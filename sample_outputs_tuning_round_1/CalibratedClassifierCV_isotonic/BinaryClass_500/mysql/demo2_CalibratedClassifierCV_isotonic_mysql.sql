...
(SELECT calibration_base_estimator_0.`KEY` AS `KEY`, CASE WHEN (calibration_base_estimator_0.`ScoreOrProba_1` < 0.0) THEN 0.8 WHEN (calibration_base_estimator_0.`ScoreOrProba_1` < 1.0) THEN (calibration_base_estimator_0.`ScoreOrProba_1` - 0.0) * 0.0 + 0.8 ELSE 0.8 END AS `Proba_1`, 1.0 - CASE WHEN (calibration_base_estimator_0.`ScoreOrProba_1` < 0.0) THEN 0.8 WHEN (calibration_base_estimator_0.`ScoreOrProba_1` < 1.0) THEN (calibration_base_estimator_0.`ScoreOrProba_1` - 0.0) * 0.0 + 0.8 ELSE 0.8 END AS `Proba_0` 
FROM calibration_base_estimator_0), 
`Normalized_Probas` AS 
(SELECT `isotonic_cte_:param_1`.`KEY` AS `KEY`, `isotonic_cte_:param_1`.`Proba_1` / (`isotonic_cte_:param_1`.`Proba_0` + `isotonic_cte_:param_1`.`Proba_1`) AS `Proba_1`, `isotonic_cte_:param_1`.`Proba_0` / (`isotonic_cte_:param_1`.`Proba_0` + `isotonic_cte_:param_1`.`Proba_1`) AS `Proba_0` 
...
(SELECT calibration_base_estimator_1.`KEY` AS `KEY`, CASE WHEN (calibration_base_estimator_1.`ScoreOrProba_1` < 0.0) THEN 0.666666666667 WHEN (calibration_base_estimator_1.`ScoreOrProba_1` < 1.0) THEN (calibration_base_estimator_1.`ScoreOrProba_1` - 0.0) * 0.0 + 0.666666666667 ELSE 0.666666666667 END AS `Proba_1`, 1.0 - CASE WHEN (calibration_base_estimator_1.`ScoreOrProba_1` < 0.0) THEN 0.666666666667 WHEN (calibration_base_estimator_1.`ScoreOrProba_1` < 1.0) THEN (calibration_base_estimator_1.`ScoreOrProba_1` - 0.0) * 0.0 + 0.666666666667 ELSE 0.666666666667 END AS `Proba_0` 
FROM calibration_base_estimator_1), 
`Normalized_Probas_1` AS 
(SELECT `isotonic_cte_:param_1_1`.`KEY` AS `KEY`, `isotonic_cte_:param_1_1`.`Proba_1` / (`isotonic_cte_:param_1_1`.`Proba_0` + `isotonic_cte_:param_1_1`.`Proba_1`) AS `Proba_1`, `isotonic_cte_:param_1_1`.`Proba_0` / (`isotonic_cte_:param_1_1`.`Proba_0` + `isotonic_cte_:param_1_1`.`Proba_1`) AS `Proba_0` 
...
`DT_node_data_2` AS 
(SELECT `Values`.node_id AS node_id, `Values`.feature AS feature, `Values`.threshold AS threshold, `Values`.count AS count, `Values`.depth AS depth, `Values`.parent_id AS parent_id, `Values`.`Proba_0` AS `Proba_0`, `Values`.`LogProba_0` AS `LogProba_0`, `Values`.`Proba_1` AS `Proba_1`, `Values`.`LogProba_1` AS `LogProba_1`, `Values`.`Decision` AS `Decision`, `Values`.`DecisionProba` AS `DecisionProba` 
FROM (SELECT 0 AS node_id, 'Feature_297' AS feature, 1.1252272129058838 AS threshold, 19 AS count, 0 AS depth, CAST(NULL AS SIGNED INTEGER) AS parent_id, 0.3157894736842105 AS `Proba_0`, -1.15267950994 AS `LogProba_0`, 0.6842105263157895 AS `Proba_1`, -0.379489621705 AS `LogProba_1`, 1 AS `Decision`, 0.684210526316 AS `DecisionProba` UNION ALL SELECT 1 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 13 AS count, 1 AS depth, 0 AS parent_id, 0.0 AS `Proba_0`, -1.79769313486231e+308 AS `LogProba_0`, 1.0 AS `Proba_1`, 0.0 AS `LogProba_1`, 1 AS `Decision`, 1.0 AS `DecisionProba` UNION ALL SELECT 2 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 6 AS count, 1 AS depth, 0 AS parent_id, 1.0 AS `Proba_0`, 0.0 AS `LogProba_0`, 0.0 AS `Proba_1`, -1.79769313486231e+308 AS `LogProba_1`, 0 AS `Decision`, 1.0 AS `DecisionProba`) AS `Values`), 
`DT_Output_2` AS 
...
(SELECT calibration_base_estimator_2.`KEY` AS `KEY`, CASE WHEN (calibration_base_estimator_2.`ScoreOrProba_1` < 0.0) THEN 0.5 WHEN (calibration_base_estimator_2.`ScoreOrProba_1` < 1.0) THEN (calibration_base_estimator_2.`ScoreOrProba_1` - 0.0) * 0.25 + 0.5 ELSE 0.75 END AS `Proba_1`, 1.0 - CASE WHEN (calibration_base_estimator_2.`ScoreOrProba_1` < 0.0) THEN 0.5 WHEN (calibration_base_estimator_2.`ScoreOrProba_1` < 1.0) THEN (calibration_base_estimator_2.`ScoreOrProba_1` - 0.0) * 0.25 + 0.5 ELSE 0.75 END AS `Proba_0` 
FROM calibration_base_estimator_2), 
`Normalized_Probas_2` AS 
(SELECT `isotonic_cte_:param_1_2`.`KEY` AS `KEY`, `isotonic_cte_:param_1_2`.`Proba_1` / (`isotonic_cte_:param_1_2`.`Proba_0` + `isotonic_cte_:param_1_2`.`Proba_1`) AS `Proba_1`, `isotonic_cte_:param_1_2`.`Proba_0` / (`isotonic_cte_:param_1_2`.`Proba_0` + `isotonic_cte_:param_1_2`.`Proba_1`) AS `Proba_0` 
...
(SELECT calibration_base_estimator_3.`KEY` AS `KEY`, CASE WHEN (calibration_base_estimator_3.`ScoreOrProba_1` < 0.0) THEN 0.8 WHEN (calibration_base_estimator_3.`ScoreOrProba_1` < 1.0) THEN (calibration_base_estimator_3.`ScoreOrProba_1` - 0.0) * 0.0 + 0.8 ELSE 0.8 END AS `Proba_1`, 1.0 - CASE WHEN (calibration_base_estimator_3.`ScoreOrProba_1` < 0.0) THEN 0.8 WHEN (calibration_base_estimator_3.`ScoreOrProba_1` < 1.0) THEN (calibration_base_estimator_3.`ScoreOrProba_1` - 0.0) * 0.0 + 0.8 ELSE 0.8 END AS `Proba_0` 
FROM calibration_base_estimator_3), 
`Normalized_Probas_3` AS 
(SELECT `isotonic_cte_:param_1_3`.`KEY` AS `KEY`, `isotonic_cte_:param_1_3`.`Proba_1` / (`isotonic_cte_:param_1_3`.`Proba_0` + `isotonic_cte_:param_1_3`.`Proba_1`) AS `Proba_1`, `isotonic_cte_:param_1_3`.`Proba_0` / (`isotonic_cte_:param_1_3`.`Proba_0` + `isotonic_cte_:param_1_3`.`Proba_1`) AS `Proba_0` 
...
orig_cte AS 
(SELECT `Calibrate_AVG_Proba`.`KEY` AS `KEY`, NULL AS `Score_0`, NULL AS `Score_1`, `Calibrate_AVG_Proba`.`Proba_0` AS `Proba_0`, `Calibrate_AVG_Proba`.`Proba_1` AS `Proba_1`, NULL AS `LogProba_0`, NULL AS `LogProba_1`, CAST(NULL AS SIGNED INTEGER) AS `Decision`, NULL AS `DecisionProba` 
