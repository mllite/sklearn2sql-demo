...
FROM (SELECT 0 AS `node_id`, 'scaler_24' AS `feature`, 0.02533610165119171 AS `threshold`, 0 AS `depth`, CAST(NULL AS INT) AS `parent_id`, 0.0 AS `Score` UNION ALL SELECT 1 AS `node_id`, CAST(NULL AS STRING) AS `feature`, CAST(NULL AS FLOAT) AS `threshold`, 1 AS `depth`, 0 AS `parent_id`, 0.19139784574508667 AS `Score` UNION ALL SELECT 2 AS `node_id`, CAST(NULL AS STRING) AS `feature`, CAST(NULL AS FLOAT) AS `threshold`, 1 AS `depth`, 0 AS `parent_id`, -0.16491228342056274 AS `Score`) AS `Values`), 
`DT_Output` AS 
...
`DT_node_data_1` AS 
(SELECT `Values`.`node_id` AS `node_id`, `Values`.`feature` AS `feature`, `Values`.`threshold` AS `threshold`, `Values`.`depth` AS `depth`, `Values`.`parent_id` AS `parent_id`, `Values`.`Score` AS `Score` 
FROM (SELECT 0 AS `node_id`, 'scaler_25' AS `feature`, -0.10406742990016937 AS `threshold`, 0 AS `depth`, CAST(NULL AS INT) AS `parent_id`, 0.0 AS `Score` UNION ALL SELECT 1 AS `node_id`, CAST(NULL AS STRING) AS `feature`, CAST(NULL AS FLOAT) AS `threshold`, 1 AS `depth`, 0 AS `parent_id`, 0.17132382094860077 AS `Score` UNION ALL SELECT 2 AS `node_id`, CAST(NULL AS STRING) AS `feature`, CAST(NULL AS FLOAT) AS `threshold`, 1 AS `depth`, 0 AS `parent_id`, -0.15663482248783112 AS `Score`) AS `Values`), 
`DT_Output_1` AS 
...
`DT_node_data_2` AS 
(SELECT `Values`.`node_id` AS `node_id`, `Values`.`feature` AS `feature`, `Values`.`threshold` AS `threshold`, `Values`.`depth` AS `depth`, `Values`.`parent_id` AS `parent_id`, `Values`.`Score` AS `Score` 
FROM (SELECT 0 AS `node_id`, 'scaler_24' AS `feature`, 0.02533610165119171 AS `threshold`, 0 AS `depth`, CAST(NULL AS INT) AS `parent_id`, 0.0 AS `Score` UNION ALL SELECT 1 AS `node_id`, CAST(NULL AS STRING) AS `feature`, CAST(NULL AS FLOAT) AS `threshold`, 1 AS `depth`, 0 AS `parent_id`, 0.16205254197120667 AS `Score` UNION ALL SELECT 2 AS `node_id`, CAST(NULL AS STRING) AS `feature`, CAST(NULL AS FLOAT) AS `threshold`, 1 AS `depth`, 0 AS `parent_id`, -0.1395835131406784 AS `Score`) AS `Values`), 
`DT_Output_2` AS 
...
`DT_node_data_3` AS 
(SELECT `Values`.`node_id` AS `node_id`, `Values`.`feature` AS `feature`, `Values`.`threshold` AS `threshold`, `Values`.`depth` AS `depth`, `Values`.`parent_id` AS `parent_id`, `Values`.`Score` AS `Score` 
FROM (SELECT 0 AS `node_id`, 'scaler_24' AS `feature`, 0.15751709043979645 AS `threshold`, 0 AS `depth`, CAST(NULL AS INT) AS `parent_id`, 0.0 AS `Score` UNION ALL SELECT 1 AS `node_id`, CAST(NULL AS STRING) AS `feature`, CAST(NULL AS FLOAT) AS `threshold`, 1 AS `depth`, 0 AS `parent_id`, 0.14153490960597992 AS `Score` UNION ALL SELECT 2 AS `node_id`, CAST(NULL AS STRING) AS `feature`, CAST(NULL AS FLOAT) AS `threshold`, 1 AS `depth`, 0 AS `parent_id`, -0.14936591684818268 AS `Score`) AS `Values`), 
`DT_Output_3` AS 
...
`DT_node_data_4` AS 
(SELECT `Values`.`node_id` AS `node_id`, `Values`.`feature` AS `feature`, `Values`.`threshold` AS `threshold`, `Values`.`depth` AS `depth`, `Values`.`parent_id` AS `parent_id`, `Values`.`Score` AS `Score` 
FROM (SELECT 0 AS `node_id`, 'scaler_24' AS `feature`, 0.02533610165119171 AS `threshold`, 0 AS `depth`, CAST(NULL AS INT) AS `parent_id`, 0.0 AS `Score` UNION ALL SELECT 1 AS `node_id`, CAST(NULL AS STRING) AS `feature`, CAST(NULL AS FLOAT) AS `threshold`, 1 AS `depth`, 0 AS `parent_id`, 0.14413604140281677 AS `Score` UNION ALL SELECT 2 AS `node_id`, CAST(NULL AS STRING) AS `feature`, CAST(NULL AS FLOAT) AS `threshold`, 1 AS `depth`, 0 AS `parent_id`, -0.12337028235197067 AS `Score`) AS `Values`), 
`DT_Output_4` AS 
...
`DT_node_data_5` AS 
(SELECT `Values`.`node_id` AS `node_id`, `Values`.`feature` AS `feature`, `Values`.`threshold` AS `threshold`, `Values`.`depth` AS `depth`, `Values`.`parent_id` AS `parent_id`, `Values`.`Score` AS `Score` 
FROM (SELECT 0 AS `node_id`, 'scaler_24' AS `feature`, 0.15751709043979645 AS `threshold`, 0 AS `depth`, CAST(NULL AS INT) AS `parent_id`, 0.0 AS `Score` UNION ALL SELECT 1 AS `node_id`, CAST(NULL AS STRING) AS `feature`, CAST(NULL AS FLOAT) AS `threshold`, 1 AS `depth`, 0 AS `parent_id`, 0.1269962340593338 AS `Score` UNION ALL SELECT 2 AS `node_id`, CAST(NULL AS STRING) AS `feature`, CAST(NULL AS FLOAT) AS `threshold`, 1 AS `depth`, 0 AS `parent_id`, -0.134647935628891 AS `Score`) AS `Values`), 
`DT_Output_5` AS 
...
`DT_node_data_6` AS 
(SELECT `Values`.`node_id` AS `node_id`, `Values`.`feature` AS `feature`, `Values`.`threshold` AS `threshold`, `Values`.`depth` AS `depth`, `Values`.`parent_id` AS `parent_id`, `Values`.`Score` AS `Score` 
FROM (SELECT 0 AS `node_id`, 'scaler_24' AS `feature`, 0.02533610165119171 AS `threshold`, 0 AS `depth`, CAST(NULL AS INT) AS `parent_id`, 0.0 AS `Score` UNION ALL SELECT 1 AS `node_id`, CAST(NULL AS STRING) AS `feature`, CAST(NULL AS FLOAT) AS `threshold`, 1 AS `depth`, 0 AS `parent_id`, 0.1318376213312149 AS `Score` UNION ALL SELECT 2 AS `node_id`, CAST(NULL AS STRING) AS `feature`, CAST(NULL AS FLOAT) AS `threshold`, 1 AS `depth`, 0 AS `parent_id`, -0.11149447411298752 AS `Score`) AS `Values`), 
`DT_Output_6` AS 
...
`DT_node_data_7` AS 
(SELECT `Values`.`node_id` AS `node_id`, `Values`.`feature` AS `feature`, `Values`.`threshold` AS `threshold`, `Values`.`depth` AS `depth`, `Values`.`parent_id` AS `parent_id`, `Values`.`Score` AS `Score` 
FROM (SELECT 0 AS `node_id`, 'scaler_25' AS `feature`, -0.10406742990016937 AS `threshold`, 0 AS `depth`, CAST(NULL AS INT) AS `parent_id`, 0.0 AS `Score` UNION ALL SELECT 1 AS `node_id`, CAST(NULL AS STRING) AS `feature`, CAST(NULL AS FLOAT) AS `threshold`, 1 AS `depth`, 0 AS `parent_id`, 0.12367173284292221 AS `Score` UNION ALL SELECT 2 AS `node_id`, CAST(NULL AS STRING) AS `feature`, CAST(NULL AS FLOAT) AS `threshold`, 1 AS `depth`, 0 AS `parent_id`, -0.11063983291387558 AS `Score`) AS `Values`), 
`DT_Output_7` AS 
...
`DT_node_data_8` AS 
(SELECT `Values`.`node_id` AS `node_id`, `Values`.`feature` AS `feature`, `Values`.`threshold` AS `threshold`, `Values`.`depth` AS `depth`, `Values`.`parent_id` AS `parent_id`, `Values`.`Score` AS `Score` 
FROM (SELECT 0 AS `node_id`, 'scaler_24' AS `feature`, 0.02533610165119171 AS `threshold`, 0 AS `depth`, CAST(NULL AS INT) AS `parent_id`, 0.0 AS `Score` UNION ALL SELECT 1 AS `node_id`, CAST(NULL AS STRING) AS `feature`, CAST(NULL AS FLOAT) AS `threshold`, 1 AS `depth`, 0 AS `parent_id`, 0.12261710315942764 AS `Score` UNION ALL SELECT 2 AS `node_id`, CAST(NULL AS STRING) AS `feature`, CAST(NULL AS FLOAT) AS `threshold`, 1 AS `depth`, 0 AS `parent_id`, -0.10089291632175446 AS `Score`) AS `Values`), 
`DT_Output_8` AS 
...
`DT_node_data_9` AS 
(SELECT `Values`.`node_id` AS `node_id`, `Values`.`feature` AS `feature`, `Values`.`threshold` AS `threshold`, `Values`.`depth` AS `depth`, `Values`.`parent_id` AS `parent_id`, `Values`.`Score` AS `Score` 
FROM (SELECT 0 AS `node_id`, 'scaler_24' AS `feature`, -0.006207090802490711 AS `threshold`, 0 AS `depth`, CAST(NULL AS INT) AS `parent_id`, 0.0 AS `Score` UNION ALL SELECT 1 AS `node_id`, CAST(NULL AS STRING) AS `feature`, CAST(NULL AS FLOAT) AS `threshold`, 1 AS `depth`, 0 AS `parent_id`, 0.11874260008335114 AS `Score` UNION ALL SELECT 2 AS `node_id`, CAST(NULL AS STRING) AS `feature`, CAST(NULL AS FLOAT) AS `threshold`, 1 AS `depth`, 0 AS `parent_id`, -0.0925363078713417 AS `Score`) AS `Values`), 
`DT_Output_9` AS 
