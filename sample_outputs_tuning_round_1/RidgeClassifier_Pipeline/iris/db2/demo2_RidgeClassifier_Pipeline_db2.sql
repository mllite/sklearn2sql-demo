...
FROM "ADS_imp_1_OUT"), 
linear_model_cte AS 
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", 0.055359893862030024 * "ADS_sca_2_OUT".scaler_output_2 + 0.167974833147614 * "ADS_sca_2_OUT".scaler_output_3 + -0.5244994698424932 * "ADS_sca_2_OUT".scaler_output_4 + -0.3662188393652218 * "ADS_sca_2_OUT".scaler_output_5 + -0.243243243243 AS "Score_0", -0.4265102291794949 * "ADS_sca_2_OUT".scaler_output_2 + -0.028227669867355264 * "ADS_sca_2_OUT".scaler_output_3 + 0.5711186711346291 * "ADS_sca_2_OUT".scaler_output_4 + 0.2400978057035554 * "ADS_sca_2_OUT".scaler_output_5 + -0.135135135135 AS "Score_1", 0.3711503353174638 * "ADS_sca_2_OUT".scaler_output_2 + -0.1397471632802585 * "ADS_sca_2_OUT".scaler_output_3 + -0.046619201292134274 * "ADS_sca_2_OUT".scaler_output_4 + 0.1261210336616658 * "ADS_sca_2_OUT".scaler_output_5 + -0.621621621622 AS "Score_2" 
FROM "ADS_sca_2_OUT"), 
orig_cte AS 
