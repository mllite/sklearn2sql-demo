...
(SELECT multinomial_cte."KEY" AS "KEY", 0.378378378378 AS "Proba_0", CASE WHEN (0.378378378378 IS NULL OR 0.378378378378 > 0.0) THEN ln(0.378378378378) ELSE -BINARY_FLOAT_INFINITY END AS "LogProba_0", 0.432432432432 AS "Proba_1", CASE WHEN (0.432432432432 IS NULL OR 0.432432432432 > 0.0) THEN ln(0.432432432432) ELSE -BINARY_FLOAT_INFINITY END AS "LogProba_1", 0.189189189189 AS "Proba_2", CASE WHEN (0.189189189189 IS NULL OR 0.189189189189 > 0.0) THEN ln(0.189189189189) ELSE -BINARY_FLOAT_INFINITY END AS "LogProba_2", multinomial_cte.multinomial_expr AS "Decision" 
