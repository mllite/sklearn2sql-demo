...
FROM (SELECT 0 AS sv_idx, -0.028152904526 AS dual_coeff, -0.706208085153 AS sv_0, 1.72400774526 AS sv_1, -1.67020294813 AS sv_2, -0.0962664240766 AS sv_3 FROM DUAL UNION ALL SELECT 1 AS sv_idx, 0.0435540213916 AS dual_coeff, -1.047780577 AS sv_0, 0.898258054886 AS sv_1, -1.14360616108 AS sv_2, 1.15306202953 AS sv_3 FROM DUAL UNION ALL SELECT 2 AS sv_idx, -0.071883135467 AS dual_coeff, 1.44631795197 AS sv_0, -1.55570693091 AS sv_1, 0.648397569942 AS sv_2, 0.0140017796406 AS sv_3 FROM DUAL UNION ALL SELECT 3 AS sv_idx, -0.344955994282 AS dual_coeff, 0.164499099534 AS sv_0, -0.997912200969 AS sv_1, -1.51915034699 AS sv_2, -1.24981948012 AS sv_3 FROM DUAL UNION ALL SELECT 4 AS sv_idx, 0.0401020096643 AS dual_coeff, -1.35684921311 AS sv_0, -1.43956176951 AS sv_1, -0.223086921758 AS sv_2, 0.624095816454 AS sv_3 FROM DUAL UNION ALL SELECT 5 AS sv_idx, 0.0240486883248 AS dual_coeff, -1.30710160499 AS sv_0, -1.79718941375 AS sv_1, -0.735675244097 AS sv_2, 0.940844015355 AS sv_3 FROM DUAL UNION ALL SELECT 6 AS sv_idx, -0.126482725925 AS dual_coeff, -0.774377257792 AS sv_0, -0.574238148168 AS sv_1, -1.65478507028 AS sv_2, 1.01640062949 AS sv_3 FROM DUAL UNION ALL SELECT 7 AS sv_idx, 0.245405071844 AS dual_coeff, -1.01076408539 AS sv_0, 0.597832962823 AS sv_1, 0.174419015679 AS sv_2, 0.495383800308 AS sv_3 FROM DUAL UNION ALL SELECT 8 AS sv_idx, 0.131217754171 AS dual_coeff, 0.40540083791 AS sv_0, -0.153771997987 AS sv_1, -0.842940359227 AS sv_2, -1.64750527014 AS sv_3 FROM DUAL UNION ALL SELECT 9 AS sv_idx, 0.0871472148046 AS dual_coeff, -0.636794256008 AS sv_0, -1.42010460146 AS sv_1, -0.379759157422 AS sv_2, -1.43449023122 AS sv_3 FROM DUAL) "Values"), 
kernel_dp AS 
