...
FROM (SELECT 0 AS node_id, CAST(NULL AS VARCHAR2(256 CHAR)) AS feature, CAST(NULL AS FLOAT) AS threshold, 0 AS depth, CAST(NULL AS INTEGER) AS parent_id, 0 AS "Score" FROM DUAL) "Values"), 
"DT_Output" AS 
