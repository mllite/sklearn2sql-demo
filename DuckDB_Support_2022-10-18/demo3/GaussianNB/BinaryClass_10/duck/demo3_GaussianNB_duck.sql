...
-- Code For temporary table TMP_20221018184821_IXTWFFU_NaiveBayes_Scores part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221018184821_IXTWFFU_NaiveBayes_Scores" (
	"KEY" BIGINT NOT NULL, 
	"Score_0" DOUBLE, 
	"Score_1" DOUBLE, 
	PRIMARY KEY ("KEY")
...
-- Code For temporary table TMP_20221018184821_IXTWFFU_NaiveBayes_Scores part 2. Populate
...
FROM centered_data) AS "Values")
 INSERT INTO "TMP_20221018184821_IXTWFFU_NaiveBayes_Scores" ("KEY", "Score_0", "Score_1") SELECT "T"."KEY", "T"."Score_0", "T"."Score_1" 
...
-- Code For temporary table TMP_20221018184821_IXTWFFU_NaiveBayes_Scores part 3. Create Index 

CREATE INDEX "ix_TMP_20221018184821_IXTWFFU_NaiveBayes_Scores_KEY" ON "TMP_20221018184821_IXTWFFU_NaiveBayes_Scores" ("KEY")
...
FROM "TMP_20221018184821_IXTWFFU_NaiveBayes_Scores" AS "NaiveBayes_Scores"), 
