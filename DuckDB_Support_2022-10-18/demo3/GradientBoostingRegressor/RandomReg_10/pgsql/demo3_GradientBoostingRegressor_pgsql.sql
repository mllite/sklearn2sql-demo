...
-- Code For temporary table TMP_20221018185417_SLIFEK2_GB_B0 part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221018185417_SLIFEK2_GB_B0" (
	"KEY" BIGINT, 
	"Estimator" FLOAT
)
...
-- Code For temporary table TMP_20221018185417_SLIFEK2_GB_B0 part 2. Populate

WITH "DT_node_lookup" AS 
(SELECT "ADS"."KEY" AS "KEY", CASE WHEN ("ADS"."Feature_2" <= 0.4864888936281204) THEN CASE WHEN ("ADS"."Feature_5" <= -0.6670668423175812) THEN CASE WHEN ("ADS"."Feature_5" <= -0.8804325759410858) THEN 3 ELSE 4 END ELSE CASE WHEN ("ADS"."Feature_8" <= -0.10979260504245758) THEN 6 ELSE 7 END END ELSE CASE WHEN ("ADS"."Feature_4" <= -1.197551190853119) THEN CASE WHEN ("ADS"."Feature_5" <= 0.10777395963668823) THEN 10 ELSE 11 END ELSE CASE WHEN ("ADS"."Feature_0" <= -0.3104289323091507) THEN 13 ELSE 14 END END END AS node_id_2 
...
FROM "DT_Output"), 
"DT_node_lookup_1" AS 
(SELECT "ADS"."KEY" AS "KEY", CASE WHEN ("ADS"."Feature_2" <= 0.4864888936281204) THEN CASE WHEN ("ADS"."Feature_7" <= 0.48319585621356964) THEN CASE WHEN ("ADS"."Feature_1" <= -1.1535027623176575) THEN 3 ELSE 4 END ELSE CASE WHEN ("ADS"."Feature_8" <= -0.13740999344736338) THEN 6 ELSE 7 END END ELSE CASE WHEN ("ADS"."Feature_4" <= -1.197551190853119) THEN CASE WHEN ("ADS"."Feature_5" <= 0.10777395963668823) THEN 10 ELSE 11 END ELSE CASE WHEN ("ADS"."Feature_0" <= -0.3104289323091507) THEN 13 ELSE 14 END END END AS node_id_2 
FROM "RandomReg_10" AS "ADS"), 
"DT_node_data_1" AS 
(SELECT "Values".nid AS nid, "Values"."E" AS "E" 
...
FROM "DT_Output_1"), 
"DT_node_lookup_2" AS 
(SELECT "ADS"."KEY" AS "KEY", CASE WHEN ("ADS"."Feature_2" <= 0.4864888936281204) THEN CASE WHEN ("ADS"."Feature_5" <= -0.6670668423175812) THEN CASE WHEN ("ADS"."Feature_5" <= -0.8804325759410858) THEN 3 ELSE 4 END ELSE CASE WHEN ("ADS"."Feature_8" <= -0.18419555574655533) THEN 6 ELSE 7 END END ELSE CASE WHEN ("ADS"."Feature_4" <= -1.197551190853119) THEN CASE WHEN ("ADS"."Feature_5" <= 0.10777395963668823) THEN 10 ELSE 11 END ELSE CASE WHEN ("ADS"."Feature_1" <= -0.19500725716352463) THEN 13 ELSE 14 END END END AS node_id_2 
FROM "RandomReg_10" AS "ADS"), 
"DT_node_data_2" AS 
(SELECT "Values".nid AS nid, "Values"."E" AS "E" 
...
FROM "DT_Output_2"), 
"DT_node_lookup_3" AS 
(SELECT "ADS"."KEY" AS "KEY", CASE WHEN ("ADS"."Feature_8" <= 1.3777701258659363) THEN CASE WHEN ("ADS"."Feature_5" <= -0.6693825721740723) THEN CASE WHEN ("ADS"."Feature_1" <= -0.07982141990214586) THEN 3 ELSE 4 END ELSE CASE WHEN ("ADS"."Feature_8" <= -0.1578926146030426) THEN 6 ELSE 7 END END ELSE CASE WHEN ("ADS"."Feature_0" <= -1.5720696449279785) THEN 9 ELSE CASE WHEN ("ADS"."Feature_8" <= 1.8881685733795166) THEN 11 ELSE 12 END END END AS node_id_2 
FROM "RandomReg_10" AS "ADS"), 
"DT_node_data_3" AS 
(SELECT "Values".nid AS nid, "Values"."E" AS "E" 
...
FROM "DT_Output_3"), 
"DT_node_lookup_4" AS 
(SELECT "ADS"."KEY" AS "KEY", CASE WHEN ("ADS"."Feature_2" <= 0.8179076910018921) THEN CASE WHEN ("ADS"."Feature_5" <= -0.5199595391750336) THEN CASE WHEN ("ADS"."Feature_1" <= -0.931333601474762) THEN 3 ELSE 4 END ELSE CASE WHEN ("ADS"."Feature_7" <= 0.6698598563671112) THEN 6 ELSE 7 END END ELSE CASE WHEN ("ADS"."Feature_8" <= -0.1578926146030426) THEN CASE WHEN ("ADS"."Feature_1" <= -0.07556744664907455) THEN 10 ELSE 11 END ELSE CASE WHEN ("ADS"."Feature_4" <= 0.3107970803976059) THEN 13 ELSE 14 END END END AS node_id_2 
FROM "RandomReg_10" AS "ADS"), 
"DT_node_data_4" AS 
(SELECT "Values".nid AS nid, "Values"."E" AS "E" 
...
FROM "DT_Output_4"), 
"DT_node_lookup_5" AS 
(SELECT "ADS"."KEY" AS "KEY", CASE WHEN ("ADS"."Feature_8" <= 1.3777701258659363) THEN CASE WHEN ("ADS"."Feature_1" <= -0.2953660264611244) THEN CASE WHEN ("ADS"."Feature_5" <= -0.5290045142173767) THEN 3 ELSE 4 END ELSE CASE WHEN ("ADS"."Feature_2" <= 0.4809132218360901) THEN 6 ELSE 7 END END ELSE CASE WHEN ("ADS"."Feature_2" <= -0.3942183628678322) THEN CASE WHEN ("ADS"."Feature_2" <= -1.2252161800861359) THEN 10 ELSE 11 END ELSE CASE WHEN ("ADS"."Feature_9" <= -1.5512021780014038) THEN 13 ELSE 14 END END END AS node_id_2 
FROM "RandomReg_10" AS "ADS"), 
"DT_node_data_5" AS 
(SELECT "Values".nid AS nid, "Values"."E" AS "E" 
...
FROM "DT_Output_5"), 
"DT_node_lookup_6" AS 
(SELECT "ADS"."KEY" AS "KEY", CASE WHEN ("ADS"."Feature_8" <= -0.3908981829881668) THEN CASE WHEN ("ADS"."Feature_3" <= -1.0433723628520966) THEN CASE WHEN ("ADS"."Feature_2" <= 0.43925850093364716) THEN 3 ELSE 4 END ELSE CASE WHEN ("ADS"."Feature_7" <= -0.19038131833076477) THEN 6 ELSE 7 END END ELSE CASE WHEN ("ADS"."Feature_1" <= -0.5763004422187805) THEN CASE WHEN ("ADS"."Feature_2" <= 0.7259149551391602) THEN 10 ELSE 11 END ELSE CASE WHEN ("ADS"."Feature_2" <= -0.3419182002544403) THEN 13 ELSE 14 END END END AS node_id_2 
FROM "RandomReg_10" AS "ADS"), 
"DT_node_data_6" AS 
(SELECT "Values".nid AS nid, "Values"."E" AS "E" 
...
FROM "DT_Output_6"), 
"DT_node_lookup_7" AS 
(SELECT "ADS"."KEY" AS "KEY", CASE WHEN ("ADS"."Feature_8" <= -0.3908981829881668) THEN CASE WHEN ("ADS"."Feature_3" <= -1.0433723628520966) THEN CASE WHEN ("ADS"."Feature_2" <= 0.4041166454553604) THEN 3 ELSE 4 END ELSE CASE WHEN ("ADS"."Feature_7" <= -0.19038131833076477) THEN 6 ELSE 7 END END ELSE CASE WHEN ("ADS"."Feature_4" <= -1.116929292678833) THEN CASE WHEN ("ADS"."Feature_8" <= 0.4848606586456299) THEN 10 ELSE 11 END ELSE CASE WHEN ("ADS"."Feature_2" <= -0.3419182002544403) THEN 13 ELSE 14 END END END AS node_id_2 
FROM "RandomReg_10" AS "ADS"), 
"DT_node_data_7" AS 
(SELECT "Values".nid AS nid, "Values"."E" AS "E" 
...
FROM "DT_Output_7"), 
"DT_node_lookup_8" AS 
(SELECT "ADS"."KEY" AS "KEY", CASE WHEN ("ADS"."Feature_8" <= 1.3777701258659363) THEN CASE WHEN ("ADS"."Feature_2" <= 1.10337233543396) THEN CASE WHEN ("ADS"."Feature_1" <= -0.10812131687998772) THEN 3 ELSE 4 END ELSE CASE WHEN ("ADS"."Feature_4" <= -0.22430559620261192) THEN 6 ELSE 7 END END ELSE CASE WHEN ("ADS"."Feature_6" <= -1.2776120901107788) THEN 9 ELSE CASE WHEN ("ADS"."Feature_8" <= 1.8881685733795166) THEN 11 ELSE 12 END END END AS node_id_2 
FROM "RandomReg_10" AS "ADS"), 
"DT_node_data_8" AS 
(SELECT "Values".nid AS nid, "Values"."E" AS "E" 
...
FROM "DT_Output_8"), 
"DT_node_lookup_9" AS 
(SELECT "ADS"."KEY" AS "KEY", CASE WHEN ("ADS"."Feature_8" <= 1.3777701258659363) THEN CASE WHEN ("ADS"."Feature_5" <= -0.6693825721740723) THEN CASE WHEN ("ADS"."Feature_5" <= -0.8804325759410858) THEN 3 ELSE 4 END ELSE CASE WHEN ("ADS"."Feature_8" <= -0.1578926146030426) THEN 6 ELSE 7 END END ELSE CASE WHEN ("ADS"."Feature_0" <= -1.5720696449279785) THEN 9 ELSE CASE WHEN ("ADS"."Feature_1" <= 0.3258654661476612) THEN 11 ELSE 12 END END END AS node_id_2 
FROM "RandomReg_10" AS "ADS"), 
"DT_node_data_9" AS 
(SELECT "Values".nid AS nid, "Values"."E" AS "E" 
...
FROM "DT_Output_9")
 INSERT INTO "TMP_20221018185417_SLIFEK2_GB_B0" ("KEY", "Estimator") SELECT "T"."KEY", "T"."Estimator" 
...
-- Code For temporary table TMP_20221018185417_I2BXLVN_GB_B1 part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221018185417_I2BXLVN_GB_B1" (
	"KEY" BIGINT, 
	"Estimator" FLOAT
)
...
-- Code For temporary table TMP_20221018185417_I2BXLVN_GB_B1 part 2. Populate

WITH "DT_node_lookup_10" AS 
(SELECT "ADS"."KEY" AS "KEY", CASE WHEN ("ADS"."Feature_2" <= 0.4864888936281204) THEN CASE WHEN ("ADS"."Feature_7" <= 0.12788642197847366) THEN CASE WHEN ("ADS"."Feature_1" <= 0.21956638246774673) THEN 3 ELSE 4 END ELSE CASE WHEN ("ADS"."Feature_5" <= 0.6095779836177826) THEN 6 ELSE 7 END END ELSE CASE WHEN ("ADS"."Feature_1" <= -0.5779649615287781) THEN CASE WHEN ("ADS"."Feature_4" <= -0.059223100543022156) THEN 10 ELSE 11 END ELSE CASE WHEN ("ADS"."Feature_0" <= 2.4845056533813477) THEN 13 ELSE 14 END END END AS node_id_2 
FROM "RandomReg_10" AS "ADS"), 
"DT_node_data_10" AS 
(SELECT "Values".nid AS nid, "Values"."E" AS "E" 
...
(SELECT "ADS"."KEY" AS "KEY", CASE WHEN ("ADS"."Feature_8" <= -0.3908981829881668) THEN CASE WHEN ("ADS"."Feature_3" <= -1.0433723628520966) THEN CASE WHEN ("ADS"."Feature_6" <= -0.34999316930770874) THEN 3 ELSE 4 END ELSE CASE WHEN ("ADS"."Feature_5" <= 0.26793916523456573) THEN 6 ELSE 7 END END ELSE CASE WHEN ("ADS"."Feature_1" <= -0.5763004422187805) THEN CASE WHEN ("ADS"."Feature_8" <= 1.3495553135871887) THEN 10 ELSE 11 END ELSE CASE WHEN ("ADS"."Feature_2" <= -0.3419182002544403) THEN 13 ELSE 14 END END END AS node_id_2 
FROM "RandomReg_10" AS "ADS"), 
"DT_node_data_11" AS 
(SELECT "Values".nid AS nid, "Values"."E" AS "E" 
...
(SELECT "ADS"."KEY" AS "KEY", CASE WHEN ("ADS"."Feature_2" <= 0.4864888936281204) THEN CASE WHEN ("ADS"."Feature_7" <= 0.12788642197847366) THEN CASE WHEN ("ADS"."Feature_6" <= -0.19785263389348984) THEN 3 ELSE 4 END ELSE CASE WHEN ("ADS"."Feature_5" <= 1.4352846145629883) THEN 6 ELSE 7 END END ELSE CASE WHEN ("ADS"."Feature_0" <= 1.8744382858276367) THEN CASE WHEN ("ADS"."Feature_1" <= -0.19500725716352463) THEN 10 ELSE 11 END ELSE CASE WHEN ("ADS"."Feature_9" <= 0.5527465343475342) THEN 13 ELSE 14 END END END AS node_id_2 
FROM "RandomReg_10" AS "ADS"), 
"DT_node_data_12" AS 
(SELECT "Values".nid AS nid, "Values"."E" AS "E" 
...
(SELECT "ADS"."KEY" AS "KEY", CASE WHEN ("ADS"."Feature_4" <= -1.0482117533683777) THEN CASE WHEN ("ADS"."Feature_5" <= 0.21651247143745422) THEN CASE WHEN ("ADS"."Feature_8" <= 0.12232283083721995) THEN 3 ELSE 4 END ELSE CASE WHEN ("ADS"."Feature_5" <= 1.1149399280548096) THEN 6 ELSE 7 END END ELSE CASE WHEN ("ADS"."Feature_8" <= -0.5495923459529877) THEN CASE WHEN ("ADS"."Feature_6" <= -0.16602688655257225) THEN 10 ELSE 11 END ELSE CASE WHEN ("ADS"."Feature_0" <= 1.1636798977851868) THEN 13 ELSE 14 END END END AS node_id_2 
FROM "RandomReg_10" AS "ADS"), 
"DT_node_data_13" AS 
(SELECT "Values".nid AS nid, "Values"."E" AS "E" 
...
(SELECT "ADS"."KEY" AS "KEY", CASE WHEN ("ADS"."Feature_5" <= -0.6693825721740723) THEN CASE WHEN ("ADS"."Feature_2" <= 0.8048999309539795) THEN CASE WHEN ("ADS"."Feature_8" <= 0.3638743758201599) THEN 3 ELSE 4 END ELSE CASE WHEN ("ADS"."Feature_4" <= 0.8961740070953965) THEN 6 ELSE 7 END END ELSE CASE WHEN ("ADS"."Feature_8" <= -0.1578926146030426) THEN CASE WHEN ("ADS"."Feature_1" <= 1.1039375066757202) THEN 10 ELSE 11 END ELSE CASE WHEN ("ADS"."Feature_0" <= 1.1356269121170044) THEN 13 ELSE 14 END END END AS node_id_2 
FROM "RandomReg_10" AS "ADS"), 
"DT_node_data_14" AS 
(SELECT "Values".nid AS nid, "Values"."E" AS "E" 
...
(SELECT "ADS"."KEY" AS "KEY", CASE WHEN ("ADS"."Feature_2" <= 0.8179076910018921) THEN CASE WHEN ("ADS"."Feature_5" <= 0.2265688106417656) THEN CASE WHEN ("ADS"."Feature_3" <= 0.610985666513443) THEN 3 ELSE 4 END ELSE CASE WHEN ("ADS"."Feature_7" <= 1.010027289390564) THEN 6 ELSE 7 END END ELSE CASE WHEN ("ADS"."Feature_8" <= -0.1578926146030426) THEN CASE WHEN ("ADS"."Feature_1" <= 1.7392034530639648) THEN 10 ELSE 11 END ELSE CASE WHEN ("ADS"."Feature_6" <= -1.3490328192710876) THEN 13 ELSE 14 END END END AS node_id_2 
FROM "RandomReg_10" AS "ADS"), 
"DT_node_data_15" AS 
(SELECT "Values".nid AS nid, "Values"."E" AS "E" 
...
FROM "DT_Output_15")
 INSERT INTO "TMP_20221018185417_I2BXLVN_GB_B1" ("KEY", "Estimator") SELECT "T"."KEY", "T"."Estimator" 
...
-- Code For temporary table TMP_20221018185417_BE802LH_GB_sum part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221018185417_BE802LH_GB_sum" (
	"KEY" BIGINT NOT NULL, 
	"Estimator" FLOAT, 
	PRIMARY KEY ("KEY")
)
...
-- Code For temporary table TMP_20221018185417_BE802LH_GB_sum part 2. Populate

WITH "GB_Union" AS 
(SELECT "GB_EnsembleUnion"."KEY" AS "KEY", "GB_EnsembleUnion"."Estimator" AS "Estimator" 
FROM (SELECT "GB_B0"."KEY" AS "KEY", "GB_B0"."Estimator" AS "Estimator" 
FROM "TMP_20221018185417_SLIFEK2_GB_B0" AS "GB_B0" UNION ALL SELECT "GB_B1"."KEY" AS "KEY", "GB_B1"."Estimator" AS "Estimator" 
FROM "TMP_20221018185417_I2BXLVN_GB_B1" AS "GB_B1") AS "GB_EnsembleUnion")
 INSERT INTO "TMP_20221018185417_BE802LH_GB_sum" ("KEY", "Estimator") SELECT "T"."KEY", "T"."Estimator" 
...
-- Code For temporary table TMP_20221018185417_BE802LH_GB_sum part 3. Create Index 

CREATE INDEX "ix_TMP_20221018185417_BE802LH_GB_sum_KEY" ON "TMP_20221018185417_BE802LH_GB_sum" ("KEY")

-- Model deployment code

SELECT "GB_sum"."KEY" AS "KEY", 26.405852730652413 + 0.1 * "GB_sum"."Estimator" AS "Estimator" 
FROM "TMP_20221018185417_BE802LH_GB_sum" AS "GB_sum"