...
-- Code For temporary table TMP_20221018190428_M8BUET4_RF_B0 part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221018190428_M8BUET4_RF_B0" (
	"KEY" BIGINT, 
	"Score_0" FLOAT, 
	"Proba_0" FLOAT, 
	"LogProba_0" FLOAT, 
...
-- Code For temporary table TMP_20221018190428_M8BUET4_RF_B0 part 2. Populate
...
FROM "DT_Output_9")
 INSERT INTO "TMP_20221018190428_M8BUET4_RF_B0" ("KEY", "Score_0", "Proba_0", "LogProba_0", "Score_1", "Proba_1", "LogProba_1", "Score_2", "Proba_2", "LogProba_2") SELECT "T"."KEY", "T"."Score_0", "T"."Proba_0", "T"."LogProba_0", "T"."Score_1", "T"."Proba_1", "T"."LogProba_1", "T"."Score_2", "T"."Proba_2", "T"."LogProba_2" 
...
-- Code For temporary table TMP_20221018190428_9SFO9YZ_RF_B1 part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221018190428_9SFO9YZ_RF_B1" (
	"KEY" BIGINT, 
	"Score_0" FLOAT, 
	"Proba_0" FLOAT, 
	"LogProba_0" FLOAT, 
...
-- Code For temporary table TMP_20221018190428_9SFO9YZ_RF_B1 part 2. Populate
...
FROM "DT_Output_15")
 INSERT INTO "TMP_20221018190428_9SFO9YZ_RF_B1" ("KEY", "Score_0", "Proba_0", "LogProba_0", "Score_1", "Proba_1", "LogProba_1", "Score_2", "Proba_2", "LogProba_2") SELECT "T"."KEY", "T"."Score_0", "T"."Proba_0", "T"."LogProba_0", "T"."Score_1", "T"."Proba_1", "T"."LogProba_1", "T"."Score_2", "T"."Proba_2", "T"."LogProba_2" 
...
-- Code For temporary table TMP_20221018190428_R8MXL9O_RF_avg part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221018190428_R8MXL9O_RF_avg" (
	"KEY" BIGINT NOT NULL, 
	"Score_0" FLOAT, 
	"Proba_0" FLOAT, 
	"LogProba_0" FLOAT, 
...
-- Code For temporary table TMP_20221018190428_R8MXL9O_RF_avg part 2. Populate
...
FROM (SELECT "RF_B0"."KEY" AS "KEY", "RF_B0"."Score_0" AS "Score_0", "RF_B0"."Proba_0" AS "Proba_0", "RF_B0"."LogProba_0" AS "LogProba_0", "RF_B0"."Score_1" AS "Score_1", "RF_B0"."Proba_1" AS "Proba_1", "RF_B0"."LogProba_1" AS "LogProba_1", "RF_B0"."Score_2" AS "Score_2", "RF_B0"."Proba_2" AS "Proba_2", "RF_B0"."LogProba_2" AS "LogProba_2" 
FROM "TMP_20221018190428_M8BUET4_RF_B0" AS "RF_B0" UNION ALL SELECT "RF_B1"."KEY" AS "KEY", "RF_B1"."Score_0" AS "Score_0", "RF_B1"."Proba_0" AS "Proba_0", "RF_B1"."LogProba_0" AS "LogProba_0", "RF_B1"."Score_1" AS "Score_1", "RF_B1"."Proba_1" AS "Proba_1", "RF_B1"."LogProba_1" AS "LogProba_1", "RF_B1"."Score_2" AS "Score_2", "RF_B1"."Proba_2" AS "Proba_2", "RF_B1"."LogProba_2" AS "LogProba_2" 
FROM "TMP_20221018190428_9SFO9YZ_RF_B1" AS "RF_B1") AS "RF_EnsembleUnion")
 INSERT INTO "TMP_20221018190428_R8MXL9O_RF_avg" ("KEY", "Score_0", "Proba_0", "LogProba_0", "Score_1", "Proba_1", "LogProba_1", "Score_2", "Proba_2", "LogProba_2") SELECT "T"."KEY", "T"."Score_0", "T"."Proba_0", "T"."LogProba_0", "T"."Score_1", "T"."Proba_1", "T"."LogProba_1", "T"."Score_2", "T"."Proba_2", "T"."LogProba_2" 
...
-- Code For temporary table TMP_20221018190428_R8MXL9O_RF_avg part 3. Create Index 

CREATE INDEX "ix_TMP_20221018190428_R8MXL9O_RF_avg_KEY" ON "TMP_20221018190428_R8MXL9O_RF_avg" ("KEY")
...
FROM "TMP_20221018190428_R8MXL9O_RF_avg" AS "RF_avg"), 
