...
-- Code For temporary table TMP_20221018185916_SJ4UFBK_ADS_imp_1_OUT part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221018185916_SJ4UFBK_ADS_imp_1_OUT" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20221018185916_SJ4UFBK_ADS_imp_1_OUT part 3. Create Index 

CREATE INDEX "ix_TMP_20221018185916_SJ4UFBK_ADS_imp_1_OUT_KEY" ON "TMP_20221018185916_SJ4UFBK_ADS_imp_1_OUT" ("KEY")

-- Code For temporary table TMP_20221018185916_5ZB04Q7_ADS_sca_2_OUT part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221018185916_5ZB04Q7_ADS_sca_2_OUT" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20221018185916_5ZB04Q7_ADS_sca_2_OUT part 2. Populate

INSERT INTO "TMP_20221018185916_5ZB04Q7_ADS_sca_2_OUT" ("KEY", scaler_output_2, scaler_output_3, scaler_output_4, scaler_output_5, scaler_output_6, scaler_output_7, scaler_output_8, scaler_output_9, scaler_output_10, scaler_output_11) SELECT "T"."KEY", "T".scaler_output_2, "T".scaler_output_3, "T".scaler_output_4, "T".scaler_output_5, "T".scaler_output_6, "T".scaler_output_7, "T".scaler_output_8, "T".scaler_output_9, "T".scaler_output_10, "T".scaler_output_11 
...
FROM "TMP_20221018185916_SJ4UFBK_ADS_imp_1_OUT" AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT") AS "T"

-- Code For temporary table TMP_20221018185916_5ZB04Q7_ADS_sca_2_OUT part 3. Create Index 

CREATE INDEX "ix_TMP_20221018185916_5ZB04Q7_ADS_sca_2_OUT_KEY" ON "TMP_20221018185916_5ZB04Q7_ADS_sca_2_OUT" ("KEY")

-- Code For temporary table TMP_20221018185916_ZJRO68Y_XGB_B0 part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221018185916_ZJRO68Y_XGB_B0" (
	"KEY" BIGINT, 
	"Estimator" FLOAT
)
...
-- Code For temporary table TMP_20221018185916_ZJRO68Y_XGB_B0 part 2. Populate
...
FROM "TMP_20221018185916_5ZB04Q7_ADS_sca_2_OUT" AS "ADS_sca_2_OUT"), 
"DT_node_data" AS 
...
FROM "DT_Output_9")
 INSERT INTO "TMP_20221018185916_ZJRO68Y_XGB_B0" ("KEY", "Estimator") SELECT "T"."KEY", "T"."Estimator" 
...
-- Code For temporary table TMP_20221018185916_G8B4PXJ_XGB_B1 part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221018185916_G8B4PXJ_XGB_B1" (
	"KEY" BIGINT, 
	"Estimator" FLOAT
)
...
-- Code For temporary table TMP_20221018185916_G8B4PXJ_XGB_B1 part 2. Populate
...
FROM "DT_Output_15")
 INSERT INTO "TMP_20221018185916_G8B4PXJ_XGB_B1" ("KEY", "Estimator") SELECT "T"."KEY", "T"."Estimator" 
...
-- Code For temporary table TMP_20221018185916_67CB4E0_XGB_sum part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221018185916_67CB4E0_XGB_sum" (
	"KEY" BIGINT NOT NULL, 
	"Estimator" FLOAT, 
	PRIMARY KEY ("KEY")
)
...
-- Code For temporary table TMP_20221018185916_67CB4E0_XGB_sum part 2. Populate

WITH "XGB_Union" AS 
(SELECT "XGB_EnsembleUnion"."KEY" AS "KEY", "XGB_EnsembleUnion"."Estimator" AS "Estimator" 
FROM (SELECT "XGB_B0"."KEY" AS "KEY", "XGB_B0"."Estimator" AS "Estimator" 
FROM "TMP_20221018185916_ZJRO68Y_XGB_B0" AS "XGB_B0" UNION ALL SELECT "XGB_B1"."KEY" AS "KEY", "XGB_B1"."Estimator" AS "Estimator" 
FROM "TMP_20221018185916_G8B4PXJ_XGB_B1" AS "XGB_B1") AS "XGB_EnsembleUnion")
 INSERT INTO "TMP_20221018185916_67CB4E0_XGB_sum" ("KEY", "Estimator") SELECT "T"."KEY", "T"."Estimator" 
...
-- Code For temporary table TMP_20221018185916_67CB4E0_XGB_sum part 3. Create Index 

CREATE INDEX "ix_TMP_20221018185916_67CB4E0_XGB_sum_KEY" ON "TMP_20221018185916_67CB4E0_XGB_sum" ("KEY")

-- Model deployment code

SELECT "XGB_sum"."KEY" AS "KEY", "XGB_sum"."Estimator" + 0.5 AS "Estimator" 
FROM "TMP_20221018185916_67CB4E0_XGB_sum" AS "XGB_sum"