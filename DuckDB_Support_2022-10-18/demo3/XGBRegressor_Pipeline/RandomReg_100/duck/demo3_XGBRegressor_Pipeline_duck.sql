...
-- Code For temporary table TMP_20221018185554_2WB1JM4_ADS_imp_1_OUT part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221018185554_2WB1JM4_ADS_imp_1_OUT" (
	"KEY" BIGINT NOT NULL, 
	impter_2 DOUBLE, 
	impter_3 DOUBLE, 
	impter_4 DOUBLE, 
...
-- Code For temporary table TMP_20221018185554_2WB1JM4_ADS_imp_1_OUT part 3. Create Index 

CREATE INDEX "ix_TMP_20221018185554_2WB1JM4_ADS_imp_1_OUT_KEY" ON "TMP_20221018185554_2WB1JM4_ADS_imp_1_OUT" ("KEY")

-- Code For temporary table TMP_20221018185554_8FIL88D_ADS_sca_2_OUT part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221018185554_8FIL88D_ADS_sca_2_OUT" (
	"KEY" BIGINT NOT NULL, 
	scaler_2 DOUBLE, 
	scaler_3 DOUBLE, 
	scaler_4 DOUBLE, 
...
FROM "TMP_20221018185554_2WB1JM4_ADS_imp_1_OUT" AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT") AS "T"

-- Code For temporary table TMP_20221018185554_8FIL88D_ADS_sca_2_OUT part 3. Create Index 

CREATE INDEX "ix_TMP_20221018185554_8FIL88D_ADS_sca_2_OUT_KEY" ON "TMP_20221018185554_8FIL88D_ADS_sca_2_OUT" ("KEY")

-- Code For temporary table TMP_20221018185554_TQDQZS3_XGB_B0 part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221018185554_TQDQZS3_XGB_B0" (
	"KEY" BIGINT, 
	"Estimator" DOUBLE
)
...
-- Code For temporary table TMP_20221018185554_TQDQZS3_XGB_B0 part 2. Populate

WITH "DT_node_lookup" AS 
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", CASE WHEN ("ADS_sca_2_OUT".scaler_82 < -0.174784958) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_43 < -0.45317921) THEN 3 ELSE 4 END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_41 < 0.43509984) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_3 < -0.0815727636) THEN 7 ELSE 8 END ELSE 6 END END AS node_id_2 
FROM "TMP_20221018185554_8FIL88D_ADS_sca_2_OUT" AS "ADS_sca_2_OUT"), 
"DT_node_data" AS 
...
FROM "DT_Output"), 
"DT_node_lookup_1" AS 
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", CASE WHEN ("ADS_sca_2_OUT".scaler_82 < -0.174784958) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_65 < -0.0208482631) THEN 3 ELSE 4 END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_96 < -0.448461592) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_22 < 0.317930162) THEN 7 ELSE 8 END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_18 < 0.233207166) THEN 9 ELSE 10 END END END AS node_id_2 
FROM "TMP_20221018185554_8FIL88D_ADS_sca_2_OUT" AS "ADS_sca_2_OUT"), 
"DT_node_data_1" AS 
(SELECT "Values".nid AS nid, "Values"."Estimator" AS "Estimator" 
...
FROM "DT_Output_1"), 
"DT_node_lookup_2" AS 
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", CASE WHEN ("ADS_sca_2_OUT".scaler_97 < -0.348418981) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_43 < -0.152117193) THEN 3 ELSE 4 END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_81 < -0.135007069) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_14 < -0.238503188) THEN 7 ELSE 8 END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_22 < 0.40323472) THEN 9 ELSE 10 END END END AS node_id_2 
FROM "TMP_20221018185554_8FIL88D_ADS_sca_2_OUT" AS "ADS_sca_2_OUT"), 
"DT_node_data_2" AS 
(SELECT "Values".nid AS nid, "Values"."Estimator" AS "Estimator" 
...
FROM "DT_Output_2"), 
"DT_node_lookup_3" AS 
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", CASE WHEN ("ADS_sca_2_OUT".scaler_43 < -0.445763588) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_82 < 0.0798400566) THEN 3 ELSE 4 END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_51 < 0.670727909) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_65 < -0.0664011836) THEN 7 ELSE 8 END ELSE 6 END END AS node_id_2 
FROM "TMP_20221018185554_8FIL88D_ADS_sca_2_OUT" AS "ADS_sca_2_OUT"), 
"DT_node_data_3" AS 
(SELECT "Values".nid AS nid, "Values"."Estimator" AS "Estimator" 
...
FROM "DT_Output_3"), 
"DT_node_lookup_4" AS 
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", CASE WHEN ("ADS_sca_2_OUT".scaler_82 < 0.987419486) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_97 < -0.813685) THEN 3 ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_41 < 0.626665831) THEN 5 ELSE 6 END END ELSE 2 END AS node_id_2 
FROM "TMP_20221018185554_8FIL88D_ADS_sca_2_OUT" AS "ADS_sca_2_OUT"), 
"DT_node_data_4" AS 
(SELECT "Values".nid AS nid, "Values"."Estimator" AS "Estimator" 
...
FROM "DT_Output_4"), 
"DT_node_lookup_5" AS 
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", CASE WHEN ("ADS_sca_2_OUT".scaler_65 < 0.323112488) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_43 < -0.0450809188) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_54 < -0.204871327) THEN 7 ELSE 8 END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_82 < 0.226664901) THEN 9 ELSE 10 END END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_96 < 0.346991837) THEN 5 ELSE 6 END END AS node_id_2 
FROM "TMP_20221018185554_8FIL88D_ADS_sca_2_OUT" AS "ADS_sca_2_OUT"), 
"DT_node_data_5" AS 
(SELECT "Values".nid AS nid, "Values"."Estimator" AS "Estimator" 
...
FROM "DT_Output_5"), 
"DT_node_lookup_6" AS 
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", CASE WHEN ("ADS_sca_2_OUT".scaler_97 < -0.348418981) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_65 < -0.0246979762) THEN 3 ELSE 4 END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_83 < -0.34963271) THEN 5 ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_81 < -0.135007069) THEN 7 ELSE 8 END END END AS node_id_2 
FROM "TMP_20221018185554_8FIL88D_ADS_sca_2_OUT" AS "ADS_sca_2_OUT"), 
"DT_node_data_6" AS 
(SELECT "Values".nid AS nid, "Values"."Estimator" AS "Estimator" 
...
FROM "DT_Output_6"), 
"DT_node_lookup_7" AS 
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", CASE WHEN ("ADS_sca_2_OUT".scaler_41 < 0.539143085) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_59 < 0.532628298) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_85 < 0.457637548) THEN 7 ELSE 8 END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_81 < 0.13102372) THEN 9 ELSE 10 END END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_65 < -0.0266534537) THEN 5 ELSE 6 END END AS node_id_2 
FROM "TMP_20221018185554_8FIL88D_ADS_sca_2_OUT" AS "ADS_sca_2_OUT"), 
"DT_node_data_7" AS 
(SELECT "Values".nid AS nid, "Values"."Estimator" AS "Estimator" 
...
FROM "DT_Output_7"), 
"DT_node_lookup_8" AS 
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", CASE WHEN ("ADS_sca_2_OUT".scaler_82 < 0.987419486) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_97 < 0.67652005) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_93 < 0.115521803) THEN 5 ELSE 6 END ELSE 4 END ELSE 2 END AS node_id_2 
FROM "TMP_20221018185554_8FIL88D_ADS_sca_2_OUT" AS "ADS_sca_2_OUT"), 
"DT_node_data_8" AS 
(SELECT "Values".nid AS nid, "Values"."Estimator" AS "Estimator" 
...
FROM "DT_Output_8"), 
"DT_node_lookup_9" AS 
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", CASE WHEN ("ADS_sca_2_OUT".scaler_65 < 0.263868272) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_43 < -0.0450809188) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_51 < -0.146268681) THEN 7 ELSE 8 END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_46 < -0.251241744) THEN 9 ELSE 10 END END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_89 < -0.482839078) THEN 5 ELSE 6 END END AS node_id_2 
FROM "TMP_20221018185554_8FIL88D_ADS_sca_2_OUT" AS "ADS_sca_2_OUT"), 
"DT_node_data_9" AS 
(SELECT "Values".nid AS nid, "Values"."Estimator" AS "Estimator" 
...
FROM "DT_Output_9")
 INSERT INTO "TMP_20221018185554_TQDQZS3_XGB_B0" ("KEY", "Estimator") SELECT "T"."KEY", "T"."Estimator" 
...
-- Code For temporary table TMP_20221018185554_9LP15JJ_XGB_B1 part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221018185554_9LP15JJ_XGB_B1" (
	"KEY" BIGINT, 
	"Estimator" DOUBLE
)
...
-- Code For temporary table TMP_20221018185554_9LP15JJ_XGB_B1 part 2. Populate

WITH "DT_node_lookup_10" AS 
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", CASE WHEN ("ADS_sca_2_OUT".scaler_82 < 1.27263355) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_97 < 0.67652005) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_83 < 0.388959944) THEN 5 ELSE 6 END ELSE 4 END ELSE 2 END AS node_id_2 
FROM "TMP_20221018185554_8FIL88D_ADS_sca_2_OUT" AS "ADS_sca_2_OUT"), 
"DT_node_data_10" AS 
(SELECT "Values".nid AS nid, "Values"."Estimator" AS "Estimator" 
...
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", CASE WHEN ("ADS_sca_2_OUT".scaler_41 < 0.539143085) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_46 < -0.891244769) THEN 3 ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_43 < 0.202229232) THEN 7 ELSE 8 END END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_32 < 0.281194955) THEN 5 ELSE 6 END END AS node_id_2 
FROM "TMP_20221018185554_8FIL88D_ADS_sca_2_OUT" AS "ADS_sca_2_OUT"), 
"DT_node_data_11" AS 
(SELECT "Values".nid AS nid, "Values"."Estimator" AS "Estimator" 
...
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", CASE WHEN ("ADS_sca_2_OUT".scaler_65 < 0.263868272) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_93 < -0.680074811) THEN 3 ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_36 < 0.447499752) THEN 7 ELSE 8 END END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_91 < -0.623429656) THEN 5 ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_97 < -0.051868625) THEN 9 ELSE 10 END END END AS node_id_2 
FROM "TMP_20221018185554_8FIL88D_ADS_sca_2_OUT" AS "ADS_sca_2_OUT"), 
"DT_node_data_12" AS 
(SELECT "Values".nid AS nid, "Values"."Estimator" AS "Estimator" 
...
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", CASE WHEN ("ADS_sca_2_OUT".scaler_65 < -1.112975) THEN 1 ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_10 < 0.73945123) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_56 < -0.715627551) THEN 5 ELSE 6 END ELSE 4 END END AS node_id_2 
FROM "TMP_20221018185554_8FIL88D_ADS_sca_2_OUT" AS "ADS_sca_2_OUT"), 
"DT_node_data_13" AS 
(SELECT "Values".nid AS nid, "Values"."Estimator" AS "Estimator" 
...
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", CASE WHEN ("ADS_sca_2_OUT".scaler_65 < 1.40907454) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_41 < 0.409238517) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_21 < -0.651192546) THEN 5 ELSE 6 END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_3 < 0.332160085) THEN 7 ELSE 8 END END ELSE 2 END AS node_id_2 
FROM "TMP_20221018185554_8FIL88D_ADS_sca_2_OUT" AS "ADS_sca_2_OUT"), 
"DT_node_data_14" AS 
(SELECT "Values".nid AS nid, "Values"."Estimator" AS "Estimator" 
...
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", CASE WHEN ("ADS_sca_2_OUT".scaler_43 < 1.17360389) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_70 < 1.03606176) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_41 < -0.245787978) THEN 5 ELSE 6 END ELSE 4 END ELSE 2 END AS node_id_2 
FROM "TMP_20221018185554_8FIL88D_ADS_sca_2_OUT" AS "ADS_sca_2_OUT"), 
"DT_node_data_15" AS 
(SELECT "Values".nid AS nid, "Values"."Estimator" AS "Estimator" 
...
FROM "DT_Output_15")
 INSERT INTO "TMP_20221018185554_9LP15JJ_XGB_B1" ("KEY", "Estimator") SELECT "T"."KEY", "T"."Estimator" 
...
-- Code For temporary table TMP_20221018185554_BH32URM_XGB_sum part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221018185554_BH32URM_XGB_sum" (
	"KEY" BIGINT NOT NULL, 
	"Estimator" DOUBLE, 
	PRIMARY KEY ("KEY")
)
...
-- Code For temporary table TMP_20221018185554_BH32URM_XGB_sum part 2. Populate

WITH "XGB_Union" AS 
(SELECT "XGB_EnsembleUnion"."KEY" AS "KEY", "XGB_EnsembleUnion"."Estimator" AS "Estimator" 
FROM (SELECT "XGB_B0"."KEY" AS "KEY", "XGB_B0"."Estimator" AS "Estimator" 
FROM "TMP_20221018185554_TQDQZS3_XGB_B0" AS "XGB_B0" UNION ALL SELECT "XGB_B1"."KEY" AS "KEY", "XGB_B1"."Estimator" AS "Estimator" 
FROM "TMP_20221018185554_9LP15JJ_XGB_B1" AS "XGB_B1") AS "XGB_EnsembleUnion")
 INSERT INTO "TMP_20221018185554_BH32URM_XGB_sum" ("KEY", "Estimator") SELECT "T"."KEY", "T"."Estimator" 
...
-- Code For temporary table TMP_20221018185554_BH32URM_XGB_sum part 3. Create Index 

CREATE INDEX "ix_TMP_20221018185554_BH32URM_XGB_sum_KEY" ON "TMP_20221018185554_BH32URM_XGB_sum" ("KEY")

-- Model deployment code

SELECT "XGB_sum"."KEY" AS "KEY", "XGB_sum"."Estimator" + 0.5 AS "Estimator" 
FROM "TMP_20221018185554_BH32URM_XGB_sum" AS "XGB_sum"