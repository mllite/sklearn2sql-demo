...
-- Code For temporary table TMP_20221018190631_HG0DA7L_ADS_imp_1_OUT part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221018190631_HG0DA7L_ADS_imp_1_OUT" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20221018190631_HG0DA7L_ADS_imp_1_OUT part 2. Populate

INSERT INTO "TMP_20221018190631_HG0DA7L_ADS_imp_1_OUT" ("KEY", imputer_output_2, imputer_output_3, imputer_output_4, imputer_output_5) SELECT "T"."KEY", "T".imputer_output_2, "T".imputer_output_3, "T".imputer_output_4, "T".imputer_output_5 
...
-- Code For temporary table TMP_20221018190631_HG0DA7L_ADS_imp_1_OUT part 3. Create Index 

CREATE INDEX "ix_TMP_20221018190631_HG0DA7L_ADS_imp_1_OUT_KEY" ON "TMP_20221018190631_HG0DA7L_ADS_imp_1_OUT" ("KEY")

-- Code For temporary table TMP_20221018190631_PGANH1Q_ADS_sca_2_OUT part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221018190631_PGANH1Q_ADS_sca_2_OUT" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20221018190631_PGANH1Q_ADS_sca_2_OUT part 2. Populate

INSERT INTO "TMP_20221018190631_PGANH1Q_ADS_sca_2_OUT" ("KEY", scaler_output_2, scaler_output_3, scaler_output_4, scaler_output_5) SELECT "T"."KEY", "T".scaler_output_2, "T".scaler_output_3, "T".scaler_output_4, "T".scaler_output_5 
...
FROM "TMP_20221018190631_HG0DA7L_ADS_imp_1_OUT" AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT") AS "T"

-- Code For temporary table TMP_20221018190631_PGANH1Q_ADS_sca_2_OUT part 3. Create Index 

CREATE INDEX "ix_TMP_20221018190631_PGANH1Q_ADS_sca_2_OUT_KEY" ON "TMP_20221018190631_PGANH1Q_ADS_sca_2_OUT" ("KEY")

-- Code For temporary table TMP_20221018190631_SQM64P0_NaiveBayes_Scores part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221018190631_SQM64P0_NaiveBayes_Scores" (
	"KEY" BIGINT NOT NULL, 
	"Score_CLASS_0" FLOAT, 
	"Score_CLASS_1" FLOAT, 
	"Score_CLASS_2" FLOAT, 
...
-- Code For temporary table TMP_20221018190631_SQM64P0_NaiveBayes_Scores part 2. Populate
...
FROM "TMP_20221018190631_PGANH1Q_ADS_sca_2_OUT" AS "ADS_sca_2_OUT"), 
"NaiveBayes_data" AS 
...
FROM centered_data) AS "Values")
 INSERT INTO "TMP_20221018190631_SQM64P0_NaiveBayes_Scores" ("KEY", "Score_CLASS_0", "Score_CLASS_1", "Score_CLASS_2") SELECT "T"."KEY", "T"."Score_CLASS_0", "T"."Score_CLASS_1", "T"."Score_CLASS_2" 
...
-- Code For temporary table TMP_20221018190631_SQM64P0_NaiveBayes_Scores part 3. Create Index 

CREATE INDEX "ix_TMP_20221018190631_SQM64P0_NaiveBayes_Scores_KEY" ON "TMP_20221018190631_SQM64P0_NaiveBayes_Scores" ("KEY")
...
FROM "TMP_20221018190631_SQM64P0_NaiveBayes_Scores" AS "NaiveBayes_Scores"), 
