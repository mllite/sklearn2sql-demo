...
-- Code For temporary table TMP_20221018185155_9E092ZO_ADS_imp_1_OUT part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221018185155_9E092ZO_ADS_imp_1_OUT" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20221018185155_9E092ZO_ADS_imp_1_OUT part 3. Create Index 

CREATE INDEX "ix_TMP_20221018185155_9E092ZO_ADS_imp_1_OUT_KEY" ON "TMP_20221018185155_9E092ZO_ADS_imp_1_OUT" ("KEY")

-- Code For temporary table TMP_20221018185155_G86JKSK_ADS_sca_2_OUT part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221018185155_G86JKSK_ADS_sca_2_OUT" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20221018185155_G86JKSK_ADS_sca_2_OUT part 2. Populate

INSERT INTO "TMP_20221018185155_G86JKSK_ADS_sca_2_OUT" ("KEY", scaler_output_2, scaler_output_3, scaler_output_4, scaler_output_5, scaler_output_6, scaler_output_7, scaler_output_8, scaler_output_9, scaler_output_10, scaler_output_11) SELECT "T"."KEY", "T".scaler_output_2, "T".scaler_output_3, "T".scaler_output_4, "T".scaler_output_5, "T".scaler_output_6, "T".scaler_output_7, "T".scaler_output_8, "T".scaler_output_9, "T".scaler_output_10, "T".scaler_output_11 
...
FROM "TMP_20221018185155_9E092ZO_ADS_imp_1_OUT" AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT") AS "T"

-- Code For temporary table TMP_20221018185155_G86JKSK_ADS_sca_2_OUT part 3. Create Index 

CREATE INDEX "ix_TMP_20221018185155_G86JKSK_ADS_sca_2_OUT_KEY" ON "TMP_20221018185155_G86JKSK_ADS_sca_2_OUT" ("KEY")

-- Code For temporary table TMP_20221018185155_QZUMXK3_NaiveBayes_Scores part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221018185155_QZUMXK3_NaiveBayes_Scores" (
	"KEY" BIGINT NOT NULL, 
	"Score_0" DOUBLE, 
	"Score_1" DOUBLE, 
	"Score_2" DOUBLE, 
...
-- Code For temporary table TMP_20221018185155_QZUMXK3_NaiveBayes_Scores part 2. Populate

WITH centered_data AS 
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", CAST("ADS_sca_2_OUT".scaler_output_2 AS DOUBLE) - 0.12850936110338088 AS scaler_output_2_0, CAST("ADS_sca_2_OUT".scaler_output_3 AS DOUBLE) - -0.5894853959123594 AS scaler_output_3_0, CAST("ADS_sca_2_OUT".scaler_output_4 AS DOUBLE) - -0.14801104071178056 AS scaler_output_4_0, CAST("ADS_sca_2_OUT".scaler_output_5 AS DOUBLE) - -0.4754829817195303 AS scaler_output_5_0, CAST("ADS_sca_2_OUT".scaler_output_6 AS DOUBLE) - 0.801905341367292 AS scaler_output_6_0, CAST("ADS_sca_2_OUT".scaler_output_7 AS DOUBLE) - -0.1991965192220112 AS scaler_output_7_0, CAST("ADS_sca_2_OUT".scaler_output_8 AS DOUBLE) - 0.4395182129547359 AS scaler_output_8_0, CAST("ADS_sca_2_OUT".scaler_output_9 AS DOUBLE) - 0.12340031909076317 AS scaler_output_9_0, CAST("ADS_sca_2_OUT".scaler_output_10 AS DOUBLE) - 0.40357025839170735 AS scaler_output_10_0, CAST("ADS_sca_2_OUT".scaler_output_11 AS DOUBLE) - 0.09870320795085713 AS scaler_output_11_0, CAST("ADS_sca_2_OUT".scaler_output_2 AS DOUBLE) - -0.05298699472844735 AS scaler_output_2_1, CAST("ADS_sca_2_OUT".scaler_output_3 AS DOUBLE) - 0.3605552729844554 AS scaler_output_3_1, CAST("ADS_sca_2_OUT".scaler_output_4 AS DOUBLE) - 0.7948406445641478 AS scaler_output_4_1, CAST("ADS_sca_2_OUT".scaler_output_5 AS DOUBLE) - 0.8936566583844016 AS scaler_output_5_1, CAST("ADS_sca_2_OUT".scaler_output_6 AS DOUBLE) - 0.16987435186219468 AS scaler_output_6_1, CAST("ADS_sca_2_OUT".scaler_output_7 AS DOUBLE) - -0.2786791750117442 AS scaler_output_7_1, CAST("ADS_sca_2_OUT".scaler_output_8 AS DOUBLE) - -0.8956718805550314 AS scaler_output_8_1, CAST("ADS_sca_2_OUT".scaler_output_9 AS DOUBLE) - 0.6738582822512323 AS scaler_output_9_1, CAST("ADS_sca_2_OUT".scaler_output_10 AS DOUBLE) - -0.20401263319909058 AS scaler_output_10_1, CAST("ADS_sca_2_OUT".scaler_output_11 AS DOUBLE) - -0.07083266262274268 AS scaler_output_11_1, CAST("ADS_sca_2_OUT".scaler_output_2 AS DOUBLE) - 0.045360401938138714 AS scaler_output_2_2, CAST("ADS_sca_2_OUT".scaler_output_3 AS DOUBLE) - -0.5876778050212879 AS scaler_output_3_2, CAST("ADS_sca_2_OUT".scaler_output_4 AS DOUBLE) - -0.7408138640905517 AS scaler_output_4_2, CAST("ADS_sca_2_OUT".scaler_output_5 AS DOUBLE) - -0.7306788392442229 AS scaler_output_5_2, CAST("ADS_sca_2_OUT".scaler_output_6 AS DOUBLE) - -0.35237818545821553 AS scaler_output_6_2, CAST("ADS_sca_2_OUT".scaler_output_7 AS DOUBLE) - 0.23356813470531584 AS scaler_output_7_2, CAST("ADS_sca_2_OUT".scaler_output_8 AS DOUBLE) - 0.6242019441344613 AS scaler_output_8_2, CAST("ADS_sca_2_OUT".scaler_output_9 AS DOUBLE) - -0.11725491493740212 AS scaler_output_9_2, CAST("ADS_sca_2_OUT".scaler_output_10 AS DOUBLE) - 0.2195369339288828 AS scaler_output_10_2, CAST("ADS_sca_2_OUT".scaler_output_11 AS DOUBLE) - 0.02765649597706878 AS scaler_output_11_2, CAST("ADS_sca_2_OUT".scaler_output_2 AS DOUBLE) - -0.09821075654794037 AS scaler_output_2_3, CAST("ADS_sca_2_OUT".scaler_output_3 AS DOUBLE) - 0.688781262143597 AS scaler_output_3_3, CAST("ADS_sca_2_OUT".scaler_output_4 AS DOUBLE) - 0.07198468742455133 AS scaler_output_4_3, CAST("ADS_sca_2_OUT".scaler_output_5 AS DOUBLE) - 0.24086987673399848 AS scaler_output_5_3, CAST("ADS_sca_2_OUT".scaler_output_6 AS DOUBLE) - -0.49019179421321984 AS scaler_output_6_3, CAST("ADS_sca_2_OUT".scaler_output_7 AS DOUBLE) - 0.20398900691476224 AS scaler_output_7_3, CAST("ADS_sca_2_OUT".scaler_output_8 AS DOUBLE) - -0.1128149593079018 AS scaler_output_8_3, CAST("ADS_sca_2_OUT".scaler_output_9 AS DOUBLE) - -0.6069669586322881 AS scaler_output_9_3, CAST("ADS_sca_2_OUT".scaler_output_10 AS DOUBLE) - -0.3443068484384806 AS scaler_output_10_3, CAST("ADS_sca_2_OUT".scaler_output_11 AS DOUBLE) - -0.04150610955463384 AS scaler_output_11_3 
FROM "TMP_20221018185155_G86JKSK_ADS_sca_2_OUT" AS "ADS_sca_2_OUT"), 
"NaiveBayes_data" AS 
...
FROM centered_data) AS "Values")
 INSERT INTO "TMP_20221018185155_QZUMXK3_NaiveBayes_Scores" ("KEY", "Score_0", "Score_1", "Score_2", "Score_3") SELECT "T"."KEY", "T"."Score_0", "T"."Score_1", "T"."Score_2", "T"."Score_3" 
...
-- Code For temporary table TMP_20221018185155_QZUMXK3_NaiveBayes_Scores part 3. Create Index 

CREATE INDEX "ix_TMP_20221018185155_QZUMXK3_NaiveBayes_Scores_KEY" ON "TMP_20221018185155_QZUMXK3_NaiveBayes_Scores" ("KEY")
...
FROM "TMP_20221018185155_QZUMXK3_NaiveBayes_Scores" AS "NaiveBayes_Scores"), 
