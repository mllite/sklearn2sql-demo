...
-- Code For temporary table TMP_20221018190525_ZQ2GYL7_ADS_imp_1_OUT part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221018190525_ZQ2GYL7_ADS_imp_1_OUT" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20221018190525_ZQ2GYL7_ADS_imp_1_OUT part 2. Populate

INSERT INTO "TMP_20221018190525_ZQ2GYL7_ADS_imp_1_OUT" ("KEY", imputer_output_2, imputer_output_3, imputer_output_4, imputer_output_5) SELECT "T"."KEY", "T".imputer_output_2, "T".imputer_output_3, "T".imputer_output_4, "T".imputer_output_5 
...
-- Code For temporary table TMP_20221018190525_ZQ2GYL7_ADS_imp_1_OUT part 3. Create Index 

CREATE INDEX "ix_TMP_20221018190525_ZQ2GYL7_ADS_imp_1_OUT_KEY" ON "TMP_20221018190525_ZQ2GYL7_ADS_imp_1_OUT" ("KEY")

-- Code For temporary table TMP_20221018190525_Y3ZMIXE_ADS_sca_2_OUT part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221018190525_Y3ZMIXE_ADS_sca_2_OUT" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20221018190525_Y3ZMIXE_ADS_sca_2_OUT part 2. Populate

INSERT INTO "TMP_20221018190525_Y3ZMIXE_ADS_sca_2_OUT" ("KEY", scaler_output_2, scaler_output_3, scaler_output_4, scaler_output_5) SELECT "T"."KEY", "T".scaler_output_2, "T".scaler_output_3, "T".scaler_output_4, "T".scaler_output_5 
...
FROM "TMP_20221018190525_ZQ2GYL7_ADS_imp_1_OUT" AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT") AS "T"

-- Code For temporary table TMP_20221018190525_Y3ZMIXE_ADS_sca_2_OUT part 3. Create Index 

CREATE INDEX "ix_TMP_20221018190525_Y3ZMIXE_ADS_sca_2_OUT_KEY" ON "TMP_20221018190525_Y3ZMIXE_ADS_sca_2_OUT" ("KEY")

-- Code For temporary table TMP_20221018190525_2B1EOKM_NaiveBayes_Scores part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221018190525_2B1EOKM_NaiveBayes_Scores" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20221018190525_2B1EOKM_NaiveBayes_Scores part 2. Populate

WITH centered_data AS 
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", CAST("ADS_sca_2_OUT".scaler_output_2 AS DOUBLE) - -1.0737587745357238 AS "scaler_output_2_1789-07-14T00:00:00.000000000", CAST("ADS_sca_2_OUT".scaler_output_3 AS DOUBLE) - 0.8854210158030993 AS "scaler_output_3_1789-07-14T00:00:00.000000000", CAST("ADS_sca_2_OUT".scaler_output_4 AS DOUBLE) - -1.379547087619958 AS "scaler_output_4_1789-07-14T00:00:00.000000000", CAST("ADS_sca_2_OUT".scaler_output_5 AS DOUBLE) - -1.3139198118632525 AS "scaler_output_5_1789-07-14T00:00:00.000000000", CAST("ADS_sca_2_OUT".scaler_output_2 AS DOUBLE) - 0.08161645102040865 AS "scaler_output_2_1789-08-14T00:00:00.000000000", CAST("ADS_sca_2_OUT".scaler_output_3 AS DOUBLE) - -0.6393881187264012 AS "scaler_output_3_1789-08-14T00:00:00.000000000", CAST("ADS_sca_2_OUT".scaler_output_4 AS DOUBLE) - 0.23427066076060687 AS "scaler_output_4_1789-08-14T00:00:00.000000000", CAST("ADS_sca_2_OUT".scaler_output_5 AS DOUBLE) - 0.10574534948367069 AS "scaler_output_5_1789-08-14T00:00:00.000000000", CAST("ADS_sca_2_OUT".scaler_output_2 AS DOUBLE) - 0.8480096887675768 AS "scaler_output_2_1789-09-14T00:00:00.000000000", CAST("ADS_sca_2_OUT".scaler_output_3 AS DOUBLE) - -0.16709425199205383 AS "scaler_output_3_1789-09-14T00:00:00.000000000", CAST("ADS_sca_2_OUT".scaler_output_4 AS DOUBLE) - 0.9691259491049802 AS "scaler_output_4_1789-09-14T00:00:00.000000000", CAST("ADS_sca_2_OUT".scaler_output_5 AS DOUBLE) - 1.032214396734732 AS "scaler_output_5_1789-09-14T00:00:00.000000000" 
FROM "TMP_20221018190525_Y3ZMIXE_ADS_sca_2_OUT" AS "ADS_sca_2_OUT"), 
"NaiveBayes_data" AS 
...
FROM centered_data) AS "Values")
 INSERT INTO "TMP_20221018190525_2B1EOKM_NaiveBayes_Scores" ("KEY", "Score_1789-07-14T00:00:00.000000000", "Score_1789-08-14T00:00:00.000000000", "Score_1789-09-14T00:00:00.000000000") SELECT "T"."KEY", "T"."Score_1789-07-14T00:00:00.000000000", "T"."Score_1789-08-14T00:00:00.000000000", "T"."Score_1789-09-14T00:00:00.000000000" 
...
-- Code For temporary table TMP_20221018190525_2B1EOKM_NaiveBayes_Scores part 3. Create Index 

CREATE INDEX "ix_TMP_20221018190525_2B1EOKM_NaiveBayes_Scores_KEY" ON "TMP_20221018190525_2B1EOKM_NaiveBayes_Scores" ("KEY")

-- Model deployment code

WITH orig_cte AS 
(SELECT "NaiveBayes_Scores"."KEY" AS "KEY", "NaiveBayes_Scores"."Score_1789-07-14T00:00:00.000000000" AS "Score_1789-07-14T00:00:00.000000000", "NaiveBayes_Scores"."Score_1789-08-14T00:00:00.000000000" AS "Score_1789-08-14T00:00:00.000000000", "NaiveBayes_Scores"."Score_1789-09-14T00:00:00.000000000" AS "Score_1789-09-14T00:00:00.000000000", CAST(NULL AS DOUBLE) AS "Proba_1789-07-14T00:00:00.000000000", CAST(NULL AS DOUBLE) AS "Proba_1789-08-14T00:00:00.000000000", CAST(NULL AS DOUBLE) AS "Proba_1789-09-14T00:00:00.000000000", CAST(NULL AS DOUBLE) AS "LogProba_1789-07-14T00:00:00.000000000", CAST(NULL AS DOUBLE) AS "LogProba_1789-08-14T00:00:00.000000000", CAST(NULL AS DOUBLE) AS "LogProba_1789-09-14T00:00:00.000000000", CAST(NULL AS BIGINT) AS "Decision", CAST(NULL AS DOUBLE) AS "DecisionProba" 
FROM "TMP_20221018190525_2B1EOKM_NaiveBayes_Scores" AS "NaiveBayes_Scores"), 
