...
-- Code For temporary table TMP_20221018190525_R2SCXEZ_ADS_imp_1_OUT part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221018190525_R2SCXEZ_ADS_imp_1_OUT" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20221018190525_R2SCXEZ_ADS_imp_1_OUT part 2. Populate

INSERT INTO "TMP_20221018190525_R2SCXEZ_ADS_imp_1_OUT" ("KEY", imputer_output_2, imputer_output_3, imputer_output_4, imputer_output_5) SELECT "T"."KEY", "T".imputer_output_2, "T".imputer_output_3, "T".imputer_output_4, "T".imputer_output_5 
...
-- Code For temporary table TMP_20221018190525_R2SCXEZ_ADS_imp_1_OUT part 3. Create Index 

CREATE INDEX "ix_TMP_20221018190525_R2SCXEZ_ADS_imp_1_OUT_KEY" ON "TMP_20221018190525_R2SCXEZ_ADS_imp_1_OUT" ("KEY")

-- Code For temporary table TMP_20221018190525_KZ6NG15_ADS_sca_2_OUT part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221018190525_KZ6NG15_ADS_sca_2_OUT" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20221018190525_KZ6NG15_ADS_sca_2_OUT part 2. Populate

INSERT INTO "TMP_20221018190525_KZ6NG15_ADS_sca_2_OUT" ("KEY", scaler_output_2, scaler_output_3, scaler_output_4, scaler_output_5) SELECT "T"."KEY", "T".scaler_output_2, "T".scaler_output_3, "T".scaler_output_4, "T".scaler_output_5 
...
FROM "TMP_20221018190525_R2SCXEZ_ADS_imp_1_OUT" AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT") AS "T"

-- Code For temporary table TMP_20221018190525_KZ6NG15_ADS_sca_2_OUT part 3. Create Index 

CREATE INDEX "ix_TMP_20221018190525_KZ6NG15_ADS_sca_2_OUT_KEY" ON "TMP_20221018190525_KZ6NG15_ADS_sca_2_OUT" ("KEY")

-- Code For temporary table TMP_20221018190525_ZT2GZL8_NaiveBayes_Scores part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221018190525_ZT2GZL8_NaiveBayes_Scores" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20221018190525_ZT2GZL8_NaiveBayes_Scores part 2. Populate

WITH centered_data AS 
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", CAST("ADS_sca_2_OUT".scaler_output_2 AS FLOAT) - -1.0737587745357238 AS "scaler_output_2_1789-07-14T00:00:00.000000000", CAST("ADS_sca_2_OUT".scaler_output_3 AS FLOAT) - 0.8854210158030993 AS "scaler_output_3_1789-07-14T00:00:00.000000000", CAST("ADS_sca_2_OUT".scaler_output_4 AS FLOAT) - -1.379547087619958 AS "scaler_output_4_1789-07-14T00:00:00.000000000", CAST("ADS_sca_2_OUT".scaler_output_5 AS FLOAT) - -1.3139198118632525 AS "scaler_output_5_1789-07-14T00:00:00.000000000", CAST("ADS_sca_2_OUT".scaler_output_2 AS FLOAT) - 0.08161645102040865 AS "scaler_output_2_1789-08-14T00:00:00.000000000", CAST("ADS_sca_2_OUT".scaler_output_3 AS FLOAT) - -0.6393881187264012 AS "scaler_output_3_1789-08-14T00:00:00.000000000", CAST("ADS_sca_2_OUT".scaler_output_4 AS FLOAT) - 0.23427066076060687 AS "scaler_output_4_1789-08-14T00:00:00.000000000", CAST("ADS_sca_2_OUT".scaler_output_5 AS FLOAT) - 0.10574534948367069 AS "scaler_output_5_1789-08-14T00:00:00.000000000", CAST("ADS_sca_2_OUT".scaler_output_2 AS FLOAT) - 0.8480096887675768 AS "scaler_output_2_1789-09-14T00:00:00.000000000", CAST("ADS_sca_2_OUT".scaler_output_3 AS FLOAT) - -0.16709425199205383 AS "scaler_output_3_1789-09-14T00:00:00.000000000", CAST("ADS_sca_2_OUT".scaler_output_4 AS FLOAT) - 0.9691259491049802 AS "scaler_output_4_1789-09-14T00:00:00.000000000", CAST("ADS_sca_2_OUT".scaler_output_5 AS FLOAT) - 1.032214396734732 AS "scaler_output_5_1789-09-14T00:00:00.000000000" 
FROM "TMP_20221018190525_KZ6NG15_ADS_sca_2_OUT" AS "ADS_sca_2_OUT"), 
"NaiveBayes_data" AS 
(SELECT "Values"."KEY" AS "KEY", "Values"."Feature" AS "Feature", "Values"."log_proba_1789-07-14T00:00:00.000000000" AS "log_proba_1789-07-14T00:00:00.000000000", "Values"."log_proba_1789-08-14T00:00:00.000000000" AS "log_proba_1789-08-14T00:00:00.000000000", "Values"."log_proba_1789-09-14T00:00:00.000000000" AS "log_proba_1789-09-14T00:00:00.000000000" 
...
FROM centered_data UNION ALL SELECT centered_data."KEY" AS "KEY", 1 AS "Feature", -0.5 * 1.5911640207454638 - (0.5 * centered_data."scaler_output_3_1789-07-14T00:00:00.000000000" * centered_data."scaler_output_3_1789-07-14T00:00:00.000000000") / 0.7813648774042327 AS "log_proba_1789-07-14T00:00:00.000000000", -0.5 * 1.2568272234475182 - (0.5 * centered_data."scaler_output_3_1789-08-14T00:00:00.000000000" * centered_data."scaler_output_3_1789-08-14T00:00:00.000000000") / 0.5593108696496359 AS "log_proba_1789-08-14T00:00:00.000000000", -0.5 * 1.1748256088528184 - (0.5 * centered_data."scaler_output_3_1789-09-14T00:00:00.000000000" * centered_data."scaler_output_3_1789-09-14T00:00:00.000000000") / 0.515276588438758 AS "log_proba_1789-09-14T00:00:00.000000000" 
FROM centered_data UNION ALL SELECT centered_data."KEY" AS "KEY", 2 AS "Feature", -0.5 * -2.856955302621188 - (0.5 * centered_data."scaler_output_4_1789-07-14T00:00:00.000000000" * centered_data."scaler_output_4_1789-07-14T00:00:00.000000000") / 0.00914239978878576 AS "log_proba_1789-07-14T00:00:00.000000000", -0.5 * -0.7060447854085655 - (0.5 * centered_data."scaler_output_4_1789-08-14T00:00:00.000000000" * centered_data."scaler_output_4_1789-08-14T00:00:00.000000000") / 0.07855770318412734 AS "log_proba_1789-08-14T00:00:00.000000000", -0.5 * -0.6643684887889371 - (0.5 * centered_data."scaler_output_4_1789-09-14T00:00:00.000000000" * centered_data."scaler_output_4_1789-09-14T00:00:00.000000000") / 0.08190087903126093 AS "log_proba_1789-09-14T00:00:00.000000000" 
FROM centered_data UNION ALL SELECT centered_data."KEY" AS "KEY", 3 AS "Feature", -0.5 * -1.9992200116148338 - (0.5 * centered_data."scaler_output_5_1789-07-14T00:00:00.000000000" * centered_data."scaler_output_5_1789-07-14T00:00:00.000000000") / 0.021556086243286397 AS "log_proba_1789-07-14T00:00:00.000000000", -0.5 * -0.7443626223673354 - (0.5 * centered_data."scaler_output_5_1789-08-14T00:00:00.000000000" * centered_data."scaler_output_5_1789-08-14T00:00:00.000000000") / 0.07560448374366707 AS "log_proba_1789-08-14T00:00:00.000000000", -0.5 * -0.1249777738360839 - (0.5 * centered_data."scaler_output_5_1789-09-14T00:00:00.000000000" * centered_data."scaler_output_5_1789-09-14T00:00:00.000000000") / 0.14045686609226135 AS "log_proba_1789-09-14T00:00:00.000000000" 
FROM centered_data) AS "Values")
 INSERT INTO "TMP_20221018190525_ZT2GZL8_NaiveBayes_Scores" ("KEY", "Score_1789-07-14T00:00:00.000000000", "Score_1789-08-14T00:00:00.000000000", "Score_1789-09-14T00:00:00.000000000") SELECT "T"."KEY", "T"."Score_1789-07-14T00:00:00.000000000", "T"."Score_1789-08-14T00:00:00.000000000", "T"."Score_1789-09-14T00:00:00.000000000" 
FROM (SELECT "NaiveBayes_Scores"."KEY" AS "KEY", "NaiveBayes_Scores"."Score_1789-07-14T00:00:00.000000000" AS "Score_1789-07-14T00:00:00.000000000", "NaiveBayes_Scores"."Score_1789-08-14T00:00:00.000000000" AS "Score_1789-08-14T00:00:00.000000000", "NaiveBayes_Scores"."Score_1789-09-14T00:00:00.000000000" AS "Score_1789-09-14T00:00:00.000000000" 
FROM (SELECT nb_sums."KEY" AS "KEY", nb_sums."Score_1789-07-14T00:00:00.000000000" AS "Score_1789-07-14T00:00:00.000000000", nb_sums."Score_1789-08-14T00:00:00.000000000" AS "Score_1789-08-14T00:00:00.000000000", nb_sums."Score_1789-09-14T00:00:00.000000000" AS "Score_1789-09-14T00:00:00.000000000" 
...
-- Code For temporary table TMP_20221018190525_ZT2GZL8_NaiveBayes_Scores part 3. Create Index 

CREATE INDEX "ix_TMP_20221018190525_ZT2GZL8_NaiveBayes_Scores_KEY" ON "TMP_20221018190525_ZT2GZL8_NaiveBayes_Scores" ("KEY")

-- Model deployment code

WITH orig_cte AS 
(SELECT "NaiveBayes_Scores"."KEY" AS "KEY", "NaiveBayes_Scores"."Score_1789-07-14T00:00:00.000000000" AS "Score_1789-07-14T00:00:00.000000000", "NaiveBayes_Scores"."Score_1789-08-14T00:00:00.000000000" AS "Score_1789-08-14T00:00:00.000000000", "NaiveBayes_Scores"."Score_1789-09-14T00:00:00.000000000" AS "Score_1789-09-14T00:00:00.000000000", CAST(NULL AS FLOAT) AS "Proba_1789-07-14T00:00:00.000000000", CAST(NULL AS FLOAT) AS "Proba_1789-08-14T00:00:00.000000000", CAST(NULL AS FLOAT) AS "Proba_1789-09-14T00:00:00.000000000", CAST(NULL AS FLOAT) AS "LogProba_1789-07-14T00:00:00.000000000", CAST(NULL AS FLOAT) AS "LogProba_1789-08-14T00:00:00.000000000", CAST(NULL AS FLOAT) AS "LogProba_1789-09-14T00:00:00.000000000", CAST(NULL AS BIGINT) AS "Decision", CAST(NULL AS FLOAT) AS "DecisionProba" 
FROM "TMP_20221018190525_ZT2GZL8_NaiveBayes_Scores" AS "NaiveBayes_Scores"), 
