...
-- Code For temporary table TMP_20221018190413_KMAFOTX_ADS_imp_1_OUT part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221018190413_KMAFOTX_ADS_imp_1_OUT" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20221018190413_KMAFOTX_ADS_imp_1_OUT part 2. Populate

INSERT INTO "TMP_20221018190413_KMAFOTX_ADS_imp_1_OUT" ("KEY", imputer_output_2, imputer_output_3, imputer_output_4, imputer_output_5) SELECT "T"."KEY", "T".imputer_output_2, "T".imputer_output_3, "T".imputer_output_4, "T".imputer_output_5 
...
-- Code For temporary table TMP_20221018190413_KMAFOTX_ADS_imp_1_OUT part 3. Create Index 

CREATE INDEX "ix_TMP_20221018190413_KMAFOTX_ADS_imp_1_OUT_KEY" ON "TMP_20221018190413_KMAFOTX_ADS_imp_1_OUT" ("KEY")

-- Code For temporary table TMP_20221018190413_Y48YMOP_ADS_sca_2_OUT part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221018190413_Y48YMOP_ADS_sca_2_OUT" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20221018190413_Y48YMOP_ADS_sca_2_OUT part 2. Populate

INSERT INTO "TMP_20221018190413_Y48YMOP_ADS_sca_2_OUT" ("KEY", scaler_output_2, scaler_output_3, scaler_output_4, scaler_output_5) SELECT "T"."KEY", "T".scaler_output_2, "T".scaler_output_3, "T".scaler_output_4, "T".scaler_output_5 
...
FROM "TMP_20221018190413_KMAFOTX_ADS_imp_1_OUT" AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT") AS "T"

-- Code For temporary table TMP_20221018190413_Y48YMOP_ADS_sca_2_OUT part 3. Create Index 

CREATE INDEX "ix_TMP_20221018190413_Y48YMOP_ADS_sca_2_OUT_KEY" ON "TMP_20221018190413_Y48YMOP_ADS_sca_2_OUT" ("KEY")

-- Code For temporary table TMP_20221018190413_PGRAYXT_NaiveBayes_Scores part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221018190413_PGRAYXT_NaiveBayes_Scores" (
	"KEY" BIGINT NOT NULL, 
	"Score_0" FLOAT, 
	"Score_1" FLOAT, 
	"Score_2" FLOAT, 
...
-- Code For temporary table TMP_20221018190413_PGRAYXT_NaiveBayes_Scores part 2. Populate

WITH centered_data AS 
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", CAST("ADS_sca_2_OUT".scaler_output_2 AS FLOAT) - -1.0737587745357238 AS scaler_output_2_0, CAST("ADS_sca_2_OUT".scaler_output_3 AS FLOAT) - 0.8854210158030993 AS scaler_output_3_0, CAST("ADS_sca_2_OUT".scaler_output_4 AS FLOAT) - -1.379547087619958 AS scaler_output_4_0, CAST("ADS_sca_2_OUT".scaler_output_5 AS FLOAT) - -1.3139198118632525 AS scaler_output_5_0, CAST("ADS_sca_2_OUT".scaler_output_2 AS FLOAT) - 0.08161645102040865 AS scaler_output_2_1, CAST("ADS_sca_2_OUT".scaler_output_3 AS FLOAT) - -0.6393881187264012 AS scaler_output_3_1, CAST("ADS_sca_2_OUT".scaler_output_4 AS FLOAT) - 0.23427066076060687 AS scaler_output_4_1, CAST("ADS_sca_2_OUT".scaler_output_5 AS FLOAT) - 0.10574534948367069 AS scaler_output_5_1, CAST("ADS_sca_2_OUT".scaler_output_2 AS FLOAT) - 0.8480096887675768 AS scaler_output_2_2, CAST("ADS_sca_2_OUT".scaler_output_3 AS FLOAT) - -0.16709425199205383 AS scaler_output_3_2, CAST("ADS_sca_2_OUT".scaler_output_4 AS FLOAT) - 0.9691259491049802 AS scaler_output_4_2, CAST("ADS_sca_2_OUT".scaler_output_5 AS FLOAT) - 1.032214396734732 AS scaler_output_5_2 
FROM "TMP_20221018190413_Y48YMOP_ADS_sca_2_OUT" AS "ADS_sca_2_OUT"), 
"NaiveBayes_data" AS 
...
FROM centered_data) AS "Values")
 INSERT INTO "TMP_20221018190413_PGRAYXT_NaiveBayes_Scores" ("KEY", "Score_0", "Score_1", "Score_2") SELECT "T"."KEY", "T"."Score_0", "T"."Score_1", "T"."Score_2" 
...
-- Code For temporary table TMP_20221018190413_PGRAYXT_NaiveBayes_Scores part 3. Create Index 

CREATE INDEX "ix_TMP_20221018190413_PGRAYXT_NaiveBayes_Scores_KEY" ON "TMP_20221018190413_PGRAYXT_NaiveBayes_Scores" ("KEY")
...
FROM "TMP_20221018190413_PGRAYXT_NaiveBayes_Scores" AS "NaiveBayes_Scores"), 
