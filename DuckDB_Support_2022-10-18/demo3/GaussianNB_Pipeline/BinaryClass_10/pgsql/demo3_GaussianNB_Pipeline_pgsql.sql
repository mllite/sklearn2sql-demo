...
-- Code For temporary table TMP_20221018184822_9JR0BB2_ADS_imp_1_OUT part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221018184822_9JR0BB2_ADS_imp_1_OUT" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20221018184822_9JR0BB2_ADS_imp_1_OUT part 3. Create Index 

CREATE INDEX "ix_TMP_20221018184822_9JR0BB2_ADS_imp_1_OUT_KEY" ON "TMP_20221018184822_9JR0BB2_ADS_imp_1_OUT" ("KEY")

-- Code For temporary table TMP_20221018184822_URH62Q3_ADS_sca_2_OUT part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221018184822_URH62Q3_ADS_sca_2_OUT" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20221018184822_URH62Q3_ADS_sca_2_OUT part 2. Populate

INSERT INTO "TMP_20221018184822_URH62Q3_ADS_sca_2_OUT" ("KEY", scaler_output_2, scaler_output_3, scaler_output_4, scaler_output_5, scaler_output_6, scaler_output_7, scaler_output_8, scaler_output_9, scaler_output_10, scaler_output_11) SELECT "T"."KEY", "T".scaler_output_2, "T".scaler_output_3, "T".scaler_output_4, "T".scaler_output_5, "T".scaler_output_6, "T".scaler_output_7, "T".scaler_output_8, "T".scaler_output_9, "T".scaler_output_10, "T".scaler_output_11 
...
FROM "TMP_20221018184822_9JR0BB2_ADS_imp_1_OUT" AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT") AS "T"

-- Code For temporary table TMP_20221018184822_URH62Q3_ADS_sca_2_OUT part 3. Create Index 

CREATE INDEX "ix_TMP_20221018184822_URH62Q3_ADS_sca_2_OUT_KEY" ON "TMP_20221018184822_URH62Q3_ADS_sca_2_OUT" ("KEY")

-- Code For temporary table TMP_20221018184822_QJBAK2S_NaiveBayes_Scores part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221018184822_QJBAK2S_NaiveBayes_Scores" (
	"KEY" BIGINT NOT NULL, 
	"Score_0" FLOAT, 
	"Score_1" FLOAT, 
	PRIMARY KEY ("KEY")
...
-- Code For temporary table TMP_20221018184822_QJBAK2S_NaiveBayes_Scores part 2. Populate

WITH centered_data AS 
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", CAST("ADS_sca_2_OUT".scaler_output_2 AS FLOAT) - 0.6608885522985145 AS scaler_output_2_0, CAST("ADS_sca_2_OUT".scaler_output_3 AS FLOAT) - 0.05011958986810387 AS scaler_output_3_0, CAST("ADS_sca_2_OUT".scaler_output_4 AS FLOAT) - 0.010237135493869304 AS scaler_output_4_0, CAST("ADS_sca_2_OUT".scaler_output_5 AS FLOAT) - -0.1134260581927905 AS scaler_output_5_0, CAST("ADS_sca_2_OUT".scaler_output_6 AS FLOAT) - 0.091931902073065 AS scaler_output_6_0, CAST("ADS_sca_2_OUT".scaler_output_7 AS FLOAT) - 0.026957993139275754 AS scaler_output_7_0, CAST("ADS_sca_2_OUT".scaler_output_8 AS FLOAT) - 0.19931034565274267 AS scaler_output_8_0, CAST("ADS_sca_2_OUT".scaler_output_9 AS FLOAT) - 0.6831306672271085 AS scaler_output_9_0, CAST("ADS_sca_2_OUT".scaler_output_10 AS FLOAT) - -0.05290181072678812 AS scaler_output_10_0, CAST("ADS_sca_2_OUT".scaler_output_11 AS FLOAT) - -0.6905707153132041 AS scaler_output_11_0, CAST("ADS_sca_2_OUT".scaler_output_2 AS FLOAT) - -0.6608885522985144 AS scaler_output_2_1, CAST("ADS_sca_2_OUT".scaler_output_3 AS FLOAT) - -0.05011958986810381 AS scaler_output_3_1, CAST("ADS_sca_2_OUT".scaler_output_4 AS FLOAT) - -0.010237135493869402 AS scaler_output_4_1, CAST("ADS_sca_2_OUT".scaler_output_5 AS FLOAT) - 0.11342605819279053 AS scaler_output_5_1, CAST("ADS_sca_2_OUT".scaler_output_6 AS FLOAT) - -0.09193190207306502 AS scaler_output_6_1, CAST("ADS_sca_2_OUT".scaler_output_7 AS FLOAT) - -0.02695799313927582 AS scaler_output_7_1, CAST("ADS_sca_2_OUT".scaler_output_8 AS FLOAT) - -0.19931034565274264 AS scaler_output_8_1, CAST("ADS_sca_2_OUT".scaler_output_9 AS FLOAT) - -0.6831306672271085 AS scaler_output_9_1, CAST("ADS_sca_2_OUT".scaler_output_10 AS FLOAT) - 0.05290181072678807 AS scaler_output_10_1, CAST("ADS_sca_2_OUT".scaler_output_11 AS FLOAT) - 0.6905707153132041 AS scaler_output_11_1 
FROM "TMP_20221018184822_URH62Q3_ADS_sca_2_OUT" AS "ADS_sca_2_OUT"), 
"NaiveBayes_data" AS 
...
FROM centered_data) AS "Values")
 INSERT INTO "TMP_20221018184822_QJBAK2S_NaiveBayes_Scores" ("KEY", "Score_0", "Score_1") SELECT "T"."KEY", "T"."Score_0", "T"."Score_1" 
...
-- Code For temporary table TMP_20221018184822_QJBAK2S_NaiveBayes_Scores part 3. Create Index 

CREATE INDEX "ix_TMP_20221018184822_QJBAK2S_NaiveBayes_Scores_KEY" ON "TMP_20221018184822_QJBAK2S_NaiveBayes_Scores" ("KEY")
...
FROM "TMP_20221018184822_QJBAK2S_NaiveBayes_Scores" AS "NaiveBayes_Scores"), 
