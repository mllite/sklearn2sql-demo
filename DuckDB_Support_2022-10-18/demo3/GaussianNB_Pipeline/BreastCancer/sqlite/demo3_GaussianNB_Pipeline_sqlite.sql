...
-- Code For temporary table TMP_20221018185046_OCEJBP4_ADS_imp_1_OUT part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221018185046_OCEJBP4_ADS_imp_1_OUT" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20221018185046_OCEJBP4_ADS_imp_1_OUT part 3. Create Index 

CREATE INDEX "ix_TMP_20221018185046_OCEJBP4_ADS_imp_1_OUT_KEY" ON "TMP_20221018185046_OCEJBP4_ADS_imp_1_OUT" ("KEY")

-- Code For temporary table TMP_20221018185046_TZXDAJR_ADS_sca_2_OUT part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221018185046_TZXDAJR_ADS_sca_2_OUT" (
	"KEY" BIGINT NOT NULL, 
...
FROM "TMP_20221018185046_OCEJBP4_ADS_imp_1_OUT" AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT") AS "T"

-- Code For temporary table TMP_20221018185046_TZXDAJR_ADS_sca_2_OUT part 3. Create Index 

CREATE INDEX "ix_TMP_20221018185046_TZXDAJR_ADS_sca_2_OUT_KEY" ON "TMP_20221018185046_TZXDAJR_ADS_sca_2_OUT" ("KEY")

-- Code For temporary table TMP_20221018185046_J651JSG_NaiveBayes_Scores part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221018185046_J651JSG_NaiveBayes_Scores" (
	"KEY" BIGINT NOT NULL, 
	"Score_0" FLOAT, 
	"Score_1" FLOAT, 
	PRIMARY KEY ("KEY")
...
-- Code For temporary table TMP_20221018185046_J651JSG_NaiveBayes_Scores part 2. Populate

WITH centered_data AS 
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", CAST("ADS_sca_2_OUT".scaler_output_2 AS FLOAT) - 1.0049577921568156 AS scaler_output_2_0, CAST("ADS_sca_2_OUT".scaler_output_3 AS FLOAT) - 0.5272347157440817 AS scaler_output_3_0, CAST("ADS_sca_2_OUT".scaler_output_4 AS FLOAT) - 1.0224656573233908 AS scaler_output_4_0, CAST("ADS_sca_2_OUT".scaler_output_5 AS FLOAT) - 0.9755487167792978 AS scaler_output_5_0, CAST("ADS_sca_2_OUT".scaler_output_6 AS FLOAT) - 0.5109783768435309 AS scaler_output_6_0, CAST("ADS_sca_2_OUT".scaler_output_7 AS FLOAT) - 0.8454996589862851 AS scaler_output_7_0, CAST("ADS_sca_2_OUT".scaler_output_8 AS FLOAT) - 0.9501566820680749 AS scaler_output_8_0, CAST("ADS_sca_2_OUT".scaler_output_9 AS FLOAT) - 1.079373194450925 AS scaler_output_9_0, CAST("ADS_sca_2_OUT".scaler_output_10 AS FLOAT) - 0.4804840066713879 AS scaler_output_10_0, CAST("ADS_sca_2_OUT".scaler_output_11 AS FLOAT) - 0.008254648911233958 AS scaler_output_11_0, CAST("ADS_sca_2_OUT".scaler_output_12 AS FLOAT) - 0.7963129136236985 AS scaler_output_12_0, CAST("ADS_sca_2_OUT".scaler_output_13 AS FLOAT) - 0.025859092767011576 AS scaler_output_13_0, CAST("ADS_sca_2_OUT".scaler_output_14 AS FLOAT) - 0.7829342356917925 AS scaler_output_14_0, CAST("ADS_sca_2_OUT".scaler_output_15 AS FLOAT) - 0.7527459637163599 AS scaler_output_15_0, CAST("ADS_sca_2_OUT".scaler_output_16 AS FLOAT) - -0.07879019714350678 AS scaler_output_16_0, CAST("ADS_sca_2_OUT".scaler_output_17 AS FLOAT) - 0.41895691591652995 AS scaler_output_17_0, CAST("ADS_sca_2_OUT".scaler_output_18 AS FLOAT) - 0.32372735579628725 AS scaler_output_18_0, CAST("ADS_sca_2_OUT".scaler_output_19 AS FLOAT) - 0.5778838844193583 AS scaler_output_19_0, CAST("ADS_sca_2_OUT".scaler_output_20 AS FLOAT) - 0.05466531696521439 AS scaler_output_20_0, CAST("ADS_sca_2_OUT".scaler_output_21 AS FLOAT) - 0.10668595002277066 AS scaler_output_21_0, CAST("ADS_sca_2_OUT".scaler_output_22 AS FLOAT) - 1.0714383582224667 AS scaler_output_22_0, CAST("ADS_sca_2_OUT".scaler_output_23 AS FLOAT) - 0.5811783181481854 AS scaler_output_23_0, CAST("ADS_sca_2_OUT".scaler_output_24 AS FLOAT) - 1.0800043767778378 AS scaler_output_24_0, CAST("ADS_sca_2_OUT".scaler_output_25 AS FLOAT) - 1.0129008849222247 AS scaler_output_25_0, CAST("ADS_sca_2_OUT".scaler_output_26 AS FLOAT) - 0.5815788803349367 AS scaler_output_26_0, CAST("ADS_sca_2_OUT".scaler_output_27 AS FLOAT) - 0.8321432517733914 AS scaler_output_27_0, CAST("ADS_sca_2_OUT".scaler_output_28 AS FLOAT) - 0.8907311579327978 AS scaler_output_28_0, CAST("ADS_sca_2_OUT".scaler_output_29 AS FLOAT) - 1.097339665184901 AS scaler_output_29_0, CAST("ADS_sca_2_OUT".scaler_output_30 AS FLOAT) - 0.5790457036351542 AS scaler_output_30_0, CAST("ADS_sca_2_OUT".scaler_output_31 AS FLOAT) - 0.44698120583557815 AS scaler_output_31_0, CAST("ADS_sca_2_OUT".scaler_output_2 AS FLOAT) - -0.5450618533731864 AS scaler_output_2_1, CAST("ADS_sca_2_OUT".scaler_output_3 AS FLOAT) - -0.2859578119289954 AS scaler_output_3_1, CAST("ADS_sca_2_OUT".scaler_output_4 AS FLOAT) - -0.5545576446499755 AS scaler_output_4_1, CAST("ADS_sca_2_OUT".scaler_output_5 AS FLOAT) - -0.5291111684226707 AS scaler_output_5_1, CAST("ADS_sca_2_OUT".scaler_output_6 AS FLOAT) - -0.2771408145592028 AS scaler_output_6_1, CAST("ADS_sca_2_OUT".scaler_output_7 AS FLOAT) - -0.45857608622985074 AS scaler_output_7_1, CAST("ADS_sca_2_OUT".scaler_output_8 AS FLOAT) - -0.5153392173928566 AS scaler_output_8_1, CAST("ADS_sca_2_OUT".scaler_output_9 AS FLOAT) - -0.5854227495327037 AS scaler_output_9_1, CAST("ADS_sca_2_OUT".scaler_output_10 AS FLOAT) - -0.26060149514380665 AS scaler_output_10_1, CAST("ADS_sca_2_OUT".scaler_output_11 AS FLOAT) - -0.004477097714565806 AS scaler_output_11_1, CAST("ADS_sca_2_OUT".scaler_output_12 AS FLOAT) - -0.4318985294230235 AS scaler_output_12_1, CAST("ADS_sca_2_OUT".scaler_output_13 AS FLOAT) - -0.014025270653293244 AS scaler_output_13_1, CAST("ADS_sca_2_OUT".scaler_output_14 AS FLOAT) - -0.4246422973243612 AS scaler_output_14_1, CAST("ADS_sca_2_OUT".scaler_output_15 AS FLOAT) - -0.40826899726989013 AS scaler_output_15_1, CAST("ADS_sca_2_OUT".scaler_output_16 AS FLOAT) - 0.04273366624732332 AS scaler_output_16_1, CAST("ADS_sca_2_OUT".scaler_output_17 AS FLOAT) - -0.22723086964964412 AS scaler_output_17_1, CAST("ADS_sca_2_OUT".scaler_output_18 AS FLOAT) - -0.17558093873696776 AS scaler_output_18_1, CAST("ADS_sca_2_OUT".scaler_output_19 AS FLOAT) - -0.31342854748168736 AS scaler_output_19_1, CAST("ADS_sca_2_OUT".scaler_output_20 AS FLOAT) - -0.029648985472661257 AS scaler_output_20_1, CAST("ADS_sca_2_OUT".scaler_output_21 AS FLOAT) - -0.057863566114043155 AS scaler_output_21_1, CAST("ADS_sca_2_OUT".scaler_output_22 AS FLOAT) - -0.5811191095443907 AS scaler_output_22_1, CAST("ADS_sca_2_OUT".scaler_output_23 AS FLOAT) - -0.3152153589956243 AS scaler_output_23_1, CAST("ADS_sca_2_OUT".scaler_output_24 AS FLOAT) - -0.5857650857100123 AS scaler_output_24_1, CAST("ADS_sca_2_OUT".scaler_output_25 AS FLOAT) - -0.5493699714832421 AS scaler_output_25_1, CAST("ADS_sca_2_OUT".scaler_output_26 AS FLOAT) - -0.315432613063021 AS scaler_output_26_1, CAST("ADS_sca_2_OUT".scaler_output_27 AS FLOAT) - -0.45133193316522807 AS scaler_output_27_1, CAST("ADS_sca_2_OUT".scaler_output_28 AS FLOAT) - -0.4831084246415161 AS scaler_output_28_1, CAST("ADS_sca_2_OUT".scaler_output_29 AS FLOAT) - -0.5951672760324885 AS scaler_output_29_1, CAST("ADS_sca_2_OUT".scaler_output_30 AS FLOAT) - -0.31405868671737264 AS scaler_output_30_1, CAST("ADS_sca_2_OUT".scaler_output_31 AS FLOAT) - -0.2424304845209864 AS scaler_output_31_1 
FROM "TMP_20221018185046_TZXDAJR_ADS_sca_2_OUT" AS "ADS_sca_2_OUT"), 
"NaiveBayes_data" AS 
...
FROM centered_data) AS "Values")
 INSERT INTO "TMP_20221018185046_J651JSG_NaiveBayes_Scores" ("KEY", "Score_0", "Score_1") SELECT "T"."KEY", "T"."Score_0", "T"."Score_1" 
...
-- Code For temporary table TMP_20221018185046_J651JSG_NaiveBayes_Scores part 3. Create Index 

CREATE INDEX "ix_TMP_20221018185046_J651JSG_NaiveBayes_Scores_KEY" ON "TMP_20221018185046_J651JSG_NaiveBayes_Scores" ("KEY")
...
FROM "TMP_20221018185046_J651JSG_NaiveBayes_Scores" AS "NaiveBayes_Scores"), 
