...
-- Code For temporary table TMP_20221018185046_4ISWDOK_ADS_imp_1_OUT part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221018185046_4ISWDOK_ADS_imp_1_OUT" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20221018185046_4ISWDOK_ADS_imp_1_OUT part 3. Create Index 

CREATE INDEX "ix_TMP_20221018185046_4ISWDOK_ADS_imp_1_OUT_KEY" ON "TMP_20221018185046_4ISWDOK_ADS_imp_1_OUT" ("KEY")

-- Code For temporary table TMP_20221018185046_S1302T8_ADS_sca_2_OUT part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221018185046_S1302T8_ADS_sca_2_OUT" (
	"KEY" BIGINT NOT NULL, 
...
FROM "TMP_20221018185046_4ISWDOK_ADS_imp_1_OUT" AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT") AS "T"

-- Code For temporary table TMP_20221018185046_S1302T8_ADS_sca_2_OUT part 3. Create Index 

CREATE INDEX "ix_TMP_20221018185046_S1302T8_ADS_sca_2_OUT_KEY" ON "TMP_20221018185046_S1302T8_ADS_sca_2_OUT" ("KEY")

-- Code For temporary table TMP_20221018185046_EIP7QPF_NaiveBayes_Scores part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221018185046_EIP7QPF_NaiveBayes_Scores" (
	"KEY" BIGINT NOT NULL, 
	"Score_0" FLOAT, 
	"Score_1" FLOAT, 
	PRIMARY KEY ("KEY")
...
-- Code For temporary table TMP_20221018185046_EIP7QPF_NaiveBayes_Scores part 2. Populate
...
FROM "TMP_20221018185046_S1302T8_ADS_sca_2_OUT" AS "ADS_sca_2_OUT"), 
"NaiveBayes_data" AS 
...
FROM centered_data) AS "Values")
 INSERT INTO "TMP_20221018185046_EIP7QPF_NaiveBayes_Scores" ("KEY", "Score_0", "Score_1") SELECT "T"."KEY", "T"."Score_0", "T"."Score_1" 
...
-- Code For temporary table TMP_20221018185046_EIP7QPF_NaiveBayes_Scores part 3. Create Index 

CREATE INDEX "ix_TMP_20221018185046_EIP7QPF_NaiveBayes_Scores_KEY" ON "TMP_20221018185046_EIP7QPF_NaiveBayes_Scores" ("KEY")
...
FROM "TMP_20221018185046_EIP7QPF_NaiveBayes_Scores" AS "NaiveBayes_Scores"), 
