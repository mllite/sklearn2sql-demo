...
-- Code For temporary table TMP_20221018185110_P9WVCA5_ADS_imp_1_OUT part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221018185110_P9WVCA5_ADS_imp_1_OUT" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20221018185110_P9WVCA5_ADS_imp_1_OUT part 3. Create Index 

CREATE INDEX "ix_TMP_20221018185110_P9WVCA5_ADS_imp_1_OUT_KEY" ON "TMP_20221018185110_P9WVCA5_ADS_imp_1_OUT" ("KEY")

-- Code For temporary table TMP_20221018185110_BTDPUQW_ADS_sca_2_OUT part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221018185110_BTDPUQW_ADS_sca_2_OUT" (
	"KEY" BIGINT NOT NULL, 
...
FROM "TMP_20221018185110_P9WVCA5_ADS_imp_1_OUT" AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT") AS "T"

-- Code For temporary table TMP_20221018185110_BTDPUQW_ADS_sca_2_OUT part 3. Create Index 

CREATE INDEX "ix_TMP_20221018185110_BTDPUQW_ADS_sca_2_OUT_KEY" ON "TMP_20221018185110_BTDPUQW_ADS_sca_2_OUT" ("KEY")
...
FROM "TMP_20221018185110_BTDPUQW_ADS_sca_2_OUT" AS "ADS_sca_2_OUT"), 
linear_model_cte AS 
(SELECT linear_input."KEY" AS "KEY", -5.227123781718718 * linear_input.scaler_output_2 + -5.379414538252818 * linear_input.scaler_output_3 + -4.844055954226589 * linear_input.scaler_output_4 + -6.605997394925096 * linear_input.scaler_output_5 + 2.776162590821608 * linear_input.scaler_output_6 + 1.9022163321307584 * linear_input.scaler_output_7 + -12.825126475461266 * linear_input.scaler_output_8 + -17.360357289138765 * linear_input.scaler_output_9 + -2.457130984503153 * linear_input.scaler_output_10 + -1.3001145678393569 * linear_input.scaler_output_11 + -21.28993546865268 * linear_input.scaler_output_12 + 0.2903238675804095 * linear_input.scaler_output_13 + -11.905424394266426 * linear_input.scaler_output_14 + -13.955425810025083 * linear_input.scaler_output_15 + 1.620750958789274 * linear_input.scaler_output_16 + 9.852696791074653 * linear_input.scaler_output_17 + 15.741519926620139 * linear_input.scaler_output_18 + -6.76232291290091 * linear_input.scaler_output_19 + -6.166905701536225 * linear_input.scaler_output_20 + 8.4149385937308 * linear_input.scaler_output_21 + -9.674048872456245 * linear_input.scaler_output_22 + -9.333660424426723 * linear_input.scaler_output_23 + -6.955735272267882 * linear_input.scaler_output_24 + -9.156503619281237 * linear_input.scaler_output_25 + -3.842956143092201 * linear_input.scaler_output_26 + -2.1976710044328835 * linear_input.scaler_output_27 + -12.802185196618689 * linear_input.scaler_output_28 + -11.750495496991546 * linear_input.scaler_output_29 + -8.614885352149676 * linear_input.scaler_output_30 + -1.4373062816088369 * linear_input.scaler_output_31 + 5.292551684170127 AS lincomb 
FROM linear_input), 
