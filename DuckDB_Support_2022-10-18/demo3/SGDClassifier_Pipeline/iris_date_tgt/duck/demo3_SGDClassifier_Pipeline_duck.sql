...
-- Code For temporary table TMP_20221018190550_VLG6B07_ADS_imp_1_OUT part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221018190550_VLG6B07_ADS_imp_1_OUT" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20221018190550_VLG6B07_ADS_imp_1_OUT part 2. Populate

INSERT INTO "TMP_20221018190550_VLG6B07_ADS_imp_1_OUT" ("KEY", imputer_output_2, imputer_output_3, imputer_output_4, imputer_output_5) SELECT "T"."KEY", "T".imputer_output_2, "T".imputer_output_3, "T".imputer_output_4, "T".imputer_output_5 
...
-- Code For temporary table TMP_20221018190550_VLG6B07_ADS_imp_1_OUT part 3. Create Index 

CREATE INDEX "ix_TMP_20221018190550_VLG6B07_ADS_imp_1_OUT_KEY" ON "TMP_20221018190550_VLG6B07_ADS_imp_1_OUT" ("KEY")

-- Code For temporary table TMP_20221018190550_B7D141C_ADS_sca_2_OUT part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221018190550_B7D141C_ADS_sca_2_OUT" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20221018190550_B7D141C_ADS_sca_2_OUT part 2. Populate

INSERT INTO "TMP_20221018190550_B7D141C_ADS_sca_2_OUT" ("KEY", scaler_output_2, scaler_output_3, scaler_output_4, scaler_output_5) SELECT "T"."KEY", "T".scaler_output_2, "T".scaler_output_3, "T".scaler_output_4, "T".scaler_output_5 
...
FROM "TMP_20221018190550_VLG6B07_ADS_imp_1_OUT" AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT") AS "T"

-- Code For temporary table TMP_20221018190550_B7D141C_ADS_sca_2_OUT part 3. Create Index 

CREATE INDEX "ix_TMP_20221018190550_B7D141C_ADS_sca_2_OUT_KEY" ON "TMP_20221018190550_B7D141C_ADS_sca_2_OUT" ("KEY")
...
FROM "TMP_20221018190550_B7D141C_ADS_sca_2_OUT" AS "ADS_sca_2_OUT"), 
linear_model_cte AS 
(SELECT linear_input."KEY" AS "KEY", -3.320347835200699 * linear_input.scaler_output_2 + 9.677334885030758 * linear_input.scaler_output_3 + -11.79617779060231 * linear_input.scaler_output_4 + -10.95555837356936 * linear_input.scaler_output_5 + -19.65670811397497 AS "Score_1789-07-14T00:00:00.000000000", -0.3983457653377626 * linear_input.scaler_output_2 + -2.2373902624652473 * linear_input.scaler_output_3 + 5.9360920125331225 * linear_input.scaler_output_4 + -7.428248556575141 * linear_input.scaler_output_5 + -1.6456561290829006 AS "Score_1789-08-14T00:00:00.000000000", -9.071879587519737 * linear_input.scaler_output_2 + -1.1614641128009788 * linear_input.scaler_output_3 + 33.32805436806505 * linear_input.scaler_output_4 + 27.339517872047768 * linear_input.scaler_output_5 + -36.438169442817234 AS "Score_1789-09-14T00:00:00.000000000" 
FROM linear_input), 
