...
-- Code For temporary table TMP_20221018190330_VU4GTW5_ADS_imp_1_OUT part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221018190330_VU4GTW5_ADS_imp_1_OUT" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20221018190330_VU4GTW5_ADS_imp_1_OUT part 2. Populate

INSERT INTO "TMP_20221018190330_VU4GTW5_ADS_imp_1_OUT" ("KEY", imputer_output_2, imputer_output_3, imputer_output_4, imputer_output_5) SELECT "T"."KEY", "T".imputer_output_2, "T".imputer_output_3, "T".imputer_output_4, "T".imputer_output_5 
...
-- Code For temporary table TMP_20221018190330_VU4GTW5_ADS_imp_1_OUT part 3. Create Index 

CREATE INDEX "ix_TMP_20221018190330_VU4GTW5_ADS_imp_1_OUT_KEY" ON "TMP_20221018190330_VU4GTW5_ADS_imp_1_OUT" ("KEY")

-- Code For temporary table TMP_20221018190330_4XYNU94_ADS_sca_2_OUT part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221018190330_4XYNU94_ADS_sca_2_OUT" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20221018190330_4XYNU94_ADS_sca_2_OUT part 2. Populate

INSERT INTO "TMP_20221018190330_4XYNU94_ADS_sca_2_OUT" ("KEY", scaler_output_2, scaler_output_3, scaler_output_4, scaler_output_5) SELECT "T"."KEY", "T".scaler_output_2, "T".scaler_output_3, "T".scaler_output_4, "T".scaler_output_5 
...
FROM "TMP_20221018190330_VU4GTW5_ADS_imp_1_OUT" AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT") AS "T"

-- Code For temporary table TMP_20221018190330_4XYNU94_ADS_sca_2_OUT part 3. Create Index 

CREATE INDEX "ix_TMP_20221018190330_4XYNU94_ADS_sca_2_OUT_KEY" ON "TMP_20221018190330_4XYNU94_ADS_sca_2_OUT" ("KEY")
...
FROM "TMP_20221018190330_4XYNU94_ADS_sca_2_OUT" AS "ADS_sca_2_OUT"), 
"SV_data" AS 
...
FROM (SELECT kernel_input."KEY" AS "KEY", "SV_data".dual_coeff * tanh(0.2499999999999999 * (kernel_input.scaler_output_2 * "SV_data".sv_0 + kernel_input.scaler_output_3 * "SV_data".sv_1 + kernel_input.scaler_output_4 * "SV_data".sv_2 + kernel_input.scaler_output_5 * "SV_data".sv_3) + 0.0) AS dot_prod1 
