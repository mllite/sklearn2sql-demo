...
-- Code For temporary table TMP_20221018185400_143ZQQI_WE_B0 part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221018185400_143ZQQI_WE_B0" (
	"KEY" BIGINT, 
	"Estimator" FLOAT, 
	"Weight" FLOAT, 
	est_index BIGINT
...
-- Code For temporary table TMP_20221018185400_143ZQQI_WE_B0 part 2. Populate
...
FROM "DT_Output_9")
 INSERT INTO "TMP_20221018185400_143ZQQI_WE_B0" ("KEY", "Estimator", "Weight", est_index) SELECT "T"."KEY", "T"."Estimator", "T"."Weight", "T".est_index 
...
-- Code For temporary table TMP_20221018185400_BDD2011_WE_B1 part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221018185400_BDD2011_WE_B1" (
	"KEY" BIGINT, 
	"Estimator" FLOAT, 
	"Weight" FLOAT, 
	est_index BIGINT
...
-- Code For temporary table TMP_20221018185400_BDD2011_WE_B1 part 2. Populate
...
FROM "DT_Output_15")
 INSERT INTO "TMP_20221018185400_BDD2011_WE_B1" ("KEY", "Estimator", "Weight", est_index) SELECT "T"."KEY", "T"."Estimator", "T"."Weight", "T".est_index 
...
-- Code For temporary table TMP_20221018185401_4CF97ZM_Quantiles part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221018185401_4CF97ZM_Quantiles" (
	"KEY" BIGINT, 
	"Quantile" FLOAT
)
...
-- Code For temporary table TMP_20221018185401_4CF97ZM_Quantiles part 2. Populate
...
FROM (SELECT "WE_B0"."KEY" AS "KEY", "WE_B0"."Estimator" AS "Estimator", "WE_B0"."Weight" AS "Weight", "WE_B0".est_index AS est_index 
FROM "TMP_20221018185400_143ZQQI_WE_B0" AS "WE_B0" UNION ALL SELECT "WE_B1"."KEY" AS "KEY", "WE_B1"."Estimator" AS "Estimator", "WE_B1"."Weight" AS "Weight", "WE_B1".est_index AS est_index 
FROM "TMP_20221018185400_BDD2011_WE_B1" AS "WE_B1") AS "WE_EnsembleUnion"), 
...
WHERE u1."Estimator" >= u2."Estimator" AND u1."KEY" = u2."KEY" GROUP BY u1."KEY", u1.est_index, u1."Estimator", u1."Weight") AS "CW")
 INSERT INTO "TMP_20221018185401_4CF97ZM_Quantiles" ("KEY", "Quantile") SELECT "T"."KEY", "T"."Quantile" 
...
FROM "TMP_20221018185401_4CF97ZM_Quantiles" AS "Quantiles"