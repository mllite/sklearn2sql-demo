...
-- Code For temporary table TMP_20221018185456_CIZAXNF_WE_B0 part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221018185456_CIZAXNF_WE_B0" (
	"KEY" BIGINT, 
	"Estimator" FLOAT, 
	"Weight" FLOAT, 
	est_index BIGINT
...
-- Code For temporary table TMP_20221018185456_CIZAXNF_WE_B0 part 2. Populate

WITH "DT_node_lookup" AS 
(SELECT "ADS"."KEY" AS "KEY", CASE WHEN ("ADS"."Feature_80" <= -0.34553782641887665) THEN CASE WHEN ("ADS"."Feature_41" <= -0.15062880516052246) THEN CASE WHEN ("ADS"."Feature_49" <= 0.33193662762641907) THEN 3 ELSE 4 END ELSE CASE WHEN ("ADS"."Feature_81" <= 0.4526127129793167) THEN 6 ELSE 7 END END ELSE CASE WHEN ("ADS"."Feature_53" <= -0.5890092998743057) THEN CASE WHEN ("ADS"."Feature_37" <= -0.04914991930127144) THEN 10 ELSE 11 END ELSE CASE WHEN ("ADS"."Feature_12" <= -1.1293261051177979) THEN 13 ELSE 14 END END END AS node_id_2 
...
FROM "DT_Output"), 
"DT_node_lookup_1" AS 
(SELECT "ADS"."KEY" AS "KEY", CASE WHEN ("ADS"."Feature_13" <= -0.9841643571853638) THEN CASE WHEN ("ADS"."Feature_90" <= -0.8632377088069916) THEN CASE WHEN ("ADS"."Feature_25" <= -1.2677878141403198) THEN 3 ELSE 4 END ELSE CASE WHEN ("ADS"."Feature_13" <= -1.1559348702430725) THEN 6 ELSE 7 END END ELSE CASE WHEN ("ADS"."Feature_49" <= -0.7116714417934418) THEN CASE WHEN ("ADS"."Feature_62" <= 0.45676225423812866) THEN 10 ELSE 11 END ELSE CASE WHEN ("ADS"."Feature_74" <= -0.3884258568286896) THEN 13 ELSE 14 END END END AS node_id_2 
FROM "RandomReg_100" AS "ADS"), 
"DT_node_data_1" AS 
(SELECT "Values".nid AS nid, "Values"."E" AS "E" 
...
FROM "DT_Output_1"), 
"DT_node_lookup_2" AS 
(SELECT "ADS"."KEY" AS "KEY", CASE WHEN ("ADS"."Feature_41" <= -0.5153412073850632) THEN CASE WHEN ("ADS"."Feature_80" <= -0.24700424075126648) THEN CASE WHEN ("ADS"."Feature_91" <= -0.2744544968008995) THEN 3 ELSE 4 END ELSE CASE WHEN ("ADS"."Feature_66" <= 0.8733834102749825) THEN 6 ELSE 7 END END ELSE CASE WHEN ("ADS"."Feature_89" <= 0.9215834140777588) THEN CASE WHEN ("ADS"."Feature_60" <= -0.7706659436225891) THEN 10 ELSE 11 END ELSE CASE WHEN ("ADS"."Feature_31" <= -0.3869132548570633) THEN 13 ELSE 14 END END END AS node_id_2 
FROM "RandomReg_100" AS "ADS"), 
"DT_node_data_2" AS 
(SELECT "Values".nid AS nid, "Values"."E" AS "E" 
...
FROM "DT_Output_2"), 
"DT_node_lookup_3" AS 
(SELECT "ADS"."KEY" AS "KEY", CASE WHEN ("ADS"."Feature_41" <= -0.5153412073850632) THEN CASE WHEN ("ADS"."Feature_80" <= 1.2518916726112366) THEN CASE WHEN ("ADS"."Feature_45" <= 0.46917635202407837) THEN 3 ELSE 4 END ELSE CASE WHEN ("ADS"."Feature_77" <= 0.6920472607016563) THEN 6 ELSE 7 END END ELSE CASE WHEN ("ADS"."Feature_39" <= -0.5033579468727112) THEN CASE WHEN ("ADS"."Feature_57" <= -0.4445692002773285) THEN 10 ELSE 11 END ELSE CASE WHEN ("ADS"."Feature_49" <= -1.5119811296463013) THEN 13 ELSE 14 END END END AS node_id_2 
FROM "RandomReg_100" AS "ADS"), 
"DT_node_data_3" AS 
(SELECT "Values".nid AS nid, "Values"."E" AS "E" 
...
FROM "DT_Output_3"), 
"DT_node_lookup_4" AS 
(SELECT "ADS"."KEY" AS "KEY", CASE WHEN ("ADS"."Feature_88" <= -0.8855451941490173) THEN CASE WHEN ("ADS"."Feature_65" <= -0.18200907111167908) THEN CASE WHEN ("ADS"."Feature_39" <= 1.5304359793663025) THEN 3 ELSE 4 END ELSE 5 END ELSE CASE WHEN ("ADS"."Feature_95" <= -0.7584029138088226) THEN CASE WHEN ("ADS"."Feature_66" <= 0.25202929228544235) THEN 8 ELSE 9 END ELSE CASE WHEN ("ADS"."Feature_80" <= -0.7997870445251465) THEN 11 ELSE 12 END END END AS node_id_2 
FROM "RandomReg_100" AS "ADS"), 
"DT_node_data_4" AS 
(SELECT "Values".nid AS nid, "Values"."E" AS "E" 
...
FROM "DT_Output_4"), 
"DT_node_lookup_5" AS 
(SELECT "ADS"."KEY" AS "KEY", CASE WHEN ("ADS"."Feature_80" <= -0.6633224785327911) THEN CASE WHEN ("ADS"."Feature_63" <= -0.0405989158898592) THEN CASE WHEN ("ADS"."Feature_92" <= -0.10441219806671143) THEN 3 ELSE 4 END ELSE CASE WHEN ("ADS"."Feature_41" <= -0.36463797092437744) THEN 6 ELSE 7 END END ELSE CASE WHEN ("ADS"."Feature_44" <= -0.9893495142459869) THEN CASE WHEN ("ADS"."Feature_83" <= -0.05271312594413757) THEN 10 ELSE 11 END ELSE CASE WHEN ("ADS"."Feature_1" <= 0.4291308969259262) THEN 13 ELSE 14 END END END AS node_id_2 
FROM "RandomReg_100" AS "ADS"), 
"DT_node_data_5" AS 
(SELECT "Values".nid AS nid, "Values"."E" AS "E" 
...
FROM "DT_Output_5"), 
"DT_node_lookup_6" AS 
(SELECT "ADS"."KEY" AS "KEY", CASE WHEN ("ADS"."Feature_63" <= -0.3170818090438843) THEN CASE WHEN ("ADS"."Feature_96" <= 1.3153736591339111) THEN CASE WHEN ("ADS"."Feature_49" <= 0.9990737736225128) THEN 3 ELSE 4 END ELSE CASE WHEN ("ADS"."Feature_67" <= 0.5289681851863861) THEN 6 ELSE 7 END END ELSE CASE WHEN ("ADS"."Feature_69" <= 0.08657990396022797) THEN CASE WHEN ("ADS"."Feature_79" <= -0.23458990640938282) THEN 10 ELSE 11 END ELSE CASE WHEN ("ADS"."Feature_43" <= -0.45903991162776947) THEN 13 ELSE 14 END END END AS node_id_2 
FROM "RandomReg_100" AS "ADS"), 
"DT_node_data_6" AS 
(SELECT "Values".nid AS nid, "Values"."E" AS "E" 
...
FROM "DT_Output_6"), 
"DT_node_lookup_7" AS 
(SELECT "ADS"."KEY" AS "KEY", CASE WHEN ("ADS"."Feature_41" <= -0.5153412073850632) THEN CASE WHEN ("ADS"."Feature_55" <= 0.7472752630710602) THEN CASE WHEN ("ADS"."Feature_79" <= 0.7658234238624573) THEN 3 ELSE 4 END ELSE CASE WHEN ("ADS"."Feature_15" <= 1.3074146509170532) THEN 6 ELSE 7 END END ELSE CASE WHEN ("ADS"."Feature_95" <= -0.4157814681529999) THEN CASE WHEN ("ADS"."Feature_32" <= -0.8026922643184662) THEN 10 ELSE 11 END ELSE CASE WHEN ("ADS"."Feature_3" <= 1.2976652681827545) THEN 13 ELSE 14 END END END AS node_id_2 
FROM "RandomReg_100" AS "ADS"), 
"DT_node_data_7" AS 
(SELECT "Values".nid AS nid, "Values"."E" AS "E" 
...
FROM "DT_Output_7"), 
"DT_node_lookup_8" AS 
(SELECT "ADS"."KEY" AS "KEY", CASE WHEN ("ADS"."Feature_95" <= -0.2972280979156494) THEN CASE WHEN ("ADS"."Feature_1" <= -1.393744945526123) THEN CASE WHEN ("ADS"."Feature_56" <= -0.9485935121774673) THEN 3 ELSE 4 END ELSE CASE WHEN ("ADS"."Feature_41" <= -0.546962708234787) THEN 6 ELSE 7 END END ELSE CASE WHEN ("ADS"."Feature_79" <= 0.3004913479089737) THEN CASE WHEN ("ADS"."Feature_68" <= -0.248687531799078) THEN 10 ELSE 11 END ELSE CASE WHEN ("ADS"."Feature_69" <= -0.7042298316955566) THEN 13 ELSE 14 END END END AS node_id_2 
FROM "RandomReg_100" AS "ADS"), 
"DT_node_data_8" AS 
(SELECT "Values".nid AS nid, "Values"."E" AS "E" 
...
FROM "DT_Output_8"), 
"DT_node_lookup_9" AS 
(SELECT "ADS"."KEY" AS "KEY", CASE WHEN ("ADS"."Feature_63" <= 0.4602121263742447) THEN CASE WHEN ("ADS"."Feature_41" <= -0.14402874559164047) THEN CASE WHEN ("ADS"."Feature_80" <= -0.31594059988856316) THEN 3 ELSE 4 END ELSE CASE WHEN ("ADS"."Feature_93" <= -0.7789497077465057) THEN 6 ELSE 7 END END ELSE CASE WHEN ("ADS"."Feature_11" <= -1.0486904978752136) THEN CASE WHEN ("ADS"."Feature_13" <= 0.3548305928707123) THEN 10 ELSE 11 END ELSE CASE WHEN ("ADS"."Feature_69" <= -0.44060735404491425) THEN 13 ELSE 14 END END END AS node_id_2 
FROM "RandomReg_100" AS "ADS"), 
"DT_node_data_9" AS 
(SELECT "Values".nid AS nid, "Values"."E" AS "E" 
...
FROM "DT_Output_9")
 INSERT INTO "TMP_20221018185456_CIZAXNF_WE_B0" ("KEY", "Estimator", "Weight", est_index) SELECT "T"."KEY", "T"."Estimator", "T"."Weight", "T".est_index 
...
-- Code For temporary table TMP_20221018185456_470012Q_WE_B1 part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221018185456_470012Q_WE_B1" (
	"KEY" BIGINT, 
	"Estimator" FLOAT, 
	"Weight" FLOAT, 
	est_index BIGINT
...
-- Code For temporary table TMP_20221018185456_470012Q_WE_B1 part 2. Populate

WITH "DT_node_lookup_10" AS 
(SELECT "ADS"."KEY" AS "KEY", CASE WHEN ("ADS"."Feature_63" <= -0.8221249580383301) THEN CASE WHEN ("ADS"."Feature_56" <= -0.36408669501543045) THEN CASE WHEN ("ADS"."Feature_78" <= 0.6419654339551926) THEN 3 ELSE 4 END ELSE CASE WHEN ("ADS"."Feature_78" <= 0.9275895655155182) THEN 6 ELSE 7 END END ELSE CASE WHEN ("ADS"."Feature_80" <= 0.9317565262317657) THEN CASE WHEN ("ADS"."Feature_65" <= 0.9399657547473907) THEN 10 ELSE 11 END ELSE CASE WHEN ("ADS"."Feature_93" <= 0.271784745156765) THEN 13 ELSE 14 END END END AS node_id_2 
FROM "RandomReg_100" AS "ADS"), 
"DT_node_data_10" AS 
(SELECT "Values".nid AS nid, "Values"."E" AS "E" 
...
(SELECT "ADS"."KEY" AS "KEY", CASE WHEN ("ADS"."Feature_80" <= -0.6753641068935394) THEN CASE WHEN ("ADS"."Feature_52" <= 1.4058173298835754) THEN CASE WHEN ("ADS"."Feature_96" <= 0.8706262409687042) THEN 3 ELSE 4 END ELSE CASE WHEN ("ADS"."Feature_43" <= -1.249612033367157) THEN 6 ELSE 7 END END ELSE CASE WHEN ("ADS"."Feature_17" <= -0.36187705397605896) THEN CASE WHEN ("ADS"."Feature_95" <= 0.3182663768529892) THEN 10 ELSE 11 END ELSE CASE WHEN ("ADS"."Feature_20" <= 0.6378057897090912) THEN 13 ELSE 14 END END END AS node_id_2 
FROM "RandomReg_100" AS "ADS"), 
"DT_node_data_11" AS 
(SELECT "Values".nid AS nid, "Values"."E" AS "E" 
...
(SELECT "ADS"."KEY" AS "KEY", CASE WHEN ("ADS"."Feature_91" <= -0.040150485932826996) THEN CASE WHEN ("ADS"."Feature_19" <= -0.6786157786846161) THEN CASE WHEN ("ADS"."Feature_37" <= 0.03979449754115194) THEN 3 ELSE 4 END ELSE CASE WHEN ("ADS"."Feature_41" <= -0.3415294885635376) THEN 6 ELSE 7 END END ELSE CASE WHEN ("ADS"."Feature_39" <= 0.3670928627252579) THEN CASE WHEN ("ADS"."Feature_62" <= 0.38502655923366547) THEN 10 ELSE 11 END ELSE CASE WHEN ("ADS"."Feature_80" <= 1.6930869221687317) THEN 13 ELSE 14 END END END AS node_id_2 
FROM "RandomReg_100" AS "ADS"), 
"DT_node_data_12" AS 
(SELECT "Values".nid AS nid, "Values"."E" AS "E" 
...
(SELECT "ADS"."KEY" AS "KEY", CASE WHEN ("ADS"."Feature_63" <= 0.25588665157556534) THEN CASE WHEN ("ADS"."Feature_80" <= -0.34553782641887665) THEN CASE WHEN ("ADS"."Feature_18" <= -0.3967856764793396) THEN 3 ELSE 4 END ELSE CASE WHEN ("ADS"."Feature_12" <= -0.09503274038434029) THEN 6 ELSE 7 END END ELSE CASE WHEN ("ADS"."Feature_59" <= -0.7684158980846405) THEN CASE WHEN ("ADS"."Feature_47" <= 1.3490431308746338) THEN 10 ELSE 11 END ELSE CASE WHEN ("ADS"."Feature_27" <= 0.3713006377220154) THEN 13 ELSE 14 END END END AS node_id_2 
FROM "RandomReg_100" AS "ADS"), 
"DT_node_data_13" AS 
(SELECT "Values".nid AS nid, "Values"."E" AS "E" 
...
(SELECT "ADS"."KEY" AS "KEY", CASE WHEN ("ADS"."Feature_80" <= -0.7656268775463104) THEN CASE WHEN ("ADS"."Feature_1" <= -0.30887018144130707) THEN CASE WHEN ("ADS"."Feature_29" <= 0.12952925264835358) THEN 3 ELSE 4 END ELSE CASE WHEN ("ADS"."Feature_55" <= 1.350800335407257) THEN 6 ELSE 7 END END ELSE CASE WHEN ("ADS"."Feature_33" <= -0.292339950799942) THEN CASE WHEN ("ADS"."Feature_47" <= -0.5029033124446869) THEN 10 ELSE 11 END ELSE CASE WHEN ("ADS"."Feature_1" <= 0.4565832167863846) THEN 13 ELSE 14 END END END AS node_id_2 
FROM "RandomReg_100" AS "ADS"), 
"DT_node_data_14" AS 
(SELECT "Values".nid AS nid, "Values"."E" AS "E" 
...
(SELECT "ADS"."KEY" AS "KEY", CASE WHEN ("ADS"."Feature_80" <= -0.25653302296996117) THEN CASE WHEN ("ADS"."Feature_41" <= -0.5217077285051346) THEN CASE WHEN ("ADS"."Feature_62" <= 1.211120367050171) THEN 3 ELSE 4 END ELSE CASE WHEN ("ADS"."Feature_2" <= -0.7036556005477905) THEN 6 ELSE 7 END END ELSE CASE WHEN ("ADS"."Feature_41" <= -0.8709725737571716) THEN CASE WHEN ("ADS"."Feature_60" <= 0.2611076459288597) THEN 10 ELSE 11 END ELSE CASE WHEN ("ADS"."Feature_78" <= -0.8572569787502289) THEN 13 ELSE 14 END END END AS node_id_2 
FROM "RandomReg_100" AS "ADS"), 
"DT_node_data_15" AS 
(SELECT "Values".nid AS nid, "Values"."E" AS "E" 
...
FROM "DT_Output_15")
 INSERT INTO "TMP_20221018185456_470012Q_WE_B1" ("KEY", "Estimator", "Weight", est_index) SELECT "T"."KEY", "T"."Estimator", "T"."Weight", "T".est_index 
...
-- Code For temporary table TMP_20221018185456_0ZLBMPK_Quantiles part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221018185456_0ZLBMPK_Quantiles" (
	"KEY" BIGINT, 
	"Quantile" FLOAT
)
...
-- Code For temporary table TMP_20221018185456_0ZLBMPK_Quantiles part 2. Populate
...
FROM (SELECT "WE_B0"."KEY" AS "KEY", "WE_B0"."Estimator" AS "Estimator", "WE_B0"."Weight" AS "Weight", "WE_B0".est_index AS est_index 
FROM "TMP_20221018185456_CIZAXNF_WE_B0" AS "WE_B0" UNION ALL SELECT "WE_B1"."KEY" AS "KEY", "WE_B1"."Estimator" AS "Estimator", "WE_B1"."Weight" AS "Weight", "WE_B1".est_index AS est_index 
FROM "TMP_20221018185456_470012Q_WE_B1" AS "WE_B1") AS "WE_EnsembleUnion"), 
...
WHERE u1."Estimator" >= u2."Estimator" AND u1."KEY" = u2."KEY" GROUP BY u1."KEY", u1.est_index, u1."Estimator", u1."Weight") AS "CW")
 INSERT INTO "TMP_20221018185456_0ZLBMPK_Quantiles" ("KEY", "Quantile") SELECT "T"."KEY", "T"."Quantile" 
...
FROM "TMP_20221018185456_0ZLBMPK_Quantiles" AS "Quantiles"