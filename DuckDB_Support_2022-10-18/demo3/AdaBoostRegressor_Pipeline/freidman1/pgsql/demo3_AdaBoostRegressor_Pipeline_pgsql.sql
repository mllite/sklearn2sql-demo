...
-- Code For temporary table TMP_20221018190057_03O16TR_ADS_imp_1_OUT part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221018190057_03O16TR_ADS_imp_1_OUT" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20221018190057_03O16TR_ADS_imp_1_OUT part 3. Create Index 

CREATE INDEX "ix_TMP_20221018190057_03O16TR_ADS_imp_1_OUT_KEY" ON "TMP_20221018190057_03O16TR_ADS_imp_1_OUT" ("KEY")

-- Code For temporary table TMP_20221018190057_BIURIBJ_ADS_sca_2_OUT part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221018190057_BIURIBJ_ADS_sca_2_OUT" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20221018190057_BIURIBJ_ADS_sca_2_OUT part 2. Populate

INSERT INTO "TMP_20221018190057_BIURIBJ_ADS_sca_2_OUT" ("KEY", scaler_output_2, scaler_output_3, scaler_output_4, scaler_output_5, scaler_output_6, scaler_output_7, scaler_output_8, scaler_output_9, scaler_output_10, scaler_output_11) SELECT "T"."KEY", "T".scaler_output_2, "T".scaler_output_3, "T".scaler_output_4, "T".scaler_output_5, "T".scaler_output_6, "T".scaler_output_7, "T".scaler_output_8, "T".scaler_output_9, "T".scaler_output_10, "T".scaler_output_11 
...
FROM "TMP_20221018190057_03O16TR_ADS_imp_1_OUT" AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT") AS "T"

-- Code For temporary table TMP_20221018190057_BIURIBJ_ADS_sca_2_OUT part 3. Create Index 

CREATE INDEX "ix_TMP_20221018190057_BIURIBJ_ADS_sca_2_OUT_KEY" ON "TMP_20221018190057_BIURIBJ_ADS_sca_2_OUT" ("KEY")

-- Code For temporary table TMP_20221018190058_ODYSIIS_WE_B0 part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221018190058_ODYSIIS_WE_B0" (
	"KEY" BIGINT, 
	"Estimator" FLOAT, 
	"Weight" FLOAT, 
	est_index BIGINT
...
-- Code For temporary table TMP_20221018190058_ODYSIIS_WE_B0 part 2. Populate

WITH "DT_node_lookup" AS 
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", CASE WHEN ("ADS_sca_2_OUT".scaler_output_3 <= -0.5990101397037506) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_output_6 <= 0.43099722266197205) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_output_5 <= -0.7714441120624542) THEN 3 ELSE 4 END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_output_8 <= 0.5740693211555481) THEN 6 ELSE 7 END END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_output_5 <= 0.9981422424316406) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_output_7 <= -1.8351979851722717) THEN 10 ELSE 11 END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_output_11 <= -1.5117244720458984) THEN 13 ELSE 14 END END END AS node_id_2 
FROM "TMP_20221018190057_BIURIBJ_ADS_sca_2_OUT" AS "ADS_sca_2_OUT"), 
"DT_node_data" AS 
...
FROM "DT_Output_1"), 
"DT_node_lookup_2" AS 
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", CASE WHEN ("ADS_sca_2_OUT".scaler_output_3 <= -0.2825087904930115) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_output_4 <= 1.1641054153442383) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_output_5 <= -0.9907792210578918) THEN 3 ELSE 4 END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_output_7 <= 0.45797020196914673) THEN 6 ELSE 7 END END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_output_2 <= -0.7201983630657196) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_output_8 <= 0.5515375733375549) THEN 10 ELSE 11 END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_output_5 <= 0.7374852299690247) THEN 13 ELSE 14 END END END AS node_id_2 
FROM "TMP_20221018190057_BIURIBJ_ADS_sca_2_OUT" AS "ADS_sca_2_OUT"), 
"DT_node_data_2" AS 
(SELECT "Values".nid AS nid, "Values"."E" AS "E" 
...
FROM "DT_Output_2"), 
"DT_node_lookup_3" AS 
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", CASE WHEN ("ADS_sca_2_OUT".scaler_output_5 <= 0.057984648272395134) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_output_6 <= 0.31750786304473877) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_output_3 <= 0.4823174625635147) THEN 3 ELSE 4 END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_output_8 <= 1.2847101092338562) THEN 6 ELSE 7 END END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_output_2 <= -1.0125129520893097) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_output_11 <= 0.1928507313132286) THEN 10 ELSE 11 END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_output_3 <= -0.7092001140117645) THEN 13 ELSE 14 END END END AS node_id_2 
FROM "TMP_20221018190057_BIURIBJ_ADS_sca_2_OUT" AS "ADS_sca_2_OUT"), 
"DT_node_data_3" AS 
(SELECT "Values".nid AS nid, "Values"."E" AS "E" 
...
FROM "DT_Output_3"), 
"DT_node_lookup_4" AS 
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", CASE WHEN ("ADS_sca_2_OUT".scaler_output_2 <= -0.905405730009079) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_output_5 <= 0.03856448829174042) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_output_2 <= -1.0249632596969604) THEN 3 ELSE 4 END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_output_8 <= 0.6200701594352722) THEN 6 ELSE 7 END END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_output_11 <= 1.4223095178604126) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_output_7 <= 1.251610517501831) THEN 10 ELSE 11 END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_output_6 <= 0.0530385822057724) THEN 13 ELSE 14 END END END AS node_id_2 
FROM "TMP_20221018190057_BIURIBJ_ADS_sca_2_OUT" AS "ADS_sca_2_OUT"), 
"DT_node_data_4" AS 
(SELECT "Values".nid AS nid, "Values"."E" AS "E" 
...
FROM "DT_Output_4"), 
"DT_node_lookup_5" AS 
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", CASE WHEN ("ADS_sca_2_OUT".scaler_output_5 <= 0.057984648272395134) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_output_3 <= 0.4936526119709015) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_output_6 <= 0.31750786304473877) THEN 3 ELSE 4 END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_output_6 <= 1.1826142072677612) THEN 6 ELSE 7 END END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_output_3 <= -0.4788433164358139) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_output_7 <= 0.5018869042396545) THEN 10 ELSE 11 END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_output_2 <= -0.8380006551742554) THEN 13 ELSE 14 END END END AS node_id_2 
FROM "TMP_20221018190057_BIURIBJ_ADS_sca_2_OUT" AS "ADS_sca_2_OUT"), 
"DT_node_data_5" AS 
(SELECT "Values".nid AS nid, "Values"."E" AS "E" 
...
FROM "DT_Output_5"), 
"DT_node_lookup_6" AS 
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", CASE WHEN ("ADS_sca_2_OUT".scaler_output_5 <= -0.18559623137116432) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_output_4 <= -0.6404086947441101) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_output_3 <= -0.01687277527526021) THEN 3 ELSE 4 END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_output_11 <= -0.2107425332069397) THEN 6 ELSE 7 END END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_output_2 <= -1.1576403379440308) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_output_11 <= -1.6233705878257751) THEN 10 ELSE 11 END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_output_3 <= -0.38098010420799255) THEN 13 ELSE 14 END END END AS node_id_2 
FROM "TMP_20221018190057_BIURIBJ_ADS_sca_2_OUT" AS "ADS_sca_2_OUT"), 
"DT_node_data_6" AS 
(SELECT "Values".nid AS nid, "Values"."E" AS "E" 
...
FROM "DT_Output_6"), 
"DT_node_lookup_7" AS 
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", CASE WHEN ("ADS_sca_2_OUT".scaler_output_5 <= -0.13406174257397652) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_output_6 <= -0.05713108088821173) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_output_7 <= -1.149171769618988) THEN 3 ELSE 4 END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_output_11 <= -0.06066661328077316) THEN 6 ELSE 7 END END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_output_3 <= -0.7110370993614197) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_output_2 <= -1.0962872505187988) THEN 10 ELSE 11 END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_output_5 <= 0.884007453918457) THEN 13 ELSE 14 END END END AS node_id_2 
FROM "TMP_20221018190057_BIURIBJ_ADS_sca_2_OUT" AS "ADS_sca_2_OUT"), 
"DT_node_data_7" AS 
(SELECT "Values".nid AS nid, "Values"."E" AS "E" 
...
FROM "DT_Output_7"), 
"DT_node_lookup_8" AS 
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", CASE WHEN ("ADS_sca_2_OUT".scaler_output_3 <= 0.4936526119709015) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_output_5 <= -1.1964271664619446) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_output_7 <= -1.1048519611358643) THEN 3 ELSE 4 END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_output_2 <= 0.8049251139163971) THEN 6 ELSE 7 END END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_output_2 <= -1.2575977444648743) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_output_10 <= 0.30531133711338043) THEN 10 ELSE 11 END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_output_5 <= -0.06301439180970192) THEN 13 ELSE 14 END END END AS node_id_2 
FROM "TMP_20221018190057_BIURIBJ_ADS_sca_2_OUT" AS "ADS_sca_2_OUT"), 
"DT_node_data_8" AS 
(SELECT "Values".nid AS nid, "Values"."E" AS "E" 
...
FROM "DT_Output_8"), 
"DT_node_lookup_9" AS 
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", CASE WHEN ("ADS_sca_2_OUT".scaler_output_5 <= -0.08507034182548523) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_output_4 <= -0.6321609020233154) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_output_7 <= -0.14652781561017036) THEN 3 ELSE 4 END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_output_5 <= -1.0772407054901123) THEN 6 ELSE 7 END END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_output_3 <= -0.4788433164358139) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_output_7 <= 0.44615861773490906) THEN 10 ELSE 11 END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_output_9 <= -1.311335563659668) THEN 13 ELSE 14 END END END AS node_id_2 
FROM "TMP_20221018190057_BIURIBJ_ADS_sca_2_OUT" AS "ADS_sca_2_OUT"), 
"DT_node_data_9" AS 
(SELECT "Values".nid AS nid, "Values"."E" AS "E" 
...
FROM "DT_Output_9")
 INSERT INTO "TMP_20221018190058_ODYSIIS_WE_B0" ("KEY", "Estimator", "Weight", est_index) SELECT "T"."KEY", "T"."Estimator", "T"."Weight", "T".est_index 
...
-- Code For temporary table TMP_20221018190058_TYV2OM3_WE_B1 part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221018190058_TYV2OM3_WE_B1" (
	"KEY" BIGINT, 
	"Estimator" FLOAT, 
	"Weight" FLOAT, 
	est_index BIGINT
...
-- Code For temporary table TMP_20221018190058_TYV2OM3_WE_B1 part 2. Populate

WITH "DT_node_lookup_10" AS 
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", CASE WHEN ("ADS_sca_2_OUT".scaler_output_6 <= 0.7952097952365875) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_output_3 <= -0.2825087904930115) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_output_5 <= -1.0131055116653442) THEN 3 ELSE 4 END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_output_2 <= -0.652317613363266) THEN 6 ELSE 7 END END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_output_3 <= 0.9287995994091034) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_output_9 <= 0.902372419834137) THEN 10 ELSE 11 END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_output_10 <= 1.1411602795124054) THEN 13 ELSE 14 END END END AS node_id_2 
FROM "TMP_20221018190057_BIURIBJ_ADS_sca_2_OUT" AS "ADS_sca_2_OUT"), 
"DT_node_data_10" AS 
(SELECT "Values".nid AS nid, "Values"."E" AS "E" 
...
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", CASE WHEN ("ADS_sca_2_OUT".scaler_output_5 <= 0.7790558338165283) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_output_3 <= -0.10965748550370336) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_output_5 <= -0.44034917652606964) THEN 3 ELSE 4 END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_output_2 <= -0.9460362792015076) THEN 6 ELSE 7 END END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_output_7 <= 0.45797020196914673) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_output_4 <= -0.7053980082273483) THEN 10 ELSE 11 END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_output_7 <= 1.1801438927650452) THEN 13 ELSE 14 END END END AS node_id_2 
FROM "TMP_20221018190057_BIURIBJ_ADS_sca_2_OUT" AS "ADS_sca_2_OUT"), 
"DT_node_data_11" AS 
(SELECT "Values".nid AS nid, "Values"."E" AS "E" 
...
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", CASE WHEN ("ADS_sca_2_OUT".scaler_output_3 <= 0.6123250275850296) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_output_2 <= -1.0451621413230896) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_output_5 <= 0.20721951127052307) THEN 3 ELSE 4 END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_output_3 <= -0.962867021560669) THEN 6 ELSE 7 END END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_output_6 <= -0.6414153277873993) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_output_9 <= -0.7036276794970036) THEN 10 ELSE 11 END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_output_3 <= 1.4299299120903015) THEN 13 ELSE 14 END END END AS node_id_2 
FROM "TMP_20221018190057_BIURIBJ_ADS_sca_2_OUT" AS "ADS_sca_2_OUT"), 
"DT_node_data_12" AS 
(SELECT "Values".nid AS nid, "Values"."E" AS "E" 
...
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", CASE WHEN ("ADS_sca_2_OUT".scaler_output_3 <= -0.01687277527526021) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_output_5 <= -0.38270749151706696) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_output_6 <= -0.6766680628061295) THEN 3 ELSE 4 END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_output_7 <= 1.081565022468567) THEN 6 ELSE 7 END END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_output_5 <= -0.161956999450922) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_output_7 <= -1.5936694145202637) THEN 10 ELSE 11 END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_output_2 <= -0.7513359487056732) THEN 13 ELSE 14 END END END AS node_id_2 
FROM "TMP_20221018190057_BIURIBJ_ADS_sca_2_OUT" AS "ADS_sca_2_OUT"), 
"DT_node_data_13" AS 
(SELECT "Values".nid AS nid, "Values"."E" AS "E" 
...
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", CASE WHEN ("ADS_sca_2_OUT".scaler_output_5 <= -1.4377910494804382) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_output_4 <= 1.3767752647399902) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_output_7 <= -1.1048519611358643) THEN 3 ELSE 4 END ELSE 5 END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_output_5 <= 0.8608259856700897) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_output_3 <= -0.8096771240234375) THEN 8 ELSE 9 END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_output_11 <= -0.7783630387857556) THEN 11 ELSE 12 END END END AS node_id_2 
FROM "TMP_20221018190057_BIURIBJ_ADS_sca_2_OUT" AS "ADS_sca_2_OUT"), 
"DT_node_data_14" AS 
(SELECT "Values".nid AS nid, "Values"."E" AS "E" 
...
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", CASE WHEN ("ADS_sca_2_OUT".scaler_output_3 <= 0.6123250275850296) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_output_4 <= -0.5997590720653534) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_output_5 <= 0.823187530040741) THEN 3 ELSE 4 END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_output_5 <= 1.150056004524231) THEN 6 ELSE 7 END END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_output_5 <= 0.7781765460968018) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_output_2 <= -1.1991350650787354) THEN 10 ELSE 11 END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_output_7 <= -1.0115613043308258) THEN 13 ELSE 14 END END END AS node_id_2 
FROM "TMP_20221018190057_BIURIBJ_ADS_sca_2_OUT" AS "ADS_sca_2_OUT"), 
"DT_node_data_15" AS 
(SELECT "Values".nid AS nid, "Values"."E" AS "E" 
...
FROM "DT_Output_15")
 INSERT INTO "TMP_20221018190058_TYV2OM3_WE_B1" ("KEY", "Estimator", "Weight", est_index) SELECT "T"."KEY", "T"."Estimator", "T"."Weight", "T".est_index 
...
-- Code For temporary table TMP_20221018190058_HX0SCUW_Quantiles part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221018190058_HX0SCUW_Quantiles" (
	"KEY" BIGINT, 
	"Quantile" FLOAT
)
...
-- Code For temporary table TMP_20221018190058_HX0SCUW_Quantiles part 2. Populate
...
FROM (SELECT "WE_B0"."KEY" AS "KEY", "WE_B0"."Estimator" AS "Estimator", "WE_B0"."Weight" AS "Weight", "WE_B0".est_index AS est_index 
FROM "TMP_20221018190058_ODYSIIS_WE_B0" AS "WE_B0" UNION ALL SELECT "WE_B1"."KEY" AS "KEY", "WE_B1"."Estimator" AS "Estimator", "WE_B1"."Weight" AS "Weight", "WE_B1".est_index AS est_index 
FROM "TMP_20221018190058_TYV2OM3_WE_B1" AS "WE_B1") AS "WE_EnsembleUnion"), 
...
WHERE u1."Estimator" >= u2."Estimator" AND u1."KEY" = u2."KEY" GROUP BY u1."KEY", u1.est_index, u1."Estimator", u1."Weight") AS "CW")
 INSERT INTO "TMP_20221018190058_HX0SCUW_Quantiles" ("KEY", "Quantile") SELECT "T"."KEY", "T"."Quantile" 
...
FROM "TMP_20221018190058_HX0SCUW_Quantiles" AS "Quantiles"