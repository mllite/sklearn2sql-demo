...
-- Code For temporary table TMP_20221018190057_56LEZ66_ADS_imp_1_OUT part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221018190057_56LEZ66_ADS_imp_1_OUT" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20221018190057_56LEZ66_ADS_imp_1_OUT part 3. Create Index 

CREATE INDEX "ix_TMP_20221018190057_56LEZ66_ADS_imp_1_OUT_KEY" ON "TMP_20221018190057_56LEZ66_ADS_imp_1_OUT" ("KEY")

-- Code For temporary table TMP_20221018190057_E6E76X9_ADS_sca_2_OUT part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221018190057_E6E76X9_ADS_sca_2_OUT" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20221018190057_E6E76X9_ADS_sca_2_OUT part 2. Populate

INSERT INTO "TMP_20221018190057_E6E76X9_ADS_sca_2_OUT" ("KEY", scaler_output_2, scaler_output_3, scaler_output_4, scaler_output_5, scaler_output_6, scaler_output_7, scaler_output_8, scaler_output_9, scaler_output_10, scaler_output_11) SELECT "T"."KEY", "T".scaler_output_2, "T".scaler_output_3, "T".scaler_output_4, "T".scaler_output_5, "T".scaler_output_6, "T".scaler_output_7, "T".scaler_output_8, "T".scaler_output_9, "T".scaler_output_10, "T".scaler_output_11 
...
FROM "TMP_20221018190057_56LEZ66_ADS_imp_1_OUT" AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT") AS "T"

-- Code For temporary table TMP_20221018190057_E6E76X9_ADS_sca_2_OUT part 3. Create Index 

CREATE INDEX "ix_TMP_20221018190057_E6E76X9_ADS_sca_2_OUT_KEY" ON "TMP_20221018190057_E6E76X9_ADS_sca_2_OUT" ("KEY")

-- Code For temporary table TMP_20221018190057_EU2XWPU_WE_B0 part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221018190057_EU2XWPU_WE_B0" (
	"KEY" BIGINT, 
	"Estimator" FLOAT, 
	"Weight" FLOAT, 
	est_index BIGINT
...
-- Code For temporary table TMP_20221018190057_EU2XWPU_WE_B0 part 2. Populate
...
FROM "TMP_20221018190057_E6E76X9_ADS_sca_2_OUT" AS "ADS_sca_2_OUT"), 
"DT_node_data" AS 
...
FROM "DT_Output_9")
 INSERT INTO "TMP_20221018190057_EU2XWPU_WE_B0" ("KEY", "Estimator", "Weight", est_index) SELECT "T"."KEY", "T"."Estimator", "T"."Weight", "T".est_index 
...
-- Code For temporary table TMP_20221018190057_6QR0A0X_WE_B1 part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221018190057_6QR0A0X_WE_B1" (
	"KEY" BIGINT, 
	"Estimator" FLOAT, 
	"Weight" FLOAT, 
	est_index BIGINT
...
-- Code For temporary table TMP_20221018190057_6QR0A0X_WE_B1 part 2. Populate
...
FROM "DT_Output_15")
 INSERT INTO "TMP_20221018190057_6QR0A0X_WE_B1" ("KEY", "Estimator", "Weight", est_index) SELECT "T"."KEY", "T"."Estimator", "T"."Weight", "T".est_index 
...
-- Code For temporary table TMP_20221018190057_TI0MCGQ_Quantiles part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221018190057_TI0MCGQ_Quantiles" (
	"KEY" BIGINT, 
	"Quantile" FLOAT
)
...
-- Code For temporary table TMP_20221018190057_TI0MCGQ_Quantiles part 2. Populate
...
FROM (SELECT "WE_B0"."KEY" AS "KEY", "WE_B0"."Estimator" AS "Estimator", "WE_B0"."Weight" AS "Weight", "WE_B0".est_index AS est_index 
FROM "TMP_20221018190057_EU2XWPU_WE_B0" AS "WE_B0" UNION ALL SELECT "WE_B1"."KEY" AS "KEY", "WE_B1"."Estimator" AS "Estimator", "WE_B1"."Weight" AS "Weight", "WE_B1".est_index AS est_index 
FROM "TMP_20221018190057_6QR0A0X_WE_B1" AS "WE_B1") AS "WE_EnsembleUnion"), 
...
WHERE u1."Estimator" >= u2."Estimator" AND u1."KEY" = u2."KEY" GROUP BY u1."KEY", u1.est_index, u1."Estimator", u1."Weight") AS "CW")
 INSERT INTO "TMP_20221018190057_TI0MCGQ_Quantiles" ("KEY", "Quantile") SELECT "T"."KEY", "T"."Quantile" 
...
FROM "TMP_20221018190057_TI0MCGQ_Quantiles" AS "Quantiles"