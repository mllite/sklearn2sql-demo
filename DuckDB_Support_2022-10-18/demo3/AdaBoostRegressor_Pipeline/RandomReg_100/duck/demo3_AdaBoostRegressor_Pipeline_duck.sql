...
-- Code For temporary table TMP_20221018185458_QMSTA75_ADS_imp_1_OUT part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221018185458_QMSTA75_ADS_imp_1_OUT" (
	"KEY" BIGINT NOT NULL, 
	impter_2 DOUBLE, 
	impter_3 DOUBLE, 
	impter_4 DOUBLE, 
...
-- Code For temporary table TMP_20221018185458_QMSTA75_ADS_imp_1_OUT part 3. Create Index 

CREATE INDEX "ix_TMP_20221018185458_QMSTA75_ADS_imp_1_OUT_KEY" ON "TMP_20221018185458_QMSTA75_ADS_imp_1_OUT" ("KEY")

-- Code For temporary table TMP_20221018185458_A2YZJGY_ADS_sca_2_OUT part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221018185458_A2YZJGY_ADS_sca_2_OUT" (
	"KEY" BIGINT NOT NULL, 
	scaler_2 DOUBLE, 
	scaler_3 DOUBLE, 
	scaler_4 DOUBLE, 
...
FROM "TMP_20221018185458_QMSTA75_ADS_imp_1_OUT" AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT") AS "T"

-- Code For temporary table TMP_20221018185458_A2YZJGY_ADS_sca_2_OUT part 3. Create Index 

CREATE INDEX "ix_TMP_20221018185458_A2YZJGY_ADS_sca_2_OUT_KEY" ON "TMP_20221018185458_A2YZJGY_ADS_sca_2_OUT" ("KEY")

-- Code For temporary table TMP_20221018185458_J342WB9_WE_B0 part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221018185458_J342WB9_WE_B0" (
	"KEY" BIGINT, 
	"Estimator" DOUBLE, 
	"Weight" DOUBLE, 
	est_index BIGINT
...
FROM "DT_Output_1"), 
"DT_node_lookup_2" AS 
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", CASE WHEN ("ADS_sca_2_OUT".scaler_43 <= -0.44576358795166016) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_82 <= -0.2101648710668087) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_93 <= -0.5397823005914688) THEN 3 ELSE 4 END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_68 <= 0.8173680156469345) THEN 6 ELSE 7 END END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_91 <= 0.9625909328460693) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_62 <= -0.7250446379184723) THEN 10 ELSE 11 END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_33 <= -0.4597311522811651) THEN 13 ELSE 14 END END END AS node_id_2 
FROM "TMP_20221018185458_A2YZJGY_ADS_sca_2_OUT" AS "ADS_sca_2_OUT"), 
"DT_node_data_2" AS 
(SELECT "Values".nid AS nid, "Values"."E" AS "E" 
...
FROM "DT_Output_2"), 
"DT_node_lookup_3" AS 
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", CASE WHEN ("ADS_sca_2_OUT".scaler_43 <= -0.44576358795166016) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_82 <= 1.1208453476428986) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_47 <= 0.4729793220758438) THEN 3 ELSE 4 END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_79 <= 0.49118366837501526) THEN 6 ELSE 7 END END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_41 <= -0.6322095990180969) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_59 <= -0.3490726724267006) THEN 10 ELSE 11 END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_51 <= -1.2654942870140076) THEN 13 ELSE 14 END END END AS node_id_2 
FROM "TMP_20221018185458_A2YZJGY_ADS_sca_2_OUT" AS "ADS_sca_2_OUT"), 
"DT_node_data_3" AS 
(SELECT "Values".nid AS nid, "Values"."E" AS "E" 
...
FROM "DT_Output_5"), 
"DT_node_lookup_6" AS 
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", CASE WHEN ("ADS_sca_2_OUT".scaler_65 <= -0.2679380849003792) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_98 <= 1.5113595724105835) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_51 <= 1.2287238240242004) THEN 3 ELSE 4 END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_69 <= 0.5256731510162354) THEN 6 ELSE 7 END END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_71 <= 0.1751529984176159) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_81 <= -0.3422964923083782) THEN 10 ELSE 11 END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_45 <= -0.5059979557991028) THEN 13 ELSE 14 END END END AS node_id_2 
FROM "TMP_20221018185458_A2YZJGY_ADS_sca_2_OUT" AS "ADS_sca_2_OUT"), 
"DT_node_data_6" AS 
(SELECT "Values".nid AS nid, "Values"."E" AS "E" 
...
FROM "DT_Output_6"), 
"DT_node_lookup_7" AS 
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", CASE WHEN ("ADS_sca_2_OUT".scaler_43 <= -0.44576358795166016) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_57 <= 0.5646339952945709) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_81 <= 0.6599217355251312) THEN 3 ELSE 4 END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_17 <= 1.2226165533065796) THEN 6 ELSE 7 END END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_97 <= -0.4716874957084656) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_34 <= -0.6425999701023102) THEN 10 ELSE 11 END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_5 <= 1.1910450160503387) THEN 13 ELSE 14 END END END AS node_id_2 
FROM "TMP_20221018185458_A2YZJGY_ADS_sca_2_OUT" AS "ADS_sca_2_OUT"), 
"DT_node_data_7" AS 
(SELECT "Values".nid AS nid, "Values"."E" AS "E" 
...
FROM "DT_Output_7"), 
"DT_node_lookup_8" AS 
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", CASE WHEN ("ADS_sca_2_OUT".scaler_97 <= -0.3484189808368683) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_3 <= -1.4249722361564636) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_58 <= -0.9572751224040985) THEN 3 ELSE 4 END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_43 <= -0.48259589076042175) THEN 6 ELSE 7 END END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_81 <= 0.19375013560056686) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_70 <= -0.38685204833745956) THEN 10 ELSE 11 END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_71 <= -0.5826713740825653) THEN 13 ELSE 14 END END END AS node_id_2 
FROM "TMP_20221018185458_A2YZJGY_ADS_sca_2_OUT" AS "ADS_sca_2_OUT"), 
"DT_node_data_8" AS 
(SELECT "Values".nid AS nid, "Values"."E" AS "E" 
...
FROM "DT_Output_9")
 INSERT INTO "TMP_20221018185458_J342WB9_WE_B0" ("KEY", "Estimator", "Weight", est_index) SELECT "T"."KEY", "T"."Estimator", "T"."Weight", "T".est_index 
...
-- Code For temporary table TMP_20221018185458_FNJY328_WE_B1 part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221018185458_FNJY328_WE_B1" (
	"KEY" BIGINT, 
	"Estimator" DOUBLE, 
	"Weight" DOUBLE, 
	est_index BIGINT
...
-- Code For temporary table TMP_20221018185458_FNJY328_WE_B1 part 2. Populate

WITH "DT_node_lookup_10" AS 
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", CASE WHEN ("ADS_sca_2_OUT".scaler_65 <= -0.7392844557762146) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_58 <= -0.3591315820813179) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_80 <= 0.529553722590208) THEN 3 ELSE 4 END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_80 <= 0.815008282661438) THEN 6 ELSE 7 END END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_82 <= 0.8365673124790192) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_67 <= 1.101576328277588) THEN 10 ELSE 11 END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_95 <= 0.6311028674244881) THEN 13 ELSE 14 END END END AS node_id_2 
FROM "TMP_20221018185458_A2YZJGY_ADS_sca_2_OUT" AS "ADS_sca_2_OUT"), 
"DT_node_data_10" AS 
(SELECT "Values".nid AS nid, "Values"."E" AS "E" 
...
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", CASE WHEN ("ADS_sca_2_OUT".scaler_93 <= -0.2811480015516281) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_21 <= -0.6382255554199219) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_39 <= 0.1271977424621582) THEN 3 ELSE 4 END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_43 <= -0.24330993741750717) THEN 6 ELSE 7 END END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_41 <= 0.33645301312208176) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_64 <= 0.40926049649715424) THEN 10 ELSE 11 END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_82 <= 1.5126239657402039) THEN 13 ELSE 14 END END END AS node_id_2 
FROM "TMP_20221018185458_A2YZJGY_ADS_sca_2_OUT" AS "ADS_sca_2_OUT"), 
"DT_node_data_12" AS 
(SELECT "Values".nid AS nid, "Values"."E" AS "E" 
...
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", CASE WHEN ("ADS_sca_2_OUT".scaler_82 <= -0.2186263594776392) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_43 <= -0.4531792104244232) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_64 <= 1.2096076011657715) THEN 3 ELSE 4 END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_4 <= -0.6843443810939789) THEN 6 ELSE 7 END END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_43 <= -0.8599983751773834) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_62 <= 0.2424440011382103) THEN 10 ELSE 11 END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_80 <= -0.9687784910202026) THEN 13 ELSE 14 END END END AS node_id_2 
FROM "TMP_20221018185458_A2YZJGY_ADS_sca_2_OUT" AS "ADS_sca_2_OUT"), 
"DT_node_data_15" AS 
(SELECT "Values".nid AS nid, "Values"."E" AS "E" 
...
FROM "DT_Output_15")
 INSERT INTO "TMP_20221018185458_FNJY328_WE_B1" ("KEY", "Estimator", "Weight", est_index) SELECT "T"."KEY", "T"."Estimator", "T"."Weight", "T".est_index 
...
-- Code For temporary table TMP_20221018185458_XY7GHTV_Quantiles part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221018185458_XY7GHTV_Quantiles" (
	"KEY" BIGINT, 
	"Quantile" DOUBLE
)
...
-- Code For temporary table TMP_20221018185458_XY7GHTV_Quantiles part 2. Populate
...
FROM (SELECT "WE_B0"."KEY" AS "KEY", "WE_B0"."Estimator" AS "Estimator", "WE_B0"."Weight" AS "Weight", "WE_B0".est_index AS est_index 
FROM "TMP_20221018185458_J342WB9_WE_B0" AS "WE_B0" UNION ALL SELECT "WE_B1"."KEY" AS "KEY", "WE_B1"."Estimator" AS "Estimator", "WE_B1"."Weight" AS "Weight", "WE_B1".est_index AS est_index 
FROM "TMP_20221018185458_FNJY328_WE_B1" AS "WE_B1") AS "WE_EnsembleUnion"), 
...
WHERE u1."Estimator" >= u2."Estimator" AND u1."KEY" = u2."KEY" GROUP BY u1."KEY", u1.est_index, u1."Estimator", u1."Weight") AS "CW")
 INSERT INTO "TMP_20221018185458_XY7GHTV_Quantiles" ("KEY", "Quantile") SELECT "T"."KEY", "T"."Quantile" 
...
FROM "TMP_20221018185458_XY7GHTV_Quantiles" AS "Quantiles"