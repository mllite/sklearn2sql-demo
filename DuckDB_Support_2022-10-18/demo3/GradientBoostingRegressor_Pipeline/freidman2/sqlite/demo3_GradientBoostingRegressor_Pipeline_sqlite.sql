...
-- Code For temporary table TMP_20221018190214_Y4ZRIGK_ADS_imp_1_OUT part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221018190214_Y4ZRIGK_ADS_imp_1_OUT" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20221018190214_Y4ZRIGK_ADS_imp_1_OUT part 2. Populate

INSERT INTO "TMP_20221018190214_Y4ZRIGK_ADS_imp_1_OUT" ("KEY", imputer_output_2, imputer_output_3, imputer_output_4, imputer_output_5) SELECT "T"."KEY", "T".imputer_output_2, "T".imputer_output_3, "T".imputer_output_4, "T".imputer_output_5 
...
-- Code For temporary table TMP_20221018190214_Y4ZRIGK_ADS_imp_1_OUT part 3. Create Index 

CREATE INDEX "ix_TMP_20221018190214_Y4ZRIGK_ADS_imp_1_OUT_KEY" ON "TMP_20221018190214_Y4ZRIGK_ADS_imp_1_OUT" ("KEY")

-- Code For temporary table TMP_20221018190214_MRHOEN2_ADS_sca_2_OUT part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221018190214_MRHOEN2_ADS_sca_2_OUT" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20221018190214_MRHOEN2_ADS_sca_2_OUT part 2. Populate

INSERT INTO "TMP_20221018190214_MRHOEN2_ADS_sca_2_OUT" ("KEY", scaler_output_2, scaler_output_3, scaler_output_4, scaler_output_5) SELECT "T"."KEY", "T".scaler_output_2, "T".scaler_output_3, "T".scaler_output_4, "T".scaler_output_5 
...
FROM "TMP_20221018190214_Y4ZRIGK_ADS_imp_1_OUT" AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT") AS "T"

-- Code For temporary table TMP_20221018190214_MRHOEN2_ADS_sca_2_OUT part 3. Create Index 

CREATE INDEX "ix_TMP_20221018190214_MRHOEN2_ADS_sca_2_OUT_KEY" ON "TMP_20221018190214_MRHOEN2_ADS_sca_2_OUT" ("KEY")

-- Code For temporary table TMP_20221018190214_822VUPB_GB_B0 part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221018190214_822VUPB_GB_B0" (
	"KEY" BIGINT, 
	"Estimator" FLOAT
)
...
FROM "DT_Output_2"), 
"DT_node_lookup_3" AS 
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", CASE WHEN ("ADS_sca_2_OUT".scaler_output_4 <= 0.017649224493652582) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_output_4 <= -0.9838692843914032) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_output_4 <= -1.4309000372886658) THEN 3 ELSE 4 END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_output_3 <= 0.0221049627289176) THEN 6 ELSE 7 END END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_output_3 <= -0.28210045397281647) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_output_3 <= -1.3361194133758545) THEN 10 ELSE 11 END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_output_3 <= 0.5316546559333801) THEN 13 ELSE 14 END END END AS node_id_2 
FROM "TMP_20221018190214_MRHOEN2_ADS_sca_2_OUT" AS "ADS_sca_2_OUT"), 
"DT_node_data_3" AS 
(SELECT "Values".nid AS nid, "Values"."E" AS "E" 
...
FROM "DT_Output_3"), 
"DT_node_lookup_4" AS 
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", CASE WHEN ("ADS_sca_2_OUT".scaler_output_4 <= -0.4017176181077957) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_output_4 <= -1.4309000372886658) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_output_4 <= -1.6865600943565369) THEN 3 ELSE 4 END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_output_3 <= -0.1512136021628976) THEN 6 ELSE 7 END END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_output_3 <= -0.4353671967983246) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_output_3 <= -1.3361194133758545) THEN 10 ELSE 11 END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_output_4 <= 0.9230736196041107) THEN 13 ELSE 14 END END END AS node_id_2 
FROM "TMP_20221018190214_MRHOEN2_ADS_sca_2_OUT" AS "ADS_sca_2_OUT"), 
"DT_node_data_4" AS 
(SELECT "Values".nid AS nid, "Values"."E" AS "E" 
...
FROM "DT_Output_4"), 
"DT_node_lookup_5" AS 
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", CASE WHEN ("ADS_sca_2_OUT".scaler_output_4 <= 0.017649224493652582) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_output_3 <= -0.10602238867431879) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_output_3 <= -1.0177715122699738) THEN 3 ELSE 4 END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_output_4 <= -0.5216203033924103) THEN 6 ELSE 7 END END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_output_3 <= 0.047109299222938716) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_output_3 <= -0.8755245804786682) THEN 10 ELSE 11 END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_output_4 <= 0.9779741168022156) THEN 13 ELSE 14 END END END AS node_id_2 
FROM "TMP_20221018190214_MRHOEN2_ADS_sca_2_OUT" AS "ADS_sca_2_OUT"), 
"DT_node_data_5" AS 
(SELECT "Values".nid AS nid, "Values"."E" AS "E" 
...
FROM "DT_Output_8"), 
"DT_node_lookup_9" AS 
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", CASE WHEN ("ADS_sca_2_OUT".scaler_output_4 <= 0.5367825776338577) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_output_3 <= 1.516704261302948) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_output_3 <= -0.24217423051595688) THEN 3 ELSE 4 END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_output_3 <= 1.6743407249450684) THEN 6 ELSE 7 END END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_output_3 <= -0.28210045397281647) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_output_3 <= -1.2677711248397827) THEN 10 ELSE 11 END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_output_3 <= 1.0630581974983215) THEN 13 ELSE 14 END END END AS node_id_2 
FROM "TMP_20221018190214_MRHOEN2_ADS_sca_2_OUT" AS "ADS_sca_2_OUT"), 
"DT_node_data_9" AS 
(SELECT "Values".nid AS nid, "Values"."E" AS "E" 
...
FROM "DT_Output_9")
 INSERT INTO "TMP_20221018190214_822VUPB_GB_B0" ("KEY", "Estimator") SELECT "T"."KEY", "T"."Estimator" 
...
-- Code For temporary table TMP_20221018190214_RUVG4BC_GB_B1 part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221018190214_RUVG4BC_GB_B1" (
	"KEY" BIGINT, 
	"Estimator" FLOAT
)
...
-- Code For temporary table TMP_20221018190214_RUVG4BC_GB_B1 part 2. Populate

WITH "DT_node_lookup_10" AS 
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", CASE WHEN ("ADS_sca_2_OUT".scaler_output_4 <= 0.8996041715145111) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_output_3 <= -0.16254910826683044) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_output_3 <= -1.0177715122699738) THEN 3 ELSE 4 END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_output_4 <= -0.5216203033924103) THEN 6 ELSE 7 END END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_output_3 <= 0.1398281529545784) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_output_3 <= -1.0464974641799927) THEN 10 ELSE 11 END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_output_3 <= 1.0630581974983215) THEN 13 ELSE 14 END END END AS node_id_2 
FROM "TMP_20221018190214_MRHOEN2_ADS_sca_2_OUT" AS "ADS_sca_2_OUT"), 
"DT_node_data_10" AS 
(SELECT "Values".nid AS nid, "Values"."E" AS "E" 
...
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", CASE WHEN ("ADS_sca_2_OUT".scaler_output_4 <= 0.5367825776338577) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_output_3 <= 1.516704261302948) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_output_4 <= -0.9838692843914032) THEN 3 ELSE 4 END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_output_4 <= -1.2832203805446625) THEN 6 ELSE 7 END END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_output_3 <= 0.2745868116617203) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_output_3 <= -1.2677711248397827) THEN 10 ELSE 11 END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_output_3 <= 1.0630581974983215) THEN 13 ELSE 14 END END END AS node_id_2 
FROM "TMP_20221018190214_MRHOEN2_ADS_sca_2_OUT" AS "ADS_sca_2_OUT"), 
"DT_node_data_12" AS 
(SELECT "Values".nid AS nid, "Values"."E" AS "E" 
...
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", CASE WHEN ("ADS_sca_2_OUT".scaler_output_4 <= 0.1700807735323906) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_output_3 <= 1.516704261302948) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_output_3 <= -0.6873287558555603) THEN 3 ELSE 4 END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_output_3 <= 1.6743407249450684) THEN 6 ELSE 7 END END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_output_3 <= 0.732145756483078) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_output_3 <= -0.4353671967983246) THEN 10 ELSE 11 END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_output_5 <= -0.6559995897114277) THEN 13 ELSE 14 END END END AS node_id_2 
FROM "TMP_20221018190214_MRHOEN2_ADS_sca_2_OUT" AS "ADS_sca_2_OUT"), 
"DT_node_data_13" AS 
(SELECT "Values".nid AS nid, "Values"."E" AS "E" 
...
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", CASE WHEN ("ADS_sca_2_OUT".scaler_output_4 <= 0.8996041715145111) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_output_3 <= -0.12360849976539612) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_output_3 <= -1.4265539050102234) THEN 3 ELSE 4 END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_output_4 <= -1.0265016853809357) THEN 6 ELSE 7 END END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_output_3 <= 0.26137249171733856) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_output_3 <= -1.0464974641799927) THEN 10 ELSE 11 END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_output_4 <= 1.5360115766525269) THEN 13 ELSE 14 END END END AS node_id_2 
FROM "TMP_20221018190214_MRHOEN2_ADS_sca_2_OUT" AS "ADS_sca_2_OUT"), 
"DT_node_data_15" AS 
(SELECT "Values".nid AS nid, "Values"."E" AS "E" 
...
FROM "DT_Output_15")
 INSERT INTO "TMP_20221018190214_RUVG4BC_GB_B1" ("KEY", "Estimator") SELECT "T"."KEY", "T"."Estimator" 
...
-- Code For temporary table TMP_20221018190214_ZQVFD3V_GB_sum part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221018190214_ZQVFD3V_GB_sum" (
	"KEY" BIGINT NOT NULL, 
	"Estimator" FLOAT, 
	PRIMARY KEY ("KEY")
)
...
-- Code For temporary table TMP_20221018190214_ZQVFD3V_GB_sum part 2. Populate

WITH "GB_Union" AS 
(SELECT "GB_EnsembleUnion"."KEY" AS "KEY", "GB_EnsembleUnion"."Estimator" AS "Estimator" 
FROM (SELECT "GB_B0"."KEY" AS "KEY", "GB_B0"."Estimator" AS "Estimator" 
FROM "TMP_20221018190214_822VUPB_GB_B0" AS "GB_B0" UNION ALL SELECT "GB_B1"."KEY" AS "KEY", "GB_B1"."Estimator" AS "Estimator" 
FROM "TMP_20221018190214_RUVG4BC_GB_B1" AS "GB_B1") AS "GB_EnsembleUnion")
 INSERT INTO "TMP_20221018190214_ZQVFD3V_GB_sum" ("KEY", "Estimator") SELECT "T"."KEY", "T"."Estimator" 
...
-- Code For temporary table TMP_20221018190214_ZQVFD3V_GB_sum part 3. Create Index 

CREATE INDEX "ix_TMP_20221018190214_ZQVFD3V_GB_sum_KEY" ON "TMP_20221018190214_ZQVFD3V_GB_sum" ("KEY")

-- Model deployment code

SELECT "GB_sum"."KEY" AS "KEY", 499.09288446517394 + 0.1 * "GB_sum"."Estimator" AS "Estimator" 
FROM "TMP_20221018190214_ZQVFD3V_GB_sum" AS "GB_sum"