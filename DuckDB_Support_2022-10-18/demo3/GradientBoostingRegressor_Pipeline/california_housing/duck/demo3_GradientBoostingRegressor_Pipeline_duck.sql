...
-- Code For temporary table TMP_20221018185619_Z0JRYP5_ADS_imp_1_OUT part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221018185619_Z0JRYP5_ADS_imp_1_OUT" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20221018185619_Z0JRYP5_ADS_imp_1_OUT part 3. Create Index 

CREATE INDEX "ix_TMP_20221018185619_Z0JRYP5_ADS_imp_1_OUT_KEY" ON "TMP_20221018185619_Z0JRYP5_ADS_imp_1_OUT" ("KEY")

-- Code For temporary table TMP_20221018185619_LP9IEQG_ADS_sca_2_OUT part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221018185619_LP9IEQG_ADS_sca_2_OUT" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20221018185619_LP9IEQG_ADS_sca_2_OUT part 2. Populate

INSERT INTO "TMP_20221018185619_LP9IEQG_ADS_sca_2_OUT" ("KEY", scaler_output_2, scaler_output_3, scaler_output_4, scaler_output_5, scaler_output_6, scaler_output_7, scaler_output_8, scaler_output_9) SELECT "T"."KEY", "T".scaler_output_2, "T".scaler_output_3, "T".scaler_output_4, "T".scaler_output_5, "T".scaler_output_6, "T".scaler_output_7, "T".scaler_output_8, "T".scaler_output_9 
...
FROM "TMP_20221018185619_Z0JRYP5_ADS_imp_1_OUT" AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT") AS "T"

-- Code For temporary table TMP_20221018185619_LP9IEQG_ADS_sca_2_OUT part 3. Create Index 

CREATE INDEX "ix_TMP_20221018185619_LP9IEQG_ADS_sca_2_OUT_KEY" ON "TMP_20221018185619_LP9IEQG_ADS_sca_2_OUT" ("KEY")

-- Code For temporary table TMP_20221018185619_LLG2DVB_GB_B0 part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221018185619_LLG2DVB_GB_B0" (
	"KEY" BIGINT, 
	"Estimator" DOUBLE
)
...
-- Code For temporary table TMP_20221018185619_LLG2DVB_GB_B0 part 2. Populate
...
FROM "TMP_20221018185619_LP9IEQG_ADS_sca_2_OUT" AS "ADS_sca_2_OUT"), 
"DT_node_data" AS 
...
FROM "DT_Output_9")
 INSERT INTO "TMP_20221018185619_LLG2DVB_GB_B0" ("KEY", "Estimator") SELECT "T"."KEY", "T"."Estimator" 
...
-- Code For temporary table TMP_20221018185619_IX1QTRL_GB_B1 part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221018185619_IX1QTRL_GB_B1" (
	"KEY" BIGINT, 
	"Estimator" DOUBLE
)
...
-- Code For temporary table TMP_20221018185619_IX1QTRL_GB_B1 part 2. Populate
...
FROM "DT_Output_15")
 INSERT INTO "TMP_20221018185619_IX1QTRL_GB_B1" ("KEY", "Estimator") SELECT "T"."KEY", "T"."Estimator" 
...
-- Code For temporary table TMP_20221018185619_AX4X5Q6_GB_sum part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221018185619_AX4X5Q6_GB_sum" (
	"KEY" BIGINT NOT NULL, 
	"Estimator" DOUBLE, 
	PRIMARY KEY ("KEY")
)
...
-- Code For temporary table TMP_20221018185619_AX4X5Q6_GB_sum part 2. Populate

WITH "GB_Union" AS 
(SELECT "GB_EnsembleUnion"."KEY" AS "KEY", "GB_EnsembleUnion"."Estimator" AS "Estimator" 
FROM (SELECT "GB_B0"."KEY" AS "KEY", "GB_B0"."Estimator" AS "Estimator" 
FROM "TMP_20221018185619_LLG2DVB_GB_B0" AS "GB_B0" UNION ALL SELECT "GB_B1"."KEY" AS "KEY", "GB_B1"."Estimator" AS "Estimator" 
FROM "TMP_20221018185619_IX1QTRL_GB_B1" AS "GB_B1") AS "GB_EnsembleUnion")
 INSERT INTO "TMP_20221018185619_AX4X5Q6_GB_sum" ("KEY", "Estimator") SELECT "T"."KEY", "T"."Estimator" 
...
-- Code For temporary table TMP_20221018185619_AX4X5Q6_GB_sum part 3. Create Index 

CREATE INDEX "ix_TMP_20221018185619_AX4X5Q6_GB_sum_KEY" ON "TMP_20221018185619_AX4X5Q6_GB_sum" ("KEY")

-- Model deployment code

SELECT "GB_sum"."KEY" AS "KEY", 2.071195173207365 + 0.1 * "GB_sum"."Estimator" AS "Estimator" 
FROM "TMP_20221018185619_AX4X5Q6_GB_sum" AS "GB_sum"