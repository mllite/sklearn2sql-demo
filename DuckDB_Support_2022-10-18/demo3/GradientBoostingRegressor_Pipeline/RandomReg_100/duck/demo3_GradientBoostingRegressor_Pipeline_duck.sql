...
-- Code For temporary table TMP_20221018185516_CUJT8NL_ADS_imp_1_OUT part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221018185516_CUJT8NL_ADS_imp_1_OUT" (
	"KEY" BIGINT NOT NULL, 
	impter_2 DOUBLE, 
	impter_3 DOUBLE, 
	impter_4 DOUBLE, 
...
-- Code For temporary table TMP_20221018185516_CUJT8NL_ADS_imp_1_OUT part 3. Create Index 

CREATE INDEX "ix_TMP_20221018185516_CUJT8NL_ADS_imp_1_OUT_KEY" ON "TMP_20221018185516_CUJT8NL_ADS_imp_1_OUT" ("KEY")

-- Code For temporary table TMP_20221018185516_L3B292S_ADS_sca_2_OUT part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221018185516_L3B292S_ADS_sca_2_OUT" (
	"KEY" BIGINT NOT NULL, 
	scaler_2 DOUBLE, 
	scaler_3 DOUBLE, 
	scaler_4 DOUBLE, 
...
FROM "TMP_20221018185516_CUJT8NL_ADS_imp_1_OUT" AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT") AS "T"

-- Code For temporary table TMP_20221018185516_L3B292S_ADS_sca_2_OUT part 3. Create Index 

CREATE INDEX "ix_TMP_20221018185516_L3B292S_ADS_sca_2_OUT_KEY" ON "TMP_20221018185516_L3B292S_ADS_sca_2_OUT" ("KEY")

-- Code For temporary table TMP_20221018185516_U4TRHG0_GB_B0 part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221018185516_U4TRHG0_GB_B0" (
	"KEY" BIGINT, 
	"Estimator" DOUBLE
)
...
FROM "DT_Output"), 
"DT_node_lookup_1" AS 
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", CASE WHEN ("ADS_sca_2_OUT".scaler_82 <= -0.17478496581315994) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_43 <= -0.4531792104244232) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_57 <= 0.6153919100761414) THEN 3 ELSE 4 END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_65 <= -0.02475996594876051) THEN 6 ELSE 7 END END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_3 <= 0.6375933587551117) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_65 <= -1.5091531872749329) THEN 10 ELSE 11 END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_30 <= 0.8356819748878479) THEN 13 ELSE 14 END END END AS node_id_2 
FROM "TMP_20221018185516_L3B292S_ADS_sca_2_OUT" AS "ADS_sca_2_OUT"), 
"DT_node_data_1" AS 
(SELECT "Values".nid AS nid, "Values"."E" AS "E" 
...
FROM "DT_Output_2"), 
"DT_node_lookup_3" AS 
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", CASE WHEN ("ADS_sca_2_OUT".scaler_82 <= -0.17478496581315994) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_43 <= -0.4531792104244232) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_65 <= 0.07095328532159328) THEN 3 ELSE 4 END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_65 <= 0.05197323486208916) THEN 6 ELSE 7 END END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_96 <= -0.4484616070985794) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_22 <= 0.6656260192394257) THEN 10 ELSE 11 END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_51 <= 1.2287238240242004) THEN 13 ELSE 14 END END END AS node_id_2 
FROM "TMP_20221018185516_L3B292S_ADS_sca_2_OUT" AS "ADS_sca_2_OUT"), 
"DT_node_data_3" AS 
(SELECT "Values".nid AS nid, "Values"."E" AS "E" 
...
FROM "DT_Output_3"), 
"DT_node_lookup_4" AS 
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", CASE WHEN ("ADS_sca_2_OUT".scaler_82 <= -0.07055003009736538) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_43 <= -0.4531792104244232) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_57 <= 0.6153919100761414) THEN 3 ELSE 4 END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_65 <= -0.02475996594876051) THEN 6 ELSE 7 END END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_96 <= -0.39707985520362854) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_37 <= 0.6634410321712494) THEN 10 ELSE 11 END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_19 <= -0.27718599885702133) THEN 13 ELSE 14 END END END AS node_id_2 
FROM "TMP_20221018185516_L3B292S_ADS_sca_2_OUT" AS "ADS_sca_2_OUT"), 
"DT_node_data_4" AS 
(SELECT "Values".nid AS nid, "Values"."E" AS "E" 
...
FROM "DT_Output_4"), 
"DT_node_lookup_5" AS 
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", CASE WHEN ("ADS_sca_2_OUT".scaler_82 <= -0.07055003009736538) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_43 <= -0.4531792104244232) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_98 <= 1.0108441710472107) THEN 3 ELSE 4 END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_65 <= 0.03369514364749193) THEN 6 ELSE 7 END END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_96 <= -0.39707985520362854) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_37 <= 0.6634410321712494) THEN 10 ELSE 11 END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_36 <= 0.8252341449260712) THEN 13 ELSE 14 END END END AS node_id_2 
FROM "TMP_20221018185516_L3B292S_ADS_sca_2_OUT" AS "ADS_sca_2_OUT"), 
"DT_node_data_5" AS 
(SELECT "Values".nid AS nid, "Values"."E" AS "E" 
...
FROM "DT_Output_6"), 
"DT_node_lookup_7" AS 
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", CASE WHEN ("ADS_sca_2_OUT".scaler_82 <= -0.5905457437038422) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_73 <= 0.7834736704826355) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_44 <= 0.41072921454906464) THEN 3 ELSE 4 END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_20 <= -0.302820585668087) THEN 6 ELSE 7 END END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_41 <= 0.43509984016418457) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_70 <= 0.7948545515537262) THEN 10 ELSE 11 END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_3 <= 1.5182774662971497) THEN 13 ELSE 14 END END END AS node_id_2 
FROM "TMP_20221018185516_L3B292S_ADS_sca_2_OUT" AS "ADS_sca_2_OUT"), 
"DT_node_data_7" AS 
(SELECT "Values".nid AS nid, "Values"."E" AS "E" 
...
FROM "DT_Output_7"), 
"DT_node_lookup_8" AS 
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", CASE WHEN ("ADS_sca_2_OUT".scaler_82 <= -0.07055003009736538) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_65 <= -0.02084826398640871) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_43 <= -0.15556256100535393) THEN 3 ELSE 4 END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_43 <= -0.5887479782104492) THEN 6 ELSE 7 END END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_61 <= -0.09043214842677116) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_43 <= -1.6150081157684326) THEN 10 ELSE 11 END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_64 <= 0.42822621762752533) THEN 13 ELSE 14 END END END AS node_id_2 
FROM "TMP_20221018185516_L3B292S_ADS_sca_2_OUT" AS "ADS_sca_2_OUT"), 
"DT_node_data_8" AS 
(SELECT "Values".nid AS nid, "Values"."E" AS "E" 
...
FROM "DT_Output_8"), 
"DT_node_lookup_9" AS 
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", CASE WHEN ("ADS_sca_2_OUT".scaler_82 <= -0.07055003009736538) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_97 <= -0.3484189808368683) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_18 <= -0.4399261623620987) THEN 3 ELSE 4 END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_14 <= -1.1575462222099304) THEN 6 ELSE 7 END END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_96 <= -0.39707985520362854) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_37 <= 0.6634410321712494) THEN 10 ELSE 11 END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_97 <= 1.1422433257102966) THEN 13 ELSE 14 END END END AS node_id_2 
FROM "TMP_20221018185516_L3B292S_ADS_sca_2_OUT" AS "ADS_sca_2_OUT"), 
"DT_node_data_9" AS 
(SELECT "Values".nid AS nid, "Values"."E" AS "E" 
...
FROM "DT_Output_9")
 INSERT INTO "TMP_20221018185516_U4TRHG0_GB_B0" ("KEY", "Estimator") SELECT "T"."KEY", "T"."Estimator" 
...
-- Code For temporary table TMP_20221018185516_2UI6ZDN_GB_B1 part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221018185516_2UI6ZDN_GB_B1" (
	"KEY" BIGINT, 
	"Estimator" DOUBLE
)
...
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", CASE WHEN ("ADS_sca_2_OUT".scaler_43 <= -0.44576358795166016) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_90 <= 1.7877029776573181) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_83 <= 0.8135848641395569) THEN 3 ELSE 4 END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_57 <= 0.02693411731161177) THEN 6 ELSE 7 END END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_94 <= -0.8815765380859375) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_39 <= 0.933567076921463) THEN 10 ELSE 11 END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_11 <= 0.5701085031032562) THEN 13 ELSE 14 END END END AS node_id_2 
FROM "TMP_20221018185516_L3B292S_ADS_sca_2_OUT" AS "ADS_sca_2_OUT"), 
"DT_node_data_12" AS 
(SELECT "Values".nid AS nid, "Values"."E" AS "E" 
...
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", CASE WHEN ("ADS_sca_2_OUT".scaler_97 <= -0.3168947398662567) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_65 <= -0.02469797572121024) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_43 <= 0.11185506358742714) THEN 3 ELSE 4 END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_68 <= -0.02588743157684803) THEN 6 ELSE 7 END END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_41 <= 0.6266658008098602) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_82 <= 0.612818032503128) THEN 10 ELSE 11 END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_17 <= -0.16016592644155025) THEN 13 ELSE 14 END END END AS node_id_2 
FROM "TMP_20221018185516_L3B292S_ADS_sca_2_OUT" AS "ADS_sca_2_OUT"), 
"DT_node_data_14" AS 
(SELECT "Values".nid AS nid, "Values"."E" AS "E" 
...
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", CASE WHEN ("ADS_sca_2_OUT".scaler_43 <= -0.44576358795166016) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_90 <= 1.7877029776573181) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_57 <= 0.6153919100761414) THEN 3 ELSE 4 END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_91 <= 0.7677144855260849) THEN 6 ELSE 7 END END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_94 <= -0.8815765380859375) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_96 <= -0.6311716884374619) THEN 10 ELSE 11 END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_46 <= -1.481136977672577) THEN 13 ELSE 14 END END END AS node_id_2 
FROM "TMP_20221018185516_L3B292S_ADS_sca_2_OUT" AS "ADS_sca_2_OUT"), 
"DT_node_data_15" AS 
(SELECT "Values".nid AS nid, "Values"."E" AS "E" 
...
FROM "DT_Output_15")
 INSERT INTO "TMP_20221018185516_2UI6ZDN_GB_B1" ("KEY", "Estimator") SELECT "T"."KEY", "T"."Estimator" 
...
-- Code For temporary table TMP_20221018185516_PD2KGPQ_GB_sum part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221018185516_PD2KGPQ_GB_sum" (
	"KEY" BIGINT NOT NULL, 
	"Estimator" DOUBLE, 
	PRIMARY KEY ("KEY")
)
...
-- Code For temporary table TMP_20221018185516_PD2KGPQ_GB_sum part 2. Populate

WITH "GB_Union" AS 
(SELECT "GB_EnsembleUnion"."KEY" AS "KEY", "GB_EnsembleUnion"."Estimator" AS "Estimator" 
FROM (SELECT "GB_B0"."KEY" AS "KEY", "GB_B0"."Estimator" AS "Estimator" 
FROM "TMP_20221018185516_U4TRHG0_GB_B0" AS "GB_B0" UNION ALL SELECT "GB_B1"."KEY" AS "KEY", "GB_B1"."Estimator" AS "Estimator" 
FROM "TMP_20221018185516_2UI6ZDN_GB_B1" AS "GB_B1") AS "GB_EnsembleUnion")
 INSERT INTO "TMP_20221018185516_PD2KGPQ_GB_sum" ("KEY", "Estimator") SELECT "T"."KEY", "T"."Estimator" 
...
-- Code For temporary table TMP_20221018185516_PD2KGPQ_GB_sum part 3. Create Index 

CREATE INDEX "ix_TMP_20221018185516_PD2KGPQ_GB_sum_KEY" ON "TMP_20221018185516_PD2KGPQ_GB_sum" ("KEY")

-- Model deployment code

SELECT "GB_sum"."KEY" AS "KEY", -11.471614782695335 + 0.1 * "GB_sum"."Estimator" AS "Estimator" 
FROM "TMP_20221018185516_PD2KGPQ_GB_sum" AS "GB_sum"