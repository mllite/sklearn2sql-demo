...
-- Code For temporary table TMP_20221018184836_TRRGP5Q_ADS_imp_1_OUT part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221018184836_TRRGP5Q_ADS_imp_1_OUT" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20221018184836_TRRGP5Q_ADS_imp_1_OUT part 3. Create Index 

CREATE INDEX "ix_TMP_20221018184836_TRRGP5Q_ADS_imp_1_OUT_KEY" ON "TMP_20221018184836_TRRGP5Q_ADS_imp_1_OUT" ("KEY")

-- Code For temporary table TMP_20221018184836_MBPSUL6_ADS_sca_2_OUT part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221018184836_MBPSUL6_ADS_sca_2_OUT" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20221018184836_MBPSUL6_ADS_sca_2_OUT part 2. Populate

INSERT INTO "TMP_20221018184836_MBPSUL6_ADS_sca_2_OUT" ("KEY", scaler_output_2, scaler_output_3, scaler_output_4, scaler_output_5, scaler_output_6, scaler_output_7, scaler_output_8, scaler_output_9, scaler_output_10, scaler_output_11) SELECT "T"."KEY", "T".scaler_output_2, "T".scaler_output_3, "T".scaler_output_4, "T".scaler_output_5, "T".scaler_output_6, "T".scaler_output_7, "T".scaler_output_8, "T".scaler_output_9, "T".scaler_output_10, "T".scaler_output_11 
...
FROM "TMP_20221018184836_TRRGP5Q_ADS_imp_1_OUT" AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT") AS "T"

-- Code For temporary table TMP_20221018184836_MBPSUL6_ADS_sca_2_OUT part 3. Create Index 

CREATE INDEX "ix_TMP_20221018184836_MBPSUL6_ADS_sca_2_OUT_KEY" ON "TMP_20221018184836_MBPSUL6_ADS_sca_2_OUT" ("KEY")

-- Code For temporary table TMP_20221018184836_GAJEDZ5_HL_1_relu_1 part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221018184836_GAJEDZ5_HL_1_relu_1" (
	"KEY" BIGINT NOT NULL, 
	"NEUR_1_1" FLOAT, 
	"NEUR_1_2" FLOAT, 
	"NEUR_1_3" FLOAT, 
...
-- Code For temporary table TMP_20221018184836_GAJEDZ5_HL_1_relu_1 part 2. Populate
...
FROM "TMP_20221018184836_MBPSUL6_ADS_sca_2_OUT" AS "ADS_sca_2_OUT"), 
"HL_BA_1" AS 
...
FROM "HL_BA_1")
 INSERT INTO "TMP_20221018184836_GAJEDZ5_HL_1_relu_1" ("KEY", "NEUR_1_1", "NEUR_1_2", "NEUR_1_3") SELECT "T"."KEY", "T"."NEUR_1_1", "T"."NEUR_1_2", "T"."NEUR_1_3" 
...
-- Code For temporary table TMP_20221018184836_GAJEDZ5_HL_1_relu_1 part 3. Create Index 

CREATE INDEX "ix_TMP_20221018184836_GAJEDZ5_HL_1_relu_1_KEY" ON "TMP_20221018184836_GAJEDZ5_HL_1_relu_1" ("KEY")

-- Code For temporary table TMP_20221018184836_DATW2NG_OL_logistic_1 part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221018184836_DATW2NG_OL_logistic_1" (
	"KEY" BIGINT NOT NULL, 
	"NEUR_3_1" FLOAT, 
	PRIMARY KEY ("KEY")
)
...
-- Code For temporary table TMP_20221018184836_DATW2NG_OL_logistic_1 part 2. Populate
...
FROM "TMP_20221018184836_GAJEDZ5_HL_1_relu_1" AS "HL_1_relu_1"), 
"HL_2_relu" AS 
...
FROM "OL_BA")
 INSERT INTO "TMP_20221018184836_DATW2NG_OL_logistic_1" ("KEY", "NEUR_3_1") SELECT "T"."KEY", "T"."NEUR_3_1" 
...
-- Code For temporary table TMP_20221018184836_DATW2NG_OL_logistic_1 part 3. Create Index 

CREATE INDEX "ix_TMP_20221018184836_DATW2NG_OL_logistic_1_KEY" ON "TMP_20221018184836_DATW2NG_OL_logistic_1" ("KEY")
...
FROM "TMP_20221018184836_DATW2NG_OL_logistic_1" AS "OL_logistic_1"), 
