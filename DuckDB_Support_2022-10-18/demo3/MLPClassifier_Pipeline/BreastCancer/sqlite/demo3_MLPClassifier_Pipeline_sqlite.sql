...
-- Code For temporary table TMP_20221018185100_KPZ3810_ADS_imp_1_OUT part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221018185100_KPZ3810_ADS_imp_1_OUT" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20221018185100_KPZ3810_ADS_imp_1_OUT part 3. Create Index 

CREATE INDEX "ix_TMP_20221018185100_KPZ3810_ADS_imp_1_OUT_KEY" ON "TMP_20221018185100_KPZ3810_ADS_imp_1_OUT" ("KEY")

-- Code For temporary table TMP_20221018185100_THM082B_ADS_sca_2_OUT part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221018185100_THM082B_ADS_sca_2_OUT" (
	"KEY" BIGINT NOT NULL, 
...
FROM "TMP_20221018185100_KPZ3810_ADS_imp_1_OUT" AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT") AS "T"

-- Code For temporary table TMP_20221018185100_THM082B_ADS_sca_2_OUT part 3. Create Index 

CREATE INDEX "ix_TMP_20221018185100_THM082B_ADS_sca_2_OUT_KEY" ON "TMP_20221018185100_THM082B_ADS_sca_2_OUT" ("KEY")

-- Code For temporary table TMP_20221018185100_G80E5XX_HL_1_relu_1 part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221018185100_G80E5XX_HL_1_relu_1" (
	"KEY" BIGINT NOT NULL, 
	"NEUR_1_1" FLOAT, 
	"NEUR_1_2" FLOAT, 
	"NEUR_1_3" FLOAT, 
...
-- Code For temporary table TMP_20221018185100_G80E5XX_HL_1_relu_1 part 2. Populate
...
FROM "TMP_20221018185100_THM082B_ADS_sca_2_OUT" AS "ADS_sca_2_OUT"), 
"HL_BA_1" AS 
(SELECT "IL"."KEY" AS "KEY", 0.6035521390925315 * "IL".scaler_output_2 + 1.2192753918755233 * "IL".scaler_output_3 + 0.36456781322703435 * "IL".scaler_output_4 + -0.09403360765033411 * "IL".scaler_output_5 + -0.7019130998425066 * "IL".scaler_output_6 + 1.0722042720291307 * "IL".scaler_output_7 + -1.018869880161723 * "IL".scaler_output_8 + -0.9825516043515834 * "IL".scaler_output_9 + -0.11165166949368867 * "IL".scaler_output_10 + -1.3214658680580396 * "IL".scaler_output_11 + -2.1600941509850733 * "IL".scaler_output_12 + -0.39714822920708576 * "IL".scaler_output_13 + -0.9811946192762169 * "IL".scaler_output_14 + -0.9508726647107313 * "IL".scaler_output_15 + 0.8291423737687466 * "IL".scaler_output_16 + 2.094348077008852 * "IL".scaler_output_17 + 0.07088330452147565 * "IL".scaler_output_18 + -0.44613963761733744 * "IL".scaler_output_19 + 0.9355619170253017 * "IL".scaler_output_20 + 1.056126842178461 * "IL".scaler_output_21 + -0.8402585978306173 * "IL".scaler_output_22 + -0.03150634068077493 * "IL".scaler_output_23 + 0.10202154671519746 * "IL".scaler_output_24 + -1.0296779074644868 * "IL".scaler_output_25 + -0.6852008687287217 * "IL".scaler_output_26 + 0.75696583958304 * "IL".scaler_output_27 + -1.0400787656400912 * "IL".scaler_output_28 + -0.5718418433133267 * "IL".scaler_output_29 + -0.20226517170791147 * "IL".scaler_output_30 + 0.3201751481218064 * "IL".scaler_output_31 + 2.7265841046700645 AS "NEUR_1_1", 0.524038293874263 * "IL".scaler_output_2 + -0.6256426237945849 * "IL".scaler_output_3 + 0.16886649831505124 * "IL".scaler_output_4 + 0.4540505763298142 * "IL".scaler_output_5 + 0.6219828093920308 * "IL".scaler_output_6 + 0.607489189749682 * "IL".scaler_output_7 + -0.7708942755925505 * "IL".scaler_output_8 + -0.6802527248197098 * "IL".scaler_output_9 + -0.2886796881298855 * "IL".scaler_output_10 + -0.5572486467865753 * "IL".scaler_output_11 + -1.5774791949650042 * "IL".scaler_output_12 + -1.4521162812630761 * "IL".scaler_output_13 + -1.0565409595096444 * "IL".scaler_output_14 + -0.5476386381163979 * "IL".scaler_output_15 + 1.2264786735699935 * "IL".scaler_output_16 + 0.3828511747007643 * "IL".scaler_output_17 + -0.1093987537319709 * "IL".scaler_output_18 + -0.23929423704878877 * "IL".scaler_output_19 + 0.06294999162377835 * "IL".scaler_output_20 + 0.7341656655599693 * "IL".scaler_output_21 + -0.5778805156295629 * "IL".scaler_output_22 + -1.9022439127763398 * "IL".scaler_output_23 + -0.33737755693920557 * "IL".scaler_output_24 + -0.27210395099894785 * "IL".scaler_output_25 + 0.525820290215527 * "IL".scaler_output_26 + -0.33564064662881293 * "IL".scaler_output_27 + -1.2393254344550244 * "IL".scaler_output_28 + -0.23335965270053727 * "IL".scaler_output_29 + -0.8140219346057387 * "IL".scaler_output_30 + -0.9325380241951522 * "IL".scaler_output_31 + 1.0332920200101883 AS "NEUR_1_2", 1.3578064125521647 * "IL".scaler_output_2 + 0.37601758415282305 * "IL".scaler_output_3 + 1.119844877628679 * "IL".scaler_output_4 + 1.0480438362510702 * "IL".scaler_output_5 + -0.05174207591519528 * "IL".scaler_output_6 + -0.04053112487869231 * "IL".scaler_output_7 + 1.875496683873208 * "IL".scaler_output_8 + 1.8551579743047795 * "IL".scaler_output_9 + -0.030320630575883006 * "IL".scaler_output_10 + -0.04438482603211126 * "IL".scaler_output_11 + 1.1277652509256921 * "IL".scaler_output_12 + -1.2928436206254221 * "IL".scaler_output_13 + 0.7655464987442145 * "IL".scaler_output_14 + 1.0363317251998996 * "IL".scaler_output_15 + 0.019817867776560964 * "IL".scaler_output_16 + -1.2968969931177425 * "IL".scaler_output_17 + -0.2885499342252627 * "IL".scaler_output_18 + 0.12253475804226464 * "IL".scaler_output_19 + 0.5580325896550815 * "IL".scaler_output_20 + -1.3726571132426308 * "IL".scaler_output_21 + 1.632557518374377 * "IL".scaler_output_22 + 2.543590966234513 * "IL".scaler_output_23 + 0.986531086766298 * "IL".scaler_output_24 + 1.907800849512982 * "IL".scaler_output_25 + 1.4305187086740971 * "IL".scaler_output_26 + -0.05490218231796687 * "IL".scaler_output_27 + 2.0709736901219458 * "IL".scaler_output_28 + 1.7844456395331365 * "IL".scaler_output_29 + 1.0414384374374972 * "IL".scaler_output_30 + -0.5640588376650875 * "IL".scaler_output_31 + 0.20041431403565452 AS "NEUR_1_3" 
FROM "IL"), 
"HL_1_relu" AS 
...
FROM "HL_BA_1")
 INSERT INTO "TMP_20221018185100_G80E5XX_HL_1_relu_1" ("KEY", "NEUR_1_1", "NEUR_1_2", "NEUR_1_3") SELECT "T"."KEY", "T"."NEUR_1_1", "T"."NEUR_1_2", "T"."NEUR_1_3" 
...
-- Code For temporary table TMP_20221018185100_G80E5XX_HL_1_relu_1 part 3. Create Index 

CREATE INDEX "ix_TMP_20221018185100_G80E5XX_HL_1_relu_1_KEY" ON "TMP_20221018185100_G80E5XX_HL_1_relu_1" ("KEY")

-- Code For temporary table TMP_20221018185100_79C7W3W_OL_logistic_1 part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221018185100_79C7W3W_OL_logistic_1" (
	"KEY" BIGINT NOT NULL, 
	"NEUR_3_1" FLOAT, 
	PRIMARY KEY ("KEY")
)
...
-- Code For temporary table TMP_20221018185100_79C7W3W_OL_logistic_1 part 2. Populate

WITH "HL_BA_2" AS 
(SELECT "HL_1_relu_1"."KEY" AS "KEY", 0.4985378443959678 * "HL_1_relu_1"."NEUR_1_1" + -0.5750282582934443 * "HL_1_relu_1"."NEUR_1_2" + -0.7201585811268131 * "HL_1_relu_1"."NEUR_1_3" + -0.027381825861335862 AS "NEUR_2_1", -0.728808328584699 * "HL_1_relu_1"."NEUR_1_1" + -0.8789506211465606 * "HL_1_relu_1"."NEUR_1_2" + 0.5483991070431984 * "HL_1_relu_1"."NEUR_1_3" + 0.6166178504467 AS "NEUR_2_2", 1.1208584530335093 * "HL_1_relu_1"."NEUR_1_1" + 1.898932975520751 * "HL_1_relu_1"."NEUR_1_2" + -1.586039505916217 * "HL_1_relu_1"."NEUR_1_3" + -0.0643642180709617 AS "NEUR_2_3", -0.5283052699886026 * "HL_1_relu_1"."NEUR_1_1" + -0.642728203801122 * "HL_1_relu_1"."NEUR_1_2" + 2.507219246293802 * "HL_1_relu_1"."NEUR_1_3" + 1.621345835432248 AS "NEUR_2_4", -0.6947502490619603 * "HL_1_relu_1"."NEUR_1_1" + -0.2695090985330501 * "HL_1_relu_1"."NEUR_1_2" + -0.661681147907395 * "HL_1_relu_1"."NEUR_1_3" + -0.815750113657602 AS "NEUR_2_5" 
FROM "TMP_20221018185100_G80E5XX_HL_1_relu_1" AS "HL_1_relu_1"), 
"HL_2_relu" AS 
...
FROM "HL_BA_2"), 
"OL_BA" AS 
(SELECT "HL_2_relu"."KEY" AS "KEY", 0.18834779921313172 * "HL_2_relu"."NEUR_2_1" + -0.7528375434279705 * "HL_2_relu"."NEUR_2_2" + 2.336269950812256 * "HL_2_relu"."NEUR_2_3" + -2.654411756087477 * "HL_2_relu"."NEUR_2_4" + 0.3793441160311875 * "HL_2_relu"."NEUR_2_5" + -0.26660724183895107 AS "NEUR_3_1" 
FROM "HL_2_relu"), 
"OL_logistic" AS 
(SELECT "OL_BA"."KEY" AS "KEY", 1.0 / (1.0 + exp(min(100.0, max(-100.0, -"OL_BA"."NEUR_3_1")))) AS "NEUR_3_1" 
FROM "OL_BA")
 INSERT INTO "TMP_20221018185100_79C7W3W_OL_logistic_1" ("KEY", "NEUR_3_1") SELECT "T"."KEY", "T"."NEUR_3_1" 
...
-- Code For temporary table TMP_20221018185100_79C7W3W_OL_logistic_1 part 3. Create Index 

CREATE INDEX "ix_TMP_20221018185100_79C7W3W_OL_logistic_1_KEY" ON "TMP_20221018185100_79C7W3W_OL_logistic_1" ("KEY")
...
FROM "TMP_20221018185100_79C7W3W_OL_logistic_1" AS "OL_logistic_1"), 
