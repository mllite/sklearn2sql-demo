...
-- Code For temporary table TMP_20221018190557_7E7CXIO_KernAgg_B0 part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221018190557_7E7CXIO_KernAgg_B0" (
	"KEY" BIGINT, 
...
-- Code For temporary table TMP_20221018190557_7E7CXIO_KernAgg_B0 part 2. Populate
...
FROM "kernel_dp_1789-07-14T00:00:00.000000000_1789-08-14T00:00:00.000000000")
 INSERT INTO "TMP_20221018190557_7E7CXIO_KernAgg_B0" ("KEY", "OVO_Class1", "OVO_Class2", "OVO_Decision", "OVO_Conf") SELECT "T"."KEY", "T"."OVO_Class1", "T"."OVO_Class2", "T"."OVO_Decision", "T"."OVO_Conf" 
...
-- Code For temporary table TMP_20221018190557_EB91137_KernAgg_B1 part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221018190557_EB91137_KernAgg_B1" (
	"KEY" BIGINT, 
	"OVO_Class1" VARCHAR COLLATE "utf8", 
	"OVO_Class2" VARCHAR COLLATE "utf8", 
	"OVO_Decision" BIGINT, 
...
-- Code For temporary table TMP_20221018190557_EB91137_KernAgg_B1 part 2. Populate
...
FROM "kernel_dp_1789-07-14T00:00:00.000000000_1789-09-14T00:00:00.000000000")
 INSERT INTO "TMP_20221018190557_EB91137_KernAgg_B1" ("KEY", "OVO_Class1", "OVO_Class2", "OVO_Decision", "OVO_Conf") SELECT "T"."KEY", "T"."OVO_Class1", "T"."OVO_Class2", "T"."OVO_Decision", "T"."OVO_Conf" 
...
-- Code For temporary table TMP_20221018190557_HCLTD62_KernAgg_B2 part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221018190557_HCLTD62_KernAgg_B2" (
	"KEY" BIGINT, 
	"OVO_Class1" VARCHAR COLLATE "utf8", 
	"OVO_Class2" VARCHAR COLLATE "utf8", 
	"OVO_Decision" BIGINT, 
...
-- Code For temporary table TMP_20221018190557_HCLTD62_KernAgg_B2 part 2. Populate
...
FROM "kernel_dp_1789-08-14T00:00:00.000000000_1789-09-14T00:00:00.000000000")
 INSERT INTO "TMP_20221018190557_HCLTD62_KernAgg_B2" ("KEY", "OVO_Class1", "OVO_Class2", "OVO_Decision", "OVO_Conf") SELECT "T"."KEY", "T"."OVO_Class1", "T"."OVO_Class2", "T"."OVO_Decision", "T"."OVO_Conf" 
...
-- Code For temporary table TMP_20221018190557_QO8GBPY_KernAgg_agg part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221018190557_QO8GBPY_KernAgg_agg" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20221018190557_QO8GBPY_KernAgg_agg part 2. Populate
...
FROM (SELECT "KernAgg_B0"."KEY" AS "KEY", "KernAgg_B0"."OVO_Class1" AS "OVO_Class1", "KernAgg_B0"."OVO_Class2" AS "OVO_Class2", "KernAgg_B0"."OVO_Decision" AS "OVO_Decision", "KernAgg_B0"."OVO_Conf" AS "OVO_Conf" 
FROM "TMP_20221018190557_7E7CXIO_KernAgg_B0" AS "KernAgg_B0" UNION ALL SELECT "KernAgg_B1"."KEY" AS "KEY", "KernAgg_B1"."OVO_Class1" AS "OVO_Class1", "KernAgg_B1"."OVO_Class2" AS "OVO_Class2", "KernAgg_B1"."OVO_Decision" AS "OVO_Decision", "KernAgg_B1"."OVO_Conf" AS "OVO_Conf" 
FROM "TMP_20221018190557_EB91137_KernAgg_B1" AS "KernAgg_B1" UNION ALL SELECT "KernAgg_B2"."KEY" AS "KEY", "KernAgg_B2"."OVO_Class1" AS "OVO_Class1", "KernAgg_B2"."OVO_Class2" AS "OVO_Class2", "KernAgg_B2"."OVO_Decision" AS "OVO_Decision", "KernAgg_B2"."OVO_Conf" AS "OVO_Conf" 
FROM "TMP_20221018190557_HCLTD62_KernAgg_B2" AS "KernAgg_B2") AS "KernAgg_EnsembleUnion"), 
"OVO_Votes" AS 
...
-- Code For temporary table TMP_20221018190557_QO8GBPY_KernAgg_agg part 3. Create Index 

CREATE INDEX "ix_TMP_20221018190557_QO8GBPY_KernAgg_agg_KEY" ON "TMP_20221018190557_QO8GBPY_KernAgg_agg" ("KEY")
...
FROM "TMP_20221018190557_QO8GBPY_KernAgg_agg" AS "KernAgg_agg"), 
