...
-- Code For temporary table TMP_20221018190557_USBU6RF_KernAgg_B0 part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221018190557_USBU6RF_KernAgg_B0" (
	"KEY" BIGINT, 
...
-- Code For temporary table TMP_20221018190557_USBU6RF_KernAgg_B0 part 2. Populate
...
FROM "kernel_cte_1789-07-14T00:00:00.000000000_1789-08-14T00:00:00.000000000") AS "KernAgg_esu_0") AS "KernAgg_B0") AS "T"

-- Code For temporary table TMP_20221018190557_BTLL68J_KernAgg_B1 part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221018190557_BTLL68J_KernAgg_B1" (
	"KEY" BIGINT, 
	"OVO_Class1" VARCHAR COLLATE "utf8", 
	"OVO_Class2" VARCHAR COLLATE "utf8", 
	"OVO_Decision" BIGINT, 
...
-- Code For temporary table TMP_20221018190557_BTLL68J_KernAgg_B1 part 2. Populate
...
(SELECT "kernel_dp_1789-07-14T00:00:00.000000000_1789-09-14T00:00:00.000000000"."KEY" AS "KEY", '1789-07-14T00:00:00.000000000' AS "OVO_Class1", '1789-09-14T00:00:00.000000000' AS "OVO_Class2", CASE WHEN (-"kernel_dp_1789-07-14T00:00:00.000000000_1789-09-14T00:00:00.000000000".dot_product >= 0.0) THEN 1 ELSE 0 END AS "OVO_Decision", coalesce(-"kernel_dp_1789-07-14T00:00:00.000000000_1789-09-14T00:00:00.000000000".dot_product, 1.0 / (1.0 + exp(least(100.0, greatest(-100.0, -(-((-"kernel_dp_1789-07-14T00:00:00.000000000_1789-09-14T00:00:00.000000000".dot_product) * -2.7812727860175634 + -0.2573773913268626))))))) AS "OVO_Conf" 
FROM "kernel_dp_1789-07-14T00:00:00.000000000_1789-09-14T00:00:00.000000000")
 INSERT INTO "TMP_20221018190557_BTLL68J_KernAgg_B1" ("KEY", "OVO_Class1", "OVO_Class2", "OVO_Decision", "OVO_Conf") SELECT "T"."KEY", "T"."OVO_Class1", "T"."OVO_Class2", "T"."OVO_Decision", "T"."OVO_Conf" 
...
FROM "kernel_cte_1789-07-14T00:00:00.000000000_1789-09-14T00:00:00.000000000") AS "KernAgg_esu_1") AS "KernAgg_B1") AS "T"

-- Code For temporary table TMP_20221018190557_7R3TNWE_KernAgg_B2 part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221018190557_7R3TNWE_KernAgg_B2" (
	"KEY" BIGINT, 
	"OVO_Class1" VARCHAR COLLATE "utf8", 
	"OVO_Class2" VARCHAR COLLATE "utf8", 
	"OVO_Decision" BIGINT, 
...
-- Code For temporary table TMP_20221018190557_7R3TNWE_KernAgg_B2 part 2. Populate
...
FROM "kernel_cte_1789-08-14T00:00:00.000000000_1789-09-14T00:00:00.000000000") AS "KernAgg_esu_2") AS "KernAgg_B2") AS "T"

-- Code For temporary table TMP_20221018190557_1PSJPAD_KernAgg_agg part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221018190557_1PSJPAD_KernAgg_agg" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20221018190557_1PSJPAD_KernAgg_agg part 2. Populate
...
FROM (SELECT "KernAgg_B0"."KEY" AS "KEY", "KernAgg_B0"."OVO_Class1" AS "OVO_Class1", "KernAgg_B0"."OVO_Class2" AS "OVO_Class2", "KernAgg_B0"."OVO_Decision" AS "OVO_Decision", "KernAgg_B0"."OVO_Conf" AS "OVO_Conf" 
FROM "TMP_20221018190557_USBU6RF_KernAgg_B0" AS "KernAgg_B0" UNION ALL SELECT "KernAgg_B1"."KEY" AS "KEY", "KernAgg_B1"."OVO_Class1" AS "OVO_Class1", "KernAgg_B1"."OVO_Class2" AS "OVO_Class2", "KernAgg_B1"."OVO_Decision" AS "OVO_Decision", "KernAgg_B1"."OVO_Conf" AS "OVO_Conf" 
FROM "TMP_20221018190557_BTLL68J_KernAgg_B1" AS "KernAgg_B1" UNION ALL SELECT "KernAgg_B2"."KEY" AS "KEY", "KernAgg_B2"."OVO_Class1" AS "OVO_Class1", "KernAgg_B2"."OVO_Class2" AS "OVO_Class2", "KernAgg_B2"."OVO_Decision" AS "OVO_Decision", "KernAgg_B2"."OVO_Conf" AS "OVO_Conf" 
FROM "TMP_20221018190557_7R3TNWE_KernAgg_B2" AS "KernAgg_B2") AS "KernAgg_EnsembleUnion"), 
"OVO_Votes" AS 
...
FROM "OVO_Votes", "MinMaxConf")
 INSERT INTO "TMP_20221018190557_1PSJPAD_KernAgg_agg" ("KEY", "OVO_Vote_1789-07-14T00:00:00.000000000", "OVO_SumConfidence_1789-07-14T00:00:00.000000000", "OVO_Vote_1789-08-14T00:00:00.000000000", "OVO_SumConfidence_1789-08-14T00:00:00.000000000", "OVO_Vote_1789-09-14T00:00:00.000000000", "OVO_SumConfidence_1789-09-14T00:00:00.000000000", max_abs_confidence, "OVO_Scale", "Score_1789-07-14T00:00:00.000000000", "Score_1789-08-14T00:00:00.000000000", "Score_1789-09-14T00:00:00.000000000") SELECT "T"."KEY", "T"."OVO_Vote_1789-07-14T00:00:00.000000000", "T"."OVO_SumConfidence_1789-07-14T00:00:00.000000000", "T"."OVO_Vote_1789-08-14T00:00:00.000000000", "T"."OVO_SumConfidence_1789-08-14T00:00:00.000000000", "T"."OVO_Vote_1789-09-14T00:00:00.000000000", "T"."OVO_SumConfidence_1789-09-14T00:00:00.000000000", "T".max_abs_confidence, "T"."OVO_Scale", "T"."Score_1789-07-14T00:00:00.000000000", "T"."Score_1789-08-14T00:00:00.000000000", "T"."Score_1789-09-14T00:00:00.000000000" 
FROM (SELECT "KernAgg_agg"."KEY" AS "KEY", "KernAgg_agg"."OVO_Vote_1789-07-14T00:00:00.000000000" AS "OVO_Vote_1789-07-14T00:00:00.000000000", "KernAgg_agg"."OVO_SumConfidence_1789-07-14T00:00:00.000000000" AS "OVO_SumConfidence_1789-07-14T00:00:00.000000000", "KernAgg_agg"."OVO_Vote_1789-08-14T00:00:00.000000000" AS "OVO_Vote_1789-08-14T00:00:00.000000000", "KernAgg_agg"."OVO_SumConfidence_1789-08-14T00:00:00.000000000" AS "OVO_SumConfidence_1789-08-14T00:00:00.000000000", "KernAgg_agg"."OVO_Vote_1789-09-14T00:00:00.000000000" AS "OVO_Vote_1789-09-14T00:00:00.000000000", "KernAgg_agg"."OVO_SumConfidence_1789-09-14T00:00:00.000000000" AS "OVO_SumConfidence_1789-09-14T00:00:00.000000000", "KernAgg_agg".max_abs_confidence AS max_abs_confidence, "KernAgg_agg"."OVO_Scale" AS "OVO_Scale", "KernAgg_agg"."Score_1789-07-14T00:00:00.000000000" AS "Score_1789-07-14T00:00:00.000000000", "KernAgg_agg"."Score_1789-08-14T00:00:00.000000000" AS "Score_1789-08-14T00:00:00.000000000", "KernAgg_agg"."Score_1789-09-14T00:00:00.000000000" AS "Score_1789-09-14T00:00:00.000000000" 
...
-- Code For temporary table TMP_20221018190557_1PSJPAD_KernAgg_agg part 3. Create Index 

CREATE INDEX "ix_TMP_20221018190557_1PSJPAD_KernAgg_agg_KEY" ON "TMP_20221018190557_1PSJPAD_KernAgg_agg" ("KEY")
...
FROM "TMP_20221018190557_1PSJPAD_KernAgg_agg" AS "KernAgg_agg"), 
