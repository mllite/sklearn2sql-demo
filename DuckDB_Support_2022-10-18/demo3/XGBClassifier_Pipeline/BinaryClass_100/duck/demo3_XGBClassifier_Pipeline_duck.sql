...
-- Code For temporary table TMP_20221018185017_8JSMIEJ_ADS_imp_1_OUT part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221018185017_8JSMIEJ_ADS_imp_1_OUT" (
	"KEY" BIGINT NOT NULL, 
	impter_2 DOUBLE, 
	impter_3 DOUBLE, 
	impter_4 DOUBLE, 
...
-- Code For temporary table TMP_20221018185017_8JSMIEJ_ADS_imp_1_OUT part 3. Create Index 

CREATE INDEX "ix_TMP_20221018185017_8JSMIEJ_ADS_imp_1_OUT_KEY" ON "TMP_20221018185017_8JSMIEJ_ADS_imp_1_OUT" ("KEY")

-- Code For temporary table TMP_20221018185017_T28LQI4_ADS_sca_2_OUT part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221018185017_T28LQI4_ADS_sca_2_OUT" (
	"KEY" BIGINT NOT NULL, 
	scaler_2 DOUBLE, 
	scaler_3 DOUBLE, 
	scaler_4 DOUBLE, 
...
FROM "TMP_20221018185017_8JSMIEJ_ADS_imp_1_OUT" AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT") AS "T"

-- Code For temporary table TMP_20221018185017_T28LQI4_ADS_sca_2_OUT part 3. Create Index 

CREATE INDEX "ix_TMP_20221018185017_T28LQI4_ADS_sca_2_OUT_KEY" ON "TMP_20221018185017_T28LQI4_ADS_sca_2_OUT" ("KEY")

-- Code For temporary table TMP_20221018185017_9TPG3HZ_XGB_B0 part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221018185017_9TPG3HZ_XGB_B0" (
	"KEY" BIGINT, 
	"Score_0" DOUBLE
)
...
-- Code For temporary table TMP_20221018185017_9TPG3HZ_XGB_B0 part 2. Populate

WITH "DT_node_lookup" AS 
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", CASE WHEN ("ADS_sca_2_OUT".scaler_59 < -0.195964277) THEN 1 ELSE 2 END AS node_id_2 
FROM "TMP_20221018185017_T28LQI4_ADS_sca_2_OUT" AS "ADS_sca_2_OUT"), 
"DT_node_data" AS 
...
FROM "DT_Output_9")
 INSERT INTO "TMP_20221018185017_9TPG3HZ_XGB_B0" ("KEY", "Score_0") SELECT "T"."KEY", "T"."Score_0" 
...
-- Code For temporary table TMP_20221018185017_4UQ4ITX_XGB_B1 part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221018185017_4UQ4ITX_XGB_B1" (
	"KEY" BIGINT, 
	"Score_0" DOUBLE
)
...
-- Code For temporary table TMP_20221018185017_4UQ4ITX_XGB_B1 part 2. Populate
...
FROM "DT_Output_15")
 INSERT INTO "TMP_20221018185017_4UQ4ITX_XGB_B1" ("KEY", "Score_0") SELECT "T"."KEY", "T"."Score_0" 
...
-- Code For temporary table TMP_20221018185017_HCXGYA4_XGB_sum part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221018185017_HCXGYA4_XGB_sum" (
	"KEY" BIGINT NOT NULL, 
	"Score_0" DOUBLE, 
	PRIMARY KEY ("KEY")
)
...
-- Code For temporary table TMP_20221018185017_HCXGYA4_XGB_sum part 2. Populate

WITH "XGB_Union" AS 
(SELECT "XGB_EnsembleUnion"."KEY" AS "KEY", "XGB_EnsembleUnion"."Score_0" AS "Score_0" 
FROM (SELECT "XGB_B0"."KEY" AS "KEY", "XGB_B0"."Score_0" AS "Score_0" 
FROM "TMP_20221018185017_9TPG3HZ_XGB_B0" AS "XGB_B0" UNION ALL SELECT "XGB_B1"."KEY" AS "KEY", "XGB_B1"."Score_0" AS "Score_0" 
FROM "TMP_20221018185017_4UQ4ITX_XGB_B1" AS "XGB_B1") AS "XGB_EnsembleUnion")
 INSERT INTO "TMP_20221018185017_HCXGYA4_XGB_sum" ("KEY", "Score_0") SELECT "T"."KEY", "T"."Score_0" 
...
-- Code For temporary table TMP_20221018185017_HCXGYA4_XGB_sum part 3. Create Index 

CREATE INDEX "ix_TMP_20221018185017_HCXGYA4_XGB_sum_KEY" ON "TMP_20221018185017_HCXGYA4_XGB_sum" ("KEY")
...
FROM "TMP_20221018185017_HCXGYA4_XGB_sum" AS "XGB_sum"), 
