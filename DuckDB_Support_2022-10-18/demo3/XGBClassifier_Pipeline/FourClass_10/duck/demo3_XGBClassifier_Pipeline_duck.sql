...
-- Code For temporary table TMP_20221018185237_TCFO86J_ADS_imp_1_OUT part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221018185237_TCFO86J_ADS_imp_1_OUT" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20221018185237_TCFO86J_ADS_imp_1_OUT part 3. Create Index 

CREATE INDEX "ix_TMP_20221018185237_TCFO86J_ADS_imp_1_OUT_KEY" ON "TMP_20221018185237_TCFO86J_ADS_imp_1_OUT" ("KEY")

-- Code For temporary table TMP_20221018185237_SURYHMD_ADS_sca_2_OUT part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221018185237_SURYHMD_ADS_sca_2_OUT" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20221018185237_SURYHMD_ADS_sca_2_OUT part 2. Populate

INSERT INTO "TMP_20221018185237_SURYHMD_ADS_sca_2_OUT" ("KEY", scaler_output_2, scaler_output_3, scaler_output_4, scaler_output_5, scaler_output_6, scaler_output_7, scaler_output_8, scaler_output_9, scaler_output_10, scaler_output_11) SELECT "T"."KEY", "T".scaler_output_2, "T".scaler_output_3, "T".scaler_output_4, "T".scaler_output_5, "T".scaler_output_6, "T".scaler_output_7, "T".scaler_output_8, "T".scaler_output_9, "T".scaler_output_10, "T".scaler_output_11 
...
FROM "TMP_20221018185237_TCFO86J_ADS_imp_1_OUT" AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT") AS "T"

-- Code For temporary table TMP_20221018185237_SURYHMD_ADS_sca_2_OUT part 3. Create Index 

CREATE INDEX "ix_TMP_20221018185237_SURYHMD_ADS_sca_2_OUT_KEY" ON "TMP_20221018185237_SURYHMD_ADS_sca_2_OUT" ("KEY")

-- Code For temporary table TMP_20221018185237_HF797P4_XGB_B0 part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221018185237_HF797P4_XGB_B0" (
	"KEY" BIGINT, 
	"Score_0" DOUBLE, 
	"Score_1" DOUBLE, 
	"Score_2" DOUBLE, 
...
-- Code For temporary table TMP_20221018185237_HF797P4_XGB_B0 part 2. Populate

WITH "DT_node_lookup" AS 
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", CASE WHEN ("ADS_sca_2_OUT".scaler_output_6 < 0.0557144508) THEN 1 ELSE 2 END AS node_id_2 
FROM "TMP_20221018185237_SURYHMD_ADS_sca_2_OUT" AS "ADS_sca_2_OUT"), 
"DT_node_data" AS 
...
FROM "DT_Output"), 
"DT_node_lookup_1" AS 
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", CASE WHEN ("ADS_sca_2_OUT".scaler_output_5 < 0.174078956) THEN 1 ELSE 2 END AS node_id_2 
FROM "TMP_20221018185237_SURYHMD_ADS_sca_2_OUT" AS "ADS_sca_2_OUT"), 
"DT_node_data_1" AS 
(SELECT "Values".nid AS nid, "Values"."Score" AS "Score" 
...
FROM "DT_Output_1"), 
"DT_node_lookup_2" AS 
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", CASE WHEN ("ADS_sca_2_OUT".scaler_output_4 < 0.113754995) THEN 1 ELSE 2 END AS node_id_2 
FROM "TMP_20221018185237_SURYHMD_ADS_sca_2_OUT" AS "ADS_sca_2_OUT"), 
"DT_node_data_2" AS 
(SELECT "Values".nid AS nid, "Values"."Score" AS "Score" 
...
FROM "DT_Output_2"), 
"DT_node_lookup_3" AS 
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", CASE WHEN ("ADS_sca_2_OUT".scaler_output_9 < 0.134699225) THEN 1 ELSE 2 END AS node_id_2 
FROM "TMP_20221018185237_SURYHMD_ADS_sca_2_OUT" AS "ADS_sca_2_OUT"), 
"DT_node_data_3" AS 
(SELECT "Values".nid AS nid, "Values"."Score" AS "Score" 
...
FROM "DT_Output_4"), 
"DT_node_lookup_5" AS 
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", CASE WHEN ("ADS_sca_2_OUT".scaler_output_5 < -0.0208569486) THEN 1 ELSE 2 END AS node_id_2 
FROM "TMP_20221018185237_SURYHMD_ADS_sca_2_OUT" AS "ADS_sca_2_OUT"), 
"DT_node_data_5" AS 
(SELECT "Values".nid AS nid, "Values"."Score" AS "Score" 
...
FROM "DT_Output_5"), 
"DT_node_lookup_6" AS 
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", CASE WHEN ("ADS_sca_2_OUT".scaler_output_8 < 0.417300165) THEN 1 ELSE 2 END AS node_id_2 
FROM "TMP_20221018185237_SURYHMD_ADS_sca_2_OUT" AS "ADS_sca_2_OUT"), 
"DT_node_data_6" AS 
(SELECT "Values".nid AS nid, "Values"."Score" AS "Score" 
...
FROM "DT_Output_6"), 
"DT_node_lookup_7" AS 
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", CASE WHEN ("ADS_sca_2_OUT".scaler_output_3 < -0.261331648) THEN 1 ELSE 2 END AS node_id_2 
FROM "TMP_20221018185237_SURYHMD_ADS_sca_2_OUT" AS "ADS_sca_2_OUT"), 
"DT_node_data_7" AS 
(SELECT "Values".nid AS nid, "Values"."Score" AS "Score" 
...
FROM "DT_Output_7"), 
"DT_node_lookup_8" AS 
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", CASE WHEN ("ADS_sca_2_OUT".scaler_output_5 < -0.0951644108) THEN 1 ELSE 2 END AS node_id_2 
FROM "TMP_20221018185237_SURYHMD_ADS_sca_2_OUT" AS "ADS_sca_2_OUT"), 
"DT_node_data_8" AS 
(SELECT "Values".nid AS nid, "Values"."Score" AS "Score" 
...
FROM "DT_Output_9")
 INSERT INTO "TMP_20221018185237_HF797P4_XGB_B0" ("KEY", "Score_0", "Score_1", "Score_2", "Score_3") SELECT "T"."KEY", "T"."Score_0", "T"."Score_1", "T"."Score_2", "T"."Score_3" 
...
-- Code For temporary table TMP_20221018185237_TN1DO9P_XGB_B1 part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221018185237_TN1DO9P_XGB_B1" (
	"KEY" BIGINT, 
	"Score_0" DOUBLE, 
	"Score_1" DOUBLE, 
	"Score_2" DOUBLE, 
...
-- Code For temporary table TMP_20221018185237_TN1DO9P_XGB_B1 part 2. Populate

WITH "DT_node_lookup_10" AS 
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", CASE WHEN ("ADS_sca_2_OUT".scaler_output_5 < -0.754903853) THEN 1 ELSE 2 END AS node_id_2 
FROM "TMP_20221018185237_SURYHMD_ADS_sca_2_OUT" AS "ADS_sca_2_OUT"), 
"DT_node_data_10" AS 
(SELECT "Values".nid AS nid, "Values"."Score" AS "Score" 
...
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", CASE WHEN ("ADS_sca_2_OUT".scaler_output_3 < 0.177651972) THEN 1 ELSE 2 END AS node_id_2 
FROM "TMP_20221018185237_SURYHMD_ADS_sca_2_OUT" AS "ADS_sca_2_OUT"), 
"DT_node_data_19" AS 
(SELECT "Values".nid AS nid, "Values"."Score" AS "Score" 
...
FROM "DT_Output_19")
 INSERT INTO "TMP_20221018185237_TN1DO9P_XGB_B1" ("KEY", "Score_0", "Score_1", "Score_2", "Score_3") SELECT "T"."KEY", "T"."Score_0", "T"."Score_1", "T"."Score_2", "T"."Score_3" 
...
-- Code For temporary table TMP_20221018185237_FE3L2F1_XGB_B2 part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221018185237_FE3L2F1_XGB_B2" (
	"KEY" BIGINT, 
	"Score_0" DOUBLE, 
	"Score_1" DOUBLE, 
	"Score_2" DOUBLE, 
...
-- Code For temporary table TMP_20221018185237_FE3L2F1_XGB_B2 part 2. Populate
...
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", CASE WHEN ("ADS_sca_2_OUT".scaler_output_7 < 0.223394632) THEN 1 ELSE 2 END AS node_id_2 
FROM "TMP_20221018185237_SURYHMD_ADS_sca_2_OUT" AS "ADS_sca_2_OUT"), 
"DT_node_data_22" AS 
(SELECT "Values".nid AS nid, "Values"."Score" AS "Score" 
...
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", CASE WHEN ("ADS_sca_2_OUT".scaler_output_5 < 0.318128288) THEN 1 ELSE 2 END AS node_id_2 
FROM "TMP_20221018185237_SURYHMD_ADS_sca_2_OUT" AS "ADS_sca_2_OUT"), 
"DT_node_data_25" AS 
(SELECT "Values".nid AS nid, "Values"."Score" AS "Score" 
...
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", CASE WHEN ("ADS_sca_2_OUT".scaler_output_6 < 0.00684611686) THEN 1 ELSE 2 END AS node_id_2 
FROM "TMP_20221018185237_SURYHMD_ADS_sca_2_OUT" AS "ADS_sca_2_OUT"), 
"DT_node_data_29" AS 
(SELECT "Values".nid AS nid, "Values"."Score" AS "Score" 
...
FROM "DT_Output_29")
 INSERT INTO "TMP_20221018185237_FE3L2F1_XGB_B2" ("KEY", "Score_0", "Score_1", "Score_2", "Score_3") SELECT "T"."KEY", "T"."Score_0", "T"."Score_1", "T"."Score_2", "T"."Score_3" 
...
-- Code For temporary table TMP_20221018185237_5O3NLAC_XGB_B3 part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221018185237_5O3NLAC_XGB_B3" (
	"KEY" BIGINT, 
	"Score_0" DOUBLE, 
	"Score_1" DOUBLE, 
	"Score_2" DOUBLE, 
...
-- Code For temporary table TMP_20221018185237_5O3NLAC_XGB_B3 part 2. Populate
...
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", CASE WHEN ("ADS_sca_2_OUT".scaler_output_2 < -0.27994889) THEN 1 ELSE 2 END AS node_id_2 
FROM "TMP_20221018185237_SURYHMD_ADS_sca_2_OUT" AS "ADS_sca_2_OUT"), 
"DT_node_data_33" AS 
(SELECT "Values".nid AS nid, "Values"."Score" AS "Score" 
...
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", CASE WHEN ("ADS_sca_2_OUT".scaler_output_6 < -0.0789468437) THEN 1 ELSE 2 END AS node_id_2 
FROM "TMP_20221018185237_SURYHMD_ADS_sca_2_OUT" AS "ADS_sca_2_OUT"), 
"DT_node_data_35" AS 
(SELECT "Values".nid AS nid, "Values"."Score" AS "Score" 
...
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", CASE WHEN ("ADS_sca_2_OUT".scaler_output_3 < -0.400556743) THEN 1 ELSE 2 END AS node_id_2 
FROM "TMP_20221018185237_SURYHMD_ADS_sca_2_OUT" AS "ADS_sca_2_OUT"), 
"DT_node_data_36" AS 
(SELECT "Values".nid AS nid, "Values"."Score" AS "Score" 
...
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", CASE WHEN ("ADS_sca_2_OUT".scaler_output_7 < -0.283124626) THEN 1 ELSE 2 END AS node_id_2 
FROM "TMP_20221018185237_SURYHMD_ADS_sca_2_OUT" AS "ADS_sca_2_OUT"), 
"DT_node_data_37" AS 
(SELECT "Values".nid AS nid, "Values"."Score" AS "Score" 
...
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", CASE WHEN ("ADS_sca_2_OUT".scaler_output_9 < -0.0582020283) THEN 1 ELSE 2 END AS node_id_2 
FROM "TMP_20221018185237_SURYHMD_ADS_sca_2_OUT" AS "ADS_sca_2_OUT"), 
"DT_node_data_39" AS 
(SELECT "Values".nid AS nid, "Values"."Score" AS "Score" 
...
FROM "DT_Output_39")
 INSERT INTO "TMP_20221018185237_5O3NLAC_XGB_B3" ("KEY", "Score_0", "Score_1", "Score_2", "Score_3") SELECT "T"."KEY", "T"."Score_0", "T"."Score_1", "T"."Score_2", "T"."Score_3" 
...
-- Code For temporary table TMP_20221018185237_1CT7UYC_XGB_B4 part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221018185237_1CT7UYC_XGB_B4" (
	"KEY" BIGINT, 
	"Score_0" DOUBLE, 
	"Score_1" DOUBLE, 
	"Score_2" DOUBLE, 
...
-- Code For temporary table TMP_20221018185237_1CT7UYC_XGB_B4 part 2. Populate

WITH "DT_node_lookup_40" AS 
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", CASE WHEN ("ADS_sca_2_OUT".scaler_output_3 < -0.499824405) THEN 1 ELSE 2 END AS node_id_2 
FROM "TMP_20221018185237_SURYHMD_ADS_sca_2_OUT" AS "ADS_sca_2_OUT"), 
"DT_node_data_40" AS 
(SELECT "Values".nid AS nid, "Values"."Score" AS "Score" 
...
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", CASE WHEN ("ADS_sca_2_OUT".scaler_output_5 < 0.358371317) THEN 1 ELSE 2 END AS node_id_2 
FROM "TMP_20221018185237_SURYHMD_ADS_sca_2_OUT" AS "ADS_sca_2_OUT"), 
"DT_node_data_41" AS 
(SELECT "Values".nid AS nid, "Values"."Score" AS "Score" 
...
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", CASE WHEN ("ADS_sca_2_OUT".scaler_output_5 < -0.240161151) THEN 1 ELSE 2 END AS node_id_2 
FROM "TMP_20221018185237_SURYHMD_ADS_sca_2_OUT" AS "ADS_sca_2_OUT"), 
"DT_node_data_44" AS 
(SELECT "Values".nid AS nid, "Values"."Score" AS "Score" 
...
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", CASE WHEN ("ADS_sca_2_OUT".scaler_output_6 < -0.0308664795) THEN 1 ELSE 2 END AS node_id_2 
FROM "TMP_20221018185237_SURYHMD_ADS_sca_2_OUT" AS "ADS_sca_2_OUT"), 
"DT_node_data_45" AS 
(SELECT "Values".nid AS nid, "Values"."Score" AS "Score" 
...
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", CASE WHEN ("ADS_sca_2_OUT".scaler_output_6 < -0.11517597) THEN 1 ELSE 2 END AS node_id_2 
FROM "TMP_20221018185237_SURYHMD_ADS_sca_2_OUT" AS "ADS_sca_2_OUT"), 
"DT_node_data_47" AS 
(SELECT "Values".nid AS nid, "Values"."Score" AS "Score" 
...
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", CASE WHEN ("ADS_sca_2_OUT".scaler_output_6 < 0.426494837) THEN 1 ELSE 2 END AS node_id_2 
FROM "TMP_20221018185237_SURYHMD_ADS_sca_2_OUT" AS "ADS_sca_2_OUT"), 
"DT_node_data_48" AS 
(SELECT "Values".nid AS nid, "Values"."Score" AS "Score" 
...
FROM "DT_Output_49")
 INSERT INTO "TMP_20221018185237_1CT7UYC_XGB_B4" ("KEY", "Score_0", "Score_1", "Score_2", "Score_3") SELECT "T"."KEY", "T"."Score_0", "T"."Score_1", "T"."Score_2", "T"."Score_3" 
...
-- Code For temporary table TMP_20221018185237_K0S0KCT_XGB_B5 part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221018185237_K0S0KCT_XGB_B5" (
	"KEY" BIGINT, 
	"Score_0" DOUBLE, 
	"Score_1" DOUBLE, 
	"Score_2" DOUBLE, 
...
-- Code For temporary table TMP_20221018185237_K0S0KCT_XGB_B5 part 2. Populate

WITH "DT_node_lookup_50" AS 
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", CASE WHEN ("ADS_sca_2_OUT".scaler_output_4 < -0.410456836) THEN 1 ELSE 2 END AS node_id_2 
FROM "TMP_20221018185237_SURYHMD_ADS_sca_2_OUT" AS "ADS_sca_2_OUT"), 
"DT_node_data_50" AS 
(SELECT "Values".nid AS nid, "Values"."Score" AS "Score" 
...
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", CASE WHEN ("ADS_sca_2_OUT".scaler_output_9 < -0.122255296) THEN 1 ELSE 2 END AS node_id_2 
FROM "TMP_20221018185237_SURYHMD_ADS_sca_2_OUT" AS "ADS_sca_2_OUT"), 
"DT_node_data_51" AS 
(SELECT "Values".nid AS nid, "Values"."Score" AS "Score" 
...
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", CASE WHEN ("ADS_sca_2_OUT".scaler_output_2 < -0.190907091) THEN 1 ELSE 2 END AS node_id_2 
FROM "TMP_20221018185237_SURYHMD_ADS_sca_2_OUT" AS "ADS_sca_2_OUT"), 
"DT_node_data_53" AS 
(SELECT "Values".nid AS nid, "Values"."Score" AS "Score" 
...
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", CASE WHEN ("ADS_sca_2_OUT".scaler_output_10 < -0.062857762) THEN 1 ELSE 2 END AS node_id_2 
FROM "TMP_20221018185237_SURYHMD_ADS_sca_2_OUT" AS "ADS_sca_2_OUT"), 
"DT_node_data_55" AS 
(SELECT "Values".nid AS nid, "Values"."Score" AS "Score" 
...
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", CASE WHEN ("ADS_sca_2_OUT".scaler_output_9 < -0.240353793) THEN 1 ELSE 2 END AS node_id_2 
FROM "TMP_20221018185237_SURYHMD_ADS_sca_2_OUT" AS "ADS_sca_2_OUT"), 
"DT_node_data_59" AS 
(SELECT "Values".nid AS nid, "Values"."Score" AS "Score" 
...
FROM "DT_Output_59")
 INSERT INTO "TMP_20221018185237_K0S0KCT_XGB_B5" ("KEY", "Score_0", "Score_1", "Score_2", "Score_3") SELECT "T"."KEY", "T"."Score_0", "T"."Score_1", "T"."Score_2", "T"."Score_3" 
...
-- Code For temporary table TMP_20221018185237_F8ZVF2V_XGB_B6 part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221018185237_F8ZVF2V_XGB_B6" (
	"KEY" BIGINT, 
	"Score_0" DOUBLE, 
	"Score_1" DOUBLE, 
	"Score_2" DOUBLE, 
...
-- Code For temporary table TMP_20221018185237_F8ZVF2V_XGB_B6 part 2. Populate

WITH "DT_node_lookup_60" AS 
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", CASE WHEN ("ADS_sca_2_OUT".scaler_output_5 < -0.261428416) THEN 1 ELSE 2 END AS node_id_2 
FROM "TMP_20221018185237_SURYHMD_ADS_sca_2_OUT" AS "ADS_sca_2_OUT"), 
"DT_node_data_60" AS 
(SELECT "Values".nid AS nid, "Values"."Score" AS "Score" 
...
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", CASE WHEN ("ADS_sca_2_OUT".scaler_output_5 < -0.0571750179) THEN 1 ELSE 2 END AS node_id_2 
FROM "TMP_20221018185237_SURYHMD_ADS_sca_2_OUT" AS "ADS_sca_2_OUT"), 
"DT_node_data_63" AS 
(SELECT "Values".nid AS nid, "Values"."Score" AS "Score" 
...
FROM "DT_Output_63")
 INSERT INTO "TMP_20221018185237_F8ZVF2V_XGB_B6" ("KEY", "Score_0", "Score_1", "Score_2", "Score_3") SELECT "T"."KEY", "T"."Score_0", "T"."Score_1", "T"."Score_2", "T"."Score_3" 
...
-- Code For temporary table TMP_20221018185237_3GXP475_XGB_sum part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221018185237_3GXP475_XGB_sum" (
	"KEY" BIGINT NOT NULL, 
	"Score_0" DOUBLE, 
	"Score_1" DOUBLE, 
	"Score_2" DOUBLE, 
...
-- Code For temporary table TMP_20221018185237_3GXP475_XGB_sum part 2. Populate
...
FROM (SELECT "XGB_B0"."KEY" AS "KEY", "XGB_B0"."Score_0" AS "Score_0", "XGB_B0"."Score_1" AS "Score_1", "XGB_B0"."Score_2" AS "Score_2", "XGB_B0"."Score_3" AS "Score_3" 
FROM "TMP_20221018185237_HF797P4_XGB_B0" AS "XGB_B0" UNION ALL SELECT "XGB_B1"."KEY" AS "KEY", "XGB_B1"."Score_0" AS "Score_0", "XGB_B1"."Score_1" AS "Score_1", "XGB_B1"."Score_2" AS "Score_2", "XGB_B1"."Score_3" AS "Score_3" 
FROM "TMP_20221018185237_TN1DO9P_XGB_B1" AS "XGB_B1" UNION ALL SELECT "XGB_B2"."KEY" AS "KEY", "XGB_B2"."Score_0" AS "Score_0", "XGB_B2"."Score_1" AS "Score_1", "XGB_B2"."Score_2" AS "Score_2", "XGB_B2"."Score_3" AS "Score_3" 
FROM "TMP_20221018185237_FE3L2F1_XGB_B2" AS "XGB_B2" UNION ALL SELECT "XGB_B3"."KEY" AS "KEY", "XGB_B3"."Score_0" AS "Score_0", "XGB_B3"."Score_1" AS "Score_1", "XGB_B3"."Score_2" AS "Score_2", "XGB_B3"."Score_3" AS "Score_3" 
FROM "TMP_20221018185237_5O3NLAC_XGB_B3" AS "XGB_B3" UNION ALL SELECT "XGB_B4"."KEY" AS "KEY", "XGB_B4"."Score_0" AS "Score_0", "XGB_B4"."Score_1" AS "Score_1", "XGB_B4"."Score_2" AS "Score_2", "XGB_B4"."Score_3" AS "Score_3" 
FROM "TMP_20221018185237_1CT7UYC_XGB_B4" AS "XGB_B4" UNION ALL SELECT "XGB_B5"."KEY" AS "KEY", "XGB_B5"."Score_0" AS "Score_0", "XGB_B5"."Score_1" AS "Score_1", "XGB_B5"."Score_2" AS "Score_2", "XGB_B5"."Score_3" AS "Score_3" 
FROM "TMP_20221018185237_K0S0KCT_XGB_B5" AS "XGB_B5" UNION ALL SELECT "XGB_B6"."KEY" AS "KEY", "XGB_B6"."Score_0" AS "Score_0", "XGB_B6"."Score_1" AS "Score_1", "XGB_B6"."Score_2" AS "Score_2", "XGB_B6"."Score_3" AS "Score_3" 
FROM "TMP_20221018185237_F8ZVF2V_XGB_B6" AS "XGB_B6") AS "XGB_EnsembleUnion")
 INSERT INTO "TMP_20221018185237_3GXP475_XGB_sum" ("KEY", "Score_0", "Score_1", "Score_2", "Score_3") SELECT "T"."KEY", "T"."Score_0", "T"."Score_1", "T"."Score_2", "T"."Score_3" 
...
-- Code For temporary table TMP_20221018185237_3GXP475_XGB_sum part 3. Create Index 

CREATE INDEX "ix_TMP_20221018185237_3GXP475_XGB_sum_KEY" ON "TMP_20221018185237_3GXP475_XGB_sum" ("KEY")
...
FROM "TMP_20221018185237_3GXP475_XGB_sum" AS "XGB_sum"), 
