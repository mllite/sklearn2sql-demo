...
-- Code For temporary table TMP_20221018190648_4O55V7Y_ADS_imp_1_OUT part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221018190648_4O55V7Y_ADS_imp_1_OUT" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20221018190648_4O55V7Y_ADS_imp_1_OUT part 2. Populate

INSERT INTO "TMP_20221018190648_4O55V7Y_ADS_imp_1_OUT" ("KEY", imputer_output_2, imputer_output_3, imputer_output_4, imputer_output_5) SELECT "T"."KEY", "T".imputer_output_2, "T".imputer_output_3, "T".imputer_output_4, "T".imputer_output_5 
...
-- Code For temporary table TMP_20221018190648_4O55V7Y_ADS_imp_1_OUT part 3. Create Index 

CREATE INDEX "ix_TMP_20221018190648_4O55V7Y_ADS_imp_1_OUT_KEY" ON "TMP_20221018190648_4O55V7Y_ADS_imp_1_OUT" ("KEY")

-- Code For temporary table TMP_20221018190648_LK433E3_ADS_sca_2_OUT part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221018190648_LK433E3_ADS_sca_2_OUT" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20221018190648_LK433E3_ADS_sca_2_OUT part 2. Populate

INSERT INTO "TMP_20221018190648_LK433E3_ADS_sca_2_OUT" ("KEY", scaler_output_2, scaler_output_3, scaler_output_4, scaler_output_5) SELECT "T"."KEY", "T".scaler_output_2, "T".scaler_output_3, "T".scaler_output_4, "T".scaler_output_5 
...
FROM "TMP_20221018190648_4O55V7Y_ADS_imp_1_OUT" AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT") AS "T"

-- Code For temporary table TMP_20221018190648_LK433E3_ADS_sca_2_OUT part 3. Create Index 

CREATE INDEX "ix_TMP_20221018190648_LK433E3_ADS_sca_2_OUT_KEY" ON "TMP_20221018190648_LK433E3_ADS_sca_2_OUT" ("KEY")

-- Code For temporary table TMP_20221018190649_4C5E5S9_RF_B0 part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221018190649_4C5E5S9_RF_B0" (
	"KEY" BIGINT, 
	"Score_CLASS_0" FLOAT, 
	"Proba_CLASS_0" FLOAT, 
...
-- Code For temporary table TMP_20221018190649_4C5E5S9_RF_B0 part 2. Populate
...
FROM "TMP_20221018190648_LK433E3_ADS_sca_2_OUT" AS "ADS_sca_2_OUT"), 
"DT_node_data" AS 
...
-- Code For temporary table TMP_20221018190649_HMAXM1Y_RF_B1 part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221018190649_HMAXM1Y_RF_B1" (
	"KEY" BIGINT, 
	"Score_CLASS_0" FLOAT, 
	"Proba_CLASS_0" FLOAT, 
	"LogProba_CLASS_0" FLOAT, 
...
-- Code For temporary table TMP_20221018190649_HMAXM1Y_RF_B1 part 2. Populate
...
FROM "DT_Output_15")
 INSERT INTO "TMP_20221018190649_HMAXM1Y_RF_B1" ("KEY", "Score_CLASS_0", "Proba_CLASS_0", "LogProba_CLASS_0", "Score_CLASS_1", "Proba_CLASS_1", "LogProba_CLASS_1", "Score_CLASS_2", "Proba_CLASS_2", "LogProba_CLASS_2") SELECT "T"."KEY", "T"."Score_CLASS_0", "T"."Proba_CLASS_0", "T"."LogProba_CLASS_0", "T"."Score_CLASS_1", "T"."Proba_CLASS_1", "T"."LogProba_CLASS_1", "T"."Score_CLASS_2", "T"."Proba_CLASS_2", "T"."LogProba_CLASS_2" 
...
-- Code For temporary table TMP_20221018190649_S2DVOFY_RF_avg part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221018190649_S2DVOFY_RF_avg" (
	"KEY" BIGINT NOT NULL, 
	"Score_CLASS_0" FLOAT, 
	"Proba_CLASS_0" FLOAT, 
	"LogProba_CLASS_0" FLOAT, 
...
-- Code For temporary table TMP_20221018190649_S2DVOFY_RF_avg part 2. Populate
...
FROM (SELECT "RF_B0"."KEY" AS "KEY", "RF_B0"."Score_CLASS_0" AS "Score_CLASS_0", "RF_B0"."Proba_CLASS_0" AS "Proba_CLASS_0", "RF_B0"."LogProba_CLASS_0" AS "LogProba_CLASS_0", "RF_B0"."Score_CLASS_1" AS "Score_CLASS_1", "RF_B0"."Proba_CLASS_1" AS "Proba_CLASS_1", "RF_B0"."LogProba_CLASS_1" AS "LogProba_CLASS_1", "RF_B0"."Score_CLASS_2" AS "Score_CLASS_2", "RF_B0"."Proba_CLASS_2" AS "Proba_CLASS_2", "RF_B0"."LogProba_CLASS_2" AS "LogProba_CLASS_2" 
FROM "TMP_20221018190649_4C5E5S9_RF_B0" AS "RF_B0" UNION ALL SELECT "RF_B1"."KEY" AS "KEY", "RF_B1"."Score_CLASS_0" AS "Score_CLASS_0", "RF_B1"."Proba_CLASS_0" AS "Proba_CLASS_0", "RF_B1"."LogProba_CLASS_0" AS "LogProba_CLASS_0", "RF_B1"."Score_CLASS_1" AS "Score_CLASS_1", "RF_B1"."Proba_CLASS_1" AS "Proba_CLASS_1", "RF_B1"."LogProba_CLASS_1" AS "LogProba_CLASS_1", "RF_B1"."Score_CLASS_2" AS "Score_CLASS_2", "RF_B1"."Proba_CLASS_2" AS "Proba_CLASS_2", "RF_B1"."LogProba_CLASS_2" AS "LogProba_CLASS_2" 
FROM "TMP_20221018190649_HMAXM1Y_RF_B1" AS "RF_B1") AS "RF_EnsembleUnion")
 INSERT INTO "TMP_20221018190649_S2DVOFY_RF_avg" ("KEY", "Score_CLASS_0", "Proba_CLASS_0", "LogProba_CLASS_0", "Score_CLASS_1", "Proba_CLASS_1", "LogProba_CLASS_1", "Score_CLASS_2", "Proba_CLASS_2", "LogProba_CLASS_2") SELECT "T"."KEY", "T"."Score_CLASS_0", "T"."Proba_CLASS_0", "T"."LogProba_CLASS_0", "T"."Score_CLASS_1", "T"."Proba_CLASS_1", "T"."LogProba_CLASS_1", "T"."Score_CLASS_2", "T"."Proba_CLASS_2", "T"."LogProba_CLASS_2" 
...
-- Code For temporary table TMP_20221018190649_S2DVOFY_RF_avg part 3. Create Index 

CREATE INDEX "ix_TMP_20221018190649_S2DVOFY_RF_avg_KEY" ON "TMP_20221018190649_S2DVOFY_RF_avg" ("KEY")
...
FROM "TMP_20221018190649_S2DVOFY_RF_avg" AS "RF_avg"), 
