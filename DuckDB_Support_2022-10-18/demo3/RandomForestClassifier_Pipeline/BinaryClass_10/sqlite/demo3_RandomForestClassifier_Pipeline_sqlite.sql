...
-- Code For temporary table TMP_20221018184842_D0SQQ2Y_ADS_imp_1_OUT part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221018184842_D0SQQ2Y_ADS_imp_1_OUT" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20221018184842_D0SQQ2Y_ADS_imp_1_OUT part 3. Create Index 

CREATE INDEX "ix_TMP_20221018184842_D0SQQ2Y_ADS_imp_1_OUT_KEY" ON "TMP_20221018184842_D0SQQ2Y_ADS_imp_1_OUT" ("KEY")

-- Code For temporary table TMP_20221018184842_F4M4JFV_ADS_sca_2_OUT part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221018184842_F4M4JFV_ADS_sca_2_OUT" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20221018184842_F4M4JFV_ADS_sca_2_OUT part 2. Populate

INSERT INTO "TMP_20221018184842_F4M4JFV_ADS_sca_2_OUT" ("KEY", scaler_output_2, scaler_output_3, scaler_output_4, scaler_output_5, scaler_output_6, scaler_output_7, scaler_output_8, scaler_output_9, scaler_output_10, scaler_output_11) SELECT "T"."KEY", "T".scaler_output_2, "T".scaler_output_3, "T".scaler_output_4, "T".scaler_output_5, "T".scaler_output_6, "T".scaler_output_7, "T".scaler_output_8, "T".scaler_output_9, "T".scaler_output_10, "T".scaler_output_11 
...
FROM "TMP_20221018184842_D0SQQ2Y_ADS_imp_1_OUT" AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT") AS "T"

-- Code For temporary table TMP_20221018184842_F4M4JFV_ADS_sca_2_OUT part 3. Create Index 

CREATE INDEX "ix_TMP_20221018184842_F4M4JFV_ADS_sca_2_OUT_KEY" ON "TMP_20221018184842_F4M4JFV_ADS_sca_2_OUT" ("KEY")

-- Code For temporary table TMP_20221018184842_BMUR56E_RF_B0 part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221018184842_BMUR56E_RF_B0" (
	"KEY" BIGINT, 
	"Score_0" FLOAT, 
	"Proba_0" FLOAT, 
	"LogProba_0" FLOAT, 
...
-- Code For temporary table TMP_20221018184842_BMUR56E_RF_B0 part 2. Populate

WITH "DT_node_lookup" AS 
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", CASE WHEN ("ADS_sca_2_OUT".scaler_output_9 <= -0.09744600765407085) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_output_8 <= 1.7904822826385498) THEN 2 ELSE 3 END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_output_3 <= -0.040885768830776215) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_output_4 <= 1.7515930533409119) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_output_7 <= 1.6695640087127686) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_output_7 <= -0.9756371378898621) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_output_10 <= 0.8374288864433765) THEN 9 ELSE 10 END ELSE 11 END ELSE 12 END ELSE 13 END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_output_5 <= 1.0299373269081116) THEN 15 ELSE 16 END END END AS node_id_2 
FROM "TMP_20221018184842_F4M4JFV_ADS_sca_2_OUT" AS "ADS_sca_2_OUT"), 
"DT_node_data" AS 
...
FROM "DT_Output"), 
"DT_node_lookup_1" AS 
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", CASE WHEN ("ADS_sca_2_OUT".scaler_output_11 <= 0.39982809126377106) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_output_8 <= -1.5110454559326172) THEN 2 ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_output_3 <= -0.6982106864452362) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_output_11 <= -0.899230420589447) THEN 5 ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_output_11 <= -0.33868634700775146) THEN 7 ELSE 8 END END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_output_10 <= -1.2021921873092651) THEN 10 ELSE 11 END END END ELSE 12 END AS node_id_2 
FROM "TMP_20221018184842_F4M4JFV_ADS_sca_2_OUT" AS "ADS_sca_2_OUT"), 
"DT_node_data_1" AS 
(SELECT "Values".nid AS nid, "Values"."P_0" AS "P_0", "Values"."P_1" AS "P_1", "Values"."D" AS "D", "Values"."DP" AS "DP" 
...
FROM "DT_Output_1"), 
"DT_node_lookup_2" AS 
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", CASE WHEN ("ADS_sca_2_OUT".scaler_output_6 <= -1.5415819883346558) THEN 1 ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_output_4 <= -0.6385309994220734) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_output_2 <= 0.8419976830482483) THEN 4 ELSE 5 END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_output_2 <= -0.7909338176250458) THEN 7 ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_output_10 <= -0.055404980666935444) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_output_7 <= -0.8065626621246338) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_output_11 <= -0.7188974022865295) THEN 11 ELSE 12 END ELSE 13 END ELSE 14 END END END END AS node_id_2 
FROM "TMP_20221018184842_F4M4JFV_ADS_sca_2_OUT" AS "ADS_sca_2_OUT"), 
"DT_node_data_2" AS 
(SELECT "Values".nid AS nid, "Values"."P_0" AS "P_0", "Values"."P_1" AS "P_1", "Values"."D" AS "D", "Values"."DP" AS "DP" 
...
FROM "DT_Output_2"), 
"DT_node_lookup_3" AS 
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", CASE WHEN ("ADS_sca_2_OUT".scaler_output_4 <= 0.6044496595859528) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_output_2 <= 0.2525553032755852) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_output_11 <= 0.35896430909633636) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_output_6 <= 0.018000438809394836) THEN 4 ELSE 5 END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_output_3 <= 0.2820662558078766) THEN 7 ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_output_10 <= 0.2733854874968529) THEN 9 ELSE 10 END END END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_output_10 <= -0.11982563510537148) THEN 12 ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_output_4 <= -0.4135747700929642) THEN 14 ELSE 15 END END END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_output_11 <= -0.7353123426437378) THEN 17 ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_output_8 <= -0.9378960728645325) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_output_8 <= -1.3291583061218262) THEN 20 ELSE 21 END ELSE 22 END END END AS node_id_2 
FROM "TMP_20221018184842_F4M4JFV_ADS_sca_2_OUT" AS "ADS_sca_2_OUT"), 
"DT_node_data_3" AS 
(SELECT "Values".nid AS nid, "Values"."P_0" AS "P_0", "Values"."P_1" AS "P_1", "Values"."D" AS "D", "Values"."DP" AS "DP" 
...
FROM "DT_Output_3"), 
"DT_node_lookup_4" AS 
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", CASE WHEN ("ADS_sca_2_OUT".scaler_output_7 <= 0.098798468708992) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_output_2 <= 0.09469972178339958) THEN 2 ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_output_2 <= 0.8419976830482483) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_output_6 <= -0.2658952325582504) THEN 5 ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_output_7 <= -0.721694141626358) THEN 7 ELSE 8 END END ELSE 9 END END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_output_11 <= 0.3664867579936981) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_output_5 <= 0.12596963858231902) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_output_7 <= 1.2095164060592651) THEN 13 ELSE 14 END ELSE 15 END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_output_9 <= -0.5180724263191223) THEN 17 ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_output_3 <= -0.6525318622589111) THEN 19 ELSE 20 END END END END AS node_id_2 
FROM "TMP_20221018184842_F4M4JFV_ADS_sca_2_OUT" AS "ADS_sca_2_OUT"), 
"DT_node_data_4" AS 
(SELECT "Values".nid AS nid, "Values"."P_0" AS "P_0", "Values"."P_1" AS "P_1", "Values"."D" AS "D", "Values"."DP" AS "DP" 
...
FROM "DT_Output_4"), 
"DT_node_lookup_5" AS 
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", CASE WHEN ("ADS_sca_2_OUT".scaler_output_9 <= 0.7019175291061401) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_output_2 <= -0.673702597618103) THEN 2 ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_output_5 <= 0.4229836165904999) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_output_4 <= -0.6828252673149109) THEN 5 ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_output_7 <= -0.7061576545238495) THEN 7 ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_output_7 <= 1.6695640087127686) THEN 9 ELSE 10 END END END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_output_7 <= -0.6792028844356537) THEN 12 ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_output_11 <= -0.5897483676671982) THEN 14 ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_output_9 <= -0.12057507038116455) THEN 16 ELSE 17 END END END END END ELSE 18 END AS node_id_2 
FROM "TMP_20221018184842_F4M4JFV_ADS_sca_2_OUT" AS "ADS_sca_2_OUT"), 
"DT_node_data_5" AS 
(SELECT "Values".nid AS nid, "Values"."P_0" AS "P_0", "Values"."P_1" AS "P_1", "Values"."D" AS "D", "Values"."DP" AS "DP" 
...
FROM "DT_Output_5"), 
"DT_node_lookup_6" AS 
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", CASE WHEN ("ADS_sca_2_OUT".scaler_output_11 <= 0.2177198063582182) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_output_9 <= 0.6834322512149811) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_output_2 <= 0.6076438426971436) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_output_2 <= 0.2812865674495697) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_output_2 <= 0.04084806889295578) THEN 5 ELSE 6 END ELSE 7 END ELSE 8 END ELSE 9 END ELSE 10 END AS node_id_2 
FROM "TMP_20221018184842_F4M4JFV_ADS_sca_2_OUT" AS "ADS_sca_2_OUT"), 
"DT_node_data_6" AS 
(SELECT "Values".nid AS nid, "Values"."P_0" AS "P_0", "Values"."P_1" AS "P_1", "Values"."D" AS "D", "Values"."DP" AS "DP" 
...
FROM "DT_Output_6"), 
"DT_node_lookup_7" AS 
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", CASE WHEN ("ADS_sca_2_OUT".scaler_output_2 <= 0.49284863471984863) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_output_3 <= -0.28039713203907013) THEN 2 ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_output_5 <= 0.34787455201148987) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_output_11 <= 0.06430907547473907) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_output_6 <= -1.5428242683410645) THEN 6 ELSE 7 END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_output_11 <= 0.39982809126377106) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_output_8 <= 1.0739960074424744) THEN 10 ELSE 11 END ELSE 12 END END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_output_7 <= 0.4285707250237465) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_output_5 <= 0.8411320447921753) THEN 15 ELSE 16 END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_output_3 <= 1.1658422648906708) THEN 18 ELSE 19 END END END END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_output_8 <= 1.4502137303352356) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_output_7 <= -1.391805112361908) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_output_7 <= -1.502712070941925) THEN 23 ELSE 24 END ELSE 25 END ELSE 26 END END AS node_id_2 
FROM "TMP_20221018184842_F4M4JFV_ADS_sca_2_OUT" AS "ADS_sca_2_OUT"), 
"DT_node_data_7" AS 
(SELECT "Values".nid AS nid, "Values"."P_0" AS "P_0", "Values"."P_1" AS "P_1", "Values"."D" AS "D", "Values"."DP" AS "DP" 
...
FROM "DT_Output_7"), 
"DT_node_lookup_8" AS 
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", CASE WHEN ("ADS_sca_2_OUT".scaler_output_9 <= -0.15989292226731777) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_output_11 <= 0.35896430909633636) THEN 2 ELSE 3 END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_output_5 <= 1.0201719403266907) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_output_3 <= 1.741069734096527) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_output_4 <= 1.6155323386192322) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_output_7 <= 1.8771445751190186) THEN 8 ELSE 9 END ELSE 10 END ELSE 11 END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_output_5 <= 1.081719160079956) THEN 13 ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_output_10 <= -0.4357791654765606) THEN 15 ELSE 16 END END END END AS node_id_2 
FROM "TMP_20221018184842_F4M4JFV_ADS_sca_2_OUT" AS "ADS_sca_2_OUT"), 
"DT_node_data_8" AS 
(SELECT "Values".nid AS nid, "Values"."P_0" AS "P_0", "Values"."P_1" AS "P_1", "Values"."D" AS "D", "Values"."DP" AS "DP" 
...
FROM "DT_Output_8"), 
"DT_node_lookup_9" AS 
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", CASE WHEN ("ADS_sca_2_OUT".scaler_output_7 <= -1.5204164385795593) THEN 1 ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_output_9 <= 0.4340944141149521) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_output_7 <= 1.5400466918945312) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_output_9 <= -0.17762035876512527) THEN 5 ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_output_3 <= -0.04720932990312576) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_output_2 <= 0.12675124406814575) THEN 8 ELSE 9 END ELSE 10 END END ELSE 11 END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_output_8 <= 1.4502137303352356) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_output_7 <= -0.8737834692001343) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_output_9 <= 0.7470591068267822) THEN 15 ELSE 16 END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_output_6 <= -1.7550748586654663) THEN 18 ELSE 19 END END ELSE 20 END END END AS node_id_2 
FROM "TMP_20221018184842_F4M4JFV_ADS_sca_2_OUT" AS "ADS_sca_2_OUT"), 
"DT_node_data_9" AS 
(SELECT "Values".nid AS nid, "Values"."P_0" AS "P_0", "Values"."P_1" AS "P_1", "Values"."D" AS "D", "Values"."DP" AS "DP" 
...
FROM "DT_Output_9")
 INSERT INTO "TMP_20221018184842_BMUR56E_RF_B0" ("KEY", "Score_0", "Proba_0", "LogProba_0", "Score_1", "Proba_1", "LogProba_1") SELECT "T"."KEY", "T"."Score_0", "T"."Proba_0", "T"."LogProba_0", "T"."Score_1", "T"."Proba_1", "T"."LogProba_1" 
...
-- Code For temporary table TMP_20221018184843_JH7TNJT_RF_B1 part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221018184843_JH7TNJT_RF_B1" (
	"KEY" BIGINT, 
	"Score_0" FLOAT, 
	"Proba_0" FLOAT, 
	"LogProba_0" FLOAT, 
...
-- Code For temporary table TMP_20221018184843_JH7TNJT_RF_B1 part 2. Populate

WITH "DT_node_lookup_10" AS 
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", CASE WHEN ("ADS_sca_2_OUT".scaler_output_8 <= -1.5110454559326172) THEN 1 ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_output_6 <= -0.7483713626861572) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_output_9 <= -0.4862777888774872) THEN 4 ELSE 5 END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_output_11 <= -0.2218535766005516) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_output_11 <= -0.8138018548488617) THEN 8 ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_output_10 <= -0.12137558683753014) THEN 10 ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_output_9 <= 0.527113288640976) THEN 12 ELSE 13 END END END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_output_3 <= 0.4109950512647629) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_output_7 <= 1.0392827689647675) THEN 16 ELSE 17 END ELSE 18 END END END END AS node_id_2 
FROM "TMP_20221018184842_F4M4JFV_ADS_sca_2_OUT" AS "ADS_sca_2_OUT"), 
"DT_node_data_10" AS 
(SELECT "Values".nid AS nid, "Values"."P_0" AS "P_0", "Values"."P_1" AS "P_1", "Values"."D" AS "D", "Values"."DP" AS "DP" 
...
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", CASE WHEN ("ADS_sca_2_OUT".scaler_output_10 <= 0.5882218182086945) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_output_2 <= 0.3036426156759262) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_output_6 <= 1.8425835371017456) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_output_6 <= -0.7483713626861572) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_output_10 <= -1.322110265493393) THEN 5 ELSE 6 END ELSE 7 END ELSE 8 END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_output_5 <= 0.44172467291355133) THEN 10 ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_output_10 <= -0.12137558683753014) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_output_8 <= -0.5067850202322006) THEN 13 ELSE 14 END ELSE 15 END END END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_output_11 <= -0.2916967272758484) THEN 17 ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_output_3 <= 0.3417997360229492) THEN 19 ELSE 20 END END END AS node_id_2 
FROM "TMP_20221018184842_F4M4JFV_ADS_sca_2_OUT" AS "ADS_sca_2_OUT"), 
"DT_node_data_11" AS 
(SELECT "Values".nid AS nid, "Values"."P_0" AS "P_0", "Values"."P_1" AS "P_1", "Values"."D" AS "D", "Values"."DP" AS "DP" 
...
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", CASE WHEN ("ADS_sca_2_OUT".scaler_output_11 <= 0.07101128064095974) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_output_8 <= 1.571669578552246) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_output_11 <= -0.5361407995223999) THEN 3 ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_output_7 <= -0.7807675302028656) THEN 5 ELSE 6 END END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_output_9 <= 0.333208579570055) THEN 8 ELSE 9 END END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_output_8 <= 1.8911219835281372) THEN 11 ELSE 12 END END AS node_id_2 
FROM "TMP_20221018184842_F4M4JFV_ADS_sca_2_OUT" AS "ADS_sca_2_OUT"), 
"DT_node_data_12" AS 
(SELECT "Values".nid AS nid, "Values"."P_0" AS "P_0", "Values"."P_1" AS "P_1", "Values"."D" AS "D", "Values"."DP" AS "DP" 
...
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", CASE WHEN ("ADS_sca_2_OUT".scaler_output_2 <= 0.49284863471984863) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_output_9 <= -0.5180724263191223) THEN 2 ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_output_7 <= -0.5002382099628448) THEN 4 ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_output_4 <= -0.6514938771724701) THEN 6 ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_output_6 <= -1.7550748586654663) THEN 8 ELSE 9 END END END END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_output_10 <= 0.8492954969406128) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_output_11 <= -0.5707489252090454) THEN 12 ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_output_4 <= 0.4337238669395447) THEN 14 ELSE 15 END END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_output_2 <= 0.6194821298122406) THEN 17 ELSE 18 END END END AS node_id_2 
FROM "TMP_20221018184842_F4M4JFV_ADS_sca_2_OUT" AS "ADS_sca_2_OUT"), 
"DT_node_data_13" AS 
(SELECT "Values".nid AS nid, "Values"."P_0" AS "P_0", "Values"."P_1" AS "P_1", "Values"."D" AS "D", "Values"."DP" AS "DP" 
...
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", CASE WHEN ("ADS_sca_2_OUT".scaler_output_8 <= 0.46281829476356506) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_output_2 <= 0.2525553032755852) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_output_9 <= 0.12622723076492548) THEN 3 ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_output_11 <= -0.553318664431572) THEN 5 ELSE 6 END END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_output_4 <= 1.4476708769798279) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_output_8 <= 0.30070554465055466) THEN 9 ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_output_5 <= -0.7278655171394348) THEN 11 ELSE 12 END END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_output_9 <= 0.6782427430152893) THEN 14 ELSE 15 END END END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_output_10 <= 0.8706877529621124) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_output_4 <= -2.582048714160919) THEN 18 ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_output_2 <= -1.1600289046764374) THEN 20 ELSE 21 END END ELSE 22 END END AS node_id_2 
FROM "TMP_20221018184842_F4M4JFV_ADS_sca_2_OUT" AS "ADS_sca_2_OUT"), 
"DT_node_data_14" AS 
(SELECT "Values".nid AS nid, "Values"."P_0" AS "P_0", "Values"."P_1" AS "P_1", "Values"."D" AS "D", "Values"."DP" AS "DP" 
...
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", CASE WHEN ("ADS_sca_2_OUT".scaler_output_11 <= 0.07101128064095974) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_output_8 <= 1.644851267337799) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_output_10 <= -0.1417776234447956) THEN 3 ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_output_7 <= -0.9102475047111511) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_output_3 <= 0.8252071738243103) THEN 6 ELSE 7 END ELSE 8 END END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_output_2 <= 0.19136908650398254) THEN 10 ELSE 11 END END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_output_5 <= -1.061799794435501) THEN 13 ELSE 14 END END AS node_id_2 
FROM "TMP_20221018184842_F4M4JFV_ADS_sca_2_OUT" AS "ADS_sca_2_OUT"), 
"DT_node_data_15" AS 
(SELECT "Values".nid AS nid, "Values"."P_0" AS "P_0", "Values"."P_1" AS "P_1", "Values"."D" AS "D", "Values"."DP" AS "DP" 
...
FROM "DT_Output_15")
 INSERT INTO "TMP_20221018184843_JH7TNJT_RF_B1" ("KEY", "Score_0", "Proba_0", "LogProba_0", "Score_1", "Proba_1", "LogProba_1") SELECT "T"."KEY", "T"."Score_0", "T"."Proba_0", "T"."LogProba_0", "T"."Score_1", "T"."Proba_1", "T"."LogProba_1" 
...
-- Code For temporary table TMP_20221018184843_YV878WA_RF_avg part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221018184843_YV878WA_RF_avg" (
	"KEY" BIGINT NOT NULL, 
	"Score_0" FLOAT, 
	"Proba_0" FLOAT, 
	"LogProba_0" FLOAT, 
...
-- Code For temporary table TMP_20221018184843_YV878WA_RF_avg part 2. Populate
...
FROM (SELECT "RF_B0"."KEY" AS "KEY", "RF_B0"."Score_0" AS "Score_0", "RF_B0"."Proba_0" AS "Proba_0", "RF_B0"."LogProba_0" AS "LogProba_0", "RF_B0"."Score_1" AS "Score_1", "RF_B0"."Proba_1" AS "Proba_1", "RF_B0"."LogProba_1" AS "LogProba_1" 
FROM "TMP_20221018184842_BMUR56E_RF_B0" AS "RF_B0" UNION ALL SELECT "RF_B1"."KEY" AS "KEY", "RF_B1"."Score_0" AS "Score_0", "RF_B1"."Proba_0" AS "Proba_0", "RF_B1"."LogProba_0" AS "LogProba_0", "RF_B1"."Score_1" AS "Score_1", "RF_B1"."Proba_1" AS "Proba_1", "RF_B1"."LogProba_1" AS "LogProba_1" 
FROM "TMP_20221018184843_JH7TNJT_RF_B1" AS "RF_B1") AS "RF_EnsembleUnion")
 INSERT INTO "TMP_20221018184843_YV878WA_RF_avg" ("KEY", "Score_0", "Proba_0", "LogProba_0", "Score_1", "Proba_1", "LogProba_1") SELECT "T"."KEY", "T"."Score_0", "T"."Proba_0", "T"."LogProba_0", "T"."Score_1", "T"."Proba_1", "T"."LogProba_1" 
...
-- Code For temporary table TMP_20221018184843_YV878WA_RF_avg part 3. Create Index 

CREATE INDEX "ix_TMP_20221018184843_YV878WA_RF_avg_KEY" ON "TMP_20221018184843_YV878WA_RF_avg" ("KEY")
...
FROM "TMP_20221018184843_YV878WA_RF_avg" AS "RF_avg"), 
