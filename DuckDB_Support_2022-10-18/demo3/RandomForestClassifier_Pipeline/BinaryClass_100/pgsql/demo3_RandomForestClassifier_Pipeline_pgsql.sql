...
-- Code For temporary table TMP_20221018184953_OFD4IM1_ADS_imp_1_OUT part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221018184953_OFD4IM1_ADS_imp_1_OUT" (
	"KEY" BIGINT NOT NULL, 
	impter_2 FLOAT, 
	impter_3 FLOAT, 
	impter_4 FLOAT, 
...
-- Code For temporary table TMP_20221018184953_OFD4IM1_ADS_imp_1_OUT part 3. Create Index 

CREATE INDEX "ix_TMP_20221018184953_OFD4IM1_ADS_imp_1_OUT_KEY" ON "TMP_20221018184953_OFD4IM1_ADS_imp_1_OUT" ("KEY")

-- Code For temporary table TMP_20221018184953_MCI36BP_ADS_sca_2_OUT part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221018184953_MCI36BP_ADS_sca_2_OUT" (
	"KEY" BIGINT NOT NULL, 
	scaler_2 FLOAT, 
	scaler_3 FLOAT, 
	scaler_4 FLOAT, 
...
FROM "TMP_20221018184953_OFD4IM1_ADS_imp_1_OUT" AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT") AS "T"

-- Code For temporary table TMP_20221018184953_MCI36BP_ADS_sca_2_OUT part 3. Create Index 

CREATE INDEX "ix_TMP_20221018184953_MCI36BP_ADS_sca_2_OUT_KEY" ON "TMP_20221018184953_MCI36BP_ADS_sca_2_OUT" ("KEY")

-- Code For temporary table TMP_20221018184953_76VENRQ_RF_B0 part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221018184953_76VENRQ_RF_B0" (
	"KEY" BIGINT, 
	"Score_0" FLOAT, 
	"Proba_0" FLOAT, 
	"LogProba_0" FLOAT, 
...
-- Code For temporary table TMP_20221018184953_76VENRQ_RF_B0 part 2. Populate

WITH "DT_node_lookup" AS 
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", CASE WHEN ("ADS_sca_2_OUT".scaler_18 <= -0.40345078706741333) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_47 <= 0.7596310079097748) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_61 <= 0.976247638463974) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_12 <= 1.8483157753944397) THEN 4 ELSE 5 END ELSE 6 END ELSE 7 END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_96 <= 0.4528079628944397) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_6 <= -0.8123522400856018) THEN 10 ELSE 11 END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_52 <= 0.16934804432094097) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_100 <= 1.0482742190361023) THEN 14 ELSE 15 END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_71 <= -0.2531144255772233) THEN 17 ELSE 18 END END END END AS node_id_2 
FROM "TMP_20221018184953_MCI36BP_ADS_sca_2_OUT" AS "ADS_sca_2_OUT"), 
"DT_node_data" AS 
...
FROM "DT_Output_3"), 
"DT_node_lookup_4" AS 
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", CASE WHEN ("ADS_sca_2_OUT".scaler_79 <= -0.617430180311203) THEN 1 ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_13 <= 1.6134028434753418) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_29 <= 0.8256935179233551) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_60 <= 0.9685824513435364) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_90 <= -2.2426377534866333) THEN 6 ELSE 7 END ELSE 8 END ELSE 9 END ELSE 10 END END AS node_id_2 
FROM "TMP_20221018184953_MCI36BP_ADS_sca_2_OUT" AS "ADS_sca_2_OUT"), 
"DT_node_data_4" AS 
(SELECT "Values".nid AS nid, "Values"."P_0" AS "P_0", "Values"."P_1" AS "P_1", "Values"."D" AS "D", "Values"."DP" AS "DP" 
...
FROM "DT_Output_4"), 
"DT_node_lookup_5" AS 
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", CASE WHEN ("ADS_sca_2_OUT".scaler_63 <= -0.4601595103740692) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_5 <= -0.37978340685367584) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_71 <= 1.4860942363739014) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_23 <= 0.46459804475307465) THEN 4 ELSE 5 END ELSE 6 END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_58 <= 1.5244999527931213) THEN 8 ELSE 9 END END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_50 <= -0.2460956797003746) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_48 <= -1.0099084377288818) THEN 12 ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_81 <= -1.3912010192871094) THEN 14 ELSE 15 END END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_60 <= 0.5898045003414154) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_75 <= 0.8604358732700348) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_61 <= -1.3341688811779022) THEN 19 ELSE 20 END ELSE 21 END ELSE 22 END END END AS node_id_2 
FROM "TMP_20221018184953_MCI36BP_ADS_sca_2_OUT" AS "ADS_sca_2_OUT"), 
"DT_node_data_5" AS 
(SELECT "Values".nid AS nid, "Values"."P_0" AS "P_0", "Values"."P_1" AS "P_1", "Values"."D" AS "D", "Values"."DP" AS "DP" 
...
FROM "DT_Output_9")
 INSERT INTO "TMP_20221018184953_76VENRQ_RF_B0" ("KEY", "Score_0", "Proba_0", "LogProba_0", "Score_1", "Proba_1", "LogProba_1") SELECT "T"."KEY", "T"."Score_0", "T"."Proba_0", "T"."LogProba_0", "T"."Score_1", "T"."Proba_1", "T"."LogProba_1" 
...
-- Code For temporary table TMP_20221018184953_5E6FC5K_RF_B1 part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221018184953_5E6FC5K_RF_B1" (
	"KEY" BIGINT, 
	"Score_0" FLOAT, 
	"Proba_0" FLOAT, 
	"LogProba_0" FLOAT, 
...
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", CASE WHEN ("ADS_sca_2_OUT".scaler_44 <= 0.7348853051662445) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_43 <= 0.5510576665401459) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_60 <= -0.0369467893615365) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_100 <= -1.2405037879943848) THEN 4 ELSE 5 END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_8 <= 0.4403476417064667) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_17 <= 0.5302181839942932) THEN 8 ELSE 9 END ELSE 10 END END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_62 <= -0.8951797112822533) THEN 12 ELSE 13 END END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_82 <= -1.5836946368217468) THEN 15 ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_65 <= -1.8797409534454346) THEN 17 ELSE 18 END END END AS node_id_2 
FROM "TMP_20221018184953_MCI36BP_ADS_sca_2_OUT" AS "ADS_sca_2_OUT"), 
"DT_node_data_11" AS 
(SELECT "Values".nid AS nid, "Values"."P_0" AS "P_0", "Values"."P_1" AS "P_1", "Values"."D" AS "D", "Values"."DP" AS "DP" 
...
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", CASE WHEN ("ADS_sca_2_OUT".scaler_94 <= -0.36253754794597626) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_20 <= -0.7763404548168182) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_47 <= -1.4598841071128845) THEN 3 ELSE 4 END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_59 <= 0.8894120454788208) THEN 6 ELSE 7 END END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_62 <= -0.5680299699306488) THEN 9 ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_6 <= 0.05269428715109825) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_14 <= -0.4073029011487961) THEN 12 ELSE 13 END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_65 <= 1.8246609568595886) THEN 15 ELSE 16 END END END END AS node_id_2 
FROM "TMP_20221018184953_MCI36BP_ADS_sca_2_OUT" AS "ADS_sca_2_OUT"), 
"DT_node_data_13" AS 
(SELECT "Values".nid AS nid, "Values"."P_0" AS "P_0", "Values"."P_1" AS "P_1", "Values"."D" AS "D", "Values"."DP" AS "DP" 
...
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", CASE WHEN ("ADS_sca_2_OUT".scaler_2 <= -0.8055896759033203) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_92 <= -1.2382536232471466) THEN 2 ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_100 <= 1.6765033602714539) THEN 4 ELSE 5 END END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_75 <= 0.8604358732700348) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_59 <= -0.32243387401103973) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_12 <= -0.764499306678772) THEN 9 ELSE 10 END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_92 <= 0.9245067238807678) THEN 12 ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_60 <= -0.2608867734670639) THEN 14 ELSE 15 END END END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_2 <= -0.2917218953371048) THEN 17 ELSE 18 END END END AS node_id_2 
FROM "TMP_20221018184953_MCI36BP_ADS_sca_2_OUT" AS "ADS_sca_2_OUT"), 
"DT_node_data_14" AS 
(SELECT "Values".nid AS nid, "Values"."P_0" AS "P_0", "Values"."P_1" AS "P_1", "Values"."D" AS "D", "Values"."DP" AS "DP" 
FROM (SELECT 2 AS nid, 0.0 AS "P_0", 1.0 AS "P_1", 1 AS "D", 1.0 AS "DP" UNION ALL SELECT 4 AS nid, 1.0 AS "P_0", 0.0 AS "P_1", 0 AS "D", 1.0 AS "DP" UNION ALL SELECT 5 AS nid, 0.0 AS "P_0", 1.0 AS "P_1", 1 AS "D", 1.0 AS "DP" UNION ALL SELECT 9 AS nid, 0.0 AS "P_0", 1.0 AS "P_1", 1 AS "D", 1.0 AS "DP" UNION ALL SELECT 10 AS nid, 1.0 AS "P_0", 0.0 AS "P_1", 0 AS "D", 1.0 AS "DP" UNION ALL SELECT 12 AS nid, 0.0 AS "P_0", 1.0 AS "P_1", 1 AS "D", 1.0 AS "DP" UNION ALL SELECT 14 AS nid, 0.0 AS "P_0", 1.0 AS "P_1", 1 AS "D", 1.0 AS "DP" UNION ALL SELECT 15 AS nid, 1.0 AS "P_0", 0.0 AS "P_1", 0 AS "D", 1.0 AS "DP" UNION ALL SELECT 17 AS nid, 0.0 AS "P_0", 1.0 AS "P_1", 1 AS "D", 1.0 AS "DP" UNION ALL SELECT 18 AS nid, 1.0 AS "P_0", 0.0 AS "P_1", 0 AS "D", 1.0 AS "DP") AS "Values"), 
...
FROM "DT_Output_15")
 INSERT INTO "TMP_20221018184953_5E6FC5K_RF_B1" ("KEY", "Score_0", "Proba_0", "LogProba_0", "Score_1", "Proba_1", "LogProba_1") SELECT "T"."KEY", "T"."Score_0", "T"."Proba_0", "T"."LogProba_0", "T"."Score_1", "T"."Proba_1", "T"."LogProba_1" 
...
-- Code For temporary table TMP_20221018184953_75FQ24H_RF_avg part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221018184953_75FQ24H_RF_avg" (
	"KEY" BIGINT NOT NULL, 
	"Score_0" FLOAT, 
	"Proba_0" FLOAT, 
	"LogProba_0" FLOAT, 
...
-- Code For temporary table TMP_20221018184953_75FQ24H_RF_avg part 2. Populate
...
FROM (SELECT "RF_B0"."KEY" AS "KEY", "RF_B0"."Score_0" AS "Score_0", "RF_B0"."Proba_0" AS "Proba_0", "RF_B0"."LogProba_0" AS "LogProba_0", "RF_B0"."Score_1" AS "Score_1", "RF_B0"."Proba_1" AS "Proba_1", "RF_B0"."LogProba_1" AS "LogProba_1" 
FROM "TMP_20221018184953_76VENRQ_RF_B0" AS "RF_B0" UNION ALL SELECT "RF_B1"."KEY" AS "KEY", "RF_B1"."Score_0" AS "Score_0", "RF_B1"."Proba_0" AS "Proba_0", "RF_B1"."LogProba_0" AS "LogProba_0", "RF_B1"."Score_1" AS "Score_1", "RF_B1"."Proba_1" AS "Proba_1", "RF_B1"."LogProba_1" AS "LogProba_1" 
FROM "TMP_20221018184953_5E6FC5K_RF_B1" AS "RF_B1") AS "RF_EnsembleUnion")
 INSERT INTO "TMP_20221018184953_75FQ24H_RF_avg" ("KEY", "Score_0", "Proba_0", "LogProba_0", "Score_1", "Proba_1", "LogProba_1") SELECT "T"."KEY", "T"."Score_0", "T"."Proba_0", "T"."LogProba_0", "T"."Score_1", "T"."Proba_1", "T"."LogProba_1" 
...
-- Code For temporary table TMP_20221018184953_75FQ24H_RF_avg part 3. Create Index 

CREATE INDEX "ix_TMP_20221018184953_75FQ24H_RF_avg_KEY" ON "TMP_20221018184953_75FQ24H_RF_avg" ("KEY")
...
FROM "TMP_20221018184953_75FQ24H_RF_avg" AS "RF_avg"), 
