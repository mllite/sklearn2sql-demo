...
-- Code For temporary table TMP_20221018184953_9MY7VCW_ADS_imp_1_OUT part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221018184953_9MY7VCW_ADS_imp_1_OUT" (
	"KEY" BIGINT NOT NULL, 
	impter_2 DOUBLE, 
	impter_3 DOUBLE, 
	impter_4 DOUBLE, 
...
-- Code For temporary table TMP_20221018184953_9MY7VCW_ADS_imp_1_OUT part 3. Create Index 

CREATE INDEX "ix_TMP_20221018184953_9MY7VCW_ADS_imp_1_OUT_KEY" ON "TMP_20221018184953_9MY7VCW_ADS_imp_1_OUT" ("KEY")

-- Code For temporary table TMP_20221018184953_41O666Q_ADS_sca_2_OUT part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221018184953_41O666Q_ADS_sca_2_OUT" (
	"KEY" BIGINT NOT NULL, 
	scaler_2 DOUBLE, 
	scaler_3 DOUBLE, 
	scaler_4 DOUBLE, 
...
FROM "TMP_20221018184953_9MY7VCW_ADS_imp_1_OUT" AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT") AS "T"

-- Code For temporary table TMP_20221018184953_41O666Q_ADS_sca_2_OUT part 3. Create Index 

CREATE INDEX "ix_TMP_20221018184953_41O666Q_ADS_sca_2_OUT_KEY" ON "TMP_20221018184953_41O666Q_ADS_sca_2_OUT" ("KEY")

-- Code For temporary table TMP_20221018184953_EHU3ZU6_RF_B0 part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221018184953_EHU3ZU6_RF_B0" (
	"KEY" BIGINT, 
	"Score_0" DOUBLE, 
	"Proba_0" DOUBLE, 
	"LogProba_0" DOUBLE, 
...
-- Code For temporary table TMP_20221018184953_EHU3ZU6_RF_B0 part 2. Populate
...
FROM "TMP_20221018184953_41O666Q_ADS_sca_2_OUT" AS "ADS_sca_2_OUT"), 
"DT_node_data" AS 
...
FROM "DT_Output_9")
 INSERT INTO "TMP_20221018184953_EHU3ZU6_RF_B0" ("KEY", "Score_0", "Proba_0", "LogProba_0", "Score_1", "Proba_1", "LogProba_1") SELECT "T"."KEY", "T"."Score_0", "T"."Proba_0", "T"."LogProba_0", "T"."Score_1", "T"."Proba_1", "T"."LogProba_1" 
...
-- Code For temporary table TMP_20221018184953_QAL0BHV_RF_B1 part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221018184953_QAL0BHV_RF_B1" (
	"KEY" BIGINT, 
	"Score_0" DOUBLE, 
	"Proba_0" DOUBLE, 
	"LogProba_0" DOUBLE, 
...
-- Code For temporary table TMP_20221018184953_QAL0BHV_RF_B1 part 2. Populate
...
FROM "DT_Output_15")
 INSERT INTO "TMP_20221018184953_QAL0BHV_RF_B1" ("KEY", "Score_0", "Proba_0", "LogProba_0", "Score_1", "Proba_1", "LogProba_1") SELECT "T"."KEY", "T"."Score_0", "T"."Proba_0", "T"."LogProba_0", "T"."Score_1", "T"."Proba_1", "T"."LogProba_1" 
...
-- Code For temporary table TMP_20221018184953_MZZRVVV_RF_avg part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221018184953_MZZRVVV_RF_avg" (
	"KEY" BIGINT NOT NULL, 
	"Score_0" DOUBLE, 
	"Proba_0" DOUBLE, 
	"LogProba_0" DOUBLE, 
...
-- Code For temporary table TMP_20221018184953_MZZRVVV_RF_avg part 2. Populate
...
FROM (SELECT "RF_B0"."KEY" AS "KEY", "RF_B0"."Score_0" AS "Score_0", "RF_B0"."Proba_0" AS "Proba_0", "RF_B0"."LogProba_0" AS "LogProba_0", "RF_B0"."Score_1" AS "Score_1", "RF_B0"."Proba_1" AS "Proba_1", "RF_B0"."LogProba_1" AS "LogProba_1" 
FROM "TMP_20221018184953_EHU3ZU6_RF_B0" AS "RF_B0" UNION ALL SELECT "RF_B1"."KEY" AS "KEY", "RF_B1"."Score_0" AS "Score_0", "RF_B1"."Proba_0" AS "Proba_0", "RF_B1"."LogProba_0" AS "LogProba_0", "RF_B1"."Score_1" AS "Score_1", "RF_B1"."Proba_1" AS "Proba_1", "RF_B1"."LogProba_1" AS "LogProba_1" 
FROM "TMP_20221018184953_QAL0BHV_RF_B1" AS "RF_B1") AS "RF_EnsembleUnion")
 INSERT INTO "TMP_20221018184953_MZZRVVV_RF_avg" ("KEY", "Score_0", "Proba_0", "LogProba_0", "Score_1", "Proba_1", "LogProba_1") SELECT "T"."KEY", "T"."Score_0", "T"."Proba_0", "T"."LogProba_0", "T"."Score_1", "T"."Proba_1", "T"."LogProba_1" 
...
-- Code For temporary table TMP_20221018184953_MZZRVVV_RF_avg part 3. Create Index 

CREATE INDEX "ix_TMP_20221018184953_MZZRVVV_RF_avg_KEY" ON "TMP_20221018184953_MZZRVVV_RF_avg" ("KEY")
...
FROM "TMP_20221018184953_MZZRVVV_RF_avg" AS "RF_avg"), 
