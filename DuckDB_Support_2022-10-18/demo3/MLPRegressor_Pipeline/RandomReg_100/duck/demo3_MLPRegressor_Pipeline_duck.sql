...
-- Code For temporary table TMP_20221018185523_Z3M5IT9_ADS_imp_1_OUT part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221018185523_Z3M5IT9_ADS_imp_1_OUT" (
	"KEY" BIGINT NOT NULL, 
	impter_2 DOUBLE, 
	impter_3 DOUBLE, 
	impter_4 DOUBLE, 
...
-- Code For temporary table TMP_20221018185523_Z3M5IT9_ADS_imp_1_OUT part 3. Create Index 

CREATE INDEX "ix_TMP_20221018185523_Z3M5IT9_ADS_imp_1_OUT_KEY" ON "TMP_20221018185523_Z3M5IT9_ADS_imp_1_OUT" ("KEY")

-- Code For temporary table TMP_20221018185524_MF9HD5E_ADS_sca_2_OUT part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221018185524_MF9HD5E_ADS_sca_2_OUT" (
	"KEY" BIGINT NOT NULL, 
	scaler_2 DOUBLE, 
	scaler_3 DOUBLE, 
	scaler_4 DOUBLE, 
...
FROM "TMP_20221018185523_Z3M5IT9_ADS_imp_1_OUT" AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT") AS "T"

-- Code For temporary table TMP_20221018185524_MF9HD5E_ADS_sca_2_OUT part 3. Create Index 

CREATE INDEX "ix_TMP_20221018185524_MF9HD5E_ADS_sca_2_OUT_KEY" ON "TMP_20221018185524_MF9HD5E_ADS_sca_2_OUT" ("KEY")

-- Code For temporary table TMP_20221018185524_0DON0UY_HL_1_relu_1 part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221018185524_0DON0UY_HL_1_relu_1" (
	"KEY" BIGINT NOT NULL, 
	"NEUR_1_1" DOUBLE, 
	"NEUR_1_2" DOUBLE, 
	"NEUR_1_3" DOUBLE, 
...
-- Code For temporary table TMP_20221018185524_0DON0UY_HL_1_relu_1 part 2. Populate
...
FROM "TMP_20221018185524_MF9HD5E_ADS_sca_2_OUT" AS "ADS_sca_2_OUT"), 
"HL_BA_1" AS 
(SELECT "IL"."KEY" AS "KEY", -5.511668110230967 * "IL".scaler_2 + 1.613788128830015 * "IL".scaler_3 + 1.3055953885792049 * "IL".scaler_4 + -2.307267916634702 * "IL".scaler_5 + 8.570432067245754 * "IL".scaler_6 + -1.5214927748226104 * "IL".scaler_7 + -2.2624741627621177 * "IL".scaler_8 + 6.395906401754512 * "IL".scaler_9 + -0.8825962435430023 * "IL".scaler_10 + 2.307866165960061 * "IL".scaler_11 + 1.500980003938289 * "IL".scaler_12 + -0.5773570022191101 * "IL".scaler_13 + -1.79745869921239 * "IL".scaler_14 + 2.6902198875048793 * "IL".scaler_15 + -7.854020714218791 * "IL".scaler_16 + -6.514785654085022 * "IL".scaler_17 + 7.916561827343824 * "IL".scaler_18 + -3.0785892778629598 * "IL".scaler_19 + -2.0825395289199875 * "IL".scaler_20 + 3.84063194622065 * "IL".scaler_21 + 1.9263307514235282 * "IL".scaler_22 + 1.5792730933482708 * "IL".scaler_23 + 0.2063535331533719 * "IL".scaler_24 + 0.7595410149696519 * "IL".scaler_25 + 0.8037573264878858 * "IL".scaler_26 + 2.2230910056796365 * "IL".scaler_27 + 4.501159535962217 * "IL".scaler_28 + -1.855243868308818 * "IL".scaler_29 + -1.169108045241702 * "IL".scaler_30 + -0.595961316789503 * "IL".scaler_31 + 1.4810176966313817 * "IL".scaler_32 + -0.15355157743500358 * "IL".scaler_33 + 3.7156844704381187 * "IL".scaler_34 + -0.16217502155584898 * "IL".scaler_35 + -3.73468372763518 * "IL".scaler_36 + 2.917498678565008 * "IL".scaler_37 + -2.9771959203757983 * "IL".scaler_38 + 0.32669293261546206 * "IL".scaler_39 + 3.237327524676824 * "IL".scaler_40 + 1.590045879087126 * "IL".scaler_41 + -6.890511058838243 * "IL".scaler_42 + 2.6792146352690946 * "IL".scaler_43 + 0.5518233802567206 * "IL".scaler_44 + -1.037977921584433 * "IL".scaler_45 + 3.80830641783122 * "IL".scaler_46 + -0.8195892898507618 * "IL".scaler_47 + -3.29896389795874 * "IL".scaler_48 + -6.266891342424379 * "IL".scaler_49 + 1.4794157197724571 * "IL".scaler_50 + -2.2511395314297338 * "IL".scaler_51 + -0.17337008789739008 * "IL".scaler_52 + 1.1637734916156448 * "IL".scaler_53 + 2.090540140643526 * "IL".scaler_54 + -2.8903590289158627 * "IL".scaler_55 + 2.4101369647495425 * "IL".scaler_56 + 0.2612174694210055 * "IL".scaler_57 + 1.4121513833235853 * "IL".scaler_58 + 2.0168257786720467 * "IL".scaler_59 + 1.3912281077332844 * "IL".scaler_60 + 0.17890556033830451 * "IL".scaler_61 + 0.6423336699566647 * "IL".scaler_62 + -0.10920465852748186 * "IL".scaler_63 + 3.3444828111594904 * "IL".scaler_64 + 7.073468905780488 * "IL".scaler_65 + 3.1798258805617263 * "IL".scaler_66 + 3.899269617314226 * "IL".scaler_67 + 3.3867028034143503 * "IL".scaler_68 + -1.6779737448244119 * "IL".scaler_69 + -3.217918431077866 * "IL".scaler_70 + -1.6975187677282377 * "IL".scaler_71 + 2.2534776693037384 * "IL".scaler_72 + -2.6607456600594936 * "IL".scaler_73 + -7.3404230959798555 * "IL".scaler_74 + 5.563743501841329 * "IL".scaler_75 + -6.619873824218707 * "IL".scaler_76 + 1.6807989780498784 * "IL".scaler_77 + -2.2514860092950606 * "IL".scaler_78 + -1.0865553779840569 * "IL".scaler_79 + -4.257420584940755 * "IL".scaler_80 + 3.8940852907119643 * "IL".scaler_81 + 8.622576121180293 * "IL".scaler_82 + -0.9207310483524362 * "IL".scaler_83 + -1.3656385089975944 * "IL".scaler_84 + -1.3361228595423684 * "IL".scaler_85 + -3.4385940346542347 * "IL".scaler_86 + 5.7704721414829185 * "IL".scaler_87 + -0.1274779613640421 * "IL".scaler_88 + 3.8244511398056793 * "IL".scaler_89 + 2.110534495913287 * "IL".scaler_90 + 5.262804046147964 * "IL".scaler_91 + 3.9687817828171457 * "IL".scaler_92 + 0.696884142255907 * "IL".scaler_93 + 2.9648394797675808 * "IL".scaler_94 + -4.126395185418224 * "IL".scaler_95 + 1.271727547807694 * "IL".scaler_96 + 2.6309913950547967 * "IL".scaler_97 + -4.371593578494971 * "IL".scaler_98 + -1.5202041157616617 * "IL".scaler_99 + 0.5715778804912642 * "IL".scaler_100 + 1.5796296139705739 * "IL".scaler_101 + -9.565208146639993 AS "NEUR_1_1", 0.9979690150598808 * "IL".scaler_2 + -7.693541055130119 * "IL".scaler_3 + -9.150162348679366 * "IL".scaler_4 + 4.812945107197775 * "IL".scaler_5 + -4.084343851917687 * "IL".scaler_6 + -1.0629139512150882 * "IL".scaler_7 + -4.297043234473699 * "IL".scaler_8 + -7.075998277559137 * "IL".scaler_9 + 5.227023511628171 * "IL".scaler_10 + 5.660135897351104 * "IL".scaler_11 + -0.34389709773212745 * "IL".scaler_12 + 0.1622710139755371 * "IL".scaler_13 + 6.228745911526869 * "IL".scaler_14 + 0.03047149774767308 * "IL".scaler_15 + 5.800721025447424 * "IL".scaler_16 + 5.668804272355144 * "IL".scaler_17 + 6.552531471690202 * "IL".scaler_18 + 7.716635437471525 * "IL".scaler_19 + 8.747752079193722 * "IL".scaler_20 + -8.237865847307088 * "IL".scaler_21 + 4.514555969907919 * "IL".scaler_22 + -2.8586830893858943 * "IL".scaler_23 + -0.614342351991894 * "IL".scaler_24 + 2.246232340050668 * "IL".scaler_25 + 1.553196452740773 * "IL".scaler_26 + -5.6201310063055026 * "IL".scaler_27 + 2.988213937525855 * "IL".scaler_28 + 6.937255764800329 * "IL".scaler_29 + -0.35390303562630404 * "IL".scaler_30 + 5.822973313665488 * "IL".scaler_31 + -6.703835237664289 * "IL".scaler_32 + 3.237323561520829 * "IL".scaler_33 + -5.951077217029798 * "IL".scaler_34 + 5.572019207313793 * "IL".scaler_35 + -9.672855417097088 * "IL".scaler_36 + 0.2599842488437444 * "IL".scaler_37 + -2.642880586984179 * "IL".scaler_38 + -0.6724915732824125 * "IL".scaler_39 + 7.323249551611015 * "IL".scaler_40 + 18.979288639003258 * "IL".scaler_41 + 1.6101307203961306 * "IL".scaler_42 + 16.459323537641747 * "IL".scaler_43 + -2.55340223868314 * "IL".scaler_44 + 6.092045690249271 * "IL".scaler_45 + -1.110474773367456 * "IL".scaler_46 + 8.390223365959828 * "IL".scaler_47 + -6.981253609997207 * "IL".scaler_48 + -4.034468485338154 * "IL".scaler_49 + -0.47190995131909014 * "IL".scaler_50 + 2.0660332253031104 * "IL".scaler_51 + -1.963612884386756 * "IL".scaler_52 + 1.6676670946173993 * "IL".scaler_53 + 1.909456417928518 * "IL".scaler_54 + -1.027576519953671 * "IL".scaler_55 + -3.4645074425919122 * "IL".scaler_56 + 2.10389640693043 * "IL".scaler_57 + -9.371834008135632 * "IL".scaler_58 + -3.2805887990193745 * "IL".scaler_59 + -2.8747284316794293 * "IL".scaler_60 + 2.7388247702943285 * "IL".scaler_61 + 7.260690403340107 * "IL".scaler_62 + -2.4082925046684385 * "IL".scaler_63 + -7.706642416417126 * "IL".scaler_64 + 14.011308761019563 * "IL".scaler_65 + 0.14886290771576288 * "IL".scaler_66 + -0.28517764584145383 * "IL".scaler_67 + -5.939370555082351 * "IL".scaler_68 + -3.5979764857296193 * "IL".scaler_69 + 3.0869260073557854 * "IL".scaler_70 + -4.444327328747325 * "IL".scaler_71 + -6.082581941319558 * "IL".scaler_72 + 6.206656264602196 * "IL".scaler_73 + 7.854015707270417 * "IL".scaler_74 + -10.291361886818285 * "IL".scaler_75 + 6.836695301775843 * "IL".scaler_76 + 0.34511944115974447 * "IL".scaler_77 + -2.607163828496726 * "IL".scaler_78 + -8.575288198682422 * "IL".scaler_79 + 3.645284392508194 * "IL".scaler_80 + 8.425875533819395 * "IL".scaler_81 + 16.40103081460079 * "IL".scaler_82 + 5.973654684610023 * "IL".scaler_83 + 0.1266605957037036 * "IL".scaler_84 + -1.378554280891692 * "IL".scaler_85 + 0.2749745261087468 * "IL".scaler_86 + -0.1346253128818546 * "IL".scaler_87 + 4.447514804161669 * "IL".scaler_88 + -5.257948637732134 * "IL".scaler_89 + -10.443937224371366 * "IL".scaler_90 + 0.6680991060914965 * "IL".scaler_91 + -7.977065238513378 * "IL".scaler_92 + 5.071460241446679 * "IL".scaler_93 + -2.2241060870353575 * "IL".scaler_94 + -1.1829762428646187 * "IL".scaler_95 + -8.34963899450514 * "IL".scaler_96 + 7.026651121333664 * "IL".scaler_97 + 2.4188109452441617 * "IL".scaler_98 + 7.827071107763544 * "IL".scaler_99 + -1.856096723671102 * "IL".scaler_100 + 7.21887681907732 * "IL".scaler_101 + 0.7894229123565111 AS "NEUR_1_2", -3.6550024471451716 * "IL".scaler_2 + -14.691914034827649 * "IL".scaler_3 + -7.519494654823166 * "IL".scaler_4 + 0.7939902576575907 * "IL".scaler_5 + -1.8118851733144745 * "IL".scaler_6 + 4.0634303028950045 * "IL".scaler_7 + 1.4491759685932273 * "IL".scaler_8 + -6.979720580470087 * "IL".scaler_9 + 16.89559188227122 * "IL".scaler_10 + 4.929139987422445 * "IL".scaler_11 + -11.149272626474868 * "IL".scaler_12 + -3.7965739639043057 * "IL".scaler_13 + 8.731004625414114 * "IL".scaler_14 + 3.310853471072699 * "IL".scaler_15 + 0.6389229598652848 * "IL".scaler_16 + 4.487538262281568 * "IL".scaler_17 + 11.314598266116802 * "IL".scaler_18 + 12.509903684488497 * "IL".scaler_19 + 4.341515930938472 * "IL".scaler_20 + -25.888264555238337 * "IL".scaler_21 + 12.16610464701794 * "IL".scaler_22 + -4.132389360530577 * "IL".scaler_23 + 9.32489869087279 * "IL".scaler_24 + -5.116741203822237 * "IL".scaler_25 + 10.60048641796268 * "IL".scaler_26 + 10.323348211419827 * "IL".scaler_27 + 1.3207709769704676 * "IL".scaler_28 + 15.887981466092313 * "IL".scaler_29 + 5.548421191954625 * "IL".scaler_30 + 5.088524339463494 * "IL".scaler_31 + 0.18943251318642865 * "IL".scaler_32 + 13.640232828337401 * "IL".scaler_33 + 4.111815935302523 * "IL".scaler_34 + 7.307002747798041 * "IL".scaler_35 + 0.7340915954132392 * "IL".scaler_36 + 5.319846960335076 * "IL".scaler_37 + -2.4048947311810163 * "IL".scaler_38 + -13.983817961397506 * "IL".scaler_39 + 8.804555865010594 * "IL".scaler_40 + 27.784658224580948 * "IL".scaler_41 + -5.876612104933705 * "IL".scaler_42 + 24.580406766707416 * "IL".scaler_43 + -11.761259438794557 * "IL".scaler_44 + 9.86236926219068 * "IL".scaler_45 + 6.9929373240444574 * "IL".scaler_46 + -2.401508042774116 * "IL".scaler_47 + 1.8504902108526866 * "IL".scaler_48 + 4.031750570926345 * "IL".scaler_49 + 2.743166881845036 * "IL".scaler_50 + 12.918913017573557 * "IL".scaler_51 + -2.082832857215007 * "IL".scaler_52 + 4.21386301284111 * "IL".scaler_53 + -4.262990123499379 * "IL".scaler_54 + -3.7130698974488907 * "IL".scaler_55 + 12.71286442333987 * "IL".scaler_56 + -6.086025632758366 * "IL".scaler_57 + -6.101364986675208 * "IL".scaler_58 + 9.750670280778468 * "IL".scaler_59 + -0.48881720449326144 * "IL".scaler_60 + 6.586079436472926 * "IL".scaler_61 + 7.67634003675364 * "IL".scaler_62 + -5.042730085559475 * "IL".scaler_63 + -12.705235603174081 * "IL".scaler_64 + 23.41740449324939 * "IL".scaler_65 + 1.9137103099729365 * "IL".scaler_66 + 1.1681354867919655 * "IL".scaler_67 + -3.8152308423642185 * "IL".scaler_68 + -11.460336783025207 * "IL".scaler_69 + 15.112120029571722 * "IL".scaler_70 + -3.766253851543006 * "IL".scaler_71 + -3.6291781747150362 * "IL".scaler_72 + 5.878163832804907 * "IL".scaler_73 + -1.1432224942980866 * "IL".scaler_74 + -6.7190741617860965 * "IL".scaler_75 + 3.582465477955963 * "IL".scaler_76 + 3.472453826257221 * "IL".scaler_77 + -1.0520956670226496 * "IL".scaler_78 + -21.188687724092595 * "IL".scaler_79 + 12.03735958861966 * "IL".scaler_80 + 7.274410961368876 * "IL".scaler_81 + 37.230727717898525 * "IL".scaler_82 + 7.685632160596088 * "IL".scaler_83 + 2.193975075313659 * "IL".scaler_84 + 1.982252403140828 * "IL".scaler_85 + -5.673208668839244 * "IL".scaler_86 + -1.2521011228855836 * "IL".scaler_87 + -11.297879820689412 * "IL".scaler_88 + 4.6719016602839085 * "IL".scaler_89 + 5.627653158996947 * "IL".scaler_90 + -0.01644689295242451 * "IL".scaler_91 + 1.5834079291772667 * "IL".scaler_92 + 11.021484802473395 * "IL".scaler_93 + 8.34656138378879 * "IL".scaler_94 + -12.04704981013473 * "IL".scaler_95 + -19.07369932910482 * "IL".scaler_96 + 23.790337103965022 * "IL".scaler_97 + 1.5862876890833 * "IL".scaler_98 + -1.3350880423356575 * "IL".scaler_99 + -1.0337800747261698 * "IL".scaler_100 + -4.457527120705807 * "IL".scaler_101 + 0.13066624253879502 AS "NEUR_1_3" 
FROM "IL"), 
"HL_1_relu" AS 
...
FROM "HL_BA_1")
 INSERT INTO "TMP_20221018185524_0DON0UY_HL_1_relu_1" ("KEY", "NEUR_1_1", "NEUR_1_2", "NEUR_1_3") SELECT "T"."KEY", "T"."NEUR_1_1", "T"."NEUR_1_2", "T"."NEUR_1_3" 
...
-- Code For temporary table TMP_20221018185524_0DON0UY_HL_1_relu_1 part 3. Create Index 

CREATE INDEX "ix_TMP_20221018185524_0DON0UY_HL_1_relu_1_KEY" ON "TMP_20221018185524_0DON0UY_HL_1_relu_1" ("KEY")

-- Code For temporary table TMP_20221018185524_M8G8KSC_OL_identity_1 part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221018185524_M8G8KSC_OL_identity_1" (
	"KEY" BIGINT NOT NULL, 
	"NEUR_3_1" DOUBLE, 
	PRIMARY KEY ("KEY")
)
...
-- Code For temporary table TMP_20221018185524_M8G8KSC_OL_identity_1 part 2. Populate

WITH "HL_BA_2" AS 
(SELECT "HL_1_relu_1"."KEY" AS "KEY", 2.3354289645888695 * "HL_1_relu_1"."NEUR_1_1" + 2.7495770884947417 * "HL_1_relu_1"."NEUR_1_2" + 3.7660471130420805 * "HL_1_relu_1"."NEUR_1_3" + -1.7490784367649825 AS "NEUR_2_1", -0.5757576523511304 * "HL_1_relu_1"."NEUR_1_1" + -2.3694911669948393 * "HL_1_relu_1"."NEUR_1_2" + -1.1859909995776126 * "HL_1_relu_1"."NEUR_1_3" + 15.8116169089496 AS "NEUR_2_2", 6.648428466275113 * "HL_1_relu_1"."NEUR_1_1" + 10.313168750289316 * "HL_1_relu_1"."NEUR_1_2" + 16.553904100040832 * "HL_1_relu_1"."NEUR_1_3" + -4.296388766056402 AS "NEUR_2_3", 1.2179726429464441 * "HL_1_relu_1"."NEUR_1_1" + 0.9692556886440535 * "HL_1_relu_1"."NEUR_1_2" + 1.9745548290482304 * "HL_1_relu_1"."NEUR_1_3" + 3.168124713887304 AS "NEUR_2_4", -0.6093467048429818 * "HL_1_relu_1"."NEUR_1_1" + -0.37766843092589303 * "HL_1_relu_1"."NEUR_1_2" + -0.6730015619714277 * "HL_1_relu_1"."NEUR_1_3" + -0.01807831622698608 AS "NEUR_2_5" 
FROM "TMP_20221018185524_0DON0UY_HL_1_relu_1" AS "HL_1_relu_1"), 
"HL_2_relu" AS 
...
FROM "HL_BA_2"), 
"OL_BA" AS 
(SELECT "HL_2_relu"."KEY" AS "KEY", 1.087038959530581 * "HL_2_relu"."NEUR_2_1" + -13.586270505061155 * "HL_2_relu"."NEUR_2_2" + -0.3115858813083334 * "HL_2_relu"."NEUR_2_3" + 0.8963150907596514 * "HL_2_relu"."NEUR_2_4" + -0.27347508797755343 * "HL_2_relu"."NEUR_2_5" + -22.488250509391108 AS "NEUR_3_1" 
FROM "HL_2_relu"), 
"OL_identity" AS 
(SELECT "OL_BA"."KEY" AS "KEY", "OL_BA"."NEUR_3_1" AS "NEUR_3_1" 
FROM "OL_BA")
 INSERT INTO "TMP_20221018185524_M8G8KSC_OL_identity_1" ("KEY", "NEUR_3_1") SELECT "T"."KEY", "T"."NEUR_3_1" 
...
-- Code For temporary table TMP_20221018185524_M8G8KSC_OL_identity_1 part 3. Create Index 

CREATE INDEX "ix_TMP_20221018185524_M8G8KSC_OL_identity_1_KEY" ON "TMP_20221018185524_M8G8KSC_OL_identity_1" ("KEY")

-- Model deployment code

SELECT "OL_identity_1"."KEY" AS "KEY", "OL_identity_1"."NEUR_3_1" AS "Estimator" 
FROM "TMP_20221018185524_M8G8KSC_OL_identity_1" AS "OL_identity_1"