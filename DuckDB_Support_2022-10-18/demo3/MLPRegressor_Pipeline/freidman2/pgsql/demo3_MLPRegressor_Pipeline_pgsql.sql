...
-- Code For temporary table TMP_20221018190220_ZG00T90_ADS_imp_1_OUT part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221018190220_ZG00T90_ADS_imp_1_OUT" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20221018190220_ZG00T90_ADS_imp_1_OUT part 2. Populate

INSERT INTO "TMP_20221018190220_ZG00T90_ADS_imp_1_OUT" ("KEY", imputer_output_2, imputer_output_3, imputer_output_4, imputer_output_5) SELECT "T"."KEY", "T".imputer_output_2, "T".imputer_output_3, "T".imputer_output_4, "T".imputer_output_5 
...
-- Code For temporary table TMP_20221018190220_ZG00T90_ADS_imp_1_OUT part 3. Create Index 

CREATE INDEX "ix_TMP_20221018190220_ZG00T90_ADS_imp_1_OUT_KEY" ON "TMP_20221018190220_ZG00T90_ADS_imp_1_OUT" ("KEY")

-- Code For temporary table TMP_20221018190220_40XCI9A_ADS_sca_2_OUT part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221018190220_40XCI9A_ADS_sca_2_OUT" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20221018190220_40XCI9A_ADS_sca_2_OUT part 2. Populate

INSERT INTO "TMP_20221018190220_40XCI9A_ADS_sca_2_OUT" ("KEY", scaler_output_2, scaler_output_3, scaler_output_4, scaler_output_5) SELECT "T"."KEY", "T".scaler_output_2, "T".scaler_output_3, "T".scaler_output_4, "T".scaler_output_5 
...
FROM "TMP_20221018190220_ZG00T90_ADS_imp_1_OUT" AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT") AS "T"

-- Code For temporary table TMP_20221018190220_40XCI9A_ADS_sca_2_OUT part 3. Create Index 

CREATE INDEX "ix_TMP_20221018190220_40XCI9A_ADS_sca_2_OUT_KEY" ON "TMP_20221018190220_40XCI9A_ADS_sca_2_OUT" ("KEY")

-- Code For temporary table TMP_20221018190220_B966Z00_HL_1_relu_1 part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221018190220_B966Z00_HL_1_relu_1" (
	"KEY" BIGINT NOT NULL, 
	"NEUR_1_1" FLOAT, 
	"NEUR_1_2" FLOAT, 
	"NEUR_1_3" FLOAT, 
...
-- Code For temporary table TMP_20221018190220_B966Z00_HL_1_relu_1 part 2. Populate
...
FROM "TMP_20221018190220_40XCI9A_ADS_sca_2_OUT" AS "ADS_sca_2_OUT"), 
"HL_BA_1" AS 
...
FROM "HL_BA_1")
 INSERT INTO "TMP_20221018190220_B966Z00_HL_1_relu_1" ("KEY", "NEUR_1_1", "NEUR_1_2", "NEUR_1_3") SELECT "T"."KEY", "T"."NEUR_1_1", "T"."NEUR_1_2", "T"."NEUR_1_3" 
...
-- Code For temporary table TMP_20221018190220_B966Z00_HL_1_relu_1 part 3. Create Index 

CREATE INDEX "ix_TMP_20221018190220_B966Z00_HL_1_relu_1_KEY" ON "TMP_20221018190220_B966Z00_HL_1_relu_1" ("KEY")

-- Code For temporary table TMP_20221018190220_OWMYMF9_OL_identity_1 part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221018190220_OWMYMF9_OL_identity_1" (
	"KEY" BIGINT NOT NULL, 
	"NEUR_3_1" FLOAT, 
	PRIMARY KEY ("KEY")
)
...
-- Code For temporary table TMP_20221018190220_OWMYMF9_OL_identity_1 part 2. Populate
...
FROM "TMP_20221018190220_B966Z00_HL_1_relu_1" AS "HL_1_relu_1"), 
"HL_2_relu" AS 
...
FROM "OL_BA")
 INSERT INTO "TMP_20221018190220_OWMYMF9_OL_identity_1" ("KEY", "NEUR_3_1") SELECT "T"."KEY", "T"."NEUR_3_1" 
...
-- Code For temporary table TMP_20221018190220_OWMYMF9_OL_identity_1 part 3. Create Index 

CREATE INDEX "ix_TMP_20221018190220_OWMYMF9_OL_identity_1_KEY" ON "TMP_20221018190220_OWMYMF9_OL_identity_1" ("KEY")

-- Model deployment code

SELECT "OL_identity_1"."KEY" AS "KEY", "OL_identity_1"."NEUR_3_1" AS "Estimator" 
FROM "TMP_20221018190220_OWMYMF9_OL_identity_1" AS "OL_identity_1"