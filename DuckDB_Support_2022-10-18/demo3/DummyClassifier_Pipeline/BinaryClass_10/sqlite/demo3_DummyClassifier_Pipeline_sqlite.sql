...
-- Code For temporary table TMP_20221018184821_CVRIQXM_ADS_imp_1_OUT part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221018184821_CVRIQXM_ADS_imp_1_OUT" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20221018184821_CVRIQXM_ADS_imp_1_OUT part 3. Create Index 

CREATE INDEX "ix_TMP_20221018184821_CVRIQXM_ADS_imp_1_OUT_KEY" ON "TMP_20221018184821_CVRIQXM_ADS_imp_1_OUT" ("KEY")

-- Code For temporary table TMP_20221018184821_U3LIWXN_ADS_sca_2_OUT part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221018184821_U3LIWXN_ADS_sca_2_OUT" (
	"KEY" BIGINT NOT NULL, 
...
FROM "TMP_20221018184821_CVRIQXM_ADS_imp_1_OUT" AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT") AS "T"

-- Code For temporary table TMP_20221018184821_U3LIWXN_ADS_sca_2_OUT part 3. Create Index 

CREATE INDEX "ix_TMP_20221018184821_U3LIWXN_ADS_sca_2_OUT_KEY" ON "TMP_20221018184821_U3LIWXN_ADS_sca_2_OUT" ("KEY")

-- Model deployment code

WITH dummy_class_reg_cte AS 
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", 0.5 AS "Proba_0", CASE WHEN (0.5 IS NULL OR 0.5 > 0.0) THEN ln(0.5) ELSE -1.79769313486231e+308 END AS "LogProba_0", 0.5 AS "Proba_1", CASE WHEN (0.5 IS NULL OR 0.5 > 0.0) THEN ln(0.5) ELSE -1.79769313486231e+308 END AS "LogProba_1", 0 AS "Decision", CASE WHEN (0 = 0) THEN 0.5 WHEN (0 = 1) THEN 0.5 END AS "DecisionProba" 
FROM "TMP_20221018184821_U3LIWXN_ADS_sca_2_OUT" AS "ADS_sca_2_OUT")
