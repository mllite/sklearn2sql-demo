...
-- Code For temporary table TMP_20221018185303_0Y5PBPT_ADS_imp_1_OUT part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221018185303_0Y5PBPT_ADS_imp_1_OUT" (
	"KEY" BIGINT NOT NULL, 
	impter_2 DOUBLE, 
	impter_3 DOUBLE, 
	impter_4 DOUBLE, 
...
-- Code For temporary table TMP_20221018185303_0Y5PBPT_ADS_imp_1_OUT part 3. Create Index 

CREATE INDEX "ix_TMP_20221018185303_0Y5PBPT_ADS_imp_1_OUT_KEY" ON "TMP_20221018185303_0Y5PBPT_ADS_imp_1_OUT" ("KEY")

-- Code For temporary table TMP_20221018185303_8UPC86D_ADS_sca_2_OUT part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221018185303_8UPC86D_ADS_sca_2_OUT" (
	"KEY" BIGINT NOT NULL, 
	scaler_2 DOUBLE, 
	scaler_3 DOUBLE, 
	scaler_4 DOUBLE, 
...
FROM "TMP_20221018185303_0Y5PBPT_ADS_imp_1_OUT" AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT") AS "T"

-- Code For temporary table TMP_20221018185303_8UPC86D_ADS_sca_2_OUT part 3. Create Index 

CREATE INDEX "ix_TMP_20221018185303_8UPC86D_ADS_sca_2_OUT_KEY" ON "TMP_20221018185303_8UPC86D_ADS_sca_2_OUT" ("KEY")

-- Model deployment code

WITH dummy_class_reg_cte AS 
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", 0.25 AS "Proba_0", CASE WHEN (0.25 IS NULL OR 0.25 > 0.0) THEN ln(0.25) ELSE '-Infinity'::float8 END AS "LogProba_0", 0.2604166666666667 AS "Proba_1", CASE WHEN (0.2604166666666667 IS NULL OR 0.2604166666666667 > 0.0) THEN ln(0.2604166666666667) ELSE '-Infinity'::float8 END AS "LogProba_1", 0.23958333333333334 AS "Proba_2", CASE WHEN (0.23958333333333334 IS NULL OR 0.23958333333333334 > 0.0) THEN ln(0.23958333333333334) ELSE '-Infinity'::float8 END AS "LogProba_2", 0.25 AS "Proba_3", CASE WHEN (0.25 IS NULL OR 0.25 > 0.0) THEN ln(0.25) ELSE '-Infinity'::float8 END AS "LogProba_3", 1 AS "Decision", CASE WHEN (1 = 0) THEN 0.25 WHEN (1 = 1) THEN 0.2604166666666667 WHEN (1 = 2) THEN 0.23958333333333334 WHEN (1 = 3) THEN 0.25 END AS "DecisionProba" 
FROM "TMP_20221018185303_8UPC86D_ADS_sca_2_OUT" AS "ADS_sca_2_OUT")
