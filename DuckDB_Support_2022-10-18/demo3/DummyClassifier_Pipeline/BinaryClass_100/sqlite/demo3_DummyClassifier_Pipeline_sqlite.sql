...
-- Code For temporary table TMP_20221018184932_VU3KB6I_ADS_imp_1_OUT part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221018184932_VU3KB6I_ADS_imp_1_OUT" (
	"KEY" BIGINT NOT NULL, 
	impter_2 FLOAT, 
	impter_3 FLOAT, 
	impter_4 FLOAT, 
...
-- Code For temporary table TMP_20221018184932_VU3KB6I_ADS_imp_1_OUT part 3. Create Index 

CREATE INDEX "ix_TMP_20221018184932_VU3KB6I_ADS_imp_1_OUT_KEY" ON "TMP_20221018184932_VU3KB6I_ADS_imp_1_OUT" ("KEY")

-- Code For temporary table TMP_20221018184932_QINIPOY_ADS_sca_2_OUT part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221018184932_QINIPOY_ADS_sca_2_OUT" (
	"KEY" BIGINT NOT NULL, 
	scaler_2 FLOAT, 
	scaler_3 FLOAT, 
	scaler_4 FLOAT, 
...
FROM "TMP_20221018184932_VU3KB6I_ADS_imp_1_OUT" AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT") AS "T"

-- Code For temporary table TMP_20221018184932_QINIPOY_ADS_sca_2_OUT part 3. Create Index 

CREATE INDEX "ix_TMP_20221018184932_QINIPOY_ADS_sca_2_OUT_KEY" ON "TMP_20221018184932_QINIPOY_ADS_sca_2_OUT" ("KEY")

-- Model deployment code

WITH dummy_class_reg_cte AS 
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", 0.525 AS "Proba_0", CASE WHEN (0.525 IS NULL OR 0.525 > 0.0) THEN ln(0.525) ELSE -1.79769313486231e+308 END AS "LogProba_0", 0.475 AS "Proba_1", CASE WHEN (0.475 IS NULL OR 0.475 > 0.0) THEN ln(0.475) ELSE -1.79769313486231e+308 END AS "LogProba_1", 0 AS "Decision", CASE WHEN (0 = 0) THEN 0.525 WHEN (0 = 1) THEN 0.475 END AS "DecisionProba" 
FROM "TMP_20221018184932_QINIPOY_ADS_sca_2_OUT" AS "ADS_sca_2_OUT")
