...
-- Code For temporary table TMP_20221018190434_YSIJYOP_ADS_imp_1_OUT part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221018190434_YSIJYOP_ADS_imp_1_OUT" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20221018190434_YSIJYOP_ADS_imp_1_OUT part 2. Populate

INSERT INTO "TMP_20221018190434_YSIJYOP_ADS_imp_1_OUT" ("KEY", imputer_output_2, imputer_output_3, imputer_output_4, imputer_output_5) SELECT "T"."KEY", "T".imputer_output_2, "T".imputer_output_3, "T".imputer_output_4, "T".imputer_output_5 
...
-- Code For temporary table TMP_20221018190434_YSIJYOP_ADS_imp_1_OUT part 3. Create Index 

CREATE INDEX "ix_TMP_20221018190434_YSIJYOP_ADS_imp_1_OUT_KEY" ON "TMP_20221018190434_YSIJYOP_ADS_imp_1_OUT" ("KEY")

-- Code For temporary table TMP_20221018190434_9PK88VX_ADS_sca_2_OUT part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221018190434_9PK88VX_ADS_sca_2_OUT" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20221018190434_9PK88VX_ADS_sca_2_OUT part 2. Populate

INSERT INTO "TMP_20221018190434_9PK88VX_ADS_sca_2_OUT" ("KEY", scaler_output_2, scaler_output_3, scaler_output_4, scaler_output_5) SELECT "T"."KEY", "T".scaler_output_2, "T".scaler_output_3, "T".scaler_output_4, "T".scaler_output_5 
...
FROM "TMP_20221018190434_YSIJYOP_ADS_imp_1_OUT" AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT") AS "T"

-- Code For temporary table TMP_20221018190434_9PK88VX_ADS_sca_2_OUT part 3. Create Index 

CREATE INDEX "ix_TMP_20221018190434_9PK88VX_ADS_sca_2_OUT_KEY" ON "TMP_20221018190434_9PK88VX_ADS_sca_2_OUT" ("KEY")
...
FROM "TMP_20221018190434_9PK88VX_ADS_sca_2_OUT" AS "ADS_sca_2_OUT"), 
linear_model_cte AS 
(SELECT linear_input."KEY" AS "KEY", 0.04819588512760317 * linear_input.scaler_output_2 + 0.23476180040415703 * linear_input.scaler_output_3 + -0.6664677705626859 * linear_input.scaler_output_4 + -0.13048751164436237 * linear_input.scaler_output_5 + -0.3833333333333344 AS "Score_0", 0.09423926375886808 * linear_input.scaler_output_2 + -0.41994553988204963 * linear_input.scaler_output_3 + 0.46950739425387517 * linear_input.scaler_output_4 + -0.5928777621045391 * linear_input.scaler_output_5 + -0.33333333333333254 AS "Score_1", -0.14243514888646713 * linear_input.scaler_output_2 + 0.18518373947789052 * linear_input.scaler_output_3 + 0.1969603763087918 * linear_input.scaler_output_4 + 0.723365273748916 * linear_input.scaler_output_5 + -0.2833333333333331 AS "Score_2" 
FROM linear_input), 
