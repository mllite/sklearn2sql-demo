...
-- Code For temporary table TMP_20221018184843_VKGN720_ADS_imp_1_OUT part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221018184843_VKGN720_ADS_imp_1_OUT" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20221018184843_VKGN720_ADS_imp_1_OUT part 3. Create Index 

CREATE INDEX "ix_TMP_20221018184843_VKGN720_ADS_imp_1_OUT_KEY" ON "TMP_20221018184843_VKGN720_ADS_imp_1_OUT" ("KEY")

-- Code For temporary table TMP_20221018184843_3VQLUZM_ADS_sca_2_OUT part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221018184843_3VQLUZM_ADS_sca_2_OUT" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20221018184843_3VQLUZM_ADS_sca_2_OUT part 2. Populate

INSERT INTO "TMP_20221018184843_3VQLUZM_ADS_sca_2_OUT" ("KEY", scaler_output_2, scaler_output_3, scaler_output_4, scaler_output_5, scaler_output_6, scaler_output_7, scaler_output_8, scaler_output_9, scaler_output_10, scaler_output_11) SELECT "T"."KEY", "T".scaler_output_2, "T".scaler_output_3, "T".scaler_output_4, "T".scaler_output_5, "T".scaler_output_6, "T".scaler_output_7, "T".scaler_output_8, "T".scaler_output_9, "T".scaler_output_10, "T".scaler_output_11 
...
FROM "TMP_20221018184843_VKGN720_ADS_imp_1_OUT" AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT") AS "T"

-- Code For temporary table TMP_20221018184843_3VQLUZM_ADS_sca_2_OUT part 3. Create Index 

CREATE INDEX "ix_TMP_20221018184843_3VQLUZM_ADS_sca_2_OUT_KEY" ON "TMP_20221018184843_3VQLUZM_ADS_sca_2_OUT" ("KEY")
...
FROM "TMP_20221018184843_3VQLUZM_ADS_sca_2_OUT" AS "ADS_sca_2_OUT"), 
linear_model_cte AS 
