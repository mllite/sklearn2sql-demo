...
-- Code For temporary table TMP_20221018184843_834VXOD_ADS_imp_1_OUT part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221018184843_834VXOD_ADS_imp_1_OUT" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20221018184843_834VXOD_ADS_imp_1_OUT part 3. Create Index 

CREATE INDEX "ix_TMP_20221018184843_834VXOD_ADS_imp_1_OUT_KEY" ON "TMP_20221018184843_834VXOD_ADS_imp_1_OUT" ("KEY")

-- Code For temporary table TMP_20221018184843_RNQW0IB_ADS_sca_2_OUT part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221018184843_RNQW0IB_ADS_sca_2_OUT" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20221018184843_RNQW0IB_ADS_sca_2_OUT part 2. Populate

INSERT INTO "TMP_20221018184843_RNQW0IB_ADS_sca_2_OUT" ("KEY", scaler_output_2, scaler_output_3, scaler_output_4, scaler_output_5, scaler_output_6, scaler_output_7, scaler_output_8, scaler_output_9, scaler_output_10, scaler_output_11) SELECT "T"."KEY", "T".scaler_output_2, "T".scaler_output_3, "T".scaler_output_4, "T".scaler_output_5, "T".scaler_output_6, "T".scaler_output_7, "T".scaler_output_8, "T".scaler_output_9, "T".scaler_output_10, "T".scaler_output_11 
...
FROM "TMP_20221018184843_834VXOD_ADS_imp_1_OUT" AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT") AS "T"

-- Code For temporary table TMP_20221018184843_RNQW0IB_ADS_sca_2_OUT part 3. Create Index 

CREATE INDEX "ix_TMP_20221018184843_RNQW0IB_ADS_sca_2_OUT_KEY" ON "TMP_20221018184843_RNQW0IB_ADS_sca_2_OUT" ("KEY")
...
FROM "TMP_20221018184843_RNQW0IB_ADS_sca_2_OUT" AS "ADS_sca_2_OUT"), 
linear_model_cte AS 
(SELECT linear_input."KEY" AS "KEY", -0.20739361763761863 * linear_input.scaler_output_2 + -0.05177981324430974 * linear_input.scaler_output_3 + -0.10422936739424425 * linear_input.scaler_output_4 + 0.12186516510382535 * linear_input.scaler_output_5 + -0.05976477414335791 * linear_input.scaler_output_6 + -0.10676849141960934 * linear_input.scaler_output_7 + -0.09803988450702736 * linear_input.scaler_output_8 + -0.2289505755515955 * linear_input.scaler_output_9 + 0.01641044539145725 * linear_input.scaler_output_10 + 0.2420484235781985 * linear_input.scaler_output_11 + 1.1712211971290363e-17 AS lincomb 
FROM linear_input), 
