...
-- Code For temporary table TMP_20221018190309_YU434JQ_LGBM_B0 part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221018190309_YU434JQ_LGBM_B0" (
	"KEY" BIGINT, 
	"Estimator" DOUBLE
)
...
-- Code For temporary table TMP_20221018190309_YU434JQ_LGBM_B0 part 2. Populate
...
FROM "DT_Output_9")
 INSERT INTO "TMP_20221018190309_YU434JQ_LGBM_B0" ("KEY", "Estimator") SELECT "T"."KEY", "T"."Estimator" 
...
-- Code For temporary table TMP_20221018190309_0N1CHWQ_LGBM_B1 part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221018190309_0N1CHWQ_LGBM_B1" (
	"KEY" BIGINT, 
	"Estimator" DOUBLE
)
...
-- Code For temporary table TMP_20221018190309_0N1CHWQ_LGBM_B1 part 2. Populate
...
FROM "DT_Output_15")
 INSERT INTO "TMP_20221018190309_0N1CHWQ_LGBM_B1" ("KEY", "Estimator") SELECT "T"."KEY", "T"."Estimator" 
...
-- Code For temporary table TMP_20221018190309_KVXESY5_LGBM_sum part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221018190309_KVXESY5_LGBM_sum" (
	"KEY" BIGINT NOT NULL, 
	"Estimator" DOUBLE, 
	PRIMARY KEY ("KEY")
)
...
-- Code For temporary table TMP_20221018190309_KVXESY5_LGBM_sum part 2. Populate

WITH "LGBM_Union" AS 
(SELECT "LGBM_EnsembleUnion"."KEY" AS "KEY", "LGBM_EnsembleUnion"."Estimator" AS "Estimator" 
FROM (SELECT "LGBM_B0"."KEY" AS "KEY", "LGBM_B0"."Estimator" AS "Estimator" 
FROM "TMP_20221018190309_YU434JQ_LGBM_B0" AS "LGBM_B0" UNION ALL SELECT "LGBM_B1"."KEY" AS "KEY", "LGBM_B1"."Estimator" AS "Estimator" 
FROM "TMP_20221018190309_0N1CHWQ_LGBM_B1" AS "LGBM_B1") AS "LGBM_EnsembleUnion")
 INSERT INTO "TMP_20221018190309_KVXESY5_LGBM_sum" ("KEY", "Estimator") SELECT "T"."KEY", "T"."Estimator" 
...
-- Code For temporary table TMP_20221018190309_KVXESY5_LGBM_sum part 3. Create Index 

CREATE INDEX "ix_TMP_20221018190309_KVXESY5_LGBM_sum_KEY" ON "TMP_20221018190309_KVXESY5_LGBM_sum" ("KEY")

-- Model deployment code

SELECT "LGBM_sum"."KEY" AS "KEY", "LGBM_sum"."Estimator" AS "Estimator" 
FROM "TMP_20221018190309_KVXESY5_LGBM_sum" AS "LGBM_sum"