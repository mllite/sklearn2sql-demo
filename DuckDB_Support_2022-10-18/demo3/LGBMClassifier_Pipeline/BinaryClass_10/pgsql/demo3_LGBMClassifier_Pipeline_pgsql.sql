...
-- Code For temporary table TMP_20221018184829_J09100R_ADS_imp_1_OUT part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221018184829_J09100R_ADS_imp_1_OUT" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20221018184829_J09100R_ADS_imp_1_OUT part 3. Create Index 

CREATE INDEX "ix_TMP_20221018184829_J09100R_ADS_imp_1_OUT_KEY" ON "TMP_20221018184829_J09100R_ADS_imp_1_OUT" ("KEY")

-- Code For temporary table TMP_20221018184829_7SAEM5G_ADS_sca_2_OUT part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221018184829_7SAEM5G_ADS_sca_2_OUT" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20221018184829_7SAEM5G_ADS_sca_2_OUT part 2. Populate

INSERT INTO "TMP_20221018184829_7SAEM5G_ADS_sca_2_OUT" ("KEY", scaler_output_2, scaler_output_3, scaler_output_4, scaler_output_5, scaler_output_6, scaler_output_7, scaler_output_8, scaler_output_9, scaler_output_10, scaler_output_11) SELECT "T"."KEY", "T".scaler_output_2, "T".scaler_output_3, "T".scaler_output_4, "T".scaler_output_5, "T".scaler_output_6, "T".scaler_output_7, "T".scaler_output_8, "T".scaler_output_9, "T".scaler_output_10, "T".scaler_output_11 
...
FROM "TMP_20221018184829_J09100R_ADS_imp_1_OUT" AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT") AS "T"

-- Code For temporary table TMP_20221018184829_7SAEM5G_ADS_sca_2_OUT part 3. Create Index 

CREATE INDEX "ix_TMP_20221018184829_7SAEM5G_ADS_sca_2_OUT_KEY" ON "TMP_20221018184829_7SAEM5G_ADS_sca_2_OUT" ("KEY")

-- Code For temporary table TMP_20221018184829_B1DFY0F_LGBM_B0 part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221018184829_B1DFY0F_LGBM_B0" (
	"KEY" BIGINT, 
	"Score_0" FLOAT
)
...
-- Code For temporary table TMP_20221018184829_B1DFY0F_LGBM_B0 part 2. Populate
...
FROM "TMP_20221018184829_7SAEM5G_ADS_sca_2_OUT" AS "ADS_sca_2_OUT"), 
"DT_node_data" AS 
...
FROM "DT_Output_9")
 INSERT INTO "TMP_20221018184829_B1DFY0F_LGBM_B0" ("KEY", "Score_0") SELECT "T"."KEY", "T"."Score_0" 
...
-- Code For temporary table TMP_20221018184829_1VLJBWW_LGBM_B1 part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221018184829_1VLJBWW_LGBM_B1" (
	"KEY" BIGINT, 
	"Score_0" FLOAT
)
...
-- Code For temporary table TMP_20221018184829_1VLJBWW_LGBM_B1 part 2. Populate
...
FROM "DT_Output_15")
 INSERT INTO "TMP_20221018184829_1VLJBWW_LGBM_B1" ("KEY", "Score_0") SELECT "T"."KEY", "T"."Score_0" 
...
-- Code For temporary table TMP_20221018184829_FKLH3Q0_LGBM_sum part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221018184829_FKLH3Q0_LGBM_sum" (
	"KEY" BIGINT NOT NULL, 
	"Score_0" FLOAT, 
	PRIMARY KEY ("KEY")
)
...
-- Code For temporary table TMP_20221018184829_FKLH3Q0_LGBM_sum part 2. Populate

WITH "LGBM_Union" AS 
(SELECT "LGBM_EnsembleUnion"."KEY" AS "KEY", "LGBM_EnsembleUnion"."Score_0" AS "Score_0" 
FROM (SELECT "LGBM_B0"."KEY" AS "KEY", "LGBM_B0"."Score_0" AS "Score_0" 
FROM "TMP_20221018184829_B1DFY0F_LGBM_B0" AS "LGBM_B0" UNION ALL SELECT "LGBM_B1"."KEY" AS "KEY", "LGBM_B1"."Score_0" AS "Score_0" 
FROM "TMP_20221018184829_1VLJBWW_LGBM_B1" AS "LGBM_B1") AS "LGBM_EnsembleUnion")
 INSERT INTO "TMP_20221018184829_FKLH3Q0_LGBM_sum" ("KEY", "Score_0") SELECT "T"."KEY", "T"."Score_0" 
...
-- Code For temporary table TMP_20221018184829_FKLH3Q0_LGBM_sum part 3. Create Index 

CREATE INDEX "ix_TMP_20221018184829_FKLH3Q0_LGBM_sum_KEY" ON "TMP_20221018184829_FKLH3Q0_LGBM_sum" ("KEY")
...
FROM "TMP_20221018184829_FKLH3Q0_LGBM_sum" AS "LGBM_sum"), 
