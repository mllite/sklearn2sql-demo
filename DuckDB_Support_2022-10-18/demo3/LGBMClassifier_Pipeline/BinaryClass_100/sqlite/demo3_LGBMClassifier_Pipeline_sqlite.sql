...
-- Code For temporary table TMP_20221018184939_EKGDBJE_ADS_imp_1_OUT part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221018184939_EKGDBJE_ADS_imp_1_OUT" (
	"KEY" BIGINT NOT NULL, 
	impter_2 FLOAT, 
	impter_3 FLOAT, 
	impter_4 FLOAT, 
...
-- Code For temporary table TMP_20221018184939_EKGDBJE_ADS_imp_1_OUT part 3. Create Index 

CREATE INDEX "ix_TMP_20221018184939_EKGDBJE_ADS_imp_1_OUT_KEY" ON "TMP_20221018184939_EKGDBJE_ADS_imp_1_OUT" ("KEY")

-- Code For temporary table TMP_20221018184939_73O23VE_ADS_sca_2_OUT part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221018184939_73O23VE_ADS_sca_2_OUT" (
	"KEY" BIGINT NOT NULL, 
	scaler_2 FLOAT, 
	scaler_3 FLOAT, 
	scaler_4 FLOAT, 
...
FROM "TMP_20221018184939_EKGDBJE_ADS_imp_1_OUT" AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT") AS "T"

-- Code For temporary table TMP_20221018184939_73O23VE_ADS_sca_2_OUT part 3. Create Index 

CREATE INDEX "ix_TMP_20221018184939_73O23VE_ADS_sca_2_OUT_KEY" ON "TMP_20221018184939_73O23VE_ADS_sca_2_OUT" ("KEY")

-- Code For temporary table TMP_20221018184939_WNI88BH_LGBM_B0 part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221018184939_WNI88BH_LGBM_B0" (
	"KEY" BIGINT, 
	"Score_0" FLOAT
)
...
-- Code For temporary table TMP_20221018184939_WNI88BH_LGBM_B0 part 2. Populate
...
FROM "TMP_20221018184939_73O23VE_ADS_sca_2_OUT" AS "ADS_sca_2_OUT"), 
"DT_node_data" AS 
(SELECT "Values".nid AS nid, "Values"."Score" AS "Score" 
FROM (SELECT 3 AS nid, -0.013047691755818533 AS "Score" UNION ALL SELECT 4 AS nid, -0.13116115343533927 AS "Score" UNION ALL SELECT 5 AS nid, -0.19532155237236287 AS "Score") AS "Values"), 
"DT_Output" AS 
...
"DT_node_data_1" AS 
(SELECT "Values".nid AS nid, "Values"."Score" AS "Score" 
FROM (SELECT 3 AS nid, 0.082474064563096 AS "Score" UNION ALL SELECT 4 AS nid, -0.09249472143965755 AS "Score" UNION ALL SELECT 5 AS nid, -0.02823482677819837 AS "Score") AS "Values"), 
"DT_Output_1" AS 
...
"DT_node_data_2" AS 
(SELECT "Values".nid AS nid, "Values"."Score" AS "Score" 
FROM (SELECT 3 AS nid, 0.07844270233923618 AS "Score" UNION ALL SELECT 4 AS nid, -0.026650782449375493 AS "Score" UNION ALL SELECT 5 AS nid, -0.08897000566114764 AS "Score") AS "Values"), 
"DT_Output_2" AS 
...
"DT_node_data_3" AS 
(SELECT "Values".nid AS nid, "Values"."Score" AS "Score" 
FROM (SELECT 3 AS nid, 0.07122008633287133 AS "Score" UNION ALL SELECT 4 AS nid, -0.0232916580558485 AS "Score" UNION ALL SELECT 5 AS nid, -0.08778197794314108 AS "Score") AS "Values"), 
"DT_Output_3" AS 
...
"DT_node_data_4" AS 
(SELECT "Values".nid AS nid, "Values"."Score" AS "Score" 
FROM (SELECT 3 AS nid, 0.07176162916964193 AS "Score" UNION ALL SELECT 4 AS nid, -0.08483918447947784 AS "Score" UNION ALL SELECT 5 AS nid, -0.022018912002807617 AS "Score") AS "Values"), 
"DT_Output_4" AS 
...
"DT_node_data_5" AS 
(SELECT "Values".nid AS nid, "Values"."Score" AS "Score" 
FROM (SELECT 3 AS nid, 0.06542451410215123 AS "Score" UNION ALL SELECT 4 AS nid, -0.01987674515762906 AS "Score" UNION ALL SELECT 5 AS nid, -0.08291828336493512 AS "Score") AS "Values"), 
"DT_Output_5" AS 
...
"DT_node_data_6" AS 
(SELECT "Values".nid AS nid, "Values"."Score" AS "Score" 
FROM (SELECT 3 AS nid, 0.08501399000780518 AS "Score" UNION ALL SELECT 4 AS nid, -0.00962820289928311 AS "Score" UNION ALL SELECT 5 AS nid, -0.08049180948299457 AS "Score") AS "Values"), 
"DT_Output_6" AS 
...
"DT_node_data_7" AS 
(SELECT "Values".nid AS nid, "Values"."Score" AS "Score" 
FROM (SELECT 3 AS nid, 0.06405741470978514 AS "Score" UNION ALL SELECT 4 AS nid, -0.07939490213337907 AS "Score" UNION ALL SELECT 5 AS nid, -0.01701778509048952 AS "Score") AS "Values"), 
"DT_Output_7" AS 
...
"DT_node_data_8" AS 
(SELECT "Values".nid AS nid, "Values"."Score" AS "Score" 
FROM (SELECT 3 AS nid, 0.08016481558706212 AS "Score" UNION ALL SELECT 4 AS nid, -0.0703470775886521 AS "Score" UNION ALL SELECT 5 AS nid, -0.002442860032314522 AS "Score") AS "Values"), 
"DT_Output_8" AS 
...
"DT_node_data_9" AS 
(SELECT "Values".nid AS nid, "Values"."Score" AS "Score" 
FROM (SELECT 3 AS nid, 0.057300588851588743 AS "Score" UNION ALL SELECT 4 AS nid, -0.01337968197221267 AS "Score" UNION ALL SELECT 5 AS nid, -0.07706520837974623 AS "Score") AS "Values"), 
"DT_Output_9" AS 
...
FROM "DT_Output_9")
 INSERT INTO "TMP_20221018184939_WNI88BH_LGBM_B0" ("KEY", "Score_0") SELECT "T"."KEY", "T"."Score_0" 
...
-- Code For temporary table TMP_20221018184939_PCOSVW5_LGBM_B1 part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221018184939_PCOSVW5_LGBM_B1" (
	"KEY" BIGINT, 
	"Score_0" FLOAT
)
...
-- Code For temporary table TMP_20221018184939_PCOSVW5_LGBM_B1 part 2. Populate
...
"DT_node_data_10" AS 
(SELECT "Values".nid AS nid, "Values"."Score" AS "Score" 
FROM (SELECT 3 AS nid, 0.07629058352982347 AS "Score" UNION ALL SELECT 4 AS nid, -0.06779884393836377 AS "Score" UNION ALL SELECT 5 AS nid, -0.0010065705385197666 AS "Score") AS "Values"), 
"DT_Output_10" AS 
...
"DT_node_data_11" AS 
(SELECT "Values".nid AS nid, "Values"."Score" AS "Score" 
FROM (SELECT 3 AS nid, 0.054133149558247544 AS "Score" UNION ALL SELECT 4 AS nid, -0.011379738142925151 AS "Score" UNION ALL SELECT 5 AS nid, -0.07444653605436229 AS "Score") AS "Values"), 
"DT_Output_11" AS 
...
"DT_node_data_12" AS 
(SELECT "Values".nid AS nid, "Values"."Score" AS "Score" 
FROM (SELECT 3 AS nid, 0.07307585913145562 AS "Score" UNION ALL SELECT 4 AS nid, -0.004310776517785183 AS "Score" UNION ALL SELECT 5 AS nid, -0.07338042428377743 AS "Score") AS "Values"), 
"DT_Output_12" AS 
...
"DT_node_data_13" AS 
(SELECT "Values".nid AS nid, "Values"."Score" AS "Score" 
FROM (SELECT 3 AS nid, 0.0714497136168247 AS "Score" UNION ALL SELECT 4 AS nid, -0.06488555047061031 AS "Score" UNION ALL SELECT 5 AS nid, 0.0017642930535847574 AS "Score") AS "Values"), 
"DT_Output_13" AS 
...
"DT_node_data_14" AS 
(SELECT "Values".nid AS nid, "Values"."Score" AS "Score" 
FROM (SELECT 3 AS nid, 0.05003883147792977 AS "Score" UNION ALL SELECT 4 AS nid, -0.007876267985220403 AS "Score" UNION ALL SELECT 5 AS nid, -0.0715440456703284 AS "Score") AS "Values"), 
"DT_Output_14" AS 
...
"DT_node_data_15" AS 
(SELECT "Values".nid AS nid, "Values"."Score" AS "Score" 
FROM (SELECT 3 AS nid, 0.06899589393509613 AS "Score" UNION ALL SELECT 4 AS nid, -0.0022865741375693994 AS "Score" UNION ALL SELECT 5 AS nid, -0.07054853747792451 AS "Score") AS "Values"), 
"DT_Output_15" AS 
...
FROM "DT_Output_15")
 INSERT INTO "TMP_20221018184939_PCOSVW5_LGBM_B1" ("KEY", "Score_0") SELECT "T"."KEY", "T"."Score_0" 
...
-- Code For temporary table TMP_20221018184939_K9MSOE9_LGBM_sum part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221018184939_K9MSOE9_LGBM_sum" (
	"KEY" BIGINT NOT NULL, 
	"Score_0" FLOAT, 
	PRIMARY KEY ("KEY")
)
...
-- Code For temporary table TMP_20221018184939_K9MSOE9_LGBM_sum part 2. Populate

WITH "LGBM_Union" AS 
(SELECT "LGBM_EnsembleUnion"."KEY" AS "KEY", "LGBM_EnsembleUnion"."Score_0" AS "Score_0" 
FROM (SELECT "LGBM_B0"."KEY" AS "KEY", "LGBM_B0"."Score_0" AS "Score_0" 
FROM "TMP_20221018184939_WNI88BH_LGBM_B0" AS "LGBM_B0" UNION ALL SELECT "LGBM_B1"."KEY" AS "KEY", "LGBM_B1"."Score_0" AS "Score_0" 
FROM "TMP_20221018184939_PCOSVW5_LGBM_B1" AS "LGBM_B1") AS "LGBM_EnsembleUnion")
 INSERT INTO "TMP_20221018184939_K9MSOE9_LGBM_sum" ("KEY", "Score_0") SELECT "T"."KEY", "T"."Score_0" 
...
-- Code For temporary table TMP_20221018184939_K9MSOE9_LGBM_sum part 3. Create Index 

CREATE INDEX "ix_TMP_20221018184939_K9MSOE9_LGBM_sum_KEY" ON "TMP_20221018184939_K9MSOE9_LGBM_sum" ("KEY")
...
FROM "TMP_20221018184939_K9MSOE9_LGBM_sum" AS "LGBM_sum"), 
