...
-- Code For temporary table TMP_20221018190420_M78E3H8_ADS_imp_1_OUT part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221018190420_M78E3H8_ADS_imp_1_OUT" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20221018190420_M78E3H8_ADS_imp_1_OUT part 2. Populate

INSERT INTO "TMP_20221018190420_M78E3H8_ADS_imp_1_OUT" ("KEY", imputer_output_2, imputer_output_3, imputer_output_4, imputer_output_5) SELECT "T"."KEY", "T".imputer_output_2, "T".imputer_output_3, "T".imputer_output_4, "T".imputer_output_5 
...
-- Code For temporary table TMP_20221018190420_M78E3H8_ADS_imp_1_OUT part 3. Create Index 

CREATE INDEX "ix_TMP_20221018190420_M78E3H8_ADS_imp_1_OUT_KEY" ON "TMP_20221018190420_M78E3H8_ADS_imp_1_OUT" ("KEY")

-- Code For temporary table TMP_20221018190420_4XKE4KV_ADS_sca_2_OUT part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221018190420_4XKE4KV_ADS_sca_2_OUT" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20221018190420_4XKE4KV_ADS_sca_2_OUT part 2. Populate

INSERT INTO "TMP_20221018190420_4XKE4KV_ADS_sca_2_OUT" ("KEY", scaler_output_2, scaler_output_3, scaler_output_4, scaler_output_5) SELECT "T"."KEY", "T".scaler_output_2, "T".scaler_output_3, "T".scaler_output_4, "T".scaler_output_5 
...
FROM "TMP_20221018190420_M78E3H8_ADS_imp_1_OUT" AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT") AS "T"

-- Code For temporary table TMP_20221018190420_4XKE4KV_ADS_sca_2_OUT part 3. Create Index 

CREATE INDEX "ix_TMP_20221018190420_4XKE4KV_ADS_sca_2_OUT_KEY" ON "TMP_20221018190420_4XKE4KV_ADS_sca_2_OUT" ("KEY")

-- Code For temporary table TMP_20221018190420_T8PYLGX_LGBM_B0 part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221018190420_T8PYLGX_LGBM_B0" (
	"KEY" BIGINT, 
	"Score_0" DOUBLE, 
	"Score_1" DOUBLE, 
	"Score_2" DOUBLE
...
-- Code For temporary table TMP_20221018190420_T8PYLGX_LGBM_B0 part 2. Populate
...
FROM "TMP_20221018190420_4XKE4KV_ADS_sca_2_OUT" AS "ADS_sca_2_OUT"), 
"DT_node_data" AS 
...
FROM "DT_Output_9")
 INSERT INTO "TMP_20221018190420_T8PYLGX_LGBM_B0" ("KEY", "Score_0", "Score_1", "Score_2") SELECT "T"."KEY", "T"."Score_0", "T"."Score_1", "T"."Score_2" 
...
-- Code For temporary table TMP_20221018190420_2F87Y9M_LGBM_B1 part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221018190420_2F87Y9M_LGBM_B1" (
	"KEY" BIGINT, 
	"Score_0" DOUBLE, 
	"Score_1" DOUBLE, 
	"Score_2" DOUBLE
...
-- Code For temporary table TMP_20221018190420_2F87Y9M_LGBM_B1 part 2. Populate
...
FROM "DT_Output_19")
 INSERT INTO "TMP_20221018190420_2F87Y9M_LGBM_B1" ("KEY", "Score_0", "Score_1", "Score_2") SELECT "T"."KEY", "T"."Score_0", "T"."Score_1", "T"."Score_2" 
FROM (SELECT "LGBM_B1"."KEY" AS "KEY", "LGBM_B1"."Score_0" AS "Score_0", "LGBM_B1"."Score_1" AS "Score_1", "LGBM_B1"."Score_2" AS "Score_2" 
...
-- Code For temporary table TMP_20221018190420_2242UZV_LGBM_B2 part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221018190420_2242UZV_LGBM_B2" (
	"KEY" BIGINT, 
	"Score_0" DOUBLE, 
	"Score_1" DOUBLE, 
	"Score_2" DOUBLE
...
-- Code For temporary table TMP_20221018190420_2242UZV_LGBM_B2 part 2. Populate
...
FROM "DT_Output_29")
 INSERT INTO "TMP_20221018190420_2242UZV_LGBM_B2" ("KEY", "Score_0", "Score_1", "Score_2") SELECT "T"."KEY", "T"."Score_0", "T"."Score_1", "T"."Score_2" 
FROM (SELECT "LGBM_B2"."KEY" AS "KEY", "LGBM_B2"."Score_0" AS "Score_0", "LGBM_B2"."Score_1" AS "Score_1", "LGBM_B2"."Score_2" AS "Score_2" 
...
-- Code For temporary table TMP_20221018190420_IFW28PB_LGBM_B3 part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221018190420_IFW28PB_LGBM_B3" (
	"KEY" BIGINT, 
	"Score_0" DOUBLE, 
	"Score_1" DOUBLE, 
	"Score_2" DOUBLE
...
-- Code For temporary table TMP_20221018190420_IFW28PB_LGBM_B3 part 2. Populate
...
FROM "DT_Output_39")
 INSERT INTO "TMP_20221018190420_IFW28PB_LGBM_B3" ("KEY", "Score_0", "Score_1", "Score_2") SELECT "T"."KEY", "T"."Score_0", "T"."Score_1", "T"."Score_2" 
FROM (SELECT "LGBM_B3"."KEY" AS "KEY", "LGBM_B3"."Score_0" AS "Score_0", "LGBM_B3"."Score_1" AS "Score_1", "LGBM_B3"."Score_2" AS "Score_2" 
...
-- Code For temporary table TMP_20221018190420_ZT7COK0_LGBM_B4 part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221018190420_ZT7COK0_LGBM_B4" (
	"KEY" BIGINT, 
	"Score_0" DOUBLE, 
	"Score_1" DOUBLE, 
	"Score_2" DOUBLE
...
-- Code For temporary table TMP_20221018190420_ZT7COK0_LGBM_B4 part 2. Populate
...
FROM "DT_Output_47")
 INSERT INTO "TMP_20221018190420_ZT7COK0_LGBM_B4" ("KEY", "Score_0", "Score_1", "Score_2") SELECT "T"."KEY", "T"."Score_0", "T"."Score_1", "T"."Score_2" 
FROM (SELECT "LGBM_B4"."KEY" AS "KEY", "LGBM_B4"."Score_0" AS "Score_0", "LGBM_B4"."Score_1" AS "Score_1", "LGBM_B4"."Score_2" AS "Score_2" 
...
-- Code For temporary table TMP_20221018190420_OTADZ8D_LGBM_sum part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221018190420_OTADZ8D_LGBM_sum" (
	"KEY" BIGINT NOT NULL, 
	"Score_0" DOUBLE, 
	"Score_1" DOUBLE, 
	"Score_2" DOUBLE, 
...
-- Code For temporary table TMP_20221018190420_OTADZ8D_LGBM_sum part 2. Populate
...
FROM (SELECT "LGBM_B0"."KEY" AS "KEY", "LGBM_B0"."Score_0" AS "Score_0", "LGBM_B0"."Score_1" AS "Score_1", "LGBM_B0"."Score_2" AS "Score_2" 
FROM "TMP_20221018190420_T8PYLGX_LGBM_B0" AS "LGBM_B0" UNION ALL SELECT "LGBM_B1"."KEY" AS "KEY", "LGBM_B1"."Score_0" AS "Score_0", "LGBM_B1"."Score_1" AS "Score_1", "LGBM_B1"."Score_2" AS "Score_2" 
FROM "TMP_20221018190420_2F87Y9M_LGBM_B1" AS "LGBM_B1" UNION ALL SELECT "LGBM_B2"."KEY" AS "KEY", "LGBM_B2"."Score_0" AS "Score_0", "LGBM_B2"."Score_1" AS "Score_1", "LGBM_B2"."Score_2" AS "Score_2" 
FROM "TMP_20221018190420_2242UZV_LGBM_B2" AS "LGBM_B2" UNION ALL SELECT "LGBM_B3"."KEY" AS "KEY", "LGBM_B3"."Score_0" AS "Score_0", "LGBM_B3"."Score_1" AS "Score_1", "LGBM_B3"."Score_2" AS "Score_2" 
FROM "TMP_20221018190420_IFW28PB_LGBM_B3" AS "LGBM_B3" UNION ALL SELECT "LGBM_B4"."KEY" AS "KEY", "LGBM_B4"."Score_0" AS "Score_0", "LGBM_B4"."Score_1" AS "Score_1", "LGBM_B4"."Score_2" AS "Score_2" 
FROM "TMP_20221018190420_ZT7COK0_LGBM_B4" AS "LGBM_B4") AS "LGBM_EnsembleUnion")
 INSERT INTO "TMP_20221018190420_OTADZ8D_LGBM_sum" ("KEY", "Score_0", "Score_1", "Score_2") SELECT "T"."KEY", "T"."Score_0", "T"."Score_1", "T"."Score_2" 
FROM (SELECT "LGBM_sum"."KEY" AS "KEY", "LGBM_sum"."Score_0" AS "Score_0", "LGBM_sum"."Score_1" AS "Score_1", "LGBM_sum"."Score_2" AS "Score_2" 
...
-- Code For temporary table TMP_20221018190420_OTADZ8D_LGBM_sum part 3. Create Index 

CREATE INDEX "ix_TMP_20221018190420_OTADZ8D_LGBM_sum_KEY" ON "TMP_20221018190420_OTADZ8D_LGBM_sum" ("KEY")
...
FROM "TMP_20221018190420_OTADZ8D_LGBM_sum" AS "LGBM_sum"), 
