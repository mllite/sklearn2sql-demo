...
-- Code For temporary table TMP_20221018185315_ZZR21Q1_ADS_imp_1_OUT part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221018185315_ZZR21Q1_ADS_imp_1_OUT" (
	"KEY" BIGINT NOT NULL, 
	impter_2 FLOAT, 
	impter_3 FLOAT, 
	impter_4 FLOAT, 
...
-- Code For temporary table TMP_20221018185315_ZZR21Q1_ADS_imp_1_OUT part 3. Create Index 

CREATE INDEX "ix_TMP_20221018185315_ZZR21Q1_ADS_imp_1_OUT_KEY" ON "TMP_20221018185315_ZZR21Q1_ADS_imp_1_OUT" ("KEY")

-- Code For temporary table TMP_20221018185315_4NB915H_ADS_sca_2_OUT part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221018185315_4NB915H_ADS_sca_2_OUT" (
	"KEY" BIGINT NOT NULL, 
	scaler_2 FLOAT, 
	scaler_3 FLOAT, 
	scaler_4 FLOAT, 
...
FROM "TMP_20221018185315_ZZR21Q1_ADS_imp_1_OUT" AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT") AS "T"

-- Code For temporary table TMP_20221018185315_4NB915H_ADS_sca_2_OUT part 3. Create Index 

CREATE INDEX "ix_TMP_20221018185315_4NB915H_ADS_sca_2_OUT_KEY" ON "TMP_20221018185315_4NB915H_ADS_sca_2_OUT" ("KEY")

-- Code For temporary table TMP_20221018185316_K6OH080_LGBM_B0 part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221018185316_K6OH080_LGBM_B0" (
	"KEY" BIGINT, 
	"Score_0" FLOAT, 
	"Score_1" FLOAT, 
	"Score_2" FLOAT, 
...
-- Code For temporary table TMP_20221018185316_K6OH080_LGBM_B0 part 2. Populate

WITH "DT_node_lookup" AS 
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", CASE WHEN ("ADS_sca_2_OUT".scaler_80 <= -0.20659892002321142) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_2 <= 0.18396981255684525) THEN 4 ELSE 5 END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_50 <= 1.0000000180025095e-35) THEN 6 ELSE 7 END END AS node_id_2 
FROM "TMP_20221018185315_4NB915H_ADS_sca_2_OUT" AS "ADS_sca_2_OUT"), 
"DT_node_data" AS 
...
"DT_node_data_1" AS 
(SELECT "Values".nid AS nid, "Values"."Score" AS "Score" 
FROM (SELECT 3 AS nid, -1.2890892668418374 AS "Score" UNION ALL SELECT 4 AS nid, -1.3907681414214201 AS "Score" UNION ALL SELECT 10 AS nid, -1.3669709580091773 AS "Score" UNION ALL SELECT 11 AS nid, -1.298824478237755 AS "Score") AS "Values"), 
"DT_Output_1" AS 
...
FROM "DT_Output_1"), 
"DT_node_lookup_2" AS 
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", CASE WHEN ("ADS_sca_2_OUT".scaler_46 <= -0.7837116766399931) THEN 2 ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_58 <= -1.0000000180025095e-35) THEN 6 ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_3 <= -0.18593312867475664) THEN 14 ELSE 15 END END END AS node_id_2 
FROM "TMP_20221018185315_4NB915H_ADS_sca_2_OUT" AS "ADS_sca_2_OUT"), 
"DT_node_data_2" AS 
(SELECT "Values".nid AS nid, "Values"."Score" AS "Score" 
...
"DT_node_data_3" AS 
(SELECT "Values".nid AS nid, "Values"."Score" AS "Score" 
FROM (SELECT 3 AS nid, -1.3448657896913192 AS "Score" UNION ALL SELECT 4 AS nid, -1.4362943611198906 AS "Score" UNION ALL SELECT 5 AS nid, -1.3770351018606313 AS "Score") AS "Values"), 
"DT_Output_3" AS 
...
"DT_node_data_4" AS 
(SELECT "Values".nid AS nid, "Values"."Score" AS "Score" 
FROM (SELECT 4 AS nid, -0.049482961392018444 AS "Score" UNION ALL SELECT 5 AS nid, -0.028773892545367094 AS "Score" UNION ALL SELECT 6 AS nid, 0.07031523086628615 AS "Score" UNION ALL SELECT 7 AS nid, -0.014458180844022736 AS "Score") AS "Values"), 
"DT_Output_4" AS 
...
"DT_node_data_5" AS 
(SELECT "Values".nid AS nid, "Values"."Score" AS "Score" 
FROM (SELECT 3 AS nid, 0.05223573692131041 AS "Score" UNION ALL SELECT 4 AS nid, -0.04456408324223247 AS "Score" UNION ALL SELECT 10 AS nid, -0.02065945444645249 AS "Score" UNION ALL SELECT 11 AS nid, 0.04395119648448423 AS "Score") AS "Values"), 
"DT_Output_5" AS 
...
"DT_node_data_6" AS 
(SELECT "Values".nid AS nid, "Values"."Score" AS "Score" 
FROM (SELECT 2 AS nid, 0.07126207445677923 AS "Score" UNION ALL SELECT 6 AS nid, 0.007848941980949367 AS "Score" UNION ALL SELECT 14 AS nid, -0.03829727219089837 AS "Score" UNION ALL SELECT 15 AS nid, -0.049172095735007734 AS "Score") AS "Values"), 
"DT_Output_6" AS 
...
"DT_node_data_7" AS 
(SELECT "Values".nid AS nid, "Values"."Score" AS "Score" 
FROM (SELECT 3 AS nid, 0.03964435665363617 AS "Score" UNION ALL SELECT 5 AS nid, 0.017037182944926493 AS "Score" UNION ALL SELECT 8 AS nid, -0.039333959352602796 AS "Score" UNION ALL SELECT 9 AS nid, -0.04991744527482584 AS "Score") AS "Values"), 
"DT_Output_7" AS 
...
"DT_node_data_8" AS 
(SELECT "Values".nid AS nid, "Values"."Score" AS "Score" 
FROM (SELECT 4 AS nid, -0.027778155175276792 AS "Score" UNION ALL SELECT 5 AS nid, -0.04899496538077605 AS "Score" UNION ALL SELECT 6 AS nid, 0.06514283041144157 AS "Score" UNION ALL SELECT 7 AS nid, -0.013911051355740856 AS "Score") AS "Values"), 
"DT_Output_8" AS 
...
"DT_node_data_9" AS 
(SELECT "Values".nid AS nid, "Values"."Score" AS "Score" 
FROM (SELECT 2 AS nid, -0.033951585165700925 AS "Score" UNION ALL SELECT 6 AS nid, -0.024972922303888978 AS "Score" UNION ALL SELECT 7 AS nid, 0.04726784033032211 AS "Score") AS "Values"), 
"DT_Output_9" AS 
...
FROM "DT_Output_9")
 INSERT INTO "TMP_20221018185316_K6OH080_LGBM_B0" ("KEY", "Score_0", "Score_1", "Score_2", "Score_3") SELECT "T"."KEY", "T"."Score_0", "T"."Score_1", "T"."Score_2", "T"."Score_3" 
...
-- Code For temporary table TMP_20221018185316_81K0EQY_LGBM_B1 part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221018185316_81K0EQY_LGBM_B1" (
	"KEY" BIGINT, 
	"Score_0" FLOAT, 
	"Score_1" FLOAT, 
	"Score_2" FLOAT, 
...
-- Code For temporary table TMP_20221018185316_81K0EQY_LGBM_B1 part 2. Populate
...
"DT_node_data_10" AS 
(SELECT "Values".nid AS nid, "Values"."Score" AS "Score" 
FROM (SELECT 4 AS nid, 0.09237201930246794 AS "Score" UNION ALL SELECT 5 AS nid, -0.01858923462203531 AS "Score" UNION ALL SELECT 6 AS nid, -0.04879422611379119 AS "Score" UNION ALL SELECT 7 AS nid, -0.009258806846968549 AS "Score") AS "Values"), 
"DT_Output_10" AS 
...
"DT_node_data_11" AS 
(SELECT "Values".nid AS nid, "Values"."Score" AS "Score" 
FROM (SELECT 3 AS nid, 0.03785573518010829 AS "Score" UNION ALL SELECT 4 AS nid, -0.04887888197972364 AS "Score" UNION ALL SELECT 5 AS nid, 0.007879268114062058 AS "Score") AS "Values"), 
"DT_Output_11" AS 
...
"DT_node_data_12" AS 
(SELECT "Values".nid AS nid, "Values"."Score" AS "Score" 
FROM (SELECT 4 AS nid, -0.048439986690607215 AS "Score" UNION ALL SELECT 5 AS nid, -0.026864788497925753 AS "Score" UNION ALL SELECT 6 AS nid, 0.07511125568040065 AS "Score" UNION ALL SELECT 7 AS nid, -0.0005621070496381429 AS "Score") AS "Values"), 
"DT_Output_12" AS 
...
"DT_node_data_13" AS 
(SELECT "Values".nid AS nid, "Values"."Score" AS "Score" 
FROM (SELECT 2 AS nid, -0.03057765733393916 AS "Score" UNION ALL SELECT 6 AS nid, -0.02682308682160567 AS "Score" UNION ALL SELECT 7 AS nid, 0.058699444536403494 AS "Score") AS "Values"), 
"DT_Output_13" AS 
...
"DT_node_data_14" AS 
(SELECT "Values".nid AS nid, "Values"."Score" AS "Score" 
FROM (SELECT 2 AS nid, 0.053108022949578775 AS "Score" UNION ALL SELECT 6 AS nid, 0.010163779083471608 AS "Score" UNION ALL SELECT 14 AS nid, -0.04847424675424805 AS "Score" UNION ALL SELECT 15 AS nid, -0.03722137967175292 AS "Score") AS "Values"), 
"DT_Output_14" AS 
...
"DT_node_data_15" AS 
(SELECT "Values".nid AS nid, "Values"."Score" AS "Score" 
FROM (SELECT 4 AS nid, -0.02338986433458315 AS "Score" UNION ALL SELECT 5 AS nid, 0.07368702786119624 AS "Score" UNION ALL SELECT 6 AS nid, -0.04987452385666867 AS "Score" UNION ALL SELECT 7 AS nid, 0.0012028529001180156 AS "Score") AS "Values"), 
"DT_Output_15" AS 
...
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", CASE WHEN ("ADS_sca_2_OUT".scaler_80 <= -0.20659892002321142) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_30 <= 0.4060519987109669) THEN 4 ELSE 5 END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_35 <= -0.19856138664745998) THEN 6 ELSE 7 END END AS node_id_2 
FROM "TMP_20221018185315_4NB915H_ADS_sca_2_OUT" AS "ADS_sca_2_OUT"), 
"DT_node_data_16" AS 
(SELECT "Values".nid AS nid, "Values"."Score" AS "Score" 
FROM (SELECT 4 AS nid, -0.04803046167592389 AS "Score" UNION ALL SELECT 5 AS nid, -0.025971624594206225 AS "Score" UNION ALL SELECT 6 AS nid, 0.06858707518493863 AS "Score" UNION ALL SELECT 7 AS nid, -0.004456423227632697 AS "Score") AS "Values"), 
"DT_Output_16" AS 
...
"DT_node_data_17" AS 
(SELECT "Values".nid AS nid, "Values"."Score" AS "Score" 
FROM (SELECT 2 AS nid, -0.03295652520124833 AS "Score" UNION ALL SELECT 6 AS nid, -0.016594564572282273 AS "Score" UNION ALL SELECT 7 AS nid, 0.049025688695967656 AS "Score") AS "Values"), 
"DT_Output_17" AS 
...
"DT_node_data_18" AS 
(SELECT "Values".nid AS nid, "Values"."Score" AS "Score" 
FROM (SELECT 4 AS nid, 0.08136231994890741 AS "Score" UNION ALL SELECT 5 AS nid, -0.017906701196827173 AS "Score" UNION ALL SELECT 6 AS nid, -0.047988726080961566 AS "Score" UNION ALL SELECT 7 AS nid, -0.008766519610724227 AS "Score") AS "Values"), 
"DT_Output_18" AS 
...
"DT_node_data_19" AS 
(SELECT "Values".nid AS nid, "Values"."Score" AS "Score" 
FROM (SELECT 3 AS nid, 0.0349832797855209 AS "Score" UNION ALL SELECT 4 AS nid, -0.0481288204897223 AS "Score" UNION ALL SELECT 5 AS nid, 0.007510231124961015 AS "Score") AS "Values"), 
"DT_Output_19" AS 
...
FROM "DT_Output_19")
 INSERT INTO "TMP_20221018185316_81K0EQY_LGBM_B1" ("KEY", "Score_0", "Score_1", "Score_2", "Score_3") SELECT "T"."KEY", "T"."Score_0", "T"."Score_1", "T"."Score_2", "T"."Score_3" 
...
-- Code For temporary table TMP_20221018185316_QED2R1R_LGBM_B2 part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221018185316_QED2R1R_LGBM_B2" (
	"KEY" BIGINT, 
	"Score_0" FLOAT, 
	"Score_1" FLOAT, 
	"Score_2" FLOAT, 
...
-- Code For temporary table TMP_20221018185316_QED2R1R_LGBM_B2 part 2. Populate
...
"DT_node_data_20" AS 
(SELECT "Values".nid AS nid, "Values"."Score" AS "Score" 
FROM (SELECT 4 AS nid, -0.04757542232199647 AS "Score" UNION ALL SELECT 5 AS nid, -0.02496872398181631 AS "Score" UNION ALL SELECT 6 AS nid, 0.05577415592049695 AS "Score" UNION ALL SELECT 7 AS nid, -0.014649306942177696 AS "Score") AS "Values"), 
"DT_Output_20" AS 
...
"DT_node_data_21" AS 
(SELECT "Values".nid AS nid, "Values"."Score" AS "Score" 
FROM (SELECT 3 AS nid, 0.04455830597296665 AS "Score" UNION ALL SELECT 4 AS nid, -0.043245743965344224 AS "Score" UNION ALL SELECT 10 AS nid, -0.020055233070032572 AS "Score" UNION ALL SELECT 11 AS nid, 0.04248134535360559 AS "Score") AS "Values"), 
"DT_Output_21" AS 
...
"DT_node_data_22" AS 
(SELECT "Values".nid AS nid, "Values"."Score" AS "Score" 
FROM (SELECT 4 AS nid, 0.074787755394837 AS "Score" UNION ALL SELECT 5 AS nid, -0.017219827525076618 AS "Score" UNION ALL SELECT 6 AS nid, -0.04755730850914176 AS "Score" UNION ALL SELECT 7 AS nid, -0.008086273221564983 AS "Score") AS "Values"), 
"DT_Output_22" AS 
...
"DT_node_data_23" AS 
(SELECT "Values".nid AS nid, "Values"."Score" AS "Score" 
FROM (SELECT 4 AS nid, -0.01759579632186101 AS "Score" UNION ALL SELECT 5 AS nid, 0.07221894391433642 AS "Score" UNION ALL SELECT 6 AS nid, -0.04923328241061269 AS "Score" UNION ALL SELECT 7 AS nid, 0.0014191655070995533 AS "Score") AS "Values"), 
"DT_Output_23" AS 
...
"DT_node_data_24" AS 
(SELECT "Values".nid AS nid, "Values"."Score" AS "Score" 
FROM (SELECT 4 AS nid, -0.023936283385256996 AS "Score" UNION ALL SELECT 5 AS nid, -0.04714031519223245 AS "Score" UNION ALL SELECT 6 AS nid, 0.06129959199539301 AS "Score" UNION ALL SELECT 7 AS nid, -0.005283912011605845 AS "Score") AS "Values"), 
"DT_Output_24" AS 
...
"DT_node_data_25" AS 
(SELECT "Values".nid AS nid, "Values"."Score" AS "Score" 
FROM (SELECT 2 AS nid, -0.029359957605593942 AS "Score" UNION ALL SELECT 6 AS nid, -0.02590639303749815 AS "Score" UNION ALL SELECT 7 AS nid, 0.05329910314912285 AS "Score") AS "Values"), 
"DT_Output_25" AS 
...
"DT_node_data_26" AS 
(SELECT "Values".nid AS nid, "Values"."Score" AS "Score" 
FROM (SELECT 4 AS nid, 0.06909839401507296 AS "Score" UNION ALL SELECT 5 AS nid, -0.016777477491846025 AS "Score" UNION ALL SELECT 6 AS nid, -0.04703767998368402 AS "Score" UNION ALL SELECT 7 AS nid, -0.0075765341807081795 AS "Score") AS "Values"), 
"DT_Output_26" AS 
...
"DT_node_data_27" AS 
(SELECT "Values".nid AS nid, "Values"."Score" AS "Score" 
FROM (SELECT 3 AS nid, 0.032484492210383485 AS "Score" UNION ALL SELECT 4 AS nid, -0.04734194458328779 AS "Score" UNION ALL SELECT 5 AS nid, 0.006635285881145422 AS "Score") AS "Values"), 
"DT_Output_27" AS 
...
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", CASE WHEN ("ADS_sca_2_OUT".scaler_80 <= -0.20659892002321142) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_6 <= 0.14608860188308426) THEN 4 ELSE 5 END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_66 <= -0.16160014838154277) THEN 6 ELSE 7 END END AS node_id_2 
FROM "TMP_20221018185315_4NB915H_ADS_sca_2_OUT" AS "ADS_sca_2_OUT"), 
"DT_node_data_28" AS 
(SELECT "Values".nid AS nid, "Values"."Score" AS "Score" 
FROM (SELECT 4 AS nid, -0.046758492297257814 AS "Score" UNION ALL SELECT 5 AS nid, -0.02307419913300338 AS "Score" UNION ALL SELECT 6 AS nid, 0.0589492804195388 AS "Score" UNION ALL SELECT 7 AS nid, -0.0059355916168356455 AS "Score") AS "Values"), 
"DT_Output_28" AS 
...
"DT_node_data_29" AS 
(SELECT "Values".nid AS nid, "Values"."Score" AS "Score" 
FROM (SELECT 2 AS nid, -0.031968617893787375 AS "Score" UNION ALL SELECT 6 AS nid, -0.023078261758970514 AS "Score" UNION ALL SELECT 7 AS nid, 0.040479786183203595 AS "Score") AS "Values"), 
"DT_Output_29" AS 
...
FROM "DT_Output_29")
 INSERT INTO "TMP_20221018185316_QED2R1R_LGBM_B2" ("KEY", "Score_0", "Score_1", "Score_2", "Score_3") SELECT "T"."KEY", "T"."Score_0", "T"."Score_1", "T"."Score_2", "T"."Score_3" 
...
-- Code For temporary table TMP_20221018185316_H9AC093_LGBM_B3 part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221018185316_H9AC093_LGBM_B3" (
	"KEY" BIGINT, 
	"Score_0" FLOAT, 
	"Score_1" FLOAT, 
	"Score_2" FLOAT, 
...
-- Code For temporary table TMP_20221018185316_H9AC093_LGBM_B3 part 2. Populate

WITH "DT_node_lookup_30" AS 
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", CASE WHEN ("ADS_sca_2_OUT".scaler_46 <= -0.8526903015263004) THEN 2 ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_21 <= -0.25420272015856016) THEN 6 ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_33 <= 1.0000000180025095e-35) THEN 14 ELSE 15 END END END AS node_id_2 
FROM "TMP_20221018185315_4NB915H_ADS_sca_2_OUT" AS "ADS_sca_2_OUT"), 
"DT_node_data_30" AS 
(SELECT "Values".nid AS nid, "Values"."Score" AS "Score" 
FROM (SELECT 2 AS nid, 0.06512574534939752 AS "Score" UNION ALL SELECT 6 AS nid, 0.007405185311014067 AS "Score" UNION ALL SELECT 14 AS nid, -0.04846120213730816 AS "Score" UNION ALL SELECT 15 AS nid, -0.03471217397842912 AS "Score") AS "Values"), 
"DT_Output_30" AS 
...
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", CASE WHEN ("ADS_sca_2_OUT".scaler_101 <= 1.0000000180025095e-35) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_21 <= -0.3420785268148518) THEN 4 ELSE 5 END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_2 <= 0.4251614900939584) THEN 6 ELSE 7 END END AS node_id_2 
FROM "TMP_20221018185315_4NB915H_ADS_sca_2_OUT" AS "ADS_sca_2_OUT"), 
"DT_node_data_31" AS 
(SELECT "Values".nid AS nid, "Values"."Score" AS "Score" 
FROM (SELECT 4 AS nid, -0.022768954553207467 AS "Score" UNION ALL SELECT 5 AS nid, 0.06263947146281233 AS "Score" UNION ALL SELECT 6 AS nid, -0.04855334931662266 AS "Score" UNION ALL SELECT 7 AS nid, 0.0043228279743799825 AS "Score") AS "Values"), 
"DT_Output_31" AS 
...
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", CASE WHEN ("ADS_sca_2_OUT".scaler_80 <= -0.20659892002321142) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_8 <= 0.15851073706032173) THEN 4 ELSE 5 END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_50 <= 1.0000000180025095e-35) THEN 6 ELSE 7 END END AS node_id_2 
FROM "TMP_20221018185315_4NB915H_ADS_sca_2_OUT" AS "ADS_sca_2_OUT"), 
"DT_node_data_32" AS 
(SELECT "Values".nid AS nid, "Values"."Score" AS "Score" 
FROM (SELECT 4 AS nid, -0.04636230594328568 AS "Score" UNION ALL SELECT 5 AS nid, -0.022214789107820796 AS "Score" UNION ALL SELECT 6 AS nid, 0.05717982811188334 AS "Score" UNION ALL SELECT 7 AS nid, -0.005884837063213874 AS "Score") AS "Values"), 
"DT_Output_32" AS 
...
"DT_node_data_33" AS 
(SELECT "Values".nid AS nid, "Values"."Score" AS "Score" 
FROM (SELECT 2 AS nid, -0.028704117822100802 AS "Score" UNION ALL SELECT 6 AS nid, -0.024583050434739365 AS "Score" UNION ALL SELECT 7 AS nid, 0.049418503700611335 AS "Score") AS "Values"), 
"DT_Output_33" AS 
...
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", CASE WHEN ("ADS_sca_2_OUT".scaler_46 <= -0.8526903015263004) THEN 2 ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_21 <= -0.25420272015856016) THEN 6 ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_60 <= -0.3936299434341043) THEN 14 ELSE 15 END END END AS node_id_2 
FROM "TMP_20221018185315_4NB915H_ADS_sca_2_OUT" AS "ADS_sca_2_OUT"), 
"DT_node_data_34" AS 
(SELECT "Values".nid AS nid, "Values"."Score" AS "Score" 
FROM (SELECT 2 AS nid, 0.06050555059886693 AS "Score" UNION ALL SELECT 6 AS nid, 0.006919681039197653 AS "Score" UNION ALL SELECT 14 AS nid, -0.03383139215230182 AS "Score" UNION ALL SELECT 15 AS nid, -0.04792930092639517 AS "Score") AS "Values"), 
"DT_Output_34" AS 
...
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", CASE WHEN ("ADS_sca_2_OUT".scaler_46 <= 0.3111670739918176) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_56 <= 0.47801802165567875) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_96 <= -1.0000000180025095e-35) THEN 8 ELSE 9 END ELSE 5 END ELSE 3 END AS node_id_2 
FROM "TMP_20221018185315_4NB915H_ADS_sca_2_OUT" AS "ADS_sca_2_OUT"), 
"DT_node_data_35" AS 
(SELECT "Values".nid AS nid, "Values"."Score" AS "Score" 
FROM (SELECT 3 AS nid, 0.03039438531772605 AS "Score" UNION ALL SELECT 5 AS nid, 0.02213220648220865 AS "Score" UNION ALL SELECT 8 AS nid, -0.04863490951534155 AS "Score" UNION ALL SELECT 9 AS nid, -0.03617697739980499 AS "Score") AS "Values"), 
"DT_Output_35" AS 
...
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", CASE WHEN ("ADS_sca_2_OUT".scaler_80 <= -0.20659892002321142) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_67 <= -0.3127803044668181) THEN 4 ELSE 5 END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_78 <= 0.055758777690439555) THEN 6 ELSE 7 END END AS node_id_2 
FROM "TMP_20221018185315_4NB915H_ADS_sca_2_OUT" AS "ADS_sca_2_OUT"), 
"DT_node_data_36" AS 
(SELECT "Values".nid AS nid, "Values"."Score" AS "Score" 
FROM (SELECT 4 AS nid, -0.02145158272310621 AS "Score" UNION ALL SELECT 5 AS nid, -0.04602653407491038 AS "Score" UNION ALL SELECT 6 AS nid, 0.04882438844030073 AS "Score" UNION ALL SELECT 7 AS nid, -0.0126512380844361 AS "Score") AS "Values"), 
"DT_Output_36" AS 
...
"DT_node_data_37" AS 
(SELECT "Values".nid AS nid, "Values"."Score" AS "Score" 
FROM (SELECT 2 AS nid, -0.0405705320589018 AS "Score" UNION ALL SELECT 6 AS nid, -0.02762033653287041 AS "Score" UNION ALL SELECT 14 AS nid, 0.07749576896794011 AS "Score" UNION ALL SELECT 15 AS nid, -0.006795114705930629 AS "Score") AS "Values"), 
"DT_Output_37" AS 
...
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", CASE WHEN ("ADS_sca_2_OUT".scaler_46 <= -0.8526903015263004) THEN 2 ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_80 <= -0.20659892002321142) THEN 6 ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_46 <= 0.17601081361933138) THEN 14 ELSE 15 END END END AS node_id_2 
FROM "TMP_20221018185315_4NB915H_ADS_sca_2_OUT" AS "ADS_sca_2_OUT"), 
"DT_node_data_38" AS 
(SELECT "Values".nid AS nid, "Values"."Score" AS "Score" 
FROM (SELECT 2 AS nid, 0.05662593381908676 AS "Score" UNION ALL SELECT 6 AS nid, 0.007221993144000756 AS "Score" UNION ALL SELECT 14 AS nid, -0.04693086225119769 AS "Score" UNION ALL SELECT 15 AS nid, -0.03321294606723816 AS "Score") AS "Values"), 
"DT_Output_38" AS 
...
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", CASE WHEN ("ADS_sca_2_OUT".scaler_46 <= 0.9159548898680373) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_31 <= 0.36901699791788345) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_99 <= 0.310544650794822) THEN 8 ELSE 9 END ELSE 5 END ELSE 3 END AS node_id_2 
FROM "TMP_20221018185315_4NB915H_ADS_sca_2_OUT" AS "ADS_sca_2_OUT"), 
"DT_node_data_39" AS 
(SELECT "Values".nid AS nid, "Values"."Score" AS "Score" 
FROM (SELECT 3 AS nid, 0.04910992997886279 AS "Score" UNION ALL SELECT 5 AS nid, 0.02305287400468143 AS "Score" UNION ALL SELECT 8 AS nid, -0.04794562777244579 AS "Score" UNION ALL SELECT 9 AS nid, -0.02500877187867434 AS "Score") AS "Values"), 
"DT_Output_39" AS 
...
FROM "DT_Output_39")
 INSERT INTO "TMP_20221018185316_H9AC093_LGBM_B3" ("KEY", "Score_0", "Score_1", "Score_2", "Score_3") SELECT "T"."KEY", "T"."Score_0", "T"."Score_1", "T"."Score_2", "T"."Score_3" 
...
-- Code For temporary table TMP_20221018185316_IA32VMZ_LGBM_B4 part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221018185316_IA32VMZ_LGBM_B4" (
	"KEY" BIGINT, 
	"Score_0" FLOAT, 
	"Score_1" FLOAT, 
	"Score_2" FLOAT, 
...
-- Code For temporary table TMP_20221018185316_IA32VMZ_LGBM_B4 part 2. Populate

WITH "DT_node_lookup_40" AS 
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", CASE WHEN ("ADS_sca_2_OUT".scaler_80 <= -0.20659892002321142) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_8 <= 0.15851073706032173) THEN 4 ELSE 5 END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_35 <= -0.19856138664745998) THEN 6 ELSE 7 END END AS node_id_2 
FROM "TMP_20221018185315_4NB915H_ADS_sca_2_OUT" AS "ADS_sca_2_OUT"), 
"DT_node_data_40" AS 
(SELECT "Values".nid AS nid, "Values"."Score" AS "Score" 
FROM (SELECT 4 AS nid, -0.04564452425309737 AS "Score" UNION ALL SELECT 5 AS nid, -0.020196093725118484 AS "Score" UNION ALL SELECT 6 AS nid, 0.052309533220100915 AS "Score" UNION ALL SELECT 7 AS nid, -0.007448205539426562 AS "Score") AS "Values"), 
"DT_Output_40" AS 
...
"DT_node_data_41" AS 
(SELECT "Values".nid AS nid, "Values"."Score" AS "Score" 
FROM (SELECT 2 AS nid, -0.030521258087453564 AS "Score" UNION ALL SELECT 6 AS nid, -0.015677879611741257 AS "Score" UNION ALL SELECT 7 AS nid, 0.04198284781271726 AS "Score") AS "Values"), 
"DT_Output_41" AS 
...
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", CASE WHEN ("ADS_sca_2_OUT".scaler_46 <= -0.9107336615828704) THEN 2 ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_21 <= -0.25420272015856016) THEN 6 ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_60 <= -0.3936299434341043) THEN 14 ELSE 15 END END END AS node_id_2 
FROM "TMP_20221018185315_4NB915H_ADS_sca_2_OUT" AS "ADS_sca_2_OUT"), 
"DT_node_data_42" AS 
(SELECT "Values".nid AS nid, "Values"."Score" AS "Score" 
FROM (SELECT 2 AS nid, 0.07096239685139778 AS "Score" UNION ALL SELECT 6 AS nid, 0.0076706351807744365 AS "Score" UNION ALL SELECT 14 AS nid, -0.03376281854033641 AS "Score" UNION ALL SELECT 15 AS nid, -0.04792043611483368 AS "Score") AS "Values"), 
"DT_Output_42" AS 
...
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", CASE WHEN ("ADS_sca_2_OUT".scaler_101 <= 1.0000000180025095e-35) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_21 <= -0.3420785268148518) THEN 4 ELSE 5 END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_55 <= 0.2521792881642213) THEN 6 ELSE 7 END END AS node_id_2 
FROM "TMP_20221018185315_4NB915H_ADS_sca_2_OUT" AS "ADS_sca_2_OUT"), 
"DT_node_data_43" AS 
(SELECT "Values".nid AS nid, "Values"."Score" AS "Score" 
FROM (SELECT 4 AS nid, -0.021433192292919845 AS "Score" UNION ALL SELECT 5 AS nid, 0.05625236781604497 AS "Score" UNION ALL SELECT 6 AS nid, -0.0481631472387776 AS "Score" UNION ALL SELECT 7 AS nid, 0.00491767036031532 AS "Score") AS "Values"), 
"DT_Output_43" AS 
...
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", CASE WHEN ("ADS_sca_2_OUT".scaler_94 <= 0.07659678856147197) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_31 <= -0.07504227709770663) THEN 4 ELSE 5 END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_93 <= -0.16486990299418197) THEN 6 ELSE 7 END END AS node_id_2 
FROM "TMP_20221018185315_4NB915H_ADS_sca_2_OUT" AS "ADS_sca_2_OUT"), 
"DT_node_data_44" AS 
(SELECT "Values".nid AS nid, "Values"."Score" AS "Score" 
FROM (SELECT 4 AS nid, 0.05330324992445217 AS "Score" UNION ALL SELECT 5 AS nid, -0.015102329160106022 AS "Score" UNION ALL SELECT 6 AS nid, -0.005661709607769088 AS "Score" UNION ALL SELECT 7 AS nid, -0.047611294855172376 AS "Score") AS "Values"), 
"DT_Output_44" AS 
...
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", CASE WHEN ("ADS_sca_2_OUT".scaler_25 <= -0.743828490543914) THEN 2 ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_47 <= 0.49431539102158945) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_38 <= 1.0000000180025095e-35) THEN 12 ELSE 13 END ELSE 7 END END AS node_id_2 
FROM "TMP_20221018185315_4NB915H_ADS_sca_2_OUT" AS "ADS_sca_2_OUT"), 
"DT_node_data_45" AS 
(SELECT "Values".nid AS nid, "Values"."Score" AS "Score" 
FROM (SELECT 2 AS nid, 0.0347917733027244 AS "Score" UNION ALL SELECT 7 AS nid, 0.017903979604916284 AS "Score" UNION ALL SELECT 12 AS nid, -0.049603816156340186 AS "Score" UNION ALL SELECT 13 AS nid, -0.00905733392570196 AS "Score") AS "Values"), 
"DT_Output_45" AS 
...
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", CASE WHEN ("ADS_sca_2_OUT".scaler_46 <= -0.9107336615828704) THEN 2 ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_21 <= -0.25420272015856016) THEN 6 ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_33 <= 1.0000000180025095e-35) THEN 14 ELSE 15 END END END AS node_id_2 
FROM "TMP_20221018185315_4NB915H_ADS_sca_2_OUT" AS "ADS_sca_2_OUT"), 
"DT_node_data_46" AS 
(SELECT "Values".nid AS nid, "Values"."Score" AS "Score" 
FROM (SELECT 2 AS nid, 0.06652633214151407 AS "Score" UNION ALL SELECT 6 AS nid, 0.007240030453438209 AS "Score" UNION ALL SELECT 14 AS nid, -0.04744312219631547 AS "Score" UNION ALL SELECT 15 AS nid, -0.032996628393518676 AS "Score") AS "Values"), 
"DT_Output_46" AS 
...
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", CASE WHEN ("ADS_sca_2_OUT".scaler_91 <= -0.45209775818938763) THEN 2 ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_101 <= -0.07294683460743877) THEN 6 ELSE 7 END END AS node_id_2 
FROM "TMP_20221018185315_4NB915H_ADS_sca_2_OUT" AS "ADS_sca_2_OUT"), 
"DT_node_data_47" AS 
(SELECT "Values".nid AS nid, "Values"."Score" AS "Score" 
FROM (SELECT 2 AS nid, -0.03599084815993396 AS "Score" UNION ALL SELECT 6 AS nid, 0.04988908551835162 AS "Score" UNION ALL SELECT 7 AS nid, -0.01827013534830788 AS "Score") AS "Values"), 
"DT_Output_47" AS 
...
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", CASE WHEN ("ADS_sca_2_OUT".scaler_80 <= -0.20659892002321142) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_25 <= 0.6387828703971571) THEN 4 ELSE 5 END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_4 <= -0.30783146661033284) THEN 6 ELSE 7 END END AS node_id_2 
FROM "TMP_20221018185315_4NB915H_ADS_sca_2_OUT" AS "ADS_sca_2_OUT"), 
"DT_node_data_48" AS 
(SELECT "Values".nid AS nid, "Values"."Score" AS "Score" 
FROM (SELECT 4 AS nid, -0.0451394462045005 AS "Score" UNION ALL SELECT 5 AS nid, -0.018219915527146344 AS "Score" UNION ALL SELECT 6 AS nid, 0.05412837765810313 AS "Score" UNION ALL SELECT 7 AS nid, -0.003541329056263961 AS "Score") AS "Values"), 
"DT_Output_48" AS 
...
"DT_node_data_49" AS 
(SELECT "Values".nid AS nid, "Values"."Score" AS "Score" 
FROM (SELECT 2 AS nid, -0.03946769679839054 AS "Score" UNION ALL SELECT 6 AS nid, -0.026170120279771447 AS "Score" UNION ALL SELECT 14 AS nid, 0.07072720447501463 AS "Score" UNION ALL SELECT 15 AS nid, -0.007056857129689126 AS "Score") AS "Values"), 
"DT_Output_49" AS 
...
FROM "DT_Output_49")
 INSERT INTO "TMP_20221018185316_IA32VMZ_LGBM_B4" ("KEY", "Score_0", "Score_1", "Score_2", "Score_3") SELECT "T"."KEY", "T"."Score_0", "T"."Score_1", "T"."Score_2", "T"."Score_3" 
...
-- Code For temporary table TMP_20221018185316_1EHZ1TH_LGBM_B5 part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221018185316_1EHZ1TH_LGBM_B5" (
	"KEY" BIGINT, 
	"Score_0" FLOAT, 
	"Score_1" FLOAT, 
	"Score_2" FLOAT, 
...
-- Code For temporary table TMP_20221018185316_1EHZ1TH_LGBM_B5 part 2. Populate
...
"DT_node_data_50" AS 
(SELECT "Values".nid AS nid, "Values"."Score" AS "Score" 
FROM (SELECT 2 AS nid, 0.06324080061040203 AS "Score" UNION ALL SELECT 6 AS nid, 0.007040275115176128 AS "Score" UNION ALL SELECT 14 AS nid, -0.03224497022732738 AS "Score" UNION ALL SELECT 15 AS nid, -0.04708118361128829 AS "Score") AS "Values"), 
"DT_Output_50" AS 
...
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", CASE WHEN ("ADS_sca_2_OUT".scaler_55 <= 0.37689067590287556) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_101 <= -0.07294683460743877) THEN 4 ELSE 5 END ELSE 3 END AS node_id_2 
FROM "TMP_20221018185315_4NB915H_ADS_sca_2_OUT" AS "ADS_sca_2_OUT"), 
"DT_node_data_51" AS 
(SELECT "Values".nid AS nid, "Values"."Score" AS "Score" 
FROM (SELECT 3 AS nid, 0.02831335559678006 AS "Score" UNION ALL SELECT 4 AS nid, 0.01052759844556276 AS "Score" UNION ALL SELECT 5 AS nid, -0.04768788885150679 AS "Score") AS "Values"), 
"DT_Output_51" AS 
...
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", CASE WHEN ("ADS_sca_2_OUT".scaler_94 <= 0.07659678856147197) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_31 <= -0.07504227709770663) THEN 4 ELSE 5 END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_17 <= 1.0000000180025095e-35) THEN 6 ELSE 7 END END AS node_id_2 
FROM "TMP_20221018185315_4NB915H_ADS_sca_2_OUT" AS "ADS_sca_2_OUT"), 
"DT_node_data_52" AS 
(SELECT "Values".nid AS nid, "Values"."Score" AS "Score" 
FROM (SELECT 4 AS nid, 0.04954944083357913 AS "Score" UNION ALL SELECT 5 AS nid, -0.014466513405954945 AS "Score" UNION ALL SELECT 6 AS nid, -0.04716845245802506 AS "Score" UNION ALL SELECT 7 AS nid, -0.0055783086738568875 AS "Score") AS "Values"), 
"DT_Output_52" AS 
...
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", CASE WHEN ("ADS_sca_2_OUT".scaler_70 <= -0.7274469808060616) THEN 2 ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_96 <= -0.2003506790254312) THEN 6 ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_36 <= 0.026121229376466087) THEN 14 ELSE 15 END END END AS node_id_2 
FROM "TMP_20221018185315_4NB915H_ADS_sca_2_OUT" AS "ADS_sca_2_OUT"), 
"DT_node_data_53" AS 
(SELECT "Values".nid AS nid, "Values"."Score" AS "Score" 
FROM (SELECT 2 AS nid, -0.038851123380294644 AS "Score" UNION ALL SELECT 6 AS nid, -0.023033528394151927 AS "Score" UNION ALL SELECT 14 AS nid, 0.0663038688584912 AS "Score" UNION ALL SELECT 15 AS nid, 0.0019481233586179391 AS "Score") AS "Values"), 
"DT_Output_53" AS 
...
"DT_node_data_54" AS 
(SELECT "Values".nid AS nid, "Values"."Score" AS "Score" 
FROM (SELECT 2 AS nid, 0.0600613182584732 AS "Score" UNION ALL SELECT 6 AS nid, 0.006884019607572333 AS "Score" UNION ALL SELECT 14 AS nid, -0.03157132365950094 AS "Score" UNION ALL SELECT 15 AS nid, -0.04669819558604147 AS "Score") AS "Values"), 
"DT_Output_54" AS 
...
"DT_node_data_55" AS 
(SELECT "Values".nid AS nid, "Values"."Score" AS "Score" 
FROM (SELECT 2 AS nid, -0.03535361412280217 AS "Score" UNION ALL SELECT 6 AS nid, 0.04553952014303134 AS "Score" UNION ALL SELECT 7 AS nid, -0.017090481427155465 AS "Score") AS "Values"), 
"DT_Output_55" AS 
...
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", CASE WHEN ("ADS_sca_2_OUT".scaler_80 <= -0.20659892002321142) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_12 <= 0.49488851058385763) THEN 4 ELSE 5 END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_4 <= -0.4745872760766509) THEN 6 ELSE 7 END END AS node_id_2 
FROM "TMP_20221018185315_4NB915H_ADS_sca_2_OUT" AS "ADS_sca_2_OUT"), 
"DT_node_data_56" AS 
(SELECT "Values".nid AS nid, "Values"."Score" AS "Score" 
FROM (SELECT 4 AS nid, -0.044802558281383464 AS "Score" UNION ALL SELECT 5 AS nid, -0.017007152726921642 AS "Score" UNION ALL SELECT 6 AS nid, 0.0564990718250623 AS "Score" UNION ALL SELECT 7 AS nid, -0.005406990134286464 AS "Score") AS "Values"), 
"DT_Output_56" AS 
...
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", CASE WHEN ("ADS_sca_2_OUT".scaler_4 <= -0.70612278579642) THEN 2 ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_11 <= -0.16760702855928997) THEN 6 ELSE 7 END END AS node_id_2 
FROM "TMP_20221018185315_4NB915H_ADS_sca_2_OUT" AS "ADS_sca_2_OUT"), 
"DT_node_data_57" AS 
(SELECT "Values".nid AS nid, "Values"."Score" AS "Score" 
FROM (SELECT 2 AS nid, -0.034416536777591065 AS "Score" UNION ALL SELECT 6 AS nid, -0.025596573488036685 AS "Score" UNION ALL SELECT 7 AS nid, 0.03676606727771858 AS "Score") AS "Values"), 
"DT_Output_57" AS 
...
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", CASE WHEN ("ADS_sca_2_OUT".scaler_46 <= -0.9107336615828704) THEN 2 ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_59 <= 1.0000000180025095e-35) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_22 <= 0.283025486148126) THEN 12 ELSE 13 END ELSE 7 END END AS node_id_2 
FROM "TMP_20221018185315_4NB915H_ADS_sca_2_OUT" AS "ADS_sca_2_OUT"), 
"DT_node_data_58" AS 
(SELECT "Values".nid AS nid, "Values"."Score" AS "Score" 
FROM (SELECT 2 AS nid, 0.05708342857042386 AS "Score" UNION ALL SELECT 7 AS nid, 0.00645788135279648 AS "Score" UNION ALL SELECT 12 AS nid, -0.04658241665495888 AS "Score" UNION ALL SELECT 13 AS nid, -0.03397965274864534 AS "Score") AS "Values"), 
"DT_Output_58" AS 
...
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", CASE WHEN ("ADS_sca_2_OUT".scaler_91 <= -0.45209775818938763) THEN 2 ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_55 <= 0.37689067590287556) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_41 <= 1.0000000180025095e-35) THEN 12 ELSE 13 END ELSE 7 END END AS node_id_2 
FROM "TMP_20221018185315_4NB915H_ADS_sca_2_OUT" AS "ADS_sca_2_OUT"), 
"DT_node_data_59" AS 
(SELECT "Values".nid AS nid, "Values"."Score" AS "Score" 
FROM (SELECT 2 AS nid, -0.034766487128175545 AS "Score" UNION ALL SELECT 7 AS nid, 0.05083497865823516 AS "Score" UNION ALL SELECT 12 AS nid, -0.047041509884351636 AS "Score" UNION ALL SELECT 13 AS nid, 0.019052725717267974 AS "Score") AS "Values"), 
"DT_Output_59" AS 
...
FROM "DT_Output_59")
 INSERT INTO "TMP_20221018185316_1EHZ1TH_LGBM_B5" ("KEY", "Score_0", "Score_1", "Score_2", "Score_3") SELECT "T"."KEY", "T"."Score_0", "T"."Score_1", "T"."Score_2", "T"."Score_3" 
...
-- Code For temporary table TMP_20221018185316_WAYK4XE_LGBM_B6 part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221018185316_WAYK4XE_LGBM_B6" (
	"KEY" BIGINT, 
	"Score_0" FLOAT, 
	"Score_1" FLOAT, 
	"Score_2" FLOAT, 
...
-- Code For temporary table TMP_20221018185316_WAYK4XE_LGBM_B6 part 2. Populate

WITH "DT_node_lookup_60" AS 
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", CASE WHEN ("ADS_sca_2_OUT".scaler_94 <= 0.07659678856147197) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_31 <= -0.07504227709770663) THEN 4 ELSE 5 END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_26 <= 0.19621913740782904) THEN 6 ELSE 7 END END AS node_id_2 
FROM "TMP_20221018185315_4NB915H_ADS_sca_2_OUT" AS "ADS_sca_2_OUT"), 
"DT_node_data_60" AS 
(SELECT "Values".nid AS nid, "Values"."Score" AS "Score" 
FROM (SELECT 4 AS nid, 0.04612511598728258 AS "Score" UNION ALL SELECT 5 AS nid, -0.01384709352178836 AS "Score" UNION ALL SELECT 6 AS nid, -0.04662253162379604 AS "Score" UNION ALL SELECT 7 AS nid, 0.0023368833131523414 AS "Score") AS "Values"), 
"DT_Output_60" AS 
...
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", CASE WHEN ("ADS_sca_2_OUT".scaler_94 <= 0.8118096302765222) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_11 <= -0.16760702855928997) THEN 4 ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_73 <= 0.1679657243993935) THEN 10 ELSE 11 END END ELSE 3 END AS node_id_2 
FROM "TMP_20221018185315_4NB915H_ADS_sca_2_OUT" AS "ADS_sca_2_OUT"), 
"DT_node_data_61" AS 
(SELECT "Values".nid AS nid, "Values"."Score" AS "Score" 
FROM (SELECT 3 AS nid, 0.044137325024493655 AS "Score" UNION ALL SELECT 4 AS nid, -0.04082320808152135 AS "Score" UNION ALL SELECT 10 AS nid, 0.03759976557933336 AS "Score" UNION ALL SELECT 11 AS nid, -0.022046486499941925 AS "Score") AS "Values"), 
"DT_Output_61" AS 
...
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", CASE WHEN ("ADS_sca_2_OUT".scaler_46 <= -0.9107336615828704) THEN 2 ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_58 <= -1.0000000180025095e-35) THEN 6 ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_96 <= -0.049833812479681626) THEN 14 ELSE 15 END END END AS node_id_2 
FROM "TMP_20221018185315_4NB915H_ADS_sca_2_OUT" AS "ADS_sca_2_OUT"), 
"DT_node_data_62" AS 
(SELECT "Values".nid AS nid, "Values"."Score" AS "Score" 
FROM (SELECT 2 AS nid, 0.05448127386633105 AS "Score" UNION ALL SELECT 6 AS nid, 0.007503971786765024 AS "Score" UNION ALL SELECT 14 AS nid, -0.03141144919571787 AS "Score" UNION ALL SELECT 15 AS nid, -0.045867033426548756 AS "Score") AS "Values"), 
"DT_Output_62" AS 
...
"DT_node_data_63" AS 
(SELECT "Values".nid AS nid, "Values"."Score" AS "Score" 
FROM (SELECT 3 AS nid, 0.025519712563736276 AS "Score" UNION ALL SELECT 4 AS nid, -0.04658503714169511 AS "Score" UNION ALL SELECT 5 AS nid, 0.005427478642559282 AS "Score") AS "Values"), 
"DT_Output_63" AS 
...
FROM "DT_Output_63")
 INSERT INTO "TMP_20221018185316_WAYK4XE_LGBM_B6" ("KEY", "Score_0", "Score_1", "Score_2", "Score_3") SELECT "T"."KEY", "T"."Score_0", "T"."Score_1", "T"."Score_2", "T"."Score_3" 
...
-- Code For temporary table TMP_20221018185316_9409H1O_LGBM_sum part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221018185316_9409H1O_LGBM_sum" (
	"KEY" BIGINT NOT NULL, 
	"Score_0" FLOAT, 
	"Score_1" FLOAT, 
	"Score_2" FLOAT, 
...
-- Code For temporary table TMP_20221018185316_9409H1O_LGBM_sum part 2. Populate
...
FROM (SELECT "LGBM_B0"."KEY" AS "KEY", "LGBM_B0"."Score_0" AS "Score_0", "LGBM_B0"."Score_1" AS "Score_1", "LGBM_B0"."Score_2" AS "Score_2", "LGBM_B0"."Score_3" AS "Score_3" 
FROM "TMP_20221018185316_K6OH080_LGBM_B0" AS "LGBM_B0" UNION ALL SELECT "LGBM_B1"."KEY" AS "KEY", "LGBM_B1"."Score_0" AS "Score_0", "LGBM_B1"."Score_1" AS "Score_1", "LGBM_B1"."Score_2" AS "Score_2", "LGBM_B1"."Score_3" AS "Score_3" 
FROM "TMP_20221018185316_81K0EQY_LGBM_B1" AS "LGBM_B1" UNION ALL SELECT "LGBM_B2"."KEY" AS "KEY", "LGBM_B2"."Score_0" AS "Score_0", "LGBM_B2"."Score_1" AS "Score_1", "LGBM_B2"."Score_2" AS "Score_2", "LGBM_B2"."Score_3" AS "Score_3" 
FROM "TMP_20221018185316_QED2R1R_LGBM_B2" AS "LGBM_B2" UNION ALL SELECT "LGBM_B3"."KEY" AS "KEY", "LGBM_B3"."Score_0" AS "Score_0", "LGBM_B3"."Score_1" AS "Score_1", "LGBM_B3"."Score_2" AS "Score_2", "LGBM_B3"."Score_3" AS "Score_3" 
FROM "TMP_20221018185316_H9AC093_LGBM_B3" AS "LGBM_B3" UNION ALL SELECT "LGBM_B4"."KEY" AS "KEY", "LGBM_B4"."Score_0" AS "Score_0", "LGBM_B4"."Score_1" AS "Score_1", "LGBM_B4"."Score_2" AS "Score_2", "LGBM_B4"."Score_3" AS "Score_3" 
FROM "TMP_20221018185316_IA32VMZ_LGBM_B4" AS "LGBM_B4" UNION ALL SELECT "LGBM_B5"."KEY" AS "KEY", "LGBM_B5"."Score_0" AS "Score_0", "LGBM_B5"."Score_1" AS "Score_1", "LGBM_B5"."Score_2" AS "Score_2", "LGBM_B5"."Score_3" AS "Score_3" 
FROM "TMP_20221018185316_1EHZ1TH_LGBM_B5" AS "LGBM_B5" UNION ALL SELECT "LGBM_B6"."KEY" AS "KEY", "LGBM_B6"."Score_0" AS "Score_0", "LGBM_B6"."Score_1" AS "Score_1", "LGBM_B6"."Score_2" AS "Score_2", "LGBM_B6"."Score_3" AS "Score_3" 
FROM "TMP_20221018185316_WAYK4XE_LGBM_B6" AS "LGBM_B6") AS "LGBM_EnsembleUnion")
 INSERT INTO "TMP_20221018185316_9409H1O_LGBM_sum" ("KEY", "Score_0", "Score_1", "Score_2", "Score_3") SELECT "T"."KEY", "T"."Score_0", "T"."Score_1", "T"."Score_2", "T"."Score_3" 
...
-- Code For temporary table TMP_20221018185316_9409H1O_LGBM_sum part 3. Create Index 

CREATE INDEX "ix_TMP_20221018185316_9409H1O_LGBM_sum_KEY" ON "TMP_20221018185316_9409H1O_LGBM_sum" ("KEY")
...
FROM "TMP_20221018185316_9409H1O_LGBM_sum" AS "LGBM_sum"), 
