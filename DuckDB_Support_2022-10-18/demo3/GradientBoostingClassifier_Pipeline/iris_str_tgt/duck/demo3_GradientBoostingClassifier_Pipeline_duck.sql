...
-- Code For temporary table TMP_20221018190634_3YJWQQ7_ADS_imp_1_OUT part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221018190634_3YJWQQ7_ADS_imp_1_OUT" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20221018190634_3YJWQQ7_ADS_imp_1_OUT part 2. Populate

INSERT INTO "TMP_20221018190634_3YJWQQ7_ADS_imp_1_OUT" ("KEY", imputer_output_2, imputer_output_3, imputer_output_4, imputer_output_5) SELECT "T"."KEY", "T".imputer_output_2, "T".imputer_output_3, "T".imputer_output_4, "T".imputer_output_5 
...
-- Code For temporary table TMP_20221018190634_3YJWQQ7_ADS_imp_1_OUT part 3. Create Index 

CREATE INDEX "ix_TMP_20221018190634_3YJWQQ7_ADS_imp_1_OUT_KEY" ON "TMP_20221018190634_3YJWQQ7_ADS_imp_1_OUT" ("KEY")

-- Code For temporary table TMP_20221018190634_052DMKM_ADS_sca_2_OUT part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221018190634_052DMKM_ADS_sca_2_OUT" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20221018190634_052DMKM_ADS_sca_2_OUT part 2. Populate

INSERT INTO "TMP_20221018190634_052DMKM_ADS_sca_2_OUT" ("KEY", scaler_output_2, scaler_output_3, scaler_output_4, scaler_output_5) SELECT "T"."KEY", "T".scaler_output_2, "T".scaler_output_3, "T".scaler_output_4, "T".scaler_output_5 
...
FROM "TMP_20221018190634_3YJWQQ7_ADS_imp_1_OUT" AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT") AS "T"

-- Code For temporary table TMP_20221018190634_052DMKM_ADS_sca_2_OUT part 3. Create Index 

CREATE INDEX "ix_TMP_20221018190634_052DMKM_ADS_sca_2_OUT_KEY" ON "TMP_20221018190634_052DMKM_ADS_sca_2_OUT" ("KEY")

-- Code For temporary table TMP_20221018190634_MJ9IR1I_GB_B0 part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221018190634_MJ9IR1I_GB_B0" (
	"KEY" BIGINT, 
...
-- Code For temporary table TMP_20221018190634_MJ9IR1I_GB_B0 part 2. Populate
...
FROM "TMP_20221018190634_052DMKM_ADS_sca_2_OUT" AS "ADS_sca_2_OUT"), 
"DT_node_data" AS 
...
FROM "DT_Output_9")
 INSERT INTO "TMP_20221018190634_MJ9IR1I_GB_B0" ("KEY", "Score_CLASS_0", "Score_CLASS_1", "Score_CLASS_2") SELECT "T"."KEY", "T"."Score_CLASS_0", "T"."Score_CLASS_1", "T"."Score_CLASS_2" 
...
-- Code For temporary table TMP_20221018190634_NJORYVL_GB_B1 part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221018190634_NJORYVL_GB_B1" (
	"KEY" BIGINT, 
	"Score_CLASS_0" DOUBLE, 
	"Score_CLASS_1" DOUBLE, 
	"Score_CLASS_2" DOUBLE
...
-- Code For temporary table TMP_20221018190634_NJORYVL_GB_B1 part 2. Populate
...
FROM "DT_Output_19")
 INSERT INTO "TMP_20221018190634_NJORYVL_GB_B1" ("KEY", "Score_CLASS_0", "Score_CLASS_1", "Score_CLASS_2") SELECT "T"."KEY", "T"."Score_CLASS_0", "T"."Score_CLASS_1", "T"."Score_CLASS_2" 
FROM (SELECT "GB_B1"."KEY" AS "KEY", "GB_B1"."Score_CLASS_0" AS "Score_CLASS_0", "GB_B1"."Score_CLASS_1" AS "Score_CLASS_1", "GB_B1"."Score_CLASS_2" AS "Score_CLASS_2" 
...
-- Code For temporary table TMP_20221018190634_2YTZBYF_GB_B2 part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221018190634_2YTZBYF_GB_B2" (
	"KEY" BIGINT, 
	"Score_CLASS_0" DOUBLE, 
	"Score_CLASS_1" DOUBLE, 
	"Score_CLASS_2" DOUBLE
...
-- Code For temporary table TMP_20221018190634_2YTZBYF_GB_B2 part 2. Populate
...
FROM "DT_Output_29")
 INSERT INTO "TMP_20221018190634_2YTZBYF_GB_B2" ("KEY", "Score_CLASS_0", "Score_CLASS_1", "Score_CLASS_2") SELECT "T"."KEY", "T"."Score_CLASS_0", "T"."Score_CLASS_1", "T"."Score_CLASS_2" 
FROM (SELECT "GB_B2"."KEY" AS "KEY", "GB_B2"."Score_CLASS_0" AS "Score_CLASS_0", "GB_B2"."Score_CLASS_1" AS "Score_CLASS_1", "GB_B2"."Score_CLASS_2" AS "Score_CLASS_2" 
...
-- Code For temporary table TMP_20221018190634_GIOC8O4_GB_B3 part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221018190634_GIOC8O4_GB_B3" (
	"KEY" BIGINT, 
	"Score_CLASS_0" DOUBLE, 
	"Score_CLASS_1" DOUBLE, 
	"Score_CLASS_2" DOUBLE
...
-- Code For temporary table TMP_20221018190634_GIOC8O4_GB_B3 part 2. Populate
...
FROM "DT_Output_39")
 INSERT INTO "TMP_20221018190634_GIOC8O4_GB_B3" ("KEY", "Score_CLASS_0", "Score_CLASS_1", "Score_CLASS_2") SELECT "T"."KEY", "T"."Score_CLASS_0", "T"."Score_CLASS_1", "T"."Score_CLASS_2" 
FROM (SELECT "GB_B3"."KEY" AS "KEY", "GB_B3"."Score_CLASS_0" AS "Score_CLASS_0", "GB_B3"."Score_CLASS_1" AS "Score_CLASS_1", "GB_B3"."Score_CLASS_2" AS "Score_CLASS_2" 
...
-- Code For temporary table TMP_20221018190634_W31T2G3_GB_B4 part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221018190634_W31T2G3_GB_B4" (
	"KEY" BIGINT, 
	"Score_CLASS_0" DOUBLE, 
	"Score_CLASS_1" DOUBLE, 
	"Score_CLASS_2" DOUBLE
...
-- Code For temporary table TMP_20221018190634_W31T2G3_GB_B4 part 2. Populate
...
FROM "DT_Output_47")
 INSERT INTO "TMP_20221018190634_W31T2G3_GB_B4" ("KEY", "Score_CLASS_0", "Score_CLASS_1", "Score_CLASS_2") SELECT "T"."KEY", "T"."Score_CLASS_0", "T"."Score_CLASS_1", "T"."Score_CLASS_2" 
FROM (SELECT "GB_B4"."KEY" AS "KEY", "GB_B4"."Score_CLASS_0" AS "Score_CLASS_0", "GB_B4"."Score_CLASS_1" AS "Score_CLASS_1", "GB_B4"."Score_CLASS_2" AS "Score_CLASS_2" 
...
-- Code For temporary table TMP_20221018190634_VJIKGM4_GB_sum part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221018190634_VJIKGM4_GB_sum" (
	"KEY" BIGINT NOT NULL, 
	"Score_CLASS_0" DOUBLE, 
	"Score_CLASS_1" DOUBLE, 
	"Score_CLASS_2" DOUBLE, 
...
-- Code For temporary table TMP_20221018190634_VJIKGM4_GB_sum part 2. Populate
...
FROM (SELECT "GB_B0"."KEY" AS "KEY", "GB_B0"."Score_CLASS_0" AS "Score_CLASS_0", "GB_B0"."Score_CLASS_1" AS "Score_CLASS_1", "GB_B0"."Score_CLASS_2" AS "Score_CLASS_2" 
FROM "TMP_20221018190634_MJ9IR1I_GB_B0" AS "GB_B0" UNION ALL SELECT "GB_B1"."KEY" AS "KEY", "GB_B1"."Score_CLASS_0" AS "Score_CLASS_0", "GB_B1"."Score_CLASS_1" AS "Score_CLASS_1", "GB_B1"."Score_CLASS_2" AS "Score_CLASS_2" 
FROM "TMP_20221018190634_NJORYVL_GB_B1" AS "GB_B1" UNION ALL SELECT "GB_B2"."KEY" AS "KEY", "GB_B2"."Score_CLASS_0" AS "Score_CLASS_0", "GB_B2"."Score_CLASS_1" AS "Score_CLASS_1", "GB_B2"."Score_CLASS_2" AS "Score_CLASS_2" 
FROM "TMP_20221018190634_2YTZBYF_GB_B2" AS "GB_B2" UNION ALL SELECT "GB_B3"."KEY" AS "KEY", "GB_B3"."Score_CLASS_0" AS "Score_CLASS_0", "GB_B3"."Score_CLASS_1" AS "Score_CLASS_1", "GB_B3"."Score_CLASS_2" AS "Score_CLASS_2" 
FROM "TMP_20221018190634_GIOC8O4_GB_B3" AS "GB_B3" UNION ALL SELECT "GB_B4"."KEY" AS "KEY", "GB_B4"."Score_CLASS_0" AS "Score_CLASS_0", "GB_B4"."Score_CLASS_1" AS "Score_CLASS_1", "GB_B4"."Score_CLASS_2" AS "Score_CLASS_2" 
FROM "TMP_20221018190634_W31T2G3_GB_B4" AS "GB_B4") AS "GB_EnsembleUnion")
 INSERT INTO "TMP_20221018190634_VJIKGM4_GB_sum" ("KEY", "Score_CLASS_0", "Score_CLASS_1", "Score_CLASS_2") SELECT "T"."KEY", "T"."Score_CLASS_0", "T"."Score_CLASS_1", "T"."Score_CLASS_2" 
FROM (SELECT "GB_sum"."KEY" AS "KEY", "GB_sum"."Score_CLASS_0" AS "Score_CLASS_0", "GB_sum"."Score_CLASS_1" AS "Score_CLASS_1", "GB_sum"."Score_CLASS_2" AS "Score_CLASS_2" 
...
-- Code For temporary table TMP_20221018190634_VJIKGM4_GB_sum part 3. Create Index 

CREATE INDEX "ix_TMP_20221018190634_VJIKGM4_GB_sum_KEY" ON "TMP_20221018190634_VJIKGM4_GB_sum" ("KEY")
...
FROM "TMP_20221018190634_VJIKGM4_GB_sum" AS "GB_sum"), 
