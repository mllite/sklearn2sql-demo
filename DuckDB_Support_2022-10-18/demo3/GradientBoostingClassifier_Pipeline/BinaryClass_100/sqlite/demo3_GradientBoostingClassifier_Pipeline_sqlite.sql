...
-- Code For temporary table TMP_20221018184939_DLD3SN0_ADS_imp_1_OUT part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221018184939_DLD3SN0_ADS_imp_1_OUT" (
	"KEY" BIGINT NOT NULL, 
	impter_2 FLOAT, 
	impter_3 FLOAT, 
	impter_4 FLOAT, 
...
-- Code For temporary table TMP_20221018184939_DLD3SN0_ADS_imp_1_OUT part 3. Create Index 

CREATE INDEX "ix_TMP_20221018184939_DLD3SN0_ADS_imp_1_OUT_KEY" ON "TMP_20221018184939_DLD3SN0_ADS_imp_1_OUT" ("KEY")

-- Code For temporary table TMP_20221018184939_NTRE7UL_ADS_sca_2_OUT part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221018184939_NTRE7UL_ADS_sca_2_OUT" (
	"KEY" BIGINT NOT NULL, 
	scaler_2 FLOAT, 
	scaler_3 FLOAT, 
	scaler_4 FLOAT, 
...
FROM "TMP_20221018184939_DLD3SN0_ADS_imp_1_OUT" AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT") AS "T"

-- Code For temporary table TMP_20221018184939_NTRE7UL_ADS_sca_2_OUT part 3. Create Index 

CREATE INDEX "ix_TMP_20221018184939_NTRE7UL_ADS_sca_2_OUT_KEY" ON "TMP_20221018184939_NTRE7UL_ADS_sca_2_OUT" ("KEY")

-- Code For temporary table TMP_20221018184939_0LCXSXH_GB_B0 part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221018184939_0LCXSXH_GB_B0" (
	"KEY" BIGINT, 
	"Score_0" FLOAT, 
	"Score_1" FLOAT
)
...
-- Code For temporary table TMP_20221018184939_0LCXSXH_GB_B0 part 2. Populate

WITH "DT_node_lookup" AS 
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", CASE WHEN ("ADS_sca_2_OUT".scaler_59 <= 0.06653057038784027) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_19 <= 1.166886031627655) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_11 <= 2.1140206456184387) THEN 3 ELSE 4 END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_21 <= 1.1025973558425903) THEN 6 ELSE 7 END END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_83 <= -2.09354031085968) THEN 9 ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_74 <= -1.8504894375801086) THEN 11 ELSE 12 END END END AS node_id_2 
FROM "TMP_20221018184939_NTRE7UL_ADS_sca_2_OUT" AS "ADS_sca_2_OUT"), 
"DT_node_data" AS 
...
FROM "DT_Output"), 
"DT_node_lookup_1" AS 
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", CASE WHEN ("ADS_sca_2_OUT".scaler_59 <= 0.06653057038784027) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_39 <= 1.5735666751861572) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_62 <= -2.1253793239593506) THEN 3 ELSE 4 END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_96 <= -0.9484712928533554) THEN 6 ELSE 7 END END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_20 <= 1.5954883098602295) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_19 <= 1.9900465607643127) THEN 10 ELSE 11 END ELSE 12 END END AS node_id_2 
FROM "TMP_20221018184939_NTRE7UL_ADS_sca_2_OUT" AS "ADS_sca_2_OUT"), 
"DT_node_data_1" AS 
(SELECT "Values".nid AS nid, "Values"."E" AS "E" 
...
FROM "DT_Output_1"), 
"DT_node_lookup_2" AS 
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", CASE WHEN ("ADS_sca_2_OUT".scaler_59 <= 0.06653057038784027) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_73 <= -2.0547890663146973) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_51 <= -0.011574998497962952) THEN 3 ELSE 4 END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_11 <= 2.1140206456184387) THEN 6 ELSE 7 END END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_24 <= -1.679437279701233) THEN 9 ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_74 <= -1.8504894375801086) THEN 11 ELSE 12 END END END AS node_id_2 
FROM "TMP_20221018184939_NTRE7UL_ADS_sca_2_OUT" AS "ADS_sca_2_OUT"), 
"DT_node_data_2" AS 
(SELECT "Values".nid AS nid, "Values"."E" AS "E" 
...
FROM "DT_Output_4")
 INSERT INTO "TMP_20221018184939_0LCXSXH_GB_B0" ("KEY", "Score_0", "Score_1") SELECT "T"."KEY", "T"."Score_0", "T"."Score_1" 
...
-- Code For temporary table TMP_20221018184939_VS3A5LA_GB_B1 part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221018184939_VS3A5LA_GB_B1" (
	"KEY" BIGINT, 
	"Score_0" FLOAT, 
	"Score_1" FLOAT
)
...
-- Code For temporary table TMP_20221018184939_VS3A5LA_GB_B1 part 2. Populate

WITH "DT_node_lookup_5" AS 
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", CASE WHEN ("ADS_sca_2_OUT".scaler_59 <= -0.11623701080679893) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_62 <= -0.5680299699306488) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_75 <= -0.01915532350540161) THEN 3 ELSE 4 END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_19 <= 1.166886031627655) THEN 6 ELSE 7 END END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_50 <= 1.4252889156341553) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_20 <= 1.5954883098602295) THEN 10 ELSE 11 END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_20 <= 0.5471102222800255) THEN 13 ELSE 14 END END END AS node_id_2 
FROM "TMP_20221018184939_NTRE7UL_ADS_sca_2_OUT" AS "ADS_sca_2_OUT"), 
"DT_node_data_5" AS 
(SELECT "Values".nid AS nid, "Values"."E" AS "E" 
...
FROM "DT_Output_5"), 
"DT_node_lookup_6" AS 
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", CASE WHEN ("ADS_sca_2_OUT".scaler_59 <= -0.11623701080679893) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_37 <= 0.5512429475784302) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_19 <= 1.3340131640434265) THEN 3 ELSE 4 END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_23 <= -0.3337329402565956) THEN 6 ELSE 7 END END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_50 <= 1.4252889156341553) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_74 <= -1.8504894375801086) THEN 10 ELSE 11 END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_78 <= 1.8757691979408264) THEN 13 ELSE 14 END END END AS node_id_2 
FROM "TMP_20221018184939_NTRE7UL_ADS_sca_2_OUT" AS "ADS_sca_2_OUT"), 
"DT_node_data_6" AS 
(SELECT "Values".nid AS nid, "Values"."E" AS "E" 
...
FROM "DT_Output_6"), 
"DT_node_lookup_7" AS 
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", CASE WHEN ("ADS_sca_2_OUT".scaler_59 <= -0.11623701080679893) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_62 <= -0.5680299699306488) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_78 <= 0.17603853158652782) THEN 3 ELSE 4 END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_37 <= 2.150393784046173) THEN 6 ELSE 7 END END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_50 <= 1.4252889156341553) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_20 <= 1.5954883098602295) THEN 10 ELSE 11 END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_68 <= 0.29374879598617554) THEN 13 ELSE 14 END END END AS node_id_2 
FROM "TMP_20221018184939_NTRE7UL_ADS_sca_2_OUT" AS "ADS_sca_2_OUT"), 
"DT_node_data_7" AS 
(SELECT "Values".nid AS nid, "Values"."E" AS "E" 
...
FROM "DT_Output_7"), 
"DT_node_lookup_8" AS 
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", CASE WHEN ("ADS_sca_2_OUT".scaler_59 <= -0.11623701080679893) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_73 <= -2.0547890663146973) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_7 <= 0.3425602540373802) THEN 3 ELSE 4 END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_37 <= 1.2283590734004974) THEN 6 ELSE 7 END END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_50 <= 1.4252889156341553) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_20 <= 1.5954883098602295) THEN 10 ELSE 11 END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_62 <= -1.2847320437431335) THEN 13 ELSE 14 END END END AS node_id_2 
FROM "TMP_20221018184939_NTRE7UL_ADS_sca_2_OUT" AS "ADS_sca_2_OUT"), 
"DT_node_data_8" AS 
(SELECT "Values".nid AS nid, "Values"."E" AS "E" 
...
FROM "DT_Output_8"), 
"DT_node_lookup_9" AS 
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", CASE WHEN ("ADS_sca_2_OUT".scaler_59 <= -0.11623701080679893) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_20 <= 1.9128592610359192) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_62 <= -2.1253793239593506) THEN 3 ELSE 4 END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_8 <= -0.6537164896726608) THEN 6 ELSE 7 END END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_50 <= 1.4252889156341553) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_56 <= 1.2069389820098877) THEN 10 ELSE 11 END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_24 <= 0.41887306049466133) THEN 13 ELSE 14 END END END AS node_id_2 
FROM "TMP_20221018184939_NTRE7UL_ADS_sca_2_OUT" AS "ADS_sca_2_OUT"), 
"DT_node_data_9" AS 
(SELECT "Values".nid AS nid, "Values"."E" AS "E" 
...
FROM "DT_Output_9")
 INSERT INTO "TMP_20221018184939_VS3A5LA_GB_B1" ("KEY", "Score_0", "Score_1") SELECT "T"."KEY", "T"."Score_0", "T"."Score_1" 
...
-- Code For temporary table TMP_20221018184939_7810FB5_GB_B2 part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221018184939_7810FB5_GB_B2" (
	"KEY" BIGINT, 
	"Score_0" FLOAT, 
	"Score_1" FLOAT
)
...
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", CASE WHEN ("ADS_sca_2_OUT".scaler_59 <= -0.1771824061870575) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_73 <= -2.0547890663146973) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_89 <= -0.3544124234467745) THEN 3 ELSE 4 END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_21 <= -1.640648066997528) THEN 6 ELSE 7 END END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_20 <= 1.5777688026428223) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_99 <= -1.8769221901893616) THEN 10 ELSE 11 END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_2 <= -0.44649940729141235) THEN 13 ELSE 14 END END END AS node_id_2 
FROM "TMP_20221018184939_NTRE7UL_ADS_sca_2_OUT" AS "ADS_sca_2_OUT"), 
"DT_node_data_14" AS 
(SELECT "Values".nid AS nid, "Values"."E" AS "E" 
...
FROM "DT_Output_14")
 INSERT INTO "TMP_20221018184939_7810FB5_GB_B2" ("KEY", "Score_0", "Score_1") SELECT "T"."KEY", "T"."Score_0", "T"."Score_1" 
...
-- Code For temporary table TMP_20221018184939_2LWT6PX_GB_B3 part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221018184939_2LWT6PX_GB_B3" (
	"KEY" BIGINT, 
	"Score_0" FLOAT, 
	"Score_1" FLOAT
)
...
-- Code For temporary table TMP_20221018184939_2LWT6PX_GB_B3 part 2. Populate

WITH "DT_node_lookup_15" AS 
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", CASE WHEN ("ADS_sca_2_OUT".scaler_79 <= 0.6556057631969452) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_61 <= -1.5158387422561646) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_43 <= 1.0166130065917969) THEN 3 ELSE 4 END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_50 <= 1.1428174376487732) THEN 6 ELSE 7 END END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_65 <= -1.2290515899658203) THEN 9 ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_12 <= -0.9596459567546844) THEN 11 ELSE 12 END END END AS node_id_2 
FROM "TMP_20221018184939_NTRE7UL_ADS_sca_2_OUT" AS "ADS_sca_2_OUT"), 
"DT_node_data_15" AS 
(SELECT "Values".nid AS nid, "Values"."E" AS "E" 
...
FROM "DT_Output_15")
 INSERT INTO "TMP_20221018184939_2LWT6PX_GB_B3" ("KEY", "Score_0", "Score_1") SELECT "T"."KEY", "T"."Score_0", "T"."Score_1" 
...
-- Code For temporary table TMP_20221018184939_SLZTT0I_GB_sum part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221018184939_SLZTT0I_GB_sum" (
	"KEY" BIGINT NOT NULL, 
	"Score_0" FLOAT, 
	"Score_1" FLOAT, 
	PRIMARY KEY ("KEY")
...
-- Code For temporary table TMP_20221018184939_SLZTT0I_GB_sum part 2. Populate

WITH "GB_Union" AS 
(SELECT "GB_EnsembleUnion"."KEY" AS "KEY", "GB_EnsembleUnion"."Score_0" AS "Score_0", "GB_EnsembleUnion"."Score_1" AS "Score_1" 
FROM (SELECT "GB_B0"."KEY" AS "KEY", "GB_B0"."Score_0" AS "Score_0", "GB_B0"."Score_1" AS "Score_1" 
FROM "TMP_20221018184939_0LCXSXH_GB_B0" AS "GB_B0" UNION ALL SELECT "GB_B1"."KEY" AS "KEY", "GB_B1"."Score_0" AS "Score_0", "GB_B1"."Score_1" AS "Score_1" 
FROM "TMP_20221018184939_VS3A5LA_GB_B1" AS "GB_B1" UNION ALL SELECT "GB_B2"."KEY" AS "KEY", "GB_B2"."Score_0" AS "Score_0", "GB_B2"."Score_1" AS "Score_1" 
FROM "TMP_20221018184939_7810FB5_GB_B2" AS "GB_B2" UNION ALL SELECT "GB_B3"."KEY" AS "KEY", "GB_B3"."Score_0" AS "Score_0", "GB_B3"."Score_1" AS "Score_1" 
FROM "TMP_20221018184939_2LWT6PX_GB_B3" AS "GB_B3") AS "GB_EnsembleUnion")
 INSERT INTO "TMP_20221018184939_SLZTT0I_GB_sum" ("KEY", "Score_0", "Score_1") SELECT "T"."KEY", "T"."Score_0", "T"."Score_1" 
...
-- Code For temporary table TMP_20221018184939_SLZTT0I_GB_sum part 3. Create Index 

CREATE INDEX "ix_TMP_20221018184939_SLZTT0I_GB_sum_KEY" ON "TMP_20221018184939_SLZTT0I_GB_sum" ("KEY")

-- Model deployment code

WITH orig_cte AS 
(SELECT "GB_sum"."KEY" AS "KEY", -(0.475 + 0.1 * "GB_sum"."Score_1") AS "Score_0", 0.475 + 0.1 * "GB_sum"."Score_1" AS "Score_1", 1.0 - 1.0 / (1.0 + exp(min(100.0, max(-100.0, -(0.475 + 0.1 * "GB_sum"."Score_1"))))) AS "Proba_0", 1.0 / (1.0 + exp(min(100.0, max(-100.0, -(0.475 + 0.1 * "GB_sum"."Score_1"))))) AS "Proba_1", CAST(NULL AS FLOAT) AS "LogProba_0", CAST(NULL AS FLOAT) AS "LogProba_1", CAST(NULL AS BIGINT) AS "Decision", CAST(NULL AS FLOAT) AS "DecisionProba" 
FROM "TMP_20221018184939_SLZTT0I_GB_sum" AS "GB_sum"), 
