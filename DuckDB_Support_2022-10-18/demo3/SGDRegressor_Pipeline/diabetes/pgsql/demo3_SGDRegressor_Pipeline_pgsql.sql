...
-- Code For temporary table TMP_20221018185845_W5VEE5Y_ADS_imp_1_OUT part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221018185845_W5VEE5Y_ADS_imp_1_OUT" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20221018185845_W5VEE5Y_ADS_imp_1_OUT part 3. Create Index 

CREATE INDEX "ix_TMP_20221018185845_W5VEE5Y_ADS_imp_1_OUT_KEY" ON "TMP_20221018185845_W5VEE5Y_ADS_imp_1_OUT" ("KEY")

-- Code For temporary table TMP_20221018185845_V9ROF95_ADS_sca_2_OUT part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221018185845_V9ROF95_ADS_sca_2_OUT" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20221018185845_V9ROF95_ADS_sca_2_OUT part 2. Populate

INSERT INTO "TMP_20221018185845_V9ROF95_ADS_sca_2_OUT" ("KEY", scaler_output_2, scaler_output_3, scaler_output_4, scaler_output_5, scaler_output_6, scaler_output_7, scaler_output_8, scaler_output_9, scaler_output_10, scaler_output_11) SELECT "T"."KEY", "T".scaler_output_2, "T".scaler_output_3, "T".scaler_output_4, "T".scaler_output_5, "T".scaler_output_6, "T".scaler_output_7, "T".scaler_output_8, "T".scaler_output_9, "T".scaler_output_10, "T".scaler_output_11 
...
FROM "TMP_20221018185845_W5VEE5Y_ADS_imp_1_OUT" AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT") AS "T"

-- Code For temporary table TMP_20221018185845_V9ROF95_ADS_sca_2_OUT part 3. Create Index 

CREATE INDEX "ix_TMP_20221018185845_V9ROF95_ADS_sca_2_OUT_KEY" ON "TMP_20221018185845_V9ROF95_ADS_sca_2_OUT" ("KEY")
...
FROM "TMP_20221018185845_V9ROF95_ADS_sca_2_OUT" AS "ADS_sca_2_OUT"), 
linear_model_cte AS 
(SELECT linear_input."KEY" AS "KEY", -0.7357125381497789 * linear_input.scaler_output_2 + -10.88502593551576 * linear_input.scaler_output_3 + 24.325318814790613 * linear_input.scaler_output_4 + 14.888668965465065 * linear_input.scaler_output_5 + -3.0313075528194 * linear_input.scaler_output_6 + -5.148673195107464 * linear_input.scaler_output_7 + -11.814471619294332 * linear_input.scaler_output_8 + 3.2583070569583237 * linear_input.scaler_output_9 + 23.364551447113666 * linear_input.scaler_output_10 + 4.171368744695999 * linear_input.scaler_output_11 + 154.25374169379043 AS "Estimator" 
FROM linear_input)
