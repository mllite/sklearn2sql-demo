...
-- Code For temporary table TMP_20221018190134_96NXE8B_ADS_imp_1_OUT part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221018190134_96NXE8B_ADS_imp_1_OUT" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20221018190134_96NXE8B_ADS_imp_1_OUT part 3. Create Index 

CREATE INDEX "ix_TMP_20221018190134_96NXE8B_ADS_imp_1_OUT_KEY" ON "TMP_20221018190134_96NXE8B_ADS_imp_1_OUT" ("KEY")

-- Code For temporary table TMP_20221018190134_Y0OPJEO_ADS_sca_2_OUT part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221018190134_Y0OPJEO_ADS_sca_2_OUT" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20221018190134_Y0OPJEO_ADS_sca_2_OUT part 2. Populate

INSERT INTO "TMP_20221018190134_Y0OPJEO_ADS_sca_2_OUT" ("KEY", scaler_output_2, scaler_output_3, scaler_output_4, scaler_output_5, scaler_output_6, scaler_output_7, scaler_output_8, scaler_output_9, scaler_output_10, scaler_output_11) SELECT "T"."KEY", "T".scaler_output_2, "T".scaler_output_3, "T".scaler_output_4, "T".scaler_output_5, "T".scaler_output_6, "T".scaler_output_7, "T".scaler_output_8, "T".scaler_output_9, "T".scaler_output_10, "T".scaler_output_11 
...
FROM "TMP_20221018190134_96NXE8B_ADS_imp_1_OUT" AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT") AS "T"

-- Code For temporary table TMP_20221018190134_Y0OPJEO_ADS_sca_2_OUT part 3. Create Index 

CREATE INDEX "ix_TMP_20221018190134_Y0OPJEO_ADS_sca_2_OUT_KEY" ON "TMP_20221018190134_Y0OPJEO_ADS_sca_2_OUT" ("KEY")
...
FROM "TMP_20221018190134_Y0OPJEO_ADS_sca_2_OUT" AS "ADS_sca_2_OUT"), 
linear_model_cte AS 
(SELECT linear_input."KEY" AS "KEY", 1.3416093005209035 * linear_input.scaler_output_2 + 2.980031469668966 * linear_input.scaler_output_3 + -0.0630966225626179 * linear_input.scaler_output_4 + 2.66190901748273 * linear_input.scaler_output_5 + 1.5681628498153715 * linear_input.scaler_output_6 + -0.055656827804283035 * linear_input.scaler_output_7 + -0.11513222759485107 * linear_input.scaler_output_8 + 0.21842630598136417 * linear_input.scaler_output_9 + 0.011765288774465112 * linear_input.scaler_output_10 + -0.3202019920391579 * linear_input.scaler_output_11 + 15.325579820157202 AS "Estimator" 
FROM linear_input)
