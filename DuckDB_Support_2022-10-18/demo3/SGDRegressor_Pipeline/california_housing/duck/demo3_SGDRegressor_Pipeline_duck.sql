...
-- Code For temporary table TMP_20221018185645_7U4QXFB_ADS_imp_1_OUT part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221018185645_7U4QXFB_ADS_imp_1_OUT" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20221018185645_7U4QXFB_ADS_imp_1_OUT part 2. Populate

INSERT INTO "TMP_20221018185645_7U4QXFB_ADS_imp_1_OUT" ("KEY", imputer_output_2, imputer_output_3, imputer_output_4, imputer_output_5, imputer_output_6, imputer_output_7, imputer_output_8, imputer_output_9) SELECT "T"."KEY", "T".imputer_output_2, "T".imputer_output_3, "T".imputer_output_4, "T".imputer_output_5, "T".imputer_output_6, "T".imputer_output_7, "T".imputer_output_8, "T".imputer_output_9 
...
-- Code For temporary table TMP_20221018185645_7U4QXFB_ADS_imp_1_OUT part 3. Create Index 

CREATE INDEX "ix_TMP_20221018185645_7U4QXFB_ADS_imp_1_OUT_KEY" ON "TMP_20221018185645_7U4QXFB_ADS_imp_1_OUT" ("KEY")

-- Code For temporary table TMP_20221018185645_RVCTE34_ADS_sca_2_OUT part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221018185645_RVCTE34_ADS_sca_2_OUT" (
	"KEY" BIGINT NOT NULL, 
...
FROM "TMP_20221018185645_7U4QXFB_ADS_imp_1_OUT" AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT") AS "T"

-- Code For temporary table TMP_20221018185645_RVCTE34_ADS_sca_2_OUT part 3. Create Index 

CREATE INDEX "ix_TMP_20221018185645_RVCTE34_ADS_sca_2_OUT_KEY" ON "TMP_20221018185645_RVCTE34_ADS_sca_2_OUT" ("KEY")
...
FROM "TMP_20221018185645_RVCTE34_ADS_sca_2_OUT" AS "ADS_sca_2_OUT"), 
linear_model_cte AS 
