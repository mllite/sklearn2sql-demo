...
-- Code For temporary table TMP_20221018185520_F3O26KV_ADS_imp_1_OUT part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221018185520_F3O26KV_ADS_imp_1_OUT" (
	"KEY" BIGINT NOT NULL, 
	impter_2 DOUBLE, 
	impter_3 DOUBLE, 
	impter_4 DOUBLE, 
...
-- Code For temporary table TMP_20221018185520_F3O26KV_ADS_imp_1_OUT part 3. Create Index 

CREATE INDEX "ix_TMP_20221018185520_F3O26KV_ADS_imp_1_OUT_KEY" ON "TMP_20221018185520_F3O26KV_ADS_imp_1_OUT" ("KEY")

-- Code For temporary table TMP_20221018185520_Z8TFJQ5_ADS_sca_2_OUT part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221018185520_Z8TFJQ5_ADS_sca_2_OUT" (
	"KEY" BIGINT NOT NULL, 
	scaler_2 DOUBLE, 
	scaler_3 DOUBLE, 
	scaler_4 DOUBLE, 
...
FROM "TMP_20221018185520_F3O26KV_ADS_imp_1_OUT" AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT") AS "T"

-- Code For temporary table TMP_20221018185520_Z8TFJQ5_ADS_sca_2_OUT part 3. Create Index 

CREATE INDEX "ix_TMP_20221018185520_Z8TFJQ5_ADS_sca_2_OUT_KEY" ON "TMP_20221018185520_Z8TFJQ5_ADS_sca_2_OUT" ("KEY")

-- Code For temporary table TMP_20221018185520_X2RXJO7_LGBM_B0 part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221018185520_X2RXJO7_LGBM_B0" (
	"KEY" BIGINT, 
	"Estimator" DOUBLE
)
...
-- Code For temporary table TMP_20221018185520_X2RXJO7_LGBM_B0 part 2. Populate
...
FROM "TMP_20221018185520_Z8TFJQ5_ADS_sca_2_OUT" AS "ADS_sca_2_OUT"), 
"DT_node_data" AS 
...
FROM "DT_Output_9")
 INSERT INTO "TMP_20221018185520_X2RXJO7_LGBM_B0" ("KEY", "Estimator") SELECT "T"."KEY", "T"."Estimator" 
...
-- Code For temporary table TMP_20221018185520_OHPTP87_LGBM_B1 part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221018185520_OHPTP87_LGBM_B1" (
	"KEY" BIGINT, 
	"Estimator" DOUBLE
)
...
-- Code For temporary table TMP_20221018185520_OHPTP87_LGBM_B1 part 2. Populate
...
FROM "DT_Output_15")
 INSERT INTO "TMP_20221018185520_OHPTP87_LGBM_B1" ("KEY", "Estimator") SELECT "T"."KEY", "T"."Estimator" 
...
-- Code For temporary table TMP_20221018185520_KBIDZTZ_LGBM_sum part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221018185520_KBIDZTZ_LGBM_sum" (
	"KEY" BIGINT NOT NULL, 
	"Estimator" DOUBLE, 
	PRIMARY KEY ("KEY")
)
...
-- Code For temporary table TMP_20221018185520_KBIDZTZ_LGBM_sum part 2. Populate

WITH "LGBM_Union" AS 
(SELECT "LGBM_EnsembleUnion"."KEY" AS "KEY", "LGBM_EnsembleUnion"."Estimator" AS "Estimator" 
FROM (SELECT "LGBM_B0"."KEY" AS "KEY", "LGBM_B0"."Estimator" AS "Estimator" 
FROM "TMP_20221018185520_X2RXJO7_LGBM_B0" AS "LGBM_B0" UNION ALL SELECT "LGBM_B1"."KEY" AS "KEY", "LGBM_B1"."Estimator" AS "Estimator" 
FROM "TMP_20221018185520_OHPTP87_LGBM_B1" AS "LGBM_B1") AS "LGBM_EnsembleUnion")
 INSERT INTO "TMP_20221018185520_KBIDZTZ_LGBM_sum" ("KEY", "Estimator") SELECT "T"."KEY", "T"."Estimator" 
...
-- Code For temporary table TMP_20221018185520_KBIDZTZ_LGBM_sum part 3. Create Index 

CREATE INDEX "ix_TMP_20221018185520_KBIDZTZ_LGBM_sum_KEY" ON "TMP_20221018185520_KBIDZTZ_LGBM_sum" ("KEY")

-- Model deployment code

SELECT "LGBM_sum"."KEY" AS "KEY", "LGBM_sum"."Estimator" AS "Estimator" 
FROM "TMP_20221018185520_KBIDZTZ_LGBM_sum" AS "LGBM_sum"