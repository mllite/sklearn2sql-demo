...
-- Code For temporary table TMP_20221018190215_5Q67NPK_ADS_imp_1_OUT part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221018190215_5Q67NPK_ADS_imp_1_OUT" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20221018190215_5Q67NPK_ADS_imp_1_OUT part 2. Populate

INSERT INTO "TMP_20221018190215_5Q67NPK_ADS_imp_1_OUT" ("KEY", imputer_output_2, imputer_output_3, imputer_output_4, imputer_output_5) SELECT "T"."KEY", "T".imputer_output_2, "T".imputer_output_3, "T".imputer_output_4, "T".imputer_output_5 
...
-- Code For temporary table TMP_20221018190215_5Q67NPK_ADS_imp_1_OUT part 3. Create Index 

CREATE INDEX "ix_TMP_20221018190215_5Q67NPK_ADS_imp_1_OUT_KEY" ON "TMP_20221018190215_5Q67NPK_ADS_imp_1_OUT" ("KEY")

-- Code For temporary table TMP_20221018190215_1VFJI21_ADS_sca_2_OUT part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221018190215_1VFJI21_ADS_sca_2_OUT" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20221018190215_1VFJI21_ADS_sca_2_OUT part 2. Populate

INSERT INTO "TMP_20221018190215_1VFJI21_ADS_sca_2_OUT" ("KEY", scaler_output_2, scaler_output_3, scaler_output_4, scaler_output_5) SELECT "T"."KEY", "T".scaler_output_2, "T".scaler_output_3, "T".scaler_output_4, "T".scaler_output_5 
...
FROM "TMP_20221018190215_5Q67NPK_ADS_imp_1_OUT" AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT") AS "T"

-- Code For temporary table TMP_20221018190215_1VFJI21_ADS_sca_2_OUT part 3. Create Index 

CREATE INDEX "ix_TMP_20221018190215_1VFJI21_ADS_sca_2_OUT_KEY" ON "TMP_20221018190215_1VFJI21_ADS_sca_2_OUT" ("KEY")

-- Code For temporary table TMP_20221018190215_1VOVDP0_LGBM_B0 part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221018190215_1VOVDP0_LGBM_B0" (
	"KEY" BIGINT, 
	"Estimator" FLOAT
)
...
-- Code For temporary table TMP_20221018190215_1VOVDP0_LGBM_B0 part 2. Populate
...
FROM "TMP_20221018190215_1VFJI21_ADS_sca_2_OUT" AS "ADS_sca_2_OUT"), 
"DT_node_data" AS 
...
FROM "DT_Output_9")
 INSERT INTO "TMP_20221018190215_1VOVDP0_LGBM_B0" ("KEY", "Estimator") SELECT "T"."KEY", "T"."Estimator" 
...
-- Code For temporary table TMP_20221018190215_R1Y39NJ_LGBM_B1 part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221018190215_R1Y39NJ_LGBM_B1" (
	"KEY" BIGINT, 
	"Estimator" FLOAT
)
...
-- Code For temporary table TMP_20221018190215_R1Y39NJ_LGBM_B1 part 2. Populate
...
FROM "DT_Output_15")
 INSERT INTO "TMP_20221018190215_R1Y39NJ_LGBM_B1" ("KEY", "Estimator") SELECT "T"."KEY", "T"."Estimator" 
...
-- Code For temporary table TMP_20221018190215_GOOGWGI_LGBM_sum part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221018190215_GOOGWGI_LGBM_sum" (
	"KEY" BIGINT NOT NULL, 
	"Estimator" FLOAT, 
	PRIMARY KEY ("KEY")
)
...
-- Code For temporary table TMP_20221018190215_GOOGWGI_LGBM_sum part 2. Populate

WITH "LGBM_Union" AS 
(SELECT "LGBM_EnsembleUnion"."KEY" AS "KEY", "LGBM_EnsembleUnion"."Estimator" AS "Estimator" 
FROM (SELECT "LGBM_B0"."KEY" AS "KEY", "LGBM_B0"."Estimator" AS "Estimator" 
FROM "TMP_20221018190215_1VOVDP0_LGBM_B0" AS "LGBM_B0" UNION ALL SELECT "LGBM_B1"."KEY" AS "KEY", "LGBM_B1"."Estimator" AS "Estimator" 
FROM "TMP_20221018190215_R1Y39NJ_LGBM_B1" AS "LGBM_B1") AS "LGBM_EnsembleUnion")
 INSERT INTO "TMP_20221018190215_GOOGWGI_LGBM_sum" ("KEY", "Estimator") SELECT "T"."KEY", "T"."Estimator" 
...
-- Code For temporary table TMP_20221018190215_GOOGWGI_LGBM_sum part 3. Create Index 

CREATE INDEX "ix_TMP_20221018190215_GOOGWGI_LGBM_sum_KEY" ON "TMP_20221018190215_GOOGWGI_LGBM_sum" ("KEY")

-- Model deployment code

SELECT "LGBM_sum"."KEY" AS "KEY", "LGBM_sum"."Estimator" AS "Estimator" 
FROM "TMP_20221018190215_GOOGWGI_LGBM_sum" AS "LGBM_sum"