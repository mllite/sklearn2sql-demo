...
-- Code For temporary table TMP_20221018190119_MEAYX5L_ADS_imp_1_OUT part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221018190119_MEAYX5L_ADS_imp_1_OUT" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20221018190119_MEAYX5L_ADS_imp_1_OUT part 3. Create Index 

CREATE INDEX "ix_TMP_20221018190119_MEAYX5L_ADS_imp_1_OUT_KEY" ON "TMP_20221018190119_MEAYX5L_ADS_imp_1_OUT" ("KEY")

-- Code For temporary table TMP_20221018190119_MSQYV48_ADS_sca_2_OUT part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221018190119_MSQYV48_ADS_sca_2_OUT" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20221018190119_MSQYV48_ADS_sca_2_OUT part 2. Populate

INSERT INTO "TMP_20221018190119_MSQYV48_ADS_sca_2_OUT" ("KEY", scaler_output_2, scaler_output_3, scaler_output_4, scaler_output_5, scaler_output_6, scaler_output_7, scaler_output_8, scaler_output_9, scaler_output_10, scaler_output_11) SELECT "T"."KEY", "T".scaler_output_2, "T".scaler_output_3, "T".scaler_output_4, "T".scaler_output_5, "T".scaler_output_6, "T".scaler_output_7, "T".scaler_output_8, "T".scaler_output_9, "T".scaler_output_10, "T".scaler_output_11 
...
FROM "TMP_20221018190119_MEAYX5L_ADS_imp_1_OUT" AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT") AS "T"

-- Code For temporary table TMP_20221018190119_MSQYV48_ADS_sca_2_OUT part 3. Create Index 

CREATE INDEX "ix_TMP_20221018190119_MSQYV48_ADS_sca_2_OUT_KEY" ON "TMP_20221018190119_MSQYV48_ADS_sca_2_OUT" ("KEY")

-- Code For temporary table TMP_20221018190119_L2AGHWL_LGBM_B0 part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221018190119_L2AGHWL_LGBM_B0" (
	"KEY" BIGINT, 
	"Estimator" DOUBLE
)
...
-- Code For temporary table TMP_20221018190119_L2AGHWL_LGBM_B0 part 2. Populate

WITH "DT_node_lookup" AS 
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", CASE WHEN ("ADS_sca_2_OUT".scaler_output_3 <= -0.03575253068147678) THEN 2 ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_output_5 <= 0.16343214314230212) THEN 6 ELSE 7 END END AS node_id_2 
FROM "TMP_20221018190119_MSQYV48_ADS_sca_2_OUT" AS "ADS_sca_2_OUT"), 
"DT_node_data" AS 
...
FROM "DT_Output_4"), 
"DT_node_lookup_5" AS 
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", CASE WHEN ("ADS_sca_2_OUT".scaler_output_5 <= -0.1199268106081446) THEN 2 ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_output_3 <= -0.03575253068147678) THEN 6 ELSE 7 END END AS node_id_2 
FROM "TMP_20221018190119_MSQYV48_ADS_sca_2_OUT" AS "ADS_sca_2_OUT"), 
"DT_node_data_5" AS 
(SELECT "Values".nid AS nid, "Values"."Estimator" AS "Estimator" 
...
FROM "DT_Output_6"), 
"DT_node_lookup_7" AS 
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", CASE WHEN ("ADS_sca_2_OUT".scaler_output_3 <= -0.03575253068147678) THEN 2 ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_output_2 <= 0.1625431860749545) THEN 6 ELSE 7 END END AS node_id_2 
FROM "TMP_20221018190119_MSQYV48_ADS_sca_2_OUT" AS "ADS_sca_2_OUT"), 
"DT_node_data_7" AS 
(SELECT "Values".nid AS nid, "Values"."Estimator" AS "Estimator" 
...
FROM "DT_Output_7"), 
"DT_node_lookup_8" AS 
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", CASE WHEN ("ADS_sca_2_OUT".scaler_output_5 <= -0.22762641972664058) THEN 2 ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_output_3 <= -0.2825087793419189) THEN 6 ELSE 7 END END AS node_id_2 
FROM "TMP_20221018190119_MSQYV48_ADS_sca_2_OUT" AS "ADS_sca_2_OUT"), 
"DT_node_data_8" AS 
(SELECT "Values".nid AS nid, "Values"."Estimator" AS "Estimator" 
...
FROM "DT_Output_8"), 
"DT_node_lookup_9" AS 
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", CASE WHEN ("ADS_sca_2_OUT".scaler_output_3 <= -0.7175518802310756) THEN 2 ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_output_2 <= -0.49655221054287896) THEN 6 ELSE 7 END END AS node_id_2 
FROM "TMP_20221018190119_MSQYV48_ADS_sca_2_OUT" AS "ADS_sca_2_OUT"), 
"DT_node_data_9" AS 
(SELECT "Values".nid AS nid, "Values"."Estimator" AS "Estimator" 
...
FROM "DT_Output_9")
 INSERT INTO "TMP_20221018190119_L2AGHWL_LGBM_B0" ("KEY", "Estimator") SELECT "T"."KEY", "T"."Estimator" 
...
-- Code For temporary table TMP_20221018190119_1XIZVDW_LGBM_B1 part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221018190119_1XIZVDW_LGBM_B1" (
	"KEY" BIGINT, 
	"Estimator" DOUBLE
)
...
-- Code For temporary table TMP_20221018190119_1XIZVDW_LGBM_B1 part 2. Populate
...
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", CASE WHEN ("ADS_sca_2_OUT".scaler_output_3 <= -0.8115141080331363) THEN 2 ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_output_2 <= -0.49655221054287896) THEN 6 ELSE 7 END END AS node_id_2 
FROM "TMP_20221018190119_MSQYV48_ADS_sca_2_OUT" AS "ADS_sca_2_OUT"), 
"DT_node_data_14" AS 
(SELECT "Values".nid AS nid, "Values"."Estimator" AS "Estimator" 
...
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", CASE WHEN ("ADS_sca_2_OUT".scaler_output_6 <= 0.5856121580016488) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_output_3 <= -0.2825087793419189) THEN 4 ELSE 5 END ELSE 3 END AS node_id_2 
FROM "TMP_20221018190119_MSQYV48_ADS_sca_2_OUT" AS "ADS_sca_2_OUT"), 
"DT_node_data_15" AS 
(SELECT "Values".nid AS nid, "Values"."Estimator" AS "Estimator" 
...
FROM "DT_Output_15")
 INSERT INTO "TMP_20221018190119_1XIZVDW_LGBM_B1" ("KEY", "Estimator") SELECT "T"."KEY", "T"."Estimator" 
...
-- Code For temporary table TMP_20221018190119_8LSVP1G_LGBM_sum part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221018190119_8LSVP1G_LGBM_sum" (
	"KEY" BIGINT NOT NULL, 
	"Estimator" DOUBLE, 
	PRIMARY KEY ("KEY")
)
...
-- Code For temporary table TMP_20221018190119_8LSVP1G_LGBM_sum part 2. Populate

WITH "LGBM_Union" AS 
(SELECT "LGBM_EnsembleUnion"."KEY" AS "KEY", "LGBM_EnsembleUnion"."Estimator" AS "Estimator" 
FROM (SELECT "LGBM_B0"."KEY" AS "KEY", "LGBM_B0"."Estimator" AS "Estimator" 
FROM "TMP_20221018190119_L2AGHWL_LGBM_B0" AS "LGBM_B0" UNION ALL SELECT "LGBM_B1"."KEY" AS "KEY", "LGBM_B1"."Estimator" AS "Estimator" 
FROM "TMP_20221018190119_1XIZVDW_LGBM_B1" AS "LGBM_B1") AS "LGBM_EnsembleUnion")
 INSERT INTO "TMP_20221018190119_8LSVP1G_LGBM_sum" ("KEY", "Estimator") SELECT "T"."KEY", "T"."Estimator" 
...
-- Code For temporary table TMP_20221018190119_8LSVP1G_LGBM_sum part 3. Create Index 

CREATE INDEX "ix_TMP_20221018190119_8LSVP1G_LGBM_sum_KEY" ON "TMP_20221018190119_8LSVP1G_LGBM_sum" ("KEY")

-- Model deployment code

SELECT "LGBM_sum"."KEY" AS "KEY", "LGBM_sum"."Estimator" AS "Estimator" 
FROM "TMP_20221018190119_8LSVP1G_LGBM_sum" AS "LGBM_sum"