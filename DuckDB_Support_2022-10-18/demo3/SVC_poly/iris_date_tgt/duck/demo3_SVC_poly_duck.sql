...
-- Code For temporary table TMP_20221018190601_DAQF7WC_KernAgg_B0 part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221018190601_DAQF7WC_KernAgg_B0" (
	"KEY" BIGINT, 
...
-- Code For temporary table TMP_20221018190601_DAQF7WC_KernAgg_B0 part 2. Populate
...
-- Code For temporary table TMP_20221018190601_JC7DTTD_KernAgg_B1 part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221018190601_JC7DTTD_KernAgg_B1" (
	"KEY" BIGINT, 
	"OVO_Class1" VARCHAR COLLATE "utf8", 
	"OVO_Class2" VARCHAR COLLATE "utf8", 
	"OVO_Decision" BIGINT, 
...
-- Code For temporary table TMP_20221018190601_JC7DTTD_KernAgg_B1 part 2. Populate
...
FROM (SELECT full_join_data_sv_1."KEY" AS "KEY", sum(CAST(full_join_data_sv_1.dot_prod1 AS DOUBLE)) + 1.1836485013121598 AS dot_product 
FROM (SELECT kernel_input."KEY" AS "KEY", "SV_data_1789-07-14T00:00:00.000000000_1789-09-14T00:00:00.000000000".dual_coeff * power(0.06541912694449836 * (kernel_input."Feature_0" * "SV_data_1789-07-14T00:00:00.000000000_1789-09-14T00:00:00.000000000".sv_0 + kernel_input."Feature_1" * "SV_data_1789-07-14T00:00:00.000000000_1789-09-14T00:00:00.000000000".sv_1 + kernel_input."Feature_2" * "SV_data_1789-07-14T00:00:00.000000000_1789-09-14T00:00:00.000000000".sv_2 + kernel_input."Feature_3" * "SV_data_1789-07-14T00:00:00.000000000_1789-09-14T00:00:00.000000000".sv_3) + 0.0, 3) AS dot_prod1 
...
(SELECT "kernel_dp_1789-07-14T00:00:00.000000000_1789-09-14T00:00:00.000000000"."KEY" AS "KEY", '1789-07-14T00:00:00.000000000' AS "OVO_Class1", '1789-09-14T00:00:00.000000000' AS "OVO_Class2", CASE WHEN (-"kernel_dp_1789-07-14T00:00:00.000000000_1789-09-14T00:00:00.000000000".dot_product >= 0.0) THEN 1 ELSE 0 END AS "OVO_Decision", coalesce(-"kernel_dp_1789-07-14T00:00:00.000000000_1789-09-14T00:00:00.000000000".dot_product, 1.0 / (1.0 + exp(least(100.0, greatest(-100.0, -(-((-"kernel_dp_1789-07-14T00:00:00.000000000_1789-09-14T00:00:00.000000000".dot_product) * -1.9507655732507698 + -0.8273683250050299))))))) AS "OVO_Conf" 
FROM "kernel_dp_1789-07-14T00:00:00.000000000_1789-09-14T00:00:00.000000000")
 INSERT INTO "TMP_20221018190601_JC7DTTD_KernAgg_B1" ("KEY", "OVO_Class1", "OVO_Class2", "OVO_Decision", "OVO_Conf") SELECT "T"."KEY", "T"."OVO_Class1", "T"."OVO_Class2", "T"."OVO_Decision", "T"."OVO_Conf" 
...
-- Code For temporary table TMP_20221018190601_UUTIN04_KernAgg_B2 part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221018190601_UUTIN04_KernAgg_B2" (
	"KEY" BIGINT, 
	"OVO_Class1" VARCHAR COLLATE "utf8", 
	"OVO_Class2" VARCHAR COLLATE "utf8", 
	"OVO_Decision" BIGINT, 
...
-- Code For temporary table TMP_20221018190601_UUTIN04_KernAgg_B2 part 2. Populate
...
-- Code For temporary table TMP_20221018190601_P8O1DA4_KernAgg_agg part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221018190601_P8O1DA4_KernAgg_agg" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20221018190601_P8O1DA4_KernAgg_agg part 2. Populate
...
FROM (SELECT "KernAgg_B0"."KEY" AS "KEY", "KernAgg_B0"."OVO_Class1" AS "OVO_Class1", "KernAgg_B0"."OVO_Class2" AS "OVO_Class2", "KernAgg_B0"."OVO_Decision" AS "OVO_Decision", "KernAgg_B0"."OVO_Conf" AS "OVO_Conf" 
FROM "TMP_20221018190601_DAQF7WC_KernAgg_B0" AS "KernAgg_B0" UNION ALL SELECT "KernAgg_B1"."KEY" AS "KEY", "KernAgg_B1"."OVO_Class1" AS "OVO_Class1", "KernAgg_B1"."OVO_Class2" AS "OVO_Class2", "KernAgg_B1"."OVO_Decision" AS "OVO_Decision", "KernAgg_B1"."OVO_Conf" AS "OVO_Conf" 
FROM "TMP_20221018190601_JC7DTTD_KernAgg_B1" AS "KernAgg_B1" UNION ALL SELECT "KernAgg_B2"."KEY" AS "KEY", "KernAgg_B2"."OVO_Class1" AS "OVO_Class1", "KernAgg_B2"."OVO_Class2" AS "OVO_Class2", "KernAgg_B2"."OVO_Decision" AS "OVO_Decision", "KernAgg_B2"."OVO_Conf" AS "OVO_Conf" 
FROM "TMP_20221018190601_UUTIN04_KernAgg_B2" AS "KernAgg_B2") AS "KernAgg_EnsembleUnion"), 
"OVO_Votes" AS 
...
-- Code For temporary table TMP_20221018190601_P8O1DA4_KernAgg_agg part 3. Create Index 

CREATE INDEX "ix_TMP_20221018190601_P8O1DA4_KernAgg_agg_KEY" ON "TMP_20221018190601_P8O1DA4_KernAgg_agg" ("KEY")
...
FROM "TMP_20221018190601_P8O1DA4_KernAgg_agg" AS "KernAgg_agg"), 
