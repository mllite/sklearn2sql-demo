...
-- Code For temporary table TMP_20221018185029_BL2ON41_ADS_imp_1_OUT part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221018185029_BL2ON41_ADS_imp_1_OUT" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20221018185029_BL2ON41_ADS_imp_1_OUT part 3. Create Index 

CREATE INDEX "ix_TMP_20221018185029_BL2ON41_ADS_imp_1_OUT_KEY" ON "TMP_20221018185029_BL2ON41_ADS_imp_1_OUT" ("KEY")

-- Code For temporary table TMP_20221018185029_X8X8QTN_ADS_sca_2_OUT part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221018185029_X8X8QTN_ADS_sca_2_OUT" (
	"KEY" BIGINT NOT NULL, 
...
FROM "TMP_20221018185029_BL2ON41_ADS_imp_1_OUT" AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT") AS "T"

-- Code For temporary table TMP_20221018185029_X8X8QTN_ADS_sca_2_OUT part 3. Create Index 

CREATE INDEX "ix_TMP_20221018185029_X8X8QTN_ADS_sca_2_OUT_KEY" ON "TMP_20221018185029_X8X8QTN_ADS_sca_2_OUT" ("KEY")

-- Code For temporary table TMP_20221018185029_2BHX5P1_CalProb_B0 part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221018185029_2BHX5P1_CalProb_B0" (
	"KEY" BIGINT, 
	"Proba_1" FLOAT, 
	"Proba_0" FLOAT
)
...
-- Code For temporary table TMP_20221018185029_2BHX5P1_CalProb_B0 part 2. Populate
...
FROM "TMP_20221018185029_X8X8QTN_ADS_sca_2_OUT" AS "ADS_sca_2_OUT"), 
"DT_node_data" AS 
...
(SELECT "Calibrated_Model_0"."KEY" AS "KEY", 1.0 / (1.0 + exp(min(100.0, max(-100.0, -(5.756413424714994 * "Calibrated_Model_0"."ScoreOrProba_1" + -2.5569469411985817))))) AS "Proba_1", 1.0 - 1.0 / (1.0 + exp(min(100.0, max(-100.0, -(5.756413424714994 * "Calibrated_Model_0"."ScoreOrProba_1" + -2.5569469411985817))))) AS "Proba_0" 
...
(SELECT "Calibrated_Model_1"."KEY" AS "KEY", 1.0 / (1.0 + exp(min(100.0, max(-100.0, -(4.6995923736239025 * "Calibrated_Model_1"."ScoreOrProba_1" + -1.924211076199023))))) AS "Proba_1", 1.0 - 1.0 / (1.0 + exp(min(100.0, max(-100.0, -(4.6995923736239025 * "Calibrated_Model_1"."ScoreOrProba_1" + -1.924211076199023))))) AS "Proba_0" 
...
(SELECT "Calibrated_Model_2"."KEY" AS "KEY", 1.0 / (1.0 + exp(min(100.0, max(-100.0, -(5.460676238424655 * "Calibrated_Model_2"."ScoreOrProba_1" + -2.2609055007805776))))) AS "Proba_1", 1.0 - 1.0 / (1.0 + exp(min(100.0, max(-100.0, -(5.460676238424655 * "Calibrated_Model_2"."ScoreOrProba_1" + -2.2609055007805776))))) AS "Proba_0" 
...
(SELECT "Calibrated_Model_3"."KEY" AS "KEY", 1.0 / (1.0 + exp(min(100.0, max(-100.0, -(4.949259195511299 * "Calibrated_Model_3"."ScoreOrProba_1" + -2.032195223156085))))) AS "Proba_1", 1.0 - 1.0 / (1.0 + exp(min(100.0, max(-100.0, -(4.949259195511299 * "Calibrated_Model_3"."ScoreOrProba_1" + -2.032195223156085))))) AS "Proba_0" 
...
FROM sigmoid_calibration_3)
 INSERT INTO "TMP_20221018185029_2BHX5P1_CalProb_B0" ("KEY", "Proba_1", "Proba_0") SELECT "T"."KEY", "T"."Proba_1", "T"."Proba_0" 
...
-- Code For temporary table TMP_20221018185029_4OZY2HS_CalProb_avg part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221018185029_4OZY2HS_CalProb_avg" (
	"KEY" BIGINT NOT NULL, 
	"Proba_1" FLOAT, 
	"Proba_0" FLOAT, 
	PRIMARY KEY ("KEY")
...
-- Code For temporary table TMP_20221018185029_4OZY2HS_CalProb_avg part 2. Populate
...
FROM (SELECT "CalProb_B0"."KEY" AS "KEY", "CalProb_B0"."Proba_1" AS "Proba_1", "CalProb_B0"."Proba_0" AS "Proba_0" 
FROM "TMP_20221018185029_2BHX5P1_CalProb_B0" AS "CalProb_B0") AS "CalProb_EnsembleUnion")
 INSERT INTO "TMP_20221018185029_4OZY2HS_CalProb_avg" ("KEY", "Proba_1", "Proba_0") SELECT "T"."KEY", "T"."Proba_1", "T"."Proba_0" 
...
-- Code For temporary table TMP_20221018185029_4OZY2HS_CalProb_avg part 3. Create Index 

CREATE INDEX "ix_TMP_20221018185029_4OZY2HS_CalProb_avg_KEY" ON "TMP_20221018185029_4OZY2HS_CalProb_avg" ("KEY")
...
FROM "TMP_20221018185029_4OZY2HS_CalProb_avg" AS "CalProb_avg"), 
