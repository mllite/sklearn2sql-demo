...
-- Code For temporary table TMP_20221018185249_48YX1PU_ADS_imp_1_OUT part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221018185249_48YX1PU_ADS_imp_1_OUT" (
	"KEY" BIGINT NOT NULL, 
	impter_2 FLOAT, 
	impter_3 FLOAT, 
	impter_4 FLOAT, 
...
-- Code For temporary table TMP_20221018185249_48YX1PU_ADS_imp_1_OUT part 3. Create Index 

CREATE INDEX "ix_TMP_20221018185249_48YX1PU_ADS_imp_1_OUT_KEY" ON "TMP_20221018185249_48YX1PU_ADS_imp_1_OUT" ("KEY")

-- Code For temporary table TMP_20221018185249_VUQPIHS_ADS_sca_2_OUT part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221018185249_VUQPIHS_ADS_sca_2_OUT" (
	"KEY" BIGINT NOT NULL, 
	scaler_2 FLOAT, 
	scaler_3 FLOAT, 
	scaler_4 FLOAT, 
...
FROM "TMP_20221018185249_48YX1PU_ADS_imp_1_OUT" AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT") AS "T"

-- Code For temporary table TMP_20221018185249_VUQPIHS_ADS_sca_2_OUT part 3. Create Index 

CREATE INDEX "ix_TMP_20221018185249_VUQPIHS_ADS_sca_2_OUT_KEY" ON "TMP_20221018185249_VUQPIHS_ADS_sca_2_OUT" ("KEY")

-- Code For temporary table TMP_20221018185249_1UKSWR5_CalProb_B0 part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221018185249_1UKSWR5_CalProb_B0" (
	"KEY" BIGINT, 
	"Proba_0" FLOAT, 
	"Proba_1" FLOAT, 
	"Proba_2" FLOAT, 
...
-- Code For temporary table TMP_20221018185249_1UKSWR5_CalProb_B0 part 2. Populate
...
FROM "TMP_20221018185249_VUQPIHS_ADS_sca_2_OUT" AS "ADS_sca_2_OUT"), 
"DT_node_data" AS 
...
(SELECT "Calibrated_Model_0"."KEY" AS "KEY", 1.0 / (1.0 + exp(min(100.0, max(-100.0, -(1.9395465355057186 * "Calibrated_Model_0"."ScoreOrProba_0" + -2.1266105321292637))))) AS "Proba_0", 1.0 / (1.0 + exp(min(100.0, max(-100.0, -(0.26124948174976903 * "Calibrated_Model_0"."ScoreOrProba_1" + -1.1036317177643802))))) AS "Proba_1", 1.0 / (1.0 + exp(min(100.0, max(-100.0, -(0.3116833400900793 * "Calibrated_Model_0"."ScoreOrProba_2" + -1.1188021580330423))))) AS "Proba_2", 1.0 / (1.0 + exp(min(100.0, max(-100.0, -(-0.5855111745559716 * "Calibrated_Model_0"."ScoreOrProba_3" + -0.9333602816585206))))) AS "Proba_3" 
...
(SELECT "Calibrated_Model_1"."KEY" AS "KEY", 1.0 / (1.0 + exp(min(100.0, max(-100.0, -(0.10926645689346644 * "Calibrated_Model_1"."ScoreOrProba_0" + -1.1002893368841236))))) AS "Proba_0", 1.0 / (1.0 + exp(min(100.0, max(-100.0, -(-1.0706294459488888 * "Calibrated_Model_1"."ScoreOrProba_1" + -0.7308876249255225))))) AS "Proba_1", 1.0 / (1.0 + exp(min(100.0, max(-100.0, -(2.098780064670375 * "Calibrated_Model_1"."ScoreOrProba_2" + -1.57299882848771))))) AS "Proba_2", 1.0 / (1.0 + exp(min(100.0, max(-100.0, -(1.7476984876046096 * "Calibrated_Model_1"."ScoreOrProba_3" + -1.3422344482435236))))) AS "Proba_3" 
...
(SELECT "Calibrated_Model_2"."KEY" AS "KEY", 1.0 / (1.0 + exp(min(100.0, max(-100.0, -(1.8312432920321235 * "Calibrated_Model_2"."ScoreOrProba_0" + -1.7788482545196076))))) AS "Proba_0", 1.0 / (1.0 + exp(min(100.0, max(-100.0, -(-1.3851760597179557 * "Calibrated_Model_2"."ScoreOrProba_1" + -0.8899331084448222))))) AS "Proba_1", 1.0 / (1.0 + exp(min(100.0, max(-100.0, -(3.2774205264550336 * "Calibrated_Model_2"."ScoreOrProba_2" + -2.2444049551885428))))) AS "Proba_2", 1.0 / (1.0 + exp(min(100.0, max(-100.0, -(1.8336891500571022 * "Calibrated_Model_2"."ScoreOrProba_3" + -1.700425756822711))))) AS "Proba_3" 
...
(SELECT "Calibrated_Model_3"."KEY" AS "KEY", 1.0 / (1.0 + exp(min(100.0, max(-100.0, -(2.6086410508531657 * "Calibrated_Model_3"."ScoreOrProba_0" + -2.1924853023037167))))) AS "Proba_0", 1.0 / (1.0 + exp(min(100.0, max(-100.0, -(-0.6192518512092107 * "Calibrated_Model_3"."ScoreOrProba_1" + -0.7236684208291104))))) AS "Proba_1", 1.0 / (1.0 + exp(min(100.0, max(-100.0, -(-0.05070288610282485 * "Calibrated_Model_3"."ScoreOrProba_2" + -1.2770947175756642))))) AS "Proba_2", 1.0 / (1.0 + exp(min(100.0, max(-100.0, -(0.6352466062688696 * "Calibrated_Model_3"."ScoreOrProba_3" + -1.2267816163128933))))) AS "Proba_3" 
...
FROM sigmoid_calibration_3)
 INSERT INTO "TMP_20221018185249_1UKSWR5_CalProb_B0" ("KEY", "Proba_0", "Proba_1", "Proba_2", "Proba_3") SELECT "T"."KEY", "T"."Proba_0", "T"."Proba_1", "T"."Proba_2", "T"."Proba_3" 
...
-- Code For temporary table TMP_20221018185249_2HSAPTC_CalProb_avg part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221018185249_2HSAPTC_CalProb_avg" (
	"KEY" BIGINT NOT NULL, 
	"Proba_0" FLOAT, 
	"Proba_1" FLOAT, 
	"Proba_2" FLOAT, 
...
-- Code For temporary table TMP_20221018185249_2HSAPTC_CalProb_avg part 2. Populate
...
FROM (SELECT "CalProb_B0"."KEY" AS "KEY", "CalProb_B0"."Proba_0" AS "Proba_0", "CalProb_B0"."Proba_1" AS "Proba_1", "CalProb_B0"."Proba_2" AS "Proba_2", "CalProb_B0"."Proba_3" AS "Proba_3" 
FROM "TMP_20221018185249_1UKSWR5_CalProb_B0" AS "CalProb_B0") AS "CalProb_EnsembleUnion")
 INSERT INTO "TMP_20221018185249_2HSAPTC_CalProb_avg" ("KEY", "Proba_0", "Proba_1", "Proba_2", "Proba_3") SELECT "T"."KEY", "T"."Proba_0", "T"."Proba_1", "T"."Proba_2", "T"."Proba_3" 
...
-- Code For temporary table TMP_20221018185249_2HSAPTC_CalProb_avg part 3. Create Index 

CREATE INDEX "ix_TMP_20221018185249_2HSAPTC_CalProb_avg_KEY" ON "TMP_20221018185249_2HSAPTC_CalProb_avg" ("KEY")
...
FROM "TMP_20221018185249_2HSAPTC_CalProb_avg" AS "CalProb_avg"), 
