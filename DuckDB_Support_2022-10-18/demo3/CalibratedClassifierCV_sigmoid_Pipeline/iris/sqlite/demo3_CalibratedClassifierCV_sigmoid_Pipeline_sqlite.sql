...
-- Code For temporary table TMP_20221018190355_M38X56W_ADS_imp_1_OUT part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221018190355_M38X56W_ADS_imp_1_OUT" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20221018190355_M38X56W_ADS_imp_1_OUT part 2. Populate

INSERT INTO "TMP_20221018190355_M38X56W_ADS_imp_1_OUT" ("KEY", imputer_output_2, imputer_output_3, imputer_output_4, imputer_output_5) SELECT "T"."KEY", "T".imputer_output_2, "T".imputer_output_3, "T".imputer_output_4, "T".imputer_output_5 
...
-- Code For temporary table TMP_20221018190355_M38X56W_ADS_imp_1_OUT part 3. Create Index 

CREATE INDEX "ix_TMP_20221018190355_M38X56W_ADS_imp_1_OUT_KEY" ON "TMP_20221018190355_M38X56W_ADS_imp_1_OUT" ("KEY")

-- Code For temporary table TMP_20221018190355_Y1M7FQ9_ADS_sca_2_OUT part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221018190355_Y1M7FQ9_ADS_sca_2_OUT" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20221018190355_Y1M7FQ9_ADS_sca_2_OUT part 2. Populate

INSERT INTO "TMP_20221018190355_Y1M7FQ9_ADS_sca_2_OUT" ("KEY", scaler_output_2, scaler_output_3, scaler_output_4, scaler_output_5) SELECT "T"."KEY", "T".scaler_output_2, "T".scaler_output_3, "T".scaler_output_4, "T".scaler_output_5 
...
FROM "TMP_20221018190355_M38X56W_ADS_imp_1_OUT" AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT") AS "T"

-- Code For temporary table TMP_20221018190355_Y1M7FQ9_ADS_sca_2_OUT part 3. Create Index 

CREATE INDEX "ix_TMP_20221018190355_Y1M7FQ9_ADS_sca_2_OUT_KEY" ON "TMP_20221018190355_Y1M7FQ9_ADS_sca_2_OUT" ("KEY")

-- Code For temporary table TMP_20221018190355_ETZPPFX_CalProb_B0 part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221018190355_ETZPPFX_CalProb_B0" (
	"KEY" BIGINT, 
	"Proba_0" FLOAT, 
	"Proba_1" FLOAT, 
	"Proba_2" FLOAT
...
-- Code For temporary table TMP_20221018190355_ETZPPFX_CalProb_B0 part 2. Populate
...
FROM "TMP_20221018190355_Y1M7FQ9_ADS_sca_2_OUT" AS "ADS_sca_2_OUT"), 
"DT_node_data" AS 
...
(SELECT "Calibrated_Model_0"."KEY" AS "KEY", 1.0 / (1.0 + exp(min(100.0, max(-100.0, -(5.393626322122635 * "Calibrated_Model_0"."ScoreOrProba_0" + -3.091045517303994))))) AS "Proba_0", 1.0 / (1.0 + exp(min(100.0, max(-100.0, -(4.671313939641343 * "Calibrated_Model_0"."ScoreOrProba_1" + -2.9060595363277137))))) AS "Proba_1", 1.0 / (1.0 + exp(min(100.0, max(-100.0, -(4.750559975206732 * "Calibrated_Model_0"."ScoreOrProba_2" + -2.3829244862170724))))) AS "Proba_2" 
...
(SELECT "Calibrated_Model_1"."KEY" AS "KEY", 1.0 / (1.0 + exp(min(100.0, max(-100.0, -(5.393626322122635 * "Calibrated_Model_1"."ScoreOrProba_0" + -3.091045517303994))))) AS "Proba_0", 1.0 / (1.0 + exp(min(100.0, max(-100.0, -(5.442417342523718 * "Calibrated_Model_1"."ScoreOrProba_1" + -3.0445224878196573))))) AS "Proba_1", 1.0 / (1.0 + exp(min(100.0, max(-100.0, -(5.48063825977776 * "Calibrated_Model_1"."ScoreOrProba_2" + -2.995732594243071))))) AS "Proba_2" 
...
(SELECT "Calibrated_Model_2"."KEY" AS "KEY", 1.0 / (1.0 + exp(min(100.0, max(-100.0, -(5.393626322122635 * "Calibrated_Model_2"."ScoreOrProba_0" + -3.091045517303994))))) AS "Proba_0", 1.0 / (1.0 + exp(min(100.0, max(-100.0, -(4.346958263204307 * "Calibrated_Model_2"."ScoreOrProba_1" + -1.9490625020164078))))) AS "Proba_1", 1.0 / (1.0 + exp(min(100.0, max(-100.0, -(4.3109878254872465 * "Calibrated_Model_2"."ScoreOrProba_2" + -2.995735836256492))))) AS "Proba_2" 
...
(SELECT "Calibrated_Model_3"."KEY" AS "KEY", 1.0 / (1.0 + exp(min(100.0, max(-100.0, -(5.442417342523718 * "Calibrated_Model_3"."ScoreOrProba_0" + -3.0445224878196573))))) AS "Proba_0", 1.0 / (1.0 + exp(min(100.0, max(-100.0, -(4.346958263204307 * "Calibrated_Model_3"."ScoreOrProba_1" + -1.9490625020164078))))) AS "Proba_1", 1.0 / (1.0 + exp(min(100.0, max(-100.0, -(4.261122708431462 * "Calibrated_Model_3"."ScoreOrProba_2" + -3.0445238393052825))))) AS "Proba_2" 
...
FROM sigmoid_calibration_3)
 INSERT INTO "TMP_20221018190355_ETZPPFX_CalProb_B0" ("KEY", "Proba_0", "Proba_1", "Proba_2") SELECT "T"."KEY", "T"."Proba_0", "T"."Proba_1", "T"."Proba_2" 
...
-- Code For temporary table TMP_20221018190355_VUUFTNH_CalProb_avg part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221018190355_VUUFTNH_CalProb_avg" (
	"KEY" BIGINT NOT NULL, 
	"Proba_0" FLOAT, 
	"Proba_1" FLOAT, 
	"Proba_2" FLOAT, 
...
-- Code For temporary table TMP_20221018190355_VUUFTNH_CalProb_avg part 2. Populate
...
FROM (SELECT "CalProb_B0"."KEY" AS "KEY", "CalProb_B0"."Proba_0" AS "Proba_0", "CalProb_B0"."Proba_1" AS "Proba_1", "CalProb_B0"."Proba_2" AS "Proba_2" 
FROM "TMP_20221018190355_ETZPPFX_CalProb_B0" AS "CalProb_B0") AS "CalProb_EnsembleUnion")
 INSERT INTO "TMP_20221018190355_VUUFTNH_CalProb_avg" ("KEY", "Proba_0", "Proba_1", "Proba_2") SELECT "T"."KEY", "T"."Proba_0", "T"."Proba_1", "T"."Proba_2" 
...
-- Code For temporary table TMP_20221018190355_VUUFTNH_CalProb_avg part 3. Create Index 

CREATE INDEX "ix_TMP_20221018190355_VUUFTNH_CalProb_avg_KEY" ON "TMP_20221018190355_VUUFTNH_CalProb_avg" ("KEY")
...
FROM "TMP_20221018190355_VUUFTNH_CalProb_avg" AS "CalProb_avg"), 
