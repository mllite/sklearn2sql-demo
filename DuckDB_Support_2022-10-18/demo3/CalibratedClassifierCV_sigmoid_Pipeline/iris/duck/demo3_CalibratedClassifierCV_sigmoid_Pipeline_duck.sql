...
-- Code For temporary table TMP_20221018190355_EDU2SPG_ADS_imp_1_OUT part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221018190355_EDU2SPG_ADS_imp_1_OUT" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20221018190355_EDU2SPG_ADS_imp_1_OUT part 2. Populate

INSERT INTO "TMP_20221018190355_EDU2SPG_ADS_imp_1_OUT" ("KEY", imputer_output_2, imputer_output_3, imputer_output_4, imputer_output_5) SELECT "T"."KEY", "T".imputer_output_2, "T".imputer_output_3, "T".imputer_output_4, "T".imputer_output_5 
...
-- Code For temporary table TMP_20221018190355_EDU2SPG_ADS_imp_1_OUT part 3. Create Index 

CREATE INDEX "ix_TMP_20221018190355_EDU2SPG_ADS_imp_1_OUT_KEY" ON "TMP_20221018190355_EDU2SPG_ADS_imp_1_OUT" ("KEY")

-- Code For temporary table TMP_20221018190355_7W2H82U_ADS_sca_2_OUT part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221018190355_7W2H82U_ADS_sca_2_OUT" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20221018190355_7W2H82U_ADS_sca_2_OUT part 2. Populate

INSERT INTO "TMP_20221018190355_7W2H82U_ADS_sca_2_OUT" ("KEY", scaler_output_2, scaler_output_3, scaler_output_4, scaler_output_5) SELECT "T"."KEY", "T".scaler_output_2, "T".scaler_output_3, "T".scaler_output_4, "T".scaler_output_5 
...
FROM "TMP_20221018190355_EDU2SPG_ADS_imp_1_OUT" AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT") AS "T"

-- Code For temporary table TMP_20221018190355_7W2H82U_ADS_sca_2_OUT part 3. Create Index 

CREATE INDEX "ix_TMP_20221018190355_7W2H82U_ADS_sca_2_OUT_KEY" ON "TMP_20221018190355_7W2H82U_ADS_sca_2_OUT" ("KEY")

-- Code For temporary table TMP_20221018190355_5C7IPEQ_CalProb_B0 part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221018190355_5C7IPEQ_CalProb_B0" (
	"KEY" BIGINT, 
	"Proba_0" DOUBLE, 
	"Proba_1" DOUBLE, 
	"Proba_2" DOUBLE
...
-- Code For temporary table TMP_20221018190355_5C7IPEQ_CalProb_B0 part 2. Populate

WITH "DT_node_lookup" AS 
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", CASE WHEN ("ADS_sca_2_OUT".scaler_output_5 <= -0.6622998267412186) THEN 1 ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_output_4 <= 0.5294224619865417) THEN 3 ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_output_4 <= 0.7047601938247681) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_output_3 <= 0.020870234817266464) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_output_5 <= 0.6734309196472168) THEN 7 ELSE 8 END ELSE 9 END ELSE 10 END END END AS node_id_2 
FROM "TMP_20221018190355_7W2H82U_ADS_sca_2_OUT" AS "ADS_sca_2_OUT"), 
"DT_node_data" AS 
...
(SELECT "DT_Output"."KEY" AS "KEY", CAST(NULL AS DOUBLE) AS "Score_0", CAST(NULL AS DOUBLE) AS "Score_1", CAST(NULL AS DOUBLE) AS "Score_2", "DT_Output"."P_0" AS "Proba_0", "DT_Output"."P_1" AS "Proba_1", "DT_Output"."P_2" AS "Proba_2", CASE WHEN ("DT_Output"."P_0" IS NULL OR "DT_Output"."P_0" > 0.0) THEN ln("DT_Output"."P_0") ELSE '-Infinity'::float8 END AS "LogProba_0", CASE WHEN ("DT_Output"."P_1" IS NULL OR "DT_Output"."P_1" > 0.0) THEN ln("DT_Output"."P_1") ELSE '-Infinity'::float8 END AS "LogProba_1", CASE WHEN ("DT_Output"."P_2" IS NULL OR "DT_Output"."P_2" > 0.0) THEN ln("DT_Output"."P_2") ELSE '-Infinity'::float8 END AS "LogProba_2", CAST(NULL AS BIGINT) AS "Decision", CAST(NULL AS DOUBLE) AS "DecisionProba", coalesce(CAST(NULL AS DOUBLE), "DT_Output"."P_0") AS "ScoreOrProba_0", coalesce(CAST(NULL AS DOUBLE), "DT_Output"."P_1") AS "ScoreOrProba_1", coalesce(CAST(NULL AS DOUBLE), "DT_Output"."P_2") AS "ScoreOrProba_2" 
FROM "DT_Output"), 
sigmoid_calibration_0 AS 
(SELECT "Calibrated_Model_0"."KEY" AS "KEY", 1.0 / (1.0 + exp(least(100.0, greatest(-100.0, -(5.393626322122635 * "Calibrated_Model_0"."ScoreOrProba_0" + -3.091045517303994))))) AS "Proba_0", 1.0 / (1.0 + exp(least(100.0, greatest(-100.0, -(4.671313939641343 * "Calibrated_Model_0"."ScoreOrProba_1" + -2.9060595363277137))))) AS "Proba_1", 1.0 / (1.0 + exp(least(100.0, greatest(-100.0, -(4.750559975206732 * "Calibrated_Model_0"."ScoreOrProba_2" + -2.3829244862170724))))) AS "Proba_2" 
...
(SELECT "DT_Output_1"."KEY" AS "KEY", CAST(NULL AS DOUBLE) AS "Score_0", CAST(NULL AS DOUBLE) AS "Score_1", CAST(NULL AS DOUBLE) AS "Score_2", "DT_Output_1"."P_0" AS "Proba_0", "DT_Output_1"."P_1" AS "Proba_1", "DT_Output_1"."P_2" AS "Proba_2", CASE WHEN ("DT_Output_1"."P_0" IS NULL OR "DT_Output_1"."P_0" > 0.0) THEN ln("DT_Output_1"."P_0") ELSE '-Infinity'::float8 END AS "LogProba_0", CASE WHEN ("DT_Output_1"."P_1" IS NULL OR "DT_Output_1"."P_1" > 0.0) THEN ln("DT_Output_1"."P_1") ELSE '-Infinity'::float8 END AS "LogProba_1", CASE WHEN ("DT_Output_1"."P_2" IS NULL OR "DT_Output_1"."P_2" > 0.0) THEN ln("DT_Output_1"."P_2") ELSE '-Infinity'::float8 END AS "LogProba_2", CAST(NULL AS BIGINT) AS "Decision", CAST(NULL AS DOUBLE) AS "DecisionProba", coalesce(CAST(NULL AS DOUBLE), "DT_Output_1"."P_0") AS "ScoreOrProba_0", coalesce(CAST(NULL AS DOUBLE), "DT_Output_1"."P_1") AS "ScoreOrProba_1", coalesce(CAST(NULL AS DOUBLE), "DT_Output_1"."P_2") AS "ScoreOrProba_2" 
FROM "DT_Output_1"), 
sigmoid_calibration_1 AS 
(SELECT "Calibrated_Model_1"."KEY" AS "KEY", 1.0 / (1.0 + exp(least(100.0, greatest(-100.0, -(5.393626322122635 * "Calibrated_Model_1"."ScoreOrProba_0" + -3.091045517303994))))) AS "Proba_0", 1.0 / (1.0 + exp(least(100.0, greatest(-100.0, -(5.442417342523718 * "Calibrated_Model_1"."ScoreOrProba_1" + -3.0445224878196573))))) AS "Proba_1", 1.0 / (1.0 + exp(least(100.0, greatest(-100.0, -(5.48063825977776 * "Calibrated_Model_1"."ScoreOrProba_2" + -2.995732594243071))))) AS "Proba_2" 
...
FROM sigmoid_calibration_3)
 INSERT INTO "TMP_20221018190355_5C7IPEQ_CalProb_B0" ("KEY", "Proba_0", "Proba_1", "Proba_2") SELECT "T"."KEY", "T"."Proba_0", "T"."Proba_1", "T"."Proba_2" 
...
-- Code For temporary table TMP_20221018190355_DMR7I7A_CalProb_avg part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221018190355_DMR7I7A_CalProb_avg" (
	"KEY" BIGINT NOT NULL, 
	"Proba_0" DOUBLE, 
	"Proba_1" DOUBLE, 
	"Proba_2" DOUBLE, 
...
-- Code For temporary table TMP_20221018190355_DMR7I7A_CalProb_avg part 2. Populate
...
FROM (SELECT "CalProb_B0"."KEY" AS "KEY", "CalProb_B0"."Proba_0" AS "Proba_0", "CalProb_B0"."Proba_1" AS "Proba_1", "CalProb_B0"."Proba_2" AS "Proba_2" 
FROM "TMP_20221018190355_5C7IPEQ_CalProb_B0" AS "CalProb_B0") AS "CalProb_EnsembleUnion")
 INSERT INTO "TMP_20221018190355_DMR7I7A_CalProb_avg" ("KEY", "Proba_0", "Proba_1", "Proba_2") SELECT "T"."KEY", "T"."Proba_0", "T"."Proba_1", "T"."Proba_2" 
FROM (SELECT "CalProb_avg"."KEY" AS "KEY", "CalProb_avg"."Proba_0" AS "Proba_0", "CalProb_avg"."Proba_1" AS "Proba_1", "CalProb_avg"."Proba_2" AS "Proba_2" 
...
-- Code For temporary table TMP_20221018190355_DMR7I7A_CalProb_avg part 3. Create Index 

CREATE INDEX "ix_TMP_20221018190355_DMR7I7A_CalProb_avg_KEY" ON "TMP_20221018190355_DMR7I7A_CalProb_avg" ("KEY")
...
FROM "TMP_20221018190355_DMR7I7A_CalProb_avg" AS "CalProb_avg"), 
