...
-- Code For temporary table TMP_20221018184759_L90H6Y7_BAG_B0 part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221018184759_L90H6Y7_BAG_B0" (
	"KEY" BIGINT, 
	"Score_0" DOUBLE, 
	"Proba_0" DOUBLE, 
	"LogProba_0" DOUBLE, 
...
-- Code For temporary table TMP_20221018184759_L90H6Y7_BAG_B0 part 2. Populate
...
FROM "DT_Output_9")
 INSERT INTO "TMP_20221018184759_L90H6Y7_BAG_B0" ("KEY", "Score_0", "Proba_0", "LogProba_0", "Score_1", "Proba_1", "LogProba_1") SELECT "T"."KEY", "T"."Score_0", "T"."Proba_0", "T"."LogProba_0", "T"."Score_1", "T"."Proba_1", "T"."LogProba_1" 
...
-- Code For temporary table TMP_20221018184759_7F5OXI4_BAG_B1 part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221018184759_7F5OXI4_BAG_B1" (
	"KEY" BIGINT, 
	"Score_0" DOUBLE, 
	"Proba_0" DOUBLE, 
	"LogProba_0" DOUBLE, 
...
-- Code For temporary table TMP_20221018184759_7F5OXI4_BAG_B1 part 2. Populate
...
FROM "DT_Output_15")
 INSERT INTO "TMP_20221018184759_7F5OXI4_BAG_B1" ("KEY", "Score_0", "Proba_0", "LogProba_0", "Score_1", "Proba_1", "LogProba_1") SELECT "T"."KEY", "T"."Score_0", "T"."Proba_0", "T"."LogProba_0", "T"."Score_1", "T"."Proba_1", "T"."LogProba_1" 
...
-- Code For temporary table TMP_20221018184759_DE23HVJ_BAG_avg part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221018184759_DE23HVJ_BAG_avg" (
	"KEY" BIGINT NOT NULL, 
	"Score_0" DOUBLE, 
	"Proba_0" DOUBLE, 
	"LogProba_0" DOUBLE, 
...
-- Code For temporary table TMP_20221018184759_DE23HVJ_BAG_avg part 2. Populate
...
FROM (SELECT "BAG_B0"."KEY" AS "KEY", "BAG_B0"."Score_0" AS "Score_0", "BAG_B0"."Proba_0" AS "Proba_0", "BAG_B0"."LogProba_0" AS "LogProba_0", "BAG_B0"."Score_1" AS "Score_1", "BAG_B0"."Proba_1" AS "Proba_1", "BAG_B0"."LogProba_1" AS "LogProba_1" 
FROM "TMP_20221018184759_L90H6Y7_BAG_B0" AS "BAG_B0" UNION ALL SELECT "BAG_B1"."KEY" AS "KEY", "BAG_B1"."Score_0" AS "Score_0", "BAG_B1"."Proba_0" AS "Proba_0", "BAG_B1"."LogProba_0" AS "LogProba_0", "BAG_B1"."Score_1" AS "Score_1", "BAG_B1"."Proba_1" AS "Proba_1", "BAG_B1"."LogProba_1" AS "LogProba_1" 
FROM "TMP_20221018184759_7F5OXI4_BAG_B1" AS "BAG_B1") AS "BAG_EnsembleUnion")
 INSERT INTO "TMP_20221018184759_DE23HVJ_BAG_avg" ("KEY", "Score_0", "Proba_0", "LogProba_0", "Score_1", "Proba_1", "LogProba_1") SELECT "T"."KEY", "T"."Score_0", "T"."Proba_0", "T"."LogProba_0", "T"."Score_1", "T"."Proba_1", "T"."LogProba_1" 
...
-- Code For temporary table TMP_20221018184759_DE23HVJ_BAG_avg part 3. Create Index 

CREATE INDEX "ix_TMP_20221018184759_DE23HVJ_BAG_avg_KEY" ON "TMP_20221018184759_DE23HVJ_BAG_avg" ("KEY")
...
FROM "TMP_20221018184759_DE23HVJ_BAG_avg" AS "BAG_avg"), 
