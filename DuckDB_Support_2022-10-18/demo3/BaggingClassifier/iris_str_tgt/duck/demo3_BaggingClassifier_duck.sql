...
-- Code For temporary table TMP_20221018190610_ALDGT23_BAG_B0 part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221018190610_ALDGT23_BAG_B0" (
	"KEY" BIGINT, 
...
-- Code For temporary table TMP_20221018190610_ALDGT23_BAG_B0 part 2. Populate
...
-- Code For temporary table TMP_20221018190610_VRLZPBD_BAG_B1 part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221018190610_VRLZPBD_BAG_B1" (
	"KEY" BIGINT, 
	"Score_CLASS_0" DOUBLE, 
	"Proba_CLASS_0" DOUBLE, 
	"LogProba_CLASS_0" DOUBLE, 
...
-- Code For temporary table TMP_20221018190610_VRLZPBD_BAG_B1 part 2. Populate
...
FROM "DT_Output_15")
 INSERT INTO "TMP_20221018190610_VRLZPBD_BAG_B1" ("KEY", "Score_CLASS_0", "Proba_CLASS_0", "LogProba_CLASS_0", "Score_CLASS_1", "Proba_CLASS_1", "LogProba_CLASS_1", "Score_CLASS_2", "Proba_CLASS_2", "LogProba_CLASS_2") SELECT "T"."KEY", "T"."Score_CLASS_0", "T"."Proba_CLASS_0", "T"."LogProba_CLASS_0", "T"."Score_CLASS_1", "T"."Proba_CLASS_1", "T"."LogProba_CLASS_1", "T"."Score_CLASS_2", "T"."Proba_CLASS_2", "T"."LogProba_CLASS_2" 
...
-- Code For temporary table TMP_20221018190610_K9NT1VP_BAG_avg part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221018190610_K9NT1VP_BAG_avg" (
	"KEY" BIGINT NOT NULL, 
	"Score_CLASS_0" DOUBLE, 
	"Proba_CLASS_0" DOUBLE, 
	"LogProba_CLASS_0" DOUBLE, 
...
-- Code For temporary table TMP_20221018190610_K9NT1VP_BAG_avg part 2. Populate
...
FROM (SELECT "BAG_B0"."KEY" AS "KEY", "BAG_B0"."Score_CLASS_0" AS "Score_CLASS_0", "BAG_B0"."Proba_CLASS_0" AS "Proba_CLASS_0", "BAG_B0"."LogProba_CLASS_0" AS "LogProba_CLASS_0", "BAG_B0"."Score_CLASS_1" AS "Score_CLASS_1", "BAG_B0"."Proba_CLASS_1" AS "Proba_CLASS_1", "BAG_B0"."LogProba_CLASS_1" AS "LogProba_CLASS_1", "BAG_B0"."Score_CLASS_2" AS "Score_CLASS_2", "BAG_B0"."Proba_CLASS_2" AS "Proba_CLASS_2", "BAG_B0"."LogProba_CLASS_2" AS "LogProba_CLASS_2" 
FROM "TMP_20221018190610_ALDGT23_BAG_B0" AS "BAG_B0" UNION ALL SELECT "BAG_B1"."KEY" AS "KEY", "BAG_B1"."Score_CLASS_0" AS "Score_CLASS_0", "BAG_B1"."Proba_CLASS_0" AS "Proba_CLASS_0", "BAG_B1"."LogProba_CLASS_0" AS "LogProba_CLASS_0", "BAG_B1"."Score_CLASS_1" AS "Score_CLASS_1", "BAG_B1"."Proba_CLASS_1" AS "Proba_CLASS_1", "BAG_B1"."LogProba_CLASS_1" AS "LogProba_CLASS_1", "BAG_B1"."Score_CLASS_2" AS "Score_CLASS_2", "BAG_B1"."Proba_CLASS_2" AS "Proba_CLASS_2", "BAG_B1"."LogProba_CLASS_2" AS "LogProba_CLASS_2" 
FROM "TMP_20221018190610_VRLZPBD_BAG_B1" AS "BAG_B1") AS "BAG_EnsembleUnion")
 INSERT INTO "TMP_20221018190610_K9NT1VP_BAG_avg" ("KEY", "Score_CLASS_0", "Proba_CLASS_0", "LogProba_CLASS_0", "Score_CLASS_1", "Proba_CLASS_1", "LogProba_CLASS_1", "Score_CLASS_2", "Proba_CLASS_2", "LogProba_CLASS_2") SELECT "T"."KEY", "T"."Score_CLASS_0", "T"."Proba_CLASS_0", "T"."LogProba_CLASS_0", "T"."Score_CLASS_1", "T"."Proba_CLASS_1", "T"."LogProba_CLASS_1", "T"."Score_CLASS_2", "T"."Proba_CLASS_2", "T"."LogProba_CLASS_2" 
...
-- Code For temporary table TMP_20221018190610_K9NT1VP_BAG_avg part 3. Create Index 

CREATE INDEX "ix_TMP_20221018190610_K9NT1VP_BAG_avg_KEY" ON "TMP_20221018190610_K9NT1VP_BAG_avg" ("KEY")
...
FROM "TMP_20221018190610_K9NT1VP_BAG_avg" AS "BAG_avg"), 
