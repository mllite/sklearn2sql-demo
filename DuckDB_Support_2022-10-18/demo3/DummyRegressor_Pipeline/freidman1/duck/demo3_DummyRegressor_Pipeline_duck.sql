...
-- Code For temporary table TMP_20221018190113_SB1M1PC_ADS_imp_1_OUT part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221018190113_SB1M1PC_ADS_imp_1_OUT" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20221018190113_SB1M1PC_ADS_imp_1_OUT part 3. Create Index 

CREATE INDEX "ix_TMP_20221018190113_SB1M1PC_ADS_imp_1_OUT_KEY" ON "TMP_20221018190113_SB1M1PC_ADS_imp_1_OUT" ("KEY")

-- Code For temporary table TMP_20221018190113_3G67NS1_ADS_sca_2_OUT part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221018190113_3G67NS1_ADS_sca_2_OUT" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20221018190113_3G67NS1_ADS_sca_2_OUT part 2. Populate

INSERT INTO "TMP_20221018190113_3G67NS1_ADS_sca_2_OUT" ("KEY", scaler_output_2, scaler_output_3, scaler_output_4, scaler_output_5, scaler_output_6, scaler_output_7, scaler_output_8, scaler_output_9, scaler_output_10, scaler_output_11) SELECT "T"."KEY", "T".scaler_output_2, "T".scaler_output_3, "T".scaler_output_4, "T".scaler_output_5, "T".scaler_output_6, "T".scaler_output_7, "T".scaler_output_8, "T".scaler_output_9, "T".scaler_output_10, "T".scaler_output_11 
...
FROM "TMP_20221018190113_SB1M1PC_ADS_imp_1_OUT" AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT") AS "T"

-- Code For temporary table TMP_20221018190113_3G67NS1_ADS_sca_2_OUT part 3. Create Index 

CREATE INDEX "ix_TMP_20221018190113_3G67NS1_ADS_sca_2_OUT_KEY" ON "TMP_20221018190113_3G67NS1_ADS_sca_2_OUT" ("KEY")

-- Model deployment code

WITH dummy_class_reg_cte AS 
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", 15.3537633818605 AS "Constant" 
FROM "TMP_20221018190113_3G67NS1_ADS_sca_2_OUT" AS "ADS_sca_2_OUT")
