...
-- Code For temporary table TMP_20221018190113_4IC8ZVH_ADS_imp_1_OUT part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221018190113_4IC8ZVH_ADS_imp_1_OUT" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20221018190113_4IC8ZVH_ADS_imp_1_OUT part 3. Create Index 

CREATE INDEX "ix_TMP_20221018190113_4IC8ZVH_ADS_imp_1_OUT_KEY" ON "TMP_20221018190113_4IC8ZVH_ADS_imp_1_OUT" ("KEY")

-- Code For temporary table TMP_20221018190113_PUDS27U_ADS_sca_2_OUT part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221018190113_PUDS27U_ADS_sca_2_OUT" (
	"KEY" BIGINT NOT NULL, 
...
FROM "TMP_20221018190113_4IC8ZVH_ADS_imp_1_OUT" AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT") AS "T"

-- Code For temporary table TMP_20221018190113_PUDS27U_ADS_sca_2_OUT part 3. Create Index 

CREATE INDEX "ix_TMP_20221018190113_PUDS27U_ADS_sca_2_OUT_KEY" ON "TMP_20221018190113_PUDS27U_ADS_sca_2_OUT" ("KEY")

-- Model deployment code

WITH dummy_class_reg_cte AS 
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", 15.3537633818605 AS "Constant" 
FROM "TMP_20221018190113_PUDS27U_ADS_sca_2_OUT" AS "ADS_sca_2_OUT")
