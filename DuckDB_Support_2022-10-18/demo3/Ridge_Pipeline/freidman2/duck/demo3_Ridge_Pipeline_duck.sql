...
-- Code For temporary table TMP_20221018190227_WOO41LR_ADS_imp_1_OUT part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221018190227_WOO41LR_ADS_imp_1_OUT" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20221018190227_WOO41LR_ADS_imp_1_OUT part 2. Populate

INSERT INTO "TMP_20221018190227_WOO41LR_ADS_imp_1_OUT" ("KEY", imputer_output_2, imputer_output_3, imputer_output_4, imputer_output_5) SELECT "T"."KEY", "T".imputer_output_2, "T".imputer_output_3, "T".imputer_output_4, "T".imputer_output_5 
...
-- Code For temporary table TMP_20221018190227_WOO41LR_ADS_imp_1_OUT part 3. Create Index 

CREATE INDEX "ix_TMP_20221018190227_WOO41LR_ADS_imp_1_OUT_KEY" ON "TMP_20221018190227_WOO41LR_ADS_imp_1_OUT" ("KEY")

-- Code For temporary table TMP_20221018190227_D0F3HC8_ADS_sca_2_OUT part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221018190227_D0F3HC8_ADS_sca_2_OUT" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20221018190227_D0F3HC8_ADS_sca_2_OUT part 2. Populate

INSERT INTO "TMP_20221018190227_D0F3HC8_ADS_sca_2_OUT" ("KEY", scaler_output_2, scaler_output_3, scaler_output_4, scaler_output_5) SELECT "T"."KEY", "T".scaler_output_2, "T".scaler_output_3, "T".scaler_output_4, "T".scaler_output_5 
...
FROM "TMP_20221018190227_WOO41LR_ADS_imp_1_OUT" AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT") AS "T"

-- Code For temporary table TMP_20221018190227_D0F3HC8_ADS_sca_2_OUT part 3. Create Index 

CREATE INDEX "ix_TMP_20221018190227_D0F3HC8_ADS_sca_2_OUT_KEY" ON "TMP_20221018190227_D0F3HC8_ADS_sca_2_OUT" ("KEY")
...
FROM "TMP_20221018190227_D0F3HC8_ADS_sca_2_OUT" AS "ADS_sca_2_OUT"), 
linear_model_cte AS 
