...
-- Code For temporary table TMP_20221018185839_Q6JFKKP_ADS_imp_1_OUT part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221018185839_Q6JFKKP_ADS_imp_1_OUT" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20221018185839_Q6JFKKP_ADS_imp_1_OUT part 3. Create Index 

CREATE INDEX "ix_TMP_20221018185839_Q6JFKKP_ADS_imp_1_OUT_KEY" ON "TMP_20221018185839_Q6JFKKP_ADS_imp_1_OUT" ("KEY")

-- Code For temporary table TMP_20221018185839_0V1S38D_ADS_sca_2_OUT part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221018185839_0V1S38D_ADS_sca_2_OUT" (
	"KEY" BIGINT NOT NULL, 
...
FROM "TMP_20221018185839_Q6JFKKP_ADS_imp_1_OUT" AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT") AS "T"

-- Code For temporary table TMP_20221018185839_0V1S38D_ADS_sca_2_OUT part 3. Create Index 

CREATE INDEX "ix_TMP_20221018185839_0V1S38D_ADS_sca_2_OUT_KEY" ON "TMP_20221018185839_0V1S38D_ADS_sca_2_OUT" ("KEY")
...
FROM "TMP_20221018185839_0V1S38D_ADS_sca_2_OUT" AS "ADS_sca_2_OUT"), 
linear_model_cte AS 
