...
-- Code For temporary table TMP_20221018185435_2R9Y3FH_ADS_imp_1_OUT part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221018185435_2R9Y3FH_ADS_imp_1_OUT" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20221018185435_2R9Y3FH_ADS_imp_1_OUT part 3. Create Index 

CREATE INDEX "ix_TMP_20221018185435_2R9Y3FH_ADS_imp_1_OUT_KEY" ON "TMP_20221018185435_2R9Y3FH_ADS_imp_1_OUT" ("KEY")

-- Code For temporary table TMP_20221018185435_627H6MI_ADS_sca_2_OUT part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221018185435_627H6MI_ADS_sca_2_OUT" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20221018185435_627H6MI_ADS_sca_2_OUT part 2. Populate

INSERT INTO "TMP_20221018185435_627H6MI_ADS_sca_2_OUT" ("KEY", scaler_output_2, scaler_output_3, scaler_output_4, scaler_output_5, scaler_output_6, scaler_output_7, scaler_output_8, scaler_output_9, scaler_output_10, scaler_output_11) SELECT "T"."KEY", "T".scaler_output_2, "T".scaler_output_3, "T".scaler_output_4, "T".scaler_output_5, "T".scaler_output_6, "T".scaler_output_7, "T".scaler_output_8, "T".scaler_output_9, "T".scaler_output_10, "T".scaler_output_11 
...
FROM "TMP_20221018185435_2R9Y3FH_ADS_imp_1_OUT" AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT") AS "T"

-- Code For temporary table TMP_20221018185435_627H6MI_ADS_sca_2_OUT part 3. Create Index 

CREATE INDEX "ix_TMP_20221018185435_627H6MI_ADS_sca_2_OUT_KEY" ON "TMP_20221018185435_627H6MI_ADS_sca_2_OUT" ("KEY")
...
FROM "TMP_20221018185435_627H6MI_ADS_sca_2_OUT" AS "ADS_sca_2_OUT"), 
linear_model_cte AS 
(SELECT linear_input."KEY" AS "KEY", 34.93629964239755 * linear_input.scaler_output_2 + 73.71003738769787 * linear_input.scaler_output_3 + 87.30118845385824 * linear_input.scaler_output_4 + 37.2003535662938 * linear_input.scaler_output_5 + 56.82441624467638 * linear_input.scaler_output_6 + 78.45109933480482 * linear_input.scaler_output_7 + 37.884334274023054 * linear_input.scaler_output_8 + 39.106491966994035 * linear_input.scaler_output_9 + 92.64892488769324 * linear_input.scaler_output_10 + 52.57456364033038 * linear_input.scaler_output_11 + 26.405852730652413 AS "Estimator" 
FROM linear_input)
