...
-- Code For temporary table TMP_20221018190124_C77EQ9H_HL_1_relu_1 part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221018190124_C77EQ9H_HL_1_relu_1" (
	"KEY" BIGINT NOT NULL, 
	"NEUR_1_1" DOUBLE, 
	"NEUR_1_2" DOUBLE, 
	"NEUR_1_3" DOUBLE, 
...
-- Code For temporary table TMP_20221018190124_C77EQ9H_HL_1_relu_1 part 2. Populate
...
FROM "HL_BA_1")
 INSERT INTO "TMP_20221018190124_C77EQ9H_HL_1_relu_1" ("KEY", "NEUR_1_1", "NEUR_1_2", "NEUR_1_3") SELECT "T"."KEY", "T"."NEUR_1_1", "T"."NEUR_1_2", "T"."NEUR_1_3" 
...
-- Code For temporary table TMP_20221018190124_C77EQ9H_HL_1_relu_1 part 3. Create Index 

CREATE INDEX "ix_TMP_20221018190124_C77EQ9H_HL_1_relu_1_KEY" ON "TMP_20221018190124_C77EQ9H_HL_1_relu_1" ("KEY")

-- Code For temporary table TMP_20221018190124_UEKEEV8_OL_identity_1 part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221018190124_UEKEEV8_OL_identity_1" (
	"KEY" BIGINT NOT NULL, 
	"NEUR_3_1" DOUBLE, 
	PRIMARY KEY ("KEY")
)
...
-- Code For temporary table TMP_20221018190124_UEKEEV8_OL_identity_1 part 2. Populate
...
FROM "TMP_20221018190124_C77EQ9H_HL_1_relu_1" AS "HL_1_relu_1"), 
"HL_2_relu" AS 
...
FROM "OL_BA")
 INSERT INTO "TMP_20221018190124_UEKEEV8_OL_identity_1" ("KEY", "NEUR_3_1") SELECT "T"."KEY", "T"."NEUR_3_1" 
...
-- Code For temporary table TMP_20221018190124_UEKEEV8_OL_identity_1 part 3. Create Index 

CREATE INDEX "ix_TMP_20221018190124_UEKEEV8_OL_identity_1_KEY" ON "TMP_20221018190124_UEKEEV8_OL_identity_1" ("KEY")

-- Model deployment code

SELECT "OL_identity_1"."KEY" AS "KEY", "OL_identity_1"."NEUR_3_1" AS "Estimator" 
FROM "TMP_20221018190124_UEKEEV8_OL_identity_1" AS "OL_identity_1"