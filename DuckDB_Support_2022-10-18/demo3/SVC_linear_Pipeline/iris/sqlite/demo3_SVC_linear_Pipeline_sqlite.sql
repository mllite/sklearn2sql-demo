...
-- Code For temporary table TMP_20221018190449_6BIT38R_ADS_imp_1_OUT part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221018190449_6BIT38R_ADS_imp_1_OUT" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20221018190449_6BIT38R_ADS_imp_1_OUT part 2. Populate

INSERT INTO "TMP_20221018190449_6BIT38R_ADS_imp_1_OUT" ("KEY", imputer_output_2, imputer_output_3, imputer_output_4, imputer_output_5) SELECT "T"."KEY", "T".imputer_output_2, "T".imputer_output_3, "T".imputer_output_4, "T".imputer_output_5 
...
-- Code For temporary table TMP_20221018190449_6BIT38R_ADS_imp_1_OUT part 3. Create Index 

CREATE INDEX "ix_TMP_20221018190449_6BIT38R_ADS_imp_1_OUT_KEY" ON "TMP_20221018190449_6BIT38R_ADS_imp_1_OUT" ("KEY")

-- Code For temporary table TMP_20221018190449_1QAXDVI_ADS_sca_2_OUT part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221018190449_1QAXDVI_ADS_sca_2_OUT" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20221018190449_1QAXDVI_ADS_sca_2_OUT part 2. Populate

INSERT INTO "TMP_20221018190449_1QAXDVI_ADS_sca_2_OUT" ("KEY", scaler_output_2, scaler_output_3, scaler_output_4, scaler_output_5) SELECT "T"."KEY", "T".scaler_output_2, "T".scaler_output_3, "T".scaler_output_4, "T".scaler_output_5 
...
FROM "TMP_20221018190449_6BIT38R_ADS_imp_1_OUT" AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT") AS "T"

-- Code For temporary table TMP_20221018190449_1QAXDVI_ADS_sca_2_OUT part 3. Create Index 

CREATE INDEX "ix_TMP_20221018190449_1QAXDVI_ADS_sca_2_OUT_KEY" ON "TMP_20221018190449_1QAXDVI_ADS_sca_2_OUT" ("KEY")

-- Code For temporary table TMP_20221018190449_PCFG0W7_KernAgg_B0 part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221018190449_PCFG0W7_KernAgg_B0" (
	"KEY" BIGINT, 
	"OVO_Class1" BIGINT, 
	"OVO_Class2" BIGINT, 
	"OVO_Decision" BIGINT, 
...
-- Code For temporary table TMP_20221018190449_PCFG0W7_KernAgg_B0 part 2. Populate
...
FROM "TMP_20221018190449_1QAXDVI_ADS_sca_2_OUT" AS "ADS_sca_2_OUT"), 
"SV_data_0_1" AS 
...
kernel_cte_0_1 AS 
(SELECT kernel_dp_0_1."KEY" AS "KEY", 0 AS "OVO_Class1", 1 AS "OVO_Class2", CASE WHEN (-kernel_dp_0_1.dot_product >= 0.0) THEN 1 ELSE 0 END AS "OVO_Decision", coalesce(-kernel_dp_0_1.dot_product, 1.0 / (1.0 + exp(min(100.0, max(-100.0, -(-((-kernel_dp_0_1.dot_product) * -2.2097558616045383 + -0.3784928789605067))))))) AS "OVO_Conf" 
FROM kernel_dp_0_1)
 INSERT INTO "TMP_20221018190449_PCFG0W7_KernAgg_B0" ("KEY", "OVO_Class1", "OVO_Class2", "OVO_Decision", "OVO_Conf") SELECT "T"."KEY", "T"."OVO_Class1", "T"."OVO_Class2", "T"."OVO_Decision", "T"."OVO_Conf" 
...
-- Code For temporary table TMP_20221018190449_86COF03_KernAgg_B1 part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221018190449_86COF03_KernAgg_B1" (
	"KEY" BIGINT, 
	"OVO_Class1" BIGINT, 
	"OVO_Class2" BIGINT, 
	"OVO_Decision" BIGINT, 
...
-- Code For temporary table TMP_20221018190449_86COF03_KernAgg_B1 part 2. Populate
...
kernel_cte_0_2 AS 
(SELECT kernel_dp_0_2."KEY" AS "KEY", 0 AS "OVO_Class1", 2 AS "OVO_Class2", CASE WHEN (-kernel_dp_0_2.dot_product >= 0.0) THEN 1 ELSE 0 END AS "OVO_Decision", coalesce(-kernel_dp_0_2.dot_product, 1.0 / (1.0 + exp(min(100.0, max(-100.0, -(-((-kernel_dp_0_2.dot_product) * -2.701594326089743 + -0.1012669546964477))))))) AS "OVO_Conf" 
FROM kernel_dp_0_2)
 INSERT INTO "TMP_20221018190449_86COF03_KernAgg_B1" ("KEY", "OVO_Class1", "OVO_Class2", "OVO_Decision", "OVO_Conf") SELECT "T"."KEY", "T"."OVO_Class1", "T"."OVO_Class2", "T"."OVO_Decision", "T"."OVO_Conf" 
...
-- Code For temporary table TMP_20221018190449_RPW1BED_KernAgg_B2 part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221018190449_RPW1BED_KernAgg_B2" (
	"KEY" BIGINT, 
	"OVO_Class1" BIGINT, 
	"OVO_Class2" BIGINT, 
	"OVO_Decision" BIGINT, 
...
-- Code For temporary table TMP_20221018190449_RPW1BED_KernAgg_B2 part 2. Populate
...
kernel_cte_1_2 AS 
(SELECT kernel_dp_1_2."KEY" AS "KEY", 1 AS "OVO_Class1", 2 AS "OVO_Class2", CASE WHEN (-kernel_dp_1_2.dot_product >= 0.0) THEN 1 ELSE 0 END AS "OVO_Decision", coalesce(-kernel_dp_1_2.dot_product, 1.0 / (1.0 + exp(min(100.0, max(-100.0, -(-((-kernel_dp_1_2.dot_product) * -2.45600578892666 + -0.16329065362886566))))))) AS "OVO_Conf" 
FROM kernel_dp_1_2)
 INSERT INTO "TMP_20221018190449_RPW1BED_KernAgg_B2" ("KEY", "OVO_Class1", "OVO_Class2", "OVO_Decision", "OVO_Conf") SELECT "T"."KEY", "T"."OVO_Class1", "T"."OVO_Class2", "T"."OVO_Decision", "T"."OVO_Conf" 
...
-- Code For temporary table TMP_20221018190449_KEKVD17_KernAgg_agg part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221018190449_KEKVD17_KernAgg_agg" (
	"KEY" BIGINT NOT NULL, 
	"OVO_Vote_0" BIGINT, 
...
-- Code For temporary table TMP_20221018190449_KEKVD17_KernAgg_agg part 2. Populate
...
FROM (SELECT "KernAgg_B0"."KEY" AS "KEY", "KernAgg_B0"."OVO_Class1" AS "OVO_Class1", "KernAgg_B0"."OVO_Class2" AS "OVO_Class2", "KernAgg_B0"."OVO_Decision" AS "OVO_Decision", "KernAgg_B0"."OVO_Conf" AS "OVO_Conf" 
FROM "TMP_20221018190449_PCFG0W7_KernAgg_B0" AS "KernAgg_B0" UNION ALL SELECT "KernAgg_B1"."KEY" AS "KEY", "KernAgg_B1"."OVO_Class1" AS "OVO_Class1", "KernAgg_B1"."OVO_Class2" AS "OVO_Class2", "KernAgg_B1"."OVO_Decision" AS "OVO_Decision", "KernAgg_B1"."OVO_Conf" AS "OVO_Conf" 
FROM "TMP_20221018190449_86COF03_KernAgg_B1" AS "KernAgg_B1" UNION ALL SELECT "KernAgg_B2"."KEY" AS "KEY", "KernAgg_B2"."OVO_Class1" AS "OVO_Class1", "KernAgg_B2"."OVO_Class2" AS "OVO_Class2", "KernAgg_B2"."OVO_Decision" AS "OVO_Decision", "KernAgg_B2"."OVO_Conf" AS "OVO_Conf" 
FROM "TMP_20221018190449_RPW1BED_KernAgg_B2" AS "KernAgg_B2") AS "KernAgg_EnsembleUnion"), 
"OVO_Votes" AS 
...
FROM "OVO_Votes", "MinMaxConf")
 INSERT INTO "TMP_20221018190449_KEKVD17_KernAgg_agg" ("KEY", "OVO_Vote_0", "OVO_SumConfidence_0", "OVO_Vote_1", "OVO_SumConfidence_1", "OVO_Vote_2", "OVO_SumConfidence_2", max_abs_confidence, "OVO_Scale", "Score_0", "Score_1", "Score_2") SELECT "T"."KEY", "T"."OVO_Vote_0", "T"."OVO_SumConfidence_0", "T"."OVO_Vote_1", "T"."OVO_SumConfidence_1", "T"."OVO_Vote_2", "T"."OVO_SumConfidence_2", "T".max_abs_confidence, "T"."OVO_Scale", "T"."Score_0", "T"."Score_1", "T"."Score_2" 
...
-- Code For temporary table TMP_20221018190449_KEKVD17_KernAgg_agg part 3. Create Index 

CREATE INDEX "ix_TMP_20221018190449_KEKVD17_KernAgg_agg_KEY" ON "TMP_20221018190449_KEKVD17_KernAgg_agg" ("KEY")
...
FROM "TMP_20221018190449_KEKVD17_KernAgg_agg" AS "KernAgg_agg"), 
