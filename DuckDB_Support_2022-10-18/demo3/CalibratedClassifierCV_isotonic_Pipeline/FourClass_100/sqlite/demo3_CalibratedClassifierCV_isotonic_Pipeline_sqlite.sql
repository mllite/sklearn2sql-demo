...
-- Code For temporary table TMP_20221018185253_AG4B9G4_ADS_imp_1_OUT part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221018185253_AG4B9G4_ADS_imp_1_OUT" (
	"KEY" BIGINT NOT NULL, 
	impter_2 FLOAT, 
	impter_3 FLOAT, 
	impter_4 FLOAT, 
...
-- Code For temporary table TMP_20221018185253_AG4B9G4_ADS_imp_1_OUT part 3. Create Index 

CREATE INDEX "ix_TMP_20221018185253_AG4B9G4_ADS_imp_1_OUT_KEY" ON "TMP_20221018185253_AG4B9G4_ADS_imp_1_OUT" ("KEY")

-- Code For temporary table TMP_20221018185253_RWLX5FF_ADS_sca_2_OUT part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221018185253_RWLX5FF_ADS_sca_2_OUT" (
	"KEY" BIGINT NOT NULL, 
	scaler_2 FLOAT, 
	scaler_3 FLOAT, 
	scaler_4 FLOAT, 
...
FROM "TMP_20221018185253_AG4B9G4_ADS_imp_1_OUT" AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT") AS "T"

-- Code For temporary table TMP_20221018185253_RWLX5FF_ADS_sca_2_OUT part 3. Create Index 

CREATE INDEX "ix_TMP_20221018185253_RWLX5FF_ADS_sca_2_OUT_KEY" ON "TMP_20221018185253_RWLX5FF_ADS_sca_2_OUT" ("KEY")

-- Code For temporary table TMP_20221018185253_L17KGRF_CalProb_B0 part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221018185253_L17KGRF_CalProb_B0" (
	"KEY" BIGINT, 
	"Proba_0" FLOAT, 
	"Proba_1" FLOAT, 
	"Proba_2" FLOAT, 
...
-- Code For temporary table TMP_20221018185253_L17KGRF_CalProb_B0 part 2. Populate
...
FROM "TMP_20221018185253_RWLX5FF_ADS_sca_2_OUT" AS "ADS_sca_2_OUT"), 
"DT_node_data" AS 
...
FROM "DT_Output"), 
isotonic_cte_0 AS 
(SELECT "Calibrated_Model_0"."KEY" AS "KEY", CASE WHEN ("Calibrated_Model_0"."ScoreOrProba_0" < 0.0) THEN 0.07692307692307693 WHEN ("Calibrated_Model_0"."ScoreOrProba_0" < 0.5) THEN ("Calibrated_Model_0"."ScoreOrProba_0" - 0.0) * 0.0 + 0.07692307692307693 WHEN ("Calibrated_Model_0"."ScoreOrProba_0" < 0.875) THEN ("Calibrated_Model_0"."ScoreOrProba_0" - 0.5) * 0.6837606837606837 + 0.07692307692307693 WHEN ("Calibrated_Model_0"."ScoreOrProba_0" < 1.0) THEN ("Calibrated_Model_0"."ScoreOrProba_0" - 0.875) * 2.1333333333333333 + 0.3333333333333333 ELSE 0.6 END AS "Proba_0", CASE WHEN ("Calibrated_Model_0"."ScoreOrProba_1" < 0.0) THEN 0.23809523809523808 WHEN ("Calibrated_Model_0"."ScoreOrProba_1" < 0.3333333333333333) THEN ("Calibrated_Model_0"."ScoreOrProba_1" - 0.0) * 0.0 + 0.23809523809523808 WHEN ("Calibrated_Model_0"."ScoreOrProba_1" < 1.0) THEN ("Calibrated_Model_0"."ScoreOrProba_1" - 0.3333333333333333) * 0.14285714285714282 + 0.23809523809523808 ELSE 0.3333333333333333 END AS "Proba_1", CASE WHEN ("Calibrated_Model_0"."ScoreOrProba_2" < 0.0) THEN 0.2 WHEN ("Calibrated_Model_0"."ScoreOrProba_2" < 0.125) THEN ("Calibrated_Model_0"."ScoreOrProba_2" - 0.0) * 0.0 + 0.2 WHEN ("Calibrated_Model_0"."ScoreOrProba_2" < 0.16666666666666666) THEN ("Calibrated_Model_0"."ScoreOrProba_2" - 0.125) * 7.200000000000001 + 0.2 WHEN ("Calibrated_Model_0"."ScoreOrProba_2" < 1.0) THEN ("Calibrated_Model_0"."ScoreOrProba_2" - 0.16666666666666666) * 0.0 + 0.5 ELSE 0.5 END AS "Proba_2", CASE WHEN ("Calibrated_Model_0"."ScoreOrProba_3" < 0.0) THEN 0.25 WHEN ("Calibrated_Model_0"."ScoreOrProba_3" < 1.0) THEN ("Calibrated_Model_0"."ScoreOrProba_3" - 0.0) * 0.0 + 0.25 ELSE 0.25 END AS "Proba_3" 
...
FROM "DT_Output_1"), 
isotonic_cte_1 AS 
(SELECT "Calibrated_Model_1"."KEY" AS "KEY", CASE WHEN ("Calibrated_Model_1"."ScoreOrProba_0" < 0.0) THEN 0.23529411764705882 WHEN ("Calibrated_Model_1"."ScoreOrProba_0" < 0.5) THEN ("Calibrated_Model_1"."ScoreOrProba_0" - 0.0) * 0.0 + 0.23529411764705882 WHEN ("Calibrated_Model_1"."ScoreOrProba_0" < 1.0) THEN ("Calibrated_Model_1"."ScoreOrProba_0" - 0.5) * 0.10084033613445376 + 0.23529411764705882 ELSE 0.2857142857142857 END AS "Proba_0", CASE WHEN ("Calibrated_Model_1"."ScoreOrProba_1" < 0.0) THEN 0.25 WHEN ("Calibrated_Model_1"."ScoreOrProba_1" < 1.0) THEN ("Calibrated_Model_1"."ScoreOrProba_1" - 0.0) * 0.0 + 0.25 ELSE 0.25 END AS "Proba_1", CASE WHEN ("Calibrated_Model_1"."ScoreOrProba_2" < 0.0) THEN 0.15 WHEN ("Calibrated_Model_1"."ScoreOrProba_2" < 0.5) THEN ("Calibrated_Model_1"."ScoreOrProba_2" - 0.0) * 0.0 + 0.15 WHEN ("Calibrated_Model_1"."ScoreOrProba_2" < 1.0) THEN ("Calibrated_Model_1"."ScoreOrProba_2" - 0.5) * 1.2 + 0.15 ELSE 0.75 END AS "Proba_2", CASE WHEN ("Calibrated_Model_1"."ScoreOrProba_3" < 0.0) THEN 0.19047619047619047 WHEN ("Calibrated_Model_1"."ScoreOrProba_3" < 1.0) THEN ("Calibrated_Model_1"."ScoreOrProba_3" - 0.0) * 0.47619047619047616 + 0.19047619047619047 ELSE 0.6666666666666666 END AS "Proba_3" 
...
FROM "DT_Output_2"), 
isotonic_cte_2 AS 
(SELECT "Calibrated_Model_2"."KEY" AS "KEY", CASE WHEN ("Calibrated_Model_2"."ScoreOrProba_0" < 0.0) THEN 0.11764705882352941 WHEN ("Calibrated_Model_2"."ScoreOrProba_0" < 0.2) THEN ("Calibrated_Model_2"."ScoreOrProba_0" - 0.0) * 0.0 + 0.11764705882352941 WHEN ("Calibrated_Model_2"."ScoreOrProba_0" < 1.0) THEN ("Calibrated_Model_2"."ScoreOrProba_0" - 0.2) * 0.5672268907563024 + 0.11764705882352941 ELSE 0.5714285714285714 END AS "Proba_0", CASE WHEN ("Calibrated_Model_2"."ScoreOrProba_1" < 0.0) THEN 0.25 WHEN ("Calibrated_Model_2"."ScoreOrProba_1" < 1.0) THEN ("Calibrated_Model_2"."ScoreOrProba_1" - 0.0) * 0.0 + 0.25 ELSE 0.25 END AS "Proba_1", CASE WHEN ("Calibrated_Model_2"."ScoreOrProba_2" < 0.0) THEN 0.05555555555555555 WHEN ("Calibrated_Model_2"."ScoreOrProba_2" < 1.0) THEN ("Calibrated_Model_2"."ScoreOrProba_2" - 0.0) * 0.7777777777777778 + 0.05555555555555555 ELSE 0.8333333333333334 END AS "Proba_2", CASE WHEN ("Calibrated_Model_2"."ScoreOrProba_3" < 0.0) THEN 0.125 WHEN ("Calibrated_Model_2"."ScoreOrProba_3" < 0.6) THEN ("Calibrated_Model_2"."ScoreOrProba_3" - 0.0) * 0.45833333333333337 + 0.125 WHEN ("Calibrated_Model_2"."ScoreOrProba_3" < 0.8333333333333334) THEN ("Calibrated_Model_2"."ScoreOrProba_3" - 0.6) * 0.0 + 0.4 WHEN ("Calibrated_Model_2"."ScoreOrProba_3" < 1.0) THEN ("Calibrated_Model_2"."ScoreOrProba_3" - 0.8333333333333334) * 1.6 + 0.4 ELSE 0.6666666666666666 END AS "Proba_3" 
...
FROM "DT_Output_3"), 
isotonic_cte_3 AS 
(SELECT "Calibrated_Model_3"."KEY" AS "KEY", CASE WHEN ("Calibrated_Model_3"."ScoreOrProba_0" < 0.0) THEN 0.0625 WHEN ("Calibrated_Model_3"."ScoreOrProba_0" < 0.9375) THEN ("Calibrated_Model_3"."ScoreOrProba_0" - 0.0) * 0.5428571428571428 + 0.0625 WHEN ("Calibrated_Model_3"."ScoreOrProba_0" < 1.0) THEN ("Calibrated_Model_3"."ScoreOrProba_0" - 0.9375) * 6.857142857142858 + 0.5714285714285714 ELSE 1.0 END AS "Proba_0", CASE WHEN ("Calibrated_Model_3"."ScoreOrProba_1" < 0.0) THEN 0.2727272727272727 WHEN ("Calibrated_Model_3"."ScoreOrProba_1" < 0.0625) THEN ("Calibrated_Model_3"."ScoreOrProba_1" - 0.0) * 0.55944055944056 + 0.2727272727272727 WHEN ("Calibrated_Model_3"."ScoreOrProba_1" < 1.0) THEN ("Calibrated_Model_3"."ScoreOrProba_1" - 0.0625) * 0.0 + 0.3076923076923077 ELSE 0.3076923076923077 END AS "Proba_1", CASE WHEN ("Calibrated_Model_3"."ScoreOrProba_2" < 0.0) THEN 0.20833333333333334 WHEN ("Calibrated_Model_3"."ScoreOrProba_2" < 1.0) THEN ("Calibrated_Model_3"."ScoreOrProba_2" - 0.0) * 0.0 + 0.20833333333333334 ELSE 0.20833333333333334 END AS "Proba_2", CASE WHEN ("Calibrated_Model_3"."ScoreOrProba_3" < 0.0) THEN 0.21052631578947367 WHEN ("Calibrated_Model_3"."ScoreOrProba_3" < 0.5) THEN ("Calibrated_Model_3"."ScoreOrProba_3" - 0.0) * 0.0 + 0.21052631578947367 WHEN ("Calibrated_Model_3"."ScoreOrProba_3" < 1.0) THEN ("Calibrated_Model_3"."ScoreOrProba_3" - 0.5) * 0.3789473684210527 + 0.21052631578947367 ELSE 0.4 END AS "Proba_3" 
...
FROM isotonic_cte_3)
 INSERT INTO "TMP_20221018185253_L17KGRF_CalProb_B0" ("KEY", "Proba_0", "Proba_1", "Proba_2", "Proba_3") SELECT "T"."KEY", "T"."Proba_0", "T"."Proba_1", "T"."Proba_2", "T"."Proba_3" 
...
-- Code For temporary table TMP_20221018185253_2D680VA_CalProb_avg part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221018185253_2D680VA_CalProb_avg" (
	"KEY" BIGINT NOT NULL, 
	"Proba_0" FLOAT, 
	"Proba_1" FLOAT, 
	"Proba_2" FLOAT, 
...
-- Code For temporary table TMP_20221018185253_2D680VA_CalProb_avg part 2. Populate
...
FROM (SELECT "CalProb_B0"."KEY" AS "KEY", "CalProb_B0"."Proba_0" AS "Proba_0", "CalProb_B0"."Proba_1" AS "Proba_1", "CalProb_B0"."Proba_2" AS "Proba_2", "CalProb_B0"."Proba_3" AS "Proba_3" 
FROM "TMP_20221018185253_L17KGRF_CalProb_B0" AS "CalProb_B0") AS "CalProb_EnsembleUnion")
 INSERT INTO "TMP_20221018185253_2D680VA_CalProb_avg" ("KEY", "Proba_0", "Proba_1", "Proba_2", "Proba_3") SELECT "T"."KEY", "T"."Proba_0", "T"."Proba_1", "T"."Proba_2", "T"."Proba_3" 
...
-- Code For temporary table TMP_20221018185253_2D680VA_CalProb_avg part 3. Create Index 

CREATE INDEX "ix_TMP_20221018185253_2D680VA_CalProb_avg_KEY" ON "TMP_20221018185253_2D680VA_CalProb_avg" ("KEY")
...
FROM "TMP_20221018185253_2D680VA_CalProb_avg" AS "CalProb_avg"), 
