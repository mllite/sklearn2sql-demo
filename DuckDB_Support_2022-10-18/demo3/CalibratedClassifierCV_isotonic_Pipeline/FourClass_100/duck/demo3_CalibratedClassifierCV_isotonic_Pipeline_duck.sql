...
-- Code For temporary table TMP_20221018185253_2TW15C1_ADS_imp_1_OUT part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221018185253_2TW15C1_ADS_imp_1_OUT" (
	"KEY" BIGINT NOT NULL, 
	impter_2 DOUBLE, 
	impter_3 DOUBLE, 
	impter_4 DOUBLE, 
...
-- Code For temporary table TMP_20221018185253_2TW15C1_ADS_imp_1_OUT part 3. Create Index 

CREATE INDEX "ix_TMP_20221018185253_2TW15C1_ADS_imp_1_OUT_KEY" ON "TMP_20221018185253_2TW15C1_ADS_imp_1_OUT" ("KEY")

-- Code For temporary table TMP_20221018185253_YMSF5JN_ADS_sca_2_OUT part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221018185253_YMSF5JN_ADS_sca_2_OUT" (
	"KEY" BIGINT NOT NULL, 
	scaler_2 DOUBLE, 
	scaler_3 DOUBLE, 
	scaler_4 DOUBLE, 
...
FROM "TMP_20221018185253_2TW15C1_ADS_imp_1_OUT" AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT") AS "T"

-- Code For temporary table TMP_20221018185253_YMSF5JN_ADS_sca_2_OUT part 3. Create Index 

CREATE INDEX "ix_TMP_20221018185253_YMSF5JN_ADS_sca_2_OUT_KEY" ON "TMP_20221018185253_YMSF5JN_ADS_sca_2_OUT" ("KEY")

-- Code For temporary table TMP_20221018185253_I5QA1KY_CalProb_B0 part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221018185253_I5QA1KY_CalProb_B0" (
	"KEY" BIGINT, 
	"Proba_0" DOUBLE, 
	"Proba_1" DOUBLE, 
	"Proba_2" DOUBLE, 
...
-- Code For temporary table TMP_20221018185253_I5QA1KY_CalProb_B0 part 2. Populate
...
FROM "TMP_20221018185253_YMSF5JN_ADS_sca_2_OUT" AS "ADS_sca_2_OUT"), 
"DT_node_data" AS 
...
FROM isotonic_cte_3)
 INSERT INTO "TMP_20221018185253_I5QA1KY_CalProb_B0" ("KEY", "Proba_0", "Proba_1", "Proba_2", "Proba_3") SELECT "T"."KEY", "T"."Proba_0", "T"."Proba_1", "T"."Proba_2", "T"."Proba_3" 
...
-- Code For temporary table TMP_20221018185253_LM1GHX2_CalProb_avg part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221018185253_LM1GHX2_CalProb_avg" (
	"KEY" BIGINT NOT NULL, 
	"Proba_0" DOUBLE, 
	"Proba_1" DOUBLE, 
	"Proba_2" DOUBLE, 
...
-- Code For temporary table TMP_20221018185253_LM1GHX2_CalProb_avg part 2. Populate
...
FROM (SELECT "CalProb_B0"."KEY" AS "KEY", "CalProb_B0"."Proba_0" AS "Proba_0", "CalProb_B0"."Proba_1" AS "Proba_1", "CalProb_B0"."Proba_2" AS "Proba_2", "CalProb_B0"."Proba_3" AS "Proba_3" 
FROM "TMP_20221018185253_I5QA1KY_CalProb_B0" AS "CalProb_B0") AS "CalProb_EnsembleUnion")
 INSERT INTO "TMP_20221018185253_LM1GHX2_CalProb_avg" ("KEY", "Proba_0", "Proba_1", "Proba_2", "Proba_3") SELECT "T"."KEY", "T"."Proba_0", "T"."Proba_1", "T"."Proba_2", "T"."Proba_3" 
...
-- Code For temporary table TMP_20221018185253_LM1GHX2_CalProb_avg part 3. Create Index 

CREATE INDEX "ix_TMP_20221018185253_LM1GHX2_CalProb_avg_KEY" ON "TMP_20221018185253_LM1GHX2_CalProb_avg" ("KEY")
...
FROM "TMP_20221018185253_LM1GHX2_CalProb_avg" AS "CalProb_avg"), 
