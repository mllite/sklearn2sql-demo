...
-- Code For temporary table TMP_20221018184918_A70KUV4_ADS_imp_1_OUT part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221018184918_A70KUV4_ADS_imp_1_OUT" (
	"KEY" BIGINT NOT NULL, 
	impter_2 FLOAT, 
	impter_3 FLOAT, 
	impter_4 FLOAT, 
...
-- Code For temporary table TMP_20221018184918_A70KUV4_ADS_imp_1_OUT part 3. Create Index 

CREATE INDEX "ix_TMP_20221018184918_A70KUV4_ADS_imp_1_OUT_KEY" ON "TMP_20221018184918_A70KUV4_ADS_imp_1_OUT" ("KEY")

-- Code For temporary table TMP_20221018184918_32GLSCR_ADS_sca_2_OUT part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221018184918_32GLSCR_ADS_sca_2_OUT" (
	"KEY" BIGINT NOT NULL, 
	scaler_2 FLOAT, 
	scaler_3 FLOAT, 
	scaler_4 FLOAT, 
...
FROM "TMP_20221018184918_A70KUV4_ADS_imp_1_OUT" AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT") AS "T"

-- Code For temporary table TMP_20221018184918_32GLSCR_ADS_sca_2_OUT part 3. Create Index 

CREATE INDEX "ix_TMP_20221018184918_32GLSCR_ADS_sca_2_OUT_KEY" ON "TMP_20221018184918_32GLSCR_ADS_sca_2_OUT" ("KEY")

-- Code For temporary table TMP_20221018184918_1NZAY3K_CalProb_B0 part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221018184918_1NZAY3K_CalProb_B0" (
	"KEY" BIGINT, 
	"Proba_1" FLOAT, 
	"Proba_0" FLOAT
)
...
-- Code For temporary table TMP_20221018184918_1NZAY3K_CalProb_B0 part 2. Populate
...
FROM "TMP_20221018184918_32GLSCR_ADS_sca_2_OUT" AS "ADS_sca_2_OUT"), 
"DT_node_data" AS 
...
FROM isotonic_cte_3)
 INSERT INTO "TMP_20221018184918_1NZAY3K_CalProb_B0" ("KEY", "Proba_1", "Proba_0") SELECT "T"."KEY", "T"."Proba_1", "T"."Proba_0" 
...
-- Code For temporary table TMP_20221018184918_CN5EIRI_CalProb_avg part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221018184918_CN5EIRI_CalProb_avg" (
	"KEY" BIGINT NOT NULL, 
	"Proba_1" FLOAT, 
	"Proba_0" FLOAT, 
	PRIMARY KEY ("KEY")
...
-- Code For temporary table TMP_20221018184918_CN5EIRI_CalProb_avg part 2. Populate
...
FROM (SELECT "CalProb_B0"."KEY" AS "KEY", "CalProb_B0"."Proba_1" AS "Proba_1", "CalProb_B0"."Proba_0" AS "Proba_0" 
FROM "TMP_20221018184918_1NZAY3K_CalProb_B0" AS "CalProb_B0") AS "CalProb_EnsembleUnion")
 INSERT INTO "TMP_20221018184918_CN5EIRI_CalProb_avg" ("KEY", "Proba_1", "Proba_0") SELECT "T"."KEY", "T"."Proba_1", "T"."Proba_0" 
...
-- Code For temporary table TMP_20221018184918_CN5EIRI_CalProb_avg part 3. Create Index 

CREATE INDEX "ix_TMP_20221018184918_CN5EIRI_CalProb_avg_KEY" ON "TMP_20221018184918_CN5EIRI_CalProb_avg" ("KEY")
...
FROM "TMP_20221018184918_CN5EIRI_CalProb_avg" AS "CalProb_avg"), 
