...
-- Code For temporary table TMP_20221018185300_2VUCYT6_ADS_imp_1_OUT part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221018185300_2VUCYT6_ADS_imp_1_OUT" (
	"KEY" BIGINT NOT NULL, 
	impter_2 DOUBLE, 
	impter_3 DOUBLE, 
	impter_4 DOUBLE, 
...
-- Code For temporary table TMP_20221018185300_2VUCYT6_ADS_imp_1_OUT part 3. Create Index 

CREATE INDEX "ix_TMP_20221018185300_2VUCYT6_ADS_imp_1_OUT_KEY" ON "TMP_20221018185300_2VUCYT6_ADS_imp_1_OUT" ("KEY")

-- Code For temporary table TMP_20221018185300_LCQUQ97_ADS_sca_2_OUT part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221018185300_LCQUQ97_ADS_sca_2_OUT" (
	"KEY" BIGINT NOT NULL, 
	scaler_2 DOUBLE, 
	scaler_3 DOUBLE, 
	scaler_4 DOUBLE, 
...
FROM "TMP_20221018185300_2VUCYT6_ADS_imp_1_OUT" AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT") AS "T"

-- Code For temporary table TMP_20221018185300_LCQUQ97_ADS_sca_2_OUT part 3. Create Index 

CREATE INDEX "ix_TMP_20221018185300_LCQUQ97_ADS_sca_2_OUT_KEY" ON "TMP_20221018185300_LCQUQ97_ADS_sca_2_OUT" ("KEY")

-- Model deployment code

WITH "DT_node_lookup" AS 
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", CASE WHEN ("ADS_sca_2_OUT".scaler_46 <= -0.9107336401939392) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_101 <= -1.0859026610851288) THEN 2 ELSE 3 END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_80 <= -0.16562547534704208) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_43 <= 0.3289739340543747) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_21 <= -0.27451857924461365) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_73 <= -0.93479323387146) THEN 8 ELSE 9 END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_91 <= 0.7886935174465179) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_5 <= -1.3134407997131348) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_94 <= 0.7356138005852699) THEN 13 ELSE 14 END ELSE 15 END ELSE 16 END END ELSE 17 END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_50 <= -0.18425396084785461) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_46 <= 1.1959999799728394) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_20 <= -2.137797236442566) THEN 21 ELSE 22 END ELSE 23 END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_21 <= 0.025623828172683716) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_31 <= 0.9999334514141083) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_14 <= 1.8300495147705078) THEN 27 ELSE 28 END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_25 <= 0.08749166131019592) THEN 30 ELSE 31 END END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_73 <= 0.5125872418284416) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_40 <= -0.2565065985545516) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_30 <= -1.2964915335178375) THEN 35 ELSE 36 END ELSE 37 END ELSE 38 END END END END END AS node_id_2 
FROM "TMP_20221018185300_LCQUQ97_ADS_sca_2_OUT" AS "ADS_sca_2_OUT"), 
"DT_node_data" AS 
