...
-- Code For temporary table TMP_20221018185038_1ZG50DO_ADS_imp_1_OUT part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221018185038_1ZG50DO_ADS_imp_1_OUT" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20221018185038_1ZG50DO_ADS_imp_1_OUT part 3. Create Index 

CREATE INDEX "ix_TMP_20221018185038_1ZG50DO_ADS_imp_1_OUT_KEY" ON "TMP_20221018185038_1ZG50DO_ADS_imp_1_OUT" ("KEY")

-- Code For temporary table TMP_20221018185038_6R3OT07_ADS_sca_2_OUT part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221018185038_6R3OT07_ADS_sca_2_OUT" (
	"KEY" BIGINT NOT NULL, 
...
FROM "TMP_20221018185038_1ZG50DO_ADS_imp_1_OUT" AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT") AS "T"

-- Code For temporary table TMP_20221018185038_6R3OT07_ADS_sca_2_OUT part 3. Create Index 

CREATE INDEX "ix_TMP_20221018185038_6R3OT07_ADS_sca_2_OUT_KEY" ON "TMP_20221018185038_6R3OT07_ADS_sca_2_OUT" ("KEY")

-- Model deployment code

WITH "DT_node_lookup" AS 
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", CASE WHEN ("ADS_sca_2_OUT".scaler_output_29 <= 0.48149049282073975) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_output_25 <= 0.15994150936603546) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_output_20 <= -1.419763207435608) THEN 3 ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_output_29 <= 0.1327482983469963) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_output_12 <= 0.8007535338401794) THEN 6 ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_output_14 <= 0.6271899342536926) THEN 8 ELSE 9 END END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_output_15 <= -0.17221208661794662) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_output_17 <= -0.7624015212059021) THEN 12 ELSE 13 END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_output_7 <= 0.9340902268886566) THEN 15 ELSE 16 END END END END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_output_26 <= -1.9275171756744385) THEN 18 ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_output_10 <= -1.0953043699264526) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_output_21 <= -0.3205822389572859) THEN 21 ELSE 22 END ELSE 23 END END END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_output_18 <= 3.2733601331710815) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_output_28 <= -0.2999221310019493) THEN 26 ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_output_8 <= -0.029022936709225178) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_output_18 <= -0.10419273190200329) THEN 29 ELSE 30 END ELSE 31 END END ELSE 32 END END AS node_id_2 
FROM "TMP_20221018185038_6R3OT07_ADS_sca_2_OUT" AS "ADS_sca_2_OUT"), 
"DT_node_data" AS 
