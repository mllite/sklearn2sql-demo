...
-- Code For temporary table TMP_20221018184926_8YCLPZC_ADS_imp_1_OUT part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221018184926_8YCLPZC_ADS_imp_1_OUT" (
	"KEY" BIGINT NOT NULL, 
	impter_2 DOUBLE, 
	impter_3 DOUBLE, 
	impter_4 DOUBLE, 
...
-- Code For temporary table TMP_20221018184926_8YCLPZC_ADS_imp_1_OUT part 3. Create Index 

CREATE INDEX "ix_TMP_20221018184926_8YCLPZC_ADS_imp_1_OUT_KEY" ON "TMP_20221018184926_8YCLPZC_ADS_imp_1_OUT" ("KEY")

-- Code For temporary table TMP_20221018184926_KW8POS0_ADS_sca_2_OUT part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221018184926_KW8POS0_ADS_sca_2_OUT" (
	"KEY" BIGINT NOT NULL, 
	scaler_2 DOUBLE, 
	scaler_3 DOUBLE, 
	scaler_4 DOUBLE, 
...
FROM "TMP_20221018184926_8YCLPZC_ADS_imp_1_OUT" AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT") AS "T"

-- Code For temporary table TMP_20221018184926_KW8POS0_ADS_sca_2_OUT part 3. Create Index 

CREATE INDEX "ix_TMP_20221018184926_KW8POS0_ADS_sca_2_OUT_KEY" ON "TMP_20221018184926_KW8POS0_ADS_sca_2_OUT" ("KEY")

-- Model deployment code

WITH "DT_node_lookup" AS 
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", CASE WHEN ("ADS_sca_2_OUT".scaler_59 <= 0.06653057038784027) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_19 <= 1.166886031627655) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_11 <= 2.1140206456184387) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_62 <= -0.5680299699306488) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_82 <= 0.3214264512062073) THEN 5 ELSE 6 END ELSE 7 END ELSE 8 END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_59 <= -0.8933883011341095) THEN 10 ELSE 11 END END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_56 <= 1.2069389820098877) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_83 <= -2.09354031085968) THEN 14 ELSE 15 END ELSE 16 END END AS node_id_2 
FROM "TMP_20221018184926_KW8POS0_ADS_sca_2_OUT" AS "ADS_sca_2_OUT"), 
"DT_node_data" AS 
