...
-- Code For temporary table TMP_20221018185913_X41I0QH_XGB_B0 part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221018185913_X41I0QH_XGB_B0" (
	"KEY" BIGINT, 
	"Estimator" DOUBLE
)
...
-- Code For temporary table TMP_20221018185913_X41I0QH_XGB_B0 part 2. Populate
...
FROM "DT_Output_9")
 INSERT INTO "TMP_20221018185913_X41I0QH_XGB_B0" ("KEY", "Estimator") SELECT "T"."KEY", "T"."Estimator" 
...
-- Code For temporary table TMP_20221018185913_A2257V4_XGB_B1 part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221018185913_A2257V4_XGB_B1" (
	"KEY" BIGINT, 
	"Estimator" DOUBLE
)
...
-- Code For temporary table TMP_20221018185913_A2257V4_XGB_B1 part 2. Populate
...
FROM "DT_Output_15")
 INSERT INTO "TMP_20221018185913_A2257V4_XGB_B1" ("KEY", "Estimator") SELECT "T"."KEY", "T"."Estimator" 
...
-- Code For temporary table TMP_20221018185913_W8NSAAJ_XGB_sum part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221018185913_W8NSAAJ_XGB_sum" (
	"KEY" BIGINT NOT NULL, 
	"Estimator" DOUBLE, 
	PRIMARY KEY ("KEY")
)
...
-- Code For temporary table TMP_20221018185913_W8NSAAJ_XGB_sum part 2. Populate

WITH "XGB_Union" AS 
(SELECT "XGB_EnsembleUnion"."KEY" AS "KEY", "XGB_EnsembleUnion"."Estimator" AS "Estimator" 
FROM (SELECT "XGB_B0"."KEY" AS "KEY", "XGB_B0"."Estimator" AS "Estimator" 
FROM "TMP_20221018185913_X41I0QH_XGB_B0" AS "XGB_B0" UNION ALL SELECT "XGB_B1"."KEY" AS "KEY", "XGB_B1"."Estimator" AS "Estimator" 
FROM "TMP_20221018185913_A2257V4_XGB_B1" AS "XGB_B1") AS "XGB_EnsembleUnion")
 INSERT INTO "TMP_20221018185913_W8NSAAJ_XGB_sum" ("KEY", "Estimator") SELECT "T"."KEY", "T"."Estimator" 
...
-- Code For temporary table TMP_20221018185913_W8NSAAJ_XGB_sum part 3. Create Index 

CREATE INDEX "ix_TMP_20221018185913_W8NSAAJ_XGB_sum_KEY" ON "TMP_20221018185913_W8NSAAJ_XGB_sum" ("KEY")

-- Model deployment code

SELECT "XGB_sum"."KEY" AS "KEY", "XGB_sum"."Estimator" + 0.5 AS "Estimator" 
FROM "TMP_20221018185913_W8NSAAJ_XGB_sum" AS "XGB_sum"