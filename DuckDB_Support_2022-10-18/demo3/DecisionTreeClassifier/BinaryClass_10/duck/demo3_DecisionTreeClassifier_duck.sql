...
(SELECT "ADS"."KEY" AS "KEY", CASE WHEN ("ADS"."Feature_9" <= 0.034406057093292475) THEN CASE WHEN ("ADS"."Feature_5" <= 2.3706862926483154) THEN CASE WHEN ("ADS"."Feature_5" <= -1.1672475934028625) THEN CASE WHEN ("ADS"."Feature_0" <= 1.1058164834976196) THEN 4 ELSE 5 END ELSE 6 END ELSE 7 END ELSE CASE WHEN ("ADS"."Feature_6" <= 1.9341034293174744) THEN 9 ELSE 10 END END AS node_id_2 
