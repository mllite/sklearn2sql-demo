...
(SELECT "ADS"."KEY" AS "KEY", CASE WHEN ("ADS"."Feature_27" <= 0.14545000344514847) THEN CASE WHEN ("ADS"."Feature_23" <= 961.5500183105469) THEN CASE WHEN ("ADS"."Feature_18" <= 0.008710499852895737) THEN 3 ELSE CASE WHEN ("ADS"."Feature_27" <= 0.12230000272393227) THEN CASE WHEN ("ADS"."Feature_10" <= 0.6430999934673309) THEN 6 ELSE CASE WHEN ("ADS"."Feature_12" <= 4.249000072479248) THEN 8 ELSE 9 END END ELSE CASE WHEN ("ADS"."Feature_13" <= 32.57499885559082) THEN CASE WHEN ("ADS"."Feature_15" <= 0.011884999927133322) THEN 12 ELSE 13 END ELSE CASE WHEN ("ADS"."Feature_5" <= 0.1543000042438507) THEN 15 ELSE 16 END END END END ELSE CASE WHEN ("ADS"."Feature_24" <= 0.0879799984395504) THEN 18 ELSE CASE WHEN ("ADS"."Feature_8" <= 0.15114999562501907) THEN CASE WHEN ("ADS"."Feature_19" <= 0.0029670000076293945) THEN 21 ELSE 22 END ELSE 23 END END END ELSE CASE WHEN ("ADS"."Feature_16" <= 0.13565000146627426) THEN CASE WHEN ("ADS"."Feature_26" <= 0.20340000092983246) THEN 26 ELSE CASE WHEN ("ADS"."Feature_6" <= 0.08588500320911407) THEN CASE WHEN ("ADS"."Feature_16" <= 0.028699999675154686) THEN 29 ELSE 30 END ELSE 31 END END ELSE 32 END END AS node_id_2 
