...
-- Code For temporary table TMP_20221018184910_BF2ECI6_ADS_imp_1_OUT part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221018184910_BF2ECI6_ADS_imp_1_OUT" (
	"KEY" BIGINT NOT NULL, 
	impter_2 DOUBLE, 
	impter_3 DOUBLE, 
	impter_4 DOUBLE, 
...
-- Code For temporary table TMP_20221018184910_BF2ECI6_ADS_imp_1_OUT part 3. Create Index 

CREATE INDEX "ix_TMP_20221018184910_BF2ECI6_ADS_imp_1_OUT_KEY" ON "TMP_20221018184910_BF2ECI6_ADS_imp_1_OUT" ("KEY")

-- Code For temporary table TMP_20221018184911_WPLMGRX_ADS_sca_2_OUT part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221018184911_WPLMGRX_ADS_sca_2_OUT" (
	"KEY" BIGINT NOT NULL, 
	scaler_2 DOUBLE, 
	scaler_3 DOUBLE, 
	scaler_4 DOUBLE, 
...
FROM "TMP_20221018184910_BF2ECI6_ADS_imp_1_OUT" AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT") AS "T"

-- Code For temporary table TMP_20221018184911_WPLMGRX_ADS_sca_2_OUT part 3. Create Index 

CREATE INDEX "ix_TMP_20221018184911_WPLMGRX_ADS_sca_2_OUT_KEY" ON "TMP_20221018184911_WPLMGRX_ADS_sca_2_OUT" ("KEY")

-- Code For temporary table TMP_20221018184911_JILZXF7_BAG_B0 part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221018184911_JILZXF7_BAG_B0" (
	"KEY" BIGINT, 
	"Score_0" DOUBLE, 
	"Proba_0" DOUBLE, 
	"LogProba_0" DOUBLE, 
...
-- Code For temporary table TMP_20221018184911_JILZXF7_BAG_B0 part 2. Populate

WITH "DT_node_lookup" AS 
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", CASE WHEN ("ADS_sca_2_OUT".scaler_59 <= -0.17161808907985687) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_32 <= 1.5231464505195618) THEN 2 ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_101 <= 0.899030938744545) THEN 4 ELSE 5 END END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_50 <= 1.4252889156341553) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_88 <= -1.7349998950958252) THEN 8 ELSE 9 END ELSE 10 END END AS node_id_2 
FROM "TMP_20221018184911_WPLMGRX_ADS_sca_2_OUT" AS "ADS_sca_2_OUT"), 
"DT_node_data" AS 
...
FROM "DT_Output_1"), 
"DT_node_lookup_2" AS 
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", CASE WHEN ("ADS_sca_2_OUT".scaler_59 <= -0.1771824061870575) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_19 <= 0.7979417145252228) THEN 2 ELSE 3 END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_76 <= -1.541745901107788) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_21 <= 0.34517980366945267) THEN 6 ELSE 7 END ELSE 8 END END AS node_id_2 
FROM "TMP_20221018184911_WPLMGRX_ADS_sca_2_OUT" AS "ADS_sca_2_OUT"), 
"DT_node_data_2" AS 
(SELECT "Values".nid AS nid, "Values"."P_0" AS "P_0", "Values"."P_1" AS "P_1", "Values"."D" AS "D", "Values"."DP" AS "DP" 
...
FROM "DT_Output_3"), 
"DT_node_lookup_4" AS 
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", CASE WHEN ("ADS_sca_2_OUT".scaler_59 <= 0.3534664064645767) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_29 <= 0.8256935179233551) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_37 <= 1.2283590734004974) THEN 3 ELSE 4 END ELSE 5 END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_66 <= -1.5169755816459656) THEN 7 ELSE 8 END END AS node_id_2 
FROM "TMP_20221018184911_WPLMGRX_ADS_sca_2_OUT" AS "ADS_sca_2_OUT"), 
"DT_node_data_4" AS 
(SELECT "Values".nid AS nid, "Values"."P_0" AS "P_0", "Values"."P_1" AS "P_1", "Values"."D" AS "D", "Values"."DP" AS "DP" 
...
FROM "DT_Output_6"), 
"DT_node_lookup_7" AS 
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", CASE WHEN ("ADS_sca_2_OUT".scaler_59 <= 0.14999675005674362) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_62 <= -2.1253793239593506) THEN 2 ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_73 <= -1.9187528491020203) THEN 4 ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_25 <= -1.7923303246498108) THEN 6 ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_77 <= 1.6204426884651184) THEN 8 ELSE 9 END END END END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_24 <= -1.679437279701233) THEN 11 ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_85 <= 2.201670229434967) THEN 13 ELSE 14 END END END AS node_id_2 
FROM "TMP_20221018184911_WPLMGRX_ADS_sca_2_OUT" AS "ADS_sca_2_OUT"), 
"DT_node_data_7" AS 
(SELECT "Values".nid AS nid, "Values"."P_0" AS "P_0", "Values"."P_1" AS "P_1", "Values"."D" AS "D", "Values"."DP" AS "DP" 
...
FROM "DT_Output_7"), 
"DT_node_lookup_8" AS 
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", CASE WHEN ("ADS_sca_2_OUT".scaler_59 <= 0.06653057038784027) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_11 <= 2.1140206456184387) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_19 <= 0.878835916519165) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_43 <= 1.929405689239502) THEN 4 ELSE 5 END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_27 <= 0.6572396531701088) THEN 7 ELSE 8 END END ELSE 9 END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_20 <= 1.2006861567497253) THEN 11 ELSE 12 END END AS node_id_2 
FROM "TMP_20221018184911_WPLMGRX_ADS_sca_2_OUT" AS "ADS_sca_2_OUT"), 
"DT_node_data_8" AS 
(SELECT "Values".nid AS nid, "Values"."P_0" AS "P_0", "Values"."P_1" AS "P_1", "Values"."D" AS "D", "Values"."DP" AS "DP" 
...
FROM "DT_Output_8"), 
"DT_node_lookup_9" AS 
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", CASE WHEN ("ADS_sca_2_OUT".scaler_59 <= -0.19454891979694366) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_62 <= -2.5164467096328735) THEN 2 ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_21 <= -1.6022401452064514) THEN 4 ELSE 5 END END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_66 <= -0.7599038779735565) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_37 <= 0.6729622185230255) THEN 8 ELSE 9 END ELSE 10 END END AS node_id_2 
FROM "TMP_20221018184911_WPLMGRX_ADS_sca_2_OUT" AS "ADS_sca_2_OUT"), 
"DT_node_data_9" AS 
(SELECT "Values".nid AS nid, "Values"."P_0" AS "P_0", "Values"."P_1" AS "P_1", "Values"."D" AS "D", "Values"."DP" AS "DP" 
...
FROM "DT_Output_9")
 INSERT INTO "TMP_20221018184911_JILZXF7_BAG_B0" ("KEY", "Score_0", "Proba_0", "LogProba_0", "Score_1", "Proba_1", "LogProba_1") SELECT "T"."KEY", "T"."Score_0", "T"."Proba_0", "T"."LogProba_0", "T"."Score_1", "T"."Proba_1", "T"."LogProba_1" 
...
-- Code For temporary table TMP_20221018184911_AOVOKMC_BAG_B1 part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221018184911_AOVOKMC_BAG_B1" (
	"KEY" BIGINT, 
	"Score_0" DOUBLE, 
	"Proba_0" DOUBLE, 
	"LogProba_0" DOUBLE, 
...
-- Code For temporary table TMP_20221018184911_AOVOKMC_BAG_B1 part 2. Populate

WITH "DT_node_lookup_10" AS 
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", CASE WHEN ("ADS_sca_2_OUT".scaler_59 <= -0.1771824061870575) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_73 <= -1.9187528491020203) THEN 2 ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_19 <= 1.389384150505066) THEN 4 ELSE 5 END END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_97 <= 1.4739298224449158) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_74 <= 2.2325390577316284) THEN 8 ELSE 9 END ELSE 10 END END AS node_id_2 
FROM "TMP_20221018184911_WPLMGRX_ADS_sca_2_OUT" AS "ADS_sca_2_OUT"), 
"DT_node_data_10" AS 
(SELECT "Values".nid AS nid, "Values"."P_0" AS "P_0", "Values"."P_1" AS "P_1", "Values"."D" AS "D", "Values"."DP" AS "DP" 
...
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", CASE WHEN ("ADS_sca_2_OUT".scaler_59 <= 0.43659448623657227) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_62 <= -1.7143091559410095) THEN 2 ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_53 <= 1.6054193377494812) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_66 <= -2.2533167600631714) THEN 5 ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_82 <= -1.7854840755462646) THEN 7 ELSE 8 END END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_77 <= 0.40223762206733227) THEN 10 ELSE 11 END END END ELSE 12 END AS node_id_2 
FROM "TMP_20221018184911_WPLMGRX_ADS_sca_2_OUT" AS "ADS_sca_2_OUT"), 
"DT_node_data_12" AS 
(SELECT "Values".nid AS nid, "Values"."P_0" AS "P_0", "Values"."P_1" AS "P_1", "Values"."D" AS "D", "Values"."DP" AS "DP" 
FROM (SELECT 2 AS nid, 0.0 AS "P_0", 1.0 AS "P_1", 1 AS "D", 1.0 AS "DP" UNION ALL SELECT 5 AS nid, 0.0 AS "P_0", 1.0 AS "P_1", 1 AS "D", 1.0 AS "DP" UNION ALL SELECT 7 AS nid, 0.0 AS "P_0", 1.0 AS "P_1", 1 AS "D", 1.0 AS "DP" UNION ALL SELECT 8 AS nid, 1.0 AS "P_0", 0.0 AS "P_1", 0 AS "D", 1.0 AS "DP" UNION ALL SELECT 10 AS nid, 0.0 AS "P_0", 1.0 AS "P_1", 1 AS "D", 1.0 AS "DP" UNION ALL SELECT 11 AS nid, 1.0 AS "P_0", 0.0 AS "P_1", 0 AS "D", 1.0 AS "DP" UNION ALL SELECT 12 AS nid, 0.0 AS "P_0", 1.0 AS "P_1", 1 AS "D", 1.0 AS "DP") AS "Values"), 
...
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", CASE WHEN ("ADS_sca_2_OUT".scaler_59 <= 0.14999675005674362) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_32 <= 1.3981027007102966) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_51 <= -1.5705016255378723) THEN 3 ELSE 4 END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_70 <= 0.3612929508090019) THEN 6 ELSE 7 END END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_88 <= 1.0583268404006958) THEN 9 ELSE 10 END END AS node_id_2 
FROM "TMP_20221018184911_WPLMGRX_ADS_sca_2_OUT" AS "ADS_sca_2_OUT"), 
"DT_node_data_13" AS 
(SELECT "Values".nid AS nid, "Values"."P_0" AS "P_0", "Values"."P_1" AS "P_1", "Values"."D" AS "D", "Values"."DP" AS "DP" 
FROM (SELECT 3 AS nid, 0.0 AS "P_0", 1.0 AS "P_1", 1 AS "D", 1.0 AS "DP" UNION ALL SELECT 4 AS nid, 1.0 AS "P_0", 0.0 AS "P_1", 0 AS "D", 1.0 AS "DP" UNION ALL SELECT 6 AS nid, 0.0 AS "P_0", 1.0 AS "P_1", 1 AS "D", 1.0 AS "DP" UNION ALL SELECT 7 AS nid, 1.0 AS "P_0", 0.0 AS "P_1", 0 AS "D", 1.0 AS "DP" UNION ALL SELECT 9 AS nid, 0.0 AS "P_0", 1.0 AS "P_1", 1 AS "D", 1.0 AS "DP" UNION ALL SELECT 10 AS nid, 1.0 AS "P_0", 0.0 AS "P_1", 0 AS "D", 1.0 AS "DP") AS "Values"), 
...
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", CASE WHEN ("ADS_sca_2_OUT".scaler_59 <= 0.06653057038784027) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_39 <= 1.51248037815094) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_20 <= -0.785609245300293) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_87 <= 0.2834956720471382) THEN 4 ELSE 5 END ELSE 6 END ELSE 7 END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_49 <= -1.429294466972351) THEN 9 ELSE 10 END END AS node_id_2 
FROM "TMP_20221018184911_WPLMGRX_ADS_sca_2_OUT" AS "ADS_sca_2_OUT"), 
"DT_node_data_14" AS 
(SELECT "Values".nid AS nid, "Values"."P_0" AS "P_0", "Values"."P_1" AS "P_1", "Values"."D" AS "D", "Values"."DP" AS "DP" 
...
FROM "DT_Output_15")
 INSERT INTO "TMP_20221018184911_AOVOKMC_BAG_B1" ("KEY", "Score_0", "Proba_0", "LogProba_0", "Score_1", "Proba_1", "LogProba_1") SELECT "T"."KEY", "T"."Score_0", "T"."Proba_0", "T"."LogProba_0", "T"."Score_1", "T"."Proba_1", "T"."LogProba_1" 
...
-- Code For temporary table TMP_20221018184911_C3ANE61_BAG_avg part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221018184911_C3ANE61_BAG_avg" (
	"KEY" BIGINT NOT NULL, 
	"Score_0" DOUBLE, 
	"Proba_0" DOUBLE, 
	"LogProba_0" DOUBLE, 
...
-- Code For temporary table TMP_20221018184911_C3ANE61_BAG_avg part 2. Populate
...
FROM (SELECT "BAG_B0"."KEY" AS "KEY", "BAG_B0"."Score_0" AS "Score_0", "BAG_B0"."Proba_0" AS "Proba_0", "BAG_B0"."LogProba_0" AS "LogProba_0", "BAG_B0"."Score_1" AS "Score_1", "BAG_B0"."Proba_1" AS "Proba_1", "BAG_B0"."LogProba_1" AS "LogProba_1" 
FROM "TMP_20221018184911_JILZXF7_BAG_B0" AS "BAG_B0" UNION ALL SELECT "BAG_B1"."KEY" AS "KEY", "BAG_B1"."Score_0" AS "Score_0", "BAG_B1"."Proba_0" AS "Proba_0", "BAG_B1"."LogProba_0" AS "LogProba_0", "BAG_B1"."Score_1" AS "Score_1", "BAG_B1"."Proba_1" AS "Proba_1", "BAG_B1"."LogProba_1" AS "LogProba_1" 
FROM "TMP_20221018184911_AOVOKMC_BAG_B1" AS "BAG_B1") AS "BAG_EnsembleUnion")
 INSERT INTO "TMP_20221018184911_C3ANE61_BAG_avg" ("KEY", "Score_0", "Proba_0", "LogProba_0", "Score_1", "Proba_1", "LogProba_1") SELECT "T"."KEY", "T"."Score_0", "T"."Proba_0", "T"."LogProba_0", "T"."Score_1", "T"."Proba_1", "T"."LogProba_1" 
...
-- Code For temporary table TMP_20221018184911_C3ANE61_BAG_avg part 3. Create Index 

CREATE INDEX "ix_TMP_20221018184911_C3ANE61_BAG_avg_KEY" ON "TMP_20221018184911_C3ANE61_BAG_avg" ("KEY")
...
FROM "TMP_20221018184911_C3ANE61_BAG_avg" AS "BAG_avg"), 
