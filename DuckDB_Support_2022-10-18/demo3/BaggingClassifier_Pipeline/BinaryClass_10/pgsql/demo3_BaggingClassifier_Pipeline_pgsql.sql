...
-- Code For temporary table TMP_20221018184800_L588T1D_ADS_imp_1_OUT part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221018184800_L588T1D_ADS_imp_1_OUT" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20221018184800_L588T1D_ADS_imp_1_OUT part 3. Create Index 

CREATE INDEX "ix_TMP_20221018184800_L588T1D_ADS_imp_1_OUT_KEY" ON "TMP_20221018184800_L588T1D_ADS_imp_1_OUT" ("KEY")

-- Code For temporary table TMP_20221018184800_KITUI4D_ADS_sca_2_OUT part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221018184800_KITUI4D_ADS_sca_2_OUT" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20221018184800_KITUI4D_ADS_sca_2_OUT part 2. Populate

INSERT INTO "TMP_20221018184800_KITUI4D_ADS_sca_2_OUT" ("KEY", scaler_output_2, scaler_output_3, scaler_output_4, scaler_output_5, scaler_output_6, scaler_output_7, scaler_output_8, scaler_output_9, scaler_output_10, scaler_output_11) SELECT "T"."KEY", "T".scaler_output_2, "T".scaler_output_3, "T".scaler_output_4, "T".scaler_output_5, "T".scaler_output_6, "T".scaler_output_7, "T".scaler_output_8, "T".scaler_output_9, "T".scaler_output_10, "T".scaler_output_11 
...
FROM "TMP_20221018184800_L588T1D_ADS_imp_1_OUT" AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT") AS "T"

-- Code For temporary table TMP_20221018184800_KITUI4D_ADS_sca_2_OUT part 3. Create Index 

CREATE INDEX "ix_TMP_20221018184800_KITUI4D_ADS_sca_2_OUT_KEY" ON "TMP_20221018184800_KITUI4D_ADS_sca_2_OUT" ("KEY")

-- Code For temporary table TMP_20221018184800_5L6BXT7_BAG_B0 part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221018184800_5L6BXT7_BAG_B0" (
	"KEY" BIGINT, 
	"Score_0" FLOAT, 
	"Proba_0" FLOAT, 
	"LogProba_0" FLOAT, 
...
-- Code For temporary table TMP_20221018184800_5L6BXT7_BAG_B0 part 2. Populate

WITH "DT_node_lookup" AS 
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", CASE WHEN ("ADS_sca_2_OUT".scaler_output_11 <= -0.12136754393577576) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_output_6 <= -1.7737327218055725) THEN 2 ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_output_8 <= 1.4502137303352356) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_output_7 <= -1.033427655696869) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_output_10 <= 0.29620200768113136) THEN 6 ELSE 7 END ELSE 8 END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_output_8 <= 2.0757689476013184) THEN 10 ELSE 11 END END END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_output_8 <= 1.7904822826385498) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_output_10 <= -1.6143869161605835) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_output_6 <= 0.36320894956588745) THEN 15 ELSE 16 END ELSE 17 END ELSE 18 END END AS node_id_2 
FROM "TMP_20221018184800_KITUI4D_ADS_sca_2_OUT" AS "ADS_sca_2_OUT"), 
"DT_node_data" AS 
...
FROM "DT_Output"), 
"DT_node_lookup_1" AS 
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", CASE WHEN ("ADS_sca_2_OUT".scaler_output_11 <= 0.39982809126377106) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_output_8 <= -1.5110454559326172) THEN 2 ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_output_5 <= 1.362203299999237) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_output_7 <= 1.9527092576026917) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_output_10 <= -1.2812311053276062) THEN 6 ELSE 7 END ELSE 8 END ELSE 9 END END ELSE 10 END AS node_id_2 
FROM "TMP_20221018184800_KITUI4D_ADS_sca_2_OUT" AS "ADS_sca_2_OUT"), 
"DT_node_data_1" AS 
(SELECT "Values".nid AS nid, "Values"."P_0" AS "P_0", "Values"."P_1" AS "P_1", "Values"."D" AS "D", "Values"."DP" AS "DP" 
...
FROM "DT_Output_1"), 
"DT_node_lookup_2" AS 
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", CASE WHEN ("ADS_sca_2_OUT".scaler_output_11 <= 0.3664867579936981) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_output_7 <= 1.8312154412269592) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_output_5 <= 1.496748447418213) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_output_4 <= 1.6820805072784424) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_output_10 <= 1.4047289490699768) THEN 5 ELSE 6 END ELSE 7 END ELSE 8 END ELSE 9 END ELSE 10 END AS node_id_2 
FROM "TMP_20221018184800_KITUI4D_ADS_sca_2_OUT" AS "ADS_sca_2_OUT"), 
"DT_node_data_2" AS 
(SELECT "Values".nid AS nid, "Values"."P_0" AS "P_0", "Values"."P_1" AS "P_1", "Values"."D" AS "D", "Values"."DP" AS "DP" 
...
FROM "DT_Output_2"), 
"DT_node_lookup_3" AS 
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", CASE WHEN ("ADS_sca_2_OUT".scaler_output_11 <= 0.35896430909633636) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_output_4 <= 1.6699108481407166) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_output_5 <= 1.496748447418213) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_output_7 <= 1.9527092576026917) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_output_7 <= -1.2437323331832886) THEN 5 ELSE 6 END ELSE 7 END ELSE 8 END ELSE 9 END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_output_8 <= 1.8911219835281372) THEN 11 ELSE 12 END END AS node_id_2 
FROM "TMP_20221018184800_KITUI4D_ADS_sca_2_OUT" AS "ADS_sca_2_OUT"), 
"DT_node_data_3" AS 
(SELECT "Values".nid AS nid, "Values"."P_0" AS "P_0", "Values"."P_1" AS "P_1", "Values"."D" AS "D", "Values"."DP" AS "DP" 
...
FROM "DT_Output_3"), 
"DT_node_lookup_4" AS 
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", CASE WHEN ("ADS_sca_2_OUT".scaler_output_11 <= -0.12136754393577576) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_output_7 <= 1.683287799358368) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_output_7 <= -1.2264688611030579) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_output_9 <= 0.83046755194664) THEN 4 ELSE 5 END ELSE 6 END ELSE 7 END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_output_8 <= 1.7904822826385498) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_output_5 <= -0.8533546328544617) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_output_2 <= -0.09680383466184139) THEN 11 ELSE 12 END ELSE 13 END ELSE 14 END END AS node_id_2 
FROM "TMP_20221018184800_KITUI4D_ADS_sca_2_OUT" AS "ADS_sca_2_OUT"), 
"DT_node_data_4" AS 
(SELECT "Values".nid AS nid, "Values"."P_0" AS "P_0", "Values"."P_1" AS "P_1", "Values"."D" AS "D", "Values"."DP" AS "DP" 
...
FROM "DT_Output_4"), 
"DT_node_lookup_5" AS 
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", CASE WHEN ("ADS_sca_2_OUT".scaler_output_11 <= 0.07101128064095974) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_output_4 <= 1.4218817949295044) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_output_7 <= 1.5617939829826355) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_output_5 <= 1.496748447418213) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_output_5 <= 0.8926777243614197) THEN 5 ELSE 6 END ELSE 7 END ELSE 8 END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_output_7 <= -0.7541185617446899) THEN 10 ELSE 11 END END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_output_6 <= 1.2690861821174622) THEN 13 ELSE 14 END END AS node_id_2 
FROM "TMP_20221018184800_KITUI4D_ADS_sca_2_OUT" AS "ADS_sca_2_OUT"), 
"DT_node_data_5" AS 
(SELECT "Values".nid AS nid, "Values"."P_0" AS "P_0", "Values"."P_1" AS "P_1", "Values"."D" AS "D", "Values"."DP" AS "DP" 
...
FROM "DT_Output_6"), 
"DT_node_lookup_7" AS 
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", CASE WHEN ("ADS_sca_2_OUT".scaler_output_11 <= 0.15696154348552227) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_output_7 <= 1.7556507587432861) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_output_7 <= -1.0403141975402832) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_output_9 <= 0.7946671843528748) THEN 4 ELSE 5 END ELSE 6 END ELSE 7 END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_output_8 <= 1.7904822826385498) THEN 9 ELSE 10 END END AS node_id_2 
FROM "TMP_20221018184800_KITUI4D_ADS_sca_2_OUT" AS "ADS_sca_2_OUT"), 
"DT_node_data_7" AS 
(SELECT "Values".nid AS nid, "Values"."P_0" AS "P_0", "Values"."P_1" AS "P_1", "Values"."D" AS "D", "Values"."DP" AS "DP" 
...
FROM "DT_Output_7"), 
"DT_node_lookup_8" AS 
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", CASE WHEN ("ADS_sca_2_OUT".scaler_output_11 <= 0.35896430909633636) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_output_7 <= 1.8312154412269592) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_output_5 <= 1.0201719403266907) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_output_4 <= 1.6155323386192322) THEN 4 ELSE 5 END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_output_8 <= -0.022482816129922867) THEN 7 ELSE 8 END END ELSE 9 END ELSE 10 END AS node_id_2 
FROM "TMP_20221018184800_KITUI4D_ADS_sca_2_OUT" AS "ADS_sca_2_OUT"), 
"DT_node_data_8" AS 
(SELECT "Values".nid AS nid, "Values"."P_0" AS "P_0", "Values"."P_1" AS "P_1", "Values"."D" AS "D", "Values"."DP" AS "DP" 
...
FROM "DT_Output_9")
 INSERT INTO "TMP_20221018184800_5L6BXT7_BAG_B0" ("KEY", "Score_0", "Proba_0", "LogProba_0", "Score_1", "Proba_1", "LogProba_1") SELECT "T"."KEY", "T"."Score_0", "T"."Proba_0", "T"."LogProba_0", "T"."Score_1", "T"."Proba_1", "T"."LogProba_1" 
...
-- Code For temporary table TMP_20221018184800_178EG1K_BAG_B1 part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221018184800_178EG1K_BAG_B1" (
	"KEY" BIGINT, 
	"Score_0" FLOAT, 
	"Proba_0" FLOAT, 
	"LogProba_0" FLOAT, 
...
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", CASE WHEN ("ADS_sca_2_OUT".scaler_output_11 <= -0.2916967272758484) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_output_8 <= 1.4718672037124634) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_output_5 <= 1.0299373269081116) THEN 3 ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_output_10 <= -0.12137558683753014) THEN 5 ELSE 6 END END ELSE 7 END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_output_8 <= 1.7904822826385498) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_output_11 <= 0.010654184967279434) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_output_11 <= -0.08907217159867287) THEN 11 ELSE 12 END ELSE 13 END ELSE 14 END END AS node_id_2 
FROM "TMP_20221018184800_KITUI4D_ADS_sca_2_OUT" AS "ADS_sca_2_OUT"), 
"DT_node_data_11" AS 
(SELECT "Values".nid AS nid, "Values"."P_0" AS "P_0", "Values"."P_1" AS "P_1", "Values"."D" AS "D", "Values"."DP" AS "DP" 
...
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", CASE WHEN ("ADS_sca_2_OUT".scaler_output_11 <= 0.07101128064095974) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_output_5 <= 1.496748447418213) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_output_4 <= 1.6699108481407166) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_output_5 <= 1.0084945261478424) THEN 4 ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_output_6 <= 0.341822799295187) THEN 6 ELSE 7 END END ELSE 8 END ELSE 9 END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_output_8 <= 1.8911219835281372) THEN 11 ELSE 12 END END AS node_id_2 
FROM "TMP_20221018184800_KITUI4D_ADS_sca_2_OUT" AS "ADS_sca_2_OUT"), 
"DT_node_data_12" AS 
(SELECT "Values".nid AS nid, "Values"."P_0" AS "P_0", "Values"."P_1" AS "P_1", "Values"."D" AS "D", "Values"."DP" AS "DP" 
FROM (SELECT 4 AS nid, 1.0 AS "P_0", 0.0 AS "P_1", 0 AS "D", 1.0 AS "DP" UNION ALL SELECT 6 AS nid, 0.0 AS "P_0", 1.0 AS "P_1", 1 AS "D", 1.0 AS "DP" UNION ALL SELECT 7 AS nid, 1.0 AS "P_0", 0.0 AS "P_1", 0 AS "D", 1.0 AS "DP" UNION ALL SELECT 8 AS nid, 0.0 AS "P_0", 1.0 AS "P_1", 1 AS "D", 1.0 AS "DP" UNION ALL SELECT 9 AS nid, 0.0 AS "P_0", 1.0 AS "P_1", 1 AS "D", 1.0 AS "DP" UNION ALL SELECT 11 AS nid, 0.0 AS "P_0", 1.0 AS "P_1", 1 AS "D", 1.0 AS "DP" UNION ALL SELECT 12 AS nid, 1.0 AS "P_0", 0.0 AS "P_1", 0 AS "D", 1.0 AS "DP") AS "Values"), 
...
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", CASE WHEN ("ADS_sca_2_OUT".scaler_output_11 <= -0.17995495349168777) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_output_7 <= 1.7556507587432861) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_output_8 <= 1.4718672037124634) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_output_11 <= -0.3295293301343918) THEN 4 ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_output_4 <= -0.012737154960632324) THEN 6 ELSE 7 END END ELSE 8 END ELSE 9 END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_output_8 <= 1.6110403537750244) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_output_10 <= -1.4374989867210388) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_output_5 <= -0.5551635399460793) THEN 13 ELSE 14 END ELSE 15 END ELSE 16 END END AS node_id_2 
FROM "TMP_20221018184800_KITUI4D_ADS_sca_2_OUT" AS "ADS_sca_2_OUT"), 
"DT_node_data_13" AS 
(SELECT "Values".nid AS nid, "Values"."P_0" AS "P_0", "Values"."P_1" AS "P_1", "Values"."D" AS "D", "Values"."DP" AS "DP" 
...
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", CASE WHEN ("ADS_sca_2_OUT".scaler_output_11 <= -0.12136754393577576) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_output_7 <= 1.7556507587432861) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_output_5 <= 1.0299373269081116) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_output_4 <= 1.6699108481407166) THEN 4 ELSE 5 END ELSE 6 END ELSE 7 END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_output_8 <= 1.8911219835281372) THEN 9 ELSE 10 END END AS node_id_2 
FROM "TMP_20221018184800_KITUI4D_ADS_sca_2_OUT" AS "ADS_sca_2_OUT"), 
"DT_node_data_14" AS 
(SELECT "Values".nid AS nid, "Values"."P_0" AS "P_0", "Values"."P_1" AS "P_1", "Values"."D" AS "D", "Values"."DP" AS "DP" 
FROM (SELECT 4 AS nid, 1.0 AS "P_0", 0.0 AS "P_1", 0 AS "D", 1.0 AS "DP" UNION ALL SELECT 5 AS nid, 0.0 AS "P_0", 1.0 AS "P_1", 1 AS "D", 1.0 AS "DP" UNION ALL SELECT 6 AS nid, 0.0 AS "P_0", 1.0 AS "P_1", 1 AS "D", 1.0 AS "DP" UNION ALL SELECT 7 AS nid, 0.0 AS "P_0", 1.0 AS "P_1", 1 AS "D", 1.0 AS "DP" UNION ALL SELECT 9 AS nid, 0.0 AS "P_0", 1.0 AS "P_1", 1 AS "D", 1.0 AS "DP" UNION ALL SELECT 10 AS nid, 1.0 AS "P_0", 0.0 AS "P_1", 0 AS "D", 1.0 AS "DP") AS "Values"), 
...
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", CASE WHEN ("ADS_sca_2_OUT".scaler_output_11 <= 0.07101128064095974) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_output_7 <= -0.8114416599273682) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_output_11 <= -0.6371528804302216) THEN 3 ELSE 4 END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_output_3 <= 1.9242610931396484) THEN 6 ELSE 7 END END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_output_5 <= -1.061799794435501) THEN 9 ELSE 10 END END AS node_id_2 
FROM "TMP_20221018184800_KITUI4D_ADS_sca_2_OUT" AS "ADS_sca_2_OUT"), 
"DT_node_data_15" AS 
(SELECT "Values".nid AS nid, "Values"."P_0" AS "P_0", "Values"."P_1" AS "P_1", "Values"."D" AS "D", "Values"."DP" AS "DP" 
...
FROM "DT_Output_15")
 INSERT INTO "TMP_20221018184800_178EG1K_BAG_B1" ("KEY", "Score_0", "Proba_0", "LogProba_0", "Score_1", "Proba_1", "LogProba_1") SELECT "T"."KEY", "T"."Score_0", "T"."Proba_0", "T"."LogProba_0", "T"."Score_1", "T"."Proba_1", "T"."LogProba_1" 
...
-- Code For temporary table TMP_20221018184800_UBABM9K_BAG_avg part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221018184800_UBABM9K_BAG_avg" (
	"KEY" BIGINT NOT NULL, 
	"Score_0" FLOAT, 
	"Proba_0" FLOAT, 
	"LogProba_0" FLOAT, 
...
-- Code For temporary table TMP_20221018184800_UBABM9K_BAG_avg part 2. Populate
...
FROM (SELECT "BAG_B0"."KEY" AS "KEY", "BAG_B0"."Score_0" AS "Score_0", "BAG_B0"."Proba_0" AS "Proba_0", "BAG_B0"."LogProba_0" AS "LogProba_0", "BAG_B0"."Score_1" AS "Score_1", "BAG_B0"."Proba_1" AS "Proba_1", "BAG_B0"."LogProba_1" AS "LogProba_1" 
FROM "TMP_20221018184800_5L6BXT7_BAG_B0" AS "BAG_B0" UNION ALL SELECT "BAG_B1"."KEY" AS "KEY", "BAG_B1"."Score_0" AS "Score_0", "BAG_B1"."Proba_0" AS "Proba_0", "BAG_B1"."LogProba_0" AS "LogProba_0", "BAG_B1"."Score_1" AS "Score_1", "BAG_B1"."Proba_1" AS "Proba_1", "BAG_B1"."LogProba_1" AS "LogProba_1" 
FROM "TMP_20221018184800_178EG1K_BAG_B1" AS "BAG_B1") AS "BAG_EnsembleUnion")
 INSERT INTO "TMP_20221018184800_UBABM9K_BAG_avg" ("KEY", "Score_0", "Proba_0", "LogProba_0", "Score_1", "Proba_1", "LogProba_1") SELECT "T"."KEY", "T"."Score_0", "T"."Proba_0", "T"."LogProba_0", "T"."Score_1", "T"."Proba_1", "T"."LogProba_1" 
...
-- Code For temporary table TMP_20221018184800_UBABM9K_BAG_avg part 3. Create Index 

CREATE INDEX "ix_TMP_20221018184800_UBABM9K_BAG_avg_KEY" ON "TMP_20221018184800_UBABM9K_BAG_avg" ("KEY")
...
FROM "TMP_20221018184800_UBABM9K_BAG_avg" AS "BAG_avg"), 
