...
-- Code For temporary table TMP_20221018190413_MS600H1_GB_B0 part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221018190413_MS600H1_GB_B0" (
	"KEY" BIGINT, 
	"Score_0" DOUBLE, 
	"Score_1" DOUBLE, 
	"Score_2" DOUBLE
...
-- Code For temporary table TMP_20221018190413_MS600H1_GB_B0 part 2. Populate
...
FROM "DT_Output_9")
 INSERT INTO "TMP_20221018190413_MS600H1_GB_B0" ("KEY", "Score_0", "Score_1", "Score_2") SELECT "T"."KEY", "T"."Score_0", "T"."Score_1", "T"."Score_2" 
...
-- Code For temporary table TMP_20221018190413_ENQDWNN_GB_B1 part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221018190413_ENQDWNN_GB_B1" (
	"KEY" BIGINT, 
	"Score_0" DOUBLE, 
	"Score_1" DOUBLE, 
	"Score_2" DOUBLE
...
-- Code For temporary table TMP_20221018190413_ENQDWNN_GB_B1 part 2. Populate
...
FROM "DT_Output_19")
 INSERT INTO "TMP_20221018190413_ENQDWNN_GB_B1" ("KEY", "Score_0", "Score_1", "Score_2") SELECT "T"."KEY", "T"."Score_0", "T"."Score_1", "T"."Score_2" 
...
-- Code For temporary table TMP_20221018190413_UOCAB6P_GB_B2 part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221018190413_UOCAB6P_GB_B2" (
	"KEY" BIGINT, 
	"Score_0" DOUBLE, 
	"Score_1" DOUBLE, 
	"Score_2" DOUBLE
...
-- Code For temporary table TMP_20221018190413_UOCAB6P_GB_B2 part 2. Populate
...
FROM "DT_Output_29")
 INSERT INTO "TMP_20221018190413_UOCAB6P_GB_B2" ("KEY", "Score_0", "Score_1", "Score_2") SELECT "T"."KEY", "T"."Score_0", "T"."Score_1", "T"."Score_2" 
...
-- Code For temporary table TMP_20221018190413_FS2JMG7_GB_B3 part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221018190413_FS2JMG7_GB_B3" (
	"KEY" BIGINT, 
	"Score_0" DOUBLE, 
	"Score_1" DOUBLE, 
	"Score_2" DOUBLE
...
-- Code For temporary table TMP_20221018190413_FS2JMG7_GB_B3 part 2. Populate
...
FROM "DT_Output_39")
 INSERT INTO "TMP_20221018190413_FS2JMG7_GB_B3" ("KEY", "Score_0", "Score_1", "Score_2") SELECT "T"."KEY", "T"."Score_0", "T"."Score_1", "T"."Score_2" 
...
-- Code For temporary table TMP_20221018190413_BUM7B5R_GB_B4 part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221018190413_BUM7B5R_GB_B4" (
	"KEY" BIGINT, 
	"Score_0" DOUBLE, 
	"Score_1" DOUBLE, 
	"Score_2" DOUBLE
...
-- Code For temporary table TMP_20221018190413_BUM7B5R_GB_B4 part 2. Populate
...
FROM "DT_Output_47")
 INSERT INTO "TMP_20221018190413_BUM7B5R_GB_B4" ("KEY", "Score_0", "Score_1", "Score_2") SELECT "T"."KEY", "T"."Score_0", "T"."Score_1", "T"."Score_2" 
...
-- Code For temporary table TMP_20221018190413_8T8GYUF_GB_sum part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221018190413_8T8GYUF_GB_sum" (
	"KEY" BIGINT NOT NULL, 
	"Score_0" DOUBLE, 
	"Score_1" DOUBLE, 
	"Score_2" DOUBLE, 
...
-- Code For temporary table TMP_20221018190413_8T8GYUF_GB_sum part 2. Populate
...
FROM (SELECT "GB_B0"."KEY" AS "KEY", "GB_B0"."Score_0" AS "Score_0", "GB_B0"."Score_1" AS "Score_1", "GB_B0"."Score_2" AS "Score_2" 
FROM "TMP_20221018190413_MS600H1_GB_B0" AS "GB_B0" UNION ALL SELECT "GB_B1"."KEY" AS "KEY", "GB_B1"."Score_0" AS "Score_0", "GB_B1"."Score_1" AS "Score_1", "GB_B1"."Score_2" AS "Score_2" 
FROM "TMP_20221018190413_ENQDWNN_GB_B1" AS "GB_B1" UNION ALL SELECT "GB_B2"."KEY" AS "KEY", "GB_B2"."Score_0" AS "Score_0", "GB_B2"."Score_1" AS "Score_1", "GB_B2"."Score_2" AS "Score_2" 
FROM "TMP_20221018190413_UOCAB6P_GB_B2" AS "GB_B2" UNION ALL SELECT "GB_B3"."KEY" AS "KEY", "GB_B3"."Score_0" AS "Score_0", "GB_B3"."Score_1" AS "Score_1", "GB_B3"."Score_2" AS "Score_2" 
FROM "TMP_20221018190413_FS2JMG7_GB_B3" AS "GB_B3" UNION ALL SELECT "GB_B4"."KEY" AS "KEY", "GB_B4"."Score_0" AS "Score_0", "GB_B4"."Score_1" AS "Score_1", "GB_B4"."Score_2" AS "Score_2" 
FROM "TMP_20221018190413_BUM7B5R_GB_B4" AS "GB_B4") AS "GB_EnsembleUnion")
 INSERT INTO "TMP_20221018190413_8T8GYUF_GB_sum" ("KEY", "Score_0", "Score_1", "Score_2") SELECT "T"."KEY", "T"."Score_0", "T"."Score_1", "T"."Score_2" 
...
-- Code For temporary table TMP_20221018190413_8T8GYUF_GB_sum part 3. Create Index 

CREATE INDEX "ix_TMP_20221018190413_8T8GYUF_GB_sum_KEY" ON "TMP_20221018190413_8T8GYUF_GB_sum" ("KEY")
...
FROM "TMP_20221018190413_8T8GYUF_GB_sum" AS "GB_sum"), 
