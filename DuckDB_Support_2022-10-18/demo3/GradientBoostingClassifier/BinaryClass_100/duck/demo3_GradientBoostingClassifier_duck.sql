...
-- Code For temporary table TMP_20221018184936_XHRMK87_GB_B0 part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221018184936_XHRMK87_GB_B0" (
	"KEY" BIGINT, 
	"Score_0" DOUBLE, 
	"Score_1" DOUBLE
)
...
-- Code For temporary table TMP_20221018184936_XHRMK87_GB_B0 part 2. Populate
...
FROM "DT_Output_4")
 INSERT INTO "TMP_20221018184936_XHRMK87_GB_B0" ("KEY", "Score_0", "Score_1") SELECT "T"."KEY", "T"."Score_0", "T"."Score_1" 
...
-- Code For temporary table TMP_20221018184936_91HFR8P_GB_B1 part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221018184936_91HFR8P_GB_B1" (
	"KEY" BIGINT, 
	"Score_0" DOUBLE, 
	"Score_1" DOUBLE
)
...
-- Code For temporary table TMP_20221018184936_91HFR8P_GB_B1 part 2. Populate
...
FROM "DT_Output_9")
 INSERT INTO "TMP_20221018184936_91HFR8P_GB_B1" ("KEY", "Score_0", "Score_1") SELECT "T"."KEY", "T"."Score_0", "T"."Score_1" 
...
-- Code For temporary table TMP_20221018184936_WBPWVZZ_GB_B2 part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221018184936_WBPWVZZ_GB_B2" (
	"KEY" BIGINT, 
	"Score_0" DOUBLE, 
	"Score_1" DOUBLE
)
...
-- Code For temporary table TMP_20221018184936_WBPWVZZ_GB_B2 part 2. Populate
...
FROM "DT_Output_14")
 INSERT INTO "TMP_20221018184936_WBPWVZZ_GB_B2" ("KEY", "Score_0", "Score_1") SELECT "T"."KEY", "T"."Score_0", "T"."Score_1" 
...
-- Code For temporary table TMP_20221018184936_A6G19IE_GB_B3 part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221018184936_A6G19IE_GB_B3" (
	"KEY" BIGINT, 
	"Score_0" DOUBLE, 
	"Score_1" DOUBLE
)
...
-- Code For temporary table TMP_20221018184936_A6G19IE_GB_B3 part 2. Populate
...
FROM "DT_Output_15")
 INSERT INTO "TMP_20221018184936_A6G19IE_GB_B3" ("KEY", "Score_0", "Score_1") SELECT "T"."KEY", "T"."Score_0", "T"."Score_1" 
...
-- Code For temporary table TMP_20221018184936_2RFCH4A_GB_sum part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221018184936_2RFCH4A_GB_sum" (
	"KEY" BIGINT NOT NULL, 
	"Score_0" DOUBLE, 
	"Score_1" DOUBLE, 
	PRIMARY KEY ("KEY")
...
-- Code For temporary table TMP_20221018184936_2RFCH4A_GB_sum part 2. Populate

WITH "GB_Union" AS 
(SELECT "GB_EnsembleUnion"."KEY" AS "KEY", "GB_EnsembleUnion"."Score_0" AS "Score_0", "GB_EnsembleUnion"."Score_1" AS "Score_1" 
FROM (SELECT "GB_B0"."KEY" AS "KEY", "GB_B0"."Score_0" AS "Score_0", "GB_B0"."Score_1" AS "Score_1" 
FROM "TMP_20221018184936_XHRMK87_GB_B0" AS "GB_B0" UNION ALL SELECT "GB_B1"."KEY" AS "KEY", "GB_B1"."Score_0" AS "Score_0", "GB_B1"."Score_1" AS "Score_1" 
FROM "TMP_20221018184936_91HFR8P_GB_B1" AS "GB_B1" UNION ALL SELECT "GB_B2"."KEY" AS "KEY", "GB_B2"."Score_0" AS "Score_0", "GB_B2"."Score_1" AS "Score_1" 
FROM "TMP_20221018184936_WBPWVZZ_GB_B2" AS "GB_B2" UNION ALL SELECT "GB_B3"."KEY" AS "KEY", "GB_B3"."Score_0" AS "Score_0", "GB_B3"."Score_1" AS "Score_1" 
FROM "TMP_20221018184936_A6G19IE_GB_B3" AS "GB_B3") AS "GB_EnsembleUnion")
 INSERT INTO "TMP_20221018184936_2RFCH4A_GB_sum" ("KEY", "Score_0", "Score_1") SELECT "T"."KEY", "T"."Score_0", "T"."Score_1" 
...
-- Code For temporary table TMP_20221018184936_2RFCH4A_GB_sum part 3. Create Index 

CREATE INDEX "ix_TMP_20221018184936_2RFCH4A_GB_sum_KEY" ON "TMP_20221018184936_2RFCH4A_GB_sum" ("KEY")
...
FROM "TMP_20221018184936_2RFCH4A_GB_sum" AS "GB_sum"), 
