...
-- Code For temporary table TMP_20221018190641_JFD74V8_ADS_imp_1_OUT part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221018190641_JFD74V8_ADS_imp_1_OUT" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20221018190641_JFD74V8_ADS_imp_1_OUT part 2. Populate

INSERT INTO "TMP_20221018190641_JFD74V8_ADS_imp_1_OUT" ("KEY", imputer_output_2, imputer_output_3, imputer_output_4, imputer_output_5) SELECT "T"."KEY", "T".imputer_output_2, "T".imputer_output_3, "T".imputer_output_4, "T".imputer_output_5 
...
-- Code For temporary table TMP_20221018190641_JFD74V8_ADS_imp_1_OUT part 3. Create Index 

CREATE INDEX "ix_TMP_20221018190641_JFD74V8_ADS_imp_1_OUT_KEY" ON "TMP_20221018190641_JFD74V8_ADS_imp_1_OUT" ("KEY")

-- Code For temporary table TMP_20221018190641_ZFPGFYB_ADS_sca_2_OUT part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221018190641_ZFPGFYB_ADS_sca_2_OUT" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20221018190641_ZFPGFYB_ADS_sca_2_OUT part 2. Populate

INSERT INTO "TMP_20221018190641_ZFPGFYB_ADS_sca_2_OUT" ("KEY", scaler_output_2, scaler_output_3, scaler_output_4, scaler_output_5) SELECT "T"."KEY", "T".scaler_output_2, "T".scaler_output_3, "T".scaler_output_4, "T".scaler_output_5 
...
FROM "TMP_20221018190641_JFD74V8_ADS_imp_1_OUT" AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT") AS "T"

-- Code For temporary table TMP_20221018190641_ZFPGFYB_ADS_sca_2_OUT part 3. Create Index 

CREATE INDEX "ix_TMP_20221018190641_ZFPGFYB_ADS_sca_2_OUT_KEY" ON "TMP_20221018190641_ZFPGFYB_ADS_sca_2_OUT" ("KEY")
...
FROM "TMP_20221018190641_ZFPGFYB_ADS_sca_2_OUT" AS "ADS_sca_2_OUT"), 
linear_model_cte AS 
(SELECT linear_input."KEY" AS "KEY", -1.0191713253927297 * linear_input.scaler_output_2 + 1.1286514286227833 * linear_input.scaler_output_3 + -1.8209700328295162 * linear_input.scaler_output_4 + -1.6411428833359436 * linear_input.scaler_output_5 + -0.4370213363887243 AS "Score_CLASS_0", 0.5805918479393348 * linear_input.scaler_output_2 + -0.3357392244090856 * linear_input.scaler_output_3 + -0.4069536292830881 * linear_input.scaler_output_4 + -0.7767307402370032 * linear_input.scaler_output_5 + 1.921622430636063 AS "Score_CLASS_1", 0.43857947745339454 * linear_input.scaler_output_2 + -0.7929122042136989 * linear_input.scaler_output_3 + 2.2279236621126044 * linear_input.scaler_output_4 + 2.417873623572947 * linear_input.scaler_output_5 + -1.4846010942473393 AS "Score_CLASS_2" 
FROM linear_input), 
linear_model_cte_logistic AS 
(SELECT linear_model_cte."KEY" AS "KEY", linear_model_cte."Score_CLASS_0" AS "Score_CLASS_0", 1.0 / (1.0 + exp(least(100.0, greatest(-100.0, -linear_model_cte."Score_CLASS_0")))) AS "Logistic_CLASS_0", linear_model_cte."Score_CLASS_1" AS "Score_CLASS_1", 1.0 / (1.0 + exp(least(100.0, greatest(-100.0, -linear_model_cte."Score_CLASS_1")))) AS "Logistic_CLASS_1", linear_model_cte."Score_CLASS_2" AS "Score_CLASS_2", 1.0 / (1.0 + exp(least(100.0, greatest(-100.0, -linear_model_cte."Score_CLASS_2")))) AS "Logistic_CLASS_2" 
