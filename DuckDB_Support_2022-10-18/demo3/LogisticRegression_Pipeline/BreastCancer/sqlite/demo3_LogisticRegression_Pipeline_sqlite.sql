...
-- Code For temporary table TMP_20221018185056_6A9ZE43_ADS_imp_1_OUT part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221018185056_6A9ZE43_ADS_imp_1_OUT" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20221018185056_6A9ZE43_ADS_imp_1_OUT part 3. Create Index 

CREATE INDEX "ix_TMP_20221018185056_6A9ZE43_ADS_imp_1_OUT_KEY" ON "TMP_20221018185056_6A9ZE43_ADS_imp_1_OUT" ("KEY")

-- Code For temporary table TMP_20221018185056_6UMBLUP_ADS_sca_2_OUT part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221018185056_6UMBLUP_ADS_sca_2_OUT" (
	"KEY" BIGINT NOT NULL, 
...
FROM "TMP_20221018185056_6A9ZE43_ADS_imp_1_OUT" AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT") AS "T"

-- Code For temporary table TMP_20221018185056_6UMBLUP_ADS_sca_2_OUT part 3. Create Index 

CREATE INDEX "ix_TMP_20221018185056_6UMBLUP_ADS_sca_2_OUT_KEY" ON "TMP_20221018185056_6UMBLUP_ADS_sca_2_OUT" ("KEY")
...
FROM "TMP_20221018185056_6UMBLUP_ADS_sca_2_OUT" AS "ADS_sca_2_OUT"), 
linear_model_cte AS 
(SELECT linear_input."KEY" AS "KEY", -0.4320486288137276 * linear_input.scaler_output_2 + -0.5062446495457346 * linear_input.scaler_output_3 + -0.38080397609704725 * linear_input.scaler_output_4 + -0.4923875684352182 * linear_input.scaler_output_5 + -0.14939621422799632 * linear_input.scaler_output_6 + 0.3641890933407609 * linear_input.scaler_output_7 + -0.7712218096341775 * linear_input.scaler_output_8 + -1.1189796804591283 * linear_input.scaler_output_9 + 0.01706744699208841 * linear_input.scaler_output_10 + 0.13598205516100964 * linear_input.scaler_output_11 + -1.4114323494730918 * linear_input.scaler_output_12 + -0.048770725370306994 * linear_input.scaler_output_13 + -0.840729807482672 * linear_input.scaler_output_14 + -0.8581002635586793 * linear_input.scaler_output_15 + 0.2555517151328375 * linear_input.scaler_output_16 + 0.8714159775369307 * linear_input.scaler_output_17 + 0.22110346535265743 * linear_input.scaler_output_18 + -0.4164267617692115 * linear_input.scaler_output_19 + 0.09422455810494464 * linear_input.scaler_output_20 + 0.6027975354217657 * linear_input.scaler_output_21 + -0.8551723368115707 * linear_input.scaler_output_22 + -0.860065835872389 * linear_input.scaler_output_23 + -0.6892066455156063 * linear_input.scaler_output_24 + -0.7839489320451941 * linear_input.scaler_output_25 + -0.6607621685781933 * linear_input.scaler_output_26 + -0.043386638661074825 * linear_input.scaler_output_27 + -0.8988462865911934 * linear_input.scaler_output_28 + -0.993339643937891 * linear_input.scaler_output_29 + -0.8587491108766367 * linear_input.scaler_output_30 + -0.06379422458842347 * linear_input.scaler_output_31 + 0.8816108273713361 AS lincomb 
FROM linear_input), 
