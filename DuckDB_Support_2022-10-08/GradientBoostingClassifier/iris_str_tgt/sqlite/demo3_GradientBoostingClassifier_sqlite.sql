...
-- Code For temporary table TMP_20221008175443_KCEEJLZ_GB_B0 part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221008175443_KCEEJLZ_GB_B0" (
	"KEY" BIGINT, 
	"Score_CLASS_0" FLOAT, 
	"Score_CLASS_1" FLOAT, 
	"Score_CLASS_2" FLOAT
...
-- Code For temporary table TMP_20221008175443_KCEEJLZ_GB_B0 part 2. Populate
...
FROM "DT_Output_9")
 INSERT INTO "TMP_20221008175443_KCEEJLZ_GB_B0" ("KEY", "Score_CLASS_0", "Score_CLASS_1", "Score_CLASS_2") SELECT "T"."KEY", "T"."Score_CLASS_0", "T"."Score_CLASS_1", "T"."Score_CLASS_2" 
...
-- Code For temporary table TMP_20221008175443_8VCA841_GB_B1 part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221008175443_8VCA841_GB_B1" (
	"KEY" BIGINT, 
	"Score_CLASS_0" FLOAT, 
	"Score_CLASS_1" FLOAT, 
	"Score_CLASS_2" FLOAT
...
-- Code For temporary table TMP_20221008175443_8VCA841_GB_B1 part 2. Populate
...
FROM "DT_Output_19")
 INSERT INTO "TMP_20221008175443_8VCA841_GB_B1" ("KEY", "Score_CLASS_0", "Score_CLASS_1", "Score_CLASS_2") SELECT "T"."KEY", "T"."Score_CLASS_0", "T"."Score_CLASS_1", "T"."Score_CLASS_2" 
...
-- Code For temporary table TMP_20221008175443_NCYOUVZ_GB_B2 part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221008175443_NCYOUVZ_GB_B2" (
	"KEY" BIGINT, 
	"Score_CLASS_0" FLOAT, 
	"Score_CLASS_1" FLOAT, 
	"Score_CLASS_2" FLOAT
...
-- Code For temporary table TMP_20221008175443_NCYOUVZ_GB_B2 part 2. Populate
...
FROM "DT_Output_29")
 INSERT INTO "TMP_20221008175443_NCYOUVZ_GB_B2" ("KEY", "Score_CLASS_0", "Score_CLASS_1", "Score_CLASS_2") SELECT "T"."KEY", "T"."Score_CLASS_0", "T"."Score_CLASS_1", "T"."Score_CLASS_2" 
...
-- Code For temporary table TMP_20221008175443_0MPROV1_GB_B3 part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221008175443_0MPROV1_GB_B3" (
	"KEY" BIGINT, 
	"Score_CLASS_0" FLOAT, 
	"Score_CLASS_1" FLOAT, 
	"Score_CLASS_2" FLOAT
...
-- Code For temporary table TMP_20221008175443_0MPROV1_GB_B3 part 2. Populate
...
FROM "DT_Output_39")
 INSERT INTO "TMP_20221008175443_0MPROV1_GB_B3" ("KEY", "Score_CLASS_0", "Score_CLASS_1", "Score_CLASS_2") SELECT "T"."KEY", "T"."Score_CLASS_0", "T"."Score_CLASS_1", "T"."Score_CLASS_2" 
...
-- Code For temporary table TMP_20221008175443_ERLI6GC_GB_B4 part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221008175443_ERLI6GC_GB_B4" (
	"KEY" BIGINT, 
	"Score_CLASS_0" FLOAT, 
	"Score_CLASS_1" FLOAT, 
	"Score_CLASS_2" FLOAT
...
-- Code For temporary table TMP_20221008175443_ERLI6GC_GB_B4 part 2. Populate
...
FROM "DT_Output_47")
 INSERT INTO "TMP_20221008175443_ERLI6GC_GB_B4" ("KEY", "Score_CLASS_0", "Score_CLASS_1", "Score_CLASS_2") SELECT "T"."KEY", "T"."Score_CLASS_0", "T"."Score_CLASS_1", "T"."Score_CLASS_2" 
...
-- Code For temporary table TMP_20221008175443_Y5R1W00_GB_sum part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221008175443_Y5R1W00_GB_sum" (
	"KEY" BIGINT NOT NULL, 
	"Score_CLASS_0" FLOAT, 
	"Score_CLASS_1" FLOAT, 
	"Score_CLASS_2" FLOAT, 
...
-- Code For temporary table TMP_20221008175443_Y5R1W00_GB_sum part 2. Populate
...
FROM (SELECT "GB_B0"."KEY" AS "KEY", "GB_B0"."Score_CLASS_0" AS "Score_CLASS_0", "GB_B0"."Score_CLASS_1" AS "Score_CLASS_1", "GB_B0"."Score_CLASS_2" AS "Score_CLASS_2" 
FROM "TMP_20221008175443_KCEEJLZ_GB_B0" AS "GB_B0" UNION ALL SELECT "GB_B1"."KEY" AS "KEY", "GB_B1"."Score_CLASS_0" AS "Score_CLASS_0", "GB_B1"."Score_CLASS_1" AS "Score_CLASS_1", "GB_B1"."Score_CLASS_2" AS "Score_CLASS_2" 
FROM "TMP_20221008175443_8VCA841_GB_B1" AS "GB_B1" UNION ALL SELECT "GB_B2"."KEY" AS "KEY", "GB_B2"."Score_CLASS_0" AS "Score_CLASS_0", "GB_B2"."Score_CLASS_1" AS "Score_CLASS_1", "GB_B2"."Score_CLASS_2" AS "Score_CLASS_2" 
FROM "TMP_20221008175443_NCYOUVZ_GB_B2" AS "GB_B2" UNION ALL SELECT "GB_B3"."KEY" AS "KEY", "GB_B3"."Score_CLASS_0" AS "Score_CLASS_0", "GB_B3"."Score_CLASS_1" AS "Score_CLASS_1", "GB_B3"."Score_CLASS_2" AS "Score_CLASS_2" 
FROM "TMP_20221008175443_0MPROV1_GB_B3" AS "GB_B3" UNION ALL SELECT "GB_B4"."KEY" AS "KEY", "GB_B4"."Score_CLASS_0" AS "Score_CLASS_0", "GB_B4"."Score_CLASS_1" AS "Score_CLASS_1", "GB_B4"."Score_CLASS_2" AS "Score_CLASS_2" 
FROM "TMP_20221008175443_ERLI6GC_GB_B4" AS "GB_B4") AS "GB_EnsembleUnion")
 INSERT INTO "TMP_20221008175443_Y5R1W00_GB_sum" ("KEY", "Score_CLASS_0", "Score_CLASS_1", "Score_CLASS_2") SELECT "T"."KEY", "T"."Score_CLASS_0", "T"."Score_CLASS_1", "T"."Score_CLASS_2" 
...
-- Code For temporary table TMP_20221008175443_Y5R1W00_GB_sum part 3. Create Index 

CREATE INDEX "ix_TMP_20221008175443_Y5R1W00_GB_sum_KEY" ON "TMP_20221008175443_Y5R1W00_GB_sum" ("KEY")
...
FROM "TMP_20221008175443_Y5R1W00_GB_sum" AS "GB_sum"), 
