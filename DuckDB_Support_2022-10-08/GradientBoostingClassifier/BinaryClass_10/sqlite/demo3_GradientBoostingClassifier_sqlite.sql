...
-- Code For temporary table TMP_20221008174657_4XO5W4O_GB_B0 part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221008174657_4XO5W4O_GB_B0" (
	"KEY" BIGINT, 
	"Score_0" FLOAT, 
	"Score_1" FLOAT
)
...
-- Code For temporary table TMP_20221008174657_4XO5W4O_GB_B0 part 2. Populate

WITH "DT_node_lookup" AS 
(SELECT "ADS"."KEY" AS "KEY", CASE WHEN ("ADS"."Feature_9" <= 0.034406057093292475) THEN CASE WHEN ("ADS"."Feature_5" <= 2.3706862926483154) THEN CASE WHEN ("ADS"."Feature_5" <= -1.1672475934028625) THEN 3 ELSE 4 END ELSE 5 END ELSE CASE WHEN ("ADS"."Feature_6" <= 1.9341034293174744) THEN 7 ELSE 8 END END AS node_id_2 
...
FROM "DT_Output_1"), 
"DT_node_lookup_2" AS 
(SELECT "ADS"."KEY" AS "KEY", CASE WHEN ("ADS"."Feature_9" <= 0.034406057093292475) THEN CASE WHEN ("ADS"."Feature_7" <= 0.3353678435087204) THEN CASE WHEN ("ADS"."Feature_5" <= -1.0882456302642822) THEN 3 ELSE 4 END ELSE CASE WHEN ("ADS"."Feature_5" <= -1.2985916137695312) THEN 6 ELSE 7 END END ELSE CASE WHEN ("ADS"."Feature_6" <= 1.9341034293174744) THEN 9 ELSE CASE WHEN ("ADS"."Feature_2" <= 0.0065431147813797) THEN 11 ELSE 12 END END END AS node_id_2 
FROM "BinaryClass_10" AS "ADS"), 
"DT_node_data_2" AS 
(SELECT "Values".nid AS nid, "Values"."E" AS "E" 
...
FROM "DT_Output_2"), 
"DT_node_lookup_3" AS 
(SELECT "ADS"."KEY" AS "KEY", CASE WHEN ("ADS"."Feature_9" <= 0.034406057093292475) THEN CASE WHEN ("ADS"."Feature_5" <= 2.3706862926483154) THEN CASE WHEN ("ADS"."Feature_3" <= 1.745934009552002) THEN 3 ELSE 4 END ELSE 5 END ELSE CASE WHEN ("ADS"."Feature_6" <= 1.9341034293174744) THEN 7 ELSE CASE WHEN ("ADS"."Feature_4" <= 1.7262625694274902) THEN 9 ELSE 10 END END END AS node_id_2 
FROM "BinaryClass_10" AS "ADS"), 
"DT_node_data_3" AS 
(SELECT "Values".nid AS nid, "Values"."E" AS "E" 
...
FROM "DT_Output_3"), 
"DT_node_lookup_4" AS 
(SELECT "ADS"."KEY" AS "KEY", CASE WHEN ("ADS"."Feature_9" <= 0.034406057093292475) THEN CASE WHEN ("ADS"."Feature_5" <= 2.3706862926483154) THEN CASE WHEN ("ADS"."Feature_2" <= 1.922914445400238) THEN 3 ELSE 4 END ELSE 5 END ELSE CASE WHEN ("ADS"."Feature_6" <= 1.9341034293174744) THEN 7 ELSE CASE WHEN ("ADS"."Feature_6" <= 2.712794542312622) THEN 9 ELSE 10 END END END AS node_id_2 
FROM "BinaryClass_10" AS "ADS"), 
"DT_node_data_4" AS 
(SELECT "Values".nid AS nid, "Values"."E" AS "E" 
...
FROM "DT_Output_4")
 INSERT INTO "TMP_20221008174657_4XO5W4O_GB_B0" ("KEY", "Score_0", "Score_1") SELECT "T"."KEY", "T"."Score_0", "T"."Score_1" 
...
-- Code For temporary table TMP_20221008174657_B7HBN1J_GB_B1 part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221008174657_B7HBN1J_GB_B1" (
	"KEY" BIGINT, 
	"Score_0" FLOAT, 
	"Score_1" FLOAT
)
...
-- Code For temporary table TMP_20221008174657_B7HBN1J_GB_B1 part 2. Populate
...
FROM "DT_Output_5"), 
"DT_node_lookup_6" AS 
(SELECT "ADS"."KEY" AS "KEY", CASE WHEN ("ADS"."Feature_9" <= 0.034406057093292475) THEN CASE WHEN ("ADS"."Feature_5" <= 2.3706862926483154) THEN CASE WHEN ("ADS"."Feature_5" <= -1.1672475934028625) THEN 3 ELSE 4 END ELSE CASE WHEN ("ADS"."Feature_0" <= 0.37195824086666107) THEN 6 ELSE 7 END END ELSE CASE WHEN ("ADS"."Feature_6" <= 1.9341034293174744) THEN 9 ELSE CASE WHEN ("ADS"."Feature_8" <= 0.27610116451978683) THEN 11 ELSE 12 END END END AS node_id_2 
FROM "BinaryClass_10" AS "ADS"), 
"DT_node_data_6" AS 
(SELECT "Values".nid AS nid, "Values"."E" AS "E" 
...
FROM "DT_Output_7"), 
"DT_node_lookup_8" AS 
(SELECT "ADS"."KEY" AS "KEY", CASE WHEN ("ADS"."Feature_9" <= 0.034406057093292475) THEN CASE WHEN ("ADS"."Feature_5" <= 2.3706862926483154) THEN CASE WHEN ("ADS"."Feature_3" <= 1.745934009552002) THEN 3 ELSE 4 END ELSE 5 END ELSE CASE WHEN ("ADS"."Feature_6" <= 1.9341034293174744) THEN 7 ELSE 8 END END AS node_id_2 
FROM "BinaryClass_10" AS "ADS"), 
"DT_node_data_8" AS 
(SELECT "Values".nid AS nid, "Values"."E" AS "E" 
...
FROM "DT_Output_8"), 
"DT_node_lookup_9" AS 
(SELECT "ADS"."KEY" AS "KEY", CASE WHEN ("ADS"."Feature_7" <= 0.3353678435087204) THEN CASE WHEN ("ADS"."Feature_5" <= -0.9849978089332581) THEN CASE WHEN ("ADS"."Feature_7" <= 0.08383590634912252) THEN 3 ELSE 4 END ELSE CASE WHEN ("ADS"."Feature_9" <= 0.3962254822254181) THEN 6 ELSE 7 END END ELSE CASE WHEN ("ADS"."Feature_5" <= -1.2985916137695312) THEN 9 ELSE 10 END END AS node_id_2 
FROM "BinaryClass_10" AS "ADS"), 
"DT_node_data_9" AS 
(SELECT "Values".nid AS nid, "Values"."E" AS "E" 
...
FROM "DT_Output_9")
 INSERT INTO "TMP_20221008174657_B7HBN1J_GB_B1" ("KEY", "Score_0", "Score_1") SELECT "T"."KEY", "T"."Score_0", "T"."Score_1" 
...
-- Code For temporary table TMP_20221008174657_ZJP6AUN_GB_B2 part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221008174657_ZJP6AUN_GB_B2" (
	"KEY" BIGINT, 
	"Score_0" FLOAT, 
	"Score_1" FLOAT
)
...
-- Code For temporary table TMP_20221008174657_ZJP6AUN_GB_B2 part 2. Populate

WITH "DT_node_lookup_10" AS 
(SELECT "ADS"."KEY" AS "KEY", CASE WHEN ("ADS"."Feature_7" <= 0.3353678435087204) THEN CASE WHEN ("ADS"."Feature_5" <= -0.9849978089332581) THEN CASE WHEN ("ADS"."Feature_0" <= 0.3825899437069893) THEN 3 ELSE 4 END ELSE CASE WHEN ("ADS"."Feature_9" <= 0.3962254822254181) THEN 6 ELSE 7 END END ELSE CASE WHEN ("ADS"."Feature_5" <= -1.2985916137695312) THEN 9 ELSE 10 END END AS node_id_2 
FROM "BinaryClass_10" AS "ADS"), 
"DT_node_data_10" AS 
(SELECT "Values".nid AS nid, "Values"."E" AS "E" 
...
(SELECT "ADS"."KEY" AS "KEY", CASE WHEN ("ADS"."Feature_7" <= 0.3353678435087204) THEN CASE WHEN ("ADS"."Feature_5" <= -0.9849978089332581) THEN CASE WHEN ("ADS"."Feature_9" <= -0.06832970306277275) THEN 3 ELSE 4 END ELSE CASE WHEN ("ADS"."Feature_7" <= -0.11454783193767071) THEN 6 ELSE 7 END END ELSE CASE WHEN ("ADS"."Feature_5" <= -1.2985916137695312) THEN 9 ELSE 10 END END AS node_id_2 
FROM "BinaryClass_10" AS "ADS"), 
"DT_node_data_11" AS 
(SELECT "Values".nid AS nid, "Values"."E" AS "E" 
...
(SELECT "ADS"."KEY" AS "KEY", CASE WHEN ("ADS"."Feature_7" <= 0.3353678435087204) THEN CASE WHEN ("ADS"."Feature_5" <= -0.9849978089332581) THEN CASE WHEN ("ADS"."Feature_9" <= -0.06832970306277275) THEN 3 ELSE 4 END ELSE CASE WHEN ("ADS"."Feature_0" <= 0.4073571115732193) THEN 6 ELSE 7 END END ELSE CASE WHEN ("ADS"."Feature_5" <= -1.2985916137695312) THEN 9 ELSE 10 END END AS node_id_2 
FROM "BinaryClass_10" AS "ADS"), 
"DT_node_data_12" AS 
(SELECT "Values".nid AS nid, "Values"."E" AS "E" 
...
(SELECT "ADS"."KEY" AS "KEY", CASE WHEN ("ADS"."Feature_9" <= 0.034406057093292475) THEN CASE WHEN ("ADS"."Feature_5" <= 2.3706862926483154) THEN CASE WHEN ("ADS"."Feature_5" <= -1.1672475934028625) THEN 3 ELSE 4 END ELSE 5 END ELSE CASE WHEN ("ADS"."Feature_6" <= 1.9341034293174744) THEN CASE WHEN ("ADS"."Feature_5" <= 1.6434659957885742) THEN 8 ELSE 9 END ELSE CASE WHEN ("ADS"."Feature_4" <= 1.7262625694274902) THEN 11 ELSE 12 END END END AS node_id_2 
FROM "BinaryClass_10" AS "ADS"), 
"DT_node_data_13" AS 
(SELECT "Values".nid AS nid, "Values"."E" AS "E" 
...
(SELECT "ADS"."KEY" AS "KEY", CASE WHEN ("ADS"."Feature_7" <= 0.3353678435087204) THEN CASE WHEN ("ADS"."Feature_5" <= -0.9849978089332581) THEN CASE WHEN ("ADS"."Feature_0" <= 0.3825899437069893) THEN 3 ELSE 4 END ELSE CASE WHEN ("ADS"."Feature_9" <= 0.43705305457115173) THEN 6 ELSE 7 END END ELSE CASE WHEN ("ADS"."Feature_5" <= -1.2985916137695312) THEN 9 ELSE 10 END END AS node_id_2 
FROM "BinaryClass_10" AS "ADS"), 
"DT_node_data_14" AS 
(SELECT "Values".nid AS nid, "Values"."E" AS "E" 
...
FROM "DT_Output_14")
 INSERT INTO "TMP_20221008174657_ZJP6AUN_GB_B2" ("KEY", "Score_0", "Score_1") SELECT "T"."KEY", "T"."Score_0", "T"."Score_1" 
...
-- Code For temporary table TMP_20221008174657_NL8JYVH_GB_B3 part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221008174657_NL8JYVH_GB_B3" (
	"KEY" BIGINT, 
	"Score_0" FLOAT, 
	"Score_1" FLOAT
)
...
-- Code For temporary table TMP_20221008174657_NL8JYVH_GB_B3 part 2. Populate

WITH "DT_node_lookup_15" AS 
(SELECT "ADS"."KEY" AS "KEY", CASE WHEN ("ADS"."Feature_7" <= 0.3353678435087204) THEN CASE WHEN ("ADS"."Feature_9" <= -0.8793928921222687) THEN 2 ELSE CASE WHEN ("ADS"."Feature_9" <= 0.034406057093292475) THEN 4 ELSE 5 END END ELSE CASE WHEN ("ADS"."Feature_5" <= -1.2985916137695312) THEN 7 ELSE 8 END END AS node_id_2 
FROM "BinaryClass_10" AS "ADS"), 
"DT_node_data_15" AS 
(SELECT "Values".nid AS nid, "Values"."E" AS "E" 
...
FROM "DT_Output_15")
 INSERT INTO "TMP_20221008174657_NL8JYVH_GB_B3" ("KEY", "Score_0", "Score_1") SELECT "T"."KEY", "T"."Score_0", "T"."Score_1" 
...
-- Code For temporary table TMP_20221008174657_TS5YDJH_GB_sum part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221008174657_TS5YDJH_GB_sum" (
	"KEY" BIGINT NOT NULL, 
	"Score_0" FLOAT, 
	"Score_1" FLOAT, 
	PRIMARY KEY ("KEY")
...
-- Code For temporary table TMP_20221008174657_TS5YDJH_GB_sum part 2. Populate

WITH "GB_Union" AS 
(SELECT "GB_EnsembleUnion"."KEY" AS "KEY", "GB_EnsembleUnion"."Score_0" AS "Score_0", "GB_EnsembleUnion"."Score_1" AS "Score_1" 
FROM (SELECT "GB_B0"."KEY" AS "KEY", "GB_B0"."Score_0" AS "Score_0", "GB_B0"."Score_1" AS "Score_1" 
FROM "TMP_20221008174657_4XO5W4O_GB_B0" AS "GB_B0" UNION ALL SELECT "GB_B1"."KEY" AS "KEY", "GB_B1"."Score_0" AS "Score_0", "GB_B1"."Score_1" AS "Score_1" 
FROM "TMP_20221008174657_B7HBN1J_GB_B1" AS "GB_B1" UNION ALL SELECT "GB_B2"."KEY" AS "KEY", "GB_B2"."Score_0" AS "Score_0", "GB_B2"."Score_1" AS "Score_1" 
FROM "TMP_20221008174657_ZJP6AUN_GB_B2" AS "GB_B2" UNION ALL SELECT "GB_B3"."KEY" AS "KEY", "GB_B3"."Score_0" AS "Score_0", "GB_B3"."Score_1" AS "Score_1" 
FROM "TMP_20221008174657_NL8JYVH_GB_B3" AS "GB_B3") AS "GB_EnsembleUnion")
 INSERT INTO "TMP_20221008174657_TS5YDJH_GB_sum" ("KEY", "Score_0", "Score_1") SELECT "T"."KEY", "T"."Score_0", "T"."Score_1" 
...
-- Code For temporary table TMP_20221008174657_TS5YDJH_GB_sum part 3. Create Index 

CREATE INDEX "ix_TMP_20221008174657_TS5YDJH_GB_sum_KEY" ON "TMP_20221008174657_TS5YDJH_GB_sum" ("KEY")

-- Model deployment code

WITH orig_cte AS 
(SELECT "GB_sum"."KEY" AS "KEY", -(0.5 + 0.1 * "GB_sum"."Score_1") AS "Score_0", 0.5 + 0.1 * "GB_sum"."Score_1" AS "Score_1", 1.0 - 1.0 / (1.0 + exp(min(100.0, max(-100.0, -(0.5 + 0.1 * "GB_sum"."Score_1"))))) AS "Proba_0", 1.0 / (1.0 + exp(min(100.0, max(-100.0, -(0.5 + 0.1 * "GB_sum"."Score_1"))))) AS "Proba_1", CAST(NULL AS FLOAT) AS "LogProba_0", CAST(NULL AS FLOAT) AS "LogProba_1", CAST(NULL AS BIGINT) AS "Decision", CAST(NULL AS FLOAT) AS "DecisionProba" 
FROM "TMP_20221008174657_TS5YDJH_GB_sum" AS "GB_sum"), 
