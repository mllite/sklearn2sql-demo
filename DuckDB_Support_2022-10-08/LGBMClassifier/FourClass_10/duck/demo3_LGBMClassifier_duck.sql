...
-- Code For temporary table TMP_20221008174832_6B8FYNM_LGBM_B0 part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221008174832_6B8FYNM_LGBM_B0" (
	"KEY" BIGINT, 
	"Score_0" FLOAT(53), 
	"Score_1" FLOAT(53), 
	"Score_2" FLOAT(53), 
...
-- Code For temporary table TMP_20221008174832_6B8FYNM_LGBM_B0 part 2. Populate
...
FROM (SELECT 3 AS nid, -1.4417316837252416 AS "Score" UNION ALL SELECT 4 AS nid, -1.5185365963601691 AS "Score" UNION ALL SELECT 5 AS nid, -1.5400419718979488 AS "Score") AS "Values"), 
"DT_Output" AS 
...
"DT_node_data_1" AS 
(SELECT "Values".nid AS nid, "Values"."Score" AS "Score" 
FROM (SELECT 3 AS nid, -1.327722932548462 AS "Score" UNION ALL SELECT 4 AS nid, -1.4262943611198906 AS "Score" UNION ALL SELECT 5 AS nid, -1.4362943611198906 AS "Score") AS "Values"), 
"DT_Output_1" AS 
...
"DT_node_data_2" AS 
(SELECT "Values".nid AS nid, "Values"."Score" AS "Score" 
FROM (SELECT 2 AS nid, -1.3124848373103668 AS "Score" UNION ALL SELECT 6 AS nid, -1.4310312032251538 AS "Score" UNION ALL SELECT 7 AS nid, -1.3791515039770335 AS "Score") AS "Values"), 
"DT_Output_2" AS 
...
"DT_node_data_3" AS 
(SELECT "Values".nid AS nid, "Values"."Score" AS "Score" 
FROM (SELECT 3 AS nid, -1.3330627908660782 AS "Score" UNION ALL SELECT 4 AS nid, -1.3144951520823478 AS "Score" UNION ALL SELECT 5 AS nid, -1.1904467898185016 AS "Score") AS "Values"), 
"DT_Output_3" AS 
...
"DT_node_data_4" AS 
(SELECT "Values".nid AS nid, "Values"."Score" AS "Score" 
FROM (SELECT 3 AS nid, 0.04627287911828212 AS "Score" UNION ALL SELECT 4 AS nid, -0.02633460880542885 AS "Score" UNION ALL SELECT 5 AS nid, -0.04770682993155158 AS "Score") AS "Values"), 
"DT_Output_4" AS 
...
"DT_node_data_5" AS 
(SELECT "Values".nid AS nid, "Values"."Score" AS "Score" 
FROM (SELECT 3 AS nid, 0.05435542642036301 AS "Score" UNION ALL SELECT 4 AS nid, -0.049386239448395555 AS "Score" UNION ALL SELECT 5 AS nid, -0.039062407617108136 AS "Score") AS "Values"), 
"DT_Output_5" AS 
...
"DT_node_data_6" AS 
(SELECT "Values".nid AS nid, "Values"."Score" AS "Score" 
FROM (SELECT 2 AS nid, 0.06691656507643298 AS "Score" UNION ALL SELECT 6 AS nid, -0.043840622020411196 AS "Score" UNION ALL SELECT 7 AS nid, 0.0067370303465114235 AS "Score") AS "Values"), 
"DT_Output_6" AS 
...
"DT_node_data_7" AS 
(SELECT "Values".nid AS nid, "Values"."Score" AS "Score" 
FROM (SELECT 3 AS nid, -0.041178816193287 AS "Score" UNION ALL SELECT 4 AS nid, -0.022662737116945247 AS "Score" UNION ALL SELECT 5 AS nid, 0.09129132081909418 AS "Score") AS "Values"), 
"DT_Output_7" AS 
...
"DT_node_data_8" AS 
(SELECT "Values".nid AS nid, "Values"."Score" AS "Score" 
FROM (SELECT 3 AS nid, 0.043029231856434154 AS "Score" UNION ALL SELECT 4 AS nid, -0.02578590086866886 AS "Score" UNION ALL SELECT 5 AS nid, -0.04708045944837226 AS "Score") AS "Values"), 
"DT_Output_8" AS 
...
"DT_node_data_9" AS 
(SELECT "Values".nid AS nid, "Values"."Score" AS "Score" 
FROM (SELECT 3 AS nid, 0.050657362403667874 AS "Score" UNION ALL SELECT 4 AS nid, -0.03820320013016176 AS "Score" UNION ALL SELECT 5 AS nid, -0.04878891243629599 AS "Score") AS "Values"), 
"DT_Output_9" AS 
...
FROM "DT_Output_9")
 INSERT INTO "TMP_20221008174832_6B8FYNM_LGBM_B0" ("KEY", "Score_0", "Score_1", "Score_2", "Score_3") SELECT "T"."KEY", "T"."Score_0", "T"."Score_1", "T"."Score_2", "T"."Score_3" 
...
-- Code For temporary table TMP_20221008174832_WPFFG8E_LGBM_B1 part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221008174832_WPFFG8E_LGBM_B1" (
	"KEY" BIGINT, 
	"Score_0" FLOAT(53), 
	"Score_1" FLOAT(53), 
	"Score_2" FLOAT(53), 
...
-- Code For temporary table TMP_20221008174832_WPFFG8E_LGBM_B1 part 2. Populate
...
"DT_node_data_10" AS 
(SELECT "Values".nid AS nid, "Values"."Score" AS "Score" 
FROM (SELECT 2 AS nid, 0.056061954517675566 AS "Score" UNION ALL SELECT 6 AS nid, -0.043219762554526364 AS "Score" UNION ALL SELECT 7 AS nid, 0.001813440276611434 AS "Score") AS "Values"), 
"DT_Output_10" AS 
...
"DT_node_data_11" AS 
(SELECT "Values".nid AS nid, "Values"."Score" AS "Score" 
FROM (SELECT 3 AS nid, -0.040331552194104586 AS "Score" UNION ALL SELECT 4 AS nid, -0.021815000906763565 AS "Score" UNION ALL SELECT 5 AS nid, 0.08369368315822175 AS "Score") AS "Values"), 
"DT_Output_11" AS 
...
"DT_node_data_12" AS 
(SELECT "Values".nid AS nid, "Values"."Score" AS "Score" 
FROM (SELECT 3 AS nid, 0.04009673112277783 AS "Score" UNION ALL SELECT 4 AS nid, -0.025212109257937883 AS "Score" UNION ALL SELECT 5 AS nid, -0.046506282407846544 AS "Score") AS "Values"), 
"DT_Output_12" AS 
...
"DT_node_data_13" AS 
(SELECT "Values".nid AS nid, "Values"."Score" AS "Score" 
FROM (SELECT 3 AS nid, 0.04724991327144753 AS "Score" UNION ALL SELECT 4 AS nid, -0.04824932654941063 AS "Score" UNION ALL SELECT 5 AS nid, -0.0372824598972271 AS "Score") AS "Values"), 
"DT_Output_13" AS 
...
"DT_node_data_14" AS 
(SELECT "Values".nid AS nid, "Values"."Score" AS "Score" 
FROM (SELECT 2 AS nid, 0.05642228713882056 AS "Score" UNION ALL SELECT 6 AS nid, -0.04253747682479185 AS "Score" UNION ALL SELECT 7 AS nid, 0.00715684751889132 AS "Score") AS "Values"), 
"DT_Output_14" AS 
...
"DT_node_data_15" AS 
(SELECT "Values".nid AS nid, "Values"."Score" AS "Score" 
FROM (SELECT 3 AS nid, -0.03953954162393316 AS "Score" UNION ALL SELECT 4 AS nid, -0.02097497374421982 AS "Score" UNION ALL SELECT 5 AS nid, 0.07747544054721145 AS "Score") AS "Values"), 
"DT_Output_15" AS 
...
"DT_node_data_16" AS 
(SELECT "Values".nid AS nid, "Values"."Score" AS "Score" 
FROM (SELECT 3 AS nid, 0.037498440160063574 AS "Score" UNION ALL SELECT 4 AS nid, -0.02466943879530606 AS "Score" UNION ALL SELECT 5 AS nid, -0.0459729436336489 AS "Score") AS "Values"), 
"DT_Output_16" AS 
...
"DT_node_data_17" AS 
(SELECT "Values".nid AS nid, "Values"."Score" AS "Score" 
FROM (SELECT 3 AS nid, 0.04434969243315201 AS "Score" UNION ALL SELECT 4 AS nid, -0.04772296053884017 AS "Score" UNION ALL SELECT 5 AS nid, -0.03649983497038875 AS "Score") AS "Values"), 
"DT_Output_17" AS 
...
"DT_node_data_18" AS 
(SELECT "Values".nid AS nid, "Values"."Score" AS "Score" 
FROM (SELECT 2 AS nid, 0.047782543147457376 AS "Score" UNION ALL SELECT 6 AS nid, -0.041934807204491976 AS "Score" UNION ALL SELECT 7 AS nid, 0.002666306755662035 AS "Score") AS "Values"), 
"DT_Output_18" AS 
...
"DT_node_data_19" AS 
(SELECT "Values".nid AS nid, "Values"."Score" AS "Score" 
FROM (SELECT 3 AS nid, -0.03875892936259273 AS "Score" UNION ALL SELECT 4 AS nid, -0.020170956937839876 AS "Score" UNION ALL SELECT 5 AS nid, 0.07202786749893395 AS "Score") AS "Values"), 
"DT_Output_19" AS 
...
FROM "DT_Output_19")
 INSERT INTO "TMP_20221008174832_WPFFG8E_LGBM_B1" ("KEY", "Score_0", "Score_1", "Score_2", "Score_3") SELECT "T"."KEY", "T"."Score_0", "T"."Score_1", "T"."Score_2", "T"."Score_3" 
...
-- Code For temporary table TMP_20221008174832_A3MC2BE_LGBM_B2 part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221008174832_A3MC2BE_LGBM_B2" (
	"KEY" BIGINT, 
	"Score_0" FLOAT(53), 
	"Score_1" FLOAT(53), 
	"Score_2" FLOAT(53), 
...
-- Code For temporary table TMP_20221008174832_A3MC2BE_LGBM_B2 part 2. Populate

WITH "DT_node_lookup_20" AS 
(SELECT "ADS"."KEY" AS "KEY", CASE WHEN ("ADS"."Feature_4" <= 0.593683701646932) THEN CASE WHEN ("ADS"."Feature_1" <= -0.07957301908751756) THEN 4 ELSE CASE WHEN ("ADS"."Feature_1" <= 1.6825816338111632) THEN 10 ELSE 11 END END ELSE 3 END AS node_id_2 
FROM "FourClass_10" AS "ADS"), 
"DT_node_data_20" AS 
(SELECT "Values".nid AS nid, "Values"."Score" AS "Score" 
FROM (SELECT 3 AS nid, 0.06322887601594172 AS "Score" UNION ALL SELECT 4 AS nid, 0.02690338328523367 AS "Score" UNION ALL SELECT 10 AS nid, -0.04822722299281875 AS "Score" UNION ALL SELECT 11 AS nid, -0.0456786408850883 AS "Score") AS "Values"), 
"DT_Output_20" AS 
...
"DT_node_data_21" AS 
(SELECT "Values".nid AS nid, "Values"."Score" AS "Score" 
FROM (SELECT 3 AS nid, 0.04162333048491916 AS "Score" UNION ALL SELECT 4 AS nid, -0.04740862545346616 AS "Score" UNION ALL SELECT 5 AS nid, -0.035868486018302594 AS "Score") AS "Values"), 
"DT_Output_21" AS 
...
(SELECT "ADS"."KEY" AS "KEY", CASE WHEN ("ADS"."Feature_2" <= 0.27678436702593656) THEN CASE WHEN ("ADS"."Feature_3" <= -1.1015614178316115) THEN 4 ELSE 5 END ELSE 3 END AS node_id_2 
FROM "FourClass_10" AS "ADS"), 
"DT_node_data_22" AS 
(SELECT "Values".nid AS nid, "Values"."Score" AS "Score" 
FROM (SELECT 3 AS nid, -0.04208574951104457 AS "Score" UNION ALL SELECT 4 AS nid, 0.059049714454620254 AS "Score" UNION ALL SELECT 5 AS nid, -0.0013465668415250265 AS "Score") AS "Values"), 
"DT_Output_22" AS 
...
"DT_node_data_23" AS 
(SELECT "Values".nid AS nid, "Values"."Score" AS "Score" 
FROM (SELECT 3 AS nid, -0.038027011659279866 AS "Score" UNION ALL SELECT 4 AS nid, -0.019382401472833866 AS "Score" UNION ALL SELECT 5 AS nid, 0.06751496317914212 AS "Score") AS "Values"), 
"DT_Output_23" AS 
...
"DT_node_data_24" AS 
(SELECT "Values".nid AS nid, "Values"."Score" AS "Score" 
FROM (SELECT 3 AS nid, 0.058404896734893345 AS "Score" UNION ALL SELECT 4 AS nid, 0.025464989992993948 AS "Score" UNION ALL SELECT 10 AS nid, -0.04773382280653453 AS "Score" UNION ALL SELECT 11 AS nid, -0.04521370769332238 AS "Score") AS "Values"), 
"DT_Output_24" AS 
...
"DT_node_data_25" AS 
(SELECT "Values".nid AS nid, "Values"."Score" AS "Score" 
FROM (SELECT 3 AS nid, 0.038821923931579835 AS "Score" UNION ALL SELECT 4 AS nid, -0.04674173600331913 AS "Score" UNION ALL SELECT 5 AS nid, -0.034761709120701215 AS "Score") AS "Values"), 
"DT_Output_25" AS 
...
(SELECT "ADS"."KEY" AS "KEY", CASE WHEN ("ADS"."Feature_3" <= -1.186266686886175) THEN 2 ELSE CASE WHEN ("ADS"."Feature_7" <= 1.2680271429278211) THEN CASE WHEN ("ADS"."Feature_9" <= 0.10068659087483507) THEN 12 ELSE 13 END ELSE 7 END END AS node_id_2 
FROM "FourClass_10" AS "ADS"), 
"DT_node_data_26" AS 
(SELECT "Values".nid AS nid, "Values"."Score" AS "Score" 
FROM (SELECT 2 AS nid, 0.05291100798419628 AS "Score" UNION ALL SELECT 7 AS nid, 0.008595354683548976 AS "Score" UNION ALL SELECT 12 AS nid, -0.04759443684485573 AS "Score" UNION ALL SELECT 13 AS nid, -0.026395677116028877 AS "Score") AS "Values"), 
"DT_Output_26" AS 
...
"DT_node_data_27" AS 
(SELECT "Values".nid AS nid, "Values"."Score" AS "Score" 
FROM (SELECT 3 AS nid, -0.037370314080264845 AS "Score" UNION ALL SELECT 4 AS nid, -0.018325909798415262 AS "Score" UNION ALL SELECT 5 AS nid, 0.06344455401274801 AS "Score") AS "Values"), 
"DT_Output_27" AS 
...
"DT_node_data_28" AS 
(SELECT "Values".nid AS nid, "Values"."Score" AS "Score" 
FROM (SELECT 3 AS nid, 0.05439223696329146 AS "Score" UNION ALL SELECT 4 AS nid, 0.023864354151847317 AS "Score" UNION ALL SELECT 10 AS nid, -0.04726508451156479 AS "Score" UNION ALL SELECT 11 AS nid, -0.044769987448176674 AS "Score") AS "Values"), 
"DT_Output_28" AS 
...
"DT_node_data_29" AS 
(SELECT "Values".nid AS nid, "Values"."Score" AS "Score" 
FROM (SELECT 2 AS nid, -0.0463422275749633 AS "Score" UNION ALL SELECT 6 AS nid, 0.005104265705983473 AS "Score" UNION ALL SELECT 7 AS nid, 0.05495853847835505 AS "Score") AS "Values"), 
"DT_Output_29" AS 
...
FROM "DT_Output_29")
 INSERT INTO "TMP_20221008174832_A3MC2BE_LGBM_B2" ("KEY", "Score_0", "Score_1", "Score_2", "Score_3") SELECT "T"."KEY", "T"."Score_0", "T"."Score_1", "T"."Score_2", "T"."Score_3" 
...
-- Code For temporary table TMP_20221008174832_NXJ8NFK_LGBM_B3 part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221008174832_NXJ8NFK_LGBM_B3" (
	"KEY" BIGINT, 
	"Score_0" FLOAT(53), 
	"Score_1" FLOAT(53), 
	"Score_2" FLOAT(53), 
...
-- Code For temporary table TMP_20221008174832_NXJ8NFK_LGBM_B3 part 2. Populate
...
"DT_node_data_30" AS 
(SELECT "Values".nid AS nid, "Values"."Score" AS "Score" 
FROM (SELECT 3 AS nid, -0.041075984053800425 AS "Score" UNION ALL SELECT 4 AS nid, -0.002317417430089348 AS "Score" UNION ALL SELECT 5 AS nid, 0.05170710073141809 AS "Score") AS "Values"), 
"DT_Output_30" AS 
...
"DT_node_data_31" AS 
(SELECT "Values".nid AS nid, "Values"."Score" AS "Score" 
FROM (SELECT 3 AS nid, -0.03669199482580308 AS "Score" UNION ALL SELECT 4 AS nid, -0.01738245877383991 AS "Score" UNION ALL SELECT 5 AS nid, 0.05967403631053361 AS "Score") AS "Values"), 
"DT_Output_31" AS 
...
"DT_node_data_32" AS 
(SELECT "Values".nid AS nid, "Values"."Score" AS "Score" 
FROM (SELECT 3 AS nid, -0.047354940397504576 AS "Score" UNION ALL SELECT 4 AS nid, -0.02186350495939734 AS "Score" UNION ALL SELECT 5 AS nid, 0.0654815522864698 AS "Score") AS "Values"), 
"DT_Output_32" AS 
...
"DT_node_data_33" AS 
(SELECT "Values".nid AS nid, "Values"."Score" AS "Score" 
FROM (SELECT 2 AS nid, -0.04589015409901156 AS "Score" UNION ALL SELECT 6 AS nid, 0.05366832642864843 AS "Score" UNION ALL SELECT 7 AS nid, 0.006902490558498001 AS "Score") AS "Values"), 
"DT_Output_33" AS 
...
"DT_node_data_34" AS 
(SELECT "Values".nid AS nid, "Values"."Score" AS "Score" 
FROM (SELECT 3 AS nid, -0.04036530903366913 AS "Score" UNION ALL SELECT 4 AS nid, 0.05022812393397759 AS "Score" UNION ALL SELECT 5 AS nid, -0.0013497361531560142 AS "Score") AS "Values"), 
"DT_Output_34" AS 
...
(SELECT "ADS"."KEY" AS "KEY", CASE WHEN ("ADS"."Feature_7" <= 0.4062949583613622) THEN CASE WHEN ("ADS"."Feature_3" <= 1.0000000180025095e-35) THEN 4 ELSE 5 END ELSE 3 END AS node_id_2 
FROM "FourClass_10" AS "ADS"), 
"DT_node_data_35" AS 
(SELECT "Values".nid AS nid, "Values"."Score" AS "Score" 
FROM (SELECT 3 AS nid, -0.03597732953212391 AS "Score" UNION ALL SELECT 4 AS nid, -0.005003238490620017 AS "Score" UNION ALL SELECT 5 AS nid, 0.054221052694591224 AS "Score") AS "Values"), 
"DT_Output_35" AS 
...
(SELECT "ADS"."KEY" AS "KEY", CASE WHEN ("ADS"."Feature_3" <= 1.5742235554144088) THEN CASE WHEN ("ADS"."Feature_7" <= 0.4062949583613622) THEN 4 ELSE 5 END ELSE 3 END AS node_id_2 
FROM "FourClass_10" AS "ADS"), 
"DT_node_data_36" AS 
(SELECT "Values".nid AS nid, "Values"."Score" AS "Score" 
FROM (SELECT 3 AS nid, -0.04689417775505241 AS "Score" UNION ALL SELECT 4 AS nid, -0.01344040868302501 AS "Score" UNION ALL SELECT 5 AS nid, 0.07072795271090365 AS "Score") AS "Values"), 
"DT_Output_36" AS 
...
"DT_node_data_37" AS 
(SELECT "Values".nid AS nid, "Values"."Score" AS "Score" 
FROM (SELECT 2 AS nid, -0.04543614610770699 AS "Score" UNION ALL SELECT 6 AS nid, 0.0498385519623288 AS "Score" UNION ALL SELECT 7 AS nid, 0.006561093225691607 AS "Score") AS "Values"), 
"DT_Output_37" AS 
...
"DT_node_data_38" AS 
(SELECT "Values".nid AS nid, "Values"."Score" AS "Score" 
FROM (SELECT 3 AS nid, -0.039687543601591185 AS "Score" UNION ALL SELECT 4 AS nid, -0.0029994633711726906 AS "Score" UNION ALL SELECT 5 AS nid, 0.04670662536837023 AS "Score") AS "Values"), 
"DT_Output_38" AS 
...
"DT_node_data_39" AS 
(SELECT "Values".nid AS nid, "Values"."Score" AS "Score" 
FROM (SELECT 3 AS nid, -0.042499584903798536 AS "Score" UNION ALL SELECT 4 AS nid, 0.05042110102660696 AS "Score" UNION ALL SELECT 5 AS nid, -0.028183579268456146 AS "Score") AS "Values"), 
"DT_Output_39" AS 
...
FROM "DT_Output_39")
 INSERT INTO "TMP_20221008174832_NXJ8NFK_LGBM_B3" ("KEY", "Score_0", "Score_1", "Score_2", "Score_3") SELECT "T"."KEY", "T"."Score_0", "T"."Score_1", "T"."Score_2", "T"."Score_3" 
...
-- Code For temporary table TMP_20221008174832_ZMD05UF_LGBM_B4 part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221008174832_ZMD05UF_LGBM_B4" (
	"KEY" BIGINT, 
	"Score_0" FLOAT(53), 
	"Score_1" FLOAT(53), 
	"Score_2" FLOAT(53), 
...
-- Code For temporary table TMP_20221008174832_ZMD05UF_LGBM_B4 part 2. Populate
...
"DT_node_data_40" AS 
(SELECT "Values".nid AS nid, "Values"."Score" AS "Score" 
FROM (SELECT 3 AS nid, -0.04648319605574644 AS "Score" UNION ALL SELECT 4 AS nid, -0.020778781933731727 AS "Score" UNION ALL SELECT 5 AS nid, 0.057501094796974385 AS "Score") AS "Values"), 
"DT_Output_40" AS 
...
"DT_node_data_41" AS 
(SELECT "Values".nid AS nid, "Values"."Score" AS "Score" 
FROM (SELECT 2 AS nid, -0.04495028285813835 AS "Score" UNION ALL SELECT 6 AS nid, 0.046317438024770514 AS "Score" UNION ALL SELECT 7 AS nid, 0.006041213321077022 AS "Score") AS "Values"), 
"DT_Output_41" AS 
...
"DT_node_data_42" AS 
(SELECT "Values".nid AS nid, "Values"."Score" AS "Score" 
FROM (SELECT 3 AS nid, -0.03905869207408785 AS "Score" UNION ALL SELECT 4 AS nid, 0.04570599090628229 AS "Score" UNION ALL SELECT 5 AS nid, -0.0017329860869479468 AS "Score") AS "Values"), 
"DT_Output_42" AS 
...
(SELECT "ADS"."KEY" AS "KEY", CASE WHEN ("ADS"."Feature_1" <= -0.21648049665219846) THEN 2 ELSE CASE WHEN ("ADS"."Feature_7" <= 1.0000000180025095e-35) THEN 6 ELSE 7 END END AS node_id_2 
FROM "FourClass_10" AS "ADS"), 
"DT_node_data_43" AS 
(SELECT "Values".nid AS nid, "Values"."Score" AS "Score" 
FROM (SELECT 2 AS nid, -0.04868675793771525 AS "Score" UNION ALL SELECT 6 AS nid, 0.05531028551345919 AS "Score" UNION ALL SELECT 7 AS nid, -0.025465442480384903 AS "Score") AS "Values"), 
"DT_Output_43" AS 
...
"DT_node_data_44" AS 
(SELECT "Values".nid AS nid, "Values"."Score" AS "Score" 
FROM (SELECT 3 AS nid, -0.04608932380425477 AS "Score" UNION ALL SELECT 4 AS nid, -0.012552759633644765 AS "Score" UNION ALL SELECT 5 AS nid, 0.06195227740419365 AS "Score") AS "Values"), 
"DT_Output_44" AS 
...
"DT_node_data_45" AS 
(SELECT "Values".nid AS nid, "Values"."Score" AS "Score" 
FROM (SELECT 2 AS nid, -0.04454428558339399 AS "Score" UNION ALL SELECT 6 AS nid, 0.04337693556234936 AS "Score" UNION ALL SELECT 7 AS nid, 0.005580271165629908 AS "Score") AS "Values"), 
"DT_Output_45" AS 
...
(SELECT "ADS"."KEY" AS "KEY", CASE WHEN ("ADS"."Feature_3" <= -1.3922299023982363) THEN 2 ELSE CASE WHEN ("ADS"."Feature_5" <= 0.1710269396013543) THEN CASE WHEN ("ADS"."Feature_4" <= -1.0000000180025095e-35) THEN 12 ELSE 13 END ELSE 7 END END AS node_id_2 
FROM "FourClass_10" AS "ADS"), 
"DT_node_data_46" AS 
(SELECT "Values".nid AS nid, "Values"."Score" AS "Score" 
FROM (SELECT 2 AS nid, 0.049935750003927824 AS "Score" UNION ALL SELECT 7 AS nid, 0.013265421499157238 AS "Score" UNION ALL SELECT 12 AS nid, -0.024145388366275153 AS "Score" UNION ALL SELECT 13 AS nid, -0.04860134932574973 AS "Score") AS "Values"), 
"DT_Output_46" AS 
...
"DT_node_data_47" AS 
(SELECT "Values".nid AS nid, "Values"."Score" AS "Score" 
FROM (SELECT 2 AS nid, -0.0481225605008722 AS "Score" UNION ALL SELECT 6 AS nid, 0.04983370793319152 AS "Score" UNION ALL SELECT 7 AS nid, -0.02919188519819161 AS "Score") AS "Values"), 
"DT_Output_47" AS 
...
(SELECT "ADS"."KEY" AS "KEY", CASE WHEN ("ADS"."Feature_3" <= 1.5742235554144088) THEN CASE WHEN ("ADS"."Feature_4" <= -0.42340240049108735) THEN 4 ELSE 5 END ELSE 3 END AS node_id_2 
FROM "FourClass_10" AS "ADS"), 
"DT_node_data_48" AS 
(SELECT "Values".nid AS nid, "Values"."Score" AS "Score" 
FROM (SELECT 3 AS nid, -0.04569303671116873 AS "Score" UNION ALL SELECT 4 AS nid, -0.025415380051147452 AS "Score" UNION ALL SELECT 5 AS nid, 0.04777523676834759 AS "Score") AS "Values"), 
"DT_Output_48" AS 
...
(SELECT "ADS"."KEY" AS "KEY", CASE WHEN ("ADS"."Feature_3" <= 0.6375722768103697) THEN 2 ELSE CASE WHEN ("ADS"."Feature_5" <= -0.27328940997574497) THEN 6 ELSE 7 END END AS node_id_2 
FROM "FourClass_10" AS "ADS"), 
"DT_node_data_49" AS 
(SELECT "Values".nid AS nid, "Values"."Score" AS "Score" 
FROM (SELECT 2 AS nid, -0.04415834808904532 AS "Score" UNION ALL SELECT 6 AS nid, 0.04522733564863889 AS "Score" UNION ALL SELECT 7 AS nid, 0.0026082675138689162 AS "Score") AS "Values"), 
"DT_Output_49" AS 
...
FROM "DT_Output_49")
 INSERT INTO "TMP_20221008174832_ZMD05UF_LGBM_B4" ("KEY", "Score_0", "Score_1", "Score_2", "Score_3") SELECT "T"."KEY", "T"."Score_0", "T"."Score_1", "T"."Score_2", "T"."Score_3" 
...
-- Code For temporary table TMP_20221008174832_EB7ZMF5_LGBM_B5 part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221008174832_EB7ZMF5_LGBM_B5" (
	"KEY" BIGINT, 
	"Score_0" FLOAT(53), 
	"Score_1" FLOAT(53), 
	"Score_2" FLOAT(53), 
...
-- Code For temporary table TMP_20221008174832_EB7ZMF5_LGBM_B5 part 2. Populate
...
"DT_node_data_50" AS 
(SELECT "Values".nid AS nid, "Values"."Score" AS "Score" 
FROM (SELECT 2 AS nid, 0.046875662685489455 AS "Score" UNION ALL SELECT 7 AS nid, 0.012746890094524815 AS "Score" UNION ALL SELECT 12 AS nid, -0.023364203592405042 AS "Score" UNION ALL SELECT 13 AS nid, -0.04799344507277831 AS "Score") AS "Values"), 
"DT_Output_50" AS 
...
"DT_node_data_51" AS 
(SELECT "Values".nid AS nid, "Values"."Score" AS "Score" 
FROM (SELECT 3 AS nid, -0.04141596473734932 AS "Score" UNION ALL SELECT 4 AS nid, 0.04579642421005694 AS "Score" UNION ALL SELECT 5 AS nid, -0.0260705864151023 AS "Score") AS "Values"), 
"DT_Output_51" AS 
...
"DT_node_data_52" AS 
(SELECT "Values".nid AS nid, "Values"."Score" AS "Score" 
FROM (SELECT 3 AS nid, -0.045329075290724725 AS "Score" UNION ALL SELECT 4 AS nid, -0.024568913988998478 AS "Score" UNION ALL SELECT 5 AS nid, 0.04461070983667146 AS "Score") AS "Values"), 
"DT_Output_52" AS 
...
"DT_node_data_53" AS 
(SELECT "Values".nid AS nid, "Values"."Score" AS "Score" 
FROM (SELECT 2 AS nid, -0.04379920448940648 AS "Score" UNION ALL SELECT 6 AS nid, 0.04227344450649518 AS "Score" UNION ALL SELECT 7 AS nid, 0.002401988051272615 AS "Score") AS "Values"), 
"DT_Output_53" AS 
...
"DT_node_data_54" AS 
(SELECT "Values".nid AS nid, "Values"."Score" AS "Score" 
FROM (SELECT 3 AS nid, -0.03760687145560755 AS "Score" UNION ALL SELECT 4 AS nid, -0.0025358872695198293 AS "Score" UNION ALL SELECT 5 AS nid, 0.039447995959841324 AS "Score") AS "Values"), 
"DT_Output_54" AS 
...
"DT_node_data_55" AS 
(SELECT "Values".nid AS nid, "Values"."Score" AS "Score" 
FROM (SELECT 2 AS nid, -0.04752480890296887 AS "Score" UNION ALL SELECT 6 AS nid, 0.04660661733188995 AS "Score" UNION ALL SELECT 7 AS nid, -0.027839677863579583 AS "Score") AS "Values"), 
"DT_Output_55" AS 
...
"DT_node_data_56" AS 
(SELECT "Values".nid AS nid, "Values"."Score" AS "Score" 
FROM (SELECT 3 AS nid, -0.044979349936968185 AS "Score" UNION ALL SELECT 4 AS nid, -0.011754082835796934 AS "Score" UNION ALL SELECT 5 AS nid, 0.052507689015374795 AS "Score") AS "Values"), 
"DT_Output_56" AS 
...
"DT_node_data_57" AS 
(SELECT "Values".nid AS nid, "Values"."Score" AS "Score" 
FROM (SELECT 2 AS nid, -0.04347704110763147 AS "Score" UNION ALL SELECT 6 AS nid, 0.03976051733401534 AS "Score" UNION ALL SELECT 7 AS nid, 0.0023959571044245044 AS "Score") AS "Values"), 
"DT_Output_57" AS 
...
(SELECT "ADS"."KEY" AS "KEY", CASE WHEN ("ADS"."Feature_3" <= -1.3922299023982363) THEN 2 ELSE CASE WHEN ("ADS"."Feature_0" <= 0.6478569902021423) THEN CASE WHEN ("ADS"."Feature_5" <= 0.09727261802506705) THEN 12 ELSE 13 END ELSE 7 END END AS node_id_2 
FROM "FourClass_10" AS "ADS"), 
"DT_node_data_58" AS 
(SELECT "Values".nid AS nid, "Values"."Score" AS "Score" 
FROM (SELECT 2 AS nid, 0.04370688749041975 AS "Score" UNION ALL SELECT 7 AS nid, 0.020401481459876882 AS "Score" UNION ALL SELECT 12 AS nid, -0.04628172149156431 AS "Score" UNION ALL SELECT 13 AS nid, -0.013997561911684981 AS "Score") AS "Values"), 
"DT_Output_58" AS 
...
(SELECT "ADS"."KEY" AS "KEY", CASE WHEN ("ADS"."Feature_4" <= 1.0000000180025095e-35) THEN CASE WHEN ("ADS"."Feature_7" <= -0.10861500751147783) THEN 4 ELSE 5 END ELSE 3 END AS node_id_2 
FROM "FourClass_10" AS "ADS"), 
"DT_node_data_59" AS 
(SELECT "Values".nid AS nid, "Values"."Score" AS "Score" 
FROM (SELECT 3 AS nid, -0.040547301637495606 AS "Score" UNION ALL SELECT 4 AS nid, 0.04019886347023366 AS "Score" UNION ALL SELECT 5 AS nid, -0.011642315524655434 AS "Score") AS "Values"), 
"DT_Output_59" AS 
...
FROM "DT_Output_59")
 INSERT INTO "TMP_20221008174832_EB7ZMF5_LGBM_B5" ("KEY", "Score_0", "Score_1", "Score_2", "Score_3") SELECT "T"."KEY", "T"."Score_0", "T"."Score_1", "T"."Score_2", "T"."Score_3" 
...
-- Code For temporary table TMP_20221008174832_PQMYTDE_LGBM_B6 part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221008174832_PQMYTDE_LGBM_B6" (
	"KEY" BIGINT, 
	"Score_0" FLOAT(53), 
	"Score_1" FLOAT(53), 
	"Score_2" FLOAT(53), 
...
-- Code For temporary table TMP_20221008174832_PQMYTDE_LGBM_B6 part 2. Populate

WITH "DT_node_lookup_60" AS 
(SELECT "ADS"."KEY" AS "KEY", CASE WHEN ("ADS"."Feature_3" <= 1.5742235554144088) THEN CASE WHEN ("ADS"."Feature_5" <= 0.1710269396013543) THEN 4 ELSE 5 END ELSE 3 END AS node_id_2 
FROM "FourClass_10" AS "ADS"), 
"DT_node_data_60" AS 
(SELECT "Values".nid AS nid, "Values"."Score" AS "Score" 
FROM (SELECT 3 AS nid, -0.04465507666291172 AS "Score" UNION ALL SELECT 4 AS nid, 0.04262103827817522 AS "Score" UNION ALL SELECT 5 AS nid, -0.021028672431481835 AS "Score") AS "Values"), 
"DT_Output_60" AS 
...
"DT_node_data_61" AS 
(SELECT "Values".nid AS nid, "Values"."Score" AS "Score" 
FROM (SELECT 2 AS nid, -0.04313382507932778 AS "Score" UNION ALL SELECT 6 AS nid, 0.03730512287801426 AS "Score" UNION ALL SELECT 7 AS nid, 0.0020981827875810113 AS "Score") AS "Values"), 
"DT_Output_61" AS 
...
"DT_node_data_62" AS 
(SELECT "Values".nid AS nid, "Values"."Score" AS "Score" 
FROM (SELECT 3 AS nid, -0.0367477801115761 AS "Score" UNION ALL SELECT 4 AS nid, -0.002081390775801361 AS "Score" UNION ALL SELECT 5 AS nid, 0.03660509445490209 AS "Score") AS "Values"), 
"DT_Output_62" AS 
...
"DT_node_data_63" AS 
(SELECT "Values".nid AS nid, "Values"."Score" AS "Score" 
FROM (SELECT 2 AS nid, -0.047045818891393705 AS "Score" UNION ALL SELECT 6 AS nid, 0.043812327155963095 AS "Score" UNION ALL SELECT 7 AS nid, -0.026627471044625435 AS "Score") AS "Values"), 
"DT_Output_63" AS 
...
FROM "DT_Output_63")
 INSERT INTO "TMP_20221008174832_PQMYTDE_LGBM_B6" ("KEY", "Score_0", "Score_1", "Score_2", "Score_3") SELECT "T"."KEY", "T"."Score_0", "T"."Score_1", "T"."Score_2", "T"."Score_3" 
...
-- Code For temporary table TMP_20221008174832_I9VRDNE_LGBM_sum part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221008174832_I9VRDNE_LGBM_sum" (
	"KEY" BIGINT NOT NULL, 
	"Score_0" FLOAT(53), 
	"Score_1" FLOAT(53), 
	"Score_2" FLOAT(53), 
...
-- Code For temporary table TMP_20221008174832_I9VRDNE_LGBM_sum part 2. Populate
...
FROM (SELECT "LGBM_B0"."KEY" AS "KEY", "LGBM_B0"."Score_0" AS "Score_0", "LGBM_B0"."Score_1" AS "Score_1", "LGBM_B0"."Score_2" AS "Score_2", "LGBM_B0"."Score_3" AS "Score_3" 
FROM "TMP_20221008174832_6B8FYNM_LGBM_B0" AS "LGBM_B0" UNION ALL SELECT "LGBM_B1"."KEY" AS "KEY", "LGBM_B1"."Score_0" AS "Score_0", "LGBM_B1"."Score_1" AS "Score_1", "LGBM_B1"."Score_2" AS "Score_2", "LGBM_B1"."Score_3" AS "Score_3" 
FROM "TMP_20221008174832_WPFFG8E_LGBM_B1" AS "LGBM_B1" UNION ALL SELECT "LGBM_B2"."KEY" AS "KEY", "LGBM_B2"."Score_0" AS "Score_0", "LGBM_B2"."Score_1" AS "Score_1", "LGBM_B2"."Score_2" AS "Score_2", "LGBM_B2"."Score_3" AS "Score_3" 
FROM "TMP_20221008174832_A3MC2BE_LGBM_B2" AS "LGBM_B2" UNION ALL SELECT "LGBM_B3"."KEY" AS "KEY", "LGBM_B3"."Score_0" AS "Score_0", "LGBM_B3"."Score_1" AS "Score_1", "LGBM_B3"."Score_2" AS "Score_2", "LGBM_B3"."Score_3" AS "Score_3" 
FROM "TMP_20221008174832_NXJ8NFK_LGBM_B3" AS "LGBM_B3" UNION ALL SELECT "LGBM_B4"."KEY" AS "KEY", "LGBM_B4"."Score_0" AS "Score_0", "LGBM_B4"."Score_1" AS "Score_1", "LGBM_B4"."Score_2" AS "Score_2", "LGBM_B4"."Score_3" AS "Score_3" 
FROM "TMP_20221008174832_ZMD05UF_LGBM_B4" AS "LGBM_B4" UNION ALL SELECT "LGBM_B5"."KEY" AS "KEY", "LGBM_B5"."Score_0" AS "Score_0", "LGBM_B5"."Score_1" AS "Score_1", "LGBM_B5"."Score_2" AS "Score_2", "LGBM_B5"."Score_3" AS "Score_3" 
FROM "TMP_20221008174832_EB7ZMF5_LGBM_B5" AS "LGBM_B5" UNION ALL SELECT "LGBM_B6"."KEY" AS "KEY", "LGBM_B6"."Score_0" AS "Score_0", "LGBM_B6"."Score_1" AS "Score_1", "LGBM_B6"."Score_2" AS "Score_2", "LGBM_B6"."Score_3" AS "Score_3" 
FROM "TMP_20221008174832_PQMYTDE_LGBM_B6" AS "LGBM_B6") AS "LGBM_EnsembleUnion")
 INSERT INTO "TMP_20221008174832_I9VRDNE_LGBM_sum" ("KEY", "Score_0", "Score_1", "Score_2", "Score_3") SELECT "T"."KEY", "T"."Score_0", "T"."Score_1", "T"."Score_2", "T"."Score_3" 
...
-- Code For temporary table TMP_20221008174832_I9VRDNE_LGBM_sum part 3. Create Index 

CREATE INDEX "ix_TMP_20221008174832_I9VRDNE_LGBM_sum_KEY" ON "TMP_20221008174832_I9VRDNE_LGBM_sum" ("KEY")
...
FROM "TMP_20221008174832_I9VRDNE_LGBM_sum" AS "LGBM_sum"), 
