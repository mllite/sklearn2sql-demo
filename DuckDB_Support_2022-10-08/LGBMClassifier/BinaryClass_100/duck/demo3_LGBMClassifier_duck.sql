...
-- Code For temporary table TMP_20221008174729_ZZA4YV3_LGBM_B0 part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221008174729_ZZA4YV3_LGBM_B0" (
	"KEY" BIGINT, 
	"Score_0" FLOAT(53)
)
...
-- Code For temporary table TMP_20221008174729_ZZA4YV3_LGBM_B0 part 2. Populate
...
FROM "DT_Output_9")
 INSERT INTO "TMP_20221008174729_ZZA4YV3_LGBM_B0" ("KEY", "Score_0") SELECT "T"."KEY", "T"."Score_0" 
...
-- Code For temporary table TMP_20221008174729_BERY0MU_LGBM_B1 part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221008174729_BERY0MU_LGBM_B1" (
	"KEY" BIGINT, 
	"Score_0" FLOAT(53)
)
...
-- Code For temporary table TMP_20221008174729_BERY0MU_LGBM_B1 part 2. Populate
...
FROM "DT_Output_15")
 INSERT INTO "TMP_20221008174729_BERY0MU_LGBM_B1" ("KEY", "Score_0") SELECT "T"."KEY", "T"."Score_0" 
...
-- Code For temporary table TMP_20221008174729_PXZURW9_LGBM_sum part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221008174729_PXZURW9_LGBM_sum" (
	"KEY" BIGINT NOT NULL, 
	"Score_0" FLOAT(53), 
	PRIMARY KEY ("KEY")
)
...
-- Code For temporary table TMP_20221008174729_PXZURW9_LGBM_sum part 2. Populate

WITH "LGBM_Union" AS 
(SELECT "LGBM_EnsembleUnion"."KEY" AS "KEY", "LGBM_EnsembleUnion"."Score_0" AS "Score_0" 
FROM (SELECT "LGBM_B0"."KEY" AS "KEY", "LGBM_B0"."Score_0" AS "Score_0" 
FROM "TMP_20221008174729_ZZA4YV3_LGBM_B0" AS "LGBM_B0" UNION ALL SELECT "LGBM_B1"."KEY" AS "KEY", "LGBM_B1"."Score_0" AS "Score_0" 
FROM "TMP_20221008174729_BERY0MU_LGBM_B1" AS "LGBM_B1") AS "LGBM_EnsembleUnion")
 INSERT INTO "TMP_20221008174729_PXZURW9_LGBM_sum" ("KEY", "Score_0") SELECT "T"."KEY", "T"."Score_0" 
...
-- Code For temporary table TMP_20221008174729_PXZURW9_LGBM_sum part 3. Create Index 

CREATE INDEX "ix_TMP_20221008174729_PXZURW9_LGBM_sum_KEY" ON "TMP_20221008174729_PXZURW9_LGBM_sum" ("KEY")
...
FROM "TMP_20221008174729_PXZURW9_LGBM_sum" AS "LGBM_sum"), 
