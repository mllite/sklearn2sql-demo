...
-- Code For temporary table TMP_20221008174751_4S4XXFM_CalProb_B0 part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221008174751_4S4XXFM_CalProb_B0" (
	"KEY" BIGINT, 
	"Proba_1" FLOAT, 
	"Proba_0" FLOAT
)
...
-- Code For temporary table TMP_20221008174751_4S4XXFM_CalProb_B0 part 2. Populate
...
FROM "DT_Output_1"), 
isotonic_cte_1 AS 
(SELECT "Calibrated_Model_1"."KEY" AS "KEY", CASE WHEN ("Calibrated_Model_1"."ScoreOrProba_1" < 0.0) THEN 0.07692307692307693 WHEN ("Calibrated_Model_1"."ScoreOrProba_1" < 0.3333333333333333) THEN ("Calibrated_Model_1"."ScoreOrProba_1" - 0.0) * 2.609230769230769 + 0.07692307692307693 WHEN ("Calibrated_Model_1"."ScoreOrProba_1" < 1.0) THEN ("Calibrated_Model_1"."ScoreOrProba_1" - 0.3333333333333333) * 0.0 + 0.9466666666666667 ELSE 0.9466666666666667 END AS "Proba_1", 1.0 - CASE WHEN ("Calibrated_Model_1"."ScoreOrProba_1" < 0.0) THEN 0.07692307692307693 WHEN ("Calibrated_Model_1"."ScoreOrProba_1" < 0.3333333333333333) THEN ("Calibrated_Model_1"."ScoreOrProba_1" - 0.0) * 2.609230769230769 + 0.07692307692307693 WHEN ("Calibrated_Model_1"."ScoreOrProba_1" < 1.0) THEN ("Calibrated_Model_1"."ScoreOrProba_1" - 0.3333333333333333) * 0.0 + 0.9466666666666667 ELSE 0.9466666666666667 END AS "Proba_0" 
...
FROM isotonic_cte_3)
 INSERT INTO "TMP_20221008174751_4S4XXFM_CalProb_B0" ("KEY", "Proba_1", "Proba_0") SELECT "T"."KEY", "T"."Proba_1", "T"."Proba_0" 
...
-- Code For temporary table TMP_20221008174751_TJ742U3_CalProb_avg part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221008174751_TJ742U3_CalProb_avg" (
	"KEY" BIGINT NOT NULL, 
	"Proba_1" FLOAT(53), 
	"Proba_0" FLOAT(53), 
	PRIMARY KEY ("KEY")
...
-- Code For temporary table TMP_20221008174751_TJ742U3_CalProb_avg part 2. Populate
...
FROM (SELECT "CalProb_B0"."KEY" AS "KEY", "CalProb_B0"."Proba_1" AS "Proba_1", "CalProb_B0"."Proba_0" AS "Proba_0" 
FROM "TMP_20221008174751_4S4XXFM_CalProb_B0" AS "CalProb_B0") AS "CalProb_EnsembleUnion")
 INSERT INTO "TMP_20221008174751_TJ742U3_CalProb_avg" ("KEY", "Proba_1", "Proba_0") SELECT "T"."KEY", "T"."Proba_1", "T"."Proba_0" 
...
-- Code For temporary table TMP_20221008174751_TJ742U3_CalProb_avg part 3. Create Index 

CREATE INDEX "ix_TMP_20221008174751_TJ742U3_CalProb_avg_KEY" ON "TMP_20221008174751_TJ742U3_CalProb_avg" ("KEY")
...
FROM "TMP_20221008174751_TJ742U3_CalProb_avg" AS "CalProb_avg"), 
