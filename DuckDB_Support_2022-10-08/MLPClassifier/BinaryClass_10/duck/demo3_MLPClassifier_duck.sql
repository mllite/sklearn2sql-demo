...
-- Code For temporary table TMP_20221008174702_KOHLQRC_HL_1_relu_1 part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221008174702_KOHLQRC_HL_1_relu_1" (
	"KEY" BIGINT NOT NULL, 
	"NEUR_1_1" FLOAT, 
	"NEUR_1_2" FLOAT, 
	"NEUR_1_3" FLOAT, 
...
-- Code For temporary table TMP_20221008174702_KOHLQRC_HL_1_relu_1 part 2. Populate
...
FROM "HL_BA_1")
 INSERT INTO "TMP_20221008174702_KOHLQRC_HL_1_relu_1" ("KEY", "NEUR_1_1", "NEUR_1_2", "NEUR_1_3") SELECT "T"."KEY", "T"."NEUR_1_1", "T"."NEUR_1_2", "T"."NEUR_1_3" 
...
-- Code For temporary table TMP_20221008174702_KOHLQRC_HL_1_relu_1 part 3. Create Index 

CREATE INDEX "ix_TMP_20221008174702_KOHLQRC_HL_1_relu_1_KEY" ON "TMP_20221008174702_KOHLQRC_HL_1_relu_1" ("KEY")

-- Code For temporary table TMP_20221008174702_6OPSFD7_OL_logistic_1 part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221008174702_6OPSFD7_OL_logistic_1" (
	"KEY" BIGINT NOT NULL, 
	"NEUR_3_1" FLOAT, 
	PRIMARY KEY ("KEY")
)
...
-- Code For temporary table TMP_20221008174702_6OPSFD7_OL_logistic_1 part 2. Populate
...
FROM "TMP_20221008174702_KOHLQRC_HL_1_relu_1" AS "HL_1_relu_1"), 
"HL_2_relu" AS 
...
FROM "OL_BA")
 INSERT INTO "TMP_20221008174702_6OPSFD7_OL_logistic_1" ("KEY", "NEUR_3_1") SELECT "T"."KEY", "T"."NEUR_3_1" 
...
-- Code For temporary table TMP_20221008174702_6OPSFD7_OL_logistic_1 part 3. Create Index 

CREATE INDEX "ix_TMP_20221008174702_6OPSFD7_OL_logistic_1_KEY" ON "TMP_20221008174702_6OPSFD7_OL_logistic_1" ("KEY")
...
FROM "TMP_20221008174702_6OPSFD7_OL_logistic_1" AS "OL_logistic_1"), 
