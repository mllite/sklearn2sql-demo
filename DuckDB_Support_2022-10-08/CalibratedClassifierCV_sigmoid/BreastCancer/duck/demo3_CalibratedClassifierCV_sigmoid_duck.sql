...
-- Code For temporary table TMP_20221008174749_D93AN9W_CalProb_B0 part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221008174749_D93AN9W_CalProb_B0" (
	"KEY" BIGINT, 
	"Proba_1" FLOAT, 
	"Proba_0" FLOAT
)
...
-- Code For temporary table TMP_20221008174749_D93AN9W_CalProb_B0 part 2. Populate

WITH "DT_node_lookup" AS 
(SELECT "ADS"."KEY" AS "KEY", CASE WHEN ("ADS"."Feature_27" <= 0.14695000648498535) THEN CASE WHEN ("ADS"."Feature_23" <= 953.9500122070312) THEN CASE WHEN ("ADS"."Feature_27" <= 0.12230000272393227) THEN CASE WHEN ("ADS"."Feature_10" <= 0.6430999934673309) THEN 4 ELSE CASE WHEN ("ADS"."Feature_1" <= 18.934999465942383) THEN 6 ELSE 7 END END ELSE CASE WHEN ("ADS"."Feature_10" <= 0.40389999747276306) THEN CASE WHEN ("ADS"."Feature_21" <= 33.91499900817871) THEN 10 ELSE 11 END ELSE CASE WHEN ("ADS"."Feature_7" <= 0.06902500055730343) THEN 13 ELSE 14 END END END ELSE CASE WHEN ("ADS"."Feature_26" <= 0.190700002014637) THEN CASE WHEN ("ADS"."Feature_22" <= 122.05000305175781) THEN 17 ELSE 18 END ELSE 19 END END ELSE CASE WHEN ("ADS"."Feature_0" <= 10.405499935150146) THEN 21 ELSE CASE WHEN ("ADS"."Feature_26" <= 0.20340000092983246) THEN 23 ELSE CASE WHEN ("ADS"."Feature_7" <= 0.05633999966084957) THEN CASE WHEN ("ADS"."Feature_7" <= 0.054854998365044594) THEN 26 ELSE 27 END ELSE 28 END END END END AS node_id_2 
...
"DT_node_lookup_1" AS 
(SELECT "ADS"."KEY" AS "KEY", CASE WHEN ("ADS"."Feature_27" <= 0.1436000019311905) THEN CASE WHEN ("ADS"."Feature_23" <= 961.5500183105469) THEN CASE WHEN ("ADS"."Feature_18" <= 0.008710499852895737) THEN 3 ELSE CASE WHEN ("ADS"."Feature_27" <= 0.1318499967455864) THEN 5 ELSE CASE WHEN ("ADS"."Feature_23" <= 779.75) THEN 7 ELSE 8 END END END ELSE 9 END ELSE CASE WHEN ("ADS"."Feature_16" <= 0.13565000146627426) THEN CASE WHEN ("ADS"."Feature_6" <= 0.08810999989509583) THEN CASE WHEN ("ADS"."Feature_28" <= 0.3084000051021576) THEN CASE WHEN ("ADS"."Feature_20" <= 18.149999618530273) THEN 14 ELSE 15 END ELSE 16 END ELSE 17 END ELSE 18 END END AS node_id_2 
FROM "BreastCancer" AS "ADS"), 
"DT_node_data_1" AS 
(SELECT "Values".nid AS nid, "Values"."P_0" AS "P_0", "Values"."P_1" AS "P_1", "Values"."D" AS "D", "Values"."DP" AS "DP" 
...
"DT_node_lookup_2" AS 
(SELECT "ADS"."KEY" AS "KEY", CASE WHEN ("ADS"."Feature_27" <= 0.14239999651908875) THEN CASE WHEN ("ADS"."Feature_23" <= 1058.0) THEN CASE WHEN ("ADS"."Feature_13" <= 48.70000076293945) THEN CASE WHEN ("ADS"."Feature_27" <= 0.1221500001847744) THEN 4 ELSE CASE WHEN ("ADS"."Feature_10" <= 0.41290000081062317) THEN 6 ELSE 7 END END ELSE CASE WHEN ("ADS"."Feature_4" <= 0.09071999788284302) THEN 9 ELSE CASE WHEN ("ADS"."Feature_21" <= 20.864999771118164) THEN 11 ELSE 12 END END END ELSE 13 END ELSE CASE WHEN ("ADS"."Feature_16" <= 0.12629999965429306) THEN CASE WHEN ("ADS"."Feature_12" <= 1.2384999990463257) THEN 16 ELSE CASE WHEN ("ADS"."Feature_1" <= 15.345000267028809) THEN CASE WHEN ("ADS"."Feature_7" <= 0.06742499954998493) THEN 19 ELSE 20 END ELSE 21 END END ELSE 22 END END AS node_id_2 
FROM "BreastCancer" AS "ADS"), 
"DT_node_data_2" AS 
(SELECT "Values".nid AS nid, "Values"."P_0" AS "P_0", "Values"."P_1" AS "P_1", "Values"."D" AS "D", "Values"."DP" AS "DP" 
...
"DT_node_lookup_3" AS 
(SELECT "ADS"."KEY" AS "KEY", CASE WHEN ("ADS"."Feature_27" <= 0.14559999853372574) THEN CASE WHEN ("ADS"."Feature_23" <= 1058.0) THEN CASE WHEN ("ADS"."Feature_18" <= 0.010340000037103891) THEN CASE WHEN ("ADS"."Feature_7" <= 0.03027999959886074) THEN 4 ELSE 5 END ELSE CASE WHEN ("ADS"."Feature_13" <= 32.98499870300293) THEN 7 ELSE CASE WHEN ("ADS"."Feature_21" <= 29.18000030517578) THEN 9 ELSE 10 END END END ELSE 11 END ELSE CASE WHEN ("ADS"."Feature_16" <= 0.13565000146627426) THEN CASE WHEN ("ADS"."Feature_26" <= 0.20340000092983246) THEN 14 ELSE 15 END ELSE 16 END END AS node_id_2 
FROM "BreastCancer" AS "ADS"), 
"DT_node_data_3" AS 
(SELECT "Values".nid AS nid, "Values"."P_0" AS "P_0", "Values"."P_1" AS "P_1", "Values"."D" AS "D", "Values"."DP" AS "DP" 
...
FROM sigmoid_calibration_3)
 INSERT INTO "TMP_20221008174749_D93AN9W_CalProb_B0" ("KEY", "Proba_1", "Proba_0") SELECT "T"."KEY", "T"."Proba_1", "T"."Proba_0" 
...
-- Code For temporary table TMP_20221008174749_HR9SBJC_CalProb_avg part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221008174749_HR9SBJC_CalProb_avg" (
	"KEY" BIGINT NOT NULL, 
	"Proba_1" FLOAT(53), 
	"Proba_0" FLOAT(53), 
	PRIMARY KEY ("KEY")
...
-- Code For temporary table TMP_20221008174749_HR9SBJC_CalProb_avg part 2. Populate
...
FROM (SELECT "CalProb_B0"."KEY" AS "KEY", "CalProb_B0"."Proba_1" AS "Proba_1", "CalProb_B0"."Proba_0" AS "Proba_0" 
FROM "TMP_20221008174749_D93AN9W_CalProb_B0" AS "CalProb_B0") AS "CalProb_EnsembleUnion")
 INSERT INTO "TMP_20221008174749_HR9SBJC_CalProb_avg" ("KEY", "Proba_1", "Proba_0") SELECT "T"."KEY", "T"."Proba_1", "T"."Proba_0" 
...
-- Code For temporary table TMP_20221008174749_HR9SBJC_CalProb_avg part 3. Create Index 

CREATE INDEX "ix_TMP_20221008174749_HR9SBJC_CalProb_avg_KEY" ON "TMP_20221008174749_HR9SBJC_CalProb_avg" ("KEY")
...
FROM "TMP_20221008174749_HR9SBJC_CalProb_avg" AS "CalProb_avg"), 
