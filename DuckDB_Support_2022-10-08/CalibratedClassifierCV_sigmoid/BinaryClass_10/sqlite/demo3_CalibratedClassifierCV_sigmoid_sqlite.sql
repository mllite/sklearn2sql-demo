...
-- Code For temporary table TMP_20221008174647_FV6MQLL_CalProb_B0 part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221008174647_FV6MQLL_CalProb_B0" (
	"KEY" BIGINT, 
	"Proba_1" FLOAT, 
	"Proba_0" FLOAT
)
...
-- Code For temporary table TMP_20221008174647_FV6MQLL_CalProb_B0 part 2. Populate
...
(SELECT "Calibrated_Model_0"."KEY" AS "KEY", 1.0 / (1.0 + exp(min(100.0, max(-100.0, -(3.3640840384918063 * "Calibrated_Model_0"."ScoreOrProba_1" + -0.9661855827081625))))) AS "Proba_1", 1.0 - 1.0 / (1.0 + exp(min(100.0, max(-100.0, -(3.3640840384918063 * "Calibrated_Model_0"."ScoreOrProba_1" + -0.9661855827081625))))) AS "Proba_0" 
...
(SELECT "Calibrated_Model_1"."KEY" AS "KEY", 1.0 / (1.0 + exp(min(100.0, max(-100.0, -(2.7526301314605353 * "Calibrated_Model_1"."ScoreOrProba_1" + -1.597109346935524))))) AS "Proba_1", 1.0 - 1.0 / (1.0 + exp(min(100.0, max(-100.0, -(2.7526301314605353 * "Calibrated_Model_1"."ScoreOrProba_1" + -1.597109346935524))))) AS "Proba_0" 
...
(SELECT "Calibrated_Model_2"."KEY" AS "KEY", 1.0 / (1.0 + exp(min(100.0, max(-100.0, -(3.650659014145949 * "Calibrated_Model_2"."ScoreOrProba_1" + -1.2527629098223438))))) AS "Proba_1", 1.0 - 1.0 / (1.0 + exp(min(100.0, max(-100.0, -(3.650659014145949 * "Calibrated_Model_2"."ScoreOrProba_1" + -1.2527629098223438))))) AS "Proba_0" 
...
(SELECT "Calibrated_Model_3"."KEY" AS "KEY", 1.0 / (1.0 + exp(min(100.0, max(-100.0, -(4.062903184000669 * "Calibrated_Model_3"."ScoreOrProba_1" + -2.3978968871297437))))) AS "Proba_1", 1.0 - 1.0 / (1.0 + exp(min(100.0, max(-100.0, -(4.062903184000669 * "Calibrated_Model_3"."ScoreOrProba_1" + -2.3978968871297437))))) AS "Proba_0" 
...
FROM sigmoid_calibration_3)
 INSERT INTO "TMP_20221008174647_FV6MQLL_CalProb_B0" ("KEY", "Proba_1", "Proba_0") SELECT "T"."KEY", "T"."Proba_1", "T"."Proba_0" 
...
-- Code For temporary table TMP_20221008174647_M1HCH7U_CalProb_avg part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221008174647_M1HCH7U_CalProb_avg" (
	"KEY" BIGINT NOT NULL, 
	"Proba_1" FLOAT, 
	"Proba_0" FLOAT, 
	PRIMARY KEY ("KEY")
...
-- Code For temporary table TMP_20221008174647_M1HCH7U_CalProb_avg part 2. Populate
...
FROM (SELECT "CalProb_B0"."KEY" AS "KEY", "CalProb_B0"."Proba_1" AS "Proba_1", "CalProb_B0"."Proba_0" AS "Proba_0" 
FROM "TMP_20221008174647_FV6MQLL_CalProb_B0" AS "CalProb_B0") AS "CalProb_EnsembleUnion")
 INSERT INTO "TMP_20221008174647_M1HCH7U_CalProb_avg" ("KEY", "Proba_1", "Proba_0") SELECT "T"."KEY", "T"."Proba_1", "T"."Proba_0" 
...
-- Code For temporary table TMP_20221008174647_M1HCH7U_CalProb_avg part 3. Create Index 

CREATE INDEX "ix_TMP_20221008174647_M1HCH7U_CalProb_avg_KEY" ON "TMP_20221008174647_M1HCH7U_CalProb_avg" ("KEY")
...
FROM "TMP_20221008174647_M1HCH7U_CalProb_avg" AS "CalProb_avg"), 
