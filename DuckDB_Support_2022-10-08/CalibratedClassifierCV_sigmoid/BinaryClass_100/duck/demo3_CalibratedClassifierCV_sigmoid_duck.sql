...
-- Code For temporary table TMP_20221008174719_L9DA9OZ_CalProb_B0 part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221008174719_L9DA9OZ_CalProb_B0" (
	"KEY" BIGINT, 
	"Proba_1" FLOAT, 
	"Proba_0" FLOAT
)
...
-- Code For temporary table TMP_20221008174719_L9DA9OZ_CalProb_B0 part 2. Populate
...
(SELECT "Calibrated_Model_0"."KEY" AS "KEY", 1.0 / (1.0 + exp(least(100.0, greatest(-100.0, -(2.1972249883101176 * "Calibrated_Model_0"."ScoreOrProba_1" + -1.098613312520129))))) AS "Proba_1", 1.0 - 1.0 / (1.0 + exp(least(100.0, greatest(-100.0, -(2.1972249883101176 * "Calibrated_Model_0"."ScoreOrProba_1" + -1.098613312520129))))) AS "Proba_0" 
...
(SELECT "Calibrated_Model_1"."KEY" AS "KEY", 1.0 / (1.0 + exp(least(100.0, greatest(-100.0, -(0.3375229379078027 * "Calibrated_Model_1"."ScoreOrProba_1" + -0.15180579266556016))))) AS "Proba_1", 1.0 - 1.0 / (1.0 + exp(least(100.0, greatest(-100.0, -(0.3375229379078027 * "Calibrated_Model_1"."ScoreOrProba_1" + -0.15180579266556016))))) AS "Proba_0" 
...
(SELECT "Calibrated_Model_2"."KEY" AS "KEY", 1.0 / (1.0 + exp(least(100.0, greatest(-100.0, -(1.7722622792314653 * "Calibrated_Model_2"."ScoreOrProba_1" + -0.9199647363838578))))) AS "Proba_1", 1.0 - 1.0 / (1.0 + exp(least(100.0, greatest(-100.0, -(1.7722622792314653 * "Calibrated_Model_2"."ScoreOrProba_1" + -0.9199647363838578))))) AS "Proba_0" 
...
(SELECT "Calibrated_Model_3"."KEY" AS "KEY", 1.0 / (1.0 + exp(least(100.0, greatest(-100.0, -(2.353584621839785 * "Calibrated_Model_3"."ScoreOrProba_1" + -1.5899821845615933))))) AS "Proba_1", 1.0 - 1.0 / (1.0 + exp(least(100.0, greatest(-100.0, -(2.353584621839785 * "Calibrated_Model_3"."ScoreOrProba_1" + -1.5899821845615933))))) AS "Proba_0" 
...
FROM sigmoid_calibration_3)
 INSERT INTO "TMP_20221008174719_L9DA9OZ_CalProb_B0" ("KEY", "Proba_1", "Proba_0") SELECT "T"."KEY", "T"."Proba_1", "T"."Proba_0" 
...
-- Code For temporary table TMP_20221008174719_LD9YW3M_CalProb_avg part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221008174719_LD9YW3M_CalProb_avg" (
	"KEY" BIGINT NOT NULL, 
	"Proba_1" FLOAT(53), 
	"Proba_0" FLOAT(53), 
	PRIMARY KEY ("KEY")
...
-- Code For temporary table TMP_20221008174719_LD9YW3M_CalProb_avg part 2. Populate
...
FROM (SELECT "CalProb_B0"."KEY" AS "KEY", "CalProb_B0"."Proba_1" AS "Proba_1", "CalProb_B0"."Proba_0" AS "Proba_0" 
FROM "TMP_20221008174719_L9DA9OZ_CalProb_B0" AS "CalProb_B0") AS "CalProb_EnsembleUnion")
 INSERT INTO "TMP_20221008174719_LD9YW3M_CalProb_avg" ("KEY", "Proba_1", "Proba_0") SELECT "T"."KEY", "T"."Proba_1", "T"."Proba_0" 
...
-- Code For temporary table TMP_20221008174719_LD9YW3M_CalProb_avg part 3. Create Index 

CREATE INDEX "ix_TMP_20221008174719_LD9YW3M_CalProb_avg_KEY" ON "TMP_20221008174719_LD9YW3M_CalProb_avg" ("KEY")
...
FROM "TMP_20221008174719_LD9YW3M_CalProb_avg" AS "CalProb_avg"), 
