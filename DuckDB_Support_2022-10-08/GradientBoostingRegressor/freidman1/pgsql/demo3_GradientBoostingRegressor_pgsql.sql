...
-- Code For temporary table TMP_20221008175216_002P40F_GB_B0 part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221008175216_002P40F_GB_B0" (
	"KEY" BIGINT, 
	"Estimator" FLOAT
)
...
-- Code For temporary table TMP_20221008175216_002P40F_GB_B0 part 2. Populate
...
FROM "DT_Output_9")
 INSERT INTO "TMP_20221008175216_002P40F_GB_B0" ("KEY", "Estimator") SELECT "T"."KEY", "T"."Estimator" 
...
-- Code For temporary table TMP_20221008175216_XZ2X9AL_GB_B1 part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221008175216_XZ2X9AL_GB_B1" (
	"KEY" BIGINT, 
	"Estimator" FLOAT
)
...
-- Code For temporary table TMP_20221008175216_XZ2X9AL_GB_B1 part 2. Populate
...
FROM "DT_Output_15")
 INSERT INTO "TMP_20221008175216_XZ2X9AL_GB_B1" ("KEY", "Estimator") SELECT "T"."KEY", "T"."Estimator" 
...
-- Code For temporary table TMP_20221008175216_S713PFY_GB_sum part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221008175216_S713PFY_GB_sum" (
	"KEY" BIGINT NOT NULL, 
	"Estimator" FLOAT, 
	PRIMARY KEY ("KEY")
)
...
-- Code For temporary table TMP_20221008175216_S713PFY_GB_sum part 2. Populate

WITH "GB_Union" AS 
(SELECT "GB_EnsembleUnion"."KEY" AS "KEY", "GB_EnsembleUnion"."Estimator" AS "Estimator" 
FROM (SELECT "GB_B0"."KEY" AS "KEY", "GB_B0"."Estimator" AS "Estimator" 
FROM "TMP_20221008175216_002P40F_GB_B0" AS "GB_B0" UNION ALL SELECT "GB_B1"."KEY" AS "KEY", "GB_B1"."Estimator" AS "Estimator" 
FROM "TMP_20221008175216_XZ2X9AL_GB_B1" AS "GB_B1") AS "GB_EnsembleUnion")
 INSERT INTO "TMP_20221008175216_S713PFY_GB_sum" ("KEY", "Estimator") SELECT "T"."KEY", "T"."Estimator" 
...
-- Code For temporary table TMP_20221008175216_S713PFY_GB_sum part 3. Create Index 

CREATE INDEX "ix_TMP_20221008175216_S713PFY_GB_sum_KEY" ON "TMP_20221008175216_S713PFY_GB_sum" ("KEY")

-- Model deployment code

SELECT "GB_sum"."KEY" AS "KEY", 15.3537633818605 + 0.1 * "GB_sum"."Estimator" AS "Estimator" 
FROM "TMP_20221008175216_S713PFY_GB_sum" AS "GB_sum"