...
-- Code For temporary table TMP_20221008175055_QI0EPHO_GB_B0 part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221008175055_QI0EPHO_GB_B0" (
	"KEY" BIGINT, 
	"Estimator" FLOAT(53)
)
...
-- Code For temporary table TMP_20221008175055_QI0EPHO_GB_B0 part 2. Populate

WITH "DT_node_lookup" AS 
(SELECT "ADS"."KEY" AS "KEY", CASE WHEN ("ADS"."Feature_8" <= 0.000710027088643983) THEN CASE WHEN ("ADS"."Feature_2" <= 0.0061888848431408405) THEN CASE WHEN ("ADS"."Feature_5" <= 0.11267216503620148) THEN 3 ELSE 4 END ELSE CASE WHEN ("ADS"."Feature_0" <= -0.08361412957310677) THEN 6 ELSE 7 END END ELSE CASE WHEN ("ADS"."Feature_2" <= 0.05576823838055134) THEN CASE WHEN ("ADS"."Feature_3" <= 0.03736521489918232) THEN 10 ELSE 11 END ELSE CASE WHEN ("ADS"."Feature_5" <= 0.022485405206680298) THEN 13 ELSE 14 END END END AS node_id_2 
...
FROM "DT_Output"), 
"DT_node_lookup_1" AS 
(SELECT "ADS"."KEY" AS "KEY", CASE WHEN ("ADS"."Feature_8" <= -0.00016962859081104398) THEN CASE WHEN ("ADS"."Feature_2" <= 0.0061888848431408405) THEN CASE WHEN ("ADS"."Feature_6" <= 0.021027816459536552) THEN 3 ELSE 4 END ELSE CASE WHEN ("ADS"."Feature_0" <= -0.08361412957310677) THEN 6 ELSE 7 END END ELSE CASE WHEN ("ADS"."Feature_2" <= 0.047145744785666466) THEN CASE WHEN ("ADS"."Feature_2" <= -0.021834230050444603) THEN 10 ELSE 11 END ELSE CASE WHEN ("ADS"."Feature_5" <= 0.022485405206680298) THEN 13 ELSE 14 END END END AS node_id_2 
FROM diabetes AS "ADS"), 
"DT_node_data_1" AS 
(SELECT "Values".nid AS nid, "Values"."E" AS "E" 
...
FROM "DT_Output_1"), 
"DT_node_lookup_2" AS 
(SELECT "ADS"."KEY" AS "KEY", CASE WHEN ("ADS"."Feature_8" <= -0.009431080427020788) THEN CASE WHEN ("ADS"."Feature_2" <= 0.0061888848431408405) THEN CASE WHEN ("ADS"."Feature_5" <= 0.11267216503620148) THEN 3 ELSE 4 END ELSE CASE WHEN ("ADS"."Feature_0" <= 0.03625963628292084) THEN 6 ELSE 7 END END ELSE CASE WHEN ("ADS"."Feature_2" <= 0.06870198622345924) THEN CASE WHEN ("ADS"."Feature_3" <= 0.03736521489918232) THEN 10 ELSE 11 END ELSE CASE WHEN ("ADS"."Feature_5" <= 0.022485405206680298) THEN 13 ELSE 14 END END END AS node_id_2 
FROM diabetes AS "ADS"), 
"DT_node_data_2" AS 
(SELECT "Values".nid AS nid, "Values"."E" AS "E" 
...
FROM "DT_Output_2"), 
"DT_node_lookup_3" AS 
(SELECT "ADS"."KEY" AS "KEY", CASE WHEN ("ADS"."Feature_8" <= 0.000710027088643983) THEN CASE WHEN ("ADS"."Feature_2" <= 0.0061888848431408405) THEN CASE WHEN ("ADS"."Feature_6" <= 0.021027816459536552) THEN 3 ELSE 4 END ELSE CASE WHEN ("ADS"."Feature_9" <= -0.01971717830747366) THEN 6 ELSE 7 END END ELSE CASE WHEN ("ADS"."Feature_2" <= 0.047145744785666466) THEN CASE WHEN ("ADS"."Feature_2" <= -0.021834230050444603) THEN 10 ELSE 11 END ELSE CASE WHEN ("ADS"."Feature_4" <= 0.038333673030138016) THEN 13 ELSE 14 END END END AS node_id_2 
FROM diabetes AS "ADS"), 
"DT_node_data_3" AS 
(SELECT "Values".nid AS nid, "Values"."E" AS "E" 
...
FROM "DT_Output_3"), 
"DT_node_lookup_4" AS 
(SELECT "ADS"."KEY" AS "KEY", CASE WHEN ("ADS"."Feature_8" <= -0.009431080427020788) THEN CASE WHEN ("ADS"."Feature_2" <= 0.0061888848431408405) THEN CASE WHEN ("ADS"."Feature_5" <= 0.11267216503620148) THEN 3 ELSE 4 END ELSE CASE WHEN ("ADS"."Feature_0" <= 0.03625963628292084) THEN 6 ELSE 7 END END ELSE CASE WHEN ("ADS"."Feature_2" <= 0.06870198622345924) THEN CASE WHEN ("ADS"."Feature_8" <= 0.04425526037812233) THEN 10 ELSE 11 END ELSE CASE WHEN ("ADS"."Feature_4" <= -0.020144323352724314) THEN 13 ELSE 14 END END END AS node_id_2 
FROM diabetes AS "ADS"), 
"DT_node_data_4" AS 
(SELECT "Values".nid AS nid, "Values"."E" AS "E" 
...
FROM "DT_Output_4"), 
"DT_node_lookup_5" AS 
(SELECT "ADS"."KEY" AS "KEY", CASE WHEN ("ADS"."Feature_8" <= -0.009431080427020788) THEN CASE WHEN ("ADS"."Feature_2" <= 0.0061888848431408405) THEN CASE WHEN ("ADS"."Feature_3" <= 0.11827221140265465) THEN 3 ELSE 4 END ELSE CASE WHEN ("ADS"."Feature_0" <= 0.03262709826231003) THEN 6 ELSE 7 END END ELSE CASE WHEN ("ADS"."Feature_2" <= 0.06870198622345924) THEN CASE WHEN ("ADS"."Feature_3" <= 0.03736521489918232) THEN 10 ELSE 11 END ELSE CASE WHEN ("ADS"."Feature_0" <= -0.05273755453526974) THEN 13 ELSE 14 END END END AS node_id_2 
FROM diabetes AS "ADS"), 
"DT_node_data_5" AS 
(SELECT "Values".nid AS nid, "Values"."E" AS "E" 
...
FROM "DT_Output_5"), 
"DT_node_lookup_6" AS 
(SELECT "ADS"."KEY" AS "KEY", CASE WHEN ("ADS"."Feature_8" <= 0.02165768202394247) THEN CASE WHEN ("ADS"."Feature_2" <= 0.005111072678118944) THEN CASE WHEN ("ADS"."Feature_7" <= 0.03135676868259907) THEN 3 ELSE 4 END ELSE CASE WHEN ("ADS"."Feature_3" <= 0.016708109062165022) THEN 6 ELSE 7 END END ELSE CASE WHEN ("ADS"."Feature_3" <= 0.06261852942407131) THEN CASE WHEN ("ADS"."Feature_6" <= -0.045241665095090866) THEN 10 ELSE 11 END ELSE CASE WHEN ("ADS"."Feature_7" <= 0.08966054022312164) THEN 13 ELSE 14 END END END AS node_id_2 
FROM diabetes AS "ADS"), 
"DT_node_data_6" AS 
(SELECT "Values".nid AS nid, "Values"."E" AS "E" 
...
FROM "DT_Output_6"), 
"DT_node_lookup_7" AS 
(SELECT "ADS"."KEY" AS "KEY", CASE WHEN ("ADS"."Feature_8" <= -0.009431080427020788) THEN CASE WHEN ("ADS"."Feature_2" <= 0.051995899528265) THEN CASE WHEN ("ADS"."Feature_6" <= 0.021027816459536552) THEN 3 ELSE 4 END ELSE CASE WHEN ("ADS"."Feature_3" <= 0.013265257992316037) THEN 6 ELSE 7 END END ELSE CASE WHEN ("ADS"."Feature_2" <= 0.07031870260834694) THEN CASE WHEN ("ADS"."Feature_3" <= 0.038518570363521576) THEN 10 ELSE 11 END ELSE CASE WHEN ("ADS"."Feature_5" <= 0.022485405206680298) THEN 13 ELSE 14 END END END AS node_id_2 
FROM diabetes AS "ADS"), 
"DT_node_data_7" AS 
(SELECT "Values".nid AS nid, "Values"."E" AS "E" 
...
FROM "DT_Output_7"), 
"DT_node_lookup_8" AS 
(SELECT "ADS"."KEY" AS "KEY", CASE WHEN ("ADS"."Feature_8" <= 0.02165768202394247) THEN CASE WHEN ("ADS"."Feature_2" <= 0.005111072678118944) THEN CASE WHEN ("ADS"."Feature_7" <= 0.03135676868259907) THEN 3 ELSE 4 END ELSE CASE WHEN ("ADS"."Feature_3" <= 0.016708109062165022) THEN 6 ELSE 7 END END ELSE CASE WHEN ("ADS"."Feature_3" <= 0.06261852942407131) THEN CASE WHEN ("ADS"."Feature_6" <= -0.045241665095090866) THEN 10 ELSE 11 END ELSE CASE WHEN ("ADS"."Feature_5" <= 0.09967650100588799) THEN 13 ELSE 14 END END END AS node_id_2 
FROM diabetes AS "ADS"), 
"DT_node_data_8" AS 
(SELECT "Values".nid AS nid, "Values"."E" AS "E" 
...
FROM "DT_Output_8"), 
"DT_node_lookup_9" AS 
(SELECT "ADS"."KEY" AS "KEY", CASE WHEN ("ADS"."Feature_8" <= -0.009431080427020788) THEN CASE WHEN ("ADS"."Feature_2" <= 0.051995899528265) THEN CASE WHEN ("ADS"."Feature_7" <= 0.061984701082110405) THEN 3 ELSE 4 END ELSE CASE WHEN ("ADS"."Feature_3" <= 0.013265257992316037) THEN 6 ELSE 7 END END ELSE CASE WHEN ("ADS"."Feature_9" <= 0.03413021191954613) THEN CASE WHEN ("ADS"."Feature_3" <= -0.04813798889517784) THEN 10 ELSE 11 END ELSE CASE WHEN ("ADS"."Feature_2" <= 0.005111072678118944) THEN 13 ELSE 14 END END END AS node_id_2 
FROM diabetes AS "ADS"), 
"DT_node_data_9" AS 
(SELECT "Values".nid AS nid, "Values"."E" AS "E" 
...
FROM "DT_Output_9")
 INSERT INTO "TMP_20221008175055_QI0EPHO_GB_B0" ("KEY", "Estimator") SELECT "T"."KEY", "T"."Estimator" 
...
-- Code For temporary table TMP_20221008175055_SB2DAT0_GB_B1 part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221008175055_SB2DAT0_GB_B1" (
	"KEY" BIGINT, 
	"Estimator" FLOAT(53)
)
...
-- Code For temporary table TMP_20221008175055_SB2DAT0_GB_B1 part 2. Populate

WITH "DT_node_lookup_10" AS 
(SELECT "ADS"."KEY" AS "KEY", CASE WHEN ("ADS"."Feature_2" <= 0.009422320872545242) THEN CASE WHEN ("ADS"."Feature_7" <= 0.03061874583363533) THEN CASE WHEN ("ADS"."Feature_8" <= 0.027040445245802402) THEN 3 ELSE 4 END ELSE CASE WHEN ("ADS"."Feature_3" <= -0.04125228710472584) THEN 6 ELSE 7 END END ELSE CASE WHEN ("ADS"."Feature_3" <= 0.023593811318278313) THEN CASE WHEN ("ADS"."Feature_9" <= 0.029988105408847332) THEN 10 ELSE 11 END ELSE CASE WHEN ("ADS"."Feature_8" <= -0.03199675586074591) THEN 13 ELSE 14 END END END AS node_id_2 
FROM diabetes AS "ADS"), 
"DT_node_data_10" AS 
(SELECT "Values".nid AS nid, "Values"."E" AS "E" 
...
(SELECT "ADS"."KEY" AS "KEY", CASE WHEN ("ADS"."Feature_2" <= 0.009422320872545242) THEN CASE WHEN ("ADS"."Feature_7" <= 0.03061874583363533) THEN CASE WHEN ("ADS"."Feature_5" <= -0.047346701845526695) THEN 3 ELSE 4 END ELSE CASE WHEN ("ADS"."Feature_5" <= -0.008829440455883741) THEN 6 ELSE 7 END END ELSE CASE WHEN ("ADS"."Feature_3" <= 0.023593811318278313) THEN CASE WHEN ("ADS"."Feature_6" <= -0.07101312652230263) THEN 10 ELSE 11 END ELSE CASE WHEN ("ADS"."Feature_8" <= -0.042962824925780296) THEN 13 ELSE 14 END END END AS node_id_2 
FROM diabetes AS "ADS"), 
"DT_node_data_11" AS 
(SELECT "Values".nid AS nid, "Values"."E" AS "E" 
...
(SELECT "ADS"."KEY" AS "KEY", CASE WHEN ("ADS"."Feature_8" <= 0.016671447083353996) THEN CASE WHEN ("ADS"."Feature_2" <= 0.0061888848431408405) THEN CASE WHEN ("ADS"."Feature_6" <= 0.021027816459536552) THEN 3 ELSE 4 END ELSE CASE WHEN ("ADS"."Feature_5" <= 0.04769385606050491) THEN 6 ELSE 7 END END ELSE CASE WHEN ("ADS"."Feature_3" <= 0.06261852942407131) THEN CASE WHEN ("ADS"."Feature_7" <= 0.09999285265803337) THEN 10 ELSE 11 END ELSE CASE WHEN ("ADS"."Feature_0" <= -0.0036982858437113464) THEN 13 ELSE 14 END END END AS node_id_2 
FROM diabetes AS "ADS"), 
"DT_node_data_12" AS 
(SELECT "Values".nid AS nid, "Values"."E" AS "E" 
...
(SELECT "ADS"."KEY" AS "KEY", CASE WHEN ("ADS"."Feature_8" <= -0.009431080427020788) THEN CASE WHEN ("ADS"."Feature_8" <= -0.04327731393277645) THEN CASE WHEN ("ADS"."Feature_0" <= -0.03820740059018135) THEN 3 ELSE 4 END ELSE CASE WHEN ("ADS"."Feature_4" <= -0.0545431450009346) THEN 6 ELSE 7 END END ELSE CASE WHEN ("ADS"."Feature_9" <= 0.03413021191954613) THEN CASE WHEN ("ADS"."Feature_3" <= -0.05903461202979088) THEN 10 ELSE 11 END ELSE CASE WHEN ("ADS"."Feature_5" <= 0.06366442888975143) THEN 13 ELSE 14 END END END AS node_id_2 
FROM diabetes AS "ADS"), 
"DT_node_data_13" AS 
(SELECT "Values".nid AS nid, "Values"."E" AS "E" 
...
(SELECT "ADS"."KEY" AS "KEY", CASE WHEN ("ADS"."Feature_2" <= 0.009422320872545242) THEN CASE WHEN ("ADS"."Feature_6" <= 0.021027816459536552) THEN CASE WHEN ("ADS"."Feature_9" <= 0.09626181423664093) THEN 3 ELSE 4 END ELSE CASE WHEN ("ADS"."Feature_0" <= 0.043524714186787605) THEN 6 ELSE 7 END END ELSE CASE WHEN ("ADS"."Feature_3" <= 0.023593811318278313) THEN CASE WHEN ("ADS"."Feature_2" <= 0.029361844062805176) THEN 10 ELSE 11 END ELSE CASE WHEN ("ADS"."Feature_8" <= -0.030137172900140285) THEN 13 ELSE 14 END END END AS node_id_2 
FROM diabetes AS "ADS"), 
"DT_node_data_14" AS 
(SELECT "Values".nid AS nid, "Values"."E" AS "E" 
...
(SELECT "ADS"."KEY" AS "KEY", CASE WHEN ("ADS"."Feature_2" <= 0.047145744785666466) THEN CASE WHEN ("ADS"."Feature_8" <= -0.04327731393277645) THEN CASE WHEN ("ADS"."Feature_9" <= -0.0735645666718483) THEN 3 ELSE 4 END ELSE CASE WHEN ("ADS"."Feature_5" <= -0.04750327579677105) THEN 6 ELSE 7 END END ELSE CASE WHEN ("ADS"."Feature_9" <= -0.023859284818172455) THEN CASE WHEN ("ADS"."Feature_3" <= -0.0005061458214186132) THEN 10 ELSE 11 END ELSE CASE WHEN ("ADS"."Feature_3" <= -0.049859415739774704) THEN 13 ELSE 14 END END END AS node_id_2 
FROM diabetes AS "ADS"), 
"DT_node_data_15" AS 
(SELECT "Values".nid AS nid, "Values"."E" AS "E" 
...
FROM "DT_Output_15")
 INSERT INTO "TMP_20221008175055_SB2DAT0_GB_B1" ("KEY", "Estimator") SELECT "T"."KEY", "T"."Estimator" 
...
-- Code For temporary table TMP_20221008175055_7SYU1UA_GB_sum part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221008175055_7SYU1UA_GB_sum" (
	"KEY" BIGINT NOT NULL, 
	"Estimator" FLOAT(53), 
	PRIMARY KEY ("KEY")
)
...
-- Code For temporary table TMP_20221008175055_7SYU1UA_GB_sum part 2. Populate

WITH "GB_Union" AS 
(SELECT "GB_EnsembleUnion"."KEY" AS "KEY", "GB_EnsembleUnion"."Estimator" AS "Estimator" 
FROM (SELECT "GB_B0"."KEY" AS "KEY", "GB_B0"."Estimator" AS "Estimator" 
FROM "TMP_20221008175055_QI0EPHO_GB_B0" AS "GB_B0" UNION ALL SELECT "GB_B1"."KEY" AS "KEY", "GB_B1"."Estimator" AS "Estimator" 
FROM "TMP_20221008175055_SB2DAT0_GB_B1" AS "GB_B1") AS "GB_EnsembleUnion")
 INSERT INTO "TMP_20221008175055_7SYU1UA_GB_sum" ("KEY", "Estimator") SELECT "T"."KEY", "T"."Estimator" 
...
-- Code For temporary table TMP_20221008175055_7SYU1UA_GB_sum part 3. Create Index 

CREATE INDEX "ix_TMP_20221008175055_7SYU1UA_GB_sum_KEY" ON "TMP_20221008175055_7SYU1UA_GB_sum" ("KEY")

-- Model deployment code

SELECT "GB_sum"."KEY" AS "KEY", 154.07365439093485 + 0.1 * "GB_sum"."Estimator" AS "Estimator" 
FROM "TMP_20221008175055_7SYU1UA_GB_sum" AS "GB_sum"