...
-- Code For temporary table TMP_20221008175245_RWCLR4N_GB_B0 part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221008175245_RWCLR4N_GB_B0" (
	"KEY" BIGINT, 
	"Estimator" FLOAT(53)
)
...
-- Code For temporary table TMP_20221008175245_RWCLR4N_GB_B0 part 2. Populate
...
FROM "DT_Output_9")
 INSERT INTO "TMP_20221008175245_RWCLR4N_GB_B0" ("KEY", "Estimator") SELECT "T"."KEY", "T"."Estimator" 
...
-- Code For temporary table TMP_20221008175245_Z6JJ50C_GB_B1 part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221008175245_Z6JJ50C_GB_B1" (
	"KEY" BIGINT, 
	"Estimator" FLOAT(53)
)
...
-- Code For temporary table TMP_20221008175245_Z6JJ50C_GB_B1 part 2. Populate
...
FROM "DT_Output_15")
 INSERT INTO "TMP_20221008175245_Z6JJ50C_GB_B1" ("KEY", "Estimator") SELECT "T"."KEY", "T"."Estimator" 
...
-- Code For temporary table TMP_20221008175245_QXBNUM4_GB_sum part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221008175245_QXBNUM4_GB_sum" (
	"KEY" BIGINT NOT NULL, 
	"Estimator" FLOAT(53), 
	PRIMARY KEY ("KEY")
)
...
-- Code For temporary table TMP_20221008175245_QXBNUM4_GB_sum part 2. Populate

WITH "GB_Union" AS 
(SELECT "GB_EnsembleUnion"."KEY" AS "KEY", "GB_EnsembleUnion"."Estimator" AS "Estimator" 
FROM (SELECT "GB_B0"."KEY" AS "KEY", "GB_B0"."Estimator" AS "Estimator" 
FROM "TMP_20221008175245_RWCLR4N_GB_B0" AS "GB_B0" UNION ALL SELECT "GB_B1"."KEY" AS "KEY", "GB_B1"."Estimator" AS "Estimator" 
FROM "TMP_20221008175245_Z6JJ50C_GB_B1" AS "GB_B1") AS "GB_EnsembleUnion")
 INSERT INTO "TMP_20221008175245_QXBNUM4_GB_sum" ("KEY", "Estimator") SELECT "T"."KEY", "T"."Estimator" 
...
-- Code For temporary table TMP_20221008175245_QXBNUM4_GB_sum part 3. Create Index 

CREATE INDEX "ix_TMP_20221008175245_QXBNUM4_GB_sum_KEY" ON "TMP_20221008175245_QXBNUM4_GB_sum" ("KEY")

-- Model deployment code

SELECT "GB_sum"."KEY" AS "KEY", 499.09288446517394 + 0.1 * "GB_sum"."Estimator" AS "Estimator" 
FROM "TMP_20221008175245_QXBNUM4_GB_sum" AS "GB_sum"