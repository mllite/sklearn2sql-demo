...
-- Code For temporary table TMP_20221008174733_JQ9WL0U_RF_B0 part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221008174733_JQ9WL0U_RF_B0" (
	"KEY" BIGINT, 
	"Score_0" FLOAT(53), 
	"Proba_0" FLOAT(53), 
	"LogProba_0" FLOAT(53), 
...
-- Code For temporary table TMP_20221008174733_JQ9WL0U_RF_B0 part 2. Populate

WITH "DT_node_lookup" AS 
(SELECT "ADS"."KEY" AS "KEY", CASE WHEN ("ADS"."Feature_16" <= -0.5211686342954636) THEN CASE WHEN ("ADS"."Feature_45" <= 0.6160559058189392) THEN CASE WHEN ("ADS"."Feature_59" <= 1.1565751731395721) THEN CASE WHEN ("ADS"."Feature_10" <= 2.1901907920837402) THEN 4 ELSE 5 END ELSE 6 END ELSE 7 END ELSE CASE WHEN ("ADS"."Feature_94" <= 0.5277243554592133) THEN CASE WHEN ("ADS"."Feature_4" <= -0.9540826380252838) THEN 10 ELSE 11 END ELSE CASE WHEN ("ADS"."Feature_50" <= 0.07080738246440887) THEN CASE WHEN ("ADS"."Feature_98" <= 0.8492567539215088) THEN 14 ELSE 15 END ELSE CASE WHEN ("ADS"."Feature_69" <= -0.16153481602668762) THEN 17 ELSE 18 END END END END AS node_id_2 
...
FROM "DT_Output"), 
"DT_node_lookup_1" AS 
(SELECT "ADS"."KEY" AS "KEY", CASE WHEN ("ADS"."Feature_57" <= -0.19605962932109833) THEN CASE WHEN ("ADS"."Feature_71" <= -2.1820791959762573) THEN 2 ELSE CASE WHEN ("ADS"."Feature_35" <= 1.072922796010971) THEN CASE WHEN ("ADS"."Feature_49" <= -1.5783874988555908) THEN 5 ELSE CASE WHEN ("ADS"."Feature_29" <= -1.3871998190879822) THEN CASE WHEN ("ADS"."Feature_97" <= -0.48833708465099335) THEN 8 ELSE 9 END ELSE CASE WHEN ("ADS"."Feature_74" <= 1.219275951385498) THEN 11 ELSE CASE WHEN ("ADS"."Feature_69" <= 0.19806352257728577) THEN 13 ELSE 14 END END END END ELSE 15 END END ELSE CASE WHEN ("ADS"."Feature_86" <= 0.7880138754844666) THEN 17 ELSE CASE WHEN ("ADS"."Feature_80" <= 0.14271172881126404) THEN 19 ELSE 20 END END END AS node_id_2 
FROM "BinaryClass_100" AS "ADS"), 
"DT_node_data_1" AS 
(SELECT "Values".nid AS nid, "Values"."P_0" AS "P_0", "Values"."P_1" AS "P_1", "Values"."D" AS "D", "Values"."DP" AS "DP" 
...
FROM "DT_Output_1"), 
"DT_node_lookup_2" AS 
(SELECT "ADS"."KEY" AS "KEY", CASE WHEN ("ADS"."Feature_60" <= -0.3833989202976227) THEN CASE WHEN ("ADS"."Feature_2" <= 0.4524155706167221) THEN 2 ELSE CASE WHEN ("ADS"."Feature_74" <= -0.4949994385242462) THEN 4 ELSE CASE WHEN ("ADS"."Feature_4" <= 0.06902444362640381) THEN 6 ELSE 7 END END END ELSE CASE WHEN ("ADS"."Feature_10" <= 1.5588550567626953) THEN CASE WHEN ("ADS"."Feature_88" <= 0.4828758090734482) THEN CASE WHEN ("ADS"."Feature_64" <= -1.8845874071121216) THEN 11 ELSE 12 END ELSE CASE WHEN ("ADS"."Feature_45" <= 2.0486058592796326) THEN CASE WHEN ("ADS"."Feature_69" <= 1.4780602008104324) THEN 15 ELSE 16 END ELSE 17 END END ELSE 18 END END AS node_id_2 
FROM "BinaryClass_100" AS "ADS"), 
"DT_node_data_2" AS 
(SELECT "Values".nid AS nid, "Values"."P_0" AS "P_0", "Values"."P_1" AS "P_1", "Values"."D" AS "D", "Values"."DP" AS "DP" 
...
FROM "DT_Output_2"), 
"DT_node_lookup_3" AS 
(SELECT "ADS"."KEY" AS "KEY", CASE WHEN ("ADS"."Feature_41" <= -0.4746619462966919) THEN CASE WHEN ("ADS"."Feature_4" <= 0.5964059382677078) THEN 2 ELSE CASE WHEN ("ADS"."Feature_83" <= -0.2657141722738743) THEN 4 ELSE 5 END END ELSE CASE WHEN ("ADS"."Feature_54" <= 1.2391473650932312) THEN CASE WHEN ("ADS"."Feature_5" <= 1.5200949907302856) THEN CASE WHEN ("ADS"."Feature_85" <= 1.5308355689048767) THEN CASE WHEN ("ADS"."Feature_10" <= -1.9706440567970276) THEN 10 ELSE CASE WHEN ("ADS"."Feature_70" <= 0.9962719678878784) THEN CASE WHEN ("ADS"."Feature_19" <= -1.9615032076835632) THEN 13 ELSE 14 END ELSE 15 END END ELSE 16 END ELSE CASE WHEN ("ADS"."Feature_70" <= 0.30650750920176506) THEN 18 ELSE 19 END END ELSE 20 END END AS node_id_2 
FROM "BinaryClass_100" AS "ADS"), 
"DT_node_data_3" AS 
(SELECT "Values".nid AS nid, "Values"."P_0" AS "P_0", "Values"."P_1" AS "P_1", "Values"."D" AS "D", "Values"."DP" AS "DP" 
...
FROM "DT_Output_3"), 
"DT_node_lookup_4" AS 
(SELECT "ADS"."KEY" AS "KEY", CASE WHEN ("ADS"."Feature_77" <= -0.279058113694191) THEN 1 ELSE CASE WHEN ("ADS"."Feature_11" <= 1.7087210416793823) THEN CASE WHEN ("ADS"."Feature_27" <= 1.0105148255825043) THEN CASE WHEN ("ADS"."Feature_58" <= 0.7087676823139191) THEN CASE WHEN ("ADS"."Feature_88" <= -2.371664583683014) THEN 6 ELSE 7 END ELSE 8 END ELSE 9 END ELSE 10 END END AS node_id_2 
FROM "BinaryClass_100" AS "ADS"), 
"DT_node_data_4" AS 
(SELECT "Values".nid AS nid, "Values"."P_0" AS "P_0", "Values"."P_1" AS "P_1", "Values"."D" AS "D", "Values"."DP" AS "DP" 
...
FROM "DT_Output_4"), 
"DT_node_lookup_5" AS 
(SELECT "ADS"."KEY" AS "KEY", CASE WHEN ("ADS"."Feature_61" <= -0.25619688630104065) THEN CASE WHEN ("ADS"."Feature_3" <= -0.5252026915550232) THEN CASE WHEN ("ADS"."Feature_69" <= 1.3981356620788574) THEN CASE WHEN ("ADS"."Feature_21" <= 0.6710361242294312) THEN 4 ELSE 5 END ELSE 6 END ELSE CASE WHEN ("ADS"."Feature_56" <= 1.4655712842941284) THEN 8 ELSE 9 END END ELSE CASE WHEN ("ADS"."Feature_48" <= -0.08753257617354393) THEN CASE WHEN ("ADS"."Feature_46" <= -1.2034213542938232) THEN 12 ELSE CASE WHEN ("ADS"."Feature_79" <= -1.3377593755722046) THEN 14 ELSE 15 END END ELSE CASE WHEN ("ADS"."Feature_58" <= 0.37975165992975235) THEN CASE WHEN ("ADS"."Feature_73" <= 0.8891735672950745) THEN CASE WHEN ("ADS"."Feature_59" <= -1.2997799217700958) THEN 19 ELSE 20 END ELSE 21 END ELSE 22 END END END AS node_id_2 
FROM "BinaryClass_100" AS "ADS"), 
"DT_node_data_5" AS 
(SELECT "Values".nid AS nid, "Values"."P_0" AS "P_0", "Values"."P_1" AS "P_1", "Values"."D" AS "D", "Values"."DP" AS "DP" 
...
FROM "DT_Output_5"), 
"DT_node_lookup_6" AS 
(SELECT "ADS"."KEY" AS "KEY", CASE WHEN ("ADS"."Feature_15" <= -0.7707918584346771) THEN CASE WHEN ("ADS"."Feature_45" <= 0.8825908601284027) THEN 2 ELSE 3 END ELSE CASE WHEN ("ADS"."Feature_82" <= 0.068818349391222) THEN CASE WHEN ("ADS"."Feature_21" <= -0.31169628351926804) THEN CASE WHEN ("ADS"."Feature_57" <= -0.612529531121254) THEN 7 ELSE 8 END ELSE 9 END ELSE CASE WHEN ("ADS"."Feature_6" <= 0.11003386601805687) THEN CASE WHEN ("ADS"."Feature_87" <= -1.0315125286579132) THEN 12 ELSE 13 END ELSE CASE WHEN ("ADS"."Feature_91" <= -0.1987566314637661) THEN 15 ELSE CASE WHEN ("ADS"."Feature_97" <= 1.0701951086521149) THEN 17 ELSE 18 END END END END END AS node_id_2 
FROM "BinaryClass_100" AS "ADS"), 
"DT_node_data_6" AS 
(SELECT "Values".nid AS nid, "Values"."P_0" AS "P_0", "Values"."P_1" AS "P_1", "Values"."D" AS "D", "Values"."DP" AS "DP" 
...
FROM "DT_Output_6"), 
"DT_node_lookup_7" AS 
(SELECT "ADS"."KEY" AS "KEY", CASE WHEN ("ADS"."Feature_96" <= 0.9772368669509888) THEN CASE WHEN ("ADS"."Feature_44" <= 0.13756240671500564) THEN CASE WHEN ("ADS"."Feature_22" <= 1.0561859607696533) THEN CASE WHEN ("ADS"."Feature_32" <= -1.226790964603424) THEN 4 ELSE 5 END ELSE 6 END ELSE CASE WHEN ("ADS"."Feature_41" <= 1.1870434880256653) THEN CASE WHEN ("ADS"."Feature_77" <= -0.05269095301628113) THEN CASE WHEN ("ADS"."Feature_33" <= -0.3389080688357353) THEN 10 ELSE 11 END ELSE 12 END ELSE 13 END END ELSE CASE WHEN ("ADS"."Feature_17" <= 1.0132035613059998) THEN CASE WHEN ("ADS"."Feature_80" <= -1.6467670798301697) THEN 16 ELSE 17 END ELSE CASE WHEN ("ADS"."Feature_40" <= -0.17568455636501312) THEN 19 ELSE 20 END END END AS node_id_2 
FROM "BinaryClass_100" AS "ADS"), 
"DT_node_data_7" AS 
(SELECT "Values".nid AS nid, "Values"."P_0" AS "P_0", "Values"."P_1" AS "P_1", "Values"."D" AS "D", "Values"."DP" AS "DP" 
...
FROM "DT_Output_7"), 
"DT_node_lookup_8" AS 
(SELECT "ADS"."KEY" AS "KEY", CASE WHEN ("ADS"."Feature_27" <= 0.0015312647446990013) THEN CASE WHEN ("ADS"."Feature_94" <= 1.247656226158142) THEN CASE WHEN ("ADS"."Feature_67" <= 0.27634621411561966) THEN 3 ELSE CASE WHEN ("ADS"."Feature_40" <= 0.5346857309341431) THEN 5 ELSE 6 END END ELSE CASE WHEN ("ADS"."Feature_41" <= -0.24881070852279663) THEN 8 ELSE CASE WHEN ("ADS"."Feature_0" <= -0.2769756503403187) THEN 10 ELSE 11 END END END ELSE CASE WHEN ("ADS"."Feature_70" <= 0.4014183580875397) THEN CASE WHEN ("ADS"."Feature_81" <= 0.8382485210895538) THEN CASE WHEN ("ADS"."Feature_47" <= -0.5260314494371414) THEN 15 ELSE CASE WHEN ("ADS"."Feature_98" <= -0.0008105859160423279) THEN 17 ELSE CASE WHEN ("ADS"."Feature_4" <= -0.02003437466919422) THEN 19 ELSE 20 END END END ELSE 21 END ELSE CASE WHEN ("ADS"."Feature_19" <= 0.5722567737102509) THEN CASE WHEN ("ADS"."Feature_42" <= -1.7606690526008606) THEN 24 ELSE 25 END ELSE 26 END END END AS node_id_2 
FROM "BinaryClass_100" AS "ADS"), 
"DT_node_data_8" AS 
(SELECT "Values".nid AS nid, "Values"."P_0" AS "P_0", "Values"."P_1" AS "P_1", "Values"."D" AS "D", "Values"."DP" AS "DP" 
...
FROM "DT_Output_8"), 
"DT_node_lookup_9" AS 
(SELECT "ADS"."KEY" AS "KEY", CASE WHEN ("ADS"."Feature_95" <= -0.22473405301570892) THEN CASE WHEN ("ADS"."Feature_16" <= -1.205639660358429) THEN 2 ELSE CASE WHEN ("ADS"."Feature_44" <= 1.4221219718456268) THEN CASE WHEN ("ADS"."Feature_4" <= 0.9930586516857147) THEN 5 ELSE 6 END ELSE 7 END END ELSE CASE WHEN ("ADS"."Feature_92" <= 1.268636405467987) THEN CASE WHEN ("ADS"."Feature_41" <= -0.755152016878128) THEN CASE WHEN ("ADS"."Feature_76" <= 0.24500855803489685) THEN 11 ELSE 12 END ELSE CASE WHEN ("ADS"."Feature_29" <= -0.7003329694271088) THEN CASE WHEN ("ADS"."Feature_58" <= -0.22272784262895584) THEN 15 ELSE 16 END ELSE 17 END END ELSE 18 END END AS node_id_2 
FROM "BinaryClass_100" AS "ADS"), 
"DT_node_data_9" AS 
(SELECT "Values".nid AS nid, "Values"."P_0" AS "P_0", "Values"."P_1" AS "P_1", "Values"."D" AS "D", "Values"."DP" AS "DP" 
...
FROM "DT_Output_9")
 INSERT INTO "TMP_20221008174733_JQ9WL0U_RF_B0" ("KEY", "Score_0", "Proba_0", "LogProba_0", "Score_1", "Proba_1", "LogProba_1") SELECT "T"."KEY", "T"."Score_0", "T"."Proba_0", "T"."LogProba_0", "T"."Score_1", "T"."Proba_1", "T"."LogProba_1" 
...
-- Code For temporary table TMP_20221008174733_S61JJ6T_RF_B1 part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221008174733_S61JJ6T_RF_B1" (
	"KEY" BIGINT, 
	"Score_0" FLOAT(53), 
	"Proba_0" FLOAT(53), 
	"LogProba_0" FLOAT(53), 
...
-- Code For temporary table TMP_20221008174733_S61JJ6T_RF_B1 part 2. Populate

WITH "DT_node_lookup_10" AS 
(SELECT "ADS"."KEY" AS "KEY", CASE WHEN ("ADS"."Feature_77" <= 0.03445534687489271) THEN CASE WHEN ("ADS"."Feature_73" <= 1.6449222564697266) THEN CASE WHEN ("ADS"."Feature_18" <= 1.0771634578704834) THEN 3 ELSE CASE WHEN ("ADS"."Feature_17" <= -0.5457596927881241) THEN 5 ELSE 6 END END ELSE 7 END ELSE CASE WHEN ("ADS"."Feature_69" <= -0.4638688713312149) THEN CASE WHEN ("ADS"."Feature_6" <= 0.3886241763830185) THEN CASE WHEN ("ADS"."Feature_94" <= 1.2602042257785797) THEN 11 ELSE 12 END ELSE 13 END ELSE CASE WHEN ("ADS"."Feature_8" <= 1.2689111232757568) THEN CASE WHEN ("ADS"."Feature_84" <= 1.6798489689826965) THEN 16 ELSE CASE WHEN ("ADS"."Feature_5" <= 0.4684140756726265) THEN 18 ELSE 19 END END ELSE CASE WHEN ("ADS"."Feature_96" <= 0.22425897046923637) THEN 21 ELSE 22 END END END END AS node_id_2 
FROM "BinaryClass_100" AS "ADS"), 
"DT_node_data_10" AS 
(SELECT "Values".nid AS nid, "Values"."P_0" AS "P_0", "Values"."P_1" AS "P_1", "Values"."D" AS "D", "Values"."DP" AS "DP" 
...
(SELECT "ADS"."KEY" AS "KEY", CASE WHEN ("ADS"."Feature_42" <= 0.6392327547073364) THEN CASE WHEN ("ADS"."Feature_41" <= 0.5994085371494293) THEN CASE WHEN ("ADS"."Feature_58" <= -0.16466024518013) THEN CASE WHEN ("ADS"."Feature_98" <= -1.2698901891708374) THEN 4 ELSE 5 END ELSE CASE WHEN ("ADS"."Feature_6" <= 0.27925464510917664) THEN CASE WHEN ("ADS"."Feature_15" <= 0.44954195618629456) THEN 8 ELSE 9 END ELSE 10 END END ELSE CASE WHEN ("ADS"."Feature_60" <= -0.9985716566443443) THEN 12 ELSE 13 END END ELSE CASE WHEN ("ADS"."Feature_80" <= -1.6365274786949158) THEN 15 ELSE CASE WHEN ("ADS"."Feature_63" <= -1.9680962562561035) THEN 17 ELSE 18 END END END AS node_id_2 
FROM "BinaryClass_100" AS "ADS"), 
"DT_node_data_11" AS 
(SELECT "Values".nid AS nid, "Values"."P_0" AS "P_0", "Values"."P_1" AS "P_1", "Values"."D" AS "D", "Values"."DP" AS "DP" 
...
(SELECT "ADS"."KEY" AS "KEY", CASE WHEN ("ADS"."Feature_18" <= 0.4967719316482544) THEN CASE WHEN ("ADS"."Feature_85" <= 0.25346560776233673) THEN CASE WHEN ("ADS"."Feature_33" <= 1.1484500169754028) THEN CASE WHEN ("ADS"."Feature_57" <= -0.9958542287349701) THEN 4 ELSE 5 END ELSE 6 END ELSE CASE WHEN ("ADS"."Feature_41" <= 1.3153379559516907) THEN CASE WHEN ("ADS"."Feature_3" <= -1.5392338037490845) THEN 9 ELSE 10 END ELSE 11 END END ELSE CASE WHEN ("ADS"."Feature_88" <= 0.6205239444971085) THEN CASE WHEN ("ADS"."Feature_42" <= -1.6034700274467468) THEN 14 ELSE CASE WHEN ("ADS"."Feature_45" <= 1.1071225106716156) THEN 16 ELSE 17 END END ELSE CASE WHEN ("ADS"."Feature_17" <= -0.5404984652996063) THEN 19 ELSE 20 END END END AS node_id_2 
FROM "BinaryClass_100" AS "ADS"), 
"DT_node_data_12" AS 
(SELECT "Values".nid AS nid, "Values"."P_0" AS "P_0", "Values"."P_1" AS "P_1", "Values"."D" AS "D", "Values"."DP" AS "DP" 
...
(SELECT "ADS"."KEY" AS "KEY", CASE WHEN ("ADS"."Feature_92" <= -0.35864657163619995) THEN CASE WHEN ("ADS"."Feature_18" <= -1.1047365069389343) THEN CASE WHEN ("ADS"."Feature_45" <= -1.608373910188675) THEN 3 ELSE 4 END ELSE CASE WHEN ("ADS"."Feature_57" <= 1.0720405578613281) THEN 6 ELSE 7 END END ELSE CASE WHEN ("ADS"."Feature_60" <= -0.6577232480049133) THEN 9 ELSE CASE WHEN ("ADS"."Feature_4" <= 0.1314699649810791) THEN CASE WHEN ("ADS"."Feature_12" <= -0.46101632714271545) THEN 12 ELSE 13 END ELSE CASE WHEN ("ADS"."Feature_63" <= 1.874411165714264) THEN 15 ELSE 16 END END END END AS node_id_2 
FROM "BinaryClass_100" AS "ADS"), 
"DT_node_data_13" AS 
(SELECT "Values".nid AS nid, "Values"."P_0" AS "P_0", "Values"."P_1" AS "P_1", "Values"."D" AS "D", "Values"."DP" AS "DP" 
...
(SELECT "ADS"."KEY" AS "KEY", CASE WHEN ("ADS"."Feature_0" <= -0.5467219948768616) THEN CASE WHEN ("ADS"."Feature_90" <= -0.8577341884374619) THEN 2 ELSE CASE WHEN ("ADS"."Feature_98" <= 1.430925190448761) THEN 4 ELSE 5 END END ELSE CASE WHEN ("ADS"."Feature_73" <= 0.8891735672950745) THEN CASE WHEN ("ADS"."Feature_57" <= -0.45606909692287445) THEN CASE WHEN ("ADS"."Feature_10" <= -0.7493161559104919) THEN 9 ELSE 10 END ELSE CASE WHEN ("ADS"."Feature_90" <= 0.9344468116760254) THEN 12 ELSE CASE WHEN ("ADS"."Feature_58" <= -0.35918014496564865) THEN 14 ELSE 15 END END END ELSE CASE WHEN ("ADS"."Feature_0" <= -0.10291439667344093) THEN 17 ELSE 18 END END END AS node_id_2 
FROM "BinaryClass_100" AS "ADS"), 
"DT_node_data_14" AS 
(SELECT "Values".nid AS nid, "Values"."P_0" AS "P_0", "Values"."P_1" AS "P_1", "Values"."D" AS "D", "Values"."DP" AS "DP" 
FROM (SELECT 2 AS nid, 0.0 AS "P_0", 1.0 AS "P_1", 1 AS "D", 1.0 AS "DP" UNION ALL SELECT 4 AS nid, 1.0 AS "P_0", 0.0 AS "P_1", 0 AS "D", 1.0 AS "DP" UNION ALL SELECT 5 AS nid, 0.0 AS "P_0", 1.0 AS "P_1", 1 AS "D", 1.0 AS "DP" UNION ALL SELECT 9 AS nid, 0.0 AS "P_0", 1.0 AS "P_1", 1 AS "D", 1.0 AS "DP" UNION ALL SELECT 10 AS nid, 1.0 AS "P_0", 0.0 AS "P_1", 0 AS "D", 1.0 AS "DP" UNION ALL SELECT 12 AS nid, 0.0 AS "P_0", 1.0 AS "P_1", 1 AS "D", 1.0 AS "DP" UNION ALL SELECT 14 AS nid, 0.0 AS "P_0", 1.0 AS "P_1", 1 AS "D", 1.0 AS "DP" UNION ALL SELECT 15 AS nid, 1.0 AS "P_0", 0.0 AS "P_1", 0 AS "D", 1.0 AS "DP" UNION ALL SELECT 17 AS nid, 0.0 AS "P_0", 1.0 AS "P_1", 1 AS "D", 1.0 AS "DP" UNION ALL SELECT 18 AS nid, 1.0 AS "P_0", 0.0 AS "P_1", 0 AS "D", 1.0 AS "DP") AS "Values"), 
...
(SELECT "ADS"."KEY" AS "KEY", CASE WHEN ("ADS"."Feature_77" <= -0.10046336613595486) THEN 1 ELSE CASE WHEN ("ADS"."Feature_47" <= -1.832064688205719) THEN 3 ELSE CASE WHEN ("ADS"."Feature_51" <= 1.9527651071548462) THEN CASE WHEN ("ADS"."Feature_67" <= 0.9939410984516144) THEN CASE WHEN ("ADS"."Feature_15" <= -0.7707918584346771) THEN 7 ELSE CASE WHEN ("ADS"."Feature_22" <= -1.4802903532981873) THEN CASE WHEN ("ADS"."Feature_92" <= -0.23344555497169495) THEN 10 ELSE 11 END ELSE 12 END END ELSE CASE WHEN ("ADS"."Feature_38" <= -0.1560400128364563) THEN 14 ELSE 15 END END ELSE CASE WHEN ("ADS"."Feature_68" <= -0.8311029076576233) THEN 17 ELSE 18 END END END END AS node_id_2 
FROM "BinaryClass_100" AS "ADS"), 
"DT_node_data_15" AS 
(SELECT "Values".nid AS nid, "Values"."P_0" AS "P_0", "Values"."P_1" AS "P_1", "Values"."D" AS "D", "Values"."DP" AS "DP" 
...
FROM "DT_Output_15")
 INSERT INTO "TMP_20221008174733_S61JJ6T_RF_B1" ("KEY", "Score_0", "Proba_0", "LogProba_0", "Score_1", "Proba_1", "LogProba_1") SELECT "T"."KEY", "T"."Score_0", "T"."Proba_0", "T"."LogProba_0", "T"."Score_1", "T"."Proba_1", "T"."LogProba_1" 
...
-- Code For temporary table TMP_20221008174733_AWAOOL6_RF_avg part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221008174733_AWAOOL6_RF_avg" (
	"KEY" BIGINT NOT NULL, 
	"Score_0" FLOAT(53), 
	"Proba_0" FLOAT(53), 
	"LogProba_0" FLOAT(53), 
...
-- Code For temporary table TMP_20221008174733_AWAOOL6_RF_avg part 2. Populate
...
FROM (SELECT "RF_B0"."KEY" AS "KEY", "RF_B0"."Score_0" AS "Score_0", "RF_B0"."Proba_0" AS "Proba_0", "RF_B0"."LogProba_0" AS "LogProba_0", "RF_B0"."Score_1" AS "Score_1", "RF_B0"."Proba_1" AS "Proba_1", "RF_B0"."LogProba_1" AS "LogProba_1" 
FROM "TMP_20221008174733_JQ9WL0U_RF_B0" AS "RF_B0" UNION ALL SELECT "RF_B1"."KEY" AS "KEY", "RF_B1"."Score_0" AS "Score_0", "RF_B1"."Proba_0" AS "Proba_0", "RF_B1"."LogProba_0" AS "LogProba_0", "RF_B1"."Score_1" AS "Score_1", "RF_B1"."Proba_1" AS "Proba_1", "RF_B1"."LogProba_1" AS "LogProba_1" 
FROM "TMP_20221008174733_S61JJ6T_RF_B1" AS "RF_B1") AS "RF_EnsembleUnion")
 INSERT INTO "TMP_20221008174733_AWAOOL6_RF_avg" ("KEY", "Score_0", "Proba_0", "LogProba_0", "Score_1", "Proba_1", "LogProba_1") SELECT "T"."KEY", "T"."Score_0", "T"."Proba_0", "T"."LogProba_0", "T"."Score_1", "T"."Proba_1", "T"."LogProba_1" 
...
-- Code For temporary table TMP_20221008174733_AWAOOL6_RF_avg part 3. Create Index 

CREATE INDEX "ix_TMP_20221008174733_AWAOOL6_RF_avg_KEY" ON "TMP_20221008174733_AWAOOL6_RF_avg" ("KEY")
...
FROM "TMP_20221008174733_AWAOOL6_RF_avg" AS "RF_avg"), 
