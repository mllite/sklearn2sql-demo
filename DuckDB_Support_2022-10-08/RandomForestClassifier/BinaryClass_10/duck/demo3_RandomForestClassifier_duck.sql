...
-- Code For temporary table TMP_20221008174702_RQDI9B1_RF_B0 part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221008174702_RQDI9B1_RF_B0" (
	"KEY" BIGINT, 
	"Score_0" FLOAT(53), 
	"Proba_0" FLOAT(53), 
	"LogProba_0" FLOAT(53), 
...
FROM "DT_Output_1"), 
"DT_node_lookup_2" AS 
(SELECT "ADS"."KEY" AS "KEY", CASE WHEN ("ADS"."Feature_4" <= -1.7700806856155396) THEN 1 ELSE CASE WHEN ("ADS"."Feature_2" <= -0.6445149779319763) THEN CASE WHEN ("ADS"."Feature_0" <= 1.0961256623268127) THEN 4 ELSE 5 END ELSE CASE WHEN ("ADS"."Feature_0" <= -0.909741222858429) THEN 7 ELSE CASE WHEN ("ADS"."Feature_8" <= -0.11671437323093414) THEN CASE WHEN ("ADS"."Feature_5" <= -1.1605233550071716) THEN CASE WHEN ("ADS"."Feature_9" <= -0.9328631162643433) THEN 11 ELSE 12 END ELSE 13 END ELSE 14 END END END END AS node_id_2 
FROM "BinaryClass_10" AS "ADS"), 
"DT_node_data_2" AS 
(SELECT "Values".nid AS nid, "Values"."P_0" AS "P_0", "Values"."P_1" AS "P_1", "Values"."D" AS "D", "Values"."DP" AS "DP" 
...
FROM "DT_Output_2"), 
"DT_node_lookup_3" AS 
(SELECT "ADS"."KEY" AS "KEY", CASE WHEN ("ADS"."Feature_2" <= 0.6906730830669403) THEN CASE WHEN ("ADS"."Feature_0" <= 0.37206408381462097) THEN CASE WHEN ("ADS"."Feature_9" <= 0.3870140016078949) THEN CASE WHEN ("ADS"."Feature_4" <= -0.03958500921726227) THEN 4 ELSE 5 END ELSE CASE WHEN ("ADS"."Feature_1" <= 0.44239868223667145) THEN 7 ELSE CASE WHEN ("ADS"."Feature_8" <= 0.23331843316555023) THEN 9 ELSE 10 END END END ELSE CASE WHEN ("ADS"."Feature_8" <= -0.18529708683490753) THEN 12 ELSE CASE WHEN ("ADS"."Feature_2" <= -0.40287092328071594) THEN 14 ELSE 15 END END END ELSE CASE WHEN ("ADS"."Feature_9" <= -0.9529637098312378) THEN 17 ELSE CASE WHEN ("ADS"."Feature_6" <= -0.7220506072044373) THEN CASE WHEN ("ADS"."Feature_6" <= -1.102955549955368) THEN 20 ELSE 21 END ELSE 22 END END END AS node_id_2 
FROM "BinaryClass_10" AS "ADS"), 
"DT_node_data_3" AS 
(SELECT "Values".nid AS nid, "Values"."P_0" AS "P_0", "Values"."P_1" AS "P_1", "Values"."D" AS "D", "Values"."DP" AS "DP" 
...
FROM "DT_Output_3"), 
"DT_node_lookup_4" AS 
(SELECT "ADS"."KEY" AS "KEY", CASE WHEN ("ADS"."Feature_5" <= 0.08723368868231773) THEN CASE WHEN ("ADS"."Feature_0" <= 0.17815682291984558) THEN 2 ELSE CASE WHEN ("ADS"."Feature_0" <= 1.0961256623268127) THEN CASE WHEN ("ADS"."Feature_4" <= -0.35459257662296295) THEN 5 ELSE CASE WHEN ("ADS"."Feature_5" <= -1.0435586869716644) THEN 7 ELSE 8 END END ELSE 9 END END ELSE CASE WHEN ("ADS"."Feature_9" <= 0.3962254822254181) THEN CASE WHEN ("ADS"."Feature_3" <= 0.2665559761226177) THEN CASE WHEN ("ADS"."Feature_5" <= 1.6180108785629272) THEN 13 ELSE 14 END ELSE 15 END ELSE CASE WHEN ("ADS"."Feature_7" <= -0.22382912784814835) THEN 17 ELSE CASE WHEN ("ADS"."Feature_1" <= -0.43689143657684326) THEN 19 ELSE 20 END END END END AS node_id_2 
FROM "BinaryClass_10" AS "ADS"), 
"DT_node_data_4" AS 
(SELECT "Values".nid AS nid, "Values"."P_0" AS "P_0", "Values"."P_1" AS "P_1", "Values"."D" AS "D", "Values"."DP" AS "DP" 
...
FROM "DT_Output_4"), 
"DT_node_lookup_5" AS 
(SELECT "ADS"."KEY" AS "KEY", CASE WHEN ("ADS"."Feature_7" <= 0.3551817834377289) THEN CASE WHEN ("ADS"."Feature_0" <= -0.7657362520694733) THEN 2 ELSE CASE WHEN ("ADS"."Feature_3" <= 0.5871007144451141) THEN CASE WHEN ("ADS"."Feature_2" <= -0.6920951008796692) THEN 5 ELSE CASE WHEN ("ADS"."Feature_5" <= -1.0221465229988098) THEN 7 ELSE CASE WHEN ("ADS"."Feature_5" <= 2.2520426511764526) THEN 9 ELSE 10 END END END ELSE CASE WHEN ("ADS"."Feature_5" <= -0.9849978089332581) THEN 12 ELSE CASE WHEN ("ADS"."Feature_9" <= -0.7747158706188202) THEN 14 ELSE CASE WHEN ("ADS"."Feature_7" <= -0.03517569601535797) THEN 16 ELSE 17 END END END END END ELSE 18 END AS node_id_2 
FROM "BinaryClass_10" AS "ADS"), 
"DT_node_data_5" AS 
(SELECT "Values".nid AS nid, "Values"."P_0" AS "P_0", "Values"."P_1" AS "P_1", "Values"."D" AS "D", "Values"."DP" AS "DP" 
...
FROM "DT_Output_5"), 
"DT_node_lookup_6" AS 
(SELECT "ADS"."KEY" AS "KEY", CASE WHEN ("ADS"."Feature_9" <= 0.2140554585494101) THEN CASE WHEN ("ADS"."Feature_7" <= 0.3464086055755615) THEN CASE WHEN ("ADS"."Feature_0" <= 0.8082491457462311) THEN CASE WHEN ("ADS"."Feature_0" <= 0.4073571115732193) THEN CASE WHEN ("ADS"."Feature_0" <= 0.11200631828978658) THEN 5 ELSE 6 END ELSE 7 END ELSE 8 END ELSE 9 END ELSE 10 END AS node_id_2 
FROM "BinaryClass_10" AS "ADS"), 
"DT_node_data_6" AS 
(SELECT "Values".nid AS nid, "Values"."P_0" AS "P_0", "Values"."P_1" AS "P_1", "Values"."D" AS "D", "Values"."DP" AS "DP" 
...
FROM "DT_Output_6"), 
"DT_node_lookup_7" AS 
(SELECT "ADS"."KEY" AS "KEY", CASE WHEN ("ADS"."Feature_0" <= 0.6672365963459015) THEN CASE WHEN ("ADS"."Feature_1" <= -0.08677904680371284) THEN 2 ELSE CASE WHEN ("ADS"."Feature_3" <= 0.5060411840677261) THEN CASE WHEN ("ADS"."Feature_9" <= 0.026198983192443848) THEN CASE WHEN ("ADS"."Feature_4" <= -1.7714591026306152) THEN 6 ELSE 7 END ELSE CASE WHEN ("ADS"."Feature_9" <= 0.43705305457115173) THEN CASE WHEN ("ADS"."Feature_6" <= 1.2365837544202805) THEN 10 ELSE 11 END ELSE 12 END END ELSE CASE WHEN ("ADS"."Feature_5" <= 0.5417215675115585) THEN CASE WHEN ("ADS"."Feature_3" <= 1.0383767485618591) THEN 15 ELSE 16 END ELSE CASE WHEN ("ADS"."Feature_1" <= 1.273874282836914) THEN 18 ELSE 19 END END END END ELSE CASE WHEN ("ADS"."Feature_6" <= 1.6028424501419067) THEN CASE WHEN ("ADS"."Feature_5" <= -1.9670971035957336) THEN CASE WHEN ("ADS"."Feature_5" <= -2.119947671890259) THEN 23 ELSE 24 END ELSE 25 END ELSE 26 END END AS node_id_2 
FROM "BinaryClass_10" AS "ADS"), 
"DT_node_data_7" AS 
(SELECT "Values".nid AS nid, "Values"."P_0" AS "P_0", "Values"."P_1" AS "P_1", "Values"."D" AS "D", "Values"."DP" AS "DP" 
...
FROM "DT_Output_7"), 
"DT_node_lookup_8" AS 
(SELECT "ADS"."KEY" AS "KEY", CASE WHEN ("ADS"."Feature_7" <= -0.05383606581017375) THEN CASE WHEN ("ADS"."Feature_9" <= 0.3870140016078949) THEN 2 ELSE 3 END ELSE CASE WHEN ("ADS"."Feature_3" <= 1.2316009998321533) THEN CASE WHEN ("ADS"."Feature_1" <= 1.8150607347488403) THEN CASE WHEN ("ADS"."Feature_2" <= 1.7767603993415833) THEN CASE WHEN ("ADS"."Feature_5" <= 2.5381274223327637) THEN 8 ELSE 9 END ELSE 10 END ELSE 11 END ELSE CASE WHEN ("ADS"."Feature_3" <= 1.298024296760559) THEN 13 ELSE CASE WHEN ("ADS"."Feature_8" <= -0.5216635912656784) THEN 15 ELSE 16 END END END END AS node_id_2 
FROM "BinaryClass_10" AS "ADS"), 
"DT_node_data_8" AS 
(SELECT "Values".nid AS nid, "Values"."P_0" AS "P_0", "Values"."P_1" AS "P_1", "Values"."D" AS "D", "Values"."DP" AS "DP" 
...
FROM "DT_Output_8"), 
"DT_node_lookup_9" AS 
(SELECT "ADS"."KEY" AS "KEY", CASE WHEN ("ADS"."Feature_5" <= -2.1443475484848022) THEN 1 ELSE CASE WHEN ("ADS"."Feature_7" <= 0.22807211428880692) THEN CASE WHEN ("ADS"."Feature_5" <= 2.0735434889793396) THEN CASE WHEN ("ADS"."Feature_7" <= -0.06224955804646015) THEN 5 ELSE CASE WHEN ("ADS"."Feature_1" <= 0.1326090805232525) THEN CASE WHEN ("ADS"."Feature_0" <= 0.21752841025590897) THEN 8 ELSE 9 END ELSE 10 END END ELSE 11 END ELSE CASE WHEN ("ADS"."Feature_6" <= 1.6028424501419067) THEN CASE WHEN ("ADS"."Feature_5" <= -1.2531661987304688) THEN CASE WHEN ("ADS"."Feature_7" <= 0.3766061067581177) THEN 15 ELSE 16 END ELSE CASE WHEN ("ADS"."Feature_4" <= -2.0069700479507446) THEN 18 ELSE 19 END END ELSE 20 END END END AS node_id_2 
FROM "BinaryClass_10" AS "ADS"), 
"DT_node_data_9" AS 
(SELECT "Values".nid AS nid, "Values"."P_0" AS "P_0", "Values"."P_1" AS "P_1", "Values"."D" AS "D", "Values"."DP" AS "DP" 
...
FROM "DT_Output_9")
 INSERT INTO "TMP_20221008174702_RQDI9B1_RF_B0" ("KEY", "Score_0", "Proba_0", "LogProba_0", "Score_1", "Proba_1", "LogProba_1") SELECT "T"."KEY", "T"."Score_0", "T"."Proba_0", "T"."LogProba_0", "T"."Score_1", "T"."Proba_1", "T"."LogProba_1" 
...
-- Code For temporary table TMP_20221008174702_PNK4FZ9_RF_B1 part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221008174702_PNK4FZ9_RF_B1" (
	"KEY" BIGINT, 
	"Score_0" FLOAT(53), 
	"Proba_0" FLOAT(53), 
	"LogProba_0" FLOAT(53), 
...
-- Code For temporary table TMP_20221008174702_PNK4FZ9_RF_B1 part 2. Populate

WITH "DT_node_lookup_10" AS 
(SELECT "ADS"."KEY" AS "KEY", CASE WHEN ("ADS"."Feature_6" <= -1.2800278663635254) THEN 1 ELSE CASE WHEN ("ADS"."Feature_4" <= -0.8899427950382233) THEN CASE WHEN ("ADS"."Feature_7" <= -0.20873930118978024) THEN 4 ELSE 5 END ELSE CASE WHEN ("ADS"."Feature_9" <= -0.3242165893316269) THEN CASE WHEN ("ADS"."Feature_9" <= -1.0490767359733582) THEN 8 ELSE CASE WHEN ("ADS"."Feature_8" <= -0.18694717437028885) THEN 10 ELSE CASE WHEN ("ADS"."Feature_7" <= 0.27221915125846863) THEN 12 ELSE 13 END END END ELSE CASE WHEN ("ADS"."Feature_1" <= 0.5636976957321167) THEN CASE WHEN ("ADS"."Feature_5" <= 1.383397102355957) THEN 16 ELSE 17 END ELSE 18 END END END END AS node_id_2 
FROM "BinaryClass_10" AS "ADS"), 
"DT_node_data_10" AS 
(SELECT "Values".nid AS nid, "Values"."P_0" AS "P_0", "Values"."P_1" AS "P_1", "Values"."D" AS "D", "Values"."DP" AS "DP" 
...
(SELECT "ADS"."KEY" AS "KEY", CASE WHEN ("ADS"."Feature_8" <= 0.5684955418109894) THEN CASE WHEN ("ADS"."Feature_0" <= 0.43481890857219696) THEN CASE WHEN ("ADS"."Feature_4" <= 1.9849525094032288) THEN CASE WHEN ("ADS"."Feature_4" <= -0.8899427950382233) THEN CASE WHEN ("ADS"."Feature_8" <= -1.4652583599090576) THEN 5 ELSE 6 END ELSE 7 END ELSE 8 END ELSE CASE WHEN ("ADS"."Feature_3" <= 0.6073265373706818) THEN 10 ELSE CASE WHEN ("ADS"."Feature_8" <= -0.18694717437028885) THEN CASE WHEN ("ADS"."Feature_6" <= -0.3023517020046711) THEN 13 ELSE 14 END ELSE 15 END END END ELSE CASE WHEN ("ADS"."Feature_9" <= -0.4097418189048767) THEN 17 ELSE CASE WHEN ("ADS"."Feature_1" <= 0.49859723448753357) THEN 19 ELSE 20 END END END AS node_id_2 
FROM "BinaryClass_10" AS "ADS"), 
"DT_node_data_11" AS 
(SELECT "Values".nid AS nid, "Values"."P_0" AS "P_0", "Values"."P_1" AS "P_1", "Values"."D" AS "D", "Values"."DP" AS "DP" 
...
(SELECT "ADS"."KEY" AS "KEY", CASE WHEN ("ADS"."Feature_9" <= 0.034406057093292475) THEN CASE WHEN ("ADS"."Feature_6" <= 1.721083164215088) THEN CASE WHEN ("ADS"."Feature_9" <= -0.7090716361999512) THEN 3 ELSE CASE WHEN ("ADS"."Feature_5" <= -1.1249728202819824) THEN 5 ELSE 6 END END ELSE CASE WHEN ("ADS"."Feature_7" <= 0.18019139021635056) THEN 8 ELSE 9 END END ELSE CASE WHEN ("ADS"."Feature_6" <= 2.0320791602134705) THEN 11 ELSE 12 END END AS node_id_2 
FROM "BinaryClass_10" AS "ADS"), 
"DT_node_data_12" AS 
(SELECT "Values".nid AS nid, "Values"."P_0" AS "P_0", "Values"."P_1" AS "P_1", "Values"."D" AS "D", "Values"."DP" AS "DP" 
...
(SELECT "ADS"."KEY" AS "KEY", CASE WHEN ("ADS"."Feature_0" <= 0.6672365963459015) THEN CASE WHEN ("ADS"."Feature_7" <= -0.22382912784814835) THEN 2 ELSE CASE WHEN ("ADS"."Feature_5" <= -0.7383509492501616) THEN 4 ELSE CASE WHEN ("ADS"."Feature_2" <= -0.6584394872188568) THEN 6 ELSE CASE WHEN ("ADS"."Feature_4" <= -2.0069700479507446) THEN 8 ELSE 9 END END END END ELSE CASE WHEN ("ADS"."Feature_8" <= 0.8464365601539612) THEN CASE WHEN ("ADS"."Feature_9" <= -0.7514504194259644) THEN 12 ELSE CASE WHEN ("ADS"."Feature_2" <= 0.5072824358940125) THEN 14 ELSE 15 END END ELSE CASE WHEN ("ADS"."Feature_0" <= 0.8227910995483398) THEN 17 ELSE 18 END END END AS node_id_2 
FROM "BinaryClass_10" AS "ADS"), 
"DT_node_data_13" AS 
(SELECT "Values".nid AS nid, "Values"."P_0" AS "P_0", "Values"."P_1" AS "P_1", "Values"."D" AS "D", "Values"."DP" AS "DP" 
...
(SELECT "ADS"."KEY" AS "KEY", CASE WHEN ("ADS"."Feature_6" <= 0.6415847837924957) THEN CASE WHEN ("ADS"."Feature_0" <= 0.37206408381462097) THEN CASE WHEN ("ADS"."Feature_7" <= 0.08195742126554251) THEN 3 ELSE CASE WHEN ("ADS"."Feature_9" <= -0.7301064729690552) THEN 5 ELSE 6 END END ELSE CASE WHEN ("ADS"."Feature_2" <= 1.5964465141296387) THEN CASE WHEN ("ADS"."Feature_6" <= 0.4837633967399597) THEN 9 ELSE CASE WHEN ("ADS"."Feature_3" <= -0.6549237370491028) THEN 11 ELSE 12 END END ELSE CASE WHEN ("ADS"."Feature_7" <= 0.3439456596970558) THEN 14 ELSE 15 END END END ELSE CASE WHEN ("ADS"."Feature_8" <= 0.8692109286785126) THEN CASE WHEN ("ADS"."Feature_2" <= -2.7322075963020325) THEN 18 ELSE CASE WHEN ("ADS"."Feature_0" <= -1.3631316721439362) THEN 20 ELSE 21 END END ELSE 22 END END AS node_id_2 
FROM "BinaryClass_10" AS "ADS"), 
"DT_node_data_14" AS 
(SELECT "Values".nid AS nid, "Values"."P_0" AS "P_0", "Values"."P_1" AS "P_1", "Values"."D" AS "D", "Values"."DP" AS "DP" 
...
(SELECT "ADS"."KEY" AS "KEY", CASE WHEN ("ADS"."Feature_9" <= 0.034406057093292475) THEN CASE WHEN ("ADS"."Feature_6" <= 1.7923275232315063) THEN CASE WHEN ("ADS"."Feature_8" <= -0.2086673378944397) THEN 3 ELSE CASE WHEN ("ADS"."Feature_5" <= -1.3034204840660095) THEN CASE WHEN ("ADS"."Feature_1" <= 0.9533973932266235) THEN 6 ELSE 7 END ELSE 8 END END ELSE CASE WHEN ("ADS"."Feature_0" <= 0.29690391570329666) THEN 10 ELSE 11 END END ELSE CASE WHEN ("ADS"."Feature_3" <= -1.01531383395195) THEN 13 ELSE 14 END END AS node_id_2 
FROM "BinaryClass_10" AS "ADS"), 
"DT_node_data_15" AS 
(SELECT "Values".nid AS nid, "Values"."P_0" AS "P_0", "Values"."P_1" AS "P_1", "Values"."D" AS "D", "Values"."DP" AS "DP" 
...
FROM "DT_Output_15")
 INSERT INTO "TMP_20221008174702_PNK4FZ9_RF_B1" ("KEY", "Score_0", "Proba_0", "LogProba_0", "Score_1", "Proba_1", "LogProba_1") SELECT "T"."KEY", "T"."Score_0", "T"."Proba_0", "T"."LogProba_0", "T"."Score_1", "T"."Proba_1", "T"."LogProba_1" 
...
-- Code For temporary table TMP_20221008174702_Y7M9XQH_RF_avg part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221008174702_Y7M9XQH_RF_avg" (
	"KEY" BIGINT NOT NULL, 
	"Score_0" FLOAT(53), 
	"Proba_0" FLOAT(53), 
	"LogProba_0" FLOAT(53), 
...
-- Code For temporary table TMP_20221008174702_Y7M9XQH_RF_avg part 2. Populate
...
FROM (SELECT "RF_B0"."KEY" AS "KEY", "RF_B0"."Score_0" AS "Score_0", "RF_B0"."Proba_0" AS "Proba_0", "RF_B0"."LogProba_0" AS "LogProba_0", "RF_B0"."Score_1" AS "Score_1", "RF_B0"."Proba_1" AS "Proba_1", "RF_B0"."LogProba_1" AS "LogProba_1" 
FROM "TMP_20221008174702_RQDI9B1_RF_B0" AS "RF_B0" UNION ALL SELECT "RF_B1"."KEY" AS "KEY", "RF_B1"."Score_0" AS "Score_0", "RF_B1"."Proba_0" AS "Proba_0", "RF_B1"."LogProba_0" AS "LogProba_0", "RF_B1"."Score_1" AS "Score_1", "RF_B1"."Proba_1" AS "Proba_1", "RF_B1"."LogProba_1" AS "LogProba_1" 
FROM "TMP_20221008174702_PNK4FZ9_RF_B1" AS "RF_B1") AS "RF_EnsembleUnion")
 INSERT INTO "TMP_20221008174702_Y7M9XQH_RF_avg" ("KEY", "Score_0", "Proba_0", "LogProba_0", "Score_1", "Proba_1", "LogProba_1") SELECT "T"."KEY", "T"."Score_0", "T"."Proba_0", "T"."LogProba_0", "T"."Score_1", "T"."Proba_1", "T"."LogProba_1" 
...
-- Code For temporary table TMP_20221008174702_Y7M9XQH_RF_avg part 3. Create Index 

CREATE INDEX "ix_TMP_20221008174702_Y7M9XQH_RF_avg_KEY" ON "TMP_20221008174702_Y7M9XQH_RF_avg" ("KEY")
...
FROM "TMP_20221008174702_Y7M9XQH_RF_avg" AS "RF_avg"), 
