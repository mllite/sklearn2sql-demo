...
-- Code For temporary table TMP_20221008174921_LSGCD7H_XGB_B0 part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221008174921_LSGCD7H_XGB_B0" (
	"KEY" BIGINT, 
	"Score_0" FLOAT(53), 
	"Score_1" FLOAT(53), 
	"Score_2" FLOAT(53), 
...
-- Code For temporary table TMP_20221008174921_LSGCD7H_XGB_B0 part 2. Populate
...
FROM "DT_Output_9")
 INSERT INTO "TMP_20221008174921_LSGCD7H_XGB_B0" ("KEY", "Score_0", "Score_1", "Score_2", "Score_3") SELECT "T"."KEY", "T"."Score_0", "T"."Score_1", "T"."Score_2", "T"."Score_3" 
...
-- Code For temporary table TMP_20221008174921_FV8E0B3_XGB_B1 part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221008174921_FV8E0B3_XGB_B1" (
	"KEY" BIGINT, 
	"Score_0" FLOAT(53), 
	"Score_1" FLOAT(53), 
	"Score_2" FLOAT(53), 
...
-- Code For temporary table TMP_20221008174921_FV8E0B3_XGB_B1 part 2. Populate
...
FROM "DT_Output_19")
 INSERT INTO "TMP_20221008174921_FV8E0B3_XGB_B1" ("KEY", "Score_0", "Score_1", "Score_2", "Score_3") SELECT "T"."KEY", "T"."Score_0", "T"."Score_1", "T"."Score_2", "T"."Score_3" 
...
-- Code For temporary table TMP_20221008174921_JYIU5TK_XGB_B2 part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221008174921_JYIU5TK_XGB_B2" (
	"KEY" BIGINT, 
	"Score_0" FLOAT(53), 
	"Score_1" FLOAT(53), 
	"Score_2" FLOAT(53), 
...
-- Code For temporary table TMP_20221008174921_JYIU5TK_XGB_B2 part 2. Populate
...
FROM "DT_Output_29")
 INSERT INTO "TMP_20221008174921_JYIU5TK_XGB_B2" ("KEY", "Score_0", "Score_1", "Score_2", "Score_3") SELECT "T"."KEY", "T"."Score_0", "T"."Score_1", "T"."Score_2", "T"."Score_3" 
...
-- Code For temporary table TMP_20221008174921_ZJVNMIV_XGB_B3 part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221008174921_ZJVNMIV_XGB_B3" (
	"KEY" BIGINT, 
	"Score_0" FLOAT(53), 
	"Score_1" FLOAT(53), 
	"Score_2" FLOAT(53), 
...
-- Code For temporary table TMP_20221008174921_ZJVNMIV_XGB_B3 part 2. Populate
...
FROM "DT_Output_39")
 INSERT INTO "TMP_20221008174921_ZJVNMIV_XGB_B3" ("KEY", "Score_0", "Score_1", "Score_2", "Score_3") SELECT "T"."KEY", "T"."Score_0", "T"."Score_1", "T"."Score_2", "T"."Score_3" 
...
-- Code For temporary table TMP_20221008174921_67M0Z5P_XGB_B4 part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221008174921_67M0Z5P_XGB_B4" (
	"KEY" BIGINT, 
	"Score_0" FLOAT(53), 
	"Score_1" FLOAT(53), 
	"Score_2" FLOAT(53), 
...
-- Code For temporary table TMP_20221008174921_67M0Z5P_XGB_B4 part 2. Populate
...
FROM "DT_Output_49")
 INSERT INTO "TMP_20221008174921_67M0Z5P_XGB_B4" ("KEY", "Score_0", "Score_1", "Score_2", "Score_3") SELECT "T"."KEY", "T"."Score_0", "T"."Score_1", "T"."Score_2", "T"."Score_3" 
...
-- Code For temporary table TMP_20221008174921_1LBSRAV_XGB_B5 part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221008174921_1LBSRAV_XGB_B5" (
	"KEY" BIGINT, 
	"Score_0" FLOAT(53), 
	"Score_1" FLOAT(53), 
	"Score_2" FLOAT(53), 
...
-- Code For temporary table TMP_20221008174921_1LBSRAV_XGB_B5 part 2. Populate
...
FROM "DT_Output_59")
 INSERT INTO "TMP_20221008174921_1LBSRAV_XGB_B5" ("KEY", "Score_0", "Score_1", "Score_2", "Score_3") SELECT "T"."KEY", "T"."Score_0", "T"."Score_1", "T"."Score_2", "T"."Score_3" 
...
-- Code For temporary table TMP_20221008174921_Q08NV1Q_XGB_B6 part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221008174921_Q08NV1Q_XGB_B6" (
	"KEY" BIGINT, 
	"Score_0" FLOAT(53), 
	"Score_1" FLOAT(53), 
	"Score_2" FLOAT(53), 
...
-- Code For temporary table TMP_20221008174921_Q08NV1Q_XGB_B6 part 2. Populate
...
FROM "DT_Output_63")
 INSERT INTO "TMP_20221008174921_Q08NV1Q_XGB_B6" ("KEY", "Score_0", "Score_1", "Score_2", "Score_3") SELECT "T"."KEY", "T"."Score_0", "T"."Score_1", "T"."Score_2", "T"."Score_3" 
...
-- Code For temporary table TMP_20221008174921_HBH2WY7_XGB_sum part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221008174921_HBH2WY7_XGB_sum" (
	"KEY" BIGINT NOT NULL, 
	"Score_0" FLOAT(53), 
	"Score_1" FLOAT(53), 
	"Score_2" FLOAT(53), 
...
-- Code For temporary table TMP_20221008174921_HBH2WY7_XGB_sum part 2. Populate
...
FROM (SELECT "XGB_B0"."KEY" AS "KEY", "XGB_B0"."Score_0" AS "Score_0", "XGB_B0"."Score_1" AS "Score_1", "XGB_B0"."Score_2" AS "Score_2", "XGB_B0"."Score_3" AS "Score_3" 
FROM "TMP_20221008174921_LSGCD7H_XGB_B0" AS "XGB_B0" UNION ALL SELECT "XGB_B1"."KEY" AS "KEY", "XGB_B1"."Score_0" AS "Score_0", "XGB_B1"."Score_1" AS "Score_1", "XGB_B1"."Score_2" AS "Score_2", "XGB_B1"."Score_3" AS "Score_3" 
FROM "TMP_20221008174921_FV8E0B3_XGB_B1" AS "XGB_B1" UNION ALL SELECT "XGB_B2"."KEY" AS "KEY", "XGB_B2"."Score_0" AS "Score_0", "XGB_B2"."Score_1" AS "Score_1", "XGB_B2"."Score_2" AS "Score_2", "XGB_B2"."Score_3" AS "Score_3" 
FROM "TMP_20221008174921_JYIU5TK_XGB_B2" AS "XGB_B2" UNION ALL SELECT "XGB_B3"."KEY" AS "KEY", "XGB_B3"."Score_0" AS "Score_0", "XGB_B3"."Score_1" AS "Score_1", "XGB_B3"."Score_2" AS "Score_2", "XGB_B3"."Score_3" AS "Score_3" 
FROM "TMP_20221008174921_ZJVNMIV_XGB_B3" AS "XGB_B3" UNION ALL SELECT "XGB_B4"."KEY" AS "KEY", "XGB_B4"."Score_0" AS "Score_0", "XGB_B4"."Score_1" AS "Score_1", "XGB_B4"."Score_2" AS "Score_2", "XGB_B4"."Score_3" AS "Score_3" 
FROM "TMP_20221008174921_67M0Z5P_XGB_B4" AS "XGB_B4" UNION ALL SELECT "XGB_B5"."KEY" AS "KEY", "XGB_B5"."Score_0" AS "Score_0", "XGB_B5"."Score_1" AS "Score_1", "XGB_B5"."Score_2" AS "Score_2", "XGB_B5"."Score_3" AS "Score_3" 
FROM "TMP_20221008174921_1LBSRAV_XGB_B5" AS "XGB_B5" UNION ALL SELECT "XGB_B6"."KEY" AS "KEY", "XGB_B6"."Score_0" AS "Score_0", "XGB_B6"."Score_1" AS "Score_1", "XGB_B6"."Score_2" AS "Score_2", "XGB_B6"."Score_3" AS "Score_3" 
FROM "TMP_20221008174921_Q08NV1Q_XGB_B6" AS "XGB_B6") AS "XGB_EnsembleUnion")
 INSERT INTO "TMP_20221008174921_HBH2WY7_XGB_sum" ("KEY", "Score_0", "Score_1", "Score_2", "Score_3") SELECT "T"."KEY", "T"."Score_0", "T"."Score_1", "T"."Score_2", "T"."Score_3" 
...
-- Code For temporary table TMP_20221008174921_HBH2WY7_XGB_sum part 3. Create Index 

CREATE INDEX "ix_TMP_20221008174921_HBH2WY7_XGB_sum_KEY" ON "TMP_20221008174921_HBH2WY7_XGB_sum" ("KEY")
...
FROM "TMP_20221008174921_HBH2WY7_XGB_sum" AS "XGB_sum"), 
