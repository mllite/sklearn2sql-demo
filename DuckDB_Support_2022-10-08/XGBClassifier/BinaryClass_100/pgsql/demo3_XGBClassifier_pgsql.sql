...
-- Code For temporary table TMP_20221008174744_WH8NSBD_XGB_B0 part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221008174744_WH8NSBD_XGB_B0" (
	"KEY" BIGINT, 
	"Score_0" FLOAT
)
...
-- Code For temporary table TMP_20221008174744_WH8NSBD_XGB_B0 part 2. Populate
...
FROM "DT_Output_9")
 INSERT INTO "TMP_20221008174744_WH8NSBD_XGB_B0" ("KEY", "Score_0") SELECT "T"."KEY", "T"."Score_0" 
...
-- Code For temporary table TMP_20221008174744_SSOBUIA_XGB_B1 part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221008174744_SSOBUIA_XGB_B1" (
	"KEY" BIGINT, 
	"Score_0" FLOAT
)
...
-- Code For temporary table TMP_20221008174744_SSOBUIA_XGB_B1 part 2. Populate
...
FROM "DT_Output_15")
 INSERT INTO "TMP_20221008174744_SSOBUIA_XGB_B1" ("KEY", "Score_0") SELECT "T"."KEY", "T"."Score_0" 
...
-- Code For temporary table TMP_20221008174744_7Y1XMJ1_XGB_sum part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221008174744_7Y1XMJ1_XGB_sum" (
	"KEY" BIGINT NOT NULL, 
	"Score_0" FLOAT, 
	PRIMARY KEY ("KEY")
)
...
-- Code For temporary table TMP_20221008174744_7Y1XMJ1_XGB_sum part 2. Populate

WITH "XGB_Union" AS 
(SELECT "XGB_EnsembleUnion"."KEY" AS "KEY", "XGB_EnsembleUnion"."Score_0" AS "Score_0" 
FROM (SELECT "XGB_B0"."KEY" AS "KEY", "XGB_B0"."Score_0" AS "Score_0" 
FROM "TMP_20221008174744_WH8NSBD_XGB_B0" AS "XGB_B0" UNION ALL SELECT "XGB_B1"."KEY" AS "KEY", "XGB_B1"."Score_0" AS "Score_0" 
FROM "TMP_20221008174744_SSOBUIA_XGB_B1" AS "XGB_B1") AS "XGB_EnsembleUnion")
 INSERT INTO "TMP_20221008174744_7Y1XMJ1_XGB_sum" ("KEY", "Score_0") SELECT "T"."KEY", "T"."Score_0" 
...
-- Code For temporary table TMP_20221008174744_7Y1XMJ1_XGB_sum part 3. Create Index 

CREATE INDEX "ix_TMP_20221008174744_7Y1XMJ1_XGB_sum_KEY" ON "TMP_20221008174744_7Y1XMJ1_XGB_sum" ("KEY")
...
FROM "TMP_20221008174744_7Y1XMJ1_XGB_sum" AS "XGB_sum"), 
