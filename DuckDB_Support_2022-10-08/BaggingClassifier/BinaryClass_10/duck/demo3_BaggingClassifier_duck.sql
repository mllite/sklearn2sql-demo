...
-- Code For temporary table TMP_20221008174647_P7OT22P_BAG_B0 part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221008174647_P7OT22P_BAG_B0" (
	"KEY" BIGINT, 
	"Score_0" FLOAT(53), 
	"Proba_0" FLOAT(53), 
	"LogProba_0" FLOAT(53), 
...
-- Code For temporary table TMP_20221008174647_P7OT22P_BAG_B0 part 2. Populate

WITH "DT_node_lookup" AS 
(SELECT "ADS"."KEY" AS "KEY", CASE WHEN ("ADS"."Feature_9" <= -0.20116814225912094) THEN CASE WHEN ("ADS"."Feature_4" <= -2.0276726484298706) THEN 2 ELSE CASE WHEN ("ADS"."Feature_6" <= 1.6028424501419067) THEN CASE WHEN ("ADS"."Feature_5" <= -1.4731858372688293) THEN CASE WHEN ("ADS"."Feature_8" <= 0.2576090916991234) THEN 6 ELSE 7 END ELSE 8 END ELSE CASE WHEN ("ADS"."Feature_6" <= 2.211838126182556) THEN 10 ELSE 11 END END END ELSE CASE WHEN ("ADS"."Feature_6" <= 1.9341034293174744) THEN CASE WHEN ("ADS"."Feature_8" <= -1.7764182686805725) THEN CASE WHEN ("ADS"."Feature_4" <= 0.34345462918281555) THEN 15 ELSE 16 END ELSE 17 END ELSE 18 END END AS node_id_2 
...
FROM "DT_Output"), 
"DT_node_lookup_1" AS 
(SELECT "ADS"."KEY" AS "KEY", CASE WHEN ("ADS"."Feature_9" <= 0.43705305457115173) THEN CASE WHEN ("ADS"."Feature_6" <= -1.2800278663635254) THEN 2 ELSE CASE WHEN ("ADS"."Feature_3" <= 1.6007295846939087) THEN CASE WHEN ("ADS"."Feature_5" <= 2.642269730567932) THEN CASE WHEN ("ADS"."Feature_8" <= -1.4217381477355957) THEN 6 ELSE 7 END ELSE 8 END ELSE 9 END END ELSE 10 END AS node_id_2 
FROM "BinaryClass_10" AS "ADS"), 
"DT_node_data_1" AS 
(SELECT "Values".nid AS nid, "Values"."P_0" AS "P_0", "Values"."P_1" AS "P_1", "Values"."D" AS "D", "Values"."DP" AS "DP" 
FROM (SELECT 2 AS nid, 0.0 AS "P_0", 1.0 AS "P_1", 1 AS "D", 1.0 AS "DP" UNION ALL SELECT 6 AS nid, 0.0 AS "P_0", 1.0 AS "P_1", 1 AS "D", 1.0 AS "DP" UNION ALL SELECT 7 AS nid, 0.9761904761904762 AS "P_0", 0.023809523809523808 AS "P_1", 0 AS "D", 0.9761904761904762 AS "DP" UNION ALL SELECT 8 AS nid, 0.0 AS "P_0", 1.0 AS "P_1", 1 AS "D", 1.0 AS "DP" UNION ALL SELECT 9 AS nid, 0.0 AS "P_0", 1.0 AS "P_1", 1 AS "D", 1.0 AS "DP" UNION ALL SELECT 10 AS nid, 0.0 AS "P_0", 1.0 AS "P_1", 1 AS "D", 1.0 AS "DP") AS "Values"), 
"DT_Output_1" AS 
...
FROM "DT_Output_1"), 
"DT_node_lookup_2" AS 
(SELECT "ADS"."KEY" AS "KEY", CASE WHEN ("ADS"."Feature_9" <= 0.3962254822254181) THEN CASE WHEN ("ADS"."Feature_5" <= 2.474828600883484) THEN CASE WHEN ("ADS"."Feature_3" <= 1.745934009552002) THEN CASE WHEN ("ADS"."Feature_2" <= 1.8482453227043152) THEN CASE WHEN ("ADS"."Feature_8" <= 1.4377551674842834) THEN 5 ELSE 6 END ELSE 7 END ELSE 8 END ELSE 9 END ELSE 10 END AS node_id_2 
FROM "BinaryClass_10" AS "ADS"), 
"DT_node_data_2" AS 
(SELECT "Values".nid AS nid, "Values"."P_0" AS "P_0", "Values"."P_1" AS "P_1", "Values"."D" AS "D", "Values"."DP" AS "DP" 
...
FROM "DT_Output_2"), 
"DT_node_lookup_3" AS 
(SELECT "ADS"."KEY" AS "KEY", CASE WHEN ("ADS"."Feature_9" <= 0.3870140016078949) THEN CASE WHEN ("ADS"."Feature_2" <= 1.8351728916168213) THEN CASE WHEN ("ADS"."Feature_3" <= 1.745934009552002) THEN CASE WHEN ("ADS"."Feature_5" <= 2.642269730567932) THEN CASE WHEN ("ADS"."Feature_5" <= -1.7630251049995422) THEN 5 ELSE 6 END ELSE 7 END ELSE 8 END ELSE 9 END ELSE CASE WHEN ("ADS"."Feature_6" <= 2.0320791602134705) THEN 11 ELSE 12 END END AS node_id_2 
FROM "BinaryClass_10" AS "ADS"), 
"DT_node_data_3" AS 
(SELECT "Values".nid AS nid, "Values"."P_0" AS "P_0", "Values"."P_1" AS "P_1", "Values"."D" AS "D", "Values"."DP" AS "DP" 
...
FROM "DT_Output_3"), 
"DT_node_lookup_4" AS 
(SELECT "ADS"."KEY" AS "KEY", CASE WHEN ("ADS"."Feature_9" <= -0.20116814225912094) THEN CASE WHEN ("ADS"."Feature_5" <= 2.270956516265869) THEN CASE WHEN ("ADS"."Feature_5" <= -1.7392327785491943) THEN CASE WHEN ("ADS"."Feature_7" <= 0.4161919951438904) THEN 4 ELSE 5 END ELSE 6 END ELSE 7 END ELSE CASE WHEN ("ADS"."Feature_6" <= 1.9341034293174744) THEN CASE WHEN ("ADS"."Feature_3" <= -0.7903546988964081) THEN CASE WHEN ("ADS"."Feature_0" <= -0.057083070278167725) THEN 11 ELSE 12 END ELSE 13 END ELSE 14 END END AS node_id_2 
FROM "BinaryClass_10" AS "ADS"), 
"DT_node_data_4" AS 
(SELECT "Values".nid AS nid, "Values"."P_0" AS "P_0", "Values"."P_1" AS "P_1", "Values"."D" AS "D", "Values"."DP" AS "DP" 
...
FROM "DT_Output_4"), 
"DT_node_lookup_5" AS 
(SELECT "ADS"."KEY" AS "KEY", CASE WHEN ("ADS"."Feature_9" <= 0.034406057093292475) THEN CASE WHEN ("ADS"."Feature_2" <= 1.5687443614006042) THEN CASE WHEN ("ADS"."Feature_5" <= 2.103515386581421) THEN CASE WHEN ("ADS"."Feature_3" <= 1.745934009552002) THEN CASE WHEN ("ADS"."Feature_3" <= 1.0940061211585999) THEN 5 ELSE 6 END ELSE 7 END ELSE 8 END ELSE CASE WHEN ("ADS"."Feature_5" <= -1.0882456302642822) THEN 10 ELSE 11 END END ELSE CASE WHEN ("ADS"."Feature_4" <= 1.3486061096191406) THEN 13 ELSE 14 END END AS node_id_2 
FROM "BinaryClass_10" AS "ADS"), 
"DT_node_data_5" AS 
(SELECT "Values".nid AS nid, "Values"."P_0" AS "P_0", "Values"."P_1" AS "P_1", "Values"."D" AS "D", "Values"."DP" AS "DP" 
...
FROM "DT_Output_5"), 
"DT_node_lookup_6" AS 
(SELECT "ADS"."KEY" AS "KEY", CASE WHEN ("ADS"."Feature_7" <= -0.0793448593467474) THEN 1 ELSE CASE WHEN ("ADS"."Feature_5" <= 2.3706862926483154) THEN CASE WHEN ("ADS"."Feature_6" <= 1.721083164215088) THEN CASE WHEN ("ADS"."Feature_5" <= -1.4731858372688293) THEN CASE WHEN ("ADS"."Feature_9" <= -0.8267439603805542) THEN 6 ELSE 7 END ELSE 8 END ELSE 9 END ELSE 10 END END AS node_id_2 
FROM "BinaryClass_10" AS "ADS"), 
"DT_node_data_6" AS 
(SELECT "Values".nid AS nid, "Values"."P_0" AS "P_0", "Values"."P_1" AS "P_1", "Values"."D" AS "D", "Values"."DP" AS "DP" 
...
FROM "DT_Output_6"), 
"DT_node_lookup_7" AS 
(SELECT "ADS"."KEY" AS "KEY", CASE WHEN ("ADS"."Feature_9" <= 0.13965497398748994) THEN CASE WHEN ("ADS"."Feature_5" <= 2.3706862926483154) THEN CASE WHEN ("ADS"."Feature_5" <= -1.4826768040657043) THEN CASE WHEN ("ADS"."Feature_7" <= 0.39920105040073395) THEN 4 ELSE 5 END ELSE 6 END ELSE 7 END ELSE CASE WHEN ("ADS"."Feature_6" <= 1.9341034293174744) THEN 9 ELSE 10 END END AS node_id_2 
FROM "BinaryClass_10" AS "ADS"), 
"DT_node_data_7" AS 
(SELECT "Values".nid AS nid, "Values"."P_0" AS "P_0", "Values"."P_1" AS "P_1", "Values"."D" AS "D", "Values"."DP" AS "DP" 
...
FROM "DT_Output_7"), 
"DT_node_lookup_8" AS 
(SELECT "ADS"."KEY" AS "KEY", CASE WHEN ("ADS"."Feature_9" <= 0.3870140016078949) THEN CASE WHEN ("ADS"."Feature_5" <= 2.474828600883484) THEN CASE WHEN ("ADS"."Feature_3" <= 1.2316009998321533) THEN CASE WHEN ("ADS"."Feature_2" <= 1.7767603993415833) THEN 4 ELSE 5 END ELSE CASE WHEN ("ADS"."Feature_6" <= 0.16913031041622162) THEN 7 ELSE 8 END END ELSE 9 END ELSE 10 END AS node_id_2 
FROM "BinaryClass_10" AS "ADS"), 
"DT_node_data_8" AS 
(SELECT "Values".nid AS nid, "Values"."P_0" AS "P_0", "Values"."P_1" AS "P_1", "Values"."D" AS "D", "Values"."DP" AS "DP" 
...
FROM "DT_Output_8"), 
"DT_node_lookup_9" AS 
(SELECT "ADS"."KEY" AS "KEY", CASE WHEN ("ADS"."Feature_7" <= 0.3353678435087204) THEN CASE WHEN ("ADS"."Feature_9" <= 0.034406057093292475) THEN CASE WHEN ("ADS"."Feature_5" <= -0.8862068951129913) THEN 3 ELSE CASE WHEN ("ADS"."Feature_4" <= -2.0069700479507446) THEN 5 ELSE 6 END END ELSE CASE WHEN ("ADS"."Feature_5" <= 2.0735434889793396) THEN 8 ELSE 9 END END ELSE 10 END AS node_id_2 
FROM "BinaryClass_10" AS "ADS"), 
"DT_node_data_9" AS 
(SELECT "Values".nid AS nid, "Values"."P_0" AS "P_0", "Values"."P_1" AS "P_1", "Values"."D" AS "D", "Values"."DP" AS "DP" 
...
FROM "DT_Output_9")
 INSERT INTO "TMP_20221008174647_P7OT22P_BAG_B0" ("KEY", "Score_0", "Proba_0", "LogProba_0", "Score_1", "Proba_1", "LogProba_1") SELECT "T"."KEY", "T"."Score_0", "T"."Proba_0", "T"."LogProba_0", "T"."Score_1", "T"."Proba_1", "T"."LogProba_1" 
...
-- Code For temporary table TMP_20221008174647_261ZIJV_BAG_B1 part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221008174647_261ZIJV_BAG_B1" (
	"KEY" BIGINT, 
	"Score_0" FLOAT(53), 
	"Proba_0" FLOAT(53), 
	"LogProba_0" FLOAT(53), 
...
-- Code For temporary table TMP_20221008174647_261ZIJV_BAG_B1 part 2. Populate

WITH "DT_node_lookup_10" AS 
(SELECT "ADS"."KEY" AS "KEY", CASE WHEN ("ADS"."Feature_9" <= 0.034406057093292475) THEN CASE WHEN ("ADS"."Feature_5" <= 2.103515386581421) THEN CASE WHEN ("ADS"."Feature_5" <= -1.1672475934028625) THEN CASE WHEN ("ADS"."Feature_0" <= 1.1058164834976196) THEN 4 ELSE 5 END ELSE 6 END ELSE 7 END ELSE CASE WHEN ("ADS"."Feature_6" <= 1.6255619823932648) THEN 9 ELSE 10 END END AS node_id_2 
FROM "BinaryClass_10" AS "ADS"), 
"DT_node_data_10" AS 
(SELECT "Values".nid AS nid, "Values"."P_0" AS "P_0", "Values"."P_1" AS "P_1", "Values"."D" AS "D", "Values"."DP" AS "DP" 
FROM (SELECT 4 AS nid, 0.0 AS "P_0", 1.0 AS "P_1", 1 AS "D", 1.0 AS "DP" UNION ALL SELECT 5 AS nid, 1.0 AS "P_0", 0.0 AS "P_1", 0 AS "D", 1.0 AS "DP" UNION ALL SELECT 6 AS nid, 1.0 AS "P_0", 0.0 AS "P_1", 0 AS "D", 1.0 AS "DP" UNION ALL SELECT 7 AS nid, 0.0 AS "P_0", 1.0 AS "P_1", 1 AS "D", 1.0 AS "DP" UNION ALL SELECT 9 AS nid, 0.0 AS "P_0", 1.0 AS "P_1", 1 AS "D", 1.0 AS "DP" UNION ALL SELECT 10 AS nid, 1.0 AS "P_0", 0.0 AS "P_1", 0 AS "D", 1.0 AS "DP") AS "Values"), 
...
(SELECT "ADS"."KEY" AS "KEY", CASE WHEN ("ADS"."Feature_9" <= -0.4097418189048767) THEN CASE WHEN ("ADS"."Feature_6" <= 1.6239227056503296) THEN CASE WHEN ("ADS"."Feature_3" <= 1.2421400547027588) THEN 3 ELSE CASE WHEN ("ADS"."Feature_8" <= -0.18694717437028885) THEN 5 ELSE 6 END END ELSE 7 END ELSE CASE WHEN ("ADS"."Feature_6" <= 1.9341034293174744) THEN CASE WHEN ("ADS"."Feature_9" <= -0.03950319066643715) THEN CASE WHEN ("ADS"."Feature_9" <= -0.16162139922380447) THEN 11 ELSE 12 END ELSE 13 END ELSE 14 END END AS node_id_2 
FROM "BinaryClass_10" AS "ADS"), 
"DT_node_data_11" AS 
(SELECT "Values".nid AS nid, "Values"."P_0" AS "P_0", "Values"."P_1" AS "P_1", "Values"."D" AS "D", "Values"."DP" AS "DP" 
...
(SELECT "ADS"."KEY" AS "KEY", CASE WHEN ("ADS"."Feature_9" <= 0.034406057093292475) THEN CASE WHEN ("ADS"."Feature_3" <= 1.745934009552002) THEN CASE WHEN ("ADS"."Feature_2" <= 1.8351728916168213) THEN CASE WHEN ("ADS"."Feature_3" <= 1.2189984321594238) THEN 4 ELSE CASE WHEN ("ADS"."Feature_4" <= 0.31972476188093424) THEN 6 ELSE 7 END END ELSE 8 END ELSE 9 END ELSE CASE WHEN ("ADS"."Feature_6" <= 2.0320791602134705) THEN 11 ELSE 12 END END AS node_id_2 
FROM "BinaryClass_10" AS "ADS"), 
"DT_node_data_12" AS 
(SELECT "Values".nid AS nid, "Values"."P_0" AS "P_0", "Values"."P_1" AS "P_1", "Values"."D" AS "D", "Values"."DP" AS "DP" 
FROM (SELECT 4 AS nid, 1.0 AS "P_0", 0.0 AS "P_1", 0 AS "D", 1.0 AS "DP" UNION ALL SELECT 6 AS nid, 0.0 AS "P_0", 1.0 AS "P_1", 1 AS "D", 1.0 AS "DP" UNION ALL SELECT 7 AS nid, 1.0 AS "P_0", 0.0 AS "P_1", 0 AS "D", 1.0 AS "DP" UNION ALL SELECT 8 AS nid, 0.0 AS "P_0", 1.0 AS "P_1", 1 AS "D", 1.0 AS "DP" UNION ALL SELECT 9 AS nid, 0.0 AS "P_0", 1.0 AS "P_1", 1 AS "D", 1.0 AS "DP" UNION ALL SELECT 11 AS nid, 0.0 AS "P_0", 1.0 AS "P_1", 1 AS "D", 1.0 AS "DP" UNION ALL SELECT 12 AS nid, 1.0 AS "P_0", 0.0 AS "P_1", 0 AS "D", 1.0 AS "DP") AS "Values"), 
...
(SELECT "ADS"."KEY" AS "KEY", CASE WHEN ("ADS"."Feature_9" <= -0.27291035652160645) THEN CASE WHEN ("ADS"."Feature_5" <= 2.3706862926483154) THEN CASE WHEN ("ADS"."Feature_6" <= 1.6239227056503296) THEN CASE WHEN ("ADS"."Feature_9" <= -0.45606909692287445) THEN 4 ELSE CASE WHEN ("ADS"."Feature_2" <= 0.027701810002326965) THEN 6 ELSE 7 END END ELSE 8 END ELSE 9 END ELSE CASE WHEN ("ADS"."Feature_6" <= 1.759411633014679) THEN CASE WHEN ("ADS"."Feature_8" <= -1.5881020426750183) THEN CASE WHEN ("ADS"."Feature_3" <= -0.4685395807027817) THEN 13 ELSE 14 END ELSE 15 END ELSE 16 END END AS node_id_2 
FROM "BinaryClass_10" AS "ADS"), 
"DT_node_data_13" AS 
(SELECT "Values".nid AS nid, "Values"."P_0" AS "P_0", "Values"."P_1" AS "P_1", "Values"."D" AS "D", "Values"."DP" AS "DP" 
...
(SELECT "ADS"."KEY" AS "KEY", CASE WHEN ("ADS"."Feature_9" <= -0.20116814225912094) THEN CASE WHEN ("ADS"."Feature_5" <= 2.3706862926483154) THEN CASE WHEN ("ADS"."Feature_3" <= 1.2421400547027588) THEN CASE WHEN ("ADS"."Feature_2" <= 1.8351728916168213) THEN 4 ELSE 5 END ELSE 6 END ELSE 7 END ELSE CASE WHEN ("ADS"."Feature_6" <= 2.0320791602134705) THEN 9 ELSE 10 END END AS node_id_2 
FROM "BinaryClass_10" AS "ADS"), 
"DT_node_data_14" AS 
(SELECT "Values".nid AS nid, "Values"."P_0" AS "P_0", "Values"."P_1" AS "P_1", "Values"."D" AS "D", "Values"."DP" AS "DP" 
FROM (SELECT 4 AS nid, 1.0 AS "P_0", 0.0 AS "P_1", 0 AS "D", 1.0 AS "DP" UNION ALL SELECT 5 AS nid, 0.0 AS "P_0", 1.0 AS "P_1", 1 AS "D", 1.0 AS "DP" UNION ALL SELECT 6 AS nid, 0.0 AS "P_0", 1.0 AS "P_1", 1 AS "D", 1.0 AS "DP" UNION ALL SELECT 7 AS nid, 0.0 AS "P_0", 1.0 AS "P_1", 1 AS "D", 1.0 AS "DP" UNION ALL SELECT 9 AS nid, 0.0 AS "P_0", 1.0 AS "P_1", 1 AS "D", 1.0 AS "DP" UNION ALL SELECT 10 AS nid, 1.0 AS "P_0", 0.0 AS "P_1", 0 AS "D", 1.0 AS "DP") AS "Values"), 
...
(SELECT "ADS"."KEY" AS "KEY", CASE WHEN ("ADS"."Feature_9" <= 0.034406057093292475) THEN CASE WHEN ("ADS"."Feature_5" <= -1.1672475934028625) THEN CASE WHEN ("ADS"."Feature_9" <= -0.8327642679214478) THEN 3 ELSE 4 END ELSE CASE WHEN ("ADS"."Feature_1" <= 1.9874111413955688) THEN 6 ELSE 7 END END ELSE CASE WHEN ("ADS"."Feature_3" <= -1.01531383395195) THEN 9 ELSE 10 END END AS node_id_2 
FROM "BinaryClass_10" AS "ADS"), 
"DT_node_data_15" AS 
(SELECT "Values".nid AS nid, "Values"."P_0" AS "P_0", "Values"."P_1" AS "P_1", "Values"."D" AS "D", "Values"."DP" AS "DP" 
...
FROM "DT_Output_15")
 INSERT INTO "TMP_20221008174647_261ZIJV_BAG_B1" ("KEY", "Score_0", "Proba_0", "LogProba_0", "Score_1", "Proba_1", "LogProba_1") SELECT "T"."KEY", "T"."Score_0", "T"."Proba_0", "T"."LogProba_0", "T"."Score_1", "T"."Proba_1", "T"."LogProba_1" 
...
-- Code For temporary table TMP_20221008174647_B89WG23_BAG_avg part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221008174647_B89WG23_BAG_avg" (
	"KEY" BIGINT NOT NULL, 
	"Score_0" FLOAT(53), 
	"Proba_0" FLOAT(53), 
	"LogProba_0" FLOAT(53), 
...
-- Code For temporary table TMP_20221008174647_B89WG23_BAG_avg part 2. Populate
...
FROM (SELECT "BAG_B0"."KEY" AS "KEY", "BAG_B0"."Score_0" AS "Score_0", "BAG_B0"."Proba_0" AS "Proba_0", "BAG_B0"."LogProba_0" AS "LogProba_0", "BAG_B0"."Score_1" AS "Score_1", "BAG_B0"."Proba_1" AS "Proba_1", "BAG_B0"."LogProba_1" AS "LogProba_1" 
FROM "TMP_20221008174647_P7OT22P_BAG_B0" AS "BAG_B0" UNION ALL SELECT "BAG_B1"."KEY" AS "KEY", "BAG_B1"."Score_0" AS "Score_0", "BAG_B1"."Proba_0" AS "Proba_0", "BAG_B1"."LogProba_0" AS "LogProba_0", "BAG_B1"."Score_1" AS "Score_1", "BAG_B1"."Proba_1" AS "Proba_1", "BAG_B1"."LogProba_1" AS "LogProba_1" 
FROM "TMP_20221008174647_261ZIJV_BAG_B1" AS "BAG_B1") AS "BAG_EnsembleUnion")
 INSERT INTO "TMP_20221008174647_B89WG23_BAG_avg" ("KEY", "Score_0", "Proba_0", "LogProba_0", "Score_1", "Proba_1", "LogProba_1") SELECT "T"."KEY", "T"."Score_0", "T"."Proba_0", "T"."LogProba_0", "T"."Score_1", "T"."Proba_1", "T"."LogProba_1" 
...
-- Code For temporary table TMP_20221008174647_B89WG23_BAG_avg part 3. Create Index 

CREATE INDEX "ix_TMP_20221008174647_B89WG23_BAG_avg_KEY" ON "TMP_20221008174647_B89WG23_BAG_avg" ("KEY")
...
FROM "TMP_20221008174647_B89WG23_BAG_avg" AS "BAG_avg"), 
