...
-- Code For temporary table TMP_20221008174717_0NPDJF0_BAG_B0 part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221008174717_0NPDJF0_BAG_B0" (
	"KEY" BIGINT, 
	"Score_0" FLOAT(53), 
	"Proba_0" FLOAT(53), 
	"LogProba_0" FLOAT(53), 
...
-- Code For temporary table TMP_20221008174717_0NPDJF0_BAG_B0 part 2. Populate

WITH "DT_node_lookup" AS 
(SELECT "ADS"."KEY" AS "KEY", CASE WHEN ("ADS"."Feature_57" <= -0.265893891453743) THEN CASE WHEN ("ADS"."Feature_30" <= 1.595907986164093) THEN 2 ELSE CASE WHEN ("ADS"."Feature_99" <= 0.84698885679245) THEN 4 ELSE 5 END END ELSE CASE WHEN ("ADS"."Feature_48" <= 1.5001174211502075) THEN CASE WHEN ("ADS"."Feature_86" <= -1.5882685780525208) THEN 8 ELSE 9 END ELSE 10 END END AS node_id_2 
...
FROM "DT_Output"), 
"DT_node_lookup_1" AS 
(SELECT "ADS"."KEY" AS "KEY", CASE WHEN ("ADS"."Feature_57" <= -0.19605962932109833) THEN CASE WHEN ("ADS"."Feature_51" <= 1.7948462963104248) THEN CASE WHEN ("ADS"."Feature_60" <= -2.2802830934524536) THEN 3 ELSE CASE WHEN ("ADS"."Feature_66" <= -1.7913909554481506) THEN 5 ELSE CASE WHEN ("ADS"."Feature_35" <= 1.072922796010971) THEN 7 ELSE 8 END END END ELSE 9 END ELSE CASE WHEN ("ADS"."Feature_74" <= -1.2598422765731812) THEN 11 ELSE 12 END END AS node_id_2 
FROM "BinaryClass_100" AS "ADS"), 
"DT_node_data_1" AS 
(SELECT "Values".nid AS nid, "Values"."P_0" AS "P_0", "Values"."P_1" AS "P_1", "Values"."D" AS "D", "Values"."DP" AS "DP" 
...
FROM "DT_Output_1"), 
"DT_node_lookup_2" AS 
(SELECT "ADS"."KEY" AS "KEY", CASE WHEN ("ADS"."Feature_57" <= -0.27291035652160645) THEN CASE WHEN ("ADS"."Feature_17" <= 0.7028412222862244) THEN 2 ELSE 3 END ELSE CASE WHEN ("ADS"."Feature_74" <= -1.6934558749198914) THEN CASE WHEN ("ADS"."Feature_19" <= 0.25105198100209236) THEN 6 ELSE 7 END ELSE 8 END END AS node_id_2 
FROM "BinaryClass_100" AS "ADS"), 
"DT_node_data_2" AS 
(SELECT "Values".nid AS nid, "Values"."P_0" AS "P_0", "Values"."P_1" AS "P_1", "Values"."D" AS "D", "Values"."DP" AS "DP" 
...
FROM "DT_Output_2"), 
"DT_node_lookup_3" AS 
(SELECT "ADS"."KEY" AS "KEY", CASE WHEN ("ADS"."Feature_57" <= 0.034406057093292475) THEN CASE WHEN ("ADS"."Feature_17" <= 1.0132035613059998) THEN CASE WHEN ("ADS"."Feature_91" <= -1.5262805819511414) THEN 3 ELSE 4 END ELSE CASE WHEN ("ADS"."Feature_39" <= -0.25046786293387413) THEN 6 ELSE 7 END END ELSE CASE WHEN ("ADS"."Feature_17" <= 1.9419240355491638) THEN 9 ELSE 10 END END AS node_id_2 
FROM "BinaryClass_100" AS "ADS"), 
"DT_node_data_3" AS 
(SELECT "Values".nid AS nid, "Values"."P_0" AS "P_0", "Values"."P_1" AS "P_1", "Values"."D" AS "D", "Values"."DP" AS "DP" 
...
FROM "DT_Output_3"), 
"DT_node_lookup_4" AS 
(SELECT "ADS"."KEY" AS "KEY", CASE WHEN ("ADS"."Feature_57" <= 0.3962254822254181) THEN CASE WHEN ("ADS"."Feature_27" <= 1.0105148255825043) THEN CASE WHEN ("ADS"."Feature_35" <= 1.1146454215049744) THEN 3 ELSE 4 END ELSE 5 END ELSE CASE WHEN ("ADS"."Feature_64" <= -1.3739370703697205) THEN 7 ELSE 8 END END AS node_id_2 
FROM "BinaryClass_100" AS "ADS"), 
"DT_node_data_4" AS 
(SELECT "Values".nid AS nid, "Values"."P_0" AS "P_0", "Values"."P_1" AS "P_1", "Values"."D" AS "D", "Values"."DP" AS "DP" 
...
FROM "DT_Output_5"), 
"DT_node_lookup_6" AS 
(SELECT "ADS"."KEY" AS "KEY", CASE WHEN ("ADS"."Feature_57" <= -0.19605962932109833) THEN CASE WHEN ("ADS"."Feature_71" <= -2.1820791959762573) THEN 2 ELSE CASE WHEN ("ADS"."Feature_43" <= 1.2855034470558167) THEN CASE WHEN ("ADS"."Feature_80" <= -1.8407464027404785) THEN 5 ELSE 6 END ELSE 7 END END ELSE CASE WHEN ("ADS"."Feature_54" <= 1.2884083986282349) THEN 9 ELSE 10 END END AS node_id_2 
FROM "BinaryClass_100" AS "ADS"), 
"DT_node_data_6" AS 
(SELECT "Values".nid AS nid, "Values"."P_0" AS "P_0", "Values"."P_1" AS "P_1", "Values"."D" AS "D", "Values"."DP" AS "DP" 
...
FROM "DT_Output_6"), 
"DT_node_lookup_7" AS 
(SELECT "ADS"."KEY" AS "KEY", CASE WHEN ("ADS"."Feature_57" <= 0.13965497398748994) THEN CASE WHEN ("ADS"."Feature_60" <= -2.2802830934524536) THEN 2 ELSE CASE WHEN ("ADS"."Feature_71" <= -2.0478143095970154) THEN 4 ELSE CASE WHEN ("ADS"."Feature_23" <= -1.5142335295677185) THEN 6 ELSE CASE WHEN ("ADS"."Feature_75" <= 1.926939308643341) THEN 8 ELSE 9 END END END END ELSE CASE WHEN ("ADS"."Feature_22" <= -1.4835891723632812) THEN 11 ELSE CASE WHEN ("ADS"."Feature_83" <= 2.287528872489929) THEN 13 ELSE 14 END END END AS node_id_2 
FROM "BinaryClass_100" AS "ADS"), 
"DT_node_data_7" AS 
(SELECT "Values".nid AS nid, "Values"."P_0" AS "P_0", "Values"."P_1" AS "P_1", "Values"."D" AS "D", "Values"."DP" AS "DP" 
...
FROM "DT_Output_7"), 
"DT_node_lookup_8" AS 
(SELECT "ADS"."KEY" AS "KEY", CASE WHEN ("ADS"."Feature_57" <= 0.034406057093292475) THEN CASE WHEN ("ADS"."Feature_9" <= 1.7608928084373474) THEN CASE WHEN ("ADS"."Feature_17" <= 0.7869232892990112) THEN CASE WHEN ("ADS"."Feature_41" <= 2.0326545238494873) THEN 4 ELSE 5 END ELSE CASE WHEN ("ADS"."Feature_25" <= 0.5118834897875786) THEN 7 ELSE 8 END END ELSE 9 END ELSE CASE WHEN ("ADS"."Feature_18" <= 1.5096360445022583) THEN 11 ELSE 12 END END AS node_id_2 
FROM "BinaryClass_100" AS "ADS"), 
"DT_node_data_8" AS 
(SELECT "Values".nid AS nid, "Values"."P_0" AS "P_0", "Values"."P_1" AS "P_1", "Values"."D" AS "D", "Values"."DP" AS "DP" 
...
FROM "DT_Output_8"), 
"DT_node_lookup_9" AS 
(SELECT "ADS"."KEY" AS "KEY", CASE WHEN ("ADS"."Feature_57" <= -0.29480913281440735) THEN CASE WHEN ("ADS"."Feature_60" <= -2.6877256631851196) THEN 2 ELSE CASE WHEN ("ADS"."Feature_19" <= -1.5968449711799622) THEN 4 ELSE 5 END END ELSE CASE WHEN ("ADS"."Feature_64" <= -0.7019087076187134) THEN CASE WHEN ("ADS"."Feature_35" <= 0.6437470018863678) THEN 8 ELSE 9 END ELSE 10 END END AS node_id_2 
FROM "BinaryClass_100" AS "ADS"), 
"DT_node_data_9" AS 
(SELECT "Values".nid AS nid, "Values"."P_0" AS "P_0", "Values"."P_1" AS "P_1", "Values"."D" AS "D", "Values"."DP" AS "DP" 
...
FROM "DT_Output_9")
 INSERT INTO "TMP_20221008174717_0NPDJF0_BAG_B0" ("KEY", "Score_0", "Proba_0", "LogProba_0", "Score_1", "Proba_1", "LogProba_1") SELECT "T"."KEY", "T"."Score_0", "T"."Proba_0", "T"."LogProba_0", "T"."Score_1", "T"."Proba_1", "T"."LogProba_1" 
...
-- Code For temporary table TMP_20221008174717_XEP6T7Y_BAG_B1 part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221008174717_XEP6T7Y_BAG_B1" (
	"KEY" BIGINT, 
	"Score_0" FLOAT(53), 
	"Proba_0" FLOAT(53), 
	"LogProba_0" FLOAT(53), 
...
-- Code For temporary table TMP_20221008174717_XEP6T7Y_BAG_B1 part 2. Populate

WITH "DT_node_lookup_10" AS 
(SELECT "ADS"."KEY" AS "KEY", CASE WHEN ("ADS"."Feature_57" <= -0.27291035652160645) THEN CASE WHEN ("ADS"."Feature_71" <= -2.0478143095970154) THEN 2 ELSE CASE WHEN ("ADS"."Feature_17" <= 1.3175909519195557) THEN 4 ELSE 5 END END ELSE CASE WHEN ("ADS"."Feature_95" <= 1.350458800792694) THEN CASE WHEN ("ADS"."Feature_72" <= 1.9071441888809204) THEN 8 ELSE 9 END ELSE 10 END END AS node_id_2 
FROM "BinaryClass_100" AS "ADS"), 
"DT_node_data_10" AS 
(SELECT "Values".nid AS nid, "Values"."P_0" AS "P_0", "Values"."P_1" AS "P_1", "Values"."D" AS "D", "Values"."DP" AS "DP" 
...
(SELECT "ADS"."KEY" AS "KEY", CASE WHEN ("ADS"."Feature_57" <= 0.39694176614284515) THEN CASE WHEN ("ADS"."Feature_17" <= 0.7190659642219543) THEN CASE WHEN ("ADS"."Feature_51" <= 1.8602692484855652) THEN 3 ELSE CASE WHEN ("ADS"."Feature_70" <= 0.2369651235640049) THEN 5 ELSE 6 END END ELSE CASE WHEN ("ADS"."Feature_69" <= -0.01749846339225769) THEN 8 ELSE 9 END END ELSE 10 END AS node_id_2 
FROM "BinaryClass_100" AS "ADS"), 
"DT_node_data_11" AS 
(SELECT "Values".nid AS nid, "Values"."P_0" AS "P_0", "Values"."P_1" AS "P_1", "Values"."D" AS "D", "Values"."DP" AS "DP" 
FROM (SELECT 3 AS nid, 1.0 AS "P_0", 0.0 AS "P_1", 0 AS "D", 1.0 AS "DP" UNION ALL SELECT 5 AS nid, 0.0 AS "P_0", 1.0 AS "P_1", 1 AS "D", 1.0 AS "DP" UNION ALL SELECT 6 AS nid, 1.0 AS "P_0", 0.0 AS "P_1", 0 AS "D", 1.0 AS "DP" UNION ALL SELECT 8 AS nid, 0.0 AS "P_0", 1.0 AS "P_1", 1 AS "D", 1.0 AS "DP" UNION ALL SELECT 9 AS nid, 1.0 AS "P_0", 0.0 AS "P_1", 0 AS "D", 1.0 AS "DP" UNION ALL SELECT 10 AS nid, 0.0 AS "P_0", 1.0 AS "P_1", 1 AS "D", 1.0 AS "DP") AS "Values"), 
...
(SELECT "ADS"."KEY" AS "KEY", CASE WHEN ("ADS"."Feature_57" <= 0.5010480731725693) THEN CASE WHEN ("ADS"."Feature_60" <= -1.8520002961158752) THEN 2 ELSE CASE WHEN ("ADS"."Feature_51" <= 1.7062252163887024) THEN CASE WHEN ("ADS"."Feature_64" <= -2.027563691139221) THEN 5 ELSE CASE WHEN ("ADS"."Feature_80" <= -1.8407464027404785) THEN 7 ELSE 8 END END ELSE CASE WHEN ("ADS"."Feature_75" <= 0.6342926025390625) THEN 10 ELSE 11 END END END ELSE 12 END AS node_id_2 
FROM "BinaryClass_100" AS "ADS"), 
"DT_node_data_12" AS 
(SELECT "Values".nid AS nid, "Values"."P_0" AS "P_0", "Values"."P_1" AS "P_1", "Values"."D" AS "D", "Values"."DP" AS "DP" 
FROM (SELECT 2 AS nid, 0.0 AS "P_0", 1.0 AS "P_1", 1 AS "D", 1.0 AS "DP" UNION ALL SELECT 5 AS nid, 0.0 AS "P_0", 1.0 AS "P_1", 1 AS "D", 1.0 AS "DP" UNION ALL SELECT 7 AS nid, 0.0 AS "P_0", 1.0 AS "P_1", 1 AS "D", 1.0 AS "DP" UNION ALL SELECT 8 AS nid, 1.0 AS "P_0", 0.0 AS "P_1", 0 AS "D", 1.0 AS "DP" UNION ALL SELECT 10 AS nid, 0.0 AS "P_0", 1.0 AS "P_1", 1 AS "D", 1.0 AS "DP" UNION ALL SELECT 11 AS nid, 1.0 AS "P_0", 0.0 AS "P_1", 0 AS "D", 1.0 AS "DP" UNION ALL SELECT 12 AS nid, 0.0 AS "P_0", 1.0 AS "P_1", 1 AS "D", 1.0 AS "DP") AS "Values"), 
...
(SELECT "ADS"."KEY" AS "KEY", CASE WHEN ("ADS"."Feature_57" <= 0.13965497398748994) THEN CASE WHEN ("ADS"."Feature_30" <= 1.463697075843811) THEN CASE WHEN ("ADS"."Feature_49" <= -1.5997705459594727) THEN 3 ELSE 4 END ELSE CASE WHEN ("ADS"."Feature_68" <= 0.1339196264743805) THEN 6 ELSE 7 END END ELSE CASE WHEN ("ADS"."Feature_86" <= 1.2234047055244446) THEN 9 ELSE 10 END END AS node_id_2 
FROM "BinaryClass_100" AS "ADS"), 
"DT_node_data_13" AS 
(SELECT "Values".nid AS nid, "Values"."P_0" AS "P_0", "Values"."P_1" AS "P_1", "Values"."D" AS "D", "Values"."DP" AS "DP" 
FROM (SELECT 3 AS nid, 0.0 AS "P_0", 1.0 AS "P_1", 1 AS "D", 1.0 AS "DP" UNION ALL SELECT 4 AS nid, 1.0 AS "P_0", 0.0 AS "P_1", 0 AS "D", 1.0 AS "DP" UNION ALL SELECT 6 AS nid, 0.0 AS "P_0", 1.0 AS "P_1", 1 AS "D", 1.0 AS "DP" UNION ALL SELECT 7 AS nid, 1.0 AS "P_0", 0.0 AS "P_1", 0 AS "D", 1.0 AS "DP" UNION ALL SELECT 9 AS nid, 0.0 AS "P_0", 1.0 AS "P_1", 1 AS "D", 1.0 AS "DP" UNION ALL SELECT 10 AS nid, 1.0 AS "P_0", 0.0 AS "P_1", 0 AS "D", 1.0 AS "DP") AS "Values"), 
...
(SELECT "ADS"."KEY" AS "KEY", CASE WHEN ("ADS"."Feature_57" <= 0.034406057093292475) THEN CASE WHEN ("ADS"."Feature_37" <= 1.6109365820884705) THEN CASE WHEN ("ADS"."Feature_18" <= -1.1169933080673218) THEN CASE WHEN ("ADS"."Feature_85" <= 0.31230954825878143) THEN 4 ELSE 5 END ELSE 6 END ELSE 7 END ELSE CASE WHEN ("ADS"."Feature_47" <= -1.2036555707454681) THEN 9 ELSE 10 END END AS node_id_2 
FROM "BinaryClass_100" AS "ADS"), 
"DT_node_data_14" AS 
(SELECT "Values".nid AS nid, "Values"."P_0" AS "P_0", "Values"."P_1" AS "P_1", "Values"."D" AS "D", "Values"."DP" AS "DP" 
...
(SELECT "ADS"."KEY" AS "KEY", CASE WHEN ("ADS"."Feature_57" <= 0.034406057093292475) THEN CASE WHEN ("ADS"."Feature_60" <= -1.9799605011940002) THEN 2 ELSE CASE WHEN ("ADS"."Feature_35" <= 0.7426413297653198) THEN 4 ELSE CASE WHEN ("ADS"."Feature_1" <= 0.413994736969471) THEN 6 ELSE 7 END END END ELSE 8 END AS node_id_2 
FROM "BinaryClass_100" AS "ADS"), 
"DT_node_data_15" AS 
(SELECT "Values".nid AS nid, "Values"."P_0" AS "P_0", "Values"."P_1" AS "P_1", "Values"."D" AS "D", "Values"."DP" AS "DP" 
FROM (SELECT 2 AS nid, 0.0 AS "P_0", 1.0 AS "P_1", 1 AS "D", 1.0 AS "DP" UNION ALL SELECT 4 AS nid, 1.0 AS "P_0", 0.0 AS "P_1", 0 AS "D", 1.0 AS "DP" UNION ALL SELECT 6 AS nid, 0.0 AS "P_0", 1.0 AS "P_1", 1 AS "D", 1.0 AS "DP" UNION ALL SELECT 7 AS nid, 1.0 AS "P_0", 0.0 AS "P_1", 0 AS "D", 1.0 AS "DP" UNION ALL SELECT 8 AS nid, 0.0 AS "P_0", 1.0 AS "P_1", 1 AS "D", 1.0 AS "DP") AS "Values"), 
...
FROM "DT_Output_15")
 INSERT INTO "TMP_20221008174717_XEP6T7Y_BAG_B1" ("KEY", "Score_0", "Proba_0", "LogProba_0", "Score_1", "Proba_1", "LogProba_1") SELECT "T"."KEY", "T"."Score_0", "T"."Proba_0", "T"."LogProba_0", "T"."Score_1", "T"."Proba_1", "T"."LogProba_1" 
...
-- Code For temporary table TMP_20221008174717_F7SEFUR_BAG_avg part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221008174717_F7SEFUR_BAG_avg" (
	"KEY" BIGINT NOT NULL, 
	"Score_0" FLOAT(53), 
	"Proba_0" FLOAT(53), 
	"LogProba_0" FLOAT(53), 
...
-- Code For temporary table TMP_20221008174717_F7SEFUR_BAG_avg part 2. Populate
...
FROM (SELECT "BAG_B0"."KEY" AS "KEY", "BAG_B0"."Score_0" AS "Score_0", "BAG_B0"."Proba_0" AS "Proba_0", "BAG_B0"."LogProba_0" AS "LogProba_0", "BAG_B0"."Score_1" AS "Score_1", "BAG_B0"."Proba_1" AS "Proba_1", "BAG_B0"."LogProba_1" AS "LogProba_1" 
FROM "TMP_20221008174717_0NPDJF0_BAG_B0" AS "BAG_B0" UNION ALL SELECT "BAG_B1"."KEY" AS "KEY", "BAG_B1"."Score_0" AS "Score_0", "BAG_B1"."Proba_0" AS "Proba_0", "BAG_B1"."LogProba_0" AS "LogProba_0", "BAG_B1"."Score_1" AS "Score_1", "BAG_B1"."Proba_1" AS "Proba_1", "BAG_B1"."LogProba_1" AS "LogProba_1" 
FROM "TMP_20221008174717_XEP6T7Y_BAG_B1" AS "BAG_B1") AS "BAG_EnsembleUnion")
 INSERT INTO "TMP_20221008174717_F7SEFUR_BAG_avg" ("KEY", "Score_0", "Proba_0", "LogProba_0", "Score_1", "Proba_1", "LogProba_1") SELECT "T"."KEY", "T"."Score_0", "T"."Proba_0", "T"."LogProba_0", "T"."Score_1", "T"."Proba_1", "T"."LogProba_1" 
...
-- Code For temporary table TMP_20221008174717_F7SEFUR_BAG_avg part 3. Create Index 

CREATE INDEX "ix_TMP_20221008174717_F7SEFUR_BAG_avg_KEY" ON "TMP_20221008174717_F7SEFUR_BAG_avg" ("KEY")
...
FROM "TMP_20221008174717_F7SEFUR_BAG_avg" AS "BAG_avg"), 
