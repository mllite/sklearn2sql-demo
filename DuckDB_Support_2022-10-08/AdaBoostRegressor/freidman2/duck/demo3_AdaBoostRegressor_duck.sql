...
-- Code For temporary table TMP_20221008175236_MJN50OU_WE_B0 part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221008175236_MJN50OU_WE_B0" (
	"KEY" BIGINT, 
	"Estimator" FLOAT(53), 
	"Weight" FLOAT(53), 
	est_index BIGINT
...
-- Code For temporary table TMP_20221008175236_MJN50OU_WE_B0 part 2. Populate

WITH "DT_node_lookup" AS 
(SELECT "ADS"."KEY" AS "KEY", CASE WHEN ("ADS"."Feature_2" <= 0.5740115642547607) THEN CASE WHEN ("ADS"."Feature_2" <= 0.20348544418811798) THEN CASE WHEN ("ADS"."Feature_2" <= 0.1157732792198658) THEN 3 ELSE 4 END ELSE CASE WHEN ("ADS"."Feature_1" <= 1435.0574340820312) THEN 6 ELSE 7 END END ELSE CASE WHEN ("ADS"."Feature_1" <= 989.6936645507812) THEN CASE WHEN ("ADS"."Feature_3" <= 7.547978401184082) THEN 10 ELSE 11 END ELSE CASE WHEN ("ADS"."Feature_2" <= 0.6275076270103455) THEN 13 ELSE 14 END END END AS node_id_2 
...
FROM "DT_Output"), 
"DT_node_lookup_1" AS 
(SELECT "ADS"."KEY" AS "KEY", CASE WHEN ("ADS"."Feature_1" <= 882.4659118652344) THEN CASE WHEN ("ADS"."Feature_2" <= 0.5629530251026154) THEN CASE WHEN ("ADS"."Feature_3" <= 5.282727479934692) THEN 3 ELSE 4 END ELSE CASE WHEN ("ADS"."Feature_1" <= 602.7623901367188) THEN 6 ELSE 7 END END ELSE CASE WHEN ("ADS"."Feature_2" <= 0.3650708496570587) THEN CASE WHEN ("ADS"."Feature_1" <= 1654.1549072265625) THEN 10 ELSE 11 END ELSE CASE WHEN ("ADS"."Feature_2" <= 0.9767304956912994) THEN 13 ELSE 14 END END END AS node_id_2 
FROM freidman2 AS "ADS"), 
"DT_node_data_1" AS 
(SELECT "Values".nid AS nid, "Values"."E" AS "E" 
...
FROM "DT_Output_1"), 
"DT_node_lookup_2" AS 
(SELECT "ADS"."KEY" AS "KEY", CASE WHEN ("ADS"."Feature_1" <= 733.7292175292969) THEN CASE WHEN ("ADS"."Feature_2" <= 0.7902979552745819) THEN CASE WHEN ("ADS"."Feature_0" <= 67.72291946411133) THEN 3 ELSE 4 END ELSE CASE WHEN ("ADS"."Feature_0" <= 44.58634376525879) THEN 6 ELSE 7 END END ELSE CASE WHEN ("ADS"."Feature_2" <= 0.3474539518356323) THEN CASE WHEN ("ADS"."Feature_1" <= 1505.2271118164062) THEN 10 ELSE 11 END ELSE CASE WHEN ("ADS"."Feature_2" <= 0.7847770750522614) THEN 13 ELSE 14 END END END AS node_id_2 
FROM freidman2 AS "ADS"), 
"DT_node_data_2" AS 
(SELECT "Values".nid AS nid, "Values"."E" AS "E" 
...
FROM "DT_Output_2"), 
"DT_node_lookup_3" AS 
(SELECT "ADS"."KEY" AS "KEY", CASE WHEN ("ADS"."Feature_2" <= 0.7971992194652557) THEN CASE WHEN ("ADS"."Feature_2" <= 0.3094656765460968) THEN CASE WHEN ("ADS"."Feature_2" <= 0.11461476236581802) THEN 3 ELSE 4 END ELSE CASE WHEN ("ADS"."Feature_1" <= 781.071533203125) THEN 6 ELSE 7 END END ELSE CASE WHEN ("ADS"."Feature_1" <= 1257.4737548828125) THEN CASE WHEN ("ADS"."Feature_1" <= 691.4309997558594) THEN 10 ELSE 11 END ELSE CASE WHEN ("ADS"."Feature_0" <= 42.05487632751465) THEN 13 ELSE 14 END END END AS node_id_2 
FROM freidman2 AS "ADS"), 
"DT_node_data_3" AS 
(SELECT "Values".nid AS nid, "Values"."E" AS "E" 
...
FROM "DT_Output_4"), 
"DT_node_lookup_5" AS 
(SELECT "ADS"."KEY" AS "KEY", CASE WHEN ("ADS"."Feature_2" <= 0.49402187764644623) THEN CASE WHEN ("ADS"."Feature_2" <= 0.23534639179706573) THEN CASE WHEN ("ADS"."Feature_2" <= 0.1250449325889349) THEN 3 ELSE 4 END ELSE CASE WHEN ("ADS"."Feature_1" <= 795.8204956054688) THEN 6 ELSE 7 END END ELSE CASE WHEN ("ADS"."Feature_1" <= 1204.87109375) THEN CASE WHEN ("ADS"."Feature_1" <= 699.738037109375) THEN 10 ELSE 11 END ELSE CASE WHEN ("ADS"."Feature_3" <= 4.895366311073303) THEN 13 ELSE 14 END END END AS node_id_2 
FROM freidman2 AS "ADS"), 
"DT_node_data_5" AS 
(SELECT "Values".nid AS nid, "Values"."E" AS "E" 
...
FROM "DT_Output_5"), 
"DT_node_lookup_6" AS 
(SELECT "ADS"."KEY" AS "KEY", CASE WHEN ("ADS"."Feature_1" <= 821.2744140625) THEN CASE WHEN ("ADS"."Feature_1" <= 490.12159729003906) THEN CASE WHEN ("ADS"."Feature_2" <= 0.7377969324588776) THEN 3 ELSE 4 END ELSE CASE WHEN ("ADS"."Feature_2" <= 0.45806238055229187) THEN 6 ELSE 7 END END ELSE CASE WHEN ("ADS"."Feature_2" <= 0.379633828997612) THEN CASE WHEN ("ADS"."Feature_2" <= 0.15311922132968903) THEN 10 ELSE 11 END ELSE CASE WHEN ("ADS"."Feature_2" <= 0.6275076270103455) THEN 13 ELSE 14 END END END AS node_id_2 
FROM freidman2 AS "ADS"), 
"DT_node_data_6" AS 
(SELECT "Values".nid AS nid, "Values"."E" AS "E" 
...
FROM "DT_Output_6"), 
"DT_node_lookup_7" AS 
(SELECT "ADS"."KEY" AS "KEY", CASE WHEN ("ADS"."Feature_1" <= 759.8154907226562) THEN CASE WHEN ("ADS"."Feature_1" <= 508.06446838378906) THEN CASE WHEN ("ADS"."Feature_2" <= 0.8158445060253143) THEN 3 ELSE 4 END ELSE CASE WHEN ("ADS"."Feature_0" <= 56.61892127990723) THEN 6 ELSE 7 END END ELSE CASE WHEN ("ADS"."Feature_2" <= 0.4603971689939499) THEN CASE WHEN ("ADS"."Feature_2" <= 0.379633828997612) THEN 10 ELSE 11 END ELSE CASE WHEN ("ADS"."Feature_2" <= 0.9767304956912994) THEN 13 ELSE 14 END END END AS node_id_2 
FROM freidman2 AS "ADS"), 
"DT_node_data_7" AS 
(SELECT "Values".nid AS nid, "Values"."E" AS "E" 
...
FROM "DT_Output_7"), 
"DT_node_lookup_8" AS 
(SELECT "ADS"."KEY" AS "KEY", CASE WHEN ("ADS"."Feature_2" <= 0.4695979952812195) THEN CASE WHEN ("ADS"."Feature_0" <= 9.954854011535645) THEN CASE WHEN ("ADS"."Feature_3" <= 6.127349019050598) THEN 3 ELSE 4 END ELSE CASE WHEN ("ADS"."Feature_0" <= 41.031734466552734) THEN 6 ELSE 7 END END ELSE CASE WHEN ("ADS"."Feature_1" <= 1217.648193359375) THEN CASE WHEN ("ADS"."Feature_1" <= 541.9518432617188) THEN 10 ELSE 11 END ELSE CASE WHEN ("ADS"."Feature_2" <= 0.7863079011440277) THEN 13 ELSE 14 END END END AS node_id_2 
FROM freidman2 AS "ADS"), 
"DT_node_data_8" AS 
(SELECT "Values".nid AS nid, "Values"."E" AS "E" 
...
FROM "DT_Output_8"), 
"DT_node_lookup_9" AS 
(SELECT "ADS"."KEY" AS "KEY", CASE WHEN ("ADS"."Feature_1" <= 882.4659118652344) THEN CASE WHEN ("ADS"."Feature_1" <= 640.1313781738281) THEN CASE WHEN ("ADS"."Feature_2" <= 0.8934462666511536) THEN 3 ELSE 4 END ELSE CASE WHEN ("ADS"."Feature_0" <= 61.53804397583008) THEN 6 ELSE 7 END END ELSE CASE WHEN ("ADS"."Feature_2" <= 0.7480506300926208) THEN CASE WHEN ("ADS"."Feature_2" <= 0.4603971689939499) THEN 10 ELSE 11 END ELSE CASE WHEN ("ADS"."Feature_1" <= 1355.5012817382812) THEN 13 ELSE 14 END END END AS node_id_2 
FROM freidman2 AS "ADS"), 
"DT_node_data_9" AS 
(SELECT "Values".nid AS nid, "Values"."E" AS "E" 
...
FROM "DT_Output_9")
 INSERT INTO "TMP_20221008175236_MJN50OU_WE_B0" ("KEY", "Estimator", "Weight", est_index) SELECT "T"."KEY", "T"."Estimator", "T"."Weight", "T".est_index 
...
-- Code For temporary table TMP_20221008175236_VXCAZWY_WE_B1 part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221008175236_VXCAZWY_WE_B1" (
	"KEY" BIGINT, 
	"Estimator" FLOAT(53), 
	"Weight" FLOAT(53), 
	est_index BIGINT
...
-- Code For temporary table TMP_20221008175236_VXCAZWY_WE_B1 part 2. Populate

WITH "DT_node_lookup_10" AS 
(SELECT "ADS"."KEY" AS "KEY", CASE WHEN ("ADS"."Feature_2" <= 0.7971992194652557) THEN CASE WHEN ("ADS"."Feature_2" <= 0.5180632621049881) THEN CASE WHEN ("ADS"."Feature_0" <= 43.33730888366699) THEN 3 ELSE 4 END ELSE CASE WHEN ("ADS"."Feature_1" <= 1209.0945434570312) THEN 6 ELSE 7 END END ELSE CASE WHEN ("ADS"."Feature_1" <= 905.7357177734375) THEN CASE WHEN ("ADS"."Feature_0" <= 21.019400775432587) THEN 10 ELSE 11 END ELSE CASE WHEN ("ADS"."Feature_3" <= 5.701060771942139) THEN 13 ELSE 14 END END END AS node_id_2 
FROM freidman2 AS "ADS"), 
"DT_node_data_10" AS 
(SELECT "Values".nid AS nid, "Values"."E" AS "E" 
...
(SELECT "ADS"."KEY" AS "KEY", CASE WHEN ("ADS"."Feature_1" <= 766.9922180175781) THEN CASE WHEN ("ADS"."Feature_1" <= 213.69110107421875) THEN CASE WHEN ("ADS"."Feature_2" <= 0.4941694736480713) THEN 3 ELSE 4 END ELSE CASE WHEN ("ADS"."Feature_0" <= 4.569775339215994) THEN 6 ELSE 7 END END ELSE CASE WHEN ("ADS"."Feature_2" <= 0.5930038094520569) THEN CASE WHEN ("ADS"."Feature_2" <= 0.288340300321579) THEN 10 ELSE 11 END ELSE CASE WHEN ("ADS"."Feature_1" <= 1121.5556030273438) THEN 13 ELSE 14 END END END AS node_id_2 
FROM freidman2 AS "ADS"), 
"DT_node_data_11" AS 
(SELECT "Values".nid AS nid, "Values"."E" AS "E" 
...
(SELECT "ADS"."KEY" AS "KEY", CASE WHEN ("ADS"."Feature_2" <= 0.6791707277297974) THEN CASE WHEN ("ADS"."Feature_2" <= 0.37775541841983795) THEN CASE WHEN ("ADS"."Feature_2" <= 0.1157732792198658) THEN 3 ELSE 4 END ELSE CASE WHEN ("ADS"."Feature_1" <= 1313.6138916015625) THEN 6 ELSE 7 END END ELSE CASE WHEN ("ADS"."Feature_1" <= 1121.5556030273438) THEN CASE WHEN ("ADS"."Feature_1" <= 384.6835403442383) THEN 10 ELSE 11 END ELSE CASE WHEN ("ADS"."Feature_3" <= 8.24548888206482) THEN 13 ELSE 14 END END END AS node_id_2 
FROM freidman2 AS "ADS"), 
"DT_node_data_12" AS 
(SELECT "Values".nid AS nid, "Values"."E" AS "E" 
...
(SELECT "ADS"."KEY" AS "KEY", CASE WHEN ("ADS"."Feature_1" <= 943.0731811523438) THEN CASE WHEN ("ADS"."Feature_1" <= 490.12159729003906) THEN CASE WHEN ("ADS"."Feature_2" <= 0.8033285439014435) THEN 3 ELSE 4 END ELSE CASE WHEN ("ADS"."Feature_2" <= 0.44081856310367584) THEN 6 ELSE 7 END END ELSE CASE WHEN ("ADS"."Feature_2" <= 0.6275076270103455) THEN CASE WHEN ("ADS"."Feature_2" <= 0.18252205848693848) THEN 10 ELSE 11 END ELSE CASE WHEN ("ADS"."Feature_1" <= 1283.81982421875) THEN 13 ELSE 14 END END END AS node_id_2 
FROM freidman2 AS "ADS"), 
"DT_node_data_13" AS 
(SELECT "Values".nid AS nid, "Values"."E" AS "E" 
...
(SELECT "ADS"."KEY" AS "KEY", CASE WHEN ("ADS"."Feature_2" <= 0.792053759098053) THEN CASE WHEN ("ADS"."Feature_1" <= 576.3799133300781) THEN CASE WHEN ("ADS"."Feature_1" <= 273.5360412597656) THEN 3 ELSE 4 END ELSE CASE WHEN ("ADS"."Feature_2" <= 0.3869176059961319) THEN 6 ELSE 7 END END ELSE CASE WHEN ("ADS"."Feature_1" <= 1023.0302429199219) THEN CASE WHEN ("ADS"."Feature_3" <= 8.592648983001709) THEN 10 ELSE 11 END ELSE CASE WHEN ("ADS"."Feature_3" <= 9.706490516662598) THEN 13 ELSE 14 END END END AS node_id_2 
FROM freidman2 AS "ADS"), 
"DT_node_data_14" AS 
(SELECT "Values".nid AS nid, "Values"."E" AS "E" 
...
(SELECT "ADS"."KEY" AS "KEY", CASE WHEN ("ADS"."Feature_1" <= 967.7061157226562) THEN CASE WHEN ("ADS"."Feature_1" <= 541.9518432617188) THEN CASE WHEN ("ADS"."Feature_2" <= 0.4498526155948639) THEN 3 ELSE 4 END ELSE CASE WHEN ("ADS"."Feature_3" <= 4.368488848209381) THEN 6 ELSE 7 END END ELSE CASE WHEN ("ADS"."Feature_2" <= 0.5975654423236847) THEN CASE WHEN ("ADS"."Feature_2" <= 0.2865905463695526) THEN 10 ELSE 11 END ELSE CASE WHEN ("ADS"."Feature_3" <= 9.706490516662598) THEN 13 ELSE 14 END END END AS node_id_2 
FROM freidman2 AS "ADS"), 
"DT_node_data_15" AS 
(SELECT "Values".nid AS nid, "Values"."E" AS "E" 
...
FROM "DT_Output_15")
 INSERT INTO "TMP_20221008175236_VXCAZWY_WE_B1" ("KEY", "Estimator", "Weight", est_index) SELECT "T"."KEY", "T"."Estimator", "T"."Weight", "T".est_index 
...
-- Code For temporary table TMP_20221008175236_0R9AJ2Z_Quantiles part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221008175236_0R9AJ2Z_Quantiles" (
	"KEY" BIGINT, 
	"Quantile" FLOAT(53)
)
...
-- Code For temporary table TMP_20221008175236_0R9AJ2Z_Quantiles part 2. Populate
...
FROM (SELECT "WE_B0"."KEY" AS "KEY", "WE_B0"."Estimator" AS "Estimator", "WE_B0"."Weight" AS "Weight", "WE_B0".est_index AS est_index 
FROM "TMP_20221008175236_MJN50OU_WE_B0" AS "WE_B0" UNION ALL SELECT "WE_B1"."KEY" AS "KEY", "WE_B1"."Estimator" AS "Estimator", "WE_B1"."Weight" AS "Weight", "WE_B1".est_index AS est_index 
FROM "TMP_20221008175236_VXCAZWY_WE_B1" AS "WE_B1") AS "WE_EnsembleUnion"), 
...
WHERE u1."Estimator" >= u2."Estimator" AND u1."KEY" = u2."KEY" GROUP BY u1."KEY", u1.est_index, u1."Estimator", u1."Weight") AS "CW")
 INSERT INTO "TMP_20221008175236_0R9AJ2Z_Quantiles" ("KEY", "Quantile") SELECT "T"."KEY", "T"."Quantile" 
...
FROM "TMP_20221008175236_0R9AJ2Z_Quantiles" AS "Quantiles"