...
-- Code For temporary table TMP_20221008174924_VIS7B71_WE_B0 part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221008174924_VIS7B71_WE_B0" (
	"KEY" BIGINT, 
	"Estimator" FLOAT(53), 
	"Weight" FLOAT(53), 
	est_index BIGINT
...
-- Code For temporary table TMP_20221008174924_VIS7B71_WE_B0 part 2. Populate

WITH "DT_node_lookup" AS 
(SELECT "ADS"."KEY" AS "KEY", CASE WHEN ("ADS"."Feature_4" <= -1.0891695022583008) THEN CASE WHEN ("ADS"."Feature_2" <= 1.1153224408626556) THEN CASE WHEN ("ADS"."Feature_4" <= -1.2480316162109375) THEN 3 ELSE 4 END ELSE 5 END ELSE CASE WHEN ("ADS"."Feature_2" <= 0.2621008902788162) THEN CASE WHEN ("ADS"."Feature_7" <= 0.7516303062438965) THEN 8 ELSE 9 END ELSE CASE WHEN ("ADS"."Feature_5" <= -0.8153923749923706) THEN 11 ELSE 12 END END END AS node_id_2 
...
FROM "DT_Output"), 
"DT_node_lookup_1" AS 
(SELECT "ADS"."KEY" AS "KEY", CASE WHEN ("ADS"."Feature_2" <= 0.4864888936281204) THEN CASE WHEN ("ADS"."Feature_5" <= 0.3544403612613678) THEN CASE WHEN ("ADS"."Feature_3" <= 0.17893501371145248) THEN 3 ELSE 4 END ELSE CASE WHEN ("ADS"."Feature_8" <= 1.4059425592422485) THEN 6 ELSE 7 END END ELSE CASE WHEN ("ADS"."Feature_8" <= -0.1578926146030426) THEN CASE WHEN ("ADS"."Feature_1" <= -0.07556744664907455) THEN 10 ELSE 11 END ELSE CASE WHEN ("ADS"."Feature_1" <= -0.6555853486061096) THEN 13 ELSE 14 END END END AS node_id_2 
FROM "RandomReg_10" AS "ADS"), 
"DT_node_data_1" AS 
(SELECT "Values".nid AS nid, "Values"."E" AS "E" 
...
FROM "DT_Output_1"), 
"DT_node_lookup_2" AS 
(SELECT "ADS"."KEY" AS "KEY", CASE WHEN ("ADS"."Feature_1" <= -0.4697559326887131) THEN CASE WHEN ("ADS"."Feature_5" <= -0.45080168545246124) THEN CASE WHEN ("ADS"."Feature_7" <= 1.1767406463623047) THEN 3 ELSE 4 END ELSE CASE WHEN ("ADS"."Feature_9" <= 0.5868625640869141) THEN 6 ELSE 7 END END ELSE CASE WHEN ("ADS"."Feature_8" <= -0.2579100653529167) THEN CASE WHEN ("ADS"."Feature_6" <= -0.23099666088819504) THEN 10 ELSE 11 END ELSE CASE WHEN ("ADS"."Feature_2" <= -0.3419182002544403) THEN 13 ELSE 14 END END END AS node_id_2 
FROM "RandomReg_10" AS "ADS"), 
"DT_node_data_2" AS 
(SELECT "Values".nid AS nid, "Values"."E" AS "E" 
...
FROM "DT_Output_2"), 
"DT_node_lookup_3" AS 
(SELECT "ADS"."KEY" AS "KEY", CASE WHEN ("ADS"."Feature_8" <= -0.3908981829881668) THEN CASE WHEN ("ADS"."Feature_2" <= 0.4633442908525467) THEN CASE WHEN ("ADS"."Feature_1" <= -1.1535027623176575) THEN 3 ELSE 4 END ELSE CASE WHEN ("ADS"."Feature_1" <= -0.08621718734502792) THEN 6 ELSE 7 END END ELSE CASE WHEN ("ADS"."Feature_5" <= -0.6248867809772491) THEN CASE WHEN ("ADS"."Feature_3" <= 1.9320313334465027) THEN 10 ELSE 11 END ELSE CASE WHEN ("ADS"."Feature_0" <= 1.1636798977851868) THEN 13 ELSE 14 END END END AS node_id_2 
FROM "RandomReg_10" AS "ADS"), 
"DT_node_data_3" AS 
(SELECT "Values".nid AS nid, "Values"."E" AS "E" 
...
FROM "DT_Output_3"), 
"DT_node_lookup_4" AS 
(SELECT "ADS"."KEY" AS "KEY", CASE WHEN ("ADS"."Feature_8" <= -0.40658096969127655) THEN CASE WHEN ("ADS"."Feature_5" <= 0.07830402627587318) THEN CASE WHEN ("ADS"."Feature_1" <= -0.11090748757123947) THEN 3 ELSE 4 END ELSE CASE WHEN ("ADS"."Feature_2" <= 0.08110732398927212) THEN 6 ELSE 7 END END ELSE CASE WHEN ("ADS"."Feature_4" <= -0.2370140254497528) THEN CASE WHEN ("ADS"."Feature_1" <= -0.3367226719856262) THEN 10 ELSE 11 END ELSE CASE WHEN ("ADS"."Feature_2" <= -0.3947802037000656) THEN 13 ELSE 14 END END END AS node_id_2 
FROM "RandomReg_10" AS "ADS"), 
"DT_node_data_4" AS 
(SELECT "Values".nid AS nid, "Values"."E" AS "E" 
...
FROM "DT_Output_4"), 
"DT_node_lookup_5" AS 
(SELECT "ADS"."KEY" AS "KEY", CASE WHEN ("ADS"."Feature_2" <= 0.8179076910018921) THEN CASE WHEN ("ADS"."Feature_5" <= -0.5199595391750336) THEN CASE WHEN ("ADS"."Feature_3" <= -0.7357114851474762) THEN 3 ELSE 4 END ELSE CASE WHEN ("ADS"."Feature_8" <= -0.10979260504245758) THEN 6 ELSE 7 END END ELSE CASE WHEN ("ADS"."Feature_8" <= -0.9346989989280701) THEN CASE WHEN ("ADS"."Feature_6" <= -0.5757330991327763) THEN 10 ELSE 11 END ELSE CASE WHEN ("ADS"."Feature_9" <= -0.9260942675173283) THEN 13 ELSE 14 END END END AS node_id_2 
FROM "RandomReg_10" AS "ADS"), 
"DT_node_data_5" AS 
(SELECT "Values".nid AS nid, "Values"."E" AS "E" 
...
FROM "DT_Output_5"), 
"DT_node_lookup_6" AS 
(SELECT "ADS"."KEY" AS "KEY", CASE WHEN ("ADS"."Feature_4" <= -0.18378066644072533) THEN CASE WHEN ("ADS"."Feature_3" <= -1.010669469833374) THEN CASE WHEN ("ADS"."Feature_2" <= -0.47532065212726593) THEN 3 ELSE 4 END ELSE CASE WHEN ("ADS"."Feature_6" <= 1.7505338788032532) THEN 6 ELSE 7 END END ELSE CASE WHEN ("ADS"."Feature_0" <= 1.1636798977851868) THEN CASE WHEN ("ADS"."Feature_2" <= 0.3587885946035385) THEN 10 ELSE 11 END ELSE CASE WHEN ("ADS"."Feature_0" <= 1.7519553899765015) THEN 13 ELSE 14 END END END AS node_id_2 
FROM "RandomReg_10" AS "ADS"), 
"DT_node_data_6" AS 
(SELECT "Values".nid AS nid, "Values"."E" AS "E" 
...
FROM "DT_Output_7"), 
"DT_node_lookup_8" AS 
(SELECT "ADS"."KEY" AS "KEY", CASE WHEN ("ADS"."Feature_2" <= 0.5715910494327545) THEN CASE WHEN ("ADS"."Feature_7" <= 0.8521278202533722) THEN CASE WHEN ("ADS"."Feature_3" <= -1.010669469833374) THEN 3 ELSE 4 END ELSE CASE WHEN ("ADS"."Feature_0" <= 0.8501834869384766) THEN 6 ELSE 7 END END ELSE CASE WHEN ("ADS"."Feature_3" <= -0.32709718495607376) THEN CASE WHEN ("ADS"."Feature_9" <= 0.3016137555241585) THEN 10 ELSE 11 END ELSE CASE WHEN ("ADS"."Feature_4" <= 0.4357970207929611) THEN 13 ELSE 14 END END END AS node_id_2 
FROM "RandomReg_10" AS "ADS"), 
"DT_node_data_8" AS 
(SELECT "Values".nid AS nid, "Values"."E" AS "E" 
...
FROM "DT_Output_8"), 
"DT_node_lookup_9" AS 
(SELECT "ADS"."KEY" AS "KEY", CASE WHEN ("ADS"."Feature_4" <= -1.05837482213974) THEN CASE WHEN ("ADS"."Feature_8" <= 0.6914758682250977) THEN CASE WHEN ("ADS"."Feature_6" <= -0.5308328419923782) THEN 3 ELSE 4 END ELSE CASE WHEN ("ADS"."Feature_1" <= 0.23885726928710938) THEN 6 ELSE 7 END END ELSE CASE WHEN ("ADS"."Feature_2" <= 0.6059607565402985) THEN CASE WHEN ("ADS"."Feature_5" <= -0.6670668423175812) THEN 10 ELSE 11 END ELSE CASE WHEN ("ADS"."Feature_4" <= 1.6530185341835022) THEN 13 ELSE 14 END END END AS node_id_2 
FROM "RandomReg_10" AS "ADS"), 
"DT_node_data_9" AS 
(SELECT "Values".nid AS nid, "Values"."E" AS "E" 
...
FROM "DT_Output_9")
 INSERT INTO "TMP_20221008174924_VIS7B71_WE_B0" ("KEY", "Estimator", "Weight", est_index) SELECT "T"."KEY", "T"."Estimator", "T"."Weight", "T".est_index 
...
-- Code For temporary table TMP_20221008174924_7D7FAV4_WE_B1 part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221008174924_7D7FAV4_WE_B1" (
	"KEY" BIGINT, 
	"Estimator" FLOAT(53), 
	"Weight" FLOAT(53), 
	est_index BIGINT
...
-- Code For temporary table TMP_20221008174924_7D7FAV4_WE_B1 part 2. Populate

WITH "DT_node_lookup_10" AS 
(SELECT "ADS"."KEY" AS "KEY", CASE WHEN ("ADS"."Feature_5" <= -0.6693825721740723) THEN CASE WHEN ("ADS"."Feature_2" <= 0.8371067941188812) THEN CASE WHEN ("ADS"."Feature_4" <= -0.5533334314823151) THEN 3 ELSE 4 END ELSE 5 END ELSE CASE WHEN ("ADS"."Feature_8" <= -0.14717379212379456) THEN CASE WHEN ("ADS"."Feature_2" <= 1.10337233543396) THEN 8 ELSE 9 END ELSE CASE WHEN ("ADS"."Feature_8" <= 1.25929594039917) THEN 11 ELSE 12 END END END AS node_id_2 
FROM "RandomReg_10" AS "ADS"), 
"DT_node_data_10" AS 
(SELECT "Values".nid AS nid, "Values"."E" AS "E" 
...
(SELECT "ADS"."KEY" AS "KEY", CASE WHEN ("ADS"."Feature_5" <= 0.2265688106417656) THEN CASE WHEN ("ADS"."Feature_3" <= -0.4326603412628174) THEN CASE WHEN ("ADS"."Feature_5" <= -0.7803284227848053) THEN 3 ELSE 4 END ELSE CASE WHEN ("ADS"."Feature_4" <= -0.9640567898750305) THEN 6 ELSE 7 END END ELSE CASE WHEN ("ADS"."Feature_8" <= -0.18978770077228546) THEN CASE WHEN ("ADS"."Feature_2" <= 0.4633442908525467) THEN 10 ELSE 11 END ELSE CASE WHEN ("ADS"."Feature_0" <= 1.1356269121170044) THEN 13 ELSE 14 END END END AS node_id_2 
FROM "RandomReg_10" AS "ADS"), 
"DT_node_data_11" AS 
(SELECT "Values".nid AS nid, "Values"."E" AS "E" 
...
(SELECT "ADS"."KEY" AS "KEY", CASE WHEN ("ADS"."Feature_4" <= -1.0482117533683777) THEN CASE WHEN ("ADS"."Feature_8" <= 0.4848606586456299) THEN CASE WHEN ("ADS"."Feature_8" <= 0.12232283083721995) THEN 3 ELSE 4 END ELSE CASE WHEN ("ADS"."Feature_1" <= 0.23885726928710938) THEN 6 ELSE 7 END END ELSE CASE WHEN ("ADS"."Feature_0" <= 1.1701385974884033) THEN CASE WHEN ("ADS"."Feature_2" <= 0.7659631967544556) THEN 10 ELSE 11 END ELSE CASE WHEN ("ADS"."Feature_4" <= 0.03275360632687807) THEN 13 ELSE 14 END END END AS node_id_2 
FROM "RandomReg_10" AS "ADS"), 
"DT_node_data_12" AS 
(SELECT "Values".nid AS nid, "Values"."E" AS "E" 
...
(SELECT "ADS"."KEY" AS "KEY", CASE WHEN ("ADS"."Feature_1" <= -0.30988679826259613) THEN CASE WHEN ("ADS"."Feature_5" <= 0.26793916523456573) THEN CASE WHEN ("ADS"."Feature_3" <= 0.6469280496239662) THEN 3 ELSE 4 END ELSE CASE WHEN ("ADS"."Feature_7" <= 1.5143302083015442) THEN 6 ELSE 7 END END ELSE CASE WHEN ("ADS"."Feature_0" <= 0.8908569812774658) THEN CASE WHEN ("ADS"."Feature_2" <= 0.28035256266593933) THEN 10 ELSE 11 END ELSE CASE WHEN ("ADS"."Feature_4" <= 1.9032750129699707) THEN 13 ELSE 14 END END END AS node_id_2 
FROM "RandomReg_10" AS "ADS"), 
"DT_node_data_13" AS 
(SELECT "Values".nid AS nid, "Values"."E" AS "E" 
...
(SELECT "ADS"."KEY" AS "KEY", CASE WHEN ("ADS"."Feature_8" <= -0.20833948999643326) THEN CASE WHEN ("ADS"."Feature_2" <= 0.4633442908525467) THEN CASE WHEN ("ADS"."Feature_5" <= -0.3632190926000476) THEN 3 ELSE 4 END ELSE CASE WHEN ("ADS"."Feature_4" <= -0.875508040189743) THEN 6 ELSE 7 END END ELSE CASE WHEN ("ADS"."Feature_0" <= 1.7519553899765015) THEN CASE WHEN ("ADS"."Feature_5" <= -0.7618716061115265) THEN 10 ELSE 11 END ELSE CASE WHEN ("ADS"."Feature_1" <= 0.25780532509088516) THEN 13 ELSE 14 END END END AS node_id_2 
FROM "RandomReg_10" AS "ADS"), 
"DT_node_data_14" AS 
(SELECT "Values".nid AS nid, "Values"."E" AS "E" 
...
(SELECT "ADS"."KEY" AS "KEY", CASE WHEN ("ADS"."Feature_8" <= 0.6005938053131104) THEN CASE WHEN ("ADS"."Feature_5" <= -0.6158618032932281) THEN CASE WHEN ("ADS"."Feature_7" <= 0.014229899737983942) THEN 3 ELSE 4 END ELSE CASE WHEN ("ADS"."Feature_8" <= -0.1578926146030426) THEN 6 ELSE 7 END END ELSE CASE WHEN ("ADS"."Feature_4" <= -0.8022096157073975) THEN CASE WHEN ("ADS"."Feature_7" <= -0.1096474900841713) THEN 10 ELSE 11 END ELSE CASE WHEN ("ADS"."Feature_3" <= -0.8659503608942032) THEN 13 ELSE 14 END END END AS node_id_2 
FROM "RandomReg_10" AS "ADS"), 
"DT_node_data_15" AS 
(SELECT "Values".nid AS nid, "Values"."E" AS "E" 
...
FROM "DT_Output_15")
 INSERT INTO "TMP_20221008174924_7D7FAV4_WE_B1" ("KEY", "Estimator", "Weight", est_index) SELECT "T"."KEY", "T"."Estimator", "T"."Weight", "T".est_index 
...
-- Code For temporary table TMP_20221008174924_7J08WTL_Quantiles part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221008174924_7J08WTL_Quantiles" (
	"KEY" BIGINT, 
	"Quantile" FLOAT(53)
)
...
-- Code For temporary table TMP_20221008174924_7J08WTL_Quantiles part 2. Populate
...
FROM (SELECT "WE_B0"."KEY" AS "KEY", "WE_B0"."Estimator" AS "Estimator", "WE_B0"."Weight" AS "Weight", "WE_B0".est_index AS est_index 
FROM "TMP_20221008174924_VIS7B71_WE_B0" AS "WE_B0" UNION ALL SELECT "WE_B1"."KEY" AS "KEY", "WE_B1"."Estimator" AS "Estimator", "WE_B1"."Weight" AS "Weight", "WE_B1".est_index AS est_index 
FROM "TMP_20221008174924_7D7FAV4_WE_B1" AS "WE_B1") AS "WE_EnsembleUnion"), 
...
WHERE u1."Estimator" >= u2."Estimator" AND u1."KEY" = u2."KEY" GROUP BY u1."KEY", u1.est_index, u1."Estimator", u1."Weight") AS "CW")
 INSERT INTO "TMP_20221008174924_7J08WTL_Quantiles" ("KEY", "Quantile") SELECT "T"."KEY", "T"."Quantile" 
...
FROM "TMP_20221008174924_7J08WTL_Quantiles" AS "Quantiles"