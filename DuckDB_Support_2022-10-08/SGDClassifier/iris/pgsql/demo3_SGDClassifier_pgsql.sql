...
FROM iris AS "ADS"), 
linear_model_cte AS 
(SELECT linear_input."KEY" AS "KEY", 5.4377379010331435 * linear_input."Feature_0" + 17.94453507340937 * linear_input."Feature_1" + -39.15171288743861 * linear_input."Feature_2" + -20.119630233822626 * linear_input."Feature_3" + 9.831866211321643 AS "Score_0", 20.48501280313276 * linear_input."Feature_0" + -85.555053471908 * linear_input."Feature_1" + 35.24627202892008 * linear_input."Feature_2" + -83.14505196565706 * linear_input."Feature_3" + 125.21739170818942 AS "Score_1", -119.44755505785692 * linear_input."Feature_0" + -100.03732736095522 * linear_input."Feature_1" + 186.2635311683454 * linear_input."Feature_2" + 149.68271743187688 * linear_input."Feature_3" + -108.8280753093305 AS "Score_2" 
FROM linear_input), 
