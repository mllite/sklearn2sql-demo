...
-- Code For temporary table TMP_20221008175441_U6VR9PB_NaiveBayes_Scores part 1. Create 


CREATE TEMPORARY TABLE "TMP_20221008175441_U6VR9PB_NaiveBayes_Scores" (
	"KEY" BIGINT NOT NULL, 
	"Score_CLASS_0" FLOAT, 
	"Score_CLASS_1" FLOAT, 
	"Score_CLASS_2" FLOAT, 
...
-- Code For temporary table TMP_20221008175441_U6VR9PB_NaiveBayes_Scores part 2. Populate

WITH centered_data AS 
(SELECT "ADS"."KEY" AS "KEY", CAST("ADS"."Feature_0" AS FLOAT(53)) - 4.95945945945946 AS "Feature_0_CLASS_0", CAST("ADS"."Feature_1" AS FLOAT(53)) - 3.42972972972973 AS "Feature_1_CLASS_0", CAST("ADS"."Feature_2" AS FLOAT(53)) - 1.4837837837837833 AS "Feature_2_CLASS_0", CAST("ADS"."Feature_3" AS FLOAT(53)) - 0.26216216216216226 AS "Feature_3_CLASS_0", CAST("ADS"."Feature_0" AS FLOAT(53)) - 5.914999999999999 AS "Feature_0_CLASS_1", CAST("ADS"."Feature_1" AS FLOAT(53)) - 2.7600000000000007 AS "Feature_1_CLASS_1", CAST("ADS"."Feature_2" AS FLOAT(53)) - 4.245 AS "Feature_2_CLASS_1", CAST("ADS"."Feature_3" AS FLOAT(53)) - 1.325 AS "Feature_3_CLASS_1", CAST("ADS"."Feature_0" AS FLOAT(53)) - 6.548837209302325 AS "Feature_0_CLASS_2", CAST("ADS"."Feature_1" AS FLOAT(53)) - 2.9674418604651165 AS "Feature_1_CLASS_2", CAST("ADS"."Feature_2" AS FLOAT(53)) - 5.502325581395348 AS "Feature_2_CLASS_2", CAST("ADS"."Feature_3" AS FLOAT(53)) - 2.01860465116279 AS "Feature_3_CLASS_2" 
...
FROM centered_data) AS "Values")
 INSERT INTO "TMP_20221008175441_U6VR9PB_NaiveBayes_Scores" ("KEY", "Score_CLASS_0", "Score_CLASS_1", "Score_CLASS_2") SELECT "T"."KEY", "T"."Score_CLASS_0", "T"."Score_CLASS_1", "T"."Score_CLASS_2" 
...
-- Code For temporary table TMP_20221008175441_U6VR9PB_NaiveBayes_Scores part 3. Create Index 

CREATE INDEX "ix_TMP_20221008175441_U6VR9PB_NaiveBayes_Scores_KEY" ON "TMP_20221008175441_U6VR9PB_NaiveBayes_Scores" ("KEY")
...
FROM "TMP_20221008175441_U6VR9PB_NaiveBayes_Scores" AS "NaiveBayes_Scores"), 
