...
(SELECT `multinomial_cte`.`KEY` AS `KEY`, 0.64 AS `Proba_0`, CASE WHEN (0.64 IS NULL OR 0.64 > 0.0) THEN log(0.64) ELSE -1.79769313486231e+308 END AS `LogProba_0`, 0.36 AS `Proba_1`, CASE WHEN (0.36 IS NULL OR 0.36 > 0.0) THEN log(0.36) ELSE -1.79769313486231e+308 END AS `LogProba_1`, `multinomial_cte`.`multinomial_expr` AS `Decision` 
