...
FROM `ADS_imp_1_OUT`), 
`linear_model_cte` AS 
(SELECT `ADS_sca_2_OUT`.`KEY` AS `KEY`, 19.559261215643012 * `ADS_sca_2_OUT`.`scaler_output_2` + 199.85474107671277 * `ADS_sca_2_OUT`.`scaler_output_3` + 252.29491433717706 * `ADS_sca_2_OUT`.`scaler_output_4` + -13.019371884686622 * `ADS_sca_2_OUT`.`scaler_output_5` + 480.740440691 AS `Estimator` 
FROM `ADS_sca_2_OUT`)
