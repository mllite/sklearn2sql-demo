...
FROM freidman3 "ADS"), 
"HL_BA_1" AS 
(SELECT "IL"."KEY" AS "KEY", -0.134577649774 * "IL"."Feature_0" + -0.591309606217 * "IL"."Feature_1" + -0.732357397923 * "IL"."Feature_2" + -0.81903323944 * "IL"."Feature_3" + 0.347593872734 AS "NEUR_1_1", -0.0874193686459 * "IL"."Feature_0" + 0.0139729343511 * "IL"."Feature_1" + -0.559797841167 * "IL"."Feature_2" + 0.656756241773 * "IL"."Feature_3" + 0.279048711152 AS "NEUR_1_2", 0.877314641619 * "IL"."Feature_0" + -0.600897740323 * "IL"."Feature_1" + 0.490578364792 * "IL"."Feature_2" + 0.131713217119 * "IL"."Feature_3" + -0.592512275061 AS "NEUR_1_3" 
FROM "IL"), 
"HL_1_relu" AS 
