...
linear_model_cte AS 
(SELECT "ADS_ano_2_OUT"."KEY" AS "KEY", -1.132210923218418 * "ADS_ano_2_OUT".anova_output_2 + 0.4865099567693955 * "ADS_ano_2_OUT".anova_output_3 + -0.22045906761780576 * "ADS_ano_2_OUT".anova_output_4 + -0.1304524038419842 * "ADS_ano_2_OUT".anova_output_5 + -1.63941405817 AS "Score_0", -2.0583800818988998 * "ADS_ano_2_OUT".anova_output_2 + -1.8019601758872943 * "ADS_ano_2_OUT".anova_output_3 + -2.8490613592674605 * "ADS_ano_2_OUT".anova_output_4 + -2.535068143266419 * "ADS_ano_2_OUT".anova_output_5 + -0.975163727541 AS "Score_1", 4.334679656476312 * "ADS_ano_2_OUT".anova_output_2 + -2.1704150696519378 * "ADS_ano_2_OUT".anova_output_3 + 2.467243896868531 * "ADS_ano_2_OUT".anova_output_4 + 1.7059509994826598 * "ADS_ano_2_OUT".anova_output_5 + -5.20145029597 AS "Score_2" 
FROM "ADS_ano_2_OUT"), 
orig_cte AS 
