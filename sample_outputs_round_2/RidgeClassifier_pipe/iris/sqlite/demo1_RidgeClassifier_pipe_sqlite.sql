...
linear_model_cte AS 
(SELECT "ADS_ano_2_OUT"."KEY" AS "KEY", -0.4188478065317805 * "ADS_ano_2_OUT".anova_output_2 + 0.5136098888082199 * "ADS_ano_2_OUT".anova_output_3 + 0.10232898611745923 * "ADS_ano_2_OUT".anova_output_4 + 0.002368328463128401 * "ADS_ano_2_OUT".anova_output_5 + -0.333333333333 AS "Score_0", 0.08437613664360533 * "ADS_ano_2_OUT".anova_output_2 + -0.6578630262580163 * "ADS_ano_2_OUT".anova_output_3 + -0.9208563150613571 * "ADS_ano_2_OUT".anova_output_4 + -0.5170214307431785 * "ADS_ano_2_OUT".anova_output_5 + -0.333333333333 AS "Score_1", 0.33447166988817506 * "ADS_ano_2_OUT".anova_output_2 + 0.1442531374497958 * "ADS_ano_2_OUT".anova_output_3 + 0.818527328943898 * "ADS_ano_2_OUT".anova_output_4 + 0.5146531022800499 * "ADS_ano_2_OUT".anova_output_5 + -0.333333333333 AS "Score_2" 
FROM "ADS_ano_2_OUT"), 
orig_cte AS 
