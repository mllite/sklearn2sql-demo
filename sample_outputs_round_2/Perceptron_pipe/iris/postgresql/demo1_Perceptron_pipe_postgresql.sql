...
linear_model_cte AS 
(SELECT "ADS_ano_2_OUT"."KEY" AS "KEY", -2.445263941439564 * "ADS_ano_2_OUT".anova_output_2 + 2.1474781585424867 * "ADS_ano_2_OUT".anova_output_3 + -0.03756605901815016 * "ADS_ano_2_OUT".anova_output_4 + -0.191902596356196 * "ADS_ano_2_OUT".anova_output_5 + -2.0 AS "Score_0", -3.8212059764704476 * "ADS_ano_2_OUT".anova_output_2 + -4.687357839558514 * "ADS_ano_2_OUT".anova_output_3 + -3.6935331098937025 * "ADS_ano_2_OUT".anova_output_4 + -2.070219924412524 * "ADS_ano_2_OUT".anova_output_5 + -3.0 AS "Score_1", 6.210813190068136 * "ADS_ano_2_OUT".anova_output_2 + -2.9395308550921513 * "ADS_ano_2_OUT".anova_output_3 + 1.9588170117983852 * "ADS_ano_2_OUT".anova_output_4 + 0.8895716858838734 * "ADS_ano_2_OUT".anova_output_5 + -6.0 AS "Score_2" 
FROM "ADS_ano_2_OUT"), 
orig_cte AS 
