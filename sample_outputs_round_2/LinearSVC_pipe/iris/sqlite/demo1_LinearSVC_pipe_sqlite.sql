...
linear_model_cte AS 
(SELECT "ADS_ano_2_OUT"."KEY" AS "KEY", -0.7754486061216929 * "ADS_ano_2_OUT".anova_output_2 + 0.6015931349024051 * "ADS_ano_2_OUT".anova_output_3 + -0.051868185959305875 * "ADS_ano_2_OUT".anova_output_4 + -0.08192843042469919 * "ADS_ano_2_OUT".anova_output_5 + -0.87680821009 AS "Score_0", 0.10075035578160343 * "ADS_ano_2_OUT".anova_output_2 + -0.7803351617829503 * "ADS_ano_2_OUT".anova_output_3 + -1.0261387742270414 * "ADS_ano_2_OUT".anova_output_4 + -0.5816936600486915 * "ADS_ano_2_OUT".anova_output_5 + -0.362807996954 AS "Score_1", 1.6253953164344372 * "ADS_ano_2_OUT".anova_output_2 + -1.0817408227969156 * "ADS_ano_2_OUT".anova_output_3 + 0.9851254277898759 * "ADS_ano_2_OUT".anova_output_4 + 0.6733301057468685 * "ADS_ano_2_OUT".anova_output_5 + -2.19560243453 AS "Score_2" 
FROM "ADS_ano_2_OUT"), 
orig_cte AS 
