...
(SELECT [ADS_ano_2_OUT].[KEY] AS [KEY], rand() AS uniform 
FROM [ADS_ano_2_OUT]), 
multinomial_cte AS 
...
(SELECT multinomial_cte.[KEY] AS [KEY], 0.333333333333 AS [Proba_0], CASE WHEN (0.333333333333 IS NULL OR 0.333333333333 > 0.0) THEN log(0.333333333333) ELSE -1.79769313486231e+308 END AS [LogProba_0], 0.333333333333 AS [Proba_1], CASE WHEN (0.333333333333 IS NULL OR 0.333333333333 > 0.0) THEN log(0.333333333333) ELSE -1.79769313486231e+308 END AS [LogProba_1], 0.333333333333 AS [Proba_2], CASE WHEN (0.333333333333 IS NULL OR 0.333333333333 > 0.0) THEN log(0.333333333333) ELSE -1.79769313486231e+308 END AS [LogProba_2], multinomial_cte.multinomial_expr AS [Decision] 
