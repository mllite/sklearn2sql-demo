...
"RawScores" AS 
(SELECT "ADS_ano_2_OUT"."KEY" AS "KEY", CAST(NULL AS FLOAT) AS "LogProba_0", CAST(NULL AS FLOAT) AS "Proba_0", -1.09861228867 + "ADS_ano_2_OUT".anova_output_2 * -3.95124371858 + (1 - "ADS_ano_2_OUT".anova_output_2) * -0.0194180858571 + "ADS_ano_2_OUT".anova_output_3 * -0.485507815782 + (1 - "ADS_ano_2_OUT".anova_output_3) * -0.955511445027 + "ADS_ano_2_OUT".anova_output_4 * -0.619039208406 + (1 - "ADS_ano_2_OUT".anova_output_4) * -0.773189888233 + "ADS_ano_2_OUT".anova_output_5 * -0.815749502652 + (1 - "ADS_ano_2_OUT".anova_output_5) * -0.583947888595 AS "Score_0", CAST(NULL AS FLOAT) AS "LogProba_1", CAST(NULL AS FLOAT) AS "Proba_1", -1.09861228867 + "ADS_ano_2_OUT".anova_output_2 * -0.213574100298 + (1 - "ADS_ano_2_OUT".anova_output_2) * -1.64865862559 + "ADS_ano_2_OUT".anova_output_3 * -1.24319351748 + (1 - "ADS_ano_2_OUT".anova_output_3) * -0.340325805937 + "ADS_ano_2_OUT".anova_output_4 * -1.06087196069 + (1 - "ADS_ano_2_OUT".anova_output_4) * -0.424883193965 + "ADS_ano_2_OUT".anova_output_5 * -0.732367893713 + (1 - "ADS_ano_2_OUT".anova_output_5) * -0.655406852577 AS "Score_1", CAST(NULL AS FLOAT) AS "LogProba_2", CAST(NULL AS FLOAT) AS "Proba_2", -1.09861228867 + "ADS_ano_2_OUT".anova_output_2 * -0.0194180858571 + (1 - "ADS_ano_2_OUT".anova_output_2) * -3.95124371858 + "ADS_ano_2_OUT".anova_output_3 * -0.583947888595 + (1 - "ADS_ano_2_OUT".anova_output_3) * -0.815749502652 + "ADS_ano_2_OUT".anova_output_4 * -0.424883193965 + (1 - "ADS_ano_2_OUT".anova_output_4) * -1.06087196069 + "ADS_ano_2_OUT".anova_output_5 * -0.583947888595 + (1 - "ADS_ano_2_OUT".anova_output_5) * -0.815749502652 AS "Score_2" 
FROM "ADS_ano_2_OUT"), 
orig_cte AS 
