...
linear_model_cte AS 
(SELECT "ADS_ano_2_OUT"."KEY" AS "KEY", -0.4188478065318418 * "ADS_ano_2_OUT".anova_output_2 + 0.5136098888082002 * "ADS_ano_2_OUT".anova_output_3 + 0.10232898611745801 * "ADS_ano_2_OUT".anova_output_4 + 0.0023683284631291035 * "ADS_ano_2_OUT".anova_output_5 + -0.333333333333 AS "Score_0", 0.08437613664360322 * "ADS_ano_2_OUT".anova_output_2 + -0.6578630262580016 * "ADS_ano_2_OUT".anova_output_3 + -0.9208563150613572 * "ADS_ano_2_OUT".anova_output_4 + -0.5170214307431797 * "ADS_ano_2_OUT".anova_output_5 + -0.333333333333 AS "Score_1", 0.3344716698882604 * "ADS_ano_2_OUT".anova_output_2 + 0.14425313744979384 * "ADS_ano_2_OUT".anova_output_3 + 0.8185273289438999 * "ADS_ano_2_OUT".anova_output_4 + 0.5146531022800502 * "ADS_ano_2_OUT".anova_output_5 + -0.333333333333 AS "Score_2" 
FROM "ADS_ano_2_OUT"), 
orig_cte AS 
