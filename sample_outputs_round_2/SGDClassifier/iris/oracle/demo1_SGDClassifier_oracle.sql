...
(SELECT "ADS"."KEY" AS "KEY", 5.71755288736418 * "ADS"."Feature_0" + 24.585477415665963 * "ADS"."Feature_1" + -36.59233847913073 * "ADS"."Feature_2" + -17.152658662092534 * "ADS"."Feature_3" + 9.91048693098 AS "Score_0", 32.59005145797578 * "ADS"."Feature_0" + -147.51286449399595 * "ADS"."Feature_1" + 6.2893081761005325 * "ADS"."Feature_2" + -99.48542024013688 * "ADS"."Feature_3" + 35.9663857347 AS "Score_1", -116.06632361349287 * "ADS"."Feature_0" + -94.91137793024548 * "ADS"."Feature_1" + 197.25557461406441 * "ADS"."Feature_2" + 176.10062893081698 * "ADS"."Feature_3" + -82.7575494628 AS "Score_2" 
FROM "INPUT_DATA" "ADS"), 
orig_cte AS 
