...
(SELECT "ADS"."KEY" AS "KEY", 0.12705283360914862 * "ADS"."Feature_0" + 0.4695089303373964 * "ADS"."Feature_1" + -0.4427640409867579 * "ADS"."Feature_2" + -0.13070722670190277 * "ADS"."Feature_3" + -0.688748826511 AS "Score_0", -0.030416160173999132 * "ADS"."Feature_0" + -0.8686439569055205 * "ADS"."Feature_1" + 0.36914586521598114 * "ADS"."Feature_2" + -0.8145271451057305 * "ADS"."Feature_3" + 2.08608735288 AS "Score_1", -0.09663667343518702 * "ADS"."Feature_0" + 0.3991350265681288 * "ADS"."Feature_1" + 0.07361817577074381 * "ADS"."Feature_2" + 0.9452343718076146 * "ADS"."Feature_3" + -2.39733852637 AS "Score_2" 
FROM "INPUT_DATA" "ADS"), 
orig_cte AS 
