...
FROM (SELECT 0 AS sv_idx, 0.584652441098 AS dual_coeff, -1.41570853025 AS sv_0, -1.47153860551 AS sv_1, -1.28919122625 AS sv_2, -1.1052880759 AS sv_3 FROM DUAL UNION ALL SELECT 1 AS sv_idx, 0.0 AS dual_coeff, -0.379596572947 AS sv_0, 0.814401136638 AS sv_1, -1.05536732738 AS sv_2, -1.25454230513 AS sv_3 FROM DUAL) "Values"), 
kernel_cte_0 AS 
...
"SV_data_2" AS 
(SELECT "Values".sv_idx AS sv_idx, "Values".dual_coeff AS dual_coeff, "Values".sv_0 AS sv_0, "Values".sv_1 AS sv_1, "Values".sv_2 AS sv_2, "Values".sv_3 AS sv_3 
FROM (SELECT 0 AS sv_idx, -0.0 AS dual_coeff, 1.69262734167 AS sv_0, -0.0168496786891 AS sv_1, 1.34132763614 AS sv_2, 0.835016904055 AS sv_3 FROM DUAL UNION ALL SELECT 1 AS sv_idx, -0.189855036242 AS dual_coeff, 0.311144731924 AS sv_0, -1.67935130934 AS sv_1, 0.873679838381 AS sv_2, 0.685762674828 AS sv_3 FROM DUAL UNION ALL SELECT 2 AS sv_idx, -0.0 AS dual_coeff, 1.34725668923 AS sv_0, 0.398775728974 AS sv_1, 1.28287166142 AS sv_2, 1.87979650865 AS sv_3 FROM DUAL UNION ALL SELECT 3 AS sv_idx, -0.0 AS dual_coeff, 0.771638935171 AS sv_0, -0.640287790184 AS sv_1, 1.04904776254 AS sv_2, 1.28277959174 AS sv_3 FROM DUAL) "Values"), 
kernel_cte_2 AS 
