...
FROM iris AS `ADS`), 
`HL_BA_1` AS 
(SELECT `IL`.`KEY` AS `KEY`, -0.134574204429 * `IL`.`Feature_0` + -0.591294467999 * `IL`.`Feature_1` + -0.732338648717 * `IL`.`Feature_2` + -0.81901227123 * `IL`.`Feature_3` + 0.347593872734 AS `NEUR_1_1`, 9.32041232837 * `IL`.`Feature_0` + 7.50489013263 * `IL`.`Feature_1` + 0.0116867028558 * `IL`.`Feature_2` + -0.0619290248959 * `IL`.`Feature_3` + 2.53231390746 AS `NEUR_1_2`, -0.397932024613 * `IL`.`Feature_0` + -6.63069768935 * `IL`.`Feature_1` + 11.235889566 * `IL`.`Feature_2` + 4.78626180123 * `IL`.`Feature_3` + -1.82084260031 AS `NEUR_1_3` 
FROM `IL`), 
`HL_1_relu` AS 
(SELECT `HL_BA_1`.`KEY` AS `KEY`, CASE WHEN (`HL_BA_1`.`NEUR_1_1` >= 0.0) THEN `HL_BA_1`.`NEUR_1_1` ELSE 0.0 END AS `NEUR_1_1`, CASE WHEN (`HL_BA_1`.`NEUR_1_2` >= 0.0) THEN `HL_BA_1`.`NEUR_1_2` ELSE 0.0 END AS `NEUR_1_2`, CASE WHEN (`HL_BA_1`.`NEUR_1_3` >= 0.0) THEN `HL_BA_1`.`NEUR_1_3` ELSE 0.0 END AS `NEUR_1_3` 
FROM `HL_BA_1`), 
`HL_BA_2` AS 
(SELECT `HL_1_relu`.`KEY` AS `KEY`, 0.67277117327 * `HL_1_relu`.`NEUR_1_1` + 3.37320893578 * `HL_1_relu`.`NEUR_1_2` + -1.34421284184 * `HL_1_relu`.`NEUR_1_3` + 3.62964324636 AS `NEUR_2_1`, 0.648814904341 * `HL_1_relu`.`NEUR_1_1` + -0.0693927361612 * `HL_1_relu`.`NEUR_1_2` + -0.645911095961 * `HL_1_relu`.`NEUR_1_3` + -0.529290429612 AS `NEUR_2_2`, -0.300710332135 * `HL_1_relu`.`NEUR_1_1` + -0.827319232512 * `HL_1_relu`.`NEUR_1_2` + -0.301036791351 * `HL_1_relu`.`NEUR_1_3` + -0.0103942825038 AS `NEUR_2_3`, -0.341320691074 * `HL_1_relu`.`NEUR_1_1` + -0.518883448777 * `HL_1_relu`.`NEUR_1_2` + -0.122325891228 * `HL_1_relu`.`NEUR_1_3` + -0.740628349607 AS `NEUR_2_4`, -0.386756143215 * `HL_1_relu`.`NEUR_1_1` + -2.83922840286 * `HL_1_relu`.`NEUR_1_2` + 11.7602436343 * `HL_1_relu`.`NEUR_1_3` + -5.88336893656 AS `NEUR_2_5` 
FROM `HL_1_relu`), 
`HL_2_relu` AS 
(SELECT `HL_BA_2`.`KEY` AS `KEY`, CASE WHEN (`HL_BA_2`.`NEUR_2_1` >= 0.0) THEN `HL_BA_2`.`NEUR_2_1` ELSE 0.0 END AS `NEUR_2_1`, CASE WHEN (`HL_BA_2`.`NEUR_2_2` >= 0.0) THEN `HL_BA_2`.`NEUR_2_2` ELSE 0.0 END AS `NEUR_2_2`, CASE WHEN (`HL_BA_2`.`NEUR_2_3` >= 0.0) THEN `HL_BA_2`.`NEUR_2_3` ELSE 0.0 END AS `NEUR_2_3`, CASE WHEN (`HL_BA_2`.`NEUR_2_4` >= 0.0) THEN `HL_BA_2`.`NEUR_2_4` ELSE 0.0 END AS `NEUR_2_4`, CASE WHEN (`HL_BA_2`.`NEUR_2_5` >= 0.0) THEN `HL_BA_2`.`NEUR_2_5` ELSE 0.0 END AS `NEUR_2_5` 
FROM `HL_BA_2`), 
`OL_BA` AS 
(SELECT `HL_2_relu`.`KEY` AS `KEY`, 2.19389325406 * `HL_2_relu`.`NEUR_2_1` + 0.591441954871 * `HL_2_relu`.`NEUR_2_2` + -0.504721532481 * `HL_2_relu`.`NEUR_2_3` + -0.769769669425 * `HL_2_relu`.`NEUR_2_4` + -11.1294140105 * `HL_2_relu`.`NEUR_2_5` + 11.8848209575 AS `NEUR_3_1`, -0.297603652326 * `HL_2_relu`.`NEUR_2_1` + 0.665156757802 * `HL_2_relu`.`NEUR_2_2` + 0.433196701485 * `HL_2_relu`.`NEUR_2_3` + 0.349232300115 * `HL_2_relu`.`NEUR_2_4` + 4.35474813409 * `HL_2_relu`.`NEUR_2_5` + -4.24491474215 AS `NEUR_3_2`, -2.40398814553 * `HL_2_relu`.`NEUR_2_1` + 0.457752185525 * `HL_2_relu`.`NEUR_2_2` + 0.0795420646274 * `HL_2_relu`.`NEUR_2_3` + -0.40661466466 * `HL_2_relu`.`NEUR_2_4` + 6.15158027893 * `HL_2_relu`.`NEUR_2_5` + -8.81666305433 AS `NEUR_3_3` 
FROM `HL_2_relu`), 
`OL_softmax` AS 
