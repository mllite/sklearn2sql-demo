...
FROM (SELECT 0 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 0 AS depth, CAST(NULL AS SIGNED INTEGER) AS parent_id, 0.00955414 AS `Score`) AS `Values`), 
`DT_Output` AS 
...
`DT_node_data_1` AS 
(SELECT `Values`.node_id AS node_id, `Values`.feature AS feature, `Values`.threshold AS threshold, `Values`.depth AS depth, `Values`.parent_id AS parent_id, `Values`.`Score` AS `Score` 
FROM (SELECT 0 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 0 AS depth, CAST(NULL AS SIGNED INTEGER) AS parent_id, 0.0210191 AS `Score`) AS `Values`), 
`DT_Output_1` AS 
...
`DT_node_data_2` AS 
(SELECT `Values`.node_id AS node_id, `Values`.feature AS feature, `Values`.threshold AS threshold, `Values`.depth AS depth, `Values`.parent_id AS parent_id, `Values`.`Score` AS `Score` 
FROM (SELECT 0 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 0 AS depth, CAST(NULL AS SIGNED INTEGER) AS parent_id, -0.0305733 AS `Score`) AS `Values`), 
`DT_Output_2` AS 
...
`DT_node_data_3` AS 
(SELECT `Values`.node_id AS node_id, `Values`.feature AS feature, `Values`.threshold AS threshold, `Values`.depth AS depth, `Values`.parent_id AS parent_id, `Values`.`Score` AS `Score` 
FROM (SELECT 0 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 0 AS depth, CAST(NULL AS SIGNED INTEGER) AS parent_id, 0.00885413 AS `Score`) AS `Values`), 
`DT_Output_3` AS 
...
`DT_node_data_4` AS 
(SELECT `Values`.node_id AS node_id, `Values`.feature AS feature, `Values`.threshold AS threshold, `Values`.depth AS depth, `Values`.parent_id AS parent_id, `Values`.`Score` AS `Score` 
FROM (SELECT 0 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 0 AS depth, CAST(NULL AS SIGNED INTEGER) AS parent_id, 0.0193475 AS `Score`) AS `Values`), 
`DT_Output_4` AS 
...
`DT_node_data_5` AS 
(SELECT `Values`.node_id AS node_id, `Values`.feature AS feature, `Values`.threshold AS threshold, `Values`.depth AS depth, `Values`.parent_id AS parent_id, `Values`.`Score` AS `Score` 
FROM (SELECT 0 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 0 AS depth, CAST(NULL AS SIGNED INTEGER) AS parent_id, -0.0288529 AS `Score`) AS `Values`), 
`DT_Output_5` AS 
...
`DT_node_data_6` AS 
(SELECT `Values`.node_id AS node_id, `Values`.feature AS feature, `Values`.threshold AS threshold, `Values`.depth AS depth, `Values`.parent_id AS parent_id, `Values`.`Score` AS `Score` 
FROM (SELECT 0 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 0 AS depth, CAST(NULL AS SIGNED INTEGER) AS parent_id, 0.00822238 AS `Score`) AS `Values`), 
`DT_Output_6` AS 
...
`DT_node_data_7` AS 
(SELECT `Values`.node_id AS node_id, `Values`.feature AS feature, `Values`.threshold AS threshold, `Values`.depth AS depth, `Values`.parent_id AS parent_id, `Values`.`Score` AS `Score` 
FROM (SELECT 0 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 0 AS depth, CAST(NULL AS SIGNED INTEGER) AS parent_id, 0.0178313 AS `Score`) AS `Values`), 
`DT_Output_7` AS 
...
`DT_node_data_8` AS 
(SELECT `Values`.node_id AS node_id, `Values`.feature AS feature, `Values`.threshold AS threshold, `Values`.depth AS depth, `Values`.parent_id AS parent_id, `Values`.`Score` AS `Score` 
FROM (SELECT 0 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 0 AS depth, CAST(NULL AS SIGNED INTEGER) AS parent_id, -0.027241 AS `Score`) AS `Values`), 
`DT_Output_8` AS 
...
`DT_node_data_9` AS 
(SELECT `Values`.node_id AS node_id, `Values`.feature AS feature, `Values`.threshold AS threshold, `Values`.depth AS depth, `Values`.parent_id AS parent_id, `Values`.`Score` AS `Score` 
FROM (SELECT 0 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 0 AS depth, CAST(NULL AS SIGNED INTEGER) AS parent_id, 0.00765006 AS `Score`) AS `Values`), 
`DT_Output_9` AS 
...
`DT_node_data_10` AS 
(SELECT `Values`.node_id AS node_id, `Values`.feature AS feature, `Values`.threshold AS threshold, `Values`.depth AS depth, `Values`.parent_id AS parent_id, `Values`.`Score` AS `Score` 
FROM (SELECT 0 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 0 AS depth, CAST(NULL AS SIGNED INTEGER) AS parent_id, 0.0164521 AS `Score`) AS `Values`), 
`DT_Output_10` AS 
...
`DT_node_data_11` AS 
(SELECT `Values`.node_id AS node_id, `Values`.feature AS feature, `Values`.threshold AS threshold, `Values`.depth AS depth, `Values`.parent_id AS parent_id, `Values`.`Score` AS `Score` 
FROM (SELECT 0 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 0 AS depth, CAST(NULL AS SIGNED INTEGER) AS parent_id, -0.0257268 AS `Score`) AS `Values`), 
`DT_Output_11` AS 
...
`DT_node_data_12` AS 
(SELECT `Values`.node_id AS node_id, `Values`.feature AS feature, `Values`.threshold AS threshold, `Values`.depth AS depth, `Values`.parent_id AS parent_id, `Values`.`Score` AS `Score` 
FROM (SELECT 0 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 0 AS depth, CAST(NULL AS SIGNED INTEGER) AS parent_id, 0.00712973 AS `Score`) AS `Values`), 
`DT_Output_12` AS 
...
`DT_node_data_13` AS 
(SELECT `Values`.node_id AS node_id, `Values`.feature AS feature, `Values`.threshold AS threshold, `Values`.depth AS depth, `Values`.parent_id AS parent_id, `Values`.`Score` AS `Score` 
FROM (SELECT 0 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 0 AS depth, CAST(NULL AS SIGNED INTEGER) AS parent_id, 0.0151944 AS `Score`) AS `Values`), 
`DT_Output_13` AS 
...
`DT_node_data_14` AS 
(SELECT `Values`.node_id AS node_id, `Values`.feature AS feature, `Values`.threshold AS threshold, `Values`.depth AS depth, `Values`.parent_id AS parent_id, `Values`.`Score` AS `Score` 
FROM (SELECT 0 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 0 AS depth, CAST(NULL AS SIGNED INTEGER) AS parent_id, -0.0243018 AS `Score`) AS `Values`), 
`DT_Output_14` AS 
...
`DT_node_data_15` AS 
(SELECT `Values`.node_id AS node_id, `Values`.feature AS feature, `Values`.threshold AS threshold, `Values`.depth AS depth, `Values`.parent_id AS parent_id, `Values`.`Score` AS `Score` 
FROM (SELECT 0 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 0 AS depth, CAST(NULL AS SIGNED INTEGER) AS parent_id, 0.00665508 AS `Score`) AS `Values`), 
`DT_Output_15` AS 
...
`DT_node_data_16` AS 
(SELECT `Values`.node_id AS node_id, `Values`.feature AS feature, `Values`.threshold AS threshold, `Values`.depth AS depth, `Values`.parent_id AS parent_id, `Values`.`Score` AS `Score` 
FROM (SELECT 0 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 0 AS depth, CAST(NULL AS SIGNED INTEGER) AS parent_id, 0.0140449 AS `Score`) AS `Values`), 
`DT_Output_16` AS 
...
`DT_node_data_17` AS 
(SELECT `Values`.node_id AS node_id, `Values`.feature AS feature, `Values`.threshold AS threshold, `Values`.depth AS depth, `Values`.parent_id AS parent_id, `Values`.`Score` AS `Score` 
FROM (SELECT 0 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 0 AS depth, CAST(NULL AS SIGNED INTEGER) AS parent_id, -0.0229584 AS `Score`) AS `Values`), 
`DT_Output_17` AS 
...
`DT_node_data_18` AS 
(SELECT `Values`.node_id AS node_id, `Values`.feature AS feature, `Values`.threshold AS threshold, `Values`.depth AS depth, `Values`.parent_id AS parent_id, `Values`.`Score` AS `Score` 
FROM (SELECT 0 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 0 AS depth, CAST(NULL AS SIGNED INTEGER) AS parent_id, 0.00622076 AS `Score`) AS `Values`), 
`DT_Output_18` AS 
...
`DT_node_data_19` AS 
(SELECT `Values`.node_id AS node_id, `Values`.feature AS feature, `Values`.threshold AS threshold, `Values`.depth AS depth, `Values`.parent_id AS parent_id, `Values`.`Score` AS `Score` 
FROM (SELECT 0 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 0 AS depth, CAST(NULL AS SIGNED INTEGER) AS parent_id, 0.0129923 AS `Score`) AS `Values`), 
`DT_Output_19` AS 
...
`DT_node_data_20` AS 
(SELECT `Values`.node_id AS node_id, `Values`.feature AS feature, `Values`.threshold AS threshold, `Values`.depth AS depth, `Values`.parent_id AS parent_id, `Values`.`Score` AS `Score` 
FROM (SELECT 0 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 0 AS depth, CAST(NULL AS SIGNED INTEGER) AS parent_id, -0.0216904 AS `Score`) AS `Values`), 
`DT_Output_20` AS 
...
`DT_node_data_21` AS 
(SELECT `Values`.node_id AS node_id, `Values`.feature AS feature, `Values`.threshold AS threshold, `Values`.depth AS depth, `Values`.parent_id AS parent_id, `Values`.`Score` AS `Score` 
FROM (SELECT 0 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 0 AS depth, CAST(NULL AS SIGNED INTEGER) AS parent_id, 0.00582216 AS `Score`) AS `Values`), 
`DT_Output_21` AS 
...
`DT_node_data_22` AS 
(SELECT `Values`.node_id AS node_id, `Values`.feature AS feature, `Values`.threshold AS threshold, `Values`.depth AS depth, `Values`.parent_id AS parent_id, `Values`.`Score` AS `Score` 
FROM (SELECT 0 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 0 AS depth, CAST(NULL AS SIGNED INTEGER) AS parent_id, 0.0120268 AS `Score`) AS `Values`), 
`DT_Output_22` AS 
...
`DT_node_data_23` AS 
(SELECT `Values`.node_id AS node_id, `Values`.feature AS feature, `Values`.threshold AS threshold, `Values`.depth AS depth, `Values`.parent_id AS parent_id, `Values`.`Score` AS `Score` 
FROM (SELECT 0 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 0 AS depth, CAST(NULL AS SIGNED INTEGER) AS parent_id, -0.0204923 AS `Score`) AS `Values`), 
`DT_Output_23` AS 
...
`DT_node_data_24` AS 
(SELECT `Values`.node_id AS node_id, `Values`.feature AS feature, `Values`.threshold AS threshold, `Values`.depth AS depth, `Values`.parent_id AS parent_id, `Values`.`Score` AS `Score` 
FROM (SELECT 0 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 0 AS depth, CAST(NULL AS SIGNED INTEGER) AS parent_id, 0.00545533 AS `Score`) AS `Values`), 
`DT_Output_24` AS 
...
`DT_node_data_25` AS 
(SELECT `Values`.node_id AS node_id, `Values`.feature AS feature, `Values`.threshold AS threshold, `Values`.depth AS depth, `Values`.parent_id AS parent_id, `Values`.`Score` AS `Score` 
FROM (SELECT 0 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 0 AS depth, CAST(NULL AS SIGNED INTEGER) AS parent_id, 0.0111399 AS `Score`) AS `Values`), 
`DT_Output_25` AS 
...
`DT_node_data_26` AS 
(SELECT `Values`.node_id AS node_id, `Values`.feature AS feature, `Values`.threshold AS threshold, `Values`.depth AS depth, `Values`.parent_id AS parent_id, `Values`.`Score` AS `Score` 
FROM (SELECT 0 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 0 AS depth, CAST(NULL AS SIGNED INTEGER) AS parent_id, -0.0193594 AS `Score`) AS `Values`), 
`DT_Output_26` AS 
...
`DT_node_data_27` AS 
(SELECT `Values`.node_id AS node_id, `Values`.feature AS feature, `Values`.threshold AS threshold, `Values`.depth AS depth, `Values`.parent_id AS parent_id, `Values`.`Score` AS `Score` 
FROM (SELECT 0 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 0 AS depth, CAST(NULL AS SIGNED INTEGER) AS parent_id, 0.00511689 AS `Score`) AS `Values`), 
`DT_Output_27` AS 
...
`DT_node_data_28` AS 
(SELECT `Values`.node_id AS node_id, `Values`.feature AS feature, `Values`.threshold AS threshold, `Values`.depth AS depth, `Values`.parent_id AS parent_id, `Values`.`Score` AS `Score` 
FROM (SELECT 0 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 0 AS depth, CAST(NULL AS SIGNED INTEGER) AS parent_id, 0.0103241 AS `Score`) AS `Values`), 
`DT_Output_28` AS 
...
`DT_node_data_29` AS 
(SELECT `Values`.node_id AS node_id, `Values`.feature AS feature, `Values`.threshold AS threshold, `Values`.depth AS depth, `Values`.parent_id AS parent_id, `Values`.`Score` AS `Score` 
FROM (SELECT 0 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 0 AS depth, CAST(NULL AS SIGNED INTEGER) AS parent_id, -0.0182875 AS `Score`) AS `Values`), 
`DT_Output_29` AS 
...
orig_cte AS 
(SELECT `XGB_Sum_Scores`.`KEY` AS `KEY`, `XGB_Sum_Scores`.`Score_0` AS `Score_0`, `XGB_Sum_Scores`.`Score_1` AS `Score_1`, `XGB_Sum_Scores`.`Score_2` AS `Score_2`, NULL AS `Proba_0`, NULL AS `Proba_1`, NULL AS `Proba_2`, NULL AS `LogProba_0`, NULL AS `LogProba_1`, NULL AS `LogProba_2`, CAST(NULL AS SIGNED INTEGER) AS `Decision` 
FROM `XGB_Sum_Scores`), 
