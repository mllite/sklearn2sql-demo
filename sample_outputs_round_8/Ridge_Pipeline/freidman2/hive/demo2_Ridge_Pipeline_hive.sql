...
FROM `ADS_imp_1_OUT`), 
`linear_model_cte` AS 
(SELECT `ADS_sca_2_OUT`.`KEY` AS `KEY`, 19.559261215642984 * `ADS_sca_2_OUT`.`scaler_output_2` + 199.8547410767128 * `ADS_sca_2_OUT`.`scaler_output_3` + 252.2949143371771 * `ADS_sca_2_OUT`.`scaler_output_4` + -13.01937188468663 * `ADS_sca_2_OUT`.`scaler_output_5` + 480.740440691 AS `Estimator` 
FROM `ADS_sca_2_OUT`)
