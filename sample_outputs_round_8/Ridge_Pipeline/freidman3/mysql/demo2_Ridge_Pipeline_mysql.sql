...
FROM `ADS_imp_1_OUT`), 
linear_model_cte AS 
(SELECT `ADS_sca_2_OUT`.`KEY` AS `KEY`, -0.0980929416282316 * `ADS_sca_2_OUT`.scaler_output_2 + 0.0678663297791829 * `ADS_sca_2_OUT`.scaler_output_3 + 0.11737674137414546 * `ADS_sca_2_OUT`.scaler_output_4 + 0.028347763443832417 * `ADS_sca_2_OUT`.scaler_output_5 + 1.4256189972 AS `Estimator` 
FROM `ADS_sca_2_OUT`)
