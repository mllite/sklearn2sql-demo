...
FROM (SELECT 0 AS node_id, 'Feature_7' AS feature, -0.2877371311187744 AS threshold, 25 AS "count", 0 AS depth, NULL AS parent_id, 1.3322676295501878e-17 AS "Estimator" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 1 AS node_id, NULL AS feature, CAST(NULL AS DOUBLE) AS threshold, 7 AS "count", 1 AS depth, NULL AS parent_id, 2.7777777777777786 AS "Estimator" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 2 AS node_id, 'Feature_5' AS feature, 2.4748287200927734 AS threshold, 18 AS "count", 1 AS depth, NULL AS parent_id, -0.24888888888888885 AS "Estimator" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 3 AS node_id, NULL AS feature, CAST(NULL AS DOUBLE) AS threshold, 16 AS "count", 2 AS depth, NULL AS parent_id, -1.5625 AS "Estimator" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 4 AS node_id, NULL AS feature, CAST(NULL AS DOUBLE) AS threshold, 2 AS "count", 2 AS depth, NULL AS parent_id, 2.777777777777778 AS "Estimator" FROM SYSIBM.SYSDUMMY1) AS "Values"), 
"DT_Output" AS 
...
"DT_node_data_1" AS 
(SELECT "Values".node_id AS node_id, "Values".feature AS feature, "Values".threshold AS threshold, "Values"."count" AS "count", "Values".depth AS depth, "Values".parent_id AS parent_id, "Values"."Estimator" AS "Estimator" 
FROM (SELECT 0 AS node_id, 'Feature_7' AS feature, -0.2877371311187744 AS threshold, 25 AS "count", 0 AS depth, NULL AS parent_id, -0.0013111369900358526 AS "Estimator" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 1 AS node_id, NULL AS feature, CAST(NULL AS DOUBLE) AS threshold, 7 AS "count", 1 AS depth, NULL AS parent_id, 2.346604672705719 AS "Estimator" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 2 AS node_id, 'Feature_5' AS feature, 2.4748287200927734 AS threshold, 18 AS "count", 1 AS depth, NULL AS parent_id, -0.22498583743755626 AS "Estimator" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 3 AS node_id, NULL AS feature, CAST(NULL AS DOUBLE) AS threshold, 16 AS "count", 2 AS depth, NULL AS parent_id, -1.4811317466104255 AS "Estimator" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 4 AS node_id, NULL AS feature, CAST(NULL AS DOUBLE) AS threshold, 2 AS "count", 2 AS depth, NULL AS parent_id, 2.3466046727057184 AS "Estimator" FROM SYSIBM.SYSDUMMY1) AS "Values"), 
"DT_Output_1" AS 
...
orig_cte AS 
(SELECT "GradBoost_Sum_Scores"."KEY" AS "KEY", 1.5753641449 + 0.1 * "GradBoost_Sum_Scores"."Score_0" AS "Score_0", -0.575364144904 + 0.1 * "GradBoost_Sum_Scores"."Score_1" AS "Score_1", CAST(NULL AS DOUBLE) AS "Proba_0", CAST(NULL AS DOUBLE) AS "Proba_1", CAST(NULL AS DOUBLE) AS "LogProba_0", CAST(NULL AS DOUBLE) AS "LogProba_1", NULL AS "Decision" 
