...
(SELECT multinomial_cte."KEY" AS "KEY", 0.24 AS "Proba_0", CASE WHEN (0.24 IS NULL OR 0.24 > 0.0) THEN ln(0.24) ELSE -BINARY_FLOAT_INFINITY END AS "LogProba_0", 0.2 AS "Proba_1", CASE WHEN (0.2 IS NULL OR 0.2 > 0.0) THEN ln(0.2) ELSE -BINARY_FLOAT_INFINITY END AS "LogProba_1", 0.24 AS "Proba_2", CASE WHEN (0.24 IS NULL OR 0.24 > 0.0) THEN ln(0.24) ELSE -BINARY_FLOAT_INFINITY END AS "LogProba_2", 0.32 AS "Proba_3", CASE WHEN (0.32 IS NULL OR 0.32 > 0.0) THEN ln(0.32) ELSE -BINARY_FLOAT_INFINITY END AS "LogProba_3", multinomial_cte.multinomial_expr AS "Decision" 
