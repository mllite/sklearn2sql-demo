...
FROM (SELECT 0 AS `node_id`, 'scaler_9' AS `feature`, -0.5501443147659302 AS `threshold`, 25 AS `count`, 0 AS `depth`, CAST(NULL AS INT) AS `parent_id`, 1.3322676295501878e-17 AS `Estimator` UNION ALL SELECT 1 AS `node_id`, CAST(NULL AS STRING) AS `feature`, CAST(NULL AS FLOAT) AS `threshold`, 7 AS `count`, 1 AS `depth`, CAST(NULL AS INT) AS `parent_id`, 2.7777777777777786 AS `Estimator` UNION ALL SELECT 2 AS `node_id`, 'scaler_7' AS `feature`, 1.5878198146820068 AS `threshold`, 18 AS `count`, 1 AS `depth`, CAST(NULL AS INT) AS `parent_id`, -0.24888888888888885 AS `Estimator` UNION ALL SELECT 3 AS `node_id`, CAST(NULL AS STRING) AS `feature`, CAST(NULL AS FLOAT) AS `threshold`, 16 AS `count`, 2 AS `depth`, CAST(NULL AS INT) AS `parent_id`, -1.5625 AS `Estimator` UNION ALL SELECT 4 AS `node_id`, CAST(NULL AS STRING) AS `feature`, CAST(NULL AS FLOAT) AS `threshold`, 2 AS `count`, 2 AS `depth`, CAST(NULL AS INT) AS `parent_id`, 2.777777777777778 AS `Estimator`) AS `Values`), 
`DT_Output` AS 
...
`DT_node_data_1` AS 
(SELECT `Values`.`node_id` AS `node_id`, `Values`.`feature` AS `feature`, `Values`.`threshold` AS `threshold`, `Values`.`count` AS `count`, `Values`.`depth` AS `depth`, `Values`.`parent_id` AS `parent_id`, `Values`.`Estimator` AS `Estimator` 
FROM (SELECT 0 AS `node_id`, 'scaler_9' AS `feature`, -0.5501443147659302 AS `threshold`, 25 AS `count`, 0 AS `depth`, CAST(NULL AS INT) AS `parent_id`, -0.0013111369900358526 AS `Estimator` UNION ALL SELECT 1 AS `node_id`, CAST(NULL AS STRING) AS `feature`, CAST(NULL AS FLOAT) AS `threshold`, 7 AS `count`, 1 AS `depth`, CAST(NULL AS INT) AS `parent_id`, 2.346604672705719 AS `Estimator` UNION ALL SELECT 2 AS `node_id`, 'scaler_7' AS `feature`, 1.5878198146820068 AS `threshold`, 18 AS `count`, 1 AS `depth`, CAST(NULL AS INT) AS `parent_id`, -0.22498583743755626 AS `Estimator` UNION ALL SELECT 3 AS `node_id`, CAST(NULL AS STRING) AS `feature`, CAST(NULL AS FLOAT) AS `threshold`, 16 AS `count`, 2 AS `depth`, CAST(NULL AS INT) AS `parent_id`, -1.4811317466104255 AS `Estimator` UNION ALL SELECT 4 AS `node_id`, CAST(NULL AS STRING) AS `feature`, CAST(NULL AS FLOAT) AS `threshold`, 2 AS `count`, 2 AS `depth`, CAST(NULL AS INT) AS `parent_id`, 2.3466046727057184 AS `Estimator`) AS `Values`), 
`DT_Output_1` AS 
