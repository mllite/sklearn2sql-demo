...
FROM "ADS_imp_1_OUT"), 
"RawScores" AS 
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", CAST(NULL AS FLOAT) AS "LogProba_0", CAST(NULL AS FLOAT) AS "Proba_0", -1.30933331998 + (-0.5 * 0.299055750239 - (0.5 * ("ADS_sca_2_OUT".scaler_output_2 - -1.1331717063) * ("ADS_sca_2_OUT".scaler_output_2 - -1.1331717063)) / 0.214633937943) + (-0.5 * 1.73512523691 - (0.5 * ("ADS_sca_2_OUT".scaler_output_3 - 0.941449945056) * ("ADS_sca_2_OUT".scaler_output_3 - 0.941449945056)) / 0.90235088257) + (-0.5 * -2.60388858324 - (0.5 * ("ADS_sca_2_OUT".scaler_output_4 - -1.49997711021) * ("ADS_sca_2_OUT".scaler_output_4 - -1.49997711021)) / 0.0117751294013) + (-0.5 * -2.07734272701 - (0.5 * ("ADS_sca_2_OUT".scaler_output_5 - -1.42297530867) * ("ADS_sca_2_OUT".scaler_output_5 - -1.42297530867)) / 0.0199361663259) AS "Score_0", CAST(NULL AS FLOAT) AS "LogProba_1", CAST(NULL AS FLOAT) AS "Proba_1", -1.0498221245 + (-0.5 * 1.08034212042 - (0.5 * ("ADS_sca_2_OUT".scaler_output_2 - 0.0321866525356) * ("ADS_sca_2_OUT".scaler_output_2 - 0.0321866525356)) / 0.468820672065) + (-0.5 * 1.37526238262 - (0.5 * ("ADS_sca_2_OUT".scaler_output_3 - -0.546768628303) * ("ADS_sca_2_OUT".scaler_output_3 - -0.546768628303)) / 0.629635194421) + (-0.5 * -0.56234416778 - (0.5 * ("ADS_sca_2_OUT".scaler_output_4 - 0.169462930223) * ("ADS_sca_2_OUT".scaler_output_4 - 0.169462930223)) / 0.0906978855965) + (-0.5 * -0.61313859664 - (0.5 * ("ADS_sca_2_OUT".scaler_output_5 - 0.0434579295455) * ("ADS_sca_2_OUT".scaler_output_5 - 0.0434579295455)) / 0.0862059857861) AS "Score_1", CAST(NULL AS FLOAT) AS "LogProba_2", CAST(NULL AS FLOAT) AS "Proba_2", -0.967584026262 + (-0.5 * 1.20777496616 - (0.5 * ("ADS_sca_2_OUT".scaler_output_2 - 0.775502716616) * ("ADS_sca_2_OUT".scaler_output_2 - 0.775502716616)) / 0.532537426026) + (-0.5 * 1.0998638447 - (0.5 * ("ADS_sca_2_OUT".scaler_output_3 - -0.165322276998) * ("ADS_sca_2_OUT".scaler_output_3 - -0.165322276998)) / 0.478062777367) + (-0.5 * -0.603337962641 - (0.5 * ("ADS_sca_2_OUT".scaler_output_4 - 0.909688932048) * ("ADS_sca_2_OUT".scaler_output_4 - 0.909688932048)) / 0.087055012807) + (-0.5 * -0.028707961011 - (0.5 * ("ADS_sca_2_OUT".scaler_output_5 - 0.971034363158) * ("ADS_sca_2_OUT".scaler_output_5 - 0.971034363158)) / 0.154650889616) AS "Score_2" 
FROM "ADS_sca_2_OUT"), 
orig_cte AS 
