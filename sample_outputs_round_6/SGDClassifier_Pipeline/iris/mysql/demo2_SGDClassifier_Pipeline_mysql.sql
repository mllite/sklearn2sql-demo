...
FROM `ADS_imp_1_OUT`), 
linear_model_cte AS 
(SELECT `ADS_sca_2_OUT`.`KEY` AS `KEY`, -11.177346230450505 * `ADS_sca_2_OUT`.scaler_output_2 + 10.938278320568461 * `ADS_sca_2_OUT`.scaler_output_3 + -18.11475931715321 * `ADS_sca_2_OUT`.scaler_output_4 + -13.821788889571234 * `ADS_sca_2_OUT`.scaler_output_5 + -19.5934969171 AS `Score_0`, 13.286592844517614 * `ADS_sca_2_OUT`.scaler_output_2 + -10.753925315165592 * `ADS_sca_2_OUT`.scaler_output_3 + 24.742506008650945 * `ADS_sca_2_OUT`.scaler_output_4 + -5.484836860940937 * `ADS_sca_2_OUT`.scaler_output_5 + -4.51743042854 AS `Score_1`, 0.8968450170048137 * `ADS_sca_2_OUT`.scaler_output_2 + -2.703844079241661 * `ADS_sca_2_OUT`.scaler_output_3 + 35.158695423440236 * `ADS_sca_2_OUT`.scaler_output_4 + 24.462372399796724 * `ADS_sca_2_OUT`.scaler_output_5 + -34.8133559716 AS `Score_2` 
FROM `ADS_sca_2_OUT`), 
orig_cte AS 
