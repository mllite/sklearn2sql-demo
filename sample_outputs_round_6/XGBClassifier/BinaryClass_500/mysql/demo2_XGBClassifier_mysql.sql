...
FROM (SELECT 0 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 0 AS depth, CAST(NULL AS SIGNED INTEGER) AS parent_id, -0.0084507 AS `Score`) AS `Values`), 
`DT_Output` AS 
...
`DT_node_data_1` AS 
(SELECT `Values`.node_id AS node_id, `Values`.feature AS feature, `Values`.threshold AS threshold, `Values`.depth AS depth, `Values`.parent_id AS parent_id, `Values`.`Score` AS `Score` 
FROM (SELECT 0 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 0 AS depth, CAST(NULL AS SIGNED INTEGER) AS parent_id, -0.00693148 AS `Score`) AS `Values`), 
`DT_Output_1` AS 
...
`DT_node_data_2` AS 
(SELECT `Values`.node_id AS node_id, `Values`.feature AS feature, `Values`.threshold AS threshold, `Values`.depth AS depth, `Values`.parent_id AS parent_id, `Values`.`Score` AS `Score` 
FROM (SELECT 0 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 0 AS depth, CAST(NULL AS SIGNED INTEGER) AS parent_id, -0.00568587 AS `Score`) AS `Values`), 
`DT_Output_2` AS 
...
`DT_node_data_3` AS 
(SELECT `Values`.node_id AS node_id, `Values`.feature AS feature, `Values`.threshold AS threshold, `Values`.depth AS depth, `Values`.parent_id AS parent_id, `Values`.`Score` AS `Score` 
FROM (SELECT 0 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 0 AS depth, CAST(NULL AS SIGNED INTEGER) AS parent_id, -0.00466427 AS `Score`) AS `Values`), 
`DT_Output_3` AS 
...
`DT_node_data_4` AS 
(SELECT `Values`.node_id AS node_id, `Values`.feature AS feature, `Values`.threshold AS threshold, `Values`.depth AS depth, `Values`.parent_id AS parent_id, `Values`.`Score` AS `Score` 
FROM (SELECT 0 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 0 AS depth, CAST(NULL AS SIGNED INTEGER) AS parent_id, -0.00382629 AS `Score`) AS `Values`), 
`DT_Output_4` AS 
...
`DT_node_data_5` AS 
(SELECT `Values`.node_id AS node_id, `Values`.feature AS feature, `Values`.threshold AS threshold, `Values`.depth AS depth, `Values`.parent_id AS parent_id, `Values`.`Score` AS `Score` 
FROM (SELECT 0 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 0 AS depth, CAST(NULL AS SIGNED INTEGER) AS parent_id, -0.00765339 AS `Score`) AS `Values`), 
`DT_Output_5` AS 
...
`DT_node_data_6` AS 
(SELECT `Values`.node_id AS node_id, `Values`.feature AS feature, `Values`.threshold AS threshold, `Values`.depth AS depth, `Values`.parent_id AS parent_id, `Values`.`Score` AS `Score` 
FROM (SELECT 0 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 0 AS depth, CAST(NULL AS SIGNED INTEGER) AS parent_id, -0.0062778 AS `Score`) AS `Values`), 
`DT_Output_6` AS 
...
`DT_node_data_7` AS 
(SELECT `Values`.node_id AS node_id, `Values`.feature AS feature, `Values`.threshold AS threshold, `Values`.depth AS depth, `Values`.parent_id AS parent_id, `Values`.`Score` AS `Score` 
FROM (SELECT 0 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 0 AS depth, CAST(NULL AS SIGNED INTEGER) AS parent_id, -0.00514979 AS `Score`) AS `Values`), 
`DT_Output_7` AS 
...
`DT_node_data_8` AS 
(SELECT `Values`.node_id AS node_id, `Values`.feature AS feature, `Values`.threshold AS threshold, `Values`.depth AS depth, `Values`.parent_id AS parent_id, `Values`.`Score` AS `Score` 
FROM (SELECT 0 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 0 AS depth, CAST(NULL AS SIGNED INTEGER) AS parent_id, -0.00422454 AS `Score`) AS `Values`), 
`DT_Output_8` AS 
...
`DT_node_data_9` AS 
(SELECT `Values`.node_id AS node_id, `Values`.feature AS feature, `Values`.threshold AS threshold, `Values`.depth AS depth, `Values`.parent_id AS parent_id, `Values`.`Score` AS `Score` 
FROM (SELECT 0 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 0 AS depth, CAST(NULL AS SIGNED INTEGER) AS parent_id, -0.00346555 AS `Score`) AS `Values`), 
`DT_Output_9` AS 
