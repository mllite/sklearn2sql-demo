...
(SELECT multinomial_cte.[KEY] AS [KEY], 0.356955380577 AS [Proba_0], CASE WHEN (0.356955380577 IS NULL OR 0.356955380577 > 0.0) THEN log(0.356955380577) ELSE -1.79769313486231e+308 END AS [LogProba_0], 0.643044619423 AS [Proba_1], CASE WHEN (0.643044619423 IS NULL OR 0.643044619423 > 0.0) THEN log(0.643044619423) ELSE -1.79769313486231e+308 END AS [LogProba_1], multinomial_cte.multinomial_expr AS [Decision] 
