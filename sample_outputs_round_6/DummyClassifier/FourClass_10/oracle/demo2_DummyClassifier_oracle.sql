...
(SELECT multinomial_cte."KEY" AS "KEY", 0.283582089552 AS "Proba_0", CASE WHEN (0.283582089552 IS NULL OR 0.283582089552 > 0.0) THEN ln(0.283582089552) ELSE -BINARY_FLOAT_INFINITY END AS "LogProba_0", 0.238805970149 AS "Proba_1", CASE WHEN (0.238805970149 IS NULL OR 0.238805970149 > 0.0) THEN ln(0.238805970149) ELSE -BINARY_FLOAT_INFINITY END AS "LogProba_1", 0.208955223881 AS "Proba_2", CASE WHEN (0.208955223881 IS NULL OR 0.208955223881 > 0.0) THEN ln(0.208955223881) ELSE -BINARY_FLOAT_INFINITY END AS "LogProba_2", 0.268656716418 AS "Proba_3", CASE WHEN (0.268656716418 IS NULL OR 0.268656716418 > 0.0) THEN ln(0.268656716418) ELSE -BINARY_FLOAT_INFINITY END AS "LogProba_3", multinomial_cte.multinomial_expr AS "Decision" 
