...
(SELECT multinomial_cte."KEY" AS "KEY", 0.462686567164 AS "Proba_0", CASE WHEN (0.462686567164 IS NULL OR 0.462686567164 > 0.0) THEN ln(0.462686567164) ELSE -BINARY_FLOAT_INFINITY END AS "LogProba_0", 0.537313432836 AS "Proba_1", CASE WHEN (0.537313432836 IS NULL OR 0.537313432836 > 0.0) THEN ln(0.537313432836) ELSE -BINARY_FLOAT_INFINITY END AS "LogProba_1", multinomial_cte.multinomial_expr AS "Decision" 
