...
(SELECT multinomial_cte."KEY" AS "KEY", 0.44776119403 AS "Proba_0", CASE WHEN (0.44776119403 IS NULL OR 0.44776119403 > 0.0) THEN ln(0.44776119403) ELSE -BINARY_FLOAT_INFINITY END AS "LogProba_0", 0.55223880597 AS "Proba_1", CASE WHEN (0.55223880597 IS NULL OR 0.55223880597 > 0.0) THEN ln(0.55223880597) ELSE -BINARY_FLOAT_INFINITY END AS "LogProba_1", multinomial_cte.multinomial_expr AS "Decision" 
