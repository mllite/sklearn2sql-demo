...
(SELECT multinomial_cte."KEY" AS "KEY", 0.253731343284 AS "Proba_0", CASE WHEN (0.253731343284 IS NULL OR 0.253731343284 > 0.0) THEN ln(0.253731343284) ELSE -BINARY_FLOAT_INFINITY END AS "LogProba_0", 0.164179104478 AS "Proba_1", CASE WHEN (0.164179104478 IS NULL OR 0.164179104478 > 0.0) THEN ln(0.164179104478) ELSE -BINARY_FLOAT_INFINITY END AS "LogProba_1", 0.34328358209 AS "Proba_2", CASE WHEN (0.34328358209 IS NULL OR 0.34328358209 > 0.0) THEN ln(0.34328358209) ELSE -BINARY_FLOAT_INFINITY END AS "LogProba_2", 0.238805970149 AS "Proba_3", CASE WHEN (0.238805970149 IS NULL OR 0.238805970149 > 0.0) THEN ln(0.238805970149) ELSE -BINARY_FLOAT_INFINITY END AS "LogProba_3", multinomial_cte.multinomial_expr AS "Decision" 
