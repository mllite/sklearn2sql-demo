...
FROM `ADS_imp_1_OUT`), 
linear_model_cte AS 
(SELECT `ADS_sca_2_OUT`.`KEY` AS `KEY`, 0.07312066581692261 * `ADS_sca_2_OUT`.scaler_output_2 + 0.2192712079303278 * `ADS_sca_2_OUT`.scaler_output_3 + -0.6359144344853961 * `ADS_sca_2_OUT`.scaler_output_4 + -0.1525484873255854 * `ADS_sca_2_OUT`.scaler_output_5 + -0.46 AS `Score_0`, 0.06494651784420198 * `ADS_sca_2_OUT`.scaler_output_2 + -0.3697949179287254 * `ADS_sca_2_OUT`.scaler_output_3 + 0.43852321948328243 * `ADS_sca_2_OUT`.scaler_output_4 + -0.5473483167745209 * `ADS_sca_2_OUT`.scaler_output_5 + -0.3 AS `Score_1`, -0.13806718366112486 * `ADS_sca_2_OUT`.scaler_output_2 + 0.15052370999839715 * `ADS_sca_2_OUT`.scaler_output_3 + 0.19739121500210857 * `ADS_sca_2_OUT`.scaler_output_4 + 0.6998968041001118 * `ADS_sca_2_OUT`.scaler_output_5 + -0.24 AS `Score_2` 
FROM `ADS_sca_2_OUT`), 
orig_cte AS 
