...
FROM [ADS_imp_1_OUT]), 
linear_model_cte AS 
(SELECT [ADS_sca_2_OUT].[KEY] AS [KEY], -0.647631420748718 * [ADS_sca_2_OUT].scaler_output_2 + 1.234457066681435 * [ADS_sca_2_OUT].scaler_output_3 + -1.4836614416892697 * [ADS_sca_2_OUT].scaler_output_4 + -1.2441068159813886 * [ADS_sca_2_OUT].scaler_output_5 + -1.88971612585 AS [Score_0], 0.1935739474397066 * [ADS_sca_2_OUT].scaler_output_2 + -0.984119579185331 * [ADS_sca_2_OUT].scaler_output_3 + 0.5438263105831411 * [ADS_sca_2_OUT].scaler_output_4 + -0.8175789179983194 * [ADS_sca_2_OUT].scaler_output_5 + -0.715700327026 AS [Score_1], 0.00545949813930245 * [ADS_sca_2_OUT].scaler_output_2 + -0.3306737081641732 * [ADS_sca_2_OUT].scaler_output_3 + 1.859284049452996 * [ADS_sca_2_OUT].scaler_output_4 + 2.4262028849235513 * [ADS_sca_2_OUT].scaler_output_5 + -2.06278525822 AS [Score_2] 
FROM [ADS_sca_2_OUT]), 
orig_cte AS 
