...
(SELECT multinomial_cte."KEY" AS "KEY", 0.27 AS "Proba_0", CASE WHEN (0.27 IS NULL OR 0.27 > 0.0) THEN ln(0.27) ELSE -BINARY_FLOAT_INFINITY END AS "LogProba_0", 0.35 AS "Proba_1", CASE WHEN (0.35 IS NULL OR 0.35 > 0.0) THEN ln(0.35) ELSE -BINARY_FLOAT_INFINITY END AS "LogProba_1", 0.38 AS "Proba_2", CASE WHEN (0.38 IS NULL OR 0.38 > 0.0) THEN ln(0.38) ELSE -BINARY_FLOAT_INFINITY END AS "LogProba_2", multinomial_cte.multinomial_expr AS "Decision" 
