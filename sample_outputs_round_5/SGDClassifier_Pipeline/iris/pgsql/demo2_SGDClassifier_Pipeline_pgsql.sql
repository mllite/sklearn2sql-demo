...
FROM "ADS_imp_1_OUT"), 
linear_model_cte AS 
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", -3.512642983269373 * "ADS_sca_2_OUT".scaler_output_2 + 16.991201997961685 * "ADS_sca_2_OUT".scaler_output_3 + -13.9247578897866 * "ADS_sca_2_OUT".scaler_output_4 + -10.110382613667843 * "ADS_sca_2_OUT".scaler_output_5 + -9.6624996625 AS "Score_0", -4.34305503605172 * "ADS_sca_2_OUT".scaler_output_2 + -15.270573947535139 * "ADS_sca_2_OUT".scaler_output_3 + 20.146889728683476 * "ADS_sca_2_OUT".scaler_output_4 + -9.196243136844346 * "ADS_sca_2_OUT".scaler_output_5 + -10.4783835029 AS "Score_1", -10.728923721948146 * "ADS_sca_2_OUT".scaler_output_2 + -7.312669214312677 * "ADS_sca_2_OUT".scaler_output_3 + 29.48008748702856 * "ADS_sca_2_OUT".scaler_output_4 + 29.947209260737672 * "ADS_sca_2_OUT".scaler_output_5 + -37.237588582 AS "Score_2" 
FROM "ADS_sca_2_OUT"), 
orig_cte AS 
