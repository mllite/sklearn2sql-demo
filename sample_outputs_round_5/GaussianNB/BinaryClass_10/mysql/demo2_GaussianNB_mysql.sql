...
WITH `RawScores` AS 
(SELECT `ADS`.`KEY` AS `KEY`, NULL AS `LogProba_0`, NULL AS `Proba_0`, -0.593774706747 + (-0.5 * 2.07914140437 - (0.5 * (`ADS`.`Feature_0` - 0.0248749231071) * (`ADS`.`Feature_0` - 0.0248749231071)) / 1.27285745539) + (-0.5 * 1.37096807983 - (0.5 * (`ADS`.`Feature_1` - -0.0748116127298) * (`ADS`.`Feature_1` - -0.0748116127298)) / 0.626937147508) + (-0.5 * 1.60756473369 - (0.5 * (`ADS`.`Feature_2` - 0.197366245997) * (`ADS`.`Feature_2` - 0.197366245997)) / 0.794285482412) + (-0.5 * 2.46021007664 - (0.5 * (`ADS`.`Feature_3` - 0.26768268929) * (`ADS`.`Feature_3` - 0.26768268929)) / 1.86327000294) + (-0.5 * 2.56659055651 - (0.5 * (`ADS`.`Feature_4` - 0.353735272105) * (`ADS`.`Feature_4` - 0.353735272105)) / 2.07241271244) + (-0.5 * 2.10409810683 - (0.5 * (`ADS`.`Feature_5` - -0.049122046887) * (`ADS`.`Feature_5` - -0.049122046887)) / 1.30502348975) + (-0.5 * 0.796700286146 - (0.5 * (`ADS`.`Feature_6` - -0.976954666454) * (`ADS`.`Feature_6` - -0.976954666454)) / 0.353038988103) + (-0.5 * 1.48573670677 - (0.5 * (`ADS`.`Feature_7` - -0.57352432421) * (`ADS`.`Feature_7` - -0.57352432421)) / 0.70318141676) + (-0.5 * 1.84618208613 - (0.5 * (`ADS`.`Feature_8` - 0.0191511652953) * (`ADS`.`Feature_8` - 0.0191511652953)) / 1.00833960207) + (-0.5 * 2.01038680527 - (0.5 * (`ADS`.`Feature_9` - -0.0831327456626) * (`ADS`.`Feature_9` - -0.0831327456626)) / 1.18828339308) AS `Score_0`, NULL AS `LogProba_1`, NULL AS `Proba_1`, -0.803495237729 + (-0.5 * 1.84086826459 - (0.5 * (`ADS`.`Feature_0` - -0.0507936665742) * (`ADS`.`Feature_0` - -0.0507936665742)) / 1.00299567627) + (-0.5 * 2.07243419983 - (0.5 * (`ADS`.`Feature_1` - 0.206461211318) * (`ADS`.`Feature_1` - 0.206461211318)) / 1.26434870693) + (-0.5 * 1.89430779305 - (0.5 * (`ADS`.`Feature_2` - -0.142874364699) * (`ADS`.`Feature_2` - -0.142874364699)) / 1.05805331735) + (-0.5 * 2.18845496954 - (0.5 * (`ADS`.`Feature_3` - -0.0269293464651) * (`ADS`.`Feature_3` - -0.0269293464651)) / 1.41988786918) + (-0.5 * 2.25457913244 - (0.5 * (`ADS`.`Feature_4` - -0.556753732069) * (`ADS`.`Feature_4` - -0.556753732069)) / 1.51695049453) + (-0.5 * 1.74467684197 - (0.5 * (`ADS`.`Feature_5` - -0.0886655562136) * (`ADS`.`Feature_5` - -0.0886655562136)) / 0.911011075354) + (-0.5 * 1.22656358136 - (0.5 * (`ADS`.`Feature_6` - 0.940493416633) * (`ADS`.`Feature_6` - 0.940493416633)) / 0.542637654333) + (-0.5 * 1.29813923235 - (0.5 * (`ADS`.`Feature_7` - 0.65405544685) * (`ADS`.`Feature_7` - 0.65405544685)) / 0.582901049144) + (-0.5 * 1.56243094359 - (0.5 * (`ADS`.`Feature_8` - 0.0422415898653) * (`ADS`.`Feature_8` - 0.0422415898653)) / 0.759233336344) + (-0.5 * 1.59703679294 - (0.5 * (`ADS`.`Feature_9` - -0.076166395875) * (`ADS`.`Feature_9` - -0.076166395875)) / 0.78596715617) AS `Score_1` 
