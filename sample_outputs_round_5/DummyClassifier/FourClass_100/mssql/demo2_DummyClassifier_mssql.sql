...
multinomial_cte AS 
(SELECT random_number_cte.[KEY] AS [KEY], CASE WHEN (random_number_cte.uniform <= 0.238805970149) THEN 0 ELSE CASE WHEN (random_number_cte.uniform <= 0.507462686567) THEN 1 ELSE CASE WHEN (random_number_cte.uniform <= 0.791044776119) THEN 2 ELSE CASE WHEN (random_number_cte.uniform <= 1.0) THEN 3 END END END END AS multinomial_expr 
FROM random_number_cte), 
dummy_class_reg_cte AS 
(SELECT multinomial_cte.[KEY] AS [KEY], 0.238805970149 AS [Proba_0], CASE WHEN (0.238805970149 IS NULL OR 0.238805970149 > 0.0) THEN log(0.238805970149) ELSE -1.79769313486231e+308 END AS [LogProba_0], 0.268656716418 AS [Proba_1], CASE WHEN (0.268656716418 IS NULL OR 0.268656716418 > 0.0) THEN log(0.268656716418) ELSE -1.79769313486231e+308 END AS [LogProba_1], 0.283582089552 AS [Proba_2], CASE WHEN (0.283582089552 IS NULL OR 0.283582089552 > 0.0) THEN log(0.283582089552) ELSE -1.79769313486231e+308 END AS [LogProba_2], 0.208955223881 AS [Proba_3], CASE WHEN (0.208955223881 IS NULL OR 0.208955223881 > 0.0) THEN log(0.208955223881) ELSE -1.79769313486231e+308 END AS [LogProba_3], multinomial_cte.multinomial_expr AS [Decision] 
