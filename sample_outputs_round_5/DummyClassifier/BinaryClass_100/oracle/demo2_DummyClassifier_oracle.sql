...
(SELECT multinomial_cte."KEY" AS "KEY", 0.492537313433 AS "Proba_0", CASE WHEN (0.492537313433 IS NULL OR 0.492537313433 > 0.0) THEN ln(0.492537313433) ELSE -BINARY_FLOAT_INFINITY END AS "LogProba_0", 0.507462686567 AS "Proba_1", CASE WHEN (0.507462686567 IS NULL OR 0.507462686567 > 0.0) THEN ln(0.507462686567) ELSE -BINARY_FLOAT_INFINITY END AS "LogProba_1", multinomial_cte.multinomial_expr AS "Decision" 
