...
(SELECT multinomial_cte."KEY" AS "KEY", 0.522388059701 AS "Proba_0", CASE WHEN (0.522388059701 IS NULL OR 0.522388059701 > 0.0) THEN ln(0.522388059701) ELSE -BINARY_FLOAT_INFINITY END AS "LogProba_0", 0.477611940299 AS "Proba_1", CASE WHEN (0.477611940299 IS NULL OR 0.477611940299 > 0.0) THEN ln(0.477611940299) ELSE -BINARY_FLOAT_INFINITY END AS "LogProba_1", multinomial_cte.multinomial_expr AS "Decision" 
