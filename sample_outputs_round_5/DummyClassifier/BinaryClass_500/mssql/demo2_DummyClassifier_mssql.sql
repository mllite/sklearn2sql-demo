...
(SELECT multinomial_cte.[KEY] AS [KEY], 0.522388059701 AS [Proba_0], CASE WHEN (0.522388059701 IS NULL OR 0.522388059701 > 0.0) THEN log(0.522388059701) ELSE -1.79769313486231e+308 END AS [LogProba_0], 0.477611940299 AS [Proba_1], CASE WHEN (0.477611940299 IS NULL OR 0.477611940299 > 0.0) THEN log(0.477611940299) ELSE -1.79769313486231e+308 END AS [LogProba_1], multinomial_cte.multinomial_expr AS [Decision] 
