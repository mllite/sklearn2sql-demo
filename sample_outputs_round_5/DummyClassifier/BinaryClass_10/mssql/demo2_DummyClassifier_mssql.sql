...
(SELECT multinomial_cte.[KEY] AS [KEY], 0.507462686567 AS [Proba_0], CASE WHEN (0.507462686567 IS NULL OR 0.507462686567 > 0.0) THEN log(0.507462686567) ELSE -1.79769313486231e+308 END AS [LogProba_0], 0.492537313433 AS [Proba_1], CASE WHEN (0.492537313433 IS NULL OR 0.492537313433 > 0.0) THEN log(0.492537313433) ELSE -1.79769313486231e+308 END AS [LogProba_1], multinomial_cte.multinomial_expr AS [Decision] 
