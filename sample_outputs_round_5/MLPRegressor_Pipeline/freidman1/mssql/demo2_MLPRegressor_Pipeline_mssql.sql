...
[ADS_sca_2_OUT] AS 
(SELECT [ADS_imp_1_OUT].[KEY] AS [KEY], (CAST([ADS_imp_1_OUT].impter_2 AS FLOAT) - 0.52040694462) / 0.277952337281 AS scaler_2, (CAST([ADS_imp_1_OUT].impter_3 AS FLOAT) - 0.488817916378) / 0.263695417862 AS scaler_3, (CAST([ADS_imp_1_OUT].impter_4 AS FLOAT) - 0.476660767814) / 0.287407327172 AS scaler_4, (CAST([ADS_imp_1_OUT].impter_5 AS FLOAT) - 0.474946755464) / 0.277247380425 AS scaler_5, (CAST([ADS_imp_1_OUT].impter_6 AS FLOAT) - 0.457208905191) / 0.284960835303 AS scaler_6, (CAST([ADS_imp_1_OUT].impter_7 AS FLOAT) - 0.515605000352) / 0.288908238828 AS scaler_7, (CAST([ADS_imp_1_OUT].impter_8 AS FLOAT) - 0.489229141818) / 0.273906464646 AS scaler_8, (CAST([ADS_imp_1_OUT].impter_9 AS FLOAT) - 0.501541190264) / 0.303240173732 AS scaler_9, (CAST([ADS_imp_1_OUT].impter_10 AS FLOAT) - 0.530047564906) / 0.27881629628 AS scaler_10, (CAST([ADS_imp_1_OUT].impter_11 AS FLOAT) - 0.474404746343) / 0.252578507023 AS scaler_11 
FROM [ADS_imp_1_OUT]), 
[IL] AS 
