...
-- Code For temporary table tmp_20180508180402_codegen_bnhgxo_ads_imp_1_out part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180508180402_codegen_bnhgxo_ads_imp_1_out (
	"KEY" BIGINT, 
	impter_2 DOUBLE, 
	impter_3 DOUBLE, 
	impter_4 DOUBLE, 
...
-- Code For temporary table tmp_20180508180402_codegen_f59gby_ads_sca_2_out part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180508180402_codegen_f59gby_ads_sca_2_out (
	"KEY" BIGINT, 
	scaler_2 DOUBLE, 
	scaler_3 DOUBLE, 
	scaler_4 DOUBLE, 
...
FROM tmp_20180508180402_codegen_bnhgxo_ads_imp_1_out AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT"

-- Code For temporary table tmp_20180508180402_codegen_1mqfir_hl_1_relu_1 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180508180402_codegen_1mqfir_hl_1_relu_1 (
	"KEY" BIGINT, 
	"NEUR_1_1" DOUBLE, 
	"NEUR_1_2" DOUBLE, 
	"NEUR_1_3" DOUBLE
...
-- Code For temporary table tmp_20180508180402_codegen_1mqfir_hl_1_relu_1 part 2. Populate

INSERT INTO tmp_20180508180402_codegen_1mqfir_hl_1_relu_1 WITH "IL" AS 
...
FROM tmp_20180508180402_codegen_f59gby_ads_sca_2_out AS "ADS_sca_2_OUT"), 
"HL_BA_1" AS 
...
-- Code For temporary table tmp_20180508180402_codegen_xp7qqp_ol_logistic_1 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180508180402_codegen_xp7qqp_ol_logistic_1 (
	"KEY" BIGINT, 
	"NEUR_3_1" DOUBLE
)
...
-- Code For temporary table tmp_20180508180402_codegen_xp7qqp_ol_logistic_1 part 2. Populate

INSERT INTO tmp_20180508180402_codegen_xp7qqp_ol_logistic_1 WITH "HL_BA_2" AS 
...
FROM tmp_20180508180402_codegen_1mqfir_hl_1_relu_1 AS "HL_1_relu_1"), 
"HL_2_relu" AS 
...
FROM tmp_20180508180402_codegen_xp7qqp_ol_logistic_1 AS "OL_logistic_1"), 
