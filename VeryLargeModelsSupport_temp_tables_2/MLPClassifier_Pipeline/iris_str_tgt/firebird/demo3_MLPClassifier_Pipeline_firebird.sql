...
-- Code For temporary table TMP_20180508190648_CODEGEN_LU0J part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508190648_CODEGEN_LU0J" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20180508190648_CODEGEN_LU0J part 2. Populate

INSERT INTO "TMP_20180508190648_CODEGEN_LU0J" ("KEY", imputer_output_2, imputer_output_3, imputer_output_4, imputer_output_5) SELECT "U"."KEY", "U".imputer_output_2, "U".imputer_output_3, "U".imputer_output_4, "U".imputer_output_5 
...
-- Code For temporary table TMP_20180508190648_CODEGEN_LU0J part 3. Create Index 

CREATE INDEX "ix_TMP_20180508190648_C_7a07" ON "TMP_20180508190648_CODEGEN_LU0J" ("KEY")

-- Code For temporary table TMP_20180508190648_CODEGEN_10MN part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508190648_CODEGEN_10MN" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20180508190648_CODEGEN_10MN part 2. Populate

INSERT INTO "TMP_20180508190648_CODEGEN_10MN" ("KEY", scaler_output_2, scaler_output_3, scaler_output_4, scaler_output_5) SELECT "U"."KEY", "U".scaler_output_2, "U".scaler_output_3, "U".scaler_output_4, "U".scaler_output_5 
...
FROM "TMP_20180508190648_CODEGEN_LU0J" AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT") AS "U"

-- Code For temporary table TMP_20180508190648_CODEGEN_10MN part 3. Create Index 

CREATE INDEX "ix_TMP_20180508190648_C_be11" ON "TMP_20180508190648_CODEGEN_10MN" ("KEY")

-- Code For temporary table TMP_20180508190648_CODEGEN_1QTA part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508190648_CODEGEN_1QTA" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20180508190648_CODEGEN_1QTA part 2. Populate

INSERT INTO "TMP_20180508190648_CODEGEN_1QTA" ("KEY", "NEUR_1_1", "NEUR_1_2", "NEUR_1_3") SELECT "U"."KEY", "U"."NEUR_1_1", "U"."NEUR_1_2", "U"."NEUR_1_3" 
FROM (WITH "IL" AS 
...
FROM "TMP_20180508190648_CODEGEN_10MN" AS "ADS_sca_2_OUT"), 
"HL_BA_1" AS 
...
-- Code For temporary table TMP_20180508190648_CODEGEN_1QTA part 3. Create Index 

CREATE INDEX "ix_TMP_20180508190648_C_3adf" ON "TMP_20180508190648_CODEGEN_1QTA" ("KEY")

-- Code For temporary table TMP_20180508190648_CODEGEN_OI8J part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508190648_CODEGEN_OI8J" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20180508190648_CODEGEN_OI8J part 2. Populate

INSERT INTO "TMP_20180508190648_CODEGEN_OI8J" ("KEY", "NEUR_3_1", "NEUR_3_2", "NEUR_3_3") SELECT "U"."KEY", "U"."NEUR_3_1", "U"."NEUR_3_2", "U"."NEUR_3_3" 
...
FROM "TMP_20180508190648_CODEGEN_1QTA" AS "HL_1_relu_1"), 
"HL_2_relu" AS 
...
-- Code For temporary table TMP_20180508190648_CODEGEN_OI8J part 3. Create Index 

CREATE INDEX "ix_TMP_20180508190648_C_3b1e" ON "TMP_20180508190648_CODEGEN_OI8J" ("KEY")
...
FROM "TMP_20180508190648_CODEGEN_OI8J" AS "OL_softmax_1"), 
