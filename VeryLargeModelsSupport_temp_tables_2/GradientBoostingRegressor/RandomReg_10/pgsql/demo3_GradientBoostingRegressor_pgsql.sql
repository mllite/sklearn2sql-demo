...
-- Code For temporary table TMP_20180508182214_CODEGEN_V6G3HL_GB_B0 part 1. Create 


CREATE TEMPORARY TABLE "TMP_20180508182214_CODEGEN_V6G3HL_GB_B0" (
	"KEY" BIGINT, 
	"Estimator" FLOAT
)
...
-- Code For temporary table TMP_20180508182214_CODEGEN_V6G3HL_GB_B0 part 2. Populate
...
FROM "DT_Output_9")
 INSERT INTO "TMP_20180508182214_CODEGEN_V6G3HL_GB_B0" ("KEY", "Estimator") SELECT "GB_B0"."KEY", "GB_B0"."Estimator" 
...
-- Code For temporary table TMP_20180508182214_CODEGEN_YBHFOZ_GB_B1 part 1. Create 


CREATE TEMPORARY TABLE "TMP_20180508182214_CODEGEN_YBHFOZ_GB_B1" (
	"KEY" BIGINT, 
	"Estimator" FLOAT
)
...
-- Code For temporary table TMP_20180508182214_CODEGEN_YBHFOZ_GB_B1 part 2. Populate
...
FROM "DT_Output_15")
 INSERT INTO "TMP_20180508182214_CODEGEN_YBHFOZ_GB_B1" ("KEY", "Estimator") SELECT "GB_B1"."KEY", "GB_B1"."Estimator" 
...
-- Code For temporary table TMP_20180508182214_CODEGEN_I3EYGR_GB_Union part 1. Create 


CREATE TEMPORARY TABLE "TMP_20180508182214_CODEGEN_I3EYGR_GB_Union" (
	"KEY" BIGINT, 
	"Estimator" FLOAT
)
...
-- Code For temporary table TMP_20180508182214_CODEGEN_I3EYGR_GB_Union part 2. Populate

INSERT INTO "TMP_20180508182214_CODEGEN_I3EYGR_GB_Union" ("KEY", "Estimator") SELECT "GB_Union"."KEY", "GB_Union"."Estimator" 
...
FROM "TMP_20180508182214_CODEGEN_V6G3HL_GB_B0" AS "GB_B0" UNION ALL SELECT "GB_B1"."KEY" AS "KEY", "GB_B1"."Estimator" AS "Estimator" 
FROM "TMP_20180508182214_CODEGEN_YBHFOZ_GB_B1" AS "GB_B1") AS "GB_EnsembleUnion") AS "GB_Union"

-- Code For temporary table TMP_20180508182214_CODEGEN_C0WOYP_GB_sum part 1. Create 


CREATE TEMPORARY TABLE "TMP_20180508182214_CODEGEN_C0WOYP_GB_sum" (
	"KEY" BIGINT NOT NULL, 
	"Estimator" FLOAT, 
	PRIMARY KEY ("KEY")
)
...
-- Code For temporary table TMP_20180508182214_CODEGEN_C0WOYP_GB_sum part 2. Populate

INSERT INTO "TMP_20180508182214_CODEGEN_C0WOYP_GB_sum" ("KEY", "Estimator") SELECT "GB_sum"."KEY", "GB_sum"."Estimator" 
...
FROM "TMP_20180508182214_CODEGEN_I3EYGR_GB_Union" AS "GB_Union" GROUP BY "GB_Union"."KEY") AS "T") AS "GB_sum"

-- Code For temporary table TMP_20180508182214_CODEGEN_C0WOYP_GB_sum part 3. Create Index 

CREATE INDEX "ix_TMP_20180508182214_CODEGEN_C0WOYP_GB_sum_KEY" ON "TMP_20180508182214_CODEGEN_C0WOYP_GB_sum" ("KEY")

-- Model deployment code

SELECT "GB_sum"."KEY" AS "KEY", 26.405852730652413 + 0.1 * "GB_sum"."Estimator" AS "Estimator" 
FROM "TMP_20180508182214_CODEGEN_C0WOYP_GB_sum" AS "GB_sum"