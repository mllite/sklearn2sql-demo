...
-- Code For temporary table TMP_20180508182215_CODEGEN_ANP9 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508182215_CODEGEN_ANP9" (
	"KEY" BIGINT, 
...
-- Code For temporary table TMP_20180508182215_CODEGEN_ANP9 part 2. Populate

INSERT INTO "TMP_20180508182215_CODEGEN_ANP9" ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
-- Code For temporary table TMP_20180508182215_CODEGEN_9WG9 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508182215_CODEGEN_9WG9" (
	"KEY" BIGINT, 
	"Estimator" DOUBLE PRECISION
)
...
-- Code For temporary table TMP_20180508182215_CODEGEN_9WG9 part 2. Populate

INSERT INTO "TMP_20180508182215_CODEGEN_9WG9" ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
-- Code For temporary table TMP_20180508182215_CODEGEN_0KIP part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508182215_CODEGEN_0KIP" (
	"KEY" BIGINT, 
	"Estimator" DOUBLE PRECISION
)
...
-- Code For temporary table TMP_20180508182215_CODEGEN_0KIP part 2. Populate

INSERT INTO "TMP_20180508182215_CODEGEN_0KIP" ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
FROM "TMP_20180508182215_CODEGEN_ANP9" AS "GB_B0" UNION ALL SELECT "GB_B1"."KEY" AS "KEY", "GB_B1"."Estimator" AS "Estimator" 
FROM "TMP_20180508182215_CODEGEN_9WG9" AS "GB_B1") AS "GB_EnsembleUnion") AS "GB_Union") AS "U"

-- Code For temporary table TMP_20180508182215_CODEGEN_XXJP part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508182215_CODEGEN_XXJP" (
	"KEY" BIGINT NOT NULL, 
	"Estimator" DOUBLE PRECISION, 
	PRIMARY KEY ("KEY")
)
...
-- Code For temporary table TMP_20180508182215_CODEGEN_XXJP part 2. Populate

INSERT INTO "TMP_20180508182215_CODEGEN_XXJP" ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
FROM "TMP_20180508182215_CODEGEN_0KIP" AS "GB_Union" GROUP BY "GB_Union"."KEY") AS "T") AS "GB_sum") AS "U"

-- Code For temporary table TMP_20180508182215_CODEGEN_XXJP part 3. Create Index 

CREATE INDEX "ix_TMP_20180508182215_C_60a3" ON "TMP_20180508182215_CODEGEN_XXJP" ("KEY")

-- Model deployment code

SELECT "GB_sum"."KEY" AS "KEY", 26.405852730652413 + 0.1 * "GB_sum"."Estimator" AS "Estimator" 
FROM "TMP_20180508182215_CODEGEN_XXJP" AS "GB_sum"