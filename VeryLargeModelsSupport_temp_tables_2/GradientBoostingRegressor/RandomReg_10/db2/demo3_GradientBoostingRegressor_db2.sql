...
-- Code For temporary table tmp_20180508182217_codegen_xznzft_gb_b0 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180508182217_codegen_xznzft_gb_b0 (
	"KEY" BIGINT, 
	"Estimator" DOUBLE
)
...
-- Code For temporary table tmp_20180508182217_codegen_xznzft_gb_b0 part 2. Populate

INSERT INTO tmp_20180508182217_codegen_xznzft_gb_b0 WITH "DT_node_lookup" AS 
...
-- Code For temporary table tmp_20180508182217_codegen_qgmk34_gb_b1 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180508182217_codegen_qgmk34_gb_b1 (
	"KEY" BIGINT, 
	"Estimator" DOUBLE
)
...
-- Code For temporary table tmp_20180508182217_codegen_qgmk34_gb_b1 part 2. Populate

INSERT INTO tmp_20180508182217_codegen_qgmk34_gb_b1 WITH "DT_node_lookup_10" AS 
...
-- Code For temporary table tmp_20180508182217_codegen_jlfs52_gb_union part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180508182217_codegen_jlfs52_gb_union (
	"KEY" BIGINT, 
	"Estimator" DOUBLE
)
...
-- Code For temporary table tmp_20180508182217_codegen_jlfs52_gb_union part 2. Populate

INSERT INTO tmp_20180508182217_codegen_jlfs52_gb_union SELECT "GB_Union"."KEY", "GB_Union"."Estimator" 
...
FROM tmp_20180508182217_codegen_xznzft_gb_b0 AS "GB_B0" UNION ALL SELECT "GB_B1"."KEY" AS "KEY", "GB_B1"."Estimator" AS "Estimator" 
FROM tmp_20180508182217_codegen_qgmk34_gb_b1 AS "GB_B1") AS "GB_EnsembleUnion") AS "GB_Union"

-- Code For temporary table tmp_20180508182217_codegen_t4sx99_gb_sum part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180508182217_codegen_t4sx99_gb_sum (
	"KEY" BIGINT, 
	"Estimator" DOUBLE
)
...
-- Code For temporary table tmp_20180508182217_codegen_t4sx99_gb_sum part 2. Populate

INSERT INTO tmp_20180508182217_codegen_t4sx99_gb_sum SELECT "GB_sum"."KEY", "GB_sum"."Estimator" 
...
FROM tmp_20180508182217_codegen_jlfs52_gb_union AS "GB_Union" GROUP BY "GB_Union"."KEY") AS "T") AS "GB_sum"

-- Model deployment code

SELECT "GB_sum"."KEY" AS "KEY", 26.405852730652413 + 0.1 * "GB_sum"."Estimator" AS "Estimator" 
FROM tmp_20180508182217_codegen_t4sx99_gb_sum AS "GB_sum"