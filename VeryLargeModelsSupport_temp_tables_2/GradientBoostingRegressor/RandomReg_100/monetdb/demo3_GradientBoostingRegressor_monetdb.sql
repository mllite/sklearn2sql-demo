...
-- Code For temporary table tmp_20180508182559_codegen_khzidg_gb_b0 part 1. Create 


CREATE TEMPORARY TABLE tmp_20180508182559_codegen_khzidg_gb_b0 (
	"KEY" BIGINT, 
	"Estimator" DOUBLE
)
...
-- Code For temporary table tmp_20180508182559_codegen_khzidg_gb_b0 part 2. Populate

INSERT INTO tmp_20180508182559_codegen_khzidg_gb_b0 ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
-- Code For temporary table tmp_20180508182559_codegen_rgjwr6_gb_b1 part 1. Create 


CREATE TEMPORARY TABLE tmp_20180508182559_codegen_rgjwr6_gb_b1 (
	"KEY" BIGINT, 
	"Estimator" DOUBLE
)
...
-- Code For temporary table tmp_20180508182559_codegen_rgjwr6_gb_b1 part 2. Populate

INSERT INTO tmp_20180508182559_codegen_rgjwr6_gb_b1 ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
-- Code For temporary table tmp_20180508182559_codegen_d1ux3a_gb_union part 1. Create 


CREATE TEMPORARY TABLE tmp_20180508182559_codegen_d1ux3a_gb_union (
	"KEY" BIGINT, 
	"Estimator" DOUBLE
)
...
-- Code For temporary table tmp_20180508182559_codegen_d1ux3a_gb_union part 2. Populate

INSERT INTO tmp_20180508182559_codegen_d1ux3a_gb_union ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
FROM tmp_20180508182559_codegen_khzidg_gb_b0 AS "GB_B0" UNION ALL SELECT "GB_B1"."KEY" AS "KEY", "GB_B1"."Estimator" AS "Estimator" 
FROM tmp_20180508182559_codegen_rgjwr6_gb_b1 AS "GB_B1") AS "GB_EnsembleUnion") AS "GB_Union") AS "U"

-- Code For temporary table tmp_20180508182559_codegen_kt5cry_gb_sum part 1. Create 


CREATE TEMPORARY TABLE tmp_20180508182559_codegen_kt5cry_gb_sum (
	"KEY" BIGINT, 
	"Estimator" DOUBLE
)
...
-- Code For temporary table tmp_20180508182559_codegen_kt5cry_gb_sum part 2. Populate

INSERT INTO tmp_20180508182559_codegen_kt5cry_gb_sum ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
FROM tmp_20180508182559_codegen_d1ux3a_gb_union AS "GB_Union" GROUP BY "GB_Union"."KEY") AS "T") AS "GB_sum") AS "U"

-- Model deployment code

SELECT "GB_sum"."KEY" AS "KEY", -11.471614782695335 + 0.1 * "GB_sum"."Estimator" AS "Estimator" 
FROM tmp_20180508182559_codegen_kt5cry_gb_sum AS "GB_sum"