...
-- Code For temporary table tmp_20180509003438_codegen_2538pu_gb_b0 part 1. Create 

CREATE TEMPORARY TABLE `tmp_20180509003438_codegen_2538pu_gb_b0` STORED AS ORC AS WITH `DT_node_lookup` AS 
...
-- Code For temporary table tmp_20180509003438_codegen_2538pu_gb_b0 part 2. Populate

SELECT * FROM `tmp_20180509003438_codegen_2538pu_gb_b0`

-- Code For temporary table tmp_20180509003438_codegen_iidv0l_gb_b1 part 1. Create 

CREATE TEMPORARY TABLE `tmp_20180509003438_codegen_iidv0l_gb_b1` STORED AS ORC AS WITH `DT_node_lookup_10` AS 
...
-- Code For temporary table tmp_20180509003438_codegen_iidv0l_gb_b1 part 2. Populate

SELECT * FROM `tmp_20180509003438_codegen_iidv0l_gb_b1`

-- Code For temporary table tmp_20180509003438_codegen_isdota_gb_union part 1. Create 

CREATE TEMPORARY TABLE `tmp_20180509003438_codegen_isdota_gb_union` STORED AS ORC AS SELECT `GB_Union`.`KEY`, `GB_Union`.`Estimator` 
...
FROM `tmp_20180509003438_codegen_2538pu_gb_b0` AS `GB_B0` UNION ALL SELECT `GB_B1`.`KEY` AS `KEY`, `GB_B1`.`Estimator` AS `Estimator` 
FROM `tmp_20180509003438_codegen_iidv0l_gb_b1` AS `GB_B1`) AS `GB_EnsembleUnion`) AS `GB_Union`

-- Code For temporary table tmp_20180509003438_codegen_isdota_gb_union part 2. Populate

SELECT * FROM `tmp_20180509003438_codegen_isdota_gb_union`

-- Code For temporary table tmp_20180509003438_codegen_5w1wgg_gb_sum part 1. Create 

CREATE TEMPORARY TABLE `tmp_20180509003438_codegen_5w1wgg_gb_sum` STORED AS ORC AS SELECT `GB_sum`.`KEY`, `GB_sum`.`Estimator` 
...
FROM `tmp_20180509003438_codegen_isdota_gb_union` AS `GB_Union` GROUP BY `GB_Union`.`KEY`) AS `T`) AS `GB_sum`

-- Code For temporary table tmp_20180509003438_codegen_5w1wgg_gb_sum part 2. Populate

SELECT * FROM `tmp_20180509003438_codegen_5w1wgg_gb_sum`

-- Model deployment code

SELECT `GB_sum`.`KEY` AS `KEY`, 154.07365439093485 + 0.1 * `GB_sum`.`Estimator` AS `Estimator` 
FROM `tmp_20180509003438_codegen_5w1wgg_gb_sum` AS `GB_sum`