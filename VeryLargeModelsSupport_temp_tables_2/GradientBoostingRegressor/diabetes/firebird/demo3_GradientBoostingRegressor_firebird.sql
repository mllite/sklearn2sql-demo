...
-- Code For temporary table TMP_20180508183351_CODEGEN_EV53 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508183351_CODEGEN_EV53" (
	"KEY" BIGINT, 
...
-- Code For temporary table TMP_20180508183351_CODEGEN_EV53 part 2. Populate

INSERT INTO "TMP_20180508183351_CODEGEN_EV53" ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
-- Code For temporary table TMP_20180508183351_CODEGEN_EP5Y part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508183351_CODEGEN_EP5Y" (
	"KEY" BIGINT, 
	"Estimator" DOUBLE PRECISION
)
...
-- Code For temporary table TMP_20180508183351_CODEGEN_EP5Y part 2. Populate

INSERT INTO "TMP_20180508183351_CODEGEN_EP5Y" ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
-- Code For temporary table TMP_20180508183351_CODEGEN_Y0NX part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508183351_CODEGEN_Y0NX" (
	"KEY" BIGINT, 
	"Estimator" DOUBLE PRECISION
)
...
-- Code For temporary table TMP_20180508183351_CODEGEN_Y0NX part 2. Populate

INSERT INTO "TMP_20180508183351_CODEGEN_Y0NX" ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
FROM "TMP_20180508183351_CODEGEN_EV53" AS "GB_B0" UNION ALL SELECT "GB_B1"."KEY" AS "KEY", "GB_B1"."Estimator" AS "Estimator" 
FROM "TMP_20180508183351_CODEGEN_EP5Y" AS "GB_B1") AS "GB_EnsembleUnion") AS "GB_Union") AS "U"

-- Code For temporary table TMP_20180508183351_CODEGEN_FGWI part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508183351_CODEGEN_FGWI" (
	"KEY" BIGINT NOT NULL, 
	"Estimator" DOUBLE PRECISION, 
	PRIMARY KEY ("KEY")
)
...
-- Code For temporary table TMP_20180508183351_CODEGEN_FGWI part 2. Populate

INSERT INTO "TMP_20180508183351_CODEGEN_FGWI" ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
FROM "TMP_20180508183351_CODEGEN_Y0NX" AS "GB_Union" GROUP BY "GB_Union"."KEY") AS "T") AS "GB_sum") AS "U"

-- Code For temporary table TMP_20180508183351_CODEGEN_FGWI part 3. Create Index 

CREATE INDEX "ix_TMP_20180508183351_C_1b61" ON "TMP_20180508183351_CODEGEN_FGWI" ("KEY")

-- Model deployment code

SELECT "GB_sum"."KEY" AS "KEY", 154.07365439093485 + 0.1 * "GB_sum"."Estimator" AS "Estimator" 
FROM "TMP_20180508183351_CODEGEN_FGWI" AS "GB_sum"