...
-- Code For temporary table tmp_20180509004250_codegen_oehjxg_bag_b0 part 1. Create 

CREATE TEMPORARY TABLE `tmp_20180509004250_codegen_oehjxg_bag_b0` STORED AS ORC AS WITH `DT_node_lookup` AS 
...
-- Code For temporary table tmp_20180509004250_codegen_oehjxg_bag_b0 part 2. Populate

SELECT * FROM `tmp_20180509004250_codegen_oehjxg_bag_b0`

-- Code For temporary table tmp_20180509004250_codegen_9r1tu8_bag_b1 part 1. Create 

CREATE TEMPORARY TABLE `tmp_20180509004250_codegen_9r1tu8_bag_b1` STORED AS ORC AS WITH `DT_node_lookup_10` AS 
...
-- Code For temporary table tmp_20180509004250_codegen_9r1tu8_bag_b1 part 2. Populate

SELECT * FROM `tmp_20180509004250_codegen_9r1tu8_bag_b1`

-- Code For temporary table tmp_20180509004250_codegen_8h6g6r_bag_union part 1. Create 

CREATE TEMPORARY TABLE `tmp_20180509004250_codegen_8h6g6r_bag_union` STORED AS ORC AS SELECT `BAG_Union`.`KEY`, `BAG_Union`.`Estimator` 
...
FROM `tmp_20180509004250_codegen_oehjxg_bag_b0` AS `BAG_B0` UNION ALL SELECT `BAG_B1`.`KEY` AS `KEY`, `BAG_B1`.`Estimator` AS `Estimator` 
FROM `tmp_20180509004250_codegen_9r1tu8_bag_b1` AS `BAG_B1`) AS `BAG_EnsembleUnion`) AS `BAG_Union`

-- Code For temporary table tmp_20180509004250_codegen_8h6g6r_bag_union part 2. Populate

SELECT * FROM `tmp_20180509004250_codegen_8h6g6r_bag_union`

-- Code For temporary table tmp_20180509004250_codegen_zvkkfk_bag_avg part 1. Create 

CREATE TEMPORARY TABLE `tmp_20180509004250_codegen_zvkkfk_bag_avg` STORED AS ORC AS SELECT `BAG_avg`.`KEY`, `BAG_avg`.`Estimator` 
...
FROM `tmp_20180509004250_codegen_8h6g6r_bag_union` AS `BAG_Union` GROUP BY `BAG_Union`.`KEY`) AS `T`) AS `BAG_avg`

-- Code For temporary table tmp_20180509004250_codegen_zvkkfk_bag_avg part 2. Populate

SELECT * FROM `tmp_20180509004250_codegen_zvkkfk_bag_avg`

-- Model deployment code

SELECT `BAG_avg`.`KEY` AS `KEY`, `BAG_avg`.`Estimator` AS `Estimator` 
FROM `tmp_20180509004250_codegen_zvkkfk_bag_avg` AS `BAG_avg`