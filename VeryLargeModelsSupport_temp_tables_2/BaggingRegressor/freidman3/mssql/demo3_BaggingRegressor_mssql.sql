...
-- Code For temporary table ##TMP_20180508185101_CODEGEN_EM9WPD_BAG_B0 part 1. Create 


CREATE TABLE ##TMP_20180508185101_CODEGEN_EM9WPD_BAG_B0 (
	[KEY] BIGINT NULL, 
...
-- Code For temporary table ##TMP_20180508185101_CODEGEN_EM9WPD_BAG_B0 part 2. Populate
...
FROM [DT_Output_9])
 INSERT INTO ##TMP_20180508185101_CODEGEN_EM9WPD_BAG_B0 ([KEY], [Estimator]) SELECT [BAG_B0].[KEY], [BAG_B0].[Estimator] 
...
-- Code For temporary table ##TMP_20180508185101_CODEGEN_OCTI5P_BAG_B1 part 1. Create 


CREATE TABLE ##TMP_20180508185101_CODEGEN_OCTI5P_BAG_B1 (
	[KEY] BIGINT NULL, 
	[Estimator] FLOAT(53) NULL
)
...
-- Code For temporary table ##TMP_20180508185101_CODEGEN_OCTI5P_BAG_B1 part 2. Populate
...
FROM [DT_Output_15])
 INSERT INTO ##TMP_20180508185101_CODEGEN_OCTI5P_BAG_B1 ([KEY], [Estimator]) SELECT [BAG_B1].[KEY], [BAG_B1].[Estimator] 
...
-- Code For temporary table ##TMP_20180508185101_CODEGEN_162F7E_BAG_Union part 1. Create 


CREATE TABLE ##TMP_20180508185101_CODEGEN_162F7E_BAG_Union (
	[KEY] BIGINT NULL, 
	[Estimator] FLOAT(53) NULL
)
...
-- Code For temporary table ##TMP_20180508185101_CODEGEN_162F7E_BAG_Union part 2. Populate

INSERT INTO ##TMP_20180508185101_CODEGEN_162F7E_BAG_Union ([KEY], [Estimator]) SELECT [BAG_Union].[KEY], [BAG_Union].[Estimator] 
...
FROM ##TMP_20180508185101_CODEGEN_EM9WPD_BAG_B0 AS [BAG_B0] UNION ALL SELECT [BAG_B1].[KEY] AS [KEY], [BAG_B1].[Estimator] AS [Estimator] 
FROM ##TMP_20180508185101_CODEGEN_OCTI5P_BAG_B1 AS [BAG_B1]) AS [BAG_EnsembleUnion]) AS [BAG_Union]

-- Code For temporary table ##TMP_20180508185101_CODEGEN_YHSOVO_BAG_avg part 1. Create 


CREATE TABLE ##TMP_20180508185101_CODEGEN_YHSOVO_BAG_avg (
	[KEY] BIGINT NULL, 
	[Estimator] FLOAT(53) NULL
)
...
-- Code For temporary table ##TMP_20180508185101_CODEGEN_YHSOVO_BAG_avg part 2. Populate

INSERT INTO ##TMP_20180508185101_CODEGEN_YHSOVO_BAG_avg ([KEY], [Estimator]) SELECT [BAG_avg].[KEY], [BAG_avg].[Estimator] 
...
FROM ##TMP_20180508185101_CODEGEN_162F7E_BAG_Union AS [BAG_Union] GROUP BY [BAG_Union].[KEY]) AS [T]) AS [BAG_avg]

-- Model deployment code

SELECT [BAG_avg].[KEY] AS [KEY], [BAG_avg].[Estimator] AS [Estimator] 
FROM ##TMP_20180508185101_CODEGEN_YHSOVO_BAG_avg AS [BAG_avg]