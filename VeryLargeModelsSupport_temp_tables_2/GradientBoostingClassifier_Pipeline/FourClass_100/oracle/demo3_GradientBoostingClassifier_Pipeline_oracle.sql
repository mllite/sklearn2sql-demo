...
-- Code For temporary table DEGEN_VFHEZO_ADS_IMP_1_OUT part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "DEGEN_VFHEZO_ADS_IMP_1_OUT" (
	"KEY" NUMBER(19), 
...
-- Code For temporary table DEGEN_PAA2D1_ADS_SCA_2_OUT part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "DEGEN_PAA2D1_ADS_SCA_2_OUT" (
	"KEY" NUMBER(19), 
...
FROM "DEGEN_VFHEZO_ADS_IMP_1_OUT" "ADS_imp_1_OUT") "ADS_sca_2_OUT") "U"

-- Code For temporary table 81740_CODEGEN_HZVJ0F_GB_B0 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "81740_CODEGEN_HZVJ0F_GB_B0" (
	"KEY" NUMBER(19), 
...
-- Code For temporary table 81740_CODEGEN_HZVJ0F_GB_B0 part 2. Populate

INSERT INTO "81740_CODEGEN_HZVJ0F_GB_B0" ("KEY", "Score_0", "Score_1", "Score_2", "Score_3") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1", "U"."Score_2", "U"."Score_3" 
...
FROM "DEGEN_PAA2D1_ADS_SCA_2_OUT" "ADS_sca_2_OUT"), 
"DT_node_data" AS 
...
-- Code For temporary table 81740_CODEGEN_J47TOL_GB_B1 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "81740_CODEGEN_J47TOL_GB_B1" (
	"KEY" NUMBER(19), 
	"Score_0" BINARY_DOUBLE, 
	"Score_1" BINARY_DOUBLE, 
	"Score_2" BINARY_DOUBLE, 
...
-- Code For temporary table 81740_CODEGEN_J47TOL_GB_B1 part 2. Populate

INSERT INTO "81740_CODEGEN_J47TOL_GB_B1" ("KEY", "Score_0", "Score_1", "Score_2", "Score_3") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1", "U"."Score_2", "U"."Score_3" 
...
-- Code For temporary table 81740_CODEGEN_L5EVKZ_GB_B2 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "81740_CODEGEN_L5EVKZ_GB_B2" (
	"KEY" NUMBER(19), 
	"Score_0" BINARY_DOUBLE, 
	"Score_1" BINARY_DOUBLE, 
	"Score_2" BINARY_DOUBLE, 
...
-- Code For temporary table 81740_CODEGEN_L5EVKZ_GB_B2 part 2. Populate

INSERT INTO "81740_CODEGEN_L5EVKZ_GB_B2" ("KEY", "Score_0", "Score_1", "Score_2", "Score_3") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1", "U"."Score_2", "U"."Score_3" 
...
-- Code For temporary table 81740_CODEGEN_0CLFVN_GB_B3 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "81740_CODEGEN_0CLFVN_GB_B3" (
	"KEY" NUMBER(19), 
	"Score_0" BINARY_DOUBLE, 
	"Score_1" BINARY_DOUBLE, 
	"Score_2" BINARY_DOUBLE, 
...
-- Code For temporary table 81740_CODEGEN_0CLFVN_GB_B3 part 2. Populate

INSERT INTO "81740_CODEGEN_0CLFVN_GB_B3" ("KEY", "Score_0", "Score_1", "Score_2", "Score_3") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1", "U"."Score_2", "U"."Score_3" 
...
-- Code For temporary table 81740_CODEGEN_DR6OPJ_GB_B4 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "81740_CODEGEN_DR6OPJ_GB_B4" (
	"KEY" NUMBER(19), 
	"Score_0" BINARY_DOUBLE, 
	"Score_1" BINARY_DOUBLE, 
	"Score_2" BINARY_DOUBLE, 
...
-- Code For temporary table 81740_CODEGEN_DR6OPJ_GB_B4 part 2. Populate

INSERT INTO "81740_CODEGEN_DR6OPJ_GB_B4" ("KEY", "Score_0", "Score_1", "Score_2", "Score_3") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1", "U"."Score_2", "U"."Score_3" 
...
-- Code For temporary table 81740_CODEGEN_1KA5L7_GB_B5 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "81740_CODEGEN_1KA5L7_GB_B5" (
	"KEY" NUMBER(19), 
	"Score_0" BINARY_DOUBLE, 
	"Score_1" BINARY_DOUBLE, 
	"Score_2" BINARY_DOUBLE, 
...
-- Code For temporary table 81740_CODEGEN_1KA5L7_GB_B5 part 2. Populate

INSERT INTO "81740_CODEGEN_1KA5L7_GB_B5" ("KEY", "Score_0", "Score_1", "Score_2", "Score_3") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1", "U"."Score_2", "U"."Score_3" 
...
-- Code For temporary table 81740_CODEGEN_29JIPO_GB_B6 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "81740_CODEGEN_29JIPO_GB_B6" (
	"KEY" NUMBER(19), 
	"Score_0" BINARY_DOUBLE, 
	"Score_1" BINARY_DOUBLE, 
	"Score_2" BINARY_DOUBLE, 
...
-- Code For temporary table 81740_CODEGEN_29JIPO_GB_B6 part 2. Populate

INSERT INTO "81740_CODEGEN_29JIPO_GB_B6" ("KEY", "Score_0", "Score_1", "Score_2", "Score_3") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1", "U"."Score_2", "U"."Score_3" 
...
-- Code For temporary table 40_CODEGEN_REWEAX_GB_UNION part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "40_CODEGEN_REWEAX_GB_UNION" (
	"KEY" NUMBER(19), 
	"Score_0" BINARY_DOUBLE, 
	"Score_1" BINARY_DOUBLE, 
	"Score_2" BINARY_DOUBLE, 
...
-- Code For temporary table 40_CODEGEN_REWEAX_GB_UNION part 2. Populate

INSERT INTO "40_CODEGEN_REWEAX_GB_UNION" ("KEY", "Score_0", "Score_1", "Score_2", "Score_3") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1", "U"."Score_2", "U"."Score_3" 
...
FROM "81740_CODEGEN_HZVJ0F_GB_B0" "GB_B0" UNION ALL SELECT "GB_B1"."KEY" AS "KEY", "GB_B1"."Score_0" AS "Score_0", "GB_B1"."Score_1" AS "Score_1", "GB_B1"."Score_2" AS "Score_2", "GB_B1"."Score_3" AS "Score_3" 
FROM "81740_CODEGEN_J47TOL_GB_B1" "GB_B1" UNION ALL SELECT "GB_B2"."KEY" AS "KEY", "GB_B2"."Score_0" AS "Score_0", "GB_B2"."Score_1" AS "Score_1", "GB_B2"."Score_2" AS "Score_2", "GB_B2"."Score_3" AS "Score_3" 
FROM "81740_CODEGEN_L5EVKZ_GB_B2" "GB_B2" UNION ALL SELECT "GB_B3"."KEY" AS "KEY", "GB_B3"."Score_0" AS "Score_0", "GB_B3"."Score_1" AS "Score_1", "GB_B3"."Score_2" AS "Score_2", "GB_B3"."Score_3" AS "Score_3" 
FROM "81740_CODEGEN_0CLFVN_GB_B3" "GB_B3" UNION ALL SELECT "GB_B4"."KEY" AS "KEY", "GB_B4"."Score_0" AS "Score_0", "GB_B4"."Score_1" AS "Score_1", "GB_B4"."Score_2" AS "Score_2", "GB_B4"."Score_3" AS "Score_3" 
FROM "81740_CODEGEN_DR6OPJ_GB_B4" "GB_B4" UNION ALL SELECT "GB_B5"."KEY" AS "KEY", "GB_B5"."Score_0" AS "Score_0", "GB_B5"."Score_1" AS "Score_1", "GB_B5"."Score_2" AS "Score_2", "GB_B5"."Score_3" AS "Score_3" 
FROM "81740_CODEGEN_1KA5L7_GB_B5" "GB_B5" UNION ALL SELECT "GB_B6"."KEY" AS "KEY", "GB_B6"."Score_0" AS "Score_0", "GB_B6"."Score_1" AS "Score_1", "GB_B6"."Score_2" AS "Score_2", "GB_B6"."Score_3" AS "Score_3" 
FROM "81740_CODEGEN_29JIPO_GB_B6" "GB_B6") "GB_EnsembleUnion") "GB_Union") "U"

-- Code For temporary table 1740_CODEGEN_REKHVE_GB_SUM part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "1740_CODEGEN_REKHVE_GB_SUM" (
	"KEY" NUMBER(19), 
	"Score_0" BINARY_DOUBLE, 
	"Score_1" BINARY_DOUBLE, 
	"Score_2" BINARY_DOUBLE, 
...
-- Code For temporary table 1740_CODEGEN_REKHVE_GB_SUM part 2. Populate

INSERT INTO "1740_CODEGEN_REKHVE_GB_SUM" ("KEY", "Score_0", "Score_1", "Score_2", "Score_3") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1", "U"."Score_2", "U"."Score_3" 
...
FROM "40_CODEGEN_REWEAX_GB_UNION" "GB_Union" GROUP BY "GB_Union"."KEY") "T") "GB_sum") "U"
...
FROM "1740_CODEGEN_REKHVE_GB_SUM" "GB_sum"), 
