...
-- Code For temporary table TMP_20180508181739_CODEGEN_EPOSVS_ADS_imp_1_OUT part 1. Create 


CREATE TEMPORARY TABLE "TMP_20180508181739_CODEGEN_EPOSVS_ADS_imp_1_OUT" (
	"KEY" BIGINT NOT NULL, 
	impter_2 FLOAT, 
	impter_3 FLOAT, 
	impter_4 FLOAT, 
...
-- Code For temporary table TMP_20180508181739_CODEGEN_EPOSVS_ADS_imp_1_OUT part 3. Create Index 

CREATE INDEX "ix_TMP_20180508181739_CODEGEN_EPOSVS_ADS_imp_1_OUT_KEY" ON "TMP_20180508181739_CODEGEN_EPOSVS_ADS_imp_1_OUT" ("KEY")

-- Code For temporary table TMP_20180508181739_CODEGEN_SI5IA2_ADS_sca_2_OUT part 1. Create 


CREATE TEMPORARY TABLE "TMP_20180508181739_CODEGEN_SI5IA2_ADS_sca_2_OUT" (
	"KEY" BIGINT NOT NULL, 
	scaler_2 FLOAT, 
	scaler_3 FLOAT, 
	scaler_4 FLOAT, 
...
FROM "TMP_20180508181739_CODEGEN_EPOSVS_ADS_imp_1_OUT" AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT"

-- Code For temporary table TMP_20180508181739_CODEGEN_SI5IA2_ADS_sca_2_OUT part 3. Create Index 

CREATE INDEX "ix_TMP_20180508181739_CODEGEN_SI5IA2_ADS_sca_2_OUT_KEY" ON "TMP_20180508181739_CODEGEN_SI5IA2_ADS_sca_2_OUT" ("KEY")

-- Code For temporary table TMP_20180508181740_CODEGEN_2SK8C9_GB_B0 part 1. Create 


CREATE TEMPORARY TABLE "TMP_20180508181740_CODEGEN_2SK8C9_GB_B0" (
	"KEY" BIGINT, 
	"Score_0" FLOAT, 
	"Score_1" FLOAT, 
	"Score_2" FLOAT, 
...
-- Code For temporary table TMP_20180508181740_CODEGEN_2SK8C9_GB_B0 part 2. Populate
...
FROM "TMP_20180508181739_CODEGEN_SI5IA2_ADS_sca_2_OUT" AS "ADS_sca_2_OUT"), 
"DT_node_data" AS 
...
FROM "DT_Output_9")
 INSERT INTO "TMP_20180508181740_CODEGEN_2SK8C9_GB_B0" ("KEY", "Score_0", "Score_1", "Score_2", "Score_3") SELECT "GB_B0"."KEY", "GB_B0"."Score_0", "GB_B0"."Score_1", "GB_B0"."Score_2", "GB_B0"."Score_3" 
...
-- Code For temporary table TMP_20180508181740_CODEGEN_JCOPSS_GB_B1 part 1. Create 


CREATE TEMPORARY TABLE "TMP_20180508181740_CODEGEN_JCOPSS_GB_B1" (
	"KEY" BIGINT, 
	"Score_0" FLOAT, 
	"Score_1" FLOAT, 
	"Score_2" FLOAT, 
...
-- Code For temporary table TMP_20180508181740_CODEGEN_JCOPSS_GB_B1 part 2. Populate
...
FROM "DT_Output_19")
 INSERT INTO "TMP_20180508181740_CODEGEN_JCOPSS_GB_B1" ("KEY", "Score_0", "Score_1", "Score_2", "Score_3") SELECT "GB_B1"."KEY", "GB_B1"."Score_0", "GB_B1"."Score_1", "GB_B1"."Score_2", "GB_B1"."Score_3" 
...
-- Code For temporary table TMP_20180508181740_CODEGEN_5G2DSM_GB_B2 part 1. Create 


CREATE TEMPORARY TABLE "TMP_20180508181740_CODEGEN_5G2DSM_GB_B2" (
	"KEY" BIGINT, 
	"Score_0" FLOAT, 
	"Score_1" FLOAT, 
	"Score_2" FLOAT, 
...
-- Code For temporary table TMP_20180508181740_CODEGEN_5G2DSM_GB_B2 part 2. Populate
...
FROM "DT_Output_29")
 INSERT INTO "TMP_20180508181740_CODEGEN_5G2DSM_GB_B2" ("KEY", "Score_0", "Score_1", "Score_2", "Score_3") SELECT "GB_B2"."KEY", "GB_B2"."Score_0", "GB_B2"."Score_1", "GB_B2"."Score_2", "GB_B2"."Score_3" 
...
-- Code For temporary table TMP_20180508181740_CODEGEN_I8LELT_GB_B3 part 1. Create 


CREATE TEMPORARY TABLE "TMP_20180508181740_CODEGEN_I8LELT_GB_B3" (
	"KEY" BIGINT, 
	"Score_0" FLOAT, 
	"Score_1" FLOAT, 
	"Score_2" FLOAT, 
...
-- Code For temporary table TMP_20180508181740_CODEGEN_I8LELT_GB_B3 part 2. Populate
...
FROM "DT_Output_39")
 INSERT INTO "TMP_20180508181740_CODEGEN_I8LELT_GB_B3" ("KEY", "Score_0", "Score_1", "Score_2", "Score_3") SELECT "GB_B3"."KEY", "GB_B3"."Score_0", "GB_B3"."Score_1", "GB_B3"."Score_2", "GB_B3"."Score_3" 
...
-- Code For temporary table TMP_20180508181740_CODEGEN_3DCZUK_GB_B4 part 1. Create 


CREATE TEMPORARY TABLE "TMP_20180508181740_CODEGEN_3DCZUK_GB_B4" (
	"KEY" BIGINT, 
	"Score_0" FLOAT, 
	"Score_1" FLOAT, 
	"Score_2" FLOAT, 
...
-- Code For temporary table TMP_20180508181740_CODEGEN_3DCZUK_GB_B4 part 2. Populate
...
FROM "DT_Output_49")
 INSERT INTO "TMP_20180508181740_CODEGEN_3DCZUK_GB_B4" ("KEY", "Score_0", "Score_1", "Score_2", "Score_3") SELECT "GB_B4"."KEY", "GB_B4"."Score_0", "GB_B4"."Score_1", "GB_B4"."Score_2", "GB_B4"."Score_3" 
...
-- Code For temporary table TMP_20180508181740_CODEGEN_NLPYPU_GB_B5 part 1. Create 


CREATE TEMPORARY TABLE "TMP_20180508181740_CODEGEN_NLPYPU_GB_B5" (
	"KEY" BIGINT, 
	"Score_0" FLOAT, 
	"Score_1" FLOAT, 
	"Score_2" FLOAT, 
...
-- Code For temporary table TMP_20180508181740_CODEGEN_NLPYPU_GB_B5 part 2. Populate
...
FROM "DT_Output_59")
 INSERT INTO "TMP_20180508181740_CODEGEN_NLPYPU_GB_B5" ("KEY", "Score_0", "Score_1", "Score_2", "Score_3") SELECT "GB_B5"."KEY", "GB_B5"."Score_0", "GB_B5"."Score_1", "GB_B5"."Score_2", "GB_B5"."Score_3" 
...
-- Code For temporary table TMP_20180508181740_CODEGEN_HXZ6BO_GB_B6 part 1. Create 


CREATE TEMPORARY TABLE "TMP_20180508181740_CODEGEN_HXZ6BO_GB_B6" (
	"KEY" BIGINT, 
	"Score_0" FLOAT, 
	"Score_1" FLOAT, 
	"Score_2" FLOAT, 
...
-- Code For temporary table TMP_20180508181740_CODEGEN_HXZ6BO_GB_B6 part 2. Populate
...
FROM "DT_Output_63")
 INSERT INTO "TMP_20180508181740_CODEGEN_HXZ6BO_GB_B6" ("KEY", "Score_0", "Score_1", "Score_2", "Score_3") SELECT "GB_B6"."KEY", "GB_B6"."Score_0", "GB_B6"."Score_1", "GB_B6"."Score_2", "GB_B6"."Score_3" 
...
-- Code For temporary table TMP_20180508181740_CODEGEN_AVCAGG_GB_Union part 1. Create 


CREATE TEMPORARY TABLE "TMP_20180508181740_CODEGEN_AVCAGG_GB_Union" (
	"KEY" BIGINT, 
	"Score_0" FLOAT, 
	"Score_1" FLOAT, 
	"Score_2" FLOAT, 
...
-- Code For temporary table TMP_20180508181740_CODEGEN_AVCAGG_GB_Union part 2. Populate

INSERT INTO "TMP_20180508181740_CODEGEN_AVCAGG_GB_Union" ("KEY", "Score_0", "Score_1", "Score_2", "Score_3") SELECT "GB_Union"."KEY", "GB_Union"."Score_0", "GB_Union"."Score_1", "GB_Union"."Score_2", "GB_Union"."Score_3" 
...
FROM "TMP_20180508181740_CODEGEN_2SK8C9_GB_B0" AS "GB_B0" UNION ALL SELECT "GB_B1"."KEY" AS "KEY", "GB_B1"."Score_0" AS "Score_0", "GB_B1"."Score_1" AS "Score_1", "GB_B1"."Score_2" AS "Score_2", "GB_B1"."Score_3" AS "Score_3" 
FROM "TMP_20180508181740_CODEGEN_JCOPSS_GB_B1" AS "GB_B1" UNION ALL SELECT "GB_B2"."KEY" AS "KEY", "GB_B2"."Score_0" AS "Score_0", "GB_B2"."Score_1" AS "Score_1", "GB_B2"."Score_2" AS "Score_2", "GB_B2"."Score_3" AS "Score_3" 
FROM "TMP_20180508181740_CODEGEN_5G2DSM_GB_B2" AS "GB_B2" UNION ALL SELECT "GB_B3"."KEY" AS "KEY", "GB_B3"."Score_0" AS "Score_0", "GB_B3"."Score_1" AS "Score_1", "GB_B3"."Score_2" AS "Score_2", "GB_B3"."Score_3" AS "Score_3" 
FROM "TMP_20180508181740_CODEGEN_I8LELT_GB_B3" AS "GB_B3" UNION ALL SELECT "GB_B4"."KEY" AS "KEY", "GB_B4"."Score_0" AS "Score_0", "GB_B4"."Score_1" AS "Score_1", "GB_B4"."Score_2" AS "Score_2", "GB_B4"."Score_3" AS "Score_3" 
FROM "TMP_20180508181740_CODEGEN_3DCZUK_GB_B4" AS "GB_B4" UNION ALL SELECT "GB_B5"."KEY" AS "KEY", "GB_B5"."Score_0" AS "Score_0", "GB_B5"."Score_1" AS "Score_1", "GB_B5"."Score_2" AS "Score_2", "GB_B5"."Score_3" AS "Score_3" 
FROM "TMP_20180508181740_CODEGEN_NLPYPU_GB_B5" AS "GB_B5" UNION ALL SELECT "GB_B6"."KEY" AS "KEY", "GB_B6"."Score_0" AS "Score_0", "GB_B6"."Score_1" AS "Score_1", "GB_B6"."Score_2" AS "Score_2", "GB_B6"."Score_3" AS "Score_3" 
FROM "TMP_20180508181740_CODEGEN_HXZ6BO_GB_B6" AS "GB_B6") AS "GB_EnsembleUnion") AS "GB_Union"

-- Code For temporary table TMP_20180508181740_CODEGEN_1VJBF1_GB_sum part 1. Create 


CREATE TEMPORARY TABLE "TMP_20180508181740_CODEGEN_1VJBF1_GB_sum" (
	"KEY" BIGINT NOT NULL, 
	"Score_0" FLOAT, 
	"Score_1" FLOAT, 
	"Score_2" FLOAT, 
...
-- Code For temporary table TMP_20180508181740_CODEGEN_1VJBF1_GB_sum part 2. Populate

INSERT INTO "TMP_20180508181740_CODEGEN_1VJBF1_GB_sum" ("KEY", "Score_0", "Score_1", "Score_2", "Score_3") SELECT "GB_sum"."KEY", "GB_sum"."Score_0", "GB_sum"."Score_1", "GB_sum"."Score_2", "GB_sum"."Score_3" 
...
FROM "TMP_20180508181740_CODEGEN_AVCAGG_GB_Union" AS "GB_Union" GROUP BY "GB_Union"."KEY") AS "T") AS "GB_sum"

-- Code For temporary table TMP_20180508181740_CODEGEN_1VJBF1_GB_sum part 3. Create Index 

CREATE INDEX "ix_TMP_20180508181740_CODEGEN_1VJBF1_GB_sum_KEY" ON "TMP_20180508181740_CODEGEN_1VJBF1_GB_sum" ("KEY")
...
FROM "TMP_20180508181740_CODEGEN_1VJBF1_GB_sum" AS "GB_sum"), 
