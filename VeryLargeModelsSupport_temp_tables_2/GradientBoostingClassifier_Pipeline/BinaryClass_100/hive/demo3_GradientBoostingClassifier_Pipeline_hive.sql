...
FROM `tmp_20180509002035_codegen_axwtkw_ads_imp_1_out` AS `ADS_imp_1_OUT`) AS `ADS_sca_2_OUT`

-- Code For temporary table tmp_20180509002035_codegen_omzpmo_ads_sca_2_out part 2. Populate

SELECT * FROM `tmp_20180509002035_codegen_omzpmo_ads_sca_2_out`

-- Code For temporary table tmp_20180509002036_codegen_dfs8bx_gb_b0 part 1. Create 

CREATE TEMPORARY TABLE `tmp_20180509002036_codegen_dfs8bx_gb_b0` STORED AS ORC AS WITH `DT_node_lookup` AS 
...
FROM `tmp_20180509002035_codegen_omzpmo_ads_sca_2_out` AS `ADS_sca_2_OUT`), 
`DT_node_data` AS 
...
-- Code For temporary table tmp_20180509002036_codegen_dfs8bx_gb_b0 part 2. Populate

SELECT * FROM `tmp_20180509002036_codegen_dfs8bx_gb_b0`

-- Code For temporary table tmp_20180509002036_codegen_c6w0l9_gb_b1 part 1. Create 

CREATE TEMPORARY TABLE `tmp_20180509002036_codegen_c6w0l9_gb_b1` STORED AS ORC AS WITH `DT_node_lookup_5` AS 
...
-- Code For temporary table tmp_20180509002036_codegen_c6w0l9_gb_b1 part 2. Populate

SELECT * FROM `tmp_20180509002036_codegen_c6w0l9_gb_b1`

-- Code For temporary table tmp_20180509002036_codegen_psvp6v_gb_b2 part 1. Create 

CREATE TEMPORARY TABLE `tmp_20180509002036_codegen_psvp6v_gb_b2` STORED AS ORC AS WITH `DT_node_lookup_10` AS 
...
-- Code For temporary table tmp_20180509002036_codegen_psvp6v_gb_b2 part 2. Populate

SELECT * FROM `tmp_20180509002036_codegen_psvp6v_gb_b2`

-- Code For temporary table tmp_20180509002036_codegen_r4q3dl_gb_b3 part 1. Create 

CREATE TEMPORARY TABLE `tmp_20180509002036_codegen_r4q3dl_gb_b3` STORED AS ORC AS WITH `DT_node_lookup_15` AS 
...
-- Code For temporary table tmp_20180509002036_codegen_r4q3dl_gb_b3 part 2. Populate

SELECT * FROM `tmp_20180509002036_codegen_r4q3dl_gb_b3`

-- Code For temporary table tmp_20180509002036_codegen_ke34go_gb_union part 1. Create 

CREATE TEMPORARY TABLE `tmp_20180509002036_codegen_ke34go_gb_union` STORED AS ORC AS SELECT `GB_Union`.`KEY`, `GB_Union`.`Score_0`, `GB_Union`.`Score_1` 
...
FROM `tmp_20180509002036_codegen_dfs8bx_gb_b0` AS `GB_B0` UNION ALL SELECT `GB_B1`.`KEY` AS `KEY`, `GB_B1`.`Score_0` AS `Score_0`, `GB_B1`.`Score_1` AS `Score_1` 
FROM `tmp_20180509002036_codegen_c6w0l9_gb_b1` AS `GB_B1` UNION ALL SELECT `GB_B2`.`KEY` AS `KEY`, `GB_B2`.`Score_0` AS `Score_0`, `GB_B2`.`Score_1` AS `Score_1` 
FROM `tmp_20180509002036_codegen_psvp6v_gb_b2` AS `GB_B2` UNION ALL SELECT `GB_B3`.`KEY` AS `KEY`, `GB_B3`.`Score_0` AS `Score_0`, `GB_B3`.`Score_1` AS `Score_1` 
FROM `tmp_20180509002036_codegen_r4q3dl_gb_b3` AS `GB_B3`) AS `GB_EnsembleUnion`) AS `GB_Union`

-- Code For temporary table tmp_20180509002036_codegen_ke34go_gb_union part 2. Populate

SELECT * FROM `tmp_20180509002036_codegen_ke34go_gb_union`

-- Code For temporary table tmp_20180509002036_codegen_gqxezd_gb_sum part 1. Create 

CREATE TEMPORARY TABLE `tmp_20180509002036_codegen_gqxezd_gb_sum` STORED AS ORC AS SELECT `GB_sum`.`KEY`, `GB_sum`.`Score_0`, `GB_sum`.`Score_1` 
...
FROM `tmp_20180509002036_codegen_ke34go_gb_union` AS `GB_Union` GROUP BY `GB_Union`.`KEY`) AS `T`) AS `GB_sum`

-- Code For temporary table tmp_20180509002036_codegen_gqxezd_gb_sum part 2. Populate

SELECT * FROM `tmp_20180509002036_codegen_gqxezd_gb_sum`

-- Model deployment code

WITH `orig_cte` AS 
(SELECT `GB_sum`.`KEY` AS `KEY`, -(-0.10008345855698253 + 0.1 * `GB_sum`.`Score_1`) AS `Score_0`, -0.10008345855698253 + 0.1 * `GB_sum`.`Score_1` AS `Score_1`, 1.0 - 1.0 / (1.0 + exp(-(-0.10008345855698253 + 0.1 * `GB_sum`.`Score_1`))) AS `Proba_0`, 1.0 / (1.0 + exp(-(-0.10008345855698253 + 0.1 * `GB_sum`.`Score_1`))) AS `Proba_1`, CAST(NULL AS DOUBLE) AS `LogProba_0`, CAST(NULL AS DOUBLE) AS `LogProba_1`, CAST(NULL AS BIGINT) AS `Decision`, CAST(NULL AS DOUBLE) AS `DecisionProba` 
FROM `tmp_20180509002036_codegen_gqxezd_gb_sum` AS `GB_sum`), 
