...
-- Code For temporary table TMP_20180508180317_CODEGEN_123S part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508180317_CODEGEN_123S" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20180508180317_CODEGEN_123S part 3. Create Index 

CREATE INDEX "ix_TMP_20180508180317_C_4d48" ON "TMP_20180508180317_CODEGEN_123S" ("KEY")

-- Code For temporary table TMP_20180508180317_CODEGEN_UEJV part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508180317_CODEGEN_UEJV" (
	"KEY" BIGINT NOT NULL, 
...
FROM "TMP_20180508180317_CODEGEN_123S" AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT") AS "U"

-- Code For temporary table TMP_20180508180317_CODEGEN_UEJV part 3. Create Index 

CREATE INDEX "ix_TMP_20180508180317_C_986c" ON "TMP_20180508180317_CODEGEN_UEJV" ("KEY")

-- Code For temporary table TMP_20180508180317_CODEGEN_9LMO part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508180317_CODEGEN_9LMO" (
	"KEY" BIGINT, 
...
-- Code For temporary table TMP_20180508180317_CODEGEN_9LMO part 2. Populate

INSERT INTO "TMP_20180508180317_CODEGEN_9LMO" ("KEY", "Score_0", "Score_1") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1" 
...
FROM "TMP_20180508180317_CODEGEN_UEJV" AS "ADS_sca_2_OUT"), 
"DT_node_data" AS 
...
-- Code For temporary table TMP_20180508180317_CODEGEN_B2G3 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508180317_CODEGEN_B2G3" (
	"KEY" BIGINT, 
	"Score_0" DOUBLE PRECISION, 
	"Score_1" DOUBLE PRECISION
)
...
-- Code For temporary table TMP_20180508180317_CODEGEN_B2G3 part 2. Populate

INSERT INTO "TMP_20180508180317_CODEGEN_B2G3" ("KEY", "Score_0", "Score_1") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1" 
...
-- Code For temporary table TMP_20180508180317_CODEGEN_G0QQ part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508180317_CODEGEN_G0QQ" (
	"KEY" BIGINT, 
	"Score_0" DOUBLE PRECISION, 
	"Score_1" DOUBLE PRECISION
)
...
-- Code For temporary table TMP_20180508180317_CODEGEN_G0QQ part 2. Populate

INSERT INTO "TMP_20180508180317_CODEGEN_G0QQ" ("KEY", "Score_0", "Score_1") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1" 
...
-- Code For temporary table TMP_20180508180317_CODEGEN_QN6R part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508180317_CODEGEN_QN6R" (
	"KEY" BIGINT, 
	"Score_0" DOUBLE PRECISION, 
	"Score_1" DOUBLE PRECISION
)
...
-- Code For temporary table TMP_20180508180317_CODEGEN_QN6R part 2. Populate

INSERT INTO "TMP_20180508180317_CODEGEN_QN6R" ("KEY", "Score_0", "Score_1") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1" 
...
-- Code For temporary table TMP_20180508180317_CODEGEN_UG1I part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508180317_CODEGEN_UG1I" (
	"KEY" BIGINT, 
	"Score_0" DOUBLE PRECISION, 
	"Score_1" DOUBLE PRECISION
)
...
-- Code For temporary table TMP_20180508180317_CODEGEN_UG1I part 2. Populate

INSERT INTO "TMP_20180508180317_CODEGEN_UG1I" ("KEY", "Score_0", "Score_1") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1" 
...
FROM "TMP_20180508180317_CODEGEN_9LMO" AS "GB_B0" UNION ALL SELECT "GB_B1"."KEY" AS "KEY", "GB_B1"."Score_0" AS "Score_0", "GB_B1"."Score_1" AS "Score_1" 
FROM "TMP_20180508180317_CODEGEN_B2G3" AS "GB_B1" UNION ALL SELECT "GB_B2"."KEY" AS "KEY", "GB_B2"."Score_0" AS "Score_0", "GB_B2"."Score_1" AS "Score_1" 
FROM "TMP_20180508180317_CODEGEN_G0QQ" AS "GB_B2" UNION ALL SELECT "GB_B3"."KEY" AS "KEY", "GB_B3"."Score_0" AS "Score_0", "GB_B3"."Score_1" AS "Score_1" 
FROM "TMP_20180508180317_CODEGEN_QN6R" AS "GB_B3") AS "GB_EnsembleUnion") AS "GB_Union") AS "U"

-- Code For temporary table TMP_20180508180317_CODEGEN_WMZ1 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508180317_CODEGEN_WMZ1" (
	"KEY" BIGINT NOT NULL, 
	"Score_0" DOUBLE PRECISION, 
	"Score_1" DOUBLE PRECISION, 
	PRIMARY KEY ("KEY")
...
-- Code For temporary table TMP_20180508180317_CODEGEN_WMZ1 part 2. Populate

INSERT INTO "TMP_20180508180317_CODEGEN_WMZ1" ("KEY", "Score_0", "Score_1") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1" 
...
FROM "TMP_20180508180317_CODEGEN_UG1I" AS "GB_Union" GROUP BY "GB_Union"."KEY") AS "T") AS "GB_sum") AS "U"

-- Code For temporary table TMP_20180508180317_CODEGEN_WMZ1 part 3. Create Index 

CREATE INDEX "ix_TMP_20180508180317_C_af84" ON "TMP_20180508180317_CODEGEN_WMZ1" ("KEY")
...
FROM "TMP_20180508180317_CODEGEN_WMZ1" AS "GB_sum"), 
