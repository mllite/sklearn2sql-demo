...
-- Code For temporary table DEGEN_YG546V_ADS_IMP_1_OUT part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "DEGEN_YG546V_ADS_IMP_1_OUT" (
	"KEY" NUMBER(19), 
...
-- Code For temporary table DEGEN_YG546V_ADS_IMP_1_OUT part 2. Populate

INSERT INTO "DEGEN_YG546V_ADS_IMP_1_OUT" ("KEY", impter_2, impter_3, impter_4, impter_5, impter_6, impter_7, impter_8, impter_9, impter_10, impter_11) SELECT "U"."KEY", "U".impter_2, "U".impter_3, "U".impter_4, "U".impter_5, "U".impter_6, "U".impter_7, "U".impter_8, "U".impter_9, "U".impter_10, "U".impter_11 
...
-- Code For temporary table DEGEN_94QGQM_ADS_SCA_2_OUT part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "DEGEN_94QGQM_ADS_SCA_2_OUT" (
	"KEY" NUMBER(19), 
...
-- Code For temporary table DEGEN_94QGQM_ADS_SCA_2_OUT part 2. Populate

INSERT INTO "DEGEN_94QGQM_ADS_SCA_2_OUT" ("KEY", scaler_2, scaler_3, scaler_4, scaler_5, scaler_6, scaler_7, scaler_8, scaler_9, scaler_10, scaler_11) SELECT "U"."KEY", "U".scaler_2, "U".scaler_3, "U".scaler_4, "U".scaler_5, "U".scaler_6, "U".scaler_7, "U".scaler_8, "U".scaler_9, "U".scaler_10, "U".scaler_11 
...
FROM "DEGEN_YG546V_ADS_IMP_1_OUT" "ADS_imp_1_OUT") "ADS_sca_2_OUT") "U"

-- Code For temporary table 75834_CODEGEN_GUYI3C_GB_B0 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "75834_CODEGEN_GUYI3C_GB_B0" (
	"KEY" NUMBER(19), 
...
-- Code For temporary table 75834_CODEGEN_GUYI3C_GB_B0 part 2. Populate

INSERT INTO "75834_CODEGEN_GUYI3C_GB_B0" ("KEY", "Score_0", "Score_1") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1" 
...
FROM "DEGEN_94QGQM_ADS_SCA_2_OUT" "ADS_sca_2_OUT"), 
"DT_node_data" AS 
...
-- Code For temporary table 75834_CODEGEN_VRQHU0_GB_B1 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "75834_CODEGEN_VRQHU0_GB_B1" (
	"KEY" NUMBER(19), 
	"Score_0" BINARY_DOUBLE, 
	"Score_1" BINARY_DOUBLE
)
...
-- Code For temporary table 75834_CODEGEN_VRQHU0_GB_B1 part 2. Populate

INSERT INTO "75834_CODEGEN_VRQHU0_GB_B1" ("KEY", "Score_0", "Score_1") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1" 
...
-- Code For temporary table 75834_CODEGEN_H6BYTC_GB_B2 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "75834_CODEGEN_H6BYTC_GB_B2" (
	"KEY" NUMBER(19), 
	"Score_0" BINARY_DOUBLE, 
	"Score_1" BINARY_DOUBLE
)
...
-- Code For temporary table 75834_CODEGEN_H6BYTC_GB_B2 part 2. Populate

INSERT INTO "75834_CODEGEN_H6BYTC_GB_B2" ("KEY", "Score_0", "Score_1") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1" 
...
-- Code For temporary table 75834_CODEGEN_5NGDFJ_GB_B3 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "75834_CODEGEN_5NGDFJ_GB_B3" (
	"KEY" NUMBER(19), 
	"Score_0" BINARY_DOUBLE, 
	"Score_1" BINARY_DOUBLE
)
...
-- Code For temporary table 75834_CODEGEN_5NGDFJ_GB_B3 part 2. Populate

INSERT INTO "75834_CODEGEN_5NGDFJ_GB_B3" ("KEY", "Score_0", "Score_1") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1" 
...
-- Code For temporary table 34_CODEGEN_EYZE4J_GB_UNION part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "34_CODEGEN_EYZE4J_GB_UNION" (
	"KEY" NUMBER(19), 
	"Score_0" BINARY_DOUBLE, 
	"Score_1" BINARY_DOUBLE
)
...
-- Code For temporary table 34_CODEGEN_EYZE4J_GB_UNION part 2. Populate

INSERT INTO "34_CODEGEN_EYZE4J_GB_UNION" ("KEY", "Score_0", "Score_1") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1" 
...
FROM "75834_CODEGEN_GUYI3C_GB_B0" "GB_B0" UNION ALL SELECT "GB_B1"."KEY" AS "KEY", "GB_B1"."Score_0" AS "Score_0", "GB_B1"."Score_1" AS "Score_1" 
FROM "75834_CODEGEN_VRQHU0_GB_B1" "GB_B1" UNION ALL SELECT "GB_B2"."KEY" AS "KEY", "GB_B2"."Score_0" AS "Score_0", "GB_B2"."Score_1" AS "Score_1" 
FROM "75834_CODEGEN_H6BYTC_GB_B2" "GB_B2" UNION ALL SELECT "GB_B3"."KEY" AS "KEY", "GB_B3"."Score_0" AS "Score_0", "GB_B3"."Score_1" AS "Score_1" 
FROM "75834_CODEGEN_5NGDFJ_GB_B3" "GB_B3") "GB_EnsembleUnion") "GB_Union") "U"

-- Code For temporary table 5834_CODEGEN_VJP2H7_GB_SUM part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "5834_CODEGEN_VJP2H7_GB_SUM" (
	"KEY" NUMBER(19), 
	"Score_0" BINARY_DOUBLE, 
	"Score_1" BINARY_DOUBLE
)
...
-- Code For temporary table 5834_CODEGEN_VJP2H7_GB_SUM part 2. Populate

INSERT INTO "5834_CODEGEN_VJP2H7_GB_SUM" ("KEY", "Score_0", "Score_1") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1" 
...
FROM "34_CODEGEN_EYZE4J_GB_UNION" "GB_Union" GROUP BY "GB_Union"."KEY") "T") "GB_sum") "U"
...
FROM "5834_CODEGEN_VJP2H7_GB_SUM" "GB_sum"), 
