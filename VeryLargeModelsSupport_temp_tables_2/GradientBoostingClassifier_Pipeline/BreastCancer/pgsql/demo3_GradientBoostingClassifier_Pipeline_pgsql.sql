...
-- Code For temporary table TMP_20180508180805_CODEGEN_FERBQ5_ADS_imp_1_OUT part 1. Create 


CREATE TEMPORARY TABLE "TMP_20180508180805_CODEGEN_FERBQ5_ADS_imp_1_OUT" (
	"KEY" BIGINT NOT NULL, 
	impter_2 FLOAT, 
	impter_3 FLOAT, 
	impter_4 FLOAT, 
...
-- Code For temporary table TMP_20180508180805_CODEGEN_FERBQ5_ADS_imp_1_OUT part 2. Populate

INSERT INTO "TMP_20180508180805_CODEGEN_FERBQ5_ADS_imp_1_OUT" ("KEY", impter_2, impter_3, impter_4, impter_5, impter_6, impter_7, impter_8, impter_9, impter_10, impter_11, impter_12, impter_13, impter_14, impter_15, impter_16, impter_17, impter_18, impter_19, impter_20, impter_21, impter_22, impter_23, impter_24, impter_25, impter_26, impter_27, impter_28, impter_29, impter_30, impter_31) SELECT "ADS_imp_1_OUT"."KEY", "ADS_imp_1_OUT".impter_2, "ADS_imp_1_OUT".impter_3, "ADS_imp_1_OUT".impter_4, "ADS_imp_1_OUT".impter_5, "ADS_imp_1_OUT".impter_6, "ADS_imp_1_OUT".impter_7, "ADS_imp_1_OUT".impter_8, "ADS_imp_1_OUT".impter_9, "ADS_imp_1_OUT".impter_10, "ADS_imp_1_OUT".impter_11, "ADS_imp_1_OUT".impter_12, "ADS_imp_1_OUT".impter_13, "ADS_imp_1_OUT".impter_14, "ADS_imp_1_OUT".impter_15, "ADS_imp_1_OUT".impter_16, "ADS_imp_1_OUT".impter_17, "ADS_imp_1_OUT".impter_18, "ADS_imp_1_OUT".impter_19, "ADS_imp_1_OUT".impter_20, "ADS_imp_1_OUT".impter_21, "ADS_imp_1_OUT".impter_22, "ADS_imp_1_OUT".impter_23, "ADS_imp_1_OUT".impter_24, "ADS_imp_1_OUT".impter_25, "ADS_imp_1_OUT".impter_26, "ADS_imp_1_OUT".impter_27, "ADS_imp_1_OUT".impter_28, "ADS_imp_1_OUT".impter_29, "ADS_imp_1_OUT".impter_30, "ADS_imp_1_OUT".impter_31 
...
-- Code For temporary table TMP_20180508180805_CODEGEN_FERBQ5_ADS_imp_1_OUT part 3. Create Index 

CREATE INDEX "ix_TMP_20180508180805_CODEGEN_FERBQ5_ADS_imp_1_OUT_KEY" ON "TMP_20180508180805_CODEGEN_FERBQ5_ADS_imp_1_OUT" ("KEY")

-- Code For temporary table TMP_20180508180805_CODEGEN_DSJQ56_ADS_sca_2_OUT part 1. Create 


CREATE TEMPORARY TABLE "TMP_20180508180805_CODEGEN_DSJQ56_ADS_sca_2_OUT" (
	"KEY" BIGINT NOT NULL, 
	scaler_2 FLOAT, 
	scaler_3 FLOAT, 
	scaler_4 FLOAT, 
...
FROM "TMP_20180508180805_CODEGEN_FERBQ5_ADS_imp_1_OUT" AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT"

-- Code For temporary table TMP_20180508180805_CODEGEN_DSJQ56_ADS_sca_2_OUT part 3. Create Index 

CREATE INDEX "ix_TMP_20180508180805_CODEGEN_DSJQ56_ADS_sca_2_OUT_KEY" ON "TMP_20180508180805_CODEGEN_DSJQ56_ADS_sca_2_OUT" ("KEY")

-- Code For temporary table TMP_20180508180805_CODEGEN_3YZKD8_GB_B0 part 1. Create 


CREATE TEMPORARY TABLE "TMP_20180508180805_CODEGEN_3YZKD8_GB_B0" (
	"KEY" BIGINT, 
	"Score_0" FLOAT, 
	"Score_1" FLOAT
)
...
-- Code For temporary table TMP_20180508180805_CODEGEN_3YZKD8_GB_B0 part 2. Populate
...
FROM "TMP_20180508180805_CODEGEN_DSJQ56_ADS_sca_2_OUT" AS "ADS_sca_2_OUT"), 
"DT_node_data" AS 
...
FROM "DT_Output_4")
 INSERT INTO "TMP_20180508180805_CODEGEN_3YZKD8_GB_B0" ("KEY", "Score_0", "Score_1") SELECT "GB_B0"."KEY", "GB_B0"."Score_0", "GB_B0"."Score_1" 
...
-- Code For temporary table TMP_20180508180805_CODEGEN_M2AI4W_GB_B1 part 1. Create 


CREATE TEMPORARY TABLE "TMP_20180508180805_CODEGEN_M2AI4W_GB_B1" (
	"KEY" BIGINT, 
	"Score_0" FLOAT, 
	"Score_1" FLOAT
)
...
-- Code For temporary table TMP_20180508180805_CODEGEN_M2AI4W_GB_B1 part 2. Populate
...
FROM "DT_Output_9")
 INSERT INTO "TMP_20180508180805_CODEGEN_M2AI4W_GB_B1" ("KEY", "Score_0", "Score_1") SELECT "GB_B1"."KEY", "GB_B1"."Score_0", "GB_B1"."Score_1" 
...
-- Code For temporary table TMP_20180508180805_CODEGEN_XZL1BO_GB_B2 part 1. Create 


CREATE TEMPORARY TABLE "TMP_20180508180805_CODEGEN_XZL1BO_GB_B2" (
	"KEY" BIGINT, 
	"Score_0" FLOAT, 
	"Score_1" FLOAT
)
...
-- Code For temporary table TMP_20180508180805_CODEGEN_XZL1BO_GB_B2 part 2. Populate
...
FROM "DT_Output_14")
 INSERT INTO "TMP_20180508180805_CODEGEN_XZL1BO_GB_B2" ("KEY", "Score_0", "Score_1") SELECT "GB_B2"."KEY", "GB_B2"."Score_0", "GB_B2"."Score_1" 
...
-- Code For temporary table TMP_20180508180805_CODEGEN_L6TXCN_GB_B3 part 1. Create 


CREATE TEMPORARY TABLE "TMP_20180508180805_CODEGEN_L6TXCN_GB_B3" (
	"KEY" BIGINT, 
	"Score_0" FLOAT, 
	"Score_1" FLOAT
)
...
-- Code For temporary table TMP_20180508180805_CODEGEN_L6TXCN_GB_B3 part 2. Populate
...
FROM "DT_Output_15")
 INSERT INTO "TMP_20180508180805_CODEGEN_L6TXCN_GB_B3" ("KEY", "Score_0", "Score_1") SELECT "GB_B3"."KEY", "GB_B3"."Score_0", "GB_B3"."Score_1" 
...
-- Code For temporary table TMP_20180508180805_CODEGEN_VF9AFE_GB_Union part 1. Create 


CREATE TEMPORARY TABLE "TMP_20180508180805_CODEGEN_VF9AFE_GB_Union" (
	"KEY" BIGINT, 
	"Score_0" FLOAT, 
	"Score_1" FLOAT
)
...
-- Code For temporary table TMP_20180508180805_CODEGEN_VF9AFE_GB_Union part 2. Populate

INSERT INTO "TMP_20180508180805_CODEGEN_VF9AFE_GB_Union" ("KEY", "Score_0", "Score_1") SELECT "GB_Union"."KEY", "GB_Union"."Score_0", "GB_Union"."Score_1" 
...
FROM "TMP_20180508180805_CODEGEN_3YZKD8_GB_B0" AS "GB_B0" UNION ALL SELECT "GB_B1"."KEY" AS "KEY", "GB_B1"."Score_0" AS "Score_0", "GB_B1"."Score_1" AS "Score_1" 
FROM "TMP_20180508180805_CODEGEN_M2AI4W_GB_B1" AS "GB_B1" UNION ALL SELECT "GB_B2"."KEY" AS "KEY", "GB_B2"."Score_0" AS "Score_0", "GB_B2"."Score_1" AS "Score_1" 
FROM "TMP_20180508180805_CODEGEN_XZL1BO_GB_B2" AS "GB_B2" UNION ALL SELECT "GB_B3"."KEY" AS "KEY", "GB_B3"."Score_0" AS "Score_0", "GB_B3"."Score_1" AS "Score_1" 
FROM "TMP_20180508180805_CODEGEN_L6TXCN_GB_B3" AS "GB_B3") AS "GB_EnsembleUnion") AS "GB_Union"

-- Code For temporary table TMP_20180508180805_CODEGEN_30XHG7_GB_sum part 1. Create 


CREATE TEMPORARY TABLE "TMP_20180508180805_CODEGEN_30XHG7_GB_sum" (
	"KEY" BIGINT NOT NULL, 
	"Score_0" FLOAT, 
	"Score_1" FLOAT, 
	PRIMARY KEY ("KEY")
...
-- Code For temporary table TMP_20180508180805_CODEGEN_30XHG7_GB_sum part 2. Populate

INSERT INTO "TMP_20180508180805_CODEGEN_30XHG7_GB_sum" ("KEY", "Score_0", "Score_1") SELECT "GB_sum"."KEY", "GB_sum"."Score_0", "GB_sum"."Score_1" 
...
FROM "TMP_20180508180805_CODEGEN_VF9AFE_GB_Union" AS "GB_Union" GROUP BY "GB_Union"."KEY") AS "T") AS "GB_sum"

-- Code For temporary table TMP_20180508180805_CODEGEN_30XHG7_GB_sum part 3. Create Index 

CREATE INDEX "ix_TMP_20180508180805_CODEGEN_30XHG7_GB_sum_KEY" ON "TMP_20180508180805_CODEGEN_30XHG7_GB_sum" ("KEY")
...
FROM "TMP_20180508180805_CODEGEN_30XHG7_GB_sum" AS "GB_sum"), 
