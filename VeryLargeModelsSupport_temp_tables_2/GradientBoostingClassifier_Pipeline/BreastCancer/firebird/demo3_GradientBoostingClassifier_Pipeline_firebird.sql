...
-- Code For temporary table TMP_20180508180806_CODEGEN_ZY4L part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508180806_CODEGEN_ZY4L" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20180508180806_CODEGEN_ZY4L part 2. Populate

INSERT INTO "TMP_20180508180806_CODEGEN_ZY4L" ("KEY", impter_2, impter_3, impter_4, impter_5, impter_6, impter_7, impter_8, impter_9, impter_10, impter_11, impter_12, impter_13, impter_14, impter_15, impter_16, impter_17, impter_18, impter_19, impter_20, impter_21, impter_22, impter_23, impter_24, impter_25, impter_26, impter_27, impter_28, impter_29, impter_30, impter_31) SELECT "U"."KEY", "U".impter_2, "U".impter_3, "U".impter_4, "U".impter_5, "U".impter_6, "U".impter_7, "U".impter_8, "U".impter_9, "U".impter_10, "U".impter_11, "U".impter_12, "U".impter_13, "U".impter_14, "U".impter_15, "U".impter_16, "U".impter_17, "U".impter_18, "U".impter_19, "U".impter_20, "U".impter_21, "U".impter_22, "U".impter_23, "U".impter_24, "U".impter_25, "U".impter_26, "U".impter_27, "U".impter_28, "U".impter_29, "U".impter_30, "U".impter_31 
...
-- Code For temporary table TMP_20180508180806_CODEGEN_ZY4L part 3. Create Index 

CREATE INDEX "ix_TMP_20180508180806_C_5591" ON "TMP_20180508180806_CODEGEN_ZY4L" ("KEY")

-- Code For temporary table TMP_20180508180806_CODEGEN_7Y9B part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508180806_CODEGEN_7Y9B" (
	"KEY" BIGINT NOT NULL, 
...
FROM "TMP_20180508180806_CODEGEN_ZY4L" AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT") AS "U"

-- Code For temporary table TMP_20180508180806_CODEGEN_7Y9B part 3. Create Index 

CREATE INDEX "ix_TMP_20180508180806_C_3da6" ON "TMP_20180508180806_CODEGEN_7Y9B" ("KEY")

-- Code For temporary table TMP_20180508180806_CODEGEN_056K part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508180806_CODEGEN_056K" (
	"KEY" BIGINT, 
...
-- Code For temporary table TMP_20180508180806_CODEGEN_056K part 2. Populate

INSERT INTO "TMP_20180508180806_CODEGEN_056K" ("KEY", "Score_0", "Score_1") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1" 
...
FROM "TMP_20180508180806_CODEGEN_7Y9B" AS "ADS_sca_2_OUT"), 
"DT_node_data" AS 
...
-- Code For temporary table TMP_20180508180806_CODEGEN_3M8R part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508180806_CODEGEN_3M8R" (
	"KEY" BIGINT, 
	"Score_0" DOUBLE PRECISION, 
	"Score_1" DOUBLE PRECISION
)
...
-- Code For temporary table TMP_20180508180806_CODEGEN_3M8R part 2. Populate

INSERT INTO "TMP_20180508180806_CODEGEN_3M8R" ("KEY", "Score_0", "Score_1") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1" 
...
-- Code For temporary table TMP_20180508180806_CODEGEN_VQ52 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508180806_CODEGEN_VQ52" (
	"KEY" BIGINT, 
	"Score_0" DOUBLE PRECISION, 
	"Score_1" DOUBLE PRECISION
)
...
-- Code For temporary table TMP_20180508180806_CODEGEN_VQ52 part 2. Populate

INSERT INTO "TMP_20180508180806_CODEGEN_VQ52" ("KEY", "Score_0", "Score_1") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1" 
...
-- Code For temporary table TMP_20180508180806_CODEGEN_03RT part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508180806_CODEGEN_03RT" (
	"KEY" BIGINT, 
	"Score_0" DOUBLE PRECISION, 
	"Score_1" DOUBLE PRECISION
)
...
-- Code For temporary table TMP_20180508180806_CODEGEN_03RT part 2. Populate

INSERT INTO "TMP_20180508180806_CODEGEN_03RT" ("KEY", "Score_0", "Score_1") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1" 
...
-- Code For temporary table TMP_20180508180806_CODEGEN_BPER part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508180806_CODEGEN_BPER" (
	"KEY" BIGINT, 
	"Score_0" DOUBLE PRECISION, 
	"Score_1" DOUBLE PRECISION
)
...
-- Code For temporary table TMP_20180508180806_CODEGEN_BPER part 2. Populate

INSERT INTO "TMP_20180508180806_CODEGEN_BPER" ("KEY", "Score_0", "Score_1") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1" 
...
FROM "TMP_20180508180806_CODEGEN_056K" AS "GB_B0" UNION ALL SELECT "GB_B1"."KEY" AS "KEY", "GB_B1"."Score_0" AS "Score_0", "GB_B1"."Score_1" AS "Score_1" 
FROM "TMP_20180508180806_CODEGEN_3M8R" AS "GB_B1" UNION ALL SELECT "GB_B2"."KEY" AS "KEY", "GB_B2"."Score_0" AS "Score_0", "GB_B2"."Score_1" AS "Score_1" 
FROM "TMP_20180508180806_CODEGEN_VQ52" AS "GB_B2" UNION ALL SELECT "GB_B3"."KEY" AS "KEY", "GB_B3"."Score_0" AS "Score_0", "GB_B3"."Score_1" AS "Score_1" 
FROM "TMP_20180508180806_CODEGEN_03RT" AS "GB_B3") AS "GB_EnsembleUnion") AS "GB_Union") AS "U"

-- Code For temporary table TMP_20180508180806_CODEGEN_66FN part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508180806_CODEGEN_66FN" (
	"KEY" BIGINT NOT NULL, 
	"Score_0" DOUBLE PRECISION, 
	"Score_1" DOUBLE PRECISION, 
	PRIMARY KEY ("KEY")
...
-- Code For temporary table TMP_20180508180806_CODEGEN_66FN part 2. Populate

INSERT INTO "TMP_20180508180806_CODEGEN_66FN" ("KEY", "Score_0", "Score_1") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1" 
...
FROM "TMP_20180508180806_CODEGEN_BPER" AS "GB_Union" GROUP BY "GB_Union"."KEY") AS "T") AS "GB_sum") AS "U"

-- Code For temporary table TMP_20180508180806_CODEGEN_66FN part 3. Create Index 

CREATE INDEX "ix_TMP_20180508180806_C_0817" ON "TMP_20180508180806_CODEGEN_66FN" ("KEY")
...
FROM "TMP_20180508180806_CODEGEN_66FN" AS "GB_sum"), 
