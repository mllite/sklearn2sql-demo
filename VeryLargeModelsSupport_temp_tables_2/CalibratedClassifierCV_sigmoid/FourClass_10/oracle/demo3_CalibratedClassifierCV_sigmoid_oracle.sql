...
-- Code For temporary table _CODEGEN_87MPGI_CALPROB_B0 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "_CODEGEN_87MPGI_CALPROB_B0" (
	"KEY" NUMBER(19), 
...
-- Code For temporary table _CODEGEN_87MPGI_CALPROB_B0 part 2. Populate

INSERT INTO "_CODEGEN_87MPGI_CALPROB_B0" ("KEY", "Proba_0", "Proba_1", "Proba_2", "Proba_3") SELECT "U"."KEY", "U"."Proba_0", "U"."Proba_1", "U"."Proba_2", "U"."Proba_3" 
...
-- Code For temporary table DEGEN_G1QW4A_CALPROB_UNION part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "DEGEN_G1QW4A_CALPROB_UNION" (
	"KEY" NUMBER(19), 
	"Proba_0" BINARY_DOUBLE, 
	"Proba_1" BINARY_DOUBLE, 
	"Proba_2" BINARY_DOUBLE, 
...
-- Code For temporary table DEGEN_G1QW4A_CALPROB_UNION part 2. Populate

INSERT INTO "DEGEN_G1QW4A_CALPROB_UNION" ("KEY", "Proba_0", "Proba_1", "Proba_2", "Proba_3") SELECT "U"."KEY", "U"."Proba_0", "U"."Proba_1", "U"."Proba_2", "U"."Proba_3" 
...
FROM "_CODEGEN_87MPGI_CALPROB_B0" "CalProb_B0") "CalProb_EnsembleUnion") "CalProb_Union") "U"

-- Code For temporary table CODEGEN_T3N5N1_CALPROB_AVG part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "CODEGEN_T3N5N1_CALPROB_AVG" (
	"KEY" NUMBER(19), 
	"Proba_0" BINARY_DOUBLE, 
	"Proba_1" BINARY_DOUBLE, 
	"Proba_2" BINARY_DOUBLE, 
...
-- Code For temporary table CODEGEN_T3N5N1_CALPROB_AVG part 2. Populate

INSERT INTO "CODEGEN_T3N5N1_CALPROB_AVG" ("KEY", "Proba_0", "Proba_1", "Proba_2", "Proba_3") SELECT "U"."KEY", "U"."Proba_0", "U"."Proba_1", "U"."Proba_2", "U"."Proba_3" 
...
FROM "DEGEN_G1QW4A_CALPROB_UNION" "CalProb_Union" GROUP BY "CalProb_Union"."KEY") "T") "CalProb_avg") "U"
...
FROM "CODEGEN_T3N5N1_CALPROB_AVG" "CalProb_avg"), 
