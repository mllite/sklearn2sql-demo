...
-- Code For temporary table TMP_20180508180636_CODEGEN_52HC part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508180636_CODEGEN_52HC" (
	"KEY" BIGINT, 
...
-- Code For temporary table TMP_20180508180636_CODEGEN_52HC part 2. Populate

INSERT INTO "TMP_20180508180636_CODEGEN_52HC" ("KEY", "Proba_1", "Proba_0") SELECT "U"."KEY", "U"."Proba_1", "U"."Proba_0" 
...
-- Code For temporary table TMP_20180508180636_CODEGEN_1P07 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508180636_CODEGEN_1P07" (
	"KEY" BIGINT, 
	"Proba_1" DOUBLE PRECISION, 
	"Proba_0" DOUBLE PRECISION
)
...
-- Code For temporary table TMP_20180508180636_CODEGEN_1P07 part 2. Populate

INSERT INTO "TMP_20180508180636_CODEGEN_1P07" ("KEY", "Proba_1", "Proba_0") SELECT "U"."KEY", "U"."Proba_1", "U"."Proba_0" 
...
FROM "TMP_20180508180636_CODEGEN_52HC" AS "CalProb_B0") AS "CalProb_EnsembleUnion") AS "CalProb_Union") AS "U"

-- Code For temporary table TMP_20180508180636_CODEGEN_7BY7 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508180636_CODEGEN_7BY7" (
	"KEY" BIGINT NOT NULL, 
	"Proba_1" DOUBLE PRECISION, 
	"Proba_0" DOUBLE PRECISION, 
	PRIMARY KEY ("KEY")
...
-- Code For temporary table TMP_20180508180636_CODEGEN_7BY7 part 2. Populate

INSERT INTO "TMP_20180508180636_CODEGEN_7BY7" ("KEY", "Proba_1", "Proba_0") SELECT "U"."KEY", "U"."Proba_1", "U"."Proba_0" 
...
FROM "TMP_20180508180636_CODEGEN_1P07" AS "CalProb_Union" GROUP BY "CalProb_Union"."KEY") AS "T") AS "CalProb_avg") AS "U"

-- Code For temporary table TMP_20180508180636_CODEGEN_7BY7 part 3. Create Index 

CREATE INDEX "ix_TMP_20180508180636_C_2625" ON "TMP_20180508180636_CODEGEN_7BY7" ("KEY")
...
FROM "TMP_20180508180636_CODEGEN_7BY7" AS "CalProb_avg"), 
