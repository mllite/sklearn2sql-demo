...
-- Code For temporary table tmp_20180509001954_codegen_nhcked_calprob_b0 part 1. Create 

CREATE TEMPORARY TABLE `tmp_20180509001954_codegen_nhcked_calprob_b0` STORED AS ORC AS WITH `DT_node_lookup` AS 
...
(SELECT `Calibrated_Model_0`.`KEY` AS `KEY`, 1.0 / (1.0 + exp(-(2.302343680054423 * `Calibrated_Model_0`.`ScoreOrProba_1` + -1.2105553273631793))) AS `Proba_1`, 1.0 - 1.0 / (1.0 + exp(-(2.302343680054423 * `Calibrated_Model_0`.`ScoreOrProba_1` + -1.2105553273631793))) AS `Proba_0` 
...
(SELECT `Calibrated_Model_1`.`KEY` AS `KEY`, 1.0 / (1.0 + exp(-(3.314062182700888 * `Calibrated_Model_1`.`ScoreOrProba_1` + -1.709231943724962))) AS `Proba_1`, 1.0 - 1.0 / (1.0 + exp(-(3.314062182700888 * `Calibrated_Model_1`.`ScoreOrProba_1` + -1.709231943724962))) AS `Proba_0` 
...
(SELECT `Calibrated_Model_2`.`KEY` AS `KEY`, 1.0 / (1.0 + exp(-(2.079068705462255 * `Calibrated_Model_2`.`ScoreOrProba_1` + -1.106710373017934))) AS `Proba_1`, 1.0 - 1.0 / (1.0 + exp(-(2.079068705462255 * `Calibrated_Model_2`.`ScoreOrProba_1` + -1.106710373017934))) AS `Proba_0` 
...
(SELECT `Calibrated_Model_3`.`KEY` AS `KEY`, 1.0 / (1.0 + exp(-(2.244245371482823 * `Calibrated_Model_3`.`ScoreOrProba_1` + -1.472565828440728))) AS `Proba_1`, 1.0 - 1.0 / (1.0 + exp(-(2.244245371482823 * `Calibrated_Model_3`.`ScoreOrProba_1` + -1.472565828440728))) AS `Proba_0` 
...
-- Code For temporary table tmp_20180509001954_codegen_nhcked_calprob_b0 part 2. Populate

SELECT * FROM `tmp_20180509001954_codegen_nhcked_calprob_b0`

-- Code For temporary table tmp_20180509001954_codegen_t470y7_calprob_union part 1. Create 

CREATE TEMPORARY TABLE `tmp_20180509001954_codegen_t470y7_calprob_union` STORED AS ORC AS SELECT `CalProb_Union`.`KEY`, `CalProb_Union`.`Proba_1`, `CalProb_Union`.`Proba_0` 
...
FROM `tmp_20180509001954_codegen_nhcked_calprob_b0` AS `CalProb_B0`) AS `CalProb_EnsembleUnion`) AS `CalProb_Union`

-- Code For temporary table tmp_20180509001954_codegen_t470y7_calprob_union part 2. Populate

SELECT * FROM `tmp_20180509001954_codegen_t470y7_calprob_union`

-- Code For temporary table tmp_20180509001954_codegen_i8qmu8_calprob_avg part 1. Create 

CREATE TEMPORARY TABLE `tmp_20180509001954_codegen_i8qmu8_calprob_avg` STORED AS ORC AS SELECT `CalProb_avg`.`KEY`, `CalProb_avg`.`Proba_1`, `CalProb_avg`.`Proba_0` 
...
FROM `tmp_20180509001954_codegen_t470y7_calprob_union` AS `CalProb_Union` GROUP BY `CalProb_Union`.`KEY`) AS `T`) AS `CalProb_avg`

-- Code For temporary table tmp_20180509001954_codegen_i8qmu8_calprob_avg part 2. Populate

SELECT * FROM `tmp_20180509001954_codegen_i8qmu8_calprob_avg`
...
FROM `tmp_20180509001954_codegen_i8qmu8_calprob_avg` AS `CalProb_avg`), 
