...
-- Code For temporary table tmp_20180509004434_codegen_5fjy7g_calprob_b0 part 1. Create 

CREATE TEMPORARY TABLE `tmp_20180509004434_codegen_5fjy7g_calprob_b0` STORED AS ORC AS WITH `DT_node_lookup` AS 
...
-- Code For temporary table tmp_20180509004434_codegen_5fjy7g_calprob_b0 part 2. Populate

SELECT * FROM `tmp_20180509004434_codegen_5fjy7g_calprob_b0`

-- Code For temporary table tmp_20180509004434_codegen_9z0gvb_calprob_union part 1. Create 

CREATE TEMPORARY TABLE `tmp_20180509004434_codegen_9z0gvb_calprob_union` STORED AS ORC AS SELECT `CalProb_Union`.`KEY`, `CalProb_Union`.`Proba_0`, `CalProb_Union`.`Proba_1`, `CalProb_Union`.`Proba_2` 
...
FROM `tmp_20180509004434_codegen_5fjy7g_calprob_b0` AS `CalProb_B0`) AS `CalProb_EnsembleUnion`) AS `CalProb_Union`

-- Code For temporary table tmp_20180509004434_codegen_9z0gvb_calprob_union part 2. Populate

SELECT * FROM `tmp_20180509004434_codegen_9z0gvb_calprob_union`

-- Code For temporary table tmp_20180509004434_codegen_fiskc3_calprob_avg part 1. Create 

CREATE TEMPORARY TABLE `tmp_20180509004434_codegen_fiskc3_calprob_avg` STORED AS ORC AS SELECT `CalProb_avg`.`KEY`, `CalProb_avg`.`Proba_0`, `CalProb_avg`.`Proba_1`, `CalProb_avg`.`Proba_2` 
...
FROM `tmp_20180509004434_codegen_9z0gvb_calprob_union` AS `CalProb_Union` GROUP BY `CalProb_Union`.`KEY`) AS `T`) AS `CalProb_avg`

-- Code For temporary table tmp_20180509004434_codegen_fiskc3_calprob_avg part 2. Populate

SELECT * FROM `tmp_20180509004434_codegen_fiskc3_calprob_avg`
...
FROM `tmp_20180509004434_codegen_fiskc3_calprob_avg` AS `CalProb_avg`), 
