...
-- Code For temporary table TMP_20180508185456_CODEGEN_VQYO part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508185456_CODEGEN_VQYO" (
	"KEY" BIGINT, 
...
-- Code For temporary table TMP_20180508185456_CODEGEN_VQYO part 2. Populate

INSERT INTO "TMP_20180508185456_CODEGEN_VQYO" ("KEY", "Proba_0", "Proba_1", "Proba_2") SELECT "U"."KEY", "U"."Proba_0", "U"."Proba_1", "U"."Proba_2" 
...
-- Code For temporary table TMP_20180508185456_CODEGEN_M7UT part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508185456_CODEGEN_M7UT" (
	"KEY" BIGINT, 
	"Proba_0" DOUBLE PRECISION, 
	"Proba_1" DOUBLE PRECISION, 
	"Proba_2" DOUBLE PRECISION
...
-- Code For temporary table TMP_20180508185456_CODEGEN_M7UT part 2. Populate

INSERT INTO "TMP_20180508185456_CODEGEN_M7UT" ("KEY", "Proba_0", "Proba_1", "Proba_2") SELECT "U"."KEY", "U"."Proba_0", "U"."Proba_1", "U"."Proba_2" 
...
FROM "TMP_20180508185456_CODEGEN_VQYO" AS "CalProb_B0") AS "CalProb_EnsembleUnion") AS "CalProb_Union") AS "U"

-- Code For temporary table TMP_20180508185456_CODEGEN_OHMI part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508185456_CODEGEN_OHMI" (
	"KEY" BIGINT NOT NULL, 
	"Proba_0" DOUBLE PRECISION, 
	"Proba_1" DOUBLE PRECISION, 
	"Proba_2" DOUBLE PRECISION, 
...
-- Code For temporary table TMP_20180508185456_CODEGEN_OHMI part 2. Populate

INSERT INTO "TMP_20180508185456_CODEGEN_OHMI" ("KEY", "Proba_0", "Proba_1", "Proba_2") SELECT "U"."KEY", "U"."Proba_0", "U"."Proba_1", "U"."Proba_2" 
...
FROM "TMP_20180508185456_CODEGEN_M7UT" AS "CalProb_Union" GROUP BY "CalProb_Union"."KEY") AS "T") AS "CalProb_avg") AS "U"

-- Code For temporary table TMP_20180508185456_CODEGEN_OHMI part 3. Create Index 

CREATE INDEX "ix_TMP_20180508185456_C_5477" ON "TMP_20180508185456_CODEGEN_OHMI" ("KEY")
...
FROM "TMP_20180508185456_CODEGEN_OHMI" AS "CalProb_avg"), 
