...
-- Code For temporary table tmp_20180508190431_codegen_eaja8m_calprob_b0 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180508190431_codegen_eaja8m_calprob_b0  (
	"KEY" BIGINT, 
...
-- Code For temporary table tmp_20180508190431_codegen_eaja8m_calprob_b0 part 2. Populate

INSERT INTO tmp_20180508190431_codegen_eaja8m_calprob_b0 ("KEY", "Proba_CLASS_0", "Proba_CLASS_1", "Proba_CLASS_2") SELECT "U"."KEY", "U"."Proba_CLASS_0", "U"."Proba_CLASS_1", "U"."Proba_CLASS_2" 
...
-- Code For temporary table tmp_20180508190431_codegen_fd1ni9_calprob_union part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180508190431_codegen_fd1ni9_calprob_union  (
	"KEY" BIGINT, 
	"Proba_CLASS_0" DOUBLE PRECISION, 
	"Proba_CLASS_1" DOUBLE PRECISION, 
	"Proba_CLASS_2" DOUBLE PRECISION
...
-- Code For temporary table tmp_20180508190431_codegen_fd1ni9_calprob_union part 2. Populate

INSERT INTO tmp_20180508190431_codegen_fd1ni9_calprob_union ("KEY", "Proba_CLASS_0", "Proba_CLASS_1", "Proba_CLASS_2") SELECT "U"."KEY", "U"."Proba_CLASS_0", "U"."Proba_CLASS_1", "U"."Proba_CLASS_2" 
...
FROM tmp_20180508190431_codegen_eaja8m_calprob_b0 AS "CalProb_B0") AS "CalProb_EnsembleUnion") AS "CalProb_Union") AS "U"

-- Code For temporary table tmp_20180508190431_codegen_pogqqx_calprob_avg part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180508190431_codegen_pogqqx_calprob_avg  (
	"KEY" BIGINT, 
	"Proba_CLASS_0" DOUBLE PRECISION, 
	"Proba_CLASS_1" DOUBLE PRECISION, 
	"Proba_CLASS_2" DOUBLE PRECISION
...
-- Code For temporary table tmp_20180508190431_codegen_pogqqx_calprob_avg part 2. Populate

INSERT INTO tmp_20180508190431_codegen_pogqqx_calprob_avg ("KEY", "Proba_CLASS_0", "Proba_CLASS_1", "Proba_CLASS_2") SELECT "U"."KEY", "U"."Proba_CLASS_0", "U"."Proba_CLASS_1", "U"."Proba_CLASS_2" 
...
FROM tmp_20180508190431_codegen_fd1ni9_calprob_union AS "CalProb_Union" GROUP BY "CalProb_Union"."KEY") AS "T") AS "CalProb_avg") AS "U"
...
FROM tmp_20180508190431_codegen_pogqqx_calprob_avg AS "CalProb_avg"), 
