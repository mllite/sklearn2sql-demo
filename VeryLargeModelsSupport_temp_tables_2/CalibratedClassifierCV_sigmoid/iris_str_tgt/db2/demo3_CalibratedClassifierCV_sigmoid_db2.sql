...
-- Code For temporary table tmp_20180508190434_codegen_tkbo5g_calprob_b0 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180508190434_codegen_tkbo5g_calprob_b0 (
	"KEY" BIGINT, 
...
-- Code For temporary table tmp_20180508190434_codegen_tkbo5g_calprob_b0 part 2. Populate

INSERT INTO tmp_20180508190434_codegen_tkbo5g_calprob_b0 WITH "DT_node_lookup" AS 
...
-- Code For temporary table tmp_20180508190434_codegen_clv8fu_calprob_union part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180508190434_codegen_clv8fu_calprob_union (
	"KEY" BIGINT, 
	"Proba_CLASS_0" DOUBLE, 
	"Proba_CLASS_1" DOUBLE, 
	"Proba_CLASS_2" DOUBLE
...
-- Code For temporary table tmp_20180508190434_codegen_clv8fu_calprob_union part 2. Populate

INSERT INTO tmp_20180508190434_codegen_clv8fu_calprob_union SELECT "CalProb_Union"."KEY", "CalProb_Union"."Proba_CLASS_0", "CalProb_Union"."Proba_CLASS_1", "CalProb_Union"."Proba_CLASS_2" 
...
FROM tmp_20180508190434_codegen_tkbo5g_calprob_b0 AS "CalProb_B0") AS "CalProb_EnsembleUnion") AS "CalProb_Union"

-- Code For temporary table tmp_20180508190434_codegen_bw7xae_calprob_avg part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180508190434_codegen_bw7xae_calprob_avg (
	"KEY" BIGINT, 
	"Proba_CLASS_0" DOUBLE, 
	"Proba_CLASS_1" DOUBLE, 
	"Proba_CLASS_2" DOUBLE
...
-- Code For temporary table tmp_20180508190434_codegen_bw7xae_calprob_avg part 2. Populate

INSERT INTO tmp_20180508190434_codegen_bw7xae_calprob_avg SELECT "CalProb_avg"."KEY", "CalProb_avg"."Proba_CLASS_0", "CalProb_avg"."Proba_CLASS_1", "CalProb_avg"."Proba_CLASS_2" 
...
FROM tmp_20180508190434_codegen_clv8fu_calprob_union AS "CalProb_Union" GROUP BY "CalProb_Union"."KEY") AS "T") AS "CalProb_avg"
...
FROM tmp_20180508190434_codegen_bw7xae_calprob_avg AS "CalProb_avg"), 
