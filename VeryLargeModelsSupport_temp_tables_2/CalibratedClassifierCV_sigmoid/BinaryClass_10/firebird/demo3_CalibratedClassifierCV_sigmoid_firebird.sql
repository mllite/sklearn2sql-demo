...
-- Code For temporary table TMP_20180508175705_CODEGEN_O9UG part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508175705_CODEGEN_O9UG" (
	"KEY" BIGINT, 
...
-- Code For temporary table TMP_20180508175705_CODEGEN_O9UG part 2. Populate

INSERT INTO "TMP_20180508175705_CODEGEN_O9UG" ("KEY", "Proba_1", "Proba_0") SELECT "U"."KEY", "U"."Proba_1", "U"."Proba_0" 
...
-- Code For temporary table TMP_20180508175705_CODEGEN_DG6J part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508175705_CODEGEN_DG6J" (
	"KEY" BIGINT, 
	"Proba_1" DOUBLE PRECISION, 
	"Proba_0" DOUBLE PRECISION
)
...
-- Code For temporary table TMP_20180508175705_CODEGEN_DG6J part 2. Populate

INSERT INTO "TMP_20180508175705_CODEGEN_DG6J" ("KEY", "Proba_1", "Proba_0") SELECT "U"."KEY", "U"."Proba_1", "U"."Proba_0" 
...
FROM "TMP_20180508175705_CODEGEN_O9UG" AS "CalProb_B0") AS "CalProb_EnsembleUnion") AS "CalProb_Union") AS "U"

-- Code For temporary table TMP_20180508175705_CODEGEN_05DW part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508175705_CODEGEN_05DW" (
	"KEY" BIGINT NOT NULL, 
	"Proba_1" DOUBLE PRECISION, 
	"Proba_0" DOUBLE PRECISION, 
	PRIMARY KEY ("KEY")
...
-- Code For temporary table TMP_20180508175705_CODEGEN_05DW part 2. Populate

INSERT INTO "TMP_20180508175705_CODEGEN_05DW" ("KEY", "Proba_1", "Proba_0") SELECT "U"."KEY", "U"."Proba_1", "U"."Proba_0" 
...
FROM "TMP_20180508175705_CODEGEN_DG6J" AS "CalProb_Union" GROUP BY "CalProb_Union"."KEY") AS "T") AS "CalProb_avg") AS "U"

-- Code For temporary table TMP_20180508175705_CODEGEN_05DW part 3. Create Index 

CREATE INDEX "ix_TMP_20180508175705_C_98b5" ON "TMP_20180508175705_CODEGEN_05DW" ("KEY")
...
FROM "TMP_20180508175705_CODEGEN_05DW" AS "CalProb_avg"), 
