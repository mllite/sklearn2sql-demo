...
-- Code For temporary table TMP_20180508185813_CODEGEN_FHMKF3_ADS_imp_1_OUT part 1. Create 


CREATE TEMPORARY TABLE `TMP_20180508185813_CODEGEN_FHMKF3_ADS_imp_1_OUT` (
	`KEY` BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20180508185813_CODEGEN_FHMKF3_ADS_imp_1_OUT part 2. Populate

INSERT INTO `TMP_20180508185813_CODEGEN_FHMKF3_ADS_imp_1_OUT` (`KEY`, imputer_output_2, imputer_output_3, imputer_output_4, imputer_output_5) SELECT `U`.`KEY`, `U`.imputer_output_2, `U`.imputer_output_3, `U`.imputer_output_4, `U`.imputer_output_5 
...
-- Code For temporary table TMP_20180508185813_CODEGEN_FHMKF3_ADS_imp_1_OUT part 3. Create Index 

CREATE INDEX `ix_TMP_20180508185813_CODEGEN_FHMKF3_ADS_imp_1_OUT_KEY` ON `TMP_20180508185813_CODEGEN_FHMKF3_ADS_imp_1_OUT` (`KEY`)

-- Code For temporary table TMP_20180508185813_CODEGEN_B131U1_ADS_sca_2_OUT part 1. Create 


CREATE TEMPORARY TABLE `TMP_20180508185813_CODEGEN_B131U1_ADS_sca_2_OUT` (
	`KEY` BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20180508185813_CODEGEN_B131U1_ADS_sca_2_OUT part 2. Populate

INSERT INTO `TMP_20180508185813_CODEGEN_B131U1_ADS_sca_2_OUT` (`KEY`, scaler_output_2, scaler_output_3, scaler_output_4, scaler_output_5) SELECT `U`.`KEY`, `U`.scaler_output_2, `U`.scaler_output_3, `U`.scaler_output_4, `U`.scaler_output_5 
...
FROM `TMP_20180508185813_CODEGEN_FHMKF3_ADS_imp_1_OUT` AS `ADS_imp_1_OUT`) AS `ADS_sca_2_OUT`) AS `U`

-- Code For temporary table TMP_20180508185813_CODEGEN_B131U1_ADS_sca_2_OUT part 3. Create Index 

CREATE INDEX `ix_TMP_20180508185813_CODEGEN_B131U1_ADS_sca_2_OUT_KEY` ON `TMP_20180508185813_CODEGEN_B131U1_ADS_sca_2_OUT` (`KEY`)

-- Code For temporary table TMP_20180508185813_CODEGEN_SLDLXA_KernAgg_B0 part 1. Create 


CREATE TEMPORARY TABLE `TMP_20180508185813_CODEGEN_SLDLXA_KernAgg_B0` (
	`KEY` BIGINT, 
	`OVO_Class1` BIGINT, 
	`OVO_Class2` BIGINT, 
	`OVO_Decision` BIGINT, 
...
-- Code For temporary table TMP_20180508185813_CODEGEN_SLDLXA_KernAgg_B0 part 2. Populate

INSERT INTO `TMP_20180508185813_CODEGEN_SLDLXA_KernAgg_B0` (`KEY`, `OVO_Class1`, `OVO_Class2`, `OVO_Decision`, `OVO_Confidence`) SELECT `U`.`KEY`, `U`.`OVO_Class1`, `U`.`OVO_Class2`, `U`.`OVO_Decision`, `U`.`OVO_Confidence` 
...
FROM `TMP_20180508185813_CODEGEN_B131U1_ADS_sca_2_OUT` AS `ADS_sca_2_OUT`), 
`SV_data_0_1` AS 
...
FROM (SELECT full_join_data_sv.`KEY` AS `KEY`, sum(full_join_data_sv.dot_prod1) + 0.017847346128780302 AS dot_product 
...
FROM (SELECT full_join_data_sv_1.`KEY` AS `KEY`, sum(full_join_data_sv_1.dot_prod1) + -0.13424915946945126 AS dot_product 
...
FROM (SELECT full_join_data_sv_2.`KEY` AS `KEY`, sum(full_join_data_sv_2.dot_prod1) + 0.05246188734842457 AS dot_product 
...
-- Code For temporary table TMP_20180508185813_CODEGEN_S5SLMX_KernAgg_Union part 1. Create 


CREATE TEMPORARY TABLE `TMP_20180508185813_CODEGEN_S5SLMX_KernAgg_Union` (
	`KEY` BIGINT, 
	`OVO_Class1` BIGINT, 
	`OVO_Class2` BIGINT, 
	`OVO_Decision` BIGINT, 
...
-- Code For temporary table TMP_20180508185813_CODEGEN_S5SLMX_KernAgg_Union part 2. Populate

INSERT INTO `TMP_20180508185813_CODEGEN_S5SLMX_KernAgg_Union` (`KEY`, `OVO_Class1`, `OVO_Class2`, `OVO_Decision`, `OVO_Confidence`) SELECT `U`.`KEY`, `U`.`OVO_Class1`, `U`.`OVO_Class2`, `U`.`OVO_Decision`, `U`.`OVO_Confidence` 
...
FROM `TMP_20180508185813_CODEGEN_SLDLXA_KernAgg_B0` AS `KernAgg_B0`) AS `KernAgg_EnsembleUnion`) AS `KernAgg_Union`) AS `U`

-- Code For temporary table TMP_20180508185813_CODEGEN_ZGNYL9_KernAgg part 1. Create 


CREATE TEMPORARY TABLE `TMP_20180508185813_CODEGEN_ZGNYL9_KernAgg` (
	`KEY` BIGINT NOT NULL, 
	`OVO_Vote_0` BIGINT, 
...
-- Code For temporary table TMP_20180508185813_CODEGEN_ZGNYL9_KernAgg part 2. Populate

INSERT INTO `TMP_20180508185813_CODEGEN_ZGNYL9_KernAgg` (`KEY`, `OVO_Vote_0`, `OVO_SumConfidence_0`, `OVO_Vote_1`, `OVO_SumConfidence_1`, `OVO_Vote_2`, `OVO_SumConfidence_2`, max_abs_confidence, `OVO_Scale`, `Score_0`, `Score_1`, `Score_2`) SELECT `U`.`KEY`, `U`.`OVO_Vote_0`, `U`.`OVO_SumConfidence_0`, `U`.`OVO_Vote_1`, `U`.`OVO_SumConfidence_1`, `U`.`OVO_Vote_2`, `U`.`OVO_SumConfidence_2`, `U`.max_abs_confidence, `U`.`OVO_Scale`, `U`.`Score_0`, `U`.`Score_1`, `U`.`Score_2` 
...
FROM `TMP_20180508185813_CODEGEN_S5SLMX_KernAgg_Union` AS `KernAgg_Union` GROUP BY `KernAgg_Union`.`KEY`) AS `Votes_Sel`), 
`OVO_SumConf_CTE` AS 
...
-- Code For temporary table TMP_20180508185813_CODEGEN_ZGNYL9_KernAgg part 3. Create Index 

CREATE INDEX `ix_TMP_20180508185813_CODEGEN_ZGNYL9_KernAgg_KEY` ON `TMP_20180508185813_CODEGEN_ZGNYL9_KernAgg` (`KEY`)
...
FROM `TMP_20180508185813_CODEGEN_ZGNYL9_KernAgg` AS `KernAgg`), 
