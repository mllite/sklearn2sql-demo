...
-- Code For temporary table TMP_20180508183241_CODEGEN_WWN4RC_WE_B0 part 1. Create 


CREATE TEMPORARY TABLE `TMP_20180508183241_CODEGEN_WWN4RC_WE_B0` (
	`KEY` BIGINT, 
	`Estimator` DOUBLE, 
	`Weight` DOUBLE, 
	est_index BIGINT
...
-- Code For temporary table TMP_20180508183241_CODEGEN_WWN4RC_WE_B0 part 2. Populate

INSERT INTO `TMP_20180508183241_CODEGEN_WWN4RC_WE_B0` (`KEY`, `Estimator`, `Weight`, est_index) SELECT `U`.`KEY`, `U`.`Estimator`, `U`.`Weight`, `U`.est_index 
...
-- Code For temporary table TMP_20180508183241_CODEGEN_W6GQNZ_WE_B1 part 1. Create 


CREATE TEMPORARY TABLE `TMP_20180508183241_CODEGEN_W6GQNZ_WE_B1` (
	`KEY` BIGINT, 
	`Estimator` DOUBLE, 
	`Weight` DOUBLE, 
	est_index BIGINT
...
-- Code For temporary table TMP_20180508183241_CODEGEN_W6GQNZ_WE_B1 part 2. Populate

INSERT INTO `TMP_20180508183241_CODEGEN_W6GQNZ_WE_B1` (`KEY`, `Estimator`, `Weight`, est_index) SELECT `U`.`KEY`, `U`.`Estimator`, `U`.`Weight`, `U`.est_index 
...
-- Code For temporary table TMP_20180508183241_CODEGEN_U24MJK_WE_Union part 1. Create 


CREATE TEMPORARY TABLE `TMP_20180508183241_CODEGEN_U24MJK_WE_Union` (
	`KEY` BIGINT, 
	`Estimator` DOUBLE, 
	`Weight` DOUBLE, 
	est_index BIGINT
...
-- Code For temporary table TMP_20180508183241_CODEGEN_U24MJK_WE_Union part 2. Populate

INSERT INTO `TMP_20180508183241_CODEGEN_U24MJK_WE_Union` (`KEY`, `Estimator`, `Weight`, est_index) SELECT `U`.`KEY`, `U`.`Estimator`, `U`.`Weight`, `U`.est_index 
...
FROM `TMP_20180508183241_CODEGEN_WWN4RC_WE_B0` AS `WE_B0` UNION ALL SELECT `WE_B1`.`KEY` AS `KEY`, `WE_B1`.`Estimator` AS `Estimator`, `WE_B1`.`Weight` AS `Weight`, `WE_B1`.est_index AS est_index 
FROM `TMP_20180508183241_CODEGEN_W6GQNZ_WE_B1` AS `WE_B1`) AS `WE_EnsembleUnion`) AS `WE_Union`) AS `U`

-- Code For temporary table TMP_20180508183241_CODEGEN_OHIIOO_Quantiles part 1. Create 


CREATE TEMPORARY TABLE `TMP_20180508183241_CODEGEN_OHIIOO_Quantiles` (
	`KEY` BIGINT, 
	`Quantile` DOUBLE
)
...
-- Code For temporary table TMP_20180508183241_CODEGEN_OHIIOO_Quantiles part 2. Populate

INSERT INTO `TMP_20180508183241_CODEGEN_OHIIOO_Quantiles` (`KEY`, `Quantile`) SELECT `U`.`KEY`, `U`.`Quantile` 
FROM (WITH `Cumulative_Frequencies` AS 
(SELECT `CW`.`KEY` AS `KEY`, `CW`.`Estimator` AS `Estimator`, `CW`.`Weight` AS `Weight`, `CW`.est_index AS est_index, `CW`.cum_weight AS cum_weight 
FROM (SELECT u1.`KEY` AS `KEY`, u1.`Estimator` AS `Estimator`, u1.`Weight` AS `Weight`, u1.est_index AS est_index, sum(u2.`Weight`) AS cum_weight 
FROM `TMP_20180508183241_CODEGEN_U24MJK_WE_Union` AS u1, `TMP_20180508183241_CODEGEN_U24MJK_WE_Union` AS u2 
...
FROM `TMP_20180508183241_CODEGEN_OHIIOO_Quantiles` AS `Quantiles`