...
-- Code For temporary table 6_CODEGEN_VVSPKF_QUANTILES part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "6_CODEGEN_VVSPKF_QUANTILES" (
	"KEY" NUMBER(19), 
...
-- Code For temporary table 6_CODEGEN_VVSPKF_QUANTILES part 2. Populate

INSERT INTO "6_CODEGEN_VVSPKF_QUANTILES" ("KEY", "Quantile") SELECT "U"."KEY", "U"."Quantile" 
...
FROM "6_CODEGEN_VVSPKF_QUANTILES" "Quantiles"