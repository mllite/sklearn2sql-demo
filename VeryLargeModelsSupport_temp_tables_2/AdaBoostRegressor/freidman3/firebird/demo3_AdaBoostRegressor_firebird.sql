...
-- Code For temporary table TMP_20180508185048_CODEGEN_VNI2 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508185048_CODEGEN_VNI2" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20180508185048_CODEGEN_VNI2 part 2. Populate

INSERT INTO "TMP_20180508185048_CODEGEN_VNI2" ("KEY", "Quantile") SELECT "U"."KEY", "U"."Quantile" 
...
-- Code For temporary table TMP_20180508185048_CODEGEN_VNI2 part 3. Create Index 

CREATE INDEX "ix_TMP_20180508185048_C_7e57" ON "TMP_20180508185048_CODEGEN_VNI2" ("KEY")

-- Model deployment code

SELECT "Quantiles"."KEY" AS "KEY", "Quantiles"."Quantile" AS "Estimator" 
FROM "TMP_20180508185048_CODEGEN_VNI2" AS "Quantiles"