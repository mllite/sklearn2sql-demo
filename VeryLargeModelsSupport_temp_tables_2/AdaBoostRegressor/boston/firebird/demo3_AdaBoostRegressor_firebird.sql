...
-- Code For temporary table TMP_20180508182851_CODEGEN_N1ZF part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508182851_CODEGEN_N1ZF" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20180508182851_CODEGEN_N1ZF part 2. Populate

INSERT INTO "TMP_20180508182851_CODEGEN_N1ZF" ("KEY", "Quantile") SELECT "U"."KEY", "U"."Quantile" 
...
-- Code For temporary table TMP_20180508182851_CODEGEN_N1ZF part 3. Create Index 

CREATE INDEX "ix_TMP_20180508182851_C_a1f5" ON "TMP_20180508182851_CODEGEN_N1ZF" ("KEY")

-- Model deployment code

SELECT "Quantiles"."KEY" AS "KEY", "Quantiles"."Quantile" AS "Estimator" 
FROM "TMP_20180508182851_CODEGEN_N1ZF" AS "Quantiles"