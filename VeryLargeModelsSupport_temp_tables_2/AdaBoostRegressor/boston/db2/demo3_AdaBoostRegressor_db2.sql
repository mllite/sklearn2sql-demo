...
-- Code For temporary table tmp_20180508182854_codegen_2pxyoj_quantiles part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180508182854_codegen_2pxyoj_quantiles (
	"KEY" BIGINT, 
	"Quantile" DOUBLE
)
...
-- Code For temporary table tmp_20180508182854_codegen_2pxyoj_quantiles part 2. Populate

INSERT INTO tmp_20180508182854_codegen_2pxyoj_quantiles WITH "DT_node_lookup" AS 
...
FROM tmp_20180508182854_codegen_2pxyoj_quantiles AS "Quantiles"