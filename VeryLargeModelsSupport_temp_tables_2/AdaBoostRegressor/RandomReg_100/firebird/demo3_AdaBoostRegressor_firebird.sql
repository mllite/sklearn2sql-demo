...
-- Code For temporary table TMP_20180508182445_CODEGEN_ZGSP part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508182445_CODEGEN_ZGSP" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20180508182445_CODEGEN_ZGSP part 2. Populate

INSERT INTO "TMP_20180508182445_CODEGEN_ZGSP" ("KEY", "Quantile") SELECT "U"."KEY", "U"."Quantile" 
...
-- Code For temporary table TMP_20180508182445_CODEGEN_ZGSP part 3. Create Index 

CREATE INDEX "ix_TMP_20180508182445_C_6b5d" ON "TMP_20180508182445_CODEGEN_ZGSP" ("KEY")

-- Model deployment code

SELECT "Quantiles"."KEY" AS "KEY", "Quantiles"."Quantile" AS "Estimator" 
FROM "TMP_20180508182445_CODEGEN_ZGSP" AS "Quantiles"