...
-- Code For temporary table TMP_20180508184708_CODEGEN_ESKO part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508184708_CODEGEN_ESKO" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20180508184708_CODEGEN_ESKO part 2. Populate

INSERT INTO "TMP_20180508184708_CODEGEN_ESKO" ("KEY", "Quantile") SELECT "U"."KEY", "U"."Quantile" 
...
-- Code For temporary table TMP_20180508184708_CODEGEN_ESKO part 3. Create Index 

CREATE INDEX "ix_TMP_20180508184708_C_ac9b" ON "TMP_20180508184708_CODEGEN_ESKO" ("KEY")

-- Model deployment code

SELECT "Quantiles"."KEY" AS "KEY", "Quantiles"."Quantile" AS "Estimator" 
FROM "TMP_20180508184708_CODEGEN_ESKO" AS "Quantiles"