...
-- Code For temporary table TMP_20180508180200_CODEGEN_YZGE part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508180200_CODEGEN_YZGE" (
	"KEY" BIGINT, 
...
-- Code For temporary table TMP_20180508180200_CODEGEN_YZGE part 2. Populate

INSERT INTO "TMP_20180508180200_CODEGEN_YZGE" ("KEY", "Proba_1", "Proba_0") SELECT "U"."KEY", "U"."Proba_1", "U"."Proba_0" 
...
-- Code For temporary table TMP_20180508180200_CODEGEN_ZWNO part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508180200_CODEGEN_ZWNO" (
	"KEY" BIGINT, 
	"Proba_1" DOUBLE PRECISION, 
	"Proba_0" DOUBLE PRECISION
)
...
-- Code For temporary table TMP_20180508180200_CODEGEN_ZWNO part 2. Populate

INSERT INTO "TMP_20180508180200_CODEGEN_ZWNO" ("KEY", "Proba_1", "Proba_0") SELECT "U"."KEY", "U"."Proba_1", "U"."Proba_0" 
...
FROM "TMP_20180508180200_CODEGEN_YZGE" AS "CalProb_B0") AS "CalProb_EnsembleUnion") AS "CalProb_Union") AS "U"

-- Code For temporary table TMP_20180508180200_CODEGEN_MDYP part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508180200_CODEGEN_MDYP" (
	"KEY" BIGINT NOT NULL, 
	"Proba_1" DOUBLE PRECISION, 
	"Proba_0" DOUBLE PRECISION, 
	PRIMARY KEY ("KEY")
...
-- Code For temporary table TMP_20180508180200_CODEGEN_MDYP part 2. Populate

INSERT INTO "TMP_20180508180200_CODEGEN_MDYP" ("KEY", "Proba_1", "Proba_0") SELECT "U"."KEY", "U"."Proba_1", "U"."Proba_0" 
...
FROM "TMP_20180508180200_CODEGEN_ZWNO" AS "CalProb_Union" GROUP BY "CalProb_Union"."KEY") AS "T") AS "CalProb_avg") AS "U"

-- Code For temporary table TMP_20180508180200_CODEGEN_MDYP part 3. Create Index 

CREATE INDEX "ix_TMP_20180508180200_C_7f2e" ON "TMP_20180508180200_CODEGEN_MDYP" ("KEY")
...
FROM "TMP_20180508180200_CODEGEN_MDYP" AS "CalProb_avg"), 
