...
-- Code For temporary table tmp_20180508195044_codegen_svsdnt_calprob_b0 part 1. Create 


CREATE TABLE tmp_20180508195044_codegen_svsdnt_calprob_b0 (
	`KEY` BIGINT, 
	`Proba_0` DOUBLE, 
	`Proba_1` DOUBLE, 
	`Proba_2` DOUBLE
...
-- Code For temporary table tmp_20180508195044_codegen_svsdnt_calprob_b0 part 2. Populate
...
FROM isotonic_cte_3)
 INSERT INTO tmp_20180508195044_codegen_svsdnt_calprob_b0 (`KEY`, `Proba_0`, `Proba_1`, `Proba_2`) SELECT `CalProb_B0`.`KEY`, `CalProb_B0`.`Proba_0`, `CalProb_B0`.`Proba_1`, `CalProb_B0`.`Proba_2` 
...
-- Code For temporary table tmp_20180508195044_codegen_oiip4s_calprob_union part 1. Create 


CREATE TABLE tmp_20180508195044_codegen_oiip4s_calprob_union (
	`KEY` BIGINT, 
	`Proba_0` DOUBLE, 
	`Proba_1` DOUBLE, 
	`Proba_2` DOUBLE
...
-- Code For temporary table tmp_20180508195044_codegen_oiip4s_calprob_union part 2. Populate

INSERT INTO tmp_20180508195044_codegen_oiip4s_calprob_union (`KEY`, `Proba_0`, `Proba_1`, `Proba_2`) SELECT `CalProb_Union`.`KEY`, `CalProb_Union`.`Proba_0`, `CalProb_Union`.`Proba_1`, `CalProb_Union`.`Proba_2` 
...
FROM tmp_20180508195044_codegen_svsdnt_calprob_b0 AS `CalProb_B0`) AS `CalProb_EnsembleUnion`) AS `CalProb_Union`

-- Code For temporary table tmp_20180508195044_codegen_ihllvs_calprob_avg part 1. Create 


CREATE TABLE tmp_20180508195044_codegen_ihllvs_calprob_avg (
	`KEY` BIGINT, 
	`Proba_0` DOUBLE, 
	`Proba_1` DOUBLE, 
	`Proba_2` DOUBLE
...
-- Code For temporary table tmp_20180508195044_codegen_ihllvs_calprob_avg part 2. Populate

INSERT INTO tmp_20180508195044_codegen_ihllvs_calprob_avg (`KEY`, `Proba_0`, `Proba_1`, `Proba_2`) SELECT `CalProb_avg`.`KEY`, `CalProb_avg`.`Proba_0`, `CalProb_avg`.`Proba_1`, `CalProb_avg`.`Proba_2` 
...
FROM tmp_20180508195044_codegen_oiip4s_calprob_union AS `CalProb_Union` GROUP BY `CalProb_Union`.`KEY`) AS `T`) AS `CalProb_avg`
...
FROM tmp_20180508195044_codegen_ihllvs_calprob_avg AS `CalProb_avg`), 
