...
-- Code For temporary table TMP_20180508190446_CODEGEN_1W09 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508190446_CODEGEN_1W09" (
	"KEY" BIGINT, 
...
-- Code For temporary table TMP_20180508190446_CODEGEN_1W09 part 2. Populate

INSERT INTO "TMP_20180508190446_CODEGEN_1W09" ("KEY", "Proba_CLASS_0", "Proba_CLASS_1", "Proba_CLASS_2") SELECT "U"."KEY", "U"."Proba_CLASS_0", "U"."Proba_CLASS_1", "U"."Proba_CLASS_2" 
...
-- Code For temporary table TMP_20180508190446_CODEGEN_EXAF part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508190446_CODEGEN_EXAF" (
	"KEY" BIGINT, 
	"Proba_CLASS_0" DOUBLE PRECISION, 
	"Proba_CLASS_1" DOUBLE PRECISION, 
	"Proba_CLASS_2" DOUBLE PRECISION
...
-- Code For temporary table TMP_20180508190446_CODEGEN_EXAF part 2. Populate

INSERT INTO "TMP_20180508190446_CODEGEN_EXAF" ("KEY", "Proba_CLASS_0", "Proba_CLASS_1", "Proba_CLASS_2") SELECT "U"."KEY", "U"."Proba_CLASS_0", "U"."Proba_CLASS_1", "U"."Proba_CLASS_2" 
...
FROM "TMP_20180508190446_CODEGEN_1W09" AS "CalProb_B0") AS "CalProb_EnsembleUnion") AS "CalProb_Union") AS "U"

-- Code For temporary table TMP_20180508190446_CODEGEN_NZMW part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508190446_CODEGEN_NZMW" (
	"KEY" BIGINT NOT NULL, 
	"Proba_CLASS_0" DOUBLE PRECISION, 
	"Proba_CLASS_1" DOUBLE PRECISION, 
	"Proba_CLASS_2" DOUBLE PRECISION, 
...
-- Code For temporary table TMP_20180508190446_CODEGEN_NZMW part 2. Populate

INSERT INTO "TMP_20180508190446_CODEGEN_NZMW" ("KEY", "Proba_CLASS_0", "Proba_CLASS_1", "Proba_CLASS_2") SELECT "U"."KEY", "U"."Proba_CLASS_0", "U"."Proba_CLASS_1", "U"."Proba_CLASS_2" 
...
FROM "TMP_20180508190446_CODEGEN_EXAF" AS "CalProb_Union" GROUP BY "CalProb_Union"."KEY") AS "T") AS "CalProb_avg") AS "U"

-- Code For temporary table TMP_20180508190446_CODEGEN_NZMW part 3. Create Index 

CREATE INDEX "ix_TMP_20180508190446_C_4e78" ON "TMP_20180508190446_CODEGEN_NZMW" ("KEY")
...
FROM "TMP_20180508190446_CODEGEN_NZMW" AS "CalProb_avg"), 
