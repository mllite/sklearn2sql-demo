...
-- Code For temporary table TMP_20180508180650_CODEGEN_EWW1 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508180650_CODEGEN_EWW1" (
	"KEY" BIGINT, 
...
-- Code For temporary table TMP_20180508180650_CODEGEN_EWW1 part 2. Populate

INSERT INTO "TMP_20180508180650_CODEGEN_EWW1" ("KEY", "Proba_1", "Proba_0") SELECT "U"."KEY", "U"."Proba_1", "U"."Proba_0" 
...
-- Code For temporary table TMP_20180508180650_CODEGEN_N557 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508180650_CODEGEN_N557" (
	"KEY" BIGINT, 
	"Proba_1" DOUBLE PRECISION, 
	"Proba_0" DOUBLE PRECISION
)
...
-- Code For temporary table TMP_20180508180650_CODEGEN_N557 part 2. Populate

INSERT INTO "TMP_20180508180650_CODEGEN_N557" ("KEY", "Proba_1", "Proba_0") SELECT "U"."KEY", "U"."Proba_1", "U"."Proba_0" 
...
FROM "TMP_20180508180650_CODEGEN_EWW1" AS "CalProb_B0") AS "CalProb_EnsembleUnion") AS "CalProb_Union") AS "U"

-- Code For temporary table TMP_20180508180650_CODEGEN_WM3M part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508180650_CODEGEN_WM3M" (
	"KEY" BIGINT NOT NULL, 
	"Proba_1" DOUBLE PRECISION, 
	"Proba_0" DOUBLE PRECISION, 
	PRIMARY KEY ("KEY")
...
-- Code For temporary table TMP_20180508180650_CODEGEN_WM3M part 2. Populate

INSERT INTO "TMP_20180508180650_CODEGEN_WM3M" ("KEY", "Proba_1", "Proba_0") SELECT "U"."KEY", "U"."Proba_1", "U"."Proba_0" 
...
FROM "TMP_20180508180650_CODEGEN_N557" AS "CalProb_Union" GROUP BY "CalProb_Union"."KEY") AS "T") AS "CalProb_avg") AS "U"

-- Code For temporary table TMP_20180508180650_CODEGEN_WM3M part 3. Create Index 

CREATE INDEX "ix_TMP_20180508180650_C_2c32" ON "TMP_20180508180650_CODEGEN_WM3M" ("KEY")
...
FROM "TMP_20180508180650_CODEGEN_WM3M" AS "CalProb_avg"), 
