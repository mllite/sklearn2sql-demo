...
-- Code For temporary table TMP_20180508182549_CODEGEN_H7DI part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508182549_CODEGEN_H7DI" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20180508182549_CODEGEN_H7DI part 3. Create Index 

CREATE INDEX "ix_TMP_20180508182549_C_aaa3" ON "TMP_20180508182549_CODEGEN_H7DI" ("KEY")

-- Code For temporary table TMP_20180508182549_CODEGEN_FCQ4 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508182549_CODEGEN_FCQ4" (
	"KEY" BIGINT NOT NULL, 
...
FROM "TMP_20180508182549_CODEGEN_H7DI" AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT") AS "U"

-- Code For temporary table TMP_20180508182549_CODEGEN_FCQ4 part 3. Create Index 

CREATE INDEX "ix_TMP_20180508182549_C_71a4" ON "TMP_20180508182549_CODEGEN_FCQ4" ("KEY")

-- Model deployment code

WITH dummy_class_reg_cte AS 
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", -11.471614782695335 AS "Constant" 
FROM "TMP_20180508182549_CODEGEN_FCQ4" AS "ADS_sca_2_OUT")
