...
-- Code For temporary table TMP_20180508185835_CODEGEN_AAIH part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508185835_CODEGEN_AAIH" (
	"KEY" BIGINT, 
	"OVO_Class1" BIGINT, 
	"OVO_Class2" BIGINT, 
	"OVO_Decision" BIGINT, 
...
-- Code For temporary table TMP_20180508185835_CODEGEN_AAIH part 2. Populate

INSERT INTO "TMP_20180508185835_CODEGEN_AAIH" ("KEY", "OVO_Class1", "OVO_Class2", "OVO_Decision", "OVO_Confidence") SELECT "U"."KEY", "U"."OVO_Class1", "U"."OVO_Class2", "U"."OVO_Decision", "U"."OVO_Confidence" 
...
kernel_cte_0_1 AS 
(SELECT kernel_dp_0_1."KEY" AS "KEY", 0 AS "OVO_Class1", 1 AS "OVO_Class2", CASE WHEN (-kernel_dp_0_1.dot_product >= 0.0) THEN 1 ELSE 0 END AS "OVO_Decision", coalesce(-kernel_dp_0_1.dot_product, 1.0 / (1.0 + exp(CASE WHEN (minvalue(maxvalue(-100.0, -(-((-kernel_dp_0_1.dot_product) * -2.20273021964727 + -0.5086671549035818))), 100.0) >= -709.782712893384) THEN minvalue(maxvalue(-100.0, -(-((-kernel_dp_0_1.dot_product) * -2.20273021964727 + -0.5086671549035818))), 100.0) ELSE -709.782712893384 END))) AS "OVO_Confidence" 
FROM kernel_dp_0_1), 
"SV_data_0_2" AS 
(SELECT "Values".sv_idx AS sv_idx, CAST("Values".dual_coeff AS DOUBLE PRECISION) AS dual_coeff, CAST("Values".sv_0 AS DOUBLE PRECISION) AS sv_0, CAST("Values".sv_1 AS DOUBLE PRECISION) AS sv_1, CAST("Values".sv_2 AS DOUBLE PRECISION) AS sv_2, CAST("Values".sv_3 AS DOUBLE PRECISION) AS sv_3 
...
kernel_cte_0_2 AS 
(SELECT kernel_dp_0_2."KEY" AS "KEY", 0 AS "OVO_Class1", 2 AS "OVO_Class2", CASE WHEN (-kernel_dp_0_2.dot_product >= 0.0) THEN 1 ELSE 0 END AS "OVO_Decision", coalesce(-kernel_dp_0_2.dot_product, 1.0 / (1.0 + exp(CASE WHEN (minvalue(maxvalue(-100.0, -(-((-kernel_dp_0_2.dot_product) * -2.772227796706661 + -0.22178923028769001))), 100.0) >= -709.782712893384) THEN minvalue(maxvalue(-100.0, -(-((-kernel_dp_0_2.dot_product) * -2.772227796706661 + -0.22178923028769001))), 100.0) ELSE -709.782712893384 END))) AS "OVO_Confidence" 
FROM kernel_dp_0_2), 
"SV_data_1_2" AS 
(SELECT "Values".sv_idx AS sv_idx, CAST("Values".dual_coeff AS DOUBLE PRECISION) AS dual_coeff, CAST("Values".sv_0 AS DOUBLE PRECISION) AS sv_0, CAST("Values".sv_1 AS DOUBLE PRECISION) AS sv_1, CAST("Values".sv_2 AS DOUBLE PRECISION) AS sv_2, CAST("Values".sv_3 AS DOUBLE PRECISION) AS sv_3 
...
kernel_cte_1_2 AS 
(SELECT kernel_dp_1_2."KEY" AS "KEY", 1 AS "OVO_Class1", 2 AS "OVO_Class2", CASE WHEN (-kernel_dp_1_2.dot_product >= 0.0) THEN 1 ELSE 0 END AS "OVO_Decision", coalesce(-kernel_dp_1_2.dot_product, 1.0 / (1.0 + exp(CASE WHEN (minvalue(maxvalue(-100.0, -(-((-kernel_dp_1_2.dot_product) * -2.3909594132602967 + 0.07675434451530815))), 100.0) >= -709.782712893384) THEN minvalue(maxvalue(-100.0, -(-((-kernel_dp_1_2.dot_product) * -2.3909594132602967 + 0.07675434451530815))), 100.0) ELSE -709.782712893384 END))) AS "OVO_Confidence" 
FROM kernel_dp_1_2)
...
-- Code For temporary table TMP_20180508185835_CODEGEN_7ZKD part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508185835_CODEGEN_7ZKD" (
	"KEY" BIGINT, 
	"OVO_Class1" BIGINT, 
	"OVO_Class2" BIGINT, 
	"OVO_Decision" BIGINT, 
...
-- Code For temporary table TMP_20180508185835_CODEGEN_7ZKD part 2. Populate

INSERT INTO "TMP_20180508185835_CODEGEN_7ZKD" ("KEY", "OVO_Class1", "OVO_Class2", "OVO_Decision", "OVO_Confidence") SELECT "U"."KEY", "U"."OVO_Class1", "U"."OVO_Class2", "U"."OVO_Decision", "U"."OVO_Confidence" 
...
FROM "TMP_20180508185835_CODEGEN_AAIH" AS "KernAgg_B0") AS "KernAgg_EnsembleUnion") AS "KernAgg_Union") AS "U"

-- Code For temporary table TMP_20180508185835_CODEGEN_GMDO part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508185835_CODEGEN_GMDO" (
	"KEY" BIGINT NOT NULL, 
	"OVO_Vote_0" BIGINT, 
...
FROM "TMP_20180508185835_CODEGEN_7ZKD" AS "KernAgg_Union" GROUP BY "KernAgg_Union"."KEY") AS "Votes_Sel"), 
"OVO_SumConf_CTE" AS 
...
-- Code For temporary table TMP_20180508185835_CODEGEN_GMDO part 3. Create Index 

CREATE INDEX "ix_TMP_20180508185835_C_9479" ON "TMP_20180508185835_CODEGEN_GMDO" ("KEY")
...
FROM "TMP_20180508185835_CODEGEN_GMDO" AS "KernAgg"), 
