...
-- Code For temporary table ##TMP_20180508185834_CODEGEN_XPLFP8_KernAgg_B0 part 1. Create 


CREATE TABLE ##TMP_20180508185834_CODEGEN_XPLFP8_KernAgg_B0 (
	[KEY] BIGINT NULL, 
...
-- Code For temporary table ##TMP_20180508185834_CODEGEN_XPLFP8_KernAgg_B0 part 2. Populate
...
kernel_cte_0_1 AS 
(SELECT kernel_dp_0_1.[KEY] AS [KEY], 0 AS [OVO_Class1], 1 AS [OVO_Class2], CASE WHEN (-kernel_dp_0_1.dot_product >= 0.0) THEN 1 ELSE 0 END AS [OVO_Decision], coalesce(-kernel_dp_0_1.dot_product, 1.0 / (1.0 + exp(CASE WHEN (CASE WHEN (-100.0 <= -(-((-kernel_dp_0_1.dot_product) * -2.20273021964727 + -0.5086671549035818))) THEN -(-((-kernel_dp_0_1.dot_product) * -2.20273021964727 + -0.5086671549035818)) ELSE -100.0 END <= 100.0) THEN CASE WHEN (-100.0 <= -(-((-kernel_dp_0_1.dot_product) * -2.20273021964727 + -0.5086671549035818))) THEN -(-((-kernel_dp_0_1.dot_product) * -2.20273021964727 + -0.5086671549035818)) ELSE -100.0 END ELSE 100.0 END))) AS [OVO_Confidence] 
FROM kernel_dp_0_1), 
[SV_data_0_2] AS 
(SELECT [Values].sv_idx AS sv_idx, CAST([Values].dual_coeff AS FLOAT(53)) AS dual_coeff, CAST([Values].sv_0 AS FLOAT(53)) AS sv_0, CAST([Values].sv_1 AS FLOAT(53)) AS sv_1, CAST([Values].sv_2 AS FLOAT(53)) AS sv_2, CAST([Values].sv_3 AS FLOAT(53)) AS sv_3 
...
kernel_cte_0_2 AS 
(SELECT kernel_dp_0_2.[KEY] AS [KEY], 0 AS [OVO_Class1], 2 AS [OVO_Class2], CASE WHEN (-kernel_dp_0_2.dot_product >= 0.0) THEN 1 ELSE 0 END AS [OVO_Decision], coalesce(-kernel_dp_0_2.dot_product, 1.0 / (1.0 + exp(CASE WHEN (CASE WHEN (-100.0 <= -(-((-kernel_dp_0_2.dot_product) * -2.772227796706661 + -0.22178923028769001))) THEN -(-((-kernel_dp_0_2.dot_product) * -2.772227796706661 + -0.22178923028769001)) ELSE -100.0 END <= 100.0) THEN CASE WHEN (-100.0 <= -(-((-kernel_dp_0_2.dot_product) * -2.772227796706661 + -0.22178923028769001))) THEN -(-((-kernel_dp_0_2.dot_product) * -2.772227796706661 + -0.22178923028769001)) ELSE -100.0 END ELSE 100.0 END))) AS [OVO_Confidence] 
FROM kernel_dp_0_2), 
[SV_data_1_2] AS 
(SELECT [Values].sv_idx AS sv_idx, CAST([Values].dual_coeff AS FLOAT(53)) AS dual_coeff, CAST([Values].sv_0 AS FLOAT(53)) AS sv_0, CAST([Values].sv_1 AS FLOAT(53)) AS sv_1, CAST([Values].sv_2 AS FLOAT(53)) AS sv_2, CAST([Values].sv_3 AS FLOAT(53)) AS sv_3 
...
kernel_cte_1_2 AS 
(SELECT kernel_dp_1_2.[KEY] AS [KEY], 1 AS [OVO_Class1], 2 AS [OVO_Class2], CASE WHEN (-kernel_dp_1_2.dot_product >= 0.0) THEN 1 ELSE 0 END AS [OVO_Decision], coalesce(-kernel_dp_1_2.dot_product, 1.0 / (1.0 + exp(CASE WHEN (CASE WHEN (-100.0 <= -(-((-kernel_dp_1_2.dot_product) * -2.3909594132602967 + 0.07675434451530815))) THEN -(-((-kernel_dp_1_2.dot_product) * -2.3909594132602967 + 0.07675434451530815)) ELSE -100.0 END <= 100.0) THEN CASE WHEN (-100.0 <= -(-((-kernel_dp_1_2.dot_product) * -2.3909594132602967 + 0.07675434451530815))) THEN -(-((-kernel_dp_1_2.dot_product) * -2.3909594132602967 + 0.07675434451530815)) ELSE -100.0 END ELSE 100.0 END))) AS [OVO_Confidence] 
FROM kernel_dp_1_2)
 INSERT INTO ##TMP_20180508185834_CODEGEN_XPLFP8_KernAgg_B0 ([KEY], [OVO_Class1], [OVO_Class2], [OVO_Decision], [OVO_Confidence]) SELECT [KernAgg_B0].[KEY], [KernAgg_B0].[OVO_Class1], [KernAgg_B0].[OVO_Class2], [KernAgg_B0].[OVO_Decision], [KernAgg_B0].[OVO_Confidence] 
...
-- Code For temporary table ##TMP_20180508185834_CODEGEN_KALV4T_KernAgg_Union part 1. Create 


CREATE TABLE ##TMP_20180508185834_CODEGEN_KALV4T_KernAgg_Union (
	[KEY] BIGINT NULL, 
	[OVO_Class1] BIGINT NULL, 
	[OVO_Class2] BIGINT NULL, 
	[OVO_Decision] BIGINT NULL, 
...
-- Code For temporary table ##TMP_20180508185834_CODEGEN_KALV4T_KernAgg_Union part 2. Populate

INSERT INTO ##TMP_20180508185834_CODEGEN_KALV4T_KernAgg_Union ([KEY], [OVO_Class1], [OVO_Class2], [OVO_Decision], [OVO_Confidence]) SELECT [KernAgg_Union].[KEY], [KernAgg_Union].[OVO_Class1], [KernAgg_Union].[OVO_Class2], [KernAgg_Union].[OVO_Decision], [KernAgg_Union].[OVO_Confidence] 
...
FROM ##TMP_20180508185834_CODEGEN_XPLFP8_KernAgg_B0 AS [KernAgg_B0]) AS [KernAgg_EnsembleUnion]) AS [KernAgg_Union]

-- Code For temporary table ##TMP_20180508185834_CODEGEN_52MUYW_KernAgg part 1. Create 


CREATE TABLE ##TMP_20180508185834_CODEGEN_52MUYW_KernAgg (
	[KEY] BIGINT NULL, 
...
-- Code For temporary table ##TMP_20180508185834_CODEGEN_52MUYW_KernAgg part 2. Populate
...
FROM ##TMP_20180508185834_CODEGEN_KALV4T_KernAgg_Union AS [KernAgg_Union] GROUP BY [KernAgg_Union].[KEY]) AS [Votes_Sel]), 
[OVO_SumConf_CTE] AS 
...
FROM [OVO_Votes], [MinMaxConf])
 INSERT INTO ##TMP_20180508185834_CODEGEN_52MUYW_KernAgg ([KEY], [OVO_Vote_0], [OVO_SumConfidence_0], [OVO_Vote_1], [OVO_SumConfidence_1], [OVO_Vote_2], [OVO_SumConfidence_2], max_abs_confidence, [OVO_Scale], [Score_0], [Score_1], [Score_2]) SELECT [KernAgg].[KEY], [KernAgg].[OVO_Vote_0], [KernAgg].[OVO_SumConfidence_0], [KernAgg].[OVO_Vote_1], [KernAgg].[OVO_SumConfidence_1], [KernAgg].[OVO_Vote_2], [KernAgg].[OVO_SumConfidence_2], [KernAgg].max_abs_confidence, [KernAgg].[OVO_Scale], [KernAgg].[Score_0], [KernAgg].[Score_1], [KernAgg].[Score_2] 
...
FROM ##TMP_20180508185834_CODEGEN_52MUYW_KernAgg AS [KernAgg]), 
