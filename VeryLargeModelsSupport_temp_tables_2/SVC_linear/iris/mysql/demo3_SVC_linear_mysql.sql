...
-- Code For temporary table TMP_20180508185833_CODEGEN_OA0MM7_KernAgg_B0 part 1. Create 


CREATE TEMPORARY TABLE `TMP_20180508185833_CODEGEN_OA0MM7_KernAgg_B0` (
	`KEY` BIGINT, 
	`OVO_Class1` BIGINT, 
	`OVO_Class2` BIGINT, 
	`OVO_Decision` BIGINT, 
...
-- Code For temporary table TMP_20180508185833_CODEGEN_OA0MM7_KernAgg_B0 part 2. Populate

INSERT INTO `TMP_20180508185833_CODEGEN_OA0MM7_KernAgg_B0` (`KEY`, `OVO_Class1`, `OVO_Class2`, `OVO_Decision`, `OVO_Confidence`) SELECT `U`.`KEY`, `U`.`OVO_Class1`, `U`.`OVO_Class2`, `U`.`OVO_Decision`, `U`.`OVO_Confidence` 
...
FROM (SELECT full_join_data_sv.`KEY` AS `KEY`, sum(full_join_data_sv.dot_prod1) + 1.4519466669807166 AS dot_product 
...
kernel_cte_0_1 AS 
(SELECT kernel_dp_0_1.`KEY` AS `KEY`, 0 AS `OVO_Class1`, 1 AS `OVO_Class2`, CASE WHEN (-kernel_dp_0_1.dot_product >= 0.0) THEN 1 ELSE 0 END AS `OVO_Decision`, coalesce(-kernel_dp_0_1.dot_product, 1.0 / (1.0 + exp(least(greatest(-100.0, -(-((-kernel_dp_0_1.dot_product) * -2.20273021964727 + -0.5086671549035818))), 100.0)))) AS `OVO_Confidence` 
FROM kernel_dp_0_1), 
`SV_data_0_2` AS 
(SELECT `Values`.sv_idx AS sv_idx, `Values`.dual_coeff AS dual_coeff, `Values`.sv_0 AS sv_0, `Values`.sv_1 AS sv_1, `Values`.sv_2 AS sv_2, `Values`.sv_3 AS sv_3 
...
FROM (SELECT full_join_data_sv_1.`KEY` AS `KEY`, sum(full_join_data_sv_1.dot_prod1) + 1.5072878538334147 AS dot_product 
...
kernel_cte_0_2 AS 
(SELECT kernel_dp_0_2.`KEY` AS `KEY`, 0 AS `OVO_Class1`, 2 AS `OVO_Class2`, CASE WHEN (-kernel_dp_0_2.dot_product >= 0.0) THEN 1 ELSE 0 END AS `OVO_Decision`, coalesce(-kernel_dp_0_2.dot_product, 1.0 / (1.0 + exp(least(greatest(-100.0, -(-((-kernel_dp_0_2.dot_product) * -2.772227796706661 + -0.22178923028769001))), 100.0)))) AS `OVO_Confidence` 
FROM kernel_dp_0_2), 
`SV_data_1_2` AS 
(SELECT `Values`.sv_idx AS sv_idx, `Values`.dual_coeff AS dual_coeff, `Values`.sv_0 AS sv_0, `Values`.sv_1 AS sv_1, `Values`.sv_2 AS sv_2, `Values`.sv_3 AS sv_3 
...
FROM (SELECT full_join_data_sv_2.`KEY` AS `KEY`, sum(full_join_data_sv_2.dot_prod1) + 6.454311462025748 AS dot_product 
...
kernel_cte_1_2 AS 
(SELECT kernel_dp_1_2.`KEY` AS `KEY`, 1 AS `OVO_Class1`, 2 AS `OVO_Class2`, CASE WHEN (-kernel_dp_1_2.dot_product >= 0.0) THEN 1 ELSE 0 END AS `OVO_Decision`, coalesce(-kernel_dp_1_2.dot_product, 1.0 / (1.0 + exp(least(greatest(-100.0, -(-((-kernel_dp_1_2.dot_product) * -2.3909594132602967 + 0.07675434451530815))), 100.0)))) AS `OVO_Confidence` 
FROM kernel_dp_1_2)
...
-- Code For temporary table TMP_20180508185833_CODEGEN_A5KUNW_KernAgg_Union part 1. Create 


CREATE TEMPORARY TABLE `TMP_20180508185833_CODEGEN_A5KUNW_KernAgg_Union` (
	`KEY` BIGINT, 
	`OVO_Class1` BIGINT, 
	`OVO_Class2` BIGINT, 
	`OVO_Decision` BIGINT, 
...
-- Code For temporary table TMP_20180508185833_CODEGEN_A5KUNW_KernAgg_Union part 2. Populate

INSERT INTO `TMP_20180508185833_CODEGEN_A5KUNW_KernAgg_Union` (`KEY`, `OVO_Class1`, `OVO_Class2`, `OVO_Decision`, `OVO_Confidence`) SELECT `U`.`KEY`, `U`.`OVO_Class1`, `U`.`OVO_Class2`, `U`.`OVO_Decision`, `U`.`OVO_Confidence` 
...
FROM `TMP_20180508185833_CODEGEN_OA0MM7_KernAgg_B0` AS `KernAgg_B0`) AS `KernAgg_EnsembleUnion`) AS `KernAgg_Union`) AS `U`

-- Code For temporary table TMP_20180508185833_CODEGEN_VKD042_KernAgg part 1. Create 


CREATE TEMPORARY TABLE `TMP_20180508185833_CODEGEN_VKD042_KernAgg` (
	`KEY` BIGINT NOT NULL, 
	`OVO_Vote_0` BIGINT, 
...
-- Code For temporary table TMP_20180508185833_CODEGEN_VKD042_KernAgg part 2. Populate

INSERT INTO `TMP_20180508185833_CODEGEN_VKD042_KernAgg` (`KEY`, `OVO_Vote_0`, `OVO_SumConfidence_0`, `OVO_Vote_1`, `OVO_SumConfidence_1`, `OVO_Vote_2`, `OVO_SumConfidence_2`, max_abs_confidence, `OVO_Scale`, `Score_0`, `Score_1`, `Score_2`) SELECT `U`.`KEY`, `U`.`OVO_Vote_0`, `U`.`OVO_SumConfidence_0`, `U`.`OVO_Vote_1`, `U`.`OVO_SumConfidence_1`, `U`.`OVO_Vote_2`, `U`.`OVO_SumConfidence_2`, `U`.max_abs_confidence, `U`.`OVO_Scale`, `U`.`Score_0`, `U`.`Score_1`, `U`.`Score_2` 
...
FROM `TMP_20180508185833_CODEGEN_A5KUNW_KernAgg_Union` AS `KernAgg_Union` GROUP BY `KernAgg_Union`.`KEY`) AS `Votes_Sel`), 
`OVO_SumConf_CTE` AS 
...
-- Code For temporary table TMP_20180508185833_CODEGEN_VKD042_KernAgg part 3. Create Index 

CREATE INDEX `ix_TMP_20180508185833_CODEGEN_VKD042_KernAgg_KEY` ON `TMP_20180508185833_CODEGEN_VKD042_KernAgg` (`KEY`)
...
FROM `TMP_20180508185833_CODEGEN_VKD042_KernAgg` AS `KernAgg`), 
