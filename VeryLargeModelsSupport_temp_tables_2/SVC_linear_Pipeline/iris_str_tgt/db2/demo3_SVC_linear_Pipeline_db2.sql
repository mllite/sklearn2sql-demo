...
-- Code For temporary table tmp_20180508190815_codegen_1e5shu_ads_imp_1_out part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180508190815_codegen_1e5shu_ads_imp_1_out (
	"KEY" BIGINT, 
...
-- Code For temporary table tmp_20180508190815_codegen_1e5shu_ads_imp_1_out part 2. Populate

INSERT INTO tmp_20180508190815_codegen_1e5shu_ads_imp_1_out SELECT "ADS_imp_1_OUT"."KEY", "ADS_imp_1_OUT".imputer_output_2, "ADS_imp_1_OUT".imputer_output_3, "ADS_imp_1_OUT".imputer_output_4, "ADS_imp_1_OUT".imputer_output_5 
...
-- Code For temporary table tmp_20180508190815_codegen_f2d6mo_ads_sca_2_out part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180508190815_codegen_f2d6mo_ads_sca_2_out (
	"KEY" BIGINT, 
...
-- Code For temporary table tmp_20180508190815_codegen_f2d6mo_ads_sca_2_out part 2. Populate

INSERT INTO tmp_20180508190815_codegen_f2d6mo_ads_sca_2_out SELECT "ADS_sca_2_OUT"."KEY", "ADS_sca_2_OUT".scaler_output_2, "ADS_sca_2_OUT".scaler_output_3, "ADS_sca_2_OUT".scaler_output_4, "ADS_sca_2_OUT".scaler_output_5 
...
FROM tmp_20180508190815_codegen_1e5shu_ads_imp_1_out AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT"

-- Code For temporary table tmp_20180508190815_codegen_1cm2no_kernagg_b0 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180508190815_codegen_1cm2no_kernagg_b0 (
	"KEY" BIGINT, 
...
-- Code For temporary table tmp_20180508190815_codegen_1cm2no_kernagg_b0 part 2. Populate

INSERT INTO tmp_20180508190815_codegen_1cm2no_kernagg_b0 WITH kernel_input AS 
...
FROM tmp_20180508190815_codegen_f2d6mo_ads_sca_2_out AS "ADS_sca_2_OUT"), 
...
-- Code For temporary table tmp_20180508190815_codegen_sfrvc0_kernagg_union part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180508190815_codegen_sfrvc0_kernagg_union (
	"KEY" BIGINT, 
	"OVO_Class1" VARCHAR(None), 
	"OVO_Class2" VARCHAR(None), 
	"OVO_Decision" BIGINT, 
...
-- Code For temporary table tmp_20180508190815_codegen_sfrvc0_kernagg_union part 2. Populate

INSERT INTO tmp_20180508190815_codegen_sfrvc0_kernagg_union SELECT "KernAgg_Union"."KEY", "KernAgg_Union"."OVO_Class1", "KernAgg_Union"."OVO_Class2", "KernAgg_Union"."OVO_Decision", "KernAgg_Union"."OVO_Confidence" 
...
FROM tmp_20180508190815_codegen_1cm2no_kernagg_b0 AS "KernAgg_B0") AS "KernAgg_EnsembleUnion") AS "KernAgg_Union"

-- Code For temporary table tmp_20180508190815_codegen_116716_kernagg part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180508190815_codegen_116716_kernagg (
	"KEY" BIGINT, 
...
-- Code For temporary table tmp_20180508190815_codegen_116716_kernagg part 2. Populate

INSERT INTO tmp_20180508190815_codegen_116716_kernagg WITH "OVO_Votes" AS 
...
FROM tmp_20180508190815_codegen_sfrvc0_kernagg_union AS "KernAgg_Union" GROUP BY "KernAgg_Union"."KEY") AS "Votes_Sel"), 
"OVO_SumConf_CTE" AS 
...
FROM tmp_20180508190815_codegen_116716_kernagg AS "KernAgg"), 
