...
-- Code For temporary table tmp_20180508190810_codegen_tidkqm_ads_imp_1_out part 1. Create 


CREATE TEMPORARY TABLE tmp_20180508190810_codegen_tidkqm_ads_imp_1_out (
	"KEY" BIGINT, 
...
-- Code For temporary table tmp_20180508190810_codegen_tidkqm_ads_imp_1_out part 2. Populate

INSERT INTO tmp_20180508190810_codegen_tidkqm_ads_imp_1_out ("KEY", imputer_output_2, imputer_output_3, imputer_output_4, imputer_output_5) SELECT "U"."KEY", "U".imputer_output_2, "U".imputer_output_3, "U".imputer_output_4, "U".imputer_output_5 
...
-- Code For temporary table tmp_20180508190810_codegen_9z18rq_ads_sca_2_out part 1. Create 


CREATE TEMPORARY TABLE tmp_20180508190810_codegen_9z18rq_ads_sca_2_out (
	"KEY" BIGINT, 
...
-- Code For temporary table tmp_20180508190810_codegen_9z18rq_ads_sca_2_out part 2. Populate

INSERT INTO tmp_20180508190810_codegen_9z18rq_ads_sca_2_out ("KEY", scaler_output_2, scaler_output_3, scaler_output_4, scaler_output_5) SELECT "U"."KEY", "U".scaler_output_2, "U".scaler_output_3, "U".scaler_output_4, "U".scaler_output_5 
...
FROM tmp_20180508190810_codegen_tidkqm_ads_imp_1_out AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT") AS "U"

-- Code For temporary table tmp_20180508190810_codegen_llj1sw_kernagg_b0 part 1. Create 


CREATE TEMPORARY TABLE tmp_20180508190810_codegen_llj1sw_kernagg_b0 (
	"KEY" BIGINT, 
	"OVO_Class1" CLOB, 
	"OVO_Class2" CLOB, 
	"OVO_Decision" BIGINT, 
...
-- Code For temporary table tmp_20180508190810_codegen_llj1sw_kernagg_b0 part 2. Populate

INSERT INTO tmp_20180508190810_codegen_llj1sw_kernagg_b0 ("KEY", "OVO_Class1", "OVO_Class2", "OVO_Decision", "OVO_Confidence") SELECT "U"."KEY", "U"."OVO_Class1", "U"."OVO_Class2", "U"."OVO_Decision", "U"."OVO_Confidence" 
...
FROM tmp_20180508190810_codegen_9z18rq_ads_sca_2_out AS "ADS_sca_2_OUT"), 
...
-- Code For temporary table tmp_20180508190810_codegen_jw1x3w_kernagg_union part 1. Create 


CREATE TEMPORARY TABLE tmp_20180508190810_codegen_jw1x3w_kernagg_union (
	"KEY" BIGINT, 
	"OVO_Class1" CLOB, 
	"OVO_Class2" CLOB, 
	"OVO_Decision" BIGINT, 
...
-- Code For temporary table tmp_20180508190810_codegen_jw1x3w_kernagg_union part 2. Populate

INSERT INTO tmp_20180508190810_codegen_jw1x3w_kernagg_union ("KEY", "OVO_Class1", "OVO_Class2", "OVO_Decision", "OVO_Confidence") SELECT "U"."KEY", "U"."OVO_Class1", "U"."OVO_Class2", "U"."OVO_Decision", "U"."OVO_Confidence" 
...
FROM tmp_20180508190810_codegen_llj1sw_kernagg_b0 AS "KernAgg_B0") AS "KernAgg_EnsembleUnion") AS "KernAgg_Union") AS "U"

-- Code For temporary table tmp_20180508190810_codegen_gu9kbj_kernagg part 1. Create 


CREATE TEMPORARY TABLE tmp_20180508190810_codegen_gu9kbj_kernagg (
	"KEY" BIGINT, 
...
-- Code For temporary table tmp_20180508190810_codegen_gu9kbj_kernagg part 2. Populate

INSERT INTO tmp_20180508190810_codegen_gu9kbj_kernagg ("KEY", "OVO_Vote_CLASS_0", "OVO_SumConfidence_CLASS_0", "OVO_Vote_CLASS_1", "OVO_SumConfidence_CLASS_1", "OVO_Vote_CLASS_2", "OVO_SumConfidence_CLASS_2", max_abs_confidence, "OVO_Scale", "Score_CLASS_0", "Score_CLASS_1", "Score_CLASS_2") SELECT "U"."KEY", "U"."OVO_Vote_CLASS_0", "U"."OVO_SumConfidence_CLASS_0", "U"."OVO_Vote_CLASS_1", "U"."OVO_SumConfidence_CLASS_1", "U"."OVO_Vote_CLASS_2", "U"."OVO_SumConfidence_CLASS_2", "U".max_abs_confidence, "U"."OVO_Scale", "U"."Score_CLASS_0", "U"."Score_CLASS_1", "U"."Score_CLASS_2" 
...
FROM tmp_20180508190810_codegen_jw1x3w_kernagg_union AS "KernAgg_Union" GROUP BY "KernAgg_Union"."KEY") AS "Votes_Sel"), 
"OVO_SumConf_CTE" AS 
...
FROM tmp_20180508190810_codegen_gu9kbj_kernagg AS "KernAgg"), 
