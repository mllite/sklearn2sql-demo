...
-- Code For temporary table ##TMP_20180508190810_CODEGEN_WPMEOK_ADS_imp_1_OUT part 1. Create 


CREATE TABLE ##TMP_20180508190810_CODEGEN_WPMEOK_ADS_imp_1_OUT (
	[KEY] BIGINT NULL, 
...
-- Code For temporary table ##TMP_20180508190810_CODEGEN_WPMEOK_ADS_imp_1_OUT part 2. Populate

INSERT INTO ##TMP_20180508190810_CODEGEN_WPMEOK_ADS_imp_1_OUT ([KEY], imputer_output_2, imputer_output_3, imputer_output_4, imputer_output_5) SELECT [ADS_imp_1_OUT].[KEY], [ADS_imp_1_OUT].imputer_output_2, [ADS_imp_1_OUT].imputer_output_3, [ADS_imp_1_OUT].imputer_output_4, [ADS_imp_1_OUT].imputer_output_5 
...
-- Code For temporary table ##TMP_20180508190810_CODEGEN_KE1Z8I_ADS_sca_2_OUT part 1. Create 


CREATE TABLE ##TMP_20180508190810_CODEGEN_KE1Z8I_ADS_sca_2_OUT (
	[KEY] BIGINT NULL, 
...
-- Code For temporary table ##TMP_20180508190810_CODEGEN_KE1Z8I_ADS_sca_2_OUT part 2. Populate

INSERT INTO ##TMP_20180508190810_CODEGEN_KE1Z8I_ADS_sca_2_OUT ([KEY], scaler_output_2, scaler_output_3, scaler_output_4, scaler_output_5) SELECT [ADS_sca_2_OUT].[KEY], [ADS_sca_2_OUT].scaler_output_2, [ADS_sca_2_OUT].scaler_output_3, [ADS_sca_2_OUT].scaler_output_4, [ADS_sca_2_OUT].scaler_output_5 
...
FROM ##TMP_20180508190810_CODEGEN_WPMEOK_ADS_imp_1_OUT AS [ADS_imp_1_OUT]) AS [ADS_sca_2_OUT]

-- Code For temporary table ##TMP_20180508190810_CODEGEN_J94W3X_KernAgg_B0 part 1. Create 


CREATE TABLE ##TMP_20180508190810_CODEGEN_J94W3X_KernAgg_B0 (
	[KEY] BIGINT NULL, 
...
-- Code For temporary table ##TMP_20180508190810_CODEGEN_J94W3X_KernAgg_B0 part 2. Populate
...
FROM ##TMP_20180508190810_CODEGEN_KE1Z8I_ADS_sca_2_OUT AS [ADS_sca_2_OUT]), 
...
(SELECT [kernel_dp_CLASS_0_CLASS_2].[KEY] AS [KEY], 'CLASS_0' AS [OVO_Class1], 'CLASS_2' AS [OVO_Class2], CASE WHEN (-[kernel_dp_CLASS_0_CLASS_2].dot_product >= 0.0) THEN 1 ELSE 0 END AS [OVO_Decision], coalesce(-[kernel_dp_CLASS_0_CLASS_2].dot_product, 1.0 / (1.0 + exp(CASE WHEN (CASE WHEN (-100.0 <= -(-((-[kernel_dp_CLASS_0_CLASS_2].dot_product) * -2.7238926850486616 + -0.1748438235716925))) THEN -(-((-[kernel_dp_CLASS_0_CLASS_2].dot_product) * -2.7238926850486616 + -0.1748438235716925)) ELSE -100.0 END <= 100.0) THEN CASE WHEN (-100.0 <= -(-((-[kernel_dp_CLASS_0_CLASS_2].dot_product) * -2.7238926850486616 + -0.1748438235716925))) THEN -(-((-[kernel_dp_CLASS_0_CLASS_2].dot_product) * -2.7238926850486616 + -0.1748438235716925)) ELSE -100.0 END ELSE 100.0 END))) AS [OVO_Confidence] 
...
(SELECT [kernel_dp_CLASS_1_CLASS_2].[KEY] AS [KEY], 'CLASS_1' AS [OVO_Class1], 'CLASS_2' AS [OVO_Class2], CASE WHEN (-[kernel_dp_CLASS_1_CLASS_2].dot_product >= 0.0) THEN 1 ELSE 0 END AS [OVO_Decision], coalesce(-[kernel_dp_CLASS_1_CLASS_2].dot_product, 1.0 / (1.0 + exp(CASE WHEN (CASE WHEN (-100.0 <= -(-((-[kernel_dp_CLASS_1_CLASS_2].dot_product) * -2.569200860775209 + 0.022984996166028157))) THEN -(-((-[kernel_dp_CLASS_1_CLASS_2].dot_product) * -2.569200860775209 + 0.022984996166028157)) ELSE -100.0 END <= 100.0) THEN CASE WHEN (-100.0 <= -(-((-[kernel_dp_CLASS_1_CLASS_2].dot_product) * -2.569200860775209 + 0.022984996166028157))) THEN -(-((-[kernel_dp_CLASS_1_CLASS_2].dot_product) * -2.569200860775209 + 0.022984996166028157)) ELSE -100.0 END ELSE 100.0 END))) AS [OVO_Confidence] 
FROM [kernel_dp_CLASS_1_CLASS_2])
 INSERT INTO ##TMP_20180508190810_CODEGEN_J94W3X_KernAgg_B0 ([KEY], [OVO_Class1], [OVO_Class2], [OVO_Decision], [OVO_Confidence]) SELECT [KernAgg_B0].[KEY], [KernAgg_B0].[OVO_Class1], [KernAgg_B0].[OVO_Class2], [KernAgg_B0].[OVO_Decision], [KernAgg_B0].[OVO_Confidence] 
...
-- Code For temporary table ##TMP_20180508190810_CODEGEN_ORR1F7_KernAgg_Union part 1. Create 


CREATE TABLE ##TMP_20180508190810_CODEGEN_ORR1F7_KernAgg_Union (
	[KEY] BIGINT NULL, 
	[OVO_Class1] VARCHAR(max) COLLATE utf8 NULL, 
	[OVO_Class2] VARCHAR(max) COLLATE utf8 NULL, 
	[OVO_Decision] BIGINT NULL, 
...
-- Code For temporary table ##TMP_20180508190810_CODEGEN_ORR1F7_KernAgg_Union part 2. Populate

INSERT INTO ##TMP_20180508190810_CODEGEN_ORR1F7_KernAgg_Union ([KEY], [OVO_Class1], [OVO_Class2], [OVO_Decision], [OVO_Confidence]) SELECT [KernAgg_Union].[KEY], [KernAgg_Union].[OVO_Class1], [KernAgg_Union].[OVO_Class2], [KernAgg_Union].[OVO_Decision], [KernAgg_Union].[OVO_Confidence] 
...
FROM ##TMP_20180508190810_CODEGEN_J94W3X_KernAgg_B0 AS [KernAgg_B0]) AS [KernAgg_EnsembleUnion]) AS [KernAgg_Union]

-- Code For temporary table ##TMP_20180508190810_CODEGEN_ZFQTQA_KernAgg part 1. Create 


CREATE TABLE ##TMP_20180508190810_CODEGEN_ZFQTQA_KernAgg (
	[KEY] BIGINT NULL, 
...
-- Code For temporary table ##TMP_20180508190810_CODEGEN_ZFQTQA_KernAgg part 2. Populate
...
FROM ##TMP_20180508190810_CODEGEN_ORR1F7_KernAgg_Union AS [KernAgg_Union] GROUP BY [KernAgg_Union].[KEY]) AS [Votes_Sel]), 
[OVO_SumConf_CTE] AS 
...
FROM ##TMP_20180508190810_CODEGEN_ZFQTQA_KernAgg AS [KernAgg]), 
