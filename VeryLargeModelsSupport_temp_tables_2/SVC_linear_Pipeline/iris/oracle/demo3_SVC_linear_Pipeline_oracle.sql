...
-- Code For temporary table DEGEN_8T8IRG_ADS_IMP_1_OUT part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "DEGEN_8T8IRG_ADS_IMP_1_OUT" (
	"KEY" NUMBER(19), 
...
-- Code For temporary table DEGEN_8T8IRG_ADS_IMP_1_OUT part 2. Populate

INSERT INTO "DEGEN_8T8IRG_ADS_IMP_1_OUT" ("KEY", imputer_output_2, imputer_output_3, imputer_output_4, imputer_output_5) SELECT "U"."KEY", "U".imputer_output_2, "U".imputer_output_3, "U".imputer_output_4, "U".imputer_output_5 
...
-- Code For temporary table DEGEN_0OLRMC_ADS_SCA_2_OUT part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "DEGEN_0OLRMC_ADS_SCA_2_OUT" (
	"KEY" NUMBER(19), 
...
-- Code For temporary table DEGEN_0OLRMC_ADS_SCA_2_OUT part 2. Populate

INSERT INTO "DEGEN_0OLRMC_ADS_SCA_2_OUT" ("KEY", scaler_output_2, scaler_output_3, scaler_output_4, scaler_output_5) SELECT "U"."KEY", "U".scaler_output_2, "U".scaler_output_3, "U".scaler_output_4, "U".scaler_output_5 
...
FROM "DEGEN_8T8IRG_ADS_IMP_1_OUT" "ADS_imp_1_OUT") "ADS_sca_2_OUT") "U"

-- Code For temporary table _CODEGEN_QK499H_KERNAGG_B0 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "_CODEGEN_QK499H_KERNAGG_B0" (
	"KEY" NUMBER(19), 
...
-- Code For temporary table _CODEGEN_QK499H_KERNAGG_B0 part 2. Populate

INSERT INTO "_CODEGEN_QK499H_KERNAGG_B0" ("KEY", "OVO_Class1", "OVO_Class2", "OVO_Decision", "OVO_Confidence") SELECT "U"."KEY", "U"."OVO_Class1", "U"."OVO_Class2", "U"."OVO_Decision", "U"."OVO_Confidence" 
...
FROM "DEGEN_0OLRMC_ADS_SCA_2_OUT" "ADS_sca_2_OUT"), 
"SV_data_0_1" AS 
...
-- Code For temporary table DEGEN_4E7JXQ_KERNAGG_UNION part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "DEGEN_4E7JXQ_KERNAGG_UNION" (
	"KEY" NUMBER(19), 
	"OVO_Class1" NUMBER(19), 
	"OVO_Class2" NUMBER(19), 
	"OVO_Decision" NUMBER(19), 
...
-- Code For temporary table DEGEN_4E7JXQ_KERNAGG_UNION part 2. Populate

INSERT INTO "DEGEN_4E7JXQ_KERNAGG_UNION" ("KEY", "OVO_Class1", "OVO_Class2", "OVO_Decision", "OVO_Confidence") SELECT "U"."KEY", "U"."OVO_Class1", "U"."OVO_Class2", "U"."OVO_Decision", "U"."OVO_Confidence" 
...
FROM "_CODEGEN_QK499H_KERNAGG_B0" "KernAgg_B0") "KernAgg_EnsembleUnion") "KernAgg_Union") "U"

-- Code For temporary table 840_CODEGEN_Q1Q899_KERNAGG part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "840_CODEGEN_Q1Q899_KERNAGG" (
	"KEY" NUMBER(19), 
...
-- Code For temporary table 840_CODEGEN_Q1Q899_KERNAGG part 2. Populate

INSERT INTO "840_CODEGEN_Q1Q899_KERNAGG" ("KEY", "OVO_Vote_0", "OVO_SumConfidence_0", "OVO_Vote_1", "OVO_SumConfidence_1", "OVO_Vote_2", "OVO_SumConfidence_2", max_abs_confidence, "OVO_Scale", "Score_0", "Score_1", "Score_2") SELECT "U"."KEY", "U"."OVO_Vote_0", "U"."OVO_SumConfidence_0", "U"."OVO_Vote_1", "U"."OVO_SumConfidence_1", "U"."OVO_Vote_2", "U"."OVO_SumConfidence_2", "U".max_abs_confidence, "U"."OVO_Scale", "U"."Score_0", "U"."Score_1", "U"."Score_2" 
...
FROM "DEGEN_4E7JXQ_KERNAGG_UNION" "KernAgg_Union" GROUP BY "KernAgg_Union"."KEY") "Votes_Sel"), 
"OVO_SumConf_CTE" AS 
...
FROM "840_CODEGEN_Q1Q899_KERNAGG" "KernAgg"), 
