...
-- Code For temporary table DEGEN_2YHJ3P_ADS_IMP_1_OUT part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "DEGEN_2YHJ3P_ADS_IMP_1_OUT" (
	"KEY" NUMBER(19), 
...
-- Code For temporary table DEGEN_2YHJ3P_ADS_IMP_1_OUT part 2. Populate

INSERT INTO "DEGEN_2YHJ3P_ADS_IMP_1_OUT" ("KEY", imputer_output_2, imputer_output_3, imputer_output_4, imputer_output_5) SELECT "U"."KEY", "U".imputer_output_2, "U".imputer_output_3, "U".imputer_output_4, "U".imputer_output_5 
...
-- Code For temporary table DEGEN_P3WWUJ_ADS_SCA_2_OUT part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "DEGEN_P3WWUJ_ADS_SCA_2_OUT" (
	"KEY" NUMBER(19), 
...
-- Code For temporary table DEGEN_P3WWUJ_ADS_SCA_2_OUT part 2. Populate

INSERT INTO "DEGEN_P3WWUJ_ADS_SCA_2_OUT" ("KEY", scaler_output_2, scaler_output_3, scaler_output_4, scaler_output_5) SELECT "U"."KEY", "U".scaler_output_2, "U".scaler_output_3, "U".scaler_output_4, "U".scaler_output_5 
...
FROM "DEGEN_2YHJ3P_ADS_IMP_1_OUT" "ADS_imp_1_OUT") "ADS_sca_2_OUT") "U"

-- Code For temporary table 5039_CODEGEN_AHWAS8_XGB_B0 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "5039_CODEGEN_AHWAS8_XGB_B0" (
	"KEY" NUMBER(19), 
...
-- Code For temporary table 5039_CODEGEN_AHWAS8_XGB_B0 part 2. Populate

INSERT INTO "5039_CODEGEN_AHWAS8_XGB_B0" ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
FROM "DEGEN_P3WWUJ_ADS_SCA_2_OUT" "ADS_sca_2_OUT"), 
"DT_node_data" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Estimator" AS BINARY_DOUBLE) AS "Estimator" 
FROM (SELECT 3 AS nid, 5.259021282196045 AS "Estimator" FROM DUAL UNION ALL SELECT 5 AS nid, 26.5679988861084 AS "Estimator" FROM DUAL UNION ALL SELECT 7 AS nid, 15.483972549438477 AS "Estimator" FROM DUAL UNION ALL SELECT 8 AS nid, 38.08768844604492 AS "Estimator" FROM DUAL UNION ALL SELECT 9 AS nid, 61.972469329833984 AS "Estimator" FROM DUAL UNION ALL SELECT 10 AS nid, 93.55223846435547 AS "Estimator" FROM DUAL) "Values"), 
"DT_Output" AS 
...
"DT_node_data_1" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Estimator" AS BINARY_DOUBLE) AS "Estimator" 
FROM (SELECT 3 AS nid, 4.780928611755371 AS "Estimator" FROM DUAL UNION ALL SELECT 4 AS nid, 20.260730743408203 AS "Estimator" FROM DUAL UNION ALL SELECT 5 AS nid, 22.574623107910156 AS "Estimator" FROM DUAL UNION ALL SELECT 7 AS nid, 58.41529083251953 AS "Estimator" FROM DUAL UNION ALL SELECT 8 AS nid, 84.34954071044922 AS "Estimator" FROM DUAL) "Values"), 
"DT_Output_1" AS 
...
"DT_node_data_2" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Estimator" AS BINARY_DOUBLE) AS "Estimator" 
FROM (SELECT 3 AS nid, 8.467768669128418 AS "Estimator" FROM DUAL UNION ALL SELECT 4 AS nid, 26.712514877319336 AS "Estimator" FROM DUAL UNION ALL SELECT 5 AS nid, 23.58084487915039 AS "Estimator" FROM DUAL UNION ALL SELECT 7 AS nid, 57.88615036010742 AS "Estimator" FROM DUAL UNION ALL SELECT 8 AS nid, 84.63152313232422 AS "Estimator" FROM DUAL) "Values"), 
"DT_Output_2" AS 
...
"DT_node_data_3" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Estimator" AS BINARY_DOUBLE) AS "Estimator" 
FROM (SELECT 3 AS nid, 3.5765016078948975 AS "Estimator" FROM DUAL UNION ALL SELECT 4 AS nid, 16.533885955810547 AS "Estimator" FROM DUAL UNION ALL SELECT 5 AS nid, 13.682024002075195 AS "Estimator" FROM DUAL UNION ALL SELECT 7 AS nid, 41.46207809448242 AS "Estimator" FROM DUAL UNION ALL SELECT 8 AS nid, 67.26363372802734 AS "Estimator" FROM DUAL) "Values"), 
"DT_Output_3" AS 
...
"DT_node_data_4" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Estimator" AS BINARY_DOUBLE) AS "Estimator" 
FROM (SELECT 3 AS nid, 6.826356410980225 AS "Estimator" FROM DUAL UNION ALL SELECT 4 AS nid, 21.607534408569336 AS "Estimator" FROM DUAL UNION ALL SELECT 5 AS nid, 22.628299713134766 AS "Estimator" FROM DUAL UNION ALL SELECT 7 AS nid, 49.021934509277344 AS "Estimator" FROM DUAL UNION ALL SELECT 8 AS nid, 73.65652465820312 AS "Estimator" FROM DUAL) "Values"), 
"DT_Output_4" AS 
...
"DT_node_data_5" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Estimator" AS BINARY_DOUBLE) AS "Estimator" 
FROM (SELECT 3 AS nid, 5.80258321762085 AS "Estimator" FROM DUAL UNION ALL SELECT 4 AS nid, 19.919614791870117 AS "Estimator" FROM DUAL UNION ALL SELECT 5 AS nid, 10.882296562194824 AS "Estimator" FROM DUAL UNION ALL SELECT 7 AS nid, 40.92027282714844 AS "Estimator" FROM DUAL UNION ALL SELECT 8 AS nid, 65.1378402709961 AS "Estimator" FROM DUAL) "Values"), 
"DT_Output_5" AS 
...
"DT_node_data_6" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Estimator" AS BINARY_DOUBLE) AS "Estimator" 
FROM (SELECT 3 AS nid, 1.5899327993392944 AS "Estimator" FROM DUAL UNION ALL SELECT 4 AS nid, 12.174163818359375 AS "Estimator" FROM DUAL UNION ALL SELECT 5 AS nid, 9.440058708190918 AS "Estimator" FROM DUAL UNION ALL SELECT 7 AS nid, 36.46533203125 AS "Estimator" FROM DUAL UNION ALL SELECT 8 AS nid, 57.04753494262695 AS "Estimator" FROM DUAL) "Values"), 
"DT_Output_6" AS 
...
"DT_node_data_7" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Estimator" AS BINARY_DOUBLE) AS "Estimator" 
FROM (SELECT 5 AS nid, 20.551504135131836 AS "Estimator" FROM DUAL UNION ALL SELECT 6 AS nid, 53.802059173583984 AS "Estimator" FROM DUAL UNION ALL SELECT 7 AS nid, 1.445393443107605 AS "Estimator" FROM DUAL UNION ALL SELECT 8 AS nid, 11.024381637573242 AS "Estimator" FROM DUAL UNION ALL SELECT 9 AS nid, 11.313101768493652 AS "Estimator" FROM DUAL UNION ALL SELECT 10 AS nid, 32.20111846923828 AS "Estimator" FROM DUAL) "Values"), 
"DT_Output_7" AS 
...
"DT_node_data_8" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Estimator" AS BINARY_DOUBLE) AS "Estimator" 
FROM (SELECT 2 AS nid, 43.654998779296875 AS "Estimator" FROM DUAL UNION ALL SELECT 5 AS nid, 1.0012569427490234 AS "Estimator" FROM DUAL UNION ALL SELECT 6 AS nid, 9.976913452148438 AS "Estimator" FROM DUAL UNION ALL SELECT 7 AS nid, 6.890918731689453 AS "Estimator" FROM DUAL UNION ALL SELECT 8 AS nid, 29.832544326782227 AS "Estimator" FROM DUAL) "Values"), 
"DT_Output_8" AS 
...
"DT_node_data_9" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Estimator" AS BINARY_DOUBLE) AS "Estimator" 
FROM (SELECT 3 AS nid, -0.025147248059511185 AS "Estimator" FROM DUAL UNION ALL SELECT 7 AS nid, 3.8255436420440674 AS "Estimator" FROM DUAL UNION ALL SELECT 8 AS nid, 15.561128616333008 AS "Estimator" FROM DUAL UNION ALL SELECT 9 AS nid, 4.447967052459717 AS "Estimator" FROM DUAL UNION ALL SELECT 10 AS nid, 22.06629753112793 AS "Estimator" FROM DUAL UNION ALL SELECT 11 AS nid, 29.23740005493164 AS "Estimator" FROM DUAL UNION ALL SELECT 12 AS nid, 48.71183395385742 AS "Estimator" FROM DUAL) "Values"), 
"DT_Output_9" AS 
...
-- Code For temporary table 5039_CODEGEN_ZBE24C_XGB_B1 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "5039_CODEGEN_ZBE24C_XGB_B1" (
	"KEY" NUMBER(19), 
	"Estimator" BINARY_DOUBLE
)
...
-- Code For temporary table 5039_CODEGEN_ZBE24C_XGB_B1 part 2. Populate

INSERT INTO "5039_CODEGEN_ZBE24C_XGB_B1" ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
FROM (WITH "DT_node_lookup_10" AS 
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", CASE WHEN ("ADS_sca_2_OUT".scaler_output_4 < 0.8996042013168335) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_output_3 < -0.349178671836853) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_output_3 < -1.0177714824676514) THEN 5 ELSE 6 END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_output_4 < -0.8362234830856323) THEN 7 ELSE 8 END END ELSE 2 END AS node_id_2 
FROM "DEGEN_P3WWUJ_ADS_SCA_2_OUT" "ADS_sca_2_OUT"), 
"DT_node_data_10" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Estimator" AS BINARY_DOUBLE) AS "Estimator" 
FROM (SELECT 2 AS nid, 36.406124114990234 AS "Estimator" FROM DUAL UNION ALL SELECT 5 AS nid, 0.7167732119560242 AS "Estimator" FROM DUAL UNION ALL SELECT 6 AS nid, 8.222705841064453 AS "Estimator" FROM DUAL UNION ALL SELECT 7 AS nid, 5.59077787399292 AS "Estimator" FROM DUAL UNION ALL SELECT 8 AS nid, 24.24737548828125 AS "Estimator" FROM DUAL) "Values"), 
"DT_Output_10" AS 
...
"DT_node_data_11" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Estimator" AS BINARY_DOUBLE) AS "Estimator" 
FROM (SELECT 4 AS nid, 17.29083251953125 AS "Estimator" FROM DUAL UNION ALL SELECT 5 AS nid, 13.511589050292969 AS "Estimator" FROM DUAL UNION ALL SELECT 6 AS nid, 38.966041564941406 AS "Estimator" FROM DUAL UNION ALL SELECT 7 AS nid, 2.6149513721466064 AS "Estimator" FROM DUAL UNION ALL SELECT 8 AS nid, 9.837066650390625 AS "Estimator" FROM DUAL) "Values"), 
"DT_Output_11" AS 
...
"DT_node_data_12" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Estimator" AS BINARY_DOUBLE) AS "Estimator" 
FROM (SELECT 3 AS nid, -1.1777454614639282 AS "Estimator" FROM DUAL UNION ALL SELECT 5 AS nid, 5.64267110824585 AS "Estimator" FROM DUAL UNION ALL SELECT 7 AS nid, 2.7211594581604004 AS "Estimator" FROM DUAL UNION ALL SELECT 8 AS nid, 11.557232856750488 AS "Estimator" FROM DUAL UNION ALL SELECT 9 AS nid, 21.083812713623047 AS "Estimator" FROM DUAL UNION ALL SELECT 10 AS nid, 39.55588912963867 AS "Estimator" FROM DUAL) "Values"), 
"DT_Output_12" AS 
...
"DT_node_data_13" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Estimator" AS BINARY_DOUBLE) AS "Estimator" 
FROM (SELECT 4 AS nid, 12.52935791015625 AS "Estimator" FROM DUAL UNION ALL SELECT 6 AS nid, 34.3646125793457 AS "Estimator" FROM DUAL UNION ALL SELECT 7 AS nid, 1.0546163320541382 AS "Estimator" FROM DUAL UNION ALL SELECT 8 AS nid, 4.928728103637695 AS "Estimator" FROM DUAL UNION ALL SELECT 9 AS nid, 5.411577224731445 AS "Estimator" FROM DUAL UNION ALL SELECT 10 AS nid, 18.062278747558594 AS "Estimator" FROM DUAL) "Values"), 
"DT_Output_13" AS 
...
"DT_node_data_14" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Estimator" AS BINARY_DOUBLE) AS "Estimator" 
FROM (SELECT 2 AS nid, 25.514925003051758 AS "Estimator" FROM DUAL UNION ALL SELECT 4 AS nid, 20.060646057128906 AS "Estimator" FROM DUAL UNION ALL SELECT 5 AS nid, -0.022940369322896004 AS "Estimator" FROM DUAL UNION ALL SELECT 6 AS nid, 8.464066505432129 AS "Estimator" FROM DUAL) "Values"), 
"DT_Output_14" AS 
...
"DT_node_data_15" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Estimator" AS BINARY_DOUBLE) AS "Estimator" 
FROM (SELECT 3 AS nid, -2.2534339427948 AS "Estimator" FROM DUAL UNION ALL SELECT 4 AS nid, 4.601406097412109 AS "Estimator" FROM DUAL UNION ALL SELECT 6 AS nid, 30.499692916870117 AS "Estimator" FROM DUAL UNION ALL SELECT 7 AS nid, 0.7789820432662964 AS "Estimator" FROM DUAL UNION ALL SELECT 8 AS nid, 14.180508613586426 AS "Estimator" FROM DUAL) "Values"), 
"DT_Output_15" AS 
...
-- Code For temporary table 9_CODEGEN_896L4C_XGB_UNION part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "9_CODEGEN_896L4C_XGB_UNION" (
	"KEY" NUMBER(19), 
	"Estimator" BINARY_DOUBLE
)
...
-- Code For temporary table 9_CODEGEN_896L4C_XGB_UNION part 2. Populate

INSERT INTO "9_CODEGEN_896L4C_XGB_UNION" ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
FROM "5039_CODEGEN_AHWAS8_XGB_B0" "XGB_B0" UNION ALL SELECT "XGB_B1"."KEY" AS "KEY", "XGB_B1"."Estimator" AS "Estimator" 
FROM "5039_CODEGEN_ZBE24C_XGB_B1" "XGB_B1") "XGB_EnsembleUnion") "XGB_Union") "U"

-- Code For temporary table 039_CODEGEN_CXBZV0_XGB_SUM part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "039_CODEGEN_CXBZV0_XGB_SUM" (
	"KEY" NUMBER(19), 
	"Estimator" BINARY_DOUBLE
)
...
-- Code For temporary table 039_CODEGEN_CXBZV0_XGB_SUM part 2. Populate

INSERT INTO "039_CODEGEN_CXBZV0_XGB_SUM" ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
FROM "9_CODEGEN_896L4C_XGB_UNION" "XGB_Union" GROUP BY "XGB_Union"."KEY") "T") "XGB_sum") "U"

-- Model deployment code

SELECT "XGB_sum"."KEY" AS "KEY", "XGB_sum"."Estimator" + 0.5 AS "Estimator" 
FROM "039_CODEGEN_CXBZV0_XGB_SUM" "XGB_sum"