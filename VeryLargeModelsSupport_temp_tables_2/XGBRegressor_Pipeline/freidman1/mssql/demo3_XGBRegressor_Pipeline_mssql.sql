...
-- Code For temporary table ##TMP_20180508184700_CODEGEN_9W1D0D_ADS_imp_1_OUT part 1. Create 


CREATE TABLE ##TMP_20180508184700_CODEGEN_9W1D0D_ADS_imp_1_OUT (
	[KEY] BIGINT NULL, 
...
-- Code For temporary table ##TMP_20180508184700_CODEGEN_9W1D0D_ADS_imp_1_OUT part 2. Populate

INSERT INTO ##TMP_20180508184700_CODEGEN_9W1D0D_ADS_imp_1_OUT ([KEY], impter_2, impter_3, impter_4, impter_5, impter_6, impter_7, impter_8, impter_9, impter_10, impter_11) SELECT [ADS_imp_1_OUT].[KEY], [ADS_imp_1_OUT].impter_2, [ADS_imp_1_OUT].impter_3, [ADS_imp_1_OUT].impter_4, [ADS_imp_1_OUT].impter_5, [ADS_imp_1_OUT].impter_6, [ADS_imp_1_OUT].impter_7, [ADS_imp_1_OUT].impter_8, [ADS_imp_1_OUT].impter_9, [ADS_imp_1_OUT].impter_10, [ADS_imp_1_OUT].impter_11 
...
-- Code For temporary table ##TMP_20180508184700_CODEGEN_HL07Q6_ADS_sca_2_OUT part 1. Create 


CREATE TABLE ##TMP_20180508184700_CODEGEN_HL07Q6_ADS_sca_2_OUT (
	[KEY] BIGINT NULL, 
	scaler_2 FLOAT NULL, 
	scaler_3 FLOAT NULL, 
	scaler_4 FLOAT NULL, 
...
-- Code For temporary table ##TMP_20180508184700_CODEGEN_HL07Q6_ADS_sca_2_OUT part 2. Populate

INSERT INTO ##TMP_20180508184700_CODEGEN_HL07Q6_ADS_sca_2_OUT ([KEY], scaler_2, scaler_3, scaler_4, scaler_5, scaler_6, scaler_7, scaler_8, scaler_9, scaler_10, scaler_11) SELECT [ADS_sca_2_OUT].[KEY], [ADS_sca_2_OUT].scaler_2, [ADS_sca_2_OUT].scaler_3, [ADS_sca_2_OUT].scaler_4, [ADS_sca_2_OUT].scaler_5, [ADS_sca_2_OUT].scaler_6, [ADS_sca_2_OUT].scaler_7, [ADS_sca_2_OUT].scaler_8, [ADS_sca_2_OUT].scaler_9, [ADS_sca_2_OUT].scaler_10, [ADS_sca_2_OUT].scaler_11 
...
FROM ##TMP_20180508184700_CODEGEN_9W1D0D_ADS_imp_1_OUT AS [ADS_imp_1_OUT]) AS [ADS_sca_2_OUT]

-- Code For temporary table ##TMP_20180508184700_CODEGEN_QLZP85_XGB_B0 part 1. Create 


CREATE TABLE ##TMP_20180508184700_CODEGEN_QLZP85_XGB_B0 (
	[KEY] BIGINT NULL, 
...
-- Code For temporary table ##TMP_20180508184700_CODEGEN_QLZP85_XGB_B0 part 2. Populate
...
FROM ##TMP_20180508184700_CODEGEN_HL07Q6_ADS_sca_2_OUT AS [ADS_sca_2_OUT]), 
[DT_node_data] AS 
...
FROM [DT_Output_9])
 INSERT INTO ##TMP_20180508184700_CODEGEN_QLZP85_XGB_B0 ([KEY], [Estimator]) SELECT [XGB_B0].[KEY], [XGB_B0].[Estimator] 
...
-- Code For temporary table ##TMP_20180508184700_CODEGEN_GOQ257_XGB_B1 part 1. Create 


CREATE TABLE ##TMP_20180508184700_CODEGEN_GOQ257_XGB_B1 (
	[KEY] BIGINT NULL, 
	[Estimator] FLOAT(53) NULL
)
...
-- Code For temporary table ##TMP_20180508184700_CODEGEN_GOQ257_XGB_B1 part 2. Populate
...
FROM [DT_Output_15])
 INSERT INTO ##TMP_20180508184700_CODEGEN_GOQ257_XGB_B1 ([KEY], [Estimator]) SELECT [XGB_B1].[KEY], [XGB_B1].[Estimator] 
...
-- Code For temporary table ##TMP_20180508184700_CODEGEN_5BO99I_XGB_Union part 1. Create 


CREATE TABLE ##TMP_20180508184700_CODEGEN_5BO99I_XGB_Union (
	[KEY] BIGINT NULL, 
	[Estimator] FLOAT(53) NULL
)
...
-- Code For temporary table ##TMP_20180508184700_CODEGEN_5BO99I_XGB_Union part 2. Populate

INSERT INTO ##TMP_20180508184700_CODEGEN_5BO99I_XGB_Union ([KEY], [Estimator]) SELECT [XGB_Union].[KEY], [XGB_Union].[Estimator] 
...
FROM ##TMP_20180508184700_CODEGEN_QLZP85_XGB_B0 AS [XGB_B0] UNION ALL SELECT [XGB_B1].[KEY] AS [KEY], [XGB_B1].[Estimator] AS [Estimator] 
FROM ##TMP_20180508184700_CODEGEN_GOQ257_XGB_B1 AS [XGB_B1]) AS [XGB_EnsembleUnion]) AS [XGB_Union]

-- Code For temporary table ##TMP_20180508184700_CODEGEN_613ESZ_XGB_sum part 1. Create 


CREATE TABLE ##TMP_20180508184700_CODEGEN_613ESZ_XGB_sum (
	[KEY] BIGINT NULL, 
	[Estimator] FLOAT(53) NULL
)
...
-- Code For temporary table ##TMP_20180508184700_CODEGEN_613ESZ_XGB_sum part 2. Populate

INSERT INTO ##TMP_20180508184700_CODEGEN_613ESZ_XGB_sum ([KEY], [Estimator]) SELECT [XGB_sum].[KEY], [XGB_sum].[Estimator] 
...
FROM ##TMP_20180508184700_CODEGEN_5BO99I_XGB_Union AS [XGB_Union] GROUP BY [XGB_Union].[KEY]) AS [T]) AS [XGB_sum]

-- Model deployment code

SELECT [XGB_sum].[KEY] AS [KEY], [XGB_sum].[Estimator] + 0.5 AS [Estimator] 
FROM ##TMP_20180508184700_CODEGEN_613ESZ_XGB_sum AS [XGB_sum]