...
-- Code For temporary table TMP_20180508184701_CODEGEN_QZEC part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508184701_CODEGEN_QZEC" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20180508184701_CODEGEN_QZEC part 2. Populate

INSERT INTO "TMP_20180508184701_CODEGEN_QZEC" ("KEY", impter_2, impter_3, impter_4, impter_5, impter_6, impter_7, impter_8, impter_9, impter_10, impter_11) SELECT "U"."KEY", "U".impter_2, "U".impter_3, "U".impter_4, "U".impter_5, "U".impter_6, "U".impter_7, "U".impter_8, "U".impter_9, "U".impter_10, "U".impter_11 
...
-- Code For temporary table TMP_20180508184701_CODEGEN_QZEC part 3. Create Index 

CREATE INDEX "ix_TMP_20180508184701_C_2da4" ON "TMP_20180508184701_CODEGEN_QZEC" ("KEY")

-- Code For temporary table TMP_20180508184701_CODEGEN_ZKJQ part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508184701_CODEGEN_ZKJQ" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20180508184701_CODEGEN_ZKJQ part 2. Populate

INSERT INTO "TMP_20180508184701_CODEGEN_ZKJQ" ("KEY", scaler_2, scaler_3, scaler_4, scaler_5, scaler_6, scaler_7, scaler_8, scaler_9, scaler_10, scaler_11) SELECT "U"."KEY", "U".scaler_2, "U".scaler_3, "U".scaler_4, "U".scaler_5, "U".scaler_6, "U".scaler_7, "U".scaler_8, "U".scaler_9, "U".scaler_10, "U".scaler_11 
...
FROM "TMP_20180508184701_CODEGEN_QZEC" AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT") AS "U"

-- Code For temporary table TMP_20180508184701_CODEGEN_ZKJQ part 3. Create Index 

CREATE INDEX "ix_TMP_20180508184701_C_f7c0" ON "TMP_20180508184701_CODEGEN_ZKJQ" ("KEY")

-- Code For temporary table TMP_20180508184701_CODEGEN_2R9F part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508184701_CODEGEN_2R9F" (
	"KEY" BIGINT, 
...
-- Code For temporary table TMP_20180508184701_CODEGEN_2R9F part 2. Populate

INSERT INTO "TMP_20180508184701_CODEGEN_2R9F" ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
FROM "TMP_20180508184701_CODEGEN_ZKJQ" AS "ADS_sca_2_OUT"), 
"DT_node_data" AS 
...
-- Code For temporary table TMP_20180508184701_CODEGEN_Q47Y part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508184701_CODEGEN_Q47Y" (
	"KEY" BIGINT, 
	"Estimator" DOUBLE PRECISION
)
...
-- Code For temporary table TMP_20180508184701_CODEGEN_Q47Y part 2. Populate

INSERT INTO "TMP_20180508184701_CODEGEN_Q47Y" ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
-- Code For temporary table TMP_20180508184701_CODEGEN_BHNQ part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508184701_CODEGEN_BHNQ" (
	"KEY" BIGINT, 
	"Estimator" DOUBLE PRECISION
)
...
-- Code For temporary table TMP_20180508184701_CODEGEN_BHNQ part 2. Populate

INSERT INTO "TMP_20180508184701_CODEGEN_BHNQ" ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
FROM "TMP_20180508184701_CODEGEN_2R9F" AS "XGB_B0" UNION ALL SELECT "XGB_B1"."KEY" AS "KEY", "XGB_B1"."Estimator" AS "Estimator" 
FROM "TMP_20180508184701_CODEGEN_Q47Y" AS "XGB_B1") AS "XGB_EnsembleUnion") AS "XGB_Union") AS "U"

-- Code For temporary table TMP_20180508184701_CODEGEN_RVKD part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508184701_CODEGEN_RVKD" (
	"KEY" BIGINT NOT NULL, 
	"Estimator" DOUBLE PRECISION, 
	PRIMARY KEY ("KEY")
)
...
-- Code For temporary table TMP_20180508184701_CODEGEN_RVKD part 2. Populate

INSERT INTO "TMP_20180508184701_CODEGEN_RVKD" ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
FROM "TMP_20180508184701_CODEGEN_BHNQ" AS "XGB_Union" GROUP BY "XGB_Union"."KEY") AS "T") AS "XGB_sum") AS "U"

-- Code For temporary table TMP_20180508184701_CODEGEN_RVKD part 3. Create Index 

CREATE INDEX "ix_TMP_20180508184701_C_8e92" ON "TMP_20180508184701_CODEGEN_RVKD" ("KEY")

-- Model deployment code

SELECT "XGB_sum"."KEY" AS "KEY", "XGB_sum"."Estimator" + 0.5 AS "Estimator" 
FROM "TMP_20180508184701_CODEGEN_RVKD" AS "XGB_sum"