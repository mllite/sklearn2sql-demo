...
-- Code For temporary table tmp_20180508182843_codegen_fjkt0e_ads_imp_1_out part 1. Create 


CREATE TEMPORARY TABLE tmp_20180508182843_codegen_fjkt0e_ads_imp_1_out (
	"KEY" BIGINT, 
	impter_2 DOUBLE, 
	impter_3 DOUBLE, 
	impter_4 DOUBLE, 
...
-- Code For temporary table tmp_20180508182843_codegen_agy6l3_ads_sca_2_out part 1. Create 


CREATE TEMPORARY TABLE tmp_20180508182843_codegen_agy6l3_ads_sca_2_out (
	"KEY" BIGINT, 
	scaler_2 DOUBLE, 
	scaler_3 DOUBLE, 
	scaler_4 DOUBLE, 
...
FROM tmp_20180508182843_codegen_fjkt0e_ads_imp_1_out AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT") AS "U"

-- Code For temporary table tmp_20180508182843_codegen_gah11l_xgb_b0 part 1. Create 


CREATE TEMPORARY TABLE tmp_20180508182843_codegen_gah11l_xgb_b0 (
	"KEY" BIGINT, 
	"Estimator" DOUBLE
)
...
-- Code For temporary table tmp_20180508182843_codegen_gah11l_xgb_b0 part 2. Populate

INSERT INTO tmp_20180508182843_codegen_gah11l_xgb_b0 ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
FROM tmp_20180508182843_codegen_agy6l3_ads_sca_2_out AS "ADS_sca_2_OUT"), 
"DT_node_data" AS 
...
-- Code For temporary table tmp_20180508182843_codegen_r6v778_xgb_b1 part 1. Create 


CREATE TEMPORARY TABLE tmp_20180508182843_codegen_r6v778_xgb_b1 (
	"KEY" BIGINT, 
	"Estimator" DOUBLE
)
...
-- Code For temporary table tmp_20180508182843_codegen_r6v778_xgb_b1 part 2. Populate

INSERT INTO tmp_20180508182843_codegen_r6v778_xgb_b1 ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
-- Code For temporary table tmp_20180508182843_codegen_z30drg_xgb_union part 1. Create 


CREATE TEMPORARY TABLE tmp_20180508182843_codegen_z30drg_xgb_union (
	"KEY" BIGINT, 
	"Estimator" DOUBLE
)
...
-- Code For temporary table tmp_20180508182843_codegen_z30drg_xgb_union part 2. Populate

INSERT INTO tmp_20180508182843_codegen_z30drg_xgb_union ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
FROM tmp_20180508182843_codegen_gah11l_xgb_b0 AS "XGB_B0" UNION ALL SELECT "XGB_B1"."KEY" AS "KEY", "XGB_B1"."Estimator" AS "Estimator" 
FROM tmp_20180508182843_codegen_r6v778_xgb_b1 AS "XGB_B1") AS "XGB_EnsembleUnion") AS "XGB_Union") AS "U"

-- Code For temporary table tmp_20180508182843_codegen_sy19rs_xgb_sum part 1. Create 


CREATE TEMPORARY TABLE tmp_20180508182843_codegen_sy19rs_xgb_sum (
	"KEY" BIGINT, 
	"Estimator" DOUBLE
)
...
-- Code For temporary table tmp_20180508182843_codegen_sy19rs_xgb_sum part 2. Populate

INSERT INTO tmp_20180508182843_codegen_sy19rs_xgb_sum ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
FROM tmp_20180508182843_codegen_z30drg_xgb_union AS "XGB_Union" GROUP BY "XGB_Union"."KEY") AS "T") AS "XGB_sum") AS "U"

-- Model deployment code

SELECT "XGB_sum"."KEY" AS "KEY", "XGB_sum"."Estimator" + 0.5 AS "Estimator" 
FROM tmp_20180508182843_codegen_sy19rs_xgb_sum AS "XGB_sum"