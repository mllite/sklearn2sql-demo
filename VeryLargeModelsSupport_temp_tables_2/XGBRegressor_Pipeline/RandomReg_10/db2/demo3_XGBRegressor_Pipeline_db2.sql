...
-- Code For temporary table tmp_20180508182440_codegen_1j6fie_ads_imp_1_out part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180508182440_codegen_1j6fie_ads_imp_1_out (
	"KEY" BIGINT, 
	impter_2 DOUBLE, 
	impter_3 DOUBLE, 
	impter_4 DOUBLE, 
...
-- Code For temporary table tmp_20180508182440_codegen_1j6fie_ads_imp_1_out part 2. Populate

INSERT INTO tmp_20180508182440_codegen_1j6fie_ads_imp_1_out SELECT "ADS_imp_1_OUT"."KEY", "ADS_imp_1_OUT".impter_2, "ADS_imp_1_OUT".impter_3, "ADS_imp_1_OUT".impter_4, "ADS_imp_1_OUT".impter_5, "ADS_imp_1_OUT".impter_6, "ADS_imp_1_OUT".impter_7, "ADS_imp_1_OUT".impter_8, "ADS_imp_1_OUT".impter_9, "ADS_imp_1_OUT".impter_10, "ADS_imp_1_OUT".impter_11 
...
-- Code For temporary table tmp_20180508182440_codegen_txv1qh_ads_sca_2_out part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180508182440_codegen_txv1qh_ads_sca_2_out (
	"KEY" BIGINT, 
	scaler_2 DOUBLE, 
	scaler_3 DOUBLE, 
	scaler_4 DOUBLE, 
...
-- Code For temporary table tmp_20180508182440_codegen_txv1qh_ads_sca_2_out part 2. Populate

INSERT INTO tmp_20180508182440_codegen_txv1qh_ads_sca_2_out SELECT "ADS_sca_2_OUT"."KEY", "ADS_sca_2_OUT".scaler_2, "ADS_sca_2_OUT".scaler_3, "ADS_sca_2_OUT".scaler_4, "ADS_sca_2_OUT".scaler_5, "ADS_sca_2_OUT".scaler_6, "ADS_sca_2_OUT".scaler_7, "ADS_sca_2_OUT".scaler_8, "ADS_sca_2_OUT".scaler_9, "ADS_sca_2_OUT".scaler_10, "ADS_sca_2_OUT".scaler_11 
...
FROM tmp_20180508182440_codegen_1j6fie_ads_imp_1_out AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT"

-- Code For temporary table tmp_20180508182440_codegen_pniyio_xgb_b0 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180508182440_codegen_pniyio_xgb_b0 (
	"KEY" BIGINT, 
	"Estimator" DOUBLE
)
...
-- Code For temporary table tmp_20180508182440_codegen_pniyio_xgb_b0 part 2. Populate

INSERT INTO tmp_20180508182440_codegen_pniyio_xgb_b0 WITH "DT_node_lookup" AS 
...
FROM tmp_20180508182440_codegen_txv1qh_ads_sca_2_out AS "ADS_sca_2_OUT"), 
"DT_node_data" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Estimator" AS DOUBLE) AS "Estimator" 
FROM (SELECT 3 AS nid, -22.155038833618164 AS "Estimator" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 5 AS nid, 0.1371171921491623 AS "Estimator" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 7 AS nid, -8.404426574707031 AS "Estimator" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 8 AS nid, 13.90919017791748 AS "Estimator" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 9 AS nid, 16.5261173248291 AS "Estimator" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 10 AS nid, 26.465993881225586 AS "Estimator" FROM SYSIBM.SYSDUMMY1) AS "Values"), 
"DT_Output" AS 
...
"DT_node_data_1" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Estimator" AS DOUBLE) AS "Estimator" 
FROM (SELECT 4 AS nid, 9.778855323791504 AS "Estimator" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 5 AS nid, 0.12465210258960724 AS "Estimator" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 7 AS nid, -21.083234786987305 AS "Estimator" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 8 AS nid, -5.810722351074219 AS "Estimator" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 9 AS nid, 15.023741722106934 AS "Estimator" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 10 AS nid, 24.059995651245117 AS "Estimator" FROM SYSIBM.SYSDUMMY1) AS "Values"), 
"DT_Output_1" AS 
...
"DT_node_data_2" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Estimator" AS DOUBLE) AS "Estimator" 
FROM (SELECT 2 AS nid, 16.941801071166992 AS "Estimator" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 5 AS nid, -20.199092864990234 AS "Estimator" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 6 AS nid, -3.550792694091797 AS "Estimator" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 7 AS nid, -4.642592906951904 AS "Estimator" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 8 AS nid, 17.064096450805664 AS "Estimator" FROM SYSIBM.SYSDUMMY1) AS "Values"), 
"DT_Output_2" AS 
...
"DT_node_data_3" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Estimator" AS DOUBLE) AS "Estimator" 
FROM (SELECT 3 AS nid, -14.395660400390625 AS "Estimator" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 4 AS nid, -2.301922082901001 AS "Estimator" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 5 AS nid, -8.532238006591797 AS "Estimator" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 7 AS nid, 2.0144879817962646 AS "Estimator" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 8 AS nid, 16.57676124572754 AS "Estimator" FROM SYSIBM.SYSDUMMY1) AS "Values"), 
"DT_Output_3" AS 
...
"DT_node_data_4" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Estimator" AS DOUBLE) AS "Estimator" 
FROM (SELECT 2 AS nid, 14.832307815551758 AS "Estimator" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 5 AS nid, -19.02397918701172 AS "Estimator" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 6 AS nid, -4.534415245056152 AS "Estimator" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 7 AS nid, -3.971592426300049 AS "Estimator" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 8 AS nid, 14.045598030090332 AS "Estimator" FROM SYSIBM.SYSDUMMY1) AS "Values"), 
"DT_Output_4" AS 
...
"DT_node_data_5" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Estimator" AS DOUBLE) AS "Estimator" 
FROM (SELECT 3 AS nid, -11.284990310668945 AS "Estimator" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 4 AS nid, -1.6324472427368164 AS "Estimator" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 5 AS nid, -6.995410442352295 AS "Estimator" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 7 AS nid, 3.276987075805664 AS "Estimator" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 8 AS nid, 17.257299423217773 AS "Estimator" FROM SYSIBM.SYSDUMMY1) AS "Values"), 
"DT_Output_5" AS 
...
"DT_node_data_6" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Estimator" AS DOUBLE) AS "Estimator" 
FROM (SELECT 2 AS nid, 12.925868034362793 AS "Estimator" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 5 AS nid, -15.253242492675781 AS "Estimator" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 6 AS nid, -2.887866973876953 AS "Estimator" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 7 AS nid, -3.274099826812744 AS "Estimator" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 8 AS nid, 11.653290748596191 AS "Estimator" FROM SYSIBM.SYSDUMMY1) AS "Values"), 
"DT_Output_6" AS 
...
"DT_node_data_7" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Estimator" AS DOUBLE) AS "Estimator" 
FROM (SELECT 5 AS nid, -0.29980388283729553 AS "Estimator" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 6 AS nid, 13.997415542602539 AS "Estimator" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 7 AS nid, -14.787727355957031 AS "Estimator" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 8 AS nid, -3.8101868629455566 AS "Estimator" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 9 AS nid, -2.2124812602996826 AS "Estimator" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 10 AS nid, 10.032784461975098 AS "Estimator" FROM SYSIBM.SYSDUMMY1) AS "Values"), 
"DT_Output_7" AS 
...
"DT_node_data_8" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Estimator" AS DOUBLE) AS "Estimator" 
FROM (SELECT 2 AS nid, 15.438780784606934 AS "Estimator" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 5 AS nid, -15.28858470916748 AS "Estimator" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 6 AS nid, -1.8839603662490845 AS "Estimator" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 7 AS nid, 0.824749767780304 AS "Estimator" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 8 AS nid, 13.91795825958252 AS "Estimator" FROM SYSIBM.SYSDUMMY1) AS "Values"), 
"DT_Output_8" AS 
...
"DT_node_data_9" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Estimator" AS DOUBLE) AS "Estimator" 
FROM (SELECT 4 AS nid, 3.2215232849121094 AS "Estimator" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 5 AS nid, -3.3912010192871094 AS "Estimator" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 7 AS nid, -14.086405754089355 AS "Estimator" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 8 AS nid, -5.727645397186279 AS "Estimator" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 9 AS nid, 2.9069461822509766 AS "Estimator" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 10 AS nid, 13.076863288879395 AS "Estimator" FROM SYSIBM.SYSDUMMY1) AS "Values"), 
"DT_Output_9" AS 
...
-- Code For temporary table tmp_20180508182440_codegen_3szhbn_xgb_b1 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180508182440_codegen_3szhbn_xgb_b1 (
	"KEY" BIGINT, 
	"Estimator" DOUBLE
)
...
-- Code For temporary table tmp_20180508182440_codegen_3szhbn_xgb_b1 part 2. Populate

INSERT INTO tmp_20180508182440_codegen_3szhbn_xgb_b1 WITH "DT_node_lookup_10" AS 
...
"DT_node_data_10" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Estimator" AS DOUBLE) AS "Estimator" 
FROM (SELECT 1 AS nid, -8.471076011657715 AS "Estimator" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 5 AS nid, -8.676445007324219 AS "Estimator" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 6 AS nid, -0.826964795589447 AS "Estimator" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 7 AS nid, -0.7917702794075012 AS "Estimator" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 8 AS nid, 10.364592552185059 AS "Estimator" FROM SYSIBM.SYSDUMMY1) AS "Values"), 
"DT_Output_10" AS 
...
"DT_node_data_11" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Estimator" AS DOUBLE) AS "Estimator" 
FROM (SELECT 3 AS nid, -12.34475326538086 AS "Estimator" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 5 AS nid, -2.3250603675842285 AS "Estimator" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 7 AS nid, -4.43468713760376 AS "Estimator" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 8 AS nid, 6.317233562469482 AS "Estimator" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 9 AS nid, 4.707091808319092 AS "Estimator" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 10 AS nid, 14.158080101013184 AS "Estimator" FROM SYSIBM.SYSDUMMY1) AS "Values"), 
"DT_Output_11" AS 
...
"DT_node_data_12" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Estimator" AS DOUBLE) AS "Estimator" 
FROM (SELECT 2 AS nid, 9.931203842163086 AS "Estimator" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 4 AS nid, 7.431036472320557 AS "Estimator" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 5 AS nid, -12.575167655944824 AS "Estimator" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 6 AS nid, -2.1470630168914795 AS "Estimator" FROM SYSIBM.SYSDUMMY1) AS "Values"), 
"DT_Output_12" AS 
...
"DT_node_data_13" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Estimator" AS DOUBLE) AS "Estimator" 
FROM (SELECT 2 AS nid, 11.724964141845703 AS "Estimator" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 5 AS nid, -11.475015640258789 AS "Estimator" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 6 AS nid, -1.759722113609314 AS "Estimator" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 7 AS nid, 0.4656667709350586 AS "Estimator" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 8 AS nid, 10.198412895202637 AS "Estimator" FROM SYSIBM.SYSDUMMY1) AS "Values"), 
"DT_Output_13" AS 
...
"DT_node_data_14" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Estimator" AS DOUBLE) AS "Estimator" 
FROM (SELECT 2 AS nid, 10.659058570861816 AS "Estimator" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 5 AS nid, -8.06911563873291 AS "Estimator" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 6 AS nid, 0.42630884051322937 AS "Estimator" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 7 AS nid, 0.421124666929245 AS "Estimator" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 8 AS nid, 9.271284103393555 AS "Estimator" FROM SYSIBM.SYSDUMMY1) AS "Values"), 
"DT_Output_14" AS 
...
"DT_node_data_15" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Estimator" AS DOUBLE) AS "Estimator" 
FROM (SELECT 1 AS nid, -6.133334159851074 AS "Estimator" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 5 AS nid, -4.635502338409424 AS "Estimator" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 6 AS nid, 1.3295211791992188 AS "Estimator" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 7 AS nid, 0.3705681562423706 AS "Estimator" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 8 AS nid, 9.8074369430542 AS "Estimator" FROM SYSIBM.SYSDUMMY1) AS "Values"), 
"DT_Output_15" AS 
...
-- Code For temporary table tmp_20180508182440_codegen_bi5kwx_xgb_union part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180508182440_codegen_bi5kwx_xgb_union (
	"KEY" BIGINT, 
	"Estimator" DOUBLE
)
...
-- Code For temporary table tmp_20180508182440_codegen_bi5kwx_xgb_union part 2. Populate

INSERT INTO tmp_20180508182440_codegen_bi5kwx_xgb_union SELECT "XGB_Union"."KEY", "XGB_Union"."Estimator" 
...
FROM tmp_20180508182440_codegen_pniyio_xgb_b0 AS "XGB_B0" UNION ALL SELECT "XGB_B1"."KEY" AS "KEY", "XGB_B1"."Estimator" AS "Estimator" 
FROM tmp_20180508182440_codegen_3szhbn_xgb_b1 AS "XGB_B1") AS "XGB_EnsembleUnion") AS "XGB_Union"

-- Code For temporary table tmp_20180508182440_codegen_ej65y7_xgb_sum part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180508182440_codegen_ej65y7_xgb_sum (
	"KEY" BIGINT, 
	"Estimator" DOUBLE
)
...
-- Code For temporary table tmp_20180508182440_codegen_ej65y7_xgb_sum part 2. Populate

INSERT INTO tmp_20180508182440_codegen_ej65y7_xgb_sum SELECT "XGB_sum"."KEY", "XGB_sum"."Estimator" 
...
FROM tmp_20180508182440_codegen_bi5kwx_xgb_union AS "XGB_Union" GROUP BY "XGB_Union"."KEY") AS "T") AS "XGB_sum"

-- Model deployment code

SELECT "XGB_sum"."KEY" AS "KEY", "XGB_sum"."Estimator" + 0.5 AS "Estimator" 
FROM tmp_20180508182440_codegen_ej65y7_xgb_sum AS "XGB_sum"