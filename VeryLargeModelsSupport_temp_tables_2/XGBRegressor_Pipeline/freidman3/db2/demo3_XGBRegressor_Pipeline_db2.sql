...
-- Code For temporary table tmp_20180508185422_codegen_b69jqu_ads_imp_1_out part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180508185422_codegen_b69jqu_ads_imp_1_out (
	"KEY" BIGINT, 
...
-- Code For temporary table tmp_20180508185422_codegen_b69jqu_ads_imp_1_out part 2. Populate

INSERT INTO tmp_20180508185422_codegen_b69jqu_ads_imp_1_out SELECT "ADS_imp_1_OUT"."KEY", "ADS_imp_1_OUT".imputer_output_2, "ADS_imp_1_OUT".imputer_output_3, "ADS_imp_1_OUT".imputer_output_4, "ADS_imp_1_OUT".imputer_output_5 
...
-- Code For temporary table tmp_20180508185422_codegen_wkzwxx_ads_sca_2_out part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180508185422_codegen_wkzwxx_ads_sca_2_out (
	"KEY" BIGINT, 
...
-- Code For temporary table tmp_20180508185422_codegen_wkzwxx_ads_sca_2_out part 2. Populate

INSERT INTO tmp_20180508185422_codegen_wkzwxx_ads_sca_2_out SELECT "ADS_sca_2_OUT"."KEY", "ADS_sca_2_OUT".scaler_output_2, "ADS_sca_2_OUT".scaler_output_3, "ADS_sca_2_OUT".scaler_output_4, "ADS_sca_2_OUT".scaler_output_5 
...
FROM tmp_20180508185422_codegen_b69jqu_ads_imp_1_out AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT"

-- Code For temporary table tmp_20180508185422_codegen_sn4phb_xgb_b0 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180508185422_codegen_sn4phb_xgb_b0 (
	"KEY" BIGINT, 
	"Estimator" DOUBLE
)
...
-- Code For temporary table tmp_20180508185422_codegen_sn4phb_xgb_b0 part 2. Populate

INSERT INTO tmp_20180508185422_codegen_sn4phb_xgb_b0 WITH "DT_node_lookup" AS 
...
FROM tmp_20180508185422_codegen_wkzwxx_ads_sca_2_out AS "ADS_sca_2_OUT"), 
"DT_node_data" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Estimator" AS DOUBLE) AS "Estimator" 
FROM (SELECT 1 AS nid, 0.03304983675479889 AS "Estimator" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 2 AS nid, 0.09192007780075073 AS "Estimator" FROM SYSIBM.SYSDUMMY1) AS "Values"), 
"DT_Output" AS 
...
"DT_node_data_1" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Estimator" AS DOUBLE) AS "Estimator" 
FROM (SELECT 1 AS nid, 0.03004531003534794 AS "Estimator" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 2 AS nid, 0.08285753428936005 AS "Estimator" FROM SYSIBM.SYSDUMMY1) AS "Values"), 
"DT_Output_1" AS 
...
"DT_node_data_2" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Estimator" AS DOUBLE) AS "Estimator" 
FROM (SELECT 1 AS nid, 0.027313916012644768 AS "Estimator" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 3 AS nid, 0.0781811997294426 AS "Estimator" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 4 AS nid, 0.05488375946879387 AS "Estimator" FROM SYSIBM.SYSDUMMY1) AS "Values"), 
"DT_Output_2" AS 
...
"DT_node_data_3" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Estimator" AS DOUBLE) AS "Estimator" 
FROM (SELECT 1 AS nid, 0.024830834940075874 AS "Estimator" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 3 AS nid, 0.07208586484193802 AS "Estimator" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 5 AS nid, 0.03887651488184929 AS "Estimator" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 6 AS nid, 0.06283045560121536 AS "Estimator" FROM SYSIBM.SYSDUMMY1) AS "Values"), 
"DT_Output_3" AS 
...
"DT_node_data_4" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Estimator" AS DOUBLE) AS "Estimator" 
FROM (SELECT 1 AS nid, 0.030827684327960014 AS "Estimator" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 3 AS nid, 0.042946554720401764 AS "Estimator" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 4 AS nid, 0.06566087901592255 AS "Estimator" FROM SYSIBM.SYSDUMMY1) AS "Values"), 
"DT_Output_4" AS 
...
"DT_node_data_5" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Estimator" AS DOUBLE) AS "Estimator" 
FROM (SELECT 1 AS nid, 0.019770970568060875 AS "Estimator" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 3 AS nid, 0.05906825140118599 AS "Estimator" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 5 AS nid, 0.031149083748459816 AS "Estimator" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 6 AS nid, 0.05134235695004463 AS "Estimator" FROM SYSIBM.SYSDUMMY1) AS "Values"), 
"DT_Output_5" AS 
...
"DT_node_data_6" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Estimator" AS DOUBLE) AS "Estimator" 
FROM (SELECT 1 AS nid, 0.02235419861972332 AS "Estimator" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 4 AS nid, 0.05528220534324646 AS "Estimator" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 5 AS nid, 0.048120249062776566 AS "Estimator" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 6 AS nid, 0.028293082490563393 AS "Estimator" FROM SYSIBM.SYSDUMMY1) AS "Values"), 
"DT_Output_6" AS 
...
"DT_node_data_7" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Estimator" AS DOUBLE) AS "Estimator" 
FROM (SELECT 1 AS nid, 0.015941409394145012 AS "Estimator" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 3 AS nid, 0.04950718954205513 AS "Estimator" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 5 AS nid, 0.025699550285935402 AS "Estimator" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 6 AS nid, 0.04306947439908981 AS "Estimator" FROM SYSIBM.SYSDUMMY1) AS "Values"), 
"DT_Output_7" AS 
...
"DT_node_data_8" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Estimator" AS DOUBLE) AS "Estimator" 
FROM (SELECT 1 AS nid, 0.018013611435890198 AS "Estimator" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 4 AS nid, 0.045275527983903885 AS "Estimator" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 5 AS nid, 0.039108484983444214 AS "Estimator" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 6 AS nid, 0.023343760520219803 AS "Estimator" FROM SYSIBM.SYSDUMMY1) AS "Values"), 
"DT_Output_8" AS 
...
"DT_node_data_9" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Estimator" AS DOUBLE) AS "Estimator" 
FROM (SELECT 1 AS nid, 0.016332341358065605 AS "Estimator" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 3 AS nid, 0.024957163259387016 AS "Estimator" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 4 AS nid, 0.039277832955121994 AS "Estimator" FROM SYSIBM.SYSDUMMY1) AS "Values"), 
"DT_Output_9" AS 
...
-- Code For temporary table tmp_20180508185422_codegen_gtrsr6_xgb_b1 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180508185422_codegen_gtrsr6_xgb_b1 (
	"KEY" BIGINT, 
	"Estimator" DOUBLE
)
...
-- Code For temporary table tmp_20180508185422_codegen_gtrsr6_xgb_b1 part 2. Populate

INSERT INTO tmp_20180508185422_codegen_gtrsr6_xgb_b1 WITH "DT_node_lookup_10" AS 
...
"DT_node_data_10" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Estimator" AS DOUBLE) AS "Estimator" 
FROM (SELECT 1 AS nid, 0.01674405112862587 AS "Estimator" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 3 AS nid, 0.022688327357172966 AS "Estimator" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 4 AS nid, 0.036280449479818344 AS "Estimator" FROM SYSIBM.SYSDUMMY1) AS "Values"), 
"DT_Output_10" AS 
...
"DT_node_data_11" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Estimator" AS DOUBLE) AS "Estimator" 
FROM (SELECT 1 AS nid, 0.03643549606204033 AS "Estimator" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 3 AS nid, 0.001228771056048572 AS "Estimator" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 5 AS nid, 0.016789136454463005 AS "Estimator" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 6 AS nid, 0.031296584755182266 AS "Estimator" FROM SYSIBM.SYSDUMMY1) AS "Values"), 
"DT_Output_11" AS 
...
"DT_node_data_12" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Estimator" AS DOUBLE) AS "Estimator" 
FROM (SELECT 1 AS nid, 0.03290235996246338 AS "Estimator" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 3 AS nid, 0.0011161346919834614 AS "Estimator" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 5 AS nid, 0.015239374712109566 AS "Estimator" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 6 AS nid, 0.028287295252084732 AS "Estimator" FROM SYSIBM.SYSDUMMY1) AS "Values"), 
"DT_Output_12" AS 
...
"DT_node_data_13" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Estimator" AS DOUBLE) AS "Estimator" 
FROM (SELECT 1 AS nid, 0.006589339580386877 AS "Estimator" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 3 AS nid, 0.026202401146292686 AS "Estimator" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 4 AS nid, 0.01683136634528637 AS "Estimator" FROM SYSIBM.SYSDUMMY1) AS "Values"), 
"DT_Output_13" AS 
...
"DT_node_data_14" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Estimator" AS DOUBLE) AS "Estimator" 
FROM (SELECT 1 AS nid, 0.027468154206871986 AS "Estimator" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 3 AS nid, -0.0004146725113969296 AS "Estimator" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 5 AS nid, 0.011774403974413872 AS "Estimator" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 6 AS nid, 0.023228108882904053 AS "Estimator" FROM SYSIBM.SYSDUMMY1) AS "Values"), 
"DT_Output_14" AS 
...
"DT_node_data_15" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Estimator" AS DOUBLE) AS "Estimator" 
FROM (SELECT 1 AS nid, 0.024804571643471718 AS "Estimator" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 3 AS nid, -0.0012562409974634647 AS "Estimator" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 5 AS nid, 0.010588334873318672 AS "Estimator" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 6 AS nid, 0.0209946371614933 AS "Estimator" FROM SYSIBM.SYSDUMMY1) AS "Values"), 
"DT_Output_15" AS 
...
-- Code For temporary table tmp_20180508185422_codegen_7p3s35_xgb_union part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180508185422_codegen_7p3s35_xgb_union (
	"KEY" BIGINT, 
	"Estimator" DOUBLE
)
...
-- Code For temporary table tmp_20180508185422_codegen_7p3s35_xgb_union part 2. Populate

INSERT INTO tmp_20180508185422_codegen_7p3s35_xgb_union SELECT "XGB_Union"."KEY", "XGB_Union"."Estimator" 
...
FROM tmp_20180508185422_codegen_sn4phb_xgb_b0 AS "XGB_B0" UNION ALL SELECT "XGB_B1"."KEY" AS "KEY", "XGB_B1"."Estimator" AS "Estimator" 
FROM tmp_20180508185422_codegen_gtrsr6_xgb_b1 AS "XGB_B1") AS "XGB_EnsembleUnion") AS "XGB_Union"

-- Code For temporary table tmp_20180508185422_codegen_9x4dvd_xgb_sum part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180508185422_codegen_9x4dvd_xgb_sum (
	"KEY" BIGINT, 
	"Estimator" DOUBLE
)
...
-- Code For temporary table tmp_20180508185422_codegen_9x4dvd_xgb_sum part 2. Populate

INSERT INTO tmp_20180508185422_codegen_9x4dvd_xgb_sum SELECT "XGB_sum"."KEY", "XGB_sum"."Estimator" 
...
FROM tmp_20180508185422_codegen_7p3s35_xgb_union AS "XGB_Union" GROUP BY "XGB_Union"."KEY") AS "T") AS "XGB_sum"

-- Model deployment code

SELECT "XGB_sum"."KEY" AS "KEY", "XGB_sum"."Estimator" + 0.5 AS "Estimator" 
FROM tmp_20180508185422_codegen_9x4dvd_xgb_sum AS "XGB_sum"