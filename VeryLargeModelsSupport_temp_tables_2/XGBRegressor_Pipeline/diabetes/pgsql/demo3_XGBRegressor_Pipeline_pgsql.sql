...
-- Code For temporary table TMP_20180508183623_CODEGEN_99POKF_ADS_imp_1_OUT part 1. Create 


CREATE TEMPORARY TABLE "TMP_20180508183623_CODEGEN_99POKF_ADS_imp_1_OUT" (
	"KEY" BIGINT NOT NULL, 
	impter_2 FLOAT, 
	impter_3 FLOAT, 
	impter_4 FLOAT, 
...
-- Code For temporary table TMP_20180508183623_CODEGEN_99POKF_ADS_imp_1_OUT part 2. Populate

INSERT INTO "TMP_20180508183623_CODEGEN_99POKF_ADS_imp_1_OUT" ("KEY", impter_2, impter_3, impter_4, impter_5, impter_6, impter_7, impter_8, impter_9, impter_10, impter_11) SELECT "ADS_imp_1_OUT"."KEY", "ADS_imp_1_OUT".impter_2, "ADS_imp_1_OUT".impter_3, "ADS_imp_1_OUT".impter_4, "ADS_imp_1_OUT".impter_5, "ADS_imp_1_OUT".impter_6, "ADS_imp_1_OUT".impter_7, "ADS_imp_1_OUT".impter_8, "ADS_imp_1_OUT".impter_9, "ADS_imp_1_OUT".impter_10, "ADS_imp_1_OUT".impter_11 
...
-- Code For temporary table TMP_20180508183623_CODEGEN_99POKF_ADS_imp_1_OUT part 3. Create Index 

CREATE INDEX "ix_TMP_20180508183623_CODEGEN_99POKF_ADS_imp_1_OUT_KEY" ON "TMP_20180508183623_CODEGEN_99POKF_ADS_imp_1_OUT" ("KEY")

-- Code For temporary table TMP_20180508183623_CODEGEN_GN3AAR_ADS_sca_2_OUT part 1. Create 


CREATE TEMPORARY TABLE "TMP_20180508183623_CODEGEN_GN3AAR_ADS_sca_2_OUT" (
	"KEY" BIGINT NOT NULL, 
	scaler_2 FLOAT, 
	scaler_3 FLOAT, 
	scaler_4 FLOAT, 
...
FROM "TMP_20180508183623_CODEGEN_99POKF_ADS_imp_1_OUT" AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT"

-- Code For temporary table TMP_20180508183623_CODEGEN_GN3AAR_ADS_sca_2_OUT part 3. Create Index 

CREATE INDEX "ix_TMP_20180508183623_CODEGEN_GN3AAR_ADS_sca_2_OUT_KEY" ON "TMP_20180508183623_CODEGEN_GN3AAR_ADS_sca_2_OUT" ("KEY")

-- Code For temporary table TMP_20180508183623_CODEGEN_RZ59I5_XGB_B0 part 1. Create 


CREATE TEMPORARY TABLE "TMP_20180508183623_CODEGEN_RZ59I5_XGB_B0" (
	"KEY" BIGINT, 
	"Estimator" FLOAT
)
...
-- Code For temporary table TMP_20180508183623_CODEGEN_RZ59I5_XGB_B0 part 2. Populate
...
FROM "TMP_20180508183623_CODEGEN_GN3AAR_ADS_sca_2_OUT" AS "ADS_sca_2_OUT"), 
"DT_node_data" AS 
...
FROM "DT_Output_9")
 INSERT INTO "TMP_20180508183623_CODEGEN_RZ59I5_XGB_B0" ("KEY", "Estimator") SELECT "XGB_B0"."KEY", "XGB_B0"."Estimator" 
...
-- Code For temporary table TMP_20180508183623_CODEGEN_C5D9B5_XGB_B1 part 1. Create 


CREATE TEMPORARY TABLE "TMP_20180508183623_CODEGEN_C5D9B5_XGB_B1" (
	"KEY" BIGINT, 
	"Estimator" FLOAT
)
...
-- Code For temporary table TMP_20180508183623_CODEGEN_C5D9B5_XGB_B1 part 2. Populate
...
FROM "DT_Output_15")
 INSERT INTO "TMP_20180508183623_CODEGEN_C5D9B5_XGB_B1" ("KEY", "Estimator") SELECT "XGB_B1"."KEY", "XGB_B1"."Estimator" 
...
-- Code For temporary table TMP_20180508183623_CODEGEN_3AD959_XGB_Union part 1. Create 


CREATE TEMPORARY TABLE "TMP_20180508183623_CODEGEN_3AD959_XGB_Union" (
	"KEY" BIGINT, 
	"Estimator" FLOAT
)
...
-- Code For temporary table TMP_20180508183623_CODEGEN_3AD959_XGB_Union part 2. Populate

INSERT INTO "TMP_20180508183623_CODEGEN_3AD959_XGB_Union" ("KEY", "Estimator") SELECT "XGB_Union"."KEY", "XGB_Union"."Estimator" 
...
FROM "TMP_20180508183623_CODEGEN_RZ59I5_XGB_B0" AS "XGB_B0" UNION ALL SELECT "XGB_B1"."KEY" AS "KEY", "XGB_B1"."Estimator" AS "Estimator" 
FROM "TMP_20180508183623_CODEGEN_C5D9B5_XGB_B1" AS "XGB_B1") AS "XGB_EnsembleUnion") AS "XGB_Union"

-- Code For temporary table TMP_20180508183623_CODEGEN_SNGKN3_XGB_sum part 1. Create 


CREATE TEMPORARY TABLE "TMP_20180508183623_CODEGEN_SNGKN3_XGB_sum" (
	"KEY" BIGINT NOT NULL, 
	"Estimator" FLOAT, 
	PRIMARY KEY ("KEY")
)
...
-- Code For temporary table TMP_20180508183623_CODEGEN_SNGKN3_XGB_sum part 2. Populate

INSERT INTO "TMP_20180508183623_CODEGEN_SNGKN3_XGB_sum" ("KEY", "Estimator") SELECT "XGB_sum"."KEY", "XGB_sum"."Estimator" 
...
FROM "TMP_20180508183623_CODEGEN_3AD959_XGB_Union" AS "XGB_Union" GROUP BY "XGB_Union"."KEY") AS "T") AS "XGB_sum"

-- Code For temporary table TMP_20180508183623_CODEGEN_SNGKN3_XGB_sum part 3. Create Index 

CREATE INDEX "ix_TMP_20180508183623_CODEGEN_SNGKN3_XGB_sum_KEY" ON "TMP_20180508183623_CODEGEN_SNGKN3_XGB_sum" ("KEY")

-- Model deployment code

SELECT "XGB_sum"."KEY" AS "KEY", "XGB_sum"."Estimator" + 0.5 AS "Estimator" 
FROM "TMP_20180508183623_CODEGEN_SNGKN3_XGB_sum" AS "XGB_sum"