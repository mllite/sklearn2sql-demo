...
-- Code For temporary table tmp_20180508183238_codegen_suiva4_ads_imp_1_out part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180508183238_codegen_suiva4_ads_imp_1_out (
	"KEY" BIGINT, 
	impter_2 DOUBLE, 
	impter_3 DOUBLE, 
	impter_4 DOUBLE, 
...
-- Code For temporary table tmp_20180508183238_codegen_suiva4_ads_imp_1_out part 2. Populate

INSERT INTO tmp_20180508183238_codegen_suiva4_ads_imp_1_out SELECT "ADS_imp_1_OUT"."KEY", "ADS_imp_1_OUT".impter_2, "ADS_imp_1_OUT".impter_3, "ADS_imp_1_OUT".impter_4, "ADS_imp_1_OUT".impter_5, "ADS_imp_1_OUT".impter_6, "ADS_imp_1_OUT".impter_7, "ADS_imp_1_OUT".impter_8, "ADS_imp_1_OUT".impter_9, "ADS_imp_1_OUT".impter_10, "ADS_imp_1_OUT".impter_11, "ADS_imp_1_OUT".impter_12, "ADS_imp_1_OUT".impter_13, "ADS_imp_1_OUT".impter_14 
...
-- Code For temporary table tmp_20180508183238_codegen_ovr0dc_ads_sca_2_out part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180508183238_codegen_ovr0dc_ads_sca_2_out (
	"KEY" BIGINT, 
	scaler_2 DOUBLE, 
	scaler_3 DOUBLE, 
	scaler_4 DOUBLE, 
...
-- Code For temporary table tmp_20180508183238_codegen_ovr0dc_ads_sca_2_out part 2. Populate

INSERT INTO tmp_20180508183238_codegen_ovr0dc_ads_sca_2_out SELECT "ADS_sca_2_OUT"."KEY", "ADS_sca_2_OUT".scaler_2, "ADS_sca_2_OUT".scaler_3, "ADS_sca_2_OUT".scaler_4, "ADS_sca_2_OUT".scaler_5, "ADS_sca_2_OUT".scaler_6, "ADS_sca_2_OUT".scaler_7, "ADS_sca_2_OUT".scaler_8, "ADS_sca_2_OUT".scaler_9, "ADS_sca_2_OUT".scaler_10, "ADS_sca_2_OUT".scaler_11, "ADS_sca_2_OUT".scaler_12, "ADS_sca_2_OUT".scaler_13, "ADS_sca_2_OUT".scaler_14 
...
FROM tmp_20180508183238_codegen_suiva4_ads_imp_1_out AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT"

-- Code For temporary table tmp_20180508183238_codegen_pqzipi_xgb_b0 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180508183238_codegen_pqzipi_xgb_b0 (
	"KEY" BIGINT, 
	"Estimator" DOUBLE
)
...
-- Code For temporary table tmp_20180508183238_codegen_pqzipi_xgb_b0 part 2. Populate

INSERT INTO tmp_20180508183238_codegen_pqzipi_xgb_b0 WITH "DT_node_lookup" AS 
...
FROM tmp_20180508183238_codegen_ovr0dc_ads_sca_2_out AS "ADS_sca_2_OUT"), 
"DT_node_data" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Estimator" AS DOUBLE) AS "Estimator" 
FROM (SELECT 4 AS nid, 3.9890244007110596 AS "Estimator" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 5 AS nid, 2.002768039703369 AS "Estimator" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 7 AS nid, 2.2746479511260986 AS "Estimator" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 8 AS nid, 2.7942373752593994 AS "Estimator" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 9 AS nid, 1.658596396446228 AS "Estimator" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 10 AS nid, 1.1890000104904175 AS "Estimator" FROM SYSIBM.SYSDUMMY1) AS "Values"), 
"DT_Output" AS 
...
"DT_node_data_1" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Estimator" AS DOUBLE) AS "Estimator" 
FROM (SELECT 5 AS nid, 2.617729902267456 AS "Estimator" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 6 AS nid, 3.904390335083008 AS "Estimator" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 7 AS nid, 2.193279504776001 AS "Estimator" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 8 AS nid, 1.7779951095581055 AS "Estimator" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 9 AS nid, 1.4815603494644165 AS "Estimator" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 10 AS nid, 1.0168761014938354 AS "Estimator" FROM SYSIBM.SYSDUMMY1) AS "Values"), 
"DT_Output_1" AS 
...
"DT_node_data_2" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Estimator" AS DOUBLE) AS "Estimator" 
FROM (SELECT 5 AS nid, 2.3615264892578125 AS "Estimator" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 6 AS nid, 3.528411865234375 AS "Estimator" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 7 AS nid, 1.9760208129882812 AS "Estimator" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 8 AS nid, 1.6032642126083374 AS "Estimator" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 9 AS nid, 0.9259337782859802 AS "Estimator" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 10 AS nid, 1.355223536491394 AS "Estimator" FROM SYSIBM.SYSDUMMY1) AS "Values"), 
"DT_Output_2" AS 
...
"DT_node_data_3" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Estimator" AS DOUBLE) AS "Estimator" 
FROM (SELECT 4 AS nid, 2.9591987133026123 AS "Estimator" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 5 AS nid, 1.5128496885299683 AS "Estimator" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 7 AS nid, 1.6322977542877197 AS "Estimator" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 8 AS nid, 2.125485420227051 AS "Estimator" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 9 AS nid, 1.2673325538635254 AS "Estimator" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 10 AS nid, 0.8523406982421875 AS "Estimator" FROM SYSIBM.SYSDUMMY1) AS "Values"), 
"DT_Output_3" AS 
...
"DT_node_data_4" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Estimator" AS DOUBLE) AS "Estimator" 
FROM (SELECT 3 AS nid, 2.078160285949707 AS "Estimator" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 4 AS nid, 2.9763565063476562 AS "Estimator" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 7 AS nid, 1.378053903579712 AS "Estimator" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 8 AS nid, 1.828680396080017 AS "Estimator" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 9 AS nid, 1.1055082082748413 AS "Estimator" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 10 AS nid, 0.7355231642723083 AS "Estimator" FROM SYSIBM.SYSDUMMY1) AS "Values"), 
"DT_Output_4" AS 
...
"DT_node_data_5" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Estimator" AS DOUBLE) AS "Estimator" 
FROM (SELECT 4 AS nid, 2.432462453842163 AS "Estimator" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 7 AS nid, 1.3629682064056396 AS "Estimator" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 8 AS nid, 1.7233394384384155 AS "Estimator" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 9 AS nid, 0.6685470938682556 AS "Estimator" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 10 AS nid, 1.1418527364730835 AS "Estimator" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 11 AS nid, 0.9621629118919373 AS "Estimator" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 12 AS nid, 0.5348416566848755 AS "Estimator" FROM SYSIBM.SYSDUMMY1) AS "Values"), 
"DT_Output_5" AS 
...
"DT_node_data_6" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Estimator" AS DOUBLE) AS "Estimator" 
FROM (SELECT 3 AS nid, 1.701004981994629 AS "Estimator" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 4 AS nid, 2.4600603580474854 AS "Estimator" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 7 AS nid, 1.866808533668518 AS "Estimator" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 8 AS nid, 1.170946717262268 AS "Estimator" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 9 AS nid, 0.9972090721130371 AS "Estimator" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 10 AS nid, 0.6476977467536926 AS "Estimator" FROM SYSIBM.SYSDUMMY1) AS "Values"), 
"DT_Output_6" AS 
...
"DT_node_data_7" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Estimator" AS DOUBLE) AS "Estimator" 
FROM (SELECT 4 AS nid, 2.1833291053771973 AS "Estimator" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 7 AS nid, 1.1028307676315308 AS "Estimator" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 8 AS nid, 1.468856692314148 AS "Estimator" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 9 AS nid, 0.9248348474502563 AS "Estimator" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 10 AS nid, 1.5930813550949097 AS "Estimator" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 11 AS nid, 0.7281293272972107 AS "Estimator" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 12 AS nid, 0.2936658561229706 AS "Estimator" FROM SYSIBM.SYSDUMMY1) AS "Values"), 
"DT_Output_7" AS 
...
"DT_node_data_8" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Estimator" AS DOUBLE) AS "Estimator" 
FROM (SELECT 4 AS nid, 1.9730825424194336 AS "Estimator" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 7 AS nid, 1.0917633771896362 AS "Estimator" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 8 AS nid, 1.8225401639938354 AS "Estimator" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 9 AS nid, 0.562129020690918 AS "Estimator" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 10 AS nid, 0.20757992565631866 AS "Estimator" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 11 AS nid, 0.6087807416915894 AS "Estimator" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 12 AS nid, 0.869446873664856 AS "Estimator" FROM SYSIBM.SYSDUMMY1) AS "Values"), 
"DT_Output_8" AS 
...
"DT_node_data_9" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Estimator" AS DOUBLE) AS "Estimator" 
FROM (SELECT 3 AS nid, 1.285546064376831 AS "Estimator" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 4 AS nid, 1.8284882307052612 AS "Estimator" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 7 AS nid, 0.8580016493797302 AS "Estimator" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 8 AS nid, 1.2938343286514282 AS "Estimator" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 9 AS nid, 0.7649194598197937 AS "Estimator" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 10 AS nid, 0.46019265055656433 AS "Estimator" FROM SYSIBM.SYSDUMMY1) AS "Values"), 
"DT_Output_9" AS 
...
-- Code For temporary table tmp_20180508183238_codegen_j4sf45_xgb_b1 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180508183238_codegen_j4sf45_xgb_b1 (
	"KEY" BIGINT, 
	"Estimator" DOUBLE
)
...
-- Code For temporary table tmp_20180508183238_codegen_j4sf45_xgb_b1 part 2. Populate

INSERT INTO tmp_20180508183238_codegen_j4sf45_xgb_b1 WITH "DT_node_lookup_10" AS 
...
"DT_node_data_10" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Estimator" AS DOUBLE) AS "Estimator" 
FROM (SELECT 6 AS nid, 0.4523448050022125 AS "Estimator" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 7 AS nid, 1.338578224182129 AS "Estimator" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 8 AS nid, 0.7056286334991455 AS "Estimator" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 9 AS nid, 0.5824922919273376 AS "Estimator" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 10 AS nid, 0.27925094962120056 AS "Estimator" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 11 AS nid, 1.1679444313049316 AS "Estimator" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 12 AS nid, 1.693954348564148 AS "Estimator" FROM SYSIBM.SYSDUMMY1) AS "Values"), 
"DT_Output_10" AS 
...
"DT_node_data_11" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Estimator" AS DOUBLE) AS "Estimator" 
FROM (SELECT 7 AS nid, 0.7656623721122742 AS "Estimator" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 8 AS nid, 1.329530119895935 AS "Estimator" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 9 AS nid, 1.521605134010315 AS "Estimator" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 10 AS nid, 1.1243324279785156 AS "Estimator" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 11 AS nid, 0.5164692401885986 AS "Estimator" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 12 AS nid, 0.27053627371788025 AS "Estimator" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 13 AS nid, 0.41958847641944885 AS "Estimator" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 14 AS nid, 0.6375863552093506 AS "Estimator" FROM SYSIBM.SYSDUMMY1) AS "Values"), 
"DT_Output_11" AS 
...
"DT_node_data_12" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Estimator" AS DOUBLE) AS "Estimator" 
FROM (SELECT 3 AS nid, 1.5813093185424805 AS "Estimator" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 7 AS nid, 0.6600021123886108 AS "Estimator" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 8 AS nid, 1.120700478553772 AS "Estimator" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 9 AS nid, 0.5910495519638062 AS "Estimator" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 10 AS nid, 1.152274489402771 AS "Estimator" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 11 AS nid, 0.42759519815444946 AS "Estimator" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 12 AS nid, 0.11005621403455734 AS "Estimator" FROM SYSIBM.SYSDUMMY1) AS "Values"), 
"DT_Output_12" AS 
...
"DT_node_data_13" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Estimator" AS DOUBLE) AS "Estimator" 
FROM (SELECT 6 AS nid, 0.15702562034130096 AS "Estimator" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 7 AS nid, 0.9060226678848267 AS "Estimator" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 8 AS nid, 0.4787502884864807 AS "Estimator" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 9 AS nid, 0.4151773154735565 AS "Estimator" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 10 AS nid, 0.1562521904706955 AS "Estimator" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 11 AS nid, 0.8186716437339783 AS "Estimator" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 12 AS nid, 1.2834728956222534 AS "Estimator" FROM SYSIBM.SYSDUMMY1) AS "Values"), 
"DT_Output_13" AS 
...
"DT_node_data_14" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Estimator" AS DOUBLE) AS "Estimator" 
FROM (SELECT 7 AS nid, 0.5241692662239075 AS "Estimator" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 8 AS nid, 0.7520281076431274 AS "Estimator" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 9 AS nid, 1.2875114679336548 AS "Estimator" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 10 AS nid, 0.7881900668144226 AS "Estimator" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 11 AS nid, 0.16284285485744476 AS "Estimator" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 12 AS nid, 0.4763443171977997 AS "Estimator" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 13 AS nid, 0.34015199542045593 AS "Estimator" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 14 AS nid, 0.12058860063552856 AS "Estimator" FROM SYSIBM.SYSDUMMY1) AS "Values"), 
"DT_Output_14" AS 
...
"DT_node_data_15" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Estimator" AS DOUBLE) AS "Estimator" 
FROM (SELECT 6 AS nid, 0.11129003018140793 AS "Estimator" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 7 AS nid, 0.7856180667877197 AS "Estimator" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 8 AS nid, 0.38532230257987976 AS "Estimator" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 9 AS nid, 0.3531283438205719 AS "Estimator" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 10 AS nid, 0.13314254581928253 AS "Estimator" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 11 AS nid, 0.6760657429695129 AS "Estimator" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 12 AS nid, 1.0761207342147827 AS "Estimator" FROM SYSIBM.SYSDUMMY1) AS "Values"), 
"DT_Output_15" AS 
...
-- Code For temporary table tmp_20180508183238_codegen_l8g0nf_xgb_union part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180508183238_codegen_l8g0nf_xgb_union (
	"KEY" BIGINT, 
	"Estimator" DOUBLE
)
...
-- Code For temporary table tmp_20180508183238_codegen_l8g0nf_xgb_union part 2. Populate

INSERT INTO tmp_20180508183238_codegen_l8g0nf_xgb_union SELECT "XGB_Union"."KEY", "XGB_Union"."Estimator" 
...
FROM tmp_20180508183238_codegen_pqzipi_xgb_b0 AS "XGB_B0" UNION ALL SELECT "XGB_B1"."KEY" AS "KEY", "XGB_B1"."Estimator" AS "Estimator" 
FROM tmp_20180508183238_codegen_j4sf45_xgb_b1 AS "XGB_B1") AS "XGB_EnsembleUnion") AS "XGB_Union"

-- Code For temporary table tmp_20180508183238_codegen_62snco_xgb_sum part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180508183238_codegen_62snco_xgb_sum (
	"KEY" BIGINT, 
	"Estimator" DOUBLE
)
...
-- Code For temporary table tmp_20180508183238_codegen_62snco_xgb_sum part 2. Populate

INSERT INTO tmp_20180508183238_codegen_62snco_xgb_sum SELECT "XGB_sum"."KEY", "XGB_sum"."Estimator" 
...
FROM tmp_20180508183238_codegen_l8g0nf_xgb_union AS "XGB_Union" GROUP BY "XGB_Union"."KEY") AS "T") AS "XGB_sum"

-- Model deployment code

SELECT "XGB_sum"."KEY" AS "KEY", "XGB_sum"."Estimator" + 0.5 AS "Estimator" 
FROM tmp_20180508183238_codegen_62snco_xgb_sum AS "XGB_sum"