...
-- Code For temporary table ##TMP_20180508184714_CODEGEN_M6H1DM_ADS_imp_1_OUT part 1. Create 


CREATE TABLE ##TMP_20180508184714_CODEGEN_M6H1DM_ADS_imp_1_OUT (
	[KEY] BIGINT NULL, 
...
-- Code For temporary table ##TMP_20180508184714_CODEGEN_M6H1DM_ADS_imp_1_OUT part 2. Populate

INSERT INTO ##TMP_20180508184714_CODEGEN_M6H1DM_ADS_imp_1_OUT ([KEY], imputer_output_2, imputer_output_3, imputer_output_4, imputer_output_5) SELECT [ADS_imp_1_OUT].[KEY], [ADS_imp_1_OUT].imputer_output_2, [ADS_imp_1_OUT].imputer_output_3, [ADS_imp_1_OUT].imputer_output_4, [ADS_imp_1_OUT].imputer_output_5 
...
-- Code For temporary table ##TMP_20180508184714_CODEGEN_NMOFXW_ADS_sca_2_OUT part 1. Create 


CREATE TABLE ##TMP_20180508184714_CODEGEN_NMOFXW_ADS_sca_2_OUT (
	[KEY] BIGINT NULL, 
...
-- Code For temporary table ##TMP_20180508184714_CODEGEN_NMOFXW_ADS_sca_2_OUT part 2. Populate

INSERT INTO ##TMP_20180508184714_CODEGEN_NMOFXW_ADS_sca_2_OUT ([KEY], scaler_output_2, scaler_output_3, scaler_output_4, scaler_output_5) SELECT [ADS_sca_2_OUT].[KEY], [ADS_sca_2_OUT].scaler_output_2, [ADS_sca_2_OUT].scaler_output_3, [ADS_sca_2_OUT].scaler_output_4, [ADS_sca_2_OUT].scaler_output_5 
...
FROM ##TMP_20180508184714_CODEGEN_M6H1DM_ADS_imp_1_OUT AS [ADS_imp_1_OUT]) AS [ADS_sca_2_OUT]

-- Code For temporary table ##TMP_20180508184714_CODEGEN_33ZPIQ_Quantiles part 1. Create 


CREATE TABLE ##TMP_20180508184714_CODEGEN_33ZPIQ_Quantiles (
	[KEY] BIGINT NULL, 
...
-- Code For temporary table ##TMP_20180508184714_CODEGEN_33ZPIQ_Quantiles part 2. Populate
...
FROM ##TMP_20180508184714_CODEGEN_NMOFXW_ADS_sca_2_OUT AS [ADS_sca_2_OUT]), 
[DT_node_data] AS 
...
WHERE u1.[Estimator] >= u2.[Estimator] AND u1.[KEY] = u2.[KEY] GROUP BY u1.[KEY], u1.est_index, u1.[Estimator], u1.[Weight]) AS [CW])
 INSERT INTO ##TMP_20180508184714_CODEGEN_33ZPIQ_Quantiles ([KEY], [Quantile]) SELECT [Quantiles].[KEY], [Quantiles].[Quantile] 
...
FROM ##TMP_20180508184714_CODEGEN_33ZPIQ_Quantiles AS [Quantiles]