...
-- Code For temporary table TMP_20180508182857_CODEGEN_IL85RL_ADS_imp_1_OUT part 1. Create 


CREATE TEMPORARY TABLE "TMP_20180508182857_CODEGEN_IL85RL_ADS_imp_1_OUT" (
	"KEY" BIGINT NOT NULL, 
	impter_2 FLOAT, 
	impter_3 FLOAT, 
	impter_4 FLOAT, 
...
-- Code For temporary table TMP_20180508182857_CODEGEN_IL85RL_ADS_imp_1_OUT part 2. Populate

INSERT INTO "TMP_20180508182857_CODEGEN_IL85RL_ADS_imp_1_OUT" ("KEY", impter_2, impter_3, impter_4, impter_5, impter_6, impter_7, impter_8, impter_9, impter_10, impter_11, impter_12, impter_13, impter_14) SELECT "ADS_imp_1_OUT"."KEY", "ADS_imp_1_OUT".impter_2, "ADS_imp_1_OUT".impter_3, "ADS_imp_1_OUT".impter_4, "ADS_imp_1_OUT".impter_5, "ADS_imp_1_OUT".impter_6, "ADS_imp_1_OUT".impter_7, "ADS_imp_1_OUT".impter_8, "ADS_imp_1_OUT".impter_9, "ADS_imp_1_OUT".impter_10, "ADS_imp_1_OUT".impter_11, "ADS_imp_1_OUT".impter_12, "ADS_imp_1_OUT".impter_13, "ADS_imp_1_OUT".impter_14 
...
-- Code For temporary table TMP_20180508182857_CODEGEN_IL85RL_ADS_imp_1_OUT part 3. Create Index 

CREATE INDEX "ix_TMP_20180508182857_CODEGEN_IL85RL_ADS_imp_1_OUT_KEY" ON "TMP_20180508182857_CODEGEN_IL85RL_ADS_imp_1_OUT" ("KEY")

-- Code For temporary table TMP_20180508182857_CODEGEN_GQBWSQ_ADS_sca_2_OUT part 1. Create 


CREATE TEMPORARY TABLE "TMP_20180508182857_CODEGEN_GQBWSQ_ADS_sca_2_OUT" (
	"KEY" BIGINT NOT NULL, 
	scaler_2 FLOAT, 
	scaler_3 FLOAT, 
	scaler_4 FLOAT, 
...
FROM "TMP_20180508182857_CODEGEN_IL85RL_ADS_imp_1_OUT" AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT"

-- Code For temporary table TMP_20180508182857_CODEGEN_GQBWSQ_ADS_sca_2_OUT part 3. Create Index 

CREATE INDEX "ix_TMP_20180508182857_CODEGEN_GQBWSQ_ADS_sca_2_OUT_KEY" ON "TMP_20180508182857_CODEGEN_GQBWSQ_ADS_sca_2_OUT" ("KEY")

-- Code For temporary table TMP_20180508182857_CODEGEN_86AMNQ_WE_B0 part 1. Create 


CREATE TEMPORARY TABLE "TMP_20180508182857_CODEGEN_86AMNQ_WE_B0" (
	"KEY" BIGINT, 
	"Estimator" FLOAT, 
	"Weight" FLOAT, 
	est_index BIGINT
...
-- Code For temporary table TMP_20180508182857_CODEGEN_86AMNQ_WE_B0 part 2. Populate
...
FROM "TMP_20180508182857_CODEGEN_GQBWSQ_ADS_sca_2_OUT" AS "ADS_sca_2_OUT"), 
"DT_node_data" AS 
...
FROM "DT_Output_9")
 INSERT INTO "TMP_20180508182857_CODEGEN_86AMNQ_WE_B0" ("KEY", "Estimator", "Weight", est_index) SELECT "WE_B0"."KEY", "WE_B0"."Estimator", "WE_B0"."Weight", "WE_B0".est_index 
...
-- Code For temporary table TMP_20180508182857_CODEGEN_0B3L2J_WE_B1 part 1. Create 


CREATE TEMPORARY TABLE "TMP_20180508182857_CODEGEN_0B3L2J_WE_B1" (
	"KEY" BIGINT, 
	"Estimator" FLOAT, 
	"Weight" FLOAT, 
	est_index BIGINT
...
-- Code For temporary table TMP_20180508182857_CODEGEN_0B3L2J_WE_B1 part 2. Populate
...
FROM "DT_Output_15")
 INSERT INTO "TMP_20180508182857_CODEGEN_0B3L2J_WE_B1" ("KEY", "Estimator", "Weight", est_index) SELECT "WE_B1"."KEY", "WE_B1"."Estimator", "WE_B1"."Weight", "WE_B1".est_index 
...
-- Code For temporary table TMP_20180508182857_CODEGEN_Y8VCVK_WE_Union part 1. Create 


CREATE TEMPORARY TABLE "TMP_20180508182857_CODEGEN_Y8VCVK_WE_Union" (
	"KEY" BIGINT, 
	"Estimator" FLOAT, 
	"Weight" FLOAT, 
	est_index BIGINT
...
-- Code For temporary table TMP_20180508182857_CODEGEN_Y8VCVK_WE_Union part 2. Populate

INSERT INTO "TMP_20180508182857_CODEGEN_Y8VCVK_WE_Union" ("KEY", "Estimator", "Weight", est_index) SELECT "WE_Union"."KEY", "WE_Union"."Estimator", "WE_Union"."Weight", "WE_Union".est_index 
...
FROM "TMP_20180508182857_CODEGEN_86AMNQ_WE_B0" AS "WE_B0" UNION ALL SELECT "WE_B1"."KEY" AS "KEY", "WE_B1"."Estimator" AS "Estimator", "WE_B1"."Weight" AS "Weight", "WE_B1".est_index AS est_index 
FROM "TMP_20180508182857_CODEGEN_0B3L2J_WE_B1" AS "WE_B1") AS "WE_EnsembleUnion") AS "WE_Union"

-- Code For temporary table TMP_20180508182857_CODEGEN_UMDNB3_Quantiles part 1. Create 


CREATE TEMPORARY TABLE "TMP_20180508182857_CODEGEN_UMDNB3_Quantiles" (
	"KEY" BIGINT, 
	"Quantile" FLOAT
)
...
-- Code For temporary table TMP_20180508182857_CODEGEN_UMDNB3_Quantiles part 2. Populate

WITH "Cumulative_Frequencies" AS 
(SELECT "CW"."KEY" AS "KEY", "CW"."Estimator" AS "Estimator", "CW"."Weight" AS "Weight", "CW".est_index AS est_index, "CW".cum_weight AS cum_weight 
FROM (SELECT u1."KEY" AS "KEY", u1."Estimator" AS "Estimator", u1."Weight" AS "Weight", u1.est_index AS est_index, sum(u2."Weight") AS cum_weight 
FROM "TMP_20180508182857_CODEGEN_Y8VCVK_WE_Union" AS u1, "TMP_20180508182857_CODEGEN_Y8VCVK_WE_Union" AS u2 
WHERE u1."Estimator" >= u2."Estimator" AND u1."KEY" = u2."KEY" GROUP BY u1."KEY", u1.est_index, u1."Estimator", u1."Weight") AS "CW")
 INSERT INTO "TMP_20180508182857_CODEGEN_UMDNB3_Quantiles" ("KEY", "Quantile") SELECT "Quantiles"."KEY", "Quantiles"."Quantile" 
...
FROM "TMP_20180508182857_CODEGEN_UMDNB3_Quantiles" AS "Quantiles"