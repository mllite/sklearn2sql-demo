...
-- Code For temporary table tmp_20180508194446_codegen_v9ohtg_ads_imp_1_out part 1. Create 


CREATE TABLE tmp_20180508194446_codegen_v9ohtg_ads_imp_1_out (
	`KEY` BIGINT, 
	impter_2 DOUBLE, 
	impter_3 DOUBLE, 
	impter_4 DOUBLE, 
...
-- Code For temporary table tmp_20180508194446_codegen_4qixzo_ads_sca_2_out part 1. Create 


CREATE TABLE tmp_20180508194446_codegen_4qixzo_ads_sca_2_out (
	`KEY` BIGINT, 
	scaler_2 DOUBLE, 
	scaler_3 DOUBLE, 
	scaler_4 DOUBLE, 
...
FROM tmp_20180508194446_codegen_v9ohtg_ads_imp_1_out AS `ADS_imp_1_OUT`) AS `ADS_sca_2_OUT`

-- Code For temporary table tmp_20180508194446_codegen_4jo8b1_quantiles part 1. Create 


CREATE TABLE tmp_20180508194446_codegen_4jo8b1_quantiles (
	`KEY` BIGINT, 
	`Quantile` DOUBLE
)
...
-- Code For temporary table tmp_20180508194446_codegen_4jo8b1_quantiles part 2. Populate
...
FROM tmp_20180508194446_codegen_4qixzo_ads_sca_2_out AS `ADS_sca_2_OUT`), 
`DT_node_data` AS 
...
WHERE u1.`Estimator` >= u2.`Estimator` AND u1.`KEY` = u2.`KEY` GROUP BY u1.`KEY`, u1.est_index, u1.`Estimator`, u1.`Weight`) AS `CW`)
 INSERT INTO tmp_20180508194446_codegen_4jo8b1_quantiles (`KEY`, `Quantile`) SELECT `Quantiles`.`KEY`, `Quantiles`.`Quantile` 
...
FROM tmp_20180508194446_codegen_4jo8b1_quantiles AS `Quantiles`