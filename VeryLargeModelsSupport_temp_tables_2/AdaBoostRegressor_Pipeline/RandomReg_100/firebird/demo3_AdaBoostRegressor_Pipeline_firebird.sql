...
-- Code For temporary table TMP_20180508182452_CODEGEN_PXUD part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508182452_CODEGEN_PXUD" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20180508182452_CODEGEN_PXUD part 3. Create Index 

CREATE INDEX "ix_TMP_20180508182452_C_b225" ON "TMP_20180508182452_CODEGEN_PXUD" ("KEY")

-- Code For temporary table TMP_20180508182452_CODEGEN_VM5V part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508182452_CODEGEN_VM5V" (
	"KEY" BIGINT NOT NULL, 
...
FROM "TMP_20180508182452_CODEGEN_PXUD" AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT") AS "U"

-- Code For temporary table TMP_20180508182452_CODEGEN_VM5V part 3. Create Index 

CREATE INDEX "ix_TMP_20180508182452_C_916c" ON "TMP_20180508182452_CODEGEN_VM5V" ("KEY")

-- Code For temporary table TMP_20180508182452_CODEGEN_YTQP part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508182452_CODEGEN_YTQP" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20180508182452_CODEGEN_YTQP part 2. Populate

INSERT INTO "TMP_20180508182452_CODEGEN_YTQP" ("KEY", "Quantile") SELECT "U"."KEY", "U"."Quantile" 
...
FROM "TMP_20180508182452_CODEGEN_VM5V" AS "ADS_sca_2_OUT"), 
"DT_node_data" AS 
(SELECT "Values".nid AS nid, CAST("Values"."E" AS DOUBLE PRECISION) AS "E" 
FROM (SELECT 3 AS nid, -299.55516868188016 AS "E" FROM rdb$database UNION ALL SELECT 4 AS nid, -439.78883114766336 AS "E" FROM rdb$database UNION ALL SELECT 6 AS nid, -149.93062882389108 AS "E" FROM rdb$database UNION ALL SELECT 7 AS nid, 111.60742166947276 AS "E" FROM rdb$database UNION ALL SELECT 10 AS nid, 319.6456319352328 AS "E" FROM rdb$database UNION ALL SELECT 11 AS nid, 108.14981384071251 AS "E" FROM rdb$database UNION ALL SELECT 13 AS nid, -74.03087422300632 AS "E" FROM rdb$database UNION ALL SELECT 14 AS nid, 120.35070981059704 AS "E" FROM rdb$database) AS "Values"), 
"DT_Output" AS 
...
"DT_node_data_1" AS 
(SELECT "Values".nid AS nid, CAST("Values"."E" AS DOUBLE PRECISION) AS "E" 
FROM (SELECT 3 AS nid, 75.60702200307296 AS "E" FROM rdb$database UNION ALL SELECT 4 AS nid, 419.8117904787066 AS "E" FROM rdb$database UNION ALL SELECT 6 AS nid, -150.50585850810697 AS "E" FROM rdb$database UNION ALL SELECT 7 AS nid, -334.8676350174931 AS "E" FROM rdb$database UNION ALL SELECT 10 AS nid, 79.09631375271496 AS "E" FROM rdb$database UNION ALL SELECT 11 AS nid, -169.73339035166558 AS "E" FROM rdb$database UNION ALL SELECT 13 AS nid, 89.9551260739289 AS "E" FROM rdb$database UNION ALL SELECT 14 AS nid, 232.21531580410792 AS "E" FROM rdb$database) AS "Values"), 
"DT_Output_1" AS 
...
"DT_node_data_2" AS 
(SELECT "Values".nid AS nid, CAST("Values"."E" AS DOUBLE PRECISION) AS "E" 
FROM (SELECT 3 AS nid, -422.76491839408925 AS "E" FROM rdb$database UNION ALL SELECT 4 AS nid, -243.53908567938973 AS "E" FROM rdb$database UNION ALL SELECT 6 AS nid, -81.38465826950127 AS "E" FROM rdb$database UNION ALL SELECT 7 AS nid, 233.33694106574706 AS "E" FROM rdb$database UNION ALL SELECT 10 AS nid, -56.83957441014503 AS "E" FROM rdb$database UNION ALL SELECT 11 AS nid, 134.62937712576715 AS "E" FROM rdb$database UNION ALL SELECT 13 AS nid, -280.96508601336274 AS "E" FROM rdb$database UNION ALL SELECT 14 AS nid, -153.06328093387233 AS "E" FROM rdb$database) AS "Values"), 
"DT_Output_2" AS 
...
"DT_node_data_3" AS 
(SELECT "Values".nid AS nid, CAST("Values"."E" AS DOUBLE PRECISION) AS "E" 
FROM (SELECT 3 AS nid, -359.3225987208778 AS "E" FROM rdb$database UNION ALL SELECT 4 AS nid, -218.33311725313078 AS "E" FROM rdb$database UNION ALL SELECT 6 AS nid, 327.27619652811467 AS "E" FROM rdb$database UNION ALL SELECT 7 AS nid, 48.423335696929506 AS "E" FROM rdb$database UNION ALL SELECT 10 AS nid, -165.08085766797484 AS "E" FROM rdb$database UNION ALL SELECT 11 AS nid, -16.45296535992008 AS "E" FROM rdb$database UNION ALL SELECT 13 AS nid, -104.86554844683326 AS "E" FROM rdb$database UNION ALL SELECT 14 AS nid, 175.4532994575898 AS "E" FROM rdb$database) AS "Values"), 
"DT_Output_3" AS 
...
"DT_node_data_4" AS 
(SELECT "Values".nid AS nid, CAST("Values"."E" AS DOUBLE PRECISION) AS "E" 
FROM (SELECT 3 AS nid, 245.21860440601063 AS "E" FROM rdb$database UNION ALL SELECT 4 AS nid, 305.0402047722153 AS "E" FROM rdb$database UNION ALL SELECT 5 AS nid, 419.81179047870665 AS "E" FROM rdb$database UNION ALL SELECT 8 AS nid, -173.73866973283788 AS "E" FROM rdb$database UNION ALL SELECT 9 AS nid, -387.5326881456799 AS "E" FROM rdb$database UNION ALL SELECT 11 AS nid, -106.36961064660952 AS "E" FROM rdb$database UNION ALL SELECT 12 AS nid, 80.25033909068998 AS "E" FROM rdb$database) AS "Values"), 
"DT_Output_4" AS 
...
"DT_node_data_5" AS 
(SELECT "Values".nid AS nid, CAST("Values"."E" AS DOUBLE PRECISION) AS "E" 
FROM (SELECT 3 AS nid, -250.1411376723568 AS "E" FROM rdb$database UNION ALL SELECT 4 AS nid, -431.1969669859277 AS "E" FROM rdb$database UNION ALL SELECT 6 AS nid, -194.4689573946363 AS "E" FROM rdb$database UNION ALL SELECT 7 AS nid, 39.53652680210184 AS "E" FROM rdb$database UNION ALL SELECT 10 AS nid, -52.26649363412389 AS "E" FROM rdb$database UNION ALL SELECT 11 AS nid, -166.33878820731078 AS "E" FROM rdb$database UNION ALL SELECT 13 AS nid, 198.9904787086985 AS "E" FROM rdb$database UNION ALL SELECT 14 AS nid, -34.15921261125043 AS "E" FROM rdb$database) AS "Values"), 
"DT_Output_5" AS 
...
"DT_node_data_6" AS 
(SELECT "Values".nid AS nid, CAST("Values"."E" AS DOUBLE PRECISION) AS "E" 
FROM (SELECT 3 AS nid, -146.81309318434305 AS "E" FROM rdb$database UNION ALL SELECT 4 AS nid, 234.75877165475936 AS "E" FROM rdb$database UNION ALL SELECT 6 AS nid, -436.89308608869476 AS "E" FROM rdb$database UNION ALL SELECT 7 AS nid, -454.8215873712685 AS "E" FROM rdb$database UNION ALL SELECT 10 AS nid, 48.7762016183392 AS "E" FROM rdb$database UNION ALL SELECT 11 AS nid, 265.5272995551691 AS "E" FROM rdb$database UNION ALL SELECT 13 AS nid, -202.30311906307523 AS "E" FROM rdb$database UNION ALL SELECT 14 AS nid, 59.00190945501265 AS "E" FROM rdb$database) AS "Values"), 
"DT_Output_6" AS 
...
"DT_node_data_7" AS 
(SELECT "Values".nid AS nid, CAST("Values"."E" AS DOUBLE PRECISION) AS "E" 
FROM (SELECT 3 AS nid, -246.1786931426876 AS "E" FROM rdb$database UNION ALL SELECT 4 AS nid, -52.10870342095156 AS "E" FROM rdb$database UNION ALL SELECT 6 AS nid, -437.5246838653099 AS "E" FROM rdb$database UNION ALL SELECT 7 AS nid, -327.50301874204285 AS "E" FROM rdb$database UNION ALL SELECT 10 AS nid, 117.89556480946582 AS "E" FROM rdb$database UNION ALL SELECT 11 AS nid, -171.36829448707329 AS "E" FROM rdb$database UNION ALL SELECT 13 AS nid, 104.24162385615097 AS "E" FROM rdb$database UNION ALL SELECT 14 AS nid, 327.0201989083299 AS "E" FROM rdb$database) AS "Values"), 
"DT_Output_7" AS 
...
"DT_node_data_8" AS 
(SELECT "Values".nid AS nid, CAST("Values"."E" AS DOUBLE PRECISION) AS "E" 
FROM (SELECT 3 AS nid, 212.81710450150226 AS "E" FROM rdb$database UNION ALL SELECT 4 AS nid, 219.92766037620171 AS "E" FROM rdb$database UNION ALL SELECT 6 AS nid, -357.0894177181091 AS "E" FROM rdb$database UNION ALL SELECT 7 AS nid, -160.98488985685765 AS "E" FROM rdb$database UNION ALL SELECT 10 AS nid, -135.17627509375765 AS "E" FROM rdb$database UNION ALL SELECT 11 AS nid, 85.26034557003274 AS "E" FROM rdb$database UNION ALL SELECT 13 AS nid, 277.81274127427787 AS "E" FROM rdb$database UNION ALL SELECT 14 AS nid, 125.55647826963536 AS "E" FROM rdb$database) AS "Values"), 
"DT_Output_8" AS 
...
"DT_node_data_9" AS 
(SELECT "Values".nid AS nid, CAST("Values"."E" AS DOUBLE PRECISION) AS "E" 
FROM (SELECT 3 AS nid, -283.74889504755856 AS "E" FROM rdb$database UNION ALL SELECT 4 AS nid, -109.5863292926706 AS "E" FROM rdb$database UNION ALL SELECT 6 AS nid, 247.11490781997932 AS "E" FROM rdb$database UNION ALL SELECT 7 AS nid, -64.3641298000168 AS "E" FROM rdb$database UNION ALL SELECT 10 AS nid, -186.18029669535417 AS "E" FROM rdb$database UNION ALL SELECT 11 AS nid, -146.53732849176905 AS "E" FROM rdb$database UNION ALL SELECT 13 AS nid, 267.0025306442181 AS "E" FROM rdb$database UNION ALL SELECT 14 AS nid, 142.6334358229316 AS "E" FROM rdb$database) AS "Values"), 
"DT_Output_9" AS 
...
"DT_node_data_10" AS 
(SELECT "Values".nid AS nid, CAST("Values"."E" AS DOUBLE PRECISION) AS "E" 
FROM (SELECT 3 AS nid, -46.89741779569693 AS "E" FROM rdb$database UNION ALL SELECT 4 AS nid, 128.74971924769997 AS "E" FROM rdb$database UNION ALL SELECT 6 AS nid, -194.64536551564441 AS "E" FROM rdb$database UNION ALL SELECT 7 AS nid, -432.78585670839794 AS "E" FROM rdb$database UNION ALL SELECT 10 AS nid, 26.278419883211438 AS "E" FROM rdb$database UNION ALL SELECT 11 AS nid, -250.18297267655564 AS "E" FROM rdb$database UNION ALL SELECT 13 AS nid, 213.40502898228738 AS "E" FROM rdb$database UNION ALL SELECT 14 AS nid, 347.2842238497908 AS "E" FROM rdb$database) AS "Values"), 
"DT_Output_10" AS 
...
"DT_node_data_11" AS 
(SELECT "Values".nid AS nid, CAST("Values"."E" AS DOUBLE PRECISION) AS "E" 
FROM (SELECT 3 AS nid, -254.39888647855693 AS "E" FROM rdb$database UNION ALL SELECT 4 AS nid, -427.51192244368093 AS "E" FROM rdb$database UNION ALL SELECT 6 AS nid, -86.11645147491663 AS "E" FROM rdb$database UNION ALL SELECT 7 AS nid, 215.90083761986224 AS "E" FROM rdb$database UNION ALL SELECT 10 AS nid, -80.6416086866768 AS "E" FROM rdb$database UNION ALL SELECT 11 AS nid, 169.16897281669048 AS "E" FROM rdb$database UNION ALL SELECT 13 AS nid, 167.85216124440603 AS "E" FROM rdb$database UNION ALL SELECT 14 AS nid, 310.86621384651613 AS "E" FROM rdb$database) AS "Values"), 
"DT_Output_11" AS 
...
"DT_node_data_12" AS 
(SELECT "Values".nid AS nid, CAST("Values"."E" AS DOUBLE PRECISION) AS "E" 
FROM (SELECT 3 AS nid, 128.70994156313017 AS "E" FROM rdb$database UNION ALL SELECT 4 AS nid, -84.88591152141443 AS "E" FROM rdb$database UNION ALL SELECT 6 AS nid, -360.0761788021789 AS "E" FROM rdb$database UNION ALL SELECT 7 AS nid, -176.06805164953155 AS "E" FROM rdb$database UNION ALL SELECT 10 AS nid, 49.17610059789685 AS "E" FROM rdb$database UNION ALL SELECT 11 AS nid, -174.6693610135026 AS "E" FROM rdb$database UNION ALL SELECT 13 AS nid, 208.40677806881985 AS "E" FROM rdb$database UNION ALL SELECT 14 AS nid, 419.81179047870665 AS "E" FROM rdb$database) AS "Values"), 
"DT_Output_12" AS 
...
"DT_node_data_13" AS 
(SELECT "Values".nid AS nid, CAST("Values"."E" AS DOUBLE PRECISION) AS "E" 
FROM (SELECT 3 AS nid, -416.9696088757073 AS "E" FROM rdb$database UNION ALL SELECT 4 AS nid, -178.1208998678555 AS "E" FROM rdb$database UNION ALL SELECT 6 AS nid, -95.51114924846917 AS "E" FROM rdb$database UNION ALL SELECT 7 AS nid, 68.03071719681672 AS "E" FROM rdb$database UNION ALL SELECT 10 AS nid, -38.114295082326265 AS "E" FROM rdb$database UNION ALL SELECT 11 AS nid, -257.9792248911822 AS "E" FROM rdb$database UNION ALL SELECT 13 AS nid, 256.49688781095426 AS "E" FROM rdb$database UNION ALL SELECT 14 AS nid, 119.43164365651639 AS "E" FROM rdb$database) AS "Values"), 
"DT_Output_13" AS 
...
"DT_node_data_14" AS 
(SELECT "Values".nid AS nid, CAST("Values"."E" AS DOUBLE PRECISION) AS "E" 
FROM (SELECT 3 AS nid, -311.3240743964379 AS "E" FROM rdb$database UNION ALL SELECT 4 AS nid, -454.8215873712685 AS "E" FROM rdb$database UNION ALL SELECT 6 AS nid, -140.76117130611314 AS "E" FROM rdb$database UNION ALL SELECT 7 AS nid, 172.79513511576155 AS "E" FROM rdb$database UNION ALL SELECT 10 AS nid, -180.97543591851664 AS "E" FROM rdb$database UNION ALL SELECT 11 AS nid, 62.882494629935834 AS "E" FROM rdb$database UNION ALL SELECT 13 AS nid, 179.37907527259367 AS "E" FROM rdb$database UNION ALL SELECT 14 AS nid, -66.78234314356789 AS "E" FROM rdb$database) AS "Values"), 
"DT_Output_14" AS 
...
"DT_node_data_15" AS 
(SELECT "Values".nid AS nid, CAST("Values"."E" AS DOUBLE PRECISION) AS "E" 
FROM (SELECT 3 AS nid, -381.9745888498094 AS "E" FROM rdb$database UNION ALL SELECT 4 AS nid, -208.7579662950499 AS "E" FROM rdb$database UNION ALL SELECT 6 AS nid, 110.77904144712802 AS "E" FROM rdb$database UNION ALL SELECT 7 AS nid, -120.33010917423199 AS "E" FROM rdb$database UNION ALL SELECT 10 AS nid, -83.49561556211482 AS "E" FROM rdb$database UNION ALL SELECT 11 AS nid, 59.62618655916408 AS "E" FROM rdb$database UNION ALL SELECT 13 AS nid, -75.64447824421846 AS "E" FROM rdb$database UNION ALL SELECT 14 AS nid, 236.27379253268913 AS "E" FROM rdb$database) AS "Values"), 
"DT_Output_15" AS 
...
-- Code For temporary table TMP_20180508182452_CODEGEN_YTQP part 3. Create Index 

CREATE INDEX "ix_TMP_20180508182452_C_101a" ON "TMP_20180508182452_CODEGEN_YTQP" ("KEY")

-- Model deployment code

SELECT "Quantiles"."KEY" AS "KEY", "Quantiles"."Quantile" AS "Estimator" 
FROM "TMP_20180508182452_CODEGEN_YTQP" AS "Quantiles"