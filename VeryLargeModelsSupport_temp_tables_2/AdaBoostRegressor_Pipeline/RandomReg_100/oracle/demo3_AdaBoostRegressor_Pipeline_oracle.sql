...
-- Code For temporary table DEGEN_2RCK78_ADS_IMP_1_OUT part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "DEGEN_2RCK78_ADS_IMP_1_OUT" (
	"KEY" NUMBER(19), 
...
-- Code For temporary table DEGEN_DZX1F5_ADS_SCA_2_OUT part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "DEGEN_DZX1F5_ADS_SCA_2_OUT" (
	"KEY" NUMBER(19), 
...
FROM "DEGEN_2RCK78_ADS_IMP_1_OUT" "ADS_imp_1_OUT") "ADS_sca_2_OUT") "U"

-- Code For temporary table 1_CODEGEN_B83CUQ_QUANTILES part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "1_CODEGEN_B83CUQ_QUANTILES" (
	"KEY" NUMBER(19), 
...
-- Code For temporary table 1_CODEGEN_B83CUQ_QUANTILES part 2. Populate

INSERT INTO "1_CODEGEN_B83CUQ_QUANTILES" ("KEY", "Quantile") SELECT "U"."KEY", "U"."Quantile" 
...
FROM "DEGEN_DZX1F5_ADS_SCA_2_OUT" "ADS_sca_2_OUT"), 
"DT_node_data" AS 
...
FROM "1_CODEGEN_B83CUQ_QUANTILES" "Quantiles"