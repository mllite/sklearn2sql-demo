...
-- Code For temporary table ##TMP_20180508185054_CODEGEN_ECPRV6_ADS_imp_1_OUT part 1. Create 


CREATE TABLE ##TMP_20180508185054_CODEGEN_ECPRV6_ADS_imp_1_OUT (
	[KEY] BIGINT NULL, 
...
-- Code For temporary table ##TMP_20180508185054_CODEGEN_ECPRV6_ADS_imp_1_OUT part 2. Populate

INSERT INTO ##TMP_20180508185054_CODEGEN_ECPRV6_ADS_imp_1_OUT ([KEY], imputer_output_2, imputer_output_3, imputer_output_4, imputer_output_5) SELECT [ADS_imp_1_OUT].[KEY], [ADS_imp_1_OUT].imputer_output_2, [ADS_imp_1_OUT].imputer_output_3, [ADS_imp_1_OUT].imputer_output_4, [ADS_imp_1_OUT].imputer_output_5 
...
-- Code For temporary table ##TMP_20180508185054_CODEGEN_PHR5JQ_ADS_sca_2_OUT part 1. Create 


CREATE TABLE ##TMP_20180508185054_CODEGEN_PHR5JQ_ADS_sca_2_OUT (
	[KEY] BIGINT NULL, 
...
-- Code For temporary table ##TMP_20180508185054_CODEGEN_PHR5JQ_ADS_sca_2_OUT part 2. Populate

INSERT INTO ##TMP_20180508185054_CODEGEN_PHR5JQ_ADS_sca_2_OUT ([KEY], scaler_output_2, scaler_output_3, scaler_output_4, scaler_output_5) SELECT [ADS_sca_2_OUT].[KEY], [ADS_sca_2_OUT].scaler_output_2, [ADS_sca_2_OUT].scaler_output_3, [ADS_sca_2_OUT].scaler_output_4, [ADS_sca_2_OUT].scaler_output_5 
...
FROM ##TMP_20180508185054_CODEGEN_ECPRV6_ADS_imp_1_OUT AS [ADS_imp_1_OUT]) AS [ADS_sca_2_OUT]

-- Code For temporary table ##TMP_20180508185054_CODEGEN_92OB1U_Quantiles part 1. Create 


CREATE TABLE ##TMP_20180508185054_CODEGEN_92OB1U_Quantiles (
	[KEY] BIGINT NULL, 
...
-- Code For temporary table ##TMP_20180508185054_CODEGEN_92OB1U_Quantiles part 2. Populate
...
FROM ##TMP_20180508185054_CODEGEN_PHR5JQ_ADS_sca_2_OUT AS [ADS_sca_2_OUT]), 
[DT_node_data] AS 
...
WHERE u1.[Estimator] >= u2.[Estimator] AND u1.[KEY] = u2.[KEY] GROUP BY u1.[KEY], u1.est_index, u1.[Estimator], u1.[Weight]) AS [CW])
 INSERT INTO ##TMP_20180508185054_CODEGEN_92OB1U_Quantiles ([KEY], [Quantile]) SELECT [Quantiles].[KEY], [Quantiles].[Quantile] 
...
FROM ##TMP_20180508185054_CODEGEN_92OB1U_Quantiles AS [Quantiles]