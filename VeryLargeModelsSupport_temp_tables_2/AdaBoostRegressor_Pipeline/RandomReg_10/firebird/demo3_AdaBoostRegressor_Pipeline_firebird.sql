...
-- Code For temporary table TMP_20180508182113_CODEGEN_7BR8 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508182113_CODEGEN_7BR8" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20180508182113_CODEGEN_7BR8 part 2. Populate

INSERT INTO "TMP_20180508182113_CODEGEN_7BR8" ("KEY", impter_2, impter_3, impter_4, impter_5, impter_6, impter_7, impter_8, impter_9, impter_10, impter_11) SELECT "U"."KEY", "U".impter_2, "U".impter_3, "U".impter_4, "U".impter_5, "U".impter_6, "U".impter_7, "U".impter_8, "U".impter_9, "U".impter_10, "U".impter_11 
...
-- Code For temporary table TMP_20180508182113_CODEGEN_7BR8 part 3. Create Index 

CREATE INDEX "ix_TMP_20180508182113_C_58f5" ON "TMP_20180508182113_CODEGEN_7BR8" ("KEY")

-- Code For temporary table TMP_20180508182113_CODEGEN_ITKK part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508182113_CODEGEN_ITKK" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20180508182113_CODEGEN_ITKK part 2. Populate

INSERT INTO "TMP_20180508182113_CODEGEN_ITKK" ("KEY", scaler_2, scaler_3, scaler_4, scaler_5, scaler_6, scaler_7, scaler_8, scaler_9, scaler_10, scaler_11) SELECT "U"."KEY", "U".scaler_2, "U".scaler_3, "U".scaler_4, "U".scaler_5, "U".scaler_6, "U".scaler_7, "U".scaler_8, "U".scaler_9, "U".scaler_10, "U".scaler_11 
...
FROM "TMP_20180508182113_CODEGEN_7BR8" AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT") AS "U"

-- Code For temporary table TMP_20180508182113_CODEGEN_ITKK part 3. Create Index 

CREATE INDEX "ix_TMP_20180508182113_C_fc66" ON "TMP_20180508182113_CODEGEN_ITKK" ("KEY")

-- Code For temporary table TMP_20180508182113_CODEGEN_BJ1Y part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508182113_CODEGEN_BJ1Y" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20180508182113_CODEGEN_BJ1Y part 2. Populate

INSERT INTO "TMP_20180508182113_CODEGEN_BJ1Y" ("KEY", "Quantile") SELECT "U"."KEY", "U"."Quantile" 
...
FROM "TMP_20180508182113_CODEGEN_ITKK" AS "ADS_sca_2_OUT"), 
"DT_node_data" AS 
(SELECT "Values".nid AS nid, CAST("Values"."E" AS DOUBLE PRECISION) AS "E" 
FROM (SELECT 3 AS nid, -258.78967128195916 AS "E" FROM rdb$database UNION ALL SELECT 4 AS nid, -459.030670753418 AS "E" FROM rdb$database UNION ALL SELECT 5 AS nid, 8.923656244969493 AS "E" FROM rdb$database UNION ALL SELECT 8 AS nid, -33.68318489379449 AS "E" FROM rdb$database UNION ALL SELECT 9 AS nid, 331.1703574482745 AS "E" FROM rdb$database UNION ALL SELECT 11 AS nid, -67.71218597426643 AS "E" FROM rdb$database UNION ALL SELECT 12 AS nid, 237.42844372247995 AS "E" FROM rdb$database) AS "Values"), 
"DT_Output" AS 
...
"DT_node_data_1" AS 
(SELECT "Values".nid AS nid, CAST("Values"."E" AS DOUBLE PRECISION) AS "E" 
FROM (SELECT 3 AS nid, -275.3140245822599 AS "E" FROM rdb$database UNION ALL SELECT 4 AS nid, -51.978296973080745 AS "E" FROM rdb$database UNION ALL SELECT 6 AS nid, -5.071250740277515 AS "E" FROM rdb$database UNION ALL SELECT 7 AS nid, 233.69717607109223 AS "E" FROM rdb$database UNION ALL SELECT 10 AS nid, -3.5129502029338977 AS "E" FROM rdb$database UNION ALL SELECT 11 AS nid, 188.04997667771173 AS "E" FROM rdb$database UNION ALL SELECT 13 AS nid, 140.41860719645143 AS "E" FROM rdb$database UNION ALL SELECT 14 AS nid, 315.516499408182 AS "E" FROM rdb$database) AS "Values"), 
"DT_Output_1" AS 
...
"DT_node_data_2" AS 
(SELECT "Values".nid AS nid, CAST("Values"."E" AS DOUBLE PRECISION) AS "E" 
FROM (SELECT 3 AS nid, -275.71317374560243 AS "E" FROM rdb$database UNION ALL SELECT 4 AS nid, -67.71218597426643 AS "E" FROM rdb$database UNION ALL SELECT 6 AS nid, 55.116699007890816 AS "E" FROM rdb$database UNION ALL SELECT 7 AS nid, -155.93422584455163 AS "E" FROM rdb$database UNION ALL SELECT 10 AS nid, -147.53184050315582 AS "E" FROM rdb$database UNION ALL SELECT 11 AS nid, 58.68288409772242 AS "E" FROM rdb$database UNION ALL SELECT 13 AS nid, 18.952518951698984 AS "E" FROM rdb$database UNION ALL SELECT 14 AS nid, 306.8298344890547 AS "E" FROM rdb$database) AS "Values"), 
"DT_Output_2" AS 
...
"DT_node_data_3" AS 
(SELECT "Values".nid AS nid, CAST("Values"."E" AS DOUBLE PRECISION) AS "E" 
FROM (SELECT 3 AS nid, -372.6097926421876 AS "E" FROM rdb$database UNION ALL SELECT 4 AS nid, -179.49806119548728 AS "E" FROM rdb$database UNION ALL SELECT 6 AS nid, 0.03464252446700726 AS "E" FROM rdb$database UNION ALL SELECT 7 AS nid, 148.5689639947692 AS "E" FROM rdb$database UNION ALL SELECT 10 AS nid, -176.44474023597397 AS "E" FROM rdb$database UNION ALL SELECT 11 AS nid, 235.3201708856319 AS "E" FROM rdb$database UNION ALL SELECT 13 AS nid, 115.83390653339242 AS "E" FROM rdb$database UNION ALL SELECT 14 AS nid, 330.130452304522 AS "E" FROM rdb$database) AS "Values"), 
"DT_Output_3" AS 
...
"DT_node_data_4" AS 
(SELECT "Values".nid AS nid, CAST("Values"."E" AS DOUBLE PRECISION) AS "E" 
FROM (SELECT 3 AS nid, -301.15376029685405 AS "E" FROM rdb$database UNION ALL SELECT 4 AS nid, -93.46844419820344 AS "E" FROM rdb$database UNION ALL SELECT 6 AS nid, -154.42942193202822 AS "E" FROM rdb$database UNION ALL SELECT 7 AS nid, 17.44341606264206 AS "E" FROM rdb$database UNION ALL SELECT 10 AS nid, -124.78009971471862 AS "E" FROM rdb$database UNION ALL SELECT 11 AS nid, 156.15648867007823 AS "E" FROM rdb$database UNION ALL SELECT 13 AS nid, -19.539222936443657 AS "E" FROM rdb$database UNION ALL SELECT 14 AS nid, 291.82620425110474 AS "E" FROM rdb$database) AS "Values"), 
"DT_Output_4" AS 
...
"DT_node_data_5" AS 
(SELECT "Values".nid AS nid, CAST("Values"."E" AS DOUBLE PRECISION) AS "E" 
FROM (SELECT 3 AS nid, -362.55766377741224 AS "E" FROM rdb$database UNION ALL SELECT 4 AS nid, -123.46523883145976 AS "E" FROM rdb$database UNION ALL SELECT 6 AS nid, -83.13715970079957 AS "E" FROM rdb$database UNION ALL SELECT 7 AS nid, 159.17936544144126 AS "E" FROM rdb$database UNION ALL SELECT 10 AS nid, -9.185160907179679 AS "E" FROM rdb$database UNION ALL SELECT 11 AS nid, 38.71263785211542 AS "E" FROM rdb$database UNION ALL SELECT 13 AS nid, 447.6909835452225 AS "E" FROM rdb$database UNION ALL SELECT 14 AS nid, 303.7602778573214 AS "E" FROM rdb$database) AS "Values"), 
"DT_Output_5" AS 
...
"DT_node_data_6" AS 
(SELECT "Values".nid AS nid, CAST("Values"."E" AS DOUBLE PRECISION) AS "E" 
FROM (SELECT 3 AS nid, -417.8058837771809 AS "E" FROM rdb$database UNION ALL SELECT 4 AS nid, -207.36981530703343 AS "E" FROM rdb$database UNION ALL SELECT 6 AS nid, -29.491925297145684 AS "E" FROM rdb$database UNION ALL SELECT 7 AS nid, 230.62947658635767 AS "E" FROM rdb$database UNION ALL SELECT 10 AS nid, -9.823581784704684 AS "E" FROM rdb$database UNION ALL SELECT 11 AS nid, 202.84876027465583 AS "E" FROM rdb$database UNION ALL SELECT 13 AS nid, 290.8432010120758 AS "E" FROM rdb$database UNION ALL SELECT 14 AS nid, 458.36306104498453 AS "E" FROM rdb$database) AS "Values"), 
"DT_Output_6" AS 
...
"DT_node_data_7" AS 
(SELECT "Values".nid AS nid, CAST("Values"."E" AS DOUBLE PRECISION) AS "E" 
FROM (SELECT 3 AS nid, -301.78584225936794 AS "E" FROM rdb$database UNION ALL SELECT 4 AS nid, -74.26631713904239 AS "E" FROM rdb$database UNION ALL SELECT 6 AS nid, -22.154561867405427 AS "E" FROM rdb$database UNION ALL SELECT 7 AS nid, 171.3986356876689 AS "E" FROM rdb$database UNION ALL SELECT 10 AS nid, 116.8891961793557 AS "E" FROM rdb$database UNION ALL SELECT 11 AS nid, 243.63801061508232 AS "E" FROM rdb$database UNION ALL SELECT 13 AS nid, 447.6909835452225 AS "E" FROM rdb$database UNION ALL SELECT 14 AS nid, 331.09987338331797 AS "E" FROM rdb$database) AS "Values"), 
"DT_Output_7" AS 
...
"DT_node_data_8" AS 
(SELECT "Values".nid AS nid, CAST("Values"."E" AS DOUBLE PRECISION) AS "E" 
FROM (SELECT 3 AS nid, -213.20347714113592 AS "E" FROM rdb$database UNION ALL SELECT 4 AS nid, -63.814558671282754 AS "E" FROM rdb$database UNION ALL SELECT 6 AS nid, 198.97164294103214 AS "E" FROM rdb$database UNION ALL SELECT 7 AS nid, 376.9384086101691 AS "E" FROM rdb$database UNION ALL SELECT 10 AS nid, 144.424454256417 AS "E" FROM rdb$database UNION ALL SELECT 11 AS nid, -32.93760686572384 AS "E" FROM rdb$database UNION ALL SELECT 13 AS nid, 212.77017134367168 AS "E" FROM rdb$database UNION ALL SELECT 14 AS nid, 376.7944341234486 AS "E" FROM rdb$database) AS "Values"), 
"DT_Output_8" AS 
...
"DT_node_data_9" AS 
(SELECT "Values".nid AS nid, CAST("Values"."E" AS DOUBLE PRECISION) AS "E" 
FROM (SELECT 3 AS nid, -459.03067075341806 AS "E" FROM rdb$database UNION ALL SELECT 4 AS nid, -273.12284471942644 AS "E" FROM rdb$database UNION ALL SELECT 6 AS nid, -20.4235287408218 AS "E" FROM rdb$database UNION ALL SELECT 7 AS nid, 58.56592202346141 AS "E" FROM rdb$database UNION ALL SELECT 10 AS nid, -252.2686492152819 AS "E" FROM rdb$database UNION ALL SELECT 11 AS nid, 78.77562259059067 AS "E" FROM rdb$database UNION ALL SELECT 13 AS nid, 202.90753073398878 AS "E" FROM rdb$database UNION ALL SELECT 14 AS nid, 428.2582628618327 AS "E" FROM rdb$database) AS "Values"), 
"DT_Output_9" AS 
...
"DT_node_data_10" AS 
(SELECT "Values".nid AS nid, CAST("Values"."E" AS DOUBLE PRECISION) AS "E" 
FROM (SELECT 3 AS nid, -375.1539668400623 AS "E" FROM rdb$database UNION ALL SELECT 4 AS nid, -189.8018001744999 AS "E" FROM rdb$database UNION ALL SELECT 5 AS nid, 325.0738816201826 AS "E" FROM rdb$database UNION ALL SELECT 8 AS nid, -74.16411287704308 AS "E" FROM rdb$database UNION ALL SELECT 9 AS nid, 215.34737912146102 AS "E" FROM rdb$database UNION ALL SELECT 11 AS nid, 153.17367712046337 AS "E" FROM rdb$database UNION ALL SELECT 12 AS nid, 358.7357714280424 AS "E" FROM rdb$database) AS "Values"), 
"DT_Output_10" AS 
...
"DT_node_data_11" AS 
(SELECT "Values".nid AS nid, CAST("Values"."E" AS DOUBLE PRECISION) AS "E" 
FROM (SELECT 3 AS nid, -319.80183820518755 AS "E" FROM rdb$database UNION ALL SELECT 4 AS nid, -446.8172118364044 AS "E" FROM rdb$database UNION ALL SELECT 6 AS nid, -266.8202258688374 AS "E" FROM rdb$database UNION ALL SELECT 7 AS nid, -154.01730507475207 AS "E" FROM rdb$database UNION ALL SELECT 10 AS nid, -155.09122813008221 AS "E" FROM rdb$database UNION ALL SELECT 11 AS nid, 101.90332661789155 AS "E" FROM rdb$database UNION ALL SELECT 13 AS nid, 183.70759149944826 AS "E" FROM rdb$database UNION ALL SELECT 14 AS nid, 409.420212416183 AS "E" FROM rdb$database) AS "Values"), 
"DT_Output_11" AS 
...
"DT_node_data_12" AS 
(SELECT "Values".nid AS nid, CAST("Values"."E" AS DOUBLE PRECISION) AS "E" 
FROM (SELECT 3 AS nid, -264.3179172951439 AS "E" FROM rdb$database UNION ALL SELECT 4 AS nid, -459.030670753418 AS "E" FROM rdb$database UNION ALL SELECT 6 AS nid, -26.880271737136272 AS "E" FROM rdb$database UNION ALL SELECT 7 AS nid, 58.56592202346141 AS "E" FROM rdb$database UNION ALL SELECT 10 AS nid, -47.128289538683944 AS "E" FROM rdb$database UNION ALL SELECT 11 AS nid, 216.12984346020096 AS "E" FROM rdb$database UNION ALL SELECT 13 AS nid, 260.80290006208634 AS "E" FROM rdb$database UNION ALL SELECT 14 AS nid, 462.9873729049727 AS "E" FROM rdb$database) AS "Values"), 
"DT_Output_12" AS 
...
"DT_node_data_13" AS 
(SELECT "Values".nid AS nid, CAST("Values"."E" AS DOUBLE PRECISION) AS "E" 
FROM (SELECT 3 AS nid, -326.10198511368253 AS "E" FROM rdb$database UNION ALL SELECT 4 AS nid, -181.5117298102302 AS "E" FROM rdb$database UNION ALL SELECT 6 AS nid, -8.897965018937406 AS "E" FROM rdb$database UNION ALL SELECT 7 AS nid, 351.37130796411674 AS "E" FROM rdb$database UNION ALL SELECT 10 AS nid, 19.841626270219137 AS "E" FROM rdb$database UNION ALL SELECT 11 AS nid, 259.01559019368403 AS "E" FROM rdb$database UNION ALL SELECT 13 AS nid, 314.2194981103516 AS "E" FROM rdb$database UNION ALL SELECT 14 AS nid, 479.70721604450864 AS "E" FROM rdb$database) AS "Values"), 
"DT_Output_13" AS 
...
"DT_node_data_14" AS 
(SELECT "Values".nid AS nid, CAST("Values"."E" AS DOUBLE PRECISION) AS "E" 
FROM (SELECT 3 AS nid, -353.6403522160441 AS "E" FROM rdb$database UNION ALL SELECT 4 AS nid, -165.23670331580712 AS "E" FROM rdb$database UNION ALL SELECT 6 AS nid, -9.617958070006466 AS "E" FROM rdb$database UNION ALL SELECT 7 AS nid, 211.2028693831088 AS "E" FROM rdb$database UNION ALL SELECT 10 AS nid, -111.96115355506403 AS "E" FROM rdb$database UNION ALL SELECT 11 AS nid, 182.9121411176754 AS "E" FROM rdb$database UNION ALL SELECT 13 AS nid, 459.6970707324548 AS "E" FROM rdb$database UNION ALL SELECT 14 AS nid, 235.3201708856319 AS "E" FROM rdb$database) AS "Values"), 
"DT_Output_14" AS 
...
"DT_node_data_15" AS 
(SELECT "Values".nid AS nid, CAST("Values"."E" AS DOUBLE PRECISION) AS "E" 
FROM (SELECT 3 AS nid, -350.4849793104147 AS "E" FROM rdb$database UNION ALL SELECT 4 AS nid, -136.46667135000865 AS "E" FROM rdb$database UNION ALL SELECT 6 AS nid, -85.8354336830041 AS "E" FROM rdb$database UNION ALL SELECT 7 AS nid, 184.7984725101791 AS "E" FROM rdb$database UNION ALL SELECT 10 AS nid, -24.728024071698115 AS "E" FROM rdb$database UNION ALL SELECT 11 AS nid, -101.20974879377152 AS "E" FROM rdb$database UNION ALL SELECT 13 AS nid, 60.83005801950535 AS "E" FROM rdb$database UNION ALL SELECT 14 AS nid, 361.888983724582 AS "E" FROM rdb$database) AS "Values"), 
"DT_Output_15" AS 
...
-- Code For temporary table TMP_20180508182113_CODEGEN_BJ1Y part 3. Create Index 

CREATE INDEX "ix_TMP_20180508182113_C_7393" ON "TMP_20180508182113_CODEGEN_BJ1Y" ("KEY")

-- Model deployment code

SELECT "Quantiles"."KEY" AS "KEY", "Quantiles"."Quantile" AS "Estimator" 
FROM "TMP_20180508182113_CODEGEN_BJ1Y" AS "Quantiles"