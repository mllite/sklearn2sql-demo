...
-- Code For temporary table TMP_20180508184850_CODEGEN_03PB part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508184850_CODEGEN_03PB" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20180508184850_CODEGEN_03PB part 2. Populate

INSERT INTO "TMP_20180508184850_CODEGEN_03PB" ("KEY", imputer_output_2, imputer_output_3, imputer_output_4, imputer_output_5) SELECT "U"."KEY", "U".imputer_output_2, "U".imputer_output_3, "U".imputer_output_4, "U".imputer_output_5 
...
-- Code For temporary table TMP_20180508184850_CODEGEN_03PB part 3. Create Index 

CREATE INDEX "ix_TMP_20180508184850_C_7e99" ON "TMP_20180508184850_CODEGEN_03PB" ("KEY")

-- Code For temporary table TMP_20180508184850_CODEGEN_Y3TC part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508184850_CODEGEN_Y3TC" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20180508184850_CODEGEN_Y3TC part 2. Populate

INSERT INTO "TMP_20180508184850_CODEGEN_Y3TC" ("KEY", scaler_output_2, scaler_output_3, scaler_output_4, scaler_output_5) SELECT "U"."KEY", "U".scaler_output_2, "U".scaler_output_3, "U".scaler_output_4, "U".scaler_output_5 
...
FROM "TMP_20180508184850_CODEGEN_03PB" AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT") AS "U"

-- Code For temporary table TMP_20180508184850_CODEGEN_Y3TC part 3. Create Index 

CREATE INDEX "ix_TMP_20180508184850_C_2b75" ON "TMP_20180508184850_CODEGEN_Y3TC" ("KEY")

-- Code For temporary table TMP_20180508184850_CODEGEN_GCIY part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508184850_CODEGEN_GCIY" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20180508184850_CODEGEN_GCIY part 2. Populate

INSERT INTO "TMP_20180508184850_CODEGEN_GCIY" ("KEY", "NEUR_1_1", "NEUR_1_2", "NEUR_1_3") SELECT "U"."KEY", "U"."NEUR_1_1", "U"."NEUR_1_2", "U"."NEUR_1_3" 
FROM (WITH "IL" AS 
...
FROM "TMP_20180508184850_CODEGEN_Y3TC" AS "ADS_sca_2_OUT"), 
"HL_BA_1" AS 
...
-- Code For temporary table TMP_20180508184850_CODEGEN_GCIY part 3. Create Index 

CREATE INDEX "ix_TMP_20180508184850_C_e2ad" ON "TMP_20180508184850_CODEGEN_GCIY" ("KEY")

-- Code For temporary table TMP_20180508184850_CODEGEN_DVJ7 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508184850_CODEGEN_DVJ7" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20180508184850_CODEGEN_DVJ7 part 2. Populate

INSERT INTO "TMP_20180508184850_CODEGEN_DVJ7" ("KEY", "NEUR_3_1") SELECT "U"."KEY", "U"."NEUR_3_1" 
...
FROM "TMP_20180508184850_CODEGEN_GCIY" AS "HL_1_relu_1"), 
"HL_2_relu" AS 
...
-- Code For temporary table TMP_20180508184850_CODEGEN_DVJ7 part 3. Create Index 

CREATE INDEX "ix_TMP_20180508184850_C_9f24" ON "TMP_20180508184850_CODEGEN_DVJ7" ("KEY")

-- Model deployment code

SELECT "OL_identity_1"."KEY" AS "KEY", "OL_identity_1"."NEUR_3_1" AS "Estimator" 
FROM "TMP_20180508184850_CODEGEN_DVJ7" AS "OL_identity_1"