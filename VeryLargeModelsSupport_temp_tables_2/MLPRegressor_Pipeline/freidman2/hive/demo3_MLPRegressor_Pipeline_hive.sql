...
-- Code For temporary table tmp_20180509004152_codegen_bwadl7_ads_imp_1_out part 1. Create 

CREATE TEMPORARY TABLE `tmp_20180509004152_codegen_bwadl7_ads_imp_1_out` STORED AS ORC AS SELECT `ADS_imp_1_OUT`.`KEY`, `ADS_imp_1_OUT`.`imputer_output_2`, `ADS_imp_1_OUT`.`imputer_output_3`, `ADS_imp_1_OUT`.`imputer_output_4`, `ADS_imp_1_OUT`.`imputer_output_5` 
...
-- Code For temporary table tmp_20180509004152_codegen_bwadl7_ads_imp_1_out part 2. Populate

SELECT * FROM `tmp_20180509004152_codegen_bwadl7_ads_imp_1_out`

-- Code For temporary table tmp_20180509004152_codegen_9nc2fv_ads_sca_2_out part 1. Create 

CREATE TEMPORARY TABLE `tmp_20180509004152_codegen_9nc2fv_ads_sca_2_out` STORED AS ORC AS SELECT `ADS_sca_2_OUT`.`KEY`, `ADS_sca_2_OUT`.`scaler_output_2`, `ADS_sca_2_OUT`.`scaler_output_3`, `ADS_sca_2_OUT`.`scaler_output_4`, `ADS_sca_2_OUT`.`scaler_output_5` 
...
FROM `tmp_20180509004152_codegen_bwadl7_ads_imp_1_out` AS `ADS_imp_1_OUT`) AS `ADS_sca_2_OUT`

-- Code For temporary table tmp_20180509004152_codegen_9nc2fv_ads_sca_2_out part 2. Populate

SELECT * FROM `tmp_20180509004152_codegen_9nc2fv_ads_sca_2_out`

-- Code For temporary table tmp_20180509004152_codegen_dq8d6i_hl_1_relu_1 part 1. Create 

CREATE TEMPORARY TABLE `tmp_20180509004152_codegen_dq8d6i_hl_1_relu_1` STORED AS ORC AS WITH `IL` AS 
...
FROM `tmp_20180509004152_codegen_9nc2fv_ads_sca_2_out` AS `ADS_sca_2_OUT`), 
`HL_BA_1` AS 
...
-- Code For temporary table tmp_20180509004152_codegen_dq8d6i_hl_1_relu_1 part 2. Populate

SELECT * FROM `tmp_20180509004152_codegen_dq8d6i_hl_1_relu_1`

-- Code For temporary table tmp_20180509004152_codegen_q7ah3f_ol_identity_1 part 1. Create 

CREATE TEMPORARY TABLE `tmp_20180509004152_codegen_q7ah3f_ol_identity_1` STORED AS ORC AS WITH `HL_BA_2` AS 
...
FROM `tmp_20180509004152_codegen_dq8d6i_hl_1_relu_1` AS `HL_1_relu_1`), 
`HL_2_relu` AS 
...
-- Code For temporary table tmp_20180509004152_codegen_q7ah3f_ol_identity_1 part 2. Populate

SELECT * FROM `tmp_20180509004152_codegen_q7ah3f_ol_identity_1`

-- Model deployment code

SELECT `OL_identity_1`.`KEY` AS `KEY`, `OL_identity_1`.`NEUR_3_1` AS `Estimator` 
FROM `tmp_20180509004152_codegen_q7ah3f_ol_identity_1` AS `OL_identity_1`