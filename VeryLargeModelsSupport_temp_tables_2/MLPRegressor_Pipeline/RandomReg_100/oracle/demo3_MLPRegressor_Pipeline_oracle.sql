...
-- Code For temporary table DEGEN_Y8VR23_ADS_IMP_1_OUT part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "DEGEN_Y8VR23_ADS_IMP_1_OUT" (
	"KEY" NUMBER(19), 
...
-- Code For temporary table DEGEN_GW124H_ADS_SCA_2_OUT part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "DEGEN_GW124H_ADS_SCA_2_OUT" (
	"KEY" NUMBER(19), 
...
FROM "DEGEN_Y8VR23_ADS_IMP_1_OUT" "ADS_imp_1_OUT") "ADS_sca_2_OUT") "U"

-- Code For temporary table CODEGEN_7EA2IQ_HL_1_RELU_1 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "CODEGEN_7EA2IQ_HL_1_RELU_1" (
	"KEY" NUMBER(19), 
...
-- Code For temporary table CODEGEN_7EA2IQ_HL_1_RELU_1 part 2. Populate

INSERT INTO "CODEGEN_7EA2IQ_HL_1_RELU_1" ("KEY", "NEUR_1_1", "NEUR_1_2", "NEUR_1_3") SELECT "U"."KEY", "U"."NEUR_1_1", "U"."NEUR_1_2", "U"."NEUR_1_3" 
FROM (WITH "IL" AS 
...
FROM "DEGEN_GW124H_ADS_SCA_2_OUT" "ADS_sca_2_OUT"), 
"HL_BA_1" AS 
...
-- Code For temporary table DEGEN_CXMXNX_OL_IDENTITY_1 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "DEGEN_CXMXNX_OL_IDENTITY_1" (
	"KEY" NUMBER(19), 
...
-- Code For temporary table DEGEN_CXMXNX_OL_IDENTITY_1 part 2. Populate

INSERT INTO "DEGEN_CXMXNX_OL_IDENTITY_1" ("KEY", "NEUR_3_1") SELECT "U"."KEY", "U"."NEUR_3_1" 
...
FROM "CODEGEN_7EA2IQ_HL_1_RELU_1" "HL_1_relu_1"), 
"HL_2_relu" AS 
...
FROM "DEGEN_CXMXNX_OL_IDENTITY_1" "OL_identity_1"