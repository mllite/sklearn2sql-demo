...
-- Code For temporary table TMP_20180508182641_CODEGEN_SFVX part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508182641_CODEGEN_SFVX" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20180508182641_CODEGEN_SFVX part 3. Create Index 

CREATE INDEX "ix_TMP_20180508182641_C_fa0d" ON "TMP_20180508182641_CODEGEN_SFVX" ("KEY")

-- Code For temporary table TMP_20180508182641_CODEGEN_K0WO part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508182641_CODEGEN_K0WO" (
	"KEY" BIGINT NOT NULL, 
...
FROM "TMP_20180508182641_CODEGEN_SFVX" AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT") AS "U"

-- Code For temporary table TMP_20180508182641_CODEGEN_K0WO part 3. Create Index 

CREATE INDEX "ix_TMP_20180508182641_C_8b34" ON "TMP_20180508182641_CODEGEN_K0WO" ("KEY")

-- Code For temporary table TMP_20180508182641_CODEGEN_ZU39 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508182641_CODEGEN_ZU39" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20180508182641_CODEGEN_ZU39 part 2. Populate

INSERT INTO "TMP_20180508182641_CODEGEN_ZU39" ("KEY", "NEUR_1_1", "NEUR_1_2", "NEUR_1_3") SELECT "U"."KEY", "U"."NEUR_1_1", "U"."NEUR_1_2", "U"."NEUR_1_3" 
FROM (WITH "IL" AS 
...
FROM "TMP_20180508182641_CODEGEN_K0WO" AS "ADS_sca_2_OUT"), 
"HL_BA_1" AS 
...
-- Code For temporary table TMP_20180508182641_CODEGEN_ZU39 part 3. Create Index 

CREATE INDEX "ix_TMP_20180508182641_C_4d4d" ON "TMP_20180508182641_CODEGEN_ZU39" ("KEY")

-- Code For temporary table TMP_20180508182641_CODEGEN_L23B part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508182641_CODEGEN_L23B" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20180508182641_CODEGEN_L23B part 2. Populate

INSERT INTO "TMP_20180508182641_CODEGEN_L23B" ("KEY", "NEUR_3_1") SELECT "U"."KEY", "U"."NEUR_3_1" 
...
FROM "TMP_20180508182641_CODEGEN_ZU39" AS "HL_1_relu_1"), 
"HL_2_relu" AS 
...
-- Code For temporary table TMP_20180508182641_CODEGEN_L23B part 3. Create Index 

CREATE INDEX "ix_TMP_20180508182641_C_357a" ON "TMP_20180508182641_CODEGEN_L23B" ("KEY")

-- Model deployment code

SELECT "OL_identity_1"."KEY" AS "KEY", "OL_identity_1"."NEUR_3_1" AS "Estimator" 
FROM "TMP_20180508182641_CODEGEN_L23B" AS "OL_identity_1"