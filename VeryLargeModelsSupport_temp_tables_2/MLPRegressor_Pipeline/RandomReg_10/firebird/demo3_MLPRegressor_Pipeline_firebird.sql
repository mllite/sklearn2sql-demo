...
-- Code For temporary table TMP_20180508182249_CODEGEN_5IX1 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508182249_CODEGEN_5IX1" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20180508182249_CODEGEN_5IX1 part 2. Populate

INSERT INTO "TMP_20180508182249_CODEGEN_5IX1" ("KEY", impter_2, impter_3, impter_4, impter_5, impter_6, impter_7, impter_8, impter_9, impter_10, impter_11) SELECT "U"."KEY", "U".impter_2, "U".impter_3, "U".impter_4, "U".impter_5, "U".impter_6, "U".impter_7, "U".impter_8, "U".impter_9, "U".impter_10, "U".impter_11 
...
-- Code For temporary table TMP_20180508182249_CODEGEN_5IX1 part 3. Create Index 

CREATE INDEX "ix_TMP_20180508182249_C_5564" ON "TMP_20180508182249_CODEGEN_5IX1" ("KEY")

-- Code For temporary table TMP_20180508182249_CODEGEN_2DZC part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508182249_CODEGEN_2DZC" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20180508182249_CODEGEN_2DZC part 2. Populate

INSERT INTO "TMP_20180508182249_CODEGEN_2DZC" ("KEY", scaler_2, scaler_3, scaler_4, scaler_5, scaler_6, scaler_7, scaler_8, scaler_9, scaler_10, scaler_11) SELECT "U"."KEY", "U".scaler_2, "U".scaler_3, "U".scaler_4, "U".scaler_5, "U".scaler_6, "U".scaler_7, "U".scaler_8, "U".scaler_9, "U".scaler_10, "U".scaler_11 
...
FROM "TMP_20180508182249_CODEGEN_5IX1" AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT") AS "U"

-- Code For temporary table TMP_20180508182249_CODEGEN_2DZC part 3. Create Index 

CREATE INDEX "ix_TMP_20180508182249_C_9f34" ON "TMP_20180508182249_CODEGEN_2DZC" ("KEY")

-- Code For temporary table TMP_20180508182249_CODEGEN_2V9U part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508182249_CODEGEN_2V9U" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20180508182249_CODEGEN_2V9U part 2. Populate

INSERT INTO "TMP_20180508182249_CODEGEN_2V9U" ("KEY", "NEUR_1_1", "NEUR_1_2", "NEUR_1_3") SELECT "U"."KEY", "U"."NEUR_1_1", "U"."NEUR_1_2", "U"."NEUR_1_3" 
FROM (WITH "IL" AS 
...
FROM "TMP_20180508182249_CODEGEN_2DZC" AS "ADS_sca_2_OUT"), 
"HL_BA_1" AS 
...
-- Code For temporary table TMP_20180508182249_CODEGEN_2V9U part 3. Create Index 

CREATE INDEX "ix_TMP_20180508182249_C_e73f" ON "TMP_20180508182249_CODEGEN_2V9U" ("KEY")

-- Code For temporary table TMP_20180508182249_CODEGEN_W20Q part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508182249_CODEGEN_W20Q" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20180508182249_CODEGEN_W20Q part 2. Populate

INSERT INTO "TMP_20180508182249_CODEGEN_W20Q" ("KEY", "NEUR_3_1") SELECT "U"."KEY", "U"."NEUR_3_1" 
...
FROM "TMP_20180508182249_CODEGEN_2V9U" AS "HL_1_relu_1"), 
"HL_2_relu" AS 
...
-- Code For temporary table TMP_20180508182249_CODEGEN_W20Q part 3. Create Index 

CREATE INDEX "ix_TMP_20180508182249_C_1dbb" ON "TMP_20180508182249_CODEGEN_W20Q" ("KEY")

-- Model deployment code

SELECT "OL_identity_1"."KEY" AS "KEY", "OL_identity_1"."NEUR_3_1" AS "Estimator" 
FROM "TMP_20180508182249_CODEGEN_W20Q" AS "OL_identity_1"