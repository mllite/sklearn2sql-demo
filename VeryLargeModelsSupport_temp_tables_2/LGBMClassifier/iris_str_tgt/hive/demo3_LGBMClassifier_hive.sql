...
-- Code For temporary table tmp_20180509004931_codegen_x9oywi_lgbm_b0 part 1. Create 

CREATE TEMPORARY TABLE `tmp_20180509004931_codegen_x9oywi_lgbm_b0` STORED AS ORC AS WITH `DT_node_lookup` AS 
...
-- Code For temporary table tmp_20180509004931_codegen_x9oywi_lgbm_b0 part 2. Populate

SELECT * FROM `tmp_20180509004931_codegen_x9oywi_lgbm_b0`

-- Code For temporary table tmp_20180509004931_codegen_i2t336_lgbm_b1 part 1. Create 

CREATE TEMPORARY TABLE `tmp_20180509004931_codegen_i2t336_lgbm_b1` STORED AS ORC AS WITH `DT_node_lookup_10` AS 
...
-- Code For temporary table tmp_20180509004931_codegen_i2t336_lgbm_b1 part 2. Populate

SELECT * FROM `tmp_20180509004931_codegen_i2t336_lgbm_b1`

-- Code For temporary table tmp_20180509004931_codegen_2bglu2_lgbm_b2 part 1. Create 

CREATE TEMPORARY TABLE `tmp_20180509004931_codegen_2bglu2_lgbm_b2` STORED AS ORC AS WITH `DT_node_lookup_20` AS 
...
-- Code For temporary table tmp_20180509004931_codegen_2bglu2_lgbm_b2 part 2. Populate

SELECT * FROM `tmp_20180509004931_codegen_2bglu2_lgbm_b2`

-- Code For temporary table tmp_20180509004931_codegen_25dys5_lgbm_b3 part 1. Create 

CREATE TEMPORARY TABLE `tmp_20180509004931_codegen_25dys5_lgbm_b3` STORED AS ORC AS WITH `DT_node_lookup_30` AS 
...
-- Code For temporary table tmp_20180509004931_codegen_25dys5_lgbm_b3 part 2. Populate

SELECT * FROM `tmp_20180509004931_codegen_25dys5_lgbm_b3`

-- Code For temporary table tmp_20180509004931_codegen_3f43fs_lgbm_b4 part 1. Create 

CREATE TEMPORARY TABLE `tmp_20180509004931_codegen_3f43fs_lgbm_b4` STORED AS ORC AS WITH `DT_node_lookup_40` AS 
...
-- Code For temporary table tmp_20180509004931_codegen_3f43fs_lgbm_b4 part 2. Populate

SELECT * FROM `tmp_20180509004931_codegen_3f43fs_lgbm_b4`

-- Code For temporary table tmp_20180509004931_codegen_giaxbl_lgbm_union part 1. Create 

CREATE TEMPORARY TABLE `tmp_20180509004931_codegen_giaxbl_lgbm_union` STORED AS ORC AS SELECT `LGBM_Union`.`KEY`, `LGBM_Union`.`Score_CLASS_0`, `LGBM_Union`.`Score_CLASS_1`, `LGBM_Union`.`Score_CLASS_2` 
...
FROM `tmp_20180509004931_codegen_x9oywi_lgbm_b0` AS `LGBM_B0` UNION ALL SELECT `LGBM_B1`.`KEY` AS `KEY`, `LGBM_B1`.`Score_CLASS_0` AS `Score_CLASS_0`, `LGBM_B1`.`Score_CLASS_1` AS `Score_CLASS_1`, `LGBM_B1`.`Score_CLASS_2` AS `Score_CLASS_2` 
FROM `tmp_20180509004931_codegen_i2t336_lgbm_b1` AS `LGBM_B1` UNION ALL SELECT `LGBM_B2`.`KEY` AS `KEY`, `LGBM_B2`.`Score_CLASS_0` AS `Score_CLASS_0`, `LGBM_B2`.`Score_CLASS_1` AS `Score_CLASS_1`, `LGBM_B2`.`Score_CLASS_2` AS `Score_CLASS_2` 
FROM `tmp_20180509004931_codegen_2bglu2_lgbm_b2` AS `LGBM_B2` UNION ALL SELECT `LGBM_B3`.`KEY` AS `KEY`, `LGBM_B3`.`Score_CLASS_0` AS `Score_CLASS_0`, `LGBM_B3`.`Score_CLASS_1` AS `Score_CLASS_1`, `LGBM_B3`.`Score_CLASS_2` AS `Score_CLASS_2` 
FROM `tmp_20180509004931_codegen_25dys5_lgbm_b3` AS `LGBM_B3` UNION ALL SELECT `LGBM_B4`.`KEY` AS `KEY`, `LGBM_B4`.`Score_CLASS_0` AS `Score_CLASS_0`, `LGBM_B4`.`Score_CLASS_1` AS `Score_CLASS_1`, `LGBM_B4`.`Score_CLASS_2` AS `Score_CLASS_2` 
FROM `tmp_20180509004931_codegen_3f43fs_lgbm_b4` AS `LGBM_B4`) AS `LGBM_EnsembleUnion`) AS `LGBM_Union`

-- Code For temporary table tmp_20180509004931_codegen_giaxbl_lgbm_union part 2. Populate

SELECT * FROM `tmp_20180509004931_codegen_giaxbl_lgbm_union`

-- Code For temporary table tmp_20180509004931_codegen_m3rcjw_lgbm_sum part 1. Create 

CREATE TEMPORARY TABLE `tmp_20180509004931_codegen_m3rcjw_lgbm_sum` STORED AS ORC AS SELECT `LGBM_sum`.`KEY`, `LGBM_sum`.`Score_CLASS_0`, `LGBM_sum`.`Score_CLASS_1`, `LGBM_sum`.`Score_CLASS_2` 
...
FROM `tmp_20180509004931_codegen_giaxbl_lgbm_union` AS `LGBM_Union` GROUP BY `LGBM_Union`.`KEY`) AS `T`) AS `LGBM_sum`

-- Code For temporary table tmp_20180509004931_codegen_m3rcjw_lgbm_sum part 2. Populate

SELECT * FROM `tmp_20180509004931_codegen_m3rcjw_lgbm_sum`
...
FROM `tmp_20180509004931_codegen_m3rcjw_lgbm_sum` AS `LGBM_sum`), 
