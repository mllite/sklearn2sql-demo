...
-- Code For temporary table tmp_20180508192158_codegen_ynt6vs_lgbm_b0 part 1. Create 


CREATE TABLE tmp_20180508192158_codegen_ynt6vs_lgbm_b0 (
	`KEY` BIGINT, 
	`Score_0` DOUBLE
)
...
-- Code For temporary table tmp_20180508192158_codegen_ynt6vs_lgbm_b0 part 2. Populate
...
FROM `DT_Output_9`)
 INSERT INTO tmp_20180508192158_codegen_ynt6vs_lgbm_b0 (`KEY`, `Score_0`) SELECT `LGBM_B0`.`KEY`, `LGBM_B0`.`Score_0` 
...
-- Code For temporary table tmp_20180508192158_codegen_0hy7i1_lgbm_b1 part 1. Create 


CREATE TABLE tmp_20180508192158_codegen_0hy7i1_lgbm_b1 (
	`KEY` BIGINT, 
	`Score_0` DOUBLE
)
...
-- Code For temporary table tmp_20180508192158_codegen_0hy7i1_lgbm_b1 part 2. Populate
...
FROM `DT_Output_15`)
 INSERT INTO tmp_20180508192158_codegen_0hy7i1_lgbm_b1 (`KEY`, `Score_0`) SELECT `LGBM_B1`.`KEY`, `LGBM_B1`.`Score_0` 
...
-- Code For temporary table tmp_20180508192158_codegen_aha125_lgbm_union part 1. Create 


CREATE TABLE tmp_20180508192158_codegen_aha125_lgbm_union (
	`KEY` BIGINT, 
	`Score_0` DOUBLE
)
...
-- Code For temporary table tmp_20180508192158_codegen_aha125_lgbm_union part 2. Populate

INSERT INTO tmp_20180508192158_codegen_aha125_lgbm_union (`KEY`, `Score_0`) SELECT `LGBM_Union`.`KEY`, `LGBM_Union`.`Score_0` 
...
FROM tmp_20180508192158_codegen_ynt6vs_lgbm_b0 AS `LGBM_B0` UNION ALL SELECT `LGBM_B1`.`KEY` AS `KEY`, `LGBM_B1`.`Score_0` AS `Score_0` 
FROM tmp_20180508192158_codegen_0hy7i1_lgbm_b1 AS `LGBM_B1`) AS `LGBM_EnsembleUnion`) AS `LGBM_Union`

-- Code For temporary table tmp_20180508192158_codegen_6e26h2_lgbm_sum part 1. Create 


CREATE TABLE tmp_20180508192158_codegen_6e26h2_lgbm_sum (
	`KEY` BIGINT, 
	`Score_0` DOUBLE
)
...
-- Code For temporary table tmp_20180508192158_codegen_6e26h2_lgbm_sum part 2. Populate

INSERT INTO tmp_20180508192158_codegen_6e26h2_lgbm_sum (`KEY`, `Score_0`) SELECT `LGBM_sum`.`KEY`, `LGBM_sum`.`Score_0` 
...
FROM tmp_20180508192158_codegen_aha125_lgbm_union AS `LGBM_Union` GROUP BY `LGBM_Union`.`KEY`) AS `T`) AS `LGBM_sum`
...
FROM tmp_20180508192158_codegen_6e26h2_lgbm_sum AS `LGBM_sum`), 
