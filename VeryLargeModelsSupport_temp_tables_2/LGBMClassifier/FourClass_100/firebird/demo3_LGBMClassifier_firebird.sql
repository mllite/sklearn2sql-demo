...
-- Code For temporary table TMP_20180508181749_CODEGEN_BUEE part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508181749_CODEGEN_BUEE" (
	"KEY" BIGINT, 
...
-- Code For temporary table TMP_20180508181749_CODEGEN_BUEE part 2. Populate

INSERT INTO "TMP_20180508181749_CODEGEN_BUEE" ("KEY", "Score_0", "Score_1", "Score_2", "Score_3") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1", "U"."Score_2", "U"."Score_3" 
...
-- Code For temporary table TMP_20180508181749_CODEGEN_MKOP part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508181749_CODEGEN_MKOP" (
	"KEY" BIGINT, 
	"Score_0" DOUBLE PRECISION, 
	"Score_1" DOUBLE PRECISION, 
	"Score_2" DOUBLE PRECISION, 
...
-- Code For temporary table TMP_20180508181749_CODEGEN_MKOP part 2. Populate

INSERT INTO "TMP_20180508181749_CODEGEN_MKOP" ("KEY", "Score_0", "Score_1", "Score_2", "Score_3") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1", "U"."Score_2", "U"."Score_3" 
...
-- Code For temporary table TMP_20180508181749_CODEGEN_ZSTN part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508181749_CODEGEN_ZSTN" (
	"KEY" BIGINT, 
	"Score_0" DOUBLE PRECISION, 
	"Score_1" DOUBLE PRECISION, 
	"Score_2" DOUBLE PRECISION, 
...
-- Code For temporary table TMP_20180508181749_CODEGEN_ZSTN part 2. Populate

INSERT INTO "TMP_20180508181749_CODEGEN_ZSTN" ("KEY", "Score_0", "Score_1", "Score_2", "Score_3") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1", "U"."Score_2", "U"."Score_3" 
...
-- Code For temporary table TMP_20180508181749_CODEGEN_NAG3 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508181749_CODEGEN_NAG3" (
	"KEY" BIGINT, 
	"Score_0" DOUBLE PRECISION, 
	"Score_1" DOUBLE PRECISION, 
	"Score_2" DOUBLE PRECISION, 
...
-- Code For temporary table TMP_20180508181749_CODEGEN_NAG3 part 2. Populate

INSERT INTO "TMP_20180508181749_CODEGEN_NAG3" ("KEY", "Score_0", "Score_1", "Score_2", "Score_3") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1", "U"."Score_2", "U"."Score_3" 
...
-- Code For temporary table TMP_20180508181749_CODEGEN_69DW part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508181749_CODEGEN_69DW" (
	"KEY" BIGINT, 
	"Score_0" DOUBLE PRECISION, 
	"Score_1" DOUBLE PRECISION, 
	"Score_2" DOUBLE PRECISION, 
...
-- Code For temporary table TMP_20180508181749_CODEGEN_69DW part 2. Populate

INSERT INTO "TMP_20180508181749_CODEGEN_69DW" ("KEY", "Score_0", "Score_1", "Score_2", "Score_3") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1", "U"."Score_2", "U"."Score_3" 
...
-- Code For temporary table TMP_20180508181749_CODEGEN_QIK7 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508181749_CODEGEN_QIK7" (
	"KEY" BIGINT, 
	"Score_0" DOUBLE PRECISION, 
	"Score_1" DOUBLE PRECISION, 
	"Score_2" DOUBLE PRECISION, 
...
-- Code For temporary table TMP_20180508181749_CODEGEN_QIK7 part 2. Populate

INSERT INTO "TMP_20180508181749_CODEGEN_QIK7" ("KEY", "Score_0", "Score_1", "Score_2", "Score_3") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1", "U"."Score_2", "U"."Score_3" 
...
-- Code For temporary table TMP_20180508181749_CODEGEN_0SJM part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508181749_CODEGEN_0SJM" (
	"KEY" BIGINT, 
	"Score_0" DOUBLE PRECISION, 
	"Score_1" DOUBLE PRECISION, 
	"Score_2" DOUBLE PRECISION, 
...
-- Code For temporary table TMP_20180508181749_CODEGEN_0SJM part 2. Populate

INSERT INTO "TMP_20180508181749_CODEGEN_0SJM" ("KEY", "Score_0", "Score_1", "Score_2", "Score_3") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1", "U"."Score_2", "U"."Score_3" 
...
-- Code For temporary table TMP_20180508181749_CODEGEN_7MJN part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508181749_CODEGEN_7MJN" (
	"KEY" BIGINT, 
	"Score_0" DOUBLE PRECISION, 
	"Score_1" DOUBLE PRECISION, 
	"Score_2" DOUBLE PRECISION, 
...
-- Code For temporary table TMP_20180508181749_CODEGEN_7MJN part 2. Populate

INSERT INTO "TMP_20180508181749_CODEGEN_7MJN" ("KEY", "Score_0", "Score_1", "Score_2", "Score_3") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1", "U"."Score_2", "U"."Score_3" 
...
FROM "TMP_20180508181749_CODEGEN_BUEE" AS "LGBM_B0" UNION ALL SELECT "LGBM_B1"."KEY" AS "KEY", "LGBM_B1"."Score_0" AS "Score_0", "LGBM_B1"."Score_1" AS "Score_1", "LGBM_B1"."Score_2" AS "Score_2", "LGBM_B1"."Score_3" AS "Score_3" 
FROM "TMP_20180508181749_CODEGEN_MKOP" AS "LGBM_B1" UNION ALL SELECT "LGBM_B2"."KEY" AS "KEY", "LGBM_B2"."Score_0" AS "Score_0", "LGBM_B2"."Score_1" AS "Score_1", "LGBM_B2"."Score_2" AS "Score_2", "LGBM_B2"."Score_3" AS "Score_3" 
FROM "TMP_20180508181749_CODEGEN_ZSTN" AS "LGBM_B2" UNION ALL SELECT "LGBM_B3"."KEY" AS "KEY", "LGBM_B3"."Score_0" AS "Score_0", "LGBM_B3"."Score_1" AS "Score_1", "LGBM_B3"."Score_2" AS "Score_2", "LGBM_B3"."Score_3" AS "Score_3" 
FROM "TMP_20180508181749_CODEGEN_NAG3" AS "LGBM_B3" UNION ALL SELECT "LGBM_B4"."KEY" AS "KEY", "LGBM_B4"."Score_0" AS "Score_0", "LGBM_B4"."Score_1" AS "Score_1", "LGBM_B4"."Score_2" AS "Score_2", "LGBM_B4"."Score_3" AS "Score_3" 
FROM "TMP_20180508181749_CODEGEN_69DW" AS "LGBM_B4" UNION ALL SELECT "LGBM_B5"."KEY" AS "KEY", "LGBM_B5"."Score_0" AS "Score_0", "LGBM_B5"."Score_1" AS "Score_1", "LGBM_B5"."Score_2" AS "Score_2", "LGBM_B5"."Score_3" AS "Score_3" 
FROM "TMP_20180508181749_CODEGEN_QIK7" AS "LGBM_B5" UNION ALL SELECT "LGBM_B6"."KEY" AS "KEY", "LGBM_B6"."Score_0" AS "Score_0", "LGBM_B6"."Score_1" AS "Score_1", "LGBM_B6"."Score_2" AS "Score_2", "LGBM_B6"."Score_3" AS "Score_3" 
FROM "TMP_20180508181749_CODEGEN_0SJM" AS "LGBM_B6") AS "LGBM_EnsembleUnion") AS "LGBM_Union") AS "U"

-- Code For temporary table TMP_20180508181749_CODEGEN_2C7R part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508181749_CODEGEN_2C7R" (
	"KEY" BIGINT NOT NULL, 
	"Score_0" DOUBLE PRECISION, 
	"Score_1" DOUBLE PRECISION, 
	"Score_2" DOUBLE PRECISION, 
...
-- Code For temporary table TMP_20180508181749_CODEGEN_2C7R part 2. Populate

INSERT INTO "TMP_20180508181749_CODEGEN_2C7R" ("KEY", "Score_0", "Score_1", "Score_2", "Score_3") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1", "U"."Score_2", "U"."Score_3" 
...
FROM "TMP_20180508181749_CODEGEN_7MJN" AS "LGBM_Union" GROUP BY "LGBM_Union"."KEY") AS "T") AS "LGBM_sum") AS "U"

-- Code For temporary table TMP_20180508181749_CODEGEN_2C7R part 3. Create Index 

CREATE INDEX "ix_TMP_20180508181749_C_1e43" ON "TMP_20180508181749_CODEGEN_2C7R" ("KEY")
...
FROM "TMP_20180508181749_CODEGEN_2C7R" AS "LGBM_sum"), 
