...
-- Code For temporary table TMP_20180508185517_CODEGEN_15E6 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508185517_CODEGEN_15E6" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20180508185517_CODEGEN_15E6 part 2. Populate

INSERT INTO "TMP_20180508185517_CODEGEN_15E6" ("KEY", imputer_output_2, imputer_output_3, imputer_output_4, imputer_output_5) SELECT "U"."KEY", "U".imputer_output_2, "U".imputer_output_3, "U".imputer_output_4, "U".imputer_output_5 
...
-- Code For temporary table TMP_20180508185517_CODEGEN_15E6 part 3. Create Index 

CREATE INDEX "ix_TMP_20180508185517_C_7ea5" ON "TMP_20180508185517_CODEGEN_15E6" ("KEY")

-- Code For temporary table TMP_20180508185517_CODEGEN_EO1E part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508185517_CODEGEN_EO1E" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20180508185517_CODEGEN_EO1E part 2. Populate

INSERT INTO "TMP_20180508185517_CODEGEN_EO1E" ("KEY", scaler_output_2, scaler_output_3, scaler_output_4, scaler_output_5) SELECT "U"."KEY", "U".scaler_output_2, "U".scaler_output_3, "U".scaler_output_4, "U".scaler_output_5 
...
FROM "TMP_20180508185517_CODEGEN_15E6" AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT") AS "U"

-- Code For temporary table TMP_20180508185517_CODEGEN_EO1E part 3. Create Index 

CREATE INDEX "ix_TMP_20180508185517_C_577c" ON "TMP_20180508185517_CODEGEN_EO1E" ("KEY")

-- Code For temporary table TMP_20180508185518_CODEGEN_989Z part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508185518_CODEGEN_989Z" (
	"KEY" BIGINT, 
...
-- Code For temporary table TMP_20180508185518_CODEGEN_989Z part 2. Populate

INSERT INTO "TMP_20180508185518_CODEGEN_989Z" ("KEY", "Proba_0", "Proba_1", "Proba_2") SELECT "U"."KEY", "U"."Proba_0", "U"."Proba_1", "U"."Proba_2" 
...
FROM "TMP_20180508185517_CODEGEN_EO1E" AS "ADS_sca_2_OUT"), 
"DT_node_data" AS 
...
-- Code For temporary table TMP_20180508185518_CODEGEN_6SB3 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508185518_CODEGEN_6SB3" (
	"KEY" BIGINT, 
	"Proba_0" DOUBLE PRECISION, 
	"Proba_1" DOUBLE PRECISION, 
	"Proba_2" DOUBLE PRECISION
...
-- Code For temporary table TMP_20180508185518_CODEGEN_6SB3 part 2. Populate

INSERT INTO "TMP_20180508185518_CODEGEN_6SB3" ("KEY", "Proba_0", "Proba_1", "Proba_2") SELECT "U"."KEY", "U"."Proba_0", "U"."Proba_1", "U"."Proba_2" 
...
FROM "TMP_20180508185518_CODEGEN_989Z" AS "CalProb_B0") AS "CalProb_EnsembleUnion") AS "CalProb_Union") AS "U"

-- Code For temporary table TMP_20180508185518_CODEGEN_Y4UF part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508185518_CODEGEN_Y4UF" (
	"KEY" BIGINT NOT NULL, 
	"Proba_0" DOUBLE PRECISION, 
	"Proba_1" DOUBLE PRECISION, 
	"Proba_2" DOUBLE PRECISION, 
...
-- Code For temporary table TMP_20180508185518_CODEGEN_Y4UF part 2. Populate

INSERT INTO "TMP_20180508185518_CODEGEN_Y4UF" ("KEY", "Proba_0", "Proba_1", "Proba_2") SELECT "U"."KEY", "U"."Proba_0", "U"."Proba_1", "U"."Proba_2" 
...
FROM "TMP_20180508185518_CODEGEN_6SB3" AS "CalProb_Union" GROUP BY "CalProb_Union"."KEY") AS "T") AS "CalProb_avg") AS "U"

-- Code For temporary table TMP_20180508185518_CODEGEN_Y4UF part 3. Create Index 

CREATE INDEX "ix_TMP_20180508185518_C_de91" ON "TMP_20180508185518_CODEGEN_Y4UF" ("KEY")
...
FROM "TMP_20180508185518_CODEGEN_Y4UF" AS "CalProb_avg"), 
