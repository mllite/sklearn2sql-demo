...
-- Code For temporary table TMP_20180508175726_CODEGEN_EC0E part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508175726_CODEGEN_EC0E" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20180508175726_CODEGEN_EC0E part 2. Populate

INSERT INTO "TMP_20180508175726_CODEGEN_EC0E" ("KEY", impter_2, impter_3, impter_4, impter_5, impter_6, impter_7, impter_8, impter_9, impter_10, impter_11) SELECT "U"."KEY", "U".impter_2, "U".impter_3, "U".impter_4, "U".impter_5, "U".impter_6, "U".impter_7, "U".impter_8, "U".impter_9, "U".impter_10, "U".impter_11 
...
-- Code For temporary table TMP_20180508175726_CODEGEN_EC0E part 3. Create Index 

CREATE INDEX "ix_TMP_20180508175726_C_b369" ON "TMP_20180508175726_CODEGEN_EC0E" ("KEY")

-- Code For temporary table TMP_20180508175726_CODEGEN_NGPM part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508175726_CODEGEN_NGPM" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20180508175726_CODEGEN_NGPM part 2. Populate

INSERT INTO "TMP_20180508175726_CODEGEN_NGPM" ("KEY", scaler_2, scaler_3, scaler_4, scaler_5, scaler_6, scaler_7, scaler_8, scaler_9, scaler_10, scaler_11) SELECT "U"."KEY", "U".scaler_2, "U".scaler_3, "U".scaler_4, "U".scaler_5, "U".scaler_6, "U".scaler_7, "U".scaler_8, "U".scaler_9, "U".scaler_10, "U".scaler_11 
...
FROM "TMP_20180508175726_CODEGEN_EC0E" AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT") AS "U"

-- Code For temporary table TMP_20180508175726_CODEGEN_NGPM part 3. Create Index 

CREATE INDEX "ix_TMP_20180508175726_C_f685" ON "TMP_20180508175726_CODEGEN_NGPM" ("KEY")

-- Code For temporary table TMP_20180508175726_CODEGEN_DLWW part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508175726_CODEGEN_DLWW" (
	"KEY" BIGINT, 
...
-- Code For temporary table TMP_20180508175726_CODEGEN_DLWW part 2. Populate

INSERT INTO "TMP_20180508175726_CODEGEN_DLWW" ("KEY", "Proba_1", "Proba_0") SELECT "U"."KEY", "U"."Proba_1", "U"."Proba_0" 
...
FROM "TMP_20180508175726_CODEGEN_NGPM" AS "ADS_sca_2_OUT"), 
"DT_node_data" AS 
...
-- Code For temporary table TMP_20180508175726_CODEGEN_54LS part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508175726_CODEGEN_54LS" (
	"KEY" BIGINT, 
	"Proba_1" DOUBLE PRECISION, 
	"Proba_0" DOUBLE PRECISION
)
...
-- Code For temporary table TMP_20180508175726_CODEGEN_54LS part 2. Populate

INSERT INTO "TMP_20180508175726_CODEGEN_54LS" ("KEY", "Proba_1", "Proba_0") SELECT "U"."KEY", "U"."Proba_1", "U"."Proba_0" 
...
FROM "TMP_20180508175726_CODEGEN_DLWW" AS "CalProb_B0") AS "CalProb_EnsembleUnion") AS "CalProb_Union") AS "U"

-- Code For temporary table TMP_20180508175726_CODEGEN_J89X part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508175726_CODEGEN_J89X" (
	"KEY" BIGINT NOT NULL, 
	"Proba_1" DOUBLE PRECISION, 
	"Proba_0" DOUBLE PRECISION, 
	PRIMARY KEY ("KEY")
...
-- Code For temporary table TMP_20180508175726_CODEGEN_J89X part 2. Populate

INSERT INTO "TMP_20180508175726_CODEGEN_J89X" ("KEY", "Proba_1", "Proba_0") SELECT "U"."KEY", "U"."Proba_1", "U"."Proba_0" 
...
FROM "TMP_20180508175726_CODEGEN_54LS" AS "CalProb_Union" GROUP BY "CalProb_Union"."KEY") AS "T") AS "CalProb_avg") AS "U"

-- Code For temporary table TMP_20180508175726_CODEGEN_J89X part 3. Create Index 

CREATE INDEX "ix_TMP_20180508175726_C_3103" ON "TMP_20180508175726_CODEGEN_J89X" ("KEY")
...
FROM "TMP_20180508175726_CODEGEN_J89X" AS "CalProb_avg"), 
