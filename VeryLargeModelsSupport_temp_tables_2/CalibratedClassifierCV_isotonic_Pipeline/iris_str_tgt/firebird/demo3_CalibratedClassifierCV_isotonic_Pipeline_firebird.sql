...
-- Code For temporary table TMP_20180508190453_CODEGEN_9GG7 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508190453_CODEGEN_9GG7" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20180508190453_CODEGEN_9GG7 part 2. Populate

INSERT INTO "TMP_20180508190453_CODEGEN_9GG7" ("KEY", imputer_output_2, imputer_output_3, imputer_output_4, imputer_output_5) SELECT "U"."KEY", "U".imputer_output_2, "U".imputer_output_3, "U".imputer_output_4, "U".imputer_output_5 
...
-- Code For temporary table TMP_20180508190453_CODEGEN_9GG7 part 3. Create Index 

CREATE INDEX "ix_TMP_20180508190453_C_f4fb" ON "TMP_20180508190453_CODEGEN_9GG7" ("KEY")

-- Code For temporary table TMP_20180508190453_CODEGEN_KGE6 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508190453_CODEGEN_KGE6" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20180508190453_CODEGEN_KGE6 part 2. Populate

INSERT INTO "TMP_20180508190453_CODEGEN_KGE6" ("KEY", scaler_output_2, scaler_output_3, scaler_output_4, scaler_output_5) SELECT "U"."KEY", "U".scaler_output_2, "U".scaler_output_3, "U".scaler_output_4, "U".scaler_output_5 
...
FROM "TMP_20180508190453_CODEGEN_9GG7" AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT") AS "U"

-- Code For temporary table TMP_20180508190453_CODEGEN_KGE6 part 3. Create Index 

CREATE INDEX "ix_TMP_20180508190453_C_97f6" ON "TMP_20180508190453_CODEGEN_KGE6" ("KEY")

-- Code For temporary table TMP_20180508190453_CODEGEN_S5DR part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508190453_CODEGEN_S5DR" (
	"KEY" BIGINT, 
...
-- Code For temporary table TMP_20180508190453_CODEGEN_S5DR part 2. Populate

INSERT INTO "TMP_20180508190453_CODEGEN_S5DR" ("KEY", "Proba_CLASS_0", "Proba_CLASS_1", "Proba_CLASS_2") SELECT "U"."KEY", "U"."Proba_CLASS_0", "U"."Proba_CLASS_1", "U"."Proba_CLASS_2" 
...
FROM "TMP_20180508190453_CODEGEN_KGE6" AS "ADS_sca_2_OUT"), 
"DT_node_data" AS 
...
-- Code For temporary table TMP_20180508190453_CODEGEN_BV7L part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508190453_CODEGEN_BV7L" (
	"KEY" BIGINT, 
	"Proba_CLASS_0" DOUBLE PRECISION, 
	"Proba_CLASS_1" DOUBLE PRECISION, 
	"Proba_CLASS_2" DOUBLE PRECISION
...
-- Code For temporary table TMP_20180508190453_CODEGEN_BV7L part 2. Populate

INSERT INTO "TMP_20180508190453_CODEGEN_BV7L" ("KEY", "Proba_CLASS_0", "Proba_CLASS_1", "Proba_CLASS_2") SELECT "U"."KEY", "U"."Proba_CLASS_0", "U"."Proba_CLASS_1", "U"."Proba_CLASS_2" 
...
FROM "TMP_20180508190453_CODEGEN_S5DR" AS "CalProb_B0") AS "CalProb_EnsembleUnion") AS "CalProb_Union") AS "U"

-- Code For temporary table TMP_20180508190453_CODEGEN_6RCK part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508190453_CODEGEN_6RCK" (
	"KEY" BIGINT NOT NULL, 
	"Proba_CLASS_0" DOUBLE PRECISION, 
	"Proba_CLASS_1" DOUBLE PRECISION, 
	"Proba_CLASS_2" DOUBLE PRECISION, 
...
-- Code For temporary table TMP_20180508190453_CODEGEN_6RCK part 2. Populate

INSERT INTO "TMP_20180508190453_CODEGEN_6RCK" ("KEY", "Proba_CLASS_0", "Proba_CLASS_1", "Proba_CLASS_2") SELECT "U"."KEY", "U"."Proba_CLASS_0", "U"."Proba_CLASS_1", "U"."Proba_CLASS_2" 
...
FROM "TMP_20180508190453_CODEGEN_BV7L" AS "CalProb_Union" GROUP BY "CalProb_Union"."KEY") AS "T") AS "CalProb_avg") AS "U"

-- Code For temporary table TMP_20180508190453_CODEGEN_6RCK part 3. Create Index 

CREATE INDEX "ix_TMP_20180508190453_C_ab43" ON "TMP_20180508190453_CODEGEN_6RCK" ("KEY")
...
FROM "TMP_20180508190453_CODEGEN_6RCK" AS "CalProb_avg"), 
