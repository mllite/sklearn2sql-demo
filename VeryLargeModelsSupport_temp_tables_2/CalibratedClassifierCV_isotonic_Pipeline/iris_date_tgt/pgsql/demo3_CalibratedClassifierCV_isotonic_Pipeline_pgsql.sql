...
-- Code For temporary table TMP_20180508190006_CODEGEN_OJ7DCR_ADS_imp_1_OUT part 1. Create 


CREATE TEMPORARY TABLE "TMP_20180508190006_CODEGEN_OJ7DCR_ADS_imp_1_OUT" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20180508190006_CODEGEN_OJ7DCR_ADS_imp_1_OUT part 2. Populate

INSERT INTO "TMP_20180508190006_CODEGEN_OJ7DCR_ADS_imp_1_OUT" ("KEY", imputer_output_2, imputer_output_3, imputer_output_4, imputer_output_5) SELECT "ADS_imp_1_OUT"."KEY", "ADS_imp_1_OUT".imputer_output_2, "ADS_imp_1_OUT".imputer_output_3, "ADS_imp_1_OUT".imputer_output_4, "ADS_imp_1_OUT".imputer_output_5 
...
-- Code For temporary table TMP_20180508190006_CODEGEN_OJ7DCR_ADS_imp_1_OUT part 3. Create Index 

CREATE INDEX "ix_TMP_20180508190006_CODEGEN_OJ7DCR_ADS_imp_1_OUT_KEY" ON "TMP_20180508190006_CODEGEN_OJ7DCR_ADS_imp_1_OUT" ("KEY")

-- Code For temporary table TMP_20180508190006_CODEGEN_QEG6MA_ADS_sca_2_OUT part 1. Create 


CREATE TEMPORARY TABLE "TMP_20180508190006_CODEGEN_QEG6MA_ADS_sca_2_OUT" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20180508190006_CODEGEN_QEG6MA_ADS_sca_2_OUT part 2. Populate

INSERT INTO "TMP_20180508190006_CODEGEN_QEG6MA_ADS_sca_2_OUT" ("KEY", scaler_output_2, scaler_output_3, scaler_output_4, scaler_output_5) SELECT "ADS_sca_2_OUT"."KEY", "ADS_sca_2_OUT".scaler_output_2, "ADS_sca_2_OUT".scaler_output_3, "ADS_sca_2_OUT".scaler_output_4, "ADS_sca_2_OUT".scaler_output_5 
...
FROM "TMP_20180508190006_CODEGEN_OJ7DCR_ADS_imp_1_OUT" AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT"

-- Code For temporary table TMP_20180508190006_CODEGEN_QEG6MA_ADS_sca_2_OUT part 3. Create Index 

CREATE INDEX "ix_TMP_20180508190006_CODEGEN_QEG6MA_ADS_sca_2_OUT_KEY" ON "TMP_20180508190006_CODEGEN_QEG6MA_ADS_sca_2_OUT" ("KEY")

-- Code For temporary table TMP_20180508190006_CODEGEN_NUPY1R_CalProb_B0 part 1. Create 


CREATE TEMPORARY TABLE "TMP_20180508190006_CODEGEN_NUPY1R_CalProb_B0" (
	"KEY" BIGINT, 
...
-- Code For temporary table TMP_20180508190006_CODEGEN_NUPY1R_CalProb_B0 part 2. Populate
...
FROM "TMP_20180508190006_CODEGEN_QEG6MA_ADS_sca_2_OUT" AS "ADS_sca_2_OUT"), 
"DT_node_data" AS 
...
-- Code For temporary table TMP_20180508190006_CODEGEN_CD5UXL_CalProb_Union part 1. Create 


CREATE TEMPORARY TABLE "TMP_20180508190006_CODEGEN_CD5UXL_CalProb_Union" (
	"KEY" BIGINT, 
	"Proba_1789-07-14T00:00:00.000000000" FLOAT, 
	"Proba_1789-08-14T00:00:00.000000000" FLOAT, 
	"Proba_1789-09-14T00:00:00.000000000" FLOAT
...
FROM "TMP_20180508190006_CODEGEN_NUPY1R_CalProb_B0" AS "CalProb_B0") AS "CalProb_EnsembleUnion") AS "CalProb_Union"

-- Code For temporary table TMP_20180508190006_CODEGEN_Z1XD8X_CalProb_avg part 1. Create 


CREATE TEMPORARY TABLE "TMP_20180508190006_CODEGEN_Z1XD8X_CalProb_avg" (
	"KEY" BIGINT NOT NULL, 
	"Proba_1789-07-14T00:00:00.000000000" FLOAT, 
	"Proba_1789-08-14T00:00:00.000000000" FLOAT, 
	"Proba_1789-09-14T00:00:00.000000000" FLOAT, 
...
FROM "TMP_20180508190006_CODEGEN_CD5UXL_CalProb_Union" AS "CalProb_Union" GROUP BY "CalProb_Union"."KEY") AS "T") AS "CalProb_avg"

-- Code For temporary table TMP_20180508190006_CODEGEN_Z1XD8X_CalProb_avg part 3. Create Index 

CREATE INDEX "ix_TMP_20180508190006_CODEGEN_Z1XD8X_CalProb_avg_KEY" ON "TMP_20180508190006_CODEGEN_Z1XD8X_CalProb_avg" ("KEY")
...
FROM "TMP_20180508190006_CODEGEN_Z1XD8X_CalProb_avg" AS "CalProb_avg"), 
