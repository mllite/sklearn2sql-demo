...
-- Code For temporary table TMP_20180508190006_CODEGEN_OQW150_ADS_imp_1_OUT part 1. Create 


CREATE TEMPORARY TABLE `TMP_20180508190006_CODEGEN_OQW150_ADS_imp_1_OUT` (
	`KEY` BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20180508190006_CODEGEN_OQW150_ADS_imp_1_OUT part 2. Populate

INSERT INTO `TMP_20180508190006_CODEGEN_OQW150_ADS_imp_1_OUT` (`KEY`, imputer_output_2, imputer_output_3, imputer_output_4, imputer_output_5) SELECT `U`.`KEY`, `U`.imputer_output_2, `U`.imputer_output_3, `U`.imputer_output_4, `U`.imputer_output_5 
...
-- Code For temporary table TMP_20180508190006_CODEGEN_OQW150_ADS_imp_1_OUT part 3. Create Index 

CREATE INDEX `ix_TMP_20180508190006_CODEGEN_OQW150_ADS_imp_1_OUT_KEY` ON `TMP_20180508190006_CODEGEN_OQW150_ADS_imp_1_OUT` (`KEY`)

-- Code For temporary table TMP_20180508190006_CODEGEN_7JJBI8_ADS_sca_2_OUT part 1. Create 


CREATE TEMPORARY TABLE `TMP_20180508190006_CODEGEN_7JJBI8_ADS_sca_2_OUT` (
	`KEY` BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20180508190006_CODEGEN_7JJBI8_ADS_sca_2_OUT part 2. Populate

INSERT INTO `TMP_20180508190006_CODEGEN_7JJBI8_ADS_sca_2_OUT` (`KEY`, scaler_output_2, scaler_output_3, scaler_output_4, scaler_output_5) SELECT `U`.`KEY`, `U`.scaler_output_2, `U`.scaler_output_3, `U`.scaler_output_4, `U`.scaler_output_5 
...
FROM `TMP_20180508190006_CODEGEN_OQW150_ADS_imp_1_OUT` AS `ADS_imp_1_OUT`) AS `ADS_sca_2_OUT`) AS `U`

-- Code For temporary table TMP_20180508190006_CODEGEN_7JJBI8_ADS_sca_2_OUT part 3. Create Index 

CREATE INDEX `ix_TMP_20180508190006_CODEGEN_7JJBI8_ADS_sca_2_OUT_KEY` ON `TMP_20180508190006_CODEGEN_7JJBI8_ADS_sca_2_OUT` (`KEY`)

-- Code For temporary table TMP_20180508190006_CODEGEN_VBHZJ2_CalProb_B0 part 1. Create 


CREATE TEMPORARY TABLE `TMP_20180508190006_CODEGEN_VBHZJ2_CalProb_B0` (
	`KEY` BIGINT, 
...
-- Code For temporary table TMP_20180508190006_CODEGEN_VBHZJ2_CalProb_B0 part 2. Populate

INSERT INTO `TMP_20180508190006_CODEGEN_VBHZJ2_CalProb_B0` (`KEY`, `Proba_1789-07-14T00:00:00.000000000`, `Proba_1789-08-14T00:00:00.000000000`, `Proba_1789-09-14T00:00:00.000000000`) SELECT `U`.`KEY`, `U`.`Proba_1789-07-14T00:00:00.000000000`, `U`.`Proba_1789-08-14T00:00:00.000000000`, `U`.`Proba_1789-09-14T00:00:00.000000000` 
...
FROM `TMP_20180508190006_CODEGEN_7JJBI8_ADS_sca_2_OUT` AS `ADS_sca_2_OUT`), 
`DT_node_data` AS 
...
(SELECT `DT_Output_1`.`KEY` AS `KEY`, NULL AS `Score_1789-07-14T00:00:00.000000000`, NULL AS `Score_1789-08-14T00:00:00.000000000`, NULL AS `Score_1789-09-14T00:00:00.000000000`, `DT_Output_1`.`P_1789-07-14T00:00:00.000000000` AS `Proba_1789-07-14T00:00:00.000000000`, `DT_Output_1`.`P_1789-08-14T00:00:00.000000000` AS `Proba_1789-08-14T00:00:00.000000000`, `DT_Output_1`.`P_1789-09-14T00:00:00.000000000` AS `Proba_1789-09-14T00:00:00.000000000`, CASE WHEN (`DT_Output_1`.`P_1789-07-14T00:00:00.000000000` IS NULL OR `DT_Output_1`.`P_1789-07-14T00:00:00.000000000` > 0.0) THEN ln(`DT_Output_1`.`P_1789-07-14T00:00:00.000000000`) ELSE -1.79769313486231e+308 END AS `LogProba_1789-07-14T00:00:00.000000000`, CASE WHEN (`DT_Output_1`.`P_1789-08-14T00:00:00.000000000` IS NULL OR `DT_Output_1`.`P_1789-08-14T00:00:00.000000000` > 0.0) THEN ln(`DT_Output_1`.`P_1789-08-14T00:00:00.000000000`) ELSE -1.79769313486231e+308 END AS `LogProba_1789-08-14T00:00:00.000000000`, CASE WHEN (`DT_Output_1`.`P_1789-09-14T00:00:00.000000000` IS NULL OR `DT_Output_1`.`P_1789-09-14T00:00:00.000000000` > 0.0) THEN ln(`DT_Output_1`.`P_1789-09-14T00:00:00.000000000`) ELSE -1.79769313486231e+308 END AS `LogProba_1789-09-14T00:00:00.000000000`, CAST(NULL AS SIGNED INTEGER) AS `Decision`, NULL AS `DecisionProba`, coalesce(NULL, `DT_Output_1`.`P_1789-07-14T00:00:00.000000000`) AS `ScoreOrProba_1789-07-14T00:00:00.000000000`, coalesce(NULL, `DT_Output_1`.`P_1789-08-14T00:00:00.000000000`) AS `ScoreOrProba_1789-08-14T00:00:00.000000000`, coalesce(NULL, `DT_Output_1`.`P_1789-09-14T00:00:00.000000000`) AS `ScoreOrProba_1789-09-14T00:00:00.000000000` 
FROM `DT_Output_1`), 
isotonic_cte_1 AS 
...
(SELECT `DT_Output_2`.`KEY` AS `KEY`, NULL AS `Score_1789-07-14T00:00:00.000000000`, NULL AS `Score_1789-08-14T00:00:00.000000000`, NULL AS `Score_1789-09-14T00:00:00.000000000`, `DT_Output_2`.`P_1789-07-14T00:00:00.000000000` AS `Proba_1789-07-14T00:00:00.000000000`, `DT_Output_2`.`P_1789-08-14T00:00:00.000000000` AS `Proba_1789-08-14T00:00:00.000000000`, `DT_Output_2`.`P_1789-09-14T00:00:00.000000000` AS `Proba_1789-09-14T00:00:00.000000000`, CASE WHEN (`DT_Output_2`.`P_1789-07-14T00:00:00.000000000` IS NULL OR `DT_Output_2`.`P_1789-07-14T00:00:00.000000000` > 0.0) THEN ln(`DT_Output_2`.`P_1789-07-14T00:00:00.000000000`) ELSE -1.79769313486231e+308 END AS `LogProba_1789-07-14T00:00:00.000000000`, CASE WHEN (`DT_Output_2`.`P_1789-08-14T00:00:00.000000000` IS NULL OR `DT_Output_2`.`P_1789-08-14T00:00:00.000000000` > 0.0) THEN ln(`DT_Output_2`.`P_1789-08-14T00:00:00.000000000`) ELSE -1.79769313486231e+308 END AS `LogProba_1789-08-14T00:00:00.000000000`, CASE WHEN (`DT_Output_2`.`P_1789-09-14T00:00:00.000000000` IS NULL OR `DT_Output_2`.`P_1789-09-14T00:00:00.000000000` > 0.0) THEN ln(`DT_Output_2`.`P_1789-09-14T00:00:00.000000000`) ELSE -1.79769313486231e+308 END AS `LogProba_1789-09-14T00:00:00.000000000`, CAST(NULL AS SIGNED INTEGER) AS `Decision`, NULL AS `DecisionProba`, coalesce(NULL, `DT_Output_2`.`P_1789-07-14T00:00:00.000000000`) AS `ScoreOrProba_1789-07-14T00:00:00.000000000`, coalesce(NULL, `DT_Output_2`.`P_1789-08-14T00:00:00.000000000`) AS `ScoreOrProba_1789-08-14T00:00:00.000000000`, coalesce(NULL, `DT_Output_2`.`P_1789-09-14T00:00:00.000000000`) AS `ScoreOrProba_1789-09-14T00:00:00.000000000` 
FROM `DT_Output_2`), 
isotonic_cte_2 AS 
...
(SELECT `DT_Output_3`.`KEY` AS `KEY`, NULL AS `Score_1789-07-14T00:00:00.000000000`, NULL AS `Score_1789-08-14T00:00:00.000000000`, NULL AS `Score_1789-09-14T00:00:00.000000000`, `DT_Output_3`.`P_1789-07-14T00:00:00.000000000` AS `Proba_1789-07-14T00:00:00.000000000`, `DT_Output_3`.`P_1789-08-14T00:00:00.000000000` AS `Proba_1789-08-14T00:00:00.000000000`, `DT_Output_3`.`P_1789-09-14T00:00:00.000000000` AS `Proba_1789-09-14T00:00:00.000000000`, CASE WHEN (`DT_Output_3`.`P_1789-07-14T00:00:00.000000000` IS NULL OR `DT_Output_3`.`P_1789-07-14T00:00:00.000000000` > 0.0) THEN ln(`DT_Output_3`.`P_1789-07-14T00:00:00.000000000`) ELSE -1.79769313486231e+308 END AS `LogProba_1789-07-14T00:00:00.000000000`, CASE WHEN (`DT_Output_3`.`P_1789-08-14T00:00:00.000000000` IS NULL OR `DT_Output_3`.`P_1789-08-14T00:00:00.000000000` > 0.0) THEN ln(`DT_Output_3`.`P_1789-08-14T00:00:00.000000000`) ELSE -1.79769313486231e+308 END AS `LogProba_1789-08-14T00:00:00.000000000`, CASE WHEN (`DT_Output_3`.`P_1789-09-14T00:00:00.000000000` IS NULL OR `DT_Output_3`.`P_1789-09-14T00:00:00.000000000` > 0.0) THEN ln(`DT_Output_3`.`P_1789-09-14T00:00:00.000000000`) ELSE -1.79769313486231e+308 END AS `LogProba_1789-09-14T00:00:00.000000000`, CAST(NULL AS SIGNED INTEGER) AS `Decision`, NULL AS `DecisionProba`, coalesce(NULL, `DT_Output_3`.`P_1789-07-14T00:00:00.000000000`) AS `ScoreOrProba_1789-07-14T00:00:00.000000000`, coalesce(NULL, `DT_Output_3`.`P_1789-08-14T00:00:00.000000000`) AS `ScoreOrProba_1789-08-14T00:00:00.000000000`, coalesce(NULL, `DT_Output_3`.`P_1789-09-14T00:00:00.000000000`) AS `ScoreOrProba_1789-09-14T00:00:00.000000000` 
FROM `DT_Output_3`), 
isotonic_cte_3 AS 
...
FROM isotonic_cte_3)
 SELECT `CalProb_B0`.`KEY`, `CalProb_B0`.`Proba_1789-07-14T00:00:00.000000000`, `CalProb_B0`.`Proba_1789-08-14T00:00:00.000000000`, `CalProb_B0`.`Proba_1789-09-14T00:00:00.000000000` 
...
-- Code For temporary table TMP_20180508190006_CODEGEN_UJKR61_CalProb_Union part 1. Create 


CREATE TEMPORARY TABLE `TMP_20180508190006_CODEGEN_UJKR61_CalProb_Union` (
	`KEY` BIGINT, 
	`Proba_1789-07-14T00:00:00.000000000` DOUBLE, 
	`Proba_1789-08-14T00:00:00.000000000` DOUBLE, 
	`Proba_1789-09-14T00:00:00.000000000` DOUBLE
...
-- Code For temporary table TMP_20180508190006_CODEGEN_UJKR61_CalProb_Union part 2. Populate

INSERT INTO `TMP_20180508190006_CODEGEN_UJKR61_CalProb_Union` (`KEY`, `Proba_1789-07-14T00:00:00.000000000`, `Proba_1789-08-14T00:00:00.000000000`, `Proba_1789-09-14T00:00:00.000000000`) SELECT `U`.`KEY`, `U`.`Proba_1789-07-14T00:00:00.000000000`, `U`.`Proba_1789-08-14T00:00:00.000000000`, `U`.`Proba_1789-09-14T00:00:00.000000000` 
FROM (SELECT `CalProb_Union`.`KEY`, `CalProb_Union`.`Proba_1789-07-14T00:00:00.000000000`, `CalProb_Union`.`Proba_1789-08-14T00:00:00.000000000`, `CalProb_Union`.`Proba_1789-09-14T00:00:00.000000000` 
...
FROM `TMP_20180508190006_CODEGEN_VBHZJ2_CalProb_B0` AS `CalProb_B0`) AS `CalProb_EnsembleUnion`) AS `CalProb_Union`) AS `U`

-- Code For temporary table TMP_20180508190006_CODEGEN_EGYH3B_CalProb_avg part 1. Create 


CREATE TEMPORARY TABLE `TMP_20180508190006_CODEGEN_EGYH3B_CalProb_avg` (
	`KEY` BIGINT NOT NULL, 
	`Proba_1789-07-14T00:00:00.000000000` DOUBLE, 
	`Proba_1789-08-14T00:00:00.000000000` DOUBLE, 
	`Proba_1789-09-14T00:00:00.000000000` DOUBLE, 
...
-- Code For temporary table TMP_20180508190006_CODEGEN_EGYH3B_CalProb_avg part 2. Populate

INSERT INTO `TMP_20180508190006_CODEGEN_EGYH3B_CalProb_avg` (`KEY`, `Proba_1789-07-14T00:00:00.000000000`, `Proba_1789-08-14T00:00:00.000000000`, `Proba_1789-09-14T00:00:00.000000000`) SELECT `U`.`KEY`, `U`.`Proba_1789-07-14T00:00:00.000000000`, `U`.`Proba_1789-08-14T00:00:00.000000000`, `U`.`Proba_1789-09-14T00:00:00.000000000` 
...
FROM (SELECT `T`.`KEY` AS `KEY`, `T`.`Proba_1789-07-14T00:00:00.000000000` AS `Proba_1789-07-14T00:00:00.000000000`, `T`.`Proba_1789-08-14T00:00:00.000000000` AS `Proba_1789-08-14T00:00:00.000000000`, `T`.`Proba_1789-09-14T00:00:00.000000000` AS `Proba_1789-09-14T00:00:00.000000000` 
FROM (SELECT `CalProb_Union`.`KEY` AS `KEY`, avg(`CalProb_Union`.`Proba_1789-07-14T00:00:00.000000000`) AS `Proba_1789-07-14T00:00:00.000000000`, avg(`CalProb_Union`.`Proba_1789-08-14T00:00:00.000000000`) AS `Proba_1789-08-14T00:00:00.000000000`, avg(`CalProb_Union`.`Proba_1789-09-14T00:00:00.000000000`) AS `Proba_1789-09-14T00:00:00.000000000` 
FROM `TMP_20180508190006_CODEGEN_UJKR61_CalProb_Union` AS `CalProb_Union` GROUP BY `CalProb_Union`.`KEY`) AS `T`) AS `CalProb_avg`) AS `U`

-- Code For temporary table TMP_20180508190006_CODEGEN_EGYH3B_CalProb_avg part 3. Create Index 

CREATE INDEX `ix_TMP_20180508190006_CODEGEN_EGYH3B_CalProb_avg_KEY` ON `TMP_20180508190006_CODEGEN_EGYH3B_CalProb_avg` (`KEY`)

-- Model deployment code

WITH orig_cte AS 
(SELECT `CalProb_avg`.`KEY` AS `KEY`, NULL AS `Score_1789-07-14T00:00:00.000000000`, NULL AS `Score_1789-08-14T00:00:00.000000000`, NULL AS `Score_1789-09-14T00:00:00.000000000`, `CalProb_avg`.`Proba_1789-07-14T00:00:00.000000000` AS `Proba_1789-07-14T00:00:00.000000000`, `CalProb_avg`.`Proba_1789-08-14T00:00:00.000000000` AS `Proba_1789-08-14T00:00:00.000000000`, `CalProb_avg`.`Proba_1789-09-14T00:00:00.000000000` AS `Proba_1789-09-14T00:00:00.000000000`, NULL AS `LogProba_1789-07-14T00:00:00.000000000`, NULL AS `LogProba_1789-08-14T00:00:00.000000000`, NULL AS `LogProba_1789-09-14T00:00:00.000000000`, CAST(NULL AS SIGNED INTEGER) AS `Decision`, NULL AS `DecisionProba` 
FROM `TMP_20180508190006_CODEGEN_EGYH3B_CalProb_avg` AS `CalProb_avg`), 
