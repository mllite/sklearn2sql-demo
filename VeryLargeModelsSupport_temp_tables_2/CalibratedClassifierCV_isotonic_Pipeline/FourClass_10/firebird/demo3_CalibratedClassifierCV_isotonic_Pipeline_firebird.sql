...
-- Code For temporary table TMP_20180508181139_CODEGEN_W8OV part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508181139_CODEGEN_W8OV" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20180508181139_CODEGEN_W8OV part 2. Populate

INSERT INTO "TMP_20180508181139_CODEGEN_W8OV" ("KEY", impter_2, impter_3, impter_4, impter_5, impter_6, impter_7, impter_8, impter_9, impter_10, impter_11) SELECT "U"."KEY", "U".impter_2, "U".impter_3, "U".impter_4, "U".impter_5, "U".impter_6, "U".impter_7, "U".impter_8, "U".impter_9, "U".impter_10, "U".impter_11 
...
-- Code For temporary table TMP_20180508181139_CODEGEN_W8OV part 3. Create Index 

CREATE INDEX "ix_TMP_20180508181139_C_1b37" ON "TMP_20180508181139_CODEGEN_W8OV" ("KEY")

-- Code For temporary table TMP_20180508181139_CODEGEN_J3UH part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508181139_CODEGEN_J3UH" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20180508181139_CODEGEN_J3UH part 2. Populate

INSERT INTO "TMP_20180508181139_CODEGEN_J3UH" ("KEY", scaler_2, scaler_3, scaler_4, scaler_5, scaler_6, scaler_7, scaler_8, scaler_9, scaler_10, scaler_11) SELECT "U"."KEY", "U".scaler_2, "U".scaler_3, "U".scaler_4, "U".scaler_5, "U".scaler_6, "U".scaler_7, "U".scaler_8, "U".scaler_9, "U".scaler_10, "U".scaler_11 
...
FROM "TMP_20180508181139_CODEGEN_W8OV" AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT") AS "U"

-- Code For temporary table TMP_20180508181139_CODEGEN_J3UH part 3. Create Index 

CREATE INDEX "ix_TMP_20180508181139_C_b73b" ON "TMP_20180508181139_CODEGEN_J3UH" ("KEY")

-- Code For temporary table TMP_20180508181139_CODEGEN_3808 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508181139_CODEGEN_3808" (
	"KEY" BIGINT, 
...
-- Code For temporary table TMP_20180508181139_CODEGEN_3808 part 2. Populate

INSERT INTO "TMP_20180508181139_CODEGEN_3808" ("KEY", "Proba_0", "Proba_1", "Proba_2", "Proba_3") SELECT "U"."KEY", "U"."Proba_0", "U"."Proba_1", "U"."Proba_2", "U"."Proba_3" 
...
FROM "TMP_20180508181139_CODEGEN_J3UH" AS "ADS_sca_2_OUT"), 
"DT_node_data" AS 
...
-- Code For temporary table TMP_20180508181139_CODEGEN_Q0W0 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508181139_CODEGEN_Q0W0" (
	"KEY" BIGINT, 
	"Proba_0" DOUBLE PRECISION, 
	"Proba_1" DOUBLE PRECISION, 
	"Proba_2" DOUBLE PRECISION, 
...
-- Code For temporary table TMP_20180508181139_CODEGEN_Q0W0 part 2. Populate

INSERT INTO "TMP_20180508181139_CODEGEN_Q0W0" ("KEY", "Proba_0", "Proba_1", "Proba_2", "Proba_3") SELECT "U"."KEY", "U"."Proba_0", "U"."Proba_1", "U"."Proba_2", "U"."Proba_3" 
...
FROM "TMP_20180508181139_CODEGEN_3808" AS "CalProb_B0") AS "CalProb_EnsembleUnion") AS "CalProb_Union") AS "U"

-- Code For temporary table TMP_20180508181139_CODEGEN_88Q3 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508181139_CODEGEN_88Q3" (
	"KEY" BIGINT NOT NULL, 
	"Proba_0" DOUBLE PRECISION, 
	"Proba_1" DOUBLE PRECISION, 
	"Proba_2" DOUBLE PRECISION, 
...
-- Code For temporary table TMP_20180508181139_CODEGEN_88Q3 part 2. Populate

INSERT INTO "TMP_20180508181139_CODEGEN_88Q3" ("KEY", "Proba_0", "Proba_1", "Proba_2", "Proba_3") SELECT "U"."KEY", "U"."Proba_0", "U"."Proba_1", "U"."Proba_2", "U"."Proba_3" 
...
FROM "TMP_20180508181139_CODEGEN_Q0W0" AS "CalProb_Union" GROUP BY "CalProb_Union"."KEY") AS "T") AS "CalProb_avg") AS "U"

-- Code For temporary table TMP_20180508181139_CODEGEN_88Q3 part 3. Create Index 

CREATE INDEX "ix_TMP_20180508181139_C_2d31" ON "TMP_20180508181139_CODEGEN_88Q3" ("KEY")
...
FROM "TMP_20180508181139_CODEGEN_88Q3" AS "CalProb_avg"), 
