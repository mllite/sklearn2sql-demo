...
-- Code For temporary table tmp_20180508181138_codegen_ct23w8_ads_imp_1_out part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180508181138_codegen_ct23w8_ads_imp_1_out  (
	"KEY" BIGINT, 
...
-- Code For temporary table tmp_20180508181138_codegen_ct23w8_ads_imp_1_out part 2. Populate

INSERT INTO tmp_20180508181138_codegen_ct23w8_ads_imp_1_out ("KEY", impter_2, impter_3, impter_4, impter_5, impter_6, impter_7, impter_8, impter_9, impter_10, impter_11) SELECT "U"."KEY", "U".impter_2, "U".impter_3, "U".impter_4, "U".impter_5, "U".impter_6, "U".impter_7, "U".impter_8, "U".impter_9, "U".impter_10, "U".impter_11 
...
-- Code For temporary table tmp_20180508181138_codegen_z6cq7d_ads_sca_2_out part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180508181138_codegen_z6cq7d_ads_sca_2_out  (
	"KEY" BIGINT, 
...
-- Code For temporary table tmp_20180508181138_codegen_z6cq7d_ads_sca_2_out part 2. Populate

INSERT INTO tmp_20180508181138_codegen_z6cq7d_ads_sca_2_out ("KEY", scaler_2, scaler_3, scaler_4, scaler_5, scaler_6, scaler_7, scaler_8, scaler_9, scaler_10, scaler_11) SELECT "U"."KEY", "U".scaler_2, "U".scaler_3, "U".scaler_4, "U".scaler_5, "U".scaler_6, "U".scaler_7, "U".scaler_8, "U".scaler_9, "U".scaler_10, "U".scaler_11 
...
FROM tmp_20180508181138_codegen_ct23w8_ads_imp_1_out AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT") AS "U"

-- Code For temporary table tmp_20180508181139_codegen_04z5uh_calprob_b0 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180508181139_codegen_04z5uh_calprob_b0  (
	"KEY" BIGINT, 
...
-- Code For temporary table tmp_20180508181139_codegen_04z5uh_calprob_b0 part 2. Populate

INSERT INTO tmp_20180508181139_codegen_04z5uh_calprob_b0 ("KEY", "Proba_0", "Proba_1", "Proba_2", "Proba_3") SELECT "U"."KEY", "U"."Proba_0", "U"."Proba_1", "U"."Proba_2", "U"."Proba_3" 
...
FROM tmp_20180508181138_codegen_z6cq7d_ads_sca_2_out AS "ADS_sca_2_OUT"), 
dummy_cte AS 
...
FROM "DT_Output"), 
isotonic_cte_0 AS 
(SELECT "Calibrated_Model_0"."KEY" AS "KEY", CASE WHEN ("Calibrated_Model_0"."ScoreOrProba_0" < CAST(0.0 AS DOUBLE PRECISION)) THEN CAST(0.066666666666667 AS DOUBLE PRECISION) WHEN ("Calibrated_Model_0"."ScoreOrProba_0" < CAST(0.2 AS DOUBLE PRECISION)) THEN ("Calibrated_Model_0"."ScoreOrProba_0" - CAST(0.0 AS DOUBLE PRECISION)) * CAST(2.166666666666666 AS DOUBLE PRECISION) + CAST(0.066666666666667 AS DOUBLE PRECISION) WHEN ("Calibrated_Model_0"."ScoreOrProba_0" < CAST(1.0 AS DOUBLE PRECISION)) THEN ("Calibrated_Model_0"."ScoreOrProba_0" - CAST(0.2 AS DOUBLE PRECISION)) * CAST(0.3125 AS DOUBLE PRECISION) + CAST(0.5 AS DOUBLE PRECISION) ELSE CAST(0.75 AS DOUBLE PRECISION) END AS "Proba_0", CASE WHEN ("Calibrated_Model_0"."ScoreOrProba_1" < CAST(0.0 AS DOUBLE PRECISION)) THEN CAST(0.133333333333333 AS DOUBLE PRECISION) WHEN ("Calibrated_Model_0"."ScoreOrProba_1" < CAST(0.875 AS DOUBLE PRECISION)) THEN ("Calibrated_Model_0"."ScoreOrProba_1" - CAST(0.0 AS DOUBLE PRECISION)) * CAST(0.419047619047619 AS DOUBLE PRECISION) + CAST(0.133333333333333 AS DOUBLE PRECISION) ELSE CAST(0.5 AS DOUBLE PRECISION) END AS "Proba_1", CASE WHEN ("Calibrated_Model_0"."ScoreOrProba_2" < CAST(0.0 AS DOUBLE PRECISION)) THEN CAST(0.088235294117647 AS DOUBLE PRECISION) WHEN ("Calibrated_Model_0"."ScoreOrProba_2" < CAST(0.8 AS DOUBLE PRECISION)) THEN ("Calibrated_Model_0"."ScoreOrProba_2" - CAST(0.0 AS DOUBLE PRECISION)) * CAST(0.0 AS DOUBLE PRECISION) + CAST(0.088235294117647 AS DOUBLE PRECISION) WHEN ("Calibrated_Model_0"."ScoreOrProba_2" < CAST(1.0 AS DOUBLE PRECISION)) THEN ("Calibrated_Model_0"."ScoreOrProba_2" - CAST(0.8 AS DOUBLE PRECISION)) * CAST(4.558823529411765 AS DOUBLE PRECISION) + CAST(0.088235294117647 AS DOUBLE PRECISION) ELSE CAST(1.0 AS DOUBLE PRECISION) END AS "Proba_2", CASE WHEN ("Calibrated_Model_0"."ScoreOrProba_3" < CAST(0.0 AS DOUBLE PRECISION)) THEN CAST(0.0625 AS DOUBLE PRECISION) WHEN ("Calibrated_Model_0"."ScoreOrProba_3" < CAST(0.125 AS DOUBLE PRECISION)) THEN ("Calibrated_Model_0"."ScoreOrProba_3" - CAST(0.0 AS DOUBLE PRECISION)) * CAST(0.0 AS DOUBLE PRECISION) + CAST(0.0625 AS DOUBLE PRECISION) WHEN ("Calibrated_Model_0"."ScoreOrProba_3" < CAST(1.0 AS DOUBLE PRECISION)) THEN ("Calibrated_Model_0"."ScoreOrProba_3" - CAST(0.125 AS DOUBLE PRECISION)) * CAST(0.744897959183674 AS DOUBLE PRECISION) + CAST(0.0625 AS DOUBLE PRECISION) ELSE CAST(0.714285714285714 AS DOUBLE PRECISION) END AS "Proba_3" 
...
FROM "DT_Output_1"), 
isotonic_cte_1 AS 
(SELECT "Calibrated_Model_1"."KEY" AS "KEY", CASE WHEN ("Calibrated_Model_1"."ScoreOrProba_0" < CAST(0.0 AS DOUBLE PRECISION)) THEN CAST(0.0625 AS DOUBLE PRECISION) WHEN ("Calibrated_Model_1"."ScoreOrProba_0" < CAST(1.0 AS DOUBLE PRECISION)) THEN ("Calibrated_Model_1"."ScoreOrProba_0" - CAST(0.0 AS DOUBLE PRECISION)) * CAST(0.7375 AS DOUBLE PRECISION) + CAST(0.0625 AS DOUBLE PRECISION) ELSE CAST(0.8 AS DOUBLE PRECISION) END AS "Proba_0", CASE WHEN ("Calibrated_Model_1"."ScoreOrProba_1" < CAST(0.0 AS DOUBLE PRECISION)) THEN CAST(0.0 AS DOUBLE PRECISION) WHEN ("Calibrated_Model_1"."ScoreOrProba_1" < CAST(0.333333333333333 AS DOUBLE PRECISION)) THEN ("Calibrated_Model_1"."ScoreOrProba_1" - CAST(0.0 AS DOUBLE PRECISION)) * CAST(1.9 AS DOUBLE PRECISION) + CAST(0.0 AS DOUBLE PRECISION) WHEN ("Calibrated_Model_1"."ScoreOrProba_1" < CAST(1.0 AS DOUBLE PRECISION)) THEN ("Calibrated_Model_1"."ScoreOrProba_1" - CAST(0.333333333333333 AS DOUBLE PRECISION)) * CAST(0.0 AS DOUBLE PRECISION) + CAST(0.633333333333333 AS DOUBLE PRECISION) ELSE CAST(0.633333333333333 AS DOUBLE PRECISION) END AS "Proba_1", CASE WHEN ("Calibrated_Model_1"."ScoreOrProba_2" < CAST(0.0 AS DOUBLE PRECISION)) THEN CAST(0.076923076923077 AS DOUBLE PRECISION) WHEN ("Calibrated_Model_1"."ScoreOrProba_2" < CAST(0.666666666666667 AS DOUBLE PRECISION)) THEN ("Calibrated_Model_1"."ScoreOrProba_2" - CAST(0.0 AS DOUBLE PRECISION)) * CAST(0.384615384615385 AS DOUBLE PRECISION) + CAST(0.076923076923077 AS DOUBLE PRECISION) WHEN ("Calibrated_Model_1"."ScoreOrProba_2" < CAST(1.0 AS DOUBLE PRECISION)) THEN ("Calibrated_Model_1"."ScoreOrProba_2" - CAST(0.666666666666667 AS DOUBLE PRECISION)) * CAST(0.8 AS DOUBLE PRECISION) + CAST(0.333333333333333 AS DOUBLE PRECISION) ELSE CAST(0.6 AS DOUBLE PRECISION) END AS "Proba_2", CASE WHEN ("Calibrated_Model_1"."ScoreOrProba_3" < CAST(0.0 AS DOUBLE PRECISION)) THEN CAST(0.166666666666667 AS DOUBLE PRECISION) WHEN ("Calibrated_Model_1"."ScoreOrProba_3" < CAST(1.0 AS DOUBLE PRECISION)) THEN ("Calibrated_Model_1"."ScoreOrProba_3" - CAST(0.0 AS DOUBLE PRECISION)) * CAST(0.833333333333333 AS DOUBLE PRECISION) + CAST(0.166666666666667 AS DOUBLE PRECISION) ELSE CAST(1.0 AS DOUBLE PRECISION) END AS "Proba_3" 
...
FROM "DT_Output_2"), 
isotonic_cte_2 AS 
(SELECT "Calibrated_Model_2"."KEY" AS "KEY", CASE WHEN ("Calibrated_Model_2"."ScoreOrProba_0" < CAST(0.0 AS DOUBLE PRECISION)) THEN CAST(0.045454545454545 AS DOUBLE PRECISION) WHEN ("Calibrated_Model_2"."ScoreOrProba_0" < CAST(0.142857142857143 AS DOUBLE PRECISION)) THEN ("Calibrated_Model_2"."ScoreOrProba_0" - CAST(0.0 AS DOUBLE PRECISION)) * CAST(0.0 AS DOUBLE PRECISION) + CAST(0.045454545454545 AS DOUBLE PRECISION) WHEN ("Calibrated_Model_2"."ScoreOrProba_0" < CAST(0.75 AS DOUBLE PRECISION)) THEN ("Calibrated_Model_2"."ScoreOrProba_0" - CAST(0.142857142857143 AS DOUBLE PRECISION)) * CAST(1.07807486631016 AS DOUBLE PRECISION) + CAST(0.045454545454545 AS DOUBLE PRECISION) WHEN ("Calibrated_Model_2"."ScoreOrProba_0" < CAST(1.0 AS DOUBLE PRECISION)) THEN ("Calibrated_Model_2"."ScoreOrProba_0" - CAST(0.75 AS DOUBLE PRECISION)) * CAST(0.0 AS DOUBLE PRECISION) + CAST(0.7 AS DOUBLE PRECISION) ELSE CAST(0.7 AS DOUBLE PRECISION) END AS "Proba_0", CASE WHEN ("Calibrated_Model_2"."ScoreOrProba_1" < CAST(0.0 AS DOUBLE PRECISION)) THEN CAST(0.142857142857143 AS DOUBLE PRECISION) WHEN ("Calibrated_Model_2"."ScoreOrProba_1" < CAST(0.571428571428571 AS DOUBLE PRECISION)) THEN ("Calibrated_Model_2"."ScoreOrProba_1" - CAST(0.0 AS DOUBLE PRECISION)) * CAST(0.916666666666666 AS DOUBLE PRECISION) + CAST(0.142857142857143 AS DOUBLE PRECISION) WHEN ("Calibrated_Model_2"."ScoreOrProba_1" < CAST(1.0 AS DOUBLE PRECISION)) THEN ("Calibrated_Model_2"."ScoreOrProba_1" - CAST(0.571428571428571 AS DOUBLE PRECISION)) * CAST(0.0 AS DOUBLE PRECISION) + CAST(0.666666666666667 AS DOUBLE PRECISION) ELSE CAST(0.666666666666667 AS DOUBLE PRECISION) END AS "Proba_1", CASE WHEN ("Calibrated_Model_2"."ScoreOrProba_2" < CAST(0.0 AS DOUBLE PRECISION)) THEN CAST(0.133333333333333 AS DOUBLE PRECISION) WHEN ("Calibrated_Model_2"."ScoreOrProba_2" < CAST(0.25 AS DOUBLE PRECISION)) THEN ("Calibrated_Model_2"."ScoreOrProba_2" - CAST(0.0 AS DOUBLE PRECISION)) * CAST(0.0 AS DOUBLE PRECISION) + CAST(0.133333333333333 AS DOUBLE PRECISION) WHEN ("Calibrated_Model_2"."ScoreOrProba_2" < CAST(1.0 AS DOUBLE PRECISION)) THEN ("Calibrated_Model_2"."ScoreOrProba_2" - CAST(0.25 AS DOUBLE PRECISION)) * CAST(0.266666666666667 AS DOUBLE PRECISION) + CAST(0.133333333333333 AS DOUBLE PRECISION) ELSE CAST(0.333333333333333 AS DOUBLE PRECISION) END AS "Proba_2", CASE WHEN ("Calibrated_Model_2"."ScoreOrProba_3" < CAST(0.0 AS DOUBLE PRECISION)) THEN CAST(0.083333333333333 AS DOUBLE PRECISION) WHEN ("Calibrated_Model_2"."ScoreOrProba_3" < CAST(0.285714285714286 AS DOUBLE PRECISION)) THEN ("Calibrated_Model_2"."ScoreOrProba_3" - CAST(0.0 AS DOUBLE PRECISION)) * CAST(0.0 AS DOUBLE PRECISION) + CAST(0.083333333333333 AS DOUBLE PRECISION) WHEN ("Calibrated_Model_2"."ScoreOrProba_3" < CAST(1.0 AS DOUBLE PRECISION)) THEN ("Calibrated_Model_2"."ScoreOrProba_3" - CAST(0.285714285714286 AS DOUBLE PRECISION)) * CAST(0.723333333333333 AS DOUBLE PRECISION) + CAST(0.083333333333333 AS DOUBLE PRECISION) ELSE CAST(0.6 AS DOUBLE PRECISION) END AS "Proba_3" 
...
FROM "DT_Output_3"), 
isotonic_cte_3 AS 
(SELECT "Calibrated_Model_3"."KEY" AS "KEY", CASE WHEN ("Calibrated_Model_3"."ScoreOrProba_0" < CAST(0.0 AS DOUBLE PRECISION)) THEN CAST(0.076923076923077 AS DOUBLE PRECISION) WHEN ("Calibrated_Model_3"."ScoreOrProba_0" < CAST(1.0 AS DOUBLE PRECISION)) THEN ("Calibrated_Model_3"."ScoreOrProba_0" - CAST(0.0 AS DOUBLE PRECISION)) * CAST(0.423076923076923 AS DOUBLE PRECISION) + CAST(0.076923076923077 AS DOUBLE PRECISION) ELSE CAST(0.5 AS DOUBLE PRECISION) END AS "Proba_0", CASE WHEN ("Calibrated_Model_3"."ScoreOrProba_1" < CAST(0.0 AS DOUBLE PRECISION)) THEN CAST(0.153846153846154 AS DOUBLE PRECISION) WHEN ("Calibrated_Model_3"."ScoreOrProba_1" < CAST(1.0 AS DOUBLE PRECISION)) THEN ("Calibrated_Model_3"."ScoreOrProba_1" - CAST(0.0 AS DOUBLE PRECISION)) * CAST(0.346153846153846 AS DOUBLE PRECISION) + CAST(0.153846153846154 AS DOUBLE PRECISION) ELSE CAST(0.5 AS DOUBLE PRECISION) END AS "Proba_1", CASE WHEN ("Calibrated_Model_3"."ScoreOrProba_2" < CAST(0.0 AS DOUBLE PRECISION)) THEN CAST(0.1875 AS DOUBLE PRECISION) WHEN ("Calibrated_Model_3"."ScoreOrProba_2" < CAST(1.0 AS DOUBLE PRECISION)) THEN ("Calibrated_Model_3"."ScoreOrProba_2" - CAST(0.0 AS DOUBLE PRECISION)) * CAST(0.479166666666667 AS DOUBLE PRECISION) + CAST(0.1875 AS DOUBLE PRECISION) ELSE CAST(0.666666666666667 AS DOUBLE PRECISION) END AS "Proba_2", CASE WHEN ("Calibrated_Model_3"."ScoreOrProba_3" < CAST(0.0 AS DOUBLE PRECISION)) THEN CAST(0.133333333333333 AS DOUBLE PRECISION) WHEN ("Calibrated_Model_3"."ScoreOrProba_3" < CAST(1.0 AS DOUBLE PRECISION)) THEN ("Calibrated_Model_3"."ScoreOrProba_3" - CAST(0.0 AS DOUBLE PRECISION)) * CAST(0.616666666666667 AS DOUBLE PRECISION) + CAST(0.133333333333333 AS DOUBLE PRECISION) ELSE CAST(0.75 AS DOUBLE PRECISION) END AS "Proba_3" 
...
-- Code For temporary table tmp_20180508181139_codegen_jgviz3_calprob_union part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180508181139_codegen_jgviz3_calprob_union  (
	"KEY" BIGINT, 
	"Proba_0" DOUBLE PRECISION, 
	"Proba_1" DOUBLE PRECISION, 
	"Proba_2" DOUBLE PRECISION, 
...
-- Code For temporary table tmp_20180508181139_codegen_jgviz3_calprob_union part 2. Populate

INSERT INTO tmp_20180508181139_codegen_jgviz3_calprob_union ("KEY", "Proba_0", "Proba_1", "Proba_2", "Proba_3") SELECT "U"."KEY", "U"."Proba_0", "U"."Proba_1", "U"."Proba_2", "U"."Proba_3" 
...
FROM tmp_20180508181139_codegen_04z5uh_calprob_b0 AS "CalProb_B0") AS "CalProb_EnsembleUnion") AS "CalProb_Union") AS "U"

-- Code For temporary table tmp_20180508181139_codegen_o852rn_calprob_avg part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180508181139_codegen_o852rn_calprob_avg  (
	"KEY" BIGINT, 
	"Proba_0" DOUBLE PRECISION, 
	"Proba_1" DOUBLE PRECISION, 
	"Proba_2" DOUBLE PRECISION, 
...
-- Code For temporary table tmp_20180508181139_codegen_o852rn_calprob_avg part 2. Populate

INSERT INTO tmp_20180508181139_codegen_o852rn_calprob_avg ("KEY", "Proba_0", "Proba_1", "Proba_2", "Proba_3") SELECT "U"."KEY", "U"."Proba_0", "U"."Proba_1", "U"."Proba_2", "U"."Proba_3" 
...
FROM tmp_20180508181139_codegen_jgviz3_calprob_union AS "CalProb_Union" GROUP BY "CalProb_Union"."KEY") AS "T") AS "CalProb_avg") AS "U"
...
FROM tmp_20180508181139_codegen_o852rn_calprob_avg AS "CalProb_avg"), 
