...
-- Code For temporary table tmp_20180508180209_codegen_pcq38g_ads_imp_1_out part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180508180209_codegen_pcq38g_ads_imp_1_out (
	"KEY" BIGINT, 
	impter_2 DOUBLE, 
	impter_3 DOUBLE, 
	impter_4 DOUBLE, 
...
-- Code For temporary table tmp_20180508180209_codegen_y3vz9b_ads_sca_2_out part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180508180209_codegen_y3vz9b_ads_sca_2_out (
	"KEY" BIGINT, 
	scaler_2 DOUBLE, 
	scaler_3 DOUBLE, 
	scaler_4 DOUBLE, 
...
FROM tmp_20180508180209_codegen_pcq38g_ads_imp_1_out AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT"

-- Code For temporary table tmp_20180508180209_codegen_5fnbd9_calprob_b0 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180508180209_codegen_5fnbd9_calprob_b0 (
	"KEY" BIGINT, 
	"Proba_1" DOUBLE, 
	"Proba_0" DOUBLE
)
...
-- Code For temporary table tmp_20180508180209_codegen_5fnbd9_calprob_b0 part 2. Populate

INSERT INTO tmp_20180508180209_codegen_5fnbd9_calprob_b0 WITH "DT_node_lookup" AS 
...
FROM tmp_20180508180209_codegen_y3vz9b_ads_sca_2_out AS "ADS_sca_2_OUT"), 
"DT_node_data" AS 
...
-- Code For temporary table tmp_20180508180209_codegen_kmi8hf_calprob_union part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180508180209_codegen_kmi8hf_calprob_union (
	"KEY" BIGINT, 
	"Proba_1" DOUBLE, 
	"Proba_0" DOUBLE
)
...
-- Code For temporary table tmp_20180508180209_codegen_kmi8hf_calprob_union part 2. Populate

INSERT INTO tmp_20180508180209_codegen_kmi8hf_calprob_union SELECT "CalProb_Union"."KEY", "CalProb_Union"."Proba_1", "CalProb_Union"."Proba_0" 
...
FROM tmp_20180508180209_codegen_5fnbd9_calprob_b0 AS "CalProb_B0") AS "CalProb_EnsembleUnion") AS "CalProb_Union"

-- Code For temporary table tmp_20180508180209_codegen_xrow9c_calprob_avg part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180508180209_codegen_xrow9c_calprob_avg (
	"KEY" BIGINT, 
	"Proba_1" DOUBLE, 
	"Proba_0" DOUBLE
)
...
-- Code For temporary table tmp_20180508180209_codegen_xrow9c_calprob_avg part 2. Populate

INSERT INTO tmp_20180508180209_codegen_xrow9c_calprob_avg SELECT "CalProb_avg"."KEY", "CalProb_avg"."Proba_1", "CalProb_avg"."Proba_0" 
...
FROM tmp_20180508180209_codegen_kmi8hf_calprob_union AS "CalProb_Union" GROUP BY "CalProb_Union"."KEY") AS "T") AS "CalProb_avg"
...
FROM tmp_20180508180209_codegen_xrow9c_calprob_avg AS "CalProb_avg"), 
