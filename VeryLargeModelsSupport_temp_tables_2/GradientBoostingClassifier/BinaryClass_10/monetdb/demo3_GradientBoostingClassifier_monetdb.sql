...
-- Code For temporary table tmp_20180508175827_codegen_zfijta_gb_b0 part 1. Create 


CREATE TEMPORARY TABLE tmp_20180508175827_codegen_zfijta_gb_b0 (
	"KEY" BIGINT, 
	"Score_0" DOUBLE, 
	"Score_1" DOUBLE
)
...
-- Code For temporary table tmp_20180508175827_codegen_zfijta_gb_b0 part 2. Populate

INSERT INTO tmp_20180508175827_codegen_zfijta_gb_b0 ("KEY", "Score_0", "Score_1") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1" 
...
-- Code For temporary table tmp_20180508175827_codegen_a7ls2d_gb_b1 part 1. Create 


CREATE TEMPORARY TABLE tmp_20180508175827_codegen_a7ls2d_gb_b1 (
	"KEY" BIGINT, 
	"Score_0" DOUBLE, 
	"Score_1" DOUBLE
)
...
-- Code For temporary table tmp_20180508175827_codegen_a7ls2d_gb_b1 part 2. Populate

INSERT INTO tmp_20180508175827_codegen_a7ls2d_gb_b1 ("KEY", "Score_0", "Score_1") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1" 
...
-- Code For temporary table tmp_20180508175827_codegen_h8yj4p_gb_b2 part 1. Create 


CREATE TEMPORARY TABLE tmp_20180508175827_codegen_h8yj4p_gb_b2 (
	"KEY" BIGINT, 
	"Score_0" DOUBLE, 
	"Score_1" DOUBLE
)
...
-- Code For temporary table tmp_20180508175827_codegen_h8yj4p_gb_b2 part 2. Populate

INSERT INTO tmp_20180508175827_codegen_h8yj4p_gb_b2 ("KEY", "Score_0", "Score_1") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1" 
...
-- Code For temporary table tmp_20180508175827_codegen_74tz7b_gb_b3 part 1. Create 


CREATE TEMPORARY TABLE tmp_20180508175827_codegen_74tz7b_gb_b3 (
	"KEY" BIGINT, 
	"Score_0" DOUBLE, 
	"Score_1" DOUBLE
)
...
-- Code For temporary table tmp_20180508175827_codegen_74tz7b_gb_b3 part 2. Populate

INSERT INTO tmp_20180508175827_codegen_74tz7b_gb_b3 ("KEY", "Score_0", "Score_1") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1" 
...
-- Code For temporary table tmp_20180508175827_codegen_0ubw19_gb_union part 1. Create 


CREATE TEMPORARY TABLE tmp_20180508175827_codegen_0ubw19_gb_union (
	"KEY" BIGINT, 
	"Score_0" DOUBLE, 
	"Score_1" DOUBLE
)
...
-- Code For temporary table tmp_20180508175827_codegen_0ubw19_gb_union part 2. Populate

INSERT INTO tmp_20180508175827_codegen_0ubw19_gb_union ("KEY", "Score_0", "Score_1") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1" 
...
FROM tmp_20180508175827_codegen_zfijta_gb_b0 AS "GB_B0" UNION ALL SELECT "GB_B1"."KEY" AS "KEY", "GB_B1"."Score_0" AS "Score_0", "GB_B1"."Score_1" AS "Score_1" 
FROM tmp_20180508175827_codegen_a7ls2d_gb_b1 AS "GB_B1" UNION ALL SELECT "GB_B2"."KEY" AS "KEY", "GB_B2"."Score_0" AS "Score_0", "GB_B2"."Score_1" AS "Score_1" 
FROM tmp_20180508175827_codegen_h8yj4p_gb_b2 AS "GB_B2" UNION ALL SELECT "GB_B3"."KEY" AS "KEY", "GB_B3"."Score_0" AS "Score_0", "GB_B3"."Score_1" AS "Score_1" 
FROM tmp_20180508175827_codegen_74tz7b_gb_b3 AS "GB_B3") AS "GB_EnsembleUnion") AS "GB_Union") AS "U"

-- Code For temporary table tmp_20180508175827_codegen_23ci0l_gb_sum part 1. Create 


CREATE TEMPORARY TABLE tmp_20180508175827_codegen_23ci0l_gb_sum (
	"KEY" BIGINT, 
	"Score_0" DOUBLE, 
	"Score_1" DOUBLE
)
...
-- Code For temporary table tmp_20180508175827_codegen_23ci0l_gb_sum part 2. Populate

INSERT INTO tmp_20180508175827_codegen_23ci0l_gb_sum ("KEY", "Score_0", "Score_1") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1" 
...
FROM tmp_20180508175827_codegen_0ubw19_gb_union AS "GB_Union" GROUP BY "GB_Union"."KEY") AS "T") AS "GB_sum") AS "U"
...
FROM tmp_20180508175827_codegen_23ci0l_gb_sum AS "GB_sum"), 
