...
-- Code For temporary table TMP_20180508175828_CODEGEN_ASVZ part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508175828_CODEGEN_ASVZ" (
	"KEY" BIGINT, 
...
-- Code For temporary table TMP_20180508175828_CODEGEN_ASVZ part 2. Populate

INSERT INTO "TMP_20180508175828_CODEGEN_ASVZ" ("KEY", "Score_0", "Score_1") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1" 
...
-- Code For temporary table TMP_20180508175828_CODEGEN_AYUK part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508175828_CODEGEN_AYUK" (
	"KEY" BIGINT, 
	"Score_0" DOUBLE PRECISION, 
	"Score_1" DOUBLE PRECISION
)
...
-- Code For temporary table TMP_20180508175828_CODEGEN_AYUK part 2. Populate

INSERT INTO "TMP_20180508175828_CODEGEN_AYUK" ("KEY", "Score_0", "Score_1") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1" 
...
-- Code For temporary table TMP_20180508175828_CODEGEN_QBDK part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508175828_CODEGEN_QBDK" (
	"KEY" BIGINT, 
	"Score_0" DOUBLE PRECISION, 
	"Score_1" DOUBLE PRECISION
)
...
-- Code For temporary table TMP_20180508175828_CODEGEN_QBDK part 2. Populate

INSERT INTO "TMP_20180508175828_CODEGEN_QBDK" ("KEY", "Score_0", "Score_1") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1" 
...
-- Code For temporary table TMP_20180508175828_CODEGEN_93GF part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508175828_CODEGEN_93GF" (
	"KEY" BIGINT, 
	"Score_0" DOUBLE PRECISION, 
	"Score_1" DOUBLE PRECISION
)
...
-- Code For temporary table TMP_20180508175828_CODEGEN_93GF part 2. Populate

INSERT INTO "TMP_20180508175828_CODEGEN_93GF" ("KEY", "Score_0", "Score_1") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1" 
...
-- Code For temporary table TMP_20180508175828_CODEGEN_V4FQ part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508175828_CODEGEN_V4FQ" (
	"KEY" BIGINT, 
	"Score_0" DOUBLE PRECISION, 
	"Score_1" DOUBLE PRECISION
)
...
-- Code For temporary table TMP_20180508175828_CODEGEN_V4FQ part 2. Populate

INSERT INTO "TMP_20180508175828_CODEGEN_V4FQ" ("KEY", "Score_0", "Score_1") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1" 
...
FROM "TMP_20180508175828_CODEGEN_ASVZ" AS "GB_B0" UNION ALL SELECT "GB_B1"."KEY" AS "KEY", "GB_B1"."Score_0" AS "Score_0", "GB_B1"."Score_1" AS "Score_1" 
FROM "TMP_20180508175828_CODEGEN_AYUK" AS "GB_B1" UNION ALL SELECT "GB_B2"."KEY" AS "KEY", "GB_B2"."Score_0" AS "Score_0", "GB_B2"."Score_1" AS "Score_1" 
FROM "TMP_20180508175828_CODEGEN_QBDK" AS "GB_B2" UNION ALL SELECT "GB_B3"."KEY" AS "KEY", "GB_B3"."Score_0" AS "Score_0", "GB_B3"."Score_1" AS "Score_1" 
FROM "TMP_20180508175828_CODEGEN_93GF" AS "GB_B3") AS "GB_EnsembleUnion") AS "GB_Union") AS "U"

-- Code For temporary table TMP_20180508175828_CODEGEN_IG2Z part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508175828_CODEGEN_IG2Z" (
	"KEY" BIGINT NOT NULL, 
	"Score_0" DOUBLE PRECISION, 
	"Score_1" DOUBLE PRECISION, 
	PRIMARY KEY ("KEY")
...
-- Code For temporary table TMP_20180508175828_CODEGEN_IG2Z part 2. Populate

INSERT INTO "TMP_20180508175828_CODEGEN_IG2Z" ("KEY", "Score_0", "Score_1") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1" 
...
FROM "TMP_20180508175828_CODEGEN_V4FQ" AS "GB_Union" GROUP BY "GB_Union"."KEY") AS "T") AS "GB_sum") AS "U"

-- Code For temporary table TMP_20180508175828_CODEGEN_IG2Z part 3. Create Index 

CREATE INDEX "ix_TMP_20180508175828_C_6d40" ON "TMP_20180508175828_CODEGEN_IG2Z" ("KEY")
...
FROM "TMP_20180508175828_CODEGEN_IG2Z" AS "GB_sum"), 
