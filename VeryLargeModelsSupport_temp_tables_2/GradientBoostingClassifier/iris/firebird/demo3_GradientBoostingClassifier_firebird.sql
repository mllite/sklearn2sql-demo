...
-- Code For temporary table TMP_20180508185620_CODEGEN_9YI2 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508185620_CODEGEN_9YI2" (
	"KEY" BIGINT, 
...
-- Code For temporary table TMP_20180508185620_CODEGEN_9YI2 part 2. Populate

INSERT INTO "TMP_20180508185620_CODEGEN_9YI2" ("KEY", "Score_0", "Score_1", "Score_2") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1", "U"."Score_2" 
...
-- Code For temporary table TMP_20180508185620_CODEGEN_3U2Y part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508185620_CODEGEN_3U2Y" (
	"KEY" BIGINT, 
	"Score_0" DOUBLE PRECISION, 
	"Score_1" DOUBLE PRECISION, 
	"Score_2" DOUBLE PRECISION
...
-- Code For temporary table TMP_20180508185620_CODEGEN_3U2Y part 2. Populate

INSERT INTO "TMP_20180508185620_CODEGEN_3U2Y" ("KEY", "Score_0", "Score_1", "Score_2") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1", "U"."Score_2" 
...
-- Code For temporary table TMP_20180508185620_CODEGEN_9XPD part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508185620_CODEGEN_9XPD" (
	"KEY" BIGINT, 
	"Score_0" DOUBLE PRECISION, 
	"Score_1" DOUBLE PRECISION, 
	"Score_2" DOUBLE PRECISION
...
-- Code For temporary table TMP_20180508185620_CODEGEN_9XPD part 2. Populate

INSERT INTO "TMP_20180508185620_CODEGEN_9XPD" ("KEY", "Score_0", "Score_1", "Score_2") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1", "U"."Score_2" 
...
-- Code For temporary table TMP_20180508185620_CODEGEN_7K1U part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508185620_CODEGEN_7K1U" (
	"KEY" BIGINT, 
	"Score_0" DOUBLE PRECISION, 
	"Score_1" DOUBLE PRECISION, 
	"Score_2" DOUBLE PRECISION
...
-- Code For temporary table TMP_20180508185620_CODEGEN_7K1U part 2. Populate

INSERT INTO "TMP_20180508185620_CODEGEN_7K1U" ("KEY", "Score_0", "Score_1", "Score_2") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1", "U"."Score_2" 
...
-- Code For temporary table TMP_20180508185620_CODEGEN_X09M part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508185620_CODEGEN_X09M" (
	"KEY" BIGINT, 
	"Score_0" DOUBLE PRECISION, 
	"Score_1" DOUBLE PRECISION, 
	"Score_2" DOUBLE PRECISION
...
-- Code For temporary table TMP_20180508185620_CODEGEN_X09M part 2. Populate

INSERT INTO "TMP_20180508185620_CODEGEN_X09M" ("KEY", "Score_0", "Score_1", "Score_2") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1", "U"."Score_2" 
...
-- Code For temporary table TMP_20180508185620_CODEGEN_6U16 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508185620_CODEGEN_6U16" (
	"KEY" BIGINT, 
	"Score_0" DOUBLE PRECISION, 
	"Score_1" DOUBLE PRECISION, 
	"Score_2" DOUBLE PRECISION
...
-- Code For temporary table TMP_20180508185620_CODEGEN_6U16 part 2. Populate

INSERT INTO "TMP_20180508185620_CODEGEN_6U16" ("KEY", "Score_0", "Score_1", "Score_2") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1", "U"."Score_2" 
...
FROM "TMP_20180508185620_CODEGEN_9YI2" AS "GB_B0" UNION ALL SELECT "GB_B1"."KEY" AS "KEY", "GB_B1"."Score_0" AS "Score_0", "GB_B1"."Score_1" AS "Score_1", "GB_B1"."Score_2" AS "Score_2" 
FROM "TMP_20180508185620_CODEGEN_3U2Y" AS "GB_B1" UNION ALL SELECT "GB_B2"."KEY" AS "KEY", "GB_B2"."Score_0" AS "Score_0", "GB_B2"."Score_1" AS "Score_1", "GB_B2"."Score_2" AS "Score_2" 
FROM "TMP_20180508185620_CODEGEN_9XPD" AS "GB_B2" UNION ALL SELECT "GB_B3"."KEY" AS "KEY", "GB_B3"."Score_0" AS "Score_0", "GB_B3"."Score_1" AS "Score_1", "GB_B3"."Score_2" AS "Score_2" 
FROM "TMP_20180508185620_CODEGEN_7K1U" AS "GB_B3" UNION ALL SELECT "GB_B4"."KEY" AS "KEY", "GB_B4"."Score_0" AS "Score_0", "GB_B4"."Score_1" AS "Score_1", "GB_B4"."Score_2" AS "Score_2" 
FROM "TMP_20180508185620_CODEGEN_X09M" AS "GB_B4") AS "GB_EnsembleUnion") AS "GB_Union") AS "U"

-- Code For temporary table TMP_20180508185620_CODEGEN_09RI part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508185620_CODEGEN_09RI" (
	"KEY" BIGINT NOT NULL, 
	"Score_0" DOUBLE PRECISION, 
	"Score_1" DOUBLE PRECISION, 
	"Score_2" DOUBLE PRECISION, 
...
-- Code For temporary table TMP_20180508185620_CODEGEN_09RI part 2. Populate

INSERT INTO "TMP_20180508185620_CODEGEN_09RI" ("KEY", "Score_0", "Score_1", "Score_2") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1", "U"."Score_2" 
...
FROM "TMP_20180508185620_CODEGEN_6U16" AS "GB_Union" GROUP BY "GB_Union"."KEY") AS "T") AS "GB_sum") AS "U"

-- Code For temporary table TMP_20180508185620_CODEGEN_09RI part 3. Create Index 

CREATE INDEX "ix_TMP_20180508185620_C_9b4d" ON "TMP_20180508185620_CODEGEN_09RI" ("KEY")
...
FROM "TMP_20180508185620_CODEGEN_09RI" AS "GB_sum"), 
