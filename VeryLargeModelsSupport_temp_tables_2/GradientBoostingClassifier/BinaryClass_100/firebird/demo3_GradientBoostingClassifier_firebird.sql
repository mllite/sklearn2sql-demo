...
-- Code For temporary table TMP_20180508180309_CODEGEN_ME3L part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508180309_CODEGEN_ME3L" (
	"KEY" BIGINT, 
...
-- Code For temporary table TMP_20180508180309_CODEGEN_ME3L part 2. Populate

INSERT INTO "TMP_20180508180309_CODEGEN_ME3L" ("KEY", "Score_0", "Score_1") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1" 
...
-- Code For temporary table TMP_20180508180309_CODEGEN_VUFE part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508180309_CODEGEN_VUFE" (
	"KEY" BIGINT, 
	"Score_0" DOUBLE PRECISION, 
	"Score_1" DOUBLE PRECISION
)
...
-- Code For temporary table TMP_20180508180309_CODEGEN_VUFE part 2. Populate

INSERT INTO "TMP_20180508180309_CODEGEN_VUFE" ("KEY", "Score_0", "Score_1") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1" 
...
-- Code For temporary table TMP_20180508180309_CODEGEN_7D2S part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508180309_CODEGEN_7D2S" (
	"KEY" BIGINT, 
	"Score_0" DOUBLE PRECISION, 
	"Score_1" DOUBLE PRECISION
)
...
-- Code For temporary table TMP_20180508180309_CODEGEN_7D2S part 2. Populate

INSERT INTO "TMP_20180508180309_CODEGEN_7D2S" ("KEY", "Score_0", "Score_1") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1" 
...
-- Code For temporary table TMP_20180508180309_CODEGEN_0ZTR part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508180309_CODEGEN_0ZTR" (
	"KEY" BIGINT, 
	"Score_0" DOUBLE PRECISION, 
	"Score_1" DOUBLE PRECISION
)
...
-- Code For temporary table TMP_20180508180309_CODEGEN_0ZTR part 2. Populate

INSERT INTO "TMP_20180508180309_CODEGEN_0ZTR" ("KEY", "Score_0", "Score_1") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1" 
...
-- Code For temporary table TMP_20180508180309_CODEGEN_Q8ON part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508180309_CODEGEN_Q8ON" (
	"KEY" BIGINT, 
	"Score_0" DOUBLE PRECISION, 
	"Score_1" DOUBLE PRECISION
)
...
-- Code For temporary table TMP_20180508180309_CODEGEN_Q8ON part 2. Populate

INSERT INTO "TMP_20180508180309_CODEGEN_Q8ON" ("KEY", "Score_0", "Score_1") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1" 
...
FROM "TMP_20180508180309_CODEGEN_ME3L" AS "GB_B0" UNION ALL SELECT "GB_B1"."KEY" AS "KEY", "GB_B1"."Score_0" AS "Score_0", "GB_B1"."Score_1" AS "Score_1" 
FROM "TMP_20180508180309_CODEGEN_VUFE" AS "GB_B1" UNION ALL SELECT "GB_B2"."KEY" AS "KEY", "GB_B2"."Score_0" AS "Score_0", "GB_B2"."Score_1" AS "Score_1" 
FROM "TMP_20180508180309_CODEGEN_7D2S" AS "GB_B2" UNION ALL SELECT "GB_B3"."KEY" AS "KEY", "GB_B3"."Score_0" AS "Score_0", "GB_B3"."Score_1" AS "Score_1" 
FROM "TMP_20180508180309_CODEGEN_0ZTR" AS "GB_B3") AS "GB_EnsembleUnion") AS "GB_Union") AS "U"

-- Code For temporary table TMP_20180508180309_CODEGEN_UW4U part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508180309_CODEGEN_UW4U" (
	"KEY" BIGINT NOT NULL, 
	"Score_0" DOUBLE PRECISION, 
	"Score_1" DOUBLE PRECISION, 
	PRIMARY KEY ("KEY")
...
-- Code For temporary table TMP_20180508180309_CODEGEN_UW4U part 2. Populate

INSERT INTO "TMP_20180508180309_CODEGEN_UW4U" ("KEY", "Score_0", "Score_1") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1" 
...
FROM "TMP_20180508180309_CODEGEN_Q8ON" AS "GB_Union" GROUP BY "GB_Union"."KEY") AS "T") AS "GB_sum") AS "U"

-- Code For temporary table TMP_20180508180309_CODEGEN_UW4U part 3. Create Index 

CREATE INDEX "ix_TMP_20180508180309_C_c778" ON "TMP_20180508180309_CODEGEN_UW4U" ("KEY")
...
FROM "TMP_20180508180309_CODEGEN_UW4U" AS "GB_sum"), 
