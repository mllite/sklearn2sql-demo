...
-- Code For temporary table TMP_20180508175925_CODEGEN_4H1V part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508175925_CODEGEN_4H1V" (
	"KEY" BIGINT, 
...
-- Code For temporary table TMP_20180508175925_CODEGEN_4H1V part 2. Populate

INSERT INTO "TMP_20180508175925_CODEGEN_4H1V" ("KEY", "Score_0", "Proba_0", "LogProba_0", "Score_1", "Proba_1", "LogProba_1") SELECT "U"."KEY", "U"."Score_0", "U"."Proba_0", "U"."LogProba_0", "U"."Score_1", "U"."Proba_1", "U"."LogProba_1" 
...
-- Code For temporary table TMP_20180508175925_CODEGEN_PDO5 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508175925_CODEGEN_PDO5" (
	"KEY" BIGINT, 
	"Score_0" DOUBLE PRECISION, 
	"Proba_0" DOUBLE PRECISION, 
	"LogProba_0" DOUBLE PRECISION, 
...
-- Code For temporary table TMP_20180508175925_CODEGEN_PDO5 part 2. Populate

INSERT INTO "TMP_20180508175925_CODEGEN_PDO5" ("KEY", "Score_0", "Proba_0", "LogProba_0", "Score_1", "Proba_1", "LogProba_1") SELECT "U"."KEY", "U"."Score_0", "U"."Proba_0", "U"."LogProba_0", "U"."Score_1", "U"."Proba_1", "U"."LogProba_1" 
...
-- Code For temporary table TMP_20180508175925_CODEGEN_NZHM part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508175925_CODEGEN_NZHM" (
	"KEY" BIGINT, 
	"Score_0" DOUBLE PRECISION, 
	"Proba_0" DOUBLE PRECISION, 
	"LogProba_0" DOUBLE PRECISION, 
...
-- Code For temporary table TMP_20180508175925_CODEGEN_NZHM part 2. Populate

INSERT INTO "TMP_20180508175925_CODEGEN_NZHM" ("KEY", "Score_0", "Proba_0", "LogProba_0", "Score_1", "Proba_1", "LogProba_1") SELECT "U"."KEY", "U"."Score_0", "U"."Proba_0", "U"."LogProba_0", "U"."Score_1", "U"."Proba_1", "U"."LogProba_1" 
...
FROM "TMP_20180508175925_CODEGEN_4H1V" AS "RF_B0" UNION ALL SELECT "RF_B1"."KEY" AS "KEY", "RF_B1"."Score_0" AS "Score_0", "RF_B1"."Proba_0" AS "Proba_0", "RF_B1"."LogProba_0" AS "LogProba_0", "RF_B1"."Score_1" AS "Score_1", "RF_B1"."Proba_1" AS "Proba_1", "RF_B1"."LogProba_1" AS "LogProba_1" 
FROM "TMP_20180508175925_CODEGEN_PDO5" AS "RF_B1") AS "RF_EnsembleUnion") AS "RF_Union") AS "U"

-- Code For temporary table TMP_20180508175925_CODEGEN_818N part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508175925_CODEGEN_818N" (
	"KEY" BIGINT NOT NULL, 
	"Score_0" DOUBLE PRECISION, 
	"Proba_0" DOUBLE PRECISION, 
	"LogProba_0" DOUBLE PRECISION, 
...
-- Code For temporary table TMP_20180508175925_CODEGEN_818N part 2. Populate

INSERT INTO "TMP_20180508175925_CODEGEN_818N" ("KEY", "Score_0", "Proba_0", "LogProba_0", "Score_1", "Proba_1", "LogProba_1") SELECT "U"."KEY", "U"."Score_0", "U"."Proba_0", "U"."LogProba_0", "U"."Score_1", "U"."Proba_1", "U"."LogProba_1" 
...
FROM "TMP_20180508175925_CODEGEN_NZHM" AS "RF_Union" GROUP BY "RF_Union"."KEY") AS "T") AS "RF_avg") AS "U"

-- Code For temporary table TMP_20180508175925_CODEGEN_818N part 3. Create Index 

CREATE INDEX "ix_TMP_20180508175925_C_4ec9" ON "TMP_20180508175925_CODEGEN_818N" ("KEY")
...
FROM "TMP_20180508175925_CODEGEN_818N" AS "RF_avg"), 
