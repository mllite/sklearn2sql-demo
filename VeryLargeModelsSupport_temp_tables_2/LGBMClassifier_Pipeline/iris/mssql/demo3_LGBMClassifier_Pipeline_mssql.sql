...
-- Code For temporary table ##TMP_20180508185641_CODEGEN_09TG2Q_ADS_imp_1_OUT part 1. Create 


CREATE TABLE ##TMP_20180508185641_CODEGEN_09TG2Q_ADS_imp_1_OUT (
	[KEY] BIGINT NULL, 
...
-- Code For temporary table ##TMP_20180508185641_CODEGEN_09TG2Q_ADS_imp_1_OUT part 2. Populate

INSERT INTO ##TMP_20180508185641_CODEGEN_09TG2Q_ADS_imp_1_OUT ([KEY], imputer_output_2, imputer_output_3, imputer_output_4, imputer_output_5) SELECT [ADS_imp_1_OUT].[KEY], [ADS_imp_1_OUT].imputer_output_2, [ADS_imp_1_OUT].imputer_output_3, [ADS_imp_1_OUT].imputer_output_4, [ADS_imp_1_OUT].imputer_output_5 
FROM (SELECT [ADS].[KEY] AS [KEY], CASE WHEN ([ADS].[Feature_0] IS NULL) THEN 5.8474999999999975 ELSE [ADS].[Feature_0] END AS imputer_output_2, CASE WHEN ([ADS].[Feature_1] IS NULL) THEN 3.0366666666666657 ELSE [ADS].[Feature_1] END AS imputer_output_3, CASE WHEN ([ADS].[Feature_2] IS NULL) THEN 3.8450000000000006 ELSE [ADS].[Feature_2] END AS imputer_output_4, CASE WHEN ([ADS].[Feature_3] IS NULL) THEN 1.245 ELSE [ADS].[Feature_3] END AS imputer_output_5 
FROM iris AS [ADS]) AS [ADS_imp_1_OUT]

-- Code For temporary table ##TMP_20180508185641_CODEGEN_XCNN6K_ADS_sca_2_OUT part 1. Create 


CREATE TABLE ##TMP_20180508185641_CODEGEN_XCNN6K_ADS_sca_2_OUT (
	[KEY] BIGINT NULL, 
...
-- Code For temporary table ##TMP_20180508185641_CODEGEN_XCNN6K_ADS_sca_2_OUT part 2. Populate

INSERT INTO ##TMP_20180508185641_CODEGEN_XCNN6K_ADS_sca_2_OUT ([KEY], scaler_output_2, scaler_output_3, scaler_output_4, scaler_output_5) SELECT [ADS_sca_2_OUT].[KEY], [ADS_sca_2_OUT].scaler_output_2, [ADS_sca_2_OUT].scaler_output_3, [ADS_sca_2_OUT].scaler_output_4, [ADS_sca_2_OUT].scaler_output_5 
...
FROM ##TMP_20180508185641_CODEGEN_09TG2Q_ADS_imp_1_OUT AS [ADS_imp_1_OUT]) AS [ADS_sca_2_OUT]

-- Code For temporary table ##TMP_20180508185641_CODEGEN_5980OJ_LGBM_B0 part 1. Create 


CREATE TABLE ##TMP_20180508185641_CODEGEN_5980OJ_LGBM_B0 (
	[KEY] BIGINT NULL, 
...
-- Code For temporary table ##TMP_20180508185641_CODEGEN_5980OJ_LGBM_B0 part 2. Populate
...
FROM ##TMP_20180508185641_CODEGEN_XCNN6K_ADS_sca_2_OUT AS [ADS_sca_2_OUT]), 
[DT_node_data] AS 
...
FROM [DT_Output_9])
 INSERT INTO ##TMP_20180508185641_CODEGEN_5980OJ_LGBM_B0 ([KEY], [Score_0], [Score_1], [Score_2]) SELECT [LGBM_B0].[KEY], [LGBM_B0].[Score_0], [LGBM_B0].[Score_1], [LGBM_B0].[Score_2] 
...
-- Code For temporary table ##TMP_20180508185641_CODEGEN_2DLRZU_LGBM_B1 part 1. Create 


CREATE TABLE ##TMP_20180508185641_CODEGEN_2DLRZU_LGBM_B1 (
	[KEY] BIGINT NULL, 
	[Score_0] FLOAT(53) NULL, 
	[Score_1] FLOAT(53) NULL, 
	[Score_2] FLOAT(53) NULL
...
-- Code For temporary table ##TMP_20180508185641_CODEGEN_2DLRZU_LGBM_B1 part 2. Populate
...
FROM [DT_Output_19])
 INSERT INTO ##TMP_20180508185641_CODEGEN_2DLRZU_LGBM_B1 ([KEY], [Score_0], [Score_1], [Score_2]) SELECT [LGBM_B1].[KEY], [LGBM_B1].[Score_0], [LGBM_B1].[Score_1], [LGBM_B1].[Score_2] 
...
-- Code For temporary table ##TMP_20180508185641_CODEGEN_6J14G4_LGBM_B2 part 1. Create 


CREATE TABLE ##TMP_20180508185641_CODEGEN_6J14G4_LGBM_B2 (
	[KEY] BIGINT NULL, 
	[Score_0] FLOAT(53) NULL, 
	[Score_1] FLOAT(53) NULL, 
	[Score_2] FLOAT(53) NULL
...
-- Code For temporary table ##TMP_20180508185641_CODEGEN_6J14G4_LGBM_B2 part 2. Populate
...
FROM [DT_Output_29])
 INSERT INTO ##TMP_20180508185641_CODEGEN_6J14G4_LGBM_B2 ([KEY], [Score_0], [Score_1], [Score_2]) SELECT [LGBM_B2].[KEY], [LGBM_B2].[Score_0], [LGBM_B2].[Score_1], [LGBM_B2].[Score_2] 
...
-- Code For temporary table ##TMP_20180508185641_CODEGEN_SP4OAV_LGBM_B3 part 1. Create 


CREATE TABLE ##TMP_20180508185641_CODEGEN_SP4OAV_LGBM_B3 (
	[KEY] BIGINT NULL, 
	[Score_0] FLOAT(53) NULL, 
	[Score_1] FLOAT(53) NULL, 
	[Score_2] FLOAT(53) NULL
...
-- Code For temporary table ##TMP_20180508185641_CODEGEN_SP4OAV_LGBM_B3 part 2. Populate
...
FROM [DT_Output_39])
 INSERT INTO ##TMP_20180508185641_CODEGEN_SP4OAV_LGBM_B3 ([KEY], [Score_0], [Score_1], [Score_2]) SELECT [LGBM_B3].[KEY], [LGBM_B3].[Score_0], [LGBM_B3].[Score_1], [LGBM_B3].[Score_2] 
...
-- Code For temporary table ##TMP_20180508185641_CODEGEN_65IYZD_LGBM_B4 part 1. Create 


CREATE TABLE ##TMP_20180508185641_CODEGEN_65IYZD_LGBM_B4 (
	[KEY] BIGINT NULL, 
	[Score_0] FLOAT(53) NULL, 
	[Score_1] FLOAT(53) NULL, 
	[Score_2] FLOAT(53) NULL
...
-- Code For temporary table ##TMP_20180508185641_CODEGEN_65IYZD_LGBM_B4 part 2. Populate
...
FROM [DT_Output_47])
 INSERT INTO ##TMP_20180508185641_CODEGEN_65IYZD_LGBM_B4 ([KEY], [Score_0], [Score_1], [Score_2]) SELECT [LGBM_B4].[KEY], [LGBM_B4].[Score_0], [LGBM_B4].[Score_1], [LGBM_B4].[Score_2] 
...
-- Code For temporary table ##TMP_20180508185641_CODEGEN_JQHL2Y_LGBM_Union part 1. Create 


CREATE TABLE ##TMP_20180508185641_CODEGEN_JQHL2Y_LGBM_Union (
	[KEY] BIGINT NULL, 
	[Score_0] FLOAT(53) NULL, 
	[Score_1] FLOAT(53) NULL, 
	[Score_2] FLOAT(53) NULL
...
-- Code For temporary table ##TMP_20180508185641_CODEGEN_JQHL2Y_LGBM_Union part 2. Populate

INSERT INTO ##TMP_20180508185641_CODEGEN_JQHL2Y_LGBM_Union ([KEY], [Score_0], [Score_1], [Score_2]) SELECT [LGBM_Union].[KEY], [LGBM_Union].[Score_0], [LGBM_Union].[Score_1], [LGBM_Union].[Score_2] 
...
FROM ##TMP_20180508185641_CODEGEN_5980OJ_LGBM_B0 AS [LGBM_B0] UNION ALL SELECT [LGBM_B1].[KEY] AS [KEY], [LGBM_B1].[Score_0] AS [Score_0], [LGBM_B1].[Score_1] AS [Score_1], [LGBM_B1].[Score_2] AS [Score_2] 
FROM ##TMP_20180508185641_CODEGEN_2DLRZU_LGBM_B1 AS [LGBM_B1] UNION ALL SELECT [LGBM_B2].[KEY] AS [KEY], [LGBM_B2].[Score_0] AS [Score_0], [LGBM_B2].[Score_1] AS [Score_1], [LGBM_B2].[Score_2] AS [Score_2] 
FROM ##TMP_20180508185641_CODEGEN_6J14G4_LGBM_B2 AS [LGBM_B2] UNION ALL SELECT [LGBM_B3].[KEY] AS [KEY], [LGBM_B3].[Score_0] AS [Score_0], [LGBM_B3].[Score_1] AS [Score_1], [LGBM_B3].[Score_2] AS [Score_2] 
FROM ##TMP_20180508185641_CODEGEN_SP4OAV_LGBM_B3 AS [LGBM_B3] UNION ALL SELECT [LGBM_B4].[KEY] AS [KEY], [LGBM_B4].[Score_0] AS [Score_0], [LGBM_B4].[Score_1] AS [Score_1], [LGBM_B4].[Score_2] AS [Score_2] 
FROM ##TMP_20180508185641_CODEGEN_65IYZD_LGBM_B4 AS [LGBM_B4]) AS [LGBM_EnsembleUnion]) AS [LGBM_Union]

-- Code For temporary table ##TMP_20180508185641_CODEGEN_H1HUU0_LGBM_sum part 1. Create 


CREATE TABLE ##TMP_20180508185641_CODEGEN_H1HUU0_LGBM_sum (
	[KEY] BIGINT NULL, 
	[Score_0] FLOAT(53) NULL, 
	[Score_1] FLOAT(53) NULL, 
	[Score_2] FLOAT(53) NULL
...
-- Code For temporary table ##TMP_20180508185641_CODEGEN_H1HUU0_LGBM_sum part 2. Populate

INSERT INTO ##TMP_20180508185641_CODEGEN_H1HUU0_LGBM_sum ([KEY], [Score_0], [Score_1], [Score_2]) SELECT [LGBM_sum].[KEY], [LGBM_sum].[Score_0], [LGBM_sum].[Score_1], [LGBM_sum].[Score_2] 
...
FROM ##TMP_20180508185641_CODEGEN_JQHL2Y_LGBM_Union AS [LGBM_Union] GROUP BY [LGBM_Union].[KEY]) AS [T]) AS [LGBM_sum]
...
FROM ##TMP_20180508185641_CODEGEN_H1HUU0_LGBM_sum AS [LGBM_sum]), 
