...
-- Code For temporary table tmp_20180508181758_codegen_0mkf5v_ads_imp_1_out part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180508181758_codegen_0mkf5v_ads_imp_1_out (
	"KEY" BIGINT, 
	impter_2 DOUBLE, 
	impter_3 DOUBLE, 
	impter_4 DOUBLE, 
...
-- Code For temporary table tmp_20180508181758_codegen_vcpkjz_ads_sca_2_out part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180508181758_codegen_vcpkjz_ads_sca_2_out (
	"KEY" BIGINT, 
	scaler_2 DOUBLE, 
	scaler_3 DOUBLE, 
	scaler_4 DOUBLE, 
...
FROM tmp_20180508181758_codegen_0mkf5v_ads_imp_1_out AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT"

-- Code For temporary table tmp_20180508181759_codegen_t67zz0_lgbm_b0 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180508181759_codegen_t67zz0_lgbm_b0 (
	"KEY" BIGINT, 
	"Score_0" DOUBLE, 
	"Score_1" DOUBLE, 
	"Score_2" DOUBLE, 
...
-- Code For temporary table tmp_20180508181759_codegen_t67zz0_lgbm_b0 part 2. Populate

INSERT INTO tmp_20180508181759_codegen_t67zz0_lgbm_b0 WITH "DT_node_lookup" AS 
...
FROM tmp_20180508181758_codegen_vcpkjz_ads_sca_2_out AS "ADS_sca_2_OUT"), 
"DT_node_data" AS 
...
"DT_node_data_1" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE) AS "Score" 
FROM (SELECT 3 AS nid, 0.04000000000000001 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 4 AS nid, -0.029629629629629624 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 10 AS nid, -0.013333333333333336 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 11 AS nid, 0.03333333333333333 AS "Score" FROM SYSIBM.SYSDUMMY1) AS "Values"), 
"DT_Output_1" AS 
...
"DT_node_data_3" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE) AS "Score" 
FROM (SELECT 3 AS nid, 0.027619047619047623 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 4 AS nid, -0.033333333333333326 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 5 AS nid, 0.006172839506172839 AS "Score" FROM SYSIBM.SYSDUMMY1) AS "Values"), 
"DT_Output_3" AS 
...
"DT_node_data_4" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE) AS "Score" 
FROM (SELECT 4 AS nid, -0.01950137705240332 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 5 AS nid, -0.033116866801664334 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 6 AS nid, 0.04781539670855374 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 7 AS nid, -0.009422123523754237 AS "Score" FROM SYSIBM.SYSDUMMY1) AS "Values"), 
"DT_Output_4" AS 
...
"DT_node_data_5" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE) AS "Score" 
FROM (SELECT 3 AS nid, 0.03801363088997682 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 4 AS nid, -0.02932448464318399 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 10 AS nid, -0.013031594356816707 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 11 AS nid, 0.03196767946224493 AS "Score" FROM SYSIBM.SYSDUMMY1) AS "Values"), 
"DT_Output_5" AS 
...
"DT_node_data_6" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE) AS "Score" 
FROM (SELECT 2 AS nid, 0.04638783591701232 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 6 AS nid, 0.0034657951744659385 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 14 AS nid, -0.02634969149111432 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 15 AS nid, -0.033209690833556266 AS "Score" FROM SYSIBM.SYSDUMMY1) AS "Values"), 
"DT_Output_6" AS 
...
"DT_node_data_7" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE) AS "Score" 
FROM (SELECT 3 AS nid, 0.02675748219394763 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 5 AS nid, 0.011240839547350058 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 8 AS nid, -0.02634310269199366 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 9 AS nid, -0.033280777876280025 AS "Score" FROM SYSIBM.SYSDUMMY1) AS "Values"), 
"DT_Output_7" AS 
...
"DT_node_data_8" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE) AS "Score" 
FROM (SELECT 4 AS nid, -0.03288932934129021 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 5 AS nid, -0.018979159650187077 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 6 AS nid, 0.04528919771027677 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 7 AS nid, -0.00923136933403049 AS "Score" FROM SYSIBM.SYSDUMMY1) AS "Values"), 
"DT_Output_8" AS 
...
"DT_node_data_9" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE) AS "Score" 
FROM (SELECT 3 AS nid, 0.03601188358369819 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 4 AS nid, -0.02901065244136429 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 10 AS nid, -0.012779393567827178 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 11 AS nid, 0.03082650742811993 AS "Score" FROM SYSIBM.SYSDUMMY1) AS "Values"), 
"DT_Output_9" AS 
...
-- Code For temporary table tmp_20180508181759_codegen_lgnxlu_lgbm_b1 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180508181759_codegen_lgnxlu_lgbm_b1 (
	"KEY" BIGINT, 
	"Score_0" DOUBLE, 
	"Score_1" DOUBLE, 
	"Score_2" DOUBLE, 
...
-- Code For temporary table tmp_20180508181759_codegen_lgnxlu_lgbm_b1 part 2. Populate

INSERT INTO tmp_20180508181759_codegen_lgnxlu_lgbm_b1 WITH "DT_node_lookup_10" AS 
...
"DT_node_data_10" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE) AS "Score" 
FROM (SELECT 2 AS nid, 0.04392797619813257 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 6 AS nid, 0.0034995312760598384 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 14 AS nid, -0.025947628685301028 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 15 AS nid, -0.03298520699909284 AS "Score" FROM SYSIBM.SYSDUMMY1) AS "Values"), 
"DT_Output_10" AS 
...
"DT_node_data_11" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE) AS "Score" 
FROM (SELECT 3 AS nid, 0.02602074371562861 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 4 AS nid, -0.03282433362550692 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 5 AS nid, 0.0055247378514521606 AS "Score" FROM SYSIBM.SYSDUMMY1) AS "Values"), 
"DT_Output_11" AS 
...
"DT_node_data_12" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE) AS "Score" 
FROM (SELECT 4 AS nid, -0.03264995365787314 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 5 AS nid, -0.018595830886695815 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 6 AS nid, 0.050425691987455085 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 7 AS nid, -0.001749296984293454 AS "Score" FROM SYSIBM.SYSDUMMY1) AS "Values"), 
"DT_Output_12" AS 
...
"DT_node_data_13" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE) AS "Score" 
FROM (SELECT 2 AS nid, -0.021949004218140684 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 6 AS nid, -0.0157961023443223 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 7 AS nid, 0.03348313811293968 AS "Score" FROM SYSIBM.SYSDUMMY1) AS "Values"), 
"DT_Output_13" AS 
...
"DT_node_data_14" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE) AS "Score" 
FROM (SELECT 4 AS nid, 0.05918926165394689 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 5 AS nid, -0.013161794876484953 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 6 AS nid, -0.032972000921317655 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 7 AS nid, -0.00737896830596874 AS "Score" FROM SYSIBM.SYSDUMMY1) AS "Values"), 
"DT_Output_14" AS 
...
"DT_node_data_15" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE) AS "Score" 
FROM (SELECT 3 AS nid, 0.024883342651118974 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 5 AS nid, 0.011209397650172129 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 8 AS nid, -0.02574125662263579 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 9 AS nid, -0.03297883402734973 AS "Score" FROM SYSIBM.SYSDUMMY1) AS "Values"), 
"DT_Output_15" AS 
...
"DT_node_data_16" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE) AS "Score" 
FROM (SELECT 4 AS nid, -0.032430851677658405 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 5 AS nid, -0.018123846889430296 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 6 AS nid, 0.04170977978319426 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 7 AS nid, -0.009273140804504107 AS "Score" FROM SYSIBM.SYSDUMMY1) AS "Values"), 
"DT_Output_16" AS 
...
"DT_node_data_17" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE) AS "Score" 
FROM (SELECT 2 AS nid, -0.021626484496901358 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 6 AS nid, -0.015503980862153691 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 7 AS nid, 0.032075414127692256 AS "Score" FROM SYSIBM.SYSDUMMY1) AS "Values"), 
"DT_Output_17" AS 
...
"DT_node_data_18" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE) AS "Score" 
FROM (SELECT 2 AS nid, 0.03421543959311732 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 6 AS nid, 0.00487014039315363 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 14 AS nid, -0.03268338788831202 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 15 AS nid, -0.025388920964320674 AS "Score" FROM SYSIBM.SYSDUMMY1) AS "Values"), 
"DT_Output_18" AS 
...
"DT_node_data_19" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE) AS "Score" 
FROM (SELECT 3 AS nid, 0.024617499910754504 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 4 AS nid, -0.032396812397344085 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 5 AS nid, 0.005050332513611498 AS "Score" FROM SYSIBM.SYSDUMMY1) AS "Values"), 
"DT_Output_19" AS 
...
-- Code For temporary table tmp_20180508181759_codegen_kyzyh7_lgbm_b2 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180508181759_codegen_kyzyh7_lgbm_b2 (
	"KEY" BIGINT, 
	"Score_0" DOUBLE, 
	"Score_1" DOUBLE, 
	"Score_2" DOUBLE, 
...
-- Code For temporary table tmp_20180508181759_codegen_kyzyh7_lgbm_b2 part 2. Populate

INSERT INTO tmp_20180508181759_codegen_kyzyh7_lgbm_b2 WITH "DT_node_lookup_20" AS 
...
"DT_node_data_20" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE) AS "Score" 
FROM (SELECT 4 AS nid, -0.01775222720740029 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 5 AS nid, -0.03221277551225128 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 6 AS nid, 0.04694754208658461 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 7 AS nid, -0.0026131372933433754 AS "Score" FROM SYSIBM.SYSDUMMY1) AS "Values"), 
"DT_Output_20" AS 
...
"DT_node_data_21" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE) AS "Score" 
FROM (SELECT 2 AS nid, -0.019702425673491817 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 6 AS nid, -0.016999640407648977 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 7 AS nid, 0.04084800650737508 AS "Score" FROM SYSIBM.SYSDUMMY1) AS "Values"), 
"DT_Output_21" AS 
...
"DT_node_data_22" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE) AS "Score" 
FROM (SELECT 4 AS nid, 0.054354714566359146 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 5 AS nid, -0.012728726983595277 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 6 AS nid, -0.032577907328825005 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 7 AS nid, -0.00712695224663154 AS "Score" FROM SYSIBM.SYSDUMMY1) AS "Values"), 
"DT_Output_22" AS 
...
"DT_node_data_23" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE) AS "Score" 
FROM (SELECT 4 AS nid, -0.01541499384979074 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 5 AS nid, 0.04875831694517585 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 6 AS nid, -0.03329191878814407 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 7 AS nid, 0.0008424509870639216 AS "Score" FROM SYSIBM.SYSDUMMY1) AS "Values"), 
"DT_Output_23" AS 
...
"DT_node_data_24" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE) AS "Score" 
FROM (SELECT 4 AS nid, -0.032003459482789993 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 5 AS nid, -0.017356620302595844 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 6 AS nid, 0.04770528095183903 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 7 AS nid, -0.0006797085272083525 AS "Score" FROM SYSIBM.SYSDUMMY1) AS "Values"), 
"DT_Output_24" AS 
...
"DT_node_data_25" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE) AS "Score" 
FROM (SELECT 2 AS nid, -0.019371272894301267 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 6 AS nid, -0.016721247478611947 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 7 AS nid, 0.03899686638528799 AS "Score" FROM SYSIBM.SYSDUMMY1) AS "Values"), 
"DT_Output_25" AS 
...
"DT_node_data_26" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE) AS "Score" 
FROM (SELECT 4 AS nid, 0.05149522314283292 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 5 AS nid, -0.012504544603488288 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 6 AS nid, -0.032328547542213336 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 7 AS nid, -0.006774197240865256 AS "Score" FROM SYSIBM.SYSDUMMY1) AS "Values"), 
"DT_Output_26" AS 
...
"DT_node_data_27" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE) AS "Score" 
FROM (SELECT 3 AS nid, 0.023376036454596696 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 4 AS nid, -0.03207537004744958 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 5 AS nid, 0.004883438224411979 AS "Score" FROM SYSIBM.SYSDUMMY1) AS "Values"), 
"DT_Output_27" AS 
...
"DT_node_data_28" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE) AS "Score" 
FROM (SELECT 4 AS nid, -0.03181411183123618 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 5 AS nid, -0.016933666524256135 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 6 AS nid, 0.03772860917958193 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 7 AS nid, -0.009573319152340823 AS "Score" FROM SYSIBM.SYSDUMMY1) AS "Values"), 
"DT_Output_28" AS 
...
"DT_node_data_29" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE) AS "Score" 
FROM (SELECT 2 AS nid, -0.02120590996883151 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 6 AS nid, -0.010137523496834167 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 7 AS nid, 0.03392735655650109 AS "Score" FROM SYSIBM.SYSDUMMY1) AS "Values"), 
"DT_Output_29" AS 
...
-- Code For temporary table tmp_20180508181759_codegen_djhp08_lgbm_b3 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180508181759_codegen_djhp08_lgbm_b3 (
	"KEY" BIGINT, 
	"Score_0" DOUBLE, 
	"Score_1" DOUBLE, 
	"Score_2" DOUBLE, 
...
-- Code For temporary table tmp_20180508181759_codegen_djhp08_lgbm_b3 part 2. Populate

INSERT INTO tmp_20180508181759_codegen_djhp08_lgbm_b3 WITH "DT_node_lookup_30" AS 
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", CASE WHEN ("ADS_sca_2_OUT".scaler_58 <= -0.22148632814087912) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_56 <= 0.20615032458101307) THEN 4 ELSE 5 END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_97 <= 0.2681499738371736) THEN 6 ELSE 7 END END AS node_id_2 
FROM tmp_20180508181758_codegen_vcpkjz_ads_sca_2_out AS "ADS_sca_2_OUT"), 
"DT_node_data_30" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE) AS "Score" 
FROM (SELECT 4 AS nid, 0.049041201469898654 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 5 AS nid, -0.012216631427201374 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 6 AS nid, -0.03208452504859873 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 7 AS nid, -0.006682050585242594 AS "Score" FROM SYSIBM.SYSDUMMY1) AS "Values"), 
"DT_Output_30" AS 
...
"DT_node_data_31" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE) AS "Score" 
FROM (SELECT 4 AS nid, -0.015126519234631425 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 5 AS nid, 0.04550586119432775 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 6 AS nid, -0.03294298315599817 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 7 AS nid, 0.0009464242182587762 AS "Score" FROM SYSIBM.SYSDUMMY1) AS "Values"), 
"DT_Output_31" AS 
...
"DT_node_data_32" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE) AS "Score" 
FROM (SELECT 4 AS nid, -0.03159959372480136 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 5 AS nid, -0.01654230089557483 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 6 AS nid, 0.04238156603142348 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 7 AS nid, -0.0032544268823302826 AS "Score" FROM SYSIBM.SYSDUMMY1) AS "Values"), 
"DT_Output_32" AS 
...
"DT_node_data_33" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE) AS "Score" 
FROM (SELECT 2 AS nid, -0.020853887712922344 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 6 AS nid, -0.009952491556638608 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 7 AS nid, 0.03242662126086929 AS "Score" FROM SYSIBM.SYSDUMMY1) AS "Values"), 
"DT_Output_33" AS 
...
"DT_node_data_34" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE) AS "Score" 
FROM (SELECT 2 AS nid, 0.030120644069081312 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 6 AS nid, 0.0055838147715844035 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 14 AS nid, -0.02433246104415448 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 15 AS nid, -0.032351120287786805 AS "Score" FROM SYSIBM.SYSDUMMY1) AS "Values"), 
"DT_Output_34" AS 
...
"DT_node_data_35" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE) AS "Score" 
FROM (SELECT 3 AS nid, 0.02230557425093129 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 4 AS nid, -0.03178711507999351 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 5 AS nid, 0.00471309946423601 AS "Score" FROM SYSIBM.SYSDUMMY1) AS "Values"), 
"DT_Output_35" AS 
...
"DT_node_data_36" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE) AS "Score" 
FROM (SELECT 4 AS nid, -0.031419953156448625 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 5 AS nid, -0.016160339201189446 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 6 AS nid, 0.0407848697202845 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 7 AS nid, -0.0033154890000054605 AS "Score" FROM SYSIBM.SYSDUMMY1) AS "Values"), 
"DT_Output_36" AS 
...
"DT_node_data_37" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE) AS "Score" 
FROM (SELECT 2 AS nid, -0.01886606867743569 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 6 AS nid, -0.016543330666217416 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 7 AS nid, 0.03670950125929424 AS "Score" FROM SYSIBM.SYSDUMMY1) AS "Values"), 
"DT_Output_37" AS 
...
"DT_node_data_38" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE) AS "Score" 
FROM (SELECT 4 AS nid, 0.04558233201544677 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 5 AS nid, -0.011852613171158027 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 6 AS nid, -0.03177444071856066 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 7 AS nid, -0.006245418426760709 AS "Score" FROM SYSIBM.SYSDUMMY1) AS "Values"), 
"DT_Output_38" AS 
...
"DT_node_data_39" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE) AS "Score" 
FROM (SELECT 4 AS nid, -0.011621861430621161 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 5 AS nid, 0.046614583679068414 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 6 AS nid, -0.032699323902063655 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 7 AS nid, 0.0011222275259279407 AS "Score" FROM SYSIBM.SYSDUMMY1) AS "Values"), 
"DT_Output_39" AS 
...
-- Code For temporary table tmp_20180508181759_codegen_k79i0s_lgbm_b4 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180508181759_codegen_k79i0s_lgbm_b4 (
	"KEY" BIGINT, 
	"Score_0" DOUBLE, 
	"Score_1" DOUBLE, 
	"Score_2" DOUBLE, 
...
-- Code For temporary table tmp_20180508181759_codegen_k79i0s_lgbm_b4 part 2. Populate

INSERT INTO tmp_20180508181759_codegen_k79i0s_lgbm_b4 WITH "DT_node_lookup_40" AS 
...
"DT_node_data_40" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE) AS "Score" 
FROM (SELECT 4 AS nid, -0.015743868724441747 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 5 AS nid, -0.031249718673060718 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 6 AS nid, 0.03998234890426754 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 7 AS nid, -0.0032482950525118803 AS "Score" FROM SYSIBM.SYSDUMMY1) AS "Values"), 
"DT_Output_40" AS 
...
"DT_node_data_41" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE) AS "Score" 
FROM (SELECT 3 AS nid, 0.02986321925216749 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 4 AS nid, -0.02821410798213432 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 10 AS nid, -0.012626279568975203 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 11 AS nid, 0.02979847522652436 AS "Score" FROM SYSIBM.SYSDUMMY1) AS "Values"), 
"DT_Output_41" AS 
...
"DT_node_data_42" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE) AS "Score" 
FROM (SELECT 4 AS nid, 0.04353130429727434 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 5 AS nid, -0.011636476982560352 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 6 AS nid, -0.031578771619088064 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 7 AS nid, -0.005960066850569324 AS "Score" FROM SYSIBM.SYSDUMMY1) AS "Values"), 
"DT_Output_42" AS 
...
"DT_node_data_43" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE) AS "Score" 
FROM (SELECT 3 AS nid, 0.02127179462958491 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 4 AS nid, -0.03199590808682975 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 5 AS nid, 0.003968421351352446 AS "Score" FROM SYSIBM.SYSDUMMY1) AS "Values"), 
"DT_Output_43" AS 
...
"DT_node_data_44" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE) AS "Score" 
FROM (SELECT 4 AS nid, -0.0310908654140684 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 5 AS nid, -0.015279135329961432 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 6 AS nid, 0.03880354145307677 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 7 AS nid, -0.00391134735279519 AS "Score" FROM SYSIBM.SYSDUMMY1) AS "Values"), 
"DT_Output_44" AS 
...
"DT_node_data_45" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE) AS "Score" 
FROM (SELECT 2 AS nid, -0.020420313781114086 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 6 AS nid, -0.014726013237717382 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 7 AS nid, 0.027470639315244978 AS "Score" FROM SYSIBM.SYSDUMMY1) AS "Values"), 
"DT_Output_45" AS 
...
"DT_node_data_46" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE) AS "Score" 
FROM (SELECT 4 AS nid, 0.042739183805542674 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 5 AS nid, -0.00894612657642856 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 6 AS nid, -0.03171787287192134 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 7 AS nid, -0.016152772496959986 AS "Score" FROM SYSIBM.SYSDUMMY1) AS "Values"), 
"DT_Output_46" AS 
...
"DT_node_data_47" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE) AS "Score" 
FROM (SELECT 4 AS nid, -0.014910353817675186 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 5 AS nid, 0.041084924059791056 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 6 AS nid, -0.03233600981842487 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 7 AS nid, 0.0012034387694043048 AS "Score" FROM SYSIBM.SYSDUMMY1) AS "Values"), 
"DT_Output_47" AS 
...
"DT_node_data_48" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE) AS "Score" 
FROM (SELECT 4 AS nid, -0.03090305305251158 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 5 AS nid, -0.014939394868731635 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 6 AS nid, 0.03382129840405984 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 7 AS nid, -0.008206307592326621 AS "Score" FROM SYSIBM.SYSDUMMY1) AS "Values"), 
"DT_Output_48" AS 
...
"DT_node_data_49" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE) AS "Score" 
FROM (SELECT 2 AS nid, -0.018526138619979884 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 6 AS nid, -0.01588077468488255 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 7 AS nid, 0.03428883703950263 AS "Score" FROM SYSIBM.SYSDUMMY1) AS "Values"), 
"DT_Output_49" AS 
...
-- Code For temporary table tmp_20180508181759_codegen_1yy37x_lgbm_b5 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180508181759_codegen_1yy37x_lgbm_b5 (
	"KEY" BIGINT, 
	"Score_0" DOUBLE, 
	"Score_1" DOUBLE, 
	"Score_2" DOUBLE, 
...
-- Code For temporary table tmp_20180508181759_codegen_1yy37x_lgbm_b5 part 2. Populate

INSERT INTO tmp_20180508181759_codegen_1yy37x_lgbm_b5 WITH "DT_node_lookup_50" AS 
...
"DT_node_data_50" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE) AS "Score" 
FROM (SELECT 4 AS nid, 0.040817250224576766 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 5 AS nid, -0.008790049401806242 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 6 AS nid, -0.015871302752483933 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 7 AS nid, -0.031483714350811424 AS "Score" FROM SYSIBM.SYSDUMMY1) AS "Values"), 
"DT_Output_50" AS 
...
"DT_node_data_51" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE) AS "Score" 
FROM (SELECT 3 AS nid, 0.0205064249734117 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 5 AS nid, 0.01043540245880489 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 8 AS nid, -0.02386062596300417 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 9 AS nid, -0.03236334009426657 AS "Score" FROM SYSIBM.SYSDUMMY1) AS "Values"), 
"DT_Output_51" AS 
...
"DT_node_data_52" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE) AS "Score" 
FROM (SELECT 4 AS nid, -0.030747030661008867 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 5 AS nid, -0.014555792926882772 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 6 AS nid, 0.031573895596735624 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 7 AS nid, -0.010175005233875134 AS "Score" FROM SYSIBM.SYSDUMMY1) AS "Values"), 
"DT_Output_52" AS 
...
"DT_node_data_53" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE) AS "Score" 
FROM (SELECT 2 AS nid, -0.0182582081209416 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 6 AS nid, -0.015596687636521743 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 7 AS nid, 0.033090334673929765 AS "Score" FROM SYSIBM.SYSDUMMY1) AS "Values"), 
"DT_Output_53" AS 
...
"DT_node_data_54" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE) AS "Score" 
FROM (SELECT 2 AS nid, -0.03203660225084873 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 6 AS nid, -0.026071125113543425 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 14 AS nid, 0.05100082011196845 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 15 AS nid, 0.0030984754684367025 AS "Score" FROM SYSIBM.SYSDUMMY1) AS "Values"), 
"DT_Output_54" AS 
...
"DT_node_data_55" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE) AS "Score" 
FROM (SELECT 3 AS nid, 0.020099509826441427 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 4 AS nid, -0.03189536515463107 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 5 AS nid, 0.0036767730116769887 AS "Score" FROM SYSIBM.SYSDUMMY1) AS "Values"), 
"DT_Output_55" AS 
...
"DT_node_data_56" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE) AS "Score" 
FROM (SELECT 4 AS nid, -0.03060751890436594 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 5 AS nid, -0.014150078595797873 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 6 AS nid, 0.03573203558143081 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 7 AS nid, -0.0044581153413860665 AS "Score" FROM SYSIBM.SYSDUMMY1) AS "Values"), 
"DT_Output_56" AS 
...
"DT_node_data_57" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE) AS "Score" 
FROM (SELECT 2 AS nid, -0.01998261413617107 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 6 AS nid, -0.009748624080525037 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 7 AS nid, 0.0292959498894432 AS "Score" FROM SYSIBM.SYSDUMMY1) AS "Values"), 
"DT_Output_57" AS 
...
"DT_node_data_58" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE) AS "Score" 
FROM (SELECT 2 AS nid, -0.0318125040411655 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 6 AS nid, -0.02578061038935473 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 14 AS nid, 0.002089881713252583 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 15 AS nid, 0.04878045633913547 AS "Score" FROM SYSIBM.SYSDUMMY1) AS "Values"), 
"DT_Output_58" AS 
...
"DT_node_data_59" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE) AS "Score" 
FROM (SELECT 4 AS nid, -0.014753650054128554 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 5 AS nid, 0.03817297064500252 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 6 AS nid, -0.03202510022630165 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 7 AS nid, 0.0018751524215349189 AS "Score" FROM SYSIBM.SYSDUMMY1) AS "Values"), 
"DT_Output_59" AS 
...
-- Code For temporary table tmp_20180508181759_codegen_2aa6dx_lgbm_b6 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180508181759_codegen_2aa6dx_lgbm_b6 (
	"KEY" BIGINT, 
	"Score_0" DOUBLE, 
	"Score_1" DOUBLE, 
	"Score_2" DOUBLE, 
...
-- Code For temporary table tmp_20180508181759_codegen_2aa6dx_lgbm_b6 part 2. Populate

INSERT INTO tmp_20180508181759_codegen_2aa6dx_lgbm_b6 WITH "DT_node_lookup_60" AS 
...
"DT_node_data_60" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE) AS "Score" 
FROM (SELECT 4 AS nid, -0.013689615874156992 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 5 AS nid, -0.030449564866642423 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 6 AS nid, 0.03490078493210116 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 7 AS nid, -0.004664885985751203 AS "Score" FROM SYSIBM.SYSDUMMY1) AS "Values"), 
"DT_Output_60" AS 
...
"DT_node_data_61" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE) AS "Score" 
FROM (SELECT 2 AS nid, -0.02628140917315637 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 6 AS nid, -0.01777674979451851 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 14 AS nid, 0.052027314115713534 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 15 AS nid, -0.004217682524032953 AS "Score" FROM SYSIBM.SYSDUMMY1) AS "Values"), 
"DT_Output_61" AS 
...
"DT_node_data_62" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE) AS "Score" 
FROM (SELECT 2 AS nid, -0.03162941178263455 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 6 AS nid, -0.02543211348171276 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 14 AS nid, 0.04728314963131467 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 15 AS nid, 0.0025346518318884884 AS "Score" FROM SYSIBM.SYSDUMMY1) AS "Values"), 
"DT_Output_62" AS 
...
"DT_node_data_63" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE) AS "Score" 
FROM (SELECT 3 AS nid, 0.019286844860131692 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 4 AS nid, -0.03102628577513182 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 5 AS nid, 0.00427368528143657 AS "Score" FROM SYSIBM.SYSDUMMY1) AS "Values"), 
"DT_Output_63" AS 
...
-- Code For temporary table tmp_20180508181759_codegen_ac5jn3_lgbm_union part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180508181759_codegen_ac5jn3_lgbm_union (
	"KEY" BIGINT, 
	"Score_0" DOUBLE, 
	"Score_1" DOUBLE, 
	"Score_2" DOUBLE, 
...
-- Code For temporary table tmp_20180508181759_codegen_ac5jn3_lgbm_union part 2. Populate

INSERT INTO tmp_20180508181759_codegen_ac5jn3_lgbm_union SELECT "LGBM_Union"."KEY", "LGBM_Union"."Score_0", "LGBM_Union"."Score_1", "LGBM_Union"."Score_2", "LGBM_Union"."Score_3" 
...
FROM tmp_20180508181759_codegen_t67zz0_lgbm_b0 AS "LGBM_B0" UNION ALL SELECT "LGBM_B1"."KEY" AS "KEY", "LGBM_B1"."Score_0" AS "Score_0", "LGBM_B1"."Score_1" AS "Score_1", "LGBM_B1"."Score_2" AS "Score_2", "LGBM_B1"."Score_3" AS "Score_3" 
FROM tmp_20180508181759_codegen_lgnxlu_lgbm_b1 AS "LGBM_B1" UNION ALL SELECT "LGBM_B2"."KEY" AS "KEY", "LGBM_B2"."Score_0" AS "Score_0", "LGBM_B2"."Score_1" AS "Score_1", "LGBM_B2"."Score_2" AS "Score_2", "LGBM_B2"."Score_3" AS "Score_3" 
FROM tmp_20180508181759_codegen_kyzyh7_lgbm_b2 AS "LGBM_B2" UNION ALL SELECT "LGBM_B3"."KEY" AS "KEY", "LGBM_B3"."Score_0" AS "Score_0", "LGBM_B3"."Score_1" AS "Score_1", "LGBM_B3"."Score_2" AS "Score_2", "LGBM_B3"."Score_3" AS "Score_3" 
FROM tmp_20180508181759_codegen_djhp08_lgbm_b3 AS "LGBM_B3" UNION ALL SELECT "LGBM_B4"."KEY" AS "KEY", "LGBM_B4"."Score_0" AS "Score_0", "LGBM_B4"."Score_1" AS "Score_1", "LGBM_B4"."Score_2" AS "Score_2", "LGBM_B4"."Score_3" AS "Score_3" 
FROM tmp_20180508181759_codegen_k79i0s_lgbm_b4 AS "LGBM_B4" UNION ALL SELECT "LGBM_B5"."KEY" AS "KEY", "LGBM_B5"."Score_0" AS "Score_0", "LGBM_B5"."Score_1" AS "Score_1", "LGBM_B5"."Score_2" AS "Score_2", "LGBM_B5"."Score_3" AS "Score_3" 
FROM tmp_20180508181759_codegen_1yy37x_lgbm_b5 AS "LGBM_B5" UNION ALL SELECT "LGBM_B6"."KEY" AS "KEY", "LGBM_B6"."Score_0" AS "Score_0", "LGBM_B6"."Score_1" AS "Score_1", "LGBM_B6"."Score_2" AS "Score_2", "LGBM_B6"."Score_3" AS "Score_3" 
FROM tmp_20180508181759_codegen_2aa6dx_lgbm_b6 AS "LGBM_B6") AS "LGBM_EnsembleUnion") AS "LGBM_Union"

-- Code For temporary table tmp_20180508181759_codegen_ul40mo_lgbm_sum part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180508181759_codegen_ul40mo_lgbm_sum (
	"KEY" BIGINT, 
	"Score_0" DOUBLE, 
	"Score_1" DOUBLE, 
	"Score_2" DOUBLE, 
...
-- Code For temporary table tmp_20180508181759_codegen_ul40mo_lgbm_sum part 2. Populate

INSERT INTO tmp_20180508181759_codegen_ul40mo_lgbm_sum SELECT "LGBM_sum"."KEY", "LGBM_sum"."Score_0", "LGBM_sum"."Score_1", "LGBM_sum"."Score_2", "LGBM_sum"."Score_3" 
...
FROM tmp_20180508181759_codegen_ac5jn3_lgbm_union AS "LGBM_Union" GROUP BY "LGBM_Union"."KEY") AS "T") AS "LGBM_sum"
...
FROM tmp_20180508181759_codegen_ul40mo_lgbm_sum AS "LGBM_sum"), 
