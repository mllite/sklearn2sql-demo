...
-- Code For temporary table TMP_20180508180331_CODEGEN_9VUY part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508180331_CODEGEN_9VUY" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20180508180331_CODEGEN_9VUY part 3. Create Index 

CREATE INDEX "ix_TMP_20180508180331_C_d45e" ON "TMP_20180508180331_CODEGEN_9VUY" ("KEY")

-- Code For temporary table TMP_20180508180331_CODEGEN_9XGJ part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508180331_CODEGEN_9XGJ" (
	"KEY" BIGINT NOT NULL, 
...
FROM "TMP_20180508180331_CODEGEN_9VUY" AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT") AS "U"

-- Code For temporary table TMP_20180508180331_CODEGEN_9XGJ part 3. Create Index 

CREATE INDEX "ix_TMP_20180508180331_C_062e" ON "TMP_20180508180331_CODEGEN_9XGJ" ("KEY")

-- Code For temporary table TMP_20180508180331_CODEGEN_2B58 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508180331_CODEGEN_2B58" (
	"KEY" BIGINT, 
...
-- Code For temporary table TMP_20180508180331_CODEGEN_2B58 part 2. Populate

INSERT INTO "TMP_20180508180331_CODEGEN_2B58" ("KEY", "Score_0") SELECT "U"."KEY", "U"."Score_0" 
...
FROM "TMP_20180508180331_CODEGEN_9XGJ" AS "ADS_sca_2_OUT"), 
"DT_node_data" AS 
...
-- Code For temporary table TMP_20180508180331_CODEGEN_9MS5 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508180331_CODEGEN_9MS5" (
	"KEY" BIGINT, 
	"Score_0" DOUBLE PRECISION
)
...
-- Code For temporary table TMP_20180508180331_CODEGEN_9MS5 part 2. Populate

INSERT INTO "TMP_20180508180331_CODEGEN_9MS5" ("KEY", "Score_0") SELECT "U"."KEY", "U"."Score_0" 
...
-- Code For temporary table TMP_20180508180331_CODEGEN_MVEN part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508180331_CODEGEN_MVEN" (
	"KEY" BIGINT, 
	"Score_0" DOUBLE PRECISION
)
...
-- Code For temporary table TMP_20180508180331_CODEGEN_MVEN part 2. Populate

INSERT INTO "TMP_20180508180331_CODEGEN_MVEN" ("KEY", "Score_0") SELECT "U"."KEY", "U"."Score_0" 
...
FROM "TMP_20180508180331_CODEGEN_2B58" AS "LGBM_B0" UNION ALL SELECT "LGBM_B1"."KEY" AS "KEY", "LGBM_B1"."Score_0" AS "Score_0" 
FROM "TMP_20180508180331_CODEGEN_9MS5" AS "LGBM_B1") AS "LGBM_EnsembleUnion") AS "LGBM_Union") AS "U"

-- Code For temporary table TMP_20180508180331_CODEGEN_MVOL part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508180331_CODEGEN_MVOL" (
	"KEY" BIGINT NOT NULL, 
	"Score_0" DOUBLE PRECISION, 
	PRIMARY KEY ("KEY")
)
...
-- Code For temporary table TMP_20180508180331_CODEGEN_MVOL part 2. Populate

INSERT INTO "TMP_20180508180331_CODEGEN_MVOL" ("KEY", "Score_0") SELECT "U"."KEY", "U"."Score_0" 
...
FROM "TMP_20180508180331_CODEGEN_MVEN" AS "LGBM_Union" GROUP BY "LGBM_Union"."KEY") AS "T") AS "LGBM_sum") AS "U"

-- Code For temporary table TMP_20180508180331_CODEGEN_MVOL part 3. Create Index 

CREATE INDEX "ix_TMP_20180508180331_C_bd32" ON "TMP_20180508180331_CODEGEN_MVOL" ("KEY")
...
FROM "TMP_20180508180331_CODEGEN_MVOL" AS "LGBM_sum"), 
