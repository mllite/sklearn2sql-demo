...
-- Code For temporary table tmp_20180508191933_codegen_n7jkov_ads_imp_1_out part 1. Create 


CREATE TABLE tmp_20180508191933_codegen_n7jkov_ads_imp_1_out (
	`KEY` BIGINT, 
	impter_2 DOUBLE, 
	impter_3 DOUBLE, 
	impter_4 DOUBLE, 
...
-- Code For temporary table tmp_20180508191934_codegen_8smao3_ads_sca_2_out part 1. Create 


CREATE TABLE tmp_20180508191934_codegen_8smao3_ads_sca_2_out (
	`KEY` BIGINT, 
	scaler_2 DOUBLE, 
	scaler_3 DOUBLE, 
	scaler_4 DOUBLE, 
...
-- Code For temporary table tmp_20180508191934_codegen_8smao3_ads_sca_2_out part 2. Populate

INSERT INTO tmp_20180508191934_codegen_8smao3_ads_sca_2_out (`KEY`, scaler_2, scaler_3, scaler_4, scaler_5, scaler_6, scaler_7, scaler_8, scaler_9, scaler_10, scaler_11) SELECT `ADS_sca_2_OUT`.`KEY`, `ADS_sca_2_OUT`.scaler_2, `ADS_sca_2_OUT`.scaler_3, `ADS_sca_2_OUT`.scaler_4, `ADS_sca_2_OUT`.scaler_5, `ADS_sca_2_OUT`.scaler_6, `ADS_sca_2_OUT`.scaler_7, `ADS_sca_2_OUT`.scaler_8, `ADS_sca_2_OUT`.scaler_9, `ADS_sca_2_OUT`.scaler_10, `ADS_sca_2_OUT`.scaler_11 
...
FROM tmp_20180508191933_codegen_n7jkov_ads_imp_1_out AS `ADS_imp_1_OUT`) AS `ADS_sca_2_OUT`

-- Code For temporary table tmp_20180508191934_codegen_x6dgka_lgbm_b0 part 1. Create 


CREATE TABLE tmp_20180508191934_codegen_x6dgka_lgbm_b0 (
	`KEY` BIGINT, 
	`Score_0` DOUBLE
)
...
-- Code For temporary table tmp_20180508191934_codegen_x6dgka_lgbm_b0 part 2. Populate
...
FROM tmp_20180508191934_codegen_8smao3_ads_sca_2_out AS `ADS_sca_2_OUT`), 
`DT_node_data` AS 
...
FROM `DT_Output_9`)
 INSERT INTO tmp_20180508191934_codegen_x6dgka_lgbm_b0 (`KEY`, `Score_0`) SELECT `LGBM_B0`.`KEY`, `LGBM_B0`.`Score_0` 
...
-- Code For temporary table tmp_20180508191934_codegen_iiswmn_lgbm_b1 part 1. Create 


CREATE TABLE tmp_20180508191934_codegen_iiswmn_lgbm_b1 (
	`KEY` BIGINT, 
	`Score_0` DOUBLE
)
...
-- Code For temporary table tmp_20180508191934_codegen_iiswmn_lgbm_b1 part 2. Populate
...
FROM `DT_Output_15`)
 INSERT INTO tmp_20180508191934_codegen_iiswmn_lgbm_b1 (`KEY`, `Score_0`) SELECT `LGBM_B1`.`KEY`, `LGBM_B1`.`Score_0` 
...
-- Code For temporary table tmp_20180508191934_codegen_zxanki_lgbm_union part 1. Create 


CREATE TABLE tmp_20180508191934_codegen_zxanki_lgbm_union (
	`KEY` BIGINT, 
	`Score_0` DOUBLE
)
...
-- Code For temporary table tmp_20180508191934_codegen_zxanki_lgbm_union part 2. Populate

INSERT INTO tmp_20180508191934_codegen_zxanki_lgbm_union (`KEY`, `Score_0`) SELECT `LGBM_Union`.`KEY`, `LGBM_Union`.`Score_0` 
...
FROM tmp_20180508191934_codegen_x6dgka_lgbm_b0 AS `LGBM_B0` UNION ALL SELECT `LGBM_B1`.`KEY` AS `KEY`, `LGBM_B1`.`Score_0` AS `Score_0` 
FROM tmp_20180508191934_codegen_iiswmn_lgbm_b1 AS `LGBM_B1`) AS `LGBM_EnsembleUnion`) AS `LGBM_Union`

-- Code For temporary table tmp_20180508191934_codegen_0yxe0r_lgbm_sum part 1. Create 


CREATE TABLE tmp_20180508191934_codegen_0yxe0r_lgbm_sum (
	`KEY` BIGINT, 
	`Score_0` DOUBLE
)
...
-- Code For temporary table tmp_20180508191934_codegen_0yxe0r_lgbm_sum part 2. Populate

INSERT INTO tmp_20180508191934_codegen_0yxe0r_lgbm_sum (`KEY`, `Score_0`) SELECT `LGBM_sum`.`KEY`, `LGBM_sum`.`Score_0` 
...
FROM tmp_20180508191934_codegen_zxanki_lgbm_union AS `LGBM_Union` GROUP BY `LGBM_Union`.`KEY`) AS `T`) AS `LGBM_sum`
...
FROM tmp_20180508191934_codegen_0yxe0r_lgbm_sum AS `LGBM_sum`), 
