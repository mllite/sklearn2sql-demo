...
-- Code For temporary table ##TMP_20180508181303_CODEGEN_C28VGA_ADS_imp_1_OUT part 1. Create 


CREATE TABLE ##TMP_20180508181303_CODEGEN_C28VGA_ADS_imp_1_OUT (
	[KEY] BIGINT NULL, 
...
-- Code For temporary table ##TMP_20180508181303_CODEGEN_SO6E19_ADS_sca_2_OUT part 1. Create 


CREATE TABLE ##TMP_20180508181303_CODEGEN_SO6E19_ADS_sca_2_OUT (
	[KEY] BIGINT NULL, 
	scaler_2 FLOAT NULL, 
	scaler_3 FLOAT NULL, 
	scaler_4 FLOAT NULL, 
...
-- Code For temporary table ##TMP_20180508181303_CODEGEN_SO6E19_ADS_sca_2_OUT part 2. Populate

INSERT INTO ##TMP_20180508181303_CODEGEN_SO6E19_ADS_sca_2_OUT ([KEY], scaler_2, scaler_3, scaler_4, scaler_5, scaler_6, scaler_7, scaler_8, scaler_9, scaler_10, scaler_11) SELECT [ADS_sca_2_OUT].[KEY], [ADS_sca_2_OUT].scaler_2, [ADS_sca_2_OUT].scaler_3, [ADS_sca_2_OUT].scaler_4, [ADS_sca_2_OUT].scaler_5, [ADS_sca_2_OUT].scaler_6, [ADS_sca_2_OUT].scaler_7, [ADS_sca_2_OUT].scaler_8, [ADS_sca_2_OUT].scaler_9, [ADS_sca_2_OUT].scaler_10, [ADS_sca_2_OUT].scaler_11 
...
FROM ##TMP_20180508181303_CODEGEN_C28VGA_ADS_imp_1_OUT AS [ADS_imp_1_OUT]) AS [ADS_sca_2_OUT]

-- Code For temporary table ##TMP_20180508181303_CODEGEN_NSS8PC_LGBM_B0 part 1. Create 


CREATE TABLE ##TMP_20180508181303_CODEGEN_NSS8PC_LGBM_B0 (
	[KEY] BIGINT NULL, 
...
-- Code For temporary table ##TMP_20180508181303_CODEGEN_NSS8PC_LGBM_B0 part 2. Populate
...
FROM ##TMP_20180508181303_CODEGEN_SO6E19_ADS_sca_2_OUT AS [ADS_sca_2_OUT]), 
[DT_node_data] AS 
...
FROM [DT_Output_9])
 INSERT INTO ##TMP_20180508181303_CODEGEN_NSS8PC_LGBM_B0 ([KEY], [Score_0], [Score_1], [Score_2], [Score_3]) SELECT [LGBM_B0].[KEY], [LGBM_B0].[Score_0], [LGBM_B0].[Score_1], [LGBM_B0].[Score_2], [LGBM_B0].[Score_3] 
...
-- Code For temporary table ##TMP_20180508181303_CODEGEN_4J2IN3_LGBM_B1 part 1. Create 


CREATE TABLE ##TMP_20180508181303_CODEGEN_4J2IN3_LGBM_B1 (
	[KEY] BIGINT NULL, 
	[Score_0] FLOAT(53) NULL, 
	[Score_1] FLOAT(53) NULL, 
	[Score_2] FLOAT(53) NULL, 
...
-- Code For temporary table ##TMP_20180508181303_CODEGEN_4J2IN3_LGBM_B1 part 2. Populate
...
FROM [DT_Output_19])
 INSERT INTO ##TMP_20180508181303_CODEGEN_4J2IN3_LGBM_B1 ([KEY], [Score_0], [Score_1], [Score_2], [Score_3]) SELECT [LGBM_B1].[KEY], [LGBM_B1].[Score_0], [LGBM_B1].[Score_1], [LGBM_B1].[Score_2], [LGBM_B1].[Score_3] 
...
-- Code For temporary table ##TMP_20180508181303_CODEGEN_UZL3PM_LGBM_B2 part 1. Create 


CREATE TABLE ##TMP_20180508181303_CODEGEN_UZL3PM_LGBM_B2 (
	[KEY] BIGINT NULL, 
	[Score_0] FLOAT(53) NULL, 
	[Score_1] FLOAT(53) NULL, 
	[Score_2] FLOAT(53) NULL, 
...
-- Code For temporary table ##TMP_20180508181303_CODEGEN_UZL3PM_LGBM_B2 part 2. Populate
...
FROM [DT_Output_29])
 INSERT INTO ##TMP_20180508181303_CODEGEN_UZL3PM_LGBM_B2 ([KEY], [Score_0], [Score_1], [Score_2], [Score_3]) SELECT [LGBM_B2].[KEY], [LGBM_B2].[Score_0], [LGBM_B2].[Score_1], [LGBM_B2].[Score_2], [LGBM_B2].[Score_3] 
...
-- Code For temporary table ##TMP_20180508181303_CODEGEN_AAD6ET_LGBM_B3 part 1. Create 


CREATE TABLE ##TMP_20180508181303_CODEGEN_AAD6ET_LGBM_B3 (
	[KEY] BIGINT NULL, 
	[Score_0] FLOAT(53) NULL, 
	[Score_1] FLOAT(53) NULL, 
	[Score_2] FLOAT(53) NULL, 
...
-- Code For temporary table ##TMP_20180508181303_CODEGEN_AAD6ET_LGBM_B3 part 2. Populate
...
FROM [DT_Output_39])
 INSERT INTO ##TMP_20180508181303_CODEGEN_AAD6ET_LGBM_B3 ([KEY], [Score_0], [Score_1], [Score_2], [Score_3]) SELECT [LGBM_B3].[KEY], [LGBM_B3].[Score_0], [LGBM_B3].[Score_1], [LGBM_B3].[Score_2], [LGBM_B3].[Score_3] 
...
-- Code For temporary table ##TMP_20180508181303_CODEGEN_JFS7G1_LGBM_B4 part 1. Create 


CREATE TABLE ##TMP_20180508181303_CODEGEN_JFS7G1_LGBM_B4 (
	[KEY] BIGINT NULL, 
	[Score_0] FLOAT(53) NULL, 
	[Score_1] FLOAT(53) NULL, 
	[Score_2] FLOAT(53) NULL, 
...
-- Code For temporary table ##TMP_20180508181303_CODEGEN_JFS7G1_LGBM_B4 part 2. Populate
...
FROM [DT_Output_49])
 INSERT INTO ##TMP_20180508181303_CODEGEN_JFS7G1_LGBM_B4 ([KEY], [Score_0], [Score_1], [Score_2], [Score_3]) SELECT [LGBM_B4].[KEY], [LGBM_B4].[Score_0], [LGBM_B4].[Score_1], [LGBM_B4].[Score_2], [LGBM_B4].[Score_3] 
...
-- Code For temporary table ##TMP_20180508181303_CODEGEN_89PRWA_LGBM_B5 part 1. Create 


CREATE TABLE ##TMP_20180508181303_CODEGEN_89PRWA_LGBM_B5 (
	[KEY] BIGINT NULL, 
	[Score_0] FLOAT(53) NULL, 
	[Score_1] FLOAT(53) NULL, 
	[Score_2] FLOAT(53) NULL, 
...
-- Code For temporary table ##TMP_20180508181303_CODEGEN_89PRWA_LGBM_B5 part 2. Populate
...
FROM [DT_Output_59])
 INSERT INTO ##TMP_20180508181303_CODEGEN_89PRWA_LGBM_B5 ([KEY], [Score_0], [Score_1], [Score_2], [Score_3]) SELECT [LGBM_B5].[KEY], [LGBM_B5].[Score_0], [LGBM_B5].[Score_1], [LGBM_B5].[Score_2], [LGBM_B5].[Score_3] 
...
-- Code For temporary table ##TMP_20180508181303_CODEGEN_A0I95N_LGBM_B6 part 1. Create 


CREATE TABLE ##TMP_20180508181303_CODEGEN_A0I95N_LGBM_B6 (
	[KEY] BIGINT NULL, 
	[Score_0] FLOAT(53) NULL, 
	[Score_1] FLOAT(53) NULL, 
	[Score_2] FLOAT(53) NULL, 
...
-- Code For temporary table ##TMP_20180508181303_CODEGEN_A0I95N_LGBM_B6 part 2. Populate
...
FROM [DT_Output_63])
 INSERT INTO ##TMP_20180508181303_CODEGEN_A0I95N_LGBM_B6 ([KEY], [Score_0], [Score_1], [Score_2], [Score_3]) SELECT [LGBM_B6].[KEY], [LGBM_B6].[Score_0], [LGBM_B6].[Score_1], [LGBM_B6].[Score_2], [LGBM_B6].[Score_3] 
...
-- Code For temporary table ##TMP_20180508181303_CODEGEN_DYDE6N_LGBM_Union part 1. Create 


CREATE TABLE ##TMP_20180508181303_CODEGEN_DYDE6N_LGBM_Union (
	[KEY] BIGINT NULL, 
	[Score_0] FLOAT(53) NULL, 
	[Score_1] FLOAT(53) NULL, 
	[Score_2] FLOAT(53) NULL, 
...
-- Code For temporary table ##TMP_20180508181303_CODEGEN_DYDE6N_LGBM_Union part 2. Populate

INSERT INTO ##TMP_20180508181303_CODEGEN_DYDE6N_LGBM_Union ([KEY], [Score_0], [Score_1], [Score_2], [Score_3]) SELECT [LGBM_Union].[KEY], [LGBM_Union].[Score_0], [LGBM_Union].[Score_1], [LGBM_Union].[Score_2], [LGBM_Union].[Score_3] 
...
FROM ##TMP_20180508181303_CODEGEN_NSS8PC_LGBM_B0 AS [LGBM_B0] UNION ALL SELECT [LGBM_B1].[KEY] AS [KEY], [LGBM_B1].[Score_0] AS [Score_0], [LGBM_B1].[Score_1] AS [Score_1], [LGBM_B1].[Score_2] AS [Score_2], [LGBM_B1].[Score_3] AS [Score_3] 
FROM ##TMP_20180508181303_CODEGEN_4J2IN3_LGBM_B1 AS [LGBM_B1] UNION ALL SELECT [LGBM_B2].[KEY] AS [KEY], [LGBM_B2].[Score_0] AS [Score_0], [LGBM_B2].[Score_1] AS [Score_1], [LGBM_B2].[Score_2] AS [Score_2], [LGBM_B2].[Score_3] AS [Score_3] 
FROM ##TMP_20180508181303_CODEGEN_UZL3PM_LGBM_B2 AS [LGBM_B2] UNION ALL SELECT [LGBM_B3].[KEY] AS [KEY], [LGBM_B3].[Score_0] AS [Score_0], [LGBM_B3].[Score_1] AS [Score_1], [LGBM_B3].[Score_2] AS [Score_2], [LGBM_B3].[Score_3] AS [Score_3] 
FROM ##TMP_20180508181303_CODEGEN_AAD6ET_LGBM_B3 AS [LGBM_B3] UNION ALL SELECT [LGBM_B4].[KEY] AS [KEY], [LGBM_B4].[Score_0] AS [Score_0], [LGBM_B4].[Score_1] AS [Score_1], [LGBM_B4].[Score_2] AS [Score_2], [LGBM_B4].[Score_3] AS [Score_3] 
FROM ##TMP_20180508181303_CODEGEN_JFS7G1_LGBM_B4 AS [LGBM_B4] UNION ALL SELECT [LGBM_B5].[KEY] AS [KEY], [LGBM_B5].[Score_0] AS [Score_0], [LGBM_B5].[Score_1] AS [Score_1], [LGBM_B5].[Score_2] AS [Score_2], [LGBM_B5].[Score_3] AS [Score_3] 
FROM ##TMP_20180508181303_CODEGEN_89PRWA_LGBM_B5 AS [LGBM_B5] UNION ALL SELECT [LGBM_B6].[KEY] AS [KEY], [LGBM_B6].[Score_0] AS [Score_0], [LGBM_B6].[Score_1] AS [Score_1], [LGBM_B6].[Score_2] AS [Score_2], [LGBM_B6].[Score_3] AS [Score_3] 
FROM ##TMP_20180508181303_CODEGEN_A0I95N_LGBM_B6 AS [LGBM_B6]) AS [LGBM_EnsembleUnion]) AS [LGBM_Union]

-- Code For temporary table ##TMP_20180508181303_CODEGEN_1ORWZF_LGBM_sum part 1. Create 


CREATE TABLE ##TMP_20180508181303_CODEGEN_1ORWZF_LGBM_sum (
	[KEY] BIGINT NULL, 
	[Score_0] FLOAT(53) NULL, 
	[Score_1] FLOAT(53) NULL, 
	[Score_2] FLOAT(53) NULL, 
...
-- Code For temporary table ##TMP_20180508181303_CODEGEN_1ORWZF_LGBM_sum part 2. Populate

INSERT INTO ##TMP_20180508181303_CODEGEN_1ORWZF_LGBM_sum ([KEY], [Score_0], [Score_1], [Score_2], [Score_3]) SELECT [LGBM_sum].[KEY], [LGBM_sum].[Score_0], [LGBM_sum].[Score_1], [LGBM_sum].[Score_2], [LGBM_sum].[Score_3] 
...
FROM ##TMP_20180508181303_CODEGEN_DYDE6N_LGBM_Union AS [LGBM_Union] GROUP BY [LGBM_Union].[KEY]) AS [T]) AS [LGBM_sum]
...
FROM ##TMP_20180508181303_CODEGEN_1ORWZF_LGBM_sum AS [LGBM_sum]), 
