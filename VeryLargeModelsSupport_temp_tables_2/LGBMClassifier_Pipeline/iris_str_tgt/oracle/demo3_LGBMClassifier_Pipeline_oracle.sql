...
-- Code For temporary table DEGEN_GKB4NL_ADS_IMP_1_OUT part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "DEGEN_GKB4NL_ADS_IMP_1_OUT" (
	"KEY" NUMBER(19), 
...
-- Code For temporary table DEGEN_GKB4NL_ADS_IMP_1_OUT part 2. Populate

INSERT INTO "DEGEN_GKB4NL_ADS_IMP_1_OUT" ("KEY", imputer_output_2, imputer_output_3, imputer_output_4, imputer_output_5) SELECT "U"."KEY", "U".imputer_output_2, "U".imputer_output_3, "U".imputer_output_4, "U".imputer_output_5 
...
-- Code For temporary table DEGEN_IDS853_ADS_SCA_2_OUT part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "DEGEN_IDS853_ADS_SCA_2_OUT" (
	"KEY" NUMBER(19), 
...
-- Code For temporary table DEGEN_IDS853_ADS_SCA_2_OUT part 2. Populate

INSERT INTO "DEGEN_IDS853_ADS_SCA_2_OUT" ("KEY", scaler_output_2, scaler_output_3, scaler_output_4, scaler_output_5) SELECT "U"."KEY", "U".scaler_output_2, "U".scaler_output_3, "U".scaler_output_4, "U".scaler_output_5 
...
FROM "DEGEN_GKB4NL_ADS_IMP_1_OUT" "ADS_imp_1_OUT") "ADS_sca_2_OUT") "U"

-- Code For temporary table 618_CODEGEN_3X7CC2_LGBM_B0 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "618_CODEGEN_3X7CC2_LGBM_B0" (
	"KEY" NUMBER(19), 
...
-- Code For temporary table 618_CODEGEN_3X7CC2_LGBM_B0 part 2. Populate

INSERT INTO "618_CODEGEN_3X7CC2_LGBM_B0" ("KEY", "Score_CLASS_0", "Score_CLASS_1", "Score_CLASS_2") SELECT "U"."KEY", "U"."Score_CLASS_0", "U"."Score_CLASS_1", "U"."Score_CLASS_2" 
...
FROM "DEGEN_IDS853_ADS_SCA_2_OUT" "ADS_sca_2_OUT"), 
"DT_node_data" AS 
...
-- Code For temporary table 618_CODEGEN_Q8KIRS_LGBM_B1 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "618_CODEGEN_Q8KIRS_LGBM_B1" (
	"KEY" NUMBER(19), 
	"Score_CLASS_0" BINARY_DOUBLE, 
	"Score_CLASS_1" BINARY_DOUBLE, 
	"Score_CLASS_2" BINARY_DOUBLE
...
-- Code For temporary table 618_CODEGEN_Q8KIRS_LGBM_B1 part 2. Populate

INSERT INTO "618_CODEGEN_Q8KIRS_LGBM_B1" ("KEY", "Score_CLASS_0", "Score_CLASS_1", "Score_CLASS_2") SELECT "U"."KEY", "U"."Score_CLASS_0", "U"."Score_CLASS_1", "U"."Score_CLASS_2" 
...
-- Code For temporary table 618_CODEGEN_HEAQHU_LGBM_B2 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "618_CODEGEN_HEAQHU_LGBM_B2" (
	"KEY" NUMBER(19), 
	"Score_CLASS_0" BINARY_DOUBLE, 
	"Score_CLASS_1" BINARY_DOUBLE, 
	"Score_CLASS_2" BINARY_DOUBLE
...
-- Code For temporary table 618_CODEGEN_HEAQHU_LGBM_B2 part 2. Populate

INSERT INTO "618_CODEGEN_HEAQHU_LGBM_B2" ("KEY", "Score_CLASS_0", "Score_CLASS_1", "Score_CLASS_2") SELECT "U"."KEY", "U"."Score_CLASS_0", "U"."Score_CLASS_1", "U"."Score_CLASS_2" 
...
-- Code For temporary table 618_CODEGEN_854JIR_LGBM_B3 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "618_CODEGEN_854JIR_LGBM_B3" (
	"KEY" NUMBER(19), 
	"Score_CLASS_0" BINARY_DOUBLE, 
	"Score_CLASS_1" BINARY_DOUBLE, 
	"Score_CLASS_2" BINARY_DOUBLE
...
-- Code For temporary table 618_CODEGEN_854JIR_LGBM_B3 part 2. Populate

INSERT INTO "618_CODEGEN_854JIR_LGBM_B3" ("KEY", "Score_CLASS_0", "Score_CLASS_1", "Score_CLASS_2") SELECT "U"."KEY", "U"."Score_CLASS_0", "U"."Score_CLASS_1", "U"."Score_CLASS_2" 
...
-- Code For temporary table 618_CODEGEN_QWKSI3_LGBM_B4 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "618_CODEGEN_QWKSI3_LGBM_B4" (
	"KEY" NUMBER(19), 
	"Score_CLASS_0" BINARY_DOUBLE, 
	"Score_CLASS_1" BINARY_DOUBLE, 
	"Score_CLASS_2" BINARY_DOUBLE
...
-- Code For temporary table 618_CODEGEN_QWKSI3_LGBM_B4 part 2. Populate

INSERT INTO "618_CODEGEN_QWKSI3_LGBM_B4" ("KEY", "Score_CLASS_0", "Score_CLASS_1", "Score_CLASS_2") SELECT "U"."KEY", "U"."Score_CLASS_0", "U"."Score_CLASS_1", "U"."Score_CLASS_2" 
...
-- Code For temporary table _CODEGEN_ROYYS1_LGBM_UNION part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "_CODEGEN_ROYYS1_LGBM_UNION" (
	"KEY" NUMBER(19), 
	"Score_CLASS_0" BINARY_DOUBLE, 
	"Score_CLASS_1" BINARY_DOUBLE, 
	"Score_CLASS_2" BINARY_DOUBLE
...
-- Code For temporary table _CODEGEN_ROYYS1_LGBM_UNION part 2. Populate

INSERT INTO "_CODEGEN_ROYYS1_LGBM_UNION" ("KEY", "Score_CLASS_0", "Score_CLASS_1", "Score_CLASS_2") SELECT "U"."KEY", "U"."Score_CLASS_0", "U"."Score_CLASS_1", "U"."Score_CLASS_2" 
...
FROM "618_CODEGEN_3X7CC2_LGBM_B0" "LGBM_B0" UNION ALL SELECT "LGBM_B1"."KEY" AS "KEY", "LGBM_B1"."Score_CLASS_0" AS "Score_CLASS_0", "LGBM_B1"."Score_CLASS_1" AS "Score_CLASS_1", "LGBM_B1"."Score_CLASS_2" AS "Score_CLASS_2" 
FROM "618_CODEGEN_Q8KIRS_LGBM_B1" "LGBM_B1" UNION ALL SELECT "LGBM_B2"."KEY" AS "KEY", "LGBM_B2"."Score_CLASS_0" AS "Score_CLASS_0", "LGBM_B2"."Score_CLASS_1" AS "Score_CLASS_1", "LGBM_B2"."Score_CLASS_2" AS "Score_CLASS_2" 
FROM "618_CODEGEN_HEAQHU_LGBM_B2" "LGBM_B2" UNION ALL SELECT "LGBM_B3"."KEY" AS "KEY", "LGBM_B3"."Score_CLASS_0" AS "Score_CLASS_0", "LGBM_B3"."Score_CLASS_1" AS "Score_CLASS_1", "LGBM_B3"."Score_CLASS_2" AS "Score_CLASS_2" 
FROM "618_CODEGEN_854JIR_LGBM_B3" "LGBM_B3" UNION ALL SELECT "LGBM_B4"."KEY" AS "KEY", "LGBM_B4"."Score_CLASS_0" AS "Score_CLASS_0", "LGBM_B4"."Score_CLASS_1" AS "Score_CLASS_1", "LGBM_B4"."Score_CLASS_2" AS "Score_CLASS_2" 
FROM "618_CODEGEN_QWKSI3_LGBM_B4" "LGBM_B4") "LGBM_EnsembleUnion") "LGBM_Union") "U"

-- Code For temporary table 18_CODEGEN_OFV7XB_LGBM_SUM part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "18_CODEGEN_OFV7XB_LGBM_SUM" (
	"KEY" NUMBER(19), 
	"Score_CLASS_0" BINARY_DOUBLE, 
	"Score_CLASS_1" BINARY_DOUBLE, 
	"Score_CLASS_2" BINARY_DOUBLE
...
-- Code For temporary table 18_CODEGEN_OFV7XB_LGBM_SUM part 2. Populate

INSERT INTO "18_CODEGEN_OFV7XB_LGBM_SUM" ("KEY", "Score_CLASS_0", "Score_CLASS_1", "Score_CLASS_2") SELECT "U"."KEY", "U"."Score_CLASS_0", "U"."Score_CLASS_1", "U"."Score_CLASS_2" 
...
FROM "_CODEGEN_ROYYS1_LGBM_UNION" "LGBM_Union" GROUP BY "LGBM_Union"."KEY") "T") "LGBM_sum") "U"
...
FROM "18_CODEGEN_OFV7XB_LGBM_SUM" "LGBM_sum"), 
