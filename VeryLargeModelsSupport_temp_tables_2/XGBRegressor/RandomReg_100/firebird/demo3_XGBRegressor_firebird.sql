...
-- Code For temporary table TMP_20180508182837_CODEGEN_VKUD part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508182837_CODEGEN_VKUD" (
	"KEY" BIGINT, 
...
-- Code For temporary table TMP_20180508182837_CODEGEN_VKUD part 2. Populate

INSERT INTO "TMP_20180508182837_CODEGEN_VKUD" ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
-- Code For temporary table TMP_20180508182837_CODEGEN_HKNH part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508182837_CODEGEN_HKNH" (
	"KEY" BIGINT, 
	"Estimator" DOUBLE PRECISION
)
...
-- Code For temporary table TMP_20180508182837_CODEGEN_HKNH part 2. Populate

INSERT INTO "TMP_20180508182837_CODEGEN_HKNH" ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
-- Code For temporary table TMP_20180508182837_CODEGEN_DT0K part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508182837_CODEGEN_DT0K" (
	"KEY" BIGINT, 
	"Estimator" DOUBLE PRECISION
)
...
-- Code For temporary table TMP_20180508182837_CODEGEN_DT0K part 2. Populate

INSERT INTO "TMP_20180508182837_CODEGEN_DT0K" ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
FROM "TMP_20180508182837_CODEGEN_VKUD" AS "XGB_B0" UNION ALL SELECT "XGB_B1"."KEY" AS "KEY", "XGB_B1"."Estimator" AS "Estimator" 
FROM "TMP_20180508182837_CODEGEN_HKNH" AS "XGB_B1") AS "XGB_EnsembleUnion") AS "XGB_Union") AS "U"

-- Code For temporary table TMP_20180508182837_CODEGEN_DMU3 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508182837_CODEGEN_DMU3" (
	"KEY" BIGINT NOT NULL, 
	"Estimator" DOUBLE PRECISION, 
	PRIMARY KEY ("KEY")
)
...
-- Code For temporary table TMP_20180508182837_CODEGEN_DMU3 part 2. Populate

INSERT INTO "TMP_20180508182837_CODEGEN_DMU3" ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
FROM "TMP_20180508182837_CODEGEN_DT0K" AS "XGB_Union" GROUP BY "XGB_Union"."KEY") AS "T") AS "XGB_sum") AS "U"

-- Code For temporary table TMP_20180508182837_CODEGEN_DMU3 part 3. Create Index 

CREATE INDEX "ix_TMP_20180508182837_C_fca3" ON "TMP_20180508182837_CODEGEN_DMU3" ("KEY")

-- Model deployment code

SELECT "XGB_sum"."KEY" AS "KEY", "XGB_sum"."Estimator" + 0.5 AS "Estimator" 
FROM "TMP_20180508182837_CODEGEN_DMU3" AS "XGB_sum"