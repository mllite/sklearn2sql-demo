...
-- Code For temporary table 5412_CODEGEN_909S4E_XGB_B0 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "5412_CODEGEN_909S4E_XGB_B0" (
	"KEY" NUMBER(19), 
...
-- Code For temporary table 5412_CODEGEN_909S4E_XGB_B0 part 2. Populate

INSERT INTO "5412_CODEGEN_909S4E_XGB_B0" ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
-- Code For temporary table 5412_CODEGEN_30EVB0_XGB_B1 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "5412_CODEGEN_30EVB0_XGB_B1" (
	"KEY" NUMBER(19), 
	"Estimator" BINARY_DOUBLE
)
...
-- Code For temporary table 5412_CODEGEN_30EVB0_XGB_B1 part 2. Populate

INSERT INTO "5412_CODEGEN_30EVB0_XGB_B1" ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
-- Code For temporary table 2_CODEGEN_RAE8VV_XGB_UNION part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "2_CODEGEN_RAE8VV_XGB_UNION" (
	"KEY" NUMBER(19), 
	"Estimator" BINARY_DOUBLE
)
...
-- Code For temporary table 2_CODEGEN_RAE8VV_XGB_UNION part 2. Populate

INSERT INTO "2_CODEGEN_RAE8VV_XGB_UNION" ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
FROM "5412_CODEGEN_909S4E_XGB_B0" "XGB_B0" UNION ALL SELECT "XGB_B1"."KEY" AS "KEY", "XGB_B1"."Estimator" AS "Estimator" 
FROM "5412_CODEGEN_30EVB0_XGB_B1" "XGB_B1") "XGB_EnsembleUnion") "XGB_Union") "U"

-- Code For temporary table 412_CODEGEN_ISCLFS_XGB_SUM part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "412_CODEGEN_ISCLFS_XGB_SUM" (
	"KEY" NUMBER(19), 
	"Estimator" BINARY_DOUBLE
)
...
-- Code For temporary table 412_CODEGEN_ISCLFS_XGB_SUM part 2. Populate

INSERT INTO "412_CODEGEN_ISCLFS_XGB_SUM" ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
FROM "2_CODEGEN_RAE8VV_XGB_UNION" "XGB_Union" GROUP BY "XGB_Union"."KEY") "T") "XGB_sum") "U"

-- Model deployment code

SELECT "XGB_sum"."KEY" AS "KEY", "XGB_sum"."Estimator" + 0.5 AS "Estimator" 
FROM "412_CODEGEN_ISCLFS_XGB_SUM" "XGB_sum"