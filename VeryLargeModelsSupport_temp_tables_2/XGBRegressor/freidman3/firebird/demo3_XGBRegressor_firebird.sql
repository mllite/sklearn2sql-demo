...
-- Code For temporary table TMP_20180508185413_CODEGEN_FP03 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508185413_CODEGEN_FP03" (
	"KEY" BIGINT, 
...
-- Code For temporary table TMP_20180508185413_CODEGEN_FP03 part 2. Populate

INSERT INTO "TMP_20180508185413_CODEGEN_FP03" ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
-- Code For temporary table TMP_20180508185413_CODEGEN_TN9Z part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508185413_CODEGEN_TN9Z" (
	"KEY" BIGINT, 
	"Estimator" DOUBLE PRECISION
)
...
-- Code For temporary table TMP_20180508185413_CODEGEN_TN9Z part 2. Populate

INSERT INTO "TMP_20180508185413_CODEGEN_TN9Z" ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
-- Code For temporary table TMP_20180508185413_CODEGEN_VXZA part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508185413_CODEGEN_VXZA" (
	"KEY" BIGINT, 
	"Estimator" DOUBLE PRECISION
)
...
-- Code For temporary table TMP_20180508185413_CODEGEN_VXZA part 2. Populate

INSERT INTO "TMP_20180508185413_CODEGEN_VXZA" ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
FROM "TMP_20180508185413_CODEGEN_FP03" AS "XGB_B0" UNION ALL SELECT "XGB_B1"."KEY" AS "KEY", "XGB_B1"."Estimator" AS "Estimator" 
FROM "TMP_20180508185413_CODEGEN_TN9Z" AS "XGB_B1") AS "XGB_EnsembleUnion") AS "XGB_Union") AS "U"

-- Code For temporary table TMP_20180508185413_CODEGEN_P6VE part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508185413_CODEGEN_P6VE" (
	"KEY" BIGINT NOT NULL, 
	"Estimator" DOUBLE PRECISION, 
	PRIMARY KEY ("KEY")
)
...
-- Code For temporary table TMP_20180508185413_CODEGEN_P6VE part 2. Populate

INSERT INTO "TMP_20180508185413_CODEGEN_P6VE" ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
FROM "TMP_20180508185413_CODEGEN_VXZA" AS "XGB_Union" GROUP BY "XGB_Union"."KEY") AS "T") AS "XGB_sum") AS "U"

-- Code For temporary table TMP_20180508185413_CODEGEN_P6VE part 3. Create Index 

CREATE INDEX "ix_TMP_20180508185413_C_1645" ON "TMP_20180508185413_CODEGEN_P6VE" ("KEY")

-- Model deployment code

SELECT "XGB_sum"."KEY" AS "KEY", "XGB_sum"."Estimator" + 0.5 AS "Estimator" 
FROM "TMP_20180508185413_CODEGEN_P6VE" AS "XGB_sum"