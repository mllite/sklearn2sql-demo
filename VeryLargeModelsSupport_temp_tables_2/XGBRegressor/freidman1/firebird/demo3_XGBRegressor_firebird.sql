...
-- Code For temporary table TMP_20180508184654_CODEGEN_501B part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508184654_CODEGEN_501B" (
	"KEY" BIGINT, 
...
-- Code For temporary table TMP_20180508184654_CODEGEN_501B part 2. Populate

INSERT INTO "TMP_20180508184654_CODEGEN_501B" ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
-- Code For temporary table TMP_20180508184654_CODEGEN_JQ6C part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508184654_CODEGEN_JQ6C" (
	"KEY" BIGINT, 
	"Estimator" DOUBLE PRECISION
)
...
-- Code For temporary table TMP_20180508184654_CODEGEN_JQ6C part 2. Populate

INSERT INTO "TMP_20180508184654_CODEGEN_JQ6C" ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
-- Code For temporary table TMP_20180508184654_CODEGEN_ESDB part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508184654_CODEGEN_ESDB" (
	"KEY" BIGINT, 
	"Estimator" DOUBLE PRECISION
)
...
-- Code For temporary table TMP_20180508184654_CODEGEN_ESDB part 2. Populate

INSERT INTO "TMP_20180508184654_CODEGEN_ESDB" ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
FROM "TMP_20180508184654_CODEGEN_501B" AS "XGB_B0" UNION ALL SELECT "XGB_B1"."KEY" AS "KEY", "XGB_B1"."Estimator" AS "Estimator" 
FROM "TMP_20180508184654_CODEGEN_JQ6C" AS "XGB_B1") AS "XGB_EnsembleUnion") AS "XGB_Union") AS "U"

-- Code For temporary table TMP_20180508184654_CODEGEN_6A4B part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508184654_CODEGEN_6A4B" (
	"KEY" BIGINT NOT NULL, 
	"Estimator" DOUBLE PRECISION, 
	PRIMARY KEY ("KEY")
)
...
-- Code For temporary table TMP_20180508184654_CODEGEN_6A4B part 2. Populate

INSERT INTO "TMP_20180508184654_CODEGEN_6A4B" ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
FROM "TMP_20180508184654_CODEGEN_ESDB" AS "XGB_Union" GROUP BY "XGB_Union"."KEY") AS "T") AS "XGB_sum") AS "U"

-- Code For temporary table TMP_20180508184654_CODEGEN_6A4B part 3. Create Index 

CREATE INDEX "ix_TMP_20180508184654_C_e41e" ON "TMP_20180508184654_CODEGEN_6A4B" ("KEY")

-- Model deployment code

SELECT "XGB_sum"."KEY" AS "KEY", "XGB_sum"."Estimator" + 0.5 AS "Estimator" 
FROM "TMP_20180508184654_CODEGEN_6A4B" AS "XGB_sum"