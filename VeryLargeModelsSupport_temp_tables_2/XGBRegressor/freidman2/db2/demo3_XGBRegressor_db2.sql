...
-- Code For temporary table tmp_20180508185036_codegen_otw34j_xgb_b0 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180508185036_codegen_otw34j_xgb_b0 (
	"KEY" BIGINT, 
	"Estimator" DOUBLE
)
...
-- Code For temporary table tmp_20180508185036_codegen_otw34j_xgb_b0 part 2. Populate

INSERT INTO tmp_20180508185036_codegen_otw34j_xgb_b0 WITH "DT_node_lookup" AS 
...
-- Code For temporary table tmp_20180508185036_codegen_p609ya_xgb_b1 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180508185036_codegen_p609ya_xgb_b1 (
	"KEY" BIGINT, 
	"Estimator" DOUBLE
)
...
-- Code For temporary table tmp_20180508185036_codegen_p609ya_xgb_b1 part 2. Populate

INSERT INTO tmp_20180508185036_codegen_p609ya_xgb_b1 WITH "DT_node_lookup_10" AS 
(SELECT "ADS"."KEY" AS "KEY", CASE WHEN ("ADS"."Feature_2" < 0.792053759098053) THEN CASE WHEN ("ADS"."Feature_1" < 784.8369140625) THEN CASE WHEN ("ADS"."Feature_1" < 476.31121826171875) THEN 5 ELSE 6 END ELSE CASE WHEN ("ADS"."Feature_2" < 0.288340300321579) THEN 7 ELSE 8 END END ELSE 2 END AS node_id_2 
FROM "FREIDMAN2" AS "ADS"), 
"DT_node_data_10" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Estimator" AS DOUBLE) AS "Estimator" 
...
-- Code For temporary table tmp_20180508185036_codegen_5q3zuq_xgb_union part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180508185036_codegen_5q3zuq_xgb_union (
	"KEY" BIGINT, 
	"Estimator" DOUBLE
)
...
-- Code For temporary table tmp_20180508185036_codegen_5q3zuq_xgb_union part 2. Populate

INSERT INTO tmp_20180508185036_codegen_5q3zuq_xgb_union SELECT "XGB_Union"."KEY", "XGB_Union"."Estimator" 
...
FROM tmp_20180508185036_codegen_otw34j_xgb_b0 AS "XGB_B0" UNION ALL SELECT "XGB_B1"."KEY" AS "KEY", "XGB_B1"."Estimator" AS "Estimator" 
FROM tmp_20180508185036_codegen_p609ya_xgb_b1 AS "XGB_B1") AS "XGB_EnsembleUnion") AS "XGB_Union"

-- Code For temporary table tmp_20180508185036_codegen_anpfgy_xgb_sum part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180508185036_codegen_anpfgy_xgb_sum (
	"KEY" BIGINT, 
	"Estimator" DOUBLE
)
...
-- Code For temporary table tmp_20180508185036_codegen_anpfgy_xgb_sum part 2. Populate

INSERT INTO tmp_20180508185036_codegen_anpfgy_xgb_sum SELECT "XGB_sum"."KEY", "XGB_sum"."Estimator" 
...
FROM tmp_20180508185036_codegen_5q3zuq_xgb_union AS "XGB_Union" GROUP BY "XGB_Union"."KEY") AS "T") AS "XGB_sum"

-- Model deployment code

SELECT "XGB_sum"."KEY" AS "KEY", "XGB_sum"."Estimator" + 0.5 AS "Estimator" 
FROM tmp_20180508185036_codegen_anpfgy_xgb_sum AS "XGB_sum"