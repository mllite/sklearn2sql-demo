...
-- Code For temporary table TMP_20180508183617_CODEGEN_F7TC part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508183617_CODEGEN_F7TC" (
	"KEY" BIGINT, 
...
-- Code For temporary table TMP_20180508183617_CODEGEN_F7TC part 2. Populate

INSERT INTO "TMP_20180508183617_CODEGEN_F7TC" ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
-- Code For temporary table TMP_20180508183617_CODEGEN_CAIM part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508183617_CODEGEN_CAIM" (
	"KEY" BIGINT, 
	"Estimator" DOUBLE PRECISION
)
...
-- Code For temporary table TMP_20180508183617_CODEGEN_CAIM part 2. Populate

INSERT INTO "TMP_20180508183617_CODEGEN_CAIM" ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
-- Code For temporary table TMP_20180508183617_CODEGEN_GFDD part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508183617_CODEGEN_GFDD" (
	"KEY" BIGINT, 
	"Estimator" DOUBLE PRECISION
)
...
-- Code For temporary table TMP_20180508183617_CODEGEN_GFDD part 2. Populate

INSERT INTO "TMP_20180508183617_CODEGEN_GFDD" ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
FROM "TMP_20180508183617_CODEGEN_F7TC" AS "XGB_B0" UNION ALL SELECT "XGB_B1"."KEY" AS "KEY", "XGB_B1"."Estimator" AS "Estimator" 
FROM "TMP_20180508183617_CODEGEN_CAIM" AS "XGB_B1") AS "XGB_EnsembleUnion") AS "XGB_Union") AS "U"

-- Code For temporary table TMP_20180508183617_CODEGEN_C9BV part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508183617_CODEGEN_C9BV" (
	"KEY" BIGINT NOT NULL, 
	"Estimator" DOUBLE PRECISION, 
	PRIMARY KEY ("KEY")
)
...
-- Code For temporary table TMP_20180508183617_CODEGEN_C9BV part 2. Populate

INSERT INTO "TMP_20180508183617_CODEGEN_C9BV" ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
FROM "TMP_20180508183617_CODEGEN_GFDD" AS "XGB_Union" GROUP BY "XGB_Union"."KEY") AS "T") AS "XGB_sum") AS "U"

-- Code For temporary table TMP_20180508183617_CODEGEN_C9BV part 3. Create Index 

CREATE INDEX "ix_TMP_20180508183617_C_62dd" ON "TMP_20180508183617_CODEGEN_C9BV" ("KEY")

-- Model deployment code

SELECT "XGB_sum"."KEY" AS "KEY", "XGB_sum"."Estimator" + 0.5 AS "Estimator" 
FROM "TMP_20180508183617_CODEGEN_C9BV" AS "XGB_sum"