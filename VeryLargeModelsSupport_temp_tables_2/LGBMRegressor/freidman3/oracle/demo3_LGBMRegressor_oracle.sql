...
-- Code For temporary table 209_CODEGEN_6V33IN_LGBM_B0 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "209_CODEGEN_6V33IN_LGBM_B0" (
	"KEY" NUMBER(19), 
...
-- Code For temporary table 209_CODEGEN_6V33IN_LGBM_B0 part 2. Populate

INSERT INTO "209_CODEGEN_6V33IN_LGBM_B0" ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
-- Code For temporary table 209_CODEGEN_V41GQW_LGBM_B1 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "209_CODEGEN_V41GQW_LGBM_B1" (
	"KEY" NUMBER(19), 
	"Estimator" BINARY_DOUBLE
)
...
-- Code For temporary table 209_CODEGEN_V41GQW_LGBM_B1 part 2. Populate

INSERT INTO "209_CODEGEN_V41GQW_LGBM_B1" ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
-- Code For temporary table _CODEGEN_OFNXL6_LGBM_UNION part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "_CODEGEN_OFNXL6_LGBM_UNION" (
	"KEY" NUMBER(19), 
	"Estimator" BINARY_DOUBLE
)
...
-- Code For temporary table _CODEGEN_OFNXL6_LGBM_UNION part 2. Populate

INSERT INTO "_CODEGEN_OFNXL6_LGBM_UNION" ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
FROM "209_CODEGEN_6V33IN_LGBM_B0" "LGBM_B0" UNION ALL SELECT "LGBM_B1"."KEY" AS "KEY", "LGBM_B1"."Estimator" AS "Estimator" 
FROM "209_CODEGEN_V41GQW_LGBM_B1" "LGBM_B1") "LGBM_EnsembleUnion") "LGBM_Union") "U"

-- Code For temporary table 09_CODEGEN_LS5HVK_LGBM_SUM part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "09_CODEGEN_LS5HVK_LGBM_SUM" (
	"KEY" NUMBER(19), 
	"Estimator" BINARY_DOUBLE
)
...
-- Code For temporary table 09_CODEGEN_LS5HVK_LGBM_SUM part 2. Populate

INSERT INTO "09_CODEGEN_LS5HVK_LGBM_SUM" ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
FROM "_CODEGEN_OFNXL6_LGBM_UNION" "LGBM_Union" GROUP BY "LGBM_Union"."KEY") "T") "LGBM_sum") "U"

-- Model deployment code

SELECT "LGBM_sum"."KEY" AS "KEY", "LGBM_sum"."Estimator" AS "Estimator" 
FROM "09_CODEGEN_LS5HVK_LGBM_SUM" "LGBM_sum"