...
-- Code For temporary table TMP_20180508184830_CODEGEN_0I0R part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508184830_CODEGEN_0I0R" (
	"KEY" BIGINT, 
...
-- Code For temporary table TMP_20180508184830_CODEGEN_0I0R part 2. Populate

INSERT INTO "TMP_20180508184830_CODEGEN_0I0R" ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
-- Code For temporary table TMP_20180508184830_CODEGEN_5N9S part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508184830_CODEGEN_5N9S" (
	"KEY" BIGINT, 
	"Estimator" DOUBLE PRECISION
)
...
-- Code For temporary table TMP_20180508184830_CODEGEN_5N9S part 2. Populate

INSERT INTO "TMP_20180508184830_CODEGEN_5N9S" ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
-- Code For temporary table TMP_20180508184830_CODEGEN_OUO3 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508184830_CODEGEN_OUO3" (
	"KEY" BIGINT, 
	"Estimator" DOUBLE PRECISION
)
...
-- Code For temporary table TMP_20180508184830_CODEGEN_OUO3 part 2. Populate

INSERT INTO "TMP_20180508184830_CODEGEN_OUO3" ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
FROM "TMP_20180508184830_CODEGEN_0I0R" AS "LGBM_B0" UNION ALL SELECT "LGBM_B1"."KEY" AS "KEY", "LGBM_B1"."Estimator" AS "Estimator" 
FROM "TMP_20180508184830_CODEGEN_5N9S" AS "LGBM_B1") AS "LGBM_EnsembleUnion") AS "LGBM_Union") AS "U"

-- Code For temporary table TMP_20180508184830_CODEGEN_92ZK part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508184830_CODEGEN_92ZK" (
	"KEY" BIGINT NOT NULL, 
	"Estimator" DOUBLE PRECISION, 
	PRIMARY KEY ("KEY")
)
...
-- Code For temporary table TMP_20180508184830_CODEGEN_92ZK part 2. Populate

INSERT INTO "TMP_20180508184830_CODEGEN_92ZK" ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
FROM "TMP_20180508184830_CODEGEN_OUO3" AS "LGBM_Union" GROUP BY "LGBM_Union"."KEY") AS "T") AS "LGBM_sum") AS "U"

-- Code For temporary table TMP_20180508184830_CODEGEN_92ZK part 3. Create Index 

CREATE INDEX "ix_TMP_20180508184830_C_5771" ON "TMP_20180508184830_CODEGEN_92ZK" ("KEY")

-- Model deployment code

SELECT "LGBM_sum"."KEY" AS "KEY", "LGBM_sum"."Estimator" AS "Estimator" 
FROM "TMP_20180508184830_CODEGEN_92ZK" AS "LGBM_sum"