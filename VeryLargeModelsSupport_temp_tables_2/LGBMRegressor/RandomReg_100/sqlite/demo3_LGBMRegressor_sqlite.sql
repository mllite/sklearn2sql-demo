...
-- Code For temporary table TMP_20180508182619_CODEGEN_9SGVRR_LGBM_B0 part 1. Create 


CREATE TEMPORARY TABLE "TMP_20180508182619_CODEGEN_9SGVRR_LGBM_B0" (
	"KEY" BIGINT, 
	"Estimator" FLOAT
)
...
-- Code For temporary table TMP_20180508182619_CODEGEN_9SGVRR_LGBM_B0 part 2. Populate
...
FROM "DT_Output_9")
 INSERT INTO "TMP_20180508182619_CODEGEN_9SGVRR_LGBM_B0" ("KEY", "Estimator") SELECT "LGBM_B0"."KEY", "LGBM_B0"."Estimator" 
...
-- Code For temporary table TMP_20180508182619_CODEGEN_D9480K_LGBM_B1 part 1. Create 


CREATE TEMPORARY TABLE "TMP_20180508182619_CODEGEN_D9480K_LGBM_B1" (
	"KEY" BIGINT, 
	"Estimator" FLOAT
)
...
-- Code For temporary table TMP_20180508182619_CODEGEN_D9480K_LGBM_B1 part 2. Populate
...
FROM "DT_Output_15")
 INSERT INTO "TMP_20180508182619_CODEGEN_D9480K_LGBM_B1" ("KEY", "Estimator") SELECT "LGBM_B1"."KEY", "LGBM_B1"."Estimator" 
...
-- Code For temporary table TMP_20180508182619_CODEGEN_BOXUBD_LGBM_Union part 1. Create 


CREATE TEMPORARY TABLE "TMP_20180508182619_CODEGEN_BOXUBD_LGBM_Union" (
	"KEY" BIGINT, 
	"Estimator" FLOAT
)
...
-- Code For temporary table TMP_20180508182619_CODEGEN_BOXUBD_LGBM_Union part 2. Populate

INSERT INTO "TMP_20180508182619_CODEGEN_BOXUBD_LGBM_Union" ("KEY", "Estimator") SELECT "LGBM_Union"."KEY", "LGBM_Union"."Estimator" 
...
FROM "TMP_20180508182619_CODEGEN_9SGVRR_LGBM_B0" AS "LGBM_B0" UNION ALL SELECT "LGBM_B1"."KEY" AS "KEY", "LGBM_B1"."Estimator" AS "Estimator" 
FROM "TMP_20180508182619_CODEGEN_D9480K_LGBM_B1" AS "LGBM_B1") AS "LGBM_EnsembleUnion") AS "LGBM_Union"

-- Code For temporary table TMP_20180508182619_CODEGEN_9WOQYT_LGBM_sum part 1. Create 


CREATE TEMPORARY TABLE "TMP_20180508182619_CODEGEN_9WOQYT_LGBM_sum" (
	"KEY" BIGINT NOT NULL, 
	"Estimator" FLOAT, 
	PRIMARY KEY ("KEY")
)
...
-- Code For temporary table TMP_20180508182619_CODEGEN_9WOQYT_LGBM_sum part 2. Populate

INSERT INTO "TMP_20180508182619_CODEGEN_9WOQYT_LGBM_sum" ("KEY", "Estimator") SELECT "LGBM_sum"."KEY", "LGBM_sum"."Estimator" 
...
FROM "TMP_20180508182619_CODEGEN_BOXUBD_LGBM_Union" AS "LGBM_Union" GROUP BY "LGBM_Union"."KEY") AS "T") AS "LGBM_sum"

-- Code For temporary table TMP_20180508182619_CODEGEN_9WOQYT_LGBM_sum part 3. Create Index 

CREATE INDEX "ix_TMP_20180508182619_CODEGEN_9WOQYT_LGBM_sum_KEY" ON "TMP_20180508182619_CODEGEN_9WOQYT_LGBM_sum" ("KEY")

-- Model deployment code

SELECT "LGBM_sum"."KEY" AS "KEY", "LGBM_sum"."Estimator" AS "Estimator" 
FROM "TMP_20180508182619_CODEGEN_9WOQYT_LGBM_sum" AS "LGBM_sum"