...
-- Code For temporary table TMP_20180508182620_CODEGEN_EXR6 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508182620_CODEGEN_EXR6" (
	"KEY" BIGINT, 
...
-- Code For temporary table TMP_20180508182620_CODEGEN_EXR6 part 2. Populate

INSERT INTO "TMP_20180508182620_CODEGEN_EXR6" ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
-- Code For temporary table TMP_20180508182620_CODEGEN_Y1MJ part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508182620_CODEGEN_Y1MJ" (
	"KEY" BIGINT, 
	"Estimator" DOUBLE PRECISION
)
...
-- Code For temporary table TMP_20180508182620_CODEGEN_Y1MJ part 2. Populate

INSERT INTO "TMP_20180508182620_CODEGEN_Y1MJ" ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
-- Code For temporary table TMP_20180508182620_CODEGEN_8G68 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508182620_CODEGEN_8G68" (
	"KEY" BIGINT, 
	"Estimator" DOUBLE PRECISION
)
...
-- Code For temporary table TMP_20180508182620_CODEGEN_8G68 part 2. Populate

INSERT INTO "TMP_20180508182620_CODEGEN_8G68" ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
FROM "TMP_20180508182620_CODEGEN_EXR6" AS "LGBM_B0" UNION ALL SELECT "LGBM_B1"."KEY" AS "KEY", "LGBM_B1"."Estimator" AS "Estimator" 
FROM "TMP_20180508182620_CODEGEN_Y1MJ" AS "LGBM_B1") AS "LGBM_EnsembleUnion") AS "LGBM_Union") AS "U"

-- Code For temporary table TMP_20180508182620_CODEGEN_0NHX part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508182620_CODEGEN_0NHX" (
	"KEY" BIGINT NOT NULL, 
	"Estimator" DOUBLE PRECISION, 
	PRIMARY KEY ("KEY")
)
...
-- Code For temporary table TMP_20180508182620_CODEGEN_0NHX part 2. Populate

INSERT INTO "TMP_20180508182620_CODEGEN_0NHX" ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
FROM "TMP_20180508182620_CODEGEN_8G68" AS "LGBM_Union" GROUP BY "LGBM_Union"."KEY") AS "T") AS "LGBM_sum") AS "U"

-- Code For temporary table TMP_20180508182620_CODEGEN_0NHX part 3. Create Index 

CREATE INDEX "ix_TMP_20180508182620_C_0dc1" ON "TMP_20180508182620_CODEGEN_0NHX" ("KEY")

-- Model deployment code

SELECT "LGBM_sum"."KEY" AS "KEY", "LGBM_sum"."Estimator" AS "Estimator" 
FROM "TMP_20180508182620_CODEGEN_0NHX" AS "LGBM_sum"