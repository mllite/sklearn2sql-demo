...
-- Code For temporary table 227_CODEGEN_9PVJCR_LGBM_B0 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "227_CODEGEN_9PVJCR_LGBM_B0" (
	"KEY" NUMBER(19), 
...
-- Code For temporary table 227_CODEGEN_9PVJCR_LGBM_B0 part 2. Populate

INSERT INTO "227_CODEGEN_9PVJCR_LGBM_B0" ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
FROM (SELECT 3 AS nid, 32.746200772783446 AS "Estimator" FROM DUAL UNION ALL SELECT 4 AS nid, 16.35685888558626 AS "Estimator" FROM DUAL UNION ALL SELECT 5 AS nid, 26.55858030807355 AS "Estimator" FROM DUAL) "Values"), 
"DT_Output" AS 
...
"DT_node_data_1" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Estimator" AS BINARY_DOUBLE) AS "Estimator" 
FROM (SELECT 3 AS nid, 6.023330282395886 AS "Estimator" FROM DUAL UNION ALL SELECT 4 AS nid, -9.546544489860535 AS "Estimator" FROM DUAL UNION ALL SELECT 5 AS nid, 0.14509103724668768 AS "Estimator" FROM DUAL) "Values"), 
"DT_Output_1" AS 
...
"DT_node_data_2" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Estimator" AS BINARY_DOUBLE) AS "Estimator" 
FROM (SELECT 3 AS nid, 5.722164007084024 AS "Estimator" FROM DUAL UNION ALL SELECT 4 AS nid, -7.8801029828878555 AS "Estimator" FROM DUAL UNION ALL SELECT 5 AS nid, 1.1954605499039526 AS "Estimator" FROM DUAL) "Values"), 
"DT_Output_2" AS 
...
"DT_node_data_3" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Estimator" AS BINARY_DOUBLE) AS "Estimator" 
FROM (SELECT 2 AS nid, -6.086806035262567 AS "Estimator" FROM DUAL UNION ALL SELECT 6 AS nid, -0.8521560813441422 AS "Estimator" FROM DUAL UNION ALL SELECT 7 AS nid, 9.623245660066605 AS "Estimator" FROM DUAL) "Values"), 
"DT_Output_3" AS 
...
"DT_node_data_4" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Estimator" AS BINARY_DOUBLE) AS "Estimator" 
FROM (SELECT 2 AS nid, -4.65805237342914 AS "Estimator" FROM DUAL UNION ALL SELECT 6 AS nid, -1.8667952474951743 AS "Estimator" FROM DUAL UNION ALL SELECT 7 AS nid, 8.542741489410401 AS "Estimator" FROM DUAL) "Values"), 
"DT_Output_4" AS 
...
"DT_node_data_5" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Estimator" AS BINARY_DOUBLE) AS "Estimator" 
FROM (SELECT 2 AS nid, -4.193964002723209 AS "Estimator" FROM DUAL UNION ALL SELECT 6 AS nid, 0.2966920852661133 AS "Estimator" FROM DUAL UNION ALL SELECT 7 AS nid, 7.866703109741211 AS "Estimator" FROM DUAL) "Values"), 
"DT_Output_5" AS 
...
"DT_node_data_6" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Estimator" AS BINARY_DOUBLE) AS "Estimator" 
FROM (SELECT 3 AS nid, 5.493027937412262 AS "Estimator" FROM DUAL UNION ALL SELECT 4 AS nid, -6.561676018238067 AS "Estimator" FROM DUAL UNION ALL SELECT 5 AS nid, 1.9566135623238303 AS "Estimator" FROM DUAL) "Values"), 
"DT_Output_6" AS 
...
"DT_node_data_7" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Estimator" AS BINARY_DOUBLE) AS "Estimator" 
FROM (SELECT 2 AS nid, -5.50080465608173 AS "Estimator" FROM DUAL UNION ALL SELECT 6 AS nid, -2.7341144788832894 AS "Estimator" FROM DUAL UNION ALL SELECT 7 AS nid, 6.435566604137421 AS "Estimator" FROM DUAL) "Values"), 
"DT_Output_7" AS 
...
"DT_node_data_8" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Estimator" AS BINARY_DOUBLE) AS "Estimator" 
FROM (SELECT 2 AS nid, -4.967426937421163 AS "Estimator" FROM DUAL UNION ALL SELECT 6 AS nid, -0.6187176295689175 AS "Estimator" FROM DUAL UNION ALL SELECT 7 AS nid, 7.561222980239176 AS "Estimator" FROM DUAL) "Values"), 
"DT_Output_8" AS 
...
"DT_node_data_9" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Estimator" AS BINARY_DOUBLE) AS "Estimator" 
FROM (SELECT 2 AS nid, -6.317852896735783 AS "Estimator" FROM DUAL UNION ALL SELECT 6 AS nid, -2.838640162785506 AS "Estimator" FROM DUAL UNION ALL SELECT 7 AS nid, 7.166515947977702 AS "Estimator" FROM DUAL) "Values"), 
"DT_Output_9" AS 
...
-- Code For temporary table 227_CODEGEN_B1APB9_LGBM_B1 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "227_CODEGEN_B1APB9_LGBM_B1" (
	"KEY" NUMBER(19), 
	"Estimator" BINARY_DOUBLE
)
...
-- Code For temporary table 227_CODEGEN_B1APB9_LGBM_B1 part 2. Populate

INSERT INTO "227_CODEGEN_B1APB9_LGBM_B1" ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
FROM (WITH "DT_node_lookup_10" AS 
(SELECT "ADS"."KEY" AS "KEY", CASE WHEN ("ADS"."Feature_1" <= -0.19500725638808467) THEN 2 ELSE CASE WHEN ("ADS"."Feature_8" <= -0.08420545265254369) THEN 6 ELSE 7 END END AS node_id_2 
FROM "RANDOMREG_10" "ADS"), 
"DT_node_data_10" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Estimator" AS BINARY_DOUBLE) AS "Estimator" 
FROM (SELECT 2 AS nid, -3.7725048169111597 AS "Estimator" FROM DUAL UNION ALL SELECT 6 AS nid, 0.43184781528654553 AS "Estimator" FROM DUAL UNION ALL SELECT 7 AS nid, 6.902944211959839 AS "Estimator" FROM DUAL) "Values"), 
"DT_Output_10" AS 
...
"DT_node_data_11" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Estimator" AS BINARY_DOUBLE) AS "Estimator" 
FROM (SELECT 3 AS nid, 4.561142703794665 AS "Estimator" FROM DUAL UNION ALL SELECT 4 AS nid, -6.227999674862829 AS "Estimator" FROM DUAL UNION ALL SELECT 5 AS nid, 1.9608283829689026 AS "Estimator" FROM DUAL) "Values"), 
"DT_Output_11" AS 
...
"DT_node_data_12" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Estimator" AS BINARY_DOUBLE) AS "Estimator" 
FROM (SELECT 2 AS nid, -4.607918028235436 AS "Estimator" FROM DUAL UNION ALL SELECT 6 AS nid, -0.47535212093165946 AS "Estimator" FROM DUAL UNION ALL SELECT 7 AS nid, 6.888518155162984 AS "Estimator" FROM DUAL) "Values"), 
"DT_Output_12" AS 
...
"DT_node_data_13" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Estimator" AS BINARY_DOUBLE) AS "Estimator" 
FROM (SELECT 2 AS nid, -3.5869268933931986 AS "Estimator" FROM DUAL UNION ALL SELECT 6 AS nid, 0.42814759643515576 AS "Estimator" FROM DUAL UNION ALL SELECT 7 AS nid, 6.544952235221863 AS "Estimator" FROM DUAL) "Values"), 
"DT_Output_13" AS 
...
"DT_node_data_14" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Estimator" AS BINARY_DOUBLE) AS "Estimator" 
FROM (SELECT 2 AS nid, -5.782482641722475 AS "Estimator" FROM DUAL UNION ALL SELECT 6 AS nid, -2.475708982245676 AS "Estimator" FROM DUAL UNION ALL SELECT 7 AS nid, 6.440923217137655 AS "Estimator" FROM DUAL) "Values"), 
"DT_Output_14" AS 
...
"DT_node_data_15" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Estimator" AS BINARY_DOUBLE) AS "Estimator" 
FROM (SELECT 2 AS nid, -4.313408274650574 AS "Estimator" FROM DUAL UNION ALL SELECT 6 AS nid, -0.4734426932675498 AS "Estimator" FROM DUAL UNION ALL SELECT 7 AS nid, 6.484483802047643 AS "Estimator" FROM DUAL) "Values"), 
"DT_Output_15" AS 
...
-- Code For temporary table _CODEGEN_XNYYNF_LGBM_UNION part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "_CODEGEN_XNYYNF_LGBM_UNION" (
	"KEY" NUMBER(19), 
	"Estimator" BINARY_DOUBLE
)
...
-- Code For temporary table _CODEGEN_XNYYNF_LGBM_UNION part 2. Populate

INSERT INTO "_CODEGEN_XNYYNF_LGBM_UNION" ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
FROM "227_CODEGEN_9PVJCR_LGBM_B0" "LGBM_B0" UNION ALL SELECT "LGBM_B1"."KEY" AS "KEY", "LGBM_B1"."Estimator" AS "Estimator" 
FROM "227_CODEGEN_B1APB9_LGBM_B1" "LGBM_B1") "LGBM_EnsembleUnion") "LGBM_Union") "U"

-- Code For temporary table 27_CODEGEN_CIOEMP_LGBM_SUM part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "27_CODEGEN_CIOEMP_LGBM_SUM" (
	"KEY" NUMBER(19), 
	"Estimator" BINARY_DOUBLE
)
...
-- Code For temporary table 27_CODEGEN_CIOEMP_LGBM_SUM part 2. Populate

INSERT INTO "27_CODEGEN_CIOEMP_LGBM_SUM" ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
FROM "_CODEGEN_XNYYNF_LGBM_UNION" "LGBM_Union" GROUP BY "LGBM_Union"."KEY") "T") "LGBM_sum") "U"

-- Model deployment code

SELECT "LGBM_sum"."KEY" AS "KEY", "LGBM_sum"."Estimator" AS "Estimator" 
FROM "27_CODEGEN_CIOEMP_LGBM_SUM" "LGBM_sum"