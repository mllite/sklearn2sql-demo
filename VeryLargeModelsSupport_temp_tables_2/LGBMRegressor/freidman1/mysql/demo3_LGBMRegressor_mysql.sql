...
-- Code For temporary table TMP_20180508184450_CODEGEN_FJQTYT_LGBM_B0 part 1. Create 


CREATE TEMPORARY TABLE `TMP_20180508184450_CODEGEN_FJQTYT_LGBM_B0` (
	`KEY` BIGINT, 
	`Estimator` DOUBLE
)
...
-- Code For temporary table TMP_20180508184450_CODEGEN_FJQTYT_LGBM_B0 part 2. Populate

INSERT INTO `TMP_20180508184450_CODEGEN_FJQTYT_LGBM_B0` (`KEY`, `Estimator`) SELECT `U`.`KEY`, `U`.`Estimator` 
...
-- Code For temporary table TMP_20180508184450_CODEGEN_L3ZOR0_LGBM_B1 part 1. Create 


CREATE TEMPORARY TABLE `TMP_20180508184450_CODEGEN_L3ZOR0_LGBM_B1` (
	`KEY` BIGINT, 
	`Estimator` DOUBLE
)
...
-- Code For temporary table TMP_20180508184450_CODEGEN_L3ZOR0_LGBM_B1 part 2. Populate

INSERT INTO `TMP_20180508184450_CODEGEN_L3ZOR0_LGBM_B1` (`KEY`, `Estimator`) SELECT `U`.`KEY`, `U`.`Estimator` 
...
-- Code For temporary table TMP_20180508184450_CODEGEN_7VP5R3_LGBM_Union part 1. Create 


CREATE TEMPORARY TABLE `TMP_20180508184450_CODEGEN_7VP5R3_LGBM_Union` (
	`KEY` BIGINT, 
	`Estimator` DOUBLE
)
...
-- Code For temporary table TMP_20180508184450_CODEGEN_7VP5R3_LGBM_Union part 2. Populate

INSERT INTO `TMP_20180508184450_CODEGEN_7VP5R3_LGBM_Union` (`KEY`, `Estimator`) SELECT `U`.`KEY`, `U`.`Estimator` 
...
FROM `TMP_20180508184450_CODEGEN_FJQTYT_LGBM_B0` AS `LGBM_B0` UNION ALL SELECT `LGBM_B1`.`KEY` AS `KEY`, `LGBM_B1`.`Estimator` AS `Estimator` 
FROM `TMP_20180508184450_CODEGEN_L3ZOR0_LGBM_B1` AS `LGBM_B1`) AS `LGBM_EnsembleUnion`) AS `LGBM_Union`) AS `U`

-- Code For temporary table TMP_20180508184450_CODEGEN_J5HJ0X_LGBM_sum part 1. Create 


CREATE TEMPORARY TABLE `TMP_20180508184450_CODEGEN_J5HJ0X_LGBM_sum` (
	`KEY` BIGINT NOT NULL, 
	`Estimator` DOUBLE, 
	PRIMARY KEY (`KEY`)
)
...
-- Code For temporary table TMP_20180508184450_CODEGEN_J5HJ0X_LGBM_sum part 2. Populate

INSERT INTO `TMP_20180508184450_CODEGEN_J5HJ0X_LGBM_sum` (`KEY`, `Estimator`) SELECT `U`.`KEY`, `U`.`Estimator` 
...
FROM `TMP_20180508184450_CODEGEN_7VP5R3_LGBM_Union` AS `LGBM_Union` GROUP BY `LGBM_Union`.`KEY`) AS `T`) AS `LGBM_sum`) AS `U`

-- Code For temporary table TMP_20180508184450_CODEGEN_J5HJ0X_LGBM_sum part 3. Create Index 

CREATE INDEX `ix_TMP_20180508184450_CODEGEN_J5HJ0X_LGBM_sum_KEY` ON `TMP_20180508184450_CODEGEN_J5HJ0X_LGBM_sum` (`KEY`)

-- Model deployment code

SELECT `LGBM_sum`.`KEY` AS `KEY`, `LGBM_sum`.`Estimator` AS `Estimator` 
FROM `TMP_20180508184450_CODEGEN_J5HJ0X_LGBM_sum` AS `LGBM_sum`