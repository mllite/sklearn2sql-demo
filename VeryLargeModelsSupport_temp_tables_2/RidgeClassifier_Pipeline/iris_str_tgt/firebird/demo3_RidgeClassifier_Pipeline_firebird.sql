...
-- Code For temporary table TMP_20180508190717_CODEGEN_F2YP part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508190717_CODEGEN_F2YP" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20180508190717_CODEGEN_F2YP part 2. Populate

INSERT INTO "TMP_20180508190717_CODEGEN_F2YP" ("KEY", imputer_output_2, imputer_output_3, imputer_output_4, imputer_output_5) SELECT "U"."KEY", "U".imputer_output_2, "U".imputer_output_3, "U".imputer_output_4, "U".imputer_output_5 
...
-- Code For temporary table TMP_20180508190717_CODEGEN_F2YP part 3. Create Index 

CREATE INDEX "ix_TMP_20180508190717_C_0326" ON "TMP_20180508190717_CODEGEN_F2YP" ("KEY")

-- Code For temporary table TMP_20180508190717_CODEGEN_QF2D part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508190717_CODEGEN_QF2D" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20180508190717_CODEGEN_QF2D part 2. Populate

INSERT INTO "TMP_20180508190717_CODEGEN_QF2D" ("KEY", scaler_output_2, scaler_output_3, scaler_output_4, scaler_output_5) SELECT "U"."KEY", "U".scaler_output_2, "U".scaler_output_3, "U".scaler_output_4, "U".scaler_output_5 
...
FROM "TMP_20180508190717_CODEGEN_F2YP" AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT") AS "U"

-- Code For temporary table TMP_20180508190717_CODEGEN_QF2D part 3. Create Index 

CREATE INDEX "ix_TMP_20180508190717_C_7ed0" ON "TMP_20180508190717_CODEGEN_QF2D" ("KEY")
...
FROM "TMP_20180508190717_CODEGEN_QF2D" AS "ADS_sca_2_OUT"), 
linear_model_cte AS 
