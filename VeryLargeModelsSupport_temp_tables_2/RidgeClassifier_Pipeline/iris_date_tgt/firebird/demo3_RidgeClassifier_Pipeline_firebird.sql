...
-- Code For temporary table TMP_20180508190227_CODEGEN_CXF6 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508190227_CODEGEN_CXF6" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20180508190227_CODEGEN_CXF6 part 2. Populate

INSERT INTO "TMP_20180508190227_CODEGEN_CXF6" ("KEY", imputer_output_2, imputer_output_3, imputer_output_4, imputer_output_5) SELECT "U"."KEY", "U".imputer_output_2, "U".imputer_output_3, "U".imputer_output_4, "U".imputer_output_5 
...
-- Code For temporary table TMP_20180508190227_CODEGEN_CXF6 part 3. Create Index 

CREATE INDEX "ix_TMP_20180508190227_C_09d8" ON "TMP_20180508190227_CODEGEN_CXF6" ("KEY")

-- Code For temporary table TMP_20180508190227_CODEGEN_SYU5 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508190227_CODEGEN_SYU5" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20180508190227_CODEGEN_SYU5 part 2. Populate

INSERT INTO "TMP_20180508190227_CODEGEN_SYU5" ("KEY", scaler_output_2, scaler_output_3, scaler_output_4, scaler_output_5) SELECT "U"."KEY", "U".scaler_output_2, "U".scaler_output_3, "U".scaler_output_4, "U".scaler_output_5 
...
FROM "TMP_20180508190227_CODEGEN_CXF6" AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT") AS "U"

-- Code For temporary table TMP_20180508190227_CODEGEN_SYU5 part 3. Create Index 

CREATE INDEX "ix_TMP_20180508190227_C_aa07" ON "TMP_20180508190227_CODEGEN_SYU5" ("KEY")
...
FROM "TMP_20180508190227_CODEGEN_SYU5" AS "ADS_sca_2_OUT"), 
linear_model_cte AS 
