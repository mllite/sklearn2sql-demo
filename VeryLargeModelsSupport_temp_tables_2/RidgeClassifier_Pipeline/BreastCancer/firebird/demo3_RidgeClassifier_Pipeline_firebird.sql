...
-- Code For temporary table TMP_20180508180919_CODEGEN_S7N1 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508180919_CODEGEN_S7N1" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20180508180919_CODEGEN_S7N1 part 3. Create Index 

CREATE INDEX "ix_TMP_20180508180919_C_ce70" ON "TMP_20180508180919_CODEGEN_S7N1" ("KEY")

-- Code For temporary table TMP_20180508180919_CODEGEN_QEUJ part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508180919_CODEGEN_QEUJ" (
	"KEY" BIGINT NOT NULL, 
...
FROM "TMP_20180508180919_CODEGEN_S7N1" AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT") AS "U"

-- Code For temporary table TMP_20180508180919_CODEGEN_QEUJ part 3. Create Index 

CREATE INDEX "ix_TMP_20180508180919_C_351c" ON "TMP_20180508180919_CODEGEN_QEUJ" ("KEY")
...
FROM "TMP_20180508180919_CODEGEN_QEUJ" AS "ADS_sca_2_OUT"), 
linear_model_cte AS 
