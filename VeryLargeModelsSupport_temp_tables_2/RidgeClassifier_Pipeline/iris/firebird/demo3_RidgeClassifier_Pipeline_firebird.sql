...
-- Code For temporary table TMP_20180508185745_CODEGEN_W63R part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508185745_CODEGEN_W63R" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20180508185745_CODEGEN_W63R part 2. Populate

INSERT INTO "TMP_20180508185745_CODEGEN_W63R" ("KEY", imputer_output_2, imputer_output_3, imputer_output_4, imputer_output_5) SELECT "U"."KEY", "U".imputer_output_2, "U".imputer_output_3, "U".imputer_output_4, "U".imputer_output_5 
...
-- Code For temporary table TMP_20180508185745_CODEGEN_W63R part 3. Create Index 

CREATE INDEX "ix_TMP_20180508185745_C_4e35" ON "TMP_20180508185745_CODEGEN_W63R" ("KEY")

-- Code For temporary table TMP_20180508185745_CODEGEN_TTOB part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508185745_CODEGEN_TTOB" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20180508185745_CODEGEN_TTOB part 2. Populate

INSERT INTO "TMP_20180508185745_CODEGEN_TTOB" ("KEY", scaler_output_2, scaler_output_3, scaler_output_4, scaler_output_5) SELECT "U"."KEY", "U".scaler_output_2, "U".scaler_output_3, "U".scaler_output_4, "U".scaler_output_5 
...
FROM "TMP_20180508185745_CODEGEN_W63R" AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT") AS "U"

-- Code For temporary table TMP_20180508185745_CODEGEN_TTOB part 3. Create Index 

CREATE INDEX "ix_TMP_20180508185745_C_40f3" ON "TMP_20180508185745_CODEGEN_TTOB" ("KEY")
...
FROM "TMP_20180508185745_CODEGEN_TTOB" AS "ADS_sca_2_OUT"), 
linear_model_cte AS 
