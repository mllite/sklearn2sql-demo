...
-- Code For temporary table tmp_20180508185502_codegen_u1b3c6_ads_imp_1_out part 1. Create 


CREATE TEMPORARY TABLE tmp_20180508185502_codegen_u1b3c6_ads_imp_1_out (
	"KEY" BIGINT, 
...
-- Code For temporary table tmp_20180508185502_codegen_u1b3c6_ads_imp_1_out part 2. Populate

INSERT INTO tmp_20180508185502_codegen_u1b3c6_ads_imp_1_out ("KEY", imputer_output_2, imputer_output_3, imputer_output_4, imputer_output_5) SELECT "U"."KEY", "U".imputer_output_2, "U".imputer_output_3, "U".imputer_output_4, "U".imputer_output_5 
...
-- Code For temporary table tmp_20180508185502_codegen_mvrwg7_ads_sca_2_out part 1. Create 


CREATE TEMPORARY TABLE tmp_20180508185502_codegen_mvrwg7_ads_sca_2_out (
	"KEY" BIGINT, 
...
-- Code For temporary table tmp_20180508185502_codegen_mvrwg7_ads_sca_2_out part 2. Populate

INSERT INTO tmp_20180508185502_codegen_mvrwg7_ads_sca_2_out ("KEY", scaler_output_2, scaler_output_3, scaler_output_4, scaler_output_5) SELECT "U"."KEY", "U".scaler_output_2, "U".scaler_output_3, "U".scaler_output_4, "U".scaler_output_5 
...
FROM tmp_20180508185502_codegen_u1b3c6_ads_imp_1_out AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT") AS "U"

-- Code For temporary table tmp_20180508185502_codegen_bx5aa1_calprob_b0 part 1. Create 


CREATE TEMPORARY TABLE tmp_20180508185502_codegen_bx5aa1_calprob_b0 (
	"KEY" BIGINT, 
	"Proba_0" DOUBLE, 
	"Proba_1" DOUBLE, 
	"Proba_2" DOUBLE
...
-- Code For temporary table tmp_20180508185502_codegen_bx5aa1_calprob_b0 part 2. Populate

INSERT INTO tmp_20180508185502_codegen_bx5aa1_calprob_b0 ("KEY", "Proba_0", "Proba_1", "Proba_2") SELECT "U"."KEY", "U"."Proba_0", "U"."Proba_1", "U"."Proba_2" 
...
FROM tmp_20180508185502_codegen_mvrwg7_ads_sca_2_out AS "ADS_sca_2_OUT"), 
"DT_node_data" AS 
...
(SELECT "DT_Output_1"."KEY" AS "KEY", CAST(NULL AS DOUBLE) AS "Score_0", CAST(NULL AS DOUBLE) AS "Score_1", CAST(NULL AS DOUBLE) AS "Score_2", "DT_Output_1"."P_0" AS "Proba_0", "DT_Output_1"."P_1" AS "Proba_1", "DT_Output_1"."P_2" AS "Proba_2", log(CASE WHEN ("DT_Output_1"."P_0" IS NULL OR "DT_Output_1"."P_0" > 1e-100) THEN "DT_Output_1"."P_0" ELSE 1e-100 END) AS "LogProba_0", log(CASE WHEN ("DT_Output_1"."P_1" IS NULL OR "DT_Output_1"."P_1" > 1e-100) THEN "DT_Output_1"."P_1" ELSE 1e-100 END) AS "LogProba_1", log(CASE WHEN ("DT_Output_1"."P_2" IS NULL OR "DT_Output_1"."P_2" > 1e-100) THEN "DT_Output_1"."P_2" ELSE 1e-100 END) AS "LogProba_2", CAST(NULL AS BIGINT) AS "Decision", CAST(NULL AS DOUBLE) AS "DecisionProba", coalesce(CAST(NULL AS DOUBLE), "DT_Output_1"."P_0") AS "ScoreOrProba_0", coalesce(CAST(NULL AS DOUBLE), "DT_Output_1"."P_1") AS "ScoreOrProba_1", coalesce(CAST(NULL AS DOUBLE), "DT_Output_1"."P_2") AS "ScoreOrProba_2" 
FROM "DT_Output_1"), 
...
-- Code For temporary table tmp_20180508185502_codegen_s499uj_calprob_union part 1. Create 


CREATE TEMPORARY TABLE tmp_20180508185502_codegen_s499uj_calprob_union (
	"KEY" BIGINT, 
	"Proba_0" DOUBLE, 
	"Proba_1" DOUBLE, 
	"Proba_2" DOUBLE
...
-- Code For temporary table tmp_20180508185502_codegen_s499uj_calprob_union part 2. Populate

INSERT INTO tmp_20180508185502_codegen_s499uj_calprob_union ("KEY", "Proba_0", "Proba_1", "Proba_2") SELECT "U"."KEY", "U"."Proba_0", "U"."Proba_1", "U"."Proba_2" 
...
FROM tmp_20180508185502_codegen_bx5aa1_calprob_b0 AS "CalProb_B0") AS "CalProb_EnsembleUnion") AS "CalProb_Union") AS "U"

-- Code For temporary table tmp_20180508185502_codegen_o6i3yf_calprob_avg part 1. Create 


CREATE TEMPORARY TABLE tmp_20180508185502_codegen_o6i3yf_calprob_avg (
	"KEY" BIGINT, 
	"Proba_0" DOUBLE, 
	"Proba_1" DOUBLE, 
	"Proba_2" DOUBLE
...
-- Code For temporary table tmp_20180508185502_codegen_o6i3yf_calprob_avg part 2. Populate

INSERT INTO tmp_20180508185502_codegen_o6i3yf_calprob_avg ("KEY", "Proba_0", "Proba_1", "Proba_2") SELECT "U"."KEY", "U"."Proba_0", "U"."Proba_1", "U"."Proba_2" 
...
FROM tmp_20180508185502_codegen_s499uj_calprob_union AS "CalProb_Union" GROUP BY "CalProb_Union"."KEY") AS "T") AS "CalProb_avg") AS "U"
...
FROM tmp_20180508185502_codegen_o6i3yf_calprob_avg AS "CalProb_avg"), 
