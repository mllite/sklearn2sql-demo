...
-- Code For temporary table tmp_20180508190437_codegen_6kem4x_ads_imp_1_out part 1. Create 


CREATE TEMPORARY TABLE tmp_20180508190437_codegen_6kem4x_ads_imp_1_out (
	"KEY" BIGINT, 
...
-- Code For temporary table tmp_20180508190437_codegen_6kem4x_ads_imp_1_out part 2. Populate

INSERT INTO tmp_20180508190437_codegen_6kem4x_ads_imp_1_out ("KEY", imputer_output_2, imputer_output_3, imputer_output_4, imputer_output_5) SELECT "U"."KEY", "U".imputer_output_2, "U".imputer_output_3, "U".imputer_output_4, "U".imputer_output_5 
...
-- Code For temporary table tmp_20180508190437_codegen_1mopig_ads_sca_2_out part 1. Create 


CREATE TEMPORARY TABLE tmp_20180508190437_codegen_1mopig_ads_sca_2_out (
	"KEY" BIGINT, 
...
-- Code For temporary table tmp_20180508190437_codegen_1mopig_ads_sca_2_out part 2. Populate

INSERT INTO tmp_20180508190437_codegen_1mopig_ads_sca_2_out ("KEY", scaler_output_2, scaler_output_3, scaler_output_4, scaler_output_5) SELECT "U"."KEY", "U".scaler_output_2, "U".scaler_output_3, "U".scaler_output_4, "U".scaler_output_5 
...
FROM tmp_20180508190437_codegen_6kem4x_ads_imp_1_out AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT") AS "U"

-- Code For temporary table tmp_20180508190437_codegen_1vhaf3_calprob_b0 part 1. Create 


CREATE TEMPORARY TABLE tmp_20180508190437_codegen_1vhaf3_calprob_b0 (
	"KEY" BIGINT, 
...
-- Code For temporary table tmp_20180508190437_codegen_1vhaf3_calprob_b0 part 2. Populate

INSERT INTO tmp_20180508190437_codegen_1vhaf3_calprob_b0 ("KEY", "Proba_CLASS_0", "Proba_CLASS_1", "Proba_CLASS_2") SELECT "U"."KEY", "U"."Proba_CLASS_0", "U"."Proba_CLASS_1", "U"."Proba_CLASS_2" 
...
FROM tmp_20180508190437_codegen_1mopig_ads_sca_2_out AS "ADS_sca_2_OUT"), 
"DT_node_data" AS 
...
-- Code For temporary table tmp_20180508190437_codegen_cs9f12_calprob_union part 1. Create 


CREATE TEMPORARY TABLE tmp_20180508190437_codegen_cs9f12_calprob_union (
	"KEY" BIGINT, 
	"Proba_CLASS_0" DOUBLE, 
	"Proba_CLASS_1" DOUBLE, 
	"Proba_CLASS_2" DOUBLE
...
-- Code For temporary table tmp_20180508190437_codegen_cs9f12_calprob_union part 2. Populate

INSERT INTO tmp_20180508190437_codegen_cs9f12_calprob_union ("KEY", "Proba_CLASS_0", "Proba_CLASS_1", "Proba_CLASS_2") SELECT "U"."KEY", "U"."Proba_CLASS_0", "U"."Proba_CLASS_1", "U"."Proba_CLASS_2" 
...
FROM tmp_20180508190437_codegen_1vhaf3_calprob_b0 AS "CalProb_B0") AS "CalProb_EnsembleUnion") AS "CalProb_Union") AS "U"

-- Code For temporary table tmp_20180508190437_codegen_pz81mn_calprob_avg part 1. Create 


CREATE TEMPORARY TABLE tmp_20180508190437_codegen_pz81mn_calprob_avg (
	"KEY" BIGINT, 
	"Proba_CLASS_0" DOUBLE, 
	"Proba_CLASS_1" DOUBLE, 
	"Proba_CLASS_2" DOUBLE
...
-- Code For temporary table tmp_20180508190437_codegen_pz81mn_calprob_avg part 2. Populate

INSERT INTO tmp_20180508190437_codegen_pz81mn_calprob_avg ("KEY", "Proba_CLASS_0", "Proba_CLASS_1", "Proba_CLASS_2") SELECT "U"."KEY", "U"."Proba_CLASS_0", "U"."Proba_CLASS_1", "U"."Proba_CLASS_2" 
...
FROM tmp_20180508190437_codegen_cs9f12_calprob_union AS "CalProb_Union" GROUP BY "CalProb_Union"."KEY") AS "T") AS "CalProb_avg") AS "U"
...
FROM tmp_20180508190437_codegen_pz81mn_calprob_avg AS "CalProb_avg"), 
