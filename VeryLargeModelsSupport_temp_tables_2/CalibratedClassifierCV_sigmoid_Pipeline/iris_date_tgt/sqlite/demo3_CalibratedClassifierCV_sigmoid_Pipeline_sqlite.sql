...
-- Code For temporary table TMP_20180508185952_CODEGEN_LQ3ZZ6_ADS_imp_1_OUT part 1. Create 


CREATE TEMPORARY TABLE "TMP_20180508185952_CODEGEN_LQ3ZZ6_ADS_imp_1_OUT" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20180508185952_CODEGEN_LQ3ZZ6_ADS_imp_1_OUT part 2. Populate

INSERT INTO "TMP_20180508185952_CODEGEN_LQ3ZZ6_ADS_imp_1_OUT" ("KEY", imputer_output_2, imputer_output_3, imputer_output_4, imputer_output_5) SELECT "ADS_imp_1_OUT"."KEY", "ADS_imp_1_OUT".imputer_output_2, "ADS_imp_1_OUT".imputer_output_3, "ADS_imp_1_OUT".imputer_output_4, "ADS_imp_1_OUT".imputer_output_5 
...
-- Code For temporary table TMP_20180508185952_CODEGEN_LQ3ZZ6_ADS_imp_1_OUT part 3. Create Index 

CREATE INDEX "ix_TMP_20180508185952_CODEGEN_LQ3ZZ6_ADS_imp_1_OUT_KEY" ON "TMP_20180508185952_CODEGEN_LQ3ZZ6_ADS_imp_1_OUT" ("KEY")

-- Code For temporary table TMP_20180508185952_CODEGEN_FFV1SL_ADS_sca_2_OUT part 1. Create 


CREATE TEMPORARY TABLE "TMP_20180508185952_CODEGEN_FFV1SL_ADS_sca_2_OUT" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20180508185952_CODEGEN_FFV1SL_ADS_sca_2_OUT part 2. Populate

INSERT INTO "TMP_20180508185952_CODEGEN_FFV1SL_ADS_sca_2_OUT" ("KEY", scaler_output_2, scaler_output_3, scaler_output_4, scaler_output_5) SELECT "ADS_sca_2_OUT"."KEY", "ADS_sca_2_OUT".scaler_output_2, "ADS_sca_2_OUT".scaler_output_3, "ADS_sca_2_OUT".scaler_output_4, "ADS_sca_2_OUT".scaler_output_5 
...
FROM "TMP_20180508185952_CODEGEN_LQ3ZZ6_ADS_imp_1_OUT" AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT"

-- Code For temporary table TMP_20180508185952_CODEGEN_FFV1SL_ADS_sca_2_OUT part 3. Create Index 

CREATE INDEX "ix_TMP_20180508185952_CODEGEN_FFV1SL_ADS_sca_2_OUT_KEY" ON "TMP_20180508185952_CODEGEN_FFV1SL_ADS_sca_2_OUT" ("KEY")

-- Code For temporary table TMP_20180508185952_CODEGEN_UO6ZL9_CalProb_B0 part 1. Create 


CREATE TEMPORARY TABLE "TMP_20180508185952_CODEGEN_UO6ZL9_CalProb_B0" (
	"KEY" BIGINT, 
...
-- Code For temporary table TMP_20180508185952_CODEGEN_UO6ZL9_CalProb_B0 part 2. Populate
...
FROM "TMP_20180508185952_CODEGEN_FFV1SL_ADS_sca_2_OUT" AS "ADS_sca_2_OUT"), 
"DT_node_data" AS 
...
(SELECT "Calibrated_Model_1"."KEY" AS "KEY", 1.0 / (1.0 + exp(min(max(-100.0, -(5.393626322122635 * "Calibrated_Model_1"."ScoreOrProba_1789-07-14T00:00:00.000000000" + -3.091045517303994)), 100.0))) AS "Proba_1789-07-14T00:00:00.000000000", 1.0 / (1.0 + exp(min(max(-100.0, -(5.442417342523719 * "Calibrated_Model_1"."ScoreOrProba_1789-08-14T00:00:00.000000000" + -3.0445224878196573)), 100.0))) AS "Proba_1789-08-14T00:00:00.000000000", 1.0 / (1.0 + exp(min(max(-100.0, -(5.480638259777759 * "Calibrated_Model_1"."ScoreOrProba_1789-09-14T00:00:00.000000000" + -2.995732594243071)), 100.0))) AS "Proba_1789-09-14T00:00:00.000000000" 
...
(SELECT "Calibrated_Model_2"."KEY" AS "KEY", 1.0 / (1.0 + exp(min(max(-100.0, -(5.393626322122635 * "Calibrated_Model_2"."ScoreOrProba_1789-07-14T00:00:00.000000000" + -3.091045517303994)), 100.0))) AS "Proba_1789-07-14T00:00:00.000000000", 1.0 / (1.0 + exp(min(max(-100.0, -(4.346958263204309 * "Calibrated_Model_2"."ScoreOrProba_1789-08-14T00:00:00.000000000" + -1.949062502016408)), 100.0))) AS "Proba_1789-08-14T00:00:00.000000000", 1.0 / (1.0 + exp(min(max(-100.0, -(4.310987825487246 * "Calibrated_Model_2"."ScoreOrProba_1789-09-14T00:00:00.000000000" + -2.995735836256492)), 100.0))) AS "Proba_1789-09-14T00:00:00.000000000" 
...
(SELECT "Calibrated_Model_3"."KEY" AS "KEY", 1.0 / (1.0 + exp(min(max(-100.0, -(5.3471066241328655 * "Calibrated_Model_3"."ScoreOrProba_1789-07-14T00:00:00.000000000" + -3.0445258104151054)), 100.0))) AS "Proba_1789-07-14T00:00:00.000000000", 1.0 / (1.0 + exp(min(max(-100.0, -(4.295450701778823 * "Calibrated_Model_3"."ScoreOrProba_1789-08-14T00:00:00.000000000" + -1.8975549276218453)), 100.0))) AS "Proba_1789-08-14T00:00:00.000000000", 1.0 / (1.0 + exp(min(max(-100.0, -(4.214379795150796 * "Calibrated_Model_3"."ScoreOrProba_1789-09-14T00:00:00.000000000" + -2.99573366824266)), 100.0))) AS "Proba_1789-09-14T00:00:00.000000000" 
...
-- Code For temporary table TMP_20180508185952_CODEGEN_1STCSH_CalProb_Union part 1. Create 


CREATE TEMPORARY TABLE "TMP_20180508185952_CODEGEN_1STCSH_CalProb_Union" (
	"KEY" BIGINT, 
	"Proba_1789-07-14T00:00:00.000000000" FLOAT, 
	"Proba_1789-08-14T00:00:00.000000000" FLOAT, 
	"Proba_1789-09-14T00:00:00.000000000" FLOAT
...
FROM "TMP_20180508185952_CODEGEN_UO6ZL9_CalProb_B0" AS "CalProb_B0") AS "CalProb_EnsembleUnion") AS "CalProb_Union"

-- Code For temporary table TMP_20180508185952_CODEGEN_37XVBS_CalProb_avg part 1. Create 


CREATE TEMPORARY TABLE "TMP_20180508185952_CODEGEN_37XVBS_CalProb_avg" (
	"KEY" BIGINT NOT NULL, 
	"Proba_1789-07-14T00:00:00.000000000" FLOAT, 
	"Proba_1789-08-14T00:00:00.000000000" FLOAT, 
	"Proba_1789-09-14T00:00:00.000000000" FLOAT, 
...
FROM "TMP_20180508185952_CODEGEN_1STCSH_CalProb_Union" AS "CalProb_Union" GROUP BY "CalProb_Union"."KEY") AS "T") AS "CalProb_avg"

-- Code For temporary table TMP_20180508185952_CODEGEN_37XVBS_CalProb_avg part 3. Create Index 

CREATE INDEX "ix_TMP_20180508185952_CODEGEN_37XVBS_CalProb_avg_KEY" ON "TMP_20180508185952_CODEGEN_37XVBS_CalProb_avg" ("KEY")
...
FROM "TMP_20180508185952_CODEGEN_37XVBS_CalProb_avg" AS "CalProb_avg"), 
