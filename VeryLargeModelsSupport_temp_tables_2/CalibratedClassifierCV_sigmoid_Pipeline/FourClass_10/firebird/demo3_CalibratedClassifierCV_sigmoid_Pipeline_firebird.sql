...
-- Code For temporary table TMP_20180508181125_CODEGEN_0ZS9 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508181125_CODEGEN_0ZS9" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20180508181125_CODEGEN_0ZS9 part 2. Populate

INSERT INTO "TMP_20180508181125_CODEGEN_0ZS9" ("KEY", impter_2, impter_3, impter_4, impter_5, impter_6, impter_7, impter_8, impter_9, impter_10, impter_11) SELECT "U"."KEY", "U".impter_2, "U".impter_3, "U".impter_4, "U".impter_5, "U".impter_6, "U".impter_7, "U".impter_8, "U".impter_9, "U".impter_10, "U".impter_11 
...
-- Code For temporary table TMP_20180508181125_CODEGEN_0ZS9 part 3. Create Index 

CREATE INDEX "ix_TMP_20180508181125_C_1332" ON "TMP_20180508181125_CODEGEN_0ZS9" ("KEY")

-- Code For temporary table TMP_20180508181125_CODEGEN_CV7W part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508181125_CODEGEN_CV7W" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20180508181125_CODEGEN_CV7W part 2. Populate

INSERT INTO "TMP_20180508181125_CODEGEN_CV7W" ("KEY", scaler_2, scaler_3, scaler_4, scaler_5, scaler_6, scaler_7, scaler_8, scaler_9, scaler_10, scaler_11) SELECT "U"."KEY", "U".scaler_2, "U".scaler_3, "U".scaler_4, "U".scaler_5, "U".scaler_6, "U".scaler_7, "U".scaler_8, "U".scaler_9, "U".scaler_10, "U".scaler_11 
...
FROM "TMP_20180508181125_CODEGEN_0ZS9" AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT") AS "U"

-- Code For temporary table TMP_20180508181125_CODEGEN_CV7W part 3. Create Index 

CREATE INDEX "ix_TMP_20180508181125_C_5ca4" ON "TMP_20180508181125_CODEGEN_CV7W" ("KEY")

-- Code For temporary table TMP_20180508181125_CODEGEN_DP33 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508181125_CODEGEN_DP33" (
	"KEY" BIGINT, 
...
-- Code For temporary table TMP_20180508181125_CODEGEN_DP33 part 2. Populate

INSERT INTO "TMP_20180508181125_CODEGEN_DP33" ("KEY", "Proba_0", "Proba_1", "Proba_2", "Proba_3") SELECT "U"."KEY", "U"."Proba_0", "U"."Proba_1", "U"."Proba_2", "U"."Proba_3" 
...
FROM "TMP_20180508181125_CODEGEN_CV7W" AS "ADS_sca_2_OUT"), 
"DT_node_data" AS 
...
FROM (SELECT 2 AS nid, 0.0 AS "P_0", 0.0 AS "P_1", 1.0 AS "P_2", 0.0 AS "P_3", 2 AS "D", 1.0 AS "DP" FROM rdb$database UNION ALL SELECT 5 AS nid, 0.0 AS "P_0", 0.0 AS "P_1", 0.0 AS "P_2", 1.0 AS "P_3", 3 AS "D", 1.0 AS "DP" FROM rdb$database UNION ALL SELECT 7 AS nid, 0.2 AS "P_0", 0.0 AS "P_1", 0.8 AS "P_2", 0.0 AS "P_3", 2 AS "D", 0.8 AS "DP" FROM rdb$database UNION ALL SELECT 8 AS nid, 0.0 AS "P_0", 0.0 AS "P_1", 0.0 AS "P_2", 1.0 AS "P_3", 3 AS "D", 1.0 AS "DP" FROM rdb$database UNION ALL SELECT 9 AS nid, 1.0 AS "P_0", 0.0 AS "P_1", 0.0 AS "P_2", 0.0 AS "P_3", 0 AS "D", 1.0 AS "DP" FROM rdb$database UNION ALL SELECT 12 AS nid, 0.0 AS "P_0", 1.0 AS "P_1", 0.0 AS "P_2", 0.0 AS "P_3", 1 AS "D", 1.0 AS "DP" FROM rdb$database UNION ALL SELECT 13 AS nid, 0.0 AS "P_0", 0.0 AS "P_1", 0.0 AS "P_2", 1.0 AS "P_3", 3 AS "D", 1.0 AS "DP" FROM rdb$database UNION ALL SELECT 16 AS nid, 1.0 AS "P_0", 0.0 AS "P_1", 0.0 AS "P_2", 0.0 AS "P_3", 0 AS "D", 1.0 AS "DP" FROM rdb$database UNION ALL SELECT 18 AS nid, 0.0 AS "P_0", 0.875 AS "P_1", 0.0 AS "P_2", 0.125 AS "P_3", 1 AS "D", 0.875 AS "DP" FROM rdb$database UNION ALL SELECT 19 AS nid, 0.0 AS "P_0", 0.0 AS "P_1", 1.0 AS "P_2", 0.0 AS "P_3", 2 AS "D", 1.0 AS "DP" FROM rdb$database UNION ALL SELECT 20 AS nid, 0.0 AS "P_0", 0.0 AS "P_1", 1.0 AS "P_2", 0.0 AS "P_3", 2 AS "D", 1.0 AS "DP" FROM rdb$database) AS "Values"), 
"DT_Output" AS 
...
(SELECT "Calibrated_Model_0"."KEY" AS "KEY", 1.0 / (1.0 + exp(CASE WHEN (minvalue(maxvalue(-100.0, -(2.614782213667346 * "Calibrated_Model_0"."ScoreOrProba_0" + -1.8541774485001863)), 100.0) >= -709.782712893384) THEN minvalue(maxvalue(-100.0, -(2.614782213667346 * "Calibrated_Model_0"."ScoreOrProba_0" + -1.8541774485001863)), 100.0) ELSE -709.782712893384 END)) AS "Proba_0", 1.0 / (1.0 + exp(CASE WHEN (minvalue(maxvalue(-100.0, -(1.6744918254963246 * "Calibrated_Model_0"."ScoreOrProba_1" + -1.6402291617335063)), 100.0) >= -709.782712893384) THEN minvalue(maxvalue(-100.0, -(1.6744918254963246 * "Calibrated_Model_0"."ScoreOrProba_1" + -1.6402291617335063)), 100.0) ELSE -709.782712893384 END)) AS "Proba_1", 1.0 / (1.0 + exp(CASE WHEN (minvalue(maxvalue(-100.0, -(1.612590274619459 * "Calibrated_Model_0"."ScoreOrProba_2" + -1.465775876667155)), 100.0) >= -709.782712893384) THEN minvalue(maxvalue(-100.0, -(1.612590274619459 * "Calibrated_Model_0"."ScoreOrProba_2" + -1.465775876667155)), 100.0) ELSE -709.782712893384 END)) AS "Proba_2", 1.0 / (1.0 + exp(CASE WHEN (minvalue(maxvalue(-100.0, -(2.675768697999654 * "Calibrated_Model_0"."ScoreOrProba_3" + -2.1312246712336864)), 100.0) >= -709.782712893384) THEN minvalue(maxvalue(-100.0, -(2.675768697999654 * "Calibrated_Model_0"."ScoreOrProba_3" + -2.1312246712336864)), 100.0) ELSE -709.782712893384 END)) AS "Proba_3" 
...
"DT_node_data_1" AS 
(SELECT "Values".nid AS nid, CAST("Values"."P_0" AS DOUBLE PRECISION) AS "P_0", CAST("Values"."P_1" AS DOUBLE PRECISION) AS "P_1", CAST("Values"."P_2" AS DOUBLE PRECISION) AS "P_2", CAST("Values"."P_3" AS DOUBLE PRECISION) AS "P_3", CAST("Values"."D" AS DOUBLE PRECISION) AS "D", CAST("Values"."DP" AS DOUBLE PRECISION) AS "DP" 
FROM (SELECT 3 AS nid, 0.0 AS "P_0", 0.0 AS "P_1", 0.0 AS "P_2", 1.0 AS "P_3", 3 AS "D", 1.0 AS "DP" FROM rdb$database UNION ALL SELECT 5 AS nid, 0.0 AS "P_0", 0.0 AS "P_1", 0.0 AS "P_2", 1.0 AS "P_3", 3 AS "D", 1.0 AS "DP" FROM rdb$database UNION ALL SELECT 7 AS nid, 0.0 AS "P_0", 0.0 AS "P_1", 1.0 AS "P_2", 0.0 AS "P_3", 2 AS "D", 1.0 AS "DP" FROM rdb$database UNION ALL SELECT 8 AS nid, 1.0 AS "P_0", 0.0 AS "P_1", 0.0 AS "P_2", 0.0 AS "P_3", 0 AS "D", 1.0 AS "DP" FROM rdb$database UNION ALL SELECT 10 AS nid, 0.0 AS "P_0", 0.0 AS "P_1", 1.0 AS "P_2", 0.0 AS "P_3", 2 AS "D", 1.0 AS "DP" FROM rdb$database UNION ALL SELECT 12 AS nid, 0.0 AS "P_0", 0.0 AS "P_1", 1.0 AS "P_2", 0.0 AS "P_3", 2 AS "D", 1.0 AS "DP" FROM rdb$database UNION ALL SELECT 13 AS nid, 1.0 AS "P_0", 0.0 AS "P_1", 0.0 AS "P_2", 0.0 AS "P_3", 0 AS "D", 1.0 AS "DP" FROM rdb$database UNION ALL SELECT 16 AS nid, 0.0 AS "P_0", 0.0 AS "P_1", 0.0 AS "P_2", 1.0 AS "P_3", 3 AS "D", 1.0 AS "DP" FROM rdb$database UNION ALL SELECT 18 AS nid, 0.0 AS "P_0", 1.0 AS "P_1", 0.0 AS "P_2", 0.0 AS "P_3", 1 AS "D", 1.0 AS "DP" FROM rdb$database UNION ALL SELECT 20 AS nid, 0.0 AS "P_0", 0.3333333333333333 AS "P_1", 0.0 AS "P_2", 0.6666666666666666 AS "P_3", 3 AS "D", 0.6666666666666666 AS "DP" FROM rdb$database UNION ALL SELECT 21 AS nid, 0.0 AS "P_0", 0.3333333333333333 AS "P_1", 0.6666666666666666 AS "P_2", 0.0 AS "P_3", 2 AS "D", 0.6666666666666666 AS "DP" FROM rdb$database UNION ALL SELECT 23 AS nid, 1.0 AS "P_0", 0.0 AS "P_1", 0.0 AS "P_2", 0.0 AS "P_3", 0 AS "D", 1.0 AS "DP" FROM rdb$database UNION ALL SELECT 26 AS nid, 0.0 AS "P_0", 1.0 AS "P_1", 0.0 AS "P_2", 0.0 AS "P_3", 1 AS "D", 1.0 AS "DP" FROM rdb$database UNION ALL SELECT 27 AS nid, 1.0 AS "P_0", 0.0 AS "P_1", 0.0 AS "P_2", 0.0 AS "P_3", 0 AS "D", 1.0 AS "DP" FROM rdb$database UNION ALL SELECT 28 AS nid, 0.0 AS "P_0", 1.0 AS "P_1", 0.0 AS "P_2", 0.0 AS "P_3", 1 AS "D", 1.0 AS "DP" FROM rdb$database) AS "Values"), 
"DT_Output_1" AS 
...
(SELECT "Calibrated_Model_1"."KEY" AS "KEY", 1.0 / (1.0 + exp(CASE WHEN (minvalue(maxvalue(-100.0, -(2.9681424816383735 * "Calibrated_Model_1"."ScoreOrProba_0" + -2.1359182242144628)), 100.0) >= -709.782712893384) THEN minvalue(maxvalue(-100.0, -(2.9681424816383735 * "Calibrated_Model_1"."ScoreOrProba_0" + -2.1359182242144628)), 100.0) ELSE -709.782712893384 END)) AS "Proba_0", 1.0 / (1.0 + exp(CASE WHEN (minvalue(maxvalue(-100.0, -(2.5189664651165287 * "Calibrated_Model_1"."ScoreOrProba_1" + -2.0741055120441403)), 100.0) >= -709.782712893384) THEN minvalue(maxvalue(-100.0, -(2.5189664651165287 * "Calibrated_Model_1"."ScoreOrProba_1" + -2.0741055120441403)), 100.0) ELSE -709.782712893384 END)) AS "Proba_1", 1.0 / (1.0 + exp(CASE WHEN (minvalue(maxvalue(-100.0, -(2.140876412096892 * "Calibrated_Model_1"."ScoreOrProba_2" + -2.040476353698952)), 100.0) >= -709.782712893384) THEN minvalue(maxvalue(-100.0, -(2.140876412096892 * "Calibrated_Model_1"."ScoreOrProba_2" + -2.040476353698952)), 100.0) ELSE -709.782712893384 END)) AS "Proba_2", 1.0 / (1.0 + exp(CASE WHEN (minvalue(maxvalue(-100.0, -(3.3646908708097913 * "Calibrated_Model_1"."ScoreOrProba_3" + -1.418780192015199)), 100.0) >= -709.782712893384) THEN minvalue(maxvalue(-100.0, -(3.3646908708097913 * "Calibrated_Model_1"."ScoreOrProba_3" + -1.418780192015199)), 100.0) ELSE -709.782712893384 END)) AS "Proba_3" 
...
"DT_node_data_2" AS 
(SELECT "Values".nid AS nid, CAST("Values"."P_0" AS DOUBLE PRECISION) AS "P_0", CAST("Values"."P_1" AS DOUBLE PRECISION) AS "P_1", CAST("Values"."P_2" AS DOUBLE PRECISION) AS "P_2", CAST("Values"."P_3" AS DOUBLE PRECISION) AS "P_3", CAST("Values"."D" AS DOUBLE PRECISION) AS "D", CAST("Values"."DP" AS DOUBLE PRECISION) AS "DP" 
FROM (SELECT 2 AS nid, 0.0 AS "P_0", 0.0 AS "P_1", 1.0 AS "P_2", 0.0 AS "P_3", 2 AS "D", 1.0 AS "DP" FROM rdb$database UNION ALL SELECT 5 AS nid, 0.0 AS "P_0", 0.0 AS "P_1", 0.0 AS "P_2", 1.0 AS "P_3", 3 AS "D", 1.0 AS "DP" FROM rdb$database UNION ALL SELECT 7 AS nid, 0.75 AS "P_0", 0.0 AS "P_1", 0.25 AS "P_2", 0.0 AS "P_3", 0 AS "D", 0.75 AS "DP" FROM rdb$database UNION ALL SELECT 8 AS nid, 0.0 AS "P_0", 0.0 AS "P_1", 1.0 AS "P_2", 0.0 AS "P_3", 2 AS "D", 1.0 AS "DP" FROM rdb$database UNION ALL SELECT 9 AS nid, 1.0 AS "P_0", 0.0 AS "P_1", 0.0 AS "P_2", 0.0 AS "P_3", 0 AS "D", 1.0 AS "DP" FROM rdb$database UNION ALL SELECT 12 AS nid, 0.0 AS "P_0", 1.0 AS "P_1", 0.0 AS "P_2", 0.0 AS "P_3", 1 AS "D", 1.0 AS "DP" FROM rdb$database UNION ALL SELECT 13 AS nid, 0.0 AS "P_0", 0.0 AS "P_1", 0.0 AS "P_2", 1.0 AS "P_3", 3 AS "D", 1.0 AS "DP" FROM rdb$database UNION ALL SELECT 17 AS nid, 1.0 AS "P_0", 0.0 AS "P_1", 0.0 AS "P_2", 0.0 AS "P_3", 0 AS "D", 1.0 AS "DP" FROM rdb$database UNION ALL SELECT 18 AS nid, 0.0 AS "P_0", 1.0 AS "P_1", 0.0 AS "P_2", 0.0 AS "P_3", 1 AS "D", 1.0 AS "DP" FROM rdb$database UNION ALL SELECT 20 AS nid, 0.0 AS "P_0", 0.0 AS "P_1", 1.0 AS "P_2", 0.0 AS "P_3", 2 AS "D", 1.0 AS "DP" FROM rdb$database UNION ALL SELECT 21 AS nid, 0.14285714285714285 AS "P_0", 0.5714285714285714 AS "P_1", 0.0 AS "P_2", 0.2857142857142857 AS "P_3", 1 AS "D", 0.5714285714285714 AS "DP" FROM rdb$database UNION ALL SELECT 22 AS nid, 0.0 AS "P_0", 0.0 AS "P_1", 0.0 AS "P_2", 1.0 AS "P_3", 3 AS "D", 1.0 AS "DP" FROM rdb$database) AS "Values"), 
"DT_Output_2" AS 
...
(SELECT "Calibrated_Model_2"."KEY" AS "KEY", 1.0 / (1.0 + exp(CASE WHEN (minvalue(maxvalue(-100.0, -(1.689332668076091 * "Calibrated_Model_2"."ScoreOrProba_0" + -1.9406293857491108)), 100.0) >= -709.782712893384) THEN minvalue(maxvalue(-100.0, -(1.689332668076091 * "Calibrated_Model_2"."ScoreOrProba_0" + -1.9406293857491108)), 100.0) ELSE -709.782712893384 END)) AS "Proba_0", 1.0 / (1.0 + exp(CASE WHEN (minvalue(maxvalue(-100.0, -(1.405628394347645 * "Calibrated_Model_2"."ScoreOrProba_1" + -1.3489731040569997)), 100.0) >= -709.782712893384) THEN minvalue(maxvalue(-100.0, -(1.405628394347645 * "Calibrated_Model_2"."ScoreOrProba_1" + -1.3489731040569997)), 100.0) ELSE -709.782712893384 END)) AS "Proba_1", 1.0 / (1.0 + exp(CASE WHEN (minvalue(maxvalue(-100.0, -(0.22478479435704893 * "Calibrated_Model_2"."ScoreOrProba_2" + -1.0263746591668546)), 100.0) >= -709.782712893384) THEN minvalue(maxvalue(-100.0, -(0.22478479435704893 * "Calibrated_Model_2"."ScoreOrProba_2" + -1.0263746591668546)), 100.0) ELSE -709.782712893384 END)) AS "Proba_2", 1.0 / (1.0 + exp(CASE WHEN (minvalue(maxvalue(-100.0, -(1.6386132666333737 * "Calibrated_Model_2"."ScoreOrProba_3" + -1.5671253094287134)), 100.0) >= -709.782712893384) THEN minvalue(maxvalue(-100.0, -(1.6386132666333737 * "Calibrated_Model_2"."ScoreOrProba_3" + -1.5671253094287134)), 100.0) ELSE -709.782712893384 END)) AS "Proba_3" 
...
"DT_node_data_3" AS 
(SELECT "Values".nid AS nid, CAST("Values"."P_0" AS DOUBLE PRECISION) AS "P_0", CAST("Values"."P_1" AS DOUBLE PRECISION) AS "P_1", CAST("Values"."P_2" AS DOUBLE PRECISION) AS "P_2", CAST("Values"."P_3" AS DOUBLE PRECISION) AS "P_3", CAST("Values"."D" AS DOUBLE PRECISION) AS "D", CAST("Values"."DP" AS DOUBLE PRECISION) AS "DP" 
FROM (SELECT 4 AS nid, 0.0 AS "P_0", 0.0 AS "P_1", 0.0 AS "P_2", 1.0 AS "P_3", 3 AS "D", 1.0 AS "DP" FROM rdb$database UNION ALL SELECT 5 AS nid, 0.0 AS "P_0", 0.0 AS "P_1", 1.0 AS "P_2", 0.0 AS "P_3", 2 AS "D", 1.0 AS "DP" FROM rdb$database UNION ALL SELECT 7 AS nid, 0.0 AS "P_0", 0.0 AS "P_1", 1.0 AS "P_2", 0.0 AS "P_3", 2 AS "D", 1.0 AS "DP" FROM rdb$database UNION ALL SELECT 8 AS nid, 1.0 AS "P_0", 0.0 AS "P_1", 0.0 AS "P_2", 0.0 AS "P_3", 0 AS "D", 1.0 AS "DP" FROM rdb$database UNION ALL SELECT 10 AS nid, 0.0 AS "P_0", 0.0 AS "P_1", 0.0 AS "P_2", 1.0 AS "P_3", 3 AS "D", 1.0 AS "DP" FROM rdb$database UNION ALL SELECT 12 AS nid, 0.0 AS "P_0", 1.0 AS "P_1", 0.0 AS "P_2", 0.0 AS "P_3", 1 AS "D", 1.0 AS "DP" FROM rdb$database UNION ALL SELECT 13 AS nid, 0.0 AS "P_0", 0.0 AS "P_1", 0.0 AS "P_2", 1.0 AS "P_3", 3 AS "D", 1.0 AS "DP" FROM rdb$database UNION ALL SELECT 16 AS nid, 0.0 AS "P_0", 0.0 AS "P_1", 1.0 AS "P_2", 0.0 AS "P_3", 2 AS "D", 1.0 AS "DP" FROM rdb$database UNION ALL SELECT 18 AS nid, 0.0 AS "P_0", 0.0 AS "P_1", 1.0 AS "P_2", 0.0 AS "P_3", 2 AS "D", 1.0 AS "DP" FROM rdb$database UNION ALL SELECT 19 AS nid, 1.0 AS "P_0", 0.0 AS "P_1", 0.0 AS "P_2", 0.0 AS "P_3", 0 AS "D", 1.0 AS "DP" FROM rdb$database UNION ALL SELECT 22 AS nid, 0.0 AS "P_0", 1.0 AS "P_1", 0.0 AS "P_2", 0.0 AS "P_3", 1 AS "D", 1.0 AS "DP" FROM rdb$database UNION ALL SELECT 23 AS nid, 0.0 AS "P_0", 0.0 AS "P_1", 1.0 AS "P_2", 0.0 AS "P_3", 2 AS "D", 1.0 AS "DP" FROM rdb$database UNION ALL SELECT 24 AS nid, 0.0 AS "P_0", 0.0 AS "P_1", 1.0 AS "P_2", 0.0 AS "P_3", 2 AS "D", 1.0 AS "DP" FROM rdb$database) AS "Values"), 
"DT_Output_3" AS 
...
(SELECT "Calibrated_Model_3"."KEY" AS "KEY", 1.0 / (1.0 + exp(CASE WHEN (minvalue(maxvalue(-100.0, -(1.7911314395473739 * "Calibrated_Model_3"."ScoreOrProba_0" + -2.0076580723287925)), 100.0) >= -709.782712893384) THEN minvalue(maxvalue(-100.0, -(1.7911314395473739 * "Calibrated_Model_3"."ScoreOrProba_0" + -2.0076580723287925)), 100.0) ELSE -709.782712893384 END)) AS "Proba_0", 1.0 / (1.0 + exp(CASE WHEN (minvalue(maxvalue(-100.0, -(1.3234114598263957 * "Calibrated_Model_3"."ScoreOrProba_1" + -1.484473012687775)), 100.0) >= -709.782712893384) THEN minvalue(maxvalue(-100.0, -(1.3234114598263957 * "Calibrated_Model_3"."ScoreOrProba_1" + -1.484473012687775)), 100.0) ELSE -709.782712893384 END)) AS "Proba_1", 1.0 / (1.0 + exp(CASE WHEN (minvalue(maxvalue(-100.0, -(1.6892598764470943 * "Calibrated_Model_3"."ScoreOrProba_2" + -1.315936557650469)), 100.0) >= -709.782712893384) THEN minvalue(maxvalue(-100.0, -(1.6892598764470943 * "Calibrated_Model_3"."ScoreOrProba_2" + -1.315936557650469)), 100.0) ELSE -709.782712893384 END)) AS "Proba_2", 1.0 / (1.0 + exp(CASE WHEN (minvalue(maxvalue(-100.0, -(2.253173046050721 * "Calibrated_Model_3"."ScoreOrProba_3" + -1.596635300071773)), 100.0) >= -709.782712893384) THEN minvalue(maxvalue(-100.0, -(2.253173046050721 * "Calibrated_Model_3"."ScoreOrProba_3" + -1.596635300071773)), 100.0) ELSE -709.782712893384 END)) AS "Proba_3" 
...
-- Code For temporary table TMP_20180508181125_CODEGEN_B2O1 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508181125_CODEGEN_B2O1" (
	"KEY" BIGINT, 
	"Proba_0" DOUBLE PRECISION, 
	"Proba_1" DOUBLE PRECISION, 
	"Proba_2" DOUBLE PRECISION, 
...
-- Code For temporary table TMP_20180508181125_CODEGEN_B2O1 part 2. Populate

INSERT INTO "TMP_20180508181125_CODEGEN_B2O1" ("KEY", "Proba_0", "Proba_1", "Proba_2", "Proba_3") SELECT "U"."KEY", "U"."Proba_0", "U"."Proba_1", "U"."Proba_2", "U"."Proba_3" 
...
FROM "TMP_20180508181125_CODEGEN_DP33" AS "CalProb_B0") AS "CalProb_EnsembleUnion") AS "CalProb_Union") AS "U"

-- Code For temporary table TMP_20180508181125_CODEGEN_5H7D part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508181125_CODEGEN_5H7D" (
	"KEY" BIGINT NOT NULL, 
	"Proba_0" DOUBLE PRECISION, 
	"Proba_1" DOUBLE PRECISION, 
	"Proba_2" DOUBLE PRECISION, 
...
-- Code For temporary table TMP_20180508181125_CODEGEN_5H7D part 2. Populate

INSERT INTO "TMP_20180508181125_CODEGEN_5H7D" ("KEY", "Proba_0", "Proba_1", "Proba_2", "Proba_3") SELECT "U"."KEY", "U"."Proba_0", "U"."Proba_1", "U"."Proba_2", "U"."Proba_3" 
...
FROM "TMP_20180508181125_CODEGEN_B2O1" AS "CalProb_Union" GROUP BY "CalProb_Union"."KEY") AS "T") AS "CalProb_avg") AS "U"

-- Code For temporary table TMP_20180508181125_CODEGEN_5H7D part 3. Create Index 

CREATE INDEX "ix_TMP_20180508181125_C_dfe6" ON "TMP_20180508181125_CODEGEN_5H7D" ("KEY")
...
FROM "TMP_20180508181125_CODEGEN_5H7D" AS "CalProb_avg"), 
