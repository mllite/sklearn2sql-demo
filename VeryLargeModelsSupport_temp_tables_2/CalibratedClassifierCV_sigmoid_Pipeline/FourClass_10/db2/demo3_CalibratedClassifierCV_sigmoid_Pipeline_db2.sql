...
-- Code For temporary table tmp_20180508181127_codegen_8at0it_ads_imp_1_out part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180508181127_codegen_8at0it_ads_imp_1_out (
	"KEY" BIGINT, 
	impter_2 DOUBLE, 
	impter_3 DOUBLE, 
	impter_4 DOUBLE, 
...
-- Code For temporary table tmp_20180508181127_codegen_8at0it_ads_imp_1_out part 2. Populate

INSERT INTO tmp_20180508181127_codegen_8at0it_ads_imp_1_out SELECT "ADS_imp_1_OUT"."KEY", "ADS_imp_1_OUT".impter_2, "ADS_imp_1_OUT".impter_3, "ADS_imp_1_OUT".impter_4, "ADS_imp_1_OUT".impter_5, "ADS_imp_1_OUT".impter_6, "ADS_imp_1_OUT".impter_7, "ADS_imp_1_OUT".impter_8, "ADS_imp_1_OUT".impter_9, "ADS_imp_1_OUT".impter_10, "ADS_imp_1_OUT".impter_11 
...
-- Code For temporary table tmp_20180508181127_codegen_6zko21_ads_sca_2_out part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180508181127_codegen_6zko21_ads_sca_2_out (
	"KEY" BIGINT, 
	scaler_2 DOUBLE, 
	scaler_3 DOUBLE, 
	scaler_4 DOUBLE, 
...
-- Code For temporary table tmp_20180508181127_codegen_6zko21_ads_sca_2_out part 2. Populate

INSERT INTO tmp_20180508181127_codegen_6zko21_ads_sca_2_out SELECT "ADS_sca_2_OUT"."KEY", "ADS_sca_2_OUT".scaler_2, "ADS_sca_2_OUT".scaler_3, "ADS_sca_2_OUT".scaler_4, "ADS_sca_2_OUT".scaler_5, "ADS_sca_2_OUT".scaler_6, "ADS_sca_2_OUT".scaler_7, "ADS_sca_2_OUT".scaler_8, "ADS_sca_2_OUT".scaler_9, "ADS_sca_2_OUT".scaler_10, "ADS_sca_2_OUT".scaler_11 
...
FROM tmp_20180508181127_codegen_8at0it_ads_imp_1_out AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT"

-- Code For temporary table tmp_20180508181127_codegen_jyer9f_calprob_b0 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180508181127_codegen_jyer9f_calprob_b0 (
	"KEY" BIGINT, 
	"Proba_0" DOUBLE, 
	"Proba_1" DOUBLE, 
	"Proba_2" DOUBLE, 
...
-- Code For temporary table tmp_20180508181127_codegen_jyer9f_calprob_b0 part 2. Populate

INSERT INTO tmp_20180508181127_codegen_jyer9f_calprob_b0 WITH "DT_node_lookup" AS 
...
FROM tmp_20180508181127_codegen_6zko21_ads_sca_2_out AS "ADS_sca_2_OUT"), 
"DT_node_data" AS 
...
-- Code For temporary table tmp_20180508181127_codegen_ed9mua_calprob_union part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180508181127_codegen_ed9mua_calprob_union (
	"KEY" BIGINT, 
	"Proba_0" DOUBLE, 
	"Proba_1" DOUBLE, 
	"Proba_2" DOUBLE, 
...
-- Code For temporary table tmp_20180508181127_codegen_ed9mua_calprob_union part 2. Populate

INSERT INTO tmp_20180508181127_codegen_ed9mua_calprob_union SELECT "CalProb_Union"."KEY", "CalProb_Union"."Proba_0", "CalProb_Union"."Proba_1", "CalProb_Union"."Proba_2", "CalProb_Union"."Proba_3" 
...
FROM tmp_20180508181127_codegen_jyer9f_calprob_b0 AS "CalProb_B0") AS "CalProb_EnsembleUnion") AS "CalProb_Union"

-- Code For temporary table tmp_20180508181127_codegen_bl4bw9_calprob_avg part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180508181127_codegen_bl4bw9_calprob_avg (
	"KEY" BIGINT, 
	"Proba_0" DOUBLE, 
	"Proba_1" DOUBLE, 
	"Proba_2" DOUBLE, 
...
-- Code For temporary table tmp_20180508181127_codegen_bl4bw9_calprob_avg part 2. Populate

INSERT INTO tmp_20180508181127_codegen_bl4bw9_calprob_avg SELECT "CalProb_avg"."KEY", "CalProb_avg"."Proba_0", "CalProb_avg"."Proba_1", "CalProb_avg"."Proba_2", "CalProb_avg"."Proba_3" 
...
FROM tmp_20180508181127_codegen_ed9mua_calprob_union AS "CalProb_Union" GROUP BY "CalProb_Union"."KEY") AS "T") AS "CalProb_avg"
...
FROM tmp_20180508181127_codegen_bl4bw9_calprob_avg AS "CalProb_avg"), 
