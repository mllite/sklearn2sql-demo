...
-- Code For temporary table tmp_20180509002211_codegen_w69chn_ads_imp_1_out part 2. Populate

SELECT * FROM `tmp_20180509002211_codegen_w69chn_ads_imp_1_out`

-- Code For temporary table tmp_20180509002211_codegen_kdjbmy_ads_sca_2_out part 1. Create 

CREATE TEMPORARY TABLE `tmp_20180509002211_codegen_kdjbmy_ads_sca_2_out` STORED AS ORC AS SELECT `ADS_sca_2_OUT`.`KEY`, `ADS_sca_2_OUT`.`scaler_2`, `ADS_sca_2_OUT`.`scaler_3`, `ADS_sca_2_OUT`.`scaler_4`, `ADS_sca_2_OUT`.`scaler_5`, `ADS_sca_2_OUT`.`scaler_6`, `ADS_sca_2_OUT`.`scaler_7`, `ADS_sca_2_OUT`.`scaler_8`, `ADS_sca_2_OUT`.`scaler_9`, `ADS_sca_2_OUT`.`scaler_10`, `ADS_sca_2_OUT`.`scaler_11`, `ADS_sca_2_OUT`.`scaler_12`, `ADS_sca_2_OUT`.`scaler_13`, `ADS_sca_2_OUT`.`scaler_14`, `ADS_sca_2_OUT`.`scaler_15`, `ADS_sca_2_OUT`.`scaler_16`, `ADS_sca_2_OUT`.`scaler_17`, `ADS_sca_2_OUT`.`scaler_18`, `ADS_sca_2_OUT`.`scaler_19`, `ADS_sca_2_OUT`.`scaler_20`, `ADS_sca_2_OUT`.`scaler_21`, `ADS_sca_2_OUT`.`scaler_22`, `ADS_sca_2_OUT`.`scaler_23`, `ADS_sca_2_OUT`.`scaler_24`, `ADS_sca_2_OUT`.`scaler_25`, `ADS_sca_2_OUT`.`scaler_26`, `ADS_sca_2_OUT`.`scaler_27`, `ADS_sca_2_OUT`.`scaler_28`, `ADS_sca_2_OUT`.`scaler_29`, `ADS_sca_2_OUT`.`scaler_30`, `ADS_sca_2_OUT`.`scaler_31` 
...
FROM `tmp_20180509002211_codegen_w69chn_ads_imp_1_out` AS `ADS_imp_1_OUT`) AS `ADS_sca_2_OUT`

-- Code For temporary table tmp_20180509002211_codegen_kdjbmy_ads_sca_2_out part 2. Populate

SELECT * FROM `tmp_20180509002211_codegen_kdjbmy_ads_sca_2_out`

-- Code For temporary table tmp_20180509002211_codegen_2gw5nm_calprob_b0 part 1. Create 

CREATE TEMPORARY TABLE `tmp_20180509002211_codegen_2gw5nm_calprob_b0` STORED AS ORC AS WITH `DT_node_lookup` AS 
...
FROM `tmp_20180509002211_codegen_kdjbmy_ads_sca_2_out` AS `ADS_sca_2_OUT`), 
`DT_node_data` AS 
...
(SELECT `Calibrated_Model_0`.`KEY` AS `KEY`, 1.0 / (1.0 + exp(-(5.756413424714996 * `Calibrated_Model_0`.`ScoreOrProba_1` + -2.5569469411985817))) AS `Proba_1`, 1.0 - 1.0 / (1.0 + exp(-(5.756413424714996 * `Calibrated_Model_0`.`ScoreOrProba_1` + -2.5569469411985817))) AS `Proba_0` 
...
(SELECT `Calibrated_Model_1`.`KEY` AS `KEY`, 1.0 / (1.0 + exp(-(4.6995923736239025 * `Calibrated_Model_1`.`ScoreOrProba_1` + -1.924211076199023))) AS `Proba_1`, 1.0 - 1.0 / (1.0 + exp(-(4.6995923736239025 * `Calibrated_Model_1`.`ScoreOrProba_1` + -1.924211076199023))) AS `Proba_0` 
...
(SELECT `Calibrated_Model_2`.`KEY` AS `KEY`, 1.0 / (1.0 + exp(-(5.460676238424658 * `Calibrated_Model_2`.`ScoreOrProba_1` + -2.260905500780578))) AS `Proba_1`, 1.0 - 1.0 / (1.0 + exp(-(5.460676238424658 * `Calibrated_Model_2`.`ScoreOrProba_1` + -2.260905500780578))) AS `Proba_0` 
...
(SELECT `Calibrated_Model_3`.`KEY` AS `KEY`, 1.0 / (1.0 + exp(-(4.949259195511301 * `Calibrated_Model_3`.`ScoreOrProba_1` + -2.0321952231560854))) AS `Proba_1`, 1.0 - 1.0 / (1.0 + exp(-(4.949259195511301 * `Calibrated_Model_3`.`ScoreOrProba_1` + -2.0321952231560854))) AS `Proba_0` 
...
-- Code For temporary table tmp_20180509002211_codegen_2gw5nm_calprob_b0 part 2. Populate

SELECT * FROM `tmp_20180509002211_codegen_2gw5nm_calprob_b0`

-- Code For temporary table tmp_20180509002211_codegen_txiztt_calprob_union part 1. Create 

CREATE TEMPORARY TABLE `tmp_20180509002211_codegen_txiztt_calprob_union` STORED AS ORC AS SELECT `CalProb_Union`.`KEY`, `CalProb_Union`.`Proba_1`, `CalProb_Union`.`Proba_0` 
...
FROM `tmp_20180509002211_codegen_2gw5nm_calprob_b0` AS `CalProb_B0`) AS `CalProb_EnsembleUnion`) AS `CalProb_Union`

-- Code For temporary table tmp_20180509002211_codegen_txiztt_calprob_union part 2. Populate

SELECT * FROM `tmp_20180509002211_codegen_txiztt_calprob_union`

-- Code For temporary table tmp_20180509002211_codegen_sy5sjv_calprob_avg part 1. Create 

CREATE TEMPORARY TABLE `tmp_20180509002211_codegen_sy5sjv_calprob_avg` STORED AS ORC AS SELECT `CalProb_avg`.`KEY`, `CalProb_avg`.`Proba_1`, `CalProb_avg`.`Proba_0` 
...
FROM `tmp_20180509002211_codegen_txiztt_calprob_union` AS `CalProb_Union` GROUP BY `CalProb_Union`.`KEY`) AS `T`) AS `CalProb_avg`

-- Code For temporary table tmp_20180509002211_codegen_sy5sjv_calprob_avg part 2. Populate

SELECT * FROM `tmp_20180509002211_codegen_sy5sjv_calprob_avg`
...
FROM `tmp_20180509002211_codegen_sy5sjv_calprob_avg` AS `CalProb_avg`), 
