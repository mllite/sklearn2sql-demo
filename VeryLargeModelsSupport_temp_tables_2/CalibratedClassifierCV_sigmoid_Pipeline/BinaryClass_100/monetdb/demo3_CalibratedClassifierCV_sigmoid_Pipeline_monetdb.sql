...
-- Code For temporary table tmp_20180508180152_codegen_9j0np9_ads_imp_1_out part 1. Create 


CREATE TEMPORARY TABLE tmp_20180508180152_codegen_9j0np9_ads_imp_1_out (
	"KEY" BIGINT, 
	impter_2 DOUBLE, 
	impter_3 DOUBLE, 
	impter_4 DOUBLE, 
...
-- Code For temporary table tmp_20180508180152_codegen_2atf1n_ads_sca_2_out part 1. Create 


CREATE TEMPORARY TABLE tmp_20180508180152_codegen_2atf1n_ads_sca_2_out (
	"KEY" BIGINT, 
	scaler_2 DOUBLE, 
	scaler_3 DOUBLE, 
	scaler_4 DOUBLE, 
...
FROM tmp_20180508180152_codegen_9j0np9_ads_imp_1_out AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT") AS "U"

-- Code For temporary table tmp_20180508180152_codegen_wxs0k1_calprob_b0 part 1. Create 


CREATE TEMPORARY TABLE tmp_20180508180152_codegen_wxs0k1_calprob_b0 (
	"KEY" BIGINT, 
	"Proba_1" DOUBLE, 
	"Proba_0" DOUBLE
)
...
-- Code For temporary table tmp_20180508180152_codegen_wxs0k1_calprob_b0 part 2. Populate

INSERT INTO tmp_20180508180152_codegen_wxs0k1_calprob_b0 ("KEY", "Proba_1", "Proba_0") SELECT "U"."KEY", "U"."Proba_1", "U"."Proba_0" 
...
FROM tmp_20180508180152_codegen_2atf1n_ads_sca_2_out AS "ADS_sca_2_OUT"), 
"DT_node_data" AS 
...
-- Code For temporary table tmp_20180508180152_codegen_w06zoc_calprob_union part 1. Create 


CREATE TEMPORARY TABLE tmp_20180508180152_codegen_w06zoc_calprob_union (
	"KEY" BIGINT, 
	"Proba_1" DOUBLE, 
	"Proba_0" DOUBLE
)
...
-- Code For temporary table tmp_20180508180152_codegen_w06zoc_calprob_union part 2. Populate

INSERT INTO tmp_20180508180152_codegen_w06zoc_calprob_union ("KEY", "Proba_1", "Proba_0") SELECT "U"."KEY", "U"."Proba_1", "U"."Proba_0" 
...
FROM tmp_20180508180152_codegen_wxs0k1_calprob_b0 AS "CalProb_B0") AS "CalProb_EnsembleUnion") AS "CalProb_Union") AS "U"

-- Code For temporary table tmp_20180508180152_codegen_ukilgq_calprob_avg part 1. Create 


CREATE TEMPORARY TABLE tmp_20180508180152_codegen_ukilgq_calprob_avg (
	"KEY" BIGINT, 
	"Proba_1" DOUBLE, 
	"Proba_0" DOUBLE
)
...
-- Code For temporary table tmp_20180508180152_codegen_ukilgq_calprob_avg part 2. Populate

INSERT INTO tmp_20180508180152_codegen_ukilgq_calprob_avg ("KEY", "Proba_1", "Proba_0") SELECT "U"."KEY", "U"."Proba_1", "U"."Proba_0" 
...
FROM tmp_20180508180152_codegen_w06zoc_calprob_union AS "CalProb_Union" GROUP BY "CalProb_Union"."KEY") AS "T") AS "CalProb_avg") AS "U"
...
FROM tmp_20180508180152_codegen_ukilgq_calprob_avg AS "CalProb_avg"), 
