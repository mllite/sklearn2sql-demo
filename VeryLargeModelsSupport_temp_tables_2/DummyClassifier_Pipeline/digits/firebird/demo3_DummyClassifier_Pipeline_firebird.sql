...
-- Code For temporary table TMP_20180508183821_CODEGEN_5H77 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508183821_CODEGEN_5H77" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20180508183821_CODEGEN_5H77 part 3. Create Index 

CREATE INDEX "ix_TMP_20180508183821_C_eaf1" ON "TMP_20180508183821_CODEGEN_5H77" ("KEY")

-- Code For temporary table TMP_20180508183821_CODEGEN_MFIA part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508183821_CODEGEN_MFIA" (
	"KEY" BIGINT NOT NULL, 
...
FROM "TMP_20180508183821_CODEGEN_5H77" AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT") AS "U"

-- Code For temporary table TMP_20180508183821_CODEGEN_MFIA part 3. Create Index 

CREATE INDEX "ix_TMP_20180508183821_C_5c57" ON "TMP_20180508183821_CODEGEN_MFIA" ("KEY")

-- Model deployment code

WITH random_number_cte AS 
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", rand AS uniform 
FROM "TMP_20180508183821_CODEGEN_MFIA" AS "ADS_sca_2_OUT"), 
multinomial_cte AS 
...
(SELECT multinomial_cte."KEY" AS "KEY", 0.09603340292275574 AS "Proba_0", CASE WHEN (0.09603340292275574 IS NULL OR 0.09603340292275574 > 0.0) THEN ln(0.09603340292275574) ELSE -1e+20 END AS "LogProba_0", 0.1022964509394572 AS "Proba_1", CASE WHEN (0.1022964509394572 IS NULL OR 0.1022964509394572 > 0.0) THEN ln(0.1022964509394572) ELSE -1e+20 END AS "LogProba_1", 0.10299234516353514 AS "Proba_2", CASE WHEN (0.10299234516353514 IS NULL OR 0.10299234516353514 > 0.0) THEN ln(0.10299234516353514) ELSE -1e+20 END AS "LogProba_2", 0.10090466249130133 AS "Proba_3", CASE WHEN (0.10090466249130133 IS NULL OR 0.10090466249130133 > 0.0) THEN ln(0.10090466249130133) ELSE -1e+20 END AS "LogProba_3", 0.10508002783576896 AS "Proba_4", CASE WHEN (0.10508002783576896 IS NULL OR 0.10508002783576896 > 0.0) THEN ln(0.10508002783576896) ELSE -1e+20 END AS "LogProba_4", 0.10020876826722339 AS "Proba_5", CASE WHEN (0.10020876826722339 IS NULL OR 0.10020876826722339 > 0.0) THEN ln(0.10020876826722339) ELSE -1e+20 END AS "LogProba_5", 0.09881697981906751 AS "Proba_6", CASE WHEN (0.09881697981906751 IS NULL OR 0.09881697981906751 > 0.0) THEN ln(0.09881697981906751) ELSE -1e+20 END AS "LogProba_6", 0.09742519137091162 AS "Proba_7", CASE WHEN (0.09742519137091162 IS NULL OR 0.09742519137091162 > 0.0) THEN ln(0.09742519137091162) ELSE -1e+20 END AS "LogProba_7", 0.09394572025052192 AS "Proba_8", CASE WHEN (0.09394572025052192 IS NULL OR 0.09394572025052192 > 0.0) THEN ln(0.09394572025052192) ELSE -1e+20 END AS "LogProba_8", 0.1022964509394572 AS "Proba_9", CASE WHEN (0.1022964509394572 IS NULL OR 0.1022964509394572 > 0.0) THEN ln(0.1022964509394572) ELSE -1e+20 END AS "LogProba_9", multinomial_cte.multinomial_expr AS "Decision" 
FROM multinomial_cte)
 SELECT dummy_class_reg_cte."KEY" AS "KEY", CAST(NULL AS DOUBLE PRECISION) AS "Score_0", CAST(NULL AS DOUBLE PRECISION) AS "Score_1", CAST(NULL AS DOUBLE PRECISION) AS "Score_2", CAST(NULL AS DOUBLE PRECISION) AS "Score_3", CAST(NULL AS DOUBLE PRECISION) AS "Score_4", CAST(NULL AS DOUBLE PRECISION) AS "Score_5", CAST(NULL AS DOUBLE PRECISION) AS "Score_6", CAST(NULL AS DOUBLE PRECISION) AS "Score_7", CAST(NULL AS DOUBLE PRECISION) AS "Score_8", CAST(NULL AS DOUBLE PRECISION) AS "Score_9", dummy_class_reg_cte."Proba_0" AS "Proba_0", dummy_class_reg_cte."Proba_1" AS "Proba_1", dummy_class_reg_cte."Proba_2" AS "Proba_2", dummy_class_reg_cte."Proba_3" AS "Proba_3", dummy_class_reg_cte."Proba_4" AS "Proba_4", dummy_class_reg_cte."Proba_5" AS "Proba_5", dummy_class_reg_cte."Proba_6" AS "Proba_6", dummy_class_reg_cte."Proba_7" AS "Proba_7", dummy_class_reg_cte."Proba_8" AS "Proba_8", dummy_class_reg_cte."Proba_9" AS "Proba_9", dummy_class_reg_cte."LogProba_0" AS "LogProba_0", dummy_class_reg_cte."LogProba_1" AS "LogProba_1", dummy_class_reg_cte."LogProba_2" AS "LogProba_2", dummy_class_reg_cte."LogProba_3" AS "LogProba_3", dummy_class_reg_cte."LogProba_4" AS "LogProba_4", dummy_class_reg_cte."LogProba_5" AS "LogProba_5", dummy_class_reg_cte."LogProba_6" AS "LogProba_6", dummy_class_reg_cte."LogProba_7" AS "LogProba_7", dummy_class_reg_cte."LogProba_8" AS "LogProba_8", dummy_class_reg_cte."LogProba_9" AS "LogProba_9", CAST(NULL AS BIGINT) AS "Decision", CAST(NULL AS DOUBLE PRECISION) AS "DecisionProba" 
