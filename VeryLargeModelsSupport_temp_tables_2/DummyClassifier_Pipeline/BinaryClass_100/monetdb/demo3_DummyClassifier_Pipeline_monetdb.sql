...
-- Code For temporary table tmp_20180508180247_codegen_gdnat6_ads_imp_1_out part 1. Create 


CREATE TEMPORARY TABLE tmp_20180508180247_codegen_gdnat6_ads_imp_1_out (
	"KEY" BIGINT, 
	impter_2 DOUBLE, 
	impter_3 DOUBLE, 
	impter_4 DOUBLE, 
...
-- Code For temporary table tmp_20180508180247_codegen_wymci8_ads_sca_2_out part 1. Create 


CREATE TEMPORARY TABLE tmp_20180508180247_codegen_wymci8_ads_sca_2_out (
	"KEY" BIGINT, 
	scaler_2 DOUBLE, 
	scaler_3 DOUBLE, 
	scaler_4 DOUBLE, 
...
FROM tmp_20180508180247_codegen_gdnat6_ads_imp_1_out AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT") AS "U"

-- Model deployment code

WITH random_number_cte AS 
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", rand() AS uniform 
FROM tmp_20180508180247_codegen_wymci8_ads_sca_2_out AS "ADS_sca_2_OUT"), 
multinomial_cte AS 
...
(SELECT multinomial_cte."KEY" AS "KEY", 0.525 AS "Proba_0", log(CASE WHEN (0.525 IS NULL OR 0.525 > 1e-100) THEN 0.525 ELSE 1e-100 END) AS "LogProba_0", 0.475 AS "Proba_1", log(CASE WHEN (0.475 IS NULL OR 0.475 > 1e-100) THEN 0.475 ELSE 1e-100 END) AS "LogProba_1", multinomial_cte.multinomial_expr AS "Decision" 
