...
-- Code For temporary table TMP_20180508181710_CODEGEN_WFIL part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508181710_CODEGEN_WFIL" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20180508181710_CODEGEN_WFIL part 3. Create Index 

CREATE INDEX "ix_TMP_20180508181710_C_b0a1" ON "TMP_20180508181710_CODEGEN_WFIL" ("KEY")

-- Code For temporary table TMP_20180508181710_CODEGEN_BVKY part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508181710_CODEGEN_BVKY" (
	"KEY" BIGINT NOT NULL, 
...
FROM "TMP_20180508181710_CODEGEN_WFIL" AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT") AS "U"

-- Code For temporary table TMP_20180508181710_CODEGEN_BVKY part 3. Create Index 

CREATE INDEX "ix_TMP_20180508181710_C_f60f" ON "TMP_20180508181710_CODEGEN_BVKY" ("KEY")

-- Model deployment code

WITH random_number_cte AS 
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", rand AS uniform 
FROM "TMP_20180508181710_CODEGEN_BVKY" AS "ADS_sca_2_OUT"), 
multinomial_cte AS 
...
(SELECT multinomial_cte."KEY" AS "KEY", 0.25 AS "Proba_0", CASE WHEN (0.25 IS NULL OR 0.25 > 0.0) THEN ln(0.25) ELSE -1e+20 END AS "LogProba_0", 0.2604166666666667 AS "Proba_1", CASE WHEN (0.2604166666666667 IS NULL OR 0.2604166666666667 > 0.0) THEN ln(0.2604166666666667) ELSE -1e+20 END AS "LogProba_1", 0.23958333333333334 AS "Proba_2", CASE WHEN (0.23958333333333334 IS NULL OR 0.23958333333333334 > 0.0) THEN ln(0.23958333333333334) ELSE -1e+20 END AS "LogProba_2", 0.25 AS "Proba_3", CASE WHEN (0.25 IS NULL OR 0.25 > 0.0) THEN ln(0.25) ELSE -1e+20 END AS "LogProba_3", multinomial_cte.multinomial_expr AS "Decision" 
