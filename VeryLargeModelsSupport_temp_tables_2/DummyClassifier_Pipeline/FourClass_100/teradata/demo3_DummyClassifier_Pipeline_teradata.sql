...
-- Code For temporary table tmp_20180508181710_codegen_mihrbu_ads_imp_1_out part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180508181710_codegen_mihrbu_ads_imp_1_out  (
	"KEY" BIGINT, 
...
-- Code For temporary table tmp_20180508181710_codegen_nmpdd1_ads_sca_2_out part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180508181710_codegen_nmpdd1_ads_sca_2_out  (
	"KEY" BIGINT, 
...
FROM tmp_20180508181710_codegen_mihrbu_ads_imp_1_out AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT") AS "U"

-- Model deployment code

WITH random_number_cte AS 
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", random() AS uniform 
FROM tmp_20180508181710_codegen_nmpdd1_ads_sca_2_out AS "ADS_sca_2_OUT"), 
multinomial_cte AS 
(SELECT random_number_cte."KEY" AS "KEY", CASE WHEN (random_number_cte.uniform <= CAST(0.25 AS DOUBLE PRECISION)) THEN 0 ELSE CASE WHEN (random_number_cte.uniform <= CAST(0.510416666666667 AS DOUBLE PRECISION)) THEN 1 ELSE CASE WHEN (random_number_cte.uniform <= CAST(0.75 AS DOUBLE PRECISION)) THEN 2 ELSE CASE WHEN (random_number_cte.uniform <= CAST(1.0 AS DOUBLE PRECISION)) THEN 3 END END END END AS multinomial_expr 
FROM random_number_cte), 
dummy_class_reg_cte AS 
(SELECT multinomial_cte."KEY" AS "KEY", CAST(0.25 AS DOUBLE PRECISION) AS "Proba_0", CASE WHEN (CAST(0.25 AS DOUBLE PRECISION) IS NULL OR CAST(0.25 AS DOUBLE PRECISION) > CAST(0.0 AS DOUBLE PRECISION)) THEN ln(CAST(0.25 AS DOUBLE PRECISION)) ELSE -1.79769313486231e+308 END AS "LogProba_0", CAST(0.260416666666667 AS DOUBLE PRECISION) AS "Proba_1", CASE WHEN (CAST(0.260416666666667 AS DOUBLE PRECISION) IS NULL OR CAST(0.260416666666667 AS DOUBLE PRECISION) > CAST(0.0 AS DOUBLE PRECISION)) THEN ln(CAST(0.260416666666667 AS DOUBLE PRECISION)) ELSE -1.79769313486231e+308 END AS "LogProba_1", CAST(0.239583333333333 AS DOUBLE PRECISION) AS "Proba_2", CASE WHEN (CAST(0.239583333333333 AS DOUBLE PRECISION) IS NULL OR CAST(0.239583333333333 AS DOUBLE PRECISION) > CAST(0.0 AS DOUBLE PRECISION)) THEN ln(CAST(0.239583333333333 AS DOUBLE PRECISION)) ELSE -1.79769313486231e+308 END AS "LogProba_2", CAST(0.25 AS DOUBLE PRECISION) AS "Proba_3", CASE WHEN (CAST(0.25 AS DOUBLE PRECISION) IS NULL OR CAST(0.25 AS DOUBLE PRECISION) > CAST(0.0 AS DOUBLE PRECISION)) THEN ln(CAST(0.25 AS DOUBLE PRECISION)) ELSE -1.79769313486231e+308 END AS "LogProba_3", multinomial_cte.multinomial_expr AS "Decision" 
