...
-- Code For temporary table tmp_20180508192924_codegen_sb02vm_ads_imp_1_out part 1. Create 


CREATE TABLE tmp_20180508192924_codegen_sb02vm_ads_imp_1_out (
	`KEY` BIGINT, 
	impter_2 DOUBLE, 
	impter_3 DOUBLE, 
	impter_4 DOUBLE, 
...
-- Code For temporary table tmp_20180508192924_codegen_wy7nhy_ads_sca_2_out part 1. Create 


CREATE TABLE tmp_20180508192924_codegen_wy7nhy_ads_sca_2_out (
	`KEY` BIGINT, 
	scaler_2 DOUBLE, 
	scaler_3 DOUBLE, 
	scaler_4 DOUBLE, 
...
FROM tmp_20180508192924_codegen_sb02vm_ads_imp_1_out AS `ADS_imp_1_OUT`) AS `ADS_sca_2_OUT`

-- Model deployment code

WITH random_number_cte AS 
(SELECT `ADS_sca_2_OUT`.`KEY` AS `KEY`, rand() AS uniform 
FROM tmp_20180508192924_codegen_wy7nhy_ads_sca_2_out AS `ADS_sca_2_OUT`), 
multinomial_cte AS 
