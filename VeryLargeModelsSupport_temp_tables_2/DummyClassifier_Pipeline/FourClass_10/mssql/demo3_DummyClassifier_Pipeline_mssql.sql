...
-- Code For temporary table ##TMP_20180508181219_CODEGEN_NL34XR_ADS_imp_1_OUT part 1. Create 


CREATE TABLE ##TMP_20180508181219_CODEGEN_NL34XR_ADS_imp_1_OUT (
	[KEY] BIGINT NULL, 
...
-- Code For temporary table ##TMP_20180508181219_CODEGEN_NL34XR_ADS_imp_1_OUT part 2. Populate

INSERT INTO ##TMP_20180508181219_CODEGEN_NL34XR_ADS_imp_1_OUT ([KEY], impter_2, impter_3, impter_4, impter_5, impter_6, impter_7, impter_8, impter_9, impter_10, impter_11) SELECT [ADS_imp_1_OUT].[KEY], [ADS_imp_1_OUT].impter_2, [ADS_imp_1_OUT].impter_3, [ADS_imp_1_OUT].impter_4, [ADS_imp_1_OUT].impter_5, [ADS_imp_1_OUT].impter_6, [ADS_imp_1_OUT].impter_7, [ADS_imp_1_OUT].impter_8, [ADS_imp_1_OUT].impter_9, [ADS_imp_1_OUT].impter_10, [ADS_imp_1_OUT].impter_11 
...
-- Code For temporary table ##TMP_20180508181219_CODEGEN_2CDFCG_ADS_sca_2_OUT part 1. Create 


CREATE TABLE ##TMP_20180508181219_CODEGEN_2CDFCG_ADS_sca_2_OUT (
	[KEY] BIGINT NULL, 
	scaler_2 FLOAT NULL, 
	scaler_3 FLOAT NULL, 
	scaler_4 FLOAT NULL, 
...
FROM ##TMP_20180508181219_CODEGEN_NL34XR_ADS_imp_1_OUT AS [ADS_imp_1_OUT]) AS [ADS_sca_2_OUT]

-- Model deployment code

WITH random_number_cte AS 
(SELECT [ADS_sca_2_OUT].[KEY] AS [KEY], rand() AS uniform 
FROM ##TMP_20180508181219_CODEGEN_2CDFCG_ADS_sca_2_OUT AS [ADS_sca_2_OUT]), 
multinomial_cte AS 
...
(SELECT multinomial_cte.[KEY] AS [KEY], 0.225 AS [Proba_0], CASE WHEN (0.225 IS NULL OR 0.225 > 0.0) THEN log(0.225) ELSE -1.79769313486231e+308 END AS [LogProba_0], 0.25 AS [Proba_1], CASE WHEN (0.25 IS NULL OR 0.25 > 0.0) THEN log(0.25) ELSE -1.79769313486231e+308 END AS [LogProba_1], 0.25 AS [Proba_2], CASE WHEN (0.25 IS NULL OR 0.25 > 0.0) THEN log(0.25) ELSE -1.79769313486231e+308 END AS [LogProba_2], 0.275 AS [Proba_3], CASE WHEN (0.275 IS NULL OR 0.275 > 0.0) THEN log(0.275) ELSE -1.79769313486231e+308 END AS [LogProba_3], multinomial_cte.multinomial_expr AS [Decision] 
