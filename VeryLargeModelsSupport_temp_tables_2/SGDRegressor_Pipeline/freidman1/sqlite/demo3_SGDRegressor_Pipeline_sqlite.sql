...
-- Code For temporary table TMP_20180508184552_CODEGEN_0ZXIQF_ADS_imp_1_OUT part 1. Create 


CREATE TEMPORARY TABLE "TMP_20180508184552_CODEGEN_0ZXIQF_ADS_imp_1_OUT" (
	"KEY" BIGINT NOT NULL, 
	impter_2 FLOAT, 
	impter_3 FLOAT, 
	impter_4 FLOAT, 
...
-- Code For temporary table TMP_20180508184552_CODEGEN_0ZXIQF_ADS_imp_1_OUT part 2. Populate

INSERT INTO "TMP_20180508184552_CODEGEN_0ZXIQF_ADS_imp_1_OUT" ("KEY", impter_2, impter_3, impter_4, impter_5, impter_6, impter_7, impter_8, impter_9, impter_10, impter_11) SELECT "ADS_imp_1_OUT"."KEY", "ADS_imp_1_OUT".impter_2, "ADS_imp_1_OUT".impter_3, "ADS_imp_1_OUT".impter_4, "ADS_imp_1_OUT".impter_5, "ADS_imp_1_OUT".impter_6, "ADS_imp_1_OUT".impter_7, "ADS_imp_1_OUT".impter_8, "ADS_imp_1_OUT".impter_9, "ADS_imp_1_OUT".impter_10, "ADS_imp_1_OUT".impter_11 
...
-- Code For temporary table TMP_20180508184552_CODEGEN_0ZXIQF_ADS_imp_1_OUT part 3. Create Index 

CREATE INDEX "ix_TMP_20180508184552_CODEGEN_0ZXIQF_ADS_imp_1_OUT_KEY" ON "TMP_20180508184552_CODEGEN_0ZXIQF_ADS_imp_1_OUT" ("KEY")

-- Code For temporary table TMP_20180508184552_CODEGEN_1UYWP4_ADS_sca_2_OUT part 1. Create 


CREATE TEMPORARY TABLE "TMP_20180508184552_CODEGEN_1UYWP4_ADS_sca_2_OUT" (
	"KEY" BIGINT NOT NULL, 
	scaler_2 FLOAT, 
	scaler_3 FLOAT, 
	scaler_4 FLOAT, 
...
-- Code For temporary table TMP_20180508184552_CODEGEN_1UYWP4_ADS_sca_2_OUT part 2. Populate

INSERT INTO "TMP_20180508184552_CODEGEN_1UYWP4_ADS_sca_2_OUT" ("KEY", scaler_2, scaler_3, scaler_4, scaler_5, scaler_6, scaler_7, scaler_8, scaler_9, scaler_10, scaler_11) SELECT "ADS_sca_2_OUT"."KEY", "ADS_sca_2_OUT".scaler_2, "ADS_sca_2_OUT".scaler_3, "ADS_sca_2_OUT".scaler_4, "ADS_sca_2_OUT".scaler_5, "ADS_sca_2_OUT".scaler_6, "ADS_sca_2_OUT".scaler_7, "ADS_sca_2_OUT".scaler_8, "ADS_sca_2_OUT".scaler_9, "ADS_sca_2_OUT".scaler_10, "ADS_sca_2_OUT".scaler_11 
...
FROM "TMP_20180508184552_CODEGEN_0ZXIQF_ADS_imp_1_OUT" AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT"

-- Code For temporary table TMP_20180508184552_CODEGEN_1UYWP4_ADS_sca_2_OUT part 3. Create Index 

CREATE INDEX "ix_TMP_20180508184552_CODEGEN_1UYWP4_ADS_sca_2_OUT_KEY" ON "TMP_20180508184552_CODEGEN_1UYWP4_ADS_sca_2_OUT" ("KEY")
...
FROM "TMP_20180508184552_CODEGEN_1UYWP4_ADS_sca_2_OUT" AS "ADS_sca_2_OUT"), 
linear_model_cte AS 
