...
-- Code For temporary table tmp_20180508193452_codegen_n30323_ads_imp_1_out part 1. Create 


CREATE TABLE tmp_20180508193452_codegen_n30323_ads_imp_1_out (
	`KEY` BIGINT, 
	impter_2 DOUBLE, 
	impter_3 DOUBLE, 
	impter_4 DOUBLE, 
...
-- Code For temporary table tmp_20180508193452_codegen_6u1w3s_ads_sca_2_out part 1. Create 


CREATE TABLE tmp_20180508193452_codegen_6u1w3s_ads_sca_2_out (
	`KEY` BIGINT, 
	scaler_2 DOUBLE, 
	scaler_3 DOUBLE, 
	scaler_4 DOUBLE, 
...
FROM tmp_20180508193452_codegen_n30323_ads_imp_1_out AS `ADS_imp_1_OUT`) AS `ADS_sca_2_OUT`
...
FROM tmp_20180508193452_codegen_6u1w3s_ads_sca_2_out AS `ADS_sca_2_OUT`), 
linear_model_cte AS 
