...
-- Code For temporary table TMP_20180508182725_CODEGEN_SG1Y part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508182725_CODEGEN_SG1Y" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20180508182725_CODEGEN_SG1Y part 3. Create Index 

CREATE INDEX "ix_TMP_20180508182725_C_98bc" ON "TMP_20180508182725_CODEGEN_SG1Y" ("KEY")

-- Code For temporary table TMP_20180508182725_CODEGEN_TOTG part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508182725_CODEGEN_TOTG" (
	"KEY" BIGINT NOT NULL, 
...
FROM "TMP_20180508182725_CODEGEN_SG1Y" AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT") AS "U"

-- Code For temporary table TMP_20180508182725_CODEGEN_TOTG part 3. Create Index 

CREATE INDEX "ix_TMP_20180508182725_C_9f2a" ON "TMP_20180508182725_CODEGEN_TOTG" ("KEY")
...
FROM "TMP_20180508182725_CODEGEN_TOTG" AS "ADS_sca_2_OUT"), 
linear_model_cte AS 
