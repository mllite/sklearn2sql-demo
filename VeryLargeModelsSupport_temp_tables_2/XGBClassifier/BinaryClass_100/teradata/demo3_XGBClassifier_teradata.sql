...
-- Code For temporary table tmp_20180508180553_codegen_66x29a_xgb_b0 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180508180553_codegen_66x29a_xgb_b0  (
	"KEY" BIGINT, 
...
-- Code For temporary table tmp_20180508180553_codegen_66x29a_xgb_b0 part 2. Populate

INSERT INTO tmp_20180508180553_codegen_66x29a_xgb_b0 ("KEY", "Score_0") SELECT "U"."KEY", "U"."Score_0" 
FROM (WITH "DT_node_lookup" AS 
(SELECT "ADS"."KEY" AS "KEY", CASE WHEN ("ADS"."Feature_57" < CAST(-0.296593874692917 AS DOUBLE PRECISION)) THEN 1 ELSE 2 END AS node_id_2 
...
-- Code For temporary table tmp_20180508180553_codegen_6yxdts_xgb_b1 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180508180553_codegen_6yxdts_xgb_b1  (
	"KEY" BIGINT, 
	"Score_0" DOUBLE PRECISION
)
...
-- Code For temporary table tmp_20180508180553_codegen_6yxdts_xgb_b1 part 2. Populate

INSERT INTO tmp_20180508180553_codegen_6yxdts_xgb_b1 ("KEY", "Score_0") SELECT "U"."KEY", "U"."Score_0" 
...
-- Code For temporary table tmp_20180508180553_codegen_gxq0yp_xgb_union part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180508180553_codegen_gxq0yp_xgb_union  (
	"KEY" BIGINT, 
	"Score_0" DOUBLE PRECISION
)
...
-- Code For temporary table tmp_20180508180553_codegen_gxq0yp_xgb_union part 2. Populate

INSERT INTO tmp_20180508180553_codegen_gxq0yp_xgb_union ("KEY", "Score_0") SELECT "U"."KEY", "U"."Score_0" 
...
FROM tmp_20180508180553_codegen_66x29a_xgb_b0 AS "XGB_B0" UNION ALL SELECT "XGB_B1"."KEY" AS "KEY", "XGB_B1"."Score_0" AS "Score_0" 
FROM tmp_20180508180553_codegen_6yxdts_xgb_b1 AS "XGB_B1") AS "XGB_EnsembleUnion") AS "XGB_Union") AS "U"

-- Code For temporary table tmp_20180508180553_codegen_tvgbxk_xgb_sum part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180508180553_codegen_tvgbxk_xgb_sum  (
	"KEY" BIGINT, 
	"Score_0" DOUBLE PRECISION
)
...
-- Code For temporary table tmp_20180508180553_codegen_tvgbxk_xgb_sum part 2. Populate

INSERT INTO tmp_20180508180553_codegen_tvgbxk_xgb_sum ("KEY", "Score_0") SELECT "U"."KEY", "U"."Score_0" 
...
FROM tmp_20180508180553_codegen_gxq0yp_xgb_union AS "XGB_Union" GROUP BY "XGB_Union"."KEY") AS "T") AS "XGB_sum") AS "U"
...
FROM tmp_20180508180553_codegen_tvgbxk_xgb_sum AS "XGB_sum"), 
