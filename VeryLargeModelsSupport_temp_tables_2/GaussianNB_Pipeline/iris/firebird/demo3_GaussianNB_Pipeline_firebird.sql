...
-- Code For temporary table TMP_20180508185613_CODEGEN_SM8S part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508185613_CODEGEN_SM8S" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20180508185613_CODEGEN_SM8S part 2. Populate

INSERT INTO "TMP_20180508185613_CODEGEN_SM8S" ("KEY", imputer_output_2, imputer_output_3, imputer_output_4, imputer_output_5) SELECT "U"."KEY", "U".imputer_output_2, "U".imputer_output_3, "U".imputer_output_4, "U".imputer_output_5 
...
-- Code For temporary table TMP_20180508185613_CODEGEN_SM8S part 3. Create Index 

CREATE INDEX "ix_TMP_20180508185613_C_897b" ON "TMP_20180508185613_CODEGEN_SM8S" ("KEY")

-- Code For temporary table TMP_20180508185613_CODEGEN_KQ1X part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508185613_CODEGEN_KQ1X" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20180508185613_CODEGEN_KQ1X part 2. Populate

INSERT INTO "TMP_20180508185613_CODEGEN_KQ1X" ("KEY", scaler_output_2, scaler_output_3, scaler_output_4, scaler_output_5) SELECT "U"."KEY", "U".scaler_output_2, "U".scaler_output_3, "U".scaler_output_4, "U".scaler_output_5 
...
FROM "TMP_20180508185613_CODEGEN_SM8S" AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT") AS "U"

-- Code For temporary table TMP_20180508185613_CODEGEN_KQ1X part 3. Create Index 

CREATE INDEX "ix_TMP_20180508185613_C_6336" ON "TMP_20180508185613_CODEGEN_KQ1X" ("KEY")
...
FROM "TMP_20180508185613_CODEGEN_KQ1X" AS "ADS_sca_2_OUT"), 
"NaiveBayes_data" AS 
