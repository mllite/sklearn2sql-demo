...
-- Code For temporary table TMP_20180508180752_CODEGEN_05IV part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508180752_CODEGEN_05IV" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20180508180752_CODEGEN_05IV part 2. Populate

INSERT INTO "TMP_20180508180752_CODEGEN_05IV" ("KEY", impter_2, impter_3, impter_4, impter_5, impter_6, impter_7, impter_8, impter_9, impter_10, impter_11, impter_12, impter_13, impter_14, impter_15, impter_16, impter_17, impter_18, impter_19, impter_20, impter_21, impter_22, impter_23, impter_24, impter_25, impter_26, impter_27, impter_28, impter_29, impter_30, impter_31) SELECT "U"."KEY", "U".impter_2, "U".impter_3, "U".impter_4, "U".impter_5, "U".impter_6, "U".impter_7, "U".impter_8, "U".impter_9, "U".impter_10, "U".impter_11, "U".impter_12, "U".impter_13, "U".impter_14, "U".impter_15, "U".impter_16, "U".impter_17, "U".impter_18, "U".impter_19, "U".impter_20, "U".impter_21, "U".impter_22, "U".impter_23, "U".impter_24, "U".impter_25, "U".impter_26, "U".impter_27, "U".impter_28, "U".impter_29, "U".impter_30, "U".impter_31 
...
-- Code For temporary table TMP_20180508180752_CODEGEN_05IV part 3. Create Index 

CREATE INDEX "ix_TMP_20180508180752_C_a798" ON "TMP_20180508180752_CODEGEN_05IV" ("KEY")

-- Code For temporary table TMP_20180508180752_CODEGEN_IO5V part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508180752_CODEGEN_IO5V" (
	"KEY" BIGINT NOT NULL, 
...
FROM "TMP_20180508180752_CODEGEN_05IV" AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT") AS "U"

-- Code For temporary table TMP_20180508180752_CODEGEN_IO5V part 3. Create Index 

CREATE INDEX "ix_TMP_20180508180752_C_604a" ON "TMP_20180508180752_CODEGEN_IO5V" ("KEY")
...
FROM "TMP_20180508180752_CODEGEN_IO5V" AS "ADS_sca_2_OUT"), 
"NaiveBayes_data" AS 
