...
-- Code For temporary table tmp_20180508185440_codegen_j4cdct_bag_b0 part 1. Create 


CREATE TEMPORARY TABLE tmp_20180508185440_codegen_j4cdct_bag_b0 (
	"KEY" BIGINT, 
	"Score_0" DOUBLE, 
	"Proba_0" DOUBLE, 
	"LogProba_0" DOUBLE, 
...
-- Code For temporary table tmp_20180508185440_codegen_j4cdct_bag_b0 part 2. Populate

INSERT INTO tmp_20180508185440_codegen_j4cdct_bag_b0 ("KEY", "Score_0", "Proba_0", "LogProba_0", "Score_1", "Proba_1", "LogProba_1", "Score_2", "Proba_2", "LogProba_2") SELECT "U"."KEY", "U"."Score_0", "U"."Proba_0", "U"."LogProba_0", "U"."Score_1", "U"."Proba_1", "U"."LogProba_1", "U"."Score_2", "U"."Proba_2", "U"."LogProba_2" 
...
"BAG_Model_0" AS 
(SELECT "DT_Output"."KEY" AS "KEY", CAST(NULL AS DOUBLE) AS "Score_0", "DT_Output"."P_0" AS "Proba_0", log(CASE WHEN ("DT_Output"."P_0" IS NULL OR "DT_Output"."P_0" > 1e-100) THEN "DT_Output"."P_0" ELSE 1e-100 END) AS "LogProba_0", CAST(NULL AS DOUBLE) AS "Score_1", "DT_Output"."P_1" AS "Proba_1", log(CASE WHEN ("DT_Output"."P_1" IS NULL OR "DT_Output"."P_1" > 1e-100) THEN "DT_Output"."P_1" ELSE 1e-100 END) AS "LogProba_1", CAST(NULL AS DOUBLE) AS "Score_2", "DT_Output"."P_2" AS "Proba_2", log(CASE WHEN ("DT_Output"."P_2" IS NULL OR "DT_Output"."P_2" > 1e-100) THEN "DT_Output"."P_2" ELSE 1e-100 END) AS "LogProba_2" 
FROM "DT_Output"), 
"DT_node_lookup_1" AS 
...
"BAG_Model_1" AS 
(SELECT "DT_Output_1"."KEY" AS "KEY", CAST(NULL AS DOUBLE) AS "Score_0", "DT_Output_1"."P_0" AS "Proba_0", log(CASE WHEN ("DT_Output_1"."P_0" IS NULL OR "DT_Output_1"."P_0" > 1e-100) THEN "DT_Output_1"."P_0" ELSE 1e-100 END) AS "LogProba_0", CAST(NULL AS DOUBLE) AS "Score_1", "DT_Output_1"."P_1" AS "Proba_1", log(CASE WHEN ("DT_Output_1"."P_1" IS NULL OR "DT_Output_1"."P_1" > 1e-100) THEN "DT_Output_1"."P_1" ELSE 1e-100 END) AS "LogProba_1", CAST(NULL AS DOUBLE) AS "Score_2", "DT_Output_1"."P_2" AS "Proba_2", log(CASE WHEN ("DT_Output_1"."P_2" IS NULL OR "DT_Output_1"."P_2" > 1e-100) THEN "DT_Output_1"."P_2" ELSE 1e-100 END) AS "LogProba_2" 
FROM "DT_Output_1"), 
"DT_node_lookup_2" AS 
...
"BAG_Model_4" AS 
(SELECT "DT_Output_4"."KEY" AS "KEY", CAST(NULL AS DOUBLE) AS "Score_0", "DT_Output_4"."P_0" AS "Proba_0", log(CASE WHEN ("DT_Output_4"."P_0" IS NULL OR "DT_Output_4"."P_0" > 1e-100) THEN "DT_Output_4"."P_0" ELSE 1e-100 END) AS "LogProba_0", CAST(NULL AS DOUBLE) AS "Score_1", "DT_Output_4"."P_1" AS "Proba_1", log(CASE WHEN ("DT_Output_4"."P_1" IS NULL OR "DT_Output_4"."P_1" > 1e-100) THEN "DT_Output_4"."P_1" ELSE 1e-100 END) AS "LogProba_1", CAST(NULL AS DOUBLE) AS "Score_2", "DT_Output_4"."P_2" AS "Proba_2", log(CASE WHEN ("DT_Output_4"."P_2" IS NULL OR "DT_Output_4"."P_2" > 1e-100) THEN "DT_Output_4"."P_2" ELSE 1e-100 END) AS "LogProba_2" 
FROM "DT_Output_4"), 
"DT_node_lookup_5" AS 
...
"BAG_Model_5" AS 
(SELECT "DT_Output_5"."KEY" AS "KEY", CAST(NULL AS DOUBLE) AS "Score_0", "DT_Output_5"."P_0" AS "Proba_0", log(CASE WHEN ("DT_Output_5"."P_0" IS NULL OR "DT_Output_5"."P_0" > 1e-100) THEN "DT_Output_5"."P_0" ELSE 1e-100 END) AS "LogProba_0", CAST(NULL AS DOUBLE) AS "Score_1", "DT_Output_5"."P_1" AS "Proba_1", log(CASE WHEN ("DT_Output_5"."P_1" IS NULL OR "DT_Output_5"."P_1" > 1e-100) THEN "DT_Output_5"."P_1" ELSE 1e-100 END) AS "LogProba_1", CAST(NULL AS DOUBLE) AS "Score_2", "DT_Output_5"."P_2" AS "Proba_2", log(CASE WHEN ("DT_Output_5"."P_2" IS NULL OR "DT_Output_5"."P_2" > 1e-100) THEN "DT_Output_5"."P_2" ELSE 1e-100 END) AS "LogProba_2" 
FROM "DT_Output_5"), 
"DT_node_lookup_6" AS 
...
"BAG_Model_6" AS 
(SELECT "DT_Output_6"."KEY" AS "KEY", CAST(NULL AS DOUBLE) AS "Score_0", "DT_Output_6"."P_0" AS "Proba_0", log(CASE WHEN ("DT_Output_6"."P_0" IS NULL OR "DT_Output_6"."P_0" > 1e-100) THEN "DT_Output_6"."P_0" ELSE 1e-100 END) AS "LogProba_0", CAST(NULL AS DOUBLE) AS "Score_1", "DT_Output_6"."P_1" AS "Proba_1", log(CASE WHEN ("DT_Output_6"."P_1" IS NULL OR "DT_Output_6"."P_1" > 1e-100) THEN "DT_Output_6"."P_1" ELSE 1e-100 END) AS "LogProba_1", CAST(NULL AS DOUBLE) AS "Score_2", "DT_Output_6"."P_2" AS "Proba_2", log(CASE WHEN ("DT_Output_6"."P_2" IS NULL OR "DT_Output_6"."P_2" > 1e-100) THEN "DT_Output_6"."P_2" ELSE 1e-100 END) AS "LogProba_2" 
FROM "DT_Output_6"), 
"DT_node_lookup_7" AS 
...
"BAG_Model_7" AS 
(SELECT "DT_Output_7"."KEY" AS "KEY", CAST(NULL AS DOUBLE) AS "Score_0", "DT_Output_7"."P_0" AS "Proba_0", log(CASE WHEN ("DT_Output_7"."P_0" IS NULL OR "DT_Output_7"."P_0" > 1e-100) THEN "DT_Output_7"."P_0" ELSE 1e-100 END) AS "LogProba_0", CAST(NULL AS DOUBLE) AS "Score_1", "DT_Output_7"."P_1" AS "Proba_1", log(CASE WHEN ("DT_Output_7"."P_1" IS NULL OR "DT_Output_7"."P_1" > 1e-100) THEN "DT_Output_7"."P_1" ELSE 1e-100 END) AS "LogProba_1", CAST(NULL AS DOUBLE) AS "Score_2", "DT_Output_7"."P_2" AS "Proba_2", log(CASE WHEN ("DT_Output_7"."P_2" IS NULL OR "DT_Output_7"."P_2" > 1e-100) THEN "DT_Output_7"."P_2" ELSE 1e-100 END) AS "LogProba_2" 
FROM "DT_Output_7"), 
"DT_node_lookup_8" AS 
...
-- Code For temporary table tmp_20180508185440_codegen_pps5in_bag_b1 part 1. Create 


CREATE TEMPORARY TABLE tmp_20180508185440_codegen_pps5in_bag_b1 (
	"KEY" BIGINT, 
	"Score_0" DOUBLE, 
	"Proba_0" DOUBLE, 
	"LogProba_0" DOUBLE, 
...
-- Code For temporary table tmp_20180508185440_codegen_pps5in_bag_b1 part 2. Populate

INSERT INTO tmp_20180508185440_codegen_pps5in_bag_b1 ("KEY", "Score_0", "Proba_0", "LogProba_0", "Score_1", "Proba_1", "LogProba_1", "Score_2", "Proba_2", "LogProba_2") SELECT "U"."KEY", "U"."Score_0", "U"."Proba_0", "U"."LogProba_0", "U"."Score_1", "U"."Proba_1", "U"."LogProba_1", "U"."Score_2", "U"."Proba_2", "U"."LogProba_2" 
...
"BAG_Model_11" AS 
(SELECT "DT_Output_11"."KEY" AS "KEY", CAST(NULL AS DOUBLE) AS "Score_0", "DT_Output_11"."P_0" AS "Proba_0", log(CASE WHEN ("DT_Output_11"."P_0" IS NULL OR "DT_Output_11"."P_0" > 1e-100) THEN "DT_Output_11"."P_0" ELSE 1e-100 END) AS "LogProba_0", CAST(NULL AS DOUBLE) AS "Score_1", "DT_Output_11"."P_1" AS "Proba_1", log(CASE WHEN ("DT_Output_11"."P_1" IS NULL OR "DT_Output_11"."P_1" > 1e-100) THEN "DT_Output_11"."P_1" ELSE 1e-100 END) AS "LogProba_1", CAST(NULL AS DOUBLE) AS "Score_2", "DT_Output_11"."P_2" AS "Proba_2", log(CASE WHEN ("DT_Output_11"."P_2" IS NULL OR "DT_Output_11"."P_2" > 1e-100) THEN "DT_Output_11"."P_2" ELSE 1e-100 END) AS "LogProba_2" 
FROM "DT_Output_11"), 
...
"BAG_Model_12" AS 
(SELECT "DT_Output_12"."KEY" AS "KEY", CAST(NULL AS DOUBLE) AS "Score_0", "DT_Output_12"."P_0" AS "Proba_0", log(CASE WHEN ("DT_Output_12"."P_0" IS NULL OR "DT_Output_12"."P_0" > 1e-100) THEN "DT_Output_12"."P_0" ELSE 1e-100 END) AS "LogProba_0", CAST(NULL AS DOUBLE) AS "Score_1", "DT_Output_12"."P_1" AS "Proba_1", log(CASE WHEN ("DT_Output_12"."P_1" IS NULL OR "DT_Output_12"."P_1" > 1e-100) THEN "DT_Output_12"."P_1" ELSE 1e-100 END) AS "LogProba_1", CAST(NULL AS DOUBLE) AS "Score_2", "DT_Output_12"."P_2" AS "Proba_2", log(CASE WHEN ("DT_Output_12"."P_2" IS NULL OR "DT_Output_12"."P_2" > 1e-100) THEN "DT_Output_12"."P_2" ELSE 1e-100 END) AS "LogProba_2" 
FROM "DT_Output_12"), 
...
"BAG_Model_13" AS 
(SELECT "DT_Output_13"."KEY" AS "KEY", CAST(NULL AS DOUBLE) AS "Score_0", "DT_Output_13"."P_0" AS "Proba_0", log(CASE WHEN ("DT_Output_13"."P_0" IS NULL OR "DT_Output_13"."P_0" > 1e-100) THEN "DT_Output_13"."P_0" ELSE 1e-100 END) AS "LogProba_0", CAST(NULL AS DOUBLE) AS "Score_1", "DT_Output_13"."P_1" AS "Proba_1", log(CASE WHEN ("DT_Output_13"."P_1" IS NULL OR "DT_Output_13"."P_1" > 1e-100) THEN "DT_Output_13"."P_1" ELSE 1e-100 END) AS "LogProba_1", CAST(NULL AS DOUBLE) AS "Score_2", "DT_Output_13"."P_2" AS "Proba_2", log(CASE WHEN ("DT_Output_13"."P_2" IS NULL OR "DT_Output_13"."P_2" > 1e-100) THEN "DT_Output_13"."P_2" ELSE 1e-100 END) AS "LogProba_2" 
FROM "DT_Output_13"), 
...
"BAG_Model_14" AS 
(SELECT "DT_Output_14"."KEY" AS "KEY", CAST(NULL AS DOUBLE) AS "Score_0", "DT_Output_14"."P_0" AS "Proba_0", log(CASE WHEN ("DT_Output_14"."P_0" IS NULL OR "DT_Output_14"."P_0" > 1e-100) THEN "DT_Output_14"."P_0" ELSE 1e-100 END) AS "LogProba_0", CAST(NULL AS DOUBLE) AS "Score_1", "DT_Output_14"."P_1" AS "Proba_1", log(CASE WHEN ("DT_Output_14"."P_1" IS NULL OR "DT_Output_14"."P_1" > 1e-100) THEN "DT_Output_14"."P_1" ELSE 1e-100 END) AS "LogProba_1", CAST(NULL AS DOUBLE) AS "Score_2", "DT_Output_14"."P_2" AS "Proba_2", log(CASE WHEN ("DT_Output_14"."P_2" IS NULL OR "DT_Output_14"."P_2" > 1e-100) THEN "DT_Output_14"."P_2" ELSE 1e-100 END) AS "LogProba_2" 
FROM "DT_Output_14"), 
...
-- Code For temporary table tmp_20180508185440_codegen_rnm9x0_bag_union part 1. Create 


CREATE TEMPORARY TABLE tmp_20180508185440_codegen_rnm9x0_bag_union (
	"KEY" BIGINT, 
	"Score_0" DOUBLE, 
	"Proba_0" DOUBLE, 
	"LogProba_0" DOUBLE, 
...
-- Code For temporary table tmp_20180508185440_codegen_rnm9x0_bag_union part 2. Populate

INSERT INTO tmp_20180508185440_codegen_rnm9x0_bag_union ("KEY", "Score_0", "Proba_0", "LogProba_0", "Score_1", "Proba_1", "LogProba_1", "Score_2", "Proba_2", "LogProba_2") SELECT "U"."KEY", "U"."Score_0", "U"."Proba_0", "U"."LogProba_0", "U"."Score_1", "U"."Proba_1", "U"."LogProba_1", "U"."Score_2", "U"."Proba_2", "U"."LogProba_2" 
...
-- Code For temporary table tmp_20180508185440_codegen_5888en_bag_avg part 2. Populate

INSERT INTO tmp_20180508185440_codegen_5888en_bag_avg ("KEY", "Score_0", "Proba_0", "LogProba_0", "Score_1", "Proba_1", "LogProba_1", "Score_2", "Proba_2", "LogProba_2") SELECT "U"."KEY", "U"."Score_0", "U"."Proba_0", "U"."LogProba_0", "U"."Score_1", "U"."Proba_1", "U"."LogProba_1", "U"."Score_2", "U"."Proba_2", "U"."LogProba_2" 
...
FROM tmp_20180508185440_codegen_rnm9x0_bag_union AS "BAG_Union" GROUP BY "BAG_Union"."KEY") AS "T") AS "BAG_avg") AS "U"
...
FROM tmp_20180508185440_codegen_5888en_bag_avg AS "BAG_avg"), 
