...
-- Code For temporary table TMP_20180508190417_CODEGEN_GH0U part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508190417_CODEGEN_GH0U" (
	"KEY" BIGINT, 
...
"BAG_Model_0" AS 
(SELECT "DT_Output"."KEY" AS "KEY", CAST(NULL AS DOUBLE PRECISION) AS "Score_CLASS_0", "DT_Output"."P_0" AS "Proba_CLASS_0", CASE WHEN ("DT_Output"."P_0" IS NULL OR "DT_Output"."P_0" > 0.0) THEN ln("DT_Output"."P_0") ELSE -1e+20 END AS "LogProba_CLASS_0", CAST(NULL AS DOUBLE PRECISION) AS "Score_CLASS_1", "DT_Output"."P_1" AS "Proba_CLASS_1", CASE WHEN ("DT_Output"."P_1" IS NULL OR "DT_Output"."P_1" > 0.0) THEN ln("DT_Output"."P_1") ELSE -1e+20 END AS "LogProba_CLASS_1", CAST(NULL AS DOUBLE PRECISION) AS "Score_CLASS_2", "DT_Output"."P_2" AS "Proba_CLASS_2", CASE WHEN ("DT_Output"."P_2" IS NULL OR "DT_Output"."P_2" > 0.0) THEN ln("DT_Output"."P_2") ELSE -1e+20 END AS "LogProba_CLASS_2" 
FROM "DT_Output"), 
"DT_node_lookup_1" AS 
...
"BAG_Model_1" AS 
(SELECT "DT_Output_1"."KEY" AS "KEY", CAST(NULL AS DOUBLE PRECISION) AS "Score_CLASS_0", "DT_Output_1"."P_0" AS "Proba_CLASS_0", CASE WHEN ("DT_Output_1"."P_0" IS NULL OR "DT_Output_1"."P_0" > 0.0) THEN ln("DT_Output_1"."P_0") ELSE -1e+20 END AS "LogProba_CLASS_0", CAST(NULL AS DOUBLE PRECISION) AS "Score_CLASS_1", "DT_Output_1"."P_1" AS "Proba_CLASS_1", CASE WHEN ("DT_Output_1"."P_1" IS NULL OR "DT_Output_1"."P_1" > 0.0) THEN ln("DT_Output_1"."P_1") ELSE -1e+20 END AS "LogProba_CLASS_1", CAST(NULL AS DOUBLE PRECISION) AS "Score_CLASS_2", "DT_Output_1"."P_2" AS "Proba_CLASS_2", CASE WHEN ("DT_Output_1"."P_2" IS NULL OR "DT_Output_1"."P_2" > 0.0) THEN ln("DT_Output_1"."P_2") ELSE -1e+20 END AS "LogProba_CLASS_2" 
FROM "DT_Output_1"), 
"DT_node_lookup_2" AS 
...
"BAG_Model_2" AS 
(SELECT "DT_Output_2"."KEY" AS "KEY", CAST(NULL AS DOUBLE PRECISION) AS "Score_CLASS_0", "DT_Output_2"."P_0" AS "Proba_CLASS_0", CASE WHEN ("DT_Output_2"."P_0" IS NULL OR "DT_Output_2"."P_0" > 0.0) THEN ln("DT_Output_2"."P_0") ELSE -1e+20 END AS "LogProba_CLASS_0", CAST(NULL AS DOUBLE PRECISION) AS "Score_CLASS_1", "DT_Output_2"."P_1" AS "Proba_CLASS_1", CASE WHEN ("DT_Output_2"."P_1" IS NULL OR "DT_Output_2"."P_1" > 0.0) THEN ln("DT_Output_2"."P_1") ELSE -1e+20 END AS "LogProba_CLASS_1", CAST(NULL AS DOUBLE PRECISION) AS "Score_CLASS_2", "DT_Output_2"."P_2" AS "Proba_CLASS_2", CASE WHEN ("DT_Output_2"."P_2" IS NULL OR "DT_Output_2"."P_2" > 0.0) THEN ln("DT_Output_2"."P_2") ELSE -1e+20 END AS "LogProba_CLASS_2" 
FROM "DT_Output_2"), 
"DT_node_lookup_3" AS 
...
"BAG_Model_3" AS 
(SELECT "DT_Output_3"."KEY" AS "KEY", CAST(NULL AS DOUBLE PRECISION) AS "Score_CLASS_0", "DT_Output_3"."P_0" AS "Proba_CLASS_0", CASE WHEN ("DT_Output_3"."P_0" IS NULL OR "DT_Output_3"."P_0" > 0.0) THEN ln("DT_Output_3"."P_0") ELSE -1e+20 END AS "LogProba_CLASS_0", CAST(NULL AS DOUBLE PRECISION) AS "Score_CLASS_1", "DT_Output_3"."P_1" AS "Proba_CLASS_1", CASE WHEN ("DT_Output_3"."P_1" IS NULL OR "DT_Output_3"."P_1" > 0.0) THEN ln("DT_Output_3"."P_1") ELSE -1e+20 END AS "LogProba_CLASS_1", CAST(NULL AS DOUBLE PRECISION) AS "Score_CLASS_2", "DT_Output_3"."P_2" AS "Proba_CLASS_2", CASE WHEN ("DT_Output_3"."P_2" IS NULL OR "DT_Output_3"."P_2" > 0.0) THEN ln("DT_Output_3"."P_2") ELSE -1e+20 END AS "LogProba_CLASS_2" 
FROM "DT_Output_3"), 
"DT_node_lookup_4" AS 
...
"BAG_Model_4" AS 
(SELECT "DT_Output_4"."KEY" AS "KEY", CAST(NULL AS DOUBLE PRECISION) AS "Score_CLASS_0", "DT_Output_4"."P_0" AS "Proba_CLASS_0", CASE WHEN ("DT_Output_4"."P_0" IS NULL OR "DT_Output_4"."P_0" > 0.0) THEN ln("DT_Output_4"."P_0") ELSE -1e+20 END AS "LogProba_CLASS_0", CAST(NULL AS DOUBLE PRECISION) AS "Score_CLASS_1", "DT_Output_4"."P_1" AS "Proba_CLASS_1", CASE WHEN ("DT_Output_4"."P_1" IS NULL OR "DT_Output_4"."P_1" > 0.0) THEN ln("DT_Output_4"."P_1") ELSE -1e+20 END AS "LogProba_CLASS_1", CAST(NULL AS DOUBLE PRECISION) AS "Score_CLASS_2", "DT_Output_4"."P_2" AS "Proba_CLASS_2", CASE WHEN ("DT_Output_4"."P_2" IS NULL OR "DT_Output_4"."P_2" > 0.0) THEN ln("DT_Output_4"."P_2") ELSE -1e+20 END AS "LogProba_CLASS_2" 
FROM "DT_Output_4"), 
"DT_node_lookup_5" AS 
...
"BAG_Model_5" AS 
(SELECT "DT_Output_5"."KEY" AS "KEY", CAST(NULL AS DOUBLE PRECISION) AS "Score_CLASS_0", "DT_Output_5"."P_0" AS "Proba_CLASS_0", CASE WHEN ("DT_Output_5"."P_0" IS NULL OR "DT_Output_5"."P_0" > 0.0) THEN ln("DT_Output_5"."P_0") ELSE -1e+20 END AS "LogProba_CLASS_0", CAST(NULL AS DOUBLE PRECISION) AS "Score_CLASS_1", "DT_Output_5"."P_1" AS "Proba_CLASS_1", CASE WHEN ("DT_Output_5"."P_1" IS NULL OR "DT_Output_5"."P_1" > 0.0) THEN ln("DT_Output_5"."P_1") ELSE -1e+20 END AS "LogProba_CLASS_1", CAST(NULL AS DOUBLE PRECISION) AS "Score_CLASS_2", "DT_Output_5"."P_2" AS "Proba_CLASS_2", CASE WHEN ("DT_Output_5"."P_2" IS NULL OR "DT_Output_5"."P_2" > 0.0) THEN ln("DT_Output_5"."P_2") ELSE -1e+20 END AS "LogProba_CLASS_2" 
FROM "DT_Output_5"), 
"DT_node_lookup_6" AS 
...
"BAG_Model_6" AS 
(SELECT "DT_Output_6"."KEY" AS "KEY", CAST(NULL AS DOUBLE PRECISION) AS "Score_CLASS_0", "DT_Output_6"."P_0" AS "Proba_CLASS_0", CASE WHEN ("DT_Output_6"."P_0" IS NULL OR "DT_Output_6"."P_0" > 0.0) THEN ln("DT_Output_6"."P_0") ELSE -1e+20 END AS "LogProba_CLASS_0", CAST(NULL AS DOUBLE PRECISION) AS "Score_CLASS_1", "DT_Output_6"."P_1" AS "Proba_CLASS_1", CASE WHEN ("DT_Output_6"."P_1" IS NULL OR "DT_Output_6"."P_1" > 0.0) THEN ln("DT_Output_6"."P_1") ELSE -1e+20 END AS "LogProba_CLASS_1", CAST(NULL AS DOUBLE PRECISION) AS "Score_CLASS_2", "DT_Output_6"."P_2" AS "Proba_CLASS_2", CASE WHEN ("DT_Output_6"."P_2" IS NULL OR "DT_Output_6"."P_2" > 0.0) THEN ln("DT_Output_6"."P_2") ELSE -1e+20 END AS "LogProba_CLASS_2" 
FROM "DT_Output_6"), 
"DT_node_lookup_7" AS 
...
"BAG_Model_7" AS 
(SELECT "DT_Output_7"."KEY" AS "KEY", CAST(NULL AS DOUBLE PRECISION) AS "Score_CLASS_0", "DT_Output_7"."P_0" AS "Proba_CLASS_0", CASE WHEN ("DT_Output_7"."P_0" IS NULL OR "DT_Output_7"."P_0" > 0.0) THEN ln("DT_Output_7"."P_0") ELSE -1e+20 END AS "LogProba_CLASS_0", CAST(NULL AS DOUBLE PRECISION) AS "Score_CLASS_1", "DT_Output_7"."P_1" AS "Proba_CLASS_1", CASE WHEN ("DT_Output_7"."P_1" IS NULL OR "DT_Output_7"."P_1" > 0.0) THEN ln("DT_Output_7"."P_1") ELSE -1e+20 END AS "LogProba_CLASS_1", CAST(NULL AS DOUBLE PRECISION) AS "Score_CLASS_2", "DT_Output_7"."P_2" AS "Proba_CLASS_2", CASE WHEN ("DT_Output_7"."P_2" IS NULL OR "DT_Output_7"."P_2" > 0.0) THEN ln("DT_Output_7"."P_2") ELSE -1e+20 END AS "LogProba_CLASS_2" 
FROM "DT_Output_7"), 
"DT_node_lookup_8" AS 
...
"BAG_Model_8" AS 
(SELECT "DT_Output_8"."KEY" AS "KEY", CAST(NULL AS DOUBLE PRECISION) AS "Score_CLASS_0", "DT_Output_8"."P_0" AS "Proba_CLASS_0", CASE WHEN ("DT_Output_8"."P_0" IS NULL OR "DT_Output_8"."P_0" > 0.0) THEN ln("DT_Output_8"."P_0") ELSE -1e+20 END AS "LogProba_CLASS_0", CAST(NULL AS DOUBLE PRECISION) AS "Score_CLASS_1", "DT_Output_8"."P_1" AS "Proba_CLASS_1", CASE WHEN ("DT_Output_8"."P_1" IS NULL OR "DT_Output_8"."P_1" > 0.0) THEN ln("DT_Output_8"."P_1") ELSE -1e+20 END AS "LogProba_CLASS_1", CAST(NULL AS DOUBLE PRECISION) AS "Score_CLASS_2", "DT_Output_8"."P_2" AS "Proba_CLASS_2", CASE WHEN ("DT_Output_8"."P_2" IS NULL OR "DT_Output_8"."P_2" > 0.0) THEN ln("DT_Output_8"."P_2") ELSE -1e+20 END AS "LogProba_CLASS_2" 
FROM "DT_Output_8"), 
"DT_node_lookup_9" AS 
...
-- Code For temporary table TMP_20180508190417_CODEGEN_FH7N part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508190417_CODEGEN_FH7N" (
	"KEY" BIGINT, 
	"Score_CLASS_0" DOUBLE PRECISION, 
	"Proba_CLASS_0" DOUBLE PRECISION, 
	"LogProba_CLASS_0" DOUBLE PRECISION, 
...
-- Code For temporary table TMP_20180508190417_CODEGEN_FH7N part 2. Populate

INSERT INTO "TMP_20180508190417_CODEGEN_FH7N" ("KEY", "Score_CLASS_0", "Proba_CLASS_0", "LogProba_CLASS_0", "Score_CLASS_1", "Proba_CLASS_1", "LogProba_CLASS_1", "Score_CLASS_2", "Proba_CLASS_2", "LogProba_CLASS_2") SELECT "U"."KEY", "U"."Score_CLASS_0", "U"."Proba_CLASS_0", "U"."LogProba_CLASS_0", "U"."Score_CLASS_1", "U"."Proba_CLASS_1", "U"."LogProba_CLASS_1", "U"."Score_CLASS_2", "U"."Proba_CLASS_2", "U"."LogProba_CLASS_2" 
...
"BAG_Model_10" AS 
(SELECT "DT_Output_10"."KEY" AS "KEY", CAST(NULL AS DOUBLE PRECISION) AS "Score_CLASS_0", "DT_Output_10"."P_0" AS "Proba_CLASS_0", CASE WHEN ("DT_Output_10"."P_0" IS NULL OR "DT_Output_10"."P_0" > 0.0) THEN ln("DT_Output_10"."P_0") ELSE -1e+20 END AS "LogProba_CLASS_0", CAST(NULL AS DOUBLE PRECISION) AS "Score_CLASS_1", "DT_Output_10"."P_1" AS "Proba_CLASS_1", CASE WHEN ("DT_Output_10"."P_1" IS NULL OR "DT_Output_10"."P_1" > 0.0) THEN ln("DT_Output_10"."P_1") ELSE -1e+20 END AS "LogProba_CLASS_1", CAST(NULL AS DOUBLE PRECISION) AS "Score_CLASS_2", "DT_Output_10"."P_2" AS "Proba_CLASS_2", CASE WHEN ("DT_Output_10"."P_2" IS NULL OR "DT_Output_10"."P_2" > 0.0) THEN ln("DT_Output_10"."P_2") ELSE -1e+20 END AS "LogProba_CLASS_2" 
FROM "DT_Output_10"), 
...
"BAG_Model_11" AS 
(SELECT "DT_Output_11"."KEY" AS "KEY", CAST(NULL AS DOUBLE PRECISION) AS "Score_CLASS_0", "DT_Output_11"."P_0" AS "Proba_CLASS_0", CASE WHEN ("DT_Output_11"."P_0" IS NULL OR "DT_Output_11"."P_0" > 0.0) THEN ln("DT_Output_11"."P_0") ELSE -1e+20 END AS "LogProba_CLASS_0", CAST(NULL AS DOUBLE PRECISION) AS "Score_CLASS_1", "DT_Output_11"."P_1" AS "Proba_CLASS_1", CASE WHEN ("DT_Output_11"."P_1" IS NULL OR "DT_Output_11"."P_1" > 0.0) THEN ln("DT_Output_11"."P_1") ELSE -1e+20 END AS "LogProba_CLASS_1", CAST(NULL AS DOUBLE PRECISION) AS "Score_CLASS_2", "DT_Output_11"."P_2" AS "Proba_CLASS_2", CASE WHEN ("DT_Output_11"."P_2" IS NULL OR "DT_Output_11"."P_2" > 0.0) THEN ln("DT_Output_11"."P_2") ELSE -1e+20 END AS "LogProba_CLASS_2" 
FROM "DT_Output_11"), 
...
"BAG_Model_12" AS 
(SELECT "DT_Output_12"."KEY" AS "KEY", CAST(NULL AS DOUBLE PRECISION) AS "Score_CLASS_0", "DT_Output_12"."P_0" AS "Proba_CLASS_0", CASE WHEN ("DT_Output_12"."P_0" IS NULL OR "DT_Output_12"."P_0" > 0.0) THEN ln("DT_Output_12"."P_0") ELSE -1e+20 END AS "LogProba_CLASS_0", CAST(NULL AS DOUBLE PRECISION) AS "Score_CLASS_1", "DT_Output_12"."P_1" AS "Proba_CLASS_1", CASE WHEN ("DT_Output_12"."P_1" IS NULL OR "DT_Output_12"."P_1" > 0.0) THEN ln("DT_Output_12"."P_1") ELSE -1e+20 END AS "LogProba_CLASS_1", CAST(NULL AS DOUBLE PRECISION) AS "Score_CLASS_2", "DT_Output_12"."P_2" AS "Proba_CLASS_2", CASE WHEN ("DT_Output_12"."P_2" IS NULL OR "DT_Output_12"."P_2" > 0.0) THEN ln("DT_Output_12"."P_2") ELSE -1e+20 END AS "LogProba_CLASS_2" 
FROM "DT_Output_12"), 
...
"BAG_Model_13" AS 
(SELECT "DT_Output_13"."KEY" AS "KEY", CAST(NULL AS DOUBLE PRECISION) AS "Score_CLASS_0", "DT_Output_13"."P_0" AS "Proba_CLASS_0", CASE WHEN ("DT_Output_13"."P_0" IS NULL OR "DT_Output_13"."P_0" > 0.0) THEN ln("DT_Output_13"."P_0") ELSE -1e+20 END AS "LogProba_CLASS_0", CAST(NULL AS DOUBLE PRECISION) AS "Score_CLASS_1", "DT_Output_13"."P_1" AS "Proba_CLASS_1", CASE WHEN ("DT_Output_13"."P_1" IS NULL OR "DT_Output_13"."P_1" > 0.0) THEN ln("DT_Output_13"."P_1") ELSE -1e+20 END AS "LogProba_CLASS_1", CAST(NULL AS DOUBLE PRECISION) AS "Score_CLASS_2", "DT_Output_13"."P_2" AS "Proba_CLASS_2", CASE WHEN ("DT_Output_13"."P_2" IS NULL OR "DT_Output_13"."P_2" > 0.0) THEN ln("DT_Output_13"."P_2") ELSE -1e+20 END AS "LogProba_CLASS_2" 
FROM "DT_Output_13"), 
...
"BAG_Model_14" AS 
(SELECT "DT_Output_14"."KEY" AS "KEY", CAST(NULL AS DOUBLE PRECISION) AS "Score_CLASS_0", "DT_Output_14"."P_0" AS "Proba_CLASS_0", CASE WHEN ("DT_Output_14"."P_0" IS NULL OR "DT_Output_14"."P_0" > 0.0) THEN ln("DT_Output_14"."P_0") ELSE -1e+20 END AS "LogProba_CLASS_0", CAST(NULL AS DOUBLE PRECISION) AS "Score_CLASS_1", "DT_Output_14"."P_1" AS "Proba_CLASS_1", CASE WHEN ("DT_Output_14"."P_1" IS NULL OR "DT_Output_14"."P_1" > 0.0) THEN ln("DT_Output_14"."P_1") ELSE -1e+20 END AS "LogProba_CLASS_1", CAST(NULL AS DOUBLE PRECISION) AS "Score_CLASS_2", "DT_Output_14"."P_2" AS "Proba_CLASS_2", CASE WHEN ("DT_Output_14"."P_2" IS NULL OR "DT_Output_14"."P_2" > 0.0) THEN ln("DT_Output_14"."P_2") ELSE -1e+20 END AS "LogProba_CLASS_2" 
FROM "DT_Output_14"), 
...
"BAG_Model_15" AS 
(SELECT "DT_Output_15"."KEY" AS "KEY", CAST(NULL AS DOUBLE PRECISION) AS "Score_CLASS_0", "DT_Output_15"."P_0" AS "Proba_CLASS_0", CASE WHEN ("DT_Output_15"."P_0" IS NULL OR "DT_Output_15"."P_0" > 0.0) THEN ln("DT_Output_15"."P_0") ELSE -1e+20 END AS "LogProba_CLASS_0", CAST(NULL AS DOUBLE PRECISION) AS "Score_CLASS_1", "DT_Output_15"."P_1" AS "Proba_CLASS_1", CASE WHEN ("DT_Output_15"."P_1" IS NULL OR "DT_Output_15"."P_1" > 0.0) THEN ln("DT_Output_15"."P_1") ELSE -1e+20 END AS "LogProba_CLASS_1", CAST(NULL AS DOUBLE PRECISION) AS "Score_CLASS_2", "DT_Output_15"."P_2" AS "Proba_CLASS_2", CASE WHEN ("DT_Output_15"."P_2" IS NULL OR "DT_Output_15"."P_2" > 0.0) THEN ln("DT_Output_15"."P_2") ELSE -1e+20 END AS "LogProba_CLASS_2" 
FROM "DT_Output_15")
...
-- Code For temporary table TMP_20180508190417_CODEGEN_JSAQ part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508190417_CODEGEN_JSAQ" (
	"KEY" BIGINT, 
	"Score_CLASS_0" DOUBLE PRECISION, 
	"Proba_CLASS_0" DOUBLE PRECISION, 
	"LogProba_CLASS_0" DOUBLE PRECISION, 
...
-- Code For temporary table TMP_20180508190417_CODEGEN_JSAQ part 2. Populate

INSERT INTO "TMP_20180508190417_CODEGEN_JSAQ" ("KEY", "Score_CLASS_0", "Proba_CLASS_0", "LogProba_CLASS_0", "Score_CLASS_1", "Proba_CLASS_1", "LogProba_CLASS_1", "Score_CLASS_2", "Proba_CLASS_2", "LogProba_CLASS_2") SELECT "U"."KEY", "U"."Score_CLASS_0", "U"."Proba_CLASS_0", "U"."LogProba_CLASS_0", "U"."Score_CLASS_1", "U"."Proba_CLASS_1", "U"."LogProba_CLASS_1", "U"."Score_CLASS_2", "U"."Proba_CLASS_2", "U"."LogProba_CLASS_2" 
...
-- Code For temporary table TMP_20180508190417_CODEGEN_OSPF part 2. Populate

INSERT INTO "TMP_20180508190417_CODEGEN_OSPF" ("KEY", "Score_CLASS_0", "Proba_CLASS_0", "LogProba_CLASS_0", "Score_CLASS_1", "Proba_CLASS_1", "LogProba_CLASS_1", "Score_CLASS_2", "Proba_CLASS_2", "LogProba_CLASS_2") SELECT "U"."KEY", "U"."Score_CLASS_0", "U"."Proba_CLASS_0", "U"."LogProba_CLASS_0", "U"."Score_CLASS_1", "U"."Proba_CLASS_1", "U"."LogProba_CLASS_1", "U"."Score_CLASS_2", "U"."Proba_CLASS_2", "U"."LogProba_CLASS_2" 
...
FROM "TMP_20180508190417_CODEGEN_JSAQ" AS "BAG_Union" GROUP BY "BAG_Union"."KEY") AS "T") AS "BAG_avg") AS "U"

-- Code For temporary table TMP_20180508190417_CODEGEN_OSPF part 3. Create Index 

CREATE INDEX "ix_TMP_20180508190417_C_88a3" ON "TMP_20180508190417_CODEGEN_OSPF" ("KEY")
...
FROM "TMP_20180508190417_CODEGEN_OSPF" AS "BAG_avg"), 
