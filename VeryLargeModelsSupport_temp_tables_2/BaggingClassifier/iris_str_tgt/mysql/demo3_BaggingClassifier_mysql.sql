...
-- Code For temporary table TMP_20180508190416_CODEGEN_C22ZR4_BAG_B0 part 1. Create 


CREATE TEMPORARY TABLE `TMP_20180508190416_CODEGEN_C22ZR4_BAG_B0` (
	`KEY` BIGINT, 
...
`BAG_Model_1` AS 
(SELECT `DT_Output_1`.`KEY` AS `KEY`, NULL AS `Score_CLASS_0`, `DT_Output_1`.`P_0` AS `Proba_CLASS_0`, CASE WHEN (`DT_Output_1`.`P_0` IS NULL OR `DT_Output_1`.`P_0` > 0.0) THEN ln(`DT_Output_1`.`P_0`) ELSE -1.79769313486231e+308 END AS `LogProba_CLASS_0`, NULL AS `Score_CLASS_1`, `DT_Output_1`.`P_1` AS `Proba_CLASS_1`, CASE WHEN (`DT_Output_1`.`P_1` IS NULL OR `DT_Output_1`.`P_1` > 0.0) THEN ln(`DT_Output_1`.`P_1`) ELSE -1.79769313486231e+308 END AS `LogProba_CLASS_1`, NULL AS `Score_CLASS_2`, `DT_Output_1`.`P_2` AS `Proba_CLASS_2`, CASE WHEN (`DT_Output_1`.`P_2` IS NULL OR `DT_Output_1`.`P_2` > 0.0) THEN ln(`DT_Output_1`.`P_2`) ELSE -1.79769313486231e+308 END AS `LogProba_CLASS_2` 
FROM `DT_Output_1`), 
`DT_node_lookup_2` AS 
...
`BAG_Model_4` AS 
(SELECT `DT_Output_4`.`KEY` AS `KEY`, NULL AS `Score_CLASS_0`, `DT_Output_4`.`P_0` AS `Proba_CLASS_0`, CASE WHEN (`DT_Output_4`.`P_0` IS NULL OR `DT_Output_4`.`P_0` > 0.0) THEN ln(`DT_Output_4`.`P_0`) ELSE -1.79769313486231e+308 END AS `LogProba_CLASS_0`, NULL AS `Score_CLASS_1`, `DT_Output_4`.`P_1` AS `Proba_CLASS_1`, CASE WHEN (`DT_Output_4`.`P_1` IS NULL OR `DT_Output_4`.`P_1` > 0.0) THEN ln(`DT_Output_4`.`P_1`) ELSE -1.79769313486231e+308 END AS `LogProba_CLASS_1`, NULL AS `Score_CLASS_2`, `DT_Output_4`.`P_2` AS `Proba_CLASS_2`, CASE WHEN (`DT_Output_4`.`P_2` IS NULL OR `DT_Output_4`.`P_2` > 0.0) THEN ln(`DT_Output_4`.`P_2`) ELSE -1.79769313486231e+308 END AS `LogProba_CLASS_2` 
FROM `DT_Output_4`), 
`DT_node_lookup_5` AS 
...
`BAG_Model_5` AS 
(SELECT `DT_Output_5`.`KEY` AS `KEY`, NULL AS `Score_CLASS_0`, `DT_Output_5`.`P_0` AS `Proba_CLASS_0`, CASE WHEN (`DT_Output_5`.`P_0` IS NULL OR `DT_Output_5`.`P_0` > 0.0) THEN ln(`DT_Output_5`.`P_0`) ELSE -1.79769313486231e+308 END AS `LogProba_CLASS_0`, NULL AS `Score_CLASS_1`, `DT_Output_5`.`P_1` AS `Proba_CLASS_1`, CASE WHEN (`DT_Output_5`.`P_1` IS NULL OR `DT_Output_5`.`P_1` > 0.0) THEN ln(`DT_Output_5`.`P_1`) ELSE -1.79769313486231e+308 END AS `LogProba_CLASS_1`, NULL AS `Score_CLASS_2`, `DT_Output_5`.`P_2` AS `Proba_CLASS_2`, CASE WHEN (`DT_Output_5`.`P_2` IS NULL OR `DT_Output_5`.`P_2` > 0.0) THEN ln(`DT_Output_5`.`P_2`) ELSE -1.79769313486231e+308 END AS `LogProba_CLASS_2` 
FROM `DT_Output_5`), 
`DT_node_lookup_6` AS 
...
`BAG_Model_7` AS 
(SELECT `DT_Output_7`.`KEY` AS `KEY`, NULL AS `Score_CLASS_0`, `DT_Output_7`.`P_0` AS `Proba_CLASS_0`, CASE WHEN (`DT_Output_7`.`P_0` IS NULL OR `DT_Output_7`.`P_0` > 0.0) THEN ln(`DT_Output_7`.`P_0`) ELSE -1.79769313486231e+308 END AS `LogProba_CLASS_0`, NULL AS `Score_CLASS_1`, `DT_Output_7`.`P_1` AS `Proba_CLASS_1`, CASE WHEN (`DT_Output_7`.`P_1` IS NULL OR `DT_Output_7`.`P_1` > 0.0) THEN ln(`DT_Output_7`.`P_1`) ELSE -1.79769313486231e+308 END AS `LogProba_CLASS_1`, NULL AS `Score_CLASS_2`, `DT_Output_7`.`P_2` AS `Proba_CLASS_2`, CASE WHEN (`DT_Output_7`.`P_2` IS NULL OR `DT_Output_7`.`P_2` > 0.0) THEN ln(`DT_Output_7`.`P_2`) ELSE -1.79769313486231e+308 END AS `LogProba_CLASS_2` 
FROM `DT_Output_7`), 
`DT_node_lookup_8` AS 
...
-- Code For temporary table TMP_20180508190416_CODEGEN_N440MI_BAG_B1 part 1. Create 


CREATE TEMPORARY TABLE `TMP_20180508190416_CODEGEN_N440MI_BAG_B1` (
	`KEY` BIGINT, 
	`Score_CLASS_0` DOUBLE, 
	`Proba_CLASS_0` DOUBLE, 
	`LogProba_CLASS_0` DOUBLE, 
...
-- Code For temporary table TMP_20180508190416_CODEGEN_N440MI_BAG_B1 part 2. Populate

INSERT INTO `TMP_20180508190416_CODEGEN_N440MI_BAG_B1` (`KEY`, `Score_CLASS_0`, `Proba_CLASS_0`, `LogProba_CLASS_0`, `Score_CLASS_1`, `Proba_CLASS_1`, `LogProba_CLASS_1`, `Score_CLASS_2`, `Proba_CLASS_2`, `LogProba_CLASS_2`) SELECT `U`.`KEY`, `U`.`Score_CLASS_0`, `U`.`Proba_CLASS_0`, `U`.`LogProba_CLASS_0`, `U`.`Score_CLASS_1`, `U`.`Proba_CLASS_1`, `U`.`LogProba_CLASS_1`, `U`.`Score_CLASS_2`, `U`.`Proba_CLASS_2`, `U`.`LogProba_CLASS_2` 
...
`BAG_Model_10` AS 
(SELECT `DT_Output_10`.`KEY` AS `KEY`, NULL AS `Score_CLASS_0`, `DT_Output_10`.`P_0` AS `Proba_CLASS_0`, CASE WHEN (`DT_Output_10`.`P_0` IS NULL OR `DT_Output_10`.`P_0` > 0.0) THEN ln(`DT_Output_10`.`P_0`) ELSE -1.79769313486231e+308 END AS `LogProba_CLASS_0`, NULL AS `Score_CLASS_1`, `DT_Output_10`.`P_1` AS `Proba_CLASS_1`, CASE WHEN (`DT_Output_10`.`P_1` IS NULL OR `DT_Output_10`.`P_1` > 0.0) THEN ln(`DT_Output_10`.`P_1`) ELSE -1.79769313486231e+308 END AS `LogProba_CLASS_1`, NULL AS `Score_CLASS_2`, `DT_Output_10`.`P_2` AS `Proba_CLASS_2`, CASE WHEN (`DT_Output_10`.`P_2` IS NULL OR `DT_Output_10`.`P_2` > 0.0) THEN ln(`DT_Output_10`.`P_2`) ELSE -1.79769313486231e+308 END AS `LogProba_CLASS_2` 
FROM `DT_Output_10`), 
...
`BAG_Model_11` AS 
(SELECT `DT_Output_11`.`KEY` AS `KEY`, NULL AS `Score_CLASS_0`, `DT_Output_11`.`P_0` AS `Proba_CLASS_0`, CASE WHEN (`DT_Output_11`.`P_0` IS NULL OR `DT_Output_11`.`P_0` > 0.0) THEN ln(`DT_Output_11`.`P_0`) ELSE -1.79769313486231e+308 END AS `LogProba_CLASS_0`, NULL AS `Score_CLASS_1`, `DT_Output_11`.`P_1` AS `Proba_CLASS_1`, CASE WHEN (`DT_Output_11`.`P_1` IS NULL OR `DT_Output_11`.`P_1` > 0.0) THEN ln(`DT_Output_11`.`P_1`) ELSE -1.79769313486231e+308 END AS `LogProba_CLASS_1`, NULL AS `Score_CLASS_2`, `DT_Output_11`.`P_2` AS `Proba_CLASS_2`, CASE WHEN (`DT_Output_11`.`P_2` IS NULL OR `DT_Output_11`.`P_2` > 0.0) THEN ln(`DT_Output_11`.`P_2`) ELSE -1.79769313486231e+308 END AS `LogProba_CLASS_2` 
FROM `DT_Output_11`), 
...
`BAG_Model_12` AS 
(SELECT `DT_Output_12`.`KEY` AS `KEY`, NULL AS `Score_CLASS_0`, `DT_Output_12`.`P_0` AS `Proba_CLASS_0`, CASE WHEN (`DT_Output_12`.`P_0` IS NULL OR `DT_Output_12`.`P_0` > 0.0) THEN ln(`DT_Output_12`.`P_0`) ELSE -1.79769313486231e+308 END AS `LogProba_CLASS_0`, NULL AS `Score_CLASS_1`, `DT_Output_12`.`P_1` AS `Proba_CLASS_1`, CASE WHEN (`DT_Output_12`.`P_1` IS NULL OR `DT_Output_12`.`P_1` > 0.0) THEN ln(`DT_Output_12`.`P_1`) ELSE -1.79769313486231e+308 END AS `LogProba_CLASS_1`, NULL AS `Score_CLASS_2`, `DT_Output_12`.`P_2` AS `Proba_CLASS_2`, CASE WHEN (`DT_Output_12`.`P_2` IS NULL OR `DT_Output_12`.`P_2` > 0.0) THEN ln(`DT_Output_12`.`P_2`) ELSE -1.79769313486231e+308 END AS `LogProba_CLASS_2` 
FROM `DT_Output_12`), 
...
`BAG_Model_13` AS 
(SELECT `DT_Output_13`.`KEY` AS `KEY`, NULL AS `Score_CLASS_0`, `DT_Output_13`.`P_0` AS `Proba_CLASS_0`, CASE WHEN (`DT_Output_13`.`P_0` IS NULL OR `DT_Output_13`.`P_0` > 0.0) THEN ln(`DT_Output_13`.`P_0`) ELSE -1.79769313486231e+308 END AS `LogProba_CLASS_0`, NULL AS `Score_CLASS_1`, `DT_Output_13`.`P_1` AS `Proba_CLASS_1`, CASE WHEN (`DT_Output_13`.`P_1` IS NULL OR `DT_Output_13`.`P_1` > 0.0) THEN ln(`DT_Output_13`.`P_1`) ELSE -1.79769313486231e+308 END AS `LogProba_CLASS_1`, NULL AS `Score_CLASS_2`, `DT_Output_13`.`P_2` AS `Proba_CLASS_2`, CASE WHEN (`DT_Output_13`.`P_2` IS NULL OR `DT_Output_13`.`P_2` > 0.0) THEN ln(`DT_Output_13`.`P_2`) ELSE -1.79769313486231e+308 END AS `LogProba_CLASS_2` 
FROM `DT_Output_13`), 
...
`BAG_Model_14` AS 
(SELECT `DT_Output_14`.`KEY` AS `KEY`, NULL AS `Score_CLASS_0`, `DT_Output_14`.`P_0` AS `Proba_CLASS_0`, CASE WHEN (`DT_Output_14`.`P_0` IS NULL OR `DT_Output_14`.`P_0` > 0.0) THEN ln(`DT_Output_14`.`P_0`) ELSE -1.79769313486231e+308 END AS `LogProba_CLASS_0`, NULL AS `Score_CLASS_1`, `DT_Output_14`.`P_1` AS `Proba_CLASS_1`, CASE WHEN (`DT_Output_14`.`P_1` IS NULL OR `DT_Output_14`.`P_1` > 0.0) THEN ln(`DT_Output_14`.`P_1`) ELSE -1.79769313486231e+308 END AS `LogProba_CLASS_1`, NULL AS `Score_CLASS_2`, `DT_Output_14`.`P_2` AS `Proba_CLASS_2`, CASE WHEN (`DT_Output_14`.`P_2` IS NULL OR `DT_Output_14`.`P_2` > 0.0) THEN ln(`DT_Output_14`.`P_2`) ELSE -1.79769313486231e+308 END AS `LogProba_CLASS_2` 
FROM `DT_Output_14`), 
...
`BAG_Model_15` AS 
(SELECT `DT_Output_15`.`KEY` AS `KEY`, NULL AS `Score_CLASS_0`, `DT_Output_15`.`P_0` AS `Proba_CLASS_0`, CASE WHEN (`DT_Output_15`.`P_0` IS NULL OR `DT_Output_15`.`P_0` > 0.0) THEN ln(`DT_Output_15`.`P_0`) ELSE -1.79769313486231e+308 END AS `LogProba_CLASS_0`, NULL AS `Score_CLASS_1`, `DT_Output_15`.`P_1` AS `Proba_CLASS_1`, CASE WHEN (`DT_Output_15`.`P_1` IS NULL OR `DT_Output_15`.`P_1` > 0.0) THEN ln(`DT_Output_15`.`P_1`) ELSE -1.79769313486231e+308 END AS `LogProba_CLASS_1`, NULL AS `Score_CLASS_2`, `DT_Output_15`.`P_2` AS `Proba_CLASS_2`, CASE WHEN (`DT_Output_15`.`P_2` IS NULL OR `DT_Output_15`.`P_2` > 0.0) THEN ln(`DT_Output_15`.`P_2`) ELSE -1.79769313486231e+308 END AS `LogProba_CLASS_2` 
FROM `DT_Output_15`)
...
-- Code For temporary table TMP_20180508190416_CODEGEN_O0PGFB_BAG_Union part 1. Create 


CREATE TEMPORARY TABLE `TMP_20180508190416_CODEGEN_O0PGFB_BAG_Union` (
	`KEY` BIGINT, 
	`Score_CLASS_0` DOUBLE, 
	`Proba_CLASS_0` DOUBLE, 
	`LogProba_CLASS_0` DOUBLE, 
...
-- Code For temporary table TMP_20180508190416_CODEGEN_O0PGFB_BAG_Union part 2. Populate

INSERT INTO `TMP_20180508190416_CODEGEN_O0PGFB_BAG_Union` (`KEY`, `Score_CLASS_0`, `Proba_CLASS_0`, `LogProba_CLASS_0`, `Score_CLASS_1`, `Proba_CLASS_1`, `LogProba_CLASS_1`, `Score_CLASS_2`, `Proba_CLASS_2`, `LogProba_CLASS_2`) SELECT `U`.`KEY`, `U`.`Score_CLASS_0`, `U`.`Proba_CLASS_0`, `U`.`LogProba_CLASS_0`, `U`.`Score_CLASS_1`, `U`.`Proba_CLASS_1`, `U`.`LogProba_CLASS_1`, `U`.`Score_CLASS_2`, `U`.`Proba_CLASS_2`, `U`.`LogProba_CLASS_2` 
...
FROM `TMP_20180508190416_CODEGEN_C22ZR4_BAG_B0` AS `BAG_B0` UNION ALL SELECT `BAG_B1`.`KEY` AS `KEY`, `BAG_B1`.`Score_CLASS_0` AS `Score_CLASS_0`, `BAG_B1`.`Proba_CLASS_0` AS `Proba_CLASS_0`, `BAG_B1`.`LogProba_CLASS_0` AS `LogProba_CLASS_0`, `BAG_B1`.`Score_CLASS_1` AS `Score_CLASS_1`, `BAG_B1`.`Proba_CLASS_1` AS `Proba_CLASS_1`, `BAG_B1`.`LogProba_CLASS_1` AS `LogProba_CLASS_1`, `BAG_B1`.`Score_CLASS_2` AS `Score_CLASS_2`, `BAG_B1`.`Proba_CLASS_2` AS `Proba_CLASS_2`, `BAG_B1`.`LogProba_CLASS_2` AS `LogProba_CLASS_2` 
FROM `TMP_20180508190416_CODEGEN_N440MI_BAG_B1` AS `BAG_B1`) AS `BAG_EnsembleUnion`) AS `BAG_Union`) AS `U`

-- Code For temporary table TMP_20180508190416_CODEGEN_5P3W6W_BAG_avg part 1. Create 


CREATE TEMPORARY TABLE `TMP_20180508190416_CODEGEN_5P3W6W_BAG_avg` (
	`KEY` BIGINT NOT NULL, 
	`Score_CLASS_0` DOUBLE, 
	`Proba_CLASS_0` DOUBLE, 
	`LogProba_CLASS_0` DOUBLE, 
...
-- Code For temporary table TMP_20180508190416_CODEGEN_5P3W6W_BAG_avg part 2. Populate

INSERT INTO `TMP_20180508190416_CODEGEN_5P3W6W_BAG_avg` (`KEY`, `Score_CLASS_0`, `Proba_CLASS_0`, `LogProba_CLASS_0`, `Score_CLASS_1`, `Proba_CLASS_1`, `LogProba_CLASS_1`, `Score_CLASS_2`, `Proba_CLASS_2`, `LogProba_CLASS_2`) SELECT `U`.`KEY`, `U`.`Score_CLASS_0`, `U`.`Proba_CLASS_0`, `U`.`LogProba_CLASS_0`, `U`.`Score_CLASS_1`, `U`.`Proba_CLASS_1`, `U`.`LogProba_CLASS_1`, `U`.`Score_CLASS_2`, `U`.`Proba_CLASS_2`, `U`.`LogProba_CLASS_2` 
...
FROM (SELECT `BAG_Union`.`KEY` AS `KEY`, avg(`BAG_Union`.`Score_CLASS_0`) AS `Score_CLASS_0`, avg(`BAG_Union`.`Proba_CLASS_0`) AS `Proba_CLASS_0`, NULL AS `LogProba_CLASS_0`, avg(`BAG_Union`.`Score_CLASS_1`) AS `Score_CLASS_1`, avg(`BAG_Union`.`Proba_CLASS_1`) AS `Proba_CLASS_1`, NULL AS `LogProba_CLASS_1`, avg(`BAG_Union`.`Score_CLASS_2`) AS `Score_CLASS_2`, avg(`BAG_Union`.`Proba_CLASS_2`) AS `Proba_CLASS_2`, NULL AS `LogProba_CLASS_2` 
FROM `TMP_20180508190416_CODEGEN_O0PGFB_BAG_Union` AS `BAG_Union` GROUP BY `BAG_Union`.`KEY`) AS `T`) AS `BAG_avg`) AS `U`

-- Code For temporary table TMP_20180508190416_CODEGEN_5P3W6W_BAG_avg part 3. Create Index 

CREATE INDEX `ix_TMP_20180508190416_CODEGEN_5P3W6W_BAG_avg_KEY` ON `TMP_20180508190416_CODEGEN_5P3W6W_BAG_avg` (`KEY`)

-- Model deployment code

WITH orig_cte AS 
(SELECT `BAG_avg`.`KEY` AS `KEY`, `BAG_avg`.`Score_CLASS_0` AS `Score_CLASS_0`, `BAG_avg`.`Score_CLASS_1` AS `Score_CLASS_1`, `BAG_avg`.`Score_CLASS_2` AS `Score_CLASS_2`, `BAG_avg`.`Proba_CLASS_0` AS `Proba_CLASS_0`, `BAG_avg`.`Proba_CLASS_1` AS `Proba_CLASS_1`, `BAG_avg`.`Proba_CLASS_2` AS `Proba_CLASS_2`, `BAG_avg`.`LogProba_CLASS_0` AS `LogProba_CLASS_0`, `BAG_avg`.`LogProba_CLASS_1` AS `LogProba_CLASS_1`, `BAG_avg`.`LogProba_CLASS_2` AS `LogProba_CLASS_2`, CAST(NULL AS SIGNED INTEGER) AS `Decision`, NULL AS `DecisionProba` 
FROM `TMP_20180508190416_CODEGEN_5P3W6W_BAG_avg` AS `BAG_avg`), 
