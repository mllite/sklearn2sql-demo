...
-- Code For temporary table TMP_20180508180622_CODEGEN_VIHI part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508180622_CODEGEN_VIHI" (
	"KEY" BIGINT, 
...
-- Code For temporary table TMP_20180508180622_CODEGEN_VIHI part 2. Populate

INSERT INTO "TMP_20180508180622_CODEGEN_VIHI" ("KEY", "Score_0", "Proba_0", "LogProba_0", "Score_1", "Proba_1", "LogProba_1") SELECT "U"."KEY", "U"."Score_0", "U"."Proba_0", "U"."LogProba_0", "U"."Score_1", "U"."Proba_1", "U"."LogProba_1" 
...
-- Code For temporary table TMP_20180508180622_CODEGEN_NHCS part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508180622_CODEGEN_NHCS" (
	"KEY" BIGINT, 
	"Score_0" DOUBLE PRECISION, 
	"Proba_0" DOUBLE PRECISION, 
	"LogProba_0" DOUBLE PRECISION, 
...
-- Code For temporary table TMP_20180508180622_CODEGEN_NHCS part 2. Populate

INSERT INTO "TMP_20180508180622_CODEGEN_NHCS" ("KEY", "Score_0", "Proba_0", "LogProba_0", "Score_1", "Proba_1", "LogProba_1") SELECT "U"."KEY", "U"."Score_0", "U"."Proba_0", "U"."LogProba_0", "U"."Score_1", "U"."Proba_1", "U"."LogProba_1" 
...
-- Code For temporary table TMP_20180508180622_CODEGEN_AVC1 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508180622_CODEGEN_AVC1" (
	"KEY" BIGINT, 
	"Score_0" DOUBLE PRECISION, 
	"Proba_0" DOUBLE PRECISION, 
	"LogProba_0" DOUBLE PRECISION, 
...
-- Code For temporary table TMP_20180508180622_CODEGEN_AVC1 part 2. Populate

INSERT INTO "TMP_20180508180622_CODEGEN_AVC1" ("KEY", "Score_0", "Proba_0", "LogProba_0", "Score_1", "Proba_1", "LogProba_1") SELECT "U"."KEY", "U"."Score_0", "U"."Proba_0", "U"."LogProba_0", "U"."Score_1", "U"."Proba_1", "U"."LogProba_1" 
...
FROM "TMP_20180508180622_CODEGEN_VIHI" AS "BAG_B0" UNION ALL SELECT "BAG_B1"."KEY" AS "KEY", "BAG_B1"."Score_0" AS "Score_0", "BAG_B1"."Proba_0" AS "Proba_0", "BAG_B1"."LogProba_0" AS "LogProba_0", "BAG_B1"."Score_1" AS "Score_1", "BAG_B1"."Proba_1" AS "Proba_1", "BAG_B1"."LogProba_1" AS "LogProba_1" 
FROM "TMP_20180508180622_CODEGEN_NHCS" AS "BAG_B1") AS "BAG_EnsembleUnion") AS "BAG_Union") AS "U"

-- Code For temporary table TMP_20180508180622_CODEGEN_5LT1 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508180622_CODEGEN_5LT1" (
	"KEY" BIGINT NOT NULL, 
	"Score_0" DOUBLE PRECISION, 
	"Proba_0" DOUBLE PRECISION, 
	"LogProba_0" DOUBLE PRECISION, 
...
-- Code For temporary table TMP_20180508180622_CODEGEN_5LT1 part 2. Populate

INSERT INTO "TMP_20180508180622_CODEGEN_5LT1" ("KEY", "Score_0", "Proba_0", "LogProba_0", "Score_1", "Proba_1", "LogProba_1") SELECT "U"."KEY", "U"."Score_0", "U"."Proba_0", "U"."LogProba_0", "U"."Score_1", "U"."Proba_1", "U"."LogProba_1" 
...
FROM "TMP_20180508180622_CODEGEN_AVC1" AS "BAG_Union" GROUP BY "BAG_Union"."KEY") AS "T") AS "BAG_avg") AS "U"

-- Code For temporary table TMP_20180508180622_CODEGEN_5LT1 part 3. Create Index 

CREATE INDEX "ix_TMP_20180508180622_C_3dc1" ON "TMP_20180508180622_CODEGEN_5LT1" ("KEY")
...
FROM "TMP_20180508180622_CODEGEN_5LT1" AS "BAG_avg"), 
