...
-- Code For temporary table TMP_20180508180131_CODEGEN_ERZV part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508180131_CODEGEN_ERZV" (
	"KEY" BIGINT, 
...
-- Code For temporary table TMP_20180508180131_CODEGEN_ERZV part 2. Populate

INSERT INTO "TMP_20180508180131_CODEGEN_ERZV" ("KEY", "Score_0", "Proba_0", "LogProba_0", "Score_1", "Proba_1", "LogProba_1") SELECT "U"."KEY", "U"."Score_0", "U"."Proba_0", "U"."LogProba_0", "U"."Score_1", "U"."Proba_1", "U"."LogProba_1" 
...
-- Code For temporary table TMP_20180508180131_CODEGEN_SNG0 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508180131_CODEGEN_SNG0" (
	"KEY" BIGINT, 
	"Score_0" DOUBLE PRECISION, 
	"Proba_0" DOUBLE PRECISION, 
	"LogProba_0" DOUBLE PRECISION, 
...
-- Code For temporary table TMP_20180508180131_CODEGEN_SNG0 part 2. Populate

INSERT INTO "TMP_20180508180131_CODEGEN_SNG0" ("KEY", "Score_0", "Proba_0", "LogProba_0", "Score_1", "Proba_1", "LogProba_1") SELECT "U"."KEY", "U"."Score_0", "U"."Proba_0", "U"."LogProba_0", "U"."Score_1", "U"."Proba_1", "U"."LogProba_1" 
...
-- Code For temporary table TMP_20180508180131_CODEGEN_B4FQ part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508180131_CODEGEN_B4FQ" (
	"KEY" BIGINT, 
	"Score_0" DOUBLE PRECISION, 
	"Proba_0" DOUBLE PRECISION, 
	"LogProba_0" DOUBLE PRECISION, 
...
-- Code For temporary table TMP_20180508180131_CODEGEN_B4FQ part 2. Populate

INSERT INTO "TMP_20180508180131_CODEGEN_B4FQ" ("KEY", "Score_0", "Proba_0", "LogProba_0", "Score_1", "Proba_1", "LogProba_1") SELECT "U"."KEY", "U"."Score_0", "U"."Proba_0", "U"."LogProba_0", "U"."Score_1", "U"."Proba_1", "U"."LogProba_1" 
...
FROM "TMP_20180508180131_CODEGEN_ERZV" AS "BAG_B0" UNION ALL SELECT "BAG_B1"."KEY" AS "KEY", "BAG_B1"."Score_0" AS "Score_0", "BAG_B1"."Proba_0" AS "Proba_0", "BAG_B1"."LogProba_0" AS "LogProba_0", "BAG_B1"."Score_1" AS "Score_1", "BAG_B1"."Proba_1" AS "Proba_1", "BAG_B1"."LogProba_1" AS "LogProba_1" 
FROM "TMP_20180508180131_CODEGEN_SNG0" AS "BAG_B1") AS "BAG_EnsembleUnion") AS "BAG_Union") AS "U"

-- Code For temporary table TMP_20180508180131_CODEGEN_8HQ8 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508180131_CODEGEN_8HQ8" (
	"KEY" BIGINT NOT NULL, 
	"Score_0" DOUBLE PRECISION, 
	"Proba_0" DOUBLE PRECISION, 
	"LogProba_0" DOUBLE PRECISION, 
...
-- Code For temporary table TMP_20180508180131_CODEGEN_8HQ8 part 2. Populate

INSERT INTO "TMP_20180508180131_CODEGEN_8HQ8" ("KEY", "Score_0", "Proba_0", "LogProba_0", "Score_1", "Proba_1", "LogProba_1") SELECT "U"."KEY", "U"."Score_0", "U"."Proba_0", "U"."LogProba_0", "U"."Score_1", "U"."Proba_1", "U"."LogProba_1" 
...
FROM "TMP_20180508180131_CODEGEN_B4FQ" AS "BAG_Union" GROUP BY "BAG_Union"."KEY") AS "T") AS "BAG_avg") AS "U"

-- Code For temporary table TMP_20180508180131_CODEGEN_8HQ8 part 3. Create Index 

CREATE INDEX "ix_TMP_20180508180131_C_5c0d" ON "TMP_20180508180131_CODEGEN_8HQ8" ("KEY")
...
FROM "TMP_20180508180131_CODEGEN_8HQ8" AS "BAG_avg"), 
