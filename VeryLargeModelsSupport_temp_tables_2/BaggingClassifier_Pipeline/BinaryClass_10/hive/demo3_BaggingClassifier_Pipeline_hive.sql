...
-- Code For temporary table tmp_20180509001743_codegen_bs5fil_ads_imp_1_out part 1. Create 

CREATE TEMPORARY TABLE `tmp_20180509001743_codegen_bs5fil_ads_imp_1_out` STORED AS ORC AS SELECT `ADS_imp_1_OUT`.`KEY`, `ADS_imp_1_OUT`.`impter_2`, `ADS_imp_1_OUT`.`impter_3`, `ADS_imp_1_OUT`.`impter_4`, `ADS_imp_1_OUT`.`impter_5`, `ADS_imp_1_OUT`.`impter_6`, `ADS_imp_1_OUT`.`impter_7`, `ADS_imp_1_OUT`.`impter_8`, `ADS_imp_1_OUT`.`impter_9`, `ADS_imp_1_OUT`.`impter_10`, `ADS_imp_1_OUT`.`impter_11` 
...
-- Code For temporary table tmp_20180509001743_codegen_bs5fil_ads_imp_1_out part 2. Populate

SELECT * FROM `tmp_20180509001743_codegen_bs5fil_ads_imp_1_out`

-- Code For temporary table tmp_20180509001743_codegen_eu5r7n_ads_sca_2_out part 1. Create 

CREATE TEMPORARY TABLE `tmp_20180509001743_codegen_eu5r7n_ads_sca_2_out` STORED AS ORC AS SELECT `ADS_sca_2_OUT`.`KEY`, `ADS_sca_2_OUT`.`scaler_2`, `ADS_sca_2_OUT`.`scaler_3`, `ADS_sca_2_OUT`.`scaler_4`, `ADS_sca_2_OUT`.`scaler_5`, `ADS_sca_2_OUT`.`scaler_6`, `ADS_sca_2_OUT`.`scaler_7`, `ADS_sca_2_OUT`.`scaler_8`, `ADS_sca_2_OUT`.`scaler_9`, `ADS_sca_2_OUT`.`scaler_10`, `ADS_sca_2_OUT`.`scaler_11` 
...
FROM `tmp_20180509001743_codegen_bs5fil_ads_imp_1_out` AS `ADS_imp_1_OUT`) AS `ADS_sca_2_OUT`

-- Code For temporary table tmp_20180509001743_codegen_eu5r7n_ads_sca_2_out part 2. Populate

SELECT * FROM `tmp_20180509001743_codegen_eu5r7n_ads_sca_2_out`

-- Code For temporary table tmp_20180509001744_codegen_do67tf_bag_b0 part 1. Create 

CREATE TEMPORARY TABLE `tmp_20180509001744_codegen_do67tf_bag_b0` STORED AS ORC AS WITH `DT_node_lookup` AS 
...
FROM `tmp_20180509001743_codegen_eu5r7n_ads_sca_2_out` AS `ADS_sca_2_OUT`), 
`DT_node_data` AS 
...
-- Code For temporary table tmp_20180509001744_codegen_do67tf_bag_b0 part 2. Populate

SELECT * FROM `tmp_20180509001744_codegen_do67tf_bag_b0`

-- Code For temporary table tmp_20180509001744_codegen_83shed_bag_b1 part 1. Create 

CREATE TEMPORARY TABLE `tmp_20180509001744_codegen_83shed_bag_b1` STORED AS ORC AS WITH `DT_node_lookup_10` AS 
...
-- Code For temporary table tmp_20180509001744_codegen_83shed_bag_b1 part 2. Populate

SELECT * FROM `tmp_20180509001744_codegen_83shed_bag_b1`

-- Code For temporary table tmp_20180509001744_codegen_3xcw9l_bag_union part 1. Create 

CREATE TEMPORARY TABLE `tmp_20180509001744_codegen_3xcw9l_bag_union` STORED AS ORC AS SELECT `BAG_Union`.`KEY`, `BAG_Union`.`Score_0`, `BAG_Union`.`Proba_0`, `BAG_Union`.`LogProba_0`, `BAG_Union`.`Score_1`, `BAG_Union`.`Proba_1`, `BAG_Union`.`LogProba_1` 
...
FROM `tmp_20180509001744_codegen_do67tf_bag_b0` AS `BAG_B0` UNION ALL SELECT `BAG_B1`.`KEY` AS `KEY`, `BAG_B1`.`Score_0` AS `Score_0`, `BAG_B1`.`Proba_0` AS `Proba_0`, `BAG_B1`.`LogProba_0` AS `LogProba_0`, `BAG_B1`.`Score_1` AS `Score_1`, `BAG_B1`.`Proba_1` AS `Proba_1`, `BAG_B1`.`LogProba_1` AS `LogProba_1` 
FROM `tmp_20180509001744_codegen_83shed_bag_b1` AS `BAG_B1`) AS `BAG_EnsembleUnion`) AS `BAG_Union`

-- Code For temporary table tmp_20180509001744_codegen_3xcw9l_bag_union part 2. Populate

SELECT * FROM `tmp_20180509001744_codegen_3xcw9l_bag_union`

-- Code For temporary table tmp_20180509001744_codegen_5mp7g9_bag_avg part 1. Create 

CREATE TEMPORARY TABLE `tmp_20180509001744_codegen_5mp7g9_bag_avg` STORED AS ORC AS SELECT `BAG_avg`.`KEY`, `BAG_avg`.`Score_0`, `BAG_avg`.`Proba_0`, `BAG_avg`.`LogProba_0`, `BAG_avg`.`Score_1`, `BAG_avg`.`Proba_1`, `BAG_avg`.`LogProba_1` 
...
FROM `tmp_20180509001744_codegen_3xcw9l_bag_union` AS `BAG_Union` GROUP BY `BAG_Union`.`KEY`) AS `T`) AS `BAG_avg`

-- Code For temporary table tmp_20180509001744_codegen_5mp7g9_bag_avg part 2. Populate

SELECT * FROM `tmp_20180509001744_codegen_5mp7g9_bag_avg`
...
FROM `tmp_20180509001744_codegen_5mp7g9_bag_avg` AS `BAG_avg`), 
