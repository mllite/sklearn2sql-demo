...
-- Code For temporary table TMP_20180508180629_CODEGEN_MTCJ part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508180629_CODEGEN_MTCJ" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20180508180629_CODEGEN_MTCJ part 3. Create Index 

CREATE INDEX "ix_TMP_20180508180629_C_06cb" ON "TMP_20180508180629_CODEGEN_MTCJ" ("KEY")

-- Code For temporary table TMP_20180508180629_CODEGEN_I0W6 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508180629_CODEGEN_I0W6" (
	"KEY" BIGINT NOT NULL, 
...
FROM "TMP_20180508180629_CODEGEN_MTCJ" AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT") AS "U"

-- Code For temporary table TMP_20180508180629_CODEGEN_I0W6 part 3. Create Index 

CREATE INDEX "ix_TMP_20180508180629_C_caa4" ON "TMP_20180508180629_CODEGEN_I0W6" ("KEY")

-- Code For temporary table TMP_20180508180629_CODEGEN_U0W4 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508180629_CODEGEN_U0W4" (
	"KEY" BIGINT, 
...
-- Code For temporary table TMP_20180508180629_CODEGEN_U0W4 part 2. Populate

INSERT INTO "TMP_20180508180629_CODEGEN_U0W4" ("KEY", "Score_0", "Proba_0", "LogProba_0", "Score_1", "Proba_1", "LogProba_1") SELECT "U"."KEY", "U"."Score_0", "U"."Proba_0", "U"."LogProba_0", "U"."Score_1", "U"."Proba_1", "U"."LogProba_1" 
...
FROM "TMP_20180508180629_CODEGEN_I0W6" AS "ADS_sca_2_OUT"), 
"DT_node_data" AS 
...
-- Code For temporary table TMP_20180508180629_CODEGEN_UZOL part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508180629_CODEGEN_UZOL" (
	"KEY" BIGINT, 
	"Score_0" DOUBLE PRECISION, 
	"Proba_0" DOUBLE PRECISION, 
	"LogProba_0" DOUBLE PRECISION, 
...
-- Code For temporary table TMP_20180508180629_CODEGEN_UZOL part 2. Populate

INSERT INTO "TMP_20180508180629_CODEGEN_UZOL" ("KEY", "Score_0", "Proba_0", "LogProba_0", "Score_1", "Proba_1", "LogProba_1") SELECT "U"."KEY", "U"."Score_0", "U"."Proba_0", "U"."LogProba_0", "U"."Score_1", "U"."Proba_1", "U"."LogProba_1" 
...
-- Code For temporary table TMP_20180508180629_CODEGEN_EAXO part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508180629_CODEGEN_EAXO" (
	"KEY" BIGINT, 
	"Score_0" DOUBLE PRECISION, 
	"Proba_0" DOUBLE PRECISION, 
	"LogProba_0" DOUBLE PRECISION, 
...
-- Code For temporary table TMP_20180508180629_CODEGEN_EAXO part 2. Populate

INSERT INTO "TMP_20180508180629_CODEGEN_EAXO" ("KEY", "Score_0", "Proba_0", "LogProba_0", "Score_1", "Proba_1", "LogProba_1") SELECT "U"."KEY", "U"."Score_0", "U"."Proba_0", "U"."LogProba_0", "U"."Score_1", "U"."Proba_1", "U"."LogProba_1" 
...
FROM "TMP_20180508180629_CODEGEN_U0W4" AS "BAG_B0" UNION ALL SELECT "BAG_B1"."KEY" AS "KEY", "BAG_B1"."Score_0" AS "Score_0", "BAG_B1"."Proba_0" AS "Proba_0", "BAG_B1"."LogProba_0" AS "LogProba_0", "BAG_B1"."Score_1" AS "Score_1", "BAG_B1"."Proba_1" AS "Proba_1", "BAG_B1"."LogProba_1" AS "LogProba_1" 
FROM "TMP_20180508180629_CODEGEN_UZOL" AS "BAG_B1") AS "BAG_EnsembleUnion") AS "BAG_Union") AS "U"

-- Code For temporary table TMP_20180508180629_CODEGEN_3BXA part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508180629_CODEGEN_3BXA" (
	"KEY" BIGINT NOT NULL, 
	"Score_0" DOUBLE PRECISION, 
	"Proba_0" DOUBLE PRECISION, 
	"LogProba_0" DOUBLE PRECISION, 
...
-- Code For temporary table TMP_20180508180629_CODEGEN_3BXA part 2. Populate

INSERT INTO "TMP_20180508180629_CODEGEN_3BXA" ("KEY", "Score_0", "Proba_0", "LogProba_0", "Score_1", "Proba_1", "LogProba_1") SELECT "U"."KEY", "U"."Score_0", "U"."Proba_0", "U"."LogProba_0", "U"."Score_1", "U"."Proba_1", "U"."LogProba_1" 
...
FROM "TMP_20180508180629_CODEGEN_EAXO" AS "BAG_Union" GROUP BY "BAG_Union"."KEY") AS "T") AS "BAG_avg") AS "U"

-- Code For temporary table TMP_20180508180629_CODEGEN_3BXA part 3. Create Index 

CREATE INDEX "ix_TMP_20180508180629_C_efd2" ON "TMP_20180508180629_CODEGEN_3BXA" ("KEY")
...
FROM "TMP_20180508180629_CODEGEN_3BXA" AS "BAG_avg"), 
