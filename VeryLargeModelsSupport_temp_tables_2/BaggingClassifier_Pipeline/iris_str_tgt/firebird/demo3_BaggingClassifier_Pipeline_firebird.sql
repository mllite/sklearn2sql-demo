...
-- Code For temporary table TMP_20180508190424_CODEGEN_CYE8 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508190424_CODEGEN_CYE8" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20180508190424_CODEGEN_CYE8 part 2. Populate

INSERT INTO "TMP_20180508190424_CODEGEN_CYE8" ("KEY", imputer_output_2, imputer_output_3, imputer_output_4, imputer_output_5) SELECT "U"."KEY", "U".imputer_output_2, "U".imputer_output_3, "U".imputer_output_4, "U".imputer_output_5 
...
-- Code For temporary table TMP_20180508190424_CODEGEN_CYE8 part 3. Create Index 

CREATE INDEX "ix_TMP_20180508190424_C_347f" ON "TMP_20180508190424_CODEGEN_CYE8" ("KEY")

-- Code For temporary table TMP_20180508190424_CODEGEN_3IVI part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508190424_CODEGEN_3IVI" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20180508190424_CODEGEN_3IVI part 2. Populate

INSERT INTO "TMP_20180508190424_CODEGEN_3IVI" ("KEY", scaler_output_2, scaler_output_3, scaler_output_4, scaler_output_5) SELECT "U"."KEY", "U".scaler_output_2, "U".scaler_output_3, "U".scaler_output_4, "U".scaler_output_5 
...
FROM "TMP_20180508190424_CODEGEN_CYE8" AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT") AS "U"

-- Code For temporary table TMP_20180508190424_CODEGEN_3IVI part 3. Create Index 

CREATE INDEX "ix_TMP_20180508190424_C_30eb" ON "TMP_20180508190424_CODEGEN_3IVI" ("KEY")

-- Code For temporary table TMP_20180508190424_CODEGEN_VQLW part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508190424_CODEGEN_VQLW" (
	"KEY" BIGINT, 
...
FROM "TMP_20180508190424_CODEGEN_3IVI" AS "ADS_sca_2_OUT"), 
"DT_node_data" AS 
...
-- Code For temporary table TMP_20180508190424_CODEGEN_TMFD part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508190424_CODEGEN_TMFD" (
	"KEY" BIGINT, 
	"Score_CLASS_0" DOUBLE PRECISION, 
	"Proba_CLASS_0" DOUBLE PRECISION, 
	"LogProba_CLASS_0" DOUBLE PRECISION, 
...
-- Code For temporary table TMP_20180508190424_CODEGEN_TMFD part 2. Populate

INSERT INTO "TMP_20180508190424_CODEGEN_TMFD" ("KEY", "Score_CLASS_0", "Proba_CLASS_0", "LogProba_CLASS_0", "Score_CLASS_1", "Proba_CLASS_1", "LogProba_CLASS_1", "Score_CLASS_2", "Proba_CLASS_2", "LogProba_CLASS_2") SELECT "U"."KEY", "U"."Score_CLASS_0", "U"."Proba_CLASS_0", "U"."LogProba_CLASS_0", "U"."Score_CLASS_1", "U"."Proba_CLASS_1", "U"."LogProba_CLASS_1", "U"."Score_CLASS_2", "U"."Proba_CLASS_2", "U"."LogProba_CLASS_2" 
...
-- Code For temporary table TMP_20180508190424_CODEGEN_XDSV part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508190424_CODEGEN_XDSV" (
	"KEY" BIGINT, 
	"Score_CLASS_0" DOUBLE PRECISION, 
	"Proba_CLASS_0" DOUBLE PRECISION, 
	"LogProba_CLASS_0" DOUBLE PRECISION, 
...
-- Code For temporary table TMP_20180508190424_CODEGEN_XDSV part 2. Populate

INSERT INTO "TMP_20180508190424_CODEGEN_XDSV" ("KEY", "Score_CLASS_0", "Proba_CLASS_0", "LogProba_CLASS_0", "Score_CLASS_1", "Proba_CLASS_1", "LogProba_CLASS_1", "Score_CLASS_2", "Proba_CLASS_2", "LogProba_CLASS_2") SELECT "U"."KEY", "U"."Score_CLASS_0", "U"."Proba_CLASS_0", "U"."LogProba_CLASS_0", "U"."Score_CLASS_1", "U"."Proba_CLASS_1", "U"."LogProba_CLASS_1", "U"."Score_CLASS_2", "U"."Proba_CLASS_2", "U"."LogProba_CLASS_2" 
...
FROM "TMP_20180508190424_CODEGEN_VQLW" AS "BAG_B0" UNION ALL SELECT "BAG_B1"."KEY" AS "KEY", "BAG_B1"."Score_CLASS_0" AS "Score_CLASS_0", "BAG_B1"."Proba_CLASS_0" AS "Proba_CLASS_0", "BAG_B1"."LogProba_CLASS_0" AS "LogProba_CLASS_0", "BAG_B1"."Score_CLASS_1" AS "Score_CLASS_1", "BAG_B1"."Proba_CLASS_1" AS "Proba_CLASS_1", "BAG_B1"."LogProba_CLASS_1" AS "LogProba_CLASS_1", "BAG_B1"."Score_CLASS_2" AS "Score_CLASS_2", "BAG_B1"."Proba_CLASS_2" AS "Proba_CLASS_2", "BAG_B1"."LogProba_CLASS_2" AS "LogProba_CLASS_2" 
FROM "TMP_20180508190424_CODEGEN_TMFD" AS "BAG_B1") AS "BAG_EnsembleUnion") AS "BAG_Union") AS "U"

-- Code For temporary table TMP_20180508190424_CODEGEN_PPIK part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508190424_CODEGEN_PPIK" (
	"KEY" BIGINT NOT NULL, 
	"Score_CLASS_0" DOUBLE PRECISION, 
	"Proba_CLASS_0" DOUBLE PRECISION, 
	"LogProba_CLASS_0" DOUBLE PRECISION, 
...
-- Code For temporary table TMP_20180508190424_CODEGEN_PPIK part 2. Populate

INSERT INTO "TMP_20180508190424_CODEGEN_PPIK" ("KEY", "Score_CLASS_0", "Proba_CLASS_0", "LogProba_CLASS_0", "Score_CLASS_1", "Proba_CLASS_1", "LogProba_CLASS_1", "Score_CLASS_2", "Proba_CLASS_2", "LogProba_CLASS_2") SELECT "U"."KEY", "U"."Score_CLASS_0", "U"."Proba_CLASS_0", "U"."LogProba_CLASS_0", "U"."Score_CLASS_1", "U"."Proba_CLASS_1", "U"."LogProba_CLASS_1", "U"."Score_CLASS_2", "U"."Proba_CLASS_2", "U"."LogProba_CLASS_2" 
...
FROM "TMP_20180508190424_CODEGEN_XDSV" AS "BAG_Union" GROUP BY "BAG_Union"."KEY") AS "T") AS "BAG_avg") AS "U"

-- Code For temporary table TMP_20180508190424_CODEGEN_PPIK part 3. Create Index 

CREATE INDEX "ix_TMP_20180508190424_C_4a71" ON "TMP_20180508190424_CODEGEN_PPIK" ("KEY")
...
FROM "TMP_20180508190424_CODEGEN_PPIK" AS "BAG_avg"), 
