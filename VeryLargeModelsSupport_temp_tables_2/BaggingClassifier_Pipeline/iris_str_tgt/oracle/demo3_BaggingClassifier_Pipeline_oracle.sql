...
-- Code For temporary table DEGEN_EHGK0N_ADS_IMP_1_OUT part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "DEGEN_EHGK0N_ADS_IMP_1_OUT" (
	"KEY" NUMBER(19), 
...
-- Code For temporary table DEGEN_EHGK0N_ADS_IMP_1_OUT part 2. Populate

INSERT INTO "DEGEN_EHGK0N_ADS_IMP_1_OUT" ("KEY", imputer_output_2, imputer_output_3, imputer_output_4, imputer_output_5) SELECT "U"."KEY", "U".imputer_output_2, "U".imputer_output_3, "U".imputer_output_4, "U".imputer_output_5 
...
-- Code For temporary table DEGEN_6QABK2_ADS_SCA_2_OUT part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "DEGEN_6QABK2_ADS_SCA_2_OUT" (
	"KEY" NUMBER(19), 
...
-- Code For temporary table DEGEN_6QABK2_ADS_SCA_2_OUT part 2. Populate

INSERT INTO "DEGEN_6QABK2_ADS_SCA_2_OUT" ("KEY", scaler_output_2, scaler_output_3, scaler_output_4, scaler_output_5) SELECT "U"."KEY", "U".scaler_output_2, "U".scaler_output_3, "U".scaler_output_4, "U".scaler_output_5 
...
FROM "DEGEN_EHGK0N_ADS_IMP_1_OUT" "ADS_imp_1_OUT") "ADS_sca_2_OUT") "U"

-- Code For temporary table 0423_CODEGEN_MV6I1X_BAG_B0 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "0423_CODEGEN_MV6I1X_BAG_B0" (
	"KEY" NUMBER(19), 
...
FROM "DEGEN_6QABK2_ADS_SCA_2_OUT" "ADS_sca_2_OUT"), 
"DT_node_data" AS 
...
-- Code For temporary table 0423_CODEGEN_9ORZ9Z_BAG_B1 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "0423_CODEGEN_9ORZ9Z_BAG_B1" (
	"KEY" NUMBER(19), 
	"Score_CLASS_0" BINARY_DOUBLE, 
	"Proba_CLASS_0" BINARY_DOUBLE, 
	"LogProba_CLASS_0" BINARY_DOUBLE, 
...
-- Code For temporary table 0423_CODEGEN_9ORZ9Z_BAG_B1 part 2. Populate

INSERT INTO "0423_CODEGEN_9ORZ9Z_BAG_B1" ("KEY", "Score_CLASS_0", "Proba_CLASS_0", "LogProba_CLASS_0", "Score_CLASS_1", "Proba_CLASS_1", "LogProba_CLASS_1", "Score_CLASS_2", "Proba_CLASS_2", "LogProba_CLASS_2") SELECT "U"."KEY", "U"."Score_CLASS_0", "U"."Proba_CLASS_0", "U"."LogProba_CLASS_0", "U"."Score_CLASS_1", "U"."Proba_CLASS_1", "U"."LogProba_CLASS_1", "U"."Score_CLASS_2", "U"."Proba_CLASS_2", "U"."LogProba_CLASS_2" 
...
-- Code For temporary table 3_CODEGEN_MJ83F1_BAG_UNION part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "3_CODEGEN_MJ83F1_BAG_UNION" (
	"KEY" NUMBER(19), 
	"Score_CLASS_0" BINARY_DOUBLE, 
	"Proba_CLASS_0" BINARY_DOUBLE, 
	"LogProba_CLASS_0" BINARY_DOUBLE, 
...
-- Code For temporary table 3_CODEGEN_MJ83F1_BAG_UNION part 2. Populate

INSERT INTO "3_CODEGEN_MJ83F1_BAG_UNION" ("KEY", "Score_CLASS_0", "Proba_CLASS_0", "LogProba_CLASS_0", "Score_CLASS_1", "Proba_CLASS_1", "LogProba_CLASS_1", "Score_CLASS_2", "Proba_CLASS_2", "LogProba_CLASS_2") SELECT "U"."KEY", "U"."Score_CLASS_0", "U"."Proba_CLASS_0", "U"."LogProba_CLASS_0", "U"."Score_CLASS_1", "U"."Proba_CLASS_1", "U"."LogProba_CLASS_1", "U"."Score_CLASS_2", "U"."Proba_CLASS_2", "U"."LogProba_CLASS_2" 
...
FROM "0423_CODEGEN_MV6I1X_BAG_B0" "BAG_B0" UNION ALL SELECT "BAG_B1"."KEY" AS "KEY", "BAG_B1"."Score_CLASS_0" AS "Score_CLASS_0", "BAG_B1"."Proba_CLASS_0" AS "Proba_CLASS_0", "BAG_B1"."LogProba_CLASS_0" AS "LogProba_CLASS_0", "BAG_B1"."Score_CLASS_1" AS "Score_CLASS_1", "BAG_B1"."Proba_CLASS_1" AS "Proba_CLASS_1", "BAG_B1"."LogProba_CLASS_1" AS "LogProba_CLASS_1", "BAG_B1"."Score_CLASS_2" AS "Score_CLASS_2", "BAG_B1"."Proba_CLASS_2" AS "Proba_CLASS_2", "BAG_B1"."LogProba_CLASS_2" AS "LogProba_CLASS_2" 
FROM "0423_CODEGEN_9ORZ9Z_BAG_B1" "BAG_B1") "BAG_EnsembleUnion") "BAG_Union") "U"

-- Code For temporary table 423_CODEGEN_IEIJYF_BAG_AVG part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "423_CODEGEN_IEIJYF_BAG_AVG" (
	"KEY" NUMBER(19), 
	"Score_CLASS_0" BINARY_DOUBLE, 
	"Proba_CLASS_0" BINARY_DOUBLE, 
	"LogProba_CLASS_0" BINARY_DOUBLE, 
...
-- Code For temporary table 423_CODEGEN_IEIJYF_BAG_AVG part 2. Populate

INSERT INTO "423_CODEGEN_IEIJYF_BAG_AVG" ("KEY", "Score_CLASS_0", "Proba_CLASS_0", "LogProba_CLASS_0", "Score_CLASS_1", "Proba_CLASS_1", "LogProba_CLASS_1", "Score_CLASS_2", "Proba_CLASS_2", "LogProba_CLASS_2") SELECT "U"."KEY", "U"."Score_CLASS_0", "U"."Proba_CLASS_0", "U"."LogProba_CLASS_0", "U"."Score_CLASS_1", "U"."Proba_CLASS_1", "U"."LogProba_CLASS_1", "U"."Score_CLASS_2", "U"."Proba_CLASS_2", "U"."LogProba_CLASS_2" 
...
FROM "3_CODEGEN_MJ83F1_BAG_UNION" "BAG_Union" GROUP BY "BAG_Union"."KEY") "T") "BAG_avg") "U"
...
FROM "423_CODEGEN_IEIJYF_BAG_AVG" "BAG_avg"), 
