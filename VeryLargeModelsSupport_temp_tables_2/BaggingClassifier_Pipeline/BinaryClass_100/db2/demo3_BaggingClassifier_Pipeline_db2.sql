...
-- Code For temporary table tmp_20180508180141_codegen_4qjxlt_ads_imp_1_out part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180508180141_codegen_4qjxlt_ads_imp_1_out (
	"KEY" BIGINT, 
	impter_2 DOUBLE, 
	impter_3 DOUBLE, 
	impter_4 DOUBLE, 
...
-- Code For temporary table tmp_20180508180141_codegen_12l9vh_ads_sca_2_out part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180508180141_codegen_12l9vh_ads_sca_2_out (
	"KEY" BIGINT, 
	scaler_2 DOUBLE, 
	scaler_3 DOUBLE, 
	scaler_4 DOUBLE, 
...
FROM tmp_20180508180141_codegen_4qjxlt_ads_imp_1_out AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT"

-- Code For temporary table tmp_20180508180141_codegen_c5qzgg_bag_b0 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180508180141_codegen_c5qzgg_bag_b0 (
	"KEY" BIGINT, 
	"Score_0" DOUBLE, 
	"Proba_0" DOUBLE, 
	"LogProba_0" DOUBLE, 
...
-- Code For temporary table tmp_20180508180141_codegen_c5qzgg_bag_b0 part 2. Populate

INSERT INTO tmp_20180508180141_codegen_c5qzgg_bag_b0 WITH "DT_node_lookup" AS 
...
FROM tmp_20180508180141_codegen_12l9vh_ads_sca_2_out AS "ADS_sca_2_OUT"), 
"DT_node_data" AS 
...
-- Code For temporary table tmp_20180508180141_codegen_0nlk7n_bag_b1 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180508180141_codegen_0nlk7n_bag_b1 (
	"KEY" BIGINT, 
	"Score_0" DOUBLE, 
	"Proba_0" DOUBLE, 
	"LogProba_0" DOUBLE, 
...
-- Code For temporary table tmp_20180508180141_codegen_0nlk7n_bag_b1 part 2. Populate

INSERT INTO tmp_20180508180141_codegen_0nlk7n_bag_b1 WITH "DT_node_lookup_10" AS 
...
-- Code For temporary table tmp_20180508180141_codegen_0dzq8e_bag_union part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180508180141_codegen_0dzq8e_bag_union (
	"KEY" BIGINT, 
	"Score_0" DOUBLE, 
	"Proba_0" DOUBLE, 
	"LogProba_0" DOUBLE, 
...
-- Code For temporary table tmp_20180508180141_codegen_0dzq8e_bag_union part 2. Populate

INSERT INTO tmp_20180508180141_codegen_0dzq8e_bag_union SELECT "BAG_Union"."KEY", "BAG_Union"."Score_0", "BAG_Union"."Proba_0", "BAG_Union"."LogProba_0", "BAG_Union"."Score_1", "BAG_Union"."Proba_1", "BAG_Union"."LogProba_1" 
...
FROM tmp_20180508180141_codegen_c5qzgg_bag_b0 AS "BAG_B0" UNION ALL SELECT "BAG_B1"."KEY" AS "KEY", "BAG_B1"."Score_0" AS "Score_0", "BAG_B1"."Proba_0" AS "Proba_0", "BAG_B1"."LogProba_0" AS "LogProba_0", "BAG_B1"."Score_1" AS "Score_1", "BAG_B1"."Proba_1" AS "Proba_1", "BAG_B1"."LogProba_1" AS "LogProba_1" 
FROM tmp_20180508180141_codegen_0nlk7n_bag_b1 AS "BAG_B1") AS "BAG_EnsembleUnion") AS "BAG_Union"

-- Code For temporary table tmp_20180508180141_codegen_u9mawd_bag_avg part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180508180141_codegen_u9mawd_bag_avg (
	"KEY" BIGINT, 
	"Score_0" DOUBLE, 
	"Proba_0" DOUBLE, 
	"LogProba_0" DOUBLE, 
...
-- Code For temporary table tmp_20180508180141_codegen_u9mawd_bag_avg part 2. Populate

INSERT INTO tmp_20180508180141_codegen_u9mawd_bag_avg SELECT "BAG_avg"."KEY", "BAG_avg"."Score_0", "BAG_avg"."Proba_0", "BAG_avg"."LogProba_0", "BAG_avg"."Score_1", "BAG_avg"."Proba_1", "BAG_avg"."LogProba_1" 
...
FROM tmp_20180508180141_codegen_0dzq8e_bag_union AS "BAG_Union" GROUP BY "BAG_Union"."KEY") AS "T") AS "BAG_avg"
...
FROM tmp_20180508180141_codegen_u9mawd_bag_avg AS "BAG_avg"), 
