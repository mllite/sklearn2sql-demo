...
-- Code For temporary table tmp_20180508180412_codegen_pogfk9_ads_imp_1_out part 1. Create 


CREATE TEMPORARY TABLE tmp_20180508180412_codegen_pogfk9_ads_imp_1_out (
	"KEY" BIGINT, 
	impter_2 DOUBLE, 
	impter_3 DOUBLE, 
	impter_4 DOUBLE, 
...
-- Code For temporary table tmp_20180508180412_codegen_2ifnj9_ads_sca_2_out part 1. Create 


CREATE TEMPORARY TABLE tmp_20180508180412_codegen_2ifnj9_ads_sca_2_out (
	"KEY" BIGINT, 
	scaler_2 DOUBLE, 
	scaler_3 DOUBLE, 
	scaler_4 DOUBLE, 
...
FROM tmp_20180508180412_codegen_pogfk9_ads_imp_1_out AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT") AS "U"

-- Code For temporary table tmp_20180508180413_codegen_runhiz_rf_b0 part 1. Create 


CREATE TEMPORARY TABLE tmp_20180508180413_codegen_runhiz_rf_b0 (
	"KEY" BIGINT, 
	"Score_0" DOUBLE, 
	"Proba_0" DOUBLE, 
	"LogProba_0" DOUBLE, 
...
-- Code For temporary table tmp_20180508180413_codegen_runhiz_rf_b0 part 2. Populate

INSERT INTO tmp_20180508180413_codegen_runhiz_rf_b0 ("KEY", "Score_0", "Proba_0", "LogProba_0", "Score_1", "Proba_1", "LogProba_1") SELECT "U"."KEY", "U"."Score_0", "U"."Proba_0", "U"."LogProba_0", "U"."Score_1", "U"."Proba_1", "U"."LogProba_1" 
...
FROM tmp_20180508180412_codegen_2ifnj9_ads_sca_2_out AS "ADS_sca_2_OUT"), 
"DT_node_data" AS 
...
-- Code For temporary table tmp_20180508180413_codegen_byfdi1_rf_b1 part 1. Create 


CREATE TEMPORARY TABLE tmp_20180508180413_codegen_byfdi1_rf_b1 (
	"KEY" BIGINT, 
	"Score_0" DOUBLE, 
	"Proba_0" DOUBLE, 
	"LogProba_0" DOUBLE, 
...
-- Code For temporary table tmp_20180508180413_codegen_byfdi1_rf_b1 part 2. Populate

INSERT INTO tmp_20180508180413_codegen_byfdi1_rf_b1 ("KEY", "Score_0", "Proba_0", "LogProba_0", "Score_1", "Proba_1", "LogProba_1") SELECT "U"."KEY", "U"."Score_0", "U"."Proba_0", "U"."LogProba_0", "U"."Score_1", "U"."Proba_1", "U"."LogProba_1" 
...
-- Code For temporary table tmp_20180508180413_codegen_cpinp8_rf_union part 1. Create 


CREATE TEMPORARY TABLE tmp_20180508180413_codegen_cpinp8_rf_union (
	"KEY" BIGINT, 
	"Score_0" DOUBLE, 
	"Proba_0" DOUBLE, 
	"LogProba_0" DOUBLE, 
...
-- Code For temporary table tmp_20180508180413_codegen_cpinp8_rf_union part 2. Populate

INSERT INTO tmp_20180508180413_codegen_cpinp8_rf_union ("KEY", "Score_0", "Proba_0", "LogProba_0", "Score_1", "Proba_1", "LogProba_1") SELECT "U"."KEY", "U"."Score_0", "U"."Proba_0", "U"."LogProba_0", "U"."Score_1", "U"."Proba_1", "U"."LogProba_1" 
...
FROM tmp_20180508180413_codegen_runhiz_rf_b0 AS "RF_B0" UNION ALL SELECT "RF_B1"."KEY" AS "KEY", "RF_B1"."Score_0" AS "Score_0", "RF_B1"."Proba_0" AS "Proba_0", "RF_B1"."LogProba_0" AS "LogProba_0", "RF_B1"."Score_1" AS "Score_1", "RF_B1"."Proba_1" AS "Proba_1", "RF_B1"."LogProba_1" AS "LogProba_1" 
FROM tmp_20180508180413_codegen_byfdi1_rf_b1 AS "RF_B1") AS "RF_EnsembleUnion") AS "RF_Union") AS "U"

-- Code For temporary table tmp_20180508180413_codegen_8mxysp_rf_avg part 1. Create 


CREATE TEMPORARY TABLE tmp_20180508180413_codegen_8mxysp_rf_avg (
	"KEY" BIGINT, 
	"Score_0" DOUBLE, 
	"Proba_0" DOUBLE, 
	"LogProba_0" DOUBLE, 
...
-- Code For temporary table tmp_20180508180413_codegen_8mxysp_rf_avg part 2. Populate

INSERT INTO tmp_20180508180413_codegen_8mxysp_rf_avg ("KEY", "Score_0", "Proba_0", "LogProba_0", "Score_1", "Proba_1", "LogProba_1") SELECT "U"."KEY", "U"."Score_0", "U"."Proba_0", "U"."LogProba_0", "U"."Score_1", "U"."Proba_1", "U"."LogProba_1" 
...
FROM tmp_20180508180413_codegen_cpinp8_rf_union AS "RF_Union" GROUP BY "RF_Union"."KEY") AS "T") AS "RF_avg") AS "U"
...
FROM tmp_20180508180413_codegen_8mxysp_rf_avg AS "RF_avg"), 
