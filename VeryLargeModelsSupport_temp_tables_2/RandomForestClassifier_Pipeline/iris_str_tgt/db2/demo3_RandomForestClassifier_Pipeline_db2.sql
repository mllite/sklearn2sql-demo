...
-- Code For temporary table tmp_20180508190704_codegen_ke89yn_ads_imp_1_out part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180508190704_codegen_ke89yn_ads_imp_1_out (
	"KEY" BIGINT, 
...
-- Code For temporary table tmp_20180508190704_codegen_ke89yn_ads_imp_1_out part 2. Populate

INSERT INTO tmp_20180508190704_codegen_ke89yn_ads_imp_1_out SELECT "ADS_imp_1_OUT"."KEY", "ADS_imp_1_OUT".imputer_output_2, "ADS_imp_1_OUT".imputer_output_3, "ADS_imp_1_OUT".imputer_output_4, "ADS_imp_1_OUT".imputer_output_5 
...
-- Code For temporary table tmp_20180508190704_codegen_pfqgv9_ads_sca_2_out part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180508190704_codegen_pfqgv9_ads_sca_2_out (
	"KEY" BIGINT, 
...
-- Code For temporary table tmp_20180508190704_codegen_pfqgv9_ads_sca_2_out part 2. Populate

INSERT INTO tmp_20180508190704_codegen_pfqgv9_ads_sca_2_out SELECT "ADS_sca_2_OUT"."KEY", "ADS_sca_2_OUT".scaler_output_2, "ADS_sca_2_OUT".scaler_output_3, "ADS_sca_2_OUT".scaler_output_4, "ADS_sca_2_OUT".scaler_output_5 
...
FROM tmp_20180508190704_codegen_ke89yn_ads_imp_1_out AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT"

-- Code For temporary table tmp_20180508190704_codegen_5dn0sm_rf_b0 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180508190704_codegen_5dn0sm_rf_b0 (
	"KEY" BIGINT, 
...
-- Code For temporary table tmp_20180508190704_codegen_5dn0sm_rf_b0 part 2. Populate

INSERT INTO tmp_20180508190704_codegen_5dn0sm_rf_b0 WITH "DT_node_lookup" AS 
...
FROM tmp_20180508190704_codegen_pfqgv9_ads_sca_2_out AS "ADS_sca_2_OUT"), 
"DT_node_data" AS 
...
-- Code For temporary table tmp_20180508190704_codegen_w21yey_rf_b1 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180508190704_codegen_w21yey_rf_b1 (
	"KEY" BIGINT, 
	"Score_CLASS_0" DOUBLE, 
	"Proba_CLASS_0" DOUBLE, 
	"LogProba_CLASS_0" DOUBLE, 
...
-- Code For temporary table tmp_20180508190704_codegen_w21yey_rf_b1 part 2. Populate

INSERT INTO tmp_20180508190704_codegen_w21yey_rf_b1 WITH "DT_node_lookup_10" AS 
...
-- Code For temporary table tmp_20180508190704_codegen_v7bk8k_rf_union part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180508190704_codegen_v7bk8k_rf_union (
	"KEY" BIGINT, 
	"Score_CLASS_0" DOUBLE, 
	"Proba_CLASS_0" DOUBLE, 
	"LogProba_CLASS_0" DOUBLE, 
...
-- Code For temporary table tmp_20180508190704_codegen_v7bk8k_rf_union part 2. Populate

INSERT INTO tmp_20180508190704_codegen_v7bk8k_rf_union SELECT "RF_Union"."KEY", "RF_Union"."Score_CLASS_0", "RF_Union"."Proba_CLASS_0", "RF_Union"."LogProba_CLASS_0", "RF_Union"."Score_CLASS_1", "RF_Union"."Proba_CLASS_1", "RF_Union"."LogProba_CLASS_1", "RF_Union"."Score_CLASS_2", "RF_Union"."Proba_CLASS_2", "RF_Union"."LogProba_CLASS_2" 
...
FROM tmp_20180508190704_codegen_5dn0sm_rf_b0 AS "RF_B0" UNION ALL SELECT "RF_B1"."KEY" AS "KEY", "RF_B1"."Score_CLASS_0" AS "Score_CLASS_0", "RF_B1"."Proba_CLASS_0" AS "Proba_CLASS_0", "RF_B1"."LogProba_CLASS_0" AS "LogProba_CLASS_0", "RF_B1"."Score_CLASS_1" AS "Score_CLASS_1", "RF_B1"."Proba_CLASS_1" AS "Proba_CLASS_1", "RF_B1"."LogProba_CLASS_1" AS "LogProba_CLASS_1", "RF_B1"."Score_CLASS_2" AS "Score_CLASS_2", "RF_B1"."Proba_CLASS_2" AS "Proba_CLASS_2", "RF_B1"."LogProba_CLASS_2" AS "LogProba_CLASS_2" 
FROM tmp_20180508190704_codegen_w21yey_rf_b1 AS "RF_B1") AS "RF_EnsembleUnion") AS "RF_Union"

-- Code For temporary table tmp_20180508190704_codegen_daiu6k_rf_avg part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180508190704_codegen_daiu6k_rf_avg (
	"KEY" BIGINT, 
	"Score_CLASS_0" DOUBLE, 
	"Proba_CLASS_0" DOUBLE, 
	"LogProba_CLASS_0" DOUBLE, 
...
-- Code For temporary table tmp_20180508190704_codegen_daiu6k_rf_avg part 2. Populate

INSERT INTO tmp_20180508190704_codegen_daiu6k_rf_avg SELECT "RF_avg"."KEY", "RF_avg"."Score_CLASS_0", "RF_avg"."Proba_CLASS_0", "RF_avg"."LogProba_CLASS_0", "RF_avg"."Score_CLASS_1", "RF_avg"."Proba_CLASS_1", "RF_avg"."LogProba_CLASS_1", "RF_avg"."Score_CLASS_2", "RF_avg"."Proba_CLASS_2", "RF_avg"."LogProba_CLASS_2" 
...
FROM tmp_20180508190704_codegen_v7bk8k_rf_union AS "RF_Union" GROUP BY "RF_Union"."KEY") AS "T") AS "RF_avg"
...
FROM tmp_20180508190704_codegen_daiu6k_rf_avg AS "RF_avg"), 
