...
-- Code For temporary table TMP_20180508190702_CODEGEN_U92K part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508190702_CODEGEN_U92K" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20180508190702_CODEGEN_U92K part 2. Populate

INSERT INTO "TMP_20180508190702_CODEGEN_U92K" ("KEY", imputer_output_2, imputer_output_3, imputer_output_4, imputer_output_5) SELECT "U"."KEY", "U".imputer_output_2, "U".imputer_output_3, "U".imputer_output_4, "U".imputer_output_5 
...
-- Code For temporary table TMP_20180508190702_CODEGEN_U92K part 3. Create Index 

CREATE INDEX "ix_TMP_20180508190702_C_7385" ON "TMP_20180508190702_CODEGEN_U92K" ("KEY")

-- Code For temporary table TMP_20180508190702_CODEGEN_0780 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508190702_CODEGEN_0780" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20180508190702_CODEGEN_0780 part 2. Populate

INSERT INTO "TMP_20180508190702_CODEGEN_0780" ("KEY", scaler_output_2, scaler_output_3, scaler_output_4, scaler_output_5) SELECT "U"."KEY", "U".scaler_output_2, "U".scaler_output_3, "U".scaler_output_4, "U".scaler_output_5 
...
FROM "TMP_20180508190702_CODEGEN_U92K" AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT") AS "U"

-- Code For temporary table TMP_20180508190702_CODEGEN_0780 part 3. Create Index 

CREATE INDEX "ix_TMP_20180508190702_C_7807" ON "TMP_20180508190702_CODEGEN_0780" ("KEY")

-- Code For temporary table TMP_20180508190702_CODEGEN_9WA0 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508190702_CODEGEN_9WA0" (
	"KEY" BIGINT, 
...
FROM "TMP_20180508190702_CODEGEN_0780" AS "ADS_sca_2_OUT"), 
"DT_node_data" AS 
...
-- Code For temporary table TMP_20180508190702_CODEGEN_SM6I part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508190702_CODEGEN_SM6I" (
	"KEY" BIGINT, 
	"Score_CLASS_0" DOUBLE PRECISION, 
	"Proba_CLASS_0" DOUBLE PRECISION, 
	"LogProba_CLASS_0" DOUBLE PRECISION, 
...
-- Code For temporary table TMP_20180508190702_CODEGEN_SM6I part 2. Populate

INSERT INTO "TMP_20180508190702_CODEGEN_SM6I" ("KEY", "Score_CLASS_0", "Proba_CLASS_0", "LogProba_CLASS_0", "Score_CLASS_1", "Proba_CLASS_1", "LogProba_CLASS_1", "Score_CLASS_2", "Proba_CLASS_2", "LogProba_CLASS_2") SELECT "U"."KEY", "U"."Score_CLASS_0", "U"."Proba_CLASS_0", "U"."LogProba_CLASS_0", "U"."Score_CLASS_1", "U"."Proba_CLASS_1", "U"."LogProba_CLASS_1", "U"."Score_CLASS_2", "U"."Proba_CLASS_2", "U"."LogProba_CLASS_2" 
...
-- Code For temporary table TMP_20180508190702_CODEGEN_72FL part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508190702_CODEGEN_72FL" (
	"KEY" BIGINT, 
	"Score_CLASS_0" DOUBLE PRECISION, 
	"Proba_CLASS_0" DOUBLE PRECISION, 
	"LogProba_CLASS_0" DOUBLE PRECISION, 
...
-- Code For temporary table TMP_20180508190702_CODEGEN_72FL part 2. Populate

INSERT INTO "TMP_20180508190702_CODEGEN_72FL" ("KEY", "Score_CLASS_0", "Proba_CLASS_0", "LogProba_CLASS_0", "Score_CLASS_1", "Proba_CLASS_1", "LogProba_CLASS_1", "Score_CLASS_2", "Proba_CLASS_2", "LogProba_CLASS_2") SELECT "U"."KEY", "U"."Score_CLASS_0", "U"."Proba_CLASS_0", "U"."LogProba_CLASS_0", "U"."Score_CLASS_1", "U"."Proba_CLASS_1", "U"."LogProba_CLASS_1", "U"."Score_CLASS_2", "U"."Proba_CLASS_2", "U"."LogProba_CLASS_2" 
...
-- Code For temporary table TMP_20180508190702_CODEGEN_IVM1 part 2. Populate

INSERT INTO "TMP_20180508190702_CODEGEN_IVM1" ("KEY", "Score_CLASS_0", "Proba_CLASS_0", "LogProba_CLASS_0", "Score_CLASS_1", "Proba_CLASS_1", "LogProba_CLASS_1", "Score_CLASS_2", "Proba_CLASS_2", "LogProba_CLASS_2") SELECT "U"."KEY", "U"."Score_CLASS_0", "U"."Proba_CLASS_0", "U"."LogProba_CLASS_0", "U"."Score_CLASS_1", "U"."Proba_CLASS_1", "U"."LogProba_CLASS_1", "U"."Score_CLASS_2", "U"."Proba_CLASS_2", "U"."LogProba_CLASS_2" 
...
FROM "TMP_20180508190702_CODEGEN_72FL" AS "RF_Union" GROUP BY "RF_Union"."KEY") AS "T") AS "RF_avg") AS "U"

-- Code For temporary table TMP_20180508190702_CODEGEN_IVM1 part 3. Create Index 

CREATE INDEX "ix_TMP_20180508190702_C_55cf" ON "TMP_20180508190702_CODEGEN_IVM1" ("KEY")
...
FROM "TMP_20180508190702_CODEGEN_IVM1" AS "RF_avg"), 
