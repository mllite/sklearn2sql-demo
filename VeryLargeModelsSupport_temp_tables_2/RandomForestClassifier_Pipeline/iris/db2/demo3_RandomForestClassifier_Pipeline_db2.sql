...
-- Code For temporary table tmp_20180508185732_codegen_25x9ya_ads_imp_1_out part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180508185732_codegen_25x9ya_ads_imp_1_out (
	"KEY" BIGINT, 
...
-- Code For temporary table tmp_20180508185732_codegen_25x9ya_ads_imp_1_out part 2. Populate

INSERT INTO tmp_20180508185732_codegen_25x9ya_ads_imp_1_out SELECT "ADS_imp_1_OUT"."KEY", "ADS_imp_1_OUT".imputer_output_2, "ADS_imp_1_OUT".imputer_output_3, "ADS_imp_1_OUT".imputer_output_4, "ADS_imp_1_OUT".imputer_output_5 
FROM (SELECT "ADS"."KEY" AS "KEY", CASE WHEN ("ADS"."Feature_0" IS NULL) THEN 5.8474999999999975 ELSE "ADS"."Feature_0" END AS imputer_output_2, CASE WHEN ("ADS"."Feature_1" IS NULL) THEN 3.0366666666666657 ELSE "ADS"."Feature_1" END AS imputer_output_3, CASE WHEN ("ADS"."Feature_2" IS NULL) THEN 3.8450000000000006 ELSE "ADS"."Feature_2" END AS imputer_output_4, CASE WHEN ("ADS"."Feature_3" IS NULL) THEN 1.245 ELSE "ADS"."Feature_3" END AS imputer_output_5 
FROM "IRIS" AS "ADS") AS "ADS_imp_1_OUT"

-- Code For temporary table tmp_20180508185732_codegen_l9p950_ads_sca_2_out part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180508185732_codegen_l9p950_ads_sca_2_out (
	"KEY" BIGINT, 
...
-- Code For temporary table tmp_20180508185732_codegen_l9p950_ads_sca_2_out part 2. Populate

INSERT INTO tmp_20180508185732_codegen_l9p950_ads_sca_2_out SELECT "ADS_sca_2_OUT"."KEY", "ADS_sca_2_OUT".scaler_output_2, "ADS_sca_2_OUT".scaler_output_3, "ADS_sca_2_OUT".scaler_output_4, "ADS_sca_2_OUT".scaler_output_5 
...
FROM tmp_20180508185732_codegen_25x9ya_ads_imp_1_out AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT"

-- Code For temporary table tmp_20180508185732_codegen_8yma66_rf_b0 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180508185732_codegen_8yma66_rf_b0 (
	"KEY" BIGINT, 
	"Score_0" DOUBLE, 
	"Proba_0" DOUBLE, 
	"LogProba_0" DOUBLE, 
...
-- Code For temporary table tmp_20180508185732_codegen_8yma66_rf_b0 part 2. Populate

INSERT INTO tmp_20180508185732_codegen_8yma66_rf_b0 WITH "DT_node_lookup" AS 
...
FROM tmp_20180508185732_codegen_l9p950_ads_sca_2_out AS "ADS_sca_2_OUT"), 
"DT_node_data" AS 
...
-- Code For temporary table tmp_20180508185732_codegen_bmjuxl_rf_b1 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180508185732_codegen_bmjuxl_rf_b1 (
	"KEY" BIGINT, 
	"Score_0" DOUBLE, 
	"Proba_0" DOUBLE, 
	"LogProba_0" DOUBLE, 
...
-- Code For temporary table tmp_20180508185732_codegen_bmjuxl_rf_b1 part 2. Populate

INSERT INTO tmp_20180508185732_codegen_bmjuxl_rf_b1 WITH "DT_node_lookup_10" AS 
...
-- Code For temporary table tmp_20180508185732_codegen_91zugw_rf_union part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180508185732_codegen_91zugw_rf_union (
	"KEY" BIGINT, 
	"Score_0" DOUBLE, 
	"Proba_0" DOUBLE, 
	"LogProba_0" DOUBLE, 
...
-- Code For temporary table tmp_20180508185732_codegen_91zugw_rf_union part 2. Populate

INSERT INTO tmp_20180508185732_codegen_91zugw_rf_union SELECT "RF_Union"."KEY", "RF_Union"."Score_0", "RF_Union"."Proba_0", "RF_Union"."LogProba_0", "RF_Union"."Score_1", "RF_Union"."Proba_1", "RF_Union"."LogProba_1", "RF_Union"."Score_2", "RF_Union"."Proba_2", "RF_Union"."LogProba_2" 
...
FROM tmp_20180508185732_codegen_8yma66_rf_b0 AS "RF_B0" UNION ALL SELECT "RF_B1"."KEY" AS "KEY", "RF_B1"."Score_0" AS "Score_0", "RF_B1"."Proba_0" AS "Proba_0", "RF_B1"."LogProba_0" AS "LogProba_0", "RF_B1"."Score_1" AS "Score_1", "RF_B1"."Proba_1" AS "Proba_1", "RF_B1"."LogProba_1" AS "LogProba_1", "RF_B1"."Score_2" AS "Score_2", "RF_B1"."Proba_2" AS "Proba_2", "RF_B1"."LogProba_2" AS "LogProba_2" 
FROM tmp_20180508185732_codegen_bmjuxl_rf_b1 AS "RF_B1") AS "RF_EnsembleUnion") AS "RF_Union"

-- Code For temporary table tmp_20180508185732_codegen_99w9v4_rf_avg part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180508185732_codegen_99w9v4_rf_avg (
	"KEY" BIGINT, 
	"Score_0" DOUBLE, 
	"Proba_0" DOUBLE, 
	"LogProba_0" DOUBLE, 
...
-- Code For temporary table tmp_20180508185732_codegen_99w9v4_rf_avg part 2. Populate

INSERT INTO tmp_20180508185732_codegen_99w9v4_rf_avg SELECT "RF_avg"."KEY", "RF_avg"."Score_0", "RF_avg"."Proba_0", "RF_avg"."LogProba_0", "RF_avg"."Score_1", "RF_avg"."Proba_1", "RF_avg"."LogProba_1", "RF_avg"."Score_2", "RF_avg"."Proba_2", "RF_avg"."LogProba_2" 
...
FROM tmp_20180508185732_codegen_91zugw_rf_union AS "RF_Union" GROUP BY "RF_Union"."KEY") AS "T") AS "RF_avg"
...
FROM tmp_20180508185732_codegen_99w9v4_rf_avg AS "RF_avg"), 
