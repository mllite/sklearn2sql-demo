...
-- Code For temporary table tmp_20180508175935_codegen_9o5c7j_ads_imp_1_out part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180508175935_codegen_9o5c7j_ads_imp_1_out (
	"KEY" BIGINT, 
	impter_2 DOUBLE, 
	impter_3 DOUBLE, 
	impter_4 DOUBLE, 
...
-- Code For temporary table tmp_20180508175935_codegen_9o5c7j_ads_imp_1_out part 2. Populate

INSERT INTO tmp_20180508175935_codegen_9o5c7j_ads_imp_1_out SELECT "ADS_imp_1_OUT"."KEY", "ADS_imp_1_OUT".impter_2, "ADS_imp_1_OUT".impter_3, "ADS_imp_1_OUT".impter_4, "ADS_imp_1_OUT".impter_5, "ADS_imp_1_OUT".impter_6, "ADS_imp_1_OUT".impter_7, "ADS_imp_1_OUT".impter_8, "ADS_imp_1_OUT".impter_9, "ADS_imp_1_OUT".impter_10, "ADS_imp_1_OUT".impter_11 
...
-- Code For temporary table tmp_20180508175935_codegen_n9uwad_ads_sca_2_out part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180508175935_codegen_n9uwad_ads_sca_2_out (
	"KEY" BIGINT, 
	scaler_2 DOUBLE, 
	scaler_3 DOUBLE, 
	scaler_4 DOUBLE, 
...
-- Code For temporary table tmp_20180508175935_codegen_n9uwad_ads_sca_2_out part 2. Populate

INSERT INTO tmp_20180508175935_codegen_n9uwad_ads_sca_2_out SELECT "ADS_sca_2_OUT"."KEY", "ADS_sca_2_OUT".scaler_2, "ADS_sca_2_OUT".scaler_3, "ADS_sca_2_OUT".scaler_4, "ADS_sca_2_OUT".scaler_5, "ADS_sca_2_OUT".scaler_6, "ADS_sca_2_OUT".scaler_7, "ADS_sca_2_OUT".scaler_8, "ADS_sca_2_OUT".scaler_9, "ADS_sca_2_OUT".scaler_10, "ADS_sca_2_OUT".scaler_11 
...
FROM tmp_20180508175935_codegen_9o5c7j_ads_imp_1_out AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT"

-- Code For temporary table tmp_20180508175935_codegen_pilcgc_rf_b0 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180508175935_codegen_pilcgc_rf_b0 (
	"KEY" BIGINT, 
	"Score_0" DOUBLE, 
	"Proba_0" DOUBLE, 
	"LogProba_0" DOUBLE, 
...
-- Code For temporary table tmp_20180508175935_codegen_pilcgc_rf_b0 part 2. Populate

INSERT INTO tmp_20180508175935_codegen_pilcgc_rf_b0 WITH "DT_node_lookup" AS 
...
FROM tmp_20180508175935_codegen_n9uwad_ads_sca_2_out AS "ADS_sca_2_OUT"), 
"DT_node_data" AS 
...
-- Code For temporary table tmp_20180508175935_codegen_la997q_rf_b1 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180508175935_codegen_la997q_rf_b1 (
	"KEY" BIGINT, 
	"Score_0" DOUBLE, 
	"Proba_0" DOUBLE, 
	"LogProba_0" DOUBLE, 
...
-- Code For temporary table tmp_20180508175935_codegen_la997q_rf_b1 part 2. Populate

INSERT INTO tmp_20180508175935_codegen_la997q_rf_b1 WITH "DT_node_lookup_10" AS 
...
-- Code For temporary table tmp_20180508175935_codegen_kuqz18_rf_union part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180508175935_codegen_kuqz18_rf_union (
	"KEY" BIGINT, 
	"Score_0" DOUBLE, 
	"Proba_0" DOUBLE, 
	"LogProba_0" DOUBLE, 
...
-- Code For temporary table tmp_20180508175935_codegen_kuqz18_rf_union part 2. Populate

INSERT INTO tmp_20180508175935_codegen_kuqz18_rf_union SELECT "RF_Union"."KEY", "RF_Union"."Score_0", "RF_Union"."Proba_0", "RF_Union"."LogProba_0", "RF_Union"."Score_1", "RF_Union"."Proba_1", "RF_Union"."LogProba_1" 
...
FROM tmp_20180508175935_codegen_pilcgc_rf_b0 AS "RF_B0" UNION ALL SELECT "RF_B1"."KEY" AS "KEY", "RF_B1"."Score_0" AS "Score_0", "RF_B1"."Proba_0" AS "Proba_0", "RF_B1"."LogProba_0" AS "LogProba_0", "RF_B1"."Score_1" AS "Score_1", "RF_B1"."Proba_1" AS "Proba_1", "RF_B1"."LogProba_1" AS "LogProba_1" 
FROM tmp_20180508175935_codegen_la997q_rf_b1 AS "RF_B1") AS "RF_EnsembleUnion") AS "RF_Union"

-- Code For temporary table tmp_20180508175935_codegen_g774x6_rf_avg part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180508175935_codegen_g774x6_rf_avg (
	"KEY" BIGINT, 
	"Score_0" DOUBLE, 
	"Proba_0" DOUBLE, 
	"LogProba_0" DOUBLE, 
...
-- Code For temporary table tmp_20180508175935_codegen_g774x6_rf_avg part 2. Populate

INSERT INTO tmp_20180508175935_codegen_g774x6_rf_avg SELECT "RF_avg"."KEY", "RF_avg"."Score_0", "RF_avg"."Proba_0", "RF_avg"."LogProba_0", "RF_avg"."Score_1", "RF_avg"."Proba_1", "RF_avg"."LogProba_1" 
...
FROM tmp_20180508175935_codegen_kuqz18_rf_union AS "RF_Union" GROUP BY "RF_Union"."KEY") AS "T") AS "RF_avg"
...
FROM tmp_20180508175935_codegen_g774x6_rf_avg AS "RF_avg"), 
