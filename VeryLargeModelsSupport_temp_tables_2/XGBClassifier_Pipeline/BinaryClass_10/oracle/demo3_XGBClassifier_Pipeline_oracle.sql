...
-- Code For temporary table DEGEN_87VMU9_ADS_IMP_1_OUT part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "DEGEN_87VMU9_ADS_IMP_1_OUT" (
	"KEY" NUMBER(19), 
...
-- Code For temporary table DEGEN_87VMU9_ADS_IMP_1_OUT part 2. Populate

INSERT INTO "DEGEN_87VMU9_ADS_IMP_1_OUT" ("KEY", impter_2, impter_3, impter_4, impter_5, impter_6, impter_7, impter_8, impter_9, impter_10, impter_11) SELECT "U"."KEY", "U".impter_2, "U".impter_3, "U".impter_4, "U".impter_5, "U".impter_6, "U".impter_7, "U".impter_8, "U".impter_9, "U".impter_10, "U".impter_11 
...
-- Code For temporary table DEGEN_9KT7E3_ADS_SCA_2_OUT part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "DEGEN_9KT7E3_ADS_SCA_2_OUT" (
	"KEY" NUMBER(19), 
...
-- Code For temporary table DEGEN_9KT7E3_ADS_SCA_2_OUT part 2. Populate

INSERT INTO "DEGEN_9KT7E3_ADS_SCA_2_OUT" ("KEY", scaler_2, scaler_3, scaler_4, scaler_5, scaler_6, scaler_7, scaler_8, scaler_9, scaler_10, scaler_11) SELECT "U"."KEY", "U".scaler_2, "U".scaler_3, "U".scaler_4, "U".scaler_5, "U".scaler_6, "U".scaler_7, "U".scaler_8, "U".scaler_9, "U".scaler_10, "U".scaler_11 
...
FROM "DEGEN_87VMU9_ADS_IMP_1_OUT" "ADS_imp_1_OUT") "ADS_sca_2_OUT") "U"

-- Code For temporary table 0108_CODEGEN_D3CJT0_XGB_B0 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "0108_CODEGEN_D3CJT0_XGB_B0" (
	"KEY" NUMBER(19), 
...
-- Code For temporary table 0108_CODEGEN_D3CJT0_XGB_B0 part 2. Populate

INSERT INTO "0108_CODEGEN_D3CJT0_XGB_B0" ("KEY", "Score_0") SELECT "U"."KEY", "U"."Score_0" 
...
FROM "DEGEN_9KT7E3_ADS_SCA_2_OUT" "ADS_sca_2_OUT"), 
"DT_node_data" AS 
...
-- Code For temporary table 0108_CODEGEN_FQ7WI9_XGB_B1 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "0108_CODEGEN_FQ7WI9_XGB_B1" (
	"KEY" NUMBER(19), 
	"Score_0" BINARY_DOUBLE
)
...
-- Code For temporary table 0108_CODEGEN_FQ7WI9_XGB_B1 part 2. Populate

INSERT INTO "0108_CODEGEN_FQ7WI9_XGB_B1" ("KEY", "Score_0") SELECT "U"."KEY", "U"."Score_0" 
...
-- Code For temporary table 8_CODEGEN_5HG60M_XGB_UNION part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "8_CODEGEN_5HG60M_XGB_UNION" (
	"KEY" NUMBER(19), 
	"Score_0" BINARY_DOUBLE
)
...
-- Code For temporary table 8_CODEGEN_5HG60M_XGB_UNION part 2. Populate

INSERT INTO "8_CODEGEN_5HG60M_XGB_UNION" ("KEY", "Score_0") SELECT "U"."KEY", "U"."Score_0" 
...
FROM "0108_CODEGEN_D3CJT0_XGB_B0" "XGB_B0" UNION ALL SELECT "XGB_B1"."KEY" AS "KEY", "XGB_B1"."Score_0" AS "Score_0" 
FROM "0108_CODEGEN_FQ7WI9_XGB_B1" "XGB_B1") "XGB_EnsembleUnion") "XGB_Union") "U"

-- Code For temporary table 108_CODEGEN_BV8IKK_XGB_SUM part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "108_CODEGEN_BV8IKK_XGB_SUM" (
	"KEY" NUMBER(19), 
	"Score_0" BINARY_DOUBLE
)
...
-- Code For temporary table 108_CODEGEN_BV8IKK_XGB_SUM part 2. Populate

INSERT INTO "108_CODEGEN_BV8IKK_XGB_SUM" ("KEY", "Score_0") SELECT "U"."KEY", "U"."Score_0" 
...
FROM "8_CODEGEN_5HG60M_XGB_UNION" "XGB_Union" GROUP BY "XGB_Union"."KEY") "T") "XGB_sum") "U"
...
FROM "108_CODEGEN_BV8IKK_XGB_SUM" "XGB_sum"), 
