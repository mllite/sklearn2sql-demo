...
-- Code For temporary table TMP_20180508182059_CODEGEN_8X8D part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508182059_CODEGEN_8X8D" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20180508182059_CODEGEN_8X8D part 3. Create Index 

CREATE INDEX "ix_TMP_20180508182059_C_4247" ON "TMP_20180508182059_CODEGEN_8X8D" ("KEY")

-- Code For temporary table TMP_20180508182059_CODEGEN_Q94G part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508182059_CODEGEN_Q94G" (
	"KEY" BIGINT NOT NULL, 
...
FROM "TMP_20180508182059_CODEGEN_8X8D" AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT") AS "U"

-- Code For temporary table TMP_20180508182059_CODEGEN_Q94G part 3. Create Index 

CREATE INDEX "ix_TMP_20180508182059_C_5cdc" ON "TMP_20180508182059_CODEGEN_Q94G" ("KEY")

-- Code For temporary table TMP_20180508182059_CODEGEN_NJMN part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508182059_CODEGEN_NJMN" (
	"KEY" BIGINT, 
...
-- Code For temporary table TMP_20180508182059_CODEGEN_NJMN part 2. Populate

INSERT INTO "TMP_20180508182059_CODEGEN_NJMN" ("KEY", "Score_0", "Score_1", "Score_2", "Score_3") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1", "U"."Score_2", "U"."Score_3" 
FROM (WITH "DT_node_lookup" AS 
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", CASE WHEN ("ADS_sca_2_OUT".scaler_80 < -0.1553783416748047) THEN 1 ELSE 2 END AS node_id_2 
FROM "TMP_20180508182059_CODEGEN_Q94G" AS "ADS_sca_2_OUT"), 
"DT_node_data" AS 
...
-- Code For temporary table TMP_20180508182059_CODEGEN_96IE part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508182059_CODEGEN_96IE" (
	"KEY" BIGINT, 
	"Score_0" DOUBLE PRECISION, 
	"Score_1" DOUBLE PRECISION, 
	"Score_2" DOUBLE PRECISION, 
...
-- Code For temporary table TMP_20180508182059_CODEGEN_96IE part 2. Populate

INSERT INTO "TMP_20180508182059_CODEGEN_96IE" ("KEY", "Score_0", "Score_1", "Score_2", "Score_3") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1", "U"."Score_2", "U"."Score_3" 
...
-- Code For temporary table TMP_20180508182059_CODEGEN_FRYN part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508182059_CODEGEN_FRYN" (
	"KEY" BIGINT, 
	"Score_0" DOUBLE PRECISION, 
	"Score_1" DOUBLE PRECISION, 
	"Score_2" DOUBLE PRECISION, 
...
-- Code For temporary table TMP_20180508182059_CODEGEN_FRYN part 2. Populate

INSERT INTO "TMP_20180508182059_CODEGEN_FRYN" ("KEY", "Score_0", "Score_1", "Score_2", "Score_3") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1", "U"."Score_2", "U"."Score_3" 
...
-- Code For temporary table TMP_20180508182059_CODEGEN_G3VE part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508182059_CODEGEN_G3VE" (
	"KEY" BIGINT, 
	"Score_0" DOUBLE PRECISION, 
	"Score_1" DOUBLE PRECISION, 
	"Score_2" DOUBLE PRECISION, 
...
-- Code For temporary table TMP_20180508182059_CODEGEN_G3VE part 2. Populate

INSERT INTO "TMP_20180508182059_CODEGEN_G3VE" ("KEY", "Score_0", "Score_1", "Score_2", "Score_3") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1", "U"."Score_2", "U"."Score_3" 
...
-- Code For temporary table TMP_20180508182059_CODEGEN_1KZ6 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508182059_CODEGEN_1KZ6" (
	"KEY" BIGINT, 
	"Score_0" DOUBLE PRECISION, 
	"Score_1" DOUBLE PRECISION, 
	"Score_2" DOUBLE PRECISION, 
...
-- Code For temporary table TMP_20180508182059_CODEGEN_1KZ6 part 2. Populate

INSERT INTO "TMP_20180508182059_CODEGEN_1KZ6" ("KEY", "Score_0", "Score_1", "Score_2", "Score_3") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1", "U"."Score_2", "U"."Score_3" 
...
-- Code For temporary table TMP_20180508182059_CODEGEN_PJDV part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508182059_CODEGEN_PJDV" (
	"KEY" BIGINT, 
	"Score_0" DOUBLE PRECISION, 
	"Score_1" DOUBLE PRECISION, 
	"Score_2" DOUBLE PRECISION, 
...
-- Code For temporary table TMP_20180508182059_CODEGEN_PJDV part 2. Populate

INSERT INTO "TMP_20180508182059_CODEGEN_PJDV" ("KEY", "Score_0", "Score_1", "Score_2", "Score_3") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1", "U"."Score_2", "U"."Score_3" 
...
-- Code For temporary table TMP_20180508182059_CODEGEN_QYCM part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508182059_CODEGEN_QYCM" (
	"KEY" BIGINT, 
	"Score_0" DOUBLE PRECISION, 
	"Score_1" DOUBLE PRECISION, 
	"Score_2" DOUBLE PRECISION, 
...
-- Code For temporary table TMP_20180508182059_CODEGEN_QYCM part 2. Populate

INSERT INTO "TMP_20180508182059_CODEGEN_QYCM" ("KEY", "Score_0", "Score_1", "Score_2", "Score_3") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1", "U"."Score_2", "U"."Score_3" 
...
-- Code For temporary table TMP_20180508182059_CODEGEN_ITYN part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508182059_CODEGEN_ITYN" (
	"KEY" BIGINT, 
	"Score_0" DOUBLE PRECISION, 
	"Score_1" DOUBLE PRECISION, 
	"Score_2" DOUBLE PRECISION, 
...
-- Code For temporary table TMP_20180508182059_CODEGEN_ITYN part 2. Populate

INSERT INTO "TMP_20180508182059_CODEGEN_ITYN" ("KEY", "Score_0", "Score_1", "Score_2", "Score_3") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1", "U"."Score_2", "U"."Score_3" 
...
FROM "TMP_20180508182059_CODEGEN_NJMN" AS "XGB_B0" UNION ALL SELECT "XGB_B1"."KEY" AS "KEY", "XGB_B1"."Score_0" AS "Score_0", "XGB_B1"."Score_1" AS "Score_1", "XGB_B1"."Score_2" AS "Score_2", "XGB_B1"."Score_3" AS "Score_3" 
FROM "TMP_20180508182059_CODEGEN_96IE" AS "XGB_B1" UNION ALL SELECT "XGB_B2"."KEY" AS "KEY", "XGB_B2"."Score_0" AS "Score_0", "XGB_B2"."Score_1" AS "Score_1", "XGB_B2"."Score_2" AS "Score_2", "XGB_B2"."Score_3" AS "Score_3" 
FROM "TMP_20180508182059_CODEGEN_FRYN" AS "XGB_B2" UNION ALL SELECT "XGB_B3"."KEY" AS "KEY", "XGB_B3"."Score_0" AS "Score_0", "XGB_B3"."Score_1" AS "Score_1", "XGB_B3"."Score_2" AS "Score_2", "XGB_B3"."Score_3" AS "Score_3" 
FROM "TMP_20180508182059_CODEGEN_G3VE" AS "XGB_B3" UNION ALL SELECT "XGB_B4"."KEY" AS "KEY", "XGB_B4"."Score_0" AS "Score_0", "XGB_B4"."Score_1" AS "Score_1", "XGB_B4"."Score_2" AS "Score_2", "XGB_B4"."Score_3" AS "Score_3" 
FROM "TMP_20180508182059_CODEGEN_1KZ6" AS "XGB_B4" UNION ALL SELECT "XGB_B5"."KEY" AS "KEY", "XGB_B5"."Score_0" AS "Score_0", "XGB_B5"."Score_1" AS "Score_1", "XGB_B5"."Score_2" AS "Score_2", "XGB_B5"."Score_3" AS "Score_3" 
FROM "TMP_20180508182059_CODEGEN_PJDV" AS "XGB_B5" UNION ALL SELECT "XGB_B6"."KEY" AS "KEY", "XGB_B6"."Score_0" AS "Score_0", "XGB_B6"."Score_1" AS "Score_1", "XGB_B6"."Score_2" AS "Score_2", "XGB_B6"."Score_3" AS "Score_3" 
FROM "TMP_20180508182059_CODEGEN_QYCM" AS "XGB_B6") AS "XGB_EnsembleUnion") AS "XGB_Union") AS "U"

-- Code For temporary table TMP_20180508182059_CODEGEN_6TKD part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508182059_CODEGEN_6TKD" (
	"KEY" BIGINT NOT NULL, 
	"Score_0" DOUBLE PRECISION, 
	"Score_1" DOUBLE PRECISION, 
	"Score_2" DOUBLE PRECISION, 
...
-- Code For temporary table TMP_20180508182059_CODEGEN_6TKD part 2. Populate

INSERT INTO "TMP_20180508182059_CODEGEN_6TKD" ("KEY", "Score_0", "Score_1", "Score_2", "Score_3") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1", "U"."Score_2", "U"."Score_3" 
...
FROM "TMP_20180508182059_CODEGEN_ITYN" AS "XGB_Union" GROUP BY "XGB_Union"."KEY") AS "T") AS "XGB_sum") AS "U"

-- Code For temporary table TMP_20180508182059_CODEGEN_6TKD part 3. Create Index 

CREATE INDEX "ix_TMP_20180508182059_C_3e6f" ON "TMP_20180508182059_CODEGEN_6TKD" ("KEY")
...
FROM "TMP_20180508182059_CODEGEN_6TKD" AS "XGB_sum"), 
