...
-- Code For temporary table tmp_20180508195517_codegen_k0y3qx_ads_imp_1_out part 1. Create 


CREATE TABLE tmp_20180508195517_codegen_k0y3qx_ads_imp_1_out (
	`KEY` BIGINT, 
...
-- Code For temporary table tmp_20180508195517_codegen_k0y3qx_ads_imp_1_out part 2. Populate

INSERT INTO tmp_20180508195517_codegen_k0y3qx_ads_imp_1_out (`KEY`, imputer_output_2, imputer_output_3, imputer_output_4, imputer_output_5) SELECT `ADS_imp_1_OUT`.`KEY`, `ADS_imp_1_OUT`.imputer_output_2, `ADS_imp_1_OUT`.imputer_output_3, `ADS_imp_1_OUT`.imputer_output_4, `ADS_imp_1_OUT`.imputer_output_5 
...
-- Code For temporary table tmp_20180508195517_codegen_7t8q93_ads_sca_2_out part 1. Create 


CREATE TABLE tmp_20180508195517_codegen_7t8q93_ads_sca_2_out (
	`KEY` BIGINT, 
...
-- Code For temporary table tmp_20180508195517_codegen_7t8q93_ads_sca_2_out part 2. Populate

INSERT INTO tmp_20180508195517_codegen_7t8q93_ads_sca_2_out (`KEY`, scaler_output_2, scaler_output_3, scaler_output_4, scaler_output_5) SELECT `ADS_sca_2_OUT`.`KEY`, `ADS_sca_2_OUT`.scaler_output_2, `ADS_sca_2_OUT`.scaler_output_3, `ADS_sca_2_OUT`.scaler_output_4, `ADS_sca_2_OUT`.scaler_output_5 
...
FROM tmp_20180508195517_codegen_k0y3qx_ads_imp_1_out AS `ADS_imp_1_OUT`) AS `ADS_sca_2_OUT`

-- Code For temporary table tmp_20180508195517_codegen_d0qod0_xgb_b0 part 1. Create 


CREATE TABLE tmp_20180508195517_codegen_d0qod0_xgb_b0 (
	`KEY` BIGINT, 
...
-- Code For temporary table tmp_20180508195517_codegen_d0qod0_xgb_b0 part 2. Populate
...
FROM tmp_20180508195517_codegen_7t8q93_ads_sca_2_out AS `ADS_sca_2_OUT`), 
`DT_node_data` AS 
...
-- Code For temporary table tmp_20180508195517_codegen_etatd9_xgb_b1 part 1. Create 


CREATE TABLE tmp_20180508195517_codegen_etatd9_xgb_b1 (
	`KEY` BIGINT, 
	`Score_1789-07-14T00:00:00.000000000` DOUBLE, 
	`Score_1789-08-14T00:00:00.000000000` DOUBLE, 
	`Score_1789-09-14T00:00:00.000000000` DOUBLE
...
-- Code For temporary table tmp_20180508195517_codegen_etatd9_xgb_b1 part 2. Populate
...
-- Code For temporary table tmp_20180508195517_codegen_j26p8f_xgb_b2 part 1. Create 


CREATE TABLE tmp_20180508195517_codegen_j26p8f_xgb_b2 (
	`KEY` BIGINT, 
	`Score_1789-07-14T00:00:00.000000000` DOUBLE, 
	`Score_1789-08-14T00:00:00.000000000` DOUBLE, 
	`Score_1789-09-14T00:00:00.000000000` DOUBLE
...
-- Code For temporary table tmp_20180508195517_codegen_j26p8f_xgb_b2 part 2. Populate
...
-- Code For temporary table tmp_20180508195517_codegen_d3rgos_xgb_b3 part 1. Create 


CREATE TABLE tmp_20180508195517_codegen_d3rgos_xgb_b3 (
	`KEY` BIGINT, 
	`Score_1789-07-14T00:00:00.000000000` DOUBLE, 
	`Score_1789-08-14T00:00:00.000000000` DOUBLE, 
	`Score_1789-09-14T00:00:00.000000000` DOUBLE
...
-- Code For temporary table tmp_20180508195517_codegen_d3rgos_xgb_b3 part 2. Populate
...
-- Code For temporary table tmp_20180508195517_codegen_4hr9zz_xgb_b4 part 1. Create 


CREATE TABLE tmp_20180508195517_codegen_4hr9zz_xgb_b4 (
	`KEY` BIGINT, 
	`Score_1789-07-14T00:00:00.000000000` DOUBLE, 
	`Score_1789-08-14T00:00:00.000000000` DOUBLE, 
	`Score_1789-09-14T00:00:00.000000000` DOUBLE
...
-- Code For temporary table tmp_20180508195517_codegen_4hr9zz_xgb_b4 part 2. Populate
...
-- Code For temporary table tmp_20180508195517_codegen_nk3osa_xgb_union part 1. Create 


CREATE TABLE tmp_20180508195517_codegen_nk3osa_xgb_union (
	`KEY` BIGINT, 
	`Score_1789-07-14T00:00:00.000000000` DOUBLE, 
	`Score_1789-08-14T00:00:00.000000000` DOUBLE, 
	`Score_1789-09-14T00:00:00.000000000` DOUBLE
...
FROM tmp_20180508195517_codegen_d0qod0_xgb_b0 AS `XGB_B0` UNION ALL SELECT `XGB_B1`.`KEY` AS `KEY`, `XGB_B1`.`Score_1789-07-14T00:00:00.000000000` AS `Score_1789-07-14T00:00:00.000000000`, `XGB_B1`.`Score_1789-08-14T00:00:00.000000000` AS `Score_1789-08-14T00:00:00.000000000`, `XGB_B1`.`Score_1789-09-14T00:00:00.000000000` AS `Score_1789-09-14T00:00:00.000000000` 
FROM tmp_20180508195517_codegen_etatd9_xgb_b1 AS `XGB_B1` UNION ALL SELECT `XGB_B2`.`KEY` AS `KEY`, `XGB_B2`.`Score_1789-07-14T00:00:00.000000000` AS `Score_1789-07-14T00:00:00.000000000`, `XGB_B2`.`Score_1789-08-14T00:00:00.000000000` AS `Score_1789-08-14T00:00:00.000000000`, `XGB_B2`.`Score_1789-09-14T00:00:00.000000000` AS `Score_1789-09-14T00:00:00.000000000` 
FROM tmp_20180508195517_codegen_j26p8f_xgb_b2 AS `XGB_B2` UNION ALL SELECT `XGB_B3`.`KEY` AS `KEY`, `XGB_B3`.`Score_1789-07-14T00:00:00.000000000` AS `Score_1789-07-14T00:00:00.000000000`, `XGB_B3`.`Score_1789-08-14T00:00:00.000000000` AS `Score_1789-08-14T00:00:00.000000000`, `XGB_B3`.`Score_1789-09-14T00:00:00.000000000` AS `Score_1789-09-14T00:00:00.000000000` 
FROM tmp_20180508195517_codegen_d3rgos_xgb_b3 AS `XGB_B3` UNION ALL SELECT `XGB_B4`.`KEY` AS `KEY`, `XGB_B4`.`Score_1789-07-14T00:00:00.000000000` AS `Score_1789-07-14T00:00:00.000000000`, `XGB_B4`.`Score_1789-08-14T00:00:00.000000000` AS `Score_1789-08-14T00:00:00.000000000`, `XGB_B4`.`Score_1789-09-14T00:00:00.000000000` AS `Score_1789-09-14T00:00:00.000000000` 
FROM tmp_20180508195517_codegen_4hr9zz_xgb_b4 AS `XGB_B4`) AS `XGB_EnsembleUnion`) AS `XGB_Union`

-- Code For temporary table tmp_20180508195517_codegen_v8itmp_xgb_sum part 1. Create 


CREATE TABLE tmp_20180508195517_codegen_v8itmp_xgb_sum (
	`KEY` BIGINT, 
	`Score_1789-07-14T00:00:00.000000000` DOUBLE, 
	`Score_1789-08-14T00:00:00.000000000` DOUBLE, 
	`Score_1789-09-14T00:00:00.000000000` DOUBLE
...
FROM tmp_20180508195517_codegen_nk3osa_xgb_union AS `XGB_Union` GROUP BY `XGB_Union`.`KEY`) AS `T`) AS `XGB_sum`
...
FROM tmp_20180508195517_codegen_v8itmp_xgb_sum AS `XGB_sum`), 
