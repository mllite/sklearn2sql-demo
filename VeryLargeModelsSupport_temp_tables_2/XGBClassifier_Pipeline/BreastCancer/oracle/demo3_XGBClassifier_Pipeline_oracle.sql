...
-- Code For temporary table DEGEN_CDQPCD_ADS_IMP_1_OUT part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "DEGEN_CDQPCD_ADS_IMP_1_OUT" (
	"KEY" NUMBER(19), 
...
-- Code For temporary table DEGEN_CDQPCD_ADS_IMP_1_OUT part 2. Populate

INSERT INTO "DEGEN_CDQPCD_ADS_IMP_1_OUT" ("KEY", impter_2, impter_3, impter_4, impter_5, impter_6, impter_7, impter_8, impter_9, impter_10, impter_11, impter_12, impter_13, impter_14, impter_15, impter_16, impter_17, impter_18, impter_19, impter_20, impter_21, impter_22, impter_23, impter_24, impter_25, impter_26, impter_27, impter_28, impter_29, impter_30, impter_31) SELECT "U"."KEY", "U".impter_2, "U".impter_3, "U".impter_4, "U".impter_5, "U".impter_6, "U".impter_7, "U".impter_8, "U".impter_9, "U".impter_10, "U".impter_11, "U".impter_12, "U".impter_13, "U".impter_14, "U".impter_15, "U".impter_16, "U".impter_17, "U".impter_18, "U".impter_19, "U".impter_20, "U".impter_21, "U".impter_22, "U".impter_23, "U".impter_24, "U".impter_25, "U".impter_26, "U".impter_27, "U".impter_28, "U".impter_29, "U".impter_30, "U".impter_31 
...
-- Code For temporary table DEGEN_3S8F5V_ADS_SCA_2_OUT part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "DEGEN_3S8F5V_ADS_SCA_2_OUT" (
	"KEY" NUMBER(19), 
...
FROM "DEGEN_CDQPCD_ADS_IMP_1_OUT" "ADS_imp_1_OUT") "ADS_sca_2_OUT") "U"

-- Code For temporary table 1039_CODEGEN_S5TWUG_XGB_B0 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "1039_CODEGEN_S5TWUG_XGB_B0" (
	"KEY" NUMBER(19), 
...
-- Code For temporary table 1039_CODEGEN_S5TWUG_XGB_B0 part 2. Populate

INSERT INTO "1039_CODEGEN_S5TWUG_XGB_B0" ("KEY", "Score_0") SELECT "U"."KEY", "U"."Score_0" 
...
FROM "DEGEN_3S8F5V_ADS_SCA_2_OUT" "ADS_sca_2_OUT"), 
"DT_node_data" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS BINARY_DOUBLE) AS "Score" 
FROM (SELECT 3 AS nid, 0.1926199346780777 AS "Score" FROM DUAL UNION ALL SELECT 4 AS nid, 0.03478261083364487 AS "Score" FROM DUAL UNION ALL SELECT 5 AS nid, -0.12727272510528564 AS "Score" FROM DUAL UNION ALL SELECT 6 AS nid, -0.19272726774215698 AS "Score" FROM DUAL) "Values"), 
"DT_Output" AS 
...
"DT_node_data_1" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS BINARY_DOUBLE) AS "Score" 
FROM (SELECT 3 AS nid, 0.17632412910461426 AS "Score" FROM DUAL UNION ALL SELECT 4 AS nid, 0.028210192918777466 AS "Score" FROM DUAL UNION ALL SELECT 5 AS nid, -0.11695275455713272 AS "Score" FROM DUAL UNION ALL SELECT 6 AS nid, -0.17597316205501556 AS "Score" FROM DUAL) "Values"), 
"DT_Output_1" AS 
...
"DT_node_data_2" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS BINARY_DOUBLE) AS "Score" 
FROM (SELECT 2 AS nid, -0.15892711281776428 AS "Score" FROM DUAL UNION ALL SELECT 3 AS nid, 0.16254661977291107 AS "Score" FROM DUAL UNION ALL SELECT 4 AS nid, 0.0025618381332606077 AS "Score" FROM DUAL) "Values"), 
"DT_Output_2" AS 
...
"DT_node_data_3" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS BINARY_DOUBLE) AS "Score" 
FROM (SELECT 3 AS nid, 0.1533551663160324 AS "Score" FROM DUAL UNION ALL SELECT 4 AS nid, 0.02111710235476494 AS "Score" FROM DUAL UNION ALL SELECT 5 AS nid, -0.1014096662402153 AS "Score" FROM DUAL UNION ALL SELECT 6 AS nid, -0.15645359456539154 AS "Score" FROM DUAL) "Values"), 
"DT_Output_3" AS 
...
"DT_node_data_4" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS BINARY_DOUBLE) AS "Score" 
FROM (SELECT 2 AS nid, -0.14159958064556122 AS "Score" FROM DUAL UNION ALL SELECT 3 AS nid, 0.14474166929721832 AS "Score" FROM DUAL UNION ALL SELECT 4 AS nid, 0.007800843566656113 AS "Score" FROM DUAL) "Values"), 
"DT_Output_4" AS 
...
"DT_node_data_5" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS BINARY_DOUBLE) AS "Score" 
FROM (SELECT 2 AS nid, -0.14109736680984497 AS "Score" FROM DUAL UNION ALL SELECT 3 AS nid, 0.1364816427230835 AS "Score" FROM DUAL UNION ALL SELECT 4 AS nid, -0.014269627630710602 AS "Score" FROM DUAL) "Values"), 
"DT_Output_5" AS 
...
"DT_node_data_6" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS BINARY_DOUBLE) AS "Score" 
FROM (SELECT 3 AS nid, 0.13363148272037506 AS "Score" FROM DUAL UNION ALL SELECT 4 AS nid, 0.020645752549171448 AS "Score" FROM DUAL UNION ALL SELECT 5 AS nid, -0.07329749315977097 AS "Score" FROM DUAL UNION ALL SELECT 6 AS nid, -0.13540911674499512 AS "Score" FROM DUAL) "Values"), 
"DT_Output_6" AS 
...
"DT_node_data_7" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS BINARY_DOUBLE) AS "Score" 
FROM (SELECT 3 AS nid, 0.1283390074968338 AS "Score" FROM DUAL UNION ALL SELECT 4 AS nid, 0.014707544818520546 AS "Score" FROM DUAL UNION ALL SELECT 5 AS nid, -0.07714793086051941 AS "Score" FROM DUAL UNION ALL SELECT 6 AS nid, -0.133819118142128 AS "Score" FROM DUAL) "Values"), 
"DT_Output_7" AS 
...
"DT_node_data_8" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS BINARY_DOUBLE) AS "Score" 
FROM (SELECT 3 AS nid, 0.12476612627506256 AS "Score" FROM DUAL UNION ALL SELECT 4 AS nid, 0.01592203602194786 AS "Score" FROM DUAL UNION ALL SELECT 5 AS nid, -0.06960324943065643 AS "Score" FROM DUAL UNION ALL SELECT 6 AS nid, -0.13226597011089325 AS "Score" FROM DUAL) "Values"), 
"DT_Output_8" AS 
...
"DT_node_data_9" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS BINARY_DOUBLE) AS "Score" 
FROM (SELECT 2 AS nid, -0.12262566387653351 AS "Score" FROM DUAL UNION ALL SELECT 3 AS nid, 0.11848687380552292 AS "Score" FROM DUAL UNION ALL SELECT 4 AS nid, -0.006392433773726225 AS "Score" FROM DUAL) "Values"), 
"DT_Output_9" AS 
...
-- Code For temporary table 1039_CODEGEN_486ZIZ_XGB_B1 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "1039_CODEGEN_486ZIZ_XGB_B1" (
	"KEY" NUMBER(19), 
	"Score_0" BINARY_DOUBLE
)
...
-- Code For temporary table 1039_CODEGEN_486ZIZ_XGB_B1 part 2. Populate

INSERT INTO "1039_CODEGEN_486ZIZ_XGB_B1" ("KEY", "Score_0") SELECT "U"."KEY", "U"."Score_0" 
...
"DT_node_data_10" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS BINARY_DOUBLE) AS "Score" 
FROM (SELECT 3 AS nid, 0.11701875180006027 AS "Score" FROM DUAL UNION ALL SELECT 4 AS nid, 0.016944319009780884 AS "Score" FROM DUAL UNION ALL SELECT 5 AS nid, -0.07019593566656113 AS "Score" FROM DUAL UNION ALL SELECT 6 AS nid, -0.12330199778079987 AS "Score" FROM DUAL) "Values"), 
"DT_Output_10" AS 
...
"DT_node_data_11" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS BINARY_DOUBLE) AS "Score" 
FROM (SELECT 3 AS nid, 0.11512360721826553 AS "Score" FROM DUAL UNION ALL SELECT 4 AS nid, 0.017077675089240074 AS "Score" FROM DUAL UNION ALL SELECT 5 AS nid, -0.06643888354301453 AS "Score" FROM DUAL UNION ALL SELECT 6 AS nid, -0.12265763431787491 AS "Score" FROM DUAL) "Values"), 
"DT_Output_11" AS 
...
"DT_node_data_12" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS BINARY_DOUBLE) AS "Score" 
FROM (SELECT 2 AS nid, -0.11374557018280029 AS "Score" FROM DUAL UNION ALL SELECT 4 AS nid, -0.003493115771561861 AS "Score" FROM DUAL UNION ALL SELECT 5 AS nid, 0.07863019406795502 AS "Score" FROM DUAL UNION ALL SELECT 6 AS nid, 0.11759652942419052 AS "Score" FROM DUAL) "Values"), 
"DT_Output_12" AS 
...
"DT_node_data_13" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS BINARY_DOUBLE) AS "Score" 
FROM (SELECT 2 AS nid, -0.10585534572601318 AS "Score" FROM DUAL UNION ALL SELECT 4 AS nid, -0.0024481695145368576 AS "Score" FROM DUAL UNION ALL SELECT 5 AS nid, 0.07931221276521683 AS "Score" FROM DUAL UNION ALL SELECT 6 AS nid, 0.11873737722635269 AS "Score" FROM DUAL) "Values"), 
"DT_Output_13" AS 
...
"DT_node_data_14" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS BINARY_DOUBLE) AS "Score" 
FROM (SELECT 3 AS nid, 0.10965307056903839 AS "Score" FROM DUAL UNION ALL SELECT 4 AS nid, 0.012755125761032104 AS "Score" FROM DUAL UNION ALL SELECT 5 AS nid, -0.06810056418180466 AS "Score" FROM DUAL UNION ALL SELECT 6 AS nid, -0.11264988034963608 AS "Score" FROM DUAL) "Values"), 
"DT_Output_14" AS 
...
"DT_node_data_15" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS BINARY_DOUBLE) AS "Score" 
FROM (SELECT 2 AS nid, -0.10041051357984543 AS "Score" FROM DUAL UNION ALL SELECT 3 AS nid, 0.1078338772058487 AS "Score" FROM DUAL UNION ALL SELECT 4 AS nid, 0.0019829440861940384 AS "Score" FROM DUAL) "Values"), 
"DT_Output_15" AS 
...
-- Code For temporary table 9_CODEGEN_SK9OZ3_XGB_UNION part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "9_CODEGEN_SK9OZ3_XGB_UNION" (
	"KEY" NUMBER(19), 
	"Score_0" BINARY_DOUBLE
)
...
-- Code For temporary table 9_CODEGEN_SK9OZ3_XGB_UNION part 2. Populate

INSERT INTO "9_CODEGEN_SK9OZ3_XGB_UNION" ("KEY", "Score_0") SELECT "U"."KEY", "U"."Score_0" 
...
FROM "1039_CODEGEN_S5TWUG_XGB_B0" "XGB_B0" UNION ALL SELECT "XGB_B1"."KEY" AS "KEY", "XGB_B1"."Score_0" AS "Score_0" 
FROM "1039_CODEGEN_486ZIZ_XGB_B1" "XGB_B1") "XGB_EnsembleUnion") "XGB_Union") "U"

-- Code For temporary table 039_CODEGEN_FC4IHK_XGB_SUM part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "039_CODEGEN_FC4IHK_XGB_SUM" (
	"KEY" NUMBER(19), 
	"Score_0" BINARY_DOUBLE
)
...
-- Code For temporary table 039_CODEGEN_FC4IHK_XGB_SUM part 2. Populate

INSERT INTO "039_CODEGEN_FC4IHK_XGB_SUM" ("KEY", "Score_0") SELECT "U"."KEY", "U"."Score_0" 
...
FROM "9_CODEGEN_SK9OZ3_XGB_UNION" "XGB_Union" GROUP BY "XGB_Union"."KEY") "T") "XGB_sum") "U"
...
FROM "039_CODEGEN_FC4IHK_XGB_SUM" "XGB_sum"), 
