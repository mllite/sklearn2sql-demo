...
-- Code For temporary table TMP_20180508180933_CODEGEN_3A2A part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508180933_CODEGEN_3A2A" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20180508180933_CODEGEN_3A2A part 3. Create Index 

CREATE INDEX "ix_TMP_20180508180933_C_def7" ON "TMP_20180508180933_CODEGEN_3A2A" ("KEY")

-- Code For temporary table TMP_20180508180933_CODEGEN_DWTM part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508180933_CODEGEN_DWTM" (
	"KEY" BIGINT NOT NULL, 
...
FROM "TMP_20180508180933_CODEGEN_3A2A" AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT") AS "U"

-- Code For temporary table TMP_20180508180933_CODEGEN_DWTM part 3. Create Index 

CREATE INDEX "ix_TMP_20180508180933_C_832a" ON "TMP_20180508180933_CODEGEN_DWTM" ("KEY")
...
FROM "TMP_20180508180933_CODEGEN_DWTM" AS "ADS_sca_2_OUT"), 
linear_model_cte AS 
