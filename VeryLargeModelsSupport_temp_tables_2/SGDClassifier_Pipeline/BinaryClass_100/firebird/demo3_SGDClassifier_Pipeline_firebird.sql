...
-- Code For temporary table TMP_20180508180443_CODEGEN_FHCJ part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508180443_CODEGEN_FHCJ" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20180508180443_CODEGEN_FHCJ part 3. Create Index 

CREATE INDEX "ix_TMP_20180508180443_C_87a8" ON "TMP_20180508180443_CODEGEN_FHCJ" ("KEY")

-- Code For temporary table TMP_20180508180443_CODEGEN_NOQZ part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508180443_CODEGEN_NOQZ" (
	"KEY" BIGINT NOT NULL, 
...
FROM "TMP_20180508180443_CODEGEN_FHCJ" AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT") AS "U"

-- Code For temporary table TMP_20180508180443_CODEGEN_NOQZ part 3. Create Index 

CREATE INDEX "ix_TMP_20180508180443_C_3bc4" ON "TMP_20180508180443_CODEGEN_NOQZ" ("KEY")
...
FROM "TMP_20180508180443_CODEGEN_NOQZ" AS "ADS_sca_2_OUT"), 
linear_model_cte AS 
