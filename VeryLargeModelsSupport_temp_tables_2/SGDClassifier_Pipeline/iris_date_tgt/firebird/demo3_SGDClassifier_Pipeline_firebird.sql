...
-- Code For temporary table TMP_20180508190242_CODEGEN_DRGM part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508190242_CODEGEN_DRGM" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20180508190242_CODEGEN_DRGM part 2. Populate

INSERT INTO "TMP_20180508190242_CODEGEN_DRGM" ("KEY", imputer_output_2, imputer_output_3, imputer_output_4, imputer_output_5) SELECT "U"."KEY", "U".imputer_output_2, "U".imputer_output_3, "U".imputer_output_4, "U".imputer_output_5 
...
-- Code For temporary table TMP_20180508190242_CODEGEN_DRGM part 3. Create Index 

CREATE INDEX "ix_TMP_20180508190242_C_43c4" ON "TMP_20180508190242_CODEGEN_DRGM" ("KEY")

-- Code For temporary table TMP_20180508190242_CODEGEN_5W1I part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508190242_CODEGEN_5W1I" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20180508190242_CODEGEN_5W1I part 2. Populate

INSERT INTO "TMP_20180508190242_CODEGEN_5W1I" ("KEY", scaler_output_2, scaler_output_3, scaler_output_4, scaler_output_5) SELECT "U"."KEY", "U".scaler_output_2, "U".scaler_output_3, "U".scaler_output_4, "U".scaler_output_5 
...
FROM "TMP_20180508190242_CODEGEN_DRGM" AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT") AS "U"

-- Code For temporary table TMP_20180508190242_CODEGEN_5W1I part 3. Create Index 

CREATE INDEX "ix_TMP_20180508190242_C_f79e" ON "TMP_20180508190242_CODEGEN_5W1I" ("KEY")
...
FROM "TMP_20180508190242_CODEGEN_5W1I" AS "ADS_sca_2_OUT"), 
linear_model_cte AS 
