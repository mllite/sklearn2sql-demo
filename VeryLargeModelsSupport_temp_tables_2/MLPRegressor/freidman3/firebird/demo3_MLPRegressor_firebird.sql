...
-- Code For temporary table TMP_20180508185223_CODEGEN_G56W part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508185223_CODEGEN_G56W" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20180508185223_CODEGEN_G56W part 2. Populate

INSERT INTO "TMP_20180508185223_CODEGEN_G56W" ("KEY", "NEUR_1_1", "NEUR_1_2", "NEUR_1_3") SELECT "U"."KEY", "U"."NEUR_1_1", "U"."NEUR_1_2", "U"."NEUR_1_3" 
FROM (WITH "IL" AS 
...
-- Code For temporary table TMP_20180508185223_CODEGEN_G56W part 3. Create Index 

CREATE INDEX "ix_TMP_20180508185223_C_ffe2" ON "TMP_20180508185223_CODEGEN_G56W" ("KEY")

-- Code For temporary table TMP_20180508185223_CODEGEN_Y312 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508185223_CODEGEN_Y312" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20180508185223_CODEGEN_Y312 part 2. Populate

INSERT INTO "TMP_20180508185223_CODEGEN_Y312" ("KEY", "NEUR_3_1") SELECT "U"."KEY", "U"."NEUR_3_1" 
...
FROM "TMP_20180508185223_CODEGEN_G56W" AS "HL_1_relu_1"), 
"HL_2_relu" AS 
...
-- Code For temporary table TMP_20180508185223_CODEGEN_Y312 part 3. Create Index 

CREATE INDEX "ix_TMP_20180508185223_C_4b69" ON "TMP_20180508185223_CODEGEN_Y312" ("KEY")

-- Model deployment code

SELECT "OL_identity_1"."KEY" AS "KEY", "OL_identity_1"."NEUR_3_1" AS "Estimator" 
FROM "TMP_20180508185223_CODEGEN_Y312" AS "OL_identity_1"