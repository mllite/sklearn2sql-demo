...
-- Code For temporary table TMP_20180508183420_CODEGEN_T9DQ part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508183420_CODEGEN_T9DQ" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20180508183420_CODEGEN_T9DQ part 2. Populate

INSERT INTO "TMP_20180508183420_CODEGEN_T9DQ" ("KEY", "NEUR_1_1", "NEUR_1_2", "NEUR_1_3") SELECT "U"."KEY", "U"."NEUR_1_1", "U"."NEUR_1_2", "U"."NEUR_1_3" 
FROM (WITH "IL" AS 
...
-- Code For temporary table TMP_20180508183420_CODEGEN_T9DQ part 3. Create Index 

CREATE INDEX "ix_TMP_20180508183420_C_3706" ON "TMP_20180508183420_CODEGEN_T9DQ" ("KEY")

-- Code For temporary table TMP_20180508183420_CODEGEN_W36N part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508183420_CODEGEN_W36N" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20180508183420_CODEGEN_W36N part 2. Populate

INSERT INTO "TMP_20180508183420_CODEGEN_W36N" ("KEY", "NEUR_3_1") SELECT "U"."KEY", "U"."NEUR_3_1" 
...
FROM "TMP_20180508183420_CODEGEN_T9DQ" AS "HL_1_relu_1"), 
"HL_2_relu" AS 
...
-- Code For temporary table TMP_20180508183420_CODEGEN_W36N part 3. Create Index 

CREATE INDEX "ix_TMP_20180508183420_C_326e" ON "TMP_20180508183420_CODEGEN_W36N" ("KEY")

-- Model deployment code

SELECT "OL_identity_1"."KEY" AS "KEY", "OL_identity_1"."NEUR_3_1" AS "Estimator" 
FROM "TMP_20180508183420_CODEGEN_W36N" AS "OL_identity_1"