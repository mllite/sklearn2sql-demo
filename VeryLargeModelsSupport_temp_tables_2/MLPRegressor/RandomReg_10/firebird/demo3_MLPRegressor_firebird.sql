...
-- Code For temporary table TMP_20180508182242_CODEGEN_8GAD part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508182242_CODEGEN_8GAD" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20180508182242_CODEGEN_8GAD part 2. Populate

INSERT INTO "TMP_20180508182242_CODEGEN_8GAD" ("KEY", "NEUR_1_1", "NEUR_1_2", "NEUR_1_3") SELECT "U"."KEY", "U"."NEUR_1_1", "U"."NEUR_1_2", "U"."NEUR_1_3" 
FROM (WITH "IL" AS 
...
-- Code For temporary table TMP_20180508182242_CODEGEN_8GAD part 3. Create Index 

CREATE INDEX "ix_TMP_20180508182242_C_b487" ON "TMP_20180508182242_CODEGEN_8GAD" ("KEY")

-- Code For temporary table TMP_20180508182242_CODEGEN_2JP5 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508182242_CODEGEN_2JP5" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20180508182242_CODEGEN_2JP5 part 2. Populate

INSERT INTO "TMP_20180508182242_CODEGEN_2JP5" ("KEY", "NEUR_3_1") SELECT "U"."KEY", "U"."NEUR_3_1" 
...
FROM "TMP_20180508182242_CODEGEN_8GAD" AS "HL_1_relu_1"), 
"HL_2_relu" AS 
...
-- Code For temporary table TMP_20180508182242_CODEGEN_2JP5 part 3. Create Index 

CREATE INDEX "ix_TMP_20180508182242_C_1941" ON "TMP_20180508182242_CODEGEN_2JP5" ("KEY")

-- Model deployment code

SELECT "OL_identity_1"."KEY" AS "KEY", "OL_identity_1"."NEUR_3_1" AS "Estimator" 
FROM "TMP_20180508182242_CODEGEN_2JP5" AS "OL_identity_1"