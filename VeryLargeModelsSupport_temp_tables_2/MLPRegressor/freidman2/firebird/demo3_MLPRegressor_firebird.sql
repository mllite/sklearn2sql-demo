...
-- Code For temporary table TMP_20180508184844_CODEGEN_I6EF part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508184844_CODEGEN_I6EF" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20180508184844_CODEGEN_I6EF part 2. Populate

INSERT INTO "TMP_20180508184844_CODEGEN_I6EF" ("KEY", "NEUR_1_1", "NEUR_1_2", "NEUR_1_3") SELECT "U"."KEY", "U"."NEUR_1_1", "U"."NEUR_1_2", "U"."NEUR_1_3" 
FROM (WITH "IL" AS 
...
-- Code For temporary table TMP_20180508184844_CODEGEN_I6EF part 3. Create Index 

CREATE INDEX "ix_TMP_20180508184844_C_cd58" ON "TMP_20180508184844_CODEGEN_I6EF" ("KEY")

-- Code For temporary table TMP_20180508184844_CODEGEN_WV08 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508184844_CODEGEN_WV08" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20180508184844_CODEGEN_WV08 part 2. Populate

INSERT INTO "TMP_20180508184844_CODEGEN_WV08" ("KEY", "NEUR_3_1") SELECT "U"."KEY", "U"."NEUR_3_1" 
...
FROM "TMP_20180508184844_CODEGEN_I6EF" AS "HL_1_relu_1"), 
"HL_2_relu" AS 
...
-- Code For temporary table TMP_20180508184844_CODEGEN_WV08 part 3. Create Index 

CREATE INDEX "ix_TMP_20180508184844_C_10dc" ON "TMP_20180508184844_CODEGEN_WV08" ("KEY")

-- Model deployment code

SELECT "OL_identity_1"."KEY" AS "KEY", "OL_identity_1"."NEUR_3_1" AS "Estimator" 
FROM "TMP_20180508184844_CODEGEN_WV08" AS "OL_identity_1"