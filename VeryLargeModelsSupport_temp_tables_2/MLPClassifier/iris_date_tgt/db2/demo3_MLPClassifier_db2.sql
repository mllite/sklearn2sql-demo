...
-- Code For temporary table tmp_20180508190154_codegen_vn9d2r_hl_1_relu_1 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180508190154_codegen_vn9d2r_hl_1_relu_1 (
	"KEY" BIGINT, 
	"NEUR_1_1" DOUBLE, 
	"NEUR_1_2" DOUBLE, 
	"NEUR_1_3" DOUBLE
...
-- Code For temporary table tmp_20180508190154_codegen_vn9d2r_hl_1_relu_1 part 2. Populate

INSERT INTO tmp_20180508190154_codegen_vn9d2r_hl_1_relu_1 WITH "IL" AS 
...
-- Code For temporary table tmp_20180508190154_codegen_btgswn_ol_softmax_1 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180508190154_codegen_btgswn_ol_softmax_1 (
	"KEY" BIGINT, 
	"NEUR_3_1" DOUBLE, 
	"NEUR_3_2" DOUBLE, 
	"NEUR_3_3" DOUBLE
...
-- Code For temporary table tmp_20180508190154_codegen_btgswn_ol_softmax_1 part 2. Populate

INSERT INTO tmp_20180508190154_codegen_btgswn_ol_softmax_1 WITH "HL_BA_2" AS 
...
FROM tmp_20180508190154_codegen_vn9d2r_hl_1_relu_1 AS "HL_1_relu_1"), 
"HL_2_relu" AS 
...
FROM tmp_20180508190154_codegen_btgswn_ol_softmax_1 AS "OL_softmax_1"), 
