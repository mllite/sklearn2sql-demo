...
linear_model_cte AS 
(SELECT linear_input."KEY" AS "KEY", CAST(13.758599124452749 AS DOUBLE PRECISION) * linear_input."Feature_0" + CAST(46.27892432770464 AS DOUBLE PRECISION) * linear_input."Feature_1" + CAST(-63.164477798623885 AS DOUBLE PRECISION) * linear_input."Feature_2" + CAST(-26.26641651031884 AS DOUBLE PRECISION) * linear_input."Feature_3" + CAST(9.771784785528839 AS DOUBLE PRECISION) AS "Score_CLASS_0", CAST(23.764853033145435 AS DOUBLE PRECISION) * linear_input."Feature_0" + CAST(-135.08442776735436 AS DOUBLE PRECISION) * linear_input."Feature_1" + CAST(-8.130081300813004 AS DOUBLE PRECISION) * linear_input."Feature_2" + CAST(-71.91994996873042 AS DOUBLE PRECISION) * linear_input."Feature_3" + CAST(39.25300669771319 AS DOUBLE PRECISION) AS "Score_CLASS_1", CAST(-117.57348342714158 AS DOUBLE PRECISION) * linear_input."Feature_0" + CAST(-99.43714821763571 AS DOUBLE PRECISION) * linear_input."Feature_1" + CAST(176.36022514071246 AS DOUBLE PRECISION) * linear_input."Feature_2" + CAST(135.08442776735419 AS DOUBLE PRECISION) * linear_input."Feature_3" + CAST(-75.97597864541908 AS DOUBLE PRECISION) AS "Score_CLASS_2" 
FROM linear_input), 
