...
-- Code For temporary table TMP_20180508190036_CODEGEN_S6QL part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508190036_CODEGEN_S6QL" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20180508190036_CODEGEN_S6QL part 2. Populate

INSERT INTO "TMP_20180508190036_CODEGEN_S6QL" ("KEY", imputer_output_2, imputer_output_3, imputer_output_4, imputer_output_5) SELECT "U"."KEY", "U".imputer_output_2, "U".imputer_output_3, "U".imputer_output_4, "U".imputer_output_5 
...
-- Code For temporary table TMP_20180508190036_CODEGEN_S6QL part 3. Create Index 

CREATE INDEX "ix_TMP_20180508190036_C_8ad6" ON "TMP_20180508190036_CODEGEN_S6QL" ("KEY")

-- Code For temporary table TMP_20180508190036_CODEGEN_9PW3 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508190036_CODEGEN_9PW3" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20180508190036_CODEGEN_9PW3 part 2. Populate

INSERT INTO "TMP_20180508190036_CODEGEN_9PW3" ("KEY", scaler_output_2, scaler_output_3, scaler_output_4, scaler_output_5) SELECT "U"."KEY", "U".scaler_output_2, "U".scaler_output_3, "U".scaler_output_4, "U".scaler_output_5 
...
FROM "TMP_20180508190036_CODEGEN_S6QL" AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT") AS "U"

-- Code For temporary table TMP_20180508190036_CODEGEN_9PW3 part 3. Create Index 

CREATE INDEX "ix_TMP_20180508190036_C_1fc8" ON "TMP_20180508190036_CODEGEN_9PW3" ("KEY")
...
FROM "TMP_20180508190036_CODEGEN_9PW3" AS "ADS_sca_2_OUT"), 
"DT_node_data" AS 
...
FROM "DT_node_lookup" LEFT OUTER JOIN "DT_node_data" ON "DT_node_lookup".node_id_2 = "DT_node_data".nid)
 SELECT "DT_Output"."KEY" AS "KEY", CAST(NULL AS DOUBLE PRECISION) AS "Score_1789-07-14T00:00:00.000000000", CAST(NULL AS DOUBLE PRECISION) AS "Score_1789-08-14T00:00:00.000000000", CAST(NULL AS DOUBLE PRECISION) AS "Score_1789-09-14T00:00:00.000000000", "DT_Output"."P_1789-07-14T00:00:00.000_1" AS "Proba_1789-07-14T00:00:00.000000000", "DT_Output"."P_1789-08-14T00:00:00.000_2" AS "Proba_1789-08-14T00:00:00.000000000", "DT_Output"."P_1789-09-14T00:00:00.000_3" AS "Proba_1789-09-14T00:00:00.000000000", CASE WHEN ("DT_Output"."P_1789-07-14T00:00:00.000_1" IS NULL OR "DT_Output"."P_1789-07-14T00:00:00.000_1" > 0.0) THEN ln("DT_Output"."P_1789-07-14T00:00:00.000_1") ELSE -1e+20 END AS "LogProba_1789-07-14T00:00:00.000000000", CASE WHEN ("DT_Output"."P_1789-08-14T00:00:00.000_2" IS NULL OR "DT_Output"."P_1789-08-14T00:00:00.000_2" > 0.0) THEN ln("DT_Output"."P_1789-08-14T00:00:00.000_2") ELSE -1e+20 END AS "LogProba_1789-08-14T00:00:00.000000000", CASE WHEN ("DT_Output"."P_1789-09-14T00:00:00.000_3" IS NULL OR "DT_Output"."P_1789-09-14T00:00:00.000_3" > 0.0) THEN ln("DT_Output"."P_1789-09-14T00:00:00.000_3") ELSE -1e+20 END AS "LogProba_1789-09-14T00:00:00.000000000", "DT_Output"."D" AS "Decision", "DT_Output"."DP" AS "DecisionProba" 
FROM "DT_Output"