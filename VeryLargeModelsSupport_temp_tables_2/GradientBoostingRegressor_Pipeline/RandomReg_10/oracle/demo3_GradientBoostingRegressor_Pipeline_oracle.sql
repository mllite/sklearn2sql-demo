...
-- Code For temporary table DEGEN_CA9P92_ADS_IMP_1_OUT part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "DEGEN_CA9P92_ADS_IMP_1_OUT" (
	"KEY" NUMBER(19), 
...
-- Code For temporary table DEGEN_CA9P92_ADS_IMP_1_OUT part 2. Populate

INSERT INTO "DEGEN_CA9P92_ADS_IMP_1_OUT" ("KEY", impter_2, impter_3, impter_4, impter_5, impter_6, impter_7, impter_8, impter_9, impter_10, impter_11) SELECT "U"."KEY", "U".impter_2, "U".impter_3, "U".impter_4, "U".impter_5, "U".impter_6, "U".impter_7, "U".impter_8, "U".impter_9, "U".impter_10, "U".impter_11 
...
-- Code For temporary table DEGEN_7V2KR0_ADS_SCA_2_OUT part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "DEGEN_7V2KR0_ADS_SCA_2_OUT" (
	"KEY" NUMBER(19), 
...
-- Code For temporary table DEGEN_7V2KR0_ADS_SCA_2_OUT part 2. Populate

INSERT INTO "DEGEN_7V2KR0_ADS_SCA_2_OUT" ("KEY", scaler_2, scaler_3, scaler_4, scaler_5, scaler_6, scaler_7, scaler_8, scaler_9, scaler_10, scaler_11) SELECT "U"."KEY", "U".scaler_2, "U".scaler_3, "U".scaler_4, "U".scaler_5, "U".scaler_6, "U".scaler_7, "U".scaler_8, "U".scaler_9, "U".scaler_10, "U".scaler_11 
...
FROM "DEGEN_CA9P92_ADS_IMP_1_OUT" "ADS_imp_1_OUT") "ADS_sca_2_OUT") "U"

-- Code For temporary table 82220_CODEGEN_XSPY8U_GB_B0 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "82220_CODEGEN_XSPY8U_GB_B0" (
	"KEY" NUMBER(19), 
...
-- Code For temporary table 82220_CODEGEN_XSPY8U_GB_B0 part 2. Populate

INSERT INTO "82220_CODEGEN_XSPY8U_GB_B0" ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
FROM "DEGEN_7V2KR0_ADS_SCA_2_OUT" "ADS_sca_2_OUT"), 
"DT_node_data" AS 
(SELECT "Values".nid AS nid, CAST("Values"."E" AS BINARY_DOUBLE) AS "E" 
FROM (SELECT 3 AS nid, -208.7780451708557 AS "E" FROM DUAL UNION ALL SELECT 4 AS nid, -437.3409386784606 AS "E" FROM DUAL UNION ALL SELECT 6 AS nid, -113.60421644601387 AS "E" FROM DUAL UNION ALL SELECT 7 AS nid, 122.45884789399581 AS "E" FROM DUAL UNION ALL SELECT 10 AS nid, -309.90060671962567 AS "E" FROM DUAL UNION ALL SELECT 11 AS nid, -32.15578897857857 AS "E" FROM DUAL UNION ALL SELECT 13 AS nid, 61.439924831450156 AS "E" FROM DUAL UNION ALL SELECT 14 AS nid, 231.09071528701512 AS "E" FROM DUAL) "Values"), 
"DT_Output" AS 
...
"DT_node_data_1" AS 
(SELECT "Values".nid AS nid, CAST("Values"."E" AS BINARY_DOUBLE) AS "E" 
FROM (SELECT 3 AS nid, -326.5091064084041 AS "E" FROM DUAL UNION ALL SELECT 4 AS nid, -98.85523416498395 AS "E" FROM DUAL UNION ALL SELECT 6 AS nid, -87.44714659587862 AS "E" FROM DUAL UNION ALL SELECT 7 AS nid, 173.77310999517758 AS "E" FROM DUAL UNION ALL SELECT 10 AS nid, -278.9105460476631 AS "E" FROM DUAL UNION ALL SELECT 11 AS nid, -28.94021008072071 AS "E" FROM DUAL UNION ALL SELECT 13 AS nid, 55.29593234830514 AS "E" FROM DUAL UNION ALL SELECT 14 AS nid, 207.98164375831354 AS "E" FROM DUAL) "Values"), 
"DT_Output_1" AS 
...
"DT_node_data_2" AS 
(SELECT "Values".nid AS nid, CAST("Values"."E" AS BINARY_DOUBLE) AS "E" 
FROM (SELECT 3 AS nid, -176.11170265107646 AS "E" FROM DUAL UNION ALL SELECT 4 AS nid, -368.5443965778881 AS "E" FROM DUAL UNION ALL SELECT 6 AS nid, -96.0390013850018 AS "E" FROM DUAL UNION ALL SELECT 7 AS nid, 99.38716020637538 AS "E" FROM DUAL UNION ALL SELECT 10 AS nid, -251.0194914428968 AS "E" FROM DUAL UNION ALL SELECT 11 AS nid, -26.04618907264864 AS "E" FROM DUAL UNION ALL SELECT 13 AS nid, 75.1277990616216 AS "E" FROM DUAL UNION ALL SELECT 14 AS nid, 204.70712521807272 AS "E" FROM DUAL) "Values"), 
"DT_Output_2" AS 
...
"DT_node_data_3" AS 
(SELECT "Values".nid AS nid, CAST("Values"."E" AS BINARY_DOUBLE) AS "E" 
FROM (SELECT 3 AS nid, -219.68151785911093 AS "E" FROM DUAL UNION ALL SELECT 4 AS nid, 1.5378845252896032 AS "E" FROM DUAL UNION ALL SELECT 6 AS nid, -63.12781904445371 AS "E" FROM DUAL UNION ALL SELECT 7 AS nid, 105.11332453399308 AS "E" FROM DUAL UNION ALL SELECT 9 AS nid, 50.921431639148395 AS "E" FROM DUAL UNION ALL SELECT 11 AS nid, 228.02920133836216 AS "E" FROM DUAL UNION ALL SELECT 12 AS nid, 332.2565374483745 AS "E" FROM DUAL) "Values"), 
"DT_Output_3" AS 
...
"DT_node_data_4" AS 
(SELECT "Values".nid AS nid, CAST("Values"."E" AS BINARY_DOUBLE) AS "E" 
FROM (SELECT 3 AS nid, -252.20320059466073 AS "E" FROM DUAL UNION ALL SELECT 4 AS nid, -121.33851568899895 AS "E" FROM DUAL UNION ALL SELECT 6 AS nid, -48.95960236182337 AS "E" FROM DUAL UNION ALL SELECT 7 AS nid, 137.19688391460684 AS "E" FROM DUAL UNION ALL SELECT 10 AS nid, -37.606554662855785 AS "E" FROM DUAL UNION ALL SELECT 11 AS nid, 125.61672398567936 AS "E" FROM DUAL UNION ALL SELECT 13 AS nid, 137.2470332453415 AS "E" FROM DUAL UNION ALL SELECT 14 AS nid, 245.25440849319094 AS "E" FROM DUAL) "Values"), 
"DT_Output_4" AS 
...
"DT_node_data_5" AS 
(SELECT "Values".nid AS nid, CAST("Values"."E" AS BINARY_DOUBLE) AS "E" 
FROM (SELECT 3 AS nid, -185.9188938422119 AS "E" FROM DUAL UNION ALL SELECT 4 AS nid, -36.723747937807836 AS "E" FROM DUAL UNION ALL SELECT 6 AS nid, -15.39934960835867 AS "E" FROM DUAL UNION ALL SELECT 7 AS nid, 144.6291018939822 AS "E" FROM DUAL UNION ALL SELECT 10 AS nid, 141.14763754957812 AS "E" FROM DUAL UNION ALL SELECT 11 AS nid, 50.72524871141589 AS "E" FROM DUAL UNION ALL SELECT 13 AS nid, 312.1140204097185 AS "E" FROM DUAL UNION ALL SELECT 14 AS nid, 212.21841759685003 AS "E" FROM DUAL) "Values"), 
"DT_Output_5" AS 
...
"DT_node_data_6" AS 
(SELECT "Values".nid AS nid, CAST("Values"."E" AS BINARY_DOUBLE) AS "E" 
FROM (SELECT 3 AS nid, -231.3428255443808 AS "E" FROM DUAL UNION ALL SELECT 4 AS nid, -137.20816742292942 AS "E" FROM DUAL UNION ALL SELECT 6 AS nid, -119.32161195024396 AS "E" FROM DUAL UNION ALL SELECT 7 AS nid, -15.759752657500488 AS "E" FROM DUAL UNION ALL SELECT 10 AS nid, -119.82952352424819 AS "E" FROM DUAL UNION ALL SELECT 11 AS nid, 63.4853201369002 AS "E" FROM DUAL UNION ALL SELECT 13 AS nid, -16.828482683273812 AS "E" FROM DUAL UNION ALL SELECT 14 AS nid, 145.22505636206762 AS "E" FROM DUAL) "Values"), 
"DT_Output_6" AS 
...
"DT_node_data_7" AS 
(SELECT "Values".nid AS nid, CAST("Values"."E" AS BINARY_DOUBLE) AS "E" 
FROM (SELECT 3 AS nid, -216.47369625379196 AS "E" FROM DUAL UNION ALL SELECT 4 AS nid, -149.3176403075912 AS "E" FROM DUAL UNION ALL SELECT 6 AS nid, -107.38945075521956 AS "E" FROM DUAL UNION ALL SELECT 7 AS nid, -14.183777391750445 AS "E" FROM DUAL UNION ALL SELECT 10 AS nid, -201.38345810104735 AS "E" FROM DUAL UNION ALL SELECT 11 AS nid, -39.495759263462226 AS "E" FROM DUAL UNION ALL SELECT 13 AS nid, -25.622143688906046 AS "E" FROM DUAL UNION ALL SELECT 14 AS nid, 105.45885917644819 AS "E" FROM DUAL) "Values"), 
"DT_Output_7" AS 
...
"DT_node_data_8" AS 
(SELECT "Values".nid AS nid, CAST("Values"."E" AS BINARY_DOUBLE) AS "E" 
FROM (SELECT 3 AS nid, -80.37727898797863 AS "E" FROM DUAL UNION ALL SELECT 4 AS nid, 19.67833565380183 AS "E" FROM DUAL UNION ALL SELECT 6 AS nid, 47.48681743313715 AS "E" FROM DUAL UNION ALL SELECT 7 AS nid, 148.22745338219823 AS "E" FROM DUAL UNION ALL SELECT 9 AS nid, 49.89778647749229 AS "E" FROM DUAL UNION ALL SELECT 11 AS nid, 153.53608940557658 AS "E" FROM DUAL UNION ALL SELECT 12 AS nid, 228.62330562896713 AS "E" FROM DUAL) "Values"), 
"DT_Output_8" AS 
...
"DT_node_data_9" AS 
(SELECT "Values".nid AS nid, CAST("Values"."E" AS BINARY_DOUBLE) AS "E" 
FROM (SELECT 3 AS nid, -73.44849390585631 AS "E" FROM DUAL UNION ALL SELECT 4 AS nid, -203.34660361054483 AS "E" FROM DUAL UNION ALL SELECT 6 AS nid, -41.48806981131387 AS "E" FROM DUAL UNION ALL SELECT 7 AS nid, 67.6964481257827 AS "E" FROM DUAL UNION ALL SELECT 9 AS nid, 44.908007829743056 AS "E" FROM DUAL UNION ALL SELECT 11 AS nid, 185.20439923785938 AS "E" FROM DUAL UNION ALL SELECT 12 AS nid, 120.53891850193266 AS "E" FROM DUAL) "Values"), 
"DT_Output_9" AS 
...
-- Code For temporary table 82220_CODEGEN_VLOGBE_GB_B1 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "82220_CODEGEN_VLOGBE_GB_B1" (
	"KEY" NUMBER(19), 
	"Estimator" BINARY_DOUBLE
)
...
-- Code For temporary table 82220_CODEGEN_VLOGBE_GB_B1 part 2. Populate

INSERT INTO "82220_CODEGEN_VLOGBE_GB_B1" ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
"DT_node_data_10" AS 
(SELECT "Values".nid AS nid, CAST("Values"."E" AS BINARY_DOUBLE) AS "E" 
FROM (SELECT 3 AS nid, -118.29201989231404 AS "E" FROM DUAL UNION ALL SELECT 4 AS nid, -25.077426497521834 AS "E" FROM DUAL UNION ALL SELECT 6 AS nid, -30.264161198717826 AS "E" FROM DUAL UNION ALL SELECT 7 AS nid, 86.31775180053027 AS "E" FROM DUAL UNION ALL SELECT 10 AS nid, -66.09975993050688 AS "E" FROM DUAL UNION ALL SELECT 11 AS nid, 62.45645261241293 AS "E" FROM DUAL UNION ALL SELECT 13 AS nid, 83.88369798046719 AS "E" FROM DUAL UNION ALL SELECT 14 AS nid, 316.42361392144784 AS "E" FROM DUAL) "Values"), 
"DT_Output_10" AS 
...
"DT_node_data_11" AS 
(SELECT "Values".nid AS nid, CAST("Values"."E" AS BINARY_DOUBLE) AS "E" 
FROM (SELECT 3 AS nid, -136.61832829293897 AS "E" FROM DUAL UNION ALL SELECT 4 AS nid, -184.6992014939845 AS "E" FROM DUAL UNION ALL SELECT 6 AS nid, -70.42234415250664 AS "E" FROM DUAL UNION ALL SELECT 7 AS nid, 1.3244360712172127 AS "E" FROM DUAL UNION ALL SELECT 10 AS nid, -65.27062830258585 AS "E" FROM DUAL UNION ALL SELECT 11 AS nid, 147.9811246230092 AS "E" FROM DUAL UNION ALL SELECT 13 AS nid, -10.649087022495026 AS "E" FROM DUAL UNION ALL SELECT 14 AS nid, 99.43300470478421 AS "E" FROM DUAL) "Values"), 
"DT_Output_11" AS 
...
"DT_node_data_12" AS 
(SELECT "Values".nid AS nid, CAST("Values"."E" AS BINARY_DOUBLE) AS "E" 
FROM (SELECT 3 AS nid, -115.61454240203253 AS "E" FROM DUAL UNION ALL SELECT 4 AS nid, -34.726895341995366 AS "E" FROM DUAL UNION ALL SELECT 6 AS nid, 14.5657363339971 AS "E" FROM DUAL UNION ALL SELECT 7 AS nid, 252.22129678068407 AS "E" FROM DUAL UNION ALL SELECT 10 AS nid, -3.8267988085527085 AS "E" FROM DUAL UNION ALL SELECT 11 AS nid, 81.075001073378 AS "E" FROM DUAL UNION ALL SELECT 13 AS nid, 235.47886905925594 AS "E" FROM DUAL UNION ALL SELECT 14 AS nid, 79.33495269097298 AS "E" FROM DUAL) "Values"), 
"DT_Output_12" AS 
...
"DT_node_data_13" AS 
(SELECT "Values".nid AS nid, CAST("Values"."E" AS BINARY_DOUBLE) AS "E" 
FROM (SELECT 3 AS nid, -123.89772888428931 AS "E" FROM DUAL UNION ALL SELECT 4 AS nid, -216.00531260592163 AS "E" FROM DUAL UNION ALL SELECT 6 AS nid, -17.928916698609747 AS "E" FROM DUAL UNION ALL SELECT 7 AS nid, -140.25547950272522 AS "E" FROM DUAL UNION ALL SELECT 10 AS nid, -77.24167356823313 AS "E" FROM DUAL UNION ALL SELECT 11 AS nid, 4.27756278838997 AS "E" FROM DUAL UNION ALL SELECT 13 AS nid, 27.77869135277366 AS "E" FROM DUAL UNION ALL SELECT 14 AS nid, 142.3041369154385 AS "E" FROM DUAL) "Values"), 
"DT_Output_13" AS 
...
"DT_node_data_14" AS 
(SELECT "Values".nid AS nid, CAST("Values"."E" AS BINARY_DOUBLE) AS "E" 
FROM (SELECT 3 AS nid, -108.59838640298976 AS "E" FROM DUAL UNION ALL SELECT 4 AS nid, -34.77991094519852 AS "E" FROM DUAL UNION ALL SELECT 6 AS nid, 57.17104373033183 AS "E" FROM DUAL UNION ALL SELECT 7 AS nid, 84.0469458646069 AS "E" FROM DUAL UNION ALL SELECT 10 AS nid, -40.715945135748996 AS "E" FROM DUAL UNION ALL SELECT 11 AS nid, 62.26102820987035 AS "E" FROM DUAL UNION ALL SELECT 13 AS nid, 40.54914463720606 AS "E" FROM DUAL UNION ALL SELECT 14 AS nid, 139.89083647282177 AS "E" FROM DUAL) "Values"), 
"DT_Output_14" AS 
...
"DT_node_data_15" AS 
(SELECT "Values".nid AS nid, CAST("Values"."E" AS BINARY_DOUBLE) AS "E" 
FROM (SELECT 3 AS nid, -83.28721962706736 AS "E" FROM DUAL UNION ALL SELECT 4 AS nid, 0.5306474709200918 AS "E" FROM DUAL UNION ALL SELECT 6 AS nid, -5.689858717217801 AS "E" FROM DUAL UNION ALL SELECT 7 AS nid, 114.3467321860319 AS "E" FROM DUAL UNION ALL SELECT 10 AS nid, 5.642558422999436 AS "E" FROM DUAL UNION ALL SELECT 11 AS nid, 127.53386061277723 AS "E" FROM DUAL UNION ALL SELECT 13 AS nid, -0.3619416936416542 AS "E" FROM DUAL UNION ALL SELECT 14 AS nid, 98.24968541797496 AS "E" FROM DUAL) "Values"), 
"DT_Output_15" AS 
...
-- Code For temporary table 20_CODEGEN_2ZVNTU_GB_UNION part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "20_CODEGEN_2ZVNTU_GB_UNION" (
	"KEY" NUMBER(19), 
	"Estimator" BINARY_DOUBLE
)
...
-- Code For temporary table 20_CODEGEN_2ZVNTU_GB_UNION part 2. Populate

INSERT INTO "20_CODEGEN_2ZVNTU_GB_UNION" ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
FROM "82220_CODEGEN_XSPY8U_GB_B0" "GB_B0" UNION ALL SELECT "GB_B1"."KEY" AS "KEY", "GB_B1"."Estimator" AS "Estimator" 
FROM "82220_CODEGEN_VLOGBE_GB_B1" "GB_B1") "GB_EnsembleUnion") "GB_Union") "U"

-- Code For temporary table 2220_CODEGEN_5GUC3I_GB_SUM part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "2220_CODEGEN_5GUC3I_GB_SUM" (
	"KEY" NUMBER(19), 
	"Estimator" BINARY_DOUBLE
)
...
-- Code For temporary table 2220_CODEGEN_5GUC3I_GB_SUM part 2. Populate

INSERT INTO "2220_CODEGEN_5GUC3I_GB_SUM" ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
FROM "20_CODEGEN_2ZVNTU_GB_UNION" "GB_Union" GROUP BY "GB_Union"."KEY") "T") "GB_sum") "U"

-- Model deployment code

SELECT "GB_sum"."KEY" AS "KEY", 26.405852730652413 + 0.1 * "GB_sum"."Estimator" AS "Estimator" 
FROM "2220_CODEGEN_5GUC3I_GB_SUM" "GB_sum"