...
-- Code For temporary table TMP_20180508182221_CODEGEN_M8OZ part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508182221_CODEGEN_M8OZ" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20180508182221_CODEGEN_M8OZ part 2. Populate

INSERT INTO "TMP_20180508182221_CODEGEN_M8OZ" ("KEY", impter_2, impter_3, impter_4, impter_5, impter_6, impter_7, impter_8, impter_9, impter_10, impter_11) SELECT "U"."KEY", "U".impter_2, "U".impter_3, "U".impter_4, "U".impter_5, "U".impter_6, "U".impter_7, "U".impter_8, "U".impter_9, "U".impter_10, "U".impter_11 
...
-- Code For temporary table TMP_20180508182221_CODEGEN_M8OZ part 3. Create Index 

CREATE INDEX "ix_TMP_20180508182221_C_a61e" ON "TMP_20180508182221_CODEGEN_M8OZ" ("KEY")

-- Code For temporary table TMP_20180508182221_CODEGEN_424H part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508182221_CODEGEN_424H" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20180508182221_CODEGEN_424H part 2. Populate

INSERT INTO "TMP_20180508182221_CODEGEN_424H" ("KEY", scaler_2, scaler_3, scaler_4, scaler_5, scaler_6, scaler_7, scaler_8, scaler_9, scaler_10, scaler_11) SELECT "U"."KEY", "U".scaler_2, "U".scaler_3, "U".scaler_4, "U".scaler_5, "U".scaler_6, "U".scaler_7, "U".scaler_8, "U".scaler_9, "U".scaler_10, "U".scaler_11 
...
FROM "TMP_20180508182221_CODEGEN_M8OZ" AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT") AS "U"

-- Code For temporary table TMP_20180508182221_CODEGEN_424H part 3. Create Index 

CREATE INDEX "ix_TMP_20180508182221_C_9919" ON "TMP_20180508182221_CODEGEN_424H" ("KEY")

-- Code For temporary table TMP_20180508182222_CODEGEN_27YR part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508182222_CODEGEN_27YR" (
	"KEY" BIGINT, 
...
-- Code For temporary table TMP_20180508182222_CODEGEN_27YR part 2. Populate

INSERT INTO "TMP_20180508182222_CODEGEN_27YR" ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
FROM "TMP_20180508182221_CODEGEN_424H" AS "ADS_sca_2_OUT"), 
"DT_node_data" AS 
...
-- Code For temporary table TMP_20180508182222_CODEGEN_SOND part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508182222_CODEGEN_SOND" (
	"KEY" BIGINT, 
	"Estimator" DOUBLE PRECISION
)
...
-- Code For temporary table TMP_20180508182222_CODEGEN_SOND part 2. Populate

INSERT INTO "TMP_20180508182222_CODEGEN_SOND" ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
-- Code For temporary table TMP_20180508182222_CODEGEN_MNIG part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508182222_CODEGEN_MNIG" (
	"KEY" BIGINT, 
	"Estimator" DOUBLE PRECISION
)
...
-- Code For temporary table TMP_20180508182222_CODEGEN_MNIG part 2. Populate

INSERT INTO "TMP_20180508182222_CODEGEN_MNIG" ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
FROM "TMP_20180508182222_CODEGEN_27YR" AS "GB_B0" UNION ALL SELECT "GB_B1"."KEY" AS "KEY", "GB_B1"."Estimator" AS "Estimator" 
FROM "TMP_20180508182222_CODEGEN_SOND" AS "GB_B1") AS "GB_EnsembleUnion") AS "GB_Union") AS "U"

-- Code For temporary table TMP_20180508182222_CODEGEN_FCG7 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508182222_CODEGEN_FCG7" (
	"KEY" BIGINT NOT NULL, 
	"Estimator" DOUBLE PRECISION, 
	PRIMARY KEY ("KEY")
)
...
-- Code For temporary table TMP_20180508182222_CODEGEN_FCG7 part 2. Populate

INSERT INTO "TMP_20180508182222_CODEGEN_FCG7" ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
FROM "TMP_20180508182222_CODEGEN_MNIG" AS "GB_Union" GROUP BY "GB_Union"."KEY") AS "T") AS "GB_sum") AS "U"

-- Code For temporary table TMP_20180508182222_CODEGEN_FCG7 part 3. Create Index 

CREATE INDEX "ix_TMP_20180508182222_C_6e82" ON "TMP_20180508182222_CODEGEN_FCG7" ("KEY")

-- Model deployment code

SELECT "GB_sum"."KEY" AS "KEY", 26.405852730652413 + 0.1 * "GB_sum"."Estimator" AS "Estimator" 
FROM "TMP_20180508182222_CODEGEN_FCG7" AS "GB_sum"