...
-- Code For temporary table ##TMP_20180508184443_CODEGEN_SCSU9E_ADS_imp_1_OUT part 1. Create 


CREATE TABLE ##TMP_20180508184443_CODEGEN_SCSU9E_ADS_imp_1_OUT (
	[KEY] BIGINT NULL, 
...
-- Code For temporary table ##TMP_20180508184443_CODEGEN_X5W7IR_ADS_sca_2_OUT part 1. Create 


CREATE TABLE ##TMP_20180508184443_CODEGEN_X5W7IR_ADS_sca_2_OUT (
	[KEY] BIGINT NULL, 
	scaler_2 FLOAT NULL, 
	scaler_3 FLOAT NULL, 
	scaler_4 FLOAT NULL, 
...
FROM ##TMP_20180508184443_CODEGEN_SCSU9E_ADS_imp_1_OUT AS [ADS_imp_1_OUT]) AS [ADS_sca_2_OUT]

-- Code For temporary table ##TMP_20180508184443_CODEGEN_DHRL21_GB_B0 part 1. Create 


CREATE TABLE ##TMP_20180508184443_CODEGEN_DHRL21_GB_B0 (
	[KEY] BIGINT NULL, 
...
-- Code For temporary table ##TMP_20180508184443_CODEGEN_DHRL21_GB_B0 part 2. Populate
...
FROM ##TMP_20180508184443_CODEGEN_X5W7IR_ADS_sca_2_OUT AS [ADS_sca_2_OUT]), 
[DT_node_data] AS 
...
FROM [DT_Output_9])
 INSERT INTO ##TMP_20180508184443_CODEGEN_DHRL21_GB_B0 ([KEY], [Estimator]) SELECT [GB_B0].[KEY], [GB_B0].[Estimator] 
...
-- Code For temporary table ##TMP_20180508184443_CODEGEN_I4S34V_GB_B1 part 1. Create 


CREATE TABLE ##TMP_20180508184443_CODEGEN_I4S34V_GB_B1 (
	[KEY] BIGINT NULL, 
	[Estimator] FLOAT(53) NULL
)
...
-- Code For temporary table ##TMP_20180508184443_CODEGEN_I4S34V_GB_B1 part 2. Populate
...
FROM [DT_Output_15])
 INSERT INTO ##TMP_20180508184443_CODEGEN_I4S34V_GB_B1 ([KEY], [Estimator]) SELECT [GB_B1].[KEY], [GB_B1].[Estimator] 
...
-- Code For temporary table ##TMP_20180508184443_CODEGEN_0SMOGP_GB_Union part 1. Create 


CREATE TABLE ##TMP_20180508184443_CODEGEN_0SMOGP_GB_Union (
	[KEY] BIGINT NULL, 
	[Estimator] FLOAT(53) NULL
)
...
-- Code For temporary table ##TMP_20180508184443_CODEGEN_0SMOGP_GB_Union part 2. Populate

INSERT INTO ##TMP_20180508184443_CODEGEN_0SMOGP_GB_Union ([KEY], [Estimator]) SELECT [GB_Union].[KEY], [GB_Union].[Estimator] 
...
FROM ##TMP_20180508184443_CODEGEN_DHRL21_GB_B0 AS [GB_B0] UNION ALL SELECT [GB_B1].[KEY] AS [KEY], [GB_B1].[Estimator] AS [Estimator] 
FROM ##TMP_20180508184443_CODEGEN_I4S34V_GB_B1 AS [GB_B1]) AS [GB_EnsembleUnion]) AS [GB_Union]

-- Code For temporary table ##TMP_20180508184443_CODEGEN_C0P0V6_GB_sum part 1. Create 


CREATE TABLE ##TMP_20180508184443_CODEGEN_C0P0V6_GB_sum (
	[KEY] BIGINT NULL, 
	[Estimator] FLOAT(53) NULL
)
...
-- Code For temporary table ##TMP_20180508184443_CODEGEN_C0P0V6_GB_sum part 2. Populate

INSERT INTO ##TMP_20180508184443_CODEGEN_C0P0V6_GB_sum ([KEY], [Estimator]) SELECT [GB_sum].[KEY], [GB_sum].[Estimator] 
...
FROM ##TMP_20180508184443_CODEGEN_0SMOGP_GB_Union AS [GB_Union] GROUP BY [GB_Union].[KEY]) AS [T]) AS [GB_sum]

-- Model deployment code

SELECT [GB_sum].[KEY] AS [KEY], 15.3537633818605 + 0.1 * [GB_sum].[Estimator] AS [Estimator] 
FROM ##TMP_20180508184443_CODEGEN_C0P0V6_GB_sum AS [GB_sum]