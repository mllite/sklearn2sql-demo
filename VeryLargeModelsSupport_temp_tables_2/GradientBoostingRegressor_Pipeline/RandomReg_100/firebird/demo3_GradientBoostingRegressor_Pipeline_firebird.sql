...
-- Code For temporary table TMP_20180508182613_CODEGEN_D5HV part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508182613_CODEGEN_D5HV" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20180508182613_CODEGEN_D5HV part 3. Create Index 

CREATE INDEX "ix_TMP_20180508182613_C_47f6" ON "TMP_20180508182613_CODEGEN_D5HV" ("KEY")

-- Code For temporary table TMP_20180508182613_CODEGEN_0ZWO part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508182613_CODEGEN_0ZWO" (
	"KEY" BIGINT NOT NULL, 
...
FROM "TMP_20180508182613_CODEGEN_D5HV" AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT") AS "U"

-- Code For temporary table TMP_20180508182613_CODEGEN_0ZWO part 3. Create Index 

CREATE INDEX "ix_TMP_20180508182613_C_1b94" ON "TMP_20180508182613_CODEGEN_0ZWO" ("KEY")

-- Code For temporary table TMP_20180508182613_CODEGEN_5M1L part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508182613_CODEGEN_5M1L" (
	"KEY" BIGINT, 
...
-- Code For temporary table TMP_20180508182613_CODEGEN_5M1L part 2. Populate

INSERT INTO "TMP_20180508182613_CODEGEN_5M1L" ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
FROM "TMP_20180508182613_CODEGEN_0ZWO" AS "ADS_sca_2_OUT"), 
"DT_node_data" AS 
...
-- Code For temporary table TMP_20180508182613_CODEGEN_N6YP part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508182613_CODEGEN_N6YP" (
	"KEY" BIGINT, 
	"Estimator" DOUBLE PRECISION
)
...
-- Code For temporary table TMP_20180508182613_CODEGEN_N6YP part 2. Populate

INSERT INTO "TMP_20180508182613_CODEGEN_N6YP" ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
-- Code For temporary table TMP_20180508182613_CODEGEN_9KTY part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508182613_CODEGEN_9KTY" (
	"KEY" BIGINT, 
	"Estimator" DOUBLE PRECISION
)
...
-- Code For temporary table TMP_20180508182613_CODEGEN_9KTY part 2. Populate

INSERT INTO "TMP_20180508182613_CODEGEN_9KTY" ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
FROM "TMP_20180508182613_CODEGEN_5M1L" AS "GB_B0" UNION ALL SELECT "GB_B1"."KEY" AS "KEY", "GB_B1"."Estimator" AS "Estimator" 
FROM "TMP_20180508182613_CODEGEN_N6YP" AS "GB_B1") AS "GB_EnsembleUnion") AS "GB_Union") AS "U"

-- Code For temporary table TMP_20180508182613_CODEGEN_GODJ part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508182613_CODEGEN_GODJ" (
	"KEY" BIGINT NOT NULL, 
	"Estimator" DOUBLE PRECISION, 
	PRIMARY KEY ("KEY")
)
...
-- Code For temporary table TMP_20180508182613_CODEGEN_GODJ part 2. Populate

INSERT INTO "TMP_20180508182613_CODEGEN_GODJ" ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
FROM "TMP_20180508182613_CODEGEN_9KTY" AS "GB_Union" GROUP BY "GB_Union"."KEY") AS "T") AS "GB_sum") AS "U"

-- Code For temporary table TMP_20180508182613_CODEGEN_GODJ part 3. Create Index 

CREATE INDEX "ix_TMP_20180508182613_C_2ab4" ON "TMP_20180508182613_CODEGEN_GODJ" ("KEY")

-- Model deployment code

SELECT "GB_sum"."KEY" AS "KEY", -11.471614782695335 + 0.1 * "GB_sum"."Estimator" AS "Estimator" 
FROM "TMP_20180508182613_CODEGEN_GODJ" AS "GB_sum"