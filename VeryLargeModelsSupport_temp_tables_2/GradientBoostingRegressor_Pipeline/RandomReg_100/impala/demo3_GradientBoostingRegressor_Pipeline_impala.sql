...
-- Code For temporary table tmp_20180508193414_codegen_93097u_ads_imp_1_out part 1. Create 


CREATE TABLE tmp_20180508193414_codegen_93097u_ads_imp_1_out (
	`KEY` BIGINT, 
	impter_2 DOUBLE, 
	impter_3 DOUBLE, 
	impter_4 DOUBLE, 
...
-- Code For temporary table tmp_20180508193414_codegen_hhkkhz_ads_sca_2_out part 1. Create 


CREATE TABLE tmp_20180508193414_codegen_hhkkhz_ads_sca_2_out (
	`KEY` BIGINT, 
	scaler_2 DOUBLE, 
	scaler_3 DOUBLE, 
	scaler_4 DOUBLE, 
...
FROM tmp_20180508193414_codegen_93097u_ads_imp_1_out AS `ADS_imp_1_OUT`) AS `ADS_sca_2_OUT`

-- Code For temporary table tmp_20180508193414_codegen_kzw2z2_gb_b0 part 1. Create 


CREATE TABLE tmp_20180508193414_codegen_kzw2z2_gb_b0 (
	`KEY` BIGINT, 
	`Estimator` DOUBLE
)
...
-- Code For temporary table tmp_20180508193414_codegen_kzw2z2_gb_b0 part 2. Populate
...
FROM tmp_20180508193414_codegen_hhkkhz_ads_sca_2_out AS `ADS_sca_2_OUT`), 
`DT_node_data` AS 
...
FROM `DT_Output_9`)
 INSERT INTO tmp_20180508193414_codegen_kzw2z2_gb_b0 (`KEY`, `Estimator`) SELECT `GB_B0`.`KEY`, `GB_B0`.`Estimator` 
...
-- Code For temporary table tmp_20180508193414_codegen_3tiofk_gb_b1 part 1. Create 


CREATE TABLE tmp_20180508193414_codegen_3tiofk_gb_b1 (
	`KEY` BIGINT, 
	`Estimator` DOUBLE
)
...
-- Code For temporary table tmp_20180508193414_codegen_3tiofk_gb_b1 part 2. Populate
...
FROM `DT_Output_15`)
 INSERT INTO tmp_20180508193414_codegen_3tiofk_gb_b1 (`KEY`, `Estimator`) SELECT `GB_B1`.`KEY`, `GB_B1`.`Estimator` 
...
-- Code For temporary table tmp_20180508193414_codegen_nrstxq_gb_union part 1. Create 


CREATE TABLE tmp_20180508193414_codegen_nrstxq_gb_union (
	`KEY` BIGINT, 
	`Estimator` DOUBLE
)
...
-- Code For temporary table tmp_20180508193414_codegen_nrstxq_gb_union part 2. Populate

INSERT INTO tmp_20180508193414_codegen_nrstxq_gb_union (`KEY`, `Estimator`) SELECT `GB_Union`.`KEY`, `GB_Union`.`Estimator` 
...
FROM tmp_20180508193414_codegen_kzw2z2_gb_b0 AS `GB_B0` UNION ALL SELECT `GB_B1`.`KEY` AS `KEY`, `GB_B1`.`Estimator` AS `Estimator` 
FROM tmp_20180508193414_codegen_3tiofk_gb_b1 AS `GB_B1`) AS `GB_EnsembleUnion`) AS `GB_Union`

-- Code For temporary table tmp_20180508193414_codegen_fo48bo_gb_sum part 1. Create 


CREATE TABLE tmp_20180508193414_codegen_fo48bo_gb_sum (
	`KEY` BIGINT, 
	`Estimator` DOUBLE
)
...
-- Code For temporary table tmp_20180508193414_codegen_fo48bo_gb_sum part 2. Populate

INSERT INTO tmp_20180508193414_codegen_fo48bo_gb_sum (`KEY`, `Estimator`) SELECT `GB_sum`.`KEY`, `GB_sum`.`Estimator` 
...
FROM tmp_20180508193414_codegen_nrstxq_gb_union AS `GB_Union` GROUP BY `GB_Union`.`KEY`) AS `T`) AS `GB_sum`

-- Model deployment code

SELECT `GB_sum`.`KEY` AS `KEY`, -11.471614782695335 + 0.1 * `GB_sum`.`Estimator` AS `Estimator` 
FROM tmp_20180508193414_codegen_fo48bo_gb_sum AS `GB_sum`