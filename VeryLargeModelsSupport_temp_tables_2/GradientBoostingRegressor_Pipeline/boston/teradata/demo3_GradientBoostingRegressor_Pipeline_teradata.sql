...
-- Code For temporary table tmp_20180508183009_codegen_v2nvv9_ads_imp_1_out part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180508183009_codegen_v2nvv9_ads_imp_1_out  (
	"KEY" BIGINT, 
...
-- Code For temporary table tmp_20180508183009_codegen_v2nvv9_ads_imp_1_out part 2. Populate

INSERT INTO tmp_20180508183009_codegen_v2nvv9_ads_imp_1_out ("KEY", impter_2, impter_3, impter_4, impter_5, impter_6, impter_7, impter_8, impter_9, impter_10, impter_11, impter_12, impter_13, impter_14) SELECT "U"."KEY", "U".impter_2, "U".impter_3, "U".impter_4, "U".impter_5, "U".impter_6, "U".impter_7, "U".impter_8, "U".impter_9, "U".impter_10, "U".impter_11, "U".impter_12, "U".impter_13, "U".impter_14 
...
-- Code For temporary table tmp_20180508183009_codegen_o4l991_ads_sca_2_out part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180508183009_codegen_o4l991_ads_sca_2_out  (
	"KEY" BIGINT, 
...
FROM tmp_20180508183009_codegen_v2nvv9_ads_imp_1_out AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT") AS "U"

-- Code For temporary table tmp_20180508183009_codegen_3ow7up_gb_b0 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180508183009_codegen_3ow7up_gb_b0  (
	"KEY" BIGINT, 
...
-- Code For temporary table tmp_20180508183009_codegen_3ow7up_gb_b0 part 2. Populate

INSERT INTO tmp_20180508183009_codegen_3ow7up_gb_b0 ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
FROM tmp_20180508183009_codegen_o4l991_ads_sca_2_out AS "ADS_sca_2_OUT"), 
dummy_cte AS 
...
-- Code For temporary table tmp_20180508183009_codegen_2nn6h8_gb_b1 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180508183009_codegen_2nn6h8_gb_b1  (
	"KEY" BIGINT, 
	"Estimator" DOUBLE PRECISION
)
...
-- Code For temporary table tmp_20180508183009_codegen_2nn6h8_gb_b1 part 2. Populate

INSERT INTO tmp_20180508183009_codegen_2nn6h8_gb_b1 ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
-- Code For temporary table tmp_20180508183009_codegen_bbxb47_gb_union part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180508183009_codegen_bbxb47_gb_union  (
	"KEY" BIGINT, 
	"Estimator" DOUBLE PRECISION
)
...
-- Code For temporary table tmp_20180508183009_codegen_bbxb47_gb_union part 2. Populate

INSERT INTO tmp_20180508183009_codegen_bbxb47_gb_union ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
FROM tmp_20180508183009_codegen_3ow7up_gb_b0 AS "GB_B0" UNION ALL SELECT "GB_B1"."KEY" AS "KEY", "GB_B1"."Estimator" AS "Estimator" 
FROM tmp_20180508183009_codegen_2nn6h8_gb_b1 AS "GB_B1") AS "GB_EnsembleUnion") AS "GB_Union") AS "U"

-- Code For temporary table tmp_20180508183009_codegen_yfqy3w_gb_sum part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180508183009_codegen_yfqy3w_gb_sum  (
	"KEY" BIGINT, 
	"Estimator" DOUBLE PRECISION
)
...
-- Code For temporary table tmp_20180508183009_codegen_yfqy3w_gb_sum part 2. Populate

INSERT INTO tmp_20180508183009_codegen_yfqy3w_gb_sum ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
FROM tmp_20180508183009_codegen_bbxb47_gb_union AS "GB_Union" GROUP BY "GB_Union"."KEY") AS "T") AS "GB_sum") AS "U"
...
FROM tmp_20180508183009_codegen_yfqy3w_gb_sum AS "GB_sum"