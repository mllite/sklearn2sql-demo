...
-- Code For temporary table TMP_20180508183009_CODEGEN_J8DP part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508183009_CODEGEN_J8DP" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20180508183009_CODEGEN_J8DP part 2. Populate

INSERT INTO "TMP_20180508183009_CODEGEN_J8DP" ("KEY", impter_2, impter_3, impter_4, impter_5, impter_6, impter_7, impter_8, impter_9, impter_10, impter_11, impter_12, impter_13, impter_14) SELECT "U"."KEY", "U".impter_2, "U".impter_3, "U".impter_4, "U".impter_5, "U".impter_6, "U".impter_7, "U".impter_8, "U".impter_9, "U".impter_10, "U".impter_11, "U".impter_12, "U".impter_13, "U".impter_14 
...
-- Code For temporary table TMP_20180508183009_CODEGEN_J8DP part 3. Create Index 

CREATE INDEX "ix_TMP_20180508183009_C_4815" ON "TMP_20180508183009_CODEGEN_J8DP" ("KEY")

-- Code For temporary table TMP_20180508183009_CODEGEN_DZMN part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508183009_CODEGEN_DZMN" (
	"KEY" BIGINT NOT NULL, 
...
FROM "TMP_20180508183009_CODEGEN_J8DP" AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT") AS "U"

-- Code For temporary table TMP_20180508183009_CODEGEN_DZMN part 3. Create Index 

CREATE INDEX "ix_TMP_20180508183009_C_3034" ON "TMP_20180508183009_CODEGEN_DZMN" ("KEY")

-- Code For temporary table TMP_20180508183009_CODEGEN_IC7J part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508183009_CODEGEN_IC7J" (
	"KEY" BIGINT, 
...
-- Code For temporary table TMP_20180508183009_CODEGEN_IC7J part 2. Populate

INSERT INTO "TMP_20180508183009_CODEGEN_IC7J" ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
FROM "TMP_20180508183009_CODEGEN_DZMN" AS "ADS_sca_2_OUT"), 
"DT_node_data" AS 
...
-- Code For temporary table TMP_20180508183009_CODEGEN_51T3 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508183009_CODEGEN_51T3" (
	"KEY" BIGINT, 
	"Estimator" DOUBLE PRECISION
)
...
-- Code For temporary table TMP_20180508183009_CODEGEN_51T3 part 2. Populate

INSERT INTO "TMP_20180508183009_CODEGEN_51T3" ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
-- Code For temporary table TMP_20180508183009_CODEGEN_CVH7 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508183009_CODEGEN_CVH7" (
	"KEY" BIGINT, 
	"Estimator" DOUBLE PRECISION
)
...
-- Code For temporary table TMP_20180508183009_CODEGEN_CVH7 part 2. Populate

INSERT INTO "TMP_20180508183009_CODEGEN_CVH7" ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
FROM "TMP_20180508183009_CODEGEN_IC7J" AS "GB_B0" UNION ALL SELECT "GB_B1"."KEY" AS "KEY", "GB_B1"."Estimator" AS "Estimator" 
FROM "TMP_20180508183009_CODEGEN_51T3" AS "GB_B1") AS "GB_EnsembleUnion") AS "GB_Union") AS "U"

-- Code For temporary table TMP_20180508183009_CODEGEN_0GAH part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508183009_CODEGEN_0GAH" (
	"KEY" BIGINT NOT NULL, 
	"Estimator" DOUBLE PRECISION, 
	PRIMARY KEY ("KEY")
)
...
-- Code For temporary table TMP_20180508183009_CODEGEN_0GAH part 2. Populate

INSERT INTO "TMP_20180508183009_CODEGEN_0GAH" ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
FROM "TMP_20180508183009_CODEGEN_CVH7" AS "GB_Union" GROUP BY "GB_Union"."KEY") AS "T") AS "GB_sum") AS "U"

-- Code For temporary table TMP_20180508183009_CODEGEN_0GAH part 3. Create Index 

CREATE INDEX "ix_TMP_20180508183009_C_f71a" ON "TMP_20180508183009_CODEGEN_0GAH" ("KEY")

-- Model deployment code

SELECT "GB_sum"."KEY" AS "KEY", 22.5789603960396 + 0.1 * "GB_sum"."Estimator" AS "Estimator" 
FROM "TMP_20180508183009_CODEGEN_0GAH" AS "GB_sum"