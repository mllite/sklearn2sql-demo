...
-- Code For temporary table tmp_20180508185847_codegen_gdsq81_kernagg_b0 part 1. Create 


CREATE TEMPORARY TABLE tmp_20180508185847_codegen_gdsq81_kernagg_b0 (
	"KEY" BIGINT, 
	"OVO_Class1" BIGINT, 
	"OVO_Class2" BIGINT, 
	"OVO_Decision" BIGINT, 
...
-- Code For temporary table tmp_20180508185847_codegen_gdsq81_kernagg_b0 part 2. Populate

INSERT INTO tmp_20180508185847_codegen_gdsq81_kernagg_b0 ("KEY", "OVO_Class1", "OVO_Class2", "OVO_Decision", "OVO_Confidence") SELECT "U"."KEY", "U"."OVO_Class1", "U"."OVO_Class2", "U"."OVO_Decision", "U"."OVO_Confidence" 
...
-- Code For temporary table tmp_20180508185847_codegen_0c4dou_kernagg_union part 1. Create 


CREATE TEMPORARY TABLE tmp_20180508185847_codegen_0c4dou_kernagg_union (
	"KEY" BIGINT, 
	"OVO_Class1" BIGINT, 
	"OVO_Class2" BIGINT, 
	"OVO_Decision" BIGINT, 
...
-- Code For temporary table tmp_20180508185847_codegen_0c4dou_kernagg_union part 2. Populate

INSERT INTO tmp_20180508185847_codegen_0c4dou_kernagg_union ("KEY", "OVO_Class1", "OVO_Class2", "OVO_Decision", "OVO_Confidence") SELECT "U"."KEY", "U"."OVO_Class1", "U"."OVO_Class2", "U"."OVO_Decision", "U"."OVO_Confidence" 
...
FROM tmp_20180508185847_codegen_gdsq81_kernagg_b0 AS "KernAgg_B0") AS "KernAgg_EnsembleUnion") AS "KernAgg_Union") AS "U"

-- Code For temporary table tmp_20180508185847_codegen_u39m4k_kernagg part 1. Create 


CREATE TEMPORARY TABLE tmp_20180508185847_codegen_u39m4k_kernagg (
	"KEY" BIGINT, 
	"OVO_Vote_0" BIGINT, 
...
-- Code For temporary table tmp_20180508185847_codegen_u39m4k_kernagg part 2. Populate

INSERT INTO tmp_20180508185847_codegen_u39m4k_kernagg ("KEY", "OVO_Vote_0", "OVO_SumConfidence_0", "OVO_Vote_1", "OVO_SumConfidence_1", "OVO_Vote_2", "OVO_SumConfidence_2", max_abs_confidence, "OVO_Scale", "Score_0", "Score_1", "Score_2") SELECT "U"."KEY", "U"."OVO_Vote_0", "U"."OVO_SumConfidence_0", "U"."OVO_Vote_1", "U"."OVO_SumConfidence_1", "U"."OVO_Vote_2", "U"."OVO_SumConfidence_2", "U".max_abs_confidence, "U"."OVO_Scale", "U"."Score_0", "U"."Score_1", "U"."Score_2" 
...
FROM tmp_20180508185847_codegen_0c4dou_kernagg_union AS "KernAgg_Union" GROUP BY "KernAgg_Union"."KEY") AS "Votes_Sel"), 
"OVO_SumConf_CTE" AS 
...
FROM tmp_20180508185847_codegen_u39m4k_kernagg AS "KernAgg"), 
