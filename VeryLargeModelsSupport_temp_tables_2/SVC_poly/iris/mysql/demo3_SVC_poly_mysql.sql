...
-- Code For temporary table TMP_20180508185847_CODEGEN_4CNW2K_KernAgg_B0 part 1. Create 


CREATE TEMPORARY TABLE `TMP_20180508185847_CODEGEN_4CNW2K_KernAgg_B0` (
	`KEY` BIGINT, 
	`OVO_Class1` BIGINT, 
	`OVO_Class2` BIGINT, 
	`OVO_Decision` BIGINT, 
...
-- Code For temporary table TMP_20180508185847_CODEGEN_4CNW2K_KernAgg_B0 part 2. Populate

INSERT INTO `TMP_20180508185847_CODEGEN_4CNW2K_KernAgg_B0` (`KEY`, `OVO_Class1`, `OVO_Class2`, `OVO_Decision`, `OVO_Confidence`) SELECT `U`.`KEY`, `U`.`OVO_Class1`, `U`.`OVO_Class2`, `U`.`OVO_Decision`, `U`.`OVO_Confidence` 
...
FROM (SELECT full_join_data_sv_2.`KEY` AS `KEY`, sum(full_join_data_sv_2.dot_prod1) + 15.184809946631539 AS dot_product 
...
-- Code For temporary table TMP_20180508185847_CODEGEN_5Y6RAD_KernAgg_Union part 1. Create 


CREATE TEMPORARY TABLE `TMP_20180508185847_CODEGEN_5Y6RAD_KernAgg_Union` (
	`KEY` BIGINT, 
	`OVO_Class1` BIGINT, 
	`OVO_Class2` BIGINT, 
	`OVO_Decision` BIGINT, 
...
-- Code For temporary table TMP_20180508185847_CODEGEN_5Y6RAD_KernAgg_Union part 2. Populate

INSERT INTO `TMP_20180508185847_CODEGEN_5Y6RAD_KernAgg_Union` (`KEY`, `OVO_Class1`, `OVO_Class2`, `OVO_Decision`, `OVO_Confidence`) SELECT `U`.`KEY`, `U`.`OVO_Class1`, `U`.`OVO_Class2`, `U`.`OVO_Decision`, `U`.`OVO_Confidence` 
...
FROM `TMP_20180508185847_CODEGEN_4CNW2K_KernAgg_B0` AS `KernAgg_B0`) AS `KernAgg_EnsembleUnion`) AS `KernAgg_Union`) AS `U`

-- Code For temporary table TMP_20180508185847_CODEGEN_GB1JYX_KernAgg part 1. Create 


CREATE TEMPORARY TABLE `TMP_20180508185847_CODEGEN_GB1JYX_KernAgg` (
	`KEY` BIGINT NOT NULL, 
	`OVO_Vote_0` BIGINT, 
...
FROM `TMP_20180508185847_CODEGEN_5Y6RAD_KernAgg_Union` AS `KernAgg_Union` GROUP BY `KernAgg_Union`.`KEY`) AS `Votes_Sel`), 
`OVO_SumConf_CTE` AS 
...
-- Code For temporary table TMP_20180508185847_CODEGEN_GB1JYX_KernAgg part 3. Create Index 

CREATE INDEX `ix_TMP_20180508185847_CODEGEN_GB1JYX_KernAgg_KEY` ON `TMP_20180508185847_CODEGEN_GB1JYX_KernAgg` (`KEY`)
...
FROM `TMP_20180508185847_CODEGEN_GB1JYX_KernAgg` AS `KernAgg`), 
