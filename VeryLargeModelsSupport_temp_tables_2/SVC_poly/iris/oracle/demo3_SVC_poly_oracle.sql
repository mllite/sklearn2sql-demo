...
-- Code For temporary table _CODEGEN_OGQJPO_KERNAGG_B0 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "_CODEGEN_OGQJPO_KERNAGG_B0" (
	"KEY" NUMBER(19), 
...
-- Code For temporary table _CODEGEN_OGQJPO_KERNAGG_B0 part 2. Populate

INSERT INTO "_CODEGEN_OGQJPO_KERNAGG_B0" ("KEY", "OVO_Class1", "OVO_Class2", "OVO_Decision", "OVO_Confidence") SELECT "U"."KEY", "U"."OVO_Class1", "U"."OVO_Class2", "U"."OVO_Decision", "U"."OVO_Confidence" 
...
kernel_cte_0_1 AS 
(SELECT kernel_dp_0_1."KEY" AS "KEY", 0 AS "OVO_Class1", 1 AS "OVO_Class2", CASE WHEN (-kernel_dp_0_1.dot_product >= 0.0) THEN 1 ELSE 0 END AS "OVO_Decision", coalesce(-kernel_dp_0_1.dot_product, 1.0 / (1.0 + exp(least(greatest(-100.0, -(-((-kernel_dp_0_1.dot_product) * -1.6614609187514184 + -0.9354879708125379))), 100.0)))) AS "OVO_Confidence" 
FROM kernel_dp_0_1), 
"SV_data_0_2" AS 
(SELECT "Values".sv_idx AS sv_idx, CAST("Values".dual_coeff AS BINARY_DOUBLE) AS dual_coeff, CAST("Values".sv_0 AS BINARY_DOUBLE) AS sv_0, CAST("Values".sv_1 AS BINARY_DOUBLE) AS sv_1, CAST("Values".sv_2 AS BINARY_DOUBLE) AS sv_2, CAST("Values".sv_3 AS BINARY_DOUBLE) AS sv_3 
...
kernel_cte_0_2 AS 
(SELECT kernel_dp_0_2."KEY" AS "KEY", 0 AS "OVO_Class1", 2 AS "OVO_Class2", CASE WHEN (-kernel_dp_0_2.dot_product >= 0.0) THEN 1 ELSE 0 END AS "OVO_Decision", coalesce(-kernel_dp_0_2.dot_product, 1.0 / (1.0 + exp(least(greatest(-100.0, -(-((-kernel_dp_0_2.dot_product) * -1.9673526513168822 + -0.9226178846685918))), 100.0)))) AS "OVO_Confidence" 
FROM kernel_dp_0_2), 
"SV_data_1_2" AS 
(SELECT "Values".sv_idx AS sv_idx, CAST("Values".dual_coeff AS BINARY_DOUBLE) AS dual_coeff, CAST("Values".sv_0 AS BINARY_DOUBLE) AS sv_0, CAST("Values".sv_1 AS BINARY_DOUBLE) AS sv_1, CAST("Values".sv_2 AS BINARY_DOUBLE) AS sv_2, CAST("Values".sv_3 AS BINARY_DOUBLE) AS sv_3 
...
kernel_cte_1_2 AS 
(SELECT kernel_dp_1_2."KEY" AS "KEY", 1 AS "OVO_Class1", 2 AS "OVO_Class2", CASE WHEN (-kernel_dp_1_2.dot_product >= 0.0) THEN 1 ELSE 0 END AS "OVO_Decision", coalesce(-kernel_dp_1_2.dot_product, 1.0 / (1.0 + exp(least(greatest(-100.0, -(-((-kernel_dp_1_2.dot_product) * -0.413584248303465 + 0.22665421123328056))), 100.0)))) AS "OVO_Confidence" 
FROM kernel_dp_1_2)
...
-- Code For temporary table DEGEN_8MUCNX_KERNAGG_UNION part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "DEGEN_8MUCNX_KERNAGG_UNION" (
	"KEY" NUMBER(19), 
	"OVO_Class1" NUMBER(19), 
	"OVO_Class2" NUMBER(19), 
	"OVO_Decision" NUMBER(19), 
...
-- Code For temporary table DEGEN_8MUCNX_KERNAGG_UNION part 2. Populate

INSERT INTO "DEGEN_8MUCNX_KERNAGG_UNION" ("KEY", "OVO_Class1", "OVO_Class2", "OVO_Decision", "OVO_Confidence") SELECT "U"."KEY", "U"."OVO_Class1", "U"."OVO_Class2", "U"."OVO_Decision", "U"."OVO_Confidence" 
...
FROM "_CODEGEN_OGQJPO_KERNAGG_B0" "KernAgg_B0") "KernAgg_EnsembleUnion") "KernAgg_Union") "U"

-- Code For temporary table 847_CODEGEN_OYBIOM_KERNAGG part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "847_CODEGEN_OYBIOM_KERNAGG" (
	"KEY" NUMBER(19), 
...
-- Code For temporary table 847_CODEGEN_OYBIOM_KERNAGG part 2. Populate

INSERT INTO "847_CODEGEN_OYBIOM_KERNAGG" ("KEY", "OVO_Vote_0", "OVO_SumConfidence_0", "OVO_Vote_1", "OVO_SumConfidence_1", "OVO_Vote_2", "OVO_SumConfidence_2", max_abs_confidence, "OVO_Scale", "Score_0", "Score_1", "Score_2") SELECT "U"."KEY", "U"."OVO_Vote_0", "U"."OVO_SumConfidence_0", "U"."OVO_Vote_1", "U"."OVO_SumConfidence_1", "U"."OVO_Vote_2", "U"."OVO_SumConfidence_2", "U".max_abs_confidence, "U"."OVO_Scale", "U"."Score_0", "U"."Score_1", "U"."Score_2" 
...
FROM "DEGEN_8MUCNX_KERNAGG_UNION" "KernAgg_Union" GROUP BY "KernAgg_Union"."KEY") "Votes_Sel"), 
"OVO_SumConf_CTE" AS 
...
FROM "847_CODEGEN_OYBIOM_KERNAGG" "KernAgg"), 
