...
-- Code For temporary table tmp_20180508190334_codegen_i16yar_kernagg_b0 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180508190334_codegen_i16yar_kernagg_b0 (
	"KEY" BIGINT, 
...
-- Code For temporary table tmp_20180508190334_codegen_i16yar_kernagg_b0 part 2. Populate

INSERT INTO tmp_20180508190334_codegen_i16yar_kernagg_b0 WITH kernel_input AS 
...
-- Code For temporary table tmp_20180508190334_codegen_xb1orm_kernagg_union part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180508190334_codegen_xb1orm_kernagg_union (
	"KEY" BIGINT, 
	"OVO_Class1" VARCHAR(None), 
	"OVO_Class2" VARCHAR(None), 
	"OVO_Decision" BIGINT, 
...
-- Code For temporary table tmp_20180508190334_codegen_xb1orm_kernagg_union part 2. Populate

INSERT INTO tmp_20180508190334_codegen_xb1orm_kernagg_union SELECT "KernAgg_Union"."KEY", "KernAgg_Union"."OVO_Class1", "KernAgg_Union"."OVO_Class2", "KernAgg_Union"."OVO_Decision", "KernAgg_Union"."OVO_Confidence" 
...
FROM tmp_20180508190334_codegen_i16yar_kernagg_b0 AS "KernAgg_B0") AS "KernAgg_EnsembleUnion") AS "KernAgg_Union"

-- Code For temporary table tmp_20180508190334_codegen_jcz26n_kernagg part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180508190334_codegen_jcz26n_kernagg (
	"KEY" BIGINT, 
...
-- Code For temporary table tmp_20180508190334_codegen_jcz26n_kernagg part 2. Populate

INSERT INTO tmp_20180508190334_codegen_jcz26n_kernagg WITH "OVO_Votes" AS 
...
FROM tmp_20180508190334_codegen_xb1orm_kernagg_union AS "KernAgg_Union" GROUP BY "KernAgg_Union"."KEY") AS "Votes_Sel"), 
"OVO_SumConf_CTE" AS 
...
FROM tmp_20180508190334_codegen_jcz26n_kernagg AS "KernAgg"), 
