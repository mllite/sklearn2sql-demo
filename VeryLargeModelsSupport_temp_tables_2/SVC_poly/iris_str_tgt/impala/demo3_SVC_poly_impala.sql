...
-- Code For temporary table tmp_20180508195735_codegen_qrkj3n_kernagg_b0 part 1. Create 


CREATE TABLE tmp_20180508195735_codegen_qrkj3n_kernagg_b0 (
	`KEY` BIGINT, 
...
-- Code For temporary table tmp_20180508195735_codegen_qrkj3n_kernagg_b0 part 2. Populate
...
(SELECT `kernel_dp_CLASS_0_CLASS_2`.`KEY` AS `KEY`, 'CLASS_0' AS `OVO_Class1`, 'CLASS_2' AS `OVO_Class2`, CASE WHEN (-`kernel_dp_CLASS_0_CLASS_2`.dot_product >= 0.0) THEN 1 ELSE 0 END AS `OVO_Decision`, coalesce(-`kernel_dp_CLASS_0_CLASS_2`.dot_product, 1.0 / (1.0 + exp(CASE WHEN (CASE WHEN (-100.0 <= -(-((-`kernel_dp_CLASS_0_CLASS_2`.dot_product) * -1.9297989307353514 + -0.9594518187585612))) THEN -(-((-`kernel_dp_CLASS_0_CLASS_2`.dot_product) * -1.9297989307353514 + -0.9594518187585612)) ELSE -100.0 END <= 100.0) THEN CASE WHEN (-100.0 <= -(-((-`kernel_dp_CLASS_0_CLASS_2`.dot_product) * -1.9297989307353514 + -0.9594518187585612))) THEN -(-((-`kernel_dp_CLASS_0_CLASS_2`.dot_product) * -1.9297989307353514 + -0.9594518187585612)) ELSE -100.0 END ELSE 100.0 END))) AS `OVO_Confidence` 
...
(SELECT `kernel_dp_CLASS_1_CLASS_2`.`KEY` AS `KEY`, 'CLASS_1' AS `OVO_Class1`, 'CLASS_2' AS `OVO_Class2`, CASE WHEN (-`kernel_dp_CLASS_1_CLASS_2`.dot_product >= 0.0) THEN 1 ELSE 0 END AS `OVO_Decision`, coalesce(-`kernel_dp_CLASS_1_CLASS_2`.dot_product, 1.0 / (1.0 + exp(CASE WHEN (CASE WHEN (-100.0 <= -(-((-`kernel_dp_CLASS_1_CLASS_2`.dot_product) * -0.36501178513894655 + 0.12519720876719553))) THEN -(-((-`kernel_dp_CLASS_1_CLASS_2`.dot_product) * -0.36501178513894655 + 0.12519720876719553)) ELSE -100.0 END <= 100.0) THEN CASE WHEN (-100.0 <= -(-((-`kernel_dp_CLASS_1_CLASS_2`.dot_product) * -0.36501178513894655 + 0.12519720876719553))) THEN -(-((-`kernel_dp_CLASS_1_CLASS_2`.dot_product) * -0.36501178513894655 + 0.12519720876719553)) ELSE -100.0 END ELSE 100.0 END))) AS `OVO_Confidence` 
FROM `kernel_dp_CLASS_1_CLASS_2`)
 INSERT INTO tmp_20180508195735_codegen_qrkj3n_kernagg_b0 (`KEY`, `OVO_Class1`, `OVO_Class2`, `OVO_Decision`, `OVO_Confidence`) SELECT `KernAgg_B0`.`KEY`, `KernAgg_B0`.`OVO_Class1`, `KernAgg_B0`.`OVO_Class2`, `KernAgg_B0`.`OVO_Decision`, `KernAgg_B0`.`OVO_Confidence` 
...
-- Code For temporary table tmp_20180508195735_codegen_qbnoq6_kernagg_union part 1. Create 


CREATE TABLE tmp_20180508195735_codegen_qbnoq6_kernagg_union (
	`KEY` BIGINT, 
	`OVO_Class1` VARCHAR COLLATE "utf8", 
	`OVO_Class2` VARCHAR COLLATE "utf8", 
	`OVO_Decision` BIGINT, 
...
-- Code For temporary table tmp_20180508195735_codegen_qbnoq6_kernagg_union part 2. Populate

INSERT INTO tmp_20180508195735_codegen_qbnoq6_kernagg_union (`KEY`, `OVO_Class1`, `OVO_Class2`, `OVO_Decision`, `OVO_Confidence`) SELECT `KernAgg_Union`.`KEY`, `KernAgg_Union`.`OVO_Class1`, `KernAgg_Union`.`OVO_Class2`, `KernAgg_Union`.`OVO_Decision`, `KernAgg_Union`.`OVO_Confidence` 
...
FROM tmp_20180508195735_codegen_qrkj3n_kernagg_b0 AS `KernAgg_B0`) AS `KernAgg_EnsembleUnion`) AS `KernAgg_Union`

-- Code For temporary table tmp_20180508195735_codegen_68ws3v_kernagg part 1. Create 


CREATE TABLE tmp_20180508195735_codegen_68ws3v_kernagg (
	`KEY` BIGINT, 
...
-- Code For temporary table tmp_20180508195735_codegen_68ws3v_kernagg part 2. Populate
...
FROM tmp_20180508195735_codegen_qbnoq6_kernagg_union AS `KernAgg_Union` GROUP BY `KernAgg_Union`.`KEY`) AS `Votes_Sel`), 
`OVO_SumConf_CTE` AS 
...
FROM tmp_20180508195735_codegen_68ws3v_kernagg AS `KernAgg`), 
