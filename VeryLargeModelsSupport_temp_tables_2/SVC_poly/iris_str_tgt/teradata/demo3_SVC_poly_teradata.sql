...
-- Code For temporary table tmp_20180508190819_codegen_3qf6no_kernagg_b0 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180508190819_codegen_3qf6no_kernagg_b0  (
	"KEY" BIGINT, 
...
-- Code For temporary table tmp_20180508190819_codegen_3qf6no_kernagg_b0 part 2. Populate

INSERT INTO tmp_20180508190819_codegen_3qf6no_kernagg_b0 ("KEY", "OVO_Class1", "OVO_Class2", "OVO_Decision", "OVO_Confidence") SELECT "U"."KEY", "U"."OVO_Class1", "U"."OVO_Class2", "U"."OVO_Decision", "U"."OVO_Confidence" 
...
-- Code For temporary table tmp_20180508190819_codegen_ic52go_kernagg_union part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180508190819_codegen_ic52go_kernagg_union  (
	"KEY" BIGINT, 
	"OVO_Class1" LONG VARCHAR, 
	"OVO_Class2" LONG VARCHAR, 
	"OVO_Decision" BIGINT, 
...
-- Code For temporary table tmp_20180508190819_codegen_ic52go_kernagg_union part 2. Populate

INSERT INTO tmp_20180508190819_codegen_ic52go_kernagg_union ("KEY", "OVO_Class1", "OVO_Class2", "OVO_Decision", "OVO_Confidence") SELECT "U"."KEY", "U"."OVO_Class1", "U"."OVO_Class2", "U"."OVO_Decision", "U"."OVO_Confidence" 
...
FROM tmp_20180508190819_codegen_3qf6no_kernagg_b0 AS "KernAgg_B0") AS "KernAgg_EnsembleUnion") AS "KernAgg_Union") AS "U"

-- Code For temporary table tmp_20180508190819_codegen_u95r7v_kernagg part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180508190819_codegen_u95r7v_kernagg  (
	"KEY" BIGINT, 
...
FROM tmp_20180508190819_codegen_ic52go_kernagg_union AS "KernAgg_Union" GROUP BY "KernAgg_Union"."KEY") AS "Votes_Sel"), 
dummy_cte AS 
(SELECT CAST(0.0 AS DOUBLE PRECISION) AS "X"), 
"OVO_SumConf_CTE" AS 
...
FROM tmp_20180508190819_codegen_u95r7v_kernagg AS "KernAgg"), 
