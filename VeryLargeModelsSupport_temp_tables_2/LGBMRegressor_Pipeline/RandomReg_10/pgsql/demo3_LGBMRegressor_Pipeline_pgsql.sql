...
-- Code For temporary table TMP_20180508182234_CODEGEN_LEYLMN_ADS_imp_1_OUT part 1. Create 


CREATE TEMPORARY TABLE "TMP_20180508182234_CODEGEN_LEYLMN_ADS_imp_1_OUT" (
	"KEY" BIGINT NOT NULL, 
	impter_2 FLOAT, 
	impter_3 FLOAT, 
	impter_4 FLOAT, 
...
-- Code For temporary table TMP_20180508182234_CODEGEN_LEYLMN_ADS_imp_1_OUT part 3. Create Index 

CREATE INDEX "ix_TMP_20180508182234_CODEGEN_LEYLMN_ADS_imp_1_OUT_KEY" ON "TMP_20180508182234_CODEGEN_LEYLMN_ADS_imp_1_OUT" ("KEY")

-- Code For temporary table TMP_20180508182234_CODEGEN_PP1L6E_ADS_sca_2_OUT part 1. Create 


CREATE TEMPORARY TABLE "TMP_20180508182234_CODEGEN_PP1L6E_ADS_sca_2_OUT" (
	"KEY" BIGINT NOT NULL, 
	scaler_2 FLOAT, 
	scaler_3 FLOAT, 
	scaler_4 FLOAT, 
...
FROM "TMP_20180508182234_CODEGEN_LEYLMN_ADS_imp_1_OUT" AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT"

-- Code For temporary table TMP_20180508182234_CODEGEN_PP1L6E_ADS_sca_2_OUT part 3. Create Index 

CREATE INDEX "ix_TMP_20180508182234_CODEGEN_PP1L6E_ADS_sca_2_OUT_KEY" ON "TMP_20180508182234_CODEGEN_PP1L6E_ADS_sca_2_OUT" ("KEY")

-- Code For temporary table TMP_20180508182234_CODEGEN_GKC4QK_LGBM_B0 part 1. Create 


CREATE TEMPORARY TABLE "TMP_20180508182234_CODEGEN_GKC4QK_LGBM_B0" (
	"KEY" BIGINT, 
	"Estimator" FLOAT
)
...
-- Code For temporary table TMP_20180508182234_CODEGEN_GKC4QK_LGBM_B0 part 2. Populate
...
FROM "TMP_20180508182234_CODEGEN_PP1L6E_ADS_sca_2_OUT" AS "ADS_sca_2_OUT"), 
"DT_node_data" AS 
...
FROM "DT_Output_9")
 INSERT INTO "TMP_20180508182234_CODEGEN_GKC4QK_LGBM_B0" ("KEY", "Estimator") SELECT "LGBM_B0"."KEY", "LGBM_B0"."Estimator" 
...
-- Code For temporary table TMP_20180508182234_CODEGEN_PC0XHS_LGBM_B1 part 1. Create 


CREATE TEMPORARY TABLE "TMP_20180508182234_CODEGEN_PC0XHS_LGBM_B1" (
	"KEY" BIGINT, 
	"Estimator" FLOAT
)
...
-- Code For temporary table TMP_20180508182234_CODEGEN_PC0XHS_LGBM_B1 part 2. Populate
...
FROM "DT_Output_15")
 INSERT INTO "TMP_20180508182234_CODEGEN_PC0XHS_LGBM_B1" ("KEY", "Estimator") SELECT "LGBM_B1"."KEY", "LGBM_B1"."Estimator" 
...
-- Code For temporary table TMP_20180508182234_CODEGEN_FCZ794_LGBM_Union part 1. Create 


CREATE TEMPORARY TABLE "TMP_20180508182234_CODEGEN_FCZ794_LGBM_Union" (
	"KEY" BIGINT, 
	"Estimator" FLOAT
)
...
-- Code For temporary table TMP_20180508182234_CODEGEN_FCZ794_LGBM_Union part 2. Populate

INSERT INTO "TMP_20180508182234_CODEGEN_FCZ794_LGBM_Union" ("KEY", "Estimator") SELECT "LGBM_Union"."KEY", "LGBM_Union"."Estimator" 
...
FROM "TMP_20180508182234_CODEGEN_GKC4QK_LGBM_B0" AS "LGBM_B0" UNION ALL SELECT "LGBM_B1"."KEY" AS "KEY", "LGBM_B1"."Estimator" AS "Estimator" 
FROM "TMP_20180508182234_CODEGEN_PC0XHS_LGBM_B1" AS "LGBM_B1") AS "LGBM_EnsembleUnion") AS "LGBM_Union"

-- Code For temporary table TMP_20180508182234_CODEGEN_SUWL2C_LGBM_sum part 1. Create 


CREATE TEMPORARY TABLE "TMP_20180508182234_CODEGEN_SUWL2C_LGBM_sum" (
	"KEY" BIGINT NOT NULL, 
	"Estimator" FLOAT, 
	PRIMARY KEY ("KEY")
)
...
-- Code For temporary table TMP_20180508182234_CODEGEN_SUWL2C_LGBM_sum part 2. Populate

INSERT INTO "TMP_20180508182234_CODEGEN_SUWL2C_LGBM_sum" ("KEY", "Estimator") SELECT "LGBM_sum"."KEY", "LGBM_sum"."Estimator" 
...
FROM "TMP_20180508182234_CODEGEN_FCZ794_LGBM_Union" AS "LGBM_Union" GROUP BY "LGBM_Union"."KEY") AS "T") AS "LGBM_sum"

-- Code For temporary table TMP_20180508182234_CODEGEN_SUWL2C_LGBM_sum part 3. Create Index 

CREATE INDEX "ix_TMP_20180508182234_CODEGEN_SUWL2C_LGBM_sum_KEY" ON "TMP_20180508182234_CODEGEN_SUWL2C_LGBM_sum" ("KEY")

-- Model deployment code

SELECT "LGBM_sum"."KEY" AS "KEY", "LGBM_sum"."Estimator" AS "Estimator" 
FROM "TMP_20180508182234_CODEGEN_SUWL2C_LGBM_sum" AS "LGBM_sum"