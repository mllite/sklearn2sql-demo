...
-- Code For temporary table ##TMP_20180508182126_CODEGEN_DJ1DPE_ADS_imp_1_OUT part 1. Create 


CREATE TABLE ##TMP_20180508182126_CODEGEN_DJ1DPE_ADS_imp_1_OUT (
	[KEY] BIGINT NULL, 
...
-- Code For temporary table ##TMP_20180508182126_CODEGEN_X3X0W3_ADS_sca_2_OUT part 1. Create 


CREATE TABLE ##TMP_20180508182126_CODEGEN_X3X0W3_ADS_sca_2_OUT (
	[KEY] BIGINT NULL, 
	scaler_2 FLOAT NULL, 
	scaler_3 FLOAT NULL, 
	scaler_4 FLOAT NULL, 
...
-- Code For temporary table ##TMP_20180508182126_CODEGEN_X3X0W3_ADS_sca_2_OUT part 2. Populate

INSERT INTO ##TMP_20180508182126_CODEGEN_X3X0W3_ADS_sca_2_OUT ([KEY], scaler_2, scaler_3, scaler_4, scaler_5, scaler_6, scaler_7, scaler_8, scaler_9, scaler_10, scaler_11) SELECT [ADS_sca_2_OUT].[KEY], [ADS_sca_2_OUT].scaler_2, [ADS_sca_2_OUT].scaler_3, [ADS_sca_2_OUT].scaler_4, [ADS_sca_2_OUT].scaler_5, [ADS_sca_2_OUT].scaler_6, [ADS_sca_2_OUT].scaler_7, [ADS_sca_2_OUT].scaler_8, [ADS_sca_2_OUT].scaler_9, [ADS_sca_2_OUT].scaler_10, [ADS_sca_2_OUT].scaler_11 
...
FROM ##TMP_20180508182126_CODEGEN_DJ1DPE_ADS_imp_1_OUT AS [ADS_imp_1_OUT]) AS [ADS_sca_2_OUT]

-- Code For temporary table ##TMP_20180508182126_CODEGEN_WKARI2_BAG_B0 part 1. Create 


CREATE TABLE ##TMP_20180508182126_CODEGEN_WKARI2_BAG_B0 (
	[KEY] BIGINT NULL, 
...
-- Code For temporary table ##TMP_20180508182126_CODEGEN_WKARI2_BAG_B0 part 2. Populate
...
FROM ##TMP_20180508182126_CODEGEN_X3X0W3_ADS_sca_2_OUT AS [ADS_sca_2_OUT]), 
[DT_node_data] AS 
...
FROM [DT_Output_9])
 INSERT INTO ##TMP_20180508182126_CODEGEN_WKARI2_BAG_B0 ([KEY], [Estimator]) SELECT [BAG_B0].[KEY], [BAG_B0].[Estimator] 
...
-- Code For temporary table ##TMP_20180508182126_CODEGEN_GX68DS_BAG_B1 part 1. Create 


CREATE TABLE ##TMP_20180508182126_CODEGEN_GX68DS_BAG_B1 (
	[KEY] BIGINT NULL, 
	[Estimator] FLOAT(53) NULL
)
...
-- Code For temporary table ##TMP_20180508182126_CODEGEN_GX68DS_BAG_B1 part 2. Populate
...
FROM [DT_Output_15])
 INSERT INTO ##TMP_20180508182126_CODEGEN_GX68DS_BAG_B1 ([KEY], [Estimator]) SELECT [BAG_B1].[KEY], [BAG_B1].[Estimator] 
...
-- Code For temporary table ##TMP_20180508182126_CODEGEN_ULFTM5_BAG_Union part 1. Create 


CREATE TABLE ##TMP_20180508182126_CODEGEN_ULFTM5_BAG_Union (
	[KEY] BIGINT NULL, 
	[Estimator] FLOAT(53) NULL
)
...
-- Code For temporary table ##TMP_20180508182126_CODEGEN_ULFTM5_BAG_Union part 2. Populate

INSERT INTO ##TMP_20180508182126_CODEGEN_ULFTM5_BAG_Union ([KEY], [Estimator]) SELECT [BAG_Union].[KEY], [BAG_Union].[Estimator] 
...
FROM ##TMP_20180508182126_CODEGEN_WKARI2_BAG_B0 AS [BAG_B0] UNION ALL SELECT [BAG_B1].[KEY] AS [KEY], [BAG_B1].[Estimator] AS [Estimator] 
FROM ##TMP_20180508182126_CODEGEN_GX68DS_BAG_B1 AS [BAG_B1]) AS [BAG_EnsembleUnion]) AS [BAG_Union]

-- Code For temporary table ##TMP_20180508182126_CODEGEN_5I6P28_BAG_avg part 1. Create 


CREATE TABLE ##TMP_20180508182126_CODEGEN_5I6P28_BAG_avg (
	[KEY] BIGINT NULL, 
	[Estimator] FLOAT(53) NULL
)
...
-- Code For temporary table ##TMP_20180508182126_CODEGEN_5I6P28_BAG_avg part 2. Populate

INSERT INTO ##TMP_20180508182126_CODEGEN_5I6P28_BAG_avg ([KEY], [Estimator]) SELECT [BAG_avg].[KEY], [BAG_avg].[Estimator] 
...
FROM ##TMP_20180508182126_CODEGEN_ULFTM5_BAG_Union AS [BAG_Union] GROUP BY [BAG_Union].[KEY]) AS [T]) AS [BAG_avg]

-- Model deployment code

SELECT [BAG_avg].[KEY] AS [KEY], [BAG_avg].[Estimator] AS [Estimator] 
FROM ##TMP_20180508182126_CODEGEN_5I6P28_BAG_avg AS [BAG_avg]