...
-- Code For temporary table tmp_20180508193152_codegen_kh6q9p_ads_imp_1_out part 1. Create 


CREATE TABLE tmp_20180508193152_codegen_kh6q9p_ads_imp_1_out (
	`KEY` BIGINT, 
	impter_2 DOUBLE, 
	impter_3 DOUBLE, 
	impter_4 DOUBLE, 
...
-- Code For temporary table tmp_20180508193152_codegen_pn76h3_ads_sca_2_out part 1. Create 


CREATE TABLE tmp_20180508193152_codegen_pn76h3_ads_sca_2_out (
	`KEY` BIGINT, 
	scaler_2 DOUBLE, 
	scaler_3 DOUBLE, 
	scaler_4 DOUBLE, 
...
FROM tmp_20180508193152_codegen_kh6q9p_ads_imp_1_out AS `ADS_imp_1_OUT`) AS `ADS_sca_2_OUT`

-- Code For temporary table tmp_20180508193152_codegen_0vmscp_bag_b0 part 1. Create 


CREATE TABLE tmp_20180508193152_codegen_0vmscp_bag_b0 (
	`KEY` BIGINT, 
	`Estimator` DOUBLE
)
...
-- Code For temporary table tmp_20180508193152_codegen_0vmscp_bag_b0 part 2. Populate
...
FROM tmp_20180508193152_codegen_pn76h3_ads_sca_2_out AS `ADS_sca_2_OUT`), 
`DT_node_data` AS 
...
FROM `DT_Output_9`)
 INSERT INTO tmp_20180508193152_codegen_0vmscp_bag_b0 (`KEY`, `Estimator`) SELECT `BAG_B0`.`KEY`, `BAG_B0`.`Estimator` 
...
-- Code For temporary table tmp_20180508193152_codegen_snu1nl_bag_b1 part 1. Create 


CREATE TABLE tmp_20180508193152_codegen_snu1nl_bag_b1 (
	`KEY` BIGINT, 
	`Estimator` DOUBLE
)
...
-- Code For temporary table tmp_20180508193152_codegen_snu1nl_bag_b1 part 2. Populate
...
FROM `DT_Output_15`)
 INSERT INTO tmp_20180508193152_codegen_snu1nl_bag_b1 (`KEY`, `Estimator`) SELECT `BAG_B1`.`KEY`, `BAG_B1`.`Estimator` 
...
-- Code For temporary table tmp_20180508193152_codegen_uq7zrc_bag_union part 1. Create 


CREATE TABLE tmp_20180508193152_codegen_uq7zrc_bag_union (
	`KEY` BIGINT, 
	`Estimator` DOUBLE
)
...
-- Code For temporary table tmp_20180508193152_codegen_uq7zrc_bag_union part 2. Populate

INSERT INTO tmp_20180508193152_codegen_uq7zrc_bag_union (`KEY`, `Estimator`) SELECT `BAG_Union`.`KEY`, `BAG_Union`.`Estimator` 
...
FROM tmp_20180508193152_codegen_0vmscp_bag_b0 AS `BAG_B0` UNION ALL SELECT `BAG_B1`.`KEY` AS `KEY`, `BAG_B1`.`Estimator` AS `Estimator` 
FROM tmp_20180508193152_codegen_snu1nl_bag_b1 AS `BAG_B1`) AS `BAG_EnsembleUnion`) AS `BAG_Union`

-- Code For temporary table tmp_20180508193152_codegen_qpyvyn_bag_avg part 1. Create 


CREATE TABLE tmp_20180508193152_codegen_qpyvyn_bag_avg (
	`KEY` BIGINT, 
	`Estimator` DOUBLE
)
...
-- Code For temporary table tmp_20180508193152_codegen_qpyvyn_bag_avg part 2. Populate

INSERT INTO tmp_20180508193152_codegen_qpyvyn_bag_avg (`KEY`, `Estimator`) SELECT `BAG_avg`.`KEY`, `BAG_avg`.`Estimator` 
...
FROM tmp_20180508193152_codegen_uq7zrc_bag_union AS `BAG_Union` GROUP BY `BAG_Union`.`KEY`) AS `T`) AS `BAG_avg`

-- Model deployment code

SELECT `BAG_avg`.`KEY` AS `KEY`, `BAG_avg`.`Estimator` AS `Estimator` 
FROM tmp_20180508193152_codegen_qpyvyn_bag_avg AS `BAG_avg`