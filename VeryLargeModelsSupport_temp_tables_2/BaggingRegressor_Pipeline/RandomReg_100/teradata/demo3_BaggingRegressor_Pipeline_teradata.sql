...
-- Code For temporary table tmp_20180508182506_codegen_sqzpvi_ads_imp_1_out part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180508182506_codegen_sqzpvi_ads_imp_1_out  (
	"KEY" BIGINT, 
...
-- Code For temporary table tmp_20180508182506_codegen_2gl7y5_ads_sca_2_out part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180508182506_codegen_2gl7y5_ads_sca_2_out  (
	"KEY" BIGINT, 
...
FROM tmp_20180508182506_codegen_sqzpvi_ads_imp_1_out AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT") AS "U"

-- Code For temporary table tmp_20180508182507_codegen_58loy3_bag_b0 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180508182507_codegen_58loy3_bag_b0  (
	"KEY" BIGINT, 
...
-- Code For temporary table tmp_20180508182507_codegen_58loy3_bag_b0 part 2. Populate

INSERT INTO tmp_20180508182507_codegen_58loy3_bag_b0 ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
FROM tmp_20180508182506_codegen_2gl7y5_ads_sca_2_out AS "ADS_sca_2_OUT"), 
dummy_cte AS 
...
-- Code For temporary table tmp_20180508182507_codegen_t2y8qx_bag_b1 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180508182507_codegen_t2y8qx_bag_b1  (
	"KEY" BIGINT, 
	"Estimator" DOUBLE PRECISION
)
...
-- Code For temporary table tmp_20180508182507_codegen_t2y8qx_bag_b1 part 2. Populate

INSERT INTO tmp_20180508182507_codegen_t2y8qx_bag_b1 ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
-- Code For temporary table tmp_20180508182507_codegen_d6qoz9_bag_union part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180508182507_codegen_d6qoz9_bag_union  (
	"KEY" BIGINT, 
	"Estimator" DOUBLE PRECISION
)
...
-- Code For temporary table tmp_20180508182507_codegen_d6qoz9_bag_union part 2. Populate

INSERT INTO tmp_20180508182507_codegen_d6qoz9_bag_union ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
FROM tmp_20180508182507_codegen_58loy3_bag_b0 AS "BAG_B0" UNION ALL SELECT "BAG_B1"."KEY" AS "KEY", "BAG_B1"."Estimator" AS "Estimator" 
FROM tmp_20180508182507_codegen_t2y8qx_bag_b1 AS "BAG_B1") AS "BAG_EnsembleUnion") AS "BAG_Union") AS "U"

-- Code For temporary table tmp_20180508182507_codegen_svsi85_bag_avg part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180508182507_codegen_svsi85_bag_avg  (
	"KEY" BIGINT, 
	"Estimator" DOUBLE PRECISION
)
...
-- Code For temporary table tmp_20180508182507_codegen_svsi85_bag_avg part 2. Populate

INSERT INTO tmp_20180508182507_codegen_svsi85_bag_avg ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
FROM tmp_20180508182507_codegen_d6qoz9_bag_union AS "BAG_Union" GROUP BY "BAG_Union"."KEY") AS "T") AS "BAG_avg") AS "U"

-- Model deployment code

SELECT "BAG_avg"."KEY" AS "KEY", "BAG_avg"."Estimator" AS "Estimator" 
FROM tmp_20180508182507_codegen_svsi85_bag_avg AS "BAG_avg"