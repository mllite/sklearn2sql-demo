...
linear_model_cte AS 
(SELECT linear_input."KEY" AS "KEY", CAST(0.367407891600021 AS DOUBLE PRECISION) * linear_input."Feature_0" + CAST(1.417475205021328 AS DOUBLE PRECISION) * linear_input."Feature_1" + CAST(-2.142257483278976 AS DOUBLE PRECISION) * linear_input."Feature_2" + CAST(-0.958993964927167 AS DOUBLE PRECISION) * linear_input."Feature_3" + CAST(0.252841819367554 AS DOUBLE PRECISION) AS "Score_CLASS_0", CAST(0.486310347304012 AS DOUBLE PRECISION) * linear_input."Feature_0" + CAST(-1.544784607377755 AS DOUBLE PRECISION) * linear_input."Feature_1" + CAST(0.480758220327249 AS DOUBLE PRECISION) * linear_input."Feature_2" + CAST(-1.320608335038882 AS DOUBLE PRECISION) * linear_input."Feature_3" + CAST(0.80727265037231 AS DOUBLE PRECISION) AS "Score_CLASS_1", CAST(-1.624720269000634 AS DOUBLE PRECISION) * linear_input."Feature_0" + CAST(-1.45587122136632 AS DOUBLE PRECISION) * linear_input."Feature_1" + CAST(2.382068725371414 AS DOUBLE PRECISION) * linear_input."Feature_2" + CAST(2.356508663538953 AS DOUBLE PRECISION) * linear_input."Feature_3" + CAST(-1.116572480612141 AS DOUBLE PRECISION) AS "Score_CLASS_2" 
FROM linear_input), 
