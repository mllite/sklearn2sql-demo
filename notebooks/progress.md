...
Source : https://github.com/antoinecarme/keras2sql/tree/master/doc

All Keras classification and regression models built with a combination/sequence of the following layers are supported  :
...
Does not depend (a lot ;) on the backend used : tested with tensorflow , theano and cntk .
