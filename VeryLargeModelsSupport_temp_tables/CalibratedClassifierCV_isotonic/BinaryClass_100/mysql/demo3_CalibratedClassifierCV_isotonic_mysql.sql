...
-- Code For temporary table TMP_20180416223105_DRY6E7_CalProb_B0 part 1/2. Create 


CREATE TEMPORARY TABLE `TMP_20180416223105_DRY6E7_CalProb_B0` (
	`KEY` BIGINT, 
	`Proba_1` DOUBLE, 
	`Proba_0` DOUBLE
)
...
-- Code For temporary table TMP_20180416223105_DRY6E7_CalProb_B0 part 2/2. Populate

INSERT INTO `TMP_20180416223105_DRY6E7_CalProb_B0` (`KEY`, `Proba_1`, `Proba_0`) SELECT `U`.`KEY`, `U`.`Proba_1`, `U`.`Proba_0` 
...
-- Code For temporary table TMP_20180416223105_IJNR7D_CalProb_Union part 1/2. Create 


CREATE TEMPORARY TABLE `TMP_20180416223105_IJNR7D_CalProb_Union` (
	`KEY` BIGINT, 
	`Proba_1` DOUBLE, 
	`Proba_0` DOUBLE
)
...
-- Code For temporary table TMP_20180416223105_IJNR7D_CalProb_Union part 2/2. Populate

INSERT INTO `TMP_20180416223105_IJNR7D_CalProb_Union` (`KEY`, `Proba_1`, `Proba_0`) SELECT `U`.`KEY`, `U`.`Proba_1`, `U`.`Proba_0` 
...
FROM `TMP_20180416223105_DRY6E7_CalProb_B0` AS `CalProb_B0`) AS `CalProb_EnsembleUnion`) AS `CalProb_Union`) AS `U`

-- Code For temporary table TMP_20180416223105_9TI2JR_CalProb_avg part 1/2. Create 


CREATE TEMPORARY TABLE `TMP_20180416223105_9TI2JR_CalProb_avg` (
	`KEY` BIGINT NOT NULL, 
	`Proba_1` DOUBLE, 
	`Proba_0` DOUBLE, 
	PRIMARY KEY (`KEY`)
...
-- Code For temporary table TMP_20180416223105_9TI2JR_CalProb_avg part 2/2. Populate

INSERT INTO `TMP_20180416223105_9TI2JR_CalProb_avg` (`KEY`, `Proba_1`, `Proba_0`) SELECT `U`.`KEY`, `U`.`Proba_1`, `U`.`Proba_0` 
...
FROM `TMP_20180416223105_IJNR7D_CalProb_Union` AS `CalProb_Union` GROUP BY `CalProb_Union`.`KEY`) AS `T`) AS `CalProb_avg`) AS `U`
...
FROM `TMP_20180416223105_9TI2JR_CalProb_avg` AS `CalProb_avg`), 
