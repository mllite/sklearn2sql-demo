...
-- Code For temporary table TMP_20180416223555_QT78RK_CALPR part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180416223555_QT78RK_CALPR" (
	"KEY" BIGINT, 
	"Proba_1" FLOAT, 
	"Proba_0" FLOAT
)
...
-- Code For temporary table TMP_20180416223555_QT78RK_CALPR part 2/2. Populate

INSERT INTO "TMP_20180416223555_QT78RK_CALPR" ("KEY", "Proba_1", "Proba_0") SELECT "U"."KEY", "U"."Proba_1", "U"."Proba_0" 
...
-- Code For temporary table TMP_20180416223555_H3J3OM_CALPR part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180416223555_H3J3OM_CALPR" (
	"KEY" BIGINT, 
	"Proba_1" FLOAT, 
	"Proba_0" FLOAT
)
...
-- Code For temporary table TMP_20180416223555_H3J3OM_CALPR part 2/2. Populate

INSERT INTO "TMP_20180416223555_H3J3OM_CALPR" ("KEY", "Proba_1", "Proba_0") SELECT "U"."KEY", "U"."Proba_1", "U"."Proba_0" 
...
FROM "TMP_20180416223555_QT78RK_CALPR" AS "CalProb_B0") AS "CalProb_EnsembleUnion") AS "CalProb_Union") AS "U"

-- Code For temporary table TMP_20180416223555_KUX1YV_CALPR part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180416223555_KUX1YV_CALPR" (
	"KEY" BIGINT, 
	"Proba_1" FLOAT, 
	"Proba_0" FLOAT
)
...
-- Code For temporary table TMP_20180416223555_KUX1YV_CALPR part 2/2. Populate

INSERT INTO "TMP_20180416223555_KUX1YV_CALPR" ("KEY", "Proba_1", "Proba_0") SELECT "U"."KEY", "U"."Proba_1", "U"."Proba_0" 
...
FROM "TMP_20180416223555_H3J3OM_CALPR" AS "CalProb_Union" GROUP BY "CalProb_Union"."KEY") AS "T") AS "CalProb_avg") AS "U"
...
FROM "TMP_20180416223555_KUX1YV_CALPR" AS "CalProb_avg"), 
