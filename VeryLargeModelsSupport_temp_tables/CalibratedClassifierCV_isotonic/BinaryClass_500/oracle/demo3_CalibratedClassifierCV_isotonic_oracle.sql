...
-- Code For temporary table 16223555_47DAD9_CALPROB_B0 part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE "16223555_47DAD9_CALPROB_B0" (
	"KEY" NUMBER(19), 
...
-- Code For temporary table 16223555_47DAD9_CALPROB_B0 part 2/2. Populate

INSERT INTO "16223555_47DAD9_CALPROB_B0" ("KEY", "Proba_1", "Proba_0") SELECT "U"."KEY", "U"."Proba_1", "U"."Proba_0" 
...
-- Code For temporary table 23555_ISXM37_CALPROB_UNION part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE "23555_ISXM37_CALPROB_UNION" (
	"KEY" NUMBER(19), 
	"Proba_1" BINARY_DOUBLE, 
	"Proba_0" BINARY_DOUBLE
)
...
-- Code For temporary table 23555_ISXM37_CALPROB_UNION part 2/2. Populate

INSERT INTO "23555_ISXM37_CALPROB_UNION" ("KEY", "Proba_1", "Proba_0") SELECT "U"."KEY", "U"."Proba_1", "U"."Proba_0" 
...
FROM "16223555_47DAD9_CALPROB_B0" "CalProb_B0") "CalProb_EnsembleUnion") "CalProb_Union") "U"

-- Code For temporary table 6223555_UL05FO_CALPROB_AVG part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE "6223555_UL05FO_CALPROB_AVG" (
...
-- Code For temporary table 6223555_UL05FO_CALPROB_AVG part 2/2. Populate

INSERT INTO "6223555_UL05FO_CALPROB_AVG" ("KEY", "Proba_1", "Proba_0") SELECT "U"."KEY", "U"."Proba_1", "U"."Proba_0" 
...
FROM "23555_ISXM37_CALPROB_UNION" "CalProb_Union" GROUP BY "CalProb_Union"."KEY") "T") "CalProb_avg") "U"
...
FROM "6223555_UL05FO_CALPROB_AVG" "CalProb_avg"), 
