...
-- Code For temporary table tmp_20180416222640_ib7wls_calp part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180416222640_ib7wls_calp  (
	"KEY" BIGINT, 
	"Proba_1" FLOAT, 
	"Proba_0" FLOAT
)
...
-- Code For temporary table tmp_20180416222640_ib7wls_calp part 2/2. Populate

INSERT INTO tmp_20180416222640_ib7wls_calp ("KEY", "Proba_1", "Proba_0") SELECT "U"."KEY", "U"."Proba_1", "U"."Proba_0" 
FROM (WITH "DT_node_lookup" AS 
(SELECT "ADS"."KEY" AS "KEY", CASE WHEN ("ADS"."Feature_9" <= 0.152860224246979) THEN CASE WHEN ("ADS"."Feature_5" <= 2.370686292648316) THEN CASE WHEN ("ADS"."Feature_5" <= -1.473185777664184) THEN CASE WHEN ("ADS"."Feature_3" <= 0.849347174167633) THEN 4 ELSE 5 END ELSE 6 END ELSE 7 END ELSE CASE WHEN ("ADS"."Feature_6" <= 1.934103488922119) THEN 9 ELSE 10 END END AS node_id_2 
...
FROM "DT_Output"), 
isotonic_cte_0 AS 
(SELECT "Calibrated_Model_0"."KEY" AS "KEY", CASE WHEN ("Calibrated_Model_0"."ScoreOrProba_1" < 0.0) THEN 0.230769230769231 WHEN ("Calibrated_Model_0"."ScoreOrProba_1" < 1.0) THEN ("Calibrated_Model_0"."ScoreOrProba_1" - 0.0) * 0.769230769230769 + 0.230769230769231 ELSE 1.0 END AS "Proba_1", 1.0 - CASE WHEN ("Calibrated_Model_0"."ScoreOrProba_1" < 0.0) THEN 0.230769230769231 WHEN ("Calibrated_Model_0"."ScoreOrProba_1" < 1.0) THEN ("Calibrated_Model_0"."ScoreOrProba_1" - 0.0) * 0.769230769230769 + 0.230769230769231 ELSE 1.0 END AS "Proba_0" 
...
FROM isotonic_cte_0), 
"DT_node_lookup_1" AS 
(SELECT "ADS"."KEY" AS "KEY", CASE WHEN ("ADS"."Feature_9" <= 0.034406058490276) THEN CASE WHEN ("ADS"."Feature_5" <= 2.370686292648316) THEN CASE WHEN ("ADS"."Feature_2" <= 1.922914505004883) THEN CASE WHEN ("ADS"."Feature_3" <= 1.646399855613708) THEN CASE WHEN ("ADS"."Feature_3" <= 1.242140054702759) THEN 5 ELSE 6 END ELSE 7 END ELSE 8 END ELSE 9 END ELSE CASE WHEN ("ADS"."Feature_5" <= 1.928068161010742) THEN 11 ELSE 12 END END AS node_id_2 
FROM "BinaryClass_10" AS "ADS"), 
"DT_node_data_1" AS 
(SELECT "Values".node_id AS node_id, CAST("Values".feature AS FLOAT) AS feature, CAST("Values"."threshold" AS FLOAT) AS "threshold", CAST("Values"."count" AS FLOAT) AS "count", CAST("Values".depth AS FLOAT) AS depth, CAST("Values".parent_id AS FLOAT) AS parent_id, CAST("Values"."Proba_0" AS FLOAT) AS "Proba_0", CAST("Values"."LogProba_0" AS FLOAT) AS "LogProba_0", CAST("Values"."Proba_1" AS FLOAT) AS "Proba_1", CAST("Values"."LogProba_1" AS FLOAT) AS "LogProba_1", CAST("Values"."Decision" AS FLOAT) AS "Decision", CAST("Values"."DecisionProba" AS FLOAT) AS "DecisionProba" 
...
FROM isotonic_cte_1), 
"DT_node_lookup_2" AS 
(SELECT "ADS"."KEY" AS "KEY", CASE WHEN ("ADS"."Feature_9" <= 0.034406058490276) THEN CASE WHEN ("ADS"."Feature_5" <= 2.370686292648316) THEN CASE WHEN ("ADS"."Feature_2" <= 1.922914505004883) THEN CASE WHEN ("ADS"."Feature_3" <= 1.771678566932678) THEN CASE WHEN ("ADS"."Feature_8" <= 1.071829795837402) THEN 5 ELSE 6 END ELSE 7 END ELSE 8 END ELSE 9 END ELSE CASE WHEN ("ADS"."Feature_6" <= 2.032079219818115) THEN 11 ELSE 12 END END AS node_id_2 
FROM "BinaryClass_10" AS "ADS"), 
"DT_node_data_2" AS 
(SELECT "Values".node_id AS node_id, CAST("Values".feature AS FLOAT) AS feature, CAST("Values"."threshold" AS FLOAT) AS "threshold", CAST("Values"."count" AS FLOAT) AS "count", CAST("Values".depth AS FLOAT) AS depth, CAST("Values".parent_id AS FLOAT) AS parent_id, CAST("Values"."Proba_0" AS FLOAT) AS "Proba_0", CAST("Values"."LogProba_0" AS FLOAT) AS "LogProba_0", CAST("Values"."Proba_1" AS FLOAT) AS "Proba_1", CAST("Values"."LogProba_1" AS FLOAT) AS "LogProba_1", CAST("Values"."Decision" AS FLOAT) AS "Decision", CAST("Values"."DecisionProba" AS FLOAT) AS "DecisionProba" 
...
FROM "DT_Output_2"), 
isotonic_cte_2 AS 
(SELECT "Calibrated_Model_2"."KEY" AS "KEY", CASE WHEN ("Calibrated_Model_2"."ScoreOrProba_1" < 0.0) THEN 0.166666666666667 WHEN ("Calibrated_Model_2"."ScoreOrProba_1" < 1.0) THEN ("Calibrated_Model_2"."ScoreOrProba_1" - 0.0) * 0.833333333333333 + 0.166666666666667 ELSE 1.0 END AS "Proba_1", 1.0 - CASE WHEN ("Calibrated_Model_2"."ScoreOrProba_1" < 0.0) THEN 0.166666666666667 WHEN ("Calibrated_Model_2"."ScoreOrProba_1" < 1.0) THEN ("Calibrated_Model_2"."ScoreOrProba_1" - 0.0) * 0.833333333333333 + 0.166666666666667 ELSE 1.0 END AS "Proba_0" 
...
FROM isotonic_cte_2), 
"DT_node_lookup_3" AS 
(SELECT "ADS"."KEY" AS "KEY", CASE WHEN ("ADS"."Feature_9" <= -0.272910356521606) THEN CASE WHEN ("ADS"."Feature_6" <= 1.62392270565033) THEN CASE WHEN ("ADS"."Feature_5" <= 2.391359567642212) THEN CASE WHEN ("ADS"."Feature_5" <= -1.473185777664184) THEN CASE WHEN ("ADS"."Feature_0" <= 1.150492906570434) THEN 5 ELSE 6 END ELSE 7 END ELSE 8 END ELSE 9 END ELSE CASE WHEN ("ADS"."Feature_6" <= 1.934103488922119) THEN CASE WHEN ("ADS"."Feature_9" <= -0.039503190666437) THEN CASE WHEN ("ADS"."Feature_3" <= -0.098098665475845) THEN 13 ELSE 14 END ELSE 15 END ELSE 16 END END AS node_id_2 
FROM "BinaryClass_10" AS "ADS"), 
"DT_node_data_3" AS 
(SELECT "Values".node_id AS node_id, CAST("Values".feature AS FLOAT) AS feature, CAST("Values"."threshold" AS FLOAT) AS "threshold", CAST("Values"."count" AS FLOAT) AS "count", CAST("Values".depth AS FLOAT) AS depth, CAST("Values".parent_id AS FLOAT) AS parent_id, CAST("Values"."Proba_0" AS FLOAT) AS "Proba_0", CAST("Values"."LogProba_0" AS FLOAT) AS "LogProba_0", CAST("Values"."Proba_1" AS FLOAT) AS "Proba_1", CAST("Values"."LogProba_1" AS FLOAT) AS "LogProba_1", CAST("Values"."Decision" AS FLOAT) AS "Decision", CAST("Values"."DecisionProba" AS FLOAT) AS "DecisionProba" 
...
-- Code For temporary table tmp_20180416222640_r3izpq_calp part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180416222640_r3izpq_calp  (
	"KEY" BIGINT, 
	"Proba_1" FLOAT, 
	"Proba_0" FLOAT
)
...
-- Code For temporary table tmp_20180416222640_r3izpq_calp part 2/2. Populate

INSERT INTO tmp_20180416222640_r3izpq_calp ("KEY", "Proba_1", "Proba_0") SELECT "U"."KEY", "U"."Proba_1", "U"."Proba_0" 
...
FROM tmp_20180416222640_ib7wls_calp AS "CalProb_B0") AS "CalProb_EnsembleUnion") AS "CalProb_Union") AS "U"

-- Code For temporary table tmp_20180416222640_uk49oc_calp part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180416222640_uk49oc_calp  (
	"KEY" BIGINT, 
	"Proba_1" FLOAT, 
	"Proba_0" FLOAT
)
...
-- Code For temporary table tmp_20180416222640_uk49oc_calp part 2/2. Populate

INSERT INTO tmp_20180416222640_uk49oc_calp ("KEY", "Proba_1", "Proba_0") SELECT "U"."KEY", "U"."Proba_1", "U"."Proba_0" 
...
FROM tmp_20180416222640_r3izpq_calp AS "CalProb_Union" GROUP BY "CalProb_Union"."KEY") AS "T") AS "CalProb_avg") AS "U"
...
FROM tmp_20180416222640_uk49oc_calp AS "CalProb_avg"), 
