...
-- Code For temporary table tmp_20180417042052_pe1vrk_calprob_b0 part 1/2. Create 


CREATE TEMPORARY TABLE tmp_20180417042052_pe1vrk_calprob_b0 (
	"KEY" BIGINT, 
	"Proba_0" FLOAT, 
	"Proba_1" FLOAT, 
	"Proba_2" FLOAT
...
-- Code For temporary table tmp_20180417042052_pe1vrk_calprob_b0 part 2/2. Populate

INSERT INTO tmp_20180417042052_pe1vrk_calprob_b0 ("KEY", "Proba_0", "Proba_1", "Proba_2") SELECT "U"."KEY", "U"."Proba_0", "U"."Proba_1", "U"."Proba_2" 
...
-- Code For temporary table tmp_20180417042052_yskudt_calprob_union part 1/2. Create 


CREATE TEMPORARY TABLE tmp_20180417042052_yskudt_calprob_union (
	"KEY" BIGINT, 
	"Proba_0" FLOAT, 
	"Proba_1" FLOAT, 
	"Proba_2" FLOAT
...
-- Code For temporary table tmp_20180417042052_yskudt_calprob_union part 2/2. Populate

INSERT INTO tmp_20180417042052_yskudt_calprob_union ("KEY", "Proba_0", "Proba_1", "Proba_2") SELECT "U"."KEY", "U"."Proba_0", "U"."Proba_1", "U"."Proba_2" 
...
FROM tmp_20180417042052_pe1vrk_calprob_b0 AS "CalProb_B0") AS "CalProb_EnsembleUnion") AS "CalProb_Union") AS "U"

-- Code For temporary table tmp_20180417042052_6c4id2_calprob_avg part 1/2. Create 


CREATE TEMPORARY TABLE tmp_20180417042052_6c4id2_calprob_avg (
	"KEY" BIGINT NOT NULL, 
	"Proba_0" FLOAT, 
	"Proba_1" FLOAT, 
	"Proba_2" FLOAT, 
...
-- Code For temporary table tmp_20180417042052_6c4id2_calprob_avg part 2/2. Populate

INSERT INTO tmp_20180417042052_6c4id2_calprob_avg ("KEY", "Proba_0", "Proba_1", "Proba_2") SELECT "U"."KEY", "U"."Proba_0", "U"."Proba_1", "U"."Proba_2" 
...
FROM tmp_20180417042052_yskudt_calprob_union AS "CalProb_Union" GROUP BY "CalProb_Union"."KEY") AS "T") AS "CalProb_avg") AS "U"
...
FROM tmp_20180417042052_6c4id2_calprob_avg AS "CalProb_avg"), 
