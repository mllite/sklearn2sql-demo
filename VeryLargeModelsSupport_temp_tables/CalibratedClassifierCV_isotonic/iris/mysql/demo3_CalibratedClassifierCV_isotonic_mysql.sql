...
-- Code For temporary table TMP_20180417042052_WAOR2Q_CalProb_B0 part 1/2. Create 


CREATE TEMPORARY TABLE `TMP_20180417042052_WAOR2Q_CalProb_B0` (
	`KEY` BIGINT, 
	`Proba_0` DOUBLE, 
	`Proba_1` DOUBLE, 
	`Proba_2` DOUBLE
...
-- Code For temporary table TMP_20180417042052_WAOR2Q_CalProb_B0 part 2/2. Populate

INSERT INTO `TMP_20180417042052_WAOR2Q_CalProb_B0` (`KEY`, `Proba_0`, `Proba_1`, `Proba_2`) SELECT `U`.`KEY`, `U`.`Proba_0`, `U`.`Proba_1`, `U`.`Proba_2` 
...
-- Code For temporary table TMP_20180417042052_7T39DU_CalProb_Union part 1/2. Create 


CREATE TEMPORARY TABLE `TMP_20180417042052_7T39DU_CalProb_Union` (
	`KEY` BIGINT, 
	`Proba_0` DOUBLE, 
	`Proba_1` DOUBLE, 
	`Proba_2` DOUBLE
...
-- Code For temporary table TMP_20180417042052_7T39DU_CalProb_Union part 2/2. Populate

INSERT INTO `TMP_20180417042052_7T39DU_CalProb_Union` (`KEY`, `Proba_0`, `Proba_1`, `Proba_2`) SELECT `U`.`KEY`, `U`.`Proba_0`, `U`.`Proba_1`, `U`.`Proba_2` 
...
FROM `TMP_20180417042052_WAOR2Q_CalProb_B0` AS `CalProb_B0`) AS `CalProb_EnsembleUnion`) AS `CalProb_Union`) AS `U`

-- Code For temporary table TMP_20180417042052_IN0ZMI_CalProb_avg part 1/2. Create 


CREATE TEMPORARY TABLE `TMP_20180417042052_IN0ZMI_CalProb_avg` (
	`KEY` BIGINT NOT NULL, 
	`Proba_0` DOUBLE, 
	`Proba_1` DOUBLE, 
	`Proba_2` DOUBLE, 
...
-- Code For temporary table TMP_20180417042052_IN0ZMI_CalProb_avg part 2/2. Populate

INSERT INTO `TMP_20180417042052_IN0ZMI_CalProb_avg` (`KEY`, `Proba_0`, `Proba_1`, `Proba_2`) SELECT `U`.`KEY`, `U`.`Proba_0`, `U`.`Proba_1`, `U`.`Proba_2` 
...
FROM `TMP_20180417042052_7T39DU_CalProb_Union` AS `CalProb_Union` GROUP BY `CalProb_Union`.`KEY`) AS `T`) AS `CalProb_avg`) AS `U`
...
FROM `TMP_20180417042052_IN0ZMI_CalProb_avg` AS `CalProb_avg`), 
