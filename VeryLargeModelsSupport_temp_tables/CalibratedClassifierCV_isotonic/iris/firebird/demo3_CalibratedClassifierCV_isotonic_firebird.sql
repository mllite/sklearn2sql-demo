...
-- Code For temporary table TMP_20180417042053_Y6QO3D_CALPR part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180417042053_Y6QO3D_CALPR" (
	"KEY" BIGINT, 
	"Proba_0" FLOAT, 
	"Proba_1" FLOAT, 
	"Proba_2" FLOAT
...
-- Code For temporary table TMP_20180417042053_Y6QO3D_CALPR part 2/2. Populate

INSERT INTO "TMP_20180417042053_Y6QO3D_CALPR" ("KEY", "Proba_0", "Proba_1", "Proba_2") SELECT "U"."KEY", "U"."Proba_0", "U"."Proba_1", "U"."Proba_2" 
...
-- Code For temporary table TMP_20180417042053_2Q8QAW_CALPR part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180417042053_2Q8QAW_CALPR" (
	"KEY" BIGINT, 
	"Proba_0" FLOAT, 
	"Proba_1" FLOAT, 
	"Proba_2" FLOAT
...
-- Code For temporary table TMP_20180417042053_2Q8QAW_CALPR part 2/2. Populate

INSERT INTO "TMP_20180417042053_2Q8QAW_CALPR" ("KEY", "Proba_0", "Proba_1", "Proba_2") SELECT "U"."KEY", "U"."Proba_0", "U"."Proba_1", "U"."Proba_2" 
...
FROM "TMP_20180417042053_Y6QO3D_CALPR" AS "CalProb_B0") AS "CalProb_EnsembleUnion") AS "CalProb_Union") AS "U"

-- Code For temporary table TMP_20180417042053_4K7GRK_CALPR part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180417042053_4K7GRK_CALPR" (
	"KEY" BIGINT, 
	"Proba_0" FLOAT, 
	"Proba_1" FLOAT, 
	"Proba_2" FLOAT
...
-- Code For temporary table TMP_20180417042053_4K7GRK_CALPR part 2/2. Populate

INSERT INTO "TMP_20180417042053_4K7GRK_CALPR" ("KEY", "Proba_0", "Proba_1", "Proba_2") SELECT "U"."KEY", "U"."Proba_0", "U"."Proba_1", "U"."Proba_2" 
...
FROM "TMP_20180417042053_2Q8QAW_CALPR" AS "CalProb_Union" GROUP BY "CalProb_Union"."KEY") AS "T") AS "CalProb_avg") AS "U"
...
FROM "TMP_20180417042053_4K7GRK_CALPR" AS "CalProb_avg"), 
