...
-- Code For temporary table TMP_20180417051020_MB7PDE_ADS_imp_1_OUT part 1/2. Create 


CREATE TEMPORARY TABLE "TMP_20180417051020_MB7PDE_ADS_imp_1_OUT" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20180417051020_MB7PDE_ADS_imp_1_OUT part 2/2. Populate

INSERT INTO "TMP_20180417051020_MB7PDE_ADS_imp_1_OUT" ("KEY", imputer_output_2, imputer_output_3, imputer_output_4, imputer_output_5) SELECT "ADS_imp_1_OUT"."KEY", "ADS_imp_1_OUT".imputer_output_2, "ADS_imp_1_OUT".imputer_output_3, "ADS_imp_1_OUT".imputer_output_4, "ADS_imp_1_OUT".imputer_output_5 
...
-- Code For temporary table TMP_20180417051020_A6EIO7_ADS_sca_2_OUT part 1/2. Create 


CREATE TEMPORARY TABLE "TMP_20180417051020_A6EIO7_ADS_sca_2_OUT" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20180417051020_A6EIO7_ADS_sca_2_OUT part 2/2. Populate

INSERT INTO "TMP_20180417051020_A6EIO7_ADS_sca_2_OUT" ("KEY", scaler_output_2, scaler_output_3, scaler_output_4, scaler_output_5) SELECT "ADS_sca_2_OUT"."KEY", "ADS_sca_2_OUT".scaler_output_2, "ADS_sca_2_OUT".scaler_output_3, "ADS_sca_2_OUT".scaler_output_4, "ADS_sca_2_OUT".scaler_output_5 
...
FROM "TMP_20180417051020_MB7PDE_ADS_imp_1_OUT" AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT"

-- Code For temporary table TMP_20180417051021_ZIU7Y6_GB_B0 part 1/2. Create 


CREATE TEMPORARY TABLE "TMP_20180417051021_ZIU7Y6_GB_B0" (
	"KEY" BIGINT, 
	"Score_CLASS_0" FLOAT, 
	"Score_CLASS_1" FLOAT, 
	"Score_CLASS_2" FLOAT
...
-- Code For temporary table TMP_20180417051021_ZIU7Y6_GB_B0 part 2/2. Populate
...
FROM "TMP_20180417051020_A6EIO7_ADS_sca_2_OUT" AS "ADS_sca_2_OUT"), 
"DT_node_data" AS 
...
FROM "DT_Output_9")
 INSERT INTO "TMP_20180417051021_ZIU7Y6_GB_B0" ("KEY", "Score_CLASS_0", "Score_CLASS_1", "Score_CLASS_2") SELECT "GB_B0"."KEY", "GB_B0"."Score_CLASS_0", "GB_B0"."Score_CLASS_1", "GB_B0"."Score_CLASS_2" 
...
-- Code For temporary table TMP_20180417051021_K8M5S9_GB_B1 part 1/2. Create 


CREATE TEMPORARY TABLE "TMP_20180417051021_K8M5S9_GB_B1" (
	"KEY" BIGINT, 
	"Score_CLASS_0" FLOAT, 
	"Score_CLASS_1" FLOAT, 
	"Score_CLASS_2" FLOAT
...
-- Code For temporary table TMP_20180417051021_K8M5S9_GB_B1 part 2/2. Populate
...
FROM "DT_Output_19")
 INSERT INTO "TMP_20180417051021_K8M5S9_GB_B1" ("KEY", "Score_CLASS_0", "Score_CLASS_1", "Score_CLASS_2") SELECT "GB_B1"."KEY", "GB_B1"."Score_CLASS_0", "GB_B1"."Score_CLASS_1", "GB_B1"."Score_CLASS_2" 
...
-- Code For temporary table TMP_20180417051021_VAGGW3_GB_B2 part 1/2. Create 


CREATE TEMPORARY TABLE "TMP_20180417051021_VAGGW3_GB_B2" (
	"KEY" BIGINT, 
	"Score_CLASS_0" FLOAT, 
	"Score_CLASS_1" FLOAT, 
	"Score_CLASS_2" FLOAT
...
-- Code For temporary table TMP_20180417051021_VAGGW3_GB_B2 part 2/2. Populate
...
FROM "DT_Output_29")
 INSERT INTO "TMP_20180417051021_VAGGW3_GB_B2" ("KEY", "Score_CLASS_0", "Score_CLASS_1", "Score_CLASS_2") SELECT "GB_B2"."KEY", "GB_B2"."Score_CLASS_0", "GB_B2"."Score_CLASS_1", "GB_B2"."Score_CLASS_2" 
...
-- Code For temporary table TMP_20180417051021_85Q7G3_GB_B3 part 1/2. Create 


CREATE TEMPORARY TABLE "TMP_20180417051021_85Q7G3_GB_B3" (
	"KEY" BIGINT, 
	"Score_CLASS_0" FLOAT, 
	"Score_CLASS_1" FLOAT, 
	"Score_CLASS_2" FLOAT
...
-- Code For temporary table TMP_20180417051021_85Q7G3_GB_B3 part 2/2. Populate
...
FROM "DT_Output_39")
 INSERT INTO "TMP_20180417051021_85Q7G3_GB_B3" ("KEY", "Score_CLASS_0", "Score_CLASS_1", "Score_CLASS_2") SELECT "GB_B3"."KEY", "GB_B3"."Score_CLASS_0", "GB_B3"."Score_CLASS_1", "GB_B3"."Score_CLASS_2" 
...
-- Code For temporary table TMP_20180417051021_GJUA08_GB_B4 part 1/2. Create 


CREATE TEMPORARY TABLE "TMP_20180417051021_GJUA08_GB_B4" (
	"KEY" BIGINT, 
	"Score_CLASS_0" FLOAT, 
	"Score_CLASS_1" FLOAT, 
	"Score_CLASS_2" FLOAT
...
-- Code For temporary table TMP_20180417051021_GJUA08_GB_B4 part 2/2. Populate
...
FROM "DT_Output_47")
 INSERT INTO "TMP_20180417051021_GJUA08_GB_B4" ("KEY", "Score_CLASS_0", "Score_CLASS_1", "Score_CLASS_2") SELECT "GB_B4"."KEY", "GB_B4"."Score_CLASS_0", "GB_B4"."Score_CLASS_1", "GB_B4"."Score_CLASS_2" 
...
-- Code For temporary table TMP_20180417051021_1VDAC2_GB_Union part 1/2. Create 


CREATE TEMPORARY TABLE "TMP_20180417051021_1VDAC2_GB_Union" (
	"KEY" BIGINT, 
	"Score_CLASS_0" FLOAT, 
	"Score_CLASS_1" FLOAT, 
	"Score_CLASS_2" FLOAT
...
-- Code For temporary table TMP_20180417051021_1VDAC2_GB_Union part 2/2. Populate

INSERT INTO "TMP_20180417051021_1VDAC2_GB_Union" ("KEY", "Score_CLASS_0", "Score_CLASS_1", "Score_CLASS_2") SELECT "GB_Union"."KEY", "GB_Union"."Score_CLASS_0", "GB_Union"."Score_CLASS_1", "GB_Union"."Score_CLASS_2" 
...
FROM "TMP_20180417051021_ZIU7Y6_GB_B0" AS "GB_B0" UNION ALL SELECT "GB_B1"."KEY" AS "KEY", "GB_B1"."Score_CLASS_0" AS "Score_CLASS_0", "GB_B1"."Score_CLASS_1" AS "Score_CLASS_1", "GB_B1"."Score_CLASS_2" AS "Score_CLASS_2" 
FROM "TMP_20180417051021_K8M5S9_GB_B1" AS "GB_B1" UNION ALL SELECT "GB_B2"."KEY" AS "KEY", "GB_B2"."Score_CLASS_0" AS "Score_CLASS_0", "GB_B2"."Score_CLASS_1" AS "Score_CLASS_1", "GB_B2"."Score_CLASS_2" AS "Score_CLASS_2" 
FROM "TMP_20180417051021_VAGGW3_GB_B2" AS "GB_B2" UNION ALL SELECT "GB_B3"."KEY" AS "KEY", "GB_B3"."Score_CLASS_0" AS "Score_CLASS_0", "GB_B3"."Score_CLASS_1" AS "Score_CLASS_1", "GB_B3"."Score_CLASS_2" AS "Score_CLASS_2" 
FROM "TMP_20180417051021_85Q7G3_GB_B3" AS "GB_B3" UNION ALL SELECT "GB_B4"."KEY" AS "KEY", "GB_B4"."Score_CLASS_0" AS "Score_CLASS_0", "GB_B4"."Score_CLASS_1" AS "Score_CLASS_1", "GB_B4"."Score_CLASS_2" AS "Score_CLASS_2" 
FROM "TMP_20180417051021_GJUA08_GB_B4" AS "GB_B4") AS "GB_EnsembleUnion") AS "GB_Union"

-- Code For temporary table TMP_20180417051021_M0ZBCP_GB_sum part 1/2. Create 


CREATE TEMPORARY TABLE "TMP_20180417051021_M0ZBCP_GB_sum" (
	"KEY" BIGINT NOT NULL, 
	"Score_CLASS_0" FLOAT, 
	"Score_CLASS_1" FLOAT, 
	"Score_CLASS_2" FLOAT, 
...
-- Code For temporary table TMP_20180417051021_M0ZBCP_GB_sum part 2/2. Populate

INSERT INTO "TMP_20180417051021_M0ZBCP_GB_sum" ("KEY", "Score_CLASS_0", "Score_CLASS_1", "Score_CLASS_2") SELECT "GB_sum"."KEY", "GB_sum"."Score_CLASS_0", "GB_sum"."Score_CLASS_1", "GB_sum"."Score_CLASS_2" 
...
FROM "TMP_20180417051021_1VDAC2_GB_Union" AS "GB_Union" GROUP BY "GB_Union"."KEY") AS "T") AS "GB_sum"
...
FROM "TMP_20180417051021_M0ZBCP_GB_sum" AS "GB_sum"), 
