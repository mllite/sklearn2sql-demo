...
-- Code For temporary table 23224_2WFCN5_ADS_IMP_1_OUT part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE "23224_2WFCN5_ADS_IMP_1_OUT" (
...
-- Code For temporary table 23224_IALZU4_ADS_SCA_2_OUT part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE "23224_IALZU4_ADS_SCA_2_OUT" (
	"KEY" NUMBER(19) NOT NULL, 
...
FROM "23224_2WFCN5_ADS_IMP_1_OUT" "ADS_imp_1_OUT") "ADS_sca_2_OUT") "U"

-- Code For temporary table 0180416223225_NG6FGH_GB_B0 part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE "0180416223225_NG6FGH_GB_B0" (
	"KEY" NUMBER(19), 
...
-- Code For temporary table 0180416223225_NG6FGH_GB_B0 part 2/2. Populate

INSERT INTO "0180416223225_NG6FGH_GB_B0" ("KEY", "Score_0", "Score_1") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1" 
...
FROM "23224_IALZU4_ADS_SCA_2_OUT" "ADS_sca_2_OUT"), 
"DT_node_data" AS 
...
-- Code For temporary table 0180416223225_9EG3HX_GB_B1 part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE "0180416223225_9EG3HX_GB_B1" (
	"KEY" NUMBER(19), 
	"Score_0" BINARY_DOUBLE, 
	"Score_1" BINARY_DOUBLE
)
...
-- Code For temporary table 0180416223225_9EG3HX_GB_B1 part 2/2. Populate

INSERT INTO "0180416223225_9EG3HX_GB_B1" ("KEY", "Score_0", "Score_1") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1" 
...
-- Code For temporary table 0180416223225_ARKENS_GB_B2 part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE "0180416223225_ARKENS_GB_B2" (
	"KEY" NUMBER(19), 
	"Score_0" BINARY_DOUBLE, 
	"Score_1" BINARY_DOUBLE
)
...
-- Code For temporary table 0180416223225_ARKENS_GB_B2 part 2/2. Populate

INSERT INTO "0180416223225_ARKENS_GB_B2" ("KEY", "Score_0", "Score_1") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1" 
...
-- Code For temporary table 0180416223225_QI6FBY_GB_B3 part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE "0180416223225_QI6FBY_GB_B3" (
	"KEY" NUMBER(19), 
	"Score_0" BINARY_DOUBLE, 
	"Score_1" BINARY_DOUBLE
)
...
-- Code For temporary table 0180416223225_QI6FBY_GB_B3 part 2/2. Populate

INSERT INTO "0180416223225_QI6FBY_GB_B3" ("KEY", "Score_0", "Score_1") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1" 
...
-- Code For temporary table 0416223225_53IZDD_GB_UNION part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE "0416223225_53IZDD_GB_UNION" (
	"KEY" NUMBER(19), 
	"Score_0" BINARY_DOUBLE, 
	"Score_1" BINARY_DOUBLE
)
...
-- Code For temporary table 0416223225_53IZDD_GB_UNION part 2/2. Populate

INSERT INTO "0416223225_53IZDD_GB_UNION" ("KEY", "Score_0", "Score_1") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1" 
...
FROM "0180416223225_NG6FGH_GB_B0" "GB_B0" UNION ALL SELECT "GB_B1"."KEY" AS "KEY", "GB_B1"."Score_0" AS "Score_0", "GB_B1"."Score_1" AS "Score_1" 
FROM "0180416223225_9EG3HX_GB_B1" "GB_B1" UNION ALL SELECT "GB_B2"."KEY" AS "KEY", "GB_B2"."Score_0" AS "Score_0", "GB_B2"."Score_1" AS "Score_1" 
FROM "0180416223225_ARKENS_GB_B2" "GB_B2" UNION ALL SELECT "GB_B3"."KEY" AS "KEY", "GB_B3"."Score_0" AS "Score_0", "GB_B3"."Score_1" AS "Score_1" 
FROM "0180416223225_QI6FBY_GB_B3" "GB_B3") "GB_EnsembleUnion") "GB_Union") "U"

-- Code For temporary table 180416223225_4CZJJ3_GB_SUM part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE "180416223225_4CZJJ3_GB_SUM" (
	"KEY" NUMBER(19) NOT NULL, 
	"Score_0" BINARY_DOUBLE, 
	"Score_1" BINARY_DOUBLE, 
	PRIMARY KEY ("KEY")
...
-- Code For temporary table 180416223225_4CZJJ3_GB_SUM part 2/2. Populate

INSERT INTO "180416223225_4CZJJ3_GB_SUM" ("KEY", "Score_0", "Score_1") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1" 
...
FROM "0416223225_53IZDD_GB_UNION" "GB_Union" GROUP BY "GB_Union"."KEY") "T") "GB_sum") "U"
...
FROM "180416223225_4CZJJ3_GB_SUM" "GB_sum"), 
