...
-- Code For temporary table TMP_20180416223224_0B4TOI_ADS_I part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180416223224_0B4TOI_ADS_I" (
	"KEY" BIGINT, 
	impter_2 FLOAT, 
	impter_3 FLOAT, 
	impter_4 FLOAT, 
...
-- Code For temporary table TMP_20180416223224_H17AJB_ADS_S part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180416223224_H17AJB_ADS_S" (
	"KEY" BIGINT, 
	scaler_2 FLOAT, 
	scaler_3 FLOAT, 
	scaler_4 FLOAT, 
...
FROM "TMP_20180416223224_0B4TOI_ADS_I" AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT") AS "U"

-- Code For temporary table TMP_20180416223225_DAVXJK_GB_B0 part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180416223225_DAVXJK_GB_B0" (
	"KEY" BIGINT, 
	"Score_0" FLOAT, 
	"Score_1" FLOAT
)
...
-- Code For temporary table TMP_20180416223225_DAVXJK_GB_B0 part 2/2. Populate

INSERT INTO "TMP_20180416223225_DAVXJK_GB_B0" ("KEY", "Score_0", "Score_1") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1" 
...
FROM "TMP_20180416223224_H17AJB_ADS_S" AS "ADS_sca_2_OUT"), 
"DT_node_data" AS 
...
-- Code For temporary table TMP_20180416223225_2JGIZ4_GB_B1 part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180416223225_2JGIZ4_GB_B1" (
	"KEY" BIGINT, 
	"Score_0" FLOAT, 
	"Score_1" FLOAT
)
...
-- Code For temporary table TMP_20180416223225_2JGIZ4_GB_B1 part 2/2. Populate

INSERT INTO "TMP_20180416223225_2JGIZ4_GB_B1" ("KEY", "Score_0", "Score_1") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1" 
...
-- Code For temporary table TMP_20180416223225_8OKVO0_GB_B2 part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180416223225_8OKVO0_GB_B2" (
	"KEY" BIGINT, 
	"Score_0" FLOAT, 
	"Score_1" FLOAT
)
...
-- Code For temporary table TMP_20180416223225_8OKVO0_GB_B2 part 2/2. Populate

INSERT INTO "TMP_20180416223225_8OKVO0_GB_B2" ("KEY", "Score_0", "Score_1") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1" 
...
-- Code For temporary table TMP_20180416223225_02FCXB_GB_B3 part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180416223225_02FCXB_GB_B3" (
	"KEY" BIGINT, 
	"Score_0" FLOAT, 
	"Score_1" FLOAT
)
...
-- Code For temporary table TMP_20180416223225_02FCXB_GB_B3 part 2/2. Populate

INSERT INTO "TMP_20180416223225_02FCXB_GB_B3" ("KEY", "Score_0", "Score_1") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1" 
...
-- Code For temporary table TMP_20180416223225_ISIGFI_GB_UN part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180416223225_ISIGFI_GB_UN" (
	"KEY" BIGINT, 
	"Score_0" FLOAT, 
	"Score_1" FLOAT
)
...
-- Code For temporary table TMP_20180416223225_ISIGFI_GB_UN part 2/2. Populate

INSERT INTO "TMP_20180416223225_ISIGFI_GB_UN" ("KEY", "Score_0", "Score_1") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1" 
...
FROM "TMP_20180416223225_DAVXJK_GB_B0" AS "GB_B0" UNION ALL SELECT "GB_B1"."KEY" AS "KEY", "GB_B1"."Score_0" AS "Score_0", "GB_B1"."Score_1" AS "Score_1" 
FROM "TMP_20180416223225_2JGIZ4_GB_B1" AS "GB_B1" UNION ALL SELECT "GB_B2"."KEY" AS "KEY", "GB_B2"."Score_0" AS "Score_0", "GB_B2"."Score_1" AS "Score_1" 
FROM "TMP_20180416223225_8OKVO0_GB_B2" AS "GB_B2" UNION ALL SELECT "GB_B3"."KEY" AS "KEY", "GB_B3"."Score_0" AS "Score_0", "GB_B3"."Score_1" AS "Score_1" 
FROM "TMP_20180416223225_02FCXB_GB_B3" AS "GB_B3") AS "GB_EnsembleUnion") AS "GB_Union") AS "U"

-- Code For temporary table TMP_20180416223225_DMYU85_GB_SU part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180416223225_DMYU85_GB_SU" (
	"KEY" BIGINT, 
	"Score_0" FLOAT, 
	"Score_1" FLOAT
)
...
-- Code For temporary table TMP_20180416223225_DMYU85_GB_SU part 2/2. Populate

INSERT INTO "TMP_20180416223225_DMYU85_GB_SU" ("KEY", "Score_0", "Score_1") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1" 
...
FROM "TMP_20180416223225_ISIGFI_GB_UN" AS "GB_Union" GROUP BY "GB_Union"."KEY") AS "T") AS "GB_sum") AS "U"
...
FROM "TMP_20180416223225_DMYU85_GB_SU" AS "GB_sum"), 
