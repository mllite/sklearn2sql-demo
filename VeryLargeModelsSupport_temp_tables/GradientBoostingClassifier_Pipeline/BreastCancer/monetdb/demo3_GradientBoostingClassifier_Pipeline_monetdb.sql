...
-- Code For temporary table tmp_20180416231645_g6ccn8_ads_imp_1_out part 1/2. Create 


CREATE TEMPORARY TABLE tmp_20180416231645_g6ccn8_ads_imp_1_out (
	"KEY" BIGINT NOT NULL, 
	impter_2 FLOAT, 
	impter_3 FLOAT, 
	impter_4 FLOAT, 
...
-- Code For temporary table tmp_20180416231645_g6ccn8_ads_imp_1_out part 2/2. Populate

INSERT INTO tmp_20180416231645_g6ccn8_ads_imp_1_out ("KEY", impter_2, impter_3, impter_4, impter_5, impter_6, impter_7, impter_8, impter_9, impter_10, impter_11, impter_12, impter_13, impter_14, impter_15, impter_16, impter_17, impter_18, impter_19, impter_20, impter_21, impter_22, impter_23, impter_24, impter_25, impter_26, impter_27, impter_28, impter_29, impter_30, impter_31) SELECT "U"."KEY", "U".impter_2, "U".impter_3, "U".impter_4, "U".impter_5, "U".impter_6, "U".impter_7, "U".impter_8, "U".impter_9, "U".impter_10, "U".impter_11, "U".impter_12, "U".impter_13, "U".impter_14, "U".impter_15, "U".impter_16, "U".impter_17, "U".impter_18, "U".impter_19, "U".impter_20, "U".impter_21, "U".impter_22, "U".impter_23, "U".impter_24, "U".impter_25, "U".impter_26, "U".impter_27, "U".impter_28, "U".impter_29, "U".impter_30, "U".impter_31 
...
-- Code For temporary table tmp_20180416231645_kvtsj0_ads_sca_2_out part 1/2. Create 


CREATE TEMPORARY TABLE tmp_20180416231645_kvtsj0_ads_sca_2_out (
	"KEY" BIGINT NOT NULL, 
	scaler_2 FLOAT, 
	scaler_3 FLOAT, 
	scaler_4 FLOAT, 
...
FROM tmp_20180416231645_g6ccn8_ads_imp_1_out AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT") AS "U"

-- Code For temporary table tmp_20180416231645_c0x3uy_gb_b0 part 1/2. Create 


CREATE TEMPORARY TABLE tmp_20180416231645_c0x3uy_gb_b0 (
	"KEY" BIGINT, 
	"Score_0" FLOAT, 
	"Score_1" FLOAT
)
...
-- Code For temporary table tmp_20180416231645_c0x3uy_gb_b0 part 2/2. Populate

INSERT INTO tmp_20180416231645_c0x3uy_gb_b0 ("KEY", "Score_0", "Score_1") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1" 
...
FROM tmp_20180416231645_kvtsj0_ads_sca_2_out AS "ADS_sca_2_OUT"), 
"DT_node_data" AS 
...
-- Code For temporary table tmp_20180416231645_ucv71a_gb_b1 part 1/2. Create 


CREATE TEMPORARY TABLE tmp_20180416231645_ucv71a_gb_b1 (
	"KEY" BIGINT, 
	"Score_0" FLOAT, 
	"Score_1" FLOAT
)
...
-- Code For temporary table tmp_20180416231645_ucv71a_gb_b1 part 2/2. Populate

INSERT INTO tmp_20180416231645_ucv71a_gb_b1 ("KEY", "Score_0", "Score_1") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1" 
...
-- Code For temporary table tmp_20180416231645_hdp469_gb_b2 part 1/2. Create 


CREATE TEMPORARY TABLE tmp_20180416231645_hdp469_gb_b2 (
	"KEY" BIGINT, 
	"Score_0" FLOAT, 
	"Score_1" FLOAT
)
...
-- Code For temporary table tmp_20180416231645_hdp469_gb_b2 part 2/2. Populate

INSERT INTO tmp_20180416231645_hdp469_gb_b2 ("KEY", "Score_0", "Score_1") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1" 
...
-- Code For temporary table tmp_20180416231645_w6otpx_gb_b3 part 1/2. Create 


CREATE TEMPORARY TABLE tmp_20180416231645_w6otpx_gb_b3 (
	"KEY" BIGINT, 
	"Score_0" FLOAT, 
	"Score_1" FLOAT
)
...
-- Code For temporary table tmp_20180416231645_w6otpx_gb_b3 part 2/2. Populate

INSERT INTO tmp_20180416231645_w6otpx_gb_b3 ("KEY", "Score_0", "Score_1") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1" 
...
-- Code For temporary table tmp_20180416231645_4wryv5_gb_union part 1/2. Create 


CREATE TEMPORARY TABLE tmp_20180416231645_4wryv5_gb_union (
	"KEY" BIGINT, 
	"Score_0" FLOAT, 
	"Score_1" FLOAT
)
...
-- Code For temporary table tmp_20180416231645_4wryv5_gb_union part 2/2. Populate

INSERT INTO tmp_20180416231645_4wryv5_gb_union ("KEY", "Score_0", "Score_1") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1" 
...
FROM tmp_20180416231645_c0x3uy_gb_b0 AS "GB_B0" UNION ALL SELECT "GB_B1"."KEY" AS "KEY", "GB_B1"."Score_0" AS "Score_0", "GB_B1"."Score_1" AS "Score_1" 
FROM tmp_20180416231645_ucv71a_gb_b1 AS "GB_B1" UNION ALL SELECT "GB_B2"."KEY" AS "KEY", "GB_B2"."Score_0" AS "Score_0", "GB_B2"."Score_1" AS "Score_1" 
FROM tmp_20180416231645_hdp469_gb_b2 AS "GB_B2" UNION ALL SELECT "GB_B3"."KEY" AS "KEY", "GB_B3"."Score_0" AS "Score_0", "GB_B3"."Score_1" AS "Score_1" 
FROM tmp_20180416231645_w6otpx_gb_b3 AS "GB_B3") AS "GB_EnsembleUnion") AS "GB_Union") AS "U"

-- Code For temporary table tmp_20180416231645_bx6q1v_gb_sum part 1/2. Create 


CREATE TEMPORARY TABLE tmp_20180416231645_bx6q1v_gb_sum (
	"KEY" BIGINT NOT NULL, 
	"Score_0" FLOAT, 
	"Score_1" FLOAT, 
	PRIMARY KEY ("KEY")
...
-- Code For temporary table tmp_20180416231645_bx6q1v_gb_sum part 2/2. Populate

INSERT INTO tmp_20180416231645_bx6q1v_gb_sum ("KEY", "Score_0", "Score_1") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1" 
...
FROM tmp_20180416231645_4wryv5_gb_union AS "GB_Union" GROUP BY "GB_Union"."KEY") AS "T") AS "GB_sum") AS "U"
...
FROM tmp_20180416231645_bx6q1v_gb_sum AS "GB_sum"), 
