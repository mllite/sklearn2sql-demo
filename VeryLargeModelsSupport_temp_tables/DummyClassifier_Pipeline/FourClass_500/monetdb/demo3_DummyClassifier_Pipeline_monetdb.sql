...
-- Code For temporary table tmp_20180417002125_hi9ybc_ads_imp_1_out part 1/2. Create 


CREATE TEMPORARY TABLE tmp_20180417002125_hi9ybc_ads_imp_1_out (
	"KEY" BIGINT NOT NULL, 
	impter_2 FLOAT, 
	impter_3 FLOAT, 
	impter_4 FLOAT, 
...
-- Code For temporary table tmp_20180417002125_q5jtwy_ads_sca_2_out part 1/2. Create 


CREATE TEMPORARY TABLE tmp_20180417002125_q5jtwy_ads_sca_2_out (
	"KEY" BIGINT NOT NULL, 
	scaler_2 FLOAT, 
	scaler_3 FLOAT, 
	scaler_4 FLOAT, 
...
FROM tmp_20180417002125_hi9ybc_ads_imp_1_out AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT") AS "U"

-- Model deployment code

WITH random_number_cte AS 
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", rand() AS uniform 
FROM tmp_20180417002125_q5jtwy_ads_sca_2_out AS "ADS_sca_2_OUT"), 
multinomial_cte AS 
...
(SELECT multinomial_cte."KEY" AS "KEY", 0.23875 AS "Proba_0", log(CASE WHEN (0.23875 IS NULL OR 0.23875 > 1e-100) THEN 0.23875 ELSE 1e-100 END) AS "LogProba_0", 0.25125 AS "Proba_1", log(CASE WHEN (0.25125 IS NULL OR 0.25125 > 1e-100) THEN 0.25125 ELSE 1e-100 END) AS "LogProba_1", 0.2525 AS "Proba_2", log(CASE WHEN (0.2525 IS NULL OR 0.2525 > 1e-100) THEN 0.2525 ELSE 1e-100 END) AS "LogProba_2", 0.2575 AS "Proba_3", log(CASE WHEN (0.2575 IS NULL OR 0.2575 > 1e-100) THEN 0.2575 ELSE 1e-100 END) AS "LogProba_3", multinomial_cte.multinomial_expr AS "Decision" 
