...
-- Code For temporary table tmp_20180417042615_g2a8g1_ads_imp_1_out part 1/2. Create 

CREATE TEMPORARY TABLE `tmp_20180417042615_g2a8g1_ads_imp_1_out` STORED AS ORC AS SELECT `ADS_imp_1_OUT`.`KEY`, `ADS_imp_1_OUT`.`imputer_output_2`, `ADS_imp_1_OUT`.`imputer_output_3`, `ADS_imp_1_OUT`.`imputer_output_4`, `ADS_imp_1_OUT`.`imputer_output_5` 
...
-- Code For temporary table tmp_20180417042615_g2a8g1_ads_imp_1_out part 2/2. Populate

SELECT * FROM `tmp_20180417042615_g2a8g1_ads_imp_1_out`

-- Code For temporary table tmp_20180417042615_gzzubd_ads_sca_2_out part 1/2. Create 

CREATE TEMPORARY TABLE `tmp_20180417042615_gzzubd_ads_sca_2_out` STORED AS ORC AS SELECT `ADS_sca_2_OUT`.`KEY`, `ADS_sca_2_OUT`.`scaler_output_2`, `ADS_sca_2_OUT`.`scaler_output_3`, `ADS_sca_2_OUT`.`scaler_output_4`, `ADS_sca_2_OUT`.`scaler_output_5` 
...
FROM `tmp_20180417042615_g2a8g1_ads_imp_1_out` AS `ADS_imp_1_OUT`) AS `ADS_sca_2_OUT`

-- Code For temporary table tmp_20180417042615_gzzubd_ads_sca_2_out part 2/2. Populate

SELECT * FROM `tmp_20180417042615_gzzubd_ads_sca_2_out`

-- Model deployment code

WITH `random_number_cte` AS 
(SELECT `ADS_sca_2_OUT`.`KEY` AS `KEY`, rand() AS `uniform` 
FROM `tmp_20180417042615_gzzubd_ads_sca_2_out` AS `ADS_sca_2_OUT`), 
`multinomial_cte` AS 
