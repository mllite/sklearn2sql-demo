...
-- Code For temporary table TMP_20180416233546_CL52YH_ADS_I part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180416233546_CL52YH_ADS_I" (
	"KEY" BIGINT, 
	impter_2 FLOAT, 
	impter_3 FLOAT, 
	impter_4 FLOAT, 
...
-- Code For temporary table TMP_20180416233546_KFXVS1_ADS_S part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180416233546_KFXVS1_ADS_S" (
	"KEY" BIGINT, 
	scaler_2 FLOAT, 
	scaler_3 FLOAT, 
	scaler_4 FLOAT, 
...
FROM "TMP_20180416233546_CL52YH_ADS_I" AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT") AS "U"

-- Model deployment code

WITH random_number_cte AS 
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", rand AS uniform 
FROM "TMP_20180416233546_KFXVS1_ADS_S" AS "ADS_sca_2_OUT"), 
multinomial_cte AS 
...
(SELECT multinomial_cte."KEY" AS "KEY", 0.245 AS "Proba_0", CASE WHEN (0.245 IS NULL OR 0.245 > 0.0) THEN ln(0.245) ELSE -1e+20 END AS "LogProba_0", 0.24875 AS "Proba_1", CASE WHEN (0.24875 IS NULL OR 0.24875 > 0.0) THEN ln(0.24875) ELSE -1e+20 END AS "LogProba_1", 0.2525 AS "Proba_2", CASE WHEN (0.2525 IS NULL OR 0.2525 > 0.0) THEN ln(0.2525) ELSE -1e+20 END AS "LogProba_2", 0.25375 AS "Proba_3", CASE WHEN (0.25375 IS NULL OR 0.25375 > 0.0) THEN ln(0.25375) ELSE -1e+20 END AS "LogProba_3", multinomial_cte.multinomial_expr AS "Decision" 
