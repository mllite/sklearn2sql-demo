...
-- Code For temporary table ##TMP_20180417025432_WM0TRW_ADS_imp_1_OUT part 1/2. Create 


CREATE TABLE ##TMP_20180417025432_WM0TRW_ADS_imp_1_OUT (
	[KEY] BIGINT NULL, 
...
-- Code For temporary table ##TMP_20180417025432_UF0TFI_ADS_sca_2_OUT part 1/2. Create 


CREATE TABLE ##TMP_20180417025432_UF0TFI_ADS_sca_2_OUT (
	[KEY] BIGINT NULL, 
	scaler_2 FLOAT NULL, 
	scaler_3 FLOAT NULL, 
	scaler_4 FLOAT NULL, 
...
FROM ##TMP_20180417025432_WM0TRW_ADS_imp_1_OUT AS [ADS_imp_1_OUT]) AS [ADS_sca_2_OUT]

-- Model deployment code

WITH random_number_cte AS 
(SELECT [ADS_sca_2_OUT].[KEY] AS [KEY], rand() AS uniform 
FROM ##TMP_20180417025432_UF0TFI_ADS_sca_2_OUT AS [ADS_sca_2_OUT]), 
multinomial_cte AS 
