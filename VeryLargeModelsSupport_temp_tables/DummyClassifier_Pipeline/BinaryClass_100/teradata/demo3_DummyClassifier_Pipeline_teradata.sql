...
-- Code For temporary table tmp_20180416223158_171knu_ads_ part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180416223158_171knu_ads_  (
	"KEY" BIGINT, 
	impter_2 FLOAT, 
	impter_3 FLOAT, 
	impter_4 FLOAT, 
...
-- Code For temporary table tmp_20180416223158_h1q8dq_ads_ part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180416223158_h1q8dq_ads_  (
	"KEY" BIGINT, 
	scaler_2 FLOAT, 
	scaler_3 FLOAT, 
	scaler_4 FLOAT, 
...
FROM tmp_20180416223158_171knu_ads_ AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT") AS "U"

-- Model deployment code

WITH random_number_cte AS 
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", random() AS uniform 
FROM tmp_20180416223158_h1q8dq_ads_ AS "ADS_sca_2_OUT"), 
multinomial_cte AS 
