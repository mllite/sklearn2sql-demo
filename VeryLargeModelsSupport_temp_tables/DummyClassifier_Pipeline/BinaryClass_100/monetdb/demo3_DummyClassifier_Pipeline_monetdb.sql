...
-- Code For temporary table tmp_20180416223157_k3peyo_ads_imp_1_out part 1/2. Create 


CREATE TEMPORARY TABLE tmp_20180416223157_k3peyo_ads_imp_1_out (
	"KEY" BIGINT NOT NULL, 
	impter_2 FLOAT, 
	impter_3 FLOAT, 
	impter_4 FLOAT, 
...
-- Code For temporary table tmp_20180416223157_yz2q9d_ads_sca_2_out part 1/2. Create 


CREATE TEMPORARY TABLE tmp_20180416223157_yz2q9d_ads_sca_2_out (
	"KEY" BIGINT NOT NULL, 
	scaler_2 FLOAT, 
	scaler_3 FLOAT, 
	scaler_4 FLOAT, 
...
FROM tmp_20180416223157_k3peyo_ads_imp_1_out AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT") AS "U"

-- Model deployment code

WITH random_number_cte AS 
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", rand() AS uniform 
FROM tmp_20180416223157_yz2q9d_ads_sca_2_out AS "ADS_sca_2_OUT"), 
multinomial_cte AS 
