...
-- Code For temporary table 31618_SU3Z1B_ADS_IMP_1_OUT part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE "31618_SU3Z1B_ADS_IMP_1_OUT" (
...
-- Code For temporary table 31618_GRYYSS_ADS_SCA_2_OUT part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE "31618_GRYYSS_ADS_SCA_2_OUT" (
	"KEY" NUMBER(19) NOT NULL, 
...
FROM "31618_SU3Z1B_ADS_IMP_1_OUT" "ADS_imp_1_OUT") "ADS_sca_2_OUT") "U"

-- Model deployment code

WITH random_number_cte AS 
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", dbms_random.value AS uniform 
FROM "31618_GRYYSS_ADS_SCA_2_OUT" "ADS_sca_2_OUT"), 
multinomial_cte AS 
