...
-- Code For temporary table tmp_20180417011726_hsbf1c_ads_ part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180417011726_hsbf1c_ads_  (
	"KEY" BIGINT, 
	impter_2 FLOAT, 
	impter_3 FLOAT, 
	impter_4 FLOAT, 
...
-- Code For temporary table tmp_20180417011726_hsbf1c_ads_ part 2/2. Populate

INSERT INTO tmp_20180417011726_hsbf1c_ads_ ("KEY", impter_2, impter_3, impter_4, impter_5, impter_6, impter_7, impter_8, impter_9, impter_10, impter_11) SELECT "U"."KEY", "U".impter_2, "U".impter_3, "U".impter_4, "U".impter_5, "U".impter_6, "U".impter_7, "U".impter_8, "U".impter_9, "U".impter_10, "U".impter_11 
...
-- Code For temporary table tmp_20180417011726_jxlp3s_ads_ part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180417011726_jxlp3s_ads_  (
	"KEY" BIGINT, 
	scaler_2 FLOAT, 
	scaler_3 FLOAT, 
	scaler_4 FLOAT, 
...
-- Code For temporary table tmp_20180417011726_jxlp3s_ads_ part 2/2. Populate

INSERT INTO tmp_20180417011726_jxlp3s_ads_ ("KEY", scaler_2, scaler_3, scaler_4, scaler_5, scaler_6, scaler_7, scaler_8, scaler_9, scaler_10, scaler_11) SELECT "U"."KEY", "U".scaler_2, "U".scaler_3, "U".scaler_4, "U".scaler_5, "U".scaler_6, "U".scaler_7, "U".scaler_8, "U".scaler_9, "U".scaler_10, "U".scaler_11 
...
FROM tmp_20180417011726_hsbf1c_ads_ AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT") AS "U"
...
FROM tmp_20180417011726_jxlp3s_ads_ AS "ADS_sca_2_OUT"), 
linear_model_cte AS 
(SELECT linear_input."KEY" AS "KEY", 34.93629964239755 * linear_input.scaler_2 + 73.71003738769787 * linear_input.scaler_3 + 87.30118845385824 * linear_input.scaler_4 + 37.2003535662938 * linear_input.scaler_5 + 56.82441624467638 * linear_input.scaler_6 + 78.45109933480481 * linear_input.scaler_7 + 37.884334274023054 * linear_input.scaler_8 + 39.106491966994035 * linear_input.scaler_9 + 92.64892488769325 * linear_input.scaler_10 + 52.57456364033038 * linear_input.scaler_11 + 26.405852730652413 AS "Estimator" 
FROM linear_input)
