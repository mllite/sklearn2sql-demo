...
-- Code For temporary table tmp_20180417023727_chudfu_ads_ part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180417023727_chudfu_ads_  (
	"KEY" BIGINT, 
	impter_2 FLOAT, 
	impter_3 FLOAT, 
	impter_4 FLOAT, 
...
-- Code For temporary table tmp_20180417023727_chudfu_ads_ part 2/2. Populate

INSERT INTO tmp_20180417023727_chudfu_ads_ ("KEY", impter_2, impter_3, impter_4, impter_5, impter_6, impter_7, impter_8, impter_9, impter_10, impter_11, impter_12, impter_13, impter_14) SELECT "U"."KEY", "U".impter_2, "U".impter_3, "U".impter_4, "U".impter_5, "U".impter_6, "U".impter_7, "U".impter_8, "U".impter_9, "U".impter_10, "U".impter_11, "U".impter_12, "U".impter_13, "U".impter_14 
...
-- Code For temporary table tmp_20180417023727_vom88t_ads_ part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180417023727_vom88t_ads_  (
	"KEY" BIGINT, 
	scaler_2 FLOAT, 
	scaler_3 FLOAT, 
	scaler_4 FLOAT, 
...
FROM tmp_20180417023727_chudfu_ads_ AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT") AS "U"
...
FROM tmp_20180417023727_vom88t_ads_ AS "ADS_sca_2_OUT"), 
linear_model_cte AS 
(SELECT linear_input."KEY" AS "KEY", -0.766041913792394 * linear_input.scaler_2 + 0.883464727756144 * linear_input.scaler_3 + 0.132375991410583 * linear_input.scaler_4 + 0.628995263531277 * linear_input.scaler_5 + -1.71855927400647 * linear_input.scaler_6 + 3.259869980609026 * linear_input.scaler_7 + -0.561763096742438 * linear_input.scaler_8 + -2.858886511587212 * linear_input.scaler_9 + 2.268647862848082 * linear_input.scaler_10 + -1.96707783758745 * linear_input.scaler_11 + -2.154340153844844 * linear_input.scaler_12 + 0.940261299902417 * linear_input.scaler_13 + -2.868751048435574 * linear_input.scaler_14 + 22.578960396039605 AS "Estimator" 
FROM linear_input)
