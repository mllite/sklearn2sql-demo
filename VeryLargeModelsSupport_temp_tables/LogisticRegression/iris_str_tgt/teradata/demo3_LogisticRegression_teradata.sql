...
linear_model_cte AS 
(SELECT linear_input."KEY" AS "KEY", 0.367407891600021 * linear_input."Feature_0" + 1.417475205021328 * linear_input."Feature_1" + -2.142257483278976 * linear_input."Feature_2" + -0.958993964927167 * linear_input."Feature_3" + 0.252841819367554 AS "Score_CLASS_0", 0.486310347304012 * linear_input."Feature_0" + -1.544784607377755 * linear_input."Feature_1" + 0.480758220327249 * linear_input."Feature_2" + -1.320608335038882 * linear_input."Feature_3" + 0.80727265037231 AS "Score_CLASS_1", -1.624720269000634 * linear_input."Feature_0" + -1.45587122136632 * linear_input."Feature_1" + 2.382068725371414 * linear_input."Feature_2" + 2.356508663538953 * linear_input."Feature_3" + -1.116572480612141 AS "Score_CLASS_2" 
FROM linear_input), 
orig_cte AS 
