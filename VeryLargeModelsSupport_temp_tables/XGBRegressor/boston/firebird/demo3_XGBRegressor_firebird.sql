...
-- Code For temporary table TMP_20180417023839_MAT3NN_XGB_B part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180417023839_MAT3NN_XGB_B" (
	"KEY" BIGINT, 
	"Estimator" FLOAT
)
...
-- Code For temporary table TMP_20180417023839_MAT3NN_XGB_B part 2/2. Populate

INSERT INTO "TMP_20180417023839_MAT3NN_XGB_B" ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
-- Code For temporary table TMP_20180417023839_2NNVMA_XGB_B part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180417023839_2NNVMA_XGB_B" (
	"KEY" BIGINT, 
	"Estimator" FLOAT
)
...
-- Code For temporary table TMP_20180417023839_2NNVMA_XGB_B part 2/2. Populate

INSERT INTO "TMP_20180417023839_2NNVMA_XGB_B" ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
-- Code For temporary table TMP_20180417023839_KBX6GO_XGB_U part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180417023839_KBX6GO_XGB_U" (
	"KEY" BIGINT, 
	"Estimator" FLOAT
)
...
-- Code For temporary table TMP_20180417023839_KBX6GO_XGB_U part 2/2. Populate

INSERT INTO "TMP_20180417023839_KBX6GO_XGB_U" ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
FROM "TMP_20180417023839_MAT3NN_XGB_B" AS "XGB_B0" UNION ALL SELECT "XGB_B1"."KEY" AS "KEY", "XGB_B1"."Estimator" AS "Estimator" 
FROM "TMP_20180417023839_2NNVMA_XGB_B" AS "XGB_B1") AS "XGB_EnsembleUnion") AS "XGB_Union") AS "U"

-- Code For temporary table TMP_20180417023839_UZYSO7_XGB_S part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180417023839_UZYSO7_XGB_S" (
	"KEY" BIGINT, 
	"Estimator" FLOAT
)
...
-- Code For temporary table TMP_20180417023839_UZYSO7_XGB_S part 2/2. Populate

INSERT INTO "TMP_20180417023839_UZYSO7_XGB_S" ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
FROM "TMP_20180417023839_KBX6GO_XGB_U" AS "XGB_Union" GROUP BY "XGB_Union"."KEY") AS "T") AS "XGB_sum") AS "U"

-- Model deployment code

SELECT "XGB_sum"."KEY" AS "KEY", "XGB_sum"."Estimator" + 0.5 AS "Estimator" 
FROM "TMP_20180417023839_UZYSO7_XGB_S" AS "XGB_sum"