...
-- Code For temporary table 180417023839_MT9S1N_XGB_B0 part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE "180417023839_MT9S1N_XGB_B0" (
	"KEY" NUMBER(19), 
...
-- Code For temporary table 180417023839_MT9S1N_XGB_B0 part 2/2. Populate

INSERT INTO "180417023839_MT9S1N_XGB_B0" ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
-- Code For temporary table 180417023839_OCJF3C_XGB_B1 part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE "180417023839_OCJF3C_XGB_B1" (
	"KEY" NUMBER(19), 
	"Estimator" BINARY_DOUBLE
)
...
-- Code For temporary table 180417023839_OCJF3C_XGB_B1 part 2/2. Populate

INSERT INTO "180417023839_OCJF3C_XGB_B1" ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
-- Code For temporary table 417023839_1ULQIX_XGB_UNION part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE "417023839_1ULQIX_XGB_UNION" (
	"KEY" NUMBER(19), 
	"Estimator" BINARY_DOUBLE
)
...
-- Code For temporary table 417023839_1ULQIX_XGB_UNION part 2/2. Populate

INSERT INTO "417023839_1ULQIX_XGB_UNION" ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
FROM "180417023839_MT9S1N_XGB_B0" "XGB_B0" UNION ALL SELECT "XGB_B1"."KEY" AS "KEY", "XGB_B1"."Estimator" AS "Estimator" 
FROM "180417023839_OCJF3C_XGB_B1" "XGB_B1") "XGB_EnsembleUnion") "XGB_Union") "U"

-- Code For temporary table 80417023839_Q6PQ2Y_XGB_SUM part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE "80417023839_Q6PQ2Y_XGB_SUM" (
...
-- Code For temporary table 80417023839_Q6PQ2Y_XGB_SUM part 2/2. Populate

INSERT INTO "80417023839_Q6PQ2Y_XGB_SUM" ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
FROM "417023839_1ULQIX_XGB_UNION" "XGB_Union" GROUP BY "XGB_Union"."KEY") "T") "XGB_sum") "U"

-- Model deployment code

SELECT "XGB_sum"."KEY" AS "KEY", "XGB_sum"."Estimator" + 0.5 AS "Estimator" 
FROM "80417023839_Q6PQ2Y_XGB_SUM" "XGB_sum"