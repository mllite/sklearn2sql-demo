...
-- Code For temporary table TMP_20180417040642_55NLD9_XGB_B0 part 1/2. Create 


CREATE TEMPORARY TABLE `TMP_20180417040642_55NLD9_XGB_B0` (
	`KEY` BIGINT, 
	`Estimator` DOUBLE
)
...
-- Code For temporary table TMP_20180417040642_55NLD9_XGB_B0 part 2/2. Populate

INSERT INTO `TMP_20180417040642_55NLD9_XGB_B0` (`KEY`, `Estimator`) SELECT `U`.`KEY`, `U`.`Estimator` 
...
-- Code For temporary table TMP_20180417040642_IO0V1Y_XGB_B1 part 1/2. Create 


CREATE TEMPORARY TABLE `TMP_20180417040642_IO0V1Y_XGB_B1` (
	`KEY` BIGINT, 
	`Estimator` DOUBLE
)
...
-- Code For temporary table TMP_20180417040642_IO0V1Y_XGB_B1 part 2/2. Populate

INSERT INTO `TMP_20180417040642_IO0V1Y_XGB_B1` (`KEY`, `Estimator`) SELECT `U`.`KEY`, `U`.`Estimator` 
...
-- Code For temporary table TMP_20180417040642_RBYDTL_XGB_Union part 1/2. Create 


CREATE TEMPORARY TABLE `TMP_20180417040642_RBYDTL_XGB_Union` (
	`KEY` BIGINT, 
	`Estimator` DOUBLE
)
...
-- Code For temporary table TMP_20180417040642_RBYDTL_XGB_Union part 2/2. Populate

INSERT INTO `TMP_20180417040642_RBYDTL_XGB_Union` (`KEY`, `Estimator`) SELECT `U`.`KEY`, `U`.`Estimator` 
...
FROM `TMP_20180417040642_55NLD9_XGB_B0` AS `XGB_B0` UNION ALL SELECT `XGB_B1`.`KEY` AS `KEY`, `XGB_B1`.`Estimator` AS `Estimator` 
FROM `TMP_20180417040642_IO0V1Y_XGB_B1` AS `XGB_B1`) AS `XGB_EnsembleUnion`) AS `XGB_Union`) AS `U`

-- Code For temporary table TMP_20180417040642_COFBQR_XGB_sum part 1/2. Create 


CREATE TEMPORARY TABLE `TMP_20180417040642_COFBQR_XGB_sum` (
	`KEY` BIGINT NOT NULL, 
	`Estimator` DOUBLE, 
	PRIMARY KEY (`KEY`)
)
...
-- Code For temporary table TMP_20180417040642_COFBQR_XGB_sum part 2/2. Populate

INSERT INTO `TMP_20180417040642_COFBQR_XGB_sum` (`KEY`, `Estimator`) SELECT `U`.`KEY`, `U`.`Estimator` 
...
FROM `TMP_20180417040642_RBYDTL_XGB_Union` AS `XGB_Union` GROUP BY `XGB_Union`.`KEY`) AS `T`) AS `XGB_sum`) AS `U`

-- Model deployment code

SELECT `XGB_sum`.`KEY` AS `KEY`, `XGB_sum`.`Estimator` + 0.5 AS `Estimator` 
FROM `TMP_20180417040642_COFBQR_XGB_sum` AS `XGB_sum`