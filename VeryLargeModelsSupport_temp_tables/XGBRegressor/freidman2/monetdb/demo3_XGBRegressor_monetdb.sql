...
-- Code For temporary table tmp_20180417040642_5yyhd8_xgb_b0 part 1/2. Create 


CREATE TEMPORARY TABLE tmp_20180417040642_5yyhd8_xgb_b0 (
	"KEY" BIGINT, 
	"Estimator" FLOAT
)
...
-- Code For temporary table tmp_20180417040642_5yyhd8_xgb_b0 part 2/2. Populate

INSERT INTO tmp_20180417040642_5yyhd8_xgb_b0 ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
-- Code For temporary table tmp_20180417040642_47aben_xgb_b1 part 1/2. Create 


CREATE TEMPORARY TABLE tmp_20180417040642_47aben_xgb_b1 (
	"KEY" BIGINT, 
	"Estimator" FLOAT
)
...
-- Code For temporary table tmp_20180417040642_47aben_xgb_b1 part 2/2. Populate

INSERT INTO tmp_20180417040642_47aben_xgb_b1 ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
-- Code For temporary table tmp_20180417040642_sn73bk_xgb_union part 1/2. Create 


CREATE TEMPORARY TABLE tmp_20180417040642_sn73bk_xgb_union (
	"KEY" BIGINT, 
	"Estimator" FLOAT
)
...
-- Code For temporary table tmp_20180417040642_sn73bk_xgb_union part 2/2. Populate

INSERT INTO tmp_20180417040642_sn73bk_xgb_union ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
FROM tmp_20180417040642_5yyhd8_xgb_b0 AS "XGB_B0" UNION ALL SELECT "XGB_B1"."KEY" AS "KEY", "XGB_B1"."Estimator" AS "Estimator" 
FROM tmp_20180417040642_47aben_xgb_b1 AS "XGB_B1") AS "XGB_EnsembleUnion") AS "XGB_Union") AS "U"

-- Code For temporary table tmp_20180417040642_8h46mw_xgb_sum part 1/2. Create 


CREATE TEMPORARY TABLE tmp_20180417040642_8h46mw_xgb_sum (
	"KEY" BIGINT NOT NULL, 
	"Estimator" FLOAT, 
	PRIMARY KEY ("KEY")
)
...
-- Code For temporary table tmp_20180417040642_8h46mw_xgb_sum part 2/2. Populate

INSERT INTO tmp_20180417040642_8h46mw_xgb_sum ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
FROM tmp_20180417040642_sn73bk_xgb_union AS "XGB_Union" GROUP BY "XGB_Union"."KEY") AS "T") AS "XGB_sum") AS "U"

-- Model deployment code

SELECT "XGB_sum"."KEY" AS "KEY", "XGB_sum"."Estimator" + 0.5 AS "Estimator" 
FROM tmp_20180417040642_8h46mw_xgb_sum AS "XGB_sum"