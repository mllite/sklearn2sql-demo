...
-- Code For temporary table tmp_20180417011838_eabhcc_xgb_b0 part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180417011838_eabhcc_xgb_b0 (
	"KEY" BIGINT, 
	"Estimator" FLOAT
)
...
-- Code For temporary table tmp_20180417011838_eabhcc_xgb_b0 part 2/2. Populate

INSERT INTO tmp_20180417011838_eabhcc_xgb_b0 WITH "DT_node_lookup" AS 
...
-- Code For temporary table tmp_20180417011838_mxy1dm_xgb_b1 part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180417011838_mxy1dm_xgb_b1 (
	"KEY" BIGINT, 
	"Estimator" FLOAT
)
...
-- Code For temporary table tmp_20180417011838_mxy1dm_xgb_b1 part 2/2. Populate

INSERT INTO tmp_20180417011838_mxy1dm_xgb_b1 WITH "DT_node_lookup_10" AS 
...
-- Code For temporary table tmp_20180417011838_qpwo7g_xgb_union part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180417011838_qpwo7g_xgb_union (
	"KEY" BIGINT, 
	"Estimator" FLOAT
)
...
-- Code For temporary table tmp_20180417011838_qpwo7g_xgb_union part 2/2. Populate

INSERT INTO tmp_20180417011838_qpwo7g_xgb_union SELECT "XGB_Union"."KEY", "XGB_Union"."Estimator" 
...
FROM tmp_20180417011838_eabhcc_xgb_b0 AS "XGB_B0" UNION ALL SELECT "XGB_B1"."KEY" AS "KEY", "XGB_B1"."Estimator" AS "Estimator" 
FROM tmp_20180417011838_mxy1dm_xgb_b1 AS "XGB_B1") AS "XGB_EnsembleUnion") AS "XGB_Union"

-- Code For temporary table tmp_20180417011838_flpsrz_xgb_sum part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180417011838_flpsrz_xgb_sum (
	"KEY" BIGINT, 
	"Estimator" FLOAT
)
...
-- Code For temporary table tmp_20180417011838_flpsrz_xgb_sum part 2/2. Populate

INSERT INTO tmp_20180417011838_flpsrz_xgb_sum SELECT "XGB_sum"."KEY", "XGB_sum"."Estimator" 
...
FROM tmp_20180417011838_qpwo7g_xgb_union AS "XGB_Union" GROUP BY "XGB_Union"."KEY") AS "T") AS "XGB_sum"

-- Model deployment code

SELECT "XGB_sum"."KEY" AS "KEY", "XGB_sum"."Estimator" + 0.5 AS "Estimator" 
FROM tmp_20180417011838_flpsrz_xgb_sum AS "XGB_sum"