...
-- Code For temporary table 23238_0XX0JM_ADS_IMP_1_OUT part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE "23238_0XX0JM_ADS_IMP_1_OUT" (
...
-- Code For temporary table 23238_BMUVLH_ADS_SCA_2_OUT part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE "23238_BMUVLH_ADS_SCA_2_OUT" (
	"KEY" NUMBER(19) NOT NULL, 
...
FROM "23238_0XX0JM_ADS_IMP_1_OUT" "ADS_imp_1_OUT") "ADS_sca_2_OUT") "U"

-- Code For temporary table 80416223238_2MNBX7_LGBM_B0 part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE "80416223238_2MNBX7_LGBM_B0" (
	"KEY" NUMBER(19), 
...
-- Code For temporary table 80416223238_2MNBX7_LGBM_B0 part 2/2. Populate

INSERT INTO "80416223238_2MNBX7_LGBM_B0" ("KEY", "Score_0") SELECT "U"."KEY", "U"."Score_0" 
...
FROM "23238_BMUVLH_ADS_SCA_2_OUT" "ADS_sca_2_OUT"), 
"DT_node_data" AS 
...
-- Code For temporary table 80416223238_JJ6N1K_LGBM_B1 part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE "80416223238_JJ6N1K_LGBM_B1" (
	"KEY" NUMBER(19), 
	"Score_0" BINARY_DOUBLE
)
...
-- Code For temporary table 80416223238_JJ6N1K_LGBM_B1 part 2/2. Populate

INSERT INTO "80416223238_JJ6N1K_LGBM_B1" ("KEY", "Score_0") SELECT "U"."KEY", "U"."Score_0" 
...
-- Code For temporary table 16223238_5F50UE_LGBM_UNION part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE "16223238_5F50UE_LGBM_UNION" (
	"KEY" NUMBER(19), 
	"Score_0" BINARY_DOUBLE
)
...
-- Code For temporary table 16223238_5F50UE_LGBM_UNION part 2/2. Populate

INSERT INTO "16223238_5F50UE_LGBM_UNION" ("KEY", "Score_0") SELECT "U"."KEY", "U"."Score_0" 
...
FROM "80416223238_2MNBX7_LGBM_B0" "LGBM_B0" UNION ALL SELECT "LGBM_B1"."KEY" AS "KEY", "LGBM_B1"."Score_0" AS "Score_0" 
FROM "80416223238_JJ6N1K_LGBM_B1" "LGBM_B1") "LGBM_EnsembleUnion") "LGBM_Union") "U"

-- Code For temporary table 0416223238_SCYSWM_LGBM_SUM part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE "0416223238_SCYSWM_LGBM_SUM" (
	"KEY" NUMBER(19) NOT NULL, 
	"Score_0" BINARY_DOUBLE, 
	PRIMARY KEY ("KEY")
)
...
-- Code For temporary table 0416223238_SCYSWM_LGBM_SUM part 2/2. Populate

INSERT INTO "0416223238_SCYSWM_LGBM_SUM" ("KEY", "Score_0") SELECT "U"."KEY", "U"."Score_0" 
...
FROM "16223238_5F50UE_LGBM_UNION" "LGBM_Union" GROUP BY "LGBM_Union"."KEY") "T") "LGBM_sum") "U"
...
FROM "0416223238_SCYSWM_LGBM_SUM" "LGBM_sum"), 
