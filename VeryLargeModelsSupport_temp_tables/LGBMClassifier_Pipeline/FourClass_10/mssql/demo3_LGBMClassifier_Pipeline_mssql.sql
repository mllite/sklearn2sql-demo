...
-- Code For temporary table ##TMP_20180416233135_N6P99K_ADS_imp_1_OUT part 1/2. Create 


CREATE TABLE ##TMP_20180416233135_N6P99K_ADS_imp_1_OUT (
	[KEY] BIGINT NULL, 
...
-- Code For temporary table ##TMP_20180416233135_N6P99K_ADS_imp_1_OUT part 2/2. Populate

INSERT INTO ##TMP_20180416233135_N6P99K_ADS_imp_1_OUT ([KEY], impter_2, impter_3, impter_4, impter_5, impter_6, impter_7, impter_8, impter_9, impter_10, impter_11) SELECT [ADS_imp_1_OUT].[KEY], [ADS_imp_1_OUT].impter_2, [ADS_imp_1_OUT].impter_3, [ADS_imp_1_OUT].impter_4, [ADS_imp_1_OUT].impter_5, [ADS_imp_1_OUT].impter_6, [ADS_imp_1_OUT].impter_7, [ADS_imp_1_OUT].impter_8, [ADS_imp_1_OUT].impter_9, [ADS_imp_1_OUT].impter_10, [ADS_imp_1_OUT].impter_11 
...
-- Code For temporary table ##TMP_20180416233135_ZDGX9T_ADS_sca_2_OUT part 1/2. Create 


CREATE TABLE ##TMP_20180416233135_ZDGX9T_ADS_sca_2_OUT (
	[KEY] BIGINT NULL, 
	scaler_2 FLOAT NULL, 
	scaler_3 FLOAT NULL, 
	scaler_4 FLOAT NULL, 
...
-- Code For temporary table ##TMP_20180416233135_ZDGX9T_ADS_sca_2_OUT part 2/2. Populate

INSERT INTO ##TMP_20180416233135_ZDGX9T_ADS_sca_2_OUT ([KEY], scaler_2, scaler_3, scaler_4, scaler_5, scaler_6, scaler_7, scaler_8, scaler_9, scaler_10, scaler_11) SELECT [ADS_sca_2_OUT].[KEY], [ADS_sca_2_OUT].scaler_2, [ADS_sca_2_OUT].scaler_3, [ADS_sca_2_OUT].scaler_4, [ADS_sca_2_OUT].scaler_5, [ADS_sca_2_OUT].scaler_6, [ADS_sca_2_OUT].scaler_7, [ADS_sca_2_OUT].scaler_8, [ADS_sca_2_OUT].scaler_9, [ADS_sca_2_OUT].scaler_10, [ADS_sca_2_OUT].scaler_11 
...
FROM ##TMP_20180416233135_N6P99K_ADS_imp_1_OUT AS [ADS_imp_1_OUT]) AS [ADS_sca_2_OUT]

-- Code For temporary table ##TMP_20180416233136_OVB1BH_LGBM_B0 part 1/2. Create 


CREATE TABLE ##TMP_20180416233136_OVB1BH_LGBM_B0 (
	[KEY] BIGINT NULL, 
...
-- Code For temporary table ##TMP_20180416233136_OVB1BH_LGBM_B0 part 2/2. Populate
...
FROM ##TMP_20180416233135_ZDGX9T_ADS_sca_2_OUT AS [ADS_sca_2_OUT]), 
[DT_node_data] AS 
...
FROM [DT_Output_9])
 INSERT INTO ##TMP_20180416233136_OVB1BH_LGBM_B0 ([KEY], [Score_0], [Score_1], [Score_2], [Score_3]) SELECT [LGBM_B0].[KEY], [LGBM_B0].[Score_0], [LGBM_B0].[Score_1], [LGBM_B0].[Score_2], [LGBM_B0].[Score_3] 
...
-- Code For temporary table ##TMP_20180416233136_UP8DQ7_LGBM_B1 part 1/2. Create 


CREATE TABLE ##TMP_20180416233136_UP8DQ7_LGBM_B1 (
	[KEY] BIGINT NULL, 
	[Score_0] FLOAT(53) NULL, 
	[Score_1] FLOAT(53) NULL, 
	[Score_2] FLOAT(53) NULL, 
...
-- Code For temporary table ##TMP_20180416233136_UP8DQ7_LGBM_B1 part 2/2. Populate
...
FROM [DT_Output_19])
 INSERT INTO ##TMP_20180416233136_UP8DQ7_LGBM_B1 ([KEY], [Score_0], [Score_1], [Score_2], [Score_3]) SELECT [LGBM_B1].[KEY], [LGBM_B1].[Score_0], [LGBM_B1].[Score_1], [LGBM_B1].[Score_2], [LGBM_B1].[Score_3] 
...
-- Code For temporary table ##TMP_20180416233136_J3DFD1_LGBM_B2 part 1/2. Create 


CREATE TABLE ##TMP_20180416233136_J3DFD1_LGBM_B2 (
	[KEY] BIGINT NULL, 
	[Score_0] FLOAT(53) NULL, 
	[Score_1] FLOAT(53) NULL, 
	[Score_2] FLOAT(53) NULL, 
...
-- Code For temporary table ##TMP_20180416233136_J3DFD1_LGBM_B2 part 2/2. Populate
...
FROM [DT_Output_29])
 INSERT INTO ##TMP_20180416233136_J3DFD1_LGBM_B2 ([KEY], [Score_0], [Score_1], [Score_2], [Score_3]) SELECT [LGBM_B2].[KEY], [LGBM_B2].[Score_0], [LGBM_B2].[Score_1], [LGBM_B2].[Score_2], [LGBM_B2].[Score_3] 
...
-- Code For temporary table ##TMP_20180416233136_3UTI5Z_LGBM_B3 part 1/2. Create 


CREATE TABLE ##TMP_20180416233136_3UTI5Z_LGBM_B3 (
	[KEY] BIGINT NULL, 
	[Score_0] FLOAT(53) NULL, 
	[Score_1] FLOAT(53) NULL, 
	[Score_2] FLOAT(53) NULL, 
...
-- Code For temporary table ##TMP_20180416233136_3UTI5Z_LGBM_B3 part 2/2. Populate
...
FROM [DT_Output_39])
 INSERT INTO ##TMP_20180416233136_3UTI5Z_LGBM_B3 ([KEY], [Score_0], [Score_1], [Score_2], [Score_3]) SELECT [LGBM_B3].[KEY], [LGBM_B3].[Score_0], [LGBM_B3].[Score_1], [LGBM_B3].[Score_2], [LGBM_B3].[Score_3] 
...
-- Code For temporary table ##TMP_20180416233136_NHR824_LGBM_B4 part 1/2. Create 


CREATE TABLE ##TMP_20180416233136_NHR824_LGBM_B4 (
	[KEY] BIGINT NULL, 
	[Score_0] FLOAT(53) NULL, 
	[Score_1] FLOAT(53) NULL, 
	[Score_2] FLOAT(53) NULL, 
...
-- Code For temporary table ##TMP_20180416233136_NHR824_LGBM_B4 part 2/2. Populate
...
FROM [DT_Output_49])
 INSERT INTO ##TMP_20180416233136_NHR824_LGBM_B4 ([KEY], [Score_0], [Score_1], [Score_2], [Score_3]) SELECT [LGBM_B4].[KEY], [LGBM_B4].[Score_0], [LGBM_B4].[Score_1], [LGBM_B4].[Score_2], [LGBM_B4].[Score_3] 
...
-- Code For temporary table ##TMP_20180416233136_1M75CQ_LGBM_B5 part 1/2. Create 


CREATE TABLE ##TMP_20180416233136_1M75CQ_LGBM_B5 (
	[KEY] BIGINT NULL, 
	[Score_0] FLOAT(53) NULL, 
	[Score_1] FLOAT(53) NULL, 
	[Score_2] FLOAT(53) NULL, 
...
-- Code For temporary table ##TMP_20180416233136_1M75CQ_LGBM_B5 part 2/2. Populate
...
FROM [DT_Output_59])
 INSERT INTO ##TMP_20180416233136_1M75CQ_LGBM_B5 ([KEY], [Score_0], [Score_1], [Score_2], [Score_3]) SELECT [LGBM_B5].[KEY], [LGBM_B5].[Score_0], [LGBM_B5].[Score_1], [LGBM_B5].[Score_2], [LGBM_B5].[Score_3] 
...
-- Code For temporary table ##TMP_20180416233136_MOZHAT_LGBM_B6 part 1/2. Create 


CREATE TABLE ##TMP_20180416233136_MOZHAT_LGBM_B6 (
	[KEY] BIGINT NULL, 
	[Score_0] FLOAT(53) NULL, 
	[Score_1] FLOAT(53) NULL, 
	[Score_2] FLOAT(53) NULL, 
...
-- Code For temporary table ##TMP_20180416233136_MOZHAT_LGBM_B6 part 2/2. Populate
...
FROM [DT_Output_63])
 INSERT INTO ##TMP_20180416233136_MOZHAT_LGBM_B6 ([KEY], [Score_0], [Score_1], [Score_2], [Score_3]) SELECT [LGBM_B6].[KEY], [LGBM_B6].[Score_0], [LGBM_B6].[Score_1], [LGBM_B6].[Score_2], [LGBM_B6].[Score_3] 
...
-- Code For temporary table ##TMP_20180416233136_19Y0EL_LGBM_Union part 1/2. Create 


CREATE TABLE ##TMP_20180416233136_19Y0EL_LGBM_Union (
	[KEY] BIGINT NULL, 
	[Score_0] FLOAT(53) NULL, 
	[Score_1] FLOAT(53) NULL, 
	[Score_2] FLOAT(53) NULL, 
...
-- Code For temporary table ##TMP_20180416233136_19Y0EL_LGBM_Union part 2/2. Populate

INSERT INTO ##TMP_20180416233136_19Y0EL_LGBM_Union ([KEY], [Score_0], [Score_1], [Score_2], [Score_3]) SELECT [LGBM_Union].[KEY], [LGBM_Union].[Score_0], [LGBM_Union].[Score_1], [LGBM_Union].[Score_2], [LGBM_Union].[Score_3] 
...
FROM ##TMP_20180416233136_OVB1BH_LGBM_B0 AS [LGBM_B0] UNION ALL SELECT [LGBM_B1].[KEY] AS [KEY], [LGBM_B1].[Score_0] AS [Score_0], [LGBM_B1].[Score_1] AS [Score_1], [LGBM_B1].[Score_2] AS [Score_2], [LGBM_B1].[Score_3] AS [Score_3] 
FROM ##TMP_20180416233136_UP8DQ7_LGBM_B1 AS [LGBM_B1] UNION ALL SELECT [LGBM_B2].[KEY] AS [KEY], [LGBM_B2].[Score_0] AS [Score_0], [LGBM_B2].[Score_1] AS [Score_1], [LGBM_B2].[Score_2] AS [Score_2], [LGBM_B2].[Score_3] AS [Score_3] 
FROM ##TMP_20180416233136_J3DFD1_LGBM_B2 AS [LGBM_B2] UNION ALL SELECT [LGBM_B3].[KEY] AS [KEY], [LGBM_B3].[Score_0] AS [Score_0], [LGBM_B3].[Score_1] AS [Score_1], [LGBM_B3].[Score_2] AS [Score_2], [LGBM_B3].[Score_3] AS [Score_3] 
FROM ##TMP_20180416233136_3UTI5Z_LGBM_B3 AS [LGBM_B3] UNION ALL SELECT [LGBM_B4].[KEY] AS [KEY], [LGBM_B4].[Score_0] AS [Score_0], [LGBM_B4].[Score_1] AS [Score_1], [LGBM_B4].[Score_2] AS [Score_2], [LGBM_B4].[Score_3] AS [Score_3] 
FROM ##TMP_20180416233136_NHR824_LGBM_B4 AS [LGBM_B4] UNION ALL SELECT [LGBM_B5].[KEY] AS [KEY], [LGBM_B5].[Score_0] AS [Score_0], [LGBM_B5].[Score_1] AS [Score_1], [LGBM_B5].[Score_2] AS [Score_2], [LGBM_B5].[Score_3] AS [Score_3] 
FROM ##TMP_20180416233136_1M75CQ_LGBM_B5 AS [LGBM_B5] UNION ALL SELECT [LGBM_B6].[KEY] AS [KEY], [LGBM_B6].[Score_0] AS [Score_0], [LGBM_B6].[Score_1] AS [Score_1], [LGBM_B6].[Score_2] AS [Score_2], [LGBM_B6].[Score_3] AS [Score_3] 
FROM ##TMP_20180416233136_MOZHAT_LGBM_B6 AS [LGBM_B6]) AS [LGBM_EnsembleUnion]) AS [LGBM_Union]

-- Code For temporary table ##TMP_20180416233136_KBDQ3M_LGBM_sum part 1/2. Create 


CREATE TABLE ##TMP_20180416233136_KBDQ3M_LGBM_sum (
	[KEY] BIGINT NULL, 
	[Score_0] FLOAT(53) NULL, 
	[Score_1] FLOAT(53) NULL, 
	[Score_2] FLOAT(53) NULL, 
...
-- Code For temporary table ##TMP_20180416233136_KBDQ3M_LGBM_sum part 2/2. Populate

INSERT INTO ##TMP_20180416233136_KBDQ3M_LGBM_sum ([KEY], [Score_0], [Score_1], [Score_2], [Score_3]) SELECT [LGBM_sum].[KEY], [LGBM_sum].[Score_0], [LGBM_sum].[Score_1], [LGBM_sum].[Score_2], [LGBM_sum].[Score_3] 
