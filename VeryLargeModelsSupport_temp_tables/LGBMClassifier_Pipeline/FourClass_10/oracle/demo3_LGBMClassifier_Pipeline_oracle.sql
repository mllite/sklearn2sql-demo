...
-- Code For temporary table 33135_19C6OF_ADS_IMP_1_OUT part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE "33135_19C6OF_ADS_IMP_1_OUT" (
...
-- Code For temporary table 33135_19C6OF_ADS_IMP_1_OUT part 2/2. Populate

INSERT INTO "33135_19C6OF_ADS_IMP_1_OUT" ("KEY", impter_2, impter_3, impter_4, impter_5, impter_6, impter_7, impter_8, impter_9, impter_10, impter_11) SELECT "U"."KEY", "U".impter_2, "U".impter_3, "U".impter_4, "U".impter_5, "U".impter_6, "U".impter_7, "U".impter_8, "U".impter_9, "U".impter_10, "U".impter_11 
...
-- Code For temporary table 33135_2NSKMW_ADS_SCA_2_OUT part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE "33135_2NSKMW_ADS_SCA_2_OUT" (
	"KEY" NUMBER(19) NOT NULL, 
...
-- Code For temporary table 33135_2NSKMW_ADS_SCA_2_OUT part 2/2. Populate

INSERT INTO "33135_2NSKMW_ADS_SCA_2_OUT" ("KEY", scaler_2, scaler_3, scaler_4, scaler_5, scaler_6, scaler_7, scaler_8, scaler_9, scaler_10, scaler_11) SELECT "U"."KEY", "U".scaler_2, "U".scaler_3, "U".scaler_4, "U".scaler_5, "U".scaler_6, "U".scaler_7, "U".scaler_8, "U".scaler_9, "U".scaler_10, "U".scaler_11 
...
FROM "33135_19C6OF_ADS_IMP_1_OUT" "ADS_imp_1_OUT") "ADS_sca_2_OUT") "U"

-- Code For temporary table 80416233135_U9RRJL_LGBM_B0 part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE "80416233135_U9RRJL_LGBM_B0" (
	"KEY" NUMBER(19), 
...
-- Code For temporary table 80416233135_U9RRJL_LGBM_B0 part 2/2. Populate

INSERT INTO "80416233135_U9RRJL_LGBM_B0" ("KEY", "Score_0", "Score_1", "Score_2", "Score_3") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1", "U"."Score_2", "U"."Score_3" 
...
FROM "33135_2NSKMW_ADS_SCA_2_OUT" "ADS_sca_2_OUT"), 
"DT_node_data" AS 
...
-- Code For temporary table 80416233135_57NBGL_LGBM_B1 part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE "80416233135_57NBGL_LGBM_B1" (
	"KEY" NUMBER(19), 
	"Score_0" BINARY_DOUBLE, 
	"Score_1" BINARY_DOUBLE, 
	"Score_2" BINARY_DOUBLE, 
...
-- Code For temporary table 80416233135_57NBGL_LGBM_B1 part 2/2. Populate

INSERT INTO "80416233135_57NBGL_LGBM_B1" ("KEY", "Score_0", "Score_1", "Score_2", "Score_3") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1", "U"."Score_2", "U"."Score_3" 
...
-- Code For temporary table 80416233135_CSMTN8_LGBM_B2 part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE "80416233135_CSMTN8_LGBM_B2" (
	"KEY" NUMBER(19), 
	"Score_0" BINARY_DOUBLE, 
	"Score_1" BINARY_DOUBLE, 
	"Score_2" BINARY_DOUBLE, 
...
-- Code For temporary table 80416233135_CSMTN8_LGBM_B2 part 2/2. Populate

INSERT INTO "80416233135_CSMTN8_LGBM_B2" ("KEY", "Score_0", "Score_1", "Score_2", "Score_3") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1", "U"."Score_2", "U"."Score_3" 
...
-- Code For temporary table 80416233135_DBY2IR_LGBM_B3 part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE "80416233135_DBY2IR_LGBM_B3" (
	"KEY" NUMBER(19), 
	"Score_0" BINARY_DOUBLE, 
	"Score_1" BINARY_DOUBLE, 
	"Score_2" BINARY_DOUBLE, 
...
-- Code For temporary table 80416233135_DBY2IR_LGBM_B3 part 2/2. Populate

INSERT INTO "80416233135_DBY2IR_LGBM_B3" ("KEY", "Score_0", "Score_1", "Score_2", "Score_3") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1", "U"."Score_2", "U"."Score_3" 
...
-- Code For temporary table 80416233135_8V1E61_LGBM_B4 part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE "80416233135_8V1E61_LGBM_B4" (
	"KEY" NUMBER(19), 
	"Score_0" BINARY_DOUBLE, 
	"Score_1" BINARY_DOUBLE, 
	"Score_2" BINARY_DOUBLE, 
...
-- Code For temporary table 80416233135_8V1E61_LGBM_B4 part 2/2. Populate

INSERT INTO "80416233135_8V1E61_LGBM_B4" ("KEY", "Score_0", "Score_1", "Score_2", "Score_3") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1", "U"."Score_2", "U"."Score_3" 
...
-- Code For temporary table 80416233135_IRVQEE_LGBM_B5 part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE "80416233135_IRVQEE_LGBM_B5" (
	"KEY" NUMBER(19), 
	"Score_0" BINARY_DOUBLE, 
	"Score_1" BINARY_DOUBLE, 
	"Score_2" BINARY_DOUBLE, 
...
-- Code For temporary table 80416233135_IRVQEE_LGBM_B5 part 2/2. Populate

INSERT INTO "80416233135_IRVQEE_LGBM_B5" ("KEY", "Score_0", "Score_1", "Score_2", "Score_3") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1", "U"."Score_2", "U"."Score_3" 
...
-- Code For temporary table 80416233135_12NN1I_LGBM_B6 part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE "80416233135_12NN1I_LGBM_B6" (
	"KEY" NUMBER(19), 
	"Score_0" BINARY_DOUBLE, 
	"Score_1" BINARY_DOUBLE, 
	"Score_2" BINARY_DOUBLE, 
...
-- Code For temporary table 80416233135_12NN1I_LGBM_B6 part 2/2. Populate

INSERT INTO "80416233135_12NN1I_LGBM_B6" ("KEY", "Score_0", "Score_1", "Score_2", "Score_3") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1", "U"."Score_2", "U"."Score_3" 
...
-- Code For temporary table 16233135_B93PXV_LGBM_UNION part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE "16233135_B93PXV_LGBM_UNION" (
	"KEY" NUMBER(19), 
	"Score_0" BINARY_DOUBLE, 
	"Score_1" BINARY_DOUBLE, 
	"Score_2" BINARY_DOUBLE, 
...
-- Code For temporary table 16233135_B93PXV_LGBM_UNION part 2/2. Populate

INSERT INTO "16233135_B93PXV_LGBM_UNION" ("KEY", "Score_0", "Score_1", "Score_2", "Score_3") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1", "U"."Score_2", "U"."Score_3" 
...
FROM "80416233135_U9RRJL_LGBM_B0" "LGBM_B0" UNION ALL SELECT "LGBM_B1"."KEY" AS "KEY", "LGBM_B1"."Score_0" AS "Score_0", "LGBM_B1"."Score_1" AS "Score_1", "LGBM_B1"."Score_2" AS "Score_2", "LGBM_B1"."Score_3" AS "Score_3" 
FROM "80416233135_57NBGL_LGBM_B1" "LGBM_B1" UNION ALL SELECT "LGBM_B2"."KEY" AS "KEY", "LGBM_B2"."Score_0" AS "Score_0", "LGBM_B2"."Score_1" AS "Score_1", "LGBM_B2"."Score_2" AS "Score_2", "LGBM_B2"."Score_3" AS "Score_3" 
FROM "80416233135_CSMTN8_LGBM_B2" "LGBM_B2" UNION ALL SELECT "LGBM_B3"."KEY" AS "KEY", "LGBM_B3"."Score_0" AS "Score_0", "LGBM_B3"."Score_1" AS "Score_1", "LGBM_B3"."Score_2" AS "Score_2", "LGBM_B3"."Score_3" AS "Score_3" 
FROM "80416233135_DBY2IR_LGBM_B3" "LGBM_B3" UNION ALL SELECT "LGBM_B4"."KEY" AS "KEY", "LGBM_B4"."Score_0" AS "Score_0", "LGBM_B4"."Score_1" AS "Score_1", "LGBM_B4"."Score_2" AS "Score_2", "LGBM_B4"."Score_3" AS "Score_3" 
FROM "80416233135_8V1E61_LGBM_B4" "LGBM_B4" UNION ALL SELECT "LGBM_B5"."KEY" AS "KEY", "LGBM_B5"."Score_0" AS "Score_0", "LGBM_B5"."Score_1" AS "Score_1", "LGBM_B5"."Score_2" AS "Score_2", "LGBM_B5"."Score_3" AS "Score_3" 
FROM "80416233135_IRVQEE_LGBM_B5" "LGBM_B5" UNION ALL SELECT "LGBM_B6"."KEY" AS "KEY", "LGBM_B6"."Score_0" AS "Score_0", "LGBM_B6"."Score_1" AS "Score_1", "LGBM_B6"."Score_2" AS "Score_2", "LGBM_B6"."Score_3" AS "Score_3" 
FROM "80416233135_12NN1I_LGBM_B6" "LGBM_B6") "LGBM_EnsembleUnion") "LGBM_Union") "U"

-- Code For temporary table 0416233135_2QPLWI_LGBM_SUM part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE "0416233135_2QPLWI_LGBM_SUM" (
	"KEY" NUMBER(19) NOT NULL, 
	"Score_0" BINARY_DOUBLE, 
	"Score_1" BINARY_DOUBLE, 
	"Score_2" BINARY_DOUBLE, 
...
-- Code For temporary table 0416233135_2QPLWI_LGBM_SUM part 2/2. Populate

INSERT INTO "0416233135_2QPLWI_LGBM_SUM" ("KEY", "Score_0", "Score_1", "Score_2", "Score_3") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1", "U"."Score_2", "U"."Score_3" 
...
FROM "16233135_B93PXV_LGBM_UNION" "LGBM_Union" GROUP BY "LGBM_Union"."KEY") "T") "LGBM_sum") "U"
...
FROM "0416233135_2QPLWI_LGBM_SUM" "LGBM_sum"), 
