...
-- Code For temporary table tmp_20180417051013_akobx9_gb_b0 part 1/2. Create 


CREATE TEMPORARY TABLE tmp_20180417051013_akobx9_gb_b0 (
	"KEY" BIGINT, 
	"Score_CLASS_0" FLOAT, 
	"Score_CLASS_1" FLOAT, 
	"Score_CLASS_2" FLOAT
...
-- Code For temporary table tmp_20180417051013_akobx9_gb_b0 part 2/2. Populate

INSERT INTO tmp_20180417051013_akobx9_gb_b0 ("KEY", "Score_CLASS_0", "Score_CLASS_1", "Score_CLASS_2") SELECT "U"."KEY", "U"."Score_CLASS_0", "U"."Score_CLASS_1", "U"."Score_CLASS_2" 
...
-- Code For temporary table tmp_20180417051013_hx17wy_gb_b1 part 1/2. Create 


CREATE TEMPORARY TABLE tmp_20180417051013_hx17wy_gb_b1 (
	"KEY" BIGINT, 
	"Score_CLASS_0" FLOAT, 
	"Score_CLASS_1" FLOAT, 
	"Score_CLASS_2" FLOAT
...
-- Code For temporary table tmp_20180417051013_hx17wy_gb_b1 part 2/2. Populate

INSERT INTO tmp_20180417051013_hx17wy_gb_b1 ("KEY", "Score_CLASS_0", "Score_CLASS_1", "Score_CLASS_2") SELECT "U"."KEY", "U"."Score_CLASS_0", "U"."Score_CLASS_1", "U"."Score_CLASS_2" 
...
-- Code For temporary table tmp_20180417051013_g0rwpx_gb_b2 part 1/2. Create 


CREATE TEMPORARY TABLE tmp_20180417051013_g0rwpx_gb_b2 (
	"KEY" BIGINT, 
	"Score_CLASS_0" FLOAT, 
	"Score_CLASS_1" FLOAT, 
	"Score_CLASS_2" FLOAT
...
-- Code For temporary table tmp_20180417051013_g0rwpx_gb_b2 part 2/2. Populate

INSERT INTO tmp_20180417051013_g0rwpx_gb_b2 ("KEY", "Score_CLASS_0", "Score_CLASS_1", "Score_CLASS_2") SELECT "U"."KEY", "U"."Score_CLASS_0", "U"."Score_CLASS_1", "U"."Score_CLASS_2" 
...
-- Code For temporary table tmp_20180417051013_fd08ox_gb_b3 part 1/2. Create 


CREATE TEMPORARY TABLE tmp_20180417051013_fd08ox_gb_b3 (
	"KEY" BIGINT, 
	"Score_CLASS_0" FLOAT, 
	"Score_CLASS_1" FLOAT, 
	"Score_CLASS_2" FLOAT
...
-- Code For temporary table tmp_20180417051013_fd08ox_gb_b3 part 2/2. Populate

INSERT INTO tmp_20180417051013_fd08ox_gb_b3 ("KEY", "Score_CLASS_0", "Score_CLASS_1", "Score_CLASS_2") SELECT "U"."KEY", "U"."Score_CLASS_0", "U"."Score_CLASS_1", "U"."Score_CLASS_2" 
...
-- Code For temporary table tmp_20180417051013_pg0wi2_gb_b4 part 1/2. Create 


CREATE TEMPORARY TABLE tmp_20180417051013_pg0wi2_gb_b4 (
	"KEY" BIGINT, 
	"Score_CLASS_0" FLOAT, 
	"Score_CLASS_1" FLOAT, 
	"Score_CLASS_2" FLOAT
...
-- Code For temporary table tmp_20180417051013_pg0wi2_gb_b4 part 2/2. Populate

INSERT INTO tmp_20180417051013_pg0wi2_gb_b4 ("KEY", "Score_CLASS_0", "Score_CLASS_1", "Score_CLASS_2") SELECT "U"."KEY", "U"."Score_CLASS_0", "U"."Score_CLASS_1", "U"."Score_CLASS_2" 
...
-- Code For temporary table tmp_20180417051013_6ogbqg_gb_union part 1/2. Create 


CREATE TEMPORARY TABLE tmp_20180417051013_6ogbqg_gb_union (
	"KEY" BIGINT, 
	"Score_CLASS_0" FLOAT, 
	"Score_CLASS_1" FLOAT, 
	"Score_CLASS_2" FLOAT
...
-- Code For temporary table tmp_20180417051013_6ogbqg_gb_union part 2/2. Populate

INSERT INTO tmp_20180417051013_6ogbqg_gb_union ("KEY", "Score_CLASS_0", "Score_CLASS_1", "Score_CLASS_2") SELECT "U"."KEY", "U"."Score_CLASS_0", "U"."Score_CLASS_1", "U"."Score_CLASS_2" 
...
FROM tmp_20180417051013_akobx9_gb_b0 AS "GB_B0" UNION ALL SELECT "GB_B1"."KEY" AS "KEY", "GB_B1"."Score_CLASS_0" AS "Score_CLASS_0", "GB_B1"."Score_CLASS_1" AS "Score_CLASS_1", "GB_B1"."Score_CLASS_2" AS "Score_CLASS_2" 
FROM tmp_20180417051013_hx17wy_gb_b1 AS "GB_B1" UNION ALL SELECT "GB_B2"."KEY" AS "KEY", "GB_B2"."Score_CLASS_0" AS "Score_CLASS_0", "GB_B2"."Score_CLASS_1" AS "Score_CLASS_1", "GB_B2"."Score_CLASS_2" AS "Score_CLASS_2" 
FROM tmp_20180417051013_g0rwpx_gb_b2 AS "GB_B2" UNION ALL SELECT "GB_B3"."KEY" AS "KEY", "GB_B3"."Score_CLASS_0" AS "Score_CLASS_0", "GB_B3"."Score_CLASS_1" AS "Score_CLASS_1", "GB_B3"."Score_CLASS_2" AS "Score_CLASS_2" 
FROM tmp_20180417051013_fd08ox_gb_b3 AS "GB_B3" UNION ALL SELECT "GB_B4"."KEY" AS "KEY", "GB_B4"."Score_CLASS_0" AS "Score_CLASS_0", "GB_B4"."Score_CLASS_1" AS "Score_CLASS_1", "GB_B4"."Score_CLASS_2" AS "Score_CLASS_2" 
FROM tmp_20180417051013_pg0wi2_gb_b4 AS "GB_B4") AS "GB_EnsembleUnion") AS "GB_Union") AS "U"

-- Code For temporary table tmp_20180417051013_jdd6it_gb_sum part 1/2. Create 


CREATE TEMPORARY TABLE tmp_20180417051013_jdd6it_gb_sum (
	"KEY" BIGINT NOT NULL, 
	"Score_CLASS_0" FLOAT, 
	"Score_CLASS_1" FLOAT, 
	"Score_CLASS_2" FLOAT, 
...
-- Code For temporary table tmp_20180417051013_jdd6it_gb_sum part 2/2. Populate

INSERT INTO tmp_20180417051013_jdd6it_gb_sum ("KEY", "Score_CLASS_0", "Score_CLASS_1", "Score_CLASS_2") SELECT "U"."KEY", "U"."Score_CLASS_0", "U"."Score_CLASS_1", "U"."Score_CLASS_2" 
...
FROM tmp_20180417051013_6ogbqg_gb_union AS "GB_Union" GROUP BY "GB_Union"."KEY") AS "T") AS "GB_sum") AS "U"
...
FROM tmp_20180417051013_jdd6it_gb_sum AS "GB_sum"), 
