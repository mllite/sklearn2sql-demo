...
-- Code For temporary table TMP_20180417042158_Y036VM_GB_B0 part 1/2. Create 


CREATE TEMPORARY TABLE "TMP_20180417042158_Y036VM_GB_B0" (
	"KEY" BIGINT, 
	"Score_0" FLOAT, 
	"Score_1" FLOAT, 
	"Score_2" FLOAT
...
-- Code For temporary table TMP_20180417042158_Y036VM_GB_B0 part 2/2. Populate
...
FROM "DT_Output_9")
 INSERT INTO "TMP_20180417042158_Y036VM_GB_B0" ("KEY", "Score_0", "Score_1", "Score_2") SELECT "GB_B0"."KEY", "GB_B0"."Score_0", "GB_B0"."Score_1", "GB_B0"."Score_2" 
...
-- Code For temporary table TMP_20180417042158_FPE39L_GB_B1 part 1/2. Create 


CREATE TEMPORARY TABLE "TMP_20180417042158_FPE39L_GB_B1" (
	"KEY" BIGINT, 
	"Score_0" FLOAT, 
	"Score_1" FLOAT, 
	"Score_2" FLOAT
...
-- Code For temporary table TMP_20180417042158_FPE39L_GB_B1 part 2/2. Populate
...
FROM "DT_Output_19")
 INSERT INTO "TMP_20180417042158_FPE39L_GB_B1" ("KEY", "Score_0", "Score_1", "Score_2") SELECT "GB_B1"."KEY", "GB_B1"."Score_0", "GB_B1"."Score_1", "GB_B1"."Score_2" 
...
-- Code For temporary table TMP_20180417042158_TA1H2Z_GB_B2 part 1/2. Create 


CREATE TEMPORARY TABLE "TMP_20180417042158_TA1H2Z_GB_B2" (
	"KEY" BIGINT, 
	"Score_0" FLOAT, 
	"Score_1" FLOAT, 
	"Score_2" FLOAT
...
-- Code For temporary table TMP_20180417042158_TA1H2Z_GB_B2 part 2/2. Populate
...
FROM "DT_Output_29")
 INSERT INTO "TMP_20180417042158_TA1H2Z_GB_B2" ("KEY", "Score_0", "Score_1", "Score_2") SELECT "GB_B2"."KEY", "GB_B2"."Score_0", "GB_B2"."Score_1", "GB_B2"."Score_2" 
...
-- Code For temporary table TMP_20180417042158_49Z9OE_GB_B3 part 1/2. Create 


CREATE TEMPORARY TABLE "TMP_20180417042158_49Z9OE_GB_B3" (
	"KEY" BIGINT, 
	"Score_0" FLOAT, 
	"Score_1" FLOAT, 
	"Score_2" FLOAT
...
-- Code For temporary table TMP_20180417042158_49Z9OE_GB_B3 part 2/2. Populate
...
FROM "DT_Output_39")
 INSERT INTO "TMP_20180417042158_49Z9OE_GB_B3" ("KEY", "Score_0", "Score_1", "Score_2") SELECT "GB_B3"."KEY", "GB_B3"."Score_0", "GB_B3"."Score_1", "GB_B3"."Score_2" 
...
-- Code For temporary table TMP_20180417042158_4FJDCF_GB_B4 part 1/2. Create 


CREATE TEMPORARY TABLE "TMP_20180417042158_4FJDCF_GB_B4" (
	"KEY" BIGINT, 
	"Score_0" FLOAT, 
	"Score_1" FLOAT, 
	"Score_2" FLOAT
...
-- Code For temporary table TMP_20180417042158_4FJDCF_GB_B4 part 2/2. Populate
...
FROM "DT_Output_47")
 INSERT INTO "TMP_20180417042158_4FJDCF_GB_B4" ("KEY", "Score_0", "Score_1", "Score_2") SELECT "GB_B4"."KEY", "GB_B4"."Score_0", "GB_B4"."Score_1", "GB_B4"."Score_2" 
...
-- Code For temporary table TMP_20180417042158_6N6JV6_GB_Union part 1/2. Create 


CREATE TEMPORARY TABLE "TMP_20180417042158_6N6JV6_GB_Union" (
	"KEY" BIGINT, 
	"Score_0" FLOAT, 
	"Score_1" FLOAT, 
	"Score_2" FLOAT
...
-- Code For temporary table TMP_20180417042158_6N6JV6_GB_Union part 2/2. Populate

INSERT INTO "TMP_20180417042158_6N6JV6_GB_Union" ("KEY", "Score_0", "Score_1", "Score_2") SELECT "GB_Union"."KEY", "GB_Union"."Score_0", "GB_Union"."Score_1", "GB_Union"."Score_2" 
...
FROM "TMP_20180417042158_Y036VM_GB_B0" AS "GB_B0" UNION ALL SELECT "GB_B1"."KEY" AS "KEY", "GB_B1"."Score_0" AS "Score_0", "GB_B1"."Score_1" AS "Score_1", "GB_B1"."Score_2" AS "Score_2" 
FROM "TMP_20180417042158_FPE39L_GB_B1" AS "GB_B1" UNION ALL SELECT "GB_B2"."KEY" AS "KEY", "GB_B2"."Score_0" AS "Score_0", "GB_B2"."Score_1" AS "Score_1", "GB_B2"."Score_2" AS "Score_2" 
FROM "TMP_20180417042158_TA1H2Z_GB_B2" AS "GB_B2" UNION ALL SELECT "GB_B3"."KEY" AS "KEY", "GB_B3"."Score_0" AS "Score_0", "GB_B3"."Score_1" AS "Score_1", "GB_B3"."Score_2" AS "Score_2" 
FROM "TMP_20180417042158_49Z9OE_GB_B3" AS "GB_B3" UNION ALL SELECT "GB_B4"."KEY" AS "KEY", "GB_B4"."Score_0" AS "Score_0", "GB_B4"."Score_1" AS "Score_1", "GB_B4"."Score_2" AS "Score_2" 
FROM "TMP_20180417042158_4FJDCF_GB_B4" AS "GB_B4") AS "GB_EnsembleUnion") AS "GB_Union"

-- Code For temporary table TMP_20180417042158_QC5WHK_GB_sum part 1/2. Create 


CREATE TEMPORARY TABLE "TMP_20180417042158_QC5WHK_GB_sum" (
	"KEY" BIGINT NOT NULL, 
	"Score_0" FLOAT, 
	"Score_1" FLOAT, 
	"Score_2" FLOAT, 
...
-- Code For temporary table TMP_20180417042158_QC5WHK_GB_sum part 2/2. Populate

INSERT INTO "TMP_20180417042158_QC5WHK_GB_sum" ("KEY", "Score_0", "Score_1", "Score_2") SELECT "GB_sum"."KEY", "GB_sum"."Score_0", "GB_sum"."Score_1", "GB_sum"."Score_2" 
...
FROM "TMP_20180417042158_6N6JV6_GB_Union" AS "GB_Union" GROUP BY "GB_Union"."KEY") AS "T") AS "GB_sum"
...
FROM "TMP_20180417042158_QC5WHK_GB_sum" AS "GB_sum"), 
