...
-- Code For temporary table TMP_20180416223218_LUMXLH_GB_B0 part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180416223218_LUMXLH_GB_B0" (
	"KEY" BIGINT, 
	"Score_0" FLOAT, 
	"Score_1" FLOAT
)
...
-- Code For temporary table TMP_20180416223218_LUMXLH_GB_B0 part 2/2. Populate

INSERT INTO "TMP_20180416223218_LUMXLH_GB_B0" ("KEY", "Score_0", "Score_1") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1" 
...
-- Code For temporary table TMP_20180416223218_GRHK8B_GB_B1 part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180416223218_GRHK8B_GB_B1" (
	"KEY" BIGINT, 
	"Score_0" FLOAT, 
	"Score_1" FLOAT
)
...
-- Code For temporary table TMP_20180416223218_GRHK8B_GB_B1 part 2/2. Populate

INSERT INTO "TMP_20180416223218_GRHK8B_GB_B1" ("KEY", "Score_0", "Score_1") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1" 
...
-- Code For temporary table TMP_20180416223218_3PUC8C_GB_B2 part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180416223218_3PUC8C_GB_B2" (
	"KEY" BIGINT, 
	"Score_0" FLOAT, 
	"Score_1" FLOAT
)
...
-- Code For temporary table TMP_20180416223218_3PUC8C_GB_B2 part 2/2. Populate

INSERT INTO "TMP_20180416223218_3PUC8C_GB_B2" ("KEY", "Score_0", "Score_1") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1" 
...
-- Code For temporary table TMP_20180416223218_1HCUN6_GB_B3 part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180416223218_1HCUN6_GB_B3" (
	"KEY" BIGINT, 
	"Score_0" FLOAT, 
	"Score_1" FLOAT
)
...
-- Code For temporary table TMP_20180416223218_1HCUN6_GB_B3 part 2/2. Populate

INSERT INTO "TMP_20180416223218_1HCUN6_GB_B3" ("KEY", "Score_0", "Score_1") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1" 
...
-- Code For temporary table TMP_20180416223218_32BAID_GB_UN part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180416223218_32BAID_GB_UN" (
	"KEY" BIGINT, 
	"Score_0" FLOAT, 
	"Score_1" FLOAT
)
...
-- Code For temporary table TMP_20180416223218_32BAID_GB_UN part 2/2. Populate

INSERT INTO "TMP_20180416223218_32BAID_GB_UN" ("KEY", "Score_0", "Score_1") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1" 
...
FROM "TMP_20180416223218_LUMXLH_GB_B0" AS "GB_B0" UNION ALL SELECT "GB_B1"."KEY" AS "KEY", "GB_B1"."Score_0" AS "Score_0", "GB_B1"."Score_1" AS "Score_1" 
FROM "TMP_20180416223218_GRHK8B_GB_B1" AS "GB_B1" UNION ALL SELECT "GB_B2"."KEY" AS "KEY", "GB_B2"."Score_0" AS "Score_0", "GB_B2"."Score_1" AS "Score_1" 
FROM "TMP_20180416223218_3PUC8C_GB_B2" AS "GB_B2" UNION ALL SELECT "GB_B3"."KEY" AS "KEY", "GB_B3"."Score_0" AS "Score_0", "GB_B3"."Score_1" AS "Score_1" 
FROM "TMP_20180416223218_1HCUN6_GB_B3" AS "GB_B3") AS "GB_EnsembleUnion") AS "GB_Union") AS "U"

-- Code For temporary table TMP_20180416223218_8C5V9X_GB_SU part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180416223218_8C5V9X_GB_SU" (
	"KEY" BIGINT, 
	"Score_0" FLOAT, 
	"Score_1" FLOAT
)
...
-- Code For temporary table TMP_20180416223218_8C5V9X_GB_SU part 2/2. Populate

INSERT INTO "TMP_20180416223218_8C5V9X_GB_SU" ("KEY", "Score_0", "Score_1") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1" 
...
FROM "TMP_20180416223218_32BAID_GB_UN" AS "GB_Union" GROUP BY "GB_Union"."KEY") AS "T") AS "GB_sum") AS "U"
...
FROM "TMP_20180416223218_8C5V9X_GB_SU" AS "GB_sum"), 
