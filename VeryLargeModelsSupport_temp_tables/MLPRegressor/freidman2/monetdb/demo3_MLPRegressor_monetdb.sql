...
-- Code For temporary table tmp_20180417040455_laag98_hl_1_relu_1 part 1/2. Create 


CREATE TEMPORARY TABLE tmp_20180417040455_laag98_hl_1_relu_1 (
	"KEY" BIGINT NOT NULL, 
	"NEUR_1_1" FLOAT, 
	"NEUR_1_2" FLOAT, 
	"NEUR_1_3" FLOAT, 
...
-- Code For temporary table tmp_20180417040455_laag98_hl_1_relu_1 part 2/2. Populate

INSERT INTO tmp_20180417040455_laag98_hl_1_relu_1 ("KEY", "NEUR_1_1", "NEUR_1_2", "NEUR_1_3") SELECT "U"."KEY", "U"."NEUR_1_1", "U"."NEUR_1_2", "U"."NEUR_1_3" 
FROM (WITH "IL" AS 
...
-- Code For temporary table tmp_20180417040455_heu6gh_ol_identity_1 part 1/2. Create 


CREATE TEMPORARY TABLE tmp_20180417040455_heu6gh_ol_identity_1 (
	"KEY" BIGINT NOT NULL, 
	"NEUR_3_1" FLOAT, 
	PRIMARY KEY ("KEY")
)
...
-- Code For temporary table tmp_20180417040455_heu6gh_ol_identity_1 part 2/2. Populate

INSERT INTO tmp_20180417040455_heu6gh_ol_identity_1 ("KEY", "NEUR_3_1") SELECT "U"."KEY", "U"."NEUR_3_1" 
...
FROM tmp_20180417040455_laag98_hl_1_relu_1 AS "HL_1_relu_1"), 
"HL_2_relu" AS 
...
FROM tmp_20180417040455_heu6gh_ol_identity_1 AS "OL_identity_1"