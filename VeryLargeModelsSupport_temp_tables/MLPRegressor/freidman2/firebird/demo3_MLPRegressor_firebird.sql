...
-- Code For temporary table TMP_20180417040455_W5QFFW_HL_1_ part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180417040455_W5QFFW_HL_1_" (
	"KEY" BIGINT, 
	"NEUR_1_1" FLOAT, 
	"NEUR_1_2" FLOAT, 
	"NEUR_1_3" FLOAT
...
-- Code For temporary table TMP_20180417040455_W5QFFW_HL_1_ part 2/2. Populate

INSERT INTO "TMP_20180417040455_W5QFFW_HL_1_" ("KEY", "NEUR_1_1", "NEUR_1_2", "NEUR_1_3") SELECT "U"."KEY", "U"."NEUR_1_1", "U"."NEUR_1_2", "U"."NEUR_1_3" 
FROM (WITH "IL" AS 
...
-- Code For temporary table TMP_20180417040455_UTNWVU_OL_ID part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180417040455_UTNWVU_OL_ID" (
	"KEY" BIGINT, 
	"NEUR_3_1" FLOAT
)
...
-- Code For temporary table TMP_20180417040455_UTNWVU_OL_ID part 2/2. Populate

INSERT INTO "TMP_20180417040455_UTNWVU_OL_ID" ("KEY", "NEUR_3_1") SELECT "U"."KEY", "U"."NEUR_3_1" 
...
FROM "TMP_20180417040455_W5QFFW_HL_1_" AS "HL_1_relu_1"), 
"HL_2_relu" AS 
...
FROM "TMP_20180417040455_UTNWVU_OL_ID" AS "OL_identity_1"