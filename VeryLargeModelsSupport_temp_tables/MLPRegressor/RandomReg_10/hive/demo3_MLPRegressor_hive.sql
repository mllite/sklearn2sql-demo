...
-- Code For temporary table tmp_20180417011650_ho7y9y_hl_1_relu_1 part 1/2. Create 

CREATE TEMPORARY TABLE `tmp_20180417011650_ho7y9y_hl_1_relu_1` STORED AS ORC AS WITH `IL` AS 
...
-- Code For temporary table tmp_20180417011650_ho7y9y_hl_1_relu_1 part 2/2. Populate

SELECT * FROM `tmp_20180417011650_ho7y9y_hl_1_relu_1`

-- Code For temporary table tmp_20180417011650_5xb1on_ol_identity_1 part 1/2. Create 

CREATE TEMPORARY TABLE `tmp_20180417011650_5xb1on_ol_identity_1` STORED AS ORC AS WITH `HL_BA_2` AS 
...
FROM `tmp_20180417011650_ho7y9y_hl_1_relu_1` AS `HL_1_relu_1`), 
`HL_2_relu` AS 
...
-- Code For temporary table tmp_20180417011650_5xb1on_ol_identity_1 part 2/2. Populate

SELECT * FROM `tmp_20180417011650_5xb1on_ol_identity_1`

-- Model deployment code

SELECT `OL_identity_1`.`KEY` AS `KEY`, `OL_identity_1`.`NEUR_3_1` AS `Estimator` 
FROM `tmp_20180417011650_5xb1on_ol_identity_1` AS `OL_identity_1`