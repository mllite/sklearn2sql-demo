...
-- Code For temporary table TMP_20180416223112_ZJTSDJ_ADS_imp_1_OUT part 1/2. Create 


CREATE TEMPORARY TABLE "TMP_20180416223112_ZJTSDJ_ADS_imp_1_OUT" (
	"KEY" BIGINT NOT NULL, 
	impter_2 FLOAT, 
	impter_3 FLOAT, 
	impter_4 FLOAT, 
...
-- Code For temporary table TMP_20180416223112_YY6QFM_ADS_sca_2_OUT part 1/2. Create 


CREATE TEMPORARY TABLE "TMP_20180416223112_YY6QFM_ADS_sca_2_OUT" (
	"KEY" BIGINT NOT NULL, 
	scaler_2 FLOAT, 
	scaler_3 FLOAT, 
	scaler_4 FLOAT, 
...
FROM "TMP_20180416223112_ZJTSDJ_ADS_imp_1_OUT" AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT"

-- Code For temporary table TMP_20180416223112_APJHOJ_CalProb_B0 part 1/2. Create 


CREATE TEMPORARY TABLE "TMP_20180416223112_APJHOJ_CalProb_B0" (
	"KEY" BIGINT, 
	"Proba_1" FLOAT, 
	"Proba_0" FLOAT
)
...
-- Code For temporary table TMP_20180416223112_APJHOJ_CalProb_B0 part 2/2. Populate
...
FROM "TMP_20180416223112_YY6QFM_ADS_sca_2_OUT" AS "ADS_sca_2_OUT"), 
"DT_node_data" AS 
...
FROM isotonic_cte_3)
 INSERT INTO "TMP_20180416223112_APJHOJ_CalProb_B0" ("KEY", "Proba_1", "Proba_0") SELECT "CalProb_B0"."KEY", "CalProb_B0"."Proba_1", "CalProb_B0"."Proba_0" 
...
-- Code For temporary table TMP_20180416223112_U8BQGR_CalProb_Union part 1/2. Create 


CREATE TEMPORARY TABLE "TMP_20180416223112_U8BQGR_CalProb_Union" (
	"KEY" BIGINT, 
	"Proba_1" FLOAT, 
	"Proba_0" FLOAT
)
...
-- Code For temporary table TMP_20180416223112_U8BQGR_CalProb_Union part 2/2. Populate

INSERT INTO "TMP_20180416223112_U8BQGR_CalProb_Union" ("KEY", "Proba_1", "Proba_0") SELECT "CalProb_Union"."KEY", "CalProb_Union"."Proba_1", "CalProb_Union"."Proba_0" 
...
FROM "TMP_20180416223112_APJHOJ_CalProb_B0" AS "CalProb_B0") AS "CalProb_EnsembleUnion") AS "CalProb_Union"

-- Code For temporary table TMP_20180416223112_G9LKDB_CalProb_avg part 1/2. Create 


CREATE TEMPORARY TABLE "TMP_20180416223112_G9LKDB_CalProb_avg" (
	"KEY" BIGINT NOT NULL, 
	"Proba_1" FLOAT, 
	"Proba_0" FLOAT, 
	PRIMARY KEY ("KEY")
...
-- Code For temporary table TMP_20180416223112_G9LKDB_CalProb_avg part 2/2. Populate

INSERT INTO "TMP_20180416223112_G9LKDB_CalProb_avg" ("KEY", "Proba_1", "Proba_0") SELECT "CalProb_avg"."KEY", "CalProb_avg"."Proba_1", "CalProb_avg"."Proba_0" 
...
FROM "TMP_20180416223112_U8BQGR_CalProb_Union" AS "CalProb_Union" GROUP BY "CalProb_Union"."KEY") AS "T") AS "CalProb_avg"
...
FROM "TMP_20180416223112_G9LKDB_CalProb_avg" AS "CalProb_avg"), 
