...
-- Code For temporary table tmp_20180416223112_2a1l2j_ads_imp_1_out part 1/2. Create 


CREATE TEMPORARY TABLE tmp_20180416223112_2a1l2j_ads_imp_1_out (
	"KEY" BIGINT NOT NULL, 
	impter_2 FLOAT, 
	impter_3 FLOAT, 
	impter_4 FLOAT, 
...
-- Code For temporary table tmp_20180416223112_gjj7bm_ads_sca_2_out part 1/2. Create 


CREATE TEMPORARY TABLE tmp_20180416223112_gjj7bm_ads_sca_2_out (
	"KEY" BIGINT NOT NULL, 
	scaler_2 FLOAT, 
	scaler_3 FLOAT, 
	scaler_4 FLOAT, 
...
FROM tmp_20180416223112_2a1l2j_ads_imp_1_out AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT") AS "U"

-- Code For temporary table tmp_20180416223112_v8enx8_calprob_b0 part 1/2. Create 


CREATE TEMPORARY TABLE tmp_20180416223112_v8enx8_calprob_b0 (
	"KEY" BIGINT, 
	"Proba_1" FLOAT, 
	"Proba_0" FLOAT
)
...
-- Code For temporary table tmp_20180416223112_v8enx8_calprob_b0 part 2/2. Populate

INSERT INTO tmp_20180416223112_v8enx8_calprob_b0 ("KEY", "Proba_1", "Proba_0") SELECT "U"."KEY", "U"."Proba_1", "U"."Proba_0" 
...
FROM tmp_20180416223112_gjj7bm_ads_sca_2_out AS "ADS_sca_2_OUT"), 
"DT_node_data" AS 
...
-- Code For temporary table tmp_20180416223112_glc6e5_calprob_union part 1/2. Create 


CREATE TEMPORARY TABLE tmp_20180416223112_glc6e5_calprob_union (
	"KEY" BIGINT, 
	"Proba_1" FLOAT, 
	"Proba_0" FLOAT
)
...
-- Code For temporary table tmp_20180416223112_glc6e5_calprob_union part 2/2. Populate

INSERT INTO tmp_20180416223112_glc6e5_calprob_union ("KEY", "Proba_1", "Proba_0") SELECT "U"."KEY", "U"."Proba_1", "U"."Proba_0" 
...
FROM tmp_20180416223112_v8enx8_calprob_b0 AS "CalProb_B0") AS "CalProb_EnsembleUnion") AS "CalProb_Union") AS "U"

-- Code For temporary table tmp_20180416223112_pnmm8u_calprob_avg part 1/2. Create 


CREATE TEMPORARY TABLE tmp_20180416223112_pnmm8u_calprob_avg (
	"KEY" BIGINT NOT NULL, 
	"Proba_1" FLOAT, 
	"Proba_0" FLOAT, 
	PRIMARY KEY ("KEY")
...
-- Code For temporary table tmp_20180416223112_pnmm8u_calprob_avg part 2/2. Populate

INSERT INTO tmp_20180416223112_pnmm8u_calprob_avg ("KEY", "Proba_1", "Proba_0") SELECT "U"."KEY", "U"."Proba_1", "U"."Proba_0" 
...
FROM tmp_20180416223112_glc6e5_calprob_union AS "CalProb_Union" GROUP BY "CalProb_Union"."KEY") AS "T") AS "CalProb_avg") AS "U"
...
FROM tmp_20180416223112_pnmm8u_calprob_avg AS "CalProb_avg"), 
