...
-- Code For temporary table tmp_20180416223113_dfwlqy_ads_ part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180416223113_dfwlqy_ads_  (
	"KEY" BIGINT, 
	impter_2 FLOAT, 
	impter_3 FLOAT, 
	impter_4 FLOAT, 
...
-- Code For temporary table tmp_20180416223113_qv2du5_ads_ part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180416223113_qv2du5_ads_  (
	"KEY" BIGINT, 
	scaler_2 FLOAT, 
	scaler_3 FLOAT, 
	scaler_4 FLOAT, 
...
FROM tmp_20180416223113_dfwlqy_ads_ AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT") AS "U"

-- Code For temporary table tmp_20180416223113_x522e6_calp part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180416223113_x522e6_calp  (
	"KEY" BIGINT, 
	"Proba_1" FLOAT, 
	"Proba_0" FLOAT
)
...
-- Code For temporary table tmp_20180416223113_x522e6_calp part 2/2. Populate

INSERT INTO tmp_20180416223113_x522e6_calp ("KEY", "Proba_1", "Proba_0") SELECT "U"."KEY", "U"."Proba_1", "U"."Proba_0" 
...
FROM tmp_20180416223113_qv2du5_ads_ AS "ADS_sca_2_OUT"), 
"DT_node_data" AS 
...
FROM "DT_Output"), 
isotonic_cte_0 AS 
(SELECT "Calibrated_Model_0"."KEY" AS "KEY", CASE WHEN ("Calibrated_Model_0"."ScoreOrProba_1" < 0.0) THEN 0.181818181818182 WHEN ("Calibrated_Model_0"."ScoreOrProba_1" < 1.0) THEN ("Calibrated_Model_0"."ScoreOrProba_1" - 0.0) * 0.618181818181818 + 0.181818181818182 ELSE 0.8 END AS "Proba_1", 1.0 - CASE WHEN ("Calibrated_Model_0"."ScoreOrProba_1" < 0.0) THEN 0.181818181818182 WHEN ("Calibrated_Model_0"."ScoreOrProba_1" < 1.0) THEN ("Calibrated_Model_0"."ScoreOrProba_1" - 0.0) * 0.618181818181818 + 0.181818181818182 ELSE 0.8 END AS "Proba_0" 
...
FROM "DT_Output_1"), 
isotonic_cte_1 AS 
(SELECT "Calibrated_Model_1"."KEY" AS "KEY", CASE WHEN ("Calibrated_Model_1"."ScoreOrProba_1" < 0.0) THEN 0.090909090909091 WHEN ("Calibrated_Model_1"."ScoreOrProba_1" < 1.0) THEN ("Calibrated_Model_1"."ScoreOrProba_1" - 0.0) * 0.809090909090909 + 0.090909090909091 ELSE 0.9 END AS "Proba_1", 1.0 - CASE WHEN ("Calibrated_Model_1"."ScoreOrProba_1" < 0.0) THEN 0.090909090909091 WHEN ("Calibrated_Model_1"."ScoreOrProba_1" < 1.0) THEN ("Calibrated_Model_1"."ScoreOrProba_1" - 0.0) * 0.809090909090909 + 0.090909090909091 ELSE 0.9 END AS "Proba_0" 
...
-- Code For temporary table tmp_20180416223113_fi0u96_calp part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180416223113_fi0u96_calp  (
	"KEY" BIGINT, 
	"Proba_1" FLOAT, 
	"Proba_0" FLOAT
)
...
-- Code For temporary table tmp_20180416223113_fi0u96_calp part 2/2. Populate

INSERT INTO tmp_20180416223113_fi0u96_calp ("KEY", "Proba_1", "Proba_0") SELECT "U"."KEY", "U"."Proba_1", "U"."Proba_0" 
...
FROM tmp_20180416223113_x522e6_calp AS "CalProb_B0") AS "CalProb_EnsembleUnion") AS "CalProb_Union") AS "U"

-- Code For temporary table tmp_20180416223113_zwcf6a_calp part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180416223113_zwcf6a_calp  (
	"KEY" BIGINT, 
	"Proba_1" FLOAT, 
	"Proba_0" FLOAT
)
...
-- Code For temporary table tmp_20180416223113_zwcf6a_calp part 2/2. Populate

INSERT INTO tmp_20180416223113_zwcf6a_calp ("KEY", "Proba_1", "Proba_0") SELECT "U"."KEY", "U"."Proba_1", "U"."Proba_0" 
...
FROM tmp_20180416223113_fi0u96_calp AS "CalProb_Union" GROUP BY "CalProb_Union"."KEY") AS "T") AS "CalProb_avg") AS "U"
...
FROM tmp_20180416223113_zwcf6a_calp AS "CalProb_avg"), 
