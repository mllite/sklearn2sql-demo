...
-- Code For temporary table 23112_U5WWXP_ADS_IMP_1_OUT part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE "23112_U5WWXP_ADS_IMP_1_OUT" (
...
-- Code For temporary table 23112_1900T9_ADS_SCA_2_OUT part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE "23112_1900T9_ADS_SCA_2_OUT" (
	"KEY" NUMBER(19) NOT NULL, 
...
FROM "23112_U5WWXP_ADS_IMP_1_OUT" "ADS_imp_1_OUT") "ADS_sca_2_OUT") "U"

-- Code For temporary table 16223112_RVWEK4_CALPROB_B0 part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE "16223112_RVWEK4_CALPROB_B0" (
	"KEY" NUMBER(19), 
...
-- Code For temporary table 16223112_RVWEK4_CALPROB_B0 part 2/2. Populate

INSERT INTO "16223112_RVWEK4_CALPROB_B0" ("KEY", "Proba_1", "Proba_0") SELECT "U"."KEY", "U"."Proba_1", "U"."Proba_0" 
...
FROM "23112_1900T9_ADS_SCA_2_OUT" "ADS_sca_2_OUT"), 
"DT_node_data" AS 
...
-- Code For temporary table 23112_PVRQ90_CALPROB_UNION part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE "23112_PVRQ90_CALPROB_UNION" (
	"KEY" NUMBER(19), 
	"Proba_1" BINARY_DOUBLE, 
	"Proba_0" BINARY_DOUBLE
)
...
-- Code For temporary table 23112_PVRQ90_CALPROB_UNION part 2/2. Populate

INSERT INTO "23112_PVRQ90_CALPROB_UNION" ("KEY", "Proba_1", "Proba_0") SELECT "U"."KEY", "U"."Proba_1", "U"."Proba_0" 
...
FROM "16223112_RVWEK4_CALPROB_B0" "CalProb_B0") "CalProb_EnsembleUnion") "CalProb_Union") "U"

-- Code For temporary table 6223112_QIJ8E4_CALPROB_AVG part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE "6223112_QIJ8E4_CALPROB_AVG" (
	"KEY" NUMBER(19) NOT NULL, 
	"Proba_1" BINARY_DOUBLE, 
	"Proba_0" BINARY_DOUBLE, 
	PRIMARY KEY ("KEY")
...
-- Code For temporary table 6223112_QIJ8E4_CALPROB_AVG part 2/2. Populate

INSERT INTO "6223112_QIJ8E4_CALPROB_AVG" ("KEY", "Proba_1", "Proba_0") SELECT "U"."KEY", "U"."Proba_1", "U"."Proba_0" 
...
FROM "23112_PVRQ90_CALPROB_UNION" "CalProb_Union" GROUP BY "CalProb_Union"."KEY") "T") "CalProb_avg") "U"
...
FROM "6223112_QIJ8E4_CALPROB_AVG" "CalProb_avg"), 
