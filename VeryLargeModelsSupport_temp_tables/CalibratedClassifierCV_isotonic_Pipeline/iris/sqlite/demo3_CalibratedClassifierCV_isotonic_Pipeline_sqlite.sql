...
-- Code For temporary table TMP_20180417042059_8DMOEB_ADS_imp_1_OUT part 1/2. Create 


CREATE TEMPORARY TABLE "TMP_20180417042059_8DMOEB_ADS_imp_1_OUT" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20180417042059_8DMOEB_ADS_imp_1_OUT part 2/2. Populate

INSERT INTO "TMP_20180417042059_8DMOEB_ADS_imp_1_OUT" ("KEY", imputer_output_2, imputer_output_3, imputer_output_4, imputer_output_5) SELECT "ADS_imp_1_OUT"."KEY", "ADS_imp_1_OUT".imputer_output_2, "ADS_imp_1_OUT".imputer_output_3, "ADS_imp_1_OUT".imputer_output_4, "ADS_imp_1_OUT".imputer_output_5 
FROM (SELECT "ADS"."KEY" AS "KEY", CASE WHEN ("ADS"."Feature_0" IS NULL) THEN 5.8474999999999975 ELSE "ADS"."Feature_0" END AS imputer_output_2, CASE WHEN ("ADS"."Feature_1" IS NULL) THEN 3.0366666666666657 ELSE "ADS"."Feature_1" END AS imputer_output_3, CASE WHEN ("ADS"."Feature_2" IS NULL) THEN 3.8450000000000006 ELSE "ADS"."Feature_2" END AS imputer_output_4, CASE WHEN ("ADS"."Feature_3" IS NULL) THEN 1.245 ELSE "ADS"."Feature_3" END AS imputer_output_5 
FROM iris AS "ADS") AS "ADS_imp_1_OUT"

-- Code For temporary table TMP_20180417042059_SAJ7UU_ADS_sca_2_OUT part 1/2. Create 


CREATE TEMPORARY TABLE "TMP_20180417042059_SAJ7UU_ADS_sca_2_OUT" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20180417042059_SAJ7UU_ADS_sca_2_OUT part 2/2. Populate

INSERT INTO "TMP_20180417042059_SAJ7UU_ADS_sca_2_OUT" ("KEY", scaler_output_2, scaler_output_3, scaler_output_4, scaler_output_5) SELECT "ADS_sca_2_OUT"."KEY", "ADS_sca_2_OUT".scaler_output_2, "ADS_sca_2_OUT".scaler_output_3, "ADS_sca_2_OUT".scaler_output_4, "ADS_sca_2_OUT".scaler_output_5 
...
FROM "TMP_20180417042059_8DMOEB_ADS_imp_1_OUT" AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT"

-- Code For temporary table TMP_20180417042059_Y2XC1Z_CalProb_B0 part 1/2. Create 


CREATE TEMPORARY TABLE "TMP_20180417042059_Y2XC1Z_CalProb_B0" (
	"KEY" BIGINT, 
	"Proba_0" FLOAT, 
	"Proba_1" FLOAT, 
	"Proba_2" FLOAT
...
-- Code For temporary table TMP_20180417042059_Y2XC1Z_CalProb_B0 part 2/2. Populate
...
FROM "TMP_20180417042059_SAJ7UU_ADS_sca_2_OUT" AS "ADS_sca_2_OUT"), 
"DT_node_data" AS 
...
FROM isotonic_cte_3)
 INSERT INTO "TMP_20180417042059_Y2XC1Z_CalProb_B0" ("KEY", "Proba_0", "Proba_1", "Proba_2") SELECT "CalProb_B0"."KEY", "CalProb_B0"."Proba_0", "CalProb_B0"."Proba_1", "CalProb_B0"."Proba_2" 
...
-- Code For temporary table TMP_20180417042059_XNVQI8_CalProb_Union part 1/2. Create 


CREATE TEMPORARY TABLE "TMP_20180417042059_XNVQI8_CalProb_Union" (
	"KEY" BIGINT, 
	"Proba_0" FLOAT, 
	"Proba_1" FLOAT, 
	"Proba_2" FLOAT
...
-- Code For temporary table TMP_20180417042059_XNVQI8_CalProb_Union part 2/2. Populate

INSERT INTO "TMP_20180417042059_XNVQI8_CalProb_Union" ("KEY", "Proba_0", "Proba_1", "Proba_2") SELECT "CalProb_Union"."KEY", "CalProb_Union"."Proba_0", "CalProb_Union"."Proba_1", "CalProb_Union"."Proba_2" 
...
FROM "TMP_20180417042059_Y2XC1Z_CalProb_B0" AS "CalProb_B0") AS "CalProb_EnsembleUnion") AS "CalProb_Union"

-- Code For temporary table TMP_20180417042059_G7C7MF_CalProb_avg part 1/2. Create 


CREATE TEMPORARY TABLE "TMP_20180417042059_G7C7MF_CalProb_avg" (
	"KEY" BIGINT NOT NULL, 
	"Proba_0" FLOAT, 
	"Proba_1" FLOAT, 
	"Proba_2" FLOAT, 
...
-- Code For temporary table TMP_20180417042059_G7C7MF_CalProb_avg part 2/2. Populate

INSERT INTO "TMP_20180417042059_G7C7MF_CalProb_avg" ("KEY", "Proba_0", "Proba_1", "Proba_2") SELECT "CalProb_avg"."KEY", "CalProb_avg"."Proba_0", "CalProb_avg"."Proba_1", "CalProb_avg"."Proba_2" 
...
FROM "TMP_20180417042059_XNVQI8_CalProb_Union" AS "CalProb_Union" GROUP BY "CalProb_Union"."KEY") AS "T") AS "CalProb_avg"
...
FROM "TMP_20180417042059_G7C7MF_CalProb_avg" AS "CalProb_avg"), 
