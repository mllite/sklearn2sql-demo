...
-- Code For temporary table 42059_I1S6NI_ADS_IMP_1_OUT part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE "42059_I1S6NI_ADS_IMP_1_OUT" (
...
-- Code For temporary table 42059_I1S6NI_ADS_IMP_1_OUT part 2/2. Populate

INSERT INTO "42059_I1S6NI_ADS_IMP_1_OUT" ("KEY", imputer_output_2, imputer_output_3, imputer_output_4, imputer_output_5) SELECT "U"."KEY", "U".imputer_output_2, "U".imputer_output_3, "U".imputer_output_4, "U".imputer_output_5 
...
-- Code For temporary table 42059_XMH1EH_ADS_SCA_2_OUT part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE "42059_XMH1EH_ADS_SCA_2_OUT" (
	"KEY" NUMBER(19) NOT NULL, 
...
-- Code For temporary table 42059_XMH1EH_ADS_SCA_2_OUT part 2/2. Populate

INSERT INTO "42059_XMH1EH_ADS_SCA_2_OUT" ("KEY", scaler_output_2, scaler_output_3, scaler_output_4, scaler_output_5) SELECT "U"."KEY", "U".scaler_output_2, "U".scaler_output_3, "U".scaler_output_4, "U".scaler_output_5 
...
FROM "42059_I1S6NI_ADS_IMP_1_OUT" "ADS_imp_1_OUT") "ADS_sca_2_OUT") "U"

-- Code For temporary table 17042100_V0R9OQ_CALPROB_B0 part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE "17042100_V0R9OQ_CALPROB_B0" (
	"KEY" NUMBER(19), 
...
-- Code For temporary table 17042100_V0R9OQ_CALPROB_B0 part 2/2. Populate

INSERT INTO "17042100_V0R9OQ_CALPROB_B0" ("KEY", "Proba_0", "Proba_1", "Proba_2") SELECT "U"."KEY", "U"."Proba_0", "U"."Proba_1", "U"."Proba_2" 
...
FROM "42059_XMH1EH_ADS_SCA_2_OUT" "ADS_sca_2_OUT"), 
"DT_node_data" AS 
...
-- Code For temporary table 42100_QHKXP4_CALPROB_UNION part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE "42100_QHKXP4_CALPROB_UNION" (
	"KEY" NUMBER(19), 
	"Proba_0" BINARY_DOUBLE, 
	"Proba_1" BINARY_DOUBLE, 
	"Proba_2" BINARY_DOUBLE
...
-- Code For temporary table 42100_QHKXP4_CALPROB_UNION part 2/2. Populate

INSERT INTO "42100_QHKXP4_CALPROB_UNION" ("KEY", "Proba_0", "Proba_1", "Proba_2") SELECT "U"."KEY", "U"."Proba_0", "U"."Proba_1", "U"."Proba_2" 
...
FROM "17042100_V0R9OQ_CALPROB_B0" "CalProb_B0") "CalProb_EnsembleUnion") "CalProb_Union") "U"

-- Code For temporary table 7042100_4IO0HS_CALPROB_AVG part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE "7042100_4IO0HS_CALPROB_AVG" (
	"KEY" NUMBER(19) NOT NULL, 
	"Proba_0" BINARY_DOUBLE, 
	"Proba_1" BINARY_DOUBLE, 
	"Proba_2" BINARY_DOUBLE, 
...
-- Code For temporary table 7042100_4IO0HS_CALPROB_AVG part 2/2. Populate

INSERT INTO "7042100_4IO0HS_CALPROB_AVG" ("KEY", "Proba_0", "Proba_1", "Proba_2") SELECT "U"."KEY", "U"."Proba_0", "U"."Proba_1", "U"."Proba_2" 
...
FROM "42100_QHKXP4_CALPROB_UNION" "CalProb_Union" GROUP BY "CalProb_Union"."KEY") "T") "CalProb_avg") "U"
...
FROM "7042100_4IO0HS_CALPROB_AVG" "CalProb_avg"), 
