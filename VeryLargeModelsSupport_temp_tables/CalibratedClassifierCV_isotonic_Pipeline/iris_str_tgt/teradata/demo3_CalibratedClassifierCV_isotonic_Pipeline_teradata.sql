...
-- Code For temporary table tmp_20180417050914_jd0q8o_ads_ part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180417050914_jd0q8o_ads_  (
	"KEY" BIGINT, 
...
-- Code For temporary table tmp_20180417050914_jd0q8o_ads_ part 2/2. Populate

INSERT INTO tmp_20180417050914_jd0q8o_ads_ ("KEY", imputer_output_2, imputer_output_3, imputer_output_4, imputer_output_5) SELECT "U"."KEY", "U".imputer_output_2, "U".imputer_output_3, "U".imputer_output_4, "U".imputer_output_5 
...
-- Code For temporary table tmp_20180417050914_ue6y1v_ads_ part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180417050914_ue6y1v_ads_  (
	"KEY" BIGINT, 
...
-- Code For temporary table tmp_20180417050914_ue6y1v_ads_ part 2/2. Populate

INSERT INTO tmp_20180417050914_ue6y1v_ads_ ("KEY", scaler_output_2, scaler_output_3, scaler_output_4, scaler_output_5) SELECT "U"."KEY", "U".scaler_output_2, "U".scaler_output_3, "U".scaler_output_4, "U".scaler_output_5 
...
FROM tmp_20180417050914_jd0q8o_ads_ AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT") AS "U"

-- Code For temporary table tmp_20180417050914_h86aos_calp part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180417050914_h86aos_calp  (
	"KEY" BIGINT, 
	"Proba_CLASS_0" FLOAT, 
	"Proba_CLASS_1" FLOAT, 
	"Proba_CLASS_2" FLOAT
...
-- Code For temporary table tmp_20180417050914_h86aos_calp part 2/2. Populate

INSERT INTO tmp_20180417050914_h86aos_calp ("KEY", "Proba_CLASS_0", "Proba_CLASS_1", "Proba_CLASS_2") SELECT "U"."KEY", "U"."Proba_CLASS_0", "U"."Proba_CLASS_1", "U"."Proba_CLASS_2" 
...
FROM tmp_20180417050914_ue6y1v_ads_ AS "ADS_sca_2_OUT"), 
"DT_node_data" AS 
...
FROM "DT_Output"), 
isotonic_cte_0 AS 
(SELECT "Calibrated_Model_0"."KEY" AS "KEY", CASE WHEN ("Calibrated_Model_0"."ScoreOrProba_CLASS_0" < 0.0) THEN 0.0 WHEN ("Calibrated_Model_0"."ScoreOrProba_CLASS_0" < 1.0) THEN ("Calibrated_Model_0"."ScoreOrProba_CLASS_0" - 0.0) * 1.0 + 0.0 ELSE 1.0 END AS "Proba_CLASS_0", CASE WHEN ("Calibrated_Model_0"."ScoreOrProba_CLASS_1" < 0.0) THEN 0.0 WHEN ("Calibrated_Model_0"."ScoreOrProba_CLASS_1" < 0.666666666666667) THEN ("Calibrated_Model_0"."ScoreOrProba_CLASS_1" - 0.0) * 1.425 + 0.0 WHEN ("Calibrated_Model_0"."ScoreOrProba_CLASS_1" < 1.0) THEN ("Calibrated_Model_0"."ScoreOrProba_CLASS_1" - 0.666666666666667) * 0.0 + 0.95 ELSE 0.95 END AS "Proba_CLASS_1", CASE WHEN ("Calibrated_Model_0"."ScoreOrProba_CLASS_2" < 0.0) THEN 0.025 WHEN ("Calibrated_Model_0"."ScoreOrProba_CLASS_2" < 0.333333333333333) THEN ("Calibrated_Model_0"."ScoreOrProba_CLASS_2" - 0.0) * 0.0 + 0.025 WHEN ("Calibrated_Model_0"."ScoreOrProba_CLASS_2" < 1.0) THEN ("Calibrated_Model_0"."ScoreOrProba_CLASS_2" - 0.333333333333333) * 1.4625 + 0.025 ELSE 1.0 END AS "Proba_CLASS_2" 
...
FROM "DT_Output_2"), 
isotonic_cte_2 AS 
(SELECT "Calibrated_Model_2"."KEY" AS "KEY", CASE WHEN ("Calibrated_Model_2"."ScoreOrProba_CLASS_0" < 0.0) THEN 0.0 WHEN ("Calibrated_Model_2"."ScoreOrProba_CLASS_0" < 1.0) THEN ("Calibrated_Model_2"."ScoreOrProba_CLASS_0" - 0.0) * 1.0 + 0.0 ELSE 1.0 END AS "Proba_CLASS_0", CASE WHEN ("Calibrated_Model_2"."ScoreOrProba_CLASS_1" < 0.0) THEN 0.090909090909091 WHEN ("Calibrated_Model_2"."ScoreOrProba_CLASS_1" < 1.0) THEN ("Calibrated_Model_2"."ScoreOrProba_CLASS_1" - 0.0) * 0.909090909090909 + 0.090909090909091 ELSE 1.0 END AS "Proba_CLASS_1", CASE WHEN ("Calibrated_Model_2"."ScoreOrProba_CLASS_2" < 0.0) THEN 0.0 WHEN ("Calibrated_Model_2"."ScoreOrProba_CLASS_2" < 1.0) THEN ("Calibrated_Model_2"."ScoreOrProba_CLASS_2" - 0.0) * 0.846153846153846 + 0.0 ELSE 0.846153846153846 END AS "Proba_CLASS_2" 
...
-- Code For temporary table tmp_20180417050914_6ykvfo_calp part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180417050914_6ykvfo_calp  (
	"KEY" BIGINT, 
	"Proba_CLASS_0" FLOAT, 
	"Proba_CLASS_1" FLOAT, 
	"Proba_CLASS_2" FLOAT
...
-- Code For temporary table tmp_20180417050914_6ykvfo_calp part 2/2. Populate

INSERT INTO tmp_20180417050914_6ykvfo_calp ("KEY", "Proba_CLASS_0", "Proba_CLASS_1", "Proba_CLASS_2") SELECT "U"."KEY", "U"."Proba_CLASS_0", "U"."Proba_CLASS_1", "U"."Proba_CLASS_2" 
...
FROM tmp_20180417050914_h86aos_calp AS "CalProb_B0") AS "CalProb_EnsembleUnion") AS "CalProb_Union") AS "U"

-- Code For temporary table tmp_20180417050914_kgbapo_calp part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180417050914_kgbapo_calp  (
	"KEY" BIGINT, 
	"Proba_CLASS_0" FLOAT, 
	"Proba_CLASS_1" FLOAT, 
	"Proba_CLASS_2" FLOAT
...
-- Code For temporary table tmp_20180417050914_kgbapo_calp part 2/2. Populate

INSERT INTO tmp_20180417050914_kgbapo_calp ("KEY", "Proba_CLASS_0", "Proba_CLASS_1", "Proba_CLASS_2") SELECT "U"."KEY", "U"."Proba_CLASS_0", "U"."Proba_CLASS_1", "U"."Proba_CLASS_2" 
...
FROM tmp_20180417050914_6ykvfo_calp AS "CalProb_Union" GROUP BY "CalProb_Union"."KEY") AS "T") AS "CalProb_avg") AS "U"
...
FROM tmp_20180417050914_kgbapo_calp AS "CalProb_avg"), 
