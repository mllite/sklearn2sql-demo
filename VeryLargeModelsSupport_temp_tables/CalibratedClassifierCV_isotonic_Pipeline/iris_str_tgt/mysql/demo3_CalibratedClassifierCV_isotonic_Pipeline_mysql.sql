...
-- Code For temporary table TMP_20180417050913_IHSG2C_ADS_imp_1_OUT part 1/2. Create 


CREATE TEMPORARY TABLE `TMP_20180417050913_IHSG2C_ADS_imp_1_OUT` (
	`KEY` BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20180417050913_IHSG2C_ADS_imp_1_OUT part 2/2. Populate

INSERT INTO `TMP_20180417050913_IHSG2C_ADS_imp_1_OUT` (`KEY`, imputer_output_2, imputer_output_3, imputer_output_4, imputer_output_5) SELECT `U`.`KEY`, `U`.imputer_output_2, `U`.imputer_output_3, `U`.imputer_output_4, `U`.imputer_output_5 
...
-- Code For temporary table TMP_20180417050913_G2HAWI_ADS_sca_2_OUT part 1/2. Create 


CREATE TEMPORARY TABLE `TMP_20180417050913_G2HAWI_ADS_sca_2_OUT` (
	`KEY` BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20180417050913_G2HAWI_ADS_sca_2_OUT part 2/2. Populate

INSERT INTO `TMP_20180417050913_G2HAWI_ADS_sca_2_OUT` (`KEY`, scaler_output_2, scaler_output_3, scaler_output_4, scaler_output_5) SELECT `U`.`KEY`, `U`.scaler_output_2, `U`.scaler_output_3, `U`.scaler_output_4, `U`.scaler_output_5 
...
FROM `TMP_20180417050913_IHSG2C_ADS_imp_1_OUT` AS `ADS_imp_1_OUT`) AS `ADS_sca_2_OUT`) AS `U`

-- Code For temporary table TMP_20180417050913_F3LBW9_CalProb_B0 part 1/2. Create 


CREATE TEMPORARY TABLE `TMP_20180417050913_F3LBW9_CalProb_B0` (
	`KEY` BIGINT, 
...
-- Code For temporary table TMP_20180417050913_F3LBW9_CalProb_B0 part 2/2. Populate

INSERT INTO `TMP_20180417050913_F3LBW9_CalProb_B0` (`KEY`, `Proba_CLASS_0`, `Proba_CLASS_1`, `Proba_CLASS_2`) SELECT `U`.`KEY`, `U`.`Proba_CLASS_0`, `U`.`Proba_CLASS_1`, `U`.`Proba_CLASS_2` 
...
FROM `TMP_20180417050913_G2HAWI_ADS_sca_2_OUT` AS `ADS_sca_2_OUT`), 
`DT_node_data` AS 
...
-- Code For temporary table TMP_20180417050913_JCZLSH_CalProb_Union part 1/2. Create 


CREATE TEMPORARY TABLE `TMP_20180417050913_JCZLSH_CalProb_Union` (
	`KEY` BIGINT, 
	`Proba_CLASS_0` DOUBLE, 
	`Proba_CLASS_1` DOUBLE, 
	`Proba_CLASS_2` DOUBLE
...
-- Code For temporary table TMP_20180417050913_JCZLSH_CalProb_Union part 2/2. Populate

INSERT INTO `TMP_20180417050913_JCZLSH_CalProb_Union` (`KEY`, `Proba_CLASS_0`, `Proba_CLASS_1`, `Proba_CLASS_2`) SELECT `U`.`KEY`, `U`.`Proba_CLASS_0`, `U`.`Proba_CLASS_1`, `U`.`Proba_CLASS_2` 
...
FROM `TMP_20180417050913_F3LBW9_CalProb_B0` AS `CalProb_B0`) AS `CalProb_EnsembleUnion`) AS `CalProb_Union`) AS `U`

-- Code For temporary table TMP_20180417050913_S0JD25_CalProb_avg part 1/2. Create 


CREATE TEMPORARY TABLE `TMP_20180417050913_S0JD25_CalProb_avg` (
	`KEY` BIGINT NOT NULL, 
	`Proba_CLASS_0` DOUBLE, 
	`Proba_CLASS_1` DOUBLE, 
	`Proba_CLASS_2` DOUBLE, 
...
-- Code For temporary table TMP_20180417050913_S0JD25_CalProb_avg part 2/2. Populate

INSERT INTO `TMP_20180417050913_S0JD25_CalProb_avg` (`KEY`, `Proba_CLASS_0`, `Proba_CLASS_1`, `Proba_CLASS_2`) SELECT `U`.`KEY`, `U`.`Proba_CLASS_0`, `U`.`Proba_CLASS_1`, `U`.`Proba_CLASS_2` 
...
FROM `TMP_20180417050913_JCZLSH_CalProb_Union` AS `CalProb_Union` GROUP BY `CalProb_Union`.`KEY`) AS `T`) AS `CalProb_avg`) AS `U`
...
FROM `TMP_20180417050913_S0JD25_CalProb_avg` AS `CalProb_avg`), 
