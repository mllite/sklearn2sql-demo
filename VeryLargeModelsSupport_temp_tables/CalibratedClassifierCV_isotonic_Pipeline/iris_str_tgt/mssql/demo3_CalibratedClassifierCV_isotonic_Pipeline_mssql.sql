...
-- Code For temporary table ##TMP_20180417050913_I1F302_ADS_imp_1_OUT part 1/2. Create 


CREATE TABLE ##TMP_20180417050913_I1F302_ADS_imp_1_OUT (
	[KEY] BIGINT NULL, 
...
-- Code For temporary table ##TMP_20180417050913_I1F302_ADS_imp_1_OUT part 2/2. Populate

INSERT INTO ##TMP_20180417050913_I1F302_ADS_imp_1_OUT ([KEY], imputer_output_2, imputer_output_3, imputer_output_4, imputer_output_5) SELECT [ADS_imp_1_OUT].[KEY], [ADS_imp_1_OUT].imputer_output_2, [ADS_imp_1_OUT].imputer_output_3, [ADS_imp_1_OUT].imputer_output_4, [ADS_imp_1_OUT].imputer_output_5 
...
-- Code For temporary table ##TMP_20180417050913_JTDG09_ADS_sca_2_OUT part 1/2. Create 


CREATE TABLE ##TMP_20180417050913_JTDG09_ADS_sca_2_OUT (
	[KEY] BIGINT NULL, 
...
-- Code For temporary table ##TMP_20180417050913_JTDG09_ADS_sca_2_OUT part 2/2. Populate

INSERT INTO ##TMP_20180417050913_JTDG09_ADS_sca_2_OUT ([KEY], scaler_output_2, scaler_output_3, scaler_output_4, scaler_output_5) SELECT [ADS_sca_2_OUT].[KEY], [ADS_sca_2_OUT].scaler_output_2, [ADS_sca_2_OUT].scaler_output_3, [ADS_sca_2_OUT].scaler_output_4, [ADS_sca_2_OUT].scaler_output_5 
...
FROM ##TMP_20180417050913_I1F302_ADS_imp_1_OUT AS [ADS_imp_1_OUT]) AS [ADS_sca_2_OUT]

-- Code For temporary table ##TMP_20180417050914_O6T33S_CalProb_B0 part 1/2. Create 


CREATE TABLE ##TMP_20180417050914_O6T33S_CalProb_B0 (
	[KEY] BIGINT NULL, 
...
-- Code For temporary table ##TMP_20180417050914_O6T33S_CalProb_B0 part 2/2. Populate
...
FROM ##TMP_20180417050913_JTDG09_ADS_sca_2_OUT AS [ADS_sca_2_OUT]), 
[DT_node_data] AS 
...
[DT_node_data_1] AS 
(SELECT [Values].node_id AS node_id, CAST([Values].feature AS FLOAT(53)) AS feature, CAST([Values].threshold AS FLOAT(53)) AS threshold, CAST([Values].count AS FLOAT(53)) AS count, CAST([Values].depth AS FLOAT(53)) AS depth, CAST([Values].parent_id AS FLOAT(53)) AS parent_id, CAST([Values].[Proba_CLASS_0] AS FLOAT(53)) AS [Proba_CLASS_0], CAST([Values].[LogProba_CLASS_0] AS FLOAT(53)) AS [LogProba_CLASS_0], CAST([Values].[Proba_CLASS_1] AS FLOAT(53)) AS [Proba_CLASS_1], CAST([Values].[LogProba_CLASS_1] AS FLOAT(53)) AS [LogProba_CLASS_1], CAST([Values].[Proba_CLASS_2] AS FLOAT(53)) AS [Proba_CLASS_2], CAST([Values].[LogProba_CLASS_2] AS FLOAT(53)) AS [LogProba_CLASS_2], CAST([Values].[Decision] AS FLOAT(53)) AS [Decision], CAST([Values].[DecisionProba] AS FLOAT(53)) AS [DecisionProba] 
FROM (SELECT 1 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 28 AS count, 1 AS depth, 0 AS parent_id, 1.0 AS [Proba_CLASS_0], 0.0 AS [LogProba_CLASS_0], 0.0 AS [Proba_CLASS_1], -1.79769313486231e+308 AS [LogProba_CLASS_1], 0.0 AS [Proba_CLASS_2], -1.79769313486231e+308 AS [LogProba_CLASS_2], 'CLASS_0' AS [Decision], 1.0 AS [DecisionProba] UNION ALL SELECT 4 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 28 AS count, 3 AS depth, 3 AS parent_id, 0.0 AS [Proba_CLASS_0], -1.79769313486231e+308 AS [LogProba_CLASS_0], 1.0 AS [Proba_CLASS_1], 0.0 AS [LogProba_CLASS_1], 0.0 AS [Proba_CLASS_2], -1.79769313486231e+308 AS [LogProba_CLASS_2], 'CLASS_1' AS [Decision], 1.0 AS [DecisionProba] UNION ALL SELECT 6 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 4 AS count, 4 AS depth, 5 AS parent_id, 0.0 AS [Proba_CLASS_0], -1.79769313486231e+308 AS [LogProba_CLASS_0], 0.0 AS [Proba_CLASS_1], -1.79769313486231e+308 AS [LogProba_CLASS_1], 1.0 AS [Proba_CLASS_2], 0.0 AS [LogProba_CLASS_2], 'CLASS_2' AS [Decision], 1.0 AS [DecisionProba] UNION ALL SELECT 7 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 1 AS count, 4 AS depth, 5 AS parent_id, 0.0 AS [Proba_CLASS_0], -1.79769313486231e+308 AS [LogProba_CLASS_0], 1.0 AS [Proba_CLASS_1], 0.0 AS [LogProba_CLASS_1], 0.0 AS [Proba_CLASS_2], -1.79769313486231e+308 AS [LogProba_CLASS_2], 'CLASS_1' AS [Decision], 1.0 AS [DecisionProba] UNION ALL SELECT 10 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 2 AS count, 4 AS depth, 9 AS parent_id, 0.0 AS [Proba_CLASS_0], -1.79769313486231e+308 AS [LogProba_CLASS_0], 0.0 AS [Proba_CLASS_1], -1.79769313486231e+308 AS [LogProba_CLASS_1], 1.0 AS [Proba_CLASS_2], 0.0 AS [LogProba_CLASS_2], 'CLASS_2' AS [Decision], 1.0 AS [DecisionProba] UNION ALL SELECT 11 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 1 AS count, 4 AS depth, 9 AS parent_id, 0.0 AS [Proba_CLASS_0], -1.79769313486231e+308 AS [LogProba_CLASS_0], 1.0 AS [Proba_CLASS_1], 0.0 AS [LogProba_CLASS_1], 0.0 AS [Proba_CLASS_2], -1.79769313486231e+308 AS [LogProba_CLASS_2], 'CLASS_1' AS [Decision], 1.0 AS [DecisionProba] UNION ALL SELECT 12 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 26 AS count, 3 AS depth, 8 AS parent_id, 0.0 AS [Proba_CLASS_0], -1.79769313486231e+308 AS [LogProba_CLASS_0], 0.0 AS [Proba_CLASS_1], -1.79769313486231e+308 AS [LogProba_CLASS_1], 1.0 AS [Proba_CLASS_2], 0.0 AS [LogProba_CLASS_2], 'CLASS_2' AS [Decision], 1.0 AS [DecisionProba]) AS [Values]), 
[DT_Output_1] AS 
...
[DT_node_data_2] AS 
(SELECT [Values].node_id AS node_id, CAST([Values].feature AS FLOAT(53)) AS feature, CAST([Values].threshold AS FLOAT(53)) AS threshold, CAST([Values].count AS FLOAT(53)) AS count, CAST([Values].depth AS FLOAT(53)) AS depth, CAST([Values].parent_id AS FLOAT(53)) AS parent_id, CAST([Values].[Proba_CLASS_0] AS FLOAT(53)) AS [Proba_CLASS_0], CAST([Values].[LogProba_CLASS_0] AS FLOAT(53)) AS [LogProba_CLASS_0], CAST([Values].[Proba_CLASS_1] AS FLOAT(53)) AS [Proba_CLASS_1], CAST([Values].[LogProba_CLASS_1] AS FLOAT(53)) AS [LogProba_CLASS_1], CAST([Values].[Proba_CLASS_2] AS FLOAT(53)) AS [Proba_CLASS_2], CAST([Values].[LogProba_CLASS_2] AS FLOAT(53)) AS [LogProba_CLASS_2], CAST([Values].[Decision] AS FLOAT(53)) AS [Decision], CAST([Values].[DecisionProba] AS FLOAT(53)) AS [DecisionProba] 
FROM (SELECT 1 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 28 AS count, 1 AS depth, 0 AS parent_id, 1.0 AS [Proba_CLASS_0], 0.0 AS [LogProba_CLASS_0], 0.0 AS [Proba_CLASS_1], -1.79769313486231e+308 AS [LogProba_CLASS_1], 0.0 AS [Proba_CLASS_2], -1.79769313486231e+308 AS [LogProba_CLASS_2], 'CLASS_0' AS [Decision], 1.0 AS [DecisionProba] UNION ALL SELECT 5 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 1 AS count, 4 AS depth, 4 AS parent_id, 0.0 AS [Proba_CLASS_0], -1.79769313486231e+308 AS [LogProba_CLASS_0], 0.0 AS [Proba_CLASS_1], -1.79769313486231e+308 AS [LogProba_CLASS_1], 1.0 AS [Proba_CLASS_2], 0.0 AS [LogProba_CLASS_2], 'CLASS_2' AS [Decision], 1.0 AS [DecisionProba] UNION ALL SELECT 6 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 29 AS count, 4 AS depth, 4 AS parent_id, 0.0 AS [Proba_CLASS_0], -1.79769313486231e+308 AS [LogProba_CLASS_0], 1.0 AS [Proba_CLASS_1], 0.0 AS [LogProba_CLASS_1], 0.0 AS [Proba_CLASS_2], -1.79769313486231e+308 AS [LogProba_CLASS_2], 'CLASS_1' AS [Decision], 1.0 AS [DecisionProba] UNION ALL SELECT 8 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 2 AS count, 4 AS depth, 7 AS parent_id, 0.0 AS [Proba_CLASS_0], -1.79769313486231e+308 AS [LogProba_CLASS_0], 0.0 AS [Proba_CLASS_1], -1.79769313486231e+308 AS [LogProba_CLASS_1], 1.0 AS [Proba_CLASS_2], 0.0 AS [LogProba_CLASS_2], 'CLASS_2' AS [Decision], 1.0 AS [DecisionProba] UNION ALL SELECT 9 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 1 AS count, 4 AS depth, 7 AS parent_id, 0.0 AS [Proba_CLASS_0], -1.79769313486231e+308 AS [LogProba_CLASS_0], 1.0 AS [Proba_CLASS_1], 0.0 AS [LogProba_CLASS_1], 0.0 AS [Proba_CLASS_2], -1.79769313486231e+308 AS [LogProba_CLASS_2], 'CLASS_1' AS [Decision], 1.0 AS [DecisionProba] UNION ALL SELECT 10 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 29 AS count, 2 AS depth, 2 AS parent_id, 0.0 AS [Proba_CLASS_0], -1.79769313486231e+308 AS [LogProba_CLASS_0], 0.0 AS [Proba_CLASS_1], -1.79769313486231e+308 AS [LogProba_CLASS_1], 1.0 AS [Proba_CLASS_2], 0.0 AS [LogProba_CLASS_2], 'CLASS_2' AS [Decision], 1.0 AS [DecisionProba]) AS [Values]), 
[DT_Output_2] AS 
...
[DT_node_data_3] AS 
(SELECT [Values].node_id AS node_id, CAST([Values].feature AS FLOAT(53)) AS feature, CAST([Values].threshold AS FLOAT(53)) AS threshold, CAST([Values].count AS FLOAT(53)) AS count, CAST([Values].depth AS FLOAT(53)) AS depth, CAST([Values].parent_id AS FLOAT(53)) AS parent_id, CAST([Values].[Proba_CLASS_0] AS FLOAT(53)) AS [Proba_CLASS_0], CAST([Values].[LogProba_CLASS_0] AS FLOAT(53)) AS [LogProba_CLASS_0], CAST([Values].[Proba_CLASS_1] AS FLOAT(53)) AS [Proba_CLASS_1], CAST([Values].[LogProba_CLASS_1] AS FLOAT(53)) AS [LogProba_CLASS_1], CAST([Values].[Proba_CLASS_2] AS FLOAT(53)) AS [Proba_CLASS_2], CAST([Values].[LogProba_CLASS_2] AS FLOAT(53)) AS [LogProba_CLASS_2], CAST([Values].[Decision] AS FLOAT(53)) AS [Decision], CAST([Values].[DecisionProba] AS FLOAT(53)) AS [DecisionProba] 
FROM (SELECT 1 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 28 AS count, 1 AS depth, 0 AS parent_id, 1.0 AS [Proba_CLASS_0], 0.0 AS [LogProba_CLASS_0], 0.0 AS [Proba_CLASS_1], -1.79769313486231e+308 AS [LogProba_CLASS_1], 0.0 AS [Proba_CLASS_2], -1.79769313486231e+308 AS [LogProba_CLASS_2], 'CLASS_0' AS [Decision], 1.0 AS [DecisionProba] UNION ALL SELECT 4 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 28 AS count, 3 AS depth, 3 AS parent_id, 0.0 AS [Proba_CLASS_0], -1.79769313486231e+308 AS [LogProba_CLASS_0], 1.0 AS [Proba_CLASS_1], 0.0 AS [LogProba_CLASS_1], 0.0 AS [Proba_CLASS_2], -1.79769313486231e+308 AS [LogProba_CLASS_2], 'CLASS_1' AS [Decision], 1.0 AS [DecisionProba] UNION ALL SELECT 6 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 2 AS count, 4 AS depth, 5 AS parent_id, 0.0 AS [Proba_CLASS_0], -1.79769313486231e+308 AS [LogProba_CLASS_0], 0.0 AS [Proba_CLASS_1], -1.79769313486231e+308 AS [LogProba_CLASS_1], 1.0 AS [Proba_CLASS_2], 0.0 AS [LogProba_CLASS_2], 'CLASS_2' AS [Decision], 1.0 AS [DecisionProba] UNION ALL SELECT 7 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 1 AS count, 4 AS depth, 5 AS parent_id, 0.0 AS [Proba_CLASS_0], -1.79769313486231e+308 AS [LogProba_CLASS_0], 1.0 AS [Proba_CLASS_1], 0.0 AS [LogProba_CLASS_1], 0.0 AS [Proba_CLASS_2], -1.79769313486231e+308 AS [LogProba_CLASS_2], 'CLASS_1' AS [Decision], 1.0 AS [DecisionProba] UNION ALL SELECT 10 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 1 AS count, 4 AS depth, 9 AS parent_id, 0.0 AS [Proba_CLASS_0], -1.79769313486231e+308 AS [LogProba_CLASS_0], 1.0 AS [Proba_CLASS_1], 0.0 AS [LogProba_CLASS_1], 0.0 AS [Proba_CLASS_2], -1.79769313486231e+308 AS [LogProba_CLASS_2], 'CLASS_1' AS [Decision], 1.0 AS [DecisionProba] UNION ALL SELECT 11 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 2 AS count, 4 AS depth, 9 AS parent_id, 0.0 AS [Proba_CLASS_0], -1.79769313486231e+308 AS [LogProba_CLASS_0], 0.0 AS [Proba_CLASS_1], -1.79769313486231e+308 AS [LogProba_CLASS_1], 1.0 AS [Proba_CLASS_2], 0.0 AS [LogProba_CLASS_2], 'CLASS_2' AS [Decision], 1.0 AS [DecisionProba] UNION ALL SELECT 12 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 29 AS count, 3 AS depth, 8 AS parent_id, 0.0 AS [Proba_CLASS_0], -1.79769313486231e+308 AS [LogProba_CLASS_0], 0.0 AS [Proba_CLASS_1], -1.79769313486231e+308 AS [LogProba_CLASS_1], 1.0 AS [Proba_CLASS_2], 0.0 AS [LogProba_CLASS_2], 'CLASS_2' AS [Decision], 1.0 AS [DecisionProba]) AS [Values]), 
[DT_Output_3] AS 
...
FROM isotonic_cte_3)
 INSERT INTO ##TMP_20180417050914_O6T33S_CalProb_B0 ([KEY], [Proba_CLASS_0], [Proba_CLASS_1], [Proba_CLASS_2]) SELECT [CalProb_B0].[KEY], [CalProb_B0].[Proba_CLASS_0], [CalProb_B0].[Proba_CLASS_1], [CalProb_B0].[Proba_CLASS_2] 
...
-- Code For temporary table ##TMP_20180417050914_UECQMF_CalProb_Union part 1/2. Create 


CREATE TABLE ##TMP_20180417050914_UECQMF_CalProb_Union (
	[KEY] BIGINT NULL, 
	[Proba_CLASS_0] FLOAT NULL, 
	[Proba_CLASS_1] FLOAT NULL, 
	[Proba_CLASS_2] FLOAT NULL
...
-- Code For temporary table ##TMP_20180417050914_UECQMF_CalProb_Union part 2/2. Populate

INSERT INTO ##TMP_20180417050914_UECQMF_CalProb_Union ([KEY], [Proba_CLASS_0], [Proba_CLASS_1], [Proba_CLASS_2]) SELECT [CalProb_Union].[KEY], [CalProb_Union].[Proba_CLASS_0], [CalProb_Union].[Proba_CLASS_1], [CalProb_Union].[Proba_CLASS_2] 
...
FROM ##TMP_20180417050914_O6T33S_CalProb_B0 AS [CalProb_B0]) AS [CalProb_EnsembleUnion]) AS [CalProb_Union]

-- Code For temporary table ##TMP_20180417050914_FXPWSH_CalProb_avg part 1/2. Create 


CREATE TABLE ##TMP_20180417050914_FXPWSH_CalProb_avg (
	[KEY] BIGINT NULL, 
...
-- Code For temporary table ##TMP_20180417050914_FXPWSH_CalProb_avg part 2/2. Populate

INSERT INTO ##TMP_20180417050914_FXPWSH_CalProb_avg ([KEY], [Proba_CLASS_0], [Proba_CLASS_1], [Proba_CLASS_2]) SELECT [CalProb_avg].[KEY], [CalProb_avg].[Proba_CLASS_0], [CalProb_avg].[Proba_CLASS_1], [CalProb_avg].[Proba_CLASS_2] 
...
FROM ##TMP_20180417050914_UECQMF_CalProb_Union AS [CalProb_Union] GROUP BY [CalProb_Union].[KEY]) AS [T]) AS [CalProb_avg]
...
FROM ##TMP_20180417050914_FXPWSH_CalProb_avg AS [CalProb_avg]), 
