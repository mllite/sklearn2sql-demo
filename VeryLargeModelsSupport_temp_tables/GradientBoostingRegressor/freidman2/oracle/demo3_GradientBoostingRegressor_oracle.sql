...
-- Code For temporary table 0180417040429_9CYMTP_GB_B0 part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE "0180417040429_9CYMTP_GB_B0" (
	"KEY" NUMBER(19), 
...
-- Code For temporary table 0180417040429_9CYMTP_GB_B0 part 2/2. Populate

INSERT INTO "0180417040429_9CYMTP_GB_B0" ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
-- Code For temporary table 0180417040429_7N1Z9J_GB_B1 part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE "0180417040429_7N1Z9J_GB_B1" (
	"KEY" NUMBER(19), 
	"Estimator" BINARY_DOUBLE
)
...
-- Code For temporary table 0180417040429_7N1Z9J_GB_B1 part 2/2. Populate

INSERT INTO "0180417040429_7N1Z9J_GB_B1" ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
-- Code For temporary table 0417040429_J9DJBO_GB_UNION part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE "0417040429_J9DJBO_GB_UNION" (
	"KEY" NUMBER(19), 
	"Estimator" BINARY_DOUBLE
)
...
-- Code For temporary table 0417040429_J9DJBO_GB_UNION part 2/2. Populate

INSERT INTO "0417040429_J9DJBO_GB_UNION" ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
FROM "0180417040429_9CYMTP_GB_B0" "GB_B0" UNION ALL SELECT "GB_B1"."KEY" AS "KEY", "GB_B1"."Estimator" AS "Estimator" 
FROM "0180417040429_7N1Z9J_GB_B1" "GB_B1") "GB_EnsembleUnion") "GB_Union") "U"

-- Code For temporary table 180417040429_GULM9T_GB_SUM part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE "180417040429_GULM9T_GB_SUM" (
...
-- Code For temporary table 180417040429_GULM9T_GB_SUM part 2/2. Populate

INSERT INTO "180417040429_GULM9T_GB_SUM" ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
FROM "0417040429_J9DJBO_GB_UNION" "GB_Union" GROUP BY "GB_Union"."KEY") "T") "GB_sum") "U"

-- Model deployment code

SELECT "GB_sum"."KEY" AS "KEY", 499.09288446517394 + 0.1 * "GB_sum"."Estimator" AS "Estimator" 
FROM "180417040429_GULM9T_GB_SUM" "GB_sum"