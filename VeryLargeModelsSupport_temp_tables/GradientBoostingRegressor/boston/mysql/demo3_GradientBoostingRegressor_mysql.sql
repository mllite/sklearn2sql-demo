...
-- Code For temporary table TMP_20180417023557_NZ8RH5_GB_B0 part 1/2. Create 


CREATE TEMPORARY TABLE `TMP_20180417023557_NZ8RH5_GB_B0` (
	`KEY` BIGINT, 
	`Estimator` DOUBLE
)
...
-- Code For temporary table TMP_20180417023557_NZ8RH5_GB_B0 part 2/2. Populate

INSERT INTO `TMP_20180417023557_NZ8RH5_GB_B0` (`KEY`, `Estimator`) SELECT `U`.`KEY`, `U`.`Estimator` 
...
-- Code For temporary table TMP_20180417023557_9VC0F2_GB_B1 part 1/2. Create 


CREATE TEMPORARY TABLE `TMP_20180417023557_9VC0F2_GB_B1` (
	`KEY` BIGINT, 
	`Estimator` DOUBLE
)
...
-- Code For temporary table TMP_20180417023557_9VC0F2_GB_B1 part 2/2. Populate

INSERT INTO `TMP_20180417023557_9VC0F2_GB_B1` (`KEY`, `Estimator`) SELECT `U`.`KEY`, `U`.`Estimator` 
...
-- Code For temporary table TMP_20180417023557_5DYNAG_GB_Union part 1/2. Create 


CREATE TEMPORARY TABLE `TMP_20180417023557_5DYNAG_GB_Union` (
	`KEY` BIGINT, 
	`Estimator` DOUBLE
)
...
-- Code For temporary table TMP_20180417023557_5DYNAG_GB_Union part 2/2. Populate

INSERT INTO `TMP_20180417023557_5DYNAG_GB_Union` (`KEY`, `Estimator`) SELECT `U`.`KEY`, `U`.`Estimator` 
...
FROM `TMP_20180417023557_NZ8RH5_GB_B0` AS `GB_B0` UNION ALL SELECT `GB_B1`.`KEY` AS `KEY`, `GB_B1`.`Estimator` AS `Estimator` 
FROM `TMP_20180417023557_9VC0F2_GB_B1` AS `GB_B1`) AS `GB_EnsembleUnion`) AS `GB_Union`) AS `U`

-- Code For temporary table TMP_20180417023557_K4JBWN_GB_sum part 1/2. Create 


CREATE TEMPORARY TABLE `TMP_20180417023557_K4JBWN_GB_sum` (
	`KEY` BIGINT NOT NULL, 
	`Estimator` DOUBLE, 
	PRIMARY KEY (`KEY`)
)
...
-- Code For temporary table TMP_20180417023557_K4JBWN_GB_sum part 2/2. Populate

INSERT INTO `TMP_20180417023557_K4JBWN_GB_sum` (`KEY`, `Estimator`) SELECT `U`.`KEY`, `U`.`Estimator` 
...
FROM `TMP_20180417023557_5DYNAG_GB_Union` AS `GB_Union` GROUP BY `GB_Union`.`KEY`) AS `T`) AS `GB_sum`) AS `U`

-- Model deployment code

SELECT `GB_sum`.`KEY` AS `KEY`, 22.5789603960396 + 0.1 * `GB_sum`.`Estimator` AS `Estimator` 
FROM `TMP_20180417023557_K4JBWN_GB_sum` AS `GB_sum`