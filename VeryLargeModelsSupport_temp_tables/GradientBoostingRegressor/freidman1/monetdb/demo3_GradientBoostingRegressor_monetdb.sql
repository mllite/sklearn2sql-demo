...
-- Code For temporary table tmp_20180417035110_5t4wia_gb_b0 part 1/2. Create 


CREATE TEMPORARY TABLE tmp_20180417035110_5t4wia_gb_b0 (
	"KEY" BIGINT, 
	"Estimator" FLOAT
)
...
-- Code For temporary table tmp_20180417035110_5t4wia_gb_b0 part 2/2. Populate

INSERT INTO tmp_20180417035110_5t4wia_gb_b0 ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
-- Code For temporary table tmp_20180417035110_0208tl_gb_b1 part 1/2. Create 


CREATE TEMPORARY TABLE tmp_20180417035110_0208tl_gb_b1 (
	"KEY" BIGINT, 
	"Estimator" FLOAT
)
...
-- Code For temporary table tmp_20180417035110_0208tl_gb_b1 part 2/2. Populate

INSERT INTO tmp_20180417035110_0208tl_gb_b1 ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
-- Code For temporary table tmp_20180417035110_uhxo0q_gb_union part 1/2. Create 


CREATE TEMPORARY TABLE tmp_20180417035110_uhxo0q_gb_union (
	"KEY" BIGINT, 
	"Estimator" FLOAT
)
...
-- Code For temporary table tmp_20180417035110_uhxo0q_gb_union part 2/2. Populate

INSERT INTO tmp_20180417035110_uhxo0q_gb_union ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
FROM tmp_20180417035110_5t4wia_gb_b0 AS "GB_B0" UNION ALL SELECT "GB_B1"."KEY" AS "KEY", "GB_B1"."Estimator" AS "Estimator" 
FROM tmp_20180417035110_0208tl_gb_b1 AS "GB_B1") AS "GB_EnsembleUnion") AS "GB_Union") AS "U"

-- Code For temporary table tmp_20180417035110_e4qx0q_gb_sum part 1/2. Create 


CREATE TEMPORARY TABLE tmp_20180417035110_e4qx0q_gb_sum (
	"KEY" BIGINT NOT NULL, 
	"Estimator" FLOAT, 
	PRIMARY KEY ("KEY")
)
...
-- Code For temporary table tmp_20180417035110_e4qx0q_gb_sum part 2/2. Populate

INSERT INTO tmp_20180417035110_e4qx0q_gb_sum ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
FROM tmp_20180417035110_uhxo0q_gb_union AS "GB_Union" GROUP BY "GB_Union"."KEY") AS "T") AS "GB_sum") AS "U"

-- Model deployment code

SELECT "GB_sum"."KEY" AS "KEY", 15.3537633818605 + 0.1 * "GB_sum"."Estimator" AS "Estimator" 
FROM tmp_20180417035110_e4qx0q_gb_sum AS "GB_sum"