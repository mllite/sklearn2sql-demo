...
-- Code For temporary table TMP_20180417012940_RCFL3F_GB_B0 part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180417012940_RCFL3F_GB_B0" (
	"KEY" BIGINT, 
	"Estimator" FLOAT
)
...
-- Code For temporary table TMP_20180417012940_RCFL3F_GB_B0 part 2/2. Populate

INSERT INTO "TMP_20180417012940_RCFL3F_GB_B0" ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
-- Code For temporary table TMP_20180417012940_GQHTGM_GB_B1 part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180417012940_GQHTGM_GB_B1" (
	"KEY" BIGINT, 
	"Estimator" FLOAT
)
...
-- Code For temporary table TMP_20180417012940_GQHTGM_GB_B1 part 2/2. Populate

INSERT INTO "TMP_20180417012940_GQHTGM_GB_B1" ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
-- Code For temporary table TMP_20180417012940_G3UX5M_GB_UN part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180417012940_G3UX5M_GB_UN" (
	"KEY" BIGINT, 
	"Estimator" FLOAT
)
...
-- Code For temporary table TMP_20180417012940_G3UX5M_GB_UN part 2/2. Populate

INSERT INTO "TMP_20180417012940_G3UX5M_GB_UN" ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
FROM "TMP_20180417012940_RCFL3F_GB_B0" AS "GB_B0" UNION ALL SELECT "GB_B1"."KEY" AS "KEY", "GB_B1"."Estimator" AS "Estimator" 
FROM "TMP_20180417012940_GQHTGM_GB_B1" AS "GB_B1") AS "GB_EnsembleUnion") AS "GB_Union") AS "U"

-- Code For temporary table TMP_20180417012940_XYC8DT_GB_SU part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180417012940_XYC8DT_GB_SU" (
	"KEY" BIGINT, 
	"Estimator" FLOAT
)
...
-- Code For temporary table TMP_20180417012940_XYC8DT_GB_SU part 2/2. Populate

INSERT INTO "TMP_20180417012940_XYC8DT_GB_SU" ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
FROM "TMP_20180417012940_G3UX5M_GB_UN" AS "GB_Union" GROUP BY "GB_Union"."KEY") AS "T") AS "GB_sum") AS "U"

-- Model deployment code

SELECT "GB_sum"."KEY" AS "KEY", -11.471614782695335 + 0.1 * "GB_sum"."Estimator" AS "Estimator" 
FROM "TMP_20180417012940_XYC8DT_GB_SU" AS "GB_sum"