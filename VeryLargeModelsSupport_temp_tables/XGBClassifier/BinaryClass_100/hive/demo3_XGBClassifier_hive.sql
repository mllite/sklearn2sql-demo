...
-- Code For temporary table tmp_20180416223456_0r13xw_xgb_b0 part 1/2. Create 

CREATE TEMPORARY TABLE `tmp_20180416223456_0r13xw_xgb_b0` STORED AS ORC AS WITH `DT_node_lookup` AS 
...
-- Code For temporary table tmp_20180416223456_0r13xw_xgb_b0 part 2/2. Populate

SELECT * FROM `tmp_20180416223456_0r13xw_xgb_b0`

-- Code For temporary table tmp_20180416223456_wyustw_xgb_b1 part 1/2. Create 

CREATE TEMPORARY TABLE `tmp_20180416223456_wyustw_xgb_b1` STORED AS ORC AS WITH `DT_node_lookup_10` AS 
(SELECT `ADS`.`KEY` AS `KEY`, 0 AS `node_id_2` 
FROM `BinaryClass_100` AS `ADS`), 
`DT_node_data_10` AS 
(SELECT `Values`.`node_id` AS `node_id`, CAST(`Values`.`feature` AS FLOAT) AS `feature`, CAST(`Values`.`threshold` AS FLOAT) AS `threshold`, CAST(`Values`.`depth` AS FLOAT) AS `depth`, CAST(`Values`.`parent_id` AS FLOAT) AS `parent_id`, CAST(`Values`.`Score` AS FLOAT) AS `Score` 
...
-- Code For temporary table tmp_20180416223456_wyustw_xgb_b1 part 2/2. Populate

SELECT * FROM `tmp_20180416223456_wyustw_xgb_b1`

-- Code For temporary table tmp_20180416223456_wzsgmd_xgb_union part 1/2. Create 

CREATE TEMPORARY TABLE `tmp_20180416223456_wzsgmd_xgb_union` STORED AS ORC AS SELECT `XGB_Union`.`KEY`, `XGB_Union`.`Score_0` 
...
FROM `tmp_20180416223456_0r13xw_xgb_b0` AS `XGB_B0` UNION ALL SELECT `XGB_B1`.`KEY` AS `KEY`, `XGB_B1`.`Score_0` AS `Score_0` 
FROM `tmp_20180416223456_wyustw_xgb_b1` AS `XGB_B1`) AS `XGB_EnsembleUnion`) AS `XGB_Union`

-- Code For temporary table tmp_20180416223456_wzsgmd_xgb_union part 2/2. Populate

SELECT * FROM `tmp_20180416223456_wzsgmd_xgb_union`

-- Code For temporary table tmp_20180416223456_nq7vjm_xgb_sum part 1/2. Create 

CREATE TEMPORARY TABLE `tmp_20180416223456_nq7vjm_xgb_sum` STORED AS ORC AS SELECT `XGB_sum`.`KEY`, `XGB_sum`.`Score_0` 
...
FROM `tmp_20180416223456_wzsgmd_xgb_union` AS `XGB_Union` GROUP BY `XGB_Union`.`KEY`) AS `T`) AS `XGB_sum`

-- Code For temporary table tmp_20180416223456_nq7vjm_xgb_sum part 2/2. Populate

SELECT * FROM `tmp_20180416223456_nq7vjm_xgb_sum`
...
FROM `tmp_20180416223456_nq7vjm_xgb_sum` AS `XGB_sum`), 
