...
-- Code For temporary table tmp_20180416223456_nzy239_xgb_ part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180416223456_nzy239_xgb_  (
	"KEY" BIGINT, 
	"Score_0" FLOAT
)
...
-- Code For temporary table tmp_20180416223456_nzy239_xgb_ part 2/2. Populate

INSERT INTO tmp_20180416223456_nzy239_xgb_ ("KEY", "Score_0") SELECT "U"."KEY", "U"."Score_0" 
FROM (WITH "DT_node_lookup" AS 
(SELECT "ADS"."KEY" AS "KEY", CASE WHEN ("ADS"."Feature_57" < -0.296593874692917) THEN 1 ELSE 2 END AS node_id_2 
...
-- Code For temporary table tmp_20180416223456_hmplro_xgb_ part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180416223456_hmplro_xgb_  (
	"KEY" BIGINT, 
	"Score_0" FLOAT
)
...
-- Code For temporary table tmp_20180416223456_hmplro_xgb_ part 2/2. Populate

INSERT INTO tmp_20180416223456_hmplro_xgb_ ("KEY", "Score_0") SELECT "U"."KEY", "U"."Score_0" 
...
-- Code For temporary table tmp_20180416223456_yksxct_xgb_ part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180416223456_yksxct_xgb_  (
	"KEY" BIGINT, 
	"Score_0" FLOAT
)
...
-- Code For temporary table tmp_20180416223456_yksxct_xgb_ part 2/2. Populate

INSERT INTO tmp_20180416223456_yksxct_xgb_ ("KEY", "Score_0") SELECT "U"."KEY", "U"."Score_0" 
...
FROM tmp_20180416223456_nzy239_xgb_ AS "XGB_B0" UNION ALL SELECT "XGB_B1"."KEY" AS "KEY", "XGB_B1"."Score_0" AS "Score_0" 
FROM tmp_20180416223456_hmplro_xgb_ AS "XGB_B1") AS "XGB_EnsembleUnion") AS "XGB_Union") AS "U"

-- Code For temporary table tmp_20180416223456_pkjkwz_xgb_ part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180416223456_pkjkwz_xgb_  (
	"KEY" BIGINT, 
	"Score_0" FLOAT
)
...
-- Code For temporary table tmp_20180416223456_pkjkwz_xgb_ part 2/2. Populate

INSERT INTO tmp_20180416223456_pkjkwz_xgb_ ("KEY", "Score_0") SELECT "U"."KEY", "U"."Score_0" 
...
FROM tmp_20180416223456_yksxct_xgb_ AS "XGB_Union" GROUP BY "XGB_Union"."KEY") AS "T") AS "XGB_sum") AS "U"
...
FROM tmp_20180416223456_pkjkwz_xgb_ AS "XGB_sum"), 
