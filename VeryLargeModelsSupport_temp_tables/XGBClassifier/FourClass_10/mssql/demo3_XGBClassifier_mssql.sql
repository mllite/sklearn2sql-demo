...
-- Code For temporary table ##TMP_20180416233349_CTEAMZ_XGB_B0 part 1/2. Create 


CREATE TABLE ##TMP_20180416233349_CTEAMZ_XGB_B0 (
	[KEY] BIGINT NULL, 
...
-- Code For temporary table ##TMP_20180416233349_CTEAMZ_XGB_B0 part 2/2. Populate
...
FROM [DT_Output_9])
 INSERT INTO ##TMP_20180416233349_CTEAMZ_XGB_B0 ([KEY], [Score_0], [Score_1], [Score_2], [Score_3]) SELECT [XGB_B0].[KEY], [XGB_B0].[Score_0], [XGB_B0].[Score_1], [XGB_B0].[Score_2], [XGB_B0].[Score_3] 
...
-- Code For temporary table ##TMP_20180416233349_59Q9KI_XGB_B1 part 1/2. Create 


CREATE TABLE ##TMP_20180416233349_59Q9KI_XGB_B1 (
	[KEY] BIGINT NULL, 
	[Score_0] FLOAT(53) NULL, 
	[Score_1] FLOAT(53) NULL, 
	[Score_2] FLOAT(53) NULL, 
...
-- Code For temporary table ##TMP_20180416233349_59Q9KI_XGB_B1 part 2/2. Populate
...
FROM [DT_Output_19])
 INSERT INTO ##TMP_20180416233349_59Q9KI_XGB_B1 ([KEY], [Score_0], [Score_1], [Score_2], [Score_3]) SELECT [XGB_B1].[KEY], [XGB_B1].[Score_0], [XGB_B1].[Score_1], [XGB_B1].[Score_2], [XGB_B1].[Score_3] 
...
-- Code For temporary table ##TMP_20180416233349_DY2X7J_XGB_B2 part 1/2. Create 


CREATE TABLE ##TMP_20180416233349_DY2X7J_XGB_B2 (
	[KEY] BIGINT NULL, 
	[Score_0] FLOAT(53) NULL, 
	[Score_1] FLOAT(53) NULL, 
	[Score_2] FLOAT(53) NULL, 
...
-- Code For temporary table ##TMP_20180416233349_DY2X7J_XGB_B2 part 2/2. Populate
...
FROM [DT_Output_29])
 INSERT INTO ##TMP_20180416233349_DY2X7J_XGB_B2 ([KEY], [Score_0], [Score_1], [Score_2], [Score_3]) SELECT [XGB_B2].[KEY], [XGB_B2].[Score_0], [XGB_B2].[Score_1], [XGB_B2].[Score_2], [XGB_B2].[Score_3] 
...
-- Code For temporary table ##TMP_20180416233349_460IDO_XGB_B3 part 1/2. Create 


CREATE TABLE ##TMP_20180416233349_460IDO_XGB_B3 (
	[KEY] BIGINT NULL, 
	[Score_0] FLOAT(53) NULL, 
	[Score_1] FLOAT(53) NULL, 
	[Score_2] FLOAT(53) NULL, 
...
-- Code For temporary table ##TMP_20180416233349_460IDO_XGB_B3 part 2/2. Populate
...
FROM [DT_Output_39])
 INSERT INTO ##TMP_20180416233349_460IDO_XGB_B3 ([KEY], [Score_0], [Score_1], [Score_2], [Score_3]) SELECT [XGB_B3].[KEY], [XGB_B3].[Score_0], [XGB_B3].[Score_1], [XGB_B3].[Score_2], [XGB_B3].[Score_3] 
...
-- Code For temporary table ##TMP_20180416233349_U3QJAT_XGB_B4 part 1/2. Create 


CREATE TABLE ##TMP_20180416233349_U3QJAT_XGB_B4 (
	[KEY] BIGINT NULL, 
	[Score_0] FLOAT(53) NULL, 
	[Score_1] FLOAT(53) NULL, 
	[Score_2] FLOAT(53) NULL, 
...
-- Code For temporary table ##TMP_20180416233349_U3QJAT_XGB_B4 part 2/2. Populate
...
FROM [DT_Output_49])
 INSERT INTO ##TMP_20180416233349_U3QJAT_XGB_B4 ([KEY], [Score_0], [Score_1], [Score_2], [Score_3]) SELECT [XGB_B4].[KEY], [XGB_B4].[Score_0], [XGB_B4].[Score_1], [XGB_B4].[Score_2], [XGB_B4].[Score_3] 
...
-- Code For temporary table ##TMP_20180416233349_PI60QK_XGB_B5 part 1/2. Create 


CREATE TABLE ##TMP_20180416233349_PI60QK_XGB_B5 (
	[KEY] BIGINT NULL, 
	[Score_0] FLOAT(53) NULL, 
	[Score_1] FLOAT(53) NULL, 
	[Score_2] FLOAT(53) NULL, 
...
-- Code For temporary table ##TMP_20180416233349_PI60QK_XGB_B5 part 2/2. Populate
...
FROM [DT_Output_59])
 INSERT INTO ##TMP_20180416233349_PI60QK_XGB_B5 ([KEY], [Score_0], [Score_1], [Score_2], [Score_3]) SELECT [XGB_B5].[KEY], [XGB_B5].[Score_0], [XGB_B5].[Score_1], [XGB_B5].[Score_2], [XGB_B5].[Score_3] 
...
-- Code For temporary table ##TMP_20180416233349_4AKM4X_XGB_B6 part 1/2. Create 


CREATE TABLE ##TMP_20180416233349_4AKM4X_XGB_B6 (
	[KEY] BIGINT NULL, 
	[Score_0] FLOAT(53) NULL, 
	[Score_1] FLOAT(53) NULL, 
	[Score_2] FLOAT(53) NULL, 
...
-- Code For temporary table ##TMP_20180416233349_4AKM4X_XGB_B6 part 2/2. Populate
...
FROM [DT_Output_63])
 INSERT INTO ##TMP_20180416233349_4AKM4X_XGB_B6 ([KEY], [Score_0], [Score_1], [Score_2], [Score_3]) SELECT [XGB_B6].[KEY], [XGB_B6].[Score_0], [XGB_B6].[Score_1], [XGB_B6].[Score_2], [XGB_B6].[Score_3] 
...
-- Code For temporary table ##TMP_20180416233349_3OBOD3_XGB_Union part 1/2. Create 


CREATE TABLE ##TMP_20180416233349_3OBOD3_XGB_Union (
	[KEY] BIGINT NULL, 
	[Score_0] FLOAT(53) NULL, 
	[Score_1] FLOAT(53) NULL, 
	[Score_2] FLOAT(53) NULL, 
...
-- Code For temporary table ##TMP_20180416233349_3OBOD3_XGB_Union part 2/2. Populate

INSERT INTO ##TMP_20180416233349_3OBOD3_XGB_Union ([KEY], [Score_0], [Score_1], [Score_2], [Score_3]) SELECT [XGB_Union].[KEY], [XGB_Union].[Score_0], [XGB_Union].[Score_1], [XGB_Union].[Score_2], [XGB_Union].[Score_3] 
...
FROM ##TMP_20180416233349_CTEAMZ_XGB_B0 AS [XGB_B0] UNION ALL SELECT [XGB_B1].[KEY] AS [KEY], [XGB_B1].[Score_0] AS [Score_0], [XGB_B1].[Score_1] AS [Score_1], [XGB_B1].[Score_2] AS [Score_2], [XGB_B1].[Score_3] AS [Score_3] 
FROM ##TMP_20180416233349_59Q9KI_XGB_B1 AS [XGB_B1] UNION ALL SELECT [XGB_B2].[KEY] AS [KEY], [XGB_B2].[Score_0] AS [Score_0], [XGB_B2].[Score_1] AS [Score_1], [XGB_B2].[Score_2] AS [Score_2], [XGB_B2].[Score_3] AS [Score_3] 
FROM ##TMP_20180416233349_DY2X7J_XGB_B2 AS [XGB_B2] UNION ALL SELECT [XGB_B3].[KEY] AS [KEY], [XGB_B3].[Score_0] AS [Score_0], [XGB_B3].[Score_1] AS [Score_1], [XGB_B3].[Score_2] AS [Score_2], [XGB_B3].[Score_3] AS [Score_3] 
FROM ##TMP_20180416233349_460IDO_XGB_B3 AS [XGB_B3] UNION ALL SELECT [XGB_B4].[KEY] AS [KEY], [XGB_B4].[Score_0] AS [Score_0], [XGB_B4].[Score_1] AS [Score_1], [XGB_B4].[Score_2] AS [Score_2], [XGB_B4].[Score_3] AS [Score_3] 
FROM ##TMP_20180416233349_U3QJAT_XGB_B4 AS [XGB_B4] UNION ALL SELECT [XGB_B5].[KEY] AS [KEY], [XGB_B5].[Score_0] AS [Score_0], [XGB_B5].[Score_1] AS [Score_1], [XGB_B5].[Score_2] AS [Score_2], [XGB_B5].[Score_3] AS [Score_3] 
FROM ##TMP_20180416233349_PI60QK_XGB_B5 AS [XGB_B5] UNION ALL SELECT [XGB_B6].[KEY] AS [KEY], [XGB_B6].[Score_0] AS [Score_0], [XGB_B6].[Score_1] AS [Score_1], [XGB_B6].[Score_2] AS [Score_2], [XGB_B6].[Score_3] AS [Score_3] 
FROM ##TMP_20180416233349_4AKM4X_XGB_B6 AS [XGB_B6]) AS [XGB_EnsembleUnion]) AS [XGB_Union]

-- Code For temporary table ##TMP_20180416233349_BY87K7_XGB_sum part 1/2. Create 


CREATE TABLE ##TMP_20180416233349_BY87K7_XGB_sum (
	[KEY] BIGINT NULL, 
	[Score_0] FLOAT(53) NULL, 
	[Score_1] FLOAT(53) NULL, 
	[Score_2] FLOAT(53) NULL, 
...
-- Code For temporary table ##TMP_20180416233349_BY87K7_XGB_sum part 2/2. Populate

INSERT INTO ##TMP_20180416233349_BY87K7_XGB_sum ([KEY], [Score_0], [Score_1], [Score_2], [Score_3]) SELECT [XGB_sum].[KEY], [XGB_sum].[Score_0], [XGB_sum].[Score_1], [XGB_sum].[Score_2], [XGB_sum].[Score_3] 
...
FROM ##TMP_20180416233349_3OBOD3_XGB_Union AS [XGB_Union] GROUP BY [XGB_Union].[KEY]) AS [T]) AS [XGB_sum]
...
FROM ##TMP_20180416233349_BY87K7_XGB_sum AS [XGB_sum]), 
