...
-- Code For temporary table tmp_20180416233349_6m010h_xgb_b0 part 1/2. Create 


CREATE TEMPORARY TABLE tmp_20180416233349_6m010h_xgb_b0 (
	"KEY" BIGINT, 
	"Score_0" FLOAT, 
	"Score_1" FLOAT, 
	"Score_2" FLOAT, 
...
-- Code For temporary table tmp_20180416233349_6m010h_xgb_b0 part 2/2. Populate

INSERT INTO tmp_20180416233349_6m010h_xgb_b0 ("KEY", "Score_0", "Score_1", "Score_2", "Score_3") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1", "U"."Score_2", "U"."Score_3" 
...
-- Code For temporary table tmp_20180416233349_33u8qv_xgb_b1 part 1/2. Create 


CREATE TEMPORARY TABLE tmp_20180416233349_33u8qv_xgb_b1 (
	"KEY" BIGINT, 
	"Score_0" FLOAT, 
	"Score_1" FLOAT, 
	"Score_2" FLOAT, 
...
-- Code For temporary table tmp_20180416233349_33u8qv_xgb_b1 part 2/2. Populate

INSERT INTO tmp_20180416233349_33u8qv_xgb_b1 ("KEY", "Score_0", "Score_1", "Score_2", "Score_3") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1", "U"."Score_2", "U"."Score_3" 
...
-- Code For temporary table tmp_20180416233349_e5t2n8_xgb_b2 part 1/2. Create 


CREATE TEMPORARY TABLE tmp_20180416233349_e5t2n8_xgb_b2 (
	"KEY" BIGINT, 
	"Score_0" FLOAT, 
	"Score_1" FLOAT, 
	"Score_2" FLOAT, 
...
-- Code For temporary table tmp_20180416233349_e5t2n8_xgb_b2 part 2/2. Populate

INSERT INTO tmp_20180416233349_e5t2n8_xgb_b2 ("KEY", "Score_0", "Score_1", "Score_2", "Score_3") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1", "U"."Score_2", "U"."Score_3" 
...
-- Code For temporary table tmp_20180416233349_m3dth3_xgb_b3 part 1/2. Create 


CREATE TEMPORARY TABLE tmp_20180416233349_m3dth3_xgb_b3 (
	"KEY" BIGINT, 
	"Score_0" FLOAT, 
	"Score_1" FLOAT, 
	"Score_2" FLOAT, 
...
-- Code For temporary table tmp_20180416233349_m3dth3_xgb_b3 part 2/2. Populate

INSERT INTO tmp_20180416233349_m3dth3_xgb_b3 ("KEY", "Score_0", "Score_1", "Score_2", "Score_3") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1", "U"."Score_2", "U"."Score_3" 
...
-- Code For temporary table tmp_20180416233349_olgl6x_xgb_b4 part 1/2. Create 


CREATE TEMPORARY TABLE tmp_20180416233349_olgl6x_xgb_b4 (
	"KEY" BIGINT, 
	"Score_0" FLOAT, 
	"Score_1" FLOAT, 
	"Score_2" FLOAT, 
...
-- Code For temporary table tmp_20180416233349_olgl6x_xgb_b4 part 2/2. Populate

INSERT INTO tmp_20180416233349_olgl6x_xgb_b4 ("KEY", "Score_0", "Score_1", "Score_2", "Score_3") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1", "U"."Score_2", "U"."Score_3" 
...
-- Code For temporary table tmp_20180416233349_p0oot1_xgb_b5 part 1/2. Create 


CREATE TEMPORARY TABLE tmp_20180416233349_p0oot1_xgb_b5 (
	"KEY" BIGINT, 
	"Score_0" FLOAT, 
	"Score_1" FLOAT, 
	"Score_2" FLOAT, 
...
-- Code For temporary table tmp_20180416233349_p0oot1_xgb_b5 part 2/2. Populate

INSERT INTO tmp_20180416233349_p0oot1_xgb_b5 ("KEY", "Score_0", "Score_1", "Score_2", "Score_3") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1", "U"."Score_2", "U"."Score_3" 
...
-- Code For temporary table tmp_20180416233349_2bbmdg_xgb_b6 part 1/2. Create 


CREATE TEMPORARY TABLE tmp_20180416233349_2bbmdg_xgb_b6 (
	"KEY" BIGINT, 
	"Score_0" FLOAT, 
	"Score_1" FLOAT, 
	"Score_2" FLOAT, 
...
-- Code For temporary table tmp_20180416233349_2bbmdg_xgb_b6 part 2/2. Populate

INSERT INTO tmp_20180416233349_2bbmdg_xgb_b6 ("KEY", "Score_0", "Score_1", "Score_2", "Score_3") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1", "U"."Score_2", "U"."Score_3" 
...
-- Code For temporary table tmp_20180416233349_d7xim0_xgb_union part 1/2. Create 


CREATE TEMPORARY TABLE tmp_20180416233349_d7xim0_xgb_union (
	"KEY" BIGINT, 
	"Score_0" FLOAT, 
	"Score_1" FLOAT, 
	"Score_2" FLOAT, 
...
-- Code For temporary table tmp_20180416233349_d7xim0_xgb_union part 2/2. Populate

INSERT INTO tmp_20180416233349_d7xim0_xgb_union ("KEY", "Score_0", "Score_1", "Score_2", "Score_3") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1", "U"."Score_2", "U"."Score_3" 
...
FROM tmp_20180416233349_6m010h_xgb_b0 AS "XGB_B0" UNION ALL SELECT "XGB_B1"."KEY" AS "KEY", "XGB_B1"."Score_0" AS "Score_0", "XGB_B1"."Score_1" AS "Score_1", "XGB_B1"."Score_2" AS "Score_2", "XGB_B1"."Score_3" AS "Score_3" 
FROM tmp_20180416233349_33u8qv_xgb_b1 AS "XGB_B1" UNION ALL SELECT "XGB_B2"."KEY" AS "KEY", "XGB_B2"."Score_0" AS "Score_0", "XGB_B2"."Score_1" AS "Score_1", "XGB_B2"."Score_2" AS "Score_2", "XGB_B2"."Score_3" AS "Score_3" 
FROM tmp_20180416233349_e5t2n8_xgb_b2 AS "XGB_B2" UNION ALL SELECT "XGB_B3"."KEY" AS "KEY", "XGB_B3"."Score_0" AS "Score_0", "XGB_B3"."Score_1" AS "Score_1", "XGB_B3"."Score_2" AS "Score_2", "XGB_B3"."Score_3" AS "Score_3" 
FROM tmp_20180416233349_m3dth3_xgb_b3 AS "XGB_B3" UNION ALL SELECT "XGB_B4"."KEY" AS "KEY", "XGB_B4"."Score_0" AS "Score_0", "XGB_B4"."Score_1" AS "Score_1", "XGB_B4"."Score_2" AS "Score_2", "XGB_B4"."Score_3" AS "Score_3" 
FROM tmp_20180416233349_olgl6x_xgb_b4 AS "XGB_B4" UNION ALL SELECT "XGB_B5"."KEY" AS "KEY", "XGB_B5"."Score_0" AS "Score_0", "XGB_B5"."Score_1" AS "Score_1", "XGB_B5"."Score_2" AS "Score_2", "XGB_B5"."Score_3" AS "Score_3" 
FROM tmp_20180416233349_p0oot1_xgb_b5 AS "XGB_B5" UNION ALL SELECT "XGB_B6"."KEY" AS "KEY", "XGB_B6"."Score_0" AS "Score_0", "XGB_B6"."Score_1" AS "Score_1", "XGB_B6"."Score_2" AS "Score_2", "XGB_B6"."Score_3" AS "Score_3" 
FROM tmp_20180416233349_2bbmdg_xgb_b6 AS "XGB_B6") AS "XGB_EnsembleUnion") AS "XGB_Union") AS "U"

-- Code For temporary table tmp_20180416233349_7fi5tf_xgb_sum part 1/2. Create 


CREATE TEMPORARY TABLE tmp_20180416233349_7fi5tf_xgb_sum (
	"KEY" BIGINT NOT NULL, 
	"Score_0" FLOAT, 
	"Score_1" FLOAT, 
	"Score_2" FLOAT, 
...
-- Code For temporary table tmp_20180416233349_7fi5tf_xgb_sum part 2/2. Populate

INSERT INTO tmp_20180416233349_7fi5tf_xgb_sum ("KEY", "Score_0", "Score_1", "Score_2", "Score_3") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1", "U"."Score_2", "U"."Score_3" 
...
FROM tmp_20180416233349_d7xim0_xgb_union AS "XGB_Union" GROUP BY "XGB_Union"."KEY") AS "T") AS "XGB_sum") AS "U"
...
FROM tmp_20180416233349_7fi5tf_xgb_sum AS "XGB_sum"), 
