...
-- Code For temporary table tmp_20180416233352_2x1ijo_xgb_b0 part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180416233352_2x1ijo_xgb_b0 (
	"KEY" BIGINT, 
	"Score_0" FLOAT, 
	"Score_1" DOUBLE, 
	"Score_2" DOUBLE, 
...
-- Code For temporary table tmp_20180416233352_2x1ijo_xgb_b0 part 2/2. Populate

INSERT INTO tmp_20180416233352_2x1ijo_xgb_b0 WITH "DT_node_lookup" AS 
...
-- Code For temporary table tmp_20180416233352_yjdyxy_xgb_b1 part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180416233352_yjdyxy_xgb_b1 (
	"KEY" BIGINT, 
	"Score_0" DOUBLE, 
	"Score_1" DOUBLE, 
	"Score_2" FLOAT, 
...
-- Code For temporary table tmp_20180416233352_yjdyxy_xgb_b1 part 2/2. Populate

INSERT INTO tmp_20180416233352_yjdyxy_xgb_b1 WITH "DT_node_lookup_10" AS 
...
-- Code For temporary table tmp_20180416233352_046tp1_xgb_b2 part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180416233352_046tp1_xgb_b2 (
	"KEY" BIGINT, 
	"Score_0" FLOAT, 
	"Score_1" DOUBLE, 
	"Score_2" DOUBLE, 
...
-- Code For temporary table tmp_20180416233352_046tp1_xgb_b2 part 2/2. Populate

INSERT INTO tmp_20180416233352_046tp1_xgb_b2 WITH "DT_node_lookup_20" AS 
(SELECT "ADS"."KEY" AS "KEY", CASE WHEN ("ADS"."Feature_4" < -0.35484129190444946) THEN 1 ELSE 2 END AS node_id_2 
FROM "FOURCLASS_10" AS "ADS"), 
"DT_node_data_20" AS 
(SELECT "Values".node_id AS node_id, CAST("Values".feature AS DOUBLE) AS feature, CAST("Values".threshold AS DOUBLE) AS threshold, CAST("Values".depth AS DOUBLE) AS depth, CAST("Values".parent_id AS DOUBLE) AS parent_id, CAST("Values"."Score" AS DOUBLE) AS "Score" 
...
-- Code For temporary table tmp_20180416233352_1xflij_xgb_b3 part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180416233352_1xflij_xgb_b3 (
	"KEY" BIGINT, 
	"Score_0" DOUBLE, 
	"Score_1" DOUBLE, 
	"Score_2" FLOAT, 
...
-- Code For temporary table tmp_20180416233352_1xflij_xgb_b3 part 2/2. Populate

INSERT INTO tmp_20180416233352_1xflij_xgb_b3 WITH "DT_node_lookup_30" AS 
...
-- Code For temporary table tmp_20180416233352_hqquwk_xgb_b4 part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180416233352_hqquwk_xgb_b4 (
	"KEY" BIGINT, 
	"Score_0" FLOAT, 
	"Score_1" DOUBLE, 
	"Score_2" DOUBLE, 
...
-- Code For temporary table tmp_20180416233352_hqquwk_xgb_b4 part 2/2. Populate

INSERT INTO tmp_20180416233352_hqquwk_xgb_b4 WITH "DT_node_lookup_40" AS 
(SELECT "ADS"."KEY" AS "KEY", CASE WHEN ("ADS"."Feature_3" < 0.5489295125007629) THEN 1 ELSE 2 END AS node_id_2 
FROM "FOURCLASS_10" AS "ADS"), 
"DT_node_data_40" AS 
(SELECT "Values".node_id AS node_id, CAST("Values".feature AS DOUBLE) AS feature, CAST("Values".threshold AS DOUBLE) AS threshold, CAST("Values".depth AS DOUBLE) AS depth, CAST("Values".parent_id AS DOUBLE) AS parent_id, CAST("Values"."Score" AS DOUBLE) AS "Score" 
...
-- Code For temporary table tmp_20180416233352_u7ac8x_xgb_b5 part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180416233352_u7ac8x_xgb_b5 (
	"KEY" BIGINT, 
	"Score_0" DOUBLE, 
	"Score_1" DOUBLE, 
	"Score_2" FLOAT, 
...
-- Code For temporary table tmp_20180416233352_u7ac8x_xgb_b5 part 2/2. Populate

INSERT INTO tmp_20180416233352_u7ac8x_xgb_b5 WITH "DT_node_lookup_50" AS 
(SELECT "ADS"."KEY" AS "KEY", CASE WHEN ("ADS"."Feature_3" < -0.9904775023460388) THEN 1 ELSE 2 END AS node_id_2 
FROM "FOURCLASS_10" AS "ADS"), 
"DT_node_data_50" AS 
(SELECT "Values".node_id AS node_id, CAST("Values".feature AS DOUBLE) AS feature, CAST("Values".threshold AS DOUBLE) AS threshold, CAST("Values".depth AS DOUBLE) AS depth, CAST("Values".parent_id AS DOUBLE) AS parent_id, CAST("Values"."Score" AS DOUBLE) AS "Score" 
...
-- Code For temporary table tmp_20180416233352_xw3btf_xgb_b6 part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180416233352_xw3btf_xgb_b6 (
	"KEY" BIGINT, 
	"Score_0" FLOAT, 
	"Score_1" DOUBLE, 
	"Score_2" DOUBLE, 
...
-- Code For temporary table tmp_20180416233352_xw3btf_xgb_b6 part 2/2. Populate

INSERT INTO tmp_20180416233352_xw3btf_xgb_b6 WITH "DT_node_lookup_60" AS 
(SELECT "ADS"."KEY" AS "KEY", CASE WHEN ("ADS"."Feature_4" < -0.35484129190444946) THEN 1 ELSE 2 END AS node_id_2 
FROM "FOURCLASS_10" AS "ADS"), 
"DT_node_data_60" AS 
(SELECT "Values".node_id AS node_id, CAST("Values".feature AS DOUBLE) AS feature, CAST("Values".threshold AS DOUBLE) AS threshold, CAST("Values".depth AS DOUBLE) AS depth, CAST("Values".parent_id AS DOUBLE) AS parent_id, CAST("Values"."Score" AS DOUBLE) AS "Score" 
...
-- Code For temporary table tmp_20180416233352_vmfrca_xgb_union part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180416233352_vmfrca_xgb_union (
	"KEY" BIGINT, 
	"Score_0" FLOAT, 
	"Score_1" DOUBLE, 
	"Score_2" DOUBLE, 
...
-- Code For temporary table tmp_20180416233352_vmfrca_xgb_union part 2/2. Populate

INSERT INTO tmp_20180416233352_vmfrca_xgb_union SELECT "XGB_Union"."KEY", "XGB_Union"."Score_0", "XGB_Union"."Score_1", "XGB_Union"."Score_2", "XGB_Union"."Score_3" 
...
FROM tmp_20180416233352_2x1ijo_xgb_b0 AS "XGB_B0" UNION ALL SELECT "XGB_B1"."KEY" AS "KEY", "XGB_B1"."Score_0" AS "Score_0", "XGB_B1"."Score_1" AS "Score_1", "XGB_B1"."Score_2" AS "Score_2", "XGB_B1"."Score_3" AS "Score_3" 
FROM tmp_20180416233352_yjdyxy_xgb_b1 AS "XGB_B1" UNION ALL SELECT "XGB_B2"."KEY" AS "KEY", "XGB_B2"."Score_0" AS "Score_0", "XGB_B2"."Score_1" AS "Score_1", "XGB_B2"."Score_2" AS "Score_2", "XGB_B2"."Score_3" AS "Score_3" 
FROM tmp_20180416233352_046tp1_xgb_b2 AS "XGB_B2" UNION ALL SELECT "XGB_B3"."KEY" AS "KEY", "XGB_B3"."Score_0" AS "Score_0", "XGB_B3"."Score_1" AS "Score_1", "XGB_B3"."Score_2" AS "Score_2", "XGB_B3"."Score_3" AS "Score_3" 
FROM tmp_20180416233352_1xflij_xgb_b3 AS "XGB_B3" UNION ALL SELECT "XGB_B4"."KEY" AS "KEY", "XGB_B4"."Score_0" AS "Score_0", "XGB_B4"."Score_1" AS "Score_1", "XGB_B4"."Score_2" AS "Score_2", "XGB_B4"."Score_3" AS "Score_3" 
FROM tmp_20180416233352_hqquwk_xgb_b4 AS "XGB_B4" UNION ALL SELECT "XGB_B5"."KEY" AS "KEY", "XGB_B5"."Score_0" AS "Score_0", "XGB_B5"."Score_1" AS "Score_1", "XGB_B5"."Score_2" AS "Score_2", "XGB_B5"."Score_3" AS "Score_3" 
FROM tmp_20180416233352_u7ac8x_xgb_b5 AS "XGB_B5" UNION ALL SELECT "XGB_B6"."KEY" AS "KEY", "XGB_B6"."Score_0" AS "Score_0", "XGB_B6"."Score_1" AS "Score_1", "XGB_B6"."Score_2" AS "Score_2", "XGB_B6"."Score_3" AS "Score_3" 
FROM tmp_20180416233352_xw3btf_xgb_b6 AS "XGB_B6") AS "XGB_EnsembleUnion") AS "XGB_Union"

-- Code For temporary table tmp_20180416233352_dbbhao_xgb_sum part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180416233352_dbbhao_xgb_sum (
	"KEY" BIGINT, 
	"Score_0" FLOAT, 
	"Score_1" FLOAT, 
	"Score_2" FLOAT, 
...
-- Code For temporary table tmp_20180416233352_dbbhao_xgb_sum part 2/2. Populate

INSERT INTO tmp_20180416233352_dbbhao_xgb_sum SELECT "XGB_sum"."KEY", "XGB_sum"."Score_0", "XGB_sum"."Score_1", "XGB_sum"."Score_2", "XGB_sum"."Score_3" 
...
FROM tmp_20180416233352_vmfrca_xgb_union AS "XGB_Union" GROUP BY "XGB_Union"."KEY") AS "T") AS "XGB_sum"
...
FROM tmp_20180416233352_dbbhao_xgb_sum AS "XGB_sum"), 
