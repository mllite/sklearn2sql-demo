...
-- Code For temporary table tmp_20180416232909_jo6q9m_xgb_b0 part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180416232909_jo6q9m_xgb_b0 (
	"KEY" BIGINT, 
	"Score_0" FLOAT
)
...
-- Code For temporary table tmp_20180416232909_jo6q9m_xgb_b0 part 2/2. Populate

INSERT INTO tmp_20180416232909_jo6q9m_xgb_b0 WITH "DT_node_lookup" AS 
...
-- Code For temporary table tmp_20180416232909_gqfpqh_xgb_b1 part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180416232909_gqfpqh_xgb_b1 (
	"KEY" BIGINT, 
	"Score_0" FLOAT
)
...
-- Code For temporary table tmp_20180416232909_gqfpqh_xgb_b1 part 2/2. Populate

INSERT INTO tmp_20180416232909_gqfpqh_xgb_b1 WITH "DT_node_lookup_10" AS 
...
-- Code For temporary table tmp_20180416232909_d7jhfp_xgb_union part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180416232909_d7jhfp_xgb_union (
	"KEY" BIGINT, 
	"Score_0" FLOAT
)
...
-- Code For temporary table tmp_20180416232909_d7jhfp_xgb_union part 2/2. Populate

INSERT INTO tmp_20180416232909_d7jhfp_xgb_union SELECT "XGB_Union"."KEY", "XGB_Union"."Score_0" 
...
FROM tmp_20180416232909_jo6q9m_xgb_b0 AS "XGB_B0" UNION ALL SELECT "XGB_B1"."KEY" AS "KEY", "XGB_B1"."Score_0" AS "Score_0" 
FROM tmp_20180416232909_gqfpqh_xgb_b1 AS "XGB_B1") AS "XGB_EnsembleUnion") AS "XGB_Union"

-- Code For temporary table tmp_20180416232909_2453dj_xgb_sum part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180416232909_2453dj_xgb_sum (
	"KEY" BIGINT, 
	"Score_0" FLOAT
)
...
-- Code For temporary table tmp_20180416232909_2453dj_xgb_sum part 2/2. Populate

INSERT INTO tmp_20180416232909_2453dj_xgb_sum SELECT "XGB_sum"."KEY", "XGB_sum"."Score_0" 
...
FROM tmp_20180416232909_d7jhfp_xgb_union AS "XGB_Union" GROUP BY "XGB_Union"."KEY") AS "T") AS "XGB_sum"
...
FROM tmp_20180416232909_2453dj_xgb_sum AS "XGB_sum"), 
