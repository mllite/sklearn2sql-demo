...
-- Code For temporary table tmp_20180417042431_sqf5v6_xgb_ part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180417042431_sqf5v6_xgb_  (
	"KEY" BIGINT, 
	"Score_0" FLOAT, 
	"Score_1" FLOAT, 
	"Score_2" FLOAT
...
-- Code For temporary table tmp_20180417042431_sqf5v6_xgb_ part 2/2. Populate

INSERT INTO tmp_20180417042431_sqf5v6_xgb_ ("KEY", "Score_0", "Score_1", "Score_2") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1", "U"."Score_2" 
...
-- Code For temporary table tmp_20180417042431_g1axr5_xgb_ part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180417042431_g1axr5_xgb_  (
	"KEY" BIGINT, 
	"Score_0" FLOAT, 
	"Score_1" FLOAT, 
	"Score_2" FLOAT
...
-- Code For temporary table tmp_20180417042431_g1axr5_xgb_ part 2/2. Populate

INSERT INTO tmp_20180417042431_g1axr5_xgb_ ("KEY", "Score_0", "Score_1", "Score_2") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1", "U"."Score_2" 
...
-- Code For temporary table tmp_20180417042431_mqeo7s_xgb_ part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180417042431_mqeo7s_xgb_  (
	"KEY" BIGINT, 
	"Score_0" FLOAT, 
	"Score_1" FLOAT, 
	"Score_2" FLOAT
...
-- Code For temporary table tmp_20180417042431_mqeo7s_xgb_ part 2/2. Populate

INSERT INTO tmp_20180417042431_mqeo7s_xgb_ ("KEY", "Score_0", "Score_1", "Score_2") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1", "U"."Score_2" 
...
-- Code For temporary table tmp_20180417042431_owxcvx_xgb_ part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180417042431_owxcvx_xgb_  (
	"KEY" BIGINT, 
	"Score_0" FLOAT, 
	"Score_1" FLOAT, 
	"Score_2" FLOAT
...
-- Code For temporary table tmp_20180417042431_owxcvx_xgb_ part 2/2. Populate

INSERT INTO tmp_20180417042431_owxcvx_xgb_ ("KEY", "Score_0", "Score_1", "Score_2") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1", "U"."Score_2" 
...
-- Code For temporary table tmp_20180417042431_4id1iz_xgb_ part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180417042431_4id1iz_xgb_  (
	"KEY" BIGINT, 
	"Score_0" FLOAT, 
	"Score_1" FLOAT, 
	"Score_2" FLOAT
...
-- Code For temporary table tmp_20180417042431_4id1iz_xgb_ part 2/2. Populate

INSERT INTO tmp_20180417042431_4id1iz_xgb_ ("KEY", "Score_0", "Score_1", "Score_2") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1", "U"."Score_2" 
...
-- Code For temporary table tmp_20180417042431_eazgx6_xgb_ part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180417042431_eazgx6_xgb_  (
	"KEY" BIGINT, 
	"Score_0" FLOAT, 
	"Score_1" FLOAT, 
	"Score_2" FLOAT
...
-- Code For temporary table tmp_20180417042431_eazgx6_xgb_ part 2/2. Populate

INSERT INTO tmp_20180417042431_eazgx6_xgb_ ("KEY", "Score_0", "Score_1", "Score_2") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1", "U"."Score_2" 
...
FROM tmp_20180417042431_sqf5v6_xgb_ AS "XGB_B0" UNION ALL SELECT "XGB_B1"."KEY" AS "KEY", "XGB_B1"."Score_0" AS "Score_0", "XGB_B1"."Score_1" AS "Score_1", "XGB_B1"."Score_2" AS "Score_2" 
FROM tmp_20180417042431_g1axr5_xgb_ AS "XGB_B1" UNION ALL SELECT "XGB_B2"."KEY" AS "KEY", "XGB_B2"."Score_0" AS "Score_0", "XGB_B2"."Score_1" AS "Score_1", "XGB_B2"."Score_2" AS "Score_2" 
FROM tmp_20180417042431_mqeo7s_xgb_ AS "XGB_B2" UNION ALL SELECT "XGB_B3"."KEY" AS "KEY", "XGB_B3"."Score_0" AS "Score_0", "XGB_B3"."Score_1" AS "Score_1", "XGB_B3"."Score_2" AS "Score_2" 
FROM tmp_20180417042431_owxcvx_xgb_ AS "XGB_B3" UNION ALL SELECT "XGB_B4"."KEY" AS "KEY", "XGB_B4"."Score_0" AS "Score_0", "XGB_B4"."Score_1" AS "Score_1", "XGB_B4"."Score_2" AS "Score_2" 
FROM tmp_20180417042431_4id1iz_xgb_ AS "XGB_B4") AS "XGB_EnsembleUnion") AS "XGB_Union") AS "U"

-- Code For temporary table tmp_20180417042431_a1zbeg_xgb_ part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180417042431_a1zbeg_xgb_  (
	"KEY" BIGINT, 
	"Score_0" FLOAT, 
	"Score_1" FLOAT, 
	"Score_2" FLOAT
...
-- Code For temporary table tmp_20180417042431_a1zbeg_xgb_ part 2/2. Populate

INSERT INTO tmp_20180417042431_a1zbeg_xgb_ ("KEY", "Score_0", "Score_1", "Score_2") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1", "U"."Score_2" 
...
FROM tmp_20180417042431_eazgx6_xgb_ AS "XGB_Union" GROUP BY "XGB_Union"."KEY") AS "T") AS "XGB_sum") AS "U"
...
FROM tmp_20180417042431_a1zbeg_xgb_ AS "XGB_sum"), 
