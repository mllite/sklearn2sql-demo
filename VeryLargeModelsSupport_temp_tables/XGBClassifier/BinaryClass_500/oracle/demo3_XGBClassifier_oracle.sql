...
-- Code For temporary table 180416231433_ZUV3MJ_XGB_B0 part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE "180416231433_ZUV3MJ_XGB_B0" (
	"KEY" NUMBER(19), 
...
-- Code For temporary table 180416231433_ZUV3MJ_XGB_B0 part 2/2. Populate

INSERT INTO "180416231433_ZUV3MJ_XGB_B0" ("KEY", "Score_0") SELECT "U"."KEY", "U"."Score_0" 
...
-- Code For temporary table 180416231433_8LSH0G_XGB_B1 part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE "180416231433_8LSH0G_XGB_B1" (
	"KEY" NUMBER(19), 
	"Score_0" BINARY_DOUBLE
)
...
-- Code For temporary table 180416231433_8LSH0G_XGB_B1 part 2/2. Populate

INSERT INTO "180416231433_8LSH0G_XGB_B1" ("KEY", "Score_0") SELECT "U"."KEY", "U"."Score_0" 
...
-- Code For temporary table 416231433_SMLFT1_XGB_UNION part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE "416231433_SMLFT1_XGB_UNION" (
	"KEY" NUMBER(19), 
	"Score_0" BINARY_DOUBLE
)
...
-- Code For temporary table 416231433_SMLFT1_XGB_UNION part 2/2. Populate

INSERT INTO "416231433_SMLFT1_XGB_UNION" ("KEY", "Score_0") SELECT "U"."KEY", "U"."Score_0" 
...
FROM "180416231433_ZUV3MJ_XGB_B0" "XGB_B0" UNION ALL SELECT "XGB_B1"."KEY" AS "KEY", "XGB_B1"."Score_0" AS "Score_0" 
FROM "180416231433_8LSH0G_XGB_B1" "XGB_B1") "XGB_EnsembleUnion") "XGB_Union") "U"

-- Code For temporary table 80416231433_2FX7V7_XGB_SUM part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE "80416231433_2FX7V7_XGB_SUM" (
...
-- Code For temporary table 80416231433_2FX7V7_XGB_SUM part 2/2. Populate

INSERT INTO "80416231433_2FX7V7_XGB_SUM" ("KEY", "Score_0") SELECT "U"."KEY", "U"."Score_0" 
...
FROM "416231433_SMLFT1_XGB_UNION" "XGB_Union" GROUP BY "XGB_Union"."KEY") "T") "XGB_sum") "U"
...
FROM "80416231433_2FX7V7_XGB_SUM" "XGB_sum"), 
