...
-- Code For temporary table tmp_20180416231433_anhizl_xgb_ part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180416231433_anhizl_xgb_  (
	"KEY" BIGINT, 
	"Score_0" FLOAT
)
...
-- Code For temporary table tmp_20180416231433_anhizl_xgb_ part 2/2. Populate

INSERT INTO tmp_20180416231433_anhizl_xgb_ ("KEY", "Score_0") SELECT "U"."KEY", "U"."Score_0" 
FROM (WITH "DT_node_lookup" AS 
(SELECT "ADS"."KEY" AS "KEY", CASE WHEN ("ADS"."Feature_244" < -0.294809132814407) THEN 1 ELSE 2 END AS node_id_2 
...
-- Code For temporary table tmp_20180416231433_fpcq8m_xgb_ part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180416231433_fpcq8m_xgb_  (
	"KEY" BIGINT, 
	"Score_0" FLOAT
)
...
-- Code For temporary table tmp_20180416231433_fpcq8m_xgb_ part 2/2. Populate

INSERT INTO tmp_20180416231433_fpcq8m_xgb_ ("KEY", "Score_0") SELECT "U"."KEY", "U"."Score_0" 
...
-- Code For temporary table tmp_20180416231433_k00pky_xgb_ part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180416231433_k00pky_xgb_  (
	"KEY" BIGINT, 
	"Score_0" FLOAT
)
...
-- Code For temporary table tmp_20180416231433_k00pky_xgb_ part 2/2. Populate

INSERT INTO tmp_20180416231433_k00pky_xgb_ ("KEY", "Score_0") SELECT "U"."KEY", "U"."Score_0" 
...
FROM tmp_20180416231433_anhizl_xgb_ AS "XGB_B0" UNION ALL SELECT "XGB_B1"."KEY" AS "KEY", "XGB_B1"."Score_0" AS "Score_0" 
FROM tmp_20180416231433_fpcq8m_xgb_ AS "XGB_B1") AS "XGB_EnsembleUnion") AS "XGB_Union") AS "U"

-- Code For temporary table tmp_20180416231433_5h00c6_xgb_ part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180416231433_5h00c6_xgb_  (
	"KEY" BIGINT, 
	"Score_0" FLOAT
)
...
-- Code For temporary table tmp_20180416231433_5h00c6_xgb_ part 2/2. Populate

INSERT INTO tmp_20180416231433_5h00c6_xgb_ ("KEY", "Score_0") SELECT "U"."KEY", "U"."Score_0" 
...
FROM tmp_20180416231433_k00pky_xgb_ AS "XGB_Union" GROUP BY "XGB_Union"."KEY") AS "T") AS "XGB_sum") AS "U"
...
FROM tmp_20180416231433_5h00c6_xgb_ AS "XGB_sum"), 
