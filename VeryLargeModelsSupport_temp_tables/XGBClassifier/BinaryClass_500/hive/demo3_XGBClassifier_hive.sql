...
-- Code For temporary table tmp_20180416231433_xlirl6_xgb_b0 part 1/2. Create 

CREATE TEMPORARY TABLE `tmp_20180416231433_xlirl6_xgb_b0` STORED AS ORC AS WITH `DT_node_lookup` AS 
...
FROM (SELECT 1 AS `node_id`, CAST(NULL AS STRING) AS `feature`, CAST(NULL AS FLOAT) AS `threshold`, 1 AS `depth`, 0 AS `parent_id`, -0.10909091681241989 AS `Score` UNION ALL SELECT 2 AS `node_id`, CAST(NULL AS STRING) AS `feature`, CAST(NULL AS FLOAT) AS `threshold`, 1 AS `depth`, 0 AS `parent_id`, 0.11818181723356247 AS `Score`) AS `Values`), 
`DT_Output` AS 
...
`DT_node_data_1` AS 
(SELECT `Values`.`node_id` AS `node_id`, CAST(`Values`.`feature` AS FLOAT) AS `feature`, CAST(`Values`.`threshold` AS FLOAT) AS `threshold`, CAST(`Values`.`depth` AS FLOAT) AS `depth`, CAST(`Values`.`parent_id` AS FLOAT) AS `parent_id`, CAST(`Values`.`Score` AS FLOAT) AS `Score` 
FROM (SELECT 0 AS `node_id`, CAST(NULL AS STRING) AS `feature`, CAST(NULL AS FLOAT) AS `threshold`, 0 AS `depth`, CAST(NULL AS BIGINT) AS `parent_id`, 0.004343749023973942 AS `Score`) AS `Values`), 
`DT_Output_1` AS 
...
`DT_node_data_2` AS 
(SELECT `Values`.`node_id` AS `node_id`, CAST(`Values`.`feature` AS FLOAT) AS `feature`, CAST(`Values`.`threshold` AS FLOAT) AS `threshold`, CAST(`Values`.`depth` AS FLOAT) AS `depth`, CAST(`Values`.`parent_id` AS FLOAT) AS `parent_id`, CAST(`Values`.`Score` AS FLOAT) AS `Score` 
FROM (SELECT 0 AS `node_id`, CAST(NULL AS STRING) AS `feature`, CAST(NULL AS FLOAT) AS `threshold`, 0 AS `depth`, CAST(NULL AS BIGINT) AS `parent_id`, 0.003930181264877319 AS `Score`) AS `Values`), 
`DT_Output_2` AS 
...
`DT_node_data_3` AS 
(SELECT `Values`.`node_id` AS `node_id`, CAST(`Values`.`feature` AS FLOAT) AS `feature`, CAST(`Values`.`threshold` AS FLOAT) AS `threshold`, CAST(`Values`.`depth` AS FLOAT) AS `depth`, CAST(`Values`.`parent_id` AS FLOAT) AS `parent_id`, CAST(`Values`.`Score` AS FLOAT) AS `Score` 
FROM (SELECT 0 AS `node_id`, CAST(NULL AS STRING) AS `feature`, CAST(NULL AS FLOAT) AS `threshold`, 0 AS `depth`, CAST(NULL AS BIGINT) AS `parent_id`, 0.0035560179967433214 AS `Score`) AS `Values`), 
`DT_Output_3` AS 
...
`DT_node_data_4` AS 
(SELECT `Values`.`node_id` AS `node_id`, CAST(`Values`.`feature` AS FLOAT) AS `feature`, CAST(`Values`.`threshold` AS FLOAT) AS `threshold`, CAST(`Values`.`depth` AS FLOAT) AS `depth`, CAST(`Values`.`parent_id` AS FLOAT) AS `parent_id`, CAST(`Values`.`Score` AS FLOAT) AS `Score` 
FROM (SELECT 0 AS `node_id`, CAST(NULL AS STRING) AS `feature`, CAST(NULL AS FLOAT) AS `threshold`, 0 AS `depth`, CAST(NULL AS BIGINT) AS `parent_id`, 0.003217478049919009 AS `Score`) AS `Values`), 
`DT_Output_4` AS 
...
`DT_node_data_5` AS 
(SELECT `Values`.`node_id` AS `node_id`, CAST(`Values`.`feature` AS FLOAT) AS `feature`, CAST(`Values`.`threshold` AS FLOAT) AS `threshold`, CAST(`Values`.`depth` AS FLOAT) AS `depth`, CAST(`Values`.`parent_id` AS FLOAT) AS `parent_id`, CAST(`Values`.`Score` AS FLOAT) AS `Score` 
FROM (SELECT 0 AS `node_id`, CAST(NULL AS STRING) AS `feature`, CAST(NULL AS FLOAT) AS `threshold`, 0 AS `depth`, CAST(NULL AS BIGINT) AS `parent_id`, 0.0029111774638295174 AS `Score`) AS `Values`), 
`DT_Output_5` AS 
...
`DT_node_data_6` AS 
(SELECT `Values`.`node_id` AS `node_id`, CAST(`Values`.`feature` AS FLOAT) AS `feature`, CAST(`Values`.`threshold` AS FLOAT) AS `threshold`, CAST(`Values`.`depth` AS FLOAT) AS `depth`, CAST(`Values`.`parent_id` AS FLOAT) AS `parent_id`, CAST(`Values`.`Score` AS FLOAT) AS `Score` 
FROM (SELECT 0 AS `node_id`, CAST(NULL AS STRING) AS `feature`, CAST(NULL AS FLOAT) AS `threshold`, 0 AS `depth`, CAST(NULL AS BIGINT) AS `parent_id`, 0.0026340510230511427 AS `Score`) AS `Values`), 
`DT_Output_6` AS 
...
`DT_node_data_7` AS 
(SELECT `Values`.`node_id` AS `node_id`, CAST(`Values`.`feature` AS FLOAT) AS `feature`, CAST(`Values`.`threshold` AS FLOAT) AS `threshold`, CAST(`Values`.`depth` AS FLOAT) AS `depth`, CAST(`Values`.`parent_id` AS FLOAT) AS `parent_id`, CAST(`Values`.`Score` AS FLOAT) AS `Score` 
FROM (SELECT 0 AS `node_id`, CAST(NULL AS STRING) AS `feature`, CAST(NULL AS FLOAT) AS `threshold`, 0 AS `depth`, CAST(NULL AS BIGINT) AS `parent_id`, 0.002383300568908453 AS `Score`) AS `Values`), 
`DT_Output_7` AS 
...
`DT_node_data_8` AS 
(SELECT `Values`.`node_id` AS `node_id`, CAST(`Values`.`feature` AS FLOAT) AS `feature`, CAST(`Values`.`threshold` AS FLOAT) AS `threshold`, CAST(`Values`.`depth` AS FLOAT) AS `depth`, CAST(`Values`.`parent_id` AS FLOAT) AS `parent_id`, CAST(`Values`.`Score` AS FLOAT) AS `Score` 
FROM (SELECT 0 AS `node_id`, CAST(NULL AS STRING) AS `feature`, CAST(NULL AS FLOAT) AS `threshold`, 0 AS `depth`, CAST(NULL AS BIGINT) AS `parent_id`, 0.002156427362933755 AS `Score`) AS `Values`), 
`DT_Output_8` AS 
...
`DT_node_data_9` AS 
(SELECT `Values`.`node_id` AS `node_id`, CAST(`Values`.`feature` AS FLOAT) AS `feature`, CAST(`Values`.`threshold` AS FLOAT) AS `threshold`, CAST(`Values`.`depth` AS FLOAT) AS `depth`, CAST(`Values`.`parent_id` AS FLOAT) AS `parent_id`, CAST(`Values`.`Score` AS FLOAT) AS `Score` 
FROM (SELECT 0 AS `node_id`, CAST(NULL AS STRING) AS `feature`, CAST(NULL AS FLOAT) AS `threshold`, 0 AS `depth`, CAST(NULL AS BIGINT) AS `parent_id`, 0.00195114070083946 AS `Score`) AS `Values`), 
`DT_Output_9` AS 
...
-- Code For temporary table tmp_20180416231433_xlirl6_xgb_b0 part 2/2. Populate

SELECT * FROM `tmp_20180416231433_xlirl6_xgb_b0`

-- Code For temporary table tmp_20180416231433_5bkp2j_xgb_b1 part 1/2. Create 

CREATE TEMPORARY TABLE `tmp_20180416231433_5bkp2j_xgb_b1` STORED AS ORC AS WITH `DT_node_lookup_10` AS 
(SELECT `ADS`.`KEY` AS `KEY`, 0 AS `node_id_2` 
FROM `BinaryClass_500` AS `ADS`), 
`DT_node_data_10` AS 
(SELECT `Values`.`node_id` AS `node_id`, CAST(`Values`.`feature` AS FLOAT) AS `feature`, CAST(`Values`.`threshold` AS FLOAT) AS `threshold`, CAST(`Values`.`depth` AS FLOAT) AS `depth`, CAST(`Values`.`parent_id` AS FLOAT) AS `parent_id`, CAST(`Values`.`Score` AS FLOAT) AS `Score` 
FROM (SELECT 0 AS `node_id`, CAST(NULL AS STRING) AS `feature`, CAST(NULL AS FLOAT) AS `threshold`, 0 AS `depth`, CAST(NULL AS BIGINT) AS `parent_id`, 0.001765410415828228 AS `Score`) AS `Values`), 
`DT_Output_10` AS 
...
`DT_node_data_11` AS 
(SELECT `Values`.`node_id` AS `node_id`, CAST(`Values`.`feature` AS FLOAT) AS `feature`, CAST(`Values`.`threshold` AS FLOAT) AS `threshold`, CAST(`Values`.`depth` AS FLOAT) AS `depth`, CAST(`Values`.`parent_id` AS FLOAT) AS `parent_id`, CAST(`Values`.`Score` AS FLOAT) AS `Score` 
FROM (SELECT 0 AS `node_id`, CAST(NULL AS STRING) AS `feature`, CAST(NULL AS FLOAT) AS `threshold`, 0 AS `depth`, CAST(NULL AS BIGINT) AS `parent_id`, 0.0015973467379808426 AS `Score`) AS `Values`), 
`DT_Output_11` AS 
...
`DT_node_data_12` AS 
(SELECT `Values`.`node_id` AS `node_id`, CAST(`Values`.`feature` AS FLOAT) AS `feature`, CAST(`Values`.`threshold` AS FLOAT) AS `threshold`, CAST(`Values`.`depth` AS FLOAT) AS `depth`, CAST(`Values`.`parent_id` AS FLOAT) AS `parent_id`, CAST(`Values`.`Score` AS FLOAT) AS `Score` 
FROM (SELECT 0 AS `node_id`, CAST(NULL AS STRING) AS `feature`, CAST(NULL AS FLOAT) AS `threshold`, 0 AS `depth`, CAST(NULL AS BIGINT) AS `parent_id`, 0.0014452841132879257 AS `Score`) AS `Values`), 
`DT_Output_12` AS 
...
`DT_node_data_13` AS 
(SELECT `Values`.`node_id` AS `node_id`, CAST(`Values`.`feature` AS FLOAT) AS `feature`, CAST(`Values`.`threshold` AS FLOAT) AS `threshold`, CAST(`Values`.`depth` AS FLOAT) AS `depth`, CAST(`Values`.`parent_id` AS FLOAT) AS `parent_id`, CAST(`Values`.`Score` AS FLOAT) AS `Score` 
FROM (SELECT 0 AS `node_id`, CAST(NULL AS STRING) AS `feature`, CAST(NULL AS FLOAT) AS `threshold`, 0 AS `depth`, CAST(NULL AS BIGINT) AS `parent_id`, 0.0013076885370537639 AS `Score`) AS `Values`), 
`DT_Output_13` AS 
...
`DT_node_data_14` AS 
(SELECT `Values`.`node_id` AS `node_id`, CAST(`Values`.`feature` AS FLOAT) AS `feature`, CAST(`Values`.`threshold` AS FLOAT) AS `threshold`, CAST(`Values`.`depth` AS FLOAT) AS `depth`, CAST(`Values`.`parent_id` AS FLOAT) AS `parent_id`, CAST(`Values`.`Score` AS FLOAT) AS `Score` 
FROM (SELECT 0 AS `node_id`, CAST(NULL AS STRING) AS `feature`, CAST(NULL AS FLOAT) AS `threshold`, 0 AS `depth`, CAST(NULL AS BIGINT) AS `parent_id`, 0.0011831921292468905 AS `Score`) AS `Values`), 
`DT_Output_14` AS 
...
`DT_node_data_15` AS 
(SELECT `Values`.`node_id` AS `node_id`, CAST(`Values`.`feature` AS FLOAT) AS `feature`, CAST(`Values`.`threshold` AS FLOAT) AS `threshold`, CAST(`Values`.`depth` AS FLOAT) AS `depth`, CAST(`Values`.`parent_id` AS FLOAT) AS `parent_id`, CAST(`Values`.`Score` AS FLOAT) AS `Score` 
FROM (SELECT 0 AS `node_id`, CAST(NULL AS STRING) AS `feature`, CAST(NULL AS FLOAT) AS `threshold`, 0 AS `depth`, CAST(NULL AS BIGINT) AS `parent_id`, 0.0010705525055527687 AS `Score`) AS `Values`), 
`DT_Output_15` AS 
...
-- Code For temporary table tmp_20180416231433_5bkp2j_xgb_b1 part 2/2. Populate

SELECT * FROM `tmp_20180416231433_5bkp2j_xgb_b1`

-- Code For temporary table tmp_20180416231433_4kio54_xgb_union part 1/2. Create 

CREATE TEMPORARY TABLE `tmp_20180416231433_4kio54_xgb_union` STORED AS ORC AS SELECT `XGB_Union`.`KEY`, `XGB_Union`.`Score_0` 
...
FROM `tmp_20180416231433_xlirl6_xgb_b0` AS `XGB_B0` UNION ALL SELECT `XGB_B1`.`KEY` AS `KEY`, `XGB_B1`.`Score_0` AS `Score_0` 
FROM `tmp_20180416231433_5bkp2j_xgb_b1` AS `XGB_B1`) AS `XGB_EnsembleUnion`) AS `XGB_Union`

-- Code For temporary table tmp_20180416231433_4kio54_xgb_union part 2/2. Populate

SELECT * FROM `tmp_20180416231433_4kio54_xgb_union`

-- Code For temporary table tmp_20180416231433_098ps3_xgb_sum part 1/2. Create 

CREATE TEMPORARY TABLE `tmp_20180416231433_098ps3_xgb_sum` STORED AS ORC AS SELECT `XGB_sum`.`KEY`, `XGB_sum`.`Score_0` 
...
FROM `tmp_20180416231433_4kio54_xgb_union` AS `XGB_Union` GROUP BY `XGB_Union`.`KEY`) AS `T`) AS `XGB_sum`

-- Code For temporary table tmp_20180416231433_098ps3_xgb_sum part 2/2. Populate

SELECT * FROM `tmp_20180416231433_098ps3_xgb_sum`
...
FROM `tmp_20180416231433_098ps3_xgb_sum` AS `XGB_sum`), 
