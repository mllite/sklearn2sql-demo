...
-- Code For temporary table TMP_20180416231433_HIK9GE_XGB_B part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180416231433_HIK9GE_XGB_B" (
	"KEY" BIGINT, 
	"Score_0" FLOAT
)
...
-- Code For temporary table TMP_20180416231433_HIK9GE_XGB_B part 2/2. Populate

INSERT INTO "TMP_20180416231433_HIK9GE_XGB_B" ("KEY", "Score_0") SELECT "U"."KEY", "U"."Score_0" 
...
-- Code For temporary table TMP_20180416231433_8816AE_XGB_B part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180416231433_8816AE_XGB_B" (
	"KEY" BIGINT, 
	"Score_0" FLOAT
)
...
-- Code For temporary table TMP_20180416231433_8816AE_XGB_B part 2/2. Populate

INSERT INTO "TMP_20180416231433_8816AE_XGB_B" ("KEY", "Score_0") SELECT "U"."KEY", "U"."Score_0" 
...
-- Code For temporary table TMP_20180416231433_LMQ9OI_XGB_U part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180416231433_LMQ9OI_XGB_U" (
	"KEY" BIGINT, 
	"Score_0" FLOAT
)
...
-- Code For temporary table TMP_20180416231433_LMQ9OI_XGB_U part 2/2. Populate

INSERT INTO "TMP_20180416231433_LMQ9OI_XGB_U" ("KEY", "Score_0") SELECT "U"."KEY", "U"."Score_0" 
...
FROM "TMP_20180416231433_HIK9GE_XGB_B" AS "XGB_B0" UNION ALL SELECT "XGB_B1"."KEY" AS "KEY", "XGB_B1"."Score_0" AS "Score_0" 
FROM "TMP_20180416231433_8816AE_XGB_B" AS "XGB_B1") AS "XGB_EnsembleUnion") AS "XGB_Union") AS "U"

-- Code For temporary table TMP_20180416231433_22ZP26_XGB_S part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180416231433_22ZP26_XGB_S" (
	"KEY" BIGINT, 
	"Score_0" FLOAT
)
...
-- Code For temporary table TMP_20180416231433_22ZP26_XGB_S part 2/2. Populate

INSERT INTO "TMP_20180416231433_22ZP26_XGB_S" ("KEY", "Score_0") SELECT "U"."KEY", "U"."Score_0" 
...
FROM "TMP_20180416231433_LMQ9OI_XGB_U" AS "XGB_Union" GROUP BY "XGB_Union"."KEY") AS "T") AS "XGB_sum") AS "U"
...
FROM "TMP_20180416231433_22ZP26_XGB_S" AS "XGB_sum"), 
