...
-- Code For temporary table tmp_20180416231433_uo3g4d_xgb_b0 part 1/2. Create 


CREATE TEMPORARY TABLE tmp_20180416231433_uo3g4d_xgb_b0 (
	"KEY" BIGINT, 
	"Score_0" FLOAT
)
...
-- Code For temporary table tmp_20180416231433_uo3g4d_xgb_b0 part 2/2. Populate

INSERT INTO tmp_20180416231433_uo3g4d_xgb_b0 ("KEY", "Score_0") SELECT "U"."KEY", "U"."Score_0" 
...
-- Code For temporary table tmp_20180416231433_shua0z_xgb_b1 part 1/2. Create 


CREATE TEMPORARY TABLE tmp_20180416231433_shua0z_xgb_b1 (
	"KEY" BIGINT, 
	"Score_0" FLOAT
)
...
-- Code For temporary table tmp_20180416231433_shua0z_xgb_b1 part 2/2. Populate

INSERT INTO tmp_20180416231433_shua0z_xgb_b1 ("KEY", "Score_0") SELECT "U"."KEY", "U"."Score_0" 
...
-- Code For temporary table tmp_20180416231433_z5w1ew_xgb_union part 1/2. Create 


CREATE TEMPORARY TABLE tmp_20180416231433_z5w1ew_xgb_union (
	"KEY" BIGINT, 
	"Score_0" FLOAT
)
...
-- Code For temporary table tmp_20180416231433_z5w1ew_xgb_union part 2/2. Populate

INSERT INTO tmp_20180416231433_z5w1ew_xgb_union ("KEY", "Score_0") SELECT "U"."KEY", "U"."Score_0" 
...
FROM tmp_20180416231433_uo3g4d_xgb_b0 AS "XGB_B0" UNION ALL SELECT "XGB_B1"."KEY" AS "KEY", "XGB_B1"."Score_0" AS "Score_0" 
FROM tmp_20180416231433_shua0z_xgb_b1 AS "XGB_B1") AS "XGB_EnsembleUnion") AS "XGB_Union") AS "U"

-- Code For temporary table tmp_20180416231433_mywykm_xgb_sum part 1/2. Create 


CREATE TEMPORARY TABLE tmp_20180416231433_mywykm_xgb_sum (
	"KEY" BIGINT NOT NULL, 
	"Score_0" FLOAT, 
	PRIMARY KEY ("KEY")
)
...
-- Code For temporary table tmp_20180416231433_mywykm_xgb_sum part 2/2. Populate

INSERT INTO tmp_20180416231433_mywykm_xgb_sum ("KEY", "Score_0") SELECT "U"."KEY", "U"."Score_0" 
...
FROM tmp_20180416231433_z5w1ew_xgb_union AS "XGB_Union" GROUP BY "XGB_Union"."KEY") AS "T") AS "XGB_sum") AS "U"
...
FROM tmp_20180416231433_mywykm_xgb_sum AS "XGB_sum"), 
