...
-- Code For temporary table tmp_20180417055150_6jhytm_xgb_ part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180417055150_6jhytm_xgb_  (
	"KEY" BIGINT, 
	"Score_CLASS_0" FLOAT, 
	"Score_CLASS_1" FLOAT, 
	"Score_CLASS_2" FLOAT
...
-- Code For temporary table tmp_20180417055150_6jhytm_xgb_ part 2/2. Populate

INSERT INTO tmp_20180417055150_6jhytm_xgb_ ("KEY", "Score_CLASS_0", "Score_CLASS_1", "Score_CLASS_2") SELECT "U"."KEY", "U"."Score_CLASS_0", "U"."Score_CLASS_1", "U"."Score_CLASS_2" 
...
-- Code For temporary table tmp_20180417055150_j85xvp_xgb_ part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180417055150_j85xvp_xgb_  (
	"KEY" BIGINT, 
	"Score_CLASS_0" FLOAT, 
	"Score_CLASS_1" FLOAT, 
	"Score_CLASS_2" FLOAT
...
-- Code For temporary table tmp_20180417055150_j85xvp_xgb_ part 2/2. Populate

INSERT INTO tmp_20180417055150_j85xvp_xgb_ ("KEY", "Score_CLASS_0", "Score_CLASS_1", "Score_CLASS_2") SELECT "U"."KEY", "U"."Score_CLASS_0", "U"."Score_CLASS_1", "U"."Score_CLASS_2" 
...
-- Code For temporary table tmp_20180417055150_x2l7jg_xgb_ part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180417055150_x2l7jg_xgb_  (
	"KEY" BIGINT, 
	"Score_CLASS_0" FLOAT, 
	"Score_CLASS_1" FLOAT, 
	"Score_CLASS_2" FLOAT
...
-- Code For temporary table tmp_20180417055150_x2l7jg_xgb_ part 2/2. Populate

INSERT INTO tmp_20180417055150_x2l7jg_xgb_ ("KEY", "Score_CLASS_0", "Score_CLASS_1", "Score_CLASS_2") SELECT "U"."KEY", "U"."Score_CLASS_0", "U"."Score_CLASS_1", "U"."Score_CLASS_2" 
...
-- Code For temporary table tmp_20180417055150_mlr385_xgb_ part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180417055150_mlr385_xgb_  (
	"KEY" BIGINT, 
	"Score_CLASS_0" FLOAT, 
	"Score_CLASS_1" FLOAT, 
	"Score_CLASS_2" FLOAT
...
-- Code For temporary table tmp_20180417055150_mlr385_xgb_ part 2/2. Populate

INSERT INTO tmp_20180417055150_mlr385_xgb_ ("KEY", "Score_CLASS_0", "Score_CLASS_1", "Score_CLASS_2") SELECT "U"."KEY", "U"."Score_CLASS_0", "U"."Score_CLASS_1", "U"."Score_CLASS_2" 
...
-- Code For temporary table tmp_20180417055150_yy9k0e_xgb_ part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180417055150_yy9k0e_xgb_  (
	"KEY" BIGINT, 
	"Score_CLASS_0" FLOAT, 
	"Score_CLASS_1" FLOAT, 
	"Score_CLASS_2" FLOAT
...
-- Code For temporary table tmp_20180417055150_yy9k0e_xgb_ part 2/2. Populate

INSERT INTO tmp_20180417055150_yy9k0e_xgb_ ("KEY", "Score_CLASS_0", "Score_CLASS_1", "Score_CLASS_2") SELECT "U"."KEY", "U"."Score_CLASS_0", "U"."Score_CLASS_1", "U"."Score_CLASS_2" 
...
-- Code For temporary table tmp_20180417055150_vcwnk9_xgb_ part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180417055150_vcwnk9_xgb_  (
	"KEY" BIGINT, 
	"Score_CLASS_0" FLOAT, 
	"Score_CLASS_1" FLOAT, 
	"Score_CLASS_2" FLOAT
...
-- Code For temporary table tmp_20180417055150_vcwnk9_xgb_ part 2/2. Populate

INSERT INTO tmp_20180417055150_vcwnk9_xgb_ ("KEY", "Score_CLASS_0", "Score_CLASS_1", "Score_CLASS_2") SELECT "U"."KEY", "U"."Score_CLASS_0", "U"."Score_CLASS_1", "U"."Score_CLASS_2" 
...
FROM tmp_20180417055150_6jhytm_xgb_ AS "XGB_B0" UNION ALL SELECT "XGB_B1"."KEY" AS "KEY", "XGB_B1"."Score_CLASS_0" AS "Score_CLASS_0", "XGB_B1"."Score_CLASS_1" AS "Score_CLASS_1", "XGB_B1"."Score_CLASS_2" AS "Score_CLASS_2" 
FROM tmp_20180417055150_j85xvp_xgb_ AS "XGB_B1" UNION ALL SELECT "XGB_B2"."KEY" AS "KEY", "XGB_B2"."Score_CLASS_0" AS "Score_CLASS_0", "XGB_B2"."Score_CLASS_1" AS "Score_CLASS_1", "XGB_B2"."Score_CLASS_2" AS "Score_CLASS_2" 
FROM tmp_20180417055150_x2l7jg_xgb_ AS "XGB_B2" UNION ALL SELECT "XGB_B3"."KEY" AS "KEY", "XGB_B3"."Score_CLASS_0" AS "Score_CLASS_0", "XGB_B3"."Score_CLASS_1" AS "Score_CLASS_1", "XGB_B3"."Score_CLASS_2" AS "Score_CLASS_2" 
FROM tmp_20180417055150_mlr385_xgb_ AS "XGB_B3" UNION ALL SELECT "XGB_B4"."KEY" AS "KEY", "XGB_B4"."Score_CLASS_0" AS "Score_CLASS_0", "XGB_B4"."Score_CLASS_1" AS "Score_CLASS_1", "XGB_B4"."Score_CLASS_2" AS "Score_CLASS_2" 
FROM tmp_20180417055150_yy9k0e_xgb_ AS "XGB_B4") AS "XGB_EnsembleUnion") AS "XGB_Union") AS "U"

-- Code For temporary table tmp_20180417055150_unzwv8_xgb_ part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180417055150_unzwv8_xgb_  (
	"KEY" BIGINT, 
	"Score_CLASS_0" FLOAT, 
	"Score_CLASS_1" FLOAT, 
	"Score_CLASS_2" FLOAT
...
-- Code For temporary table tmp_20180417055150_unzwv8_xgb_ part 2/2. Populate

INSERT INTO tmp_20180417055150_unzwv8_xgb_ ("KEY", "Score_CLASS_0", "Score_CLASS_1", "Score_CLASS_2") SELECT "U"."KEY", "U"."Score_CLASS_0", "U"."Score_CLASS_1", "U"."Score_CLASS_2" 
...
FROM tmp_20180417055150_vcwnk9_xgb_ AS "XGB_Union" GROUP BY "XGB_Union"."KEY") AS "T") AS "XGB_sum") AS "U"
...
FROM tmp_20180417055150_unzwv8_xgb_ AS "XGB_sum"), 
