...
-- Code For temporary table TMP_20180417012934_WBWBLQ_ADS_imp_1_OUT part 1/2. Create 


CREATE TEMPORARY TABLE `TMP_20180417012934_WBWBLQ_ADS_imp_1_OUT` (
	`KEY` BIGINT NOT NULL, 
	impter_2 DOUBLE, 
	impter_3 DOUBLE, 
	impter_4 DOUBLE, 
...
-- Code For temporary table TMP_20180417012934_7XUEY0_ADS_sca_2_OUT part 1/2. Create 


CREATE TEMPORARY TABLE `TMP_20180417012934_7XUEY0_ADS_sca_2_OUT` (
	`KEY` BIGINT NOT NULL, 
	scaler_2 DOUBLE, 
	scaler_3 DOUBLE, 
	scaler_4 DOUBLE, 
...
FROM `TMP_20180417012934_WBWBLQ_ADS_imp_1_OUT` AS `ADS_imp_1_OUT`) AS `ADS_sca_2_OUT`) AS `U`

-- Model deployment code

WITH dummy_class_reg_cte AS 
(SELECT `ADS_sca_2_OUT`.`KEY` AS `KEY`, -11.471614782695335 AS `Constant` 
FROM `TMP_20180417012934_7XUEY0_ADS_sca_2_OUT` AS `ADS_sca_2_OUT`)
