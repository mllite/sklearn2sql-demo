...
-- Code For temporary table tmp_20180417012935_7revau_ads_ part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180417012935_7revau_ads_  (
	"KEY" BIGINT, 
	impter_2 FLOAT, 
	impter_3 FLOAT, 
	impter_4 FLOAT, 
...
-- Code For temporary table tmp_20180417012935_mzcyuf_ads_ part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180417012935_mzcyuf_ads_  (
	"KEY" BIGINT, 
	scaler_2 FLOAT, 
	scaler_3 FLOAT, 
	scaler_4 FLOAT, 
...
FROM tmp_20180417012935_7revau_ads_ AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT") AS "U"

-- Model deployment code

WITH dummy_class_reg_cte AS 
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", -11.471614782695333 AS "Constant" 
FROM tmp_20180417012935_mzcyuf_ads_ AS "ADS_sca_2_OUT")
