...
-- Code For temporary table tmp_20180417023550_rsr1ns_ads_imp_1_out part 1/2. Create 


CREATE TEMPORARY TABLE tmp_20180417023550_rsr1ns_ads_imp_1_out (
	"KEY" BIGINT NOT NULL, 
	impter_2 FLOAT, 
	impter_3 FLOAT, 
	impter_4 FLOAT, 
...
-- Code For temporary table tmp_20180417023550_rsr1ns_ads_imp_1_out part 2/2. Populate

INSERT INTO tmp_20180417023550_rsr1ns_ads_imp_1_out ("KEY", impter_2, impter_3, impter_4, impter_5, impter_6, impter_7, impter_8, impter_9, impter_10, impter_11, impter_12, impter_13, impter_14) SELECT "U"."KEY", "U".impter_2, "U".impter_3, "U".impter_4, "U".impter_5, "U".impter_6, "U".impter_7, "U".impter_8, "U".impter_9, "U".impter_10, "U".impter_11, "U".impter_12, "U".impter_13, "U".impter_14 
...
-- Code For temporary table tmp_20180417023550_aw4wwv_ads_sca_2_out part 1/2. Create 


CREATE TEMPORARY TABLE tmp_20180417023550_aw4wwv_ads_sca_2_out (
	"KEY" BIGINT NOT NULL, 
	scaler_2 FLOAT, 
	scaler_3 FLOAT, 
	scaler_4 FLOAT, 
...
FROM tmp_20180417023550_rsr1ns_ads_imp_1_out AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT") AS "U"

-- Model deployment code

WITH dummy_class_reg_cte AS 
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", 22.5789603960396 AS "Constant" 
FROM tmp_20180417023550_aw4wwv_ads_sca_2_out AS "ADS_sca_2_OUT")
