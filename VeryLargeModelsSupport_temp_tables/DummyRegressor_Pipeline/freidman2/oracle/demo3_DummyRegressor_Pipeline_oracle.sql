...
-- Code For temporary table 40423_MSPVQ8_ADS_IMP_1_OUT part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE "40423_MSPVQ8_ADS_IMP_1_OUT" (
...
-- Code For temporary table 40423_MSPVQ8_ADS_IMP_1_OUT part 2/2. Populate

INSERT INTO "40423_MSPVQ8_ADS_IMP_1_OUT" ("KEY", imputer_output_2, imputer_output_3, imputer_output_4, imputer_output_5) SELECT "U"."KEY", "U".imputer_output_2, "U".imputer_output_3, "U".imputer_output_4, "U".imputer_output_5 
...
-- Code For temporary table 40423_3Z1KJI_ADS_SCA_2_OUT part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE "40423_3Z1KJI_ADS_SCA_2_OUT" (
	"KEY" NUMBER(19) NOT NULL, 
...
-- Code For temporary table 40423_3Z1KJI_ADS_SCA_2_OUT part 2/2. Populate

INSERT INTO "40423_3Z1KJI_ADS_SCA_2_OUT" ("KEY", scaler_output_2, scaler_output_3, scaler_output_4, scaler_output_5) SELECT "U"."KEY", "U".scaler_output_2, "U".scaler_output_3, "U".scaler_output_4, "U".scaler_output_5 
...
FROM "40423_MSPVQ8_ADS_IMP_1_OUT" "ADS_imp_1_OUT") "ADS_sca_2_OUT") "U"

-- Model deployment code

WITH dummy_class_reg_cte AS 
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", 499.09288446517394 AS "Constant" 
FROM "40423_3Z1KJI_ADS_SCA_2_OUT" "ADS_sca_2_OUT")
