...
-- Code For temporary table TMP_20180417042416_NOQ82O_KernAgg_B0 part 1/2. Create 


CREATE TEMPORARY TABLE `TMP_20180417042416_NOQ82O_KernAgg_B0` (
	`KEY` BIGINT, 
	`OVO_Class1` BIGINT, 
	`OVO_Class2` BIGINT, 
	`OVO_Decision` BIGINT, 
...
-- Code For temporary table TMP_20180417042416_NOQ82O_KernAgg_B0 part 2/2. Populate

INSERT INTO `TMP_20180417042416_NOQ82O_KernAgg_B0` (`KEY`, `OVO_Class1`, `OVO_Class2`, `OVO_Decision`, `OVO_Confidence`) SELECT `U`.`KEY`, `U`.`OVO_Class1`, `U`.`OVO_Class2`, `U`.`OVO_Decision`, `U`.`OVO_Confidence` 
...
FROM (SELECT full_join_data_sv.`KEY` AS `KEY`, sum(full_join_data_sv.dot_prod1) + 1.1361099459962782 AS dot_product 
...
FROM (SELECT full_join_data_sv_1.`KEY` AS `KEY`, sum(full_join_data_sv_1.dot_prod1) + 1.1844509506518808 AS dot_product 
...
FROM (SELECT full_join_data_sv_2.`KEY` AS `KEY`, sum(full_join_data_sv_2.dot_prod1) + 5.246021085266416 AS dot_product 
...
-- Code For temporary table TMP_20180417042416_7IMSW5_KernAgg_Union part 1/2. Create 


CREATE TEMPORARY TABLE `TMP_20180417042416_7IMSW5_KernAgg_Union` (
	`KEY` BIGINT, 
	`OVO_Class1` BIGINT, 
	`OVO_Class2` BIGINT, 
	`OVO_Decision` BIGINT, 
...
-- Code For temporary table TMP_20180417042416_7IMSW5_KernAgg_Union part 2/2. Populate

INSERT INTO `TMP_20180417042416_7IMSW5_KernAgg_Union` (`KEY`, `OVO_Class1`, `OVO_Class2`, `OVO_Decision`, `OVO_Confidence`) SELECT `U`.`KEY`, `U`.`OVO_Class1`, `U`.`OVO_Class2`, `U`.`OVO_Decision`, `U`.`OVO_Confidence` 
...
FROM `TMP_20180417042416_NOQ82O_KernAgg_B0` AS `KernAgg_B0`) AS `KernAgg_EnsembleUnion`) AS `KernAgg_Union`) AS `U`

-- Code For temporary table TMP_20180417042416_68OMBG_KernAgg part 1/2. Create 


CREATE TEMPORARY TABLE `TMP_20180417042416_68OMBG_KernAgg` (
	`KEY` BIGINT NOT NULL, 
	`OVO_Vote_0` BIGINT, 
...
FROM `TMP_20180417042416_7IMSW5_KernAgg_Union` AS `KernAgg_Union` GROUP BY `KernAgg_Union`.`KEY`) AS `Votes_Sel`), 
`OVO_SumConf_CTE` AS 
...
FROM `TMP_20180417042416_68OMBG_KernAgg` AS `KernAgg`), 
