...
-- Code For temporary table tmp_20180417042417_e0anud_kernagg_b0 part 1/2. Create 

CREATE TEMPORARY TABLE `tmp_20180417042417_e0anud_kernagg_b0` STORED AS ORC AS WITH `kernel_input` AS 
...
-- Code For temporary table tmp_20180417042417_e0anud_kernagg_b0 part 2/2. Populate

SELECT * FROM `tmp_20180417042417_e0anud_kernagg_b0`

-- Code For temporary table tmp_20180417042417_shl9lv_kernagg_union part 1/2. Create 

CREATE TEMPORARY TABLE `tmp_20180417042417_shl9lv_kernagg_union` STORED AS ORC AS SELECT `KernAgg_Union`.`KEY`, `KernAgg_Union`.`OVO_Class1`, `KernAgg_Union`.`OVO_Class2`, `KernAgg_Union`.`OVO_Decision`, `KernAgg_Union`.`OVO_Confidence` 
...
FROM `tmp_20180417042417_e0anud_kernagg_b0` AS `KernAgg_B0`) AS `KernAgg_EnsembleUnion`) AS `KernAgg_Union`

-- Code For temporary table tmp_20180417042417_shl9lv_kernagg_union part 2/2. Populate

SELECT * FROM `tmp_20180417042417_shl9lv_kernagg_union`

-- Code For temporary table tmp_20180417042417_fliqhp_kernagg part 1/2. Create 

CREATE TEMPORARY TABLE `tmp_20180417042417_fliqhp_kernagg` STORED AS ORC AS WITH `OVO_Votes` AS 
...
FROM `tmp_20180417042417_shl9lv_kernagg_union` AS `KernAgg_Union` GROUP BY `KernAgg_Union`.`KEY`) AS `Votes_Sel`), 
`OVO_SumConf_CTE` AS 
...
-- Code For temporary table tmp_20180417042417_fliqhp_kernagg part 2/2. Populate

SELECT * FROM `tmp_20180417042417_fliqhp_kernagg`
...
FROM `tmp_20180417042417_fliqhp_kernagg` AS `KernAgg`), 
