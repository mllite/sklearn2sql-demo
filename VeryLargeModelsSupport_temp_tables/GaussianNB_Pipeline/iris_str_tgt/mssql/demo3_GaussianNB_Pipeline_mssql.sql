...
-- Code For temporary table ##TMP_20180417051006_6Q55EJ_ADS_imp_1_OUT part 1/2. Create 


CREATE TABLE ##TMP_20180417051006_6Q55EJ_ADS_imp_1_OUT (
	[KEY] BIGINT NULL, 
...
-- Code For temporary table ##TMP_20180417051006_6Q55EJ_ADS_imp_1_OUT part 2/2. Populate

INSERT INTO ##TMP_20180417051006_6Q55EJ_ADS_imp_1_OUT ([KEY], imputer_output_2, imputer_output_3, imputer_output_4, imputer_output_5) SELECT [ADS_imp_1_OUT].[KEY], [ADS_imp_1_OUT].imputer_output_2, [ADS_imp_1_OUT].imputer_output_3, [ADS_imp_1_OUT].imputer_output_4, [ADS_imp_1_OUT].imputer_output_5 
...
-- Code For temporary table ##TMP_20180417051006_TCO87N_ADS_sca_2_OUT part 1/2. Create 


CREATE TABLE ##TMP_20180417051006_TCO87N_ADS_sca_2_OUT (
	[KEY] BIGINT NULL, 
...
-- Code For temporary table ##TMP_20180417051006_TCO87N_ADS_sca_2_OUT part 2/2. Populate

INSERT INTO ##TMP_20180417051006_TCO87N_ADS_sca_2_OUT ([KEY], scaler_output_2, scaler_output_3, scaler_output_4, scaler_output_5) SELECT [ADS_sca_2_OUT].[KEY], [ADS_sca_2_OUT].scaler_output_2, [ADS_sca_2_OUT].scaler_output_3, [ADS_sca_2_OUT].scaler_output_4, [ADS_sca_2_OUT].scaler_output_5 
...
FROM ##TMP_20180417051006_6Q55EJ_ADS_imp_1_OUT AS [ADS_imp_1_OUT]) AS [ADS_sca_2_OUT]

-- Model deployment code

WITH [RawScores] AS 
(SELECT [ADS_sca_2_OUT].[KEY] AS [KEY], CAST(NULL AS FLOAT(53)) AS [LogProba_CLASS_0], CAST(NULL AS FLOAT(53)) AS [Proba_CLASS_0], -1.1765738301378215 + (-0.5 * 0.10397266098536322 - (0.5 * (CAST([ADS_sca_2_OUT].scaler_output_2 AS FLOAT(53)) - -1.0737587745357238) * (CAST([ADS_sca_2_OUT].scaler_output_2 AS FLOAT(53)) - -1.0737587745357238)) / 0.17659356929665943) + (-0.5 * 1.6176992712861724 - (0.5 * (CAST([ADS_sca_2_OUT].scaler_output_3 AS FLOAT(53)) - 0.870008970111042) * (CAST([ADS_sca_2_OUT].scaler_output_3 AS FLOAT(53)) - 0.870008970111042)) / 0.8023761267174477) + (-0.5 * -2.8627124529802606 - (0.5 * (CAST([ADS_sca_2_OUT].scaler_output_4 AS FLOAT(53)) - -1.3793950932290453) * (CAST([ADS_sca_2_OUT].scaler_output_4 AS FLOAT(53)) - -1.3793950932290453)) / 0.009089916839634978) + (-0.5 * -1.9540850615939565 - (0.5 * (CAST([ADS_sca_2_OUT].scaler_output_5 AS FLOAT(53)) - -1.3142779871589043) * (CAST([ADS_sca_2_OUT].scaler_output_5 AS FLOAT(53)) - -1.3142779871589043)) / 0.022551309855470963) AS [Score_CLASS_0], CAST(NULL AS FLOAT(53)) AS [LogProba_CLASS_1], CAST(NULL AS FLOAT(53)) AS [Proba_CLASS_1], -1.0986122886681098 + (-0.5 * 0.9876234284885649 - (0.5 * (CAST([ADS_sca_2_OUT].scaler_output_2 AS FLOAT(53)) - 0.08161645102040865) * (CAST([ADS_sca_2_OUT].scaler_output_2 AS FLOAT(53)) - 0.08161645102040865)) / 0.4273065370611847) + (-0.5 * 1.2703633982695903 - (0.5 * (CAST([ADS_sca_2_OUT].scaler_output_3 AS FLOAT(53)) - -0.6341793371020635) * (CAST([ADS_sca_2_OUT].scaler_output_3 AS FLOAT(53)) - -0.6341793371020635)) / 0.566933272060774) + (-0.5 * -0.704680569700576 - (0.5 * (CAST([ADS_sca_2_OUT].scaler_output_4 AS FLOAT(53)) - 0.23394313160820315) * (CAST([ADS_sca_2_OUT].scaler_output_4 AS FLOAT(53)) - 0.23394313160820315)) / 0.0786649459713098) + (-0.5 * -0.7476146898927448 - (0.5 * (CAST([ADS_sca_2_OUT].scaler_output_5 AS FLOAT(53)) - 0.10668484415166186) * (CAST([ADS_sca_2_OUT].scaler_output_5 AS FLOAT(53)) - 0.10668484415166186)) / 0.07535901221863746) AS [Score_CLASS_1], CAST(NULL AS FLOAT(53)) AS [LogProba_CLASS_2], CAST(NULL AS FLOAT(53)) AS [Proba_CLASS_2], -1.0262916270884836 + (-0.5 * 1.1913340818433376 - (0.5 * (CAST([ADS_sca_2_OUT].scaler_output_2 AS FLOAT(53)) - 0.8480096887675768) * (CAST([ADS_sca_2_OUT].scaler_output_2 AS FLOAT(53)) - 0.8480096887675768)) / 0.5238536201393055) + (-0.5 * 1.188361783672836 - (0.5 * (CAST([ADS_sca_2_OUT].scaler_output_3 AS FLOAT(53)) - -0.15867810255873832) * (CAST([ADS_sca_2_OUT].scaler_output_3 AS FLOAT(53)) - -0.15867810255873832)) / 0.5222988826987977) + (-0.5 * -0.6630042730802398 - (0.5 * (CAST([ADS_sca_2_OUT].scaler_output_4 AS FLOAT(53)) - 0.9692998415150353) * (CAST([ADS_sca_2_OUT].scaler_output_4 AS FLOAT(53)) - 0.9692998415150353)) / 0.08201268574388819) + (-0.5 * -0.1282298413813872 - (0.5 * (CAST([ADS_sca_2_OUT].scaler_output_5 AS FLOAT(53)) - 1.0316486455537892) * (CAST([ADS_sca_2_OUT].scaler_output_5 AS FLOAT(53)) - 1.0316486455537892)) / 0.14000083280397102) AS [Score_CLASS_2] 
FROM ##TMP_20180417051006_TCO87N_ADS_sca_2_OUT AS [ADS_sca_2_OUT]), 
orig_cte AS 
