...
-- Code For temporary table tmp_20180417051007_fx7err_ads_ part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180417051007_fx7err_ads_  (
	"KEY" BIGINT, 
...
-- Code For temporary table tmp_20180417051007_fx7err_ads_ part 2/2. Populate

INSERT INTO tmp_20180417051007_fx7err_ads_ ("KEY", imputer_output_2, imputer_output_3, imputer_output_4, imputer_output_5) SELECT "U"."KEY", "U".imputer_output_2, "U".imputer_output_3, "U".imputer_output_4, "U".imputer_output_5 
...
-- Code For temporary table tmp_20180417051007_qlae67_ads_ part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180417051007_qlae67_ads_  (
	"KEY" BIGINT, 
...
-- Code For temporary table tmp_20180417051007_qlae67_ads_ part 2/2. Populate

INSERT INTO tmp_20180417051007_qlae67_ads_ ("KEY", scaler_output_2, scaler_output_3, scaler_output_4, scaler_output_5) SELECT "U"."KEY", "U".scaler_output_2, "U".scaler_output_3, "U".scaler_output_4, "U".scaler_output_5 
...
FROM tmp_20180417051007_fx7err_ads_ AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT") AS "U"

-- Model deployment code

WITH "RawScores" AS 
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", CAST(NULL AS FLOAT) AS "LogProba_CLASS_0", CAST(NULL AS FLOAT) AS "Proba_CLASS_0", -1.176573830137822 + (-0.5 * 0.103972660985363 - (0.5 * (CAST("ADS_sca_2_OUT".scaler_output_2 AS FLOAT) - -1.073758774535724) * (CAST("ADS_sca_2_OUT".scaler_output_2 AS FLOAT) - -1.073758774535724)) / 0.17659356929665943) + (-0.5 * 1.617699271286172 - (0.5 * (CAST("ADS_sca_2_OUT".scaler_output_3 AS FLOAT) - 0.870008970111042) * (CAST("ADS_sca_2_OUT".scaler_output_3 AS FLOAT) - 0.870008970111042)) / 0.8023761267174477) + (-0.5 * -2.86271245298026 - (0.5 * (CAST("ADS_sca_2_OUT".scaler_output_4 AS FLOAT) - -1.379395093229045) * (CAST("ADS_sca_2_OUT".scaler_output_4 AS FLOAT) - -1.379395093229045)) / 0.009089916839634978) + (-0.5 * -1.954085061593956 - (0.5 * (CAST("ADS_sca_2_OUT".scaler_output_5 AS FLOAT) - -1.314277987158904) * (CAST("ADS_sca_2_OUT".scaler_output_5 AS FLOAT) - -1.314277987158904)) / 0.022551309855470963) AS "Score_CLASS_0", CAST(NULL AS FLOAT) AS "LogProba_CLASS_1", CAST(NULL AS FLOAT) AS "Proba_CLASS_1", -1.09861228866811 + (-0.5 * 0.987623428488565 - (0.5 * (CAST("ADS_sca_2_OUT".scaler_output_2 AS FLOAT) - 0.081616451020409) * (CAST("ADS_sca_2_OUT".scaler_output_2 AS FLOAT) - 0.081616451020409)) / 0.4273065370611847) + (-0.5 * 1.27036339826959 - (0.5 * (CAST("ADS_sca_2_OUT".scaler_output_3 AS FLOAT) - -0.634179337102064) * (CAST("ADS_sca_2_OUT".scaler_output_3 AS FLOAT) - -0.634179337102064)) / 0.566933272060774) + (-0.5 * -0.704680569700576 - (0.5 * (CAST("ADS_sca_2_OUT".scaler_output_4 AS FLOAT) - 0.233943131608203) * (CAST("ADS_sca_2_OUT".scaler_output_4 AS FLOAT) - 0.233943131608203)) / 0.0786649459713098) + (-0.5 * -0.747614689892745 - (0.5 * (CAST("ADS_sca_2_OUT".scaler_output_5 AS FLOAT) - 0.106684844151662) * (CAST("ADS_sca_2_OUT".scaler_output_5 AS FLOAT) - 0.106684844151662)) / 0.07535901221863746) AS "Score_CLASS_1", CAST(NULL AS FLOAT) AS "LogProba_CLASS_2", CAST(NULL AS FLOAT) AS "Proba_CLASS_2", -1.026291627088484 + (-0.5 * 1.191334081843338 - (0.5 * (CAST("ADS_sca_2_OUT".scaler_output_2 AS FLOAT) - 0.848009688767577) * (CAST("ADS_sca_2_OUT".scaler_output_2 AS FLOAT) - 0.848009688767577)) / 0.5238536201393055) + (-0.5 * 1.188361783672836 - (0.5 * (CAST("ADS_sca_2_OUT".scaler_output_3 AS FLOAT) - -0.158678102558738) * (CAST("ADS_sca_2_OUT".scaler_output_3 AS FLOAT) - -0.158678102558738)) / 0.5222988826987977) + (-0.5 * -0.66300427308024 - (0.5 * (CAST("ADS_sca_2_OUT".scaler_output_4 AS FLOAT) - 0.969299841515035) * (CAST("ADS_sca_2_OUT".scaler_output_4 AS FLOAT) - 0.969299841515035)) / 0.08201268574388819) + (-0.5 * -0.128229841381387 - (0.5 * (CAST("ADS_sca_2_OUT".scaler_output_5 AS FLOAT) - 1.031648645553789) * (CAST("ADS_sca_2_OUT".scaler_output_5 AS FLOAT) - 1.031648645553789)) / 0.14000083280397102) AS "Score_CLASS_2" 
FROM tmp_20180417051007_qlae67_ads_ AS "ADS_sca_2_OUT"), 
orig_cte AS 
