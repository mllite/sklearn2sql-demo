...
-- Code For temporary table tmp_20180417042437_ckljtp_ads_ part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180417042437_ckljtp_ads_  (
	"KEY" BIGINT, 
...
-- Code For temporary table tmp_20180417042437_ckljtp_ads_ part 2/2. Populate

INSERT INTO tmp_20180417042437_ckljtp_ads_ ("KEY", imputer_output_2, imputer_output_3, imputer_output_4, imputer_output_5) SELECT "U"."KEY", "U".imputer_output_2, "U".imputer_output_3, "U".imputer_output_4, "U".imputer_output_5 
...
-- Code For temporary table tmp_20180417042437_muqy3r_ads_ part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180417042437_muqy3r_ads_  (
	"KEY" BIGINT, 
...
-- Code For temporary table tmp_20180417042437_muqy3r_ads_ part 2/2. Populate

INSERT INTO tmp_20180417042437_muqy3r_ads_ ("KEY", scaler_output_2, scaler_output_3, scaler_output_4, scaler_output_5) SELECT "U"."KEY", "U".scaler_output_2, "U".scaler_output_3, "U".scaler_output_4, "U".scaler_output_5 
...
FROM tmp_20180417042437_ckljtp_ads_ AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT") AS "U"

-- Code For temporary table tmp_20180417042438_nisthe_xgb_ part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180417042438_nisthe_xgb_  (
	"KEY" BIGINT, 
	"Score_0" FLOAT, 
	"Score_1" FLOAT, 
	"Score_2" FLOAT
...
-- Code For temporary table tmp_20180417042438_nisthe_xgb_ part 2/2. Populate

INSERT INTO tmp_20180417042438_nisthe_xgb_ ("KEY", "Score_0", "Score_1", "Score_2") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1", "U"."Score_2" 
...
FROM tmp_20180417042437_muqy3r_ads_ AS "ADS_sca_2_OUT"), 
"DT_node_data" AS 
...
-- Code For temporary table tmp_20180417042438_2jnhci_xgb_ part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180417042438_2jnhci_xgb_  (
	"KEY" BIGINT, 
	"Score_0" FLOAT, 
	"Score_1" FLOAT, 
	"Score_2" FLOAT
...
-- Code For temporary table tmp_20180417042438_2jnhci_xgb_ part 2/2. Populate

INSERT INTO tmp_20180417042438_2jnhci_xgb_ ("KEY", "Score_0", "Score_1", "Score_2") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1", "U"."Score_2" 
...
-- Code For temporary table tmp_20180417042438_yf2zj5_xgb_ part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180417042438_yf2zj5_xgb_  (
	"KEY" BIGINT, 
	"Score_0" FLOAT, 
	"Score_1" FLOAT, 
	"Score_2" FLOAT
...
-- Code For temporary table tmp_20180417042438_yf2zj5_xgb_ part 2/2. Populate

INSERT INTO tmp_20180417042438_yf2zj5_xgb_ ("KEY", "Score_0", "Score_1", "Score_2") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1", "U"."Score_2" 
...
-- Code For temporary table tmp_20180417042438_0ffqu3_xgb_ part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180417042438_0ffqu3_xgb_  (
	"KEY" BIGINT, 
	"Score_0" FLOAT, 
	"Score_1" FLOAT, 
	"Score_2" FLOAT
...
-- Code For temporary table tmp_20180417042438_0ffqu3_xgb_ part 2/2. Populate

INSERT INTO tmp_20180417042438_0ffqu3_xgb_ ("KEY", "Score_0", "Score_1", "Score_2") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1", "U"."Score_2" 
...
-- Code For temporary table tmp_20180417042438_zbft1m_xgb_ part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180417042438_zbft1m_xgb_  (
	"KEY" BIGINT, 
	"Score_0" FLOAT, 
	"Score_1" FLOAT, 
	"Score_2" FLOAT
...
-- Code For temporary table tmp_20180417042438_zbft1m_xgb_ part 2/2. Populate

INSERT INTO tmp_20180417042438_zbft1m_xgb_ ("KEY", "Score_0", "Score_1", "Score_2") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1", "U"."Score_2" 
...
-- Code For temporary table tmp_20180417042438_gxc2pv_xgb_ part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180417042438_gxc2pv_xgb_  (
	"KEY" BIGINT, 
	"Score_0" FLOAT, 
	"Score_1" FLOAT, 
	"Score_2" FLOAT
...
-- Code For temporary table tmp_20180417042438_gxc2pv_xgb_ part 2/2. Populate

INSERT INTO tmp_20180417042438_gxc2pv_xgb_ ("KEY", "Score_0", "Score_1", "Score_2") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1", "U"."Score_2" 
...
FROM tmp_20180417042438_nisthe_xgb_ AS "XGB_B0" UNION ALL SELECT "XGB_B1"."KEY" AS "KEY", "XGB_B1"."Score_0" AS "Score_0", "XGB_B1"."Score_1" AS "Score_1", "XGB_B1"."Score_2" AS "Score_2" 
FROM tmp_20180417042438_2jnhci_xgb_ AS "XGB_B1" UNION ALL SELECT "XGB_B2"."KEY" AS "KEY", "XGB_B2"."Score_0" AS "Score_0", "XGB_B2"."Score_1" AS "Score_1", "XGB_B2"."Score_2" AS "Score_2" 
FROM tmp_20180417042438_yf2zj5_xgb_ AS "XGB_B2" UNION ALL SELECT "XGB_B3"."KEY" AS "KEY", "XGB_B3"."Score_0" AS "Score_0", "XGB_B3"."Score_1" AS "Score_1", "XGB_B3"."Score_2" AS "Score_2" 
FROM tmp_20180417042438_0ffqu3_xgb_ AS "XGB_B3" UNION ALL SELECT "XGB_B4"."KEY" AS "KEY", "XGB_B4"."Score_0" AS "Score_0", "XGB_B4"."Score_1" AS "Score_1", "XGB_B4"."Score_2" AS "Score_2" 
FROM tmp_20180417042438_zbft1m_xgb_ AS "XGB_B4") AS "XGB_EnsembleUnion") AS "XGB_Union") AS "U"

-- Code For temporary table tmp_20180417042438_ssvrwr_xgb_ part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180417042438_ssvrwr_xgb_  (
	"KEY" BIGINT, 
	"Score_0" FLOAT, 
	"Score_1" FLOAT, 
	"Score_2" FLOAT
...
-- Code For temporary table tmp_20180417042438_ssvrwr_xgb_ part 2/2. Populate

INSERT INTO tmp_20180417042438_ssvrwr_xgb_ ("KEY", "Score_0", "Score_1", "Score_2") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1", "U"."Score_2" 
...
FROM tmp_20180417042438_gxc2pv_xgb_ AS "XGB_Union" GROUP BY "XGB_Union"."KEY") AS "T") AS "XGB_sum") AS "U"
...
FROM tmp_20180417042438_ssvrwr_xgb_ AS "XGB_sum"), 
