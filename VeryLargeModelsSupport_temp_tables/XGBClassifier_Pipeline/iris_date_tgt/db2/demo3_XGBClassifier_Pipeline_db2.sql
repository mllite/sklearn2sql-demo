...
-- Code For temporary table tmp_20180417050820_5sryjz_ads_imp_1_out part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180417050820_5sryjz_ads_imp_1_out (
	"KEY" BIGINT, 
...
-- Code For temporary table tmp_20180417050820_5sryjz_ads_imp_1_out part 2/2. Populate

INSERT INTO tmp_20180417050820_5sryjz_ads_imp_1_out SELECT "ADS_imp_1_OUT"."KEY", "ADS_imp_1_OUT".imputer_output_2, "ADS_imp_1_OUT".imputer_output_3, "ADS_imp_1_OUT".imputer_output_4, "ADS_imp_1_OUT".imputer_output_5 
...
-- Code For temporary table tmp_20180417050820_0eu7v1_ads_sca_2_out part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180417050820_0eu7v1_ads_sca_2_out (
	"KEY" BIGINT, 
...
-- Code For temporary table tmp_20180417050820_0eu7v1_ads_sca_2_out part 2/2. Populate

INSERT INTO tmp_20180417050820_0eu7v1_ads_sca_2_out SELECT "ADS_sca_2_OUT"."KEY", "ADS_sca_2_OUT".scaler_output_2, "ADS_sca_2_OUT".scaler_output_3, "ADS_sca_2_OUT".scaler_output_4, "ADS_sca_2_OUT".scaler_output_5 
...
FROM tmp_20180417050820_5sryjz_ads_imp_1_out AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT"

-- Code For temporary table tmp_20180417050820_ic32xj_xgb_b0 part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180417050820_ic32xj_xgb_b0 (
	"KEY" BIGINT, 
...
-- Code For temporary table tmp_20180417050820_ic32xj_xgb_b0 part 2/2. Populate

INSERT INTO tmp_20180417050820_ic32xj_xgb_b0 WITH "DT_node_lookup" AS 
...
FROM tmp_20180417050820_0eu7v1_ads_sca_2_out AS "ADS_sca_2_OUT"), 
"DT_node_data" AS 
...
-- Code For temporary table tmp_20180417050820_7qbb2o_xgb_b1 part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180417050820_7qbb2o_xgb_b1 (
	"KEY" BIGINT, 
...
-- Code For temporary table tmp_20180417050820_7qbb2o_xgb_b1 part 2/2. Populate

INSERT INTO tmp_20180417050820_7qbb2o_xgb_b1 WITH "DT_node_lookup_10" AS 
...
-- Code For temporary table tmp_20180417050820_apqxo6_xgb_b2 part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180417050820_apqxo6_xgb_b2 (
	"KEY" BIGINT, 
	"Score_1789-07-14T00:00:00.000000000" DOUBLE, 
	"Score_1789-08-14T00:00:00.000000000" DOUBLE, 
...
-- Code For temporary table tmp_20180417050820_apqxo6_xgb_b2 part 2/2. Populate

INSERT INTO tmp_20180417050820_apqxo6_xgb_b2 WITH "DT_node_lookup_20" AS 
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", CASE WHEN ("ADS_sca_2_OUT".scaler_output_4 < 0.5877821445465088) THEN 1 ELSE 2 END AS node_id_2 
FROM tmp_20180417050820_0eu7v1_ads_sca_2_out AS "ADS_sca_2_OUT"), 
"DT_node_data_20" AS 
(SELECT "Values".node_id AS node_id, CAST("Values".feature AS DOUBLE) AS feature, CAST("Values".threshold AS DOUBLE) AS threshold, CAST("Values".depth AS DOUBLE) AS depth, CAST("Values".parent_id AS DOUBLE) AS parent_id, CAST("Values"."Score" AS DOUBLE) AS "Score" 
...
-- Code For temporary table tmp_20180417050820_7j2dtb_xgb_b3 part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180417050820_7j2dtb_xgb_b3 (
	"KEY" BIGINT, 
	"Score_1789-07-14T00:00:00.000000000" FLOAT, 
	"Score_1789-08-14T00:00:00.000000000" DOUBLE, 
	"Score_1789-09-14T00:00:00.000000000" DOUBLE
...
-- Code For temporary table tmp_20180417050820_7j2dtb_xgb_b3 part 2/2. Populate

INSERT INTO tmp_20180417050820_7j2dtb_xgb_b3 WITH "DT_node_lookup_30" AS 
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", CASE WHEN ("ADS_sca_2_OUT".scaler_output_4 < -0.8158766627311707) THEN 1 ELSE 2 END AS node_id_2 
FROM tmp_20180417050820_0eu7v1_ads_sca_2_out AS "ADS_sca_2_OUT"), 
"DT_node_data_30" AS 
(SELECT "Values".node_id AS node_id, CAST("Values".feature AS DOUBLE) AS feature, CAST("Values".threshold AS DOUBLE) AS threshold, CAST("Values".depth AS DOUBLE) AS depth, CAST("Values".parent_id AS DOUBLE) AS parent_id, CAST("Values"."Score" AS DOUBLE) AS "Score" 
...
-- Code For temporary table tmp_20180417050820_196yzp_xgb_b4 part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180417050820_196yzp_xgb_b4 (
	"KEY" BIGINT, 
	"Score_1789-07-14T00:00:00.000000000" DOUBLE, 
	"Score_1789-08-14T00:00:00.000000000" FLOAT, 
	"Score_1789-09-14T00:00:00.000000000" DOUBLE
...
-- Code For temporary table tmp_20180417050820_196yzp_xgb_b4 part 2/2. Populate

INSERT INTO tmp_20180417050820_196yzp_xgb_b4 WITH "DT_node_lookup_40" AS 
...
-- Code For temporary table tmp_20180417050820_p3rgbj_xgb_union part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180417050820_p3rgbj_xgb_union (
	"KEY" BIGINT, 
	"Score_1789-07-14T00:00:00.000000000" FLOAT, 
	"Score_1789-08-14T00:00:00.000000000" DOUBLE, 
	"Score_1789-09-14T00:00:00.000000000" DOUBLE
...
-- Code For temporary table tmp_20180417050820_p3rgbj_xgb_union part 2/2. Populate

INSERT INTO tmp_20180417050820_p3rgbj_xgb_union SELECT "XGB_Union"."KEY", "XGB_Union"."Score_1789-07-14T00:00:00.000000000", "XGB_Union"."Score_1789-08-14T00:00:00.000000000", "XGB_Union"."Score_1789-09-14T00:00:00.000000000" 
...
FROM tmp_20180417050820_ic32xj_xgb_b0 AS "XGB_B0" UNION ALL SELECT "XGB_B1"."KEY" AS "KEY", "XGB_B1"."Score_1789-07-14T00:00:00.000000000" AS "Score_1789-07-14T00:00:00.000000000", "XGB_B1"."Score_1789-08-14T00:00:00.000000000" AS "Score_1789-08-14T00:00:00.000000000", "XGB_B1"."Score_1789-09-14T00:00:00.000000000" AS "Score_1789-09-14T00:00:00.000000000" 
FROM tmp_20180417050820_7qbb2o_xgb_b1 AS "XGB_B1" UNION ALL SELECT "XGB_B2"."KEY" AS "KEY", "XGB_B2"."Score_1789-07-14T00:00:00.000000000" AS "Score_1789-07-14T00:00:00.000000000", "XGB_B2"."Score_1789-08-14T00:00:00.000000000" AS "Score_1789-08-14T00:00:00.000000000", "XGB_B2"."Score_1789-09-14T00:00:00.000000000" AS "Score_1789-09-14T00:00:00.000000000" 
FROM tmp_20180417050820_apqxo6_xgb_b2 AS "XGB_B2" UNION ALL SELECT "XGB_B3"."KEY" AS "KEY", "XGB_B3"."Score_1789-07-14T00:00:00.000000000" AS "Score_1789-07-14T00:00:00.000000000", "XGB_B3"."Score_1789-08-14T00:00:00.000000000" AS "Score_1789-08-14T00:00:00.000000000", "XGB_B3"."Score_1789-09-14T00:00:00.000000000" AS "Score_1789-09-14T00:00:00.000000000" 
FROM tmp_20180417050820_7j2dtb_xgb_b3 AS "XGB_B3" UNION ALL SELECT "XGB_B4"."KEY" AS "KEY", "XGB_B4"."Score_1789-07-14T00:00:00.000000000" AS "Score_1789-07-14T00:00:00.000000000", "XGB_B4"."Score_1789-08-14T00:00:00.000000000" AS "Score_1789-08-14T00:00:00.000000000", "XGB_B4"."Score_1789-09-14T00:00:00.000000000" AS "Score_1789-09-14T00:00:00.000000000" 
FROM tmp_20180417050820_196yzp_xgb_b4 AS "XGB_B4") AS "XGB_EnsembleUnion") AS "XGB_Union"

-- Code For temporary table tmp_20180417050820_mxet5p_xgb_sum part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180417050820_mxet5p_xgb_sum (
	"KEY" BIGINT, 
	"Score_1789-07-14T00:00:00.000000000" FLOAT, 
	"Score_1789-08-14T00:00:00.000000000" FLOAT, 
	"Score_1789-09-14T00:00:00.000000000" FLOAT
...
-- Code For temporary table tmp_20180417050820_mxet5p_xgb_sum part 2/2. Populate

INSERT INTO tmp_20180417050820_mxet5p_xgb_sum SELECT "XGB_sum"."KEY", "XGB_sum"."Score_1789-07-14T00:00:00.000000000", "XGB_sum"."Score_1789-08-14T00:00:00.000000000", "XGB_sum"."Score_1789-09-14T00:00:00.000000000" 
...
FROM tmp_20180417050820_p3rgbj_xgb_union AS "XGB_Union" GROUP BY "XGB_Union"."KEY") AS "T") AS "XGB_sum"
...
FROM tmp_20180417050820_mxet5p_xgb_sum AS "XGB_sum"), 
