...
-- Code For temporary table tmp_20180417001906_zu7rpq_ads_imp_1_out part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180417001906_zu7rpq_ads_imp_1_out (
	"KEY" BIGINT, 
	impter_2 DOUBLE, 
	impter_3 DOUBLE, 
	impter_4 DOUBLE, 
...
-- Code For temporary table tmp_20180417001906_dfeztl_ads_sca_2_out part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180417001906_dfeztl_ads_sca_2_out (
	"KEY" BIGINT, 
	scaler_2 FLOAT, 
	scaler_3 FLOAT, 
	scaler_4 FLOAT, 
...
FROM tmp_20180417001906_zu7rpq_ads_imp_1_out AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT"

-- Code For temporary table tmp_20180417001907_lk2ci4_xgb_b0 part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180417001907_lk2ci4_xgb_b0 (
	"KEY" BIGINT, 
	"Score_0" FLOAT, 
	"Score_1" DOUBLE, 
	"Score_2" DOUBLE, 
...
-- Code For temporary table tmp_20180417001907_lk2ci4_xgb_b0 part 2/2. Populate

INSERT INTO tmp_20180417001907_lk2ci4_xgb_b0 WITH "DT_node_lookup" AS 
...
FROM tmp_20180417001906_dfeztl_ads_sca_2_out AS "ADS_sca_2_OUT"), 
"DT_node_data" AS 
...
-- Code For temporary table tmp_20180417001907_op58gp_xgb_b1 part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180417001907_op58gp_xgb_b1 (
	"KEY" BIGINT, 
	"Score_0" DOUBLE, 
	"Score_1" DOUBLE, 
	"Score_2" FLOAT, 
...
-- Code For temporary table tmp_20180417001907_op58gp_xgb_b1 part 2/2. Populate

INSERT INTO tmp_20180417001907_op58gp_xgb_b1 WITH "DT_node_lookup_10" AS 
...
-- Code For temporary table tmp_20180417001907_eq86kv_xgb_b2 part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180417001907_eq86kv_xgb_b2 (
	"KEY" BIGINT, 
	"Score_0" FLOAT, 
	"Score_1" DOUBLE, 
	"Score_2" DOUBLE, 
...
-- Code For temporary table tmp_20180417001907_eq86kv_xgb_b2 part 2/2. Populate

INSERT INTO tmp_20180417001907_eq86kv_xgb_b2 WITH "DT_node_lookup_20" AS 
...
-- Code For temporary table tmp_20180417001907_jio6ni_xgb_b3 part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180417001907_jio6ni_xgb_b3 (
	"KEY" BIGINT, 
	"Score_0" DOUBLE, 
	"Score_1" DOUBLE, 
	"Score_2" FLOAT, 
...
-- Code For temporary table tmp_20180417001907_jio6ni_xgb_b3 part 2/2. Populate

INSERT INTO tmp_20180417001907_jio6ni_xgb_b3 WITH "DT_node_lookup_30" AS 
...
-- Code For temporary table tmp_20180417001907_nr16ex_xgb_b4 part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180417001907_nr16ex_xgb_b4 (
	"KEY" BIGINT, 
	"Score_0" FLOAT, 
	"Score_1" DOUBLE, 
	"Score_2" DOUBLE, 
...
-- Code For temporary table tmp_20180417001907_nr16ex_xgb_b4 part 2/2. Populate

INSERT INTO tmp_20180417001907_nr16ex_xgb_b4 WITH "DT_node_lookup_40" AS 
...
-- Code For temporary table tmp_20180417001907_3w8brs_xgb_b5 part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180417001907_3w8brs_xgb_b5 (
	"KEY" BIGINT, 
	"Score_0" DOUBLE, 
	"Score_1" DOUBLE, 
	"Score_2" FLOAT, 
...
-- Code For temporary table tmp_20180417001907_3w8brs_xgb_b5 part 2/2. Populate

INSERT INTO tmp_20180417001907_3w8brs_xgb_b5 WITH "DT_node_lookup_50" AS 
...
-- Code For temporary table tmp_20180417001907_zzv0jx_xgb_b6 part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180417001907_zzv0jx_xgb_b6 (
	"KEY" BIGINT, 
	"Score_0" FLOAT, 
	"Score_1" DOUBLE, 
	"Score_2" DOUBLE, 
...
-- Code For temporary table tmp_20180417001907_zzv0jx_xgb_b6 part 2/2. Populate

INSERT INTO tmp_20180417001907_zzv0jx_xgb_b6 WITH "DT_node_lookup_60" AS 
...
-- Code For temporary table tmp_20180417001907_z67v4c_xgb_union part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180417001907_z67v4c_xgb_union (
	"KEY" BIGINT, 
	"Score_0" FLOAT, 
	"Score_1" DOUBLE, 
	"Score_2" DOUBLE, 
...
-- Code For temporary table tmp_20180417001907_z67v4c_xgb_union part 2/2. Populate

INSERT INTO tmp_20180417001907_z67v4c_xgb_union SELECT "XGB_Union"."KEY", "XGB_Union"."Score_0", "XGB_Union"."Score_1", "XGB_Union"."Score_2", "XGB_Union"."Score_3" 
...
FROM tmp_20180417001907_lk2ci4_xgb_b0 AS "XGB_B0" UNION ALL SELECT "XGB_B1"."KEY" AS "KEY", "XGB_B1"."Score_0" AS "Score_0", "XGB_B1"."Score_1" AS "Score_1", "XGB_B1"."Score_2" AS "Score_2", "XGB_B1"."Score_3" AS "Score_3" 
FROM tmp_20180417001907_op58gp_xgb_b1 AS "XGB_B1" UNION ALL SELECT "XGB_B2"."KEY" AS "KEY", "XGB_B2"."Score_0" AS "Score_0", "XGB_B2"."Score_1" AS "Score_1", "XGB_B2"."Score_2" AS "Score_2", "XGB_B2"."Score_3" AS "Score_3" 
FROM tmp_20180417001907_eq86kv_xgb_b2 AS "XGB_B2" UNION ALL SELECT "XGB_B3"."KEY" AS "KEY", "XGB_B3"."Score_0" AS "Score_0", "XGB_B3"."Score_1" AS "Score_1", "XGB_B3"."Score_2" AS "Score_2", "XGB_B3"."Score_3" AS "Score_3" 
FROM tmp_20180417001907_jio6ni_xgb_b3 AS "XGB_B3" UNION ALL SELECT "XGB_B4"."KEY" AS "KEY", "XGB_B4"."Score_0" AS "Score_0", "XGB_B4"."Score_1" AS "Score_1", "XGB_B4"."Score_2" AS "Score_2", "XGB_B4"."Score_3" AS "Score_3" 
FROM tmp_20180417001907_nr16ex_xgb_b4 AS "XGB_B4" UNION ALL SELECT "XGB_B5"."KEY" AS "KEY", "XGB_B5"."Score_0" AS "Score_0", "XGB_B5"."Score_1" AS "Score_1", "XGB_B5"."Score_2" AS "Score_2", "XGB_B5"."Score_3" AS "Score_3" 
FROM tmp_20180417001907_3w8brs_xgb_b5 AS "XGB_B5" UNION ALL SELECT "XGB_B6"."KEY" AS "KEY", "XGB_B6"."Score_0" AS "Score_0", "XGB_B6"."Score_1" AS "Score_1", "XGB_B6"."Score_2" AS "Score_2", "XGB_B6"."Score_3" AS "Score_3" 
FROM tmp_20180417001907_zzv0jx_xgb_b6 AS "XGB_B6") AS "XGB_EnsembleUnion") AS "XGB_Union"

-- Code For temporary table tmp_20180417001907_ny883y_xgb_sum part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180417001907_ny883y_xgb_sum (
	"KEY" BIGINT, 
	"Score_0" FLOAT, 
	"Score_1" FLOAT, 
	"Score_2" FLOAT, 
...
-- Code For temporary table tmp_20180417001907_ny883y_xgb_sum part 2/2. Populate

INSERT INTO tmp_20180417001907_ny883y_xgb_sum SELECT "XGB_sum"."KEY", "XGB_sum"."Score_0", "XGB_sum"."Score_1", "XGB_sum"."Score_2", "XGB_sum"."Score_3" 
...
FROM tmp_20180417001907_z67v4c_xgb_union AS "XGB_Union" GROUP BY "XGB_Union"."KEY") AS "T") AS "XGB_sum"
...
FROM tmp_20180417001907_ny883y_xgb_sum AS "XGB_sum"), 
