...
-- Code For temporary table TMP_20180416233357_4KJZHL_ADS_imp_1_OUT part 1/2. Create 


CREATE TEMPORARY TABLE "TMP_20180416233357_4KJZHL_ADS_imp_1_OUT" (
	"KEY" BIGINT NOT NULL, 
	impter_2 FLOAT, 
	impter_3 FLOAT, 
	impter_4 FLOAT, 
...
-- Code For temporary table TMP_20180416233357_GIP3G0_ADS_sca_2_OUT part 1/2. Create 


CREATE TEMPORARY TABLE "TMP_20180416233357_GIP3G0_ADS_sca_2_OUT" (
	"KEY" BIGINT NOT NULL, 
	scaler_2 FLOAT, 
	scaler_3 FLOAT, 
	scaler_4 FLOAT, 
...
-- Code For temporary table TMP_20180416233357_GIP3G0_ADS_sca_2_OUT part 2/2. Populate

INSERT INTO "TMP_20180416233357_GIP3G0_ADS_sca_2_OUT" ("KEY", scaler_2, scaler_3, scaler_4, scaler_5, scaler_6, scaler_7, scaler_8, scaler_9, scaler_10, scaler_11) SELECT "ADS_sca_2_OUT"."KEY", "ADS_sca_2_OUT".scaler_2, "ADS_sca_2_OUT".scaler_3, "ADS_sca_2_OUT".scaler_4, "ADS_sca_2_OUT".scaler_5, "ADS_sca_2_OUT".scaler_6, "ADS_sca_2_OUT".scaler_7, "ADS_sca_2_OUT".scaler_8, "ADS_sca_2_OUT".scaler_9, "ADS_sca_2_OUT".scaler_10, "ADS_sca_2_OUT".scaler_11 
...
FROM "TMP_20180416233357_4KJZHL_ADS_imp_1_OUT" AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT"

-- Code For temporary table TMP_20180416233357_VIK5LH_XGB_B0 part 1/2. Create 


CREATE TEMPORARY TABLE "TMP_20180416233357_VIK5LH_XGB_B0" (
	"KEY" BIGINT, 
	"Score_0" FLOAT, 
	"Score_1" FLOAT, 
	"Score_2" FLOAT, 
...
-- Code For temporary table TMP_20180416233357_VIK5LH_XGB_B0 part 2/2. Populate

WITH "DT_node_lookup" AS 
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", CASE WHEN ("ADS_sca_2_OUT".scaler_6 < 0.055714450776576996) THEN 1 ELSE 2 END AS node_id_2 
FROM "TMP_20180416233357_GIP3G0_ADS_sca_2_OUT" AS "ADS_sca_2_OUT"), 
"DT_node_data" AS 
...
FROM "DT_Output_9")
 INSERT INTO "TMP_20180416233357_VIK5LH_XGB_B0" ("KEY", "Score_0", "Score_1", "Score_2", "Score_3") SELECT "XGB_B0"."KEY", "XGB_B0"."Score_0", "XGB_B0"."Score_1", "XGB_B0"."Score_2", "XGB_B0"."Score_3" 
...
-- Code For temporary table TMP_20180416233357_JAJWFD_XGB_B1 part 1/2. Create 


CREATE TEMPORARY TABLE "TMP_20180416233357_JAJWFD_XGB_B1" (
	"KEY" BIGINT, 
	"Score_0" FLOAT, 
	"Score_1" FLOAT, 
	"Score_2" FLOAT, 
...
-- Code For temporary table TMP_20180416233357_JAJWFD_XGB_B1 part 2/2. Populate
...
FROM "DT_Output_19")
 INSERT INTO "TMP_20180416233357_JAJWFD_XGB_B1" ("KEY", "Score_0", "Score_1", "Score_2", "Score_3") SELECT "XGB_B1"."KEY", "XGB_B1"."Score_0", "XGB_B1"."Score_1", "XGB_B1"."Score_2", "XGB_B1"."Score_3" 
...
-- Code For temporary table TMP_20180416233357_M5748V_XGB_B2 part 1/2. Create 


CREATE TEMPORARY TABLE "TMP_20180416233357_M5748V_XGB_B2" (
	"KEY" BIGINT, 
	"Score_0" FLOAT, 
	"Score_1" FLOAT, 
	"Score_2" FLOAT, 
...
-- Code For temporary table TMP_20180416233357_M5748V_XGB_B2 part 2/2. Populate
...
FROM "DT_Output_29")
 INSERT INTO "TMP_20180416233357_M5748V_XGB_B2" ("KEY", "Score_0", "Score_1", "Score_2", "Score_3") SELECT "XGB_B2"."KEY", "XGB_B2"."Score_0", "XGB_B2"."Score_1", "XGB_B2"."Score_2", "XGB_B2"."Score_3" 
...
-- Code For temporary table TMP_20180416233357_AWCP5S_XGB_B3 part 1/2. Create 


CREATE TEMPORARY TABLE "TMP_20180416233357_AWCP5S_XGB_B3" (
	"KEY" BIGINT, 
	"Score_0" FLOAT, 
	"Score_1" FLOAT, 
	"Score_2" FLOAT, 
...
-- Code For temporary table TMP_20180416233357_AWCP5S_XGB_B3 part 2/2. Populate
...
FROM "DT_Output_39")
 INSERT INTO "TMP_20180416233357_AWCP5S_XGB_B3" ("KEY", "Score_0", "Score_1", "Score_2", "Score_3") SELECT "XGB_B3"."KEY", "XGB_B3"."Score_0", "XGB_B3"."Score_1", "XGB_B3"."Score_2", "XGB_B3"."Score_3" 
...
-- Code For temporary table TMP_20180416233357_YKCTWW_XGB_B4 part 1/2. Create 


CREATE TEMPORARY TABLE "TMP_20180416233357_YKCTWW_XGB_B4" (
	"KEY" BIGINT, 
	"Score_0" FLOAT, 
	"Score_1" FLOAT, 
	"Score_2" FLOAT, 
...
-- Code For temporary table TMP_20180416233357_YKCTWW_XGB_B4 part 2/2. Populate
...
FROM "DT_Output_49")
 INSERT INTO "TMP_20180416233357_YKCTWW_XGB_B4" ("KEY", "Score_0", "Score_1", "Score_2", "Score_3") SELECT "XGB_B4"."KEY", "XGB_B4"."Score_0", "XGB_B4"."Score_1", "XGB_B4"."Score_2", "XGB_B4"."Score_3" 
...
-- Code For temporary table TMP_20180416233357_WYTH66_XGB_B5 part 1/2. Create 


CREATE TEMPORARY TABLE "TMP_20180416233357_WYTH66_XGB_B5" (
	"KEY" BIGINT, 
	"Score_0" FLOAT, 
	"Score_1" FLOAT, 
	"Score_2" FLOAT, 
...
-- Code For temporary table TMP_20180416233357_WYTH66_XGB_B5 part 2/2. Populate
...
FROM "DT_Output_59")
 INSERT INTO "TMP_20180416233357_WYTH66_XGB_B5" ("KEY", "Score_0", "Score_1", "Score_2", "Score_3") SELECT "XGB_B5"."KEY", "XGB_B5"."Score_0", "XGB_B5"."Score_1", "XGB_B5"."Score_2", "XGB_B5"."Score_3" 
...
-- Code For temporary table TMP_20180416233357_4BVK95_XGB_B6 part 1/2. Create 


CREATE TEMPORARY TABLE "TMP_20180416233357_4BVK95_XGB_B6" (
	"KEY" BIGINT, 
	"Score_0" FLOAT, 
	"Score_1" FLOAT, 
	"Score_2" FLOAT, 
...
-- Code For temporary table TMP_20180416233357_4BVK95_XGB_B6 part 2/2. Populate
...
FROM "DT_Output_63")
 INSERT INTO "TMP_20180416233357_4BVK95_XGB_B6" ("KEY", "Score_0", "Score_1", "Score_2", "Score_3") SELECT "XGB_B6"."KEY", "XGB_B6"."Score_0", "XGB_B6"."Score_1", "XGB_B6"."Score_2", "XGB_B6"."Score_3" 
...
-- Code For temporary table TMP_20180416233357_L9TZ5W_XGB_Union part 1/2. Create 


CREATE TEMPORARY TABLE "TMP_20180416233357_L9TZ5W_XGB_Union" (
	"KEY" BIGINT, 
	"Score_0" FLOAT, 
	"Score_1" FLOAT, 
	"Score_2" FLOAT, 
...
-- Code For temporary table TMP_20180416233357_L9TZ5W_XGB_Union part 2/2. Populate

INSERT INTO "TMP_20180416233357_L9TZ5W_XGB_Union" ("KEY", "Score_0", "Score_1", "Score_2", "Score_3") SELECT "XGB_Union"."KEY", "XGB_Union"."Score_0", "XGB_Union"."Score_1", "XGB_Union"."Score_2", "XGB_Union"."Score_3" 
...
FROM "TMP_20180416233357_VIK5LH_XGB_B0" AS "XGB_B0" UNION ALL SELECT "XGB_B1"."KEY" AS "KEY", "XGB_B1"."Score_0" AS "Score_0", "XGB_B1"."Score_1" AS "Score_1", "XGB_B1"."Score_2" AS "Score_2", "XGB_B1"."Score_3" AS "Score_3" 
FROM "TMP_20180416233357_JAJWFD_XGB_B1" AS "XGB_B1" UNION ALL SELECT "XGB_B2"."KEY" AS "KEY", "XGB_B2"."Score_0" AS "Score_0", "XGB_B2"."Score_1" AS "Score_1", "XGB_B2"."Score_2" AS "Score_2", "XGB_B2"."Score_3" AS "Score_3" 
FROM "TMP_20180416233357_M5748V_XGB_B2" AS "XGB_B2" UNION ALL SELECT "XGB_B3"."KEY" AS "KEY", "XGB_B3"."Score_0" AS "Score_0", "XGB_B3"."Score_1" AS "Score_1", "XGB_B3"."Score_2" AS "Score_2", "XGB_B3"."Score_3" AS "Score_3" 
FROM "TMP_20180416233357_AWCP5S_XGB_B3" AS "XGB_B3" UNION ALL SELECT "XGB_B4"."KEY" AS "KEY", "XGB_B4"."Score_0" AS "Score_0", "XGB_B4"."Score_1" AS "Score_1", "XGB_B4"."Score_2" AS "Score_2", "XGB_B4"."Score_3" AS "Score_3" 
FROM "TMP_20180416233357_YKCTWW_XGB_B4" AS "XGB_B4" UNION ALL SELECT "XGB_B5"."KEY" AS "KEY", "XGB_B5"."Score_0" AS "Score_0", "XGB_B5"."Score_1" AS "Score_1", "XGB_B5"."Score_2" AS "Score_2", "XGB_B5"."Score_3" AS "Score_3" 
FROM "TMP_20180416233357_WYTH66_XGB_B5" AS "XGB_B5" UNION ALL SELECT "XGB_B6"."KEY" AS "KEY", "XGB_B6"."Score_0" AS "Score_0", "XGB_B6"."Score_1" AS "Score_1", "XGB_B6"."Score_2" AS "Score_2", "XGB_B6"."Score_3" AS "Score_3" 
FROM "TMP_20180416233357_4BVK95_XGB_B6" AS "XGB_B6") AS "XGB_EnsembleUnion") AS "XGB_Union"

-- Code For temporary table TMP_20180416233357_QZJPG7_XGB_sum part 1/2. Create 


CREATE TEMPORARY TABLE "TMP_20180416233357_QZJPG7_XGB_sum" (
	"KEY" BIGINT NOT NULL, 
	"Score_0" FLOAT, 
	"Score_1" FLOAT, 
	"Score_2" FLOAT, 
...
-- Code For temporary table TMP_20180416233357_QZJPG7_XGB_sum part 2/2. Populate

INSERT INTO "TMP_20180416233357_QZJPG7_XGB_sum" ("KEY", "Score_0", "Score_1", "Score_2", "Score_3") SELECT "XGB_sum"."KEY", "XGB_sum"."Score_0", "XGB_sum"."Score_1", "XGB_sum"."Score_2", "XGB_sum"."Score_3" 
...
FROM "TMP_20180416233357_L9TZ5W_XGB_Union" AS "XGB_Union" GROUP BY "XGB_Union"."KEY") AS "T") AS "XGB_sum"
...
FROM "TMP_20180416233357_QZJPG7_XGB_sum" AS "XGB_sum"), 
