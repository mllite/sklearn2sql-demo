...
-- Code For temporary table ##TMP_20180416223502_GP6UAV_ADS_imp_1_OUT part 1/2. Create 


CREATE TABLE ##TMP_20180416223502_GP6UAV_ADS_imp_1_OUT (
	[KEY] BIGINT NULL, 
...
-- Code For temporary table ##TMP_20180416223502_4IPDSY_ADS_sca_2_OUT part 1/2. Create 


CREATE TABLE ##TMP_20180416223502_4IPDSY_ADS_sca_2_OUT (
	[KEY] BIGINT NULL, 
	scaler_2 FLOAT NULL, 
	scaler_3 FLOAT NULL, 
	scaler_4 FLOAT NULL, 
...
FROM ##TMP_20180416223502_GP6UAV_ADS_imp_1_OUT AS [ADS_imp_1_OUT]) AS [ADS_sca_2_OUT]

-- Code For temporary table ##TMP_20180416223502_DC4VJM_XGB_B0 part 1/2. Create 


CREATE TABLE ##TMP_20180416223502_DC4VJM_XGB_B0 (
	[KEY] BIGINT NULL, 
...
-- Code For temporary table ##TMP_20180416223502_DC4VJM_XGB_B0 part 2/2. Populate

WITH [DT_node_lookup] AS 
(SELECT [ADS_sca_2_OUT].[KEY] AS [KEY], CASE WHEN ([ADS_sca_2_OUT].scaler_59 < -0.1959642767906189) THEN 1 ELSE 2 END AS node_id_2 
FROM ##TMP_20180416223502_4IPDSY_ADS_sca_2_OUT AS [ADS_sca_2_OUT]), 
[DT_node_data] AS 
...
FROM (SELECT 1 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 1 AS depth, 0 AS parent_id, -0.13636364042758942 AS [Score] UNION ALL SELECT 2 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 1 AS depth, 0 AS parent_id, 0.11818181723356247 AS [Score]) AS [Values]), 
[DT_Output] AS 
...
[DT_node_data_1] AS 
(SELECT [Values].node_id AS node_id, CAST([Values].feature AS FLOAT(53)) AS feature, CAST([Values].threshold AS FLOAT(53)) AS threshold, CAST([Values].depth AS FLOAT(53)) AS depth, CAST([Values].parent_id AS FLOAT(53)) AS parent_id, CAST([Values].[Score] AS FLOAT(53)) AS [Score] 
FROM (SELECT 0 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 0 AS depth, CAST(NULL AS BIGINT) AS parent_id, -0.008695119060575962 AS [Score]) AS [Values]), 
[DT_Output_1] AS 
...
[DT_node_data_2] AS 
(SELECT [Values].node_id AS node_id, CAST([Values].feature AS FLOAT(53)) AS feature, CAST([Values].threshold AS FLOAT(53)) AS threshold, CAST([Values].depth AS FLOAT(53)) AS depth, CAST([Values].parent_id AS FLOAT(53)) AS parent_id, CAST([Values].[Score] AS FLOAT(53)) AS [Score] 
FROM (SELECT 0 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 0 AS depth, CAST(NULL AS BIGINT) AS parent_id, -0.007867632433772087 AS [Score]) AS [Values]), 
[DT_Output_2] AS 
...
[DT_node_data_3] AS 
(SELECT [Values].node_id AS node_id, CAST([Values].feature AS FLOAT(53)) AS feature, CAST([Values].threshold AS FLOAT(53)) AS threshold, CAST([Values].depth AS FLOAT(53)) AS depth, CAST([Values].parent_id AS FLOAT(53)) AS parent_id, CAST([Values].[Score] AS FLOAT(53)) AS [Score] 
FROM (SELECT 0 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 0 AS depth, CAST(NULL AS BIGINT) AS parent_id, -0.007119080517441034 AS [Score]) AS [Values]), 
[DT_Output_3] AS 
...
[DT_node_data_4] AS 
(SELECT [Values].node_id AS node_id, CAST([Values].feature AS FLOAT(53)) AS feature, CAST([Values].threshold AS FLOAT(53)) AS threshold, CAST([Values].depth AS FLOAT(53)) AS depth, CAST([Values].parent_id AS FLOAT(53)) AS parent_id, CAST([Values].[Score] AS FLOAT(53)) AS [Score] 
FROM (SELECT 0 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 0 AS depth, CAST(NULL AS BIGINT) AS parent_id, -0.006441877223551273 AS [Score]) AS [Values]), 
[DT_Output_4] AS 
...
[DT_node_data_5] AS 
(SELECT [Values].node_id AS node_id, CAST([Values].feature AS FLOAT(53)) AS feature, CAST([Values].threshold AS FLOAT(53)) AS threshold, CAST([Values].depth AS FLOAT(53)) AS depth, CAST([Values].parent_id AS FLOAT(53)) AS parent_id, CAST([Values].[Score] AS FLOAT(53)) AS [Score] 
FROM (SELECT 0 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 0 AS depth, CAST(NULL AS BIGINT) AS parent_id, -0.005829159170389175 AS [Score]) AS [Values]), 
[DT_Output_5] AS 
...
[DT_node_data_6] AS 
(SELECT [Values].node_id AS node_id, CAST([Values].feature AS FLOAT(53)) AS feature, CAST([Values].threshold AS FLOAT(53)) AS threshold, CAST([Values].depth AS FLOAT(53)) AS depth, CAST([Values].parent_id AS FLOAT(53)) AS parent_id, CAST([Values].[Score] AS FLOAT(53)) AS [Score] 
FROM (SELECT 0 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 0 AS depth, CAST(NULL AS BIGINT) AS parent_id, -0.0052747568115592 AS [Score]) AS [Values]), 
[DT_Output_6] AS 
...
[DT_node_data_7] AS 
(SELECT [Values].node_id AS node_id, CAST([Values].feature AS FLOAT(53)) AS feature, CAST([Values].threshold AS FLOAT(53)) AS threshold, CAST([Values].depth AS FLOAT(53)) AS depth, CAST([Values].parent_id AS FLOAT(53)) AS parent_id, CAST([Values].[Score] AS FLOAT(53)) AS [Score] 
FROM (SELECT 0 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 0 AS depth, CAST(NULL AS BIGINT) AS parent_id, -0.00477311247959733 AS [Score]) AS [Values]), 
[DT_Output_7] AS 
...
[DT_node_data_8] AS 
(SELECT [Values].node_id AS node_id, CAST([Values].feature AS FLOAT(53)) AS feature, CAST([Values].threshold AS FLOAT(53)) AS threshold, CAST([Values].depth AS FLOAT(53)) AS depth, CAST([Values].parent_id AS FLOAT(53)) AS parent_id, CAST([Values].[Score] AS FLOAT(53)) AS [Score] 
FROM (SELECT 0 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 0 AS depth, CAST(NULL AS BIGINT) AS parent_id, -0.004319168161600828 AS [Score]) AS [Values]), 
[DT_Output_8] AS 
...
[DT_node_data_9] AS 
(SELECT [Values].node_id AS node_id, CAST([Values].feature AS FLOAT(53)) AS feature, CAST([Values].threshold AS FLOAT(53)) AS threshold, CAST([Values].depth AS FLOAT(53)) AS depth, CAST([Values].parent_id AS FLOAT(53)) AS parent_id, CAST([Values].[Score] AS FLOAT(53)) AS [Score] 
FROM (SELECT 0 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 0 AS depth, CAST(NULL AS BIGINT) AS parent_id, -0.003908377606421709 AS [Score]) AS [Values]), 
[DT_Output_9] AS 
...
FROM [DT_Output_9])
 INSERT INTO ##TMP_20180416223502_DC4VJM_XGB_B0 ([KEY], [Score_0]) SELECT [XGB_B0].[KEY], [XGB_B0].[Score_0] 
...
-- Code For temporary table ##TMP_20180416223502_WS8YXH_XGB_B1 part 1/2. Create 


CREATE TABLE ##TMP_20180416223502_WS8YXH_XGB_B1 (
	[KEY] BIGINT NULL, 
	[Score_0] FLOAT(53) NULL
)
...
-- Code For temporary table ##TMP_20180416223502_WS8YXH_XGB_B1 part 2/2. Populate
...
[DT_node_data_10] AS 
(SELECT [Values].node_id AS node_id, CAST([Values].feature AS FLOAT(53)) AS feature, CAST([Values].threshold AS FLOAT(53)) AS threshold, CAST([Values].depth AS FLOAT(53)) AS depth, CAST([Values].parent_id AS FLOAT(53)) AS parent_id, CAST([Values].[Score] AS FLOAT(53)) AS [Score] 
FROM (SELECT 0 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 0 AS depth, CAST(NULL AS BIGINT) AS parent_id, -0.0035366646479815245 AS [Score]) AS [Values]), 
[DT_Output_10] AS 
...
[DT_node_data_11] AS 
(SELECT [Values].node_id AS node_id, CAST([Values].feature AS FLOAT(53)) AS feature, CAST([Values].threshold AS FLOAT(53)) AS threshold, CAST([Values].depth AS FLOAT(53)) AS depth, CAST([Values].parent_id AS FLOAT(53)) AS parent_id, CAST([Values].[Score] AS FLOAT(53)) AS [Score] 
FROM (SELECT 0 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 0 AS depth, CAST(NULL AS BIGINT) AS parent_id, -0.00320029235444963 AS [Score]) AS [Values]), 
[DT_Output_11] AS 
...
[DT_node_data_12] AS 
(SELECT [Values].node_id AS node_id, CAST([Values].feature AS FLOAT(53)) AS feature, CAST([Values].threshold AS FLOAT(53)) AS threshold, CAST([Values].depth AS FLOAT(53)) AS depth, CAST([Values].parent_id AS FLOAT(53)) AS parent_id, CAST([Values].[Score] AS FLOAT(53)) AS [Score] 
FROM (SELECT 0 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 0 AS depth, CAST(NULL AS BIGINT) AS parent_id, -0.0028958830516785383 AS [Score]) AS [Values]), 
[DT_Output_12] AS 
...
[DT_node_data_13] AS 
(SELECT [Values].node_id AS node_id, CAST([Values].feature AS FLOAT(53)) AS feature, CAST([Values].threshold AS FLOAT(53)) AS threshold, CAST([Values].depth AS FLOAT(53)) AS depth, CAST([Values].parent_id AS FLOAT(53)) AS parent_id, CAST([Values].[Score] AS FLOAT(53)) AS [Score] 
FROM (SELECT 0 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 0 AS depth, CAST(NULL AS BIGINT) AS parent_id, -0.0026204369496554136 AS [Score]) AS [Values]), 
[DT_Output_13] AS 
...
[DT_node_data_14] AS 
(SELECT [Values].node_id AS node_id, CAST([Values].feature AS FLOAT(53)) AS feature, CAST([Values].threshold AS FLOAT(53)) AS threshold, CAST([Values].depth AS FLOAT(53)) AS depth, CAST([Values].parent_id AS FLOAT(53)) AS parent_id, CAST([Values].[Score] AS FLOAT(53)) AS [Score] 
FROM (SELECT 0 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 0 AS depth, CAST(NULL AS BIGINT) AS parent_id, -0.002371155424043536 AS [Score]) AS [Values]), 
[DT_Output_14] AS 
...
[DT_node_data_15] AS 
(SELECT [Values].node_id AS node_id, CAST([Values].feature AS FLOAT(53)) AS feature, CAST([Values].threshold AS FLOAT(53)) AS threshold, CAST([Values].depth AS FLOAT(53)) AS depth, CAST([Values].parent_id AS FLOAT(53)) AS parent_id, CAST([Values].[Score] AS FLOAT(53)) AS [Score] 
FROM (SELECT 0 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 0 AS depth, CAST(NULL AS BIGINT) AS parent_id, -0.0021455788519233465 AS [Score]) AS [Values]), 
[DT_Output_15] AS 
...
FROM [DT_Output_15])
 INSERT INTO ##TMP_20180416223502_WS8YXH_XGB_B1 ([KEY], [Score_0]) SELECT [XGB_B1].[KEY], [XGB_B1].[Score_0] 
...
-- Code For temporary table ##TMP_20180416223502_QURW19_XGB_Union part 1/2. Create 


CREATE TABLE ##TMP_20180416223502_QURW19_XGB_Union (
	[KEY] BIGINT NULL, 
	[Score_0] FLOAT(53) NULL
)
...
-- Code For temporary table ##TMP_20180416223502_QURW19_XGB_Union part 2/2. Populate

INSERT INTO ##TMP_20180416223502_QURW19_XGB_Union ([KEY], [Score_0]) SELECT [XGB_Union].[KEY], [XGB_Union].[Score_0] 
...
FROM ##TMP_20180416223502_DC4VJM_XGB_B0 AS [XGB_B0] UNION ALL SELECT [XGB_B1].[KEY] AS [KEY], [XGB_B1].[Score_0] AS [Score_0] 
FROM ##TMP_20180416223502_WS8YXH_XGB_B1 AS [XGB_B1]) AS [XGB_EnsembleUnion]) AS [XGB_Union]

-- Code For temporary table ##TMP_20180416223502_XVPGYL_XGB_sum part 1/2. Create 


CREATE TABLE ##TMP_20180416223502_XVPGYL_XGB_sum (
	[KEY] BIGINT NULL, 
	[Score_0] FLOAT(53) NULL
)
...
-- Code For temporary table ##TMP_20180416223502_XVPGYL_XGB_sum part 2/2. Populate

INSERT INTO ##TMP_20180416223502_XVPGYL_XGB_sum ([KEY], [Score_0]) SELECT [XGB_sum].[KEY], [XGB_sum].[Score_0] 
...
FROM ##TMP_20180416223502_QURW19_XGB_Union AS [XGB_Union] GROUP BY [XGB_Union].[KEY]) AS [T]) AS [XGB_sum]
...
FROM ##TMP_20180416223502_XVPGYL_XGB_sum AS [XGB_sum]), 
