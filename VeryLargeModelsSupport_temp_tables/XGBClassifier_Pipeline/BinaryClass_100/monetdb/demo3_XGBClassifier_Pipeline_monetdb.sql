...
-- Code For temporary table tmp_20180416223502_2t6dvw_ads_imp_1_out part 1/2. Create 


CREATE TEMPORARY TABLE tmp_20180416223502_2t6dvw_ads_imp_1_out (
	"KEY" BIGINT NOT NULL, 
	impter_2 FLOAT, 
	impter_3 FLOAT, 
	impter_4 FLOAT, 
...
-- Code For temporary table tmp_20180416223502_wm2ywa_ads_sca_2_out part 1/2. Create 


CREATE TEMPORARY TABLE tmp_20180416223502_wm2ywa_ads_sca_2_out (
	"KEY" BIGINT NOT NULL, 
	scaler_2 FLOAT, 
	scaler_3 FLOAT, 
	scaler_4 FLOAT, 
...
FROM tmp_20180416223502_2t6dvw_ads_imp_1_out AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT") AS "U"

-- Code For temporary table tmp_20180416223502_o3tf1n_xgb_b0 part 1/2. Create 


CREATE TEMPORARY TABLE tmp_20180416223502_o3tf1n_xgb_b0 (
	"KEY" BIGINT, 
	"Score_0" FLOAT
)
...
-- Code For temporary table tmp_20180416223502_o3tf1n_xgb_b0 part 2/2. Populate

INSERT INTO tmp_20180416223502_o3tf1n_xgb_b0 ("KEY", "Score_0") SELECT "U"."KEY", "U"."Score_0" 
FROM (WITH "DT_node_lookup" AS 
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", CASE WHEN ("ADS_sca_2_OUT".scaler_59 < -0.1959642767906189) THEN 1 ELSE 2 END AS node_id_2 
FROM tmp_20180416223502_wm2ywa_ads_sca_2_out AS "ADS_sca_2_OUT"), 
"DT_node_data" AS 
...
-- Code For temporary table tmp_20180416223502_9k0h7d_xgb_b1 part 1/2. Create 


CREATE TEMPORARY TABLE tmp_20180416223502_9k0h7d_xgb_b1 (
	"KEY" BIGINT, 
	"Score_0" FLOAT
)
...
-- Code For temporary table tmp_20180416223502_9k0h7d_xgb_b1 part 2/2. Populate

INSERT INTO tmp_20180416223502_9k0h7d_xgb_b1 ("KEY", "Score_0") SELECT "U"."KEY", "U"."Score_0" 
...
-- Code For temporary table tmp_20180416223502_hxfg43_xgb_union part 1/2. Create 


CREATE TEMPORARY TABLE tmp_20180416223502_hxfg43_xgb_union (
	"KEY" BIGINT, 
	"Score_0" FLOAT
)
...
-- Code For temporary table tmp_20180416223502_hxfg43_xgb_union part 2/2. Populate

INSERT INTO tmp_20180416223502_hxfg43_xgb_union ("KEY", "Score_0") SELECT "U"."KEY", "U"."Score_0" 
...
FROM tmp_20180416223502_o3tf1n_xgb_b0 AS "XGB_B0" UNION ALL SELECT "XGB_B1"."KEY" AS "KEY", "XGB_B1"."Score_0" AS "Score_0" 
FROM tmp_20180416223502_9k0h7d_xgb_b1 AS "XGB_B1") AS "XGB_EnsembleUnion") AS "XGB_Union") AS "U"

-- Code For temporary table tmp_20180416223502_oslq0u_xgb_sum part 1/2. Create 


CREATE TEMPORARY TABLE tmp_20180416223502_oslq0u_xgb_sum (
	"KEY" BIGINT NOT NULL, 
	"Score_0" FLOAT, 
	PRIMARY KEY ("KEY")
)
...
-- Code For temporary table tmp_20180416223502_oslq0u_xgb_sum part 2/2. Populate

INSERT INTO tmp_20180416223502_oslq0u_xgb_sum ("KEY", "Score_0") SELECT "U"."KEY", "U"."Score_0" 
...
FROM tmp_20180416223502_hxfg43_xgb_union AS "XGB_Union" GROUP BY "XGB_Union"."KEY") AS "T") AS "XGB_sum") AS "U"
...
FROM tmp_20180416223502_oslq0u_xgb_sum AS "XGB_sum"), 
