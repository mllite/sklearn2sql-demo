...
-- Code For temporary table tmp_20180417055209_4mt6na_ads_ part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180417055209_4mt6na_ads_  (
	"KEY" BIGINT, 
...
-- Code For temporary table tmp_20180417055209_4mt6na_ads_ part 2/2. Populate

INSERT INTO tmp_20180417055209_4mt6na_ads_ ("KEY", imputer_output_2, imputer_output_3, imputer_output_4, imputer_output_5) SELECT "U"."KEY", "U".imputer_output_2, "U".imputer_output_3, "U".imputer_output_4, "U".imputer_output_5 
...
-- Code For temporary table tmp_20180417055209_glq5iy_ads_ part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180417055209_glq5iy_ads_  (
	"KEY" BIGINT, 
...
-- Code For temporary table tmp_20180417055209_glq5iy_ads_ part 2/2. Populate

INSERT INTO tmp_20180417055209_glq5iy_ads_ ("KEY", scaler_output_2, scaler_output_3, scaler_output_4, scaler_output_5) SELECT "U"."KEY", "U".scaler_output_2, "U".scaler_output_3, "U".scaler_output_4, "U".scaler_output_5 
...
FROM tmp_20180417055209_4mt6na_ads_ AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT") AS "U"

-- Code For temporary table tmp_20180417055209_75dhjv_xgb_ part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180417055209_75dhjv_xgb_  (
	"KEY" BIGINT, 
	"Score_CLASS_0" FLOAT, 
	"Score_CLASS_1" FLOAT, 
	"Score_CLASS_2" FLOAT
...
-- Code For temporary table tmp_20180417055209_75dhjv_xgb_ part 2/2. Populate

INSERT INTO tmp_20180417055209_75dhjv_xgb_ ("KEY", "Score_CLASS_0", "Score_CLASS_1", "Score_CLASS_2") SELECT "U"."KEY", "U"."Score_CLASS_0", "U"."Score_CLASS_1", "U"."Score_CLASS_2" 
FROM (WITH "DT_node_lookup" AS 
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", CASE WHEN ("ADS_sca_2_OUT".scaler_output_4 < -0.815876662731171) THEN 1 ELSE 2 END AS node_id_2 
FROM tmp_20180417055209_glq5iy_ads_ AS "ADS_sca_2_OUT"), 
"DT_node_data" AS 
...
FROM "DT_Output"), 
"DT_node_lookup_1" AS 
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", CASE WHEN ("ADS_sca_2_OUT".scaler_output_4 < -0.815876662731171) THEN 1 ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_output_4 < 0.587782144546509) THEN 3 ELSE 4 END END AS node_id_2 
FROM tmp_20180417055209_glq5iy_ads_ AS "ADS_sca_2_OUT"), 
"DT_node_data_1" AS 
(SELECT "Values".node_id AS node_id, CAST("Values".feature AS FLOAT) AS feature, CAST("Values"."threshold" AS FLOAT) AS "threshold", CAST("Values".depth AS FLOAT) AS depth, CAST("Values".parent_id AS FLOAT) AS parent_id, CAST("Values"."Score" AS FLOAT) AS "Score" 
...
FROM "DT_Output_1"), 
"DT_node_lookup_2" AS 
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", CASE WHEN ("ADS_sca_2_OUT".scaler_output_4 < 0.587782144546509) THEN 1 ELSE 2 END AS node_id_2 
FROM tmp_20180417055209_glq5iy_ads_ AS "ADS_sca_2_OUT"), 
"DT_node_data_2" AS 
(SELECT "Values".node_id AS node_id, CAST("Values".feature AS FLOAT) AS feature, CAST("Values"."threshold" AS FLOAT) AS "threshold", CAST("Values".depth AS FLOAT) AS depth, CAST("Values".parent_id AS FLOAT) AS parent_id, CAST("Values"."Score" AS FLOAT) AS "Score" 
...
FROM "DT_Output_3"), 
"DT_node_lookup_4" AS 
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", CASE WHEN ("ADS_sca_2_OUT".scaler_output_4 < -0.815876662731171) THEN 1 ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_output_5 < 0.673448085784912) THEN 3 ELSE 4 END END AS node_id_2 
FROM tmp_20180417055209_glq5iy_ads_ AS "ADS_sca_2_OUT"), 
"DT_node_data_4" AS 
(SELECT "Values".node_id AS node_id, CAST("Values".feature AS FLOAT) AS feature, CAST("Values"."threshold" AS FLOAT) AS "threshold", CAST("Values".depth AS FLOAT) AS depth, CAST("Values".parent_id AS FLOAT) AS parent_id, CAST("Values"."Score" AS FLOAT) AS "Score" 
...
FROM "DT_Output_6"), 
"DT_node_lookup_7" AS 
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", CASE WHEN ("ADS_sca_2_OUT".scaler_output_4 < -0.815876662731171) THEN 1 ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_output_4 < 0.646267890930176) THEN 3 ELSE 4 END END AS node_id_2 
FROM tmp_20180417055209_glq5iy_ads_ AS "ADS_sca_2_OUT"), 
"DT_node_data_7" AS 
(SELECT "Values".node_id AS node_id, CAST("Values".feature AS FLOAT) AS feature, CAST("Values"."threshold" AS FLOAT) AS "threshold", CAST("Values".depth AS FLOAT) AS depth, CAST("Values".parent_id AS FLOAT) AS parent_id, CAST("Values"."Score" AS FLOAT) AS "Score" 
...
-- Code For temporary table tmp_20180417055209_n08xnt_xgb_ part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180417055209_n08xnt_xgb_  (
	"KEY" BIGINT, 
	"Score_CLASS_0" FLOAT, 
	"Score_CLASS_1" FLOAT, 
	"Score_CLASS_2" FLOAT
...
-- Code For temporary table tmp_20180417055209_n08xnt_xgb_ part 2/2. Populate

INSERT INTO tmp_20180417055209_n08xnt_xgb_ ("KEY", "Score_CLASS_0", "Score_CLASS_1", "Score_CLASS_2") SELECT "U"."KEY", "U"."Score_CLASS_0", "U"."Score_CLASS_1", "U"."Score_CLASS_2" 
FROM (WITH "DT_node_lookup_10" AS 
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", CASE WHEN ("ADS_sca_2_OUT".scaler_output_5 < 0.673448085784912) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_output_4 < -0.815876662731171) THEN 3 ELSE 4 END ELSE 2 END AS node_id_2 
FROM tmp_20180417055209_glq5iy_ads_ AS "ADS_sca_2_OUT"), 
"DT_node_data_10" AS 
(SELECT "Values".node_id AS node_id, CAST("Values".feature AS FLOAT) AS feature, CAST("Values"."threshold" AS FLOAT) AS "threshold", CAST("Values".depth AS FLOAT) AS depth, CAST("Values".parent_id AS FLOAT) AS parent_id, CAST("Values"."Score" AS FLOAT) AS "Score" 
...
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", CASE WHEN ("ADS_sca_2_OUT".scaler_output_5 < 0.540091991424561) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_output_4 < 0.236867412924767) THEN 3 ELSE 4 END ELSE 2 END AS node_id_2 
FROM tmp_20180417055209_glq5iy_ads_ AS "ADS_sca_2_OUT"), 
"DT_node_data_11" AS 
(SELECT "Values".node_id AS node_id, CAST("Values".feature AS FLOAT) AS feature, CAST("Values"."threshold" AS FLOAT) AS "threshold", CAST("Values".depth AS FLOAT) AS depth, CAST("Values".parent_id AS FLOAT) AS parent_id, CAST("Values"."Score" AS FLOAT) AS "Score" 
...
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", CASE WHEN ("ADS_sca_2_OUT".scaler_output_4 < 0.704753637313843) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_output_4 < -0.815876662731171) THEN 3 ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_output_4 < 0.353838980197906) THEN 5 ELSE 6 END END ELSE 2 END AS node_id_2 
FROM tmp_20180417055209_glq5iy_ads_ AS "ADS_sca_2_OUT"), 
"DT_node_data_13" AS 
(SELECT "Values".node_id AS node_id, CAST("Values".feature AS FLOAT) AS feature, CAST("Values"."threshold" AS FLOAT) AS "threshold", CAST("Values".depth AS FLOAT) AS depth, CAST("Values".parent_id AS FLOAT) AS parent_id, CAST("Values"."Score" AS FLOAT) AS "Score" 
...
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", CASE WHEN ("ADS_sca_2_OUT".scaler_output_5 < 0.540091991424561) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_output_4 < 0.178381636738777) THEN 3 ELSE 4 END ELSE 2 END AS node_id_2 
FROM tmp_20180417055209_glq5iy_ads_ AS "ADS_sca_2_OUT"), 
"DT_node_data_17" AS 
(SELECT "Values".node_id AS node_id, CAST("Values".feature AS FLOAT) AS feature, CAST("Values"."threshold" AS FLOAT) AS "threshold", CAST("Values".depth AS FLOAT) AS depth, CAST("Values".parent_id AS FLOAT) AS parent_id, CAST("Values"."Score" AS FLOAT) AS "Score" 
...
-- Code For temporary table tmp_20180417055209_rou4mg_xgb_ part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180417055209_rou4mg_xgb_  (
	"KEY" BIGINT, 
	"Score_CLASS_0" FLOAT, 
	"Score_CLASS_1" FLOAT, 
	"Score_CLASS_2" FLOAT
...
-- Code For temporary table tmp_20180417055209_rou4mg_xgb_ part 2/2. Populate

INSERT INTO tmp_20180417055209_rou4mg_xgb_ ("KEY", "Score_CLASS_0", "Score_CLASS_1", "Score_CLASS_2") SELECT "U"."KEY", "U"."Score_CLASS_0", "U"."Score_CLASS_1", "U"."Score_CLASS_2" 
...
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", CASE WHEN ("ADS_sca_2_OUT".scaler_output_4 < 0.529296338558197) THEN 1 ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_output_4 < 0.880210995674133) THEN 3 ELSE 4 END END AS node_id_2 
FROM tmp_20180417055209_glq5iy_ads_ AS "ADS_sca_2_OUT"), 
"DT_node_data_23" AS 
(SELECT "Values".node_id AS node_id, CAST("Values".feature AS FLOAT) AS feature, CAST("Values"."threshold" AS FLOAT) AS "threshold", CAST("Values".depth AS FLOAT) AS depth, CAST("Values".parent_id AS FLOAT) AS parent_id, CAST("Values"."Score" AS FLOAT) AS "Score" 
...
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", CASE WHEN ("ADS_sca_2_OUT".scaler_output_5 < 0.540091991424561) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_output_5 < 0.00666780397296) THEN 3 ELSE 4 END ELSE 2 END AS node_id_2 
FROM tmp_20180417055209_glq5iy_ads_ AS "ADS_sca_2_OUT"), 
"DT_node_data_26" AS 
(SELECT "Values".node_id AS node_id, CAST("Values".feature AS FLOAT) AS feature, CAST("Values"."threshold" AS FLOAT) AS "threshold", CAST("Values".depth AS FLOAT) AS depth, CAST("Values".parent_id AS FLOAT) AS parent_id, CAST("Values"."Score" AS FLOAT) AS "Score" 
...
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", CASE WHEN ("ADS_sca_2_OUT".scaler_output_4 < 0.704753637313843) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_output_4 < -0.406476199626923) THEN 3 ELSE 4 END ELSE 2 END AS node_id_2 
FROM tmp_20180417055209_glq5iy_ads_ AS "ADS_sca_2_OUT"), 
"DT_node_data_28" AS 
(SELECT "Values".node_id AS node_id, CAST("Values".feature AS FLOAT) AS feature, CAST("Values"."threshold" AS FLOAT) AS "threshold", CAST("Values".depth AS FLOAT) AS depth, CAST("Values".parent_id AS FLOAT) AS parent_id, CAST("Values"."Score" AS FLOAT) AS "Score" 
...
-- Code For temporary table tmp_20180417055209_oiaolt_xgb_ part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180417055209_oiaolt_xgb_  (
	"KEY" BIGINT, 
	"Score_CLASS_0" FLOAT, 
	"Score_CLASS_1" FLOAT, 
	"Score_CLASS_2" FLOAT
...
-- Code For temporary table tmp_20180417055209_oiaolt_xgb_ part 2/2. Populate

INSERT INTO tmp_20180417055209_oiaolt_xgb_ ("KEY", "Score_CLASS_0", "Score_CLASS_1", "Score_CLASS_2") SELECT "U"."KEY", "U"."Score_CLASS_0", "U"."Score_CLASS_1", "U"."Score_CLASS_2" 
...
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", CASE WHEN ("ADS_sca_2_OUT".scaler_output_5 < 0.673448085784912) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_output_4 < -0.260261744260788) THEN 3 ELSE 4 END ELSE 2 END AS node_id_2 
FROM tmp_20180417055209_glq5iy_ads_ AS "ADS_sca_2_OUT"), 
"DT_node_data_31" AS 
(SELECT "Values".node_id AS node_id, CAST("Values".feature AS FLOAT) AS feature, CAST("Values"."threshold" AS FLOAT) AS "threshold", CAST("Values".depth AS FLOAT) AS depth, CAST("Values".parent_id AS FLOAT) AS parent_id, CAST("Values"."Score" AS FLOAT) AS "Score" 
...
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", CASE WHEN ("ADS_sca_2_OUT".scaler_output_5 < 0.540091991424561) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_output_4 < 0.061410073190928) THEN 3 ELSE 4 END ELSE 2 END AS node_id_2 
FROM tmp_20180417055209_glq5iy_ads_ AS "ADS_sca_2_OUT"), 
"DT_node_data_32" AS 
(SELECT "Values".node_id AS node_id, CAST("Values".feature AS FLOAT) AS feature, CAST("Values"."threshold" AS FLOAT) AS "threshold", CAST("Values".depth AS FLOAT) AS depth, CAST("Values".parent_id AS FLOAT) AS parent_id, CAST("Values"."Score" AS FLOAT) AS "Score" 
...
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", CASE WHEN ("ADS_sca_2_OUT".scaler_output_4 < 0.646267890930176) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_output_4 < -0.260261744260788) THEN 3 ELSE 4 END ELSE 2 END AS node_id_2 
FROM tmp_20180417055209_glq5iy_ads_ AS "ADS_sca_2_OUT"), 
"DT_node_data_34" AS 
(SELECT "Values".node_id AS node_id, CAST("Values".feature AS FLOAT) AS feature, CAST("Values"."threshold" AS FLOAT) AS "threshold", CAST("Values".depth AS FLOAT) AS depth, CAST("Values".parent_id AS FLOAT) AS parent_id, CAST("Values"."Score" AS FLOAT) AS "Score" 
...
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", CASE WHEN ("ADS_sca_2_OUT".scaler_output_4 < 0.646267890930176) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_output_4 < -0.143290162086487) THEN 3 ELSE 4 END ELSE 2 END AS node_id_2 
FROM tmp_20180417055209_glq5iy_ads_ AS "ADS_sca_2_OUT"), 
"DT_node_data_37" AS 
(SELECT "Values".node_id AS node_id, CAST("Values".feature AS FLOAT) AS feature, CAST("Values"."threshold" AS FLOAT) AS "threshold", CAST("Values".depth AS FLOAT) AS depth, CAST("Values".parent_id AS FLOAT) AS parent_id, CAST("Values"."Score" AS FLOAT) AS "Score" 
...
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", CASE WHEN ("ADS_sca_2_OUT".scaler_output_5 < 0.406735956668854) THEN 1 ELSE 2 END AS node_id_2 
FROM tmp_20180417055209_glq5iy_ads_ AS "ADS_sca_2_OUT"), 
"DT_node_data_38" AS 
(SELECT "Values".node_id AS node_id, CAST("Values".feature AS FLOAT) AS feature, CAST("Values"."threshold" AS FLOAT) AS "threshold", CAST("Values".depth AS FLOAT) AS depth, CAST("Values".parent_id AS FLOAT) AS parent_id, CAST("Values"."Score" AS FLOAT) AS "Score" 
...
-- Code For temporary table tmp_20180417055209_p89v42_xgb_ part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180417055209_p89v42_xgb_  (
	"KEY" BIGINT, 
	"Score_CLASS_0" FLOAT, 
	"Score_CLASS_1" FLOAT, 
	"Score_CLASS_2" FLOAT
...
-- Code For temporary table tmp_20180417055209_p89v42_xgb_ part 2/2. Populate

INSERT INTO tmp_20180417055209_p89v42_xgb_ ("KEY", "Score_CLASS_0", "Score_CLASS_1", "Score_CLASS_2") SELECT "U"."KEY", "U"."Score_CLASS_0", "U"."Score_CLASS_1", "U"."Score_CLASS_2" 
FROM (WITH "DT_node_lookup_40" AS 
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", CASE WHEN ("ADS_sca_2_OUT".scaler_output_5 < 0.540091991424561) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_output_5 < -0.260044306516647) THEN 3 ELSE 4 END ELSE 2 END AS node_id_2 
FROM tmp_20180417055209_glq5iy_ads_ AS "ADS_sca_2_OUT"), 
"DT_node_data_40" AS 
(SELECT "Values".node_id AS node_id, CAST("Values".feature AS FLOAT) AS feature, CAST("Values"."threshold" AS FLOAT) AS "threshold", CAST("Values".depth AS FLOAT) AS depth, CAST("Values".parent_id AS FLOAT) AS parent_id, CAST("Values"."Score" AS FLOAT) AS "Score" 
...
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", CASE WHEN ("ADS_sca_2_OUT".scaler_output_5 < 0.540091991424561) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_output_4 < 0.002924289554358) THEN 3 ELSE 4 END ELSE 2 END AS node_id_2 
FROM tmp_20180417055209_glq5iy_ads_ AS "ADS_sca_2_OUT"), 
"DT_node_data_43" AS 
(SELECT "Values".node_id AS node_id, CAST("Values".feature AS FLOAT) AS feature, CAST("Values"."threshold" AS FLOAT) AS "threshold", CAST("Values".depth AS FLOAT) AS depth, CAST("Values".parent_id AS FLOAT) AS parent_id, CAST("Values"."Score" AS FLOAT) AS "Score" 
...
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", CASE WHEN ("ADS_sca_2_OUT".scaler_output_4 < 0.587782144546509) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_output_2 < -0.359716951847076) THEN 3 ELSE 4 END ELSE 2 END AS node_id_2 
FROM tmp_20180417055209_glq5iy_ads_ AS "ADS_sca_2_OUT"), 
"DT_node_data_46" AS 
(SELECT "Values".node_id AS node_id, CAST("Values".feature AS FLOAT) AS feature, CAST("Values"."threshold" AS FLOAT) AS "threshold", CAST("Values".depth AS FLOAT) AS depth, CAST("Values".parent_id AS FLOAT) AS parent_id, CAST("Values"."Score" AS FLOAT) AS "Score" 
...
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", CASE WHEN ("ADS_sca_2_OUT".scaler_output_4 < 0.646267890930176) THEN 1 ELSE 2 END AS node_id_2 
FROM tmp_20180417055209_glq5iy_ads_ AS "ADS_sca_2_OUT"), 
"DT_node_data_47" AS 
(SELECT "Values".node_id AS node_id, CAST("Values".feature AS FLOAT) AS feature, CAST("Values"."threshold" AS FLOAT) AS "threshold", CAST("Values".depth AS FLOAT) AS depth, CAST("Values".parent_id AS FLOAT) AS parent_id, CAST("Values"."Score" AS FLOAT) AS "Score" 
...
-- Code For temporary table tmp_20180417055209_uyi56l_xgb_ part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180417055209_uyi56l_xgb_  (
	"KEY" BIGINT, 
	"Score_CLASS_0" FLOAT, 
	"Score_CLASS_1" FLOAT, 
	"Score_CLASS_2" FLOAT
...
-- Code For temporary table tmp_20180417055209_uyi56l_xgb_ part 2/2. Populate

INSERT INTO tmp_20180417055209_uyi56l_xgb_ ("KEY", "Score_CLASS_0", "Score_CLASS_1", "Score_CLASS_2") SELECT "U"."KEY", "U"."Score_CLASS_0", "U"."Score_CLASS_1", "U"."Score_CLASS_2" 
...
FROM tmp_20180417055209_75dhjv_xgb_ AS "XGB_B0" UNION ALL SELECT "XGB_B1"."KEY" AS "KEY", "XGB_B1"."Score_CLASS_0" AS "Score_CLASS_0", "XGB_B1"."Score_CLASS_1" AS "Score_CLASS_1", "XGB_B1"."Score_CLASS_2" AS "Score_CLASS_2" 
FROM tmp_20180417055209_n08xnt_xgb_ AS "XGB_B1" UNION ALL SELECT "XGB_B2"."KEY" AS "KEY", "XGB_B2"."Score_CLASS_0" AS "Score_CLASS_0", "XGB_B2"."Score_CLASS_1" AS "Score_CLASS_1", "XGB_B2"."Score_CLASS_2" AS "Score_CLASS_2" 
FROM tmp_20180417055209_rou4mg_xgb_ AS "XGB_B2" UNION ALL SELECT "XGB_B3"."KEY" AS "KEY", "XGB_B3"."Score_CLASS_0" AS "Score_CLASS_0", "XGB_B3"."Score_CLASS_1" AS "Score_CLASS_1", "XGB_B3"."Score_CLASS_2" AS "Score_CLASS_2" 
FROM tmp_20180417055209_oiaolt_xgb_ AS "XGB_B3" UNION ALL SELECT "XGB_B4"."KEY" AS "KEY", "XGB_B4"."Score_CLASS_0" AS "Score_CLASS_0", "XGB_B4"."Score_CLASS_1" AS "Score_CLASS_1", "XGB_B4"."Score_CLASS_2" AS "Score_CLASS_2" 
FROM tmp_20180417055209_p89v42_xgb_ AS "XGB_B4") AS "XGB_EnsembleUnion") AS "XGB_Union") AS "U"

-- Code For temporary table tmp_20180417055209_em44ay_xgb_ part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180417055209_em44ay_xgb_  (
	"KEY" BIGINT, 
	"Score_CLASS_0" FLOAT, 
	"Score_CLASS_1" FLOAT, 
	"Score_CLASS_2" FLOAT
...
-- Code For temporary table tmp_20180417055209_em44ay_xgb_ part 2/2. Populate

INSERT INTO tmp_20180417055209_em44ay_xgb_ ("KEY", "Score_CLASS_0", "Score_CLASS_1", "Score_CLASS_2") SELECT "U"."KEY", "U"."Score_CLASS_0", "U"."Score_CLASS_1", "U"."Score_CLASS_2" 
...
FROM tmp_20180417055209_uyi56l_xgb_ AS "XGB_Union" GROUP BY "XGB_Union"."KEY") AS "T") AS "XGB_sum") AS "U"
...
FROM tmp_20180417055209_em44ay_xgb_ AS "XGB_sum"), 
