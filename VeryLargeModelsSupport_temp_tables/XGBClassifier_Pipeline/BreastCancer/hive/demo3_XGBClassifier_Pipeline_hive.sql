...
-- Code For temporary table tmp_20180416232913_834ca0_ads_imp_1_out part 2/2. Populate

SELECT * FROM `tmp_20180416232913_834ca0_ads_imp_1_out`

-- Code For temporary table tmp_20180416232913_l6d82y_ads_sca_2_out part 1/2. Create 

CREATE TEMPORARY TABLE `tmp_20180416232913_l6d82y_ads_sca_2_out` STORED AS ORC AS SELECT `ADS_sca_2_OUT`.`KEY`, `ADS_sca_2_OUT`.`scaler_2`, `ADS_sca_2_OUT`.`scaler_3`, `ADS_sca_2_OUT`.`scaler_4`, `ADS_sca_2_OUT`.`scaler_5`, `ADS_sca_2_OUT`.`scaler_6`, `ADS_sca_2_OUT`.`scaler_7`, `ADS_sca_2_OUT`.`scaler_8`, `ADS_sca_2_OUT`.`scaler_9`, `ADS_sca_2_OUT`.`scaler_10`, `ADS_sca_2_OUT`.`scaler_11`, `ADS_sca_2_OUT`.`scaler_12`, `ADS_sca_2_OUT`.`scaler_13`, `ADS_sca_2_OUT`.`scaler_14`, `ADS_sca_2_OUT`.`scaler_15`, `ADS_sca_2_OUT`.`scaler_16`, `ADS_sca_2_OUT`.`scaler_17`, `ADS_sca_2_OUT`.`scaler_18`, `ADS_sca_2_OUT`.`scaler_19`, `ADS_sca_2_OUT`.`scaler_20`, `ADS_sca_2_OUT`.`scaler_21`, `ADS_sca_2_OUT`.`scaler_22`, `ADS_sca_2_OUT`.`scaler_23`, `ADS_sca_2_OUT`.`scaler_24`, `ADS_sca_2_OUT`.`scaler_25`, `ADS_sca_2_OUT`.`scaler_26`, `ADS_sca_2_OUT`.`scaler_27`, `ADS_sca_2_OUT`.`scaler_28`, `ADS_sca_2_OUT`.`scaler_29`, `ADS_sca_2_OUT`.`scaler_30`, `ADS_sca_2_OUT`.`scaler_31` 
...
FROM `tmp_20180416232913_834ca0_ads_imp_1_out` AS `ADS_imp_1_OUT`) AS `ADS_sca_2_OUT`

-- Code For temporary table tmp_20180416232913_l6d82y_ads_sca_2_out part 2/2. Populate

SELECT * FROM `tmp_20180416232913_l6d82y_ads_sca_2_out`

-- Code For temporary table tmp_20180416232913_w20asn_xgb_b0 part 1/2. Create 

CREATE TEMPORARY TABLE `tmp_20180416232913_w20asn_xgb_b0` STORED AS ORC AS WITH `DT_node_lookup` AS 
...
FROM `tmp_20180416232913_l6d82y_ads_sca_2_out` AS `ADS_sca_2_OUT`), 
`DT_node_data` AS 
...
FROM (SELECT 3 AS `node_id`, CAST(NULL AS STRING) AS `feature`, CAST(NULL AS FLOAT) AS `threshold`, 2 AS `depth`, 1 AS `parent_id`, 0.1926199346780777 AS `Score` UNION ALL SELECT 4 AS `node_id`, CAST(NULL AS STRING) AS `feature`, CAST(NULL AS FLOAT) AS `threshold`, 2 AS `depth`, 1 AS `parent_id`, 0.03478261083364487 AS `Score` UNION ALL SELECT 5 AS `node_id`, CAST(NULL AS STRING) AS `feature`, CAST(NULL AS FLOAT) AS `threshold`, 2 AS `depth`, 2 AS `parent_id`, -0.12727272510528564 AS `Score` UNION ALL SELECT 6 AS `node_id`, CAST(NULL AS STRING) AS `feature`, CAST(NULL AS FLOAT) AS `threshold`, 2 AS `depth`, 2 AS `parent_id`, -0.19272726774215698 AS `Score`) AS `Values`), 
`DT_Output` AS 
...
`DT_node_data_1` AS 
(SELECT `Values`.`node_id` AS `node_id`, CAST(`Values`.`feature` AS FLOAT) AS `feature`, CAST(`Values`.`threshold` AS FLOAT) AS `threshold`, CAST(`Values`.`depth` AS FLOAT) AS `depth`, CAST(`Values`.`parent_id` AS FLOAT) AS `parent_id`, CAST(`Values`.`Score` AS FLOAT) AS `Score` 
FROM (SELECT 3 AS `node_id`, CAST(NULL AS STRING) AS `feature`, CAST(NULL AS FLOAT) AS `threshold`, 2 AS `depth`, 1 AS `parent_id`, 0.17632412910461426 AS `Score` UNION ALL SELECT 4 AS `node_id`, CAST(NULL AS STRING) AS `feature`, CAST(NULL AS FLOAT) AS `threshold`, 2 AS `depth`, 1 AS `parent_id`, 0.028210192918777466 AS `Score` UNION ALL SELECT 5 AS `node_id`, CAST(NULL AS STRING) AS `feature`, CAST(NULL AS FLOAT) AS `threshold`, 2 AS `depth`, 2 AS `parent_id`, -0.11695275455713272 AS `Score` UNION ALL SELECT 6 AS `node_id`, CAST(NULL AS STRING) AS `feature`, CAST(NULL AS FLOAT) AS `threshold`, 2 AS `depth`, 2 AS `parent_id`, -0.17597316205501556 AS `Score`) AS `Values`), 
`DT_Output_1` AS 
...
`DT_node_data_2` AS 
(SELECT `Values`.`node_id` AS `node_id`, CAST(`Values`.`feature` AS FLOAT) AS `feature`, CAST(`Values`.`threshold` AS FLOAT) AS `threshold`, CAST(`Values`.`depth` AS FLOAT) AS `depth`, CAST(`Values`.`parent_id` AS FLOAT) AS `parent_id`, CAST(`Values`.`Score` AS FLOAT) AS `Score` 
FROM (SELECT 2 AS `node_id`, CAST(NULL AS STRING) AS `feature`, CAST(NULL AS FLOAT) AS `threshold`, 1 AS `depth`, 0 AS `parent_id`, -0.15892711281776428 AS `Score` UNION ALL SELECT 3 AS `node_id`, CAST(NULL AS STRING) AS `feature`, CAST(NULL AS FLOAT) AS `threshold`, 2 AS `depth`, 1 AS `parent_id`, 0.16254661977291107 AS `Score` UNION ALL SELECT 4 AS `node_id`, CAST(NULL AS STRING) AS `feature`, CAST(NULL AS FLOAT) AS `threshold`, 2 AS `depth`, 1 AS `parent_id`, 0.0025618381332606077 AS `Score`) AS `Values`), 
`DT_Output_2` AS 
...
`DT_node_data_3` AS 
(SELECT `Values`.`node_id` AS `node_id`, CAST(`Values`.`feature` AS FLOAT) AS `feature`, CAST(`Values`.`threshold` AS FLOAT) AS `threshold`, CAST(`Values`.`depth` AS FLOAT) AS `depth`, CAST(`Values`.`parent_id` AS FLOAT) AS `parent_id`, CAST(`Values`.`Score` AS FLOAT) AS `Score` 
FROM (SELECT 3 AS `node_id`, CAST(NULL AS STRING) AS `feature`, CAST(NULL AS FLOAT) AS `threshold`, 2 AS `depth`, 1 AS `parent_id`, 0.1533551663160324 AS `Score` UNION ALL SELECT 4 AS `node_id`, CAST(NULL AS STRING) AS `feature`, CAST(NULL AS FLOAT) AS `threshold`, 2 AS `depth`, 1 AS `parent_id`, 0.02111710235476494 AS `Score` UNION ALL SELECT 5 AS `node_id`, CAST(NULL AS STRING) AS `feature`, CAST(NULL AS FLOAT) AS `threshold`, 2 AS `depth`, 2 AS `parent_id`, -0.1014096662402153 AS `Score` UNION ALL SELECT 6 AS `node_id`, CAST(NULL AS STRING) AS `feature`, CAST(NULL AS FLOAT) AS `threshold`, 2 AS `depth`, 2 AS `parent_id`, -0.15645359456539154 AS `Score`) AS `Values`), 
`DT_Output_3` AS 
...
`DT_node_data_4` AS 
(SELECT `Values`.`node_id` AS `node_id`, CAST(`Values`.`feature` AS FLOAT) AS `feature`, CAST(`Values`.`threshold` AS FLOAT) AS `threshold`, CAST(`Values`.`depth` AS FLOAT) AS `depth`, CAST(`Values`.`parent_id` AS FLOAT) AS `parent_id`, CAST(`Values`.`Score` AS FLOAT) AS `Score` 
FROM (SELECT 2 AS `node_id`, CAST(NULL AS STRING) AS `feature`, CAST(NULL AS FLOAT) AS `threshold`, 1 AS `depth`, 0 AS `parent_id`, -0.14159958064556122 AS `Score` UNION ALL SELECT 3 AS `node_id`, CAST(NULL AS STRING) AS `feature`, CAST(NULL AS FLOAT) AS `threshold`, 2 AS `depth`, 1 AS `parent_id`, 0.14474166929721832 AS `Score` UNION ALL SELECT 4 AS `node_id`, CAST(NULL AS STRING) AS `feature`, CAST(NULL AS FLOAT) AS `threshold`, 2 AS `depth`, 1 AS `parent_id`, 0.007800843566656113 AS `Score`) AS `Values`), 
`DT_Output_4` AS 
...
`DT_node_data_5` AS 
(SELECT `Values`.`node_id` AS `node_id`, CAST(`Values`.`feature` AS FLOAT) AS `feature`, CAST(`Values`.`threshold` AS FLOAT) AS `threshold`, CAST(`Values`.`depth` AS FLOAT) AS `depth`, CAST(`Values`.`parent_id` AS FLOAT) AS `parent_id`, CAST(`Values`.`Score` AS FLOAT) AS `Score` 
FROM (SELECT 2 AS `node_id`, CAST(NULL AS STRING) AS `feature`, CAST(NULL AS FLOAT) AS `threshold`, 1 AS `depth`, 0 AS `parent_id`, -0.14109736680984497 AS `Score` UNION ALL SELECT 3 AS `node_id`, CAST(NULL AS STRING) AS `feature`, CAST(NULL AS FLOAT) AS `threshold`, 2 AS `depth`, 1 AS `parent_id`, 0.1364816427230835 AS `Score` UNION ALL SELECT 4 AS `node_id`, CAST(NULL AS STRING) AS `feature`, CAST(NULL AS FLOAT) AS `threshold`, 2 AS `depth`, 1 AS `parent_id`, -0.014269627630710602 AS `Score`) AS `Values`), 
`DT_Output_5` AS 
...
`DT_node_data_6` AS 
(SELECT `Values`.`node_id` AS `node_id`, CAST(`Values`.`feature` AS FLOAT) AS `feature`, CAST(`Values`.`threshold` AS FLOAT) AS `threshold`, CAST(`Values`.`depth` AS FLOAT) AS `depth`, CAST(`Values`.`parent_id` AS FLOAT) AS `parent_id`, CAST(`Values`.`Score` AS FLOAT) AS `Score` 
FROM (SELECT 3 AS `node_id`, CAST(NULL AS STRING) AS `feature`, CAST(NULL AS FLOAT) AS `threshold`, 2 AS `depth`, 1 AS `parent_id`, 0.13363148272037506 AS `Score` UNION ALL SELECT 4 AS `node_id`, CAST(NULL AS STRING) AS `feature`, CAST(NULL AS FLOAT) AS `threshold`, 2 AS `depth`, 1 AS `parent_id`, 0.020645752549171448 AS `Score` UNION ALL SELECT 5 AS `node_id`, CAST(NULL AS STRING) AS `feature`, CAST(NULL AS FLOAT) AS `threshold`, 2 AS `depth`, 2 AS `parent_id`, -0.07329749315977097 AS `Score` UNION ALL SELECT 6 AS `node_id`, CAST(NULL AS STRING) AS `feature`, CAST(NULL AS FLOAT) AS `threshold`, 2 AS `depth`, 2 AS `parent_id`, -0.13540911674499512 AS `Score`) AS `Values`), 
`DT_Output_6` AS 
...
`DT_node_data_7` AS 
(SELECT `Values`.`node_id` AS `node_id`, CAST(`Values`.`feature` AS FLOAT) AS `feature`, CAST(`Values`.`threshold` AS FLOAT) AS `threshold`, CAST(`Values`.`depth` AS FLOAT) AS `depth`, CAST(`Values`.`parent_id` AS FLOAT) AS `parent_id`, CAST(`Values`.`Score` AS FLOAT) AS `Score` 
FROM (SELECT 3 AS `node_id`, CAST(NULL AS STRING) AS `feature`, CAST(NULL AS FLOAT) AS `threshold`, 2 AS `depth`, 1 AS `parent_id`, 0.1283390074968338 AS `Score` UNION ALL SELECT 4 AS `node_id`, CAST(NULL AS STRING) AS `feature`, CAST(NULL AS FLOAT) AS `threshold`, 2 AS `depth`, 1 AS `parent_id`, 0.014707544818520546 AS `Score` UNION ALL SELECT 5 AS `node_id`, CAST(NULL AS STRING) AS `feature`, CAST(NULL AS FLOAT) AS `threshold`, 2 AS `depth`, 2 AS `parent_id`, -0.07714793086051941 AS `Score` UNION ALL SELECT 6 AS `node_id`, CAST(NULL AS STRING) AS `feature`, CAST(NULL AS FLOAT) AS `threshold`, 2 AS `depth`, 2 AS `parent_id`, -0.133819118142128 AS `Score`) AS `Values`), 
`DT_Output_7` AS 
...
`DT_node_data_8` AS 
(SELECT `Values`.`node_id` AS `node_id`, CAST(`Values`.`feature` AS FLOAT) AS `feature`, CAST(`Values`.`threshold` AS FLOAT) AS `threshold`, CAST(`Values`.`depth` AS FLOAT) AS `depth`, CAST(`Values`.`parent_id` AS FLOAT) AS `parent_id`, CAST(`Values`.`Score` AS FLOAT) AS `Score` 
FROM (SELECT 3 AS `node_id`, CAST(NULL AS STRING) AS `feature`, CAST(NULL AS FLOAT) AS `threshold`, 2 AS `depth`, 1 AS `parent_id`, 0.12476612627506256 AS `Score` UNION ALL SELECT 4 AS `node_id`, CAST(NULL AS STRING) AS `feature`, CAST(NULL AS FLOAT) AS `threshold`, 2 AS `depth`, 1 AS `parent_id`, 0.01592203602194786 AS `Score` UNION ALL SELECT 5 AS `node_id`, CAST(NULL AS STRING) AS `feature`, CAST(NULL AS FLOAT) AS `threshold`, 2 AS `depth`, 2 AS `parent_id`, -0.06960324943065643 AS `Score` UNION ALL SELECT 6 AS `node_id`, CAST(NULL AS STRING) AS `feature`, CAST(NULL AS FLOAT) AS `threshold`, 2 AS `depth`, 2 AS `parent_id`, -0.13226597011089325 AS `Score`) AS `Values`), 
`DT_Output_8` AS 
...
`DT_node_data_9` AS 
(SELECT `Values`.`node_id` AS `node_id`, CAST(`Values`.`feature` AS FLOAT) AS `feature`, CAST(`Values`.`threshold` AS FLOAT) AS `threshold`, CAST(`Values`.`depth` AS FLOAT) AS `depth`, CAST(`Values`.`parent_id` AS FLOAT) AS `parent_id`, CAST(`Values`.`Score` AS FLOAT) AS `Score` 
FROM (SELECT 2 AS `node_id`, CAST(NULL AS STRING) AS `feature`, CAST(NULL AS FLOAT) AS `threshold`, 1 AS `depth`, 0 AS `parent_id`, -0.12262566387653351 AS `Score` UNION ALL SELECT 3 AS `node_id`, CAST(NULL AS STRING) AS `feature`, CAST(NULL AS FLOAT) AS `threshold`, 2 AS `depth`, 1 AS `parent_id`, 0.11848687380552292 AS `Score` UNION ALL SELECT 4 AS `node_id`, CAST(NULL AS STRING) AS `feature`, CAST(NULL AS FLOAT) AS `threshold`, 2 AS `depth`, 1 AS `parent_id`, -0.006392433773726225 AS `Score`) AS `Values`), 
`DT_Output_9` AS 
...
-- Code For temporary table tmp_20180416232913_w20asn_xgb_b0 part 2/2. Populate

SELECT * FROM `tmp_20180416232913_w20asn_xgb_b0`

-- Code For temporary table tmp_20180416232913_8db20a_xgb_b1 part 1/2. Create 

CREATE TEMPORARY TABLE `tmp_20180416232913_8db20a_xgb_b1` STORED AS ORC AS WITH `DT_node_lookup_10` AS 
...
`DT_node_data_10` AS 
(SELECT `Values`.`node_id` AS `node_id`, CAST(`Values`.`feature` AS FLOAT) AS `feature`, CAST(`Values`.`threshold` AS FLOAT) AS `threshold`, CAST(`Values`.`depth` AS FLOAT) AS `depth`, CAST(`Values`.`parent_id` AS FLOAT) AS `parent_id`, CAST(`Values`.`Score` AS FLOAT) AS `Score` 
FROM (SELECT 3 AS `node_id`, CAST(NULL AS STRING) AS `feature`, CAST(NULL AS FLOAT) AS `threshold`, 2 AS `depth`, 1 AS `parent_id`, 0.11701875180006027 AS `Score` UNION ALL SELECT 4 AS `node_id`, CAST(NULL AS STRING) AS `feature`, CAST(NULL AS FLOAT) AS `threshold`, 2 AS `depth`, 1 AS `parent_id`, 0.016944319009780884 AS `Score` UNION ALL SELECT 5 AS `node_id`, CAST(NULL AS STRING) AS `feature`, CAST(NULL AS FLOAT) AS `threshold`, 2 AS `depth`, 2 AS `parent_id`, -0.07019593566656113 AS `Score` UNION ALL SELECT 6 AS `node_id`, CAST(NULL AS STRING) AS `feature`, CAST(NULL AS FLOAT) AS `threshold`, 2 AS `depth`, 2 AS `parent_id`, -0.12330199778079987 AS `Score`) AS `Values`), 
`DT_Output_10` AS 
...
`DT_node_data_11` AS 
(SELECT `Values`.`node_id` AS `node_id`, CAST(`Values`.`feature` AS FLOAT) AS `feature`, CAST(`Values`.`threshold` AS FLOAT) AS `threshold`, CAST(`Values`.`depth` AS FLOAT) AS `depth`, CAST(`Values`.`parent_id` AS FLOAT) AS `parent_id`, CAST(`Values`.`Score` AS FLOAT) AS `Score` 
FROM (SELECT 3 AS `node_id`, CAST(NULL AS STRING) AS `feature`, CAST(NULL AS FLOAT) AS `threshold`, 2 AS `depth`, 1 AS `parent_id`, 0.11512360721826553 AS `Score` UNION ALL SELECT 4 AS `node_id`, CAST(NULL AS STRING) AS `feature`, CAST(NULL AS FLOAT) AS `threshold`, 2 AS `depth`, 1 AS `parent_id`, 0.017077675089240074 AS `Score` UNION ALL SELECT 5 AS `node_id`, CAST(NULL AS STRING) AS `feature`, CAST(NULL AS FLOAT) AS `threshold`, 2 AS `depth`, 2 AS `parent_id`, -0.06643888354301453 AS `Score` UNION ALL SELECT 6 AS `node_id`, CAST(NULL AS STRING) AS `feature`, CAST(NULL AS FLOAT) AS `threshold`, 2 AS `depth`, 2 AS `parent_id`, -0.12265763431787491 AS `Score`) AS `Values`), 
`DT_Output_11` AS 
...
`DT_node_data_12` AS 
(SELECT `Values`.`node_id` AS `node_id`, CAST(`Values`.`feature` AS FLOAT) AS `feature`, CAST(`Values`.`threshold` AS FLOAT) AS `threshold`, CAST(`Values`.`depth` AS FLOAT) AS `depth`, CAST(`Values`.`parent_id` AS FLOAT) AS `parent_id`, CAST(`Values`.`Score` AS FLOAT) AS `Score` 
FROM (SELECT 2 AS `node_id`, CAST(NULL AS STRING) AS `feature`, CAST(NULL AS FLOAT) AS `threshold`, 1 AS `depth`, 0 AS `parent_id`, -0.11374557018280029 AS `Score` UNION ALL SELECT 4 AS `node_id`, CAST(NULL AS STRING) AS `feature`, CAST(NULL AS FLOAT) AS `threshold`, 2 AS `depth`, 1 AS `parent_id`, -0.003493115771561861 AS `Score` UNION ALL SELECT 5 AS `node_id`, CAST(NULL AS STRING) AS `feature`, CAST(NULL AS FLOAT) AS `threshold`, 3 AS `depth`, 3 AS `parent_id`, 0.07863019406795502 AS `Score` UNION ALL SELECT 6 AS `node_id`, CAST(NULL AS STRING) AS `feature`, CAST(NULL AS FLOAT) AS `threshold`, 3 AS `depth`, 3 AS `parent_id`, 0.11759652942419052 AS `Score`) AS `Values`), 
`DT_Output_12` AS 
...
`DT_node_data_13` AS 
(SELECT `Values`.`node_id` AS `node_id`, CAST(`Values`.`feature` AS FLOAT) AS `feature`, CAST(`Values`.`threshold` AS FLOAT) AS `threshold`, CAST(`Values`.`depth` AS FLOAT) AS `depth`, CAST(`Values`.`parent_id` AS FLOAT) AS `parent_id`, CAST(`Values`.`Score` AS FLOAT) AS `Score` 
FROM (SELECT 2 AS `node_id`, CAST(NULL AS STRING) AS `feature`, CAST(NULL AS FLOAT) AS `threshold`, 1 AS `depth`, 0 AS `parent_id`, -0.10585534572601318 AS `Score` UNION ALL SELECT 4 AS `node_id`, CAST(NULL AS STRING) AS `feature`, CAST(NULL AS FLOAT) AS `threshold`, 2 AS `depth`, 1 AS `parent_id`, -0.0024481695145368576 AS `Score` UNION ALL SELECT 5 AS `node_id`, CAST(NULL AS STRING) AS `feature`, CAST(NULL AS FLOAT) AS `threshold`, 3 AS `depth`, 3 AS `parent_id`, 0.07931221276521683 AS `Score` UNION ALL SELECT 6 AS `node_id`, CAST(NULL AS STRING) AS `feature`, CAST(NULL AS FLOAT) AS `threshold`, 3 AS `depth`, 3 AS `parent_id`, 0.11873737722635269 AS `Score`) AS `Values`), 
`DT_Output_13` AS 
...
`DT_node_data_14` AS 
(SELECT `Values`.`node_id` AS `node_id`, CAST(`Values`.`feature` AS FLOAT) AS `feature`, CAST(`Values`.`threshold` AS FLOAT) AS `threshold`, CAST(`Values`.`depth` AS FLOAT) AS `depth`, CAST(`Values`.`parent_id` AS FLOAT) AS `parent_id`, CAST(`Values`.`Score` AS FLOAT) AS `Score` 
FROM (SELECT 3 AS `node_id`, CAST(NULL AS STRING) AS `feature`, CAST(NULL AS FLOAT) AS `threshold`, 2 AS `depth`, 1 AS `parent_id`, 0.10965307056903839 AS `Score` UNION ALL SELECT 4 AS `node_id`, CAST(NULL AS STRING) AS `feature`, CAST(NULL AS FLOAT) AS `threshold`, 2 AS `depth`, 1 AS `parent_id`, 0.012755125761032104 AS `Score` UNION ALL SELECT 5 AS `node_id`, CAST(NULL AS STRING) AS `feature`, CAST(NULL AS FLOAT) AS `threshold`, 2 AS `depth`, 2 AS `parent_id`, -0.06810056418180466 AS `Score` UNION ALL SELECT 6 AS `node_id`, CAST(NULL AS STRING) AS `feature`, CAST(NULL AS FLOAT) AS `threshold`, 2 AS `depth`, 2 AS `parent_id`, -0.11264988034963608 AS `Score`) AS `Values`), 
`DT_Output_14` AS 
...
`DT_node_data_15` AS 
(SELECT `Values`.`node_id` AS `node_id`, CAST(`Values`.`feature` AS FLOAT) AS `feature`, CAST(`Values`.`threshold` AS FLOAT) AS `threshold`, CAST(`Values`.`depth` AS FLOAT) AS `depth`, CAST(`Values`.`parent_id` AS FLOAT) AS `parent_id`, CAST(`Values`.`Score` AS FLOAT) AS `Score` 
FROM (SELECT 2 AS `node_id`, CAST(NULL AS STRING) AS `feature`, CAST(NULL AS FLOAT) AS `threshold`, 1 AS `depth`, 0 AS `parent_id`, -0.10041051357984543 AS `Score` UNION ALL SELECT 3 AS `node_id`, CAST(NULL AS STRING) AS `feature`, CAST(NULL AS FLOAT) AS `threshold`, 2 AS `depth`, 1 AS `parent_id`, 0.1078338772058487 AS `Score` UNION ALL SELECT 4 AS `node_id`, CAST(NULL AS STRING) AS `feature`, CAST(NULL AS FLOAT) AS `threshold`, 2 AS `depth`, 1 AS `parent_id`, 0.0019829440861940384 AS `Score`) AS `Values`), 
`DT_Output_15` AS 
...
-- Code For temporary table tmp_20180416232913_8db20a_xgb_b1 part 2/2. Populate

SELECT * FROM `tmp_20180416232913_8db20a_xgb_b1`

-- Code For temporary table tmp_20180416232913_pabv8k_xgb_union part 1/2. Create 

CREATE TEMPORARY TABLE `tmp_20180416232913_pabv8k_xgb_union` STORED AS ORC AS SELECT `XGB_Union`.`KEY`, `XGB_Union`.`Score_0` 
...
FROM `tmp_20180416232913_w20asn_xgb_b0` AS `XGB_B0` UNION ALL SELECT `XGB_B1`.`KEY` AS `KEY`, `XGB_B1`.`Score_0` AS `Score_0` 
FROM `tmp_20180416232913_8db20a_xgb_b1` AS `XGB_B1`) AS `XGB_EnsembleUnion`) AS `XGB_Union`

-- Code For temporary table tmp_20180416232913_pabv8k_xgb_union part 2/2. Populate

SELECT * FROM `tmp_20180416232913_pabv8k_xgb_union`

-- Code For temporary table tmp_20180416232913_b7d4xl_xgb_sum part 1/2. Create 

CREATE TEMPORARY TABLE `tmp_20180416232913_b7d4xl_xgb_sum` STORED AS ORC AS SELECT `XGB_sum`.`KEY`, `XGB_sum`.`Score_0` 
...
FROM `tmp_20180416232913_pabv8k_xgb_union` AS `XGB_Union` GROUP BY `XGB_Union`.`KEY`) AS `T`) AS `XGB_sum`

-- Code For temporary table tmp_20180416232913_b7d4xl_xgb_sum part 2/2. Populate

SELECT * FROM `tmp_20180416232913_b7d4xl_xgb_sum`
...
FROM `tmp_20180416232913_b7d4xl_xgb_sum` AS `XGB_sum`), 
