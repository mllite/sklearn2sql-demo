...
-- Code For temporary table 32913_OIOJXE_ADS_IMP_1_OUT part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE "32913_OIOJXE_ADS_IMP_1_OUT" (
...
-- Code For temporary table 32913_OIOJXE_ADS_IMP_1_OUT part 2/2. Populate

INSERT INTO "32913_OIOJXE_ADS_IMP_1_OUT" ("KEY", impter_2, impter_3, impter_4, impter_5, impter_6, impter_7, impter_8, impter_9, impter_10, impter_11, impter_12, impter_13, impter_14, impter_15, impter_16, impter_17, impter_18, impter_19, impter_20, impter_21, impter_22, impter_23, impter_24, impter_25, impter_26, impter_27, impter_28, impter_29, impter_30, impter_31) SELECT "U"."KEY", "U".impter_2, "U".impter_3, "U".impter_4, "U".impter_5, "U".impter_6, "U".impter_7, "U".impter_8, "U".impter_9, "U".impter_10, "U".impter_11, "U".impter_12, "U".impter_13, "U".impter_14, "U".impter_15, "U".impter_16, "U".impter_17, "U".impter_18, "U".impter_19, "U".impter_20, "U".impter_21, "U".impter_22, "U".impter_23, "U".impter_24, "U".impter_25, "U".impter_26, "U".impter_27, "U".impter_28, "U".impter_29, "U".impter_30, "U".impter_31 
...
-- Code For temporary table 32913_A4W7KI_ADS_SCA_2_OUT part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE "32913_A4W7KI_ADS_SCA_2_OUT" (
	"KEY" NUMBER(19) NOT NULL, 
...
FROM "32913_OIOJXE_ADS_IMP_1_OUT" "ADS_imp_1_OUT") "ADS_sca_2_OUT") "U"

-- Code For temporary table 180416232913_7WBQ66_XGB_B0 part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE "180416232913_7WBQ66_XGB_B0" (
	"KEY" NUMBER(19), 
...
-- Code For temporary table 180416232913_7WBQ66_XGB_B0 part 2/2. Populate

INSERT INTO "180416232913_7WBQ66_XGB_B0" ("KEY", "Score_0") SELECT "U"."KEY", "U"."Score_0" 
...
FROM "32913_A4W7KI_ADS_SCA_2_OUT" "ADS_sca_2_OUT"), 
"DT_node_data" AS 
...
-- Code For temporary table 180416232913_Z6IARU_XGB_B1 part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE "180416232913_Z6IARU_XGB_B1" (
	"KEY" NUMBER(19), 
	"Score_0" BINARY_DOUBLE
)
...
-- Code For temporary table 180416232913_Z6IARU_XGB_B1 part 2/2. Populate

INSERT INTO "180416232913_Z6IARU_XGB_B1" ("KEY", "Score_0") SELECT "U"."KEY", "U"."Score_0" 
...
-- Code For temporary table 416232913_UMOI31_XGB_UNION part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE "416232913_UMOI31_XGB_UNION" (
	"KEY" NUMBER(19), 
	"Score_0" BINARY_DOUBLE
)
...
-- Code For temporary table 416232913_UMOI31_XGB_UNION part 2/2. Populate

INSERT INTO "416232913_UMOI31_XGB_UNION" ("KEY", "Score_0") SELECT "U"."KEY", "U"."Score_0" 
...
FROM "180416232913_7WBQ66_XGB_B0" "XGB_B0" UNION ALL SELECT "XGB_B1"."KEY" AS "KEY", "XGB_B1"."Score_0" AS "Score_0" 
FROM "180416232913_Z6IARU_XGB_B1" "XGB_B1") "XGB_EnsembleUnion") "XGB_Union") "U"

-- Code For temporary table 80416232913_Q9R115_XGB_SUM part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE "80416232913_Q9R115_XGB_SUM" (
	"KEY" NUMBER(19) NOT NULL, 
	"Score_0" BINARY_DOUBLE, 
	PRIMARY KEY ("KEY")
)
...
-- Code For temporary table 80416232913_Q9R115_XGB_SUM part 2/2. Populate

INSERT INTO "80416232913_Q9R115_XGB_SUM" ("KEY", "Score_0") SELECT "U"."KEY", "U"."Score_0" 
...
FROM "416232913_UMOI31_XGB_UNION" "XGB_Union" GROUP BY "XGB_Union"."KEY") "T") "XGB_sum") "U"
...
FROM "80416232913_Q9R115_XGB_SUM" "XGB_sum"), 
