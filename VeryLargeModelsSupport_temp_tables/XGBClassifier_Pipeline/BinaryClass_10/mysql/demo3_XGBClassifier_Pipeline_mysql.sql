...
-- Code For temporary table TMP_20180416223015_E2RR04_ADS_imp_1_OUT part 1/2. Create 


CREATE TEMPORARY TABLE `TMP_20180416223015_E2RR04_ADS_imp_1_OUT` (
	`KEY` BIGINT NOT NULL, 
	impter_2 DOUBLE, 
	impter_3 DOUBLE, 
	impter_4 DOUBLE, 
...
-- Code For temporary table TMP_20180416223015_E2RR04_ADS_imp_1_OUT part 2/2. Populate

INSERT INTO `TMP_20180416223015_E2RR04_ADS_imp_1_OUT` (`KEY`, impter_2, impter_3, impter_4, impter_5, impter_6, impter_7, impter_8, impter_9, impter_10, impter_11) SELECT `U`.`KEY`, `U`.impter_2, `U`.impter_3, `U`.impter_4, `U`.impter_5, `U`.impter_6, `U`.impter_7, `U`.impter_8, `U`.impter_9, `U`.impter_10, `U`.impter_11 
...
-- Code For temporary table TMP_20180416223015_RR73QI_ADS_sca_2_OUT part 1/2. Create 


CREATE TEMPORARY TABLE `TMP_20180416223015_RR73QI_ADS_sca_2_OUT` (
	`KEY` BIGINT NOT NULL, 
	scaler_2 DOUBLE, 
	scaler_3 DOUBLE, 
	scaler_4 DOUBLE, 
...
-- Code For temporary table TMP_20180416223015_RR73QI_ADS_sca_2_OUT part 2/2. Populate

INSERT INTO `TMP_20180416223015_RR73QI_ADS_sca_2_OUT` (`KEY`, scaler_2, scaler_3, scaler_4, scaler_5, scaler_6, scaler_7, scaler_8, scaler_9, scaler_10, scaler_11) SELECT `U`.`KEY`, `U`.scaler_2, `U`.scaler_3, `U`.scaler_4, `U`.scaler_5, `U`.scaler_6, `U`.scaler_7, `U`.scaler_8, `U`.scaler_9, `U`.scaler_10, `U`.scaler_11 
...
FROM `TMP_20180416223015_E2RR04_ADS_imp_1_OUT` AS `ADS_imp_1_OUT`) AS `ADS_sca_2_OUT`) AS `U`

-- Code For temporary table TMP_20180416223015_BABG5I_XGB_B0 part 1/2. Create 


CREATE TEMPORARY TABLE `TMP_20180416223015_BABG5I_XGB_B0` (
	`KEY` BIGINT, 
	`Score_0` DOUBLE
)
...
-- Code For temporary table TMP_20180416223015_BABG5I_XGB_B0 part 2/2. Populate

INSERT INTO `TMP_20180416223015_BABG5I_XGB_B0` (`KEY`, `Score_0`) SELECT `U`.`KEY`, `U`.`Score_0` 
...
FROM `TMP_20180416223015_RR73QI_ADS_sca_2_OUT` AS `ADS_sca_2_OUT`), 
`DT_node_data` AS 
...
-- Code For temporary table TMP_20180416223015_3L0IE0_XGB_B1 part 1/2. Create 


CREATE TEMPORARY TABLE `TMP_20180416223015_3L0IE0_XGB_B1` (
	`KEY` BIGINT, 
	`Score_0` DOUBLE
)
...
-- Code For temporary table TMP_20180416223015_3L0IE0_XGB_B1 part 2/2. Populate

INSERT INTO `TMP_20180416223015_3L0IE0_XGB_B1` (`KEY`, `Score_0`) SELECT `U`.`KEY`, `U`.`Score_0` 
...
-- Code For temporary table TMP_20180416223015_FNL9SB_XGB_Union part 1/2. Create 


CREATE TEMPORARY TABLE `TMP_20180416223015_FNL9SB_XGB_Union` (
	`KEY` BIGINT, 
	`Score_0` DOUBLE
)
...
-- Code For temporary table TMP_20180416223015_FNL9SB_XGB_Union part 2/2. Populate

INSERT INTO `TMP_20180416223015_FNL9SB_XGB_Union` (`KEY`, `Score_0`) SELECT `U`.`KEY`, `U`.`Score_0` 
...
FROM `TMP_20180416223015_BABG5I_XGB_B0` AS `XGB_B0` UNION ALL SELECT `XGB_B1`.`KEY` AS `KEY`, `XGB_B1`.`Score_0` AS `Score_0` 
FROM `TMP_20180416223015_3L0IE0_XGB_B1` AS `XGB_B1`) AS `XGB_EnsembleUnion`) AS `XGB_Union`) AS `U`

-- Code For temporary table TMP_20180416223015_BYSP7U_XGB_sum part 1/2. Create 


CREATE TEMPORARY TABLE `TMP_20180416223015_BYSP7U_XGB_sum` (
	`KEY` BIGINT NOT NULL, 
	`Score_0` DOUBLE, 
	PRIMARY KEY (`KEY`)
)
...
-- Code For temporary table TMP_20180416223015_BYSP7U_XGB_sum part 2/2. Populate

INSERT INTO `TMP_20180416223015_BYSP7U_XGB_sum` (`KEY`, `Score_0`) SELECT `U`.`KEY`, `U`.`Score_0` 
...
FROM `TMP_20180416223015_FNL9SB_XGB_Union` AS `XGB_Union` GROUP BY `XGB_Union`.`KEY`) AS `T`) AS `XGB_sum`) AS `U`
...
FROM `TMP_20180416223015_BYSP7U_XGB_sum` AS `XGB_sum`), 
