...
-- Code For temporary table tmp_20180416223016_5jf12d_ads_imp_1_out part 1/2. Create 

CREATE TEMPORARY TABLE `tmp_20180416223016_5jf12d_ads_imp_1_out` STORED AS ORC AS SELECT `ADS_imp_1_OUT`.`KEY`, `ADS_imp_1_OUT`.`impter_2`, `ADS_imp_1_OUT`.`impter_3`, `ADS_imp_1_OUT`.`impter_4`, `ADS_imp_1_OUT`.`impter_5`, `ADS_imp_1_OUT`.`impter_6`, `ADS_imp_1_OUT`.`impter_7`, `ADS_imp_1_OUT`.`impter_8`, `ADS_imp_1_OUT`.`impter_9`, `ADS_imp_1_OUT`.`impter_10`, `ADS_imp_1_OUT`.`impter_11` 
...
-- Code For temporary table tmp_20180416223016_5jf12d_ads_imp_1_out part 2/2. Populate

SELECT * FROM `tmp_20180416223016_5jf12d_ads_imp_1_out`

-- Code For temporary table tmp_20180416223016_4ljqu1_ads_sca_2_out part 1/2. Create 

CREATE TEMPORARY TABLE `tmp_20180416223016_4ljqu1_ads_sca_2_out` STORED AS ORC AS SELECT `ADS_sca_2_OUT`.`KEY`, `ADS_sca_2_OUT`.`scaler_2`, `ADS_sca_2_OUT`.`scaler_3`, `ADS_sca_2_OUT`.`scaler_4`, `ADS_sca_2_OUT`.`scaler_5`, `ADS_sca_2_OUT`.`scaler_6`, `ADS_sca_2_OUT`.`scaler_7`, `ADS_sca_2_OUT`.`scaler_8`, `ADS_sca_2_OUT`.`scaler_9`, `ADS_sca_2_OUT`.`scaler_10`, `ADS_sca_2_OUT`.`scaler_11` 
...
FROM `tmp_20180416223016_5jf12d_ads_imp_1_out` AS `ADS_imp_1_OUT`) AS `ADS_sca_2_OUT`

-- Code For temporary table tmp_20180416223016_4ljqu1_ads_sca_2_out part 2/2. Populate

SELECT * FROM `tmp_20180416223016_4ljqu1_ads_sca_2_out`

-- Code For temporary table tmp_20180416223016_3kk13b_xgb_b0 part 1/2. Create 

CREATE TEMPORARY TABLE `tmp_20180416223016_3kk13b_xgb_b0` STORED AS ORC AS WITH `DT_node_lookup` AS 
(SELECT `ADS_sca_2_OUT`.`KEY` AS `KEY`, CASE WHEN (`ADS_sca_2_OUT`.`scaler_11` < -0.24119442701339722) THEN 1 ELSE 2 END AS `node_id_2` 
FROM `tmp_20180416223016_4ljqu1_ads_sca_2_out` AS `ADS_sca_2_OUT`), 
`DT_node_data` AS 
...
FROM (SELECT 1 AS `node_id`, CAST(NULL AS STRING) AS `feature`, CAST(NULL AS FLOAT) AS `threshold`, 1 AS `depth`, 0 AS `parent_id`, -0.11818181723356247 AS `Score` UNION ALL SELECT 2 AS `node_id`, CAST(NULL AS STRING) AS `feature`, CAST(NULL AS FLOAT) AS `threshold`, 1 AS `depth`, 0 AS `parent_id`, 0.11818181723356247 AS `Score`) AS `Values`), 
`DT_Output` AS 
...
`DT_node_data_1` AS 
(SELECT `Values`.`node_id` AS `node_id`, CAST(`Values`.`feature` AS FLOAT) AS `feature`, CAST(`Values`.`threshold` AS FLOAT) AS `threshold`, CAST(`Values`.`depth` AS FLOAT) AS `depth`, CAST(`Values`.`parent_id` AS FLOAT) AS `parent_id`, CAST(`Values`.`Score` AS FLOAT) AS `Score` 
FROM (SELECT 0 AS `node_id`, CAST(NULL AS STRING) AS `feature`, CAST(NULL AS FLOAT) AS `threshold`, 0 AS `depth`, CAST(NULL AS BIGINT) AS `parent_id`, 4.698811562064975e-09 AS `Score`) AS `Values`), 
`DT_Output_1` AS 
...
`DT_node_data_6` AS 
(SELECT `Values`.`node_id` AS `node_id`, CAST(`Values`.`feature` AS FLOAT) AS `feature`, CAST(`Values`.`threshold` AS FLOAT) AS `threshold`, CAST(`Values`.`depth` AS FLOAT) AS `depth`, CAST(`Values`.`parent_id` AS FLOAT) AS `parent_id`, CAST(`Values`.`Score` AS FLOAT) AS `Score` 
FROM (SELECT 0 AS `node_id`, CAST(NULL AS STRING) AS `feature`, CAST(NULL AS FLOAT) AS `threshold`, 0 AS `depth`, CAST(NULL AS BIGINT) AS `parent_id`, -6.692246756756504e-09 AS `Score`) AS `Values`), 
`DT_Output_6` AS 
...
-- Code For temporary table tmp_20180416223016_3kk13b_xgb_b0 part 2/2. Populate

SELECT * FROM `tmp_20180416223016_3kk13b_xgb_b0`

-- Code For temporary table tmp_20180416223016_o7yvva_xgb_b1 part 1/2. Create 

CREATE TEMPORARY TABLE `tmp_20180416223016_o7yvva_xgb_b1` STORED AS ORC AS WITH `DT_node_lookup_10` AS 
(SELECT `ADS_sca_2_OUT`.`KEY` AS `KEY`, 0 AS `node_id_2` 
FROM `tmp_20180416223016_4ljqu1_ads_sca_2_out` AS `ADS_sca_2_OUT`), 
`DT_node_data_10` AS 
(SELECT `Values`.`node_id` AS `node_id`, CAST(`Values`.`feature` AS FLOAT) AS `feature`, CAST(`Values`.`threshold` AS FLOAT) AS `threshold`, CAST(`Values`.`depth` AS FLOAT) AS `depth`, CAST(`Values`.`parent_id` AS FLOAT) AS `parent_id`, CAST(`Values`.`Score` AS FLOAT) AS `Score` 
...
-- Code For temporary table tmp_20180416223016_o7yvva_xgb_b1 part 2/2. Populate

SELECT * FROM `tmp_20180416223016_o7yvva_xgb_b1`

-- Code For temporary table tmp_20180416223016_07pzin_xgb_union part 1/2. Create 

CREATE TEMPORARY TABLE `tmp_20180416223016_07pzin_xgb_union` STORED AS ORC AS SELECT `XGB_Union`.`KEY`, `XGB_Union`.`Score_0` 
...
FROM `tmp_20180416223016_3kk13b_xgb_b0` AS `XGB_B0` UNION ALL SELECT `XGB_B1`.`KEY` AS `KEY`, `XGB_B1`.`Score_0` AS `Score_0` 
FROM `tmp_20180416223016_o7yvva_xgb_b1` AS `XGB_B1`) AS `XGB_EnsembleUnion`) AS `XGB_Union`

-- Code For temporary table tmp_20180416223016_07pzin_xgb_union part 2/2. Populate

SELECT * FROM `tmp_20180416223016_07pzin_xgb_union`

-- Code For temporary table tmp_20180416223016_uy09i6_xgb_sum part 1/2. Create 

CREATE TEMPORARY TABLE `tmp_20180416223016_uy09i6_xgb_sum` STORED AS ORC AS SELECT `XGB_sum`.`KEY`, `XGB_sum`.`Score_0` 
...
FROM `tmp_20180416223016_07pzin_xgb_union` AS `XGB_Union` GROUP BY `XGB_Union`.`KEY`) AS `T`) AS `XGB_sum`

-- Code For temporary table tmp_20180416223016_uy09i6_xgb_sum part 2/2. Populate

SELECT * FROM `tmp_20180416223016_uy09i6_xgb_sum`
...
FROM `tmp_20180416223016_uy09i6_xgb_sum` AS `XGB_sum`), 
