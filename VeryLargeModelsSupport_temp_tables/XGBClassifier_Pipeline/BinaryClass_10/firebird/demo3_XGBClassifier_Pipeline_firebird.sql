...
-- Code For temporary table TMP_20180416223016_H5296Z_ADS_I part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180416223016_H5296Z_ADS_I" (
	"KEY" BIGINT, 
	impter_2 FLOAT, 
	impter_3 FLOAT, 
	impter_4 FLOAT, 
...
-- Code For temporary table TMP_20180416223016_H5296Z_ADS_I part 2/2. Populate

INSERT INTO "TMP_20180416223016_H5296Z_ADS_I" ("KEY", impter_2, impter_3, impter_4, impter_5, impter_6, impter_7, impter_8, impter_9, impter_10, impter_11) SELECT "U"."KEY", "U".impter_2, "U".impter_3, "U".impter_4, "U".impter_5, "U".impter_6, "U".impter_7, "U".impter_8, "U".impter_9, "U".impter_10, "U".impter_11 
...
-- Code For temporary table TMP_20180416223016_8PO7RZ_ADS_S part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180416223016_8PO7RZ_ADS_S" (
	"KEY" BIGINT, 
	scaler_2 FLOAT, 
	scaler_3 FLOAT, 
	scaler_4 FLOAT, 
...
-- Code For temporary table TMP_20180416223016_8PO7RZ_ADS_S part 2/2. Populate

INSERT INTO "TMP_20180416223016_8PO7RZ_ADS_S" ("KEY", scaler_2, scaler_3, scaler_4, scaler_5, scaler_6, scaler_7, scaler_8, scaler_9, scaler_10, scaler_11) SELECT "U"."KEY", "U".scaler_2, "U".scaler_3, "U".scaler_4, "U".scaler_5, "U".scaler_6, "U".scaler_7, "U".scaler_8, "U".scaler_9, "U".scaler_10, "U".scaler_11 
...
FROM "TMP_20180416223016_H5296Z_ADS_I" AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT") AS "U"

-- Code For temporary table TMP_20180416223016_UMBV7I_XGB_B part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180416223016_UMBV7I_XGB_B" (
	"KEY" BIGINT, 
	"Score_0" FLOAT
)
...
-- Code For temporary table TMP_20180416223016_UMBV7I_XGB_B part 2/2. Populate

INSERT INTO "TMP_20180416223016_UMBV7I_XGB_B" ("KEY", "Score_0") SELECT "U"."KEY", "U"."Score_0" 
...
FROM "TMP_20180416223016_8PO7RZ_ADS_S" AS "ADS_sca_2_OUT"), 
"DT_node_data" AS 
...
"DT_node_data_1" AS 
(SELECT "Values".node_id AS node_id, CAST("Values".feature AS FLOAT) AS feature, CAST("Values".threshold AS FLOAT) AS threshold, CAST("Values".depth AS FLOAT) AS depth, CAST("Values".parent_id AS FLOAT) AS parent_id, CAST("Values"."Score" AS FLOAT) AS "Score" 
FROM (SELECT 0 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT) AS threshold, 0 AS depth, CAST(NULL AS BIGINT) AS parent_id, 4.698811562064975e-09 AS "Score" FROM rdb$database) AS "Values"), 
"DT_Output_1" AS 
...
"DT_node_data_6" AS 
(SELECT "Values".node_id AS node_id, CAST("Values".feature AS FLOAT) AS feature, CAST("Values".threshold AS FLOAT) AS threshold, CAST("Values".depth AS FLOAT) AS depth, CAST("Values".parent_id AS FLOAT) AS parent_id, CAST("Values"."Score" AS FLOAT) AS "Score" 
FROM (SELECT 0 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT) AS threshold, 0 AS depth, CAST(NULL AS BIGINT) AS parent_id, -6.692246756756504e-09 AS "Score" FROM rdb$database) AS "Values"), 
"DT_Output_6" AS 
...
-- Code For temporary table TMP_20180416223016_0E4UFK_XGB_B part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180416223016_0E4UFK_XGB_B" (
	"KEY" BIGINT, 
	"Score_0" FLOAT
)
...
-- Code For temporary table TMP_20180416223016_0E4UFK_XGB_B part 2/2. Populate

INSERT INTO "TMP_20180416223016_0E4UFK_XGB_B" ("KEY", "Score_0") SELECT "U"."KEY", "U"."Score_0" 
...
-- Code For temporary table TMP_20180416223016_M77LUO_XGB_U part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180416223016_M77LUO_XGB_U" (
	"KEY" BIGINT, 
	"Score_0" FLOAT
)
...
-- Code For temporary table TMP_20180416223016_M77LUO_XGB_U part 2/2. Populate

INSERT INTO "TMP_20180416223016_M77LUO_XGB_U" ("KEY", "Score_0") SELECT "U"."KEY", "U"."Score_0" 
...
FROM "TMP_20180416223016_UMBV7I_XGB_B" AS "XGB_B0" UNION ALL SELECT "XGB_B1"."KEY" AS "KEY", "XGB_B1"."Score_0" AS "Score_0" 
FROM "TMP_20180416223016_0E4UFK_XGB_B" AS "XGB_B1") AS "XGB_EnsembleUnion") AS "XGB_Union") AS "U"

-- Code For temporary table TMP_20180416223016_D8E3O3_XGB_S part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180416223016_D8E3O3_XGB_S" (
	"KEY" BIGINT, 
	"Score_0" FLOAT
)
...
-- Code For temporary table TMP_20180416223016_D8E3O3_XGB_S part 2/2. Populate

INSERT INTO "TMP_20180416223016_D8E3O3_XGB_S" ("KEY", "Score_0") SELECT "U"."KEY", "U"."Score_0" 
...
FROM "TMP_20180416223016_M77LUO_XGB_U" AS "XGB_Union" GROUP BY "XGB_Union"."KEY") AS "T") AS "XGB_sum") AS "U"
...
FROM "TMP_20180416223016_D8E3O3_XGB_S" AS "XGB_sum"), 
