...
-- Code For temporary table tmp_20180417042330_l0tetf_ads_ part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180417042330_l0tetf_ads_  (
	"KEY" BIGINT, 
...
-- Code For temporary table tmp_20180417042330_l0tetf_ads_ part 2/2. Populate

INSERT INTO tmp_20180417042330_l0tetf_ads_ ("KEY", imputer_output_2, imputer_output_3, imputer_output_4, imputer_output_5) SELECT "U"."KEY", "U".imputer_output_2, "U".imputer_output_3, "U".imputer_output_4, "U".imputer_output_5 
...
-- Code For temporary table tmp_20180417042330_9ufc9z_ads_ part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180417042330_9ufc9z_ads_  (
	"KEY" BIGINT, 
...
-- Code For temporary table tmp_20180417042330_9ufc9z_ads_ part 2/2. Populate

INSERT INTO tmp_20180417042330_9ufc9z_ads_ ("KEY", scaler_output_2, scaler_output_3, scaler_output_4, scaler_output_5) SELECT "U"."KEY", "U".scaler_output_2, "U".scaler_output_3, "U".scaler_output_4, "U".scaler_output_5 
...
FROM tmp_20180417042330_l0tetf_ads_ AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT") AS "U"
