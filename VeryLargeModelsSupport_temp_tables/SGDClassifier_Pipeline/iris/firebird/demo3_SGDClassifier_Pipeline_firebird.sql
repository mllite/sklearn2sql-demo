...
-- Code For temporary table TMP_20180417042329_TUOU99_ADS_I part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180417042329_TUOU99_ADS_I" (
	"KEY" BIGINT, 
...
-- Code For temporary table TMP_20180417042329_TUOU99_ADS_I part 2/2. Populate

INSERT INTO "TMP_20180417042329_TUOU99_ADS_I" ("KEY", imputer_output_2, imputer_output_3, imputer_output_4, imputer_output_5) SELECT "U"."KEY", "U".imputer_output_2, "U".imputer_output_3, "U".imputer_output_4, "U".imputer_output_5 
...
-- Code For temporary table TMP_20180417042329_3XTPAY_ADS_S part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180417042329_3XTPAY_ADS_S" (
	"KEY" BIGINT, 
...
-- Code For temporary table TMP_20180417042329_3XTPAY_ADS_S part 2/2. Populate

INSERT INTO "TMP_20180417042329_3XTPAY_ADS_S" ("KEY", scaler_output_2, scaler_output_3, scaler_output_4, scaler_output_5) SELECT "U"."KEY", "U".scaler_output_2, "U".scaler_output_3, "U".scaler_output_4, "U".scaler_output_5 
...
FROM "TMP_20180417042329_TUOU99_ADS_I" AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT") AS "U"
...
FROM "TMP_20180417042329_3XTPAY_ADS_S" AS "ADS_sca_2_OUT"), 
linear_model_cte AS 
