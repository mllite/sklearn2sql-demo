...
-- Code For temporary table TMP_20180416222910_Q10U79_ADS_I part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180416222910_Q10U79_ADS_I" (
	"KEY" BIGINT, 
	impter_2 FLOAT, 
	impter_3 FLOAT, 
	impter_4 FLOAT, 
...
-- Code For temporary table TMP_20180416222910_Q10U79_ADS_I part 2/2. Populate

INSERT INTO "TMP_20180416222910_Q10U79_ADS_I" ("KEY", impter_2, impter_3, impter_4, impter_5, impter_6, impter_7, impter_8, impter_9, impter_10, impter_11) SELECT "U"."KEY", "U".impter_2, "U".impter_3, "U".impter_4, "U".impter_5, "U".impter_6, "U".impter_7, "U".impter_8, "U".impter_9, "U".impter_10, "U".impter_11 
...
-- Code For temporary table TMP_20180416222910_5OXBWO_ADS_S part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180416222910_5OXBWO_ADS_S" (
	"KEY" BIGINT, 
	scaler_2 FLOAT, 
	scaler_3 FLOAT, 
	scaler_4 FLOAT, 
...
-- Code For temporary table TMP_20180416222910_5OXBWO_ADS_S part 2/2. Populate

INSERT INTO "TMP_20180416222910_5OXBWO_ADS_S" ("KEY", scaler_2, scaler_3, scaler_4, scaler_5, scaler_6, scaler_7, scaler_8, scaler_9, scaler_10, scaler_11) SELECT "U"."KEY", "U".scaler_2, "U".scaler_3, "U".scaler_4, "U".scaler_5, "U".scaler_6, "U".scaler_7, "U".scaler_8, "U".scaler_9, "U".scaler_10, "U".scaler_11 
...
FROM "TMP_20180416222910_Q10U79_ADS_I" AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT") AS "U"
...
FROM "TMP_20180416222910_5OXBWO_ADS_S" AS "ADS_sca_2_OUT"), 
linear_model_cte AS 
