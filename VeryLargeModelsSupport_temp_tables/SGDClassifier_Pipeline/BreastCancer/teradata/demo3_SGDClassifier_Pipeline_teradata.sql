...
-- Code For temporary table tmp_20180416231809_61tqq1_ads_ part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180416231809_61tqq1_ads_  (
	"KEY" BIGINT, 
	impter_2 FLOAT, 
	impter_3 FLOAT, 
	impter_4 FLOAT, 
...
-- Code For temporary table tmp_20180416231809_61tqq1_ads_ part 2/2. Populate

INSERT INTO tmp_20180416231809_61tqq1_ads_ ("KEY", impter_2, impter_3, impter_4, impter_5, impter_6, impter_7, impter_8, impter_9, impter_10, impter_11, impter_12, impter_13, impter_14, impter_15, impter_16, impter_17, impter_18, impter_19, impter_20, impter_21, impter_22, impter_23, impter_24, impter_25, impter_26, impter_27, impter_28, impter_29, impter_30, impter_31) SELECT "U"."KEY", "U".impter_2, "U".impter_3, "U".impter_4, "U".impter_5, "U".impter_6, "U".impter_7, "U".impter_8, "U".impter_9, "U".impter_10, "U".impter_11, "U".impter_12, "U".impter_13, "U".impter_14, "U".impter_15, "U".impter_16, "U".impter_17, "U".impter_18, "U".impter_19, "U".impter_20, "U".impter_21, "U".impter_22, "U".impter_23, "U".impter_24, "U".impter_25, "U".impter_26, "U".impter_27, "U".impter_28, "U".impter_29, "U".impter_30, "U".impter_31 
...
-- Code For temporary table tmp_20180416231809_2e945m_ads_ part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180416231809_2e945m_ads_  (
	"KEY" BIGINT, 
	scaler_2 FLOAT, 
	scaler_3 FLOAT, 
	scaler_4 FLOAT, 
...
FROM tmp_20180416231809_61tqq1_ads_ AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT") AS "U"
...
FROM tmp_20180416231809_2e945m_ads_ AS "ADS_sca_2_OUT"), 
linear_model_cte AS 
(SELECT linear_input."KEY" AS "KEY", -8.548919382461623 * linear_input.scaler_2 + -3.259538036826956 * linear_input.scaler_3 + -8.476857383956384 * linear_input.scaler_4 + -8.23534657775992 * linear_input.scaler_5 + -5.205335997956869 * linear_input.scaler_6 + -0.960728731691539 * linear_input.scaler_7 + -24.811902865825594 * linear_input.scaler_8 + -34.69362918345244 * linear_input.scaler_9 + -3.45364375292235 * linear_input.scaler_10 + 2.524051509223556 * linear_input.scaler_11 + -28.410528741878014 * linear_input.scaler_12 + -0.62786064312959 * linear_input.scaler_13 + -21.26230675329681 * linear_input.scaler_14 + -18.08880388873673 * linear_input.scaler_15 + 10.969908878049218 * linear_input.scaler_16 + 19.069346288340352 * linear_input.scaler_17 + 13.098987067360495 * linear_input.scaler_18 + -11.00052209420924 * linear_input.scaler_19 + -3.373469396087772 * linear_input.scaler_20 + 28.689005688650106 * linear_input.scaler_21 + -13.742058958815306 * linear_input.scaler_22 + -12.819026085404625 * linear_input.scaler_23 + -12.115197229876072 * linear_input.scaler_24 + -11.168051449662606 * linear_input.scaler_25 + -14.614438863585688 * linear_input.scaler_26 + -14.627970751098937 * linear_input.scaler_27 + -21.877670360458826 * linear_input.scaler_28 + -33.49352800121592 * linear_input.scaler_29 + -22.12647048242086 * linear_input.scaler_30 + -8.300703470882356 * linear_input.scaler_31 + 14.297852318193058 AS lincomb 
FROM linear_input)
