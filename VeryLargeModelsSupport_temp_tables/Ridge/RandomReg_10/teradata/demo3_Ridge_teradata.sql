...
linear_model_cte AS 
(SELECT linear_input."KEY" AS "KEY", 33.995127705742 * linear_input."Feature_0" + 74.27149691595135 * linear_input."Feature_1" + 93.46619498786532 * linear_input."Feature_2" + 34.27298880225485 * linear_input."Feature_3" + 53.03396721690206 * linear_input."Feature_4" + 83.71233951181253 * linear_input."Feature_5" + 33.4484690010958 * linear_input."Feature_6" + 40.10271037872668 * linear_input."Feature_7" + 81.37088972564804 * linear_input."Feature_8" + 59.42534354923733 * linear_input."Feature_9" + 0.503834205546099 AS "Estimator" 
FROM linear_input)
