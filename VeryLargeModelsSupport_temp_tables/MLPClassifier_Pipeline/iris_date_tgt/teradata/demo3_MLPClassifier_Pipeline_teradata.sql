...
-- Code For temporary table tmp_20180417042725_78ywxw_ads_ part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180417042725_78ywxw_ads_  (
	"KEY" BIGINT, 
...
-- Code For temporary table tmp_20180417042725_78ywxw_ads_ part 2/2. Populate

INSERT INTO tmp_20180417042725_78ywxw_ads_ ("KEY", imputer_output_2, imputer_output_3, imputer_output_4, imputer_output_5) SELECT "U"."KEY", "U".imputer_output_2, "U".imputer_output_3, "U".imputer_output_4, "U".imputer_output_5 
...
-- Code For temporary table tmp_20180417042725_8ay6sd_ads_ part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180417042725_8ay6sd_ads_  (
	"KEY" BIGINT, 
...
-- Code For temporary table tmp_20180417042725_8ay6sd_ads_ part 2/2. Populate

INSERT INTO tmp_20180417042725_8ay6sd_ads_ ("KEY", scaler_output_2, scaler_output_3, scaler_output_4, scaler_output_5) SELECT "U"."KEY", "U".scaler_output_2, "U".scaler_output_3, "U".scaler_output_4, "U".scaler_output_5 
...
FROM tmp_20180417042725_78ywxw_ads_ AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT") AS "U"

-- Code For temporary table tmp_20180417042725_3nfmg1_hl_1 part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180417042725_3nfmg1_hl_1  (
	"KEY" BIGINT, 
	"NEUR_1_1" FLOAT, 
	"NEUR_1_2" FLOAT, 
	"NEUR_1_3" FLOAT
...
-- Code For temporary table tmp_20180417042725_3nfmg1_hl_1 part 2/2. Populate

INSERT INTO tmp_20180417042725_3nfmg1_hl_1 ("KEY", "NEUR_1_1", "NEUR_1_2", "NEUR_1_3") SELECT "U"."KEY", "U"."NEUR_1_1", "U"."NEUR_1_2", "U"."NEUR_1_3" 
FROM (WITH "IL" AS 
...
-- Code For temporary table tmp_20180417042725_5gu9p6_ol_s part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180417042725_5gu9p6_ol_s  (
	"KEY" BIGINT, 
	"NEUR_3_1" FLOAT, 
	"NEUR_3_2" FLOAT, 
	"NEUR_3_3" FLOAT
...
-- Code For temporary table tmp_20180417042725_5gu9p6_ol_s part 2/2. Populate

INSERT INTO tmp_20180417042725_5gu9p6_ol_s ("KEY", "NEUR_3_1", "NEUR_3_2", "NEUR_3_3") SELECT "U"."KEY", "U"."NEUR_3_1", "U"."NEUR_3_2", "U"."NEUR_3_3" 
FROM (WITH "HL_BA_2" AS 
(SELECT "HL_1_relu_1"."KEY" AS "KEY", 4.802628275790061 * "HL_1_relu_1"."NEUR_1_1" + 2.385191423963928 * "HL_1_relu_1"."NEUR_1_2" + -6.137068795883637 * "HL_1_relu_1"."NEUR_1_3" + -4.129195176965002 AS "NEUR_2_1", -0.765522781332369 * "HL_1_relu_1"."NEUR_1_1" + 3.834474949832534 * "HL_1_relu_1"."NEUR_1_2" + -0.801835589309112 * "HL_1_relu_1"."NEUR_1_3" + -2.274224105924782 AS "NEUR_2_2", -0.300664841399637 * "HL_1_relu_1"."NEUR_1_1" + -0.82719407765008 * "HL_1_relu_1"."NEUR_1_2" + -0.300991251230314 * "HL_1_relu_1"."NEUR_1_3" + -0.010394282503777 AS "NEUR_2_3", -0.341269056901892 * "HL_1_relu_1"."NEUR_1_1" + -0.518804953338625 * "HL_1_relu_1"."NEUR_1_2" + -0.122307386061482 * "HL_1_relu_1"."NEUR_1_3" + -0.740628349606889 AS "NEUR_2_4", -4.065295719003372 * "HL_1_relu_1"."NEUR_1_1" + -0.682800142785825 * "HL_1_relu_1"."NEUR_1_2" + 11.962556576412146 * "HL_1_relu_1"."NEUR_1_3" + 1.692551863026365 AS "NEUR_2_5" 
FROM tmp_20180417042725_3nfmg1_hl_1 AS "HL_1_relu_1"), 
"HL_2_relu" AS 
...
FROM "HL_BA_2"), 
"OL_BA" AS 
(SELECT "HL_2_relu"."KEY" AS "KEY", 4.932910621886575 * "HL_2_relu"."NEUR_2_1" + 7.160161889687136 * "HL_2_relu"."NEUR_2_2" + -0.504645179422775 * "HL_2_relu"."NEUR_2_3" + -0.769653220523105 * "HL_2_relu"."NEUR_2_4" + -11.87866204118191 * "HL_2_relu"."NEUR_2_5" + -21.607792454821038 AS "NEUR_3_1", 2.908187208764973 * "HL_2_relu"."NEUR_2_1" + 1.412214590183448 * "HL_2_relu"."NEUR_2_2" + 0.433131168531018 * "HL_2_relu"."NEUR_2_3" + 0.349179469093327 * "HL_2_relu"."NEUR_2_4" + 3.560939998511619 * "HL_2_relu"."NEUR_2_5" + 32.9669934591267 AS "NEUR_3_2", -8.348719571042205 * "HL_2_relu"."NEUR_2_1" + -6.858284924549348 * "HL_2_relu"."NEUR_2_2" + 0.07953003169538 * "HL_2_relu"."NEUR_2_3" + -0.406553152972502 * "HL_2_relu"."NEUR_2_4" + 7.694730704047067 * "HL_2_relu"."NEUR_2_5" + -12.535957843272707 AS "NEUR_3_3" 
FROM "HL_2_relu"), 
"OL_softmax" AS 
...
FROM tmp_20180417042725_5gu9p6_ol_s AS "OL_softmax_1"), 
