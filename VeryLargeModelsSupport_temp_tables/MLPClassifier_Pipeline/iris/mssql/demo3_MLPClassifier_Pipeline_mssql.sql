...
-- Code For temporary table ##TMP_20180417042246_EOXMBA_ADS_imp_1_OUT part 1/2. Create 


CREATE TABLE ##TMP_20180417042246_EOXMBA_ADS_imp_1_OUT (
	[KEY] BIGINT NULL, 
...
-- Code For temporary table ##TMP_20180417042246_EOXMBA_ADS_imp_1_OUT part 2/2. Populate

INSERT INTO ##TMP_20180417042246_EOXMBA_ADS_imp_1_OUT ([KEY], imputer_output_2, imputer_output_3, imputer_output_4, imputer_output_5) SELECT [ADS_imp_1_OUT].[KEY], [ADS_imp_1_OUT].imputer_output_2, [ADS_imp_1_OUT].imputer_output_3, [ADS_imp_1_OUT].imputer_output_4, [ADS_imp_1_OUT].imputer_output_5 
FROM (SELECT [ADS].[KEY] AS [KEY], CASE WHEN ([ADS].[Feature_0] IS NULL) THEN 5.8474999999999975 ELSE [ADS].[Feature_0] END AS imputer_output_2, CASE WHEN ([ADS].[Feature_1] IS NULL) THEN 3.0366666666666657 ELSE [ADS].[Feature_1] END AS imputer_output_3, CASE WHEN ([ADS].[Feature_2] IS NULL) THEN 3.8450000000000006 ELSE [ADS].[Feature_2] END AS imputer_output_4, CASE WHEN ([ADS].[Feature_3] IS NULL) THEN 1.245 ELSE [ADS].[Feature_3] END AS imputer_output_5 
FROM iris AS [ADS]) AS [ADS_imp_1_OUT]

-- Code For temporary table ##TMP_20180417042246_PSPX7H_ADS_sca_2_OUT part 1/2. Create 


CREATE TABLE ##TMP_20180417042246_PSPX7H_ADS_sca_2_OUT (
	[KEY] BIGINT NULL, 
...
-- Code For temporary table ##TMP_20180417042246_PSPX7H_ADS_sca_2_OUT part 2/2. Populate

INSERT INTO ##TMP_20180417042246_PSPX7H_ADS_sca_2_OUT ([KEY], scaler_output_2, scaler_output_3, scaler_output_4, scaler_output_5) SELECT [ADS_sca_2_OUT].[KEY], [ADS_sca_2_OUT].scaler_output_2, [ADS_sca_2_OUT].scaler_output_3, [ADS_sca_2_OUT].scaler_output_4, [ADS_sca_2_OUT].scaler_output_5 
...
FROM ##TMP_20180417042246_EOXMBA_ADS_imp_1_OUT AS [ADS_imp_1_OUT]) AS [ADS_sca_2_OUT]

-- Code For temporary table ##TMP_20180417042246_KHWS1F_HL_1_relu_1 part 1/2. Create 


CREATE TABLE ##TMP_20180417042246_KHWS1F_HL_1_relu_1 (
	[KEY] BIGINT NULL, 
...
-- Code For temporary table ##TMP_20180417042246_KHWS1F_HL_1_relu_1 part 2/2. Populate
...
FROM ##TMP_20180417042246_PSPX7H_ADS_sca_2_OUT AS [ADS_sca_2_OUT]), 
[HL_BA_1] AS 
...
FROM [HL_BA_1])
 INSERT INTO ##TMP_20180417042246_KHWS1F_HL_1_relu_1 ([KEY], [NEUR_1_1], [NEUR_1_2], [NEUR_1_3]) SELECT [HL_1_relu_1].[KEY], [HL_1_relu_1].[NEUR_1_1], [HL_1_relu_1].[NEUR_1_2], [HL_1_relu_1].[NEUR_1_3] 
FROM (SELECT [HL_1_relu].[KEY] AS [KEY], [HL_1_relu].[NEUR_1_1] AS [NEUR_1_1], [HL_1_relu].[NEUR_1_2] AS [NEUR_1_2], [HL_1_relu].[NEUR_1_3] AS [NEUR_1_3] 
FROM [HL_1_relu]) AS [HL_1_relu_1]

-- Code For temporary table ##TMP_20180417042246_Y0N76B_OL_softmax_1 part 1/2. Create 


CREATE TABLE ##TMP_20180417042246_Y0N76B_OL_softmax_1 (
	[KEY] BIGINT NULL, 
	[NEUR_3_1] FLOAT(53) NULL, 
	[NEUR_3_2] FLOAT(53) NULL, 
	[NEUR_3_3] FLOAT(53) NULL
)



-- Code For temporary table ##TMP_20180417042246_Y0N76B_OL_softmax_1 part 2/2. Populate
...
FROM ##TMP_20180417042246_KHWS1F_HL_1_relu_1 AS [HL_1_relu_1]), 
[HL_2_relu] AS 
...
FROM [HL_2_relu]), 
[OL_softmax] AS 
(SELECT [OL_BA].[KEY] AS [KEY], CAST([OL_BA].[NEUR_3_1] AS FLOAT(53)) AS [NEUR_3_1], CAST([OL_BA].[NEUR_3_2] AS FLOAT(53)) AS [NEUR_3_2], CAST([OL_BA].[NEUR_3_3] AS FLOAT(53)) AS [NEUR_3_3] 
FROM [OL_BA])
 INSERT INTO ##TMP_20180417042246_Y0N76B_OL_softmax_1 ([KEY], [NEUR_3_1], [NEUR_3_2], [NEUR_3_3]) SELECT [OL_softmax_1].[KEY], [OL_softmax_1].[NEUR_3_1], [OL_softmax_1].[NEUR_3_2], [OL_softmax_1].[NEUR_3_3] 
...
WITH orig_cte AS 
(SELECT [OL_softmax_1].[KEY] AS [KEY], [OL_softmax_1].[NEUR_3_1] AS [Score_0], [OL_softmax_1].[NEUR_3_2] AS [Score_1], [OL_softmax_1].[NEUR_3_3] AS [Score_2], CAST(NULL AS FLOAT(53)) AS [Proba_0], CAST(NULL AS FLOAT(53)) AS [Proba_1], CAST(NULL AS FLOAT(53)) AS [Proba_2], CAST(NULL AS FLOAT(53)) AS [LogProba_0], CAST(NULL AS FLOAT(53)) AS [LogProba_1], CAST(NULL AS FLOAT(53)) AS [LogProba_2], CAST(NULL AS BIGINT) AS [Decision], CAST(NULL AS FLOAT(53)) AS [DecisionProba] 
FROM ##TMP_20180417042246_Y0N76B_OL_softmax_1 AS [OL_softmax_1]), 
