...
-- Code For temporary table TMP_20180417051104_V6B6LP_ADS_imp_1_OUT part 1/2. Create 


CREATE TEMPORARY TABLE `TMP_20180417051104_V6B6LP_ADS_imp_1_OUT` (
	`KEY` BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20180417051104_V6B6LP_ADS_imp_1_OUT part 2/2. Populate

INSERT INTO `TMP_20180417051104_V6B6LP_ADS_imp_1_OUT` (`KEY`, imputer_output_2, imputer_output_3, imputer_output_4, imputer_output_5) SELECT `U`.`KEY`, `U`.imputer_output_2, `U`.imputer_output_3, `U`.imputer_output_4, `U`.imputer_output_5 
...
-- Code For temporary table TMP_20180417051104_E6YUDA_ADS_sca_2_OUT part 1/2. Create 


CREATE TEMPORARY TABLE `TMP_20180417051104_E6YUDA_ADS_sca_2_OUT` (
	`KEY` BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20180417051104_E6YUDA_ADS_sca_2_OUT part 2/2. Populate

INSERT INTO `TMP_20180417051104_E6YUDA_ADS_sca_2_OUT` (`KEY`, scaler_output_2, scaler_output_3, scaler_output_4, scaler_output_5) SELECT `U`.`KEY`, `U`.scaler_output_2, `U`.scaler_output_3, `U`.scaler_output_4, `U`.scaler_output_5 
...
FROM `TMP_20180417051104_V6B6LP_ADS_imp_1_OUT` AS `ADS_imp_1_OUT`) AS `ADS_sca_2_OUT`) AS `U`

-- Code For temporary table TMP_20180417051104_CNRIOD_HL_1_relu_1 part 1/2. Create 


CREATE TEMPORARY TABLE `TMP_20180417051104_CNRIOD_HL_1_relu_1` (
	`KEY` BIGINT NOT NULL, 
	`NEUR_1_1` DOUBLE, 
	`NEUR_1_2` DOUBLE, 
	`NEUR_1_3` DOUBLE, 
...
-- Code For temporary table TMP_20180417051104_CNRIOD_HL_1_relu_1 part 2/2. Populate

INSERT INTO `TMP_20180417051104_CNRIOD_HL_1_relu_1` (`KEY`, `NEUR_1_1`, `NEUR_1_2`, `NEUR_1_3`) SELECT `U`.`KEY`, `U`.`NEUR_1_1`, `U`.`NEUR_1_2`, `U`.`NEUR_1_3` 
FROM (WITH `IL` AS 
...
FROM `TMP_20180417051104_E6YUDA_ADS_sca_2_OUT` AS `ADS_sca_2_OUT`), 
`HL_BA_1` AS 
...
-- Code For temporary table TMP_20180417051104_1SVHTE_OL_softmax_1 part 1/2. Create 


CREATE TEMPORARY TABLE `TMP_20180417051104_1SVHTE_OL_softmax_1` (
	`KEY` BIGINT NOT NULL, 
	`NEUR_3_1` DOUBLE, 
	`NEUR_3_2` DOUBLE, 
	`NEUR_3_3` DOUBLE, 
...
-- Code For temporary table TMP_20180417051104_1SVHTE_OL_softmax_1 part 2/2. Populate

INSERT INTO `TMP_20180417051104_1SVHTE_OL_softmax_1` (`KEY`, `NEUR_3_1`, `NEUR_3_2`, `NEUR_3_3`) SELECT `U`.`KEY`, `U`.`NEUR_3_1`, `U`.`NEUR_3_2`, `U`.`NEUR_3_3` 
...
FROM `TMP_20180417051104_CNRIOD_HL_1_relu_1` AS `HL_1_relu_1`), 
`HL_2_relu` AS 
...
FROM `TMP_20180417051104_1SVHTE_OL_softmax_1` AS `OL_softmax_1`), 
