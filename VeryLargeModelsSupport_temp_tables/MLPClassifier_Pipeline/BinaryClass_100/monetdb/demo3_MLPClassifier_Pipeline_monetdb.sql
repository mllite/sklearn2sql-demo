...
-- Code For temporary table tmp_20180416223306_lz1um2_ads_imp_1_out part 1/2. Create 


CREATE TEMPORARY TABLE tmp_20180416223306_lz1um2_ads_imp_1_out (
	"KEY" BIGINT NOT NULL, 
	impter_2 FLOAT, 
	impter_3 FLOAT, 
	impter_4 FLOAT, 
...
-- Code For temporary table tmp_20180416223306_5dzazx_ads_sca_2_out part 1/2. Create 


CREATE TEMPORARY TABLE tmp_20180416223306_5dzazx_ads_sca_2_out (
	"KEY" BIGINT NOT NULL, 
	scaler_2 FLOAT, 
	scaler_3 FLOAT, 
	scaler_4 FLOAT, 
...
FROM tmp_20180416223306_lz1um2_ads_imp_1_out AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT") AS "U"

-- Code For temporary table tmp_20180416223306_ucan5f_hl_1_relu_1 part 1/2. Create 


CREATE TEMPORARY TABLE tmp_20180416223306_ucan5f_hl_1_relu_1 (
	"KEY" BIGINT NOT NULL, 
	"NEUR_1_1" FLOAT, 
	"NEUR_1_2" FLOAT, 
	"NEUR_1_3" FLOAT, 
...
-- Code For temporary table tmp_20180416223306_ucan5f_hl_1_relu_1 part 2/2. Populate

INSERT INTO tmp_20180416223306_ucan5f_hl_1_relu_1 ("KEY", "NEUR_1_1", "NEUR_1_2", "NEUR_1_3") SELECT "U"."KEY", "U"."NEUR_1_1", "U"."NEUR_1_2", "U"."NEUR_1_3" 
FROM (WITH "IL" AS 
...
FROM tmp_20180416223306_5dzazx_ads_sca_2_out AS "ADS_sca_2_OUT"), 
"HL_BA_1" AS 
...
FROM "IL"), 
"HL_1_relu" AS 
(SELECT "HL_BA_1"."KEY" AS "KEY", CAST(CASE WHEN ("HL_BA_1"."NEUR_1_1" <= 0.0) THEN 0.0 ELSE "HL_BA_1"."NEUR_1_1" END AS FLOAT) AS "NEUR_1_1", CAST(CASE WHEN ("HL_BA_1"."NEUR_1_2" <= 0.0) THEN 0.0 ELSE "HL_BA_1"."NEUR_1_2" END AS FLOAT) AS "NEUR_1_2", CAST(CASE WHEN ("HL_BA_1"."NEUR_1_3" <= 0.0) THEN 0.0 ELSE "HL_BA_1"."NEUR_1_3" END AS FLOAT) AS "NEUR_1_3" 
FROM "HL_BA_1")
 SELECT "HL_1_relu_1"."KEY", "HL_1_relu_1"."NEUR_1_1", "HL_1_relu_1"."NEUR_1_2", "HL_1_relu_1"."NEUR_1_3" 
FROM (SELECT "HL_1_relu"."KEY" AS "KEY", "HL_1_relu"."NEUR_1_1" AS "NEUR_1_1", "HL_1_relu"."NEUR_1_2" AS "NEUR_1_2", "HL_1_relu"."NEUR_1_3" AS "NEUR_1_3" 
FROM "HL_1_relu") AS "HL_1_relu_1") AS "U"

-- Code For temporary table tmp_20180416223306_4vpa8v_ol_logistic_1 part 1/2. Create 


CREATE TEMPORARY TABLE tmp_20180416223306_4vpa8v_ol_logistic_1 (
	"KEY" BIGINT NOT NULL, 
	"NEUR_3_1" FLOAT, 
	PRIMARY KEY ("KEY")
)
...
-- Code For temporary table tmp_20180416223306_4vpa8v_ol_logistic_1 part 2/2. Populate

INSERT INTO tmp_20180416223306_4vpa8v_ol_logistic_1 ("KEY", "NEUR_3_1") SELECT "U"."KEY", "U"."NEUR_3_1" 
...
FROM tmp_20180416223306_ucan5f_hl_1_relu_1 AS "HL_1_relu_1"), 
"HL_2_relu" AS 
(SELECT "HL_BA_2"."KEY" AS "KEY", CAST(CASE WHEN ("HL_BA_2"."NEUR_2_1" <= 0.0) THEN 0.0 ELSE "HL_BA_2"."NEUR_2_1" END AS FLOAT) AS "NEUR_2_1", CAST(CASE WHEN ("HL_BA_2"."NEUR_2_2" <= 0.0) THEN 0.0 ELSE "HL_BA_2"."NEUR_2_2" END AS FLOAT) AS "NEUR_2_2", CAST(CASE WHEN ("HL_BA_2"."NEUR_2_3" <= 0.0) THEN 0.0 ELSE "HL_BA_2"."NEUR_2_3" END AS FLOAT) AS "NEUR_2_3", CAST(CASE WHEN ("HL_BA_2"."NEUR_2_4" <= 0.0) THEN 0.0 ELSE "HL_BA_2"."NEUR_2_4" END AS FLOAT) AS "NEUR_2_4", CAST(CASE WHEN ("HL_BA_2"."NEUR_2_5" <= 0.0) THEN 0.0 ELSE "HL_BA_2"."NEUR_2_5" END AS FLOAT) AS "NEUR_2_5" 
FROM "HL_BA_2"), 
"OL_BA" AS 
...
FROM "HL_2_relu"), 
"OL_logistic" AS 
(SELECT "OL_BA"."KEY" AS "KEY", CAST(1.0 / (1.0 + exp(CASE WHEN (CASE WHEN (-100.0 <= -"OL_BA"."NEUR_3_1") THEN -"OL_BA"."NEUR_3_1" ELSE -100.0 END <= 100.0) THEN CASE WHEN (-100.0 <= -"OL_BA"."NEUR_3_1") THEN -"OL_BA"."NEUR_3_1" ELSE -100.0 END ELSE 100.0 END)) AS FLOAT) AS "NEUR_3_1" 
FROM "OL_BA")
...
FROM tmp_20180416223306_4vpa8v_ol_logistic_1 AS "OL_logistic_1"), 
