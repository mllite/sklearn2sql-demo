...
-- Code For temporary table tmp_20180416223309_et7629_ads_imp_1_out part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180416223309_et7629_ads_imp_1_out (
	"KEY" BIGINT, 
	impter_2 DOUBLE, 
	impter_3 DOUBLE, 
	impter_4 DOUBLE, 
...
-- Code For temporary table tmp_20180416223309_gupitl_ads_sca_2_out part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180416223309_gupitl_ads_sca_2_out (
	"KEY" BIGINT, 
	scaler_2 FLOAT, 
	scaler_3 FLOAT, 
	scaler_4 FLOAT, 
...
FROM tmp_20180416223309_et7629_ads_imp_1_out AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT"

-- Code For temporary table tmp_20180416223309_3wd34r_hl_1_relu_1 part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180416223309_3wd34r_hl_1_relu_1 (
	"KEY" BIGINT, 
	"NEUR_1_1" FLOAT, 
	"NEUR_1_2" FLOAT, 
	"NEUR_1_3" FLOAT
...
-- Code For temporary table tmp_20180416223309_3wd34r_hl_1_relu_1 part 2/2. Populate

INSERT INTO tmp_20180416223309_3wd34r_hl_1_relu_1 WITH "IL" AS 
...
FROM tmp_20180416223309_gupitl_ads_sca_2_out AS "ADS_sca_2_OUT"), 
"HL_BA_1" AS 
...
-- Code For temporary table tmp_20180416223309_euf4jq_ol_logistic_1 part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180416223309_euf4jq_ol_logistic_1 (
	"KEY" BIGINT, 
	"NEUR_3_1" FLOAT
)
...
-- Code For temporary table tmp_20180416223309_euf4jq_ol_logistic_1 part 2/2. Populate

INSERT INTO tmp_20180416223309_euf4jq_ol_logistic_1 WITH "HL_BA_2" AS 
...
FROM tmp_20180416223309_3wd34r_hl_1_relu_1 AS "HL_1_relu_1"), 
"HL_2_relu" AS 
...
FROM "HL_2_relu"), 
"OL_logistic" AS 
(SELECT "OL_BA"."KEY" AS "KEY", CAST(? / (? + exp(least(greatest(-?, -"OL_BA"."NEUR_3_1"), ?))) AS DOUBLE) AS "NEUR_3_1" 
FROM "OL_BA")
...
FROM tmp_20180416223309_euf4jq_ol_logistic_1 AS "OL_logistic_1"), 
