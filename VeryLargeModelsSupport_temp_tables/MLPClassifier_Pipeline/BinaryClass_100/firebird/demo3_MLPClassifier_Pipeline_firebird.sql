...
-- Code For temporary table TMP_20180416223306_RPVTG0_ADS_I part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180416223306_RPVTG0_ADS_I" (
	"KEY" BIGINT, 
	impter_2 FLOAT, 
	impter_3 FLOAT, 
	impter_4 FLOAT, 
...
-- Code For temporary table TMP_20180416223306_S49THT_ADS_S part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180416223306_S49THT_ADS_S" (
	"KEY" BIGINT, 
	scaler_2 FLOAT, 
	scaler_3 FLOAT, 
	scaler_4 FLOAT, 
...
FROM "TMP_20180416223306_RPVTG0_ADS_I" AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT") AS "U"

-- Code For temporary table TMP_20180416223306_8JXJ2X_HL_1_ part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180416223306_8JXJ2X_HL_1_" (
	"KEY" BIGINT, 
	"NEUR_1_1" FLOAT, 
	"NEUR_1_2" FLOAT, 
	"NEUR_1_3" FLOAT
...
-- Code For temporary table TMP_20180416223306_8JXJ2X_HL_1_ part 2/2. Populate

INSERT INTO "TMP_20180416223306_8JXJ2X_HL_1_" ("KEY", "NEUR_1_1", "NEUR_1_2", "NEUR_1_3") SELECT "U"."KEY", "U"."NEUR_1_1", "U"."NEUR_1_2", "U"."NEUR_1_3" 
FROM (WITH "IL" AS 
...
FROM "TMP_20180416223306_S49THT_ADS_S" AS "ADS_sca_2_OUT"), 
"HL_BA_1" AS 
...
-- Code For temporary table TMP_20180416223307_BNJ2DG_OL_LO part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180416223307_BNJ2DG_OL_LO" (
	"KEY" BIGINT, 
	"NEUR_3_1" FLOAT
)
...
-- Code For temporary table TMP_20180416223307_BNJ2DG_OL_LO part 2/2. Populate

INSERT INTO "TMP_20180416223307_BNJ2DG_OL_LO" ("KEY", "NEUR_3_1") SELECT "U"."KEY", "U"."NEUR_3_1" 
...
FROM "TMP_20180416223306_8JXJ2X_HL_1_" AS "HL_1_relu_1"), 
"HL_2_relu" AS 
...
FROM "TMP_20180416223307_BNJ2DG_OL_LO" AS "OL_logistic_1"), 
