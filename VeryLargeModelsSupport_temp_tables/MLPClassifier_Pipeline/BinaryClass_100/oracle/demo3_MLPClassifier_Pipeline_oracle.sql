...
-- Code For temporary table 23306_UTH250_ADS_IMP_1_OUT part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE "23306_UTH250_ADS_IMP_1_OUT" (
...
-- Code For temporary table 23306_9NN0S3_ADS_SCA_2_OUT part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE "23306_9NN0S3_ADS_SCA_2_OUT" (
	"KEY" NUMBER(19) NOT NULL, 
...
FROM "23306_UTH250_ADS_IMP_1_OUT" "ADS_imp_1_OUT") "ADS_sca_2_OUT") "U"

-- Code For temporary table 6223306_ZG54NH_HL_1_RELU_1 part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE "6223306_ZG54NH_HL_1_RELU_1" (
	"KEY" NUMBER(19) NOT NULL, 
...
-- Code For temporary table 6223306_ZG54NH_HL_1_RELU_1 part 2/2. Populate

INSERT INTO "6223306_ZG54NH_HL_1_RELU_1" ("KEY", "NEUR_1_1", "NEUR_1_2", "NEUR_1_3") SELECT "U"."KEY", "U"."NEUR_1_1", "U"."NEUR_1_2", "U"."NEUR_1_3" 
FROM (WITH "IL" AS 
...
FROM "23306_9NN0S3_ADS_SCA_2_OUT" "ADS_sca_2_OUT"), 
"HL_BA_1" AS 
...
-- Code For temporary table 23306_4ECF0F_OL_LOGISTIC_1 part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE "23306_4ECF0F_OL_LOGISTIC_1" (
	"KEY" NUMBER(19) NOT NULL, 
...
-- Code For temporary table 23306_4ECF0F_OL_LOGISTIC_1 part 2/2. Populate

INSERT INTO "23306_4ECF0F_OL_LOGISTIC_1" ("KEY", "NEUR_3_1") SELECT "U"."KEY", "U"."NEUR_3_1" 
...
FROM "6223306_ZG54NH_HL_1_RELU_1" "HL_1_relu_1"), 
"HL_2_relu" AS 
...
FROM "HL_2_relu"), 
"OL_logistic" AS 
(SELECT "OL_BA"."KEY" AS "KEY", CAST(1.0 / (1.0 + exp(least(greatest(-100.0, -"OL_BA"."NEUR_3_1"), 100.0))) AS BINARY_DOUBLE) AS "NEUR_3_1" 
FROM "OL_BA")
 SELECT "OL_logistic_1"."KEY", "OL_logistic_1"."NEUR_3_1" 
FROM (SELECT "OL_logistic"."KEY" AS "KEY", "OL_logistic"."NEUR_3_1" AS "NEUR_3_1" 
FROM "OL_logistic") "OL_logistic_1") "U"
...
FROM "23306_4ECF0F_OL_LOGISTIC_1" "OL_logistic_1"), 
