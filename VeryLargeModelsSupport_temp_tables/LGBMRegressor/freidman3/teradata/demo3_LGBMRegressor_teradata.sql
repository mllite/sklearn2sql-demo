...
-- Code For temporary table tmp_20180417041801_8y2uxx_lgbm part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180417041801_8y2uxx_lgbm  (
	"KEY" BIGINT, 
	"Estimator" FLOAT
)
...
-- Code For temporary table tmp_20180417041801_8y2uxx_lgbm part 2/2. Populate

INSERT INTO tmp_20180417041801_8y2uxx_lgbm ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
FROM (WITH "DT_node_lookup" AS 
(SELECT "ADS"."KEY" AS "KEY", CASE WHEN ("ADS"."Feature_2" <= 0.305207058501728) THEN 2 ELSE CASE WHEN ("ADS"."Feature_1" <= 821.274408712417) THEN 6 ELSE 7 END END AS node_id_2 
...
FROM "DT_Output_3"), 
"DT_node_lookup_4" AS 
(SELECT "ADS"."KEY" AS "KEY", CASE WHEN ("ADS"."Feature_2" <= 0.305207058501728) THEN 2 ELSE CASE WHEN ("ADS"."Feature_0" <= 49.232675914117046) THEN 6 ELSE 7 END END AS node_id_2 
FROM freidman3 AS "ADS"), 
"DT_node_data_4" AS 
(SELECT "Values".node_id AS node_id, CAST("Values".feature AS FLOAT) AS feature, CAST("Values"."threshold" AS FLOAT) AS "threshold", CAST("Values".depth AS FLOAT) AS depth, CAST("Values".parent_id AS FLOAT) AS parent_id, CAST("Values"."Estimator" AS FLOAT) AS "Estimator" 
...
-- Code For temporary table tmp_20180417041801_echxpa_lgbm part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180417041801_echxpa_lgbm  (
	"KEY" BIGINT, 
	"Estimator" FLOAT
)
...
-- Code For temporary table tmp_20180417041801_echxpa_lgbm part 2/2. Populate

INSERT INTO tmp_20180417041801_echxpa_lgbm ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
(SELECT "ADS"."KEY" AS "KEY", CASE WHEN ("ADS"."Feature_1" <= 568.0729020105207) THEN 2 ELSE CASE WHEN ("ADS"."Feature_2" <= 0.414427948105479) THEN 6 ELSE 7 END END AS node_id_2 
FROM freidman3 AS "ADS"), 
"DT_node_data_12" AS 
(SELECT "Values".node_id AS node_id, CAST("Values".feature AS FLOAT) AS feature, CAST("Values"."threshold" AS FLOAT) AS "threshold", CAST("Values".depth AS FLOAT) AS depth, CAST("Values".parent_id AS FLOAT) AS parent_id, CAST("Values"."Estimator" AS FLOAT) AS "Estimator" 
...
(SELECT "ADS"."KEY" AS "KEY", CASE WHEN ("ADS"."Feature_2" <= 0.305207058501728) THEN 2 ELSE CASE WHEN ("ADS"."Feature_0" <= 34.446685757025755) THEN 6 ELSE 7 END END AS node_id_2 
FROM freidman3 AS "ADS"), 
"DT_node_data_13" AS 
(SELECT "Values".node_id AS node_id, CAST("Values".feature AS FLOAT) AS feature, CAST("Values"."threshold" AS FLOAT) AS "threshold", CAST("Values".depth AS FLOAT) AS depth, CAST("Values".parent_id AS FLOAT) AS parent_id, CAST("Values"."Estimator" AS FLOAT) AS "Estimator" 
...
-- Code For temporary table tmp_20180417041801_5tos0f_lgbm part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180417041801_5tos0f_lgbm  (
	"KEY" BIGINT, 
	"Estimator" FLOAT
)
...
-- Code For temporary table tmp_20180417041801_5tos0f_lgbm part 2/2. Populate

INSERT INTO tmp_20180417041801_5tos0f_lgbm ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
FROM tmp_20180417041801_8y2uxx_lgbm AS "LGBM_B0" UNION ALL SELECT "LGBM_B1"."KEY" AS "KEY", "LGBM_B1"."Estimator" AS "Estimator" 
FROM tmp_20180417041801_echxpa_lgbm AS "LGBM_B1") AS "LGBM_EnsembleUnion") AS "LGBM_Union") AS "U"

-- Code For temporary table tmp_20180417041801_v9m99u_lgbm part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180417041801_v9m99u_lgbm  (
	"KEY" BIGINT, 
	"Estimator" FLOAT
)
...
-- Code For temporary table tmp_20180417041801_v9m99u_lgbm part 2/2. Populate

INSERT INTO tmp_20180417041801_v9m99u_lgbm ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
FROM tmp_20180417041801_5tos0f_lgbm AS "LGBM_Union" GROUP BY "LGBM_Union"."KEY") AS "T") AS "LGBM_sum") AS "U"

-- Model deployment code

SELECT "LGBM_sum"."KEY" AS "KEY", "LGBM_sum"."Estimator" AS "Estimator" 
FROM tmp_20180417041801_v9m99u_lgbm AS "LGBM_sum"