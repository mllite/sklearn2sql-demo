...
-- Code For temporary table 80417011635_H7R679_LGBM_B0 part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE "80417011635_H7R679_LGBM_B0" (
	"KEY" NUMBER(19), 
...
-- Code For temporary table 80417011635_H7R679_LGBM_B0 part 2/2. Populate

INSERT INTO "80417011635_H7R679_LGBM_B0" ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
-- Code For temporary table 80417011635_YOUDX9_LGBM_B1 part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE "80417011635_YOUDX9_LGBM_B1" (
	"KEY" NUMBER(19), 
	"Estimator" BINARY_DOUBLE
)
...
-- Code For temporary table 80417011635_YOUDX9_LGBM_B1 part 2/2. Populate

INSERT INTO "80417011635_YOUDX9_LGBM_B1" ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
-- Code For temporary table 17011635_S9ZSUG_LGBM_UNION part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE "17011635_S9ZSUG_LGBM_UNION" (
	"KEY" NUMBER(19), 
	"Estimator" BINARY_DOUBLE
)
...
-- Code For temporary table 17011635_S9ZSUG_LGBM_UNION part 2/2. Populate

INSERT INTO "17011635_S9ZSUG_LGBM_UNION" ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
FROM "80417011635_H7R679_LGBM_B0" "LGBM_B0" UNION ALL SELECT "LGBM_B1"."KEY" AS "KEY", "LGBM_B1"."Estimator" AS "Estimator" 
FROM "80417011635_YOUDX9_LGBM_B1" "LGBM_B1") "LGBM_EnsembleUnion") "LGBM_Union") "U"

-- Code For temporary table 0417011635_PKK41Q_LGBM_SUM part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE "0417011635_PKK41Q_LGBM_SUM" (
...
-- Code For temporary table 0417011635_PKK41Q_LGBM_SUM part 2/2. Populate

INSERT INTO "0417011635_PKK41Q_LGBM_SUM" ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
FROM "17011635_S9ZSUG_LGBM_UNION" "LGBM_Union" GROUP BY "LGBM_Union"."KEY") "T") "LGBM_sum") "U"

-- Model deployment code

SELECT "LGBM_sum"."KEY" AS "KEY", "LGBM_sum"."Estimator" AS "Estimator" 
FROM "0417011635_PKK41Q_LGBM_SUM" "LGBM_sum"