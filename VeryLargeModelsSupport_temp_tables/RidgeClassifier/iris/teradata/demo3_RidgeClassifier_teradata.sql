...
FROM iris AS "ADS"), 
linear_model_cte AS 
(SELECT linear_input."KEY" AS "KEY", 0.11193795454575 * linear_input."Feature_0" + 0.468127134852417 * linear_input."Feature_1" + -0.45688479499295 * linear_input."Feature_2" + -0.093262002076467 * linear_input."Feature_3" + -0.586603359375013 AS "Score_0", 0.056699806292054 * linear_input."Feature_0" + -0.873462688641896 * linear_input."Feature_1" + 0.308123089458302 * linear_input."Feature_2" + -0.782414188107933 * linear_input."Feature_3" + 1.776901965776979 AS "Score_1", -0.168637760837801 * linear_input."Feature_0" + 0.405335553789477 * linear_input."Feature_1" + 0.148761705534641 * linear_input."Feature_2" + 0.875676190184415 * linear_input."Feature_3" + -2.190298606401961 AS "Score_2" 
FROM linear_input), 
orig_cte AS 
