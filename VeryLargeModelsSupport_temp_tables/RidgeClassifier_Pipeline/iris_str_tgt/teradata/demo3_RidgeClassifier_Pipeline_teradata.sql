...
-- Code For temporary table tmp_20180417051131_kkqqpe_ads_ part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180417051131_kkqqpe_ads_  (
	"KEY" BIGINT, 
...
-- Code For temporary table tmp_20180417051131_kkqqpe_ads_ part 2/2. Populate

INSERT INTO tmp_20180417051131_kkqqpe_ads_ ("KEY", imputer_output_2, imputer_output_3, imputer_output_4, imputer_output_5) SELECT "U"."KEY", "U".imputer_output_2, "U".imputer_output_3, "U".imputer_output_4, "U".imputer_output_5 
...
-- Code For temporary table tmp_20180417051131_omjvvv_ads_ part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180417051131_omjvvv_ads_  (
	"KEY" BIGINT, 
...
-- Code For temporary table tmp_20180417051131_omjvvv_ads_ part 2/2. Populate

INSERT INTO tmp_20180417051131_omjvvv_ads_ ("KEY", scaler_output_2, scaler_output_3, scaler_output_4, scaler_output_5) SELECT "U"."KEY", "U".scaler_output_2, "U".scaler_output_3, "U".scaler_output_4, "U".scaler_output_5 
...
FROM tmp_20180417051131_kkqqpe_ads_ AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT") AS "U"
...
FROM tmp_20180417051131_omjvvv_ads_ AS "ADS_sca_2_OUT"), 
linear_model_cte AS 
(SELECT linear_input."KEY" AS "KEY", 0.049025265861861 * linear_input.scaler_output_2 + 0.232582266572878 * linear_input.scaler_output_3 + -0.661792036546098 * linear_input.scaler_output_4 + -0.139574406777555 * linear_input.scaler_output_5 + -0.383333333333334 AS "Score_CLASS_0", 0.088630670738594 * linear_input.scaler_output_2 + -0.411550387069844 * linear_input.scaler_output_3 + 0.466081272857524 * linear_input.scaler_output_4 + -0.576381522875229 * linear_input.scaler_output_5 + -0.333333333333333 AS "Score_CLASS_1", -0.137655936600453 * linear_input.scaler_output_2 + 0.178968120496965 * linear_input.scaler_output_3 + 0.195710763688574 * linear_input.scaler_output_4 + 0.715955929652782 * linear_input.scaler_output_5 + -0.283333333333333 AS "Score_CLASS_2" 
FROM linear_input), 
orig_cte AS 
