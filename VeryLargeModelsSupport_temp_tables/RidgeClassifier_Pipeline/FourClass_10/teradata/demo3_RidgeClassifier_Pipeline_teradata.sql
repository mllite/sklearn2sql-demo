...
-- Code For temporary table tmp_20180416233231_hq7227_ads_ part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180416233231_hq7227_ads_  (
	"KEY" BIGINT, 
	impter_2 FLOAT, 
	impter_3 FLOAT, 
	impter_4 FLOAT, 
...
-- Code For temporary table tmp_20180416233231_hq7227_ads_ part 2/2. Populate

INSERT INTO tmp_20180416233231_hq7227_ads_ ("KEY", impter_2, impter_3, impter_4, impter_5, impter_6, impter_7, impter_8, impter_9, impter_10, impter_11) SELECT "U"."KEY", "U".impter_2, "U".impter_3, "U".impter_4, "U".impter_5, "U".impter_6, "U".impter_7, "U".impter_8, "U".impter_9, "U".impter_10, "U".impter_11 
...
-- Code For temporary table tmp_20180416233231_i1rtlp_ads_ part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180416233231_i1rtlp_ads_  (
	"KEY" BIGINT, 
	scaler_2 FLOAT, 
	scaler_3 FLOAT, 
	scaler_4 FLOAT, 
...
-- Code For temporary table tmp_20180416233231_i1rtlp_ads_ part 2/2. Populate

INSERT INTO tmp_20180416233231_i1rtlp_ads_ ("KEY", scaler_2, scaler_3, scaler_4, scaler_5, scaler_6, scaler_7, scaler_8, scaler_9, scaler_10, scaler_11) SELECT "U"."KEY", "U".scaler_2, "U".scaler_3, "U".scaler_4, "U".scaler_5, "U".scaler_6, "U".scaler_7, "U".scaler_8, "U".scaler_9, "U".scaler_10, "U".scaler_11 
...
FROM tmp_20180416233231_hq7227_ads_ AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT") AS "U"
...
FROM tmp_20180416233231_i1rtlp_ads_ AS "ADS_sca_2_OUT"), 
linear_model_cte AS 
(SELECT linear_input."KEY" AS "KEY", 0.102923448926226 * linear_input.scaler_2 + -0.161288798149075 * linear_input.scaler_3 + -0.016595188655311 * linear_input.scaler_4 + -0.08197797950089 * linear_input.scaler_5 + 0.279498503189558 * linear_input.scaler_6 + -0.094413899388207 * linear_input.scaler_7 + 0.066409022901028 * linear_input.scaler_8 + 0.146473714692304 * linear_input.scaler_9 + 0.133220223779781 * linear_input.scaler_10 + 0.021794692001736 * linear_input.scaler_11 + -0.55 AS "Score_0", -0.01625399141134 * linear_input.scaler_2 + 0.025836013334246 * linear_input.scaler_3 + 0.167650356490424 * linear_input.scaler_4 + 0.135305224561499 * linear_input.scaler_5 + 0.130361214447547 * linear_input.scaler_6 + -0.029555027453144 * linear_input.scaler_7 + -0.132766068315994 * linear_input.scaler_8 + 0.111839602210274 * linear_input.scaler_9 + -0.087837451283606 * linear_input.scaler_10 + 0.030081452459964 * linear_input.scaler_11 + -0.5 AS "Score_1", -0.055034959342428 * linear_input.scaler_2 + -0.246282365655989 * linear_input.scaler_3 + -0.24675054936025 * linear_input.scaler_4 + -0.145539579871298 * linear_input.scaler_5 + -0.289717846086926 * linear_input.scaler_6 + 6.4578780121e-05 * linear_input.scaler_7 + 0.06281000919981 * linear_input.scaler_8 + 0.205259687690472 * linear_input.scaler_9 + 0.124551628237356 * linear_input.scaler_10 + 0.022640261593939 * linear_input.scaler_11 + -0.5 AS "Score_2", -0.031634498172458 * linear_input.scaler_2 + 0.381735150470821 * linear_input.scaler_3 + 0.095695381525142 * linear_input.scaler_4 + 0.092212334810683 * linear_input.scaler_5 + -0.12014187155018 * linear_input.scaler_6 + 0.12390434806123 * linear_input.scaler_7 + 0.003547036215157 * linear_input.scaler_8 + -0.463573004593046 * linear_input.scaler_9 + -0.169934400733531 * linear_input.scaler_10 + -0.07451640605564 * linear_input.scaler_11 + -0.45 AS "Score_3" 
FROM linear_input), 
orig_cte AS 
