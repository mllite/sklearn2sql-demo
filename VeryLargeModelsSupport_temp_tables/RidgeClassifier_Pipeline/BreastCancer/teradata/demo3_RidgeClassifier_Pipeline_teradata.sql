...
-- Code For temporary table tmp_20180416231755_q70mo2_ads_ part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180416231755_q70mo2_ads_  (
	"KEY" BIGINT, 
	impter_2 FLOAT, 
	impter_3 FLOAT, 
	impter_4 FLOAT, 
...
-- Code For temporary table tmp_20180416231755_q70mo2_ads_ part 2/2. Populate

INSERT INTO tmp_20180416231755_q70mo2_ads_ ("KEY", impter_2, impter_3, impter_4, impter_5, impter_6, impter_7, impter_8, impter_9, impter_10, impter_11, impter_12, impter_13, impter_14, impter_15, impter_16, impter_17, impter_18, impter_19, impter_20, impter_21, impter_22, impter_23, impter_24, impter_25, impter_26, impter_27, impter_28, impter_29, impter_30, impter_31) SELECT "U"."KEY", "U".impter_2, "U".impter_3, "U".impter_4, "U".impter_5, "U".impter_6, "U".impter_7, "U".impter_8, "U".impter_9, "U".impter_10, "U".impter_11, "U".impter_12, "U".impter_13, "U".impter_14, "U".impter_15, "U".impter_16, "U".impter_17, "U".impter_18, "U".impter_19, "U".impter_20, "U".impter_21, "U".impter_22, "U".impter_23, "U".impter_24, "U".impter_25, "U".impter_26, "U".impter_27, "U".impter_28, "U".impter_29, "U".impter_30, "U".impter_31 
...
-- Code For temporary table tmp_20180416231755_ceilh3_ads_ part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180416231755_ceilh3_ads_  (
	"KEY" BIGINT, 
	scaler_2 FLOAT, 
	scaler_3 FLOAT, 
	scaler_4 FLOAT, 
...
FROM tmp_20180416231755_q70mo2_ads_ AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT") AS "U"
...
FROM tmp_20180416231755_ceilh3_ads_ AS "ADS_sca_2_OUT"), 
linear_model_cte AS 
(SELECT linear_input."KEY" AS "KEY", -0.180223887127939 * linear_input.scaler_2 + -0.015925862855607 * linear_input.scaler_3 + -0.109803039656955 * linear_input.scaler_4 + 0.239624364569416 * linear_input.scaler_5 + 0.060096767972787 * linear_input.scaler_6 + 0.315330256166869 * linear_input.scaler_7 + -0.122906262655359 * linear_input.scaler_8 + -0.301729463039258 * linear_input.scaler_9 + -0.000376309767502 * linear_input.scaler_10 + -0.009533035008003 * linear_input.scaler_11 + -0.444492040751962 * linear_input.scaler_12 + 0.02549617211024 * linear_input.scaler_13 + 0.043533243841704 * linear_input.scaler_14 + 0.275310282513324 * linear_input.scaler_15 + -0.076561646650147 * linear_input.scaler_16 + 0.053464139497877 * linear_input.scaler_17 + 0.202456974440715 * linear_input.scaler_18 + -0.090436816170214 * linear_input.scaler_19 + -0.015032628365407 * linear_input.scaler_20 + 0.01276885327629 * linear_input.scaler_21 + -0.678174248128468 * linear_input.scaler_22 + -0.094857145408031 * linear_input.scaler_23 + 0.097383622230701 * linear_input.scaler_24 + 0.351663479285275 * linear_input.scaler_25 + -0.05399196081726 * linear_input.scaler_26 + -0.03775909348742 * linear_input.scaler_27 + -0.164045603183931 * linear_input.scaler_28 + -0.090577355401964 * linear_input.scaler_29 + -0.094869924243738 * linear_input.scaler_30 + -0.122632414121873 * linear_input.scaler_31 + 0.296703296703297 AS lincomb 
FROM linear_input)
