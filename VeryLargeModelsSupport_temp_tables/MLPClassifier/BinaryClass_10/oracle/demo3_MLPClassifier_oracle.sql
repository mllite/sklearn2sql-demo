...
-- Code For temporary table 6222824_ZDVN91_HL_1_RELU_1 part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE "6222824_ZDVN91_HL_1_RELU_1" (
...
-- Code For temporary table 6222824_ZDVN91_HL_1_RELU_1 part 2/2. Populate

INSERT INTO "6222824_ZDVN91_HL_1_RELU_1" ("KEY", "NEUR_1_1", "NEUR_1_2", "NEUR_1_3") SELECT "U"."KEY", "U"."NEUR_1_1", "U"."NEUR_1_2", "U"."NEUR_1_3" 
FROM (WITH "IL" AS 
...
-- Code For temporary table 22824_81J7LK_OL_LOGISTIC_1 part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE "22824_81J7LK_OL_LOGISTIC_1" (
	"KEY" NUMBER(19) NOT NULL, 
...
-- Code For temporary table 22824_81J7LK_OL_LOGISTIC_1 part 2/2. Populate

INSERT INTO "22824_81J7LK_OL_LOGISTIC_1" ("KEY", "NEUR_3_1") SELECT "U"."KEY", "U"."NEUR_3_1" 
...
FROM "6222824_ZDVN91_HL_1_RELU_1" "HL_1_relu_1"), 
"HL_2_relu" AS 
...
FROM "22824_81J7LK_OL_LOGISTIC_1" "OL_logistic_1"), 
