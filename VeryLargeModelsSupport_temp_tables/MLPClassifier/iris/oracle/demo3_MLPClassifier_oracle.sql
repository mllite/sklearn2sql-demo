...
-- Code For temporary table 7042239_DZG70U_HL_1_RELU_1 part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE "7042239_DZG70U_HL_1_RELU_1" (
...
-- Code For temporary table 7042239_DZG70U_HL_1_RELU_1 part 2/2. Populate

INSERT INTO "7042239_DZG70U_HL_1_RELU_1" ("KEY", "NEUR_1_1", "NEUR_1_2", "NEUR_1_3") SELECT "U"."KEY", "U"."NEUR_1_1", "U"."NEUR_1_2", "U"."NEUR_1_3" 
FROM (WITH "IL" AS 
...
-- Code For temporary table 042239_B52F5G_OL_SOFTMAX_1 part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE "042239_B52F5G_OL_SOFTMAX_1" (
	"KEY" NUMBER(19) NOT NULL, 
...
-- Code For temporary table 042239_B52F5G_OL_SOFTMAX_1 part 2/2. Populate

INSERT INTO "042239_B52F5G_OL_SOFTMAX_1" ("KEY", "NEUR_3_1", "NEUR_3_2", "NEUR_3_3") SELECT "U"."KEY", "U"."NEUR_3_1", "U"."NEUR_3_2", "U"."NEUR_3_3" 
...
FROM "7042239_DZG70U_HL_1_RELU_1" "HL_1_relu_1"), 
"HL_2_relu" AS 
...
FROM "042239_B52F5G_OL_SOFTMAX_1" "OL_softmax_1"), 
