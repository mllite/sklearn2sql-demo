...
-- Code For temporary table tmp_20180417042242_agox1y_hl_1_relu_1 part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180417042242_agox1y_hl_1_relu_1 (
	"KEY" BIGINT, 
	"NEUR_1_1" FLOAT, 
	"NEUR_1_2" FLOAT, 
	"NEUR_1_3" FLOAT
...
-- Code For temporary table tmp_20180417042242_agox1y_hl_1_relu_1 part 2/2. Populate

INSERT INTO tmp_20180417042242_agox1y_hl_1_relu_1 WITH "IL" AS 
...
-- Code For temporary table tmp_20180417042242_dzrzkv_ol_softmax_1 part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180417042242_dzrzkv_ol_softmax_1 (
	"KEY" BIGINT, 
	"NEUR_3_1" FLOAT, 
	"NEUR_3_2" FLOAT, 
	"NEUR_3_3" FLOAT
...
-- Code For temporary table tmp_20180417042242_dzrzkv_ol_softmax_1 part 2/2. Populate

INSERT INTO tmp_20180417042242_dzrzkv_ol_softmax_1 WITH "HL_BA_2" AS 
...
FROM tmp_20180417042242_agox1y_hl_1_relu_1 AS "HL_1_relu_1"), 
"HL_2_relu" AS 
...
FROM tmp_20180417042242_dzrzkv_ol_softmax_1 AS "OL_softmax_1"), 
