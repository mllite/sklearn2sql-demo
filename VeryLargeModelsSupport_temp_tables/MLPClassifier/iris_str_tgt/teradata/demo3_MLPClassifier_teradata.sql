...
-- Code For temporary table tmp_20180417051057_3pbo6y_hl_1 part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180417051057_3pbo6y_hl_1  (
	"KEY" BIGINT, 
	"NEUR_1_1" FLOAT, 
	"NEUR_1_2" FLOAT, 
	"NEUR_1_3" FLOAT
...
-- Code For temporary table tmp_20180417051057_3pbo6y_hl_1 part 2/2. Populate

INSERT INTO tmp_20180417051057_3pbo6y_hl_1 ("KEY", "NEUR_1_1", "NEUR_1_2", "NEUR_1_3") SELECT "U"."KEY", "U"."NEUR_1_1", "U"."NEUR_1_2", "U"."NEUR_1_3" 
FROM (WITH "IL" AS 
...
-- Code For temporary table tmp_20180417051057_pm6zqv_ol_s part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180417051057_pm6zqv_ol_s  (
	"KEY" BIGINT, 
	"NEUR_3_1" FLOAT, 
	"NEUR_3_2" FLOAT, 
	"NEUR_3_3" FLOAT
...
-- Code For temporary table tmp_20180417051057_pm6zqv_ol_s part 2/2. Populate

INSERT INTO tmp_20180417051057_pm6zqv_ol_s ("KEY", "NEUR_3_1", "NEUR_3_2", "NEUR_3_3") SELECT "U"."KEY", "U"."NEUR_3_1", "U"."NEUR_3_2", "U"."NEUR_3_3" 
...
FROM tmp_20180417051057_3pbo6y_hl_1 AS "HL_1_relu_1"), 
"HL_2_relu" AS 
...
FROM tmp_20180417051057_pm6zqv_ol_s AS "OL_softmax_1"), 
