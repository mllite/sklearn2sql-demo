...
linear_model_cte AS 
(SELECT linear_input."KEY" AS "KEY", 28.627661164978555 * linear_input."Feature_0" + 53.461497286565745 * linear_input."Feature_1" + 66.46934640103174 * linear_input."Feature_2" + 32.69873075515514 * linear_input."Feature_3" + 43.29503126580085 * linear_input."Feature_4" + 57.09907059593139 * linear_input."Feature_5" + 23.158123206983337 * linear_input."Feature_6" + 31.616153072642767 * linear_input."Feature_7" + 66.29004894491052 * linear_input."Feature_8" + 29.958859784854912 * linear_input."Feature_9" + 11.233413030334829 AS "Estimator" 
FROM linear_input)
