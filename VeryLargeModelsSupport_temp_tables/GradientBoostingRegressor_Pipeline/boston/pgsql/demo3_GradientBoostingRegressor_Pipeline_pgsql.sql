...
-- Code For temporary table TMP_20180417023603_I4MUQB_ADS_imp_1_OUT part 1/2. Create 


CREATE TEMPORARY TABLE "TMP_20180417023603_I4MUQB_ADS_imp_1_OUT" (
	"KEY" BIGINT NOT NULL, 
	impter_2 FLOAT, 
	impter_3 FLOAT, 
	impter_4 FLOAT, 
...
-- Code For temporary table TMP_20180417023603_GFGC8U_ADS_sca_2_OUT part 1/2. Create 


CREATE TEMPORARY TABLE "TMP_20180417023603_GFGC8U_ADS_sca_2_OUT" (
	"KEY" BIGINT NOT NULL, 
	scaler_2 FLOAT, 
	scaler_3 FLOAT, 
	scaler_4 FLOAT, 
...
FROM "TMP_20180417023603_I4MUQB_ADS_imp_1_OUT" AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT"

-- Code For temporary table TMP_20180417023603_ASEMMB_GB_B0 part 1/2. Create 


CREATE TEMPORARY TABLE "TMP_20180417023603_ASEMMB_GB_B0" (
	"KEY" BIGINT, 
	"Estimator" FLOAT
)
...
-- Code For temporary table TMP_20180417023603_ASEMMB_GB_B0 part 2/2. Populate
...
FROM "TMP_20180417023603_GFGC8U_ADS_sca_2_OUT" AS "ADS_sca_2_OUT"), 
"DT_node_data" AS 
...
FROM "DT_Output_9")
 INSERT INTO "TMP_20180417023603_ASEMMB_GB_B0" ("KEY", "Estimator") SELECT "GB_B0"."KEY", "GB_B0"."Estimator" 
...
-- Code For temporary table TMP_20180417023603_7H8SS7_GB_B1 part 1/2. Create 


CREATE TEMPORARY TABLE "TMP_20180417023603_7H8SS7_GB_B1" (
	"KEY" BIGINT, 
	"Estimator" FLOAT
)
...
-- Code For temporary table TMP_20180417023603_7H8SS7_GB_B1 part 2/2. Populate
...
FROM "DT_Output_15")
 INSERT INTO "TMP_20180417023603_7H8SS7_GB_B1" ("KEY", "Estimator") SELECT "GB_B1"."KEY", "GB_B1"."Estimator" 
...
-- Code For temporary table TMP_20180417023603_6WEPH1_GB_Union part 1/2. Create 


CREATE TEMPORARY TABLE "TMP_20180417023603_6WEPH1_GB_Union" (
	"KEY" BIGINT, 
	"Estimator" FLOAT
)
...
-- Code For temporary table TMP_20180417023603_6WEPH1_GB_Union part 2/2. Populate

INSERT INTO "TMP_20180417023603_6WEPH1_GB_Union" ("KEY", "Estimator") SELECT "GB_Union"."KEY", "GB_Union"."Estimator" 
...
FROM "TMP_20180417023603_ASEMMB_GB_B0" AS "GB_B0" UNION ALL SELECT "GB_B1"."KEY" AS "KEY", "GB_B1"."Estimator" AS "Estimator" 
FROM "TMP_20180417023603_7H8SS7_GB_B1" AS "GB_B1") AS "GB_EnsembleUnion") AS "GB_Union"

-- Code For temporary table TMP_20180417023603_MI8614_GB_sum part 1/2. Create 


CREATE TEMPORARY TABLE "TMP_20180417023603_MI8614_GB_sum" (
	"KEY" BIGINT NOT NULL, 
	"Estimator" FLOAT, 
	PRIMARY KEY ("KEY")
)
...
-- Code For temporary table TMP_20180417023603_MI8614_GB_sum part 2/2. Populate

INSERT INTO "TMP_20180417023603_MI8614_GB_sum" ("KEY", "Estimator") SELECT "GB_sum"."KEY", "GB_sum"."Estimator" 
...
FROM "TMP_20180417023603_6WEPH1_GB_Union" AS "GB_Union" GROUP BY "GB_Union"."KEY") AS "T") AS "GB_sum"

-- Model deployment code

SELECT "GB_sum"."KEY" AS "KEY", 22.5789603960396 + 0.1 * "GB_sum"."Estimator" AS "Estimator" 
FROM "TMP_20180417023603_MI8614_GB_sum" AS "GB_sum"