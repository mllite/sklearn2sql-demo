...
-- Code For temporary table TMP_20180417023603_R5KFJ6_ADS_I part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180417023603_R5KFJ6_ADS_I" (
	"KEY" BIGINT, 
	impter_2 FLOAT, 
	impter_3 FLOAT, 
	impter_4 FLOAT, 
...
-- Code For temporary table TMP_20180417023603_R5KFJ6_ADS_I part 2/2. Populate

INSERT INTO "TMP_20180417023603_R5KFJ6_ADS_I" ("KEY", impter_2, impter_3, impter_4, impter_5, impter_6, impter_7, impter_8, impter_9, impter_10, impter_11, impter_12, impter_13, impter_14) SELECT "U"."KEY", "U".impter_2, "U".impter_3, "U".impter_4, "U".impter_5, "U".impter_6, "U".impter_7, "U".impter_8, "U".impter_9, "U".impter_10, "U".impter_11, "U".impter_12, "U".impter_13, "U".impter_14 
...
-- Code For temporary table TMP_20180417023603_AHYQ92_ADS_S part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180417023603_AHYQ92_ADS_S" (
	"KEY" BIGINT, 
	scaler_2 FLOAT, 
	scaler_3 FLOAT, 
	scaler_4 FLOAT, 
...
FROM "TMP_20180417023603_R5KFJ6_ADS_I" AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT") AS "U"

-- Code For temporary table TMP_20180417023604_K49O3T_GB_B0 part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180417023604_K49O3T_GB_B0" (
	"KEY" BIGINT, 
	"Estimator" FLOAT
)
...
-- Code For temporary table TMP_20180417023604_K49O3T_GB_B0 part 2/2. Populate

INSERT INTO "TMP_20180417023604_K49O3T_GB_B0" ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
FROM "TMP_20180417023603_AHYQ92_ADS_S" AS "ADS_sca_2_OUT"), 
"DT_node_data" AS 
...
-- Code For temporary table TMP_20180417023604_AD7YAW_GB_B1 part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180417023604_AD7YAW_GB_B1" (
	"KEY" BIGINT, 
	"Estimator" FLOAT
)
...
-- Code For temporary table TMP_20180417023604_AD7YAW_GB_B1 part 2/2. Populate

INSERT INTO "TMP_20180417023604_AD7YAW_GB_B1" ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
-- Code For temporary table TMP_20180417023604_JY9AP3_GB_UN part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180417023604_JY9AP3_GB_UN" (
	"KEY" BIGINT, 
	"Estimator" FLOAT
)
...
-- Code For temporary table TMP_20180417023604_JY9AP3_GB_UN part 2/2. Populate

INSERT INTO "TMP_20180417023604_JY9AP3_GB_UN" ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
FROM "TMP_20180417023604_K49O3T_GB_B0" AS "GB_B0" UNION ALL SELECT "GB_B1"."KEY" AS "KEY", "GB_B1"."Estimator" AS "Estimator" 
FROM "TMP_20180417023604_AD7YAW_GB_B1" AS "GB_B1") AS "GB_EnsembleUnion") AS "GB_Union") AS "U"

-- Code For temporary table TMP_20180417023604_IVD3FV_GB_SU part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180417023604_IVD3FV_GB_SU" (
	"KEY" BIGINT, 
	"Estimator" FLOAT
)
...
-- Code For temporary table TMP_20180417023604_IVD3FV_GB_SU part 2/2. Populate

INSERT INTO "TMP_20180417023604_IVD3FV_GB_SU" ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
FROM "TMP_20180417023604_JY9AP3_GB_UN" AS "GB_Union" GROUP BY "GB_Union"."KEY") AS "T") AS "GB_sum") AS "U"

-- Model deployment code

SELECT "GB_sum"."KEY" AS "KEY", 22.5789603960396 + 0.1 * "GB_sum"."Estimator" AS "Estimator" 
FROM "TMP_20180417023604_IVD3FV_GB_SU" AS "GB_sum"