...
-- Code For temporary table TMP_20180417041754_9DKCSC_ADS_imp_1_OUT part 1/2. Create 


CREATE TEMPORARY TABLE "TMP_20180417041754_9DKCSC_ADS_imp_1_OUT" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20180417041754_9DKCSC_ADS_imp_1_OUT part 2/2. Populate

INSERT INTO "TMP_20180417041754_9DKCSC_ADS_imp_1_OUT" ("KEY", imputer_output_2, imputer_output_3, imputer_output_4, imputer_output_5) SELECT "ADS_imp_1_OUT"."KEY", "ADS_imp_1_OUT".imputer_output_2, "ADS_imp_1_OUT".imputer_output_3, "ADS_imp_1_OUT".imputer_output_4, "ADS_imp_1_OUT".imputer_output_5 
...
-- Code For temporary table TMP_20180417041754_DIP7IP_ADS_sca_2_OUT part 1/2. Create 


CREATE TEMPORARY TABLE "TMP_20180417041754_DIP7IP_ADS_sca_2_OUT" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20180417041754_DIP7IP_ADS_sca_2_OUT part 2/2. Populate

INSERT INTO "TMP_20180417041754_DIP7IP_ADS_sca_2_OUT" ("KEY", scaler_output_2, scaler_output_3, scaler_output_4, scaler_output_5) SELECT "ADS_sca_2_OUT"."KEY", "ADS_sca_2_OUT".scaler_output_2, "ADS_sca_2_OUT".scaler_output_3, "ADS_sca_2_OUT".scaler_output_4, "ADS_sca_2_OUT".scaler_output_5 
...
FROM "TMP_20180417041754_9DKCSC_ADS_imp_1_OUT" AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT"

-- Code For temporary table TMP_20180417041754_66A53Y_GB_B0 part 1/2. Create 


CREATE TEMPORARY TABLE "TMP_20180417041754_66A53Y_GB_B0" (
	"KEY" BIGINT, 
	"Estimator" FLOAT
)
...
-- Code For temporary table TMP_20180417041754_66A53Y_GB_B0 part 2/2. Populate
...
FROM "TMP_20180417041754_DIP7IP_ADS_sca_2_OUT" AS "ADS_sca_2_OUT"), 
"DT_node_data" AS 
...
FROM "DT_Output_9")
 INSERT INTO "TMP_20180417041754_66A53Y_GB_B0" ("KEY", "Estimator") SELECT "GB_B0"."KEY", "GB_B0"."Estimator" 
...
-- Code For temporary table TMP_20180417041754_F86HAJ_GB_B1 part 1/2. Create 


CREATE TEMPORARY TABLE "TMP_20180417041754_F86HAJ_GB_B1" (
	"KEY" BIGINT, 
	"Estimator" FLOAT
)
...
-- Code For temporary table TMP_20180417041754_F86HAJ_GB_B1 part 2/2. Populate
...
FROM "DT_Output_15")
 INSERT INTO "TMP_20180417041754_F86HAJ_GB_B1" ("KEY", "Estimator") SELECT "GB_B1"."KEY", "GB_B1"."Estimator" 
...
-- Code For temporary table TMP_20180417041754_46VSWM_GB_Union part 1/2. Create 


CREATE TEMPORARY TABLE "TMP_20180417041754_46VSWM_GB_Union" (
	"KEY" BIGINT, 
	"Estimator" FLOAT
)
...
-- Code For temporary table TMP_20180417041754_46VSWM_GB_Union part 2/2. Populate

INSERT INTO "TMP_20180417041754_46VSWM_GB_Union" ("KEY", "Estimator") SELECT "GB_Union"."KEY", "GB_Union"."Estimator" 
...
FROM "TMP_20180417041754_66A53Y_GB_B0" AS "GB_B0" UNION ALL SELECT "GB_B1"."KEY" AS "KEY", "GB_B1"."Estimator" AS "Estimator" 
FROM "TMP_20180417041754_F86HAJ_GB_B1" AS "GB_B1") AS "GB_EnsembleUnion") AS "GB_Union"

-- Code For temporary table TMP_20180417041754_HRGRAP_GB_sum part 1/2. Create 


CREATE TEMPORARY TABLE "TMP_20180417041754_HRGRAP_GB_sum" (
	"KEY" BIGINT NOT NULL, 
	"Estimator" FLOAT, 
	PRIMARY KEY ("KEY")
)
...
-- Code For temporary table TMP_20180417041754_HRGRAP_GB_sum part 2/2. Populate

INSERT INTO "TMP_20180417041754_HRGRAP_GB_sum" ("KEY", "Estimator") SELECT "GB_sum"."KEY", "GB_sum"."Estimator" 
...
FROM "TMP_20180417041754_46VSWM_GB_Union" AS "GB_Union" GROUP BY "GB_Union"."KEY") AS "T") AS "GB_sum"

-- Model deployment code

SELECT "GB_sum"."KEY" AS "KEY", 1.3612342030259192 + 0.1 * "GB_sum"."Estimator" AS "Estimator" 
FROM "TMP_20180417041754_HRGRAP_GB_sum" AS "GB_sum"