...
-- Code For temporary table tmp_20180417035117_0khj3b_ads_imp_1_out part 1/2. Create 


CREATE TEMPORARY TABLE tmp_20180417035117_0khj3b_ads_imp_1_out (
	"KEY" BIGINT NOT NULL, 
	impter_2 FLOAT, 
	impter_3 FLOAT, 
	impter_4 FLOAT, 
...
-- Code For temporary table tmp_20180417035117_0khj3b_ads_imp_1_out part 2/2. Populate

INSERT INTO tmp_20180417035117_0khj3b_ads_imp_1_out ("KEY", impter_2, impter_3, impter_4, impter_5, impter_6, impter_7, impter_8, impter_9, impter_10, impter_11) SELECT "U"."KEY", "U".impter_2, "U".impter_3, "U".impter_4, "U".impter_5, "U".impter_6, "U".impter_7, "U".impter_8, "U".impter_9, "U".impter_10, "U".impter_11 
...
-- Code For temporary table tmp_20180417035117_n1ytqi_ads_sca_2_out part 1/2. Create 


CREATE TEMPORARY TABLE tmp_20180417035117_n1ytqi_ads_sca_2_out (
	"KEY" BIGINT NOT NULL, 
	scaler_2 FLOAT, 
	scaler_3 FLOAT, 
	scaler_4 FLOAT, 
...
-- Code For temporary table tmp_20180417035117_n1ytqi_ads_sca_2_out part 2/2. Populate

INSERT INTO tmp_20180417035117_n1ytqi_ads_sca_2_out ("KEY", scaler_2, scaler_3, scaler_4, scaler_5, scaler_6, scaler_7, scaler_8, scaler_9, scaler_10, scaler_11) SELECT "U"."KEY", "U".scaler_2, "U".scaler_3, "U".scaler_4, "U".scaler_5, "U".scaler_6, "U".scaler_7, "U".scaler_8, "U".scaler_9, "U".scaler_10, "U".scaler_11 
...
FROM tmp_20180417035117_0khj3b_ads_imp_1_out AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT") AS "U"

-- Code For temporary table tmp_20180417035117_k2pfl5_gb_b0 part 1/2. Create 


CREATE TEMPORARY TABLE tmp_20180417035117_k2pfl5_gb_b0 (
	"KEY" BIGINT, 
	"Estimator" FLOAT
)
...
-- Code For temporary table tmp_20180417035117_k2pfl5_gb_b0 part 2/2. Populate

INSERT INTO tmp_20180417035117_k2pfl5_gb_b0 ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
FROM tmp_20180417035117_n1ytqi_ads_sca_2_out AS "ADS_sca_2_OUT"), 
"DT_node_data" AS 
...
-- Code For temporary table tmp_20180417035117_j699wf_gb_b1 part 1/2. Create 


CREATE TEMPORARY TABLE tmp_20180417035117_j699wf_gb_b1 (
	"KEY" BIGINT, 
	"Estimator" FLOAT
)
...
-- Code For temporary table tmp_20180417035117_j699wf_gb_b1 part 2/2. Populate

INSERT INTO tmp_20180417035117_j699wf_gb_b1 ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
-- Code For temporary table tmp_20180417035117_f81s5w_gb_union part 1/2. Create 


CREATE TEMPORARY TABLE tmp_20180417035117_f81s5w_gb_union (
	"KEY" BIGINT, 
	"Estimator" FLOAT
)
...
-- Code For temporary table tmp_20180417035117_f81s5w_gb_union part 2/2. Populate

INSERT INTO tmp_20180417035117_f81s5w_gb_union ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
FROM tmp_20180417035117_k2pfl5_gb_b0 AS "GB_B0" UNION ALL SELECT "GB_B1"."KEY" AS "KEY", "GB_B1"."Estimator" AS "Estimator" 
FROM tmp_20180417035117_j699wf_gb_b1 AS "GB_B1") AS "GB_EnsembleUnion") AS "GB_Union") AS "U"

-- Code For temporary table tmp_20180417035117_c3xoa4_gb_sum part 1/2. Create 


CREATE TEMPORARY TABLE tmp_20180417035117_c3xoa4_gb_sum (
	"KEY" BIGINT NOT NULL, 
	"Estimator" FLOAT, 
	PRIMARY KEY ("KEY")
)
...
-- Code For temporary table tmp_20180417035117_c3xoa4_gb_sum part 2/2. Populate

INSERT INTO tmp_20180417035117_c3xoa4_gb_sum ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
FROM tmp_20180417035117_f81s5w_gb_union AS "GB_Union" GROUP BY "GB_Union"."KEY") AS "T") AS "GB_sum") AS "U"

-- Model deployment code

SELECT "GB_sum"."KEY" AS "KEY", 15.3537633818605 + 0.1 * "GB_sum"."Estimator" AS "Estimator" 
FROM tmp_20180417035117_c3xoa4_gb_sum AS "GB_sum"