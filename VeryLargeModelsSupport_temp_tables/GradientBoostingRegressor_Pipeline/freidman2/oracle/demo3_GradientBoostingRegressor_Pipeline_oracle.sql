...
-- Code For temporary table 40435_TM8IGD_ADS_IMP_1_OUT part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE "40435_TM8IGD_ADS_IMP_1_OUT" (
...
-- Code For temporary table 40435_TM8IGD_ADS_IMP_1_OUT part 2/2. Populate

INSERT INTO "40435_TM8IGD_ADS_IMP_1_OUT" ("KEY", imputer_output_2, imputer_output_3, imputer_output_4, imputer_output_5) SELECT "U"."KEY", "U".imputer_output_2, "U".imputer_output_3, "U".imputer_output_4, "U".imputer_output_5 
...
-- Code For temporary table 40435_OZDVCU_ADS_SCA_2_OUT part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE "40435_OZDVCU_ADS_SCA_2_OUT" (
	"KEY" NUMBER(19) NOT NULL, 
...
-- Code For temporary table 40435_OZDVCU_ADS_SCA_2_OUT part 2/2. Populate

INSERT INTO "40435_OZDVCU_ADS_SCA_2_OUT" ("KEY", scaler_output_2, scaler_output_3, scaler_output_4, scaler_output_5) SELECT "U"."KEY", "U".scaler_output_2, "U".scaler_output_3, "U".scaler_output_4, "U".scaler_output_5 
...
FROM "40435_TM8IGD_ADS_IMP_1_OUT" "ADS_imp_1_OUT") "ADS_sca_2_OUT") "U"

-- Code For temporary table 0180417040436_E1KAVO_GB_B0 part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE "0180417040436_E1KAVO_GB_B0" (
	"KEY" NUMBER(19), 
...
-- Code For temporary table 0180417040436_E1KAVO_GB_B0 part 2/2. Populate

INSERT INTO "0180417040436_E1KAVO_GB_B0" ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
FROM "40435_OZDVCU_ADS_SCA_2_OUT" "ADS_sca_2_OUT"), 
"DT_node_data" AS 
...
-- Code For temporary table 0180417040436_NMY3K8_GB_B1 part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE "0180417040436_NMY3K8_GB_B1" (
	"KEY" NUMBER(19), 
	"Estimator" BINARY_DOUBLE
)
...
-- Code For temporary table 0180417040436_NMY3K8_GB_B1 part 2/2. Populate

INSERT INTO "0180417040436_NMY3K8_GB_B1" ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
-- Code For temporary table 0417040436_DJT94T_GB_UNION part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE "0417040436_DJT94T_GB_UNION" (
	"KEY" NUMBER(19), 
	"Estimator" BINARY_DOUBLE
)
...
-- Code For temporary table 0417040436_DJT94T_GB_UNION part 2/2. Populate

INSERT INTO "0417040436_DJT94T_GB_UNION" ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
FROM "0180417040436_E1KAVO_GB_B0" "GB_B0" UNION ALL SELECT "GB_B1"."KEY" AS "KEY", "GB_B1"."Estimator" AS "Estimator" 
FROM "0180417040436_NMY3K8_GB_B1" "GB_B1") "GB_EnsembleUnion") "GB_Union") "U"

-- Code For temporary table 180417040436_TQ449Y_GB_SUM part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE "180417040436_TQ449Y_GB_SUM" (
	"KEY" NUMBER(19) NOT NULL, 
	"Estimator" BINARY_DOUBLE, 
	PRIMARY KEY ("KEY")
)
...
-- Code For temporary table 180417040436_TQ449Y_GB_SUM part 2/2. Populate

INSERT INTO "180417040436_TQ449Y_GB_SUM" ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
FROM "0417040436_DJT94T_GB_UNION" "GB_Union" GROUP BY "GB_Union"."KEY") "T") "GB_sum") "U"

-- Model deployment code

SELECT "GB_sum"."KEY" AS "KEY", 499.09288446517394 + 0.1 * "GB_sum"."Estimator" AS "Estimator" 
FROM "180417040436_TQ449Y_GB_SUM" "GB_sum"