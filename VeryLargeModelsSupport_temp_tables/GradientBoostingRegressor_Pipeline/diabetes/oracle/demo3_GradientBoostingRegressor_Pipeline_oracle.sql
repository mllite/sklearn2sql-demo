...
-- Code For temporary table 24952_VR8Y6P_ADS_IMP_1_OUT part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE "24952_VR8Y6P_ADS_IMP_1_OUT" (
...
-- Code For temporary table 24952_VR8Y6P_ADS_IMP_1_OUT part 2/2. Populate

INSERT INTO "24952_VR8Y6P_ADS_IMP_1_OUT" ("KEY", impter_2, impter_3, impter_4, impter_5, impter_6, impter_7, impter_8, impter_9, impter_10, impter_11) SELECT "U"."KEY", "U".impter_2, "U".impter_3, "U".impter_4, "U".impter_5, "U".impter_6, "U".impter_7, "U".impter_8, "U".impter_9, "U".impter_10, "U".impter_11 
...
-- Code For temporary table 24952_6GG331_ADS_SCA_2_OUT part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE "24952_6GG331_ADS_SCA_2_OUT" (
	"KEY" NUMBER(19) NOT NULL, 
...
-- Code For temporary table 24952_6GG331_ADS_SCA_2_OUT part 2/2. Populate

INSERT INTO "24952_6GG331_ADS_SCA_2_OUT" ("KEY", scaler_2, scaler_3, scaler_4, scaler_5, scaler_6, scaler_7, scaler_8, scaler_9, scaler_10, scaler_11) SELECT "U"."KEY", "U".scaler_2, "U".scaler_3, "U".scaler_4, "U".scaler_5, "U".scaler_6, "U".scaler_7, "U".scaler_8, "U".scaler_9, "U".scaler_10, "U".scaler_11 
...
FROM "24952_VR8Y6P_ADS_IMP_1_OUT" "ADS_imp_1_OUT") "ADS_sca_2_OUT") "U"

-- Code For temporary table 0180417024952_EPA03E_GB_B0 part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE "0180417024952_EPA03E_GB_B0" (
	"KEY" NUMBER(19), 
...
-- Code For temporary table 0180417024952_EPA03E_GB_B0 part 2/2. Populate

INSERT INTO "0180417024952_EPA03E_GB_B0" ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
FROM "24952_6GG331_ADS_SCA_2_OUT" "ADS_sca_2_OUT"), 
"DT_node_data" AS 
...
-- Code For temporary table 0180417024952_TJZZOY_GB_B1 part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE "0180417024952_TJZZOY_GB_B1" (
	"KEY" NUMBER(19), 
	"Estimator" BINARY_DOUBLE
)
...
-- Code For temporary table 0180417024952_TJZZOY_GB_B1 part 2/2. Populate

INSERT INTO "0180417024952_TJZZOY_GB_B1" ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
-- Code For temporary table 0417024952_05XHV9_GB_UNION part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE "0417024952_05XHV9_GB_UNION" (
	"KEY" NUMBER(19), 
	"Estimator" BINARY_DOUBLE
)
...
-- Code For temporary table 0417024952_05XHV9_GB_UNION part 2/2. Populate

INSERT INTO "0417024952_05XHV9_GB_UNION" ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
FROM "0180417024952_EPA03E_GB_B0" "GB_B0" UNION ALL SELECT "GB_B1"."KEY" AS "KEY", "GB_B1"."Estimator" AS "Estimator" 
FROM "0180417024952_TJZZOY_GB_B1" "GB_B1") "GB_EnsembleUnion") "GB_Union") "U"

-- Code For temporary table 180417024952_H5U7XU_GB_SUM part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE "180417024952_H5U7XU_GB_SUM" (
	"KEY" NUMBER(19) NOT NULL, 
	"Estimator" BINARY_DOUBLE, 
	PRIMARY KEY ("KEY")
)
...
-- Code For temporary table 180417024952_H5U7XU_GB_SUM part 2/2. Populate

INSERT INTO "180417024952_H5U7XU_GB_SUM" ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
FROM "0417024952_05XHV9_GB_UNION" "GB_Union" GROUP BY "GB_Union"."KEY") "T") "GB_sum") "U"

-- Model deployment code

SELECT "GB_sum"."KEY" AS "KEY", 154.07365439093485 + 0.1 * "GB_sum"."Estimator" AS "Estimator" 
FROM "180417024952_H5U7XU_GB_SUM" "GB_sum"