...
-- Code For temporary table TMP_20180417012947_0CNBHK_ADS_I part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180417012947_0CNBHK_ADS_I" (
	"KEY" BIGINT, 
	impter_2 FLOAT, 
	impter_3 FLOAT, 
	impter_4 FLOAT, 
...
-- Code For temporary table TMP_20180417012947_66H4VD_ADS_S part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180417012947_66H4VD_ADS_S" (
	"KEY" BIGINT, 
	scaler_2 FLOAT, 
	scaler_3 FLOAT, 
	scaler_4 FLOAT, 
...
FROM "TMP_20180417012947_0CNBHK_ADS_I" AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT") AS "U"

-- Code For temporary table TMP_20180417012947_XV428G_GB_B0 part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180417012947_XV428G_GB_B0" (
	"KEY" BIGINT, 
	"Estimator" FLOAT
)
...
-- Code For temporary table TMP_20180417012947_XV428G_GB_B0 part 2/2. Populate

INSERT INTO "TMP_20180417012947_XV428G_GB_B0" ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
FROM "TMP_20180417012947_66H4VD_ADS_S" AS "ADS_sca_2_OUT"), 
"DT_node_data" AS 
...
-- Code For temporary table TMP_20180417012947_YC7GW3_GB_B1 part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180417012947_YC7GW3_GB_B1" (
	"KEY" BIGINT, 
	"Estimator" FLOAT
)
...
-- Code For temporary table TMP_20180417012947_YC7GW3_GB_B1 part 2/2. Populate

INSERT INTO "TMP_20180417012947_YC7GW3_GB_B1" ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
-- Code For temporary table TMP_20180417012947_7AJL50_GB_UN part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180417012947_7AJL50_GB_UN" (
	"KEY" BIGINT, 
	"Estimator" FLOAT
)
...
-- Code For temporary table TMP_20180417012947_7AJL50_GB_UN part 2/2. Populate

INSERT INTO "TMP_20180417012947_7AJL50_GB_UN" ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
FROM "TMP_20180417012947_XV428G_GB_B0" AS "GB_B0" UNION ALL SELECT "GB_B1"."KEY" AS "KEY", "GB_B1"."Estimator" AS "Estimator" 
FROM "TMP_20180417012947_YC7GW3_GB_B1" AS "GB_B1") AS "GB_EnsembleUnion") AS "GB_Union") AS "U"

-- Code For temporary table TMP_20180417012947_WMIVB1_GB_SU part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180417012947_WMIVB1_GB_SU" (
	"KEY" BIGINT, 
	"Estimator" FLOAT
)
...
-- Code For temporary table TMP_20180417012947_WMIVB1_GB_SU part 2/2. Populate

INSERT INTO "TMP_20180417012947_WMIVB1_GB_SU" ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
FROM "TMP_20180417012947_7AJL50_GB_UN" AS "GB_Union" GROUP BY "GB_Union"."KEY") AS "T") AS "GB_sum") AS "U"

-- Model deployment code

SELECT "GB_sum"."KEY" AS "KEY", -11.471614782695335 + 0.1 * "GB_sum"."Estimator" AS "Estimator" 
FROM "TMP_20180417012947_WMIVB1_GB_SU" AS "GB_sum"