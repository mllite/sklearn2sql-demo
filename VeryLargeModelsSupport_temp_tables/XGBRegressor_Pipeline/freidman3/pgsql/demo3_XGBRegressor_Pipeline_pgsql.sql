...
-- Code For temporary table TMP_20180417042004_9GMUQS_ADS_imp_1_OUT part 1/2. Create 


CREATE TEMPORARY TABLE "TMP_20180417042004_9GMUQS_ADS_imp_1_OUT" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20180417042004_9GMUQS_ADS_imp_1_OUT part 2/2. Populate

INSERT INTO "TMP_20180417042004_9GMUQS_ADS_imp_1_OUT" ("KEY", imputer_output_2, imputer_output_3, imputer_output_4, imputer_output_5) SELECT "ADS_imp_1_OUT"."KEY", "ADS_imp_1_OUT".imputer_output_2, "ADS_imp_1_OUT".imputer_output_3, "ADS_imp_1_OUT".imputer_output_4, "ADS_imp_1_OUT".imputer_output_5 
...
-- Code For temporary table TMP_20180417042004_QRORDV_ADS_sca_2_OUT part 1/2. Create 


CREATE TEMPORARY TABLE "TMP_20180417042004_QRORDV_ADS_sca_2_OUT" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20180417042004_QRORDV_ADS_sca_2_OUT part 2/2. Populate

INSERT INTO "TMP_20180417042004_QRORDV_ADS_sca_2_OUT" ("KEY", scaler_output_2, scaler_output_3, scaler_output_4, scaler_output_5) SELECT "ADS_sca_2_OUT"."KEY", "ADS_sca_2_OUT".scaler_output_2, "ADS_sca_2_OUT".scaler_output_3, "ADS_sca_2_OUT".scaler_output_4, "ADS_sca_2_OUT".scaler_output_5 
...
FROM "TMP_20180417042004_9GMUQS_ADS_imp_1_OUT" AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT"

-- Code For temporary table TMP_20180417042004_21D10S_XGB_B0 part 1/2. Create 


CREATE TEMPORARY TABLE "TMP_20180417042004_21D10S_XGB_B0" (
	"KEY" BIGINT, 
	"Estimator" FLOAT
)
...
-- Code For temporary table TMP_20180417042004_21D10S_XGB_B0 part 2/2. Populate
...
FROM "TMP_20180417042004_QRORDV_ADS_sca_2_OUT" AS "ADS_sca_2_OUT"), 
"DT_node_data" AS 
...
FROM "DT_Output_9")
 INSERT INTO "TMP_20180417042004_21D10S_XGB_B0" ("KEY", "Estimator") SELECT "XGB_B0"."KEY", "XGB_B0"."Estimator" 
...
-- Code For temporary table TMP_20180417042004_Z3DSRM_XGB_B1 part 1/2. Create 


CREATE TEMPORARY TABLE "TMP_20180417042004_Z3DSRM_XGB_B1" (
	"KEY" BIGINT, 
	"Estimator" FLOAT
)
...
-- Code For temporary table TMP_20180417042004_Z3DSRM_XGB_B1 part 2/2. Populate
...
FROM "DT_Output_15")
 INSERT INTO "TMP_20180417042004_Z3DSRM_XGB_B1" ("KEY", "Estimator") SELECT "XGB_B1"."KEY", "XGB_B1"."Estimator" 
...
-- Code For temporary table TMP_20180417042004_COOYVI_XGB_Union part 1/2. Create 


CREATE TEMPORARY TABLE "TMP_20180417042004_COOYVI_XGB_Union" (
	"KEY" BIGINT, 
	"Estimator" FLOAT
)
...
-- Code For temporary table TMP_20180417042004_COOYVI_XGB_Union part 2/2. Populate

INSERT INTO "TMP_20180417042004_COOYVI_XGB_Union" ("KEY", "Estimator") SELECT "XGB_Union"."KEY", "XGB_Union"."Estimator" 
...
FROM "TMP_20180417042004_21D10S_XGB_B0" AS "XGB_B0" UNION ALL SELECT "XGB_B1"."KEY" AS "KEY", "XGB_B1"."Estimator" AS "Estimator" 
FROM "TMP_20180417042004_Z3DSRM_XGB_B1" AS "XGB_B1") AS "XGB_EnsembleUnion") AS "XGB_Union"

-- Code For temporary table TMP_20180417042004_MHSBCC_XGB_sum part 1/2. Create 


CREATE TEMPORARY TABLE "TMP_20180417042004_MHSBCC_XGB_sum" (
	"KEY" BIGINT NOT NULL, 
	"Estimator" FLOAT, 
	PRIMARY KEY ("KEY")
)
...
-- Code For temporary table TMP_20180417042004_MHSBCC_XGB_sum part 2/2. Populate

INSERT INTO "TMP_20180417042004_MHSBCC_XGB_sum" ("KEY", "Estimator") SELECT "XGB_sum"."KEY", "XGB_sum"."Estimator" 
...
FROM "TMP_20180417042004_COOYVI_XGB_Union" AS "XGB_Union" GROUP BY "XGB_Union"."KEY") AS "T") AS "XGB_sum"

-- Model deployment code

SELECT "XGB_sum"."KEY" AS "KEY", "XGB_sum"."Estimator" + 0.5 AS "Estimator" 
FROM "TMP_20180417042004_MHSBCC_XGB_sum" AS "XGB_sum"