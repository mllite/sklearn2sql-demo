...
-- Code For temporary table tmp_20180417042004_k4z5w9_ads_imp_1_out part 1/2. Create 


CREATE TEMPORARY TABLE tmp_20180417042004_k4z5w9_ads_imp_1_out (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table tmp_20180417042004_k4z5w9_ads_imp_1_out part 2/2. Populate

INSERT INTO tmp_20180417042004_k4z5w9_ads_imp_1_out ("KEY", imputer_output_2, imputer_output_3, imputer_output_4, imputer_output_5) SELECT "U"."KEY", "U".imputer_output_2, "U".imputer_output_3, "U".imputer_output_4, "U".imputer_output_5 
...
-- Code For temporary table tmp_20180417042004_39jrdv_ads_sca_2_out part 1/2. Create 


CREATE TEMPORARY TABLE tmp_20180417042004_39jrdv_ads_sca_2_out (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table tmp_20180417042004_39jrdv_ads_sca_2_out part 2/2. Populate

INSERT INTO tmp_20180417042004_39jrdv_ads_sca_2_out ("KEY", scaler_output_2, scaler_output_3, scaler_output_4, scaler_output_5) SELECT "U"."KEY", "U".scaler_output_2, "U".scaler_output_3, "U".scaler_output_4, "U".scaler_output_5 
...
FROM tmp_20180417042004_k4z5w9_ads_imp_1_out AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT") AS "U"

-- Code For temporary table tmp_20180417042004_nzho5q_xgb_b0 part 1/2. Create 


CREATE TEMPORARY TABLE tmp_20180417042004_nzho5q_xgb_b0 (
	"KEY" BIGINT, 
	"Estimator" FLOAT
)
...
-- Code For temporary table tmp_20180417042004_nzho5q_xgb_b0 part 2/2. Populate

INSERT INTO tmp_20180417042004_nzho5q_xgb_b0 ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
FROM tmp_20180417042004_39jrdv_ads_sca_2_out AS "ADS_sca_2_OUT"), 
"DT_node_data" AS 
...
-- Code For temporary table tmp_20180417042004_kg9aip_xgb_b1 part 1/2. Create 


CREATE TEMPORARY TABLE tmp_20180417042004_kg9aip_xgb_b1 (
	"KEY" BIGINT, 
	"Estimator" FLOAT
)
...
-- Code For temporary table tmp_20180417042004_kg9aip_xgb_b1 part 2/2. Populate

INSERT INTO tmp_20180417042004_kg9aip_xgb_b1 ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
-- Code For temporary table tmp_20180417042004_2w94xk_xgb_union part 1/2. Create 


CREATE TEMPORARY TABLE tmp_20180417042004_2w94xk_xgb_union (
	"KEY" BIGINT, 
	"Estimator" FLOAT
)
...
-- Code For temporary table tmp_20180417042004_2w94xk_xgb_union part 2/2. Populate

INSERT INTO tmp_20180417042004_2w94xk_xgb_union ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
FROM tmp_20180417042004_nzho5q_xgb_b0 AS "XGB_B0" UNION ALL SELECT "XGB_B1"."KEY" AS "KEY", "XGB_B1"."Estimator" AS "Estimator" 
FROM tmp_20180417042004_kg9aip_xgb_b1 AS "XGB_B1") AS "XGB_EnsembleUnion") AS "XGB_Union") AS "U"

-- Code For temporary table tmp_20180417042004_8saoyj_xgb_sum part 1/2. Create 


CREATE TEMPORARY TABLE tmp_20180417042004_8saoyj_xgb_sum (
	"KEY" BIGINT NOT NULL, 
	"Estimator" FLOAT, 
	PRIMARY KEY ("KEY")
)
...
-- Code For temporary table tmp_20180417042004_8saoyj_xgb_sum part 2/2. Populate

INSERT INTO tmp_20180417042004_8saoyj_xgb_sum ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
FROM tmp_20180417042004_2w94xk_xgb_union AS "XGB_Union" GROUP BY "XGB_Union"."KEY") AS "T") AS "XGB_sum") AS "U"

-- Model deployment code

SELECT "XGB_sum"."KEY" AS "KEY", "XGB_sum"."Estimator" + 0.5 AS "Estimator" 
FROM tmp_20180417042004_8saoyj_xgb_sum AS "XGB_sum"