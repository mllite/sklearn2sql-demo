...
-- Code For temporary table tmp_20180417011844_1d23r3_ads_imp_1_out part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180417011844_1d23r3_ads_imp_1_out (
	"KEY" BIGINT, 
	impter_2 DOUBLE, 
	impter_3 DOUBLE, 
	impter_4 DOUBLE, 
...
-- Code For temporary table tmp_20180417011844_1d23r3_ads_imp_1_out part 2/2. Populate

INSERT INTO tmp_20180417011844_1d23r3_ads_imp_1_out SELECT "ADS_imp_1_OUT"."KEY", "ADS_imp_1_OUT".impter_2, "ADS_imp_1_OUT".impter_3, "ADS_imp_1_OUT".impter_4, "ADS_imp_1_OUT".impter_5, "ADS_imp_1_OUT".impter_6, "ADS_imp_1_OUT".impter_7, "ADS_imp_1_OUT".impter_8, "ADS_imp_1_OUT".impter_9, "ADS_imp_1_OUT".impter_10, "ADS_imp_1_OUT".impter_11 
...
-- Code For temporary table tmp_20180417011844_8ef5zi_ads_sca_2_out part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180417011844_8ef5zi_ads_sca_2_out (
	"KEY" BIGINT, 
	scaler_2 FLOAT, 
	scaler_3 FLOAT, 
	scaler_4 FLOAT, 
...
FROM tmp_20180417011844_1d23r3_ads_imp_1_out AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT"

-- Code For temporary table tmp_20180417011845_rxrq6y_xgb_b0 part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180417011845_rxrq6y_xgb_b0 (
	"KEY" BIGINT, 
	"Estimator" FLOAT
)
...
-- Code For temporary table tmp_20180417011845_rxrq6y_xgb_b0 part 2/2. Populate

INSERT INTO tmp_20180417011845_rxrq6y_xgb_b0 WITH "DT_node_lookup" AS 
...
FROM tmp_20180417011844_8ef5zi_ads_sca_2_out AS "ADS_sca_2_OUT"), 
"DT_node_data" AS 
...
-- Code For temporary table tmp_20180417011845_lekkh7_xgb_b1 part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180417011845_lekkh7_xgb_b1 (
	"KEY" BIGINT, 
	"Estimator" FLOAT
)
...
-- Code For temporary table tmp_20180417011845_lekkh7_xgb_b1 part 2/2. Populate

INSERT INTO tmp_20180417011845_lekkh7_xgb_b1 WITH "DT_node_lookup_10" AS 
...
-- Code For temporary table tmp_20180417011845_ktz8et_xgb_union part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180417011845_ktz8et_xgb_union (
	"KEY" BIGINT, 
	"Estimator" FLOAT
)
...
-- Code For temporary table tmp_20180417011845_ktz8et_xgb_union part 2/2. Populate

INSERT INTO tmp_20180417011845_ktz8et_xgb_union SELECT "XGB_Union"."KEY", "XGB_Union"."Estimator" 
...
FROM tmp_20180417011845_rxrq6y_xgb_b0 AS "XGB_B0" UNION ALL SELECT "XGB_B1"."KEY" AS "KEY", "XGB_B1"."Estimator" AS "Estimator" 
FROM tmp_20180417011845_lekkh7_xgb_b1 AS "XGB_B1") AS "XGB_EnsembleUnion") AS "XGB_Union"

-- Code For temporary table tmp_20180417011845_w2g3xy_xgb_sum part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180417011845_w2g3xy_xgb_sum (
	"KEY" BIGINT, 
	"Estimator" FLOAT
)
...
-- Code For temporary table tmp_20180417011845_w2g3xy_xgb_sum part 2/2. Populate

INSERT INTO tmp_20180417011845_w2g3xy_xgb_sum SELECT "XGB_sum"."KEY", "XGB_sum"."Estimator" 
...
FROM tmp_20180417011845_ktz8et_xgb_union AS "XGB_Union" GROUP BY "XGB_Union"."KEY") AS "T") AS "XGB_sum"

-- Model deployment code

SELECT "XGB_sum"."KEY" AS "KEY", "XGB_sum"."Estimator" + 0.5 AS "Estimator" 
FROM tmp_20180417011845_w2g3xy_xgb_sum AS "XGB_sum"