...
-- Code For temporary table 23846_Z1INJ6_ADS_IMP_1_OUT part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE "23846_Z1INJ6_ADS_IMP_1_OUT" (
...
-- Code For temporary table 23846_Z1INJ6_ADS_IMP_1_OUT part 2/2. Populate

INSERT INTO "23846_Z1INJ6_ADS_IMP_1_OUT" ("KEY", impter_2, impter_3, impter_4, impter_5, impter_6, impter_7, impter_8, impter_9, impter_10, impter_11, impter_12, impter_13, impter_14) SELECT "U"."KEY", "U".impter_2, "U".impter_3, "U".impter_4, "U".impter_5, "U".impter_6, "U".impter_7, "U".impter_8, "U".impter_9, "U".impter_10, "U".impter_11, "U".impter_12, "U".impter_13, "U".impter_14 
...
-- Code For temporary table 23846_IM2O1X_ADS_SCA_2_OUT part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE "23846_IM2O1X_ADS_SCA_2_OUT" (
	"KEY" NUMBER(19) NOT NULL, 
...
FROM "23846_Z1INJ6_ADS_IMP_1_OUT" "ADS_imp_1_OUT") "ADS_sca_2_OUT") "U"

-- Code For temporary table 180417023846_XWQCY5_XGB_B0 part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE "180417023846_XWQCY5_XGB_B0" (
	"KEY" NUMBER(19), 
...
-- Code For temporary table 180417023846_XWQCY5_XGB_B0 part 2/2. Populate

INSERT INTO "180417023846_XWQCY5_XGB_B0" ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
FROM "23846_IM2O1X_ADS_SCA_2_OUT" "ADS_sca_2_OUT"), 
"DT_node_data" AS 
...
-- Code For temporary table 180417023846_VA58Y7_XGB_B1 part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE "180417023846_VA58Y7_XGB_B1" (
	"KEY" NUMBER(19), 
	"Estimator" BINARY_DOUBLE
)
...
-- Code For temporary table 180417023846_VA58Y7_XGB_B1 part 2/2. Populate

INSERT INTO "180417023846_VA58Y7_XGB_B1" ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
-- Code For temporary table 417023846_L6W47G_XGB_UNION part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE "417023846_L6W47G_XGB_UNION" (
	"KEY" NUMBER(19), 
	"Estimator" BINARY_DOUBLE
)
...
-- Code For temporary table 417023846_L6W47G_XGB_UNION part 2/2. Populate

INSERT INTO "417023846_L6W47G_XGB_UNION" ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
FROM "180417023846_XWQCY5_XGB_B0" "XGB_B0" UNION ALL SELECT "XGB_B1"."KEY" AS "KEY", "XGB_B1"."Estimator" AS "Estimator" 
FROM "180417023846_VA58Y7_XGB_B1" "XGB_B1") "XGB_EnsembleUnion") "XGB_Union") "U"

-- Code For temporary table 80417023846_2LD9AL_XGB_SUM part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE "80417023846_2LD9AL_XGB_SUM" (
	"KEY" NUMBER(19) NOT NULL, 
	"Estimator" BINARY_DOUBLE, 
	PRIMARY KEY ("KEY")
)
...
-- Code For temporary table 80417023846_2LD9AL_XGB_SUM part 2/2. Populate

INSERT INTO "80417023846_2LD9AL_XGB_SUM" ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
FROM "417023846_L6W47G_XGB_UNION" "XGB_Union" GROUP BY "XGB_Union"."KEY") "T") "XGB_sum") "U"

-- Model deployment code

SELECT "XGB_sum"."KEY" AS "KEY", "XGB_sum"."Estimator" + 0.5 AS "Estimator" 
FROM "80417023846_2LD9AL_XGB_SUM" "XGB_sum"