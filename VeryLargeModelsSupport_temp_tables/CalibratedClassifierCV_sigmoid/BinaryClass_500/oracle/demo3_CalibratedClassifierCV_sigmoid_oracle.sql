...
-- Code For temporary table 16223539_O6DABB_CALPROB_B0 part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE "16223539_O6DABB_CALPROB_B0" (
	"KEY" NUMBER(19), 
...
-- Code For temporary table 16223539_O6DABB_CALPROB_B0 part 2/2. Populate

INSERT INTO "16223539_O6DABB_CALPROB_B0" ("KEY", "Proba_1", "Proba_0") SELECT "U"."KEY", "U"."Proba_1", "U"."Proba_0" 
...
-- Code For temporary table 23539_2LU5EU_CALPROB_UNION part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE "23539_2LU5EU_CALPROB_UNION" (
	"KEY" NUMBER(19), 
	"Proba_1" BINARY_DOUBLE, 
	"Proba_0" BINARY_DOUBLE
)
...
-- Code For temporary table 23539_2LU5EU_CALPROB_UNION part 2/2. Populate

INSERT INTO "23539_2LU5EU_CALPROB_UNION" ("KEY", "Proba_1", "Proba_0") SELECT "U"."KEY", "U"."Proba_1", "U"."Proba_0" 
...
FROM "16223539_O6DABB_CALPROB_B0" "CalProb_B0") "CalProb_EnsembleUnion") "CalProb_Union") "U"

-- Code For temporary table 6223539_J4GC1C_CALPROB_AVG part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE "6223539_J4GC1C_CALPROB_AVG" (
...
-- Code For temporary table 6223539_J4GC1C_CALPROB_AVG part 2/2. Populate

INSERT INTO "6223539_J4GC1C_CALPROB_AVG" ("KEY", "Proba_1", "Proba_0") SELECT "U"."KEY", "U"."Proba_1", "U"."Proba_0" 
...
FROM "23539_2LU5EU_CALPROB_UNION" "CalProb_Union" GROUP BY "CalProb_Union"."KEY") "T") "CalProb_avg") "U"
...
FROM "6223539_J4GC1C_CALPROB_AVG" "CalProb_avg"), 
