...
-- Code For temporary table tmp_20180417042039_c7mxgx_calp part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180417042039_c7mxgx_calp  (
	"KEY" BIGINT, 
	"Proba_0" FLOAT, 
	"Proba_1" FLOAT, 
	"Proba_2" FLOAT
...
-- Code For temporary table tmp_20180417042039_c7mxgx_calp part 2/2. Populate

INSERT INTO tmp_20180417042039_c7mxgx_calp ("KEY", "Proba_0", "Proba_1", "Proba_2") SELECT "U"."KEY", "U"."Proba_0", "U"."Proba_1", "U"."Proba_2" 
...
-- Code For temporary table tmp_20180417042039_i71o7q_calp part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180417042039_i71o7q_calp  (
	"KEY" BIGINT, 
	"Proba_0" FLOAT, 
	"Proba_1" FLOAT, 
	"Proba_2" FLOAT
...
-- Code For temporary table tmp_20180417042039_i71o7q_calp part 2/2. Populate

INSERT INTO tmp_20180417042039_i71o7q_calp ("KEY", "Proba_0", "Proba_1", "Proba_2") SELECT "U"."KEY", "U"."Proba_0", "U"."Proba_1", "U"."Proba_2" 
...
FROM tmp_20180417042039_c7mxgx_calp AS "CalProb_B0") AS "CalProb_EnsembleUnion") AS "CalProb_Union") AS "U"

-- Code For temporary table tmp_20180417042039_yz3nql_calp part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180417042039_yz3nql_calp  (
	"KEY" BIGINT, 
	"Proba_0" FLOAT, 
	"Proba_1" FLOAT, 
	"Proba_2" FLOAT
...
-- Code For temporary table tmp_20180417042039_yz3nql_calp part 2/2. Populate

INSERT INTO tmp_20180417042039_yz3nql_calp ("KEY", "Proba_0", "Proba_1", "Proba_2") SELECT "U"."KEY", "U"."Proba_0", "U"."Proba_1", "U"."Proba_2" 
...
FROM tmp_20180417042039_i71o7q_calp AS "CalProb_Union" GROUP BY "CalProb_Union"."KEY") AS "T") AS "CalProb_avg") AS "U"
...
FROM tmp_20180417042039_yz3nql_calp AS "CalProb_avg"), 
