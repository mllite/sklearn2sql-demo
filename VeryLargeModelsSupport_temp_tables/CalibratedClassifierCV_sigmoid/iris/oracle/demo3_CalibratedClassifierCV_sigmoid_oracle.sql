...
-- Code For temporary table 17042039_58DEOI_CALPROB_B0 part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE "17042039_58DEOI_CALPROB_B0" (
	"KEY" NUMBER(19), 
...
-- Code For temporary table 17042039_58DEOI_CALPROB_B0 part 2/2. Populate

INSERT INTO "17042039_58DEOI_CALPROB_B0" ("KEY", "Proba_0", "Proba_1", "Proba_2") SELECT "U"."KEY", "U"."Proba_0", "U"."Proba_1", "U"."Proba_2" 
...
-- Code For temporary table 42039_A3WD9K_CALPROB_UNION part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE "42039_A3WD9K_CALPROB_UNION" (
	"KEY" NUMBER(19), 
	"Proba_0" BINARY_DOUBLE, 
	"Proba_1" BINARY_DOUBLE, 
	"Proba_2" BINARY_DOUBLE
...
-- Code For temporary table 42039_A3WD9K_CALPROB_UNION part 2/2. Populate

INSERT INTO "42039_A3WD9K_CALPROB_UNION" ("KEY", "Proba_0", "Proba_1", "Proba_2") SELECT "U"."KEY", "U"."Proba_0", "U"."Proba_1", "U"."Proba_2" 
...
FROM "17042039_58DEOI_CALPROB_B0" "CalProb_B0") "CalProb_EnsembleUnion") "CalProb_Union") "U"

-- Code For temporary table 7042039_CYEXMF_CALPROB_AVG part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE "7042039_CYEXMF_CALPROB_AVG" (
...
-- Code For temporary table 7042039_CYEXMF_CALPROB_AVG part 2/2. Populate

INSERT INTO "7042039_CYEXMF_CALPROB_AVG" ("KEY", "Proba_0", "Proba_1", "Proba_2") SELECT "U"."KEY", "U"."Proba_0", "U"."Proba_1", "U"."Proba_2" 
...
FROM "42039_A3WD9K_CALPROB_UNION" "CalProb_Union" GROUP BY "CalProb_Union"."KEY") "T") "CalProb_avg") "U"
...
FROM "7042039_CYEXMF_CALPROB_AVG" "CalProb_avg"), 
