...
-- Code For temporary table tmp_20180417050854_uh6gbw_calp part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180417050854_uh6gbw_calp  (
	"KEY" BIGINT, 
	"Proba_CLASS_0" FLOAT, 
	"Proba_CLASS_1" FLOAT, 
	"Proba_CLASS_2" FLOAT
...
-- Code For temporary table tmp_20180417050854_uh6gbw_calp part 2/2. Populate

INSERT INTO tmp_20180417050854_uh6gbw_calp ("KEY", "Proba_CLASS_0", "Proba_CLASS_1", "Proba_CLASS_2") SELECT "U"."KEY", "U"."Proba_CLASS_0", "U"."Proba_CLASS_1", "U"."Proba_CLASS_2" 
...
-- Code For temporary table tmp_20180417050854_29n6sl_calp part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180417050854_29n6sl_calp  (
	"KEY" BIGINT, 
	"Proba_CLASS_0" FLOAT, 
	"Proba_CLASS_1" FLOAT, 
	"Proba_CLASS_2" FLOAT
...
-- Code For temporary table tmp_20180417050854_29n6sl_calp part 2/2. Populate

INSERT INTO tmp_20180417050854_29n6sl_calp ("KEY", "Proba_CLASS_0", "Proba_CLASS_1", "Proba_CLASS_2") SELECT "U"."KEY", "U"."Proba_CLASS_0", "U"."Proba_CLASS_1", "U"."Proba_CLASS_2" 
...
FROM tmp_20180417050854_uh6gbw_calp AS "CalProb_B0") AS "CalProb_EnsembleUnion") AS "CalProb_Union") AS "U"

-- Code For temporary table tmp_20180417050854_3jm461_calp part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180417050854_3jm461_calp  (
	"KEY" BIGINT, 
	"Proba_CLASS_0" FLOAT, 
	"Proba_CLASS_1" FLOAT, 
	"Proba_CLASS_2" FLOAT
...
-- Code For temporary table tmp_20180417050854_3jm461_calp part 2/2. Populate

INSERT INTO tmp_20180417050854_3jm461_calp ("KEY", "Proba_CLASS_0", "Proba_CLASS_1", "Proba_CLASS_2") SELECT "U"."KEY", "U"."Proba_CLASS_0", "U"."Proba_CLASS_1", "U"."Proba_CLASS_2" 
...
FROM tmp_20180417050854_29n6sl_calp AS "CalProb_Union" GROUP BY "CalProb_Union"."KEY") AS "T") AS "CalProb_avg") AS "U"
...
FROM tmp_20180417050854_3jm461_calp AS "CalProb_avg"), 
