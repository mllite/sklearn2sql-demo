...
-- Code For temporary table tmp_20180416222627_d49w3m_calp part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180416222627_d49w3m_calp  (
	"KEY" BIGINT, 
	"Proba_1" FLOAT, 
	"Proba_0" FLOAT
)
...
-- Code For temporary table tmp_20180416222627_d49w3m_calp part 2/2. Populate

INSERT INTO tmp_20180416222627_d49w3m_calp ("KEY", "Proba_1", "Proba_0") SELECT "U"."KEY", "U"."Proba_1", "U"."Proba_0" 
...
-- Code For temporary table tmp_20180416222627_ka8dkn_calp part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180416222627_ka8dkn_calp  (
	"KEY" BIGINT, 
	"Proba_1" FLOAT, 
	"Proba_0" FLOAT
)
...
-- Code For temporary table tmp_20180416222627_ka8dkn_calp part 2/2. Populate

INSERT INTO tmp_20180416222627_ka8dkn_calp ("KEY", "Proba_1", "Proba_0") SELECT "U"."KEY", "U"."Proba_1", "U"."Proba_0" 
...
FROM tmp_20180416222627_d49w3m_calp AS "CalProb_B0") AS "CalProb_EnsembleUnion") AS "CalProb_Union") AS "U"

-- Code For temporary table tmp_20180416222627_u4xrnf_calp part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180416222627_u4xrnf_calp  (
	"KEY" BIGINT, 
	"Proba_1" FLOAT, 
	"Proba_0" FLOAT
)
...
-- Code For temporary table tmp_20180416222627_u4xrnf_calp part 2/2. Populate

INSERT INTO tmp_20180416222627_u4xrnf_calp ("KEY", "Proba_1", "Proba_0") SELECT "U"."KEY", "U"."Proba_1", "U"."Proba_0" 
...
FROM tmp_20180416222627_ka8dkn_calp AS "CalProb_Union" GROUP BY "CalProb_Union"."KEY") AS "T") AS "CalProb_avg") AS "U"
...
FROM tmp_20180416222627_u4xrnf_calp AS "CalProb_avg"), 
