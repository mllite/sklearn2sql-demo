...
-- Code For temporary table TMP_20180416222626_01K3WH_CALPR part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180416222626_01K3WH_CALPR" (
	"KEY" BIGINT, 
	"Proba_1" FLOAT, 
	"Proba_0" FLOAT
)
...
-- Code For temporary table TMP_20180416222626_01K3WH_CALPR part 2/2. Populate

INSERT INTO "TMP_20180416222626_01K3WH_CALPR" ("KEY", "Proba_1", "Proba_0") SELECT "U"."KEY", "U"."Proba_1", "U"."Proba_0" 
...
-- Code For temporary table TMP_20180416222626_2AP4HN_CALPR part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180416222626_2AP4HN_CALPR" (
	"KEY" BIGINT, 
	"Proba_1" FLOAT, 
	"Proba_0" FLOAT
)
...
-- Code For temporary table TMP_20180416222626_2AP4HN_CALPR part 2/2. Populate

INSERT INTO "TMP_20180416222626_2AP4HN_CALPR" ("KEY", "Proba_1", "Proba_0") SELECT "U"."KEY", "U"."Proba_1", "U"."Proba_0" 
...
FROM "TMP_20180416222626_01K3WH_CALPR" AS "CalProb_B0") AS "CalProb_EnsembleUnion") AS "CalProb_Union") AS "U"

-- Code For temporary table TMP_20180416222626_0N5Z5H_CALPR part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180416222626_0N5Z5H_CALPR" (
	"KEY" BIGINT, 
	"Proba_1" FLOAT, 
	"Proba_0" FLOAT
)
...
-- Code For temporary table TMP_20180416222626_0N5Z5H_CALPR part 2/2. Populate

INSERT INTO "TMP_20180416222626_0N5Z5H_CALPR" ("KEY", "Proba_1", "Proba_0") SELECT "U"."KEY", "U"."Proba_1", "U"."Proba_0" 
...
FROM "TMP_20180416222626_2AP4HN_CALPR" AS "CalProb_Union" GROUP BY "CalProb_Union"."KEY") AS "T") AS "CalProb_avg") AS "U"
...
FROM "TMP_20180416222626_0N5Z5H_CALPR" AS "CalProb_avg"), 
