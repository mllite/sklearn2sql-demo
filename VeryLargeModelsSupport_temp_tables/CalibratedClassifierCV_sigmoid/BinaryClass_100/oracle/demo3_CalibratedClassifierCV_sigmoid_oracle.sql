...
-- Code For temporary table 16223052_Z0X81R_CALPROB_B0 part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE "16223052_Z0X81R_CALPROB_B0" (
	"KEY" NUMBER(19), 
...
-- Code For temporary table 16223052_Z0X81R_CALPROB_B0 part 2/2. Populate

INSERT INTO "16223052_Z0X81R_CALPROB_B0" ("KEY", "Proba_1", "Proba_0") SELECT "U"."KEY", "U"."Proba_1", "U"."Proba_0" 
...
-- Code For temporary table 23052_SANXOP_CALPROB_UNION part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE "23052_SANXOP_CALPROB_UNION" (
	"KEY" NUMBER(19), 
	"Proba_1" BINARY_DOUBLE, 
	"Proba_0" BINARY_DOUBLE
)
...
-- Code For temporary table 23052_SANXOP_CALPROB_UNION part 2/2. Populate

INSERT INTO "23052_SANXOP_CALPROB_UNION" ("KEY", "Proba_1", "Proba_0") SELECT "U"."KEY", "U"."Proba_1", "U"."Proba_0" 
...
FROM "16223052_Z0X81R_CALPROB_B0" "CalProb_B0") "CalProb_EnsembleUnion") "CalProb_Union") "U"

-- Code For temporary table 6223052_71V8VT_CALPROB_AVG part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE "6223052_71V8VT_CALPROB_AVG" (
...
-- Code For temporary table 6223052_71V8VT_CALPROB_AVG part 2/2. Populate

INSERT INTO "6223052_71V8VT_CALPROB_AVG" ("KEY", "Proba_1", "Proba_0") SELECT "U"."KEY", "U"."Proba_1", "U"."Proba_0" 
...
FROM "23052_SANXOP_CALPROB_UNION" "CalProb_Union" GROUP BY "CalProb_Union"."KEY") "T") "CalProb_avg") "U"
...
FROM "6223052_71V8VT_CALPROB_AVG" "CalProb_avg"), 
