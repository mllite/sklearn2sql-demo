...
-- Code For temporary table tmp_20180416223145_cy430p_ads_ part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180416223145_cy430p_ads_  (
	"KEY" BIGINT, 
	impter_2 FLOAT, 
	impter_3 FLOAT, 
	impter_4 FLOAT, 
...
-- Code For temporary table tmp_20180416223145_v0b3me_ads_ part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180416223145_v0b3me_ads_  (
	"KEY" BIGINT, 
	scaler_2 FLOAT, 
	scaler_3 FLOAT, 
	scaler_4 FLOAT, 
...
FROM tmp_20180416223145_cy430p_ads_ AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT") AS "U"

-- Model deployment code

WITH "DT_node_lookup" AS 
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", CASE WHEN ("ADS_sca_2_OUT".scaler_59 <= 0.06653057038784) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_19 <= 1.1668860912323) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_11 <= 2.114020586013794) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_62 <= -0.568029999732971) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_82 <= 0.321426451206207) THEN 5 ELSE 6 END ELSE 7 END ELSE 8 END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_59 <= -0.893388271331787) THEN 10 ELSE 11 END END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_56 <= 1.206938982009888) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_83 <= -2.09354019165039) THEN 14 ELSE 15 END ELSE 16 END END AS node_id_2 
FROM tmp_20180416223145_v0b3me_ads_ AS "ADS_sca_2_OUT"), 
"DT_node_data" AS 
