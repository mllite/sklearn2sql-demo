...
-- Code For temporary table tmp_20180417050940_78d0ty_ads_imp_1_out part 1/2. Create 

CREATE TEMPORARY TABLE `tmp_20180417050940_78d0ty_ads_imp_1_out` STORED AS ORC AS SELECT `ADS_imp_1_OUT`.`KEY`, `ADS_imp_1_OUT`.`imputer_output_2`, `ADS_imp_1_OUT`.`imputer_output_3`, `ADS_imp_1_OUT`.`imputer_output_4`, `ADS_imp_1_OUT`.`imputer_output_5` 
...
-- Code For temporary table tmp_20180417050940_78d0ty_ads_imp_1_out part 2/2. Populate

SELECT * FROM `tmp_20180417050940_78d0ty_ads_imp_1_out`

-- Code For temporary table tmp_20180417050940_7u3yaa_ads_sca_2_out part 1/2. Create 

CREATE TEMPORARY TABLE `tmp_20180417050940_7u3yaa_ads_sca_2_out` STORED AS ORC AS SELECT `ADS_sca_2_OUT`.`KEY`, `ADS_sca_2_OUT`.`scaler_output_2`, `ADS_sca_2_OUT`.`scaler_output_3`, `ADS_sca_2_OUT`.`scaler_output_4`, `ADS_sca_2_OUT`.`scaler_output_5` 
...
FROM `tmp_20180417050940_78d0ty_ads_imp_1_out` AS `ADS_imp_1_OUT`) AS `ADS_sca_2_OUT`

-- Code For temporary table tmp_20180417050940_7u3yaa_ads_sca_2_out part 2/2. Populate

SELECT * FROM `tmp_20180417050940_7u3yaa_ads_sca_2_out`
...
FROM `tmp_20180417050940_7u3yaa_ads_sca_2_out` AS `ADS_sca_2_OUT`), 
`DT_node_data` AS 
...
FROM (SELECT 1 AS `node_id`, CAST(NULL AS STRING) AS `feature`, CAST(NULL AS FLOAT) AS `threshold`, 37 AS `count`, 1 AS `depth`, 0 AS `parent_id`, 1.0 AS `Proba_CLASS_0`, 0.0 AS `LogProba_CLASS_0`, 0.0 AS `Proba_CLASS_1`, -1.79769313486231e+308 AS `LogProba_CLASS_1`, 0.0 AS `Proba_CLASS_2`, -1.79769313486231e+308 AS `LogProba_CLASS_2`, 'CLASS_0' AS `Decision`, 1.0 AS `DecisionProba` UNION ALL SELECT 4 AS `node_id`, CAST(NULL AS STRING) AS `feature`, CAST(NULL AS FLOAT) AS `threshold`, 36 AS `count`, 3 AS `depth`, 3 AS `parent_id`, 0.0 AS `Proba_CLASS_0`, -1.79769313486231e+308 AS `LogProba_CLASS_0`, 1.0 AS `Proba_CLASS_1`, 0.0 AS `LogProba_CLASS_1`, 0.0 AS `Proba_CLASS_2`, -1.79769313486231e+308 AS `LogProba_CLASS_2`, 'CLASS_1' AS `Decision`, 1.0 AS `DecisionProba` UNION ALL SELECT 6 AS `node_id`, CAST(NULL AS STRING) AS `feature`, CAST(NULL AS FLOAT) AS `threshold`, 2 AS `count`, 4 AS `depth`, 5 AS `parent_id`, 0.0 AS `Proba_CLASS_0`, -1.79769313486231e+308 AS `LogProba_CLASS_0`, 0.0 AS `Proba_CLASS_1`, -1.79769313486231e+308 AS `LogProba_CLASS_1`, 1.0 AS `Proba_CLASS_2`, 0.0 AS `LogProba_CLASS_2`, 'CLASS_2' AS `Decision`, 1.0 AS `DecisionProba` UNION ALL SELECT 7 AS `node_id`, CAST(NULL AS STRING) AS `feature`, CAST(NULL AS FLOAT) AS `threshold`, 1 AS `count`, 4 AS `depth`, 5 AS `parent_id`, 0.0 AS `Proba_CLASS_0`, -1.79769313486231e+308 AS `LogProba_CLASS_0`, 1.0 AS `Proba_CLASS_1`, 0.0 AS `LogProba_CLASS_1`, 0.0 AS `Proba_CLASS_2`, -1.79769313486231e+308 AS `LogProba_CLASS_2`, 'CLASS_1' AS `Decision`, 1.0 AS `DecisionProba` UNION ALL SELECT 11 AS `node_id`, CAST(NULL AS STRING) AS `feature`, CAST(NULL AS FLOAT) AS `threshold`, 1 AS `count`, 5 AS `depth`, 10 AS `parent_id`, 0.0 AS `Proba_CLASS_0`, -1.79769313486231e+308 AS `LogProba_CLASS_0`, 0.0 AS `Proba_CLASS_1`, -1.79769313486231e+308 AS `LogProba_CLASS_1`, 1.0 AS `Proba_CLASS_2`, 0.0 AS `LogProba_CLASS_2`, 'CLASS_2' AS `Decision`, 1.0 AS `DecisionProba` UNION ALL SELECT 12 AS `node_id`, CAST(NULL AS STRING) AS `feature`, CAST(NULL AS FLOAT) AS `threshold`, 3 AS `count`, 5 AS `depth`, 10 AS `parent_id`, 0.0 AS `Proba_CLASS_0`, -1.79769313486231e+308 AS `LogProba_CLASS_0`, 1.0 AS `Proba_CLASS_1`, 0.0 AS `LogProba_CLASS_1`, 0.0 AS `Proba_CLASS_2`, -1.79769313486231e+308 AS `LogProba_CLASS_2`, 'CLASS_1' AS `Decision`, 1.0 AS `DecisionProba` UNION ALL SELECT 13 AS `node_id`, CAST(NULL AS STRING) AS `feature`, CAST(NULL AS FLOAT) AS `threshold`, 3 AS `count`, 4 AS `depth`, 9 AS `parent_id`, 0.0 AS `Proba_CLASS_0`, -1.79769313486231e+308 AS `LogProba_CLASS_0`, 0.0 AS `Proba_CLASS_1`, -1.79769313486231e+308 AS `LogProba_CLASS_1`, 1.0 AS `Proba_CLASS_2`, 0.0 AS `LogProba_CLASS_2`, 'CLASS_2' AS `Decision`, 1.0 AS `DecisionProba` UNION ALL SELECT 14 AS `node_id`, CAST(NULL AS STRING) AS `feature`, CAST(NULL AS FLOAT) AS `threshold`, 37 AS `count`, 3 AS `depth`, 8 AS `parent_id`, 0.0 AS `Proba_CLASS_0`, -1.79769313486231e+308 AS `LogProba_CLASS_0`, 0.0 AS `Proba_CLASS_1`, -1.79769313486231e+308 AS `LogProba_CLASS_1`, 1.0 AS `Proba_CLASS_2`, 0.0 AS `LogProba_CLASS_2`, 'CLASS_2' AS `Decision`, 1.0 AS `DecisionProba`) AS `Values`), 
`DT_Output` AS 
