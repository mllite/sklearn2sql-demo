...
-- Code For temporary table ##TMP_20180417042601_KAOXZU_ADS_imp_1_OUT part 1/2. Create 


CREATE TABLE ##TMP_20180417042601_KAOXZU_ADS_imp_1_OUT (
	[KEY] BIGINT NULL, 
...
-- Code For temporary table ##TMP_20180417042601_KAOXZU_ADS_imp_1_OUT part 2/2. Populate

INSERT INTO ##TMP_20180417042601_KAOXZU_ADS_imp_1_OUT ([KEY], imputer_output_2, imputer_output_3, imputer_output_4, imputer_output_5) SELECT [ADS_imp_1_OUT].[KEY], [ADS_imp_1_OUT].imputer_output_2, [ADS_imp_1_OUT].imputer_output_3, [ADS_imp_1_OUT].imputer_output_4, [ADS_imp_1_OUT].imputer_output_5 
...
-- Code For temporary table ##TMP_20180417042601_N49VG0_ADS_sca_2_OUT part 1/2. Create 


CREATE TABLE ##TMP_20180417042601_N49VG0_ADS_sca_2_OUT (
	[KEY] BIGINT NULL, 
...
-- Code For temporary table ##TMP_20180417042601_N49VG0_ADS_sca_2_OUT part 2/2. Populate

INSERT INTO ##TMP_20180417042601_N49VG0_ADS_sca_2_OUT ([KEY], scaler_output_2, scaler_output_3, scaler_output_4, scaler_output_5) SELECT [ADS_sca_2_OUT].[KEY], [ADS_sca_2_OUT].scaler_output_2, [ADS_sca_2_OUT].scaler_output_3, [ADS_sca_2_OUT].scaler_output_4, [ADS_sca_2_OUT].scaler_output_5 
...
FROM ##TMP_20180417042601_KAOXZU_ADS_imp_1_OUT AS [ADS_imp_1_OUT]) AS [ADS_sca_2_OUT]
...
FROM ##TMP_20180417042601_N49VG0_ADS_sca_2_OUT AS [ADS_sca_2_OUT]), 
[DT_node_data] AS 
(SELECT [Values].node_id AS node_id, CAST([Values].feature AS FLOAT(53)) AS feature, CAST([Values].threshold AS FLOAT(53)) AS threshold, CAST([Values].count AS FLOAT(53)) AS count, CAST([Values].depth AS FLOAT(53)) AS depth, CAST([Values].parent_id AS FLOAT(53)) AS parent_id, CAST([Values].[Proba_1789-07-14T00:00:00.000000000] AS FLOAT(53)) AS [Proba_1789-07-14T00:00:00.000000000], CAST([Values].[LogProba_1789-07-14T00:00:00.000000000] AS FLOAT(53)) AS [LogProba_1789-07-14T00:00:00.000000000], CAST([Values].[Proba_1789-08-14T00:00:00.000000000] AS FLOAT(53)) AS [Proba_1789-08-14T00:00:00.000000000], CAST([Values].[LogProba_1789-08-14T00:00:00.000000000] AS FLOAT(53)) AS [LogProba_1789-08-14T00:00:00.000000000], CAST([Values].[Proba_1789-09-14T00:00:00.000000000] AS FLOAT(53)) AS [Proba_1789-09-14T00:00:00.000000000], CAST([Values].[LogProba_1789-09-14T00:00:00.000000000] AS FLOAT(53)) AS [LogProba_1789-09-14T00:00:00.000000000], CAST([Values].[Decision] AS FLOAT(53)) AS [Decision], CAST([Values].[DecisionProba] AS FLOAT(53)) AS [DecisionProba] 
FROM (SELECT 1 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 37 AS count, 1 AS depth, 0 AS parent_id, 1.0 AS [Proba_1789-07-14T00:00:00.000000000], 0.0 AS [LogProba_1789-07-14T00:00:00.000000000], 0.0 AS [Proba_1789-08-14T00:00:00.000000000], -1.79769313486231e+308 AS [LogProba_1789-08-14T00:00:00.000000000], 0.0 AS [Proba_1789-09-14T00:00:00.000000000], -1.79769313486231e+308 AS [LogProba_1789-09-14T00:00:00.000000000], '1789-07-14T00:00:00.000000000' AS [Decision], 1.0 AS [DecisionProba] UNION ALL SELECT 4 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 36 AS count, 3 AS depth, 3 AS parent_id, 0.0 AS [Proba_1789-07-14T00:00:00.000000000], -1.79769313486231e+308 AS [LogProba_1789-07-14T00:00:00.000000000], 1.0 AS [Proba_1789-08-14T00:00:00.000000000], 0.0 AS [LogProba_1789-08-14T00:00:00.000000000], 0.0 AS [Proba_1789-09-14T00:00:00.000000000], -1.79769313486231e+308 AS [LogProba_1789-09-14T00:00:00.000000000], '1789-08-14T00:00:00.000000000' AS [Decision], 1.0 AS [DecisionProba] UNION ALL SELECT 6 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 2 AS count, 4 AS depth, 5 AS parent_id, 0.0 AS [Proba_1789-07-14T00:00:00.000000000], -1.79769313486231e+308 AS [LogProba_1789-07-14T00:00:00.000000000], 0.0 AS [Proba_1789-08-14T00:00:00.000000000], -1.79769313486231e+308 AS [LogProba_1789-08-14T00:00:00.000000000], 1.0 AS [Proba_1789-09-14T00:00:00.000000000], 0.0 AS [LogProba_1789-09-14T00:00:00.000000000], '1789-09-14T00:00:00.000000000' AS [Decision], 1.0 AS [DecisionProba] UNION ALL SELECT 7 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 1 AS count, 4 AS depth, 5 AS parent_id, 0.0 AS [Proba_1789-07-14T00:00:00.000000000], -1.79769313486231e+308 AS [LogProba_1789-07-14T00:00:00.000000000], 1.0 AS [Proba_1789-08-14T00:00:00.000000000], 0.0 AS [LogProba_1789-08-14T00:00:00.000000000], 0.0 AS [Proba_1789-09-14T00:00:00.000000000], -1.79769313486231e+308 AS [LogProba_1789-09-14T00:00:00.000000000], '1789-08-14T00:00:00.000000000' AS [Decision], 1.0 AS [DecisionProba] UNION ALL SELECT 11 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 1 AS count, 5 AS depth, 10 AS parent_id, 0.0 AS [Proba_1789-07-14T00:00:00.000000000], -1.79769313486231e+308 AS [LogProba_1789-07-14T00:00:00.000000000], 0.0 AS [Proba_1789-08-14T00:00:00.000000000], -1.79769313486231e+308 AS [LogProba_1789-08-14T00:00:00.000000000], 1.0 AS [Proba_1789-09-14T00:00:00.000000000], 0.0 AS [LogProba_1789-09-14T00:00:00.000000000], '1789-09-14T00:00:00.000000000' AS [Decision], 1.0 AS [DecisionProba] UNION ALL SELECT 12 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS count, 5 AS depth, 10 AS parent_id, 0.0 AS [Proba_1789-07-14T00:00:00.000000000], -1.79769313486231e+308 AS [LogProba_1789-07-14T00:00:00.000000000], 1.0 AS [Proba_1789-08-14T00:00:00.000000000], 0.0 AS [LogProba_1789-08-14T00:00:00.000000000], 0.0 AS [Proba_1789-09-14T00:00:00.000000000], -1.79769313486231e+308 AS [LogProba_1789-09-14T00:00:00.000000000], '1789-08-14T00:00:00.000000000' AS [Decision], 1.0 AS [DecisionProba] UNION ALL SELECT 13 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS count, 4 AS depth, 9 AS parent_id, 0.0 AS [Proba_1789-07-14T00:00:00.000000000], -1.79769313486231e+308 AS [LogProba_1789-07-14T00:00:00.000000000], 0.0 AS [Proba_1789-08-14T00:00:00.000000000], -1.79769313486231e+308 AS [LogProba_1789-08-14T00:00:00.000000000], 1.0 AS [Proba_1789-09-14T00:00:00.000000000], 0.0 AS [LogProba_1789-09-14T00:00:00.000000000], '1789-09-14T00:00:00.000000000' AS [Decision], 1.0 AS [DecisionProba] UNION ALL SELECT 14 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 37 AS count, 3 AS depth, 8 AS parent_id, 0.0 AS [Proba_1789-07-14T00:00:00.000000000], -1.79769313486231e+308 AS [LogProba_1789-07-14T00:00:00.000000000], 0.0 AS [Proba_1789-08-14T00:00:00.000000000], -1.79769313486231e+308 AS [LogProba_1789-08-14T00:00:00.000000000], 1.0 AS [Proba_1789-09-14T00:00:00.000000000], 0.0 AS [LogProba_1789-09-14T00:00:00.000000000], '1789-09-14T00:00:00.000000000' AS [Decision], 1.0 AS [DecisionProba]) AS [Values]), 
[DT_Output] AS 
