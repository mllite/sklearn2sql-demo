...
-- Code For temporary table tmp_20180417042126_buwx3g_ads_ part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180417042126_buwx3g_ads_  (
	"KEY" BIGINT, 
...
-- Code For temporary table tmp_20180417042126_buwx3g_ads_ part 2/2. Populate

INSERT INTO tmp_20180417042126_buwx3g_ads_ ("KEY", imputer_output_2, imputer_output_3, imputer_output_4, imputer_output_5) SELECT "U"."KEY", "U".imputer_output_2, "U".imputer_output_3, "U".imputer_output_4, "U".imputer_output_5 
...
-- Code For temporary table tmp_20180417042127_s86iaj_ads_ part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180417042127_s86iaj_ads_  (
	"KEY" BIGINT, 
...
-- Code For temporary table tmp_20180417042127_s86iaj_ads_ part 2/2. Populate

INSERT INTO tmp_20180417042127_s86iaj_ads_ ("KEY", scaler_output_2, scaler_output_3, scaler_output_4, scaler_output_5) SELECT "U"."KEY", "U".scaler_output_2, "U".scaler_output_3, "U".scaler_output_4, "U".scaler_output_5 
...
FROM tmp_20180417042126_buwx3g_ads_ AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT") AS "U"
...
FROM tmp_20180417042127_s86iaj_ads_ AS "ADS_sca_2_OUT"), 
"DT_node_data" AS 
...
FROM (SELECT 1 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT) AS "threshold", 37 AS "count", 1 AS depth, 0 AS parent_id, 1.0 AS "Proba_0", 0.0 AS "LogProba_0", 0.0 AS "Proba_1", -1.79769313486231e+308 AS "LogProba_1", 0.0 AS "Proba_2", -1.79769313486231e+308 AS "LogProba_2", 0 AS "Decision", 1.0 AS "DecisionProba" 
