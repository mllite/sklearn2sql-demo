...
-- Code For temporary table tmp_20180416233039_o27lhj_ads_ part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180416233039_o27lhj_ads_  (
	"KEY" BIGINT, 
	impter_2 FLOAT, 
	impter_3 FLOAT, 
	impter_4 FLOAT, 
...
-- Code For temporary table tmp_20180416233039_o27lhj_ads_ part 2/2. Populate

INSERT INTO tmp_20180416233039_o27lhj_ads_ ("KEY", impter_2, impter_3, impter_4, impter_5, impter_6, impter_7, impter_8, impter_9, impter_10, impter_11) SELECT "U"."KEY", "U".impter_2, "U".impter_3, "U".impter_4, "U".impter_5, "U".impter_6, "U".impter_7, "U".impter_8, "U".impter_9, "U".impter_10, "U".impter_11 
...
-- Code For temporary table tmp_20180416233039_ybf729_ads_ part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180416233039_ybf729_ads_  (
	"KEY" BIGINT, 
	scaler_2 FLOAT, 
	scaler_3 FLOAT, 
	scaler_4 FLOAT, 
...
-- Code For temporary table tmp_20180416233039_ybf729_ads_ part 2/2. Populate

INSERT INTO tmp_20180416233039_ybf729_ads_ ("KEY", scaler_2, scaler_3, scaler_4, scaler_5, scaler_6, scaler_7, scaler_8, scaler_9, scaler_10, scaler_11) SELECT "U"."KEY", "U".scaler_2, "U".scaler_3, "U".scaler_4, "U".scaler_5, "U".scaler_6, "U".scaler_7, "U".scaler_8, "U".scaler_9, "U".scaler_10, "U".scaler_11 
...
FROM tmp_20180416233039_o27lhj_ads_ AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT") AS "U"

-- Model deployment code

WITH "DT_node_lookup" AS 
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", CASE WHEN ("ADS_sca_2_OUT".scaler_5 <= -0.057175017893314) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_5 <= -1.091533422470093) THEN 2 ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_6 <= 0.055714450776577) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_2 <= 0.666355133056641) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_3 <= -0.717765927314758) THEN 6 ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_2 <= -1.836770176887512) THEN 8 ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_4 <= -1.298542737960816) THEN 10 ELSE 11 END END END ELSE 12 END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_4 <= -1.725775718688965) THEN 14 ELSE 15 END END END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_9 <= 0.13469922542572) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_6 <= 0.161496639251709) THEN 18 ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_9 <= -0.047089215368032) THEN 20 ELSE 21 END END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_10 <= 0.885828495025635) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_5 <= 0.318128287792206) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_8 <= -0.232108145952225) THEN 25 ELSE 26 END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_9 <= 1.948196649551392) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_10 <= 0.274374336004257) THEN 29 ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_10 <= 0.492200374603272) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_11 <= -0.660323739051819) THEN 32 ELSE 33 END ELSE 34 END END ELSE 35 END END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_6 <= -1.350844621658325) THEN 37 ELSE 38 END END END END AS node_id_2 
FROM tmp_20180416233039_ybf729_ads_ AS "ADS_sca_2_OUT"), 
"DT_node_data" AS 
