...
-- Code For temporary table ##TMP_20180416231521_LVOVUB_ADS_imp_1_OUT part 1/2. Create 


CREATE TABLE ##TMP_20180416231521_LVOVUB_ADS_imp_1_OUT (
	[KEY] BIGINT NULL, 
...
-- Code For temporary table ##TMP_20180416231521_XIMI3A_ADS_sca_2_OUT part 1/2. Create 


CREATE TABLE ##TMP_20180416231521_XIMI3A_ADS_sca_2_OUT (
	[KEY] BIGINT NULL, 
	scaler_2 FLOAT NULL, 
	scaler_3 FLOAT NULL, 
	scaler_4 FLOAT NULL, 
...
FROM ##TMP_20180416231521_LVOVUB_ADS_imp_1_OUT AS [ADS_imp_1_OUT]) AS [ADS_sca_2_OUT]

-- Code For temporary table ##TMP_20180416231521_BM6NRT_CalProb_B0 part 1/2. Create 


CREATE TABLE ##TMP_20180416231521_BM6NRT_CalProb_B0 (
	[KEY] BIGINT NULL, 
	[Proba_1] FLOAT NULL, 
	[Proba_0] FLOAT NULL
)
...
-- Code For temporary table ##TMP_20180416231521_BM6NRT_CalProb_B0 part 2/2. Populate
...
FROM ##TMP_20180416231521_XIMI3A_ADS_sca_2_OUT AS [ADS_sca_2_OUT]), 
[DT_node_data] AS 
...
(SELECT [Calibrated_Model_0].[KEY] AS [KEY], 1.0 / (1.0 + exp(CASE WHEN (CASE WHEN (-100.0 <= -(5.756413424714996 * [Calibrated_Model_0].[ScoreOrProba_1] + -2.5569469411985817)) THEN -(5.756413424714996 * [Calibrated_Model_0].[ScoreOrProba_1] + -2.5569469411985817) ELSE -100.0 END <= 100.0) THEN CASE WHEN (-100.0 <= -(5.756413424714996 * [Calibrated_Model_0].[ScoreOrProba_1] + -2.5569469411985817)) THEN -(5.756413424714996 * [Calibrated_Model_0].[ScoreOrProba_1] + -2.5569469411985817) ELSE -100.0 END ELSE 100.0 END)) AS [Proba_1], 1.0 - 1.0 / (1.0 + exp(CASE WHEN (CASE WHEN (-100.0 <= -(5.756413424714996 * [Calibrated_Model_0].[ScoreOrProba_1] + -2.5569469411985817)) THEN -(5.756413424714996 * [Calibrated_Model_0].[ScoreOrProba_1] + -2.5569469411985817) ELSE -100.0 END <= 100.0) THEN CASE WHEN (-100.0 <= -(5.756413424714996 * [Calibrated_Model_0].[ScoreOrProba_1] + -2.5569469411985817)) THEN -(5.756413424714996 * [Calibrated_Model_0].[ScoreOrProba_1] + -2.5569469411985817) ELSE -100.0 END ELSE 100.0 END)) AS [Proba_0] 
...
(SELECT [Calibrated_Model_1].[KEY] AS [KEY], 1.0 / (1.0 + exp(CASE WHEN (CASE WHEN (-100.0 <= -(4.6995923736239025 * [Calibrated_Model_1].[ScoreOrProba_1] + -1.924211076199023)) THEN -(4.6995923736239025 * [Calibrated_Model_1].[ScoreOrProba_1] + -1.924211076199023) ELSE -100.0 END <= 100.0) THEN CASE WHEN (-100.0 <= -(4.6995923736239025 * [Calibrated_Model_1].[ScoreOrProba_1] + -1.924211076199023)) THEN -(4.6995923736239025 * [Calibrated_Model_1].[ScoreOrProba_1] + -1.924211076199023) ELSE -100.0 END ELSE 100.0 END)) AS [Proba_1], 1.0 - 1.0 / (1.0 + exp(CASE WHEN (CASE WHEN (-100.0 <= -(4.6995923736239025 * [Calibrated_Model_1].[ScoreOrProba_1] + -1.924211076199023)) THEN -(4.6995923736239025 * [Calibrated_Model_1].[ScoreOrProba_1] + -1.924211076199023) ELSE -100.0 END <= 100.0) THEN CASE WHEN (-100.0 <= -(4.6995923736239025 * [Calibrated_Model_1].[ScoreOrProba_1] + -1.924211076199023)) THEN -(4.6995923736239025 * [Calibrated_Model_1].[ScoreOrProba_1] + -1.924211076199023) ELSE -100.0 END ELSE 100.0 END)) AS [Proba_0] 
...
[DT_node_data_2] AS 
(SELECT [Values].node_id AS node_id, CAST([Values].feature AS FLOAT(53)) AS feature, CAST([Values].threshold AS FLOAT(53)) AS threshold, CAST([Values].count AS FLOAT(53)) AS count, CAST([Values].depth AS FLOAT(53)) AS depth, CAST([Values].parent_id AS FLOAT(53)) AS parent_id, CAST([Values].[Proba_0] AS FLOAT(53)) AS [Proba_0], CAST([Values].[LogProba_0] AS FLOAT(53)) AS [LogProba_0], CAST([Values].[Proba_1] AS FLOAT(53)) AS [Proba_1], CAST([Values].[LogProba_1] AS FLOAT(53)) AS [LogProba_1], CAST([Values].[Decision] AS FLOAT(53)) AS [Decision], CAST([Values].[DecisionProba] AS FLOAT(53)) AS [DecisionProba] 
FROM (SELECT 4 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 197 AS count, 4 AS depth, 3 AS parent_id, 0.0 AS [Proba_0], -1.79769313486231e+308 AS [LogProba_0], 1.0 AS [Proba_1], 0.0 AS [LogProba_1], 1 AS [Decision], 1.0 AS [DecisionProba] UNION ALL SELECT 6 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 15 AS count, 5 AS depth, 5 AS parent_id, 0.06666666666666667 AS [Proba_0], -2.70805020110221 AS [LogProba_0], 0.9333333333333333 AS [Proba_1], -0.06899287148695143 AS [LogProba_1], 1 AS [Decision], 0.9333333333333333 AS [DecisionProba] UNION ALL SELECT 7 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 4 AS count, 5 AS depth, 5 AS parent_id, 0.75 AS [Proba_0], -0.2876820724517809 AS [LogProba_0], 0.25 AS [Proba_1], -1.3862943611198906 AS [LogProba_1], 0 AS [Decision], 0.75 AS [DecisionProba] UNION ALL SELECT 9 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 2 AS count, 4 AS depth, 8 AS parent_id, 0.0 AS [Proba_0], -1.79769313486231e+308 AS [LogProba_0], 1.0 AS [Proba_1], 0.0 AS [LogProba_1], 1 AS [Decision], 1.0 AS [DecisionProba] UNION ALL SELECT 11 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 1 AS count, 5 AS depth, 10 AS parent_id, 0.0 AS [Proba_0], -1.79769313486231e+308 AS [LogProba_0], 1.0 AS [Proba_1], 0.0 AS [LogProba_1], 1 AS [Decision], 1.0 AS [DecisionProba] UNION ALL SELECT 12 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS count, 5 AS depth, 10 AS parent_id, 1.0 AS [Proba_0], 0.0 AS [LogProba_0], 0.0 AS [Proba_1], -1.79769313486231e+308 AS [LogProba_1], 0 AS [Decision], 1.0 AS [DecisionProba] UNION ALL SELECT 13 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 9 AS count, 2 AS depth, 1 AS parent_id, 1.0 AS [Proba_0], 0.0 AS [LogProba_0], 0.0 AS [Proba_1], -1.79769313486231e+308 AS [LogProba_1], 0 AS [Decision], 1.0 AS [DecisionProba] UNION ALL SELECT 16 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 1 AS count, 3 AS depth, 15 AS parent_id, 0.0 AS [Proba_0], -1.79769313486231e+308 AS [LogProba_0], 1.0 AS [Proba_1], 0.0 AS [LogProba_1], 1 AS [Decision], 1.0 AS [DecisionProba] UNION ALL SELECT 19 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 1 AS count, 5 AS depth, 18 AS parent_id, 0.0 AS [Proba_0], -1.79769313486231e+308 AS [LogProba_0], 1.0 AS [Proba_1], 0.0 AS [LogProba_1], 1 AS [Decision], 1.0 AS [DecisionProba] UNION ALL SELECT 20 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS count, 5 AS depth, 18 AS parent_id, 1.0 AS [Proba_0], 0.0 AS [LogProba_0], 0.0 AS [Proba_1], -1.79769313486231e+308 AS [LogProba_1], 0 AS [Decision], 1.0 AS [DecisionProba] UNION ALL SELECT 21 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 101 AS count, 4 AS depth, 17 AS parent_id, 1.0 AS [Proba_0], 0.0 AS [LogProba_0], 0.0 AS [Proba_1], -1.79769313486231e+308 AS [LogProba_1], 0 AS [Decision], 1.0 AS [DecisionProba] UNION ALL SELECT 22 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 4 AS count, 2 AS depth, 14 AS parent_id, 0.0 AS [Proba_0], -1.79769313486231e+308 AS [LogProba_0], 1.0 AS [Proba_1], 0.0 AS [LogProba_1], 1 AS [Decision], 1.0 AS [DecisionProba]) AS [Values]), 
[DT_Output_2] AS 
...
(SELECT [Calibrated_Model_2].[KEY] AS [KEY], 1.0 / (1.0 + exp(CASE WHEN (CASE WHEN (-100.0 <= -(5.460676238424658 * [Calibrated_Model_2].[ScoreOrProba_1] + -2.260905500780578)) THEN -(5.460676238424658 * [Calibrated_Model_2].[ScoreOrProba_1] + -2.260905500780578) ELSE -100.0 END <= 100.0) THEN CASE WHEN (-100.0 <= -(5.460676238424658 * [Calibrated_Model_2].[ScoreOrProba_1] + -2.260905500780578)) THEN -(5.460676238424658 * [Calibrated_Model_2].[ScoreOrProba_1] + -2.260905500780578) ELSE -100.0 END ELSE 100.0 END)) AS [Proba_1], 1.0 - 1.0 / (1.0 + exp(CASE WHEN (CASE WHEN (-100.0 <= -(5.460676238424658 * [Calibrated_Model_2].[ScoreOrProba_1] + -2.260905500780578)) THEN -(5.460676238424658 * [Calibrated_Model_2].[ScoreOrProba_1] + -2.260905500780578) ELSE -100.0 END <= 100.0) THEN CASE WHEN (-100.0 <= -(5.460676238424658 * [Calibrated_Model_2].[ScoreOrProba_1] + -2.260905500780578)) THEN -(5.460676238424658 * [Calibrated_Model_2].[ScoreOrProba_1] + -2.260905500780578) ELSE -100.0 END ELSE 100.0 END)) AS [Proba_0] 
...
[DT_node_data_3] AS 
(SELECT [Values].node_id AS node_id, CAST([Values].feature AS FLOAT(53)) AS feature, CAST([Values].threshold AS FLOAT(53)) AS threshold, CAST([Values].count AS FLOAT(53)) AS count, CAST([Values].depth AS FLOAT(53)) AS depth, CAST([Values].parent_id AS FLOAT(53)) AS parent_id, CAST([Values].[Proba_0] AS FLOAT(53)) AS [Proba_0], CAST([Values].[LogProba_0] AS FLOAT(53)) AS [LogProba_0], CAST([Values].[Proba_1] AS FLOAT(53)) AS [Proba_1], CAST([Values].[LogProba_1] AS FLOAT(53)) AS [LogProba_1], CAST([Values].[Decision] AS FLOAT(53)) AS [Decision], CAST([Values].[DecisionProba] AS FLOAT(53)) AS [DecisionProba] 
FROM (SELECT 4 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 2 AS count, 4 AS depth, 3 AS parent_id, 1.0 AS [Proba_0], 0.0 AS [LogProba_0], 0.0 AS [Proba_1], -1.79769313486231e+308 AS [LogProba_1], 0 AS [Decision], 1.0 AS [DecisionProba] UNION ALL SELECT 5 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 1 AS count, 4 AS depth, 3 AS parent_id, 0.0 AS [Proba_0], -1.79769313486231e+308 AS [LogProba_0], 1.0 AS [Proba_1], 0.0 AS [LogProba_1], 1 AS [Decision], 1.0 AS [DecisionProba] UNION ALL SELECT 7 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 197 AS count, 4 AS depth, 6 AS parent_id, 0.0 AS [Proba_0], -1.79769313486231e+308 AS [LogProba_0], 1.0 AS [Proba_1], 0.0 AS [LogProba_1], 1 AS [Decision], 1.0 AS [DecisionProba] UNION ALL SELECT 9 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 21 AS count, 5 AS depth, 8 AS parent_id, 0.047619047619047616 AS [Proba_0], -3.044522437723423 AS [LogProba_0], 0.9523809523809523 AS [Proba_1], -0.048790164169432056 AS [LogProba_1], 1 AS [Decision], 0.9523809523809523 AS [DecisionProba] UNION ALL SELECT 10 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 2 AS count, 5 AS depth, 8 AS parent_id, 1.0 AS [Proba_0], 0.0 AS [LogProba_0], 0.0 AS [Proba_1], -1.79769313486231e+308 AS [LogProba_1], 0 AS [Decision], 1.0 AS [DecisionProba] UNION ALL SELECT 11 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 9 AS count, 2 AS depth, 1 AS parent_id, 1.0 AS [Proba_0], 0.0 AS [LogProba_0], 0.0 AS [Proba_1], -1.79769313486231e+308 AS [LogProba_1], 0 AS [Decision], 1.0 AS [DecisionProba] UNION ALL SELECT 14 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 1 AS count, 3 AS depth, 13 AS parent_id, 0.0 AS [Proba_0], -1.79769313486231e+308 AS [LogProba_0], 1.0 AS [Proba_1], 0.0 AS [LogProba_1], 1 AS [Decision], 1.0 AS [DecisionProba] UNION ALL SELECT 15 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 106 AS count, 3 AS depth, 13 AS parent_id, 1.0 AS [Proba_0], 0.0 AS [LogProba_0], 0.0 AS [Proba_1], -1.79769313486231e+308 AS [LogProba_1], 0 AS [Decision], 1.0 AS [DecisionProba] UNION ALL SELECT 16 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS count, 2 AS depth, 12 AS parent_id, 0.0 AS [Proba_0], -1.79769313486231e+308 AS [LogProba_0], 1.0 AS [Proba_1], 0.0 AS [LogProba_1], 1 AS [Decision], 1.0 AS [DecisionProba]) AS [Values]), 
[DT_Output_3] AS 
...
(SELECT [Calibrated_Model_3].[KEY] AS [KEY], 1.0 / (1.0 + exp(CASE WHEN (CASE WHEN (-100.0 <= -(4.949259195511301 * [Calibrated_Model_3].[ScoreOrProba_1] + -2.0321952231560854)) THEN -(4.949259195511301 * [Calibrated_Model_3].[ScoreOrProba_1] + -2.0321952231560854) ELSE -100.0 END <= 100.0) THEN CASE WHEN (-100.0 <= -(4.949259195511301 * [Calibrated_Model_3].[ScoreOrProba_1] + -2.0321952231560854)) THEN -(4.949259195511301 * [Calibrated_Model_3].[ScoreOrProba_1] + -2.0321952231560854) ELSE -100.0 END ELSE 100.0 END)) AS [Proba_1], 1.0 - 1.0 / (1.0 + exp(CASE WHEN (CASE WHEN (-100.0 <= -(4.949259195511301 * [Calibrated_Model_3].[ScoreOrProba_1] + -2.0321952231560854)) THEN -(4.949259195511301 * [Calibrated_Model_3].[ScoreOrProba_1] + -2.0321952231560854) ELSE -100.0 END <= 100.0) THEN CASE WHEN (-100.0 <= -(4.949259195511301 * [Calibrated_Model_3].[ScoreOrProba_1] + -2.0321952231560854)) THEN -(4.949259195511301 * [Calibrated_Model_3].[ScoreOrProba_1] + -2.0321952231560854) ELSE -100.0 END ELSE 100.0 END)) AS [Proba_0] 
...
FROM sigmoid_calibration_3)
 INSERT INTO ##TMP_20180416231521_BM6NRT_CalProb_B0 ([KEY], [Proba_1], [Proba_0]) SELECT [CalProb_B0].[KEY], [CalProb_B0].[Proba_1], [CalProb_B0].[Proba_0] 
...
-- Code For temporary table ##TMP_20180416231521_REFPMW_CalProb_Union part 1/2. Create 


CREATE TABLE ##TMP_20180416231521_REFPMW_CalProb_Union (
	[KEY] BIGINT NULL, 
	[Proba_1] FLOAT NULL, 
	[Proba_0] FLOAT NULL
)
...
-- Code For temporary table ##TMP_20180416231521_REFPMW_CalProb_Union part 2/2. Populate

INSERT INTO ##TMP_20180416231521_REFPMW_CalProb_Union ([KEY], [Proba_1], [Proba_0]) SELECT [CalProb_Union].[KEY], [CalProb_Union].[Proba_1], [CalProb_Union].[Proba_0] 
...
FROM ##TMP_20180416231521_BM6NRT_CalProb_B0 AS [CalProb_B0]) AS [CalProb_EnsembleUnion]) AS [CalProb_Union]

-- Code For temporary table ##TMP_20180416231521_53ZQBH_CalProb_avg part 1/2. Create 


CREATE TABLE ##TMP_20180416231521_53ZQBH_CalProb_avg (
	[KEY] BIGINT NULL, 
...
-- Code For temporary table ##TMP_20180416231521_53ZQBH_CalProb_avg part 2/2. Populate

INSERT INTO ##TMP_20180416231521_53ZQBH_CalProb_avg ([KEY], [Proba_1], [Proba_0]) SELECT [CalProb_avg].[KEY], [CalProb_avg].[Proba_1], [CalProb_avg].[Proba_0] 
...
FROM ##TMP_20180416231521_REFPMW_CalProb_Union AS [CalProb_Union] GROUP BY [CalProb_Union].[KEY]) AS [T]) AS [CalProb_avg]
...
FROM ##TMP_20180416231521_53ZQBH_CalProb_avg AS [CalProb_avg]), 
