...
-- Code For temporary table tmp_20180417042046_uqlg5p_ads_ part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180417042046_uqlg5p_ads_  (
	"KEY" BIGINT, 
...
-- Code For temporary table tmp_20180417042046_uqlg5p_ads_ part 2/2. Populate

INSERT INTO tmp_20180417042046_uqlg5p_ads_ ("KEY", imputer_output_2, imputer_output_3, imputer_output_4, imputer_output_5) SELECT "U"."KEY", "U".imputer_output_2, "U".imputer_output_3, "U".imputer_output_4, "U".imputer_output_5 
...
-- Code For temporary table tmp_20180417042046_05m8qz_ads_ part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180417042046_05m8qz_ads_  (
	"KEY" BIGINT, 
...
-- Code For temporary table tmp_20180417042046_05m8qz_ads_ part 2/2. Populate

INSERT INTO tmp_20180417042046_05m8qz_ads_ ("KEY", scaler_output_2, scaler_output_3, scaler_output_4, scaler_output_5) SELECT "U"."KEY", "U".scaler_output_2, "U".scaler_output_3, "U".scaler_output_4, "U".scaler_output_5 
...
FROM tmp_20180417042046_uqlg5p_ads_ AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT") AS "U"

-- Code For temporary table tmp_20180417042046_a92pkg_calp part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180417042046_a92pkg_calp  (
	"KEY" BIGINT, 
	"Proba_0" FLOAT, 
	"Proba_1" FLOAT, 
	"Proba_2" FLOAT
...
-- Code For temporary table tmp_20180417042046_a92pkg_calp part 2/2. Populate

INSERT INTO tmp_20180417042046_a92pkg_calp ("KEY", "Proba_0", "Proba_1", "Proba_2") SELECT "U"."KEY", "U"."Proba_0", "U"."Proba_1", "U"."Proba_2" 
...
FROM tmp_20180417042046_05m8qz_ads_ AS "ADS_sca_2_OUT"), 
"DT_node_data" AS 
...
-- Code For temporary table tmp_20180417042046_x81b0o_calp part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180417042046_x81b0o_calp  (
	"KEY" BIGINT, 
	"Proba_0" FLOAT, 
	"Proba_1" FLOAT, 
	"Proba_2" FLOAT
...
-- Code For temporary table tmp_20180417042046_x81b0o_calp part 2/2. Populate

INSERT INTO tmp_20180417042046_x81b0o_calp ("KEY", "Proba_0", "Proba_1", "Proba_2") SELECT "U"."KEY", "U"."Proba_0", "U"."Proba_1", "U"."Proba_2" 
...
FROM tmp_20180417042046_a92pkg_calp AS "CalProb_B0") AS "CalProb_EnsembleUnion") AS "CalProb_Union") AS "U"

-- Code For temporary table tmp_20180417042046_994mzy_calp part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180417042046_994mzy_calp  (
	"KEY" BIGINT, 
	"Proba_0" FLOAT, 
	"Proba_1" FLOAT, 
	"Proba_2" FLOAT
...
-- Code For temporary table tmp_20180417042046_994mzy_calp part 2/2. Populate

INSERT INTO tmp_20180417042046_994mzy_calp ("KEY", "Proba_0", "Proba_1", "Proba_2") SELECT "U"."KEY", "U"."Proba_0", "U"."Proba_1", "U"."Proba_2" 
...
FROM tmp_20180417042046_x81b0o_calp AS "CalProb_Union" GROUP BY "CalProb_Union"."KEY") AS "T") AS "CalProb_avg") AS "U"
...
FROM tmp_20180417042046_994mzy_calp AS "CalProb_avg"), 
