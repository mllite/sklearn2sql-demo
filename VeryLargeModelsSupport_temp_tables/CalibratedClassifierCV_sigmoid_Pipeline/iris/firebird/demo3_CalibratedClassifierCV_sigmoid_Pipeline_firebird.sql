...
-- Code For temporary table TMP_20180417042046_I26977_ADS_I part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180417042046_I26977_ADS_I" (
	"KEY" BIGINT, 
...
-- Code For temporary table TMP_20180417042046_I26977_ADS_I part 2/2. Populate

INSERT INTO "TMP_20180417042046_I26977_ADS_I" ("KEY", imputer_output_2, imputer_output_3, imputer_output_4, imputer_output_5) SELECT "U"."KEY", "U".imputer_output_2, "U".imputer_output_3, "U".imputer_output_4, "U".imputer_output_5 
...
-- Code For temporary table TMP_20180417042046_EJAFTX_ADS_S part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180417042046_EJAFTX_ADS_S" (
	"KEY" BIGINT, 
...
-- Code For temporary table TMP_20180417042046_EJAFTX_ADS_S part 2/2. Populate

INSERT INTO "TMP_20180417042046_EJAFTX_ADS_S" ("KEY", scaler_output_2, scaler_output_3, scaler_output_4, scaler_output_5) SELECT "U"."KEY", "U".scaler_output_2, "U".scaler_output_3, "U".scaler_output_4, "U".scaler_output_5 
...
FROM "TMP_20180417042046_I26977_ADS_I" AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT") AS "U"

-- Code For temporary table TMP_20180417042046_TX55RT_CALPR part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180417042046_TX55RT_CALPR" (
	"KEY" BIGINT, 
	"Proba_0" FLOAT, 
	"Proba_1" FLOAT, 
	"Proba_2" FLOAT
...
-- Code For temporary table TMP_20180417042046_TX55RT_CALPR part 2/2. Populate

INSERT INTO "TMP_20180417042046_TX55RT_CALPR" ("KEY", "Proba_0", "Proba_1", "Proba_2") SELECT "U"."KEY", "U"."Proba_0", "U"."Proba_1", "U"."Proba_2" 
...
FROM "TMP_20180417042046_EJAFTX_ADS_S" AS "ADS_sca_2_OUT"), 
"DT_node_data" AS 
...
(SELECT "Calibrated_Model_0"."KEY" AS "KEY", 1.0 / (1.0 + exp(CASE WHEN (minvalue(maxvalue(-100.0, -(5.488937334779731 * "Calibrated_Model_0"."ScoreOrProba_0" + -3.0910424939613868)), 100.0) >= -709.782712893384) THEN minvalue(maxvalue(-100.0, -(5.488937334779731 * "Calibrated_Model_0"."ScoreOrProba_0" + -3.0910424939613868)), 100.0) ELSE -709.782712893384 END)) AS "Proba_0", 1.0 / (1.0 + exp(CASE WHEN (minvalue(maxvalue(-100.0, -(4.718121478468529 * "Calibrated_Model_0"."ScoreOrProba_1" + -2.95244363385918)), 100.0) >= -709.782712893384) THEN minvalue(maxvalue(-100.0, -(4.718121478468529 * "Calibrated_Model_0"."ScoreOrProba_1" + -2.95244363385918)), 100.0) ELSE -709.782712893384 END)) AS "Proba_1", 1.0 / (1.0 + exp(CASE WHEN (minvalue(maxvalue(-100.0, -(4.801955584523639 * "Calibrated_Model_0"."ScoreOrProba_2" + -2.4323200933644706)), 100.0) >= -709.782712893384) THEN minvalue(maxvalue(-100.0, -(4.801955584523639 * "Calibrated_Model_0"."ScoreOrProba_2" + -2.4323200933644706)), 100.0) ELSE -709.782712893384 END)) AS "Proba_2" 
...
(SELECT "Calibrated_Model_1"."KEY" AS "KEY", 1.0 / (1.0 + exp(CASE WHEN (minvalue(maxvalue(-100.0, -(5.393626322122635 * "Calibrated_Model_1"."ScoreOrProba_0" + -3.091045517303994)), 100.0) >= -709.782712893384) THEN minvalue(maxvalue(-100.0, -(5.393626322122635 * "Calibrated_Model_1"."ScoreOrProba_0" + -3.091045517303994)), 100.0) ELSE -709.782712893384 END)) AS "Proba_0", 1.0 / (1.0 + exp(CASE WHEN (minvalue(maxvalue(-100.0, -(5.442417342523719 * "Calibrated_Model_1"."ScoreOrProba_1" + -3.0445224878196573)), 100.0) >= -709.782712893384) THEN minvalue(maxvalue(-100.0, -(5.442417342523719 * "Calibrated_Model_1"."ScoreOrProba_1" + -3.0445224878196573)), 100.0) ELSE -709.782712893384 END)) AS "Proba_1", 1.0 / (1.0 + exp(CASE WHEN (minvalue(maxvalue(-100.0, -(5.480638259777759 * "Calibrated_Model_1"."ScoreOrProba_2" + -2.995732594243071)), 100.0) >= -709.782712893384) THEN minvalue(maxvalue(-100.0, -(5.480638259777759 * "Calibrated_Model_1"."ScoreOrProba_2" + -2.995732594243071)), 100.0) ELSE -709.782712893384 END)) AS "Proba_2" 
...
(SELECT "DT_Output_2"."KEY" AS "KEY", CAST(NULL AS FLOAT) AS "Score_0", CAST(NULL AS FLOAT) AS "Score_1", CAST(NULL AS FLOAT) AS "Score_2", "DT_Output_2"."Proba_0" AS "Proba_0", "DT_Output_2"."Proba_1" AS "Proba_1", "DT_Output_2"."Proba_2" AS "Proba_2", "DT_Output_2"."LogProba_0" AS "LogProba_0", "DT_Output_2"."LogProba_1" AS "LogProba_1", "DT_Output_2"."LogProba_2" AS "LogProba_2", CAST(NULL AS BIGINT) AS "Decision", CAST(NULL AS FLOAT) AS "DecisionProba", coalesce(CAST(NULL AS FLOAT), "DT_Output_2"."Proba_0") AS "ScoreOrProba_0", coalesce(CAST(NULL AS FLOAT), "DT_Output_2"."Proba_1") AS "ScoreOrProba_1", coalesce(CAST(NULL AS FLOAT), "DT_Output_2"."Proba_2") AS "ScoreOrProba_2" 
FROM "DT_Output_2"), 
sigmoid_calibration_2 AS 
(SELECT "Calibrated_Model_2"."KEY" AS "KEY", 1.0 / (1.0 + exp(CASE WHEN (minvalue(maxvalue(-100.0, -(5.393626322122635 * "Calibrated_Model_2"."ScoreOrProba_0" + -3.091045517303994)), 100.0) >= -709.782712893384) THEN minvalue(maxvalue(-100.0, -(5.393626322122635 * "Calibrated_Model_2"."ScoreOrProba_0" + -3.091045517303994)), 100.0) ELSE -709.782712893384 END)) AS "Proba_0", 1.0 / (1.0 + exp(CASE WHEN (minvalue(maxvalue(-100.0, -(4.346958263204309 * "Calibrated_Model_2"."ScoreOrProba_1" + -1.949062502016408)), 100.0) >= -709.782712893384) THEN minvalue(maxvalue(-100.0, -(4.346958263204309 * "Calibrated_Model_2"."ScoreOrProba_1" + -1.949062502016408)), 100.0) ELSE -709.782712893384 END)) AS "Proba_1", 1.0 / (1.0 + exp(CASE WHEN (minvalue(maxvalue(-100.0, -(4.310987825487246 * "Calibrated_Model_2"."ScoreOrProba_2" + -2.995735836256492)), 100.0) >= -709.782712893384) THEN minvalue(maxvalue(-100.0, -(4.310987825487246 * "Calibrated_Model_2"."ScoreOrProba_2" + -2.995735836256492)), 100.0) ELSE -709.782712893384 END)) AS "Proba_2" 
...
"DT_node_data_3" AS 
(SELECT "Values".node_id AS node_id, CAST("Values".feature AS FLOAT) AS feature, CAST("Values".threshold AS FLOAT) AS threshold, CAST("Values"."count" AS FLOAT) AS "count", CAST("Values".depth AS FLOAT) AS depth, CAST("Values".parent_id AS FLOAT) AS parent_id, CAST("Values"."Proba_0" AS FLOAT) AS "Proba_0", CAST("Values"."LogProba_0" AS FLOAT) AS "LogProba_0", CAST("Values"."Proba_1" AS FLOAT) AS "Proba_1", CAST("Values"."LogProba_1" AS FLOAT) AS "LogProba_1", CAST("Values"."Proba_2" AS FLOAT) AS "Proba_2", CAST("Values"."LogProba_2" AS FLOAT) AS "LogProba_2", CAST("Values"."Decision" AS FLOAT) AS "Decision", CAST("Values"."DecisionProba" AS FLOAT) AS "DecisionProba" 
FROM (SELECT 1 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT) AS threshold, 28 AS "count", 1 AS depth, 0 AS parent_id, 1.0 AS "Proba_0", 0.0 AS "LogProba_0", 0.0 AS "Proba_1", -1e+20 AS "LogProba_1", 0.0 AS "Proba_2", -1e+20 AS "LogProba_2", 0 AS "Decision", 1.0 AS "DecisionProba" FROM rdb$database UNION ALL SELECT 4 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT) AS threshold, 28 AS "count", 3 AS depth, 3 AS parent_id, 0.0 AS "Proba_0", -1e+20 AS "LogProba_0", 1.0 AS "Proba_1", 0.0 AS "LogProba_1", 0.0 AS "Proba_2", -1e+20 AS "LogProba_2", 1 AS "Decision", 1.0 AS "DecisionProba" FROM rdb$database UNION ALL SELECT 6 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT) AS threshold, 2 AS "count", 4 AS depth, 5 AS parent_id, 0.0 AS "Proba_0", -1e+20 AS "LogProba_0", 0.0 AS "Proba_1", -1e+20 AS "LogProba_1", 1.0 AS "Proba_2", 0.0 AS "LogProba_2", 2 AS "Decision", 1.0 AS "DecisionProba" FROM rdb$database UNION ALL SELECT 7 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT) AS threshold, 1 AS "count", 4 AS depth, 5 AS parent_id, 0.0 AS "Proba_0", -1e+20 AS "LogProba_0", 1.0 AS "Proba_1", 0.0 AS "LogProba_1", 0.0 AS "Proba_2", -1e+20 AS "LogProba_2", 1 AS "Decision", 1.0 AS "DecisionProba" FROM rdb$database UNION ALL SELECT 10 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT) AS threshold, 1 AS "count", 4 AS depth, 9 AS parent_id, 0.0 AS "Proba_0", -1e+20 AS "LogProba_0", 1.0 AS "Proba_1", 0.0 AS "LogProba_1", 0.0 AS "Proba_2", -1e+20 AS "LogProba_2", 1 AS "Decision", 1.0 AS "DecisionProba" FROM rdb$database UNION ALL SELECT 11 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT) AS threshold, 2 AS "count", 4 AS depth, 9 AS parent_id, 0.0 AS "Proba_0", -1e+20 AS "LogProba_0", 0.0 AS "Proba_1", -1e+20 AS "LogProba_1", 1.0 AS "Proba_2", 0.0 AS "LogProba_2", 2 AS "Decision", 1.0 AS "DecisionProba" FROM rdb$database UNION ALL SELECT 12 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT) AS threshold, 29 AS "count", 3 AS depth, 8 AS parent_id, 0.0 AS "Proba_0", -1e+20 AS "LogProba_0", 0.0 AS "Proba_1", -1e+20 AS "LogProba_1", 1.0 AS "Proba_2", 0.0 AS "LogProba_2", 2 AS "Decision", 1.0 AS "DecisionProba" FROM rdb$database) AS "Values"), 
"DT_Output_3" AS 
...
(SELECT "DT_Output_3"."KEY" AS "KEY", CAST(NULL AS FLOAT) AS "Score_0", CAST(NULL AS FLOAT) AS "Score_1", CAST(NULL AS FLOAT) AS "Score_2", "DT_Output_3"."Proba_0" AS "Proba_0", "DT_Output_3"."Proba_1" AS "Proba_1", "DT_Output_3"."Proba_2" AS "Proba_2", "DT_Output_3"."LogProba_0" AS "LogProba_0", "DT_Output_3"."LogProba_1" AS "LogProba_1", "DT_Output_3"."LogProba_2" AS "LogProba_2", CAST(NULL AS BIGINT) AS "Decision", CAST(NULL AS FLOAT) AS "DecisionProba", coalesce(CAST(NULL AS FLOAT), "DT_Output_3"."Proba_0") AS "ScoreOrProba_0", coalesce(CAST(NULL AS FLOAT), "DT_Output_3"."Proba_1") AS "ScoreOrProba_1", coalesce(CAST(NULL AS FLOAT), "DT_Output_3"."Proba_2") AS "ScoreOrProba_2" 
FROM "DT_Output_3"), 
sigmoid_calibration_3 AS 
(SELECT "Calibrated_Model_3"."KEY" AS "KEY", 1.0 / (1.0 + exp(CASE WHEN (minvalue(maxvalue(-100.0, -(5.3471066241328655 * "Calibrated_Model_3"."ScoreOrProba_0" + -3.0445258104151054)), 100.0) >= -709.782712893384) THEN minvalue(maxvalue(-100.0, -(5.3471066241328655 * "Calibrated_Model_3"."ScoreOrProba_0" + -3.0445258104151054)), 100.0) ELSE -709.782712893384 END)) AS "Proba_0", 1.0 / (1.0 + exp(CASE WHEN (minvalue(maxvalue(-100.0, -(4.295450701778823 * "Calibrated_Model_3"."ScoreOrProba_1" + -1.8975549276218453)), 100.0) >= -709.782712893384) THEN minvalue(maxvalue(-100.0, -(4.295450701778823 * "Calibrated_Model_3"."ScoreOrProba_1" + -1.8975549276218453)), 100.0) ELSE -709.782712893384 END)) AS "Proba_1", 1.0 / (1.0 + exp(CASE WHEN (minvalue(maxvalue(-100.0, -(4.214379795150796 * "Calibrated_Model_3"."ScoreOrProba_2" + -2.99573366824266)), 100.0) >= -709.782712893384) THEN minvalue(maxvalue(-100.0, -(4.214379795150796 * "Calibrated_Model_3"."ScoreOrProba_2" + -2.99573366824266)), 100.0) ELSE -709.782712893384 END)) AS "Proba_2" 
...
-- Code For temporary table TMP_20180417042046_0PNR0H_CALPR part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180417042046_0PNR0H_CALPR" (
	"KEY" BIGINT, 
	"Proba_0" FLOAT, 
	"Proba_1" FLOAT, 
	"Proba_2" FLOAT
...
-- Code For temporary table TMP_20180417042046_0PNR0H_CALPR part 2/2. Populate

INSERT INTO "TMP_20180417042046_0PNR0H_CALPR" ("KEY", "Proba_0", "Proba_1", "Proba_2") SELECT "U"."KEY", "U"."Proba_0", "U"."Proba_1", "U"."Proba_2" 
...
FROM "TMP_20180417042046_TX55RT_CALPR" AS "CalProb_B0") AS "CalProb_EnsembleUnion") AS "CalProb_Union") AS "U"

-- Code For temporary table TMP_20180417042046_ZBJTKK_CALPR part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180417042046_ZBJTKK_CALPR" (
	"KEY" BIGINT, 
	"Proba_0" FLOAT, 
	"Proba_1" FLOAT, 
	"Proba_2" FLOAT
...
-- Code For temporary table TMP_20180417042046_ZBJTKK_CALPR part 2/2. Populate

INSERT INTO "TMP_20180417042046_ZBJTKK_CALPR" ("KEY", "Proba_0", "Proba_1", "Proba_2") SELECT "U"."KEY", "U"."Proba_0", "U"."Proba_1", "U"."Proba_2" 
...
FROM "TMP_20180417042046_0PNR0H_CALPR" AS "CalProb_Union" GROUP BY "CalProb_Union"."KEY") AS "T") AS "CalProb_avg") AS "U"
...
FROM "TMP_20180417042046_ZBJTKK_CALPR" AS "CalProb_avg"), 
