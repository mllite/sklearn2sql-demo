...
-- Code For temporary table TMP_20180416223058_B4CCZ9_ADS_I part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180416223058_B4CCZ9_ADS_I" (
	"KEY" BIGINT, 
	impter_2 FLOAT, 
	impter_3 FLOAT, 
	impter_4 FLOAT, 
...
-- Code For temporary table TMP_20180416223059_NC8SSU_ADS_S part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180416223059_NC8SSU_ADS_S" (
	"KEY" BIGINT, 
	scaler_2 FLOAT, 
	scaler_3 FLOAT, 
	scaler_4 FLOAT, 
...
FROM "TMP_20180416223058_B4CCZ9_ADS_I" AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT") AS "U"

-- Code For temporary table TMP_20180416223059_6INKBQ_CALPR part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180416223059_6INKBQ_CALPR" (
	"KEY" BIGINT, 
	"Proba_1" FLOAT, 
	"Proba_0" FLOAT
)
...
-- Code For temporary table TMP_20180416223059_6INKBQ_CALPR part 2/2. Populate

INSERT INTO "TMP_20180416223059_6INKBQ_CALPR" ("KEY", "Proba_1", "Proba_0") SELECT "U"."KEY", "U"."Proba_1", "U"."Proba_0" 
...
FROM "TMP_20180416223059_NC8SSU_ADS_S" AS "ADS_sca_2_OUT"), 
"DT_node_data" AS 
...
-- Code For temporary table TMP_20180416223059_9I3DDO_CALPR part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180416223059_9I3DDO_CALPR" (
	"KEY" BIGINT, 
	"Proba_1" FLOAT, 
	"Proba_0" FLOAT
)
...
-- Code For temporary table TMP_20180416223059_9I3DDO_CALPR part 2/2. Populate

INSERT INTO "TMP_20180416223059_9I3DDO_CALPR" ("KEY", "Proba_1", "Proba_0") SELECT "U"."KEY", "U"."Proba_1", "U"."Proba_0" 
...
FROM "TMP_20180416223059_6INKBQ_CALPR" AS "CalProb_B0") AS "CalProb_EnsembleUnion") AS "CalProb_Union") AS "U"

-- Code For temporary table TMP_20180416223059_FOSWU9_CALPR part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180416223059_FOSWU9_CALPR" (
	"KEY" BIGINT, 
	"Proba_1" FLOAT, 
	"Proba_0" FLOAT
)
...
-- Code For temporary table TMP_20180416223059_FOSWU9_CALPR part 2/2. Populate

INSERT INTO "TMP_20180416223059_FOSWU9_CALPR" ("KEY", "Proba_1", "Proba_0") SELECT "U"."KEY", "U"."Proba_1", "U"."Proba_0" 
...
FROM "TMP_20180416223059_9I3DDO_CALPR" AS "CalProb_Union" GROUP BY "CalProb_Union"."KEY") AS "T") AS "CalProb_avg") AS "U"
...
FROM "TMP_20180416223059_FOSWU9_CALPR" AS "CalProb_avg"), 
