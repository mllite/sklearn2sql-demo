...
-- Code For temporary table ##TMP_20180416223058_R2099O_ADS_imp_1_OUT part 1/2. Create 


CREATE TABLE ##TMP_20180416223058_R2099O_ADS_imp_1_OUT (
	[KEY] BIGINT NULL, 
...
-- Code For temporary table ##TMP_20180416223058_NDJ7YJ_ADS_sca_2_OUT part 1/2. Create 


CREATE TABLE ##TMP_20180416223058_NDJ7YJ_ADS_sca_2_OUT (
	[KEY] BIGINT NULL, 
	scaler_2 FLOAT NULL, 
	scaler_3 FLOAT NULL, 
	scaler_4 FLOAT NULL, 
...
FROM ##TMP_20180416223058_R2099O_ADS_imp_1_OUT AS [ADS_imp_1_OUT]) AS [ADS_sca_2_OUT]

-- Code For temporary table ##TMP_20180416223058_JQNC54_CalProb_B0 part 1/2. Create 


CREATE TABLE ##TMP_20180416223058_JQNC54_CalProb_B0 (
	[KEY] BIGINT NULL, 
	[Proba_1] FLOAT NULL, 
	[Proba_0] FLOAT NULL
)
...
-- Code For temporary table ##TMP_20180416223058_JQNC54_CalProb_B0 part 2/2. Populate
...
FROM ##TMP_20180416223058_NDJ7YJ_ADS_sca_2_OUT AS [ADS_sca_2_OUT]), 
[DT_node_data] AS 
...
(SELECT [Calibrated_Model_0].[KEY] AS [KEY], 1.0 / (1.0 + exp(CASE WHEN (CASE WHEN (-100.0 <= -(2.302343680054423 * [Calibrated_Model_0].[ScoreOrProba_1] + -1.2105553273631793)) THEN -(2.302343680054423 * [Calibrated_Model_0].[ScoreOrProba_1] + -1.2105553273631793) ELSE -100.0 END <= 100.0) THEN CASE WHEN (-100.0 <= -(2.302343680054423 * [Calibrated_Model_0].[ScoreOrProba_1] + -1.2105553273631793)) THEN -(2.302343680054423 * [Calibrated_Model_0].[ScoreOrProba_1] + -1.2105553273631793) ELSE -100.0 END ELSE 100.0 END)) AS [Proba_1], 1.0 - 1.0 / (1.0 + exp(CASE WHEN (CASE WHEN (-100.0 <= -(2.302343680054423 * [Calibrated_Model_0].[ScoreOrProba_1] + -1.2105553273631793)) THEN -(2.302343680054423 * [Calibrated_Model_0].[ScoreOrProba_1] + -1.2105553273631793) ELSE -100.0 END <= 100.0) THEN CASE WHEN (-100.0 <= -(2.302343680054423 * [Calibrated_Model_0].[ScoreOrProba_1] + -1.2105553273631793)) THEN -(2.302343680054423 * [Calibrated_Model_0].[ScoreOrProba_1] + -1.2105553273631793) ELSE -100.0 END ELSE 100.0 END)) AS [Proba_0] 
...
[DT_node_data_1] AS 
(SELECT [Values].node_id AS node_id, CAST([Values].feature AS FLOAT(53)) AS feature, CAST([Values].threshold AS FLOAT(53)) AS threshold, CAST([Values].count AS FLOAT(53)) AS count, CAST([Values].depth AS FLOAT(53)) AS depth, CAST([Values].parent_id AS FLOAT(53)) AS parent_id, CAST([Values].[Proba_0] AS FLOAT(53)) AS [Proba_0], CAST([Values].[LogProba_0] AS FLOAT(53)) AS [LogProba_0], CAST([Values].[Proba_1] AS FLOAT(53)) AS [Proba_1], CAST([Values].[LogProba_1] AS FLOAT(53)) AS [LogProba_1], CAST([Values].[Decision] AS FLOAT(53)) AS [Decision], CAST([Values].[DecisionProba] AS FLOAT(53)) AS [DecisionProba] 
FROM (SELECT 4 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 1 AS count, 4 AS depth, 3 AS parent_id, 0.0 AS [Proba_0], -1.79769313486231e+308 AS [LogProba_0], 1.0 AS [Proba_1], 0.0 AS [LogProba_1], 1 AS [Decision], 1.0 AS [DecisionProba] UNION ALL SELECT 5 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 28 AS count, 4 AS depth, 3 AS parent_id, 1.0 AS [Proba_0], 0.0 AS [LogProba_0], 0.0 AS [Proba_1], -1.79769313486231e+308 AS [LogProba_1], 0 AS [Decision], 1.0 AS [DecisionProba] UNION ALL SELECT 7 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 2 AS count, 4 AS depth, 6 AS parent_id, 0.0 AS [Proba_0], -1.79769313486231e+308 AS [LogProba_0], 1.0 AS [Proba_1], 0.0 AS [LogProba_1], 1 AS [Decision], 1.0 AS [DecisionProba] UNION ALL SELECT 8 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 1 AS count, 4 AS depth, 6 AS parent_id, 1.0 AS [Proba_0], 0.0 AS [LogProba_0], 0.0 AS [Proba_1], -1.79769313486231e+308 AS [LogProba_1], 0 AS [Decision], 1.0 AS [DecisionProba] UNION ALL SELECT 10 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 1 AS count, 3 AS depth, 9 AS parent_id, 1.0 AS [Proba_0], 0.0 AS [LogProba_0], 0.0 AS [Proba_1], -1.79769313486231e+308 AS [LogProba_1], 0 AS [Decision], 1.0 AS [DecisionProba] UNION ALL SELECT 11 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS count, 3 AS depth, 9 AS parent_id, 0.0 AS [Proba_0], -1.79769313486231e+308 AS [LogProba_0], 1.0 AS [Proba_1], 0.0 AS [LogProba_1], 1 AS [Decision], 1.0 AS [DecisionProba] UNION ALL SELECT 13 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 22 AS count, 2 AS depth, 12 AS parent_id, 0.0 AS [Proba_0], -1.79769313486231e+308 AS [LogProba_0], 1.0 AS [Proba_1], 0.0 AS [LogProba_1], 1 AS [Decision], 1.0 AS [DecisionProba] UNION ALL SELECT 14 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 1 AS count, 2 AS depth, 12 AS parent_id, 1.0 AS [Proba_0], 0.0 AS [LogProba_0], 0.0 AS [Proba_1], -1.79769313486231e+308 AS [LogProba_1], 0 AS [Decision], 1.0 AS [DecisionProba]) AS [Values]), 
[DT_Output_1] AS 
...
(SELECT [Calibrated_Model_1].[KEY] AS [KEY], 1.0 / (1.0 + exp(CASE WHEN (CASE WHEN (-100.0 <= -(3.314062182700888 * [Calibrated_Model_1].[ScoreOrProba_1] + -1.709231943724962)) THEN -(3.314062182700888 * [Calibrated_Model_1].[ScoreOrProba_1] + -1.709231943724962) ELSE -100.0 END <= 100.0) THEN CASE WHEN (-100.0 <= -(3.314062182700888 * [Calibrated_Model_1].[ScoreOrProba_1] + -1.709231943724962)) THEN -(3.314062182700888 * [Calibrated_Model_1].[ScoreOrProba_1] + -1.709231943724962) ELSE -100.0 END ELSE 100.0 END)) AS [Proba_1], 1.0 - 1.0 / (1.0 + exp(CASE WHEN (CASE WHEN (-100.0 <= -(3.314062182700888 * [Calibrated_Model_1].[ScoreOrProba_1] + -1.709231943724962)) THEN -(3.314062182700888 * [Calibrated_Model_1].[ScoreOrProba_1] + -1.709231943724962) ELSE -100.0 END <= 100.0) THEN CASE WHEN (-100.0 <= -(3.314062182700888 * [Calibrated_Model_1].[ScoreOrProba_1] + -1.709231943724962)) THEN -(3.314062182700888 * [Calibrated_Model_1].[ScoreOrProba_1] + -1.709231943724962) ELSE -100.0 END ELSE 100.0 END)) AS [Proba_0] 
...
(SELECT [Calibrated_Model_2].[KEY] AS [KEY], 1.0 / (1.0 + exp(CASE WHEN (CASE WHEN (-100.0 <= -(2.079068705462255 * [Calibrated_Model_2].[ScoreOrProba_1] + -1.106710373017934)) THEN -(2.079068705462255 * [Calibrated_Model_2].[ScoreOrProba_1] + -1.106710373017934) ELSE -100.0 END <= 100.0) THEN CASE WHEN (-100.0 <= -(2.079068705462255 * [Calibrated_Model_2].[ScoreOrProba_1] + -1.106710373017934)) THEN -(2.079068705462255 * [Calibrated_Model_2].[ScoreOrProba_1] + -1.106710373017934) ELSE -100.0 END ELSE 100.0 END)) AS [Proba_1], 1.0 - 1.0 / (1.0 + exp(CASE WHEN (CASE WHEN (-100.0 <= -(2.079068705462255 * [Calibrated_Model_2].[ScoreOrProba_1] + -1.106710373017934)) THEN -(2.079068705462255 * [Calibrated_Model_2].[ScoreOrProba_1] + -1.106710373017934) ELSE -100.0 END <= 100.0) THEN CASE WHEN (-100.0 <= -(2.079068705462255 * [Calibrated_Model_2].[ScoreOrProba_1] + -1.106710373017934)) THEN -(2.079068705462255 * [Calibrated_Model_2].[ScoreOrProba_1] + -1.106710373017934) ELSE -100.0 END ELSE 100.0 END)) AS [Proba_0] 
...
(SELECT [Calibrated_Model_3].[KEY] AS [KEY], 1.0 / (1.0 + exp(CASE WHEN (CASE WHEN (-100.0 <= -(2.244245371482823 * [Calibrated_Model_3].[ScoreOrProba_1] + -1.472565828440728)) THEN -(2.244245371482823 * [Calibrated_Model_3].[ScoreOrProba_1] + -1.472565828440728) ELSE -100.0 END <= 100.0) THEN CASE WHEN (-100.0 <= -(2.244245371482823 * [Calibrated_Model_3].[ScoreOrProba_1] + -1.472565828440728)) THEN -(2.244245371482823 * [Calibrated_Model_3].[ScoreOrProba_1] + -1.472565828440728) ELSE -100.0 END ELSE 100.0 END)) AS [Proba_1], 1.0 - 1.0 / (1.0 + exp(CASE WHEN (CASE WHEN (-100.0 <= -(2.244245371482823 * [Calibrated_Model_3].[ScoreOrProba_1] + -1.472565828440728)) THEN -(2.244245371482823 * [Calibrated_Model_3].[ScoreOrProba_1] + -1.472565828440728) ELSE -100.0 END <= 100.0) THEN CASE WHEN (-100.0 <= -(2.244245371482823 * [Calibrated_Model_3].[ScoreOrProba_1] + -1.472565828440728)) THEN -(2.244245371482823 * [Calibrated_Model_3].[ScoreOrProba_1] + -1.472565828440728) ELSE -100.0 END ELSE 100.0 END)) AS [Proba_0] 
...
FROM sigmoid_calibration_3)
 INSERT INTO ##TMP_20180416223058_JQNC54_CalProb_B0 ([KEY], [Proba_1], [Proba_0]) SELECT [CalProb_B0].[KEY], [CalProb_B0].[Proba_1], [CalProb_B0].[Proba_0] 
...
-- Code For temporary table ##TMP_20180416223058_KERANE_CalProb_Union part 1/2. Create 


CREATE TABLE ##TMP_20180416223058_KERANE_CalProb_Union (
	[KEY] BIGINT NULL, 
	[Proba_1] FLOAT NULL, 
	[Proba_0] FLOAT NULL
)
...
-- Code For temporary table ##TMP_20180416223058_KERANE_CalProb_Union part 2/2. Populate

INSERT INTO ##TMP_20180416223058_KERANE_CalProb_Union ([KEY], [Proba_1], [Proba_0]) SELECT [CalProb_Union].[KEY], [CalProb_Union].[Proba_1], [CalProb_Union].[Proba_0] 
...
FROM ##TMP_20180416223058_JQNC54_CalProb_B0 AS [CalProb_B0]) AS [CalProb_EnsembleUnion]) AS [CalProb_Union]

-- Code For temporary table ##TMP_20180416223058_LEMDSR_CalProb_avg part 1/2. Create 


CREATE TABLE ##TMP_20180416223058_LEMDSR_CalProb_avg (
	[KEY] BIGINT NULL, 
...
-- Code For temporary table ##TMP_20180416223058_LEMDSR_CalProb_avg part 2/2. Populate

INSERT INTO ##TMP_20180416223058_LEMDSR_CalProb_avg ([KEY], [Proba_1], [Proba_0]) SELECT [CalProb_avg].[KEY], [CalProb_avg].[Proba_1], [CalProb_avg].[Proba_0] 
...
FROM ##TMP_20180416223058_KERANE_CalProb_Union AS [CalProb_Union] GROUP BY [CalProb_Union].[KEY]) AS [T]) AS [CalProb_avg]
...
FROM ##TMP_20180416223058_LEMDSR_CalProb_avg AS [CalProb_avg]), 
