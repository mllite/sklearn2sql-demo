...
-- Code For temporary table TMP_20180416223058_KWEEMC_ADS_imp_1_OUT part 1/2. Create 


CREATE TEMPORARY TABLE "TMP_20180416223058_KWEEMC_ADS_imp_1_OUT" (
	"KEY" BIGINT NOT NULL, 
	impter_2 FLOAT, 
	impter_3 FLOAT, 
	impter_4 FLOAT, 
...
-- Code For temporary table TMP_20180416223058_4X8Z05_ADS_sca_2_OUT part 1/2. Create 


CREATE TEMPORARY TABLE "TMP_20180416223058_4X8Z05_ADS_sca_2_OUT" (
	"KEY" BIGINT NOT NULL, 
	scaler_2 FLOAT, 
	scaler_3 FLOAT, 
	scaler_4 FLOAT, 
...
FROM "TMP_20180416223058_KWEEMC_ADS_imp_1_OUT" AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT"

-- Code For temporary table TMP_20180416223058_901OLA_CalProb_B0 part 1/2. Create 


CREATE TEMPORARY TABLE "TMP_20180416223058_901OLA_CalProb_B0" (
	"KEY" BIGINT, 
	"Proba_1" FLOAT, 
	"Proba_0" FLOAT
)
...
-- Code For temporary table TMP_20180416223058_901OLA_CalProb_B0 part 2/2. Populate
...
FROM "TMP_20180416223058_4X8Z05_ADS_sca_2_OUT" AS "ADS_sca_2_OUT"), 
"DT_node_data" AS 
...
(SELECT "Calibrated_Model_0"."KEY" AS "KEY", 1.0 / (1.0 + exp(min(max(-100.0, -(2.302343680054423 * "Calibrated_Model_0"."ScoreOrProba_1" + -1.2105553273631793)), 100.0))) AS "Proba_1", 1.0 - 1.0 / (1.0 + exp(min(max(-100.0, -(2.302343680054423 * "Calibrated_Model_0"."ScoreOrProba_1" + -1.2105553273631793)), 100.0))) AS "Proba_0" 
...
(SELECT "Calibrated_Model_1"."KEY" AS "KEY", 1.0 / (1.0 + exp(min(max(-100.0, -(3.314062182700888 * "Calibrated_Model_1"."ScoreOrProba_1" + -1.709231943724962)), 100.0))) AS "Proba_1", 1.0 - 1.0 / (1.0 + exp(min(max(-100.0, -(3.314062182700888 * "Calibrated_Model_1"."ScoreOrProba_1" + -1.709231943724962)), 100.0))) AS "Proba_0" 
...
(SELECT "Calibrated_Model_2"."KEY" AS "KEY", 1.0 / (1.0 + exp(min(max(-100.0, -(2.079068705462255 * "Calibrated_Model_2"."ScoreOrProba_1" + -1.106710373017934)), 100.0))) AS "Proba_1", 1.0 - 1.0 / (1.0 + exp(min(max(-100.0, -(2.079068705462255 * "Calibrated_Model_2"."ScoreOrProba_1" + -1.106710373017934)), 100.0))) AS "Proba_0" 
...
(SELECT "Calibrated_Model_3"."KEY" AS "KEY", 1.0 / (1.0 + exp(min(max(-100.0, -(2.244245371482823 * "Calibrated_Model_3"."ScoreOrProba_1" + -1.472565828440728)), 100.0))) AS "Proba_1", 1.0 - 1.0 / (1.0 + exp(min(max(-100.0, -(2.244245371482823 * "Calibrated_Model_3"."ScoreOrProba_1" + -1.472565828440728)), 100.0))) AS "Proba_0" 
...
FROM sigmoid_calibration_3)
 INSERT INTO "TMP_20180416223058_901OLA_CalProb_B0" ("KEY", "Proba_1", "Proba_0") SELECT "CalProb_B0"."KEY", "CalProb_B0"."Proba_1", "CalProb_B0"."Proba_0" 
...
-- Code For temporary table TMP_20180416223058_W36YGW_CalProb_Union part 1/2. Create 


CREATE TEMPORARY TABLE "TMP_20180416223058_W36YGW_CalProb_Union" (
	"KEY" BIGINT, 
	"Proba_1" FLOAT, 
	"Proba_0" FLOAT
)
...
-- Code For temporary table TMP_20180416223058_W36YGW_CalProb_Union part 2/2. Populate

INSERT INTO "TMP_20180416223058_W36YGW_CalProb_Union" ("KEY", "Proba_1", "Proba_0") SELECT "CalProb_Union"."KEY", "CalProb_Union"."Proba_1", "CalProb_Union"."Proba_0" 
...
FROM "TMP_20180416223058_901OLA_CalProb_B0" AS "CalProb_B0") AS "CalProb_EnsembleUnion") AS "CalProb_Union"

-- Code For temporary table TMP_20180416223058_Y53R9Y_CalProb_avg part 1/2. Create 


CREATE TEMPORARY TABLE "TMP_20180416223058_Y53R9Y_CalProb_avg" (
	"KEY" BIGINT NOT NULL, 
	"Proba_1" FLOAT, 
	"Proba_0" FLOAT, 
	PRIMARY KEY ("KEY")
...
-- Code For temporary table TMP_20180416223058_Y53R9Y_CalProb_avg part 2/2. Populate

INSERT INTO "TMP_20180416223058_Y53R9Y_CalProb_avg" ("KEY", "Proba_1", "Proba_0") SELECT "CalProb_avg"."KEY", "CalProb_avg"."Proba_1", "CalProb_avg"."Proba_0" 
...
FROM "TMP_20180416223058_W36YGW_CalProb_Union" AS "CalProb_Union" GROUP BY "CalProb_Union"."KEY") AS "T") AS "CalProb_avg"
...
FROM "TMP_20180416223058_Y53R9Y_CalProb_avg" AS "CalProb_avg"), 
