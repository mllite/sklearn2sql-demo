...
-- Code For temporary table tmp_20180417002024_z29env_ads_imp_1_out part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180417002024_z29env_ads_imp_1_out (
	"KEY" BIGINT, 
	impter_2 DOUBLE, 
	impter_3 DOUBLE, 
	impter_4 DOUBLE, 
...
-- Code For temporary table tmp_20180417002024_jv3727_ads_sca_2_out part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180417002024_jv3727_ads_sca_2_out (
	"KEY" BIGINT, 
	scaler_2 FLOAT, 
	scaler_3 FLOAT, 
	scaler_4 FLOAT, 
...
FROM tmp_20180417002024_z29env_ads_imp_1_out AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT"

-- Code For temporary table tmp_20180417002024_7owyj1_calprob_b0 part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180417002024_7owyj1_calprob_b0 (
	"KEY" BIGINT, 
	"Proba_0" DOUBLE, 
	"Proba_1" DOUBLE, 
	"Proba_2" DOUBLE, 
...
-- Code For temporary table tmp_20180417002024_7owyj1_calprob_b0 part 2/2. Populate

INSERT INTO tmp_20180417002024_7owyj1_calprob_b0 WITH "DT_node_lookup" AS 
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", CASE WHEN ("ADS_sca_2_OUT".scaler_20 <= 0.7499295473098755) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_251 <= 0.24379587173461914) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_479 <= 0.04622082784771919) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_458 <= -0.6727912425994873) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_370 <= -0.7000545859336853) THEN 5 ELSE 6 END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_210 <= 1.2913949489593506) THEN 8 ELSE 9 END END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_254 <= -1.1540367603302002) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_335 <= -0.4779128432273865) THEN 12 ELSE 13 END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_145 <= 0.0863872691988945) THEN 15 ELSE 16 END END END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_408 <= 0.09100764989852905) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_360 <= 0.32023119926452637) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_320 <= -0.8187143802642822) THEN 20 ELSE 21 END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_434 <= 1.7322666645050049) THEN 23 ELSE 24 END END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_200 <= -0.7635407447814941) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_379 <= 0.5111312866210938) THEN 27 ELSE 28 END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_337 <= -0.2663278579711914) THEN 30 ELSE 31 END END END END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_262 <= 1.3461663722991943) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_499 <= -0.7511270046234131) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_169 <= -0.4077262580394745) THEN 35 ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_122 <= 0.20328231155872345) THEN 37 ELSE 38 END END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_438 <= -0.8414123058319092) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_332 <= 0.4979507327079773) THEN 41 ELSE 42 END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_231 <= -1.1243606805801392) THEN 44 ELSE 45 END END END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_16 <= 0.057503096759319305) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_141 <= -1.0813555717468262) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_122 <= -1.0537327527999878) THEN 49 ELSE 50 END ELSE 51 END ELSE 52 END END END AS node_id_2 
FROM tmp_20180417002024_jv3727_ads_sca_2_out AS "ADS_sca_2_OUT"), 
"DT_node_data" AS 
(SELECT "Values".node_id AS node_id, CAST("Values".feature AS DOUBLE) AS feature, CAST("Values".threshold AS DOUBLE) AS threshold, CAST("Values"."count" AS DOUBLE) AS "count", CAST("Values".depth AS DOUBLE) AS depth, CAST("Values".parent_id AS DOUBLE) AS parent_id, CAST("Values"."Proba_0" AS DOUBLE) AS "Proba_0", CAST("Values"."LogProba_0" AS DOUBLE) AS "LogProba_0", CAST("Values"."Proba_1" AS DOUBLE) AS "Proba_1", CAST("Values"."LogProba_1" AS DOUBLE) AS "LogProba_1", CAST("Values"."Proba_2" AS DOUBLE) AS "Proba_2", CAST("Values"."LogProba_2" AS DOUBLE) AS "LogProba_2", CAST("Values"."Proba_3" AS DOUBLE) AS "Proba_3", CAST("Values"."LogProba_3" AS DOUBLE) AS "LogProba_3", CAST("Values"."Decision" AS DOUBLE) AS "Decision", CAST("Values"."DecisionProba" AS DOUBLE) AS "DecisionProba" 
FROM (SELECT 5 AS node_id, NULL AS feature, CAST(NULL AS DOUBLE) AS threshold, 10 AS "count", 5 AS depth, 4 AS parent_id, 0.8 AS "Proba_0", -0.2231435513142097 AS "LogProba_0", 0.0 AS "Proba_1", -1.79769313486231e+308 AS "LogProba_1", 0.0 AS "Proba_2", -1.79769313486231e+308 AS "LogProba_2", 0.2 AS "Proba_3", -1.6094379124341003 AS "LogProba_3", 0 AS "Decision", 0.8 AS "DecisionProba" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 6 AS node_id, NULL AS feature, CAST(NULL AS DOUBLE) AS threshold, 29 AS "count", 5 AS depth, 4 AS parent_id, 0.06896551724137931 AS "Proba_0", -2.6741486494265287 AS "LogProba_0", 0.2413793103448276 AS "Proba_1", -1.4213856809311607 AS "LogProba_1", 0.5517241379310345 AS "Proba_2", -0.5947071077466928 AS "LogProba_2", 0.13793103448275862 AS "Proba_3", -1.9810014688665833 AS "LogProba_3", 2 AS "Decision", 0.5517241379310345 AS "DecisionProba" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 8 AS node_id, NULL AS feature, CAST(NULL AS DOUBLE) AS threshold, 97 AS "count", 5 AS depth, 7 AS parent_id, 0.07216494845360824 AS "Proba_0", -2.62880082944807 AS "LogProba_0", 0.7010309278350515 AS "Proba_1", -0.3552032733272762 AS "LogProba_1", 0.12371134020618557 AS "Proba_2", -2.0898043287153825 AS "LogProba_2", 0.10309278350515463 AS "Proba_3", -2.2721258855093374 AS "LogProba_3", 1 AS "Decision", 0.7010309278350515 AS "DecisionProba" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 9 AS node_id, NULL AS feature, CAST(NULL AS DOUBLE) AS threshold, 10 AS "count", 5 AS depth, 7 AS parent_id, 0.1 AS "Proba_0", -2.3025850929940455 AS "LogProba_0", 0.1 AS "Proba_1", -2.3025850929940455 AS "LogProba_1", 0.2 AS "Proba_2", -1.6094379124341003 AS "LogProba_2", 0.6 AS "Proba_3", -0.5108256237659907 AS "LogProba_3", 3 AS "Decision", 0.6 AS "DecisionProba" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 12 AS node_id, NULL AS feature, CAST(NULL AS DOUBLE) AS threshold, 10 AS "count", 5 AS depth, 11 AS parent_id, 0.9 AS "Proba_0", -0.10536051565782628 AS "LogProba_0", 0.0 AS "Proba_1", -1.79769313486231e+308 AS "LogProba_1", 0.1 AS "Proba_2", -2.3025850929940455 AS "LogProba_2", 0.0 AS "Proba_3", -1.79769313486231e+308 AS "LogProba_3", 0 AS "Decision", 0.9 AS "DecisionProba" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 13 AS node_id, NULL AS feature, CAST(NULL AS DOUBLE) AS threshold, 14 AS "count", 5 AS depth, 11 AS parent_id, 0.21428571428571427 AS "Proba_0", -1.540445040947149 AS "LogProba_0", 0.14285714285714285 AS "Proba_1", -1.9459101490553135 AS "LogProba_1", 0.0 AS "Proba_2", -1.79769313486231e+308 AS "LogProba_2", 0.6428571428571429 AS "Proba_3", -0.4418327522790392 AS "LogProba_3", 3 AS "Decision", 0.6428571428571429 AS "DecisionProba" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 15 AS node_id, NULL AS feature, CAST(NULL AS DOUBLE) AS threshold, 67 AS "count", 5 AS depth, 14 AS parent_id, 0.13432835820895522 AS "Proba_0", -2.0074680420547466 AS "LogProba_0", 0.1791044776119403 AS "Proba_1", -1.7197859696029658 AS "LogProba_1", 0.5373134328358209 AS "Proba_2", -0.621173680934856 AS "LogProba_2", 0.14925373134328357 AS "Proba_3", -1.9021075263969205 AS "LogProba_3", 2 AS "Decision", 0.5373134328358209 AS "DecisionProba" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 16 AS node_id, NULL AS feature, CAST(NULL AS DOUBLE) AS threshold, 59 AS "count", 5 AS depth, 14 AS parent_id, 0.23728813559322035 AS "Proba_0", -1.4384801142904609 AS "LogProba_0", 0.3559322033898305 AS "Proba_1", -1.0330150061822965 AS "LogProba_1", 0.1864406779661017 AS "Proba_2", -1.6796421711073488 AS "LogProba_2", 0.22033898305084745 AS "Proba_3", -1.5125880864441827 AS "LogProba_3", 1 AS "Decision", 0.3559322033898305 AS "DecisionProba" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 20 AS node_id, NULL AS feature, CAST(NULL AS DOUBLE) AS threshold, 9 AS "count", 5 AS depth, 19 AS parent_id, 0.2222222222222222 AS "Proba_0", -1.5040773967762742 AS "LogProba_0", 0.1111111111111111 AS "Proba_1", -2.1972245773362196 AS "LogProba_1", 0.5555555555555556 AS "Proba_2", -0.587786664902119 AS "LogProba_2", 0.1111111111111111 AS "Proba_3", -2.1972245773362196 AS "LogProba_3", 2 AS "Decision", 0.5555555555555556 AS "DecisionProba" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 21 AS node_id, NULL AS feature, CAST(NULL AS DOUBLE) AS threshold, 32 AS "count", 5 AS depth, 19 AS parent_id, 0.875 AS "Proba_0", -0.13353139262452263 AS "LogProba_0", 0.03125 AS "Proba_1", -3.4657359027997265 AS "LogProba_1", 0.0625 AS "Proba_2", -2.772588722239781 AS "LogProba_2", 0.03125 AS "Proba_3", -3.4657359027997265 AS "LogProba_3", 0 AS "Decision", 0.875 AS "DecisionProba" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 23 AS node_id, NULL AS feature, CAST(NULL AS DOUBLE) AS threshold, 31 AS "count", 5 AS depth, 22 AS parent_id, 0.3870967741935484 AS "Proba_0", -0.9490805546971459 AS "LogProba_0", 0.06451612903225806 AS "Proba_1", -2.740840023925201 AS "LogProba_1", 0.16129032258064516 AS "Proba_2", -1.824549292051046 AS "LogProba_2", 0.3870967741935484 AS "Proba_3", -0.9490805546971459 AS "LogProba_3", 0 AS "Decision", 0.3870967741935484 AS "DecisionProba" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 24 AS node_id, NULL AS feature, CAST(NULL AS DOUBLE) AS threshold, 4 AS "count", 5 AS depth, 22 AS parent_id, 0.0 AS "Proba_0", -1.79769313486231e+308 AS "LogProba_0", 1.0 AS "Proba_1", 0.0 AS "LogProba_1", 0.0 AS "Proba_2", -1.79769313486231e+308 AS "LogProba_2", 0.0 AS "Proba_3", -1.79769313486231e+308 AS "LogProba_3", 1 AS "Decision", 1.0 AS "DecisionProba" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 27 AS node_id, NULL AS feature, CAST(NULL AS DOUBLE) AS threshold, 19 AS "count", 5 AS depth, 26 AS parent_id, 0.10526315789473684 AS "Proba_0", -2.2512917986064953 AS "LogProba_0", 0.0 AS "Proba_1", -1.79769313486231e+308 AS "LogProba_1", 0.8421052631578947 AS "Proba_2", -0.17185025692665928 AS "LogProba_2", 0.05263157894736842 AS "Proba_3", -2.9444389791664407 AS "LogProba_3", 2 AS "Decision", 0.8421052631578947 AS "DecisionProba" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 28 AS node_id, NULL AS feature, CAST(NULL AS DOUBLE) AS threshold, 9 AS "count", 5 AS depth, 26 AS parent_id, 0.2222222222222222 AS "Proba_0", -1.5040773967762742 AS "LogProba_0", 0.4444444444444444 AS "Proba_1", -0.8109302162163288 AS "LogProba_1", 0.1111111111111111 AS "Proba_2", -2.1972245773362196 AS "LogProba_2", 0.2222222222222222 AS "Proba_3", -1.5040773967762742 AS "LogProba_3", 1 AS "Decision", 0.4444444444444444 AS "DecisionProba" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 30 AS node_id, NULL AS feature, CAST(NULL AS DOUBLE) AS threshold, 27 AS "count", 5 AS depth, 29 AS parent_id, 0.4444444444444444 AS "Proba_0", -0.8109302162163288 AS "LogProba_0", 0.037037037037037035 AS "Proba_1", -3.295836866004329 AS "LogProba_1", 0.3333333333333333 AS "Proba_2", -1.0986122886681098 AS "LogProba_2", 0.18518518518518517 AS "Proba_3", -1.6863989535702288 AS "LogProba_3", 0 AS "Decision", 0.4444444444444444 AS "DecisionProba" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 31 AS node_id, NULL AS feature, CAST(NULL AS DOUBLE) AS threshold, 41 AS "count", 5 AS depth, 29 AS parent_id, 0.04878048780487805 AS "Proba_0", -3.0204248861443626 AS "LogProba_0", 0.2926829268292683 AS "Proba_1", -1.2286654169163076 AS "LogProba_1", 0.12195121951219512 AS "Proba_2", -2.1041341542702074 AS "LogProba_2", 0.5365853658536586 AS "Proba_3", -0.6225296133459919 AS "LogProba_3", 3 AS "Decision", 0.5365853658536586 AS "DecisionProba" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 35 AS node_id, NULL AS feature, CAST(NULL AS DOUBLE) AS threshold, 13 AS "count", 4 AS depth, 34 AS parent_id, 0.0 AS "Proba_0", -1.79769313486231e+308 AS "LogProba_0", 0.0 AS "Proba_1", -1.79769313486231e+308 AS "LogProba_1", 1.0 AS "Proba_2", 0.0 AS "LogProba_2", 0.0 AS "Proba_3", -1.79769313486231e+308 AS "LogProba_3", 2 AS "Decision", 1.0 AS "DecisionProba" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 37 AS node_id, NULL AS feature, CAST(NULL AS DOUBLE) AS threshold, 7 AS "count", 5 AS depth, 36 AS parent_id, 0.5714285714285714 AS "Proba_0", -0.5596157879354228 AS "LogProba_0", 0.14285714285714285 AS "Proba_1", -1.9459101490553135 AS "LogProba_1", 0.2857142857142857 AS "Proba_2", -1.252762968495368 AS "LogProba_2", 0.0 AS "Proba_3", -1.79769313486231e+308 AS "LogProba_3", 0 AS "Decision", 0.5714285714285714 AS "DecisionProba" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 38 AS node_id, NULL AS feature, CAST(NULL AS DOUBLE) AS threshold, 4 AS "count", 5 AS depth, 36 AS parent_id, 0.0 AS "Proba_0", -1.79769313486231e+308 AS "LogProba_0", 0.0 AS "Proba_1", -1.79769313486231e+308 AS "LogProba_1", 0.0 AS "Proba_2", -1.79769313486231e+308 AS "LogProba_2", 1.0 AS "Proba_3", 0.0 AS "LogProba_3", 3 AS "Decision", 1.0 AS "DecisionProba" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 41 AS node_id, NULL AS feature, CAST(NULL AS DOUBLE) AS threshold, 15 AS "count", 5 AS depth, 40 AS parent_id, 0.8666666666666667 AS "Proba_0", -0.1431008436406733 AS "LogProba_0", 0.06666666666666667 AS "Proba_1", -2.70805020110221 AS "LogProba_1", 0.06666666666666667 AS "Proba_2", -2.70805020110221 AS "LogProba_2", 0.0 AS "Proba_3", -1.79769313486231e+308 AS "LogProba_3", 0 AS "Decision", 0.8666666666666667 AS "DecisionProba" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 42 AS node_id, NULL AS feature, CAST(NULL AS DOUBLE) AS threshold, 10 AS "count", 5 AS depth, 40 AS parent_id, 0.2 AS "Proba_0", -1.6094379124341003 AS "LogProba_0", 0.1 AS "Proba_1", -2.3025850929940455 AS "LogProba_1", 0.0 AS "Proba_2", -1.79769313486231e+308 AS "LogProba_2", 0.7 AS "Proba_3", -0.35667494393873245 AS "LogProba_3", 3 AS "Decision", 0.7 AS "DecisionProba" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 44 AS node_id, NULL AS feature, CAST(NULL AS DOUBLE) AS threshold, 10 AS "count", 5 AS depth, 43 AS parent_id, 0.1 AS "Proba_0", -2.3025850929940455 AS "LogProba_0", 0.0 AS "Proba_1", -1.79769313486231e+308 AS "LogProba_1", 0.8 AS "Proba_2", -0.2231435513142097 AS "LogProba_2", 0.1 AS "Proba_3", -2.3025850929940455 AS "LogProba_3", 2 AS "Decision", 0.8 AS "DecisionProba" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 45 AS node_id, NULL AS feature, CAST(NULL AS DOUBLE) AS threshold, 58 AS "count", 5 AS depth, 43 AS parent_id, 0.15517241379310345 AS "Proba_0", -1.8632184332102 AS "LogProba_0", 0.034482758620689655 AS "Proba_1", -3.367295829986474 AS "LogProba_1", 0.08620689655172414 AS "Proba_2", -2.451005098112319 AS "LogProba_2", 0.7241379310344828 AS "Proba_3", -0.322773392263051 AS "LogProba_3", 3 AS "Decision", 0.7241379310344828 AS "DecisionProba" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 49 AS node_id, NULL AS feature, CAST(NULL AS DOUBLE) AS threshold, 1 AS "count", 5 AS depth, 48 AS parent_id, 1.0 AS "Proba_0", 0.0 AS "LogProba_0", 0.0 AS "Proba_1", -1.79769313486231e+308 AS "LogProba_1", 0.0 AS "Proba_2", -1.79769313486231e+308 AS "LogProba_2", 0.0 AS "Proba_3", -1.79769313486231e+308 AS "LogProba_3", 0 AS "Decision", 1.0 AS "DecisionProba" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 50 AS node_id, NULL AS feature, CAST(NULL AS DOUBLE) AS threshold, 1 AS "count", 5 AS depth, 48 AS parent_id, 0.0 AS "Proba_0", -1.79769313486231e+308 AS "LogProba_0", 0.0 AS "Proba_1", -1.79769313486231e+308 AS "LogProba_1", 1.0 AS "Proba_2", 0.0 AS "LogProba_2", 0.0 AS "Proba_3", -1.79769313486231e+308 AS "LogProba_3", 2 AS "Decision", 1.0 AS "DecisionProba" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 51 AS node_id, NULL AS feature, CAST(NULL AS DOUBLE) AS threshold, 2 AS "count", 4 AS depth, 47 AS parent_id, 0.0 AS "Proba_0", -1.79769313486231e+308 AS "LogProba_0", 0.0 AS "Proba_1", -1.79769313486231e+308 AS "LogProba_1", 0.0 AS "Proba_2", -1.79769313486231e+308 AS "LogProba_2", 1.0 AS "Proba_3", 0.0 AS "LogProba_3", 3 AS "Decision", 1.0 AS "DecisionProba" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 52 AS node_id, NULL AS feature, CAST(NULL AS DOUBLE) AS threshold, 9 AS "count", 3 AS depth, 46 AS parent_id, 0.0 AS "Proba_0", -1.79769313486231e+308 AS "LogProba_0", 1.0 AS "Proba_1", 0.0 AS "LogProba_1", 0.0 AS "Proba_2", -1.79769313486231e+308 AS "LogProba_2", 0.0 AS "Proba_3", -1.79769313486231e+308 AS "LogProba_3", 1 AS "Decision", 1.0 AS "DecisionProba" FROM SYSIBM.SYSDUMMY1) AS "Values"), 
"DT_Output" AS 
...
(SELECT "DT_Output"."KEY" AS "KEY", CAST(NULL AS DOUBLE) AS "Score_0", CAST(NULL AS DOUBLE) AS "Score_1", CAST(NULL AS DOUBLE) AS "Score_2", CAST(NULL AS DOUBLE) AS "Score_3", "DT_Output"."Proba_0" AS "Proba_0", "DT_Output"."Proba_1" AS "Proba_1", "DT_Output"."Proba_2" AS "Proba_2", "DT_Output"."Proba_3" AS "Proba_3", "DT_Output"."LogProba_0" AS "LogProba_0", "DT_Output"."LogProba_1" AS "LogProba_1", "DT_Output"."LogProba_2" AS "LogProba_2", "DT_Output"."LogProba_3" AS "LogProba_3", NULL AS "Decision", CAST(NULL AS DOUBLE) AS "DecisionProba", coalesce(CAST(NULL AS DOUBLE), "DT_Output"."Proba_0") AS "ScoreOrProba_0", coalesce(CAST(NULL AS DOUBLE), "DT_Output"."Proba_1") AS "ScoreOrProba_1", coalesce(CAST(NULL AS DOUBLE), "DT_Output"."Proba_2") AS "ScoreOrProba_2", coalesce(CAST(NULL AS DOUBLE), "DT_Output"."Proba_3") AS "ScoreOrProba_3" 
FROM "DT_Output"), 
sigmoid_calibration_0 AS 
(SELECT "Calibrated_Model_0"."KEY" AS "KEY", 1.0 / (1.0 + exp(least(greatest(-100.0, -(-0.3340451760406988 * "Calibrated_Model_0"."ScoreOrProba_0" + -1.098665621265825)), 100.0))) AS "Proba_0", 1.0 / (1.0 + exp(least(greatest(-100.0, -(1.0133469751817132 * "Calibrated_Model_0"."ScoreOrProba_1" + -1.3667604794601305)), 100.0))) AS "Proba_1", 1.0 / (1.0 + exp(least(greatest(-100.0, -(0.7915218057838734 * "Calibrated_Model_0"."ScoreOrProba_2" + -1.2798320911332832)), 100.0))) AS "Proba_2", 1.0 / (1.0 + exp(least(greatest(-100.0, -(0.02596536941515934 * "Calibrated_Model_0"."ScoreOrProba_3" + -1.066527862390536)), 100.0))) AS "Proba_3" 
...
"DT_node_lookup_1" AS 
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", CASE WHEN ("ADS_sca_2_OUT".scaler_268 <= 0.5288784503936768) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_198 <= 0.8383753299713135) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_261 <= 0.5515919327735901) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_137 <= 0.16197675466537476) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_185 <= -1.343750238418579) THEN 5 ELSE 6 END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_461 <= -0.7565647959709167) THEN 8 ELSE 9 END END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_497 <= -0.09553587436676025) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_426 <= -0.7646473050117493) THEN 12 ELSE 13 END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_312 <= 0.763069748878479) THEN 15 ELSE 16 END END END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_76 <= -0.8632370233535767) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_422 <= -1.0703800916671753) THEN 19 ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_117 <= 1.19620943069458) THEN 21 ELSE 22 END END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_211 <= 0.7624328136444092) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_392 <= -1.7588105201721191) THEN 25 ELSE 26 END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_310 <= 0.25438857078552246) THEN 28 ELSE 29 END END END END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_108 <= -1.0468288660049438) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_424 <= 0.7556660175323486) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_401 <= 1.0938084125518799) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_404 <= 0.19167791306972504) THEN 34 ELSE 35 END ELSE 36 END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_122 <= -1.3313319683074951) THEN 38 ELSE 39 END END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_144 <= 0.2783798575401306) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_398 <= 0.6877672672271729) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_33 <= -0.8600993156433105) THEN 43 ELSE 44 END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_187 <= -0.04768328368663788) THEN 46 ELSE 47 END END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_202 <= 1.3020657300949097) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_375 <= 0.9718129634857178) THEN 50 ELSE 51 END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_69 <= 0.9259128570556641) THEN 53 ELSE 54 END END END END END AS node_id_2 
FROM tmp_20180417002024_jv3727_ads_sca_2_out AS "ADS_sca_2_OUT"), 
"DT_node_data_1" AS 
(SELECT "Values".node_id AS node_id, CAST("Values".feature AS DOUBLE) AS feature, CAST("Values".threshold AS DOUBLE) AS threshold, CAST("Values"."count" AS DOUBLE) AS "count", CAST("Values".depth AS DOUBLE) AS depth, CAST("Values".parent_id AS DOUBLE) AS parent_id, CAST("Values"."Proba_0" AS DOUBLE) AS "Proba_0", CAST("Values"."LogProba_0" AS DOUBLE) AS "LogProba_0", CAST("Values"."Proba_1" AS DOUBLE) AS "Proba_1", CAST("Values"."LogProba_1" AS DOUBLE) AS "LogProba_1", CAST("Values"."Proba_2" AS DOUBLE) AS "Proba_2", CAST("Values"."LogProba_2" AS DOUBLE) AS "LogProba_2", CAST("Values"."Proba_3" AS DOUBLE) AS "Proba_3", CAST("Values"."LogProba_3" AS DOUBLE) AS "LogProba_3", CAST("Values"."Decision" AS DOUBLE) AS "Decision", CAST("Values"."DecisionProba" AS DOUBLE) AS "DecisionProba" 
FROM (SELECT 5 AS node_id, NULL AS feature, CAST(NULL AS DOUBLE) AS threshold, 18 AS "count", 5 AS depth, 4 AS parent_id, 0.05555555555555555 AS "Proba_0", -2.890371757896165 AS "LogProba_0", 0.0 AS "Proba_1", -1.79769313486231e+308 AS "LogProba_1", 0.05555555555555555 AS "Proba_2", -2.890371757896165 AS "LogProba_2", 0.8888888888888888 AS "Proba_3", -0.11778303565638351 AS "LogProba_3", 3 AS "Decision", 0.8888888888888888 AS "DecisionProba" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 6 AS node_id, NULL AS feature, CAST(NULL AS DOUBLE) AS threshold, 129 AS "count", 5 AS depth, 4 AS parent_id, 0.31007751937984496 AS "Proba_0", -1.170932950247736 AS "LogProba_0", 0.18604651162790697 AS "Proba_1", -1.6817585740137264 AS "LogProba_1", 0.17829457364341086 AS "Proba_2", -1.7243181884325223 AS "LogProba_2", 0.32558139534883723 AS "Proba_3", -1.1221427860783038 AS "LogProba_3", 3 AS "Decision", 0.32558139534883723 AS "DecisionProba" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 8 AS node_id, NULL AS feature, CAST(NULL AS DOUBLE) AS threshold, 19 AS "count", 5 AS depth, 7 AS parent_id, 0.05263157894736842 AS "Proba_0", -2.9444389791664407 AS "LogProba_0", 0.7894736842105263 AS "Proba_1", -0.2363887780642304 AS "LogProba_1", 0.10526315789473684 AS "Proba_2", -2.2512917986064953 AS "LogProba_2", 0.05263157894736842 AS "Proba_3", -2.9444389791664407 AS "LogProba_3", 1 AS "Decision", 0.7894736842105263 AS "DecisionProba" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 9 AS node_id, NULL AS feature, CAST(NULL AS DOUBLE) AS threshold, 80 AS "count", 5 AS depth, 7 AS parent_id, 0.125 AS "Proba_0", -2.0794415416798357 AS "LogProba_0", 0.25 AS "Proba_1", -1.3862943611198906 AS "LogProba_1", 0.325 AS "Proba_2", -1.1239300966523995 AS "LogProba_2", 0.3 AS "Proba_3", -1.2039728043259361 AS "LogProba_3", 2 AS "Decision", 0.325 AS "DecisionProba" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 12 AS node_id, NULL AS feature, CAST(NULL AS DOUBLE) AS threshold, 8 AS "count", 5 AS depth, 11 AS parent_id, 0.125 AS "Proba_0", -2.0794415416798357 AS "LogProba_0", 0.75 AS "Proba_1", -0.2876820724517809 AS "LogProba_1", 0.0 AS "Proba_2", -1.79769313486231e+308 AS "LogProba_2", 0.125 AS "Proba_3", -2.0794415416798357 AS "LogProba_3", 1 AS "Decision", 0.75 AS "DecisionProba" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 13 AS node_id, NULL AS feature, CAST(NULL AS DOUBLE) AS threshold, 31 AS "count", 5 AS depth, 11 AS parent_id, 0.1935483870967742 AS "Proba_0", -1.6422277352570913 AS "LogProba_0", 0.0967741935483871 AS "Proba_1", -2.3353749158170367 AS "LogProba_1", 0.5483870967741935 AS "Proba_2", -0.6007738604289302 AS "LogProba_2", 0.16129032258064516 AS "Proba_3", -1.824549292051046 AS "LogProba_3", 2 AS "Decision", 0.5483870967741935 AS "DecisionProba" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 15 AS node_id, NULL AS feature, CAST(NULL AS DOUBLE) AS threshold, 40 AS "count", 5 AS depth, 14 AS parent_id, 0.05 AS "Proba_0", -2.995732273553991 AS "LogProba_0", 0.8 AS "Proba_1", -0.2231435513142097 AS "LogProba_1", 0.075 AS "Proba_2", -2.5902671654458267 AS "LogProba_2", 0.075 AS "Proba_3", -2.5902671654458267 AS "LogProba_3", 1 AS "Decision", 0.8 AS "DecisionProba" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 16 AS node_id, NULL AS feature, CAST(NULL AS DOUBLE) AS threshold, 5 AS "count", 5 AS depth, 14 AS parent_id, 0.8 AS "Proba_0", -0.2231435513142097 AS "LogProba_0", 0.0 AS "Proba_1", -1.79769313486231e+308 AS "LogProba_1", 0.2 AS "Proba_2", -1.6094379124341003 AS "LogProba_2", 0.0 AS "Proba_3", -1.79769313486231e+308 AS "LogProba_3", 0 AS "Decision", 0.8 AS "DecisionProba" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 19 AS node_id, NULL AS feature, CAST(NULL AS DOUBLE) AS threshold, 3 AS "count", 4 AS depth, 18 AS parent_id, 0.0 AS "Proba_0", -1.79769313486231e+308 AS "LogProba_0", 1.0 AS "Proba_1", 0.0 AS "LogProba_1", 0.0 AS "Proba_2", -1.79769313486231e+308 AS "LogProba_2", 0.0 AS "Proba_3", -1.79769313486231e+308 AS "LogProba_3", 1 AS "Decision", 1.0 AS "DecisionProba" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 21 AS node_id, NULL AS feature, CAST(NULL AS DOUBLE) AS threshold, 11 AS "count", 5 AS depth, 20 AS parent_id, 0.0 AS "Proba_0", -1.79769313486231e+308 AS "LogProba_0", 0.0 AS "Proba_1", -1.79769313486231e+308 AS "LogProba_1", 0.0 AS "Proba_2", -1.79769313486231e+308 AS "LogProba_2", 1.0 AS "Proba_3", 0.0 AS "LogProba_3", 3 AS "Decision", 1.0 AS "DecisionProba" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 22 AS node_id, NULL AS feature, CAST(NULL AS DOUBLE) AS threshold, 2 AS "count", 5 AS depth, 20 AS parent_id, 0.5 AS "Proba_0", -0.6931471805599453 AS "LogProba_0", 0.0 AS "Proba_1", -1.79769313486231e+308 AS "LogProba_1", 0.5 AS "Proba_2", -0.6931471805599453 AS "LogProba_2", 0.0 AS "Proba_3", -1.79769313486231e+308 AS "LogProba_3", 0 AS "Decision", 0.5 AS "DecisionProba" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 25 AS node_id, NULL AS feature, CAST(NULL AS DOUBLE) AS threshold, 3 AS "count", 5 AS depth, 24 AS parent_id, 0.0 AS "Proba_0", -1.79769313486231e+308 AS "LogProba_0", 0.0 AS "Proba_1", -1.79769313486231e+308 AS "LogProba_1", 0.0 AS "Proba_2", -1.79769313486231e+308 AS "LogProba_2", 1.0 AS "Proba_3", 0.0 AS "LogProba_3", 3 AS "Decision", 1.0 AS "DecisionProba" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 26 AS node_id, NULL AS feature, CAST(NULL AS DOUBLE) AS threshold, 48 AS "count", 5 AS depth, 24 AS parent_id, 0.041666666666666664 AS "Proba_0", -3.1780538303479458 AS "LogProba_0", 0.125 AS "Proba_1", -2.0794415416798357 AS "LogProba_1", 0.7708333333333334 AS "Proba_2", -0.2602830982636664 AS "LogProba_2", 0.0625 AS "Proba_3", -2.772588722239781 AS "LogProba_3", 2 AS "Decision", 0.7708333333333334 AS "DecisionProba" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 28 AS node_id, NULL AS feature, CAST(NULL AS DOUBLE) AS threshold, 14 AS "count", 5 AS depth, 27 AS parent_id, 0.14285714285714285 AS "Proba_0", -1.9459101490553135 AS "LogProba_0", 0.21428571428571427 AS "Proba_1", -1.540445040947149 AS "LogProba_1", 0.0 AS "Proba_2", -1.79769313486231e+308 AS "LogProba_2", 0.6428571428571429 AS "Proba_3", -0.4418327522790392 AS "LogProba_3", 3 AS "Decision", 0.6428571428571429 AS "DecisionProba" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 29 AS node_id, NULL AS feature, CAST(NULL AS DOUBLE) AS threshold, 7 AS "count", 5 AS depth, 27 AS parent_id, 0.2857142857142857 AS "Proba_0", -1.252762968495368 AS "LogProba_0", 0.0 AS "Proba_1", -1.79769313486231e+308 AS "LogProba_1", 0.7142857142857143 AS "Proba_2", -0.3364722366212129 AS "LogProba_2", 0.0 AS "Proba_3", -1.79769313486231e+308 AS "LogProba_3", 2 AS "Decision", 0.7142857142857143 AS "DecisionProba" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 34 AS node_id, NULL AS feature, CAST(NULL AS DOUBLE) AS threshold, 10 AS "count", 5 AS depth, 33 AS parent_id, 0.0 AS "Proba_0", -1.79769313486231e+308 AS "LogProba_0", 0.0 AS "Proba_1", -1.79769313486231e+308 AS "LogProba_1", 0.0 AS "Proba_2", -1.79769313486231e+308 AS "LogProba_2", 1.0 AS "Proba_3", 0.0 AS "LogProba_3", 3 AS "Decision", 1.0 AS "DecisionProba" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 35 AS node_id, NULL AS feature, CAST(NULL AS DOUBLE) AS threshold, 3 AS "count", 5 AS depth, 33 AS parent_id, 0.0 AS "Proba_0", -1.79769313486231e+308 AS "LogProba_0", 1.0 AS "Proba_1", 0.0 AS "LogProba_1", 0.0 AS "Proba_2", -1.79769313486231e+308 AS "LogProba_2", 0.0 AS "Proba_3", -1.79769313486231e+308 AS "LogProba_3", 1 AS "Decision", 1.0 AS "DecisionProba" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 36 AS node_id, NULL AS feature, CAST(NULL AS DOUBLE) AS threshold, 4 AS "count", 4 AS depth, 32 AS parent_id, 0.0 AS "Proba_0", -1.79769313486231e+308 AS "LogProba_0", 0.0 AS "Proba_1", -1.79769313486231e+308 AS "LogProba_1", 1.0 AS "Proba_2", 0.0 AS "LogProba_2", 0.0 AS "Proba_3", -1.79769313486231e+308 AS "LogProba_3", 2 AS "Decision", 1.0 AS "DecisionProba" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 38 AS node_id, NULL AS feature, CAST(NULL AS DOUBLE) AS threshold, 1 AS "count", 4 AS depth, 37 AS parent_id, 1.0 AS "Proba_0", 0.0 AS "LogProba_0", 0.0 AS "Proba_1", -1.79769313486231e+308 AS "LogProba_1", 0.0 AS "Proba_2", -1.79769313486231e+308 AS "LogProba_2", 0.0 AS "Proba_3", -1.79769313486231e+308 AS "LogProba_3", 0 AS "Decision", 1.0 AS "DecisionProba" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 39 AS node_id, NULL AS feature, CAST(NULL AS DOUBLE) AS threshold, 10 AS "count", 4 AS depth, 37 AS parent_id, 0.0 AS "Proba_0", -1.79769313486231e+308 AS "LogProba_0", 1.0 AS "Proba_1", 0.0 AS "LogProba_1", 0.0 AS "Proba_2", -1.79769313486231e+308 AS "LogProba_2", 0.0 AS "Proba_3", -1.79769313486231e+308 AS "LogProba_3", 1 AS "Decision", 1.0 AS "DecisionProba" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 43 AS node_id, NULL AS feature, CAST(NULL AS DOUBLE) AS threshold, 9 AS "count", 5 AS depth, 42 AS parent_id, 0.1111111111111111 AS "Proba_0", -2.1972245773362196 AS "LogProba_0", 0.6666666666666666 AS "Proba_1", -0.40546510810816444 AS "LogProba_1", 0.1111111111111111 AS "Proba_2", -2.1972245773362196 AS "LogProba_2", 0.1111111111111111 AS "Proba_3", -2.1972245773362196 AS "LogProba_3", 1 AS "Decision", 0.6666666666666666 AS "DecisionProba" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 44 AS node_id, NULL AS feature, CAST(NULL AS DOUBLE) AS threshold, 64 AS "count", 5 AS depth, 42 AS parent_id, 0.796875 AS "Proba_0", -0.22705745063534608 AS "LogProba_0", 0.09375 AS "Proba_1", -2.367123614131617 AS "LogProba_1", 0.078125 AS "Proba_2", -2.5494451709255714 AS "LogProba_2", 0.03125 AS "Proba_3", -3.4657359027997265 AS "LogProba_3", 0 AS "Decision", 0.796875 AS "DecisionProba" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 46 AS node_id, NULL AS feature, CAST(NULL AS DOUBLE) AS threshold, 12 AS "count", 5 AS depth, 45 AS parent_id, 0.25 AS "Proba_0", -1.3862943611198906 AS "LogProba_0", 0.0 AS "Proba_1", -1.79769313486231e+308 AS "LogProba_1", 0.75 AS "Proba_2", -0.2876820724517809 AS "LogProba_2", 0.0 AS "Proba_3", -1.79769313486231e+308 AS "LogProba_3", 2 AS "Decision", 0.75 AS "DecisionProba" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 47 AS node_id, NULL AS feature, CAST(NULL AS DOUBLE) AS threshold, 13 AS "count", 5 AS depth, 45 AS parent_id, 0.23076923076923078 AS "Proba_0", -1.466337068793427 AS "LogProba_0", 0.38461538461538464 AS "Proba_1", -0.9555114450274363 AS "LogProba_1", 0.0 AS "Proba_2", -1.79769313486231e+308 AS "LogProba_2", 0.38461538461538464 AS "Proba_3", -0.9555114450274363 AS "LogProba_3", 1 AS "Decision", 0.38461538461538464 AS "DecisionProba" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 50 AS node_id, NULL AS feature, CAST(NULL AS DOUBLE) AS threshold, 37 AS "count", 5 AS depth, 49 AS parent_id, 0.10810810810810811 AS "Proba_0", -2.2246235515243336 AS "LogProba_0", 0.24324324324324326 AS "Proba_1", -1.413693335308005 AS "LogProba_1", 0.16216216216216217 AS "Proba_2", -1.8191584434161694 AS "LogProba_2", 0.4864864864864865 AS "Proba_3", -0.7205461547480597 AS "LogProba_3", 3 AS "Decision", 0.4864864864864865 AS "DecisionProba" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 51 AS node_id, NULL AS feature, CAST(NULL AS DOUBLE) AS threshold, 9 AS "count", 5 AS depth, 49 AS parent_id, 0.7777777777777778 AS "Proba_0", -0.25131442828090605 AS "LogProba_0", 0.0 AS "Proba_1", -1.79769313486231e+308 AS "LogProba_1", 0.2222222222222222 AS "Proba_2", -1.5040773967762742 AS "LogProba_2", 0.0 AS "Proba_3", -1.79769313486231e+308 AS "LogProba_3", 0 AS "Decision", 0.7777777777777778 AS "DecisionProba" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 53 AS node_id, NULL AS feature, CAST(NULL AS DOUBLE) AS threshold, 8 AS "count", 5 AS depth, 52 AS parent_id, 0.0 AS "Proba_0", -1.79769313486231e+308 AS "LogProba_0", 0.0 AS "Proba_1", -1.79769313486231e+308 AS "LogProba_1", 1.0 AS "Proba_2", 0.0 AS "LogProba_2", 0.0 AS "Proba_3", -1.79769313486231e+308 AS "LogProba_3", 2 AS "Decision", 1.0 AS "DecisionProba" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 54 AS node_id, NULL AS feature, CAST(NULL AS DOUBLE) AS threshold, 1 AS "count", 5 AS depth, 52 AS parent_id, 1.0 AS "Proba_0", 0.0 AS "LogProba_0", 0.0 AS "Proba_1", -1.79769313486231e+308 AS "LogProba_1", 0.0 AS "Proba_2", -1.79769313486231e+308 AS "LogProba_2", 0.0 AS "Proba_3", -1.79769313486231e+308 AS "LogProba_3", 0 AS "Decision", 1.0 AS "DecisionProba" FROM SYSIBM.SYSDUMMY1) AS "Values"), 
"DT_Output_1" AS 
...
(SELECT "DT_Output_1"."KEY" AS "KEY", CAST(NULL AS DOUBLE) AS "Score_0", CAST(NULL AS DOUBLE) AS "Score_1", CAST(NULL AS DOUBLE) AS "Score_2", CAST(NULL AS DOUBLE) AS "Score_3", "DT_Output_1"."Proba_0" AS "Proba_0", "DT_Output_1"."Proba_1" AS "Proba_1", "DT_Output_1"."Proba_2" AS "Proba_2", "DT_Output_1"."Proba_3" AS "Proba_3", "DT_Output_1"."LogProba_0" AS "LogProba_0", "DT_Output_1"."LogProba_1" AS "LogProba_1", "DT_Output_1"."LogProba_2" AS "LogProba_2", "DT_Output_1"."LogProba_3" AS "LogProba_3", NULL AS "Decision", CAST(NULL AS DOUBLE) AS "DecisionProba", coalesce(CAST(NULL AS DOUBLE), "DT_Output_1"."Proba_0") AS "ScoreOrProba_0", coalesce(CAST(NULL AS DOUBLE), "DT_Output_1"."Proba_1") AS "ScoreOrProba_1", coalesce(CAST(NULL AS DOUBLE), "DT_Output_1"."Proba_2") AS "ScoreOrProba_2", coalesce(CAST(NULL AS DOUBLE), "DT_Output_1"."Proba_3") AS "ScoreOrProba_3" 
FROM "DT_Output_1"), 
sigmoid_calibration_1 AS 
(SELECT "Calibrated_Model_1"."KEY" AS "KEY", 1.0 / (1.0 + exp(least(greatest(-100.0, -(0.6406888231568605 * "Calibrated_Model_1"."ScoreOrProba_0" + -1.303079458902145)), 100.0))) AS "Proba_0", 1.0 / (1.0 + exp(least(greatest(-100.0, -(1.1867608353986114 * "Calibrated_Model_1"."ScoreOrProba_1" + -1.4618756402245139)), 100.0))) AS "Proba_1", 1.0 / (1.0 + exp(least(greatest(-100.0, -(1.060367048284584 * "Calibrated_Model_1"."ScoreOrProba_2" + -1.3714336860079577)), 100.0))) AS "Proba_2", 1.0 / (1.0 + exp(least(greatest(-100.0, -(0.059516156693283875 * "Calibrated_Model_1"."ScoreOrProba_3" + -1.066398921501775)), 100.0))) AS "Proba_3" 
...
"DT_node_lookup_2" AS 
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", CASE WHEN ("ADS_sca_2_OUT".scaler_251 <= 0.2026970535516739) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_211 <= -0.7073056697845459) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_285 <= 0.6475998163223267) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_338 <= 0.5067453384399414) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_148 <= -1.4235565662384033) THEN 5 ELSE 6 END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_143 <= 0.13217870891094208) THEN 8 ELSE 9 END END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_483 <= 0.22175869345664978) THEN 11 ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_482 <= 1.2466236352920532) THEN 13 ELSE 14 END END END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_340 <= 0.5790898203849792) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_497 <= -0.09086430072784424) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_345 <= -0.14745724201202393) THEN 18 ELSE 19 END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_159 <= -0.8588269948959351) THEN 21 ELSE 22 END END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_485 <= 0.6993215084075928) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_291 <= 0.36598336696624756) THEN 25 ELSE 26 END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_60 <= -0.605135440826416) THEN 28 ELSE 29 END END END END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_499 <= -1.2895954847335815) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_78 <= 0.06911789625883102) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_127 <= 1.0010125637054443) THEN 33 ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_108 <= -0.13334831595420837) THEN 35 ELSE 36 END END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_116 <= 0.8570865392684937) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_43 <= -1.4529955387115479) THEN 39 ELSE 40 END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_379 <= -0.7932655811309814) THEN 42 ELSE 43 END END END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_290 <= 0.5938695669174194) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_155 <= 0.23433229327201843) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_305 <= -0.5034763813018799) THEN 47 ELSE 48 END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_426 <= -0.5597013235092163) THEN 50 ELSE 51 END END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_297 <= -0.9002730846405029) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_201 <= -1.350407361984253) THEN 54 ELSE 55 END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_39 <= 0.39607828855514526) THEN 57 ELSE 58 END END END END END AS node_id_2 
FROM tmp_20180417002024_jv3727_ads_sca_2_out AS "ADS_sca_2_OUT"), 
"DT_node_data_2" AS 
(SELECT "Values".node_id AS node_id, CAST("Values".feature AS DOUBLE) AS feature, CAST("Values".threshold AS DOUBLE) AS threshold, CAST("Values"."count" AS DOUBLE) AS "count", CAST("Values".depth AS DOUBLE) AS depth, CAST("Values".parent_id AS DOUBLE) AS parent_id, CAST("Values"."Proba_0" AS DOUBLE) AS "Proba_0", CAST("Values"."LogProba_0" AS DOUBLE) AS "LogProba_0", CAST("Values"."Proba_1" AS DOUBLE) AS "Proba_1", CAST("Values"."LogProba_1" AS DOUBLE) AS "LogProba_1", CAST("Values"."Proba_2" AS DOUBLE) AS "Proba_2", CAST("Values"."LogProba_2" AS DOUBLE) AS "LogProba_2", CAST("Values"."Proba_3" AS DOUBLE) AS "Proba_3", CAST("Values"."LogProba_3" AS DOUBLE) AS "LogProba_3", CAST("Values"."Decision" AS DOUBLE) AS "Decision", CAST("Values"."DecisionProba" AS DOUBLE) AS "DecisionProba" 
FROM (SELECT 5 AS node_id, NULL AS feature, CAST(NULL AS DOUBLE) AS threshold, 5 AS "count", 5 AS depth, 4 AS parent_id, 0.8 AS "Proba_0", -0.2231435513142097 AS "LogProba_0", 0.2 AS "Proba_1", -1.6094379124341003 AS "LogProba_1", 0.0 AS "Proba_2", -1.79769313486231e+308 AS "LogProba_2", 0.0 AS "Proba_3", -1.79769313486231e+308 AS "LogProba_3", 0 AS "Decision", 0.8 AS "DecisionProba" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 6 AS node_id, NULL AS feature, CAST(NULL AS DOUBLE) AS threshold, 44 AS "count", 5 AS depth, 4 AS parent_id, 0.022727272727272728 AS "Proba_0", -3.784189633918261 AS "LogProba_0", 0.06818181818181818 AS "Proba_1", -2.6855773452501515 AS "LogProba_1", 0.75 AS "Proba_2", -0.2876820724517809 AS "LogProba_2", 0.1590909090909091 AS "Proba_3", -1.8382794848629478 AS "LogProba_3", 2 AS "Decision", 0.75 AS "DecisionProba" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 8 AS node_id, NULL AS feature, CAST(NULL AS DOUBLE) AS threshold, 10 AS "count", 5 AS depth, 7 AS parent_id, 0.0 AS "Proba_0", -1.79769313486231e+308 AS "LogProba_0", 0.9 AS "Proba_1", -0.10536051565782628 AS "LogProba_1", 0.0 AS "Proba_2", -1.79769313486231e+308 AS "LogProba_2", 0.1 AS "Proba_3", -2.3025850929940455 AS "LogProba_3", 1 AS "Decision", 0.9 AS "DecisionProba" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 9 AS node_id, NULL AS feature, CAST(NULL AS DOUBLE) AS threshold, 9 AS "count", 5 AS depth, 7 AS parent_id, 0.6666666666666666 AS "Proba_0", -0.40546510810816444 AS "LogProba_0", 0.0 AS "Proba_1", -1.79769313486231e+308 AS "LogProba_1", 0.3333333333333333 AS "Proba_2", -1.0986122886681098 AS "LogProba_2", 0.0 AS "Proba_3", -1.79769313486231e+308 AS "LogProba_3", 0 AS "Decision", 0.6666666666666666 AS "DecisionProba" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 11 AS node_id, NULL AS feature, CAST(NULL AS DOUBLE) AS threshold, 9 AS "count", 4 AS depth, 10 AS parent_id, 1.0 AS "Proba_0", 0.0 AS "LogProba_0", 0.0 AS "Proba_1", -1.79769313486231e+308 AS "LogProba_1", 0.0 AS "Proba_2", -1.79769313486231e+308 AS "LogProba_2", 0.0 AS "Proba_3", -1.79769313486231e+308 AS "LogProba_3", 0 AS "Decision", 1.0 AS "DecisionProba" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 13 AS node_id, NULL AS feature, CAST(NULL AS DOUBLE) AS threshold, 3 AS "count", 5 AS depth, 12 AS parent_id, 0.0 AS "Proba_0", -1.79769313486231e+308 AS "LogProba_0", 0.6666666666666666 AS "Proba_1", -0.40546510810816444 AS "LogProba_1", 0.3333333333333333 AS "Proba_2", -1.0986122886681098 AS "LogProba_2", 0.0 AS "Proba_3", -1.79769313486231e+308 AS "LogProba_3", 1 AS "Decision", 0.6666666666666666 AS "DecisionProba" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 14 AS node_id, NULL AS feature, CAST(NULL AS DOUBLE) AS threshold, 2 AS "count", 5 AS depth, 12 AS parent_id, 0.0 AS "Proba_0", -1.79769313486231e+308 AS "LogProba_0", 0.0 AS "Proba_1", -1.79769313486231e+308 AS "LogProba_1", 0.0 AS "Proba_2", -1.79769313486231e+308 AS "LogProba_2", 1.0 AS "Proba_3", 0.0 AS "LogProba_3", 3 AS "Decision", 1.0 AS "DecisionProba" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 18 AS node_id, NULL AS feature, CAST(NULL AS DOUBLE) AS threshold, 53 AS "count", 5 AS depth, 17 AS parent_id, 0.4339622641509434 AS "Proba_0", -0.8347976976229721 AS "LogProba_0", 0.2641509433962264 AS "Proba_1", -1.3312345839368633 AS "LogProba_1", 0.2641509433962264 AS "Proba_2", -1.3312345839368633 AS "LogProba_2", 0.03773584905660377 AS "Proba_3", -3.2771447329921766 AS "LogProba_3", 0 AS "Decision", 0.4339622641509434 AS "DecisionProba" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 19 AS node_id, NULL AS feature, CAST(NULL AS DOUBLE) AS threshold, 49 AS "count", 5 AS depth, 17 AS parent_id, 0.10204081632653061 AS "Proba_0", -2.2823823856765264 AS "LogProba_0", 0.3469387755102041 AS "Proba_1", -1.0586069540544105 AS "LogProba_1", 0.16326530612244897 AS "Proba_2", -1.8123787564307907 AS "LogProba_2", 0.3877551020408163 AS "Proba_3", -0.9473813189441862 AS "LogProba_3", 3 AS "Decision", 0.3877551020408163 AS "DecisionProba" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 21 AS node_id, NULL AS feature, CAST(NULL AS DOUBLE) AS threshold, 15 AS "count", 5 AS depth, 20 AS parent_id, 0.06666666666666667 AS "Proba_0", -2.70805020110221 AS "LogProba_0", 0.13333333333333333 AS "Proba_1", -2.0149030205422647 AS "LogProba_1", 0.26666666666666666 AS "Proba_2", -1.3217558399823195 AS "LogProba_2", 0.5333333333333333 AS "Proba_3", -0.6286086594223742 AS "LogProba_3", 3 AS "Decision", 0.5333333333333333 AS "DecisionProba" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 22 AS node_id, NULL AS feature, CAST(NULL AS DOUBLE) AS threshold, 83 AS "count", 5 AS depth, 20 AS parent_id, 0.07228915662650602 AS "Proba_0", -2.627081138568543 AS "LogProba_0", 0.6867469879518072 AS "Proba_1", -0.3757893399620478 AS "LogProba_1", 0.10843373493975904 AS "Proba_2", -2.2216160304603787 AS "LogProba_2", 0.13253012048192772 AS "Proba_3", -2.020945334998227 AS "LogProba_3", 1 AS "Decision", 0.6867469879518072 AS "DecisionProba" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 25 AS node_id, NULL AS feature, CAST(NULL AS DOUBLE) AS threshold, 30 AS "count", 5 AS depth, 24 AS parent_id, 0.0 AS "Proba_0", -1.79769313486231e+308 AS "LogProba_0", 0.13333333333333333 AS "Proba_1", -2.0149030205422647 AS "LogProba_1", 0.7666666666666667 AS "Proba_2", -0.2657031657330056 AS "LogProba_2", 0.1 AS "Proba_3", -2.3025850929940455 AS "LogProba_3", 2 AS "Decision", 0.7666666666666667 AS "DecisionProba" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 26 AS node_id, NULL AS feature, CAST(NULL AS DOUBLE) AS threshold, 17 AS "count", 5 AS depth, 24 AS parent_id, 0.35294117647058826 AS "Proba_0", -1.041453874828161 AS "LogProba_0", 0.23529411764705882 AS "Proba_1", -1.4469189829363254 AS "LogProba_1", 0.11764705882352941 AS "Proba_2", -2.1400661634962708 AS "LogProba_2", 0.29411764705882354 AS "Proba_3", -1.2237754316221157 AS "LogProba_3", 0 AS "Decision", 0.35294117647058826 AS "DecisionProba" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 28 AS node_id, NULL AS feature, CAST(NULL AS DOUBLE) AS threshold, 8 AS "count", 5 AS depth, 27 AS parent_id, 0.375 AS "Proba_0", -0.9808292530117262 AS "LogProba_0", 0.375 AS "Proba_1", -0.9808292530117262 AS "LogProba_1", 0.125 AS "Proba_2", -2.0794415416798357 AS "LogProba_2", 0.125 AS "Proba_3", -2.0794415416798357 AS "LogProba_3", 0 AS "Decision", 0.375 AS "DecisionProba" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 29 AS node_id, NULL AS feature, CAST(NULL AS DOUBLE) AS threshold, 14 AS "count", 5 AS depth, 27 AS parent_id, 0.0 AS "Proba_0", -1.79769313486231e+308 AS "LogProba_0", 0.0 AS "Proba_1", -1.79769313486231e+308 AS "LogProba_1", 0.07142857142857142 AS "Proba_2", -2.639057329615259 AS "LogProba_2", 0.9285714285714286 AS "Proba_3", -0.07410797215372185 AS "LogProba_3", 3 AS "Decision", 0.9285714285714286 AS "DecisionProba" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 33 AS node_id, NULL AS feature, CAST(NULL AS DOUBLE) AS threshold, 16 AS "count", 4 AS depth, 32 AS parent_id, 0.0 AS "Proba_0", -1.79769313486231e+308 AS "LogProba_0", 0.0 AS "Proba_1", -1.79769313486231e+308 AS "LogProba_1", 1.0 AS "Proba_2", 0.0 AS "LogProba_2", 0.0 AS "Proba_3", -1.79769313486231e+308 AS "LogProba_3", 2 AS "Decision", 1.0 AS "DecisionProba" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 35 AS node_id, NULL AS feature, CAST(NULL AS DOUBLE) AS threshold, 2 AS "count", 5 AS depth, 34 AS parent_id, 0.0 AS "Proba_0", -1.79769313486231e+308 AS "LogProba_0", 1.0 AS "Proba_1", 0.0 AS "LogProba_1", 0.0 AS "Proba_2", -1.79769313486231e+308 AS "LogProba_2", 0.0 AS "Proba_3", -1.79769313486231e+308 AS "LogProba_3", 1 AS "Decision", 1.0 AS "DecisionProba" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 36 AS node_id, NULL AS feature, CAST(NULL AS DOUBLE) AS threshold, 2 AS "count", 5 AS depth, 34 AS parent_id, 0.5 AS "Proba_0", -0.6931471805599453 AS "LogProba_0", 0.0 AS "Proba_1", -1.79769313486231e+308 AS "LogProba_1", 0.0 AS "Proba_2", -1.79769313486231e+308 AS "LogProba_2", 0.5 AS "Proba_3", -0.6931471805599453 AS "LogProba_3", 0 AS "Decision", 0.5 AS "DecisionProba" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 39 AS node_id, NULL AS feature, CAST(NULL AS DOUBLE) AS threshold, 1 AS "count", 5 AS depth, 38 AS parent_id, 0.0 AS "Proba_0", -1.79769313486231e+308 AS "LogProba_0", 0.0 AS "Proba_1", -1.79769313486231e+308 AS "LogProba_1", 0.0 AS "Proba_2", -1.79769313486231e+308 AS "LogProba_2", 1.0 AS "Proba_3", 0.0 AS "LogProba_3", 3 AS "Decision", 1.0 AS "DecisionProba" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 40 AS node_id, NULL AS feature, CAST(NULL AS DOUBLE) AS threshold, 10 AS "count", 5 AS depth, 38 AS parent_id, 1.0 AS "Proba_0", 0.0 AS "LogProba_0", 0.0 AS "Proba_1", -1.79769313486231e+308 AS "LogProba_1", 0.0 AS "Proba_2", -1.79769313486231e+308 AS "LogProba_2", 0.0 AS "Proba_3", -1.79769313486231e+308 AS "LogProba_3", 0 AS "Decision", 1.0 AS "DecisionProba" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 42 AS node_id, NULL AS feature, CAST(NULL AS DOUBLE) AS threshold, 3 AS "count", 5 AS depth, 41 AS parent_id, 0.0 AS "Proba_0", -1.79769313486231e+308 AS "LogProba_0", 0.0 AS "Proba_1", -1.79769313486231e+308 AS "LogProba_1", 1.0 AS "Proba_2", 0.0 AS "LogProba_2", 0.0 AS "Proba_3", -1.79769313486231e+308 AS "LogProba_3", 2 AS "Decision", 1.0 AS "DecisionProba" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 43 AS node_id, NULL AS feature, CAST(NULL AS DOUBLE) AS threshold, 3 AS "count", 5 AS depth, 41 AS parent_id, 0.0 AS "Proba_0", -1.79769313486231e+308 AS "LogProba_0", 0.6666666666666666 AS "Proba_1", -0.40546510810816444 AS "LogProba_1", 0.0 AS "Proba_2", -1.79769313486231e+308 AS "LogProba_2", 0.3333333333333333 AS "Proba_3", -1.0986122886681098 AS "LogProba_3", 1 AS "Decision", 0.6666666666666666 AS "DecisionProba" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 47 AS node_id, NULL AS feature, CAST(NULL AS DOUBLE) AS threshold, 28 AS "count", 5 AS depth, 46 AS parent_id, 0.07142857142857142 AS "Proba_0", -2.639057329615259 AS "LogProba_0", 0.0 AS "Proba_1", -1.79769313486231e+308 AS "LogProba_1", 0.07142857142857142 AS "Proba_2", -2.639057329615259 AS "LogProba_2", 0.8571428571428571 AS "Proba_3", -0.15415067982725836 AS "LogProba_3", 3 AS "Decision", 0.8571428571428571 AS "DecisionProba" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 48 AS node_id, NULL AS feature, CAST(NULL AS DOUBLE) AS threshold, 67 AS "count", 5 AS depth, 46 AS parent_id, 0.3880597014925373 AS "Proba_0", -0.946596081369484 AS "LogProba_0", 0.08955223880597014 AS "Proba_1", -2.412933150162911 AS "LogProba_1", 0.07462686567164178 AS "Proba_2", -2.5952547069568657 AS "LogProba_2", 0.44776119402985076 AS "Proba_3", -0.8034952377288106 AS "LogProba_3", 3 AS "Decision", 0.44776119402985076 AS "DecisionProba" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 50 AS node_id, NULL AS feature, CAST(NULL AS DOUBLE) AS threshold, 21 AS "count", 5 AS depth, 49 AS parent_id, 0.47619047619047616 AS "Proba_0", -0.7419373447293773 AS "LogProba_0", 0.3333333333333333 AS "Proba_1", -1.0986122886681098 AS "LogProba_1", 0.19047619047619047 AS "Proba_2", -1.6582280766035324 AS "LogProba_2", 0.0 AS "Proba_3", -1.79769313486231e+308 AS "LogProba_3", 0 AS "Decision", 0.47619047619047616 AS "DecisionProba" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 51 AS node_id, NULL AS feature, CAST(NULL AS DOUBLE) AS threshold, 40 AS "count", 5 AS depth, 49 AS parent_id, 0.05 AS "Proba_0", -2.995732273553991 AS "LogProba_0", 0.225 AS "Proba_1", -1.491654876777717 AS "LogProba_1", 0.3 AS "Proba_2", -1.2039728043259361 AS "LogProba_2", 0.425 AS "Proba_3", -0.8556661100577202 AS "LogProba_3", 3 AS "Decision", 0.425 AS "DecisionProba" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 54 AS node_id, NULL AS feature, CAST(NULL AS DOUBLE) AS threshold, 1 AS "count", 5 AS depth, 53 AS parent_id, 0.0 AS "Proba_0", -1.79769313486231e+308 AS "LogProba_0", 0.0 AS "Proba_1", -1.79769313486231e+308 AS "LogProba_1", 0.0 AS "Proba_2", -1.79769313486231e+308 AS "LogProba_2", 1.0 AS "Proba_3", 0.0 AS "LogProba_3", 3 AS "Decision", 1.0 AS "DecisionProba" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 55 AS node_id, NULL AS feature, CAST(NULL AS DOUBLE) AS threshold, 6 AS "count", 5 AS depth, 53 AS parent_id, 0.0 AS "Proba_0", -1.79769313486231e+308 AS "LogProba_0", 1.0 AS "Proba_1", 0.0 AS "LogProba_1", 0.0 AS "Proba_2", -1.79769313486231e+308 AS "LogProba_2", 0.0 AS "Proba_3", -1.79769313486231e+308 AS "LogProba_3", 1 AS "Decision", 1.0 AS "DecisionProba" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 57 AS node_id, NULL AS feature, CAST(NULL AS DOUBLE) AS threshold, 31 AS "count", 5 AS depth, 56 AS parent_id, 0.7741935483870968 AS "Proba_0", -0.25593337413720063 AS "LogProba_0", 0.03225806451612903 AS "Proba_1", -3.4339872044851463 AS "LogProba_1", 0.06451612903225806 AS "Proba_2", -2.740840023925201 AS "LogProba_2", 0.12903225806451613 AS "Proba_3", -2.0476928433652555 AS "LogProba_3", 0 AS "Decision", 0.7741935483870968 AS "DecisionProba" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 58 AS node_id, NULL AS feature, CAST(NULL AS DOUBLE) AS threshold, 19 AS "count", 5 AS depth, 56 AS parent_id, 0.21052631578947367 AS "Proba_0", -1.55814461804655 AS "LogProba_0", 0.10526315789473684 AS "Proba_1", -2.2512917986064953 AS "LogProba_1", 0.47368421052631576 AS "Proba_2", -0.7472144018302211 AS "LogProba_2", 0.21052631578947367 AS "Proba_3", -1.55814461804655 AS "LogProba_3", 2 AS "Decision", 0.47368421052631576 AS "DecisionProba" FROM SYSIBM.SYSDUMMY1) AS "Values"), 
"DT_Output_2" AS 
...
(SELECT "DT_Output_2"."KEY" AS "KEY", CAST(NULL AS DOUBLE) AS "Score_0", CAST(NULL AS DOUBLE) AS "Score_1", CAST(NULL AS DOUBLE) AS "Score_2", CAST(NULL AS DOUBLE) AS "Score_3", "DT_Output_2"."Proba_0" AS "Proba_0", "DT_Output_2"."Proba_1" AS "Proba_1", "DT_Output_2"."Proba_2" AS "Proba_2", "DT_Output_2"."Proba_3" AS "Proba_3", "DT_Output_2"."LogProba_0" AS "LogProba_0", "DT_Output_2"."LogProba_1" AS "LogProba_1", "DT_Output_2"."LogProba_2" AS "LogProba_2", "DT_Output_2"."LogProba_3" AS "LogProba_3", NULL AS "Decision", CAST(NULL AS DOUBLE) AS "DecisionProba", coalesce(CAST(NULL AS DOUBLE), "DT_Output_2"."Proba_0") AS "ScoreOrProba_0", coalesce(CAST(NULL AS DOUBLE), "DT_Output_2"."Proba_1") AS "ScoreOrProba_1", coalesce(CAST(NULL AS DOUBLE), "DT_Output_2"."Proba_2") AS "ScoreOrProba_2", coalesce(CAST(NULL AS DOUBLE), "DT_Output_2"."Proba_3") AS "ScoreOrProba_3" 
FROM "DT_Output_2"), 
sigmoid_calibration_2 AS 
(SELECT "Calibrated_Model_2"."KEY" AS "KEY", 1.0 / (1.0 + exp(least(greatest(-100.0, -(-0.11067036048263225 * "Calibrated_Model_2"."ScoreOrProba_0" + -1.120008307860179)), 100.0))) AS "Proba_0", 1.0 / (1.0 + exp(least(greatest(-100.0, -(0.9950702486496436 * "Calibrated_Model_2"."ScoreOrProba_1" + -1.3713833466239904)), 100.0))) AS "Proba_1", 1.0 / (1.0 + exp(least(greatest(-100.0, -(0.23223991990819945 * "Calibrated_Model_2"."ScoreOrProba_2" + -1.145353095701938)), 100.0))) AS "Proba_2", 1.0 / (1.0 + exp(least(greatest(-100.0, -(0.7341257989298635 * "Calibrated_Model_2"."ScoreOrProba_3" + -1.2751384758676936)), 100.0))) AS "Proba_3" 
...
"DT_node_lookup_3" AS 
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", CASE WHEN ("ADS_sca_2_OUT".scaler_340 <= -0.31521958112716675) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_251 <= -0.49755534529685974) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_257 <= 0.2004275619983673) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_122 <= -0.6080366969108582) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_130 <= 0.4821823239326477) THEN 5 ELSE 6 END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_276 <= 0.34953001141548157) THEN 8 ELSE 9 END END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_331 <= -0.7244659662246704) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_7 <= -0.09218505769968033) THEN 12 ELSE 13 END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_244 <= -1.0944440364837646) THEN 15 ELSE 16 END END END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_131 <= -1.3816640377044678) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_30 <= 1.5202927589416504) THEN 19 ELSE 20 END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_331 <= -0.9930855631828308) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_444 <= -0.4267270267009735) THEN 23 ELSE 24 END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_270 <= 1.3043689727783203) THEN 26 ELSE 27 END END END END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_303 <= -1.3109276294708252) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_52 <= 0.7377253770828247) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_249 <= 1.512592077255249) THEN 31 ELSE 32 END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_473 <= 1.1239821910858154) THEN 34 ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_471 <= -0.48757612705230713) THEN 36 ELSE 37 END END END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_74 <= 0.5697135925292969) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_131 <= -0.97968590259552) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_184 <= -0.4857725203037262) THEN 41 ELSE 42 END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_291 <= -0.27640387415885925) THEN 44 ELSE 45 END END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_181 <= -0.6299618482589722) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_139 <= -0.1397012174129486) THEN 48 ELSE 49 END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_230 <= -0.051711078733205795) THEN 51 ELSE 52 END END END END END AS node_id_2 
FROM tmp_20180417002024_jv3727_ads_sca_2_out AS "ADS_sca_2_OUT"), 
"DT_node_data_3" AS 
(SELECT "Values".node_id AS node_id, CAST("Values".feature AS DOUBLE) AS feature, CAST("Values".threshold AS DOUBLE) AS threshold, CAST("Values"."count" AS DOUBLE) AS "count", CAST("Values".depth AS DOUBLE) AS depth, CAST("Values".parent_id AS DOUBLE) AS parent_id, CAST("Values"."Proba_0" AS DOUBLE) AS "Proba_0", CAST("Values"."LogProba_0" AS DOUBLE) AS "LogProba_0", CAST("Values"."Proba_1" AS DOUBLE) AS "Proba_1", CAST("Values"."LogProba_1" AS DOUBLE) AS "LogProba_1", CAST("Values"."Proba_2" AS DOUBLE) AS "Proba_2", CAST("Values"."LogProba_2" AS DOUBLE) AS "LogProba_2", CAST("Values"."Proba_3" AS DOUBLE) AS "Proba_3", CAST("Values"."LogProba_3" AS DOUBLE) AS "LogProba_3", CAST("Values"."Decision" AS DOUBLE) AS "Decision", CAST("Values"."DecisionProba" AS DOUBLE) AS "DecisionProba" 
FROM (SELECT 5 AS node_id, NULL AS feature, CAST(NULL AS DOUBLE) AS threshold, 13 AS "count", 5 AS depth, 4 AS parent_id, 0.0 AS "Proba_0", -1.79769313486231e+308 AS "LogProba_0", 0.0 AS "Proba_1", -1.79769313486231e+308 AS "LogProba_1", 0.9230769230769231 AS "Proba_2", -0.08004270767353637 AS "LogProba_2", 0.07692307692307693 AS "Proba_3", -2.5649493574615367 AS "LogProba_3", 2 AS "Decision", 0.9230769230769231 AS "DecisionProba" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 6 AS node_id, NULL AS feature, CAST(NULL AS DOUBLE) AS threshold, 3 AS "count", 5 AS depth, 4 AS parent_id, 0.0 AS "Proba_0", -1.79769313486231e+308 AS "LogProba_0", 1.0 AS "Proba_1", 0.0 AS "LogProba_1", 0.0 AS "Proba_2", -1.79769313486231e+308 AS "LogProba_2", 0.0 AS "Proba_3", -1.79769313486231e+308 AS "LogProba_3", 1 AS "Decision", 1.0 AS "DecisionProba" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 8 AS node_id, NULL AS feature, CAST(NULL AS DOUBLE) AS threshold, 22 AS "count", 5 AS depth, 7 AS parent_id, 0.09090909090909091 AS "Proba_0", -2.3978952727983707 AS "LogProba_0", 0.4090909090909091 AS "Proba_1", -0.8938178760220964 AS "LogProba_1", 0.13636363636363635 AS "Proba_2", -1.9924301646902063 AS "LogProba_2", 0.36363636363636365 AS "Proba_3", -1.0116009116784799 AS "LogProba_3", 1 AS "Decision", 0.4090909090909091 AS "DecisionProba" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 9 AS node_id, NULL AS feature, CAST(NULL AS DOUBLE) AS threshold, 12 AS "count", 5 AS depth, 7 AS parent_id, 0.75 AS "Proba_0", -0.2876820724517809 AS "LogProba_0", 0.16666666666666666 AS "Proba_1", -1.791759469228055 AS "LogProba_1", 0.08333333333333333 AS "Proba_2", -2.4849066497880004 AS "LogProba_2", 0.0 AS "Proba_3", -1.79769313486231e+308 AS "LogProba_3", 0 AS "Decision", 0.75 AS "DecisionProba" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 12 AS node_id, NULL AS feature, CAST(NULL AS DOUBLE) AS threshold, 5 AS "count", 5 AS depth, 11 AS parent_id, 0.2 AS "Proba_0", -1.6094379124341003 AS "LogProba_0", 0.6 AS "Proba_1", -0.5108256237659907 AS "LogProba_1", 0.0 AS "Proba_2", -1.79769313486231e+308 AS "LogProba_2", 0.2 AS "Proba_3", -1.6094379124341003 AS "LogProba_3", 1 AS "Decision", 0.6 AS "DecisionProba" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 13 AS node_id, NULL AS feature, CAST(NULL AS DOUBLE) AS threshold, 5 AS "count", 5 AS depth, 11 AS parent_id, 0.0 AS "Proba_0", -1.79769313486231e+308 AS "LogProba_0", 0.0 AS "Proba_1", -1.79769313486231e+308 AS "LogProba_1", 1.0 AS "Proba_2", 0.0 AS "LogProba_2", 0.0 AS "Proba_3", -1.79769313486231e+308 AS "LogProba_3", 2 AS "Decision", 1.0 AS "DecisionProba" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 15 AS node_id, NULL AS feature, CAST(NULL AS DOUBLE) AS threshold, 3 AS "count", 5 AS depth, 14 AS parent_id, 1.0 AS "Proba_0", 0.0 AS "LogProba_0", 0.0 AS "Proba_1", -1.79769313486231e+308 AS "LogProba_1", 0.0 AS "Proba_2", -1.79769313486231e+308 AS "LogProba_2", 0.0 AS "Proba_3", -1.79769313486231e+308 AS "LogProba_3", 0 AS "Decision", 1.0 AS "DecisionProba" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 16 AS node_id, NULL AS feature, CAST(NULL AS DOUBLE) AS threshold, 24 AS "count", 5 AS depth, 14 AS parent_id, 0.0 AS "Proba_0", -1.79769313486231e+308 AS "LogProba_0", 1.0 AS "Proba_1", 0.0 AS "LogProba_1", 0.0 AS "Proba_2", -1.79769313486231e+308 AS "LogProba_2", 0.0 AS "Proba_3", -1.79769313486231e+308 AS "LogProba_3", 1 AS "Decision", 1.0 AS "DecisionProba" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 19 AS node_id, NULL AS feature, CAST(NULL AS DOUBLE) AS threshold, 7 AS "count", 4 AS depth, 18 AS parent_id, 0.0 AS "Proba_0", -1.79769313486231e+308 AS "LogProba_0", 1.0 AS "Proba_1", 0.0 AS "LogProba_1", 0.0 AS "Proba_2", -1.79769313486231e+308 AS "LogProba_2", 0.0 AS "Proba_3", -1.79769313486231e+308 AS "LogProba_3", 1 AS "Decision", 1.0 AS "DecisionProba" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 20 AS node_id, NULL AS feature, CAST(NULL AS DOUBLE) AS threshold, 1 AS "count", 4 AS depth, 18 AS parent_id, 0.0 AS "Proba_0", -1.79769313486231e+308 AS "LogProba_0", 0.0 AS "Proba_1", -1.79769313486231e+308 AS "LogProba_1", 0.0 AS "Proba_2", -1.79769313486231e+308 AS "LogProba_2", 1.0 AS "Proba_3", 0.0 AS "LogProba_3", 3 AS "Decision", 1.0 AS "DecisionProba" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 23 AS node_id, NULL AS feature, CAST(NULL AS DOUBLE) AS threshold, 9 AS "count", 5 AS depth, 22 AS parent_id, 0.1111111111111111 AS "Proba_0", -2.1972245773362196 AS "LogProba_0", 0.0 AS "Proba_1", -1.79769313486231e+308 AS "LogProba_1", 0.0 AS "Proba_2", -1.79769313486231e+308 AS "LogProba_2", 0.8888888888888888 AS "Proba_3", -0.11778303565638351 AS "LogProba_3", 3 AS "Decision", 0.8888888888888888 AS "DecisionProba" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 24 AS node_id, NULL AS feature, CAST(NULL AS DOUBLE) AS threshold, 10 AS "count", 5 AS depth, 22 AS parent_id, 0.2 AS "Proba_0", -1.6094379124341003 AS "LogProba_0", 0.5 AS "Proba_1", -0.6931471805599453 AS "LogProba_1", 0.2 AS "Proba_2", -1.6094379124341003 AS "LogProba_2", 0.1 AS "Proba_3", -2.3025850929940455 AS "LogProba_3", 1 AS "Decision", 0.5 AS "DecisionProba" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 26 AS node_id, NULL AS feature, CAST(NULL AS DOUBLE) AS threshold, 105 AS "count", 5 AS depth, 25 AS parent_id, 0.6095238095238096 AS "Proba_0", -0.4950772667978514 AS "LogProba_0", 0.10476190476190476 AS "Proba_1", -2.256065077359153 AS "LogProba_1", 0.19047619047619047 AS "Proba_2", -1.6582280766035324 AS "LogProba_2", 0.09523809523809523 AS "Proba_3", -2.3513752571634776 AS "LogProba_3", 0 AS "Decision", 0.6095238095238096 AS "DecisionProba" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 27 AS node_id, NULL AS feature, CAST(NULL AS DOUBLE) AS threshold, 10 AS "count", 5 AS depth, 25 AS parent_id, 0.0 AS "Proba_0", -1.79769313486231e+308 AS "LogProba_0", 0.4 AS "Proba_1", -0.916290731874155 AS "LogProba_1", 0.6 AS "Proba_2", -0.5108256237659907 AS "LogProba_2", 0.0 AS "Proba_3", -1.79769313486231e+308 AS "LogProba_3", 2 AS "Decision", 0.6 AS "DecisionProba" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 31 AS node_id, NULL AS feature, CAST(NULL AS DOUBLE) AS threshold, 22 AS "count", 4 AS depth, 30 AS parent_id, 0.0 AS "Proba_0", -1.79769313486231e+308 AS "LogProba_0", 0.0 AS "Proba_1", -1.79769313486231e+308 AS "LogProba_1", 0.0 AS "Proba_2", -1.79769313486231e+308 AS "LogProba_2", 1.0 AS "Proba_3", 0.0 AS "LogProba_3", 3 AS "Decision", 1.0 AS "DecisionProba" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 32 AS node_id, NULL AS feature, CAST(NULL AS DOUBLE) AS threshold, 1 AS "count", 4 AS depth, 30 AS parent_id, 0.0 AS "Proba_0", -1.79769313486231e+308 AS "LogProba_0", 0.0 AS "Proba_1", -1.79769313486231e+308 AS "LogProba_1", 1.0 AS "Proba_2", 0.0 AS "LogProba_2", 0.0 AS "Proba_3", -1.79769313486231e+308 AS "LogProba_3", 2 AS "Decision", 1.0 AS "DecisionProba" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 34 AS node_id, NULL AS feature, CAST(NULL AS DOUBLE) AS threshold, 3 AS "count", 4 AS depth, 33 AS parent_id, 0.0 AS "Proba_0", -1.79769313486231e+308 AS "LogProba_0", 1.0 AS "Proba_1", 0.0 AS "LogProba_1", 0.0 AS "Proba_2", -1.79769313486231e+308 AS "LogProba_2", 0.0 AS "Proba_3", -1.79769313486231e+308 AS "LogProba_3", 1 AS "Decision", 1.0 AS "DecisionProba" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 36 AS node_id, NULL AS feature, CAST(NULL AS DOUBLE) AS threshold, 1 AS "count", 5 AS depth, 35 AS parent_id, 0.0 AS "Proba_0", -1.79769313486231e+308 AS "LogProba_0", 0.0 AS "Proba_1", -1.79769313486231e+308 AS "LogProba_1", 0.0 AS "Proba_2", -1.79769313486231e+308 AS "LogProba_2", 1.0 AS "Proba_3", 0.0 AS "LogProba_3", 3 AS "Decision", 1.0 AS "DecisionProba" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 37 AS node_id, NULL AS feature, CAST(NULL AS DOUBLE) AS threshold, 1 AS "count", 5 AS depth, 35 AS parent_id, 0.0 AS "Proba_0", -1.79769313486231e+308 AS "LogProba_0", 0.0 AS "Proba_1", -1.79769313486231e+308 AS "LogProba_1", 1.0 AS "Proba_2", 0.0 AS "LogProba_2", 0.0 AS "Proba_3", -1.79769313486231e+308 AS "LogProba_3", 2 AS "Decision", 1.0 AS "DecisionProba" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 41 AS node_id, NULL AS feature, CAST(NULL AS DOUBLE) AS threshold, 10 AS "count", 5 AS depth, 40 AS parent_id, 0.0 AS "Proba_0", -1.79769313486231e+308 AS "LogProba_0", 1.0 AS "Proba_1", 0.0 AS "LogProba_1", 0.0 AS "Proba_2", -1.79769313486231e+308 AS "LogProba_2", 0.0 AS "Proba_3", -1.79769313486231e+308 AS "LogProba_3", 1 AS "Decision", 1.0 AS "DecisionProba" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 42 AS node_id, NULL AS feature, CAST(NULL AS DOUBLE) AS threshold, 25 AS "count", 5 AS depth, 40 AS parent_id, 0.12 AS "Proba_0", -2.120263536200091 AS "LogProba_0", 0.28 AS "Proba_1", -1.2729656758128873 AS "LogProba_1", 0.12 AS "Proba_2", -2.120263536200091 AS "LogProba_2", 0.48 AS "Proba_3", -0.7339691750802004 AS "LogProba_3", 3 AS "Decision", 0.48 AS "DecisionProba" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 44 AS node_id, NULL AS feature, CAST(NULL AS DOUBLE) AS threshold, 81 AS "count", 5 AS depth, 43 AS parent_id, 0.12345679012345678 AS "Proba_0", -2.0918640616783932 AS "LogProba_0", 0.12345679012345678 AS "Proba_1", -2.0918640616783932 AS "LogProba_1", 0.5185185185185185 AS "Proba_2", -0.6567795363890705 AS "LogProba_2", 0.2345679012345679 AS "Proba_3", -1.4500101755059984 AS "LogProba_3", 2 AS "Decision", 0.5185185185185185 AS "DecisionProba" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 45 AS node_id, NULL AS feature, CAST(NULL AS DOUBLE) AS threshold, 126 AS "count", 5 AS depth, 43 AS parent_id, 0.3412698412698413 AS "Proba_0", -1.0750817912579156 AS "LogProba_0", 0.2222222222222222 AS "Proba_1", -1.5040773967762742 AS "LogProba_1", 0.2619047619047619 AS "Proba_2", -1.3397743454849977 AS "LogProba_2", 0.1746031746031746 AS "Proba_3", -1.7452394535931621 AS "LogProba_3", 0 AS "Decision", 0.3412698412698413 AS "DecisionProba" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 48 AS node_id, NULL AS feature, CAST(NULL AS DOUBLE) AS threshold, 14 AS "count", 5 AS depth, 47 AS parent_id, 0.07142857142857142 AS "Proba_0", -2.639057329615259 AS "LogProba_0", 0.8571428571428571 AS "Proba_1", -0.15415067982725836 AS "LogProba_1", 0.07142857142857142 AS "Proba_2", -2.639057329615259 AS "LogProba_2", 0.0 AS "Proba_3", -1.79769313486231e+308 AS "LogProba_3", 1 AS "Decision", 0.8571428571428571 AS "DecisionProba" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 49 AS node_id, NULL AS feature, CAST(NULL AS DOUBLE) AS threshold, 12 AS "count", 5 AS depth, 47 AS parent_id, 0.25 AS "Proba_0", -1.3862943611198906 AS "LogProba_0", 0.08333333333333333 AS "Proba_1", -2.4849066497880004 AS "LogProba_1", 0.25 AS "Proba_2", -1.3862943611198906 AS "LogProba_2", 0.4166666666666667 AS "Proba_3", -0.8754687373538999 AS "LogProba_3", 3 AS "Decision", 0.4166666666666667 AS "DecisionProba" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 51 AS node_id, NULL AS feature, CAST(NULL AS DOUBLE) AS threshold, 33 AS "count", 5 AS depth, 50 AS parent_id, 0.030303030303030304 AS "Proba_0", -3.4965075614664802 AS "LogProba_0", 0.18181818181818182 AS "Proba_1", -1.7047480922384253 AS "LogProba_1", 0.45454545454545453 AS "Proba_2", -0.7884573603642702 AS "LogProba_2", 0.3333333333333333 AS "Proba_3", -1.0986122886681098 AS "LogProba_3", 2 AS "Decision", 0.45454545454545453 AS "DecisionProba" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 52 AS node_id, NULL AS feature, CAST(NULL AS DOUBLE) AS threshold, 44 AS "count", 5 AS depth, 50 AS parent_id, 0.022727272727272728 AS "Proba_0", -3.784189633918261 AS "LogProba_0", 0.13636363636363635 AS "Proba_1", -1.9924301646902063 AS "LogProba_1", 0.09090909090909091 AS "Proba_2", -2.3978952727983707 AS "LogProba_2", 0.75 AS "Proba_3", -0.2876820724517809 AS "LogProba_3", 3 AS "Decision", 0.75 AS "DecisionProba" FROM SYSIBM.SYSDUMMY1) AS "Values"), 
"DT_Output_3" AS 
...
(SELECT "DT_Output_3"."KEY" AS "KEY", CAST(NULL AS DOUBLE) AS "Score_0", CAST(NULL AS DOUBLE) AS "Score_1", CAST(NULL AS DOUBLE) AS "Score_2", CAST(NULL AS DOUBLE) AS "Score_3", "DT_Output_3"."Proba_0" AS "Proba_0", "DT_Output_3"."Proba_1" AS "Proba_1", "DT_Output_3"."Proba_2" AS "Proba_2", "DT_Output_3"."Proba_3" AS "Proba_3", "DT_Output_3"."LogProba_0" AS "LogProba_0", "DT_Output_3"."LogProba_1" AS "LogProba_1", "DT_Output_3"."LogProba_2" AS "LogProba_2", "DT_Output_3"."LogProba_3" AS "LogProba_3", NULL AS "Decision", CAST(NULL AS DOUBLE) AS "DecisionProba", coalesce(CAST(NULL AS DOUBLE), "DT_Output_3"."Proba_0") AS "ScoreOrProba_0", coalesce(CAST(NULL AS DOUBLE), "DT_Output_3"."Proba_1") AS "ScoreOrProba_1", coalesce(CAST(NULL AS DOUBLE), "DT_Output_3"."Proba_2") AS "ScoreOrProba_2", coalesce(CAST(NULL AS DOUBLE), "DT_Output_3"."Proba_3") AS "ScoreOrProba_3" 
FROM "DT_Output_3"), 
sigmoid_calibration_3 AS 
(SELECT "Calibrated_Model_3"."KEY" AS "KEY", 1.0 / (1.0 + exp(least(greatest(-100.0, -(1.6555122652934657 * "Calibrated_Model_3"."ScoreOrProba_0" + -1.6171430979278207)), 100.0))) AS "Proba_0", 1.0 / (1.0 + exp(least(greatest(-100.0, -(0.5408301791954305 * "Calibrated_Model_3"."ScoreOrProba_1" + -1.2218654025619988)), 100.0))) AS "Proba_1", 1.0 / (1.0 + exp(least(greatest(-100.0, -(0.20523725572835624 * "Calibrated_Model_3"."ScoreOrProba_2" + -1.1339964042244912)), 100.0))) AS "Proba_2", 1.0 / (1.0 + exp(least(greatest(-100.0, -(1.3273710457263495 * "Calibrated_Model_3"."ScoreOrProba_3" + -1.4408243367861748)), 100.0))) AS "Proba_3" 
...
-- Code For temporary table tmp_20180417002024_41ytt4_calprob_union part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180417002024_41ytt4_calprob_union (
	"KEY" BIGINT, 
	"Proba_0" DOUBLE, 
	"Proba_1" DOUBLE, 
	"Proba_2" DOUBLE, 
...
-- Code For temporary table tmp_20180417002024_41ytt4_calprob_union part 2/2. Populate

INSERT INTO tmp_20180417002024_41ytt4_calprob_union SELECT "CalProb_Union"."KEY", "CalProb_Union"."Proba_0", "CalProb_Union"."Proba_1", "CalProb_Union"."Proba_2", "CalProb_Union"."Proba_3" 
...
FROM tmp_20180417002024_7owyj1_calprob_b0 AS "CalProb_B0") AS "CalProb_EnsembleUnion") AS "CalProb_Union"

-- Code For temporary table tmp_20180417002024_c7x3fh_calprob_avg part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180417002024_c7x3fh_calprob_avg (
	"KEY" BIGINT, 
	"Proba_0" FLOAT, 
	"Proba_1" FLOAT, 
	"Proba_2" FLOAT, 
...
-- Code For temporary table tmp_20180417002024_c7x3fh_calprob_avg part 2/2. Populate

INSERT INTO tmp_20180417002024_c7x3fh_calprob_avg SELECT "CalProb_avg"."KEY", "CalProb_avg"."Proba_0", "CalProb_avg"."Proba_1", "CalProb_avg"."Proba_2", "CalProb_avg"."Proba_3" 
...
FROM tmp_20180417002024_41ytt4_calprob_union AS "CalProb_Union" GROUP BY "CalProb_Union"."KEY") AS "T") AS "CalProb_avg"
...
FROM tmp_20180417002024_c7x3fh_calprob_avg AS "CalProb_avg"), 
