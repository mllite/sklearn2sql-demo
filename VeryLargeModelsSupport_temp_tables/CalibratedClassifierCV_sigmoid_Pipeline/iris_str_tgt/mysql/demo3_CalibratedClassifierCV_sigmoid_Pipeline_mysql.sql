...
-- Code For temporary table TMP_20180417050900_JZD95Q_ADS_imp_1_OUT part 1/2. Create 


CREATE TEMPORARY TABLE `TMP_20180417050900_JZD95Q_ADS_imp_1_OUT` (
	`KEY` BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20180417050900_JZD95Q_ADS_imp_1_OUT part 2/2. Populate

INSERT INTO `TMP_20180417050900_JZD95Q_ADS_imp_1_OUT` (`KEY`, imputer_output_2, imputer_output_3, imputer_output_4, imputer_output_5) SELECT `U`.`KEY`, `U`.imputer_output_2, `U`.imputer_output_3, `U`.imputer_output_4, `U`.imputer_output_5 
...
-- Code For temporary table TMP_20180417050900_X6BMRO_ADS_sca_2_OUT part 1/2. Create 


CREATE TEMPORARY TABLE `TMP_20180417050900_X6BMRO_ADS_sca_2_OUT` (
	`KEY` BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20180417050900_X6BMRO_ADS_sca_2_OUT part 2/2. Populate

INSERT INTO `TMP_20180417050900_X6BMRO_ADS_sca_2_OUT` (`KEY`, scaler_output_2, scaler_output_3, scaler_output_4, scaler_output_5) SELECT `U`.`KEY`, `U`.scaler_output_2, `U`.scaler_output_3, `U`.scaler_output_4, `U`.scaler_output_5 
...
FROM `TMP_20180417050900_JZD95Q_ADS_imp_1_OUT` AS `ADS_imp_1_OUT`) AS `ADS_sca_2_OUT`) AS `U`

-- Code For temporary table TMP_20180417050900_UNFMXT_CalProb_B0 part 1/2. Create 


CREATE TEMPORARY TABLE `TMP_20180417050900_UNFMXT_CalProb_B0` (
	`KEY` BIGINT, 
...
-- Code For temporary table TMP_20180417050900_UNFMXT_CalProb_B0 part 2/2. Populate

INSERT INTO `TMP_20180417050900_UNFMXT_CalProb_B0` (`KEY`, `Proba_CLASS_0`, `Proba_CLASS_1`, `Proba_CLASS_2`) SELECT `U`.`KEY`, `U`.`Proba_CLASS_0`, `U`.`Proba_CLASS_1`, `U`.`Proba_CLASS_2` 
...
(SELECT `DT_Output`.`KEY` AS `KEY`, NULL AS `Score_CLASS_0`, NULL AS `Score_CLASS_1`, NULL AS `Score_CLASS_2`, `DT_Output`.`Proba_CLASS_0` AS `Proba_CLASS_0`, `DT_Output`.`Proba_CLASS_1` AS `Proba_CLASS_1`, `DT_Output`.`Proba_CLASS_2` AS `Proba_CLASS_2`, `DT_Output`.`LogProba_CLASS_0` AS `LogProba_CLASS_0`, `DT_Output`.`LogProba_CLASS_1` AS `LogProba_CLASS_1`, `DT_Output`.`LogProba_CLASS_2` AS `LogProba_CLASS_2`, CAST(NULL AS SIGNED INTEGER) AS `Decision`, NULL AS `DecisionProba`, coalesce(NULL, `DT_Output`.`Proba_CLASS_0`) AS `ScoreOrProba_CLASS_0`, coalesce(NULL, `DT_Output`.`Proba_CLASS_1`) AS `ScoreOrProba_CLASS_1`, coalesce(NULL, `DT_Output`.`Proba_CLASS_2`) AS `ScoreOrProba_CLASS_2` 
FROM `DT_Output`), 
...
`DT_node_data_1` AS 
(SELECT `Values`.node_id AS node_id, `Values`.feature AS feature, `Values`.threshold AS threshold, `Values`.count AS count, `Values`.depth AS depth, `Values`.parent_id AS parent_id, `Values`.`Proba_CLASS_0` AS `Proba_CLASS_0`, `Values`.`LogProba_CLASS_0` AS `LogProba_CLASS_0`, `Values`.`Proba_CLASS_1` AS `Proba_CLASS_1`, `Values`.`LogProba_CLASS_1` AS `LogProba_CLASS_1`, `Values`.`Proba_CLASS_2` AS `Proba_CLASS_2`, `Values`.`LogProba_CLASS_2` AS `LogProba_CLASS_2`, `Values`.`Decision` AS `Decision`, `Values`.`DecisionProba` AS `DecisionProba` 
FROM (SELECT 1 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 28 AS count, 1 AS depth, 0 AS parent_id, 1.0 AS `Proba_CLASS_0`, 0.0 AS `LogProba_CLASS_0`, 0.0 AS `Proba_CLASS_1`, -1.79769313486231e+308 AS `LogProba_CLASS_1`, 0.0 AS `Proba_CLASS_2`, -1.79769313486231e+308 AS `LogProba_CLASS_2`, 'CLASS_0' AS `Decision`, 1.0 AS `DecisionProba` UNION ALL SELECT 4 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 28 AS count, 3 AS depth, 3 AS parent_id, 0.0 AS `Proba_CLASS_0`, -1.79769313486231e+308 AS `LogProba_CLASS_0`, 1.0 AS `Proba_CLASS_1`, 0.0 AS `LogProba_CLASS_1`, 0.0 AS `Proba_CLASS_2`, -1.79769313486231e+308 AS `LogProba_CLASS_2`, 'CLASS_1' AS `Decision`, 1.0 AS `DecisionProba` UNION ALL SELECT 6 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 4 AS count, 4 AS depth, 5 AS parent_id, 0.0 AS `Proba_CLASS_0`, -1.79769313486231e+308 AS `LogProba_CLASS_0`, 0.0 AS `Proba_CLASS_1`, -1.79769313486231e+308 AS `LogProba_CLASS_1`, 1.0 AS `Proba_CLASS_2`, 0.0 AS `LogProba_CLASS_2`, 'CLASS_2' AS `Decision`, 1.0 AS `DecisionProba` UNION ALL SELECT 7 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 1 AS count, 4 AS depth, 5 AS parent_id, 0.0 AS `Proba_CLASS_0`, -1.79769313486231e+308 AS `LogProba_CLASS_0`, 1.0 AS `Proba_CLASS_1`, 0.0 AS `LogProba_CLASS_1`, 0.0 AS `Proba_CLASS_2`, -1.79769313486231e+308 AS `LogProba_CLASS_2`, 'CLASS_1' AS `Decision`, 1.0 AS `DecisionProba` UNION ALL SELECT 10 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 2 AS count, 4 AS depth, 9 AS parent_id, 0.0 AS `Proba_CLASS_0`, -1.79769313486231e+308 AS `LogProba_CLASS_0`, 0.0 AS `Proba_CLASS_1`, -1.79769313486231e+308 AS `LogProba_CLASS_1`, 1.0 AS `Proba_CLASS_2`, 0.0 AS `LogProba_CLASS_2`, 'CLASS_2' AS `Decision`, 1.0 AS `DecisionProba` UNION ALL SELECT 11 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 1 AS count, 4 AS depth, 9 AS parent_id, 0.0 AS `Proba_CLASS_0`, -1.79769313486231e+308 AS `LogProba_CLASS_0`, 1.0 AS `Proba_CLASS_1`, 0.0 AS `LogProba_CLASS_1`, 0.0 AS `Proba_CLASS_2`, -1.79769313486231e+308 AS `LogProba_CLASS_2`, 'CLASS_1' AS `Decision`, 1.0 AS `DecisionProba` UNION ALL SELECT 12 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 26 AS count, 3 AS depth, 8 AS parent_id, 0.0 AS `Proba_CLASS_0`, -1.79769313486231e+308 AS `LogProba_CLASS_0`, 0.0 AS `Proba_CLASS_1`, -1.79769313486231e+308 AS `LogProba_CLASS_1`, 1.0 AS `Proba_CLASS_2`, 0.0 AS `LogProba_CLASS_2`, 'CLASS_2' AS `Decision`, 1.0 AS `DecisionProba`) AS `Values`), 
`DT_Output_1` AS 
...
`DT_node_data_2` AS 
(SELECT `Values`.node_id AS node_id, `Values`.feature AS feature, `Values`.threshold AS threshold, `Values`.count AS count, `Values`.depth AS depth, `Values`.parent_id AS parent_id, `Values`.`Proba_CLASS_0` AS `Proba_CLASS_0`, `Values`.`LogProba_CLASS_0` AS `LogProba_CLASS_0`, `Values`.`Proba_CLASS_1` AS `Proba_CLASS_1`, `Values`.`LogProba_CLASS_1` AS `LogProba_CLASS_1`, `Values`.`Proba_CLASS_2` AS `Proba_CLASS_2`, `Values`.`LogProba_CLASS_2` AS `LogProba_CLASS_2`, `Values`.`Decision` AS `Decision`, `Values`.`DecisionProba` AS `DecisionProba` 
FROM (SELECT 1 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 28 AS count, 1 AS depth, 0 AS parent_id, 1.0 AS `Proba_CLASS_0`, 0.0 AS `LogProba_CLASS_0`, 0.0 AS `Proba_CLASS_1`, -1.79769313486231e+308 AS `LogProba_CLASS_1`, 0.0 AS `Proba_CLASS_2`, -1.79769313486231e+308 AS `LogProba_CLASS_2`, 'CLASS_0' AS `Decision`, 1.0 AS `DecisionProba` UNION ALL SELECT 5 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 1 AS count, 4 AS depth, 4 AS parent_id, 0.0 AS `Proba_CLASS_0`, -1.79769313486231e+308 AS `LogProba_CLASS_0`, 0.0 AS `Proba_CLASS_1`, -1.79769313486231e+308 AS `LogProba_CLASS_1`, 1.0 AS `Proba_CLASS_2`, 0.0 AS `LogProba_CLASS_2`, 'CLASS_2' AS `Decision`, 1.0 AS `DecisionProba` UNION ALL SELECT 6 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 29 AS count, 4 AS depth, 4 AS parent_id, 0.0 AS `Proba_CLASS_0`, -1.79769313486231e+308 AS `LogProba_CLASS_0`, 1.0 AS `Proba_CLASS_1`, 0.0 AS `LogProba_CLASS_1`, 0.0 AS `Proba_CLASS_2`, -1.79769313486231e+308 AS `LogProba_CLASS_2`, 'CLASS_1' AS `Decision`, 1.0 AS `DecisionProba` UNION ALL SELECT 8 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 2 AS count, 4 AS depth, 7 AS parent_id, 0.0 AS `Proba_CLASS_0`, -1.79769313486231e+308 AS `LogProba_CLASS_0`, 0.0 AS `Proba_CLASS_1`, -1.79769313486231e+308 AS `LogProba_CLASS_1`, 1.0 AS `Proba_CLASS_2`, 0.0 AS `LogProba_CLASS_2`, 'CLASS_2' AS `Decision`, 1.0 AS `DecisionProba` UNION ALL SELECT 9 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 1 AS count, 4 AS depth, 7 AS parent_id, 0.0 AS `Proba_CLASS_0`, -1.79769313486231e+308 AS `LogProba_CLASS_0`, 1.0 AS `Proba_CLASS_1`, 0.0 AS `LogProba_CLASS_1`, 0.0 AS `Proba_CLASS_2`, -1.79769313486231e+308 AS `LogProba_CLASS_2`, 'CLASS_1' AS `Decision`, 1.0 AS `DecisionProba` UNION ALL SELECT 10 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 29 AS count, 2 AS depth, 2 AS parent_id, 0.0 AS `Proba_CLASS_0`, -1.79769313486231e+308 AS `LogProba_CLASS_0`, 0.0 AS `Proba_CLASS_1`, -1.79769313486231e+308 AS `LogProba_CLASS_1`, 1.0 AS `Proba_CLASS_2`, 0.0 AS `LogProba_CLASS_2`, 'CLASS_2' AS `Decision`, 1.0 AS `DecisionProba`) AS `Values`), 
`DT_Output_2` AS 
...
(SELECT `DT_Output_2`.`KEY` AS `KEY`, NULL AS `Score_CLASS_0`, NULL AS `Score_CLASS_1`, NULL AS `Score_CLASS_2`, `DT_Output_2`.`Proba_CLASS_0` AS `Proba_CLASS_0`, `DT_Output_2`.`Proba_CLASS_1` AS `Proba_CLASS_1`, `DT_Output_2`.`Proba_CLASS_2` AS `Proba_CLASS_2`, `DT_Output_2`.`LogProba_CLASS_0` AS `LogProba_CLASS_0`, `DT_Output_2`.`LogProba_CLASS_1` AS `LogProba_CLASS_1`, `DT_Output_2`.`LogProba_CLASS_2` AS `LogProba_CLASS_2`, CAST(NULL AS SIGNED INTEGER) AS `Decision`, NULL AS `DecisionProba`, coalesce(NULL, `DT_Output_2`.`Proba_CLASS_0`) AS `ScoreOrProba_CLASS_0`, coalesce(NULL, `DT_Output_2`.`Proba_CLASS_1`) AS `ScoreOrProba_CLASS_1`, coalesce(NULL, `DT_Output_2`.`Proba_CLASS_2`) AS `ScoreOrProba_CLASS_2` 
FROM `DT_Output_2`), 
...
`DT_node_data_3` AS 
(SELECT `Values`.node_id AS node_id, `Values`.feature AS feature, `Values`.threshold AS threshold, `Values`.count AS count, `Values`.depth AS depth, `Values`.parent_id AS parent_id, `Values`.`Proba_CLASS_0` AS `Proba_CLASS_0`, `Values`.`LogProba_CLASS_0` AS `LogProba_CLASS_0`, `Values`.`Proba_CLASS_1` AS `Proba_CLASS_1`, `Values`.`LogProba_CLASS_1` AS `LogProba_CLASS_1`, `Values`.`Proba_CLASS_2` AS `Proba_CLASS_2`, `Values`.`LogProba_CLASS_2` AS `LogProba_CLASS_2`, `Values`.`Decision` AS `Decision`, `Values`.`DecisionProba` AS `DecisionProba` 
FROM (SELECT 1 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 28 AS count, 1 AS depth, 0 AS parent_id, 1.0 AS `Proba_CLASS_0`, 0.0 AS `LogProba_CLASS_0`, 0.0 AS `Proba_CLASS_1`, -1.79769313486231e+308 AS `LogProba_CLASS_1`, 0.0 AS `Proba_CLASS_2`, -1.79769313486231e+308 AS `LogProba_CLASS_2`, 'CLASS_0' AS `Decision`, 1.0 AS `DecisionProba` UNION ALL SELECT 4 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 28 AS count, 3 AS depth, 3 AS parent_id, 0.0 AS `Proba_CLASS_0`, -1.79769313486231e+308 AS `LogProba_CLASS_0`, 1.0 AS `Proba_CLASS_1`, 0.0 AS `LogProba_CLASS_1`, 0.0 AS `Proba_CLASS_2`, -1.79769313486231e+308 AS `LogProba_CLASS_2`, 'CLASS_1' AS `Decision`, 1.0 AS `DecisionProba` UNION ALL SELECT 6 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 2 AS count, 4 AS depth, 5 AS parent_id, 0.0 AS `Proba_CLASS_0`, -1.79769313486231e+308 AS `LogProba_CLASS_0`, 0.0 AS `Proba_CLASS_1`, -1.79769313486231e+308 AS `LogProba_CLASS_1`, 1.0 AS `Proba_CLASS_2`, 0.0 AS `LogProba_CLASS_2`, 'CLASS_2' AS `Decision`, 1.0 AS `DecisionProba` UNION ALL SELECT 7 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 1 AS count, 4 AS depth, 5 AS parent_id, 0.0 AS `Proba_CLASS_0`, -1.79769313486231e+308 AS `LogProba_CLASS_0`, 1.0 AS `Proba_CLASS_1`, 0.0 AS `LogProba_CLASS_1`, 0.0 AS `Proba_CLASS_2`, -1.79769313486231e+308 AS `LogProba_CLASS_2`, 'CLASS_1' AS `Decision`, 1.0 AS `DecisionProba` UNION ALL SELECT 10 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 1 AS count, 4 AS depth, 9 AS parent_id, 0.0 AS `Proba_CLASS_0`, -1.79769313486231e+308 AS `LogProba_CLASS_0`, 1.0 AS `Proba_CLASS_1`, 0.0 AS `LogProba_CLASS_1`, 0.0 AS `Proba_CLASS_2`, -1.79769313486231e+308 AS `LogProba_CLASS_2`, 'CLASS_1' AS `Decision`, 1.0 AS `DecisionProba` UNION ALL SELECT 11 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 2 AS count, 4 AS depth, 9 AS parent_id, 0.0 AS `Proba_CLASS_0`, -1.79769313486231e+308 AS `LogProba_CLASS_0`, 0.0 AS `Proba_CLASS_1`, -1.79769313486231e+308 AS `LogProba_CLASS_1`, 1.0 AS `Proba_CLASS_2`, 0.0 AS `LogProba_CLASS_2`, 'CLASS_2' AS `Decision`, 1.0 AS `DecisionProba` UNION ALL SELECT 12 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 29 AS count, 3 AS depth, 8 AS parent_id, 0.0 AS `Proba_CLASS_0`, -1.79769313486231e+308 AS `LogProba_CLASS_0`, 0.0 AS `Proba_CLASS_1`, -1.79769313486231e+308 AS `LogProba_CLASS_1`, 1.0 AS `Proba_CLASS_2`, 0.0 AS `LogProba_CLASS_2`, 'CLASS_2' AS `Decision`, 1.0 AS `DecisionProba`) AS `Values`), 
`DT_Output_3` AS 
...
-- Code For temporary table TMP_20180417050900_FN785V_CalProb_Union part 1/2. Create 


CREATE TEMPORARY TABLE `TMP_20180417050900_FN785V_CalProb_Union` (
	`KEY` BIGINT, 
	`Proba_CLASS_0` DOUBLE, 
	`Proba_CLASS_1` DOUBLE, 
	`Proba_CLASS_2` DOUBLE
...
-- Code For temporary table TMP_20180417050900_FN785V_CalProb_Union part 2/2. Populate

INSERT INTO `TMP_20180417050900_FN785V_CalProb_Union` (`KEY`, `Proba_CLASS_0`, `Proba_CLASS_1`, `Proba_CLASS_2`) SELECT `U`.`KEY`, `U`.`Proba_CLASS_0`, `U`.`Proba_CLASS_1`, `U`.`Proba_CLASS_2` 
...
FROM `TMP_20180417050900_UNFMXT_CalProb_B0` AS `CalProb_B0`) AS `CalProb_EnsembleUnion`) AS `CalProb_Union`) AS `U`

-- Code For temporary table TMP_20180417050900_C18PAP_CalProb_avg part 1/2. Create 


CREATE TEMPORARY TABLE `TMP_20180417050900_C18PAP_CalProb_avg` (
	`KEY` BIGINT NOT NULL, 
	`Proba_CLASS_0` DOUBLE, 
	`Proba_CLASS_1` DOUBLE, 
	`Proba_CLASS_2` DOUBLE, 
...
-- Code For temporary table TMP_20180417050900_C18PAP_CalProb_avg part 2/2. Populate

INSERT INTO `TMP_20180417050900_C18PAP_CalProb_avg` (`KEY`, `Proba_CLASS_0`, `Proba_CLASS_1`, `Proba_CLASS_2`) SELECT `U`.`KEY`, `U`.`Proba_CLASS_0`, `U`.`Proba_CLASS_1`, `U`.`Proba_CLASS_2` 
...
FROM `TMP_20180417050900_FN785V_CalProb_Union` AS `CalProb_Union` GROUP BY `CalProb_Union`.`KEY`) AS `T`) AS `CalProb_avg`) AS `U`
...
FROM `TMP_20180417050900_C18PAP_CalProb_avg` AS `CalProb_avg`), 
