...
-- Code For temporary table tmp_20180417050903_l3bj20_ads_imp_1_out part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180417050903_l3bj20_ads_imp_1_out (
	"KEY" BIGINT, 
...
-- Code For temporary table tmp_20180417050903_l3bj20_ads_imp_1_out part 2/2. Populate

INSERT INTO tmp_20180417050903_l3bj20_ads_imp_1_out SELECT "ADS_imp_1_OUT"."KEY", "ADS_imp_1_OUT".imputer_output_2, "ADS_imp_1_OUT".imputer_output_3, "ADS_imp_1_OUT".imputer_output_4, "ADS_imp_1_OUT".imputer_output_5 
...
-- Code For temporary table tmp_20180417050903_3c1uyy_ads_sca_2_out part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180417050903_3c1uyy_ads_sca_2_out (
	"KEY" BIGINT, 
...
-- Code For temporary table tmp_20180417050903_3c1uyy_ads_sca_2_out part 2/2. Populate

INSERT INTO tmp_20180417050903_3c1uyy_ads_sca_2_out SELECT "ADS_sca_2_OUT"."KEY", "ADS_sca_2_OUT".scaler_output_2, "ADS_sca_2_OUT".scaler_output_3, "ADS_sca_2_OUT".scaler_output_4, "ADS_sca_2_OUT".scaler_output_5 
...
FROM tmp_20180417050903_l3bj20_ads_imp_1_out AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT"

-- Code For temporary table tmp_20180417050903_1c7hm4_calprob_b0 part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180417050903_1c7hm4_calprob_b0 (
	"KEY" BIGINT, 
...
-- Code For temporary table tmp_20180417050903_1c7hm4_calprob_b0 part 2/2. Populate

INSERT INTO tmp_20180417050903_1c7hm4_calprob_b0 WITH "DT_node_lookup" AS 
...
FROM tmp_20180417050903_3c1uyy_ads_sca_2_out AS "ADS_sca_2_OUT"), 
"DT_node_data" AS 
...
-- Code For temporary table tmp_20180417050903_ui9v5y_calprob_union part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180417050903_ui9v5y_calprob_union (
	"KEY" BIGINT, 
	"Proba_CLASS_0" DOUBLE, 
	"Proba_CLASS_1" DOUBLE, 
	"Proba_CLASS_2" DOUBLE
...
-- Code For temporary table tmp_20180417050903_ui9v5y_calprob_union part 2/2. Populate

INSERT INTO tmp_20180417050903_ui9v5y_calprob_union SELECT "CalProb_Union"."KEY", "CalProb_Union"."Proba_CLASS_0", "CalProb_Union"."Proba_CLASS_1", "CalProb_Union"."Proba_CLASS_2" 
...
FROM tmp_20180417050903_1c7hm4_calprob_b0 AS "CalProb_B0") AS "CalProb_EnsembleUnion") AS "CalProb_Union"

-- Code For temporary table tmp_20180417050903_45ekga_calprob_avg part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180417050903_45ekga_calprob_avg (
	"KEY" BIGINT, 
	"Proba_CLASS_0" FLOAT, 
	"Proba_CLASS_1" FLOAT, 
	"Proba_CLASS_2" FLOAT
...
-- Code For temporary table tmp_20180417050903_45ekga_calprob_avg part 2/2. Populate

INSERT INTO tmp_20180417050903_45ekga_calprob_avg SELECT "CalProb_avg"."KEY", "CalProb_avg"."Proba_CLASS_0", "CalProb_avg"."Proba_CLASS_1", "CalProb_avg"."Proba_CLASS_2" 
...
FROM tmp_20180417050903_ui9v5y_calprob_union AS "CalProb_Union" GROUP BY "CalProb_Union"."KEY") AS "T") AS "CalProb_avg"
...
FROM tmp_20180417050903_45ekga_calprob_avg AS "CalProb_avg"), 
