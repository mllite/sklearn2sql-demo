...
-- Code For temporary table TMP_20180417050900_4YO1DO_ADS_I part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180417050900_4YO1DO_ADS_I" (
	"KEY" BIGINT, 
...
-- Code For temporary table TMP_20180417050900_4YO1DO_ADS_I part 2/2. Populate

INSERT INTO "TMP_20180417050900_4YO1DO_ADS_I" ("KEY", imputer_output_2, imputer_output_3, imputer_output_4, imputer_output_5) SELECT "U"."KEY", "U".imputer_output_2, "U".imputer_output_3, "U".imputer_output_4, "U".imputer_output_5 
...
-- Code For temporary table TMP_20180417050900_N26D3A_ADS_S part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180417050900_N26D3A_ADS_S" (
	"KEY" BIGINT, 
...
-- Code For temporary table TMP_20180417050900_N26D3A_ADS_S part 2/2. Populate

INSERT INTO "TMP_20180417050900_N26D3A_ADS_S" ("KEY", scaler_output_2, scaler_output_3, scaler_output_4, scaler_output_5) SELECT "U"."KEY", "U".scaler_output_2, "U".scaler_output_3, "U".scaler_output_4, "U".scaler_output_5 
...
FROM "TMP_20180417050900_4YO1DO_ADS_I" AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT") AS "U"

-- Code For temporary table TMP_20180417050900_FI5REO_CALPR part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180417050900_FI5REO_CALPR" (
	"KEY" BIGINT, 
	"Proba_CLASS_0" FLOAT, 
	"Proba_CLASS_1" FLOAT, 
	"Proba_CLASS_2" FLOAT
...
-- Code For temporary table TMP_20180417050900_FI5REO_CALPR part 2/2. Populate

INSERT INTO "TMP_20180417050900_FI5REO_CALPR" ("KEY", "Proba_CLASS_0", "Proba_CLASS_1", "Proba_CLASS_2") SELECT "U"."KEY", "U"."Proba_CLASS_0", "U"."Proba_CLASS_1", "U"."Proba_CLASS_2" 
...
FROM "TMP_20180417050900_N26D3A_ADS_S" AS "ADS_sca_2_OUT"), 
"DT_node_data" AS 
...
-- Code For temporary table TMP_20180417050900_YRRJ7E_CALPR part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180417050900_YRRJ7E_CALPR" (
	"KEY" BIGINT, 
	"Proba_CLASS_0" FLOAT, 
	"Proba_CLASS_1" FLOAT, 
	"Proba_CLASS_2" FLOAT
...
-- Code For temporary table TMP_20180417050900_YRRJ7E_CALPR part 2/2. Populate

INSERT INTO "TMP_20180417050900_YRRJ7E_CALPR" ("KEY", "Proba_CLASS_0", "Proba_CLASS_1", "Proba_CLASS_2") SELECT "U"."KEY", "U"."Proba_CLASS_0", "U"."Proba_CLASS_1", "U"."Proba_CLASS_2" 
...
FROM "TMP_20180417050900_FI5REO_CALPR" AS "CalProb_B0") AS "CalProb_EnsembleUnion") AS "CalProb_Union") AS "U"

-- Code For temporary table TMP_20180417050900_ZU46XL_CALPR part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180417050900_ZU46XL_CALPR" (
	"KEY" BIGINT, 
	"Proba_CLASS_0" FLOAT, 
	"Proba_CLASS_1" FLOAT, 
	"Proba_CLASS_2" FLOAT
...
-- Code For temporary table TMP_20180417050900_ZU46XL_CALPR part 2/2. Populate

INSERT INTO "TMP_20180417050900_ZU46XL_CALPR" ("KEY", "Proba_CLASS_0", "Proba_CLASS_1", "Proba_CLASS_2") SELECT "U"."KEY", "U"."Proba_CLASS_0", "U"."Proba_CLASS_1", "U"."Proba_CLASS_2" 
...
FROM "TMP_20180417050900_YRRJ7E_CALPR" AS "CalProb_Union" GROUP BY "CalProb_Union"."KEY") AS "T") AS "CalProb_avg") AS "U"
...
FROM "TMP_20180417050900_ZU46XL_CALPR" AS "CalProb_avg"), 
