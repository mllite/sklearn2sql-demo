...
-- Code For temporary table TMP_20180416222632_2EQW87_ADS_imp_1_OUT part 1/2. Create 


CREATE TEMPORARY TABLE "TMP_20180416222632_2EQW87_ADS_imp_1_OUT" (
	"KEY" BIGINT NOT NULL, 
	impter_2 FLOAT, 
	impter_3 FLOAT, 
	impter_4 FLOAT, 
...
-- Code For temporary table TMP_20180416222632_2EQW87_ADS_imp_1_OUT part 2/2. Populate

INSERT INTO "TMP_20180416222632_2EQW87_ADS_imp_1_OUT" ("KEY", impter_2, impter_3, impter_4, impter_5, impter_6, impter_7, impter_8, impter_9, impter_10, impter_11) SELECT "ADS_imp_1_OUT"."KEY", "ADS_imp_1_OUT".impter_2, "ADS_imp_1_OUT".impter_3, "ADS_imp_1_OUT".impter_4, "ADS_imp_1_OUT".impter_5, "ADS_imp_1_OUT".impter_6, "ADS_imp_1_OUT".impter_7, "ADS_imp_1_OUT".impter_8, "ADS_imp_1_OUT".impter_9, "ADS_imp_1_OUT".impter_10, "ADS_imp_1_OUT".impter_11 
...
-- Code For temporary table TMP_20180416222632_6SMLD3_ADS_sca_2_OUT part 1/2. Create 


CREATE TEMPORARY TABLE "TMP_20180416222632_6SMLD3_ADS_sca_2_OUT" (
	"KEY" BIGINT NOT NULL, 
	scaler_2 FLOAT, 
	scaler_3 FLOAT, 
	scaler_4 FLOAT, 
...
-- Code For temporary table TMP_20180416222632_6SMLD3_ADS_sca_2_OUT part 2/2. Populate

INSERT INTO "TMP_20180416222632_6SMLD3_ADS_sca_2_OUT" ("KEY", scaler_2, scaler_3, scaler_4, scaler_5, scaler_6, scaler_7, scaler_8, scaler_9, scaler_10, scaler_11) SELECT "ADS_sca_2_OUT"."KEY", "ADS_sca_2_OUT".scaler_2, "ADS_sca_2_OUT".scaler_3, "ADS_sca_2_OUT".scaler_4, "ADS_sca_2_OUT".scaler_5, "ADS_sca_2_OUT".scaler_6, "ADS_sca_2_OUT".scaler_7, "ADS_sca_2_OUT".scaler_8, "ADS_sca_2_OUT".scaler_9, "ADS_sca_2_OUT".scaler_10, "ADS_sca_2_OUT".scaler_11 
...
FROM "TMP_20180416222632_2EQW87_ADS_imp_1_OUT" AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT"

-- Code For temporary table TMP_20180416222632_CMDHUO_CalProb_B0 part 1/2. Create 


CREATE TEMPORARY TABLE "TMP_20180416222632_CMDHUO_CalProb_B0" (
	"KEY" BIGINT, 
	"Proba_1" FLOAT, 
	"Proba_0" FLOAT
)
...
-- Code For temporary table TMP_20180416222632_CMDHUO_CalProb_B0 part 2/2. Populate
...
FROM "TMP_20180416222632_6SMLD3_ADS_sca_2_OUT" AS "ADS_sca_2_OUT"), 
"DT_node_data" AS 
...
(SELECT "Calibrated_Model_0"."KEY" AS "KEY", 1.0 / (1.0 + exp(min(max(-100.0, -(3.3640840384918076 * "Calibrated_Model_0"."ScoreOrProba_1" + -0.9661855827081625)), 100.0))) AS "Proba_1", 1.0 - 1.0 / (1.0 + exp(min(max(-100.0, -(3.3640840384918076 * "Calibrated_Model_0"."ScoreOrProba_1" + -0.9661855827081625)), 100.0))) AS "Proba_0" 
...
(SELECT "Calibrated_Model_1"."KEY" AS "KEY", 1.0 / (1.0 + exp(min(max(-100.0, -(2.7526301314605353 * "Calibrated_Model_1"."ScoreOrProba_1" + -1.597109346935524)), 100.0))) AS "Proba_1", 1.0 - 1.0 / (1.0 + exp(min(max(-100.0, -(2.7526301314605353 * "Calibrated_Model_1"."ScoreOrProba_1" + -1.597109346935524)), 100.0))) AS "Proba_0" 
...
(SELECT "Calibrated_Model_2"."KEY" AS "KEY", 1.0 / (1.0 + exp(min(max(-100.0, -(3.650659014145948 * "Calibrated_Model_2"."ScoreOrProba_1" + -1.2527629098223436)), 100.0))) AS "Proba_1", 1.0 - 1.0 / (1.0 + exp(min(max(-100.0, -(3.650659014145948 * "Calibrated_Model_2"."ScoreOrProba_1" + -1.2527629098223436)), 100.0))) AS "Proba_0" 
...
(SELECT "Calibrated_Model_3"."KEY" AS "KEY", 1.0 / (1.0 + exp(min(max(-100.0, -(4.062903184000669 * "Calibrated_Model_3"."ScoreOrProba_1" + -2.3978968871297432)), 100.0))) AS "Proba_1", 1.0 - 1.0 / (1.0 + exp(min(max(-100.0, -(4.062903184000669 * "Calibrated_Model_3"."ScoreOrProba_1" + -2.3978968871297432)), 100.0))) AS "Proba_0" 
...
FROM sigmoid_calibration_3)
 INSERT INTO "TMP_20180416222632_CMDHUO_CalProb_B0" ("KEY", "Proba_1", "Proba_0") SELECT "CalProb_B0"."KEY", "CalProb_B0"."Proba_1", "CalProb_B0"."Proba_0" 
...
-- Code For temporary table TMP_20180416222632_PHPHLA_CalProb_Union part 1/2. Create 


CREATE TEMPORARY TABLE "TMP_20180416222632_PHPHLA_CalProb_Union" (
	"KEY" BIGINT, 
	"Proba_1" FLOAT, 
	"Proba_0" FLOAT
)
...
-- Code For temporary table TMP_20180416222632_PHPHLA_CalProb_Union part 2/2. Populate

INSERT INTO "TMP_20180416222632_PHPHLA_CalProb_Union" ("KEY", "Proba_1", "Proba_0") SELECT "CalProb_Union"."KEY", "CalProb_Union"."Proba_1", "CalProb_Union"."Proba_0" 
...
FROM "TMP_20180416222632_CMDHUO_CalProb_B0" AS "CalProb_B0") AS "CalProb_EnsembleUnion") AS "CalProb_Union"

-- Code For temporary table TMP_20180416222632_N3HBM4_CalProb_avg part 1/2. Create 


CREATE TEMPORARY TABLE "TMP_20180416222632_N3HBM4_CalProb_avg" (
	"KEY" BIGINT NOT NULL, 
	"Proba_1" FLOAT, 
	"Proba_0" FLOAT, 
	PRIMARY KEY ("KEY")
...
-- Code For temporary table TMP_20180416222632_N3HBM4_CalProb_avg part 2/2. Populate

INSERT INTO "TMP_20180416222632_N3HBM4_CalProb_avg" ("KEY", "Proba_1", "Proba_0") SELECT "CalProb_avg"."KEY", "CalProb_avg"."Proba_1", "CalProb_avg"."Proba_0" 
...
FROM "TMP_20180416222632_PHPHLA_CalProb_Union" AS "CalProb_Union" GROUP BY "CalProb_Union"."KEY") AS "T") AS "CalProb_avg"
...
FROM "TMP_20180416222632_N3HBM4_CalProb_avg" AS "CalProb_avg"), 
