...
-- Code For temporary table tmp_20180416222632_z3txl0_ads_imp_1_out part 1/2. Create 


CREATE TEMPORARY TABLE tmp_20180416222632_z3txl0_ads_imp_1_out (
	"KEY" BIGINT NOT NULL, 
	impter_2 FLOAT, 
	impter_3 FLOAT, 
	impter_4 FLOAT, 
...
-- Code For temporary table tmp_20180416222632_z3txl0_ads_imp_1_out part 2/2. Populate

INSERT INTO tmp_20180416222632_z3txl0_ads_imp_1_out ("KEY", impter_2, impter_3, impter_4, impter_5, impter_6, impter_7, impter_8, impter_9, impter_10, impter_11) SELECT "U"."KEY", "U".impter_2, "U".impter_3, "U".impter_4, "U".impter_5, "U".impter_6, "U".impter_7, "U".impter_8, "U".impter_9, "U".impter_10, "U".impter_11 
...
-- Code For temporary table tmp_20180416222632_wjlyaa_ads_sca_2_out part 1/2. Create 


CREATE TEMPORARY TABLE tmp_20180416222632_wjlyaa_ads_sca_2_out (
	"KEY" BIGINT NOT NULL, 
	scaler_2 FLOAT, 
	scaler_3 FLOAT, 
	scaler_4 FLOAT, 
...
-- Code For temporary table tmp_20180416222632_wjlyaa_ads_sca_2_out part 2/2. Populate

INSERT INTO tmp_20180416222632_wjlyaa_ads_sca_2_out ("KEY", scaler_2, scaler_3, scaler_4, scaler_5, scaler_6, scaler_7, scaler_8, scaler_9, scaler_10, scaler_11) SELECT "U"."KEY", "U".scaler_2, "U".scaler_3, "U".scaler_4, "U".scaler_5, "U".scaler_6, "U".scaler_7, "U".scaler_8, "U".scaler_9, "U".scaler_10, "U".scaler_11 
...
FROM tmp_20180416222632_z3txl0_ads_imp_1_out AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT") AS "U"

-- Code For temporary table tmp_20180416222632_bst62c_calprob_b0 part 1/2. Create 


CREATE TEMPORARY TABLE tmp_20180416222632_bst62c_calprob_b0 (
	"KEY" BIGINT, 
	"Proba_1" FLOAT, 
	"Proba_0" FLOAT
)
...
-- Code For temporary table tmp_20180416222632_bst62c_calprob_b0 part 2/2. Populate

INSERT INTO tmp_20180416222632_bst62c_calprob_b0 ("KEY", "Proba_1", "Proba_0") SELECT "U"."KEY", "U"."Proba_1", "U"."Proba_0" 
...
FROM tmp_20180416222632_wjlyaa_ads_sca_2_out AS "ADS_sca_2_OUT"), 
"DT_node_data" AS 
...
(SELECT "Calibrated_Model_0"."KEY" AS "KEY", 1.0 / (1.0 + exp(CASE WHEN (CASE WHEN (-100.0 <= -(3.3640840384918076 * "Calibrated_Model_0"."ScoreOrProba_1" + -0.9661855827081625)) THEN -(3.3640840384918076 * "Calibrated_Model_0"."ScoreOrProba_1" + -0.9661855827081625) ELSE -100.0 END <= 100.0) THEN CASE WHEN (-100.0 <= -(3.3640840384918076 * "Calibrated_Model_0"."ScoreOrProba_1" + -0.9661855827081625)) THEN -(3.3640840384918076 * "Calibrated_Model_0"."ScoreOrProba_1" + -0.9661855827081625) ELSE -100.0 END ELSE 100.0 END)) AS "Proba_1", 1.0 - 1.0 / (1.0 + exp(CASE WHEN (CASE WHEN (-100.0 <= -(3.3640840384918076 * "Calibrated_Model_0"."ScoreOrProba_1" + -0.9661855827081625)) THEN -(3.3640840384918076 * "Calibrated_Model_0"."ScoreOrProba_1" + -0.9661855827081625) ELSE -100.0 END <= 100.0) THEN CASE WHEN (-100.0 <= -(3.3640840384918076 * "Calibrated_Model_0"."ScoreOrProba_1" + -0.9661855827081625)) THEN -(3.3640840384918076 * "Calibrated_Model_0"."ScoreOrProba_1" + -0.9661855827081625) ELSE -100.0 END ELSE 100.0 END)) AS "Proba_0" 
...
(SELECT "Calibrated_Model_1"."KEY" AS "KEY", 1.0 / (1.0 + exp(CASE WHEN (CASE WHEN (-100.0 <= -(2.7526301314605353 * "Calibrated_Model_1"."ScoreOrProba_1" + -1.597109346935524)) THEN -(2.7526301314605353 * "Calibrated_Model_1"."ScoreOrProba_1" + -1.597109346935524) ELSE -100.0 END <= 100.0) THEN CASE WHEN (-100.0 <= -(2.7526301314605353 * "Calibrated_Model_1"."ScoreOrProba_1" + -1.597109346935524)) THEN -(2.7526301314605353 * "Calibrated_Model_1"."ScoreOrProba_1" + -1.597109346935524) ELSE -100.0 END ELSE 100.0 END)) AS "Proba_1", 1.0 - 1.0 / (1.0 + exp(CASE WHEN (CASE WHEN (-100.0 <= -(2.7526301314605353 * "Calibrated_Model_1"."ScoreOrProba_1" + -1.597109346935524)) THEN -(2.7526301314605353 * "Calibrated_Model_1"."ScoreOrProba_1" + -1.597109346935524) ELSE -100.0 END <= 100.0) THEN CASE WHEN (-100.0 <= -(2.7526301314605353 * "Calibrated_Model_1"."ScoreOrProba_1" + -1.597109346935524)) THEN -(2.7526301314605353 * "Calibrated_Model_1"."ScoreOrProba_1" + -1.597109346935524) ELSE -100.0 END ELSE 100.0 END)) AS "Proba_0" 
...
(SELECT "Calibrated_Model_2"."KEY" AS "KEY", 1.0 / (1.0 + exp(CASE WHEN (CASE WHEN (-100.0 <= -(3.650659014145948 * "Calibrated_Model_2"."ScoreOrProba_1" + -1.2527629098223436)) THEN -(3.650659014145948 * "Calibrated_Model_2"."ScoreOrProba_1" + -1.2527629098223436) ELSE -100.0 END <= 100.0) THEN CASE WHEN (-100.0 <= -(3.650659014145948 * "Calibrated_Model_2"."ScoreOrProba_1" + -1.2527629098223436)) THEN -(3.650659014145948 * "Calibrated_Model_2"."ScoreOrProba_1" + -1.2527629098223436) ELSE -100.0 END ELSE 100.0 END)) AS "Proba_1", 1.0 - 1.0 / (1.0 + exp(CASE WHEN (CASE WHEN (-100.0 <= -(3.650659014145948 * "Calibrated_Model_2"."ScoreOrProba_1" + -1.2527629098223436)) THEN -(3.650659014145948 * "Calibrated_Model_2"."ScoreOrProba_1" + -1.2527629098223436) ELSE -100.0 END <= 100.0) THEN CASE WHEN (-100.0 <= -(3.650659014145948 * "Calibrated_Model_2"."ScoreOrProba_1" + -1.2527629098223436)) THEN -(3.650659014145948 * "Calibrated_Model_2"."ScoreOrProba_1" + -1.2527629098223436) ELSE -100.0 END ELSE 100.0 END)) AS "Proba_0" 
...
(SELECT "Calibrated_Model_3"."KEY" AS "KEY", 1.0 / (1.0 + exp(CASE WHEN (CASE WHEN (-100.0 <= -(4.062903184000669 * "Calibrated_Model_3"."ScoreOrProba_1" + -2.3978968871297432)) THEN -(4.062903184000669 * "Calibrated_Model_3"."ScoreOrProba_1" + -2.3978968871297432) ELSE -100.0 END <= 100.0) THEN CASE WHEN (-100.0 <= -(4.062903184000669 * "Calibrated_Model_3"."ScoreOrProba_1" + -2.3978968871297432)) THEN -(4.062903184000669 * "Calibrated_Model_3"."ScoreOrProba_1" + -2.3978968871297432) ELSE -100.0 END ELSE 100.0 END)) AS "Proba_1", 1.0 - 1.0 / (1.0 + exp(CASE WHEN (CASE WHEN (-100.0 <= -(4.062903184000669 * "Calibrated_Model_3"."ScoreOrProba_1" + -2.3978968871297432)) THEN -(4.062903184000669 * "Calibrated_Model_3"."ScoreOrProba_1" + -2.3978968871297432) ELSE -100.0 END <= 100.0) THEN CASE WHEN (-100.0 <= -(4.062903184000669 * "Calibrated_Model_3"."ScoreOrProba_1" + -2.3978968871297432)) THEN -(4.062903184000669 * "Calibrated_Model_3"."ScoreOrProba_1" + -2.3978968871297432) ELSE -100.0 END ELSE 100.0 END)) AS "Proba_0" 
...
-- Code For temporary table tmp_20180416222632_56tta0_calprob_union part 1/2. Create 


CREATE TEMPORARY TABLE tmp_20180416222632_56tta0_calprob_union (
	"KEY" BIGINT, 
	"Proba_1" FLOAT, 
	"Proba_0" FLOAT
)
...
-- Code For temporary table tmp_20180416222632_56tta0_calprob_union part 2/2. Populate

INSERT INTO tmp_20180416222632_56tta0_calprob_union ("KEY", "Proba_1", "Proba_0") SELECT "U"."KEY", "U"."Proba_1", "U"."Proba_0" 
...
FROM tmp_20180416222632_bst62c_calprob_b0 AS "CalProb_B0") AS "CalProb_EnsembleUnion") AS "CalProb_Union") AS "U"

-- Code For temporary table tmp_20180416222632_s8gk9y_calprob_avg part 1/2. Create 


CREATE TEMPORARY TABLE tmp_20180416222632_s8gk9y_calprob_avg (
	"KEY" BIGINT NOT NULL, 
	"Proba_1" FLOAT, 
	"Proba_0" FLOAT, 
	PRIMARY KEY ("KEY")
...
-- Code For temporary table tmp_20180416222632_s8gk9y_calprob_avg part 2/2. Populate

INSERT INTO tmp_20180416222632_s8gk9y_calprob_avg ("KEY", "Proba_1", "Proba_0") SELECT "U"."KEY", "U"."Proba_1", "U"."Proba_0" 
...
FROM tmp_20180416222632_56tta0_calprob_union AS "CalProb_Union" GROUP BY "CalProb_Union"."KEY") AS "T") AS "CalProb_avg") AS "U"
...
FROM tmp_20180416222632_s8gk9y_calprob_avg AS "CalProb_avg"), 
