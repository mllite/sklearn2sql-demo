...
-- Code For temporary table TMP_20180417042650_UPX0HL_LGBM_B0 part 1/2. Create 


CREATE TEMPORARY TABLE `TMP_20180417042650_UPX0HL_LGBM_B0` (
	`KEY` BIGINT, 
...
-- Code For temporary table TMP_20180417042650_UPX0HL_LGBM_B0 part 2/2. Populate

INSERT INTO `TMP_20180417042650_UPX0HL_LGBM_B0` (`KEY`, `Score_1789-07-14T00:00:00.000000000`, `Score_1789-08-14T00:00:00.000000000`, `Score_1789-09-14T00:00:00.000000000`) SELECT `U`.`KEY`, `U`.`Score_1789-07-14T00:00:00.000000000`, `U`.`Score_1789-08-14T00:00:00.000000000`, `U`.`Score_1789-09-14T00:00:00.000000000` 
...
-- Code For temporary table TMP_20180417042650_I0WZ8Z_LGBM_B1 part 1/2. Create 


CREATE TEMPORARY TABLE `TMP_20180417042650_I0WZ8Z_LGBM_B1` (
	`KEY` BIGINT, 
	`Score_1789-07-14T00:00:00.000000000` DOUBLE, 
	`Score_1789-08-14T00:00:00.000000000` DOUBLE, 
	`Score_1789-09-14T00:00:00.000000000` DOUBLE
...
-- Code For temporary table TMP_20180417042650_I0WZ8Z_LGBM_B1 part 2/2. Populate

INSERT INTO `TMP_20180417042650_I0WZ8Z_LGBM_B1` (`KEY`, `Score_1789-07-14T00:00:00.000000000`, `Score_1789-08-14T00:00:00.000000000`, `Score_1789-09-14T00:00:00.000000000`) SELECT `U`.`KEY`, `U`.`Score_1789-07-14T00:00:00.000000000`, `U`.`Score_1789-08-14T00:00:00.000000000`, `U`.`Score_1789-09-14T00:00:00.000000000` 
...
-- Code For temporary table TMP_20180417042650_R4U26H_LGBM_B2 part 1/2. Create 


CREATE TEMPORARY TABLE `TMP_20180417042650_R4U26H_LGBM_B2` (
	`KEY` BIGINT, 
	`Score_1789-07-14T00:00:00.000000000` DOUBLE, 
	`Score_1789-08-14T00:00:00.000000000` DOUBLE, 
	`Score_1789-09-14T00:00:00.000000000` DOUBLE
...
-- Code For temporary table TMP_20180417042650_R4U26H_LGBM_B2 part 2/2. Populate

INSERT INTO `TMP_20180417042650_R4U26H_LGBM_B2` (`KEY`, `Score_1789-07-14T00:00:00.000000000`, `Score_1789-08-14T00:00:00.000000000`, `Score_1789-09-14T00:00:00.000000000`) SELECT `U`.`KEY`, `U`.`Score_1789-07-14T00:00:00.000000000`, `U`.`Score_1789-08-14T00:00:00.000000000`, `U`.`Score_1789-09-14T00:00:00.000000000` 
...
-- Code For temporary table TMP_20180417042650_QL3PAL_LGBM_B3 part 1/2. Create 


CREATE TEMPORARY TABLE `TMP_20180417042650_QL3PAL_LGBM_B3` (
	`KEY` BIGINT, 
	`Score_1789-07-14T00:00:00.000000000` DOUBLE, 
	`Score_1789-08-14T00:00:00.000000000` DOUBLE, 
	`Score_1789-09-14T00:00:00.000000000` DOUBLE
...
-- Code For temporary table TMP_20180417042650_QL3PAL_LGBM_B3 part 2/2. Populate

INSERT INTO `TMP_20180417042650_QL3PAL_LGBM_B3` (`KEY`, `Score_1789-07-14T00:00:00.000000000`, `Score_1789-08-14T00:00:00.000000000`, `Score_1789-09-14T00:00:00.000000000`) SELECT `U`.`KEY`, `U`.`Score_1789-07-14T00:00:00.000000000`, `U`.`Score_1789-08-14T00:00:00.000000000`, `U`.`Score_1789-09-14T00:00:00.000000000` 
...
-- Code For temporary table TMP_20180417042650_UTLSI5_LGBM_B4 part 1/2. Create 


CREATE TEMPORARY TABLE `TMP_20180417042650_UTLSI5_LGBM_B4` (
	`KEY` BIGINT, 
	`Score_1789-07-14T00:00:00.000000000` DOUBLE, 
	`Score_1789-08-14T00:00:00.000000000` DOUBLE, 
	`Score_1789-09-14T00:00:00.000000000` DOUBLE
...
-- Code For temporary table TMP_20180417042650_UTLSI5_LGBM_B4 part 2/2. Populate

INSERT INTO `TMP_20180417042650_UTLSI5_LGBM_B4` (`KEY`, `Score_1789-07-14T00:00:00.000000000`, `Score_1789-08-14T00:00:00.000000000`, `Score_1789-09-14T00:00:00.000000000`) SELECT `U`.`KEY`, `U`.`Score_1789-07-14T00:00:00.000000000`, `U`.`Score_1789-08-14T00:00:00.000000000`, `U`.`Score_1789-09-14T00:00:00.000000000` 
...
`DT_node_data_41` AS 
(SELECT `Values`.node_id AS node_id, `Values`.feature AS feature, `Values`.threshold AS threshold, `Values`.depth AS depth, `Values`.parent_id AS parent_id, `Values`.`Score` AS `Score` 
FROM (SELECT 3 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 1 AS depth, 1 AS parent_id, 0.03992866306278911 AS `Score` UNION ALL SELECT 5 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 2 AS depth, 2 AS parent_id, -0.014165172018767998 AS `Score` UNION ALL SELECT 8 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 4 AS parent_id, -0.031011173303837687 AS `Score` UNION ALL SELECT 9 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 4 AS parent_id, -0.031542987346648975 AS `Score`) AS `Values`), 
`DT_Output_41` AS 
...
-- Code For temporary table TMP_20180417042650_H0NLXY_LGBM_Union part 1/2. Create 


CREATE TEMPORARY TABLE `TMP_20180417042650_H0NLXY_LGBM_Union` (
	`KEY` BIGINT, 
	`Score_1789-07-14T00:00:00.000000000` DOUBLE, 
	`Score_1789-08-14T00:00:00.000000000` DOUBLE, 
	`Score_1789-09-14T00:00:00.000000000` DOUBLE
...
-- Code For temporary table TMP_20180417042650_H0NLXY_LGBM_Union part 2/2. Populate

INSERT INTO `TMP_20180417042650_H0NLXY_LGBM_Union` (`KEY`, `Score_1789-07-14T00:00:00.000000000`, `Score_1789-08-14T00:00:00.000000000`, `Score_1789-09-14T00:00:00.000000000`) SELECT `U`.`KEY`, `U`.`Score_1789-07-14T00:00:00.000000000`, `U`.`Score_1789-08-14T00:00:00.000000000`, `U`.`Score_1789-09-14T00:00:00.000000000` 
...
FROM `TMP_20180417042650_UPX0HL_LGBM_B0` AS `LGBM_B0` UNION ALL SELECT `LGBM_B1`.`KEY` AS `KEY`, `LGBM_B1`.`Score_1789-07-14T00:00:00.000000000` AS `Score_1789-07-14T00:00:00.000000000`, `LGBM_B1`.`Score_1789-08-14T00:00:00.000000000` AS `Score_1789-08-14T00:00:00.000000000`, `LGBM_B1`.`Score_1789-09-14T00:00:00.000000000` AS `Score_1789-09-14T00:00:00.000000000` 
FROM `TMP_20180417042650_I0WZ8Z_LGBM_B1` AS `LGBM_B1` UNION ALL SELECT `LGBM_B2`.`KEY` AS `KEY`, `LGBM_B2`.`Score_1789-07-14T00:00:00.000000000` AS `Score_1789-07-14T00:00:00.000000000`, `LGBM_B2`.`Score_1789-08-14T00:00:00.000000000` AS `Score_1789-08-14T00:00:00.000000000`, `LGBM_B2`.`Score_1789-09-14T00:00:00.000000000` AS `Score_1789-09-14T00:00:00.000000000` 
FROM `TMP_20180417042650_R4U26H_LGBM_B2` AS `LGBM_B2` UNION ALL SELECT `LGBM_B3`.`KEY` AS `KEY`, `LGBM_B3`.`Score_1789-07-14T00:00:00.000000000` AS `Score_1789-07-14T00:00:00.000000000`, `LGBM_B3`.`Score_1789-08-14T00:00:00.000000000` AS `Score_1789-08-14T00:00:00.000000000`, `LGBM_B3`.`Score_1789-09-14T00:00:00.000000000` AS `Score_1789-09-14T00:00:00.000000000` 
FROM `TMP_20180417042650_QL3PAL_LGBM_B3` AS `LGBM_B3` UNION ALL SELECT `LGBM_B4`.`KEY` AS `KEY`, `LGBM_B4`.`Score_1789-07-14T00:00:00.000000000` AS `Score_1789-07-14T00:00:00.000000000`, `LGBM_B4`.`Score_1789-08-14T00:00:00.000000000` AS `Score_1789-08-14T00:00:00.000000000`, `LGBM_B4`.`Score_1789-09-14T00:00:00.000000000` AS `Score_1789-09-14T00:00:00.000000000` 
FROM `TMP_20180417042650_UTLSI5_LGBM_B4` AS `LGBM_B4`) AS `LGBM_EnsembleUnion`) AS `LGBM_Union`) AS `U`

-- Code For temporary table TMP_20180417042650_5GETAO_LGBM_sum part 1/2. Create 


CREATE TEMPORARY TABLE `TMP_20180417042650_5GETAO_LGBM_sum` (
	`KEY` BIGINT NOT NULL, 
	`Score_1789-07-14T00:00:00.000000000` DOUBLE, 
	`Score_1789-08-14T00:00:00.000000000` DOUBLE, 
	`Score_1789-09-14T00:00:00.000000000` DOUBLE, 
...
-- Code For temporary table TMP_20180417042650_5GETAO_LGBM_sum part 2/2. Populate

INSERT INTO `TMP_20180417042650_5GETAO_LGBM_sum` (`KEY`, `Score_1789-07-14T00:00:00.000000000`, `Score_1789-08-14T00:00:00.000000000`, `Score_1789-09-14T00:00:00.000000000`) SELECT `U`.`KEY`, `U`.`Score_1789-07-14T00:00:00.000000000`, `U`.`Score_1789-08-14T00:00:00.000000000`, `U`.`Score_1789-09-14T00:00:00.000000000` 
...
FROM `TMP_20180417042650_H0NLXY_LGBM_Union` AS `LGBM_Union` GROUP BY `LGBM_Union`.`KEY`) AS `T`) AS `LGBM_sum`) AS `U`
...
FROM `TMP_20180417042650_5GETAO_LGBM_sum` AS `LGBM_sum`), 
