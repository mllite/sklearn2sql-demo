...
-- Code For temporary table tmp_20180417051029_rqdrx2_lgbm_b0 part 1/2. Create 


CREATE TEMPORARY TABLE tmp_20180417051029_rqdrx2_lgbm_b0 (
	"KEY" BIGINT, 
	"Score_CLASS_0" FLOAT, 
	"Score_CLASS_1" FLOAT, 
	"Score_CLASS_2" FLOAT
...
-- Code For temporary table tmp_20180417051029_rqdrx2_lgbm_b0 part 2/2. Populate

INSERT INTO tmp_20180417051029_rqdrx2_lgbm_b0 ("KEY", "Score_CLASS_0", "Score_CLASS_1", "Score_CLASS_2") SELECT "U"."KEY", "U"."Score_CLASS_0", "U"."Score_CLASS_1", "U"."Score_CLASS_2" 
...
-- Code For temporary table tmp_20180417051029_ybxkro_lgbm_b1 part 1/2. Create 


CREATE TEMPORARY TABLE tmp_20180417051029_ybxkro_lgbm_b1 (
	"KEY" BIGINT, 
	"Score_CLASS_0" FLOAT, 
	"Score_CLASS_1" FLOAT, 
	"Score_CLASS_2" FLOAT
...
-- Code For temporary table tmp_20180417051029_ybxkro_lgbm_b1 part 2/2. Populate

INSERT INTO tmp_20180417051029_ybxkro_lgbm_b1 ("KEY", "Score_CLASS_0", "Score_CLASS_1", "Score_CLASS_2") SELECT "U"."KEY", "U"."Score_CLASS_0", "U"."Score_CLASS_1", "U"."Score_CLASS_2" 
...
-- Code For temporary table tmp_20180417051029_iwer0z_lgbm_b2 part 1/2. Create 


CREATE TEMPORARY TABLE tmp_20180417051029_iwer0z_lgbm_b2 (
	"KEY" BIGINT, 
	"Score_CLASS_0" FLOAT, 
	"Score_CLASS_1" FLOAT, 
	"Score_CLASS_2" FLOAT
...
-- Code For temporary table tmp_20180417051029_iwer0z_lgbm_b2 part 2/2. Populate

INSERT INTO tmp_20180417051029_iwer0z_lgbm_b2 ("KEY", "Score_CLASS_0", "Score_CLASS_1", "Score_CLASS_2") SELECT "U"."KEY", "U"."Score_CLASS_0", "U"."Score_CLASS_1", "U"."Score_CLASS_2" 
...
-- Code For temporary table tmp_20180417051029_odc17i_lgbm_b3 part 1/2. Create 


CREATE TEMPORARY TABLE tmp_20180417051029_odc17i_lgbm_b3 (
	"KEY" BIGINT, 
	"Score_CLASS_0" FLOAT, 
	"Score_CLASS_1" FLOAT, 
	"Score_CLASS_2" FLOAT
...
-- Code For temporary table tmp_20180417051029_odc17i_lgbm_b3 part 2/2. Populate

INSERT INTO tmp_20180417051029_odc17i_lgbm_b3 ("KEY", "Score_CLASS_0", "Score_CLASS_1", "Score_CLASS_2") SELECT "U"."KEY", "U"."Score_CLASS_0", "U"."Score_CLASS_1", "U"."Score_CLASS_2" 
...
-- Code For temporary table tmp_20180417051029_qmzuv3_lgbm_b4 part 1/2. Create 


CREATE TEMPORARY TABLE tmp_20180417051029_qmzuv3_lgbm_b4 (
	"KEY" BIGINT, 
	"Score_CLASS_0" FLOAT, 
	"Score_CLASS_1" FLOAT, 
	"Score_CLASS_2" FLOAT
...
-- Code For temporary table tmp_20180417051029_qmzuv3_lgbm_b4 part 2/2. Populate

INSERT INTO tmp_20180417051029_qmzuv3_lgbm_b4 ("KEY", "Score_CLASS_0", "Score_CLASS_1", "Score_CLASS_2") SELECT "U"."KEY", "U"."Score_CLASS_0", "U"."Score_CLASS_1", "U"."Score_CLASS_2" 
...
-- Code For temporary table tmp_20180417051029_lv0fhj_lgbm_union part 1/2. Create 


CREATE TEMPORARY TABLE tmp_20180417051029_lv0fhj_lgbm_union (
	"KEY" BIGINT, 
	"Score_CLASS_0" FLOAT, 
	"Score_CLASS_1" FLOAT, 
	"Score_CLASS_2" FLOAT
...
-- Code For temporary table tmp_20180417051029_lv0fhj_lgbm_union part 2/2. Populate

INSERT INTO tmp_20180417051029_lv0fhj_lgbm_union ("KEY", "Score_CLASS_0", "Score_CLASS_1", "Score_CLASS_2") SELECT "U"."KEY", "U"."Score_CLASS_0", "U"."Score_CLASS_1", "U"."Score_CLASS_2" 
...
FROM tmp_20180417051029_rqdrx2_lgbm_b0 AS "LGBM_B0" UNION ALL SELECT "LGBM_B1"."KEY" AS "KEY", "LGBM_B1"."Score_CLASS_0" AS "Score_CLASS_0", "LGBM_B1"."Score_CLASS_1" AS "Score_CLASS_1", "LGBM_B1"."Score_CLASS_2" AS "Score_CLASS_2" 
FROM tmp_20180417051029_ybxkro_lgbm_b1 AS "LGBM_B1" UNION ALL SELECT "LGBM_B2"."KEY" AS "KEY", "LGBM_B2"."Score_CLASS_0" AS "Score_CLASS_0", "LGBM_B2"."Score_CLASS_1" AS "Score_CLASS_1", "LGBM_B2"."Score_CLASS_2" AS "Score_CLASS_2" 
FROM tmp_20180417051029_iwer0z_lgbm_b2 AS "LGBM_B2" UNION ALL SELECT "LGBM_B3"."KEY" AS "KEY", "LGBM_B3"."Score_CLASS_0" AS "Score_CLASS_0", "LGBM_B3"."Score_CLASS_1" AS "Score_CLASS_1", "LGBM_B3"."Score_CLASS_2" AS "Score_CLASS_2" 
FROM tmp_20180417051029_odc17i_lgbm_b3 AS "LGBM_B3" UNION ALL SELECT "LGBM_B4"."KEY" AS "KEY", "LGBM_B4"."Score_CLASS_0" AS "Score_CLASS_0", "LGBM_B4"."Score_CLASS_1" AS "Score_CLASS_1", "LGBM_B4"."Score_CLASS_2" AS "Score_CLASS_2" 
FROM tmp_20180417051029_qmzuv3_lgbm_b4 AS "LGBM_B4") AS "LGBM_EnsembleUnion") AS "LGBM_Union") AS "U"

-- Code For temporary table tmp_20180417051029_2st0ro_lgbm_sum part 1/2. Create 


CREATE TEMPORARY TABLE tmp_20180417051029_2st0ro_lgbm_sum (
	"KEY" BIGINT NOT NULL, 
	"Score_CLASS_0" FLOAT, 
	"Score_CLASS_1" FLOAT, 
	"Score_CLASS_2" FLOAT, 
...
-- Code For temporary table tmp_20180417051029_2st0ro_lgbm_sum part 2/2. Populate

INSERT INTO tmp_20180417051029_2st0ro_lgbm_sum ("KEY", "Score_CLASS_0", "Score_CLASS_1", "Score_CLASS_2") SELECT "U"."KEY", "U"."Score_CLASS_0", "U"."Score_CLASS_1", "U"."Score_CLASS_2" 
...
FROM tmp_20180417051029_lv0fhj_lgbm_union AS "LGBM_Union" GROUP BY "LGBM_Union"."KEY") AS "T") AS "LGBM_sum") AS "U"
...
FROM tmp_20180417051029_2st0ro_lgbm_sum AS "LGBM_sum"), 
