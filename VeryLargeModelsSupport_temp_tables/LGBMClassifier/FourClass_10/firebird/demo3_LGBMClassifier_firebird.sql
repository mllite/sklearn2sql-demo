...
-- Code For temporary table TMP_20180416233129_V26BFU_LGBM_ part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180416233129_V26BFU_LGBM_" (
	"KEY" BIGINT, 
	"Score_0" FLOAT, 
	"Score_1" FLOAT, 
	"Score_2" FLOAT, 
...
-- Code For temporary table TMP_20180416233129_V26BFU_LGBM_ part 2/2. Populate

INSERT INTO "TMP_20180416233129_V26BFU_LGBM_" ("KEY", "Score_0", "Score_1", "Score_2", "Score_3") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1", "U"."Score_2", "U"."Score_3" 
...
-- Code For temporary table TMP_20180416233129_NO8HUF_LGBM_ part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180416233129_NO8HUF_LGBM_" (
	"KEY" BIGINT, 
	"Score_0" FLOAT, 
	"Score_1" FLOAT, 
	"Score_2" FLOAT, 
...
-- Code For temporary table TMP_20180416233129_NO8HUF_LGBM_ part 2/2. Populate

INSERT INTO "TMP_20180416233129_NO8HUF_LGBM_" ("KEY", "Score_0", "Score_1", "Score_2", "Score_3") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1", "U"."Score_2", "U"."Score_3" 
...
-- Code For temporary table TMP_20180416233129_PX4X8A_LGBM_ part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180416233129_PX4X8A_LGBM_" (
	"KEY" BIGINT, 
	"Score_0" FLOAT, 
	"Score_1" FLOAT, 
	"Score_2" FLOAT, 
...
-- Code For temporary table TMP_20180416233129_PX4X8A_LGBM_ part 2/2. Populate

INSERT INTO "TMP_20180416233129_PX4X8A_LGBM_" ("KEY", "Score_0", "Score_1", "Score_2", "Score_3") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1", "U"."Score_2", "U"."Score_3" 
...
-- Code For temporary table TMP_20180416233129_OBEDHK_LGBM_ part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180416233129_OBEDHK_LGBM_" (
	"KEY" BIGINT, 
	"Score_0" FLOAT, 
	"Score_1" FLOAT, 
	"Score_2" FLOAT, 
...
-- Code For temporary table TMP_20180416233129_OBEDHK_LGBM_ part 2/2. Populate

INSERT INTO "TMP_20180416233129_OBEDHK_LGBM_" ("KEY", "Score_0", "Score_1", "Score_2", "Score_3") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1", "U"."Score_2", "U"."Score_3" 
...
-- Code For temporary table TMP_20180416233129_OKG328_LGBM_ part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180416233129_OKG328_LGBM_" (
	"KEY" BIGINT, 
	"Score_0" FLOAT, 
	"Score_1" FLOAT, 
	"Score_2" FLOAT, 
...
-- Code For temporary table TMP_20180416233129_OKG328_LGBM_ part 2/2. Populate

INSERT INTO "TMP_20180416233129_OKG328_LGBM_" ("KEY", "Score_0", "Score_1", "Score_2", "Score_3") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1", "U"."Score_2", "U"."Score_3" 
...
-- Code For temporary table TMP_20180416233129_E4QYJW_LGBM_ part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180416233129_E4QYJW_LGBM_" (
	"KEY" BIGINT, 
	"Score_0" FLOAT, 
	"Score_1" FLOAT, 
	"Score_2" FLOAT, 
...
-- Code For temporary table TMP_20180416233129_E4QYJW_LGBM_ part 2/2. Populate

INSERT INTO "TMP_20180416233129_E4QYJW_LGBM_" ("KEY", "Score_0", "Score_1", "Score_2", "Score_3") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1", "U"."Score_2", "U"."Score_3" 
...
-- Code For temporary table TMP_20180416233129_SBLJBX_LGBM_ part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180416233129_SBLJBX_LGBM_" (
	"KEY" BIGINT, 
	"Score_0" FLOAT, 
	"Score_1" FLOAT, 
	"Score_2" FLOAT, 
...
-- Code For temporary table TMP_20180416233129_SBLJBX_LGBM_ part 2/2. Populate

INSERT INTO "TMP_20180416233129_SBLJBX_LGBM_" ("KEY", "Score_0", "Score_1", "Score_2", "Score_3") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1", "U"."Score_2", "U"."Score_3" 
...
-- Code For temporary table TMP_20180416233129_VXKPUA_LGBM_ part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180416233129_VXKPUA_LGBM_" (
	"KEY" BIGINT, 
	"Score_0" FLOAT, 
	"Score_1" FLOAT, 
	"Score_2" FLOAT, 
...
-- Code For temporary table TMP_20180416233129_VXKPUA_LGBM_ part 2/2. Populate

INSERT INTO "TMP_20180416233129_VXKPUA_LGBM_" ("KEY", "Score_0", "Score_1", "Score_2", "Score_3") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1", "U"."Score_2", "U"."Score_3" 
...
FROM "TMP_20180416233129_V26BFU_LGBM_" AS "LGBM_B0" UNION ALL SELECT "LGBM_B1"."KEY" AS "KEY", "LGBM_B1"."Score_0" AS "Score_0", "LGBM_B1"."Score_1" AS "Score_1", "LGBM_B1"."Score_2" AS "Score_2", "LGBM_B1"."Score_3" AS "Score_3" 
FROM "TMP_20180416233129_NO8HUF_LGBM_" AS "LGBM_B1" UNION ALL SELECT "LGBM_B2"."KEY" AS "KEY", "LGBM_B2"."Score_0" AS "Score_0", "LGBM_B2"."Score_1" AS "Score_1", "LGBM_B2"."Score_2" AS "Score_2", "LGBM_B2"."Score_3" AS "Score_3" 
FROM "TMP_20180416233129_PX4X8A_LGBM_" AS "LGBM_B2" UNION ALL SELECT "LGBM_B3"."KEY" AS "KEY", "LGBM_B3"."Score_0" AS "Score_0", "LGBM_B3"."Score_1" AS "Score_1", "LGBM_B3"."Score_2" AS "Score_2", "LGBM_B3"."Score_3" AS "Score_3" 
FROM "TMP_20180416233129_OBEDHK_LGBM_" AS "LGBM_B3" UNION ALL SELECT "LGBM_B4"."KEY" AS "KEY", "LGBM_B4"."Score_0" AS "Score_0", "LGBM_B4"."Score_1" AS "Score_1", "LGBM_B4"."Score_2" AS "Score_2", "LGBM_B4"."Score_3" AS "Score_3" 
FROM "TMP_20180416233129_OKG328_LGBM_" AS "LGBM_B4" UNION ALL SELECT "LGBM_B5"."KEY" AS "KEY", "LGBM_B5"."Score_0" AS "Score_0", "LGBM_B5"."Score_1" AS "Score_1", "LGBM_B5"."Score_2" AS "Score_2", "LGBM_B5"."Score_3" AS "Score_3" 
FROM "TMP_20180416233129_E4QYJW_LGBM_" AS "LGBM_B5" UNION ALL SELECT "LGBM_B6"."KEY" AS "KEY", "LGBM_B6"."Score_0" AS "Score_0", "LGBM_B6"."Score_1" AS "Score_1", "LGBM_B6"."Score_2" AS "Score_2", "LGBM_B6"."Score_3" AS "Score_3" 
FROM "TMP_20180416233129_SBLJBX_LGBM_" AS "LGBM_B6") AS "LGBM_EnsembleUnion") AS "LGBM_Union") AS "U"

-- Code For temporary table TMP_20180416233129_ZWG56T_LGBM_ part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180416233129_ZWG56T_LGBM_" (
	"KEY" BIGINT, 
	"Score_0" FLOAT, 
	"Score_1" FLOAT, 
	"Score_2" FLOAT, 
...
-- Code For temporary table TMP_20180416233129_ZWG56T_LGBM_ part 2/2. Populate

INSERT INTO "TMP_20180416233129_ZWG56T_LGBM_" ("KEY", "Score_0", "Score_1", "Score_2", "Score_3") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1", "U"."Score_2", "U"."Score_3" 
...
FROM "TMP_20180416233129_VXKPUA_LGBM_" AS "LGBM_Union" GROUP BY "LGBM_Union"."KEY") AS "T") AS "LGBM_sum") AS "U"
...
FROM "TMP_20180416233129_ZWG56T_LGBM_" AS "LGBM_sum"), 
