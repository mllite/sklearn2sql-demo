...
-- Code For temporary table 80417042212_T2KXAH_LGBM_B0 part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE "80417042212_T2KXAH_LGBM_B0" (
	"KEY" NUMBER(19), 
...
-- Code For temporary table 80417042212_T2KXAH_LGBM_B0 part 2/2. Populate

INSERT INTO "80417042212_T2KXAH_LGBM_B0" ("KEY", "Score_0", "Score_1", "Score_2") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1", "U"."Score_2" 
...
-- Code For temporary table 80417042212_V4DW82_LGBM_B1 part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE "80417042212_V4DW82_LGBM_B1" (
	"KEY" NUMBER(19), 
	"Score_0" BINARY_DOUBLE, 
	"Score_1" BINARY_DOUBLE, 
	"Score_2" BINARY_DOUBLE
...
-- Code For temporary table 80417042212_V4DW82_LGBM_B1 part 2/2. Populate

INSERT INTO "80417042212_V4DW82_LGBM_B1" ("KEY", "Score_0", "Score_1", "Score_2") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1", "U"."Score_2" 
...
-- Code For temporary table 80417042212_PCE1BX_LGBM_B2 part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE "80417042212_PCE1BX_LGBM_B2" (
	"KEY" NUMBER(19), 
	"Score_0" BINARY_DOUBLE, 
	"Score_1" BINARY_DOUBLE, 
	"Score_2" BINARY_DOUBLE
...
-- Code For temporary table 80417042212_PCE1BX_LGBM_B2 part 2/2. Populate

INSERT INTO "80417042212_PCE1BX_LGBM_B2" ("KEY", "Score_0", "Score_1", "Score_2") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1", "U"."Score_2" 
...
-- Code For temporary table 80417042212_SKSO7Q_LGBM_B3 part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE "80417042212_SKSO7Q_LGBM_B3" (
	"KEY" NUMBER(19), 
	"Score_0" BINARY_DOUBLE, 
	"Score_1" BINARY_DOUBLE, 
	"Score_2" BINARY_DOUBLE
...
-- Code For temporary table 80417042212_SKSO7Q_LGBM_B3 part 2/2. Populate

INSERT INTO "80417042212_SKSO7Q_LGBM_B3" ("KEY", "Score_0", "Score_1", "Score_2") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1", "U"."Score_2" 
...
-- Code For temporary table 80417042212_ZDLYC3_LGBM_B4 part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE "80417042212_ZDLYC3_LGBM_B4" (
	"KEY" NUMBER(19), 
	"Score_0" BINARY_DOUBLE, 
	"Score_1" BINARY_DOUBLE, 
	"Score_2" BINARY_DOUBLE
...
-- Code For temporary table 80417042212_ZDLYC3_LGBM_B4 part 2/2. Populate

INSERT INTO "80417042212_ZDLYC3_LGBM_B4" ("KEY", "Score_0", "Score_1", "Score_2") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1", "U"."Score_2" 
...
-- Code For temporary table 17042212_ASRDTN_LGBM_UNION part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE "17042212_ASRDTN_LGBM_UNION" (
	"KEY" NUMBER(19), 
	"Score_0" BINARY_DOUBLE, 
	"Score_1" BINARY_DOUBLE, 
	"Score_2" BINARY_DOUBLE
...
-- Code For temporary table 17042212_ASRDTN_LGBM_UNION part 2/2. Populate

INSERT INTO "17042212_ASRDTN_LGBM_UNION" ("KEY", "Score_0", "Score_1", "Score_2") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1", "U"."Score_2" 
...
FROM "80417042212_T2KXAH_LGBM_B0" "LGBM_B0" UNION ALL SELECT "LGBM_B1"."KEY" AS "KEY", "LGBM_B1"."Score_0" AS "Score_0", "LGBM_B1"."Score_1" AS "Score_1", "LGBM_B1"."Score_2" AS "Score_2" 
FROM "80417042212_V4DW82_LGBM_B1" "LGBM_B1" UNION ALL SELECT "LGBM_B2"."KEY" AS "KEY", "LGBM_B2"."Score_0" AS "Score_0", "LGBM_B2"."Score_1" AS "Score_1", "LGBM_B2"."Score_2" AS "Score_2" 
FROM "80417042212_PCE1BX_LGBM_B2" "LGBM_B2" UNION ALL SELECT "LGBM_B3"."KEY" AS "KEY", "LGBM_B3"."Score_0" AS "Score_0", "LGBM_B3"."Score_1" AS "Score_1", "LGBM_B3"."Score_2" AS "Score_2" 
FROM "80417042212_SKSO7Q_LGBM_B3" "LGBM_B3" UNION ALL SELECT "LGBM_B4"."KEY" AS "KEY", "LGBM_B4"."Score_0" AS "Score_0", "LGBM_B4"."Score_1" AS "Score_1", "LGBM_B4"."Score_2" AS "Score_2" 
FROM "80417042212_ZDLYC3_LGBM_B4" "LGBM_B4") "LGBM_EnsembleUnion") "LGBM_Union") "U"

-- Code For temporary table 0417042212_3OW086_LGBM_SUM part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE "0417042212_3OW086_LGBM_SUM" (
...
-- Code For temporary table 0417042212_3OW086_LGBM_SUM part 2/2. Populate

INSERT INTO "0417042212_3OW086_LGBM_SUM" ("KEY", "Score_0", "Score_1", "Score_2") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1", "U"."Score_2" 
...
FROM "17042212_ASRDTN_LGBM_UNION" "LGBM_Union" GROUP BY "LGBM_Union"."KEY") "T") "LGBM_sum") "U"
...
FROM "0417042212_3OW086_LGBM_SUM" "LGBM_sum"), 
