...
-- Code For temporary table TMP_20180417042213_U5A4PA_LGBM_ part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180417042213_U5A4PA_LGBM_" (
	"KEY" BIGINT, 
	"Score_0" FLOAT, 
	"Score_1" FLOAT, 
	"Score_2" FLOAT
...
-- Code For temporary table TMP_20180417042213_U5A4PA_LGBM_ part 2/2. Populate

INSERT INTO "TMP_20180417042213_U5A4PA_LGBM_" ("KEY", "Score_0", "Score_1", "Score_2") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1", "U"."Score_2" 
...
-- Code For temporary table TMP_20180417042213_6Y8S3K_LGBM_ part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180417042213_6Y8S3K_LGBM_" (
	"KEY" BIGINT, 
	"Score_0" FLOAT, 
	"Score_1" FLOAT, 
	"Score_2" FLOAT
...
-- Code For temporary table TMP_20180417042213_6Y8S3K_LGBM_ part 2/2. Populate

INSERT INTO "TMP_20180417042213_6Y8S3K_LGBM_" ("KEY", "Score_0", "Score_1", "Score_2") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1", "U"."Score_2" 
...
-- Code For temporary table TMP_20180417042213_ZL0HJ8_LGBM_ part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180417042213_ZL0HJ8_LGBM_" (
	"KEY" BIGINT, 
	"Score_0" FLOAT, 
	"Score_1" FLOAT, 
	"Score_2" FLOAT
...
-- Code For temporary table TMP_20180417042213_ZL0HJ8_LGBM_ part 2/2. Populate

INSERT INTO "TMP_20180417042213_ZL0HJ8_LGBM_" ("KEY", "Score_0", "Score_1", "Score_2") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1", "U"."Score_2" 
...
-- Code For temporary table TMP_20180417042213_XROSQ7_LGBM_ part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180417042213_XROSQ7_LGBM_" (
	"KEY" BIGINT, 
	"Score_0" FLOAT, 
	"Score_1" FLOAT, 
	"Score_2" FLOAT
...
-- Code For temporary table TMP_20180417042213_XROSQ7_LGBM_ part 2/2. Populate

INSERT INTO "TMP_20180417042213_XROSQ7_LGBM_" ("KEY", "Score_0", "Score_1", "Score_2") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1", "U"."Score_2" 
...
-- Code For temporary table TMP_20180417042213_UCG9MS_LGBM_ part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180417042213_UCG9MS_LGBM_" (
	"KEY" BIGINT, 
	"Score_0" FLOAT, 
	"Score_1" FLOAT, 
	"Score_2" FLOAT
...
-- Code For temporary table TMP_20180417042213_UCG9MS_LGBM_ part 2/2. Populate

INSERT INTO "TMP_20180417042213_UCG9MS_LGBM_" ("KEY", "Score_0", "Score_1", "Score_2") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1", "U"."Score_2" 
...
-- Code For temporary table TMP_20180417042213_RTLA5H_LGBM_ part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180417042213_RTLA5H_LGBM_" (
	"KEY" BIGINT, 
	"Score_0" FLOAT, 
	"Score_1" FLOAT, 
	"Score_2" FLOAT
...
-- Code For temporary table TMP_20180417042213_RTLA5H_LGBM_ part 2/2. Populate

INSERT INTO "TMP_20180417042213_RTLA5H_LGBM_" ("KEY", "Score_0", "Score_1", "Score_2") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1", "U"."Score_2" 
...
FROM "TMP_20180417042213_U5A4PA_LGBM_" AS "LGBM_B0" UNION ALL SELECT "LGBM_B1"."KEY" AS "KEY", "LGBM_B1"."Score_0" AS "Score_0", "LGBM_B1"."Score_1" AS "Score_1", "LGBM_B1"."Score_2" AS "Score_2" 
FROM "TMP_20180417042213_6Y8S3K_LGBM_" AS "LGBM_B1" UNION ALL SELECT "LGBM_B2"."KEY" AS "KEY", "LGBM_B2"."Score_0" AS "Score_0", "LGBM_B2"."Score_1" AS "Score_1", "LGBM_B2"."Score_2" AS "Score_2" 
FROM "TMP_20180417042213_ZL0HJ8_LGBM_" AS "LGBM_B2" UNION ALL SELECT "LGBM_B3"."KEY" AS "KEY", "LGBM_B3"."Score_0" AS "Score_0", "LGBM_B3"."Score_1" AS "Score_1", "LGBM_B3"."Score_2" AS "Score_2" 
FROM "TMP_20180417042213_XROSQ7_LGBM_" AS "LGBM_B3" UNION ALL SELECT "LGBM_B4"."KEY" AS "KEY", "LGBM_B4"."Score_0" AS "Score_0", "LGBM_B4"."Score_1" AS "Score_1", "LGBM_B4"."Score_2" AS "Score_2" 
FROM "TMP_20180417042213_UCG9MS_LGBM_" AS "LGBM_B4") AS "LGBM_EnsembleUnion") AS "LGBM_Union") AS "U"

-- Code For temporary table TMP_20180417042213_VBOIJL_LGBM_ part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180417042213_VBOIJL_LGBM_" (
	"KEY" BIGINT, 
	"Score_0" FLOAT, 
	"Score_1" FLOAT, 
	"Score_2" FLOAT
...
-- Code For temporary table TMP_20180417042213_VBOIJL_LGBM_ part 2/2. Populate

INSERT INTO "TMP_20180417042213_VBOIJL_LGBM_" ("KEY", "Score_0", "Score_1", "Score_2") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1", "U"."Score_2" 
...
FROM "TMP_20180417042213_RTLA5H_LGBM_" AS "LGBM_Union" GROUP BY "LGBM_Union"."KEY") AS "T") AS "LGBM_sum") AS "U"
...
FROM "TMP_20180417042213_VBOIJL_LGBM_" AS "LGBM_sum"), 
