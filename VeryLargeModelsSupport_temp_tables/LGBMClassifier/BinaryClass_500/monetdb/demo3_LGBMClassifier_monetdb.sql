...
-- Code For temporary table tmp_20180416223725_gpmowp_lgbm_b0 part 1/2. Create 


CREATE TEMPORARY TABLE tmp_20180416223725_gpmowp_lgbm_b0 (
	"KEY" BIGINT, 
	"Score_0" FLOAT
)
...
-- Code For temporary table tmp_20180416223725_gpmowp_lgbm_b0 part 2/2. Populate

INSERT INTO tmp_20180416223725_gpmowp_lgbm_b0 ("KEY", "Score_0") SELECT "U"."KEY", "U"."Score_0" 
...
-- Code For temporary table tmp_20180416223725_d28953_lgbm_b1 part 1/2. Create 


CREATE TEMPORARY TABLE tmp_20180416223725_d28953_lgbm_b1 (
	"KEY" BIGINT, 
	"Score_0" FLOAT
)
...
-- Code For temporary table tmp_20180416223725_d28953_lgbm_b1 part 2/2. Populate

INSERT INTO tmp_20180416223725_d28953_lgbm_b1 ("KEY", "Score_0") SELECT "U"."KEY", "U"."Score_0" 
...
-- Code For temporary table tmp_20180416223725_kj8efi_lgbm_union part 1/2. Create 


CREATE TEMPORARY TABLE tmp_20180416223725_kj8efi_lgbm_union (
	"KEY" BIGINT, 
	"Score_0" FLOAT
)
...
-- Code For temporary table tmp_20180416223725_kj8efi_lgbm_union part 2/2. Populate

INSERT INTO tmp_20180416223725_kj8efi_lgbm_union ("KEY", "Score_0") SELECT "U"."KEY", "U"."Score_0" 
...
FROM tmp_20180416223725_gpmowp_lgbm_b0 AS "LGBM_B0" UNION ALL SELECT "LGBM_B1"."KEY" AS "KEY", "LGBM_B1"."Score_0" AS "Score_0" 
FROM tmp_20180416223725_d28953_lgbm_b1 AS "LGBM_B1") AS "LGBM_EnsembleUnion") AS "LGBM_Union") AS "U"

-- Code For temporary table tmp_20180416223725_ymd6vz_lgbm_sum part 1/2. Create 


CREATE TEMPORARY TABLE tmp_20180416223725_ymd6vz_lgbm_sum (
	"KEY" BIGINT NOT NULL, 
	"Score_0" FLOAT, 
	PRIMARY KEY ("KEY")
)
...
-- Code For temporary table tmp_20180416223725_ymd6vz_lgbm_sum part 2/2. Populate

INSERT INTO tmp_20180416223725_ymd6vz_lgbm_sum ("KEY", "Score_0") SELECT "U"."KEY", "U"."Score_0" 
...
FROM tmp_20180416223725_kj8efi_lgbm_union AS "LGBM_Union" GROUP BY "LGBM_Union"."KEY") AS "T") AS "LGBM_sum") AS "U"
...
FROM tmp_20180416223725_ymd6vz_lgbm_sum AS "LGBM_sum"), 
