...
-- Code For temporary table tmp_20180416231714_kwd2gy_ads_ part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180416231714_kwd2gy_ads_  (
	"KEY" BIGINT, 
	impter_2 FLOAT, 
	impter_3 FLOAT, 
	impter_4 FLOAT, 
...
-- Code For temporary table tmp_20180416231714_kwd2gy_ads_ part 2/2. Populate

INSERT INTO tmp_20180416231714_kwd2gy_ads_ ("KEY", impter_2, impter_3, impter_4, impter_5, impter_6, impter_7, impter_8, impter_9, impter_10, impter_11, impter_12, impter_13, impter_14, impter_15, impter_16, impter_17, impter_18, impter_19, impter_20, impter_21, impter_22, impter_23, impter_24, impter_25, impter_26, impter_27, impter_28, impter_29, impter_30, impter_31) SELECT "U"."KEY", "U".impter_2, "U".impter_3, "U".impter_4, "U".impter_5, "U".impter_6, "U".impter_7, "U".impter_8, "U".impter_9, "U".impter_10, "U".impter_11, "U".impter_12, "U".impter_13, "U".impter_14, "U".impter_15, "U".impter_16, "U".impter_17, "U".impter_18, "U".impter_19, "U".impter_20, "U".impter_21, "U".impter_22, "U".impter_23, "U".impter_24, "U".impter_25, "U".impter_26, "U".impter_27, "U".impter_28, "U".impter_29, "U".impter_30, "U".impter_31 
...
-- Code For temporary table tmp_20180416231714_9l0i3w_ads_ part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180416231714_9l0i3w_ads_  (
	"KEY" BIGINT, 
	scaler_2 FLOAT, 
	scaler_3 FLOAT, 
	scaler_4 FLOAT, 
...
FROM tmp_20180416231714_kwd2gy_ads_ AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT") AS "U"
...
FROM tmp_20180416231714_9l0i3w_ads_ AS "ADS_sca_2_OUT"), 
linear_model_cte AS 
(SELECT linear_input."KEY" AS "KEY", -0.388889977660523 * linear_input.scaler_2 + -0.471801196084478 * linear_input.scaler_3 + -0.341133464116003 * linear_input.scaler_4 + -0.512311998227288 * linear_input.scaler_5 + -0.104589377372137 * linear_input.scaler_6 + 0.395690771291006 * linear_input.scaler_7 + -0.802840803208006 * linear_input.scaler_8 + -1.132865681950448 * linear_input.scaler_9 + 0.034849735336112 * linear_input.scaler_10 + 0.088584659379373 * linear_input.scaler_11 + -1.431858691745215 * linear_input.scaler_12 + -0.044925251976393 * linear_input.scaler_13 + -0.867584830211793 * linear_input.scaler_14 + -0.929518232211108 * linear_input.scaler_15 + 0.21365225319239 * linear_input.scaler_16 + 0.887860233692337 * linear_input.scaler_17 + 0.241989132652767 * linear_input.scaler_18 + -0.362214874667008 * linear_input.scaler_19 + 0.06423015632544 * linear_input.scaler_20 + 0.565809436284143 * linear_input.scaler_21 + -0.852999945385823 * linear_input.scaler_22 + -0.848614296827982 * linear_input.scaler_23 + -0.689679796386834 * linear_input.scaler_24 + -0.851921628770982 * linear_input.scaler_25 + -0.670291701129988 * linear_input.scaler_26 + -0.024352018070713 * linear_input.scaler_27 + -0.888052788130278 * linear_input.scaler_28 + -0.981216140884796 * linear_input.scaler_29 + -0.853800610613817 * linear_input.scaler_30 + -0.092342714075253 * linear_input.scaler_31 + 0.699544333215379 AS lincomb 
FROM linear_input)
