...
-- Code For temporary table tmp_20180416222818_66su6z_ads_ part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180416222818_66su6z_ads_  (
	"KEY" BIGINT, 
	impter_2 FLOAT, 
	impter_3 FLOAT, 
	impter_4 FLOAT, 
...
-- Code For temporary table tmp_20180416222818_66su6z_ads_ part 2/2. Populate

INSERT INTO tmp_20180416222818_66su6z_ads_ ("KEY", impter_2, impter_3, impter_4, impter_5, impter_6, impter_7, impter_8, impter_9, impter_10, impter_11) SELECT "U"."KEY", "U".impter_2, "U".impter_3, "U".impter_4, "U".impter_5, "U".impter_6, "U".impter_7, "U".impter_8, "U".impter_9, "U".impter_10, "U".impter_11 
...
-- Code For temporary table tmp_20180416222818_tbkflj_ads_ part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180416222818_tbkflj_ads_  (
	"KEY" BIGINT, 
	scaler_2 FLOAT, 
	scaler_3 FLOAT, 
	scaler_4 FLOAT, 
...
-- Code For temporary table tmp_20180416222818_tbkflj_ads_ part 2/2. Populate

INSERT INTO tmp_20180416222818_tbkflj_ads_ ("KEY", scaler_2, scaler_3, scaler_4, scaler_5, scaler_6, scaler_7, scaler_8, scaler_9, scaler_10, scaler_11) SELECT "U"."KEY", "U".scaler_2, "U".scaler_3, "U".scaler_4, "U".scaler_5, "U".scaler_6, "U".scaler_7, "U".scaler_8, "U".scaler_9, "U".scaler_10, "U".scaler_11 
...
FROM tmp_20180416222818_66su6z_ads_ AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT") AS "U"
...
FROM tmp_20180416222818_tbkflj_ads_ AS "ADS_sca_2_OUT"), 
linear_model_cte AS 
(SELECT linear_input."KEY" AS "KEY", -0.931431873882138 * linear_input.scaler_2 + -0.132657590473984 * linear_input.scaler_3 + -0.568285351261996 * linear_input.scaler_4 + 0.495573107564661 * linear_input.scaler_5 + -0.378761139043498 * linear_input.scaler_6 + -0.648269434063238 * linear_input.scaler_7 + -0.362917248407231 * linear_input.scaler_8 + -1.053270325805898 * linear_input.scaler_9 + 0.123495749794977 * linear_input.scaler_10 + 1.130570527103086 * linear_input.scaler_11 + 0.462617017500377 AS lincomb 
FROM linear_input)
