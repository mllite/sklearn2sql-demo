...
-- Code For temporary table tmp_20180417042233_1nbbz3_ads_imp_1_out part 1/2. Create 


CREATE TEMPORARY TABLE tmp_20180417042233_1nbbz3_ads_imp_1_out (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table tmp_20180417042233_1nbbz3_ads_imp_1_out part 2/2. Populate

INSERT INTO tmp_20180417042233_1nbbz3_ads_imp_1_out ("KEY", imputer_output_2, imputer_output_3, imputer_output_4, imputer_output_5) SELECT "U"."KEY", "U".imputer_output_2, "U".imputer_output_3, "U".imputer_output_4, "U".imputer_output_5 
...
-- Code For temporary table tmp_20180417042233_78xwg7_ads_sca_2_out part 1/2. Create 


CREATE TEMPORARY TABLE tmp_20180417042233_78xwg7_ads_sca_2_out (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table tmp_20180417042233_78xwg7_ads_sca_2_out part 2/2. Populate

INSERT INTO tmp_20180417042233_78xwg7_ads_sca_2_out ("KEY", scaler_output_2, scaler_output_3, scaler_output_4, scaler_output_5) SELECT "U"."KEY", "U".scaler_output_2, "U".scaler_output_3, "U".scaler_output_4, "U".scaler_output_5 
...
FROM tmp_20180417042233_1nbbz3_ads_imp_1_out AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT") AS "U"
...
FROM tmp_20180417042233_78xwg7_ads_sca_2_out AS "ADS_sca_2_OUT"), 
linear_model_cte AS 
...
FROM linear_input), 
orig_cte AS 
(SELECT linear_model_cte."KEY" AS "KEY", linear_model_cte."Score_0" AS "Score_0", linear_model_cte."Score_1" AS "Score_1", linear_model_cte."Score_2" AS "Score_2", (1.0 / (1.0 + exp(CASE WHEN (CASE WHEN (-100.0 <= -linear_model_cte."Score_0") THEN -linear_model_cte."Score_0" ELSE -100.0 END <= 100.0) THEN CASE WHEN (-100.0 <= -linear_model_cte."Score_0") THEN -linear_model_cte."Score_0" ELSE -100.0 END ELSE 100.0 END))) / (1.0 / (1.0 + exp(CASE WHEN (CASE WHEN (-100.0 <= -linear_model_cte."Score_0") THEN -linear_model_cte."Score_0" ELSE -100.0 END <= 100.0) THEN CASE WHEN (-100.0 <= -linear_model_cte."Score_0") THEN -linear_model_cte."Score_0" ELSE -100.0 END ELSE 100.0 END)) + 1.0 / (1.0 + exp(CASE WHEN (CASE WHEN (-100.0 <= -linear_model_cte."Score_1") THEN -linear_model_cte."Score_1" ELSE -100.0 END <= 100.0) THEN CASE WHEN (-100.0 <= -linear_model_cte."Score_1") THEN -linear_model_cte."Score_1" ELSE -100.0 END ELSE 100.0 END)) + 1.0 / (1.0 + exp(CASE WHEN (CASE WHEN (-100.0 <= -linear_model_cte."Score_2") THEN -linear_model_cte."Score_2" ELSE -100.0 END <= 100.0) THEN CASE WHEN (-100.0 <= -linear_model_cte."Score_2") THEN -linear_model_cte."Score_2" ELSE -100.0 END ELSE 100.0 END))) AS "Proba_0", (1.0 / (1.0 + exp(CASE WHEN (CASE WHEN (-100.0 <= -linear_model_cte."Score_1") THEN -linear_model_cte."Score_1" ELSE -100.0 END <= 100.0) THEN CASE WHEN (-100.0 <= -linear_model_cte."Score_1") THEN -linear_model_cte."Score_1" ELSE -100.0 END ELSE 100.0 END))) / (1.0 / (1.0 + exp(CASE WHEN (CASE WHEN (-100.0 <= -linear_model_cte."Score_0") THEN -linear_model_cte."Score_0" ELSE -100.0 END <= 100.0) THEN CASE WHEN (-100.0 <= -linear_model_cte."Score_0") THEN -linear_model_cte."Score_0" ELSE -100.0 END ELSE 100.0 END)) + 1.0 / (1.0 + exp(CASE WHEN (CASE WHEN (-100.0 <= -linear_model_cte."Score_1") THEN -linear_model_cte."Score_1" ELSE -100.0 END <= 100.0) THEN CASE WHEN (-100.0 <= -linear_model_cte."Score_1") THEN -linear_model_cte."Score_1" ELSE -100.0 END ELSE 100.0 END)) + 1.0 / (1.0 + exp(CASE WHEN (CASE WHEN (-100.0 <= -linear_model_cte."Score_2") THEN -linear_model_cte."Score_2" ELSE -100.0 END <= 100.0) THEN CASE WHEN (-100.0 <= -linear_model_cte."Score_2") THEN -linear_model_cte."Score_2" ELSE -100.0 END ELSE 100.0 END))) AS "Proba_1", (1.0 / (1.0 + exp(CASE WHEN (CASE WHEN (-100.0 <= -linear_model_cte."Score_2") THEN -linear_model_cte."Score_2" ELSE -100.0 END <= 100.0) THEN CASE WHEN (-100.0 <= -linear_model_cte."Score_2") THEN -linear_model_cte."Score_2" ELSE -100.0 END ELSE 100.0 END))) / (1.0 / (1.0 + exp(CASE WHEN (CASE WHEN (-100.0 <= -linear_model_cte."Score_0") THEN -linear_model_cte."Score_0" ELSE -100.0 END <= 100.0) THEN CASE WHEN (-100.0 <= -linear_model_cte."Score_0") THEN -linear_model_cte."Score_0" ELSE -100.0 END ELSE 100.0 END)) + 1.0 / (1.0 + exp(CASE WHEN (CASE WHEN (-100.0 <= -linear_model_cte."Score_1") THEN -linear_model_cte."Score_1" ELSE -100.0 END <= 100.0) THEN CASE WHEN (-100.0 <= -linear_model_cte."Score_1") THEN -linear_model_cte."Score_1" ELSE -100.0 END ELSE 100.0 END)) + 1.0 / (1.0 + exp(CASE WHEN (CASE WHEN (-100.0 <= -linear_model_cte."Score_2") THEN -linear_model_cte."Score_2" ELSE -100.0 END <= 100.0) THEN CASE WHEN (-100.0 <= -linear_model_cte."Score_2") THEN -linear_model_cte."Score_2" ELSE -100.0 END ELSE 100.0 END))) AS "Proba_2", CAST(NULL AS FLOAT) AS "LogProba_0", CAST(NULL AS FLOAT) AS "LogProba_1", CAST(NULL AS FLOAT) AS "LogProba_2", CAST(NULL AS BIGINT) AS "Decision", CAST(NULL AS FLOAT) AS "DecisionProba" 
