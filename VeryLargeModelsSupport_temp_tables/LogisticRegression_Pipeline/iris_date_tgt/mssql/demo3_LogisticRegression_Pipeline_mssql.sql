...
-- Code For temporary table ##TMP_20180417042710_M3Q1GV_ADS_imp_1_OUT part 1/2. Create 


CREATE TABLE ##TMP_20180417042710_M3Q1GV_ADS_imp_1_OUT (
	[KEY] BIGINT NULL, 
...
-- Code For temporary table ##TMP_20180417042710_M3Q1GV_ADS_imp_1_OUT part 2/2. Populate

INSERT INTO ##TMP_20180417042710_M3Q1GV_ADS_imp_1_OUT ([KEY], imputer_output_2, imputer_output_3, imputer_output_4, imputer_output_5) SELECT [ADS_imp_1_OUT].[KEY], [ADS_imp_1_OUT].imputer_output_2, [ADS_imp_1_OUT].imputer_output_3, [ADS_imp_1_OUT].imputer_output_4, [ADS_imp_1_OUT].imputer_output_5 
...
-- Code For temporary table ##TMP_20180417042710_13E48Z_ADS_sca_2_OUT part 1/2. Create 


CREATE TABLE ##TMP_20180417042710_13E48Z_ADS_sca_2_OUT (
	[KEY] BIGINT NULL, 
...
-- Code For temporary table ##TMP_20180417042710_13E48Z_ADS_sca_2_OUT part 2/2. Populate

INSERT INTO ##TMP_20180417042710_13E48Z_ADS_sca_2_OUT ([KEY], scaler_output_2, scaler_output_3, scaler_output_4, scaler_output_5) SELECT [ADS_sca_2_OUT].[KEY], [ADS_sca_2_OUT].scaler_output_2, [ADS_sca_2_OUT].scaler_output_3, [ADS_sca_2_OUT].scaler_output_4, [ADS_sca_2_OUT].scaler_output_5 
...
FROM ##TMP_20180417042710_M3Q1GV_ADS_imp_1_OUT AS [ADS_imp_1_OUT]) AS [ADS_sca_2_OUT]
...
FROM ##TMP_20180417042710_13E48Z_ADS_sca_2_OUT AS [ADS_sca_2_OUT]), 
linear_model_cte AS 
...
FROM linear_input), 
orig_cte AS 
(SELECT linear_model_cte.[KEY] AS [KEY], linear_model_cte.[Score_1789-07-14T00:00:00.000000000] AS [Score_1789-07-14T00:00:00.000000000], linear_model_cte.[Score_1789-08-14T00:00:00.000000000] AS [Score_1789-08-14T00:00:00.000000000], linear_model_cte.[Score_1789-09-14T00:00:00.000000000] AS [Score_1789-09-14T00:00:00.000000000], (1.0 / (1.0 + exp(CASE WHEN (CASE WHEN (-100.0 <= -linear_model_cte.[Score_1789-07-14T00:00:00.000000000]) THEN -linear_model_cte.[Score_1789-07-14T00:00:00.000000000] ELSE -100.0 END <= 100.0) THEN CASE WHEN (-100.0 <= -linear_model_cte.[Score_1789-07-14T00:00:00.000000000]) THEN -linear_model_cte.[Score_1789-07-14T00:00:00.000000000] ELSE -100.0 END ELSE 100.0 END))) / (1.0 / (1.0 + exp(CASE WHEN (CASE WHEN (-100.0 <= -linear_model_cte.[Score_1789-07-14T00:00:00.000000000]) THEN -linear_model_cte.[Score_1789-07-14T00:00:00.000000000] ELSE -100.0 END <= 100.0) THEN CASE WHEN (-100.0 <= -linear_model_cte.[Score_1789-07-14T00:00:00.000000000]) THEN -linear_model_cte.[Score_1789-07-14T00:00:00.000000000] ELSE -100.0 END ELSE 100.0 END)) + 1.0 / (1.0 + exp(CASE WHEN (CASE WHEN (-100.0 <= -linear_model_cte.[Score_1789-08-14T00:00:00.000000000]) THEN -linear_model_cte.[Score_1789-08-14T00:00:00.000000000] ELSE -100.0 END <= 100.0) THEN CASE WHEN (-100.0 <= -linear_model_cte.[Score_1789-08-14T00:00:00.000000000]) THEN -linear_model_cte.[Score_1789-08-14T00:00:00.000000000] ELSE -100.0 END ELSE 100.0 END)) + 1.0 / (1.0 + exp(CASE WHEN (CASE WHEN (-100.0 <= -linear_model_cte.[Score_1789-09-14T00:00:00.000000000]) THEN -linear_model_cte.[Score_1789-09-14T00:00:00.000000000] ELSE -100.0 END <= 100.0) THEN CASE WHEN (-100.0 <= -linear_model_cte.[Score_1789-09-14T00:00:00.000000000]) THEN -linear_model_cte.[Score_1789-09-14T00:00:00.000000000] ELSE -100.0 END ELSE 100.0 END))) AS [Proba_1789-07-14T00:00:00.000000000], (1.0 / (1.0 + exp(CASE WHEN (CASE WHEN (-100.0 <= -linear_model_cte.[Score_1789-08-14T00:00:00.000000000]) THEN -linear_model_cte.[Score_1789-08-14T00:00:00.000000000] ELSE -100.0 END <= 100.0) THEN CASE WHEN (-100.0 <= -linear_model_cte.[Score_1789-08-14T00:00:00.000000000]) THEN -linear_model_cte.[Score_1789-08-14T00:00:00.000000000] ELSE -100.0 END ELSE 100.0 END))) / (1.0 / (1.0 + exp(CASE WHEN (CASE WHEN (-100.0 <= -linear_model_cte.[Score_1789-07-14T00:00:00.000000000]) THEN -linear_model_cte.[Score_1789-07-14T00:00:00.000000000] ELSE -100.0 END <= 100.0) THEN CASE WHEN (-100.0 <= -linear_model_cte.[Score_1789-07-14T00:00:00.000000000]) THEN -linear_model_cte.[Score_1789-07-14T00:00:00.000000000] ELSE -100.0 END ELSE 100.0 END)) + 1.0 / (1.0 + exp(CASE WHEN (CASE WHEN (-100.0 <= -linear_model_cte.[Score_1789-08-14T00:00:00.000000000]) THEN -linear_model_cte.[Score_1789-08-14T00:00:00.000000000] ELSE -100.0 END <= 100.0) THEN CASE WHEN (-100.0 <= -linear_model_cte.[Score_1789-08-14T00:00:00.000000000]) THEN -linear_model_cte.[Score_1789-08-14T00:00:00.000000000] ELSE -100.0 END ELSE 100.0 END)) + 1.0 / (1.0 + exp(CASE WHEN (CASE WHEN (-100.0 <= -linear_model_cte.[Score_1789-09-14T00:00:00.000000000]) THEN -linear_model_cte.[Score_1789-09-14T00:00:00.000000000] ELSE -100.0 END <= 100.0) THEN CASE WHEN (-100.0 <= -linear_model_cte.[Score_1789-09-14T00:00:00.000000000]) THEN -linear_model_cte.[Score_1789-09-14T00:00:00.000000000] ELSE -100.0 END ELSE 100.0 END))) AS [Proba_1789-08-14T00:00:00.000000000], (1.0 / (1.0 + exp(CASE WHEN (CASE WHEN (-100.0 <= -linear_model_cte.[Score_1789-09-14T00:00:00.000000000]) THEN -linear_model_cte.[Score_1789-09-14T00:00:00.000000000] ELSE -100.0 END <= 100.0) THEN CASE WHEN (-100.0 <= -linear_model_cte.[Score_1789-09-14T00:00:00.000000000]) THEN -linear_model_cte.[Score_1789-09-14T00:00:00.000000000] ELSE -100.0 END ELSE 100.0 END))) / (1.0 / (1.0 + exp(CASE WHEN (CASE WHEN (-100.0 <= -linear_model_cte.[Score_1789-07-14T00:00:00.000000000]) THEN -linear_model_cte.[Score_1789-07-14T00:00:00.000000000] ELSE -100.0 END <= 100.0) THEN CASE WHEN (-100.0 <= -linear_model_cte.[Score_1789-07-14T00:00:00.000000000]) THEN -linear_model_cte.[Score_1789-07-14T00:00:00.000000000] ELSE -100.0 END ELSE 100.0 END)) + 1.0 / (1.0 + exp(CASE WHEN (CASE WHEN (-100.0 <= -linear_model_cte.[Score_1789-08-14T00:00:00.000000000]) THEN -linear_model_cte.[Score_1789-08-14T00:00:00.000000000] ELSE -100.0 END <= 100.0) THEN CASE WHEN (-100.0 <= -linear_model_cte.[Score_1789-08-14T00:00:00.000000000]) THEN -linear_model_cte.[Score_1789-08-14T00:00:00.000000000] ELSE -100.0 END ELSE 100.0 END)) + 1.0 / (1.0 + exp(CASE WHEN (CASE WHEN (-100.0 <= -linear_model_cte.[Score_1789-09-14T00:00:00.000000000]) THEN -linear_model_cte.[Score_1789-09-14T00:00:00.000000000] ELSE -100.0 END <= 100.0) THEN CASE WHEN (-100.0 <= -linear_model_cte.[Score_1789-09-14T00:00:00.000000000]) THEN -linear_model_cte.[Score_1789-09-14T00:00:00.000000000] ELSE -100.0 END ELSE 100.0 END))) AS [Proba_1789-09-14T00:00:00.000000000], CAST(NULL AS FLOAT(53)) AS [LogProba_1789-07-14T00:00:00.000000000], CAST(NULL AS FLOAT(53)) AS [LogProba_1789-08-14T00:00:00.000000000], CAST(NULL AS FLOAT(53)) AS [LogProba_1789-09-14T00:00:00.000000000], CAST(NULL AS BIGINT) AS [Decision], CAST(NULL AS FLOAT(53)) AS [DecisionProba] 
