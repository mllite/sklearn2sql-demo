...
-- Code For temporary table TMP_20180417042710_8XQUYK_ADS_I part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180417042710_8XQUYK_ADS_I" (
	"KEY" BIGINT, 
...
-- Code For temporary table TMP_20180417042710_8XQUYK_ADS_I part 2/2. Populate

INSERT INTO "TMP_20180417042710_8XQUYK_ADS_I" ("KEY", imputer_output_2, imputer_output_3, imputer_output_4, imputer_output_5) SELECT "U"."KEY", "U".imputer_output_2, "U".imputer_output_3, "U".imputer_output_4, "U".imputer_output_5 
...
-- Code For temporary table TMP_20180417042710_MKC868_ADS_S part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180417042710_MKC868_ADS_S" (
	"KEY" BIGINT, 
...
-- Code For temporary table TMP_20180417042710_MKC868_ADS_S part 2/2. Populate

INSERT INTO "TMP_20180417042710_MKC868_ADS_S" ("KEY", scaler_output_2, scaler_output_3, scaler_output_4, scaler_output_5) SELECT "U"."KEY", "U".scaler_output_2, "U".scaler_output_3, "U".scaler_output_4, "U".scaler_output_5 
...
FROM "TMP_20180417042710_8XQUYK_ADS_I" AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT") AS "U"
...
FROM "TMP_20180417042710_MKC868_ADS_S" AS "ADS_sca_2_OUT"), 
linear_model_cte AS 
...
FROM linear_input), 
orig_cte AS 
(SELECT linear_model_cte."KEY" AS "KEY", linear_model_cte."Score_1789-07-14T00:00:00.000000000" AS "Score_1789-07-14T00:00:00.000000000", linear_model_cte."Score_1789-08-14T00:00:00.000000000" AS "Score_1789-08-14T00:00:00.000000000", linear_model_cte."Score_1789-09-14T00:00:00.000000000" AS "Score_1789-09-14T00:00:00.000000000", (1.0 / (1.0 + exp(CASE WHEN (minvalue(maxvalue(-100.0, -linear_model_cte."Score_1789-07-14T00:00:00.000000000"), 100.0) >= -709.782712893384) THEN minvalue(maxvalue(-100.0, -linear_model_cte."Score_1789-07-14T00:00:00.000000000"), 100.0) ELSE -709.782712893384 END))) / (1.0 / (1.0 + exp(CASE WHEN (minvalue(maxvalue(-100.0, -linear_model_cte."Score_1789-07-14T00:00:00.000000000"), 100.0) >= -709.782712893384) THEN minvalue(maxvalue(-100.0, -linear_model_cte."Score_1789-07-14T00:00:00.000000000"), 100.0) ELSE -709.782712893384 END)) + 1.0 / (1.0 + exp(CASE WHEN (minvalue(maxvalue(-100.0, -linear_model_cte."Score_1789-08-14T00:00:00.000000000"), 100.0) >= -709.782712893384) THEN minvalue(maxvalue(-100.0, -linear_model_cte."Score_1789-08-14T00:00:00.000000000"), 100.0) ELSE -709.782712893384 END)) + 1.0 / (1.0 + exp(CASE WHEN (minvalue(maxvalue(-100.0, -linear_model_cte."Score_1789-09-14T00:00:00.000000000"), 100.0) >= -709.782712893384) THEN minvalue(maxvalue(-100.0, -linear_model_cte."Score_1789-09-14T00:00:00.000000000"), 100.0) ELSE -709.782712893384 END))) AS "Proba_1789-07-14T00:00:00.000000000", (1.0 / (1.0 + exp(CASE WHEN (minvalue(maxvalue(-100.0, -linear_model_cte."Score_1789-08-14T00:00:00.000000000"), 100.0) >= -709.782712893384) THEN minvalue(maxvalue(-100.0, -linear_model_cte."Score_1789-08-14T00:00:00.000000000"), 100.0) ELSE -709.782712893384 END))) / (1.0 / (1.0 + exp(CASE WHEN (minvalue(maxvalue(-100.0, -linear_model_cte."Score_1789-07-14T00:00:00.000000000"), 100.0) >= -709.782712893384) THEN minvalue(maxvalue(-100.0, -linear_model_cte."Score_1789-07-14T00:00:00.000000000"), 100.0) ELSE -709.782712893384 END)) + 1.0 / (1.0 + exp(CASE WHEN (minvalue(maxvalue(-100.0, -linear_model_cte."Score_1789-08-14T00:00:00.000000000"), 100.0) >= -709.782712893384) THEN minvalue(maxvalue(-100.0, -linear_model_cte."Score_1789-08-14T00:00:00.000000000"), 100.0) ELSE -709.782712893384 END)) + 1.0 / (1.0 + exp(CASE WHEN (minvalue(maxvalue(-100.0, -linear_model_cte."Score_1789-09-14T00:00:00.000000000"), 100.0) >= -709.782712893384) THEN minvalue(maxvalue(-100.0, -linear_model_cte."Score_1789-09-14T00:00:00.000000000"), 100.0) ELSE -709.782712893384 END))) AS "Proba_1789-08-14T00:00:00.000000000", (1.0 / (1.0 + exp(CASE WHEN (minvalue(maxvalue(-100.0, -linear_model_cte."Score_1789-09-14T00:00:00.000000000"), 100.0) >= -709.782712893384) THEN minvalue(maxvalue(-100.0, -linear_model_cte."Score_1789-09-14T00:00:00.000000000"), 100.0) ELSE -709.782712893384 END))) / (1.0 / (1.0 + exp(CASE WHEN (minvalue(maxvalue(-100.0, -linear_model_cte."Score_1789-07-14T00:00:00.000000000"), 100.0) >= -709.782712893384) THEN minvalue(maxvalue(-100.0, -linear_model_cte."Score_1789-07-14T00:00:00.000000000"), 100.0) ELSE -709.782712893384 END)) + 1.0 / (1.0 + exp(CASE WHEN (minvalue(maxvalue(-100.0, -linear_model_cte."Score_1789-08-14T00:00:00.000000000"), 100.0) >= -709.782712893384) THEN minvalue(maxvalue(-100.0, -linear_model_cte."Score_1789-08-14T00:00:00.000000000"), 100.0) ELSE -709.782712893384 END)) + 1.0 / (1.0 + exp(CASE WHEN (minvalue(maxvalue(-100.0, -linear_model_cte."Score_1789-09-14T00:00:00.000000000"), 100.0) >= -709.782712893384) THEN minvalue(maxvalue(-100.0, -linear_model_cte."Score_1789-09-14T00:00:00.000000000"), 100.0) ELSE -709.782712893384 END))) AS "Proba_1789-09-14T00:00:00.000000000", CAST(NULL AS FLOAT) AS "LogProba_1789-07-14T00:00:00.000000000", CAST(NULL AS FLOAT) AS "LogProba_1789-08-14T00:00:00.000000000", CAST(NULL AS FLOAT) AS "LogProba_1789-09-14T00:00:00.000000000", CAST(NULL AS BIGINT) AS "Decision", CAST(NULL AS FLOAT) AS "DecisionProba" 
