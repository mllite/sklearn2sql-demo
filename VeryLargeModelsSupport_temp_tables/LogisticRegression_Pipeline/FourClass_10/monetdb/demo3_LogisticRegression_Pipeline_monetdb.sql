...
-- Code For temporary table tmp_20180416233149_vhtxmp_ads_imp_1_out part 1/2. Create 


CREATE TEMPORARY TABLE tmp_20180416233149_vhtxmp_ads_imp_1_out (
	"KEY" BIGINT NOT NULL, 
	impter_2 FLOAT, 
	impter_3 FLOAT, 
	impter_4 FLOAT, 
...
-- Code For temporary table tmp_20180416233149_vhtxmp_ads_imp_1_out part 2/2. Populate

INSERT INTO tmp_20180416233149_vhtxmp_ads_imp_1_out ("KEY", impter_2, impter_3, impter_4, impter_5, impter_6, impter_7, impter_8, impter_9, impter_10, impter_11) SELECT "U"."KEY", "U".impter_2, "U".impter_3, "U".impter_4, "U".impter_5, "U".impter_6, "U".impter_7, "U".impter_8, "U".impter_9, "U".impter_10, "U".impter_11 
...
-- Code For temporary table tmp_20180416233149_rakdpr_ads_sca_2_out part 1/2. Create 


CREATE TEMPORARY TABLE tmp_20180416233149_rakdpr_ads_sca_2_out (
	"KEY" BIGINT NOT NULL, 
	scaler_2 FLOAT, 
	scaler_3 FLOAT, 
	scaler_4 FLOAT, 
...
-- Code For temporary table tmp_20180416233149_rakdpr_ads_sca_2_out part 2/2. Populate

INSERT INTO tmp_20180416233149_rakdpr_ads_sca_2_out ("KEY", scaler_2, scaler_3, scaler_4, scaler_5, scaler_6, scaler_7, scaler_8, scaler_9, scaler_10, scaler_11) SELECT "U"."KEY", "U".scaler_2, "U".scaler_3, "U".scaler_4, "U".scaler_5, "U".scaler_6, "U".scaler_7, "U".scaler_8, "U".scaler_9, "U".scaler_10, "U".scaler_11 
...
FROM tmp_20180416233149_vhtxmp_ads_imp_1_out AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT") AS "U"
...
FROM tmp_20180416233149_rakdpr_ads_sca_2_out AS "ADS_sca_2_OUT"), 
linear_model_cte AS 
...
FROM linear_input), 
orig_cte AS 
(SELECT linear_model_cte."KEY" AS "KEY", linear_model_cte."Score_0" AS "Score_0", linear_model_cte."Score_1" AS "Score_1", linear_model_cte."Score_2" AS "Score_2", linear_model_cte."Score_3" AS "Score_3", (1.0 / (1.0 + exp(CASE WHEN (CASE WHEN (-100.0 <= -linear_model_cte."Score_0") THEN -linear_model_cte."Score_0" ELSE -100.0 END <= 100.0) THEN CASE WHEN (-100.0 <= -linear_model_cte."Score_0") THEN -linear_model_cte."Score_0" ELSE -100.0 END ELSE 100.0 END))) / (1.0 / (1.0 + exp(CASE WHEN (CASE WHEN (-100.0 <= -linear_model_cte."Score_0") THEN -linear_model_cte."Score_0" ELSE -100.0 END <= 100.0) THEN CASE WHEN (-100.0 <= -linear_model_cte."Score_0") THEN -linear_model_cte."Score_0" ELSE -100.0 END ELSE 100.0 END)) + 1.0 / (1.0 + exp(CASE WHEN (CASE WHEN (-100.0 <= -linear_model_cte."Score_1") THEN -linear_model_cte."Score_1" ELSE -100.0 END <= 100.0) THEN CASE WHEN (-100.0 <= -linear_model_cte."Score_1") THEN -linear_model_cte."Score_1" ELSE -100.0 END ELSE 100.0 END)) + 1.0 / (1.0 + exp(CASE WHEN (CASE WHEN (-100.0 <= -linear_model_cte."Score_2") THEN -linear_model_cte."Score_2" ELSE -100.0 END <= 100.0) THEN CASE WHEN (-100.0 <= -linear_model_cte."Score_2") THEN -linear_model_cte."Score_2" ELSE -100.0 END ELSE 100.0 END)) + 1.0 / (1.0 + exp(CASE WHEN (CASE WHEN (-100.0 <= -linear_model_cte."Score_3") THEN -linear_model_cte."Score_3" ELSE -100.0 END <= 100.0) THEN CASE WHEN (-100.0 <= -linear_model_cte."Score_3") THEN -linear_model_cte."Score_3" ELSE -100.0 END ELSE 100.0 END))) AS "Proba_0", (1.0 / (1.0 + exp(CASE WHEN (CASE WHEN (-100.0 <= -linear_model_cte."Score_1") THEN -linear_model_cte."Score_1" ELSE -100.0 END <= 100.0) THEN CASE WHEN (-100.0 <= -linear_model_cte."Score_1") THEN -linear_model_cte."Score_1" ELSE -100.0 END ELSE 100.0 END))) / (1.0 / (1.0 + exp(CASE WHEN (CASE WHEN (-100.0 <= -linear_model_cte."Score_0") THEN -linear_model_cte."Score_0" ELSE -100.0 END <= 100.0) THEN CASE WHEN (-100.0 <= -linear_model_cte."Score_0") THEN -linear_model_cte."Score_0" ELSE -100.0 END ELSE 100.0 END)) + 1.0 / (1.0 + exp(CASE WHEN (CASE WHEN (-100.0 <= -linear_model_cte."Score_1") THEN -linear_model_cte."Score_1" ELSE -100.0 END <= 100.0) THEN CASE WHEN (-100.0 <= -linear_model_cte."Score_1") THEN -linear_model_cte."Score_1" ELSE -100.0 END ELSE 100.0 END)) + 1.0 / (1.0 + exp(CASE WHEN (CASE WHEN (-100.0 <= -linear_model_cte."Score_2") THEN -linear_model_cte."Score_2" ELSE -100.0 END <= 100.0) THEN CASE WHEN (-100.0 <= -linear_model_cte."Score_2") THEN -linear_model_cte."Score_2" ELSE -100.0 END ELSE 100.0 END)) + 1.0 / (1.0 + exp(CASE WHEN (CASE WHEN (-100.0 <= -linear_model_cte."Score_3") THEN -linear_model_cte."Score_3" ELSE -100.0 END <= 100.0) THEN CASE WHEN (-100.0 <= -linear_model_cte."Score_3") THEN -linear_model_cte."Score_3" ELSE -100.0 END ELSE 100.0 END))) AS "Proba_1", (1.0 / (1.0 + exp(CASE WHEN (CASE WHEN (-100.0 <= -linear_model_cte."Score_2") THEN -linear_model_cte."Score_2" ELSE -100.0 END <= 100.0) THEN CASE WHEN (-100.0 <= -linear_model_cte."Score_2") THEN -linear_model_cte."Score_2" ELSE -100.0 END ELSE 100.0 END))) / (1.0 / (1.0 + exp(CASE WHEN (CASE WHEN (-100.0 <= -linear_model_cte."Score_0") THEN -linear_model_cte."Score_0" ELSE -100.0 END <= 100.0) THEN CASE WHEN (-100.0 <= -linear_model_cte."Score_0") THEN -linear_model_cte."Score_0" ELSE -100.0 END ELSE 100.0 END)) + 1.0 / (1.0 + exp(CASE WHEN (CASE WHEN (-100.0 <= -linear_model_cte."Score_1") THEN -linear_model_cte."Score_1" ELSE -100.0 END <= 100.0) THEN CASE WHEN (-100.0 <= -linear_model_cte."Score_1") THEN -linear_model_cte."Score_1" ELSE -100.0 END ELSE 100.0 END)) + 1.0 / (1.0 + exp(CASE WHEN (CASE WHEN (-100.0 <= -linear_model_cte."Score_2") THEN -linear_model_cte."Score_2" ELSE -100.0 END <= 100.0) THEN CASE WHEN (-100.0 <= -linear_model_cte."Score_2") THEN -linear_model_cte."Score_2" ELSE -100.0 END ELSE 100.0 END)) + 1.0 / (1.0 + exp(CASE WHEN (CASE WHEN (-100.0 <= -linear_model_cte."Score_3") THEN -linear_model_cte."Score_3" ELSE -100.0 END <= 100.0) THEN CASE WHEN (-100.0 <= -linear_model_cte."Score_3") THEN -linear_model_cte."Score_3" ELSE -100.0 END ELSE 100.0 END))) AS "Proba_2", (1.0 / (1.0 + exp(CASE WHEN (CASE WHEN (-100.0 <= -linear_model_cte."Score_3") THEN -linear_model_cte."Score_3" ELSE -100.0 END <= 100.0) THEN CASE WHEN (-100.0 <= -linear_model_cte."Score_3") THEN -linear_model_cte."Score_3" ELSE -100.0 END ELSE 100.0 END))) / (1.0 / (1.0 + exp(CASE WHEN (CASE WHEN (-100.0 <= -linear_model_cte."Score_0") THEN -linear_model_cte."Score_0" ELSE -100.0 END <= 100.0) THEN CASE WHEN (-100.0 <= -linear_model_cte."Score_0") THEN -linear_model_cte."Score_0" ELSE -100.0 END ELSE 100.0 END)) + 1.0 / (1.0 + exp(CASE WHEN (CASE WHEN (-100.0 <= -linear_model_cte."Score_1") THEN -linear_model_cte."Score_1" ELSE -100.0 END <= 100.0) THEN CASE WHEN (-100.0 <= -linear_model_cte."Score_1") THEN -linear_model_cte."Score_1" ELSE -100.0 END ELSE 100.0 END)) + 1.0 / (1.0 + exp(CASE WHEN (CASE WHEN (-100.0 <= -linear_model_cte."Score_2") THEN -linear_model_cte."Score_2" ELSE -100.0 END <= 100.0) THEN CASE WHEN (-100.0 <= -linear_model_cte."Score_2") THEN -linear_model_cte."Score_2" ELSE -100.0 END ELSE 100.0 END)) + 1.0 / (1.0 + exp(CASE WHEN (CASE WHEN (-100.0 <= -linear_model_cte."Score_3") THEN -linear_model_cte."Score_3" ELSE -100.0 END <= 100.0) THEN CASE WHEN (-100.0 <= -linear_model_cte."Score_3") THEN -linear_model_cte."Score_3" ELSE -100.0 END ELSE 100.0 END))) AS "Proba_3", CAST(NULL AS FLOAT) AS "LogProba_0", CAST(NULL AS FLOAT) AS "LogProba_1", CAST(NULL AS FLOAT) AS "LogProba_2", CAST(NULL AS FLOAT) AS "LogProba_3", CAST(NULL AS BIGINT) AS "Decision", CAST(NULL AS FLOAT) AS "DecisionProba" 
