...
-- Code For temporary table tmp_20180416223255_j8xskd_ads_imp_1_out part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180416223255_j8xskd_ads_imp_1_out (
	"KEY" BIGINT, 
	impter_2 DOUBLE, 
	impter_3 DOUBLE, 
	impter_4 DOUBLE, 
...
-- Code For temporary table tmp_20180416223255_n0jpas_ads_sca_2_out part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180416223255_n0jpas_ads_sca_2_out (
	"KEY" BIGINT, 
	scaler_2 FLOAT, 
	scaler_3 FLOAT, 
	scaler_4 FLOAT, 
...
FROM tmp_20180416223255_j8xskd_ads_imp_1_out AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT"
...
FROM tmp_20180416223255_n0jpas_ads_sca_2_out AS "ADS_sca_2_OUT"), 
linear_model_cte AS 
