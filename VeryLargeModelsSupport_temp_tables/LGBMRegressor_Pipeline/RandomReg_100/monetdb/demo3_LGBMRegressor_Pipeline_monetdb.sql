...
-- Code For temporary table tmp_20180417013000_xo03pu_ads_imp_1_out part 1/2. Create 


CREATE TEMPORARY TABLE tmp_20180417013000_xo03pu_ads_imp_1_out (
	"KEY" BIGINT NOT NULL, 
	impter_2 FLOAT, 
	impter_3 FLOAT, 
	impter_4 FLOAT, 
...
-- Code For temporary table tmp_20180417013000_oyuy19_ads_sca_2_out part 1/2. Create 


CREATE TEMPORARY TABLE tmp_20180417013000_oyuy19_ads_sca_2_out (
	"KEY" BIGINT NOT NULL, 
	scaler_2 FLOAT, 
	scaler_3 FLOAT, 
	scaler_4 FLOAT, 
...
FROM tmp_20180417013000_xo03pu_ads_imp_1_out AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT") AS "U"

-- Code For temporary table tmp_20180417013000_c6zu10_lgbm_b0 part 1/2. Create 


CREATE TEMPORARY TABLE tmp_20180417013000_c6zu10_lgbm_b0 (
	"KEY" BIGINT, 
	"Estimator" FLOAT
)
...
-- Code For temporary table tmp_20180417013000_c6zu10_lgbm_b0 part 2/2. Populate

INSERT INTO tmp_20180417013000_c6zu10_lgbm_b0 ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
FROM tmp_20180417013000_oyuy19_ads_sca_2_out AS "ADS_sca_2_OUT"), 
"DT_node_data" AS 
...
-- Code For temporary table tmp_20180417013000_6f7ba5_lgbm_b1 part 1/2. Create 


CREATE TEMPORARY TABLE tmp_20180417013000_6f7ba5_lgbm_b1 (
	"KEY" BIGINT, 
	"Estimator" FLOAT
)
...
-- Code For temporary table tmp_20180417013000_6f7ba5_lgbm_b1 part 2/2. Populate

INSERT INTO tmp_20180417013000_6f7ba5_lgbm_b1 ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
-- Code For temporary table tmp_20180417013000_xd2ih6_lgbm_union part 1/2. Create 


CREATE TEMPORARY TABLE tmp_20180417013000_xd2ih6_lgbm_union (
	"KEY" BIGINT, 
	"Estimator" FLOAT
)
...
-- Code For temporary table tmp_20180417013000_xd2ih6_lgbm_union part 2/2. Populate

INSERT INTO tmp_20180417013000_xd2ih6_lgbm_union ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
FROM tmp_20180417013000_c6zu10_lgbm_b0 AS "LGBM_B0" UNION ALL SELECT "LGBM_B1"."KEY" AS "KEY", "LGBM_B1"."Estimator" AS "Estimator" 
FROM tmp_20180417013000_6f7ba5_lgbm_b1 AS "LGBM_B1") AS "LGBM_EnsembleUnion") AS "LGBM_Union") AS "U"

-- Code For temporary table tmp_20180417013000_v8zomh_lgbm_sum part 1/2. Create 


CREATE TEMPORARY TABLE tmp_20180417013000_v8zomh_lgbm_sum (
	"KEY" BIGINT NOT NULL, 
	"Estimator" FLOAT, 
	PRIMARY KEY ("KEY")
)
...
-- Code For temporary table tmp_20180417013000_v8zomh_lgbm_sum part 2/2. Populate

INSERT INTO tmp_20180417013000_v8zomh_lgbm_sum ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
FROM tmp_20180417013000_xd2ih6_lgbm_union AS "LGBM_Union" GROUP BY "LGBM_Union"."KEY") AS "T") AS "LGBM_sum") AS "U"

-- Model deployment code

SELECT "LGBM_sum"."KEY" AS "KEY", "LGBM_sum"."Estimator" AS "Estimator" 
FROM tmp_20180417013000_v8zomh_lgbm_sum AS "LGBM_sum"