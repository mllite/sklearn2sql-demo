...
-- Code For temporary table TMP_20180417013000_Y5K6CI_ADS_imp_1_OUT part 1/2. Create 


CREATE TEMPORARY TABLE `TMP_20180417013000_Y5K6CI_ADS_imp_1_OUT` (
	`KEY` BIGINT NOT NULL, 
	impter_2 DOUBLE, 
	impter_3 DOUBLE, 
	impter_4 DOUBLE, 
...
-- Code For temporary table TMP_20180417013000_PJH5YU_ADS_sca_2_OUT part 1/2. Create 


CREATE TEMPORARY TABLE `TMP_20180417013000_PJH5YU_ADS_sca_2_OUT` (
	`KEY` BIGINT NOT NULL, 
	scaler_2 DOUBLE, 
	scaler_3 DOUBLE, 
	scaler_4 DOUBLE, 
...
FROM `TMP_20180417013000_Y5K6CI_ADS_imp_1_OUT` AS `ADS_imp_1_OUT`) AS `ADS_sca_2_OUT`) AS `U`

-- Code For temporary table TMP_20180417013000_4J34Y4_LGBM_B0 part 1/2. Create 


CREATE TEMPORARY TABLE `TMP_20180417013000_4J34Y4_LGBM_B0` (
	`KEY` BIGINT, 
	`Estimator` DOUBLE
)
...
-- Code For temporary table TMP_20180417013000_4J34Y4_LGBM_B0 part 2/2. Populate

INSERT INTO `TMP_20180417013000_4J34Y4_LGBM_B0` (`KEY`, `Estimator`) SELECT `U`.`KEY`, `U`.`Estimator` 
...
FROM `TMP_20180417013000_PJH5YU_ADS_sca_2_OUT` AS `ADS_sca_2_OUT`), 
`DT_node_data` AS 
...
-- Code For temporary table TMP_20180417013000_4IVE6V_LGBM_B1 part 1/2. Create 


CREATE TEMPORARY TABLE `TMP_20180417013000_4IVE6V_LGBM_B1` (
	`KEY` BIGINT, 
	`Estimator` DOUBLE
)
...
-- Code For temporary table TMP_20180417013000_4IVE6V_LGBM_B1 part 2/2. Populate

INSERT INTO `TMP_20180417013000_4IVE6V_LGBM_B1` (`KEY`, `Estimator`) SELECT `U`.`KEY`, `U`.`Estimator` 
...
-- Code For temporary table TMP_20180417013000_C7R0OK_LGBM_Union part 1/2. Create 


CREATE TEMPORARY TABLE `TMP_20180417013000_C7R0OK_LGBM_Union` (
	`KEY` BIGINT, 
	`Estimator` DOUBLE
)
...
-- Code For temporary table TMP_20180417013000_C7R0OK_LGBM_Union part 2/2. Populate

INSERT INTO `TMP_20180417013000_C7R0OK_LGBM_Union` (`KEY`, `Estimator`) SELECT `U`.`KEY`, `U`.`Estimator` 
...
FROM `TMP_20180417013000_4J34Y4_LGBM_B0` AS `LGBM_B0` UNION ALL SELECT `LGBM_B1`.`KEY` AS `KEY`, `LGBM_B1`.`Estimator` AS `Estimator` 
FROM `TMP_20180417013000_4IVE6V_LGBM_B1` AS `LGBM_B1`) AS `LGBM_EnsembleUnion`) AS `LGBM_Union`) AS `U`

-- Code For temporary table TMP_20180417013000_DGXGUE_LGBM_sum part 1/2. Create 


CREATE TEMPORARY TABLE `TMP_20180417013000_DGXGUE_LGBM_sum` (
	`KEY` BIGINT NOT NULL, 
	`Estimator` DOUBLE, 
	PRIMARY KEY (`KEY`)
)
...
-- Code For temporary table TMP_20180417013000_DGXGUE_LGBM_sum part 2/2. Populate

INSERT INTO `TMP_20180417013000_DGXGUE_LGBM_sum` (`KEY`, `Estimator`) SELECT `U`.`KEY`, `U`.`Estimator` 
...
FROM `TMP_20180417013000_C7R0OK_LGBM_Union` AS `LGBM_Union` GROUP BY `LGBM_Union`.`KEY`) AS `T`) AS `LGBM_sum`) AS `U`

-- Model deployment code

SELECT `LGBM_sum`.`KEY` AS `KEY`, `LGBM_sum`.`Estimator` AS `Estimator` 
FROM `TMP_20180417013000_DGXGUE_LGBM_sum` AS `LGBM_sum`