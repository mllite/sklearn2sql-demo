...
-- Code For temporary table tmp_20180417023739_c4kxyn_ads_ part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180417023739_c4kxyn_ads_  (
	"KEY" BIGINT, 
	impter_2 FLOAT, 
	impter_3 FLOAT, 
	impter_4 FLOAT, 
...
-- Code For temporary table tmp_20180417023739_c4kxyn_ads_ part 2/2. Populate

INSERT INTO tmp_20180417023739_c4kxyn_ads_ ("KEY", impter_2, impter_3, impter_4, impter_5, impter_6, impter_7, impter_8, impter_9, impter_10, impter_11, impter_12, impter_13, impter_14) SELECT "U"."KEY", "U".impter_2, "U".impter_3, "U".impter_4, "U".impter_5, "U".impter_6, "U".impter_7, "U".impter_8, "U".impter_9, "U".impter_10, "U".impter_11, "U".impter_12, "U".impter_13, "U".impter_14 
...
-- Code For temporary table tmp_20180417023739_5rzyba_ads_ part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180417023739_5rzyba_ads_  (
	"KEY" BIGINT, 
	scaler_2 FLOAT, 
	scaler_3 FLOAT, 
	scaler_4 FLOAT, 
...
FROM tmp_20180417023739_c4kxyn_ads_ AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT") AS "U"
...
FROM tmp_20180417023739_5rzyba_ads_ AS "ADS_sca_2_OUT"), 
linear_model_cte AS 
(SELECT linear_input."KEY" AS "KEY", -0.440695845496368 * linear_input.scaler_2 + 0.54781178374487 * linear_input.scaler_3 + -0.345047412115745 * linear_input.scaler_4 + 0.783353433887601 * linear_input.scaler_5 + -0.733544849424395 * linear_input.scaler_6 + 3.518256178024306 * linear_input.scaler_7 + -0.34308261350663 * linear_input.scaler_8 + -1.851853068786619 * linear_input.scaler_9 + 0.528140149872451 * linear_input.scaler_10 + -0.489769384760452 * linear_input.scaler_11 + -1.890922746469155 * linear_input.scaler_12 + 0.862227997368068 * linear_input.scaler_13 + -2.851946170869835 * linear_input.scaler_14 + 22.1770167086741 AS "Estimator" 
FROM linear_input)
