...
-- Code For temporary table tmp_20180417013054_x2dy2t_ads_imp_1_out part 1/2. Create 


CREATE TEMPORARY TABLE tmp_20180417013054_x2dy2t_ads_imp_1_out (
	"KEY" BIGINT NOT NULL, 
	impter_2 FLOAT, 
	impter_3 FLOAT, 
	impter_4 FLOAT, 
...
-- Code For temporary table tmp_20180417013054_620x8s_ads_sca_2_out part 1/2. Create 


CREATE TEMPORARY TABLE tmp_20180417013054_620x8s_ads_sca_2_out (
	"KEY" BIGINT NOT NULL, 
	scaler_2 FLOAT, 
	scaler_3 FLOAT, 
	scaler_4 FLOAT, 
...
FROM tmp_20180417013054_x2dy2t_ads_imp_1_out AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT") AS "U"
...
FROM tmp_20180417013054_620x8s_ads_sca_2_out AS "ADS_sca_2_OUT"), 
linear_model_cte AS 
