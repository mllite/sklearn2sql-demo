...
-- Code For temporary table 13013_57KXDD_ADS_IMP_1_OUT part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE "13013_57KXDD_ADS_IMP_1_OUT" (
...
-- Code For temporary table 13013_UFGCQD_ADS_SCA_2_OUT part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE "13013_UFGCQD_ADS_SCA_2_OUT" (
	"KEY" NUMBER(19) NOT NULL, 
...
FROM "13013_57KXDD_ADS_IMP_1_OUT" "ADS_imp_1_OUT") "ADS_sca_2_OUT") "U"

-- Code For temporary table 7013013_2POOHZ_HL_1_RELU_1 part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE "7013013_2POOHZ_HL_1_RELU_1" (
	"KEY" NUMBER(19) NOT NULL, 
...
-- Code For temporary table 7013013_2POOHZ_HL_1_RELU_1 part 2/2. Populate

INSERT INTO "7013013_2POOHZ_HL_1_RELU_1" ("KEY", "NEUR_1_1", "NEUR_1_2", "NEUR_1_3") SELECT "U"."KEY", "U"."NEUR_1_1", "U"."NEUR_1_2", "U"."NEUR_1_3" 
FROM (WITH "IL" AS 
...
FROM "13013_UFGCQD_ADS_SCA_2_OUT" "ADS_sca_2_OUT"), 
"HL_BA_1" AS 
...
-- Code For temporary table 13013_GM2LQH_OL_IDENTITY_1 part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE "13013_GM2LQH_OL_IDENTITY_1" (
	"KEY" NUMBER(19) NOT NULL, 
...
-- Code For temporary table 13013_GM2LQH_OL_IDENTITY_1 part 2/2. Populate

INSERT INTO "13013_GM2LQH_OL_IDENTITY_1" ("KEY", "NEUR_3_1") SELECT "U"."KEY", "U"."NEUR_3_1" 
...
FROM "7013013_2POOHZ_HL_1_RELU_1" "HL_1_relu_1"), 
"HL_2_relu" AS 
...
FROM "13013_GM2LQH_OL_IDENTITY_1" "OL_identity_1"