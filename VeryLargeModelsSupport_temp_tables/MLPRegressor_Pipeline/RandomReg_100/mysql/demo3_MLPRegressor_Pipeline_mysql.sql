...
-- Code For temporary table TMP_20180417013013_VZQM3I_ADS_imp_1_OUT part 1/2. Create 


CREATE TEMPORARY TABLE `TMP_20180417013013_VZQM3I_ADS_imp_1_OUT` (
	`KEY` BIGINT NOT NULL, 
	impter_2 DOUBLE, 
	impter_3 DOUBLE, 
	impter_4 DOUBLE, 
...
-- Code For temporary table TMP_20180417013013_RMZNGH_ADS_sca_2_OUT part 1/2. Create 


CREATE TEMPORARY TABLE `TMP_20180417013013_RMZNGH_ADS_sca_2_OUT` (
	`KEY` BIGINT NOT NULL, 
	scaler_2 DOUBLE, 
	scaler_3 DOUBLE, 
	scaler_4 DOUBLE, 
...
FROM `TMP_20180417013013_VZQM3I_ADS_imp_1_OUT` AS `ADS_imp_1_OUT`) AS `ADS_sca_2_OUT`) AS `U`

-- Code For temporary table TMP_20180417013013_A5BOSI_HL_1_relu_1 part 1/2. Create 


CREATE TEMPORARY TABLE `TMP_20180417013013_A5BOSI_HL_1_relu_1` (
	`KEY` BIGINT NOT NULL, 
	`NEUR_1_1` DOUBLE, 
	`NEUR_1_2` DOUBLE, 
	`NEUR_1_3` DOUBLE, 
...
-- Code For temporary table TMP_20180417013013_A5BOSI_HL_1_relu_1 part 2/2. Populate

INSERT INTO `TMP_20180417013013_A5BOSI_HL_1_relu_1` (`KEY`, `NEUR_1_1`, `NEUR_1_2`, `NEUR_1_3`) SELECT `U`.`KEY`, `U`.`NEUR_1_1`, `U`.`NEUR_1_2`, `U`.`NEUR_1_3` 
FROM (WITH `IL` AS 
...
FROM `TMP_20180417013013_RMZNGH_ADS_sca_2_OUT` AS `ADS_sca_2_OUT`), 
`HL_BA_1` AS 
...
-- Code For temporary table TMP_20180417013013_GMDEH8_OL_identity_1 part 1/2. Create 


CREATE TEMPORARY TABLE `TMP_20180417013013_GMDEH8_OL_identity_1` (
	`KEY` BIGINT NOT NULL, 
	`NEUR_3_1` DOUBLE, 
	PRIMARY KEY (`KEY`)
)
...
-- Code For temporary table TMP_20180417013013_GMDEH8_OL_identity_1 part 2/2. Populate

INSERT INTO `TMP_20180417013013_GMDEH8_OL_identity_1` (`KEY`, `NEUR_3_1`) SELECT `U`.`KEY`, `U`.`NEUR_3_1` 
...
FROM `TMP_20180417013013_A5BOSI_HL_1_relu_1` AS `HL_1_relu_1`), 
`HL_2_relu` AS 
...
FROM `TMP_20180417013013_GMDEH8_OL_identity_1` AS `OL_identity_1`