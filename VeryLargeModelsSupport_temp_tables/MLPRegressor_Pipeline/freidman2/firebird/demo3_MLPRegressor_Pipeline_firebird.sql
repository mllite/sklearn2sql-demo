...
-- Code For temporary table TMP_20180417040502_LTP183_ADS_I part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180417040502_LTP183_ADS_I" (
	"KEY" BIGINT, 
...
-- Code For temporary table TMP_20180417040502_LTP183_ADS_I part 2/2. Populate

INSERT INTO "TMP_20180417040502_LTP183_ADS_I" ("KEY", imputer_output_2, imputer_output_3, imputer_output_4, imputer_output_5) SELECT "U"."KEY", "U".imputer_output_2, "U".imputer_output_3, "U".imputer_output_4, "U".imputer_output_5 
...
-- Code For temporary table TMP_20180417040502_W5GB19_ADS_S part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180417040502_W5GB19_ADS_S" (
	"KEY" BIGINT, 
...
-- Code For temporary table TMP_20180417040502_W5GB19_ADS_S part 2/2. Populate

INSERT INTO "TMP_20180417040502_W5GB19_ADS_S" ("KEY", scaler_output_2, scaler_output_3, scaler_output_4, scaler_output_5) SELECT "U"."KEY", "U".scaler_output_2, "U".scaler_output_3, "U".scaler_output_4, "U".scaler_output_5 
...
FROM "TMP_20180417040502_LTP183_ADS_I" AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT") AS "U"

-- Code For temporary table TMP_20180417040502_UIA3SP_HL_1_ part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180417040502_UIA3SP_HL_1_" (
	"KEY" BIGINT, 
	"NEUR_1_1" FLOAT, 
	"NEUR_1_2" FLOAT, 
	"NEUR_1_3" FLOAT
...
-- Code For temporary table TMP_20180417040502_UIA3SP_HL_1_ part 2/2. Populate

INSERT INTO "TMP_20180417040502_UIA3SP_HL_1_" ("KEY", "NEUR_1_1", "NEUR_1_2", "NEUR_1_3") SELECT "U"."KEY", "U"."NEUR_1_1", "U"."NEUR_1_2", "U"."NEUR_1_3" 
FROM (WITH "IL" AS 
...
FROM "TMP_20180417040502_W5GB19_ADS_S" AS "ADS_sca_2_OUT"), 
"HL_BA_1" AS 
...
-- Code For temporary table TMP_20180417040502_79K8N1_OL_ID part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180417040502_79K8N1_OL_ID" (
	"KEY" BIGINT, 
	"NEUR_3_1" FLOAT
)
...
-- Code For temporary table TMP_20180417040502_79K8N1_OL_ID part 2/2. Populate

INSERT INTO "TMP_20180417040502_79K8N1_OL_ID" ("KEY", "NEUR_3_1") SELECT "U"."KEY", "U"."NEUR_3_1" 
...
FROM "TMP_20180417040502_UIA3SP_HL_1_" AS "HL_1_relu_1"), 
"HL_2_relu" AS 
...
FROM "TMP_20180417040502_79K8N1_OL_ID" AS "OL_identity_1"