...
-- Code For temporary table TMP_20180417025020_5Y1J5H_ADS_imp_1_OUT part 1/2. Create 


CREATE TEMPORARY TABLE `TMP_20180417025020_5Y1J5H_ADS_imp_1_OUT` (
	`KEY` BIGINT NOT NULL, 
	impter_2 DOUBLE, 
	impter_3 DOUBLE, 
	impter_4 DOUBLE, 
...
-- Code For temporary table TMP_20180417025020_5Y1J5H_ADS_imp_1_OUT part 2/2. Populate

INSERT INTO `TMP_20180417025020_5Y1J5H_ADS_imp_1_OUT` (`KEY`, impter_2, impter_3, impter_4, impter_5, impter_6, impter_7, impter_8, impter_9, impter_10, impter_11) SELECT `U`.`KEY`, `U`.impter_2, `U`.impter_3, `U`.impter_4, `U`.impter_5, `U`.impter_6, `U`.impter_7, `U`.impter_8, `U`.impter_9, `U`.impter_10, `U`.impter_11 
...
-- Code For temporary table TMP_20180417025020_19HT0W_ADS_sca_2_OUT part 1/2. Create 


CREATE TEMPORARY TABLE `TMP_20180417025020_19HT0W_ADS_sca_2_OUT` (
	`KEY` BIGINT NOT NULL, 
	scaler_2 DOUBLE, 
	scaler_3 DOUBLE, 
	scaler_4 DOUBLE, 
...
-- Code For temporary table TMP_20180417025020_19HT0W_ADS_sca_2_OUT part 2/2. Populate

INSERT INTO `TMP_20180417025020_19HT0W_ADS_sca_2_OUT` (`KEY`, scaler_2, scaler_3, scaler_4, scaler_5, scaler_6, scaler_7, scaler_8, scaler_9, scaler_10, scaler_11) SELECT `U`.`KEY`, `U`.scaler_2, `U`.scaler_3, `U`.scaler_4, `U`.scaler_5, `U`.scaler_6, `U`.scaler_7, `U`.scaler_8, `U`.scaler_9, `U`.scaler_10, `U`.scaler_11 
...
FROM `TMP_20180417025020_5Y1J5H_ADS_imp_1_OUT` AS `ADS_imp_1_OUT`) AS `ADS_sca_2_OUT`) AS `U`

-- Code For temporary table TMP_20180417025020_HFMTCX_HL_1_relu_1 part 1/2. Create 


CREATE TEMPORARY TABLE `TMP_20180417025020_HFMTCX_HL_1_relu_1` (
	`KEY` BIGINT NOT NULL, 
	`NEUR_1_1` DOUBLE, 
	`NEUR_1_2` DOUBLE, 
	`NEUR_1_3` DOUBLE, 
...
-- Code For temporary table TMP_20180417025020_HFMTCX_HL_1_relu_1 part 2/2. Populate

INSERT INTO `TMP_20180417025020_HFMTCX_HL_1_relu_1` (`KEY`, `NEUR_1_1`, `NEUR_1_2`, `NEUR_1_3`) SELECT `U`.`KEY`, `U`.`NEUR_1_1`, `U`.`NEUR_1_2`, `U`.`NEUR_1_3` 
FROM (WITH `IL` AS 
...
FROM `TMP_20180417025020_19HT0W_ADS_sca_2_OUT` AS `ADS_sca_2_OUT`), 
`HL_BA_1` AS 
...
-- Code For temporary table TMP_20180417025020_T3FN7T_OL_identity_1 part 1/2. Create 


CREATE TEMPORARY TABLE `TMP_20180417025020_T3FN7T_OL_identity_1` (
	`KEY` BIGINT NOT NULL, 
	`NEUR_3_1` DOUBLE, 
	PRIMARY KEY (`KEY`)
)
...
-- Code For temporary table TMP_20180417025020_T3FN7T_OL_identity_1 part 2/2. Populate

INSERT INTO `TMP_20180417025020_T3FN7T_OL_identity_1` (`KEY`, `NEUR_3_1`) SELECT `U`.`KEY`, `U`.`NEUR_3_1` 
...
FROM `TMP_20180417025020_HFMTCX_HL_1_relu_1` AS `HL_1_relu_1`), 
`HL_2_relu` AS 
...
FROM `TMP_20180417025020_T3FN7T_OL_identity_1` AS `OL_identity_1`