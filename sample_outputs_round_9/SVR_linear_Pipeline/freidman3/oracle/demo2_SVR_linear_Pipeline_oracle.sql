...
FROM (SELECT 0 AS sv_idx, 0.127978093196 AS dual_coeff, 0.220060490956 AS sv_0, 0.291104580959 AS sv_1, -0.818337617437 AS sv_2, -0.00812391265666 AS sv_3 FROM DUAL UNION ALL SELECT 1 AS sv_idx, 0.340832990326 AS dual_coeff, -1.047780577 AS sv_0, 0.898258054886 AS sv_1, -1.14360616108 AS sv_2, 1.15306202953 AS sv_3 FROM DUAL UNION ALL SELECT 2 AS sv_idx, -0.30889093895 AS dual_coeff, 1.44631795197 AS sv_0, -1.55570693091 AS sv_1, 0.648397569942 AS sv_2, 0.0140017796406 AS sv_3 FROM DUAL UNION ALL SELECT 3 AS sv_idx, -1.0 AS dual_coeff, 0.164499099534 AS sv_0, -0.997912200969 AS sv_1, -1.51915034699 AS sv_2, -1.24981948012 AS sv_3 FROM DUAL UNION ALL SELECT 4 AS sv_idx, 0.639672829772 AS dual_coeff, -1.35684921311 AS sv_0, -1.43956176951 AS sv_1, -0.223086921758 AS sv_2, 0.624095816454 AS sv_3 FROM DUAL UNION ALL SELECT 5 AS sv_idx, 1.0 AS dual_coeff, -1.30710160499 AS sv_0, -1.79718941375 AS sv_1, -0.735675244097 AS sv_2, 0.940844015355 AS sv_3 FROM DUAL UNION ALL SELECT 6 AS sv_idx, -1.0 AS dual_coeff, -0.774377257792 AS sv_0, -0.574238148168 AS sv_1, -1.65478507028 AS sv_2, 1.01640062949 AS sv_3 FROM DUAL UNION ALL SELECT 7 AS sv_idx, 0.343307493735 AS dual_coeff, 1.9345610707 AS sv_0, 1.48326059879 AS sv_1, 0.919646059068 AS sv_2, 0.802340001117 AS sv_3 FROM DUAL UNION ALL SELECT 8 AS sv_idx, 0.817352372491 AS dual_coeff, 0.40540083791 AS sv_0, -0.153771997987 AS sv_1, -0.842940359227 AS sv_2, -1.64750527014 AS sv_3 FROM DUAL UNION ALL SELECT 9 AS sv_idx, -0.960252840569 AS dual_coeff, -1.29762513179 AS sv_0, 0.00659629188135 AS sv_1, 1.17265600446 AS sv_2, 0.921604192064 AS sv_3 FROM DUAL) "Values"), 
kernel_dp AS 
