...
(SELECT multinomial_cte.[KEY] AS [KEY], 0.352112676056 AS [Proba_0], CASE WHEN (0.352112676056 IS NULL OR 0.352112676056 > 0.0) THEN log(0.352112676056) ELSE -1.79769313486231e+308 END AS [LogProba_0], 0.647887323944 AS [Proba_1], CASE WHEN (0.647887323944 IS NULL OR 0.647887323944 > 0.0) THEN log(0.647887323944) ELSE -1.79769313486231e+308 END AS [LogProba_1], multinomial_cte.multinomial_expr AS [Decision] 
