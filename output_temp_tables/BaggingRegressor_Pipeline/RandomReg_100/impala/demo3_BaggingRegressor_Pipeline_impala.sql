...
-- Code For temporary table tmp_20180602144752_7mi_ads_imp_1_out part 1. Create 


CREATE TABLE tmp_20180602144752_7mi_ads_imp_1_out (
	`KEY` BIGINT, 
	impter_2 DOUBLE, 
	impter_3 DOUBLE, 
	impter_4 DOUBLE, 
...
-- Code For temporary table tmp_20180602144752_16j_ads_sca_2_out part 1. Create 


CREATE TABLE tmp_20180602144752_16j_ads_sca_2_out (
	`KEY` BIGINT, 
	scaler_2 DOUBLE, 
	scaler_3 DOUBLE, 
	scaler_4 DOUBLE, 
...
FROM tmp_20180602144752_7mi_ads_imp_1_out AS `ADS_imp_1_OUT`) AS `ADS_sca_2_OUT`

-- Code For temporary table tmp_20180602144752_h8f_bag_b0 part 1. Create 


CREATE TABLE tmp_20180602144752_h8f_bag_b0 (
	`KEY` BIGINT, 
	`Estimator` DOUBLE
)
...
-- Code For temporary table tmp_20180602144752_h8f_bag_b0 part 2. Populate
...
FROM tmp_20180602144752_16j_ads_sca_2_out AS `ADS_sca_2_OUT`), 
`DT_node_data` AS 
...
FROM `DT_Output_9`)
 INSERT INTO tmp_20180602144752_h8f_bag_b0 (`KEY`, `Estimator`) SELECT `BAG_B0`.`KEY`, `BAG_B0`.`Estimator` 
...
-- Code For temporary table tmp_20180602144752_915_bag_b1 part 1. Create 


CREATE TABLE tmp_20180602144752_915_bag_b1 (
	`KEY` BIGINT, 
	`Estimator` DOUBLE
)
...
-- Code For temporary table tmp_20180602144752_915_bag_b1 part 2. Populate
...
FROM `DT_Output_15`)
 INSERT INTO tmp_20180602144752_915_bag_b1 (`KEY`, `Estimator`) SELECT `BAG_B1`.`KEY`, `BAG_B1`.`Estimator` 
...
-- Code For temporary table tmp_20180602144752_f8u_bag_avg part 1. Create 


CREATE TABLE tmp_20180602144752_f8u_bag_avg (
	`KEY` BIGINT, 
	`Estimator` DOUBLE
)
...
-- Code For temporary table tmp_20180602144752_f8u_bag_avg part 2. Populate
...
FROM tmp_20180602144752_h8f_bag_b0 AS `BAG_B0` UNION ALL SELECT `BAG_B1`.`KEY` AS `KEY`, `BAG_B1`.`Estimator` AS `Estimator` 
FROM tmp_20180602144752_915_bag_b1 AS `BAG_B1`) AS `BAG_EnsembleUnion`)
 INSERT INTO tmp_20180602144752_f8u_bag_avg (`KEY`, `Estimator`) SELECT `BAG_avg`.`KEY`, `BAG_avg`.`Estimator` 
...
FROM tmp_20180602144752_f8u_bag_avg AS `BAG_avg`