...
-- Code For temporary table tmp_20180602142509_qot_gb_b0 part 1. Create 

CREATE TEMPORARY TABLE `tmp_20180602142509_qot_gb_b0` STORED AS ORC AS WITH `DT_node_lookup` AS 
...
-- Code For temporary table tmp_20180602142509_qot_gb_b0 part 2. Populate

SELECT * FROM `tmp_20180602142509_qot_gb_b0`

-- Code For temporary table tmp_20180602142509_m10_gb_b1 part 1. Create 

CREATE TEMPORARY TABLE `tmp_20180602142509_m10_gb_b1` STORED AS ORC AS WITH `DT_node_lookup_5` AS 
...
-- Code For temporary table tmp_20180602142509_m10_gb_b1 part 2. Populate

SELECT * FROM `tmp_20180602142509_m10_gb_b1`

-- Code For temporary table tmp_20180602142509_9q4_gb_b2 part 1. Create 

CREATE TEMPORARY TABLE `tmp_20180602142509_9q4_gb_b2` STORED AS ORC AS WITH `DT_node_lookup_10` AS 
...
-- Code For temporary table tmp_20180602142509_9q4_gb_b2 part 2. Populate

SELECT * FROM `tmp_20180602142509_9q4_gb_b2`

-- Code For temporary table tmp_20180602142509_j3i_gb_b3 part 1. Create 

CREATE TEMPORARY TABLE `tmp_20180602142509_j3i_gb_b3` STORED AS ORC AS WITH `DT_node_lookup_15` AS 
...
-- Code For temporary table tmp_20180602142509_j3i_gb_b3 part 2. Populate

SELECT * FROM `tmp_20180602142509_j3i_gb_b3`

-- Code For temporary table tmp_20180602142509_74z_gb_sum part 1. Create 

CREATE TEMPORARY TABLE `tmp_20180602142509_74z_gb_sum` STORED AS ORC AS WITH `GB_Union` AS 
...
FROM `tmp_20180602142509_qot_gb_b0` AS `GB_B0` UNION ALL SELECT `GB_B1`.`KEY` AS `KEY`, `GB_B1`.`Score_0` AS `Score_0`, `GB_B1`.`Score_1` AS `Score_1` 
FROM `tmp_20180602142509_m10_gb_b1` AS `GB_B1` UNION ALL SELECT `GB_B2`.`KEY` AS `KEY`, `GB_B2`.`Score_0` AS `Score_0`, `GB_B2`.`Score_1` AS `Score_1` 
FROM `tmp_20180602142509_9q4_gb_b2` AS `GB_B2` UNION ALL SELECT `GB_B3`.`KEY` AS `KEY`, `GB_B3`.`Score_0` AS `Score_0`, `GB_B3`.`Score_1` AS `Score_1` 
FROM `tmp_20180602142509_j3i_gb_b3` AS `GB_B3`) AS `GB_EnsembleUnion`)
...
-- Code For temporary table tmp_20180602142509_74z_gb_sum part 2. Populate

SELECT * FROM `tmp_20180602142509_74z_gb_sum`
...
FROM `tmp_20180602142509_74z_gb_sum` AS `GB_sum`), 
