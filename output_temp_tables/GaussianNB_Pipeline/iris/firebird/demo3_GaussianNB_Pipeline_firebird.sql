...
-- Code For temporary table TMP_20180602_0SI_ADS_IMP_1_OUT part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180602_0SI_ADS_IMP_1_OUT" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20180602_0SI_ADS_IMP_1_OUT part 2. Populate

INSERT INTO "TMP_20180602_0SI_ADS_IMP_1_OUT" ("KEY", imputer_output_2, imputer_output_3, imputer_output_4, imputer_output_5) SELECT "U"."KEY", "U".imputer_output_2, "U".imputer_output_3, "U".imputer_output_4, "U".imputer_output_5 
...
-- Code For temporary table TMP_20180602_0SI_ADS_IMP_1_OUT part 3. Create Index 

CREATE INDEX "ix_TMP_20180602_0SI_ADS_f738" ON "TMP_20180602_0SI_ADS_IMP_1_OUT" ("KEY")

-- Code For temporary table TMP_20180602_KN2_ADS_SCA_2_OUT part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180602_KN2_ADS_SCA_2_OUT" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20180602_KN2_ADS_SCA_2_OUT part 2. Populate

INSERT INTO "TMP_20180602_KN2_ADS_SCA_2_OUT" ("KEY", scaler_output_2, scaler_output_3, scaler_output_4, scaler_output_5) SELECT "U"."KEY", "U".scaler_output_2, "U".scaler_output_3, "U".scaler_output_4, "U".scaler_output_5 
...
FROM "TMP_20180602_0SI_ADS_IMP_1_OUT" AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT") AS "U"

-- Code For temporary table TMP_20180602_KN2_ADS_SCA_2_OUT part 3. Create Index 

CREATE INDEX "ix_TMP_20180602_KN2_ADS_b508" ON "TMP_20180602_KN2_ADS_SCA_2_OUT" ("KEY")

-- Code For temporary table TMP_20180602_D67_NAIVEBAYES_SCO part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180602_D67_NAIVEBAYES_SCO" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20180602_D67_NAIVEBAYES_SCO part 2. Populate

INSERT INTO "TMP_20180602_D67_NAIVEBAYES_SCO" ("KEY", "Score_0", "Score_1", "Score_2") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1", "U"."Score_2" 
...
FROM "TMP_20180602_KN2_ADS_SCA_2_OUT" AS "ADS_sca_2_OUT"), 
"NaiveBayes_data" AS 
...
-- Code For temporary table TMP_20180602_D67_NAIVEBAYES_SCO part 3. Create Index 

CREATE INDEX "ix_TMP_20180602_D67_NAI_08d0" ON "TMP_20180602_D67_NAIVEBAYES_SCO" ("KEY")
...
FROM "TMP_20180602_D67_NAIVEBAYES_SCO" AS "NaiveBayes_Scores"), 
