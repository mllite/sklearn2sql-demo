...
-- Code For temporary table ##TMP_20180602142458_XAL_ADS_imp_1_OUT part 1. Create 


CREATE TABLE ##TMP_20180602142458_XAL_ADS_imp_1_OUT (
	[KEY] BIGINT NULL, 
...
-- Code For temporary table ##TMP_20180602142458_DF9_ADS_sca_2_OUT part 1. Create 


CREATE TABLE ##TMP_20180602142458_DF9_ADS_sca_2_OUT (
	[KEY] BIGINT NULL, 
	scaler_2 FLOAT NULL, 
	scaler_3 FLOAT NULL, 
	scaler_4 FLOAT NULL, 
...
FROM ##TMP_20180602142458_XAL_ADS_imp_1_OUT AS [ADS_imp_1_OUT]) AS [ADS_sca_2_OUT]

-- Code For temporary table ##TMP_20180602142458_WSP_NaiveBayes_Scores part 1. Create 


CREATE TABLE ##TMP_20180602142458_WSP_NaiveBayes_Scores (
	[KEY] BIGINT NULL, 
	[Score_0] FLOAT NULL, 
	[Score_1] FLOAT NULL
)
...
-- Code For temporary table ##TMP_20180602142458_WSP_NaiveBayes_Scores part 2. Populate
...
FROM ##TMP_20180602142458_DF9_ADS_sca_2_OUT AS [ADS_sca_2_OUT]), 
[NaiveBayes_data] AS 
...
FROM centered_data) AS [Values])
 INSERT INTO ##TMP_20180602142458_WSP_NaiveBayes_Scores ([KEY], [Score_0], [Score_1]) SELECT [NaiveBayes_Scores].[KEY], [NaiveBayes_Scores].[Score_0], [NaiveBayes_Scores].[Score_1] 
...
FROM ##TMP_20180602142458_WSP_NaiveBayes_Scores AS [NaiveBayes_Scores]), 
