...
-- Code For temporary table TMP_20180602_SE5_LGBM_B0 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180602_SE5_LGBM_B0" (
	"KEY" NUMBER(19), 
...
-- Code For temporary table TMP_20180602_SE5_LGBM_B0 part 2. Populate

INSERT INTO "TMP_20180602_SE5_LGBM_B0" ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
-- Code For temporary table TMP_20180602_RZ4_LGBM_B1 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180602_RZ4_LGBM_B1" (
	"KEY" NUMBER(19), 
	"Estimator" BINARY_DOUBLE
)
...
-- Code For temporary table TMP_20180602_RZ4_LGBM_B1 part 2. Populate

INSERT INTO "TMP_20180602_RZ4_LGBM_B1" ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
-- Code For temporary table TMP_20180602_0ME_LGBM_SUM part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180602_0ME_LGBM_SUM" (
	"KEY" NUMBER(19), 
	"Estimator" BINARY_DOUBLE
)
...
-- Code For temporary table TMP_20180602_0ME_LGBM_SUM part 2. Populate

INSERT INTO "TMP_20180602_0ME_LGBM_SUM" ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
FROM "TMP_20180602_SE5_LGBM_B0" "LGBM_B0" UNION ALL SELECT "LGBM_B1"."KEY" AS "KEY", "LGBM_B1"."Estimator" AS "Estimator" 
FROM "TMP_20180602_RZ4_LGBM_B1" "LGBM_B1") "LGBM_EnsembleUnion")
...
FROM "TMP_20180602_0ME_LGBM_SUM" "LGBM_sum"