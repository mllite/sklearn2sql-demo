...
-- Code For temporary table TMP_20180602151248_VMM_LGBM_B0 part 1. Create 


CREATE TEMPORARY TABLE "TMP_20180602151248_VMM_LGBM_B0" (
	"KEY" BIGINT, 
	"Estimator" FLOAT
)
...
-- Code For temporary table TMP_20180602151248_VMM_LGBM_B0 part 2. Populate
...
FROM "DT_Output_9")
 INSERT INTO "TMP_20180602151248_VMM_LGBM_B0" ("KEY", "Estimator") SELECT "LGBM_B0"."KEY", "LGBM_B0"."Estimator" 
...
-- Code For temporary table TMP_20180602151248_7Z0_LGBM_B1 part 1. Create 


CREATE TEMPORARY TABLE "TMP_20180602151248_7Z0_LGBM_B1" (
	"KEY" BIGINT, 
	"Estimator" FLOAT
)
...
-- Code For temporary table TMP_20180602151248_7Z0_LGBM_B1 part 2. Populate
...
FROM "DT_Output_15")
 INSERT INTO "TMP_20180602151248_7Z0_LGBM_B1" ("KEY", "Estimator") SELECT "LGBM_B1"."KEY", "LGBM_B1"."Estimator" 
...
-- Code For temporary table TMP_20180602151248_V1J_LGBM_sum part 1. Create 


CREATE TEMPORARY TABLE "TMP_20180602151248_V1J_LGBM_sum" (
	"KEY" BIGINT NOT NULL, 
	"Estimator" FLOAT, 
	PRIMARY KEY ("KEY")
)
...
-- Code For temporary table TMP_20180602151248_V1J_LGBM_sum part 2. Populate
...
FROM "TMP_20180602151248_VMM_LGBM_B0" AS "LGBM_B0" UNION ALL SELECT "LGBM_B1"."KEY" AS "KEY", "LGBM_B1"."Estimator" AS "Estimator" 
FROM "TMP_20180602151248_7Z0_LGBM_B1" AS "LGBM_B1") AS "LGBM_EnsembleUnion")
 INSERT INTO "TMP_20180602151248_V1J_LGBM_sum" ("KEY", "Estimator") SELECT "LGBM_sum"."KEY", "LGBM_sum"."Estimator" 
...
-- Code For temporary table TMP_20180602151248_V1J_LGBM_sum part 3. Create Index 

CREATE INDEX "ix_TMP_20180602151248_V1J_LGBM_sum_KEY" ON "TMP_20180602151248_V1J_LGBM_sum" ("KEY")

-- Model deployment code

SELECT "LGBM_sum"."KEY" AS "KEY", "LGBM_sum"."Estimator" AS "Estimator" 
FROM "TMP_20180602151248_V1J_LGBM_sum" AS "LGBM_sum"