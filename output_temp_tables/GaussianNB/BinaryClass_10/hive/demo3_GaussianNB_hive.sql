...
-- Code For temporary table tmp_20180602141230_y42_naivebayes_scores part 1. Create 

CREATE TEMPORARY TABLE `tmp_20180602141230_y42_naivebayes_scores` STORED AS ORC AS WITH `centered_data` AS 
...
-- Code For temporary table tmp_20180602141230_y42_naivebayes_scores part 2. Populate

SELECT * FROM `tmp_20180602141230_y42_naivebayes_scores`
...
FROM `tmp_20180602141230_y42_naivebayes_scores` AS `NaiveBayes_Scores`), 
