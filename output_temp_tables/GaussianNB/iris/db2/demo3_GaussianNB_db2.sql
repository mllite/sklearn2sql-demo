...
-- Code For temporary table tmp_20180602152753_um2_naivebayes_scores part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180602152753_um2_naivebayes_scores (
	"KEY" BIGINT, 
	"Score_0" DOUBLE, 
	"Score_1" DOUBLE, 
	"Score_2" DOUBLE
...
-- Code For temporary table tmp_20180602152753_um2_naivebayes_scores part 2. Populate

INSERT INTO tmp_20180602152753_um2_naivebayes_scores WITH centered_data AS 
...
FROM tmp_20180602152753_um2_naivebayes_scores AS "NaiveBayes_Scores"), 
