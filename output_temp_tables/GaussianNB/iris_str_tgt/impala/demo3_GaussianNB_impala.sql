...
-- Code For temporary table tmp_20180602160301_bx7_naivebayes_scores part 1. Create 


CREATE TABLE tmp_20180602160301_bx7_naivebayes_scores (
	`KEY` BIGINT, 
...
-- Code For temporary table tmp_20180602160301_bx7_naivebayes_scores part 2. Populate
...
FROM centered_data) AS `Values`)
 INSERT INTO tmp_20180602160301_bx7_naivebayes_scores (`KEY`, `Score_CLASS_0`, `Score_CLASS_1`, `Score_CLASS_2`) SELECT `NaiveBayes_Scores`.`KEY`, `NaiveBayes_Scores`.`Score_CLASS_0`, `NaiveBayes_Scores`.`Score_CLASS_1`, `NaiveBayes_Scores`.`Score_CLASS_2` 
...
FROM tmp_20180602160301_bx7_naivebayes_scores AS `NaiveBayes_Scores`), 
