...
-- Code For temporary table TMP_20180602160300_1LY_NaiveBayes_Scores part 1. Create 


CREATE TEMPORARY TABLE "TMP_20180602160300_1LY_NaiveBayes_Scores" (
	"KEY" BIGINT NOT NULL, 
	"Score_CLASS_0" FLOAT, 
	"Score_CLASS_1" FLOAT, 
	"Score_CLASS_2" FLOAT, 
...
-- Code For temporary table TMP_20180602160300_1LY_NaiveBayes_Scores part 2. Populate

WITH centered_data AS 
(SELECT "ADS"."KEY" AS "KEY", CAST("ADS"."Feature_0" AS FLOAT) - 4.95945945945946 AS "Feature_0_CLASS_0", CAST("ADS"."Feature_1" AS FLOAT) - 3.4162162162162164 AS "Feature_1_CLASS_0", CAST("ADS"."Feature_2" AS FLOAT) - 1.4864864864864862 AS "Feature_2_CLASS_0", CAST("ADS"."Feature_3" AS FLOAT) - 0.2594594594594595 AS "Feature_3_CLASS_0", CAST("ADS"."Feature_0" AS FLOAT) - 5.914999999999999 AS "Feature_0_CLASS_1", CAST("ADS"."Feature_1" AS FLOAT) - 2.7600000000000007 AS "Feature_1_CLASS_1", CAST("ADS"."Feature_2" AS FLOAT) - 4.245 AS "Feature_2_CLASS_1", CAST("ADS"."Feature_3" AS FLOAT) - 1.325 AS "Feature_3_CLASS_1", CAST("ADS"."Feature_0" AS FLOAT) - 6.548837209302325 AS "Feature_0_CLASS_2", CAST("ADS"."Feature_1" AS FLOAT) - 2.9674418604651165 AS "Feature_1_CLASS_2", CAST("ADS"."Feature_2" AS FLOAT) - 5.502325581395348 AS "Feature_2_CLASS_2", CAST("ADS"."Feature_3" AS FLOAT) - 2.01860465116279 AS "Feature_3_CLASS_2" 
...
FROM centered_data) AS "Values")
 INSERT INTO "TMP_20180602160300_1LY_NaiveBayes_Scores" ("KEY", "Score_CLASS_0", "Score_CLASS_1", "Score_CLASS_2") SELECT "NaiveBayes_Scores"."KEY", "NaiveBayes_Scores"."Score_CLASS_0", "NaiveBayes_Scores"."Score_CLASS_1", "NaiveBayes_Scores"."Score_CLASS_2" 
...
-- Code For temporary table TMP_20180602160300_1LY_NaiveBayes_Scores part 3. Create Index 

CREATE INDEX "ix_TMP_20180602160300_1LY_NaiveBayes_Scores_KEY" ON "TMP_20180602160300_1LY_NaiveBayes_Scores" ("KEY")
...
FROM "TMP_20180602160300_1LY_NaiveBayes_Scores" AS "NaiveBayes_Scores"), 
