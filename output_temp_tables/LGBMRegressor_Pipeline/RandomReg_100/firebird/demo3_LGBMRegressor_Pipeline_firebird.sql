...
-- Code For temporary table TMP_20180602_V5I_ADS_IMP_1_OUT part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180602_V5I_ADS_IMP_1_OUT" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20180602_V5I_ADS_IMP_1_OUT part 3. Create Index 

CREATE INDEX "ix_TMP_20180602_V5I_ADS_9c29" ON "TMP_20180602_V5I_ADS_IMP_1_OUT" ("KEY")

-- Code For temporary table TMP_20180602_UXB_ADS_SCA_2_OUT part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180602_UXB_ADS_SCA_2_OUT" (
	"KEY" BIGINT NOT NULL, 
...
FROM "TMP_20180602_V5I_ADS_IMP_1_OUT" AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT") AS "U"

-- Code For temporary table TMP_20180602_UXB_ADS_SCA_2_OUT part 3. Create Index 

CREATE INDEX "ix_TMP_20180602_UXB_ADS_9ecd" ON "TMP_20180602_UXB_ADS_SCA_2_OUT" ("KEY")

-- Code For temporary table TMP_20180602_K6C_LGBM_B0 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180602_K6C_LGBM_B0" (
	"KEY" BIGINT, 
...
-- Code For temporary table TMP_20180602_K6C_LGBM_B0 part 2. Populate

INSERT INTO "TMP_20180602_K6C_LGBM_B0" ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
FROM "TMP_20180602_UXB_ADS_SCA_2_OUT" AS "ADS_sca_2_OUT"), 
"DT_node_data" AS 
...
-- Code For temporary table TMP_20180602_EU2_LGBM_B1 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180602_EU2_LGBM_B1" (
	"KEY" BIGINT, 
	"Estimator" DOUBLE PRECISION
)
...
-- Code For temporary table TMP_20180602_EU2_LGBM_B1 part 2. Populate

INSERT INTO "TMP_20180602_EU2_LGBM_B1" ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
-- Code For temporary table TMP_20180602_9VN_LGBM_B2 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180602_9VN_LGBM_B2" (
	"KEY" BIGINT, 
	"Estimator" DOUBLE PRECISION
)
...
-- Code For temporary table TMP_20180602_9VN_LGBM_B2 part 2. Populate

INSERT INTO "TMP_20180602_9VN_LGBM_B2" ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
-- Code For temporary table TMP_20180602_9HC_LGBM_B3 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180602_9HC_LGBM_B3" (
	"KEY" BIGINT, 
	"Estimator" DOUBLE PRECISION
)
...
-- Code For temporary table TMP_20180602_9HC_LGBM_B3 part 2. Populate

INSERT INTO "TMP_20180602_9HC_LGBM_B3" ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
-- Code For temporary table TMP_20180602_5VK_LGBM_SUM part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180602_5VK_LGBM_SUM" (
	"KEY" BIGINT NOT NULL, 
	"Estimator" DOUBLE PRECISION, 
	PRIMARY KEY ("KEY")
)
...
-- Code For temporary table TMP_20180602_5VK_LGBM_SUM part 2. Populate

INSERT INTO "TMP_20180602_5VK_LGBM_SUM" ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
FROM "TMP_20180602_K6C_LGBM_B0" AS "LGBM_B0" UNION ALL SELECT "LGBM_B1"."KEY" AS "KEY", "LGBM_B1"."Estimator" AS "Estimator" 
FROM "TMP_20180602_EU2_LGBM_B1" AS "LGBM_B1" UNION ALL SELECT "LGBM_B2"."KEY" AS "KEY", "LGBM_B2"."Estimator" AS "Estimator" 
FROM "TMP_20180602_9VN_LGBM_B2" AS "LGBM_B2" UNION ALL SELECT "LGBM_B3"."KEY" AS "KEY", "LGBM_B3"."Estimator" AS "Estimator" 
FROM "TMP_20180602_9HC_LGBM_B3" AS "LGBM_B3") AS "LGBM_EnsembleUnion")
...
-- Code For temporary table TMP_20180602_5VK_LGBM_SUM part 3. Create Index 

CREATE INDEX "ix_TMP_20180602_5VK_LGB_6ca6" ON "TMP_20180602_5VK_LGBM_SUM" ("KEY")

-- Model deployment code

SELECT "LGBM_sum"."KEY" AS "KEY", "LGBM_sum"."Estimator" AS "Estimator" 
FROM "TMP_20180602_5VK_LGBM_SUM" AS "LGBM_sum"