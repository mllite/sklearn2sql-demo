...
-- Code For temporary table 20180602_NFC_ADS_IMP_1_OUT part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "20180602_NFC_ADS_IMP_1_OUT" (
	"KEY" NUMBER(19), 
...
-- Code For temporary table 20180602_C64_ADS_SCA_2_OUT part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "20180602_C64_ADS_SCA_2_OUT" (
	"KEY" NUMBER(19), 
...
FROM "20180602_NFC_ADS_IMP_1_OUT" "ADS_imp_1_OUT") "ADS_sca_2_OUT") "U"

-- Code For temporary table TMP_20180602_JVC_LGBM_B0 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180602_JVC_LGBM_B0" (
	"KEY" NUMBER(19), 
...
-- Code For temporary table TMP_20180602_JVC_LGBM_B0 part 2. Populate

INSERT INTO "TMP_20180602_JVC_LGBM_B0" ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
FROM "20180602_C64_ADS_SCA_2_OUT" "ADS_sca_2_OUT"), 
"DT_node_data" AS 
...
-- Code For temporary table TMP_20180602_JU0_LGBM_B1 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180602_JU0_LGBM_B1" (
	"KEY" NUMBER(19), 
	"Estimator" BINARY_DOUBLE
)
...
-- Code For temporary table TMP_20180602_JU0_LGBM_B1 part 2. Populate

INSERT INTO "TMP_20180602_JU0_LGBM_B1" ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
-- Code For temporary table TMP_20180602_P67_LGBM_SUM part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180602_P67_LGBM_SUM" (
	"KEY" NUMBER(19), 
	"Estimator" BINARY_DOUBLE
)
...
-- Code For temporary table TMP_20180602_P67_LGBM_SUM part 2. Populate

INSERT INTO "TMP_20180602_P67_LGBM_SUM" ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
FROM "TMP_20180602_JVC_LGBM_B0" "LGBM_B0" UNION ALL SELECT "LGBM_B1"."KEY" AS "KEY", "LGBM_B1"."Estimator" AS "Estimator" 
FROM "TMP_20180602_JU0_LGBM_B1" "LGBM_B1") "LGBM_EnsembleUnion")
...
FROM "TMP_20180602_P67_LGBM_SUM" "LGBM_sum"