...
-- Code For temporary table TMP_20180602_4JP_ADS_IMP_1_OUT part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180602_4JP_ADS_IMP_1_OUT" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20180602_4JP_ADS_IMP_1_OUT part 3. Create Index 

CREATE INDEX "ix_TMP_20180602_4JP_ADS_e675" ON "TMP_20180602_4JP_ADS_IMP_1_OUT" ("KEY")

-- Code For temporary table TMP_20180602_4TT_ADS_SCA_2_OUT part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180602_4TT_ADS_SCA_2_OUT" (
	"KEY" BIGINT NOT NULL, 
...
FROM "TMP_20180602_4JP_ADS_IMP_1_OUT" AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT") AS "U"

-- Code For temporary table TMP_20180602_4TT_ADS_SCA_2_OUT part 3. Create Index 

CREATE INDEX "ix_TMP_20180602_4TT_ADS_3077" ON "TMP_20180602_4TT_ADS_SCA_2_OUT" ("KEY")

-- Code For temporary table TMP_20180602_9EZ_LGBM_B0 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180602_9EZ_LGBM_B0" (
	"KEY" BIGINT, 
...
-- Code For temporary table TMP_20180602_9EZ_LGBM_B0 part 2. Populate

INSERT INTO "TMP_20180602_9EZ_LGBM_B0" ("KEY", "Score_0") SELECT "U"."KEY", "U"."Score_0" 
...
FROM "TMP_20180602_4TT_ADS_SCA_2_OUT" AS "ADS_sca_2_OUT"), 
"DT_node_data" AS 
...
-- Code For temporary table TMP_20180602_88R_LGBM_B1 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180602_88R_LGBM_B1" (
	"KEY" BIGINT, 
	"Score_0" DOUBLE PRECISION
)
...
-- Code For temporary table TMP_20180602_88R_LGBM_B1 part 2. Populate

INSERT INTO "TMP_20180602_88R_LGBM_B1" ("KEY", "Score_0") SELECT "U"."KEY", "U"."Score_0" 
...
-- Code For temporary table TMP_20180602_2F5_LGBM_B2 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180602_2F5_LGBM_B2" (
	"KEY" BIGINT, 
	"Score_0" DOUBLE PRECISION
)
...
-- Code For temporary table TMP_20180602_2F5_LGBM_B2 part 2. Populate

INSERT INTO "TMP_20180602_2F5_LGBM_B2" ("KEY", "Score_0") SELECT "U"."KEY", "U"."Score_0" 
...
-- Code For temporary table TMP_20180602_3RD_LGBM_B3 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180602_3RD_LGBM_B3" (
	"KEY" BIGINT, 
	"Score_0" DOUBLE PRECISION
)
...
-- Code For temporary table TMP_20180602_3RD_LGBM_B3 part 2. Populate

INSERT INTO "TMP_20180602_3RD_LGBM_B3" ("KEY", "Score_0") SELECT "U"."KEY", "U"."Score_0" 
...
-- Code For temporary table TMP_20180602_M66_LGBM_SUM part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180602_M66_LGBM_SUM" (
	"KEY" BIGINT NOT NULL, 
	"Score_0" DOUBLE PRECISION, 
	PRIMARY KEY ("KEY")
)
...
-- Code For temporary table TMP_20180602_M66_LGBM_SUM part 2. Populate

INSERT INTO "TMP_20180602_M66_LGBM_SUM" ("KEY", "Score_0") SELECT "U"."KEY", "U"."Score_0" 
...
FROM "TMP_20180602_9EZ_LGBM_B0" AS "LGBM_B0" UNION ALL SELECT "LGBM_B1"."KEY" AS "KEY", "LGBM_B1"."Score_0" AS "Score_0" 
FROM "TMP_20180602_88R_LGBM_B1" AS "LGBM_B1" UNION ALL SELECT "LGBM_B2"."KEY" AS "KEY", "LGBM_B2"."Score_0" AS "Score_0" 
FROM "TMP_20180602_2F5_LGBM_B2" AS "LGBM_B2" UNION ALL SELECT "LGBM_B3"."KEY" AS "KEY", "LGBM_B3"."Score_0" AS "Score_0" 
FROM "TMP_20180602_3RD_LGBM_B3" AS "LGBM_B3") AS "LGBM_EnsembleUnion")
...
-- Code For temporary table TMP_20180602_M66_LGBM_SUM part 3. Create Index 

CREATE INDEX "ix_TMP_20180602_M66_LGB_ed85" ON "TMP_20180602_M66_LGBM_SUM" ("KEY")
...
FROM "TMP_20180602_M66_LGBM_SUM" AS "LGBM_sum"), 
