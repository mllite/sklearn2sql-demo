...
-- Code For temporary table TMP_20180602141910_381_ADS_imp_1_OUT part 1. Create 


CREATE TEMPORARY TABLE "TMP_20180602141910_381_ADS_imp_1_OUT" (
	"KEY" BIGINT NOT NULL, 
	impter_2 FLOAT, 
	impter_3 FLOAT, 
	impter_4 FLOAT, 
...
-- Code For temporary table TMP_20180602141910_381_ADS_imp_1_OUT part 3. Create Index 

CREATE INDEX "ix_TMP_20180602141910_381_ADS_imp_1_OUT_KEY" ON "TMP_20180602141910_381_ADS_imp_1_OUT" ("KEY")

-- Code For temporary table TMP_20180602141910_65V_ADS_sca_2_OUT part 1. Create 


CREATE TEMPORARY TABLE "TMP_20180602141910_65V_ADS_sca_2_OUT" (
	"KEY" BIGINT NOT NULL, 
	scaler_2 FLOAT, 
	scaler_3 FLOAT, 
	scaler_4 FLOAT, 
...
FROM "TMP_20180602141910_381_ADS_imp_1_OUT" AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT"

-- Code For temporary table TMP_20180602141910_65V_ADS_sca_2_OUT part 3. Create Index 

CREATE INDEX "ix_TMP_20180602141910_65V_ADS_sca_2_OUT_KEY" ON "TMP_20180602141910_65V_ADS_sca_2_OUT" ("KEY")

-- Code For temporary table TMP_20180602141910_68O_LGBM_B0 part 1. Create 


CREATE TEMPORARY TABLE "TMP_20180602141910_68O_LGBM_B0" (
	"KEY" BIGINT, 
	"Score_0" FLOAT
)
...
-- Code For temporary table TMP_20180602141910_68O_LGBM_B0 part 2. Populate
...
FROM "TMP_20180602141910_65V_ADS_sca_2_OUT" AS "ADS_sca_2_OUT"), 
"DT_node_data" AS 
...
FROM "DT_Output_9")
 INSERT INTO "TMP_20180602141910_68O_LGBM_B0" ("KEY", "Score_0") SELECT "LGBM_B0"."KEY", "LGBM_B0"."Score_0" 
...
-- Code For temporary table TMP_20180602141910_REX_LGBM_B1 part 1. Create 


CREATE TEMPORARY TABLE "TMP_20180602141910_REX_LGBM_B1" (
	"KEY" BIGINT, 
	"Score_0" FLOAT
)
...
-- Code For temporary table TMP_20180602141910_REX_LGBM_B1 part 2. Populate
...
FROM "DT_Output_15")
 INSERT INTO "TMP_20180602141910_REX_LGBM_B1" ("KEY", "Score_0") SELECT "LGBM_B1"."KEY", "LGBM_B1"."Score_0" 
...
-- Code For temporary table TMP_20180602141910_3K1_LGBM_sum part 1. Create 


CREATE TEMPORARY TABLE "TMP_20180602141910_3K1_LGBM_sum" (
	"KEY" BIGINT NOT NULL, 
	"Score_0" FLOAT, 
	PRIMARY KEY ("KEY")
)
...
-- Code For temporary table TMP_20180602141910_3K1_LGBM_sum part 2. Populate
...
FROM "TMP_20180602141910_68O_LGBM_B0" AS "LGBM_B0" UNION ALL SELECT "LGBM_B1"."KEY" AS "KEY", "LGBM_B1"."Score_0" AS "Score_0" 
FROM "TMP_20180602141910_REX_LGBM_B1" AS "LGBM_B1") AS "LGBM_EnsembleUnion")
 INSERT INTO "TMP_20180602141910_3K1_LGBM_sum" ("KEY", "Score_0") SELECT "LGBM_sum"."KEY", "LGBM_sum"."Score_0" 
...
-- Code For temporary table TMP_20180602141910_3K1_LGBM_sum part 3. Create Index 

CREATE INDEX "ix_TMP_20180602141910_3K1_LGBM_sum_KEY" ON "TMP_20180602141910_3K1_LGBM_sum" ("KEY")
...
FROM "TMP_20180602141910_3K1_LGBM_sum" AS "LGBM_sum"), 
