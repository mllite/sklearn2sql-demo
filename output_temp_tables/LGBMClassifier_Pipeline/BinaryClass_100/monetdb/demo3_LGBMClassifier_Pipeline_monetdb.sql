...
-- Code For temporary table tmp_20180602141910_lr5_ads_imp_1_out part 1. Create 


CREATE TEMPORARY TABLE tmp_20180602141910_lr5_ads_imp_1_out (
	"KEY" BIGINT, 
	impter_2 DOUBLE, 
	impter_3 DOUBLE, 
	impter_4 DOUBLE, 
...
-- Code For temporary table tmp_20180602141910_4ye_ads_sca_2_out part 1. Create 


CREATE TEMPORARY TABLE tmp_20180602141910_4ye_ads_sca_2_out (
	"KEY" BIGINT, 
	scaler_2 DOUBLE, 
	scaler_3 DOUBLE, 
	scaler_4 DOUBLE, 
...
FROM tmp_20180602141910_lr5_ads_imp_1_out AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT") AS "U"

-- Code For temporary table tmp_20180602141910_nia_lgbm_b0 part 1. Create 


CREATE TEMPORARY TABLE tmp_20180602141910_nia_lgbm_b0 (
	"KEY" BIGINT, 
	"Score_0" DOUBLE
)
...
-- Code For temporary table tmp_20180602141910_nia_lgbm_b0 part 2. Populate

INSERT INTO tmp_20180602141910_nia_lgbm_b0 ("KEY", "Score_0") SELECT "U"."KEY", "U"."Score_0" 
...
FROM tmp_20180602141910_4ye_ads_sca_2_out AS "ADS_sca_2_OUT"), 
"DT_node_data" AS 
...
-- Code For temporary table tmp_20180602141910_rb7_lgbm_b1 part 1. Create 


CREATE TEMPORARY TABLE tmp_20180602141910_rb7_lgbm_b1 (
	"KEY" BIGINT, 
	"Score_0" DOUBLE
)
...
-- Code For temporary table tmp_20180602141910_rb7_lgbm_b1 part 2. Populate

INSERT INTO tmp_20180602141910_rb7_lgbm_b1 ("KEY", "Score_0") SELECT "U"."KEY", "U"."Score_0" 
...
-- Code For temporary table tmp_20180602141910_h7y_lgbm_sum part 1. Create 


CREATE TEMPORARY TABLE tmp_20180602141910_h7y_lgbm_sum (
	"KEY" BIGINT, 
	"Score_0" DOUBLE
)
...
-- Code For temporary table tmp_20180602141910_h7y_lgbm_sum part 2. Populate

INSERT INTO tmp_20180602141910_h7y_lgbm_sum ("KEY", "Score_0") SELECT "U"."KEY", "U"."Score_0" 
...
FROM tmp_20180602141910_nia_lgbm_b0 AS "LGBM_B0" UNION ALL SELECT "LGBM_B1"."KEY" AS "KEY", "LGBM_B1"."Score_0" AS "Score_0" 
FROM tmp_20180602141910_rb7_lgbm_b1 AS "LGBM_B1") AS "LGBM_EnsembleUnion")
...
FROM tmp_20180602141910_h7y_lgbm_sum AS "LGBM_sum"), 
