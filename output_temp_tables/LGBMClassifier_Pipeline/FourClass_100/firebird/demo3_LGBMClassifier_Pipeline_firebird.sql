...
-- Code For temporary table TMP_20180602_V4M_ADS_IMP_1_OUT part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180602_V4M_ADS_IMP_1_OUT" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20180602_V4M_ADS_IMP_1_OUT part 3. Create Index 

CREATE INDEX "ix_TMP_20180602_V4M_ADS_f375" ON "TMP_20180602_V4M_ADS_IMP_1_OUT" ("KEY")

-- Code For temporary table TMP_20180602_F24_ADS_SCA_2_OUT part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180602_F24_ADS_SCA_2_OUT" (
	"KEY" BIGINT NOT NULL, 
...
FROM "TMP_20180602_V4M_ADS_IMP_1_OUT" AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT") AS "U"

-- Code For temporary table TMP_20180602_F24_ADS_SCA_2_OUT part 3. Create Index 

CREATE INDEX "ix_TMP_20180602_F24_ADS_d70d" ON "TMP_20180602_F24_ADS_SCA_2_OUT" ("KEY")

-- Code For temporary table TMP_20180602_SSX_LGBM_B0 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180602_SSX_LGBM_B0" (
	"KEY" BIGINT, 
...
-- Code For temporary table TMP_20180602_SSX_LGBM_B0 part 2. Populate

INSERT INTO "TMP_20180602_SSX_LGBM_B0" ("KEY", "Score_0", "Score_1", "Score_2", "Score_3") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1", "U"."Score_2", "U"."Score_3" 
...
FROM "TMP_20180602_F24_ADS_SCA_2_OUT" AS "ADS_sca_2_OUT"), 
"DT_node_data" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE PRECISION) AS "Score" 
FROM (SELECT 4 AS nid, -0.01999999999999999 AS "Score" FROM rdb$database UNION ALL SELECT 5 AS nid, -0.03333333333333333 AS "Score" FROM rdb$database UNION ALL SELECT 6 AS nid, 0.05757575757575755 AS "Score" FROM rdb$database UNION ALL SELECT 7 AS nid, -0.0011494252873563218 AS "Score" FROM rdb$database) AS "Values"), 
"DT_Output" AS 
...
"DT_node_data_1" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE PRECISION) AS "Score" 
FROM (SELECT 3 AS nid, 0.04000000000000001 AS "Score" FROM rdb$database UNION ALL SELECT 4 AS nid, -0.029629629629629624 AS "Score" FROM rdb$database UNION ALL SELECT 10 AS nid, -0.013333333333333336 AS "Score" FROM rdb$database UNION ALL SELECT 11 AS nid, 0.03333333333333333 AS "Score" FROM rdb$database) AS "Values"), 
"DT_Output_1" AS 
...
"DT_node_data_2" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE PRECISION) AS "Score" 
FROM (SELECT 2 AS nid, 0.049206349206349205 AS "Score" FROM rdb$database UNION ALL SELECT 6 AS nid, 0.0030303030303030294 AS "Score" FROM rdb$database UNION ALL SELECT 14 AS nid, -0.02666666666666667 AS "Score" FROM rdb$database UNION ALL SELECT 15 AS nid, -0.03333333333333333 AS "Score" FROM rdb$database) AS "Values"), 
"DT_Output_2" AS 
...
"DT_node_data_3" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE PRECISION) AS "Score" 
FROM (SELECT 3 AS nid, 0.027619047619047623 AS "Score" FROM rdb$database UNION ALL SELECT 4 AS nid, -0.033333333333333326 AS "Score" FROM rdb$database UNION ALL SELECT 5 AS nid, 0.006172839506172839 AS "Score" FROM rdb$database) AS "Values"), 
"DT_Output_3" AS 
...
"DT_node_data_4" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE PRECISION) AS "Score" 
FROM (SELECT 4 AS nid, -0.01950137705240332 AS "Score" FROM rdb$database UNION ALL SELECT 5 AS nid, -0.033116866801664334 AS "Score" FROM rdb$database UNION ALL SELECT 6 AS nid, 0.04781539670855374 AS "Score" FROM rdb$database UNION ALL SELECT 7 AS nid, -0.009422123523754237 AS "Score" FROM rdb$database) AS "Values"), 
"DT_Output_4" AS 
...
FROM "LGBM_Model_0_1") AS "LGBM_esu_0") AS "LGBM_B0") AS "U"

-- Code For temporary table TMP_20180602_1SS_LGBM_B1 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180602_1SS_LGBM_B1" (
	"KEY" BIGINT, 
	"Score_0" DOUBLE PRECISION, 
	"Score_1" DOUBLE PRECISION, 
	"Score_2" DOUBLE PRECISION, 
...
-- Code For temporary table TMP_20180602_1SS_LGBM_B1 part 2. Populate

INSERT INTO "TMP_20180602_1SS_LGBM_B1" ("KEY", "Score_0", "Score_1", "Score_2", "Score_3") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1", "U"."Score_2", "U"."Score_3" 
FROM (WITH "DT_node_lookup_5" AS 
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", CASE WHEN ("ADS_sca_2_OUT".scaler_94 <= 0.7422130423340411) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_11 <= -0.16760702855928997) THEN 4 ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_96 <= 0.0909658923333073) THEN 10 ELSE 11 END END ELSE 3 END AS node_id_2 
FROM "TMP_20180602_F24_ADS_SCA_2_OUT" AS "ADS_sca_2_OUT"), 
"DT_node_data_5" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE PRECISION) AS "Score" 
FROM (SELECT 3 AS nid, 0.03801363088997682 AS "Score" FROM rdb$database UNION ALL SELECT 4 AS nid, -0.02932448464318399 AS "Score" FROM rdb$database UNION ALL SELECT 10 AS nid, -0.013031594356816707 AS "Score" FROM rdb$database UNION ALL SELECT 11 AS nid, 0.03196767946224493 AS "Score" FROM rdb$database) AS "Values"), 
"DT_Output_5" AS 
...
"DT_node_data_6" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE PRECISION) AS "Score" 
FROM (SELECT 2 AS nid, 0.04638783591701232 AS "Score" FROM rdb$database UNION ALL SELECT 6 AS nid, 0.0034657951744659385 AS "Score" FROM rdb$database UNION ALL SELECT 14 AS nid, -0.02634969149111432 AS "Score" FROM rdb$database UNION ALL SELECT 15 AS nid, -0.033209690833556266 AS "Score" FROM rdb$database) AS "Values"), 
"DT_Output_6" AS 
...
"DT_node_data_7" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE PRECISION) AS "Score" 
FROM (SELECT 3 AS nid, 0.02675748219394763 AS "Score" FROM rdb$database UNION ALL SELECT 5 AS nid, 0.011240839547350058 AS "Score" FROM rdb$database UNION ALL SELECT 8 AS nid, -0.02634310269199366 AS "Score" FROM rdb$database UNION ALL SELECT 9 AS nid, -0.033280777876280025 AS "Score" FROM rdb$database) AS "Values"), 
"DT_Output_7" AS 
...
"DT_node_data_8" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE PRECISION) AS "Score" 
FROM (SELECT 4 AS nid, -0.03288932934129021 AS "Score" FROM rdb$database UNION ALL SELECT 5 AS nid, -0.018979159650187077 AS "Score" FROM rdb$database UNION ALL SELECT 6 AS nid, 0.04528919771027677 AS "Score" FROM rdb$database UNION ALL SELECT 7 AS nid, -0.00923136933403049 AS "Score" FROM rdb$database) AS "Values"), 
"DT_Output_8" AS 
...
"DT_node_data_9" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE PRECISION) AS "Score" 
FROM (SELECT 3 AS nid, 0.03601188358369819 AS "Score" FROM rdb$database UNION ALL SELECT 4 AS nid, -0.02901065244136429 AS "Score" FROM rdb$database UNION ALL SELECT 10 AS nid, -0.012779393567827178 AS "Score" FROM rdb$database UNION ALL SELECT 11 AS nid, 0.03082650742811993 AS "Score" FROM rdb$database) AS "Values"), 
"DT_Output_9" AS 
...
FROM (SELECT "LGBM_Model_1_1"."KEY" AS "KEY", "LGBM_Model_1_1"."Score_0" AS "Score_0", "LGBM_Model_1_1"."Score_1" AS "Score_1", "LGBM_Model_1_1"."Score_2" AS "Score_2", "LGBM_Model_1_1"."Score_3" AS "Score_3" 
...
FROM "LGBM_Model_1_2") AS "LGBM_esu_1") AS "LGBM_B1") AS "U"

-- Code For temporary table TMP_20180602_8G5_LGBM_B2 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180602_8G5_LGBM_B2" (
	"KEY" BIGINT, 
	"Score_0" DOUBLE PRECISION, 
	"Score_1" DOUBLE PRECISION, 
	"Score_2" DOUBLE PRECISION, 
...
-- Code For temporary table TMP_20180602_8G5_LGBM_B2 part 2. Populate

INSERT INTO "TMP_20180602_8G5_LGBM_B2" ("KEY", "Score_0", "Score_1", "Score_2", "Score_3") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1", "U"."Score_2", "U"."Score_3" 
...
"DT_node_data_10" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE PRECISION) AS "Score" 
FROM (SELECT 2 AS nid, 0.04392797619813257 AS "Score" FROM rdb$database UNION ALL SELECT 6 AS nid, 0.0034995312760598384 AS "Score" FROM rdb$database UNION ALL SELECT 14 AS nid, -0.025947628685301028 AS "Score" FROM rdb$database UNION ALL SELECT 15 AS nid, -0.03298520699909284 AS "Score" FROM rdb$database) AS "Values"), 
"DT_Output_10" AS 
...
"DT_node_data_11" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE PRECISION) AS "Score" 
FROM (SELECT 3 AS nid, 0.02602074371562861 AS "Score" FROM rdb$database UNION ALL SELECT 4 AS nid, -0.03282433362550692 AS "Score" FROM rdb$database UNION ALL SELECT 5 AS nid, 0.0055247378514521606 AS "Score" FROM rdb$database) AS "Values"), 
"DT_Output_11" AS 
...
"DT_node_data_12" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE PRECISION) AS "Score" 
FROM (SELECT 4 AS nid, -0.03264995365787314 AS "Score" FROM rdb$database UNION ALL SELECT 5 AS nid, -0.018595830886695815 AS "Score" FROM rdb$database UNION ALL SELECT 6 AS nid, 0.050425691987455085 AS "Score" FROM rdb$database UNION ALL SELECT 7 AS nid, -0.001749296984293454 AS "Score" FROM rdb$database) AS "Values"), 
"DT_Output_12" AS 
...
"DT_node_data_13" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE PRECISION) AS "Score" 
FROM (SELECT 2 AS nid, -0.021949004218140684 AS "Score" FROM rdb$database UNION ALL SELECT 6 AS nid, -0.0157961023443223 AS "Score" FROM rdb$database UNION ALL SELECT 7 AS nid, 0.03348313811293968 AS "Score" FROM rdb$database) AS "Values"), 
"DT_Output_13" AS 
...
"DT_node_data_14" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE PRECISION) AS "Score" 
FROM (SELECT 4 AS nid, 0.05918926165394689 AS "Score" FROM rdb$database UNION ALL SELECT 5 AS nid, -0.013161794876484953 AS "Score" FROM rdb$database UNION ALL SELECT 6 AS nid, -0.032972000921317655 AS "Score" FROM rdb$database UNION ALL SELECT 7 AS nid, -0.00737896830596874 AS "Score" FROM rdb$database) AS "Values"), 
"DT_Output_14" AS 
...
FROM "LGBM_Model_2_3") AS "LGBM_esu_2") AS "LGBM_B2") AS "U"

-- Code For temporary table TMP_20180602_MGU_LGBM_B3 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180602_MGU_LGBM_B3" (
	"KEY" BIGINT, 
	"Score_0" DOUBLE PRECISION, 
	"Score_1" DOUBLE PRECISION, 
	"Score_2" DOUBLE PRECISION, 
...
-- Code For temporary table TMP_20180602_MGU_LGBM_B3 part 2. Populate

INSERT INTO "TMP_20180602_MGU_LGBM_B3" ("KEY", "Score_0", "Score_1", "Score_2", "Score_3") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1", "U"."Score_2", "U"."Score_3" 
FROM (WITH "DT_node_lookup_15" AS 
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", CASE WHEN ("ADS_sca_2_OUT".scaler_46 <= 0.3111670739918176) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_56 <= 0.43876687599494696) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_7 <= 0.20916239470271483) THEN 8 ELSE 9 END ELSE 5 END ELSE 3 END AS node_id_2 
FROM "TMP_20180602_F24_ADS_SCA_2_OUT" AS "ADS_sca_2_OUT"), 
"DT_node_data_15" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE PRECISION) AS "Score" 
FROM (SELECT 3 AS nid, 0.024883342651118974 AS "Score" FROM rdb$database UNION ALL SELECT 5 AS nid, 0.011209397650172129 AS "Score" FROM rdb$database UNION ALL SELECT 8 AS nid, -0.02574125662263579 AS "Score" FROM rdb$database UNION ALL SELECT 9 AS nid, -0.03297883402734973 AS "Score" FROM rdb$database) AS "Values"), 
"DT_Output_15" AS 
...
"DT_node_data_16" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE PRECISION) AS "Score" 
FROM (SELECT 4 AS nid, -0.032430851677658405 AS "Score" FROM rdb$database UNION ALL SELECT 5 AS nid, -0.018123846889430296 AS "Score" FROM rdb$database UNION ALL SELECT 6 AS nid, 0.04170977978319426 AS "Score" FROM rdb$database UNION ALL SELECT 7 AS nid, -0.009273140804504107 AS "Score" FROM rdb$database) AS "Values"), 
"DT_Output_16" AS 
...
"DT_node_data_17" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE PRECISION) AS "Score" 
FROM (SELECT 2 AS nid, -0.021626484496901358 AS "Score" FROM rdb$database UNION ALL SELECT 6 AS nid, -0.015503980862153691 AS "Score" FROM rdb$database UNION ALL SELECT 7 AS nid, 0.032075414127692256 AS "Score" FROM rdb$database) AS "Values"), 
"DT_Output_17" AS 
...
"DT_node_data_18" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE PRECISION) AS "Score" 
FROM (SELECT 2 AS nid, 0.03421543959311732 AS "Score" FROM rdb$database UNION ALL SELECT 6 AS nid, 0.00487014039315363 AS "Score" FROM rdb$database UNION ALL SELECT 14 AS nid, -0.03268338788831202 AS "Score" FROM rdb$database UNION ALL SELECT 15 AS nid, -0.025388920964320674 AS "Score" FROM rdb$database) AS "Values"), 
"DT_Output_18" AS 
...
"DT_node_data_19" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE PRECISION) AS "Score" 
FROM (SELECT 3 AS nid, 0.024617499910754504 AS "Score" FROM rdb$database UNION ALL SELECT 4 AS nid, -0.032396812397344085 AS "Score" FROM rdb$database UNION ALL SELECT 5 AS nid, 0.005050332513611498 AS "Score" FROM rdb$database) AS "Values"), 
"DT_Output_19" AS 
...
FROM (SELECT "LGBM_Model_3_3"."KEY" AS "KEY", "LGBM_Model_3_3"."Score_0" AS "Score_0", "LGBM_Model_3_3"."Score_1" AS "Score_1", "LGBM_Model_3_3"."Score_2" AS "Score_2", "LGBM_Model_3_3"."Score_3" AS "Score_3" 
...
FROM "LGBM_Model_3_4") AS "LGBM_esu_3") AS "LGBM_B3") AS "U"

-- Code For temporary table TMP_20180602_LJE_LGBM_B4 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180602_LJE_LGBM_B4" (
	"KEY" BIGINT, 
	"Score_0" DOUBLE PRECISION, 
	"Score_1" DOUBLE PRECISION, 
	"Score_2" DOUBLE PRECISION, 
...
-- Code For temporary table TMP_20180602_LJE_LGBM_B4 part 2. Populate

INSERT INTO "TMP_20180602_LJE_LGBM_B4" ("KEY", "Score_0", "Score_1", "Score_2", "Score_3") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1", "U"."Score_2", "U"."Score_3" 
...
"DT_node_data_20" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE PRECISION) AS "Score" 
FROM (SELECT 4 AS nid, -0.01775222720740029 AS "Score" FROM rdb$database UNION ALL SELECT 5 AS nid, -0.03221277551225128 AS "Score" FROM rdb$database UNION ALL SELECT 6 AS nid, 0.04694754208658461 AS "Score" FROM rdb$database UNION ALL SELECT 7 AS nid, -0.0026131372933433754 AS "Score" FROM rdb$database) AS "Values"), 
"DT_Output_20" AS 
...
"DT_node_data_21" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE PRECISION) AS "Score" 
FROM (SELECT 2 AS nid, -0.019702425673491817 AS "Score" FROM rdb$database UNION ALL SELECT 6 AS nid, -0.016999640407648977 AS "Score" FROM rdb$database UNION ALL SELECT 7 AS nid, 0.04084800650737508 AS "Score" FROM rdb$database) AS "Values"), 
"DT_Output_21" AS 
...
"DT_node_data_22" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE PRECISION) AS "Score" 
FROM (SELECT 4 AS nid, 0.054354714566359146 AS "Score" FROM rdb$database UNION ALL SELECT 5 AS nid, -0.012728726983595277 AS "Score" FROM rdb$database UNION ALL SELECT 6 AS nid, -0.032577907328825005 AS "Score" FROM rdb$database UNION ALL SELECT 7 AS nid, -0.00712695224663154 AS "Score" FROM rdb$database) AS "Values"), 
"DT_Output_22" AS 
...
"DT_node_data_23" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE PRECISION) AS "Score" 
FROM (SELECT 4 AS nid, -0.01541499384979074 AS "Score" FROM rdb$database UNION ALL SELECT 5 AS nid, 0.04875831694517585 AS "Score" FROM rdb$database UNION ALL SELECT 6 AS nid, -0.03329191878814407 AS "Score" FROM rdb$database UNION ALL SELECT 7 AS nid, 0.0008424509870639216 AS "Score" FROM rdb$database) AS "Values"), 
"DT_Output_23" AS 
...
"DT_node_data_24" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE PRECISION) AS "Score" 
FROM (SELECT 4 AS nid, -0.032003459482789993 AS "Score" FROM rdb$database UNION ALL SELECT 5 AS nid, -0.017356620302595844 AS "Score" FROM rdb$database UNION ALL SELECT 6 AS nid, 0.04770528095183903 AS "Score" FROM rdb$database UNION ALL SELECT 7 AS nid, -0.0006797085272083525 AS "Score" FROM rdb$database) AS "Values"), 
"DT_Output_24" AS 
...
FROM "LGBM_Model_0_6") AS "LGBM_esu_4") AS "LGBM_B4") AS "U"

-- Code For temporary table TMP_20180602_O0J_LGBM_B5 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180602_O0J_LGBM_B5" (
	"KEY" BIGINT, 
	"Score_0" DOUBLE PRECISION, 
	"Score_1" DOUBLE PRECISION, 
	"Score_2" DOUBLE PRECISION, 
...
-- Code For temporary table TMP_20180602_O0J_LGBM_B5 part 2. Populate

INSERT INTO "TMP_20180602_O0J_LGBM_B5" ("KEY", "Score_0", "Score_1", "Score_2", "Score_3") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1", "U"."Score_2", "U"."Score_3" 
FROM (WITH "DT_node_lookup_25" AS 
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", CASE WHEN ("ADS_sca_2_OUT".scaler_50 <= -0.20437877954345876) THEN 2 ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_90 <= -0.3502806381050438) THEN 6 ELSE 7 END END AS node_id_2 
FROM "TMP_20180602_F24_ADS_SCA_2_OUT" AS "ADS_sca_2_OUT"), 
"DT_node_data_25" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE PRECISION) AS "Score" 
FROM (SELECT 2 AS nid, -0.019371272894301267 AS "Score" FROM rdb$database UNION ALL SELECT 6 AS nid, -0.016721247478611947 AS "Score" FROM rdb$database UNION ALL SELECT 7 AS nid, 0.03899686638528799 AS "Score" FROM rdb$database) AS "Values"), 
"DT_Output_25" AS 
...
"DT_node_data_26" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE PRECISION) AS "Score" 
FROM (SELECT 4 AS nid, 0.05149522314283292 AS "Score" FROM rdb$database UNION ALL SELECT 5 AS nid, -0.012504544603488288 AS "Score" FROM rdb$database UNION ALL SELECT 6 AS nid, -0.032328547542213336 AS "Score" FROM rdb$database UNION ALL SELECT 7 AS nid, -0.006774197240865256 AS "Score" FROM rdb$database) AS "Values"), 
"DT_Output_26" AS 
...
"DT_node_data_27" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE PRECISION) AS "Score" 
FROM (SELECT 3 AS nid, 0.023376036454596696 AS "Score" FROM rdb$database UNION ALL SELECT 4 AS nid, -0.03207537004744958 AS "Score" FROM rdb$database UNION ALL SELECT 5 AS nid, 0.004883438224411979 AS "Score" FROM rdb$database) AS "Values"), 
"DT_Output_27" AS 
...
"DT_node_data_28" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE PRECISION) AS "Score" 
FROM (SELECT 4 AS nid, -0.03181411183123618 AS "Score" FROM rdb$database UNION ALL SELECT 5 AS nid, -0.016933666524256135 AS "Score" FROM rdb$database UNION ALL SELECT 6 AS nid, 0.03772860917958193 AS "Score" FROM rdb$database UNION ALL SELECT 7 AS nid, -0.009573319152340823 AS "Score" FROM rdb$database) AS "Values"), 
"DT_Output_28" AS 
...
"DT_node_data_29" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE PRECISION) AS "Score" 
FROM (SELECT 2 AS nid, -0.02120590996883151 AS "Score" FROM rdb$database UNION ALL SELECT 6 AS nid, -0.010137523496834167 AS "Score" FROM rdb$database UNION ALL SELECT 7 AS nid, 0.03392735655650109 AS "Score" FROM rdb$database) AS "Values"), 
"DT_Output_29" AS 
...
FROM (SELECT "LGBM_Model_1_6"."KEY" AS "KEY", "LGBM_Model_1_6"."Score_0" AS "Score_0", "LGBM_Model_1_6"."Score_1" AS "Score_1", "LGBM_Model_1_6"."Score_2" AS "Score_2", "LGBM_Model_1_6"."Score_3" AS "Score_3" 
...
FROM "LGBM_Model_1_7") AS "LGBM_esu_5") AS "LGBM_B5") AS "U"

-- Code For temporary table TMP_20180602_Y56_LGBM_B6 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180602_Y56_LGBM_B6" (
	"KEY" BIGINT, 
	"Score_0" DOUBLE PRECISION, 
	"Score_1" DOUBLE PRECISION, 
	"Score_2" DOUBLE PRECISION, 
...
-- Code For temporary table TMP_20180602_Y56_LGBM_B6 part 2. Populate

INSERT INTO "TMP_20180602_Y56_LGBM_B6" ("KEY", "Score_0", "Score_1", "Score_2", "Score_3") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1", "U"."Score_2", "U"."Score_3" 
FROM (WITH "DT_node_lookup_30" AS 
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", CASE WHEN ("ADS_sca_2_OUT".scaler_58 <= -0.22148632814087912) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_56 <= 0.20615032458101307) THEN 4 ELSE 5 END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_97 <= 0.2681499738371736) THEN 6 ELSE 7 END END AS node_id_2 
FROM "TMP_20180602_F24_ADS_SCA_2_OUT" AS "ADS_sca_2_OUT"), 
"DT_node_data_30" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE PRECISION) AS "Score" 
FROM (SELECT 4 AS nid, 0.049041201469898654 AS "Score" FROM rdb$database UNION ALL SELECT 5 AS nid, -0.012216631427201374 AS "Score" FROM rdb$database UNION ALL SELECT 6 AS nid, -0.03208452504859873 AS "Score" FROM rdb$database UNION ALL SELECT 7 AS nid, -0.006682050585242594 AS "Score" FROM rdb$database) AS "Values"), 
"DT_Output_30" AS 
...
"DT_node_data_31" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE PRECISION) AS "Score" 
FROM (SELECT 4 AS nid, -0.015126519234631425 AS "Score" FROM rdb$database UNION ALL SELECT 5 AS nid, 0.04550586119432775 AS "Score" FROM rdb$database UNION ALL SELECT 6 AS nid, -0.03294298315599817 AS "Score" FROM rdb$database UNION ALL SELECT 7 AS nid, 0.0009464242182587762 AS "Score" FROM rdb$database) AS "Values"), 
"DT_Output_31" AS 
...
"DT_node_data_32" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE PRECISION) AS "Score" 
FROM (SELECT 4 AS nid, -0.03159959372480136 AS "Score" FROM rdb$database UNION ALL SELECT 5 AS nid, -0.01654230089557483 AS "Score" FROM rdb$database UNION ALL SELECT 6 AS nid, 0.04238156603142348 AS "Score" FROM rdb$database UNION ALL SELECT 7 AS nid, -0.0032544268823302826 AS "Score" FROM rdb$database) AS "Values"), 
"DT_Output_32" AS 
...
"DT_node_data_33" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE PRECISION) AS "Score" 
FROM (SELECT 2 AS nid, -0.020853887712922344 AS "Score" FROM rdb$database UNION ALL SELECT 6 AS nid, -0.009952491556638608 AS "Score" FROM rdb$database UNION ALL SELECT 7 AS nid, 0.03242662126086929 AS "Score" FROM rdb$database) AS "Values"), 
"DT_Output_33" AS 
...
"DT_node_data_34" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE PRECISION) AS "Score" 
FROM (SELECT 2 AS nid, 0.030120644069081312 AS "Score" FROM rdb$database UNION ALL SELECT 6 AS nid, 0.0055838147715844035 AS "Score" FROM rdb$database UNION ALL SELECT 14 AS nid, -0.02433246104415448 AS "Score" FROM rdb$database UNION ALL SELECT 15 AS nid, -0.032351120287786805 AS "Score" FROM rdb$database) AS "Values"), 
"DT_Output_34" AS 
...
FROM "LGBM_Model_2_8") AS "LGBM_esu_6") AS "LGBM_B6") AS "U"

-- Code For temporary table TMP_20180602_0XW_LGBM_B7 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180602_0XW_LGBM_B7" (
	"KEY" BIGINT, 
	"Score_0" DOUBLE PRECISION, 
	"Score_1" DOUBLE PRECISION, 
	"Score_2" DOUBLE PRECISION, 
...
-- Code For temporary table TMP_20180602_0XW_LGBM_B7 part 2. Populate

INSERT INTO "TMP_20180602_0XW_LGBM_B7" ("KEY", "Score_0", "Score_1", "Score_2", "Score_3") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1", "U"."Score_2", "U"."Score_3" 
FROM (WITH "DT_node_lookup_35" AS 
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", CASE WHEN ("ADS_sca_2_OUT".scaler_31 <= 0.36901699791788345) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_46 <= 0.06978065000800054) THEN 4 ELSE 5 END ELSE 3 END AS node_id_2 
FROM "TMP_20180602_F24_ADS_SCA_2_OUT" AS "ADS_sca_2_OUT"), 
"DT_node_data_35" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE PRECISION) AS "Score" 
FROM (SELECT 3 AS nid, 0.02230557425093129 AS "Score" FROM rdb$database UNION ALL SELECT 4 AS nid, -0.03178711507999351 AS "Score" FROM rdb$database UNION ALL SELECT 5 AS nid, 0.00471309946423601 AS "Score" FROM rdb$database) AS "Values"), 
"DT_Output_35" AS 
...
"DT_node_data_36" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE PRECISION) AS "Score" 
FROM (SELECT 4 AS nid, -0.031419953156448625 AS "Score" FROM rdb$database UNION ALL SELECT 5 AS nid, -0.016160339201189446 AS "Score" FROM rdb$database UNION ALL SELECT 6 AS nid, 0.0407848697202845 AS "Score" FROM rdb$database UNION ALL SELECT 7 AS nid, -0.0033154890000054605 AS "Score" FROM rdb$database) AS "Values"), 
"DT_Output_36" AS 
...
"DT_node_data_37" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE PRECISION) AS "Score" 
FROM (SELECT 2 AS nid, -0.01886606867743569 AS "Score" FROM rdb$database UNION ALL SELECT 6 AS nid, -0.016543330666217416 AS "Score" FROM rdb$database UNION ALL SELECT 7 AS nid, 0.03670950125929424 AS "Score" FROM rdb$database) AS "Values"), 
"DT_Output_37" AS 
...
"DT_node_data_38" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE PRECISION) AS "Score" 
FROM (SELECT 4 AS nid, 0.04558233201544677 AS "Score" FROM rdb$database UNION ALL SELECT 5 AS nid, -0.011852613171158027 AS "Score" FROM rdb$database UNION ALL SELECT 6 AS nid, -0.03177444071856066 AS "Score" FROM rdb$database UNION ALL SELECT 7 AS nid, -0.006245418426760709 AS "Score" FROM rdb$database) AS "Values"), 
"DT_Output_38" AS 
...
"DT_node_data_39" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE PRECISION) AS "Score" 
FROM (SELECT 4 AS nid, -0.011621861430621161 AS "Score" FROM rdb$database UNION ALL SELECT 5 AS nid, 0.046614583679068414 AS "Score" FROM rdb$database UNION ALL SELECT 6 AS nid, -0.032699323902063655 AS "Score" FROM rdb$database UNION ALL SELECT 7 AS nid, 0.0011222275259279407 AS "Score" FROM rdb$database) AS "Values"), 
"DT_Output_39" AS 
...
FROM "DT_Output_39")
 SELECT "LGBM_B7"."KEY", "LGBM_B7"."Score_0", "LGBM_B7"."Score_1", "LGBM_B7"."Score_2", "LGBM_B7"."Score_3" 
FROM (SELECT "LGBM_esu_7"."KEY" AS "KEY", "LGBM_esu_7"."Score_0" AS "Score_0", "LGBM_esu_7"."Score_1" AS "Score_1", "LGBM_esu_7"."Score_2" AS "Score_2", "LGBM_esu_7"."Score_3" AS "Score_3" 
FROM (SELECT "LGBM_Model_3_8"."KEY" AS "KEY", "LGBM_Model_3_8"."Score_0" AS "Score_0", "LGBM_Model_3_8"."Score_1" AS "Score_1", "LGBM_Model_3_8"."Score_2" AS "Score_2", "LGBM_Model_3_8"."Score_3" AS "Score_3" 
...
FROM "LGBM_Model_3_9") AS "LGBM_esu_7") AS "LGBM_B7") AS "U"

-- Code For temporary table TMP_20180602_E76_LGBM_B8 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180602_E76_LGBM_B8" (
	"KEY" BIGINT, 
	"Score_0" DOUBLE PRECISION, 
	"Score_1" DOUBLE PRECISION, 
	"Score_2" DOUBLE PRECISION, 
...
-- Code For temporary table TMP_20180602_E76_LGBM_B8 part 2. Populate

INSERT INTO "TMP_20180602_E76_LGBM_B8" ("KEY", "Score_0", "Score_1", "Score_2", "Score_3") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1", "U"."Score_2", "U"."Score_3" 
...
"DT_node_data_40" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE PRECISION) AS "Score" 
FROM (SELECT 4 AS nid, -0.015743868724441747 AS "Score" FROM rdb$database UNION ALL SELECT 5 AS nid, -0.031249718673060718 AS "Score" FROM rdb$database UNION ALL SELECT 6 AS nid, 0.03998234890426754 AS "Score" FROM rdb$database UNION ALL SELECT 7 AS nid, -0.0032482950525118803 AS "Score" FROM rdb$database) AS "Values"), 
"DT_Output_40" AS 
...
"DT_node_data_41" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE PRECISION) AS "Score" 
FROM (SELECT 3 AS nid, 0.02986321925216749 AS "Score" FROM rdb$database UNION ALL SELECT 4 AS nid, -0.02821410798213432 AS "Score" FROM rdb$database UNION ALL SELECT 10 AS nid, -0.012626279568975203 AS "Score" FROM rdb$database UNION ALL SELECT 11 AS nid, 0.02979847522652436 AS "Score" FROM rdb$database) AS "Values"), 
"DT_Output_41" AS 
...
"DT_node_data_42" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE PRECISION) AS "Score" 
FROM (SELECT 4 AS nid, 0.04353130429727434 AS "Score" FROM rdb$database UNION ALL SELECT 5 AS nid, -0.011636476982560352 AS "Score" FROM rdb$database UNION ALL SELECT 6 AS nid, -0.031578771619088064 AS "Score" FROM rdb$database UNION ALL SELECT 7 AS nid, -0.005960066850569324 AS "Score" FROM rdb$database) AS "Values"), 
"DT_Output_42" AS 
...
"DT_node_data_43" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE PRECISION) AS "Score" 
FROM (SELECT 3 AS nid, 0.02127179462958491 AS "Score" FROM rdb$database UNION ALL SELECT 4 AS nid, -0.03199590808682975 AS "Score" FROM rdb$database UNION ALL SELECT 5 AS nid, 0.003968421351352446 AS "Score" FROM rdb$database) AS "Values"), 
"DT_Output_43" AS 
...
"DT_node_data_44" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE PRECISION) AS "Score" 
FROM (SELECT 4 AS nid, -0.0310908654140684 AS "Score" FROM rdb$database UNION ALL SELECT 5 AS nid, -0.015279135329961432 AS "Score" FROM rdb$database UNION ALL SELECT 6 AS nid, 0.03880354145307677 AS "Score" FROM rdb$database UNION ALL SELECT 7 AS nid, -0.00391134735279519 AS "Score" FROM rdb$database) AS "Values"), 
"DT_Output_44" AS 
...
FROM "DT_Output_44")
 SELECT "LGBM_B8"."KEY", "LGBM_B8"."Score_0", "LGBM_B8"."Score_1", "LGBM_B8"."Score_2", "LGBM_B8"."Score_3" 
FROM (SELECT "LGBM_esu_8"."KEY" AS "KEY", "LGBM_esu_8"."Score_0" AS "Score_0", "LGBM_esu_8"."Score_1" AS "Score_1", "LGBM_esu_8"."Score_2" AS "Score_2", "LGBM_esu_8"."Score_3" AS "Score_3" 
...
FROM "LGBM_Model_0_11") AS "LGBM_esu_8") AS "LGBM_B8") AS "U"

-- Code For temporary table TMP_20180602_JG9_LGBM_B9 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180602_JG9_LGBM_B9" (
	"KEY" BIGINT, 
	"Score_0" DOUBLE PRECISION, 
	"Score_1" DOUBLE PRECISION, 
	"Score_2" DOUBLE PRECISION, 
...
-- Code For temporary table TMP_20180602_JG9_LGBM_B9 part 2. Populate

INSERT INTO "TMP_20180602_JG9_LGBM_B9" ("KEY", "Score_0", "Score_1", "Score_2", "Score_3") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1", "U"."Score_2", "U"."Score_3" 
FROM (WITH "DT_node_lookup_45" AS 
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", CASE WHEN ("ADS_sca_2_OUT".scaler_46 <= -0.227315336240404) THEN 2 ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_90 <= -0.3502806381050438) THEN 6 ELSE 7 END END AS node_id_2 
FROM "TMP_20180602_F24_ADS_SCA_2_OUT" AS "ADS_sca_2_OUT"), 
"DT_node_data_45" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE PRECISION) AS "Score" 
FROM (SELECT 2 AS nid, -0.020420313781114086 AS "Score" FROM rdb$database UNION ALL SELECT 6 AS nid, -0.014726013237717382 AS "Score" FROM rdb$database UNION ALL SELECT 7 AS nid, 0.027470639315244978 AS "Score" FROM rdb$database) AS "Values"), 
"DT_Output_45" AS 
...
"DT_node_data_46" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE PRECISION) AS "Score" 
FROM (SELECT 4 AS nid, 0.042739183805542674 AS "Score" FROM rdb$database UNION ALL SELECT 5 AS nid, -0.00894612657642856 AS "Score" FROM rdb$database UNION ALL SELECT 6 AS nid, -0.03171787287192134 AS "Score" FROM rdb$database UNION ALL SELECT 7 AS nid, -0.016152772496959986 AS "Score" FROM rdb$database) AS "Values"), 
"DT_Output_46" AS 
...
"DT_node_data_47" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE PRECISION) AS "Score" 
FROM (SELECT 4 AS nid, -0.014910353817675186 AS "Score" FROM rdb$database UNION ALL SELECT 5 AS nid, 0.041084924059791056 AS "Score" FROM rdb$database UNION ALL SELECT 6 AS nid, -0.03233600981842487 AS "Score" FROM rdb$database UNION ALL SELECT 7 AS nid, 0.0012034387694043048 AS "Score" FROM rdb$database) AS "Values"), 
"DT_Output_47" AS 
...
"DT_node_data_48" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE PRECISION) AS "Score" 
FROM (SELECT 4 AS nid, -0.03090305305251158 AS "Score" FROM rdb$database UNION ALL SELECT 5 AS nid, -0.014939394868731635 AS "Score" FROM rdb$database UNION ALL SELECT 6 AS nid, 0.03382129840405984 AS "Score" FROM rdb$database UNION ALL SELECT 7 AS nid, -0.008206307592326621 AS "Score" FROM rdb$database) AS "Values"), 
"DT_Output_48" AS 
...
"DT_node_data_49" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE PRECISION) AS "Score" 
FROM (SELECT 2 AS nid, -0.018526138619979884 AS "Score" FROM rdb$database UNION ALL SELECT 6 AS nid, -0.01588077468488255 AS "Score" FROM rdb$database UNION ALL SELECT 7 AS nid, 0.03428883703950263 AS "Score" FROM rdb$database) AS "Values"), 
"DT_Output_49" AS 
...
FROM "DT_Output_49")
 SELECT "LGBM_B9"."KEY", "LGBM_B9"."Score_0", "LGBM_B9"."Score_1", "LGBM_B9"."Score_2", "LGBM_B9"."Score_3" 
FROM (SELECT "LGBM_esu_9"."KEY" AS "KEY", "LGBM_esu_9"."Score_0" AS "Score_0", "LGBM_esu_9"."Score_1" AS "Score_1", "LGBM_esu_9"."Score_2" AS "Score_2", "LGBM_esu_9"."Score_3" AS "Score_3" 
FROM (SELECT "LGBM_Model_1_11"."KEY" AS "KEY", "LGBM_Model_1_11"."Score_0" AS "Score_0", "LGBM_Model_1_11"."Score_1" AS "Score_1", "LGBM_Model_1_11"."Score_2" AS "Score_2", "LGBM_Model_1_11"."Score_3" AS "Score_3" 
...
FROM "LGBM_Model_1_12") AS "LGBM_esu_9") AS "LGBM_B9") AS "U"

-- Code For temporary table TMP_20180602_SJI_LGBM_B10 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180602_SJI_LGBM_B10" (
	"KEY" BIGINT, 
	"Score_0" DOUBLE PRECISION, 
	"Score_1" DOUBLE PRECISION, 
	"Score_2" DOUBLE PRECISION, 
...
-- Code For temporary table TMP_20180602_SJI_LGBM_B10 part 2. Populate

INSERT INTO "TMP_20180602_SJI_LGBM_B10" ("KEY", "Score_0", "Score_1", "Score_2", "Score_3") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1", "U"."Score_2", "U"."Score_3" 
...
"DT_node_data_50" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE PRECISION) AS "Score" 
FROM (SELECT 4 AS nid, 0.040817250224576766 AS "Score" FROM rdb$database UNION ALL SELECT 5 AS nid, -0.008790049401806242 AS "Score" FROM rdb$database UNION ALL SELECT 6 AS nid, -0.015871302752483933 AS "Score" FROM rdb$database UNION ALL SELECT 7 AS nid, -0.031483714350811424 AS "Score" FROM rdb$database) AS "Values"), 
"DT_Output_50" AS 
...
"DT_node_data_51" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE PRECISION) AS "Score" 
FROM (SELECT 3 AS nid, 0.0205064249734117 AS "Score" FROM rdb$database UNION ALL SELECT 5 AS nid, 0.01043540245880489 AS "Score" FROM rdb$database UNION ALL SELECT 8 AS nid, -0.02386062596300417 AS "Score" FROM rdb$database UNION ALL SELECT 9 AS nid, -0.03236334009426657 AS "Score" FROM rdb$database) AS "Values"), 
"DT_Output_51" AS 
...
"DT_node_data_52" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE PRECISION) AS "Score" 
FROM (SELECT 4 AS nid, -0.030747030661008867 AS "Score" FROM rdb$database UNION ALL SELECT 5 AS nid, -0.014555792926882772 AS "Score" FROM rdb$database UNION ALL SELECT 6 AS nid, 0.031573895596735624 AS "Score" FROM rdb$database UNION ALL SELECT 7 AS nid, -0.010175005233875134 AS "Score" FROM rdb$database) AS "Values"), 
"DT_Output_52" AS 
...
"DT_node_data_53" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE PRECISION) AS "Score" 
FROM (SELECT 2 AS nid, -0.0182582081209416 AS "Score" FROM rdb$database UNION ALL SELECT 6 AS nid, -0.015596687636521743 AS "Score" FROM rdb$database UNION ALL SELECT 7 AS nid, 0.033090334673929765 AS "Score" FROM rdb$database) AS "Values"), 
"DT_Output_53" AS 
...
"DT_node_data_54" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE PRECISION) AS "Score" 
FROM (SELECT 2 AS nid, -0.03203660225084873 AS "Score" FROM rdb$database UNION ALL SELECT 6 AS nid, -0.026071125113543425 AS "Score" FROM rdb$database UNION ALL SELECT 14 AS nid, 0.05100082011196845 AS "Score" FROM rdb$database UNION ALL SELECT 15 AS nid, 0.0030984754684367025 AS "Score" FROM rdb$database) AS "Values"), 
"DT_Output_54" AS 
...
FROM "DT_Output_54")
 SELECT "LGBM_B10"."KEY", "LGBM_B10"."Score_0", "LGBM_B10"."Score_1", "LGBM_B10"."Score_2", "LGBM_B10"."Score_3" 
FROM (SELECT "LGBM_esu_10"."KEY" AS "KEY", "LGBM_esu_10"."Score_0" AS "Score_0", "LGBM_esu_10"."Score_1" AS "Score_1", "LGBM_esu_10"."Score_2" AS "Score_2", "LGBM_esu_10"."Score_3" AS "Score_3" 
...
FROM "LGBM_Model_2_13") AS "LGBM_esu_10") AS "LGBM_B10") AS "U"

-- Code For temporary table TMP_20180602_NQQ_LGBM_B11 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180602_NQQ_LGBM_B11" (
	"KEY" BIGINT, 
	"Score_0" DOUBLE PRECISION, 
	"Score_1" DOUBLE PRECISION, 
	"Score_2" DOUBLE PRECISION, 
...
-- Code For temporary table TMP_20180602_NQQ_LGBM_B11 part 2. Populate

INSERT INTO "TMP_20180602_NQQ_LGBM_B11" ("KEY", "Score_0", "Score_1", "Score_2", "Score_3") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1", "U"."Score_2", "U"."Score_3" 
...
"DT_node_data_55" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE PRECISION) AS "Score" 
FROM (SELECT 3 AS nid, 0.020099509826441427 AS "Score" FROM rdb$database UNION ALL SELECT 4 AS nid, -0.03189536515463107 AS "Score" FROM rdb$database UNION ALL SELECT 5 AS nid, 0.0036767730116769887 AS "Score" FROM rdb$database) AS "Values"), 
"DT_Output_55" AS 
...
"DT_node_data_56" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE PRECISION) AS "Score" 
FROM (SELECT 4 AS nid, -0.03060751890436594 AS "Score" FROM rdb$database UNION ALL SELECT 5 AS nid, -0.014150078595797873 AS "Score" FROM rdb$database UNION ALL SELECT 6 AS nid, 0.03573203558143081 AS "Score" FROM rdb$database UNION ALL SELECT 7 AS nid, -0.0044581153413860665 AS "Score" FROM rdb$database) AS "Values"), 
"DT_Output_56" AS 
...
"DT_node_data_57" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE PRECISION) AS "Score" 
FROM (SELECT 2 AS nid, -0.01998261413617107 AS "Score" FROM rdb$database UNION ALL SELECT 6 AS nid, -0.009748624080525037 AS "Score" FROM rdb$database UNION ALL SELECT 7 AS nid, 0.0292959498894432 AS "Score" FROM rdb$database) AS "Values"), 
"DT_Output_57" AS 
...
"DT_node_data_58" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE PRECISION) AS "Score" 
FROM (SELECT 2 AS nid, -0.0318125040411655 AS "Score" FROM rdb$database UNION ALL SELECT 6 AS nid, -0.02578061038935473 AS "Score" FROM rdb$database UNION ALL SELECT 14 AS nid, 0.002089881713252583 AS "Score" FROM rdb$database UNION ALL SELECT 15 AS nid, 0.04878045633913547 AS "Score" FROM rdb$database) AS "Values"), 
"DT_Output_58" AS 
...
"DT_node_data_59" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE PRECISION) AS "Score" 
FROM (SELECT 4 AS nid, -0.014753650054128554 AS "Score" FROM rdb$database UNION ALL SELECT 5 AS nid, 0.03817297064500252 AS "Score" FROM rdb$database UNION ALL SELECT 6 AS nid, -0.03202510022630165 AS "Score" FROM rdb$database UNION ALL SELECT 7 AS nid, 0.0018751524215349189 AS "Score" FROM rdb$database) AS "Values"), 
"DT_Output_59" AS 
...
FROM "DT_Output_59")
 SELECT "LGBM_B11"."KEY", "LGBM_B11"."Score_0", "LGBM_B11"."Score_1", "LGBM_B11"."Score_2", "LGBM_B11"."Score_3" 
FROM (SELECT "LGBM_esu_11"."KEY" AS "KEY", "LGBM_esu_11"."Score_0" AS "Score_0", "LGBM_esu_11"."Score_1" AS "Score_1", "LGBM_esu_11"."Score_2" AS "Score_2", "LGBM_esu_11"."Score_3" AS "Score_3" 
FROM (SELECT "LGBM_Model_3_13"."KEY" AS "KEY", "LGBM_Model_3_13"."Score_0" AS "Score_0", "LGBM_Model_3_13"."Score_1" AS "Score_1", "LGBM_Model_3_13"."Score_2" AS "Score_2", "LGBM_Model_3_13"."Score_3" AS "Score_3" 
...
FROM "LGBM_Model_3_14") AS "LGBM_esu_11") AS "LGBM_B11") AS "U"

-- Code For temporary table TMP_20180602_NKF_LGBM_B12 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180602_NKF_LGBM_B12" (
	"KEY" BIGINT, 
	"Score_0" DOUBLE PRECISION, 
	"Score_1" DOUBLE PRECISION, 
	"Score_2" DOUBLE PRECISION, 
...
-- Code For temporary table TMP_20180602_NKF_LGBM_B12 part 2. Populate

INSERT INTO "TMP_20180602_NKF_LGBM_B12" ("KEY", "Score_0", "Score_1", "Score_2", "Score_3") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1", "U"."Score_2", "U"."Score_3" 
...
"DT_node_data_60" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE PRECISION) AS "Score" 
FROM (SELECT 4 AS nid, -0.013689615874156992 AS "Score" FROM rdb$database UNION ALL SELECT 5 AS nid, -0.030449564866642423 AS "Score" FROM rdb$database UNION ALL SELECT 6 AS nid, 0.03490078493210116 AS "Score" FROM rdb$database UNION ALL SELECT 7 AS nid, -0.004664885985751203 AS "Score" FROM rdb$database) AS "Values"), 
"DT_Output_60" AS 
...
"DT_node_data_61" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE PRECISION) AS "Score" 
FROM (SELECT 2 AS nid, -0.02628140917315637 AS "Score" FROM rdb$database UNION ALL SELECT 6 AS nid, -0.01777674979451851 AS "Score" FROM rdb$database UNION ALL SELECT 14 AS nid, 0.052027314115713534 AS "Score" FROM rdb$database UNION ALL SELECT 15 AS nid, -0.004217682524032953 AS "Score" FROM rdb$database) AS "Values"), 
"DT_Output_61" AS 
...
"DT_node_data_62" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE PRECISION) AS "Score" 
FROM (SELECT 2 AS nid, -0.03162941178263455 AS "Score" FROM rdb$database UNION ALL SELECT 6 AS nid, -0.02543211348171276 AS "Score" FROM rdb$database UNION ALL SELECT 14 AS nid, 0.04728314963131467 AS "Score" FROM rdb$database UNION ALL SELECT 15 AS nid, 0.0025346518318884884 AS "Score" FROM rdb$database) AS "Values"), 
"DT_Output_62" AS 
...
"DT_node_data_63" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE PRECISION) AS "Score" 
FROM (SELECT 3 AS nid, 0.019286844860131692 AS "Score" FROM rdb$database UNION ALL SELECT 4 AS nid, -0.03102628577513182 AS "Score" FROM rdb$database UNION ALL SELECT 5 AS nid, 0.00427368528143657 AS "Score" FROM rdb$database) AS "Values"), 
"DT_Output_63" AS 
...
FROM "DT_Output_63")
 SELECT "LGBM_B12"."KEY", "LGBM_B12"."Score_0", "LGBM_B12"."Score_1", "LGBM_B12"."Score_2", "LGBM_B12"."Score_3" 
FROM (SELECT "LGBM_esu_12"."KEY" AS "KEY", "LGBM_esu_12"."Score_0" AS "Score_0", "LGBM_esu_12"."Score_1" AS "Score_1", "LGBM_esu_12"."Score_2" AS "Score_2", "LGBM_esu_12"."Score_3" AS "Score_3" 
...
FROM "LGBM_Model_3_15") AS "LGBM_esu_12") AS "LGBM_B12") AS "U"

-- Code For temporary table TMP_20180602_G82_LGBM_SUM part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180602_G82_LGBM_SUM" (
	"KEY" BIGINT NOT NULL, 
	"Score_0" DOUBLE PRECISION, 
	"Score_1" DOUBLE PRECISION, 
	"Score_2" DOUBLE PRECISION, 
...
-- Code For temporary table TMP_20180602_G82_LGBM_SUM part 2. Populate

INSERT INTO "TMP_20180602_G82_LGBM_SUM" ("KEY", "Score_0", "Score_1", "Score_2", "Score_3") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1", "U"."Score_2", "U"."Score_3" 
...
FROM "TMP_20180602_SSX_LGBM_B0" AS "LGBM_B0" UNION ALL SELECT "LGBM_B1"."KEY" AS "KEY", "LGBM_B1"."Score_0" AS "Score_0", "LGBM_B1"."Score_1" AS "Score_1", "LGBM_B1"."Score_2" AS "Score_2", "LGBM_B1"."Score_3" AS "Score_3" 
FROM "TMP_20180602_1SS_LGBM_B1" AS "LGBM_B1" UNION ALL SELECT "LGBM_B2"."KEY" AS "KEY", "LGBM_B2"."Score_0" AS "Score_0", "LGBM_B2"."Score_1" AS "Score_1", "LGBM_B2"."Score_2" AS "Score_2", "LGBM_B2"."Score_3" AS "Score_3" 
FROM "TMP_20180602_8G5_LGBM_B2" AS "LGBM_B2" UNION ALL SELECT "LGBM_B3"."KEY" AS "KEY", "LGBM_B3"."Score_0" AS "Score_0", "LGBM_B3"."Score_1" AS "Score_1", "LGBM_B3"."Score_2" AS "Score_2", "LGBM_B3"."Score_3" AS "Score_3" 
FROM "TMP_20180602_MGU_LGBM_B3" AS "LGBM_B3" UNION ALL SELECT "LGBM_B4"."KEY" AS "KEY", "LGBM_B4"."Score_0" AS "Score_0", "LGBM_B4"."Score_1" AS "Score_1", "LGBM_B4"."Score_2" AS "Score_2", "LGBM_B4"."Score_3" AS "Score_3" 
FROM "TMP_20180602_LJE_LGBM_B4" AS "LGBM_B4" UNION ALL SELECT "LGBM_B5"."KEY" AS "KEY", "LGBM_B5"."Score_0" AS "Score_0", "LGBM_B5"."Score_1" AS "Score_1", "LGBM_B5"."Score_2" AS "Score_2", "LGBM_B5"."Score_3" AS "Score_3" 
FROM "TMP_20180602_O0J_LGBM_B5" AS "LGBM_B5" UNION ALL SELECT "LGBM_B6"."KEY" AS "KEY", "LGBM_B6"."Score_0" AS "Score_0", "LGBM_B6"."Score_1" AS "Score_1", "LGBM_B6"."Score_2" AS "Score_2", "LGBM_B6"."Score_3" AS "Score_3" 
FROM "TMP_20180602_Y56_LGBM_B6" AS "LGBM_B6" UNION ALL SELECT "LGBM_B7"."KEY" AS "KEY", "LGBM_B7"."Score_0" AS "Score_0", "LGBM_B7"."Score_1" AS "Score_1", "LGBM_B7"."Score_2" AS "Score_2", "LGBM_B7"."Score_3" AS "Score_3" 
FROM "TMP_20180602_0XW_LGBM_B7" AS "LGBM_B7" UNION ALL SELECT "LGBM_B8"."KEY" AS "KEY", "LGBM_B8"."Score_0" AS "Score_0", "LGBM_B8"."Score_1" AS "Score_1", "LGBM_B8"."Score_2" AS "Score_2", "LGBM_B8"."Score_3" AS "Score_3" 
FROM "TMP_20180602_E76_LGBM_B8" AS "LGBM_B8" UNION ALL SELECT "LGBM_B9"."KEY" AS "KEY", "LGBM_B9"."Score_0" AS "Score_0", "LGBM_B9"."Score_1" AS "Score_1", "LGBM_B9"."Score_2" AS "Score_2", "LGBM_B9"."Score_3" AS "Score_3" 
FROM "TMP_20180602_JG9_LGBM_B9" AS "LGBM_B9" UNION ALL SELECT "LGBM_B10"."KEY" AS "KEY", "LGBM_B10"."Score_0" AS "Score_0", "LGBM_B10"."Score_1" AS "Score_1", "LGBM_B10"."Score_2" AS "Score_2", "LGBM_B10"."Score_3" AS "Score_3" 
FROM "TMP_20180602_SJI_LGBM_B10" AS "LGBM_B10" UNION ALL SELECT "LGBM_B11"."KEY" AS "KEY", "LGBM_B11"."Score_0" AS "Score_0", "LGBM_B11"."Score_1" AS "Score_1", "LGBM_B11"."Score_2" AS "Score_2", "LGBM_B11"."Score_3" AS "Score_3" 
FROM "TMP_20180602_NQQ_LGBM_B11" AS "LGBM_B11" UNION ALL SELECT "LGBM_B12"."KEY" AS "KEY", "LGBM_B12"."Score_0" AS "Score_0", "LGBM_B12"."Score_1" AS "Score_1", "LGBM_B12"."Score_2" AS "Score_2", "LGBM_B12"."Score_3" AS "Score_3" 
FROM "TMP_20180602_NKF_LGBM_B12" AS "LGBM_B12") AS "LGBM_EnsembleUnion")
...
-- Code For temporary table TMP_20180602_G82_LGBM_SUM part 3. Create Index 

CREATE INDEX "ix_TMP_20180602_G82_LGB_394f" ON "TMP_20180602_G82_LGBM_SUM" ("KEY")
...
FROM "TMP_20180602_G82_LGBM_SUM" AS "LGBM_sum"), 
