...
-- Code For temporary table tmp_20180602160348_k6i_ads_imp_1_out part 1. Create 


CREATE TEMPORARY TABLE tmp_20180602160348_k6i_ads_imp_1_out (
	"KEY" BIGINT, 
...
-- Code For temporary table tmp_20180602160348_k6i_ads_imp_1_out part 2. Populate

INSERT INTO tmp_20180602160348_k6i_ads_imp_1_out ("KEY", imputer_output_2, imputer_output_3, imputer_output_4, imputer_output_5) SELECT "U"."KEY", "U".imputer_output_2, "U".imputer_output_3, "U".imputer_output_4, "U".imputer_output_5 
...
-- Code For temporary table tmp_20180602160348_s2s_ads_sca_2_out part 1. Create 


CREATE TEMPORARY TABLE tmp_20180602160348_s2s_ads_sca_2_out (
	"KEY" BIGINT, 
...
-- Code For temporary table tmp_20180602160348_s2s_ads_sca_2_out part 2. Populate

INSERT INTO tmp_20180602160348_s2s_ads_sca_2_out ("KEY", scaler_output_2, scaler_output_3, scaler_output_4, scaler_output_5) SELECT "U"."KEY", "U".scaler_output_2, "U".scaler_output_3, "U".scaler_output_4, "U".scaler_output_5 
...
FROM tmp_20180602160348_k6i_ads_imp_1_out AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT") AS "U"

-- Code For temporary table tmp_20180602160348_959_lgbm_b0 part 1. Create 


CREATE TEMPORARY TABLE tmp_20180602160348_959_lgbm_b0 (
	"KEY" BIGINT, 
...
-- Code For temporary table tmp_20180602160348_959_lgbm_b0 part 2. Populate

INSERT INTO tmp_20180602160348_959_lgbm_b0 ("KEY", "Score_CLASS_0", "Score_CLASS_1", "Score_CLASS_2") SELECT "U"."KEY", "U"."Score_CLASS_0", "U"."Score_CLASS_1", "U"."Score_CLASS_2" 
...
FROM tmp_20180602160348_s2s_ads_sca_2_out AS "ADS_sca_2_OUT"), 
"DT_node_data" AS 
...
-- Code For temporary table tmp_20180602160348_1os_lgbm_b1 part 1. Create 


CREATE TEMPORARY TABLE tmp_20180602160348_1os_lgbm_b1 (
	"KEY" BIGINT, 
	"Score_CLASS_0" DOUBLE, 
	"Score_CLASS_1" DOUBLE, 
	"Score_CLASS_2" DOUBLE
...
-- Code For temporary table tmp_20180602160348_1os_lgbm_b1 part 2. Populate

INSERT INTO tmp_20180602160348_1os_lgbm_b1 ("KEY", "Score_CLASS_0", "Score_CLASS_1", "Score_CLASS_2") SELECT "U"."KEY", "U"."Score_CLASS_0", "U"."Score_CLASS_1", "U"."Score_CLASS_2" 
...
-- Code For temporary table tmp_20180602160348_g9q_lgbm_b2 part 1. Create 


CREATE TEMPORARY TABLE tmp_20180602160348_g9q_lgbm_b2 (
	"KEY" BIGINT, 
	"Score_CLASS_0" DOUBLE, 
	"Score_CLASS_1" DOUBLE, 
	"Score_CLASS_2" DOUBLE
...
-- Code For temporary table tmp_20180602160348_g9q_lgbm_b2 part 2. Populate

INSERT INTO tmp_20180602160348_g9q_lgbm_b2 ("KEY", "Score_CLASS_0", "Score_CLASS_1", "Score_CLASS_2") SELECT "U"."KEY", "U"."Score_CLASS_0", "U"."Score_CLASS_1", "U"."Score_CLASS_2" 
...
-- Code For temporary table tmp_20180602160348_btt_lgbm_b3 part 1. Create 


CREATE TEMPORARY TABLE tmp_20180602160348_btt_lgbm_b3 (
	"KEY" BIGINT, 
	"Score_CLASS_0" DOUBLE, 
	"Score_CLASS_1" DOUBLE, 
	"Score_CLASS_2" DOUBLE
...
-- Code For temporary table tmp_20180602160348_btt_lgbm_b3 part 2. Populate

INSERT INTO tmp_20180602160348_btt_lgbm_b3 ("KEY", "Score_CLASS_0", "Score_CLASS_1", "Score_CLASS_2") SELECT "U"."KEY", "U"."Score_CLASS_0", "U"."Score_CLASS_1", "U"."Score_CLASS_2" 
...
-- Code For temporary table tmp_20180602160348_7ps_lgbm_b4 part 1. Create 


CREATE TEMPORARY TABLE tmp_20180602160348_7ps_lgbm_b4 (
	"KEY" BIGINT, 
	"Score_CLASS_0" DOUBLE, 
	"Score_CLASS_1" DOUBLE, 
	"Score_CLASS_2" DOUBLE
...
-- Code For temporary table tmp_20180602160348_7ps_lgbm_b4 part 2. Populate

INSERT INTO tmp_20180602160348_7ps_lgbm_b4 ("KEY", "Score_CLASS_0", "Score_CLASS_1", "Score_CLASS_2") SELECT "U"."KEY", "U"."Score_CLASS_0", "U"."Score_CLASS_1", "U"."Score_CLASS_2" 
...
-- Code For temporary table tmp_20180602160348_eyf_lgbm_sum part 1. Create 


CREATE TEMPORARY TABLE tmp_20180602160348_eyf_lgbm_sum (
	"KEY" BIGINT, 
	"Score_CLASS_0" DOUBLE, 
	"Score_CLASS_1" DOUBLE, 
	"Score_CLASS_2" DOUBLE
...
-- Code For temporary table tmp_20180602160348_eyf_lgbm_sum part 2. Populate

INSERT INTO tmp_20180602160348_eyf_lgbm_sum ("KEY", "Score_CLASS_0", "Score_CLASS_1", "Score_CLASS_2") SELECT "U"."KEY", "U"."Score_CLASS_0", "U"."Score_CLASS_1", "U"."Score_CLASS_2" 
...
FROM tmp_20180602160348_959_lgbm_b0 AS "LGBM_B0" UNION ALL SELECT "LGBM_B1"."KEY" AS "KEY", "LGBM_B1"."Score_CLASS_0" AS "Score_CLASS_0", "LGBM_B1"."Score_CLASS_1" AS "Score_CLASS_1", "LGBM_B1"."Score_CLASS_2" AS "Score_CLASS_2" 
FROM tmp_20180602160348_1os_lgbm_b1 AS "LGBM_B1" UNION ALL SELECT "LGBM_B2"."KEY" AS "KEY", "LGBM_B2"."Score_CLASS_0" AS "Score_CLASS_0", "LGBM_B2"."Score_CLASS_1" AS "Score_CLASS_1", "LGBM_B2"."Score_CLASS_2" AS "Score_CLASS_2" 
FROM tmp_20180602160348_g9q_lgbm_b2 AS "LGBM_B2" UNION ALL SELECT "LGBM_B3"."KEY" AS "KEY", "LGBM_B3"."Score_CLASS_0" AS "Score_CLASS_0", "LGBM_B3"."Score_CLASS_1" AS "Score_CLASS_1", "LGBM_B3"."Score_CLASS_2" AS "Score_CLASS_2" 
FROM tmp_20180602160348_btt_lgbm_b3 AS "LGBM_B3" UNION ALL SELECT "LGBM_B4"."KEY" AS "KEY", "LGBM_B4"."Score_CLASS_0" AS "Score_CLASS_0", "LGBM_B4"."Score_CLASS_1" AS "Score_CLASS_1", "LGBM_B4"."Score_CLASS_2" AS "Score_CLASS_2" 
FROM tmp_20180602160348_7ps_lgbm_b4 AS "LGBM_B4") AS "LGBM_EnsembleUnion")
...
FROM tmp_20180602160348_eyf_lgbm_sum AS "LGBM_sum"), 
