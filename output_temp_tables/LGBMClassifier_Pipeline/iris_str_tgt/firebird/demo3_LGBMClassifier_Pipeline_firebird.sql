...
-- Code For temporary table TMP_20180602_NZ1_ADS_IMP_1_OUT part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180602_NZ1_ADS_IMP_1_OUT" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20180602_NZ1_ADS_IMP_1_OUT part 2. Populate

INSERT INTO "TMP_20180602_NZ1_ADS_IMP_1_OUT" ("KEY", imputer_output_2, imputer_output_3, imputer_output_4, imputer_output_5) SELECT "U"."KEY", "U".imputer_output_2, "U".imputer_output_3, "U".imputer_output_4, "U".imputer_output_5 
...
-- Code For temporary table TMP_20180602_NZ1_ADS_IMP_1_OUT part 3. Create Index 

CREATE INDEX "ix_TMP_20180602_NZ1_ADS_ada5" ON "TMP_20180602_NZ1_ADS_IMP_1_OUT" ("KEY")

-- Code For temporary table TMP_20180602_J32_ADS_SCA_2_OUT part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180602_J32_ADS_SCA_2_OUT" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20180602_J32_ADS_SCA_2_OUT part 2. Populate

INSERT INTO "TMP_20180602_J32_ADS_SCA_2_OUT" ("KEY", scaler_output_2, scaler_output_3, scaler_output_4, scaler_output_5) SELECT "U"."KEY", "U".scaler_output_2, "U".scaler_output_3, "U".scaler_output_4, "U".scaler_output_5 
...
FROM "TMP_20180602_NZ1_ADS_IMP_1_OUT" AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT") AS "U"

-- Code For temporary table TMP_20180602_J32_ADS_SCA_2_OUT part 3. Create Index 

CREATE INDEX "ix_TMP_20180602_J32_ADS_75ff" ON "TMP_20180602_J32_ADS_SCA_2_OUT" ("KEY")

-- Code For temporary table TMP_20180602_SAG_LGBM_B0 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180602_SAG_LGBM_B0" (
	"KEY" BIGINT, 
...
-- Code For temporary table TMP_20180602_SAG_LGBM_B0 part 2. Populate

INSERT INTO "TMP_20180602_SAG_LGBM_B0" ("KEY", "Score_CLASS_0", "Score_CLASS_1", "Score_CLASS_2") SELECT "U"."KEY", "U"."Score_CLASS_0", "U"."Score_CLASS_1", "U"."Score_CLASS_2" 
...
FROM "TMP_20180602_J32_ADS_SCA_2_OUT" AS "ADS_sca_2_OUT"), 
"DT_node_data" AS 
...
-- Code For temporary table TMP_20180602_QYA_LGBM_B1 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180602_QYA_LGBM_B1" (
	"KEY" BIGINT, 
	"Score_CLASS_0" DOUBLE PRECISION, 
	"Score_CLASS_1" DOUBLE PRECISION, 
	"Score_CLASS_2" DOUBLE PRECISION
...
-- Code For temporary table TMP_20180602_QYA_LGBM_B1 part 2. Populate

INSERT INTO "TMP_20180602_QYA_LGBM_B1" ("KEY", "Score_CLASS_0", "Score_CLASS_1", "Score_CLASS_2") SELECT "U"."KEY", "U"."Score_CLASS_0", "U"."Score_CLASS_1", "U"."Score_CLASS_2" 
...
FROM (SELECT "LGBM_Model_2_1"."KEY" AS "KEY", "LGBM_Model_2_1"."Score_CLASS_0" AS "Score_CLASS_0", "LGBM_Model_2_1"."Score_CLASS_1" AS "Score_CLASS_1", "LGBM_Model_2_1"."Score_CLASS_2" AS "Score_CLASS_2" 
...
-- Code For temporary table TMP_20180602_2GD_LGBM_B2 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180602_2GD_LGBM_B2" (
	"KEY" BIGINT, 
	"Score_CLASS_0" DOUBLE PRECISION, 
	"Score_CLASS_1" DOUBLE PRECISION, 
	"Score_CLASS_2" DOUBLE PRECISION
...
-- Code For temporary table TMP_20180602_2GD_LGBM_B2 part 2. Populate

INSERT INTO "TMP_20180602_2GD_LGBM_B2" ("KEY", "Score_CLASS_0", "Score_CLASS_1", "Score_CLASS_2") SELECT "U"."KEY", "U"."Score_CLASS_0", "U"."Score_CLASS_1", "U"."Score_CLASS_2" 
...
-- Code For temporary table TMP_20180602_7K4_LGBM_B3 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180602_7K4_LGBM_B3" (
	"KEY" BIGINT, 
	"Score_CLASS_0" DOUBLE PRECISION, 
	"Score_CLASS_1" DOUBLE PRECISION, 
	"Score_CLASS_2" DOUBLE PRECISION
...
-- Code For temporary table TMP_20180602_7K4_LGBM_B3 part 2. Populate

INSERT INTO "TMP_20180602_7K4_LGBM_B3" ("KEY", "Score_CLASS_0", "Score_CLASS_1", "Score_CLASS_2") SELECT "U"."KEY", "U"."Score_CLASS_0", "U"."Score_CLASS_1", "U"."Score_CLASS_2" 
...
FROM (SELECT "LGBM_Model_0_5"."KEY" AS "KEY", "LGBM_Model_0_5"."Score_CLASS_0" AS "Score_CLASS_0", "LGBM_Model_0_5"."Score_CLASS_1" AS "Score_CLASS_1", "LGBM_Model_0_5"."Score_CLASS_2" AS "Score_CLASS_2" 
...
-- Code For temporary table TMP_20180602_IXL_LGBM_B4 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180602_IXL_LGBM_B4" (
	"KEY" BIGINT, 
	"Score_CLASS_0" DOUBLE PRECISION, 
	"Score_CLASS_1" DOUBLE PRECISION, 
	"Score_CLASS_2" DOUBLE PRECISION
...
-- Code For temporary table TMP_20180602_IXL_LGBM_B4 part 2. Populate

INSERT INTO "TMP_20180602_IXL_LGBM_B4" ("KEY", "Score_CLASS_0", "Score_CLASS_1", "Score_CLASS_2") SELECT "U"."KEY", "U"."Score_CLASS_0", "U"."Score_CLASS_1", "U"."Score_CLASS_2" 
...
-- Code For temporary table TMP_20180602_EMF_LGBM_B5 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180602_EMF_LGBM_B5" (
	"KEY" BIGINT, 
	"Score_CLASS_0" DOUBLE PRECISION, 
	"Score_CLASS_1" DOUBLE PRECISION, 
	"Score_CLASS_2" DOUBLE PRECISION
...
-- Code For temporary table TMP_20180602_EMF_LGBM_B5 part 2. Populate

INSERT INTO "TMP_20180602_EMF_LGBM_B5" ("KEY", "Score_CLASS_0", "Score_CLASS_1", "Score_CLASS_2") SELECT "U"."KEY", "U"."Score_CLASS_0", "U"."Score_CLASS_1", "U"."Score_CLASS_2" 
...
FROM "DT_Output_29")
 SELECT "LGBM_B5"."KEY", "LGBM_B5"."Score_CLASS_0", "LGBM_B5"."Score_CLASS_1", "LGBM_B5"."Score_CLASS_2" 
FROM (SELECT "LGBM_esu_5"."KEY" AS "KEY", "LGBM_esu_5"."Score_CLASS_0" AS "Score_CLASS_0", "LGBM_esu_5"."Score_CLASS_1" AS "Score_CLASS_1", "LGBM_esu_5"."Score_CLASS_2" AS "Score_CLASS_2" 
FROM (SELECT "LGBM_Model_1_8"."KEY" AS "KEY", "LGBM_Model_1_8"."Score_CLASS_0" AS "Score_CLASS_0", "LGBM_Model_1_8"."Score_CLASS_1" AS "Score_CLASS_1", "LGBM_Model_1_8"."Score_CLASS_2" AS "Score_CLASS_2" 
...
-- Code For temporary table TMP_20180602_R6V_LGBM_B6 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180602_R6V_LGBM_B6" (
	"KEY" BIGINT, 
	"Score_CLASS_0" DOUBLE PRECISION, 
	"Score_CLASS_1" DOUBLE PRECISION, 
	"Score_CLASS_2" DOUBLE PRECISION
...
-- Code For temporary table TMP_20180602_R6V_LGBM_B6 part 2. Populate

INSERT INTO "TMP_20180602_R6V_LGBM_B6" ("KEY", "Score_CLASS_0", "Score_CLASS_1", "Score_CLASS_2") SELECT "U"."KEY", "U"."Score_CLASS_0", "U"."Score_CLASS_1", "U"."Score_CLASS_2" 
...
FROM "DT_Output_34")
 SELECT "LGBM_B6"."KEY", "LGBM_B6"."Score_CLASS_0", "LGBM_B6"."Score_CLASS_1", "LGBM_B6"."Score_CLASS_2" 
FROM (SELECT "LGBM_esu_6"."KEY" AS "KEY", "LGBM_esu_6"."Score_CLASS_0" AS "Score_CLASS_0", "LGBM_esu_6"."Score_CLASS_1" AS "Score_CLASS_1", "LGBM_esu_6"."Score_CLASS_2" AS "Score_CLASS_2" 
...
-- Code For temporary table TMP_20180602_EOA_LGBM_B7 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180602_EOA_LGBM_B7" (
	"KEY" BIGINT, 
	"Score_CLASS_0" DOUBLE PRECISION, 
	"Score_CLASS_1" DOUBLE PRECISION, 
	"Score_CLASS_2" DOUBLE PRECISION
...
-- Code For temporary table TMP_20180602_EOA_LGBM_B7 part 2. Populate

INSERT INTO "TMP_20180602_EOA_LGBM_B7" ("KEY", "Score_CLASS_0", "Score_CLASS_1", "Score_CLASS_2") SELECT "U"."KEY", "U"."Score_CLASS_0", "U"."Score_CLASS_1", "U"."Score_CLASS_2" 
...
FROM "DT_Output_39")
 SELECT "LGBM_B7"."KEY", "LGBM_B7"."Score_CLASS_0", "LGBM_B7"."Score_CLASS_1", "LGBM_B7"."Score_CLASS_2" 
FROM (SELECT "LGBM_esu_7"."KEY" AS "KEY", "LGBM_esu_7"."Score_CLASS_0" AS "Score_CLASS_0", "LGBM_esu_7"."Score_CLASS_1" AS "Score_CLASS_1", "LGBM_esu_7"."Score_CLASS_2" AS "Score_CLASS_2" 
FROM (SELECT "LGBM_Model_2_11"."KEY" AS "KEY", "LGBM_Model_2_11"."Score_CLASS_0" AS "Score_CLASS_0", "LGBM_Model_2_11"."Score_CLASS_1" AS "Score_CLASS_1", "LGBM_Model_2_11"."Score_CLASS_2" AS "Score_CLASS_2" 
...
-- Code For temporary table TMP_20180602_G1T_LGBM_B8 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180602_G1T_LGBM_B8" (
	"KEY" BIGINT, 
	"Score_CLASS_0" DOUBLE PRECISION, 
	"Score_CLASS_1" DOUBLE PRECISION, 
	"Score_CLASS_2" DOUBLE PRECISION
...
-- Code For temporary table TMP_20180602_G1T_LGBM_B8 part 2. Populate

INSERT INTO "TMP_20180602_G1T_LGBM_B8" ("KEY", "Score_CLASS_0", "Score_CLASS_1", "Score_CLASS_2") SELECT "U"."KEY", "U"."Score_CLASS_0", "U"."Score_CLASS_1", "U"."Score_CLASS_2" 
...
FROM "DT_Output_44")
 SELECT "LGBM_B8"."KEY", "LGBM_B8"."Score_CLASS_0", "LGBM_B8"."Score_CLASS_1", "LGBM_B8"."Score_CLASS_2" 
FROM (SELECT "LGBM_esu_8"."KEY" AS "KEY", "LGBM_esu_8"."Score_CLASS_0" AS "Score_CLASS_0", "LGBM_esu_8"."Score_CLASS_1" AS "Score_CLASS_1", "LGBM_esu_8"."Score_CLASS_2" AS "Score_CLASS_2" 
...
-- Code For temporary table TMP_20180602_G47_LGBM_B9 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180602_G47_LGBM_B9" (
	"KEY" BIGINT, 
	"Score_CLASS_0" DOUBLE PRECISION, 
	"Score_CLASS_1" DOUBLE PRECISION, 
	"Score_CLASS_2" DOUBLE PRECISION
...
-- Code For temporary table TMP_20180602_G47_LGBM_B9 part 2. Populate

INSERT INTO "TMP_20180602_G47_LGBM_B9" ("KEY", "Score_CLASS_0", "Score_CLASS_1", "Score_CLASS_2") SELECT "U"."KEY", "U"."Score_CLASS_0", "U"."Score_CLASS_1", "U"."Score_CLASS_2" 
...
FROM "DT_Output_47")
 SELECT "LGBM_B9"."KEY", "LGBM_B9"."Score_CLASS_0", "LGBM_B9"."Score_CLASS_1", "LGBM_B9"."Score_CLASS_2" 
FROM (SELECT "LGBM_esu_9"."KEY" AS "KEY", "LGBM_esu_9"."Score_CLASS_0" AS "Score_CLASS_0", "LGBM_esu_9"."Score_CLASS_1" AS "Score_CLASS_1", "LGBM_esu_9"."Score_CLASS_2" AS "Score_CLASS_2" 
FROM (SELECT "LGBM_Model_0_15"."KEY" AS "KEY", "LGBM_Model_0_15"."Score_CLASS_0" AS "Score_CLASS_0", "LGBM_Model_0_15"."Score_CLASS_1" AS "Score_CLASS_1", "LGBM_Model_0_15"."Score_CLASS_2" AS "Score_CLASS_2" 
...
-- Code For temporary table TMP_20180602_BLC_LGBM_SUM part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180602_BLC_LGBM_SUM" (
	"KEY" BIGINT NOT NULL, 
	"Score_CLASS_0" DOUBLE PRECISION, 
	"Score_CLASS_1" DOUBLE PRECISION, 
	"Score_CLASS_2" DOUBLE PRECISION, 
...
-- Code For temporary table TMP_20180602_BLC_LGBM_SUM part 2. Populate

INSERT INTO "TMP_20180602_BLC_LGBM_SUM" ("KEY", "Score_CLASS_0", "Score_CLASS_1", "Score_CLASS_2") SELECT "U"."KEY", "U"."Score_CLASS_0", "U"."Score_CLASS_1", "U"."Score_CLASS_2" 
...
FROM "TMP_20180602_SAG_LGBM_B0" AS "LGBM_B0" UNION ALL SELECT "LGBM_B1"."KEY" AS "KEY", "LGBM_B1"."Score_CLASS_0" AS "Score_CLASS_0", "LGBM_B1"."Score_CLASS_1" AS "Score_CLASS_1", "LGBM_B1"."Score_CLASS_2" AS "Score_CLASS_2" 
FROM "TMP_20180602_QYA_LGBM_B1" AS "LGBM_B1" UNION ALL SELECT "LGBM_B2"."KEY" AS "KEY", "LGBM_B2"."Score_CLASS_0" AS "Score_CLASS_0", "LGBM_B2"."Score_CLASS_1" AS "Score_CLASS_1", "LGBM_B2"."Score_CLASS_2" AS "Score_CLASS_2" 
FROM "TMP_20180602_2GD_LGBM_B2" AS "LGBM_B2" UNION ALL SELECT "LGBM_B3"."KEY" AS "KEY", "LGBM_B3"."Score_CLASS_0" AS "Score_CLASS_0", "LGBM_B3"."Score_CLASS_1" AS "Score_CLASS_1", "LGBM_B3"."Score_CLASS_2" AS "Score_CLASS_2" 
FROM "TMP_20180602_7K4_LGBM_B3" AS "LGBM_B3" UNION ALL SELECT "LGBM_B4"."KEY" AS "KEY", "LGBM_B4"."Score_CLASS_0" AS "Score_CLASS_0", "LGBM_B4"."Score_CLASS_1" AS "Score_CLASS_1", "LGBM_B4"."Score_CLASS_2" AS "Score_CLASS_2" 
FROM "TMP_20180602_IXL_LGBM_B4" AS "LGBM_B4" UNION ALL SELECT "LGBM_B5"."KEY" AS "KEY", "LGBM_B5"."Score_CLASS_0" AS "Score_CLASS_0", "LGBM_B5"."Score_CLASS_1" AS "Score_CLASS_1", "LGBM_B5"."Score_CLASS_2" AS "Score_CLASS_2" 
FROM "TMP_20180602_EMF_LGBM_B5" AS "LGBM_B5" UNION ALL SELECT "LGBM_B6"."KEY" AS "KEY", "LGBM_B6"."Score_CLASS_0" AS "Score_CLASS_0", "LGBM_B6"."Score_CLASS_1" AS "Score_CLASS_1", "LGBM_B6"."Score_CLASS_2" AS "Score_CLASS_2" 
FROM "TMP_20180602_R6V_LGBM_B6" AS "LGBM_B6" UNION ALL SELECT "LGBM_B7"."KEY" AS "KEY", "LGBM_B7"."Score_CLASS_0" AS "Score_CLASS_0", "LGBM_B7"."Score_CLASS_1" AS "Score_CLASS_1", "LGBM_B7"."Score_CLASS_2" AS "Score_CLASS_2" 
FROM "TMP_20180602_EOA_LGBM_B7" AS "LGBM_B7" UNION ALL SELECT "LGBM_B8"."KEY" AS "KEY", "LGBM_B8"."Score_CLASS_0" AS "Score_CLASS_0", "LGBM_B8"."Score_CLASS_1" AS "Score_CLASS_1", "LGBM_B8"."Score_CLASS_2" AS "Score_CLASS_2" 
FROM "TMP_20180602_G1T_LGBM_B8" AS "LGBM_B8" UNION ALL SELECT "LGBM_B9"."KEY" AS "KEY", "LGBM_B9"."Score_CLASS_0" AS "Score_CLASS_0", "LGBM_B9"."Score_CLASS_1" AS "Score_CLASS_1", "LGBM_B9"."Score_CLASS_2" AS "Score_CLASS_2" 
FROM "TMP_20180602_G47_LGBM_B9" AS "LGBM_B9") AS "LGBM_EnsembleUnion")
...
-- Code For temporary table TMP_20180602_BLC_LGBM_SUM part 3. Create Index 

CREATE INDEX "ix_TMP_20180602_BLC_LGB_eb3b" ON "TMP_20180602_BLC_LGBM_SUM" ("KEY")
...
FROM "TMP_20180602_BLC_LGBM_SUM" AS "LGBM_sum"), 
