...
-- Code For temporary table tmp_20180602151547_owf_ads_imp_1_out part 1. Create 


CREATE TABLE tmp_20180602151547_owf_ads_imp_1_out (
	`KEY` BIGINT, 
	impter_2 DOUBLE, 
	impter_3 DOUBLE, 
	impter_4 DOUBLE, 
...
-- Code For temporary table tmp_20180602151547_owf_ads_imp_1_out part 2. Populate

INSERT INTO tmp_20180602151547_owf_ads_imp_1_out (`KEY`, impter_2, impter_3, impter_4, impter_5, impter_6, impter_7, impter_8, impter_9, impter_10, impter_11) SELECT `ADS_imp_1_OUT`.`KEY`, `ADS_imp_1_OUT`.impter_2, `ADS_imp_1_OUT`.impter_3, `ADS_imp_1_OUT`.impter_4, `ADS_imp_1_OUT`.impter_5, `ADS_imp_1_OUT`.impter_6, `ADS_imp_1_OUT`.impter_7, `ADS_imp_1_OUT`.impter_8, `ADS_imp_1_OUT`.impter_9, `ADS_imp_1_OUT`.impter_10, `ADS_imp_1_OUT`.impter_11 
...
-- Code For temporary table tmp_20180602151547_op5_ads_sca_2_out part 1. Create 


CREATE TABLE tmp_20180602151547_op5_ads_sca_2_out (
	`KEY` BIGINT, 
	scaler_2 DOUBLE, 
	scaler_3 DOUBLE, 
	scaler_4 DOUBLE, 
...
FROM tmp_20180602151547_owf_ads_imp_1_out AS `ADS_imp_1_OUT`) AS `ADS_sca_2_OUT`

-- Code For temporary table tmp_20180602151547_lc9_xgb_b0 part 1. Create 


CREATE TABLE tmp_20180602151547_lc9_xgb_b0 (
	`KEY` BIGINT, 
	`Estimator` DOUBLE
)
...
-- Code For temporary table tmp_20180602151547_lc9_xgb_b0 part 2. Populate
...
FROM tmp_20180602151547_op5_ads_sca_2_out AS `ADS_sca_2_OUT`), 
`DT_node_data` AS 
...
FROM `DT_Output_9`)
 INSERT INTO tmp_20180602151547_lc9_xgb_b0 (`KEY`, `Estimator`) SELECT `XGB_B0`.`KEY`, `XGB_B0`.`Estimator` 
...
-- Code For temporary table tmp_20180602151547_3kw_xgb_b1 part 1. Create 


CREATE TABLE tmp_20180602151547_3kw_xgb_b1 (
	`KEY` BIGINT, 
	`Estimator` DOUBLE
)
...
-- Code For temporary table tmp_20180602151547_3kw_xgb_b1 part 2. Populate
...
FROM `DT_Output_15`)
 INSERT INTO tmp_20180602151547_3kw_xgb_b1 (`KEY`, `Estimator`) SELECT `XGB_B1`.`KEY`, `XGB_B1`.`Estimator` 
...
-- Code For temporary table tmp_20180602151547_332_xgb_sum part 1. Create 


CREATE TABLE tmp_20180602151547_332_xgb_sum (
	`KEY` BIGINT, 
	`Estimator` DOUBLE
)
...
-- Code For temporary table tmp_20180602151547_332_xgb_sum part 2. Populate
...
FROM tmp_20180602151547_lc9_xgb_b0 AS `XGB_B0` UNION ALL SELECT `XGB_B1`.`KEY` AS `KEY`, `XGB_B1`.`Estimator` AS `Estimator` 
FROM tmp_20180602151547_3kw_xgb_b1 AS `XGB_B1`) AS `XGB_EnsembleUnion`)
 INSERT INTO tmp_20180602151547_332_xgb_sum (`KEY`, `Estimator`) SELECT `XGB_sum`.`KEY`, `XGB_sum`.`Estimator` 
...
FROM tmp_20180602151547_332_xgb_sum AS `XGB_sum`