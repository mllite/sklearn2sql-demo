...
-- Code For temporary table tmp_20180602145727_m2r_ads_imp_1_out part 2. Populate

SELECT * FROM `tmp_20180602145727_m2r_ads_imp_1_out`

-- Code For temporary table tmp_20180602145727_p79_ads_sca_2_out part 1. Create 

CREATE TEMPORARY TABLE `tmp_20180602145727_p79_ads_sca_2_out` STORED AS ORC AS SELECT `ADS_sca_2_OUT`.`KEY`, `ADS_sca_2_OUT`.`scaler_2`, `ADS_sca_2_OUT`.`scaler_3`, `ADS_sca_2_OUT`.`scaler_4`, `ADS_sca_2_OUT`.`scaler_5`, `ADS_sca_2_OUT`.`scaler_6`, `ADS_sca_2_OUT`.`scaler_7`, `ADS_sca_2_OUT`.`scaler_8`, `ADS_sca_2_OUT`.`scaler_9`, `ADS_sca_2_OUT`.`scaler_10`, `ADS_sca_2_OUT`.`scaler_11`, `ADS_sca_2_OUT`.`scaler_12`, `ADS_sca_2_OUT`.`scaler_13`, `ADS_sca_2_OUT`.`scaler_14` 
...
FROM `tmp_20180602145727_m2r_ads_imp_1_out` AS `ADS_imp_1_OUT`) AS `ADS_sca_2_OUT`

-- Code For temporary table tmp_20180602145727_p79_ads_sca_2_out part 2. Populate

SELECT * FROM `tmp_20180602145727_p79_ads_sca_2_out`

-- Code For temporary table tmp_20180602145727_dfy_xgb_b0 part 1. Create 

CREATE TEMPORARY TABLE `tmp_20180602145727_dfy_xgb_b0` STORED AS ORC AS WITH `DT_node_lookup` AS 
...
FROM `tmp_20180602145727_p79_ads_sca_2_out` AS `ADS_sca_2_OUT`), 
`DT_node_data` AS 
...
-- Code For temporary table tmp_20180602145727_dfy_xgb_b0 part 2. Populate

SELECT * FROM `tmp_20180602145727_dfy_xgb_b0`

-- Code For temporary table tmp_20180602145727_z0r_xgb_b1 part 1. Create 

CREATE TEMPORARY TABLE `tmp_20180602145727_z0r_xgb_b1` STORED AS ORC AS WITH `DT_node_lookup_10` AS 
...
-- Code For temporary table tmp_20180602145727_z0r_xgb_b1 part 2. Populate

SELECT * FROM `tmp_20180602145727_z0r_xgb_b1`

-- Code For temporary table tmp_20180602145727_bj1_xgb_sum part 1. Create 

CREATE TEMPORARY TABLE `tmp_20180602145727_bj1_xgb_sum` STORED AS ORC AS WITH `XGB_Union` AS 
...
FROM `tmp_20180602145727_dfy_xgb_b0` AS `XGB_B0` UNION ALL SELECT `XGB_B1`.`KEY` AS `KEY`, `XGB_B1`.`Estimator` AS `Estimator` 
FROM `tmp_20180602145727_z0r_xgb_b1` AS `XGB_B1`) AS `XGB_EnsembleUnion`)
...
-- Code For temporary table tmp_20180602145727_bj1_xgb_sum part 2. Populate

SELECT * FROM `tmp_20180602145727_bj1_xgb_sum`

-- Model deployment code

SELECT `XGB_sum`.`KEY` AS `KEY`, `XGB_sum`.`Estimator` + 0.5 AS `Estimator` 
FROM `tmp_20180602145727_bj1_xgb_sum` AS `XGB_sum`