...
-- Code For temporary table ##TMP_20180602152529_P6I_ADS_imp_1_OUT part 1. Create 


CREATE TABLE ##TMP_20180602152529_P6I_ADS_imp_1_OUT (
	[KEY] BIGINT NULL, 
...
-- Code For temporary table ##TMP_20180602152529_P6I_ADS_imp_1_OUT part 2. Populate

INSERT INTO ##TMP_20180602152529_P6I_ADS_imp_1_OUT ([KEY], imputer_output_2, imputer_output_3, imputer_output_4, imputer_output_5) SELECT [ADS_imp_1_OUT].[KEY], [ADS_imp_1_OUT].imputer_output_2, [ADS_imp_1_OUT].imputer_output_3, [ADS_imp_1_OUT].imputer_output_4, [ADS_imp_1_OUT].imputer_output_5 
...
-- Code For temporary table ##TMP_20180602152529_6G0_ADS_sca_2_OUT part 1. Create 


CREATE TABLE ##TMP_20180602152529_6G0_ADS_sca_2_OUT (
	[KEY] BIGINT NULL, 
...
-- Code For temporary table ##TMP_20180602152529_6G0_ADS_sca_2_OUT part 2. Populate

INSERT INTO ##TMP_20180602152529_6G0_ADS_sca_2_OUT ([KEY], scaler_output_2, scaler_output_3, scaler_output_4, scaler_output_5) SELECT [ADS_sca_2_OUT].[KEY], [ADS_sca_2_OUT].scaler_output_2, [ADS_sca_2_OUT].scaler_output_3, [ADS_sca_2_OUT].scaler_output_4, [ADS_sca_2_OUT].scaler_output_5 
...
FROM ##TMP_20180602152529_P6I_ADS_imp_1_OUT AS [ADS_imp_1_OUT]) AS [ADS_sca_2_OUT]

-- Code For temporary table ##TMP_20180602152529_Q7E_XGB_B0 part 1. Create 


CREATE TABLE ##TMP_20180602152529_Q7E_XGB_B0 (
	[KEY] BIGINT NULL, 
...
-- Code For temporary table ##TMP_20180602152529_Q7E_XGB_B0 part 2. Populate
...
FROM ##TMP_20180602152529_6G0_ADS_sca_2_OUT AS [ADS_sca_2_OUT]), 
[DT_node_data] AS 
...
FROM [DT_Output_9])
 INSERT INTO ##TMP_20180602152529_Q7E_XGB_B0 ([KEY], [Estimator]) SELECT [XGB_B0].[KEY], [XGB_B0].[Estimator] 
...
-- Code For temporary table ##TMP_20180602152529_CDO_XGB_B1 part 1. Create 


CREATE TABLE ##TMP_20180602152529_CDO_XGB_B1 (
	[KEY] BIGINT NULL, 
	[Estimator] FLOAT(53) NULL
)
...
-- Code For temporary table ##TMP_20180602152529_CDO_XGB_B1 part 2. Populate
...
FROM [DT_Output_15])
 INSERT INTO ##TMP_20180602152529_CDO_XGB_B1 ([KEY], [Estimator]) SELECT [XGB_B1].[KEY], [XGB_B1].[Estimator] 
...
-- Code For temporary table ##TMP_20180602152529_8FW_XGB_sum part 1. Create 


CREATE TABLE ##TMP_20180602152529_8FW_XGB_sum (
	[KEY] BIGINT NULL, 
	[Estimator] FLOAT(53) NULL
)
...
-- Code For temporary table ##TMP_20180602152529_8FW_XGB_sum part 2. Populate
...
FROM ##TMP_20180602152529_Q7E_XGB_B0 AS [XGB_B0] UNION ALL SELECT [XGB_B1].[KEY] AS [KEY], [XGB_B1].[Estimator] AS [Estimator] 
FROM ##TMP_20180602152529_CDO_XGB_B1 AS [XGB_B1]) AS [XGB_EnsembleUnion])
 INSERT INTO ##TMP_20180602152529_8FW_XGB_sum ([KEY], [Estimator]) SELECT [XGB_sum].[KEY], [XGB_sum].[Estimator] 
...
FROM ##TMP_20180602152529_8FW_XGB_sum AS [XGB_sum]