...
-- Code For temporary table tmp_20180602152533_911_ads_imp_1_out part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180602152533_911_ads_imp_1_out (
	"KEY" BIGINT, 
...
-- Code For temporary table tmp_20180602152533_911_ads_imp_1_out part 2. Populate

INSERT INTO tmp_20180602152533_911_ads_imp_1_out SELECT "ADS_imp_1_OUT"."KEY", "ADS_imp_1_OUT".imputer_output_2, "ADS_imp_1_OUT".imputer_output_3, "ADS_imp_1_OUT".imputer_output_4, "ADS_imp_1_OUT".imputer_output_5 
...
-- Code For temporary table tmp_20180602152533_b6n_ads_sca_2_out part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180602152533_b6n_ads_sca_2_out (
	"KEY" BIGINT, 
...
-- Code For temporary table tmp_20180602152533_b6n_ads_sca_2_out part 2. Populate

INSERT INTO tmp_20180602152533_b6n_ads_sca_2_out SELECT "ADS_sca_2_OUT"."KEY", "ADS_sca_2_OUT".scaler_output_2, "ADS_sca_2_OUT".scaler_output_3, "ADS_sca_2_OUT".scaler_output_4, "ADS_sca_2_OUT".scaler_output_5 
...
FROM tmp_20180602152533_911_ads_imp_1_out AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT"

-- Code For temporary table tmp_20180602152533_p2t_xgb_b0 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180602152533_p2t_xgb_b0 (
	"KEY" BIGINT, 
	"Estimator" DOUBLE
)
...
-- Code For temporary table tmp_20180602152533_p2t_xgb_b0 part 2. Populate

INSERT INTO tmp_20180602152533_p2t_xgb_b0 WITH "DT_node_lookup" AS 
...
FROM tmp_20180602152533_b6n_ads_sca_2_out AS "ADS_sca_2_OUT"), 
"DT_node_data" AS 
...
-- Code For temporary table tmp_20180602152533_7tv_xgb_b1 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180602152533_7tv_xgb_b1 (
	"KEY" BIGINT, 
	"Estimator" DOUBLE
)
...
-- Code For temporary table tmp_20180602152533_7tv_xgb_b1 part 2. Populate

INSERT INTO tmp_20180602152533_7tv_xgb_b1 WITH "DT_node_lookup_10" AS 
...
-- Code For temporary table tmp_20180602152533_0ui_xgb_sum part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180602152533_0ui_xgb_sum (
	"KEY" BIGINT, 
	"Estimator" DOUBLE
)
...
-- Code For temporary table tmp_20180602152533_0ui_xgb_sum part 2. Populate

INSERT INTO tmp_20180602152533_0ui_xgb_sum WITH "XGB_Union" AS 
...
FROM tmp_20180602152533_p2t_xgb_b0 AS "XGB_B0" UNION ALL SELECT "XGB_B1"."KEY" AS "KEY", "XGB_B1"."Estimator" AS "Estimator" 
FROM tmp_20180602152533_7tv_xgb_b1 AS "XGB_B1") AS "XGB_EnsembleUnion")
...
FROM tmp_20180602152533_0ui_xgb_sum AS "XGB_sum"