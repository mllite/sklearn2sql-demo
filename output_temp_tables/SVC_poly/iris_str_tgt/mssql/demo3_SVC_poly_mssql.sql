...
-- Code For temporary table ##TMP_20180602162038_USW_KernAgg_B0 part 1. Create 


CREATE TABLE ##TMP_20180602162038_USW_KernAgg_B0 (
	[KEY] BIGINT NULL, 
...
-- Code For temporary table ##TMP_20180602162038_USW_KernAgg_B0 part 2. Populate
...
FROM (SELECT kernel_input.[KEY] AS [KEY], [SV_data_CLASS_0_CLASS_1].dual_coeff * power(CAST(0.25 * (kernel_input.[Feature_0] * [SV_data_CLASS_0_CLASS_1].sv_0 + kernel_input.[Feature_1] * [SV_data_CLASS_0_CLASS_1].sv_1 + kernel_input.[Feature_2] * [SV_data_CLASS_0_CLASS_1].sv_2 + kernel_input.[Feature_3] * [SV_data_CLASS_0_CLASS_1].sv_3) + 0.0 AS FLOAT(53)), 3) AS dot_prod1 
...
(SELECT [kernel_dp_CLASS_0_CLASS_1].[KEY] AS [KEY], 'CLASS_0' AS [OVO_Class1], 'CLASS_1' AS [OVO_Class2], CASE WHEN (-[kernel_dp_CLASS_0_CLASS_1].dot_product >= 0.0) THEN 1 ELSE 0 END AS [OVO_Decision], coalesce(-[kernel_dp_CLASS_0_CLASS_1].dot_product, 1.0 / (1.0 + exp(CASE WHEN (CASE WHEN (-100.0 <= -(-((-[kernel_dp_CLASS_0_CLASS_1].dot_product) * -1.6452832261274615 + -0.9217878659409225))) THEN -(-((-[kernel_dp_CLASS_0_CLASS_1].dot_product) * -1.6452832261274615 + -0.9217878659409225)) ELSE -100.0 END <= 100.0) THEN CASE WHEN (-100.0 <= -(-((-[kernel_dp_CLASS_0_CLASS_1].dot_product) * -1.6452832261274615 + -0.9217878659409225))) THEN -(-((-[kernel_dp_CLASS_0_CLASS_1].dot_product) * -1.6452832261274615 + -0.9217878659409225)) ELSE -100.0 END ELSE 100.0 END))) AS [OVO_Conf] 
FROM [kernel_dp_CLASS_0_CLASS_1])
 INSERT INTO ##TMP_20180602162038_USW_KernAgg_B0 ([KEY], [OVO_Class1], [OVO_Class2], [OVO_Decision], [OVO_Conf]) SELECT [KernAgg_B0].[KEY], [KernAgg_B0].[OVO_Class1], [KernAgg_B0].[OVO_Class2], [KernAgg_B0].[OVO_Decision], [KernAgg_B0].[OVO_Conf] 
...
-- Code For temporary table ##TMP_20180602162038_XVL_KernAgg_B1 part 1. Create 


CREATE TABLE ##TMP_20180602162038_XVL_KernAgg_B1 (
	[KEY] BIGINT NULL, 
	[OVO_Class1] VARCHAR(max) COLLATE utf8 NULL, 
	[OVO_Class2] VARCHAR(max) COLLATE utf8 NULL, 
	[OVO_Decision] BIGINT NULL, 
...
-- Code For temporary table ##TMP_20180602162038_XVL_KernAgg_B1 part 2. Populate
...
FROM (SELECT kernel_input.[KEY] AS [KEY], [SV_data_CLASS_0_CLASS_2].dual_coeff * power(CAST(0.25 * (kernel_input.[Feature_0] * [SV_data_CLASS_0_CLASS_2].sv_0 + kernel_input.[Feature_1] * [SV_data_CLASS_0_CLASS_2].sv_1 + kernel_input.[Feature_2] * [SV_data_CLASS_0_CLASS_2].sv_2 + kernel_input.[Feature_3] * [SV_data_CLASS_0_CLASS_2].sv_3) + 0.0 AS FLOAT(53)), 3) AS dot_prod1 
...
(SELECT [kernel_dp_CLASS_0_CLASS_2].[KEY] AS [KEY], 'CLASS_0' AS [OVO_Class1], 'CLASS_2' AS [OVO_Class2], CASE WHEN (-[kernel_dp_CLASS_0_CLASS_2].dot_product >= 0.0) THEN 1 ELSE 0 END AS [OVO_Decision], coalesce(-[kernel_dp_CLASS_0_CLASS_2].dot_product, 1.0 / (1.0 + exp(CASE WHEN (CASE WHEN (-100.0 <= -(-((-[kernel_dp_CLASS_0_CLASS_2].dot_product) * -2.0446428004386434 + -0.6355118085291712))) THEN -(-((-[kernel_dp_CLASS_0_CLASS_2].dot_product) * -2.0446428004386434 + -0.6355118085291712)) ELSE -100.0 END <= 100.0) THEN CASE WHEN (-100.0 <= -(-((-[kernel_dp_CLASS_0_CLASS_2].dot_product) * -2.0446428004386434 + -0.6355118085291712))) THEN -(-((-[kernel_dp_CLASS_0_CLASS_2].dot_product) * -2.0446428004386434 + -0.6355118085291712)) ELSE -100.0 END ELSE 100.0 END))) AS [OVO_Conf] 
FROM [kernel_dp_CLASS_0_CLASS_2])
 INSERT INTO ##TMP_20180602162038_XVL_KernAgg_B1 ([KEY], [OVO_Class1], [OVO_Class2], [OVO_Decision], [OVO_Conf]) SELECT [KernAgg_B1].[KEY], [KernAgg_B1].[OVO_Class1], [KernAgg_B1].[OVO_Class2], [KernAgg_B1].[OVO_Decision], [KernAgg_B1].[OVO_Conf] 
...
-- Code For temporary table ##TMP_20180602162038_UBJ_KernAgg_B2 part 1. Create 


CREATE TABLE ##TMP_20180602162038_UBJ_KernAgg_B2 (
	[KEY] BIGINT NULL, 
	[OVO_Class1] VARCHAR(max) COLLATE utf8 NULL, 
	[OVO_Class2] VARCHAR(max) COLLATE utf8 NULL, 
	[OVO_Decision] BIGINT NULL, 
...
-- Code For temporary table ##TMP_20180602162038_UBJ_KernAgg_B2 part 2. Populate
...
FROM (SELECT kernel_input.[KEY] AS [KEY], [SV_data_CLASS_1_CLASS_2].dual_coeff * power(CAST(0.25 * (kernel_input.[Feature_0] * [SV_data_CLASS_1_CLASS_2].sv_0 + kernel_input.[Feature_1] * [SV_data_CLASS_1_CLASS_2].sv_1 + kernel_input.[Feature_2] * [SV_data_CLASS_1_CLASS_2].sv_2 + kernel_input.[Feature_3] * [SV_data_CLASS_1_CLASS_2].sv_3) + 0.0 AS FLOAT(53)), 3) AS dot_prod1 
...
(SELECT [kernel_dp_CLASS_1_CLASS_2].[KEY] AS [KEY], 'CLASS_1' AS [OVO_Class1], 'CLASS_2' AS [OVO_Class2], CASE WHEN (-[kernel_dp_CLASS_1_CLASS_2].dot_product >= 0.0) THEN 1 ELSE 0 END AS [OVO_Decision], coalesce(-[kernel_dp_CLASS_1_CLASS_2].dot_product, 1.0 / (1.0 + exp(CASE WHEN (CASE WHEN (-100.0 <= -(-((-[kernel_dp_CLASS_1_CLASS_2].dot_product) * -0.3526411164623769 + -0.13182819140164967))) THEN -(-((-[kernel_dp_CLASS_1_CLASS_2].dot_product) * -0.3526411164623769 + -0.13182819140164967)) ELSE -100.0 END <= 100.0) THEN CASE WHEN (-100.0 <= -(-((-[kernel_dp_CLASS_1_CLASS_2].dot_product) * -0.3526411164623769 + -0.13182819140164967))) THEN -(-((-[kernel_dp_CLASS_1_CLASS_2].dot_product) * -0.3526411164623769 + -0.13182819140164967)) ELSE -100.0 END ELSE 100.0 END))) AS [OVO_Conf] 
FROM [kernel_dp_CLASS_1_CLASS_2])
 INSERT INTO ##TMP_20180602162038_UBJ_KernAgg_B2 ([KEY], [OVO_Class1], [OVO_Class2], [OVO_Decision], [OVO_Conf]) SELECT [KernAgg_B2].[KEY], [KernAgg_B2].[OVO_Class1], [KernAgg_B2].[OVO_Class2], [KernAgg_B2].[OVO_Decision], [KernAgg_B2].[OVO_Conf] 
...
-- Code For temporary table ##TMP_20180602162038_JBV_KernAgg_agg part 1. Create 


CREATE TABLE ##TMP_20180602162038_JBV_KernAgg_agg (
	[KEY] BIGINT NULL, 
...
-- Code For temporary table ##TMP_20180602162038_JBV_KernAgg_agg part 2. Populate
...
FROM ##TMP_20180602162038_USW_KernAgg_B0 AS [KernAgg_B0] UNION ALL SELECT [KernAgg_B1].[KEY] AS [KEY], [KernAgg_B1].[OVO_Class1] AS [OVO_Class1], [KernAgg_B1].[OVO_Class2] AS [OVO_Class2], [KernAgg_B1].[OVO_Decision] AS [OVO_Decision], [KernAgg_B1].[OVO_Conf] AS [OVO_Conf] 
FROM ##TMP_20180602162038_XVL_KernAgg_B1 AS [KernAgg_B1] UNION ALL SELECT [KernAgg_B2].[KEY] AS [KEY], [KernAgg_B2].[OVO_Class1] AS [OVO_Class1], [KernAgg_B2].[OVO_Class2] AS [OVO_Class2], [KernAgg_B2].[OVO_Decision] AS [OVO_Decision], [KernAgg_B2].[OVO_Conf] AS [OVO_Conf] 
FROM ##TMP_20180602162038_UBJ_KernAgg_B2 AS [KernAgg_B2]) AS [KernAgg_EnsembleUnion]), 
[OVO_Votes] AS 
...
FROM ##TMP_20180602162038_JBV_KernAgg_agg AS [KernAgg_agg]), 
