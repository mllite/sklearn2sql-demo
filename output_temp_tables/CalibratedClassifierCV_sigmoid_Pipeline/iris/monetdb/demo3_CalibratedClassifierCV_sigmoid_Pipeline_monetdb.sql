...
-- Code For temporary table tmp_20180602152627_ubd_ads_imp_1_out part 1. Create 


CREATE TEMPORARY TABLE tmp_20180602152627_ubd_ads_imp_1_out (
	"KEY" BIGINT, 
...
-- Code For temporary table tmp_20180602152627_ubd_ads_imp_1_out part 2. Populate

INSERT INTO tmp_20180602152627_ubd_ads_imp_1_out ("KEY", imputer_output_2, imputer_output_3, imputer_output_4, imputer_output_5) SELECT "U"."KEY", "U".imputer_output_2, "U".imputer_output_3, "U".imputer_output_4, "U".imputer_output_5 
...
-- Code For temporary table tmp_20180602152627_asx_ads_sca_2_out part 1. Create 


CREATE TEMPORARY TABLE tmp_20180602152627_asx_ads_sca_2_out (
	"KEY" BIGINT, 
...
-- Code For temporary table tmp_20180602152627_asx_ads_sca_2_out part 2. Populate

INSERT INTO tmp_20180602152627_asx_ads_sca_2_out ("KEY", scaler_output_2, scaler_output_3, scaler_output_4, scaler_output_5) SELECT "U"."KEY", "U".scaler_output_2, "U".scaler_output_3, "U".scaler_output_4, "U".scaler_output_5 
...
FROM tmp_20180602152627_ubd_ads_imp_1_out AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT") AS "U"

-- Code For temporary table tmp_20180602152627_h88_calprob_b0 part 1. Create 


CREATE TEMPORARY TABLE tmp_20180602152627_h88_calprob_b0 (
	"KEY" BIGINT, 
	"Proba_0" DOUBLE, 
	"Proba_1" DOUBLE, 
	"Proba_2" DOUBLE
...
-- Code For temporary table tmp_20180602152627_h88_calprob_b0 part 2. Populate

INSERT INTO tmp_20180602152627_h88_calprob_b0 ("KEY", "Proba_0", "Proba_1", "Proba_2") SELECT "U"."KEY", "U"."Proba_0", "U"."Proba_1", "U"."Proba_2" 
...
FROM tmp_20180602152627_asx_ads_sca_2_out AS "ADS_sca_2_OUT"), 
"DT_node_data" AS 
...
-- Code For temporary table tmp_20180602152627_jxl_calprob_avg part 1. Create 


CREATE TEMPORARY TABLE tmp_20180602152627_jxl_calprob_avg (
	"KEY" BIGINT, 
	"Proba_0" DOUBLE, 
	"Proba_1" DOUBLE, 
	"Proba_2" DOUBLE
...
-- Code For temporary table tmp_20180602152627_jxl_calprob_avg part 2. Populate

INSERT INTO tmp_20180602152627_jxl_calprob_avg ("KEY", "Proba_0", "Proba_1", "Proba_2") SELECT "U"."KEY", "U"."Proba_0", "U"."Proba_1", "U"."Proba_2" 
...
FROM tmp_20180602152627_h88_calprob_b0 AS "CalProb_B0") AS "CalProb_EnsembleUnion")
...
FROM tmp_20180602152627_jxl_calprob_avg AS "CalProb_avg"), 
