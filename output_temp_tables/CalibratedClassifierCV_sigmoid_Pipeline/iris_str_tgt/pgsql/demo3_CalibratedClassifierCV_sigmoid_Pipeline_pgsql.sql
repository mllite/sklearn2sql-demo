...
-- Code For temporary table TMP_20180602160142_KEL_ADS_imp_1_OUT part 1. Create 


CREATE TEMPORARY TABLE "TMP_20180602160142_KEL_ADS_imp_1_OUT" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20180602160142_KEL_ADS_imp_1_OUT part 2. Populate

INSERT INTO "TMP_20180602160142_KEL_ADS_imp_1_OUT" ("KEY", imputer_output_2, imputer_output_3, imputer_output_4, imputer_output_5) SELECT "ADS_imp_1_OUT"."KEY", "ADS_imp_1_OUT".imputer_output_2, "ADS_imp_1_OUT".imputer_output_3, "ADS_imp_1_OUT".imputer_output_4, "ADS_imp_1_OUT".imputer_output_5 
...
-- Code For temporary table TMP_20180602160142_KEL_ADS_imp_1_OUT part 3. Create Index 

CREATE INDEX "ix_TMP_20180602160142_KEL_ADS_imp_1_OUT_KEY" ON "TMP_20180602160142_KEL_ADS_imp_1_OUT" ("KEY")

-- Code For temporary table TMP_20180602160142_WY6_ADS_sca_2_OUT part 1. Create 


CREATE TEMPORARY TABLE "TMP_20180602160142_WY6_ADS_sca_2_OUT" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20180602160142_WY6_ADS_sca_2_OUT part 2. Populate

INSERT INTO "TMP_20180602160142_WY6_ADS_sca_2_OUT" ("KEY", scaler_output_2, scaler_output_3, scaler_output_4, scaler_output_5) SELECT "ADS_sca_2_OUT"."KEY", "ADS_sca_2_OUT".scaler_output_2, "ADS_sca_2_OUT".scaler_output_3, "ADS_sca_2_OUT".scaler_output_4, "ADS_sca_2_OUT".scaler_output_5 
...
FROM "TMP_20180602160142_KEL_ADS_imp_1_OUT" AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT"

-- Code For temporary table TMP_20180602160142_WY6_ADS_sca_2_OUT part 3. Create Index 

CREATE INDEX "ix_TMP_20180602160142_WY6_ADS_sca_2_OUT_KEY" ON "TMP_20180602160142_WY6_ADS_sca_2_OUT" ("KEY")

-- Code For temporary table TMP_20180602160142_SRB_CalProb_B0 part 1. Create 


CREATE TEMPORARY TABLE "TMP_20180602160142_SRB_CalProb_B0" (
	"KEY" BIGINT, 
	"Proba_CLASS_0" FLOAT, 
	"Proba_CLASS_1" FLOAT, 
	"Proba_CLASS_2" FLOAT
...
-- Code For temporary table TMP_20180602160142_SRB_CalProb_B0 part 2. Populate
...
FROM "TMP_20180602160142_WY6_ADS_sca_2_OUT" AS "ADS_sca_2_OUT"), 
"DT_node_data" AS 
...
FROM sigmoid_calibration_3)
 INSERT INTO "TMP_20180602160142_SRB_CalProb_B0" ("KEY", "Proba_CLASS_0", "Proba_CLASS_1", "Proba_CLASS_2") SELECT "CalProb_B0"."KEY", "CalProb_B0"."Proba_CLASS_0", "CalProb_B0"."Proba_CLASS_1", "CalProb_B0"."Proba_CLASS_2" 
...
-- Code For temporary table TMP_20180602160142_FWD_CalProb_avg part 1. Create 


CREATE TEMPORARY TABLE "TMP_20180602160142_FWD_CalProb_avg" (
	"KEY" BIGINT NOT NULL, 
	"Proba_CLASS_0" FLOAT, 
	"Proba_CLASS_1" FLOAT, 
	"Proba_CLASS_2" FLOAT, 
...
-- Code For temporary table TMP_20180602160142_FWD_CalProb_avg part 2. Populate
...
FROM "TMP_20180602160142_SRB_CalProb_B0" AS "CalProb_B0") AS "CalProb_EnsembleUnion")
 INSERT INTO "TMP_20180602160142_FWD_CalProb_avg" ("KEY", "Proba_CLASS_0", "Proba_CLASS_1", "Proba_CLASS_2") SELECT "CalProb_avg"."KEY", "CalProb_avg"."Proba_CLASS_0", "CalProb_avg"."Proba_CLASS_1", "CalProb_avg"."Proba_CLASS_2" 
...
-- Code For temporary table TMP_20180602160142_FWD_CalProb_avg part 3. Create Index 

CREATE INDEX "ix_TMP_20180602160142_FWD_CalProb_avg_KEY" ON "TMP_20180602160142_FWD_CalProb_avg" ("KEY")
...
FROM "TMP_20180602160142_FWD_CalProb_avg" AS "CalProb_avg"), 
