...
-- Code For temporary table 20180602_3U6_ADS_IMP_1_OUT part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "20180602_3U6_ADS_IMP_1_OUT" (
	"KEY" NUMBER(19), 
...
-- Code For temporary table 20180602_3U6_ADS_IMP_1_OUT part 2. Populate

INSERT INTO "20180602_3U6_ADS_IMP_1_OUT" ("KEY", imputer_output_2, imputer_output_3, imputer_output_4, imputer_output_5) SELECT "U"."KEY", "U".imputer_output_2, "U".imputer_output_3, "U".imputer_output_4, "U".imputer_output_5 
...
-- Code For temporary table 20180602_698_ADS_SCA_2_OUT part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "20180602_698_ADS_SCA_2_OUT" (
	"KEY" NUMBER(19), 
...
-- Code For temporary table 20180602_698_ADS_SCA_2_OUT part 2. Populate

INSERT INTO "20180602_698_ADS_SCA_2_OUT" ("KEY", scaler_output_2, scaler_output_3, scaler_output_4, scaler_output_5) SELECT "U"."KEY", "U".scaler_output_2, "U".scaler_output_3, "U".scaler_output_4, "U".scaler_output_5 
...
FROM "20180602_3U6_ADS_IMP_1_OUT" "ADS_imp_1_OUT") "ADS_sca_2_OUT") "U"

-- Code For temporary table MP_20180602_5XP_CALPROB_B0 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "MP_20180602_5XP_CALPROB_B0" (
	"KEY" NUMBER(19), 
...
-- Code For temporary table MP_20180602_5XP_CALPROB_B0 part 2. Populate

INSERT INTO "MP_20180602_5XP_CALPROB_B0" ("KEY", "Proba_CLASS_0", "Proba_CLASS_1", "Proba_CLASS_2") SELECT "U"."KEY", "U"."Proba_CLASS_0", "U"."Proba_CLASS_1", "U"."Proba_CLASS_2" 
...
FROM "20180602_698_ADS_SCA_2_OUT" "ADS_sca_2_OUT"), 
"DT_node_data" AS 
...
-- Code For temporary table P_20180602_1MS_CALPROB_AVG part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "P_20180602_1MS_CALPROB_AVG" (
	"KEY" NUMBER(19), 
	"Proba_CLASS_0" BINARY_DOUBLE, 
	"Proba_CLASS_1" BINARY_DOUBLE, 
	"Proba_CLASS_2" BINARY_DOUBLE
...
-- Code For temporary table P_20180602_1MS_CALPROB_AVG part 2. Populate

INSERT INTO "P_20180602_1MS_CALPROB_AVG" ("KEY", "Proba_CLASS_0", "Proba_CLASS_1", "Proba_CLASS_2") SELECT "U"."KEY", "U"."Proba_CLASS_0", "U"."Proba_CLASS_1", "U"."Proba_CLASS_2" 
...
FROM "MP_20180602_5XP_CALPROB_B0" "CalProb_B0") "CalProb_EnsembleUnion")
...
FROM "P_20180602_1MS_CALPROB_AVG" "CalProb_avg"), 
