...
-- Code For temporary table TMP_20180602_O2M_ADS_IMP_1_OUT part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180602_O2M_ADS_IMP_1_OUT" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20180602_O2M_ADS_IMP_1_OUT part 3. Create Index 

CREATE INDEX "ix_TMP_20180602_O2M_ADS_0f24" ON "TMP_20180602_O2M_ADS_IMP_1_OUT" ("KEY")

-- Code For temporary table TMP_20180602_MRT_ADS_SCA_2_OUT part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180602_MRT_ADS_SCA_2_OUT" (
	"KEY" BIGINT NOT NULL, 
...
FROM "TMP_20180602_O2M_ADS_IMP_1_OUT" AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT") AS "U"

-- Code For temporary table TMP_20180602_MRT_ADS_SCA_2_OUT part 3. Create Index 

CREATE INDEX "ix_TMP_20180602_MRT_ADS_0503" ON "TMP_20180602_MRT_ADS_SCA_2_OUT" ("KEY")

-- Code For temporary table TMP_20180602_JAF_HL_1_RELU_1 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180602_JAF_HL_1_RELU_1" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20180602_JAF_HL_1_RELU_1 part 2. Populate

INSERT INTO "TMP_20180602_JAF_HL_1_RELU_1" ("KEY", "NEUR_1_1", "NEUR_1_2", "NEUR_1_3") SELECT "U"."KEY", "U"."NEUR_1_1", "U"."NEUR_1_2", "U"."NEUR_1_3" 
FROM (WITH "IL" AS 
...
FROM "TMP_20180602_MRT_ADS_SCA_2_OUT" AS "ADS_sca_2_OUT"), 
"HL_BA_1" AS 
...
-- Code For temporary table TMP_20180602_JAF_HL_1_RELU_1 part 3. Create Index 

CREATE INDEX "ix_TMP_20180602_JAF_HL__ded1" ON "TMP_20180602_JAF_HL_1_RELU_1" ("KEY")

-- Code For temporary table TMP_20180602_JLU_OL_LOGISTIC_1 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180602_JLU_OL_LOGISTIC_1" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20180602_JLU_OL_LOGISTIC_1 part 2. Populate

INSERT INTO "TMP_20180602_JLU_OL_LOGISTIC_1" ("KEY", "NEUR_3_1") SELECT "U"."KEY", "U"."NEUR_3_1" 
...
FROM "TMP_20180602_JAF_HL_1_RELU_1" AS "HL_1_relu_1"), 
"HL_2_relu" AS 
...
-- Code For temporary table TMP_20180602_JLU_OL_LOGISTIC_1 part 3. Create Index 

CREATE INDEX "ix_TMP_20180602_JLU_OL__0f9d" ON "TMP_20180602_JLU_OL_LOGISTIC_1" ("KEY")
...
FROM "TMP_20180602_JLU_OL_LOGISTIC_1" AS "OL_logistic_1"), 
