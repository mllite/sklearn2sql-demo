...
-- Code For temporary table 20180602_X1H_ADS_IMP_1_OUT part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "20180602_X1H_ADS_IMP_1_OUT" (
	"KEY" NUMBER(19), 
...
-- Code For temporary table 20180602_X1H_ADS_IMP_1_OUT part 2. Populate

INSERT INTO "20180602_X1H_ADS_IMP_1_OUT" ("KEY", imputer_output_2, imputer_output_3, imputer_output_4, imputer_output_5) SELECT "U"."KEY", "U".imputer_output_2, "U".imputer_output_3, "U".imputer_output_4, "U".imputer_output_5 
...
-- Code For temporary table 20180602_SQJ_ADS_SCA_2_OUT part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "20180602_SQJ_ADS_SCA_2_OUT" (
	"KEY" NUMBER(19), 
...
-- Code For temporary table 20180602_SQJ_ADS_SCA_2_OUT part 2. Populate

INSERT INTO "20180602_SQJ_ADS_SCA_2_OUT" ("KEY", scaler_output_2, scaler_output_3, scaler_output_4, scaler_output_5) SELECT "U"."KEY", "U".scaler_output_2, "U".scaler_output_3, "U".scaler_output_4, "U".scaler_output_5 
...
FROM "20180602_X1H_ADS_IMP_1_OUT" "ADS_imp_1_OUT") "ADS_sca_2_OUT") "U"

-- Code For temporary table P_20180602_QGN_HL_1_RELU_1 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "P_20180602_QGN_HL_1_RELU_1" (
	"KEY" NUMBER(19), 
...
-- Code For temporary table P_20180602_QGN_HL_1_RELU_1 part 2. Populate

INSERT INTO "P_20180602_QGN_HL_1_RELU_1" ("KEY", "NEUR_1_1", "NEUR_1_2", "NEUR_1_3") SELECT "U"."KEY", "U"."NEUR_1_1", "U"."NEUR_1_2", "U"."NEUR_1_3" 
FROM (WITH "IL" AS 
...
FROM "20180602_SQJ_ADS_SCA_2_OUT" "ADS_sca_2_OUT"), 
"HL_BA_1" AS 
...
-- Code For temporary table _20180602_9HO_OL_SOFTMAX_1 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "_20180602_9HO_OL_SOFTMAX_1" (
	"KEY" NUMBER(19), 
...
-- Code For temporary table _20180602_9HO_OL_SOFTMAX_1 part 2. Populate

INSERT INTO "_20180602_9HO_OL_SOFTMAX_1" ("KEY", "NEUR_3_1", "NEUR_3_2", "NEUR_3_3") SELECT "U"."KEY", "U"."NEUR_3_1", "U"."NEUR_3_2", "U"."NEUR_3_3" 
...
FROM "P_20180602_QGN_HL_1_RELU_1" "HL_1_relu_1"), 
"HL_2_relu" AS 
...
FROM "_20180602_9HO_OL_SOFTMAX_1" "OL_softmax_1"), 
