...
-- Code For temporary table tmp_20180602161143_9xr_ads_imp_1_out part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180602161143_9xr_ads_imp_1_out (
	"KEY" BIGINT, 
...
-- Code For temporary table tmp_20180602161143_9xr_ads_imp_1_out part 2. Populate

INSERT INTO tmp_20180602161143_9xr_ads_imp_1_out SELECT "ADS_imp_1_OUT"."KEY", "ADS_imp_1_OUT".imputer_output_2, "ADS_imp_1_OUT".imputer_output_3, "ADS_imp_1_OUT".imputer_output_4, "ADS_imp_1_OUT".imputer_output_5 
...
-- Code For temporary table tmp_20180602161143_2ot_ads_sca_2_out part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180602161143_2ot_ads_sca_2_out (
	"KEY" BIGINT, 
...
-- Code For temporary table tmp_20180602161143_2ot_ads_sca_2_out part 2. Populate

INSERT INTO tmp_20180602161143_2ot_ads_sca_2_out SELECT "ADS_sca_2_OUT"."KEY", "ADS_sca_2_OUT".scaler_output_2, "ADS_sca_2_OUT".scaler_output_3, "ADS_sca_2_OUT".scaler_output_4, "ADS_sca_2_OUT".scaler_output_5 
...
FROM tmp_20180602161143_9xr_ads_imp_1_out AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT"

-- Code For temporary table tmp_20180602161143_21u_kernagg_b0 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180602161143_21u_kernagg_b0 (
	"KEY" BIGINT, 
...
-- Code For temporary table tmp_20180602161143_21u_kernagg_b0 part 2. Populate

INSERT INTO tmp_20180602161143_21u_kernagg_b0 WITH kernel_input AS 
...
FROM tmp_20180602161143_2ot_ads_sca_2_out AS "ADS_sca_2_OUT"), 
...
-- Code For temporary table tmp_20180602161143_b7e_kernagg_b1 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180602161143_b7e_kernagg_b1 (
	"KEY" BIGINT, 
	"OVO_Class1" VARCHAR(None), 
	"OVO_Class2" VARCHAR(None), 
	"OVO_Decision" BIGINT, 
...
-- Code For temporary table tmp_20180602161143_b7e_kernagg_b1 part 2. Populate

INSERT INTO tmp_20180602161143_b7e_kernagg_b1 WITH kernel_input AS 
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", CAST("ADS_sca_2_OUT".scaler_output_2 AS DOUBLE) AS scaler_output_2, CAST("ADS_sca_2_OUT".scaler_output_3 AS DOUBLE) AS scaler_output_3, CAST("ADS_sca_2_OUT".scaler_output_4 AS DOUBLE) AS scaler_output_4, CAST("ADS_sca_2_OUT".scaler_output_5 AS DOUBLE) AS scaler_output_5 
FROM tmp_20180602161143_2ot_ads_sca_2_out AS "ADS_sca_2_OUT"), 
...
-- Code For temporary table tmp_20180602161143_g1m_kernagg_b2 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180602161143_g1m_kernagg_b2 (
	"KEY" BIGINT, 
	"OVO_Class1" VARCHAR(None), 
	"OVO_Class2" VARCHAR(None), 
	"OVO_Decision" BIGINT, 
...
-- Code For temporary table tmp_20180602161143_g1m_kernagg_b2 part 2. Populate

INSERT INTO tmp_20180602161143_g1m_kernagg_b2 WITH kernel_input AS 
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", CAST("ADS_sca_2_OUT".scaler_output_2 AS DOUBLE) AS scaler_output_2, CAST("ADS_sca_2_OUT".scaler_output_3 AS DOUBLE) AS scaler_output_3, CAST("ADS_sca_2_OUT".scaler_output_4 AS DOUBLE) AS scaler_output_4, CAST("ADS_sca_2_OUT".scaler_output_5 AS DOUBLE) AS scaler_output_5 
FROM tmp_20180602161143_2ot_ads_sca_2_out AS "ADS_sca_2_OUT"), 
...
-- Code For temporary table tmp_20180602161143_kbh_kernagg_agg part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180602161143_kbh_kernagg_agg (
	"KEY" BIGINT, 
...
-- Code For temporary table tmp_20180602161143_kbh_kernagg_agg part 2. Populate

INSERT INTO tmp_20180602161143_kbh_kernagg_agg WITH "KernAgg_Union" AS 
...
FROM tmp_20180602161143_21u_kernagg_b0 AS "KernAgg_B0" UNION ALL SELECT "KernAgg_B1"."KEY" AS "KEY", "KernAgg_B1"."OVO_Class1" AS "OVO_Class1", "KernAgg_B1"."OVO_Class2" AS "OVO_Class2", "KernAgg_B1"."OVO_Decision" AS "OVO_Decision", "KernAgg_B1"."OVO_Conf" AS "OVO_Conf" 
FROM tmp_20180602161143_b7e_kernagg_b1 AS "KernAgg_B1" UNION ALL SELECT "KernAgg_B2"."KEY" AS "KEY", "KernAgg_B2"."OVO_Class1" AS "OVO_Class1", "KernAgg_B2"."OVO_Class2" AS "OVO_Class2", "KernAgg_B2"."OVO_Decision" AS "OVO_Decision", "KernAgg_B2"."OVO_Conf" AS "OVO_Conf" 
FROM tmp_20180602161143_g1m_kernagg_b2 AS "KernAgg_B2") AS "KernAgg_EnsembleUnion"), 
"OVO_Votes" AS 
...
FROM tmp_20180602161143_kbh_kernagg_agg AS "KernAgg_agg"), 
