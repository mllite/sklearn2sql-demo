...
-- Code For temporary table tmp_20180602152926_ae9_rf_b0 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180602152926_ae9_rf_b0  (
	"KEY" BIGINT, 
...
-- Code For temporary table tmp_20180602152926_ae9_rf_b0 part 2. Populate

INSERT INTO tmp_20180602152926_ae9_rf_b0 ("KEY", "Score_0", "Proba_0", "LogProba_0", "Score_1", "Proba_1", "LogProba_1", "Score_2", "Proba_2", "LogProba_2") SELECT "U"."KEY", "U"."Score_0", "U"."Proba_0", "U"."LogProba_0", "U"."Score_1", "U"."Proba_1", "U"."LogProba_1", "U"."Score_2", "U"."Proba_2", "U"."LogProba_2" 
...
-- Code For temporary table tmp_20180602152926_6q7_rf_b1 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180602152926_6q7_rf_b1  (
	"KEY" BIGINT, 
	"Score_0" DOUBLE PRECISION, 
	"Proba_0" DOUBLE PRECISION, 
	"LogProba_0" DOUBLE PRECISION, 
...
-- Code For temporary table tmp_20180602152926_6q7_rf_b1 part 2. Populate

INSERT INTO tmp_20180602152926_6q7_rf_b1 ("KEY", "Score_0", "Proba_0", "LogProba_0", "Score_1", "Proba_1", "LogProba_1", "Score_2", "Proba_2", "LogProba_2") SELECT "U"."KEY", "U"."Score_0", "U"."Proba_0", "U"."LogProba_0", "U"."Score_1", "U"."Proba_1", "U"."LogProba_1", "U"."Score_2", "U"."Proba_2", "U"."LogProba_2" 
...
-- Code For temporary table tmp_20180602152926_p0z_rf_avg part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180602152926_p0z_rf_avg  (
	"KEY" BIGINT, 
	"Score_0" DOUBLE PRECISION, 
	"Proba_0" DOUBLE PRECISION, 
	"LogProba_0" DOUBLE PRECISION, 
...
-- Code For temporary table tmp_20180602152926_p0z_rf_avg part 2. Populate

INSERT INTO tmp_20180602152926_p0z_rf_avg ("KEY", "Score_0", "Proba_0", "LogProba_0", "Score_1", "Proba_1", "LogProba_1", "Score_2", "Proba_2", "LogProba_2") SELECT "U"."KEY", "U"."Score_0", "U"."Proba_0", "U"."LogProba_0", "U"."Score_1", "U"."Proba_1", "U"."LogProba_1", "U"."Score_2", "U"."Proba_2", "U"."LogProba_2" 
...
FROM tmp_20180602152926_p0z_rf_avg AS "RF_avg"), 
