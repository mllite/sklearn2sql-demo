...
-- Code For temporary table tmp_20180602160435_dhk_rf_b0 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180602160435_dhk_rf_b0  (
	"KEY" BIGINT, 
...
-- Code For temporary table tmp_20180602160435_fmb_rf_b1 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180602160435_fmb_rf_b1  (
	"KEY" BIGINT, 
	"Score_CLASS_0" DOUBLE PRECISION, 
	"Proba_CLASS_0" DOUBLE PRECISION, 
	"LogProba_CLASS_0" DOUBLE PRECISION, 
...
-- Code For temporary table tmp_20180602160435_fmb_rf_b1 part 2. Populate

INSERT INTO tmp_20180602160435_fmb_rf_b1 ("KEY", "Score_CLASS_0", "Proba_CLASS_0", "LogProba_CLASS_0", "Score_CLASS_1", "Proba_CLASS_1", "LogProba_CLASS_1", "Score_CLASS_2", "Proba_CLASS_2", "LogProba_CLASS_2") SELECT "U"."KEY", "U"."Score_CLASS_0", "U"."Proba_CLASS_0", "U"."LogProba_CLASS_0", "U"."Score_CLASS_1", "U"."Proba_CLASS_1", "U"."LogProba_CLASS_1", "U"."Score_CLASS_2", "U"."Proba_CLASS_2", "U"."LogProba_CLASS_2" 
...
-- Code For temporary table tmp_20180602160435_mfj_rf_avg part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180602160435_mfj_rf_avg  (
	"KEY" BIGINT, 
	"Score_CLASS_0" DOUBLE PRECISION, 
	"Proba_CLASS_0" DOUBLE PRECISION, 
	"LogProba_CLASS_0" DOUBLE PRECISION, 
...
-- Code For temporary table tmp_20180602160435_mfj_rf_avg part 2. Populate

INSERT INTO tmp_20180602160435_mfj_rf_avg ("KEY", "Score_CLASS_0", "Proba_CLASS_0", "LogProba_CLASS_0", "Score_CLASS_1", "Proba_CLASS_1", "LogProba_CLASS_1", "Score_CLASS_2", "Proba_CLASS_2", "LogProba_CLASS_2") SELECT "U"."KEY", "U"."Score_CLASS_0", "U"."Proba_CLASS_0", "U"."LogProba_CLASS_0", "U"."Score_CLASS_1", "U"."Proba_CLASS_1", "U"."LogProba_CLASS_1", "U"."Score_CLASS_2", "U"."Proba_CLASS_2", "U"."LogProba_CLASS_2" 
...
FROM tmp_20180602160435_mfj_rf_avg AS "RF_avg"), 
