...
-- Code For temporary table TMP_20180602_FWY_RF_B0 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180602_FWY_RF_B0" (
	"KEY" BIGINT, 
...
-- Code For temporary table TMP_20180602_C9P_RF_B1 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180602_C9P_RF_B1" (
	"KEY" BIGINT, 
	"Score_CLASS_0" DOUBLE PRECISION, 
	"Proba_CLASS_0" DOUBLE PRECISION, 
	"LogProba_CLASS_0" DOUBLE PRECISION, 
...
-- Code For temporary table TMP_20180602_C9P_RF_B1 part 2. Populate

INSERT INTO "TMP_20180602_C9P_RF_B1" ("KEY", "Score_CLASS_0", "Proba_CLASS_0", "LogProba_CLASS_0", "Score_CLASS_1", "Proba_CLASS_1", "LogProba_CLASS_1", "Score_CLASS_2", "Proba_CLASS_2", "LogProba_CLASS_2") SELECT "U"."KEY", "U"."Score_CLASS_0", "U"."Proba_CLASS_0", "U"."LogProba_CLASS_0", "U"."Score_CLASS_1", "U"."Proba_CLASS_1", "U"."LogProba_CLASS_1", "U"."Score_CLASS_2", "U"."Proba_CLASS_2", "U"."LogProba_CLASS_2" 
...
-- Code For temporary table TMP_20180602_N2S_RF_B2 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180602_N2S_RF_B2" (
	"KEY" BIGINT, 
	"Score_CLASS_0" DOUBLE PRECISION, 
	"Proba_CLASS_0" DOUBLE PRECISION, 
	"LogProba_CLASS_0" DOUBLE PRECISION, 
...
-- Code For temporary table TMP_20180602_N2S_RF_B2 part 2. Populate

INSERT INTO "TMP_20180602_N2S_RF_B2" ("KEY", "Score_CLASS_0", "Proba_CLASS_0", "LogProba_CLASS_0", "Score_CLASS_1", "Proba_CLASS_1", "LogProba_CLASS_1", "Score_CLASS_2", "Proba_CLASS_2", "LogProba_CLASS_2") SELECT "U"."KEY", "U"."Score_CLASS_0", "U"."Proba_CLASS_0", "U"."LogProba_CLASS_0", "U"."Score_CLASS_1", "U"."Proba_CLASS_1", "U"."LogProba_CLASS_1", "U"."Score_CLASS_2", "U"."Proba_CLASS_2", "U"."LogProba_CLASS_2" 
...
"RF_Model_14" AS 
(SELECT "DT_Output_14"."KEY" AS "KEY", CAST(NULL AS DOUBLE PRECISION) AS "Score_CLASS_0", "DT_Output_14"."P_0.0" AS "Proba_CLASS_0", CASE WHEN ("DT_Output_14"."P_0.0" IS NULL OR "DT_Output_14"."P_0.0" > 0.0) THEN ln("DT_Output_14"."P_0.0") ELSE -1.79769313486231e+308 END AS "LogProba_CLASS_0", CAST(NULL AS DOUBLE PRECISION) AS "Score_CLASS_1", "DT_Output_14"."P_1.0" AS "Proba_CLASS_1", CASE WHEN ("DT_Output_14"."P_1.0" IS NULL OR "DT_Output_14"."P_1.0" > 0.0) THEN ln("DT_Output_14"."P_1.0") ELSE -1.79769313486231e+308 END AS "LogProba_CLASS_1", CAST(NULL AS DOUBLE PRECISION) AS "Score_CLASS_2", "DT_Output_14"."P_2.0" AS "Proba_CLASS_2", CASE WHEN ("DT_Output_14"."P_2.0" IS NULL OR "DT_Output_14"."P_2.0" > 0.0) THEN ln("DT_Output_14"."P_2.0") ELSE -1.79769313486231e+308 END AS "LogProba_CLASS_2" 
FROM "DT_Output_14")
 SELECT "RF_B2"."KEY", "RF_B2"."Score_CLASS_0", "RF_B2"."Proba_CLASS_0", "RF_B2"."LogProba_CLASS_0", "RF_B2"."Score_CLASS_1", "RF_B2"."Proba_CLASS_1", "RF_B2"."LogProba_CLASS_1", "RF_B2"."Score_CLASS_2", "RF_B2"."Proba_CLASS_2", "RF_B2"."LogProba_CLASS_2" 
FROM (SELECT "RF_esu_2"."KEY" AS "KEY", "RF_esu_2"."Score_CLASS_0" AS "Score_CLASS_0", "RF_esu_2"."Proba_CLASS_0" AS "Proba_CLASS_0", "RF_esu_2"."LogProba_CLASS_0" AS "LogProba_CLASS_0", "RF_esu_2"."Score_CLASS_1" AS "Score_CLASS_1", "RF_esu_2"."Proba_CLASS_1" AS "Proba_CLASS_1", "RF_esu_2"."LogProba_CLASS_1" AS "LogProba_CLASS_1", "RF_esu_2"."Score_CLASS_2" AS "Score_CLASS_2", "RF_esu_2"."Proba_CLASS_2" AS "Proba_CLASS_2", "RF_esu_2"."LogProba_CLASS_2" AS "LogProba_CLASS_2" 
...
-- Code For temporary table TMP_20180602_2LT_RF_B3 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180602_2LT_RF_B3" (
	"KEY" BIGINT, 
	"Score_CLASS_0" DOUBLE PRECISION, 
	"Proba_CLASS_0" DOUBLE PRECISION, 
	"LogProba_CLASS_0" DOUBLE PRECISION, 
...
-- Code For temporary table TMP_20180602_2LT_RF_B3 part 2. Populate

INSERT INTO "TMP_20180602_2LT_RF_B3" ("KEY", "Score_CLASS_0", "Proba_CLASS_0", "LogProba_CLASS_0", "Score_CLASS_1", "Proba_CLASS_1", "LogProba_CLASS_1", "Score_CLASS_2", "Proba_CLASS_2", "LogProba_CLASS_2") SELECT "U"."KEY", "U"."Score_CLASS_0", "U"."Proba_CLASS_0", "U"."LogProba_CLASS_0", "U"."Score_CLASS_1", "U"."Proba_CLASS_1", "U"."LogProba_CLASS_1", "U"."Score_CLASS_2", "U"."Proba_CLASS_2", "U"."LogProba_CLASS_2" 
...
"RF_Model_15" AS 
(SELECT "DT_Output_15"."KEY" AS "KEY", CAST(NULL AS DOUBLE PRECISION) AS "Score_CLASS_0", "DT_Output_15"."P_0.0" AS "Proba_CLASS_0", CASE WHEN ("DT_Output_15"."P_0.0" IS NULL OR "DT_Output_15"."P_0.0" > 0.0) THEN ln("DT_Output_15"."P_0.0") ELSE -1.79769313486231e+308 END AS "LogProba_CLASS_0", CAST(NULL AS DOUBLE PRECISION) AS "Score_CLASS_1", "DT_Output_15"."P_1.0" AS "Proba_CLASS_1", CASE WHEN ("DT_Output_15"."P_1.0" IS NULL OR "DT_Output_15"."P_1.0" > 0.0) THEN ln("DT_Output_15"."P_1.0") ELSE -1.79769313486231e+308 END AS "LogProba_CLASS_1", CAST(NULL AS DOUBLE PRECISION) AS "Score_CLASS_2", "DT_Output_15"."P_2.0" AS "Proba_CLASS_2", CASE WHEN ("DT_Output_15"."P_2.0" IS NULL OR "DT_Output_15"."P_2.0" > 0.0) THEN ln("DT_Output_15"."P_2.0") ELSE -1.79769313486231e+308 END AS "LogProba_CLASS_2" 
FROM "DT_Output_15")
 SELECT "RF_B3"."KEY", "RF_B3"."Score_CLASS_0", "RF_B3"."Proba_CLASS_0", "RF_B3"."LogProba_CLASS_0", "RF_B3"."Score_CLASS_1", "RF_B3"."Proba_CLASS_1", "RF_B3"."LogProba_CLASS_1", "RF_B3"."Score_CLASS_2", "RF_B3"."Proba_CLASS_2", "RF_B3"."LogProba_CLASS_2" 
FROM (SELECT "RF_esu_3"."KEY" AS "KEY", "RF_esu_3"."Score_CLASS_0" AS "Score_CLASS_0", "RF_esu_3"."Proba_CLASS_0" AS "Proba_CLASS_0", "RF_esu_3"."LogProba_CLASS_0" AS "LogProba_CLASS_0", "RF_esu_3"."Score_CLASS_1" AS "Score_CLASS_1", "RF_esu_3"."Proba_CLASS_1" AS "Proba_CLASS_1", "RF_esu_3"."LogProba_CLASS_1" AS "LogProba_CLASS_1", "RF_esu_3"."Score_CLASS_2" AS "Score_CLASS_2", "RF_esu_3"."Proba_CLASS_2" AS "Proba_CLASS_2", "RF_esu_3"."LogProba_CLASS_2" AS "LogProba_CLASS_2" 
FROM (SELECT "RF_Model_15"."KEY" AS "KEY", "RF_Model_15"."Score_CLASS_0" AS "Score_CLASS_0", "RF_Model_15"."Proba_CLASS_0" AS "Proba_CLASS_0", "RF_Model_15"."LogProba_CLASS_0" AS "LogProba_CLASS_0", "RF_Model_15"."Score_CLASS_1" AS "Score_CLASS_1", "RF_Model_15"."Proba_CLASS_1" AS "Proba_CLASS_1", "RF_Model_15"."LogProba_CLASS_1" AS "LogProba_CLASS_1", "RF_Model_15"."Score_CLASS_2" AS "Score_CLASS_2", "RF_Model_15"."Proba_CLASS_2" AS "Proba_CLASS_2", "RF_Model_15"."LogProba_CLASS_2" AS "LogProba_CLASS_2" 
FROM "RF_Model_15") AS "RF_esu_3") AS "RF_B3") AS "U"

-- Code For temporary table TMP_20180602_SR9_RF_AVG part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180602_SR9_RF_AVG" (
	"KEY" BIGINT NOT NULL, 
	"Score_CLASS_0" DOUBLE PRECISION, 
	"Proba_CLASS_0" DOUBLE PRECISION, 
	"LogProba_CLASS_0" DOUBLE PRECISION, 
...
-- Code For temporary table TMP_20180602_SR9_RF_AVG part 2. Populate

INSERT INTO "TMP_20180602_SR9_RF_AVG" ("KEY", "Score_CLASS_0", "Proba_CLASS_0", "LogProba_CLASS_0", "Score_CLASS_1", "Proba_CLASS_1", "LogProba_CLASS_1", "Score_CLASS_2", "Proba_CLASS_2", "LogProba_CLASS_2") SELECT "U"."KEY", "U"."Score_CLASS_0", "U"."Proba_CLASS_0", "U"."LogProba_CLASS_0", "U"."Score_CLASS_1", "U"."Proba_CLASS_1", "U"."LogProba_CLASS_1", "U"."Score_CLASS_2", "U"."Proba_CLASS_2", "U"."LogProba_CLASS_2" 
...
FROM "TMP_20180602_FWY_RF_B0" AS "RF_B0" UNION ALL SELECT "RF_B1"."KEY" AS "KEY", "RF_B1"."Score_CLASS_0" AS "Score_CLASS_0", "RF_B1"."Proba_CLASS_0" AS "Proba_CLASS_0", "RF_B1"."LogProba_CLASS_0" AS "LogProba_CLASS_0", "RF_B1"."Score_CLASS_1" AS "Score_CLASS_1", "RF_B1"."Proba_CLASS_1" AS "Proba_CLASS_1", "RF_B1"."LogProba_CLASS_1" AS "LogProba_CLASS_1", "RF_B1"."Score_CLASS_2" AS "Score_CLASS_2", "RF_B1"."Proba_CLASS_2" AS "Proba_CLASS_2", "RF_B1"."LogProba_CLASS_2" AS "LogProba_CLASS_2" 
FROM "TMP_20180602_C9P_RF_B1" AS "RF_B1" UNION ALL SELECT "RF_B2"."KEY" AS "KEY", "RF_B2"."Score_CLASS_0" AS "Score_CLASS_0", "RF_B2"."Proba_CLASS_0" AS "Proba_CLASS_0", "RF_B2"."LogProba_CLASS_0" AS "LogProba_CLASS_0", "RF_B2"."Score_CLASS_1" AS "Score_CLASS_1", "RF_B2"."Proba_CLASS_1" AS "Proba_CLASS_1", "RF_B2"."LogProba_CLASS_1" AS "LogProba_CLASS_1", "RF_B2"."Score_CLASS_2" AS "Score_CLASS_2", "RF_B2"."Proba_CLASS_2" AS "Proba_CLASS_2", "RF_B2"."LogProba_CLASS_2" AS "LogProba_CLASS_2" 
FROM "TMP_20180602_N2S_RF_B2" AS "RF_B2" UNION ALL SELECT "RF_B3"."KEY" AS "KEY", "RF_B3"."Score_CLASS_0" AS "Score_CLASS_0", "RF_B3"."Proba_CLASS_0" AS "Proba_CLASS_0", "RF_B3"."LogProba_CLASS_0" AS "LogProba_CLASS_0", "RF_B3"."Score_CLASS_1" AS "Score_CLASS_1", "RF_B3"."Proba_CLASS_1" AS "Proba_CLASS_1", "RF_B3"."LogProba_CLASS_1" AS "LogProba_CLASS_1", "RF_B3"."Score_CLASS_2" AS "Score_CLASS_2", "RF_B3"."Proba_CLASS_2" AS "Proba_CLASS_2", "RF_B3"."LogProba_CLASS_2" AS "LogProba_CLASS_2" 
FROM "TMP_20180602_2LT_RF_B3" AS "RF_B3") AS "RF_EnsembleUnion")
...
-- Code For temporary table TMP_20180602_SR9_RF_AVG part 3. Create Index 

CREATE INDEX "ix_TMP_20180602_SR9_RF_AVG_KEY" ON "TMP_20180602_SR9_RF_AVG" ("KEY")
...
FROM "TMP_20180602_SR9_RF_AVG" AS "RF_avg"), 
