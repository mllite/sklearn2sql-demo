...
-- Code For temporary table TMP_20180602_C5T_RF_B0 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180602_C5T_RF_B0" (
	"KEY" NUMBER(19), 
...
-- Code For temporary table TMP_20180602_C5T_RF_B0 part 2. Populate

INSERT INTO "TMP_20180602_C5T_RF_B0" ("KEY", "Score_0", "Proba_0", "LogProba_0", "Score_1", "Proba_1", "LogProba_1") SELECT "U"."KEY", "U"."Score_0", "U"."Proba_0", "U"."LogProba_0", "U"."Score_1", "U"."Proba_1", "U"."LogProba_1" 
...
-- Code For temporary table TMP_20180602_U6C_RF_B1 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180602_U6C_RF_B1" (
	"KEY" NUMBER(19), 
	"Score_0" BINARY_DOUBLE, 
	"Proba_0" BINARY_DOUBLE, 
	"LogProba_0" BINARY_DOUBLE, 
...
-- Code For temporary table TMP_20180602_U6C_RF_B1 part 2. Populate

INSERT INTO "TMP_20180602_U6C_RF_B1" ("KEY", "Score_0", "Proba_0", "LogProba_0", "Score_1", "Proba_1", "LogProba_1") SELECT "U"."KEY", "U"."Score_0", "U"."Proba_0", "U"."LogProba_0", "U"."Score_1", "U"."Proba_1", "U"."LogProba_1" 
...
-- Code For temporary table TMP_20180602_A6G_RF_AVG part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180602_A6G_RF_AVG" (
	"KEY" NUMBER(19), 
	"Score_0" BINARY_DOUBLE, 
	"Proba_0" BINARY_DOUBLE, 
	"LogProba_0" BINARY_DOUBLE, 
...
-- Code For temporary table TMP_20180602_A6G_RF_AVG part 2. Populate

INSERT INTO "TMP_20180602_A6G_RF_AVG" ("KEY", "Score_0", "Proba_0", "LogProba_0", "Score_1", "Proba_1", "LogProba_1") SELECT "U"."KEY", "U"."Score_0", "U"."Proba_0", "U"."LogProba_0", "U"."Score_1", "U"."Proba_1", "U"."LogProba_1" 
...
FROM "TMP_20180602_C5T_RF_B0" "RF_B0" UNION ALL SELECT "RF_B1"."KEY" AS "KEY", "RF_B1"."Score_0" AS "Score_0", "RF_B1"."Proba_0" AS "Proba_0", "RF_B1"."LogProba_0" AS "LogProba_0", "RF_B1"."Score_1" AS "Score_1", "RF_B1"."Proba_1" AS "Proba_1", "RF_B1"."LogProba_1" AS "LogProba_1" 
FROM "TMP_20180602_U6C_RF_B1" "RF_B1") "RF_EnsembleUnion")
...
FROM "TMP_20180602_A6G_RF_AVG" "RF_avg"), 
