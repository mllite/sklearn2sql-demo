...
-- Code For temporary table tmp_20180602141356_5un_rf_b0 part 1. Create 

CREATE TEMPORARY TABLE `tmp_20180602141356_5un_rf_b0` STORED AS ORC AS WITH `DT_node_lookup` AS 
...
-- Code For temporary table tmp_20180602141356_5un_rf_b0 part 2. Populate

SELECT * FROM `tmp_20180602141356_5un_rf_b0`

-- Code For temporary table tmp_20180602141356_yqp_rf_b1 part 1. Create 

CREATE TEMPORARY TABLE `tmp_20180602141356_yqp_rf_b1` STORED AS ORC AS WITH `DT_node_lookup_10` AS 
...
-- Code For temporary table tmp_20180602141356_yqp_rf_b1 part 2. Populate

SELECT * FROM `tmp_20180602141356_yqp_rf_b1`

-- Code For temporary table tmp_20180602141356_up5_rf_avg part 1. Create 

CREATE TEMPORARY TABLE `tmp_20180602141356_up5_rf_avg` STORED AS ORC AS WITH `RF_Union` AS 
...
FROM `tmp_20180602141356_5un_rf_b0` AS `RF_B0` UNION ALL SELECT `RF_B1`.`KEY` AS `KEY`, `RF_B1`.`Score_0` AS `Score_0`, `RF_B1`.`Proba_0` AS `Proba_0`, `RF_B1`.`LogProba_0` AS `LogProba_0`, `RF_B1`.`Score_1` AS `Score_1`, `RF_B1`.`Proba_1` AS `Proba_1`, `RF_B1`.`LogProba_1` AS `LogProba_1` 
FROM `tmp_20180602141356_yqp_rf_b1` AS `RF_B1`) AS `RF_EnsembleUnion`)
...
-- Code For temporary table tmp_20180602141356_up5_rf_avg part 2. Populate

SELECT * FROM `tmp_20180602141356_up5_rf_avg`
...
FROM `tmp_20180602141356_up5_rf_avg` AS `RF_avg`), 
