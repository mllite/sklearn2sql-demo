...
-- Code For temporary table TMP_20180602_UIA_ADS_IMP_1_OUT part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180602_UIA_ADS_IMP_1_OUT" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20180602_UIA_ADS_IMP_1_OUT part 2. Populate

INSERT INTO "TMP_20180602_UIA_ADS_IMP_1_OUT" ("KEY", impter_2, impter_3, impter_4, impter_5, impter_6, impter_7, impter_8, impter_9, impter_10, impter_11, impter_12, impter_13, impter_14, impter_15, impter_16, impter_17, impter_18, impter_19, impter_20, impter_21, impter_22, impter_23, impter_24, impter_25, impter_26, impter_27, impter_28, impter_29, impter_30, impter_31) SELECT "U"."KEY", "U".impter_2, "U".impter_3, "U".impter_4, "U".impter_5, "U".impter_6, "U".impter_7, "U".impter_8, "U".impter_9, "U".impter_10, "U".impter_11, "U".impter_12, "U".impter_13, "U".impter_14, "U".impter_15, "U".impter_16, "U".impter_17, "U".impter_18, "U".impter_19, "U".impter_20, "U".impter_21, "U".impter_22, "U".impter_23, "U".impter_24, "U".impter_25, "U".impter_26, "U".impter_27, "U".impter_28, "U".impter_29, "U".impter_30, "U".impter_31 
...
-- Code For temporary table TMP_20180602_UIA_ADS_IMP_1_OUT part 3. Create Index 

CREATE INDEX "ix_TMP_20180602_UIA_ADS_8c8f" ON "TMP_20180602_UIA_ADS_IMP_1_OUT" ("KEY")

-- Code For temporary table TMP_20180602_EIK_ADS_SCA_2_OUT part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180602_EIK_ADS_SCA_2_OUT" (
	"KEY" BIGINT NOT NULL, 
...
FROM "TMP_20180602_UIA_ADS_IMP_1_OUT" AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT") AS "U"

-- Code For temporary table TMP_20180602_EIK_ADS_SCA_2_OUT part 3. Create Index 

CREATE INDEX "ix_TMP_20180602_EIK_ADS_6bc0" ON "TMP_20180602_EIK_ADS_SCA_2_OUT" ("KEY")
...
FROM "TMP_20180602_EIK_ADS_SCA_2_OUT" AS "ADS_sca_2_OUT"), 
linear_model_cte AS 
(SELECT linear_input."KEY" AS "KEY", -0.1802238871279391 * linear_input.scaler_2 + -0.01592586285560738 * linear_input.scaler_3 + -0.10980303965695525 * linear_input.scaler_4 + 0.23962436456941621 * linear_input.scaler_5 + 0.060096767972786756 * linear_input.scaler_6 + 0.3153302561668691 * linear_input.scaler_7 + -0.12290626265535891 * linear_input.scaler_8 + -0.30172946303925763 * linear_input.scaler_9 + -0.0003763097675016977 * linear_input.scaler_10 + -0.009533035008003095 * linear_input.scaler_11 + -0.44449204075196247 * linear_input.scaler_12 + 0.025496172110240488 * linear_input.scaler_13 + 0.043533243841704296 * linear_input.scaler_14 + 0.27531028251332396 * linear_input.scaler_15 + -0.07656164665014682 * linear_input.scaler_16 + 0.0534641394978772 * linear_input.scaler_17 + 0.20245697444071484 * linear_input.scaler_18 + -0.09043681617021362 * linear_input.scaler_19 + -0.015032628365407348 * linear_input.scaler_20 + 0.012768853276290218 * linear_input.scaler_21 + -0.6781742481284683 * linear_input.scaler_22 + -0.0948571454080311 * linear_input.scaler_23 + 0.09738362223070099 * linear_input.scaler_24 + 0.35166347928527525 * linear_input.scaler_25 + -0.053991960817259585 * linear_input.scaler_26 + -0.03775909348742013 * linear_input.scaler_27 + -0.1640456031839313 * linear_input.scaler_28 + -0.09057735540196425 * linear_input.scaler_29 + -0.09486992424373761 * linear_input.scaler_30 + -0.12263241412187273 * linear_input.scaler_31 + 0.29670329670329687 AS lincomb 
FROM linear_input), 
