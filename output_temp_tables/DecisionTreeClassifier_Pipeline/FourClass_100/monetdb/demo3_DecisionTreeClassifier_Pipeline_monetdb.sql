...
-- Code For temporary table tmp_20180602143716_b0h_ads_imp_1_out part 1. Create 


CREATE TEMPORARY TABLE tmp_20180602143716_b0h_ads_imp_1_out (
	"KEY" BIGINT, 
	impter_2 DOUBLE, 
	impter_3 DOUBLE, 
	impter_4 DOUBLE, 
...
-- Code For temporary table tmp_20180602143716_k46_ads_sca_2_out part 1. Create 


CREATE TEMPORARY TABLE tmp_20180602143716_k46_ads_sca_2_out (
	"KEY" BIGINT, 
	scaler_2 DOUBLE, 
	scaler_3 DOUBLE, 
	scaler_4 DOUBLE, 
...
FROM tmp_20180602143716_b0h_ads_imp_1_out AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT") AS "U"
...
FROM tmp_20180602143716_k46_ads_sca_2_out AS "ADS_sca_2_OUT"), 
"DT_node_data" AS 
