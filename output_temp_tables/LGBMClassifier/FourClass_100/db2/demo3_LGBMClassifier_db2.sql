...
-- Code For temporary table tmp_20180602143830_4cd_lgbm_b0 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180602143830_4cd_lgbm_b0 (
	"KEY" BIGINT, 
	"Score_0" DOUBLE, 
	"Score_1" DOUBLE, 
	"Score_2" DOUBLE, 
...
-- Code For temporary table tmp_20180602143830_4cd_lgbm_b0 part 2. Populate

INSERT INTO tmp_20180602143830_4cd_lgbm_b0 WITH "DT_node_lookup" AS 
...
-- Code For temporary table tmp_20180602143830_l3o_lgbm_b1 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180602143830_l3o_lgbm_b1 (
	"KEY" BIGINT, 
	"Score_0" DOUBLE, 
	"Score_1" DOUBLE, 
	"Score_2" DOUBLE, 
...
-- Code For temporary table tmp_20180602143830_l3o_lgbm_b1 part 2. Populate

INSERT INTO tmp_20180602143830_l3o_lgbm_b1 WITH "DT_node_lookup_10" AS 
...
-- Code For temporary table tmp_20180602143830_vs0_lgbm_b2 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180602143830_vs0_lgbm_b2 (
	"KEY" BIGINT, 
	"Score_0" DOUBLE, 
	"Score_1" DOUBLE, 
	"Score_2" DOUBLE, 
...
-- Code For temporary table tmp_20180602143830_vs0_lgbm_b2 part 2. Populate

INSERT INTO tmp_20180602143830_vs0_lgbm_b2 WITH "DT_node_lookup_20" AS 
...
-- Code For temporary table tmp_20180602143830_8gf_lgbm_b3 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180602143830_8gf_lgbm_b3 (
	"KEY" BIGINT, 
	"Score_0" DOUBLE, 
	"Score_1" DOUBLE, 
	"Score_2" DOUBLE, 
...
-- Code For temporary table tmp_20180602143830_8gf_lgbm_b3 part 2. Populate

INSERT INTO tmp_20180602143830_8gf_lgbm_b3 WITH "DT_node_lookup_30" AS 
(SELECT "ADS"."KEY" AS "KEY", CASE WHEN ("ADS"."Feature_56" <= 1.0000000180025095e-35) THEN CASE WHEN ("ADS"."Feature_54" <= 0.06279759359864408) THEN 4 ELSE 5 END ELSE CASE WHEN ("ADS"."Feature_31" <= 0.13931694912793788) THEN 6 ELSE 7 END END AS node_id_2 
FROM "FOURCLASS_100" AS "ADS"), 
"DT_node_data_30" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE) AS "Score" 
...
-- Code For temporary table tmp_20180602143830_fim_lgbm_b4 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180602143830_fim_lgbm_b4 (
	"KEY" BIGINT, 
	"Score_0" DOUBLE, 
	"Score_1" DOUBLE, 
	"Score_2" DOUBLE, 
...
-- Code For temporary table tmp_20180602143830_fim_lgbm_b4 part 2. Populate

INSERT INTO tmp_20180602143830_fim_lgbm_b4 WITH "DT_node_lookup_40" AS 
...
-- Code For temporary table tmp_20180602143830_179_lgbm_b5 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180602143830_179_lgbm_b5 (
	"KEY" BIGINT, 
	"Score_0" DOUBLE, 
	"Score_1" DOUBLE, 
	"Score_2" DOUBLE, 
...
-- Code For temporary table tmp_20180602143830_179_lgbm_b5 part 2. Populate

INSERT INTO tmp_20180602143830_179_lgbm_b5 WITH "DT_node_lookup_50" AS 
(SELECT "ADS"."KEY" AS "KEY", CASE WHEN ("ADS"."Feature_56" <= 1.0000000180025095e-35) THEN CASE WHEN ("ADS"."Feature_54" <= 0.06279759359864408) THEN 4 ELSE 5 END ELSE CASE WHEN ("ADS"."Feature_95" <= 1.0000000180025095e-35) THEN 6 ELSE 7 END END AS node_id_2 
FROM "FOURCLASS_100" AS "ADS"), 
"DT_node_data_50" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE) AS "Score" 
...
-- Code For temporary table tmp_20180602143830_nem_lgbm_b6 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180602143830_nem_lgbm_b6 (
	"KEY" BIGINT, 
	"Score_0" DOUBLE, 
	"Score_1" DOUBLE, 
	"Score_2" DOUBLE, 
...
-- Code For temporary table tmp_20180602143830_nem_lgbm_b6 part 2. Populate

INSERT INTO tmp_20180602143830_nem_lgbm_b6 WITH "DT_node_lookup_60" AS 
(SELECT "ADS"."KEY" AS "KEY", CASE WHEN ("ADS"."Feature_78" <= -0.6945887143399035) THEN CASE WHEN ("ADS"."Feature_64" <= -0.0690557983856105) THEN 4 ELSE 5 END ELSE CASE WHEN ("ADS"."Feature_33" <= -0.20105028919503856) THEN 6 ELSE 7 END END AS node_id_2 
FROM "FOURCLASS_100" AS "ADS"), 
"DT_node_data_60" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE) AS "Score" 
...
-- Code For temporary table tmp_20180602143830_om8_lgbm_sum part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180602143830_om8_lgbm_sum (
	"KEY" BIGINT, 
	"Score_0" DOUBLE, 
	"Score_1" DOUBLE, 
	"Score_2" DOUBLE, 
...
-- Code For temporary table tmp_20180602143830_om8_lgbm_sum part 2. Populate

INSERT INTO tmp_20180602143830_om8_lgbm_sum WITH "LGBM_Union" AS 
...
FROM tmp_20180602143830_4cd_lgbm_b0 AS "LGBM_B0" UNION ALL SELECT "LGBM_B1"."KEY" AS "KEY", "LGBM_B1"."Score_0" AS "Score_0", "LGBM_B1"."Score_1" AS "Score_1", "LGBM_B1"."Score_2" AS "Score_2", "LGBM_B1"."Score_3" AS "Score_3" 
FROM tmp_20180602143830_l3o_lgbm_b1 AS "LGBM_B1" UNION ALL SELECT "LGBM_B2"."KEY" AS "KEY", "LGBM_B2"."Score_0" AS "Score_0", "LGBM_B2"."Score_1" AS "Score_1", "LGBM_B2"."Score_2" AS "Score_2", "LGBM_B2"."Score_3" AS "Score_3" 
FROM tmp_20180602143830_vs0_lgbm_b2 AS "LGBM_B2" UNION ALL SELECT "LGBM_B3"."KEY" AS "KEY", "LGBM_B3"."Score_0" AS "Score_0", "LGBM_B3"."Score_1" AS "Score_1", "LGBM_B3"."Score_2" AS "Score_2", "LGBM_B3"."Score_3" AS "Score_3" 
FROM tmp_20180602143830_8gf_lgbm_b3 AS "LGBM_B3" UNION ALL SELECT "LGBM_B4"."KEY" AS "KEY", "LGBM_B4"."Score_0" AS "Score_0", "LGBM_B4"."Score_1" AS "Score_1", "LGBM_B4"."Score_2" AS "Score_2", "LGBM_B4"."Score_3" AS "Score_3" 
FROM tmp_20180602143830_fim_lgbm_b4 AS "LGBM_B4" UNION ALL SELECT "LGBM_B5"."KEY" AS "KEY", "LGBM_B5"."Score_0" AS "Score_0", "LGBM_B5"."Score_1" AS "Score_1", "LGBM_B5"."Score_2" AS "Score_2", "LGBM_B5"."Score_3" AS "Score_3" 
FROM tmp_20180602143830_179_lgbm_b5 AS "LGBM_B5" UNION ALL SELECT "LGBM_B6"."KEY" AS "KEY", "LGBM_B6"."Score_0" AS "Score_0", "LGBM_B6"."Score_1" AS "Score_1", "LGBM_B6"."Score_2" AS "Score_2", "LGBM_B6"."Score_3" AS "Score_3" 
FROM tmp_20180602143830_nem_lgbm_b6 AS "LGBM_B6") AS "LGBM_EnsembleUnion")
...
FROM tmp_20180602143830_om8_lgbm_sum AS "LGBM_sum"), 
