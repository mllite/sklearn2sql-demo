...
-- Code For temporary table tmp_20180602141906_1o1_lgbm_b0 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180602141906_1o1_lgbm_b0 (
	"KEY" BIGINT, 
	"Score_0" DOUBLE
)
...
-- Code For temporary table tmp_20180602141906_1o1_lgbm_b0 part 2. Populate

INSERT INTO tmp_20180602141906_1o1_lgbm_b0 WITH "DT_node_lookup" AS 
...
-- Code For temporary table tmp_20180602141906_ybq_lgbm_b1 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180602141906_ybq_lgbm_b1 (
	"KEY" BIGINT, 
	"Score_0" DOUBLE
)
...
-- Code For temporary table tmp_20180602141906_ybq_lgbm_b1 part 2. Populate

INSERT INTO tmp_20180602141906_ybq_lgbm_b1 WITH "DT_node_lookup_10" AS 
(SELECT "ADS"."KEY" AS "KEY", CASE WHEN ("ADS"."Feature_57" <= -0.2067798577984605) THEN CASE WHEN ("ADS"."Feature_33" <= 0.20325693874805037) THEN 4 ELSE 5 END ELSE 3 END AS node_id_2 
FROM "BINARYCLASS_100" AS "ADS"), 
"DT_node_data_10" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE) AS "Score" 
...
-- Code For temporary table tmp_20180602141906_zkv_lgbm_sum part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180602141906_zkv_lgbm_sum (
	"KEY" BIGINT, 
	"Score_0" DOUBLE
)
...
-- Code For temporary table tmp_20180602141906_zkv_lgbm_sum part 2. Populate

INSERT INTO tmp_20180602141906_zkv_lgbm_sum WITH "LGBM_Union" AS 
...
FROM tmp_20180602141906_1o1_lgbm_b0 AS "LGBM_B0" UNION ALL SELECT "LGBM_B1"."KEY" AS "KEY", "LGBM_B1"."Score_0" AS "Score_0" 
FROM tmp_20180602141906_ybq_lgbm_b1 AS "LGBM_B1") AS "LGBM_EnsembleUnion")
...
FROM tmp_20180602141906_zkv_lgbm_sum AS "LGBM_sum"), 
