...
-- Code For temporary table tmp_20180602143154_jn9_lgbm_b0 part 1. Create 

CREATE TEMPORARY TABLE `tmp_20180602143154_jn9_lgbm_b0` STORED AS ORC AS WITH `DT_node_lookup` AS 
...
-- Code For temporary table tmp_20180602143154_jn9_lgbm_b0 part 2. Populate

SELECT * FROM `tmp_20180602143154_jn9_lgbm_b0`

-- Code For temporary table tmp_20180602143154_v45_lgbm_b1 part 1. Create 

CREATE TEMPORARY TABLE `tmp_20180602143154_v45_lgbm_b1` STORED AS ORC AS WITH `DT_node_lookup_10` AS 
(SELECT `ADS`.`KEY` AS `KEY`, CASE WHEN (`ADS`.`Feature_3` <= -1.1015614178316115) THEN 2 ELSE CASE WHEN (`ADS`.`Feature_7` <= 1.2680271429278211) THEN 6 ELSE 7 END END AS `node_id_2` 
FROM `FourClass_10` AS `ADS`), 
`DT_node_data_10` AS 
(SELECT `Values`.`nid` AS `nid`, CAST(`Values`.`Score` AS DOUBLE) AS `Score` 
...
-- Code For temporary table tmp_20180602143154_v45_lgbm_b1 part 2. Populate

SELECT * FROM `tmp_20180602143154_v45_lgbm_b1`

-- Code For temporary table tmp_20180602143154_5xq_lgbm_b2 part 1. Create 

CREATE TEMPORARY TABLE `tmp_20180602143154_5xq_lgbm_b2` STORED AS ORC AS WITH `DT_node_lookup_20` AS 
(SELECT `ADS`.`KEY` AS `KEY`, CASE WHEN (`ADS`.`Feature_4` <= -0.42340240049108735) THEN CASE WHEN (`ADS`.`Feature_1` <= 0.9355983576674877) THEN 4 ELSE 5 END ELSE 3 END AS `node_id_2` 
FROM `FourClass_10` AS `ADS`), 
`DT_node_data_20` AS 
(SELECT `Values`.`nid` AS `nid`, CAST(`Values`.`Score` AS DOUBLE) AS `Score` 
...
-- Code For temporary table tmp_20180602143154_5xq_lgbm_b2 part 2. Populate

SELECT * FROM `tmp_20180602143154_5xq_lgbm_b2`

-- Code For temporary table tmp_20180602143154_402_lgbm_b3 part 1. Create 

CREATE TEMPORARY TABLE `tmp_20180602143154_402_lgbm_b3` STORED AS ORC AS WITH `DT_node_lookup_30` AS 
...
-- Code For temporary table tmp_20180602143154_402_lgbm_b3 part 2. Populate

SELECT * FROM `tmp_20180602143154_402_lgbm_b3`

-- Code For temporary table tmp_20180602143154_t6q_lgbm_b4 part 1. Create 

CREATE TEMPORARY TABLE `tmp_20180602143154_t6q_lgbm_b4` STORED AS ORC AS WITH `DT_node_lookup_40` AS 
(SELECT `ADS`.`KEY` AS `KEY`, CASE WHEN (`ADS`.`Feature_3` <= 0.6375722768103697) THEN 2 ELSE CASE WHEN (`ADS`.`Feature_6` <= -0.937933750803626) THEN 6 ELSE 7 END END AS `node_id_2` 
FROM `FourClass_10` AS `ADS`), 
`DT_node_data_40` AS 
(SELECT `Values`.`nid` AS `nid`, CAST(`Values`.`Score` AS DOUBLE) AS `Score` 
...
-- Code For temporary table tmp_20180602143154_t6q_lgbm_b4 part 2. Populate

SELECT * FROM `tmp_20180602143154_t6q_lgbm_b4`

-- Code For temporary table tmp_20180602143154_vhx_lgbm_b5 part 1. Create 

CREATE TEMPORARY TABLE `tmp_20180602143154_vhx_lgbm_b5` STORED AS ORC AS WITH `DT_node_lookup_50` AS 
(SELECT `ADS`.`KEY` AS `KEY`, CASE WHEN (`ADS`.`Feature_2` <= 0.27678436702593656) THEN CASE WHEN (`ADS`.`Feature_5` <= 0.1710269396013543) THEN 4 ELSE 5 END ELSE 3 END AS `node_id_2` 
FROM `FourClass_10` AS `ADS`), 
`DT_node_data_50` AS 
(SELECT `Values`.`nid` AS `nid`, CAST(`Values`.`Score` AS DOUBLE) AS `Score` 
...
-- Code For temporary table tmp_20180602143154_vhx_lgbm_b5 part 2. Populate

SELECT * FROM `tmp_20180602143154_vhx_lgbm_b5`

-- Code For temporary table tmp_20180602143154_ic0_lgbm_b6 part 1. Create 

CREATE TEMPORARY TABLE `tmp_20180602143154_ic0_lgbm_b6` STORED AS ORC AS WITH `DT_node_lookup_60` AS 
(SELECT `ADS`.`KEY` AS `KEY`, CASE WHEN (`ADS`.`Feature_3` <= 1.5742235554144088) THEN CASE WHEN (`ADS`.`Feature_4` <= -0.33088139951140233) THEN 4 ELSE 5 END ELSE 3 END AS `node_id_2` 
FROM `FourClass_10` AS `ADS`), 
`DT_node_data_60` AS 
(SELECT `Values`.`nid` AS `nid`, CAST(`Values`.`Score` AS DOUBLE) AS `Score` 
...
-- Code For temporary table tmp_20180602143154_ic0_lgbm_b6 part 2. Populate

SELECT * FROM `tmp_20180602143154_ic0_lgbm_b6`

-- Code For temporary table tmp_20180602143154_cl1_lgbm_sum part 1. Create 

CREATE TEMPORARY TABLE `tmp_20180602143154_cl1_lgbm_sum` STORED AS ORC AS WITH `LGBM_Union` AS 
...
FROM `tmp_20180602143154_jn9_lgbm_b0` AS `LGBM_B0` UNION ALL SELECT `LGBM_B1`.`KEY` AS `KEY`, `LGBM_B1`.`Score_0` AS `Score_0`, `LGBM_B1`.`Score_1` AS `Score_1`, `LGBM_B1`.`Score_2` AS `Score_2`, `LGBM_B1`.`Score_3` AS `Score_3` 
FROM `tmp_20180602143154_v45_lgbm_b1` AS `LGBM_B1` UNION ALL SELECT `LGBM_B2`.`KEY` AS `KEY`, `LGBM_B2`.`Score_0` AS `Score_0`, `LGBM_B2`.`Score_1` AS `Score_1`, `LGBM_B2`.`Score_2` AS `Score_2`, `LGBM_B2`.`Score_3` AS `Score_3` 
FROM `tmp_20180602143154_5xq_lgbm_b2` AS `LGBM_B2` UNION ALL SELECT `LGBM_B3`.`KEY` AS `KEY`, `LGBM_B3`.`Score_0` AS `Score_0`, `LGBM_B3`.`Score_1` AS `Score_1`, `LGBM_B3`.`Score_2` AS `Score_2`, `LGBM_B3`.`Score_3` AS `Score_3` 
FROM `tmp_20180602143154_402_lgbm_b3` AS `LGBM_B3` UNION ALL SELECT `LGBM_B4`.`KEY` AS `KEY`, `LGBM_B4`.`Score_0` AS `Score_0`, `LGBM_B4`.`Score_1` AS `Score_1`, `LGBM_B4`.`Score_2` AS `Score_2`, `LGBM_B4`.`Score_3` AS `Score_3` 
FROM `tmp_20180602143154_t6q_lgbm_b4` AS `LGBM_B4` UNION ALL SELECT `LGBM_B5`.`KEY` AS `KEY`, `LGBM_B5`.`Score_0` AS `Score_0`, `LGBM_B5`.`Score_1` AS `Score_1`, `LGBM_B5`.`Score_2` AS `Score_2`, `LGBM_B5`.`Score_3` AS `Score_3` 
FROM `tmp_20180602143154_vhx_lgbm_b5` AS `LGBM_B5` UNION ALL SELECT `LGBM_B6`.`KEY` AS `KEY`, `LGBM_B6`.`Score_0` AS `Score_0`, `LGBM_B6`.`Score_1` AS `Score_1`, `LGBM_B6`.`Score_2` AS `Score_2`, `LGBM_B6`.`Score_3` AS `Score_3` 
FROM `tmp_20180602143154_ic0_lgbm_b6` AS `LGBM_B6`) AS `LGBM_EnsembleUnion`)
...
-- Code For temporary table tmp_20180602143154_cl1_lgbm_sum part 2. Populate

SELECT * FROM `tmp_20180602143154_cl1_lgbm_sum`
...
FROM `tmp_20180602143154_cl1_lgbm_sum` AS `LGBM_sum`), 
