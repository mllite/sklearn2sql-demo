...
-- Code For temporary table TMP_20180602143153_8VD_LGBM_B0 part 1. Create 


CREATE TEMPORARY TABLE "TMP_20180602143153_8VD_LGBM_B0" (
	"KEY" BIGINT, 
	"Score_0" FLOAT, 
	"Score_1" FLOAT, 
	"Score_2" FLOAT, 
...
-- Code For temporary table TMP_20180602143153_8VD_LGBM_B0 part 2. Populate
...
FROM "DT_Output_9")
 INSERT INTO "TMP_20180602143153_8VD_LGBM_B0" ("KEY", "Score_0", "Score_1", "Score_2", "Score_3") SELECT "LGBM_B0"."KEY", "LGBM_B0"."Score_0", "LGBM_B0"."Score_1", "LGBM_B0"."Score_2", "LGBM_B0"."Score_3" 
...
-- Code For temporary table TMP_20180602143153_E6R_LGBM_B1 part 1. Create 


CREATE TEMPORARY TABLE "TMP_20180602143153_E6R_LGBM_B1" (
	"KEY" BIGINT, 
	"Score_0" FLOAT, 
	"Score_1" FLOAT, 
	"Score_2" FLOAT, 
...
-- Code For temporary table TMP_20180602143153_E6R_LGBM_B1 part 2. Populate
...
FROM "DT_Output_19")
 INSERT INTO "TMP_20180602143153_E6R_LGBM_B1" ("KEY", "Score_0", "Score_1", "Score_2", "Score_3") SELECT "LGBM_B1"."KEY", "LGBM_B1"."Score_0", "LGBM_B1"."Score_1", "LGBM_B1"."Score_2", "LGBM_B1"."Score_3" 
...
-- Code For temporary table TMP_20180602143153_W3V_LGBM_B2 part 1. Create 


CREATE TEMPORARY TABLE "TMP_20180602143153_W3V_LGBM_B2" (
	"KEY" BIGINT, 
	"Score_0" FLOAT, 
	"Score_1" FLOAT, 
	"Score_2" FLOAT, 
...
-- Code For temporary table TMP_20180602143153_W3V_LGBM_B2 part 2. Populate
...
FROM "DT_Output_29")
 INSERT INTO "TMP_20180602143153_W3V_LGBM_B2" ("KEY", "Score_0", "Score_1", "Score_2", "Score_3") SELECT "LGBM_B2"."KEY", "LGBM_B2"."Score_0", "LGBM_B2"."Score_1", "LGBM_B2"."Score_2", "LGBM_B2"."Score_3" 
...
-- Code For temporary table TMP_20180602143153_1OW_LGBM_B3 part 1. Create 


CREATE TEMPORARY TABLE "TMP_20180602143153_1OW_LGBM_B3" (
	"KEY" BIGINT, 
	"Score_0" FLOAT, 
	"Score_1" FLOAT, 
	"Score_2" FLOAT, 
...
-- Code For temporary table TMP_20180602143153_1OW_LGBM_B3 part 2. Populate
...
FROM "DT_Output_39")
 INSERT INTO "TMP_20180602143153_1OW_LGBM_B3" ("KEY", "Score_0", "Score_1", "Score_2", "Score_3") SELECT "LGBM_B3"."KEY", "LGBM_B3"."Score_0", "LGBM_B3"."Score_1", "LGBM_B3"."Score_2", "LGBM_B3"."Score_3" 
...
-- Code For temporary table TMP_20180602143153_RD9_LGBM_B4 part 1. Create 


CREATE TEMPORARY TABLE "TMP_20180602143153_RD9_LGBM_B4" (
	"KEY" BIGINT, 
	"Score_0" FLOAT, 
	"Score_1" FLOAT, 
	"Score_2" FLOAT, 
...
-- Code For temporary table TMP_20180602143153_RD9_LGBM_B4 part 2. Populate
...
FROM "DT_Output_49")
 INSERT INTO "TMP_20180602143153_RD9_LGBM_B4" ("KEY", "Score_0", "Score_1", "Score_2", "Score_3") SELECT "LGBM_B4"."KEY", "LGBM_B4"."Score_0", "LGBM_B4"."Score_1", "LGBM_B4"."Score_2", "LGBM_B4"."Score_3" 
...
-- Code For temporary table TMP_20180602143153_6QK_LGBM_B5 part 1. Create 


CREATE TEMPORARY TABLE "TMP_20180602143153_6QK_LGBM_B5" (
	"KEY" BIGINT, 
	"Score_0" FLOAT, 
	"Score_1" FLOAT, 
	"Score_2" FLOAT, 
...
-- Code For temporary table TMP_20180602143153_6QK_LGBM_B5 part 2. Populate
...
FROM "DT_Output_59")
 INSERT INTO "TMP_20180602143153_6QK_LGBM_B5" ("KEY", "Score_0", "Score_1", "Score_2", "Score_3") SELECT "LGBM_B5"."KEY", "LGBM_B5"."Score_0", "LGBM_B5"."Score_1", "LGBM_B5"."Score_2", "LGBM_B5"."Score_3" 
...
-- Code For temporary table TMP_20180602143153_FMS_LGBM_B6 part 1. Create 


CREATE TEMPORARY TABLE "TMP_20180602143153_FMS_LGBM_B6" (
	"KEY" BIGINT, 
	"Score_0" FLOAT, 
	"Score_1" FLOAT, 
	"Score_2" FLOAT, 
...
-- Code For temporary table TMP_20180602143153_FMS_LGBM_B6 part 2. Populate
...
FROM "DT_Output_63")
 INSERT INTO "TMP_20180602143153_FMS_LGBM_B6" ("KEY", "Score_0", "Score_1", "Score_2", "Score_3") SELECT "LGBM_B6"."KEY", "LGBM_B6"."Score_0", "LGBM_B6"."Score_1", "LGBM_B6"."Score_2", "LGBM_B6"."Score_3" 
...
-- Code For temporary table TMP_20180602143154_LDD_LGBM_sum part 1. Create 


CREATE TEMPORARY TABLE "TMP_20180602143154_LDD_LGBM_sum" (
	"KEY" BIGINT NOT NULL, 
	"Score_0" FLOAT, 
	"Score_1" FLOAT, 
	"Score_2" FLOAT, 
...
-- Code For temporary table TMP_20180602143154_LDD_LGBM_sum part 2. Populate
...
FROM "TMP_20180602143153_8VD_LGBM_B0" AS "LGBM_B0" UNION ALL SELECT "LGBM_B1"."KEY" AS "KEY", "LGBM_B1"."Score_0" AS "Score_0", "LGBM_B1"."Score_1" AS "Score_1", "LGBM_B1"."Score_2" AS "Score_2", "LGBM_B1"."Score_3" AS "Score_3" 
FROM "TMP_20180602143153_E6R_LGBM_B1" AS "LGBM_B1" UNION ALL SELECT "LGBM_B2"."KEY" AS "KEY", "LGBM_B2"."Score_0" AS "Score_0", "LGBM_B2"."Score_1" AS "Score_1", "LGBM_B2"."Score_2" AS "Score_2", "LGBM_B2"."Score_3" AS "Score_3" 
FROM "TMP_20180602143153_W3V_LGBM_B2" AS "LGBM_B2" UNION ALL SELECT "LGBM_B3"."KEY" AS "KEY", "LGBM_B3"."Score_0" AS "Score_0", "LGBM_B3"."Score_1" AS "Score_1", "LGBM_B3"."Score_2" AS "Score_2", "LGBM_B3"."Score_3" AS "Score_3" 
FROM "TMP_20180602143153_1OW_LGBM_B3" AS "LGBM_B3" UNION ALL SELECT "LGBM_B4"."KEY" AS "KEY", "LGBM_B4"."Score_0" AS "Score_0", "LGBM_B4"."Score_1" AS "Score_1", "LGBM_B4"."Score_2" AS "Score_2", "LGBM_B4"."Score_3" AS "Score_3" 
FROM "TMP_20180602143153_RD9_LGBM_B4" AS "LGBM_B4" UNION ALL SELECT "LGBM_B5"."KEY" AS "KEY", "LGBM_B5"."Score_0" AS "Score_0", "LGBM_B5"."Score_1" AS "Score_1", "LGBM_B5"."Score_2" AS "Score_2", "LGBM_B5"."Score_3" AS "Score_3" 
FROM "TMP_20180602143153_6QK_LGBM_B5" AS "LGBM_B5" UNION ALL SELECT "LGBM_B6"."KEY" AS "KEY", "LGBM_B6"."Score_0" AS "Score_0", "LGBM_B6"."Score_1" AS "Score_1", "LGBM_B6"."Score_2" AS "Score_2", "LGBM_B6"."Score_3" AS "Score_3" 
FROM "TMP_20180602143153_FMS_LGBM_B6" AS "LGBM_B6") AS "LGBM_EnsembleUnion")
 INSERT INTO "TMP_20180602143154_LDD_LGBM_sum" ("KEY", "Score_0", "Score_1", "Score_2", "Score_3") SELECT "LGBM_sum"."KEY", "LGBM_sum"."Score_0", "LGBM_sum"."Score_1", "LGBM_sum"."Score_2", "LGBM_sum"."Score_3" 
...
-- Code For temporary table TMP_20180602143154_LDD_LGBM_sum part 3. Create Index 

CREATE INDEX "ix_TMP_20180602143154_LDD_LGBM_sum_KEY" ON "TMP_20180602143154_LDD_LGBM_sum" ("KEY")
...
FROM "TMP_20180602143154_LDD_LGBM_sum" AS "LGBM_sum"), 
