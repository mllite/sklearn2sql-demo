...
-- Code For temporary table tmp_20180602160343_ne1_lgbm_b0 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180602160343_ne1_lgbm_b0 (
	"KEY" BIGINT, 
...
-- Code For temporary table tmp_20180602160343_ne1_lgbm_b0 part 2. Populate

INSERT INTO tmp_20180602160343_ne1_lgbm_b0 WITH "DT_node_lookup" AS 
...
-- Code For temporary table tmp_20180602160343_7hc_lgbm_b1 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180602160343_7hc_lgbm_b1 (
	"KEY" BIGINT, 
	"Score_CLASS_0" DOUBLE, 
	"Score_CLASS_1" DOUBLE, 
	"Score_CLASS_2" DOUBLE
...
-- Code For temporary table tmp_20180602160343_7hc_lgbm_b1 part 2. Populate

INSERT INTO tmp_20180602160343_7hc_lgbm_b1 WITH "DT_node_lookup_10" AS 
...
-- Code For temporary table tmp_20180602160343_daz_lgbm_b2 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180602160343_daz_lgbm_b2 (
	"KEY" BIGINT, 
	"Score_CLASS_0" DOUBLE, 
	"Score_CLASS_1" DOUBLE, 
	"Score_CLASS_2" DOUBLE
...
-- Code For temporary table tmp_20180602160343_daz_lgbm_b2 part 2. Populate

INSERT INTO tmp_20180602160343_daz_lgbm_b2 WITH "DT_node_lookup_20" AS 
...
-- Code For temporary table tmp_20180602160343_6tp_lgbm_b3 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180602160343_6tp_lgbm_b3 (
	"KEY" BIGINT, 
	"Score_CLASS_0" DOUBLE, 
	"Score_CLASS_1" DOUBLE, 
	"Score_CLASS_2" DOUBLE
...
-- Code For temporary table tmp_20180602160343_6tp_lgbm_b3 part 2. Populate

INSERT INTO tmp_20180602160343_6tp_lgbm_b3 WITH "DT_node_lookup_30" AS 
...
-- Code For temporary table tmp_20180602160343_s0c_lgbm_b4 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180602160343_s0c_lgbm_b4 (
	"KEY" BIGINT, 
	"Score_CLASS_0" DOUBLE, 
	"Score_CLASS_1" DOUBLE, 
	"Score_CLASS_2" DOUBLE
...
-- Code For temporary table tmp_20180602160343_s0c_lgbm_b4 part 2. Populate

INSERT INTO tmp_20180602160343_s0c_lgbm_b4 WITH "DT_node_lookup_40" AS 
...
-- Code For temporary table tmp_20180602160343_omv_lgbm_sum part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180602160343_omv_lgbm_sum (
	"KEY" BIGINT, 
	"Score_CLASS_0" DOUBLE, 
	"Score_CLASS_1" DOUBLE, 
	"Score_CLASS_2" DOUBLE
...
-- Code For temporary table tmp_20180602160343_omv_lgbm_sum part 2. Populate

INSERT INTO tmp_20180602160343_omv_lgbm_sum WITH "LGBM_Union" AS 
...
FROM tmp_20180602160343_ne1_lgbm_b0 AS "LGBM_B0" UNION ALL SELECT "LGBM_B1"."KEY" AS "KEY", "LGBM_B1"."Score_CLASS_0" AS "Score_CLASS_0", "LGBM_B1"."Score_CLASS_1" AS "Score_CLASS_1", "LGBM_B1"."Score_CLASS_2" AS "Score_CLASS_2" 
FROM tmp_20180602160343_7hc_lgbm_b1 AS "LGBM_B1" UNION ALL SELECT "LGBM_B2"."KEY" AS "KEY", "LGBM_B2"."Score_CLASS_0" AS "Score_CLASS_0", "LGBM_B2"."Score_CLASS_1" AS "Score_CLASS_1", "LGBM_B2"."Score_CLASS_2" AS "Score_CLASS_2" 
FROM tmp_20180602160343_daz_lgbm_b2 AS "LGBM_B2" UNION ALL SELECT "LGBM_B3"."KEY" AS "KEY", "LGBM_B3"."Score_CLASS_0" AS "Score_CLASS_0", "LGBM_B3"."Score_CLASS_1" AS "Score_CLASS_1", "LGBM_B3"."Score_CLASS_2" AS "Score_CLASS_2" 
FROM tmp_20180602160343_6tp_lgbm_b3 AS "LGBM_B3" UNION ALL SELECT "LGBM_B4"."KEY" AS "KEY", "LGBM_B4"."Score_CLASS_0" AS "Score_CLASS_0", "LGBM_B4"."Score_CLASS_1" AS "Score_CLASS_1", "LGBM_B4"."Score_CLASS_2" AS "Score_CLASS_2" 
FROM tmp_20180602160343_s0c_lgbm_b4 AS "LGBM_B4") AS "LGBM_EnsembleUnion")
...
FROM tmp_20180602160343_omv_lgbm_sum AS "LGBM_sum"), 
