...
-- Code For temporary table TMP_20180602_COP_ADS_IMP_1_OUT part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180602_COP_ADS_IMP_1_OUT" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20180602_COP_ADS_IMP_1_OUT part 3. Create Index 

CREATE INDEX "ix_TMP_20180602_COP_ADS_5fbd" ON "TMP_20180602_COP_ADS_IMP_1_OUT" ("KEY")

-- Code For temporary table TMP_20180602_MEV_ADS_SCA_2_OUT part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180602_MEV_ADS_SCA_2_OUT" (
	"KEY" BIGINT NOT NULL, 
...
FROM "TMP_20180602_COP_ADS_IMP_1_OUT" AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT") AS "U"

-- Code For temporary table TMP_20180602_MEV_ADS_SCA_2_OUT part 3. Create Index 

CREATE INDEX "ix_TMP_20180602_MEV_ADS_693b" ON "TMP_20180602_MEV_ADS_SCA_2_OUT" ("KEY")

-- Code For temporary table TMP_20180602_YOQ_ADB_B0 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180602_YOQ_ADB_B0" (
	"KEY" BIGINT, 
...
-- Code For temporary table TMP_20180602_YOQ_ADB_B0 part 2. Populate

INSERT INTO "TMP_20180602_YOQ_ADB_B0" ("KEY", "Score_0", "Proba_0", "Score_1", "Proba_1") SELECT "U"."KEY", "U"."Score_0", "U"."Proba_0", "U"."Score_1", "U"."Proba_1" 
...
FROM "TMP_20180602_MEV_ADS_SCA_2_OUT" AS "ADS_sca_2_OUT"), 
"DT_node_data" AS 
...
-- Code For temporary table TMP_20180602_3NP_ADB_B1 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180602_3NP_ADB_B1" (
	"KEY" BIGINT, 
	"Score_0" DOUBLE PRECISION, 
	"Proba_0" DOUBLE PRECISION, 
	"Score_1" DOUBLE PRECISION, 
...
-- Code For temporary table TMP_20180602_3NP_ADB_B1 part 2. Populate

INSERT INTO "TMP_20180602_3NP_ADB_B1" ("KEY", "Score_0", "Proba_0", "Score_1", "Proba_1") SELECT "U"."KEY", "U"."Score_0", "U"."Proba_0", "U"."Score_1", "U"."Proba_1" 
...
-- Code For temporary table TMP_20180602_E6N_ADB_B2 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180602_E6N_ADB_B2" (
	"KEY" BIGINT, 
	"Score_0" DOUBLE PRECISION, 
	"Proba_0" DOUBLE PRECISION, 
	"Score_1" DOUBLE PRECISION, 
...
-- Code For temporary table TMP_20180602_E6N_ADB_B2 part 2. Populate

INSERT INTO "TMP_20180602_E6N_ADB_B2" ("KEY", "Score_0", "Proba_0", "Score_1", "Proba_1") SELECT "U"."KEY", "U"."Score_0", "U"."Proba_0", "U"."Score_1", "U"."Proba_1" 
...
-- Code For temporary table TMP_20180602_T7B_ADB_B3 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180602_T7B_ADB_B3" (
	"KEY" BIGINT, 
	"Score_0" DOUBLE PRECISION, 
	"Proba_0" DOUBLE PRECISION, 
	"Score_1" DOUBLE PRECISION, 
...
-- Code For temporary table TMP_20180602_T7B_ADB_B3 part 2. Populate

INSERT INTO "TMP_20180602_T7B_ADB_B3" ("KEY", "Score_0", "Proba_0", "Score_1", "Proba_1") SELECT "U"."KEY", "U"."Score_0", "U"."Proba_0", "U"."Score_1", "U"."Proba_1" 
...
-- Code For temporary table TMP_20180602_G35_ADB_SUM part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180602_G35_ADB_SUM" (
	"KEY" BIGINT NOT NULL, 
	"Score_0" DOUBLE PRECISION, 
	"Proba_0" DOUBLE PRECISION, 
	"Score_1" DOUBLE PRECISION, 
...
-- Code For temporary table TMP_20180602_G35_ADB_SUM part 2. Populate

INSERT INTO "TMP_20180602_G35_ADB_SUM" ("KEY", "Score_0", "Proba_0", "Score_1", "Proba_1") SELECT "U"."KEY", "U"."Score_0", "U"."Proba_0", "U"."Score_1", "U"."Proba_1" 
...
FROM "TMP_20180602_YOQ_ADB_B0" AS "ADB_B0" UNION ALL SELECT "ADB_B1"."KEY" AS "KEY", "ADB_B1"."Score_0" AS "Score_0", "ADB_B1"."Proba_0" AS "Proba_0", "ADB_B1"."Score_1" AS "Score_1", "ADB_B1"."Proba_1" AS "Proba_1" 
FROM "TMP_20180602_3NP_ADB_B1" AS "ADB_B1" UNION ALL SELECT "ADB_B2"."KEY" AS "KEY", "ADB_B2"."Score_0" AS "Score_0", "ADB_B2"."Proba_0" AS "Proba_0", "ADB_B2"."Score_1" AS "Score_1", "ADB_B2"."Proba_1" AS "Proba_1" 
FROM "TMP_20180602_E6N_ADB_B2" AS "ADB_B2" UNION ALL SELECT "ADB_B3"."KEY" AS "KEY", "ADB_B3"."Score_0" AS "Score_0", "ADB_B3"."Proba_0" AS "Proba_0", "ADB_B3"."Score_1" AS "Score_1", "ADB_B3"."Proba_1" AS "Proba_1" 
FROM "TMP_20180602_T7B_ADB_B3" AS "ADB_B3") AS "ADB_EnsembleUnion")
...
-- Code For temporary table TMP_20180602_G35_ADB_SUM part 3. Create Index 

CREATE INDEX "ix_TMP_20180602_G35_ADB_SUM_KEY" ON "TMP_20180602_G35_ADB_SUM" ("KEY")
...
FROM "TMP_20180602_G35_ADB_SUM" AS "ADB_sum"), 
