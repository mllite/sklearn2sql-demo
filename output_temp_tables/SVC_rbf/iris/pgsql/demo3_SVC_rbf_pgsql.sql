...
-- Code For temporary table TMP_20180602153022_EYL_KernAgg_B0 part 1. Create 


CREATE TEMPORARY TABLE "TMP_20180602153022_EYL_KernAgg_B0" (
	"KEY" BIGINT, 
	"OVO_Class1" BIGINT, 
	"OVO_Class2" BIGINT, 
	"OVO_Decision" BIGINT, 
...
-- Code For temporary table TMP_20180602153022_EYL_KernAgg_B0 part 2. Populate
...
FROM kernel_dp_0_1)
 INSERT INTO "TMP_20180602153022_EYL_KernAgg_B0" ("KEY", "OVO_Class1", "OVO_Class2", "OVO_Decision", "OVO_Conf") SELECT "KernAgg_B0"."KEY", "KernAgg_B0"."OVO_Class1", "KernAgg_B0"."OVO_Class2", "KernAgg_B0"."OVO_Decision", "KernAgg_B0"."OVO_Conf" 
...
-- Code For temporary table TMP_20180602153022_GHW_KernAgg_B1 part 1. Create 


CREATE TEMPORARY TABLE "TMP_20180602153022_GHW_KernAgg_B1" (
	"KEY" BIGINT, 
	"OVO_Class1" BIGINT, 
	"OVO_Class2" BIGINT, 
	"OVO_Decision" BIGINT, 
...
-- Code For temporary table TMP_20180602153022_GHW_KernAgg_B1 part 2. Populate
...
FROM kernel_dp_0_2)
 INSERT INTO "TMP_20180602153022_GHW_KernAgg_B1" ("KEY", "OVO_Class1", "OVO_Class2", "OVO_Decision", "OVO_Conf") SELECT "KernAgg_B1"."KEY", "KernAgg_B1"."OVO_Class1", "KernAgg_B1"."OVO_Class2", "KernAgg_B1"."OVO_Decision", "KernAgg_B1"."OVO_Conf" 
...
-- Code For temporary table TMP_20180602153022_5Q9_KernAgg_B2 part 1. Create 


CREATE TEMPORARY TABLE "TMP_20180602153022_5Q9_KernAgg_B2" (
	"KEY" BIGINT, 
	"OVO_Class1" BIGINT, 
	"OVO_Class2" BIGINT, 
	"OVO_Decision" BIGINT, 
...
-- Code For temporary table TMP_20180602153022_5Q9_KernAgg_B2 part 2. Populate
...
FROM kernel_dp_1_2)
 INSERT INTO "TMP_20180602153022_5Q9_KernAgg_B2" ("KEY", "OVO_Class1", "OVO_Class2", "OVO_Decision", "OVO_Conf") SELECT "KernAgg_B2"."KEY", "KernAgg_B2"."OVO_Class1", "KernAgg_B2"."OVO_Class2", "KernAgg_B2"."OVO_Decision", "KernAgg_B2"."OVO_Conf" 
...
-- Code For temporary table TMP_20180602153022_RU0_KernAgg_agg part 1. Create 


CREATE TEMPORARY TABLE "TMP_20180602153022_RU0_KernAgg_agg" (
	"KEY" BIGINT NOT NULL, 
	"OVO_Vote_0" BIGINT, 
...
-- Code For temporary table TMP_20180602153022_RU0_KernAgg_agg part 2. Populate
...
FROM "TMP_20180602153022_EYL_KernAgg_B0" AS "KernAgg_B0" UNION ALL SELECT "KernAgg_B1"."KEY" AS "KEY", "KernAgg_B1"."OVO_Class1" AS "OVO_Class1", "KernAgg_B1"."OVO_Class2" AS "OVO_Class2", "KernAgg_B1"."OVO_Decision" AS "OVO_Decision", "KernAgg_B1"."OVO_Conf" AS "OVO_Conf" 
FROM "TMP_20180602153022_GHW_KernAgg_B1" AS "KernAgg_B1" UNION ALL SELECT "KernAgg_B2"."KEY" AS "KEY", "KernAgg_B2"."OVO_Class1" AS "OVO_Class1", "KernAgg_B2"."OVO_Class2" AS "OVO_Class2", "KernAgg_B2"."OVO_Decision" AS "OVO_Decision", "KernAgg_B2"."OVO_Conf" AS "OVO_Conf" 
FROM "TMP_20180602153022_5Q9_KernAgg_B2" AS "KernAgg_B2") AS "KernAgg_EnsembleUnion"), 
"OVO_Votes" AS 
...
-- Code For temporary table TMP_20180602153022_RU0_KernAgg_agg part 3. Create Index 

CREATE INDEX "ix_TMP_20180602153022_RU0_KernAgg_agg_KEY" ON "TMP_20180602153022_RU0_KernAgg_agg" ("KEY")
...
FROM "TMP_20180602153022_RU0_KernAgg_agg" AS "KernAgg_agg"), 
