...
-- Code For temporary table tmp_20180602141653_jvz_calprob_b0 part 1. Create 


CREATE TEMPORARY TABLE tmp_20180602141653_jvz_calprob_b0 (
	"KEY" BIGINT, 
	"Proba_1" DOUBLE, 
	"Proba_0" DOUBLE
)
...
-- Code For temporary table tmp_20180602141653_jvz_calprob_b0 part 2. Populate

INSERT INTO tmp_20180602141653_jvz_calprob_b0 ("KEY", "Proba_1", "Proba_0") SELECT "U"."KEY", "U"."Proba_1", "U"."Proba_0" 
...
-- Code For temporary table tmp_20180602141653_4kf_calprob_avg part 1. Create 


CREATE TEMPORARY TABLE tmp_20180602141653_4kf_calprob_avg (
	"KEY" BIGINT, 
	"Proba_1" DOUBLE, 
	"Proba_0" DOUBLE
)
...
-- Code For temporary table tmp_20180602141653_4kf_calprob_avg part 2. Populate

INSERT INTO tmp_20180602141653_4kf_calprob_avg ("KEY", "Proba_1", "Proba_0") SELECT "U"."KEY", "U"."Proba_1", "U"."Proba_0" 
...
FROM tmp_20180602141653_jvz_calprob_b0 AS "CalProb_B0") AS "CalProb_EnsembleUnion")
...
FROM tmp_20180602141653_4kf_calprob_avg AS "CalProb_avg"), 
