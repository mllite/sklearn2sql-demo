...
-- Code For temporary table ##TMP_20180602141103_KGX_CalProb_B0 part 1. Create 


CREATE TABLE ##TMP_20180602141103_KGX_CalProb_B0 (
	[KEY] BIGINT NULL, 
	[Proba_1] FLOAT NULL, 
	[Proba_0] FLOAT NULL
)
...
-- Code For temporary table ##TMP_20180602141103_KGX_CalProb_B0 part 2. Populate
...
FROM sigmoid_calibration_3)
 INSERT INTO ##TMP_20180602141103_KGX_CalProb_B0 ([KEY], [Proba_1], [Proba_0]) SELECT [CalProb_B0].[KEY], [CalProb_B0].[Proba_1], [CalProb_B0].[Proba_0] 
...
-- Code For temporary table ##TMP_20180602141103_EKU_CalProb_avg part 1. Create 


CREATE TABLE ##TMP_20180602141103_EKU_CalProb_avg (
	[KEY] BIGINT NULL, 
...
-- Code For temporary table ##TMP_20180602141103_EKU_CalProb_avg part 2. Populate
...
FROM ##TMP_20180602141103_KGX_CalProb_B0 AS [CalProb_B0]) AS [CalProb_EnsembleUnion])
 INSERT INTO ##TMP_20180602141103_EKU_CalProb_avg ([KEY], [Proba_1], [Proba_0]) SELECT [CalProb_avg].[KEY], [CalProb_avg].[Proba_1], [CalProb_avg].[Proba_0] 
...
FROM ##TMP_20180602141103_EKU_CalProb_avg AS [CalProb_avg]), 
