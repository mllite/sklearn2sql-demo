...
-- Code For temporary table tmp_20180602160133_owf_calprob_b0 part 1. Create 


CREATE TEMPORARY TABLE tmp_20180602160133_owf_calprob_b0 (
	"KEY" BIGINT, 
...
-- Code For temporary table tmp_20180602160133_owf_calprob_b0 part 2. Populate

INSERT INTO tmp_20180602160133_owf_calprob_b0 ("KEY", "Proba_CLASS_0", "Proba_CLASS_1", "Proba_CLASS_2") SELECT "U"."KEY", "U"."Proba_CLASS_0", "U"."Proba_CLASS_1", "U"."Proba_CLASS_2" 
...
-- Code For temporary table tmp_20180602160133_omn_calprob_avg part 1. Create 


CREATE TEMPORARY TABLE tmp_20180602160133_omn_calprob_avg (
	"KEY" BIGINT, 
	"Proba_CLASS_0" DOUBLE, 
	"Proba_CLASS_1" DOUBLE, 
	"Proba_CLASS_2" DOUBLE
...
-- Code For temporary table tmp_20180602160133_omn_calprob_avg part 2. Populate

INSERT INTO tmp_20180602160133_omn_calprob_avg ("KEY", "Proba_CLASS_0", "Proba_CLASS_1", "Proba_CLASS_2") SELECT "U"."KEY", "U"."Proba_CLASS_0", "U"."Proba_CLASS_1", "U"."Proba_CLASS_2" 
...
FROM tmp_20180602160133_owf_calprob_b0 AS "CalProb_B0") AS "CalProb_EnsembleUnion")
...
FROM tmp_20180602160133_omn_calprob_avg AS "CalProb_avg"), 
