...
-- Code For temporary table tmp_20180602160134_j6e_calprob_b0 part 1. Create 

CREATE TEMPORARY TABLE `tmp_20180602160134_j6e_calprob_b0` STORED AS ORC AS WITH `DT_node_lookup` AS 
...
-- Code For temporary table tmp_20180602160134_j6e_calprob_b0 part 2. Populate

SELECT * FROM `tmp_20180602160134_j6e_calprob_b0`

-- Code For temporary table tmp_20180602160134_bfm_calprob_avg part 1. Create 

CREATE TEMPORARY TABLE `tmp_20180602160134_bfm_calprob_avg` STORED AS ORC AS WITH `CalProb_Union` AS 
...
FROM `tmp_20180602160134_j6e_calprob_b0` AS `CalProb_B0`) AS `CalProb_EnsembleUnion`)
...
-- Code For temporary table tmp_20180602160134_bfm_calprob_avg part 2. Populate

SELECT * FROM `tmp_20180602160134_bfm_calprob_avg`
...
FROM `tmp_20180602160134_bfm_calprob_avg` AS `CalProb_avg`), 
