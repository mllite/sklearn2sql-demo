...
-- Code For temporary table TMP_20180602_8ID_CALPROB_B0 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180602_8ID_CALPROB_B0" (
	"KEY" BIGINT, 
...
-- Code For temporary table TMP_20180602_8ID_CALPROB_B0 part 2. Populate

INSERT INTO "TMP_20180602_8ID_CALPROB_B0" ("KEY", "Proba_0", "Proba_1", "Proba_2") SELECT "U"."KEY", "U"."Proba_0", "U"."Proba_1", "U"."Proba_2" 
...
-- Code For temporary table TMP_20180602_2Y3_CALPROB_AVG part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180602_2Y3_CALPROB_AVG" (
	"KEY" BIGINT NOT NULL, 
	"Proba_0" DOUBLE PRECISION, 
	"Proba_1" DOUBLE PRECISION, 
	"Proba_2" DOUBLE PRECISION, 
...
-- Code For temporary table TMP_20180602_2Y3_CALPROB_AVG part 2. Populate

INSERT INTO "TMP_20180602_2Y3_CALPROB_AVG" ("KEY", "Proba_0", "Proba_1", "Proba_2") SELECT "U"."KEY", "U"."Proba_0", "U"."Proba_1", "U"."Proba_2" 
...
FROM "TMP_20180602_8ID_CALPROB_B0" AS "CalProb_B0") AS "CalProb_EnsembleUnion")
...
-- Code For temporary table TMP_20180602_2Y3_CALPROB_AVG part 3. Create Index 

CREATE INDEX "ix_TMP_20180602_2Y3_CAL_8c79" ON "TMP_20180602_2Y3_CALPROB_AVG" ("KEY")
...
FROM "TMP_20180602_2Y3_CALPROB_AVG" AS "CalProb_avg"), 
