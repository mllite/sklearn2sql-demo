...
-- Code For temporary table TMP_20180602_6PR_CALPROB_B0 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180602_6PR_CALPROB_B0" (
	"KEY" BIGINT, 
...
-- Code For temporary table TMP_20180602_6PR_CALPROB_B0 part 2. Populate

INSERT INTO "TMP_20180602_6PR_CALPROB_B0" ("KEY", "Proba_1", "Proba_0") SELECT "U"."KEY", "U"."Proba_1", "U"."Proba_0" 
...
-- Code For temporary table TMP_20180602_TNK_CALPROB_AVG part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180602_TNK_CALPROB_AVG" (
	"KEY" BIGINT NOT NULL, 
	"Proba_1" DOUBLE PRECISION, 
	"Proba_0" DOUBLE PRECISION, 
	PRIMARY KEY ("KEY")
...
-- Code For temporary table TMP_20180602_TNK_CALPROB_AVG part 2. Populate

INSERT INTO "TMP_20180602_TNK_CALPROB_AVG" ("KEY", "Proba_1", "Proba_0") SELECT "U"."KEY", "U"."Proba_1", "U"."Proba_0" 
...
FROM "TMP_20180602_6PR_CALPROB_B0" AS "CalProb_B0") AS "CalProb_EnsembleUnion")
...
-- Code For temporary table TMP_20180602_TNK_CALPROB_AVG part 3. Create Index 

CREATE INDEX "ix_TMP_20180602_TNK_CAL_8d6e" ON "TMP_20180602_TNK_CALPROB_AVG" ("KEY")
...
FROM "TMP_20180602_TNK_CALPROB_AVG" AS "CalProb_avg"), 
