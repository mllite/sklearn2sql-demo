...
-- Code For temporary table tmp_20180602152114_ly1_bag_b0 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180602152114_ly1_bag_b0 (
	"KEY" BIGINT, 
	"Estimator" DOUBLE
)
...
-- Code For temporary table tmp_20180602152114_ly1_bag_b0 part 2. Populate

INSERT INTO tmp_20180602152114_ly1_bag_b0 WITH "DT_node_lookup" AS 
...
-- Code For temporary table tmp_20180602152114_vxn_bag_b1 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180602152114_vxn_bag_b1 (
	"KEY" BIGINT, 
	"Estimator" DOUBLE
)
...
-- Code For temporary table tmp_20180602152114_vxn_bag_b1 part 2. Populate

INSERT INTO tmp_20180602152114_vxn_bag_b1 WITH "DT_node_lookup_10" AS 
...
-- Code For temporary table tmp_20180602152114_8cj_bag_avg part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180602152114_8cj_bag_avg (
	"KEY" BIGINT, 
	"Estimator" DOUBLE
)
...
-- Code For temporary table tmp_20180602152114_8cj_bag_avg part 2. Populate

INSERT INTO tmp_20180602152114_8cj_bag_avg WITH "BAG_Union" AS 
...
FROM tmp_20180602152114_ly1_bag_b0 AS "BAG_B0" UNION ALL SELECT "BAG_B1"."KEY" AS "KEY", "BAG_B1"."Estimator" AS "Estimator" 
FROM tmp_20180602152114_vxn_bag_b1 AS "BAG_B1") AS "BAG_EnsembleUnion")
...
FROM tmp_20180602152114_8cj_bag_avg AS "BAG_avg"