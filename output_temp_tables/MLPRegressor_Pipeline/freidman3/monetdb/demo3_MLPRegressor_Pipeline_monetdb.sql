...
-- Code For temporary table tmp_20180602152306_9zs_ads_imp_1_out part 1. Create 


CREATE TEMPORARY TABLE tmp_20180602152306_9zs_ads_imp_1_out (
	"KEY" BIGINT, 
...
-- Code For temporary table tmp_20180602152306_9zs_ads_imp_1_out part 2. Populate

INSERT INTO tmp_20180602152306_9zs_ads_imp_1_out ("KEY", imputer_output_2, imputer_output_3, imputer_output_4, imputer_output_5) SELECT "U"."KEY", "U".imputer_output_2, "U".imputer_output_3, "U".imputer_output_4, "U".imputer_output_5 
...
-- Code For temporary table tmp_20180602152306_ebs_ads_sca_2_out part 1. Create 


CREATE TEMPORARY TABLE tmp_20180602152306_ebs_ads_sca_2_out (
	"KEY" BIGINT, 
...
-- Code For temporary table tmp_20180602152306_ebs_ads_sca_2_out part 2. Populate

INSERT INTO tmp_20180602152306_ebs_ads_sca_2_out ("KEY", scaler_output_2, scaler_output_3, scaler_output_4, scaler_output_5) SELECT "U"."KEY", "U".scaler_output_2, "U".scaler_output_3, "U".scaler_output_4, "U".scaler_output_5 
...
FROM tmp_20180602152306_9zs_ads_imp_1_out AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT") AS "U"

-- Code For temporary table tmp_20180602152306_ufg_hl_1_relu_1 part 1. Create 


CREATE TEMPORARY TABLE tmp_20180602152306_ufg_hl_1_relu_1 (
	"KEY" BIGINT, 
	"NEUR_1_1" DOUBLE, 
	"NEUR_1_2" DOUBLE, 
	"NEUR_1_3" DOUBLE
...
-- Code For temporary table tmp_20180602152306_ufg_hl_1_relu_1 part 2. Populate

INSERT INTO tmp_20180602152306_ufg_hl_1_relu_1 ("KEY", "NEUR_1_1", "NEUR_1_2", "NEUR_1_3") SELECT "U"."KEY", "U"."NEUR_1_1", "U"."NEUR_1_2", "U"."NEUR_1_3" 
FROM (WITH "IL" AS 
...
FROM tmp_20180602152306_ebs_ads_sca_2_out AS "ADS_sca_2_OUT"), 
"HL_BA_1" AS 
...
-- Code For temporary table tmp_20180602152306_snx_ol_identity_1 part 1. Create 


CREATE TEMPORARY TABLE tmp_20180602152306_snx_ol_identity_1 (
	"KEY" BIGINT, 
	"NEUR_3_1" DOUBLE
)
...
-- Code For temporary table tmp_20180602152306_snx_ol_identity_1 part 2. Populate

INSERT INTO tmp_20180602152306_snx_ol_identity_1 ("KEY", "NEUR_3_1") SELECT "U"."KEY", "U"."NEUR_3_1" 
...
FROM tmp_20180602152306_ufg_hl_1_relu_1 AS "HL_1_relu_1"), 
"HL_2_relu" AS 
...
FROM tmp_20180602152306_snx_ol_identity_1 AS "OL_identity_1"