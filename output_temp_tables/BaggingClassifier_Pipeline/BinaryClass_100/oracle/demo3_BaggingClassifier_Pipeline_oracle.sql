...
-- Code For temporary table 20180602_GSB_ADS_IMP_1_OUT part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "20180602_GSB_ADS_IMP_1_OUT" (
	"KEY" NUMBER(19), 
...
-- Code For temporary table 20180602_LPI_ADS_SCA_2_OUT part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "20180602_LPI_ADS_SCA_2_OUT" (
	"KEY" NUMBER(19), 
...
FROM "20180602_GSB_ADS_IMP_1_OUT" "ADS_imp_1_OUT") "ADS_sca_2_OUT") "U"

-- Code For temporary table TMP_20180602_R2U_BAG_B0 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180602_R2U_BAG_B0" (
	"KEY" NUMBER(19), 
...
-- Code For temporary table TMP_20180602_R2U_BAG_B0 part 2. Populate

INSERT INTO "TMP_20180602_R2U_BAG_B0" ("KEY", "Score_0", "Proba_0", "LogProba_0", "Score_1", "Proba_1", "LogProba_1") SELECT "U"."KEY", "U"."Score_0", "U"."Proba_0", "U"."LogProba_0", "U"."Score_1", "U"."Proba_1", "U"."LogProba_1" 
...
FROM "20180602_LPI_ADS_SCA_2_OUT" "ADS_sca_2_OUT"), 
"DT_node_data" AS 
...
-- Code For temporary table TMP_20180602_19Z_BAG_B1 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180602_19Z_BAG_B1" (
	"KEY" NUMBER(19), 
	"Score_0" BINARY_DOUBLE, 
	"Proba_0" BINARY_DOUBLE, 
	"LogProba_0" BINARY_DOUBLE, 
...
-- Code For temporary table TMP_20180602_19Z_BAG_B1 part 2. Populate

INSERT INTO "TMP_20180602_19Z_BAG_B1" ("KEY", "Score_0", "Proba_0", "LogProba_0", "Score_1", "Proba_1", "LogProba_1") SELECT "U"."KEY", "U"."Score_0", "U"."Proba_0", "U"."LogProba_0", "U"."Score_1", "U"."Proba_1", "U"."LogProba_1" 
...
-- Code For temporary table TMP_20180602_HQ1_BAG_AVG part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180602_HQ1_BAG_AVG" (
	"KEY" NUMBER(19), 
	"Score_0" BINARY_DOUBLE, 
	"Proba_0" BINARY_DOUBLE, 
	"LogProba_0" BINARY_DOUBLE, 
...
-- Code For temporary table TMP_20180602_HQ1_BAG_AVG part 2. Populate

INSERT INTO "TMP_20180602_HQ1_BAG_AVG" ("KEY", "Score_0", "Proba_0", "LogProba_0", "Score_1", "Proba_1", "LogProba_1") SELECT "U"."KEY", "U"."Score_0", "U"."Proba_0", "U"."LogProba_0", "U"."Score_1", "U"."Proba_1", "U"."LogProba_1" 
...
FROM "TMP_20180602_R2U_BAG_B0" "BAG_B0" UNION ALL SELECT "BAG_B1"."KEY" AS "KEY", "BAG_B1"."Score_0" AS "Score_0", "BAG_B1"."Proba_0" AS "Proba_0", "BAG_B1"."LogProba_0" AS "LogProba_0", "BAG_B1"."Score_1" AS "Score_1", "BAG_B1"."Proba_1" AS "Proba_1", "BAG_B1"."LogProba_1" AS "LogProba_1" 
FROM "TMP_20180602_19Z_BAG_B1" "BAG_B1") "BAG_EnsembleUnion")
...
FROM "TMP_20180602_HQ1_BAG_AVG" "BAG_avg"), 
