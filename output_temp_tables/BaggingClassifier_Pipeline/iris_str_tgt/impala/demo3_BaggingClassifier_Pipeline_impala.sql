...
-- Code For temporary table tmp_20180602160124_a6g_ads_imp_1_out part 1. Create 


CREATE TABLE tmp_20180602160124_a6g_ads_imp_1_out (
	`KEY` BIGINT, 
...
-- Code For temporary table tmp_20180602160124_a6g_ads_imp_1_out part 2. Populate

INSERT INTO tmp_20180602160124_a6g_ads_imp_1_out (`KEY`, imputer_output_2, imputer_output_3, imputer_output_4, imputer_output_5) SELECT `ADS_imp_1_OUT`.`KEY`, `ADS_imp_1_OUT`.imputer_output_2, `ADS_imp_1_OUT`.imputer_output_3, `ADS_imp_1_OUT`.imputer_output_4, `ADS_imp_1_OUT`.imputer_output_5 
...
-- Code For temporary table tmp_20180602160124_mlt_ads_sca_2_out part 1. Create 


CREATE TABLE tmp_20180602160124_mlt_ads_sca_2_out (
	`KEY` BIGINT, 
...
-- Code For temporary table tmp_20180602160124_mlt_ads_sca_2_out part 2. Populate

INSERT INTO tmp_20180602160124_mlt_ads_sca_2_out (`KEY`, scaler_output_2, scaler_output_3, scaler_output_4, scaler_output_5) SELECT `ADS_sca_2_OUT`.`KEY`, `ADS_sca_2_OUT`.scaler_output_2, `ADS_sca_2_OUT`.scaler_output_3, `ADS_sca_2_OUT`.scaler_output_4, `ADS_sca_2_OUT`.scaler_output_5 
...
FROM tmp_20180602160124_a6g_ads_imp_1_out AS `ADS_imp_1_OUT`) AS `ADS_sca_2_OUT`

-- Code For temporary table tmp_20180602160124_wz1_bag_b0 part 1. Create 


CREATE TABLE tmp_20180602160124_wz1_bag_b0 (
	`KEY` BIGINT, 
...
-- Code For temporary table tmp_20180602160124_wz1_bag_b0 part 2. Populate
...
FROM tmp_20180602160124_mlt_ads_sca_2_out AS `ADS_sca_2_OUT`), 
`DT_node_data` AS 
...
-- Code For temporary table tmp_20180602160124_eae_bag_b1 part 1. Create 


CREATE TABLE tmp_20180602160124_eae_bag_b1 (
	`KEY` BIGINT, 
	`Score_CLASS_0` DOUBLE, 
	`Proba_CLASS_0` DOUBLE, 
	`LogProba_CLASS_0` DOUBLE, 
...
-- Code For temporary table tmp_20180602160124_eae_bag_b1 part 2. Populate
...
-- Code For temporary table tmp_20180602160124_aem_bag_avg part 1. Create 


CREATE TABLE tmp_20180602160124_aem_bag_avg (
	`KEY` BIGINT, 
	`Score_CLASS_0` DOUBLE, 
	`Proba_CLASS_0` DOUBLE, 
	`LogProba_CLASS_0` DOUBLE, 
...
-- Code For temporary table tmp_20180602160124_aem_bag_avg part 2. Populate
...
FROM tmp_20180602160124_aem_bag_avg AS `BAG_avg`), 
