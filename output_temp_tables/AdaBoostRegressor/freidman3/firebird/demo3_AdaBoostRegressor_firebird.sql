...
-- Code For temporary table TMP_20180602_9O4_QUANTILES part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180602_9O4_QUANTILES" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20180602_9O4_QUANTILES part 2. Populate

INSERT INTO "TMP_20180602_9O4_QUANTILES" ("KEY", "Quantile") SELECT "U"."KEY", "U"."Quantile" 
...
-- Code For temporary table TMP_20180602_9O4_QUANTILES part 3. Create Index 

CREATE INDEX "ix_TMP_20180602_9O4_QUA_fd85" ON "TMP_20180602_9O4_QUANTILES" ("KEY")

-- Model deployment code

SELECT "Quantiles"."KEY" AS "KEY", "Quantiles"."Quantile" AS "Estimator" 
FROM "TMP_20180602_9O4_QUANTILES" AS "Quantiles"