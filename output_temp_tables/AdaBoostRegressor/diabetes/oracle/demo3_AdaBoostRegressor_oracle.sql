...
-- Code For temporary table TMP_20180602_F8E_QUANTILES part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180602_F8E_QUANTILES" (
	"KEY" NUMBER(19), 
...
-- Code For temporary table TMP_20180602_F8E_QUANTILES part 2. Populate

INSERT INTO "TMP_20180602_F8E_QUANTILES" ("KEY", "Quantile") SELECT "U"."KEY", "U"."Quantile" 
...
"DT_node_data_6" AS 
(SELECT "Values".nid AS nid, CAST("Values"."E" AS BINARY_DOUBLE) AS "E" 
FROM (SELECT 3 AS nid, 124.71111111111111 AS "E" FROM DUAL UNION ALL SELECT 4 AS nid, 78.91489361702128 AS "E" FROM DUAL UNION ALL SELECT 6 AS nid, 230.82142857142858 AS "E" FROM DUAL UNION ALL SELECT 7 AS nid, 120.27272727272727 AS "E" FROM DUAL UNION ALL SELECT 10 AS nid, 173.36111111111111 AS "E" FROM DUAL UNION ALL SELECT 11 AS nid, 346.0 AS "E" FROM DUAL UNION ALL SELECT 13 AS nid, 128.0 AS "E" FROM DUAL UNION ALL SELECT 14 AS nid, 265.68333333333334 AS "E" FROM DUAL) "Values"), 
"DT_Output_6" AS 
...
"DT_node_data_7" AS 
(SELECT "Values".nid AS nid, CAST("Values"."E" AS BINARY_DOUBLE) AS "E" 
FROM (SELECT 3 AS nid, 77.53333333333333 AS "E" FROM DUAL UNION ALL SELECT 4 AS nid, 119.72058823529412 AS "E" FROM DUAL UNION ALL SELECT 6 AS nid, 262.6666666666667 AS "E" FROM DUAL UNION ALL SELECT 7 AS nid, 204.75 AS "E" FROM DUAL UNION ALL SELECT 10 AS nid, 118.73417721518987 AS "E" FROM DUAL UNION ALL SELECT 11 AS nid, 192.41666666666666 AS "E" FROM DUAL UNION ALL SELECT 13 AS nid, 252.05494505494505 AS "E" FROM DUAL UNION ALL SELECT 14 AS nid, 142.40740740740742 AS "E" FROM DUAL) "Values"), 
"DT_Output_7" AS 
...
"DT_node_data_8" AS 
(SELECT "Values".nid AS nid, CAST("Values"."E" AS BINARY_DOUBLE) AS "E" 
FROM (SELECT 3 AS nid, 130.54098360655738 AS "E" FROM DUAL UNION ALL SELECT 4 AS nid, 78.84210526315789 AS "E" FROM DUAL UNION ALL SELECT 6 AS nid, 149.10687022900763 AS "E" FROM DUAL UNION ALL SELECT 7 AS nid, 216.78181818181818 AS "E" FROM DUAL UNION ALL SELECT 10 AS nid, 85.9 AS "E" FROM DUAL UNION ALL SELECT 11 AS nid, 192.0 AS "E" FROM DUAL UNION ALL SELECT 13 AS nid, 98.0 AS "E" FROM DUAL UNION ALL SELECT 14 AS nid, 272.33962264150944 AS "E" FROM DUAL) "Values"), 
"DT_Output_8" AS 
...
"DT_node_data_9" AS 
(SELECT "Values".nid AS nid, CAST("Values"."E" AS BINARY_DOUBLE) AS "E" 
FROM (SELECT 3 AS nid, 226.05 AS "E" FROM DUAL UNION ALL SELECT 4 AS nid, 134.34939759036143 AS "E" FROM DUAL UNION ALL SELECT 6 AS nid, 346.0 AS "E" FROM DUAL UNION ALL SELECT 7 AS nid, 275.90909090909093 AS "E" FROM DUAL UNION ALL SELECT 10 AS nid, 86.5 AS "E" FROM DUAL UNION ALL SELECT 11 AS nid, 183.375 AS "E" FROM DUAL UNION ALL SELECT 13 AS nid, 275.0833333333333 AS "E" FROM DUAL UNION ALL SELECT 14 AS nid, 213.27272727272728 AS "E" FROM DUAL) "Values"), 
"DT_Output_9" AS 
...
"DT_node_data_10" AS 
(SELECT "Values".nid AS nid, CAST("Values"."E" AS BINARY_DOUBLE) AS "E" 
FROM (SELECT 3 AS nid, 140.2 AS "E" FROM DUAL UNION ALL SELECT 4 AS nid, 252.66666666666666 AS "E" FROM DUAL UNION ALL SELECT 6 AS nid, 148.875 AS "E" FROM DUAL UNION ALL SELECT 7 AS nid, 88.66071428571429 AS "E" FROM DUAL UNION ALL SELECT 10 AS nid, 90.72222222222223 AS "E" FROM DUAL UNION ALL SELECT 11 AS nid, 175.05555555555554 AS "E" FROM DUAL UNION ALL SELECT 13 AS nid, 207.4468085106383 AS "E" FROM DUAL UNION ALL SELECT 14 AS nid, 75.76923076923077 AS "E" FROM DUAL) "Values"), 
"DT_Output_10" AS 
...
"DT_node_data_11" AS 
(SELECT "Values".nid AS nid, CAST("Values"."E" AS BINARY_DOUBLE) AS "E" 
FROM (SELECT 3 AS nid, 104.5 AS "E" FROM DUAL UNION ALL SELECT 4 AS nid, 205.75 AS "E" FROM DUAL UNION ALL SELECT 6 AS nid, 189.5 AS "E" FROM DUAL UNION ALL SELECT 7 AS nid, 93.21428571428571 AS "E" FROM DUAL UNION ALL SELECT 10 AS nid, 304.28 AS "E" FROM DUAL UNION ALL SELECT 11 AS nid, 190.65625 AS "E" FROM DUAL UNION ALL SELECT 13 AS nid, 285.0 AS "E" FROM DUAL UNION ALL SELECT 14 AS nid, 160.20673076923077 AS "E" FROM DUAL) "Values"), 
"DT_Output_11" AS 
...
"DT_node_data_12" AS 
(SELECT "Values".nid AS nid, CAST("Values"."E" AS BINARY_DOUBLE) AS "E" 
FROM (SELECT 3 AS nid, 136.22727272727272 AS "E" FROM DUAL UNION ALL SELECT 4 AS nid, 63.851851851851855 AS "E" FROM DUAL UNION ALL SELECT 6 AS nid, 119.93939393939394 AS "E" FROM DUAL UNION ALL SELECT 7 AS nid, 200.98924731182797 AS "E" FROM DUAL UNION ALL SELECT 10 AS nid, 158.18 AS "E" FROM DUAL UNION ALL SELECT 11 AS nid, 271.3333333333333 AS "E" FROM DUAL UNION ALL SELECT 13 AS nid, 277.23333333333335 AS "E" FROM DUAL UNION ALL SELECT 14 AS nid, 321.125 AS "E" FROM DUAL) "Values"), 
"DT_Output_12" AS 
...
"DT_node_data_13" AS 
(SELECT "Values".nid AS nid, CAST("Values"."E" AS BINARY_DOUBLE) AS "E" 
FROM (SELECT 3 AS nid, 246.84615384615384 AS "E" FROM DUAL UNION ALL SELECT 4 AS nid, 146.9453781512605 AS "E" FROM DUAL UNION ALL SELECT 6 AS nid, 315.6666666666667 AS "E" FROM DUAL UNION ALL SELECT 7 AS nid, 211.0 AS "E" FROM DUAL UNION ALL SELECT 10 AS nid, 178.8780487804878 AS "E" FROM DUAL UNION ALL SELECT 11 AS nid, 287.1111111111111 AS "E" FROM DUAL UNION ALL SELECT 13 AS nid, 206.75 AS "E" FROM DUAL UNION ALL SELECT 14 AS nid, 305.07142857142856 AS "E" FROM DUAL) "Values"), 
"DT_Output_13" AS 
...
"DT_node_data_14" AS 
(SELECT "Values".nid AS nid, CAST("Values"."E" AS BINARY_DOUBLE) AS "E" 
FROM (SELECT 3 AS nid, 59.41379310344828 AS "E" FROM DUAL UNION ALL SELECT 4 AS nid, 121.0 AS "E" FROM DUAL UNION ALL SELECT 6 AS nid, 164.83333333333334 AS "E" FROM DUAL UNION ALL SELECT 7 AS nid, 84.81818181818181 AS "E" FROM DUAL UNION ALL SELECT 10 AS nid, 40.75 AS "E" FROM DUAL UNION ALL SELECT 11 AS nid, 161.78523489932886 AS "E" FROM DUAL UNION ALL SELECT 13 AS nid, 182.04166666666666 AS "E" FROM DUAL UNION ALL SELECT 14 AS nid, 269.74074074074076 AS "E" FROM DUAL) "Values"), 
"DT_Output_14" AS 
...
"DT_node_data_15" AS 
(SELECT "Values".nid AS nid, CAST("Values"."E" AS BINARY_DOUBLE) AS "E" 
FROM (SELECT 3 AS nid, 154.99382716049382 AS "E" FROM DUAL UNION ALL SELECT 4 AS nid, 100.74444444444444 AS "E" FROM DUAL UNION ALL SELECT 6 AS nid, 158.30434782608697 AS "E" FROM DUAL UNION ALL SELECT 7 AS nid, 263.34375 AS "E" FROM DUAL UNION ALL SELECT 9 AS nid, 128.0 AS "E" FROM DUAL UNION ALL SELECT 11 AS nid, 310.6060606060606 AS "E" FROM DUAL UNION ALL SELECT 12 AS nid, 180.2 AS "E" FROM DUAL) "Values"), 
"DT_Output_15" AS 
...
FROM "TMP_20180602_F8E_QUANTILES" "Quantiles"