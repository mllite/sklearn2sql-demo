...
-- Code For temporary table TMP_20180602_NUX_ADS_IMP_1_OUT part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180602_NUX_ADS_IMP_1_OUT" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20180602_NUX_ADS_IMP_1_OUT part 3. Create Index 

CREATE INDEX "ix_TMP_20180602_NUX_ADS_5055" ON "TMP_20180602_NUX_ADS_IMP_1_OUT" ("KEY")

-- Code For temporary table TMP_20180602_1WE_ADS_SCA_2_OUT part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180602_1WE_ADS_SCA_2_OUT" (
	"KEY" BIGINT NOT NULL, 
...
FROM "TMP_20180602_NUX_ADS_IMP_1_OUT" AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT") AS "U"

-- Code For temporary table TMP_20180602_1WE_ADS_SCA_2_OUT part 3. Create Index 

CREATE INDEX "ix_TMP_20180602_1WE_ADS_8b73" ON "TMP_20180602_1WE_ADS_SCA_2_OUT" ("KEY")

-- Code For temporary table TMP_20180602_U3X_GB_B0 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180602_U3X_GB_B0" (
	"KEY" BIGINT, 
...
-- Code For temporary table TMP_20180602_U3X_GB_B0 part 2. Populate

INSERT INTO "TMP_20180602_U3X_GB_B0" ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
FROM "TMP_20180602_1WE_ADS_SCA_2_OUT" AS "ADS_sca_2_OUT"), 
"DT_node_data" AS 
(SELECT "Values".nid AS nid, CAST("Values"."E" AS DOUBLE PRECISION) AS "E" 
FROM (SELECT 3 AS nid, -252.84102656467715 AS "E" FROM rdb$database UNION ALL SELECT 4 AS nid, -401.01586877236855 AS "E" FROM rdb$database UNION ALL SELECT 6 AS nid, -140.43801884125133 AS "E" FROM rdb$database UNION ALL SELECT 7 AS nid, 111.22723579469624 AS "E" FROM rdb$database UNION ALL SELECT 10 AS nid, 2.0020662492701846 AS "E" FROM rdb$database UNION ALL SELECT 11 AS nid, 193.88392579467964 AS "E" FROM rdb$database UNION ALL SELECT 13 AS nid, 236.29693349709683 AS "E" FROM rdb$database UNION ALL SELECT 14 AS nid, -68.24444068793147 AS "E" FROM rdb$database) AS "Values"), 
"DT_Output" AS 
...
"DT_node_data_1" AS 
(SELECT "Values".nid AS nid, CAST("Values"."E" AS DOUBLE PRECISION) AS "E" 
FROM (SELECT 3 AS nid, -227.55692390820943 AS "E" FROM rdb$database UNION ALL SELECT 4 AS nid, -360.91428189513175 AS "E" FROM rdb$database UNION ALL SELECT 6 AS nid, -152.25652148339992 AS "E" FROM rdb$database UNION ALL SELECT 7 AS nid, 77.73187383936153 AS "E" FROM rdb$database UNION ALL SELECT 10 AS nid, -160.31951781815866 AS "E" FROM rdb$database UNION ALL SELECT 11 AS nid, 160.54972594405706 AS "E" FROM rdb$database UNION ALL SELECT 13 AS nid, -47.46336042041583 AS "E" FROM rdb$database UNION ALL SELECT 14 AS nid, 102.703183089185 AS "E" FROM rdb$database) AS "Values"), 
"DT_Output_1" AS 
...
"DT_node_data_2" AS 
(SELECT "Values".nid AS nid, CAST("Values"."E" AS DOUBLE PRECISION) AS "E" 
FROM (SELECT 3 AS nid, -268.6966071831282 AS "E" FROM rdb$database UNION ALL SELECT 4 AS nid, -132.286115276833 AS "E" FROM rdb$database UNION ALL SELECT 6 AS nid, -66.30218273793687 AS "E" FROM rdb$database UNION ALL SELECT 7 AS nid, 132.8221282945893 AS "E" FROM rdb$database UNION ALL SELECT 10 AS nid, -4.5147952272318355 AS "E" FROM rdb$database UNION ALL SELECT 11 AS nid, 162.23855532393944 AS "E" FROM rdb$database UNION ALL SELECT 13 AS nid, 18.409364311488886 AS "E" FROM rdb$database UNION ALL SELECT 14 AS nid, 211.7568683380744 AS "E" FROM rdb$database) AS "Values"), 
"DT_Output_2" AS 
...
"DT_node_data_3" AS 
(SELECT "Values".nid AS nid, CAST("Values"."E" AS DOUBLE PRECISION) AS "E" 
FROM (SELECT 3 AS nid, -248.63223217136462 AS "E" FROM rdb$database UNION ALL SELECT 4 AS nid, -138.64685597514327 AS "E" FROM rdb$database UNION ALL SELECT 6 AS nid, -104.47481289543998 AS "E" FROM rdb$database UNION ALL SELECT 7 AS nid, 88.63223618704266 AS "E" FROM rdb$database UNION ALL SELECT 10 AS nid, 109.73803198644433 AS "E" FROM rdb$database UNION ALL SELECT 11 AS nid, 259.2870627880886 AS "E" FROM rdb$database UNION ALL SELECT 13 AS nid, -2.7785670851123636 AS "E" FROM rdb$database UNION ALL SELECT 14 AS nid, 197.77273802049856 AS "E" FROM rdb$database) AS "Values"), 
"DT_Output_3" AS 
...
"DT_node_data_4" AS 
(SELECT "Values".nid AS nid, CAST("Values"."E" AS DOUBLE PRECISION) AS "E" 
FROM (SELECT 3 AS nid, -166.08417260866474 AS "E" FROM rdb$database UNION ALL SELECT 4 AS nid, -273.0899697701693 AS "E" FROM rdb$database UNION ALL SELECT 6 AS nid, -104.24398888014426 AS "E" FROM rdb$database UNION ALL SELECT 7 AS nid, 53.03467027243673 AS "E" FROM rdb$database UNION ALL SELECT 10 AS nid, 108.15211098937698 AS "E" FROM rdb$database UNION ALL SELECT 11 AS nid, 256.10264878677424 AS "E" FROM rdb$database UNION ALL SELECT 13 AS nid, -35.819061204929746 AS "E" FROM rdb$database UNION ALL SELECT 14 AS nid, 101.20656778478092 AS "E" FROM rdb$database) AS "Values"), 
"DT_Output_4" AS 
...
-- Code For temporary table TMP_20180602_51X_GB_B1 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180602_51X_GB_B1" (
	"KEY" BIGINT, 
	"Estimator" DOUBLE PRECISION
)
...
-- Code For temporary table TMP_20180602_51X_GB_B1 part 2. Populate

INSERT INTO "TMP_20180602_51X_GB_B1" ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
"DT_node_data_5" AS 
(SELECT "Values".nid AS nid, CAST("Values"."E" AS DOUBLE PRECISION) AS "E" 
FROM (SELECT 3 AS nid, -147.87696104193762 AS "E" FROM rdb$database UNION ALL SELECT 4 AS nid, -250.5773557107342 AS "E" FROM rdb$database UNION ALL SELECT 6 AS nid, -86.96777144299705 AS "E" FROM rdb$database UNION ALL SELECT 7 AS nid, 53.81725389069262 AS "E" FROM rdb$database UNION ALL SELECT 10 AS nid, 97.33689989043926 AS "E" FROM rdb$database UNION ALL SELECT 11 AS nid, 230.49238390809677 AS "E" FROM rdb$database UNION ALL SELECT 13 AS nid, 61.954603928554725 AS "E" FROM rdb$database UNION ALL SELECT 14 AS nid, -88.7201442903887 AS "E" FROM rdb$database) AS "Values"), 
"DT_Output_5" AS 
...
"DT_node_data_6" AS 
(SELECT "Values".nid AS nid, CAST("Values"."E" AS DOUBLE PRECISION) AS "E" 
FROM (SELECT 3 AS nid, -182.63471636324059 AS "E" FROM rdb$database UNION ALL SELECT 4 AS nid, -86.71306885573706 AS "E" FROM rdb$database UNION ALL SELECT 6 AS nid, -32.57971656242132 AS "E" FROM rdb$database UNION ALL SELECT 7 AS nid, 99.9914994301132 AS "E" FROM rdb$database UNION ALL SELECT 10 AS nid, -143.53177440111878 AS "E" FROM rdb$database UNION ALL SELECT 11 AS nid, 37.91215350311193 AS "E" FROM rdb$database UNION ALL SELECT 13 AS nid, 138.3715502781027 AS "E" FROM rdb$database UNION ALL SELECT 14 AS nid, -47.4458269514782 AS "E" FROM rdb$database) AS "Values"), 
"DT_Output_6" AS 
...
"DT_node_data_7" AS 
(SELECT "Values".nid AS nid, CAST("Values"."E" AS DOUBLE PRECISION) AS "E" 
FROM (SELECT 3 AS nid, -145.43711457466674 AS "E" FROM rdb$database UNION ALL SELECT 4 AS nid, -35.40083739231901 AS "E" FROM rdb$database UNION ALL SELECT 6 AS nid, 24.89731543252883 AS "E" FROM rdb$database UNION ALL SELECT 7 AS nid, 149.58226543185765 AS "E" FROM rdb$database UNION ALL SELECT 10 AS nid, -25.5045863629451 AS "E" FROM rdb$database UNION ALL SELECT 11 AS nid, 102.207549307282 AS "E" FROM rdb$database UNION ALL SELECT 13 AS nid, 128.2519385213634 AS "E" FROM rdb$database UNION ALL SELECT 14 AS nid, -18.353759863352334 AS "E" FROM rdb$database) AS "Values"), 
"DT_Output_7" AS 
...
"DT_node_data_8" AS 
(SELECT "Values".nid AS nid, CAST("Values"."E" AS DOUBLE PRECISION) AS "E" 
FROM (SELECT 3 AS nid, -157.19419874992286 AS "E" FROM rdb$database UNION ALL SELECT 4 AS nid, -60.3809500717206 AS "E" FROM rdb$database UNION ALL SELECT 6 AS nid, -73.98362499412102 AS "E" FROM rdb$database UNION ALL SELECT 7 AS nid, 40.436523048835895 AS "E" FROM rdb$database UNION ALL SELECT 10 AS nid, -74.86005898402577 AS "E" FROM rdb$database UNION ALL SELECT 11 AS nid, 113.14956109235057 AS "E" FROM rdb$database UNION ALL SELECT 13 AS nid, 47.664503383772654 AS "E" FROM rdb$database UNION ALL SELECT 14 AS nid, -74.18404813706101 AS "E" FROM rdb$database) AS "Values"), 
"DT_Output_8" AS 
...
"DT_node_data_9" AS 
(SELECT "Values".nid AS nid, CAST("Values"."E" AS DOUBLE PRECISION) AS "E" 
FROM (SELECT 3 AS nid, -160.0552494150242 AS "E" FROM rdb$database UNION ALL SELECT 4 AS nid, -83.4053948562265 AS "E" FROM rdb$database UNION ALL SELECT 6 AS nid, -107.6707256102459 AS "E" FROM rdb$database UNION ALL SELECT 7 AS nid, 21.68229919627524 AS "E" FROM rdb$database UNION ALL SELECT 10 AS nid, 66.22304540348168 AS "E" FROM rdb$database UNION ALL SELECT 11 AS nid, 171.99591624788687 AS "E" FROM rdb$database UNION ALL SELECT 13 AS nid, -9.026621321357302 AS "E" FROM rdb$database UNION ALL SELECT 14 AS nid, 153.64635202717568 AS "E" FROM rdb$database) AS "Values"), 
"DT_Output_9" AS 
...
-- Code For temporary table TMP_20180602_QR8_GB_B2 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180602_QR8_GB_B2" (
	"KEY" BIGINT, 
	"Estimator" DOUBLE PRECISION
)
...
-- Code For temporary table TMP_20180602_QR8_GB_B2 part 2. Populate

INSERT INTO "TMP_20180602_QR8_GB_B2" ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
"DT_node_data_10" AS 
(SELECT "Values".nid AS nid, CAST("Values"."E" AS DOUBLE PRECISION) AS "E" 
FROM (SELECT 3 AS nid, -105.70169960582692 AS "E" FROM rdb$database UNION ALL SELECT 4 AS nid, -14.012286209710851 AS "E" FROM rdb$database UNION ALL SELECT 6 AS nid, 39.81136640417115 AS "E" FROM rdb$database UNION ALL SELECT 7 AS nid, 155.01699967450787 AS "E" FROM rdb$database UNION ALL SELECT 10 AS nid, -69.66580779283252 AS "E" FROM rdb$database UNION ALL SELECT 11 AS nid, 24.479886218202687 AS "E" FROM rdb$database UNION ALL SELECT 13 AS nid, 46.06291534740547 AS "E" FROM rdb$database UNION ALL SELECT 14 AS nid, 184.43107173825283 AS "E" FROM rdb$database) AS "Values"), 
"DT_Output_10" AS 
...
"DT_node_data_11" AS 
(SELECT "Values".nid AS nid, CAST("Values"."E" AS DOUBLE PRECISION) AS "E" 
FROM (SELECT 3 AS nid, -85.51429185270395 AS "E" FROM rdb$database UNION ALL SELECT 4 AS nid, -167.63542374683593 AS "E" FROM rdb$database UNION ALL SELECT 6 AS nid, -92.37300794483369 AS "E" FROM rdb$database UNION ALL SELECT 7 AS nid, 48.0373508303457 AS "E" FROM rdb$database UNION ALL SELECT 10 AS nid, 41.398422030964845 AS "E" FROM rdb$database UNION ALL SELECT 11 AS nid, -38.63231201479074 AS "E" FROM rdb$database UNION ALL SELECT 13 AS nid, 27.3176001355772 AS "E" FROM rdb$database UNION ALL SELECT 14 AS nid, 114.33811274292584 AS "E" FROM rdb$database) AS "Values"), 
"DT_Output_11" AS 
...
"DT_node_data_12" AS 
(SELECT "Values".nid AS nid, CAST("Values"."E" AS DOUBLE PRECISION) AS "E" 
FROM (SELECT 3 AS nid, -88.60974980486985 AS "E" FROM rdb$database UNION ALL SELECT 4 AS nid, -12.744809409235376 AS "E" FROM rdb$database UNION ALL SELECT 6 AS nid, 128.08148843276447 AS "E" FROM rdb$database UNION ALL SELECT 7 AS nid, 24.396418489461453 AS "E" FROM rdb$database UNION ALL SELECT 10 AS nid, -49.001931036505745 AS "E" FROM rdb$database UNION ALL SELECT 11 AS nid, 56.63786601424134 AS "E" FROM rdb$database UNION ALL SELECT 13 AS nid, 28.179575262824848 AS "E" FROM rdb$database UNION ALL SELECT 14 AS nid, 97.7534295213522 AS "E" FROM rdb$database) AS "Values"), 
"DT_Output_12" AS 
...
"DT_node_data_13" AS 
(SELECT "Values".nid AS nid, CAST("Values"."E" AS DOUBLE PRECISION) AS "E" 
FROM (SELECT 3 AS nid, -126.75924001583564 AS "E" FROM rdb$database UNION ALL SELECT 4 AS nid, -62.85697130244644 AS "E" FROM rdb$database UNION ALL SELECT 6 AS nid, -20.930351632698404 AS "E" FROM rdb$database UNION ALL SELECT 7 AS nid, 88.42260758197688 AS "E" FROM rdb$database UNION ALL SELECT 10 AS nid, -71.32424126285527 AS "E" FROM rdb$database UNION ALL SELECT 11 AS nid, 27.80278345761975 AS "E" FROM rdb$database UNION ALL SELECT 13 AS nid, -23.88205873080682 AS "E" FROM rdb$database UNION ALL SELECT 14 AS nid, 109.34348791177808 AS "E" FROM rdb$database) AS "Values"), 
"DT_Output_13" AS 
...
"DT_node_data_14" AS 
(SELECT "Values".nid AS nid, CAST("Values"."E" AS DOUBLE PRECISION) AS "E" 
FROM (SELECT 3 AS nid, -93.99300868549963 AS "E" FROM rdb$database UNION ALL SELECT 4 AS nid, -24.414196642770957 AS "E" FROM rdb$database UNION ALL SELECT 6 AS nid, -46.85619479898081 AS "E" FROM rdb$database UNION ALL SELECT 7 AS nid, 43.98578648472594 AS "E" FROM rdb$database UNION ALL SELECT 10 AS nid, -13.732619488024172 AS "E" FROM rdb$database UNION ALL SELECT 11 AS nid, 54.38832187751443 AS "E" FROM rdb$database UNION ALL SELECT 13 AS nid, 37.37067942773186 AS "E" FROM rdb$database UNION ALL SELECT 14 AS nid, 119.40651264221049 AS "E" FROM rdb$database) AS "Values"), 
"DT_Output_14" AS 
...
-- Code For temporary table TMP_20180602_FTE_GB_B3 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180602_FTE_GB_B3" (
	"KEY" BIGINT, 
	"Estimator" DOUBLE PRECISION
)
...
-- Code For temporary table TMP_20180602_FTE_GB_B3 part 2. Populate

INSERT INTO "TMP_20180602_FTE_GB_B3" ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
"DT_node_data_15" AS 
(SELECT "Values".nid AS nid, CAST("Values"."E" AS DOUBLE PRECISION) AS "E" 
FROM (SELECT 3 AS nid, -46.29054098483074 AS "E" FROM rdb$database UNION ALL SELECT 4 AS nid, -111.54646162817066 AS "E" FROM rdb$database UNION ALL SELECT 6 AS nid, 20.549760243555752 AS "E" FROM rdb$database UNION ALL SELECT 7 AS nid, 98.90015861055879 AS "E" FROM rdb$database UNION ALL SELECT 10 AS nid, 13.135862842611658 AS "E" FROM rdb$database UNION ALL SELECT 11 AS nid, -51.91086899502939 AS "E" FROM rdb$database UNION ALL SELECT 13 AS nid, -33.21712489184561 AS "E" FROM rdb$database UNION ALL SELECT 14 AS nid, 47.69542431288654 AS "E" FROM rdb$database) AS "Values"), 
"DT_Output_15" AS 
...
-- Code For temporary table TMP_20180602_4EL_GB_SUM part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180602_4EL_GB_SUM" (
	"KEY" BIGINT NOT NULL, 
	"Estimator" DOUBLE PRECISION, 
	PRIMARY KEY ("KEY")
)
...
-- Code For temporary table TMP_20180602_4EL_GB_SUM part 2. Populate

INSERT INTO "TMP_20180602_4EL_GB_SUM" ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
FROM "TMP_20180602_U3X_GB_B0" AS "GB_B0" UNION ALL SELECT "GB_B1"."KEY" AS "KEY", "GB_B1"."Estimator" AS "Estimator" 
FROM "TMP_20180602_51X_GB_B1" AS "GB_B1" UNION ALL SELECT "GB_B2"."KEY" AS "KEY", "GB_B2"."Estimator" AS "Estimator" 
FROM "TMP_20180602_QR8_GB_B2" AS "GB_B2" UNION ALL SELECT "GB_B3"."KEY" AS "KEY", "GB_B3"."Estimator" AS "Estimator" 
FROM "TMP_20180602_FTE_GB_B3" AS "GB_B3") AS "GB_EnsembleUnion")
...
-- Code For temporary table TMP_20180602_4EL_GB_SUM part 3. Create Index 

CREATE INDEX "ix_TMP_20180602_4EL_GB_SUM_KEY" ON "TMP_20180602_4EL_GB_SUM" ("KEY")

-- Model deployment code

SELECT "GB_sum"."KEY" AS "KEY", -11.471614782695335 + 0.1 * "GB_sum"."Estimator" AS "Estimator" 
FROM "TMP_20180602_4EL_GB_SUM" AS "GB_sum"