...
-- Code For temporary table tmp_20180602144738_o20_ads_imp_1_out part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180602144738_o20_ads_imp_1_out (
	"KEY" BIGINT, 
	impter_2 DOUBLE, 
	impter_3 DOUBLE, 
	impter_4 DOUBLE, 
...
-- Code For temporary table tmp_20180602144738_16c_ads_sca_2_out part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180602144738_16c_ads_sca_2_out (
	"KEY" BIGINT, 
	scaler_2 DOUBLE, 
	scaler_3 DOUBLE, 
	scaler_4 DOUBLE, 
...
FROM tmp_20180602144738_o20_ads_imp_1_out AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT"

-- Code For temporary table tmp_20180602144738_qe4_quantiles part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180602144738_qe4_quantiles (
	"KEY" BIGINT, 
	"Quantile" DOUBLE
)
...
-- Code For temporary table tmp_20180602144738_qe4_quantiles part 2. Populate

INSERT INTO tmp_20180602144738_qe4_quantiles WITH "DT_node_lookup" AS 
...
FROM tmp_20180602144738_16c_ads_sca_2_out AS "ADS_sca_2_OUT"), 
"DT_node_data" AS 
...
FROM tmp_20180602144738_qe4_quantiles AS "Quantiles"