...
-- Code For temporary table 20180602_DQH_ADS_IMP_1_OUT part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "20180602_DQH_ADS_IMP_1_OUT" (
	"KEY" NUMBER(19), 
...
-- Code For temporary table 20180602_DQH_ADS_IMP_1_OUT part 2. Populate

INSERT INTO "20180602_DQH_ADS_IMP_1_OUT" ("KEY", imputer_output_2, imputer_output_3, imputer_output_4, imputer_output_5) SELECT "U"."KEY", "U".imputer_output_2, "U".imputer_output_3, "U".imputer_output_4, "U".imputer_output_5 
...
-- Code For temporary table 20180602_U88_ADS_SCA_2_OUT part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "20180602_U88_ADS_SCA_2_OUT" (
	"KEY" NUMBER(19), 
...
-- Code For temporary table 20180602_U88_ADS_SCA_2_OUT part 2. Populate

INSERT INTO "20180602_U88_ADS_SCA_2_OUT" ("KEY", scaler_output_2, scaler_output_3, scaler_output_4, scaler_output_5) SELECT "U"."KEY", "U".scaler_output_2, "U".scaler_output_3, "U".scaler_output_4, "U".scaler_output_5 
...
FROM "20180602_DQH_ADS_IMP_1_OUT" "ADS_imp_1_OUT") "ADS_sca_2_OUT") "U"

-- Code For temporary table TMP_20180602_XDS_QUANTILES part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180602_XDS_QUANTILES" (
	"KEY" NUMBER(19), 
...
-- Code For temporary table TMP_20180602_XDS_QUANTILES part 2. Populate

INSERT INTO "TMP_20180602_XDS_QUANTILES" ("KEY", "Quantile") SELECT "U"."KEY", "U"."Quantile" 
...
FROM "20180602_U88_ADS_SCA_2_OUT" "ADS_sca_2_OUT"), 
"DT_node_data" AS 
...
FROM "TMP_20180602_XDS_QUANTILES" "Quantiles"