...
-- Code For temporary table TMP_20180602152059_PH2_ADS_imp_1_OUT part 1. Create 


CREATE TEMPORARY TABLE `TMP_20180602152059_PH2_ADS_imp_1_OUT` (
	`KEY` BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20180602152059_PH2_ADS_imp_1_OUT part 2. Populate

INSERT INTO `TMP_20180602152059_PH2_ADS_imp_1_OUT` (`KEY`, imputer_output_2, imputer_output_3, imputer_output_4, imputer_output_5) SELECT `U`.`KEY`, `U`.imputer_output_2, `U`.imputer_output_3, `U`.imputer_output_4, `U`.imputer_output_5 
...
-- Code For temporary table TMP_20180602152059_PH2_ADS_imp_1_OUT part 3. Create Index 

CREATE INDEX `ix_TMP_20180602152059_PH2_ADS_imp_1_OUT_KEY` ON `TMP_20180602152059_PH2_ADS_imp_1_OUT` (`KEY`)

-- Code For temporary table TMP_20180602152059_6AP_ADS_sca_2_OUT part 1. Create 


CREATE TEMPORARY TABLE `TMP_20180602152059_6AP_ADS_sca_2_OUT` (
	`KEY` BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20180602152059_6AP_ADS_sca_2_OUT part 2. Populate

INSERT INTO `TMP_20180602152059_6AP_ADS_sca_2_OUT` (`KEY`, scaler_output_2, scaler_output_3, scaler_output_4, scaler_output_5) SELECT `U`.`KEY`, `U`.scaler_output_2, `U`.scaler_output_3, `U`.scaler_output_4, `U`.scaler_output_5 
...
FROM `TMP_20180602152059_PH2_ADS_imp_1_OUT` AS `ADS_imp_1_OUT`) AS `ADS_sca_2_OUT`) AS `U`

-- Code For temporary table TMP_20180602152059_6AP_ADS_sca_2_OUT part 3. Create Index 

CREATE INDEX `ix_TMP_20180602152059_6AP_ADS_sca_2_OUT_KEY` ON `TMP_20180602152059_6AP_ADS_sca_2_OUT` (`KEY`)

-- Code For temporary table TMP_20180602152059_S5M_WE_B0 part 1. Create 


CREATE TEMPORARY TABLE `TMP_20180602152059_S5M_WE_B0` (
	`KEY` BIGINT, 
	`Estimator` DOUBLE, 
	`Weight` DOUBLE, 
	est_index BIGINT
...
-- Code For temporary table TMP_20180602152059_S5M_WE_B0 part 2. Populate

INSERT INTO `TMP_20180602152059_S5M_WE_B0` (`KEY`, `Estimator`, `Weight`, est_index) SELECT `U`.`KEY`, `U`.`Estimator`, `U`.`Weight`, `U`.est_index 
...
FROM `TMP_20180602152059_6AP_ADS_sca_2_OUT` AS `ADS_sca_2_OUT`), 
`DT_node_data` AS 
...
-- Code For temporary table TMP_20180602152059_254_WE_B1 part 1. Create 


CREATE TEMPORARY TABLE `TMP_20180602152059_254_WE_B1` (
	`KEY` BIGINT, 
	`Estimator` DOUBLE, 
	`Weight` DOUBLE, 
	est_index BIGINT
...
-- Code For temporary table TMP_20180602152059_254_WE_B1 part 2. Populate

INSERT INTO `TMP_20180602152059_254_WE_B1` (`KEY`, `Estimator`, `Weight`, est_index) SELECT `U`.`KEY`, `U`.`Estimator`, `U`.`Weight`, `U`.est_index 
...
-- Code For temporary table TMP_20180602152059_J9D_Quantiles part 1. Create 


CREATE TEMPORARY TABLE `TMP_20180602152059_J9D_Quantiles` (
	`KEY` BIGINT, 
	`Quantile` DOUBLE
)
...
-- Code For temporary table TMP_20180602152059_J9D_Quantiles part 2. Populate

INSERT INTO `TMP_20180602152059_J9D_Quantiles` (`KEY`, `Quantile`) SELECT `U`.`KEY`, `U`.`Quantile` 
...
FROM `TMP_20180602152059_S5M_WE_B0` AS `WE_B0` UNION ALL SELECT `WE_B1`.`KEY` AS `KEY`, `WE_B1`.`Estimator` AS `Estimator`, `WE_B1`.`Weight` AS `Weight`, `WE_B1`.est_index AS est_index 
FROM `TMP_20180602152059_254_WE_B1` AS `WE_B1`) AS `WE_EnsembleUnion`), 
...
FROM `TMP_20180602152059_J9D_Quantiles` AS `Quantiles`