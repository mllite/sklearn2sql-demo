...
-- Code For temporary table 20180602_IAE_ADS_IMP_1_OUT part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "20180602_IAE_ADS_IMP_1_OUT" (
	"KEY" NUMBER(19), 
...
-- Code For temporary table 20180602_IAE_ADS_IMP_1_OUT part 2. Populate

INSERT INTO "20180602_IAE_ADS_IMP_1_OUT" ("KEY", impter_2, impter_3, impter_4, impter_5, impter_6, impter_7, impter_8, impter_9, impter_10, impter_11) SELECT "U"."KEY", "U".impter_2, "U".impter_3, "U".impter_4, "U".impter_5, "U".impter_6, "U".impter_7, "U".impter_8, "U".impter_9, "U".impter_10, "U".impter_11 
...
-- Code For temporary table 20180602_D8A_ADS_SCA_2_OUT part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "20180602_D8A_ADS_SCA_2_OUT" (
	"KEY" NUMBER(19), 
...
-- Code For temporary table 20180602_D8A_ADS_SCA_2_OUT part 2. Populate

INSERT INTO "20180602_D8A_ADS_SCA_2_OUT" ("KEY", scaler_2, scaler_3, scaler_4, scaler_5, scaler_6, scaler_7, scaler_8, scaler_9, scaler_10, scaler_11) SELECT "U"."KEY", "U".scaler_2, "U".scaler_3, "U".scaler_4, "U".scaler_5, "U".scaler_6, "U".scaler_7, "U".scaler_8, "U".scaler_9, "U".scaler_10, "U".scaler_11 
...
FROM "20180602_IAE_ADS_IMP_1_OUT" "ADS_imp_1_OUT") "ADS_sca_2_OUT") "U"

-- Code For temporary table TMP_20180602_ZM1_QUANTILES part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180602_ZM1_QUANTILES" (
	"KEY" NUMBER(19), 
...
-- Code For temporary table TMP_20180602_ZM1_QUANTILES part 2. Populate

INSERT INTO "TMP_20180602_ZM1_QUANTILES" ("KEY", "Quantile") SELECT "U"."KEY", "U"."Quantile" 
...
FROM "20180602_D8A_ADS_SCA_2_OUT" "ADS_sca_2_OUT"), 
"DT_node_data" AS 
(SELECT "Values".nid AS nid, CAST("Values"."E" AS BINARY_DOUBLE) AS "E" 
FROM (SELECT 3 AS nid, 7.108390979047101 AS "E" FROM DUAL UNION ALL SELECT 4 AS nid, 10.330887125839682 AS "E" FROM DUAL UNION ALL SELECT 6 AS nid, 12.484302041779221 AS "E" FROM DUAL UNION ALL SELECT 7 AS nid, 16.867007546276703 AS "E" FROM DUAL UNION ALL SELECT 10 AS nid, 9.958336196414976 AS "E" FROM DUAL UNION ALL SELECT 11 AS nid, 16.155086265138074 AS "E" FROM DUAL UNION ALL SELECT 13 AS nid, 16.714568981882323 AS "E" FROM DUAL UNION ALL SELECT 14 AS nid, 21.530772731913935 AS "E" FROM DUAL) "Values"), 
"DT_Output" AS 
...
"DT_node_data_1" AS 
(SELECT "Values".nid AS nid, CAST("Values"."E" AS BINARY_DOUBLE) AS "E" 
FROM (SELECT 3 AS nid, 6.680372815192879 AS "E" FROM DUAL UNION ALL SELECT 4 AS nid, 13.03309136966267 AS "E" FROM DUAL UNION ALL SELECT 6 AS nid, 16.137564712882295 AS "E" FROM DUAL UNION ALL SELECT 7 AS nid, 23.693970395239386 AS "E" FROM DUAL UNION ALL SELECT 10 AS nid, 22.107190514382584 AS "E" FROM DUAL UNION ALL SELECT 11 AS nid, 17.253474800388226 AS "E" FROM DUAL UNION ALL SELECT 13 AS nid, 24.121309045735764 AS "E" FROM DUAL UNION ALL SELECT 14 AS nid, 18.900387696177468 AS "E" FROM DUAL) "Values"), 
"DT_Output_1" AS 
...
"DT_node_data_2" AS 
(SELECT "Values".nid AS nid, CAST("Values"."E" AS BINARY_DOUBLE) AS "E" 
FROM (SELECT 3 AS nid, 6.390535756426625 AS "E" FROM DUAL UNION ALL SELECT 4 AS nid, 11.762807430332275 AS "E" FROM DUAL UNION ALL SELECT 6 AS nid, 16.62135112393742 AS "E" FROM DUAL UNION ALL SELECT 7 AS nid, 23.693970395239383 AS "E" FROM DUAL UNION ALL SELECT 10 AS nid, 13.283041611951388 AS "E" FROM DUAL UNION ALL SELECT 11 AS nid, 18.705200260853758 AS "E" FROM DUAL UNION ALL SELECT 13 AS nid, 18.520728123777474 AS "E" FROM DUAL UNION ALL SELECT 14 AS nid, 22.083801758207265 AS "E" FROM DUAL) "Values"), 
"DT_Output_2" AS 
...
"DT_node_data_3" AS 
(SELECT "Values".nid AS nid, CAST("Values"."E" AS BINARY_DOUBLE) AS "E" 
FROM (SELECT 3 AS nid, 8.136348380598148 AS "E" FROM DUAL UNION ALL SELECT 4 AS nid, 15.858066789184889 AS "E" FROM DUAL UNION ALL SELECT 6 AS nid, 14.397970646627817 AS "E" FROM DUAL UNION ALL SELECT 7 AS nid, 18.970449127439544 AS "E" FROM DUAL UNION ALL SELECT 10 AS nid, 14.302644720397842 AS "E" FROM DUAL UNION ALL SELECT 11 AS nid, 11.868082094679432 AS "E" FROM DUAL UNION ALL SELECT 13 AS nid, 13.455276821939162 AS "E" FROM DUAL UNION ALL SELECT 14 AS nid, 20.67940396773559 AS "E" FROM DUAL) "Values"), 
"DT_Output_3" AS 
...
"DT_node_data_4" AS 
(SELECT "Values".nid AS nid, CAST("Values"."E" AS BINARY_DOUBLE) AS "E" 
FROM (SELECT 3 AS nid, 7.164708422831759 AS "E" FROM DUAL UNION ALL SELECT 4 AS nid, 10.131789617052231 AS "E" FROM DUAL UNION ALL SELECT 6 AS nid, 13.911320667815804 AS "E" FROM DUAL UNION ALL SELECT 7 AS nid, 18.377623053610236 AS "E" FROM DUAL UNION ALL SELECT 10 AS nid, 17.591009984785604 AS "E" FROM DUAL UNION ALL SELECT 11 AS nid, 24.891578342407303 AS "E" FROM DUAL UNION ALL SELECT 13 AS nid, 9.735041217996262 AS "E" FROM DUAL UNION ALL SELECT 14 AS nid, 12.760129264370008 AS "E" FROM DUAL) "Values"), 
"DT_Output_4" AS 
...
"DT_node_data_5" AS 
(SELECT "Values".nid AS nid, CAST("Values"."E" AS BINARY_DOUBLE) AS "E" 
FROM (SELECT 3 AS nid, 8.338897071859385 AS "E" FROM DUAL UNION ALL SELECT 4 AS nid, 12.585661309165012 AS "E" FROM DUAL UNION ALL SELECT 6 AS nid, 16.866642141163844 AS "E" FROM DUAL UNION ALL SELECT 7 AS nid, 20.014322406211242 AS "E" FROM DUAL UNION ALL SELECT 10 AS nid, 16.54478677328689 AS "E" FROM DUAL UNION ALL SELECT 11 AS nid, 11.278641750854856 AS "E" FROM DUAL UNION ALL SELECT 13 AS nid, 15.993851491279953 AS "E" FROM DUAL UNION ALL SELECT 14 AS nid, 22.826162334588 AS "E" FROM DUAL) "Values"), 
"DT_Output_5" AS 
...
"DT_node_data_6" AS 
(SELECT "Values".nid AS nid, CAST("Values"."E" AS BINARY_DOUBLE) AS "E" 
FROM (SELECT 3 AS nid, 12.595464262752419 AS "E" FROM DUAL UNION ALL SELECT 4 AS nid, 17.42633590328741 AS "E" FROM DUAL UNION ALL SELECT 6 AS nid, 13.342747497232347 AS "E" FROM DUAL UNION ALL SELECT 7 AS nid, 8.599400184796023 AS "E" FROM DUAL UNION ALL SELECT 10 AS nid, 15.308483991007721 AS "E" FROM DUAL UNION ALL SELECT 11 AS nid, 11.860016705250542 AS "E" FROM DUAL UNION ALL SELECT 13 AS nid, 16.443728602186205 AS "E" FROM DUAL UNION ALL SELECT 14 AS nid, 19.882622968509114 AS "E" FROM DUAL) "Values"), 
"DT_Output_6" AS 
...
"DT_node_data_7" AS 
(SELECT "Values".nid AS nid, CAST("Values"."E" AS BINARY_DOUBLE) AS "E" 
FROM (SELECT 3 AS nid, 10.94895415393129 AS "E" FROM DUAL UNION ALL SELECT 4 AS nid, 7.260669944487352 AS "E" FROM DUAL UNION ALL SELECT 6 AS nid, 18.695635887820288 AS "E" FROM DUAL UNION ALL SELECT 7 AS nid, 13.985256317059017 AS "E" FROM DUAL UNION ALL SELECT 10 AS nid, 9.549583624035378 AS "E" FROM DUAL UNION ALL SELECT 11 AS nid, 11.471182882103852 AS "E" FROM DUAL UNION ALL SELECT 13 AS nid, 18.56162832703596 AS "E" FROM DUAL UNION ALL SELECT 14 AS nid, 21.540404060617437 AS "E" FROM DUAL) "Values"), 
"DT_Output_7" AS 
...
"DT_node_data_8" AS 
(SELECT "Values".nid AS nid, CAST("Values"."E" AS BINARY_DOUBLE) AS "E" 
FROM (SELECT 3 AS nid, 10.052439937241036 AS "E" FROM DUAL UNION ALL SELECT 4 AS nid, 6.449781817277611 AS "E" FROM DUAL UNION ALL SELECT 6 AS nid, 12.485240268478293 AS "E" FROM DUAL UNION ALL SELECT 7 AS nid, 19.808409991600072 AS "E" FROM DUAL UNION ALL SELECT 10 AS nid, 14.536245187358322 AS "E" FROM DUAL UNION ALL SELECT 11 AS nid, 12.423411759463056 AS "E" FROM DUAL UNION ALL SELECT 13 AS nid, 17.78981671222573 AS "E" FROM DUAL UNION ALL SELECT 14 AS nid, 21.498446695430406 AS "E" FROM DUAL) "Values"), 
"DT_Output_8" AS 
...
"DT_node_data_9" AS 
(SELECT "Values".nid AS nid, CAST("Values"."E" AS BINARY_DOUBLE) AS "E" 
FROM (SELECT 3 AS nid, 11.90948021138629 AS "E" FROM DUAL UNION ALL SELECT 4 AS nid, 17.231922397914737 AS "E" FROM DUAL UNION ALL SELECT 6 AS nid, 6.990506673547558 AS "E" FROM DUAL UNION ALL SELECT 7 AS nid, 10.95573020235244 AS "E" FROM DUAL UNION ALL SELECT 10 AS nid, 17.41278188627197 AS "E" FROM DUAL UNION ALL SELECT 11 AS nid, 11.766125447580091 AS "E" FROM DUAL UNION ALL SELECT 13 AS nid, 15.189044377231586 AS "E" FROM DUAL UNION ALL SELECT 14 AS nid, 22.86966194942791 AS "E" FROM DUAL) "Values"), 
"DT_Output_9" AS 
...
"DT_node_data_10" AS 
(SELECT "Values".nid AS nid, CAST("Values"."E" AS BINARY_DOUBLE) AS "E" 
FROM (SELECT 3 AS nid, 6.7384031095263905 AS "E" FROM DUAL UNION ALL SELECT 4 AS nid, 11.752927183529824 AS "E" FROM DUAL UNION ALL SELECT 6 AS nid, 10.763360117743344 AS "E" FROM DUAL UNION ALL SELECT 7 AS nid, 18.074528428073364 AS "E" FROM DUAL UNION ALL SELECT 10 AS nid, 17.078177502322482 AS "E" FROM DUAL UNION ALL SELECT 11 AS nid, 23.693970395239383 AS "E" FROM DUAL UNION ALL SELECT 13 AS nid, 20.134116626100056 AS "E" FROM DUAL UNION ALL SELECT 14 AS nid, 23.18131440832091 AS "E" FROM DUAL) "Values"), 
"DT_Output_10" AS 
...
"DT_node_data_11" AS 
(SELECT "Values".nid AS nid, CAST("Values"."E" AS BINARY_DOUBLE) AS "E" 
FROM (SELECT 3 AS nid, 7.8366307170001175 AS "E" FROM DUAL UNION ALL SELECT 4 AS nid, 12.882177460158417 AS "E" FROM DUAL UNION ALL SELECT 6 AS nid, 12.810220702138997 AS "E" FROM DUAL UNION ALL SELECT 7 AS nid, 18.954608923364916 AS "E" FROM DUAL UNION ALL SELECT 10 AS nid, 23.06101058117155 AS "E" FROM DUAL UNION ALL SELECT 11 AS nid, 18.037378593929937 AS "E" FROM DUAL UNION ALL SELECT 13 AS nid, 23.23168268252753 AS "E" FROM DUAL UNION ALL SELECT 14 AS nid, 25.15083662496389 AS "E" FROM DUAL) "Values"), 
"DT_Output_11" AS 
...
"DT_node_data_12" AS 
(SELECT "Values".nid AS nid, CAST("Values"."E" AS BINARY_DOUBLE) AS "E" 
FROM (SELECT 3 AS nid, 6.392901461382325 AS "E" FROM DUAL UNION ALL SELECT 4 AS nid, 9.549583624035378 AS "E" FROM DUAL UNION ALL SELECT 6 AS nid, 11.079712881100889 AS "E" FROM DUAL UNION ALL SELECT 7 AS nid, 16.694311753230085 AS "E" FROM DUAL UNION ALL SELECT 10 AS nid, 12.423411759463056 AS "E" FROM DUAL UNION ALL SELECT 11 AS nid, 16.9994398670528 AS "E" FROM DUAL UNION ALL SELECT 13 AS nid, 24.01582078608117 AS "E" FROM DUAL UNION ALL SELECT 14 AS nid, 18.306954978921546 AS "E" FROM DUAL) "Values"), 
"DT_Output_12" AS 
...
"DT_node_data_13" AS 
(SELECT "Values".nid AS nid, CAST("Values"."E" AS BINARY_DOUBLE) AS "E" 
FROM (SELECT 3 AS nid, 6.357795525185893 AS "E" FROM DUAL UNION ALL SELECT 4 AS nid, 10.038408168333754 AS "E" FROM DUAL UNION ALL SELECT 6 AS nid, 16.404095381550448 AS "E" FROM DUAL UNION ALL SELECT 7 AS nid, 11.12897125170135 AS "E" FROM DUAL UNION ALL SELECT 10 AS nid, 10.181631174833692 AS "E" FROM DUAL UNION ALL SELECT 11 AS nid, 16.995769642220143 AS "E" FROM DUAL UNION ALL SELECT 13 AS nid, 19.613868253758056 AS "E" FROM DUAL UNION ALL SELECT 14 AS nid, 23.250448269296612 AS "E" FROM DUAL) "Values"), 
"DT_Output_13" AS 
...
"DT_node_data_14" AS 
(SELECT "Values".nid AS nid, CAST("Values"."E" AS BINARY_DOUBLE) AS "E" 
FROM (SELECT 3 AS nid, 9.933415417524246 AS "E" FROM DUAL UNION ALL SELECT 4 AS nid, 7.064840674234973 AS "E" FROM DUAL UNION ALL SELECT 5 AS nid, 17.89244707919063 AS "E" FROM DUAL UNION ALL SELECT 8 AS nid, 9.60822446553016 AS "E" FROM DUAL UNION ALL SELECT 9 AS nid, 16.4174377999376 AS "E" FROM DUAL UNION ALL SELECT 11 AS nid, 15.422782995512641 AS "E" FROM DUAL UNION ALL SELECT 12 AS nid, 22.159414410239958 AS "E" FROM DUAL) "Values"), 
"DT_Output_14" AS 
...
"DT_node_data_15" AS 
(SELECT "Values".nid AS nid, CAST("Values"."E" AS BINARY_DOUBLE) AS "E" 
FROM (SELECT 3 AS nid, 16.128071583870984 AS "E" FROM DUAL UNION ALL SELECT 4 AS nid, 22.088070107878004 AS "E" FROM DUAL UNION ALL SELECT 6 AS nid, 10.055721967905004 AS "E" FROM DUAL UNION ALL SELECT 7 AS nid, 21.021444371224298 AS "E" FROM DUAL UNION ALL SELECT 10 AS nid, 12.951620116436871 AS "E" FROM DUAL UNION ALL SELECT 11 AS nid, 18.78950979027687 AS "E" FROM DUAL UNION ALL SELECT 13 AS nid, 19.303788312018888 AS "E" FROM DUAL UNION ALL SELECT 14 AS nid, 24.739343229309082 AS "E" FROM DUAL) "Values"), 
"DT_Output_15" AS 
...
FROM "TMP_20180602_ZM1_QUANTILES" "Quantiles"