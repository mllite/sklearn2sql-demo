...
-- Code For temporary table MP_20180602_NGN_KERNAGG_B0 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "MP_20180602_NGN_KERNAGG_B0" (
	"KEY" NUMBER(19), 
...
-- Code For temporary table MP_20180602_NGN_KERNAGG_B0 part 2. Populate

INSERT INTO "MP_20180602_NGN_KERNAGG_B0" ("KEY", "OVO_Class1", "OVO_Class2", "OVO_Decision", "OVO_Conf") SELECT "U"."KEY", "U"."OVO_Class1", "U"."OVO_Class2", "U"."OVO_Decision", "U"."OVO_Conf" 
...
-- Code For temporary table MP_20180602_9BZ_KERNAGG_B1 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "MP_20180602_9BZ_KERNAGG_B1" (
	"KEY" NUMBER(19), 
	"OVO_Class1" NUMBER(19), 
	"OVO_Class2" NUMBER(19), 
	"OVO_Decision" NUMBER(19), 
...
-- Code For temporary table MP_20180602_9BZ_KERNAGG_B1 part 2. Populate

INSERT INTO "MP_20180602_9BZ_KERNAGG_B1" ("KEY", "OVO_Class1", "OVO_Class2", "OVO_Decision", "OVO_Conf") SELECT "U"."KEY", "U"."OVO_Class1", "U"."OVO_Class2", "U"."OVO_Decision", "U"."OVO_Conf" 
FROM (WITH kernel_input AS 
(SELECT "ADS"."KEY" AS "KEY", CAST("ADS"."Feature_0" AS BINARY_DOUBLE) AS "Feature_0", CAST("ADS"."Feature_1" AS BINARY_DOUBLE) AS "Feature_1", CAST("ADS"."Feature_2" AS BINARY_DOUBLE) AS "Feature_2", CAST("ADS"."Feature_3" AS BINARY_DOUBLE) AS "Feature_3", CAST("ADS"."TGT" AS BINARY_DOUBLE) AS "TGT" 
FROM "IRIS" "ADS"), 
"SV_data_0_2" AS 
...
-- Code For temporary table MP_20180602_S5D_KERNAGG_B2 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "MP_20180602_S5D_KERNAGG_B2" (
	"KEY" NUMBER(19), 
	"OVO_Class1" NUMBER(19), 
	"OVO_Class2" NUMBER(19), 
	"OVO_Decision" NUMBER(19), 
...
-- Code For temporary table MP_20180602_S5D_KERNAGG_B2 part 2. Populate

INSERT INTO "MP_20180602_S5D_KERNAGG_B2" ("KEY", "OVO_Class1", "OVO_Class2", "OVO_Decision", "OVO_Conf") SELECT "U"."KEY", "U"."OVO_Class1", "U"."OVO_Class2", "U"."OVO_Decision", "U"."OVO_Conf" 
FROM (WITH kernel_input AS 
(SELECT "ADS"."KEY" AS "KEY", CAST("ADS"."Feature_0" AS BINARY_DOUBLE) AS "Feature_0", CAST("ADS"."Feature_1" AS BINARY_DOUBLE) AS "Feature_1", CAST("ADS"."Feature_2" AS BINARY_DOUBLE) AS "Feature_2", CAST("ADS"."Feature_3" AS BINARY_DOUBLE) AS "Feature_3", CAST("ADS"."TGT" AS BINARY_DOUBLE) AS "TGT" 
FROM "IRIS" "ADS"), 
"SV_data_1_2" AS 
...
-- Code For temporary table P_20180602_L2G_KERNAGG_AGG part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "P_20180602_L2G_KERNAGG_AGG" (
	"KEY" NUMBER(19), 
...
-- Code For temporary table P_20180602_L2G_KERNAGG_AGG part 2. Populate

INSERT INTO "P_20180602_L2G_KERNAGG_AGG" ("KEY", "OVO_Vote_0", "OVO_SumConfidence_0", "OVO_Vote_1", "OVO_SumConfidence_1", "OVO_Vote_2", "OVO_SumConfidence_2", max_abs_confidence, "OVO_Scale", "Score_0", "Score_1", "Score_2") SELECT "U"."KEY", "U"."OVO_Vote_0", "U"."OVO_SumConfidence_0", "U"."OVO_Vote_1", "U"."OVO_SumConfidence_1", "U"."OVO_Vote_2", "U"."OVO_SumConfidence_2", "U".max_abs_confidence, "U"."OVO_Scale", "U"."Score_0", "U"."Score_1", "U"."Score_2" 
...
FROM "MP_20180602_NGN_KERNAGG_B0" "KernAgg_B0" UNION ALL SELECT "KernAgg_B1"."KEY" AS "KEY", "KernAgg_B1"."OVO_Class1" AS "OVO_Class1", "KernAgg_B1"."OVO_Class2" AS "OVO_Class2", "KernAgg_B1"."OVO_Decision" AS "OVO_Decision", "KernAgg_B1"."OVO_Conf" AS "OVO_Conf" 
FROM "MP_20180602_9BZ_KERNAGG_B1" "KernAgg_B1" UNION ALL SELECT "KernAgg_B2"."KEY" AS "KEY", "KernAgg_B2"."OVO_Class1" AS "OVO_Class1", "KernAgg_B2"."OVO_Class2" AS "OVO_Class2", "KernAgg_B2"."OVO_Decision" AS "OVO_Decision", "KernAgg_B2"."OVO_Conf" AS "OVO_Conf" 
FROM "MP_20180602_S5D_KERNAGG_B2" "KernAgg_B2") "KernAgg_EnsembleUnion"), 
"OVO_Votes" AS 
...
FROM "P_20180602_L2G_KERNAGG_AGG" "KernAgg_agg"), 
