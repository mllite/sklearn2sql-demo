...
-- Code For temporary table tmp_20180602142837_n67_xgb_b0 part 1. Create 


CREATE TABLE tmp_20180602142837_n67_xgb_b0 (
	`KEY` BIGINT, 
	`Score_0` DOUBLE
)
...
-- Code For temporary table tmp_20180602142837_n67_xgb_b0 part 2. Populate
...
FROM `DT_Output_9`)
 INSERT INTO tmp_20180602142837_n67_xgb_b0 (`KEY`, `Score_0`) SELECT `XGB_B0`.`KEY`, `XGB_B0`.`Score_0` 
...
-- Code For temporary table tmp_20180602142837_fta_xgb_b1 part 1. Create 


CREATE TABLE tmp_20180602142837_fta_xgb_b1 (
	`KEY` BIGINT, 
	`Score_0` DOUBLE
)
...
-- Code For temporary table tmp_20180602142837_fta_xgb_b1 part 2. Populate
...
FROM `DT_Output_15`)
 INSERT INTO tmp_20180602142837_fta_xgb_b1 (`KEY`, `Score_0`) SELECT `XGB_B1`.`KEY`, `XGB_B1`.`Score_0` 
...
-- Code For temporary table tmp_20180602142837_gqy_xgb_sum part 1. Create 


CREATE TABLE tmp_20180602142837_gqy_xgb_sum (
	`KEY` BIGINT, 
	`Score_0` DOUBLE
)
...
-- Code For temporary table tmp_20180602142837_gqy_xgb_sum part 2. Populate
...
FROM tmp_20180602142837_n67_xgb_b0 AS `XGB_B0` UNION ALL SELECT `XGB_B1`.`KEY` AS `KEY`, `XGB_B1`.`Score_0` AS `Score_0` 
FROM tmp_20180602142837_fta_xgb_b1 AS `XGB_B1`) AS `XGB_EnsembleUnion`)
 INSERT INTO tmp_20180602142837_gqy_xgb_sum (`KEY`, `Score_0`) SELECT `XGB_sum`.`KEY`, `XGB_sum`.`Score_0` 
...
FROM tmp_20180602142837_gqy_xgb_sum AS `XGB_sum`), 
