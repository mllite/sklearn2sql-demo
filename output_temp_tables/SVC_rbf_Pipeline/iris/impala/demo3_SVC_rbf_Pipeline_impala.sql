...
-- Code For temporary table tmp_20180602153031_5gt_ads_imp_1_out part 1. Create 


CREATE TABLE tmp_20180602153031_5gt_ads_imp_1_out (
	`KEY` BIGINT, 
...
-- Code For temporary table tmp_20180602153031_5gt_ads_imp_1_out part 2. Populate

INSERT INTO tmp_20180602153031_5gt_ads_imp_1_out (`KEY`, imputer_output_2, imputer_output_3, imputer_output_4, imputer_output_5) SELECT `ADS_imp_1_OUT`.`KEY`, `ADS_imp_1_OUT`.imputer_output_2, `ADS_imp_1_OUT`.imputer_output_3, `ADS_imp_1_OUT`.imputer_output_4, `ADS_imp_1_OUT`.imputer_output_5 
FROM (SELECT `ADS`.`KEY` AS `KEY`, CASE WHEN (`ADS`.`Feature_0` IS NULL) THEN 5.8474999999999975 ELSE `ADS`.`Feature_0` END AS imputer_output_2, CASE WHEN (`ADS`.`Feature_1` IS NULL) THEN 3.0366666666666657 ELSE `ADS`.`Feature_1` END AS imputer_output_3, CASE WHEN (`ADS`.`Feature_2` IS NULL) THEN 3.8450000000000006 ELSE `ADS`.`Feature_2` END AS imputer_output_4, CASE WHEN (`ADS`.`Feature_3` IS NULL) THEN 1.245 ELSE `ADS`.`Feature_3` END AS imputer_output_5 
FROM iris AS `ADS`) AS `ADS_imp_1_OUT`

-- Code For temporary table tmp_20180602153031_wfl_ads_sca_2_out part 1. Create 


CREATE TABLE tmp_20180602153031_wfl_ads_sca_2_out (
	`KEY` BIGINT, 
...
-- Code For temporary table tmp_20180602153031_wfl_ads_sca_2_out part 2. Populate

INSERT INTO tmp_20180602153031_wfl_ads_sca_2_out (`KEY`, scaler_output_2, scaler_output_3, scaler_output_4, scaler_output_5) SELECT `ADS_sca_2_OUT`.`KEY`, `ADS_sca_2_OUT`.scaler_output_2, `ADS_sca_2_OUT`.scaler_output_3, `ADS_sca_2_OUT`.scaler_output_4, `ADS_sca_2_OUT`.scaler_output_5 
...
FROM tmp_20180602153031_5gt_ads_imp_1_out AS `ADS_imp_1_OUT`) AS `ADS_sca_2_OUT`

-- Code For temporary table tmp_20180602153031_gou_kernagg_b0 part 1. Create 


CREATE TABLE tmp_20180602153031_gou_kernagg_b0 (
	`KEY` BIGINT, 
	`OVO_Class1` BIGINT, 
	`OVO_Class2` BIGINT, 
	`OVO_Decision` BIGINT, 
...
-- Code For temporary table tmp_20180602153031_gou_kernagg_b0 part 2. Populate
...
FROM tmp_20180602153031_wfl_ads_sca_2_out AS `ADS_sca_2_OUT`), 
`SV_data_0_1` AS 
...
kernel_cte_0_1 AS 
(SELECT kernel_dp_0_1.`KEY` AS `KEY`, 0 AS `OVO_Class1`, 1 AS `OVO_Class2`, CASE WHEN (-kernel_dp_0_1.dot_product >= 0.0) THEN 1 ELSE 0 END AS `OVO_Decision`, coalesce(-kernel_dp_0_1.dot_product, 1.0 / (1.0 + exp(CASE WHEN (CASE WHEN (-100.0 <= -(-((-kernel_dp_0_1.dot_product) * -3.372681844552797 + -0.19981768936597305))) THEN -(-((-kernel_dp_0_1.dot_product) * -3.372681844552797 + -0.19981768936597305)) ELSE -100.0 END <= 100.0) THEN CASE WHEN (-100.0 <= -(-((-kernel_dp_0_1.dot_product) * -3.372681844552797 + -0.19981768936597305))) THEN -(-((-kernel_dp_0_1.dot_product) * -3.372681844552797 + -0.19981768936597305)) ELSE -100.0 END ELSE 100.0 END))) AS `OVO_Conf` 
FROM kernel_dp_0_1)
 INSERT INTO tmp_20180602153031_gou_kernagg_b0 (`KEY`, `OVO_Class1`, `OVO_Class2`, `OVO_Decision`, `OVO_Conf`) SELECT `KernAgg_B0`.`KEY`, `KernAgg_B0`.`OVO_Class1`, `KernAgg_B0`.`OVO_Class2`, `KernAgg_B0`.`OVO_Decision`, `KernAgg_B0`.`OVO_Conf` 
...
-- Code For temporary table tmp_20180602153031_10i_kernagg_b1 part 1. Create 


CREATE TABLE tmp_20180602153031_10i_kernagg_b1 (
	`KEY` BIGINT, 
	`OVO_Class1` BIGINT, 
	`OVO_Class2` BIGINT, 
	`OVO_Decision` BIGINT, 
...
-- Code For temporary table tmp_20180602153031_10i_kernagg_b1 part 2. Populate
...
kernel_cte_0_2 AS 
(SELECT kernel_dp_0_2.`KEY` AS `KEY`, 0 AS `OVO_Class1`, 2 AS `OVO_Class2`, CASE WHEN (-kernel_dp_0_2.dot_product >= 0.0) THEN 1 ELSE 0 END AS `OVO_Decision`, coalesce(-kernel_dp_0_2.dot_product, 1.0 / (1.0 + exp(CASE WHEN (CASE WHEN (-100.0 <= -(-((-kernel_dp_0_2.dot_product) * -3.5875715408098325 + 0.011249584139668933))) THEN -(-((-kernel_dp_0_2.dot_product) * -3.5875715408098325 + 0.011249584139668933)) ELSE -100.0 END <= 100.0) THEN CASE WHEN (-100.0 <= -(-((-kernel_dp_0_2.dot_product) * -3.5875715408098325 + 0.011249584139668933))) THEN -(-((-kernel_dp_0_2.dot_product) * -3.5875715408098325 + 0.011249584139668933)) ELSE -100.0 END ELSE 100.0 END))) AS `OVO_Conf` 
FROM kernel_dp_0_2)
 INSERT INTO tmp_20180602153031_10i_kernagg_b1 (`KEY`, `OVO_Class1`, `OVO_Class2`, `OVO_Decision`, `OVO_Conf`) SELECT `KernAgg_B1`.`KEY`, `KernAgg_B1`.`OVO_Class1`, `KernAgg_B1`.`OVO_Class2`, `KernAgg_B1`.`OVO_Decision`, `KernAgg_B1`.`OVO_Conf` 
...
-- Code For temporary table tmp_20180602153031_4p5_kernagg_b2 part 1. Create 


CREATE TABLE tmp_20180602153031_4p5_kernagg_b2 (
	`KEY` BIGINT, 
	`OVO_Class1` BIGINT, 
	`OVO_Class2` BIGINT, 
	`OVO_Decision` BIGINT, 
...
-- Code For temporary table tmp_20180602153031_4p5_kernagg_b2 part 2. Populate
...
kernel_cte_1_2 AS 
(SELECT kernel_dp_1_2.`KEY` AS `KEY`, 1 AS `OVO_Class1`, 2 AS `OVO_Class2`, CASE WHEN (-kernel_dp_1_2.dot_product >= 0.0) THEN 1 ELSE 0 END AS `OVO_Decision`, coalesce(-kernel_dp_1_2.dot_product, 1.0 / (1.0 + exp(CASE WHEN (CASE WHEN (-100.0 <= -(-((-kernel_dp_1_2.dot_product) * -3.8320605106150567 + 0.31686122473950074))) THEN -(-((-kernel_dp_1_2.dot_product) * -3.8320605106150567 + 0.31686122473950074)) ELSE -100.0 END <= 100.0) THEN CASE WHEN (-100.0 <= -(-((-kernel_dp_1_2.dot_product) * -3.8320605106150567 + 0.31686122473950074))) THEN -(-((-kernel_dp_1_2.dot_product) * -3.8320605106150567 + 0.31686122473950074)) ELSE -100.0 END ELSE 100.0 END))) AS `OVO_Conf` 
FROM kernel_dp_1_2)
 INSERT INTO tmp_20180602153031_4p5_kernagg_b2 (`KEY`, `OVO_Class1`, `OVO_Class2`, `OVO_Decision`, `OVO_Conf`) SELECT `KernAgg_B2`.`KEY`, `KernAgg_B2`.`OVO_Class1`, `KernAgg_B2`.`OVO_Class2`, `KernAgg_B2`.`OVO_Decision`, `KernAgg_B2`.`OVO_Conf` 
...
-- Code For temporary table tmp_20180602153031_a94_kernagg_agg part 1. Create 


CREATE TABLE tmp_20180602153031_a94_kernagg_agg (
	`KEY` BIGINT, 
	`OVO_Vote_0` BIGINT, 
...
-- Code For temporary table tmp_20180602153031_a94_kernagg_agg part 2. Populate
...
FROM tmp_20180602153031_gou_kernagg_b0 AS `KernAgg_B0` UNION ALL SELECT `KernAgg_B1`.`KEY` AS `KEY`, `KernAgg_B1`.`OVO_Class1` AS `OVO_Class1`, `KernAgg_B1`.`OVO_Class2` AS `OVO_Class2`, `KernAgg_B1`.`OVO_Decision` AS `OVO_Decision`, `KernAgg_B1`.`OVO_Conf` AS `OVO_Conf` 
FROM tmp_20180602153031_10i_kernagg_b1 AS `KernAgg_B1` UNION ALL SELECT `KernAgg_B2`.`KEY` AS `KEY`, `KernAgg_B2`.`OVO_Class1` AS `OVO_Class1`, `KernAgg_B2`.`OVO_Class2` AS `OVO_Class2`, `KernAgg_B2`.`OVO_Decision` AS `OVO_Decision`, `KernAgg_B2`.`OVO_Conf` AS `OVO_Conf` 
FROM tmp_20180602153031_4p5_kernagg_b2 AS `KernAgg_B2`) AS `KernAgg_EnsembleUnion`), 
`OVO_Votes` AS 
...
FROM `OVO_Votes`, `MinMaxConf`)
 INSERT INTO tmp_20180602153031_a94_kernagg_agg (`KEY`, `OVO_Vote_0`, `OVO_SumConfidence_0`, `OVO_Vote_1`, `OVO_SumConfidence_1`, `OVO_Vote_2`, `OVO_SumConfidence_2`, max_abs_confidence, `OVO_Scale`, `Score_0`, `Score_1`, `Score_2`) SELECT `KernAgg_agg`.`KEY`, `KernAgg_agg`.`OVO_Vote_0`, `KernAgg_agg`.`OVO_SumConfidence_0`, `KernAgg_agg`.`OVO_Vote_1`, `KernAgg_agg`.`OVO_SumConfidence_1`, `KernAgg_agg`.`OVO_Vote_2`, `KernAgg_agg`.`OVO_SumConfidence_2`, `KernAgg_agg`.max_abs_confidence, `KernAgg_agg`.`OVO_Scale`, `KernAgg_agg`.`Score_0`, `KernAgg_agg`.`Score_1`, `KernAgg_agg`.`Score_2` 
...
FROM tmp_20180602153031_a94_kernagg_agg AS `KernAgg_agg`), 
