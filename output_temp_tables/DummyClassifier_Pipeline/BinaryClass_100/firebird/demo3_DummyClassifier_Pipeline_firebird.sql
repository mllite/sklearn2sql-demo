...
-- Code For temporary table TMP_20180602_CQH_ADS_IMP_1_OUT part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180602_CQH_ADS_IMP_1_OUT" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20180602_CQH_ADS_IMP_1_OUT part 3. Create Index 

CREATE INDEX "ix_TMP_20180602_CQH_ADS_988b" ON "TMP_20180602_CQH_ADS_IMP_1_OUT" ("KEY")

-- Code For temporary table TMP_20180602_BW0_ADS_SCA_2_OUT part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180602_BW0_ADS_SCA_2_OUT" (
	"KEY" BIGINT NOT NULL, 
...
FROM "TMP_20180602_CQH_ADS_IMP_1_OUT" AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT") AS "U"

-- Code For temporary table TMP_20180602_BW0_ADS_SCA_2_OUT part 3. Create Index 

CREATE INDEX "ix_TMP_20180602_BW0_ADS_e376" ON "TMP_20180602_BW0_ADS_SCA_2_OUT" ("KEY")

-- Model deployment code

WITH random_number_cte AS 
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", rand AS uniform 
FROM "TMP_20180602_BW0_ADS_SCA_2_OUT" AS "ADS_sca_2_OUT"), 
multinomial_cte AS 
