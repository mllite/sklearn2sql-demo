...
-- Code For temporary table TMP_20180602_K11_ADS_IMP_1_OUT part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180602_K11_ADS_IMP_1_OUT" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20180602_K11_ADS_IMP_1_OUT part 3. Create Index 

CREATE INDEX "ix_TMP_20180602_K11_ADS_e257" ON "TMP_20180602_K11_ADS_IMP_1_OUT" ("KEY")

-- Code For temporary table TMP_20180602_72E_ADS_SCA_2_OUT part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180602_72E_ADS_SCA_2_OUT" (
	"KEY" BIGINT NOT NULL, 
...
FROM "TMP_20180602_K11_ADS_IMP_1_OUT" AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT") AS "U"

-- Code For temporary table TMP_20180602_72E_ADS_SCA_2_OUT part 3. Create Index 

CREATE INDEX "ix_TMP_20180602_72E_ADS_0513" ON "TMP_20180602_72E_ADS_SCA_2_OUT" ("KEY")

-- Model deployment code

WITH dummy_class_reg_cte AS 
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", -11.471614782695335 AS "Constant" 
FROM "TMP_20180602_72E_ADS_SCA_2_OUT" AS "ADS_sca_2_OUT")
