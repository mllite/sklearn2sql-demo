...
-- Code For temporary table 20180602_BJB_ADS_IMP_1_OUT part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "20180602_BJB_ADS_IMP_1_OUT" (
	"KEY" NUMBER(19), 
...
-- Code For temporary table 20180602_ABP_ADS_SCA_2_OUT part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "20180602_ABP_ADS_SCA_2_OUT" (
	"KEY" NUMBER(19), 
...
FROM "20180602_BJB_ADS_IMP_1_OUT" "ADS_imp_1_OUT") "ADS_sca_2_OUT") "U"

-- Model deployment code

WITH dummy_class_reg_cte AS 
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", 22.5789603960396 AS "Constant" 
FROM "20180602_ABP_ADS_SCA_2_OUT" "ADS_sca_2_OUT")
