...
-- Code For temporary table ##TMP_20180602142003_NX9_ADS_imp_1_OUT part 1. Create 


CREATE TABLE ##TMP_20180602142003_NX9_ADS_imp_1_OUT (
	[KEY] BIGINT NULL, 
...
-- Code For temporary table ##TMP_20180602142003_BGP_ADS_sca_2_OUT part 1. Create 


CREATE TABLE ##TMP_20180602142003_BGP_ADS_sca_2_OUT (
	[KEY] BIGINT NULL, 
	scaler_2 FLOAT NULL, 
	scaler_3 FLOAT NULL, 
	scaler_4 FLOAT NULL, 
...
FROM ##TMP_20180602142003_NX9_ADS_imp_1_OUT AS [ADS_imp_1_OUT]) AS [ADS_sca_2_OUT]

-- Code For temporary table ##TMP_20180602142004_L4Z_RF_B0 part 1. Create 


CREATE TABLE ##TMP_20180602142004_L4Z_RF_B0 (
	[KEY] BIGINT NULL, 
...
-- Code For temporary table ##TMP_20180602142004_L4Z_RF_B0 part 2. Populate
...
FROM ##TMP_20180602142003_BGP_ADS_sca_2_OUT AS [ADS_sca_2_OUT]), 
[DT_node_data] AS 
...
FROM [DT_Output_9])
 INSERT INTO ##TMP_20180602142004_L4Z_RF_B0 ([KEY], [Score_0], [Proba_0], [LogProba_0], [Score_1], [Proba_1], [LogProba_1]) SELECT [RF_B0].[KEY], [RF_B0].[Score_0], [RF_B0].[Proba_0], [RF_B0].[LogProba_0], [RF_B0].[Score_1], [RF_B0].[Proba_1], [RF_B0].[LogProba_1] 
...
-- Code For temporary table ##TMP_20180602142004_Q87_RF_B1 part 1. Create 


CREATE TABLE ##TMP_20180602142004_Q87_RF_B1 (
	[KEY] BIGINT NULL, 
	[Score_0] FLOAT(53) NULL, 
	[Proba_0] FLOAT(53) NULL, 
	[LogProba_0] FLOAT(53) NULL, 
...
-- Code For temporary table ##TMP_20180602142004_Q87_RF_B1 part 2. Populate
...
FROM [DT_Output_15])
 INSERT INTO ##TMP_20180602142004_Q87_RF_B1 ([KEY], [Score_0], [Proba_0], [LogProba_0], [Score_1], [Proba_1], [LogProba_1]) SELECT [RF_B1].[KEY], [RF_B1].[Score_0], [RF_B1].[Proba_0], [RF_B1].[LogProba_0], [RF_B1].[Score_1], [RF_B1].[Proba_1], [RF_B1].[LogProba_1] 
...
-- Code For temporary table ##TMP_20180602142004_R5Y_RF_avg part 1. Create 


CREATE TABLE ##TMP_20180602142004_R5Y_RF_avg (
	[KEY] BIGINT NULL, 
	[Score_0] FLOAT(53) NULL, 
	[Proba_0] FLOAT(53) NULL, 
	[LogProba_0] FLOAT(53) NULL, 
...
-- Code For temporary table ##TMP_20180602142004_R5Y_RF_avg part 2. Populate
...
FROM ##TMP_20180602142004_L4Z_RF_B0 AS [RF_B0] UNION ALL SELECT [RF_B1].[KEY] AS [KEY], [RF_B1].[Score_0] AS [Score_0], [RF_B1].[Proba_0] AS [Proba_0], [RF_B1].[LogProba_0] AS [LogProba_0], [RF_B1].[Score_1] AS [Score_1], [RF_B1].[Proba_1] AS [Proba_1], [RF_B1].[LogProba_1] AS [LogProba_1] 
FROM ##TMP_20180602142004_Q87_RF_B1 AS [RF_B1]) AS [RF_EnsembleUnion])
 INSERT INTO ##TMP_20180602142004_R5Y_RF_avg ([KEY], [Score_0], [Proba_0], [LogProba_0], [Score_1], [Proba_1], [LogProba_1]) SELECT [RF_avg].[KEY], [RF_avg].[Score_0], [RF_avg].[Proba_0], [RF_avg].[LogProba_0], [RF_avg].[Score_1], [RF_avg].[Proba_1], [RF_avg].[LogProba_1] 
...
FROM ##TMP_20180602142004_R5Y_RF_avg AS [RF_avg]), 
