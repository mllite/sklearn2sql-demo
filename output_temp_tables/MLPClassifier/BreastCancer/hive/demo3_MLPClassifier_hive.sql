...
-- Code For temporary table tmp_20180602142605_d7g_hl_1_relu_1 part 1. Create 

CREATE TEMPORARY TABLE `tmp_20180602142605_d7g_hl_1_relu_1` STORED AS ORC AS WITH `IL` AS 
...
-- Code For temporary table tmp_20180602142605_d7g_hl_1_relu_1 part 2. Populate

SELECT * FROM `tmp_20180602142605_d7g_hl_1_relu_1`

-- Code For temporary table tmp_20180602142605_zib_ol_logistic_1 part 1. Create 

CREATE TEMPORARY TABLE `tmp_20180602142605_zib_ol_logistic_1` STORED AS ORC AS WITH `HL_BA_2` AS 
...
FROM `tmp_20180602142605_d7g_hl_1_relu_1` AS `HL_1_relu_1`), 
`HL_2_relu` AS 
...
-- Code For temporary table tmp_20180602142605_zib_ol_logistic_1 part 2. Populate

SELECT * FROM `tmp_20180602142605_zib_ol_logistic_1`
...
FROM `tmp_20180602142605_zib_ol_logistic_1` AS `OL_logistic_1`), 
