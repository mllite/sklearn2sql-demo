...
-- Code For temporary table TMP_20180602160417_WPB_HL_1_relu_1 part 1. Create 


CREATE TEMPORARY TABLE `TMP_20180602160417_WPB_HL_1_relu_1` (
	`KEY` BIGINT NOT NULL, 
	`NEUR_1_1` DOUBLE, 
	`NEUR_1_2` DOUBLE, 
	`NEUR_1_3` DOUBLE, 
...
-- Code For temporary table TMP_20180602160417_WPB_HL_1_relu_1 part 2. Populate

INSERT INTO `TMP_20180602160417_WPB_HL_1_relu_1` (`KEY`, `NEUR_1_1`, `NEUR_1_2`, `NEUR_1_3`) SELECT `U`.`KEY`, `U`.`NEUR_1_1`, `U`.`NEUR_1_2`, `U`.`NEUR_1_3` 
FROM (WITH `IL` AS 
...
-- Code For temporary table TMP_20180602160417_WPB_HL_1_relu_1 part 3. Create Index 

CREATE INDEX `ix_TMP_20180602160417_WPB_HL_1_relu_1_KEY` ON `TMP_20180602160417_WPB_HL_1_relu_1` (`KEY`)

-- Code For temporary table TMP_20180602160417_0Z2_OL_softmax_1 part 1. Create 


CREATE TEMPORARY TABLE `TMP_20180602160417_0Z2_OL_softmax_1` (
	`KEY` BIGINT NOT NULL, 
	`NEUR_3_1` DOUBLE, 
	`NEUR_3_2` DOUBLE, 
	`NEUR_3_3` DOUBLE, 
...
-- Code For temporary table TMP_20180602160417_0Z2_OL_softmax_1 part 2. Populate

INSERT INTO `TMP_20180602160417_0Z2_OL_softmax_1` (`KEY`, `NEUR_3_1`, `NEUR_3_2`, `NEUR_3_3`) SELECT `U`.`KEY`, `U`.`NEUR_3_1`, `U`.`NEUR_3_2`, `U`.`NEUR_3_3` 
...
FROM `TMP_20180602160417_WPB_HL_1_relu_1` AS `HL_1_relu_1`), 
`HL_2_relu` AS 
...
-- Code For temporary table TMP_20180602160417_0Z2_OL_softmax_1 part 3. Create Index 

CREATE INDEX `ix_TMP_20180602160417_0Z2_OL_softmax_1_KEY` ON `TMP_20180602160417_0Z2_OL_softmax_1` (`KEY`)
...
FROM `TMP_20180602160417_0Z2_OL_softmax_1` AS `OL_softmax_1`), 
