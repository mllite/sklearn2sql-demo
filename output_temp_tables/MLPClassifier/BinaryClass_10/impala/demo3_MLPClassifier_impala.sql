...
-- Code For temporary table tmp_20180602141338_595_hl_1_relu_1 part 1. Create 


CREATE TABLE tmp_20180602141338_595_hl_1_relu_1 (
	`KEY` BIGINT, 
	`NEUR_1_1` DOUBLE, 
	`NEUR_1_2` DOUBLE, 
	`NEUR_1_3` DOUBLE
...
-- Code For temporary table tmp_20180602141338_595_hl_1_relu_1 part 2. Populate
...
FROM `HL_BA_1`)
 INSERT INTO tmp_20180602141338_595_hl_1_relu_1 (`KEY`, `NEUR_1_1`, `NEUR_1_2`, `NEUR_1_3`) SELECT `HL_1_relu_1`.`KEY`, `HL_1_relu_1`.`NEUR_1_1`, `HL_1_relu_1`.`NEUR_1_2`, `HL_1_relu_1`.`NEUR_1_3` 
FROM (SELECT `HL_1_relu`.`KEY` AS `KEY`, `HL_1_relu`.`NEUR_1_1` AS `NEUR_1_1`, `HL_1_relu`.`NEUR_1_2` AS `NEUR_1_2`, `HL_1_relu`.`NEUR_1_3` AS `NEUR_1_3` 
FROM `HL_1_relu`) AS `HL_1_relu_1`

-- Code For temporary table tmp_20180602141338_hb8_ol_logistic_1 part 1. Create 


CREATE TABLE tmp_20180602141338_hb8_ol_logistic_1 (
	`KEY` BIGINT, 
	`NEUR_3_1` DOUBLE
)
...
-- Code For temporary table tmp_20180602141338_hb8_ol_logistic_1 part 2. Populate
...
FROM tmp_20180602141338_595_hl_1_relu_1 AS `HL_1_relu_1`), 
`HL_2_relu` AS 
...
FROM `OL_BA`)
 INSERT INTO tmp_20180602141338_hb8_ol_logistic_1 (`KEY`, `NEUR_3_1`) SELECT `OL_logistic_1`.`KEY`, `OL_logistic_1`.`NEUR_3_1` 
...
FROM tmp_20180602141338_hb8_ol_logistic_1 AS `OL_logistic_1`), 
