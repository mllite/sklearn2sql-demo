...
-- Code For temporary table TMP_20180602_B3W_ADS_IMP_1_OUT part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180602_B3W_ADS_IMP_1_OUT" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20180602_B3W_ADS_IMP_1_OUT part 3. Create Index 

CREATE INDEX "ix_TMP_20180602_B3W_ADS_f433" ON "TMP_20180602_B3W_ADS_IMP_1_OUT" ("KEY")

-- Code For temporary table TMP_20180602_850_ADS_SCA_2_OUT part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180602_850_ADS_SCA_2_OUT" (
	"KEY" BIGINT NOT NULL, 
...
FROM "TMP_20180602_B3W_ADS_IMP_1_OUT" AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT") AS "U"

-- Code For temporary table TMP_20180602_850_ADS_SCA_2_OUT part 3. Create Index 

CREATE INDEX "ix_TMP_20180602_850_ADS_935b" ON "TMP_20180602_850_ADS_SCA_2_OUT" ("KEY")

-- Code For temporary table TMP_20180602_30E_CALPROB_B0 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180602_30E_CALPROB_B0" (
	"KEY" BIGINT, 
...
-- Code For temporary table TMP_20180602_30E_CALPROB_B0 part 2. Populate

INSERT INTO "TMP_20180602_30E_CALPROB_B0" ("KEY", "Proba_1", "Proba_0") SELECT "U"."KEY", "U"."Proba_1", "U"."Proba_0" 
...
FROM "TMP_20180602_850_ADS_SCA_2_OUT" AS "ADS_sca_2_OUT"), 
"DT_node_data" AS 
...
-- Code For temporary table TMP_20180602_O14_CALPROB_AVG part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180602_O14_CALPROB_AVG" (
	"KEY" BIGINT NOT NULL, 
	"Proba_1" DOUBLE PRECISION, 
	"Proba_0" DOUBLE PRECISION, 
	PRIMARY KEY ("KEY")
...
-- Code For temporary table TMP_20180602_O14_CALPROB_AVG part 2. Populate

INSERT INTO "TMP_20180602_O14_CALPROB_AVG" ("KEY", "Proba_1", "Proba_0") SELECT "U"."KEY", "U"."Proba_1", "U"."Proba_0" 
...
FROM "TMP_20180602_30E_CALPROB_B0" AS "CalProb_B0") AS "CalProb_EnsembleUnion")
...
-- Code For temporary table TMP_20180602_O14_CALPROB_AVG part 3. Create Index 

CREATE INDEX "ix_TMP_20180602_O14_CAL_cd3c" ON "TMP_20180602_O14_CALPROB_AVG" ("KEY")
...
FROM "TMP_20180602_O14_CALPROB_AVG" AS "CalProb_avg"), 
