...
-- Code For temporary table 20180602_JZ2_ADS_IMP_1_OUT part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "20180602_JZ2_ADS_IMP_1_OUT" (
	"KEY" NUMBER(19), 
...
-- Code For temporary table 20180602_WZM_ADS_SCA_2_OUT part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "20180602_WZM_ADS_SCA_2_OUT" (
	"KEY" NUMBER(19), 
...
FROM "20180602_JZ2_ADS_IMP_1_OUT" "ADS_imp_1_OUT") "ADS_sca_2_OUT") "U"

-- Code For temporary table MP_20180602_T4G_CALPROB_B0 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "MP_20180602_T4G_CALPROB_B0" (
	"KEY" NUMBER(19), 
...
-- Code For temporary table MP_20180602_T4G_CALPROB_B0 part 2. Populate

INSERT INTO "MP_20180602_T4G_CALPROB_B0" ("KEY", "Proba_1", "Proba_0") SELECT "U"."KEY", "U"."Proba_1", "U"."Proba_0" 
...
FROM "20180602_WZM_ADS_SCA_2_OUT" "ADS_sca_2_OUT"), 
"DT_node_data" AS 
...
-- Code For temporary table P_20180602_ZNF_CALPROB_AVG part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "P_20180602_ZNF_CALPROB_AVG" (
	"KEY" NUMBER(19), 
	"Proba_1" BINARY_DOUBLE, 
	"Proba_0" BINARY_DOUBLE
)
...
-- Code For temporary table P_20180602_ZNF_CALPROB_AVG part 2. Populate

INSERT INTO "P_20180602_ZNF_CALPROB_AVG" ("KEY", "Proba_1", "Proba_0") SELECT "U"."KEY", "U"."Proba_1", "U"."Proba_0" 
...
FROM "MP_20180602_T4G_CALPROB_B0" "CalProb_B0") "CalProb_EnsembleUnion")
...
FROM "P_20180602_ZNF_CALPROB_AVG" "CalProb_avg"), 
