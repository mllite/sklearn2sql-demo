...
-- Code For temporary table tmp_20180602141134_cje_ads_imp_1_out part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180602141134_cje_ads_imp_1_out (
	"KEY" BIGINT, 
	impter_2 DOUBLE, 
	impter_3 DOUBLE, 
	impter_4 DOUBLE, 
...
-- Code For temporary table tmp_20180602141134_4zf_ads_sca_2_out part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180602141134_4zf_ads_sca_2_out (
	"KEY" BIGINT, 
	scaler_2 DOUBLE, 
	scaler_3 DOUBLE, 
	scaler_4 DOUBLE, 
...
-- Code For temporary table tmp_20180602141134_4zf_ads_sca_2_out part 2. Populate

INSERT INTO tmp_20180602141134_4zf_ads_sca_2_out SELECT "ADS_sca_2_OUT"."KEY", "ADS_sca_2_OUT".scaler_2, "ADS_sca_2_OUT".scaler_3, "ADS_sca_2_OUT".scaler_4, "ADS_sca_2_OUT".scaler_5, "ADS_sca_2_OUT".scaler_6, "ADS_sca_2_OUT".scaler_7, "ADS_sca_2_OUT".scaler_8, "ADS_sca_2_OUT".scaler_9, "ADS_sca_2_OUT".scaler_10, "ADS_sca_2_OUT".scaler_11 
...
FROM tmp_20180602141134_cje_ads_imp_1_out AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT"

-- Code For temporary table tmp_20180602141135_kxg_calprob_b0 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180602141135_kxg_calprob_b0 (
	"KEY" BIGINT, 
	"Proba_1" DOUBLE, 
	"Proba_0" DOUBLE
)
...
-- Code For temporary table tmp_20180602141135_kxg_calprob_b0 part 2. Populate

INSERT INTO tmp_20180602141135_kxg_calprob_b0 WITH "DT_node_lookup" AS 
...
FROM tmp_20180602141134_4zf_ads_sca_2_out AS "ADS_sca_2_OUT"), 
"DT_node_data" AS 
...
-- Code For temporary table tmp_20180602141135_l7r_calprob_avg part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180602141135_l7r_calprob_avg (
	"KEY" BIGINT, 
	"Proba_1" DOUBLE, 
	"Proba_0" DOUBLE
)
...
-- Code For temporary table tmp_20180602141135_l7r_calprob_avg part 2. Populate

INSERT INTO tmp_20180602141135_l7r_calprob_avg WITH "CalProb_Union" AS 
...
FROM tmp_20180602141135_kxg_calprob_b0 AS "CalProb_B0") AS "CalProb_EnsembleUnion")
...
FROM tmp_20180602141135_l7r_calprob_avg AS "CalProb_avg"), 
