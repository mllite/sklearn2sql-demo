...
-- Code For temporary table TMP_20180602143011_DKF_ADS_imp_1_OUT part 1. Create 


CREATE TEMPORARY TABLE "TMP_20180602143011_DKF_ADS_imp_1_OUT" (
	"KEY" BIGINT NOT NULL, 
	impter_2 FLOAT, 
	impter_3 FLOAT, 
	impter_4 FLOAT, 
...
-- Code For temporary table TMP_20180602143011_DKF_ADS_imp_1_OUT part 2. Populate

INSERT INTO "TMP_20180602143011_DKF_ADS_imp_1_OUT" ("KEY", impter_2, impter_3, impter_4, impter_5, impter_6, impter_7, impter_8, impter_9, impter_10, impter_11) SELECT "ADS_imp_1_OUT"."KEY", "ADS_imp_1_OUT".impter_2, "ADS_imp_1_OUT".impter_3, "ADS_imp_1_OUT".impter_4, "ADS_imp_1_OUT".impter_5, "ADS_imp_1_OUT".impter_6, "ADS_imp_1_OUT".impter_7, "ADS_imp_1_OUT".impter_8, "ADS_imp_1_OUT".impter_9, "ADS_imp_1_OUT".impter_10, "ADS_imp_1_OUT".impter_11 
...
-- Code For temporary table TMP_20180602143011_DKF_ADS_imp_1_OUT part 3. Create Index 

CREATE INDEX "ix_TMP_20180602143011_DKF_ADS_imp_1_OUT_KEY" ON "TMP_20180602143011_DKF_ADS_imp_1_OUT" ("KEY")

-- Code For temporary table TMP_20180602143011_P0A_ADS_sca_2_OUT part 1. Create 


CREATE TEMPORARY TABLE "TMP_20180602143011_P0A_ADS_sca_2_OUT" (
	"KEY" BIGINT NOT NULL, 
	scaler_2 FLOAT, 
	scaler_3 FLOAT, 
	scaler_4 FLOAT, 
...
-- Code For temporary table TMP_20180602143011_P0A_ADS_sca_2_OUT part 2. Populate

INSERT INTO "TMP_20180602143011_P0A_ADS_sca_2_OUT" ("KEY", scaler_2, scaler_3, scaler_4, scaler_5, scaler_6, scaler_7, scaler_8, scaler_9, scaler_10, scaler_11) SELECT "ADS_sca_2_OUT"."KEY", "ADS_sca_2_OUT".scaler_2, "ADS_sca_2_OUT".scaler_3, "ADS_sca_2_OUT".scaler_4, "ADS_sca_2_OUT".scaler_5, "ADS_sca_2_OUT".scaler_6, "ADS_sca_2_OUT".scaler_7, "ADS_sca_2_OUT".scaler_8, "ADS_sca_2_OUT".scaler_9, "ADS_sca_2_OUT".scaler_10, "ADS_sca_2_OUT".scaler_11 
...
FROM "TMP_20180602143011_DKF_ADS_imp_1_OUT" AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT"

-- Code For temporary table TMP_20180602143011_P0A_ADS_sca_2_OUT part 3. Create Index 

CREATE INDEX "ix_TMP_20180602143011_P0A_ADS_sca_2_OUT_KEY" ON "TMP_20180602143011_P0A_ADS_sca_2_OUT" ("KEY")

-- Code For temporary table TMP_20180602143011_WX7_CalProb_B0 part 1. Create 


CREATE TEMPORARY TABLE "TMP_20180602143011_WX7_CalProb_B0" (
	"KEY" BIGINT, 
	"Proba_0" FLOAT, 
	"Proba_1" FLOAT, 
	"Proba_2" FLOAT, 
...
-- Code For temporary table TMP_20180602143011_WX7_CalProb_B0 part 2. Populate
...
FROM "TMP_20180602143011_P0A_ADS_sca_2_OUT" AS "ADS_sca_2_OUT"), 
"DT_node_data" AS 
...
FROM isotonic_cte_3)
 INSERT INTO "TMP_20180602143011_WX7_CalProb_B0" ("KEY", "Proba_0", "Proba_1", "Proba_2", "Proba_3") SELECT "CalProb_B0"."KEY", "CalProb_B0"."Proba_0", "CalProb_B0"."Proba_1", "CalProb_B0"."Proba_2", "CalProb_B0"."Proba_3" 
...
-- Code For temporary table TMP_20180602143011_F8I_CalProb_avg part 1. Create 


CREATE TEMPORARY TABLE "TMP_20180602143011_F8I_CalProb_avg" (
	"KEY" BIGINT NOT NULL, 
	"Proba_0" FLOAT, 
	"Proba_1" FLOAT, 
	"Proba_2" FLOAT, 
...
-- Code For temporary table TMP_20180602143011_F8I_CalProb_avg part 2. Populate
...
FROM "TMP_20180602143011_WX7_CalProb_B0" AS "CalProb_B0") AS "CalProb_EnsembleUnion")
 INSERT INTO "TMP_20180602143011_F8I_CalProb_avg" ("KEY", "Proba_0", "Proba_1", "Proba_2", "Proba_3") SELECT "CalProb_avg"."KEY", "CalProb_avg"."Proba_0", "CalProb_avg"."Proba_1", "CalProb_avg"."Proba_2", "CalProb_avg"."Proba_3" 
...
-- Code For temporary table TMP_20180602143011_F8I_CalProb_avg part 3. Create Index 

CREATE INDEX "ix_TMP_20180602143011_F8I_CalProb_avg_KEY" ON "TMP_20180602143011_F8I_CalProb_avg" ("KEY")
...
FROM "TMP_20180602143011_F8I_CalProb_avg" AS "CalProb_avg"), 
