...
-- Code For temporary table 20180602_4KB_ADS_IMP_1_OUT part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "20180602_4KB_ADS_IMP_1_OUT" (
	"KEY" NUMBER(19), 
...
-- Code For temporary table 20180602_4KB_ADS_IMP_1_OUT part 2. Populate

INSERT INTO "20180602_4KB_ADS_IMP_1_OUT" ("KEY", impter_2, impter_3, impter_4, impter_5, impter_6, impter_7, impter_8, impter_9, impter_10, impter_11) SELECT "U"."KEY", "U".impter_2, "U".impter_3, "U".impter_4, "U".impter_5, "U".impter_6, "U".impter_7, "U".impter_8, "U".impter_9, "U".impter_10, "U".impter_11 
...
-- Code For temporary table 20180602_YIS_ADS_SCA_2_OUT part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "20180602_YIS_ADS_SCA_2_OUT" (
	"KEY" NUMBER(19), 
...
-- Code For temporary table 20180602_YIS_ADS_SCA_2_OUT part 2. Populate

INSERT INTO "20180602_YIS_ADS_SCA_2_OUT" ("KEY", scaler_2, scaler_3, scaler_4, scaler_5, scaler_6, scaler_7, scaler_8, scaler_9, scaler_10, scaler_11) SELECT "U"."KEY", "U".scaler_2, "U".scaler_3, "U".scaler_4, "U".scaler_5, "U".scaler_6, "U".scaler_7, "U".scaler_8, "U".scaler_9, "U".scaler_10, "U".scaler_11 
...
FROM "20180602_4KB_ADS_IMP_1_OUT" "ADS_imp_1_OUT") "ADS_sca_2_OUT") "U"

-- Code For temporary table MP_20180602_9DA_CALPROB_B0 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "MP_20180602_9DA_CALPROB_B0" (
	"KEY" NUMBER(19), 
...
-- Code For temporary table MP_20180602_9DA_CALPROB_B0 part 2. Populate

INSERT INTO "MP_20180602_9DA_CALPROB_B0" ("KEY", "Proba_0", "Proba_1", "Proba_2", "Proba_3") SELECT "U"."KEY", "U"."Proba_0", "U"."Proba_1", "U"."Proba_2", "U"."Proba_3" 
...
FROM "20180602_YIS_ADS_SCA_2_OUT" "ADS_sca_2_OUT"), 
"DT_node_data" AS 
...
-- Code For temporary table P_20180602_MMM_CALPROB_AVG part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "P_20180602_MMM_CALPROB_AVG" (
	"KEY" NUMBER(19), 
	"Proba_0" BINARY_DOUBLE, 
	"Proba_1" BINARY_DOUBLE, 
	"Proba_2" BINARY_DOUBLE, 
...
-- Code For temporary table P_20180602_MMM_CALPROB_AVG part 2. Populate

INSERT INTO "P_20180602_MMM_CALPROB_AVG" ("KEY", "Proba_0", "Proba_1", "Proba_2", "Proba_3") SELECT "U"."KEY", "U"."Proba_0", "U"."Proba_1", "U"."Proba_2", "U"."Proba_3" 
...
FROM "MP_20180602_9DA_CALPROB_B0" "CalProb_B0") "CalProb_EnsembleUnion")
...
FROM "P_20180602_MMM_CALPROB_AVG" "CalProb_avg"), 
