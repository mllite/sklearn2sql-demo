...
-- Code For temporary table tmp_20180602143011_pwd_ads_imp_1_out part 1. Create 


CREATE TABLE tmp_20180602143011_pwd_ads_imp_1_out (
	`KEY` BIGINT, 
	impter_2 DOUBLE, 
	impter_3 DOUBLE, 
	impter_4 DOUBLE, 
...
-- Code For temporary table tmp_20180602143011_pwd_ads_imp_1_out part 2. Populate

INSERT INTO tmp_20180602143011_pwd_ads_imp_1_out (`KEY`, impter_2, impter_3, impter_4, impter_5, impter_6, impter_7, impter_8, impter_9, impter_10, impter_11) SELECT `ADS_imp_1_OUT`.`KEY`, `ADS_imp_1_OUT`.impter_2, `ADS_imp_1_OUT`.impter_3, `ADS_imp_1_OUT`.impter_4, `ADS_imp_1_OUT`.impter_5, `ADS_imp_1_OUT`.impter_6, `ADS_imp_1_OUT`.impter_7, `ADS_imp_1_OUT`.impter_8, `ADS_imp_1_OUT`.impter_9, `ADS_imp_1_OUT`.impter_10, `ADS_imp_1_OUT`.impter_11 
...
-- Code For temporary table tmp_20180602143011_30i_ads_sca_2_out part 1. Create 


CREATE TABLE tmp_20180602143011_30i_ads_sca_2_out (
	`KEY` BIGINT, 
	scaler_2 DOUBLE, 
	scaler_3 DOUBLE, 
	scaler_4 DOUBLE, 
...
FROM tmp_20180602143011_pwd_ads_imp_1_out AS `ADS_imp_1_OUT`) AS `ADS_sca_2_OUT`

-- Code For temporary table tmp_20180602143011_ash_calprob_b0 part 1. Create 


CREATE TABLE tmp_20180602143011_ash_calprob_b0 (
	`KEY` BIGINT, 
	`Proba_0` DOUBLE, 
	`Proba_1` DOUBLE, 
	`Proba_2` DOUBLE, 
...
-- Code For temporary table tmp_20180602143011_ash_calprob_b0 part 2. Populate
...
FROM tmp_20180602143011_30i_ads_sca_2_out AS `ADS_sca_2_OUT`), 
`DT_node_data` AS 
...
FROM isotonic_cte_3)
 INSERT INTO tmp_20180602143011_ash_calprob_b0 (`KEY`, `Proba_0`, `Proba_1`, `Proba_2`, `Proba_3`) SELECT `CalProb_B0`.`KEY`, `CalProb_B0`.`Proba_0`, `CalProb_B0`.`Proba_1`, `CalProb_B0`.`Proba_2`, `CalProb_B0`.`Proba_3` 
...
-- Code For temporary table tmp_20180602143011_qeu_calprob_avg part 1. Create 


CREATE TABLE tmp_20180602143011_qeu_calprob_avg (
	`KEY` BIGINT, 
	`Proba_0` DOUBLE, 
	`Proba_1` DOUBLE, 
	`Proba_2` DOUBLE, 
...
-- Code For temporary table tmp_20180602143011_qeu_calprob_avg part 2. Populate
...
FROM tmp_20180602143011_ash_calprob_b0 AS `CalProb_B0`) AS `CalProb_EnsembleUnion`)
 INSERT INTO tmp_20180602143011_qeu_calprob_avg (`KEY`, `Proba_0`, `Proba_1`, `Proba_2`, `Proba_3`) SELECT `CalProb_avg`.`KEY`, `CalProb_avg`.`Proba_0`, `CalProb_avg`.`Proba_1`, `CalProb_avg`.`Proba_2`, `CalProb_avg`.`Proba_3` 
...
FROM tmp_20180602143011_qeu_calprob_avg AS `CalProb_avg`), 
