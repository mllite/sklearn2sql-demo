...
-- Code For temporary table tmp_20180602142221_ze0_ads_imp_1_out part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180602142221_ze0_ads_imp_1_out  (
	"KEY" BIGINT, 
...
-- Code For temporary table tmp_20180602142221_q7e_ads_sca_2_out part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180602142221_q7e_ads_sca_2_out  (
	"KEY" BIGINT, 
...
FROM tmp_20180602142221_ze0_ads_imp_1_out AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT") AS "U"

-- Code For temporary table tmp_20180602142222_sia_xgb_b0 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180602142222_sia_xgb_b0  (
	"KEY" BIGINT, 
...
-- Code For temporary table tmp_20180602142222_sia_xgb_b0 part 2. Populate

INSERT INTO tmp_20180602142222_sia_xgb_b0 ("KEY", "Score_0") SELECT "U"."KEY", "U"."Score_0" 
...
FROM tmp_20180602142221_q7e_ads_sca_2_out AS "ADS_sca_2_OUT"), 
dummy_cte AS 
...
-- Code For temporary table tmp_20180602142222_6eh_xgb_b1 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180602142222_6eh_xgb_b1  (
	"KEY" BIGINT, 
	"Score_0" DOUBLE PRECISION
)
...
-- Code For temporary table tmp_20180602142222_6eh_xgb_b1 part 2. Populate

INSERT INTO tmp_20180602142222_6eh_xgb_b1 ("KEY", "Score_0") SELECT "U"."KEY", "U"."Score_0" 
...
-- Code For temporary table tmp_20180602142222_t4a_xgb_sum part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180602142222_t4a_xgb_sum  (
	"KEY" BIGINT, 
	"Score_0" DOUBLE PRECISION
)
...
-- Code For temporary table tmp_20180602142222_t4a_xgb_sum part 2. Populate

INSERT INTO tmp_20180602142222_t4a_xgb_sum ("KEY", "Score_0") SELECT "U"."KEY", "U"."Score_0" 
...
FROM tmp_20180602142222_sia_xgb_b0 AS "XGB_B0" UNION ALL SELECT "XGB_B1"."KEY" AS "KEY", "XGB_B1"."Score_0" AS "Score_0" 
FROM tmp_20180602142222_6eh_xgb_b1 AS "XGB_B1") AS "XGB_EnsembleUnion")
...
FROM tmp_20180602142222_t4a_xgb_sum AS "XGB_sum"), 
