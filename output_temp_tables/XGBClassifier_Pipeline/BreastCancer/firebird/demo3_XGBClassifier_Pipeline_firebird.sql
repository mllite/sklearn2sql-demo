...
-- Code For temporary table TMP_20180602_FZB_ADS_IMP_1_OUT part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180602_FZB_ADS_IMP_1_OUT" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20180602_FZB_ADS_IMP_1_OUT part 3. Create Index 

CREATE INDEX "ix_TMP_20180602_FZB_ADS_afb5" ON "TMP_20180602_FZB_ADS_IMP_1_OUT" ("KEY")

-- Code For temporary table TMP_20180602_IEK_ADS_SCA_2_OUT part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180602_IEK_ADS_SCA_2_OUT" (
	"KEY" BIGINT NOT NULL, 
...
FROM "TMP_20180602_FZB_ADS_IMP_1_OUT" AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT") AS "U"

-- Code For temporary table TMP_20180602_IEK_ADS_SCA_2_OUT part 3. Create Index 

CREATE INDEX "ix_TMP_20180602_IEK_ADS_d9b3" ON "TMP_20180602_IEK_ADS_SCA_2_OUT" ("KEY")

-- Code For temporary table TMP_20180602_LPH_XGB_B0 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180602_LPH_XGB_B0" (
	"KEY" BIGINT, 
...
-- Code For temporary table TMP_20180602_LPH_XGB_B0 part 2. Populate

INSERT INTO "TMP_20180602_LPH_XGB_B0" ("KEY", "Score_0") SELECT "U"."KEY", "U"."Score_0" 
...
FROM "TMP_20180602_IEK_ADS_SCA_2_OUT" AS "ADS_sca_2_OUT"), 
"DT_node_data" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE PRECISION) AS "Score" 
FROM (SELECT 3 AS nid, 0.1926199346780777 AS "Score" FROM rdb$database UNION ALL SELECT 4 AS nid, 0.03478261083364487 AS "Score" FROM rdb$database UNION ALL SELECT 5 AS nid, -0.12727272510528564 AS "Score" FROM rdb$database UNION ALL SELECT 6 AS nid, -0.19272726774215698 AS "Score" FROM rdb$database) AS "Values"), 
"DT_Output" AS 
...
"DT_node_data_1" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE PRECISION) AS "Score" 
FROM (SELECT 3 AS nid, 0.17632412910461426 AS "Score" FROM rdb$database UNION ALL SELECT 4 AS nid, 0.028210192918777466 AS "Score" FROM rdb$database UNION ALL SELECT 5 AS nid, -0.11695275455713272 AS "Score" FROM rdb$database UNION ALL SELECT 6 AS nid, -0.17597316205501556 AS "Score" FROM rdb$database) AS "Values"), 
"DT_Output_1" AS 
...
"DT_node_data_2" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE PRECISION) AS "Score" 
FROM (SELECT 2 AS nid, -0.15892711281776428 AS "Score" FROM rdb$database UNION ALL SELECT 3 AS nid, 0.16254661977291107 AS "Score" FROM rdb$database UNION ALL SELECT 4 AS nid, 0.0025618381332606077 AS "Score" FROM rdb$database) AS "Values"), 
"DT_Output_2" AS 
...
"DT_node_data_3" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE PRECISION) AS "Score" 
FROM (SELECT 3 AS nid, 0.1533551663160324 AS "Score" FROM rdb$database UNION ALL SELECT 4 AS nid, 0.02111710235476494 AS "Score" FROM rdb$database UNION ALL SELECT 5 AS nid, -0.1014096662402153 AS "Score" FROM rdb$database UNION ALL SELECT 6 AS nid, -0.15645359456539154 AS "Score" FROM rdb$database) AS "Values"), 
"DT_Output_3" AS 
...
"DT_node_data_4" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE PRECISION) AS "Score" 
FROM (SELECT 2 AS nid, -0.14159958064556122 AS "Score" FROM rdb$database UNION ALL SELECT 3 AS nid, 0.14474166929721832 AS "Score" FROM rdb$database UNION ALL SELECT 4 AS nid, 0.007800843566656113 AS "Score" FROM rdb$database) AS "Values"), 
"DT_Output_4" AS 
...
-- Code For temporary table TMP_20180602_0AZ_XGB_B1 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180602_0AZ_XGB_B1" (
	"KEY" BIGINT, 
	"Score_0" DOUBLE PRECISION
)
...
-- Code For temporary table TMP_20180602_0AZ_XGB_B1 part 2. Populate

INSERT INTO "TMP_20180602_0AZ_XGB_B1" ("KEY", "Score_0") SELECT "U"."KEY", "U"."Score_0" 
...
"DT_node_data_5" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE PRECISION) AS "Score" 
FROM (SELECT 2 AS nid, -0.14109736680984497 AS "Score" FROM rdb$database UNION ALL SELECT 3 AS nid, 0.1364816427230835 AS "Score" FROM rdb$database UNION ALL SELECT 4 AS nid, -0.014269627630710602 AS "Score" FROM rdb$database) AS "Values"), 
"DT_Output_5" AS 
...
"DT_node_data_6" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE PRECISION) AS "Score" 
FROM (SELECT 3 AS nid, 0.13363148272037506 AS "Score" FROM rdb$database UNION ALL SELECT 4 AS nid, 0.020645752549171448 AS "Score" FROM rdb$database UNION ALL SELECT 5 AS nid, -0.07329749315977097 AS "Score" FROM rdb$database UNION ALL SELECT 6 AS nid, -0.13540911674499512 AS "Score" FROM rdb$database) AS "Values"), 
"DT_Output_6" AS 
...
"DT_node_data_7" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE PRECISION) AS "Score" 
FROM (SELECT 3 AS nid, 0.1283390074968338 AS "Score" FROM rdb$database UNION ALL SELECT 4 AS nid, 0.014707544818520546 AS "Score" FROM rdb$database UNION ALL SELECT 5 AS nid, -0.07714793086051941 AS "Score" FROM rdb$database UNION ALL SELECT 6 AS nid, -0.133819118142128 AS "Score" FROM rdb$database) AS "Values"), 
"DT_Output_7" AS 
...
"DT_node_data_8" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE PRECISION) AS "Score" 
FROM (SELECT 3 AS nid, 0.12476612627506256 AS "Score" FROM rdb$database UNION ALL SELECT 4 AS nid, 0.01592203602194786 AS "Score" FROM rdb$database UNION ALL SELECT 5 AS nid, -0.06960324943065643 AS "Score" FROM rdb$database UNION ALL SELECT 6 AS nid, -0.13226597011089325 AS "Score" FROM rdb$database) AS "Values"), 
"DT_Output_8" AS 
...
"DT_node_data_9" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE PRECISION) AS "Score" 
FROM (SELECT 2 AS nid, -0.12262566387653351 AS "Score" FROM rdb$database UNION ALL SELECT 3 AS nid, 0.11848687380552292 AS "Score" FROM rdb$database UNION ALL SELECT 4 AS nid, -0.006392433773726225 AS "Score" FROM rdb$database) AS "Values"), 
"DT_Output_9" AS 
...
-- Code For temporary table TMP_20180602_7DA_XGB_B2 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180602_7DA_XGB_B2" (
	"KEY" BIGINT, 
	"Score_0" DOUBLE PRECISION
)
...
-- Code For temporary table TMP_20180602_7DA_XGB_B2 part 2. Populate

INSERT INTO "TMP_20180602_7DA_XGB_B2" ("KEY", "Score_0") SELECT "U"."KEY", "U"."Score_0" 
...
"DT_node_data_10" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE PRECISION) AS "Score" 
FROM (SELECT 3 AS nid, 0.11701875180006027 AS "Score" FROM rdb$database UNION ALL SELECT 4 AS nid, 0.016944319009780884 AS "Score" FROM rdb$database UNION ALL SELECT 5 AS nid, -0.07019593566656113 AS "Score" FROM rdb$database UNION ALL SELECT 6 AS nid, -0.12330199778079987 AS "Score" FROM rdb$database) AS "Values"), 
"DT_Output_10" AS 
...
"DT_node_data_11" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE PRECISION) AS "Score" 
FROM (SELECT 3 AS nid, 0.11512360721826553 AS "Score" FROM rdb$database UNION ALL SELECT 4 AS nid, 0.017077675089240074 AS "Score" FROM rdb$database UNION ALL SELECT 5 AS nid, -0.06643888354301453 AS "Score" FROM rdb$database UNION ALL SELECT 6 AS nid, -0.12265763431787491 AS "Score" FROM rdb$database) AS "Values"), 
"DT_Output_11" AS 
...
"DT_node_data_12" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE PRECISION) AS "Score" 
FROM (SELECT 2 AS nid, -0.11374557018280029 AS "Score" FROM rdb$database UNION ALL SELECT 4 AS nid, -0.003493115771561861 AS "Score" FROM rdb$database UNION ALL SELECT 5 AS nid, 0.07863019406795502 AS "Score" FROM rdb$database UNION ALL SELECT 6 AS nid, 0.11759652942419052 AS "Score" FROM rdb$database) AS "Values"), 
"DT_Output_12" AS 
...
"DT_node_data_13" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE PRECISION) AS "Score" 
FROM (SELECT 2 AS nid, -0.10585534572601318 AS "Score" FROM rdb$database UNION ALL SELECT 4 AS nid, -0.0024481695145368576 AS "Score" FROM rdb$database UNION ALL SELECT 5 AS nid, 0.07931221276521683 AS "Score" FROM rdb$database UNION ALL SELECT 6 AS nid, 0.11873737722635269 AS "Score" FROM rdb$database) AS "Values"), 
"DT_Output_13" AS 
...
"DT_node_data_14" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE PRECISION) AS "Score" 
FROM (SELECT 3 AS nid, 0.10965307056903839 AS "Score" FROM rdb$database UNION ALL SELECT 4 AS nid, 0.012755125761032104 AS "Score" FROM rdb$database UNION ALL SELECT 5 AS nid, -0.06810056418180466 AS "Score" FROM rdb$database UNION ALL SELECT 6 AS nid, -0.11264988034963608 AS "Score" FROM rdb$database) AS "Values"), 
"DT_Output_14" AS 
...
-- Code For temporary table TMP_20180602_6Z0_XGB_B3 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180602_6Z0_XGB_B3" (
	"KEY" BIGINT, 
	"Score_0" DOUBLE PRECISION
)
...
-- Code For temporary table TMP_20180602_6Z0_XGB_B3 part 2. Populate

INSERT INTO "TMP_20180602_6Z0_XGB_B3" ("KEY", "Score_0") SELECT "U"."KEY", "U"."Score_0" 
...
"DT_node_data_15" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE PRECISION) AS "Score" 
FROM (SELECT 2 AS nid, -0.10041051357984543 AS "Score" FROM rdb$database UNION ALL SELECT 3 AS nid, 0.1078338772058487 AS "Score" FROM rdb$database UNION ALL SELECT 4 AS nid, 0.0019829440861940384 AS "Score" FROM rdb$database) AS "Values"), 
"DT_Output_15" AS 
...
-- Code For temporary table TMP_20180602_DA2_XGB_SUM part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180602_DA2_XGB_SUM" (
	"KEY" BIGINT NOT NULL, 
	"Score_0" DOUBLE PRECISION, 
	PRIMARY KEY ("KEY")
)
...
-- Code For temporary table TMP_20180602_DA2_XGB_SUM part 2. Populate

INSERT INTO "TMP_20180602_DA2_XGB_SUM" ("KEY", "Score_0") SELECT "U"."KEY", "U"."Score_0" 
...
FROM "TMP_20180602_LPH_XGB_B0" AS "XGB_B0" UNION ALL SELECT "XGB_B1"."KEY" AS "KEY", "XGB_B1"."Score_0" AS "Score_0" 
FROM "TMP_20180602_0AZ_XGB_B1" AS "XGB_B1" UNION ALL SELECT "XGB_B2"."KEY" AS "KEY", "XGB_B2"."Score_0" AS "Score_0" 
FROM "TMP_20180602_7DA_XGB_B2" AS "XGB_B2" UNION ALL SELECT "XGB_B3"."KEY" AS "KEY", "XGB_B3"."Score_0" AS "Score_0" 
FROM "TMP_20180602_6Z0_XGB_B3" AS "XGB_B3") AS "XGB_EnsembleUnion")
...
-- Code For temporary table TMP_20180602_DA2_XGB_SUM part 3. Create Index 

CREATE INDEX "ix_TMP_20180602_DA2_XGB_SUM_KEY" ON "TMP_20180602_DA2_XGB_SUM" ("KEY")
...
FROM "TMP_20180602_DA2_XGB_SUM" AS "XGB_sum"), 
