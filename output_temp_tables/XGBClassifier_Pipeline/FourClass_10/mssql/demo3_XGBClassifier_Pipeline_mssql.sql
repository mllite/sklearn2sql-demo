...
-- Code For temporary table ##TMP_20180602143513_TNH_ADS_imp_1_OUT part 1. Create 


CREATE TABLE ##TMP_20180602143513_TNH_ADS_imp_1_OUT (
	[KEY] BIGINT NULL, 
...
-- Code For temporary table ##TMP_20180602143513_TNH_ADS_imp_1_OUT part 2. Populate

INSERT INTO ##TMP_20180602143513_TNH_ADS_imp_1_OUT ([KEY], impter_2, impter_3, impter_4, impter_5, impter_6, impter_7, impter_8, impter_9, impter_10, impter_11) SELECT [ADS_imp_1_OUT].[KEY], [ADS_imp_1_OUT].impter_2, [ADS_imp_1_OUT].impter_3, [ADS_imp_1_OUT].impter_4, [ADS_imp_1_OUT].impter_5, [ADS_imp_1_OUT].impter_6, [ADS_imp_1_OUT].impter_7, [ADS_imp_1_OUT].impter_8, [ADS_imp_1_OUT].impter_9, [ADS_imp_1_OUT].impter_10, [ADS_imp_1_OUT].impter_11 
...
-- Code For temporary table ##TMP_20180602143513_2YY_ADS_sca_2_OUT part 1. Create 


CREATE TABLE ##TMP_20180602143513_2YY_ADS_sca_2_OUT (
	[KEY] BIGINT NULL, 
	scaler_2 FLOAT NULL, 
	scaler_3 FLOAT NULL, 
	scaler_4 FLOAT NULL, 
...
-- Code For temporary table ##TMP_20180602143513_2YY_ADS_sca_2_OUT part 2. Populate

INSERT INTO ##TMP_20180602143513_2YY_ADS_sca_2_OUT ([KEY], scaler_2, scaler_3, scaler_4, scaler_5, scaler_6, scaler_7, scaler_8, scaler_9, scaler_10, scaler_11) SELECT [ADS_sca_2_OUT].[KEY], [ADS_sca_2_OUT].scaler_2, [ADS_sca_2_OUT].scaler_3, [ADS_sca_2_OUT].scaler_4, [ADS_sca_2_OUT].scaler_5, [ADS_sca_2_OUT].scaler_6, [ADS_sca_2_OUT].scaler_7, [ADS_sca_2_OUT].scaler_8, [ADS_sca_2_OUT].scaler_9, [ADS_sca_2_OUT].scaler_10, [ADS_sca_2_OUT].scaler_11 
...
FROM ##TMP_20180602143513_TNH_ADS_imp_1_OUT AS [ADS_imp_1_OUT]) AS [ADS_sca_2_OUT]

-- Code For temporary table ##TMP_20180602143514_9CX_XGB_B0 part 1. Create 


CREATE TABLE ##TMP_20180602143514_9CX_XGB_B0 (
	[KEY] BIGINT NULL, 
...
-- Code For temporary table ##TMP_20180602143514_9CX_XGB_B0 part 2. Populate

WITH [DT_node_lookup] AS 
(SELECT [ADS_sca_2_OUT].[KEY] AS [KEY], CASE WHEN ([ADS_sca_2_OUT].scaler_6 < 0.055714450776576996) THEN 1 ELSE 2 END AS node_id_2 
FROM ##TMP_20180602143513_2YY_ADS_sca_2_OUT AS [ADS_sca_2_OUT]), 
[DT_node_data] AS 
...
FROM [DT_Output_9])
 INSERT INTO ##TMP_20180602143514_9CX_XGB_B0 ([KEY], [Score_0], [Score_1], [Score_2], [Score_3]) SELECT [XGB_B0].[KEY], [XGB_B0].[Score_0], [XGB_B0].[Score_1], [XGB_B0].[Score_2], [XGB_B0].[Score_3] 
...
-- Code For temporary table ##TMP_20180602143514_YLX_XGB_B1 part 1. Create 


CREATE TABLE ##TMP_20180602143514_YLX_XGB_B1 (
	[KEY] BIGINT NULL, 
	[Score_0] FLOAT(53) NULL, 
	[Score_1] FLOAT(53) NULL, 
	[Score_2] FLOAT(53) NULL, 
...
-- Code For temporary table ##TMP_20180602143514_YLX_XGB_B1 part 2. Populate
...
FROM [DT_Output_19])
 INSERT INTO ##TMP_20180602143514_YLX_XGB_B1 ([KEY], [Score_0], [Score_1], [Score_2], [Score_3]) SELECT [XGB_B1].[KEY], [XGB_B1].[Score_0], [XGB_B1].[Score_1], [XGB_B1].[Score_2], [XGB_B1].[Score_3] 
...
-- Code For temporary table ##TMP_20180602143514_KGB_XGB_B2 part 1. Create 


CREATE TABLE ##TMP_20180602143514_KGB_XGB_B2 (
	[KEY] BIGINT NULL, 
	[Score_0] FLOAT(53) NULL, 
	[Score_1] FLOAT(53) NULL, 
	[Score_2] FLOAT(53) NULL, 
...
-- Code For temporary table ##TMP_20180602143514_KGB_XGB_B2 part 2. Populate
...
FROM [DT_Output_29])
 INSERT INTO ##TMP_20180602143514_KGB_XGB_B2 ([KEY], [Score_0], [Score_1], [Score_2], [Score_3]) SELECT [XGB_B2].[KEY], [XGB_B2].[Score_0], [XGB_B2].[Score_1], [XGB_B2].[Score_2], [XGB_B2].[Score_3] 
...
-- Code For temporary table ##TMP_20180602143514_F6I_XGB_B3 part 1. Create 


CREATE TABLE ##TMP_20180602143514_F6I_XGB_B3 (
	[KEY] BIGINT NULL, 
	[Score_0] FLOAT(53) NULL, 
	[Score_1] FLOAT(53) NULL, 
	[Score_2] FLOAT(53) NULL, 
...
-- Code For temporary table ##TMP_20180602143514_F6I_XGB_B3 part 2. Populate
...
FROM [DT_Output_39])
 INSERT INTO ##TMP_20180602143514_F6I_XGB_B3 ([KEY], [Score_0], [Score_1], [Score_2], [Score_3]) SELECT [XGB_B3].[KEY], [XGB_B3].[Score_0], [XGB_B3].[Score_1], [XGB_B3].[Score_2], [XGB_B3].[Score_3] 
...
-- Code For temporary table ##TMP_20180602143514_AWT_XGB_B4 part 1. Create 


CREATE TABLE ##TMP_20180602143514_AWT_XGB_B4 (
	[KEY] BIGINT NULL, 
	[Score_0] FLOAT(53) NULL, 
	[Score_1] FLOAT(53) NULL, 
	[Score_2] FLOAT(53) NULL, 
...
-- Code For temporary table ##TMP_20180602143514_AWT_XGB_B4 part 2. Populate
...
FROM [DT_Output_49])
 INSERT INTO ##TMP_20180602143514_AWT_XGB_B4 ([KEY], [Score_0], [Score_1], [Score_2], [Score_3]) SELECT [XGB_B4].[KEY], [XGB_B4].[Score_0], [XGB_B4].[Score_1], [XGB_B4].[Score_2], [XGB_B4].[Score_3] 
...
-- Code For temporary table ##TMP_20180602143514_0OP_XGB_B5 part 1. Create 


CREATE TABLE ##TMP_20180602143514_0OP_XGB_B5 (
	[KEY] BIGINT NULL, 
	[Score_0] FLOAT(53) NULL, 
	[Score_1] FLOAT(53) NULL, 
	[Score_2] FLOAT(53) NULL, 
...
-- Code For temporary table ##TMP_20180602143514_0OP_XGB_B5 part 2. Populate
...
FROM [DT_Output_59])
 INSERT INTO ##TMP_20180602143514_0OP_XGB_B5 ([KEY], [Score_0], [Score_1], [Score_2], [Score_3]) SELECT [XGB_B5].[KEY], [XGB_B5].[Score_0], [XGB_B5].[Score_1], [XGB_B5].[Score_2], [XGB_B5].[Score_3] 
...
-- Code For temporary table ##TMP_20180602143514_B5A_XGB_B6 part 1. Create 


CREATE TABLE ##TMP_20180602143514_B5A_XGB_B6 (
	[KEY] BIGINT NULL, 
	[Score_0] FLOAT(53) NULL, 
	[Score_1] FLOAT(53) NULL, 
	[Score_2] FLOAT(53) NULL, 
...
-- Code For temporary table ##TMP_20180602143514_B5A_XGB_B6 part 2. Populate
...
FROM [DT_Output_63])
 INSERT INTO ##TMP_20180602143514_B5A_XGB_B6 ([KEY], [Score_0], [Score_1], [Score_2], [Score_3]) SELECT [XGB_B6].[KEY], [XGB_B6].[Score_0], [XGB_B6].[Score_1], [XGB_B6].[Score_2], [XGB_B6].[Score_3] 
...
-- Code For temporary table ##TMP_20180602143514_OSD_XGB_sum part 1. Create 


CREATE TABLE ##TMP_20180602143514_OSD_XGB_sum (
	[KEY] BIGINT NULL, 
	[Score_0] FLOAT(53) NULL, 
	[Score_1] FLOAT(53) NULL, 
	[Score_2] FLOAT(53) NULL, 
...
-- Code For temporary table ##TMP_20180602143514_OSD_XGB_sum part 2. Populate
...
FROM ##TMP_20180602143514_9CX_XGB_B0 AS [XGB_B0] UNION ALL SELECT [XGB_B1].[KEY] AS [KEY], [XGB_B1].[Score_0] AS [Score_0], [XGB_B1].[Score_1] AS [Score_1], [XGB_B1].[Score_2] AS [Score_2], [XGB_B1].[Score_3] AS [Score_3] 
FROM ##TMP_20180602143514_YLX_XGB_B1 AS [XGB_B1] UNION ALL SELECT [XGB_B2].[KEY] AS [KEY], [XGB_B2].[Score_0] AS [Score_0], [XGB_B2].[Score_1] AS [Score_1], [XGB_B2].[Score_2] AS [Score_2], [XGB_B2].[Score_3] AS [Score_3] 
FROM ##TMP_20180602143514_KGB_XGB_B2 AS [XGB_B2] UNION ALL SELECT [XGB_B3].[KEY] AS [KEY], [XGB_B3].[Score_0] AS [Score_0], [XGB_B3].[Score_1] AS [Score_1], [XGB_B3].[Score_2] AS [Score_2], [XGB_B3].[Score_3] AS [Score_3] 
FROM ##TMP_20180602143514_F6I_XGB_B3 AS [XGB_B3] UNION ALL SELECT [XGB_B4].[KEY] AS [KEY], [XGB_B4].[Score_0] AS [Score_0], [XGB_B4].[Score_1] AS [Score_1], [XGB_B4].[Score_2] AS [Score_2], [XGB_B4].[Score_3] AS [Score_3] 
FROM ##TMP_20180602143514_AWT_XGB_B4 AS [XGB_B4] UNION ALL SELECT [XGB_B5].[KEY] AS [KEY], [XGB_B5].[Score_0] AS [Score_0], [XGB_B5].[Score_1] AS [Score_1], [XGB_B5].[Score_2] AS [Score_2], [XGB_B5].[Score_3] AS [Score_3] 
FROM ##TMP_20180602143514_0OP_XGB_B5 AS [XGB_B5] UNION ALL SELECT [XGB_B6].[KEY] AS [KEY], [XGB_B6].[Score_0] AS [Score_0], [XGB_B6].[Score_1] AS [Score_1], [XGB_B6].[Score_2] AS [Score_2], [XGB_B6].[Score_3] AS [Score_3] 
FROM ##TMP_20180602143514_B5A_XGB_B6 AS [XGB_B6]) AS [XGB_EnsembleUnion])
 INSERT INTO ##TMP_20180602143514_OSD_XGB_sum ([KEY], [Score_0], [Score_1], [Score_2], [Score_3]) SELECT [XGB_sum].[KEY], [XGB_sum].[Score_0], [XGB_sum].[Score_1], [XGB_sum].[Score_2], [XGB_sum].[Score_3] 
...
FROM ##TMP_20180602143514_OSD_XGB_sum AS [XGB_sum]), 
