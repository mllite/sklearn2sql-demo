...
-- Code For temporary table tmp_20180602144408_nss_gb_b0 part 1. Create 


CREATE TEMPORARY TABLE tmp_20180602144408_nss_gb_b0 (
	"KEY" BIGINT, 
	"Estimator" DOUBLE
)
...
-- Code For temporary table tmp_20180602144408_nss_gb_b0 part 2. Populate

INSERT INTO tmp_20180602144408_nss_gb_b0 ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
-- Code For temporary table tmp_20180602144408_ydz_gb_b1 part 1. Create 


CREATE TEMPORARY TABLE tmp_20180602144408_ydz_gb_b1 (
	"KEY" BIGINT, 
	"Estimator" DOUBLE
)
...
-- Code For temporary table tmp_20180602144408_ydz_gb_b1 part 2. Populate

INSERT INTO tmp_20180602144408_ydz_gb_b1 ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
-- Code For temporary table tmp_20180602144408_ziw_gb_sum part 1. Create 


CREATE TEMPORARY TABLE tmp_20180602144408_ziw_gb_sum (
	"KEY" BIGINT, 
	"Estimator" DOUBLE
)
...
-- Code For temporary table tmp_20180602144408_ziw_gb_sum part 2. Populate

INSERT INTO tmp_20180602144408_ziw_gb_sum ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
FROM tmp_20180602144408_nss_gb_b0 AS "GB_B0" UNION ALL SELECT "GB_B1"."KEY" AS "KEY", "GB_B1"."Estimator" AS "Estimator" 
FROM tmp_20180602144408_ydz_gb_b1 AS "GB_B1") AS "GB_EnsembleUnion")
...
FROM tmp_20180602144408_ziw_gb_sum AS "GB_sum"