...
-- Code For temporary table TMP_20180602_J0O_GB_B0 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180602_J0O_GB_B0" (
	"KEY" NUMBER(19), 
...
-- Code For temporary table TMP_20180602_J0O_GB_B0 part 2. Populate

INSERT INTO "TMP_20180602_J0O_GB_B0" ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
-- Code For temporary table TMP_20180602_R45_GB_B1 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180602_R45_GB_B1" (
	"KEY" NUMBER(19), 
	"Estimator" BINARY_DOUBLE
)
...
-- Code For temporary table TMP_20180602_R45_GB_B1 part 2. Populate

INSERT INTO "TMP_20180602_R45_GB_B1" ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
-- Code For temporary table TMP_20180602_1WL_GB_SUM part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180602_1WL_GB_SUM" (
	"KEY" NUMBER(19), 
	"Estimator" BINARY_DOUBLE
)
...
-- Code For temporary table TMP_20180602_1WL_GB_SUM part 2. Populate

INSERT INTO "TMP_20180602_1WL_GB_SUM" ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
FROM "TMP_20180602_J0O_GB_B0" "GB_B0" UNION ALL SELECT "GB_B1"."KEY" AS "KEY", "GB_B1"."Estimator" AS "Estimator" 
FROM "TMP_20180602_R45_GB_B1" "GB_B1") "GB_EnsembleUnion")
...
FROM "TMP_20180602_1WL_GB_SUM" "GB_sum"