...
-- Code For temporary table tmp_20180602150219_e3m_xgb_b0 part 1. Create 

CREATE TEMPORARY TABLE `tmp_20180602150219_e3m_xgb_b0` STORED AS ORC AS WITH `DT_node_lookup` AS 
...
-- Code For temporary table tmp_20180602150219_e3m_xgb_b0 part 2. Populate

SELECT * FROM `tmp_20180602150219_e3m_xgb_b0`

-- Code For temporary table tmp_20180602150219_zzk_xgb_b1 part 1. Create 

CREATE TEMPORARY TABLE `tmp_20180602150219_zzk_xgb_b1` STORED AS ORC AS WITH `DT_node_lookup_10` AS 
...
-- Code For temporary table tmp_20180602150219_zzk_xgb_b1 part 2. Populate

SELECT * FROM `tmp_20180602150219_zzk_xgb_b1`

-- Code For temporary table tmp_20180602150219_x0l_xgb_sum part 1. Create 

CREATE TEMPORARY TABLE `tmp_20180602150219_x0l_xgb_sum` STORED AS ORC AS WITH `XGB_Union` AS 
...
FROM `tmp_20180602150219_e3m_xgb_b0` AS `XGB_B0` UNION ALL SELECT `XGB_B1`.`KEY` AS `KEY`, `XGB_B1`.`Estimator` AS `Estimator` 
FROM `tmp_20180602150219_zzk_xgb_b1` AS `XGB_B1`) AS `XGB_EnsembleUnion`)
...
-- Code For temporary table tmp_20180602150219_x0l_xgb_sum part 2. Populate

SELECT * FROM `tmp_20180602150219_x0l_xgb_sum`

-- Model deployment code

SELECT `XGB_sum`.`KEY` AS `KEY`, `XGB_sum`.`Estimator` + 0.5 AS `Estimator` 
FROM `tmp_20180602150219_x0l_xgb_sum` AS `XGB_sum`