...
-- Code For temporary table TMP_20180602150219_DLC_XGB_B0 part 1. Create 


CREATE TEMPORARY TABLE `TMP_20180602150219_DLC_XGB_B0` (
	`KEY` BIGINT, 
	`Estimator` DOUBLE
)
...
-- Code For temporary table TMP_20180602150219_DLC_XGB_B0 part 2. Populate

INSERT INTO `TMP_20180602150219_DLC_XGB_B0` (`KEY`, `Estimator`) SELECT `U`.`KEY`, `U`.`Estimator` 
...
-- Code For temporary table TMP_20180602150219_GW9_XGB_B1 part 1. Create 


CREATE TEMPORARY TABLE `TMP_20180602150219_GW9_XGB_B1` (
	`KEY` BIGINT, 
	`Estimator` DOUBLE
)
...
-- Code For temporary table TMP_20180602150219_GW9_XGB_B1 part 2. Populate

INSERT INTO `TMP_20180602150219_GW9_XGB_B1` (`KEY`, `Estimator`) SELECT `U`.`KEY`, `U`.`Estimator` 
...
-- Code For temporary table TMP_20180602150219_KZL_XGB_sum part 1. Create 


CREATE TEMPORARY TABLE `TMP_20180602150219_KZL_XGB_sum` (
	`KEY` BIGINT NOT NULL, 
	`Estimator` DOUBLE, 
	PRIMARY KEY (`KEY`)
)
...
-- Code For temporary table TMP_20180602150219_KZL_XGB_sum part 2. Populate

INSERT INTO `TMP_20180602150219_KZL_XGB_sum` (`KEY`, `Estimator`) SELECT `U`.`KEY`, `U`.`Estimator` 
...
FROM `TMP_20180602150219_DLC_XGB_B0` AS `XGB_B0` UNION ALL SELECT `XGB_B1`.`KEY` AS `KEY`, `XGB_B1`.`Estimator` AS `Estimator` 
FROM `TMP_20180602150219_GW9_XGB_B1` AS `XGB_B1`) AS `XGB_EnsembleUnion`)
...
-- Code For temporary table TMP_20180602150219_KZL_XGB_sum part 3. Create Index 

CREATE INDEX `ix_TMP_20180602150219_KZL_XGB_sum_KEY` ON `TMP_20180602150219_KZL_XGB_sum` (`KEY`)

-- Model deployment code

SELECT `XGB_sum`.`KEY` AS `KEY`, `XGB_sum`.`Estimator` + 0.5 AS `Estimator` 
FROM `TMP_20180602150219_KZL_XGB_sum` AS `XGB_sum`