...
-- Code For temporary table tmp_20180602144706_yi3_xgb_b0 part 1. Create 


CREATE TABLE tmp_20180602144706_yi3_xgb_b0 (
	`KEY` BIGINT, 
	`Estimator` DOUBLE
)
...
-- Code For temporary table tmp_20180602144706_yi3_xgb_b0 part 2. Populate
...
FROM `DT_Output_9`)
 INSERT INTO tmp_20180602144706_yi3_xgb_b0 (`KEY`, `Estimator`) SELECT `XGB_B0`.`KEY`, `XGB_B0`.`Estimator` 
...
-- Code For temporary table tmp_20180602144706_sux_xgb_b1 part 1. Create 


CREATE TABLE tmp_20180602144706_sux_xgb_b1 (
	`KEY` BIGINT, 
	`Estimator` DOUBLE
)
...
-- Code For temporary table tmp_20180602144706_sux_xgb_b1 part 2. Populate
...
FROM `DT_Output_15`)
 INSERT INTO tmp_20180602144706_sux_xgb_b1 (`KEY`, `Estimator`) SELECT `XGB_B1`.`KEY`, `XGB_B1`.`Estimator` 
...
-- Code For temporary table tmp_20180602144706_e84_xgb_sum part 1. Create 


CREATE TABLE tmp_20180602144706_e84_xgb_sum (
	`KEY` BIGINT, 
	`Estimator` DOUBLE
)
...
-- Code For temporary table tmp_20180602144706_e84_xgb_sum part 2. Populate
...
FROM tmp_20180602144706_yi3_xgb_b0 AS `XGB_B0` UNION ALL SELECT `XGB_B1`.`KEY` AS `KEY`, `XGB_B1`.`Estimator` AS `Estimator` 
FROM tmp_20180602144706_sux_xgb_b1 AS `XGB_B1`) AS `XGB_EnsembleUnion`)
 INSERT INTO tmp_20180602144706_e84_xgb_sum (`KEY`, `Estimator`) SELECT `XGB_sum`.`KEY`, `XGB_sum`.`Estimator` 
...
FROM tmp_20180602144706_e84_xgb_sum AS `XGB_sum`