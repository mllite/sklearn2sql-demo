...
-- Code For temporary table TMP_20180602_URL_XGB_B0 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180602_URL_XGB_B0" (
	"KEY" BIGINT, 
...
-- Code For temporary table TMP_20180602_URL_XGB_B0 part 2. Populate

INSERT INTO "TMP_20180602_URL_XGB_B0" ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
-- Code For temporary table TMP_20180602_SZ5_XGB_B1 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180602_SZ5_XGB_B1" (
	"KEY" BIGINT, 
	"Estimator" DOUBLE PRECISION
)
...
-- Code For temporary table TMP_20180602_SZ5_XGB_B1 part 2. Populate

INSERT INTO "TMP_20180602_SZ5_XGB_B1" ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
-- Code For temporary table TMP_20180602_Q47_XGB_B2 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180602_Q47_XGB_B2" (
	"KEY" BIGINT, 
	"Estimator" DOUBLE PRECISION
)
...
-- Code For temporary table TMP_20180602_Q47_XGB_B2 part 2. Populate

INSERT INTO "TMP_20180602_Q47_XGB_B2" ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
-- Code For temporary table TMP_20180602_IY1_XGB_B3 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180602_IY1_XGB_B3" (
	"KEY" BIGINT, 
	"Estimator" DOUBLE PRECISION
)
...
-- Code For temporary table TMP_20180602_IY1_XGB_B3 part 2. Populate

INSERT INTO "TMP_20180602_IY1_XGB_B3" ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
-- Code For temporary table TMP_20180602_BG0_XGB_SUM part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180602_BG0_XGB_SUM" (
	"KEY" BIGINT NOT NULL, 
	"Estimator" DOUBLE PRECISION, 
	PRIMARY KEY ("KEY")
)
...
-- Code For temporary table TMP_20180602_BG0_XGB_SUM part 2. Populate

INSERT INTO "TMP_20180602_BG0_XGB_SUM" ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
FROM "TMP_20180602_URL_XGB_B0" AS "XGB_B0" UNION ALL SELECT "XGB_B1"."KEY" AS "KEY", "XGB_B1"."Estimator" AS "Estimator" 
FROM "TMP_20180602_SZ5_XGB_B1" AS "XGB_B1" UNION ALL SELECT "XGB_B2"."KEY" AS "KEY", "XGB_B2"."Estimator" AS "Estimator" 
FROM "TMP_20180602_Q47_XGB_B2" AS "XGB_B2" UNION ALL SELECT "XGB_B3"."KEY" AS "KEY", "XGB_B3"."Estimator" AS "Estimator" 
FROM "TMP_20180602_IY1_XGB_B3" AS "XGB_B3") AS "XGB_EnsembleUnion")
...
-- Code For temporary table TMP_20180602_BG0_XGB_SUM part 3. Create Index 

CREATE INDEX "ix_TMP_20180602_BG0_XGB_SUM_KEY" ON "TMP_20180602_BG0_XGB_SUM" ("KEY")

-- Model deployment code

SELECT "XGB_sum"."KEY" AS "KEY", "XGB_sum"."Estimator" + 0.5 AS "Estimator" 
FROM "TMP_20180602_BG0_XGB_SUM" AS "XGB_sum"