...
-- Code For temporary table P_20180602_RAN_HL_1_RELU_1 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "P_20180602_RAN_HL_1_RELU_1" (
	"KEY" NUMBER(19), 
...
-- Code For temporary table P_20180602_RAN_HL_1_RELU_1 part 2. Populate

INSERT INTO "P_20180602_RAN_HL_1_RELU_1" ("KEY", "NEUR_1_1", "NEUR_1_2", "NEUR_1_3") SELECT "U"."KEY", "U"."NEUR_1_1", "U"."NEUR_1_2", "U"."NEUR_1_3" 
FROM (WITH "IL" AS 
...
-- Code For temporary table 20180602_40C_OL_IDENTITY_1 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "20180602_40C_OL_IDENTITY_1" (
	"KEY" NUMBER(19), 
...
-- Code For temporary table 20180602_40C_OL_IDENTITY_1 part 2. Populate

INSERT INTO "20180602_40C_OL_IDENTITY_1" ("KEY", "NEUR_3_1") SELECT "U"."KEY", "U"."NEUR_3_1" 
...
FROM "P_20180602_RAN_HL_1_RELU_1" "HL_1_relu_1"), 
"HL_2_relu" AS 
...
FROM "20180602_40C_OL_IDENTITY_1" "OL_identity_1"