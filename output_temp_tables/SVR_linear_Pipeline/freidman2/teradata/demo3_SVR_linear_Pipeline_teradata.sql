...
-- Code For temporary table tmp_20180602151948_edh_ads_imp_1_out part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180602151948_edh_ads_imp_1_out  (
	"KEY" BIGINT, 
...
-- Code For temporary table tmp_20180602151948_edh_ads_imp_1_out part 2. Populate

INSERT INTO tmp_20180602151948_edh_ads_imp_1_out ("KEY", imputer_output_2, imputer_output_3, imputer_output_4, imputer_output_5) SELECT "U"."KEY", "U".imputer_output_2, "U".imputer_output_3, "U".imputer_output_4, "U".imputer_output_5 
...
-- Code For temporary table tmp_20180602151948_0ti_ads_sca_2_out part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180602151948_0ti_ads_sca_2_out  (
	"KEY" BIGINT, 
...
-- Code For temporary table tmp_20180602151948_0ti_ads_sca_2_out part 2. Populate

INSERT INTO tmp_20180602151948_0ti_ads_sca_2_out ("KEY", scaler_output_2, scaler_output_3, scaler_output_4, scaler_output_5) SELECT "U"."KEY", "U".scaler_output_2, "U".scaler_output_3, "U".scaler_output_4, "U".scaler_output_5 
...
FROM tmp_20180602151948_edh_ads_imp_1_out AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT") AS "U"
...
FROM tmp_20180602151948_0ti_ads_sca_2_out AS "ADS_sca_2_OUT"), 
dummy_cte AS 
