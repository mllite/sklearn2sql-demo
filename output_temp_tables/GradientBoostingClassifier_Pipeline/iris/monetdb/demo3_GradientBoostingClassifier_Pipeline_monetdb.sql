...
-- Code For temporary table tmp_20180602152817_7dp_ads_imp_1_out part 1. Create 


CREATE TEMPORARY TABLE tmp_20180602152817_7dp_ads_imp_1_out (
	"KEY" BIGINT, 
...
-- Code For temporary table tmp_20180602152817_7dp_ads_imp_1_out part 2. Populate

INSERT INTO tmp_20180602152817_7dp_ads_imp_1_out ("KEY", imputer_output_2, imputer_output_3, imputer_output_4, imputer_output_5) SELECT "U"."KEY", "U".imputer_output_2, "U".imputer_output_3, "U".imputer_output_4, "U".imputer_output_5 
...
-- Code For temporary table tmp_20180602152817_9gg_ads_sca_2_out part 1. Create 


CREATE TEMPORARY TABLE tmp_20180602152817_9gg_ads_sca_2_out (
	"KEY" BIGINT, 
...
-- Code For temporary table tmp_20180602152817_9gg_ads_sca_2_out part 2. Populate

INSERT INTO tmp_20180602152817_9gg_ads_sca_2_out ("KEY", scaler_output_2, scaler_output_3, scaler_output_4, scaler_output_5) SELECT "U"."KEY", "U".scaler_output_2, "U".scaler_output_3, "U".scaler_output_4, "U".scaler_output_5 
...
FROM tmp_20180602152817_7dp_ads_imp_1_out AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT") AS "U"

-- Code For temporary table tmp_20180602152817_zhi_gb_b0 part 1. Create 


CREATE TEMPORARY TABLE tmp_20180602152817_zhi_gb_b0 (
	"KEY" BIGINT, 
	"Score_0" DOUBLE, 
	"Score_1" DOUBLE, 
	"Score_2" DOUBLE
...
-- Code For temporary table tmp_20180602152817_zhi_gb_b0 part 2. Populate

INSERT INTO tmp_20180602152817_zhi_gb_b0 ("KEY", "Score_0", "Score_1", "Score_2") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1", "U"."Score_2" 
...
FROM tmp_20180602152817_9gg_ads_sca_2_out AS "ADS_sca_2_OUT"), 
"DT_node_data" AS 
...
-- Code For temporary table tmp_20180602152817_75c_gb_b1 part 1. Create 


CREATE TEMPORARY TABLE tmp_20180602152817_75c_gb_b1 (
	"KEY" BIGINT, 
	"Score_0" DOUBLE, 
	"Score_1" DOUBLE, 
	"Score_2" DOUBLE
...
-- Code For temporary table tmp_20180602152817_75c_gb_b1 part 2. Populate

INSERT INTO tmp_20180602152817_75c_gb_b1 ("KEY", "Score_0", "Score_1", "Score_2") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1", "U"."Score_2" 
...
-- Code For temporary table tmp_20180602152817_xn5_gb_b2 part 1. Create 


CREATE TEMPORARY TABLE tmp_20180602152817_xn5_gb_b2 (
	"KEY" BIGINT, 
	"Score_0" DOUBLE, 
	"Score_1" DOUBLE, 
	"Score_2" DOUBLE
...
-- Code For temporary table tmp_20180602152817_xn5_gb_b2 part 2. Populate

INSERT INTO tmp_20180602152817_xn5_gb_b2 ("KEY", "Score_0", "Score_1", "Score_2") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1", "U"."Score_2" 
...
-- Code For temporary table tmp_20180602152817_1ba_gb_b3 part 1. Create 


CREATE TEMPORARY TABLE tmp_20180602152817_1ba_gb_b3 (
	"KEY" BIGINT, 
	"Score_0" DOUBLE, 
	"Score_1" DOUBLE, 
	"Score_2" DOUBLE
...
-- Code For temporary table tmp_20180602152817_1ba_gb_b3 part 2. Populate

INSERT INTO tmp_20180602152817_1ba_gb_b3 ("KEY", "Score_0", "Score_1", "Score_2") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1", "U"."Score_2" 
...
-- Code For temporary table tmp_20180602152817_6rk_gb_b4 part 1. Create 


CREATE TEMPORARY TABLE tmp_20180602152817_6rk_gb_b4 (
	"KEY" BIGINT, 
	"Score_0" DOUBLE, 
	"Score_1" DOUBLE, 
	"Score_2" DOUBLE
...
-- Code For temporary table tmp_20180602152817_6rk_gb_b4 part 2. Populate

INSERT INTO tmp_20180602152817_6rk_gb_b4 ("KEY", "Score_0", "Score_1", "Score_2") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1", "U"."Score_2" 
...
-- Code For temporary table tmp_20180602152817_xiz_gb_sum part 1. Create 


CREATE TEMPORARY TABLE tmp_20180602152817_xiz_gb_sum (
	"KEY" BIGINT, 
	"Score_0" DOUBLE, 
	"Score_1" DOUBLE, 
	"Score_2" DOUBLE
...
-- Code For temporary table tmp_20180602152817_xiz_gb_sum part 2. Populate

INSERT INTO tmp_20180602152817_xiz_gb_sum ("KEY", "Score_0", "Score_1", "Score_2") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1", "U"."Score_2" 
...
FROM tmp_20180602152817_zhi_gb_b0 AS "GB_B0" UNION ALL SELECT "GB_B1"."KEY" AS "KEY", "GB_B1"."Score_0" AS "Score_0", "GB_B1"."Score_1" AS "Score_1", "GB_B1"."Score_2" AS "Score_2" 
FROM tmp_20180602152817_75c_gb_b1 AS "GB_B1" UNION ALL SELECT "GB_B2"."KEY" AS "KEY", "GB_B2"."Score_0" AS "Score_0", "GB_B2"."Score_1" AS "Score_1", "GB_B2"."Score_2" AS "Score_2" 
FROM tmp_20180602152817_xn5_gb_b2 AS "GB_B2" UNION ALL SELECT "GB_B3"."KEY" AS "KEY", "GB_B3"."Score_0" AS "Score_0", "GB_B3"."Score_1" AS "Score_1", "GB_B3"."Score_2" AS "Score_2" 
FROM tmp_20180602152817_1ba_gb_b3 AS "GB_B3" UNION ALL SELECT "GB_B4"."KEY" AS "KEY", "GB_B4"."Score_0" AS "Score_0", "GB_B4"."Score_1" AS "Score_1", "GB_B4"."Score_2" AS "Score_2" 
FROM tmp_20180602152817_6rk_gb_b4 AS "GB_B4") AS "GB_EnsembleUnion")
...
FROM tmp_20180602152817_xiz_gb_sum AS "GB_sum"), 
