...
-- Code For temporary table tmp_20180602143144_jjc_ads_imp_1_out part 1. Create 

CREATE TEMPORARY TABLE `tmp_20180602143144_jjc_ads_imp_1_out` STORED AS ORC AS SELECT `ADS_imp_1_OUT`.`KEY`, `ADS_imp_1_OUT`.`impter_2`, `ADS_imp_1_OUT`.`impter_3`, `ADS_imp_1_OUT`.`impter_4`, `ADS_imp_1_OUT`.`impter_5`, `ADS_imp_1_OUT`.`impter_6`, `ADS_imp_1_OUT`.`impter_7`, `ADS_imp_1_OUT`.`impter_8`, `ADS_imp_1_OUT`.`impter_9`, `ADS_imp_1_OUT`.`impter_10`, `ADS_imp_1_OUT`.`impter_11` 
...
-- Code For temporary table tmp_20180602143144_jjc_ads_imp_1_out part 2. Populate

SELECT * FROM `tmp_20180602143144_jjc_ads_imp_1_out`

-- Code For temporary table tmp_20180602143144_df7_ads_sca_2_out part 1. Create 

CREATE TEMPORARY TABLE `tmp_20180602143144_df7_ads_sca_2_out` STORED AS ORC AS SELECT `ADS_sca_2_OUT`.`KEY`, `ADS_sca_2_OUT`.`scaler_2`, `ADS_sca_2_OUT`.`scaler_3`, `ADS_sca_2_OUT`.`scaler_4`, `ADS_sca_2_OUT`.`scaler_5`, `ADS_sca_2_OUT`.`scaler_6`, `ADS_sca_2_OUT`.`scaler_7`, `ADS_sca_2_OUT`.`scaler_8`, `ADS_sca_2_OUT`.`scaler_9`, `ADS_sca_2_OUT`.`scaler_10`, `ADS_sca_2_OUT`.`scaler_11` 
...
FROM `tmp_20180602143144_jjc_ads_imp_1_out` AS `ADS_imp_1_OUT`) AS `ADS_sca_2_OUT`

-- Code For temporary table tmp_20180602143144_df7_ads_sca_2_out part 2. Populate

SELECT * FROM `tmp_20180602143144_df7_ads_sca_2_out`

-- Code For temporary table tmp_20180602143144_xco_gb_b0 part 1. Create 

CREATE TEMPORARY TABLE `tmp_20180602143144_xco_gb_b0` STORED AS ORC AS WITH `DT_node_lookup` AS 
...
FROM `tmp_20180602143144_df7_ads_sca_2_out` AS `ADS_sca_2_OUT`), 
`DT_node_data` AS 
...
-- Code For temporary table tmp_20180602143144_xco_gb_b0 part 2. Populate

SELECT * FROM `tmp_20180602143144_xco_gb_b0`

-- Code For temporary table tmp_20180602143144_9bq_gb_b1 part 1. Create 

CREATE TEMPORARY TABLE `tmp_20180602143144_9bq_gb_b1` STORED AS ORC AS WITH `DT_node_lookup_10` AS 
...
-- Code For temporary table tmp_20180602143144_9bq_gb_b1 part 2. Populate

SELECT * FROM `tmp_20180602143144_9bq_gb_b1`

-- Code For temporary table tmp_20180602143144_pu8_gb_b2 part 1. Create 

CREATE TEMPORARY TABLE `tmp_20180602143144_pu8_gb_b2` STORED AS ORC AS WITH `DT_node_lookup_20` AS 
(SELECT `ADS_sca_2_OUT`.`KEY` AS `KEY`, CASE WHEN (`ADS_sca_2_OUT`.`scaler_6` <= 0.055714450776576996) THEN CASE WHEN (`ADS_sca_2_OUT`.`scaler_11` <= 2.486302375793457) THEN CASE WHEN (`ADS_sca_2_OUT`.`scaler_2` <= -1.484807014465332) THEN 3 ELSE 4 END ELSE 5 END ELSE CASE WHEN (`ADS_sca_2_OUT`.`scaler_5` <= 0.17407895624637604) THEN CASE WHEN (`ADS_sca_2_OUT`.`scaler_8` <= 1.4334330558776855) THEN 8 ELSE 9 END ELSE CASE WHEN (`ADS_sca_2_OUT`.`scaler_11` <= -1.296878695487976) THEN 11 ELSE 12 END END END AS `node_id_2` 
FROM `tmp_20180602143144_df7_ads_sca_2_out` AS `ADS_sca_2_OUT`), 
`DT_node_data_20` AS 
(SELECT `Values`.`nid` AS `nid`, CAST(`Values`.`E` AS DOUBLE) AS `E` 
...
-- Code For temporary table tmp_20180602143144_pu8_gb_b2 part 2. Populate

SELECT * FROM `tmp_20180602143144_pu8_gb_b2`

-- Code For temporary table tmp_20180602143144_kye_gb_b3 part 1. Create 

CREATE TEMPORARY TABLE `tmp_20180602143144_kye_gb_b3` STORED AS ORC AS WITH `DT_node_lookup_30` AS 
...
-- Code For temporary table tmp_20180602143144_kye_gb_b3 part 2. Populate

SELECT * FROM `tmp_20180602143144_kye_gb_b3`

-- Code For temporary table tmp_20180602143144_31x_gb_b4 part 1. Create 

CREATE TEMPORARY TABLE `tmp_20180602143144_31x_gb_b4` STORED AS ORC AS WITH `DT_node_lookup_40` AS 
...
-- Code For temporary table tmp_20180602143144_31x_gb_b4 part 2. Populate

SELECT * FROM `tmp_20180602143144_31x_gb_b4`

-- Code For temporary table tmp_20180602143144_vwz_gb_b5 part 1. Create 

CREATE TEMPORARY TABLE `tmp_20180602143144_vwz_gb_b5` STORED AS ORC AS WITH `DT_node_lookup_50` AS 
...
-- Code For temporary table tmp_20180602143144_vwz_gb_b5 part 2. Populate

SELECT * FROM `tmp_20180602143144_vwz_gb_b5`

-- Code For temporary table tmp_20180602143144_hwf_gb_b6 part 1. Create 

CREATE TEMPORARY TABLE `tmp_20180602143144_hwf_gb_b6` STORED AS ORC AS WITH `DT_node_lookup_60` AS 
...
-- Code For temporary table tmp_20180602143144_hwf_gb_b6 part 2. Populate

SELECT * FROM `tmp_20180602143144_hwf_gb_b6`

-- Code For temporary table tmp_20180602143144_dii_gb_sum part 1. Create 

CREATE TEMPORARY TABLE `tmp_20180602143144_dii_gb_sum` STORED AS ORC AS WITH `GB_Union` AS 
...
FROM `tmp_20180602143144_xco_gb_b0` AS `GB_B0` UNION ALL SELECT `GB_B1`.`KEY` AS `KEY`, `GB_B1`.`Score_0` AS `Score_0`, `GB_B1`.`Score_1` AS `Score_1`, `GB_B1`.`Score_2` AS `Score_2`, `GB_B1`.`Score_3` AS `Score_3` 
FROM `tmp_20180602143144_9bq_gb_b1` AS `GB_B1` UNION ALL SELECT `GB_B2`.`KEY` AS `KEY`, `GB_B2`.`Score_0` AS `Score_0`, `GB_B2`.`Score_1` AS `Score_1`, `GB_B2`.`Score_2` AS `Score_2`, `GB_B2`.`Score_3` AS `Score_3` 
FROM `tmp_20180602143144_pu8_gb_b2` AS `GB_B2` UNION ALL SELECT `GB_B3`.`KEY` AS `KEY`, `GB_B3`.`Score_0` AS `Score_0`, `GB_B3`.`Score_1` AS `Score_1`, `GB_B3`.`Score_2` AS `Score_2`, `GB_B3`.`Score_3` AS `Score_3` 
FROM `tmp_20180602143144_kye_gb_b3` AS `GB_B3` UNION ALL SELECT `GB_B4`.`KEY` AS `KEY`, `GB_B4`.`Score_0` AS `Score_0`, `GB_B4`.`Score_1` AS `Score_1`, `GB_B4`.`Score_2` AS `Score_2`, `GB_B4`.`Score_3` AS `Score_3` 
FROM `tmp_20180602143144_31x_gb_b4` AS `GB_B4` UNION ALL SELECT `GB_B5`.`KEY` AS `KEY`, `GB_B5`.`Score_0` AS `Score_0`, `GB_B5`.`Score_1` AS `Score_1`, `GB_B5`.`Score_2` AS `Score_2`, `GB_B5`.`Score_3` AS `Score_3` 
FROM `tmp_20180602143144_vwz_gb_b5` AS `GB_B5` UNION ALL SELECT `GB_B6`.`KEY` AS `KEY`, `GB_B6`.`Score_0` AS `Score_0`, `GB_B6`.`Score_1` AS `Score_1`, `GB_B6`.`Score_2` AS `Score_2`, `GB_B6`.`Score_3` AS `Score_3` 
FROM `tmp_20180602143144_hwf_gb_b6` AS `GB_B6`) AS `GB_EnsembleUnion`)
...
-- Code For temporary table tmp_20180602143144_dii_gb_sum part 2. Populate

SELECT * FROM `tmp_20180602143144_dii_gb_sum`
...
FROM `tmp_20180602143144_dii_gb_sum` AS `GB_sum`), 
