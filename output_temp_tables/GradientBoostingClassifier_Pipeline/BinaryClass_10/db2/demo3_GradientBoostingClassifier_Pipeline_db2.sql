...
-- Code For temporary table tmp_20180602141300_av2_ads_imp_1_out part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180602141300_av2_ads_imp_1_out (
	"KEY" BIGINT, 
	impter_2 DOUBLE, 
	impter_3 DOUBLE, 
	impter_4 DOUBLE, 
...
-- Code For temporary table tmp_20180602141300_av2_ads_imp_1_out part 2. Populate

INSERT INTO tmp_20180602141300_av2_ads_imp_1_out SELECT "ADS_imp_1_OUT"."KEY", "ADS_imp_1_OUT".impter_2, "ADS_imp_1_OUT".impter_3, "ADS_imp_1_OUT".impter_4, "ADS_imp_1_OUT".impter_5, "ADS_imp_1_OUT".impter_6, "ADS_imp_1_OUT".impter_7, "ADS_imp_1_OUT".impter_8, "ADS_imp_1_OUT".impter_9, "ADS_imp_1_OUT".impter_10, "ADS_imp_1_OUT".impter_11 
...
-- Code For temporary table tmp_20180602141300_u7v_ads_sca_2_out part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180602141300_u7v_ads_sca_2_out (
	"KEY" BIGINT, 
	scaler_2 DOUBLE, 
	scaler_3 DOUBLE, 
	scaler_4 DOUBLE, 
...
FROM tmp_20180602141300_av2_ads_imp_1_out AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT"

-- Code For temporary table tmp_20180602141300_fi6_gb_b0 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180602141300_fi6_gb_b0 (
	"KEY" BIGINT, 
	"Score_0" DOUBLE, 
	"Score_1" DOUBLE
)
...
-- Code For temporary table tmp_20180602141300_fi6_gb_b0 part 2. Populate

INSERT INTO tmp_20180602141300_fi6_gb_b0 WITH "DT_node_lookup" AS 
...
FROM tmp_20180602141300_u7v_ads_sca_2_out AS "ADS_sca_2_OUT"), 
"DT_node_data" AS 
...
-- Code For temporary table tmp_20180602141300_gxq_gb_b1 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180602141300_gxq_gb_b1 (
	"KEY" BIGINT, 
	"Score_0" DOUBLE, 
	"Score_1" DOUBLE
)
...
-- Code For temporary table tmp_20180602141300_gxq_gb_b1 part 2. Populate

INSERT INTO tmp_20180602141300_gxq_gb_b1 WITH "DT_node_lookup_5" AS 
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", CASE WHEN ("ADS_sca_2_OUT".scaler_11 <= 0.07101128250360489) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_9 <= 0.6601690649986267) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_7 <= -0.7541185617446899) THEN 3 ELSE 4 END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_7 <= -0.9067436456680298) THEN 6 ELSE 7 END END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_8 <= 1.7904822826385498) THEN 9 ELSE 10 END END AS node_id_2 
FROM tmp_20180602141300_u7v_ads_sca_2_out AS "ADS_sca_2_OUT"), 
"DT_node_data_5" AS 
(SELECT "Values".nid AS nid, CAST("Values"."E" AS DOUBLE) AS "E" 
...
-- Code For temporary table tmp_20180602141300_sd0_gb_b2 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180602141300_sd0_gb_b2 (
	"KEY" BIGINT, 
	"Score_0" DOUBLE, 
	"Score_1" DOUBLE
)
...
-- Code For temporary table tmp_20180602141300_sd0_gb_b2 part 2. Populate

INSERT INTO tmp_20180602141300_sd0_gb_b2 WITH "DT_node_lookup_10" AS 
...
-- Code For temporary table tmp_20180602141300_fyj_gb_b3 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180602141300_fyj_gb_b3 (
	"KEY" BIGINT, 
	"Score_0" DOUBLE, 
	"Score_1" DOUBLE
)
...
-- Code For temporary table tmp_20180602141300_fyj_gb_b3 part 2. Populate

INSERT INTO tmp_20180602141300_fyj_gb_b3 WITH "DT_node_lookup_15" AS 
...
-- Code For temporary table tmp_20180602141300_htl_gb_sum part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180602141300_htl_gb_sum (
	"KEY" BIGINT, 
	"Score_0" DOUBLE, 
	"Score_1" DOUBLE
)
...
-- Code For temporary table tmp_20180602141300_htl_gb_sum part 2. Populate

INSERT INTO tmp_20180602141300_htl_gb_sum WITH "GB_Union" AS 
...
FROM tmp_20180602141300_fi6_gb_b0 AS "GB_B0" UNION ALL SELECT "GB_B1"."KEY" AS "KEY", "GB_B1"."Score_0" AS "Score_0", "GB_B1"."Score_1" AS "Score_1" 
FROM tmp_20180602141300_gxq_gb_b1 AS "GB_B1" UNION ALL SELECT "GB_B2"."KEY" AS "KEY", "GB_B2"."Score_0" AS "Score_0", "GB_B2"."Score_1" AS "Score_1" 
FROM tmp_20180602141300_sd0_gb_b2 AS "GB_B2" UNION ALL SELECT "GB_B3"."KEY" AS "KEY", "GB_B3"."Score_0" AS "Score_0", "GB_B3"."Score_1" AS "Score_1" 
FROM tmp_20180602141300_fyj_gb_b3 AS "GB_B3") AS "GB_EnsembleUnion")
...
FROM tmp_20180602141300_htl_gb_sum AS "GB_sum"), 
