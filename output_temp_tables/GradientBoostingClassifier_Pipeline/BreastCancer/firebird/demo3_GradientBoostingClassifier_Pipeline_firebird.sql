...
-- Code For temporary table TMP_20180602_9ET_ADS_IMP_1_OUT part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180602_9ET_ADS_IMP_1_OUT" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20180602_9ET_ADS_IMP_1_OUT part 2. Populate

INSERT INTO "TMP_20180602_9ET_ADS_IMP_1_OUT" ("KEY", impter_2, impter_3, impter_4, impter_5, impter_6, impter_7, impter_8, impter_9, impter_10, impter_11, impter_12, impter_13, impter_14, impter_15, impter_16, impter_17, impter_18, impter_19, impter_20, impter_21, impter_22, impter_23, impter_24, impter_25, impter_26, impter_27, impter_28, impter_29, impter_30, impter_31) SELECT "U"."KEY", "U".impter_2, "U".impter_3, "U".impter_4, "U".impter_5, "U".impter_6, "U".impter_7, "U".impter_8, "U".impter_9, "U".impter_10, "U".impter_11, "U".impter_12, "U".impter_13, "U".impter_14, "U".impter_15, "U".impter_16, "U".impter_17, "U".impter_18, "U".impter_19, "U".impter_20, "U".impter_21, "U".impter_22, "U".impter_23, "U".impter_24, "U".impter_25, "U".impter_26, "U".impter_27, "U".impter_28, "U".impter_29, "U".impter_30, "U".impter_31 
...
-- Code For temporary table TMP_20180602_9ET_ADS_IMP_1_OUT part 3. Create Index 

CREATE INDEX "ix_TMP_20180602_9ET_ADS_3907" ON "TMP_20180602_9ET_ADS_IMP_1_OUT" ("KEY")

-- Code For temporary table TMP_20180602_6X9_ADS_SCA_2_OUT part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180602_6X9_ADS_SCA_2_OUT" (
	"KEY" BIGINT NOT NULL, 
...
FROM "TMP_20180602_9ET_ADS_IMP_1_OUT" AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT") AS "U"

-- Code For temporary table TMP_20180602_6X9_ADS_SCA_2_OUT part 3. Create Index 

CREATE INDEX "ix_TMP_20180602_6X9_ADS_671e" ON "TMP_20180602_6X9_ADS_SCA_2_OUT" ("KEY")

-- Code For temporary table TMP_20180602_52Z_GB_B0 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180602_52Z_GB_B0" (
	"KEY" BIGINT, 
...
-- Code For temporary table TMP_20180602_52Z_GB_B0 part 2. Populate

INSERT INTO "TMP_20180602_52Z_GB_B0" ("KEY", "Score_0", "Score_1") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1" 
...
FROM "TMP_20180602_6X9_ADS_SCA_2_OUT" AS "ADS_sca_2_OUT"), 
"DT_node_data" AS 
(SELECT "Values".nid AS nid, CAST("Values"."E" AS DOUBLE PRECISION) AS "E" 
FROM (SELECT 3 AS nid, 1.4672680374970977 AS "E" FROM rdb$database UNION ALL SELECT 4 AS nid, -2.84375 AS "E" FROM rdb$database UNION ALL SELECT 6 AS nid, 1.542372881355932 AS "E" FROM rdb$database UNION ALL SELECT 7 AS nid, -2.5513418079096044 AS "E" FROM rdb$database UNION ALL SELECT 10 AS nid, 1.542372881355932 AS "E" FROM rdb$database UNION ALL SELECT 11 AS nid, -2.8126427455222975 AS "E" FROM rdb$database UNION ALL SELECT 12 AS nid, 1.542372881355932 AS "E" FROM rdb$database) AS "Values"), 
"DT_Output" AS 
...
"DT_node_data_1" AS 
(SELECT "Values".nid AS nid, CAST("Values"."E" AS DOUBLE PRECISION) AS "E" 
FROM (SELECT 3 AS nid, 1.3910810640434235 AS "E" FROM rdb$database UNION ALL SELECT 4 AS nid, -0.6596363687823121 AS "E" FROM rdb$database UNION ALL SELECT 5 AS nid, -2.4285605948643654 AS "E" FROM rdb$database UNION ALL SELECT 8 AS nid, 1.4648507794791157 AS "E" FROM rdb$database UNION ALL SELECT 9 AS nid, -2.3625649177559 AS "E" FROM rdb$database UNION ALL SELECT 10 AS nid, 1.4648507794791157 AS "E" FROM rdb$database) AS "Values"), 
"DT_Output_1" AS 
...
"DT_node_data_2" AS 
(SELECT "Values".nid AS nid, CAST("Values"."E" AS DOUBLE PRECISION) AS "E" 
FROM (SELECT 3 AS nid, 1.325752981201139 AS "E" FROM rdb$database UNION ALL SELECT 4 AS nid, -2.298828759622404 AS "E" FROM rdb$database UNION ALL SELECT 6 AS nid, -0.41581243138643503 AS "E" FROM rdb$database UNION ALL SELECT 7 AS nid, -2.1796581996190336 AS "E" FROM rdb$database UNION ALL SELECT 10 AS nid, 1.4015095712340189 AS "E" FROM rdb$database UNION ALL SELECT 11 AS nid, -2.0704363544628133 AS "E" FROM rdb$database UNION ALL SELECT 12 AS nid, 1.4015095712340189 AS "E" FROM rdb$database) AS "Values"), 
"DT_Output_2" AS 
...
-- Code For temporary table TMP_20180602_HDC_GB_B1 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180602_HDC_GB_B1" (
	"KEY" BIGINT, 
	"Score_0" DOUBLE PRECISION, 
	"Score_1" DOUBLE PRECISION
)
...
-- Code For temporary table TMP_20180602_HDC_GB_B1 part 2. Populate

INSERT INTO "TMP_20180602_HDC_GB_B1" ("KEY", "Score_0", "Score_1") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1" 
...
"DT_node_data_3" AS 
(SELECT "Values".nid AS nid, CAST("Values"."E" AS DOUBLE PRECISION) AS "E" 
FROM (SELECT 3 AS nid, 1.337391257440793 AS "E" FROM rdb$database UNION ALL SELECT 4 AS nid, 0.5259058848218274 AS "E" FROM rdb$database UNION ALL SELECT 6 AS nid, -1.964524712944416 AS "E" FROM rdb$database UNION ALL SELECT 7 AS nid, -0.3250280638871503 AS "E" FROM rdb$database UNION ALL SELECT 10 AS nid, 1.3490029638835022 AS "E" FROM rdb$database UNION ALL SELECT 11 AS nid, -1.864903415871084 AS "E" FROM rdb$database UNION ALL SELECT 12 AS nid, 1.3490029638835022 AS "E" FROM rdb$database) AS "Values"), 
"DT_Output_3" AS 
...
"DT_node_data_4" AS 
(SELECT "Values".nid AS nid, CAST("Values"."E" AS DOUBLE PRECISION) AS "E" 
FROM (SELECT 3 AS nid, 1.2252582301094506 AS "E" FROM rdb$database UNION ALL SELECT 4 AS nid, -0.6444012093376688 AS "E" FROM rdb$database UNION ALL SELECT 6 AS nid, -1.8831833870360208 AS "E" FROM rdb$database UNION ALL SELECT 7 AS nid, -1.7537720394216378 AS "E" FROM rdb$database UNION ALL SELECT 10 AS nid, 1.304959846853716 AS "E" FROM rdb$database UNION ALL SELECT 11 AS nid, -1.7123629964831781 AS "E" FROM rdb$database UNION ALL SELECT 12 AS nid, 1.304959846853716 AS "E" FROM rdb$database) AS "Values"), 
"DT_Output_4" AS 
...
-- Code For temporary table TMP_20180602_MV0_GB_B2 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180602_MV0_GB_B2" (
	"KEY" BIGINT, 
	"Score_0" DOUBLE PRECISION, 
	"Score_1" DOUBLE PRECISION
)
...
-- Code For temporary table TMP_20180602_MV0_GB_B2 part 2. Populate

INSERT INTO "TMP_20180602_MV0_GB_B2" ("KEY", "Score_0", "Score_1") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1" 
FROM (WITH "DT_node_lookup_5" AS 
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", CASE WHEN ("ADS_sca_2_OUT".scaler_29 <= 0.48149049282073975) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_25 <= 0.15994150936603546) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_29 <= 0.1327483057975769) THEN 3 ELSE 4 END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_28 <= -0.3612968325614929) THEN 6 ELSE 7 END END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_18 <= 3.273360252380371) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_28 <= -0.2999221384525299) THEN 10 ELSE 11 END ELSE 12 END END AS node_id_2 
FROM "TMP_20180602_6X9_ADS_SCA_2_OUT" AS "ADS_sca_2_OUT"), 
"DT_node_data_5" AS 
(SELECT "Values".nid AS nid, CAST("Values"."E" AS DOUBLE PRECISION) AS "E" 
FROM (SELECT 3 AS nid, 1.2415089447386418 AS "E" FROM rdb$database UNION ALL SELECT 4 AS nid, 0.30503527183452517 AS "E" FROM rdb$database UNION ALL SELECT 6 AS nid, -0.21670809809280697 AS "E" FROM rdb$database UNION ALL SELECT 7 AS nid, -1.7137770178917424 AS "E" FROM rdb$database UNION ALL SELECT 10 AS nid, 1.2676510643808934 AS "E" FROM rdb$database UNION ALL SELECT 11 AS nid, -1.5947285027219134 AS "E" FROM rdb$database UNION ALL SELECT 12 AS nid, 1.2676510643808934 AS "E" FROM rdb$database) AS "Values"), 
"DT_Output_5" AS 
...
"DT_node_data_6" AS 
(SELECT "Values".nid AS nid, CAST("Values"."E" AS DOUBLE PRECISION) AS "E" 
FROM (SELECT 3 AS nid, 1.1431754507972833 AS "E" FROM rdb$database UNION ALL SELECT 4 AS nid, -2.154747136176465 AS "E" FROM rdb$database UNION ALL SELECT 6 AS nid, 1.3937977212659114 AS "E" FROM rdb$database UNION ALL SELECT 7 AS nid, -1.4053585903840005 AS "E" FROM rdb$database UNION ALL SELECT 10 AS nid, 1.2357846827064884 AS "E" FROM rdb$database UNION ALL SELECT 11 AS nid, -1.5013341803568825 AS "E" FROM rdb$database UNION ALL SELECT 12 AS nid, 1.2357846827064884 AS "E" FROM rdb$database) AS "Values"), 
"DT_Output_6" AS 
...
"DT_node_data_7" AS 
(SELECT "Values".nid AS nid, CAST("Values"."E" AS DOUBLE PRECISION) AS "E" 
FROM (SELECT 3 AS nid, 1.1140638313109361 AS "E" FROM rdb$database UNION ALL SELECT 4 AS nid, -0.6850547208862369 AS "E" FROM rdb$database UNION ALL SELECT 6 AS nid, -1.622042151312407 AS "E" FROM rdb$database UNION ALL SELECT 7 AS nid, -1.463316569996885 AS "E" FROM rdb$database UNION ALL SELECT 10 AS nid, -0.6223244208798957 AS "E" FROM rdb$database UNION ALL SELECT 11 AS nid, -1.458362111766775 AS "E" FROM rdb$database UNION ALL SELECT 12 AS nid, 1.2083752537625256 AS "E" FROM rdb$database) AS "Values"), 
"DT_Output_7" AS 
...
-- Code For temporary table TMP_20180602_XXK_GB_B3 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180602_XXK_GB_B3" (
	"KEY" BIGINT, 
	"Score_0" DOUBLE PRECISION, 
	"Score_1" DOUBLE PRECISION
)
...
-- Code For temporary table TMP_20180602_XXK_GB_B3 part 2. Populate

INSERT INTO "TMP_20180602_XXK_GB_B3" ("KEY", "Score_0", "Score_1") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1" 
...
"DT_node_data_8" AS 
(SELECT "Values".nid AS nid, CAST("Values"."E" AS DOUBLE PRECISION) AS "E" 
FROM (SELECT 3 AS nid, 1.170082852660399 AS "E" FROM rdb$database UNION ALL SELECT 4 AS nid, -0.7688817876615806 AS "E" FROM rdb$database UNION ALL SELECT 6 AS nid, -5.312663161823737 AS "E" FROM rdb$database UNION ALL SELECT 7 AS nid, -0.3499135131559847 AS "E" FROM rdb$database UNION ALL SELECT 10 AS nid, 1.2604609511249625 AS "E" FROM rdb$database UNION ALL SELECT 11 AS nid, -1.39616203133061 AS "E" FROM rdb$database UNION ALL SELECT 13 AS nid, 1.2045413152456894 AS "E" FROM rdb$database UNION ALL SELECT 14 AS nid, -1.375147552727802 AS "E" FROM rdb$database) AS "Values"), 
"DT_Output_8" AS 
...
"DT_node_data_9" AS 
(SELECT "Values".nid AS nid, CAST("Values"."E" AS DOUBLE PRECISION) AS "E" 
FROM (SELECT 3 AS nid, -1.2313893936130431 AS "E" FROM rdb$database UNION ALL SELECT 4 AS nid, 1.0404918231271474 AS "E" FROM rdb$database UNION ALL SELECT 6 AS nid, -1.4609496820265393 AS "E" FROM rdb$database UNION ALL SELECT 7 AS nid, -1.348935694543427 AS "E" FROM rdb$database UNION ALL SELECT 10 AS nid, -0.4909139260216936 AS "E" FROM rdb$database UNION ALL SELECT 11 AS nid, -1.3496117136742993 AS "E" FROM rdb$database UNION ALL SELECT 12 AS nid, 1.1912333451680777 AS "E" FROM rdb$database) AS "Values"), 
"DT_Output_9" AS 
...
-- Code For temporary table TMP_20180602_XD4_GB_B4 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180602_XD4_GB_B4" (
	"KEY" BIGINT, 
	"Score_0" DOUBLE PRECISION, 
	"Score_1" DOUBLE PRECISION
)
...
-- Code For temporary table TMP_20180602_XD4_GB_B4 part 2. Populate

INSERT INTO "TMP_20180602_XD4_GB_B4" ("KEY", "Score_0", "Score_1") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1" 
...
"DT_node_data_10" AS 
(SELECT "Values".nid AS nid, CAST("Values"."E" AS DOUBLE PRECISION) AS "E" 
FROM (SELECT 3 AS nid, 1.1573788010278787 AS "E" FROM rdb$database UNION ALL SELECT 4 AS nid, -0.24332334325649765 AS "E" FROM rdb$database UNION ALL SELECT 6 AS nid, -3.813244609114664 AS "E" FROM rdb$database UNION ALL SELECT 7 AS nid, -0.28311533886774737 AS "E" FROM rdb$database UNION ALL SELECT 10 AS nid, 1.2081843772263323 AS "E" FROM rdb$database UNION ALL SELECT 11 AS nid, -1.301040835931553 AS "E" FROM rdb$database UNION ALL SELECT 13 AS nid, -5.5232853654050516 AS "E" FROM rdb$database UNION ALL SELECT 14 AS nid, -1.228061813737884 AS "E" FROM rdb$database) AS "Values"), 
"DT_Output_10" AS 
...
"DT_node_data_11" AS 
(SELECT "Values".nid AS nid, CAST("Values"."E" AS DOUBLE PRECISION) AS "E" 
FROM (SELECT 3 AS nid, 1.0130050080939823 AS "E" FROM rdb$database UNION ALL SELECT 4 AS nid, -0.6085975537753274 AS "E" FROM rdb$database UNION ALL SELECT 6 AS nid, -1.35226641067665 AS "E" FROM rdb$database UNION ALL SELECT 7 AS nid, -1.2697380467331816 AS "E" FROM rdb$database UNION ALL SELECT 10 AS nid, 1.248133592056964 AS "E" FROM rdb$database UNION ALL SELECT 11 AS nid, -1.2355331057844585 AS "E" FROM rdb$database UNION ALL SELECT 12 AS nid, 1.174632293648151 AS "E" FROM rdb$database) AS "Values"), 
"DT_Output_11" AS 
...
"DT_node_data_12" AS 
(SELECT "Values".nid AS nid, CAST("Values"."E" AS DOUBLE PRECISION) AS "E" 
FROM (SELECT 3 AS nid, 1.1129323613426614 AS "E" FROM rdb$database UNION ALL SELECT 4 AS nid, -0.3833120183862359 AS "E" FROM rdb$database UNION ALL SELECT 6 AS nid, -2.512518864432701 AS "E" FROM rdb$database UNION ALL SELECT 7 AS nid, 1.3964432581512807 AS "E" FROM rdb$database UNION ALL SELECT 10 AS nid, 1.175433734908052 AS "E" FROM rdb$database UNION ALL SELECT 11 AS nid, -1.2330697012930862 AS "E" FROM rdb$database UNION ALL SELECT 13 AS nid, 0.13615090246014946 AS "E" FROM rdb$database UNION ALL SELECT 14 AS nid, -1.2503365564467128 AS "E" FROM rdb$database) AS "Values"), 
"DT_Output_12" AS 
...
-- Code For temporary table TMP_20180602_RBR_GB_B5 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180602_RBR_GB_B5" (
	"KEY" BIGINT, 
	"Score_0" DOUBLE PRECISION, 
	"Score_1" DOUBLE PRECISION
)
...
-- Code For temporary table TMP_20180602_RBR_GB_B5 part 2. Populate

INSERT INTO "TMP_20180602_RBR_GB_B5" ("KEY", "Score_0", "Score_1") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1" 
...
"DT_node_data_13" AS 
(SELECT "Values".nid AS nid, CAST("Values"."E" AS DOUBLE PRECISION) AS "E" 
FROM (SELECT 3 AS nid, -1.728247179407999 AS "E" FROM rdb$database UNION ALL SELECT 4 AS nid, 1.0122933091300323 AS "E" FROM rdb$database UNION ALL SELECT 6 AS nid, -1.2961392831818679 AS "E" FROM rdb$database UNION ALL SELECT 7 AS nid, -1.2121769656039516 AS "E" FROM rdb$database UNION ALL SELECT 10 AS nid, 1.1616683622263533 AS "E" FROM rdb$database UNION ALL SELECT 11 AS nid, -1.253400761953175 AS "E" FROM rdb$database UNION ALL SELECT 13 AS nid, -0.2370429284357811 AS "E" FROM rdb$database UNION ALL SELECT 14 AS nid, -1.2514709178702141 AS "E" FROM rdb$database) AS "Values"), 
"DT_Output_13" AS 
...
"DT_node_data_14" AS 
(SELECT "Values".nid AS nid, CAST("Values"."E" AS DOUBLE PRECISION) AS "E" 
FROM (SELECT 3 AS nid, 1.015313346764975 AS "E" FROM rdb$database UNION ALL SELECT 4 AS nid, -1.2320153919118215 AS "E" FROM rdb$database UNION ALL SELECT 6 AS nid, -2.340648965439501 AS "E" FROM rdb$database UNION ALL SELECT 7 AS nid, 1.311580978429844 AS "E" FROM rdb$database UNION ALL SELECT 10 AS nid, 1.4370603152604646 AS "E" FROM rdb$database UNION ALL SELECT 11 AS nid, -1.0100591137193176 AS "E" FROM rdb$database UNION ALL SELECT 13 AS nid, -6.67333385029474 AS "E" FROM rdb$database UNION ALL SELECT 14 AS nid, -1.1537588917855885 AS "E" FROM rdb$database) AS "Values"), 
"DT_Output_14" AS 
...
-- Code For temporary table TMP_20180602_CAZ_GB_B6 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180602_CAZ_GB_B6" (
	"KEY" BIGINT, 
	"Score_0" DOUBLE PRECISION, 
	"Score_1" DOUBLE PRECISION
)
...
-- Code For temporary table TMP_20180602_CAZ_GB_B6 part 2. Populate

INSERT INTO "TMP_20180602_CAZ_GB_B6" ("KEY", "Score_0", "Score_1") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1" 
...
"DT_node_data_15" AS 
(SELECT "Values".nid AS nid, CAST("Values"."E" AS DOUBLE PRECISION) AS "E" 
FROM (SELECT 3 AS nid, 0.8646324817801285 AS "E" FROM rdb$database UNION ALL SELECT 4 AS nid, 3.5719361261467393 AS "E" FROM rdb$database UNION ALL SELECT 6 AS nid, -1.205331690676246 AS "E" FROM rdb$database UNION ALL SELECT 7 AS nid, 1.111745945147061 AS "E" FROM rdb$database UNION ALL SELECT 9 AS nid, -3.708144152948966 AS "E" FROM rdb$database UNION ALL SELECT 11 AS nid, -0.010190020632271308 AS "E" FROM rdb$database UNION ALL SELECT 12 AS nid, -1.146306323182662 AS "E" FROM rdb$database) AS "Values"), 
"DT_Output_15" AS 
...
-- Code For temporary table TMP_20180602_3O2_GB_SUM part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180602_3O2_GB_SUM" (
	"KEY" BIGINT NOT NULL, 
	"Score_0" DOUBLE PRECISION, 
	"Score_1" DOUBLE PRECISION, 
	PRIMARY KEY ("KEY")
...
-- Code For temporary table TMP_20180602_3O2_GB_SUM part 2. Populate

INSERT INTO "TMP_20180602_3O2_GB_SUM" ("KEY", "Score_0", "Score_1") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1" 
...
FROM "TMP_20180602_52Z_GB_B0" AS "GB_B0" UNION ALL SELECT "GB_B1"."KEY" AS "KEY", "GB_B1"."Score_0" AS "Score_0", "GB_B1"."Score_1" AS "Score_1" 
FROM "TMP_20180602_HDC_GB_B1" AS "GB_B1" UNION ALL SELECT "GB_B2"."KEY" AS "KEY", "GB_B2"."Score_0" AS "Score_0", "GB_B2"."Score_1" AS "Score_1" 
FROM "TMP_20180602_MV0_GB_B2" AS "GB_B2" UNION ALL SELECT "GB_B3"."KEY" AS "KEY", "GB_B3"."Score_0" AS "Score_0", "GB_B3"."Score_1" AS "Score_1" 
FROM "TMP_20180602_XXK_GB_B3" AS "GB_B3" UNION ALL SELECT "GB_B4"."KEY" AS "KEY", "GB_B4"."Score_0" AS "Score_0", "GB_B4"."Score_1" AS "Score_1" 
FROM "TMP_20180602_XD4_GB_B4" AS "GB_B4" UNION ALL SELECT "GB_B5"."KEY" AS "KEY", "GB_B5"."Score_0" AS "Score_0", "GB_B5"."Score_1" AS "Score_1" 
FROM "TMP_20180602_RBR_GB_B5" AS "GB_B5" UNION ALL SELECT "GB_B6"."KEY" AS "KEY", "GB_B6"."Score_0" AS "Score_0", "GB_B6"."Score_1" AS "Score_1" 
FROM "TMP_20180602_CAZ_GB_B6" AS "GB_B6") AS "GB_EnsembleUnion")
...
-- Code For temporary table TMP_20180602_3O2_GB_SUM part 3. Create Index 

CREATE INDEX "ix_TMP_20180602_3O2_GB_SUM_KEY" ON "TMP_20180602_3O2_GB_SUM" ("KEY")

-- Model deployment code

WITH orig_cte AS 
(SELECT "GB_sum"."KEY" AS "KEY", -(0.6118015411059929 + 0.1 * "GB_sum"."Score_1") AS "Score_0", 0.6118015411059929 + 0.1 * "GB_sum"."Score_1" AS "Score_1", 1.0 - 1.0 / (1.0 + exp(CASE WHEN (minvalue(maxvalue(-100.0, -(0.6118015411059929 + 0.1 * "GB_sum"."Score_1")), 100.0) >= -709.782712893384) THEN minvalue(maxvalue(-100.0, -(0.6118015411059929 + 0.1 * "GB_sum"."Score_1")), 100.0) ELSE -709.782712893384 END)) AS "Proba_0", 1.0 / (1.0 + exp(CASE WHEN (minvalue(maxvalue(-100.0, -(0.6118015411059929 + 0.1 * "GB_sum"."Score_1")), 100.0) >= -709.782712893384) THEN minvalue(maxvalue(-100.0, -(0.6118015411059929 + 0.1 * "GB_sum"."Score_1")), 100.0) ELSE -709.782712893384 END)) AS "Proba_1", CAST(NULL AS DOUBLE PRECISION) AS "LogProba_0", CAST(NULL AS DOUBLE PRECISION) AS "LogProba_1", CAST(NULL AS BIGINT) AS "Decision", CAST(NULL AS DOUBLE PRECISION) AS "DecisionProba" 
FROM "TMP_20180602_3O2_GB_SUM" AS "GB_sum"), 
