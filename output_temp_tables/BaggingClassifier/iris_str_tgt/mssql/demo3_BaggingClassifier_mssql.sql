...
-- Code For temporary table ##TMP_20180602160115_4K4_BAG_B0 part 1. Create 


CREATE TABLE ##TMP_20180602160115_4K4_BAG_B0 (
	[KEY] BIGINT NULL, 
...
-- Code For temporary table ##TMP_20180602160115_4K4_BAG_B0 part 2. Populate
...
-- Code For temporary table ##TMP_20180602160115_Z1S_BAG_B1 part 1. Create 


CREATE TABLE ##TMP_20180602160115_Z1S_BAG_B1 (
	[KEY] BIGINT NULL, 
	[Score_CLASS_0] FLOAT(53) NULL, 
	[Proba_CLASS_0] FLOAT(53) NULL, 
	[LogProba_CLASS_0] FLOAT(53) NULL, 
...
-- Code For temporary table ##TMP_20180602160115_Z1S_BAG_B1 part 2. Populate
...
-- Code For temporary table ##TMP_20180602160115_ICK_BAG_avg part 1. Create 


CREATE TABLE ##TMP_20180602160115_ICK_BAG_avg (
	[KEY] BIGINT NULL, 
	[Score_CLASS_0] FLOAT(53) NULL, 
	[Proba_CLASS_0] FLOAT(53) NULL, 
	[LogProba_CLASS_0] FLOAT(53) NULL, 
...
-- Code For temporary table ##TMP_20180602160115_ICK_BAG_avg part 2. Populate
...
FROM ##TMP_20180602160115_ICK_BAG_avg AS [BAG_avg]), 
