...
-- Code For temporary table TMP_20180602_0TZ_BAG_B0 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180602_0TZ_BAG_B0" (
	"KEY" BIGINT, 
...
-- Code For temporary table TMP_20180602_0TZ_BAG_B0 part 2. Populate

INSERT INTO "TMP_20180602_0TZ_BAG_B0" ("KEY", "Score_0", "Proba_0", "LogProba_0", "Score_1", "Proba_1", "LogProba_1", "Score_2", "Proba_2", "LogProba_2") SELECT "U"."KEY", "U"."Score_0", "U"."Proba_0", "U"."LogProba_0", "U"."Score_1", "U"."Proba_1", "U"."LogProba_1", "U"."Score_2", "U"."Proba_2", "U"."LogProba_2" 
...
-- Code For temporary table TMP_20180602_3DS_BAG_B1 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180602_3DS_BAG_B1" (
	"KEY" BIGINT, 
	"Score_0" DOUBLE PRECISION, 
	"Proba_0" DOUBLE PRECISION, 
	"LogProba_0" DOUBLE PRECISION, 
...
-- Code For temporary table TMP_20180602_3DS_BAG_B1 part 2. Populate

INSERT INTO "TMP_20180602_3DS_BAG_B1" ("KEY", "Score_0", "Proba_0", "LogProba_0", "Score_1", "Proba_1", "LogProba_1", "Score_2", "Proba_2", "LogProba_2") SELECT "U"."KEY", "U"."Score_0", "U"."Proba_0", "U"."LogProba_0", "U"."Score_1", "U"."Proba_1", "U"."LogProba_1", "U"."Score_2", "U"."Proba_2", "U"."LogProba_2" 
...
-- Code For temporary table TMP_20180602_FWR_BAG_B2 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180602_FWR_BAG_B2" (
	"KEY" BIGINT, 
	"Score_0" DOUBLE PRECISION, 
	"Proba_0" DOUBLE PRECISION, 
	"LogProba_0" DOUBLE PRECISION, 
...
-- Code For temporary table TMP_20180602_FWR_BAG_B2 part 2. Populate

INSERT INTO "TMP_20180602_FWR_BAG_B2" ("KEY", "Score_0", "Proba_0", "LogProba_0", "Score_1", "Proba_1", "LogProba_1", "Score_2", "Proba_2", "LogProba_2") SELECT "U"."KEY", "U"."Score_0", "U"."Proba_0", "U"."LogProba_0", "U"."Score_1", "U"."Proba_1", "U"."LogProba_1", "U"."Score_2", "U"."Proba_2", "U"."LogProba_2" 
...
FROM "DT_Output_14")
 SELECT "BAG_B2"."KEY", "BAG_B2"."Score_0", "BAG_B2"."Proba_0", "BAG_B2"."LogProba_0", "BAG_B2"."Score_1", "BAG_B2"."Proba_1", "BAG_B2"."LogProba_1", "BAG_B2"."Score_2", "BAG_B2"."Proba_2", "BAG_B2"."LogProba_2" 
FROM (SELECT "BAG_esu_2"."KEY" AS "KEY", "BAG_esu_2"."Score_0" AS "Score_0", "BAG_esu_2"."Proba_0" AS "Proba_0", "BAG_esu_2"."LogProba_0" AS "LogProba_0", "BAG_esu_2"."Score_1" AS "Score_1", "BAG_esu_2"."Proba_1" AS "Proba_1", "BAG_esu_2"."LogProba_1" AS "LogProba_1", "BAG_esu_2"."Score_2" AS "Score_2", "BAG_esu_2"."Proba_2" AS "Proba_2", "BAG_esu_2"."LogProba_2" AS "LogProba_2" 
...
-- Code For temporary table TMP_20180602_SYZ_BAG_B3 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180602_SYZ_BAG_B3" (
	"KEY" BIGINT, 
	"Score_0" DOUBLE PRECISION, 
	"Proba_0" DOUBLE PRECISION, 
	"LogProba_0" DOUBLE PRECISION, 
...
-- Code For temporary table TMP_20180602_SYZ_BAG_B3 part 2. Populate

INSERT INTO "TMP_20180602_SYZ_BAG_B3" ("KEY", "Score_0", "Proba_0", "LogProba_0", "Score_1", "Proba_1", "LogProba_1", "Score_2", "Proba_2", "LogProba_2") SELECT "U"."KEY", "U"."Score_0", "U"."Proba_0", "U"."LogProba_0", "U"."Score_1", "U"."Proba_1", "U"."LogProba_1", "U"."Score_2", "U"."Proba_2", "U"."LogProba_2" 
...
FROM "DT_Output_15")
 SELECT "BAG_B3"."KEY", "BAG_B3"."Score_0", "BAG_B3"."Proba_0", "BAG_B3"."LogProba_0", "BAG_B3"."Score_1", "BAG_B3"."Proba_1", "BAG_B3"."LogProba_1", "BAG_B3"."Score_2", "BAG_B3"."Proba_2", "BAG_B3"."LogProba_2" 
FROM (SELECT "BAG_esu_3"."KEY" AS "KEY", "BAG_esu_3"."Score_0" AS "Score_0", "BAG_esu_3"."Proba_0" AS "Proba_0", "BAG_esu_3"."LogProba_0" AS "LogProba_0", "BAG_esu_3"."Score_1" AS "Score_1", "BAG_esu_3"."Proba_1" AS "Proba_1", "BAG_esu_3"."LogProba_1" AS "LogProba_1", "BAG_esu_3"."Score_2" AS "Score_2", "BAG_esu_3"."Proba_2" AS "Proba_2", "BAG_esu_3"."LogProba_2" AS "LogProba_2" 
...
-- Code For temporary table TMP_20180602_CYY_BAG_AVG part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180602_CYY_BAG_AVG" (
	"KEY" BIGINT NOT NULL, 
	"Score_0" DOUBLE PRECISION, 
	"Proba_0" DOUBLE PRECISION, 
	"LogProba_0" DOUBLE PRECISION, 
...
-- Code For temporary table TMP_20180602_CYY_BAG_AVG part 2. Populate

INSERT INTO "TMP_20180602_CYY_BAG_AVG" ("KEY", "Score_0", "Proba_0", "LogProba_0", "Score_1", "Proba_1", "LogProba_1", "Score_2", "Proba_2", "LogProba_2") SELECT "U"."KEY", "U"."Score_0", "U"."Proba_0", "U"."LogProba_0", "U"."Score_1", "U"."Proba_1", "U"."LogProba_1", "U"."Score_2", "U"."Proba_2", "U"."LogProba_2" 
...
-- Code For temporary table TMP_20180602_CYY_BAG_AVG part 3. Create Index 

CREATE INDEX "ix_TMP_20180602_CYY_BAG_AVG_KEY" ON "TMP_20180602_CYY_BAG_AVG" ("KEY")
...
FROM "TMP_20180602_CYY_BAG_AVG" AS "BAG_avg"), 
