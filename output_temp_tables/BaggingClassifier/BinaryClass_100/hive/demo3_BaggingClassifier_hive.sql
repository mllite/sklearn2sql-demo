...
-- Code For temporary table tmp_20180602141632_c5f_bag_b0 part 1. Create 

CREATE TEMPORARY TABLE `tmp_20180602141632_c5f_bag_b0` STORED AS ORC AS WITH `DT_node_lookup` AS 
...
-- Code For temporary table tmp_20180602141632_c5f_bag_b0 part 2. Populate

SELECT * FROM `tmp_20180602141632_c5f_bag_b0`

-- Code For temporary table tmp_20180602141632_uxe_bag_b1 part 1. Create 

CREATE TEMPORARY TABLE `tmp_20180602141632_uxe_bag_b1` STORED AS ORC AS WITH `DT_node_lookup_10` AS 
...
-- Code For temporary table tmp_20180602141632_uxe_bag_b1 part 2. Populate

SELECT * FROM `tmp_20180602141632_uxe_bag_b1`

-- Code For temporary table tmp_20180602141632_k1t_bag_avg part 1. Create 

CREATE TEMPORARY TABLE `tmp_20180602141632_k1t_bag_avg` STORED AS ORC AS WITH `BAG_Union` AS 
...
FROM `tmp_20180602141632_c5f_bag_b0` AS `BAG_B0` UNION ALL SELECT `BAG_B1`.`KEY` AS `KEY`, `BAG_B1`.`Score_0` AS `Score_0`, `BAG_B1`.`Proba_0` AS `Proba_0`, `BAG_B1`.`LogProba_0` AS `LogProba_0`, `BAG_B1`.`Score_1` AS `Score_1`, `BAG_B1`.`Proba_1` AS `Proba_1`, `BAG_B1`.`LogProba_1` AS `LogProba_1` 
FROM `tmp_20180602141632_uxe_bag_b1` AS `BAG_B1`) AS `BAG_EnsembleUnion`)
...
-- Code For temporary table tmp_20180602141632_k1t_bag_avg part 2. Populate

SELECT * FROM `tmp_20180602141632_k1t_bag_avg`
...
FROM `tmp_20180602141632_k1t_bag_avg` AS `BAG_avg`), 
