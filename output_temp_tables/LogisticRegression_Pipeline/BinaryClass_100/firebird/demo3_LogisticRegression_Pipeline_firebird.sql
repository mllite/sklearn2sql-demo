...
-- Code For temporary table TMP_20180602_IK2_ADS_IMP_1_OUT part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180602_IK2_ADS_IMP_1_OUT" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20180602_IK2_ADS_IMP_1_OUT part 3. Create Index 

CREATE INDEX "ix_TMP_20180602_IK2_ADS_7e97" ON "TMP_20180602_IK2_ADS_IMP_1_OUT" ("KEY")

-- Code For temporary table TMP_20180602_HW0_ADS_SCA_2_OUT part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180602_HW0_ADS_SCA_2_OUT" (
	"KEY" BIGINT NOT NULL, 
...
FROM "TMP_20180602_IK2_ADS_IMP_1_OUT" AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT") AS "U"

-- Code For temporary table TMP_20180602_HW0_ADS_SCA_2_OUT part 3. Create Index 

CREATE INDEX "ix_TMP_20180602_HW0_ADS_2f52" ON "TMP_20180602_HW0_ADS_SCA_2_OUT" ("KEY")
...
FROM "TMP_20180602_HW0_ADS_SCA_2_OUT" AS "ADS_sca_2_OUT"), 
linear_model_cte AS 
