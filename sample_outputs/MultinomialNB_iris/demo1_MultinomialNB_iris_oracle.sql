...
WITH "RawScores" AS 
(SELECT "ADS"."KEY" AS "KEY", CAST(NULL AS FLOAT) AS "LogProba_0", CAST(NULL AS FLOAT) AS "Proba_0", -1.09861228867 + "ADS"."Feature_0" * -0.708939060258 + "ADS"."Feature_1" * -1.08867359242 + "ADS"."Feature_2" * -1.92882235463 + "ADS"."Feature_3" * -3.65536967522 AS "Score_0", CAST(NULL AS FLOAT) AS "LogProba_1", CAST(NULL AS FLOAT) AS "Proba_1", -1.09861228867 + "ADS"."Feature_0" * -0.88088275443 + "ADS"."Feature_1" * -1.63924027342 + "ADS"."Feature_2" * -1.21132885966 + "ADS"."Feature_3" * -2.36814463803 AS "Score_1", CAST(NULL AS FLOAT) AS "LogProba_2", CAST(NULL AS FLOAT) AS "Proba_2", -1.09861228867 + "ADS"."Feature_0" * -0.957790462781 + "ADS"."Feature_1" * -1.749461213 + "ADS"."Feature_2" * -1.12831744308 + "ADS"."Feature_3" * -2.13018483147 AS "Score_2" 
FROM "INPUT_DATA" "ADS"), 
orig_cte AS 
