...
WITH "RawScores" AS 
(SELECT "ADS"."KEY" AS "KEY", CAST(NULL AS FLOAT(53)) AS "LogProba_-1", CAST(NULL AS FLOAT(53)) AS "Proba_-1", -0.798507696218 + (-0.5 * 1.58442095539 - (0.5 * ("ADS"."Feature_0" - -0.109137440008) * ("ADS"."Feature_0" - -0.109137440008)) / 0.776113807022) + (-0.5 * 1.7144176729 - (0.5 * ("ADS"."Feature_1" - -0.092803070908) * ("ADS"."Feature_1" - -0.092803070908)) / 0.883857530869) + (-0.5 * 1.89182397282 - (0.5 * ("ADS"."Feature_2" - 0.24011601671) * ("ADS"."Feature_2" - 0.24011601671)) / 1.05542856418) + (-0.5 * 1.69899885243 - (0.5 * ("ADS"."Feature_3" - 0.0314315046681) * ("ADS"."Feature_3" - 0.0314315046681)) / 0.870334016522) + (-0.5 * 1.98835581986 - (0.5 * ("ADS"."Feature_4" - 0.113969267155) * ("ADS"."Feature_4" - 0.113969267155)) / 1.16239060805) AS "Score_-1", CAST(NULL AS FLOAT(53)) AS "LogProba_1", CAST(NULL AS FLOAT(53)) AS "Proba_1", -0.597837000756 + (-0.5 * 1.97704795347 - (0.5 * ("ADS"."Feature_0" - -0.0370523473936) * ("ADS"."Feature_0" - -0.0370523473936)) / 1.14932048723) + (-0.5 * 1.77770931195 - (0.5 * ("ADS"."Feature_1" - -0.140731130923) * ("ADS"."Feature_1" - -0.140731130923)) / 0.941606561639) + (-0.5 * 1.73261656279 - (0.5 * ("ADS"."Feature_2" - -0.428998376845) * ("ADS"."Feature_2" - -0.428998376845)) / 0.900090015333) + (-0.5 * 1.91614260175 - (0.5 * ("ADS"."Feature_3" - -0.233511860564) * ("ADS"."Feature_3" - -0.233511860564)) / 1.08140977306) + (-0.5 * 1.70136476627 - (0.5 * ("ADS"."Feature_4" - -0.0181072243001) * ("ADS"."Feature_4" - -0.0181072243001)) / 0.872395589609) AS "Score_1" 
