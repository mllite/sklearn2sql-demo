...
FROM "ADS_imp_1_OUT"), 
"RawScores" AS 
(SELECT "ADS_ano_2_OUT"."KEY" AS "KEY", CAST(NULL AS FLOAT(53)) AS "LogProba_-1", CAST(NULL AS FLOAT(53)) AS "Proba_-1", -0.798507696218 + (-0.5 * 2.21070085108 - (0.5 * ("ADS_ano_2_OUT".anova_output_2 - 0.162565691702) * ("ADS_ano_2_OUT".anova_output_2 - 0.162565691702)) / 1.45182848286) + (-0.5 * 2.17642442612 - (0.5 * ("ADS_ano_2_OUT".anova_output_3 - 0.30644346448) * ("ADS_ano_2_OUT".anova_output_3 - 0.30644346448)) / 1.40290818871) + (-0.5 * 1.53414729477 - (0.5 * ("ADS_ano_2_OUT".anova_output_4 - 0.134110119753) * ("ADS_ano_2_OUT".anova_output_4 - 0.134110119753)) / 0.738060284327) + (-0.5 * 1.39063374151 - (0.5 * ("ADS_ano_2_OUT".anova_output_5 - -0.0152808388623) * ("ADS_ano_2_OUT".anova_output_5 - -0.0152808388623)) / 0.639388310251) + (-0.5 * 1.17611083482 - (0.5 * ("ADS_ano_2_OUT".anova_output_6 - -0.160177628) * ("ADS_ano_2_OUT".anova_output_6 - -0.160177628)) / 0.515939261043) AS "Score_-1", CAST(NULL AS FLOAT(53)) AS "LogProba_1", CAST(NULL AS FLOAT(53)) AS "Proba_1", -0.597837000756 + (-0.5 * 1.77302357769 - (0.5 * ("ADS_ano_2_OUT".anova_output_2 - -0.133008293211) * ("ADS_ano_2_OUT".anova_output_2 - -0.133008293211)) / 0.937204764387) + (-0.5 * 1.67717854953 - (0.5 * ("ADS_ano_2_OUT".anova_output_3 - -0.250726470938) * ("ADS_ano_2_OUT".anova_output_3 - -0.250726470938)) / 0.851548759986) + (-0.5 * 1.9886774458 - (0.5 * ("ADS_ano_2_OUT".anova_output_4 - -0.109726461616) * ("ADS_ano_2_OUT".anova_output_4 - -0.109726461616)) / 1.16276452315) + (-0.5 * 1.93817834925 - (0.5 * ("ADS_ano_2_OUT".anova_output_5 - 0.0125025045237) * ("ADS_ano_2_OUT".anova_output_5 - 0.0125025045237)) / 1.10550393727) + (-0.5 * 1.71886877839 - (0.5 * ("ADS_ano_2_OUT".anova_output_6 - 0.131054422909) * ("ADS_ano_2_OUT".anova_output_6 - 0.131054422909)) / 0.887800442621) AS "Score_1" 
FROM "ADS_ano_2_OUT"), 
orig_cte AS 
