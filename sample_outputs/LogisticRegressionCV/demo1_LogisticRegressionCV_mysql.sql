...
FROM (SELECT `ADS`.`KEY` AS `KEY`, 0.008138740131190909 * `ADS`.`Feature_0` + -0.043994486040755 * `ADS`.`Feature_1` + -0.3523396197940023 * `ADS`.`Feature_2` + -0.13849766934475083 * `ADS`.`Feature_3` + -0.06684155229714452 * `ADS`.`Feature_4` + 0.14550035708 AS linear_combination 
