...
WITH "RawScores" AS 
(SELECT "ADS"."KEY" AS "KEY", CAST(NULL AS FLOAT(53)) AS "LogProba_-1", CAST(NULL AS FLOAT(53)) AS "Proba_-1", -0.798507696218 + "ADS"."Feature_0" * -0.714653385781 + (1 - "ADS"."Feature_0") * -0.672093771362 + "ADS"."Feature_1" * -0.805625163987 + (1 - "ADS"."Feature_1") * -0.592051063689 + "ADS"."Feature_2" * -0.482851771724 + (1 - "ADS"."Feature_2") * -0.959775843814 + "ADS"."Feature_3" * -0.805625163987 + (1 - "ADS"."Feature_3") * -0.592051063689 + "ADS"."Feature_4" * -0.672093771362 + (1 - "ADS"."Feature_4") * -0.714653385781 AS "Score_-1", CAST(NULL AS FLOAT(53)) AS "LogProba_1", CAST(NULL AS FLOAT(53)) AS "Proba_1", -0.597837000756 + "ADS"."Feature_0" * -0.74721440183 + (1 - "ADS"."Feature_0") * -0.641853886172 + "ADS"."Feature_1" * -0.824175442966 + (1 - "ADS"."Feature_1") * -0.577315365035 + "ADS"."Feature_2" * -1.09861228867 + (1 - "ADS"."Feature_2") * -0.405465108108 + "ADS"."Feature_3" * -0.824175442966 + (1 - "ADS"."Feature_3") * -0.577315365035 + "ADS"."Feature_4" * -0.74721440183 + (1 - "ADS"."Feature_4") * -0.641853886172 AS "Score_1" 
