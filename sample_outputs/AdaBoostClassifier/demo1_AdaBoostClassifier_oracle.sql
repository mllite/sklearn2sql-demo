...
"DT_node_data_2" AS 
(SELECT "Values".node_id AS node_id, "Values".feature AS feature, "Values".threshold AS threshold, "Values".count AS count, "Values".depth AS depth, "Values"."Proba_-1" AS "Proba_-1", "Values"."LogProba_-1" AS "LogProba_-1", "Values"."Proba_1" AS "Proba_1", "Values"."LogProba_1" AS "LogProba_1", "Values"."Decision" AS "Decision" 
FROM (SELECT 0 AS node_id, 'Feature_3' AS feature, -0.7610960602760315 AS threshold, 100 AS count, 0 AS depth, 0.5000000000000001 AS "Proba_-1", -0.69314718056 AS "LogProba_-1", 0.4999999999999999 AS "Proba_1", -0.69314718056 AS "LogProba_1", -1 AS "Decision" FROM DUAL UNION ALL SELECT 1 AS node_id, CAST(NULL AS VARCHAR2(256 CHAR)) AS feature, CAST(NULL AS FLOAT) AS threshold, 25 AS count, 1 AS depth, 0.3022840745072261 AS "Proba_-1", -1.19638805967 AS "LogProba_-1", 0.6977159254927738 AS "Proba_1", -0.359943242595 AS "LogProba_1", 1 AS "Decision" FROM DUAL UNION ALL SELECT 2 AS node_id, CAST(NULL AS VARCHAR2(256 CHAR)) AS feature, CAST(NULL AS FLOAT) AS threshold, 75 AS count, 1 AS depth, 0.560374680538914 AS "Proba_-1", -0.579149646591 AS "LogProba_-1", 0.43962531946108596 AS "Proba_1", -0.821832461521 AS "LogProba_1", -1 AS "Decision" FROM DUAL) "Values"), 
"DT_node_lookup_2" AS 
...
"DT_node_data_3" AS 
(SELECT "Values".node_id AS node_id, "Values".feature AS feature, "Values".threshold AS threshold, "Values".count AS count, "Values".depth AS depth, "Values"."Proba_-1" AS "Proba_-1", "Values"."LogProba_-1" AS "LogProba_-1", "Values"."Proba_1" AS "Proba_1", "Values"."LogProba_1" AS "LogProba_1", "Values"."Decision" AS "Decision" 
FROM (SELECT 0 AS node_id, 'Feature_2' AS feature, 1.6307957172393799 AS threshold, 100 AS count, 0 AS depth, 0.5000000000000001 AS "Proba_-1", -0.69314718056 AS "LogProba_-1", 0.5 AS "Proba_1", -0.69314718056 AS "LogProba_1", -1 AS "Decision" FROM DUAL UNION ALL SELECT 1 AS node_id, CAST(NULL AS VARCHAR2(256 CHAR)) AS feature, CAST(NULL AS FLOAT) AS threshold, 96 AS count, 1 AS depth, 0.4831486967775019 AS "Proba_-1", -0.727430811886 AS "LogProba_-1", 0.5168513032224982 AS "Proba_1", -0.660000060499 AS "LogProba_1", 1 AS "Decision" FROM DUAL UNION ALL SELECT 2 AS node_id, CAST(NULL AS VARCHAR2(256 CHAR)) AS feature, CAST(NULL AS FLOAT) AS threshold, 4 AS count, 1 AS depth, 1.0 AS "Proba_-1", 0.0 AS "LogProba_-1", 0.0 AS "Proba_1", -BINARY_FLOAT_INFINITY AS "LogProba_1", -1 AS "Decision" FROM DUAL) "Values"), 
"DT_node_lookup_3" AS 
...
"DT_node_data_4" AS 
(SELECT "Values".node_id AS node_id, "Values".feature AS feature, "Values".threshold AS threshold, "Values".count AS count, "Values".depth AS depth, "Values"."Proba_-1" AS "Proba_-1", "Values"."LogProba_-1" AS "LogProba_-1", "Values"."Proba_1" AS "Proba_1", "Values"."LogProba_1" AS "LogProba_1", "Values"."Decision" AS "Decision" 
FROM (SELECT 0 AS node_id, 'Feature_1' AS feature, -1.5352129936218262 AS threshold, 100 AS count, 0 AS depth, 0.5000000002512467 AS "Proba_-1", -0.693147180057 AS "LogProba_-1", 0.4999999997487534 AS "Proba_1", -0.693147181062 AS "LogProba_1", -1 AS "Decision" FROM DUAL UNION ALL SELECT 1 AS node_id, CAST(NULL AS VARCHAR2(256 CHAR)) AS feature, CAST(NULL AS FLOAT) AS threshold, 6 AS count, 1 AS depth, 2.2838748156227793e-09 AS "Proba_-1", -19.8973923559 AS "LogProba_-1", 0.9999999977161251 AS "Proba_1", -2.28387486961e-09 AS "LogProba_1", 1 AS "Decision" FROM DUAL UNION ALL SELECT 2 AS node_id, CAST(NULL AS VARCHAR2(256 CHAR)) AS feature, CAST(NULL AS FLOAT) AS threshold, 94 AS count, 1 AS depth, 0.524472321121912 AS "Proba_-1", -0.64536262447 AS "LogProba_-1", 0.47552767887808806 AS "Proba_1", -0.743330188642 AS "LogProba_1", -1 AS "Decision" FROM DUAL) "Values"), 
"DT_node_lookup_4" AS 
...
"DT_node_data_6" AS 
(SELECT "Values".node_id AS node_id, "Values".feature AS feature, "Values".threshold AS threshold, "Values".count AS count, "Values".depth AS depth, "Values"."Proba_-1" AS "Proba_-1", "Values"."LogProba_-1" AS "LogProba_-1", "Values"."Proba_1" AS "Proba_1", "Values"."LogProba_1" AS "LogProba_1", "Values"."Decision" AS "Decision" 
FROM (SELECT 0 AS node_id, 'Feature_4' AS feature, -0.45125359296798706 AS threshold, 100 AS count, 0 AS depth, 0.4999999999999997 AS "Proba_-1", -0.69314718056 AS "LogProba_-1", 0.5000000000000003 AS "Proba_1", -0.69314718056 AS "LogProba_1", 1 AS "Decision" FROM DUAL UNION ALL SELECT 1 AS node_id, CAST(NULL AS VARCHAR2(256 CHAR)) AS feature, CAST(NULL AS FLOAT) AS threshold, 29 AS count, 1 AS depth, 0.31855922585902813 AS "Proba_-1", -1.1439468688 AS "LogProba_-1", 0.6814407741409719 AS "Proba_1", -0.383545936771 AS "LogProba_1", 1 AS "Decision" FROM DUAL UNION ALL SELECT 2 AS node_id, CAST(NULL AS VARCHAR2(256 CHAR)) AS feature, CAST(NULL AS FLOAT) AS threshold, 71 AS count, 1 AS depth, 0.580769578719691 AS "Proba_-1", -0.543401195081 AS "LogProba_-1", 0.4192304212803091 AS "Proba_1", -0.86933457876 AS "LogProba_1", -1 AS "Decision" FROM DUAL) "Values"), 
"DT_node_lookup_6" AS 
...
"DT_node_data_9" AS 
(SELECT "Values".node_id AS node_id, "Values".feature AS feature, "Values".threshold AS threshold, "Values".count AS count, "Values".depth AS depth, "Values"."Proba_-1" AS "Proba_-1", "Values"."LogProba_-1" AS "LogProba_-1", "Values"."Proba_1" AS "Proba_1", "Values"."LogProba_1" AS "LogProba_1", "Values"."Decision" AS "Decision" 
FROM (SELECT 0 AS node_id, 'Feature_0' AS feature, 2.2167487144470215 AS threshold, 100 AS count, 0 AS depth, 0.5 AS "Proba_-1", -0.69314718056 AS "LogProba_-1", 0.5 AS "Proba_1", -0.69314718056 AS "LogProba_1", -1 AS "Decision" FROM DUAL UNION ALL SELECT 1 AS node_id, CAST(NULL AS VARCHAR2(256 CHAR)) AS feature, CAST(NULL AS FLOAT) AS threshold, 99 AS count, 1 AS depth, 0.48392635367974157 AS "Proba_-1", -0.725822545662 AS "LogProba_-1", 0.5160736463202584 AS "Proba_1", -0.661505798258 AS "LogProba_1", 1 AS "Decision" FROM DUAL UNION ALL SELECT 2 AS node_id, CAST(NULL AS VARCHAR2(256 CHAR)) AS feature, CAST(NULL AS FLOAT) AS threshold, 1 AS count, 1 AS depth, 1.0 AS "Proba_-1", 0.0 AS "LogProba_-1", 0.0 AS "Proba_1", -BINARY_FLOAT_INFINITY AS "LogProba_1", -1 AS "Decision" FROM DUAL) "Values"), 
"DT_node_lookup_9" AS 
