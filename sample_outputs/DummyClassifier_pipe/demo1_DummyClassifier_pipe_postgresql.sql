...
(SELECT multinomial_cte."KEY" AS "KEY", 0.45 AS "Proba_-1", CASE WHEN (0.45 > 0.0) THEN ln(0.45) ELSE -1.79769313486231e+308 END AS "LogProba_-1", 0.55 AS "Proba_1", CASE WHEN (0.55 > 0.0) THEN ln(0.55) ELSE -1.79769313486231e+308 END AS "LogProba_1", multinomial_cte.multinomial_expr AS "Decision" 
FROM multinomial_cte)
 SELECT dummy_class_reg_cte."KEY" AS "KEY", CAST(NULL AS FLOAT(53)) AS "Score_-1", CAST(NULL AS FLOAT(53)) AS "Score_1", dummy_class_reg_cte."Proba_-1" AS "Proba_-1", dummy_class_reg_cte."Proba_1" AS "Proba_1", dummy_class_reg_cte."LogProba_-1" AS "LogProba_-1", dummy_class_reg_cte."LogProba_1" AS "LogProba_1", dummy_class_reg_cte."Decision" AS "Decision" 
