...
FROM (SELECT `ADS`.`KEY` AS `KEY`, -0.651313972406459 * `ADS`.`Feature_0` + 0.1252345575938374 * `ADS`.`Feature_1` + 0.4597437615703026 * `ADS`.`Feature_2` + -1.6939688055166868 * `ADS`.`Feature_3` + -0.4397901886776779 * `ADS`.`Feature_4` + -0.654723956578 AS linear_combination 
