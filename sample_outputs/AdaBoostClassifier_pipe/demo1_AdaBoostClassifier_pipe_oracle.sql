...
FROM "ADS_imp_1_OUT"), 
"DT_node_lookup" AS 
(SELECT "ADS_ano_2_OUT"."KEY" AS "KEY", CASE WHEN ("ADS_ano_2_OUT".anova_output_3 <= 1.0217169523239136) THEN 1 ELSE 2 END AS node_id 
FROM "ADS_ano_2_OUT"), 
"DT_Output" AS 
...
"DT_node_data_2" AS 
(SELECT "Values".node_id AS node_id, "Values".feature AS feature, "Values".threshold AS threshold, "Values".count AS count, "Values".depth AS depth, "Values"."Proba_-1" AS "Proba_-1", "Values"."LogProba_-1" AS "LogProba_-1", "Values"."Proba_1" AS "Proba_1", "Values"."LogProba_1" AS "LogProba_1", "Values"."Decision" AS "Decision" 
FROM (SELECT 0 AS node_id, 'anova_output_5' AS feature, 0.751193642616272 AS threshold, 100 AS count, 0 AS depth, 0.4999999999999999 AS "Proba_-1", -0.69314718056 AS "LogProba_-1", 0.5000000000000001 AS "Proba_1", -0.69314718056 AS "LogProba_1", 1 AS "Decision" FROM DUAL UNION ALL SELECT 1 AS node_id, CAST(NULL AS VARCHAR2(256 CHAR)) AS feature, CAST(NULL AS FLOAT) AS threshold, 79 AS count, 1 AS depth, 0.5511900395656418 AS "Proba_-1", -0.5956756299 AS "LogProba_-1", 0.44880996043435817 AS "Proba_1", -0.801155731539 AS "LogProba_1", -1 AS "Decision" FROM DUAL UNION ALL SELECT 2 AS node_id, CAST(NULL AS VARCHAR2(256 CHAR)) AS feature, CAST(NULL AS FLOAT) AS threshold, 21 AS count, 1 AS depth, 0.24568944919346494 AS "Proba_-1", -1.4036869422 AS "LogProba_-1", 0.754310550806535 AS "Proba_1", -0.281951124674 AS "LogProba_1", 1 AS "Decision" FROM DUAL) "Values"), 
"DT_node_lookup_2" AS 
(SELECT "ADS_ano_2_OUT"."KEY" AS "KEY", CASE WHEN ("ADS_ano_2_OUT".anova_output_5 <= 0.751193642616272) THEN 1 ELSE 2 END AS node_id 
FROM "ADS_ano_2_OUT"), 
"DT_Output_2" AS 
...
"DT_node_data_3" AS 
(SELECT "Values".node_id AS node_id, "Values".feature AS feature, "Values".threshold AS threshold, "Values".count AS count, "Values".depth AS depth, "Values"."Proba_-1" AS "Proba_-1", "Values"."LogProba_-1" AS "LogProba_-1", "Values"."Proba_1" AS "Proba_1", "Values"."LogProba_1" AS "LogProba_1", "Values"."Decision" AS "Decision" 
FROM (SELECT 0 AS node_id, 'anova_output_6' AS feature, -1.229390263557434 AS threshold, 100 AS count, 0 AS depth, 0.4999999999999999 AS "Proba_-1", -0.69314718056 AS "LogProba_-1", 0.5 AS "Proba_1", -0.69314718056 AS "LogProba_1", 1 AS "Decision" FROM DUAL UNION ALL SELECT 1 AS node_id, CAST(NULL AS VARCHAR2(256 CHAR)) AS feature, CAST(NULL AS FLOAT) AS threshold, 5 AS count, 1 AS depth, 0.0 AS "Proba_-1", -BINARY_FLOAT_INFINITY AS "LogProba_-1", 1.0 AS "Proba_1", 0.0 AS "LogProba_1", 1 AS "Decision" FROM DUAL UNION ALL SELECT 2 AS node_id, CAST(NULL AS VARCHAR2(256 CHAR)) AS feature, CAST(NULL AS FLOAT) AS threshold, 95 AS count, 1 AS depth, 0.5284623034003356 AS "Proba_-1", -0.637783803746 AS "LogProba_-1", 0.47153769659966444 AS "Proba_1", -0.751756229734 AS "LogProba_1", -1 AS "Decision" FROM DUAL) "Values"), 
"DT_node_lookup_3" AS 
(SELECT "ADS_ano_2_OUT"."KEY" AS "KEY", CASE WHEN ("ADS_ano_2_OUT".anova_output_6 <= -1.229390263557434) THEN 1 ELSE 2 END AS node_id 
FROM "ADS_ano_2_OUT"), 
"DT_Output_3" AS 
...
"DT_node_data_5" AS 
(SELECT "Values".node_id AS node_id, "Values".feature AS feature, "Values".threshold AS threshold, "Values".count AS count, "Values".depth AS depth, "Values"."Proba_-1" AS "Proba_-1", "Values"."LogProba_-1" AS "LogProba_-1", "Values"."Proba_1" AS "Proba_1", "Values"."LogProba_1" AS "LogProba_1", "Values"."Decision" AS "Decision" 
FROM (SELECT 0 AS node_id, 'anova_output_2' AS feature, 0.030657175928354263 AS threshold, 100 AS count, 0 AS depth, 0.4999999999999999 AS "Proba_-1", -0.69314718056 AS "LogProba_-1", 0.5000000000000001 AS "Proba_1", -0.69314718056 AS "LogProba_1", 1 AS "Decision" FROM DUAL UNION ALL SELECT 1 AS node_id, CAST(NULL AS VARCHAR2(256 CHAR)) AS feature, CAST(NULL AS FLOAT) AS threshold, 50 AS count, 1 AS depth, 0.3704782461883407 AS "Proba_-1", -0.992960550711 AS "LogProba_-1", 0.6295217538116594 AS "Proba_1", -0.462794868809 AS "LogProba_1", 1 AS "Decision" FROM DUAL UNION ALL SELECT 2 AS node_id, CAST(NULL AS VARCHAR2(256 CHAR)) AS feature, CAST(NULL AS FLOAT) AS threshold, 50 AS count, 1 AS depth, 0.6341243199093464 AS "Proba_-1", -0.455510255583 AS "LogProba_-1", 0.3658756800906537 AS "Proba_1", -1.00546167517 AS "LogProba_1", -1 AS "Decision" FROM DUAL) "Values"), 
"DT_node_lookup_5" AS 
(SELECT "ADS_ano_2_OUT"."KEY" AS "KEY", CASE WHEN ("ADS_ano_2_OUT".anova_output_2 <= 0.030657175928354263) THEN 1 ELSE 2 END AS node_id 
FROM "ADS_ano_2_OUT"), 
"DT_Output_5" AS 
...
"DT_node_data_7" AS 
(SELECT "Values".node_id AS node_id, "Values".feature AS feature, "Values".threshold AS threshold, "Values".count AS count, "Values".depth AS depth, "Values"."Proba_-1" AS "Proba_-1", "Values"."LogProba_-1" AS "LogProba_-1", "Values"."Proba_1" AS "Proba_1", "Values"."LogProba_1" AS "LogProba_1", "Values"."Decision" AS "Decision" 
FROM (SELECT 0 AS node_id, 'anova_output_3' AS feature, 1.9003496170043945 AS threshold, 100 AS count, 0 AS depth, 0.49999999999999994 AS "Proba_-1", -0.69314718056 AS "LogProba_-1", 0.5 AS "Proba_1", -0.69314718056 AS "LogProba_1", 1 AS "Decision" FROM DUAL UNION ALL SELECT 1 AS node_id, CAST(NULL AS VARCHAR2(256 CHAR)) AS feature, CAST(NULL AS FLOAT) AS threshold, 95 AS count, 1 AS depth, 0.47309374271452004 AS "Proba_-1", -0.74846172257 AS "LogProba_-1", 0.52690625728548 AS "Proba_1", -0.640732626177 AS "LogProba_1", 1 AS "Decision" FROM DUAL UNION ALL SELECT 2 AS node_id, CAST(NULL AS VARCHAR2(256 CHAR)) AS feature, CAST(NULL AS FLOAT) AS threshold, 5 AS count, 1 AS depth, 1.0 AS "Proba_-1", 0.0 AS "LogProba_-1", 0.0 AS "Proba_1", -BINARY_FLOAT_INFINITY AS "LogProba_1", -1 AS "Decision" FROM DUAL) "Values"), 
"DT_node_lookup_7" AS 
(SELECT "ADS_ano_2_OUT"."KEY" AS "KEY", CASE WHEN ("ADS_ano_2_OUT".anova_output_3 <= 1.9003496170043945) THEN 1 ELSE 2 END AS node_id 
FROM "ADS_ano_2_OUT"), 
"DT_Output_7" AS 
...
"DT_node_data_8" AS 
(SELECT "Values".node_id AS node_id, "Values".feature AS feature, "Values".threshold AS threshold, "Values".count AS count, "Values".depth AS depth, "Values"."Proba_-1" AS "Proba_-1", "Values"."LogProba_-1" AS "LogProba_-1", "Values"."Proba_1" AS "Proba_1", "Values"."LogProba_1" AS "LogProba_1", "Values"."Decision" AS "Decision" 
FROM (SELECT 0 AS node_id, 'anova_output_4' AS feature, -1.3217706680297852 AS threshold, 100 AS count, 0 AS depth, 0.5000000004015162 AS "Proba_-1", -0.693147179757 AS "LogProba_-1", 0.49999999959848385 AS "Proba_1", -0.693147181363 AS "LogProba_1", -1 AS "Decision" FROM DUAL UNION ALL SELECT 1 AS node_id, CAST(NULL AS VARCHAR2(256 CHAR)) AS feature, CAST(NULL AS FLOAT) AS threshold, 10 AS count, 1 AS depth, 0.11843718027728807 AS "Proba_-1", -2.13337258321 AS "LogProba_-1", 0.8815628197227119 AS "Proba_1", -0.126059015109 AS "LogProba_1", 1 AS "Decision" FROM DUAL UNION ALL SELECT 2 AS node_id, CAST(NULL AS VARCHAR2(256 CHAR)) AS feature, CAST(NULL AS FLOAT) AS threshold, 90 AS count, 1 AS depth, 0.5329004896769016 AS "Proba_-1", -0.629420570789 AS "LogProba_-1", 0.4670995103230983 AS "Proba_1", -0.761212959809 AS "LogProba_1", -1 AS "Decision" FROM DUAL) "Values"), 
"DT_node_lookup_8" AS 
(SELECT "ADS_ano_2_OUT"."KEY" AS "KEY", CASE WHEN ("ADS_ano_2_OUT".anova_output_4 <= -1.3217706680297852) THEN 1 ELSE 2 END AS node_id 
FROM "ADS_ano_2_OUT"), 
"DT_Output_8" AS 
...
"DT_node_data_10" AS 
(SELECT "Values".node_id AS node_id, "Values".feature AS feature, "Values".threshold AS threshold, "Values".count AS count, "Values".depth AS depth, "Values"."Proba_-1" AS "Proba_-1", "Values"."LogProba_-1" AS "LogProba_-1", "Values"."Proba_1" AS "Proba_1", "Values"."LogProba_1" AS "LogProba_1", "Values"."Decision" AS "Decision" 
FROM (SELECT 0 AS node_id, 'anova_output_5' AS feature, -1.630774974822998 AS threshold, 100 AS count, 0 AS depth, 0.4999999999999999 AS "Proba_-1", -0.69314718056 AS "LogProba_-1", 0.5000000000000002 AS "Proba_1", -0.69314718056 AS "LogProba_1", 1 AS "Decision" FROM DUAL UNION ALL SELECT 1 AS node_id, CAST(NULL AS VARCHAR2(256 CHAR)) AS feature, CAST(NULL AS FLOAT) AS threshold, 3 AS count, 1 AS depth, 0.0 AS "Proba_-1", -BINARY_FLOAT_INFINITY AS "LogProba_-1", 1.0 AS "Proba_1", 0.0 AS "LogProba_1", 1 AS "Decision" FROM DUAL UNION ALL SELECT 2 AS node_id, CAST(NULL AS VARCHAR2(256 CHAR)) AS feature, CAST(NULL AS FLOAT) AS threshold, 97 AS count, 1 AS depth, 0.524047482390885 AS "Proba_-1", -0.646172983517 AS "LogProba_-1", 0.47595251760911494 AS "Proba_1", -0.742437182648 AS "LogProba_1", -1 AS "Decision" FROM DUAL) "Values"), 
"DT_node_lookup_10" AS 
(SELECT "ADS_ano_2_OUT"."KEY" AS "KEY", CASE WHEN ("ADS_ano_2_OUT".anova_output_5 <= -1.630774974822998) THEN 1 ELSE 2 END AS node_id 
FROM "ADS_ano_2_OUT"), 
"DT_Output_10" AS 
