...
FROM (SELECT `ADS`.`KEY` AS `KEY`, -0.03727948620987273 * `ADS`.`Feature_0` + -0.1189826699975303 * `ADS`.`Feature_1` + -0.6837430547186152 * `ADS`.`Feature_2` + -0.2627023969136878 * `ADS`.`Feature_3` + -0.12210325995481029 * `ADS`.`Feature_4` + 0.0933862940082 AS linear_combination 
