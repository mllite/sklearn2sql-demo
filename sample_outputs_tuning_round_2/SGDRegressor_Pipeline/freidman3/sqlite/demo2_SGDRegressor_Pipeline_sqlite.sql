...
FROM "ADS_imp_1_OUT"), 
linear_model_cte AS 
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", -0.05650113408120648 * "ADS_sca_2_OUT".scaler_output_2 + 0.0552564964561722 * "ADS_sca_2_OUT".scaler_output_3 + 0.108477543222794 * "ADS_sca_2_OUT".scaler_output_4 + 0.01847829922800209 * "ADS_sca_2_OUT".scaler_output_5 + 0.949419223663 AS "Estimator" 
FROM "ADS_sca_2_OUT")
