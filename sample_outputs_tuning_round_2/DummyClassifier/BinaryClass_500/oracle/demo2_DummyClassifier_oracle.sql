...
(SELECT multinomial_cte."KEY" AS "KEY", 0.4875 AS "Proba_0", CASE WHEN (0.4875 IS NULL OR 0.4875 > 0.0) THEN ln(0.4875) ELSE -BINARY_FLOAT_INFINITY END AS "LogProba_0", 0.5125 AS "Proba_1", CASE WHEN (0.5125 IS NULL OR 0.5125 > 0.0) THEN ln(0.5125) ELSE -BINARY_FLOAT_INFINITY END AS "LogProba_1", multinomial_cte.multinomial_expr AS "Decision" 
