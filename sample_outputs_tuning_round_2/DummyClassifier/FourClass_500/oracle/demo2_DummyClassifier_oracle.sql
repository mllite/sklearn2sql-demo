...
(SELECT multinomial_cte."KEY" AS "KEY", 0.23875 AS "Proba_0", CASE WHEN (0.23875 IS NULL OR 0.23875 > 0.0) THEN ln(0.23875) ELSE -BINARY_FLOAT_INFINITY END AS "LogProba_0", 0.25125 AS "Proba_1", CASE WHEN (0.25125 IS NULL OR 0.25125 > 0.0) THEN ln(0.25125) ELSE -BINARY_FLOAT_INFINITY END AS "LogProba_1", 0.2525 AS "Proba_2", CASE WHEN (0.2525 IS NULL OR 0.2525 > 0.0) THEN ln(0.2525) ELSE -BINARY_FLOAT_INFINITY END AS "LogProba_2", 0.2575 AS "Proba_3", CASE WHEN (0.2575 IS NULL OR 0.2575 > 0.0) THEN ln(0.2575) ELSE -BINARY_FLOAT_INFINITY END AS "LogProba_3", multinomial_cte.multinomial_expr AS "Decision" 
