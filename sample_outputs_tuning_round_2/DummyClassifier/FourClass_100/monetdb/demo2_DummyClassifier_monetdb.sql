...
(SELECT multinomial_cte."KEY" AS "KEY", 0.245 AS "Proba_0", CASE WHEN (0.245 IS NULL) THEN 0.245 ELSE CASE WHEN (0.245 > 0.0) THEN log(0.245) ELSE -1.79769313486231e+308 END END AS "LogProba_0", 0.24875 AS "Proba_1", CASE WHEN (0.24875 IS NULL) THEN 0.24875 ELSE CASE WHEN (0.24875 > 0.0) THEN log(0.24875) ELSE -1.79769313486231e+308 END END AS "LogProba_1", 0.2525 AS "Proba_2", CASE WHEN (0.2525 IS NULL) THEN 0.2525 ELSE CASE WHEN (0.2525 > 0.0) THEN log(0.2525) ELSE -1.79769313486231e+308 END END AS "LogProba_2", 0.25375 AS "Proba_3", CASE WHEN (0.25375 IS NULL) THEN 0.25375 ELSE CASE WHEN (0.25375 > 0.0) THEN log(0.25375) ELSE -1.79769313486231e+308 END END AS "LogProba_3", multinomial_cte.multinomial_expr AS "Decision" 
