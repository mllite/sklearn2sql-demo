...
(SELECT multinomial_cte."KEY" AS "KEY", 0.245 AS "Proba_0", CASE WHEN (0.245 IS NULL OR 0.245 > 0.0) THEN ln(0.245) ELSE -BINARY_FLOAT_INFINITY END AS "LogProba_0", 0.24875 AS "Proba_1", CASE WHEN (0.24875 IS NULL OR 0.24875 > 0.0) THEN ln(0.24875) ELSE -BINARY_FLOAT_INFINITY END AS "LogProba_1", 0.2525 AS "Proba_2", CASE WHEN (0.2525 IS NULL OR 0.2525 > 0.0) THEN ln(0.2525) ELSE -BINARY_FLOAT_INFINITY END AS "LogProba_2", 0.25375 AS "Proba_3", CASE WHEN (0.25375 IS NULL OR 0.25375 > 0.0) THEN ln(0.25375) ELSE -BINARY_FLOAT_INFINITY END AS "LogProba_3", multinomial_cte.multinomial_expr AS "Decision" 
