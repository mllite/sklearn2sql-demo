...
(SELECT multinomial_cte."KEY" AS "KEY", 0.351648351648 AS "Proba_0", CASE WHEN (0.351648351648 IS NULL OR 0.351648351648 > 0.0) THEN ln(0.351648351648) ELSE -BINARY_FLOAT_INFINITY END AS "LogProba_0", 0.648351648352 AS "Proba_1", CASE WHEN (0.648351648352 IS NULL OR 0.648351648352 > 0.0) THEN ln(0.648351648352) ELSE -BINARY_FLOAT_INFINITY END AS "LogProba_1", multinomial_cte.multinomial_expr AS "Decision" 
