...
(SELECT multinomial_cte."KEY" AS "KEY", 0.5 AS "Proba_0", CASE WHEN (0.5 IS NULL) THEN 0.5 ELSE CASE WHEN (0.5 > 0.0) THEN log(0.5) ELSE -1.79769313486231e+308 END END AS "LogProba_0", 0.5 AS "Proba_1", CASE WHEN (0.5 IS NULL) THEN 0.5 ELSE CASE WHEN (0.5 > 0.0) THEN log(0.5) ELSE -1.79769313486231e+308 END END AS "LogProba_1", multinomial_cte.multinomial_expr AS "Decision" 
