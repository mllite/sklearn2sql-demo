...
orig_cte AS 
(SELECT "XGB_Sum_Scores"."KEY" AS "KEY", "XGB_Sum_Scores"."Score_0" AS "Score_0", CAST(NULL AS FLOAT) AS "Score_1", 1.0 - 1.0 / (1.0 + exp(CASE WHEN (CASE WHEN (CASE WHEN (-"XGB_Sum_Scores"."Score_0" <= -100.0) THEN -100.0 ELSE -"XGB_Sum_Scores"."Score_0" END >= 100.0) THEN 100.0 ELSE CASE WHEN (-"XGB_Sum_Scores"."Score_0" <= -100.0) THEN -100.0 ELSE -"XGB_Sum_Scores"."Score_0" END END >= -709.782712893) THEN CASE WHEN (CASE WHEN (-"XGB_Sum_Scores"."Score_0" <= -100.0) THEN -100.0 ELSE -"XGB_Sum_Scores"."Score_0" END >= 100.0) THEN 100.0 ELSE CASE WHEN (-"XGB_Sum_Scores"."Score_0" <= -100.0) THEN -100.0 ELSE -"XGB_Sum_Scores"."Score_0" END END ELSE -709.782712893 END)) AS "Proba_0", 1.0 / (1.0 + exp(CASE WHEN (CASE WHEN (CASE WHEN (-"XGB_Sum_Scores"."Score_0" <= -100.0) THEN -100.0 ELSE -"XGB_Sum_Scores"."Score_0" END >= 100.0) THEN 100.0 ELSE CASE WHEN (-"XGB_Sum_Scores"."Score_0" <= -100.0) THEN -100.0 ELSE -"XGB_Sum_Scores"."Score_0" END END >= -709.782712893) THEN CASE WHEN (CASE WHEN (-"XGB_Sum_Scores"."Score_0" <= -100.0) THEN -100.0 ELSE -"XGB_Sum_Scores"."Score_0" END >= 100.0) THEN 100.0 ELSE CASE WHEN (-"XGB_Sum_Scores"."Score_0" <= -100.0) THEN -100.0 ELSE -"XGB_Sum_Scores"."Score_0" END END ELSE -709.782712893 END)) AS "Proba_1", CAST(NULL AS FLOAT) AS "LogProba_0", CAST(NULL AS FLOAT) AS "LogProba_1", CAST(NULL AS INTEGER) AS "Decision", CAST(NULL AS FLOAT) AS "DecisionProba" 
FROM "XGB_Sum_Scores"), 
