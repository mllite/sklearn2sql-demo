...
FROM "ADS_imp_1_OUT"), 
linear_model_cte AS 
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", 0.04902526586186135 * "ADS_sca_2_OUT".scaler_output_2 + 0.23258226657287756 * "ADS_sca_2_OUT".scaler_output_3 + -0.6617920365460979 * "ADS_sca_2_OUT".scaler_output_4 + -0.13957440677755487 * "ADS_sca_2_OUT".scaler_output_5 + -0.383333333333 AS "Score_0", 0.0886306707385939 * "ADS_sca_2_OUT".scaler_output_2 + -0.4115503870698435 * "ADS_sca_2_OUT".scaler_output_3 + 0.4660812728575237 * "ADS_sca_2_OUT".scaler_output_4 + -0.5763815228752289 * "ADS_sca_2_OUT".scaler_output_5 + -0.333333333333 AS "Score_1", -0.13765593660045333 * "ADS_sca_2_OUT".scaler_output_2 + 0.17896812049696517 * "ADS_sca_2_OUT".scaler_output_3 + 0.19571076368857368 * "ADS_sca_2_OUT".scaler_output_4 + 0.7159559296527818 * "ADS_sca_2_OUT".scaler_output_5 + -0.283333333333 AS "Score_2" 
FROM "ADS_sca_2_OUT"), 
orig_cte AS 
