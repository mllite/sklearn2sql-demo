...
(SELECT "ADS"."KEY" AS "KEY", 13.758599124452747 * "ADS"."Feature_0" + 46.27892432770464 * "ADS"."Feature_1" + -63.164477798623885 * "ADS"."Feature_2" + -26.26641651031884 * "ADS"."Feature_3" + 9.77178478553 AS "Score_0", 23.764853033145435 * "ADS"."Feature_0" + -135.08442776735436 * "ADS"."Feature_1" + -8.130081300813004 * "ADS"."Feature_2" + -71.91994996873042 * "ADS"."Feature_3" + 39.2530066977 AS "Score_1", -117.57348342714158 * "ADS"."Feature_0" + -99.43714821763571 * "ADS"."Feature_1" + 176.36022514071246 * "ADS"."Feature_2" + 135.08442776735419 * "ADS"."Feature_3" + -75.9759786454 AS "Score_2" 
FROM iris AS "ADS"), 
orig_cte AS 
