...
-- Code For temporary table TMP_20180508175656_CODEGEN_Y63XTO_ADS_imp_1_OUT part 1. Create 


CREATE TEMPORARY TABLE "TMP_20180508175656_CODEGEN_Y63XTO_ADS_imp_1_OUT" (
	"KEY" BIGINT NOT NULL, 
	impter_2 FLOAT, 
	impter_3 FLOAT, 
	impter_4 FLOAT, 
...
-- Code For temporary table TMP_20180508175656_CODEGEN_Y63XTO_ADS_imp_1_OUT part 3. Create Index 

CREATE INDEX "ix_TMP_20180508175656_CODEGEN_Y63XTO_ADS_imp_1_OUT_KEY" ON "TMP_20180508175656_CODEGEN_Y63XTO_ADS_imp_1_OUT" ("KEY")

-- Code For temporary table TMP_20180508175656_CODEGEN_0IBJ11_ADS_sca_2_OUT part 1. Create 


CREATE TEMPORARY TABLE "TMP_20180508175656_CODEGEN_0IBJ11_ADS_sca_2_OUT" (
	"KEY" BIGINT NOT NULL, 
	scaler_2 FLOAT, 
	scaler_3 FLOAT, 
	scaler_4 FLOAT, 
...
-- Code For temporary table TMP_20180508175656_CODEGEN_0IBJ11_ADS_sca_2_OUT part 2. Populate

INSERT INTO "TMP_20180508175656_CODEGEN_0IBJ11_ADS_sca_2_OUT" ("KEY", scaler_2, scaler_3, scaler_4, scaler_5, scaler_6, scaler_7, scaler_8, scaler_9, scaler_10, scaler_11) SELECT "ADS_sca_2_OUT"."KEY", "ADS_sca_2_OUT".scaler_2, "ADS_sca_2_OUT".scaler_3, "ADS_sca_2_OUT".scaler_4, "ADS_sca_2_OUT".scaler_5, "ADS_sca_2_OUT".scaler_6, "ADS_sca_2_OUT".scaler_7, "ADS_sca_2_OUT".scaler_8, "ADS_sca_2_OUT".scaler_9, "ADS_sca_2_OUT".scaler_10, "ADS_sca_2_OUT".scaler_11 
...
FROM "TMP_20180508175656_CODEGEN_Y63XTO_ADS_imp_1_OUT" AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT"

-- Code For temporary table TMP_20180508175656_CODEGEN_0IBJ11_ADS_sca_2_OUT part 3. Create Index 

CREATE INDEX "ix_TMP_20180508175656_CODEGEN_0IBJ11_ADS_sca_2_OUT_KEY" ON "TMP_20180508175656_CODEGEN_0IBJ11_ADS_sca_2_OUT" ("KEY")

-- Code For temporary table TMP_20180508175657_CODEGEN_L2F2FS_BAG_B0 part 1. Create 


CREATE TEMPORARY TABLE "TMP_20180508175657_CODEGEN_L2F2FS_BAG_B0" (
	"KEY" BIGINT, 
	"Score_0" FLOAT, 
	"Proba_0" FLOAT, 
	"LogProba_0" FLOAT, 
...
-- Code For temporary table TMP_20180508175657_CODEGEN_L2F2FS_BAG_B0 part 2. Populate
...
FROM "TMP_20180508175656_CODEGEN_0IBJ11_ADS_sca_2_OUT" AS "ADS_sca_2_OUT"), 
"DT_node_data" AS 
...
FROM "DT_Output_9")
 INSERT INTO "TMP_20180508175657_CODEGEN_L2F2FS_BAG_B0" ("KEY", "Score_0", "Proba_0", "LogProba_0", "Score_1", "Proba_1", "LogProba_1") SELECT "BAG_B0"."KEY", "BAG_B0"."Score_0", "BAG_B0"."Proba_0", "BAG_B0"."LogProba_0", "BAG_B0"."Score_1", "BAG_B0"."Proba_1", "BAG_B0"."LogProba_1" 
...
-- Code For temporary table TMP_20180508175657_CODEGEN_CRLFC8_BAG_B1 part 1. Create 


CREATE TEMPORARY TABLE "TMP_20180508175657_CODEGEN_CRLFC8_BAG_B1" (
	"KEY" BIGINT, 
	"Score_0" FLOAT, 
	"Proba_0" FLOAT, 
	"LogProba_0" FLOAT, 
...
-- Code For temporary table TMP_20180508175657_CODEGEN_CRLFC8_BAG_B1 part 2. Populate
...
FROM "DT_Output_15")
 INSERT INTO "TMP_20180508175657_CODEGEN_CRLFC8_BAG_B1" ("KEY", "Score_0", "Proba_0", "LogProba_0", "Score_1", "Proba_1", "LogProba_1") SELECT "BAG_B1"."KEY", "BAG_B1"."Score_0", "BAG_B1"."Proba_0", "BAG_B1"."LogProba_0", "BAG_B1"."Score_1", "BAG_B1"."Proba_1", "BAG_B1"."LogProba_1" 
...
-- Code For temporary table TMP_20180508175657_CODEGEN_OCYBI9_BAG_Union part 1. Create 


CREATE TEMPORARY TABLE "TMP_20180508175657_CODEGEN_OCYBI9_BAG_Union" (
	"KEY" BIGINT, 
	"Score_0" FLOAT, 
	"Proba_0" FLOAT, 
	"LogProba_0" FLOAT, 
...
-- Code For temporary table TMP_20180508175657_CODEGEN_OCYBI9_BAG_Union part 2. Populate

INSERT INTO "TMP_20180508175657_CODEGEN_OCYBI9_BAG_Union" ("KEY", "Score_0", "Proba_0", "LogProba_0", "Score_1", "Proba_1", "LogProba_1") SELECT "BAG_Union"."KEY", "BAG_Union"."Score_0", "BAG_Union"."Proba_0", "BAG_Union"."LogProba_0", "BAG_Union"."Score_1", "BAG_Union"."Proba_1", "BAG_Union"."LogProba_1" 
...
FROM "TMP_20180508175657_CODEGEN_L2F2FS_BAG_B0" AS "BAG_B0" UNION ALL SELECT "BAG_B1"."KEY" AS "KEY", "BAG_B1"."Score_0" AS "Score_0", "BAG_B1"."Proba_0" AS "Proba_0", "BAG_B1"."LogProba_0" AS "LogProba_0", "BAG_B1"."Score_1" AS "Score_1", "BAG_B1"."Proba_1" AS "Proba_1", "BAG_B1"."LogProba_1" AS "LogProba_1" 
FROM "TMP_20180508175657_CODEGEN_CRLFC8_BAG_B1" AS "BAG_B1") AS "BAG_EnsembleUnion") AS "BAG_Union"

-- Code For temporary table TMP_20180508175657_CODEGEN_X28G6J_BAG_avg part 1. Create 


CREATE TEMPORARY TABLE "TMP_20180508175657_CODEGEN_X28G6J_BAG_avg" (
	"KEY" BIGINT NOT NULL, 
	"Score_0" FLOAT, 
	"Proba_0" FLOAT, 
	"LogProba_0" FLOAT, 
...
-- Code For temporary table TMP_20180508175657_CODEGEN_X28G6J_BAG_avg part 2. Populate

INSERT INTO "TMP_20180508175657_CODEGEN_X28G6J_BAG_avg" ("KEY", "Score_0", "Proba_0", "LogProba_0", "Score_1", "Proba_1", "LogProba_1") SELECT "BAG_avg"."KEY", "BAG_avg"."Score_0", "BAG_avg"."Proba_0", "BAG_avg"."LogProba_0", "BAG_avg"."Score_1", "BAG_avg"."Proba_1", "BAG_avg"."LogProba_1" 
...
FROM "TMP_20180508175657_CODEGEN_OCYBI9_BAG_Union" AS "BAG_Union" GROUP BY "BAG_Union"."KEY") AS "T") AS "BAG_avg"

-- Code For temporary table TMP_20180508175657_CODEGEN_X28G6J_BAG_avg part 3. Create Index 

CREATE INDEX "ix_TMP_20180508175657_CODEGEN_X28G6J_BAG_avg_KEY" ON "TMP_20180508175657_CODEGEN_X28G6J_BAG_avg" ("KEY")
...
FROM "TMP_20180508175657_CODEGEN_X28G6J_BAG_avg" AS "BAG_avg"), 
