...
-- Code For temporary table TMP_20180602141054_493_ADS_imp_1_OUT part 1. Create 


CREATE TEMPORARY TABLE `TMP_20180602141054_493_ADS_imp_1_OUT` (
	`KEY` BIGINT NOT NULL, 
	impter_2 DOUBLE, 
	impter_3 DOUBLE, 
	impter_4 DOUBLE, 
...
-- Code For temporary table TMP_20180602141054_493_ADS_imp_1_OUT part 2. Populate

INSERT INTO `TMP_20180602141054_493_ADS_imp_1_OUT` (`KEY`, impter_2, impter_3, impter_4, impter_5, impter_6, impter_7, impter_8, impter_9, impter_10, impter_11) SELECT `U`.`KEY`, `U`.impter_2, `U`.impter_3, `U`.impter_4, `U`.impter_5, `U`.impter_6, `U`.impter_7, `U`.impter_8, `U`.impter_9, `U`.impter_10, `U`.impter_11 
...
-- Code For temporary table TMP_20180602141054_493_ADS_imp_1_OUT part 3. Create Index 

CREATE INDEX `ix_TMP_20180602141054_493_ADS_imp_1_OUT_KEY` ON `TMP_20180602141054_493_ADS_imp_1_OUT` (`KEY`)

-- Code For temporary table TMP_20180602141054_65Q_ADS_sca_2_OUT part 1. Create 


CREATE TEMPORARY TABLE `TMP_20180602141054_65Q_ADS_sca_2_OUT` (
	`KEY` BIGINT NOT NULL, 
	scaler_2 DOUBLE, 
	scaler_3 DOUBLE, 
	scaler_4 DOUBLE, 
...
-- Code For temporary table TMP_20180602141054_65Q_ADS_sca_2_OUT part 2. Populate

INSERT INTO `TMP_20180602141054_65Q_ADS_sca_2_OUT` (`KEY`, scaler_2, scaler_3, scaler_4, scaler_5, scaler_6, scaler_7, scaler_8, scaler_9, scaler_10, scaler_11) SELECT `U`.`KEY`, `U`.scaler_2, `U`.scaler_3, `U`.scaler_4, `U`.scaler_5, `U`.scaler_6, `U`.scaler_7, `U`.scaler_8, `U`.scaler_9, `U`.scaler_10, `U`.scaler_11 
...
FROM `TMP_20180602141054_493_ADS_imp_1_OUT` AS `ADS_imp_1_OUT`) AS `ADS_sca_2_OUT`) AS `U`

-- Code For temporary table TMP_20180602141054_65Q_ADS_sca_2_OUT part 3. Create Index 

CREATE INDEX `ix_TMP_20180602141054_65Q_ADS_sca_2_OUT_KEY` ON `TMP_20180602141054_65Q_ADS_sca_2_OUT` (`KEY`)

-- Code For temporary table TMP_20180602141055_WPQ_BAG_B0 part 1. Create 


CREATE TEMPORARY TABLE `TMP_20180602141055_WPQ_BAG_B0` (
	`KEY` BIGINT, 
	`Score_0` DOUBLE, 
	`Proba_0` DOUBLE, 
	`LogProba_0` DOUBLE, 
...
-- Code For temporary table TMP_20180602141055_WPQ_BAG_B0 part 2. Populate

INSERT INTO `TMP_20180602141055_WPQ_BAG_B0` (`KEY`, `Score_0`, `Proba_0`, `LogProba_0`, `Score_1`, `Proba_1`, `LogProba_1`) SELECT `U`.`KEY`, `U`.`Score_0`, `U`.`Proba_0`, `U`.`LogProba_0`, `U`.`Score_1`, `U`.`Proba_1`, `U`.`LogProba_1` 
...
FROM `TMP_20180602141054_65Q_ADS_sca_2_OUT` AS `ADS_sca_2_OUT`), 
`DT_node_data` AS 
...
-- Code For temporary table TMP_20180602141055_RCU_BAG_B1 part 1. Create 


CREATE TEMPORARY TABLE `TMP_20180602141055_RCU_BAG_B1` (
	`KEY` BIGINT, 
	`Score_0` DOUBLE, 
	`Proba_0` DOUBLE, 
	`LogProba_0` DOUBLE, 
...
-- Code For temporary table TMP_20180602141055_RCU_BAG_B1 part 2. Populate

INSERT INTO `TMP_20180602141055_RCU_BAG_B1` (`KEY`, `Score_0`, `Proba_0`, `LogProba_0`, `Score_1`, `Proba_1`, `LogProba_1`) SELECT `U`.`KEY`, `U`.`Score_0`, `U`.`Proba_0`, `U`.`LogProba_0`, `U`.`Score_1`, `U`.`Proba_1`, `U`.`LogProba_1` 
...
-- Code For temporary table TMP_20180602141055_T60_BAG_avg part 1. Create 


CREATE TEMPORARY TABLE `TMP_20180602141055_T60_BAG_avg` (
	`KEY` BIGINT NOT NULL, 
	`Score_0` DOUBLE, 
	`Proba_0` DOUBLE, 
	`LogProba_0` DOUBLE, 
...
-- Code For temporary table TMP_20180602141055_T60_BAG_avg part 2. Populate

INSERT INTO `TMP_20180602141055_T60_BAG_avg` (`KEY`, `Score_0`, `Proba_0`, `LogProba_0`, `Score_1`, `Proba_1`, `LogProba_1`) SELECT `U`.`KEY`, `U`.`Score_0`, `U`.`Proba_0`, `U`.`LogProba_0`, `U`.`Score_1`, `U`.`Proba_1`, `U`.`LogProba_1` 
...
FROM `TMP_20180602141055_WPQ_BAG_B0` AS `BAG_B0` UNION ALL SELECT `BAG_B1`.`KEY` AS `KEY`, `BAG_B1`.`Score_0` AS `Score_0`, `BAG_B1`.`Proba_0` AS `Proba_0`, `BAG_B1`.`LogProba_0` AS `LogProba_0`, `BAG_B1`.`Score_1` AS `Score_1`, `BAG_B1`.`Proba_1` AS `Proba_1`, `BAG_B1`.`LogProba_1` AS `LogProba_1` 
FROM `TMP_20180602141055_RCU_BAG_B1` AS `BAG_B1`) AS `BAG_EnsembleUnion`)
...
-- Code For temporary table TMP_20180602141055_T60_BAG_avg part 3. Create Index 

CREATE INDEX `ix_TMP_20180602141055_T60_BAG_avg_KEY` ON `TMP_20180602141055_T60_BAG_avg` (`KEY`)
...
FROM `TMP_20180602141055_T60_BAG_avg` AS `BAG_avg`), 
