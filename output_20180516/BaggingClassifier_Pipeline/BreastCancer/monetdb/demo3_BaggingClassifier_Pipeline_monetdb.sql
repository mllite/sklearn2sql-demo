...
-- Code For temporary table tmp_20180516111438_codegen_5dlm26_ads_imp_1_out part 1. Create 


CREATE TEMPORARY TABLE tmp_20180516111438_codegen_5dlm26_ads_imp_1_out (
	"KEY" BIGINT, 
	impter_2 DOUBLE, 
	impter_3 DOUBLE, 
	impter_4 DOUBLE, 
...
-- Code For temporary table tmp_20180516111438_codegen_5dlm26_ads_imp_1_out part 2. Populate

INSERT INTO tmp_20180516111438_codegen_5dlm26_ads_imp_1_out ("KEY", impter_2, impter_3, impter_4, impter_5, impter_6, impter_7, impter_8, impter_9, impter_10, impter_11, impter_12, impter_13, impter_14, impter_15, impter_16, impter_17, impter_18, impter_19, impter_20, impter_21, impter_22, impter_23, impter_24, impter_25, impter_26, impter_27, impter_28, impter_29, impter_30, impter_31) SELECT "U"."KEY", "U".impter_2, "U".impter_3, "U".impter_4, "U".impter_5, "U".impter_6, "U".impter_7, "U".impter_8, "U".impter_9, "U".impter_10, "U".impter_11, "U".impter_12, "U".impter_13, "U".impter_14, "U".impter_15, "U".impter_16, "U".impter_17, "U".impter_18, "U".impter_19, "U".impter_20, "U".impter_21, "U".impter_22, "U".impter_23, "U".impter_24, "U".impter_25, "U".impter_26, "U".impter_27, "U".impter_28, "U".impter_29, "U".impter_30, "U".impter_31 
...
-- Code For temporary table tmp_20180516111438_codegen_o5lqxg_ads_sca_2_out part 1. Create 


CREATE TEMPORARY TABLE tmp_20180516111438_codegen_o5lqxg_ads_sca_2_out (
	"KEY" BIGINT, 
	scaler_2 DOUBLE, 
	scaler_3 DOUBLE, 
	scaler_4 DOUBLE, 
...
FROM tmp_20180516111438_codegen_5dlm26_ads_imp_1_out AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT") AS "U"

-- Code For temporary table tmp_20180516111439_codegen_s0kp67_bag_b0 part 1. Create 


CREATE TEMPORARY TABLE tmp_20180516111439_codegen_s0kp67_bag_b0 (
	"KEY" BIGINT, 
	"Score_0" DOUBLE, 
	"Proba_0" DOUBLE, 
	"LogProba_0" DOUBLE, 
...
-- Code For temporary table tmp_20180516111439_codegen_s0kp67_bag_b0 part 2. Populate

INSERT INTO tmp_20180516111439_codegen_s0kp67_bag_b0 ("KEY", "Score_0", "Proba_0", "LogProba_0", "Score_1", "Proba_1", "LogProba_1") SELECT "U"."KEY", "U"."Score_0", "U"."Proba_0", "U"."LogProba_0", "U"."Score_1", "U"."Proba_1", "U"."LogProba_1" 
...
FROM tmp_20180516111438_codegen_o5lqxg_ads_sca_2_out AS "ADS_sca_2_OUT"), 
"DT_node_data" AS 
...
-- Code For temporary table tmp_20180516111439_codegen_q34l3v_bag_b1 part 1. Create 


CREATE TEMPORARY TABLE tmp_20180516111439_codegen_q34l3v_bag_b1 (
	"KEY" BIGINT, 
	"Score_0" DOUBLE, 
	"Proba_0" DOUBLE, 
	"LogProba_0" DOUBLE, 
...
-- Code For temporary table tmp_20180516111439_codegen_q34l3v_bag_b1 part 2. Populate

INSERT INTO tmp_20180516111439_codegen_q34l3v_bag_b1 ("KEY", "Score_0", "Proba_0", "LogProba_0", "Score_1", "Proba_1", "LogProba_1") SELECT "U"."KEY", "U"."Score_0", "U"."Proba_0", "U"."LogProba_0", "U"."Score_1", "U"."Proba_1", "U"."LogProba_1" 
...
-- Code For temporary table tmp_20180516111439_codegen_ztln8k_bag_avg part 1. Create 


CREATE TEMPORARY TABLE tmp_20180516111439_codegen_ztln8k_bag_avg (
	"KEY" BIGINT, 
	"Score_0" DOUBLE, 
	"Proba_0" DOUBLE, 
	"LogProba_0" DOUBLE, 
...
-- Code For temporary table tmp_20180516111439_codegen_ztln8k_bag_avg part 2. Populate

INSERT INTO tmp_20180516111439_codegen_ztln8k_bag_avg ("KEY", "Score_0", "Proba_0", "LogProba_0", "Score_1", "Proba_1", "LogProba_1") SELECT "U"."KEY", "U"."Score_0", "U"."Proba_0", "U"."LogProba_0", "U"."Score_1", "U"."Proba_1", "U"."LogProba_1" 
...
FROM tmp_20180516111439_codegen_s0kp67_bag_b0 AS "BAG_B0" UNION ALL SELECT "BAG_B1"."KEY" AS "KEY", "BAG_B1"."Score_0" AS "Score_0", "BAG_B1"."Proba_0" AS "Proba_0", "BAG_B1"."LogProba_0" AS "LogProba_0", "BAG_B1"."Score_1" AS "Score_1", "BAG_B1"."Proba_1" AS "Proba_1", "BAG_B1"."LogProba_1" AS "LogProba_1" 
FROM tmp_20180516111439_codegen_q34l3v_bag_b1 AS "BAG_B1") AS "BAG_EnsembleUnion")
...
FROM tmp_20180516111439_codegen_ztln8k_bag_avg AS "BAG_avg"), 
