...
-- Code For temporary table tmp_20180516111439_codegen_azq8g7_ads_imp_1_out part 1. Create 


CREATE TABLE tmp_20180516111439_codegen_azq8g7_ads_imp_1_out (
	`KEY` BIGINT, 
	impter_2 DOUBLE, 
	impter_3 DOUBLE, 
	impter_4 DOUBLE, 
...
-- Code For temporary table tmp_20180516111439_codegen_azq8g7_ads_imp_1_out part 2. Populate

INSERT INTO tmp_20180516111439_codegen_azq8g7_ads_imp_1_out (`KEY`, impter_2, impter_3, impter_4, impter_5, impter_6, impter_7, impter_8, impter_9, impter_10, impter_11, impter_12, impter_13, impter_14, impter_15, impter_16, impter_17, impter_18, impter_19, impter_20, impter_21, impter_22, impter_23, impter_24, impter_25, impter_26, impter_27, impter_28, impter_29, impter_30, impter_31) SELECT `ADS_imp_1_OUT`.`KEY`, `ADS_imp_1_OUT`.impter_2, `ADS_imp_1_OUT`.impter_3, `ADS_imp_1_OUT`.impter_4, `ADS_imp_1_OUT`.impter_5, `ADS_imp_1_OUT`.impter_6, `ADS_imp_1_OUT`.impter_7, `ADS_imp_1_OUT`.impter_8, `ADS_imp_1_OUT`.impter_9, `ADS_imp_1_OUT`.impter_10, `ADS_imp_1_OUT`.impter_11, `ADS_imp_1_OUT`.impter_12, `ADS_imp_1_OUT`.impter_13, `ADS_imp_1_OUT`.impter_14, `ADS_imp_1_OUT`.impter_15, `ADS_imp_1_OUT`.impter_16, `ADS_imp_1_OUT`.impter_17, `ADS_imp_1_OUT`.impter_18, `ADS_imp_1_OUT`.impter_19, `ADS_imp_1_OUT`.impter_20, `ADS_imp_1_OUT`.impter_21, `ADS_imp_1_OUT`.impter_22, `ADS_imp_1_OUT`.impter_23, `ADS_imp_1_OUT`.impter_24, `ADS_imp_1_OUT`.impter_25, `ADS_imp_1_OUT`.impter_26, `ADS_imp_1_OUT`.impter_27, `ADS_imp_1_OUT`.impter_28, `ADS_imp_1_OUT`.impter_29, `ADS_imp_1_OUT`.impter_30, `ADS_imp_1_OUT`.impter_31 
...
-- Code For temporary table tmp_20180516111439_codegen_mqw0np_ads_sca_2_out part 1. Create 


CREATE TABLE tmp_20180516111439_codegen_mqw0np_ads_sca_2_out (
	`KEY` BIGINT, 
	scaler_2 DOUBLE, 
	scaler_3 DOUBLE, 
	scaler_4 DOUBLE, 
...
FROM tmp_20180516111439_codegen_azq8g7_ads_imp_1_out AS `ADS_imp_1_OUT`) AS `ADS_sca_2_OUT`

-- Code For temporary table tmp_20180516111439_codegen_w6dmqi_bag_b0 part 1. Create 


CREATE TABLE tmp_20180516111439_codegen_w6dmqi_bag_b0 (
	`KEY` BIGINT, 
	`Score_0` DOUBLE, 
	`Proba_0` DOUBLE, 
	`LogProba_0` DOUBLE, 
...
-- Code For temporary table tmp_20180516111439_codegen_w6dmqi_bag_b0 part 2. Populate
...
FROM tmp_20180516111439_codegen_mqw0np_ads_sca_2_out AS `ADS_sca_2_OUT`), 
`DT_node_data` AS 
...
FROM `DT_Output_9`)
 INSERT INTO tmp_20180516111439_codegen_w6dmqi_bag_b0 (`KEY`, `Score_0`, `Proba_0`, `LogProba_0`, `Score_1`, `Proba_1`, `LogProba_1`) SELECT `BAG_B0`.`KEY`, `BAG_B0`.`Score_0`, `BAG_B0`.`Proba_0`, `BAG_B0`.`LogProba_0`, `BAG_B0`.`Score_1`, `BAG_B0`.`Proba_1`, `BAG_B0`.`LogProba_1` 
...
-- Code For temporary table tmp_20180516111439_codegen_h4grxr_bag_b1 part 1. Create 


CREATE TABLE tmp_20180516111439_codegen_h4grxr_bag_b1 (
	`KEY` BIGINT, 
	`Score_0` DOUBLE, 
	`Proba_0` DOUBLE, 
	`LogProba_0` DOUBLE, 
...
-- Code For temporary table tmp_20180516111439_codegen_h4grxr_bag_b1 part 2. Populate
...
FROM `DT_Output_15`)
 INSERT INTO tmp_20180516111439_codegen_h4grxr_bag_b1 (`KEY`, `Score_0`, `Proba_0`, `LogProba_0`, `Score_1`, `Proba_1`, `LogProba_1`) SELECT `BAG_B1`.`KEY`, `BAG_B1`.`Score_0`, `BAG_B1`.`Proba_0`, `BAG_B1`.`LogProba_0`, `BAG_B1`.`Score_1`, `BAG_B1`.`Proba_1`, `BAG_B1`.`LogProba_1` 
...
-- Code For temporary table tmp_20180516111439_codegen_0nmp4p_bag_avg part 1. Create 


CREATE TABLE tmp_20180516111439_codegen_0nmp4p_bag_avg (
	`KEY` BIGINT, 
	`Score_0` DOUBLE, 
	`Proba_0` DOUBLE, 
	`LogProba_0` DOUBLE, 
...
-- Code For temporary table tmp_20180516111439_codegen_0nmp4p_bag_avg part 2. Populate
...
FROM tmp_20180516111439_codegen_w6dmqi_bag_b0 AS `BAG_B0` UNION ALL SELECT `BAG_B1`.`KEY` AS `KEY`, `BAG_B1`.`Score_0` AS `Score_0`, `BAG_B1`.`Proba_0` AS `Proba_0`, `BAG_B1`.`LogProba_0` AS `LogProba_0`, `BAG_B1`.`Score_1` AS `Score_1`, `BAG_B1`.`Proba_1` AS `Proba_1`, `BAG_B1`.`LogProba_1` AS `LogProba_1` 
FROM tmp_20180516111439_codegen_h4grxr_bag_b1 AS `BAG_B1`) AS `BAG_EnsembleUnion`)
 INSERT INTO tmp_20180516111439_codegen_0nmp4p_bag_avg (`KEY`, `Score_0`, `Proba_0`, `LogProba_0`, `Score_1`, `Proba_1`, `LogProba_1`) SELECT `BAG_avg`.`KEY`, `BAG_avg`.`Score_0`, `BAG_avg`.`Proba_0`, `BAG_avg`.`LogProba_0`, `BAG_avg`.`Score_1`, `BAG_avg`.`Proba_1`, `BAG_avg`.`LogProba_1` 
...
FROM tmp_20180516111439_codegen_0nmp4p_bag_avg AS `BAG_avg`), 
