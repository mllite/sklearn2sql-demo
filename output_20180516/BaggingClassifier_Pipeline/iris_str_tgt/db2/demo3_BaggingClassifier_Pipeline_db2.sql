...
-- Code For temporary table tmp_20180508190427_codegen_ryewfy_ads_imp_1_out part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180508190427_codegen_ryewfy_ads_imp_1_out (
	"KEY" BIGINT, 
...
-- Code For temporary table tmp_20180508190427_codegen_ryewfy_ads_imp_1_out part 2. Populate

INSERT INTO tmp_20180508190427_codegen_ryewfy_ads_imp_1_out SELECT "ADS_imp_1_OUT"."KEY", "ADS_imp_1_OUT".imputer_output_2, "ADS_imp_1_OUT".imputer_output_3, "ADS_imp_1_OUT".imputer_output_4, "ADS_imp_1_OUT".imputer_output_5 
...
-- Code For temporary table tmp_20180508190427_codegen_l20x3g_ads_sca_2_out part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180508190427_codegen_l20x3g_ads_sca_2_out (
	"KEY" BIGINT, 
...
-- Code For temporary table tmp_20180508190427_codegen_l20x3g_ads_sca_2_out part 2. Populate

INSERT INTO tmp_20180508190427_codegen_l20x3g_ads_sca_2_out SELECT "ADS_sca_2_OUT"."KEY", "ADS_sca_2_OUT".scaler_output_2, "ADS_sca_2_OUT".scaler_output_3, "ADS_sca_2_OUT".scaler_output_4, "ADS_sca_2_OUT".scaler_output_5 
...
FROM tmp_20180508190427_codegen_ryewfy_ads_imp_1_out AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT"

-- Code For temporary table tmp_20180508190427_codegen_tn5drd_bag_b0 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180508190427_codegen_tn5drd_bag_b0 (
	"KEY" BIGINT, 
...
-- Code For temporary table tmp_20180508190427_codegen_tn5drd_bag_b0 part 2. Populate

INSERT INTO tmp_20180508190427_codegen_tn5drd_bag_b0 WITH "DT_node_lookup" AS 
...
FROM tmp_20180508190427_codegen_l20x3g_ads_sca_2_out AS "ADS_sca_2_OUT"), 
"DT_node_data" AS 
...
-- Code For temporary table tmp_20180508190427_codegen_d1h32k_bag_b1 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180508190427_codegen_d1h32k_bag_b1 (
	"KEY" BIGINT, 
	"Score_CLASS_0" DOUBLE, 
	"Proba_CLASS_0" DOUBLE, 
	"LogProba_CLASS_0" DOUBLE, 
...
-- Code For temporary table tmp_20180508190427_codegen_d1h32k_bag_b1 part 2. Populate

INSERT INTO tmp_20180508190427_codegen_d1h32k_bag_b1 WITH "DT_node_lookup_10" AS 
...
-- Code For temporary table tmp_20180508190427_codegen_3re1ok_bag_union part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180508190427_codegen_3re1ok_bag_union (
	"KEY" BIGINT, 
	"Score_CLASS_0" DOUBLE, 
	"Proba_CLASS_0" DOUBLE, 
	"LogProba_CLASS_0" DOUBLE, 
...
-- Code For temporary table tmp_20180508190427_codegen_3re1ok_bag_union part 2. Populate

INSERT INTO tmp_20180508190427_codegen_3re1ok_bag_union SELECT "BAG_Union"."KEY", "BAG_Union"."Score_CLASS_0", "BAG_Union"."Proba_CLASS_0", "BAG_Union"."LogProba_CLASS_0", "BAG_Union"."Score_CLASS_1", "BAG_Union"."Proba_CLASS_1", "BAG_Union"."LogProba_CLASS_1", "BAG_Union"."Score_CLASS_2", "BAG_Union"."Proba_CLASS_2", "BAG_Union"."LogProba_CLASS_2" 
...
FROM tmp_20180508190427_codegen_tn5drd_bag_b0 AS "BAG_B0" UNION ALL SELECT "BAG_B1"."KEY" AS "KEY", "BAG_B1"."Score_CLASS_0" AS "Score_CLASS_0", "BAG_B1"."Proba_CLASS_0" AS "Proba_CLASS_0", "BAG_B1"."LogProba_CLASS_0" AS "LogProba_CLASS_0", "BAG_B1"."Score_CLASS_1" AS "Score_CLASS_1", "BAG_B1"."Proba_CLASS_1" AS "Proba_CLASS_1", "BAG_B1"."LogProba_CLASS_1" AS "LogProba_CLASS_1", "BAG_B1"."Score_CLASS_2" AS "Score_CLASS_2", "BAG_B1"."Proba_CLASS_2" AS "Proba_CLASS_2", "BAG_B1"."LogProba_CLASS_2" AS "LogProba_CLASS_2" 
FROM tmp_20180508190427_codegen_d1h32k_bag_b1 AS "BAG_B1") AS "BAG_EnsembleUnion") AS "BAG_Union"

-- Code For temporary table tmp_20180508190427_codegen_qie78s_bag_avg part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180508190427_codegen_qie78s_bag_avg (
	"KEY" BIGINT, 
	"Score_CLASS_0" DOUBLE, 
	"Proba_CLASS_0" DOUBLE, 
	"LogProba_CLASS_0" DOUBLE, 
...
-- Code For temporary table tmp_20180508190427_codegen_qie78s_bag_avg part 2. Populate

INSERT INTO tmp_20180508190427_codegen_qie78s_bag_avg SELECT "BAG_avg"."KEY", "BAG_avg"."Score_CLASS_0", "BAG_avg"."Proba_CLASS_0", "BAG_avg"."LogProba_CLASS_0", "BAG_avg"."Score_CLASS_1", "BAG_avg"."Proba_CLASS_1", "BAG_avg"."LogProba_CLASS_1", "BAG_avg"."Score_CLASS_2", "BAG_avg"."Proba_CLASS_2", "BAG_avg"."LogProba_CLASS_2" 
...
FROM tmp_20180508190427_codegen_3re1ok_bag_union AS "BAG_Union" GROUP BY "BAG_Union"."KEY") AS "T") AS "BAG_avg"
...
FROM tmp_20180508190427_codegen_qie78s_bag_avg AS "BAG_avg"), 
