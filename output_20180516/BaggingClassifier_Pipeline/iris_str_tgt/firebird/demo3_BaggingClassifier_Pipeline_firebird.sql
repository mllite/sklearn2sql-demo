...
-- Code For temporary table TMP_20180516_CODEGEN_3VCRPS_ADS part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180516_CODEGEN_3VCRPS_ADS" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20180516_CODEGEN_3VCRPS_ADS part 2. Populate

INSERT INTO "TMP_20180516_CODEGEN_3VCRPS_ADS" ("KEY", imputer_output_2, imputer_output_3, imputer_output_4, imputer_output_5) SELECT "U"."KEY", "U".imputer_output_2, "U".imputer_output_3, "U".imputer_output_4, "U".imputer_output_5 
...
-- Code For temporary table TMP_20180516_CODEGEN_3VCRPS_ADS part 3. Create Index 

CREATE INDEX "ix_TMP_20180516_CODEGEN_a996" ON "TMP_20180516_CODEGEN_3VCRPS_ADS" ("KEY")

-- Code For temporary table TMP_20180516_CODEGEN_VH4QNJ_ADS part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180516_CODEGEN_VH4QNJ_ADS" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20180516_CODEGEN_VH4QNJ_ADS part 2. Populate

INSERT INTO "TMP_20180516_CODEGEN_VH4QNJ_ADS" ("KEY", scaler_output_2, scaler_output_3, scaler_output_4, scaler_output_5) SELECT "U"."KEY", "U".scaler_output_2, "U".scaler_output_3, "U".scaler_output_4, "U".scaler_output_5 
...
FROM "TMP_20180516_CODEGEN_3VCRPS_ADS" AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT") AS "U"

-- Code For temporary table TMP_20180516_CODEGEN_VH4QNJ_ADS part 3. Create Index 

CREATE INDEX "ix_TMP_20180516_CODEGEN_e96e" ON "TMP_20180516_CODEGEN_VH4QNJ_ADS" ("KEY")

-- Code For temporary table TMP_20180516_CODEGEN_L273UD_BAG part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180516_CODEGEN_L273UD_BAG" (
	"KEY" BIGINT, 
...
FROM "TMP_20180516_CODEGEN_VH4QNJ_ADS" AS "ADS_sca_2_OUT"), 
"DT_node_data" AS 
...
-- Code For temporary table TMP_20180516_CODEGEN_5K2L9J_BAG part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180516_CODEGEN_5K2L9J_BAG" (
	"KEY" BIGINT, 
	"Score_CLASS_0" DOUBLE PRECISION, 
	"Proba_CLASS_0" DOUBLE PRECISION, 
	"LogProba_CLASS_0" DOUBLE PRECISION, 
...
-- Code For temporary table TMP_20180516_CODEGEN_5K2L9J_BAG part 2. Populate

INSERT INTO "TMP_20180516_CODEGEN_5K2L9J_BAG" ("KEY", "Score_CLASS_0", "Proba_CLASS_0", "LogProba_CLASS_0", "Score_CLASS_1", "Proba_CLASS_1", "LogProba_CLASS_1", "Score_CLASS_2", "Proba_CLASS_2", "LogProba_CLASS_2") SELECT "U"."KEY", "U"."Score_CLASS_0", "U"."Proba_CLASS_0", "U"."LogProba_CLASS_0", "U"."Score_CLASS_1", "U"."Proba_CLASS_1", "U"."LogProba_CLASS_1", "U"."Score_CLASS_2", "U"."Proba_CLASS_2", "U"."LogProba_CLASS_2" 
...
-- Code For temporary table TMP_20180516_CODEGEN_ON75S7_BAG part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180516_CODEGEN_ON75S7_BAG" (
	"KEY" BIGINT NOT NULL, 
	"Score_CLASS_0" DOUBLE PRECISION, 
	"Proba_CLASS_0" DOUBLE PRECISION, 
	"LogProba_CLASS_0" DOUBLE PRECISION, 
...
-- Code For temporary table TMP_20180516_CODEGEN_ON75S7_BAG part 2. Populate

INSERT INTO "TMP_20180516_CODEGEN_ON75S7_BAG" ("KEY", "Score_CLASS_0", "Proba_CLASS_0", "LogProba_CLASS_0", "Score_CLASS_1", "Proba_CLASS_1", "LogProba_CLASS_1", "Score_CLASS_2", "Proba_CLASS_2", "LogProba_CLASS_2") SELECT "U"."KEY", "U"."Score_CLASS_0", "U"."Proba_CLASS_0", "U"."LogProba_CLASS_0", "U"."Score_CLASS_1", "U"."Proba_CLASS_1", "U"."LogProba_CLASS_1", "U"."Score_CLASS_2", "U"."Proba_CLASS_2", "U"."LogProba_CLASS_2" 
...
-- Code For temporary table TMP_20180516_CODEGEN_ON75S7_BAG part 3. Create Index 

CREATE INDEX "ix_TMP_20180516_CODEGEN_b089" ON "TMP_20180516_CODEGEN_ON75S7_BAG" ("KEY")
...
FROM "TMP_20180516_CODEGEN_ON75S7_BAG" AS "BAG_avg"), 
