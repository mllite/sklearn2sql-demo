...
-- Code For temporary table tmp_20180516110757_codegen_rb7gcq_ads_imp_1_out part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180516110757_codegen_rb7gcq_ads_imp_1_out  (
	"KEY" BIGINT, 
...
-- Code For temporary table tmp_20180516110757_codegen_5k8xsb_ads_sca_2_out part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180516110757_codegen_5k8xsb_ads_sca_2_out  (
	"KEY" BIGINT, 
...
FROM tmp_20180516110757_codegen_rb7gcq_ads_imp_1_out AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT") AS "U"

-- Code For temporary table tmp_20180516110757_codegen_olozk4_bag_b0 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180516110757_codegen_olozk4_bag_b0  (
	"KEY" BIGINT, 
...
-- Code For temporary table tmp_20180516110757_codegen_olozk4_bag_b0 part 2. Populate

INSERT INTO tmp_20180516110757_codegen_olozk4_bag_b0 ("KEY", "Score_0", "Proba_0", "LogProba_0", "Score_1", "Proba_1", "LogProba_1") SELECT "U"."KEY", "U"."Score_0", "U"."Proba_0", "U"."LogProba_0", "U"."Score_1", "U"."Proba_1", "U"."LogProba_1" 
...
FROM tmp_20180516110757_codegen_5k8xsb_ads_sca_2_out AS "ADS_sca_2_OUT"), 
dummy_cte AS 
...
-- Code For temporary table tmp_20180516110757_codegen_gzkzfo_bag_b1 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180516110757_codegen_gzkzfo_bag_b1  (
	"KEY" BIGINT, 
	"Score_0" DOUBLE PRECISION, 
	"Proba_0" DOUBLE PRECISION, 
	"LogProba_0" DOUBLE PRECISION, 
...
-- Code For temporary table tmp_20180516110757_codegen_gzkzfo_bag_b1 part 2. Populate

INSERT INTO tmp_20180516110757_codegen_gzkzfo_bag_b1 ("KEY", "Score_0", "Proba_0", "LogProba_0", "Score_1", "Proba_1", "LogProba_1") SELECT "U"."KEY", "U"."Score_0", "U"."Proba_0", "U"."LogProba_0", "U"."Score_1", "U"."Proba_1", "U"."LogProba_1" 
...
-- Code For temporary table tmp_20180516110757_codegen_wgy23u_bag_avg part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180516110757_codegen_wgy23u_bag_avg  (
	"KEY" BIGINT, 
	"Score_0" DOUBLE PRECISION, 
	"Proba_0" DOUBLE PRECISION, 
	"LogProba_0" DOUBLE PRECISION, 
...
-- Code For temporary table tmp_20180516110757_codegen_wgy23u_bag_avg part 2. Populate

INSERT INTO tmp_20180516110757_codegen_wgy23u_bag_avg ("KEY", "Score_0", "Proba_0", "LogProba_0", "Score_1", "Proba_1", "LogProba_1") SELECT "U"."KEY", "U"."Score_0", "U"."Proba_0", "U"."LogProba_0", "U"."Score_1", "U"."Proba_1", "U"."LogProba_1" 
...
FROM tmp_20180516110757_codegen_olozk4_bag_b0 AS "BAG_B0" UNION ALL SELECT "BAG_B1"."KEY" AS "KEY", "BAG_B1"."Score_0" AS "Score_0", "BAG_B1"."Proba_0" AS "Proba_0", "BAG_B1"."LogProba_0" AS "LogProba_0", "BAG_B1"."Score_1" AS "Score_1", "BAG_B1"."Proba_1" AS "Proba_1", "BAG_B1"."LogProba_1" AS "LogProba_1" 
FROM tmp_20180516110757_codegen_gzkzfo_bag_b1 AS "BAG_B1") AS "BAG_EnsembleUnion")
...
FROM tmp_20180516110757_codegen_wgy23u_bag_avg AS "BAG_avg"), 
