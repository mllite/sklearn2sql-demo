...
-- Code For temporary table DEGEN_2SH53T_ADS_IMP_1_OUT part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "DEGEN_2SH53T_ADS_IMP_1_OUT" (
	"KEY" NUMBER(19), 
...
-- Code For temporary table DEGEN_LGXP8B_ADS_SCA_2_OUT part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "DEGEN_LGXP8B_ADS_SCA_2_OUT" (
	"KEY" NUMBER(19), 
...
FROM "DEGEN_2SH53T_ADS_IMP_1_OUT" "ADS_imp_1_OUT") "ADS_sca_2_OUT") "U"

-- Code For temporary table 0516_CODEGEN_S0J9Q6_BAG_B0 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "0516_CODEGEN_S0J9Q6_BAG_B0" (
	"KEY" NUMBER(19), 
...
-- Code For temporary table 0516_CODEGEN_S0J9Q6_BAG_B0 part 2. Populate

INSERT INTO "0516_CODEGEN_S0J9Q6_BAG_B0" ("KEY", "Score_0", "Proba_0", "LogProba_0", "Score_1", "Proba_1", "LogProba_1") SELECT "U"."KEY", "U"."Score_0", "U"."Proba_0", "U"."LogProba_0", "U"."Score_1", "U"."Proba_1", "U"."LogProba_1" 
...
FROM "DEGEN_LGXP8B_ADS_SCA_2_OUT" "ADS_sca_2_OUT"), 
"DT_node_data" AS 
...
-- Code For temporary table 0516_CODEGEN_TW8J4M_BAG_B1 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "0516_CODEGEN_TW8J4M_BAG_B1" (
	"KEY" NUMBER(19), 
	"Score_0" BINARY_DOUBLE, 
	"Proba_0" BINARY_DOUBLE, 
	"LogProba_0" BINARY_DOUBLE, 
...
-- Code For temporary table 0516_CODEGEN_TW8J4M_BAG_B1 part 2. Populate

INSERT INTO "0516_CODEGEN_TW8J4M_BAG_B1" ("KEY", "Score_0", "Proba_0", "LogProba_0", "Score_1", "Proba_1", "LogProba_1") SELECT "U"."KEY", "U"."Score_0", "U"."Proba_0", "U"."LogProba_0", "U"."Score_1", "U"."Proba_1", "U"."LogProba_1" 
...
-- Code For temporary table 516_CODEGEN_B3MJZL_BAG_AVG part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "516_CODEGEN_B3MJZL_BAG_AVG" (
	"KEY" NUMBER(19), 
	"Score_0" BINARY_DOUBLE, 
	"Proba_0" BINARY_DOUBLE, 
	"LogProba_0" BINARY_DOUBLE, 
...
-- Code For temporary table 516_CODEGEN_B3MJZL_BAG_AVG part 2. Populate

INSERT INTO "516_CODEGEN_B3MJZL_BAG_AVG" ("KEY", "Score_0", "Proba_0", "LogProba_0", "Score_1", "Proba_1", "LogProba_1") SELECT "U"."KEY", "U"."Score_0", "U"."Proba_0", "U"."LogProba_0", "U"."Score_1", "U"."Proba_1", "U"."LogProba_1" 
...
FROM "0516_CODEGEN_S0J9Q6_BAG_B0" "BAG_B0" UNION ALL SELECT "BAG_B1"."KEY" AS "KEY", "BAG_B1"."Score_0" AS "Score_0", "BAG_B1"."Proba_0" AS "Proba_0", "BAG_B1"."LogProba_0" AS "LogProba_0", "BAG_B1"."Score_1" AS "Score_1", "BAG_B1"."Proba_1" AS "Proba_1", "BAG_B1"."LogProba_1" AS "LogProba_1" 
FROM "0516_CODEGEN_TW8J4M_BAG_B1" "BAG_B1") "BAG_EnsembleUnion")
...
FROM "516_CODEGEN_B3MJZL_BAG_AVG" "BAG_avg"), 
