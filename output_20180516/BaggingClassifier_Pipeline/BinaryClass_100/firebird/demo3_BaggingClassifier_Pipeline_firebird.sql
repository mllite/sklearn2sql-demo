...
-- Code For temporary table TMP_20180516_CODEGEN_YXNN22_ADS part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180516_CODEGEN_YXNN22_ADS" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20180516_CODEGEN_YXNN22_ADS part 3. Create Index 

CREATE INDEX "ix_TMP_20180516_CODEGEN_ca19" ON "TMP_20180516_CODEGEN_YXNN22_ADS" ("KEY")

-- Code For temporary table TMP_20180516_CODEGEN_ZMYGWE_ADS part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180516_CODEGEN_ZMYGWE_ADS" (
	"KEY" BIGINT NOT NULL, 
...
FROM "TMP_20180516_CODEGEN_YXNN22_ADS" AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT") AS "U"

-- Code For temporary table TMP_20180516_CODEGEN_ZMYGWE_ADS part 3. Create Index 

CREATE INDEX "ix_TMP_20180516_CODEGEN_c096" ON "TMP_20180516_CODEGEN_ZMYGWE_ADS" ("KEY")

-- Code For temporary table TMP_20180516_CODEGEN_IP6VR6_BAG part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180516_CODEGEN_IP6VR6_BAG" (
	"KEY" BIGINT, 
...
-- Code For temporary table TMP_20180516_CODEGEN_IP6VR6_BAG part 2. Populate

INSERT INTO "TMP_20180516_CODEGEN_IP6VR6_BAG" ("KEY", "Score_0", "Proba_0", "LogProba_0", "Score_1", "Proba_1", "LogProba_1") SELECT "U"."KEY", "U"."Score_0", "U"."Proba_0", "U"."LogProba_0", "U"."Score_1", "U"."Proba_1", "U"."LogProba_1" 
...
FROM "TMP_20180516_CODEGEN_ZMYGWE_ADS" AS "ADS_sca_2_OUT"), 
"DT_node_data" AS 
...
-- Code For temporary table TMP_20180516_CODEGEN_GDNGNO_BAG part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180516_CODEGEN_GDNGNO_BAG" (
	"KEY" BIGINT, 
	"Score_0" DOUBLE PRECISION, 
	"Proba_0" DOUBLE PRECISION, 
	"LogProba_0" DOUBLE PRECISION, 
...
-- Code For temporary table TMP_20180516_CODEGEN_GDNGNO_BAG part 2. Populate

INSERT INTO "TMP_20180516_CODEGEN_GDNGNO_BAG" ("KEY", "Score_0", "Proba_0", "LogProba_0", "Score_1", "Proba_1", "LogProba_1") SELECT "U"."KEY", "U"."Score_0", "U"."Proba_0", "U"."LogProba_0", "U"."Score_1", "U"."Proba_1", "U"."LogProba_1" 
...
-- Code For temporary table TMP_20180516_CODEGEN_9KHO6K_BAG part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180516_CODEGEN_9KHO6K_BAG" (
	"KEY" BIGINT NOT NULL, 
	"Score_0" DOUBLE PRECISION, 
	"Proba_0" DOUBLE PRECISION, 
	"LogProba_0" DOUBLE PRECISION, 
...
-- Code For temporary table TMP_20180516_CODEGEN_9KHO6K_BAG part 2. Populate

INSERT INTO "TMP_20180516_CODEGEN_9KHO6K_BAG" ("KEY", "Score_0", "Proba_0", "LogProba_0", "Score_1", "Proba_1", "LogProba_1") SELECT "U"."KEY", "U"."Score_0", "U"."Proba_0", "U"."LogProba_0", "U"."Score_1", "U"."Proba_1", "U"."LogProba_1" 
...
FROM "TMP_20180516_CODEGEN_IP6VR6_BAG" AS "BAG_B0" UNION ALL SELECT "BAG_B1"."KEY" AS "KEY", "BAG_B1"."Score_0" AS "Score_0", "BAG_B1"."Proba_0" AS "Proba_0", "BAG_B1"."LogProba_0" AS "LogProba_0", "BAG_B1"."Score_1" AS "Score_1", "BAG_B1"."Proba_1" AS "Proba_1", "BAG_B1"."LogProba_1" AS "LogProba_1" 
FROM "TMP_20180516_CODEGEN_GDNGNO_BAG" AS "BAG_B1") AS "BAG_EnsembleUnion")
...
-- Code For temporary table TMP_20180516_CODEGEN_9KHO6K_BAG part 3. Create Index 

CREATE INDEX "ix_TMP_20180516_CODEGEN_b38e" ON "TMP_20180516_CODEGEN_9KHO6K_BAG" ("KEY")
...
FROM "TMP_20180516_CODEGEN_9KHO6K_BAG" AS "BAG_avg"), 
