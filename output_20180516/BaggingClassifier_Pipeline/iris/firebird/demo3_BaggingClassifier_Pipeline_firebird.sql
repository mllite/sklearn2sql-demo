...
-- Code For temporary table TMP_20180508185449_CODEGEN_OO8G part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508185449_CODEGEN_OO8G" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20180508185449_CODEGEN_OO8G part 2. Populate

INSERT INTO "TMP_20180508185449_CODEGEN_OO8G" ("KEY", imputer_output_2, imputer_output_3, imputer_output_4, imputer_output_5) SELECT "U"."KEY", "U".imputer_output_2, "U".imputer_output_3, "U".imputer_output_4, "U".imputer_output_5 
...
-- Code For temporary table TMP_20180508185449_CODEGEN_OO8G part 3. Create Index 

CREATE INDEX "ix_TMP_20180508185449_C_1795" ON "TMP_20180508185449_CODEGEN_OO8G" ("KEY")

-- Code For temporary table TMP_20180508185449_CODEGEN_6J7W part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508185449_CODEGEN_6J7W" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20180508185449_CODEGEN_6J7W part 2. Populate

INSERT INTO "TMP_20180508185449_CODEGEN_6J7W" ("KEY", scaler_output_2, scaler_output_3, scaler_output_4, scaler_output_5) SELECT "U"."KEY", "U".scaler_output_2, "U".scaler_output_3, "U".scaler_output_4, "U".scaler_output_5 
...
FROM "TMP_20180508185449_CODEGEN_OO8G" AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT") AS "U"

-- Code For temporary table TMP_20180508185449_CODEGEN_6J7W part 3. Create Index 

CREATE INDEX "ix_TMP_20180508185449_C_6f0f" ON "TMP_20180508185449_CODEGEN_6J7W" ("KEY")

-- Code For temporary table TMP_20180508185449_CODEGEN_4QKH part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508185449_CODEGEN_4QKH" (
	"KEY" BIGINT, 
...
-- Code For temporary table TMP_20180508185449_CODEGEN_4QKH part 2. Populate

INSERT INTO "TMP_20180508185449_CODEGEN_4QKH" ("KEY", "Score_0", "Proba_0", "LogProba_0", "Score_1", "Proba_1", "LogProba_1", "Score_2", "Proba_2", "LogProba_2") SELECT "U"."KEY", "U"."Score_0", "U"."Proba_0", "U"."LogProba_0", "U"."Score_1", "U"."Proba_1", "U"."LogProba_1", "U"."Score_2", "U"."Proba_2", "U"."LogProba_2" 
...
FROM "TMP_20180508185449_CODEGEN_6J7W" AS "ADS_sca_2_OUT"), 
"DT_node_data" AS 
...
-- Code For temporary table TMP_20180508185450_CODEGEN_VH4Z part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508185450_CODEGEN_VH4Z" (
	"KEY" BIGINT, 
	"Score_0" DOUBLE PRECISION, 
	"Proba_0" DOUBLE PRECISION, 
	"LogProba_0" DOUBLE PRECISION, 
...
-- Code For temporary table TMP_20180508185450_CODEGEN_VH4Z part 2. Populate

INSERT INTO "TMP_20180508185450_CODEGEN_VH4Z" ("KEY", "Score_0", "Proba_0", "LogProba_0", "Score_1", "Proba_1", "LogProba_1", "Score_2", "Proba_2", "LogProba_2") SELECT "U"."KEY", "U"."Score_0", "U"."Proba_0", "U"."LogProba_0", "U"."Score_1", "U"."Proba_1", "U"."LogProba_1", "U"."Score_2", "U"."Proba_2", "U"."LogProba_2" 
...
-- Code For temporary table TMP_20180508185450_CODEGEN_QZRG part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508185450_CODEGEN_QZRG" (
	"KEY" BIGINT, 
	"Score_0" DOUBLE PRECISION, 
	"Proba_0" DOUBLE PRECISION, 
	"LogProba_0" DOUBLE PRECISION, 
...
-- Code For temporary table TMP_20180508185450_CODEGEN_QZRG part 2. Populate

INSERT INTO "TMP_20180508185450_CODEGEN_QZRG" ("KEY", "Score_0", "Proba_0", "LogProba_0", "Score_1", "Proba_1", "LogProba_1", "Score_2", "Proba_2", "LogProba_2") SELECT "U"."KEY", "U"."Score_0", "U"."Proba_0", "U"."LogProba_0", "U"."Score_1", "U"."Proba_1", "U"."LogProba_1", "U"."Score_2", "U"."Proba_2", "U"."LogProba_2" 
...
FROM "TMP_20180508185449_CODEGEN_4QKH" AS "BAG_B0" UNION ALL SELECT "BAG_B1"."KEY" AS "KEY", "BAG_B1"."Score_0" AS "Score_0", "BAG_B1"."Proba_0" AS "Proba_0", "BAG_B1"."LogProba_0" AS "LogProba_0", "BAG_B1"."Score_1" AS "Score_1", "BAG_B1"."Proba_1" AS "Proba_1", "BAG_B1"."LogProba_1" AS "LogProba_1", "BAG_B1"."Score_2" AS "Score_2", "BAG_B1"."Proba_2" AS "Proba_2", "BAG_B1"."LogProba_2" AS "LogProba_2" 
FROM "TMP_20180508185450_CODEGEN_VH4Z" AS "BAG_B1") AS "BAG_EnsembleUnion") AS "BAG_Union") AS "U"

-- Code For temporary table TMP_20180508185450_CODEGEN_LZU4 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508185450_CODEGEN_LZU4" (
	"KEY" BIGINT NOT NULL, 
	"Score_0" DOUBLE PRECISION, 
	"Proba_0" DOUBLE PRECISION, 
	"LogProba_0" DOUBLE PRECISION, 
...
-- Code For temporary table TMP_20180508185450_CODEGEN_LZU4 part 2. Populate

INSERT INTO "TMP_20180508185450_CODEGEN_LZU4" ("KEY", "Score_0", "Proba_0", "LogProba_0", "Score_1", "Proba_1", "LogProba_1", "Score_2", "Proba_2", "LogProba_2") SELECT "U"."KEY", "U"."Score_0", "U"."Proba_0", "U"."LogProba_0", "U"."Score_1", "U"."Proba_1", "U"."LogProba_1", "U"."Score_2", "U"."Proba_2", "U"."LogProba_2" 
...
FROM "TMP_20180508185450_CODEGEN_QZRG" AS "BAG_Union" GROUP BY "BAG_Union"."KEY") AS "T") AS "BAG_avg") AS "U"

-- Code For temporary table TMP_20180508185450_CODEGEN_LZU4 part 3. Create Index 

CREATE INDEX "ix_TMP_20180508185450_C_c998" ON "TMP_20180508185450_CODEGEN_LZU4" ("KEY")
...
FROM "TMP_20180508185450_CODEGEN_LZU4" AS "BAG_avg"), 
