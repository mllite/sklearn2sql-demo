...
-- Code For temporary table TMP_20180516_CODEGEN_1HKK57_ADS part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180516_CODEGEN_1HKK57_ADS" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20180516_CODEGEN_1HKK57_ADS part 2. Populate

INSERT INTO "TMP_20180516_CODEGEN_1HKK57_ADS" ("KEY", imputer_output_2, imputer_output_3, imputer_output_4, imputer_output_5) SELECT "U"."KEY", "U".imputer_output_2, "U".imputer_output_3, "U".imputer_output_4, "U".imputer_output_5 
...
-- Code For temporary table TMP_20180516_CODEGEN_1HKK57_ADS part 3. Create Index 

CREATE INDEX "ix_TMP_20180516_CODEGEN_a2b6" ON "TMP_20180516_CODEGEN_1HKK57_ADS" ("KEY")

-- Code For temporary table TMP_20180516_CODEGEN_R58K5A_ADS part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180516_CODEGEN_R58K5A_ADS" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20180516_CODEGEN_R58K5A_ADS part 2. Populate

INSERT INTO "TMP_20180516_CODEGEN_R58K5A_ADS" ("KEY", scaler_output_2, scaler_output_3, scaler_output_4, scaler_output_5) SELECT "U"."KEY", "U".scaler_output_2, "U".scaler_output_3, "U".scaler_output_4, "U".scaler_output_5 
...
FROM "TMP_20180516_CODEGEN_1HKK57_ADS" AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT") AS "U"

-- Code For temporary table TMP_20180516_CODEGEN_R58K5A_ADS part 3. Create Index 

CREATE INDEX "ix_TMP_20180516_CODEGEN_e22c" ON "TMP_20180516_CODEGEN_R58K5A_ADS" ("KEY")

-- Code For temporary table TMP_20180516_CODEGEN_3HAZ8C_BAG part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180516_CODEGEN_3HAZ8C_BAG" (
	"KEY" BIGINT, 
...
-- Code For temporary table TMP_20180516_CODEGEN_3HAZ8C_BAG part 2. Populate

INSERT INTO "TMP_20180516_CODEGEN_3HAZ8C_BAG" ("KEY", "Score_0", "Proba_0", "LogProba_0", "Score_1", "Proba_1", "LogProba_1", "Score_2", "Proba_2", "LogProba_2") SELECT "U"."KEY", "U"."Score_0", "U"."Proba_0", "U"."LogProba_0", "U"."Score_1", "U"."Proba_1", "U"."LogProba_1", "U"."Score_2", "U"."Proba_2", "U"."LogProba_2" 
...
FROM "TMP_20180516_CODEGEN_R58K5A_ADS" AS "ADS_sca_2_OUT"), 
"DT_node_data" AS 
...
-- Code For temporary table TMP_20180516_CODEGEN_U57142_BAG part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180516_CODEGEN_U57142_BAG" (
	"KEY" BIGINT, 
	"Score_0" DOUBLE PRECISION, 
	"Proba_0" DOUBLE PRECISION, 
	"LogProba_0" DOUBLE PRECISION, 
...
-- Code For temporary table TMP_20180516_CODEGEN_U57142_BAG part 2. Populate

INSERT INTO "TMP_20180516_CODEGEN_U57142_BAG" ("KEY", "Score_0", "Proba_0", "LogProba_0", "Score_1", "Proba_1", "LogProba_1", "Score_2", "Proba_2", "LogProba_2") SELECT "U"."KEY", "U"."Score_0", "U"."Proba_0", "U"."LogProba_0", "U"."Score_1", "U"."Proba_1", "U"."LogProba_1", "U"."Score_2", "U"."Proba_2", "U"."LogProba_2" 
...
-- Code For temporary table TMP_20180516_CODEGEN_FE94TX_BAG part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180516_CODEGEN_FE94TX_BAG" (
	"KEY" BIGINT NOT NULL, 
	"Score_0" DOUBLE PRECISION, 
	"Proba_0" DOUBLE PRECISION, 
	"LogProba_0" DOUBLE PRECISION, 
...
-- Code For temporary table TMP_20180516_CODEGEN_FE94TX_BAG part 2. Populate

INSERT INTO "TMP_20180516_CODEGEN_FE94TX_BAG" ("KEY", "Score_0", "Proba_0", "LogProba_0", "Score_1", "Proba_1", "LogProba_1", "Score_2", "Proba_2", "LogProba_2") SELECT "U"."KEY", "U"."Score_0", "U"."Proba_0", "U"."LogProba_0", "U"."Score_1", "U"."Proba_1", "U"."LogProba_1", "U"."Score_2", "U"."Proba_2", "U"."LogProba_2" 
...
-- Code For temporary table TMP_20180516_CODEGEN_FE94TX_BAG part 3. Create Index 

CREATE INDEX "ix_TMP_20180516_CODEGEN_8da3" ON "TMP_20180516_CODEGEN_FE94TX_BAG" ("KEY")
...
FROM "TMP_20180516_CODEGEN_FE94TX_BAG" AS "BAG_avg"), 
