...
-- Code For temporary table tmp_20180516122227_codegen_3uygqr_ads_imp_1_out part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180516122227_codegen_3uygqr_ads_imp_1_out (
	"KEY" BIGINT, 
...
-- Code For temporary table tmp_20180516122227_codegen_3uygqr_ads_imp_1_out part 2. Populate

INSERT INTO tmp_20180516122227_codegen_3uygqr_ads_imp_1_out SELECT "ADS_imp_1_OUT"."KEY", "ADS_imp_1_OUT".imputer_output_2, "ADS_imp_1_OUT".imputer_output_3, "ADS_imp_1_OUT".imputer_output_4, "ADS_imp_1_OUT".imputer_output_5 
FROM (SELECT "ADS"."KEY" AS "KEY", CASE WHEN ("ADS"."Feature_0" IS NULL) THEN 5.8474999999999975 ELSE "ADS"."Feature_0" END AS imputer_output_2, CASE WHEN ("ADS"."Feature_1" IS NULL) THEN 3.0366666666666657 ELSE "ADS"."Feature_1" END AS imputer_output_3, CASE WHEN ("ADS"."Feature_2" IS NULL) THEN 3.8450000000000006 ELSE "ADS"."Feature_2" END AS imputer_output_4, CASE WHEN ("ADS"."Feature_3" IS NULL) THEN 1.245 ELSE "ADS"."Feature_3" END AS imputer_output_5 
FROM "IRIS" AS "ADS") AS "ADS_imp_1_OUT"

-- Code For temporary table tmp_20180516122227_codegen_q29m0j_ads_sca_2_out part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180516122227_codegen_q29m0j_ads_sca_2_out (
	"KEY" BIGINT, 
...
-- Code For temporary table tmp_20180516122227_codegen_q29m0j_ads_sca_2_out part 2. Populate

INSERT INTO tmp_20180516122227_codegen_q29m0j_ads_sca_2_out SELECT "ADS_sca_2_OUT"."KEY", "ADS_sca_2_OUT".scaler_output_2, "ADS_sca_2_OUT".scaler_output_3, "ADS_sca_2_OUT".scaler_output_4, "ADS_sca_2_OUT".scaler_output_5 
...
FROM tmp_20180516122227_codegen_3uygqr_ads_imp_1_out AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT"

-- Code For temporary table tmp_20180516122227_codegen_4b4kr6_bag_b0 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180516122227_codegen_4b4kr6_bag_b0 (
	"KEY" BIGINT, 
	"Score_0" DOUBLE, 
	"Proba_0" DOUBLE, 
	"LogProba_0" DOUBLE, 
...
-- Code For temporary table tmp_20180516122227_codegen_4b4kr6_bag_b0 part 2. Populate

INSERT INTO tmp_20180516122227_codegen_4b4kr6_bag_b0 WITH "DT_node_lookup" AS 
...
FROM tmp_20180516122227_codegen_q29m0j_ads_sca_2_out AS "ADS_sca_2_OUT"), 
"DT_node_data" AS 
...
-- Code For temporary table tmp_20180516122227_codegen_mlk1b9_bag_b1 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180516122227_codegen_mlk1b9_bag_b1 (
	"KEY" BIGINT, 
	"Score_0" DOUBLE, 
	"Proba_0" DOUBLE, 
	"LogProba_0" DOUBLE, 
...
-- Code For temporary table tmp_20180516122227_codegen_mlk1b9_bag_b1 part 2. Populate

INSERT INTO tmp_20180516122227_codegen_mlk1b9_bag_b1 WITH "DT_node_lookup_10" AS 
...
-- Code For temporary table tmp_20180516122227_codegen_8vu7a7_bag_avg part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180516122227_codegen_8vu7a7_bag_avg (
	"KEY" BIGINT, 
	"Score_0" DOUBLE, 
	"Proba_0" DOUBLE, 
	"LogProba_0" DOUBLE, 
...
-- Code For temporary table tmp_20180516122227_codegen_8vu7a7_bag_avg part 2. Populate

INSERT INTO tmp_20180516122227_codegen_8vu7a7_bag_avg WITH "BAG_Union" AS 
...
FROM tmp_20180516122227_codegen_8vu7a7_bag_avg AS "BAG_avg"), 
