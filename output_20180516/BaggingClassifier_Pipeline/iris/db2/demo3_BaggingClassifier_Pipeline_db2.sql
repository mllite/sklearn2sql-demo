...
-- Code For temporary table tmp_20180508185452_codegen_v5g4cq_ads_imp_1_out part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180508185452_codegen_v5g4cq_ads_imp_1_out (
	"KEY" BIGINT, 
...
-- Code For temporary table tmp_20180508185452_codegen_v5g4cq_ads_imp_1_out part 2. Populate

INSERT INTO tmp_20180508185452_codegen_v5g4cq_ads_imp_1_out SELECT "ADS_imp_1_OUT"."KEY", "ADS_imp_1_OUT".imputer_output_2, "ADS_imp_1_OUT".imputer_output_3, "ADS_imp_1_OUT".imputer_output_4, "ADS_imp_1_OUT".imputer_output_5 
FROM (SELECT "ADS"."KEY" AS "KEY", CASE WHEN ("ADS"."Feature_0" IS NULL) THEN 5.8474999999999975 ELSE "ADS"."Feature_0" END AS imputer_output_2, CASE WHEN ("ADS"."Feature_1" IS NULL) THEN 3.0366666666666657 ELSE "ADS"."Feature_1" END AS imputer_output_3, CASE WHEN ("ADS"."Feature_2" IS NULL) THEN 3.8450000000000006 ELSE "ADS"."Feature_2" END AS imputer_output_4, CASE WHEN ("ADS"."Feature_3" IS NULL) THEN 1.245 ELSE "ADS"."Feature_3" END AS imputer_output_5 
FROM "IRIS" AS "ADS") AS "ADS_imp_1_OUT"

-- Code For temporary table tmp_20180508185452_codegen_s365mw_ads_sca_2_out part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180508185452_codegen_s365mw_ads_sca_2_out (
	"KEY" BIGINT, 
...
-- Code For temporary table tmp_20180508185452_codegen_s365mw_ads_sca_2_out part 2. Populate

INSERT INTO tmp_20180508185452_codegen_s365mw_ads_sca_2_out SELECT "ADS_sca_2_OUT"."KEY", "ADS_sca_2_OUT".scaler_output_2, "ADS_sca_2_OUT".scaler_output_3, "ADS_sca_2_OUT".scaler_output_4, "ADS_sca_2_OUT".scaler_output_5 
...
FROM tmp_20180508185452_codegen_v5g4cq_ads_imp_1_out AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT"

-- Code For temporary table tmp_20180508185452_codegen_m6yzpk_bag_b0 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180508185452_codegen_m6yzpk_bag_b0 (
	"KEY" BIGINT, 
	"Score_0" DOUBLE, 
	"Proba_0" DOUBLE, 
	"LogProba_0" DOUBLE, 
...
-- Code For temporary table tmp_20180508185452_codegen_m6yzpk_bag_b0 part 2. Populate

INSERT INTO tmp_20180508185452_codegen_m6yzpk_bag_b0 WITH "DT_node_lookup" AS 
...
FROM tmp_20180508185452_codegen_s365mw_ads_sca_2_out AS "ADS_sca_2_OUT"), 
"DT_node_data" AS 
...
-- Code For temporary table tmp_20180508185452_codegen_r9lgg9_bag_b1 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180508185452_codegen_r9lgg9_bag_b1 (
	"KEY" BIGINT, 
	"Score_0" DOUBLE, 
	"Proba_0" DOUBLE, 
	"LogProba_0" DOUBLE, 
...
-- Code For temporary table tmp_20180508185452_codegen_r9lgg9_bag_b1 part 2. Populate

INSERT INTO tmp_20180508185452_codegen_r9lgg9_bag_b1 WITH "DT_node_lookup_10" AS 
...
-- Code For temporary table tmp_20180508185452_codegen_bnwavh_bag_union part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180508185452_codegen_bnwavh_bag_union (
	"KEY" BIGINT, 
	"Score_0" DOUBLE, 
	"Proba_0" DOUBLE, 
	"LogProba_0" DOUBLE, 
...
-- Code For temporary table tmp_20180508185452_codegen_bnwavh_bag_union part 2. Populate

INSERT INTO tmp_20180508185452_codegen_bnwavh_bag_union SELECT "BAG_Union"."KEY", "BAG_Union"."Score_0", "BAG_Union"."Proba_0", "BAG_Union"."LogProba_0", "BAG_Union"."Score_1", "BAG_Union"."Proba_1", "BAG_Union"."LogProba_1", "BAG_Union"."Score_2", "BAG_Union"."Proba_2", "BAG_Union"."LogProba_2" 
...
-- Code For temporary table tmp_20180508185452_codegen_caznrc_bag_avg part 2. Populate

INSERT INTO tmp_20180508185452_codegen_caznrc_bag_avg SELECT "BAG_avg"."KEY", "BAG_avg"."Score_0", "BAG_avg"."Proba_0", "BAG_avg"."LogProba_0", "BAG_avg"."Score_1", "BAG_avg"."Proba_1", "BAG_avg"."LogProba_1", "BAG_avg"."Score_2", "BAG_avg"."Proba_2", "BAG_avg"."LogProba_2" 
...
FROM tmp_20180508185452_codegen_bnwavh_bag_union AS "BAG_Union" GROUP BY "BAG_Union"."KEY") AS "T") AS "BAG_avg"
...
FROM tmp_20180508185452_codegen_caznrc_bag_avg AS "BAG_avg"), 
