...
-- Code For temporary table tmp_20180509004430_codegen_rqr8i3_ads_imp_1_out part 1. Create 

CREATE TEMPORARY TABLE `tmp_20180509004430_codegen_rqr8i3_ads_imp_1_out` STORED AS ORC AS SELECT `ADS_imp_1_OUT`.`KEY`, `ADS_imp_1_OUT`.`imputer_output_2`, `ADS_imp_1_OUT`.`imputer_output_3`, `ADS_imp_1_OUT`.`imputer_output_4`, `ADS_imp_1_OUT`.`imputer_output_5` 
FROM (SELECT `ADS`.`KEY` AS `KEY`, CASE WHEN (`ADS`.`Feature_0` IS NULL) THEN 5.8474999999999975 ELSE `ADS`.`Feature_0` END AS `imputer_output_2`, CASE WHEN (`ADS`.`Feature_1` IS NULL) THEN 3.0366666666666657 ELSE `ADS`.`Feature_1` END AS `imputer_output_3`, CASE WHEN (`ADS`.`Feature_2` IS NULL) THEN 3.8450000000000006 ELSE `ADS`.`Feature_2` END AS `imputer_output_4`, CASE WHEN (`ADS`.`Feature_3` IS NULL) THEN 1.245 ELSE `ADS`.`Feature_3` END AS `imputer_output_5` 
FROM `iris` AS `ADS`) AS `ADS_imp_1_OUT`

-- Code For temporary table tmp_20180509004430_codegen_rqr8i3_ads_imp_1_out part 2. Populate

SELECT * FROM `tmp_20180509004430_codegen_rqr8i3_ads_imp_1_out`

-- Code For temporary table tmp_20180509004430_codegen_gmqps2_ads_sca_2_out part 1. Create 

CREATE TEMPORARY TABLE `tmp_20180509004430_codegen_gmqps2_ads_sca_2_out` STORED AS ORC AS SELECT `ADS_sca_2_OUT`.`KEY`, `ADS_sca_2_OUT`.`scaler_output_2`, `ADS_sca_2_OUT`.`scaler_output_3`, `ADS_sca_2_OUT`.`scaler_output_4`, `ADS_sca_2_OUT`.`scaler_output_5` 
...
FROM `tmp_20180509004430_codegen_rqr8i3_ads_imp_1_out` AS `ADS_imp_1_OUT`) AS `ADS_sca_2_OUT`

-- Code For temporary table tmp_20180509004430_codegen_gmqps2_ads_sca_2_out part 2. Populate

SELECT * FROM `tmp_20180509004430_codegen_gmqps2_ads_sca_2_out`

-- Code For temporary table tmp_20180509004430_codegen_oxtagd_bag_b0 part 1. Create 

CREATE TEMPORARY TABLE `tmp_20180509004430_codegen_oxtagd_bag_b0` STORED AS ORC AS WITH `DT_node_lookup` AS 
...
FROM `tmp_20180509004430_codegen_gmqps2_ads_sca_2_out` AS `ADS_sca_2_OUT`), 
`DT_node_data` AS 
...
-- Code For temporary table tmp_20180509004430_codegen_oxtagd_bag_b0 part 2. Populate

SELECT * FROM `tmp_20180509004430_codegen_oxtagd_bag_b0`

-- Code For temporary table tmp_20180509004430_codegen_vyaf98_bag_b1 part 1. Create 

CREATE TEMPORARY TABLE `tmp_20180509004430_codegen_vyaf98_bag_b1` STORED AS ORC AS WITH `DT_node_lookup_10` AS 
...
-- Code For temporary table tmp_20180509004430_codegen_vyaf98_bag_b1 part 2. Populate

SELECT * FROM `tmp_20180509004430_codegen_vyaf98_bag_b1`

-- Code For temporary table tmp_20180509004430_codegen_pruj23_bag_union part 1. Create 

CREATE TEMPORARY TABLE `tmp_20180509004430_codegen_pruj23_bag_union` STORED AS ORC AS SELECT `BAG_Union`.`KEY`, `BAG_Union`.`Score_0`, `BAG_Union`.`Proba_0`, `BAG_Union`.`LogProba_0`, `BAG_Union`.`Score_1`, `BAG_Union`.`Proba_1`, `BAG_Union`.`LogProba_1`, `BAG_Union`.`Score_2`, `BAG_Union`.`Proba_2`, `BAG_Union`.`LogProba_2` 
...
FROM `tmp_20180509004430_codegen_oxtagd_bag_b0` AS `BAG_B0` UNION ALL SELECT `BAG_B1`.`KEY` AS `KEY`, `BAG_B1`.`Score_0` AS `Score_0`, `BAG_B1`.`Proba_0` AS `Proba_0`, `BAG_B1`.`LogProba_0` AS `LogProba_0`, `BAG_B1`.`Score_1` AS `Score_1`, `BAG_B1`.`Proba_1` AS `Proba_1`, `BAG_B1`.`LogProba_1` AS `LogProba_1`, `BAG_B1`.`Score_2` AS `Score_2`, `BAG_B1`.`Proba_2` AS `Proba_2`, `BAG_B1`.`LogProba_2` AS `LogProba_2` 
FROM `tmp_20180509004430_codegen_vyaf98_bag_b1` AS `BAG_B1`) AS `BAG_EnsembleUnion`) AS `BAG_Union`

-- Code For temporary table tmp_20180509004430_codegen_pruj23_bag_union part 2. Populate

SELECT * FROM `tmp_20180509004430_codegen_pruj23_bag_union`

-- Code For temporary table tmp_20180509004430_codegen_0a4i77_bag_avg part 1. Create 

CREATE TEMPORARY TABLE `tmp_20180509004430_codegen_0a4i77_bag_avg` STORED AS ORC AS SELECT `BAG_avg`.`KEY`, `BAG_avg`.`Score_0`, `BAG_avg`.`Proba_0`, `BAG_avg`.`LogProba_0`, `BAG_avg`.`Score_1`, `BAG_avg`.`Proba_1`, `BAG_avg`.`LogProba_1`, `BAG_avg`.`Score_2`, `BAG_avg`.`Proba_2`, `BAG_avg`.`LogProba_2` 
...
FROM `tmp_20180509004430_codegen_pruj23_bag_union` AS `BAG_Union` GROUP BY `BAG_Union`.`KEY`) AS `T`) AS `BAG_avg`

-- Code For temporary table tmp_20180509004430_codegen_0a4i77_bag_avg part 2. Populate

SELECT * FROM `tmp_20180509004430_codegen_0a4i77_bag_avg`
...
FROM `tmp_20180509004430_codegen_0a4i77_bag_avg` AS `BAG_avg`), 
