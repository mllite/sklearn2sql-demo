...
-- Code For temporary table tmp_20180508185448_codegen_awyaga_ads_imp_1_out part 1. Create 


CREATE TEMPORARY TABLE tmp_20180508185448_codegen_awyaga_ads_imp_1_out (
	"KEY" BIGINT, 
...
-- Code For temporary table tmp_20180508185448_codegen_awyaga_ads_imp_1_out part 2. Populate

INSERT INTO tmp_20180508185448_codegen_awyaga_ads_imp_1_out ("KEY", imputer_output_2, imputer_output_3, imputer_output_4, imputer_output_5) SELECT "U"."KEY", "U".imputer_output_2, "U".imputer_output_3, "U".imputer_output_4, "U".imputer_output_5 
...
-- Code For temporary table tmp_20180508185448_codegen_7oak61_ads_sca_2_out part 1. Create 


CREATE TEMPORARY TABLE tmp_20180508185448_codegen_7oak61_ads_sca_2_out (
	"KEY" BIGINT, 
...
-- Code For temporary table tmp_20180508185448_codegen_7oak61_ads_sca_2_out part 2. Populate

INSERT INTO tmp_20180508185448_codegen_7oak61_ads_sca_2_out ("KEY", scaler_output_2, scaler_output_3, scaler_output_4, scaler_output_5) SELECT "U"."KEY", "U".scaler_output_2, "U".scaler_output_3, "U".scaler_output_4, "U".scaler_output_5 
...
FROM tmp_20180508185448_codegen_awyaga_ads_imp_1_out AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT") AS "U"

-- Code For temporary table tmp_20180508185448_codegen_iqt06d_bag_b0 part 1. Create 


CREATE TEMPORARY TABLE tmp_20180508185448_codegen_iqt06d_bag_b0 (
	"KEY" BIGINT, 
	"Score_0" DOUBLE, 
	"Proba_0" DOUBLE, 
	"LogProba_0" DOUBLE, 
...
-- Code For temporary table tmp_20180508185448_codegen_iqt06d_bag_b0 part 2. Populate

INSERT INTO tmp_20180508185448_codegen_iqt06d_bag_b0 ("KEY", "Score_0", "Proba_0", "LogProba_0", "Score_1", "Proba_1", "LogProba_1", "Score_2", "Proba_2", "LogProba_2") SELECT "U"."KEY", "U"."Score_0", "U"."Proba_0", "U"."LogProba_0", "U"."Score_1", "U"."Proba_1", "U"."LogProba_1", "U"."Score_2", "U"."Proba_2", "U"."LogProba_2" 
...
FROM tmp_20180508185448_codegen_7oak61_ads_sca_2_out AS "ADS_sca_2_OUT"), 
"DT_node_data" AS 
...
-- Code For temporary table tmp_20180508185449_codegen_itp3gf_bag_b1 part 1. Create 


CREATE TEMPORARY TABLE tmp_20180508185449_codegen_itp3gf_bag_b1 (
	"KEY" BIGINT, 
	"Score_0" DOUBLE, 
	"Proba_0" DOUBLE, 
	"LogProba_0" DOUBLE, 
...
-- Code For temporary table tmp_20180508185449_codegen_itp3gf_bag_b1 part 2. Populate

INSERT INTO tmp_20180508185449_codegen_itp3gf_bag_b1 ("KEY", "Score_0", "Proba_0", "LogProba_0", "Score_1", "Proba_1", "LogProba_1", "Score_2", "Proba_2", "LogProba_2") SELECT "U"."KEY", "U"."Score_0", "U"."Proba_0", "U"."LogProba_0", "U"."Score_1", "U"."Proba_1", "U"."LogProba_1", "U"."Score_2", "U"."Proba_2", "U"."LogProba_2" 
...
-- Code For temporary table tmp_20180508185449_codegen_ifogv5_bag_union part 1. Create 


CREATE TEMPORARY TABLE tmp_20180508185449_codegen_ifogv5_bag_union (
	"KEY" BIGINT, 
	"Score_0" DOUBLE, 
	"Proba_0" DOUBLE, 
	"LogProba_0" DOUBLE, 
...
-- Code For temporary table tmp_20180508185449_codegen_ifogv5_bag_union part 2. Populate

INSERT INTO tmp_20180508185449_codegen_ifogv5_bag_union ("KEY", "Score_0", "Proba_0", "LogProba_0", "Score_1", "Proba_1", "LogProba_1", "Score_2", "Proba_2", "LogProba_2") SELECT "U"."KEY", "U"."Score_0", "U"."Proba_0", "U"."LogProba_0", "U"."Score_1", "U"."Proba_1", "U"."LogProba_1", "U"."Score_2", "U"."Proba_2", "U"."LogProba_2" 
...
FROM tmp_20180508185448_codegen_iqt06d_bag_b0 AS "BAG_B0" UNION ALL SELECT "BAG_B1"."KEY" AS "KEY", "BAG_B1"."Score_0" AS "Score_0", "BAG_B1"."Proba_0" AS "Proba_0", "BAG_B1"."LogProba_0" AS "LogProba_0", "BAG_B1"."Score_1" AS "Score_1", "BAG_B1"."Proba_1" AS "Proba_1", "BAG_B1"."LogProba_1" AS "LogProba_1", "BAG_B1"."Score_2" AS "Score_2", "BAG_B1"."Proba_2" AS "Proba_2", "BAG_B1"."LogProba_2" AS "LogProba_2" 
FROM tmp_20180508185449_codegen_itp3gf_bag_b1 AS "BAG_B1") AS "BAG_EnsembleUnion") AS "BAG_Union") AS "U"

-- Code For temporary table tmp_20180508185449_codegen_rm8215_bag_avg part 1. Create 


CREATE TEMPORARY TABLE tmp_20180508185449_codegen_rm8215_bag_avg (
	"KEY" BIGINT, 
	"Score_0" DOUBLE, 
	"Proba_0" DOUBLE, 
	"LogProba_0" DOUBLE, 
...
-- Code For temporary table tmp_20180508185449_codegen_rm8215_bag_avg part 2. Populate

INSERT INTO tmp_20180508185449_codegen_rm8215_bag_avg ("KEY", "Score_0", "Proba_0", "LogProba_0", "Score_1", "Proba_1", "LogProba_1", "Score_2", "Proba_2", "LogProba_2") SELECT "U"."KEY", "U"."Score_0", "U"."Proba_0", "U"."LogProba_0", "U"."Score_1", "U"."Proba_1", "U"."LogProba_1", "U"."Score_2", "U"."Proba_2", "U"."LogProba_2" 
...
FROM tmp_20180508185449_codegen_ifogv5_bag_union AS "BAG_Union" GROUP BY "BAG_Union"."KEY") AS "T") AS "BAG_avg") AS "U"
...
FROM tmp_20180508185449_codegen_rm8215_bag_avg AS "BAG_avg"), 
