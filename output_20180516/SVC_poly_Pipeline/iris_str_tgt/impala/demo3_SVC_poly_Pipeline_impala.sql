...
-- Code For temporary table tmp_20180602162338_055_ads_imp_1_out part 1. Create 


CREATE TABLE tmp_20180602162338_055_ads_imp_1_out (
	`KEY` BIGINT, 
...
-- Code For temporary table tmp_20180602162338_055_ads_imp_1_out part 2. Populate

INSERT INTO tmp_20180602162338_055_ads_imp_1_out (`KEY`, imputer_output_2, imputer_output_3, imputer_output_4, imputer_output_5) SELECT `ADS_imp_1_OUT`.`KEY`, `ADS_imp_1_OUT`.imputer_output_2, `ADS_imp_1_OUT`.imputer_output_3, `ADS_imp_1_OUT`.imputer_output_4, `ADS_imp_1_OUT`.imputer_output_5 
...
-- Code For temporary table tmp_20180602162338_mhd_ads_sca_2_out part 1. Create 


CREATE TABLE tmp_20180602162338_mhd_ads_sca_2_out (
	`KEY` BIGINT, 
...
-- Code For temporary table tmp_20180602162338_mhd_ads_sca_2_out part 2. Populate

INSERT INTO tmp_20180602162338_mhd_ads_sca_2_out (`KEY`, scaler_output_2, scaler_output_3, scaler_output_4, scaler_output_5) SELECT `ADS_sca_2_OUT`.`KEY`, `ADS_sca_2_OUT`.scaler_output_2, `ADS_sca_2_OUT`.scaler_output_3, `ADS_sca_2_OUT`.scaler_output_4, `ADS_sca_2_OUT`.scaler_output_5 
...
FROM tmp_20180602162338_055_ads_imp_1_out AS `ADS_imp_1_OUT`) AS `ADS_sca_2_OUT`

-- Code For temporary table tmp_20180602162338_pcu_kernagg_b0 part 1. Create 


CREATE TABLE tmp_20180602162338_pcu_kernagg_b0 (
	`KEY` BIGINT, 
...
-- Code For temporary table tmp_20180602162338_pcu_kernagg_b0 part 2. Populate
...
FROM tmp_20180602162338_mhd_ads_sca_2_out AS `ADS_sca_2_OUT`), 
...
FROM `kernel_dp_CLASS_0_CLASS_1`)
 INSERT INTO tmp_20180602162338_pcu_kernagg_b0 (`KEY`, `OVO_Class1`, `OVO_Class2`, `OVO_Decision`, `OVO_Conf`) SELECT `KernAgg_B0`.`KEY`, `KernAgg_B0`.`OVO_Class1`, `KernAgg_B0`.`OVO_Class2`, `KernAgg_B0`.`OVO_Decision`, `KernAgg_B0`.`OVO_Conf` 
...
-- Code For temporary table tmp_20180602162338_88y_kernagg_b1 part 1. Create 


CREATE TABLE tmp_20180602162338_88y_kernagg_b1 (
	`KEY` BIGINT, 
	`OVO_Class1` VARCHAR COLLATE "utf8", 
	`OVO_Class2` VARCHAR COLLATE "utf8", 
	`OVO_Decision` BIGINT, 
...
-- Code For temporary table tmp_20180602162338_88y_kernagg_b1 part 2. Populate
...
FROM `kernel_dp_CLASS_0_CLASS_2`)
 INSERT INTO tmp_20180602162338_88y_kernagg_b1 (`KEY`, `OVO_Class1`, `OVO_Class2`, `OVO_Decision`, `OVO_Conf`) SELECT `KernAgg_B1`.`KEY`, `KernAgg_B1`.`OVO_Class1`, `KernAgg_B1`.`OVO_Class2`, `KernAgg_B1`.`OVO_Decision`, `KernAgg_B1`.`OVO_Conf` 
...
-- Code For temporary table tmp_20180602162338_knr_kernagg_b2 part 1. Create 


CREATE TABLE tmp_20180602162338_knr_kernagg_b2 (
	`KEY` BIGINT, 
	`OVO_Class1` VARCHAR COLLATE "utf8", 
	`OVO_Class2` VARCHAR COLLATE "utf8", 
	`OVO_Decision` BIGINT, 
...
-- Code For temporary table tmp_20180602162338_knr_kernagg_b2 part 2. Populate
...
FROM `kernel_dp_CLASS_1_CLASS_2`)
 INSERT INTO tmp_20180602162338_knr_kernagg_b2 (`KEY`, `OVO_Class1`, `OVO_Class2`, `OVO_Decision`, `OVO_Conf`) SELECT `KernAgg_B2`.`KEY`, `KernAgg_B2`.`OVO_Class1`, `KernAgg_B2`.`OVO_Class2`, `KernAgg_B2`.`OVO_Decision`, `KernAgg_B2`.`OVO_Conf` 
...
-- Code For temporary table tmp_20180602162338_ngd_kernagg_agg part 1. Create 


CREATE TABLE tmp_20180602162338_ngd_kernagg_agg (
	`KEY` BIGINT, 
...
-- Code For temporary table tmp_20180602162338_ngd_kernagg_agg part 2. Populate
...
FROM tmp_20180602162338_pcu_kernagg_b0 AS `KernAgg_B0` UNION ALL SELECT `KernAgg_B1`.`KEY` AS `KEY`, `KernAgg_B1`.`OVO_Class1` AS `OVO_Class1`, `KernAgg_B1`.`OVO_Class2` AS `OVO_Class2`, `KernAgg_B1`.`OVO_Decision` AS `OVO_Decision`, `KernAgg_B1`.`OVO_Conf` AS `OVO_Conf` 
FROM tmp_20180602162338_88y_kernagg_b1 AS `KernAgg_B1` UNION ALL SELECT `KernAgg_B2`.`KEY` AS `KEY`, `KernAgg_B2`.`OVO_Class1` AS `OVO_Class1`, `KernAgg_B2`.`OVO_Class2` AS `OVO_Class2`, `KernAgg_B2`.`OVO_Decision` AS `OVO_Decision`, `KernAgg_B2`.`OVO_Conf` AS `OVO_Conf` 
FROM tmp_20180602162338_knr_kernagg_b2 AS `KernAgg_B2`) AS `KernAgg_EnsembleUnion`), 
`OVO_Votes` AS 
...
FROM tmp_20180602162338_ngd_kernagg_agg AS `KernAgg_agg`), 
