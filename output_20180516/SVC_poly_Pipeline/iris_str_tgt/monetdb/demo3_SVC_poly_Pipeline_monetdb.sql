...
-- Code For temporary table tmp_20180516133508_codegen_alqb3m_ads_imp_1_out part 1. Create 


CREATE TEMPORARY TABLE tmp_20180516133508_codegen_alqb3m_ads_imp_1_out (
	"KEY" BIGINT, 
...
-- Code For temporary table tmp_20180516133508_codegen_alqb3m_ads_imp_1_out part 2. Populate

INSERT INTO tmp_20180516133508_codegen_alqb3m_ads_imp_1_out ("KEY", imputer_output_2, imputer_output_3, imputer_output_4, imputer_output_5) SELECT "U"."KEY", "U".imputer_output_2, "U".imputer_output_3, "U".imputer_output_4, "U".imputer_output_5 
...
-- Code For temporary table tmp_20180516133508_codegen_a6q1fc_ads_sca_2_out part 1. Create 


CREATE TEMPORARY TABLE tmp_20180516133508_codegen_a6q1fc_ads_sca_2_out (
	"KEY" BIGINT, 
...
-- Code For temporary table tmp_20180516133508_codegen_a6q1fc_ads_sca_2_out part 2. Populate

INSERT INTO tmp_20180516133508_codegen_a6q1fc_ads_sca_2_out ("KEY", scaler_output_2, scaler_output_3, scaler_output_4, scaler_output_5) SELECT "U"."KEY", "U".scaler_output_2, "U".scaler_output_3, "U".scaler_output_4, "U".scaler_output_5 
...
FROM tmp_20180516133508_codegen_alqb3m_ads_imp_1_out AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT") AS "U"

-- Code For temporary table tmp_20180516133508_codegen_wqlhhn_kernagg_b0 part 1. Create 


CREATE TEMPORARY TABLE tmp_20180516133508_codegen_wqlhhn_kernagg_b0 (
	"KEY" BIGINT, 
	"OVO_Class1" CLOB, 
	"OVO_Class2" CLOB, 
	"OVO_Decision" BIGINT, 
...
-- Code For temporary table tmp_20180516133508_codegen_wqlhhn_kernagg_b0 part 2. Populate

INSERT INTO tmp_20180516133508_codegen_wqlhhn_kernagg_b0 ("KEY", "OVO_Class1", "OVO_Class2", "OVO_Decision", "OVO_Confidence") SELECT "U"."KEY", "U"."OVO_Class1", "U"."OVO_Class2", "U"."OVO_Decision", "U"."OVO_Confidence" 
...
FROM tmp_20180516133508_codegen_a6q1fc_ads_sca_2_out AS "ADS_sca_2_OUT"), 
...
-- Code For temporary table tmp_20180516133508_codegen_0gibw3_kernagg_b1 part 1. Create 


CREATE TEMPORARY TABLE tmp_20180516133508_codegen_0gibw3_kernagg_b1 (
	"KEY" BIGINT, 
	"OVO_Class1" CLOB, 
	"OVO_Class2" CLOB, 
	"OVO_Decision" BIGINT, 
...
-- Code For temporary table tmp_20180516133508_codegen_0gibw3_kernagg_b1 part 2. Populate

INSERT INTO tmp_20180516133508_codegen_0gibw3_kernagg_b1 ("KEY", "OVO_Class1", "OVO_Class2", "OVO_Decision", "OVO_Confidence") SELECT "U"."KEY", "U"."OVO_Class1", "U"."OVO_Class2", "U"."OVO_Decision", "U"."OVO_Confidence" 
FROM (WITH kernel_input AS 
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", CAST("ADS_sca_2_OUT".scaler_output_2 AS DOUBLE) AS scaler_output_2, CAST("ADS_sca_2_OUT".scaler_output_3 AS DOUBLE) AS scaler_output_3, CAST("ADS_sca_2_OUT".scaler_output_4 AS DOUBLE) AS scaler_output_4, CAST("ADS_sca_2_OUT".scaler_output_5 AS DOUBLE) AS scaler_output_5 
FROM tmp_20180516133508_codegen_a6q1fc_ads_sca_2_out AS "ADS_sca_2_OUT"), 
...
-- Code For temporary table tmp_20180516133508_codegen_j3hmwc_kernagg_b2 part 1. Create 


CREATE TEMPORARY TABLE tmp_20180516133508_codegen_j3hmwc_kernagg_b2 (
	"KEY" BIGINT, 
	"OVO_Class1" CLOB, 
	"OVO_Class2" CLOB, 
	"OVO_Decision" BIGINT, 
...
-- Code For temporary table tmp_20180516133508_codegen_j3hmwc_kernagg_b2 part 2. Populate

INSERT INTO tmp_20180516133508_codegen_j3hmwc_kernagg_b2 ("KEY", "OVO_Class1", "OVO_Class2", "OVO_Decision", "OVO_Confidence") SELECT "U"."KEY", "U"."OVO_Class1", "U"."OVO_Class2", "U"."OVO_Decision", "U"."OVO_Confidence" 
FROM (WITH kernel_input AS 
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", CAST("ADS_sca_2_OUT".scaler_output_2 AS DOUBLE) AS scaler_output_2, CAST("ADS_sca_2_OUT".scaler_output_3 AS DOUBLE) AS scaler_output_3, CAST("ADS_sca_2_OUT".scaler_output_4 AS DOUBLE) AS scaler_output_4, CAST("ADS_sca_2_OUT".scaler_output_5 AS DOUBLE) AS scaler_output_5 
FROM tmp_20180516133508_codegen_a6q1fc_ads_sca_2_out AS "ADS_sca_2_OUT"), 
...
-- Code For temporary table tmp_20180516133508_codegen_4zuo7r_kernagg part 1. Create 


CREATE TEMPORARY TABLE tmp_20180516133508_codegen_4zuo7r_kernagg (
	"KEY" BIGINT, 
...
-- Code For temporary table tmp_20180516133508_codegen_4zuo7r_kernagg part 2. Populate

INSERT INTO tmp_20180516133508_codegen_4zuo7r_kernagg ("KEY", "OVO_Vote_CLASS_0", "OVO_SumConfidence_CLASS_0", "OVO_Vote_CLASS_1", "OVO_SumConfidence_CLASS_1", "OVO_Vote_CLASS_2", "OVO_SumConfidence_CLASS_2", max_abs_confidence, "OVO_Scale", "Score_CLASS_0", "Score_CLASS_1", "Score_CLASS_2") SELECT "U"."KEY", "U"."OVO_Vote_CLASS_0", "U"."OVO_SumConfidence_CLASS_0", "U"."OVO_Vote_CLASS_1", "U"."OVO_SumConfidence_CLASS_1", "U"."OVO_Vote_CLASS_2", "U"."OVO_SumConfidence_CLASS_2", "U".max_abs_confidence, "U"."OVO_Scale", "U"."Score_CLASS_0", "U"."Score_CLASS_1", "U"."Score_CLASS_2" 
...
FROM tmp_20180516133508_codegen_wqlhhn_kernagg_b0 AS "KernAgg_B0" UNION ALL SELECT "KernAgg_B1"."KEY" AS "KEY", "KernAgg_B1"."OVO_Class1" AS "OVO_Class1", "KernAgg_B1"."OVO_Class2" AS "OVO_Class2", "KernAgg_B1"."OVO_Decision" AS "OVO_Decision", "KernAgg_B1"."OVO_Confidence" AS "OVO_Confidence" 
FROM tmp_20180516133508_codegen_0gibw3_kernagg_b1 AS "KernAgg_B1" UNION ALL SELECT "KernAgg_B2"."KEY" AS "KEY", "KernAgg_B2"."OVO_Class1" AS "OVO_Class1", "KernAgg_B2"."OVO_Class2" AS "OVO_Class2", "KernAgg_B2"."OVO_Decision" AS "OVO_Decision", "KernAgg_B2"."OVO_Confidence" AS "OVO_Confidence" 
FROM tmp_20180516133508_codegen_j3hmwc_kernagg_b2 AS "KernAgg_B2") AS "KernAgg_EnsembleUnion"), 
"OVO_Votes" AS 
...
FROM tmp_20180516133508_codegen_4zuo7r_kernagg AS "KernAgg"), 
