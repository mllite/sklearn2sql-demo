...
-- Code For temporary table DEGEN_FMXG3H_ADS_IMP_1_OUT part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "DEGEN_FMXG3H_ADS_IMP_1_OUT" (
	"KEY" NUMBER(19), 
...
-- Code For temporary table DEGEN_FMXG3H_ADS_IMP_1_OUT part 2. Populate

INSERT INTO "DEGEN_FMXG3H_ADS_IMP_1_OUT" ("KEY", imputer_output_2, imputer_output_3, imputer_output_4, imputer_output_5) SELECT "U"."KEY", "U".imputer_output_2, "U".imputer_output_3, "U".imputer_output_4, "U".imputer_output_5 
...
-- Code For temporary table DEGEN_DC9756_ADS_SCA_2_OUT part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "DEGEN_DC9756_ADS_SCA_2_OUT" (
	"KEY" NUMBER(19), 
...
-- Code For temporary table DEGEN_DC9756_ADS_SCA_2_OUT part 2. Populate

INSERT INTO "DEGEN_DC9756_ADS_SCA_2_OUT" ("KEY", scaler_output_2, scaler_output_3, scaler_output_4, scaler_output_5) SELECT "U"."KEY", "U".scaler_output_2, "U".scaler_output_3, "U".scaler_output_4, "U".scaler_output_5 
...
FROM "DEGEN_FMXG3H_ADS_IMP_1_OUT" "ADS_imp_1_OUT") "ADS_sca_2_OUT") "U"

-- Code For temporary table _CODEGEN_AMTU4U_KERNAGG_B0 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "_CODEGEN_AMTU4U_KERNAGG_B0" (
	"KEY" NUMBER(19), 
...
-- Code For temporary table _CODEGEN_AMTU4U_KERNAGG_B0 part 2. Populate

INSERT INTO "_CODEGEN_AMTU4U_KERNAGG_B0" ("KEY", "OVO_Class1", "OVO_Class2", "OVO_Decision", "OVO_Confidence") SELECT "U"."KEY", "U"."OVO_Class1", "U"."OVO_Class2", "U"."OVO_Decision", "U"."OVO_Confidence" 
...
FROM "DEGEN_DC9756_ADS_SCA_2_OUT" "ADS_sca_2_OUT"), 
"SV_data_0_1" AS 
...
-- Code For temporary table _CODEGEN_04G4KT_KERNAGG_B1 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "_CODEGEN_04G4KT_KERNAGG_B1" (
	"KEY" NUMBER(19), 
	"OVO_Class1" NUMBER(19), 
	"OVO_Class2" NUMBER(19), 
	"OVO_Decision" NUMBER(19), 
...
-- Code For temporary table _CODEGEN_04G4KT_KERNAGG_B1 part 2. Populate

INSERT INTO "_CODEGEN_04G4KT_KERNAGG_B1" ("KEY", "OVO_Class1", "OVO_Class2", "OVO_Decision", "OVO_Confidence") SELECT "U"."KEY", "U"."OVO_Class1", "U"."OVO_Class2", "U"."OVO_Decision", "U"."OVO_Confidence" 
FROM (WITH kernel_input AS 
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", CAST("ADS_sca_2_OUT".scaler_output_2 AS BINARY_DOUBLE) AS scaler_output_2, CAST("ADS_sca_2_OUT".scaler_output_3 AS BINARY_DOUBLE) AS scaler_output_3, CAST("ADS_sca_2_OUT".scaler_output_4 AS BINARY_DOUBLE) AS scaler_output_4, CAST("ADS_sca_2_OUT".scaler_output_5 AS BINARY_DOUBLE) AS scaler_output_5 
FROM "DEGEN_DC9756_ADS_SCA_2_OUT" "ADS_sca_2_OUT"), 
"SV_data_0_2" AS 
...
-- Code For temporary table _CODEGEN_TB2X4Y_KERNAGG_B2 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "_CODEGEN_TB2X4Y_KERNAGG_B2" (
	"KEY" NUMBER(19), 
	"OVO_Class1" NUMBER(19), 
	"OVO_Class2" NUMBER(19), 
	"OVO_Decision" NUMBER(19), 
...
-- Code For temporary table _CODEGEN_TB2X4Y_KERNAGG_B2 part 2. Populate

INSERT INTO "_CODEGEN_TB2X4Y_KERNAGG_B2" ("KEY", "OVO_Class1", "OVO_Class2", "OVO_Decision", "OVO_Confidence") SELECT "U"."KEY", "U"."OVO_Class1", "U"."OVO_Class2", "U"."OVO_Decision", "U"."OVO_Confidence" 
FROM (WITH kernel_input AS 
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", CAST("ADS_sca_2_OUT".scaler_output_2 AS BINARY_DOUBLE) AS scaler_output_2, CAST("ADS_sca_2_OUT".scaler_output_3 AS BINARY_DOUBLE) AS scaler_output_3, CAST("ADS_sca_2_OUT".scaler_output_4 AS BINARY_DOUBLE) AS scaler_output_4, CAST("ADS_sca_2_OUT".scaler_output_5 AS BINARY_DOUBLE) AS scaler_output_5 
FROM "DEGEN_DC9756_ADS_SCA_2_OUT" "ADS_sca_2_OUT"), 
"SV_data_1_2" AS 
...
-- Code For temporary table 516_CODEGEN_194QVE_KERNAGG part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "516_CODEGEN_194QVE_KERNAGG" (
	"KEY" NUMBER(19), 
...
-- Code For temporary table 516_CODEGEN_194QVE_KERNAGG part 2. Populate

INSERT INTO "516_CODEGEN_194QVE_KERNAGG" ("KEY", "OVO_Vote_0", "OVO_SumConfidence_0", "OVO_Vote_1", "OVO_SumConfidence_1", "OVO_Vote_2", "OVO_SumConfidence_2", max_abs_confidence, "OVO_Scale", "Score_0", "Score_1", "Score_2") SELECT "U"."KEY", "U"."OVO_Vote_0", "U"."OVO_SumConfidence_0", "U"."OVO_Vote_1", "U"."OVO_SumConfidence_1", "U"."OVO_Vote_2", "U"."OVO_SumConfidence_2", "U".max_abs_confidence, "U"."OVO_Scale", "U"."Score_0", "U"."Score_1", "U"."Score_2" 
...
FROM "_CODEGEN_AMTU4U_KERNAGG_B0" "KernAgg_B0" UNION ALL SELECT "KernAgg_B1"."KEY" AS "KEY", "KernAgg_B1"."OVO_Class1" AS "OVO_Class1", "KernAgg_B1"."OVO_Class2" AS "OVO_Class2", "KernAgg_B1"."OVO_Decision" AS "OVO_Decision", "KernAgg_B1"."OVO_Confidence" AS "OVO_Confidence" 
FROM "_CODEGEN_04G4KT_KERNAGG_B1" "KernAgg_B1" UNION ALL SELECT "KernAgg_B2"."KEY" AS "KEY", "KernAgg_B2"."OVO_Class1" AS "OVO_Class1", "KernAgg_B2"."OVO_Class2" AS "OVO_Class2", "KernAgg_B2"."OVO_Decision" AS "OVO_Decision", "KernAgg_B2"."OVO_Confidence" AS "OVO_Confidence" 
FROM "_CODEGEN_TB2X4Y_KERNAGG_B2" "KernAgg_B2") "KernAgg_EnsembleUnion"), 
"OVO_Votes" AS 
...
FROM "516_CODEGEN_194QVE_KERNAGG" "KernAgg"), 
