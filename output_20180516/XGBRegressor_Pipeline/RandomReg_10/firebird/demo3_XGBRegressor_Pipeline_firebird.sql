...
-- Code For temporary table TMP_20180516_CODEGEN_UUBB5J_ADS part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180516_CODEGEN_UUBB5J_ADS" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20180516_CODEGEN_UUBB5J_ADS part 2. Populate

INSERT INTO "TMP_20180516_CODEGEN_UUBB5J_ADS" ("KEY", impter_2, impter_3, impter_4, impter_5, impter_6, impter_7, impter_8, impter_9, impter_10, impter_11) SELECT "U"."KEY", "U".impter_2, "U".impter_3, "U".impter_4, "U".impter_5, "U".impter_6, "U".impter_7, "U".impter_8, "U".impter_9, "U".impter_10, "U".impter_11 
...
-- Code For temporary table TMP_20180516_CODEGEN_UUBB5J_ADS part 3. Create Index 

CREATE INDEX "ix_TMP_20180516_CODEGEN_23e4" ON "TMP_20180516_CODEGEN_UUBB5J_ADS" ("KEY")

-- Code For temporary table TMP_20180516_CODEGEN_P4V7XM_ADS part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180516_CODEGEN_P4V7XM_ADS" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20180516_CODEGEN_P4V7XM_ADS part 2. Populate

INSERT INTO "TMP_20180516_CODEGEN_P4V7XM_ADS" ("KEY", scaler_2, scaler_3, scaler_4, scaler_5, scaler_6, scaler_7, scaler_8, scaler_9, scaler_10, scaler_11) SELECT "U"."KEY", "U".scaler_2, "U".scaler_3, "U".scaler_4, "U".scaler_5, "U".scaler_6, "U".scaler_7, "U".scaler_8, "U".scaler_9, "U".scaler_10, "U".scaler_11 
...
FROM "TMP_20180516_CODEGEN_UUBB5J_ADS" AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT") AS "U"

-- Code For temporary table TMP_20180516_CODEGEN_P4V7XM_ADS part 3. Create Index 

CREATE INDEX "ix_TMP_20180516_CODEGEN_77c0" ON "TMP_20180516_CODEGEN_P4V7XM_ADS" ("KEY")

-- Code For temporary table TMP_20180516_CODEGEN_72BNS9_XGB part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180516_CODEGEN_72BNS9_XGB" (
	"KEY" BIGINT, 
...
-- Code For temporary table TMP_20180516_CODEGEN_72BNS9_XGB part 2. Populate

INSERT INTO "TMP_20180516_CODEGEN_72BNS9_XGB" ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
FROM "TMP_20180516_CODEGEN_P4V7XM_ADS" AS "ADS_sca_2_OUT"), 
"DT_node_data" AS 
...
-- Code For temporary table TMP_20180516_CODEGEN_RZ5ZYP_XGB part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180516_CODEGEN_RZ5ZYP_XGB" (
	"KEY" BIGINT, 
	"Estimator" DOUBLE PRECISION
)
...
-- Code For temporary table TMP_20180516_CODEGEN_RZ5ZYP_XGB part 2. Populate

INSERT INTO "TMP_20180516_CODEGEN_RZ5ZYP_XGB" ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
-- Code For temporary table TMP_20180516_CODEGEN_5BBXDS_XGB part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180516_CODEGEN_5BBXDS_XGB" (
	"KEY" BIGINT NOT NULL, 
	"Estimator" DOUBLE PRECISION, 
	PRIMARY KEY ("KEY")
)
...
-- Code For temporary table TMP_20180516_CODEGEN_5BBXDS_XGB part 2. Populate

INSERT INTO "TMP_20180516_CODEGEN_5BBXDS_XGB" ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
FROM "TMP_20180516_CODEGEN_72BNS9_XGB" AS "XGB_B0" UNION ALL SELECT "XGB_B1"."KEY" AS "KEY", "XGB_B1"."Estimator" AS "Estimator" 
FROM "TMP_20180516_CODEGEN_RZ5ZYP_XGB" AS "XGB_B1") AS "XGB_EnsembleUnion")
...
-- Code For temporary table TMP_20180516_CODEGEN_5BBXDS_XGB part 3. Create Index 

CREATE INDEX "ix_TMP_20180516_CODEGEN_c73e" ON "TMP_20180516_CODEGEN_5BBXDS_XGB" ("KEY")

-- Model deployment code

SELECT "XGB_sum"."KEY" AS "KEY", "XGB_sum"."Estimator" + 0.5 AS "Estimator" 
FROM "TMP_20180516_CODEGEN_5BBXDS_XGB" AS "XGB_sum"