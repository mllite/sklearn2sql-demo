...
-- Code For temporary table ##TMP_20180602144715_XSM_ADS_imp_1_OUT part 1. Create 


CREATE TABLE ##TMP_20180602144715_XSM_ADS_imp_1_OUT (
	[KEY] BIGINT NULL, 
...
-- Code For temporary table ##TMP_20180602144715_XSM_ADS_imp_1_OUT part 2. Populate

INSERT INTO ##TMP_20180602144715_XSM_ADS_imp_1_OUT ([KEY], impter_2, impter_3, impter_4, impter_5, impter_6, impter_7, impter_8, impter_9, impter_10, impter_11) SELECT [ADS_imp_1_OUT].[KEY], [ADS_imp_1_OUT].impter_2, [ADS_imp_1_OUT].impter_3, [ADS_imp_1_OUT].impter_4, [ADS_imp_1_OUT].impter_5, [ADS_imp_1_OUT].impter_6, [ADS_imp_1_OUT].impter_7, [ADS_imp_1_OUT].impter_8, [ADS_imp_1_OUT].impter_9, [ADS_imp_1_OUT].impter_10, [ADS_imp_1_OUT].impter_11 
...
-- Code For temporary table ##TMP_20180602144715_8W7_ADS_sca_2_OUT part 1. Create 


CREATE TABLE ##TMP_20180602144715_8W7_ADS_sca_2_OUT (
	[KEY] BIGINT NULL, 
	scaler_2 FLOAT NULL, 
	scaler_3 FLOAT NULL, 
	scaler_4 FLOAT NULL, 
...
FROM ##TMP_20180602144715_XSM_ADS_imp_1_OUT AS [ADS_imp_1_OUT]) AS [ADS_sca_2_OUT]

-- Code For temporary table ##TMP_20180602144715_KXK_XGB_B0 part 1. Create 


CREATE TABLE ##TMP_20180602144715_KXK_XGB_B0 (
	[KEY] BIGINT NULL, 
...
-- Code For temporary table ##TMP_20180602144715_KXK_XGB_B0 part 2. Populate
...
FROM ##TMP_20180602144715_8W7_ADS_sca_2_OUT AS [ADS_sca_2_OUT]), 
[DT_node_data] AS 
...
FROM [DT_Output_9])
 INSERT INTO ##TMP_20180602144715_KXK_XGB_B0 ([KEY], [Estimator]) SELECT [XGB_B0].[KEY], [XGB_B0].[Estimator] 
...
-- Code For temporary table ##TMP_20180602144715_ITM_XGB_B1 part 1. Create 


CREATE TABLE ##TMP_20180602144715_ITM_XGB_B1 (
	[KEY] BIGINT NULL, 
	[Estimator] FLOAT(53) NULL
)
...
-- Code For temporary table ##TMP_20180602144715_ITM_XGB_B1 part 2. Populate
...
FROM [DT_Output_15])
 INSERT INTO ##TMP_20180602144715_ITM_XGB_B1 ([KEY], [Estimator]) SELECT [XGB_B1].[KEY], [XGB_B1].[Estimator] 
...
-- Code For temporary table ##TMP_20180602144715_GHP_XGB_sum part 1. Create 


CREATE TABLE ##TMP_20180602144715_GHP_XGB_sum (
	[KEY] BIGINT NULL, 
	[Estimator] FLOAT(53) NULL
)
...
-- Code For temporary table ##TMP_20180602144715_GHP_XGB_sum part 2. Populate
...
FROM ##TMP_20180602144715_KXK_XGB_B0 AS [XGB_B0] UNION ALL SELECT [XGB_B1].[KEY] AS [KEY], [XGB_B1].[Estimator] AS [Estimator] 
FROM ##TMP_20180602144715_ITM_XGB_B1 AS [XGB_B1]) AS [XGB_EnsembleUnion])
 INSERT INTO ##TMP_20180602144715_GHP_XGB_sum ([KEY], [Estimator]) SELECT [XGB_sum].[KEY], [XGB_sum].[Estimator] 
...
FROM ##TMP_20180602144715_GHP_XGB_sum AS [XGB_sum]