...
-- Code For temporary table tmp_20180508183626_codegen_gip3p4_ads_imp_1_out part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180508183626_codegen_gip3p4_ads_imp_1_out (
	"KEY" BIGINT, 
	impter_2 DOUBLE, 
	impter_3 DOUBLE, 
	impter_4 DOUBLE, 
...
-- Code For temporary table tmp_20180508183626_codegen_gip3p4_ads_imp_1_out part 2. Populate

INSERT INTO tmp_20180508183626_codegen_gip3p4_ads_imp_1_out SELECT "ADS_imp_1_OUT"."KEY", "ADS_imp_1_OUT".impter_2, "ADS_imp_1_OUT".impter_3, "ADS_imp_1_OUT".impter_4, "ADS_imp_1_OUT".impter_5, "ADS_imp_1_OUT".impter_6, "ADS_imp_1_OUT".impter_7, "ADS_imp_1_OUT".impter_8, "ADS_imp_1_OUT".impter_9, "ADS_imp_1_OUT".impter_10, "ADS_imp_1_OUT".impter_11 
...
-- Code For temporary table tmp_20180508183626_codegen_64etvs_ads_sca_2_out part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180508183626_codegen_64etvs_ads_sca_2_out (
	"KEY" BIGINT, 
	scaler_2 DOUBLE, 
	scaler_3 DOUBLE, 
	scaler_4 DOUBLE, 
...
-- Code For temporary table tmp_20180508183626_codegen_64etvs_ads_sca_2_out part 2. Populate

INSERT INTO tmp_20180508183626_codegen_64etvs_ads_sca_2_out SELECT "ADS_sca_2_OUT"."KEY", "ADS_sca_2_OUT".scaler_2, "ADS_sca_2_OUT".scaler_3, "ADS_sca_2_OUT".scaler_4, "ADS_sca_2_OUT".scaler_5, "ADS_sca_2_OUT".scaler_6, "ADS_sca_2_OUT".scaler_7, "ADS_sca_2_OUT".scaler_8, "ADS_sca_2_OUT".scaler_9, "ADS_sca_2_OUT".scaler_10, "ADS_sca_2_OUT".scaler_11 
...
FROM tmp_20180508183626_codegen_gip3p4_ads_imp_1_out AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT"

-- Code For temporary table tmp_20180508183626_codegen_51zan0_xgb_b0 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180508183626_codegen_51zan0_xgb_b0 (
	"KEY" BIGINT, 
	"Estimator" DOUBLE
)
...
-- Code For temporary table tmp_20180508183626_codegen_51zan0_xgb_b0 part 2. Populate

INSERT INTO tmp_20180508183626_codegen_51zan0_xgb_b0 WITH "DT_node_lookup" AS 
...
FROM tmp_20180508183626_codegen_64etvs_ads_sca_2_out AS "ADS_sca_2_OUT"), 
"DT_node_data" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Estimator" AS DOUBLE) AS "Estimator" 
FROM (SELECT 4 AS nid, 15.776923179626465 AS "Estimator" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 6 AS nid, 24.05500030517578 AS "Estimator" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 7 AS nid, 10.930405616760254 AS "Estimator" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 8 AS nid, 8.347762107849121 AS "Estimator" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 9 AS nid, 13.62121295928955 AS "Estimator" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 10 AS nid, 18.598438262939453 AS "Estimator" FROM SYSIBM.SYSDUMMY1) AS "Values"), 
"DT_Output" AS 
...
"DT_node_data_1" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Estimator" AS DOUBLE) AS "Estimator" 
FROM (SELECT 4 AS nid, 14.003450393676758 AS "Estimator" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 6 AS nid, 23.286762237548828 AS "Estimator" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 7 AS nid, 9.415186882019043 AS "Estimator" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 8 AS nid, 7.198849678039551 AS "Estimator" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 9 AS nid, 14.533350944519043 AS "Estimator" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 10 AS nid, 19.064584732055664 AS "Estimator" FROM SYSIBM.SYSDUMMY1) AS "Values"), 
"DT_Output_1" AS 
...
"DT_node_data_2" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Estimator" AS DOUBLE) AS "Estimator" 
FROM (SELECT 6 AS nid, 20.29665184020996 AS "Estimator" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 7 AS nid, 6.414662837982178 AS "Estimator" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 8 AS nid, 8.630793571472168 AS "Estimator" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 9 AS nid, 9.850298881530762 AS "Estimator" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 10 AS nid, 14.109347343444824 AS "Estimator" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 11 AS nid, 10.822417259216309 AS "Estimator" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 12 AS nid, 15.3329439163208 AS "Estimator" FROM SYSIBM.SYSDUMMY1) AS "Values"), 
"DT_Output_2" AS 
...
"DT_node_data_3" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Estimator" AS DOUBLE) AS "Estimator" 
FROM (SELECT 7 AS nid, 8.028899192810059 AS "Estimator" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 8 AS nid, 5.990607738494873 AS "Estimator" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 9 AS nid, 8.930937767028809 AS "Estimator" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 10 AS nid, 12.754850387573242 AS "Estimator" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 11 AS nid, 9.25925064086914 AS "Estimator" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 12 AS nid, 13.668062210083008 AS "Estimator" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 13 AS nid, 19.54034996032715 AS "Estimator" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 14 AS nid, 13.672558784484863 AS "Estimator" FROM SYSIBM.SYSDUMMY1) AS "Values"), 
"DT_Output_3" AS 
...
"DT_node_data_4" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Estimator" AS DOUBLE) AS "Estimator" 
FROM (SELECT 7 AS nid, 6.921077728271484 AS "Estimator" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 8 AS nid, 5.144952297210693 AS "Estimator" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 9 AS nid, 11.345939636230469 AS "Estimator" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 10 AS nid, 7.35351037979126 AS "Estimator" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 11 AS nid, 9.932232856750488 AS "Estimator" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 12 AS nid, 13.648144721984863 AS "Estimator" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 13 AS nid, 11.720587730407715 AS "Estimator" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 14 AS nid, 16.95893669128418 AS "Estimator" FROM SYSIBM.SYSDUMMY1) AS "Values"), 
"DT_Output_4" AS 
...
"DT_node_data_5" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Estimator" AS DOUBLE) AS "Estimator" 
FROM (SELECT 6 AS nid, 15.905003547668457 AS "Estimator" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 7 AS nid, 5.828351974487305 AS "Estimator" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 8 AS nid, 3.6082522869110107 AS "Estimator" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 9 AS nid, 10.483193397521973 AS "Estimator" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 10 AS nid, 6.575033664703369 AS "Estimator" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 11 AS nid, 5.92445707321167 AS "Estimator" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 12 AS nid, 11.060623168945312 AS "Estimator" FROM SYSIBM.SYSDUMMY1) AS "Values"), 
"DT_Output_5" AS 
...
"DT_node_data_6" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Estimator" AS DOUBLE) AS "Estimator" 
FROM (SELECT 6 AS nid, 14.899293899536133 AS "Estimator" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 7 AS nid, 5.037124156951904 AS "Estimator" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 8 AS nid, 8.110381126403809 AS "Estimator" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 9 AS nid, 7.3873162269592285 AS "Estimator" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 10 AS nid, 11.648924827575684 AS "Estimator" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 11 AS nid, 13.217264175415039 AS "Estimator" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 12 AS nid, 8.917932510375977 AS "Estimator" FROM SYSIBM.SYSDUMMY1) AS "Values"), 
"DT_Output_6" AS 
...
"DT_node_data_7" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Estimator" AS DOUBLE) AS "Estimator" 
FROM (SELECT 7 AS nid, 5.168146133422852 AS "Estimator" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 8 AS nid, 3.6053311824798584 AS "Estimator" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 9 AS nid, 8.7820405960083 AS "Estimator" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 10 AS nid, 5.390221118927002 AS "Estimator" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 11 AS nid, 5.32416296005249 AS "Estimator" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 12 AS nid, 8.763245582580566 AS "Estimator" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 13 AS nid, 8.623435974121094 AS "Estimator" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 14 AS nid, 12.895909309387207 AS "Estimator" FROM SYSIBM.SYSDUMMY1) AS "Values"), 
"DT_Output_7" AS 
...
"DT_node_data_8" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Estimator" AS DOUBLE) AS "Estimator" 
FROM (SELECT 6 AS nid, 12.363444328308105 AS "Estimator" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 7 AS nid, 4.04940938949585 AS "Estimator" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 8 AS nid, 6.651192665100098 AS "Estimator" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 9 AS nid, 6.120324611663818 AS "Estimator" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 10 AS nid, 10.08482551574707 AS "Estimator" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 11 AS nid, 8.969040870666504 AS "Estimator" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 12 AS nid, 3.548654317855835 AS "Estimator" FROM SYSIBM.SYSDUMMY1) AS "Values"), 
"DT_Output_8" AS 
...
"DT_node_data_9" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Estimator" AS DOUBLE) AS "Estimator" 
FROM (SELECT 4 AS nid, 7.961431980133057 AS "Estimator" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 6 AS nid, 11.157633781433105 AS "Estimator" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 7 AS nid, 2.6931638717651367 AS "Estimator" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 8 AS nid, 4.346072673797607 AS "Estimator" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 9 AS nid, 6.031167030334473 AS "Estimator" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 10 AS nid, 8.75991439819336 AS "Estimator" FROM SYSIBM.SYSDUMMY1) AS "Values"), 
"DT_Output_9" AS 
...
-- Code For temporary table tmp_20180508183626_codegen_uuuivx_xgb_b1 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180508183626_codegen_uuuivx_xgb_b1 (
	"KEY" BIGINT, 
	"Estimator" DOUBLE
)
...
-- Code For temporary table tmp_20180508183626_codegen_uuuivx_xgb_b1 part 2. Populate

INSERT INTO tmp_20180508183626_codegen_uuuivx_xgb_b1 WITH "DT_node_lookup_10" AS 
...
"DT_node_data_10" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Estimator" AS DOUBLE) AS "Estimator" 
FROM (SELECT 7 AS nid, 5.3822102546691895 AS "Estimator" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 8 AS nid, 2.910175323486328 AS "Estimator" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 9 AS nid, 4.021858215332031 AS "Estimator" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 10 AS nid, 7.552056312561035 AS "Estimator" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 11 AS nid, 4.675178050994873 AS "Estimator" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 12 AS nid, 8.340153694152832 AS "Estimator" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 13 AS nid, 7.252984523773193 AS "Estimator" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 14 AS nid, 10.570660591125488 AS "Estimator" FROM SYSIBM.SYSDUMMY1) AS "Values"), 
"DT_Output_10" AS 
...
"DT_node_data_11" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Estimator" AS DOUBLE) AS "Estimator" 
FROM (SELECT 7 AS nid, 3.94830584526062 AS "Estimator" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 8 AS nid, 2.2174837589263916 AS "Estimator" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 9 AS nid, 2.6256496906280518 AS "Estimator" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 10 AS nid, 7.762805938720703 AS "Estimator" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 11 AS nid, 4.909304141998291 AS "Estimator" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 12 AS nid, 7.3871750831604 AS "Estimator" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 13 AS nid, 10.758736610412598 AS "Estimator" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 14 AS nid, 6.986988067626953 AS "Estimator" FROM SYSIBM.SYSDUMMY1) AS "Values"), 
"DT_Output_11" AS 
...
"DT_node_data_12" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Estimator" AS DOUBLE) AS "Estimator" 
FROM (SELECT 7 AS nid, 2.458796739578247 AS "Estimator" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 8 AS nid, 5.796570777893066 AS "Estimator" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 9 AS nid, 3.137352466583252 AS "Estimator" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 10 AS nid, 6.299558639526367 AS "Estimator" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 11 AS nid, 3.8004708290100098 AS "Estimator" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 12 AS nid, 6.960630893707275 AS "Estimator" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 13 AS nid, 5.935761451721191 AS "Estimator" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 14 AS nid, 8.735002517700195 AS "Estimator" FROM SYSIBM.SYSDUMMY1) AS "Values"), 
"DT_Output_12" AS 
...
"DT_node_data_13" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Estimator" AS DOUBLE) AS "Estimator" 
FROM (SELECT 7 AS nid, 4.188769817352295 AS "Estimator" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 8 AS nid, 1.9906542301177979 AS "Estimator" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 9 AS nid, 2.0451626777648926 AS "Estimator" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 10 AS nid, 5.4328932762146 AS "Estimator" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 11 AS nid, 6.339311122894287 AS "Estimator" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 12 AS nid, 3.2873058319091797 AS "Estimator" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 13 AS nid, 5.36133337020874 AS "Estimator" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 14 AS nid, 7.887193202972412 AS "Estimator" FROM SYSIBM.SYSDUMMY1) AS "Values"), 
"DT_Output_13" AS 
...
"DT_node_data_14" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Estimator" AS DOUBLE) AS "Estimator" 
FROM (SELECT 7 AS nid, 2.65255069732666 AS "Estimator" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 8 AS nid, 0.41457176208496094 AS "Estimator" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 9 AS nid, 2.761002779006958 AS "Estimator" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 10 AS nid, 4.807448863983154 AS "Estimator" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 11 AS nid, 4.043216228485107 AS "Estimator" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 12 AS nid, 6.891916751861572 AS "Estimator" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 13 AS nid, 0.9939157366752625 AS "Estimator" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 14 AS nid, 7.210835933685303 AS "Estimator" FROM SYSIBM.SYSDUMMY1) AS "Values"), 
"DT_Output_14" AS 
...
"DT_node_data_15" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Estimator" AS DOUBLE) AS "Estimator" 
FROM (SELECT 7 AS nid, 0.42818233370780945 AS "Estimator" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 8 AS nid, 2.249375343322754 AS "Estimator" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 9 AS nid, 4.159715175628662 AS "Estimator" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 10 AS nid, 1.6386209726333618 AS "Estimator" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 11 AS nid, 7.7528204917907715 AS "Estimator" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 12 AS nid, 3.6319217681884766 AS "Estimator" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 13 AS nid, 1.6937063932418823 AS "Estimator" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 14 AS nid, 5.325215816497803 AS "Estimator" FROM SYSIBM.SYSDUMMY1) AS "Values"), 
"DT_Output_15" AS 
...
-- Code For temporary table tmp_20180508183626_codegen_om1jus_xgb_union part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180508183626_codegen_om1jus_xgb_union (
	"KEY" BIGINT, 
	"Estimator" DOUBLE
)
...
-- Code For temporary table tmp_20180508183626_codegen_om1jus_xgb_union part 2. Populate

INSERT INTO tmp_20180508183626_codegen_om1jus_xgb_union SELECT "XGB_Union"."KEY", "XGB_Union"."Estimator" 
...
FROM tmp_20180508183626_codegen_51zan0_xgb_b0 AS "XGB_B0" UNION ALL SELECT "XGB_B1"."KEY" AS "KEY", "XGB_B1"."Estimator" AS "Estimator" 
FROM tmp_20180508183626_codegen_uuuivx_xgb_b1 AS "XGB_B1") AS "XGB_EnsembleUnion") AS "XGB_Union"

-- Code For temporary table tmp_20180508183626_codegen_usjrnn_xgb_sum part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180508183626_codegen_usjrnn_xgb_sum (
	"KEY" BIGINT, 
	"Estimator" DOUBLE
)
...
-- Code For temporary table tmp_20180508183626_codegen_usjrnn_xgb_sum part 2. Populate

INSERT INTO tmp_20180508183626_codegen_usjrnn_xgb_sum SELECT "XGB_sum"."KEY", "XGB_sum"."Estimator" 
...
FROM tmp_20180508183626_codegen_om1jus_xgb_union AS "XGB_Union" GROUP BY "XGB_Union"."KEY") AS "T") AS "XGB_sum"

-- Model deployment code

SELECT "XGB_sum"."KEY" AS "KEY", "XGB_sum"."Estimator" + 0.5 AS "Estimator" 
FROM tmp_20180508183626_codegen_usjrnn_xgb_sum AS "XGB_sum"