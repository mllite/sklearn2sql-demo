...
-- Code For temporary table TMP_20180602_M7D_ADS_IMP_1_OUT part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180602_M7D_ADS_IMP_1_OUT" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20180602_M7D_ADS_IMP_1_OUT part 2. Populate

INSERT INTO "TMP_20180602_M7D_ADS_IMP_1_OUT" ("KEY", impter_2, impter_3, impter_4, impter_5, impter_6, impter_7, impter_8, impter_9, impter_10, impter_11) SELECT "U"."KEY", "U".impter_2, "U".impter_3, "U".impter_4, "U".impter_5, "U".impter_6, "U".impter_7, "U".impter_8, "U".impter_9, "U".impter_10, "U".impter_11 
...
-- Code For temporary table TMP_20180602_M7D_ADS_IMP_1_OUT part 3. Create Index 

CREATE INDEX "ix_TMP_20180602_M7D_ADS_c85f" ON "TMP_20180602_M7D_ADS_IMP_1_OUT" ("KEY")

-- Code For temporary table TMP_20180602_QCE_ADS_SCA_2_OUT part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180602_QCE_ADS_SCA_2_OUT" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20180602_QCE_ADS_SCA_2_OUT part 2. Populate

INSERT INTO "TMP_20180602_QCE_ADS_SCA_2_OUT" ("KEY", scaler_2, scaler_3, scaler_4, scaler_5, scaler_6, scaler_7, scaler_8, scaler_9, scaler_10, scaler_11) SELECT "U"."KEY", "U".scaler_2, "U".scaler_3, "U".scaler_4, "U".scaler_5, "U".scaler_6, "U".scaler_7, "U".scaler_8, "U".scaler_9, "U".scaler_10, "U".scaler_11 
...
FROM "TMP_20180602_M7D_ADS_IMP_1_OUT" AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT") AS "U"

-- Code For temporary table TMP_20180602_QCE_ADS_SCA_2_OUT part 3. Create Index 

CREATE INDEX "ix_TMP_20180602_QCE_ADS_aea5" ON "TMP_20180602_QCE_ADS_SCA_2_OUT" ("KEY")

-- Code For temporary table TMP_20180602_Z9Z_XGB_B0 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180602_Z9Z_XGB_B0" (
	"KEY" BIGINT, 
...
-- Code For temporary table TMP_20180602_Z9Z_XGB_B0 part 2. Populate

INSERT INTO "TMP_20180602_Z9Z_XGB_B0" ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
FROM "TMP_20180602_QCE_ADS_SCA_2_OUT" AS "ADS_sca_2_OUT"), 
"DT_node_data" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Estimator" AS DOUBLE PRECISION) AS "Estimator" 
FROM (SELECT 2 AS nid, 1.7346981763839722 AS "Estimator" FROM rdb$database UNION ALL SELECT 3 AS nid, 0.7246237993240356 AS "Estimator" FROM rdb$database UNION ALL SELECT 4 AS nid, 1.2854242324829102 AS "Estimator" FROM rdb$database) AS "Values"), 
"DT_Output" AS 
...
"DT_node_data_1" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Estimator" AS DOUBLE PRECISION) AS "Estimator" 
FROM (SELECT 1 AS nid, 0.8841015100479126 AS "Estimator" FROM rdb$database UNION ALL SELECT 3 AS nid, 0.9877474904060364 AS "Estimator" FROM rdb$database UNION ALL SELECT 4 AS nid, 1.6178016662597656 AS "Estimator" FROM rdb$database) AS "Values"), 
"DT_Output_1" AS 
...
"DT_node_data_2" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Estimator" AS DOUBLE PRECISION) AS "Estimator" 
FROM (SELECT 3 AS nid, 0.5728387236595154 AS "Estimator" FROM rdb$database UNION ALL SELECT 4 AS nid, 1.0455927848815918 AS "Estimator" FROM rdb$database UNION ALL SELECT 5 AS nid, 1.0199894905090332 AS "Estimator" FROM rdb$database UNION ALL SELECT 6 AS nid, 1.5323306322097778 AS "Estimator" FROM rdb$database) AS "Values"), 
"DT_Output_2" AS 
...
"DT_node_data_3" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Estimator" AS DOUBLE PRECISION) AS "Estimator" 
FROM (SELECT 3 AS nid, 0.5853623151779175 AS "Estimator" FROM rdb$database UNION ALL SELECT 4 AS nid, 1.0090750455856323 AS "Estimator" FROM rdb$database UNION ALL SELECT 5 AS nid, 0.8120507597923279 AS "Estimator" FROM rdb$database UNION ALL SELECT 6 AS nid, 1.3750017881393433 AS "Estimator" FROM rdb$database) AS "Values"), 
"DT_Output_3" AS 
...
"DT_node_data_4" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Estimator" AS DOUBLE PRECISION) AS "Estimator" 
FROM (SELECT 4 AS nid, 0.9971041679382324 AS "Estimator" FROM rdb$database UNION ALL SELECT 5 AS nid, 0.8192136883735657 AS "Estimator" FROM rdb$database UNION ALL SELECT 6 AS nid, 1.2618716955184937 AS "Estimator" FROM rdb$database UNION ALL SELECT 7 AS nid, 0.38835859298706055 AS "Estimator" FROM rdb$database UNION ALL SELECT 8 AS nid, 0.7371280789375305 AS "Estimator" FROM rdb$database) AS "Values"), 
"DT_Output_4" AS 
...
-- Code For temporary table TMP_20180602_LBK_XGB_B1 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180602_LBK_XGB_B1" (
	"KEY" BIGINT, 
	"Estimator" DOUBLE PRECISION
)
...
-- Code For temporary table TMP_20180602_LBK_XGB_B1 part 2. Populate

INSERT INTO "TMP_20180602_LBK_XGB_B1" ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
"DT_node_data_5" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Estimator" AS DOUBLE PRECISION) AS "Estimator" 
FROM (SELECT 3 AS nid, 0.4594433903694153 AS "Estimator" FROM rdb$database UNION ALL SELECT 4 AS nid, 0.7925733923912048 AS "Estimator" FROM rdb$database UNION ALL SELECT 5 AS nid, 0.6406915783882141 AS "Estimator" FROM rdb$database UNION ALL SELECT 6 AS nid, 1.1351743936538696 AS "Estimator" FROM rdb$database) AS "Values"), 
"DT_Output_5" AS 
...
"DT_node_data_6" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Estimator" AS DOUBLE PRECISION) AS "Estimator" 
FROM (SELECT 4 AS nid, 0.7740703225135803 AS "Estimator" FROM rdb$database UNION ALL SELECT 5 AS nid, 0.5934602618217468 AS "Estimator" FROM rdb$database UNION ALL SELECT 6 AS nid, 1.0693920850753784 AS "Estimator" FROM rdb$database UNION ALL SELECT 7 AS nid, 0.31571075320243835 AS "Estimator" FROM rdb$database UNION ALL SELECT 8 AS nid, 0.5366585850715637 AS "Estimator" FROM rdb$database) AS "Values"), 
"DT_Output_6" AS 
...
"DT_node_data_7" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Estimator" AS DOUBLE PRECISION) AS "Estimator" 
FROM (SELECT 4 AS nid, 0.7578622698783875 AS "Estimator" FROM rdb$database UNION ALL SELECT 5 AS nid, 0.5825784206390381 AS "Estimator" FROM rdb$database UNION ALL SELECT 6 AS nid, 0.9448731541633606 AS "Estimator" FROM rdb$database UNION ALL SELECT 7 AS nid, 0.24906635284423828 AS "Estimator" FROM rdb$database UNION ALL SELECT 8 AS nid, 0.49070701003074646 AS "Estimator" FROM rdb$database) AS "Values"), 
"DT_Output_7" AS 
...
"DT_node_data_8" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Estimator" AS DOUBLE PRECISION) AS "Estimator" 
FROM (SELECT 3 AS nid, 0.27396664023399353 AS "Estimator" FROM rdb$database UNION ALL SELECT 4 AS nid, 0.5175621509552002 AS "Estimator" FROM rdb$database UNION ALL SELECT 5 AS nid, 0.38917142152786255 AS "Estimator" FROM rdb$database UNION ALL SELECT 7 AS nid, 0.6444721221923828 AS "Estimator" FROM rdb$database UNION ALL SELECT 8 AS nid, 0.9190694093704224 AS "Estimator" FROM rdb$database) AS "Values"), 
"DT_Output_8" AS 
...
"DT_node_data_9" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Estimator" AS DOUBLE PRECISION) AS "Estimator" 
FROM (SELECT 4 AS nid, 0.651627779006958 AS "Estimator" FROM rdb$database UNION ALL SELECT 5 AS nid, 0.4800221621990204 AS "Estimator" FROM rdb$database UNION ALL SELECT 6 AS nid, 0.7893773913383484 AS "Estimator" FROM rdb$database UNION ALL SELECT 7 AS nid, 0.20325541496276855 AS "Estimator" FROM rdb$database UNION ALL SELECT 8 AS nid, 0.434192419052124 AS "Estimator" FROM rdb$database) AS "Values"), 
"DT_Output_9" AS 
...
-- Code For temporary table TMP_20180602_MTR_XGB_B2 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180602_MTR_XGB_B2" (
	"KEY" BIGINT, 
	"Estimator" DOUBLE PRECISION
)
...
-- Code For temporary table TMP_20180602_MTR_XGB_B2 part 2. Populate

INSERT INTO "TMP_20180602_MTR_XGB_B2" ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
"DT_node_data_10" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Estimator" AS DOUBLE PRECISION) AS "Estimator" 
FROM (SELECT 4 AS nid, 0.5818823575973511 AS "Estimator" FROM rdb$database UNION ALL SELECT 5 AS nid, 0.39021584391593933 AS "Estimator" FROM rdb$database UNION ALL SELECT 6 AS nid, 0.7339689135551453 AS "Estimator" FROM rdb$database UNION ALL SELECT 7 AS nid, 0.16256581246852875 AS "Estimator" FROM rdb$database UNION ALL SELECT 8 AS nid, 0.3969610929489136 AS "Estimator" FROM rdb$database) AS "Values"), 
"DT_Output_10" AS 
...
"DT_node_data_11" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Estimator" AS DOUBLE PRECISION) AS "Estimator" 
FROM (SELECT 2 AS nid, 0.6802745461463928 AS "Estimator" FROM rdb$database UNION ALL SELECT 3 AS nid, 0.16090121865272522 AS "Estimator" FROM rdb$database UNION ALL SELECT 5 AS nid, 0.32339319586753845 AS "Estimator" FROM rdb$database UNION ALL SELECT 6 AS nid, 0.5403069257736206 AS "Estimator" FROM rdb$database) AS "Values"), 
"DT_Output_11" AS 
...
"DT_node_data_12" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Estimator" AS DOUBLE PRECISION) AS "Estimator" 
FROM (SELECT 3 AS nid, 0.15629492700099945 AS "Estimator" FROM rdb$database UNION ALL SELECT 4 AS nid, 0.32957178354263306 AS "Estimator" FROM rdb$database UNION ALL SELECT 5 AS nid, 0.2805353105068207 AS "Estimator" FROM rdb$database UNION ALL SELECT 7 AS nid, 0.47836312651634216 AS "Estimator" FROM rdb$database UNION ALL SELECT 8 AS nid, 0.7044827342033386 AS "Estimator" FROM rdb$database) AS "Values"), 
"DT_Output_12" AS 
...
"DT_node_data_13" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Estimator" AS DOUBLE PRECISION) AS "Estimator" 
FROM (SELECT 1 AS nid, 0.2060031145811081 AS "Estimator" FROM rdb$database UNION ALL SELECT 5 AS nid, 0.16673491895198822 AS "Estimator" FROM rdb$database UNION ALL SELECT 6 AS nid, 0.36741912364959717 AS "Estimator" FROM rdb$database UNION ALL SELECT 7 AS nid, 0.4518183171749115 AS "Estimator" FROM rdb$database UNION ALL SELECT 8 AS nid, 0.6593319773674011 AS "Estimator" FROM rdb$database) AS "Values"), 
"DT_Output_13" AS 
...
"DT_node_data_14" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Estimator" AS DOUBLE PRECISION) AS "Estimator" 
FROM (SELECT 2 AS nid, 0.49411293864250183 AS "Estimator" FROM rdb$database UNION ALL SELECT 3 AS nid, 0.09668485075235367 AS "Estimator" FROM rdb$database UNION ALL SELECT 5 AS nid, 0.28059008717536926 AS "Estimator" FROM rdb$database UNION ALL SELECT 6 AS nid, 0.47315284609794617 AS "Estimator" FROM rdb$database) AS "Values"), 
"DT_Output_14" AS 
...
-- Code For temporary table TMP_20180602_6Q2_XGB_B3 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180602_6Q2_XGB_B3" (
	"KEY" BIGINT, 
	"Estimator" DOUBLE PRECISION
)
...
-- Code For temporary table TMP_20180602_6Q2_XGB_B3 part 2. Populate

INSERT INTO "TMP_20180602_6Q2_XGB_B3" ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
"DT_node_data_15" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Estimator" AS DOUBLE PRECISION) AS "Estimator" 
FROM (SELECT 2 AS nid, 0.486659437417984 AS "Estimator" FROM rdb$database UNION ALL SELECT 4 AS nid, 0.46058622002601624 AS "Estimator" FROM rdb$database UNION ALL SELECT 5 AS nid, 0.07151826471090317 AS "Estimator" FROM rdb$database UNION ALL SELECT 6 AS nid, 0.2683967053890228 AS "Estimator" FROM rdb$database) AS "Values"), 
"DT_Output_15" AS 
...
-- Code For temporary table TMP_20180602_2B5_XGB_SUM part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180602_2B5_XGB_SUM" (
	"KEY" BIGINT NOT NULL, 
	"Estimator" DOUBLE PRECISION, 
	PRIMARY KEY ("KEY")
)
...
-- Code For temporary table TMP_20180602_2B5_XGB_SUM part 2. Populate

INSERT INTO "TMP_20180602_2B5_XGB_SUM" ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
FROM "TMP_20180602_Z9Z_XGB_B0" AS "XGB_B0" UNION ALL SELECT "XGB_B1"."KEY" AS "KEY", "XGB_B1"."Estimator" AS "Estimator" 
FROM "TMP_20180602_LBK_XGB_B1" AS "XGB_B1" UNION ALL SELECT "XGB_B2"."KEY" AS "KEY", "XGB_B2"."Estimator" AS "Estimator" 
FROM "TMP_20180602_MTR_XGB_B2" AS "XGB_B2" UNION ALL SELECT "XGB_B3"."KEY" AS "KEY", "XGB_B3"."Estimator" AS "Estimator" 
FROM "TMP_20180602_6Q2_XGB_B3" AS "XGB_B3") AS "XGB_EnsembleUnion")
...
-- Code For temporary table TMP_20180602_2B5_XGB_SUM part 3. Create Index 

CREATE INDEX "ix_TMP_20180602_2B5_XGB_SUM_KEY" ON "TMP_20180602_2B5_XGB_SUM" ("KEY")

-- Model deployment code

SELECT "XGB_sum"."KEY" AS "KEY", "XGB_sum"."Estimator" + 0.5 AS "Estimator" 
FROM "TMP_20180602_2B5_XGB_SUM" AS "XGB_sum"