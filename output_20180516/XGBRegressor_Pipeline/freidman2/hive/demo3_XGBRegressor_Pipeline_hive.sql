...
-- Code For temporary table tmp_20180509004240_codegen_35dl43_ads_imp_1_out part 1. Create 

CREATE TEMPORARY TABLE `tmp_20180509004240_codegen_35dl43_ads_imp_1_out` STORED AS ORC AS SELECT `ADS_imp_1_OUT`.`KEY`, `ADS_imp_1_OUT`.`imputer_output_2`, `ADS_imp_1_OUT`.`imputer_output_3`, `ADS_imp_1_OUT`.`imputer_output_4`, `ADS_imp_1_OUT`.`imputer_output_5` 
...
-- Code For temporary table tmp_20180509004240_codegen_35dl43_ads_imp_1_out part 2. Populate

SELECT * FROM `tmp_20180509004240_codegen_35dl43_ads_imp_1_out`

-- Code For temporary table tmp_20180509004240_codegen_ywb90v_ads_sca_2_out part 1. Create 

CREATE TEMPORARY TABLE `tmp_20180509004240_codegen_ywb90v_ads_sca_2_out` STORED AS ORC AS SELECT `ADS_sca_2_OUT`.`KEY`, `ADS_sca_2_OUT`.`scaler_output_2`, `ADS_sca_2_OUT`.`scaler_output_3`, `ADS_sca_2_OUT`.`scaler_output_4`, `ADS_sca_2_OUT`.`scaler_output_5` 
...
FROM `tmp_20180509004240_codegen_35dl43_ads_imp_1_out` AS `ADS_imp_1_OUT`) AS `ADS_sca_2_OUT`

-- Code For temporary table tmp_20180509004240_codegen_ywb90v_ads_sca_2_out part 2. Populate

SELECT * FROM `tmp_20180509004240_codegen_ywb90v_ads_sca_2_out`

-- Code For temporary table tmp_20180509004241_codegen_98jpa9_xgb_b0 part 1. Create 

CREATE TEMPORARY TABLE `tmp_20180509004241_codegen_98jpa9_xgb_b0` STORED AS ORC AS WITH `DT_node_lookup` AS 
...
FROM `tmp_20180509004240_codegen_ywb90v_ads_sca_2_out` AS `ADS_sca_2_OUT`), 
`DT_node_data` AS 
...
-- Code For temporary table tmp_20180509004241_codegen_98jpa9_xgb_b0 part 2. Populate

SELECT * FROM `tmp_20180509004241_codegen_98jpa9_xgb_b0`

-- Code For temporary table tmp_20180509004241_codegen_9jzfpp_xgb_b1 part 1. Create 

CREATE TEMPORARY TABLE `tmp_20180509004241_codegen_9jzfpp_xgb_b1` STORED AS ORC AS WITH `DT_node_lookup_10` AS 
(SELECT `ADS_sca_2_OUT`.`KEY` AS `KEY`, CASE WHEN (`ADS_sca_2_OUT`.`scaler_output_4` < 0.8996042013168335) THEN CASE WHEN (`ADS_sca_2_OUT`.`scaler_output_3` < -0.349178671836853) THEN CASE WHEN (`ADS_sca_2_OUT`.`scaler_output_3` < -1.0177714824676514) THEN 5 ELSE 6 END ELSE CASE WHEN (`ADS_sca_2_OUT`.`scaler_output_4` < -0.8362234830856323) THEN 7 ELSE 8 END END ELSE 2 END AS `node_id_2` 
FROM `tmp_20180509004240_codegen_ywb90v_ads_sca_2_out` AS `ADS_sca_2_OUT`), 
`DT_node_data_10` AS 
(SELECT `Values`.`nid` AS `nid`, CAST(`Values`.`Estimator` AS DOUBLE) AS `Estimator` 
...
-- Code For temporary table tmp_20180509004241_codegen_9jzfpp_xgb_b1 part 2. Populate

SELECT * FROM `tmp_20180509004241_codegen_9jzfpp_xgb_b1`

-- Code For temporary table tmp_20180509004241_codegen_o6epwf_xgb_union part 1. Create 

CREATE TEMPORARY TABLE `tmp_20180509004241_codegen_o6epwf_xgb_union` STORED AS ORC AS SELECT `XGB_Union`.`KEY`, `XGB_Union`.`Estimator` 
...
FROM `tmp_20180509004241_codegen_98jpa9_xgb_b0` AS `XGB_B0` UNION ALL SELECT `XGB_B1`.`KEY` AS `KEY`, `XGB_B1`.`Estimator` AS `Estimator` 
FROM `tmp_20180509004241_codegen_9jzfpp_xgb_b1` AS `XGB_B1`) AS `XGB_EnsembleUnion`) AS `XGB_Union`

-- Code For temporary table tmp_20180509004241_codegen_o6epwf_xgb_union part 2. Populate

SELECT * FROM `tmp_20180509004241_codegen_o6epwf_xgb_union`

-- Code For temporary table tmp_20180509004241_codegen_8jzfe2_xgb_sum part 1. Create 

CREATE TEMPORARY TABLE `tmp_20180509004241_codegen_8jzfe2_xgb_sum` STORED AS ORC AS SELECT `XGB_sum`.`KEY`, `XGB_sum`.`Estimator` 
...
FROM `tmp_20180509004241_codegen_o6epwf_xgb_union` AS `XGB_Union` GROUP BY `XGB_Union`.`KEY`) AS `T`) AS `XGB_sum`

-- Code For temporary table tmp_20180509004241_codegen_8jzfe2_xgb_sum part 2. Populate

SELECT * FROM `tmp_20180509004241_codegen_8jzfe2_xgb_sum`

-- Model deployment code

SELECT `XGB_sum`.`KEY` AS `KEY`, `XGB_sum`.`Estimator` + 0.5 AS `Estimator` 
FROM `tmp_20180509004241_codegen_8jzfe2_xgb_sum` AS `XGB_sum`