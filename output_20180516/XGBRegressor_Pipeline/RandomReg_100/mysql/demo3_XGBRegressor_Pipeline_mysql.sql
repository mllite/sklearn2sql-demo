...
-- Code For temporary table TMP_20180508182843_CODEGEN_UYWMB6_ADS_imp_1_OUT part 1. Create 


CREATE TEMPORARY TABLE `TMP_20180508182843_CODEGEN_UYWMB6_ADS_imp_1_OUT` (
	`KEY` BIGINT NOT NULL, 
	impter_2 DOUBLE, 
	impter_3 DOUBLE, 
	impter_4 DOUBLE, 
...
-- Code For temporary table TMP_20180508182843_CODEGEN_UYWMB6_ADS_imp_1_OUT part 3. Create Index 

CREATE INDEX `ix_TMP_20180508182843_CODEGEN_UYWMB6_ADS_imp_1_OUT_KEY` ON `TMP_20180508182843_CODEGEN_UYWMB6_ADS_imp_1_OUT` (`KEY`)

-- Code For temporary table TMP_20180508182843_CODEGEN_WVRGZY_ADS_sca_2_OUT part 1. Create 


CREATE TEMPORARY TABLE `TMP_20180508182843_CODEGEN_WVRGZY_ADS_sca_2_OUT` (
	`KEY` BIGINT NOT NULL, 
	scaler_2 DOUBLE, 
	scaler_3 DOUBLE, 
	scaler_4 DOUBLE, 
...
FROM `TMP_20180508182843_CODEGEN_UYWMB6_ADS_imp_1_OUT` AS `ADS_imp_1_OUT`) AS `ADS_sca_2_OUT`) AS `U`

-- Code For temporary table TMP_20180508182843_CODEGEN_WVRGZY_ADS_sca_2_OUT part 3. Create Index 

CREATE INDEX `ix_TMP_20180508182843_CODEGEN_WVRGZY_ADS_sca_2_OUT_KEY` ON `TMP_20180508182843_CODEGEN_WVRGZY_ADS_sca_2_OUT` (`KEY`)

-- Code For temporary table TMP_20180508182843_CODEGEN_3FCJJF_XGB_B0 part 1. Create 


CREATE TEMPORARY TABLE `TMP_20180508182843_CODEGEN_3FCJJF_XGB_B0` (
	`KEY` BIGINT, 
	`Estimator` DOUBLE
)
...
-- Code For temporary table TMP_20180508182843_CODEGEN_3FCJJF_XGB_B0 part 2. Populate

INSERT INTO `TMP_20180508182843_CODEGEN_3FCJJF_XGB_B0` (`KEY`, `Estimator`) SELECT `U`.`KEY`, `U`.`Estimator` 
...
FROM `TMP_20180508182843_CODEGEN_WVRGZY_ADS_sca_2_OUT` AS `ADS_sca_2_OUT`), 
`DT_node_data` AS 
...
-- Code For temporary table TMP_20180508182843_CODEGEN_HPNJX3_XGB_B1 part 1. Create 


CREATE TEMPORARY TABLE `TMP_20180508182843_CODEGEN_HPNJX3_XGB_B1` (
	`KEY` BIGINT, 
	`Estimator` DOUBLE
)
...
-- Code For temporary table TMP_20180508182843_CODEGEN_HPNJX3_XGB_B1 part 2. Populate

INSERT INTO `TMP_20180508182843_CODEGEN_HPNJX3_XGB_B1` (`KEY`, `Estimator`) SELECT `U`.`KEY`, `U`.`Estimator` 
...
-- Code For temporary table TMP_20180508182843_CODEGEN_ZDQZHU_XGB_Union part 1. Create 


CREATE TEMPORARY TABLE `TMP_20180508182843_CODEGEN_ZDQZHU_XGB_Union` (
	`KEY` BIGINT, 
	`Estimator` DOUBLE
)
...
-- Code For temporary table TMP_20180508182843_CODEGEN_ZDQZHU_XGB_Union part 2. Populate

INSERT INTO `TMP_20180508182843_CODEGEN_ZDQZHU_XGB_Union` (`KEY`, `Estimator`) SELECT `U`.`KEY`, `U`.`Estimator` 
...
FROM `TMP_20180508182843_CODEGEN_3FCJJF_XGB_B0` AS `XGB_B0` UNION ALL SELECT `XGB_B1`.`KEY` AS `KEY`, `XGB_B1`.`Estimator` AS `Estimator` 
FROM `TMP_20180508182843_CODEGEN_HPNJX3_XGB_B1` AS `XGB_B1`) AS `XGB_EnsembleUnion`) AS `XGB_Union`) AS `U`

-- Code For temporary table TMP_20180508182843_CODEGEN_THQEYU_XGB_sum part 1. Create 


CREATE TEMPORARY TABLE `TMP_20180508182843_CODEGEN_THQEYU_XGB_sum` (
	`KEY` BIGINT NOT NULL, 
	`Estimator` DOUBLE, 
	PRIMARY KEY (`KEY`)
)
...
-- Code For temporary table TMP_20180508182843_CODEGEN_THQEYU_XGB_sum part 2. Populate

INSERT INTO `TMP_20180508182843_CODEGEN_THQEYU_XGB_sum` (`KEY`, `Estimator`) SELECT `U`.`KEY`, `U`.`Estimator` 
...
FROM `TMP_20180508182843_CODEGEN_ZDQZHU_XGB_Union` AS `XGB_Union` GROUP BY `XGB_Union`.`KEY`) AS `T`) AS `XGB_sum`) AS `U`

-- Code For temporary table TMP_20180508182843_CODEGEN_THQEYU_XGB_sum part 3. Create Index 

CREATE INDEX `ix_TMP_20180508182843_CODEGEN_THQEYU_XGB_sum_KEY` ON `TMP_20180508182843_CODEGEN_THQEYU_XGB_sum` (`KEY`)

-- Model deployment code

SELECT `XGB_sum`.`KEY` AS `KEY`, `XGB_sum`.`Estimator` + 0.5 AS `Estimator` 
FROM `TMP_20180508182843_CODEGEN_THQEYU_XGB_sum` AS `XGB_sum`