...
-- Code For temporary table TMP_20180516_CODEGEN_VG5JE3_ADS part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180516_CODEGEN_VG5JE3_ADS" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20180516_CODEGEN_VG5JE3_ADS part 3. Create Index 

CREATE INDEX "ix_TMP_20180516_CODEGEN_8f83" ON "TMP_20180516_CODEGEN_VG5JE3_ADS" ("KEY")

-- Code For temporary table TMP_20180516_CODEGEN_TXZUJI_ADS part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180516_CODEGEN_TXZUJI_ADS" (
	"KEY" BIGINT NOT NULL, 
...
FROM "TMP_20180516_CODEGEN_VG5JE3_ADS" AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT") AS "U"

-- Code For temporary table TMP_20180516_CODEGEN_TXZUJI_ADS part 3. Create Index 

CREATE INDEX "ix_TMP_20180516_CODEGEN_2914" ON "TMP_20180516_CODEGEN_TXZUJI_ADS" ("KEY")

-- Code For temporary table TMP_20180516_CODEGEN_ZYW8IR_XGB part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180516_CODEGEN_ZYW8IR_XGB" (
	"KEY" BIGINT, 
...
-- Code For temporary table TMP_20180516_CODEGEN_ZYW8IR_XGB part 2. Populate

INSERT INTO "TMP_20180516_CODEGEN_ZYW8IR_XGB" ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
FROM "TMP_20180516_CODEGEN_TXZUJI_ADS" AS "ADS_sca_2_OUT"), 
"DT_node_data" AS 
...
-- Code For temporary table TMP_20180516_CODEGEN_JGB1TR_XGB part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180516_CODEGEN_JGB1TR_XGB" (
	"KEY" BIGINT, 
	"Estimator" DOUBLE PRECISION
)
...
-- Code For temporary table TMP_20180516_CODEGEN_JGB1TR_XGB part 2. Populate

INSERT INTO "TMP_20180516_CODEGEN_JGB1TR_XGB" ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
-- Code For temporary table TMP_20180516_CODEGEN_43HUEL_XGB part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180516_CODEGEN_43HUEL_XGB" (
	"KEY" BIGINT NOT NULL, 
	"Estimator" DOUBLE PRECISION, 
	PRIMARY KEY ("KEY")
)
...
-- Code For temporary table TMP_20180516_CODEGEN_43HUEL_XGB part 2. Populate

INSERT INTO "TMP_20180516_CODEGEN_43HUEL_XGB" ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
FROM "TMP_20180516_CODEGEN_ZYW8IR_XGB" AS "XGB_B0" UNION ALL SELECT "XGB_B1"."KEY" AS "KEY", "XGB_B1"."Estimator" AS "Estimator" 
FROM "TMP_20180516_CODEGEN_JGB1TR_XGB" AS "XGB_B1") AS "XGB_EnsembleUnion")
...
-- Code For temporary table TMP_20180516_CODEGEN_43HUEL_XGB part 3. Create Index 

CREATE INDEX "ix_TMP_20180516_CODEGEN_32d2" ON "TMP_20180516_CODEGEN_43HUEL_XGB" ("KEY")

-- Model deployment code

SELECT "XGB_sum"."KEY" AS "KEY", "XGB_sum"."Estimator" + 0.5 AS "Estimator" 
FROM "TMP_20180516_CODEGEN_43HUEL_XGB" AS "XGB_sum"