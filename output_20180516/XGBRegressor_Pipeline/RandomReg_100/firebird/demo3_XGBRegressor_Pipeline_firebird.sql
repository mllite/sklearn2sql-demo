...
-- Code For temporary table TMP_20180508182844_CODEGEN_MJ0V part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508182844_CODEGEN_MJ0V" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20180508182844_CODEGEN_MJ0V part 3. Create Index 

CREATE INDEX "ix_TMP_20180508182844_C_6837" ON "TMP_20180508182844_CODEGEN_MJ0V" ("KEY")

-- Code For temporary table TMP_20180508182844_CODEGEN_PL3E part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508182844_CODEGEN_PL3E" (
	"KEY" BIGINT NOT NULL, 
...
FROM "TMP_20180508182844_CODEGEN_MJ0V" AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT") AS "U"

-- Code For temporary table TMP_20180508182844_CODEGEN_PL3E part 3. Create Index 

CREATE INDEX "ix_TMP_20180508182844_C_3338" ON "TMP_20180508182844_CODEGEN_PL3E" ("KEY")

-- Code For temporary table TMP_20180508182844_CODEGEN_N11J part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508182844_CODEGEN_N11J" (
	"KEY" BIGINT, 
...
-- Code For temporary table TMP_20180508182844_CODEGEN_N11J part 2. Populate

INSERT INTO "TMP_20180508182844_CODEGEN_N11J" ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
FROM "TMP_20180508182844_CODEGEN_PL3E" AS "ADS_sca_2_OUT"), 
"DT_node_data" AS 
...
-- Code For temporary table TMP_20180508182844_CODEGEN_DZJ5 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508182844_CODEGEN_DZJ5" (
	"KEY" BIGINT, 
	"Estimator" DOUBLE PRECISION
)
...
-- Code For temporary table TMP_20180508182844_CODEGEN_DZJ5 part 2. Populate

INSERT INTO "TMP_20180508182844_CODEGEN_DZJ5" ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
-- Code For temporary table TMP_20180508182844_CODEGEN_AWMT part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508182844_CODEGEN_AWMT" (
	"KEY" BIGINT, 
	"Estimator" DOUBLE PRECISION
)
...
-- Code For temporary table TMP_20180508182844_CODEGEN_AWMT part 2. Populate

INSERT INTO "TMP_20180508182844_CODEGEN_AWMT" ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
FROM "TMP_20180508182844_CODEGEN_N11J" AS "XGB_B0" UNION ALL SELECT "XGB_B1"."KEY" AS "KEY", "XGB_B1"."Estimator" AS "Estimator" 
FROM "TMP_20180508182844_CODEGEN_DZJ5" AS "XGB_B1") AS "XGB_EnsembleUnion") AS "XGB_Union") AS "U"

-- Code For temporary table TMP_20180508182844_CODEGEN_VXG3 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508182844_CODEGEN_VXG3" (
	"KEY" BIGINT NOT NULL, 
	"Estimator" DOUBLE PRECISION, 
	PRIMARY KEY ("KEY")
)
...
-- Code For temporary table TMP_20180508182844_CODEGEN_VXG3 part 2. Populate

INSERT INTO "TMP_20180508182844_CODEGEN_VXG3" ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
FROM "TMP_20180508182844_CODEGEN_AWMT" AS "XGB_Union" GROUP BY "XGB_Union"."KEY") AS "T") AS "XGB_sum") AS "U"

-- Code For temporary table TMP_20180508182844_CODEGEN_VXG3 part 3. Create Index 

CREATE INDEX "ix_TMP_20180508182844_C_aeec" ON "TMP_20180508182844_CODEGEN_VXG3" ("KEY")

-- Model deployment code

SELECT "XGB_sum"."KEY" AS "KEY", "XGB_sum"."Estimator" + 0.5 AS "Estimator" 
FROM "TMP_20180508182844_CODEGEN_VXG3" AS "XGB_sum"