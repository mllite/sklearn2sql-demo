...
-- Code For temporary table tmp_20180516114558_codegen_qzfqx8_ads_imp_1_out part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180516114558_codegen_qzfqx8_ads_imp_1_out  (
	"KEY" BIGINT, 
...
-- Code For temporary table tmp_20180516114558_codegen_iwfzjg_ads_sca_2_out part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180516114558_codegen_iwfzjg_ads_sca_2_out  (
	"KEY" BIGINT, 
...
FROM tmp_20180516114558_codegen_qzfqx8_ads_imp_1_out AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT") AS "U"

-- Code For temporary table tmp_20180516114558_codegen_v36rfj_xgb_b0 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180516114558_codegen_v36rfj_xgb_b0  (
	"KEY" BIGINT, 
...
-- Code For temporary table tmp_20180516114558_codegen_v36rfj_xgb_b0 part 2. Populate

INSERT INTO tmp_20180516114558_codegen_v36rfj_xgb_b0 ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
FROM tmp_20180516114558_codegen_iwfzjg_ads_sca_2_out AS "ADS_sca_2_OUT"), 
dummy_cte AS 
...
-- Code For temporary table tmp_20180516114558_codegen_bv8thm_xgb_b1 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180516114558_codegen_bv8thm_xgb_b1  (
	"KEY" BIGINT, 
	"Estimator" DOUBLE PRECISION
)
...
-- Code For temporary table tmp_20180516114558_codegen_bv8thm_xgb_b1 part 2. Populate

INSERT INTO tmp_20180516114558_codegen_bv8thm_xgb_b1 ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
-- Code For temporary table tmp_20180516114558_codegen_562hdw_xgb_sum part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180516114558_codegen_562hdw_xgb_sum  (
	"KEY" BIGINT, 
	"Estimator" DOUBLE PRECISION
)
...
-- Code For temporary table tmp_20180516114558_codegen_562hdw_xgb_sum part 2. Populate

INSERT INTO tmp_20180516114558_codegen_562hdw_xgb_sum ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
FROM tmp_20180516114558_codegen_v36rfj_xgb_b0 AS "XGB_B0" UNION ALL SELECT "XGB_B1"."KEY" AS "KEY", "XGB_B1"."Estimator" AS "Estimator" 
FROM tmp_20180516114558_codegen_bv8thm_xgb_b1 AS "XGB_B1") AS "XGB_EnsembleUnion")
...
FROM tmp_20180516114558_codegen_562hdw_xgb_sum AS "XGB_sum"