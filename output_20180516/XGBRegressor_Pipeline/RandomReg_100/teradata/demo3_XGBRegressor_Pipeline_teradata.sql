...
-- Code For temporary table tmp_20180508182844_codegen_0t4j7i_ads_imp_1_out part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180508182844_codegen_0t4j7i_ads_imp_1_out  (
	"KEY" BIGINT, 
...
-- Code For temporary table tmp_20180508182844_codegen_tlr4lp_ads_sca_2_out part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180508182844_codegen_tlr4lp_ads_sca_2_out  (
	"KEY" BIGINT, 
...
FROM tmp_20180508182844_codegen_0t4j7i_ads_imp_1_out AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT") AS "U"

-- Code For temporary table tmp_20180508182844_codegen_t4w309_xgb_b0 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180508182844_codegen_t4w309_xgb_b0  (
	"KEY" BIGINT, 
...
-- Code For temporary table tmp_20180508182844_codegen_t4w309_xgb_b0 part 2. Populate

INSERT INTO tmp_20180508182844_codegen_t4w309_xgb_b0 ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
FROM tmp_20180508182844_codegen_tlr4lp_ads_sca_2_out AS "ADS_sca_2_OUT"), 
dummy_cte AS 
...
FROM "DT_Output_7"), 
"DT_node_lookup_8" AS 
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", CASE WHEN ("ADS_sca_2_OUT".scaler_82 < CAST(-0.070550031960011 AS DOUBLE PRECISION)) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_65 < CAST(-0.020848263055086 AS DOUBLE PRECISION)) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_73 < CAST(-0.131930738687515 AS DOUBLE PRECISION)) THEN 7 ELSE 8 END ELSE 4 END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_61 < CAST(-0.090432152152061 AS DOUBLE PRECISION)) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_39 < CAST(0.161500334739685 AS DOUBLE PRECISION)) THEN 9 ELSE 10 END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_44 < CAST(0.516301512718201 AS DOUBLE PRECISION)) THEN 11 ELSE 12 END END END AS node_id_2 
FROM tmp_20180508182844_codegen_tlr4lp_ads_sca_2_out AS "ADS_sca_2_OUT"), 
"DT_node_data_8" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Estimator" AS DOUBLE PRECISION) AS "Estimator" 
...
FROM "DT_Output_8"), 
"DT_node_lookup_9" AS 
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", CASE WHEN ("ADS_sca_2_OUT".scaler_43 < CAST(-0.44576358795166 AS DOUBLE PRECISION)) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_82 < CAST(0.079840056598186 AS DOUBLE PRECISION)) THEN 3 ELSE 4 END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_94 < CAST(-0.881576538085938 AS DOUBLE PRECISION)) THEN 5 ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_11 < CAST(0.451461136341095 AS DOUBLE PRECISION)) THEN 7 ELSE 8 END END END AS node_id_2 
FROM tmp_20180508182844_codegen_tlr4lp_ads_sca_2_out AS "ADS_sca_2_OUT"), 
"DT_node_data_9" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Estimator" AS DOUBLE PRECISION) AS "Estimator" 
...
-- Code For temporary table tmp_20180508182844_codegen_4j5wq9_xgb_b1 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180508182844_codegen_4j5wq9_xgb_b1  (
	"KEY" BIGINT, 
	"Estimator" DOUBLE PRECISION
)
...
-- Code For temporary table tmp_20180508182844_codegen_4j5wq9_xgb_b1 part 2. Populate

INSERT INTO tmp_20180508182844_codegen_4j5wq9_xgb_b1 ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
FROM (WITH "DT_node_lookup_10" AS 
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", CASE WHEN ("ADS_sca_2_OUT".scaler_97 < CAST(-0.348418980836868 AS DOUBLE PRECISION)) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_82 < CAST(-0.231866031885147 AS DOUBLE PRECISION)) THEN 3 ELSE 4 END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_41 < CAST(0.626665830612183 AS DOUBLE PRECISION)) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_82 < CAST(0.612818002700806 AS DOUBLE PRECISION)) THEN 7 ELSE 8 END ELSE 6 END END AS node_id_2 
FROM tmp_20180508182844_codegen_tlr4lp_ads_sca_2_out AS "ADS_sca_2_OUT"), 
dummy_cte AS 
(SELECT CAST(0.0 AS DOUBLE PRECISION) AS "X"), 
"DT_node_data_10" AS 
...
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", CASE WHEN ("ADS_sca_2_OUT".scaler_43 < CAST(-0.44576358795166 AS DOUBLE PRECISION)) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_65 < CAST(0.285290479660034 AS DOUBLE PRECISION)) THEN 3 ELSE 4 END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_51 < CAST(0.670727908611298 AS DOUBLE PRECISION)) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_94 < CAST(-0.242407023906708 AS DOUBLE PRECISION)) THEN 7 ELSE 8 END ELSE 6 END END AS node_id_2 
FROM tmp_20180508182844_codegen_tlr4lp_ads_sca_2_out AS "ADS_sca_2_OUT"), 
"DT_node_data_11" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Estimator" AS DOUBLE PRECISION) AS "Estimator" 
...
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", CASE WHEN ("ADS_sca_2_OUT".scaler_97 < CAST(-0.348418980836868 AS DOUBLE PRECISION)) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_43 < CAST(-0.152117192745209 AS DOUBLE PRECISION)) THEN 3 ELSE 4 END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_41 < CAST(-0.659211277961731 AS DOUBLE PRECISION)) THEN 5 ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_65 < CAST(-0.295507609844208 AS DOUBLE PRECISION)) THEN 7 ELSE 8 END END END AS node_id_2 
FROM tmp_20180508182844_codegen_tlr4lp_ads_sca_2_out AS "ADS_sca_2_OUT"), 
"DT_node_data_12" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Estimator" AS DOUBLE PRECISION) AS "Estimator" 
...
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", CASE WHEN ("ADS_sca_2_OUT".scaler_82 < CAST(0.200310185551643 AS DOUBLE PRECISION)) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_65 < CAST(0.46510922908783 AS DOUBLE PRECISION)) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_43 < CAST(-0.02538556419313 AS DOUBLE PRECISION)) THEN 7 ELSE 8 END ELSE 4 END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_19 < CAST(-0.478091657161713 AS DOUBLE PRECISION)) THEN 5 ELSE 6 END END AS node_id_2 
FROM tmp_20180508182844_codegen_tlr4lp_ads_sca_2_out AS "ADS_sca_2_OUT"), 
"DT_node_data_14" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Estimator" AS DOUBLE PRECISION) AS "Estimator" 
...
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", CASE WHEN ("ADS_sca_2_OUT".scaler_97 < CAST(-0.348418980836868 AS DOUBLE PRECISION)) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_65 < CAST(-0.024697976186872 AS DOUBLE PRECISION)) THEN 3 ELSE 4 END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_41 < CAST(0.626665830612183 AS DOUBLE PRECISION)) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_82 < CAST(0.731658756732941 AS DOUBLE PRECISION)) THEN 7 ELSE 8 END ELSE 6 END END AS node_id_2 
FROM tmp_20180508182844_codegen_tlr4lp_ads_sca_2_out AS "ADS_sca_2_OUT"), 
"DT_node_data_15" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Estimator" AS DOUBLE PRECISION) AS "Estimator" 
...
-- Code For temporary table tmp_20180508182844_codegen_xdvw6e_xgb_union part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180508182844_codegen_xdvw6e_xgb_union  (
	"KEY" BIGINT, 
	"Estimator" DOUBLE PRECISION
)
...
-- Code For temporary table tmp_20180508182844_codegen_xdvw6e_xgb_union part 2. Populate

INSERT INTO tmp_20180508182844_codegen_xdvw6e_xgb_union ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
FROM tmp_20180508182844_codegen_t4w309_xgb_b0 AS "XGB_B0" UNION ALL SELECT "XGB_B1"."KEY" AS "KEY", "XGB_B1"."Estimator" AS "Estimator" 
FROM tmp_20180508182844_codegen_4j5wq9_xgb_b1 AS "XGB_B1") AS "XGB_EnsembleUnion") AS "XGB_Union") AS "U"

-- Code For temporary table tmp_20180508182844_codegen_gd5spt_xgb_sum part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180508182844_codegen_gd5spt_xgb_sum  (
	"KEY" BIGINT, 
	"Estimator" DOUBLE PRECISION
)
...
-- Code For temporary table tmp_20180508182844_codegen_gd5spt_xgb_sum part 2. Populate

INSERT INTO tmp_20180508182844_codegen_gd5spt_xgb_sum ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
FROM tmp_20180508182844_codegen_xdvw6e_xgb_union AS "XGB_Union" GROUP BY "XGB_Union"."KEY") AS "T") AS "XGB_sum") AS "U"

-- Model deployment code

SELECT "XGB_sum"."KEY" AS "KEY", "XGB_sum"."Estimator" + CAST(0.5 AS DOUBLE PRECISION) AS "Estimator" 
FROM tmp_20180508182844_codegen_gd5spt_xgb_sum AS "XGB_sum"