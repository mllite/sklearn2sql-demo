...
-- Code For temporary table TMP_20180516_CODEGEN_CW2WW6_ADS part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180516_CODEGEN_CW2WW6_ADS" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20180516_CODEGEN_CW2WW6_ADS part 2. Populate

INSERT INTO "TMP_20180516_CODEGEN_CW2WW6_ADS" ("KEY", imputer_output_2, imputer_output_3, imputer_output_4, imputer_output_5) SELECT "U"."KEY", "U".imputer_output_2, "U".imputer_output_3, "U".imputer_output_4, "U".imputer_output_5 
...
-- Code For temporary table TMP_20180516_CODEGEN_CW2WW6_ADS part 3. Create Index 

CREATE INDEX "ix_TMP_20180516_CODEGEN_ac0c" ON "TMP_20180516_CODEGEN_CW2WW6_ADS" ("KEY")

-- Code For temporary table TMP_20180516_CODEGEN_EYW86X_ADS part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180516_CODEGEN_EYW86X_ADS" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20180516_CODEGEN_EYW86X_ADS part 2. Populate

INSERT INTO "TMP_20180516_CODEGEN_EYW86X_ADS" ("KEY", scaler_output_2, scaler_output_3, scaler_output_4, scaler_output_5) SELECT "U"."KEY", "U".scaler_output_2, "U".scaler_output_3, "U".scaler_output_4, "U".scaler_output_5 
...
FROM "TMP_20180516_CODEGEN_CW2WW6_ADS" AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT") AS "U"

-- Code For temporary table TMP_20180516_CODEGEN_EYW86X_ADS part 3. Create Index 

CREATE INDEX "ix_TMP_20180516_CODEGEN_ab56" ON "TMP_20180516_CODEGEN_EYW86X_ADS" ("KEY")

-- Code For temporary table TMP_20180516_CODEGEN_4EROTN_XGB part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180516_CODEGEN_4EROTN_XGB" (
	"KEY" BIGINT, 
...
-- Code For temporary table TMP_20180516_CODEGEN_4EROTN_XGB part 2. Populate

INSERT INTO "TMP_20180516_CODEGEN_4EROTN_XGB" ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
FROM "TMP_20180516_CODEGEN_EYW86X_ADS" AS "ADS_sca_2_OUT"), 
"DT_node_data" AS 
...
-- Code For temporary table TMP_20180516_CODEGEN_2XQ5L9_XGB part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180516_CODEGEN_2XQ5L9_XGB" (
	"KEY" BIGINT, 
	"Estimator" DOUBLE PRECISION
)
...
-- Code For temporary table TMP_20180516_CODEGEN_2XQ5L9_XGB part 2. Populate

INSERT INTO "TMP_20180516_CODEGEN_2XQ5L9_XGB" ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
-- Code For temporary table TMP_20180516_CODEGEN_0BS06H_XGB part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180516_CODEGEN_0BS06H_XGB" (
	"KEY" BIGINT NOT NULL, 
	"Estimator" DOUBLE PRECISION, 
	PRIMARY KEY ("KEY")
)
...
-- Code For temporary table TMP_20180516_CODEGEN_0BS06H_XGB part 2. Populate

INSERT INTO "TMP_20180516_CODEGEN_0BS06H_XGB" ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
FROM "TMP_20180516_CODEGEN_4EROTN_XGB" AS "XGB_B0" UNION ALL SELECT "XGB_B1"."KEY" AS "KEY", "XGB_B1"."Estimator" AS "Estimator" 
FROM "TMP_20180516_CODEGEN_2XQ5L9_XGB" AS "XGB_B1") AS "XGB_EnsembleUnion")
...
-- Code For temporary table TMP_20180516_CODEGEN_0BS06H_XGB part 3. Create Index 

CREATE INDEX "ix_TMP_20180516_CODEGEN_95cb" ON "TMP_20180516_CODEGEN_0BS06H_XGB" ("KEY")

-- Model deployment code

SELECT "XGB_sum"."KEY" AS "KEY", "XGB_sum"."Estimator" + 0.5 AS "Estimator" 
FROM "TMP_20180516_CODEGEN_0BS06H_XGB" AS "XGB_sum"