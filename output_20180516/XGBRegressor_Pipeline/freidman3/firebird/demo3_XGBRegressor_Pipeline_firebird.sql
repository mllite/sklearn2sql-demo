...
-- Code For temporary table TMP_20180508185420_CODEGEN_QOJC part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508185420_CODEGEN_QOJC" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20180508185420_CODEGEN_QOJC part 2. Populate

INSERT INTO "TMP_20180508185420_CODEGEN_QOJC" ("KEY", imputer_output_2, imputer_output_3, imputer_output_4, imputer_output_5) SELECT "U"."KEY", "U".imputer_output_2, "U".imputer_output_3, "U".imputer_output_4, "U".imputer_output_5 
...
-- Code For temporary table TMP_20180508185420_CODEGEN_QOJC part 3. Create Index 

CREATE INDEX "ix_TMP_20180508185420_C_5e22" ON "TMP_20180508185420_CODEGEN_QOJC" ("KEY")

-- Code For temporary table TMP_20180508185420_CODEGEN_NR8Y part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508185420_CODEGEN_NR8Y" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20180508185420_CODEGEN_NR8Y part 2. Populate

INSERT INTO "TMP_20180508185420_CODEGEN_NR8Y" ("KEY", scaler_output_2, scaler_output_3, scaler_output_4, scaler_output_5) SELECT "U"."KEY", "U".scaler_output_2, "U".scaler_output_3, "U".scaler_output_4, "U".scaler_output_5 
...
FROM "TMP_20180508185420_CODEGEN_QOJC" AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT") AS "U"

-- Code For temporary table TMP_20180508185420_CODEGEN_NR8Y part 3. Create Index 

CREATE INDEX "ix_TMP_20180508185420_C_2696" ON "TMP_20180508185420_CODEGEN_NR8Y" ("KEY")

-- Code For temporary table TMP_20180508185420_CODEGEN_O4NS part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508185420_CODEGEN_O4NS" (
	"KEY" BIGINT, 
...
-- Code For temporary table TMP_20180508185420_CODEGEN_O4NS part 2. Populate

INSERT INTO "TMP_20180508185420_CODEGEN_O4NS" ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
FROM "TMP_20180508185420_CODEGEN_NR8Y" AS "ADS_sca_2_OUT"), 
"DT_node_data" AS 
...
-- Code For temporary table TMP_20180508185420_CODEGEN_JO1S part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508185420_CODEGEN_JO1S" (
	"KEY" BIGINT, 
	"Estimator" DOUBLE PRECISION
)
...
-- Code For temporary table TMP_20180508185420_CODEGEN_JO1S part 2. Populate

INSERT INTO "TMP_20180508185420_CODEGEN_JO1S" ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
-- Code For temporary table TMP_20180508185420_CODEGEN_VK0S part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508185420_CODEGEN_VK0S" (
	"KEY" BIGINT, 
	"Estimator" DOUBLE PRECISION
)
...
-- Code For temporary table TMP_20180508185420_CODEGEN_VK0S part 2. Populate

INSERT INTO "TMP_20180508185420_CODEGEN_VK0S" ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
FROM "TMP_20180508185420_CODEGEN_O4NS" AS "XGB_B0" UNION ALL SELECT "XGB_B1"."KEY" AS "KEY", "XGB_B1"."Estimator" AS "Estimator" 
FROM "TMP_20180508185420_CODEGEN_JO1S" AS "XGB_B1") AS "XGB_EnsembleUnion") AS "XGB_Union") AS "U"

-- Code For temporary table TMP_20180508185420_CODEGEN_LFDT part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508185420_CODEGEN_LFDT" (
	"KEY" BIGINT NOT NULL, 
	"Estimator" DOUBLE PRECISION, 
	PRIMARY KEY ("KEY")
)
...
-- Code For temporary table TMP_20180508185420_CODEGEN_LFDT part 2. Populate

INSERT INTO "TMP_20180508185420_CODEGEN_LFDT" ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
FROM "TMP_20180508185420_CODEGEN_VK0S" AS "XGB_Union" GROUP BY "XGB_Union"."KEY") AS "T") AS "XGB_sum") AS "U"

-- Code For temporary table TMP_20180508185420_CODEGEN_LFDT part 3. Create Index 

CREATE INDEX "ix_TMP_20180508185420_C_b39d" ON "TMP_20180508185420_CODEGEN_LFDT" ("KEY")

-- Model deployment code

SELECT "XGB_sum"."KEY" AS "KEY", "XGB_sum"."Estimator" + 0.5 AS "Estimator" 
FROM "TMP_20180508185420_CODEGEN_LFDT" AS "XGB_sum"