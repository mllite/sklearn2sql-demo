...
-- Code For temporary table TMP_20180508183235_CODEGEN_63GG part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508183235_CODEGEN_63GG" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20180508183235_CODEGEN_63GG part 2. Populate

INSERT INTO "TMP_20180508183235_CODEGEN_63GG" ("KEY", impter_2, impter_3, impter_4, impter_5, impter_6, impter_7, impter_8, impter_9, impter_10, impter_11, impter_12, impter_13, impter_14) SELECT "U"."KEY", "U".impter_2, "U".impter_3, "U".impter_4, "U".impter_5, "U".impter_6, "U".impter_7, "U".impter_8, "U".impter_9, "U".impter_10, "U".impter_11, "U".impter_12, "U".impter_13, "U".impter_14 
...
-- Code For temporary table TMP_20180508183235_CODEGEN_63GG part 3. Create Index 

CREATE INDEX "ix_TMP_20180508183235_C_be3f" ON "TMP_20180508183235_CODEGEN_63GG" ("KEY")

-- Code For temporary table TMP_20180508183235_CODEGEN_JCT0 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508183235_CODEGEN_JCT0" (
	"KEY" BIGINT NOT NULL, 
...
FROM "TMP_20180508183235_CODEGEN_63GG" AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT") AS "U"

-- Code For temporary table TMP_20180508183235_CODEGEN_JCT0 part 3. Create Index 

CREATE INDEX "ix_TMP_20180508183235_C_da62" ON "TMP_20180508183235_CODEGEN_JCT0" ("KEY")

-- Code For temporary table TMP_20180508183235_CODEGEN_JPG4 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508183235_CODEGEN_JPG4" (
	"KEY" BIGINT, 
...
-- Code For temporary table TMP_20180508183235_CODEGEN_JPG4 part 2. Populate

INSERT INTO "TMP_20180508183235_CODEGEN_JPG4" ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
FROM "TMP_20180508183235_CODEGEN_JCT0" AS "ADS_sca_2_OUT"), 
"DT_node_data" AS 
...
-- Code For temporary table TMP_20180508183235_CODEGEN_W827 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508183235_CODEGEN_W827" (
	"KEY" BIGINT, 
	"Estimator" DOUBLE PRECISION
)
...
-- Code For temporary table TMP_20180508183235_CODEGEN_W827 part 2. Populate

INSERT INTO "TMP_20180508183235_CODEGEN_W827" ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
-- Code For temporary table TMP_20180508183235_CODEGEN_FJ1M part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508183235_CODEGEN_FJ1M" (
	"KEY" BIGINT, 
	"Estimator" DOUBLE PRECISION
)
...
-- Code For temporary table TMP_20180508183235_CODEGEN_FJ1M part 2. Populate

INSERT INTO "TMP_20180508183235_CODEGEN_FJ1M" ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
FROM "TMP_20180508183235_CODEGEN_JPG4" AS "XGB_B0" UNION ALL SELECT "XGB_B1"."KEY" AS "KEY", "XGB_B1"."Estimator" AS "Estimator" 
FROM "TMP_20180508183235_CODEGEN_W827" AS "XGB_B1") AS "XGB_EnsembleUnion") AS "XGB_Union") AS "U"

-- Code For temporary table TMP_20180508183235_CODEGEN_DEKB part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508183235_CODEGEN_DEKB" (
	"KEY" BIGINT NOT NULL, 
	"Estimator" DOUBLE PRECISION, 
	PRIMARY KEY ("KEY")
)
...
-- Code For temporary table TMP_20180508183235_CODEGEN_DEKB part 2. Populate

INSERT INTO "TMP_20180508183235_CODEGEN_DEKB" ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
FROM "TMP_20180508183235_CODEGEN_FJ1M" AS "XGB_Union" GROUP BY "XGB_Union"."KEY") AS "T") AS "XGB_sum") AS "U"

-- Code For temporary table TMP_20180508183235_CODEGEN_DEKB part 3. Create Index 

CREATE INDEX "ix_TMP_20180508183235_C_179d" ON "TMP_20180508183235_CODEGEN_DEKB" ("KEY")

-- Model deployment code

SELECT "XGB_sum"."KEY" AS "KEY", "XGB_sum"."Estimator" + 0.5 AS "Estimator" 
FROM "TMP_20180508183235_CODEGEN_DEKB" AS "XGB_sum"