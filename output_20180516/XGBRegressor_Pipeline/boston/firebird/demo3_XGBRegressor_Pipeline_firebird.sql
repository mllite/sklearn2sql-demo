...
-- Code For temporary table TMP_20180516_CODEGEN_MFKQUU_ADS part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180516_CODEGEN_MFKQUU_ADS" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20180516_CODEGEN_MFKQUU_ADS part 2. Populate

INSERT INTO "TMP_20180516_CODEGEN_MFKQUU_ADS" ("KEY", impter_2, impter_3, impter_4, impter_5, impter_6, impter_7, impter_8, impter_9, impter_10, impter_11, impter_12, impter_13, impter_14) SELECT "U"."KEY", "U".impter_2, "U".impter_3, "U".impter_4, "U".impter_5, "U".impter_6, "U".impter_7, "U".impter_8, "U".impter_9, "U".impter_10, "U".impter_11, "U".impter_12, "U".impter_13, "U".impter_14 
...
-- Code For temporary table TMP_20180516_CODEGEN_MFKQUU_ADS part 3. Create Index 

CREATE INDEX "ix_TMP_20180516_CODEGEN_7ed0" ON "TMP_20180516_CODEGEN_MFKQUU_ADS" ("KEY")

-- Code For temporary table TMP_20180516_CODEGEN_W0V9IR_ADS part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180516_CODEGEN_W0V9IR_ADS" (
	"KEY" BIGINT NOT NULL, 
...
FROM "TMP_20180516_CODEGEN_MFKQUU_ADS" AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT") AS "U"

-- Code For temporary table TMP_20180516_CODEGEN_W0V9IR_ADS part 3. Create Index 

CREATE INDEX "ix_TMP_20180516_CODEGEN_74a5" ON "TMP_20180516_CODEGEN_W0V9IR_ADS" ("KEY")

-- Code For temporary table TMP_20180516_CODEGEN_E414NU_XGB part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180516_CODEGEN_E414NU_XGB" (
	"KEY" BIGINT, 
...
-- Code For temporary table TMP_20180516_CODEGEN_E414NU_XGB part 2. Populate

INSERT INTO "TMP_20180516_CODEGEN_E414NU_XGB" ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
FROM "TMP_20180516_CODEGEN_W0V9IR_ADS" AS "ADS_sca_2_OUT"), 
"DT_node_data" AS 
...
-- Code For temporary table TMP_20180516_CODEGEN_NIOYI1_XGB part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180516_CODEGEN_NIOYI1_XGB" (
	"KEY" BIGINT, 
	"Estimator" DOUBLE PRECISION
)
...
-- Code For temporary table TMP_20180516_CODEGEN_NIOYI1_XGB part 2. Populate

INSERT INTO "TMP_20180516_CODEGEN_NIOYI1_XGB" ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
-- Code For temporary table TMP_20180516_CODEGEN_T99HGS_XGB part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180516_CODEGEN_T99HGS_XGB" (
	"KEY" BIGINT NOT NULL, 
	"Estimator" DOUBLE PRECISION, 
	PRIMARY KEY ("KEY")
)
...
-- Code For temporary table TMP_20180516_CODEGEN_T99HGS_XGB part 2. Populate

INSERT INTO "TMP_20180516_CODEGEN_T99HGS_XGB" ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
FROM "TMP_20180516_CODEGEN_E414NU_XGB" AS "XGB_B0" UNION ALL SELECT "XGB_B1"."KEY" AS "KEY", "XGB_B1"."Estimator" AS "Estimator" 
FROM "TMP_20180516_CODEGEN_NIOYI1_XGB" AS "XGB_B1") AS "XGB_EnsembleUnion")
...
-- Code For temporary table TMP_20180516_CODEGEN_T99HGS_XGB part 3. Create Index 

CREATE INDEX "ix_TMP_20180516_CODEGEN_b6f9" ON "TMP_20180516_CODEGEN_T99HGS_XGB" ("KEY")

-- Model deployment code

SELECT "XGB_sum"."KEY" AS "KEY", "XGB_sum"."Estimator" + 0.5 AS "Estimator" 
FROM "TMP_20180516_CODEGEN_T99HGS_XGB" AS "XGB_sum"