...
-- Code For temporary table tmp_20180516115119_codegen_hecdx6_ads_imp_1_out part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180516115119_codegen_hecdx6_ads_imp_1_out  (
	"KEY" BIGINT, 
...
-- Code For temporary table tmp_20180516115119_codegen_hecdx6_ads_imp_1_out part 2. Populate

INSERT INTO tmp_20180516115119_codegen_hecdx6_ads_imp_1_out ("KEY", impter_2, impter_3, impter_4, impter_5, impter_6, impter_7, impter_8, impter_9, impter_10, impter_11, impter_12, impter_13, impter_14) SELECT "U"."KEY", "U".impter_2, "U".impter_3, "U".impter_4, "U".impter_5, "U".impter_6, "U".impter_7, "U".impter_8, "U".impter_9, "U".impter_10, "U".impter_11, "U".impter_12, "U".impter_13, "U".impter_14 
...
-- Code For temporary table tmp_20180516115119_codegen_088wd4_ads_sca_2_out part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180516115119_codegen_088wd4_ads_sca_2_out  (
	"KEY" BIGINT, 
...
FROM tmp_20180516115119_codegen_hecdx6_ads_imp_1_out AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT") AS "U"

-- Code For temporary table tmp_20180516115119_codegen_bydujf_xgb_b0 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180516115119_codegen_bydujf_xgb_b0  (
	"KEY" BIGINT, 
...
-- Code For temporary table tmp_20180516115119_codegen_bydujf_xgb_b0 part 2. Populate

INSERT INTO tmp_20180516115119_codegen_bydujf_xgb_b0 ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
FROM tmp_20180516115119_codegen_088wd4_ads_sca_2_out AS "ADS_sca_2_OUT"), 
dummy_cte AS 
...
-- Code For temporary table tmp_20180516115119_codegen_uqbkqp_xgb_b1 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180516115119_codegen_uqbkqp_xgb_b1  (
	"KEY" BIGINT, 
	"Estimator" DOUBLE PRECISION
)
...
-- Code For temporary table tmp_20180516115119_codegen_uqbkqp_xgb_b1 part 2. Populate

INSERT INTO tmp_20180516115119_codegen_uqbkqp_xgb_b1 ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
-- Code For temporary table tmp_20180516115119_codegen_q9th99_xgb_sum part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180516115119_codegen_q9th99_xgb_sum  (
	"KEY" BIGINT, 
	"Estimator" DOUBLE PRECISION
)
...
-- Code For temporary table tmp_20180516115119_codegen_q9th99_xgb_sum part 2. Populate

INSERT INTO tmp_20180516115119_codegen_q9th99_xgb_sum ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
FROM tmp_20180516115119_codegen_bydujf_xgb_b0 AS "XGB_B0" UNION ALL SELECT "XGB_B1"."KEY" AS "KEY", "XGB_B1"."Estimator" AS "Estimator" 
FROM tmp_20180516115119_codegen_uqbkqp_xgb_b1 AS "XGB_B1") AS "XGB_EnsembleUnion")
...
FROM tmp_20180516115119_codegen_q9th99_xgb_sum AS "XGB_sum"