...
-- Code For temporary table 20180602_JKS_ADS_IMP_1_OUT part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "20180602_JKS_ADS_IMP_1_OUT" (
	"KEY" NUMBER(19), 
...
-- Code For temporary table 20180602_JKS_ADS_IMP_1_OUT part 2. Populate

INSERT INTO "20180602_JKS_ADS_IMP_1_OUT" ("KEY", impter_2, impter_3, impter_4, impter_5, impter_6, impter_7, impter_8, impter_9, impter_10, impter_11, impter_12, impter_13, impter_14) SELECT "U"."KEY", "U".impter_2, "U".impter_3, "U".impter_4, "U".impter_5, "U".impter_6, "U".impter_7, "U".impter_8, "U".impter_9, "U".impter_10, "U".impter_11, "U".impter_12, "U".impter_13, "U".impter_14 
...
-- Code For temporary table 20180602_4WK_ADS_SCA_2_OUT part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "20180602_4WK_ADS_SCA_2_OUT" (
	"KEY" NUMBER(19), 
...
FROM "20180602_JKS_ADS_IMP_1_OUT" "ADS_imp_1_OUT") "ADS_sca_2_OUT") "U"

-- Code For temporary table TMP_20180602_R7B_XGB_B0 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180602_R7B_XGB_B0" (
	"KEY" NUMBER(19), 
...
-- Code For temporary table TMP_20180602_R7B_XGB_B0 part 2. Populate

INSERT INTO "TMP_20180602_R7B_XGB_B0" ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
FROM "20180602_4WK_ADS_SCA_2_OUT" "ADS_sca_2_OUT"), 
"DT_node_data" AS 
...
-- Code For temporary table TMP_20180602_M1B_XGB_B1 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180602_M1B_XGB_B1" (
	"KEY" NUMBER(19), 
	"Estimator" BINARY_DOUBLE
)
...
-- Code For temporary table TMP_20180602_M1B_XGB_B1 part 2. Populate

INSERT INTO "TMP_20180602_M1B_XGB_B1" ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
-- Code For temporary table TMP_20180602_6R1_XGB_SUM part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180602_6R1_XGB_SUM" (
	"KEY" NUMBER(19), 
	"Estimator" BINARY_DOUBLE
)
...
-- Code For temporary table TMP_20180602_6R1_XGB_SUM part 2. Populate

INSERT INTO "TMP_20180602_6R1_XGB_SUM" ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
FROM "TMP_20180602_R7B_XGB_B0" "XGB_B0" UNION ALL SELECT "XGB_B1"."KEY" AS "KEY", "XGB_B1"."Estimator" AS "Estimator" 
FROM "TMP_20180602_M1B_XGB_B1" "XGB_B1") "XGB_EnsembleUnion")
...
FROM "TMP_20180602_6R1_XGB_SUM" "XGB_sum"