...
-- Code For temporary table ##TMP_20180516131153_CODEGEN_MRN15C_GB_B0 part 1. Create 


CREATE TABLE ##TMP_20180516131153_CODEGEN_MRN15C_GB_B0 (
	[KEY] BIGINT NULL, 
...
-- Code For temporary table ##TMP_20180516131153_CODEGEN_MRN15C_GB_B0 part 2. Populate
...
FROM [DT_Output_9])
 INSERT INTO ##TMP_20180516131153_CODEGEN_MRN15C_GB_B0 ([KEY], [Score_CLASS_0], [Score_CLASS_1], [Score_CLASS_2]) SELECT [GB_B0].[KEY], [GB_B0].[Score_CLASS_0], [GB_B0].[Score_CLASS_1], [GB_B0].[Score_CLASS_2] 
...
-- Code For temporary table ##TMP_20180516131153_CODEGEN_5PDQEP_GB_B1 part 1. Create 


CREATE TABLE ##TMP_20180516131153_CODEGEN_5PDQEP_GB_B1 (
	[KEY] BIGINT NULL, 
	[Score_CLASS_0] FLOAT(53) NULL, 
	[Score_CLASS_1] FLOAT(53) NULL, 
	[Score_CLASS_2] FLOAT(53) NULL
...
-- Code For temporary table ##TMP_20180516131153_CODEGEN_5PDQEP_GB_B1 part 2. Populate
...
FROM [DT_Output_19])
 INSERT INTO ##TMP_20180516131153_CODEGEN_5PDQEP_GB_B1 ([KEY], [Score_CLASS_0], [Score_CLASS_1], [Score_CLASS_2]) SELECT [GB_B1].[KEY], [GB_B1].[Score_CLASS_0], [GB_B1].[Score_CLASS_1], [GB_B1].[Score_CLASS_2] 
...
-- Code For temporary table ##TMP_20180516131153_CODEGEN_74MY24_GB_B2 part 1. Create 


CREATE TABLE ##TMP_20180516131153_CODEGEN_74MY24_GB_B2 (
	[KEY] BIGINT NULL, 
	[Score_CLASS_0] FLOAT(53) NULL, 
	[Score_CLASS_1] FLOAT(53) NULL, 
	[Score_CLASS_2] FLOAT(53) NULL
...
-- Code For temporary table ##TMP_20180516131153_CODEGEN_74MY24_GB_B2 part 2. Populate
...
FROM [DT_Output_29])
 INSERT INTO ##TMP_20180516131153_CODEGEN_74MY24_GB_B2 ([KEY], [Score_CLASS_0], [Score_CLASS_1], [Score_CLASS_2]) SELECT [GB_B2].[KEY], [GB_B2].[Score_CLASS_0], [GB_B2].[Score_CLASS_1], [GB_B2].[Score_CLASS_2] 
...
-- Code For temporary table ##TMP_20180516131153_CODEGEN_HBNSOE_GB_B3 part 1. Create 


CREATE TABLE ##TMP_20180516131153_CODEGEN_HBNSOE_GB_B3 (
	[KEY] BIGINT NULL, 
	[Score_CLASS_0] FLOAT(53) NULL, 
	[Score_CLASS_1] FLOAT(53) NULL, 
	[Score_CLASS_2] FLOAT(53) NULL
...
-- Code For temporary table ##TMP_20180516131153_CODEGEN_HBNSOE_GB_B3 part 2. Populate
...
FROM [DT_Output_39])
 INSERT INTO ##TMP_20180516131153_CODEGEN_HBNSOE_GB_B3 ([KEY], [Score_CLASS_0], [Score_CLASS_1], [Score_CLASS_2]) SELECT [GB_B3].[KEY], [GB_B3].[Score_CLASS_0], [GB_B3].[Score_CLASS_1], [GB_B3].[Score_CLASS_2] 
...
-- Code For temporary table ##TMP_20180516131153_CODEGEN_N74G45_GB_B4 part 1. Create 


CREATE TABLE ##TMP_20180516131153_CODEGEN_N74G45_GB_B4 (
	[KEY] BIGINT NULL, 
	[Score_CLASS_0] FLOAT(53) NULL, 
	[Score_CLASS_1] FLOAT(53) NULL, 
	[Score_CLASS_2] FLOAT(53) NULL
...
-- Code For temporary table ##TMP_20180516131153_CODEGEN_N74G45_GB_B4 part 2. Populate
...
FROM [DT_Output_47])
 INSERT INTO ##TMP_20180516131153_CODEGEN_N74G45_GB_B4 ([KEY], [Score_CLASS_0], [Score_CLASS_1], [Score_CLASS_2]) SELECT [GB_B4].[KEY], [GB_B4].[Score_CLASS_0], [GB_B4].[Score_CLASS_1], [GB_B4].[Score_CLASS_2] 
...
-- Code For temporary table ##TMP_20180516131153_CODEGEN_MF2UUS_GB_sum part 1. Create 


CREATE TABLE ##TMP_20180516131153_CODEGEN_MF2UUS_GB_sum (
	[KEY] BIGINT NULL, 
	[Score_CLASS_0] FLOAT(53) NULL, 
	[Score_CLASS_1] FLOAT(53) NULL, 
	[Score_CLASS_2] FLOAT(53) NULL
...
-- Code For temporary table ##TMP_20180516131153_CODEGEN_MF2UUS_GB_sum part 2. Populate
...
FROM ##TMP_20180516131153_CODEGEN_MRN15C_GB_B0 AS [GB_B0] UNION ALL SELECT [GB_B1].[KEY] AS [KEY], [GB_B1].[Score_CLASS_0] AS [Score_CLASS_0], [GB_B1].[Score_CLASS_1] AS [Score_CLASS_1], [GB_B1].[Score_CLASS_2] AS [Score_CLASS_2] 
FROM ##TMP_20180516131153_CODEGEN_5PDQEP_GB_B1 AS [GB_B1] UNION ALL SELECT [GB_B2].[KEY] AS [KEY], [GB_B2].[Score_CLASS_0] AS [Score_CLASS_0], [GB_B2].[Score_CLASS_1] AS [Score_CLASS_1], [GB_B2].[Score_CLASS_2] AS [Score_CLASS_2] 
FROM ##TMP_20180516131153_CODEGEN_74MY24_GB_B2 AS [GB_B2] UNION ALL SELECT [GB_B3].[KEY] AS [KEY], [GB_B3].[Score_CLASS_0] AS [Score_CLASS_0], [GB_B3].[Score_CLASS_1] AS [Score_CLASS_1], [GB_B3].[Score_CLASS_2] AS [Score_CLASS_2] 
FROM ##TMP_20180516131153_CODEGEN_HBNSOE_GB_B3 AS [GB_B3] UNION ALL SELECT [GB_B4].[KEY] AS [KEY], [GB_B4].[Score_CLASS_0] AS [Score_CLASS_0], [GB_B4].[Score_CLASS_1] AS [Score_CLASS_1], [GB_B4].[Score_CLASS_2] AS [Score_CLASS_2] 
FROM ##TMP_20180516131153_CODEGEN_N74G45_GB_B4 AS [GB_B4]) AS [GB_EnsembleUnion])
 INSERT INTO ##TMP_20180516131153_CODEGEN_MF2UUS_GB_sum ([KEY], [Score_CLASS_0], [Score_CLASS_1], [Score_CLASS_2]) SELECT [GB_sum].[KEY], [GB_sum].[Score_CLASS_0], [GB_sum].[Score_CLASS_1], [GB_sum].[Score_CLASS_2] 
...
FROM ##TMP_20180516131153_CODEGEN_MF2UUS_GB_sum AS [GB_sum]), 
