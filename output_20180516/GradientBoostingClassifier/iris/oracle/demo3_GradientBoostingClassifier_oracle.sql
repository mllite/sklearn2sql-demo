...
-- Code For temporary table 85619_CODEGEN_INPVZP_GB_B0 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "85619_CODEGEN_INPVZP_GB_B0" (
	"KEY" NUMBER(19), 
...
-- Code For temporary table 85619_CODEGEN_INPVZP_GB_B0 part 2. Populate

INSERT INTO "85619_CODEGEN_INPVZP_GB_B0" ("KEY", "Score_0", "Score_1", "Score_2") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1", "U"."Score_2" 
...
-- Code For temporary table 85619_CODEGEN_JYS5I4_GB_B1 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "85619_CODEGEN_JYS5I4_GB_B1" (
	"KEY" NUMBER(19), 
	"Score_0" BINARY_DOUBLE, 
	"Score_1" BINARY_DOUBLE, 
	"Score_2" BINARY_DOUBLE
...
-- Code For temporary table 85619_CODEGEN_JYS5I4_GB_B1 part 2. Populate

INSERT INTO "85619_CODEGEN_JYS5I4_GB_B1" ("KEY", "Score_0", "Score_1", "Score_2") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1", "U"."Score_2" 
...
-- Code For temporary table 85619_CODEGEN_XJOBQW_GB_B2 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "85619_CODEGEN_XJOBQW_GB_B2" (
	"KEY" NUMBER(19), 
	"Score_0" BINARY_DOUBLE, 
	"Score_1" BINARY_DOUBLE, 
	"Score_2" BINARY_DOUBLE
...
-- Code For temporary table 85619_CODEGEN_XJOBQW_GB_B2 part 2. Populate

INSERT INTO "85619_CODEGEN_XJOBQW_GB_B2" ("KEY", "Score_0", "Score_1", "Score_2") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1", "U"."Score_2" 
...
-- Code For temporary table 85619_CODEGEN_3VFA57_GB_B3 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "85619_CODEGEN_3VFA57_GB_B3" (
	"KEY" NUMBER(19), 
	"Score_0" BINARY_DOUBLE, 
	"Score_1" BINARY_DOUBLE, 
	"Score_2" BINARY_DOUBLE
...
-- Code For temporary table 85619_CODEGEN_3VFA57_GB_B3 part 2. Populate

INSERT INTO "85619_CODEGEN_3VFA57_GB_B3" ("KEY", "Score_0", "Score_1", "Score_2") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1", "U"."Score_2" 
...
-- Code For temporary table 85619_CODEGEN_T2UMDO_GB_B4 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "85619_CODEGEN_T2UMDO_GB_B4" (
	"KEY" NUMBER(19), 
	"Score_0" BINARY_DOUBLE, 
	"Score_1" BINARY_DOUBLE, 
	"Score_2" BINARY_DOUBLE
...
-- Code For temporary table 85619_CODEGEN_T2UMDO_GB_B4 part 2. Populate

INSERT INTO "85619_CODEGEN_T2UMDO_GB_B4" ("KEY", "Score_0", "Score_1", "Score_2") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1", "U"."Score_2" 
...
-- Code For temporary table 19_CODEGEN_GJC8T9_GB_UNION part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "19_CODEGEN_GJC8T9_GB_UNION" (
	"KEY" NUMBER(19), 
	"Score_0" BINARY_DOUBLE, 
	"Score_1" BINARY_DOUBLE, 
	"Score_2" BINARY_DOUBLE
...
-- Code For temporary table 19_CODEGEN_GJC8T9_GB_UNION part 2. Populate

INSERT INTO "19_CODEGEN_GJC8T9_GB_UNION" ("KEY", "Score_0", "Score_1", "Score_2") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1", "U"."Score_2" 
...
FROM "85619_CODEGEN_INPVZP_GB_B0" "GB_B0" UNION ALL SELECT "GB_B1"."KEY" AS "KEY", "GB_B1"."Score_0" AS "Score_0", "GB_B1"."Score_1" AS "Score_1", "GB_B1"."Score_2" AS "Score_2" 
FROM "85619_CODEGEN_JYS5I4_GB_B1" "GB_B1" UNION ALL SELECT "GB_B2"."KEY" AS "KEY", "GB_B2"."Score_0" AS "Score_0", "GB_B2"."Score_1" AS "Score_1", "GB_B2"."Score_2" AS "Score_2" 
FROM "85619_CODEGEN_XJOBQW_GB_B2" "GB_B2" UNION ALL SELECT "GB_B3"."KEY" AS "KEY", "GB_B3"."Score_0" AS "Score_0", "GB_B3"."Score_1" AS "Score_1", "GB_B3"."Score_2" AS "Score_2" 
FROM "85619_CODEGEN_3VFA57_GB_B3" "GB_B3" UNION ALL SELECT "GB_B4"."KEY" AS "KEY", "GB_B4"."Score_0" AS "Score_0", "GB_B4"."Score_1" AS "Score_1", "GB_B4"."Score_2" AS "Score_2" 
FROM "85619_CODEGEN_T2UMDO_GB_B4" "GB_B4") "GB_EnsembleUnion") "GB_Union") "U"

-- Code For temporary table 5619_CODEGEN_8HMG3S_GB_SUM part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "5619_CODEGEN_8HMG3S_GB_SUM" (
	"KEY" NUMBER(19), 
	"Score_0" BINARY_DOUBLE, 
	"Score_1" BINARY_DOUBLE, 
	"Score_2" BINARY_DOUBLE
...
-- Code For temporary table 5619_CODEGEN_8HMG3S_GB_SUM part 2. Populate

INSERT INTO "5619_CODEGEN_8HMG3S_GB_SUM" ("KEY", "Score_0", "Score_1", "Score_2") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1", "U"."Score_2" 
...
FROM "19_CODEGEN_GJC8T9_GB_UNION" "GB_Union" GROUP BY "GB_Union"."KEY") "T") "GB_sum") "U"
...
FROM "5619_CODEGEN_8HMG3S_GB_SUM" "GB_sum"), 
