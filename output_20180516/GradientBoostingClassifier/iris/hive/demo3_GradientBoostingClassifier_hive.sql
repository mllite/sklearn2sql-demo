...
-- Code For temporary table tmp_20180602152808_arn_gb_b0 part 1. Create 

CREATE TEMPORARY TABLE `tmp_20180602152808_arn_gb_b0` STORED AS ORC AS WITH `DT_node_lookup` AS 
...
-- Code For temporary table tmp_20180602152808_arn_gb_b0 part 2. Populate

SELECT * FROM `tmp_20180602152808_arn_gb_b0`

-- Code For temporary table tmp_20180602152808_teb_gb_b1 part 1. Create 

CREATE TEMPORARY TABLE `tmp_20180602152808_teb_gb_b1` STORED AS ORC AS WITH `DT_node_lookup_10` AS 
...
-- Code For temporary table tmp_20180602152808_teb_gb_b1 part 2. Populate

SELECT * FROM `tmp_20180602152808_teb_gb_b1`

-- Code For temporary table tmp_20180602152808_8a6_gb_b2 part 1. Create 

CREATE TEMPORARY TABLE `tmp_20180602152808_8a6_gb_b2` STORED AS ORC AS WITH `DT_node_lookup_20` AS 
...
-- Code For temporary table tmp_20180602152808_8a6_gb_b2 part 2. Populate

SELECT * FROM `tmp_20180602152808_8a6_gb_b2`

-- Code For temporary table tmp_20180602152808_ty2_gb_b3 part 1. Create 

CREATE TEMPORARY TABLE `tmp_20180602152808_ty2_gb_b3` STORED AS ORC AS WITH `DT_node_lookup_30` AS 
(SELECT `ADS`.`KEY` AS `KEY`, CASE WHEN (`ADS`.`Feature_2` <= 2.450000047683716) THEN 1 ELSE CASE WHEN (`ADS`.`Feature_1` <= 3.1500000953674316) THEN CASE WHEN (`ADS`.`Feature_1` <= 2.25) THEN 4 ELSE 5 END ELSE CASE WHEN (`ADS`.`Feature_0` <= 5.949999809265137) THEN 7 ELSE 8 END END END AS `node_id_2` 
FROM `iris` AS `ADS`), 
`DT_node_data_30` AS 
(SELECT `Values`.`nid` AS `nid`, CAST(`Values`.`E` AS DOUBLE) AS `E` 
...
-- Code For temporary table tmp_20180602152808_ty2_gb_b3 part 2. Populate

SELECT * FROM `tmp_20180602152808_ty2_gb_b3`

-- Code For temporary table tmp_20180602152808_vzu_gb_b4 part 1. Create 

CREATE TEMPORARY TABLE `tmp_20180602152808_vzu_gb_b4` STORED AS ORC AS WITH `DT_node_lookup_40` AS 
(SELECT `ADS`.`KEY` AS `KEY`, CASE WHEN (`ADS`.`Feature_2` <= 4.949999809265137) THEN CASE WHEN (`ADS`.`Feature_2` <= 2.450000047683716) THEN 2 ELSE CASE WHEN (`ADS`.`Feature_3` <= 1.6500000953674316) THEN 4 ELSE 5 END END ELSE CASE WHEN (`ADS`.`Feature_1` <= 2.3499999046325684) THEN 7 ELSE CASE WHEN (`ADS`.`Feature_2` <= 5.050000190734863) THEN 9 ELSE 10 END END END AS `node_id_2` 
FROM `iris` AS `ADS`), 
`DT_node_data_40` AS 
(SELECT `Values`.`nid` AS `nid`, CAST(`Values`.`E` AS DOUBLE) AS `E` 
...
-- Code For temporary table tmp_20180602152808_vzu_gb_b4 part 2. Populate

SELECT * FROM `tmp_20180602152808_vzu_gb_b4`

-- Code For temporary table tmp_20180602152808_lyr_gb_sum part 1. Create 

CREATE TEMPORARY TABLE `tmp_20180602152808_lyr_gb_sum` STORED AS ORC AS WITH `GB_Union` AS 
...
FROM `tmp_20180602152808_arn_gb_b0` AS `GB_B0` UNION ALL SELECT `GB_B1`.`KEY` AS `KEY`, `GB_B1`.`Score_0` AS `Score_0`, `GB_B1`.`Score_1` AS `Score_1`, `GB_B1`.`Score_2` AS `Score_2` 
FROM `tmp_20180602152808_teb_gb_b1` AS `GB_B1` UNION ALL SELECT `GB_B2`.`KEY` AS `KEY`, `GB_B2`.`Score_0` AS `Score_0`, `GB_B2`.`Score_1` AS `Score_1`, `GB_B2`.`Score_2` AS `Score_2` 
FROM `tmp_20180602152808_8a6_gb_b2` AS `GB_B2` UNION ALL SELECT `GB_B3`.`KEY` AS `KEY`, `GB_B3`.`Score_0` AS `Score_0`, `GB_B3`.`Score_1` AS `Score_1`, `GB_B3`.`Score_2` AS `Score_2` 
FROM `tmp_20180602152808_ty2_gb_b3` AS `GB_B3` UNION ALL SELECT `GB_B4`.`KEY` AS `KEY`, `GB_B4`.`Score_0` AS `Score_0`, `GB_B4`.`Score_1` AS `Score_1`, `GB_B4`.`Score_2` AS `Score_2` 
FROM `tmp_20180602152808_vzu_gb_b4` AS `GB_B4`) AS `GB_EnsembleUnion`)
...
-- Code For temporary table tmp_20180602152808_lyr_gb_sum part 2. Populate

SELECT * FROM `tmp_20180602152808_lyr_gb_sum`
...
FROM `tmp_20180602152808_lyr_gb_sum` AS `GB_sum`), 
