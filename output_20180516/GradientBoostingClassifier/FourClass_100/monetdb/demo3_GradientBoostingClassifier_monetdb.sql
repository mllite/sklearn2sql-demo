...
-- Code For temporary table tmp_20180508181731_codegen_f6czyq_gb_b0 part 1. Create 


CREATE TEMPORARY TABLE tmp_20180508181731_codegen_f6czyq_gb_b0 (
	"KEY" BIGINT, 
	"Score_0" DOUBLE, 
	"Score_1" DOUBLE, 
	"Score_2" DOUBLE, 
...
-- Code For temporary table tmp_20180508181731_codegen_f6czyq_gb_b0 part 2. Populate

INSERT INTO tmp_20180508181731_codegen_f6czyq_gb_b0 ("KEY", "Score_0", "Score_1", "Score_2", "Score_3") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1", "U"."Score_2", "U"."Score_3" 
...
-- Code For temporary table tmp_20180508181731_codegen_zeiiob_gb_b1 part 1. Create 


CREATE TEMPORARY TABLE tmp_20180508181731_codegen_zeiiob_gb_b1 (
	"KEY" BIGINT, 
	"Score_0" DOUBLE, 
	"Score_1" DOUBLE, 
	"Score_2" DOUBLE, 
...
-- Code For temporary table tmp_20180508181731_codegen_zeiiob_gb_b1 part 2. Populate

INSERT INTO tmp_20180508181731_codegen_zeiiob_gb_b1 ("KEY", "Score_0", "Score_1", "Score_2", "Score_3") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1", "U"."Score_2", "U"."Score_3" 
...
-- Code For temporary table tmp_20180508181731_codegen_gf91lr_gb_b2 part 1. Create 


CREATE TEMPORARY TABLE tmp_20180508181731_codegen_gf91lr_gb_b2 (
	"KEY" BIGINT, 
	"Score_0" DOUBLE, 
	"Score_1" DOUBLE, 
	"Score_2" DOUBLE, 
...
-- Code For temporary table tmp_20180508181731_codegen_gf91lr_gb_b2 part 2. Populate

INSERT INTO tmp_20180508181731_codegen_gf91lr_gb_b2 ("KEY", "Score_0", "Score_1", "Score_2", "Score_3") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1", "U"."Score_2", "U"."Score_3" 
...
-- Code For temporary table tmp_20180508181731_codegen_yjm7jw_gb_b3 part 1. Create 


CREATE TEMPORARY TABLE tmp_20180508181731_codegen_yjm7jw_gb_b3 (
	"KEY" BIGINT, 
	"Score_0" DOUBLE, 
	"Score_1" DOUBLE, 
	"Score_2" DOUBLE, 
...
-- Code For temporary table tmp_20180508181731_codegen_yjm7jw_gb_b3 part 2. Populate

INSERT INTO tmp_20180508181731_codegen_yjm7jw_gb_b3 ("KEY", "Score_0", "Score_1", "Score_2", "Score_3") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1", "U"."Score_2", "U"."Score_3" 
...
-- Code For temporary table tmp_20180508181731_codegen_v7871p_gb_b4 part 1. Create 


CREATE TEMPORARY TABLE tmp_20180508181731_codegen_v7871p_gb_b4 (
	"KEY" BIGINT, 
	"Score_0" DOUBLE, 
	"Score_1" DOUBLE, 
	"Score_2" DOUBLE, 
...
-- Code For temporary table tmp_20180508181731_codegen_v7871p_gb_b4 part 2. Populate

INSERT INTO tmp_20180508181731_codegen_v7871p_gb_b4 ("KEY", "Score_0", "Score_1", "Score_2", "Score_3") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1", "U"."Score_2", "U"."Score_3" 
...
-- Code For temporary table tmp_20180508181731_codegen_gsptda_gb_b5 part 1. Create 


CREATE TEMPORARY TABLE tmp_20180508181731_codegen_gsptda_gb_b5 (
	"KEY" BIGINT, 
	"Score_0" DOUBLE, 
	"Score_1" DOUBLE, 
	"Score_2" DOUBLE, 
...
-- Code For temporary table tmp_20180508181731_codegen_gsptda_gb_b5 part 2. Populate

INSERT INTO tmp_20180508181731_codegen_gsptda_gb_b5 ("KEY", "Score_0", "Score_1", "Score_2", "Score_3") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1", "U"."Score_2", "U"."Score_3" 
...
-- Code For temporary table tmp_20180508181731_codegen_qr7c3e_gb_b6 part 1. Create 


CREATE TEMPORARY TABLE tmp_20180508181731_codegen_qr7c3e_gb_b6 (
	"KEY" BIGINT, 
	"Score_0" DOUBLE, 
	"Score_1" DOUBLE, 
	"Score_2" DOUBLE, 
...
-- Code For temporary table tmp_20180508181731_codegen_qr7c3e_gb_b6 part 2. Populate

INSERT INTO tmp_20180508181731_codegen_qr7c3e_gb_b6 ("KEY", "Score_0", "Score_1", "Score_2", "Score_3") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1", "U"."Score_2", "U"."Score_3" 
...
-- Code For temporary table tmp_20180508181731_codegen_ydm6b1_gb_union part 1. Create 


CREATE TEMPORARY TABLE tmp_20180508181731_codegen_ydm6b1_gb_union (
	"KEY" BIGINT, 
	"Score_0" DOUBLE, 
	"Score_1" DOUBLE, 
	"Score_2" DOUBLE, 
...
-- Code For temporary table tmp_20180508181731_codegen_ydm6b1_gb_union part 2. Populate

INSERT INTO tmp_20180508181731_codegen_ydm6b1_gb_union ("KEY", "Score_0", "Score_1", "Score_2", "Score_3") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1", "U"."Score_2", "U"."Score_3" 
...
FROM tmp_20180508181731_codegen_f6czyq_gb_b0 AS "GB_B0" UNION ALL SELECT "GB_B1"."KEY" AS "KEY", "GB_B1"."Score_0" AS "Score_0", "GB_B1"."Score_1" AS "Score_1", "GB_B1"."Score_2" AS "Score_2", "GB_B1"."Score_3" AS "Score_3" 
FROM tmp_20180508181731_codegen_zeiiob_gb_b1 AS "GB_B1" UNION ALL SELECT "GB_B2"."KEY" AS "KEY", "GB_B2"."Score_0" AS "Score_0", "GB_B2"."Score_1" AS "Score_1", "GB_B2"."Score_2" AS "Score_2", "GB_B2"."Score_3" AS "Score_3" 
FROM tmp_20180508181731_codegen_gf91lr_gb_b2 AS "GB_B2" UNION ALL SELECT "GB_B3"."KEY" AS "KEY", "GB_B3"."Score_0" AS "Score_0", "GB_B3"."Score_1" AS "Score_1", "GB_B3"."Score_2" AS "Score_2", "GB_B3"."Score_3" AS "Score_3" 
FROM tmp_20180508181731_codegen_yjm7jw_gb_b3 AS "GB_B3" UNION ALL SELECT "GB_B4"."KEY" AS "KEY", "GB_B4"."Score_0" AS "Score_0", "GB_B4"."Score_1" AS "Score_1", "GB_B4"."Score_2" AS "Score_2", "GB_B4"."Score_3" AS "Score_3" 
FROM tmp_20180508181731_codegen_v7871p_gb_b4 AS "GB_B4" UNION ALL SELECT "GB_B5"."KEY" AS "KEY", "GB_B5"."Score_0" AS "Score_0", "GB_B5"."Score_1" AS "Score_1", "GB_B5"."Score_2" AS "Score_2", "GB_B5"."Score_3" AS "Score_3" 
FROM tmp_20180508181731_codegen_gsptda_gb_b5 AS "GB_B5" UNION ALL SELECT "GB_B6"."KEY" AS "KEY", "GB_B6"."Score_0" AS "Score_0", "GB_B6"."Score_1" AS "Score_1", "GB_B6"."Score_2" AS "Score_2", "GB_B6"."Score_3" AS "Score_3" 
FROM tmp_20180508181731_codegen_qr7c3e_gb_b6 AS "GB_B6") AS "GB_EnsembleUnion") AS "GB_Union") AS "U"

-- Code For temporary table tmp_20180508181731_codegen_szem1e_gb_sum part 1. Create 


CREATE TEMPORARY TABLE tmp_20180508181731_codegen_szem1e_gb_sum (
	"KEY" BIGINT, 
	"Score_0" DOUBLE, 
	"Score_1" DOUBLE, 
	"Score_2" DOUBLE, 
...
-- Code For temporary table tmp_20180508181731_codegen_szem1e_gb_sum part 2. Populate

INSERT INTO tmp_20180508181731_codegen_szem1e_gb_sum ("KEY", "Score_0", "Score_1", "Score_2", "Score_3") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1", "U"."Score_2", "U"."Score_3" 
...
FROM tmp_20180508181731_codegen_ydm6b1_gb_union AS "GB_Union" GROUP BY "GB_Union"."KEY") AS "T") AS "GB_sum") AS "U"
...
FROM tmp_20180508181731_codegen_szem1e_gb_sum AS "GB_sum"), 
