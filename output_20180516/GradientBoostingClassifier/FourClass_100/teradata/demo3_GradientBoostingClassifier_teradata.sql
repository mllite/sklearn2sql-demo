...
-- Code For temporary table tmp_20180508181732_codegen_ktg50g_gb_b0 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180508181732_codegen_ktg50g_gb_b0  (
	"KEY" BIGINT, 
...
-- Code For temporary table tmp_20180508181732_codegen_ktg50g_gb_b0 part 2. Populate

INSERT INTO tmp_20180508181732_codegen_ktg50g_gb_b0 ("KEY", "Score_0", "Score_1", "Score_2", "Score_3") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1", "U"."Score_2", "U"."Score_3" 
...
-- Code For temporary table tmp_20180508181732_codegen_k88jsq_gb_b1 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180508181732_codegen_k88jsq_gb_b1  (
	"KEY" BIGINT, 
	"Score_0" DOUBLE PRECISION, 
	"Score_1" DOUBLE PRECISION, 
	"Score_2" DOUBLE PRECISION, 
...
-- Code For temporary table tmp_20180508181732_codegen_k88jsq_gb_b1 part 2. Populate

INSERT INTO tmp_20180508181732_codegen_k88jsq_gb_b1 ("KEY", "Score_0", "Score_1", "Score_2", "Score_3") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1", "U"."Score_2", "U"."Score_3" 
...
-- Code For temporary table tmp_20180508181732_codegen_6agiqm_gb_b2 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180508181732_codegen_6agiqm_gb_b2  (
	"KEY" BIGINT, 
	"Score_0" DOUBLE PRECISION, 
	"Score_1" DOUBLE PRECISION, 
	"Score_2" DOUBLE PRECISION, 
...
-- Code For temporary table tmp_20180508181732_codegen_6agiqm_gb_b2 part 2. Populate

INSERT INTO tmp_20180508181732_codegen_6agiqm_gb_b2 ("KEY", "Score_0", "Score_1", "Score_2", "Score_3") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1", "U"."Score_2", "U"."Score_3" 
...
-- Code For temporary table tmp_20180508181732_codegen_rv3mu3_gb_b3 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180508181732_codegen_rv3mu3_gb_b3  (
	"KEY" BIGINT, 
	"Score_0" DOUBLE PRECISION, 
	"Score_1" DOUBLE PRECISION, 
	"Score_2" DOUBLE PRECISION, 
...
-- Code For temporary table tmp_20180508181732_codegen_rv3mu3_gb_b3 part 2. Populate

INSERT INTO tmp_20180508181732_codegen_rv3mu3_gb_b3 ("KEY", "Score_0", "Score_1", "Score_2", "Score_3") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1", "U"."Score_2", "U"."Score_3" 
...
-- Code For temporary table tmp_20180508181732_codegen_7ln3g5_gb_b4 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180508181732_codegen_7ln3g5_gb_b4  (
	"KEY" BIGINT, 
	"Score_0" DOUBLE PRECISION, 
	"Score_1" DOUBLE PRECISION, 
	"Score_2" DOUBLE PRECISION, 
...
-- Code For temporary table tmp_20180508181732_codegen_7ln3g5_gb_b4 part 2. Populate

INSERT INTO tmp_20180508181732_codegen_7ln3g5_gb_b4 ("KEY", "Score_0", "Score_1", "Score_2", "Score_3") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1", "U"."Score_2", "U"."Score_3" 
...
-- Code For temporary table tmp_20180508181732_codegen_dx4g2t_gb_b5 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180508181732_codegen_dx4g2t_gb_b5  (
	"KEY" BIGINT, 
	"Score_0" DOUBLE PRECISION, 
	"Score_1" DOUBLE PRECISION, 
	"Score_2" DOUBLE PRECISION, 
...
-- Code For temporary table tmp_20180508181732_codegen_dx4g2t_gb_b5 part 2. Populate

INSERT INTO tmp_20180508181732_codegen_dx4g2t_gb_b5 ("KEY", "Score_0", "Score_1", "Score_2", "Score_3") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1", "U"."Score_2", "U"."Score_3" 
...
-- Code For temporary table tmp_20180508181732_codegen_yat8mx_gb_b6 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180508181732_codegen_yat8mx_gb_b6  (
	"KEY" BIGINT, 
	"Score_0" DOUBLE PRECISION, 
	"Score_1" DOUBLE PRECISION, 
	"Score_2" DOUBLE PRECISION, 
...
-- Code For temporary table tmp_20180508181732_codegen_yat8mx_gb_b6 part 2. Populate

INSERT INTO tmp_20180508181732_codegen_yat8mx_gb_b6 ("KEY", "Score_0", "Score_1", "Score_2", "Score_3") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1", "U"."Score_2", "U"."Score_3" 
...
-- Code For temporary table tmp_20180508181732_codegen_pbtmxq_gb_union part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180508181732_codegen_pbtmxq_gb_union  (
	"KEY" BIGINT, 
	"Score_0" DOUBLE PRECISION, 
	"Score_1" DOUBLE PRECISION, 
	"Score_2" DOUBLE PRECISION, 
...
-- Code For temporary table tmp_20180508181732_codegen_pbtmxq_gb_union part 2. Populate

INSERT INTO tmp_20180508181732_codegen_pbtmxq_gb_union ("KEY", "Score_0", "Score_1", "Score_2", "Score_3") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1", "U"."Score_2", "U"."Score_3" 
...
FROM tmp_20180508181732_codegen_ktg50g_gb_b0 AS "GB_B0" UNION ALL SELECT "GB_B1"."KEY" AS "KEY", "GB_B1"."Score_0" AS "Score_0", "GB_B1"."Score_1" AS "Score_1", "GB_B1"."Score_2" AS "Score_2", "GB_B1"."Score_3" AS "Score_3" 
FROM tmp_20180508181732_codegen_k88jsq_gb_b1 AS "GB_B1" UNION ALL SELECT "GB_B2"."KEY" AS "KEY", "GB_B2"."Score_0" AS "Score_0", "GB_B2"."Score_1" AS "Score_1", "GB_B2"."Score_2" AS "Score_2", "GB_B2"."Score_3" AS "Score_3" 
FROM tmp_20180508181732_codegen_6agiqm_gb_b2 AS "GB_B2" UNION ALL SELECT "GB_B3"."KEY" AS "KEY", "GB_B3"."Score_0" AS "Score_0", "GB_B3"."Score_1" AS "Score_1", "GB_B3"."Score_2" AS "Score_2", "GB_B3"."Score_3" AS "Score_3" 
FROM tmp_20180508181732_codegen_rv3mu3_gb_b3 AS "GB_B3" UNION ALL SELECT "GB_B4"."KEY" AS "KEY", "GB_B4"."Score_0" AS "Score_0", "GB_B4"."Score_1" AS "Score_1", "GB_B4"."Score_2" AS "Score_2", "GB_B4"."Score_3" AS "Score_3" 
FROM tmp_20180508181732_codegen_7ln3g5_gb_b4 AS "GB_B4" UNION ALL SELECT "GB_B5"."KEY" AS "KEY", "GB_B5"."Score_0" AS "Score_0", "GB_B5"."Score_1" AS "Score_1", "GB_B5"."Score_2" AS "Score_2", "GB_B5"."Score_3" AS "Score_3" 
FROM tmp_20180508181732_codegen_dx4g2t_gb_b5 AS "GB_B5" UNION ALL SELECT "GB_B6"."KEY" AS "KEY", "GB_B6"."Score_0" AS "Score_0", "GB_B6"."Score_1" AS "Score_1", "GB_B6"."Score_2" AS "Score_2", "GB_B6"."Score_3" AS "Score_3" 
FROM tmp_20180508181732_codegen_yat8mx_gb_b6 AS "GB_B6") AS "GB_EnsembleUnion") AS "GB_Union") AS "U"

-- Code For temporary table tmp_20180508181732_codegen_mik5zq_gb_sum part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180508181732_codegen_mik5zq_gb_sum  (
	"KEY" BIGINT, 
	"Score_0" DOUBLE PRECISION, 
	"Score_1" DOUBLE PRECISION, 
	"Score_2" DOUBLE PRECISION, 
...
-- Code For temporary table tmp_20180508181732_codegen_mik5zq_gb_sum part 2. Populate

INSERT INTO tmp_20180508181732_codegen_mik5zq_gb_sum ("KEY", "Score_0", "Score_1", "Score_2", "Score_3") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1", "U"."Score_2", "U"."Score_3" 
...
FROM tmp_20180508181732_codegen_pbtmxq_gb_union AS "GB_Union" GROUP BY "GB_Union"."KEY") AS "T") AS "GB_sum") AS "U"
...
FROM tmp_20180508181732_codegen_mik5zq_gb_sum AS "GB_sum"), 
