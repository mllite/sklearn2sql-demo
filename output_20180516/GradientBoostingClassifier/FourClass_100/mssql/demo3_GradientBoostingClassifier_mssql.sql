...
-- Code For temporary table ##TMP_20180516113020_CODEGEN_R8NQ4S_GB_B0 part 1. Create 


CREATE TABLE ##TMP_20180516113020_CODEGEN_R8NQ4S_GB_B0 (
	[KEY] BIGINT NULL, 
...
-- Code For temporary table ##TMP_20180516113020_CODEGEN_R8NQ4S_GB_B0 part 2. Populate
...
FROM [DT_Output_9])
 INSERT INTO ##TMP_20180516113020_CODEGEN_R8NQ4S_GB_B0 ([KEY], [Score_0], [Score_1], [Score_2], [Score_3]) SELECT [GB_B0].[KEY], [GB_B0].[Score_0], [GB_B0].[Score_1], [GB_B0].[Score_2], [GB_B0].[Score_3] 
...
-- Code For temporary table ##TMP_20180516113020_CODEGEN_AUZ65W_GB_B1 part 1. Create 


CREATE TABLE ##TMP_20180516113020_CODEGEN_AUZ65W_GB_B1 (
	[KEY] BIGINT NULL, 
	[Score_0] FLOAT(53) NULL, 
	[Score_1] FLOAT(53) NULL, 
	[Score_2] FLOAT(53) NULL, 
...
-- Code For temporary table ##TMP_20180516113020_CODEGEN_AUZ65W_GB_B1 part 2. Populate
...
FROM [DT_Output_19])
 INSERT INTO ##TMP_20180516113020_CODEGEN_AUZ65W_GB_B1 ([KEY], [Score_0], [Score_1], [Score_2], [Score_3]) SELECT [GB_B1].[KEY], [GB_B1].[Score_0], [GB_B1].[Score_1], [GB_B1].[Score_2], [GB_B1].[Score_3] 
...
-- Code For temporary table ##TMP_20180516113020_CODEGEN_O130W4_GB_B2 part 1. Create 


CREATE TABLE ##TMP_20180516113020_CODEGEN_O130W4_GB_B2 (
	[KEY] BIGINT NULL, 
	[Score_0] FLOAT(53) NULL, 
	[Score_1] FLOAT(53) NULL, 
	[Score_2] FLOAT(53) NULL, 
...
-- Code For temporary table ##TMP_20180516113020_CODEGEN_O130W4_GB_B2 part 2. Populate
...
FROM [DT_Output_29])
 INSERT INTO ##TMP_20180516113020_CODEGEN_O130W4_GB_B2 ([KEY], [Score_0], [Score_1], [Score_2], [Score_3]) SELECT [GB_B2].[KEY], [GB_B2].[Score_0], [GB_B2].[Score_1], [GB_B2].[Score_2], [GB_B2].[Score_3] 
...
-- Code For temporary table ##TMP_20180516113020_CODEGEN_L1Y68H_GB_B3 part 1. Create 


CREATE TABLE ##TMP_20180516113020_CODEGEN_L1Y68H_GB_B3 (
	[KEY] BIGINT NULL, 
	[Score_0] FLOAT(53) NULL, 
	[Score_1] FLOAT(53) NULL, 
	[Score_2] FLOAT(53) NULL, 
...
-- Code For temporary table ##TMP_20180516113020_CODEGEN_L1Y68H_GB_B3 part 2. Populate
...
FROM [DT_Output_39])
 INSERT INTO ##TMP_20180516113020_CODEGEN_L1Y68H_GB_B3 ([KEY], [Score_0], [Score_1], [Score_2], [Score_3]) SELECT [GB_B3].[KEY], [GB_B3].[Score_0], [GB_B3].[Score_1], [GB_B3].[Score_2], [GB_B3].[Score_3] 
...
-- Code For temporary table ##TMP_20180516113020_CODEGEN_0CC62Z_GB_B4 part 1. Create 


CREATE TABLE ##TMP_20180516113020_CODEGEN_0CC62Z_GB_B4 (
	[KEY] BIGINT NULL, 
	[Score_0] FLOAT(53) NULL, 
	[Score_1] FLOAT(53) NULL, 
	[Score_2] FLOAT(53) NULL, 
...
-- Code For temporary table ##TMP_20180516113020_CODEGEN_0CC62Z_GB_B4 part 2. Populate
...
FROM [DT_Output_49])
 INSERT INTO ##TMP_20180516113020_CODEGEN_0CC62Z_GB_B4 ([KEY], [Score_0], [Score_1], [Score_2], [Score_3]) SELECT [GB_B4].[KEY], [GB_B4].[Score_0], [GB_B4].[Score_1], [GB_B4].[Score_2], [GB_B4].[Score_3] 
...
-- Code For temporary table ##TMP_20180516113020_CODEGEN_OXLZU6_GB_B5 part 1. Create 


CREATE TABLE ##TMP_20180516113020_CODEGEN_OXLZU6_GB_B5 (
	[KEY] BIGINT NULL, 
	[Score_0] FLOAT(53) NULL, 
	[Score_1] FLOAT(53) NULL, 
	[Score_2] FLOAT(53) NULL, 
...
-- Code For temporary table ##TMP_20180516113020_CODEGEN_OXLZU6_GB_B5 part 2. Populate
...
FROM [DT_Output_59])
 INSERT INTO ##TMP_20180516113020_CODEGEN_OXLZU6_GB_B5 ([KEY], [Score_0], [Score_1], [Score_2], [Score_3]) SELECT [GB_B5].[KEY], [GB_B5].[Score_0], [GB_B5].[Score_1], [GB_B5].[Score_2], [GB_B5].[Score_3] 
...
-- Code For temporary table ##TMP_20180516113020_CODEGEN_16PARE_GB_B6 part 1. Create 


CREATE TABLE ##TMP_20180516113020_CODEGEN_16PARE_GB_B6 (
	[KEY] BIGINT NULL, 
	[Score_0] FLOAT(53) NULL, 
	[Score_1] FLOAT(53) NULL, 
	[Score_2] FLOAT(53) NULL, 
...
-- Code For temporary table ##TMP_20180516113020_CODEGEN_16PARE_GB_B6 part 2. Populate
...
FROM [DT_Output_63])
 INSERT INTO ##TMP_20180516113020_CODEGEN_16PARE_GB_B6 ([KEY], [Score_0], [Score_1], [Score_2], [Score_3]) SELECT [GB_B6].[KEY], [GB_B6].[Score_0], [GB_B6].[Score_1], [GB_B6].[Score_2], [GB_B6].[Score_3] 
...
-- Code For temporary table ##TMP_20180516113020_CODEGEN_Z0PP1L_GB_sum part 1. Create 


CREATE TABLE ##TMP_20180516113020_CODEGEN_Z0PP1L_GB_sum (
	[KEY] BIGINT NULL, 
	[Score_0] FLOAT(53) NULL, 
	[Score_1] FLOAT(53) NULL, 
	[Score_2] FLOAT(53) NULL, 
...
-- Code For temporary table ##TMP_20180516113020_CODEGEN_Z0PP1L_GB_sum part 2. Populate
...
FROM ##TMP_20180516113020_CODEGEN_R8NQ4S_GB_B0 AS [GB_B0] UNION ALL SELECT [GB_B1].[KEY] AS [KEY], [GB_B1].[Score_0] AS [Score_0], [GB_B1].[Score_1] AS [Score_1], [GB_B1].[Score_2] AS [Score_2], [GB_B1].[Score_3] AS [Score_3] 
FROM ##TMP_20180516113020_CODEGEN_AUZ65W_GB_B1 AS [GB_B1] UNION ALL SELECT [GB_B2].[KEY] AS [KEY], [GB_B2].[Score_0] AS [Score_0], [GB_B2].[Score_1] AS [Score_1], [GB_B2].[Score_2] AS [Score_2], [GB_B2].[Score_3] AS [Score_3] 
FROM ##TMP_20180516113020_CODEGEN_O130W4_GB_B2 AS [GB_B2] UNION ALL SELECT [GB_B3].[KEY] AS [KEY], [GB_B3].[Score_0] AS [Score_0], [GB_B3].[Score_1] AS [Score_1], [GB_B3].[Score_2] AS [Score_2], [GB_B3].[Score_3] AS [Score_3] 
FROM ##TMP_20180516113020_CODEGEN_L1Y68H_GB_B3 AS [GB_B3] UNION ALL SELECT [GB_B4].[KEY] AS [KEY], [GB_B4].[Score_0] AS [Score_0], [GB_B4].[Score_1] AS [Score_1], [GB_B4].[Score_2] AS [Score_2], [GB_B4].[Score_3] AS [Score_3] 
FROM ##TMP_20180516113020_CODEGEN_0CC62Z_GB_B4 AS [GB_B4] UNION ALL SELECT [GB_B5].[KEY] AS [KEY], [GB_B5].[Score_0] AS [Score_0], [GB_B5].[Score_1] AS [Score_1], [GB_B5].[Score_2] AS [Score_2], [GB_B5].[Score_3] AS [Score_3] 
FROM ##TMP_20180516113020_CODEGEN_OXLZU6_GB_B5 AS [GB_B5] UNION ALL SELECT [GB_B6].[KEY] AS [KEY], [GB_B6].[Score_0] AS [Score_0], [GB_B6].[Score_1] AS [Score_1], [GB_B6].[Score_2] AS [Score_2], [GB_B6].[Score_3] AS [Score_3] 
FROM ##TMP_20180516113020_CODEGEN_16PARE_GB_B6 AS [GB_B6]) AS [GB_EnsembleUnion])
 INSERT INTO ##TMP_20180516113020_CODEGEN_Z0PP1L_GB_sum ([KEY], [Score_0], [Score_1], [Score_2], [Score_3]) SELECT [GB_sum].[KEY], [GB_sum].[Score_0], [GB_sum].[Score_1], [GB_sum].[Score_2], [GB_sum].[Score_3] 
...
FROM ##TMP_20180516113020_CODEGEN_Z0PP1L_GB_sum AS [GB_sum]), 
