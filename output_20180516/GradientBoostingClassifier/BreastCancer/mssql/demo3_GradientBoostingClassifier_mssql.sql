...
-- Code For temporary table ##TMP_20180516111650_CODEGEN_O8WUZZ_GB_B0 part 1. Create 


CREATE TABLE ##TMP_20180516111650_CODEGEN_O8WUZZ_GB_B0 (
	[KEY] BIGINT NULL, 
...
-- Code For temporary table ##TMP_20180516111650_CODEGEN_O8WUZZ_GB_B0 part 2. Populate
...
FROM [DT_Output_4])
 INSERT INTO ##TMP_20180516111650_CODEGEN_O8WUZZ_GB_B0 ([KEY], [Score_0], [Score_1]) SELECT [GB_B0].[KEY], [GB_B0].[Score_0], [GB_B0].[Score_1] 
...
-- Code For temporary table ##TMP_20180516111650_CODEGEN_5QSTP9_GB_B1 part 1. Create 


CREATE TABLE ##TMP_20180516111650_CODEGEN_5QSTP9_GB_B1 (
	[KEY] BIGINT NULL, 
	[Score_0] FLOAT(53) NULL, 
	[Score_1] FLOAT(53) NULL
)
...
-- Code For temporary table ##TMP_20180516111650_CODEGEN_5QSTP9_GB_B1 part 2. Populate
...
FROM [DT_Output_9])
 INSERT INTO ##TMP_20180516111650_CODEGEN_5QSTP9_GB_B1 ([KEY], [Score_0], [Score_1]) SELECT [GB_B1].[KEY], [GB_B1].[Score_0], [GB_B1].[Score_1] 
...
-- Code For temporary table ##TMP_20180516111650_CODEGEN_FBW2B1_GB_B2 part 1. Create 


CREATE TABLE ##TMP_20180516111650_CODEGEN_FBW2B1_GB_B2 (
	[KEY] BIGINT NULL, 
	[Score_0] FLOAT(53) NULL, 
	[Score_1] FLOAT(53) NULL
)
...
-- Code For temporary table ##TMP_20180516111650_CODEGEN_FBW2B1_GB_B2 part 2. Populate
...
FROM [DT_Output_14])
 INSERT INTO ##TMP_20180516111650_CODEGEN_FBW2B1_GB_B2 ([KEY], [Score_0], [Score_1]) SELECT [GB_B2].[KEY], [GB_B2].[Score_0], [GB_B2].[Score_1] 
...
-- Code For temporary table ##TMP_20180516111650_CODEGEN_ZAL34P_GB_B3 part 1. Create 


CREATE TABLE ##TMP_20180516111650_CODEGEN_ZAL34P_GB_B3 (
	[KEY] BIGINT NULL, 
	[Score_0] FLOAT(53) NULL, 
	[Score_1] FLOAT(53) NULL
)
...
-- Code For temporary table ##TMP_20180516111650_CODEGEN_ZAL34P_GB_B3 part 2. Populate
...
FROM [DT_Output_15])
 INSERT INTO ##TMP_20180516111650_CODEGEN_ZAL34P_GB_B3 ([KEY], [Score_0], [Score_1]) SELECT [GB_B3].[KEY], [GB_B3].[Score_0], [GB_B3].[Score_1] 
...
-- Code For temporary table ##TMP_20180516111650_CODEGEN_FROTC7_GB_sum part 1. Create 


CREATE TABLE ##TMP_20180516111650_CODEGEN_FROTC7_GB_sum (
	[KEY] BIGINT NULL, 
	[Score_0] FLOAT(53) NULL, 
	[Score_1] FLOAT(53) NULL
)
...
-- Code For temporary table ##TMP_20180516111650_CODEGEN_FROTC7_GB_sum part 2. Populate
...
FROM ##TMP_20180516111650_CODEGEN_O8WUZZ_GB_B0 AS [GB_B0] UNION ALL SELECT [GB_B1].[KEY] AS [KEY], [GB_B1].[Score_0] AS [Score_0], [GB_B1].[Score_1] AS [Score_1] 
FROM ##TMP_20180516111650_CODEGEN_5QSTP9_GB_B1 AS [GB_B1] UNION ALL SELECT [GB_B2].[KEY] AS [KEY], [GB_B2].[Score_0] AS [Score_0], [GB_B2].[Score_1] AS [Score_1] 
FROM ##TMP_20180516111650_CODEGEN_FBW2B1_GB_B2 AS [GB_B2] UNION ALL SELECT [GB_B3].[KEY] AS [KEY], [GB_B3].[Score_0] AS [Score_0], [GB_B3].[Score_1] AS [Score_1] 
FROM ##TMP_20180516111650_CODEGEN_ZAL34P_GB_B3 AS [GB_B3]) AS [GB_EnsembleUnion])
 INSERT INTO ##TMP_20180516111650_CODEGEN_FROTC7_GB_sum ([KEY], [Score_0], [Score_1]) SELECT [GB_sum].[KEY], [GB_sum].[Score_0], [GB_sum].[Score_1] 
...
FROM ##TMP_20180516111650_CODEGEN_FROTC7_GB_sum AS [GB_sum]), 
