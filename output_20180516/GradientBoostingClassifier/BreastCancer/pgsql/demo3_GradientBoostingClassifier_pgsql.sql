...
-- Code For temporary table TMP_20180602142508_6H0_GB_B0 part 1. Create 


CREATE TEMPORARY TABLE "TMP_20180602142508_6H0_GB_B0" (
	"KEY" BIGINT, 
	"Score_0" FLOAT, 
	"Score_1" FLOAT
)
...
-- Code For temporary table TMP_20180602142508_6H0_GB_B0 part 2. Populate
...
FROM "DT_Output_4")
 INSERT INTO "TMP_20180602142508_6H0_GB_B0" ("KEY", "Score_0", "Score_1") SELECT "GB_B0"."KEY", "GB_B0"."Score_0", "GB_B0"."Score_1" 
...
-- Code For temporary table TMP_20180602142508_YEI_GB_B1 part 1. Create 


CREATE TEMPORARY TABLE "TMP_20180602142508_YEI_GB_B1" (
	"KEY" BIGINT, 
	"Score_0" FLOAT, 
	"Score_1" FLOAT
)
...
-- Code For temporary table TMP_20180602142508_YEI_GB_B1 part 2. Populate
...
FROM "DT_Output_9")
 INSERT INTO "TMP_20180602142508_YEI_GB_B1" ("KEY", "Score_0", "Score_1") SELECT "GB_B1"."KEY", "GB_B1"."Score_0", "GB_B1"."Score_1" 
...
-- Code For temporary table TMP_20180602142508_Q26_GB_B2 part 1. Create 


CREATE TEMPORARY TABLE "TMP_20180602142508_Q26_GB_B2" (
	"KEY" BIGINT, 
	"Score_0" FLOAT, 
	"Score_1" FLOAT
)
...
-- Code For temporary table TMP_20180602142508_Q26_GB_B2 part 2. Populate
...
FROM "DT_Output_14")
 INSERT INTO "TMP_20180602142508_Q26_GB_B2" ("KEY", "Score_0", "Score_1") SELECT "GB_B2"."KEY", "GB_B2"."Score_0", "GB_B2"."Score_1" 
...
-- Code For temporary table TMP_20180602142508_PCJ_GB_B3 part 1. Create 


CREATE TEMPORARY TABLE "TMP_20180602142508_PCJ_GB_B3" (
	"KEY" BIGINT, 
	"Score_0" FLOAT, 
	"Score_1" FLOAT
)
...
-- Code For temporary table TMP_20180602142508_PCJ_GB_B3 part 2. Populate
...
FROM "DT_Output_15")
 INSERT INTO "TMP_20180602142508_PCJ_GB_B3" ("KEY", "Score_0", "Score_1") SELECT "GB_B3"."KEY", "GB_B3"."Score_0", "GB_B3"."Score_1" 
...
-- Code For temporary table TMP_20180602142508_KGC_GB_sum part 1. Create 


CREATE TEMPORARY TABLE "TMP_20180602142508_KGC_GB_sum" (
	"KEY" BIGINT NOT NULL, 
	"Score_0" FLOAT, 
	"Score_1" FLOAT, 
	PRIMARY KEY ("KEY")
...
-- Code For temporary table TMP_20180602142508_KGC_GB_sum part 2. Populate
...
FROM "TMP_20180602142508_6H0_GB_B0" AS "GB_B0" UNION ALL SELECT "GB_B1"."KEY" AS "KEY", "GB_B1"."Score_0" AS "Score_0", "GB_B1"."Score_1" AS "Score_1" 
FROM "TMP_20180602142508_YEI_GB_B1" AS "GB_B1" UNION ALL SELECT "GB_B2"."KEY" AS "KEY", "GB_B2"."Score_0" AS "Score_0", "GB_B2"."Score_1" AS "Score_1" 
FROM "TMP_20180602142508_Q26_GB_B2" AS "GB_B2" UNION ALL SELECT "GB_B3"."KEY" AS "KEY", "GB_B3"."Score_0" AS "Score_0", "GB_B3"."Score_1" AS "Score_1" 
FROM "TMP_20180602142508_PCJ_GB_B3" AS "GB_B3") AS "GB_EnsembleUnion")
 INSERT INTO "TMP_20180602142508_KGC_GB_sum" ("KEY", "Score_0", "Score_1") SELECT "GB_sum"."KEY", "GB_sum"."Score_0", "GB_sum"."Score_1" 
...
-- Code For temporary table TMP_20180602142508_KGC_GB_sum part 3. Create Index 

CREATE INDEX "ix_TMP_20180602142508_KGC_GB_sum_KEY" ON "TMP_20180602142508_KGC_GB_sum" ("KEY")
...
FROM "TMP_20180602142508_KGC_GB_sum" AS "GB_sum"), 
