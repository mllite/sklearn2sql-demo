...
-- Code For temporary table tmp_20180508180802_codegen_e31ck3_gb_b0 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180508180802_codegen_e31ck3_gb_b0 (
	"KEY" BIGINT, 
	"Score_0" DOUBLE, 
	"Score_1" DOUBLE
)
...
-- Code For temporary table tmp_20180508180802_codegen_e31ck3_gb_b0 part 2. Populate

INSERT INTO tmp_20180508180802_codegen_e31ck3_gb_b0 WITH "DT_node_lookup" AS 
...
-- Code For temporary table tmp_20180508180802_codegen_tnmzsx_gb_b1 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180508180802_codegen_tnmzsx_gb_b1 (
	"KEY" BIGINT, 
	"Score_0" DOUBLE, 
	"Score_1" DOUBLE
)
...
-- Code For temporary table tmp_20180508180802_codegen_tnmzsx_gb_b1 part 2. Populate

INSERT INTO tmp_20180508180802_codegen_tnmzsx_gb_b1 WITH "DT_node_lookup_5" AS 
...
-- Code For temporary table tmp_20180508180802_codegen_szld1j_gb_b2 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180508180802_codegen_szld1j_gb_b2 (
	"KEY" BIGINT, 
	"Score_0" DOUBLE, 
	"Score_1" DOUBLE
)
...
-- Code For temporary table tmp_20180508180802_codegen_szld1j_gb_b2 part 2. Populate

INSERT INTO tmp_20180508180802_codegen_szld1j_gb_b2 WITH "DT_node_lookup_10" AS 
...
-- Code For temporary table tmp_20180508180802_codegen_k0rr45_gb_b3 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180508180802_codegen_k0rr45_gb_b3 (
	"KEY" BIGINT, 
	"Score_0" DOUBLE, 
	"Score_1" DOUBLE
)
...
-- Code For temporary table tmp_20180508180802_codegen_k0rr45_gb_b3 part 2. Populate

INSERT INTO tmp_20180508180802_codegen_k0rr45_gb_b3 WITH "DT_node_lookup_15" AS 
...
-- Code For temporary table tmp_20180508180802_codegen_4vkv4v_gb_union part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180508180802_codegen_4vkv4v_gb_union (
	"KEY" BIGINT, 
	"Score_0" DOUBLE, 
	"Score_1" DOUBLE
)
...
-- Code For temporary table tmp_20180508180802_codegen_4vkv4v_gb_union part 2. Populate

INSERT INTO tmp_20180508180802_codegen_4vkv4v_gb_union SELECT "GB_Union"."KEY", "GB_Union"."Score_0", "GB_Union"."Score_1" 
...
FROM tmp_20180508180802_codegen_e31ck3_gb_b0 AS "GB_B0" UNION ALL SELECT "GB_B1"."KEY" AS "KEY", "GB_B1"."Score_0" AS "Score_0", "GB_B1"."Score_1" AS "Score_1" 
FROM tmp_20180508180802_codegen_tnmzsx_gb_b1 AS "GB_B1" UNION ALL SELECT "GB_B2"."KEY" AS "KEY", "GB_B2"."Score_0" AS "Score_0", "GB_B2"."Score_1" AS "Score_1" 
FROM tmp_20180508180802_codegen_szld1j_gb_b2 AS "GB_B2" UNION ALL SELECT "GB_B3"."KEY" AS "KEY", "GB_B3"."Score_0" AS "Score_0", "GB_B3"."Score_1" AS "Score_1" 
FROM tmp_20180508180802_codegen_k0rr45_gb_b3 AS "GB_B3") AS "GB_EnsembleUnion") AS "GB_Union"

-- Code For temporary table tmp_20180508180802_codegen_dyxzn4_gb_sum part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180508180802_codegen_dyxzn4_gb_sum (
	"KEY" BIGINT, 
	"Score_0" DOUBLE, 
	"Score_1" DOUBLE
)
...
-- Code For temporary table tmp_20180508180802_codegen_dyxzn4_gb_sum part 2. Populate

INSERT INTO tmp_20180508180802_codegen_dyxzn4_gb_sum SELECT "GB_sum"."KEY", "GB_sum"."Score_0", "GB_sum"."Score_1" 
...
FROM tmp_20180508180802_codegen_4vkv4v_gb_union AS "GB_Union" GROUP BY "GB_Union"."KEY") AS "T") AS "GB_sum"
...
FROM tmp_20180508180802_codegen_dyxzn4_gb_sum AS "GB_sum"), 
