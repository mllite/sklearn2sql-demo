...
-- Code For temporary table TMP_20180516114105_CODEGEN_JL7K5S_ADS_imp_1_OUT part 1. Create 


CREATE TEMPORARY TABLE "TMP_20180516114105_CODEGEN_JL7K5S_ADS_imp_1_OUT" (
	"KEY" BIGINT NOT NULL, 
	impter_2 FLOAT, 
	impter_3 FLOAT, 
	impter_4 FLOAT, 
...
-- Code For temporary table TMP_20180516114105_CODEGEN_JL7K5S_ADS_imp_1_OUT part 3. Create Index 

CREATE INDEX "ix_TMP_20180516114105_CODEGEN_JL7K5S_ADS_imp_1_OUT_KEY" ON "TMP_20180516114105_CODEGEN_JL7K5S_ADS_imp_1_OUT" ("KEY")

-- Code For temporary table TMP_20180516114105_CODEGEN_NCMQWT_ADS_sca_2_OUT part 1. Create 


CREATE TEMPORARY TABLE "TMP_20180516114105_CODEGEN_NCMQWT_ADS_sca_2_OUT" (
	"KEY" BIGINT NOT NULL, 
	scaler_2 FLOAT, 
	scaler_3 FLOAT, 
	scaler_4 FLOAT, 
...
FROM "TMP_20180516114105_CODEGEN_JL7K5S_ADS_imp_1_OUT" AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT"

-- Code For temporary table TMP_20180516114105_CODEGEN_NCMQWT_ADS_sca_2_OUT part 3. Create Index 

CREATE INDEX "ix_TMP_20180516114105_CODEGEN_NCMQWT_ADS_sca_2_OUT_KEY" ON "TMP_20180516114105_CODEGEN_NCMQWT_ADS_sca_2_OUT" ("KEY")

-- Code For temporary table TMP_20180516114105_CODEGEN_WHK50P_BAG_B0 part 1. Create 


CREATE TEMPORARY TABLE "TMP_20180516114105_CODEGEN_WHK50P_BAG_B0" (
	"KEY" BIGINT, 
	"Estimator" FLOAT
)
...
-- Code For temporary table TMP_20180516114105_CODEGEN_WHK50P_BAG_B0 part 2. Populate
...
FROM "TMP_20180516114105_CODEGEN_NCMQWT_ADS_sca_2_OUT" AS "ADS_sca_2_OUT"), 
"DT_node_data" AS 
...
FROM "DT_Output_9")
 INSERT INTO "TMP_20180516114105_CODEGEN_WHK50P_BAG_B0" ("KEY", "Estimator") SELECT "BAG_B0"."KEY", "BAG_B0"."Estimator" 
...
-- Code For temporary table TMP_20180516114105_CODEGEN_KTAV4C_BAG_B1 part 1. Create 


CREATE TEMPORARY TABLE "TMP_20180516114105_CODEGEN_KTAV4C_BAG_B1" (
	"KEY" BIGINT, 
	"Estimator" FLOAT
)
...
-- Code For temporary table TMP_20180516114105_CODEGEN_KTAV4C_BAG_B1 part 2. Populate
...
FROM "DT_Output_15")
 INSERT INTO "TMP_20180516114105_CODEGEN_KTAV4C_BAG_B1" ("KEY", "Estimator") SELECT "BAG_B1"."KEY", "BAG_B1"."Estimator" 
...
-- Code For temporary table TMP_20180516114105_CODEGEN_QSJ05Q_BAG_avg part 1. Create 


CREATE TEMPORARY TABLE "TMP_20180516114105_CODEGEN_QSJ05Q_BAG_avg" (
	"KEY" BIGINT NOT NULL, 
	"Estimator" FLOAT, 
	PRIMARY KEY ("KEY")
)
...
-- Code For temporary table TMP_20180516114105_CODEGEN_QSJ05Q_BAG_avg part 2. Populate
...
FROM "TMP_20180516114105_CODEGEN_WHK50P_BAG_B0" AS "BAG_B0" UNION ALL SELECT "BAG_B1"."KEY" AS "KEY", "BAG_B1"."Estimator" AS "Estimator" 
FROM "TMP_20180516114105_CODEGEN_KTAV4C_BAG_B1" AS "BAG_B1") AS "BAG_EnsembleUnion")
 INSERT INTO "TMP_20180516114105_CODEGEN_QSJ05Q_BAG_avg" ("KEY", "Estimator") SELECT "BAG_avg"."KEY", "BAG_avg"."Estimator" 
...
-- Code For temporary table TMP_20180516114105_CODEGEN_QSJ05Q_BAG_avg part 3. Create Index 

CREATE INDEX "ix_TMP_20180516114105_CODEGEN_QSJ05Q_BAG_avg_KEY" ON "TMP_20180516114105_CODEGEN_QSJ05Q_BAG_avg" ("KEY")

-- Model deployment code

SELECT "BAG_avg"."KEY" AS "KEY", "BAG_avg"."Estimator" AS "Estimator" 
FROM "TMP_20180516114105_CODEGEN_QSJ05Q_BAG_avg" AS "BAG_avg"