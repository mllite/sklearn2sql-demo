...
-- Code For temporary table TMP_20180516114105_CODEGEN_1E0WH6_ADS_imp_1_OUT part 1. Create 


CREATE TEMPORARY TABLE `TMP_20180516114105_CODEGEN_1E0WH6_ADS_imp_1_OUT` (
	`KEY` BIGINT NOT NULL, 
	impter_2 DOUBLE, 
	impter_3 DOUBLE, 
	impter_4 DOUBLE, 
...
-- Code For temporary table TMP_20180516114105_CODEGEN_1E0WH6_ADS_imp_1_OUT part 3. Create Index 

CREATE INDEX `ix_TMP_20180516114105_CODEGEN_1E0WH6_ADS_imp_1_OUT_KEY` ON `TMP_20180516114105_CODEGEN_1E0WH6_ADS_imp_1_OUT` (`KEY`)

-- Code For temporary table TMP_20180516114105_CODEGEN_5A1UEY_ADS_sca_2_OUT part 1. Create 


CREATE TEMPORARY TABLE `TMP_20180516114105_CODEGEN_5A1UEY_ADS_sca_2_OUT` (
	`KEY` BIGINT NOT NULL, 
	scaler_2 DOUBLE, 
	scaler_3 DOUBLE, 
	scaler_4 DOUBLE, 
...
FROM `TMP_20180516114105_CODEGEN_1E0WH6_ADS_imp_1_OUT` AS `ADS_imp_1_OUT`) AS `ADS_sca_2_OUT`) AS `U`

-- Code For temporary table TMP_20180516114105_CODEGEN_5A1UEY_ADS_sca_2_OUT part 3. Create Index 

CREATE INDEX `ix_TMP_20180516114105_CODEGEN_5A1UEY_ADS_sca_2_OUT_KEY` ON `TMP_20180516114105_CODEGEN_5A1UEY_ADS_sca_2_OUT` (`KEY`)

-- Code For temporary table TMP_20180516114105_CODEGEN_JFOOWC_BAG_B0 part 1. Create 


CREATE TEMPORARY TABLE `TMP_20180516114105_CODEGEN_JFOOWC_BAG_B0` (
	`KEY` BIGINT, 
	`Estimator` DOUBLE
)
...
-- Code For temporary table TMP_20180516114105_CODEGEN_JFOOWC_BAG_B0 part 2. Populate

INSERT INTO `TMP_20180516114105_CODEGEN_JFOOWC_BAG_B0` (`KEY`, `Estimator`) SELECT `U`.`KEY`, `U`.`Estimator` 
...
FROM `TMP_20180516114105_CODEGEN_5A1UEY_ADS_sca_2_OUT` AS `ADS_sca_2_OUT`), 
`DT_node_data` AS 
...
-- Code For temporary table TMP_20180516114105_CODEGEN_U17U3V_BAG_B1 part 1. Create 


CREATE TEMPORARY TABLE `TMP_20180516114105_CODEGEN_U17U3V_BAG_B1` (
	`KEY` BIGINT, 
	`Estimator` DOUBLE
)
...
-- Code For temporary table TMP_20180516114105_CODEGEN_U17U3V_BAG_B1 part 2. Populate

INSERT INTO `TMP_20180516114105_CODEGEN_U17U3V_BAG_B1` (`KEY`, `Estimator`) SELECT `U`.`KEY`, `U`.`Estimator` 
...
-- Code For temporary table TMP_20180516114105_CODEGEN_7OYMDM_BAG_avg part 1. Create 


CREATE TEMPORARY TABLE `TMP_20180516114105_CODEGEN_7OYMDM_BAG_avg` (
	`KEY` BIGINT NOT NULL, 
	`Estimator` DOUBLE, 
	PRIMARY KEY (`KEY`)
)
...
-- Code For temporary table TMP_20180516114105_CODEGEN_7OYMDM_BAG_avg part 2. Populate

INSERT INTO `TMP_20180516114105_CODEGEN_7OYMDM_BAG_avg` (`KEY`, `Estimator`) SELECT `U`.`KEY`, `U`.`Estimator` 
...
FROM `TMP_20180516114105_CODEGEN_JFOOWC_BAG_B0` AS `BAG_B0` UNION ALL SELECT `BAG_B1`.`KEY` AS `KEY`, `BAG_B1`.`Estimator` AS `Estimator` 
FROM `TMP_20180516114105_CODEGEN_U17U3V_BAG_B1` AS `BAG_B1`) AS `BAG_EnsembleUnion`)
...
-- Code For temporary table TMP_20180516114105_CODEGEN_7OYMDM_BAG_avg part 3. Create Index 

CREATE INDEX `ix_TMP_20180516114105_CODEGEN_7OYMDM_BAG_avg_KEY` ON `TMP_20180516114105_CODEGEN_7OYMDM_BAG_avg` (`KEY`)

-- Model deployment code

SELECT `BAG_avg`.`KEY` AS `KEY`, `BAG_avg`.`Estimator` AS `Estimator` 
FROM `TMP_20180516114105_CODEGEN_7OYMDM_BAG_avg` AS `BAG_avg`