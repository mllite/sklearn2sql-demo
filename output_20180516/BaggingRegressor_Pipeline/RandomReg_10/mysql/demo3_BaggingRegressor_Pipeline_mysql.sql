...
-- Code For temporary table TMP_20180508182126_CODEGEN_X15IAQ_ADS_imp_1_OUT part 1. Create 


CREATE TEMPORARY TABLE `TMP_20180508182126_CODEGEN_X15IAQ_ADS_imp_1_OUT` (
	`KEY` BIGINT NOT NULL, 
	impter_2 DOUBLE, 
	impter_3 DOUBLE, 
	impter_4 DOUBLE, 
...
-- Code For temporary table TMP_20180508182126_CODEGEN_X15IAQ_ADS_imp_1_OUT part 2. Populate

INSERT INTO `TMP_20180508182126_CODEGEN_X15IAQ_ADS_imp_1_OUT` (`KEY`, impter_2, impter_3, impter_4, impter_5, impter_6, impter_7, impter_8, impter_9, impter_10, impter_11) SELECT `U`.`KEY`, `U`.impter_2, `U`.impter_3, `U`.impter_4, `U`.impter_5, `U`.impter_6, `U`.impter_7, `U`.impter_8, `U`.impter_9, `U`.impter_10, `U`.impter_11 
...
-- Code For temporary table TMP_20180508182126_CODEGEN_X15IAQ_ADS_imp_1_OUT part 3. Create Index 

CREATE INDEX `ix_TMP_20180508182126_CODEGEN_X15IAQ_ADS_imp_1_OUT_KEY` ON `TMP_20180508182126_CODEGEN_X15IAQ_ADS_imp_1_OUT` (`KEY`)

-- Code For temporary table TMP_20180508182126_CODEGEN_YW5GUV_ADS_sca_2_OUT part 1. Create 


CREATE TEMPORARY TABLE `TMP_20180508182126_CODEGEN_YW5GUV_ADS_sca_2_OUT` (
	`KEY` BIGINT NOT NULL, 
	scaler_2 DOUBLE, 
	scaler_3 DOUBLE, 
	scaler_4 DOUBLE, 
...
-- Code For temporary table TMP_20180508182126_CODEGEN_YW5GUV_ADS_sca_2_OUT part 2. Populate

INSERT INTO `TMP_20180508182126_CODEGEN_YW5GUV_ADS_sca_2_OUT` (`KEY`, scaler_2, scaler_3, scaler_4, scaler_5, scaler_6, scaler_7, scaler_8, scaler_9, scaler_10, scaler_11) SELECT `U`.`KEY`, `U`.scaler_2, `U`.scaler_3, `U`.scaler_4, `U`.scaler_5, `U`.scaler_6, `U`.scaler_7, `U`.scaler_8, `U`.scaler_9, `U`.scaler_10, `U`.scaler_11 
...
FROM `TMP_20180508182126_CODEGEN_X15IAQ_ADS_imp_1_OUT` AS `ADS_imp_1_OUT`) AS `ADS_sca_2_OUT`) AS `U`

-- Code For temporary table TMP_20180508182126_CODEGEN_YW5GUV_ADS_sca_2_OUT part 3. Create Index 

CREATE INDEX `ix_TMP_20180508182126_CODEGEN_YW5GUV_ADS_sca_2_OUT_KEY` ON `TMP_20180508182126_CODEGEN_YW5GUV_ADS_sca_2_OUT` (`KEY`)

-- Code For temporary table TMP_20180508182126_CODEGEN_HOJ2IF_BAG_B0 part 1. Create 


CREATE TEMPORARY TABLE `TMP_20180508182126_CODEGEN_HOJ2IF_BAG_B0` (
	`KEY` BIGINT, 
	`Estimator` DOUBLE
)
...
-- Code For temporary table TMP_20180508182126_CODEGEN_HOJ2IF_BAG_B0 part 2. Populate

INSERT INTO `TMP_20180508182126_CODEGEN_HOJ2IF_BAG_B0` (`KEY`, `Estimator`) SELECT `U`.`KEY`, `U`.`Estimator` 
...
FROM `TMP_20180508182126_CODEGEN_YW5GUV_ADS_sca_2_OUT` AS `ADS_sca_2_OUT`), 
`DT_node_data` AS 
...
`DT_node_data_1` AS 
(SELECT `Values`.nid AS nid, `Values`.`E` AS `E` 
FROM (SELECT 4 AS nid, -284.890410429711 AS `E` UNION ALL SELECT 6 AS nid, -165.64587304935068 AS `E` UNION ALL SELECT 7 AS nid, -210.35491750133752 AS `E` UNION ALL SELECT 8 AS nid, -53.55855810403281 AS `E` UNION ALL SELECT 10 AS nid, -351.3842930876292 AS `E` UNION ALL SELECT 12 AS nid, -459.030670753418 AS `E` UNION ALL SELECT 13 AS nid, -422.39029400237723 AS `E` UNION ALL SELECT 18 AS nid, -155.5341988547945 AS `E` UNION ALL SELECT 19 AS nid, -244.20935844983507 AS `E` UNION ALL SELECT 20 AS nid, -9.185160907179679 AS `E` UNION ALL SELECT 23 AS nid, -223.26828856161853 AS `E` UNION ALL SELECT 24 AS nid, -2.6022185522222703 AS `E` UNION ALL SELECT 26 AS nid, 144.424454256417 AS `E` UNION ALL SELECT 27 AS nid, 156.85798347147366 AS `E` UNION ALL SELECT 31 AS nid, 11.979848483268036 AS `E` UNION ALL SELECT 32 AS nid, 23.511748777975313 AS `E` UNION ALL SELECT 34 AS nid, -27.42654029072463 AS `E` UNION ALL SELECT 35 AS nid, -32.3700606387813 AS `E` UNION ALL SELECT 38 AS nid, -14.482521662072362 AS `E` UNION ALL SELECT 39 AS nid, -33.337014733450744 AS `E` UNION ALL SELECT 41 AS nid, 210.19737687026083 AS `E` UNION ALL SELECT 42 AS nid, 373.2958762353178 AS `E`) AS `Values`), 
`DT_Output_1` AS 
...
`DT_node_data_3` AS 
(SELECT `Values`.nid AS nid, `Values`.`E` AS `E` 
FROM (SELECT 4 AS nid, -351.3842930876292 AS `E` UNION ALL SELECT 5 AS nid, -459.030670753418 AS `E` UNION ALL SELECT 8 AS nid, -210.69664064319215 AS `E` UNION ALL SELECT 9 AS nid, -305.6750972104841 AS `E` UNION ALL SELECT 11 AS nid, -53.55855810403281 AS `E` UNION ALL SELECT 12 AS nid, -122.95886223941 AS `E` UNION ALL SELECT 16 AS nid, -116.6762085558222 AS `E` UNION ALL SELECT 17 AS nid, -216.97685028819683 AS `E` UNION ALL SELECT 19 AS nid, -181.5117298102302 AS `E` UNION ALL SELECT 20 AS nid, 17.619280054329796 AS `E` UNION ALL SELECT 23 AS nid, 15.08637447863128 AS `E` UNION ALL SELECT 24 AS nid, 128.21020798682676 AS `E` UNION ALL SELECT 26 AS nid, 320.6826523308587 AS `E` UNION ALL SELECT 27 AS nid, 376.9384086101691 AS `E` UNION ALL SELECT 29 AS nid, -298.79907558939374 AS `E` UNION ALL SELECT 33 AS nid, -9.185160907179679 AS `E` UNION ALL SELECT 34 AS nid, -67.71218597426643 AS `E` UNION ALL SELECT 36 AS nid, 351.37130796411674 AS `E` UNION ALL SELECT 37 AS nid, 148.1109056250043 AS `E` UNION ALL SELECT 40 AS nid, 169.37489455103199 AS `E` UNION ALL SELECT 41 AS nid, 265.0347129627642 AS `E` UNION ALL SELECT 43 AS nid, 314.9874715901854 AS `E` UNION ALL SELECT 44 AS nid, 479.70721604450864 AS `E`) AS `Values`), 
`DT_Output_3` AS 
...
`DT_node_data_5` AS 
(SELECT `Values`.nid AS nid, `Values`.`E` AS `E` 
FROM (SELECT 4 AS nid, -351.3842930876292 AS `E` UNION ALL SELECT 5 AS nid, -422.39029400237723 AS `E` UNION ALL SELECT 8 AS nid, -104.92167060892582 AS `E` UNION ALL SELECT 9 AS nid, -191.063284323481 AS `E` UNION ALL SELECT 10 AS nid, -305.6750972104841 AS `E` UNION ALL SELECT 14 AS nid, -192.83109115096553 AS `E` UNION ALL SELECT 15 AS nid, -120.67653414105177 AS `E` UNION ALL SELECT 17 AS nid, -18.88939923472416 AS `E` UNION ALL SELECT 18 AS nid, -114.01123052917626 AS `E` UNION ALL SELECT 21 AS nid, 103.60520840434049 AS `E` UNION ALL SELECT 22 AS nid, -18.883085331926868 AS `E` UNION ALL SELECT 23 AS nid, 393.261092787257 AS `E` UNION ALL SELECT 28 AS nid, -181.5117298102302 AS `E` UNION ALL SELECT 29 AS nid, -251.2683418956458 AS `E` UNION ALL SELECT 31 AS nid, 22.30851676353701 AS `E` UNION ALL SELECT 32 AS nid, -33.06227029601031 AS `E` UNION ALL SELECT 34 AS nid, 156.85798347147366 AS `E` UNION ALL SELECT 36 AS nid, 277.9812845098006 AS `E` UNION ALL SELECT 37 AS nid, 235.3201708856319 AS `E` UNION ALL SELECT 41 AS nid, 79.5768303814577 AS `E` UNION ALL SELECT 42 AS nid, 198.97164294103217 AS `E` UNION ALL SELECT 44 AS nid, 210.4674417575487 AS `E` UNION ALL SELECT 45 AS nid, 329.52203269548926 AS `E` UNION ALL SELECT 48 AS nid, 270.15339820458973 AS `E` UNION ALL SELECT 49 AS nid, 344.4919380068218 AS `E` UNION ALL SELECT 50 AS nid, 479.70721604450864 AS `E`) AS `Values`), 
`DT_Output_5` AS 
...
`DT_node_data_7` AS 
(SELECT `Values`.nid AS nid, `Values`.`E` AS `E` 
FROM (SELECT 5 AS nid, -422.39029400237723 AS `E` UNION ALL SELECT 6 AS nid, -278.4070414726523 AS `E` UNION ALL SELECT 8 AS nid, -194.2074617845642 AS `E` UNION ALL SELECT 9 AS nid, -69.44228833394571 AS `E` UNION ALL SELECT 12 AS nid, -224.07377768185083 AS `E` UNION ALL SELECT 13 AS nid, -67.8740888192385 AS `E` UNION ALL SELECT 15 AS nid, 212.28993399393994 AS `E` UNION ALL SELECT 16 AS nid, 13.66733519279175 AS `E` UNION ALL SELECT 19 AS nid, -284.890410429711 AS `E` UNION ALL SELECT 21 AS nid, -26.697877154088868 AS `E` UNION ALL SELECT 22 AS nid, 62.64480580928396 AS `E` UNION ALL SELECT 25 AS nid, 240.96884028801762 AS `E` UNION ALL SELECT 26 AS nid, 113.4408795258052 AS `E` UNION ALL SELECT 28 AS nid, 479.70721604450864 AS `E` UNION ALL SELECT 29 AS nid, 376.9384086101691 AS `E` UNION ALL SELECT 32 AS nid, -9.185160907179679 AS `E` UNION ALL SELECT 34 AS nid, 156.85798347147366 AS `E` UNION ALL SELECT 35 AS nid, 144.424454256417 AS `E` UNION ALL SELECT 39 AS nid, 259.87552025822583 AS `E` UNION ALL SELECT 40 AS nid, 235.3201708856319 AS `E` UNION ALL SELECT 42 AS nid, 194.4087167101487 AS `E` UNION ALL SELECT 43 AS nid, 191.5521549407964 AS `E` UNION ALL SELECT 46 AS nid, 349.4216823421892 AS `E` UNION ALL SELECT 47 AS nid, 318.6525737486649 AS `E` UNION ALL SELECT 48 AS nid, 277.9812845098006 AS `E`) AS `Values`), 
`DT_Output_7` AS 
...
`DT_node_data_8` AS 
(SELECT `Values`.nid AS nid, `Values`.`E` AS `E` 
FROM (SELECT 4 AS nid, -298.79907558939374 AS `E` UNION ALL SELECT 5 AS nid, -351.3842930876292 AS `E` UNION ALL SELECT 8 AS nid, -165.64587304935068 AS `E` UNION ALL SELECT 9 AS nid, -80.35271335228391 AS `E` UNION ALL SELECT 11 AS nid, -284.890410429711 AS `E` UNION ALL SELECT 12 AS nid, -215.90421619322228 AS `E` UNION ALL SELECT 16 AS nid, -147.70083070777562 AS `E` UNION ALL SELECT 17 AS nid, -241.49883785185892 AS `E` UNION ALL SELECT 19 AS nid, -182.332005662268 AS `E` UNION ALL SELECT 20 AS nid, -13.103235906353564 AS `E` UNION ALL SELECT 23 AS nid, 37.973325215090554 AS `E` UNION ALL SELECT 24 AS nid, 131.0368050808161 AS `E` UNION ALL SELECT 26 AS nid, -33.337014733450744 AS `E` UNION ALL SELECT 27 AS nid, 236.03797400232807 AS `E` UNION ALL SELECT 30 AS nid, 290.70915409731754 AS `E` UNION ALL SELECT 33 AS nid, 320.6826523308587 AS `E` UNION ALL SELECT 34 AS nid, 325.0738816201826 AS `E` UNION ALL SELECT 36 AS nid, 351.37130796411674 AS `E` UNION ALL SELECT 37 AS nid, 360.61572443308125 AS `E` UNION ALL SELECT 38 AS nid, 447.6909835452225 AS `E`) AS `Values`), 
`DT_Output_8` AS 
...
`DT_node_data_9` AS 
(SELECT `Values`.nid AS nid, `Values`.`E` AS `E` 
FROM (SELECT 5 AS nid, -459.030670753418 AS `E` UNION ALL SELECT 6 AS nid, -422.39029400237723 AS `E` UNION ALL SELECT 8 AS nid, -305.6750972104841 AS `E` UNION ALL SELECT 9 AS nid, -255.70566701747688 AS `E` UNION ALL SELECT 12 AS nid, -87.58168137550874 AS `E` UNION ALL SELECT 13 AS nid, -269.31768956004163 AS `E` UNION ALL SELECT 14 AS nid, 235.3201708856319 AS `E` UNION ALL SELECT 18 AS nid, -80.36713172562187 AS `E` UNION ALL SELECT 19 AS nid, -179.40108890307974 AS `E` UNION ALL SELECT 21 AS nid, 5.200960840615618 AS `E` UNION ALL SELECT 22 AS nid, 152.78222778259249 AS `E` UNION ALL SELECT 25 AS nid, 225.16672153439853 AS `E` UNION ALL SELECT 26 AS nid, 313.56051428540366 AS `E` UNION ALL SELECT 28 AS nid, 87.07542544694495 AS `E` UNION ALL SELECT 29 AS nid, 198.97164294103217 AS `E` UNION ALL SELECT 34 AS nid, 325.0738816201826 AS `E` UNION ALL SELECT 35 AS nid, 320.6826523308587 AS `E` UNION ALL SELECT 37 AS nid, 360.61572443308125 AS `E` UNION ALL SELECT 38 AS nid, 351.37130796411674 AS `E` UNION ALL SELECT 39 AS nid, 447.6909835452225 AS `E` UNION ALL SELECT 42 AS nid, 194.4087167101487 AS `E` UNION ALL SELECT 44 AS nid, 246.88551254371106 AS `E` UNION ALL SELECT 45 AS nid, 290.70915409731754 AS `E` UNION ALL SELECT 46 AS nid, 58.56592202346141 AS `E`) AS `Values`), 
`DT_Output_9` AS 
...
-- Code For temporary table TMP_20180508182126_CODEGEN_EBJDO8_BAG_B1 part 1. Create 


CREATE TEMPORARY TABLE `TMP_20180508182126_CODEGEN_EBJDO8_BAG_B1` (
	`KEY` BIGINT, 
	`Estimator` DOUBLE
)
...
-- Code For temporary table TMP_20180508182126_CODEGEN_EBJDO8_BAG_B1 part 2. Populate

INSERT INTO `TMP_20180508182126_CODEGEN_EBJDO8_BAG_B1` (`KEY`, `Estimator`) SELECT `U`.`KEY`, `U`.`Estimator` 
...
`DT_node_data_15` AS 
(SELECT `Values`.nid AS nid, `Values`.`E` AS `E` 
FROM (SELECT 5 AS nid, -351.3842930876292 AS `E` UNION ALL SELECT 6 AS nid, -298.79907558939374 AS `E` UNION ALL SELECT 7 AS nid, -459.030670753418 AS `E` UNION ALL SELECT 10 AS nid, -273.7570917356055 AS `E` UNION ALL SELECT 11 AS nid, -230.736136275325 AS `E` UNION ALL SELECT 13 AS nid, -188.0003952753441 AS `E` UNION ALL SELECT 14 AS nid, -81.43203056443055 AS `E` UNION ALL SELECT 16 AS nid, 325.0738816201826 AS `E` UNION ALL SELECT 17 AS nid, 235.3201708856319 AS `E` UNION ALL SELECT 22 AS nid, -110.57931123012992 AS `E` UNION ALL SELECT 23 AS nid, 3.776947440020895 AS `E` UNION ALL SELECT 25 AS nid, 15.489340422486551 AS `E` UNION ALL SELECT 26 AS nid, 136.81863919098882 AS `E` UNION ALL SELECT 29 AS nid, -9.617958070006466 AS `E` UNION ALL SELECT 30 AS nid, 58.56592202346141 AS `E` UNION ALL SELECT 32 AS nid, 221.960847427731 AS `E` UNION ALL SELECT 33 AS nid, 340.64918838196996 AS `E` UNION ALL SELECT 37 AS nid, -27.42654029072463 AS `E` UNION ALL SELECT 38 AS nid, 8.923656244969493 AS `E` UNION ALL SELECT 40 AS nid, 156.85798347147366 AS `E` UNION ALL SELECT 41 AS nid, 144.424454256417 AS `E` UNION ALL SELECT 44 AS nid, 113.4408795258052 AS `E` UNION ALL SELECT 45 AS nid, 290.8269455889381 AS `E` UNION ALL SELECT 47 AS nid, 447.6909835452225 AS `E` UNION ALL SELECT 48 AS nid, 479.70721604450864 AS `E`) AS `Values`), 
`DT_Output_15` AS 
...
-- Code For temporary table TMP_20180508182126_CODEGEN_PUDYQV_BAG_Union part 1. Create 


CREATE TEMPORARY TABLE `TMP_20180508182126_CODEGEN_PUDYQV_BAG_Union` (
	`KEY` BIGINT, 
	`Estimator` DOUBLE
)
...
-- Code For temporary table TMP_20180508182126_CODEGEN_PUDYQV_BAG_Union part 2. Populate

INSERT INTO `TMP_20180508182126_CODEGEN_PUDYQV_BAG_Union` (`KEY`, `Estimator`) SELECT `U`.`KEY`, `U`.`Estimator` 
...
FROM `TMP_20180508182126_CODEGEN_HOJ2IF_BAG_B0` AS `BAG_B0` UNION ALL SELECT `BAG_B1`.`KEY` AS `KEY`, `BAG_B1`.`Estimator` AS `Estimator` 
FROM `TMP_20180508182126_CODEGEN_EBJDO8_BAG_B1` AS `BAG_B1`) AS `BAG_EnsembleUnion`) AS `BAG_Union`) AS `U`

-- Code For temporary table TMP_20180508182126_CODEGEN_EYKS31_BAG_avg part 1. Create 


CREATE TEMPORARY TABLE `TMP_20180508182126_CODEGEN_EYKS31_BAG_avg` (
	`KEY` BIGINT NOT NULL, 
	`Estimator` DOUBLE, 
	PRIMARY KEY (`KEY`)
)
...
-- Code For temporary table TMP_20180508182126_CODEGEN_EYKS31_BAG_avg part 2. Populate

INSERT INTO `TMP_20180508182126_CODEGEN_EYKS31_BAG_avg` (`KEY`, `Estimator`) SELECT `U`.`KEY`, `U`.`Estimator` 
...
FROM `TMP_20180508182126_CODEGEN_PUDYQV_BAG_Union` AS `BAG_Union` GROUP BY `BAG_Union`.`KEY`) AS `T`) AS `BAG_avg`) AS `U`

-- Code For temporary table TMP_20180508182126_CODEGEN_EYKS31_BAG_avg part 3. Create Index 

CREATE INDEX `ix_TMP_20180508182126_CODEGEN_EYKS31_BAG_avg_KEY` ON `TMP_20180508182126_CODEGEN_EYKS31_BAG_avg` (`KEY`)

-- Model deployment code

SELECT `BAG_avg`.`KEY` AS `KEY`, `BAG_avg`.`Estimator` AS `Estimator` 
FROM `TMP_20180508182126_CODEGEN_EYKS31_BAG_avg` AS `BAG_avg`