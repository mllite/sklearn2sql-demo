...
-- Code For temporary table TMP_20180602_DUV_GB_B0 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180602_DUV_GB_B0" (
	"KEY" BIGINT, 
...
-- Code For temporary table TMP_20180602_DUV_GB_B0 part 2. Populate

INSERT INTO "TMP_20180602_DUV_GB_B0" ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
-- Code For temporary table TMP_20180602_CM8_GB_B1 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180602_CM8_GB_B1" (
	"KEY" BIGINT, 
	"Estimator" DOUBLE PRECISION
)
...
-- Code For temporary table TMP_20180602_CM8_GB_B1 part 2. Populate

INSERT INTO "TMP_20180602_CM8_GB_B1" ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
-- Code For temporary table TMP_20180602_D4J_GB_B2 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180602_D4J_GB_B2" (
	"KEY" BIGINT, 
	"Estimator" DOUBLE PRECISION
)
...
-- Code For temporary table TMP_20180602_D4J_GB_B2 part 2. Populate

INSERT INTO "TMP_20180602_D4J_GB_B2" ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
-- Code For temporary table TMP_20180602_BDJ_GB_B3 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180602_BDJ_GB_B3" (
	"KEY" BIGINT, 
	"Estimator" DOUBLE PRECISION
)
...
-- Code For temporary table TMP_20180602_BDJ_GB_B3 part 2. Populate

INSERT INTO "TMP_20180602_BDJ_GB_B3" ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
-- Code For temporary table TMP_20180602_YIX_GB_SUM part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180602_YIX_GB_SUM" (
	"KEY" BIGINT NOT NULL, 
	"Estimator" DOUBLE PRECISION, 
	PRIMARY KEY ("KEY")
)
...
-- Code For temporary table TMP_20180602_YIX_GB_SUM part 2. Populate

INSERT INTO "TMP_20180602_YIX_GB_SUM" ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
FROM "TMP_20180602_DUV_GB_B0" AS "GB_B0" UNION ALL SELECT "GB_B1"."KEY" AS "KEY", "GB_B1"."Estimator" AS "Estimator" 
FROM "TMP_20180602_CM8_GB_B1" AS "GB_B1" UNION ALL SELECT "GB_B2"."KEY" AS "KEY", "GB_B2"."Estimator" AS "Estimator" 
FROM "TMP_20180602_D4J_GB_B2" AS "GB_B2" UNION ALL SELECT "GB_B3"."KEY" AS "KEY", "GB_B3"."Estimator" AS "Estimator" 
FROM "TMP_20180602_BDJ_GB_B3" AS "GB_B3") AS "GB_EnsembleUnion")
...
-- Code For temporary table TMP_20180602_YIX_GB_SUM part 3. Create Index 

CREATE INDEX "ix_TMP_20180602_YIX_GB_SUM_KEY" ON "TMP_20180602_YIX_GB_SUM" ("KEY")

-- Model deployment code

SELECT "GB_sum"."KEY" AS "KEY", -11.471614782695335 + 0.1 * "GB_sum"."Estimator" AS "Estimator" 
FROM "TMP_20180602_YIX_GB_SUM" AS "GB_sum"