...
-- Code For temporary table tmp_20180508185156_codegen_1z0ke8_gb_b0 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180508185156_codegen_1z0ke8_gb_b0  (
	"KEY" BIGINT, 
...
-- Code For temporary table tmp_20180508185156_codegen_1z0ke8_gb_b0 part 2. Populate

INSERT INTO tmp_20180508185156_codegen_1z0ke8_gb_b0 ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
-- Code For temporary table tmp_20180508185156_codegen_8qorae_gb_b1 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180508185156_codegen_8qorae_gb_b1  (
	"KEY" BIGINT, 
	"Estimator" DOUBLE PRECISION
)
...
-- Code For temporary table tmp_20180508185156_codegen_8qorae_gb_b1 part 2. Populate

INSERT INTO tmp_20180508185156_codegen_8qorae_gb_b1 ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
-- Code For temporary table tmp_20180508185156_codegen_9g6caa_gb_union part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180508185156_codegen_9g6caa_gb_union  (
	"KEY" BIGINT, 
	"Estimator" DOUBLE PRECISION
)
...
-- Code For temporary table tmp_20180508185156_codegen_9g6caa_gb_union part 2. Populate

INSERT INTO tmp_20180508185156_codegen_9g6caa_gb_union ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
FROM tmp_20180508185156_codegen_1z0ke8_gb_b0 AS "GB_B0" UNION ALL SELECT "GB_B1"."KEY" AS "KEY", "GB_B1"."Estimator" AS "Estimator" 
FROM tmp_20180508185156_codegen_8qorae_gb_b1 AS "GB_B1") AS "GB_EnsembleUnion") AS "GB_Union") AS "U"

-- Code For temporary table tmp_20180508185156_codegen_yf1d3j_gb_sum part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180508185156_codegen_yf1d3j_gb_sum  (
	"KEY" BIGINT, 
	"Estimator" DOUBLE PRECISION
)
...
-- Code For temporary table tmp_20180508185156_codegen_yf1d3j_gb_sum part 2. Populate

INSERT INTO tmp_20180508185156_codegen_yf1d3j_gb_sum ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
FROM tmp_20180508185156_codegen_9g6caa_gb_union AS "GB_Union" GROUP BY "GB_Union"."KEY") AS "T") AS "GB_sum") AS "U"
...
FROM tmp_20180508185156_codegen_yf1d3j_gb_sum AS "GB_sum"