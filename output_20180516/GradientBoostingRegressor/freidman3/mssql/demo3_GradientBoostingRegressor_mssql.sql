...
-- Code For temporary table ##TMP_20180516121810_CODEGEN_Y18TEM_GB_B0 part 1. Create 


CREATE TABLE ##TMP_20180516121810_CODEGEN_Y18TEM_GB_B0 (
	[KEY] BIGINT NULL, 
...
-- Code For temporary table ##TMP_20180516121810_CODEGEN_Y18TEM_GB_B0 part 2. Populate
...
FROM [DT_Output_9])
 INSERT INTO ##TMP_20180516121810_CODEGEN_Y18TEM_GB_B0 ([KEY], [Estimator]) SELECT [GB_B0].[KEY], [GB_B0].[Estimator] 
...
-- Code For temporary table ##TMP_20180516121810_CODEGEN_E570F3_GB_B1 part 1. Create 


CREATE TABLE ##TMP_20180516121810_CODEGEN_E570F3_GB_B1 (
	[KEY] BIGINT NULL, 
	[Estimator] FLOAT(53) NULL
)
...
-- Code For temporary table ##TMP_20180516121810_CODEGEN_E570F3_GB_B1 part 2. Populate
...
FROM [DT_Output_15])
 INSERT INTO ##TMP_20180516121810_CODEGEN_E570F3_GB_B1 ([KEY], [Estimator]) SELECT [GB_B1].[KEY], [GB_B1].[Estimator] 
...
-- Code For temporary table ##TMP_20180516121810_CODEGEN_DEDTIH_GB_sum part 1. Create 


CREATE TABLE ##TMP_20180516121810_CODEGEN_DEDTIH_GB_sum (
	[KEY] BIGINT NULL, 
	[Estimator] FLOAT(53) NULL
)
...
-- Code For temporary table ##TMP_20180516121810_CODEGEN_DEDTIH_GB_sum part 2. Populate
...
FROM ##TMP_20180516121810_CODEGEN_Y18TEM_GB_B0 AS [GB_B0] UNION ALL SELECT [GB_B1].[KEY] AS [KEY], [GB_B1].[Estimator] AS [Estimator] 
FROM ##TMP_20180516121810_CODEGEN_E570F3_GB_B1 AS [GB_B1]) AS [GB_EnsembleUnion])
 INSERT INTO ##TMP_20180516121810_CODEGEN_DEDTIH_GB_sum ([KEY], [Estimator]) SELECT [GB_sum].[KEY], [GB_sum].[Estimator] 
...
FROM ##TMP_20180516121810_CODEGEN_DEDTIH_GB_sum AS [GB_sum]