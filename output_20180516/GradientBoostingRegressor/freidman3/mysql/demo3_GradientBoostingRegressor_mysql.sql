...
-- Code For temporary table TMP_20180516121810_CODEGEN_7Y8MFK_GB_B0 part 1. Create 


CREATE TEMPORARY TABLE `TMP_20180516121810_CODEGEN_7Y8MFK_GB_B0` (
	`KEY` BIGINT, 
	`Estimator` DOUBLE
)
...
-- Code For temporary table TMP_20180516121810_CODEGEN_7Y8MFK_GB_B0 part 2. Populate

INSERT INTO `TMP_20180516121810_CODEGEN_7Y8MFK_GB_B0` (`KEY`, `Estimator`) SELECT `U`.`KEY`, `U`.`Estimator` 
...
-- Code For temporary table TMP_20180516121810_CODEGEN_J7D01M_GB_B1 part 1. Create 


CREATE TEMPORARY TABLE `TMP_20180516121810_CODEGEN_J7D01M_GB_B1` (
	`KEY` BIGINT, 
	`Estimator` DOUBLE
)
...
-- Code For temporary table TMP_20180516121810_CODEGEN_J7D01M_GB_B1 part 2. Populate

INSERT INTO `TMP_20180516121810_CODEGEN_J7D01M_GB_B1` (`KEY`, `Estimator`) SELECT `U`.`KEY`, `U`.`Estimator` 
...
-- Code For temporary table TMP_20180516121810_CODEGEN_BBDNF9_GB_sum part 1. Create 


CREATE TEMPORARY TABLE `TMP_20180516121810_CODEGEN_BBDNF9_GB_sum` (
	`KEY` BIGINT NOT NULL, 
	`Estimator` DOUBLE, 
	PRIMARY KEY (`KEY`)
)
...
-- Code For temporary table TMP_20180516121810_CODEGEN_BBDNF9_GB_sum part 2. Populate

INSERT INTO `TMP_20180516121810_CODEGEN_BBDNF9_GB_sum` (`KEY`, `Estimator`) SELECT `U`.`KEY`, `U`.`Estimator` 
...
FROM `TMP_20180516121810_CODEGEN_7Y8MFK_GB_B0` AS `GB_B0` UNION ALL SELECT `GB_B1`.`KEY` AS `KEY`, `GB_B1`.`Estimator` AS `Estimator` 
FROM `TMP_20180516121810_CODEGEN_J7D01M_GB_B1` AS `GB_B1`) AS `GB_EnsembleUnion`)
...
-- Code For temporary table TMP_20180516121810_CODEGEN_BBDNF9_GB_sum part 3. Create Index 

CREATE INDEX `ix_TMP_20180516121810_CODEGEN_BBDNF9_GB_sum_KEY` ON `TMP_20180516121810_CODEGEN_BBDNF9_GB_sum` (`KEY`)

-- Model deployment code

SELECT `GB_sum`.`KEY` AS `KEY`, 1.3612342030259192 + 0.1 * `GB_sum`.`Estimator` AS `Estimator` 
FROM `TMP_20180516121810_CODEGEN_BBDNF9_GB_sum` AS `GB_sum`