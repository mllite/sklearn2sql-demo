...
-- Code For temporary table 82214_CODEGEN_0ZLWHP_GB_B0 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "82214_CODEGEN_0ZLWHP_GB_B0" (
	"KEY" NUMBER(19), 
...
-- Code For temporary table 82214_CODEGEN_0ZLWHP_GB_B0 part 2. Populate

INSERT INTO "82214_CODEGEN_0ZLWHP_GB_B0" ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
-- Code For temporary table 82214_CODEGEN_2TL6RQ_GB_B1 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "82214_CODEGEN_2TL6RQ_GB_B1" (
	"KEY" NUMBER(19), 
	"Estimator" BINARY_DOUBLE
)
...
-- Code For temporary table 82214_CODEGEN_2TL6RQ_GB_B1 part 2. Populate

INSERT INTO "82214_CODEGEN_2TL6RQ_GB_B1" ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
-- Code For temporary table 14_CODEGEN_VIFZHB_GB_UNION part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "14_CODEGEN_VIFZHB_GB_UNION" (
	"KEY" NUMBER(19), 
	"Estimator" BINARY_DOUBLE
)
...
-- Code For temporary table 14_CODEGEN_VIFZHB_GB_UNION part 2. Populate

INSERT INTO "14_CODEGEN_VIFZHB_GB_UNION" ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
FROM "82214_CODEGEN_0ZLWHP_GB_B0" "GB_B0" UNION ALL SELECT "GB_B1"."KEY" AS "KEY", "GB_B1"."Estimator" AS "Estimator" 
FROM "82214_CODEGEN_2TL6RQ_GB_B1" "GB_B1") "GB_EnsembleUnion") "GB_Union") "U"

-- Code For temporary table 2214_CODEGEN_GWJ98V_GB_SUM part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "2214_CODEGEN_GWJ98V_GB_SUM" (
	"KEY" NUMBER(19), 
	"Estimator" BINARY_DOUBLE
)
...
-- Code For temporary table 2214_CODEGEN_GWJ98V_GB_SUM part 2. Populate

INSERT INTO "2214_CODEGEN_GWJ98V_GB_SUM" ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
FROM "14_CODEGEN_VIFZHB_GB_UNION" "GB_Union" GROUP BY "GB_Union"."KEY") "T") "GB_sum") "U"

-- Model deployment code

SELECT "GB_sum"."KEY" AS "KEY", 26.405852730652413 + 0.1 * "GB_sum"."Estimator" AS "Estimator" 
FROM "2214_CODEGEN_GWJ98V_GB_SUM" "GB_sum"