...
-- Code For temporary table 83350_CODEGEN_BFC21B_GB_B0 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "83350_CODEGEN_BFC21B_GB_B0" (
	"KEY" NUMBER(19), 
...
-- Code For temporary table 83350_CODEGEN_BFC21B_GB_B0 part 2. Populate

INSERT INTO "83350_CODEGEN_BFC21B_GB_B0" ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
-- Code For temporary table 83350_CODEGEN_W0ZLYU_GB_B1 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "83350_CODEGEN_W0ZLYU_GB_B1" (
	"KEY" NUMBER(19), 
	"Estimator" BINARY_DOUBLE
)
...
-- Code For temporary table 83350_CODEGEN_W0ZLYU_GB_B1 part 2. Populate

INSERT INTO "83350_CODEGEN_W0ZLYU_GB_B1" ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
-- Code For temporary table 50_CODEGEN_VDB4CV_GB_UNION part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "50_CODEGEN_VDB4CV_GB_UNION" (
	"KEY" NUMBER(19), 
	"Estimator" BINARY_DOUBLE
)
...
-- Code For temporary table 50_CODEGEN_VDB4CV_GB_UNION part 2. Populate

INSERT INTO "50_CODEGEN_VDB4CV_GB_UNION" ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
FROM "83350_CODEGEN_BFC21B_GB_B0" "GB_B0" UNION ALL SELECT "GB_B1"."KEY" AS "KEY", "GB_B1"."Estimator" AS "Estimator" 
FROM "83350_CODEGEN_W0ZLYU_GB_B1" "GB_B1") "GB_EnsembleUnion") "GB_Union") "U"

-- Code For temporary table 3350_CODEGEN_GDMDLF_GB_SUM part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "3350_CODEGEN_GDMDLF_GB_SUM" (
	"KEY" NUMBER(19), 
	"Estimator" BINARY_DOUBLE
)
...
-- Code For temporary table 3350_CODEGEN_GDMDLF_GB_SUM part 2. Populate

INSERT INTO "3350_CODEGEN_GDMDLF_GB_SUM" ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
FROM "50_CODEGEN_VDB4CV_GB_UNION" "GB_Union" GROUP BY "GB_Union"."KEY") "T") "GB_sum") "U"

-- Model deployment code

SELECT "GB_sum"."KEY" AS "KEY", 154.07365439093485 + 0.1 * "GB_sum"."Estimator" AS "Estimator" 
FROM "3350_CODEGEN_GDMDLF_GB_SUM" "GB_sum"