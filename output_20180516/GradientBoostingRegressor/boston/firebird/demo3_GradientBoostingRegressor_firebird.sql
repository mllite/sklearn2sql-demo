...
-- Code For temporary table TMP_20180508183001_CODEGEN_VTTR part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508183001_CODEGEN_VTTR" (
	"KEY" BIGINT, 
...
-- Code For temporary table TMP_20180508183001_CODEGEN_VTTR part 2. Populate

INSERT INTO "TMP_20180508183001_CODEGEN_VTTR" ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
-- Code For temporary table TMP_20180508183001_CODEGEN_WO37 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508183001_CODEGEN_WO37" (
	"KEY" BIGINT, 
	"Estimator" DOUBLE PRECISION
)
...
-- Code For temporary table TMP_20180508183001_CODEGEN_WO37 part 2. Populate

INSERT INTO "TMP_20180508183001_CODEGEN_WO37" ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
-- Code For temporary table TMP_20180508183001_CODEGEN_CJ0P part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508183001_CODEGEN_CJ0P" (
	"KEY" BIGINT, 
	"Estimator" DOUBLE PRECISION
)
...
-- Code For temporary table TMP_20180508183001_CODEGEN_CJ0P part 2. Populate

INSERT INTO "TMP_20180508183001_CODEGEN_CJ0P" ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
FROM "TMP_20180508183001_CODEGEN_VTTR" AS "GB_B0" UNION ALL SELECT "GB_B1"."KEY" AS "KEY", "GB_B1"."Estimator" AS "Estimator" 
FROM "TMP_20180508183001_CODEGEN_WO37" AS "GB_B1") AS "GB_EnsembleUnion") AS "GB_Union") AS "U"

-- Code For temporary table TMP_20180508183001_CODEGEN_GTFF part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508183001_CODEGEN_GTFF" (
	"KEY" BIGINT NOT NULL, 
	"Estimator" DOUBLE PRECISION, 
	PRIMARY KEY ("KEY")
)
...
-- Code For temporary table TMP_20180508183001_CODEGEN_GTFF part 2. Populate

INSERT INTO "TMP_20180508183001_CODEGEN_GTFF" ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
FROM "TMP_20180508183001_CODEGEN_CJ0P" AS "GB_Union" GROUP BY "GB_Union"."KEY") AS "T") AS "GB_sum") AS "U"

-- Code For temporary table TMP_20180508183001_CODEGEN_GTFF part 3. Create Index 

CREATE INDEX "ix_TMP_20180508183001_C_2eea" ON "TMP_20180508183001_CODEGEN_GTFF" ("KEY")

-- Model deployment code

SELECT "GB_sum"."KEY" AS "KEY", 22.5789603960396 + 0.1 * "GB_sum"."Estimator" AS "Estimator" 
FROM "TMP_20180508183001_CODEGEN_GTFF" AS "GB_sum"