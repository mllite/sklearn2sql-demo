...
-- Code For temporary table TMP_20180516114745_CODEGEN_6CRNMD_GB_B0 part 1. Create 


CREATE TEMPORARY TABLE "TMP_20180516114745_CODEGEN_6CRNMD_GB_B0" (
	"KEY" BIGINT, 
	"Estimator" FLOAT
)
...
-- Code For temporary table TMP_20180516114745_CODEGEN_6CRNMD_GB_B0 part 2. Populate
...
FROM "DT_Output_9")
 INSERT INTO "TMP_20180516114745_CODEGEN_6CRNMD_GB_B0" ("KEY", "Estimator") SELECT "GB_B0"."KEY", "GB_B0"."Estimator" 
...
-- Code For temporary table TMP_20180516114745_CODEGEN_V8P99G_GB_B1 part 1. Create 


CREATE TEMPORARY TABLE "TMP_20180516114745_CODEGEN_V8P99G_GB_B1" (
	"KEY" BIGINT, 
	"Estimator" FLOAT
)
...
-- Code For temporary table TMP_20180516114745_CODEGEN_V8P99G_GB_B1 part 2. Populate
...
FROM "DT_Output_15")
 INSERT INTO "TMP_20180516114745_CODEGEN_V8P99G_GB_B1" ("KEY", "Estimator") SELECT "GB_B1"."KEY", "GB_B1"."Estimator" 
...
-- Code For temporary table TMP_20180516114745_CODEGEN_INABF1_GB_sum part 1. Create 


CREATE TEMPORARY TABLE "TMP_20180516114745_CODEGEN_INABF1_GB_sum" (
	"KEY" BIGINT NOT NULL, 
	"Estimator" FLOAT, 
	PRIMARY KEY ("KEY")
)
...
-- Code For temporary table TMP_20180516114745_CODEGEN_INABF1_GB_sum part 2. Populate
...
FROM "TMP_20180516114745_CODEGEN_6CRNMD_GB_B0" AS "GB_B0" UNION ALL SELECT "GB_B1"."KEY" AS "KEY", "GB_B1"."Estimator" AS "Estimator" 
FROM "TMP_20180516114745_CODEGEN_V8P99G_GB_B1" AS "GB_B1") AS "GB_EnsembleUnion")
 INSERT INTO "TMP_20180516114745_CODEGEN_INABF1_GB_sum" ("KEY", "Estimator") SELECT "GB_sum"."KEY", "GB_sum"."Estimator" 
...
-- Code For temporary table TMP_20180516114745_CODEGEN_INABF1_GB_sum part 3. Create Index 

CREATE INDEX "ix_TMP_20180516114745_CODEGEN_INABF1_GB_sum_KEY" ON "TMP_20180516114745_CODEGEN_INABF1_GB_sum" ("KEY")

-- Model deployment code

SELECT "GB_sum"."KEY" AS "KEY", 22.5789603960396 + 0.1 * "GB_sum"."Estimator" AS "Estimator" 
FROM "TMP_20180516114745_CODEGEN_INABF1_GB_sum" AS "GB_sum"