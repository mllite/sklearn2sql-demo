...
-- Code For temporary table TMP_20180602145403_SW4_GB_B0 part 1. Create 


CREATE TEMPORARY TABLE `TMP_20180602145403_SW4_GB_B0` (
	`KEY` BIGINT, 
	`Estimator` DOUBLE
)
...
-- Code For temporary table TMP_20180602145403_SW4_GB_B0 part 2. Populate

INSERT INTO `TMP_20180602145403_SW4_GB_B0` (`KEY`, `Estimator`) SELECT `U`.`KEY`, `U`.`Estimator` 
...
-- Code For temporary table TMP_20180602145403_6SY_GB_B1 part 1. Create 


CREATE TEMPORARY TABLE `TMP_20180602145403_6SY_GB_B1` (
	`KEY` BIGINT, 
	`Estimator` DOUBLE
)
...
-- Code For temporary table TMP_20180602145403_6SY_GB_B1 part 2. Populate

INSERT INTO `TMP_20180602145403_6SY_GB_B1` (`KEY`, `Estimator`) SELECT `U`.`KEY`, `U`.`Estimator` 
...
-- Code For temporary table TMP_20180602145403_X9X_GB_sum part 1. Create 


CREATE TEMPORARY TABLE `TMP_20180602145403_X9X_GB_sum` (
	`KEY` BIGINT NOT NULL, 
	`Estimator` DOUBLE, 
	PRIMARY KEY (`KEY`)
)
...
-- Code For temporary table TMP_20180602145403_X9X_GB_sum part 2. Populate

INSERT INTO `TMP_20180602145403_X9X_GB_sum` (`KEY`, `Estimator`) SELECT `U`.`KEY`, `U`.`Estimator` 
...
FROM `TMP_20180602145403_SW4_GB_B0` AS `GB_B0` UNION ALL SELECT `GB_B1`.`KEY` AS `KEY`, `GB_B1`.`Estimator` AS `Estimator` 
FROM `TMP_20180602145403_6SY_GB_B1` AS `GB_B1`) AS `GB_EnsembleUnion`)
...
-- Code For temporary table TMP_20180602145403_X9X_GB_sum part 3. Create Index 

CREATE INDEX `ix_TMP_20180602145403_X9X_GB_sum_KEY` ON `TMP_20180602145403_X9X_GB_sum` (`KEY`)

-- Model deployment code

SELECT `GB_sum`.`KEY` AS `KEY`, 22.5789603960396 + 0.1 * `GB_sum`.`Estimator` AS `Estimator` 
FROM `TMP_20180602145403_X9X_GB_sum` AS `GB_sum`