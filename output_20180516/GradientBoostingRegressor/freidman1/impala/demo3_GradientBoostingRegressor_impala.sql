...
-- Code For temporary table tmp_20180508194517_codegen_talk49_gb_b0 part 1. Create 


CREATE TABLE tmp_20180508194517_codegen_talk49_gb_b0 (
	`KEY` BIGINT, 
	`Estimator` DOUBLE
)
...
-- Code For temporary table tmp_20180508194517_codegen_talk49_gb_b0 part 2. Populate
...
FROM `DT_Output_9`)
 INSERT INTO tmp_20180508194517_codegen_talk49_gb_b0 (`KEY`, `Estimator`) SELECT `GB_B0`.`KEY`, `GB_B0`.`Estimator` 
...
-- Code For temporary table tmp_20180508194517_codegen_98se8r_gb_b1 part 1. Create 


CREATE TABLE tmp_20180508194517_codegen_98se8r_gb_b1 (
	`KEY` BIGINT, 
	`Estimator` DOUBLE
)
...
-- Code For temporary table tmp_20180508194517_codegen_98se8r_gb_b1 part 2. Populate
...
FROM `DT_Output_15`)
 INSERT INTO tmp_20180508194517_codegen_98se8r_gb_b1 (`KEY`, `Estimator`) SELECT `GB_B1`.`KEY`, `GB_B1`.`Estimator` 
...
-- Code For temporary table tmp_20180508194517_codegen_wvwedv_gb_union part 1. Create 


CREATE TABLE tmp_20180508194517_codegen_wvwedv_gb_union (
	`KEY` BIGINT, 
	`Estimator` DOUBLE
)
...
-- Code For temporary table tmp_20180508194517_codegen_wvwedv_gb_union part 2. Populate

INSERT INTO tmp_20180508194517_codegen_wvwedv_gb_union (`KEY`, `Estimator`) SELECT `GB_Union`.`KEY`, `GB_Union`.`Estimator` 
...
FROM tmp_20180508194517_codegen_talk49_gb_b0 AS `GB_B0` UNION ALL SELECT `GB_B1`.`KEY` AS `KEY`, `GB_B1`.`Estimator` AS `Estimator` 
FROM tmp_20180508194517_codegen_98se8r_gb_b1 AS `GB_B1`) AS `GB_EnsembleUnion`) AS `GB_Union`

-- Code For temporary table tmp_20180508194517_codegen_ehblp0_gb_sum part 1. Create 


CREATE TABLE tmp_20180508194517_codegen_ehblp0_gb_sum (
	`KEY` BIGINT, 
	`Estimator` DOUBLE
)
...
-- Code For temporary table tmp_20180508194517_codegen_ehblp0_gb_sum part 2. Populate

INSERT INTO tmp_20180508194517_codegen_ehblp0_gb_sum (`KEY`, `Estimator`) SELECT `GB_sum`.`KEY`, `GB_sum`.`Estimator` 
...
FROM tmp_20180508194517_codegen_wvwedv_gb_union AS `GB_Union` GROUP BY `GB_Union`.`KEY`) AS `T`) AS `GB_sum`

-- Model deployment code

SELECT `GB_sum`.`KEY` AS `KEY`, 15.3537633818605 + 0.1 * `GB_sum`.`Estimator` AS `Estimator` 
FROM tmp_20180508194517_codegen_ehblp0_gb_sum AS `GB_sum`