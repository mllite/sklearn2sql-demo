...
-- Code For temporary table tmp_20180516120728_codegen_3p21h6_gb_b0 part 1. Create 


CREATE TABLE tmp_20180516120728_codegen_3p21h6_gb_b0 (
	`KEY` BIGINT, 
	`Estimator` DOUBLE
)
...
-- Code For temporary table tmp_20180516120728_codegen_3p21h6_gb_b0 part 2. Populate
...
FROM `DT_Output_9`)
 INSERT INTO tmp_20180516120728_codegen_3p21h6_gb_b0 (`KEY`, `Estimator`) SELECT `GB_B0`.`KEY`, `GB_B0`.`Estimator` 
...
-- Code For temporary table tmp_20180516120728_codegen_aiqx4w_gb_b1 part 1. Create 


CREATE TABLE tmp_20180516120728_codegen_aiqx4w_gb_b1 (
	`KEY` BIGINT, 
	`Estimator` DOUBLE
)
...
-- Code For temporary table tmp_20180516120728_codegen_aiqx4w_gb_b1 part 2. Populate
...
FROM `DT_Output_15`)
 INSERT INTO tmp_20180516120728_codegen_aiqx4w_gb_b1 (`KEY`, `Estimator`) SELECT `GB_B1`.`KEY`, `GB_B1`.`Estimator` 
...
-- Code For temporary table tmp_20180516120728_codegen_rsbapv_gb_sum part 1. Create 


CREATE TABLE tmp_20180516120728_codegen_rsbapv_gb_sum (
	`KEY` BIGINT, 
	`Estimator` DOUBLE
)
...
-- Code For temporary table tmp_20180516120728_codegen_rsbapv_gb_sum part 2. Populate
...
FROM tmp_20180516120728_codegen_3p21h6_gb_b0 AS `GB_B0` UNION ALL SELECT `GB_B1`.`KEY` AS `KEY`, `GB_B1`.`Estimator` AS `Estimator` 
FROM tmp_20180516120728_codegen_aiqx4w_gb_b1 AS `GB_B1`) AS `GB_EnsembleUnion`)
 INSERT INTO tmp_20180516120728_codegen_rsbapv_gb_sum (`KEY`, `Estimator`) SELECT `GB_sum`.`KEY`, `GB_sum`.`Estimator` 
...
FROM tmp_20180516120728_codegen_rsbapv_gb_sum AS `GB_sum`