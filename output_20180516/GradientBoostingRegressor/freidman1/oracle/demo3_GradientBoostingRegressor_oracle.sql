...
-- Code For temporary table 84435_CODEGEN_OHT06P_GB_B0 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "84435_CODEGEN_OHT06P_GB_B0" (
	"KEY" NUMBER(19), 
...
-- Code For temporary table 84435_CODEGEN_OHT06P_GB_B0 part 2. Populate

INSERT INTO "84435_CODEGEN_OHT06P_GB_B0" ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
-- Code For temporary table 84435_CODEGEN_TSRUBE_GB_B1 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "84435_CODEGEN_TSRUBE_GB_B1" (
	"KEY" NUMBER(19), 
	"Estimator" BINARY_DOUBLE
)
...
-- Code For temporary table 84435_CODEGEN_TSRUBE_GB_B1 part 2. Populate

INSERT INTO "84435_CODEGEN_TSRUBE_GB_B1" ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
-- Code For temporary table 35_CODEGEN_JLQFIG_GB_UNION part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "35_CODEGEN_JLQFIG_GB_UNION" (
	"KEY" NUMBER(19), 
	"Estimator" BINARY_DOUBLE
)
...
-- Code For temporary table 35_CODEGEN_JLQFIG_GB_UNION part 2. Populate

INSERT INTO "35_CODEGEN_JLQFIG_GB_UNION" ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
FROM "84435_CODEGEN_OHT06P_GB_B0" "GB_B0" UNION ALL SELECT "GB_B1"."KEY" AS "KEY", "GB_B1"."Estimator" AS "Estimator" 
FROM "84435_CODEGEN_TSRUBE_GB_B1" "GB_B1") "GB_EnsembleUnion") "GB_Union") "U"

-- Code For temporary table 4435_CODEGEN_9O3H3E_GB_SUM part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "4435_CODEGEN_9O3H3E_GB_SUM" (
	"KEY" NUMBER(19), 
	"Estimator" BINARY_DOUBLE
)
...
-- Code For temporary table 4435_CODEGEN_9O3H3E_GB_SUM part 2. Populate

INSERT INTO "4435_CODEGEN_9O3H3E_GB_SUM" ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
FROM "35_CODEGEN_JLQFIG_GB_UNION" "GB_Union" GROUP BY "GB_Union"."KEY") "T") "GB_sum") "U"

-- Model deployment code

SELECT "GB_sum"."KEY" AS "KEY", 15.3537633818605 + 0.1 * "GB_sum"."Estimator" AS "Estimator" 
FROM "4435_CODEGEN_9O3H3E_GB_SUM" "GB_sum"