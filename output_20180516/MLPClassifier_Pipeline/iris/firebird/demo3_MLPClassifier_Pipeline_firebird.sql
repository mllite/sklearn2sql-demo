...
-- Code For temporary table TMP_20180508185710_CODEGEN_GEDM part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508185710_CODEGEN_GEDM" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20180508185710_CODEGEN_GEDM part 2. Populate

INSERT INTO "TMP_20180508185710_CODEGEN_GEDM" ("KEY", imputer_output_2, imputer_output_3, imputer_output_4, imputer_output_5) SELECT "U"."KEY", "U".imputer_output_2, "U".imputer_output_3, "U".imputer_output_4, "U".imputer_output_5 
...
-- Code For temporary table TMP_20180508185710_CODEGEN_GEDM part 3. Create Index 

CREATE INDEX "ix_TMP_20180508185710_C_47c8" ON "TMP_20180508185710_CODEGEN_GEDM" ("KEY")

-- Code For temporary table TMP_20180508185710_CODEGEN_GTRV part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508185710_CODEGEN_GTRV" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20180508185710_CODEGEN_GTRV part 2. Populate

INSERT INTO "TMP_20180508185710_CODEGEN_GTRV" ("KEY", scaler_output_2, scaler_output_3, scaler_output_4, scaler_output_5) SELECT "U"."KEY", "U".scaler_output_2, "U".scaler_output_3, "U".scaler_output_4, "U".scaler_output_5 
...
FROM "TMP_20180508185710_CODEGEN_GEDM" AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT") AS "U"

-- Code For temporary table TMP_20180508185710_CODEGEN_GTRV part 3. Create Index 

CREATE INDEX "ix_TMP_20180508185710_C_dfde" ON "TMP_20180508185710_CODEGEN_GTRV" ("KEY")

-- Code For temporary table TMP_20180508185710_CODEGEN_4DVK part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508185710_CODEGEN_4DVK" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20180508185710_CODEGEN_4DVK part 2. Populate

INSERT INTO "TMP_20180508185710_CODEGEN_4DVK" ("KEY", "NEUR_1_1", "NEUR_1_2", "NEUR_1_3") SELECT "U"."KEY", "U"."NEUR_1_1", "U"."NEUR_1_2", "U"."NEUR_1_3" 
FROM (WITH "IL" AS 
...
FROM "TMP_20180508185710_CODEGEN_GTRV" AS "ADS_sca_2_OUT"), 
"HL_BA_1" AS 
...
-- Code For temporary table TMP_20180508185710_CODEGEN_4DVK part 3. Create Index 

CREATE INDEX "ix_TMP_20180508185710_C_9d44" ON "TMP_20180508185710_CODEGEN_4DVK" ("KEY")

-- Code For temporary table TMP_20180508185710_CODEGEN_IQ33 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508185710_CODEGEN_IQ33" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20180508185710_CODEGEN_IQ33 part 2. Populate

INSERT INTO "TMP_20180508185710_CODEGEN_IQ33" ("KEY", "NEUR_3_1", "NEUR_3_2", "NEUR_3_3") SELECT "U"."KEY", "U"."NEUR_3_1", "U"."NEUR_3_2", "U"."NEUR_3_3" 
...
FROM "TMP_20180508185710_CODEGEN_4DVK" AS "HL_1_relu_1"), 
"HL_2_relu" AS 
...
-- Code For temporary table TMP_20180508185710_CODEGEN_IQ33 part 3. Create Index 

CREATE INDEX "ix_TMP_20180508185710_C_eaf2" ON "TMP_20180508185710_CODEGEN_IQ33" ("KEY")
...
FROM "TMP_20180508185710_CODEGEN_IQ33" AS "OL_softmax_1"), 
