...
-- Code For temporary table tmp_20180516122551_codegen_ea1m21_ads_imp_1_out part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180516122551_codegen_ea1m21_ads_imp_1_out (
	"KEY" BIGINT, 
...
-- Code For temporary table tmp_20180516122551_codegen_ea1m21_ads_imp_1_out part 2. Populate

INSERT INTO tmp_20180516122551_codegen_ea1m21_ads_imp_1_out SELECT "ADS_imp_1_OUT"."KEY", "ADS_imp_1_OUT".imputer_output_2, "ADS_imp_1_OUT".imputer_output_3, "ADS_imp_1_OUT".imputer_output_4, "ADS_imp_1_OUT".imputer_output_5 
FROM (SELECT "ADS"."KEY" AS "KEY", CASE WHEN ("ADS"."Feature_0" IS NULL) THEN 5.8474999999999975 ELSE "ADS"."Feature_0" END AS imputer_output_2, CASE WHEN ("ADS"."Feature_1" IS NULL) THEN 3.0366666666666657 ELSE "ADS"."Feature_1" END AS imputer_output_3, CASE WHEN ("ADS"."Feature_2" IS NULL) THEN 3.8450000000000006 ELSE "ADS"."Feature_2" END AS imputer_output_4, CASE WHEN ("ADS"."Feature_3" IS NULL) THEN 1.245 ELSE "ADS"."Feature_3" END AS imputer_output_5 
FROM "IRIS" AS "ADS") AS "ADS_imp_1_OUT"

-- Code For temporary table tmp_20180516122551_codegen_vjy22l_ads_sca_2_out part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180516122551_codegen_vjy22l_ads_sca_2_out (
	"KEY" BIGINT, 
...
-- Code For temporary table tmp_20180516122551_codegen_vjy22l_ads_sca_2_out part 2. Populate

INSERT INTO tmp_20180516122551_codegen_vjy22l_ads_sca_2_out SELECT "ADS_sca_2_OUT"."KEY", "ADS_sca_2_OUT".scaler_output_2, "ADS_sca_2_OUT".scaler_output_3, "ADS_sca_2_OUT".scaler_output_4, "ADS_sca_2_OUT".scaler_output_5 
...
FROM tmp_20180516122551_codegen_ea1m21_ads_imp_1_out AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT"

-- Code For temporary table tmp_20180516122551_codegen_xw7ogm_hl_1_relu_1 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180516122551_codegen_xw7ogm_hl_1_relu_1 (
	"KEY" BIGINT, 
	"NEUR_1_1" DOUBLE, 
	"NEUR_1_2" DOUBLE, 
	"NEUR_1_3" DOUBLE
...
-- Code For temporary table tmp_20180516122551_codegen_xw7ogm_hl_1_relu_1 part 2. Populate

INSERT INTO tmp_20180516122551_codegen_xw7ogm_hl_1_relu_1 WITH "IL" AS 
...
FROM tmp_20180516122551_codegen_vjy22l_ads_sca_2_out AS "ADS_sca_2_OUT"), 
"HL_BA_1" AS 
...
-- Code For temporary table tmp_20180516122551_codegen_lgt344_ol_softmax_1 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180516122551_codegen_lgt344_ol_softmax_1 (
	"KEY" BIGINT, 
	"NEUR_3_1" DOUBLE, 
	"NEUR_3_2" DOUBLE, 
	"NEUR_3_3" DOUBLE
...
-- Code For temporary table tmp_20180516122551_codegen_lgt344_ol_softmax_1 part 2. Populate

INSERT INTO tmp_20180516122551_codegen_lgt344_ol_softmax_1 WITH "HL_BA_2" AS 
...
FROM tmp_20180516122551_codegen_xw7ogm_hl_1_relu_1 AS "HL_1_relu_1"), 
"HL_2_relu" AS 
...
FROM tmp_20180516122551_codegen_lgt344_ol_softmax_1 AS "OL_softmax_1"), 
