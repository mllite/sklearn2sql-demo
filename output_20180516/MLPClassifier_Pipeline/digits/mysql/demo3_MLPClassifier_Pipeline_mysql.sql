...
-- Code For temporary table TMP_20180508183959_CODEGEN_9VVBIH_ADS_imp_1_OUT part 1. Create 


CREATE TEMPORARY TABLE `TMP_20180508183959_CODEGEN_9VVBIH_ADS_imp_1_OUT` (
	`KEY` BIGINT NOT NULL, 
	impter_2 DOUBLE, 
	impter_3 DOUBLE, 
	impter_4 DOUBLE, 
...
-- Code For temporary table TMP_20180508183959_CODEGEN_9VVBIH_ADS_imp_1_OUT part 3. Create Index 

CREATE INDEX `ix_TMP_20180508183959_CODEGEN_9VVBIH_ADS_imp_1_OUT_KEY` ON `TMP_20180508183959_CODEGEN_9VVBIH_ADS_imp_1_OUT` (`KEY`)

-- Code For temporary table TMP_20180508183959_CODEGEN_C7E0OQ_ADS_sca_2_OUT part 1. Create 


CREATE TEMPORARY TABLE `TMP_20180508183959_CODEGEN_C7E0OQ_ADS_sca_2_OUT` (
	`KEY` BIGINT NOT NULL, 
	scaler_2 DOUBLE, 
	scaler_3 DOUBLE, 
	scaler_4 DOUBLE, 
...
FROM `TMP_20180508183959_CODEGEN_9VVBIH_ADS_imp_1_OUT` AS `ADS_imp_1_OUT`) AS `ADS_sca_2_OUT`) AS `U`

-- Code For temporary table TMP_20180508183959_CODEGEN_C7E0OQ_ADS_sca_2_OUT part 3. Create Index 

CREATE INDEX `ix_TMP_20180508183959_CODEGEN_C7E0OQ_ADS_sca_2_OUT_KEY` ON `TMP_20180508183959_CODEGEN_C7E0OQ_ADS_sca_2_OUT` (`KEY`)

-- Code For temporary table TMP_20180508183959_CODEGEN_94TI6Z_HL_1_relu_1 part 1. Create 


CREATE TEMPORARY TABLE `TMP_20180508183959_CODEGEN_94TI6Z_HL_1_relu_1` (
	`KEY` BIGINT NOT NULL, 
	`NEUR_1_1` DOUBLE, 
	`NEUR_1_2` DOUBLE, 
	`NEUR_1_3` DOUBLE, 
...
-- Code For temporary table TMP_20180508183959_CODEGEN_94TI6Z_HL_1_relu_1 part 2. Populate

INSERT INTO `TMP_20180508183959_CODEGEN_94TI6Z_HL_1_relu_1` (`KEY`, `NEUR_1_1`, `NEUR_1_2`, `NEUR_1_3`) SELECT `U`.`KEY`, `U`.`NEUR_1_1`, `U`.`NEUR_1_2`, `U`.`NEUR_1_3` 
FROM (WITH `IL` AS 
...
FROM `TMP_20180508183959_CODEGEN_C7E0OQ_ADS_sca_2_OUT` AS `ADS_sca_2_OUT`), 
`HL_BA_1` AS 
...
-- Code For temporary table TMP_20180508183959_CODEGEN_94TI6Z_HL_1_relu_1 part 3. Create Index 

CREATE INDEX `ix_TMP_20180508183959_CODEGEN_94TI6Z_HL_1_relu_1_KEY` ON `TMP_20180508183959_CODEGEN_94TI6Z_HL_1_relu_1` (`KEY`)

-- Code For temporary table TMP_20180508183959_CODEGEN_KMH55P_OL_softmax_1 part 1. Create 


CREATE TEMPORARY TABLE `TMP_20180508183959_CODEGEN_KMH55P_OL_softmax_1` (
	`KEY` BIGINT NOT NULL, 
	`NEUR_3_1` DOUBLE, 
	`NEUR_3_2` DOUBLE, 
	`NEUR_3_3` DOUBLE, 
...
-- Code For temporary table TMP_20180508183959_CODEGEN_KMH55P_OL_softmax_1 part 2. Populate

INSERT INTO `TMP_20180508183959_CODEGEN_KMH55P_OL_softmax_1` (`KEY`, `NEUR_3_1`, `NEUR_3_2`, `NEUR_3_3`, `NEUR_3_4`, `NEUR_3_5`, `NEUR_3_6`, `NEUR_3_7`, `NEUR_3_8`, `NEUR_3_9`, `NEUR_3_10`) SELECT `U`.`KEY`, `U`.`NEUR_3_1`, `U`.`NEUR_3_2`, `U`.`NEUR_3_3`, `U`.`NEUR_3_4`, `U`.`NEUR_3_5`, `U`.`NEUR_3_6`, `U`.`NEUR_3_7`, `U`.`NEUR_3_8`, `U`.`NEUR_3_9`, `U`.`NEUR_3_10` 
...
FROM `TMP_20180508183959_CODEGEN_94TI6Z_HL_1_relu_1` AS `HL_1_relu_1`), 
`HL_2_relu` AS 
