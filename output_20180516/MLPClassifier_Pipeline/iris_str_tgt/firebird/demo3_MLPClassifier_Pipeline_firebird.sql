...
-- Code For temporary table TMP_20180516_CODEGEN_YGWPZA_ADS part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180516_CODEGEN_YGWPZA_ADS" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20180516_CODEGEN_YGWPZA_ADS part 2. Populate

INSERT INTO "TMP_20180516_CODEGEN_YGWPZA_ADS" ("KEY", imputer_output_2, imputer_output_3, imputer_output_4, imputer_output_5) SELECT "U"."KEY", "U".imputer_output_2, "U".imputer_output_3, "U".imputer_output_4, "U".imputer_output_5 
...
-- Code For temporary table TMP_20180516_CODEGEN_YGWPZA_ADS part 3. Create Index 

CREATE INDEX "ix_TMP_20180516_CODEGEN_fdbf" ON "TMP_20180516_CODEGEN_YGWPZA_ADS" ("KEY")

-- Code For temporary table TMP_20180516_CODEGEN_7RMOWZ_ADS part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180516_CODEGEN_7RMOWZ_ADS" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20180516_CODEGEN_7RMOWZ_ADS part 2. Populate

INSERT INTO "TMP_20180516_CODEGEN_7RMOWZ_ADS" ("KEY", scaler_output_2, scaler_output_3, scaler_output_4, scaler_output_5) SELECT "U"."KEY", "U".scaler_output_2, "U".scaler_output_3, "U".scaler_output_4, "U".scaler_output_5 
...
FROM "TMP_20180516_CODEGEN_YGWPZA_ADS" AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT") AS "U"

-- Code For temporary table TMP_20180516_CODEGEN_7RMOWZ_ADS part 3. Create Index 

CREATE INDEX "ix_TMP_20180516_CODEGEN_9016" ON "TMP_20180516_CODEGEN_7RMOWZ_ADS" ("KEY")

-- Code For temporary table TMP_20180516_CODEGEN_IA1PAW_HL_ part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180516_CODEGEN_IA1PAW_HL_" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20180516_CODEGEN_IA1PAW_HL_ part 2. Populate

INSERT INTO "TMP_20180516_CODEGEN_IA1PAW_HL_" ("KEY", "NEUR_1_1", "NEUR_1_2", "NEUR_1_3") SELECT "U"."KEY", "U"."NEUR_1_1", "U"."NEUR_1_2", "U"."NEUR_1_3" 
FROM (WITH "IL" AS 
...
FROM "TMP_20180516_CODEGEN_7RMOWZ_ADS" AS "ADS_sca_2_OUT"), 
"HL_BA_1" AS 
...
-- Code For temporary table TMP_20180516_CODEGEN_IA1PAW_HL_ part 3. Create Index 

CREATE INDEX "ix_TMP_20180516_CODEGEN_060d" ON "TMP_20180516_CODEGEN_IA1PAW_HL_" ("KEY")

-- Code For temporary table TMP_20180516_CODEGEN_380B0E_OL_ part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180516_CODEGEN_380B0E_OL_" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20180516_CODEGEN_380B0E_OL_ part 2. Populate

INSERT INTO "TMP_20180516_CODEGEN_380B0E_OL_" ("KEY", "NEUR_3_1", "NEUR_3_2", "NEUR_3_3") SELECT "U"."KEY", "U"."NEUR_3_1", "U"."NEUR_3_2", "U"."NEUR_3_3" 
...
FROM "TMP_20180516_CODEGEN_IA1PAW_HL_" AS "HL_1_relu_1"), 
"HL_2_relu" AS 
...
-- Code For temporary table TMP_20180516_CODEGEN_380B0E_OL_ part 3. Create Index 

CREATE INDEX "ix_TMP_20180516_CODEGEN_c48c" ON "TMP_20180516_CODEGEN_380B0E_OL_" ("KEY")
...
FROM "TMP_20180516_CODEGEN_380B0E_OL_" AS "OL_softmax_1"), 
