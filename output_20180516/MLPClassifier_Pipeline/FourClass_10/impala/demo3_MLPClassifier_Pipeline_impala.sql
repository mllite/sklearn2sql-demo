...
-- Code For temporary table tmp_20180516112442_codegen_5b1yt7_ads_imp_1_out part 1. Create 


CREATE TABLE tmp_20180516112442_codegen_5b1yt7_ads_imp_1_out (
	`KEY` BIGINT, 
	impter_2 DOUBLE, 
	impter_3 DOUBLE, 
	impter_4 DOUBLE, 
...
-- Code For temporary table tmp_20180516112442_codegen_uxnd03_ads_sca_2_out part 1. Create 


CREATE TABLE tmp_20180516112442_codegen_uxnd03_ads_sca_2_out (
	`KEY` BIGINT, 
	scaler_2 DOUBLE, 
	scaler_3 DOUBLE, 
	scaler_4 DOUBLE, 
...
-- Code For temporary table tmp_20180516112442_codegen_uxnd03_ads_sca_2_out part 2. Populate

INSERT INTO tmp_20180516112442_codegen_uxnd03_ads_sca_2_out (`KEY`, scaler_2, scaler_3, scaler_4, scaler_5, scaler_6, scaler_7, scaler_8, scaler_9, scaler_10, scaler_11) SELECT `ADS_sca_2_OUT`.`KEY`, `ADS_sca_2_OUT`.scaler_2, `ADS_sca_2_OUT`.scaler_3, `ADS_sca_2_OUT`.scaler_4, `ADS_sca_2_OUT`.scaler_5, `ADS_sca_2_OUT`.scaler_6, `ADS_sca_2_OUT`.scaler_7, `ADS_sca_2_OUT`.scaler_8, `ADS_sca_2_OUT`.scaler_9, `ADS_sca_2_OUT`.scaler_10, `ADS_sca_2_OUT`.scaler_11 
...
FROM tmp_20180516112442_codegen_5b1yt7_ads_imp_1_out AS `ADS_imp_1_OUT`) AS `ADS_sca_2_OUT`

-- Code For temporary table tmp_20180516112442_codegen_afd2xp_hl_1_relu_1 part 1. Create 


CREATE TABLE tmp_20180516112442_codegen_afd2xp_hl_1_relu_1 (
	`KEY` BIGINT, 
	`NEUR_1_1` DOUBLE, 
	`NEUR_1_2` DOUBLE, 
	`NEUR_1_3` DOUBLE
...
-- Code For temporary table tmp_20180516112442_codegen_afd2xp_hl_1_relu_1 part 2. Populate
...
FROM tmp_20180516112442_codegen_uxnd03_ads_sca_2_out AS `ADS_sca_2_OUT`), 
`HL_BA_1` AS 
...
FROM `HL_BA_1`)
 INSERT INTO tmp_20180516112442_codegen_afd2xp_hl_1_relu_1 (`KEY`, `NEUR_1_1`, `NEUR_1_2`, `NEUR_1_3`) SELECT `HL_1_relu_1`.`KEY`, `HL_1_relu_1`.`NEUR_1_1`, `HL_1_relu_1`.`NEUR_1_2`, `HL_1_relu_1`.`NEUR_1_3` 
FROM (SELECT `HL_1_relu`.`KEY` AS `KEY`, `HL_1_relu`.`NEUR_1_1` AS `NEUR_1_1`, `HL_1_relu`.`NEUR_1_2` AS `NEUR_1_2`, `HL_1_relu`.`NEUR_1_3` AS `NEUR_1_3` 
FROM `HL_1_relu`) AS `HL_1_relu_1`

-- Code For temporary table tmp_20180516112442_codegen_edwwd8_ol_softmax_1 part 1. Create 


CREATE TABLE tmp_20180516112442_codegen_edwwd8_ol_softmax_1 (
	`KEY` BIGINT, 
	`NEUR_3_1` DOUBLE, 
	`NEUR_3_2` DOUBLE, 
	`NEUR_3_3` DOUBLE, 
...
-- Code For temporary table tmp_20180516112442_codegen_edwwd8_ol_softmax_1 part 2. Populate
...
FROM tmp_20180516112442_codegen_afd2xp_hl_1_relu_1 AS `HL_1_relu_1`), 
`HL_2_relu` AS 
...
FROM `OL_BA`)
 INSERT INTO tmp_20180516112442_codegen_edwwd8_ol_softmax_1 (`KEY`, `NEUR_3_1`, `NEUR_3_2`, `NEUR_3_3`, `NEUR_3_4`) SELECT `OL_softmax_1`.`KEY`, `OL_softmax_1`.`NEUR_3_1`, `OL_softmax_1`.`NEUR_3_2`, `OL_softmax_1`.`NEUR_3_3`, `OL_softmax_1`.`NEUR_3_4` 
...
FROM tmp_20180516112442_codegen_edwwd8_ol_softmax_1 AS `OL_softmax_1`), 
