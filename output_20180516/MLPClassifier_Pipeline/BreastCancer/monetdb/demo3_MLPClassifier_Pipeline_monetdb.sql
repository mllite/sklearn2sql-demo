...
-- Code For temporary table tmp_20180516111758_codegen_33dz8h_ads_imp_1_out part 1. Create 


CREATE TEMPORARY TABLE tmp_20180516111758_codegen_33dz8h_ads_imp_1_out (
	"KEY" BIGINT, 
	impter_2 DOUBLE, 
	impter_3 DOUBLE, 
	impter_4 DOUBLE, 
...
-- Code For temporary table tmp_20180516111758_codegen_33dz8h_ads_imp_1_out part 2. Populate

INSERT INTO tmp_20180516111758_codegen_33dz8h_ads_imp_1_out ("KEY", impter_2, impter_3, impter_4, impter_5, impter_6, impter_7, impter_8, impter_9, impter_10, impter_11, impter_12, impter_13, impter_14, impter_15, impter_16, impter_17, impter_18, impter_19, impter_20, impter_21, impter_22, impter_23, impter_24, impter_25, impter_26, impter_27, impter_28, impter_29, impter_30, impter_31) SELECT "U"."KEY", "U".impter_2, "U".impter_3, "U".impter_4, "U".impter_5, "U".impter_6, "U".impter_7, "U".impter_8, "U".impter_9, "U".impter_10, "U".impter_11, "U".impter_12, "U".impter_13, "U".impter_14, "U".impter_15, "U".impter_16, "U".impter_17, "U".impter_18, "U".impter_19, "U".impter_20, "U".impter_21, "U".impter_22, "U".impter_23, "U".impter_24, "U".impter_25, "U".impter_26, "U".impter_27, "U".impter_28, "U".impter_29, "U".impter_30, "U".impter_31 
...
-- Code For temporary table tmp_20180516111758_codegen_x0kcx9_ads_sca_2_out part 1. Create 


CREATE TEMPORARY TABLE tmp_20180516111758_codegen_x0kcx9_ads_sca_2_out (
	"KEY" BIGINT, 
	scaler_2 DOUBLE, 
	scaler_3 DOUBLE, 
	scaler_4 DOUBLE, 
...
FROM tmp_20180516111758_codegen_33dz8h_ads_imp_1_out AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT") AS "U"

-- Code For temporary table tmp_20180516111758_codegen_x8qt0f_hl_1_relu_1 part 1. Create 


CREATE TEMPORARY TABLE tmp_20180516111758_codegen_x8qt0f_hl_1_relu_1 (
	"KEY" BIGINT, 
	"NEUR_1_1" DOUBLE, 
	"NEUR_1_2" DOUBLE, 
	"NEUR_1_3" DOUBLE
...
-- Code For temporary table tmp_20180516111758_codegen_x8qt0f_hl_1_relu_1 part 2. Populate

INSERT INTO tmp_20180516111758_codegen_x8qt0f_hl_1_relu_1 ("KEY", "NEUR_1_1", "NEUR_1_2", "NEUR_1_3") SELECT "U"."KEY", "U"."NEUR_1_1", "U"."NEUR_1_2", "U"."NEUR_1_3" 
FROM (WITH "IL" AS 
...
FROM tmp_20180516111758_codegen_x0kcx9_ads_sca_2_out AS "ADS_sca_2_OUT"), 
"HL_BA_1" AS 
...
-- Code For temporary table tmp_20180516111758_codegen_gd82g7_ol_logistic_1 part 1. Create 


CREATE TEMPORARY TABLE tmp_20180516111758_codegen_gd82g7_ol_logistic_1 (
	"KEY" BIGINT, 
	"NEUR_3_1" DOUBLE
)
...
-- Code For temporary table tmp_20180516111758_codegen_gd82g7_ol_logistic_1 part 2. Populate

INSERT INTO tmp_20180516111758_codegen_gd82g7_ol_logistic_1 ("KEY", "NEUR_3_1") SELECT "U"."KEY", "U"."NEUR_3_1" 
...
FROM tmp_20180516111758_codegen_x8qt0f_hl_1_relu_1 AS "HL_1_relu_1"), 
"HL_2_relu" AS 
...
FROM tmp_20180516111758_codegen_gd82g7_ol_logistic_1 AS "OL_logistic_1"), 
