...
-- Code For temporary table ##TMP_20180508180848_CODEGEN_MWA3M0_ADS_imp_1_OUT part 1. Create 


CREATE TABLE ##TMP_20180508180848_CODEGEN_MWA3M0_ADS_imp_1_OUT (
	[KEY] BIGINT NULL, 
...
-- Code For temporary table ##TMP_20180508180848_CODEGEN_17A7DV_ADS_sca_2_OUT part 1. Create 


CREATE TABLE ##TMP_20180508180848_CODEGEN_17A7DV_ADS_sca_2_OUT (
	[KEY] BIGINT NULL, 
	scaler_2 FLOAT NULL, 
	scaler_3 FLOAT NULL, 
	scaler_4 FLOAT NULL, 
...
FROM ##TMP_20180508180848_CODEGEN_MWA3M0_ADS_imp_1_OUT AS [ADS_imp_1_OUT]) AS [ADS_sca_2_OUT]

-- Code For temporary table ##TMP_20180508180848_CODEGEN_XW4PIC_HL_1_relu_1 part 1. Create 


CREATE TABLE ##TMP_20180508180848_CODEGEN_XW4PIC_HL_1_relu_1 (
	[KEY] BIGINT NULL, 
	[NEUR_1_1] FLOAT NULL, 
	[NEUR_1_2] FLOAT NULL, 
	[NEUR_1_3] FLOAT NULL
...
-- Code For temporary table ##TMP_20180508180848_CODEGEN_XW4PIC_HL_1_relu_1 part 2. Populate
...
FROM ##TMP_20180508180848_CODEGEN_17A7DV_ADS_sca_2_OUT AS [ADS_sca_2_OUT]), 
[HL_BA_1] AS 
...
FROM [HL_BA_1])
 INSERT INTO ##TMP_20180508180848_CODEGEN_XW4PIC_HL_1_relu_1 ([KEY], [NEUR_1_1], [NEUR_1_2], [NEUR_1_3]) SELECT [HL_1_relu_1].[KEY], [HL_1_relu_1].[NEUR_1_1], [HL_1_relu_1].[NEUR_1_2], [HL_1_relu_1].[NEUR_1_3] 
FROM (SELECT [HL_1_relu].[KEY] AS [KEY], [HL_1_relu].[NEUR_1_1] AS [NEUR_1_1], [HL_1_relu].[NEUR_1_2] AS [NEUR_1_2], [HL_1_relu].[NEUR_1_3] AS [NEUR_1_3] 
FROM [HL_1_relu]) AS [HL_1_relu_1]

-- Code For temporary table ##TMP_20180508180848_CODEGEN_DYO0JP_OL_logistic_1 part 1. Create 


CREATE TABLE ##TMP_20180508180848_CODEGEN_DYO0JP_OL_logistic_1 (
	[KEY] BIGINT NULL, 
	[NEUR_3_1] FLOAT NULL
)
...
-- Code For temporary table ##TMP_20180508180848_CODEGEN_DYO0JP_OL_logistic_1 part 2. Populate
...
FROM ##TMP_20180508180848_CODEGEN_XW4PIC_HL_1_relu_1 AS [HL_1_relu_1]), 
[HL_2_relu] AS 
...
FROM [OL_BA])
 INSERT INTO ##TMP_20180508180848_CODEGEN_DYO0JP_OL_logistic_1 ([KEY], [NEUR_3_1]) SELECT [OL_logistic_1].[KEY], [OL_logistic_1].[NEUR_3_1] 
...
FROM ##TMP_20180508180848_CODEGEN_DYO0JP_OL_logistic_1 AS [OL_logistic_1]), 
