...
-- Code For temporary table tmp_20180602153533_y8d_ads_imp_1_out part 1. Create 


CREATE TABLE tmp_20180602153533_y8d_ads_imp_1_out (
	`KEY` BIGINT, 
...
-- Code For temporary table tmp_20180602153533_y8d_ads_imp_1_out part 2. Populate

INSERT INTO tmp_20180602153533_y8d_ads_imp_1_out (`KEY`, imputer_output_2, imputer_output_3, imputer_output_4, imputer_output_5) SELECT `ADS_imp_1_OUT`.`KEY`, `ADS_imp_1_OUT`.imputer_output_2, `ADS_imp_1_OUT`.imputer_output_3, `ADS_imp_1_OUT`.imputer_output_4, `ADS_imp_1_OUT`.imputer_output_5 
...
-- Code For temporary table tmp_20180602153533_vrl_ads_sca_2_out part 1. Create 


CREATE TABLE tmp_20180602153533_vrl_ads_sca_2_out (
	`KEY` BIGINT, 
...
-- Code For temporary table tmp_20180602153533_vrl_ads_sca_2_out part 2. Populate

INSERT INTO tmp_20180602153533_vrl_ads_sca_2_out (`KEY`, scaler_output_2, scaler_output_3, scaler_output_4, scaler_output_5) SELECT `ADS_sca_2_OUT`.`KEY`, `ADS_sca_2_OUT`.scaler_output_2, `ADS_sca_2_OUT`.scaler_output_3, `ADS_sca_2_OUT`.scaler_output_4, `ADS_sca_2_OUT`.scaler_output_5 
...
FROM tmp_20180602153533_y8d_ads_imp_1_out AS `ADS_imp_1_OUT`) AS `ADS_sca_2_OUT`

-- Code For temporary table tmp_20180602153533_td4_hl_1_relu_1 part 1. Create 


CREATE TABLE tmp_20180602153533_td4_hl_1_relu_1 (
	`KEY` BIGINT, 
	`NEUR_1_1` DOUBLE, 
	`NEUR_1_2` DOUBLE, 
	`NEUR_1_3` DOUBLE
...
-- Code For temporary table tmp_20180602153533_td4_hl_1_relu_1 part 2. Populate
...
FROM tmp_20180602153533_vrl_ads_sca_2_out AS `ADS_sca_2_OUT`), 
`HL_BA_1` AS 
...
FROM `HL_BA_1`)
 INSERT INTO tmp_20180602153533_td4_hl_1_relu_1 (`KEY`, `NEUR_1_1`, `NEUR_1_2`, `NEUR_1_3`) SELECT `HL_1_relu_1`.`KEY`, `HL_1_relu_1`.`NEUR_1_1`, `HL_1_relu_1`.`NEUR_1_2`, `HL_1_relu_1`.`NEUR_1_3` 
FROM (SELECT `HL_1_relu`.`KEY` AS `KEY`, `HL_1_relu`.`NEUR_1_1` AS `NEUR_1_1`, `HL_1_relu`.`NEUR_1_2` AS `NEUR_1_2`, `HL_1_relu`.`NEUR_1_3` AS `NEUR_1_3` 
FROM `HL_1_relu`) AS `HL_1_relu_1`

-- Code For temporary table tmp_20180602153533_ia2_ol_softmax_1 part 1. Create 


CREATE TABLE tmp_20180602153533_ia2_ol_softmax_1 (
	`KEY` BIGINT, 
	`NEUR_3_1` DOUBLE, 
	`NEUR_3_2` DOUBLE, 
	`NEUR_3_3` DOUBLE
...
-- Code For temporary table tmp_20180602153533_ia2_ol_softmax_1 part 2. Populate
...
FROM tmp_20180602153533_td4_hl_1_relu_1 AS `HL_1_relu_1`), 
`HL_2_relu` AS 
...
FROM `OL_BA`)
 INSERT INTO tmp_20180602153533_ia2_ol_softmax_1 (`KEY`, `NEUR_3_1`, `NEUR_3_2`, `NEUR_3_3`) SELECT `OL_softmax_1`.`KEY`, `OL_softmax_1`.`NEUR_3_1`, `OL_softmax_1`.`NEUR_3_2`, `OL_softmax_1`.`NEUR_3_3` 
...
FROM tmp_20180602153533_ia2_ol_softmax_1 AS `OL_softmax_1`), 
