...
-- Code For temporary table tmp_20180516123810_codegen_0fo1js_ads_imp_1_out part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180516123810_codegen_0fo1js_ads_imp_1_out  (
	"KEY" BIGINT, 
...
-- Code For temporary table tmp_20180516123810_codegen_0fo1js_ads_imp_1_out part 2. Populate

INSERT INTO tmp_20180516123810_codegen_0fo1js_ads_imp_1_out ("KEY", imputer_output_2, imputer_output_3, imputer_output_4, imputer_output_5) SELECT "U"."KEY", "U".imputer_output_2, "U".imputer_output_3, "U".imputer_output_4, "U".imputer_output_5 
...
-- Code For temporary table tmp_20180516123810_codegen_1gzb9y_ads_sca_2_out part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180516123810_codegen_1gzb9y_ads_sca_2_out  (
	"KEY" BIGINT, 
...
-- Code For temporary table tmp_20180516123810_codegen_1gzb9y_ads_sca_2_out part 2. Populate

INSERT INTO tmp_20180516123810_codegen_1gzb9y_ads_sca_2_out ("KEY", scaler_output_2, scaler_output_3, scaler_output_4, scaler_output_5) SELECT "U"."KEY", "U".scaler_output_2, "U".scaler_output_3, "U".scaler_output_4, "U".scaler_output_5 
...
FROM tmp_20180516123810_codegen_0fo1js_ads_imp_1_out AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT") AS "U"

-- Code For temporary table tmp_20180516123810_codegen_v8ot8m_hl_1_relu_1 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180516123810_codegen_v8ot8m_hl_1_relu_1  (
	"KEY" BIGINT, 
...
-- Code For temporary table tmp_20180516123810_codegen_v8ot8m_hl_1_relu_1 part 2. Populate

INSERT INTO tmp_20180516123810_codegen_v8ot8m_hl_1_relu_1 ("KEY", "NEUR_1_1", "NEUR_1_2", "NEUR_1_3") SELECT "U"."KEY", "U"."NEUR_1_1", "U"."NEUR_1_2", "U"."NEUR_1_3" 
FROM (WITH "IL" AS 
...
FROM tmp_20180516123810_codegen_1gzb9y_ads_sca_2_out AS "ADS_sca_2_OUT"), 
"HL_BA_1" AS 
...
-- Code For temporary table tmp_20180516123810_codegen_kh59vs_ol_softmax_1 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180516123810_codegen_kh59vs_ol_softmax_1  (
	"KEY" BIGINT, 
...
-- Code For temporary table tmp_20180516123810_codegen_kh59vs_ol_softmax_1 part 2. Populate

INSERT INTO tmp_20180516123810_codegen_kh59vs_ol_softmax_1 ("KEY", "NEUR_3_1", "NEUR_3_2", "NEUR_3_3") SELECT "U"."KEY", "U"."NEUR_3_1", "U"."NEUR_3_2", "U"."NEUR_3_3" 
...
FROM tmp_20180516123810_codegen_v8ot8m_hl_1_relu_1 AS "HL_1_relu_1"), 
"HL_2_relu" AS 
...
FROM tmp_20180516123810_codegen_kh59vs_ol_softmax_1 AS "OL_softmax_1"), 
