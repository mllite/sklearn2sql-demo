...
-- Code For temporary table TMP_20180508180359_CODEGEN_TM5Q part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508180359_CODEGEN_TM5Q" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20180508180359_CODEGEN_TM5Q part 3. Create Index 

CREATE INDEX "ix_TMP_20180508180359_C_bd89" ON "TMP_20180508180359_CODEGEN_TM5Q" ("KEY")

-- Code For temporary table TMP_20180508180359_CODEGEN_EV3A part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508180359_CODEGEN_EV3A" (
	"KEY" BIGINT NOT NULL, 
...
FROM "TMP_20180508180359_CODEGEN_TM5Q" AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT") AS "U"

-- Code For temporary table TMP_20180508180359_CODEGEN_EV3A part 3. Create Index 

CREATE INDEX "ix_TMP_20180508180359_C_2175" ON "TMP_20180508180359_CODEGEN_EV3A" ("KEY")

-- Code For temporary table TMP_20180508180359_CODEGEN_87TF part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508180359_CODEGEN_87TF" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20180508180359_CODEGEN_87TF part 2. Populate

INSERT INTO "TMP_20180508180359_CODEGEN_87TF" ("KEY", "NEUR_1_1", "NEUR_1_2", "NEUR_1_3") SELECT "U"."KEY", "U"."NEUR_1_1", "U"."NEUR_1_2", "U"."NEUR_1_3" 
FROM (WITH "IL" AS 
...
FROM "TMP_20180508180359_CODEGEN_EV3A" AS "ADS_sca_2_OUT"), 
"HL_BA_1" AS 
...
-- Code For temporary table TMP_20180508180359_CODEGEN_87TF part 3. Create Index 

CREATE INDEX "ix_TMP_20180508180359_C_8abe" ON "TMP_20180508180359_CODEGEN_87TF" ("KEY")

-- Code For temporary table TMP_20180508180359_CODEGEN_84EV part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508180359_CODEGEN_84EV" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20180508180359_CODEGEN_84EV part 2. Populate

INSERT INTO "TMP_20180508180359_CODEGEN_84EV" ("KEY", "NEUR_3_1") SELECT "U"."KEY", "U"."NEUR_3_1" 
...
FROM "TMP_20180508180359_CODEGEN_87TF" AS "HL_1_relu_1"), 
"HL_2_relu" AS 
...
-- Code For temporary table TMP_20180508180359_CODEGEN_84EV part 3. Create Index 

CREATE INDEX "ix_TMP_20180508180359_C_0e59" ON "TMP_20180508180359_CODEGEN_84EV" ("KEY")
...
FROM "TMP_20180508180359_CODEGEN_84EV" AS "OL_logistic_1"), 
