...
-- Code For temporary table TMP_20180516_CODEGEN_J6XXO6_ADS part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180516_CODEGEN_J6XXO6_ADS" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20180516_CODEGEN_J6XXO6_ADS part 3. Create Index 

CREATE INDEX "ix_TMP_20180516_CODEGEN_a0ae" ON "TMP_20180516_CODEGEN_J6XXO6_ADS" ("KEY")

-- Code For temporary table TMP_20180516_CODEGEN_JTBX8C_ADS part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180516_CODEGEN_JTBX8C_ADS" (
	"KEY" BIGINT NOT NULL, 
...
FROM "TMP_20180516_CODEGEN_J6XXO6_ADS" AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT") AS "U"

-- Code For temporary table TMP_20180516_CODEGEN_JTBX8C_ADS part 3. Create Index 

CREATE INDEX "ix_TMP_20180516_CODEGEN_0d12" ON "TMP_20180516_CODEGEN_JTBX8C_ADS" ("KEY")

-- Code For temporary table TMP_20180516_CODEGEN_HKBC8O_HL_ part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180516_CODEGEN_HKBC8O_HL_" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20180516_CODEGEN_HKBC8O_HL_ part 2. Populate

INSERT INTO "TMP_20180516_CODEGEN_HKBC8O_HL_" ("KEY", "NEUR_1_1", "NEUR_1_2", "NEUR_1_3") SELECT "U"."KEY", "U"."NEUR_1_1", "U"."NEUR_1_2", "U"."NEUR_1_3" 
FROM (WITH "IL" AS 
...
FROM "TMP_20180516_CODEGEN_JTBX8C_ADS" AS "ADS_sca_2_OUT"), 
"HL_BA_1" AS 
(SELECT "IL"."KEY" AS "KEY", 0.35700328407140103 * "IL".scaler_2 + -0.1037594543184666 * "IL".scaler_3 + -0.031819805251470726 * "IL".scaler_4 + 0.058951834963934725 * "IL".scaler_5 + -0.6992887231304372 * "IL".scaler_6 + 0.5714175261024846 * "IL".scaler_7 + 0.0588141401486954 * "IL".scaler_8 + 0.1549468133911427 * "IL".scaler_9 + 0.8386129149029498 * "IL".scaler_10 + -0.052158336055007956 * "IL".scaler_11 + -1.0153613260477796 * "IL".scaler_12 + 0.3053353626531423 * "IL".scaler_13 + 0.07428035197111843 * "IL".scaler_14 + 0.1214738627023855 * "IL".scaler_15 + 0.29515227321056614 * "IL".scaler_16 + -0.6961647294007791 * "IL".scaler_17 + 0.2456250251409616 * "IL".scaler_18 + -0.16978263328388377 * "IL".scaler_19 + 0.03463237773190615 * "IL".scaler_20 + 0.046171779259396244 * "IL".scaler_21 + -0.3083667917444744 * "IL".scaler_22 + 0.4149198041075246 * "IL".scaler_23 + -0.23738195139335003 * "IL".scaler_24 + -0.29828349737569004 * "IL".scaler_25 + 0.14401371969521104 * "IL".scaler_26 + -0.08973712038062329 * "IL".scaler_27 + 0.0035956584054444617 * "IL".scaler_28 + -0.2307356431992899 * "IL".scaler_29 + -0.3602090321055631 * "IL".scaler_30 + 0.47597116162982156 * "IL".scaler_31 + 0.12020137085306414 * "IL".scaler_32 + -0.1815794120340707 * "IL".scaler_33 + 0.13859233277670843 * "IL".scaler_34 + -0.4531429561533027 * "IL".scaler_35 + -0.3320052466943154 * "IL".scaler_36 + 0.09412278368167344 * "IL".scaler_37 + -0.4904046654990922 * "IL".scaler_38 + 1.0525870848448944 * "IL".scaler_39 + -0.48359983673432494 * "IL".scaler_40 + -0.20588879552038983 * "IL".scaler_41 + -0.07123804059115066 * "IL".scaler_42 + -0.5338727078937195 * "IL".scaler_43 + 0.30514655313725997 * "IL".scaler_44 + -0.009707511154488122 * "IL".scaler_45 + -0.3756485263659393 * "IL".scaler_46 + 0.377862407582254 * "IL".scaler_47 + 0.5034669802136227 * "IL".scaler_48 + 0.26933672703484524 * "IL".scaler_49 + -0.26901933353321805 * "IL".scaler_50 + -0.22226088820693535 * "IL".scaler_51 + -0.35147101843377065 * "IL".scaler_52 + 0.33099255867055993 * "IL".scaler_53 + -0.23568071627400852 * "IL".scaler_54 + -0.39081754930401563 * "IL".scaler_55 + 0.14406060209233015 * "IL".scaler_56 + -0.26431665772518725 * "IL".scaler_57 + 0.23483579194663398 * "IL".scaler_58 + 0.5884610601480975 * "IL".scaler_59 + -0.17172921646054015 * "IL".scaler_60 + 0.06865982649312966 * "IL".scaler_61 + -0.16354914224211212 * "IL".scaler_62 + -0.03721611058687924 * "IL".scaler_63 + 0.5007840189272099 * "IL".scaler_64 + 0.6159244597356011 * "IL".scaler_65 + 0.1355737021299321 * "IL".scaler_66 + -0.16487186948850724 * "IL".scaler_67 + -0.5576092401599226 * "IL".scaler_68 + -0.19931276648475346 * "IL".scaler_69 + -0.5250990030229011 * "IL".scaler_70 + -0.18657858969406727 * "IL".scaler_71 + -0.2950161132976542 * "IL".scaler_72 + -0.6602758161643548 * "IL".scaler_73 + 0.025744091227941877 * "IL".scaler_74 + -0.21138041586181927 * "IL".scaler_75 + 0.20228971863354028 * "IL".scaler_76 + 0.43290104212468444 * "IL".scaler_77 + 0.32384273277639314 * "IL".scaler_78 + -1.0060348027696104 * "IL".scaler_79 + 0.11620708564792674 * "IL".scaler_80 + 0.058006276476599485 * "IL".scaler_81 + -0.202638574937044 * "IL".scaler_82 + -0.5070604128479355 * "IL".scaler_83 + 0.04293057089139571 * "IL".scaler_84 + 0.20672337204462565 * "IL".scaler_85 + 0.321653271140547 * "IL".scaler_86 + -0.3147158301282812 * "IL".scaler_87 + -0.47312587653851607 * "IL".scaler_88 + 0.03794493401137022 * "IL".scaler_89 + 0.7869437326916656 * "IL".scaler_90 + -0.33668059151645385 * "IL".scaler_91 + -0.5744563876464345 * "IL".scaler_92 + -0.49685877968051523 * "IL".scaler_93 + 0.5082063282027587 * "IL".scaler_94 + -0.23969950411137386 * "IL".scaler_95 + -0.0935140246954834 * "IL".scaler_96 + -0.07084885609869646 * "IL".scaler_97 + -0.31007107033420617 * "IL".scaler_98 + -0.1511349938678975 * "IL".scaler_99 + 0.30427145418167534 * "IL".scaler_100 + 0.5405694106745698 * "IL".scaler_101 + -1.0149900752424696 AS "NEUR_1_1", 0.22087896619248293 * "IL".scaler_2 + 0.10234571953072066 * "IL".scaler_3 + -0.1856302685835363 * "IL".scaler_4 + 0.21280733517187714 * "IL".scaler_5 + -0.49319313460584896 * "IL".scaler_6 + 0.030063706212672396 * "IL".scaler_7 + 0.007553145100237272 * "IL".scaler_8 + -0.3763165175999343 * "IL".scaler_9 + 0.3762199278986401 * "IL".scaler_10 + -0.18338461109034151 * "IL".scaler_11 + -0.22951243348537512 * "IL".scaler_12 + -0.11431813783843432 * "IL".scaler_13 + -0.1939906320408836 * "IL".scaler_14 + 0.4365744916259924 * "IL".scaler_15 + 0.2176281216809042 * "IL".scaler_16 + -0.12095001930810041 * "IL".scaler_17 + 0.10649350433300958 * "IL".scaler_18 + -0.10456288282978378 * "IL".scaler_19 + -0.10930625924936534 * "IL".scaler_20 + 0.17992963099300766 * "IL".scaler_21 + -0.021558379729115066 * "IL".scaler_22 + -0.19769257060932222 * "IL".scaler_23 + -0.37434747979528404 * "IL".scaler_24 + -0.1930765056716926 * "IL".scaler_25 + -0.050355209083854595 * "IL".scaler_26 + -0.175289717470562 * "IL".scaler_27 + 0.014844762851985839 * "IL".scaler_28 + 0.19455347545585694 * "IL".scaler_29 + -0.14822580182351328 * "IL".scaler_30 + -0.33163368555775236 * "IL".scaler_31 + -0.24542431007507404 * "IL".scaler_32 + -0.38409167768595043 * "IL".scaler_33 + -0.1504586950685483 * "IL".scaler_34 + -0.17524786992150315 * "IL".scaler_35 + -0.4122948269977452 * "IL".scaler_36 + 0.1340568174892844 * "IL".scaler_37 + 0.06532761931355073 * "IL".scaler_38 + -0.1749309662421567 * "IL".scaler_39 + 0.12164455432377536 * "IL".scaler_40 + 0.04150460450793604 * "IL".scaler_41 + 0.2732511273403339 * "IL".scaler_42 + 0.0005342938692667559 * "IL".scaler_43 + 0.1545672439981025 * "IL".scaler_44 + -0.029225231157502043 * "IL".scaler_45 + 0.02240041600872177 * "IL".scaler_46 + -0.18308197586625582 * "IL".scaler_47 + 0.29375792518678306 * "IL".scaler_48 + 0.08802975449601938 * "IL".scaler_49 + -0.1915012786139999 * "IL".scaler_50 + -0.25224997160813545 * "IL".scaler_51 + 0.03632704062064707 * "IL".scaler_52 + -0.24472891321122256 * "IL".scaler_53 + -0.19883804050411671 * "IL".scaler_54 + 0.026523814815531403 * "IL".scaler_55 + 0.11809939607462293 * "IL".scaler_56 + -0.14934787023595936 * "IL".scaler_57 + 0.09445637342119693 * "IL".scaler_58 + 0.6671311110936481 * "IL".scaler_59 + 0.06764644646208308 * "IL".scaler_60 + -0.14935165095310748 * "IL".scaler_61 + -0.45500919099140863 * "IL".scaler_62 + 0.30981894775901253 * "IL".scaler_63 + -0.06443740473375457 * "IL".scaler_64 + 0.1624010351717607 * "IL".scaler_65 + 0.44009531415179975 * "IL".scaler_66 + 0.13159457220000212 * "IL".scaler_67 + 0.4854672326674036 * "IL".scaler_68 + 0.5411878923394005 * "IL".scaler_69 + 0.05908066538113431 * "IL".scaler_70 + -0.2555614042350825 * "IL".scaler_71 + -0.2209722180990805 * "IL".scaler_72 + 0.44090760795119727 * "IL".scaler_73 + 0.05012383155002381 * "IL".scaler_74 + -0.02982292644701397 * "IL".scaler_75 + 0.03183027193882641 * "IL".scaler_76 + 0.2717639394920189 * "IL".scaler_77 + 0.11145445519153674 * "IL".scaler_78 + -0.49868748654558637 * "IL".scaler_79 + 0.054650549871441814 * "IL".scaler_80 + 0.11907193682253857 * "IL".scaler_81 + 0.15894979193333927 * "IL".scaler_82 + 0.11219754542879012 * "IL".scaler_83 + 0.016854029199558234 * "IL".scaler_84 + 0.11990973798517361 * "IL".scaler_85 + -0.1665788801814132 * "IL".scaler_86 + 0.03591196150028701 * "IL".scaler_87 + -0.1048686497684499 * "IL".scaler_88 + -0.27767983833639914 * "IL".scaler_89 + -0.26987822452396454 * "IL".scaler_90 + -0.10972345215488882 * "IL".scaler_91 + -0.20666583502972527 * "IL".scaler_92 + -0.42966877233746986 * "IL".scaler_93 + 0.4649114631559849 * "IL".scaler_94 + 0.4329534389999228 * "IL".scaler_95 + -0.35545091634938963 * "IL".scaler_96 + -0.05444140530318848 * "IL".scaler_97 + 0.0659999723558536 * "IL".scaler_98 + -0.11761468441267874 * "IL".scaler_99 + 0.28852650831465315 * "IL".scaler_100 + -0.3014734910735263 * "IL".scaler_101 + -0.16134646677649114 AS "NEUR_1_2", 0.2953944074490273 * "IL".scaler_2 + -0.28058557374639814 * "IL".scaler_3 + -0.13524523629388532 * "IL".scaler_4 + -0.16162339999153919 * "IL".scaler_5 + -0.9554031393932195 * "IL".scaler_6 + 0.27146117875906106 * "IL".scaler_7 + -0.15445548278300414 * "IL".scaler_8 + -0.06862864945147161 * "IL".scaler_9 + -0.2975987839809309 * "IL".scaler_10 + 0.504403366504544 * "IL".scaler_11 + 0.14111602633442222 * "IL".scaler_12 + -0.12236357286455543 * "IL".scaler_13 + 0.3505256230853871 * "IL".scaler_14 + 0.01748298557792966 * "IL".scaler_15 + -0.2699089080304034 * "IL".scaler_16 + -0.2515284574303784 * "IL".scaler_17 + -0.17127909282934006 * "IL".scaler_18 + 0.08739051586170093 * "IL".scaler_19 + -0.20737245096453027 * "IL".scaler_20 + -0.26142943084980147 * "IL".scaler_21 + 0.057657181766710315 * "IL".scaler_22 + -0.0703078336988912 * "IL".scaler_23 + -0.2726091780219622 * "IL".scaler_24 + -0.0010579848432772983 * "IL".scaler_25 + -0.1745668102723946 * "IL".scaler_26 + 0.19414927121541892 * "IL".scaler_27 + 0.058660469446784665 * "IL".scaler_28 + 0.3243160157632959 * "IL".scaler_29 + 0.041148806157850513 * "IL".scaler_30 + -0.03035344442945433 * "IL".scaler_31 + -0.2585410051765102 * "IL".scaler_32 + -0.2932383781372753 * "IL".scaler_33 + -0.005600502714169235 * "IL".scaler_34 + -0.2583904584706466 * "IL".scaler_35 + -0.26940549192689045 * "IL".scaler_36 + -0.13054311133254384 * "IL".scaler_37 + -0.16906000409587013 * "IL".scaler_38 + 0.368272116376879 * "IL".scaler_39 + -0.15971776172932328 * "IL".scaler_40 + -0.3507822453328727 * "IL".scaler_41 + 0.03521041760913949 * "IL".scaler_42 + -0.24290041734483706 * "IL".scaler_43 + -0.43201476288779656 * "IL".scaler_44 + 0.11521117989486178 * "IL".scaler_45 + -0.5539201232094136 * "IL".scaler_46 + -0.47593460044825703 * "IL".scaler_47 + 0.3166438399796928 * "IL".scaler_48 + 0.08418848747944092 * "IL".scaler_49 + -0.592655986923956 * "IL".scaler_50 + -0.2545941327790926 * "IL".scaler_51 + 0.39372093382410434 * "IL".scaler_52 + 0.07735519360095364 * "IL".scaler_53 + 0.14465286102603142 * "IL".scaler_54 + 0.22686981174370732 * "IL".scaler_55 + -0.02608000744291049 * "IL".scaler_56 + -0.18551278825838943 * "IL".scaler_57 + 0.11453464481792833 * "IL".scaler_58 + 0.8760659595252321 * "IL".scaler_59 + -0.1066492901792956 * "IL".scaler_60 + 0.16520076572849945 * "IL".scaler_61 + -0.42821282223089957 * "IL".scaler_62 + 0.08132893780068952 * "IL".scaler_63 + -0.2887925597064232 * "IL".scaler_64 + 0.3717573111409261 * "IL".scaler_65 + -0.0949447600934047 * "IL".scaler_66 + 0.17957089441669702 * "IL".scaler_67 + -0.13732485705565317 * "IL".scaler_68 + 0.2766430326438576 * "IL".scaler_69 + -0.3015777962192939 * "IL".scaler_70 + 0.03827827288029172 * "IL".scaler_71 + 0.017864402149702623 * "IL".scaler_72 + -0.352840515627103 * "IL".scaler_73 + -0.036562770674704634 * "IL".scaler_74 + -0.4212035301782967 * "IL".scaler_75 + 0.2921589049536415 * "IL".scaler_76 + -0.18114926655324592 * "IL".scaler_77 + 0.5058739768578726 * "IL".scaler_78 + -0.6605893726858232 * "IL".scaler_79 + -0.2406684686614794 * "IL".scaler_80 + -0.19790456988308291 * "IL".scaler_81 + 0.10918484365971645 * "IL".scaler_82 + 0.4426043470792952 * "IL".scaler_83 + 0.590987772798441 * "IL".scaler_84 + -0.12442491948341024 * "IL".scaler_85 + 0.06349482942461313 * "IL".scaler_86 + -0.08455823011868242 * "IL".scaler_87 + -0.21595266819152864 * "IL".scaler_88 + 0.19734680450949196 * "IL".scaler_89 + 0.03332165333886019 * "IL".scaler_90 + -0.3085953149205743 * "IL".scaler_91 + -0.2684940733536633 * "IL".scaler_92 + -0.0023366115278056856 * "IL".scaler_93 + 0.20333101139760398 * "IL".scaler_94 + -0.5234752636920016 * "IL".scaler_95 + -0.16054708221783354 * "IL".scaler_96 + -0.11363024244086702 * "IL".scaler_97 + -0.18632757051075768 * "IL".scaler_98 + -0.069815990236885 * "IL".scaler_99 + 0.24503092131090462 * "IL".scaler_100 + -0.05712681244635438 * "IL".scaler_101 + 0.421841001384555 AS "NEUR_1_3" 
FROM "IL"), 
"HL_1_relu" AS 
...
-- Code For temporary table TMP_20180516_CODEGEN_HKBC8O_HL_ part 3. Create Index 

CREATE INDEX "ix_TMP_20180516_CODEGEN_f5fa" ON "TMP_20180516_CODEGEN_HKBC8O_HL_" ("KEY")

-- Code For temporary table TMP_20180516_CODEGEN_RL0FRW_OL_ part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180516_CODEGEN_RL0FRW_OL_" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20180516_CODEGEN_RL0FRW_OL_ part 2. Populate

INSERT INTO "TMP_20180516_CODEGEN_RL0FRW_OL_" ("KEY", "NEUR_3_1") SELECT "U"."KEY", "U"."NEUR_3_1" 
FROM (WITH "HL_BA_2" AS 
(SELECT "HL_1_relu_1"."KEY" AS "KEY", 0.4877835093482188 * "HL_1_relu_1"."NEUR_1_1" + 0.7640820177647489 * "HL_1_relu_1"."NEUR_1_2" + 1.2935868732600717 * "HL_1_relu_1"."NEUR_1_3" + -0.3836291391462858 AS "NEUR_2_1", -0.2093863294158159 * "HL_1_relu_1"."NEUR_1_1" + -0.0998236745864489 * "HL_1_relu_1"."NEUR_1_2" + 0.148903805830189 * "HL_1_relu_1"."NEUR_1_3" + 1.9434291585808752 AS "NEUR_2_2", -0.3501648234363574 * "HL_1_relu_1"."NEUR_1_1" + 1.3483531489811509 * "HL_1_relu_1"."NEUR_1_2" + 1.0524789288081409 * "HL_1_relu_1"."NEUR_1_3" + -0.31699938593075055 AS "NEUR_2_3", -1.0966761917374277 * "HL_1_relu_1"."NEUR_1_1" + 0.22716483542720595 * "HL_1_relu_1"."NEUR_1_2" + -0.5669496004683575 * "HL_1_relu_1"."NEUR_1_3" + 0.9408192537628315 AS "NEUR_2_4", -0.6092229013363542 * "HL_1_relu_1"."NEUR_1_1" + -0.37759169845847745 * "HL_1_relu_1"."NEUR_1_2" + -0.6728648254423195 * "HL_1_relu_1"."NEUR_1_3" + -0.01807831622698608 AS "NEUR_2_5" 
FROM "TMP_20180516_CODEGEN_HKBC8O_HL_" AS "HL_1_relu_1"), 
"HL_2_relu" AS 
...
FROM "HL_BA_2"), 
"OL_BA" AS 
(SELECT "HL_2_relu"."KEY" AS "KEY", 1.551306757198663 * "HL_2_relu"."NEUR_2_1" + -1.3852380982648398 * "HL_2_relu"."NEUR_2_2" + 1.410782550589642 * "HL_2_relu"."NEUR_2_3" + -0.9180688455093254 * "HL_2_relu"."NEUR_2_4" + -0.2734195249053314 * "HL_2_relu"."NEUR_2_5" + -0.18483436711869422 AS "NEUR_3_1" 
FROM "HL_2_relu"), 
"OL_logistic" AS 
(SELECT "OL_BA"."KEY" AS "KEY", 1.0 / (1.0 + exp(CASE WHEN (minvalue(maxvalue(-100.0, -"OL_BA"."NEUR_3_1"), 100.0) >= -709.782712893384) THEN minvalue(maxvalue(-100.0, -"OL_BA"."NEUR_3_1"), 100.0) ELSE -709.782712893384 END)) AS "NEUR_3_1" 
FROM "OL_BA")
...
-- Code For temporary table TMP_20180516_CODEGEN_RL0FRW_OL_ part 3. Create Index 

CREATE INDEX "ix_TMP_20180516_CODEGEN_e97c" ON "TMP_20180516_CODEGEN_RL0FRW_OL_" ("KEY")
...
FROM "TMP_20180516_CODEGEN_RL0FRW_OL_" AS "OL_logistic_1"), 
