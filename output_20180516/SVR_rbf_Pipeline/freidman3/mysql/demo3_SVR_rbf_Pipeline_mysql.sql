...
-- Code For temporary table TMP_20180516122120_CODEGEN_9KTI9A_ADS_imp_1_OUT part 1. Create 


CREATE TEMPORARY TABLE `TMP_20180516122120_CODEGEN_9KTI9A_ADS_imp_1_OUT` (
	`KEY` BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20180516122120_CODEGEN_9KTI9A_ADS_imp_1_OUT part 2. Populate

INSERT INTO `TMP_20180516122120_CODEGEN_9KTI9A_ADS_imp_1_OUT` (`KEY`, imputer_output_2, imputer_output_3, imputer_output_4, imputer_output_5) SELECT `U`.`KEY`, `U`.imputer_output_2, `U`.imputer_output_3, `U`.imputer_output_4, `U`.imputer_output_5 
...
-- Code For temporary table TMP_20180516122120_CODEGEN_9KTI9A_ADS_imp_1_OUT part 3. Create Index 

CREATE INDEX `ix_TMP_20180516122120_CODEGEN_9KTI9A_ADS_imp_1_OUT_KEY` ON `TMP_20180516122120_CODEGEN_9KTI9A_ADS_imp_1_OUT` (`KEY`)

-- Code For temporary table TMP_20180516122120_CODEGEN_PSCTAZ_ADS_sca_2_OUT part 1. Create 


CREATE TEMPORARY TABLE `TMP_20180516122120_CODEGEN_PSCTAZ_ADS_sca_2_OUT` (
	`KEY` BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20180516122120_CODEGEN_PSCTAZ_ADS_sca_2_OUT part 2. Populate

INSERT INTO `TMP_20180516122120_CODEGEN_PSCTAZ_ADS_sca_2_OUT` (`KEY`, scaler_output_2, scaler_output_3, scaler_output_4, scaler_output_5) SELECT `U`.`KEY`, `U`.scaler_output_2, `U`.scaler_output_3, `U`.scaler_output_4, `U`.scaler_output_5 
...
FROM `TMP_20180516122120_CODEGEN_9KTI9A_ADS_imp_1_OUT` AS `ADS_imp_1_OUT`) AS `ADS_sca_2_OUT`) AS `U`

-- Code For temporary table TMP_20180516122120_CODEGEN_PSCTAZ_ADS_sca_2_OUT part 3. Create Index 

CREATE INDEX `ix_TMP_20180516122120_CODEGEN_PSCTAZ_ADS_sca_2_OUT_KEY` ON `TMP_20180516122120_CODEGEN_PSCTAZ_ADS_sca_2_OUT` (`KEY`)
...
FROM `TMP_20180516122120_CODEGEN_PSCTAZ_ADS_sca_2_OUT` AS `ADS_sca_2_OUT`), 
`SV_data` AS 
