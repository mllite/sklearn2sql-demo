...
-- Code For temporary table tmp_20180602144218_g61_xgb_b0 part 1. Create 

CREATE TEMPORARY TABLE `tmp_20180602144218_g61_xgb_b0` STORED AS ORC AS WITH `DT_node_lookup` AS 
...
-- Code For temporary table tmp_20180602144218_g61_xgb_b0 part 2. Populate

SELECT * FROM `tmp_20180602144218_g61_xgb_b0`

-- Code For temporary table tmp_20180602144218_ka3_xgb_b1 part 1. Create 

CREATE TEMPORARY TABLE `tmp_20180602144218_ka3_xgb_b1` STORED AS ORC AS WITH `DT_node_lookup_10` AS 
...
-- Code For temporary table tmp_20180602144218_ka3_xgb_b1 part 2. Populate

SELECT * FROM `tmp_20180602144218_ka3_xgb_b1`

-- Code For temporary table tmp_20180602144218_zgw_xgb_b2 part 1. Create 

CREATE TEMPORARY TABLE `tmp_20180602144218_zgw_xgb_b2` STORED AS ORC AS WITH `DT_node_lookup_20` AS 
...
-- Code For temporary table tmp_20180602144218_zgw_xgb_b2 part 2. Populate

SELECT * FROM `tmp_20180602144218_zgw_xgb_b2`

-- Code For temporary table tmp_20180602144218_4d4_xgb_b3 part 1. Create 

CREATE TEMPORARY TABLE `tmp_20180602144218_4d4_xgb_b3` STORED AS ORC AS WITH `DT_node_lookup_30` AS 
(SELECT `ADS`.`KEY` AS `KEY`, CASE WHEN (`ADS`.`Feature_56` < -0.03355539217591286) THEN 1 ELSE 2 END AS `node_id_2` 
FROM `FourClass_100` AS `ADS`), 
`DT_node_data_30` AS 
(SELECT `Values`.`nid` AS `nid`, CAST(`Values`.`Score` AS DOUBLE) AS `Score` 
...
-- Code For temporary table tmp_20180602144218_4d4_xgb_b3 part 2. Populate

SELECT * FROM `tmp_20180602144218_4d4_xgb_b3`

-- Code For temporary table tmp_20180602144218_6qz_xgb_b4 part 1. Create 

CREATE TEMPORARY TABLE `tmp_20180602144218_6qz_xgb_b4` STORED AS ORC AS WITH `DT_node_lookup_40` AS 
...
-- Code For temporary table tmp_20180602144218_6qz_xgb_b4 part 2. Populate

SELECT * FROM `tmp_20180602144218_6qz_xgb_b4`

-- Code For temporary table tmp_20180602144218_xcz_xgb_b5 part 1. Create 

CREATE TEMPORARY TABLE `tmp_20180602144218_xcz_xgb_b5` STORED AS ORC AS WITH `DT_node_lookup_50` AS 
...
-- Code For temporary table tmp_20180602144218_xcz_xgb_b5 part 2. Populate

SELECT * FROM `tmp_20180602144218_xcz_xgb_b5`

-- Code For temporary table tmp_20180602144218_esv_xgb_b6 part 1. Create 

CREATE TEMPORARY TABLE `tmp_20180602144218_esv_xgb_b6` STORED AS ORC AS WITH `DT_node_lookup_60` AS 
(SELECT `ADS`.`KEY` AS `KEY`, CASE WHEN (`ADS`.`Feature_92` < 0.07349112629890442) THEN 1 ELSE 2 END AS `node_id_2` 
FROM `FourClass_100` AS `ADS`), 
`DT_node_data_60` AS 
(SELECT `Values`.`nid` AS `nid`, CAST(`Values`.`Score` AS DOUBLE) AS `Score` 
...
-- Code For temporary table tmp_20180602144218_esv_xgb_b6 part 2. Populate

SELECT * FROM `tmp_20180602144218_esv_xgb_b6`

-- Code For temporary table tmp_20180602144218_ysf_xgb_sum part 1. Create 

CREATE TEMPORARY TABLE `tmp_20180602144218_ysf_xgb_sum` STORED AS ORC AS WITH `XGB_Union` AS 
...
FROM `tmp_20180602144218_g61_xgb_b0` AS `XGB_B0` UNION ALL SELECT `XGB_B1`.`KEY` AS `KEY`, `XGB_B1`.`Score_0` AS `Score_0`, `XGB_B1`.`Score_1` AS `Score_1`, `XGB_B1`.`Score_2` AS `Score_2`, `XGB_B1`.`Score_3` AS `Score_3` 
FROM `tmp_20180602144218_ka3_xgb_b1` AS `XGB_B1` UNION ALL SELECT `XGB_B2`.`KEY` AS `KEY`, `XGB_B2`.`Score_0` AS `Score_0`, `XGB_B2`.`Score_1` AS `Score_1`, `XGB_B2`.`Score_2` AS `Score_2`, `XGB_B2`.`Score_3` AS `Score_3` 
FROM `tmp_20180602144218_zgw_xgb_b2` AS `XGB_B2` UNION ALL SELECT `XGB_B3`.`KEY` AS `KEY`, `XGB_B3`.`Score_0` AS `Score_0`, `XGB_B3`.`Score_1` AS `Score_1`, `XGB_B3`.`Score_2` AS `Score_2`, `XGB_B3`.`Score_3` AS `Score_3` 
FROM `tmp_20180602144218_4d4_xgb_b3` AS `XGB_B3` UNION ALL SELECT `XGB_B4`.`KEY` AS `KEY`, `XGB_B4`.`Score_0` AS `Score_0`, `XGB_B4`.`Score_1` AS `Score_1`, `XGB_B4`.`Score_2` AS `Score_2`, `XGB_B4`.`Score_3` AS `Score_3` 
FROM `tmp_20180602144218_6qz_xgb_b4` AS `XGB_B4` UNION ALL SELECT `XGB_B5`.`KEY` AS `KEY`, `XGB_B5`.`Score_0` AS `Score_0`, `XGB_B5`.`Score_1` AS `Score_1`, `XGB_B5`.`Score_2` AS `Score_2`, `XGB_B5`.`Score_3` AS `Score_3` 
FROM `tmp_20180602144218_xcz_xgb_b5` AS `XGB_B5` UNION ALL SELECT `XGB_B6`.`KEY` AS `KEY`, `XGB_B6`.`Score_0` AS `Score_0`, `XGB_B6`.`Score_1` AS `Score_1`, `XGB_B6`.`Score_2` AS `Score_2`, `XGB_B6`.`Score_3` AS `Score_3` 
FROM `tmp_20180602144218_esv_xgb_b6` AS `XGB_B6`) AS `XGB_EnsembleUnion`)
...
-- Code For temporary table tmp_20180602144218_ysf_xgb_sum part 2. Populate

SELECT * FROM `tmp_20180602144218_ysf_xgb_sum`
...
FROM `tmp_20180602144218_ysf_xgb_sum` AS `XGB_sum`), 
