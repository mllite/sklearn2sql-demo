...
-- Code For temporary table tmp_20180508192550_codegen_tuhwpm_xgb_b0 part 1. Create 


CREATE TABLE tmp_20180508192550_codegen_tuhwpm_xgb_b0 (
	`KEY` BIGINT, 
	`Score_0` DOUBLE
)
...
-- Code For temporary table tmp_20180508192550_codegen_tuhwpm_xgb_b0 part 2. Populate
...
FROM `DT_Output_9`)
 INSERT INTO tmp_20180508192550_codegen_tuhwpm_xgb_b0 (`KEY`, `Score_0`) SELECT `XGB_B0`.`KEY`, `XGB_B0`.`Score_0` 
...
-- Code For temporary table tmp_20180508192550_codegen_gxv8c5_xgb_b1 part 1. Create 


CREATE TABLE tmp_20180508192550_codegen_gxv8c5_xgb_b1 (
	`KEY` BIGINT, 
	`Score_0` DOUBLE
)
...
-- Code For temporary table tmp_20180508192550_codegen_gxv8c5_xgb_b1 part 2. Populate
...
FROM `DT_Output_15`)
 INSERT INTO tmp_20180508192550_codegen_gxv8c5_xgb_b1 (`KEY`, `Score_0`) SELECT `XGB_B1`.`KEY`, `XGB_B1`.`Score_0` 
...
-- Code For temporary table tmp_20180508192550_codegen_8pns9t_xgb_union part 1. Create 


CREATE TABLE tmp_20180508192550_codegen_8pns9t_xgb_union (
	`KEY` BIGINT, 
	`Score_0` DOUBLE
)
...
-- Code For temporary table tmp_20180508192550_codegen_8pns9t_xgb_union part 2. Populate

INSERT INTO tmp_20180508192550_codegen_8pns9t_xgb_union (`KEY`, `Score_0`) SELECT `XGB_Union`.`KEY`, `XGB_Union`.`Score_0` 
...
FROM tmp_20180508192550_codegen_tuhwpm_xgb_b0 AS `XGB_B0` UNION ALL SELECT `XGB_B1`.`KEY` AS `KEY`, `XGB_B1`.`Score_0` AS `Score_0` 
FROM tmp_20180508192550_codegen_gxv8c5_xgb_b1 AS `XGB_B1`) AS `XGB_EnsembleUnion`) AS `XGB_Union`

-- Code For temporary table tmp_20180508192550_codegen_lslmnh_xgb_sum part 1. Create 


CREATE TABLE tmp_20180508192550_codegen_lslmnh_xgb_sum (
	`KEY` BIGINT, 
	`Score_0` DOUBLE
)
...
-- Code For temporary table tmp_20180508192550_codegen_lslmnh_xgb_sum part 2. Populate

INSERT INTO tmp_20180508192550_codegen_lslmnh_xgb_sum (`KEY`, `Score_0`) SELECT `XGB_sum`.`KEY`, `XGB_sum`.`Score_0` 
...
FROM tmp_20180508192550_codegen_8pns9t_xgb_union AS `XGB_Union` GROUP BY `XGB_Union`.`KEY`) AS `T`) AS `XGB_sum`
...
FROM tmp_20180508192550_codegen_lslmnh_xgb_sum AS `XGB_sum`), 
