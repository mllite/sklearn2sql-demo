...
-- Code For temporary table 1033_CODEGEN_31YTVL_XGB_B0 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "1033_CODEGEN_31YTVL_XGB_B0" (
	"KEY" NUMBER(19), 
...
-- Code For temporary table 1033_CODEGEN_31YTVL_XGB_B0 part 2. Populate

INSERT INTO "1033_CODEGEN_31YTVL_XGB_B0" ("KEY", "Score_0") SELECT "U"."KEY", "U"."Score_0" 
...
-- Code For temporary table 1033_CODEGEN_QR8N9N_XGB_B1 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "1033_CODEGEN_QR8N9N_XGB_B1" (
	"KEY" NUMBER(19), 
	"Score_0" BINARY_DOUBLE
)
...
-- Code For temporary table 1033_CODEGEN_QR8N9N_XGB_B1 part 2. Populate

INSERT INTO "1033_CODEGEN_QR8N9N_XGB_B1" ("KEY", "Score_0") SELECT "U"."KEY", "U"."Score_0" 
...
-- Code For temporary table 3_CODEGEN_HPTI4M_XGB_UNION part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "3_CODEGEN_HPTI4M_XGB_UNION" (
	"KEY" NUMBER(19), 
	"Score_0" BINARY_DOUBLE
)
...
-- Code For temporary table 3_CODEGEN_HPTI4M_XGB_UNION part 2. Populate

INSERT INTO "3_CODEGEN_HPTI4M_XGB_UNION" ("KEY", "Score_0") SELECT "U"."KEY", "U"."Score_0" 
...
FROM "1033_CODEGEN_31YTVL_XGB_B0" "XGB_B0" UNION ALL SELECT "XGB_B1"."KEY" AS "KEY", "XGB_B1"."Score_0" AS "Score_0" 
FROM "1033_CODEGEN_QR8N9N_XGB_B1" "XGB_B1") "XGB_EnsembleUnion") "XGB_Union") "U"

-- Code For temporary table 033_CODEGEN_6YSU36_XGB_SUM part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "033_CODEGEN_6YSU36_XGB_SUM" (
	"KEY" NUMBER(19), 
	"Score_0" BINARY_DOUBLE
)
...
-- Code For temporary table 033_CODEGEN_6YSU36_XGB_SUM part 2. Populate

INSERT INTO "033_CODEGEN_6YSU36_XGB_SUM" ("KEY", "Score_0") SELECT "U"."KEY", "U"."Score_0" 
...
FROM "3_CODEGEN_HPTI4M_XGB_UNION" "XGB_Union" GROUP BY "XGB_Union"."KEY") "T") "XGB_sum") "U"
...
FROM "033_CODEGEN_6YSU36_XGB_SUM" "XGB_sum"), 
