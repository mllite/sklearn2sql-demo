...
-- Code For temporary table tmp_20180516130321_codegen_pp7uxr_xgb_b0 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180516130321_codegen_pp7uxr_xgb_b0 (
	"KEY" BIGINT, 
...
-- Code For temporary table tmp_20180516130321_codegen_pp7uxr_xgb_b0 part 2. Populate

INSERT INTO tmp_20180516130321_codegen_pp7uxr_xgb_b0 WITH "DT_node_lookup" AS 
...
-- Code For temporary table tmp_20180516130321_codegen_dvc4k3_xgb_b1 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180516130321_codegen_dvc4k3_xgb_b1 (
	"KEY" BIGINT, 
	"Score_1789-07-14T00:00:00.000000000" DOUBLE, 
	"Score_1789-08-14T00:00:00.000000000" DOUBLE, 
	"Score_1789-09-14T00:00:00.000000000" DOUBLE
...
-- Code For temporary table tmp_20180516130321_codegen_dvc4k3_xgb_b1 part 2. Populate

INSERT INTO tmp_20180516130321_codegen_dvc4k3_xgb_b1 WITH "DT_node_lookup_10" AS 
...
-- Code For temporary table tmp_20180516130321_codegen_mwhv1c_xgb_b2 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180516130321_codegen_mwhv1c_xgb_b2 (
	"KEY" BIGINT, 
	"Score_1789-07-14T00:00:00.000000000" DOUBLE, 
	"Score_1789-08-14T00:00:00.000000000" DOUBLE, 
	"Score_1789-09-14T00:00:00.000000000" DOUBLE
...
-- Code For temporary table tmp_20180516130321_codegen_mwhv1c_xgb_b2 part 2. Populate

INSERT INTO tmp_20180516130321_codegen_mwhv1c_xgb_b2 WITH "DT_node_lookup_20" AS 
(SELECT "ADS"."KEY" AS "KEY", CASE WHEN ("ADS"."Feature_2" < 4.850000381469727) THEN 1 ELSE 2 END AS node_id_2 
FROM "IRIS_DATE_TGT" AS "ADS"), 
"DT_node_data_20" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE) AS "Score" 
...
-- Code For temporary table tmp_20180516130321_codegen_eteqn2_xgb_b3 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180516130321_codegen_eteqn2_xgb_b3 (
	"KEY" BIGINT, 
	"Score_1789-07-14T00:00:00.000000000" DOUBLE, 
	"Score_1789-08-14T00:00:00.000000000" DOUBLE, 
	"Score_1789-09-14T00:00:00.000000000" DOUBLE
...
-- Code For temporary table tmp_20180516130321_codegen_eteqn2_xgb_b3 part 2. Populate

INSERT INTO tmp_20180516130321_codegen_eteqn2_xgb_b3 WITH "DT_node_lookup_30" AS 
(SELECT "ADS"."KEY" AS "KEY", CASE WHEN ("ADS"."Feature_2" < 2.450000047683716) THEN 1 ELSE 2 END AS node_id_2 
FROM "IRIS_DATE_TGT" AS "ADS"), 
"DT_node_data_30" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE) AS "Score" 
...
-- Code For temporary table tmp_20180516130321_codegen_g0a0tx_xgb_b4 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180516130321_codegen_g0a0tx_xgb_b4 (
	"KEY" BIGINT, 
	"Score_1789-07-14T00:00:00.000000000" DOUBLE, 
	"Score_1789-08-14T00:00:00.000000000" DOUBLE, 
	"Score_1789-09-14T00:00:00.000000000" DOUBLE
...
-- Code For temporary table tmp_20180516130321_codegen_g0a0tx_xgb_b4 part 2. Populate

INSERT INTO tmp_20180516130321_codegen_g0a0tx_xgb_b4 WITH "DT_node_lookup_40" AS 
...
-- Code For temporary table tmp_20180516130321_codegen_b75hzk_xgb_sum part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180516130321_codegen_b75hzk_xgb_sum (
	"KEY" BIGINT, 
	"Score_1789-07-14T00:00:00.000000000" DOUBLE, 
	"Score_1789-08-14T00:00:00.000000000" DOUBLE, 
	"Score_1789-09-14T00:00:00.000000000" DOUBLE
...
-- Code For temporary table tmp_20180516130321_codegen_b75hzk_xgb_sum part 2. Populate

INSERT INTO tmp_20180516130321_codegen_b75hzk_xgb_sum WITH "XGB_Union" AS 
...
FROM tmp_20180516130321_codegen_b75hzk_xgb_sum AS "XGB_sum"), 
