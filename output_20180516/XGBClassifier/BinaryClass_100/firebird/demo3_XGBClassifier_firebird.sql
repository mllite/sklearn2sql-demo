...
-- Code For temporary table TMP_20180508180553_CODEGEN_7CDE part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508180553_CODEGEN_7CDE" (
	"KEY" BIGINT, 
...
-- Code For temporary table TMP_20180508180553_CODEGEN_7CDE part 2. Populate

INSERT INTO "TMP_20180508180553_CODEGEN_7CDE" ("KEY", "Score_0") SELECT "U"."KEY", "U"."Score_0" 
...
-- Code For temporary table TMP_20180508180553_CODEGEN_0RTK part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508180553_CODEGEN_0RTK" (
	"KEY" BIGINT, 
	"Score_0" DOUBLE PRECISION
)
...
-- Code For temporary table TMP_20180508180553_CODEGEN_0RTK part 2. Populate

INSERT INTO "TMP_20180508180553_CODEGEN_0RTK" ("KEY", "Score_0") SELECT "U"."KEY", "U"."Score_0" 
...
-- Code For temporary table TMP_20180508180553_CODEGEN_Q43W part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508180553_CODEGEN_Q43W" (
	"KEY" BIGINT, 
	"Score_0" DOUBLE PRECISION
)
...
-- Code For temporary table TMP_20180508180553_CODEGEN_Q43W part 2. Populate

INSERT INTO "TMP_20180508180553_CODEGEN_Q43W" ("KEY", "Score_0") SELECT "U"."KEY", "U"."Score_0" 
...
FROM "TMP_20180508180553_CODEGEN_7CDE" AS "XGB_B0" UNION ALL SELECT "XGB_B1"."KEY" AS "KEY", "XGB_B1"."Score_0" AS "Score_0" 
FROM "TMP_20180508180553_CODEGEN_0RTK" AS "XGB_B1") AS "XGB_EnsembleUnion") AS "XGB_Union") AS "U"

-- Code For temporary table TMP_20180508180553_CODEGEN_7CG1 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508180553_CODEGEN_7CG1" (
	"KEY" BIGINT NOT NULL, 
	"Score_0" DOUBLE PRECISION, 
	PRIMARY KEY ("KEY")
)
...
-- Code For temporary table TMP_20180508180553_CODEGEN_7CG1 part 2. Populate

INSERT INTO "TMP_20180508180553_CODEGEN_7CG1" ("KEY", "Score_0") SELECT "U"."KEY", "U"."Score_0" 
...
FROM "TMP_20180508180553_CODEGEN_Q43W" AS "XGB_Union" GROUP BY "XGB_Union"."KEY") AS "T") AS "XGB_sum") AS "U"

-- Code For temporary table TMP_20180508180553_CODEGEN_7CG1 part 3. Create Index 

CREATE INDEX "ix_TMP_20180508180553_C_d077" ON "TMP_20180508180553_CODEGEN_7CG1" ("KEY")
...
FROM "TMP_20180508180553_CODEGEN_7CG1" AS "XGB_sum"), 
