...
-- Code For temporary table TMP_20180516_CODEGEN_DK366R_XGB part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180516_CODEGEN_DK366R_XGB" (
	"KEY" BIGINT, 
...
-- Code For temporary table TMP_20180516_CODEGEN_DK366R_XGB part 2. Populate

INSERT INTO "TMP_20180516_CODEGEN_DK366R_XGB" ("KEY", "Score_0") SELECT "U"."KEY", "U"."Score_0" 
...
-- Code For temporary table TMP_20180516_CODEGEN_NRR40R_XGB part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180516_CODEGEN_NRR40R_XGB" (
	"KEY" BIGINT, 
	"Score_0" DOUBLE PRECISION
)
...
-- Code For temporary table TMP_20180516_CODEGEN_NRR40R_XGB part 2. Populate

INSERT INTO "TMP_20180516_CODEGEN_NRR40R_XGB" ("KEY", "Score_0") SELECT "U"."KEY", "U"."Score_0" 
...
-- Code For temporary table TMP_20180516_CODEGEN_IAXZJ8_XGB part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180516_CODEGEN_IAXZJ8_XGB" (
	"KEY" BIGINT NOT NULL, 
	"Score_0" DOUBLE PRECISION, 
	PRIMARY KEY ("KEY")
)
...
-- Code For temporary table TMP_20180516_CODEGEN_IAXZJ8_XGB part 2. Populate

INSERT INTO "TMP_20180516_CODEGEN_IAXZJ8_XGB" ("KEY", "Score_0") SELECT "U"."KEY", "U"."Score_0" 
...
FROM "TMP_20180516_CODEGEN_DK366R_XGB" AS "XGB_B0" UNION ALL SELECT "XGB_B1"."KEY" AS "KEY", "XGB_B1"."Score_0" AS "Score_0" 
FROM "TMP_20180516_CODEGEN_NRR40R_XGB" AS "XGB_B1") AS "XGB_EnsembleUnion")
...
-- Code For temporary table TMP_20180516_CODEGEN_IAXZJ8_XGB part 3. Create Index 

CREATE INDEX "ix_TMP_20180516_CODEGEN_c859" ON "TMP_20180516_CODEGEN_IAXZJ8_XGB" ("KEY")
...
FROM "TMP_20180516_CODEGEN_IAXZJ8_XGB" AS "XGB_sum"), 
