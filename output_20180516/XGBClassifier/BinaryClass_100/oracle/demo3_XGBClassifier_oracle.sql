...
-- Code For temporary table 0552_CODEGEN_TY4354_XGB_B0 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "0552_CODEGEN_TY4354_XGB_B0" (
	"KEY" NUMBER(19), 
...
-- Code For temporary table 0552_CODEGEN_TY4354_XGB_B0 part 2. Populate

INSERT INTO "0552_CODEGEN_TY4354_XGB_B0" ("KEY", "Score_0") SELECT "U"."KEY", "U"."Score_0" 
...
-- Code For temporary table 0552_CODEGEN_5HQVWU_XGB_B1 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "0552_CODEGEN_5HQVWU_XGB_B1" (
	"KEY" NUMBER(19), 
	"Score_0" BINARY_DOUBLE
)
...
-- Code For temporary table 0552_CODEGEN_5HQVWU_XGB_B1 part 2. Populate

INSERT INTO "0552_CODEGEN_5HQVWU_XGB_B1" ("KEY", "Score_0") SELECT "U"."KEY", "U"."Score_0" 
...
-- Code For temporary table 2_CODEGEN_9MCAWO_XGB_UNION part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "2_CODEGEN_9MCAWO_XGB_UNION" (
	"KEY" NUMBER(19), 
	"Score_0" BINARY_DOUBLE
)
...
-- Code For temporary table 2_CODEGEN_9MCAWO_XGB_UNION part 2. Populate

INSERT INTO "2_CODEGEN_9MCAWO_XGB_UNION" ("KEY", "Score_0") SELECT "U"."KEY", "U"."Score_0" 
...
FROM "0552_CODEGEN_TY4354_XGB_B0" "XGB_B0" UNION ALL SELECT "XGB_B1"."KEY" AS "KEY", "XGB_B1"."Score_0" AS "Score_0" 
FROM "0552_CODEGEN_5HQVWU_XGB_B1" "XGB_B1") "XGB_EnsembleUnion") "XGB_Union") "U"

-- Code For temporary table 552_CODEGEN_DIK1L5_XGB_SUM part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "552_CODEGEN_DIK1L5_XGB_SUM" (
	"KEY" NUMBER(19), 
	"Score_0" BINARY_DOUBLE
)
...
-- Code For temporary table 552_CODEGEN_DIK1L5_XGB_SUM part 2. Populate

INSERT INTO "552_CODEGEN_DIK1L5_XGB_SUM" ("KEY", "Score_0") SELECT "U"."KEY", "U"."Score_0" 
...
FROM "2_CODEGEN_9MCAWO_XGB_UNION" "XGB_Union" GROUP BY "XGB_Union"."KEY") "T") "XGB_sum") "U"
...
FROM "552_CODEGEN_DIK1L5_XGB_SUM" "XGB_sum"), 
