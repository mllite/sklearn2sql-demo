...
-- Code For temporary table 0516_CODEGEN_J4Z82Z_XGB_B0 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "0516_CODEGEN_J4Z82Z_XGB_B0" (
	"KEY" NUMBER(19), 
...
-- Code For temporary table 0516_CODEGEN_J4Z82Z_XGB_B0 part 2. Populate

INSERT INTO "0516_CODEGEN_J4Z82Z_XGB_B0" ("KEY", "Score_0") SELECT "U"."KEY", "U"."Score_0" 
...
-- Code For temporary table 0516_CODEGEN_NICHB6_XGB_B1 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "0516_CODEGEN_NICHB6_XGB_B1" (
	"KEY" NUMBER(19), 
	"Score_0" BINARY_DOUBLE
)
...
-- Code For temporary table 0516_CODEGEN_NICHB6_XGB_B1 part 2. Populate

INSERT INTO "0516_CODEGEN_NICHB6_XGB_B1" ("KEY", "Score_0") SELECT "U"."KEY", "U"."Score_0" 
...
-- Code For temporary table 516_CODEGEN_FS5NSI_XGB_SUM part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "516_CODEGEN_FS5NSI_XGB_SUM" (
	"KEY" NUMBER(19), 
	"Score_0" BINARY_DOUBLE
)
...
-- Code For temporary table 516_CODEGEN_FS5NSI_XGB_SUM part 2. Populate

INSERT INTO "516_CODEGEN_FS5NSI_XGB_SUM" ("KEY", "Score_0") SELECT "U"."KEY", "U"."Score_0" 
...
FROM "0516_CODEGEN_J4Z82Z_XGB_B0" "XGB_B0" UNION ALL SELECT "XGB_B1"."KEY" AS "KEY", "XGB_B1"."Score_0" AS "Score_0" 
FROM "0516_CODEGEN_NICHB6_XGB_B1" "XGB_B1") "XGB_EnsembleUnion")
...
FROM "516_CODEGEN_FS5NSI_XGB_SUM" "XGB_sum"), 
