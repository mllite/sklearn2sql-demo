...
-- Code For temporary table tmp_20180516111353_codegen_xw9zi0_xgb_b0 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180516111353_codegen_xw9zi0_xgb_b0 (
	"KEY" BIGINT, 
	"Score_0" DOUBLE
)
...
-- Code For temporary table tmp_20180516111353_codegen_xw9zi0_xgb_b0 part 2. Populate

INSERT INTO tmp_20180516111353_codegen_xw9zi0_xgb_b0 WITH "DT_node_lookup" AS 
...
-- Code For temporary table tmp_20180516111353_codegen_op84uu_xgb_b1 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180516111353_codegen_op84uu_xgb_b1 (
	"KEY" BIGINT, 
	"Score_0" DOUBLE
)
...
-- Code For temporary table tmp_20180516111353_codegen_op84uu_xgb_b1 part 2. Populate

INSERT INTO tmp_20180516111353_codegen_op84uu_xgb_b1 WITH "DT_node_lookup_10" AS 
(SELECT "ADS"."KEY" AS "KEY", 0 AS node_id_2 
FROM "BINARYCLASS_100" AS "ADS"), 
"DT_node_data_10" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE) AS "Score" 
...
-- Code For temporary table tmp_20180516111353_codegen_nksotw_xgb_sum part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180516111353_codegen_nksotw_xgb_sum (
	"KEY" BIGINT, 
	"Score_0" DOUBLE
)
...
-- Code For temporary table tmp_20180516111353_codegen_nksotw_xgb_sum part 2. Populate

INSERT INTO tmp_20180516111353_codegen_nksotw_xgb_sum WITH "XGB_Union" AS 
...
FROM tmp_20180516111353_codegen_xw9zi0_xgb_b0 AS "XGB_B0" UNION ALL SELECT "XGB_B1"."KEY" AS "KEY", "XGB_B1"."Score_0" AS "Score_0" 
FROM tmp_20180516111353_codegen_op84uu_xgb_b1 AS "XGB_B1") AS "XGB_EnsembleUnion")
...
FROM tmp_20180516111353_codegen_nksotw_xgb_sum AS "XGB_sum"), 
