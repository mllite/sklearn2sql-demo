...
-- Code For temporary table tmp_20180509003922_codegen_lfjmdl_xgb_b0 part 1. Create 

CREATE TEMPORARY TABLE `tmp_20180509003922_codegen_lfjmdl_xgb_b0` STORED AS ORC AS WITH `DT_node_lookup` AS 
...
-- Code For temporary table tmp_20180509003922_codegen_lfjmdl_xgb_b0 part 2. Populate

SELECT * FROM `tmp_20180509003922_codegen_lfjmdl_xgb_b0`

-- Code For temporary table tmp_20180509003922_codegen_u3rtjl_xgb_b1 part 1. Create 

CREATE TEMPORARY TABLE `tmp_20180509003922_codegen_u3rtjl_xgb_b1` STORED AS ORC AS WITH `DT_node_lookup_10` AS 
...
-- Code For temporary table tmp_20180509003922_codegen_u3rtjl_xgb_b1 part 2. Populate

SELECT * FROM `tmp_20180509003922_codegen_u3rtjl_xgb_b1`

-- Code For temporary table tmp_20180509003922_codegen_tuqu11_xgb_b2 part 1. Create 

CREATE TEMPORARY TABLE `tmp_20180509003922_codegen_tuqu11_xgb_b2` STORED AS ORC AS WITH `DT_node_lookup_20` AS 
...
-- Code For temporary table tmp_20180509003922_codegen_tuqu11_xgb_b2 part 2. Populate

SELECT * FROM `tmp_20180509003922_codegen_tuqu11_xgb_b2`

-- Code For temporary table tmp_20180509003922_codegen_rm8q4t_xgb_b3 part 1. Create 

CREATE TEMPORARY TABLE `tmp_20180509003922_codegen_rm8q4t_xgb_b3` STORED AS ORC AS WITH `DT_node_lookup_30` AS 
...
-- Code For temporary table tmp_20180509003922_codegen_rm8q4t_xgb_b3 part 2. Populate

SELECT * FROM `tmp_20180509003922_codegen_rm8q4t_xgb_b3`

-- Code For temporary table tmp_20180509003922_codegen_vl97q1_xgb_b4 part 1. Create 

CREATE TEMPORARY TABLE `tmp_20180509003922_codegen_vl97q1_xgb_b4` STORED AS ORC AS WITH `DT_node_lookup_40` AS 
...
-- Code For temporary table tmp_20180509003922_codegen_vl97q1_xgb_b4 part 2. Populate

SELECT * FROM `tmp_20180509003922_codegen_vl97q1_xgb_b4`

-- Code For temporary table tmp_20180509003922_codegen_wkdwiv_xgb_b5 part 1. Create 

CREATE TEMPORARY TABLE `tmp_20180509003922_codegen_wkdwiv_xgb_b5` STORED AS ORC AS WITH `DT_node_lookup_50` AS 
...
-- Code For temporary table tmp_20180509003922_codegen_wkdwiv_xgb_b5 part 2. Populate

SELECT * FROM `tmp_20180509003922_codegen_wkdwiv_xgb_b5`

-- Code For temporary table tmp_20180509003922_codegen_iw75sv_xgb_b6 part 1. Create 

CREATE TEMPORARY TABLE `tmp_20180509003922_codegen_iw75sv_xgb_b6` STORED AS ORC AS WITH `DT_node_lookup_60` AS 
...
-- Code For temporary table tmp_20180509003922_codegen_iw75sv_xgb_b6 part 2. Populate

SELECT * FROM `tmp_20180509003922_codegen_iw75sv_xgb_b6`

-- Code For temporary table tmp_20180509003922_codegen_6tfkzh_xgb_b7 part 1. Create 

CREATE TEMPORARY TABLE `tmp_20180509003922_codegen_6tfkzh_xgb_b7` STORED AS ORC AS WITH `DT_node_lookup_70` AS 
(SELECT `ADS`.`KEY` AS `KEY`, CASE WHEN (`ADS`.`Feature_36` < 0.5) THEN CASE WHEN (`ADS`.`Feature_33` < 0.5) THEN 3 ELSE CASE WHEN (`ADS`.`Feature_21` < 8.5) THEN 7 ELSE 8 END END ELSE CASE WHEN (`ADS`.`Feature_36` < 3.5) THEN 5 ELSE 6 END END AS `node_id_2` 
FROM `digits` AS `ADS`), 
`DT_node_data_70` AS 
(SELECT `Values`.`nid` AS `nid`, CAST(`Values`.`Score` AS DOUBLE) AS `Score` 
...
-- Code For temporary table tmp_20180509003922_codegen_6tfkzh_xgb_b7 part 2. Populate

SELECT * FROM `tmp_20180509003922_codegen_6tfkzh_xgb_b7`

-- Code For temporary table tmp_20180509003922_codegen_hd0yt0_xgb_b8 part 1. Create 

CREATE TEMPORARY TABLE `tmp_20180509003922_codegen_hd0yt0_xgb_b8` STORED AS ORC AS WITH `DT_node_lookup_80` AS 
...
-- Code For temporary table tmp_20180509003922_codegen_hd0yt0_xgb_b8 part 2. Populate

SELECT * FROM `tmp_20180509003922_codegen_hd0yt0_xgb_b8`

-- Code For temporary table tmp_20180509003922_codegen_1bw9b5_xgb_b9 part 1. Create 

CREATE TEMPORARY TABLE `tmp_20180509003922_codegen_1bw9b5_xgb_b9` STORED AS ORC AS WITH `DT_node_lookup_90` AS 
...
-- Code For temporary table tmp_20180509003922_codegen_1bw9b5_xgb_b9 part 2. Populate

SELECT * FROM `tmp_20180509003922_codegen_1bw9b5_xgb_b9`

-- Code For temporary table tmp_20180509003922_codegen_tfcwoq_xgb_b10 part 1. Create 

CREATE TEMPORARY TABLE `tmp_20180509003922_codegen_tfcwoq_xgb_b10` STORED AS ORC AS WITH `DT_node_lookup_100` AS 
(SELECT `ADS`.`KEY` AS `KEY`, CASE WHEN (`ADS`.`Feature_36` < 0.5) THEN CASE WHEN (`ADS`.`Feature_28` < 2.5) THEN CASE WHEN (`ADS`.`Feature_43` < 4.5) THEN 7 ELSE 8 END ELSE 4 END ELSE CASE WHEN (`ADS`.`Feature_28` < 0.5) THEN 5 ELSE 6 END END AS `node_id_2` 
FROM `digits` AS `ADS`), 
`DT_node_data_100` AS 
(SELECT `Values`.`nid` AS `nid`, CAST(`Values`.`Score` AS DOUBLE) AS `Score` 
...
-- Code For temporary table tmp_20180509003922_codegen_tfcwoq_xgb_b10 part 2. Populate

SELECT * FROM `tmp_20180509003922_codegen_tfcwoq_xgb_b10`

-- Code For temporary table tmp_20180509003922_codegen_vber7z_xgb_b11 part 1. Create 

CREATE TEMPORARY TABLE `tmp_20180509003922_codegen_vber7z_xgb_b11` STORED AS ORC AS WITH `DT_node_lookup_110` AS 
(SELECT `ADS`.`KEY` AS `KEY`, CASE WHEN (`ADS`.`Feature_36` < 0.5) THEN CASE WHEN (`ADS`.`Feature_28` < 2.5) THEN CASE WHEN (`ADS`.`Feature_13` < 6.5) THEN 7 ELSE 8 END ELSE 4 END ELSE CASE WHEN (`ADS`.`Feature_36` < 3.5) THEN 5 ELSE 6 END END AS `node_id_2` 
FROM `digits` AS `ADS`), 
`DT_node_data_110` AS 
(SELECT `Values`.`nid` AS `nid`, CAST(`Values`.`Score` AS DOUBLE) AS `Score` 
...
-- Code For temporary table tmp_20180509003922_codegen_vber7z_xgb_b11 part 2. Populate

SELECT * FROM `tmp_20180509003922_codegen_vber7z_xgb_b11`

-- Code For temporary table tmp_20180509003922_codegen_mhxfs5_xgb_b12 part 1. Create 

CREATE TEMPORARY TABLE `tmp_20180509003922_codegen_mhxfs5_xgb_b12` STORED AS ORC AS WITH `DT_node_lookup_120` AS 
...
-- Code For temporary table tmp_20180509003922_codegen_mhxfs5_xgb_b12 part 2. Populate

SELECT * FROM `tmp_20180509003922_codegen_mhxfs5_xgb_b12`

-- Code For temporary table tmp_20180509003922_codegen_3jvv0g_xgb_b13 part 1. Create 

CREATE TEMPORARY TABLE `tmp_20180509003922_codegen_3jvv0g_xgb_b13` STORED AS ORC AS WITH `DT_node_lookup_130` AS 
...
-- Code For temporary table tmp_20180509003922_codegen_3jvv0g_xgb_b13 part 2. Populate

SELECT * FROM `tmp_20180509003922_codegen_3jvv0g_xgb_b13`

-- Code For temporary table tmp_20180509003922_codegen_tqxtht_xgb_b14 part 1. Create 

CREATE TEMPORARY TABLE `tmp_20180509003922_codegen_tqxtht_xgb_b14` STORED AS ORC AS WITH `DT_node_lookup_140` AS 
...
-- Code For temporary table tmp_20180509003922_codegen_tqxtht_xgb_b14 part 2. Populate

SELECT * FROM `tmp_20180509003922_codegen_tqxtht_xgb_b14`

-- Code For temporary table tmp_20180509003922_codegen_459xze_xgb_b15 part 1. Create 

CREATE TEMPORARY TABLE `tmp_20180509003922_codegen_459xze_xgb_b15` STORED AS ORC AS WITH `DT_node_lookup_150` AS 
...
-- Code For temporary table tmp_20180509003922_codegen_459xze_xgb_b15 part 2. Populate

SELECT * FROM `tmp_20180509003922_codegen_459xze_xgb_b15`

-- Code For temporary table tmp_20180509003922_codegen_azywns_xgb_union part 1. Create 

CREATE TEMPORARY TABLE `tmp_20180509003922_codegen_azywns_xgb_union` STORED AS ORC AS SELECT `XGB_Union`.`KEY`, `XGB_Union`.`Score_0`, `XGB_Union`.`Score_1`, `XGB_Union`.`Score_2`, `XGB_Union`.`Score_3`, `XGB_Union`.`Score_4`, `XGB_Union`.`Score_5`, `XGB_Union`.`Score_6`, `XGB_Union`.`Score_7`, `XGB_Union`.`Score_8`, `XGB_Union`.`Score_9` 
...
FROM `tmp_20180509003922_codegen_lfjmdl_xgb_b0` AS `XGB_B0` UNION ALL SELECT `XGB_B1`.`KEY` AS `KEY`, `XGB_B1`.`Score_0` AS `Score_0`, `XGB_B1`.`Score_1` AS `Score_1`, `XGB_B1`.`Score_2` AS `Score_2`, `XGB_B1`.`Score_3` AS `Score_3`, `XGB_B1`.`Score_4` AS `Score_4`, `XGB_B1`.`Score_5` AS `Score_5`, `XGB_B1`.`Score_6` AS `Score_6`, `XGB_B1`.`Score_7` AS `Score_7`, `XGB_B1`.`Score_8` AS `Score_8`, `XGB_B1`.`Score_9` AS `Score_9` 
FROM `tmp_20180509003922_codegen_u3rtjl_xgb_b1` AS `XGB_B1` UNION ALL SELECT `XGB_B2`.`KEY` AS `KEY`, `XGB_B2`.`Score_0` AS `Score_0`, `XGB_B2`.`Score_1` AS `Score_1`, `XGB_B2`.`Score_2` AS `Score_2`, `XGB_B2`.`Score_3` AS `Score_3`, `XGB_B2`.`Score_4` AS `Score_4`, `XGB_B2`.`Score_5` AS `Score_5`, `XGB_B2`.`Score_6` AS `Score_6`, `XGB_B2`.`Score_7` AS `Score_7`, `XGB_B2`.`Score_8` AS `Score_8`, `XGB_B2`.`Score_9` AS `Score_9` 
FROM `tmp_20180509003922_codegen_tuqu11_xgb_b2` AS `XGB_B2` UNION ALL SELECT `XGB_B3`.`KEY` AS `KEY`, `XGB_B3`.`Score_0` AS `Score_0`, `XGB_B3`.`Score_1` AS `Score_1`, `XGB_B3`.`Score_2` AS `Score_2`, `XGB_B3`.`Score_3` AS `Score_3`, `XGB_B3`.`Score_4` AS `Score_4`, `XGB_B3`.`Score_5` AS `Score_5`, `XGB_B3`.`Score_6` AS `Score_6`, `XGB_B3`.`Score_7` AS `Score_7`, `XGB_B3`.`Score_8` AS `Score_8`, `XGB_B3`.`Score_9` AS `Score_9` 
FROM `tmp_20180509003922_codegen_rm8q4t_xgb_b3` AS `XGB_B3` UNION ALL SELECT `XGB_B4`.`KEY` AS `KEY`, `XGB_B4`.`Score_0` AS `Score_0`, `XGB_B4`.`Score_1` AS `Score_1`, `XGB_B4`.`Score_2` AS `Score_2`, `XGB_B4`.`Score_3` AS `Score_3`, `XGB_B4`.`Score_4` AS `Score_4`, `XGB_B4`.`Score_5` AS `Score_5`, `XGB_B4`.`Score_6` AS `Score_6`, `XGB_B4`.`Score_7` AS `Score_7`, `XGB_B4`.`Score_8` AS `Score_8`, `XGB_B4`.`Score_9` AS `Score_9` 
FROM `tmp_20180509003922_codegen_vl97q1_xgb_b4` AS `XGB_B4` UNION ALL SELECT `XGB_B5`.`KEY` AS `KEY`, `XGB_B5`.`Score_0` AS `Score_0`, `XGB_B5`.`Score_1` AS `Score_1`, `XGB_B5`.`Score_2` AS `Score_2`, `XGB_B5`.`Score_3` AS `Score_3`, `XGB_B5`.`Score_4` AS `Score_4`, `XGB_B5`.`Score_5` AS `Score_5`, `XGB_B5`.`Score_6` AS `Score_6`, `XGB_B5`.`Score_7` AS `Score_7`, `XGB_B5`.`Score_8` AS `Score_8`, `XGB_B5`.`Score_9` AS `Score_9` 
FROM `tmp_20180509003922_codegen_wkdwiv_xgb_b5` AS `XGB_B5` UNION ALL SELECT `XGB_B6`.`KEY` AS `KEY`, `XGB_B6`.`Score_0` AS `Score_0`, `XGB_B6`.`Score_1` AS `Score_1`, `XGB_B6`.`Score_2` AS `Score_2`, `XGB_B6`.`Score_3` AS `Score_3`, `XGB_B6`.`Score_4` AS `Score_4`, `XGB_B6`.`Score_5` AS `Score_5`, `XGB_B6`.`Score_6` AS `Score_6`, `XGB_B6`.`Score_7` AS `Score_7`, `XGB_B6`.`Score_8` AS `Score_8`, `XGB_B6`.`Score_9` AS `Score_9` 
FROM `tmp_20180509003922_codegen_iw75sv_xgb_b6` AS `XGB_B6` UNION ALL SELECT `XGB_B7`.`KEY` AS `KEY`, `XGB_B7`.`Score_0` AS `Score_0`, `XGB_B7`.`Score_1` AS `Score_1`, `XGB_B7`.`Score_2` AS `Score_2`, `XGB_B7`.`Score_3` AS `Score_3`, `XGB_B7`.`Score_4` AS `Score_4`, `XGB_B7`.`Score_5` AS `Score_5`, `XGB_B7`.`Score_6` AS `Score_6`, `XGB_B7`.`Score_7` AS `Score_7`, `XGB_B7`.`Score_8` AS `Score_8`, `XGB_B7`.`Score_9` AS `Score_9` 
FROM `tmp_20180509003922_codegen_6tfkzh_xgb_b7` AS `XGB_B7` UNION ALL SELECT `XGB_B8`.`KEY` AS `KEY`, `XGB_B8`.`Score_0` AS `Score_0`, `XGB_B8`.`Score_1` AS `Score_1`, `XGB_B8`.`Score_2` AS `Score_2`, `XGB_B8`.`Score_3` AS `Score_3`, `XGB_B8`.`Score_4` AS `Score_4`, `XGB_B8`.`Score_5` AS `Score_5`, `XGB_B8`.`Score_6` AS `Score_6`, `XGB_B8`.`Score_7` AS `Score_7`, `XGB_B8`.`Score_8` AS `Score_8`, `XGB_B8`.`Score_9` AS `Score_9` 
FROM `tmp_20180509003922_codegen_hd0yt0_xgb_b8` AS `XGB_B8` UNION ALL SELECT `XGB_B9`.`KEY` AS `KEY`, `XGB_B9`.`Score_0` AS `Score_0`, `XGB_B9`.`Score_1` AS `Score_1`, `XGB_B9`.`Score_2` AS `Score_2`, `XGB_B9`.`Score_3` AS `Score_3`, `XGB_B9`.`Score_4` AS `Score_4`, `XGB_B9`.`Score_5` AS `Score_5`, `XGB_B9`.`Score_6` AS `Score_6`, `XGB_B9`.`Score_7` AS `Score_7`, `XGB_B9`.`Score_8` AS `Score_8`, `XGB_B9`.`Score_9` AS `Score_9` 
FROM `tmp_20180509003922_codegen_1bw9b5_xgb_b9` AS `XGB_B9` UNION ALL SELECT `XGB_B10`.`KEY` AS `KEY`, `XGB_B10`.`Score_0` AS `Score_0`, `XGB_B10`.`Score_1` AS `Score_1`, `XGB_B10`.`Score_2` AS `Score_2`, `XGB_B10`.`Score_3` AS `Score_3`, `XGB_B10`.`Score_4` AS `Score_4`, `XGB_B10`.`Score_5` AS `Score_5`, `XGB_B10`.`Score_6` AS `Score_6`, `XGB_B10`.`Score_7` AS `Score_7`, `XGB_B10`.`Score_8` AS `Score_8`, `XGB_B10`.`Score_9` AS `Score_9` 
FROM `tmp_20180509003922_codegen_tfcwoq_xgb_b10` AS `XGB_B10` UNION ALL SELECT `XGB_B11`.`KEY` AS `KEY`, `XGB_B11`.`Score_0` AS `Score_0`, `XGB_B11`.`Score_1` AS `Score_1`, `XGB_B11`.`Score_2` AS `Score_2`, `XGB_B11`.`Score_3` AS `Score_3`, `XGB_B11`.`Score_4` AS `Score_4`, `XGB_B11`.`Score_5` AS `Score_5`, `XGB_B11`.`Score_6` AS `Score_6`, `XGB_B11`.`Score_7` AS `Score_7`, `XGB_B11`.`Score_8` AS `Score_8`, `XGB_B11`.`Score_9` AS `Score_9` 
FROM `tmp_20180509003922_codegen_vber7z_xgb_b11` AS `XGB_B11` UNION ALL SELECT `XGB_B12`.`KEY` AS `KEY`, `XGB_B12`.`Score_0` AS `Score_0`, `XGB_B12`.`Score_1` AS `Score_1`, `XGB_B12`.`Score_2` AS `Score_2`, `XGB_B12`.`Score_3` AS `Score_3`, `XGB_B12`.`Score_4` AS `Score_4`, `XGB_B12`.`Score_5` AS `Score_5`, `XGB_B12`.`Score_6` AS `Score_6`, `XGB_B12`.`Score_7` AS `Score_7`, `XGB_B12`.`Score_8` AS `Score_8`, `XGB_B12`.`Score_9` AS `Score_9` 
FROM `tmp_20180509003922_codegen_mhxfs5_xgb_b12` AS `XGB_B12` UNION ALL SELECT `XGB_B13`.`KEY` AS `KEY`, `XGB_B13`.`Score_0` AS `Score_0`, `XGB_B13`.`Score_1` AS `Score_1`, `XGB_B13`.`Score_2` AS `Score_2`, `XGB_B13`.`Score_3` AS `Score_3`, `XGB_B13`.`Score_4` AS `Score_4`, `XGB_B13`.`Score_5` AS `Score_5`, `XGB_B13`.`Score_6` AS `Score_6`, `XGB_B13`.`Score_7` AS `Score_7`, `XGB_B13`.`Score_8` AS `Score_8`, `XGB_B13`.`Score_9` AS `Score_9` 
FROM `tmp_20180509003922_codegen_3jvv0g_xgb_b13` AS `XGB_B13` UNION ALL SELECT `XGB_B14`.`KEY` AS `KEY`, `XGB_B14`.`Score_0` AS `Score_0`, `XGB_B14`.`Score_1` AS `Score_1`, `XGB_B14`.`Score_2` AS `Score_2`, `XGB_B14`.`Score_3` AS `Score_3`, `XGB_B14`.`Score_4` AS `Score_4`, `XGB_B14`.`Score_5` AS `Score_5`, `XGB_B14`.`Score_6` AS `Score_6`, `XGB_B14`.`Score_7` AS `Score_7`, `XGB_B14`.`Score_8` AS `Score_8`, `XGB_B14`.`Score_9` AS `Score_9` 
FROM `tmp_20180509003922_codegen_tqxtht_xgb_b14` AS `XGB_B14` UNION ALL SELECT `XGB_B15`.`KEY` AS `KEY`, `XGB_B15`.`Score_0` AS `Score_0`, `XGB_B15`.`Score_1` AS `Score_1`, `XGB_B15`.`Score_2` AS `Score_2`, `XGB_B15`.`Score_3` AS `Score_3`, `XGB_B15`.`Score_4` AS `Score_4`, `XGB_B15`.`Score_5` AS `Score_5`, `XGB_B15`.`Score_6` AS `Score_6`, `XGB_B15`.`Score_7` AS `Score_7`, `XGB_B15`.`Score_8` AS `Score_8`, `XGB_B15`.`Score_9` AS `Score_9` 
FROM `tmp_20180509003922_codegen_459xze_xgb_b15` AS `XGB_B15`) AS `XGB_EnsembleUnion`) AS `XGB_Union`

-- Code For temporary table tmp_20180509003922_codegen_azywns_xgb_union part 2. Populate

SELECT * FROM `tmp_20180509003922_codegen_azywns_xgb_union`

-- Code For temporary table tmp_20180509003922_codegen_h3h5os_xgb_sum part 1. Create 

CREATE TEMPORARY TABLE `tmp_20180509003922_codegen_h3h5os_xgb_sum` STORED AS ORC AS SELECT `XGB_sum`.`KEY`, `XGB_sum`.`Score_0`, `XGB_sum`.`Score_1`, `XGB_sum`.`Score_2`, `XGB_sum`.`Score_3`, `XGB_sum`.`Score_4`, `XGB_sum`.`Score_5`, `XGB_sum`.`Score_6`, `XGB_sum`.`Score_7`, `XGB_sum`.`Score_8`, `XGB_sum`.`Score_9` 
...
FROM `tmp_20180509003922_codegen_azywns_xgb_union` AS `XGB_Union` GROUP BY `XGB_Union`.`KEY`) AS `T`) AS `XGB_sum`

-- Code For temporary table tmp_20180509003922_codegen_h3h5os_xgb_sum part 2. Populate

SELECT * FROM `tmp_20180509003922_codegen_h3h5os_xgb_sum`
...
FROM `tmp_20180509003922_codegen_h3h5os_xgb_sum` AS `XGB_sum`), 
