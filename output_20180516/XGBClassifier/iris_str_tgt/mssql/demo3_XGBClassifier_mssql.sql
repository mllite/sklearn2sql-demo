...
-- Code For temporary table ##TMP_20180508190832_CODEGEN_5XT7IY_XGB_B0 part 1. Create 


CREATE TABLE ##TMP_20180508190832_CODEGEN_5XT7IY_XGB_B0 (
	[KEY] BIGINT NULL, 
...
-- Code For temporary table ##TMP_20180508190832_CODEGEN_5XT7IY_XGB_B0 part 2. Populate
...
FROM [DT_Output_9])
 INSERT INTO ##TMP_20180508190832_CODEGEN_5XT7IY_XGB_B0 ([KEY], [Score_CLASS_0], [Score_CLASS_1], [Score_CLASS_2]) SELECT [XGB_B0].[KEY], [XGB_B0].[Score_CLASS_0], [XGB_B0].[Score_CLASS_1], [XGB_B0].[Score_CLASS_2] 
...
-- Code For temporary table ##TMP_20180508190832_CODEGEN_7SU0XB_XGB_B1 part 1. Create 


CREATE TABLE ##TMP_20180508190832_CODEGEN_7SU0XB_XGB_B1 (
	[KEY] BIGINT NULL, 
	[Score_CLASS_0] FLOAT(53) NULL, 
	[Score_CLASS_1] FLOAT(53) NULL, 
	[Score_CLASS_2] FLOAT(53) NULL
...
-- Code For temporary table ##TMP_20180508190832_CODEGEN_7SU0XB_XGB_B1 part 2. Populate
...
FROM [DT_Output_19])
 INSERT INTO ##TMP_20180508190832_CODEGEN_7SU0XB_XGB_B1 ([KEY], [Score_CLASS_0], [Score_CLASS_1], [Score_CLASS_2]) SELECT [XGB_B1].[KEY], [XGB_B1].[Score_CLASS_0], [XGB_B1].[Score_CLASS_1], [XGB_B1].[Score_CLASS_2] 
...
-- Code For temporary table ##TMP_20180508190832_CODEGEN_XMCTDW_XGB_B2 part 1. Create 


CREATE TABLE ##TMP_20180508190832_CODEGEN_XMCTDW_XGB_B2 (
	[KEY] BIGINT NULL, 
	[Score_CLASS_0] FLOAT(53) NULL, 
	[Score_CLASS_1] FLOAT(53) NULL, 
	[Score_CLASS_2] FLOAT(53) NULL
...
-- Code For temporary table ##TMP_20180508190832_CODEGEN_XMCTDW_XGB_B2 part 2. Populate
...
FROM [DT_Output_29])
 INSERT INTO ##TMP_20180508190832_CODEGEN_XMCTDW_XGB_B2 ([KEY], [Score_CLASS_0], [Score_CLASS_1], [Score_CLASS_2]) SELECT [XGB_B2].[KEY], [XGB_B2].[Score_CLASS_0], [XGB_B2].[Score_CLASS_1], [XGB_B2].[Score_CLASS_2] 
...
-- Code For temporary table ##TMP_20180508190832_CODEGEN_967Y5L_XGB_B3 part 1. Create 


CREATE TABLE ##TMP_20180508190832_CODEGEN_967Y5L_XGB_B3 (
	[KEY] BIGINT NULL, 
	[Score_CLASS_0] FLOAT(53) NULL, 
	[Score_CLASS_1] FLOAT(53) NULL, 
	[Score_CLASS_2] FLOAT(53) NULL
...
-- Code For temporary table ##TMP_20180508190832_CODEGEN_967Y5L_XGB_B3 part 2. Populate
...
FROM [DT_Output_39])
 INSERT INTO ##TMP_20180508190832_CODEGEN_967Y5L_XGB_B3 ([KEY], [Score_CLASS_0], [Score_CLASS_1], [Score_CLASS_2]) SELECT [XGB_B3].[KEY], [XGB_B3].[Score_CLASS_0], [XGB_B3].[Score_CLASS_1], [XGB_B3].[Score_CLASS_2] 
...
-- Code For temporary table ##TMP_20180508190832_CODEGEN_W0J3AR_XGB_B4 part 1. Create 


CREATE TABLE ##TMP_20180508190832_CODEGEN_W0J3AR_XGB_B4 (
	[KEY] BIGINT NULL, 
	[Score_CLASS_0] FLOAT(53) NULL, 
	[Score_CLASS_1] FLOAT(53) NULL, 
	[Score_CLASS_2] FLOAT(53) NULL
...
-- Code For temporary table ##TMP_20180508190832_CODEGEN_W0J3AR_XGB_B4 part 2. Populate
...
FROM [DT_Output_47])
 INSERT INTO ##TMP_20180508190832_CODEGEN_W0J3AR_XGB_B4 ([KEY], [Score_CLASS_0], [Score_CLASS_1], [Score_CLASS_2]) SELECT [XGB_B4].[KEY], [XGB_B4].[Score_CLASS_0], [XGB_B4].[Score_CLASS_1], [XGB_B4].[Score_CLASS_2] 
...
-- Code For temporary table ##TMP_20180508190832_CODEGEN_HAVDR5_XGB_Union part 1. Create 


CREATE TABLE ##TMP_20180508190832_CODEGEN_HAVDR5_XGB_Union (
	[KEY] BIGINT NULL, 
	[Score_CLASS_0] FLOAT(53) NULL, 
	[Score_CLASS_1] FLOAT(53) NULL, 
	[Score_CLASS_2] FLOAT(53) NULL
...
-- Code For temporary table ##TMP_20180508190832_CODEGEN_HAVDR5_XGB_Union part 2. Populate

INSERT INTO ##TMP_20180508190832_CODEGEN_HAVDR5_XGB_Union ([KEY], [Score_CLASS_0], [Score_CLASS_1], [Score_CLASS_2]) SELECT [XGB_Union].[KEY], [XGB_Union].[Score_CLASS_0], [XGB_Union].[Score_CLASS_1], [XGB_Union].[Score_CLASS_2] 
...
FROM ##TMP_20180508190832_CODEGEN_5XT7IY_XGB_B0 AS [XGB_B0] UNION ALL SELECT [XGB_B1].[KEY] AS [KEY], [XGB_B1].[Score_CLASS_0] AS [Score_CLASS_0], [XGB_B1].[Score_CLASS_1] AS [Score_CLASS_1], [XGB_B1].[Score_CLASS_2] AS [Score_CLASS_2] 
FROM ##TMP_20180508190832_CODEGEN_7SU0XB_XGB_B1 AS [XGB_B1] UNION ALL SELECT [XGB_B2].[KEY] AS [KEY], [XGB_B2].[Score_CLASS_0] AS [Score_CLASS_0], [XGB_B2].[Score_CLASS_1] AS [Score_CLASS_1], [XGB_B2].[Score_CLASS_2] AS [Score_CLASS_2] 
FROM ##TMP_20180508190832_CODEGEN_XMCTDW_XGB_B2 AS [XGB_B2] UNION ALL SELECT [XGB_B3].[KEY] AS [KEY], [XGB_B3].[Score_CLASS_0] AS [Score_CLASS_0], [XGB_B3].[Score_CLASS_1] AS [Score_CLASS_1], [XGB_B3].[Score_CLASS_2] AS [Score_CLASS_2] 
FROM ##TMP_20180508190832_CODEGEN_967Y5L_XGB_B3 AS [XGB_B3] UNION ALL SELECT [XGB_B4].[KEY] AS [KEY], [XGB_B4].[Score_CLASS_0] AS [Score_CLASS_0], [XGB_B4].[Score_CLASS_1] AS [Score_CLASS_1], [XGB_B4].[Score_CLASS_2] AS [Score_CLASS_2] 
FROM ##TMP_20180508190832_CODEGEN_W0J3AR_XGB_B4 AS [XGB_B4]) AS [XGB_EnsembleUnion]) AS [XGB_Union]

-- Code For temporary table ##TMP_20180508190832_CODEGEN_U6L2B6_XGB_sum part 1. Create 


CREATE TABLE ##TMP_20180508190832_CODEGEN_U6L2B6_XGB_sum (
	[KEY] BIGINT NULL, 
	[Score_CLASS_0] FLOAT(53) NULL, 
	[Score_CLASS_1] FLOAT(53) NULL, 
	[Score_CLASS_2] FLOAT(53) NULL
...
-- Code For temporary table ##TMP_20180508190832_CODEGEN_U6L2B6_XGB_sum part 2. Populate

INSERT INTO ##TMP_20180508190832_CODEGEN_U6L2B6_XGB_sum ([KEY], [Score_CLASS_0], [Score_CLASS_1], [Score_CLASS_2]) SELECT [XGB_sum].[KEY], [XGB_sum].[Score_CLASS_0], [XGB_sum].[Score_CLASS_1], [XGB_sum].[Score_CLASS_2] 
...
FROM ##TMP_20180508190832_CODEGEN_HAVDR5_XGB_Union AS [XGB_Union] GROUP BY [XGB_Union].[KEY]) AS [T]) AS [XGB_sum]
...
FROM ##TMP_20180508190832_CODEGEN_U6L2B6_XGB_sum AS [XGB_sum]), 
