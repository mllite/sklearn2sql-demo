...
-- Code For temporary table TMP_20180516133808_CODEGEN_8B2N19_XGB_B0 part 1. Create 


CREATE TEMPORARY TABLE "TMP_20180516133808_CODEGEN_8B2N19_XGB_B0" (
	"KEY" BIGINT, 
	"Score_CLASS_0" FLOAT, 
	"Score_CLASS_1" FLOAT, 
	"Score_CLASS_2" FLOAT
...
-- Code For temporary table TMP_20180516133808_CODEGEN_8B2N19_XGB_B0 part 2. Populate
...
FROM "DT_Output_9")
 INSERT INTO "TMP_20180516133808_CODEGEN_8B2N19_XGB_B0" ("KEY", "Score_CLASS_0", "Score_CLASS_1", "Score_CLASS_2") SELECT "XGB_B0"."KEY", "XGB_B0"."Score_CLASS_0", "XGB_B0"."Score_CLASS_1", "XGB_B0"."Score_CLASS_2" 
...
-- Code For temporary table TMP_20180516133808_CODEGEN_UCR673_XGB_B1 part 1. Create 


CREATE TEMPORARY TABLE "TMP_20180516133808_CODEGEN_UCR673_XGB_B1" (
	"KEY" BIGINT, 
	"Score_CLASS_0" FLOAT, 
	"Score_CLASS_1" FLOAT, 
	"Score_CLASS_2" FLOAT
...
-- Code For temporary table TMP_20180516133808_CODEGEN_UCR673_XGB_B1 part 2. Populate
...
FROM "DT_Output_19")
 INSERT INTO "TMP_20180516133808_CODEGEN_UCR673_XGB_B1" ("KEY", "Score_CLASS_0", "Score_CLASS_1", "Score_CLASS_2") SELECT "XGB_B1"."KEY", "XGB_B1"."Score_CLASS_0", "XGB_B1"."Score_CLASS_1", "XGB_B1"."Score_CLASS_2" 
...
-- Code For temporary table TMP_20180516133808_CODEGEN_U6IX7O_XGB_B2 part 1. Create 


CREATE TEMPORARY TABLE "TMP_20180516133808_CODEGEN_U6IX7O_XGB_B2" (
	"KEY" BIGINT, 
	"Score_CLASS_0" FLOAT, 
	"Score_CLASS_1" FLOAT, 
	"Score_CLASS_2" FLOAT
...
-- Code For temporary table TMP_20180516133808_CODEGEN_U6IX7O_XGB_B2 part 2. Populate
...
FROM "DT_Output_29")
 INSERT INTO "TMP_20180516133808_CODEGEN_U6IX7O_XGB_B2" ("KEY", "Score_CLASS_0", "Score_CLASS_1", "Score_CLASS_2") SELECT "XGB_B2"."KEY", "XGB_B2"."Score_CLASS_0", "XGB_B2"."Score_CLASS_1", "XGB_B2"."Score_CLASS_2" 
...
-- Code For temporary table TMP_20180516133808_CODEGEN_LH701A_XGB_B3 part 1. Create 


CREATE TEMPORARY TABLE "TMP_20180516133808_CODEGEN_LH701A_XGB_B3" (
	"KEY" BIGINT, 
	"Score_CLASS_0" FLOAT, 
	"Score_CLASS_1" FLOAT, 
	"Score_CLASS_2" FLOAT
...
-- Code For temporary table TMP_20180516133808_CODEGEN_LH701A_XGB_B3 part 2. Populate
...
FROM "DT_Output_39")
 INSERT INTO "TMP_20180516133808_CODEGEN_LH701A_XGB_B3" ("KEY", "Score_CLASS_0", "Score_CLASS_1", "Score_CLASS_2") SELECT "XGB_B3"."KEY", "XGB_B3"."Score_CLASS_0", "XGB_B3"."Score_CLASS_1", "XGB_B3"."Score_CLASS_2" 
...
-- Code For temporary table TMP_20180516133808_CODEGEN_4I2ZVS_XGB_B4 part 1. Create 


CREATE TEMPORARY TABLE "TMP_20180516133808_CODEGEN_4I2ZVS_XGB_B4" (
	"KEY" BIGINT, 
	"Score_CLASS_0" FLOAT, 
	"Score_CLASS_1" FLOAT, 
	"Score_CLASS_2" FLOAT
...
-- Code For temporary table TMP_20180516133808_CODEGEN_4I2ZVS_XGB_B4 part 2. Populate
...
FROM "DT_Output_47")
 INSERT INTO "TMP_20180516133808_CODEGEN_4I2ZVS_XGB_B4" ("KEY", "Score_CLASS_0", "Score_CLASS_1", "Score_CLASS_2") SELECT "XGB_B4"."KEY", "XGB_B4"."Score_CLASS_0", "XGB_B4"."Score_CLASS_1", "XGB_B4"."Score_CLASS_2" 
...
-- Code For temporary table TMP_20180516133808_CODEGEN_2JKP4C_XGB_sum part 1. Create 


CREATE TEMPORARY TABLE "TMP_20180516133808_CODEGEN_2JKP4C_XGB_sum" (
	"KEY" BIGINT NOT NULL, 
	"Score_CLASS_0" FLOAT, 
	"Score_CLASS_1" FLOAT, 
	"Score_CLASS_2" FLOAT, 
...
-- Code For temporary table TMP_20180516133808_CODEGEN_2JKP4C_XGB_sum part 2. Populate
...
FROM "TMP_20180516133808_CODEGEN_8B2N19_XGB_B0" AS "XGB_B0" UNION ALL SELECT "XGB_B1"."KEY" AS "KEY", "XGB_B1"."Score_CLASS_0" AS "Score_CLASS_0", "XGB_B1"."Score_CLASS_1" AS "Score_CLASS_1", "XGB_B1"."Score_CLASS_2" AS "Score_CLASS_2" 
FROM "TMP_20180516133808_CODEGEN_UCR673_XGB_B1" AS "XGB_B1" UNION ALL SELECT "XGB_B2"."KEY" AS "KEY", "XGB_B2"."Score_CLASS_0" AS "Score_CLASS_0", "XGB_B2"."Score_CLASS_1" AS "Score_CLASS_1", "XGB_B2"."Score_CLASS_2" AS "Score_CLASS_2" 
FROM "TMP_20180516133808_CODEGEN_U6IX7O_XGB_B2" AS "XGB_B2" UNION ALL SELECT "XGB_B3"."KEY" AS "KEY", "XGB_B3"."Score_CLASS_0" AS "Score_CLASS_0", "XGB_B3"."Score_CLASS_1" AS "Score_CLASS_1", "XGB_B3"."Score_CLASS_2" AS "Score_CLASS_2" 
FROM "TMP_20180516133808_CODEGEN_LH701A_XGB_B3" AS "XGB_B3" UNION ALL SELECT "XGB_B4"."KEY" AS "KEY", "XGB_B4"."Score_CLASS_0" AS "Score_CLASS_0", "XGB_B4"."Score_CLASS_1" AS "Score_CLASS_1", "XGB_B4"."Score_CLASS_2" AS "Score_CLASS_2" 
FROM "TMP_20180516133808_CODEGEN_4I2ZVS_XGB_B4" AS "XGB_B4") AS "XGB_EnsembleUnion")
 INSERT INTO "TMP_20180516133808_CODEGEN_2JKP4C_XGB_sum" ("KEY", "Score_CLASS_0", "Score_CLASS_1", "Score_CLASS_2") SELECT "XGB_sum"."KEY", "XGB_sum"."Score_CLASS_0", "XGB_sum"."Score_CLASS_1", "XGB_sum"."Score_CLASS_2" 
...
-- Code For temporary table TMP_20180516133808_CODEGEN_2JKP4C_XGB_sum part 3. Create Index 

CREATE INDEX "ix_TMP_20180516133808_CODEGEN_2JKP4C_XGB_sum_KEY" ON "TMP_20180516133808_CODEGEN_2JKP4C_XGB_sum" ("KEY")
...
FROM "TMP_20180516133808_CODEGEN_2JKP4C_XGB_sum" AS "XGB_sum"), 
