...
-- Code For temporary table tmp_20180602162637_07k_xgb_b0 part 1. Create 


CREATE TEMPORARY TABLE tmp_20180602162637_07k_xgb_b0 (
	"KEY" BIGINT, 
...
-- Code For temporary table tmp_20180602162637_07k_xgb_b0 part 2. Populate

INSERT INTO tmp_20180602162637_07k_xgb_b0 ("KEY", "Score_CLASS_0", "Score_CLASS_1", "Score_CLASS_2") SELECT "U"."KEY", "U"."Score_CLASS_0", "U"."Score_CLASS_1", "U"."Score_CLASS_2" 
...
-- Code For temporary table tmp_20180602162637_285_xgb_b1 part 1. Create 


CREATE TEMPORARY TABLE tmp_20180602162637_285_xgb_b1 (
	"KEY" BIGINT, 
	"Score_CLASS_0" DOUBLE, 
	"Score_CLASS_1" DOUBLE, 
	"Score_CLASS_2" DOUBLE
...
-- Code For temporary table tmp_20180602162637_285_xgb_b1 part 2. Populate

INSERT INTO tmp_20180602162637_285_xgb_b1 ("KEY", "Score_CLASS_0", "Score_CLASS_1", "Score_CLASS_2") SELECT "U"."KEY", "U"."Score_CLASS_0", "U"."Score_CLASS_1", "U"."Score_CLASS_2" 
...
-- Code For temporary table tmp_20180602162637_5by_xgb_b2 part 1. Create 


CREATE TEMPORARY TABLE tmp_20180602162637_5by_xgb_b2 (
	"KEY" BIGINT, 
	"Score_CLASS_0" DOUBLE, 
	"Score_CLASS_1" DOUBLE, 
	"Score_CLASS_2" DOUBLE
...
-- Code For temporary table tmp_20180602162637_5by_xgb_b2 part 2. Populate

INSERT INTO tmp_20180602162637_5by_xgb_b2 ("KEY", "Score_CLASS_0", "Score_CLASS_1", "Score_CLASS_2") SELECT "U"."KEY", "U"."Score_CLASS_0", "U"."Score_CLASS_1", "U"."Score_CLASS_2" 
...
-- Code For temporary table tmp_20180602162637_tiw_xgb_b3 part 1. Create 


CREATE TEMPORARY TABLE tmp_20180602162637_tiw_xgb_b3 (
	"KEY" BIGINT, 
	"Score_CLASS_0" DOUBLE, 
	"Score_CLASS_1" DOUBLE, 
	"Score_CLASS_2" DOUBLE
...
-- Code For temporary table tmp_20180602162637_tiw_xgb_b3 part 2. Populate

INSERT INTO tmp_20180602162637_tiw_xgb_b3 ("KEY", "Score_CLASS_0", "Score_CLASS_1", "Score_CLASS_2") SELECT "U"."KEY", "U"."Score_CLASS_0", "U"."Score_CLASS_1", "U"."Score_CLASS_2" 
...
-- Code For temporary table tmp_20180602162637_k0i_xgb_b4 part 1. Create 


CREATE TEMPORARY TABLE tmp_20180602162637_k0i_xgb_b4 (
	"KEY" BIGINT, 
	"Score_CLASS_0" DOUBLE, 
	"Score_CLASS_1" DOUBLE, 
	"Score_CLASS_2" DOUBLE
...
-- Code For temporary table tmp_20180602162637_k0i_xgb_b4 part 2. Populate

INSERT INTO tmp_20180602162637_k0i_xgb_b4 ("KEY", "Score_CLASS_0", "Score_CLASS_1", "Score_CLASS_2") SELECT "U"."KEY", "U"."Score_CLASS_0", "U"."Score_CLASS_1", "U"."Score_CLASS_2" 
...
-- Code For temporary table tmp_20180602162637_zws_xgb_sum part 1. Create 


CREATE TEMPORARY TABLE tmp_20180602162637_zws_xgb_sum (
	"KEY" BIGINT, 
	"Score_CLASS_0" DOUBLE, 
	"Score_CLASS_1" DOUBLE, 
	"Score_CLASS_2" DOUBLE
...
-- Code For temporary table tmp_20180602162637_zws_xgb_sum part 2. Populate

INSERT INTO tmp_20180602162637_zws_xgb_sum ("KEY", "Score_CLASS_0", "Score_CLASS_1", "Score_CLASS_2") SELECT "U"."KEY", "U"."Score_CLASS_0", "U"."Score_CLASS_1", "U"."Score_CLASS_2" 
...
FROM tmp_20180602162637_07k_xgb_b0 AS "XGB_B0" UNION ALL SELECT "XGB_B1"."KEY" AS "KEY", "XGB_B1"."Score_CLASS_0" AS "Score_CLASS_0", "XGB_B1"."Score_CLASS_1" AS "Score_CLASS_1", "XGB_B1"."Score_CLASS_2" AS "Score_CLASS_2" 
FROM tmp_20180602162637_285_xgb_b1 AS "XGB_B1" UNION ALL SELECT "XGB_B2"."KEY" AS "KEY", "XGB_B2"."Score_CLASS_0" AS "Score_CLASS_0", "XGB_B2"."Score_CLASS_1" AS "Score_CLASS_1", "XGB_B2"."Score_CLASS_2" AS "Score_CLASS_2" 
FROM tmp_20180602162637_5by_xgb_b2 AS "XGB_B2" UNION ALL SELECT "XGB_B3"."KEY" AS "KEY", "XGB_B3"."Score_CLASS_0" AS "Score_CLASS_0", "XGB_B3"."Score_CLASS_1" AS "Score_CLASS_1", "XGB_B3"."Score_CLASS_2" AS "Score_CLASS_2" 
FROM tmp_20180602162637_tiw_xgb_b3 AS "XGB_B3" UNION ALL SELECT "XGB_B4"."KEY" AS "KEY", "XGB_B4"."Score_CLASS_0" AS "Score_CLASS_0", "XGB_B4"."Score_CLASS_1" AS "Score_CLASS_1", "XGB_B4"."Score_CLASS_2" AS "Score_CLASS_2" 
FROM tmp_20180602162637_k0i_xgb_b4 AS "XGB_B4") AS "XGB_EnsembleUnion")
...
FROM tmp_20180602162637_zws_xgb_sum AS "XGB_sum"), 
