...
-- Code For temporary table TMP_20180516110707_CODEGEN_XLAN6W_XGB_B0 part 1. Create 


CREATE TEMPORARY TABLE "TMP_20180516110707_CODEGEN_XLAN6W_XGB_B0" (
	"KEY" BIGINT, 
	"Score_0" FLOAT
)
...
-- Code For temporary table TMP_20180516110707_CODEGEN_XLAN6W_XGB_B0 part 2. Populate
...
FROM "DT_Output_9")
 INSERT INTO "TMP_20180516110707_CODEGEN_XLAN6W_XGB_B0" ("KEY", "Score_0") SELECT "XGB_B0"."KEY", "XGB_B0"."Score_0" 
...
-- Code For temporary table TMP_20180516110707_CODEGEN_656W3G_XGB_B1 part 1. Create 


CREATE TEMPORARY TABLE "TMP_20180516110707_CODEGEN_656W3G_XGB_B1" (
	"KEY" BIGINT, 
	"Score_0" FLOAT
)
...
-- Code For temporary table TMP_20180516110707_CODEGEN_656W3G_XGB_B1 part 2. Populate
...
FROM "DT_Output_15")
 INSERT INTO "TMP_20180516110707_CODEGEN_656W3G_XGB_B1" ("KEY", "Score_0") SELECT "XGB_B1"."KEY", "XGB_B1"."Score_0" 
...
-- Code For temporary table TMP_20180516110707_CODEGEN_0Y4BOW_XGB_sum part 1. Create 


CREATE TEMPORARY TABLE "TMP_20180516110707_CODEGEN_0Y4BOW_XGB_sum" (
	"KEY" BIGINT NOT NULL, 
	"Score_0" FLOAT, 
	PRIMARY KEY ("KEY")
)
...
-- Code For temporary table TMP_20180516110707_CODEGEN_0Y4BOW_XGB_sum part 2. Populate
...
FROM "TMP_20180516110707_CODEGEN_XLAN6W_XGB_B0" AS "XGB_B0" UNION ALL SELECT "XGB_B1"."KEY" AS "KEY", "XGB_B1"."Score_0" AS "Score_0" 
FROM "TMP_20180516110707_CODEGEN_656W3G_XGB_B1" AS "XGB_B1") AS "XGB_EnsembleUnion")
 INSERT INTO "TMP_20180516110707_CODEGEN_0Y4BOW_XGB_sum" ("KEY", "Score_0") SELECT "XGB_sum"."KEY", "XGB_sum"."Score_0" 
...
-- Code For temporary table TMP_20180516110707_CODEGEN_0Y4BOW_XGB_sum part 3. Create Index 

CREATE INDEX "ix_TMP_20180516110707_CODEGEN_0Y4BOW_XGB_sum_KEY" ON "TMP_20180516110707_CODEGEN_0Y4BOW_XGB_sum" ("KEY")
...
FROM "TMP_20180516110707_CODEGEN_0Y4BOW_XGB_sum" AS "XGB_sum"), 
