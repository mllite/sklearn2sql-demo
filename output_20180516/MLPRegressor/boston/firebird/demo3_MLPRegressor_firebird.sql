...
-- Code For temporary table TMP_20180516_CODEGEN_01DTCT_HL_ part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180516_CODEGEN_01DTCT_HL_" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20180516_CODEGEN_01DTCT_HL_ part 2. Populate

INSERT INTO "TMP_20180516_CODEGEN_01DTCT_HL_" ("KEY", "NEUR_1_1", "NEUR_1_2", "NEUR_1_3") SELECT "U"."KEY", "U"."NEUR_1_1", "U"."NEUR_1_2", "U"."NEUR_1_3" 
FROM (WITH "IL" AS 
...
-- Code For temporary table TMP_20180516_CODEGEN_01DTCT_HL_ part 3. Create Index 

CREATE INDEX "ix_TMP_20180516_CODEGEN_183d" ON "TMP_20180516_CODEGEN_01DTCT_HL_" ("KEY")

-- Code For temporary table TMP_20180516_CODEGEN_ALHJ3N_OL_ part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180516_CODEGEN_ALHJ3N_OL_" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20180516_CODEGEN_ALHJ3N_OL_ part 2. Populate

INSERT INTO "TMP_20180516_CODEGEN_ALHJ3N_OL_" ("KEY", "NEUR_3_1") SELECT "U"."KEY", "U"."NEUR_3_1" 
...
FROM "TMP_20180516_CODEGEN_01DTCT_HL_" AS "HL_1_relu_1"), 
"HL_2_relu" AS 
...
-- Code For temporary table TMP_20180516_CODEGEN_ALHJ3N_OL_ part 3. Create Index 

CREATE INDEX "ix_TMP_20180516_CODEGEN_aaa6" ON "TMP_20180516_CODEGEN_ALHJ3N_OL_" ("KEY")

-- Model deployment code

SELECT "OL_identity_1"."KEY" AS "KEY", "OL_identity_1"."NEUR_3_1" AS "Estimator" 
FROM "TMP_20180516_CODEGEN_ALHJ3N_OL_" AS "OL_identity_1"