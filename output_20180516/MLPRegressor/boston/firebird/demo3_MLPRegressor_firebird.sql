...
-- Code For temporary table TMP_20180508183030_CODEGEN_J6V3 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508183030_CODEGEN_J6V3" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20180508183030_CODEGEN_J6V3 part 2. Populate

INSERT INTO "TMP_20180508183030_CODEGEN_J6V3" ("KEY", "NEUR_1_1", "NEUR_1_2", "NEUR_1_3") SELECT "U"."KEY", "U"."NEUR_1_1", "U"."NEUR_1_2", "U"."NEUR_1_3" 
FROM (WITH "IL" AS 
...
-- Code For temporary table TMP_20180508183030_CODEGEN_J6V3 part 3. Create Index 

CREATE INDEX "ix_TMP_20180508183030_C_d28c" ON "TMP_20180508183030_CODEGEN_J6V3" ("KEY")

-- Code For temporary table TMP_20180508183030_CODEGEN_VXCW part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508183030_CODEGEN_VXCW" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20180508183030_CODEGEN_VXCW part 2. Populate

INSERT INTO "TMP_20180508183030_CODEGEN_VXCW" ("KEY", "NEUR_3_1") SELECT "U"."KEY", "U"."NEUR_3_1" 
...
FROM "TMP_20180508183030_CODEGEN_J6V3" AS "HL_1_relu_1"), 
"HL_2_relu" AS 
...
-- Code For temporary table TMP_20180508183030_CODEGEN_VXCW part 3. Create Index 

CREATE INDEX "ix_TMP_20180508183030_C_c5b1" ON "TMP_20180508183030_CODEGEN_VXCW" ("KEY")

-- Model deployment code

SELECT "OL_identity_1"."KEY" AS "KEY", "OL_identity_1"."NEUR_3_1" AS "Estimator" 
FROM "TMP_20180508183030_CODEGEN_VXCW" AS "OL_identity_1"