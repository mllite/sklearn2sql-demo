...
-- Code For temporary table CODEGEN_FMR4B0_HL_1_RELU_1 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "CODEGEN_FMR4B0_HL_1_RELU_1" (
	"KEY" NUMBER(19), 
...
-- Code For temporary table CODEGEN_FMR4B0_HL_1_RELU_1 part 2. Populate

INSERT INTO "CODEGEN_FMR4B0_HL_1_RELU_1" ("KEY", "NEUR_1_1", "NEUR_1_2", "NEUR_1_3") SELECT "U"."KEY", "U"."NEUR_1_1", "U"."NEUR_1_2", "U"."NEUR_1_3" 
FROM (WITH "IL" AS 
...
-- Code For temporary table DEGEN_J7IWIF_OL_IDENTITY_1 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "DEGEN_J7IWIF_OL_IDENTITY_1" (
	"KEY" NUMBER(19), 
...
-- Code For temporary table DEGEN_J7IWIF_OL_IDENTITY_1 part 2. Populate

INSERT INTO "DEGEN_J7IWIF_OL_IDENTITY_1" ("KEY", "NEUR_3_1") SELECT "U"."KEY", "U"."NEUR_3_1" 
...
FROM "CODEGEN_FMR4B0_HL_1_RELU_1" "HL_1_relu_1"), 
"HL_2_relu" AS 
...
FROM "DEGEN_J7IWIF_OL_IDENTITY_1" "OL_identity_1"