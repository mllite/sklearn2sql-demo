...
-- Code For temporary table tmp_20180602145946_lv4_hl_1_relu_1 part 1. Create 


CREATE TEMPORARY TABLE tmp_20180602145946_lv4_hl_1_relu_1 (
	"KEY" BIGINT, 
	"NEUR_1_1" DOUBLE, 
	"NEUR_1_2" DOUBLE, 
	"NEUR_1_3" DOUBLE
...
-- Code For temporary table tmp_20180602145946_lv4_hl_1_relu_1 part 2. Populate

INSERT INTO tmp_20180602145946_lv4_hl_1_relu_1 ("KEY", "NEUR_1_1", "NEUR_1_2", "NEUR_1_3") SELECT "U"."KEY", "U"."NEUR_1_1", "U"."NEUR_1_2", "U"."NEUR_1_3" 
FROM (WITH "IL" AS 
...
-- Code For temporary table tmp_20180602145946_mc7_ol_identity_1 part 1. Create 


CREATE TEMPORARY TABLE tmp_20180602145946_mc7_ol_identity_1 (
	"KEY" BIGINT, 
	"NEUR_3_1" DOUBLE
)
...
-- Code For temporary table tmp_20180602145946_mc7_ol_identity_1 part 2. Populate

INSERT INTO tmp_20180602145946_mc7_ol_identity_1 ("KEY", "NEUR_3_1") SELECT "U"."KEY", "U"."NEUR_3_1" 
...
FROM tmp_20180602145946_lv4_hl_1_relu_1 AS "HL_1_relu_1"), 
"HL_2_relu" AS 
...
FROM tmp_20180602145946_mc7_ol_identity_1 AS "OL_identity_1"