...
-- Code For temporary table 4653_CODEGEN_U2PQL4_XGB_B0 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "4653_CODEGEN_U2PQL4_XGB_B0" (
	"KEY" NUMBER(19), 
...
-- Code For temporary table 4653_CODEGEN_U2PQL4_XGB_B0 part 2. Populate

INSERT INTO "4653_CODEGEN_U2PQL4_XGB_B0" ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
-- Code For temporary table 4653_CODEGEN_LK3KFH_XGB_B1 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "4653_CODEGEN_LK3KFH_XGB_B1" (
	"KEY" NUMBER(19), 
	"Estimator" BINARY_DOUBLE
)
...
-- Code For temporary table 4653_CODEGEN_LK3KFH_XGB_B1 part 2. Populate

INSERT INTO "4653_CODEGEN_LK3KFH_XGB_B1" ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
-- Code For temporary table 3_CODEGEN_9UEFAF_XGB_UNION part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "3_CODEGEN_9UEFAF_XGB_UNION" (
	"KEY" NUMBER(19), 
	"Estimator" BINARY_DOUBLE
)
...
-- Code For temporary table 3_CODEGEN_9UEFAF_XGB_UNION part 2. Populate

INSERT INTO "3_CODEGEN_9UEFAF_XGB_UNION" ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
FROM "4653_CODEGEN_U2PQL4_XGB_B0" "XGB_B0" UNION ALL SELECT "XGB_B1"."KEY" AS "KEY", "XGB_B1"."Estimator" AS "Estimator" 
FROM "4653_CODEGEN_LK3KFH_XGB_B1" "XGB_B1") "XGB_EnsembleUnion") "XGB_Union") "U"

-- Code For temporary table 653_CODEGEN_4Q2NU2_XGB_SUM part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "653_CODEGEN_4Q2NU2_XGB_SUM" (
	"KEY" NUMBER(19), 
	"Estimator" BINARY_DOUBLE
)
...
-- Code For temporary table 653_CODEGEN_4Q2NU2_XGB_SUM part 2. Populate

INSERT INTO "653_CODEGEN_4Q2NU2_XGB_SUM" ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
FROM "3_CODEGEN_9UEFAF_XGB_UNION" "XGB_Union" GROUP BY "XGB_Union"."KEY") "T") "XGB_sum") "U"

-- Model deployment code

SELECT "XGB_sum"."KEY" AS "KEY", "XGB_sum"."Estimator" + 0.5 AS "Estimator" 
FROM "653_CODEGEN_4Q2NU2_XGB_SUM" "XGB_sum"