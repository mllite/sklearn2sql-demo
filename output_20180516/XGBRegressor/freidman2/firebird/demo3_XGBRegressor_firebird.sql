...
-- Code For temporary table TMP_20180508185033_CODEGEN_H80B part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508185033_CODEGEN_H80B" (
	"KEY" BIGINT, 
...
-- Code For temporary table TMP_20180508185033_CODEGEN_H80B part 2. Populate

INSERT INTO "TMP_20180508185033_CODEGEN_H80B" ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
-- Code For temporary table TMP_20180508185033_CODEGEN_MZMR part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508185033_CODEGEN_MZMR" (
	"KEY" BIGINT, 
	"Estimator" DOUBLE PRECISION
)
...
-- Code For temporary table TMP_20180508185033_CODEGEN_MZMR part 2. Populate

INSERT INTO "TMP_20180508185033_CODEGEN_MZMR" ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
-- Code For temporary table TMP_20180508185033_CODEGEN_SCP0 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508185033_CODEGEN_SCP0" (
	"KEY" BIGINT, 
	"Estimator" DOUBLE PRECISION
)
...
-- Code For temporary table TMP_20180508185033_CODEGEN_SCP0 part 2. Populate

INSERT INTO "TMP_20180508185033_CODEGEN_SCP0" ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
FROM "TMP_20180508185033_CODEGEN_H80B" AS "XGB_B0" UNION ALL SELECT "XGB_B1"."KEY" AS "KEY", "XGB_B1"."Estimator" AS "Estimator" 
FROM "TMP_20180508185033_CODEGEN_MZMR" AS "XGB_B1") AS "XGB_EnsembleUnion") AS "XGB_Union") AS "U"

-- Code For temporary table TMP_20180508185033_CODEGEN_J91L part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508185033_CODEGEN_J91L" (
	"KEY" BIGINT NOT NULL, 
	"Estimator" DOUBLE PRECISION, 
	PRIMARY KEY ("KEY")
)
...
-- Code For temporary table TMP_20180508185033_CODEGEN_J91L part 2. Populate

INSERT INTO "TMP_20180508185033_CODEGEN_J91L" ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
FROM "TMP_20180508185033_CODEGEN_SCP0" AS "XGB_Union" GROUP BY "XGB_Union"."KEY") AS "T") AS "XGB_sum") AS "U"

-- Code For temporary table TMP_20180508185033_CODEGEN_J91L part 3. Create Index 

CREATE INDEX "ix_TMP_20180508185033_C_823d" ON "TMP_20180508185033_CODEGEN_J91L" ("KEY")

-- Model deployment code

SELECT "XGB_sum"."KEY" AS "KEY", "XGB_sum"."Estimator" + 0.5 AS "Estimator" 
FROM "TMP_20180508185033_CODEGEN_J91L" AS "XGB_sum"