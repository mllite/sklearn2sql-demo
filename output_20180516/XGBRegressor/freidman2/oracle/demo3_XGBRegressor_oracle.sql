...
-- Code For temporary table 5032_CODEGEN_EYK8PT_XGB_B0 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "5032_CODEGEN_EYK8PT_XGB_B0" (
	"KEY" NUMBER(19), 
...
-- Code For temporary table 5032_CODEGEN_EYK8PT_XGB_B0 part 2. Populate

INSERT INTO "5032_CODEGEN_EYK8PT_XGB_B0" ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
-- Code For temporary table 5032_CODEGEN_HMTKQ9_XGB_B1 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "5032_CODEGEN_HMTKQ9_XGB_B1" (
	"KEY" NUMBER(19), 
	"Estimator" BINARY_DOUBLE
)
...
-- Code For temporary table 5032_CODEGEN_HMTKQ9_XGB_B1 part 2. Populate

INSERT INTO "5032_CODEGEN_HMTKQ9_XGB_B1" ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
-- Code For temporary table 2_CODEGEN_XMJ5DE_XGB_UNION part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "2_CODEGEN_XMJ5DE_XGB_UNION" (
	"KEY" NUMBER(19), 
	"Estimator" BINARY_DOUBLE
)
...
-- Code For temporary table 2_CODEGEN_XMJ5DE_XGB_UNION part 2. Populate

INSERT INTO "2_CODEGEN_XMJ5DE_XGB_UNION" ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
FROM "5032_CODEGEN_EYK8PT_XGB_B0" "XGB_B0" UNION ALL SELECT "XGB_B1"."KEY" AS "KEY", "XGB_B1"."Estimator" AS "Estimator" 
FROM "5032_CODEGEN_HMTKQ9_XGB_B1" "XGB_B1") "XGB_EnsembleUnion") "XGB_Union") "U"

-- Code For temporary table 032_CODEGEN_D7FRZF_XGB_SUM part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "032_CODEGEN_D7FRZF_XGB_SUM" (
	"KEY" NUMBER(19), 
	"Estimator" BINARY_DOUBLE
)
...
-- Code For temporary table 032_CODEGEN_D7FRZF_XGB_SUM part 2. Populate

INSERT INTO "032_CODEGEN_D7FRZF_XGB_SUM" ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
FROM "2_CODEGEN_XMJ5DE_XGB_UNION" "XGB_Union" GROUP BY "XGB_Union"."KEY") "T") "XGB_sum") "U"

-- Model deployment code

SELECT "XGB_sum"."KEY" AS "KEY", "XGB_sum"."Estimator" + 0.5 AS "Estimator" 
FROM "032_CODEGEN_D7FRZF_XGB_SUM" "XGB_sum"