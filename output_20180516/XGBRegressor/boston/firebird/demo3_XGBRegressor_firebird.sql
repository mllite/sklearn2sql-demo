...
-- Code For temporary table TMP_20180508183228_CODEGEN_SKDO part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508183228_CODEGEN_SKDO" (
	"KEY" BIGINT, 
...
-- Code For temporary table TMP_20180508183228_CODEGEN_SKDO part 2. Populate

INSERT INTO "TMP_20180508183228_CODEGEN_SKDO" ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
-- Code For temporary table TMP_20180508183228_CODEGEN_PDEI part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508183228_CODEGEN_PDEI" (
	"KEY" BIGINT, 
	"Estimator" DOUBLE PRECISION
)
...
-- Code For temporary table TMP_20180508183228_CODEGEN_PDEI part 2. Populate

INSERT INTO "TMP_20180508183228_CODEGEN_PDEI" ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
-- Code For temporary table TMP_20180508183228_CODEGEN_O6XJ part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508183228_CODEGEN_O6XJ" (
	"KEY" BIGINT, 
	"Estimator" DOUBLE PRECISION
)
...
-- Code For temporary table TMP_20180508183228_CODEGEN_O6XJ part 2. Populate

INSERT INTO "TMP_20180508183228_CODEGEN_O6XJ" ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
FROM "TMP_20180508183228_CODEGEN_SKDO" AS "XGB_B0" UNION ALL SELECT "XGB_B1"."KEY" AS "KEY", "XGB_B1"."Estimator" AS "Estimator" 
FROM "TMP_20180508183228_CODEGEN_PDEI" AS "XGB_B1") AS "XGB_EnsembleUnion") AS "XGB_Union") AS "U"

-- Code For temporary table TMP_20180508183228_CODEGEN_YGBI part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508183228_CODEGEN_YGBI" (
	"KEY" BIGINT NOT NULL, 
	"Estimator" DOUBLE PRECISION, 
	PRIMARY KEY ("KEY")
)
...
-- Code For temporary table TMP_20180508183228_CODEGEN_YGBI part 2. Populate

INSERT INTO "TMP_20180508183228_CODEGEN_YGBI" ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
FROM "TMP_20180508183228_CODEGEN_O6XJ" AS "XGB_Union" GROUP BY "XGB_Union"."KEY") AS "T") AS "XGB_sum") AS "U"

-- Code For temporary table TMP_20180508183228_CODEGEN_YGBI part 3. Create Index 

CREATE INDEX "ix_TMP_20180508183228_C_5b21" ON "TMP_20180508183228_CODEGEN_YGBI" ("KEY")

-- Model deployment code

SELECT "XGB_sum"."KEY" AS "KEY", "XGB_sum"."Estimator" + 0.5 AS "Estimator" 
FROM "TMP_20180508183228_CODEGEN_YGBI" AS "XGB_sum"