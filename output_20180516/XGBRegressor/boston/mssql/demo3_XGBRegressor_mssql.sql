...
-- Code For temporary table ##TMP_20180516115109_CODEGEN_KOEPFY_XGB_B0 part 1. Create 


CREATE TABLE ##TMP_20180516115109_CODEGEN_KOEPFY_XGB_B0 (
	[KEY] BIGINT NULL, 
...
-- Code For temporary table ##TMP_20180516115109_CODEGEN_KOEPFY_XGB_B0 part 2. Populate
...
FROM [DT_Output_9])
 INSERT INTO ##TMP_20180516115109_CODEGEN_KOEPFY_XGB_B0 ([KEY], [Estimator]) SELECT [XGB_B0].[KEY], [XGB_B0].[Estimator] 
...
-- Code For temporary table ##TMP_20180516115109_CODEGEN_LJ4WS0_XGB_B1 part 1. Create 


CREATE TABLE ##TMP_20180516115109_CODEGEN_LJ4WS0_XGB_B1 (
	[KEY] BIGINT NULL, 
	[Estimator] FLOAT(53) NULL
)
...
-- Code For temporary table ##TMP_20180516115109_CODEGEN_LJ4WS0_XGB_B1 part 2. Populate
...
FROM [DT_Output_15])
 INSERT INTO ##TMP_20180516115109_CODEGEN_LJ4WS0_XGB_B1 ([KEY], [Estimator]) SELECT [XGB_B1].[KEY], [XGB_B1].[Estimator] 
...
-- Code For temporary table ##TMP_20180516115109_CODEGEN_DO5PWM_XGB_sum part 1. Create 


CREATE TABLE ##TMP_20180516115109_CODEGEN_DO5PWM_XGB_sum (
	[KEY] BIGINT NULL, 
	[Estimator] FLOAT(53) NULL
)
...
-- Code For temporary table ##TMP_20180516115109_CODEGEN_DO5PWM_XGB_sum part 2. Populate
...
FROM ##TMP_20180516115109_CODEGEN_KOEPFY_XGB_B0 AS [XGB_B0] UNION ALL SELECT [XGB_B1].[KEY] AS [KEY], [XGB_B1].[Estimator] AS [Estimator] 
FROM ##TMP_20180516115109_CODEGEN_LJ4WS0_XGB_B1 AS [XGB_B1]) AS [XGB_EnsembleUnion])
 INSERT INTO ##TMP_20180516115109_CODEGEN_DO5PWM_XGB_sum ([KEY], [Estimator]) SELECT [XGB_sum].[KEY], [XGB_sum].[Estimator] 
...
FROM ##TMP_20180516115109_CODEGEN_DO5PWM_XGB_sum AS [XGB_sum]