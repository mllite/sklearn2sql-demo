...
-- Code For temporary table tmp_20180602145219_3y5_xgb_b0 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180602145219_3y5_xgb_b0 (
	"KEY" BIGINT, 
	"Estimator" DOUBLE
)
...
-- Code For temporary table tmp_20180602145219_3y5_xgb_b0 part 2. Populate

INSERT INTO tmp_20180602145219_3y5_xgb_b0 WITH "DT_node_lookup" AS 
...
-- Code For temporary table tmp_20180602145219_r8b_xgb_b1 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180602145219_r8b_xgb_b1 (
	"KEY" BIGINT, 
	"Estimator" DOUBLE
)
...
-- Code For temporary table tmp_20180602145219_r8b_xgb_b1 part 2. Populate

INSERT INTO tmp_20180602145219_r8b_xgb_b1 WITH "DT_node_lookup_10" AS 
...
-- Code For temporary table tmp_20180602145219_977_xgb_sum part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180602145219_977_xgb_sum (
	"KEY" BIGINT, 
	"Estimator" DOUBLE
)
...
-- Code For temporary table tmp_20180602145219_977_xgb_sum part 2. Populate

INSERT INTO tmp_20180602145219_977_xgb_sum WITH "XGB_Union" AS 
...
FROM tmp_20180602145219_3y5_xgb_b0 AS "XGB_B0" UNION ALL SELECT "XGB_B1"."KEY" AS "KEY", "XGB_B1"."Estimator" AS "Estimator" 
FROM tmp_20180602145219_r8b_xgb_b1 AS "XGB_B1") AS "XGB_EnsembleUnion")
...
FROM tmp_20180602145219_977_xgb_sum AS "XGB_sum"