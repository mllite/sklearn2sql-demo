...
-- Code For temporary table tmp_20180516114545_codegen_hvkh59_xgb_b0 part 1. Create 


CREATE TEMPORARY TABLE tmp_20180516114545_codegen_hvkh59_xgb_b0 (
	"KEY" BIGINT, 
	"Estimator" DOUBLE
)
...
-- Code For temporary table tmp_20180516114545_codegen_hvkh59_xgb_b0 part 2. Populate

INSERT INTO tmp_20180516114545_codegen_hvkh59_xgb_b0 ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
-- Code For temporary table tmp_20180516114545_codegen_jipwsy_xgb_b1 part 1. Create 


CREATE TEMPORARY TABLE tmp_20180516114545_codegen_jipwsy_xgb_b1 (
	"KEY" BIGINT, 
	"Estimator" DOUBLE
)
...
-- Code For temporary table tmp_20180516114545_codegen_jipwsy_xgb_b1 part 2. Populate

INSERT INTO tmp_20180516114545_codegen_jipwsy_xgb_b1 ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
-- Code For temporary table tmp_20180516114545_codegen_ynxg51_xgb_sum part 1. Create 


CREATE TEMPORARY TABLE tmp_20180516114545_codegen_ynxg51_xgb_sum (
	"KEY" BIGINT, 
	"Estimator" DOUBLE
)
...
-- Code For temporary table tmp_20180516114545_codegen_ynxg51_xgb_sum part 2. Populate

INSERT INTO tmp_20180516114545_codegen_ynxg51_xgb_sum ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
FROM tmp_20180516114545_codegen_hvkh59_xgb_b0 AS "XGB_B0" UNION ALL SELECT "XGB_B1"."KEY" AS "KEY", "XGB_B1"."Estimator" AS "Estimator" 
FROM tmp_20180516114545_codegen_jipwsy_xgb_b1 AS "XGB_B1") AS "XGB_EnsembleUnion")
...
FROM tmp_20180516114545_codegen_ynxg51_xgb_sum AS "XGB_sum"