...
-- Code For temporary table TMP_20180602_FFH_XGB_B0 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180602_FFH_XGB_B0" (
	"KEY" NUMBER(19), 
...
-- Code For temporary table TMP_20180602_FFH_XGB_B0 part 2. Populate

INSERT INTO "TMP_20180602_FFH_XGB_B0" ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
-- Code For temporary table TMP_20180602_TL1_XGB_B1 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180602_TL1_XGB_B1" (
	"KEY" NUMBER(19), 
	"Estimator" BINARY_DOUBLE
)
...
-- Code For temporary table TMP_20180602_TL1_XGB_B1 part 2. Populate

INSERT INTO "TMP_20180602_TL1_XGB_B1" ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
-- Code For temporary table TMP_20180602_IG6_XGB_SUM part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180602_IG6_XGB_SUM" (
	"KEY" NUMBER(19), 
	"Estimator" BINARY_DOUBLE
)
...
-- Code For temporary table TMP_20180602_IG6_XGB_SUM part 2. Populate

INSERT INTO "TMP_20180602_IG6_XGB_SUM" ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
FROM "TMP_20180602_FFH_XGB_B0" "XGB_B0" UNION ALL SELECT "XGB_B1"."KEY" AS "KEY", "XGB_B1"."Estimator" AS "Estimator" 
FROM "TMP_20180602_TL1_XGB_B1" "XGB_B1") "XGB_EnsembleUnion")
...
FROM "TMP_20180602_IG6_XGB_SUM" "XGB_sum"