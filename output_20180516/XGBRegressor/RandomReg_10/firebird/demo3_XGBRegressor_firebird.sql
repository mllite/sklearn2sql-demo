...
-- Code For temporary table TMP_20180508182431_CODEGEN_T9FL part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508182431_CODEGEN_T9FL" (
	"KEY" BIGINT, 
...
-- Code For temporary table TMP_20180508182431_CODEGEN_T9FL part 2. Populate

INSERT INTO "TMP_20180508182431_CODEGEN_T9FL" ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
-- Code For temporary table TMP_20180508182431_CODEGEN_U11V part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508182431_CODEGEN_U11V" (
	"KEY" BIGINT, 
	"Estimator" DOUBLE PRECISION
)
...
-- Code For temporary table TMP_20180508182431_CODEGEN_U11V part 2. Populate

INSERT INTO "TMP_20180508182431_CODEGEN_U11V" ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
-- Code For temporary table TMP_20180508182431_CODEGEN_KQWS part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508182431_CODEGEN_KQWS" (
	"KEY" BIGINT, 
	"Estimator" DOUBLE PRECISION
)
...
-- Code For temporary table TMP_20180508182431_CODEGEN_KQWS part 2. Populate

INSERT INTO "TMP_20180508182431_CODEGEN_KQWS" ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
FROM "TMP_20180508182431_CODEGEN_T9FL" AS "XGB_B0" UNION ALL SELECT "XGB_B1"."KEY" AS "KEY", "XGB_B1"."Estimator" AS "Estimator" 
FROM "TMP_20180508182431_CODEGEN_U11V" AS "XGB_B1") AS "XGB_EnsembleUnion") AS "XGB_Union") AS "U"

-- Code For temporary table TMP_20180508182431_CODEGEN_1JDK part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508182431_CODEGEN_1JDK" (
	"KEY" BIGINT NOT NULL, 
	"Estimator" DOUBLE PRECISION, 
	PRIMARY KEY ("KEY")
)
...
-- Code For temporary table TMP_20180508182431_CODEGEN_1JDK part 2. Populate

INSERT INTO "TMP_20180508182431_CODEGEN_1JDK" ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
FROM "TMP_20180508182431_CODEGEN_KQWS" AS "XGB_Union" GROUP BY "XGB_Union"."KEY") AS "T") AS "XGB_sum") AS "U"

-- Code For temporary table TMP_20180508182431_CODEGEN_1JDK part 3. Create Index 

CREATE INDEX "ix_TMP_20180508182431_C_49fe" ON "TMP_20180508182431_CODEGEN_1JDK" ("KEY")

-- Model deployment code

SELECT "XGB_sum"."KEY" AS "KEY", "XGB_sum"."Estimator" + 0.5 AS "Estimator" 
FROM "TMP_20180508182431_CODEGEN_1JDK" AS "XGB_sum"