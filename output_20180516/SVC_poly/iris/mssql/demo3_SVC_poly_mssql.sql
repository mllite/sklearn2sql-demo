...
-- Code For temporary table ##TMP_20180602153116_QLV_KernAgg_B0 part 1. Create 


CREATE TABLE ##TMP_20180602153116_QLV_KernAgg_B0 (
	[KEY] BIGINT NULL, 
...
-- Code For temporary table ##TMP_20180602153116_QLV_KernAgg_B0 part 2. Populate
...
FROM (SELECT kernel_input.[KEY] AS [KEY], [SV_data_0_1].dual_coeff * power(CAST(0.25 * (kernel_input.[Feature_0] * [SV_data_0_1].sv_0 + kernel_input.[Feature_1] * [SV_data_0_1].sv_1 + kernel_input.[Feature_2] * [SV_data_0_1].sv_2 + kernel_input.[Feature_3] * [SV_data_0_1].sv_3) + 0.0 AS FLOAT(53)), 3) AS dot_prod1 
FROM kernel_input, [SV_data_0_1]) AS full_join_data_sv GROUP BY full_join_data_sv.[KEY]) AS t), 
kernel_cte_0_1 AS 
(SELECT kernel_dp_0_1.[KEY] AS [KEY], 0 AS [OVO_Class1], 1 AS [OVO_Class2], CASE WHEN (-kernel_dp_0_1.dot_product >= 0.0) THEN 1 ELSE 0 END AS [OVO_Decision], coalesce(-kernel_dp_0_1.dot_product, 1.0 / (1.0 + exp(CASE WHEN (CASE WHEN (-100.0 <= -(-((-kernel_dp_0_1.dot_product) * -1.6568593205688362 + -0.9482594418264659))) THEN -(-((-kernel_dp_0_1.dot_product) * -1.6568593205688362 + -0.9482594418264659)) ELSE -100.0 END <= 100.0) THEN CASE WHEN (-100.0 <= -(-((-kernel_dp_0_1.dot_product) * -1.6568593205688362 + -0.9482594418264659))) THEN -(-((-kernel_dp_0_1.dot_product) * -1.6568593205688362 + -0.9482594418264659)) ELSE -100.0 END ELSE 100.0 END))) AS [OVO_Conf] 
FROM kernel_dp_0_1)
 INSERT INTO ##TMP_20180602153116_QLV_KernAgg_B0 ([KEY], [OVO_Class1], [OVO_Class2], [OVO_Decision], [OVO_Conf]) SELECT [KernAgg_B0].[KEY], [KernAgg_B0].[OVO_Class1], [KernAgg_B0].[OVO_Class2], [KernAgg_B0].[OVO_Decision], [KernAgg_B0].[OVO_Conf] 
...
-- Code For temporary table ##TMP_20180602153116_J0J_KernAgg_B1 part 1. Create 


CREATE TABLE ##TMP_20180602153116_J0J_KernAgg_B1 (
	[KEY] BIGINT NULL, 
	[OVO_Class1] BIGINT NULL, 
	[OVO_Class2] BIGINT NULL, 
	[OVO_Decision] BIGINT NULL, 
...
-- Code For temporary table ##TMP_20180602153116_J0J_KernAgg_B1 part 2. Populate
...
FROM (SELECT kernel_input.[KEY] AS [KEY], [SV_data_0_2].dual_coeff * power(CAST(0.25 * (kernel_input.[Feature_0] * [SV_data_0_2].sv_0 + kernel_input.[Feature_1] * [SV_data_0_2].sv_1 + kernel_input.[Feature_2] * [SV_data_0_2].sv_2 + kernel_input.[Feature_3] * [SV_data_0_2].sv_3) + 0.0 AS FLOAT(53)), 3) AS dot_prod1 
FROM kernel_input, [SV_data_0_2]) AS full_join_data_sv_1 GROUP BY full_join_data_sv_1.[KEY]) AS t_1), 
kernel_cte_0_2 AS 
(SELECT kernel_dp_0_2.[KEY] AS [KEY], 0 AS [OVO_Class1], 2 AS [OVO_Class2], CASE WHEN (-kernel_dp_0_2.dot_product >= 0.0) THEN 1 ELSE 0 END AS [OVO_Decision], coalesce(-kernel_dp_0_2.dot_product, 1.0 / (1.0 + exp(CASE WHEN (CASE WHEN (-100.0 <= -(-((-kernel_dp_0_2.dot_product) * -1.9912706169429077 + -0.7665376243657053))) THEN -(-((-kernel_dp_0_2.dot_product) * -1.9912706169429077 + -0.7665376243657053)) ELSE -100.0 END <= 100.0) THEN CASE WHEN (-100.0 <= -(-((-kernel_dp_0_2.dot_product) * -1.9912706169429077 + -0.7665376243657053))) THEN -(-((-kernel_dp_0_2.dot_product) * -1.9912706169429077 + -0.7665376243657053)) ELSE -100.0 END ELSE 100.0 END))) AS [OVO_Conf] 
FROM kernel_dp_0_2)
 INSERT INTO ##TMP_20180602153116_J0J_KernAgg_B1 ([KEY], [OVO_Class1], [OVO_Class2], [OVO_Decision], [OVO_Conf]) SELECT [KernAgg_B1].[KEY], [KernAgg_B1].[OVO_Class1], [KernAgg_B1].[OVO_Class2], [KernAgg_B1].[OVO_Decision], [KernAgg_B1].[OVO_Conf] 
...
-- Code For temporary table ##TMP_20180602153116_MF3_KernAgg_B2 part 1. Create 


CREATE TABLE ##TMP_20180602153116_MF3_KernAgg_B2 (
	[KEY] BIGINT NULL, 
	[OVO_Class1] BIGINT NULL, 
	[OVO_Class2] BIGINT NULL, 
	[OVO_Decision] BIGINT NULL, 
...
-- Code For temporary table ##TMP_20180602153116_MF3_KernAgg_B2 part 2. Populate
...
FROM (SELECT kernel_input.[KEY] AS [KEY], [SV_data_1_2].dual_coeff * power(CAST(0.25 * (kernel_input.[Feature_0] * [SV_data_1_2].sv_0 + kernel_input.[Feature_1] * [SV_data_1_2].sv_1 + kernel_input.[Feature_2] * [SV_data_1_2].sv_2 + kernel_input.[Feature_3] * [SV_data_1_2].sv_3) + 0.0 AS FLOAT(53)), 3) AS dot_prod1 
FROM kernel_input, [SV_data_1_2]) AS full_join_data_sv_2 GROUP BY full_join_data_sv_2.[KEY]) AS t_2), 
kernel_cte_1_2 AS 
(SELECT kernel_dp_1_2.[KEY] AS [KEY], 1 AS [OVO_Class1], 2 AS [OVO_Class2], CASE WHEN (-kernel_dp_1_2.dot_product >= 0.0) THEN 1 ELSE 0 END AS [OVO_Decision], coalesce(-kernel_dp_1_2.dot_product, 1.0 / (1.0 + exp(CASE WHEN (CASE WHEN (-100.0 <= -(-((-kernel_dp_1_2.dot_product) * -0.31066041880700385 + 0.14483676971616083))) THEN -(-((-kernel_dp_1_2.dot_product) * -0.31066041880700385 + 0.14483676971616083)) ELSE -100.0 END <= 100.0) THEN CASE WHEN (-100.0 <= -(-((-kernel_dp_1_2.dot_product) * -0.31066041880700385 + 0.14483676971616083))) THEN -(-((-kernel_dp_1_2.dot_product) * -0.31066041880700385 + 0.14483676971616083)) ELSE -100.0 END ELSE 100.0 END))) AS [OVO_Conf] 
FROM kernel_dp_1_2)
 INSERT INTO ##TMP_20180602153116_MF3_KernAgg_B2 ([KEY], [OVO_Class1], [OVO_Class2], [OVO_Decision], [OVO_Conf]) SELECT [KernAgg_B2].[KEY], [KernAgg_B2].[OVO_Class1], [KernAgg_B2].[OVO_Class2], [KernAgg_B2].[OVO_Decision], [KernAgg_B2].[OVO_Conf] 
...
-- Code For temporary table ##TMP_20180602153116_SLB_KernAgg_agg part 1. Create 


CREATE TABLE ##TMP_20180602153116_SLB_KernAgg_agg (
	[KEY] BIGINT NULL, 
...
-- Code For temporary table ##TMP_20180602153116_SLB_KernAgg_agg part 2. Populate
...
FROM ##TMP_20180602153116_QLV_KernAgg_B0 AS [KernAgg_B0] UNION ALL SELECT [KernAgg_B1].[KEY] AS [KEY], [KernAgg_B1].[OVO_Class1] AS [OVO_Class1], [KernAgg_B1].[OVO_Class2] AS [OVO_Class2], [KernAgg_B1].[OVO_Decision] AS [OVO_Decision], [KernAgg_B1].[OVO_Conf] AS [OVO_Conf] 
FROM ##TMP_20180602153116_J0J_KernAgg_B1 AS [KernAgg_B1] UNION ALL SELECT [KernAgg_B2].[KEY] AS [KEY], [KernAgg_B2].[OVO_Class1] AS [OVO_Class1], [KernAgg_B2].[OVO_Class2] AS [OVO_Class2], [KernAgg_B2].[OVO_Decision] AS [OVO_Decision], [KernAgg_B2].[OVO_Conf] AS [OVO_Conf] 
FROM ##TMP_20180602153116_MF3_KernAgg_B2 AS [KernAgg_B2]) AS [KernAgg_EnsembleUnion]), 
[OVO_Votes] AS 
...
FROM [OVO_Votes], [MinMaxConf])
 INSERT INTO ##TMP_20180602153116_SLB_KernAgg_agg ([KEY], [OVO_Vote_0], [OVO_SumConfidence_0], [OVO_Vote_1], [OVO_SumConfidence_1], [OVO_Vote_2], [OVO_SumConfidence_2], max_abs_confidence, [OVO_Scale], [Score_0], [Score_1], [Score_2]) SELECT [KernAgg_agg].[KEY], [KernAgg_agg].[OVO_Vote_0], [KernAgg_agg].[OVO_SumConfidence_0], [KernAgg_agg].[OVO_Vote_1], [KernAgg_agg].[OVO_SumConfidence_1], [KernAgg_agg].[OVO_Vote_2], [KernAgg_agg].[OVO_SumConfidence_2], [KernAgg_agg].max_abs_confidence, [KernAgg_agg].[OVO_Scale], [KernAgg_agg].[Score_0], [KernAgg_agg].[Score_1], [KernAgg_agg].[Score_2] 
...
FROM ##TMP_20180602153116_SLB_KernAgg_agg AS [KernAgg_agg]), 
