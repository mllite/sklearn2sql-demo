...
-- Code For temporary table TMP_20180508185847_CODEGEN_TGOLPE_KernAgg_B0 part 1. Create 


CREATE TEMPORARY TABLE "TMP_20180508185847_CODEGEN_TGOLPE_KernAgg_B0" (
	"KEY" BIGINT, 
	"OVO_Class1" BIGINT, 
	"OVO_Class2" BIGINT, 
	"OVO_Decision" BIGINT, 
...
-- Code For temporary table TMP_20180508185847_CODEGEN_TGOLPE_KernAgg_B0 part 2. Populate
...
FROM kernel_dp_1_2)
 INSERT INTO "TMP_20180508185847_CODEGEN_TGOLPE_KernAgg_B0" ("KEY", "OVO_Class1", "OVO_Class2", "OVO_Decision", "OVO_Confidence") SELECT "KernAgg_B0"."KEY", "KernAgg_B0"."OVO_Class1", "KernAgg_B0"."OVO_Class2", "KernAgg_B0"."OVO_Decision", "KernAgg_B0"."OVO_Confidence" 
...
-- Code For temporary table TMP_20180508185847_CODEGEN_URSHUI_KernAgg_Union part 1. Create 


CREATE TEMPORARY TABLE "TMP_20180508185847_CODEGEN_URSHUI_KernAgg_Union" (
	"KEY" BIGINT, 
	"OVO_Class1" BIGINT, 
	"OVO_Class2" BIGINT, 
	"OVO_Decision" BIGINT, 
...
-- Code For temporary table TMP_20180508185847_CODEGEN_URSHUI_KernAgg_Union part 2. Populate

INSERT INTO "TMP_20180508185847_CODEGEN_URSHUI_KernAgg_Union" ("KEY", "OVO_Class1", "OVO_Class2", "OVO_Decision", "OVO_Confidence") SELECT "KernAgg_Union"."KEY", "KernAgg_Union"."OVO_Class1", "KernAgg_Union"."OVO_Class2", "KernAgg_Union"."OVO_Decision", "KernAgg_Union"."OVO_Confidence" 
...
FROM "TMP_20180508185847_CODEGEN_TGOLPE_KernAgg_B0" AS "KernAgg_B0") AS "KernAgg_EnsembleUnion") AS "KernAgg_Union"

-- Code For temporary table TMP_20180508185847_CODEGEN_1IF0OT_KernAgg part 1. Create 


CREATE TEMPORARY TABLE "TMP_20180508185847_CODEGEN_1IF0OT_KernAgg" (
	"KEY" BIGINT NOT NULL, 
	"OVO_Vote_0" BIGINT, 
...
-- Code For temporary table TMP_20180508185847_CODEGEN_1IF0OT_KernAgg part 2. Populate
...
FROM "TMP_20180508185847_CODEGEN_URSHUI_KernAgg_Union" AS "KernAgg_Union" GROUP BY "KernAgg_Union"."KEY") AS "Votes_Sel"), 
"OVO_SumConf_CTE" AS 
...
FROM "OVO_Votes", "MinMaxConf")
 INSERT INTO "TMP_20180508185847_CODEGEN_1IF0OT_KernAgg" ("KEY", "OVO_Vote_0", "OVO_SumConfidence_0", "OVO_Vote_1", "OVO_SumConfidence_1", "OVO_Vote_2", "OVO_SumConfidence_2", max_abs_confidence, "OVO_Scale", "Score_0", "Score_1", "Score_2") SELECT "KernAgg"."KEY", "KernAgg"."OVO_Vote_0", "KernAgg"."OVO_SumConfidence_0", "KernAgg"."OVO_Vote_1", "KernAgg"."OVO_SumConfidence_1", "KernAgg"."OVO_Vote_2", "KernAgg"."OVO_SumConfidence_2", "KernAgg".max_abs_confidence, "KernAgg"."OVO_Scale", "KernAgg"."Score_0", "KernAgg"."Score_1", "KernAgg"."Score_2" 
...
-- Code For temporary table TMP_20180508185847_CODEGEN_1IF0OT_KernAgg part 3. Create Index 

CREATE INDEX "ix_TMP_20180508185847_CODEGEN_1IF0OT_KernAgg_KEY" ON "TMP_20180508185847_CODEGEN_1IF0OT_KernAgg" ("KEY")
...
FROM "TMP_20180508185847_CODEGEN_1IF0OT_KernAgg" AS "KernAgg"), 
