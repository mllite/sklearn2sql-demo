...
-- Code For temporary table TMP_20180602153115_IYB_KernAgg_B0 part 1. Create 


CREATE TEMPORARY TABLE "TMP_20180602153115_IYB_KernAgg_B0" (
	"KEY" BIGINT, 
	"OVO_Class1" BIGINT, 
	"OVO_Class2" BIGINT, 
	"OVO_Decision" BIGINT, 
...
-- Code For temporary table TMP_20180602153115_IYB_KernAgg_B0 part 2. Populate
...
FROM kernel_dp_0_1)
 INSERT INTO "TMP_20180602153115_IYB_KernAgg_B0" ("KEY", "OVO_Class1", "OVO_Class2", "OVO_Decision", "OVO_Conf") SELECT "KernAgg_B0"."KEY", "KernAgg_B0"."OVO_Class1", "KernAgg_B0"."OVO_Class2", "KernAgg_B0"."OVO_Decision", "KernAgg_B0"."OVO_Conf" 
...
-- Code For temporary table TMP_20180602153115_6PM_KernAgg_B1 part 1. Create 


CREATE TEMPORARY TABLE "TMP_20180602153115_6PM_KernAgg_B1" (
	"KEY" BIGINT, 
	"OVO_Class1" BIGINT, 
	"OVO_Class2" BIGINT, 
	"OVO_Decision" BIGINT, 
...
-- Code For temporary table TMP_20180602153115_6PM_KernAgg_B1 part 2. Populate
...
FROM kernel_dp_0_2)
 INSERT INTO "TMP_20180602153115_6PM_KernAgg_B1" ("KEY", "OVO_Class1", "OVO_Class2", "OVO_Decision", "OVO_Conf") SELECT "KernAgg_B1"."KEY", "KernAgg_B1"."OVO_Class1", "KernAgg_B1"."OVO_Class2", "KernAgg_B1"."OVO_Decision", "KernAgg_B1"."OVO_Conf" 
...
-- Code For temporary table TMP_20180602153115_OA5_KernAgg_B2 part 1. Create 


CREATE TEMPORARY TABLE "TMP_20180602153115_OA5_KernAgg_B2" (
	"KEY" BIGINT, 
	"OVO_Class1" BIGINT, 
	"OVO_Class2" BIGINT, 
	"OVO_Decision" BIGINT, 
...
-- Code For temporary table TMP_20180602153115_OA5_KernAgg_B2 part 2. Populate
...
FROM kernel_dp_1_2)
 INSERT INTO "TMP_20180602153115_OA5_KernAgg_B2" ("KEY", "OVO_Class1", "OVO_Class2", "OVO_Decision", "OVO_Conf") SELECT "KernAgg_B2"."KEY", "KernAgg_B2"."OVO_Class1", "KernAgg_B2"."OVO_Class2", "KernAgg_B2"."OVO_Decision", "KernAgg_B2"."OVO_Conf" 
...
-- Code For temporary table TMP_20180602153116_LDM_KernAgg_agg part 1. Create 


CREATE TEMPORARY TABLE "TMP_20180602153116_LDM_KernAgg_agg" (
	"KEY" BIGINT NOT NULL, 
	"OVO_Vote_0" BIGINT, 
...
-- Code For temporary table TMP_20180602153116_LDM_KernAgg_agg part 2. Populate
...
FROM "TMP_20180602153115_IYB_KernAgg_B0" AS "KernAgg_B0" UNION ALL SELECT "KernAgg_B1"."KEY" AS "KEY", "KernAgg_B1"."OVO_Class1" AS "OVO_Class1", "KernAgg_B1"."OVO_Class2" AS "OVO_Class2", "KernAgg_B1"."OVO_Decision" AS "OVO_Decision", "KernAgg_B1"."OVO_Conf" AS "OVO_Conf" 
FROM "TMP_20180602153115_6PM_KernAgg_B1" AS "KernAgg_B1" UNION ALL SELECT "KernAgg_B2"."KEY" AS "KEY", "KernAgg_B2"."OVO_Class1" AS "OVO_Class1", "KernAgg_B2"."OVO_Class2" AS "OVO_Class2", "KernAgg_B2"."OVO_Decision" AS "OVO_Decision", "KernAgg_B2"."OVO_Conf" AS "OVO_Conf" 
FROM "TMP_20180602153115_OA5_KernAgg_B2" AS "KernAgg_B2") AS "KernAgg_EnsembleUnion"), 
"OVO_Votes" AS 
...
FROM "OVO_Votes", "MinMaxConf")
 INSERT INTO "TMP_20180602153116_LDM_KernAgg_agg" ("KEY", "OVO_Vote_0", "OVO_SumConfidence_0", "OVO_Vote_1", "OVO_SumConfidence_1", "OVO_Vote_2", "OVO_SumConfidence_2", max_abs_confidence, "OVO_Scale", "Score_0", "Score_1", "Score_2") SELECT "KernAgg_agg"."KEY", "KernAgg_agg"."OVO_Vote_0", "KernAgg_agg"."OVO_SumConfidence_0", "KernAgg_agg"."OVO_Vote_1", "KernAgg_agg"."OVO_SumConfidence_1", "KernAgg_agg"."OVO_Vote_2", "KernAgg_agg"."OVO_SumConfidence_2", "KernAgg_agg".max_abs_confidence, "KernAgg_agg"."OVO_Scale", "KernAgg_agg"."Score_0", "KernAgg_agg"."Score_1", "KernAgg_agg"."Score_2" 
...
-- Code For temporary table TMP_20180602153116_LDM_KernAgg_agg part 3. Create Index 

CREATE INDEX "ix_TMP_20180602153116_LDM_KernAgg_agg_KEY" ON "TMP_20180602153116_LDM_KernAgg_agg" ("KEY")
...
FROM "TMP_20180602153116_LDM_KernAgg_agg" AS "KernAgg_agg"), 
