...
-- Code For temporary table tmp_20180516122758_codegen_3mjaj3_kernagg_b0 part 1. Create 


CREATE TABLE tmp_20180516122758_codegen_3mjaj3_kernagg_b0 (
	`KEY` BIGINT, 
	`OVO_Class1` BIGINT, 
	`OVO_Class2` BIGINT, 
	`OVO_Decision` BIGINT, 
...
-- Code For temporary table tmp_20180516122758_codegen_3mjaj3_kernagg_b0 part 2. Populate
...
kernel_cte_0_1 AS 
(SELECT kernel_dp_0_1.`KEY` AS `KEY`, 0 AS `OVO_Class1`, 1 AS `OVO_Class2`, CASE WHEN (-kernel_dp_0_1.dot_product >= 0.0) THEN 1 ELSE 0 END AS `OVO_Decision`, coalesce(-kernel_dp_0_1.dot_product, 1.0 / (1.0 + exp(CASE WHEN (CASE WHEN (-100.0 <= -(-((-kernel_dp_0_1.dot_product) * -1.6215146704999286 + -0.9610089383340904))) THEN -(-((-kernel_dp_0_1.dot_product) * -1.6215146704999286 + -0.9610089383340904)) ELSE -100.0 END <= 100.0) THEN CASE WHEN (-100.0 <= -(-((-kernel_dp_0_1.dot_product) * -1.6215146704999286 + -0.9610089383340904))) THEN -(-((-kernel_dp_0_1.dot_product) * -1.6215146704999286 + -0.9610089383340904)) ELSE -100.0 END ELSE 100.0 END))) AS `OVO_Confidence` 
FROM kernel_dp_0_1)
 INSERT INTO tmp_20180516122758_codegen_3mjaj3_kernagg_b0 (`KEY`, `OVO_Class1`, `OVO_Class2`, `OVO_Decision`, `OVO_Confidence`) SELECT `KernAgg_B0`.`KEY`, `KernAgg_B0`.`OVO_Class1`, `KernAgg_B0`.`OVO_Class2`, `KernAgg_B0`.`OVO_Decision`, `KernAgg_B0`.`OVO_Confidence` 
...
-- Code For temporary table tmp_20180516122758_codegen_hll7sb_kernagg_b1 part 1. Create 


CREATE TABLE tmp_20180516122758_codegen_hll7sb_kernagg_b1 (
	`KEY` BIGINT, 
	`OVO_Class1` BIGINT, 
	`OVO_Class2` BIGINT, 
	`OVO_Decision` BIGINT, 
...
-- Code For temporary table tmp_20180516122758_codegen_hll7sb_kernagg_b1 part 2. Populate
...
kernel_cte_0_2 AS 
(SELECT kernel_dp_0_2.`KEY` AS `KEY`, 0 AS `OVO_Class1`, 2 AS `OVO_Class2`, CASE WHEN (-kernel_dp_0_2.dot_product >= 0.0) THEN 1 ELSE 0 END AS `OVO_Decision`, coalesce(-kernel_dp_0_2.dot_product, 1.0 / (1.0 + exp(CASE WHEN (CASE WHEN (-100.0 <= -(-((-kernel_dp_0_2.dot_product) * -1.938480369410695 + -0.8465119363272148))) THEN -(-((-kernel_dp_0_2.dot_product) * -1.938480369410695 + -0.8465119363272148)) ELSE -100.0 END <= 100.0) THEN CASE WHEN (-100.0 <= -(-((-kernel_dp_0_2.dot_product) * -1.938480369410695 + -0.8465119363272148))) THEN -(-((-kernel_dp_0_2.dot_product) * -1.938480369410695 + -0.8465119363272148)) ELSE -100.0 END ELSE 100.0 END))) AS `OVO_Confidence` 
FROM kernel_dp_0_2)
 INSERT INTO tmp_20180516122758_codegen_hll7sb_kernagg_b1 (`KEY`, `OVO_Class1`, `OVO_Class2`, `OVO_Decision`, `OVO_Confidence`) SELECT `KernAgg_B1`.`KEY`, `KernAgg_B1`.`OVO_Class1`, `KernAgg_B1`.`OVO_Class2`, `KernAgg_B1`.`OVO_Decision`, `KernAgg_B1`.`OVO_Confidence` 
...
-- Code For temporary table tmp_20180516122758_codegen_owte8y_kernagg_b2 part 1. Create 


CREATE TABLE tmp_20180516122758_codegen_owte8y_kernagg_b2 (
	`KEY` BIGINT, 
	`OVO_Class1` BIGINT, 
	`OVO_Class2` BIGINT, 
	`OVO_Decision` BIGINT, 
...
-- Code For temporary table tmp_20180516122758_codegen_owte8y_kernagg_b2 part 2. Populate
...
kernel_cte_1_2 AS 
(SELECT kernel_dp_1_2.`KEY` AS `KEY`, 1 AS `OVO_Class1`, 2 AS `OVO_Class2`, CASE WHEN (-kernel_dp_1_2.dot_product >= 0.0) THEN 1 ELSE 0 END AS `OVO_Decision`, coalesce(-kernel_dp_1_2.dot_product, 1.0 / (1.0 + exp(CASE WHEN (CASE WHEN (-100.0 <= -(-((-kernel_dp_1_2.dot_product) * -0.4068963900124744 + -0.040785355582391984))) THEN -(-((-kernel_dp_1_2.dot_product) * -0.4068963900124744 + -0.040785355582391984)) ELSE -100.0 END <= 100.0) THEN CASE WHEN (-100.0 <= -(-((-kernel_dp_1_2.dot_product) * -0.4068963900124744 + -0.040785355582391984))) THEN -(-((-kernel_dp_1_2.dot_product) * -0.4068963900124744 + -0.040785355582391984)) ELSE -100.0 END ELSE 100.0 END))) AS `OVO_Confidence` 
FROM kernel_dp_1_2)
 INSERT INTO tmp_20180516122758_codegen_owte8y_kernagg_b2 (`KEY`, `OVO_Class1`, `OVO_Class2`, `OVO_Decision`, `OVO_Confidence`) SELECT `KernAgg_B2`.`KEY`, `KernAgg_B2`.`OVO_Class1`, `KernAgg_B2`.`OVO_Class2`, `KernAgg_B2`.`OVO_Decision`, `KernAgg_B2`.`OVO_Confidence` 
...
-- Code For temporary table tmp_20180516122758_codegen_en6xn8_kernagg part 1. Create 


CREATE TABLE tmp_20180516122758_codegen_en6xn8_kernagg (
	`KEY` BIGINT, 
	`OVO_Vote_0` BIGINT, 
...
-- Code For temporary table tmp_20180516122758_codegen_en6xn8_kernagg part 2. Populate
...
FROM tmp_20180516122758_codegen_3mjaj3_kernagg_b0 AS `KernAgg_B0` UNION ALL SELECT `KernAgg_B1`.`KEY` AS `KEY`, `KernAgg_B1`.`OVO_Class1` AS `OVO_Class1`, `KernAgg_B1`.`OVO_Class2` AS `OVO_Class2`, `KernAgg_B1`.`OVO_Decision` AS `OVO_Decision`, `KernAgg_B1`.`OVO_Confidence` AS `OVO_Confidence` 
FROM tmp_20180516122758_codegen_hll7sb_kernagg_b1 AS `KernAgg_B1` UNION ALL SELECT `KernAgg_B2`.`KEY` AS `KEY`, `KernAgg_B2`.`OVO_Class1` AS `OVO_Class1`, `KernAgg_B2`.`OVO_Class2` AS `OVO_Class2`, `KernAgg_B2`.`OVO_Decision` AS `OVO_Decision`, `KernAgg_B2`.`OVO_Confidence` AS `OVO_Confidence` 
FROM tmp_20180516122758_codegen_owte8y_kernagg_b2 AS `KernAgg_B2`) AS `KernAgg_EnsembleUnion`), 
`OVO_Votes` AS 
...
FROM `OVO_Votes`, `MinMaxConf`)
 INSERT INTO tmp_20180516122758_codegen_en6xn8_kernagg (`KEY`, `OVO_Vote_0`, `OVO_SumConfidence_0`, `OVO_Vote_1`, `OVO_SumConfidence_1`, `OVO_Vote_2`, `OVO_SumConfidence_2`, max_abs_confidence, `OVO_Scale`, `Score_0`, `Score_1`, `Score_2`) SELECT `KernAgg`.`KEY`, `KernAgg`.`OVO_Vote_0`, `KernAgg`.`OVO_SumConfidence_0`, `KernAgg`.`OVO_Vote_1`, `KernAgg`.`OVO_SumConfidence_1`, `KernAgg`.`OVO_Vote_2`, `KernAgg`.`OVO_SumConfidence_2`, `KernAgg`.max_abs_confidence, `KernAgg`.`OVO_Scale`, `KernAgg`.`Score_0`, `KernAgg`.`Score_1`, `KernAgg`.`Score_2` 
...
FROM tmp_20180516122758_codegen_en6xn8_kernagg AS `KernAgg`), 
