...
-- Code For temporary table tmp_20180508195236_codegen_28l40n_kernagg_b0 part 1. Create 


CREATE TABLE tmp_20180508195236_codegen_28l40n_kernagg_b0 (
	`KEY` BIGINT, 
	`OVO_Class1` BIGINT, 
	`OVO_Class2` BIGINT, 
	`OVO_Decision` BIGINT, 
...
-- Code For temporary table tmp_20180508195236_codegen_28l40n_kernagg_b0 part 2. Populate
...
kernel_cte_0_1 AS 
(SELECT kernel_dp_0_1.`KEY` AS `KEY`, 0 AS `OVO_Class1`, 1 AS `OVO_Class2`, CASE WHEN (-kernel_dp_0_1.dot_product >= 0.0) THEN 1 ELSE 0 END AS `OVO_Decision`, coalesce(-kernel_dp_0_1.dot_product, 1.0 / (1.0 + exp(CASE WHEN (CASE WHEN (-100.0 <= -(-((-kernel_dp_0_1.dot_product) * -1.6485501761160595 + -0.9647746540543143))) THEN -(-((-kernel_dp_0_1.dot_product) * -1.6485501761160595 + -0.9647746540543143)) ELSE -100.0 END <= 100.0) THEN CASE WHEN (-100.0 <= -(-((-kernel_dp_0_1.dot_product) * -1.6485501761160595 + -0.9647746540543143))) THEN -(-((-kernel_dp_0_1.dot_product) * -1.6485501761160595 + -0.9647746540543143)) ELSE -100.0 END ELSE 100.0 END))) AS `OVO_Confidence` 
FROM kernel_dp_0_1), 
`SV_data_0_2` AS 
(SELECT `Values`.sv_idx AS sv_idx, CAST(`Values`.dual_coeff AS DOUBLE) AS dual_coeff, CAST(`Values`.sv_0 AS DOUBLE) AS sv_0, CAST(`Values`.sv_1 AS DOUBLE) AS sv_1, CAST(`Values`.sv_2 AS DOUBLE) AS sv_2, CAST(`Values`.sv_3 AS DOUBLE) AS sv_3 
...
kernel_cte_0_2 AS 
(SELECT kernel_dp_0_2.`KEY` AS `KEY`, 0 AS `OVO_Class1`, 2 AS `OVO_Class2`, CASE WHEN (-kernel_dp_0_2.dot_product >= 0.0) THEN 1 ELSE 0 END AS `OVO_Decision`, coalesce(-kernel_dp_0_2.dot_product, 1.0 / (1.0 + exp(CASE WHEN (CASE WHEN (-100.0 <= -(-((-kernel_dp_0_2.dot_product) * -1.9484392661505685 + -0.8821524448078564))) THEN -(-((-kernel_dp_0_2.dot_product) * -1.9484392661505685 + -0.8821524448078564)) ELSE -100.0 END <= 100.0) THEN CASE WHEN (-100.0 <= -(-((-kernel_dp_0_2.dot_product) * -1.9484392661505685 + -0.8821524448078564))) THEN -(-((-kernel_dp_0_2.dot_product) * -1.9484392661505685 + -0.8821524448078564)) ELSE -100.0 END ELSE 100.0 END))) AS `OVO_Confidence` 
FROM kernel_dp_0_2), 
`SV_data_1_2` AS 
(SELECT `Values`.sv_idx AS sv_idx, CAST(`Values`.dual_coeff AS DOUBLE) AS dual_coeff, CAST(`Values`.sv_0 AS DOUBLE) AS sv_0, CAST(`Values`.sv_1 AS DOUBLE) AS sv_1, CAST(`Values`.sv_2 AS DOUBLE) AS sv_2, CAST(`Values`.sv_3 AS DOUBLE) AS sv_3 
...
kernel_cte_1_2 AS 
(SELECT kernel_dp_1_2.`KEY` AS `KEY`, 1 AS `OVO_Class1`, 2 AS `OVO_Class2`, CASE WHEN (-kernel_dp_1_2.dot_product >= 0.0) THEN 1 ELSE 0 END AS `OVO_Decision`, coalesce(-kernel_dp_1_2.dot_product, 1.0 / (1.0 + exp(CASE WHEN (CASE WHEN (-100.0 <= -(-((-kernel_dp_1_2.dot_product) * -0.36865644297183775 + 0.1923052483774909))) THEN -(-((-kernel_dp_1_2.dot_product) * -0.36865644297183775 + 0.1923052483774909)) ELSE -100.0 END <= 100.0) THEN CASE WHEN (-100.0 <= -(-((-kernel_dp_1_2.dot_product) * -0.36865644297183775 + 0.1923052483774909))) THEN -(-((-kernel_dp_1_2.dot_product) * -0.36865644297183775 + 0.1923052483774909)) ELSE -100.0 END ELSE 100.0 END))) AS `OVO_Confidence` 
FROM kernel_dp_1_2)
 INSERT INTO tmp_20180508195236_codegen_28l40n_kernagg_b0 (`KEY`, `OVO_Class1`, `OVO_Class2`, `OVO_Decision`, `OVO_Confidence`) SELECT `KernAgg_B0`.`KEY`, `KernAgg_B0`.`OVO_Class1`, `KernAgg_B0`.`OVO_Class2`, `KernAgg_B0`.`OVO_Decision`, `KernAgg_B0`.`OVO_Confidence` 
...
-- Code For temporary table tmp_20180508195236_codegen_d1pmgk_kernagg_union part 1. Create 


CREATE TABLE tmp_20180508195236_codegen_d1pmgk_kernagg_union (
	`KEY` BIGINT, 
	`OVO_Class1` BIGINT, 
	`OVO_Class2` BIGINT, 
	`OVO_Decision` BIGINT, 
...
-- Code For temporary table tmp_20180508195236_codegen_d1pmgk_kernagg_union part 2. Populate

INSERT INTO tmp_20180508195236_codegen_d1pmgk_kernagg_union (`KEY`, `OVO_Class1`, `OVO_Class2`, `OVO_Decision`, `OVO_Confidence`) SELECT `KernAgg_Union`.`KEY`, `KernAgg_Union`.`OVO_Class1`, `KernAgg_Union`.`OVO_Class2`, `KernAgg_Union`.`OVO_Decision`, `KernAgg_Union`.`OVO_Confidence` 
...
FROM tmp_20180508195236_codegen_28l40n_kernagg_b0 AS `KernAgg_B0`) AS `KernAgg_EnsembleUnion`) AS `KernAgg_Union`

-- Code For temporary table tmp_20180508195236_codegen_qwjied_kernagg part 1. Create 


CREATE TABLE tmp_20180508195236_codegen_qwjied_kernagg (
	`KEY` BIGINT, 
	`OVO_Vote_0` BIGINT, 
...
-- Code For temporary table tmp_20180508195236_codegen_qwjied_kernagg part 2. Populate
...
FROM tmp_20180508195236_codegen_d1pmgk_kernagg_union AS `KernAgg_Union` GROUP BY `KernAgg_Union`.`KEY`) AS `Votes_Sel`), 
`OVO_SumConf_CTE` AS 
...
FROM tmp_20180508195236_codegen_qwjied_kernagg AS `KernAgg`), 
