...
-- Code For temporary table TMP_20180516_CODEGEN_MOTPDL_KER part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180516_CODEGEN_MOTPDL_KER" (
	"KEY" BIGINT, 
	"OVO_Class1" BIGINT, 
	"OVO_Class2" BIGINT, 
	"OVO_Decision" BIGINT, 
...
-- Code For temporary table TMP_20180516_CODEGEN_MOTPDL_KER part 2. Populate

INSERT INTO "TMP_20180516_CODEGEN_MOTPDL_KER" ("KEY", "OVO_Class1", "OVO_Class2", "OVO_Decision", "OVO_Confidence") SELECT "U"."KEY", "U"."OVO_Class1", "U"."OVO_Class2", "U"."OVO_Decision", "U"."OVO_Confidence" 
...
kernel_cte_0_1 AS 
(SELECT kernel_dp_0_1."KEY" AS "KEY", 0 AS "OVO_Class1", 1 AS "OVO_Class2", CASE WHEN (-kernel_dp_0_1.dot_product >= 0.0) THEN 1 ELSE 0 END AS "OVO_Decision", coalesce(-kernel_dp_0_1.dot_product, 1.0 / (1.0 + exp(CASE WHEN (minvalue(maxvalue(-100.0, -(-((-kernel_dp_0_1.dot_product) * -1.6215146704999286 + -0.9610089383340904))), 100.0) >= -709.782712893384) THEN minvalue(maxvalue(-100.0, -(-((-kernel_dp_0_1.dot_product) * -1.6215146704999286 + -0.9610089383340904))), 100.0) ELSE -709.782712893384 END))) AS "OVO_Confidence" 
FROM kernel_dp_0_1)
...
-- Code For temporary table TMP_20180516_CODEGEN_MIQTFJ_KER part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180516_CODEGEN_MIQTFJ_KER" (
	"KEY" BIGINT, 
	"OVO_Class1" BIGINT, 
	"OVO_Class2" BIGINT, 
	"OVO_Decision" BIGINT, 
...
-- Code For temporary table TMP_20180516_CODEGEN_MIQTFJ_KER part 2. Populate

INSERT INTO "TMP_20180516_CODEGEN_MIQTFJ_KER" ("KEY", "OVO_Class1", "OVO_Class2", "OVO_Decision", "OVO_Confidence") SELECT "U"."KEY", "U"."OVO_Class1", "U"."OVO_Class2", "U"."OVO_Decision", "U"."OVO_Confidence" 
FROM (WITH kernel_input AS 
(SELECT "ADS"."KEY" AS "KEY", CAST("ADS"."Feature_0" AS DOUBLE PRECISION) AS "Feature_0", CAST("ADS"."Feature_1" AS DOUBLE PRECISION) AS "Feature_1", CAST("ADS"."Feature_2" AS DOUBLE PRECISION) AS "Feature_2", CAST("ADS"."Feature_3" AS DOUBLE PRECISION) AS "Feature_3", CAST("ADS"."TGT" AS DOUBLE PRECISION) AS "TGT" 
FROM iris AS "ADS"), 
"SV_data_0_2" AS 
...
kernel_cte_0_2 AS 
(SELECT kernel_dp_0_2."KEY" AS "KEY", 0 AS "OVO_Class1", 2 AS "OVO_Class2", CASE WHEN (-kernel_dp_0_2.dot_product >= 0.0) THEN 1 ELSE 0 END AS "OVO_Decision", coalesce(-kernel_dp_0_2.dot_product, 1.0 / (1.0 + exp(CASE WHEN (minvalue(maxvalue(-100.0, -(-((-kernel_dp_0_2.dot_product) * -1.938480369410695 + -0.8465119363272148))), 100.0) >= -709.782712893384) THEN minvalue(maxvalue(-100.0, -(-((-kernel_dp_0_2.dot_product) * -1.938480369410695 + -0.8465119363272148))), 100.0) ELSE -709.782712893384 END))) AS "OVO_Confidence" 
FROM kernel_dp_0_2)
...
-- Code For temporary table TMP_20180516_CODEGEN_O4WIDY_KER part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180516_CODEGEN_O4WIDY_KER" (
	"KEY" BIGINT, 
	"OVO_Class1" BIGINT, 
	"OVO_Class2" BIGINT, 
	"OVO_Decision" BIGINT, 
...
-- Code For temporary table TMP_20180516_CODEGEN_O4WIDY_KER part 2. Populate

INSERT INTO "TMP_20180516_CODEGEN_O4WIDY_KER" ("KEY", "OVO_Class1", "OVO_Class2", "OVO_Decision", "OVO_Confidence") SELECT "U"."KEY", "U"."OVO_Class1", "U"."OVO_Class2", "U"."OVO_Decision", "U"."OVO_Confidence" 
FROM (WITH kernel_input AS 
(SELECT "ADS"."KEY" AS "KEY", CAST("ADS"."Feature_0" AS DOUBLE PRECISION) AS "Feature_0", CAST("ADS"."Feature_1" AS DOUBLE PRECISION) AS "Feature_1", CAST("ADS"."Feature_2" AS DOUBLE PRECISION) AS "Feature_2", CAST("ADS"."Feature_3" AS DOUBLE PRECISION) AS "Feature_3", CAST("ADS"."TGT" AS DOUBLE PRECISION) AS "TGT" 
FROM iris AS "ADS"), 
"SV_data_1_2" AS 
...
kernel_cte_1_2 AS 
(SELECT kernel_dp_1_2."KEY" AS "KEY", 1 AS "OVO_Class1", 2 AS "OVO_Class2", CASE WHEN (-kernel_dp_1_2.dot_product >= 0.0) THEN 1 ELSE 0 END AS "OVO_Decision", coalesce(-kernel_dp_1_2.dot_product, 1.0 / (1.0 + exp(CASE WHEN (minvalue(maxvalue(-100.0, -(-((-kernel_dp_1_2.dot_product) * -0.4068963900124744 + -0.040785355582391984))), 100.0) >= -709.782712893384) THEN minvalue(maxvalue(-100.0, -(-((-kernel_dp_1_2.dot_product) * -0.4068963900124744 + -0.040785355582391984))), 100.0) ELSE -709.782712893384 END))) AS "OVO_Confidence" 
FROM kernel_dp_1_2)
...
-- Code For temporary table TMP_20180516_CODEGEN_ASQP1N_KER part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180516_CODEGEN_ASQP1N_KER" (
	"KEY" BIGINT NOT NULL, 
	"OVO_Vote_0" BIGINT, 
...
-- Code For temporary table TMP_20180516_CODEGEN_ASQP1N_KER part 2. Populate

INSERT INTO "TMP_20180516_CODEGEN_ASQP1N_KER" ("KEY", "OVO_Vote_0", "OVO_SumConfidence_0", "OVO_Vote_1", "OVO_SumConfidence_1", "OVO_Vote_2", "OVO_SumConfidence_2", max_abs_confidence, "OVO_Scale", "Score_0", "Score_1", "Score_2") SELECT "U"."KEY", "U"."OVO_Vote_0", "U"."OVO_SumConfidence_0", "U"."OVO_Vote_1", "U"."OVO_SumConfidence_1", "U"."OVO_Vote_2", "U"."OVO_SumConfidence_2", "U".max_abs_confidence, "U"."OVO_Scale", "U"."Score_0", "U"."Score_1", "U"."Score_2" 
...
FROM "TMP_20180516_CODEGEN_MOTPDL_KER" AS "KernAgg_B0" UNION ALL SELECT "KernAgg_B1"."KEY" AS "KEY", "KernAgg_B1"."OVO_Class1" AS "OVO_Class1", "KernAgg_B1"."OVO_Class2" AS "OVO_Class2", "KernAgg_B1"."OVO_Decision" AS "OVO_Decision", "KernAgg_B1"."OVO_Confidence" AS "OVO_Confidence" 
FROM "TMP_20180516_CODEGEN_MIQTFJ_KER" AS "KernAgg_B1" UNION ALL SELECT "KernAgg_B2"."KEY" AS "KEY", "KernAgg_B2"."OVO_Class1" AS "OVO_Class1", "KernAgg_B2"."OVO_Class2" AS "OVO_Class2", "KernAgg_B2"."OVO_Decision" AS "OVO_Decision", "KernAgg_B2"."OVO_Confidence" AS "OVO_Confidence" 
FROM "TMP_20180516_CODEGEN_O4WIDY_KER" AS "KernAgg_B2") AS "KernAgg_EnsembleUnion"), 
"OVO_Votes" AS 
...
-- Code For temporary table TMP_20180516_CODEGEN_ASQP1N_KER part 3. Create Index 

CREATE INDEX "ix_TMP_20180516_CODEGEN_3338" ON "TMP_20180516_CODEGEN_ASQP1N_KER" ("KEY")
...
FROM "TMP_20180516_CODEGEN_ASQP1N_KER" AS "KernAgg"), 
