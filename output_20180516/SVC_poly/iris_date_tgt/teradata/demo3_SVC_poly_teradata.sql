...
-- Code For temporary table tmp_20180516125716_codegen_0lzhr1_kernagg_b0 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180516125716_codegen_0lzhr1_kernagg_b0  (
	"KEY" BIGINT, 
...
-- Code For temporary table tmp_20180516125716_codegen_0lzhr1_kernagg_b0 part 2. Populate

INSERT INTO tmp_20180516125716_codegen_0lzhr1_kernagg_b0 ("KEY", "OVO_Class1", "OVO_Class2", "OVO_Decision", "OVO_Confidence") SELECT "U"."KEY", "U"."OVO_Class1", "U"."OVO_Class2", "U"."OVO_Decision", "U"."OVO_Confidence" 
...
FROM dummy_cte UNION ALL SELECT 1 AS sv_idx, CAST(0.008884167561703 AS DOUBLE PRECISION) AS dual_coeff, CAST(5.1 AS DOUBLE PRECISION) AS sv_0, CAST(3.3 AS DOUBLE PRECISION) AS sv_1, CAST(1.7 AS DOUBLE PRECISION) AS sv_2, CAST(0.5 AS DOUBLE PRECISION) AS sv_3 
FROM dummy_cte UNION ALL SELECT 2 AS sv_idx, CAST(0.0 AS DOUBLE PRECISION) AS dual_coeff, CAST(5.1 AS DOUBLE PRECISION) AS sv_0, CAST(3.8 AS DOUBLE PRECISION) AS sv_1, CAST(1.9 AS DOUBLE PRECISION) AS sv_2, CAST(0.4 AS DOUBLE PRECISION) AS sv_3 
FROM dummy_cte UNION ALL SELECT 3 AS sv_idx, CAST(0.000510938870975 AS DOUBLE PRECISION) AS dual_coeff, CAST(4.5 AS DOUBLE PRECISION) AS sv_0, CAST(2.3 AS DOUBLE PRECISION) AS sv_1, CAST(1.3 AS DOUBLE PRECISION) AS sv_2, CAST(0.3 AS DOUBLE PRECISION) AS sv_3 
FROM dummy_cte UNION ALL SELECT 4 AS sv_idx, CAST(-0.009395106432678 AS DOUBLE PRECISION) AS dual_coeff, CAST(5.1 AS DOUBLE PRECISION) AS sv_0, CAST(2.5 AS DOUBLE PRECISION) AS sv_1, CAST(3.0 AS DOUBLE PRECISION) AS sv_2, CAST(1.1 AS DOUBLE PRECISION) AS sv_3 
FROM dummy_cte UNION ALL SELECT 5 AS sv_idx, CAST(-0.0 AS DOUBLE PRECISION) AS dual_coeff, CAST(5.9 AS DOUBLE PRECISION) AS sv_0, CAST(3.2 AS DOUBLE PRECISION) AS sv_1, CAST(4.8 AS DOUBLE PRECISION) AS sv_2, CAST(1.8 AS DOUBLE PRECISION) AS sv_3 
FROM dummy_cte UNION ALL SELECT 6 AS sv_idx, CAST(-0.0 AS DOUBLE PRECISION) AS dual_coeff, CAST(6.3 AS DOUBLE PRECISION) AS sv_0, CAST(2.5 AS DOUBLE PRECISION) AS sv_1, CAST(4.9 AS DOUBLE PRECISION) AS sv_2, CAST(1.5 AS DOUBLE PRECISION) AS sv_3 
FROM dummy_cte) AS "Values"), 
"kernel_dp_1789-07-14T00:00:00.000000000_1789-08-14T00:00:00.000000000" AS 
(SELECT t."KEY" AS "KEY", t.dot_product AS dot_product 
FROM (SELECT full_join_data_sv."KEY" AS "KEY", sum(CAST(full_join_data_sv.dot_prod1 AS DOUBLE PRECISION)) + CAST(1.136109945996278 AS DOUBLE PRECISION) AS dot_product 
FROM (SELECT kernel_input."KEY" AS "KEY", "SV_data_1789-07-14T00:00:00.000000000_1789-08-14T00:00:00.000000000".dual_coeff * power(CAST(0.25 AS DOUBLE PRECISION) * (kernel_input."Feature_0" * "SV_data_1789-07-14T00:00:00.000000000_1789-08-14T00:00:00.000000000".sv_0 + kernel_input."Feature_1" * "SV_data_1789-07-14T00:00:00.000000000_1789-08-14T00:00:00.000000000".sv_1 + kernel_input."Feature_2" * "SV_data_1789-07-14T00:00:00.000000000_1789-08-14T00:00:00.000000000".sv_2 + kernel_input."Feature_3" * "SV_data_1789-07-14T00:00:00.000000000_1789-08-14T00:00:00.000000000".sv_3) + CAST(0.0 AS DOUBLE PRECISION), 3) AS dot_prod1 
...
-- Code For temporary table tmp_20180516125716_codegen_ab4t85_kernagg_b1 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180516125716_codegen_ab4t85_kernagg_b1  (
	"KEY" BIGINT, 
	"OVO_Class1" LONG VARCHAR, 
	"OVO_Class2" LONG VARCHAR, 
	"OVO_Decision" BIGINT, 
...
-- Code For temporary table tmp_20180516125716_codegen_ab4t85_kernagg_b1 part 2. Populate

INSERT INTO tmp_20180516125716_codegen_ab4t85_kernagg_b1 ("KEY", "OVO_Class1", "OVO_Class2", "OVO_Decision", "OVO_Confidence") SELECT "U"."KEY", "U"."OVO_Class1", "U"."OVO_Class2", "U"."OVO_Decision", "U"."OVO_Confidence" 
FROM (WITH kernel_input AS 
(SELECT "ADS"."KEY" AS "KEY", CAST("ADS"."Feature_0" AS DOUBLE PRECISION) AS "Feature_0", CAST("ADS"."Feature_1" AS DOUBLE PRECISION) AS "Feature_1", CAST("ADS"."Feature_2" AS DOUBLE PRECISION) AS "Feature_2", CAST("ADS"."Feature_3" AS DOUBLE PRECISION) AS "Feature_3", CAST("ADS"."TGT" AS DOUBLE PRECISION) AS "TGT" 
FROM iris_date_tgt AS "ADS"), 
dummy_cte AS 
...
(SELECT "Values".sv_idx AS sv_idx, CAST("Values".dual_coeff AS DOUBLE PRECISION) AS dual_coeff, CAST("Values".sv_0 AS DOUBLE PRECISION) AS sv_0, CAST("Values".sv_1 AS DOUBLE PRECISION) AS sv_1, CAST("Values".sv_2 AS DOUBLE PRECISION) AS sv_2, CAST("Values".sv_3 AS DOUBLE PRECISION) AS sv_3 
FROM (SELECT 0 AS sv_idx, CAST(0.000628605631052 AS DOUBLE PRECISION) AS dual_coeff, CAST(4.8 AS DOUBLE PRECISION) AS sv_0, CAST(3.4 AS DOUBLE PRECISION) AS sv_1, CAST(1.9 AS DOUBLE PRECISION) AS sv_2, CAST(0.2 AS DOUBLE PRECISION) AS sv_3 
FROM dummy_cte UNION ALL SELECT 1 AS sv_idx, CAST(0.000506677930534 AS DOUBLE PRECISION) AS dual_coeff, CAST(5.1 AS DOUBLE PRECISION) AS sv_0, CAST(3.3 AS DOUBLE PRECISION) AS sv_1, CAST(1.7 AS DOUBLE PRECISION) AS sv_2, CAST(0.5 AS DOUBLE PRECISION) AS sv_3 
FROM dummy_cte UNION ALL SELECT 2 AS sv_idx, CAST(0.000681476176768 AS DOUBLE PRECISION) AS dual_coeff, CAST(5.1 AS DOUBLE PRECISION) AS sv_0, CAST(3.8 AS DOUBLE PRECISION) AS sv_1, CAST(1.9 AS DOUBLE PRECISION) AS sv_2, CAST(0.4 AS DOUBLE PRECISION) AS sv_3 
FROM dummy_cte UNION ALL SELECT 3 AS sv_idx, CAST(0.0 AS DOUBLE PRECISION) AS dual_coeff, CAST(4.5 AS DOUBLE PRECISION) AS sv_0, CAST(2.3 AS DOUBLE PRECISION) AS sv_1, CAST(1.3 AS DOUBLE PRECISION) AS sv_2, CAST(0.3 AS DOUBLE PRECISION) AS sv_3 
FROM dummy_cte UNION ALL SELECT 7 AS sv_idx, CAST(-0.0 AS DOUBLE PRECISION) AS dual_coeff, CAST(6.1 AS DOUBLE PRECISION) AS sv_0, CAST(3.0 AS DOUBLE PRECISION) AS sv_1, CAST(4.9 AS DOUBLE PRECISION) AS sv_2, CAST(1.8 AS DOUBLE PRECISION) AS sv_3 
FROM dummy_cte UNION ALL SELECT 8 AS sv_idx, CAST(-0.001816759738355 AS DOUBLE PRECISION) AS dual_coeff, CAST(4.9 AS DOUBLE PRECISION) AS sv_0, CAST(2.5 AS DOUBLE PRECISION) AS sv_1, CAST(4.5 AS DOUBLE PRECISION) AS sv_2, CAST(1.7 AS DOUBLE PRECISION) AS sv_3 
FROM dummy_cte UNION ALL SELECT 9 AS sv_idx, CAST(-0.0 AS DOUBLE PRECISION) AS dual_coeff, CAST(6.0 AS DOUBLE PRECISION) AS sv_0, CAST(3.0 AS DOUBLE PRECISION) AS sv_1, CAST(4.8 AS DOUBLE PRECISION) AS sv_2, CAST(1.8 AS DOUBLE PRECISION) AS sv_3 
FROM dummy_cte UNION ALL SELECT 10 AS sv_idx, CAST(-0.0 AS DOUBLE PRECISION) AS dual_coeff, CAST(6.3 AS DOUBLE PRECISION) AS sv_0, CAST(2.8 AS DOUBLE PRECISION) AS sv_1, CAST(5.1 AS DOUBLE PRECISION) AS sv_2, CAST(1.5 AS DOUBLE PRECISION) AS sv_3 
FROM dummy_cte) AS "Values"), 
...
FROM (SELECT full_join_data_sv_1."KEY" AS "KEY", sum(CAST(full_join_data_sv_1.dot_prod1 AS DOUBLE PRECISION)) + CAST(1.184450950651881 AS DOUBLE PRECISION) AS dot_product 
FROM (SELECT kernel_input."KEY" AS "KEY", "SV_data_1789-07-14T00:00:00.000000000_1789-09-14T00:00:00.000000000".dual_coeff * power(CAST(0.25 AS DOUBLE PRECISION) * (kernel_input."Feature_0" * "SV_data_1789-07-14T00:00:00.000000000_1789-09-14T00:00:00.000000000".sv_0 + kernel_input."Feature_1" * "SV_data_1789-07-14T00:00:00.000000000_1789-09-14T00:00:00.000000000".sv_1 + kernel_input."Feature_2" * "SV_data_1789-07-14T00:00:00.000000000_1789-09-14T00:00:00.000000000".sv_2 + kernel_input."Feature_3" * "SV_data_1789-07-14T00:00:00.000000000_1789-09-14T00:00:00.000000000".sv_3) + CAST(0.0 AS DOUBLE PRECISION), 3) AS dot_prod1 
...
-- Code For temporary table tmp_20180516125716_codegen_rhaxe8_kernagg_b2 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180516125716_codegen_rhaxe8_kernagg_b2  (
	"KEY" BIGINT, 
	"OVO_Class1" LONG VARCHAR, 
	"OVO_Class2" LONG VARCHAR, 
	"OVO_Decision" BIGINT, 
...
-- Code For temporary table tmp_20180516125716_codegen_rhaxe8_kernagg_b2 part 2. Populate

INSERT INTO tmp_20180516125716_codegen_rhaxe8_kernagg_b2 ("KEY", "OVO_Class1", "OVO_Class2", "OVO_Decision", "OVO_Confidence") SELECT "U"."KEY", "U"."OVO_Class1", "U"."OVO_Class2", "U"."OVO_Decision", "U"."OVO_Confidence" 
FROM (WITH kernel_input AS 
(SELECT "ADS"."KEY" AS "KEY", CAST("ADS"."Feature_0" AS DOUBLE PRECISION) AS "Feature_0", CAST("ADS"."Feature_1" AS DOUBLE PRECISION) AS "Feature_1", CAST("ADS"."Feature_2" AS DOUBLE PRECISION) AS "Feature_2", CAST("ADS"."Feature_3" AS DOUBLE PRECISION) AS "Feature_3", CAST("ADS"."TGT" AS DOUBLE PRECISION) AS "TGT" 
FROM iris_date_tgt AS "ADS"), 
dummy_cte AS 
...
(SELECT "Values".sv_idx AS sv_idx, CAST("Values".dual_coeff AS DOUBLE PRECISION) AS dual_coeff, CAST("Values".sv_0 AS DOUBLE PRECISION) AS sv_0, CAST("Values".sv_1 AS DOUBLE PRECISION) AS sv_1, CAST("Values".sv_2 AS DOUBLE PRECISION) AS sv_2, CAST("Values".sv_3 AS DOUBLE PRECISION) AS sv_3 
FROM (SELECT 4 AS sv_idx, CAST(0.0 AS DOUBLE PRECISION) AS dual_coeff, CAST(5.1 AS DOUBLE PRECISION) AS sv_0, CAST(2.5 AS DOUBLE PRECISION) AS sv_1, CAST(3.0 AS DOUBLE PRECISION) AS sv_2, CAST(1.1 AS DOUBLE PRECISION) AS sv_3 
FROM dummy_cte UNION ALL SELECT 5 AS sv_idx, CAST(1.0 AS DOUBLE PRECISION) AS dual_coeff, CAST(5.9 AS DOUBLE PRECISION) AS sv_0, CAST(3.2 AS DOUBLE PRECISION) AS sv_1, CAST(4.8 AS DOUBLE PRECISION) AS sv_2, CAST(1.8 AS DOUBLE PRECISION) AS sv_3 
FROM dummy_cte UNION ALL SELECT 6 AS sv_idx, CAST(0.626184319196579 AS DOUBLE PRECISION) AS dual_coeff, CAST(6.3 AS DOUBLE PRECISION) AS sv_0, CAST(2.5 AS DOUBLE PRECISION) AS sv_1, CAST(4.9 AS DOUBLE PRECISION) AS sv_2, CAST(1.5 AS DOUBLE PRECISION) AS sv_3 
FROM dummy_cte UNION ALL SELECT 7 AS sv_idx, CAST(-0.077920394236566 AS DOUBLE PRECISION) AS dual_coeff, CAST(6.1 AS DOUBLE PRECISION) AS sv_0, CAST(3.0 AS DOUBLE PRECISION) AS sv_1, CAST(4.9 AS DOUBLE PRECISION) AS sv_2, CAST(1.8 AS DOUBLE PRECISION) AS sv_3 
FROM dummy_cte UNION ALL SELECT 8 AS sv_idx, CAST(-0.09951481759606 AS DOUBLE PRECISION) AS dual_coeff, CAST(4.9 AS DOUBLE PRECISION) AS sv_0, CAST(2.5 AS DOUBLE PRECISION) AS sv_1, CAST(4.5 AS DOUBLE PRECISION) AS sv_2, CAST(1.7 AS DOUBLE PRECISION) AS sv_3 
FROM dummy_cte UNION ALL SELECT 9 AS sv_idx, CAST(-1.0 AS DOUBLE PRECISION) AS dual_coeff, CAST(6.0 AS DOUBLE PRECISION) AS sv_0, CAST(3.0 AS DOUBLE PRECISION) AS sv_1, CAST(4.8 AS DOUBLE PRECISION) AS sv_2, CAST(1.8 AS DOUBLE PRECISION) AS sv_3 
FROM dummy_cte UNION ALL SELECT 10 AS sv_idx, CAST(-0.448749107363953 AS DOUBLE PRECISION) AS dual_coeff, CAST(6.3 AS DOUBLE PRECISION) AS sv_0, CAST(2.8 AS DOUBLE PRECISION) AS sv_1, CAST(5.1 AS DOUBLE PRECISION) AS sv_2, CAST(1.5 AS DOUBLE PRECISION) AS sv_3 
FROM dummy_cte) AS "Values"), 
...
-- Code For temporary table tmp_20180516125716_codegen_jdflk2_kernagg part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180516125716_codegen_jdflk2_kernagg  (
	"KEY" BIGINT, 
...
FROM tmp_20180516125716_codegen_0lzhr1_kernagg_b0 AS "KernAgg_B0" UNION ALL SELECT "KernAgg_B1"."KEY" AS "KEY", "KernAgg_B1"."OVO_Class1" AS "OVO_Class1", "KernAgg_B1"."OVO_Class2" AS "OVO_Class2", "KernAgg_B1"."OVO_Decision" AS "OVO_Decision", "KernAgg_B1"."OVO_Confidence" AS "OVO_Confidence" 
FROM tmp_20180516125716_codegen_ab4t85_kernagg_b1 AS "KernAgg_B1" UNION ALL SELECT "KernAgg_B2"."KEY" AS "KEY", "KernAgg_B2"."OVO_Class1" AS "OVO_Class1", "KernAgg_B2"."OVO_Class2" AS "OVO_Class2", "KernAgg_B2"."OVO_Decision" AS "OVO_Decision", "KernAgg_B2"."OVO_Confidence" AS "OVO_Confidence" 
FROM tmp_20180516125716_codegen_rhaxe8_kernagg_b2 AS "KernAgg_B2") AS "KernAgg_EnsembleUnion"), 
"OVO_Votes" AS 
...
FROM tmp_20180516125716_codegen_jdflk2_kernagg AS "KernAgg"), 
