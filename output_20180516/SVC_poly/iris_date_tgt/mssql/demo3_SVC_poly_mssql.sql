...
-- Code For temporary table ##TMP_20180516125716_CODEGEN_0O6LYQ_KernAgg_B0 part 1. Create 


CREATE TABLE ##TMP_20180516125716_CODEGEN_0O6LYQ_KernAgg_B0 (
	[KEY] BIGINT NULL, 
...
-- Code For temporary table ##TMP_20180516125716_CODEGEN_0O6LYQ_KernAgg_B0 part 2. Populate
...
FROM [kernel_dp_1789-07-14T00:00:00.000000000_1789-08-14T00:00:00.000000000])
 INSERT INTO ##TMP_20180516125716_CODEGEN_0O6LYQ_KernAgg_B0 ([KEY], [OVO_Class1], [OVO_Class2], [OVO_Decision], [OVO_Confidence]) SELECT [KernAgg_B0].[KEY], [KernAgg_B0].[OVO_Class1], [KernAgg_B0].[OVO_Class2], [KernAgg_B0].[OVO_Decision], [KernAgg_B0].[OVO_Confidence] 
...
-- Code For temporary table ##TMP_20180516125716_CODEGEN_W8NMBC_KernAgg_B1 part 1. Create 


CREATE TABLE ##TMP_20180516125716_CODEGEN_W8NMBC_KernAgg_B1 (
	[KEY] BIGINT NULL, 
	[OVO_Class1] VARCHAR(max) COLLATE utf8 NULL, 
	[OVO_Class2] VARCHAR(max) COLLATE utf8 NULL, 
	[OVO_Decision] BIGINT NULL, 
...
-- Code For temporary table ##TMP_20180516125716_CODEGEN_W8NMBC_KernAgg_B1 part 2. Populate
...
FROM [kernel_dp_1789-07-14T00:00:00.000000000_1789-09-14T00:00:00.000000000])
 INSERT INTO ##TMP_20180516125716_CODEGEN_W8NMBC_KernAgg_B1 ([KEY], [OVO_Class1], [OVO_Class2], [OVO_Decision], [OVO_Confidence]) SELECT [KernAgg_B1].[KEY], [KernAgg_B1].[OVO_Class1], [KernAgg_B1].[OVO_Class2], [KernAgg_B1].[OVO_Decision], [KernAgg_B1].[OVO_Confidence] 
...
-- Code For temporary table ##TMP_20180516125716_CODEGEN_EEOJAK_KernAgg_B2 part 1. Create 


CREATE TABLE ##TMP_20180516125716_CODEGEN_EEOJAK_KernAgg_B2 (
	[KEY] BIGINT NULL, 
	[OVO_Class1] VARCHAR(max) COLLATE utf8 NULL, 
	[OVO_Class2] VARCHAR(max) COLLATE utf8 NULL, 
	[OVO_Decision] BIGINT NULL, 
...
-- Code For temporary table ##TMP_20180516125716_CODEGEN_EEOJAK_KernAgg_B2 part 2. Populate
...
FROM [kernel_dp_1789-08-14T00:00:00.000000000_1789-09-14T00:00:00.000000000])
 INSERT INTO ##TMP_20180516125716_CODEGEN_EEOJAK_KernAgg_B2 ([KEY], [OVO_Class1], [OVO_Class2], [OVO_Decision], [OVO_Confidence]) SELECT [KernAgg_B2].[KEY], [KernAgg_B2].[OVO_Class1], [KernAgg_B2].[OVO_Class2], [KernAgg_B2].[OVO_Decision], [KernAgg_B2].[OVO_Confidence] 
...
-- Code For temporary table ##TMP_20180516125716_CODEGEN_3DIYWS_KernAgg part 1. Create 


CREATE TABLE ##TMP_20180516125716_CODEGEN_3DIYWS_KernAgg (
	[KEY] BIGINT NULL, 
...
-- Code For temporary table ##TMP_20180516125716_CODEGEN_3DIYWS_KernAgg part 2. Populate
...
FROM ##TMP_20180516125716_CODEGEN_0O6LYQ_KernAgg_B0 AS [KernAgg_B0] UNION ALL SELECT [KernAgg_B1].[KEY] AS [KEY], [KernAgg_B1].[OVO_Class1] AS [OVO_Class1], [KernAgg_B1].[OVO_Class2] AS [OVO_Class2], [KernAgg_B1].[OVO_Decision] AS [OVO_Decision], [KernAgg_B1].[OVO_Confidence] AS [OVO_Confidence] 
FROM ##TMP_20180516125716_CODEGEN_W8NMBC_KernAgg_B1 AS [KernAgg_B1] UNION ALL SELECT [KernAgg_B2].[KEY] AS [KEY], [KernAgg_B2].[OVO_Class1] AS [OVO_Class1], [KernAgg_B2].[OVO_Class2] AS [OVO_Class2], [KernAgg_B2].[OVO_Decision] AS [OVO_Decision], [KernAgg_B2].[OVO_Confidence] AS [OVO_Confidence] 
FROM ##TMP_20180516125716_CODEGEN_EEOJAK_KernAgg_B2 AS [KernAgg_B2]) AS [KernAgg_EnsembleUnion]), 
[OVO_Votes] AS 
...
FROM ##TMP_20180516125716_CODEGEN_3DIYWS_KernAgg AS [KernAgg]), 
