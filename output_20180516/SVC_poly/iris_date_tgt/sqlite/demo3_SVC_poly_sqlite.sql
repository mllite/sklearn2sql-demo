...
-- Code For temporary table TMP_20180516125716_CODEGEN_DFCUBN_KernAgg_B0 part 1. Create 


CREATE TEMPORARY TABLE "TMP_20180516125716_CODEGEN_DFCUBN_KernAgg_B0" (
	"KEY" BIGINT, 
...
-- Code For temporary table TMP_20180516125716_CODEGEN_DFCUBN_KernAgg_B0 part 2. Populate
...
FROM "kernel_dp_1789-07-14T00:00:00.000000000_1789-08-14T00:00:00.000000000")
 INSERT INTO "TMP_20180516125716_CODEGEN_DFCUBN_KernAgg_B0" ("KEY", "OVO_Class1", "OVO_Class2", "OVO_Decision", "OVO_Confidence") SELECT "KernAgg_B0"."KEY", "KernAgg_B0"."OVO_Class1", "KernAgg_B0"."OVO_Class2", "KernAgg_B0"."OVO_Decision", "KernAgg_B0"."OVO_Confidence" 
...
-- Code For temporary table TMP_20180516125716_CODEGEN_GV29LJ_KernAgg_B1 part 1. Create 


CREATE TEMPORARY TABLE "TMP_20180516125716_CODEGEN_GV29LJ_KernAgg_B1" (
	"KEY" BIGINT, 
	"OVO_Class1" VARCHAR COLLATE "utf8", 
	"OVO_Class2" VARCHAR COLLATE "utf8", 
	"OVO_Decision" BIGINT, 
...
-- Code For temporary table TMP_20180516125716_CODEGEN_GV29LJ_KernAgg_B1 part 2. Populate
...
(SELECT "kernel_dp_1789-07-14T00:00:00.000000000_1789-09-14T00:00:00.000000000"."KEY" AS "KEY", '1789-07-14T00:00:00.000000000' AS "OVO_Class1", '1789-09-14T00:00:00.000000000' AS "OVO_Class2", CASE WHEN (-"kernel_dp_1789-07-14T00:00:00.000000000_1789-09-14T00:00:00.000000000".dot_product >= 0.0) THEN 1 ELSE 0 END AS "OVO_Decision", coalesce(-"kernel_dp_1789-07-14T00:00:00.000000000_1789-09-14T00:00:00.000000000".dot_product, 1.0 / (1.0 + exp(min(max(-100.0, -(-((-"kernel_dp_1789-07-14T00:00:00.000000000_1789-09-14T00:00:00.000000000".dot_product) * -1.9075428755349555 + -0.9161487225195705))), 100.0)))) AS "OVO_Confidence" 
FROM "kernel_dp_1789-07-14T00:00:00.000000000_1789-09-14T00:00:00.000000000")
 INSERT INTO "TMP_20180516125716_CODEGEN_GV29LJ_KernAgg_B1" ("KEY", "OVO_Class1", "OVO_Class2", "OVO_Decision", "OVO_Confidence") SELECT "KernAgg_B1"."KEY", "KernAgg_B1"."OVO_Class1", "KernAgg_B1"."OVO_Class2", "KernAgg_B1"."OVO_Decision", "KernAgg_B1"."OVO_Confidence" 
...
-- Code For temporary table TMP_20180516125716_CODEGEN_4GBPL6_KernAgg_B2 part 1. Create 


CREATE TEMPORARY TABLE "TMP_20180516125716_CODEGEN_4GBPL6_KernAgg_B2" (
	"KEY" BIGINT, 
	"OVO_Class1" VARCHAR COLLATE "utf8", 
	"OVO_Class2" VARCHAR COLLATE "utf8", 
	"OVO_Decision" BIGINT, 
...
-- Code For temporary table TMP_20180516125716_CODEGEN_4GBPL6_KernAgg_B2 part 2. Populate
...
FROM (SELECT full_join_data_sv_2."KEY" AS "KEY", sum(CAST(full_join_data_sv_2.dot_prod1 AS FLOAT)) + 15.184809946631539 AS dot_product 
...
FROM "kernel_dp_1789-08-14T00:00:00.000000000_1789-09-14T00:00:00.000000000")
 INSERT INTO "TMP_20180516125716_CODEGEN_4GBPL6_KernAgg_B2" ("KEY", "OVO_Class1", "OVO_Class2", "OVO_Decision", "OVO_Confidence") SELECT "KernAgg_B2"."KEY", "KernAgg_B2"."OVO_Class1", "KernAgg_B2"."OVO_Class2", "KernAgg_B2"."OVO_Decision", "KernAgg_B2"."OVO_Confidence" 
...
-- Code For temporary table TMP_20180516125716_CODEGEN_Y1R205_KernAgg part 1. Create 


CREATE TEMPORARY TABLE "TMP_20180516125716_CODEGEN_Y1R205_KernAgg" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20180516125716_CODEGEN_Y1R205_KernAgg part 2. Populate
...
FROM "TMP_20180516125716_CODEGEN_DFCUBN_KernAgg_B0" AS "KernAgg_B0" UNION ALL SELECT "KernAgg_B1"."KEY" AS "KEY", "KernAgg_B1"."OVO_Class1" AS "OVO_Class1", "KernAgg_B1"."OVO_Class2" AS "OVO_Class2", "KernAgg_B1"."OVO_Decision" AS "OVO_Decision", "KernAgg_B1"."OVO_Confidence" AS "OVO_Confidence" 
FROM "TMP_20180516125716_CODEGEN_GV29LJ_KernAgg_B1" AS "KernAgg_B1" UNION ALL SELECT "KernAgg_B2"."KEY" AS "KEY", "KernAgg_B2"."OVO_Class1" AS "OVO_Class1", "KernAgg_B2"."OVO_Class2" AS "OVO_Class2", "KernAgg_B2"."OVO_Decision" AS "OVO_Decision", "KernAgg_B2"."OVO_Confidence" AS "OVO_Confidence" 
FROM "TMP_20180516125716_CODEGEN_4GBPL6_KernAgg_B2" AS "KernAgg_B2") AS "KernAgg_EnsembleUnion"), 
"OVO_Votes" AS 
...
-- Code For temporary table TMP_20180516125716_CODEGEN_Y1R205_KernAgg part 3. Create Index 

CREATE INDEX "ix_TMP_20180516125716_CODEGEN_Y1R205_KernAgg_KEY" ON "TMP_20180516125716_CODEGEN_Y1R205_KernAgg" ("KEY")
...
FROM "TMP_20180516125716_CODEGEN_Y1R205_KernAgg" AS "KernAgg"), 
