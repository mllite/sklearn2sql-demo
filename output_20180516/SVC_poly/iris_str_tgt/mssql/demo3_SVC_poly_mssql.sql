...
-- Code For temporary table ##TMP_20180508190818_CODEGEN_C9F9WU_KernAgg_B0 part 1. Create 


CREATE TABLE ##TMP_20180508190818_CODEGEN_C9F9WU_KernAgg_B0 (
	[KEY] BIGINT NULL, 
...
-- Code For temporary table ##TMP_20180508190818_CODEGEN_C9F9WU_KernAgg_B0 part 2. Populate
...
FROM [kernel_dp_CLASS_1_CLASS_2])
 INSERT INTO ##TMP_20180508190818_CODEGEN_C9F9WU_KernAgg_B0 ([KEY], [OVO_Class1], [OVO_Class2], [OVO_Decision], [OVO_Confidence]) SELECT [KernAgg_B0].[KEY], [KernAgg_B0].[OVO_Class1], [KernAgg_B0].[OVO_Class2], [KernAgg_B0].[OVO_Decision], [KernAgg_B0].[OVO_Confidence] 
...
-- Code For temporary table ##TMP_20180508190818_CODEGEN_JUYMQZ_KernAgg_Union part 1. Create 


CREATE TABLE ##TMP_20180508190818_CODEGEN_JUYMQZ_KernAgg_Union (
	[KEY] BIGINT NULL, 
	[OVO_Class1] VARCHAR(max) COLLATE utf8 NULL, 
	[OVO_Class2] VARCHAR(max) COLLATE utf8 NULL, 
	[OVO_Decision] BIGINT NULL, 
...
-- Code For temporary table ##TMP_20180508190818_CODEGEN_JUYMQZ_KernAgg_Union part 2. Populate

INSERT INTO ##TMP_20180508190818_CODEGEN_JUYMQZ_KernAgg_Union ([KEY], [OVO_Class1], [OVO_Class2], [OVO_Decision], [OVO_Confidence]) SELECT [KernAgg_Union].[KEY], [KernAgg_Union].[OVO_Class1], [KernAgg_Union].[OVO_Class2], [KernAgg_Union].[OVO_Decision], [KernAgg_Union].[OVO_Confidence] 
...
FROM ##TMP_20180508190818_CODEGEN_C9F9WU_KernAgg_B0 AS [KernAgg_B0]) AS [KernAgg_EnsembleUnion]) AS [KernAgg_Union]

-- Code For temporary table ##TMP_20180508190818_CODEGEN_SWPC0S_KernAgg part 1. Create 


CREATE TABLE ##TMP_20180508190818_CODEGEN_SWPC0S_KernAgg (
	[KEY] BIGINT NULL, 
...
-- Code For temporary table ##TMP_20180508190818_CODEGEN_SWPC0S_KernAgg part 2. Populate
...
FROM ##TMP_20180508190818_CODEGEN_JUYMQZ_KernAgg_Union AS [KernAgg_Union] GROUP BY [KernAgg_Union].[KEY]) AS [Votes_Sel]), 
[OVO_SumConf_CTE] AS 
...
FROM ##TMP_20180508190818_CODEGEN_SWPC0S_KernAgg AS [KernAgg]), 
