...
-- Code For temporary table tmp_20180602162037_8z0_kernagg_b0 part 1. Create 


CREATE TEMPORARY TABLE tmp_20180602162037_8z0_kernagg_b0 (
	"KEY" BIGINT, 
	"OVO_Class1" CLOB, 
	"OVO_Class2" CLOB, 
	"OVO_Decision" BIGINT, 
...
-- Code For temporary table tmp_20180602162037_8z0_kernagg_b0 part 2. Populate

INSERT INTO tmp_20180602162037_8z0_kernagg_b0 ("KEY", "OVO_Class1", "OVO_Class2", "OVO_Decision", "OVO_Conf") SELECT "U"."KEY", "U"."OVO_Class1", "U"."OVO_Class2", "U"."OVO_Decision", "U"."OVO_Conf" 
...
-- Code For temporary table tmp_20180602162037_9uq_kernagg_b1 part 1. Create 


CREATE TEMPORARY TABLE tmp_20180602162037_9uq_kernagg_b1 (
	"KEY" BIGINT, 
	"OVO_Class1" CLOB, 
	"OVO_Class2" CLOB, 
	"OVO_Decision" BIGINT, 
...
-- Code For temporary table tmp_20180602162037_9uq_kernagg_b1 part 2. Populate

INSERT INTO tmp_20180602162037_9uq_kernagg_b1 ("KEY", "OVO_Class1", "OVO_Class2", "OVO_Decision", "OVO_Conf") SELECT "U"."KEY", "U"."OVO_Class1", "U"."OVO_Class2", "U"."OVO_Decision", "U"."OVO_Conf" 
FROM (WITH kernel_input AS 
(SELECT "ADS"."KEY" AS "KEY", CAST("ADS"."Feature_0" AS DOUBLE) AS "Feature_0", CAST("ADS"."Feature_1" AS DOUBLE) AS "Feature_1", CAST("ADS"."Feature_2" AS DOUBLE) AS "Feature_2", CAST("ADS"."Feature_3" AS DOUBLE) AS "Feature_3", CAST("ADS"."TGT" AS DOUBLE) AS "TGT" 
FROM iris_str_tgt AS "ADS"), 
...
-- Code For temporary table tmp_20180602162037_g7y_kernagg_b2 part 1. Create 


CREATE TEMPORARY TABLE tmp_20180602162037_g7y_kernagg_b2 (
	"KEY" BIGINT, 
	"OVO_Class1" CLOB, 
	"OVO_Class2" CLOB, 
	"OVO_Decision" BIGINT, 
...
-- Code For temporary table tmp_20180602162037_g7y_kernagg_b2 part 2. Populate

INSERT INTO tmp_20180602162037_g7y_kernagg_b2 ("KEY", "OVO_Class1", "OVO_Class2", "OVO_Decision", "OVO_Conf") SELECT "U"."KEY", "U"."OVO_Class1", "U"."OVO_Class2", "U"."OVO_Decision", "U"."OVO_Conf" 
FROM (WITH kernel_input AS 
(SELECT "ADS"."KEY" AS "KEY", CAST("ADS"."Feature_0" AS DOUBLE) AS "Feature_0", CAST("ADS"."Feature_1" AS DOUBLE) AS "Feature_1", CAST("ADS"."Feature_2" AS DOUBLE) AS "Feature_2", CAST("ADS"."Feature_3" AS DOUBLE) AS "Feature_3", CAST("ADS"."TGT" AS DOUBLE) AS "TGT" 
FROM iris_str_tgt AS "ADS"), 
...
-- Code For temporary table tmp_20180602162037_hy7_kernagg_agg part 1. Create 


CREATE TEMPORARY TABLE tmp_20180602162037_hy7_kernagg_agg (
	"KEY" BIGINT, 
...
-- Code For temporary table tmp_20180602162037_hy7_kernagg_agg part 2. Populate

INSERT INTO tmp_20180602162037_hy7_kernagg_agg ("KEY", "OVO_Vote_CLASS_0", "OVO_SumConfidence_CLASS_0", "OVO_Vote_CLASS_1", "OVO_SumConfidence_CLASS_1", "OVO_Vote_CLASS_2", "OVO_SumConfidence_CLASS_2", max_abs_confidence, "OVO_Scale", "Score_CLASS_0", "Score_CLASS_1", "Score_CLASS_2") SELECT "U"."KEY", "U"."OVO_Vote_CLASS_0", "U"."OVO_SumConfidence_CLASS_0", "U"."OVO_Vote_CLASS_1", "U"."OVO_SumConfidence_CLASS_1", "U"."OVO_Vote_CLASS_2", "U"."OVO_SumConfidence_CLASS_2", "U".max_abs_confidence, "U"."OVO_Scale", "U"."Score_CLASS_0", "U"."Score_CLASS_1", "U"."Score_CLASS_2" 
...
FROM tmp_20180602162037_8z0_kernagg_b0 AS "KernAgg_B0" UNION ALL SELECT "KernAgg_B1"."KEY" AS "KEY", "KernAgg_B1"."OVO_Class1" AS "OVO_Class1", "KernAgg_B1"."OVO_Class2" AS "OVO_Class2", "KernAgg_B1"."OVO_Decision" AS "OVO_Decision", "KernAgg_B1"."OVO_Conf" AS "OVO_Conf" 
FROM tmp_20180602162037_9uq_kernagg_b1 AS "KernAgg_B1" UNION ALL SELECT "KernAgg_B2"."KEY" AS "KEY", "KernAgg_B2"."OVO_Class1" AS "OVO_Class1", "KernAgg_B2"."OVO_Class2" AS "OVO_Class2", "KernAgg_B2"."OVO_Decision" AS "OVO_Decision", "KernAgg_B2"."OVO_Conf" AS "OVO_Conf" 
FROM tmp_20180602162037_g7y_kernagg_b2 AS "KernAgg_B2") AS "KernAgg_EnsembleUnion"), 
"OVO_Votes" AS 
...
FROM tmp_20180602162037_hy7_kernagg_agg AS "KernAgg_agg"), 
