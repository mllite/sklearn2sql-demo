...
-- Code For temporary table tmp_20180508190818_codegen_cvm2s5_kernagg_b0 part 1. Create 


CREATE TEMPORARY TABLE tmp_20180508190818_codegen_cvm2s5_kernagg_b0 (
	"KEY" BIGINT, 
	"OVO_Class1" CLOB, 
	"OVO_Class2" CLOB, 
	"OVO_Decision" BIGINT, 
...
-- Code For temporary table tmp_20180508190818_codegen_cvm2s5_kernagg_b0 part 2. Populate

INSERT INTO tmp_20180508190818_codegen_cvm2s5_kernagg_b0 ("KEY", "OVO_Class1", "OVO_Class2", "OVO_Decision", "OVO_Confidence") SELECT "U"."KEY", "U"."OVO_Class1", "U"."OVO_Class2", "U"."OVO_Decision", "U"."OVO_Confidence" 
...
(SELECT "kernel_dp_CLASS_0_CLASS_2"."KEY" AS "KEY", 'CLASS_0' AS "OVO_Class1", 'CLASS_2' AS "OVO_Class2", CASE WHEN (-"kernel_dp_CLASS_0_CLASS_2".dot_product >= 0.0) THEN 1 ELSE 0 END AS "OVO_Decision", coalesce(-"kernel_dp_CLASS_0_CLASS_2".dot_product, 1.0 / (1.0 + exp(CASE WHEN (CASE WHEN (-100.0 <= -(-((-"kernel_dp_CLASS_0_CLASS_2".dot_product) * -1.9681248475679565 + -0.7379798661053221))) THEN -(-((-"kernel_dp_CLASS_0_CLASS_2".dot_product) * -1.9681248475679565 + -0.7379798661053221)) ELSE -100.0 END <= 100.0) THEN CASE WHEN (-100.0 <= -(-((-"kernel_dp_CLASS_0_CLASS_2".dot_product) * -1.9681248475679565 + -0.7379798661053221))) THEN -(-((-"kernel_dp_CLASS_0_CLASS_2".dot_product) * -1.9681248475679565 + -0.7379798661053221)) ELSE -100.0 END ELSE 100.0 END))) AS "OVO_Confidence" 
...
(SELECT "kernel_dp_CLASS_1_CLASS_2"."KEY" AS "KEY", 'CLASS_1' AS "OVO_Class1", 'CLASS_2' AS "OVO_Class2", CASE WHEN (-"kernel_dp_CLASS_1_CLASS_2".dot_product >= 0.0) THEN 1 ELSE 0 END AS "OVO_Decision", coalesce(-"kernel_dp_CLASS_1_CLASS_2".dot_product, 1.0 / (1.0 + exp(CASE WHEN (CASE WHEN (-100.0 <= -(-((-"kernel_dp_CLASS_1_CLASS_2".dot_product) * -0.32769941369070227 + 0.16533429287285586))) THEN -(-((-"kernel_dp_CLASS_1_CLASS_2".dot_product) * -0.32769941369070227 + 0.16533429287285586)) ELSE -100.0 END <= 100.0) THEN CASE WHEN (-100.0 <= -(-((-"kernel_dp_CLASS_1_CLASS_2".dot_product) * -0.32769941369070227 + 0.16533429287285586))) THEN -(-((-"kernel_dp_CLASS_1_CLASS_2".dot_product) * -0.32769941369070227 + 0.16533429287285586)) ELSE -100.0 END ELSE 100.0 END))) AS "OVO_Confidence" 
...
-- Code For temporary table tmp_20180508190818_codegen_4vmpzp_kernagg_union part 1. Create 


CREATE TEMPORARY TABLE tmp_20180508190818_codegen_4vmpzp_kernagg_union (
	"KEY" BIGINT, 
	"OVO_Class1" CLOB, 
	"OVO_Class2" CLOB, 
	"OVO_Decision" BIGINT, 
...
-- Code For temporary table tmp_20180508190818_codegen_4vmpzp_kernagg_union part 2. Populate

INSERT INTO tmp_20180508190818_codegen_4vmpzp_kernagg_union ("KEY", "OVO_Class1", "OVO_Class2", "OVO_Decision", "OVO_Confidence") SELECT "U"."KEY", "U"."OVO_Class1", "U"."OVO_Class2", "U"."OVO_Decision", "U"."OVO_Confidence" 
...
FROM tmp_20180508190818_codegen_cvm2s5_kernagg_b0 AS "KernAgg_B0") AS "KernAgg_EnsembleUnion") AS "KernAgg_Union") AS "U"

-- Code For temporary table tmp_20180508190818_codegen_vd6twj_kernagg part 1. Create 


CREATE TEMPORARY TABLE tmp_20180508190818_codegen_vd6twj_kernagg (
	"KEY" BIGINT, 
...
-- Code For temporary table tmp_20180508190818_codegen_vd6twj_kernagg part 2. Populate

INSERT INTO tmp_20180508190818_codegen_vd6twj_kernagg ("KEY", "OVO_Vote_CLASS_0", "OVO_SumConfidence_CLASS_0", "OVO_Vote_CLASS_1", "OVO_SumConfidence_CLASS_1", "OVO_Vote_CLASS_2", "OVO_SumConfidence_CLASS_2", max_abs_confidence, "OVO_Scale", "Score_CLASS_0", "Score_CLASS_1", "Score_CLASS_2") SELECT "U"."KEY", "U"."OVO_Vote_CLASS_0", "U"."OVO_SumConfidence_CLASS_0", "U"."OVO_Vote_CLASS_1", "U"."OVO_SumConfidence_CLASS_1", "U"."OVO_Vote_CLASS_2", "U"."OVO_SumConfidence_CLASS_2", "U".max_abs_confidence, "U"."OVO_Scale", "U"."Score_CLASS_0", "U"."Score_CLASS_1", "U"."Score_CLASS_2" 
...
FROM tmp_20180508190818_codegen_4vmpzp_kernagg_union AS "KernAgg_Union" GROUP BY "KernAgg_Union"."KEY") AS "Votes_Sel"), 
"OVO_SumConf_CTE" AS 
...
FROM tmp_20180508190818_codegen_vd6twj_kernagg AS "KernAgg"), 
