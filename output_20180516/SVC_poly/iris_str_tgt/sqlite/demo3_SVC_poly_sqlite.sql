...
-- Code For temporary table TMP_20180516133208_CODEGEN_FWC10Y_KernAgg_B0 part 1. Create 


CREATE TEMPORARY TABLE "TMP_20180516133208_CODEGEN_FWC10Y_KernAgg_B0" (
	"KEY" BIGINT, 
...
-- Code For temporary table TMP_20180516133208_CODEGEN_FWC10Y_KernAgg_B0 part 2. Populate
...
-- Code For temporary table TMP_20180516133208_CODEGEN_BLS4TU_KernAgg_B1 part 1. Create 


CREATE TEMPORARY TABLE "TMP_20180516133208_CODEGEN_BLS4TU_KernAgg_B1" (
	"KEY" BIGINT, 
	"OVO_Class1" VARCHAR COLLATE "utf8", 
	"OVO_Class2" VARCHAR COLLATE "utf8", 
	"OVO_Decision" BIGINT, 
...
-- Code For temporary table TMP_20180516133208_CODEGEN_BLS4TU_KernAgg_B1 part 2. Populate
...
(SELECT "kernel_dp_CLASS_0_CLASS_2"."KEY" AS "KEY", 'CLASS_0' AS "OVO_Class1", 'CLASS_2' AS "OVO_Class2", CASE WHEN (-"kernel_dp_CLASS_0_CLASS_2".dot_product >= 0.0) THEN 1 ELSE 0 END AS "OVO_Decision", coalesce(-"kernel_dp_CLASS_0_CLASS_2".dot_product, 1.0 / (1.0 + exp(min(max(-100.0, -(-((-"kernel_dp_CLASS_0_CLASS_2".dot_product) * -1.9810700291801813 + -0.7639352166716962))), 100.0)))) AS "OVO_Confidence" 
FROM "kernel_dp_CLASS_0_CLASS_2")
 INSERT INTO "TMP_20180516133208_CODEGEN_BLS4TU_KernAgg_B1" ("KEY", "OVO_Class1", "OVO_Class2", "OVO_Decision", "OVO_Confidence") SELECT "KernAgg_B1"."KEY", "KernAgg_B1"."OVO_Class1", "KernAgg_B1"."OVO_Class2", "KernAgg_B1"."OVO_Decision", "KernAgg_B1"."OVO_Confidence" 
...
-- Code For temporary table TMP_20180516133208_CODEGEN_JKXY4K_KernAgg_B2 part 1. Create 


CREATE TEMPORARY TABLE "TMP_20180516133208_CODEGEN_JKXY4K_KernAgg_B2" (
	"KEY" BIGINT, 
	"OVO_Class1" VARCHAR COLLATE "utf8", 
	"OVO_Class2" VARCHAR COLLATE "utf8", 
	"OVO_Decision" BIGINT, 
...
-- Code For temporary table TMP_20180516133208_CODEGEN_JKXY4K_KernAgg_B2 part 2. Populate
...
(SELECT "kernel_dp_CLASS_1_CLASS_2"."KEY" AS "KEY", 'CLASS_1' AS "OVO_Class1", 'CLASS_2' AS "OVO_Class2", CASE WHEN (-"kernel_dp_CLASS_1_CLASS_2".dot_product >= 0.0) THEN 1 ELSE 0 END AS "OVO_Decision", coalesce(-"kernel_dp_CLASS_1_CLASS_2".dot_product, 1.0 / (1.0 + exp(min(max(-100.0, -(-((-"kernel_dp_CLASS_1_CLASS_2".dot_product) * -0.4180680570784987 + 0.09998696961310848))), 100.0)))) AS "OVO_Confidence" 
FROM "kernel_dp_CLASS_1_CLASS_2")
 INSERT INTO "TMP_20180516133208_CODEGEN_JKXY4K_KernAgg_B2" ("KEY", "OVO_Class1", "OVO_Class2", "OVO_Decision", "OVO_Confidence") SELECT "KernAgg_B2"."KEY", "KernAgg_B2"."OVO_Class1", "KernAgg_B2"."OVO_Class2", "KernAgg_B2"."OVO_Decision", "KernAgg_B2"."OVO_Confidence" 
...
-- Code For temporary table TMP_20180516133208_CODEGEN_O868NE_KernAgg part 1. Create 


CREATE TEMPORARY TABLE "TMP_20180516133208_CODEGEN_O868NE_KernAgg" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20180516133208_CODEGEN_O868NE_KernAgg part 2. Populate
...
FROM "TMP_20180516133208_CODEGEN_FWC10Y_KernAgg_B0" AS "KernAgg_B0" UNION ALL SELECT "KernAgg_B1"."KEY" AS "KEY", "KernAgg_B1"."OVO_Class1" AS "OVO_Class1", "KernAgg_B1"."OVO_Class2" AS "OVO_Class2", "KernAgg_B1"."OVO_Decision" AS "OVO_Decision", "KernAgg_B1"."OVO_Confidence" AS "OVO_Confidence" 
FROM "TMP_20180516133208_CODEGEN_BLS4TU_KernAgg_B1" AS "KernAgg_B1" UNION ALL SELECT "KernAgg_B2"."KEY" AS "KEY", "KernAgg_B2"."OVO_Class1" AS "OVO_Class1", "KernAgg_B2"."OVO_Class2" AS "OVO_Class2", "KernAgg_B2"."OVO_Decision" AS "OVO_Decision", "KernAgg_B2"."OVO_Confidence" AS "OVO_Confidence" 
FROM "TMP_20180516133208_CODEGEN_JKXY4K_KernAgg_B2" AS "KernAgg_B2") AS "KernAgg_EnsembleUnion"), 
"OVO_Votes" AS 
...
-- Code For temporary table TMP_20180516133208_CODEGEN_O868NE_KernAgg part 3. Create Index 

CREATE INDEX "ix_TMP_20180516133208_CODEGEN_O868NE_KernAgg_KEY" ON "TMP_20180516133208_CODEGEN_O868NE_KernAgg" ("KEY")
...
FROM "TMP_20180516133208_CODEGEN_O868NE_KernAgg" AS "KernAgg"), 
