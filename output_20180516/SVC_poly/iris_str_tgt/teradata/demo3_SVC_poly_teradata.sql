...
-- Code For temporary table tmp_20180516133208_codegen_wpvg2m_kernagg_b0 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180516133208_codegen_wpvg2m_kernagg_b0  (
	"KEY" BIGINT, 
...
-- Code For temporary table tmp_20180516133208_codegen_wpvg2m_kernagg_b0 part 2. Populate

INSERT INTO tmp_20180516133208_codegen_wpvg2m_kernagg_b0 ("KEY", "OVO_Class1", "OVO_Class2", "OVO_Decision", "OVO_Confidence") SELECT "U"."KEY", "U"."OVO_Class1", "U"."OVO_Class2", "U"."OVO_Decision", "U"."OVO_Confidence" 
...
FROM (SELECT kernel_input."KEY" AS "KEY", "SV_data_CLASS_0_CLASS_1".dual_coeff * power(CAST(0.25 AS DOUBLE PRECISION) * (kernel_input."Feature_0" * "SV_data_CLASS_0_CLASS_1".sv_0 + kernel_input."Feature_1" * "SV_data_CLASS_0_CLASS_1".sv_1 + kernel_input."Feature_2" * "SV_data_CLASS_0_CLASS_1".sv_2 + kernel_input."Feature_3" * "SV_data_CLASS_0_CLASS_1".sv_3) + CAST(0.0 AS DOUBLE PRECISION), 3) AS dot_prod1 
...
-- Code For temporary table tmp_20180516133208_codegen_hiuh0r_kernagg_b1 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180516133208_codegen_hiuh0r_kernagg_b1  (
	"KEY" BIGINT, 
	"OVO_Class1" LONG VARCHAR, 
	"OVO_Class2" LONG VARCHAR, 
	"OVO_Decision" BIGINT, 
...
-- Code For temporary table tmp_20180516133208_codegen_hiuh0r_kernagg_b1 part 2. Populate

INSERT INTO tmp_20180516133208_codegen_hiuh0r_kernagg_b1 ("KEY", "OVO_Class1", "OVO_Class2", "OVO_Decision", "OVO_Confidence") SELECT "U"."KEY", "U"."OVO_Class1", "U"."OVO_Class2", "U"."OVO_Decision", "U"."OVO_Confidence" 
FROM (WITH kernel_input AS 
(SELECT "ADS"."KEY" AS "KEY", CAST("ADS"."Feature_0" AS DOUBLE PRECISION) AS "Feature_0", CAST("ADS"."Feature_1" AS DOUBLE PRECISION) AS "Feature_1", CAST("ADS"."Feature_2" AS DOUBLE PRECISION) AS "Feature_2", CAST("ADS"."Feature_3" AS DOUBLE PRECISION) AS "Feature_3", CAST("ADS"."TGT" AS DOUBLE PRECISION) AS "TGT" 
FROM iris_str_tgt AS "ADS"), 
dummy_cte AS 
...
FROM (SELECT kernel_input."KEY" AS "KEY", "SV_data_CLASS_0_CLASS_2".dual_coeff * power(CAST(0.25 AS DOUBLE PRECISION) * (kernel_input."Feature_0" * "SV_data_CLASS_0_CLASS_2".sv_0 + kernel_input."Feature_1" * "SV_data_CLASS_0_CLASS_2".sv_1 + kernel_input."Feature_2" * "SV_data_CLASS_0_CLASS_2".sv_2 + kernel_input."Feature_3" * "SV_data_CLASS_0_CLASS_2".sv_3) + CAST(0.0 AS DOUBLE PRECISION), 3) AS dot_prod1 
...
-- Code For temporary table tmp_20180516133208_codegen_8j0pth_kernagg_b2 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180516133208_codegen_8j0pth_kernagg_b2  (
	"KEY" BIGINT, 
	"OVO_Class1" LONG VARCHAR, 
	"OVO_Class2" LONG VARCHAR, 
	"OVO_Decision" BIGINT, 
...
-- Code For temporary table tmp_20180516133208_codegen_8j0pth_kernagg_b2 part 2. Populate

INSERT INTO tmp_20180516133208_codegen_8j0pth_kernagg_b2 ("KEY", "OVO_Class1", "OVO_Class2", "OVO_Decision", "OVO_Confidence") SELECT "U"."KEY", "U"."OVO_Class1", "U"."OVO_Class2", "U"."OVO_Decision", "U"."OVO_Confidence" 
FROM (WITH kernel_input AS 
(SELECT "ADS"."KEY" AS "KEY", CAST("ADS"."Feature_0" AS DOUBLE PRECISION) AS "Feature_0", CAST("ADS"."Feature_1" AS DOUBLE PRECISION) AS "Feature_1", CAST("ADS"."Feature_2" AS DOUBLE PRECISION) AS "Feature_2", CAST("ADS"."Feature_3" AS DOUBLE PRECISION) AS "Feature_3", CAST("ADS"."TGT" AS DOUBLE PRECISION) AS "TGT" 
FROM iris_str_tgt AS "ADS"), 
dummy_cte AS 
...
FROM (SELECT kernel_input."KEY" AS "KEY", "SV_data_CLASS_1_CLASS_2".dual_coeff * power(CAST(0.25 AS DOUBLE PRECISION) * (kernel_input."Feature_0" * "SV_data_CLASS_1_CLASS_2".sv_0 + kernel_input."Feature_1" * "SV_data_CLASS_1_CLASS_2".sv_1 + kernel_input."Feature_2" * "SV_data_CLASS_1_CLASS_2".sv_2 + kernel_input."Feature_3" * "SV_data_CLASS_1_CLASS_2".sv_3) + CAST(0.0 AS DOUBLE PRECISION), 3) AS dot_prod1 
...
-- Code For temporary table tmp_20180516133208_codegen_c13off_kernagg part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180516133208_codegen_c13off_kernagg  (
	"KEY" BIGINT, 
...
-- Code For temporary table tmp_20180516133208_codegen_c13off_kernagg part 2. Populate

INSERT INTO tmp_20180516133208_codegen_c13off_kernagg ("KEY", "OVO_Vote_CLASS_0", "OVO_SumConfidence_CLASS_0", "OVO_Vote_CLASS_1", "OVO_SumConfidence_CLASS_1", "OVO_Vote_CLASS_2", "OVO_SumConfidence_CLASS_2", max_abs_confidence, "OVO_Scale", "Score_CLASS_0", "Score_CLASS_1", "Score_CLASS_2") SELECT "U"."KEY", "U"."OVO_Vote_CLASS_0", "U"."OVO_SumConfidence_CLASS_0", "U"."OVO_Vote_CLASS_1", "U"."OVO_SumConfidence_CLASS_1", "U"."OVO_Vote_CLASS_2", "U"."OVO_SumConfidence_CLASS_2", "U".max_abs_confidence, "U"."OVO_Scale", "U"."Score_CLASS_0", "U"."Score_CLASS_1", "U"."Score_CLASS_2" 
...
FROM tmp_20180516133208_codegen_wpvg2m_kernagg_b0 AS "KernAgg_B0" UNION ALL SELECT "KernAgg_B1"."KEY" AS "KEY", "KernAgg_B1"."OVO_Class1" AS "OVO_Class1", "KernAgg_B1"."OVO_Class2" AS "OVO_Class2", "KernAgg_B1"."OVO_Decision" AS "OVO_Decision", "KernAgg_B1"."OVO_Confidence" AS "OVO_Confidence" 
FROM tmp_20180516133208_codegen_hiuh0r_kernagg_b1 AS "KernAgg_B1" UNION ALL SELECT "KernAgg_B2"."KEY" AS "KEY", "KernAgg_B2"."OVO_Class1" AS "OVO_Class1", "KernAgg_B2"."OVO_Class2" AS "OVO_Class2", "KernAgg_B2"."OVO_Decision" AS "OVO_Decision", "KernAgg_B2"."OVO_Confidence" AS "OVO_Confidence" 
FROM tmp_20180516133208_codegen_8j0pth_kernagg_b2 AS "KernAgg_B2") AS "KernAgg_EnsembleUnion"), 
"OVO_Votes" AS 
...
FROM tmp_20180516133208_codegen_c13off_kernagg AS "KernAgg"), 
