...
-- Code For temporary table tmp_20180602162042_icu_kernagg_b0 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180602162042_icu_kernagg_b0 (
	"KEY" BIGINT, 
...
-- Code For temporary table tmp_20180602162042_icu_kernagg_b0 part 2. Populate

INSERT INTO tmp_20180602162042_icu_kernagg_b0 WITH kernel_input AS 
...
-- Code For temporary table tmp_20180602162042_5g9_kernagg_b1 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180602162042_5g9_kernagg_b1 (
	"KEY" BIGINT, 
	"OVO_Class1" VARCHAR(None), 
	"OVO_Class2" VARCHAR(None), 
	"OVO_Decision" BIGINT, 
...
-- Code For temporary table tmp_20180602162042_5g9_kernagg_b1 part 2. Populate

INSERT INTO tmp_20180602162042_5g9_kernagg_b1 WITH kernel_input AS 
(SELECT "ADS"."KEY" AS "KEY", CAST("ADS"."Feature_0" AS DOUBLE) AS "Feature_0", CAST("ADS"."Feature_1" AS DOUBLE) AS "Feature_1", CAST("ADS"."Feature_2" AS DOUBLE) AS "Feature_2", CAST("ADS"."Feature_3" AS DOUBLE) AS "Feature_3", CAST("ADS"."TGT" AS DOUBLE) AS "TGT" 
FROM "IRIS_STR_TGT" AS "ADS"), 
...
-- Code For temporary table tmp_20180602162042_81e_kernagg_b2 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180602162042_81e_kernagg_b2 (
	"KEY" BIGINT, 
	"OVO_Class1" VARCHAR(None), 
	"OVO_Class2" VARCHAR(None), 
	"OVO_Decision" BIGINT, 
...
-- Code For temporary table tmp_20180602162042_81e_kernagg_b2 part 2. Populate

INSERT INTO tmp_20180602162042_81e_kernagg_b2 WITH kernel_input AS 
(SELECT "ADS"."KEY" AS "KEY", CAST("ADS"."Feature_0" AS DOUBLE) AS "Feature_0", CAST("ADS"."Feature_1" AS DOUBLE) AS "Feature_1", CAST("ADS"."Feature_2" AS DOUBLE) AS "Feature_2", CAST("ADS"."Feature_3" AS DOUBLE) AS "Feature_3", CAST("ADS"."TGT" AS DOUBLE) AS "TGT" 
FROM "IRIS_STR_TGT" AS "ADS"), 
...
-- Code For temporary table tmp_20180602162042_cb4_kernagg_agg part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180602162042_cb4_kernagg_agg (
	"KEY" BIGINT, 
...
-- Code For temporary table tmp_20180602162042_cb4_kernagg_agg part 2. Populate

INSERT INTO tmp_20180602162042_cb4_kernagg_agg WITH "KernAgg_Union" AS 
...
FROM tmp_20180602162042_icu_kernagg_b0 AS "KernAgg_B0" UNION ALL SELECT "KernAgg_B1"."KEY" AS "KEY", "KernAgg_B1"."OVO_Class1" AS "OVO_Class1", "KernAgg_B1"."OVO_Class2" AS "OVO_Class2", "KernAgg_B1"."OVO_Decision" AS "OVO_Decision", "KernAgg_B1"."OVO_Conf" AS "OVO_Conf" 
FROM tmp_20180602162042_5g9_kernagg_b1 AS "KernAgg_B1" UNION ALL SELECT "KernAgg_B2"."KEY" AS "KEY", "KernAgg_B2"."OVO_Class1" AS "OVO_Class1", "KernAgg_B2"."OVO_Class2" AS "OVO_Class2", "KernAgg_B2"."OVO_Decision" AS "OVO_Decision", "KernAgg_B2"."OVO_Conf" AS "OVO_Conf" 
FROM tmp_20180602162042_81e_kernagg_b2 AS "KernAgg_B2") AS "KernAgg_EnsembleUnion"), 
"OVO_Votes" AS 
...
FROM tmp_20180602162042_cb4_kernagg_agg AS "KernAgg_agg"), 
