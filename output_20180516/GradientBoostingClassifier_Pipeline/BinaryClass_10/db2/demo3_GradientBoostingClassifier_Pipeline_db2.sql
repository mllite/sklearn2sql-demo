...
-- Code For temporary table tmp_20180508175838_codegen_ba98e3_ads_imp_1_out part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180508175838_codegen_ba98e3_ads_imp_1_out (
	"KEY" BIGINT, 
	impter_2 DOUBLE, 
	impter_3 DOUBLE, 
	impter_4 DOUBLE, 
...
-- Code For temporary table tmp_20180508175838_codegen_ba98e3_ads_imp_1_out part 2. Populate

INSERT INTO tmp_20180508175838_codegen_ba98e3_ads_imp_1_out SELECT "ADS_imp_1_OUT"."KEY", "ADS_imp_1_OUT".impter_2, "ADS_imp_1_OUT".impter_3, "ADS_imp_1_OUT".impter_4, "ADS_imp_1_OUT".impter_5, "ADS_imp_1_OUT".impter_6, "ADS_imp_1_OUT".impter_7, "ADS_imp_1_OUT".impter_8, "ADS_imp_1_OUT".impter_9, "ADS_imp_1_OUT".impter_10, "ADS_imp_1_OUT".impter_11 
...
-- Code For temporary table tmp_20180508175838_codegen_p8k4ni_ads_sca_2_out part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180508175838_codegen_p8k4ni_ads_sca_2_out (
	"KEY" BIGINT, 
	scaler_2 DOUBLE, 
	scaler_3 DOUBLE, 
	scaler_4 DOUBLE, 
...
-- Code For temporary table tmp_20180508175838_codegen_p8k4ni_ads_sca_2_out part 2. Populate

INSERT INTO tmp_20180508175838_codegen_p8k4ni_ads_sca_2_out SELECT "ADS_sca_2_OUT"."KEY", "ADS_sca_2_OUT".scaler_2, "ADS_sca_2_OUT".scaler_3, "ADS_sca_2_OUT".scaler_4, "ADS_sca_2_OUT".scaler_5, "ADS_sca_2_OUT".scaler_6, "ADS_sca_2_OUT".scaler_7, "ADS_sca_2_OUT".scaler_8, "ADS_sca_2_OUT".scaler_9, "ADS_sca_2_OUT".scaler_10, "ADS_sca_2_OUT".scaler_11 
...
FROM tmp_20180508175838_codegen_ba98e3_ads_imp_1_out AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT"

-- Code For temporary table tmp_20180508175839_codegen_7ebzmm_gb_b0 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180508175839_codegen_7ebzmm_gb_b0 (
	"KEY" BIGINT, 
	"Score_0" DOUBLE, 
	"Score_1" DOUBLE
)
...
-- Code For temporary table tmp_20180508175839_codegen_7ebzmm_gb_b0 part 2. Populate

INSERT INTO tmp_20180508175839_codegen_7ebzmm_gb_b0 WITH "DT_node_lookup" AS 
...
FROM tmp_20180508175838_codegen_p8k4ni_ads_sca_2_out AS "ADS_sca_2_OUT"), 
"DT_node_data" AS 
(SELECT "Values".nid AS nid, CAST("Values"."E" AS DOUBLE) AS "E" 
FROM (SELECT 3 AS nid, -0.15384615384615385 AS "E" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 4 AS nid, -2.0 AS "E" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 5 AS nid, 2.0 AS "E" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 7 AS nid, 2.0 AS "E" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 8 AS nid, -2.0 AS "E" FROM SYSIBM.SYSDUMMY1) AS "Values"), 
"DT_Output" AS 
...
"DT_node_data_1" AS 
(SELECT "Values".nid AS nid, CAST("Values"."E" AS DOUBLE) AS "E" 
FROM (SELECT 3 AS nid, -0.13847003506844247 AS "E" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 4 AS nid, -1.8187307530779822 AS "E" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 5 AS nid, 1.8187307530779817 AS "E" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 7 AS nid, 1.8187307530779817 AS "E" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 8 AS nid, -1.8187307530779822 AS "E" FROM SYSIBM.SYSDUMMY1) AS "Values"), 
"DT_Output_1" AS 
...
"DT_node_data_2" AS 
(SELECT "Values".nid AS nid, CAST("Values"."E" AS DOUBLE) AS "E" 
FROM (SELECT 3 AS nid, 2.029663056273607 AS "E" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 4 AS nid, -1.1217211227850905 AS "E" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 6 AS nid, -1.9711914921168885 AS "E" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 7 AS nid, -1.6825816841776358 AS "E" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 9 AS nid, 1.682581684177635 AS "E" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 10 AS nid, -1.6825816841776358 AS "E" FROM SYSIBM.SYSDUMMY1) AS "Values"), 
"DT_Output_2" AS 
...
"DT_node_data_3" AS 
(SELECT "Values".nid AS nid, CAST("Values"."E" AS DOUBLE) AS "E" 
FROM (SELECT 3 AS nid, -1.2864660764794682 AS "E" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 4 AS nid, 1.8405198691485003 AS "E" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 5 AS nid, 1.7636078071636292 AS "E" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 7 AS nid, 1.5768740943066493 AS "E" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 8 AS nid, -1.5768740943066488 AS "E" FROM SYSIBM.SYSDUMMY1) AS "Values"), 
"DT_Output_3" AS 
...
"DT_node_data_4" AS 
(SELECT "Values".nid AS nid, CAST("Values"."E" AS DOUBLE) AS "E" 
FROM (SELECT 3 AS nid, -1.2117249884428376 AS "E" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 4 AS nid, 1.9559132821549832 AS "E" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 5 AS nid, 1.6401442459379127 AS "E" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 7 AS nid, 1.492717814519233 AS "E" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 8 AS nid, -1.492717814519233 AS "E" FROM SYSIBM.SYSDUMMY1) AS "Values"), 
"DT_Output_4" AS 
...
-- Code For temporary table tmp_20180508175839_codegen_d6gwx0_gb_b1 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180508175839_codegen_d6gwx0_gb_b1 (
	"KEY" BIGINT, 
	"Score_0" DOUBLE, 
	"Score_1" DOUBLE
)
...
-- Code For temporary table tmp_20180508175839_codegen_d6gwx0_gb_b1 part 2. Populate

INSERT INTO tmp_20180508175839_codegen_d6gwx0_gb_b1 WITH "DT_node_lookup_5" AS 
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", CASE WHEN ("ADS_sca_2_OUT".scaler_11 <= 0.07101128250360489) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_9 <= 0.6601690649986267) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_7 <= -0.7541185617446899) THEN 3 ELSE 4 END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_7 <= -0.9067436456680298) THEN 6 ELSE 7 END END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_8 <= 1.7904822826385498) THEN 9 ELSE 10 END END AS node_id_2 
FROM tmp_20180508175838_codegen_p8k4ni_ads_sca_2_out AS "ADS_sca_2_OUT"), 
"DT_node_data_5" AS 
(SELECT "Values".nid AS nid, CAST("Values"."E" AS DOUBLE) AS "E" 
FROM (SELECT 3 AS nid, 1.885642417488209 AS "E" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 4 AS nid, -0.9536234176150937 AS "E" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 6 AS nid, -1.6211579543283008 AS "E" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 7 AS nid, -1.449351273756259 AS "E" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 9 AS nid, 1.4243950929603062 AS "E" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 10 AS nid, -1.4243950929603058 AS "E" FROM SYSIBM.SYSDUMMY1) AS "Values"), 
"DT_Output_5" AS 
...
"DT_node_data_6" AS 
(SELECT "Values".nid AS nid, CAST("Values"."E" AS DOUBLE) AS "E" 
FROM (SELECT 3 AS nid, 0.034092464473056215 AS "E" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 4 AS nid, -1.4101642957975853 AS "E" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 5 AS nid, 1.5976716078766435 AS "E" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 7 AS nid, 1.368052405793643 AS "E" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 8 AS nid, -1.3680524057936443 AS "E" FROM SYSIBM.SYSDUMMY1) AS "Values"), 
"DT_Output_6" AS 
...
"DT_node_data_7" AS 
(SELECT "Values".nid AS nid, CAST("Values"."E" AS DOUBLE) AS "E" 
FROM (SELECT 3 AS nid, 1.7325581378799262 AS "E" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 4 AS nid, -0.8446287141773386 AS "E" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 6 AS nid, -1.5300009798940906 AS "E" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 7 AS nid, -1.3375971672397093 AS "E" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 9 AS nid, 1.320993249880287 AS "E" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 10 AS nid, -1.320993249880286 AS "E" FROM SYSIBM.SYSDUMMY1) AS "Values"), 
"DT_Output_7" AS 
...
"DT_node_data_8" AS 
(SELECT "Values".nid AS nid, CAST("Values"."E" AS DOUBLE) AS "E" 
FROM (SELECT 3 AS nid, -0.9991597393140883 AS "E" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 4 AS nid, 1.5478008465502715 AS "E" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 5 AS nid, 1.554317242661278 AS "E" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 7 AS nid, 1.2812716053275388 AS "E" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 8 AS nid, -1.281271605327538 AS "E" FROM SYSIBM.SYSDUMMY1) AS "Values"), 
"DT_Output_8" AS 
...
"DT_node_data_9" AS 
(SELECT "Values".nid AS nid, CAST("Values"."E" AS DOUBLE) AS "E" 
FROM (SELECT 3 AS nid, 1.2474463050002376 AS "E" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 4 AS nid, 1.6409435582754206 AS "E" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 6 AS nid, -0.7048073824764006 AS "E" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 7 AS nid, 1.1286418950002148 AS "E" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 9 AS nid, -1.4115632784888261 AS "E" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 10 AS nid, -1.267248164332446 AS "E" FROM SYSIBM.SYSDUMMY1) AS "Values"), 
"DT_Output_9" AS 
...
-- Code For temporary table tmp_20180508175839_codegen_wn1lkn_gb_b2 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180508175839_codegen_wn1lkn_gb_b2 (
	"KEY" BIGINT, 
	"Score_0" DOUBLE, 
	"Score_1" DOUBLE
)
...
-- Code For temporary table tmp_20180508175839_codegen_wn1lkn_gb_b2 part 2. Populate

INSERT INTO tmp_20180508175839_codegen_wn1lkn_gb_b2 WITH "DT_node_lookup_10" AS 
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", CASE WHEN ("ADS_sca_2_OUT".scaler_9 <= 0.6601690649986267) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_7 <= -0.6792029142379761) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_2 <= 0.2611241638660431) THEN 3 ELSE 4 END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_11 <= 0.3664867579936981) THEN 6 ELSE 7 END END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_7 <= -0.9067436456680298) THEN 9 ELSE 10 END END AS node_id_2 
FROM tmp_20180508175838_codegen_p8k4ni_ads_sca_2_out AS "ADS_sca_2_OUT"), 
"DT_node_data_10" AS 
(SELECT "Values".nid AS nid, CAST("Values"."E" AS DOUBLE) AS "E" 
FROM (SELECT 3 AS nid, 1.2184263700300324 AS "E" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 4 AS nid, 1.5461569468624359 AS "E" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 6 AS nid, -0.650107306740469 AS "E" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 7 AS nid, 1.08568074504253 AS "E" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 9 AS nid, -1.3573824352603094 AS "E" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 10 AS nid, -1.2354392373628378 AS "E" FROM SYSIBM.SYSDUMMY1) AS "Values"), 
"DT_Output_10" AS 
...
"DT_node_data_11" AS 
(SELECT "Values".nid AS nid, CAST("Values"."E" AS DOUBLE) AS "E" 
FROM (SELECT 3 AS nid, 1.4696247823959214 AS "E" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 4 AS nid, 1.193370171985729 AS "E" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 6 AS nid, 0.9559635164394037 AS "E" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 7 AS nid, -0.6719261067130203 AS "E" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 9 AS nid, -1.312020288239965 AS "E" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 10 AS nid, -1.2080771534525385 AS "E" FROM SYSIBM.SYSDUMMY1) AS "Values"), 
"DT_Output_11" AS 
...
"DT_node_data_12" AS 
(SELECT "Values".nid AS nid, CAST("Values"."E" AS DOUBLE) AS "E" 
FROM (SELECT 3 AS nid, 1.4067686970730768 AS "E" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 4 AS nid, 1.1716176992600653 AS "E" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 6 AS nid, 0.5662845648276641 AS "E" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 7 AS nid, -1.254792449094061 AS "E" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 9 AS nid, -1.2736544511427008 AS "E" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 10 AS nid, -1.184398877840221 AS "E" FROM SYSIBM.SYSDUMMY1) AS "Values"), 
"DT_Output_12" AS 
...
"DT_node_data_13" AS 
(SELECT "Values".nid AS nid, CAST("Values"."E" AS DOUBLE) AS "E" 
FROM (SELECT 3 AS nid, 0.0744224226197791 AS "E" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 4 AS nid, -1.2077480105959142 AS "E" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 5 AS nid, 1.5491441975162652 AS "E" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 8 AS nid, 1.1645200827182243 AS "E" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 9 AS nid, 1.2111046798702165 AS "E" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 11 AS nid, -1.3595490765186873 AS "E" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 12 AS nid, -1.251621745056133 AS "E" FROM SYSIBM.SYSDUMMY1) AS "Values"), 
"DT_Output_13" AS 
...
"DT_node_data_14" AS 
(SELECT "Values".nid AS nid, CAST("Values"."E" AS DOUBLE) AS "E" 
FROM (SELECT 3 AS nid, 1.135864157694164 AS "E" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 4 AS nid, 1.3518548370812429 AS "E" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 6 AS nid, -0.4726610334665721 AS "E" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 7 AS nid, 1.1515365924767922 AS "E" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 9 AS nid, -1.2427283654474486 AS "E" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 10 AS nid, -1.1451672515691305 AS "E" FROM SYSIBM.SYSDUMMY1) AS "Values"), 
"DT_Output_14" AS 
...
-- Code For temporary table tmp_20180508175839_codegen_a05fav_gb_b3 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180508175839_codegen_a05fav_gb_b3 (
	"KEY" BIGINT, 
	"Score_0" DOUBLE, 
	"Score_1" DOUBLE
)
...
-- Code For temporary table tmp_20180508175839_codegen_a05fav_gb_b3 part 2. Populate

INSERT INTO tmp_20180508175839_codegen_a05fav_gb_b3 WITH "DT_node_lookup_15" AS 
...
"DT_node_data_15" AS 
(SELECT "Values".nid AS nid, CAST("Values"."E" AS DOUBLE) AS "E" 
FROM (SELECT 2 AS nid, 1.4931003709313195 AS "E" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 4 AS nid, -0.3736476669355103 AS "E" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 5 AS nid, 0.9204301051861393 AS "E" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 7 AS nid, -1.2143628508478628 AS "E" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 8 AS nid, -1.1294597227644136 AS "E" FROM SYSIBM.SYSDUMMY1) AS "Values"), 
"DT_Output_15" AS 
...
-- Code For temporary table tmp_20180508175839_codegen_tehvz1_gb_union part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180508175839_codegen_tehvz1_gb_union (
	"KEY" BIGINT, 
	"Score_0" DOUBLE, 
	"Score_1" DOUBLE
)
...
-- Code For temporary table tmp_20180508175839_codegen_tehvz1_gb_union part 2. Populate

INSERT INTO tmp_20180508175839_codegen_tehvz1_gb_union SELECT "GB_Union"."KEY", "GB_Union"."Score_0", "GB_Union"."Score_1" 
...
FROM tmp_20180508175839_codegen_7ebzmm_gb_b0 AS "GB_B0" UNION ALL SELECT "GB_B1"."KEY" AS "KEY", "GB_B1"."Score_0" AS "Score_0", "GB_B1"."Score_1" AS "Score_1" 
FROM tmp_20180508175839_codegen_d6gwx0_gb_b1 AS "GB_B1" UNION ALL SELECT "GB_B2"."KEY" AS "KEY", "GB_B2"."Score_0" AS "Score_0", "GB_B2"."Score_1" AS "Score_1" 
FROM tmp_20180508175839_codegen_wn1lkn_gb_b2 AS "GB_B2" UNION ALL SELECT "GB_B3"."KEY" AS "KEY", "GB_B3"."Score_0" AS "Score_0", "GB_B3"."Score_1" AS "Score_1" 
FROM tmp_20180508175839_codegen_a05fav_gb_b3 AS "GB_B3") AS "GB_EnsembleUnion") AS "GB_Union"

-- Code For temporary table tmp_20180508175839_codegen_1fsfue_gb_sum part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180508175839_codegen_1fsfue_gb_sum (
	"KEY" BIGINT, 
	"Score_0" DOUBLE, 
	"Score_1" DOUBLE
)
...
-- Code For temporary table tmp_20180508175839_codegen_1fsfue_gb_sum part 2. Populate

INSERT INTO tmp_20180508175839_codegen_1fsfue_gb_sum SELECT "GB_sum"."KEY", "GB_sum"."Score_0", "GB_sum"."Score_1" 
...
FROM tmp_20180508175839_codegen_tehvz1_gb_union AS "GB_Union" GROUP BY "GB_Union"."KEY") AS "T") AS "GB_sum"
...
FROM tmp_20180508175839_codegen_1fsfue_gb_sum AS "GB_sum"), 
