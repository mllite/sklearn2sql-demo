...
-- Code For temporary table TMP_20180602141255_OD5_ADS_imp_1_OUT part 1. Create 


CREATE TEMPORARY TABLE "TMP_20180602141255_OD5_ADS_imp_1_OUT" (
	"KEY" BIGINT NOT NULL, 
	impter_2 FLOAT, 
	impter_3 FLOAT, 
	impter_4 FLOAT, 
...
-- Code For temporary table TMP_20180602141255_OD5_ADS_imp_1_OUT part 2. Populate

INSERT INTO "TMP_20180602141255_OD5_ADS_imp_1_OUT" ("KEY", impter_2, impter_3, impter_4, impter_5, impter_6, impter_7, impter_8, impter_9, impter_10, impter_11) SELECT "ADS_imp_1_OUT"."KEY", "ADS_imp_1_OUT".impter_2, "ADS_imp_1_OUT".impter_3, "ADS_imp_1_OUT".impter_4, "ADS_imp_1_OUT".impter_5, "ADS_imp_1_OUT".impter_6, "ADS_imp_1_OUT".impter_7, "ADS_imp_1_OUT".impter_8, "ADS_imp_1_OUT".impter_9, "ADS_imp_1_OUT".impter_10, "ADS_imp_1_OUT".impter_11 
...
-- Code For temporary table TMP_20180602141255_OD5_ADS_imp_1_OUT part 3. Create Index 

CREATE INDEX "ix_TMP_20180602141255_OD5_ADS_imp_1_OUT_KEY" ON "TMP_20180602141255_OD5_ADS_imp_1_OUT" ("KEY")

-- Code For temporary table TMP_20180602141255_XJ5_ADS_sca_2_OUT part 1. Create 


CREATE TEMPORARY TABLE "TMP_20180602141255_XJ5_ADS_sca_2_OUT" (
	"KEY" BIGINT NOT NULL, 
	scaler_2 FLOAT, 
	scaler_3 FLOAT, 
	scaler_4 FLOAT, 
...
-- Code For temporary table TMP_20180602141255_XJ5_ADS_sca_2_OUT part 2. Populate

INSERT INTO "TMP_20180602141255_XJ5_ADS_sca_2_OUT" ("KEY", scaler_2, scaler_3, scaler_4, scaler_5, scaler_6, scaler_7, scaler_8, scaler_9, scaler_10, scaler_11) SELECT "ADS_sca_2_OUT"."KEY", "ADS_sca_2_OUT".scaler_2, "ADS_sca_2_OUT".scaler_3, "ADS_sca_2_OUT".scaler_4, "ADS_sca_2_OUT".scaler_5, "ADS_sca_2_OUT".scaler_6, "ADS_sca_2_OUT".scaler_7, "ADS_sca_2_OUT".scaler_8, "ADS_sca_2_OUT".scaler_9, "ADS_sca_2_OUT".scaler_10, "ADS_sca_2_OUT".scaler_11 
...
FROM "TMP_20180602141255_OD5_ADS_imp_1_OUT" AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT"

-- Code For temporary table TMP_20180602141255_XJ5_ADS_sca_2_OUT part 3. Create Index 

CREATE INDEX "ix_TMP_20180602141255_XJ5_ADS_sca_2_OUT_KEY" ON "TMP_20180602141255_XJ5_ADS_sca_2_OUT" ("KEY")

-- Code For temporary table TMP_20180602141255_ATI_GB_B0 part 1. Create 


CREATE TEMPORARY TABLE "TMP_20180602141255_ATI_GB_B0" (
	"KEY" BIGINT, 
	"Score_0" FLOAT, 
	"Score_1" FLOAT
)
...
-- Code For temporary table TMP_20180602141255_ATI_GB_B0 part 2. Populate
...
FROM "TMP_20180602141255_XJ5_ADS_sca_2_OUT" AS "ADS_sca_2_OUT"), 
"DT_node_data" AS 
...
FROM "DT_Output_4")
 INSERT INTO "TMP_20180602141255_ATI_GB_B0" ("KEY", "Score_0", "Score_1") SELECT "GB_B0"."KEY", "GB_B0"."Score_0", "GB_B0"."Score_1" 
...
-- Code For temporary table TMP_20180602141255_0HY_GB_B1 part 1. Create 


CREATE TEMPORARY TABLE "TMP_20180602141255_0HY_GB_B1" (
	"KEY" BIGINT, 
	"Score_0" FLOAT, 
	"Score_1" FLOAT
)
...
-- Code For temporary table TMP_20180602141255_0HY_GB_B1 part 2. Populate
...
FROM "DT_Output_9")
 INSERT INTO "TMP_20180602141255_0HY_GB_B1" ("KEY", "Score_0", "Score_1") SELECT "GB_B1"."KEY", "GB_B1"."Score_0", "GB_B1"."Score_1" 
...
-- Code For temporary table TMP_20180602141255_ZEG_GB_B2 part 1. Create 


CREATE TEMPORARY TABLE "TMP_20180602141255_ZEG_GB_B2" (
	"KEY" BIGINT, 
	"Score_0" FLOAT, 
	"Score_1" FLOAT
)
...
-- Code For temporary table TMP_20180602141255_ZEG_GB_B2 part 2. Populate
...
FROM "DT_Output_14")
 INSERT INTO "TMP_20180602141255_ZEG_GB_B2" ("KEY", "Score_0", "Score_1") SELECT "GB_B2"."KEY", "GB_B2"."Score_0", "GB_B2"."Score_1" 
...
-- Code For temporary table TMP_20180602141255_2S5_GB_B3 part 1. Create 


CREATE TEMPORARY TABLE "TMP_20180602141255_2S5_GB_B3" (
	"KEY" BIGINT, 
	"Score_0" FLOAT, 
	"Score_1" FLOAT
)
...
-- Code For temporary table TMP_20180602141255_2S5_GB_B3 part 2. Populate
...
FROM "DT_Output_15")
 INSERT INTO "TMP_20180602141255_2S5_GB_B3" ("KEY", "Score_0", "Score_1") SELECT "GB_B3"."KEY", "GB_B3"."Score_0", "GB_B3"."Score_1" 
...
-- Code For temporary table TMP_20180602141255_KCP_GB_sum part 1. Create 


CREATE TEMPORARY TABLE "TMP_20180602141255_KCP_GB_sum" (
	"KEY" BIGINT NOT NULL, 
	"Score_0" FLOAT, 
	"Score_1" FLOAT, 
	PRIMARY KEY ("KEY")
...
-- Code For temporary table TMP_20180602141255_KCP_GB_sum part 2. Populate
...
FROM "TMP_20180602141255_ATI_GB_B0" AS "GB_B0" UNION ALL SELECT "GB_B1"."KEY" AS "KEY", "GB_B1"."Score_0" AS "Score_0", "GB_B1"."Score_1" AS "Score_1" 
FROM "TMP_20180602141255_0HY_GB_B1" AS "GB_B1" UNION ALL SELECT "GB_B2"."KEY" AS "KEY", "GB_B2"."Score_0" AS "Score_0", "GB_B2"."Score_1" AS "Score_1" 
FROM "TMP_20180602141255_ZEG_GB_B2" AS "GB_B2" UNION ALL SELECT "GB_B3"."KEY" AS "KEY", "GB_B3"."Score_0" AS "Score_0", "GB_B3"."Score_1" AS "Score_1" 
FROM "TMP_20180602141255_2S5_GB_B3" AS "GB_B3") AS "GB_EnsembleUnion")
 INSERT INTO "TMP_20180602141255_KCP_GB_sum" ("KEY", "Score_0", "Score_1") SELECT "GB_sum"."KEY", "GB_sum"."Score_0", "GB_sum"."Score_1" 
...
-- Code For temporary table TMP_20180602141255_KCP_GB_sum part 3. Create Index 

CREATE INDEX "ix_TMP_20180602141255_KCP_GB_sum_KEY" ON "TMP_20180602141255_KCP_GB_sum" ("KEY")
...
FROM "TMP_20180602141255_KCP_GB_sum" AS "GB_sum"), 
