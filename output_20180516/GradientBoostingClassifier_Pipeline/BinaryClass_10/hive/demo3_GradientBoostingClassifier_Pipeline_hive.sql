...
-- Code For temporary table tmp_20180509001827_codegen_01hcsn_ads_imp_1_out part 1. Create 

CREATE TEMPORARY TABLE `tmp_20180509001827_codegen_01hcsn_ads_imp_1_out` STORED AS ORC AS SELECT `ADS_imp_1_OUT`.`KEY`, `ADS_imp_1_OUT`.`impter_2`, `ADS_imp_1_OUT`.`impter_3`, `ADS_imp_1_OUT`.`impter_4`, `ADS_imp_1_OUT`.`impter_5`, `ADS_imp_1_OUT`.`impter_6`, `ADS_imp_1_OUT`.`impter_7`, `ADS_imp_1_OUT`.`impter_8`, `ADS_imp_1_OUT`.`impter_9`, `ADS_imp_1_OUT`.`impter_10`, `ADS_imp_1_OUT`.`impter_11` 
...
-- Code For temporary table tmp_20180509001827_codegen_01hcsn_ads_imp_1_out part 2. Populate

SELECT * FROM `tmp_20180509001827_codegen_01hcsn_ads_imp_1_out`

-- Code For temporary table tmp_20180509001827_codegen_m402fu_ads_sca_2_out part 1. Create 

CREATE TEMPORARY TABLE `tmp_20180509001827_codegen_m402fu_ads_sca_2_out` STORED AS ORC AS SELECT `ADS_sca_2_OUT`.`KEY`, `ADS_sca_2_OUT`.`scaler_2`, `ADS_sca_2_OUT`.`scaler_3`, `ADS_sca_2_OUT`.`scaler_4`, `ADS_sca_2_OUT`.`scaler_5`, `ADS_sca_2_OUT`.`scaler_6`, `ADS_sca_2_OUT`.`scaler_7`, `ADS_sca_2_OUT`.`scaler_8`, `ADS_sca_2_OUT`.`scaler_9`, `ADS_sca_2_OUT`.`scaler_10`, `ADS_sca_2_OUT`.`scaler_11` 
...
FROM `tmp_20180509001827_codegen_01hcsn_ads_imp_1_out` AS `ADS_imp_1_OUT`) AS `ADS_sca_2_OUT`

-- Code For temporary table tmp_20180509001827_codegen_m402fu_ads_sca_2_out part 2. Populate

SELECT * FROM `tmp_20180509001827_codegen_m402fu_ads_sca_2_out`

-- Code For temporary table tmp_20180509001828_codegen_ro195p_gb_b0 part 1. Create 

CREATE TEMPORARY TABLE `tmp_20180509001828_codegen_ro195p_gb_b0` STORED AS ORC AS WITH `DT_node_lookup` AS 
...
FROM `tmp_20180509001827_codegen_m402fu_ads_sca_2_out` AS `ADS_sca_2_OUT`), 
`DT_node_data` AS 
...
-- Code For temporary table tmp_20180509001828_codegen_ro195p_gb_b0 part 2. Populate

SELECT * FROM `tmp_20180509001828_codegen_ro195p_gb_b0`

-- Code For temporary table tmp_20180509001828_codegen_g6f31g_gb_b1 part 1. Create 

CREATE TEMPORARY TABLE `tmp_20180509001828_codegen_g6f31g_gb_b1` STORED AS ORC AS WITH `DT_node_lookup_5` AS 
(SELECT `ADS_sca_2_OUT`.`KEY` AS `KEY`, CASE WHEN (`ADS_sca_2_OUT`.`scaler_11` <= 0.07101128250360489) THEN CASE WHEN (`ADS_sca_2_OUT`.`scaler_9` <= 0.6601690649986267) THEN CASE WHEN (`ADS_sca_2_OUT`.`scaler_7` <= -0.7541185617446899) THEN 3 ELSE 4 END ELSE CASE WHEN (`ADS_sca_2_OUT`.`scaler_7` <= -0.9067436456680298) THEN 6 ELSE 7 END END ELSE CASE WHEN (`ADS_sca_2_OUT`.`scaler_8` <= 1.7904822826385498) THEN 9 ELSE 10 END END AS `node_id_2` 
FROM `tmp_20180509001827_codegen_m402fu_ads_sca_2_out` AS `ADS_sca_2_OUT`), 
`DT_node_data_5` AS 
(SELECT `Values`.`nid` AS `nid`, CAST(`Values`.`E` AS DOUBLE) AS `E` 
...
-- Code For temporary table tmp_20180509001828_codegen_g6f31g_gb_b1 part 2. Populate

SELECT * FROM `tmp_20180509001828_codegen_g6f31g_gb_b1`

-- Code For temporary table tmp_20180509001828_codegen_skhz3c_gb_b2 part 1. Create 

CREATE TEMPORARY TABLE `tmp_20180509001828_codegen_skhz3c_gb_b2` STORED AS ORC AS WITH `DT_node_lookup_10` AS 
...
-- Code For temporary table tmp_20180509001828_codegen_skhz3c_gb_b2 part 2. Populate

SELECT * FROM `tmp_20180509001828_codegen_skhz3c_gb_b2`

-- Code For temporary table tmp_20180509001828_codegen_c2w4di_gb_b3 part 1. Create 

CREATE TEMPORARY TABLE `tmp_20180509001828_codegen_c2w4di_gb_b3` STORED AS ORC AS WITH `DT_node_lookup_15` AS 
...
-- Code For temporary table tmp_20180509001828_codegen_c2w4di_gb_b3 part 2. Populate

SELECT * FROM `tmp_20180509001828_codegen_c2w4di_gb_b3`

-- Code For temporary table tmp_20180509001828_codegen_0n59tr_gb_union part 1. Create 

CREATE TEMPORARY TABLE `tmp_20180509001828_codegen_0n59tr_gb_union` STORED AS ORC AS SELECT `GB_Union`.`KEY`, `GB_Union`.`Score_0`, `GB_Union`.`Score_1` 
...
FROM `tmp_20180509001828_codegen_ro195p_gb_b0` AS `GB_B0` UNION ALL SELECT `GB_B1`.`KEY` AS `KEY`, `GB_B1`.`Score_0` AS `Score_0`, `GB_B1`.`Score_1` AS `Score_1` 
FROM `tmp_20180509001828_codegen_g6f31g_gb_b1` AS `GB_B1` UNION ALL SELECT `GB_B2`.`KEY` AS `KEY`, `GB_B2`.`Score_0` AS `Score_0`, `GB_B2`.`Score_1` AS `Score_1` 
FROM `tmp_20180509001828_codegen_skhz3c_gb_b2` AS `GB_B2` UNION ALL SELECT `GB_B3`.`KEY` AS `KEY`, `GB_B3`.`Score_0` AS `Score_0`, `GB_B3`.`Score_1` AS `Score_1` 
FROM `tmp_20180509001828_codegen_c2w4di_gb_b3` AS `GB_B3`) AS `GB_EnsembleUnion`) AS `GB_Union`

-- Code For temporary table tmp_20180509001828_codegen_0n59tr_gb_union part 2. Populate

SELECT * FROM `tmp_20180509001828_codegen_0n59tr_gb_union`

-- Code For temporary table tmp_20180509001828_codegen_cbli4a_gb_sum part 1. Create 

CREATE TEMPORARY TABLE `tmp_20180509001828_codegen_cbli4a_gb_sum` STORED AS ORC AS SELECT `GB_sum`.`KEY`, `GB_sum`.`Score_0`, `GB_sum`.`Score_1` 
...
FROM `tmp_20180509001828_codegen_0n59tr_gb_union` AS `GB_Union` GROUP BY `GB_Union`.`KEY`) AS `T`) AS `GB_sum`

-- Code For temporary table tmp_20180509001828_codegen_cbli4a_gb_sum part 2. Populate

SELECT * FROM `tmp_20180509001828_codegen_cbli4a_gb_sum`

-- Model deployment code

WITH `orig_cte` AS 
(SELECT `GB_sum`.`KEY` AS `KEY`, -(0.0 + 0.1 * `GB_sum`.`Score_1`) AS `Score_0`, 0.0 + 0.1 * `GB_sum`.`Score_1` AS `Score_1`, 1.0 - 1.0 / (1.0 + exp(-(0.0 + 0.1 * `GB_sum`.`Score_1`))) AS `Proba_0`, 1.0 / (1.0 + exp(-(0.0 + 0.1 * `GB_sum`.`Score_1`))) AS `Proba_1`, CAST(NULL AS DOUBLE) AS `LogProba_0`, CAST(NULL AS DOUBLE) AS `LogProba_1`, CAST(NULL AS BIGINT) AS `Decision`, CAST(NULL AS DOUBLE) AS `DecisionProba` 
FROM `tmp_20180509001828_codegen_cbli4a_gb_sum` AS `GB_sum`), 
