...
-- Code For temporary table TMP_20180602_I0R_ADS_IMP_1_OUT part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180602_I0R_ADS_IMP_1_OUT" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20180602_I0R_ADS_IMP_1_OUT part 2. Populate

INSERT INTO "TMP_20180602_I0R_ADS_IMP_1_OUT" ("KEY", impter_2, impter_3, impter_4, impter_5, impter_6, impter_7, impter_8, impter_9, impter_10, impter_11) SELECT "U"."KEY", "U".impter_2, "U".impter_3, "U".impter_4, "U".impter_5, "U".impter_6, "U".impter_7, "U".impter_8, "U".impter_9, "U".impter_10, "U".impter_11 
...
-- Code For temporary table TMP_20180602_I0R_ADS_IMP_1_OUT part 3. Create Index 

CREATE INDEX "ix_TMP_20180602_I0R_ADS_2168" ON "TMP_20180602_I0R_ADS_IMP_1_OUT" ("KEY")

-- Code For temporary table TMP_20180602_I5B_ADS_SCA_2_OUT part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180602_I5B_ADS_SCA_2_OUT" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20180602_I5B_ADS_SCA_2_OUT part 2. Populate

INSERT INTO "TMP_20180602_I5B_ADS_SCA_2_OUT" ("KEY", scaler_2, scaler_3, scaler_4, scaler_5, scaler_6, scaler_7, scaler_8, scaler_9, scaler_10, scaler_11) SELECT "U"."KEY", "U".scaler_2, "U".scaler_3, "U".scaler_4, "U".scaler_5, "U".scaler_6, "U".scaler_7, "U".scaler_8, "U".scaler_9, "U".scaler_10, "U".scaler_11 
...
FROM "TMP_20180602_I0R_ADS_IMP_1_OUT" AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT") AS "U"

-- Code For temporary table TMP_20180602_I5B_ADS_SCA_2_OUT part 3. Create Index 

CREATE INDEX "ix_TMP_20180602_I5B_ADS_83bc" ON "TMP_20180602_I5B_ADS_SCA_2_OUT" ("KEY")

-- Code For temporary table TMP_20180602_CTO_GB_B0 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180602_CTO_GB_B0" (
	"KEY" BIGINT, 
...
-- Code For temporary table TMP_20180602_CTO_GB_B0 part 2. Populate

INSERT INTO "TMP_20180602_CTO_GB_B0" ("KEY", "Score_0", "Score_1") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1" 
...
FROM "TMP_20180602_I5B_ADS_SCA_2_OUT" AS "ADS_sca_2_OUT"), 
"DT_node_data" AS 
(SELECT "Values".nid AS nid, CAST("Values"."E" AS DOUBLE PRECISION) AS "E" 
FROM (SELECT 3 AS nid, -0.15384615384615385 AS "E" FROM rdb$database UNION ALL SELECT 4 AS nid, -2.0 AS "E" FROM rdb$database UNION ALL SELECT 5 AS nid, 2.0 AS "E" FROM rdb$database UNION ALL SELECT 7 AS nid, 2.0 AS "E" FROM rdb$database UNION ALL SELECT 8 AS nid, -2.0 AS "E" FROM rdb$database) AS "Values"), 
"DT_Output" AS 
...
"DT_node_data_1" AS 
(SELECT "Values".nid AS nid, CAST("Values"."E" AS DOUBLE PRECISION) AS "E" 
FROM (SELECT 3 AS nid, -0.13847003506844247 AS "E" FROM rdb$database UNION ALL SELECT 4 AS nid, -1.8187307530779822 AS "E" FROM rdb$database UNION ALL SELECT 5 AS nid, 1.8187307530779817 AS "E" FROM rdb$database UNION ALL SELECT 7 AS nid, 1.8187307530779817 AS "E" FROM rdb$database UNION ALL SELECT 8 AS nid, -1.8187307530779822 AS "E" FROM rdb$database) AS "Values"), 
"DT_Output_1" AS 
...
"DT_node_data_2" AS 
(SELECT "Values".nid AS nid, CAST("Values"."E" AS DOUBLE PRECISION) AS "E" 
FROM (SELECT 3 AS nid, 2.029663056273607 AS "E" FROM rdb$database UNION ALL SELECT 4 AS nid, -1.1217211227850905 AS "E" FROM rdb$database UNION ALL SELECT 6 AS nid, -1.9711914921168885 AS "E" FROM rdb$database UNION ALL SELECT 7 AS nid, -1.6825816841776358 AS "E" FROM rdb$database UNION ALL SELECT 9 AS nid, 1.682581684177635 AS "E" FROM rdb$database UNION ALL SELECT 10 AS nid, -1.6825816841776358 AS "E" FROM rdb$database) AS "Values"), 
"DT_Output_2" AS 
...
-- Code For temporary table TMP_20180602_HMM_GB_B1 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180602_HMM_GB_B1" (
	"KEY" BIGINT, 
	"Score_0" DOUBLE PRECISION, 
	"Score_1" DOUBLE PRECISION
)
...
-- Code For temporary table TMP_20180602_HMM_GB_B1 part 2. Populate

INSERT INTO "TMP_20180602_HMM_GB_B1" ("KEY", "Score_0", "Score_1") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1" 
...
"DT_node_data_3" AS 
(SELECT "Values".nid AS nid, CAST("Values"."E" AS DOUBLE PRECISION) AS "E" 
FROM (SELECT 3 AS nid, -1.2864660764794682 AS "E" FROM rdb$database UNION ALL SELECT 4 AS nid, 1.8405198691485003 AS "E" FROM rdb$database UNION ALL SELECT 5 AS nid, 1.7636078071636292 AS "E" FROM rdb$database UNION ALL SELECT 7 AS nid, 1.5768740943066493 AS "E" FROM rdb$database UNION ALL SELECT 8 AS nid, -1.5768740943066488 AS "E" FROM rdb$database) AS "Values"), 
"DT_Output_3" AS 
...
"DT_node_data_4" AS 
(SELECT "Values".nid AS nid, CAST("Values"."E" AS DOUBLE PRECISION) AS "E" 
FROM (SELECT 3 AS nid, -1.2117249884428376 AS "E" FROM rdb$database UNION ALL SELECT 4 AS nid, 1.9559132821549832 AS "E" FROM rdb$database UNION ALL SELECT 5 AS nid, 1.6401442459379127 AS "E" FROM rdb$database UNION ALL SELECT 7 AS nid, 1.492717814519233 AS "E" FROM rdb$database UNION ALL SELECT 8 AS nid, -1.492717814519233 AS "E" FROM rdb$database) AS "Values"), 
"DT_Output_4" AS 
...
-- Code For temporary table TMP_20180602_J16_GB_B2 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180602_J16_GB_B2" (
	"KEY" BIGINT, 
	"Score_0" DOUBLE PRECISION, 
	"Score_1" DOUBLE PRECISION
)
...
-- Code For temporary table TMP_20180602_J16_GB_B2 part 2. Populate

INSERT INTO "TMP_20180602_J16_GB_B2" ("KEY", "Score_0", "Score_1") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1" 
FROM (WITH "DT_node_lookup_5" AS 
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", CASE WHEN ("ADS_sca_2_OUT".scaler_11 <= 0.07101128250360489) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_9 <= 0.6601690649986267) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_7 <= -0.7541185617446899) THEN 3 ELSE 4 END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_7 <= -0.9067436456680298) THEN 6 ELSE 7 END END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_8 <= 1.7904822826385498) THEN 9 ELSE 10 END END AS node_id_2 
FROM "TMP_20180602_I5B_ADS_SCA_2_OUT" AS "ADS_sca_2_OUT"), 
"DT_node_data_5" AS 
(SELECT "Values".nid AS nid, CAST("Values"."E" AS DOUBLE PRECISION) AS "E" 
FROM (SELECT 3 AS nid, 1.885642417488209 AS "E" FROM rdb$database UNION ALL SELECT 4 AS nid, -0.9536234176150937 AS "E" FROM rdb$database UNION ALL SELECT 6 AS nid, -1.6211579543283008 AS "E" FROM rdb$database UNION ALL SELECT 7 AS nid, -1.449351273756259 AS "E" FROM rdb$database UNION ALL SELECT 9 AS nid, 1.4243950929603062 AS "E" FROM rdb$database UNION ALL SELECT 10 AS nid, -1.4243950929603058 AS "E" FROM rdb$database) AS "Values"), 
"DT_Output_5" AS 
...
"DT_node_data_6" AS 
(SELECT "Values".nid AS nid, CAST("Values"."E" AS DOUBLE PRECISION) AS "E" 
FROM (SELECT 3 AS nid, 0.034092464473056215 AS "E" FROM rdb$database UNION ALL SELECT 4 AS nid, -1.4101642957975853 AS "E" FROM rdb$database UNION ALL SELECT 5 AS nid, 1.5976716078766435 AS "E" FROM rdb$database UNION ALL SELECT 7 AS nid, 1.368052405793643 AS "E" FROM rdb$database UNION ALL SELECT 8 AS nid, -1.3680524057936443 AS "E" FROM rdb$database) AS "Values"), 
"DT_Output_6" AS 
...
"DT_node_data_7" AS 
(SELECT "Values".nid AS nid, CAST("Values"."E" AS DOUBLE PRECISION) AS "E" 
FROM (SELECT 3 AS nid, 1.7325581378799262 AS "E" FROM rdb$database UNION ALL SELECT 4 AS nid, -0.8446287141773386 AS "E" FROM rdb$database UNION ALL SELECT 6 AS nid, -1.5300009798940906 AS "E" FROM rdb$database UNION ALL SELECT 7 AS nid, -1.3375971672397093 AS "E" FROM rdb$database UNION ALL SELECT 9 AS nid, 1.320993249880287 AS "E" FROM rdb$database UNION ALL SELECT 10 AS nid, -1.320993249880286 AS "E" FROM rdb$database) AS "Values"), 
"DT_Output_7" AS 
...
-- Code For temporary table TMP_20180602_6LZ_GB_B3 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180602_6LZ_GB_B3" (
	"KEY" BIGINT, 
	"Score_0" DOUBLE PRECISION, 
	"Score_1" DOUBLE PRECISION
)
...
-- Code For temporary table TMP_20180602_6LZ_GB_B3 part 2. Populate

INSERT INTO "TMP_20180602_6LZ_GB_B3" ("KEY", "Score_0", "Score_1") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1" 
...
"DT_node_data_8" AS 
(SELECT "Values".nid AS nid, CAST("Values"."E" AS DOUBLE PRECISION) AS "E" 
FROM (SELECT 3 AS nid, -0.9991597393140883 AS "E" FROM rdb$database UNION ALL SELECT 4 AS nid, 1.5478008465502715 AS "E" FROM rdb$database UNION ALL SELECT 5 AS nid, 1.554317242661278 AS "E" FROM rdb$database UNION ALL SELECT 7 AS nid, 1.2812716053275388 AS "E" FROM rdb$database UNION ALL SELECT 8 AS nid, -1.281271605327538 AS "E" FROM rdb$database) AS "Values"), 
"DT_Output_8" AS 
...
"DT_node_data_9" AS 
(SELECT "Values".nid AS nid, CAST("Values"."E" AS DOUBLE PRECISION) AS "E" 
FROM (SELECT 3 AS nid, 1.2474463050002376 AS "E" FROM rdb$database UNION ALL SELECT 4 AS nid, 1.6409435582754206 AS "E" FROM rdb$database UNION ALL SELECT 6 AS nid, -0.7048073824764006 AS "E" FROM rdb$database UNION ALL SELECT 7 AS nid, 1.1286418950002148 AS "E" FROM rdb$database UNION ALL SELECT 9 AS nid, -1.4115632784888261 AS "E" FROM rdb$database UNION ALL SELECT 10 AS nid, -1.267248164332446 AS "E" FROM rdb$database) AS "Values"), 
"DT_Output_9" AS 
...
-- Code For temporary table TMP_20180602_U8X_GB_B4 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180602_U8X_GB_B4" (
	"KEY" BIGINT, 
	"Score_0" DOUBLE PRECISION, 
	"Score_1" DOUBLE PRECISION
)
...
-- Code For temporary table TMP_20180602_U8X_GB_B4 part 2. Populate

INSERT INTO "TMP_20180602_U8X_GB_B4" ("KEY", "Score_0", "Score_1") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1" 
FROM (WITH "DT_node_lookup_10" AS 
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", CASE WHEN ("ADS_sca_2_OUT".scaler_9 <= 0.6601690649986267) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_7 <= -0.6792029142379761) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_2 <= 0.2611241638660431) THEN 3 ELSE 4 END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_11 <= 0.3664867579936981) THEN 6 ELSE 7 END END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_7 <= -0.9067436456680298) THEN 9 ELSE 10 END END AS node_id_2 
FROM "TMP_20180602_I5B_ADS_SCA_2_OUT" AS "ADS_sca_2_OUT"), 
"DT_node_data_10" AS 
(SELECT "Values".nid AS nid, CAST("Values"."E" AS DOUBLE PRECISION) AS "E" 
FROM (SELECT 3 AS nid, 1.2184263700300324 AS "E" FROM rdb$database UNION ALL SELECT 4 AS nid, 1.5461569468624359 AS "E" FROM rdb$database UNION ALL SELECT 6 AS nid, -0.650107306740469 AS "E" FROM rdb$database UNION ALL SELECT 7 AS nid, 1.08568074504253 AS "E" FROM rdb$database UNION ALL SELECT 9 AS nid, -1.3573824352603094 AS "E" FROM rdb$database UNION ALL SELECT 10 AS nid, -1.2354392373628378 AS "E" FROM rdb$database) AS "Values"), 
"DT_Output_10" AS 
...
"DT_node_data_11" AS 
(SELECT "Values".nid AS nid, CAST("Values"."E" AS DOUBLE PRECISION) AS "E" 
FROM (SELECT 3 AS nid, 1.4696247823959214 AS "E" FROM rdb$database UNION ALL SELECT 4 AS nid, 1.193370171985729 AS "E" FROM rdb$database UNION ALL SELECT 6 AS nid, 0.9559635164394037 AS "E" FROM rdb$database UNION ALL SELECT 7 AS nid, -0.6719261067130203 AS "E" FROM rdb$database UNION ALL SELECT 9 AS nid, -1.312020288239965 AS "E" FROM rdb$database UNION ALL SELECT 10 AS nid, -1.2080771534525385 AS "E" FROM rdb$database) AS "Values"), 
"DT_Output_11" AS 
...
"DT_node_data_12" AS 
(SELECT "Values".nid AS nid, CAST("Values"."E" AS DOUBLE PRECISION) AS "E" 
FROM (SELECT 3 AS nid, 1.4067686970730768 AS "E" FROM rdb$database UNION ALL SELECT 4 AS nid, 1.1716176992600653 AS "E" FROM rdb$database UNION ALL SELECT 6 AS nid, 0.5662845648276641 AS "E" FROM rdb$database UNION ALL SELECT 7 AS nid, -1.254792449094061 AS "E" FROM rdb$database UNION ALL SELECT 9 AS nid, -1.2736544511427008 AS "E" FROM rdb$database UNION ALL SELECT 10 AS nid, -1.184398877840221 AS "E" FROM rdb$database) AS "Values"), 
"DT_Output_12" AS 
...
-- Code For temporary table TMP_20180602_65E_GB_B5 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180602_65E_GB_B5" (
	"KEY" BIGINT, 
	"Score_0" DOUBLE PRECISION, 
	"Score_1" DOUBLE PRECISION
)
...
-- Code For temporary table TMP_20180602_65E_GB_B5 part 2. Populate

INSERT INTO "TMP_20180602_65E_GB_B5" ("KEY", "Score_0", "Score_1") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1" 
...
"DT_node_data_13" AS 
(SELECT "Values".nid AS nid, CAST("Values"."E" AS DOUBLE PRECISION) AS "E" 
FROM (SELECT 3 AS nid, 0.0744224226197791 AS "E" FROM rdb$database UNION ALL SELECT 4 AS nid, -1.2077480105959142 AS "E" FROM rdb$database UNION ALL SELECT 5 AS nid, 1.5491441975162652 AS "E" FROM rdb$database UNION ALL SELECT 8 AS nid, 1.1645200827182243 AS "E" FROM rdb$database UNION ALL SELECT 9 AS nid, 1.2111046798702165 AS "E" FROM rdb$database UNION ALL SELECT 11 AS nid, -1.3595490765186873 AS "E" FROM rdb$database UNION ALL SELECT 12 AS nid, -1.251621745056133 AS "E" FROM rdb$database) AS "Values"), 
"DT_Output_13" AS 
...
"DT_node_data_14" AS 
(SELECT "Values".nid AS nid, CAST("Values"."E" AS DOUBLE PRECISION) AS "E" 
FROM (SELECT 3 AS nid, 1.135864157694164 AS "E" FROM rdb$database UNION ALL SELECT 4 AS nid, 1.3518548370812429 AS "E" FROM rdb$database UNION ALL SELECT 6 AS nid, -0.4726610334665721 AS "E" FROM rdb$database UNION ALL SELECT 7 AS nid, 1.1515365924767922 AS "E" FROM rdb$database UNION ALL SELECT 9 AS nid, -1.2427283654474486 AS "E" FROM rdb$database UNION ALL SELECT 10 AS nid, -1.1451672515691305 AS "E" FROM rdb$database) AS "Values"), 
"DT_Output_14" AS 
...
-- Code For temporary table TMP_20180602_YTS_GB_B6 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180602_YTS_GB_B6" (
	"KEY" BIGINT, 
	"Score_0" DOUBLE PRECISION, 
	"Score_1" DOUBLE PRECISION
)
...
-- Code For temporary table TMP_20180602_YTS_GB_B6 part 2. Populate

INSERT INTO "TMP_20180602_YTS_GB_B6" ("KEY", "Score_0", "Score_1") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1" 
...
"DT_node_data_15" AS 
(SELECT "Values".nid AS nid, CAST("Values"."E" AS DOUBLE PRECISION) AS "E" 
FROM (SELECT 2 AS nid, 1.4931003709313195 AS "E" FROM rdb$database UNION ALL SELECT 4 AS nid, -0.3736476669355103 AS "E" FROM rdb$database UNION ALL SELECT 5 AS nid, 0.9204301051861393 AS "E" FROM rdb$database UNION ALL SELECT 7 AS nid, -1.2143628508478628 AS "E" FROM rdb$database UNION ALL SELECT 8 AS nid, -1.1294597227644136 AS "E" FROM rdb$database) AS "Values"), 
"DT_Output_15" AS 
...
-- Code For temporary table TMP_20180602_9KM_GB_SUM part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180602_9KM_GB_SUM" (
	"KEY" BIGINT NOT NULL, 
	"Score_0" DOUBLE PRECISION, 
	"Score_1" DOUBLE PRECISION, 
	PRIMARY KEY ("KEY")
...
-- Code For temporary table TMP_20180602_9KM_GB_SUM part 2. Populate

INSERT INTO "TMP_20180602_9KM_GB_SUM" ("KEY", "Score_0", "Score_1") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1" 
...
FROM "TMP_20180602_CTO_GB_B0" AS "GB_B0" UNION ALL SELECT "GB_B1"."KEY" AS "KEY", "GB_B1"."Score_0" AS "Score_0", "GB_B1"."Score_1" AS "Score_1" 
FROM "TMP_20180602_HMM_GB_B1" AS "GB_B1" UNION ALL SELECT "GB_B2"."KEY" AS "KEY", "GB_B2"."Score_0" AS "Score_0", "GB_B2"."Score_1" AS "Score_1" 
FROM "TMP_20180602_J16_GB_B2" AS "GB_B2" UNION ALL SELECT "GB_B3"."KEY" AS "KEY", "GB_B3"."Score_0" AS "Score_0", "GB_B3"."Score_1" AS "Score_1" 
FROM "TMP_20180602_6LZ_GB_B3" AS "GB_B3" UNION ALL SELECT "GB_B4"."KEY" AS "KEY", "GB_B4"."Score_0" AS "Score_0", "GB_B4"."Score_1" AS "Score_1" 
FROM "TMP_20180602_U8X_GB_B4" AS "GB_B4" UNION ALL SELECT "GB_B5"."KEY" AS "KEY", "GB_B5"."Score_0" AS "Score_0", "GB_B5"."Score_1" AS "Score_1" 
FROM "TMP_20180602_65E_GB_B5" AS "GB_B5" UNION ALL SELECT "GB_B6"."KEY" AS "KEY", "GB_B6"."Score_0" AS "Score_0", "GB_B6"."Score_1" AS "Score_1" 
FROM "TMP_20180602_YTS_GB_B6" AS "GB_B6") AS "GB_EnsembleUnion")
...
-- Code For temporary table TMP_20180602_9KM_GB_SUM part 3. Create Index 

CREATE INDEX "ix_TMP_20180602_9KM_GB_SUM_KEY" ON "TMP_20180602_9KM_GB_SUM" ("KEY")
...
FROM "TMP_20180602_9KM_GB_SUM" AS "GB_sum"), 
