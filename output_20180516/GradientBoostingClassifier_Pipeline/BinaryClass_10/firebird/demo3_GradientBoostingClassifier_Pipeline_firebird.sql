...
-- Code For temporary table TMP_20180516_CODEGEN_4UYX6D_ADS part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180516_CODEGEN_4UYX6D_ADS" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20180516_CODEGEN_4UYX6D_ADS part 2. Populate

INSERT INTO "TMP_20180516_CODEGEN_4UYX6D_ADS" ("KEY", impter_2, impter_3, impter_4, impter_5, impter_6, impter_7, impter_8, impter_9, impter_10, impter_11) SELECT "U"."KEY", "U".impter_2, "U".impter_3, "U".impter_4, "U".impter_5, "U".impter_6, "U".impter_7, "U".impter_8, "U".impter_9, "U".impter_10, "U".impter_11 
...
-- Code For temporary table TMP_20180516_CODEGEN_4UYX6D_ADS part 3. Create Index 

CREATE INDEX "ix_TMP_20180516_CODEGEN_5dd7" ON "TMP_20180516_CODEGEN_4UYX6D_ADS" ("KEY")

-- Code For temporary table TMP_20180516_CODEGEN_GVZ9CO_ADS part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180516_CODEGEN_GVZ9CO_ADS" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20180516_CODEGEN_GVZ9CO_ADS part 2. Populate

INSERT INTO "TMP_20180516_CODEGEN_GVZ9CO_ADS" ("KEY", scaler_2, scaler_3, scaler_4, scaler_5, scaler_6, scaler_7, scaler_8, scaler_9, scaler_10, scaler_11) SELECT "U"."KEY", "U".scaler_2, "U".scaler_3, "U".scaler_4, "U".scaler_5, "U".scaler_6, "U".scaler_7, "U".scaler_8, "U".scaler_9, "U".scaler_10, "U".scaler_11 
...
FROM "TMP_20180516_CODEGEN_4UYX6D_ADS" AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT") AS "U"

-- Code For temporary table TMP_20180516_CODEGEN_GVZ9CO_ADS part 3. Create Index 

CREATE INDEX "ix_TMP_20180516_CODEGEN_c8af" ON "TMP_20180516_CODEGEN_GVZ9CO_ADS" ("KEY")

-- Code For temporary table TMP_20180516_CODEGEN_K7TIBM_GB_ part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180516_CODEGEN_K7TIBM_GB_" (
	"KEY" BIGINT, 
...
-- Code For temporary table TMP_20180516_CODEGEN_K7TIBM_GB_ part 2. Populate

INSERT INTO "TMP_20180516_CODEGEN_K7TIBM_GB_" ("KEY", "Score_0", "Score_1") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1" 
...
FROM "TMP_20180516_CODEGEN_GVZ9CO_ADS" AS "ADS_sca_2_OUT"), 
"DT_node_data" AS 
...
-- Code For temporary table TMP_20180516_CODEGEN_D9X3XG_GB_ part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180516_CODEGEN_D9X3XG_GB_" (
	"KEY" BIGINT, 
	"Score_0" DOUBLE PRECISION, 
	"Score_1" DOUBLE PRECISION
)
...
-- Code For temporary table TMP_20180516_CODEGEN_D9X3XG_GB_ part 2. Populate

INSERT INTO "TMP_20180516_CODEGEN_D9X3XG_GB_" ("KEY", "Score_0", "Score_1") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1" 
...
-- Code For temporary table TMP_20180516_CODEGEN_8VXWAA_GB_ part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180516_CODEGEN_8VXWAA_GB_" (
	"KEY" BIGINT, 
	"Score_0" DOUBLE PRECISION, 
	"Score_1" DOUBLE PRECISION
)
...
-- Code For temporary table TMP_20180516_CODEGEN_8VXWAA_GB_ part 2. Populate

INSERT INTO "TMP_20180516_CODEGEN_8VXWAA_GB_" ("KEY", "Score_0", "Score_1") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1" 
...
-- Code For temporary table TMP_20180516_CODEGEN_V5501O_GB_ part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180516_CODEGEN_V5501O_GB_" (
	"KEY" BIGINT, 
	"Score_0" DOUBLE PRECISION, 
	"Score_1" DOUBLE PRECISION
)
...
-- Code For temporary table TMP_20180516_CODEGEN_V5501O_GB_ part 2. Populate

INSERT INTO "TMP_20180516_CODEGEN_V5501O_GB_" ("KEY", "Score_0", "Score_1") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1" 
...
-- Code For temporary table TMP_20180516_CODEGEN_VUELT2_GB_ part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180516_CODEGEN_VUELT2_GB_" (
	"KEY" BIGINT NOT NULL, 
	"Score_0" DOUBLE PRECISION, 
	"Score_1" DOUBLE PRECISION, 
	PRIMARY KEY ("KEY")
...
-- Code For temporary table TMP_20180516_CODEGEN_VUELT2_GB_ part 2. Populate

INSERT INTO "TMP_20180516_CODEGEN_VUELT2_GB_" ("KEY", "Score_0", "Score_1") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1" 
...
FROM "TMP_20180516_CODEGEN_K7TIBM_GB_" AS "GB_B0" UNION ALL SELECT "GB_B1"."KEY" AS "KEY", "GB_B1"."Score_0" AS "Score_0", "GB_B1"."Score_1" AS "Score_1" 
FROM "TMP_20180516_CODEGEN_D9X3XG_GB_" AS "GB_B1" UNION ALL SELECT "GB_B2"."KEY" AS "KEY", "GB_B2"."Score_0" AS "Score_0", "GB_B2"."Score_1" AS "Score_1" 
FROM "TMP_20180516_CODEGEN_8VXWAA_GB_" AS "GB_B2" UNION ALL SELECT "GB_B3"."KEY" AS "KEY", "GB_B3"."Score_0" AS "Score_0", "GB_B3"."Score_1" AS "Score_1" 
FROM "TMP_20180516_CODEGEN_V5501O_GB_" AS "GB_B3") AS "GB_EnsembleUnion")
...
-- Code For temporary table TMP_20180516_CODEGEN_VUELT2_GB_ part 3. Create Index 

CREATE INDEX "ix_TMP_20180516_CODEGEN_8eb7" ON "TMP_20180516_CODEGEN_VUELT2_GB_" ("KEY")
...
FROM "TMP_20180516_CODEGEN_VUELT2_GB_" AS "GB_sum"), 
