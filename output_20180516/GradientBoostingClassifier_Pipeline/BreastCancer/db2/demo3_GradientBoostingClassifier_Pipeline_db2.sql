...
-- Code For temporary table tmp_20180508180809_codegen_7mgcki_ads_imp_1_out part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180508180809_codegen_7mgcki_ads_imp_1_out (
	"KEY" BIGINT, 
	impter_2 DOUBLE, 
	impter_3 DOUBLE, 
	impter_4 DOUBLE, 
...
-- Code For temporary table tmp_20180508180809_codegen_7mgcki_ads_imp_1_out part 2. Populate

INSERT INTO tmp_20180508180809_codegen_7mgcki_ads_imp_1_out SELECT "ADS_imp_1_OUT"."KEY", "ADS_imp_1_OUT".impter_2, "ADS_imp_1_OUT".impter_3, "ADS_imp_1_OUT".impter_4, "ADS_imp_1_OUT".impter_5, "ADS_imp_1_OUT".impter_6, "ADS_imp_1_OUT".impter_7, "ADS_imp_1_OUT".impter_8, "ADS_imp_1_OUT".impter_9, "ADS_imp_1_OUT".impter_10, "ADS_imp_1_OUT".impter_11, "ADS_imp_1_OUT".impter_12, "ADS_imp_1_OUT".impter_13, "ADS_imp_1_OUT".impter_14, "ADS_imp_1_OUT".impter_15, "ADS_imp_1_OUT".impter_16, "ADS_imp_1_OUT".impter_17, "ADS_imp_1_OUT".impter_18, "ADS_imp_1_OUT".impter_19, "ADS_imp_1_OUT".impter_20, "ADS_imp_1_OUT".impter_21, "ADS_imp_1_OUT".impter_22, "ADS_imp_1_OUT".impter_23, "ADS_imp_1_OUT".impter_24, "ADS_imp_1_OUT".impter_25, "ADS_imp_1_OUT".impter_26, "ADS_imp_1_OUT".impter_27, "ADS_imp_1_OUT".impter_28, "ADS_imp_1_OUT".impter_29, "ADS_imp_1_OUT".impter_30, "ADS_imp_1_OUT".impter_31 
...
-- Code For temporary table tmp_20180508180809_codegen_ptszqo_ads_sca_2_out part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180508180809_codegen_ptszqo_ads_sca_2_out (
	"KEY" BIGINT, 
	scaler_2 DOUBLE, 
	scaler_3 DOUBLE, 
	scaler_4 DOUBLE, 
...
FROM tmp_20180508180809_codegen_7mgcki_ads_imp_1_out AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT"

-- Code For temporary table tmp_20180508180809_codegen_ltk51q_gb_b0 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180508180809_codegen_ltk51q_gb_b0 (
	"KEY" BIGINT, 
	"Score_0" DOUBLE, 
	"Score_1" DOUBLE
)
...
-- Code For temporary table tmp_20180508180809_codegen_ltk51q_gb_b0 part 2. Populate

INSERT INTO tmp_20180508180809_codegen_ltk51q_gb_b0 WITH "DT_node_lookup" AS 
...
FROM tmp_20180508180809_codegen_ptszqo_ads_sca_2_out AS "ADS_sca_2_OUT"), 
"DT_node_data" AS 
(SELECT "Values".nid AS nid, CAST("Values"."E" AS DOUBLE) AS "E" 
FROM (SELECT 3 AS nid, 1.4672680374970977 AS "E" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 4 AS nid, -2.84375 AS "E" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 6 AS nid, 1.542372881355932 AS "E" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 7 AS nid, -2.5513418079096044 AS "E" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 10 AS nid, 1.542372881355932 AS "E" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 11 AS nid, -2.8126427455222975 AS "E" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 12 AS nid, 1.542372881355932 AS "E" FROM SYSIBM.SYSDUMMY1) AS "Values"), 
"DT_Output" AS 
...
"DT_node_data_1" AS 
(SELECT "Values".nid AS nid, CAST("Values"."E" AS DOUBLE) AS "E" 
FROM (SELECT 3 AS nid, 1.3910810640434235 AS "E" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 4 AS nid, -0.6596363687823121 AS "E" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 5 AS nid, -2.4285605948643654 AS "E" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 8 AS nid, 1.4648507794791157 AS "E" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 9 AS nid, -2.3625649177559 AS "E" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 10 AS nid, 1.4648507794791157 AS "E" FROM SYSIBM.SYSDUMMY1) AS "Values"), 
"DT_Output_1" AS 
...
"DT_node_data_2" AS 
(SELECT "Values".nid AS nid, CAST("Values"."E" AS DOUBLE) AS "E" 
FROM (SELECT 3 AS nid, 1.325752981201139 AS "E" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 4 AS nid, -2.298828759622404 AS "E" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 6 AS nid, -0.41581243138643503 AS "E" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 7 AS nid, -2.1796581996190336 AS "E" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 10 AS nid, 1.4015095712340189 AS "E" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 11 AS nid, -2.0704363544628133 AS "E" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 12 AS nid, 1.4015095712340189 AS "E" FROM SYSIBM.SYSDUMMY1) AS "Values"), 
"DT_Output_2" AS 
...
"DT_node_data_3" AS 
(SELECT "Values".nid AS nid, CAST("Values"."E" AS DOUBLE) AS "E" 
FROM (SELECT 3 AS nid, 1.337391257440793 AS "E" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 4 AS nid, 0.5259058848218274 AS "E" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 6 AS nid, -1.964524712944416 AS "E" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 7 AS nid, -0.3250280638871503 AS "E" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 10 AS nid, 1.3490029638835022 AS "E" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 11 AS nid, -1.864903415871084 AS "E" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 12 AS nid, 1.3490029638835022 AS "E" FROM SYSIBM.SYSDUMMY1) AS "Values"), 
"DT_Output_3" AS 
...
"DT_node_data_4" AS 
(SELECT "Values".nid AS nid, CAST("Values"."E" AS DOUBLE) AS "E" 
FROM (SELECT 3 AS nid, 1.2252582301094506 AS "E" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 4 AS nid, -0.6444012093376688 AS "E" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 6 AS nid, -1.8831833870360208 AS "E" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 7 AS nid, -1.7537720394216378 AS "E" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 10 AS nid, 1.304959846853716 AS "E" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 11 AS nid, -1.7123629964831781 AS "E" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 12 AS nid, 1.304959846853716 AS "E" FROM SYSIBM.SYSDUMMY1) AS "Values"), 
"DT_Output_4" AS 
...
-- Code For temporary table tmp_20180508180809_codegen_4feach_gb_b1 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180508180809_codegen_4feach_gb_b1 (
	"KEY" BIGINT, 
	"Score_0" DOUBLE, 
	"Score_1" DOUBLE
)
...
-- Code For temporary table tmp_20180508180809_codegen_4feach_gb_b1 part 2. Populate

INSERT INTO tmp_20180508180809_codegen_4feach_gb_b1 WITH "DT_node_lookup_5" AS 
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", CASE WHEN ("ADS_sca_2_OUT".scaler_29 <= 0.48149049282073975) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_25 <= 0.15994150936603546) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_29 <= 0.1327483057975769) THEN 3 ELSE 4 END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_28 <= -0.3612968325614929) THEN 6 ELSE 7 END END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_18 <= 3.273360252380371) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_28 <= -0.2999221384525299) THEN 10 ELSE 11 END ELSE 12 END END AS node_id_2 
FROM tmp_20180508180809_codegen_ptszqo_ads_sca_2_out AS "ADS_sca_2_OUT"), 
"DT_node_data_5" AS 
(SELECT "Values".nid AS nid, CAST("Values"."E" AS DOUBLE) AS "E" 
FROM (SELECT 3 AS nid, 1.2415089447386418 AS "E" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 4 AS nid, 0.30503527183452517 AS "E" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 6 AS nid, -0.21670809809280697 AS "E" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 7 AS nid, -1.7137770178917424 AS "E" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 10 AS nid, 1.2676510643808934 AS "E" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 11 AS nid, -1.5947285027219134 AS "E" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 12 AS nid, 1.2676510643808934 AS "E" FROM SYSIBM.SYSDUMMY1) AS "Values"), 
"DT_Output_5" AS 
...
"DT_node_data_6" AS 
(SELECT "Values".nid AS nid, CAST("Values"."E" AS DOUBLE) AS "E" 
FROM (SELECT 3 AS nid, 1.1431754507972833 AS "E" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 4 AS nid, -2.154747136176465 AS "E" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 6 AS nid, 1.3937977212659114 AS "E" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 7 AS nid, -1.4053585903840005 AS "E" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 10 AS nid, 1.2357846827064884 AS "E" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 11 AS nid, -1.5013341803568825 AS "E" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 12 AS nid, 1.2357846827064884 AS "E" FROM SYSIBM.SYSDUMMY1) AS "Values"), 
"DT_Output_6" AS 
...
"DT_node_data_7" AS 
(SELECT "Values".nid AS nid, CAST("Values"."E" AS DOUBLE) AS "E" 
FROM (SELECT 3 AS nid, 1.1140638313109361 AS "E" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 4 AS nid, -0.6850547208862369 AS "E" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 6 AS nid, -1.622042151312407 AS "E" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 7 AS nid, -1.463316569996885 AS "E" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 10 AS nid, -0.6223244208798957 AS "E" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 11 AS nid, -1.458362111766775 AS "E" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 12 AS nid, 1.2083752537625256 AS "E" FROM SYSIBM.SYSDUMMY1) AS "Values"), 
"DT_Output_7" AS 
...
"DT_node_data_8" AS 
(SELECT "Values".nid AS nid, CAST("Values"."E" AS DOUBLE) AS "E" 
FROM (SELECT 3 AS nid, 1.170082852660399 AS "E" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 4 AS nid, -0.7688817876615806 AS "E" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 6 AS nid, -5.312663161823737 AS "E" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 7 AS nid, -0.3499135131559847 AS "E" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 10 AS nid, 1.2604609511249625 AS "E" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 11 AS nid, -1.39616203133061 AS "E" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 13 AS nid, 1.2045413152456894 AS "E" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 14 AS nid, -1.375147552727802 AS "E" FROM SYSIBM.SYSDUMMY1) AS "Values"), 
"DT_Output_8" AS 
...
"DT_node_data_9" AS 
(SELECT "Values".nid AS nid, CAST("Values"."E" AS DOUBLE) AS "E" 
FROM (SELECT 3 AS nid, -1.2313893936130431 AS "E" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 4 AS nid, 1.0404918231271474 AS "E" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 6 AS nid, -1.4609496820265393 AS "E" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 7 AS nid, -1.348935694543427 AS "E" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 10 AS nid, -0.4909139260216936 AS "E" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 11 AS nid, -1.3496117136742993 AS "E" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 12 AS nid, 1.1912333451680777 AS "E" FROM SYSIBM.SYSDUMMY1) AS "Values"), 
"DT_Output_9" AS 
...
-- Code For temporary table tmp_20180508180809_codegen_s8uzuj_gb_b2 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180508180809_codegen_s8uzuj_gb_b2 (
	"KEY" BIGINT, 
	"Score_0" DOUBLE, 
	"Score_1" DOUBLE
)
...
-- Code For temporary table tmp_20180508180809_codegen_s8uzuj_gb_b2 part 2. Populate

INSERT INTO tmp_20180508180809_codegen_s8uzuj_gb_b2 WITH "DT_node_lookup_10" AS 
...
"DT_node_data_10" AS 
(SELECT "Values".nid AS nid, CAST("Values"."E" AS DOUBLE) AS "E" 
FROM (SELECT 3 AS nid, 1.1573788010278787 AS "E" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 4 AS nid, -0.24332334325649765 AS "E" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 6 AS nid, -3.813244609114664 AS "E" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 7 AS nid, -0.28311533886774737 AS "E" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 10 AS nid, 1.2081843772263323 AS "E" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 11 AS nid, -1.301040835931553 AS "E" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 13 AS nid, -5.5232853654050516 AS "E" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 14 AS nid, -1.228061813737884 AS "E" FROM SYSIBM.SYSDUMMY1) AS "Values"), 
"DT_Output_10" AS 
...
"DT_node_data_11" AS 
(SELECT "Values".nid AS nid, CAST("Values"."E" AS DOUBLE) AS "E" 
FROM (SELECT 3 AS nid, 1.0130050080939823 AS "E" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 4 AS nid, -0.6085975537753274 AS "E" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 6 AS nid, -1.35226641067665 AS "E" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 7 AS nid, -1.2697380467331816 AS "E" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 10 AS nid, 1.248133592056964 AS "E" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 11 AS nid, -1.2355331057844585 AS "E" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 12 AS nid, 1.174632293648151 AS "E" FROM SYSIBM.SYSDUMMY1) AS "Values"), 
"DT_Output_11" AS 
...
"DT_node_data_12" AS 
(SELECT "Values".nid AS nid, CAST("Values"."E" AS DOUBLE) AS "E" 
FROM (SELECT 3 AS nid, 1.1129323613426614 AS "E" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 4 AS nid, -0.3833120183862359 AS "E" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 6 AS nid, -2.512518864432701 AS "E" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 7 AS nid, 1.3964432581512807 AS "E" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 10 AS nid, 1.175433734908052 AS "E" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 11 AS nid, -1.2330697012930862 AS "E" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 13 AS nid, 0.13615090246014946 AS "E" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 14 AS nid, -1.2503365564467128 AS "E" FROM SYSIBM.SYSDUMMY1) AS "Values"), 
"DT_Output_12" AS 
...
"DT_node_data_13" AS 
(SELECT "Values".nid AS nid, CAST("Values"."E" AS DOUBLE) AS "E" 
FROM (SELECT 3 AS nid, -1.728247179407999 AS "E" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 4 AS nid, 1.0122933091300323 AS "E" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 6 AS nid, -1.2961392831818679 AS "E" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 7 AS nid, -1.2121769656039516 AS "E" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 10 AS nid, 1.1616683622263533 AS "E" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 11 AS nid, -1.253400761953175 AS "E" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 13 AS nid, -0.2370429284357811 AS "E" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 14 AS nid, -1.2514709178702141 AS "E" FROM SYSIBM.SYSDUMMY1) AS "Values"), 
"DT_Output_13" AS 
...
"DT_node_data_14" AS 
(SELECT "Values".nid AS nid, CAST("Values"."E" AS DOUBLE) AS "E" 
FROM (SELECT 3 AS nid, 1.015313346764975 AS "E" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 4 AS nid, -1.2320153919118215 AS "E" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 6 AS nid, -2.340648965439501 AS "E" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 7 AS nid, 1.311580978429844 AS "E" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 10 AS nid, 1.4370603152604646 AS "E" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 11 AS nid, -1.0100591137193176 AS "E" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 13 AS nid, -6.67333385029474 AS "E" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 14 AS nid, -1.1537588917855885 AS "E" FROM SYSIBM.SYSDUMMY1) AS "Values"), 
"DT_Output_14" AS 
...
-- Code For temporary table tmp_20180508180809_codegen_rzyte9_gb_b3 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180508180809_codegen_rzyte9_gb_b3 (
	"KEY" BIGINT, 
	"Score_0" DOUBLE, 
	"Score_1" DOUBLE
)
...
-- Code For temporary table tmp_20180508180809_codegen_rzyte9_gb_b3 part 2. Populate

INSERT INTO tmp_20180508180809_codegen_rzyte9_gb_b3 WITH "DT_node_lookup_15" AS 
...
"DT_node_data_15" AS 
(SELECT "Values".nid AS nid, CAST("Values"."E" AS DOUBLE) AS "E" 
FROM (SELECT 3 AS nid, 0.8646324817801285 AS "E" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 4 AS nid, 3.5719361261467393 AS "E" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 6 AS nid, -1.205331690676246 AS "E" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 7 AS nid, 1.111745945147061 AS "E" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 9 AS nid, -3.708144152948966 AS "E" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 11 AS nid, -0.010190020632271308 AS "E" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 12 AS nid, -1.146306323182662 AS "E" FROM SYSIBM.SYSDUMMY1) AS "Values"), 
"DT_Output_15" AS 
...
-- Code For temporary table tmp_20180508180809_codegen_bg0tkd_gb_union part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180508180809_codegen_bg0tkd_gb_union (
	"KEY" BIGINT, 
	"Score_0" DOUBLE, 
	"Score_1" DOUBLE
)
...
-- Code For temporary table tmp_20180508180809_codegen_bg0tkd_gb_union part 2. Populate

INSERT INTO tmp_20180508180809_codegen_bg0tkd_gb_union SELECT "GB_Union"."KEY", "GB_Union"."Score_0", "GB_Union"."Score_1" 
...
FROM tmp_20180508180809_codegen_ltk51q_gb_b0 AS "GB_B0" UNION ALL SELECT "GB_B1"."KEY" AS "KEY", "GB_B1"."Score_0" AS "Score_0", "GB_B1"."Score_1" AS "Score_1" 
FROM tmp_20180508180809_codegen_4feach_gb_b1 AS "GB_B1" UNION ALL SELECT "GB_B2"."KEY" AS "KEY", "GB_B2"."Score_0" AS "Score_0", "GB_B2"."Score_1" AS "Score_1" 
FROM tmp_20180508180809_codegen_s8uzuj_gb_b2 AS "GB_B2" UNION ALL SELECT "GB_B3"."KEY" AS "KEY", "GB_B3"."Score_0" AS "Score_0", "GB_B3"."Score_1" AS "Score_1" 
FROM tmp_20180508180809_codegen_rzyte9_gb_b3 AS "GB_B3") AS "GB_EnsembleUnion") AS "GB_Union"

-- Code For temporary table tmp_20180508180809_codegen_0my06o_gb_sum part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180508180809_codegen_0my06o_gb_sum (
	"KEY" BIGINT, 
	"Score_0" DOUBLE, 
	"Score_1" DOUBLE
)
...
-- Code For temporary table tmp_20180508180809_codegen_0my06o_gb_sum part 2. Populate

INSERT INTO tmp_20180508180809_codegen_0my06o_gb_sum SELECT "GB_sum"."KEY", "GB_sum"."Score_0", "GB_sum"."Score_1" 
...
FROM tmp_20180508180809_codegen_bg0tkd_gb_union AS "GB_Union" GROUP BY "GB_Union"."KEY") AS "T") AS "GB_sum"
...
FROM tmp_20180508180809_codegen_0my06o_gb_sum AS "GB_sum"), 
