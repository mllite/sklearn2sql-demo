...
-- Code For temporary table TMP_20180516_CODEGEN_51NCCV_ADS part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180516_CODEGEN_51NCCV_ADS" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20180516_CODEGEN_51NCCV_ADS part 3. Create Index 

CREATE INDEX "ix_TMP_20180516_CODEGEN_9e48" ON "TMP_20180516_CODEGEN_51NCCV_ADS" ("KEY")

-- Code For temporary table TMP_20180516_CODEGEN_WMYAN6_ADS part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180516_CODEGEN_WMYAN6_ADS" (
	"KEY" BIGINT NOT NULL, 
...
FROM "TMP_20180516_CODEGEN_51NCCV_ADS" AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT") AS "U"

-- Code For temporary table TMP_20180516_CODEGEN_WMYAN6_ADS part 3. Create Index 

CREATE INDEX "ix_TMP_20180516_CODEGEN_0556" ON "TMP_20180516_CODEGEN_WMYAN6_ADS" ("KEY")

-- Code For temporary table TMP_20180516_CODEGEN_ADEIMC_GB_ part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180516_CODEGEN_ADEIMC_GB_" (
	"KEY" BIGINT, 
...
-- Code For temporary table TMP_20180516_CODEGEN_ADEIMC_GB_ part 2. Populate

INSERT INTO "TMP_20180516_CODEGEN_ADEIMC_GB_" ("KEY", "Score_0", "Score_1") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1" 
...
FROM "TMP_20180516_CODEGEN_WMYAN6_ADS" AS "ADS_sca_2_OUT"), 
"DT_node_data" AS 
...
-- Code For temporary table TMP_20180516_CODEGEN_ELML7V_GB_ part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180516_CODEGEN_ELML7V_GB_" (
	"KEY" BIGINT, 
	"Score_0" DOUBLE PRECISION, 
	"Score_1" DOUBLE PRECISION
)
...
-- Code For temporary table TMP_20180516_CODEGEN_ELML7V_GB_ part 2. Populate

INSERT INTO "TMP_20180516_CODEGEN_ELML7V_GB_" ("KEY", "Score_0", "Score_1") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1" 
...
-- Code For temporary table TMP_20180516_CODEGEN_CZLQ1A_GB_ part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180516_CODEGEN_CZLQ1A_GB_" (
	"KEY" BIGINT, 
	"Score_0" DOUBLE PRECISION, 
	"Score_1" DOUBLE PRECISION
)
...
-- Code For temporary table TMP_20180516_CODEGEN_CZLQ1A_GB_ part 2. Populate

INSERT INTO "TMP_20180516_CODEGEN_CZLQ1A_GB_" ("KEY", "Score_0", "Score_1") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1" 
...
-- Code For temporary table TMP_20180516_CODEGEN_1GVHIP_GB_ part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180516_CODEGEN_1GVHIP_GB_" (
	"KEY" BIGINT, 
	"Score_0" DOUBLE PRECISION, 
	"Score_1" DOUBLE PRECISION
)
...
-- Code For temporary table TMP_20180516_CODEGEN_1GVHIP_GB_ part 2. Populate

INSERT INTO "TMP_20180516_CODEGEN_1GVHIP_GB_" ("KEY", "Score_0", "Score_1") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1" 
...
-- Code For temporary table TMP_20180516_CODEGEN_RLWY87_GB_ part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180516_CODEGEN_RLWY87_GB_" (
	"KEY" BIGINT NOT NULL, 
	"Score_0" DOUBLE PRECISION, 
	"Score_1" DOUBLE PRECISION, 
	PRIMARY KEY ("KEY")
...
-- Code For temporary table TMP_20180516_CODEGEN_RLWY87_GB_ part 2. Populate

INSERT INTO "TMP_20180516_CODEGEN_RLWY87_GB_" ("KEY", "Score_0", "Score_1") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1" 
...
FROM "TMP_20180516_CODEGEN_ADEIMC_GB_" AS "GB_B0" UNION ALL SELECT "GB_B1"."KEY" AS "KEY", "GB_B1"."Score_0" AS "Score_0", "GB_B1"."Score_1" AS "Score_1" 
FROM "TMP_20180516_CODEGEN_ELML7V_GB_" AS "GB_B1" UNION ALL SELECT "GB_B2"."KEY" AS "KEY", "GB_B2"."Score_0" AS "Score_0", "GB_B2"."Score_1" AS "Score_1" 
FROM "TMP_20180516_CODEGEN_CZLQ1A_GB_" AS "GB_B2" UNION ALL SELECT "GB_B3"."KEY" AS "KEY", "GB_B3"."Score_0" AS "Score_0", "GB_B3"."Score_1" AS "Score_1" 
FROM "TMP_20180516_CODEGEN_1GVHIP_GB_" AS "GB_B3") AS "GB_EnsembleUnion")
...
-- Code For temporary table TMP_20180516_CODEGEN_RLWY87_GB_ part 3. Create Index 

CREATE INDEX "ix_TMP_20180516_CODEGEN_738d" ON "TMP_20180516_CODEGEN_RLWY87_GB_" ("KEY")
...
FROM "TMP_20180516_CODEGEN_RLWY87_GB_" AS "GB_sum"), 
