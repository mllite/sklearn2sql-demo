...
-- Code For temporary table tmp_20180516111659_codegen_pyxwnm_ads_imp_1_out part 2. Populate

SELECT * FROM `tmp_20180516111659_codegen_pyxwnm_ads_imp_1_out`

-- Code For temporary table tmp_20180516111659_codegen_a4fez9_ads_sca_2_out part 1. Create 

CREATE TEMPORARY TABLE `tmp_20180516111659_codegen_a4fez9_ads_sca_2_out` STORED AS ORC AS SELECT `ADS_sca_2_OUT`.`KEY`, `ADS_sca_2_OUT`.`scaler_2`, `ADS_sca_2_OUT`.`scaler_3`, `ADS_sca_2_OUT`.`scaler_4`, `ADS_sca_2_OUT`.`scaler_5`, `ADS_sca_2_OUT`.`scaler_6`, `ADS_sca_2_OUT`.`scaler_7`, `ADS_sca_2_OUT`.`scaler_8`, `ADS_sca_2_OUT`.`scaler_9`, `ADS_sca_2_OUT`.`scaler_10`, `ADS_sca_2_OUT`.`scaler_11`, `ADS_sca_2_OUT`.`scaler_12`, `ADS_sca_2_OUT`.`scaler_13`, `ADS_sca_2_OUT`.`scaler_14`, `ADS_sca_2_OUT`.`scaler_15`, `ADS_sca_2_OUT`.`scaler_16`, `ADS_sca_2_OUT`.`scaler_17`, `ADS_sca_2_OUT`.`scaler_18`, `ADS_sca_2_OUT`.`scaler_19`, `ADS_sca_2_OUT`.`scaler_20`, `ADS_sca_2_OUT`.`scaler_21`, `ADS_sca_2_OUT`.`scaler_22`, `ADS_sca_2_OUT`.`scaler_23`, `ADS_sca_2_OUT`.`scaler_24`, `ADS_sca_2_OUT`.`scaler_25`, `ADS_sca_2_OUT`.`scaler_26`, `ADS_sca_2_OUT`.`scaler_27`, `ADS_sca_2_OUT`.`scaler_28`, `ADS_sca_2_OUT`.`scaler_29`, `ADS_sca_2_OUT`.`scaler_30`, `ADS_sca_2_OUT`.`scaler_31` 
...
FROM `tmp_20180516111659_codegen_pyxwnm_ads_imp_1_out` AS `ADS_imp_1_OUT`) AS `ADS_sca_2_OUT`

-- Code For temporary table tmp_20180516111659_codegen_a4fez9_ads_sca_2_out part 2. Populate

SELECT * FROM `tmp_20180516111659_codegen_a4fez9_ads_sca_2_out`

-- Code For temporary table tmp_20180516111659_codegen_0kytlm_gb_b0 part 1. Create 

CREATE TEMPORARY TABLE `tmp_20180516111659_codegen_0kytlm_gb_b0` STORED AS ORC AS WITH `DT_node_lookup` AS 
...
FROM `tmp_20180516111659_codegen_a4fez9_ads_sca_2_out` AS `ADS_sca_2_OUT`), 
`DT_node_data` AS 
...
-- Code For temporary table tmp_20180516111659_codegen_0kytlm_gb_b0 part 2. Populate

SELECT * FROM `tmp_20180516111659_codegen_0kytlm_gb_b0`

-- Code For temporary table tmp_20180516111659_codegen_dki8rb_gb_b1 part 1. Create 

CREATE TEMPORARY TABLE `tmp_20180516111659_codegen_dki8rb_gb_b1` STORED AS ORC AS WITH `DT_node_lookup_5` AS 
...
-- Code For temporary table tmp_20180516111659_codegen_dki8rb_gb_b1 part 2. Populate

SELECT * FROM `tmp_20180516111659_codegen_dki8rb_gb_b1`

-- Code For temporary table tmp_20180516111659_codegen_ii201n_gb_b2 part 1. Create 

CREATE TEMPORARY TABLE `tmp_20180516111659_codegen_ii201n_gb_b2` STORED AS ORC AS WITH `DT_node_lookup_10` AS 
...
-- Code For temporary table tmp_20180516111659_codegen_ii201n_gb_b2 part 2. Populate

SELECT * FROM `tmp_20180516111659_codegen_ii201n_gb_b2`

-- Code For temporary table tmp_20180516111659_codegen_8364vm_gb_b3 part 1. Create 

CREATE TEMPORARY TABLE `tmp_20180516111659_codegen_8364vm_gb_b3` STORED AS ORC AS WITH `DT_node_lookup_15` AS 
...
-- Code For temporary table tmp_20180516111659_codegen_8364vm_gb_b3 part 2. Populate

SELECT * FROM `tmp_20180516111659_codegen_8364vm_gb_b3`

-- Code For temporary table tmp_20180516111659_codegen_phcdj3_gb_sum part 1. Create 

CREATE TEMPORARY TABLE `tmp_20180516111659_codegen_phcdj3_gb_sum` STORED AS ORC AS WITH `GB_Union` AS 
...
FROM `tmp_20180516111659_codegen_0kytlm_gb_b0` AS `GB_B0` UNION ALL SELECT `GB_B1`.`KEY` AS `KEY`, `GB_B1`.`Score_0` AS `Score_0`, `GB_B1`.`Score_1` AS `Score_1` 
FROM `tmp_20180516111659_codegen_dki8rb_gb_b1` AS `GB_B1` UNION ALL SELECT `GB_B2`.`KEY` AS `KEY`, `GB_B2`.`Score_0` AS `Score_0`, `GB_B2`.`Score_1` AS `Score_1` 
FROM `tmp_20180516111659_codegen_ii201n_gb_b2` AS `GB_B2` UNION ALL SELECT `GB_B3`.`KEY` AS `KEY`, `GB_B3`.`Score_0` AS `Score_0`, `GB_B3`.`Score_1` AS `Score_1` 
FROM `tmp_20180516111659_codegen_8364vm_gb_b3` AS `GB_B3`) AS `GB_EnsembleUnion`)
...
-- Code For temporary table tmp_20180516111659_codegen_phcdj3_gb_sum part 2. Populate

SELECT * FROM `tmp_20180516111659_codegen_phcdj3_gb_sum`
...
FROM `tmp_20180516111659_codegen_phcdj3_gb_sum` AS `GB_sum`), 
