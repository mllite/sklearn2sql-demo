...
-- Code For temporary table DEGEN_KHMR1Z_ADS_IMP_1_OUT part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "DEGEN_KHMR1Z_ADS_IMP_1_OUT" (
	"KEY" NUMBER(19), 
...
-- Code For temporary table DEGEN_KHMR1Z_ADS_IMP_1_OUT part 2. Populate

INSERT INTO "DEGEN_KHMR1Z_ADS_IMP_1_OUT" ("KEY", imputer_output_2, imputer_output_3, imputer_output_4, imputer_output_5) SELECT "U"."KEY", "U".imputer_output_2, "U".imputer_output_3, "U".imputer_output_4, "U".imputer_output_5 
...
-- Code For temporary table DEGEN_VM53QI_ADS_SCA_2_OUT part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "DEGEN_VM53QI_ADS_SCA_2_OUT" (
	"KEY" NUMBER(19), 
...
-- Code For temporary table DEGEN_VM53QI_ADS_SCA_2_OUT part 2. Populate

INSERT INTO "DEGEN_VM53QI_ADS_SCA_2_OUT" ("KEY", scaler_output_2, scaler_output_3, scaler_output_4, scaler_output_5) SELECT "U"."KEY", "U".scaler_output_2, "U".scaler_output_3, "U".scaler_output_4, "U".scaler_output_5 
...
FROM "DEGEN_KHMR1Z_ADS_IMP_1_OUT" "ADS_imp_1_OUT") "ADS_sca_2_OUT") "U"

-- Code For temporary table 90603_CODEGEN_LRSH68_GB_B0 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "90603_CODEGEN_LRSH68_GB_B0" (
	"KEY" NUMBER(19), 
...
-- Code For temporary table 90603_CODEGEN_LRSH68_GB_B0 part 2. Populate

INSERT INTO "90603_CODEGEN_LRSH68_GB_B0" ("KEY", "Score_CLASS_0", "Score_CLASS_1", "Score_CLASS_2") SELECT "U"."KEY", "U"."Score_CLASS_0", "U"."Score_CLASS_1", "U"."Score_CLASS_2" 
...
FROM "DEGEN_VM53QI_ADS_SCA_2_OUT" "ADS_sca_2_OUT"), 
"DT_node_data" AS 
...
-- Code For temporary table 90603_CODEGEN_LBE14G_GB_B1 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "90603_CODEGEN_LBE14G_GB_B1" (
	"KEY" NUMBER(19), 
	"Score_CLASS_0" BINARY_DOUBLE, 
	"Score_CLASS_1" BINARY_DOUBLE, 
	"Score_CLASS_2" BINARY_DOUBLE
...
-- Code For temporary table 90603_CODEGEN_LBE14G_GB_B1 part 2. Populate

INSERT INTO "90603_CODEGEN_LBE14G_GB_B1" ("KEY", "Score_CLASS_0", "Score_CLASS_1", "Score_CLASS_2") SELECT "U"."KEY", "U"."Score_CLASS_0", "U"."Score_CLASS_1", "U"."Score_CLASS_2" 
...
-- Code For temporary table 90603_CODEGEN_1ICS7O_GB_B2 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "90603_CODEGEN_1ICS7O_GB_B2" (
	"KEY" NUMBER(19), 
	"Score_CLASS_0" BINARY_DOUBLE, 
	"Score_CLASS_1" BINARY_DOUBLE, 
	"Score_CLASS_2" BINARY_DOUBLE
...
-- Code For temporary table 90603_CODEGEN_1ICS7O_GB_B2 part 2. Populate

INSERT INTO "90603_CODEGEN_1ICS7O_GB_B2" ("KEY", "Score_CLASS_0", "Score_CLASS_1", "Score_CLASS_2") SELECT "U"."KEY", "U"."Score_CLASS_0", "U"."Score_CLASS_1", "U"."Score_CLASS_2" 
...
-- Code For temporary table 90603_CODEGEN_DHL8FZ_GB_B3 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "90603_CODEGEN_DHL8FZ_GB_B3" (
	"KEY" NUMBER(19), 
	"Score_CLASS_0" BINARY_DOUBLE, 
	"Score_CLASS_1" BINARY_DOUBLE, 
	"Score_CLASS_2" BINARY_DOUBLE
...
-- Code For temporary table 90603_CODEGEN_DHL8FZ_GB_B3 part 2. Populate

INSERT INTO "90603_CODEGEN_DHL8FZ_GB_B3" ("KEY", "Score_CLASS_0", "Score_CLASS_1", "Score_CLASS_2") SELECT "U"."KEY", "U"."Score_CLASS_0", "U"."Score_CLASS_1", "U"."Score_CLASS_2" 
...
-- Code For temporary table 90603_CODEGEN_V1U460_GB_B4 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "90603_CODEGEN_V1U460_GB_B4" (
	"KEY" NUMBER(19), 
	"Score_CLASS_0" BINARY_DOUBLE, 
	"Score_CLASS_1" BINARY_DOUBLE, 
	"Score_CLASS_2" BINARY_DOUBLE
...
-- Code For temporary table 90603_CODEGEN_V1U460_GB_B4 part 2. Populate

INSERT INTO "90603_CODEGEN_V1U460_GB_B4" ("KEY", "Score_CLASS_0", "Score_CLASS_1", "Score_CLASS_2") SELECT "U"."KEY", "U"."Score_CLASS_0", "U"."Score_CLASS_1", "U"."Score_CLASS_2" 
...
-- Code For temporary table 03_CODEGEN_AY6Z7D_GB_UNION part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "03_CODEGEN_AY6Z7D_GB_UNION" (
	"KEY" NUMBER(19), 
	"Score_CLASS_0" BINARY_DOUBLE, 
	"Score_CLASS_1" BINARY_DOUBLE, 
	"Score_CLASS_2" BINARY_DOUBLE
...
-- Code For temporary table 03_CODEGEN_AY6Z7D_GB_UNION part 2. Populate

INSERT INTO "03_CODEGEN_AY6Z7D_GB_UNION" ("KEY", "Score_CLASS_0", "Score_CLASS_1", "Score_CLASS_2") SELECT "U"."KEY", "U"."Score_CLASS_0", "U"."Score_CLASS_1", "U"."Score_CLASS_2" 
...
FROM "90603_CODEGEN_LRSH68_GB_B0" "GB_B0" UNION ALL SELECT "GB_B1"."KEY" AS "KEY", "GB_B1"."Score_CLASS_0" AS "Score_CLASS_0", "GB_B1"."Score_CLASS_1" AS "Score_CLASS_1", "GB_B1"."Score_CLASS_2" AS "Score_CLASS_2" 
FROM "90603_CODEGEN_LBE14G_GB_B1" "GB_B1" UNION ALL SELECT "GB_B2"."KEY" AS "KEY", "GB_B2"."Score_CLASS_0" AS "Score_CLASS_0", "GB_B2"."Score_CLASS_1" AS "Score_CLASS_1", "GB_B2"."Score_CLASS_2" AS "Score_CLASS_2" 
FROM "90603_CODEGEN_1ICS7O_GB_B2" "GB_B2" UNION ALL SELECT "GB_B3"."KEY" AS "KEY", "GB_B3"."Score_CLASS_0" AS "Score_CLASS_0", "GB_B3"."Score_CLASS_1" AS "Score_CLASS_1", "GB_B3"."Score_CLASS_2" AS "Score_CLASS_2" 
FROM "90603_CODEGEN_DHL8FZ_GB_B3" "GB_B3" UNION ALL SELECT "GB_B4"."KEY" AS "KEY", "GB_B4"."Score_CLASS_0" AS "Score_CLASS_0", "GB_B4"."Score_CLASS_1" AS "Score_CLASS_1", "GB_B4"."Score_CLASS_2" AS "Score_CLASS_2" 
FROM "90603_CODEGEN_V1U460_GB_B4" "GB_B4") "GB_EnsembleUnion") "GB_Union") "U"

-- Code For temporary table 0603_CODEGEN_NRA8D2_GB_SUM part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "0603_CODEGEN_NRA8D2_GB_SUM" (
	"KEY" NUMBER(19), 
	"Score_CLASS_0" BINARY_DOUBLE, 
	"Score_CLASS_1" BINARY_DOUBLE, 
	"Score_CLASS_2" BINARY_DOUBLE
...
-- Code For temporary table 0603_CODEGEN_NRA8D2_GB_SUM part 2. Populate

INSERT INTO "0603_CODEGEN_NRA8D2_GB_SUM" ("KEY", "Score_CLASS_0", "Score_CLASS_1", "Score_CLASS_2") SELECT "U"."KEY", "U"."Score_CLASS_0", "U"."Score_CLASS_1", "U"."Score_CLASS_2" 
...
FROM "03_CODEGEN_AY6Z7D_GB_UNION" "GB_Union" GROUP BY "GB_Union"."KEY") "T") "GB_sum") "U"
...
FROM "0603_CODEGEN_NRA8D2_GB_SUM" "GB_sum"), 
