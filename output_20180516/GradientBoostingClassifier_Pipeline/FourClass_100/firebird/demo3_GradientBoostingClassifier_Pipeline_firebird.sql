...
-- Code For temporary table TMP_20180508181740_CODEGEN_6VDK part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508181740_CODEGEN_6VDK" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20180508181740_CODEGEN_6VDK part 3. Create Index 

CREATE INDEX "ix_TMP_20180508181740_C_7ee0" ON "TMP_20180508181740_CODEGEN_6VDK" ("KEY")

-- Code For temporary table TMP_20180508181741_CODEGEN_F561 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508181741_CODEGEN_F561" (
	"KEY" BIGINT NOT NULL, 
...
FROM "TMP_20180508181740_CODEGEN_6VDK" AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT") AS "U"

-- Code For temporary table TMP_20180508181741_CODEGEN_F561 part 3. Create Index 

CREATE INDEX "ix_TMP_20180508181741_C_5284" ON "TMP_20180508181741_CODEGEN_F561" ("KEY")

-- Code For temporary table TMP_20180508181741_CODEGEN_Y3A9 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508181741_CODEGEN_Y3A9" (
	"KEY" BIGINT, 
...
-- Code For temporary table TMP_20180508181741_CODEGEN_Y3A9 part 2. Populate

INSERT INTO "TMP_20180508181741_CODEGEN_Y3A9" ("KEY", "Score_0", "Score_1", "Score_2", "Score_3") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1", "U"."Score_2", "U"."Score_3" 
...
FROM "TMP_20180508181741_CODEGEN_F561" AS "ADS_sca_2_OUT"), 
"DT_node_data" AS 
...
-- Code For temporary table TMP_20180508181741_CODEGEN_33OK part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508181741_CODEGEN_33OK" (
	"KEY" BIGINT, 
	"Score_0" DOUBLE PRECISION, 
	"Score_1" DOUBLE PRECISION, 
	"Score_2" DOUBLE PRECISION, 
...
-- Code For temporary table TMP_20180508181741_CODEGEN_33OK part 2. Populate

INSERT INTO "TMP_20180508181741_CODEGEN_33OK" ("KEY", "Score_0", "Score_1", "Score_2", "Score_3") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1", "U"."Score_2", "U"."Score_3" 
...
-- Code For temporary table TMP_20180508181741_CODEGEN_C8VB part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508181741_CODEGEN_C8VB" (
	"KEY" BIGINT, 
	"Score_0" DOUBLE PRECISION, 
	"Score_1" DOUBLE PRECISION, 
	"Score_2" DOUBLE PRECISION, 
...
-- Code For temporary table TMP_20180508181741_CODEGEN_C8VB part 2. Populate

INSERT INTO "TMP_20180508181741_CODEGEN_C8VB" ("KEY", "Score_0", "Score_1", "Score_2", "Score_3") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1", "U"."Score_2", "U"."Score_3" 
...
-- Code For temporary table TMP_20180508181741_CODEGEN_OYOA part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508181741_CODEGEN_OYOA" (
	"KEY" BIGINT, 
	"Score_0" DOUBLE PRECISION, 
	"Score_1" DOUBLE PRECISION, 
	"Score_2" DOUBLE PRECISION, 
...
-- Code For temporary table TMP_20180508181741_CODEGEN_OYOA part 2. Populate

INSERT INTO "TMP_20180508181741_CODEGEN_OYOA" ("KEY", "Score_0", "Score_1", "Score_2", "Score_3") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1", "U"."Score_2", "U"."Score_3" 
...
-- Code For temporary table TMP_20180508181741_CODEGEN_CX1Q part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508181741_CODEGEN_CX1Q" (
	"KEY" BIGINT, 
	"Score_0" DOUBLE PRECISION, 
	"Score_1" DOUBLE PRECISION, 
	"Score_2" DOUBLE PRECISION, 
...
-- Code For temporary table TMP_20180508181741_CODEGEN_CX1Q part 2. Populate

INSERT INTO "TMP_20180508181741_CODEGEN_CX1Q" ("KEY", "Score_0", "Score_1", "Score_2", "Score_3") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1", "U"."Score_2", "U"."Score_3" 
...
-- Code For temporary table TMP_20180508181741_CODEGEN_EUEZ part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508181741_CODEGEN_EUEZ" (
	"KEY" BIGINT, 
	"Score_0" DOUBLE PRECISION, 
	"Score_1" DOUBLE PRECISION, 
	"Score_2" DOUBLE PRECISION, 
...
-- Code For temporary table TMP_20180508181741_CODEGEN_EUEZ part 2. Populate

INSERT INTO "TMP_20180508181741_CODEGEN_EUEZ" ("KEY", "Score_0", "Score_1", "Score_2", "Score_3") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1", "U"."Score_2", "U"."Score_3" 
...
-- Code For temporary table TMP_20180508181741_CODEGEN_EMLX part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508181741_CODEGEN_EMLX" (
	"KEY" BIGINT, 
	"Score_0" DOUBLE PRECISION, 
	"Score_1" DOUBLE PRECISION, 
	"Score_2" DOUBLE PRECISION, 
...
-- Code For temporary table TMP_20180508181741_CODEGEN_EMLX part 2. Populate

INSERT INTO "TMP_20180508181741_CODEGEN_EMLX" ("KEY", "Score_0", "Score_1", "Score_2", "Score_3") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1", "U"."Score_2", "U"."Score_3" 
...
-- Code For temporary table TMP_20180508181741_CODEGEN_DCD2 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508181741_CODEGEN_DCD2" (
	"KEY" BIGINT, 
	"Score_0" DOUBLE PRECISION, 
	"Score_1" DOUBLE PRECISION, 
	"Score_2" DOUBLE PRECISION, 
...
-- Code For temporary table TMP_20180508181741_CODEGEN_DCD2 part 2. Populate

INSERT INTO "TMP_20180508181741_CODEGEN_DCD2" ("KEY", "Score_0", "Score_1", "Score_2", "Score_3") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1", "U"."Score_2", "U"."Score_3" 
...
FROM "TMP_20180508181741_CODEGEN_Y3A9" AS "GB_B0" UNION ALL SELECT "GB_B1"."KEY" AS "KEY", "GB_B1"."Score_0" AS "Score_0", "GB_B1"."Score_1" AS "Score_1", "GB_B1"."Score_2" AS "Score_2", "GB_B1"."Score_3" AS "Score_3" 
FROM "TMP_20180508181741_CODEGEN_33OK" AS "GB_B1" UNION ALL SELECT "GB_B2"."KEY" AS "KEY", "GB_B2"."Score_0" AS "Score_0", "GB_B2"."Score_1" AS "Score_1", "GB_B2"."Score_2" AS "Score_2", "GB_B2"."Score_3" AS "Score_3" 
FROM "TMP_20180508181741_CODEGEN_C8VB" AS "GB_B2" UNION ALL SELECT "GB_B3"."KEY" AS "KEY", "GB_B3"."Score_0" AS "Score_0", "GB_B3"."Score_1" AS "Score_1", "GB_B3"."Score_2" AS "Score_2", "GB_B3"."Score_3" AS "Score_3" 
FROM "TMP_20180508181741_CODEGEN_OYOA" AS "GB_B3" UNION ALL SELECT "GB_B4"."KEY" AS "KEY", "GB_B4"."Score_0" AS "Score_0", "GB_B4"."Score_1" AS "Score_1", "GB_B4"."Score_2" AS "Score_2", "GB_B4"."Score_3" AS "Score_3" 
FROM "TMP_20180508181741_CODEGEN_CX1Q" AS "GB_B4" UNION ALL SELECT "GB_B5"."KEY" AS "KEY", "GB_B5"."Score_0" AS "Score_0", "GB_B5"."Score_1" AS "Score_1", "GB_B5"."Score_2" AS "Score_2", "GB_B5"."Score_3" AS "Score_3" 
FROM "TMP_20180508181741_CODEGEN_EUEZ" AS "GB_B5" UNION ALL SELECT "GB_B6"."KEY" AS "KEY", "GB_B6"."Score_0" AS "Score_0", "GB_B6"."Score_1" AS "Score_1", "GB_B6"."Score_2" AS "Score_2", "GB_B6"."Score_3" AS "Score_3" 
FROM "TMP_20180508181741_CODEGEN_EMLX" AS "GB_B6") AS "GB_EnsembleUnion") AS "GB_Union") AS "U"

-- Code For temporary table TMP_20180508181741_CODEGEN_1SAG part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508181741_CODEGEN_1SAG" (
	"KEY" BIGINT NOT NULL, 
	"Score_0" DOUBLE PRECISION, 
	"Score_1" DOUBLE PRECISION, 
	"Score_2" DOUBLE PRECISION, 
...
-- Code For temporary table TMP_20180508181741_CODEGEN_1SAG part 2. Populate

INSERT INTO "TMP_20180508181741_CODEGEN_1SAG" ("KEY", "Score_0", "Score_1", "Score_2", "Score_3") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1", "U"."Score_2", "U"."Score_3" 
...
FROM "TMP_20180508181741_CODEGEN_DCD2" AS "GB_Union" GROUP BY "GB_Union"."KEY") AS "T") AS "GB_sum") AS "U"

-- Code For temporary table TMP_20180508181741_CODEGEN_1SAG part 3. Create Index 

CREATE INDEX "ix_TMP_20180508181741_C_b7cd" ON "TMP_20180508181741_CODEGEN_1SAG" ("KEY")
...
FROM "TMP_20180508181741_CODEGEN_1SAG" AS "GB_sum"), 
