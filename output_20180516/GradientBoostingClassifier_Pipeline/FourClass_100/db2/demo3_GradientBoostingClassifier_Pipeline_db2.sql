...
-- Code For temporary table tmp_20180508181743_codegen_5z5uk7_ads_imp_1_out part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180508181743_codegen_5z5uk7_ads_imp_1_out (
	"KEY" BIGINT, 
	impter_2 DOUBLE, 
	impter_3 DOUBLE, 
	impter_4 DOUBLE, 
...
-- Code For temporary table tmp_20180508181743_codegen_u4pglu_ads_sca_2_out part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180508181743_codegen_u4pglu_ads_sca_2_out (
	"KEY" BIGINT, 
	scaler_2 DOUBLE, 
	scaler_3 DOUBLE, 
	scaler_4 DOUBLE, 
...
FROM tmp_20180508181743_codegen_5z5uk7_ads_imp_1_out AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT"

-- Code For temporary table tmp_20180508181744_codegen_nz30m9_gb_b0 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180508181744_codegen_nz30m9_gb_b0 (
	"KEY" BIGINT, 
	"Score_0" DOUBLE, 
	"Score_1" DOUBLE, 
	"Score_2" DOUBLE, 
...
-- Code For temporary table tmp_20180508181744_codegen_nz30m9_gb_b0 part 2. Populate

INSERT INTO tmp_20180508181744_codegen_nz30m9_gb_b0 WITH "DT_node_lookup" AS 
...
FROM tmp_20180508181743_codegen_u4pglu_ads_sca_2_out AS "ADS_sca_2_OUT"), 
"DT_node_data" AS 
...
-- Code For temporary table tmp_20180508181744_codegen_u842jk_gb_b1 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180508181744_codegen_u842jk_gb_b1 (
	"KEY" BIGINT, 
	"Score_0" DOUBLE, 
	"Score_1" DOUBLE, 
	"Score_2" DOUBLE, 
...
-- Code For temporary table tmp_20180508181744_codegen_u842jk_gb_b1 part 2. Populate

INSERT INTO tmp_20180508181744_codegen_u842jk_gb_b1 WITH "DT_node_lookup_10" AS 
...
-- Code For temporary table tmp_20180508181744_codegen_1od182_gb_b2 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180508181744_codegen_1od182_gb_b2 (
	"KEY" BIGINT, 
	"Score_0" DOUBLE, 
	"Score_1" DOUBLE, 
	"Score_2" DOUBLE, 
...
-- Code For temporary table tmp_20180508181744_codegen_1od182_gb_b2 part 2. Populate

INSERT INTO tmp_20180508181744_codegen_1od182_gb_b2 WITH "DT_node_lookup_20" AS 
...
-- Code For temporary table tmp_20180508181744_codegen_42o2dt_gb_b3 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180508181744_codegen_42o2dt_gb_b3 (
	"KEY" BIGINT, 
	"Score_0" DOUBLE, 
	"Score_1" DOUBLE, 
	"Score_2" DOUBLE, 
...
-- Code For temporary table tmp_20180508181744_codegen_42o2dt_gb_b3 part 2. Populate

INSERT INTO tmp_20180508181744_codegen_42o2dt_gb_b3 WITH "DT_node_lookup_30" AS 
...
-- Code For temporary table tmp_20180508181744_codegen_itvlvn_gb_b4 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180508181744_codegen_itvlvn_gb_b4 (
	"KEY" BIGINT, 
	"Score_0" DOUBLE, 
	"Score_1" DOUBLE, 
	"Score_2" DOUBLE, 
...
-- Code For temporary table tmp_20180508181744_codegen_itvlvn_gb_b4 part 2. Populate

INSERT INTO tmp_20180508181744_codegen_itvlvn_gb_b4 WITH "DT_node_lookup_40" AS 
...
-- Code For temporary table tmp_20180508181744_codegen_uzu1ki_gb_b5 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180508181744_codegen_uzu1ki_gb_b5 (
	"KEY" BIGINT, 
	"Score_0" DOUBLE, 
	"Score_1" DOUBLE, 
	"Score_2" DOUBLE, 
...
-- Code For temporary table tmp_20180508181744_codegen_uzu1ki_gb_b5 part 2. Populate

INSERT INTO tmp_20180508181744_codegen_uzu1ki_gb_b5 WITH "DT_node_lookup_50" AS 
...
-- Code For temporary table tmp_20180508181744_codegen_8npyv9_gb_b6 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180508181744_codegen_8npyv9_gb_b6 (
	"KEY" BIGINT, 
	"Score_0" DOUBLE, 
	"Score_1" DOUBLE, 
	"Score_2" DOUBLE, 
...
-- Code For temporary table tmp_20180508181744_codegen_8npyv9_gb_b6 part 2. Populate

INSERT INTO tmp_20180508181744_codegen_8npyv9_gb_b6 WITH "DT_node_lookup_60" AS 
...
-- Code For temporary table tmp_20180508181744_codegen_szef59_gb_union part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180508181744_codegen_szef59_gb_union (
	"KEY" BIGINT, 
	"Score_0" DOUBLE, 
	"Score_1" DOUBLE, 
	"Score_2" DOUBLE, 
...
-- Code For temporary table tmp_20180508181744_codegen_szef59_gb_union part 2. Populate

INSERT INTO tmp_20180508181744_codegen_szef59_gb_union SELECT "GB_Union"."KEY", "GB_Union"."Score_0", "GB_Union"."Score_1", "GB_Union"."Score_2", "GB_Union"."Score_3" 
...
FROM tmp_20180508181744_codegen_nz30m9_gb_b0 AS "GB_B0" UNION ALL SELECT "GB_B1"."KEY" AS "KEY", "GB_B1"."Score_0" AS "Score_0", "GB_B1"."Score_1" AS "Score_1", "GB_B1"."Score_2" AS "Score_2", "GB_B1"."Score_3" AS "Score_3" 
FROM tmp_20180508181744_codegen_u842jk_gb_b1 AS "GB_B1" UNION ALL SELECT "GB_B2"."KEY" AS "KEY", "GB_B2"."Score_0" AS "Score_0", "GB_B2"."Score_1" AS "Score_1", "GB_B2"."Score_2" AS "Score_2", "GB_B2"."Score_3" AS "Score_3" 
FROM tmp_20180508181744_codegen_1od182_gb_b2 AS "GB_B2" UNION ALL SELECT "GB_B3"."KEY" AS "KEY", "GB_B3"."Score_0" AS "Score_0", "GB_B3"."Score_1" AS "Score_1", "GB_B3"."Score_2" AS "Score_2", "GB_B3"."Score_3" AS "Score_3" 
FROM tmp_20180508181744_codegen_42o2dt_gb_b3 AS "GB_B3" UNION ALL SELECT "GB_B4"."KEY" AS "KEY", "GB_B4"."Score_0" AS "Score_0", "GB_B4"."Score_1" AS "Score_1", "GB_B4"."Score_2" AS "Score_2", "GB_B4"."Score_3" AS "Score_3" 
FROM tmp_20180508181744_codegen_itvlvn_gb_b4 AS "GB_B4" UNION ALL SELECT "GB_B5"."KEY" AS "KEY", "GB_B5"."Score_0" AS "Score_0", "GB_B5"."Score_1" AS "Score_1", "GB_B5"."Score_2" AS "Score_2", "GB_B5"."Score_3" AS "Score_3" 
FROM tmp_20180508181744_codegen_uzu1ki_gb_b5 AS "GB_B5" UNION ALL SELECT "GB_B6"."KEY" AS "KEY", "GB_B6"."Score_0" AS "Score_0", "GB_B6"."Score_1" AS "Score_1", "GB_B6"."Score_2" AS "Score_2", "GB_B6"."Score_3" AS "Score_3" 
FROM tmp_20180508181744_codegen_8npyv9_gb_b6 AS "GB_B6") AS "GB_EnsembleUnion") AS "GB_Union"

-- Code For temporary table tmp_20180508181744_codegen_u9syev_gb_sum part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180508181744_codegen_u9syev_gb_sum (
	"KEY" BIGINT, 
	"Score_0" DOUBLE, 
	"Score_1" DOUBLE, 
	"Score_2" DOUBLE, 
...
-- Code For temporary table tmp_20180508181744_codegen_u9syev_gb_sum part 2. Populate

INSERT INTO tmp_20180508181744_codegen_u9syev_gb_sum SELECT "GB_sum"."KEY", "GB_sum"."Score_0", "GB_sum"."Score_1", "GB_sum"."Score_2", "GB_sum"."Score_3" 
...
FROM tmp_20180508181744_codegen_szef59_gb_union AS "GB_Union" GROUP BY "GB_Union"."KEY") AS "T") AS "GB_sum"
...
FROM tmp_20180508181744_codegen_u9syev_gb_sum AS "GB_sum"), 
