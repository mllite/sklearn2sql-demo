...
FROM `tmp_20180509002713_codegen_lg5x4l_ads_imp_1_out` AS `ADS_imp_1_OUT`) AS `ADS_sca_2_OUT`

-- Code For temporary table tmp_20180509002713_codegen_qsh748_ads_sca_2_out part 2. Populate

SELECT * FROM `tmp_20180509002713_codegen_qsh748_ads_sca_2_out`

-- Code For temporary table tmp_20180509002713_codegen_ug5had_gb_b0 part 1. Create 

CREATE TEMPORARY TABLE `tmp_20180509002713_codegen_ug5had_gb_b0` STORED AS ORC AS WITH `DT_node_lookup` AS 
...
FROM `tmp_20180509002713_codegen_qsh748_ads_sca_2_out` AS `ADS_sca_2_OUT`), 
`DT_node_data` AS 
...
-- Code For temporary table tmp_20180509002713_codegen_ug5had_gb_b0 part 2. Populate

SELECT * FROM `tmp_20180509002713_codegen_ug5had_gb_b0`

-- Code For temporary table tmp_20180509002713_codegen_ae5mbt_gb_b1 part 1. Create 

CREATE TEMPORARY TABLE `tmp_20180509002713_codegen_ae5mbt_gb_b1` STORED AS ORC AS WITH `DT_node_lookup_10` AS 
...
-- Code For temporary table tmp_20180509002713_codegen_ae5mbt_gb_b1 part 2. Populate

SELECT * FROM `tmp_20180509002713_codegen_ae5mbt_gb_b1`

-- Code For temporary table tmp_20180509002713_codegen_75j6k5_gb_b2 part 1. Create 

CREATE TEMPORARY TABLE `tmp_20180509002713_codegen_75j6k5_gb_b2` STORED AS ORC AS WITH `DT_node_lookup_20` AS 
...
-- Code For temporary table tmp_20180509002713_codegen_75j6k5_gb_b2 part 2. Populate

SELECT * FROM `tmp_20180509002713_codegen_75j6k5_gb_b2`

-- Code For temporary table tmp_20180509002713_codegen_6u4n5s_gb_b3 part 1. Create 

CREATE TEMPORARY TABLE `tmp_20180509002713_codegen_6u4n5s_gb_b3` STORED AS ORC AS WITH `DT_node_lookup_30` AS 
...
-- Code For temporary table tmp_20180509002713_codegen_6u4n5s_gb_b3 part 2. Populate

SELECT * FROM `tmp_20180509002713_codegen_6u4n5s_gb_b3`

-- Code For temporary table tmp_20180509002713_codegen_82ec17_gb_b4 part 1. Create 

CREATE TEMPORARY TABLE `tmp_20180509002713_codegen_82ec17_gb_b4` STORED AS ORC AS WITH `DT_node_lookup_40` AS 
...
-- Code For temporary table tmp_20180509002713_codegen_82ec17_gb_b4 part 2. Populate

SELECT * FROM `tmp_20180509002713_codegen_82ec17_gb_b4`

-- Code For temporary table tmp_20180509002713_codegen_g57lk4_gb_b5 part 1. Create 

CREATE TEMPORARY TABLE `tmp_20180509002713_codegen_g57lk4_gb_b5` STORED AS ORC AS WITH `DT_node_lookup_50` AS 
...
-- Code For temporary table tmp_20180509002713_codegen_g57lk4_gb_b5 part 2. Populate

SELECT * FROM `tmp_20180509002713_codegen_g57lk4_gb_b5`

-- Code For temporary table tmp_20180509002713_codegen_ymkqyy_gb_b6 part 1. Create 

CREATE TEMPORARY TABLE `tmp_20180509002713_codegen_ymkqyy_gb_b6` STORED AS ORC AS WITH `DT_node_lookup_60` AS 
...
-- Code For temporary table tmp_20180509002713_codegen_ymkqyy_gb_b6 part 2. Populate

SELECT * FROM `tmp_20180509002713_codegen_ymkqyy_gb_b6`

-- Code For temporary table tmp_20180509002713_codegen_l0iozh_gb_union part 1. Create 

CREATE TEMPORARY TABLE `tmp_20180509002713_codegen_l0iozh_gb_union` STORED AS ORC AS SELECT `GB_Union`.`KEY`, `GB_Union`.`Score_0`, `GB_Union`.`Score_1`, `GB_Union`.`Score_2`, `GB_Union`.`Score_3` 
...
FROM `tmp_20180509002713_codegen_ug5had_gb_b0` AS `GB_B0` UNION ALL SELECT `GB_B1`.`KEY` AS `KEY`, `GB_B1`.`Score_0` AS `Score_0`, `GB_B1`.`Score_1` AS `Score_1`, `GB_B1`.`Score_2` AS `Score_2`, `GB_B1`.`Score_3` AS `Score_3` 
FROM `tmp_20180509002713_codegen_ae5mbt_gb_b1` AS `GB_B1` UNION ALL SELECT `GB_B2`.`KEY` AS `KEY`, `GB_B2`.`Score_0` AS `Score_0`, `GB_B2`.`Score_1` AS `Score_1`, `GB_B2`.`Score_2` AS `Score_2`, `GB_B2`.`Score_3` AS `Score_3` 
FROM `tmp_20180509002713_codegen_75j6k5_gb_b2` AS `GB_B2` UNION ALL SELECT `GB_B3`.`KEY` AS `KEY`, `GB_B3`.`Score_0` AS `Score_0`, `GB_B3`.`Score_1` AS `Score_1`, `GB_B3`.`Score_2` AS `Score_2`, `GB_B3`.`Score_3` AS `Score_3` 
FROM `tmp_20180509002713_codegen_6u4n5s_gb_b3` AS `GB_B3` UNION ALL SELECT `GB_B4`.`KEY` AS `KEY`, `GB_B4`.`Score_0` AS `Score_0`, `GB_B4`.`Score_1` AS `Score_1`, `GB_B4`.`Score_2` AS `Score_2`, `GB_B4`.`Score_3` AS `Score_3` 
FROM `tmp_20180509002713_codegen_82ec17_gb_b4` AS `GB_B4` UNION ALL SELECT `GB_B5`.`KEY` AS `KEY`, `GB_B5`.`Score_0` AS `Score_0`, `GB_B5`.`Score_1` AS `Score_1`, `GB_B5`.`Score_2` AS `Score_2`, `GB_B5`.`Score_3` AS `Score_3` 
FROM `tmp_20180509002713_codegen_g57lk4_gb_b5` AS `GB_B5` UNION ALL SELECT `GB_B6`.`KEY` AS `KEY`, `GB_B6`.`Score_0` AS `Score_0`, `GB_B6`.`Score_1` AS `Score_1`, `GB_B6`.`Score_2` AS `Score_2`, `GB_B6`.`Score_3` AS `Score_3` 
FROM `tmp_20180509002713_codegen_ymkqyy_gb_b6` AS `GB_B6`) AS `GB_EnsembleUnion`) AS `GB_Union`

-- Code For temporary table tmp_20180509002713_codegen_l0iozh_gb_union part 2. Populate

SELECT * FROM `tmp_20180509002713_codegen_l0iozh_gb_union`

-- Code For temporary table tmp_20180509002713_codegen_ij5bi2_gb_sum part 1. Create 

CREATE TEMPORARY TABLE `tmp_20180509002713_codegen_ij5bi2_gb_sum` STORED AS ORC AS SELECT `GB_sum`.`KEY`, `GB_sum`.`Score_0`, `GB_sum`.`Score_1`, `GB_sum`.`Score_2`, `GB_sum`.`Score_3` 
...
FROM `tmp_20180509002713_codegen_l0iozh_gb_union` AS `GB_Union` GROUP BY `GB_Union`.`KEY`) AS `T`) AS `GB_sum`

-- Code For temporary table tmp_20180509002713_codegen_ij5bi2_gb_sum part 2. Populate

SELECT * FROM `tmp_20180509002713_codegen_ij5bi2_gb_sum`
...
FROM `tmp_20180509002713_codegen_ij5bi2_gb_sum` AS `GB_sum`), 
