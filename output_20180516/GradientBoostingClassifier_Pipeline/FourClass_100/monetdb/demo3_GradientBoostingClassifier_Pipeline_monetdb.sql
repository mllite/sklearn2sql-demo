...
-- Code For temporary table tmp_20180516113032_codegen_dfrn85_ads_imp_1_out part 1. Create 


CREATE TEMPORARY TABLE tmp_20180516113032_codegen_dfrn85_ads_imp_1_out (
	"KEY" BIGINT, 
	impter_2 DOUBLE, 
	impter_3 DOUBLE, 
	impter_4 DOUBLE, 
...
-- Code For temporary table tmp_20180516113032_codegen_h09865_ads_sca_2_out part 1. Create 


CREATE TEMPORARY TABLE tmp_20180516113032_codegen_h09865_ads_sca_2_out (
	"KEY" BIGINT, 
	scaler_2 DOUBLE, 
	scaler_3 DOUBLE, 
	scaler_4 DOUBLE, 
...
FROM tmp_20180516113032_codegen_dfrn85_ads_imp_1_out AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT") AS "U"

-- Code For temporary table tmp_20180516113032_codegen_osdtj3_gb_b0 part 1. Create 


CREATE TEMPORARY TABLE tmp_20180516113032_codegen_osdtj3_gb_b0 (
	"KEY" BIGINT, 
	"Score_0" DOUBLE, 
	"Score_1" DOUBLE, 
	"Score_2" DOUBLE, 
...
-- Code For temporary table tmp_20180516113032_codegen_osdtj3_gb_b0 part 2. Populate

INSERT INTO tmp_20180516113032_codegen_osdtj3_gb_b0 ("KEY", "Score_0", "Score_1", "Score_2", "Score_3") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1", "U"."Score_2", "U"."Score_3" 
...
FROM tmp_20180516113032_codegen_h09865_ads_sca_2_out AS "ADS_sca_2_OUT"), 
"DT_node_data" AS 
...
-- Code For temporary table tmp_20180516113032_codegen_0pdgna_gb_b1 part 1. Create 


CREATE TEMPORARY TABLE tmp_20180516113032_codegen_0pdgna_gb_b1 (
	"KEY" BIGINT, 
	"Score_0" DOUBLE, 
	"Score_1" DOUBLE, 
	"Score_2" DOUBLE, 
...
-- Code For temporary table tmp_20180516113032_codegen_0pdgna_gb_b1 part 2. Populate

INSERT INTO tmp_20180516113032_codegen_0pdgna_gb_b1 ("KEY", "Score_0", "Score_1", "Score_2", "Score_3") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1", "U"."Score_2", "U"."Score_3" 
...
-- Code For temporary table tmp_20180516113032_codegen_i70ygd_gb_b2 part 1. Create 


CREATE TEMPORARY TABLE tmp_20180516113032_codegen_i70ygd_gb_b2 (
	"KEY" BIGINT, 
	"Score_0" DOUBLE, 
	"Score_1" DOUBLE, 
	"Score_2" DOUBLE, 
...
-- Code For temporary table tmp_20180516113032_codegen_i70ygd_gb_b2 part 2. Populate

INSERT INTO tmp_20180516113032_codegen_i70ygd_gb_b2 ("KEY", "Score_0", "Score_1", "Score_2", "Score_3") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1", "U"."Score_2", "U"."Score_3" 
...
-- Code For temporary table tmp_20180516113032_codegen_b7uhmr_gb_b3 part 1. Create 


CREATE TEMPORARY TABLE tmp_20180516113032_codegen_b7uhmr_gb_b3 (
	"KEY" BIGINT, 
	"Score_0" DOUBLE, 
	"Score_1" DOUBLE, 
	"Score_2" DOUBLE, 
...
-- Code For temporary table tmp_20180516113032_codegen_b7uhmr_gb_b3 part 2. Populate

INSERT INTO tmp_20180516113032_codegen_b7uhmr_gb_b3 ("KEY", "Score_0", "Score_1", "Score_2", "Score_3") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1", "U"."Score_2", "U"."Score_3" 
...
-- Code For temporary table tmp_20180516113032_codegen_o6qi03_gb_b4 part 1. Create 


CREATE TEMPORARY TABLE tmp_20180516113032_codegen_o6qi03_gb_b4 (
	"KEY" BIGINT, 
	"Score_0" DOUBLE, 
	"Score_1" DOUBLE, 
	"Score_2" DOUBLE, 
...
-- Code For temporary table tmp_20180516113032_codegen_o6qi03_gb_b4 part 2. Populate

INSERT INTO tmp_20180516113032_codegen_o6qi03_gb_b4 ("KEY", "Score_0", "Score_1", "Score_2", "Score_3") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1", "U"."Score_2", "U"."Score_3" 
...
-- Code For temporary table tmp_20180516113032_codegen_wzvgvo_gb_b5 part 1. Create 


CREATE TEMPORARY TABLE tmp_20180516113032_codegen_wzvgvo_gb_b5 (
	"KEY" BIGINT, 
	"Score_0" DOUBLE, 
	"Score_1" DOUBLE, 
	"Score_2" DOUBLE, 
...
-- Code For temporary table tmp_20180516113032_codegen_wzvgvo_gb_b5 part 2. Populate

INSERT INTO tmp_20180516113032_codegen_wzvgvo_gb_b5 ("KEY", "Score_0", "Score_1", "Score_2", "Score_3") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1", "U"."Score_2", "U"."Score_3" 
...
-- Code For temporary table tmp_20180516113032_codegen_4yy178_gb_b6 part 1. Create 


CREATE TEMPORARY TABLE tmp_20180516113032_codegen_4yy178_gb_b6 (
	"KEY" BIGINT, 
	"Score_0" DOUBLE, 
	"Score_1" DOUBLE, 
	"Score_2" DOUBLE, 
...
-- Code For temporary table tmp_20180516113032_codegen_4yy178_gb_b6 part 2. Populate

INSERT INTO tmp_20180516113032_codegen_4yy178_gb_b6 ("KEY", "Score_0", "Score_1", "Score_2", "Score_3") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1", "U"."Score_2", "U"."Score_3" 
...
-- Code For temporary table tmp_20180516113032_codegen_0l7754_gb_sum part 1. Create 


CREATE TEMPORARY TABLE tmp_20180516113032_codegen_0l7754_gb_sum (
	"KEY" BIGINT, 
	"Score_0" DOUBLE, 
	"Score_1" DOUBLE, 
	"Score_2" DOUBLE, 
...
-- Code For temporary table tmp_20180516113032_codegen_0l7754_gb_sum part 2. Populate

INSERT INTO tmp_20180516113032_codegen_0l7754_gb_sum ("KEY", "Score_0", "Score_1", "Score_2", "Score_3") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1", "U"."Score_2", "U"."Score_3" 
...
FROM tmp_20180516113032_codegen_osdtj3_gb_b0 AS "GB_B0" UNION ALL SELECT "GB_B1"."KEY" AS "KEY", "GB_B1"."Score_0" AS "Score_0", "GB_B1"."Score_1" AS "Score_1", "GB_B1"."Score_2" AS "Score_2", "GB_B1"."Score_3" AS "Score_3" 
FROM tmp_20180516113032_codegen_0pdgna_gb_b1 AS "GB_B1" UNION ALL SELECT "GB_B2"."KEY" AS "KEY", "GB_B2"."Score_0" AS "Score_0", "GB_B2"."Score_1" AS "Score_1", "GB_B2"."Score_2" AS "Score_2", "GB_B2"."Score_3" AS "Score_3" 
FROM tmp_20180516113032_codegen_i70ygd_gb_b2 AS "GB_B2" UNION ALL SELECT "GB_B3"."KEY" AS "KEY", "GB_B3"."Score_0" AS "Score_0", "GB_B3"."Score_1" AS "Score_1", "GB_B3"."Score_2" AS "Score_2", "GB_B3"."Score_3" AS "Score_3" 
FROM tmp_20180516113032_codegen_b7uhmr_gb_b3 AS "GB_B3" UNION ALL SELECT "GB_B4"."KEY" AS "KEY", "GB_B4"."Score_0" AS "Score_0", "GB_B4"."Score_1" AS "Score_1", "GB_B4"."Score_2" AS "Score_2", "GB_B4"."Score_3" AS "Score_3" 
FROM tmp_20180516113032_codegen_o6qi03_gb_b4 AS "GB_B4" UNION ALL SELECT "GB_B5"."KEY" AS "KEY", "GB_B5"."Score_0" AS "Score_0", "GB_B5"."Score_1" AS "Score_1", "GB_B5"."Score_2" AS "Score_2", "GB_B5"."Score_3" AS "Score_3" 
FROM tmp_20180516113032_codegen_wzvgvo_gb_b5 AS "GB_B5" UNION ALL SELECT "GB_B6"."KEY" AS "KEY", "GB_B6"."Score_0" AS "Score_0", "GB_B6"."Score_1" AS "Score_1", "GB_B6"."Score_2" AS "Score_2", "GB_B6"."Score_3" AS "Score_3" 
FROM tmp_20180516113032_codegen_4yy178_gb_b6 AS "GB_B6") AS "GB_EnsembleUnion")
...
FROM tmp_20180516113032_codegen_0l7754_gb_sum AS "GB_sum"), 
