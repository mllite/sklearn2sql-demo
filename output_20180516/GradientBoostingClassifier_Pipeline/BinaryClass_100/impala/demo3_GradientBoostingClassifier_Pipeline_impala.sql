...
-- Code For temporary table tmp_20180508192154_codegen_90zxk6_ads_imp_1_out part 1. Create 


CREATE TABLE tmp_20180508192154_codegen_90zxk6_ads_imp_1_out (
	`KEY` BIGINT, 
	impter_2 DOUBLE, 
	impter_3 DOUBLE, 
	impter_4 DOUBLE, 
...
-- Code For temporary table tmp_20180508192154_codegen_5a12au_ads_sca_2_out part 1. Create 


CREATE TABLE tmp_20180508192154_codegen_5a12au_ads_sca_2_out (
	`KEY` BIGINT, 
	scaler_2 DOUBLE, 
	scaler_3 DOUBLE, 
	scaler_4 DOUBLE, 
...
FROM tmp_20180508192154_codegen_90zxk6_ads_imp_1_out AS `ADS_imp_1_OUT`) AS `ADS_sca_2_OUT`

-- Code For temporary table tmp_20180508192154_codegen_2re4ke_gb_b0 part 1. Create 


CREATE TABLE tmp_20180508192154_codegen_2re4ke_gb_b0 (
	`KEY` BIGINT, 
	`Score_0` DOUBLE, 
	`Score_1` DOUBLE
)
...
-- Code For temporary table tmp_20180508192154_codegen_2re4ke_gb_b0 part 2. Populate
...
FROM tmp_20180508192154_codegen_5a12au_ads_sca_2_out AS `ADS_sca_2_OUT`), 
`DT_node_data` AS 
...
FROM `DT_Output_4`)
 INSERT INTO tmp_20180508192154_codegen_2re4ke_gb_b0 (`KEY`, `Score_0`, `Score_1`) SELECT `GB_B0`.`KEY`, `GB_B0`.`Score_0`, `GB_B0`.`Score_1` 
...
-- Code For temporary table tmp_20180508192154_codegen_dz8clc_gb_b1 part 1. Create 


CREATE TABLE tmp_20180508192154_codegen_dz8clc_gb_b1 (
	`KEY` BIGINT, 
	`Score_0` DOUBLE, 
	`Score_1` DOUBLE
)
...
-- Code For temporary table tmp_20180508192154_codegen_dz8clc_gb_b1 part 2. Populate
...
FROM `DT_Output_9`)
 INSERT INTO tmp_20180508192154_codegen_dz8clc_gb_b1 (`KEY`, `Score_0`, `Score_1`) SELECT `GB_B1`.`KEY`, `GB_B1`.`Score_0`, `GB_B1`.`Score_1` 
...
-- Code For temporary table tmp_20180508192154_codegen_0k4iim_gb_b2 part 1. Create 


CREATE TABLE tmp_20180508192154_codegen_0k4iim_gb_b2 (
	`KEY` BIGINT, 
	`Score_0` DOUBLE, 
	`Score_1` DOUBLE
)
...
-- Code For temporary table tmp_20180508192154_codegen_0k4iim_gb_b2 part 2. Populate
...
FROM `DT_Output_14`)
 INSERT INTO tmp_20180508192154_codegen_0k4iim_gb_b2 (`KEY`, `Score_0`, `Score_1`) SELECT `GB_B2`.`KEY`, `GB_B2`.`Score_0`, `GB_B2`.`Score_1` 
...
-- Code For temporary table tmp_20180508192154_codegen_qbwipm_gb_b3 part 1. Create 


CREATE TABLE tmp_20180508192154_codegen_qbwipm_gb_b3 (
	`KEY` BIGINT, 
	`Score_0` DOUBLE, 
	`Score_1` DOUBLE
)
...
-- Code For temporary table tmp_20180508192154_codegen_qbwipm_gb_b3 part 2. Populate
...
FROM `DT_Output_15`)
 INSERT INTO tmp_20180508192154_codegen_qbwipm_gb_b3 (`KEY`, `Score_0`, `Score_1`) SELECT `GB_B3`.`KEY`, `GB_B3`.`Score_0`, `GB_B3`.`Score_1` 
...
-- Code For temporary table tmp_20180508192154_codegen_7o0vru_gb_union part 1. Create 


CREATE TABLE tmp_20180508192154_codegen_7o0vru_gb_union (
	`KEY` BIGINT, 
	`Score_0` DOUBLE, 
	`Score_1` DOUBLE
)
...
-- Code For temporary table tmp_20180508192154_codegen_7o0vru_gb_union part 2. Populate

INSERT INTO tmp_20180508192154_codegen_7o0vru_gb_union (`KEY`, `Score_0`, `Score_1`) SELECT `GB_Union`.`KEY`, `GB_Union`.`Score_0`, `GB_Union`.`Score_1` 
...
FROM tmp_20180508192154_codegen_2re4ke_gb_b0 AS `GB_B0` UNION ALL SELECT `GB_B1`.`KEY` AS `KEY`, `GB_B1`.`Score_0` AS `Score_0`, `GB_B1`.`Score_1` AS `Score_1` 
FROM tmp_20180508192154_codegen_dz8clc_gb_b1 AS `GB_B1` UNION ALL SELECT `GB_B2`.`KEY` AS `KEY`, `GB_B2`.`Score_0` AS `Score_0`, `GB_B2`.`Score_1` AS `Score_1` 
FROM tmp_20180508192154_codegen_0k4iim_gb_b2 AS `GB_B2` UNION ALL SELECT `GB_B3`.`KEY` AS `KEY`, `GB_B3`.`Score_0` AS `Score_0`, `GB_B3`.`Score_1` AS `Score_1` 
FROM tmp_20180508192154_codegen_qbwipm_gb_b3 AS `GB_B3`) AS `GB_EnsembleUnion`) AS `GB_Union`

-- Code For temporary table tmp_20180508192154_codegen_3fi8h3_gb_sum part 1. Create 


CREATE TABLE tmp_20180508192154_codegen_3fi8h3_gb_sum (
	`KEY` BIGINT, 
	`Score_0` DOUBLE, 
	`Score_1` DOUBLE
)
...
-- Code For temporary table tmp_20180508192154_codegen_3fi8h3_gb_sum part 2. Populate

INSERT INTO tmp_20180508192154_codegen_3fi8h3_gb_sum (`KEY`, `Score_0`, `Score_1`) SELECT `GB_sum`.`KEY`, `GB_sum`.`Score_0`, `GB_sum`.`Score_1` 
...
FROM tmp_20180508192154_codegen_7o0vru_gb_union AS `GB_Union` GROUP BY `GB_Union`.`KEY`) AS `T`) AS `GB_sum`
...
FROM tmp_20180508192154_codegen_3fi8h3_gb_sum AS `GB_sum`), 
