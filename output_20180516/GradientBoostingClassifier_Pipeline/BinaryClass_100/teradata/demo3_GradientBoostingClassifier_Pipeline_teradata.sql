...
-- Code For temporary table tmp_20180516111012_codegen_xq44hg_ads_imp_1_out part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180516111012_codegen_xq44hg_ads_imp_1_out  (
	"KEY" BIGINT, 
...
-- Code For temporary table tmp_20180516111012_codegen_rbh0tg_ads_sca_2_out part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180516111012_codegen_rbh0tg_ads_sca_2_out  (
	"KEY" BIGINT, 
...
FROM tmp_20180516111012_codegen_xq44hg_ads_imp_1_out AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT") AS "U"

-- Code For temporary table tmp_20180516111012_codegen_2dn10j_gb_b0 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180516111012_codegen_2dn10j_gb_b0  (
	"KEY" BIGINT, 
...
-- Code For temporary table tmp_20180516111012_codegen_2dn10j_gb_b0 part 2. Populate

INSERT INTO tmp_20180516111012_codegen_2dn10j_gb_b0 ("KEY", "Score_0", "Score_1") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1" 
...
FROM tmp_20180516111012_codegen_rbh0tg_ads_sca_2_out AS "ADS_sca_2_OUT"), 
dummy_cte AS 
...
-- Code For temporary table tmp_20180516111012_codegen_9tp9tu_gb_b1 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180516111012_codegen_9tp9tu_gb_b1  (
	"KEY" BIGINT, 
	"Score_0" DOUBLE PRECISION, 
	"Score_1" DOUBLE PRECISION
)
...
-- Code For temporary table tmp_20180516111012_codegen_9tp9tu_gb_b1 part 2. Populate

INSERT INTO tmp_20180516111012_codegen_9tp9tu_gb_b1 ("KEY", "Score_0", "Score_1") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1" 
...
-- Code For temporary table tmp_20180516111012_codegen_9es772_gb_b2 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180516111012_codegen_9es772_gb_b2  (
	"KEY" BIGINT, 
	"Score_0" DOUBLE PRECISION, 
	"Score_1" DOUBLE PRECISION
)
...
-- Code For temporary table tmp_20180516111012_codegen_9es772_gb_b2 part 2. Populate

INSERT INTO tmp_20180516111012_codegen_9es772_gb_b2 ("KEY", "Score_0", "Score_1") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1" 
...
-- Code For temporary table tmp_20180516111012_codegen_kh7way_gb_b3 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180516111012_codegen_kh7way_gb_b3  (
	"KEY" BIGINT, 
	"Score_0" DOUBLE PRECISION, 
	"Score_1" DOUBLE PRECISION
)
...
-- Code For temporary table tmp_20180516111012_codegen_kh7way_gb_b3 part 2. Populate

INSERT INTO tmp_20180516111012_codegen_kh7way_gb_b3 ("KEY", "Score_0", "Score_1") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1" 
...
-- Code For temporary table tmp_20180516111012_codegen_vjnbux_gb_sum part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180516111012_codegen_vjnbux_gb_sum  (
	"KEY" BIGINT, 
	"Score_0" DOUBLE PRECISION, 
	"Score_1" DOUBLE PRECISION
)
...
-- Code For temporary table tmp_20180516111012_codegen_vjnbux_gb_sum part 2. Populate

INSERT INTO tmp_20180516111012_codegen_vjnbux_gb_sum ("KEY", "Score_0", "Score_1") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1" 
...
FROM tmp_20180516111012_codegen_2dn10j_gb_b0 AS "GB_B0" UNION ALL SELECT "GB_B1"."KEY" AS "KEY", "GB_B1"."Score_0" AS "Score_0", "GB_B1"."Score_1" AS "Score_1" 
FROM tmp_20180516111012_codegen_9tp9tu_gb_b1 AS "GB_B1" UNION ALL SELECT "GB_B2"."KEY" AS "KEY", "GB_B2"."Score_0" AS "Score_0", "GB_B2"."Score_1" AS "Score_1" 
FROM tmp_20180516111012_codegen_9es772_gb_b2 AS "GB_B2" UNION ALL SELECT "GB_B3"."KEY" AS "KEY", "GB_B3"."Score_0" AS "Score_0", "GB_B3"."Score_1" AS "Score_1" 
FROM tmp_20180516111012_codegen_kh7way_gb_b3 AS "GB_B3") AS "GB_EnsembleUnion")
...
FROM tmp_20180516111012_codegen_vjnbux_gb_sum AS "GB_sum"), 
