...
-- Code For temporary table TMP_20180508180315_CODEGEN_8ULZYO_ADS_imp_1_OUT part 1. Create 


CREATE TEMPORARY TABLE "TMP_20180508180315_CODEGEN_8ULZYO_ADS_imp_1_OUT" (
	"KEY" BIGINT NOT NULL, 
	impter_2 FLOAT, 
	impter_3 FLOAT, 
	impter_4 FLOAT, 
...
-- Code For temporary table TMP_20180508180315_CODEGEN_8ULZYO_ADS_imp_1_OUT part 3. Create Index 

CREATE INDEX "ix_TMP_20180508180315_CODEGEN_8ULZYO_ADS_imp_1_OUT_KEY" ON "TMP_20180508180315_CODEGEN_8ULZYO_ADS_imp_1_OUT" ("KEY")

-- Code For temporary table TMP_20180508180315_CODEGEN_PE72AU_ADS_sca_2_OUT part 1. Create 


CREATE TEMPORARY TABLE "TMP_20180508180315_CODEGEN_PE72AU_ADS_sca_2_OUT" (
	"KEY" BIGINT NOT NULL, 
	scaler_2 FLOAT, 
	scaler_3 FLOAT, 
	scaler_4 FLOAT, 
...
FROM "TMP_20180508180315_CODEGEN_8ULZYO_ADS_imp_1_OUT" AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT"

-- Code For temporary table TMP_20180508180315_CODEGEN_PE72AU_ADS_sca_2_OUT part 3. Create Index 

CREATE INDEX "ix_TMP_20180508180315_CODEGEN_PE72AU_ADS_sca_2_OUT_KEY" ON "TMP_20180508180315_CODEGEN_PE72AU_ADS_sca_2_OUT" ("KEY")

-- Code For temporary table TMP_20180508180315_CODEGEN_ADNR41_GB_B0 part 1. Create 


CREATE TEMPORARY TABLE "TMP_20180508180315_CODEGEN_ADNR41_GB_B0" (
	"KEY" BIGINT, 
	"Score_0" FLOAT, 
	"Score_1" FLOAT
)
...
-- Code For temporary table TMP_20180508180315_CODEGEN_ADNR41_GB_B0 part 2. Populate
...
FROM "TMP_20180508180315_CODEGEN_PE72AU_ADS_sca_2_OUT" AS "ADS_sca_2_OUT"), 
"DT_node_data" AS 
...
FROM "DT_Output_4")
 INSERT INTO "TMP_20180508180315_CODEGEN_ADNR41_GB_B0" ("KEY", "Score_0", "Score_1") SELECT "GB_B0"."KEY", "GB_B0"."Score_0", "GB_B0"."Score_1" 
...
-- Code For temporary table TMP_20180508180316_CODEGEN_7LWPLP_GB_B1 part 1. Create 


CREATE TEMPORARY TABLE "TMP_20180508180316_CODEGEN_7LWPLP_GB_B1" (
	"KEY" BIGINT, 
	"Score_0" FLOAT, 
	"Score_1" FLOAT
)
...
-- Code For temporary table TMP_20180508180316_CODEGEN_7LWPLP_GB_B1 part 2. Populate
...
FROM "DT_Output_9")
 INSERT INTO "TMP_20180508180316_CODEGEN_7LWPLP_GB_B1" ("KEY", "Score_0", "Score_1") SELECT "GB_B1"."KEY", "GB_B1"."Score_0", "GB_B1"."Score_1" 
...
-- Code For temporary table TMP_20180508180316_CODEGEN_7FVQ7A_GB_B2 part 1. Create 


CREATE TEMPORARY TABLE "TMP_20180508180316_CODEGEN_7FVQ7A_GB_B2" (
	"KEY" BIGINT, 
	"Score_0" FLOAT, 
	"Score_1" FLOAT
)
...
-- Code For temporary table TMP_20180508180316_CODEGEN_7FVQ7A_GB_B2 part 2. Populate
...
FROM "DT_Output_14")
 INSERT INTO "TMP_20180508180316_CODEGEN_7FVQ7A_GB_B2" ("KEY", "Score_0", "Score_1") SELECT "GB_B2"."KEY", "GB_B2"."Score_0", "GB_B2"."Score_1" 
...
-- Code For temporary table TMP_20180508180316_CODEGEN_BQLZOV_GB_B3 part 1. Create 


CREATE TEMPORARY TABLE "TMP_20180508180316_CODEGEN_BQLZOV_GB_B3" (
	"KEY" BIGINT, 
	"Score_0" FLOAT, 
	"Score_1" FLOAT
)
...
-- Code For temporary table TMP_20180508180316_CODEGEN_BQLZOV_GB_B3 part 2. Populate
...
FROM "DT_Output_15")
 INSERT INTO "TMP_20180508180316_CODEGEN_BQLZOV_GB_B3" ("KEY", "Score_0", "Score_1") SELECT "GB_B3"."KEY", "GB_B3"."Score_0", "GB_B3"."Score_1" 
...
-- Code For temporary table TMP_20180508180316_CODEGEN_OZS4RO_GB_Union part 1. Create 


CREATE TEMPORARY TABLE "TMP_20180508180316_CODEGEN_OZS4RO_GB_Union" (
	"KEY" BIGINT, 
	"Score_0" FLOAT, 
	"Score_1" FLOAT
)
...
-- Code For temporary table TMP_20180508180316_CODEGEN_OZS4RO_GB_Union part 2. Populate

INSERT INTO "TMP_20180508180316_CODEGEN_OZS4RO_GB_Union" ("KEY", "Score_0", "Score_1") SELECT "GB_Union"."KEY", "GB_Union"."Score_0", "GB_Union"."Score_1" 
...
FROM "TMP_20180508180315_CODEGEN_ADNR41_GB_B0" AS "GB_B0" UNION ALL SELECT "GB_B1"."KEY" AS "KEY", "GB_B1"."Score_0" AS "Score_0", "GB_B1"."Score_1" AS "Score_1" 
FROM "TMP_20180508180316_CODEGEN_7LWPLP_GB_B1" AS "GB_B1" UNION ALL SELECT "GB_B2"."KEY" AS "KEY", "GB_B2"."Score_0" AS "Score_0", "GB_B2"."Score_1" AS "Score_1" 
FROM "TMP_20180508180316_CODEGEN_7FVQ7A_GB_B2" AS "GB_B2" UNION ALL SELECT "GB_B3"."KEY" AS "KEY", "GB_B3"."Score_0" AS "Score_0", "GB_B3"."Score_1" AS "Score_1" 
FROM "TMP_20180508180316_CODEGEN_BQLZOV_GB_B3" AS "GB_B3") AS "GB_EnsembleUnion") AS "GB_Union"

-- Code For temporary table TMP_20180508180316_CODEGEN_0MJSS7_GB_sum part 1. Create 


CREATE TEMPORARY TABLE "TMP_20180508180316_CODEGEN_0MJSS7_GB_sum" (
	"KEY" BIGINT NOT NULL, 
	"Score_0" FLOAT, 
	"Score_1" FLOAT, 
	PRIMARY KEY ("KEY")
...
-- Code For temporary table TMP_20180508180316_CODEGEN_0MJSS7_GB_sum part 2. Populate

INSERT INTO "TMP_20180508180316_CODEGEN_0MJSS7_GB_sum" ("KEY", "Score_0", "Score_1") SELECT "GB_sum"."KEY", "GB_sum"."Score_0", "GB_sum"."Score_1" 
...
FROM "TMP_20180508180316_CODEGEN_OZS4RO_GB_Union" AS "GB_Union" GROUP BY "GB_Union"."KEY") AS "T") AS "GB_sum"

-- Code For temporary table TMP_20180508180316_CODEGEN_0MJSS7_GB_sum part 3. Create Index 

CREATE INDEX "ix_TMP_20180508180316_CODEGEN_0MJSS7_GB_sum_KEY" ON "TMP_20180508180316_CODEGEN_0MJSS7_GB_sum" ("KEY")

-- Model deployment code

WITH orig_cte AS 
(SELECT "GB_sum"."KEY" AS "KEY", -(-0.10008345855698253 + 0.1 * "GB_sum"."Score_1") AS "Score_0", -0.10008345855698253 + 0.1 * "GB_sum"."Score_1" AS "Score_1", 1.0 - 1.0 / (1.0 + exp(min(max(-100.0, -(-0.10008345855698253 + 0.1 * "GB_sum"."Score_1")), 100.0))) AS "Proba_0", 1.0 / (1.0 + exp(min(max(-100.0, -(-0.10008345855698253 + 0.1 * "GB_sum"."Score_1")), 100.0))) AS "Proba_1", CAST(NULL AS FLOAT) AS "LogProba_0", CAST(NULL AS FLOAT) AS "LogProba_1", CAST(NULL AS BIGINT) AS "Decision", CAST(NULL AS FLOAT) AS "DecisionProba" 
FROM "TMP_20180508180316_CODEGEN_0MJSS7_GB_sum" AS "GB_sum"), 
