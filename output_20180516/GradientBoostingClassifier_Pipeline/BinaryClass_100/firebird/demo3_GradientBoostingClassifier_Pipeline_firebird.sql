...
-- Code For temporary table TMP_20180602_3AP_ADS_IMP_1_OUT part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180602_3AP_ADS_IMP_1_OUT" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20180602_3AP_ADS_IMP_1_OUT part 3. Create Index 

CREATE INDEX "ix_TMP_20180602_3AP_ADS_c760" ON "TMP_20180602_3AP_ADS_IMP_1_OUT" ("KEY")

-- Code For temporary table TMP_20180602_VWG_ADS_SCA_2_OUT part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180602_VWG_ADS_SCA_2_OUT" (
	"KEY" BIGINT NOT NULL, 
...
FROM "TMP_20180602_3AP_ADS_IMP_1_OUT" AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT") AS "U"

-- Code For temporary table TMP_20180602_VWG_ADS_SCA_2_OUT part 3. Create Index 

CREATE INDEX "ix_TMP_20180602_VWG_ADS_f253" ON "TMP_20180602_VWG_ADS_SCA_2_OUT" ("KEY")

-- Code For temporary table TMP_20180602_LRR_GB_B0 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180602_LRR_GB_B0" (
	"KEY" BIGINT, 
...
-- Code For temporary table TMP_20180602_LRR_GB_B0 part 2. Populate

INSERT INTO "TMP_20180602_LRR_GB_B0" ("KEY", "Score_0", "Score_1") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1" 
...
FROM "TMP_20180602_VWG_ADS_SCA_2_OUT" AS "ADS_sca_2_OUT"), 
"DT_node_data" AS 
(SELECT "Values".nid AS nid, CAST("Values"."E" AS DOUBLE PRECISION) AS "E" 
FROM (SELECT 3 AS nid, -1.6183315431435734 AS "E" FROM rdb$database UNION ALL SELECT 4 AS nid, 2.1052631578947363 AS "E" FROM rdb$database UNION ALL SELECT 6 AS nid, 2.1052631578947363 AS "E" FROM rdb$database UNION ALL SELECT 7 AS nid, -1.904761904761905 AS "E" FROM rdb$database UNION ALL SELECT 10 AS nid, -1.904761904761905 AS "E" FROM rdb$database UNION ALL SELECT 11 AS nid, 2.105263157894737 AS "E" FROM rdb$database UNION ALL SELECT 12 AS nid, -1.904761904761905 AS "E" FROM rdb$database) AS "Values"), 
"DT_Output" AS 
...
"DT_node_data_1" AS 
(SELECT "Values".nid AS nid, CAST("Values"."E" AS DOUBLE PRECISION) AS "E" 
FROM (SELECT 3 AS nid, 2.096008535366903 AS "E" FROM rdb$database UNION ALL SELECT 4 AS nid, -1.4234854473404777 AS "E" FROM rdb$database UNION ALL SELECT 6 AS nid, 1.895437496504261 AS "E" FROM rdb$database UNION ALL SELECT 7 AS nid, 2.2994181831603377 AS "E" FROM rdb$database UNION ALL SELECT 10 AS nid, 1.8954374965042624 AS "E" FROM rdb$database UNION ALL SELECT 11 AS nid, -1.7478449197552628 AS "E" FROM rdb$database UNION ALL SELECT 12 AS nid, -1.7478449197552628 AS "E" FROM rdb$database) AS "Values"), 
"DT_Output_1" AS 
...
-- Code For temporary table TMP_20180602_TCC_GB_B1 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180602_TCC_GB_B1" (
	"KEY" BIGINT, 
	"Score_0" DOUBLE PRECISION, 
	"Score_1" DOUBLE PRECISION
)
...
-- Code For temporary table TMP_20180602_TCC_GB_B1 part 2. Populate

INSERT INTO "TMP_20180602_TCC_GB_B1" ("KEY", "Score_0", "Score_1") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1" 
...
"DT_node_data_3" AS 
(SELECT "Values".nid AS nid, CAST("Values"."E" AS DOUBLE PRECISION) AS "E" 
FROM (SELECT 3 AS nid, 2.2033215782363085 AS "E" FROM rdb$database UNION ALL SELECT 4 AS nid, 1.8292167028822635 AS "E" FROM rdb$database UNION ALL SELECT 6 AS nid, -1.2388948754014388 AS "E" FROM rdb$database UNION ALL SELECT 7 AS nid, 1.8443051333640834 AS "E" FROM rdb$database UNION ALL SELECT 9 AS nid, -1.5335854573777359 AS "E" FROM rdb$database UNION ALL SELECT 11 AS nid, 1.6224640389018972 AS "E" FROM rdb$database UNION ALL SELECT 12 AS nid, -1.5335854573777359 AS "E" FROM rdb$database) AS "Values"), 
"DT_Output_3" AS 
...
"DT_node_data_4" AS 
(SELECT "Values".nid AS nid, CAST("Values"."E" AS DOUBLE PRECISION) AS "E" 
FROM (SELECT 3 AS nid, -1.4201836338413583 AS "E" FROM rdb$database UNION ALL SELECT 4 AS nid, 0.8818891509469176 AS "E" FROM rdb$database UNION ALL SELECT 6 AS nid, 2.0543740519216325 AS "E" FROM rdb$database UNION ALL SELECT 7 AS nid, -1.5115435903792729 AS "E" FROM rdb$database UNION ALL SELECT 10 AS nid, -1.4577213966216014 AS "E" FROM rdb$database UNION ALL SELECT 11 AS nid, 1.5448043165070784 AS "E" FROM rdb$database UNION ALL SELECT 13 AS nid, -1.4876585385597692 AS "E" FROM rdb$database UNION ALL SELECT 14 AS nid, 1.529238644498216 AS "E" FROM rdb$database) AS "Values"), 
"DT_Output_4" AS 
...
-- Code For temporary table TMP_20180602_PPW_GB_B2 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180602_PPW_GB_B2" (
	"KEY" BIGINT, 
	"Score_0" DOUBLE PRECISION, 
	"Score_1" DOUBLE PRECISION
)
...
-- Code For temporary table TMP_20180602_PPW_GB_B2 part 2. Populate

INSERT INTO "TMP_20180602_PPW_GB_B2" ("KEY", "Score_0", "Score_1") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1" 
...
"DT_node_data_5" AS 
(SELECT "Values".nid AS nid, CAST("Values"."E" AS DOUBLE PRECISION) AS "E" 
FROM (SELECT 3 AS nid, 1.958202526870995 AS "E" FROM rdb$database UNION ALL SELECT 4 AS nid, -1.448008549051362 AS "E" FROM rdb$database UNION ALL SELECT 6 AS nid, -1.3444944167722634 AS "E" FROM rdb$database UNION ALL SELECT 7 AS nid, 0.7265051857481474 AS "E" FROM rdb$database UNION ALL SELECT 10 AS nid, -1.395633609741032 AS "E" FROM rdb$database UNION ALL SELECT 11 AS nid, 1.4673881774513675 AS "E" FROM rdb$database UNION ALL SELECT 13 AS nid, 1.4541899894634762 AS "E" FROM rdb$database UNION ALL SELECT 14 AS nid, -1.4203469592033384 AS "E" FROM rdb$database) AS "Values"), 
"DT_Output_5" AS 
...
"DT_node_data_6" AS 
(SELECT "Values".nid AS nid, CAST("Values"."E" AS DOUBLE PRECISION) AS "E" 
FROM (SELECT 3 AS nid, -1.3946185074449031 AS "E" FROM rdb$database UNION ALL SELECT 4 AS nid, 0.525957561992705 AS "E" FROM rdb$database UNION ALL SELECT 6 AS nid, 1.937257098415046 AS "E" FROM rdb$database UNION ALL SELECT 7 AS nid, -0.8866233396726353 AS "E" FROM rdb$database UNION ALL SELECT 10 AS nid, -1.344097550451214 AS "E" FROM rdb$database UNION ALL SELECT 11 AS nid, 1.4040651025086777 AS "E" FROM rdb$database UNION ALL SELECT 13 AS nid, -1.3647650410708272 AS "E" FROM rdb$database UNION ALL SELECT 14 AS nid, 1.3927198824988734 AS "E" FROM rdb$database) AS "Values"), 
"DT_Output_6" AS 
...
-- Code For temporary table TMP_20180602_5FG_GB_B3 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180602_5FG_GB_B3" (
	"KEY" BIGINT, 
	"Score_0" DOUBLE PRECISION, 
	"Score_1" DOUBLE PRECISION
)
...
-- Code For temporary table TMP_20180602_5FG_GB_B3 part 2. Populate

INSERT INTO "TMP_20180602_5FG_GB_B3" ("KEY", "Score_0", "Score_1") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1" 
...
"DT_node_data_8" AS 
(SELECT "Values".nid AS nid, CAST("Values"."E" AS DOUBLE PRECISION) AS "E" 
FROM (SELECT 3 AS nid, 1.6108718821416377 AS "E" FROM rdb$database UNION ALL SELECT 4 AS nid, 1.6688510571596784 AS "E" FROM rdb$database UNION ALL SELECT 6 AS nid, -1.068080084295244 AS "E" FROM rdb$database UNION ALL SELECT 7 AS nid, 0.9475315093373128 AS "E" FROM rdb$database UNION ALL SELECT 10 AS nid, 1.307398426483107 AS "E" FROM rdb$database UNION ALL SELECT 11 AS nid, -1.264127868945373 AS "E" FROM rdb$database UNION ALL SELECT 13 AS nid, 1.298765298853743 AS "E" FROM rdb$database UNION ALL SELECT 14 AS nid, -1.279025518068119 AS "E" FROM rdb$database) AS "Values"), 
"DT_Output_8" AS 
...
"DT_node_data_9" AS 
(SELECT "Values".nid AS nid, CAST("Values"."E" AS DOUBLE PRECISION) AS "E" 
FROM (SELECT 3 AS nid, 1.4900163352519837 AS "E" FROM rdb$database UNION ALL SELECT 4 AS nid, -0.9948753872812511 AS "E" FROM rdb$database UNION ALL SELECT 6 AS nid, 1.632261202074544 AS "E" FROM rdb$database UNION ALL SELECT 7 AS nid, 1.519985051185009 AS "E" FROM rdb$database UNION ALL SELECT 10 AS nid, -1.2327629493831462 AS "E" FROM rdb$database UNION ALL SELECT 11 AS nid, 1.2699877686233394 AS "E" FROM rdb$database UNION ALL SELECT 13 AS nid, -1.245562745293807 AS "E" FROM rdb$database UNION ALL SELECT 14 AS nid, 1.262376837539426 AS "E" FROM rdb$database) AS "Values"), 
"DT_Output_9" AS 
...
-- Code For temporary table TMP_20180602_QDE_GB_B4 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180602_QDE_GB_B4" (
	"KEY" BIGINT, 
	"Score_0" DOUBLE PRECISION, 
	"Score_1" DOUBLE PRECISION
)
...
-- Code For temporary table TMP_20180602_QDE_GB_B4 part 2. Populate

INSERT INTO "TMP_20180602_QDE_GB_B4" ("KEY", "Score_0", "Score_1") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1" 
...
"DT_node_data_10" AS 
(SELECT "Values".nid AS nid, CAST("Values"."E" AS DOUBLE PRECISION) AS "E" 
FROM (SELECT 3 AS nid, 1.446661732834358 AS "E" FROM rdb$database UNION ALL SELECT 4 AS nid, -1.2499360133065067 AS "E" FROM rdb$database UNION ALL SELECT 6 AS nid, 1.6219351936501099 AS "E" FROM rdb$database UNION ALL SELECT 7 AS nid, -1.2895245850004842 AS "E" FROM rdb$database UNION ALL SELECT 10 AS nid, 1.1975528332766405 AS "E" FROM rdb$database UNION ALL SELECT 11 AS nid, -0.6151746918646214 AS "E" FROM rdb$database UNION ALL SELECT 13 AS nid, -1.317315323569 AS "E" FROM rdb$database UNION ALL SELECT 14 AS nid, -1.2057669579063237 AS "E" FROM rdb$database) AS "Values"), 
"DT_Output_10" AS 
...
"DT_node_data_11" AS 
(SELECT "Values".nid AS nid, CAST("Values"."E" AS DOUBLE PRECISION) AS "E" 
FROM (SELECT 3 AS nid, -1.220589039043774 AS "E" FROM rdb$database UNION ALL SELECT 4 AS nid, 1.3865013593274123 AS "E" FROM rdb$database UNION ALL SELECT 6 AS nid, 1.5327998769743132 AS "E" FROM rdb$database UNION ALL SELECT 7 AS nid, -1.2548231207419789 AS "E" FROM rdb$database UNION ALL SELECT 10 AS nid, -1.2256580639543597 AS "E" FROM rdb$database UNION ALL SELECT 11 AS nid, -1.2318331300228573 AS "E" FROM rdb$database UNION ALL SELECT 13 AS nid, 1.2459403972282284 AS "E" FROM rdb$database UNION ALL SELECT 14 AS nid, -0.05217530635323901 AS "E" FROM rdb$database) AS "Values"), 
"DT_Output_11" AS 
...
-- Code For temporary table TMP_20180602_86K_GB_B5 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180602_86K_GB_B5" (
	"KEY" BIGINT, 
	"Score_0" DOUBLE PRECISION, 
	"Score_1" DOUBLE PRECISION
)
...
-- Code For temporary table TMP_20180602_86K_GB_B5 part 2. Populate

INSERT INTO "TMP_20180602_86K_GB_B5" ("KEY", "Score_0", "Score_1") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1" 
...
"DT_node_data_13" AS 
(SELECT "Values".nid AS nid, CAST("Values"."E" AS DOUBLE PRECISION) AS "E" 
FROM (SELECT 3 AS nid, -1.0027112222309909 AS "E" FROM rdb$database UNION ALL SELECT 4 AS nid, 0.5020490769066449 AS "E" FROM rdb$database UNION ALL SELECT 6 AS nid, 1.4820602336151274 AS "E" FROM rdb$database UNION ALL SELECT 7 AS nid, 1.289621326139366 AS "E" FROM rdb$database UNION ALL SELECT 10 AS nid, 1.1667450118563434 AS "E" FROM rdb$database UNION ALL SELECT 11 AS nid, -1.1612257530876875 AS "E" FROM rdb$database UNION ALL SELECT 12 AS nid, -1.1796530087132728 AS "E" FROM rdb$database) AS "Values"), 
"DT_Output_13" AS 
...
"DT_node_data_14" AS 
(SELECT "Values".nid AS nid, CAST("Values"."E" AS DOUBLE PRECISION) AS "E" 
FROM (SELECT 3 AS nid, 1.3748289048641364 AS "E" FROM rdb$database UNION ALL SELECT 4 AS nid, 1.3254178894915882 AS "E" FROM rdb$database UNION ALL SELECT 6 AS nid, 1.5416984936659368 AS "E" FROM rdb$database UNION ALL SELECT 7 AS nid, -0.9882844135467986 AS "E" FROM rdb$database UNION ALL SELECT 10 AS nid, -1.1728890055441057 AS "E" FROM rdb$database UNION ALL SELECT 11 AS nid, 1.017348509871444 AS "E" FROM rdb$database UNION ALL SELECT 13 AS nid, -1.1435499417251889 AS "E" FROM rdb$database UNION ALL SELECT 14 AS nid, -1.2203033466414503 AS "E" FROM rdb$database) AS "Values"), 
"DT_Output_14" AS 
...
-- Code For temporary table TMP_20180602_MZI_GB_B6 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180602_MZI_GB_B6" (
	"KEY" BIGINT, 
	"Score_0" DOUBLE PRECISION, 
	"Score_1" DOUBLE PRECISION
)
...
-- Code For temporary table TMP_20180602_MZI_GB_B6 part 2. Populate

INSERT INTO "TMP_20180602_MZI_GB_B6" ("KEY", "Score_0", "Score_1") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1" 
...
"DT_node_data_15" AS 
(SELECT "Values".nid AS nid, CAST("Values"."E" AS DOUBLE PRECISION) AS "E" 
FROM (SELECT 3 AS nid, -1.1408123626661393 AS "E" FROM rdb$database UNION ALL SELECT 4 AS nid, -1.1949952326507387 AS "E" FROM rdb$database UNION ALL SELECT 6 AS nid, 0.8502158462658079 AS "E" FROM rdb$database UNION ALL SELECT 7 AS nid, -0.5955307623945251 AS "E" FROM rdb$database UNION ALL SELECT 9 AS nid, -1.2312159733472068 AS "E" FROM rdb$database UNION ALL SELECT 11 AS nid, -1.1721830246591496 AS "E" FROM rdb$database UNION ALL SELECT 12 AS nid, -1.1415942686578024 AS "E" FROM rdb$database) AS "Values"), 
"DT_Output_15" AS 
...
-- Code For temporary table TMP_20180602_EGX_GB_SUM part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180602_EGX_GB_SUM" (
	"KEY" BIGINT NOT NULL, 
	"Score_0" DOUBLE PRECISION, 
	"Score_1" DOUBLE PRECISION, 
	PRIMARY KEY ("KEY")
...
-- Code For temporary table TMP_20180602_EGX_GB_SUM part 2. Populate

INSERT INTO "TMP_20180602_EGX_GB_SUM" ("KEY", "Score_0", "Score_1") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1" 
...
FROM "TMP_20180602_LRR_GB_B0" AS "GB_B0" UNION ALL SELECT "GB_B1"."KEY" AS "KEY", "GB_B1"."Score_0" AS "Score_0", "GB_B1"."Score_1" AS "Score_1" 
FROM "TMP_20180602_TCC_GB_B1" AS "GB_B1" UNION ALL SELECT "GB_B2"."KEY" AS "KEY", "GB_B2"."Score_0" AS "Score_0", "GB_B2"."Score_1" AS "Score_1" 
FROM "TMP_20180602_PPW_GB_B2" AS "GB_B2" UNION ALL SELECT "GB_B3"."KEY" AS "KEY", "GB_B3"."Score_0" AS "Score_0", "GB_B3"."Score_1" AS "Score_1" 
FROM "TMP_20180602_5FG_GB_B3" AS "GB_B3" UNION ALL SELECT "GB_B4"."KEY" AS "KEY", "GB_B4"."Score_0" AS "Score_0", "GB_B4"."Score_1" AS "Score_1" 
FROM "TMP_20180602_QDE_GB_B4" AS "GB_B4" UNION ALL SELECT "GB_B5"."KEY" AS "KEY", "GB_B5"."Score_0" AS "Score_0", "GB_B5"."Score_1" AS "Score_1" 
FROM "TMP_20180602_86K_GB_B5" AS "GB_B5" UNION ALL SELECT "GB_B6"."KEY" AS "KEY", "GB_B6"."Score_0" AS "Score_0", "GB_B6"."Score_1" AS "Score_1" 
FROM "TMP_20180602_MZI_GB_B6" AS "GB_B6") AS "GB_EnsembleUnion")
...
-- Code For temporary table TMP_20180602_EGX_GB_SUM part 3. Create Index 

CREATE INDEX "ix_TMP_20180602_EGX_GB_SUM_KEY" ON "TMP_20180602_EGX_GB_SUM" ("KEY")
...
FROM "TMP_20180602_EGX_GB_SUM" AS "GB_sum"), 
