...
-- Code For temporary table DEGEN_70EUNJ_ADS_IMP_1_OUT part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "DEGEN_70EUNJ_ADS_IMP_1_OUT" (
	"KEY" NUMBER(19), 
...
-- Code For temporary table DEGEN_2MXSIO_ADS_SCA_2_OUT part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "DEGEN_2MXSIO_ADS_SCA_2_OUT" (
	"KEY" NUMBER(19), 
...
FROM "DEGEN_70EUNJ_ADS_IMP_1_OUT" "ADS_imp_1_OUT") "ADS_sca_2_OUT") "U"

-- Code For temporary table 80316_CODEGEN_KNR4L4_GB_B0 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "80316_CODEGEN_KNR4L4_GB_B0" (
	"KEY" NUMBER(19), 
...
-- Code For temporary table 80316_CODEGEN_KNR4L4_GB_B0 part 2. Populate

INSERT INTO "80316_CODEGEN_KNR4L4_GB_B0" ("KEY", "Score_0", "Score_1") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1" 
...
FROM "DEGEN_2MXSIO_ADS_SCA_2_OUT" "ADS_sca_2_OUT"), 
"DT_node_data" AS 
...
-- Code For temporary table 80316_CODEGEN_94DB5F_GB_B1 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "80316_CODEGEN_94DB5F_GB_B1" (
	"KEY" NUMBER(19), 
	"Score_0" BINARY_DOUBLE, 
	"Score_1" BINARY_DOUBLE
)
...
-- Code For temporary table 80316_CODEGEN_94DB5F_GB_B1 part 2. Populate

INSERT INTO "80316_CODEGEN_94DB5F_GB_B1" ("KEY", "Score_0", "Score_1") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1" 
...
-- Code For temporary table 80316_CODEGEN_KQVVBU_GB_B2 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "80316_CODEGEN_KQVVBU_GB_B2" (
	"KEY" NUMBER(19), 
	"Score_0" BINARY_DOUBLE, 
	"Score_1" BINARY_DOUBLE
)
...
-- Code For temporary table 80316_CODEGEN_KQVVBU_GB_B2 part 2. Populate

INSERT INTO "80316_CODEGEN_KQVVBU_GB_B2" ("KEY", "Score_0", "Score_1") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1" 
...
-- Code For temporary table 80316_CODEGEN_VOAM7E_GB_B3 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "80316_CODEGEN_VOAM7E_GB_B3" (
	"KEY" NUMBER(19), 
	"Score_0" BINARY_DOUBLE, 
	"Score_1" BINARY_DOUBLE
)
...
-- Code For temporary table 80316_CODEGEN_VOAM7E_GB_B3 part 2. Populate

INSERT INTO "80316_CODEGEN_VOAM7E_GB_B3" ("KEY", "Score_0", "Score_1") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1" 
...
-- Code For temporary table 16_CODEGEN_EWIEER_GB_UNION part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "16_CODEGEN_EWIEER_GB_UNION" (
	"KEY" NUMBER(19), 
	"Score_0" BINARY_DOUBLE, 
	"Score_1" BINARY_DOUBLE
)
...
-- Code For temporary table 16_CODEGEN_EWIEER_GB_UNION part 2. Populate

INSERT INTO "16_CODEGEN_EWIEER_GB_UNION" ("KEY", "Score_0", "Score_1") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1" 
...
FROM "80316_CODEGEN_KNR4L4_GB_B0" "GB_B0" UNION ALL SELECT "GB_B1"."KEY" AS "KEY", "GB_B1"."Score_0" AS "Score_0", "GB_B1"."Score_1" AS "Score_1" 
FROM "80316_CODEGEN_94DB5F_GB_B1" "GB_B1" UNION ALL SELECT "GB_B2"."KEY" AS "KEY", "GB_B2"."Score_0" AS "Score_0", "GB_B2"."Score_1" AS "Score_1" 
FROM "80316_CODEGEN_KQVVBU_GB_B2" "GB_B2" UNION ALL SELECT "GB_B3"."KEY" AS "KEY", "GB_B3"."Score_0" AS "Score_0", "GB_B3"."Score_1" AS "Score_1" 
FROM "80316_CODEGEN_VOAM7E_GB_B3" "GB_B3") "GB_EnsembleUnion") "GB_Union") "U"

-- Code For temporary table 0316_CODEGEN_RFQFWR_GB_SUM part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "0316_CODEGEN_RFQFWR_GB_SUM" (
	"KEY" NUMBER(19), 
	"Score_0" BINARY_DOUBLE, 
	"Score_1" BINARY_DOUBLE
)
...
-- Code For temporary table 0316_CODEGEN_RFQFWR_GB_SUM part 2. Populate

INSERT INTO "0316_CODEGEN_RFQFWR_GB_SUM" ("KEY", "Score_0", "Score_1") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1" 
...
FROM "16_CODEGEN_EWIEER_GB_UNION" "GB_Union" GROUP BY "GB_Union"."KEY") "T") "GB_sum") "U"
...
FROM "0316_CODEGEN_RFQFWR_GB_SUM" "GB_sum"), 
