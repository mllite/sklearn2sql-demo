...
-- Code For temporary table TMP_20180516_CODEGEN_AS1HTG_ADS part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180516_CODEGEN_AS1HTG_ADS" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20180516_CODEGEN_AS1HTG_ADS part 2. Populate

INSERT INTO "TMP_20180516_CODEGEN_AS1HTG_ADS" ("KEY", imputer_output_2, imputer_output_3, imputer_output_4, imputer_output_5) SELECT "U"."KEY", "U".imputer_output_2, "U".imputer_output_3, "U".imputer_output_4, "U".imputer_output_5 
...
-- Code For temporary table TMP_20180516_CODEGEN_AS1HTG_ADS part 3. Create Index 

CREATE INDEX "ix_TMP_20180516_CODEGEN_5bf2" ON "TMP_20180516_CODEGEN_AS1HTG_ADS" ("KEY")

-- Code For temporary table TMP_20180516_CODEGEN_GFVKVD_ADS part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180516_CODEGEN_GFVKVD_ADS" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20180516_CODEGEN_GFVKVD_ADS part 2. Populate

INSERT INTO "TMP_20180516_CODEGEN_GFVKVD_ADS" ("KEY", scaler_output_2, scaler_output_3, scaler_output_4, scaler_output_5) SELECT "U"."KEY", "U".scaler_output_2, "U".scaler_output_3, "U".scaler_output_4, "U".scaler_output_5 
...
FROM "TMP_20180516_CODEGEN_AS1HTG_ADS" AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT") AS "U"

-- Code For temporary table TMP_20180516_CODEGEN_GFVKVD_ADS part 3. Create Index 

CREATE INDEX "ix_TMP_20180516_CODEGEN_5389" ON "TMP_20180516_CODEGEN_GFVKVD_ADS" ("KEY")

-- Code For temporary table TMP_20180516_CODEGEN_U77JD6_GB_ part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180516_CODEGEN_U77JD6_GB_" (
	"KEY" BIGINT, 
...
-- Code For temporary table TMP_20180516_CODEGEN_U77JD6_GB_ part 2. Populate

INSERT INTO "TMP_20180516_CODEGEN_U77JD6_GB_" ("KEY", "Score_0", "Score_1", "Score_2") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1", "U"."Score_2" 
...
FROM "TMP_20180516_CODEGEN_GFVKVD_ADS" AS "ADS_sca_2_OUT"), 
"DT_node_data" AS 
...
-- Code For temporary table TMP_20180516_CODEGEN_RPK0T2_GB_ part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180516_CODEGEN_RPK0T2_GB_" (
	"KEY" BIGINT, 
	"Score_0" DOUBLE PRECISION, 
	"Score_1" DOUBLE PRECISION, 
	"Score_2" DOUBLE PRECISION
...
-- Code For temporary table TMP_20180516_CODEGEN_RPK0T2_GB_ part 2. Populate

INSERT INTO "TMP_20180516_CODEGEN_RPK0T2_GB_" ("KEY", "Score_0", "Score_1", "Score_2") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1", "U"."Score_2" 
...
-- Code For temporary table TMP_20180516_CODEGEN_0IY1MO_GB_ part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180516_CODEGEN_0IY1MO_GB_" (
	"KEY" BIGINT, 
	"Score_0" DOUBLE PRECISION, 
	"Score_1" DOUBLE PRECISION, 
	"Score_2" DOUBLE PRECISION
...
-- Code For temporary table TMP_20180516_CODEGEN_0IY1MO_GB_ part 2. Populate

INSERT INTO "TMP_20180516_CODEGEN_0IY1MO_GB_" ("KEY", "Score_0", "Score_1", "Score_2") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1", "U"."Score_2" 
...
-- Code For temporary table TMP_20180516_CODEGEN_SHLI4B_GB_ part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180516_CODEGEN_SHLI4B_GB_" (
	"KEY" BIGINT, 
	"Score_0" DOUBLE PRECISION, 
	"Score_1" DOUBLE PRECISION, 
	"Score_2" DOUBLE PRECISION
...
-- Code For temporary table TMP_20180516_CODEGEN_SHLI4B_GB_ part 2. Populate

INSERT INTO "TMP_20180516_CODEGEN_SHLI4B_GB_" ("KEY", "Score_0", "Score_1", "Score_2") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1", "U"."Score_2" 
...
-- Code For temporary table TMP_20180516_CODEGEN_UPL2GT_GB_ part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180516_CODEGEN_UPL2GT_GB_" (
	"KEY" BIGINT, 
	"Score_0" DOUBLE PRECISION, 
	"Score_1" DOUBLE PRECISION, 
	"Score_2" DOUBLE PRECISION
...
-- Code For temporary table TMP_20180516_CODEGEN_UPL2GT_GB_ part 2. Populate

INSERT INTO "TMP_20180516_CODEGEN_UPL2GT_GB_" ("KEY", "Score_0", "Score_1", "Score_2") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1", "U"."Score_2" 
...
-- Code For temporary table TMP_20180516_CODEGEN_ALXQCQ_GB_ part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180516_CODEGEN_ALXQCQ_GB_" (
	"KEY" BIGINT NOT NULL, 
	"Score_0" DOUBLE PRECISION, 
	"Score_1" DOUBLE PRECISION, 
	"Score_2" DOUBLE PRECISION, 
...
-- Code For temporary table TMP_20180516_CODEGEN_ALXQCQ_GB_ part 2. Populate

INSERT INTO "TMP_20180516_CODEGEN_ALXQCQ_GB_" ("KEY", "Score_0", "Score_1", "Score_2") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1", "U"."Score_2" 
...
FROM "TMP_20180516_CODEGEN_U77JD6_GB_" AS "GB_B0" UNION ALL SELECT "GB_B1"."KEY" AS "KEY", "GB_B1"."Score_0" AS "Score_0", "GB_B1"."Score_1" AS "Score_1", "GB_B1"."Score_2" AS "Score_2" 
FROM "TMP_20180516_CODEGEN_RPK0T2_GB_" AS "GB_B1" UNION ALL SELECT "GB_B2"."KEY" AS "KEY", "GB_B2"."Score_0" AS "Score_0", "GB_B2"."Score_1" AS "Score_1", "GB_B2"."Score_2" AS "Score_2" 
FROM "TMP_20180516_CODEGEN_0IY1MO_GB_" AS "GB_B2" UNION ALL SELECT "GB_B3"."KEY" AS "KEY", "GB_B3"."Score_0" AS "Score_0", "GB_B3"."Score_1" AS "Score_1", "GB_B3"."Score_2" AS "Score_2" 
FROM "TMP_20180516_CODEGEN_SHLI4B_GB_" AS "GB_B3" UNION ALL SELECT "GB_B4"."KEY" AS "KEY", "GB_B4"."Score_0" AS "Score_0", "GB_B4"."Score_1" AS "Score_1", "GB_B4"."Score_2" AS "Score_2" 
FROM "TMP_20180516_CODEGEN_UPL2GT_GB_" AS "GB_B4") AS "GB_EnsembleUnion")
...
-- Code For temporary table TMP_20180516_CODEGEN_ALXQCQ_GB_ part 3. Create Index 

CREATE INDEX "ix_TMP_20180516_CODEGEN_db08" ON "TMP_20180516_CODEGEN_ALXQCQ_GB_" ("KEY")
...
FROM "TMP_20180516_CODEGEN_ALXQCQ_GB_" AS "GB_sum"), 
