...
-- Code For temporary table tmp_20180516122444_codegen_l4spqo_ads_imp_1_out part 1. Create 

CREATE TEMPORARY TABLE `tmp_20180516122444_codegen_l4spqo_ads_imp_1_out` STORED AS ORC AS SELECT `ADS_imp_1_OUT`.`KEY`, `ADS_imp_1_OUT`.`imputer_output_2`, `ADS_imp_1_OUT`.`imputer_output_3`, `ADS_imp_1_OUT`.`imputer_output_4`, `ADS_imp_1_OUT`.`imputer_output_5` 
FROM (SELECT `ADS`.`KEY` AS `KEY`, CASE WHEN (`ADS`.`Feature_0` IS NULL) THEN 5.8474999999999975 ELSE `ADS`.`Feature_0` END AS `imputer_output_2`, CASE WHEN (`ADS`.`Feature_1` IS NULL) THEN 3.0366666666666657 ELSE `ADS`.`Feature_1` END AS `imputer_output_3`, CASE WHEN (`ADS`.`Feature_2` IS NULL) THEN 3.8450000000000006 ELSE `ADS`.`Feature_2` END AS `imputer_output_4`, CASE WHEN (`ADS`.`Feature_3` IS NULL) THEN 1.245 ELSE `ADS`.`Feature_3` END AS `imputer_output_5` 
FROM `iris` AS `ADS`) AS `ADS_imp_1_OUT`

-- Code For temporary table tmp_20180516122444_codegen_l4spqo_ads_imp_1_out part 2. Populate

SELECT * FROM `tmp_20180516122444_codegen_l4spqo_ads_imp_1_out`

-- Code For temporary table tmp_20180516122444_codegen_ockxtl_ads_sca_2_out part 1. Create 

CREATE TEMPORARY TABLE `tmp_20180516122444_codegen_ockxtl_ads_sca_2_out` STORED AS ORC AS SELECT `ADS_sca_2_OUT`.`KEY`, `ADS_sca_2_OUT`.`scaler_output_2`, `ADS_sca_2_OUT`.`scaler_output_3`, `ADS_sca_2_OUT`.`scaler_output_4`, `ADS_sca_2_OUT`.`scaler_output_5` 
...
FROM `tmp_20180516122444_codegen_l4spqo_ads_imp_1_out` AS `ADS_imp_1_OUT`) AS `ADS_sca_2_OUT`

-- Code For temporary table tmp_20180516122444_codegen_ockxtl_ads_sca_2_out part 2. Populate

SELECT * FROM `tmp_20180516122444_codegen_ockxtl_ads_sca_2_out`

-- Code For temporary table tmp_20180516122444_codegen_nm3gn3_gb_b0 part 1. Create 

CREATE TEMPORARY TABLE `tmp_20180516122444_codegen_nm3gn3_gb_b0` STORED AS ORC AS WITH `DT_node_lookup` AS 
...
FROM `tmp_20180516122444_codegen_ockxtl_ads_sca_2_out` AS `ADS_sca_2_OUT`), 
`DT_node_data` AS 
...
-- Code For temporary table tmp_20180516122444_codegen_nm3gn3_gb_b0 part 2. Populate

SELECT * FROM `tmp_20180516122444_codegen_nm3gn3_gb_b0`

-- Code For temporary table tmp_20180516122444_codegen_ri2rwq_gb_b1 part 1. Create 

CREATE TEMPORARY TABLE `tmp_20180516122444_codegen_ri2rwq_gb_b1` STORED AS ORC AS WITH `DT_node_lookup_10` AS 
...
-- Code For temporary table tmp_20180516122444_codegen_ri2rwq_gb_b1 part 2. Populate

SELECT * FROM `tmp_20180516122444_codegen_ri2rwq_gb_b1`

-- Code For temporary table tmp_20180516122444_codegen_cpc6wy_gb_b2 part 1. Create 

CREATE TEMPORARY TABLE `tmp_20180516122444_codegen_cpc6wy_gb_b2` STORED AS ORC AS WITH `DT_node_lookup_20` AS 
(SELECT `ADS_sca_2_OUT`.`KEY` AS `KEY`, CASE WHEN (`ADS_sca_2_OUT`.`scaler_output_4` <= 0.5877821445465088) THEN CASE WHEN (`ADS_sca_2_OUT`.`scaler_output_5` <= 0.5400919914245605) THEN CASE WHEN (`ADS_sca_2_OUT`.`scaler_output_5` <= -0.5934344530105591) THEN 3 ELSE 4 END ELSE CASE WHEN (`ADS_sca_2_OUT`.`scaler_output_3` <= 0.1451735943555832) THEN 6 ELSE 7 END END ELSE CASE WHEN (`ADS_sca_2_OUT`.`scaler_output_5` <= 0.6734480857849121) THEN CASE WHEN (`ADS_sca_2_OUT`.`scaler_output_4` <= 0.6462678909301758) THEN 10 ELSE 11 END ELSE CASE WHEN (`ADS_sca_2_OUT`.`scaler_output_4` <= 0.6462678909301758) THEN 13 ELSE 14 END END END AS `node_id_2` 
FROM `tmp_20180516122444_codegen_ockxtl_ads_sca_2_out` AS `ADS_sca_2_OUT`), 
`DT_node_data_20` AS 
(SELECT `Values`.`nid` AS `nid`, CAST(`Values`.`E` AS DOUBLE) AS `E` 
...
-- Code For temporary table tmp_20180516122444_codegen_cpc6wy_gb_b2 part 2. Populate

SELECT * FROM `tmp_20180516122444_codegen_cpc6wy_gb_b2`

-- Code For temporary table tmp_20180516122444_codegen_e5qt2e_gb_b3 part 1. Create 

CREATE TEMPORARY TABLE `tmp_20180516122444_codegen_e5qt2e_gb_b3` STORED AS ORC AS WITH `DT_node_lookup_30` AS 
(SELECT `ADS_sca_2_OUT`.`KEY` AS `KEY`, CASE WHEN (`ADS_sca_2_OUT`.`scaler_output_4` <= -0.8158766627311707) THEN 1 ELSE CASE WHEN (`ADS_sca_2_OUT`.`scaler_output_3` <= 0.2597843110561371) THEN CASE WHEN (`ADS_sca_2_OUT`.`scaler_output_3` <= -1.803208827972412) THEN 4 ELSE 5 END ELSE CASE WHEN (`ADS_sca_2_OUT`.`scaler_output_2` <= 0.12393608689308167) THEN 7 ELSE 8 END END END AS `node_id_2` 
FROM `tmp_20180516122444_codegen_ockxtl_ads_sca_2_out` AS `ADS_sca_2_OUT`), 
`DT_node_data_30` AS 
(SELECT `Values`.`nid` AS `nid`, CAST(`Values`.`E` AS DOUBLE) AS `E` 
...
-- Code For temporary table tmp_20180516122444_codegen_e5qt2e_gb_b3 part 2. Populate

SELECT * FROM `tmp_20180516122444_codegen_e5qt2e_gb_b3`

-- Code For temporary table tmp_20180516122444_codegen_ddsmzo_gb_b4 part 1. Create 

CREATE TEMPORARY TABLE `tmp_20180516122444_codegen_ddsmzo_gb_b4` STORED AS ORC AS WITH `DT_node_lookup_40` AS 
(SELECT `ADS_sca_2_OUT`.`KEY` AS `KEY`, CASE WHEN (`ADS_sca_2_OUT`.`scaler_output_4` <= 0.6462678909301758) THEN CASE WHEN (`ADS_sca_2_OUT`.`scaler_output_4` <= -0.8158766627311707) THEN 2 ELSE CASE WHEN (`ADS_sca_2_OUT`.`scaler_output_5` <= 0.5400919914245605) THEN 4 ELSE 5 END END ELSE CASE WHEN (`ADS_sca_2_OUT`.`scaler_output_3` <= -1.5739872455596924) THEN 7 ELSE CASE WHEN (`ADS_sca_2_OUT`.`scaler_output_4` <= 0.7047536373138428) THEN 9 ELSE 10 END END END AS `node_id_2` 
FROM `tmp_20180516122444_codegen_ockxtl_ads_sca_2_out` AS `ADS_sca_2_OUT`), 
`DT_node_data_40` AS 
(SELECT `Values`.`nid` AS `nid`, CAST(`Values`.`E` AS DOUBLE) AS `E` 
...
-- Code For temporary table tmp_20180516122444_codegen_ddsmzo_gb_b4 part 2. Populate

SELECT * FROM `tmp_20180516122444_codegen_ddsmzo_gb_b4`

-- Code For temporary table tmp_20180516122444_codegen_irhlau_gb_sum part 1. Create 

CREATE TEMPORARY TABLE `tmp_20180516122444_codegen_irhlau_gb_sum` STORED AS ORC AS WITH `GB_Union` AS 
...
FROM `tmp_20180516122444_codegen_nm3gn3_gb_b0` AS `GB_B0` UNION ALL SELECT `GB_B1`.`KEY` AS `KEY`, `GB_B1`.`Score_0` AS `Score_0`, `GB_B1`.`Score_1` AS `Score_1`, `GB_B1`.`Score_2` AS `Score_2` 
FROM `tmp_20180516122444_codegen_ri2rwq_gb_b1` AS `GB_B1` UNION ALL SELECT `GB_B2`.`KEY` AS `KEY`, `GB_B2`.`Score_0` AS `Score_0`, `GB_B2`.`Score_1` AS `Score_1`, `GB_B2`.`Score_2` AS `Score_2` 
FROM `tmp_20180516122444_codegen_cpc6wy_gb_b2` AS `GB_B2` UNION ALL SELECT `GB_B3`.`KEY` AS `KEY`, `GB_B3`.`Score_0` AS `Score_0`, `GB_B3`.`Score_1` AS `Score_1`, `GB_B3`.`Score_2` AS `Score_2` 
FROM `tmp_20180516122444_codegen_e5qt2e_gb_b3` AS `GB_B3` UNION ALL SELECT `GB_B4`.`KEY` AS `KEY`, `GB_B4`.`Score_0` AS `Score_0`, `GB_B4`.`Score_1` AS `Score_1`, `GB_B4`.`Score_2` AS `Score_2` 
FROM `tmp_20180516122444_codegen_ddsmzo_gb_b4` AS `GB_B4`) AS `GB_EnsembleUnion`)
...
-- Code For temporary table tmp_20180516122444_codegen_irhlau_gb_sum part 2. Populate

SELECT * FROM `tmp_20180516122444_codegen_irhlau_gb_sum`
...
FROM `tmp_20180516122444_codegen_irhlau_gb_sum` AS `GB_sum`), 
