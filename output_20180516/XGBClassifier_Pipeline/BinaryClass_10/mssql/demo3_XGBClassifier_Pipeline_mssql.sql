...
-- Code For temporary table ##TMP_20180508180108_CODEGEN_24493R_ADS_imp_1_OUT part 1. Create 


CREATE TABLE ##TMP_20180508180108_CODEGEN_24493R_ADS_imp_1_OUT (
	[KEY] BIGINT NULL, 
...
-- Code For temporary table ##TMP_20180508180108_CODEGEN_24493R_ADS_imp_1_OUT part 2. Populate

INSERT INTO ##TMP_20180508180108_CODEGEN_24493R_ADS_imp_1_OUT ([KEY], impter_2, impter_3, impter_4, impter_5, impter_6, impter_7, impter_8, impter_9, impter_10, impter_11) SELECT [ADS_imp_1_OUT].[KEY], [ADS_imp_1_OUT].impter_2, [ADS_imp_1_OUT].impter_3, [ADS_imp_1_OUT].impter_4, [ADS_imp_1_OUT].impter_5, [ADS_imp_1_OUT].impter_6, [ADS_imp_1_OUT].impter_7, [ADS_imp_1_OUT].impter_8, [ADS_imp_1_OUT].impter_9, [ADS_imp_1_OUT].impter_10, [ADS_imp_1_OUT].impter_11 
...
-- Code For temporary table ##TMP_20180508180108_CODEGEN_D908A1_ADS_sca_2_OUT part 1. Create 


CREATE TABLE ##TMP_20180508180108_CODEGEN_D908A1_ADS_sca_2_OUT (
	[KEY] BIGINT NULL, 
	scaler_2 FLOAT NULL, 
	scaler_3 FLOAT NULL, 
	scaler_4 FLOAT NULL, 
...
FROM ##TMP_20180508180108_CODEGEN_24493R_ADS_imp_1_OUT AS [ADS_imp_1_OUT]) AS [ADS_sca_2_OUT]

-- Code For temporary table ##TMP_20180508180108_CODEGEN_VZN8WC_XGB_B0 part 1. Create 


CREATE TABLE ##TMP_20180508180108_CODEGEN_VZN8WC_XGB_B0 (
	[KEY] BIGINT NULL, 
...
-- Code For temporary table ##TMP_20180508180108_CODEGEN_VZN8WC_XGB_B0 part 2. Populate

WITH [DT_node_lookup] AS 
(SELECT [ADS_sca_2_OUT].[KEY] AS [KEY], CASE WHEN ([ADS_sca_2_OUT].scaler_11 < -0.24119442701339722) THEN 1 ELSE 2 END AS node_id_2 
FROM ##TMP_20180508180108_CODEGEN_D908A1_ADS_sca_2_OUT AS [ADS_sca_2_OUT]), 
[DT_node_data] AS 
...
FROM [DT_Output_9])
 INSERT INTO ##TMP_20180508180108_CODEGEN_VZN8WC_XGB_B0 ([KEY], [Score_0]) SELECT [XGB_B0].[KEY], [XGB_B0].[Score_0] 
...
-- Code For temporary table ##TMP_20180508180108_CODEGEN_M6BCYP_XGB_B1 part 1. Create 


CREATE TABLE ##TMP_20180508180108_CODEGEN_M6BCYP_XGB_B1 (
	[KEY] BIGINT NULL, 
	[Score_0] FLOAT(53) NULL
)
...
-- Code For temporary table ##TMP_20180508180108_CODEGEN_M6BCYP_XGB_B1 part 2. Populate
...
FROM [DT_Output_15])
 INSERT INTO ##TMP_20180508180108_CODEGEN_M6BCYP_XGB_B1 ([KEY], [Score_0]) SELECT [XGB_B1].[KEY], [XGB_B1].[Score_0] 
...
-- Code For temporary table ##TMP_20180508180108_CODEGEN_7U8E6T_XGB_Union part 1. Create 


CREATE TABLE ##TMP_20180508180108_CODEGEN_7U8E6T_XGB_Union (
	[KEY] BIGINT NULL, 
	[Score_0] FLOAT(53) NULL
)
...
-- Code For temporary table ##TMP_20180508180108_CODEGEN_7U8E6T_XGB_Union part 2. Populate

INSERT INTO ##TMP_20180508180108_CODEGEN_7U8E6T_XGB_Union ([KEY], [Score_0]) SELECT [XGB_Union].[KEY], [XGB_Union].[Score_0] 
...
FROM ##TMP_20180508180108_CODEGEN_VZN8WC_XGB_B0 AS [XGB_B0] UNION ALL SELECT [XGB_B1].[KEY] AS [KEY], [XGB_B1].[Score_0] AS [Score_0] 
FROM ##TMP_20180508180108_CODEGEN_M6BCYP_XGB_B1 AS [XGB_B1]) AS [XGB_EnsembleUnion]) AS [XGB_Union]

-- Code For temporary table ##TMP_20180508180108_CODEGEN_E34A4A_XGB_sum part 1. Create 


CREATE TABLE ##TMP_20180508180108_CODEGEN_E34A4A_XGB_sum (
	[KEY] BIGINT NULL, 
	[Score_0] FLOAT(53) NULL
)
...
-- Code For temporary table ##TMP_20180508180108_CODEGEN_E34A4A_XGB_sum part 2. Populate

INSERT INTO ##TMP_20180508180108_CODEGEN_E34A4A_XGB_sum ([KEY], [Score_0]) SELECT [XGB_sum].[KEY], [XGB_sum].[Score_0] 
...
FROM ##TMP_20180508180108_CODEGEN_7U8E6T_XGB_Union AS [XGB_Union] GROUP BY [XGB_Union].[KEY]) AS [T]) AS [XGB_sum]
...
FROM ##TMP_20180508180108_CODEGEN_E34A4A_XGB_sum AS [XGB_sum]), 
