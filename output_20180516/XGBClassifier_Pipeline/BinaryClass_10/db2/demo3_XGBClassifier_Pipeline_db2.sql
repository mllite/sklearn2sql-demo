...
-- Code For temporary table tmp_20180508180112_codegen_8dilxa_ads_imp_1_out part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180508180112_codegen_8dilxa_ads_imp_1_out (
	"KEY" BIGINT, 
	impter_2 DOUBLE, 
	impter_3 DOUBLE, 
	impter_4 DOUBLE, 
...
-- Code For temporary table tmp_20180508180112_codegen_8dilxa_ads_imp_1_out part 2. Populate

INSERT INTO tmp_20180508180112_codegen_8dilxa_ads_imp_1_out SELECT "ADS_imp_1_OUT"."KEY", "ADS_imp_1_OUT".impter_2, "ADS_imp_1_OUT".impter_3, "ADS_imp_1_OUT".impter_4, "ADS_imp_1_OUT".impter_5, "ADS_imp_1_OUT".impter_6, "ADS_imp_1_OUT".impter_7, "ADS_imp_1_OUT".impter_8, "ADS_imp_1_OUT".impter_9, "ADS_imp_1_OUT".impter_10, "ADS_imp_1_OUT".impter_11 
...
-- Code For temporary table tmp_20180508180112_codegen_77chxt_ads_sca_2_out part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180508180112_codegen_77chxt_ads_sca_2_out (
	"KEY" BIGINT, 
	scaler_2 DOUBLE, 
	scaler_3 DOUBLE, 
	scaler_4 DOUBLE, 
...
-- Code For temporary table tmp_20180508180112_codegen_77chxt_ads_sca_2_out part 2. Populate

INSERT INTO tmp_20180508180112_codegen_77chxt_ads_sca_2_out SELECT "ADS_sca_2_OUT"."KEY", "ADS_sca_2_OUT".scaler_2, "ADS_sca_2_OUT".scaler_3, "ADS_sca_2_OUT".scaler_4, "ADS_sca_2_OUT".scaler_5, "ADS_sca_2_OUT".scaler_6, "ADS_sca_2_OUT".scaler_7, "ADS_sca_2_OUT".scaler_8, "ADS_sca_2_OUT".scaler_9, "ADS_sca_2_OUT".scaler_10, "ADS_sca_2_OUT".scaler_11 
...
FROM tmp_20180508180112_codegen_8dilxa_ads_imp_1_out AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT"

-- Code For temporary table tmp_20180508180112_codegen_taizui_xgb_b0 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180508180112_codegen_taizui_xgb_b0 (
	"KEY" BIGINT, 
	"Score_0" DOUBLE
)
...
-- Code For temporary table tmp_20180508180112_codegen_taizui_xgb_b0 part 2. Populate

INSERT INTO tmp_20180508180112_codegen_taizui_xgb_b0 WITH "DT_node_lookup" AS 
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", CASE WHEN ("ADS_sca_2_OUT".scaler_11 < -0.24119442701339722) THEN 1 ELSE 2 END AS node_id_2 
FROM tmp_20180508180112_codegen_77chxt_ads_sca_2_out AS "ADS_sca_2_OUT"), 
"DT_node_data" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE) AS "Score" 
FROM (SELECT 1 AS nid, -0.11818181723356247 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 2 AS nid, 0.11818181723356247 AS "Score" FROM SYSIBM.SYSDUMMY1) AS "Values"), 
"DT_Output" AS 
...
"DT_node_data_1" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE) AS "Score" 
FROM (SELECT 0 AS nid, 4.698811562064975e-09 AS "Score" FROM SYSIBM.SYSDUMMY1) AS "Values"), 
"DT_Output_1" AS 
...
"DT_node_data_6" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE) AS "Score" 
FROM (SELECT 0 AS nid, -6.692246756756504e-09 AS "Score" FROM SYSIBM.SYSDUMMY1) AS "Values"), 
"DT_Output_6" AS 
...
-- Code For temporary table tmp_20180508180112_codegen_7fu1w5_xgb_b1 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180508180112_codegen_7fu1w5_xgb_b1 (
	"KEY" BIGINT, 
	"Score_0" DOUBLE
)
...
-- Code For temporary table tmp_20180508180112_codegen_7fu1w5_xgb_b1 part 2. Populate

INSERT INTO tmp_20180508180112_codegen_7fu1w5_xgb_b1 WITH "DT_node_lookup_10" AS 
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", 0 AS node_id_2 
FROM tmp_20180508180112_codegen_77chxt_ads_sca_2_out AS "ADS_sca_2_OUT"), 
"DT_node_data_10" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE) AS "Score" 
...
-- Code For temporary table tmp_20180508180112_codegen_inobp9_xgb_union part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180508180112_codegen_inobp9_xgb_union (
	"KEY" BIGINT, 
	"Score_0" DOUBLE
)
...
-- Code For temporary table tmp_20180508180112_codegen_inobp9_xgb_union part 2. Populate

INSERT INTO tmp_20180508180112_codegen_inobp9_xgb_union SELECT "XGB_Union"."KEY", "XGB_Union"."Score_0" 
...
FROM tmp_20180508180112_codegen_taizui_xgb_b0 AS "XGB_B0" UNION ALL SELECT "XGB_B1"."KEY" AS "KEY", "XGB_B1"."Score_0" AS "Score_0" 
FROM tmp_20180508180112_codegen_7fu1w5_xgb_b1 AS "XGB_B1") AS "XGB_EnsembleUnion") AS "XGB_Union"

-- Code For temporary table tmp_20180508180112_codegen_huj0o8_xgb_sum part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180508180112_codegen_huj0o8_xgb_sum (
	"KEY" BIGINT, 
	"Score_0" DOUBLE
)
...
-- Code For temporary table tmp_20180508180112_codegen_huj0o8_xgb_sum part 2. Populate

INSERT INTO tmp_20180508180112_codegen_huj0o8_xgb_sum SELECT "XGB_sum"."KEY", "XGB_sum"."Score_0" 
...
FROM tmp_20180508180112_codegen_inobp9_xgb_union AS "XGB_Union" GROUP BY "XGB_Union"."KEY") AS "T") AS "XGB_sum"
...
FROM tmp_20180508180112_codegen_huj0o8_xgb_sum AS "XGB_sum"), 
