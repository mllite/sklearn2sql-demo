...
-- Code For temporary table ##TMP_20180516112040_CODEGEN_E7P3OU_ADS_imp_1_OUT part 1. Create 


CREATE TABLE ##TMP_20180516112040_CODEGEN_E7P3OU_ADS_imp_1_OUT (
	[KEY] BIGINT NULL, 
...
-- Code For temporary table ##TMP_20180516112040_CODEGEN_E7P3OU_ADS_imp_1_OUT part 2. Populate

INSERT INTO ##TMP_20180516112040_CODEGEN_E7P3OU_ADS_imp_1_OUT ([KEY], impter_2, impter_3, impter_4, impter_5, impter_6, impter_7, impter_8, impter_9, impter_10, impter_11, impter_12, impter_13, impter_14, impter_15, impter_16, impter_17, impter_18, impter_19, impter_20, impter_21, impter_22, impter_23, impter_24, impter_25, impter_26, impter_27, impter_28, impter_29, impter_30, impter_31) SELECT [ADS_imp_1_OUT].[KEY], [ADS_imp_1_OUT].impter_2, [ADS_imp_1_OUT].impter_3, [ADS_imp_1_OUT].impter_4, [ADS_imp_1_OUT].impter_5, [ADS_imp_1_OUT].impter_6, [ADS_imp_1_OUT].impter_7, [ADS_imp_1_OUT].impter_8, [ADS_imp_1_OUT].impter_9, [ADS_imp_1_OUT].impter_10, [ADS_imp_1_OUT].impter_11, [ADS_imp_1_OUT].impter_12, [ADS_imp_1_OUT].impter_13, [ADS_imp_1_OUT].impter_14, [ADS_imp_1_OUT].impter_15, [ADS_imp_1_OUT].impter_16, [ADS_imp_1_OUT].impter_17, [ADS_imp_1_OUT].impter_18, [ADS_imp_1_OUT].impter_19, [ADS_imp_1_OUT].impter_20, [ADS_imp_1_OUT].impter_21, [ADS_imp_1_OUT].impter_22, [ADS_imp_1_OUT].impter_23, [ADS_imp_1_OUT].impter_24, [ADS_imp_1_OUT].impter_25, [ADS_imp_1_OUT].impter_26, [ADS_imp_1_OUT].impter_27, [ADS_imp_1_OUT].impter_28, [ADS_imp_1_OUT].impter_29, [ADS_imp_1_OUT].impter_30, [ADS_imp_1_OUT].impter_31 
...
-- Code For temporary table ##TMP_20180516112040_CODEGEN_LTHWZ5_ADS_sca_2_OUT part 1. Create 


CREATE TABLE ##TMP_20180516112040_CODEGEN_LTHWZ5_ADS_sca_2_OUT (
	[KEY] BIGINT NULL, 
	scaler_2 FLOAT NULL, 
	scaler_3 FLOAT NULL, 
	scaler_4 FLOAT NULL, 
...
FROM ##TMP_20180516112040_CODEGEN_E7P3OU_ADS_imp_1_OUT AS [ADS_imp_1_OUT]) AS [ADS_sca_2_OUT]

-- Code For temporary table ##TMP_20180516112040_CODEGEN_7CYCKR_XGB_B0 part 1. Create 


CREATE TABLE ##TMP_20180516112040_CODEGEN_7CYCKR_XGB_B0 (
	[KEY] BIGINT NULL, 
...
-- Code For temporary table ##TMP_20180516112040_CODEGEN_7CYCKR_XGB_B0 part 2. Populate
...
FROM ##TMP_20180516112040_CODEGEN_LTHWZ5_ADS_sca_2_OUT AS [ADS_sca_2_OUT]), 
[DT_node_data] AS 
...
FROM [DT_Output_9])
 INSERT INTO ##TMP_20180516112040_CODEGEN_7CYCKR_XGB_B0 ([KEY], [Score_0]) SELECT [XGB_B0].[KEY], [XGB_B0].[Score_0] 
...
-- Code For temporary table ##TMP_20180516112040_CODEGEN_IJ424H_XGB_B1 part 1. Create 


CREATE TABLE ##TMP_20180516112040_CODEGEN_IJ424H_XGB_B1 (
	[KEY] BIGINT NULL, 
	[Score_0] FLOAT(53) NULL
)
...
-- Code For temporary table ##TMP_20180516112040_CODEGEN_IJ424H_XGB_B1 part 2. Populate
...
FROM [DT_Output_15])
 INSERT INTO ##TMP_20180516112040_CODEGEN_IJ424H_XGB_B1 ([KEY], [Score_0]) SELECT [XGB_B1].[KEY], [XGB_B1].[Score_0] 
...
-- Code For temporary table ##TMP_20180516112040_CODEGEN_G1I3D7_XGB_sum part 1. Create 


CREATE TABLE ##TMP_20180516112040_CODEGEN_G1I3D7_XGB_sum (
	[KEY] BIGINT NULL, 
	[Score_0] FLOAT(53) NULL
)
...
-- Code For temporary table ##TMP_20180516112040_CODEGEN_G1I3D7_XGB_sum part 2. Populate
...
FROM ##TMP_20180516112040_CODEGEN_7CYCKR_XGB_B0 AS [XGB_B0] UNION ALL SELECT [XGB_B1].[KEY] AS [KEY], [XGB_B1].[Score_0] AS [Score_0] 
FROM ##TMP_20180516112040_CODEGEN_IJ424H_XGB_B1 AS [XGB_B1]) AS [XGB_EnsembleUnion])
 INSERT INTO ##TMP_20180516112040_CODEGEN_G1I3D7_XGB_sum ([KEY], [Score_0]) SELECT [XGB_sum].[KEY], [XGB_sum].[Score_0] 
...
FROM ##TMP_20180516112040_CODEGEN_G1I3D7_XGB_sum AS [XGB_sum]), 
