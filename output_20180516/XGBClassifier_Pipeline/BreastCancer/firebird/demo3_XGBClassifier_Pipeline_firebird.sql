...
-- Code For temporary table TMP_20180516_CODEGEN_K0SX8N_ADS part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180516_CODEGEN_K0SX8N_ADS" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20180516_CODEGEN_K0SX8N_ADS part 3. Create Index 

CREATE INDEX "ix_TMP_20180516_CODEGEN_19e6" ON "TMP_20180516_CODEGEN_K0SX8N_ADS" ("KEY")

-- Code For temporary table TMP_20180516_CODEGEN_Y1RL6N_ADS part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180516_CODEGEN_Y1RL6N_ADS" (
	"KEY" BIGINT NOT NULL, 
...
FROM "TMP_20180516_CODEGEN_K0SX8N_ADS" AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT") AS "U"

-- Code For temporary table TMP_20180516_CODEGEN_Y1RL6N_ADS part 3. Create Index 

CREATE INDEX "ix_TMP_20180516_CODEGEN_4d32" ON "TMP_20180516_CODEGEN_Y1RL6N_ADS" ("KEY")

-- Code For temporary table TMP_20180516_CODEGEN_KR4VMT_XGB part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180516_CODEGEN_KR4VMT_XGB" (
	"KEY" BIGINT, 
...
-- Code For temporary table TMP_20180516_CODEGEN_KR4VMT_XGB part 2. Populate

INSERT INTO "TMP_20180516_CODEGEN_KR4VMT_XGB" ("KEY", "Score_0") SELECT "U"."KEY", "U"."Score_0" 
...
FROM "TMP_20180516_CODEGEN_Y1RL6N_ADS" AS "ADS_sca_2_OUT"), 
"DT_node_data" AS 
...
-- Code For temporary table TMP_20180516_CODEGEN_XW6O39_XGB part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180516_CODEGEN_XW6O39_XGB" (
	"KEY" BIGINT, 
	"Score_0" DOUBLE PRECISION
)
...
-- Code For temporary table TMP_20180516_CODEGEN_XW6O39_XGB part 2. Populate

INSERT INTO "TMP_20180516_CODEGEN_XW6O39_XGB" ("KEY", "Score_0") SELECT "U"."KEY", "U"."Score_0" 
...
-- Code For temporary table TMP_20180516_CODEGEN_AC0FUA_XGB part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180516_CODEGEN_AC0FUA_XGB" (
	"KEY" BIGINT NOT NULL, 
	"Score_0" DOUBLE PRECISION, 
	PRIMARY KEY ("KEY")
)
...
-- Code For temporary table TMP_20180516_CODEGEN_AC0FUA_XGB part 2. Populate

INSERT INTO "TMP_20180516_CODEGEN_AC0FUA_XGB" ("KEY", "Score_0") SELECT "U"."KEY", "U"."Score_0" 
...
FROM "TMP_20180516_CODEGEN_KR4VMT_XGB" AS "XGB_B0" UNION ALL SELECT "XGB_B1"."KEY" AS "KEY", "XGB_B1"."Score_0" AS "Score_0" 
FROM "TMP_20180516_CODEGEN_XW6O39_XGB" AS "XGB_B1") AS "XGB_EnsembleUnion")
...
-- Code For temporary table TMP_20180516_CODEGEN_AC0FUA_XGB part 3. Create Index 

CREATE INDEX "ix_TMP_20180516_CODEGEN_b722" ON "TMP_20180516_CODEGEN_AC0FUA_XGB" ("KEY")
...
FROM "TMP_20180516_CODEGEN_AC0FUA_XGB" AS "XGB_sum"), 
