...
-- Code For temporary table tmp_20180516112046_codegen_rhitqa_ads_imp_1_out part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180516112046_codegen_rhitqa_ads_imp_1_out (
	"KEY" BIGINT, 
	impter_2 DOUBLE, 
	impter_3 DOUBLE, 
	impter_4 DOUBLE, 
...
-- Code For temporary table tmp_20180516112046_codegen_mhwrnf_ads_sca_2_out part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180516112046_codegen_mhwrnf_ads_sca_2_out (
	"KEY" BIGINT, 
	scaler_2 DOUBLE, 
	scaler_3 DOUBLE, 
	scaler_4 DOUBLE, 
...
FROM tmp_20180516112046_codegen_rhitqa_ads_imp_1_out AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT"

-- Code For temporary table tmp_20180516112046_codegen_ljobu2_xgb_b0 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180516112046_codegen_ljobu2_xgb_b0 (
	"KEY" BIGINT, 
	"Score_0" DOUBLE
)
...
-- Code For temporary table tmp_20180516112046_codegen_ljobu2_xgb_b0 part 2. Populate

INSERT INTO tmp_20180516112046_codegen_ljobu2_xgb_b0 WITH "DT_node_lookup" AS 
...
FROM tmp_20180516112046_codegen_mhwrnf_ads_sca_2_out AS "ADS_sca_2_OUT"), 
"DT_node_data" AS 
...
-- Code For temporary table tmp_20180516112046_codegen_ocpl3f_xgb_b1 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180516112046_codegen_ocpl3f_xgb_b1 (
	"KEY" BIGINT, 
	"Score_0" DOUBLE
)
...
-- Code For temporary table tmp_20180516112046_codegen_ocpl3f_xgb_b1 part 2. Populate

INSERT INTO tmp_20180516112046_codegen_ocpl3f_xgb_b1 WITH "DT_node_lookup_10" AS 
...
-- Code For temporary table tmp_20180516112046_codegen_lhkf46_xgb_sum part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180516112046_codegen_lhkf46_xgb_sum (
	"KEY" BIGINT, 
	"Score_0" DOUBLE
)
...
-- Code For temporary table tmp_20180516112046_codegen_lhkf46_xgb_sum part 2. Populate

INSERT INTO tmp_20180516112046_codegen_lhkf46_xgb_sum WITH "XGB_Union" AS 
...
FROM tmp_20180516112046_codegen_ljobu2_xgb_b0 AS "XGB_B0" UNION ALL SELECT "XGB_B1"."KEY" AS "KEY", "XGB_B1"."Score_0" AS "Score_0" 
FROM tmp_20180516112046_codegen_ocpl3f_xgb_b1 AS "XGB_B1") AS "XGB_EnsembleUnion")
...
FROM tmp_20180516112046_codegen_lhkf46_xgb_sum AS "XGB_sum"), 
