...
FROM `tmp_20180516120530_codegen_jrre9w_ads_imp_1_out` AS `ADS_imp_1_OUT`) AS `ADS_sca_2_OUT`

-- Code For temporary table tmp_20180516120530_codegen_1s205k_ads_sca_2_out part 2. Populate

SELECT * FROM `tmp_20180516120530_codegen_1s205k_ads_sca_2_out`

-- Code For temporary table tmp_20180516120531_codegen_uw6srd_xgb_b0 part 1. Create 

CREATE TEMPORARY TABLE `tmp_20180516120531_codegen_uw6srd_xgb_b0` STORED AS ORC AS WITH `DT_node_lookup` AS 
...
FROM `tmp_20180516120530_codegen_1s205k_ads_sca_2_out` AS `ADS_sca_2_OUT`), 
`DT_node_data` AS 
...
-- Code For temporary table tmp_20180516120531_codegen_uw6srd_xgb_b0 part 2. Populate

SELECT * FROM `tmp_20180516120531_codegen_uw6srd_xgb_b0`

-- Code For temporary table tmp_20180516120531_codegen_2lbflq_xgb_b1 part 1. Create 

CREATE TEMPORARY TABLE `tmp_20180516120531_codegen_2lbflq_xgb_b1` STORED AS ORC AS WITH `DT_node_lookup_10` AS 
...
-- Code For temporary table tmp_20180516120531_codegen_2lbflq_xgb_b1 part 2. Populate

SELECT * FROM `tmp_20180516120531_codegen_2lbflq_xgb_b1`

-- Code For temporary table tmp_20180516120531_codegen_hv1yxj_xgb_b2 part 1. Create 

CREATE TEMPORARY TABLE `tmp_20180516120531_codegen_hv1yxj_xgb_b2` STORED AS ORC AS WITH `DT_node_lookup_20` AS 
...
-- Code For temporary table tmp_20180516120531_codegen_hv1yxj_xgb_b2 part 2. Populate

SELECT * FROM `tmp_20180516120531_codegen_hv1yxj_xgb_b2`

-- Code For temporary table tmp_20180516120531_codegen_uywonm_xgb_b3 part 1. Create 

CREATE TEMPORARY TABLE `tmp_20180516120531_codegen_uywonm_xgb_b3` STORED AS ORC AS WITH `DT_node_lookup_30` AS 
...
-- Code For temporary table tmp_20180516120531_codegen_uywonm_xgb_b3 part 2. Populate

SELECT * FROM `tmp_20180516120531_codegen_uywonm_xgb_b3`

-- Code For temporary table tmp_20180516120531_codegen_ta0nb0_xgb_b4 part 1. Create 

CREATE TEMPORARY TABLE `tmp_20180516120531_codegen_ta0nb0_xgb_b4` STORED AS ORC AS WITH `DT_node_lookup_40` AS 
...
-- Code For temporary table tmp_20180516120531_codegen_ta0nb0_xgb_b4 part 2. Populate

SELECT * FROM `tmp_20180516120531_codegen_ta0nb0_xgb_b4`

-- Code For temporary table tmp_20180516120531_codegen_mztacw_xgb_b5 part 1. Create 

CREATE TEMPORARY TABLE `tmp_20180516120531_codegen_mztacw_xgb_b5` STORED AS ORC AS WITH `DT_node_lookup_50` AS 
...
-- Code For temporary table tmp_20180516120531_codegen_mztacw_xgb_b5 part 2. Populate

SELECT * FROM `tmp_20180516120531_codegen_mztacw_xgb_b5`

-- Code For temporary table tmp_20180516120531_codegen_qcchl2_xgb_b6 part 1. Create 

CREATE TEMPORARY TABLE `tmp_20180516120531_codegen_qcchl2_xgb_b6` STORED AS ORC AS WITH `DT_node_lookup_60` AS 
...
-- Code For temporary table tmp_20180516120531_codegen_qcchl2_xgb_b6 part 2. Populate

SELECT * FROM `tmp_20180516120531_codegen_qcchl2_xgb_b6`

-- Code For temporary table tmp_20180516120531_codegen_8s3fj9_xgb_b7 part 1. Create 

CREATE TEMPORARY TABLE `tmp_20180516120531_codegen_8s3fj9_xgb_b7` STORED AS ORC AS WITH `DT_node_lookup_70` AS 
(SELECT `ADS_sca_2_OUT`.`KEY` AS `KEY`, CASE WHEN (`ADS_sca_2_OUT`.`scaler_38` < -1.6508052349090576) THEN CASE WHEN (`ADS_sca_2_OUT`.`scaler_35` < -0.5203844308853149) THEN 3 ELSE CASE WHEN (`ADS_sca_2_OUT`.`scaler_23` < 0.10995353013277054) THEN 7 ELSE 8 END END ELSE CASE WHEN (`ADS_sca_2_OUT`.`scaler_38` < -1.1439052820205688) THEN 5 ELSE 6 END END AS `node_id_2` 
FROM `tmp_20180516120530_codegen_1s205k_ads_sca_2_out` AS `ADS_sca_2_OUT`), 
`DT_node_data_70` AS 
(SELECT `Values`.`nid` AS `nid`, CAST(`Values`.`Score` AS DOUBLE) AS `Score` 
...
-- Code For temporary table tmp_20180516120531_codegen_8s3fj9_xgb_b7 part 2. Populate

SELECT * FROM `tmp_20180516120531_codegen_8s3fj9_xgb_b7`

-- Code For temporary table tmp_20180516120531_codegen_tiqrsj_xgb_b8 part 1. Create 

CREATE TEMPORARY TABLE `tmp_20180516120531_codegen_tiqrsj_xgb_b8` STORED AS ORC AS WITH `DT_node_lookup_80` AS 
(SELECT `ADS_sca_2_OUT`.`KEY` AS `KEY`, CASE WHEN (`ADS_sca_2_OUT`.`scaler_38` < -1.6508052349090576) THEN CASE WHEN (`ADS_sca_2_OUT`.`scaler_30` < -1.2292683124542236) THEN CASE WHEN (`ADS_sca_2_OUT`.`scaler_15` < -0.26780885457992554) THEN 7 ELSE 8 END ELSE 4 END ELSE CASE WHEN (`ADS_sca_2_OUT`.`scaler_38` < -1.1439052820205688) THEN 5 ELSE 6 END END AS `node_id_2` 
FROM `tmp_20180516120530_codegen_1s205k_ads_sca_2_out` AS `ADS_sca_2_OUT`), 
`DT_node_data_80` AS 
(SELECT `Values`.`nid` AS `nid`, CAST(`Values`.`Score` AS DOUBLE) AS `Score` 
...
-- Code For temporary table tmp_20180516120531_codegen_tiqrsj_xgb_b8 part 2. Populate

SELECT * FROM `tmp_20180516120531_codegen_tiqrsj_xgb_b8`

-- Code For temporary table tmp_20180516120531_codegen_kege8w_xgb_b9 part 1. Create 

CREATE TEMPORARY TABLE `tmp_20180516120531_codegen_kege8w_xgb_b9` STORED AS ORC AS WITH `DT_node_lookup_90` AS 
...
-- Code For temporary table tmp_20180516120531_codegen_kege8w_xgb_b9 part 2. Populate

SELECT * FROM `tmp_20180516120531_codegen_kege8w_xgb_b9`

-- Code For temporary table tmp_20180516120531_codegen_l548ka_xgb_b10 part 1. Create 

CREATE TEMPORARY TABLE `tmp_20180516120531_codegen_l548ka_xgb_b10` STORED AS ORC AS WITH `DT_node_lookup_100` AS 
(SELECT `ADS_sca_2_OUT`.`KEY` AS `KEY`, CASE WHEN (`ADS_sca_2_OUT`.`scaler_38` < -1.6508052349090576) THEN CASE WHEN (`ADS_sca_2_OUT`.`scaler_30` < -1.2292683124542236) THEN CASE WHEN (`ADS_sca_2_OUT`.`scaler_45` < -0.42503583431243896) THEN 7 ELSE 8 END ELSE 4 END ELSE CASE WHEN (`ADS_sca_2_OUT`.`scaler_30` < -1.555469036102295) THEN 5 ELSE 6 END END AS `node_id_2` 
FROM `tmp_20180516120530_codegen_1s205k_ads_sca_2_out` AS `ADS_sca_2_OUT`), 
`DT_node_data_100` AS 
(SELECT `Values`.`nid` AS `nid`, CAST(`Values`.`Score` AS DOUBLE) AS `Score` 
...
-- Code For temporary table tmp_20180516120531_codegen_l548ka_xgb_b10 part 2. Populate

SELECT * FROM `tmp_20180516120531_codegen_l548ka_xgb_b10`

-- Code For temporary table tmp_20180516120531_codegen_k8p9aa_xgb_b11 part 1. Create 

CREATE TEMPORARY TABLE `tmp_20180516120531_codegen_k8p9aa_xgb_b11` STORED AS ORC AS WITH `DT_node_lookup_110` AS 
(SELECT `ADS_sca_2_OUT`.`KEY` AS `KEY`, CASE WHEN (`ADS_sca_2_OUT`.`scaler_38` < -1.6508052349090576) THEN CASE WHEN (`ADS_sca_2_OUT`.`scaler_30` < -1.2292683124542236) THEN CASE WHEN (`ADS_sca_2_OUT`.`scaler_15` < -0.26780885457992554) THEN 7 ELSE 8 END ELSE 4 END ELSE CASE WHEN (`ADS_sca_2_OUT`.`scaler_38` < -1.1439052820205688) THEN 5 ELSE 6 END END AS `node_id_2` 
FROM `tmp_20180516120530_codegen_1s205k_ads_sca_2_out` AS `ADS_sca_2_OUT`), 
`DT_node_data_110` AS 
(SELECT `Values`.`nid` AS `nid`, CAST(`Values`.`Score` AS DOUBLE) AS `Score` 
...
-- Code For temporary table tmp_20180516120531_codegen_k8p9aa_xgb_b11 part 2. Populate

SELECT * FROM `tmp_20180516120531_codegen_k8p9aa_xgb_b11`

-- Code For temporary table tmp_20180516120531_codegen_nrzwp3_xgb_b12 part 1. Create 

CREATE TEMPORARY TABLE `tmp_20180516120531_codegen_nrzwp3_xgb_b12` STORED AS ORC AS WITH `DT_node_lookup_120` AS 
...
-- Code For temporary table tmp_20180516120531_codegen_nrzwp3_xgb_b12 part 2. Populate

SELECT * FROM `tmp_20180516120531_codegen_nrzwp3_xgb_b12`

-- Code For temporary table tmp_20180516120531_codegen_yorgmv_xgb_b13 part 1. Create 

CREATE TEMPORARY TABLE `tmp_20180516120531_codegen_yorgmv_xgb_b13` STORED AS ORC AS WITH `DT_node_lookup_130` AS 
...
-- Code For temporary table tmp_20180516120531_codegen_yorgmv_xgb_b13 part 2. Populate

SELECT * FROM `tmp_20180516120531_codegen_yorgmv_xgb_b13`

-- Code For temporary table tmp_20180516120531_codegen_5bnenl_xgb_b14 part 1. Create 

CREATE TEMPORARY TABLE `tmp_20180516120531_codegen_5bnenl_xgb_b14` STORED AS ORC AS WITH `DT_node_lookup_140` AS 
...
-- Code For temporary table tmp_20180516120531_codegen_5bnenl_xgb_b14 part 2. Populate

SELECT * FROM `tmp_20180516120531_codegen_5bnenl_xgb_b14`

-- Code For temporary table tmp_20180516120531_codegen_gre6la_xgb_b15 part 1. Create 

CREATE TEMPORARY TABLE `tmp_20180516120531_codegen_gre6la_xgb_b15` STORED AS ORC AS WITH `DT_node_lookup_150` AS 
...
-- Code For temporary table tmp_20180516120531_codegen_gre6la_xgb_b15 part 2. Populate

SELECT * FROM `tmp_20180516120531_codegen_gre6la_xgb_b15`

-- Code For temporary table tmp_20180516120531_codegen_orz89f_xgb_sum part 1. Create 

CREATE TEMPORARY TABLE `tmp_20180516120531_codegen_orz89f_xgb_sum` STORED AS ORC AS WITH `XGB_Union` AS 
...
-- Code For temporary table tmp_20180516120531_codegen_orz89f_xgb_sum part 2. Populate

SELECT * FROM `tmp_20180516120531_codegen_orz89f_xgb_sum`
...
FROM `tmp_20180516120531_codegen_orz89f_xgb_sum` AS `XGB_sum`), 
