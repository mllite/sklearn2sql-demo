...
FROM `tmp_20180509003926_codegen_yblocc_ads_imp_1_out` AS `ADS_imp_1_OUT`) AS `ADS_sca_2_OUT`

-- Code For temporary table tmp_20180509003926_codegen_0qe9fo_ads_sca_2_out part 2. Populate

SELECT * FROM `tmp_20180509003926_codegen_0qe9fo_ads_sca_2_out`

-- Code For temporary table tmp_20180509003927_codegen_6gddfg_xgb_b0 part 1. Create 

CREATE TEMPORARY TABLE `tmp_20180509003927_codegen_6gddfg_xgb_b0` STORED AS ORC AS WITH `DT_node_lookup` AS 
...
FROM `tmp_20180509003926_codegen_0qe9fo_ads_sca_2_out` AS `ADS_sca_2_OUT`), 
`DT_node_data` AS 
...
-- Code For temporary table tmp_20180509003927_codegen_6gddfg_xgb_b0 part 2. Populate

SELECT * FROM `tmp_20180509003927_codegen_6gddfg_xgb_b0`

-- Code For temporary table tmp_20180509003927_codegen_6gin19_xgb_b1 part 1. Create 

CREATE TEMPORARY TABLE `tmp_20180509003927_codegen_6gin19_xgb_b1` STORED AS ORC AS WITH `DT_node_lookup_10` AS 
...
-- Code For temporary table tmp_20180509003927_codegen_6gin19_xgb_b1 part 2. Populate

SELECT * FROM `tmp_20180509003927_codegen_6gin19_xgb_b1`

-- Code For temporary table tmp_20180509003927_codegen_txrmbx_xgb_b2 part 1. Create 

CREATE TEMPORARY TABLE `tmp_20180509003927_codegen_txrmbx_xgb_b2` STORED AS ORC AS WITH `DT_node_lookup_20` AS 
...
-- Code For temporary table tmp_20180509003927_codegen_txrmbx_xgb_b2 part 2. Populate

SELECT * FROM `tmp_20180509003927_codegen_txrmbx_xgb_b2`

-- Code For temporary table tmp_20180509003927_codegen_5fppfv_xgb_b3 part 1. Create 

CREATE TEMPORARY TABLE `tmp_20180509003927_codegen_5fppfv_xgb_b3` STORED AS ORC AS WITH `DT_node_lookup_30` AS 
...
-- Code For temporary table tmp_20180509003927_codegen_5fppfv_xgb_b3 part 2. Populate

SELECT * FROM `tmp_20180509003927_codegen_5fppfv_xgb_b3`

-- Code For temporary table tmp_20180509003927_codegen_02iw3f_xgb_b4 part 1. Create 

CREATE TEMPORARY TABLE `tmp_20180509003927_codegen_02iw3f_xgb_b4` STORED AS ORC AS WITH `DT_node_lookup_40` AS 
...
-- Code For temporary table tmp_20180509003927_codegen_02iw3f_xgb_b4 part 2. Populate

SELECT * FROM `tmp_20180509003927_codegen_02iw3f_xgb_b4`

-- Code For temporary table tmp_20180509003927_codegen_lyoykv_xgb_b5 part 1. Create 

CREATE TEMPORARY TABLE `tmp_20180509003927_codegen_lyoykv_xgb_b5` STORED AS ORC AS WITH `DT_node_lookup_50` AS 
...
-- Code For temporary table tmp_20180509003927_codegen_lyoykv_xgb_b5 part 2. Populate

SELECT * FROM `tmp_20180509003927_codegen_lyoykv_xgb_b5`

-- Code For temporary table tmp_20180509003927_codegen_6uubxs_xgb_b6 part 1. Create 

CREATE TEMPORARY TABLE `tmp_20180509003927_codegen_6uubxs_xgb_b6` STORED AS ORC AS WITH `DT_node_lookup_60` AS 
...
-- Code For temporary table tmp_20180509003927_codegen_6uubxs_xgb_b6 part 2. Populate

SELECT * FROM `tmp_20180509003927_codegen_6uubxs_xgb_b6`

-- Code For temporary table tmp_20180509003927_codegen_on5m3b_xgb_b7 part 1. Create 

CREATE TEMPORARY TABLE `tmp_20180509003927_codegen_on5m3b_xgb_b7` STORED AS ORC AS WITH `DT_node_lookup_70` AS 
(SELECT `ADS_sca_2_OUT`.`KEY` AS `KEY`, CASE WHEN (`ADS_sca_2_OUT`.`scaler_38` < -1.6508052349090576) THEN CASE WHEN (`ADS_sca_2_OUT`.`scaler_35` < -0.5203844308853149) THEN 3 ELSE CASE WHEN (`ADS_sca_2_OUT`.`scaler_23` < 0.10995353013277054) THEN 7 ELSE 8 END END ELSE CASE WHEN (`ADS_sca_2_OUT`.`scaler_38` < -1.1439052820205688) THEN 5 ELSE 6 END END AS `node_id_2` 
FROM `tmp_20180509003926_codegen_0qe9fo_ads_sca_2_out` AS `ADS_sca_2_OUT`), 
`DT_node_data_70` AS 
(SELECT `Values`.`nid` AS `nid`, CAST(`Values`.`Score` AS DOUBLE) AS `Score` 
...
-- Code For temporary table tmp_20180509003927_codegen_on5m3b_xgb_b7 part 2. Populate

SELECT * FROM `tmp_20180509003927_codegen_on5m3b_xgb_b7`

-- Code For temporary table tmp_20180509003927_codegen_lvocrn_xgb_b8 part 1. Create 

CREATE TEMPORARY TABLE `tmp_20180509003927_codegen_lvocrn_xgb_b8` STORED AS ORC AS WITH `DT_node_lookup_80` AS 
(SELECT `ADS_sca_2_OUT`.`KEY` AS `KEY`, CASE WHEN (`ADS_sca_2_OUT`.`scaler_38` < -1.6508052349090576) THEN CASE WHEN (`ADS_sca_2_OUT`.`scaler_30` < -1.2292683124542236) THEN CASE WHEN (`ADS_sca_2_OUT`.`scaler_15` < -0.26780885457992554) THEN 7 ELSE 8 END ELSE 4 END ELSE CASE WHEN (`ADS_sca_2_OUT`.`scaler_38` < -1.1439052820205688) THEN 5 ELSE 6 END END AS `node_id_2` 
FROM `tmp_20180509003926_codegen_0qe9fo_ads_sca_2_out` AS `ADS_sca_2_OUT`), 
`DT_node_data_80` AS 
(SELECT `Values`.`nid` AS `nid`, CAST(`Values`.`Score` AS DOUBLE) AS `Score` 
...
-- Code For temporary table tmp_20180509003927_codegen_lvocrn_xgb_b8 part 2. Populate

SELECT * FROM `tmp_20180509003927_codegen_lvocrn_xgb_b8`

-- Code For temporary table tmp_20180509003927_codegen_qf7x86_xgb_b9 part 1. Create 

CREATE TEMPORARY TABLE `tmp_20180509003927_codegen_qf7x86_xgb_b9` STORED AS ORC AS WITH `DT_node_lookup_90` AS 
...
-- Code For temporary table tmp_20180509003927_codegen_qf7x86_xgb_b9 part 2. Populate

SELECT * FROM `tmp_20180509003927_codegen_qf7x86_xgb_b9`

-- Code For temporary table tmp_20180509003927_codegen_es42ae_xgb_b10 part 1. Create 

CREATE TEMPORARY TABLE `tmp_20180509003927_codegen_es42ae_xgb_b10` STORED AS ORC AS WITH `DT_node_lookup_100` AS 
(SELECT `ADS_sca_2_OUT`.`KEY` AS `KEY`, CASE WHEN (`ADS_sca_2_OUT`.`scaler_38` < -1.6508052349090576) THEN CASE WHEN (`ADS_sca_2_OUT`.`scaler_30` < -1.2292683124542236) THEN CASE WHEN (`ADS_sca_2_OUT`.`scaler_45` < -0.42503583431243896) THEN 7 ELSE 8 END ELSE 4 END ELSE CASE WHEN (`ADS_sca_2_OUT`.`scaler_30` < -1.555469036102295) THEN 5 ELSE 6 END END AS `node_id_2` 
FROM `tmp_20180509003926_codegen_0qe9fo_ads_sca_2_out` AS `ADS_sca_2_OUT`), 
`DT_node_data_100` AS 
(SELECT `Values`.`nid` AS `nid`, CAST(`Values`.`Score` AS DOUBLE) AS `Score` 
...
-- Code For temporary table tmp_20180509003927_codegen_es42ae_xgb_b10 part 2. Populate

SELECT * FROM `tmp_20180509003927_codegen_es42ae_xgb_b10`

-- Code For temporary table tmp_20180509003927_codegen_e8x0bs_xgb_b11 part 1. Create 

CREATE TEMPORARY TABLE `tmp_20180509003927_codegen_e8x0bs_xgb_b11` STORED AS ORC AS WITH `DT_node_lookup_110` AS 
(SELECT `ADS_sca_2_OUT`.`KEY` AS `KEY`, CASE WHEN (`ADS_sca_2_OUT`.`scaler_38` < -1.6508052349090576) THEN CASE WHEN (`ADS_sca_2_OUT`.`scaler_30` < -1.2292683124542236) THEN CASE WHEN (`ADS_sca_2_OUT`.`scaler_15` < -0.26780885457992554) THEN 7 ELSE 8 END ELSE 4 END ELSE CASE WHEN (`ADS_sca_2_OUT`.`scaler_38` < -1.1439052820205688) THEN 5 ELSE 6 END END AS `node_id_2` 
FROM `tmp_20180509003926_codegen_0qe9fo_ads_sca_2_out` AS `ADS_sca_2_OUT`), 
`DT_node_data_110` AS 
(SELECT `Values`.`nid` AS `nid`, CAST(`Values`.`Score` AS DOUBLE) AS `Score` 
...
-- Code For temporary table tmp_20180509003927_codegen_e8x0bs_xgb_b11 part 2. Populate

SELECT * FROM `tmp_20180509003927_codegen_e8x0bs_xgb_b11`

-- Code For temporary table tmp_20180509003927_codegen_ahgf13_xgb_b12 part 1. Create 

CREATE TEMPORARY TABLE `tmp_20180509003927_codegen_ahgf13_xgb_b12` STORED AS ORC AS WITH `DT_node_lookup_120` AS 
...
-- Code For temporary table tmp_20180509003927_codegen_ahgf13_xgb_b12 part 2. Populate

SELECT * FROM `tmp_20180509003927_codegen_ahgf13_xgb_b12`

-- Code For temporary table tmp_20180509003927_codegen_nx11e0_xgb_b13 part 1. Create 

CREATE TEMPORARY TABLE `tmp_20180509003927_codegen_nx11e0_xgb_b13` STORED AS ORC AS WITH `DT_node_lookup_130` AS 
...
-- Code For temporary table tmp_20180509003927_codegen_nx11e0_xgb_b13 part 2. Populate

SELECT * FROM `tmp_20180509003927_codegen_nx11e0_xgb_b13`

-- Code For temporary table tmp_20180509003927_codegen_sd8miq_xgb_b14 part 1. Create 

CREATE TEMPORARY TABLE `tmp_20180509003927_codegen_sd8miq_xgb_b14` STORED AS ORC AS WITH `DT_node_lookup_140` AS 
...
-- Code For temporary table tmp_20180509003927_codegen_sd8miq_xgb_b14 part 2. Populate

SELECT * FROM `tmp_20180509003927_codegen_sd8miq_xgb_b14`

-- Code For temporary table tmp_20180509003927_codegen_60mwdx_xgb_b15 part 1. Create 

CREATE TEMPORARY TABLE `tmp_20180509003927_codegen_60mwdx_xgb_b15` STORED AS ORC AS WITH `DT_node_lookup_150` AS 
...
-- Code For temporary table tmp_20180509003927_codegen_60mwdx_xgb_b15 part 2. Populate

SELECT * FROM `tmp_20180509003927_codegen_60mwdx_xgb_b15`

-- Code For temporary table tmp_20180509003927_codegen_o7jrjq_xgb_union part 1. Create 

CREATE TEMPORARY TABLE `tmp_20180509003927_codegen_o7jrjq_xgb_union` STORED AS ORC AS SELECT `XGB_Union`.`KEY`, `XGB_Union`.`Score_0`, `XGB_Union`.`Score_1`, `XGB_Union`.`Score_2`, `XGB_Union`.`Score_3`, `XGB_Union`.`Score_4`, `XGB_Union`.`Score_5`, `XGB_Union`.`Score_6`, `XGB_Union`.`Score_7`, `XGB_Union`.`Score_8`, `XGB_Union`.`Score_9` 
...
FROM `tmp_20180509003927_codegen_o7jrjq_xgb_union` AS `XGB_Union` GROUP BY `XGB_Union`.`KEY`) AS `T`) AS `XGB_sum`

-- Code For temporary table tmp_20180509003927_codegen_9zghxn_xgb_sum part 2. Populate

SELECT * FROM `tmp_20180509003927_codegen_9zghxn_xgb_sum`
...
FROM `tmp_20180509003927_codegen_9zghxn_xgb_sum` AS `XGB_sum`), 
