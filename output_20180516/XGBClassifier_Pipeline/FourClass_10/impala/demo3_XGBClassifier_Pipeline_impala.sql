...
-- Code For temporary table tmp_20180508192829_codegen_hkcg09_ads_imp_1_out part 1. Create 


CREATE TABLE tmp_20180508192829_codegen_hkcg09_ads_imp_1_out (
	`KEY` BIGINT, 
	impter_2 DOUBLE, 
	impter_3 DOUBLE, 
	impter_4 DOUBLE, 
...
-- Code For temporary table tmp_20180508192829_codegen_hkcg09_ads_imp_1_out part 2. Populate

INSERT INTO tmp_20180508192829_codegen_hkcg09_ads_imp_1_out (`KEY`, impter_2, impter_3, impter_4, impter_5, impter_6, impter_7, impter_8, impter_9, impter_10, impter_11) SELECT `ADS_imp_1_OUT`.`KEY`, `ADS_imp_1_OUT`.impter_2, `ADS_imp_1_OUT`.impter_3, `ADS_imp_1_OUT`.impter_4, `ADS_imp_1_OUT`.impter_5, `ADS_imp_1_OUT`.impter_6, `ADS_imp_1_OUT`.impter_7, `ADS_imp_1_OUT`.impter_8, `ADS_imp_1_OUT`.impter_9, `ADS_imp_1_OUT`.impter_10, `ADS_imp_1_OUT`.impter_11 
...
-- Code For temporary table tmp_20180508192829_codegen_lbqy4u_ads_sca_2_out part 1. Create 


CREATE TABLE tmp_20180508192829_codegen_lbqy4u_ads_sca_2_out (
	`KEY` BIGINT, 
	scaler_2 DOUBLE, 
	scaler_3 DOUBLE, 
	scaler_4 DOUBLE, 
...
-- Code For temporary table tmp_20180508192829_codegen_lbqy4u_ads_sca_2_out part 2. Populate

INSERT INTO tmp_20180508192829_codegen_lbqy4u_ads_sca_2_out (`KEY`, scaler_2, scaler_3, scaler_4, scaler_5, scaler_6, scaler_7, scaler_8, scaler_9, scaler_10, scaler_11) SELECT `ADS_sca_2_OUT`.`KEY`, `ADS_sca_2_OUT`.scaler_2, `ADS_sca_2_OUT`.scaler_3, `ADS_sca_2_OUT`.scaler_4, `ADS_sca_2_OUT`.scaler_5, `ADS_sca_2_OUT`.scaler_6, `ADS_sca_2_OUT`.scaler_7, `ADS_sca_2_OUT`.scaler_8, `ADS_sca_2_OUT`.scaler_9, `ADS_sca_2_OUT`.scaler_10, `ADS_sca_2_OUT`.scaler_11 
...
FROM tmp_20180508192829_codegen_hkcg09_ads_imp_1_out AS `ADS_imp_1_OUT`) AS `ADS_sca_2_OUT`

-- Code For temporary table tmp_20180508192829_codegen_lkbf1p_xgb_b0 part 1. Create 


CREATE TABLE tmp_20180508192829_codegen_lkbf1p_xgb_b0 (
	`KEY` BIGINT, 
	`Score_0` DOUBLE, 
	`Score_1` DOUBLE, 
	`Score_2` DOUBLE, 
...
-- Code For temporary table tmp_20180508192829_codegen_lkbf1p_xgb_b0 part 2. Populate

WITH `DT_node_lookup` AS 
(SELECT `ADS_sca_2_OUT`.`KEY` AS `KEY`, CASE WHEN (`ADS_sca_2_OUT`.scaler_6 < 0.055714450776576996) THEN 1 ELSE 2 END AS node_id_2 
FROM tmp_20180508192829_codegen_lbqy4u_ads_sca_2_out AS `ADS_sca_2_OUT`), 
`DT_node_data` AS 
...
FROM `DT_Output_9`)
 INSERT INTO tmp_20180508192829_codegen_lkbf1p_xgb_b0 (`KEY`, `Score_0`, `Score_1`, `Score_2`, `Score_3`) SELECT `XGB_B0`.`KEY`, `XGB_B0`.`Score_0`, `XGB_B0`.`Score_1`, `XGB_B0`.`Score_2`, `XGB_B0`.`Score_3` 
...
-- Code For temporary table tmp_20180508192829_codegen_tg1epn_xgb_b1 part 1. Create 


CREATE TABLE tmp_20180508192829_codegen_tg1epn_xgb_b1 (
	`KEY` BIGINT, 
	`Score_0` DOUBLE, 
	`Score_1` DOUBLE, 
	`Score_2` DOUBLE, 
...
-- Code For temporary table tmp_20180508192829_codegen_tg1epn_xgb_b1 part 2. Populate
...
FROM `DT_Output_19`)
 INSERT INTO tmp_20180508192829_codegen_tg1epn_xgb_b1 (`KEY`, `Score_0`, `Score_1`, `Score_2`, `Score_3`) SELECT `XGB_B1`.`KEY`, `XGB_B1`.`Score_0`, `XGB_B1`.`Score_1`, `XGB_B1`.`Score_2`, `XGB_B1`.`Score_3` 
...
-- Code For temporary table tmp_20180508192829_codegen_mmqlbb_xgb_b2 part 1. Create 


CREATE TABLE tmp_20180508192829_codegen_mmqlbb_xgb_b2 (
	`KEY` BIGINT, 
	`Score_0` DOUBLE, 
	`Score_1` DOUBLE, 
	`Score_2` DOUBLE, 
...
-- Code For temporary table tmp_20180508192829_codegen_mmqlbb_xgb_b2 part 2. Populate
...
FROM `DT_Output_29`)
 INSERT INTO tmp_20180508192829_codegen_mmqlbb_xgb_b2 (`KEY`, `Score_0`, `Score_1`, `Score_2`, `Score_3`) SELECT `XGB_B2`.`KEY`, `XGB_B2`.`Score_0`, `XGB_B2`.`Score_1`, `XGB_B2`.`Score_2`, `XGB_B2`.`Score_3` 
...
-- Code For temporary table tmp_20180508192829_codegen_9tt06d_xgb_b3 part 1. Create 


CREATE TABLE tmp_20180508192829_codegen_9tt06d_xgb_b3 (
	`KEY` BIGINT, 
	`Score_0` DOUBLE, 
	`Score_1` DOUBLE, 
	`Score_2` DOUBLE, 
...
-- Code For temporary table tmp_20180508192829_codegen_9tt06d_xgb_b3 part 2. Populate
...
FROM `DT_Output_39`)
 INSERT INTO tmp_20180508192829_codegen_9tt06d_xgb_b3 (`KEY`, `Score_0`, `Score_1`, `Score_2`, `Score_3`) SELECT `XGB_B3`.`KEY`, `XGB_B3`.`Score_0`, `XGB_B3`.`Score_1`, `XGB_B3`.`Score_2`, `XGB_B3`.`Score_3` 
...
-- Code For temporary table tmp_20180508192829_codegen_xqwuk2_xgb_b4 part 1. Create 


CREATE TABLE tmp_20180508192829_codegen_xqwuk2_xgb_b4 (
	`KEY` BIGINT, 
	`Score_0` DOUBLE, 
	`Score_1` DOUBLE, 
	`Score_2` DOUBLE, 
...
-- Code For temporary table tmp_20180508192829_codegen_xqwuk2_xgb_b4 part 2. Populate
...
FROM `DT_Output_49`)
 INSERT INTO tmp_20180508192829_codegen_xqwuk2_xgb_b4 (`KEY`, `Score_0`, `Score_1`, `Score_2`, `Score_3`) SELECT `XGB_B4`.`KEY`, `XGB_B4`.`Score_0`, `XGB_B4`.`Score_1`, `XGB_B4`.`Score_2`, `XGB_B4`.`Score_3` 
...
-- Code For temporary table tmp_20180508192829_codegen_zm4ix5_xgb_b5 part 1. Create 


CREATE TABLE tmp_20180508192829_codegen_zm4ix5_xgb_b5 (
	`KEY` BIGINT, 
	`Score_0` DOUBLE, 
	`Score_1` DOUBLE, 
	`Score_2` DOUBLE, 
...
-- Code For temporary table tmp_20180508192829_codegen_zm4ix5_xgb_b5 part 2. Populate
...
FROM `DT_Output_59`)
 INSERT INTO tmp_20180508192829_codegen_zm4ix5_xgb_b5 (`KEY`, `Score_0`, `Score_1`, `Score_2`, `Score_3`) SELECT `XGB_B5`.`KEY`, `XGB_B5`.`Score_0`, `XGB_B5`.`Score_1`, `XGB_B5`.`Score_2`, `XGB_B5`.`Score_3` 
...
-- Code For temporary table tmp_20180508192829_codegen_b1a20f_xgb_b6 part 1. Create 


CREATE TABLE tmp_20180508192829_codegen_b1a20f_xgb_b6 (
	`KEY` BIGINT, 
	`Score_0` DOUBLE, 
	`Score_1` DOUBLE, 
	`Score_2` DOUBLE, 
...
-- Code For temporary table tmp_20180508192829_codegen_b1a20f_xgb_b6 part 2. Populate
...
FROM `DT_Output_63`)
 INSERT INTO tmp_20180508192829_codegen_b1a20f_xgb_b6 (`KEY`, `Score_0`, `Score_1`, `Score_2`, `Score_3`) SELECT `XGB_B6`.`KEY`, `XGB_B6`.`Score_0`, `XGB_B6`.`Score_1`, `XGB_B6`.`Score_2`, `XGB_B6`.`Score_3` 
...
-- Code For temporary table tmp_20180508192829_codegen_jjr3d6_xgb_union part 1. Create 


CREATE TABLE tmp_20180508192829_codegen_jjr3d6_xgb_union (
	`KEY` BIGINT, 
	`Score_0` DOUBLE, 
	`Score_1` DOUBLE, 
	`Score_2` DOUBLE, 
...
-- Code For temporary table tmp_20180508192829_codegen_jjr3d6_xgb_union part 2. Populate

INSERT INTO tmp_20180508192829_codegen_jjr3d6_xgb_union (`KEY`, `Score_0`, `Score_1`, `Score_2`, `Score_3`) SELECT `XGB_Union`.`KEY`, `XGB_Union`.`Score_0`, `XGB_Union`.`Score_1`, `XGB_Union`.`Score_2`, `XGB_Union`.`Score_3` 
...
FROM tmp_20180508192829_codegen_lkbf1p_xgb_b0 AS `XGB_B0` UNION ALL SELECT `XGB_B1`.`KEY` AS `KEY`, `XGB_B1`.`Score_0` AS `Score_0`, `XGB_B1`.`Score_1` AS `Score_1`, `XGB_B1`.`Score_2` AS `Score_2`, `XGB_B1`.`Score_3` AS `Score_3` 
FROM tmp_20180508192829_codegen_tg1epn_xgb_b1 AS `XGB_B1` UNION ALL SELECT `XGB_B2`.`KEY` AS `KEY`, `XGB_B2`.`Score_0` AS `Score_0`, `XGB_B2`.`Score_1` AS `Score_1`, `XGB_B2`.`Score_2` AS `Score_2`, `XGB_B2`.`Score_3` AS `Score_3` 
FROM tmp_20180508192829_codegen_mmqlbb_xgb_b2 AS `XGB_B2` UNION ALL SELECT `XGB_B3`.`KEY` AS `KEY`, `XGB_B3`.`Score_0` AS `Score_0`, `XGB_B3`.`Score_1` AS `Score_1`, `XGB_B3`.`Score_2` AS `Score_2`, `XGB_B3`.`Score_3` AS `Score_3` 
FROM tmp_20180508192829_codegen_9tt06d_xgb_b3 AS `XGB_B3` UNION ALL SELECT `XGB_B4`.`KEY` AS `KEY`, `XGB_B4`.`Score_0` AS `Score_0`, `XGB_B4`.`Score_1` AS `Score_1`, `XGB_B4`.`Score_2` AS `Score_2`, `XGB_B4`.`Score_3` AS `Score_3` 
FROM tmp_20180508192829_codegen_xqwuk2_xgb_b4 AS `XGB_B4` UNION ALL SELECT `XGB_B5`.`KEY` AS `KEY`, `XGB_B5`.`Score_0` AS `Score_0`, `XGB_B5`.`Score_1` AS `Score_1`, `XGB_B5`.`Score_2` AS `Score_2`, `XGB_B5`.`Score_3` AS `Score_3` 
FROM tmp_20180508192829_codegen_zm4ix5_xgb_b5 AS `XGB_B5` UNION ALL SELECT `XGB_B6`.`KEY` AS `KEY`, `XGB_B6`.`Score_0` AS `Score_0`, `XGB_B6`.`Score_1` AS `Score_1`, `XGB_B6`.`Score_2` AS `Score_2`, `XGB_B6`.`Score_3` AS `Score_3` 
FROM tmp_20180508192829_codegen_b1a20f_xgb_b6 AS `XGB_B6`) AS `XGB_EnsembleUnion`) AS `XGB_Union`

-- Code For temporary table tmp_20180508192829_codegen_plcpi6_xgb_sum part 1. Create 


CREATE TABLE tmp_20180508192829_codegen_plcpi6_xgb_sum (
	`KEY` BIGINT, 
	`Score_0` DOUBLE, 
	`Score_1` DOUBLE, 
	`Score_2` DOUBLE, 
...
-- Code For temporary table tmp_20180508192829_codegen_plcpi6_xgb_sum part 2. Populate

INSERT INTO tmp_20180508192829_codegen_plcpi6_xgb_sum (`KEY`, `Score_0`, `Score_1`, `Score_2`, `Score_3`) SELECT `XGB_sum`.`KEY`, `XGB_sum`.`Score_0`, `XGB_sum`.`Score_1`, `XGB_sum`.`Score_2`, `XGB_sum`.`Score_3` 
...
FROM tmp_20180508192829_codegen_jjr3d6_xgb_union AS `XGB_Union` GROUP BY `XGB_Union`.`KEY`) AS `T`) AS `XGB_sum`
...
FROM tmp_20180508192829_codegen_plcpi6_xgb_sum AS `XGB_sum`), 
