...
-- Code For temporary table TMP_20180508181528_CODEGEN_Y4AC part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508181528_CODEGEN_Y4AC" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20180508181528_CODEGEN_Y4AC part 2. Populate

INSERT INTO "TMP_20180508181528_CODEGEN_Y4AC" ("KEY", impter_2, impter_3, impter_4, impter_5, impter_6, impter_7, impter_8, impter_9, impter_10, impter_11) SELECT "U"."KEY", "U".impter_2, "U".impter_3, "U".impter_4, "U".impter_5, "U".impter_6, "U".impter_7, "U".impter_8, "U".impter_9, "U".impter_10, "U".impter_11 
...
-- Code For temporary table TMP_20180508181528_CODEGEN_Y4AC part 3. Create Index 

CREATE INDEX "ix_TMP_20180508181528_C_5fec" ON "TMP_20180508181528_CODEGEN_Y4AC" ("KEY")

-- Code For temporary table TMP_20180508181528_CODEGEN_VYH1 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508181528_CODEGEN_VYH1" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20180508181528_CODEGEN_VYH1 part 2. Populate

INSERT INTO "TMP_20180508181528_CODEGEN_VYH1" ("KEY", scaler_2, scaler_3, scaler_4, scaler_5, scaler_6, scaler_7, scaler_8, scaler_9, scaler_10, scaler_11) SELECT "U"."KEY", "U".scaler_2, "U".scaler_3, "U".scaler_4, "U".scaler_5, "U".scaler_6, "U".scaler_7, "U".scaler_8, "U".scaler_9, "U".scaler_10, "U".scaler_11 
...
FROM "TMP_20180508181528_CODEGEN_Y4AC" AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT") AS "U"

-- Code For temporary table TMP_20180508181528_CODEGEN_VYH1 part 3. Create Index 

CREATE INDEX "ix_TMP_20180508181528_C_4b38" ON "TMP_20180508181528_CODEGEN_VYH1" ("KEY")

-- Code For temporary table TMP_20180508181528_CODEGEN_NJL1 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508181528_CODEGEN_NJL1" (
	"KEY" BIGINT, 
...
-- Code For temporary table TMP_20180508181528_CODEGEN_NJL1 part 2. Populate

INSERT INTO "TMP_20180508181528_CODEGEN_NJL1" ("KEY", "Score_0", "Score_1", "Score_2", "Score_3") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1", "U"."Score_2", "U"."Score_3" 
...
FROM "TMP_20180508181528_CODEGEN_VYH1" AS "ADS_sca_2_OUT"), 
"DT_node_data" AS 
...
-- Code For temporary table TMP_20180508181528_CODEGEN_UODG part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508181528_CODEGEN_UODG" (
	"KEY" BIGINT, 
	"Score_0" DOUBLE PRECISION, 
	"Score_1" DOUBLE PRECISION, 
	"Score_2" DOUBLE PRECISION, 
...
-- Code For temporary table TMP_20180508181528_CODEGEN_UODG part 2. Populate

INSERT INTO "TMP_20180508181528_CODEGEN_UODG" ("KEY", "Score_0", "Score_1", "Score_2", "Score_3") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1", "U"."Score_2", "U"."Score_3" 
...
-- Code For temporary table TMP_20180508181528_CODEGEN_PE5I part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508181528_CODEGEN_PE5I" (
	"KEY" BIGINT, 
	"Score_0" DOUBLE PRECISION, 
	"Score_1" DOUBLE PRECISION, 
	"Score_2" DOUBLE PRECISION, 
...
-- Code For temporary table TMP_20180508181528_CODEGEN_PE5I part 2. Populate

INSERT INTO "TMP_20180508181528_CODEGEN_PE5I" ("KEY", "Score_0", "Score_1", "Score_2", "Score_3") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1", "U"."Score_2", "U"."Score_3" 
...
-- Code For temporary table TMP_20180508181528_CODEGEN_BXR2 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508181528_CODEGEN_BXR2" (
	"KEY" BIGINT, 
	"Score_0" DOUBLE PRECISION, 
	"Score_1" DOUBLE PRECISION, 
	"Score_2" DOUBLE PRECISION, 
...
-- Code For temporary table TMP_20180508181528_CODEGEN_BXR2 part 2. Populate

INSERT INTO "TMP_20180508181528_CODEGEN_BXR2" ("KEY", "Score_0", "Score_1", "Score_2", "Score_3") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1", "U"."Score_2", "U"."Score_3" 
...
-- Code For temporary table TMP_20180508181528_CODEGEN_W6WV part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508181528_CODEGEN_W6WV" (
	"KEY" BIGINT, 
	"Score_0" DOUBLE PRECISION, 
	"Score_1" DOUBLE PRECISION, 
	"Score_2" DOUBLE PRECISION, 
...
-- Code For temporary table TMP_20180508181528_CODEGEN_W6WV part 2. Populate

INSERT INTO "TMP_20180508181528_CODEGEN_W6WV" ("KEY", "Score_0", "Score_1", "Score_2", "Score_3") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1", "U"."Score_2", "U"."Score_3" 
...
-- Code For temporary table TMP_20180508181528_CODEGEN_3STT part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508181528_CODEGEN_3STT" (
	"KEY" BIGINT, 
	"Score_0" DOUBLE PRECISION, 
	"Score_1" DOUBLE PRECISION, 
	"Score_2" DOUBLE PRECISION, 
...
-- Code For temporary table TMP_20180508181528_CODEGEN_3STT part 2. Populate

INSERT INTO "TMP_20180508181528_CODEGEN_3STT" ("KEY", "Score_0", "Score_1", "Score_2", "Score_3") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1", "U"."Score_2", "U"."Score_3" 
...
-- Code For temporary table TMP_20180508181528_CODEGEN_9YQ5 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508181528_CODEGEN_9YQ5" (
	"KEY" BIGINT, 
	"Score_0" DOUBLE PRECISION, 
	"Score_1" DOUBLE PRECISION, 
	"Score_2" DOUBLE PRECISION, 
...
-- Code For temporary table TMP_20180508181528_CODEGEN_9YQ5 part 2. Populate

INSERT INTO "TMP_20180508181528_CODEGEN_9YQ5" ("KEY", "Score_0", "Score_1", "Score_2", "Score_3") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1", "U"."Score_2", "U"."Score_3" 
...
-- Code For temporary table TMP_20180508181528_CODEGEN_P1RB part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508181528_CODEGEN_P1RB" (
	"KEY" BIGINT, 
	"Score_0" DOUBLE PRECISION, 
	"Score_1" DOUBLE PRECISION, 
	"Score_2" DOUBLE PRECISION, 
...
-- Code For temporary table TMP_20180508181528_CODEGEN_P1RB part 2. Populate

INSERT INTO "TMP_20180508181528_CODEGEN_P1RB" ("KEY", "Score_0", "Score_1", "Score_2", "Score_3") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1", "U"."Score_2", "U"."Score_3" 
...
FROM "TMP_20180508181528_CODEGEN_NJL1" AS "XGB_B0" UNION ALL SELECT "XGB_B1"."KEY" AS "KEY", "XGB_B1"."Score_0" AS "Score_0", "XGB_B1"."Score_1" AS "Score_1", "XGB_B1"."Score_2" AS "Score_2", "XGB_B1"."Score_3" AS "Score_3" 
FROM "TMP_20180508181528_CODEGEN_UODG" AS "XGB_B1" UNION ALL SELECT "XGB_B2"."KEY" AS "KEY", "XGB_B2"."Score_0" AS "Score_0", "XGB_B2"."Score_1" AS "Score_1", "XGB_B2"."Score_2" AS "Score_2", "XGB_B2"."Score_3" AS "Score_3" 
FROM "TMP_20180508181528_CODEGEN_PE5I" AS "XGB_B2" UNION ALL SELECT "XGB_B3"."KEY" AS "KEY", "XGB_B3"."Score_0" AS "Score_0", "XGB_B3"."Score_1" AS "Score_1", "XGB_B3"."Score_2" AS "Score_2", "XGB_B3"."Score_3" AS "Score_3" 
FROM "TMP_20180508181528_CODEGEN_BXR2" AS "XGB_B3" UNION ALL SELECT "XGB_B4"."KEY" AS "KEY", "XGB_B4"."Score_0" AS "Score_0", "XGB_B4"."Score_1" AS "Score_1", "XGB_B4"."Score_2" AS "Score_2", "XGB_B4"."Score_3" AS "Score_3" 
FROM "TMP_20180508181528_CODEGEN_W6WV" AS "XGB_B4" UNION ALL SELECT "XGB_B5"."KEY" AS "KEY", "XGB_B5"."Score_0" AS "Score_0", "XGB_B5"."Score_1" AS "Score_1", "XGB_B5"."Score_2" AS "Score_2", "XGB_B5"."Score_3" AS "Score_3" 
FROM "TMP_20180508181528_CODEGEN_3STT" AS "XGB_B5" UNION ALL SELECT "XGB_B6"."KEY" AS "KEY", "XGB_B6"."Score_0" AS "Score_0", "XGB_B6"."Score_1" AS "Score_1", "XGB_B6"."Score_2" AS "Score_2", "XGB_B6"."Score_3" AS "Score_3" 
FROM "TMP_20180508181528_CODEGEN_9YQ5" AS "XGB_B6") AS "XGB_EnsembleUnion") AS "XGB_Union") AS "U"

-- Code For temporary table TMP_20180508181528_CODEGEN_AFQG part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508181528_CODEGEN_AFQG" (
	"KEY" BIGINT NOT NULL, 
	"Score_0" DOUBLE PRECISION, 
	"Score_1" DOUBLE PRECISION, 
	"Score_2" DOUBLE PRECISION, 
...
-- Code For temporary table TMP_20180508181528_CODEGEN_AFQG part 2. Populate

INSERT INTO "TMP_20180508181528_CODEGEN_AFQG" ("KEY", "Score_0", "Score_1", "Score_2", "Score_3") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1", "U"."Score_2", "U"."Score_3" 
...
FROM "TMP_20180508181528_CODEGEN_P1RB" AS "XGB_Union" GROUP BY "XGB_Union"."KEY") AS "T") AS "XGB_sum") AS "U"

-- Code For temporary table TMP_20180508181528_CODEGEN_AFQG part 3. Create Index 

CREATE INDEX "ix_TMP_20180508181528_C_ea11" ON "TMP_20180508181528_CODEGEN_AFQG" ("KEY")
...
FROM "TMP_20180508181528_CODEGEN_AFQG" AS "XGB_sum"), 
