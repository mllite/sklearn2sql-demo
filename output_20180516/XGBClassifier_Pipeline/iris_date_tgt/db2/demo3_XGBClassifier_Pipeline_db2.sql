...
-- Code For temporary table tmp_20180602160051_3vt_ads_imp_1_out part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180602160051_3vt_ads_imp_1_out (
	"KEY" BIGINT, 
...
-- Code For temporary table tmp_20180602160051_3vt_ads_imp_1_out part 2. Populate

INSERT INTO tmp_20180602160051_3vt_ads_imp_1_out SELECT "ADS_imp_1_OUT"."KEY", "ADS_imp_1_OUT".imputer_output_2, "ADS_imp_1_OUT".imputer_output_3, "ADS_imp_1_OUT".imputer_output_4, "ADS_imp_1_OUT".imputer_output_5 
...
-- Code For temporary table tmp_20180602160051_0dc_ads_sca_2_out part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180602160051_0dc_ads_sca_2_out (
	"KEY" BIGINT, 
...
-- Code For temporary table tmp_20180602160051_0dc_ads_sca_2_out part 2. Populate

INSERT INTO tmp_20180602160051_0dc_ads_sca_2_out SELECT "ADS_sca_2_OUT"."KEY", "ADS_sca_2_OUT".scaler_output_2, "ADS_sca_2_OUT".scaler_output_3, "ADS_sca_2_OUT".scaler_output_4, "ADS_sca_2_OUT".scaler_output_5 
...
FROM tmp_20180602160051_3vt_ads_imp_1_out AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT"

-- Code For temporary table tmp_20180602160051_yfx_xgb_b0 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180602160051_yfx_xgb_b0 (
	"KEY" BIGINT, 
...
-- Code For temporary table tmp_20180602160051_yfx_xgb_b0 part 2. Populate

INSERT INTO tmp_20180602160051_yfx_xgb_b0 WITH "DT_node_lookup" AS 
...
FROM tmp_20180602160051_0dc_ads_sca_2_out AS "ADS_sca_2_OUT"), 
"DT_node_data" AS 
...
-- Code For temporary table tmp_20180602160051_o84_xgb_b1 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180602160051_o84_xgb_b1 (
	"KEY" BIGINT, 
	"Score_1789-07-14T00:00:00.000000000" DOUBLE, 
	"Score_1789-08-14T00:00:00.000000000" DOUBLE, 
	"Score_1789-09-14T00:00:00.000000000" DOUBLE
...
-- Code For temporary table tmp_20180602160051_o84_xgb_b1 part 2. Populate

INSERT INTO tmp_20180602160051_o84_xgb_b1 WITH "DT_node_lookup_10" AS 
...
-- Code For temporary table tmp_20180602160051_1un_xgb_b2 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180602160051_1un_xgb_b2 (
	"KEY" BIGINT, 
	"Score_1789-07-14T00:00:00.000000000" DOUBLE, 
	"Score_1789-08-14T00:00:00.000000000" DOUBLE, 
	"Score_1789-09-14T00:00:00.000000000" DOUBLE
...
-- Code For temporary table tmp_20180602160051_1un_xgb_b2 part 2. Populate

INSERT INTO tmp_20180602160051_1un_xgb_b2 WITH "DT_node_lookup_20" AS 
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", CASE WHEN ("ADS_sca_2_OUT".scaler_output_4 < 0.5877821445465088) THEN 1 ELSE 2 END AS node_id_2 
FROM tmp_20180602160051_0dc_ads_sca_2_out AS "ADS_sca_2_OUT"), 
"DT_node_data_20" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE) AS "Score" 
...
-- Code For temporary table tmp_20180602160051_njx_xgb_b3 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180602160051_njx_xgb_b3 (
	"KEY" BIGINT, 
	"Score_1789-07-14T00:00:00.000000000" DOUBLE, 
	"Score_1789-08-14T00:00:00.000000000" DOUBLE, 
	"Score_1789-09-14T00:00:00.000000000" DOUBLE
...
-- Code For temporary table tmp_20180602160051_njx_xgb_b3 part 2. Populate

INSERT INTO tmp_20180602160051_njx_xgb_b3 WITH "DT_node_lookup_30" AS 
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", CASE WHEN ("ADS_sca_2_OUT".scaler_output_4 < -0.8158766627311707) THEN 1 ELSE 2 END AS node_id_2 
FROM tmp_20180602160051_0dc_ads_sca_2_out AS "ADS_sca_2_OUT"), 
"DT_node_data_30" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE) AS "Score" 
...
-- Code For temporary table tmp_20180602160051_dbe_xgb_b4 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180602160051_dbe_xgb_b4 (
	"KEY" BIGINT, 
	"Score_1789-07-14T00:00:00.000000000" DOUBLE, 
	"Score_1789-08-14T00:00:00.000000000" DOUBLE, 
	"Score_1789-09-14T00:00:00.000000000" DOUBLE
...
-- Code For temporary table tmp_20180602160051_dbe_xgb_b4 part 2. Populate

INSERT INTO tmp_20180602160051_dbe_xgb_b4 WITH "DT_node_lookup_40" AS 
...
-- Code For temporary table tmp_20180602160051_iip_xgb_sum part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180602160051_iip_xgb_sum (
	"KEY" BIGINT, 
	"Score_1789-07-14T00:00:00.000000000" DOUBLE, 
	"Score_1789-08-14T00:00:00.000000000" DOUBLE, 
	"Score_1789-09-14T00:00:00.000000000" DOUBLE
...
-- Code For temporary table tmp_20180602160051_iip_xgb_sum part 2. Populate

INSERT INTO tmp_20180602160051_iip_xgb_sum WITH "XGB_Union" AS 
...
FROM tmp_20180602160051_iip_xgb_sum AS "XGB_sum"), 
