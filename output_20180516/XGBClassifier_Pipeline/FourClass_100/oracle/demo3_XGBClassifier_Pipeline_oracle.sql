...
-- Code For temporary table DEGEN_W6M77O_ADS_IMP_1_OUT part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "DEGEN_W6M77O_ADS_IMP_1_OUT" (
	"KEY" NUMBER(19), 
...
-- Code For temporary table DEGEN_G00ATS_ADS_SCA_2_OUT part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "DEGEN_G00ATS_ADS_SCA_2_OUT" (
	"KEY" NUMBER(19), 
...
FROM "DEGEN_W6M77O_ADS_IMP_1_OUT" "ADS_imp_1_OUT") "ADS_sca_2_OUT") "U"

-- Code For temporary table 0516_CODEGEN_AT5L45_XGB_B0 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "0516_CODEGEN_AT5L45_XGB_B0" (
	"KEY" NUMBER(19), 
...
-- Code For temporary table 0516_CODEGEN_AT5L45_XGB_B0 part 2. Populate

INSERT INTO "0516_CODEGEN_AT5L45_XGB_B0" ("KEY", "Score_0", "Score_1", "Score_2", "Score_3") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1", "U"."Score_2", "U"."Score_3" 
FROM (WITH "DT_node_lookup" AS 
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", CASE WHEN ("ADS_sca_2_OUT".scaler_80 < -0.1553783416748047) THEN 1 ELSE 2 END AS node_id_2 
FROM "DEGEN_G00ATS_ADS_SCA_2_OUT" "ADS_sca_2_OUT"), 
"DT_node_data" AS 
...
-- Code For temporary table 0516_CODEGEN_W53TMU_XGB_B1 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "0516_CODEGEN_W53TMU_XGB_B1" (
	"KEY" NUMBER(19), 
	"Score_0" BINARY_DOUBLE, 
	"Score_1" BINARY_DOUBLE, 
	"Score_2" BINARY_DOUBLE, 
...
-- Code For temporary table 0516_CODEGEN_W53TMU_XGB_B1 part 2. Populate

INSERT INTO "0516_CODEGEN_W53TMU_XGB_B1" ("KEY", "Score_0", "Score_1", "Score_2", "Score_3") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1", "U"."Score_2", "U"."Score_3" 
...
-- Code For temporary table 0516_CODEGEN_NSVA1Q_XGB_B2 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "0516_CODEGEN_NSVA1Q_XGB_B2" (
	"KEY" NUMBER(19), 
	"Score_0" BINARY_DOUBLE, 
	"Score_1" BINARY_DOUBLE, 
	"Score_2" BINARY_DOUBLE, 
...
-- Code For temporary table 0516_CODEGEN_NSVA1Q_XGB_B2 part 2. Populate

INSERT INTO "0516_CODEGEN_NSVA1Q_XGB_B2" ("KEY", "Score_0", "Score_1", "Score_2", "Score_3") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1", "U"."Score_2", "U"."Score_3" 
...
-- Code For temporary table 0516_CODEGEN_55I9HM_XGB_B3 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "0516_CODEGEN_55I9HM_XGB_B3" (
	"KEY" NUMBER(19), 
	"Score_0" BINARY_DOUBLE, 
	"Score_1" BINARY_DOUBLE, 
	"Score_2" BINARY_DOUBLE, 
...
-- Code For temporary table 0516_CODEGEN_55I9HM_XGB_B3 part 2. Populate

INSERT INTO "0516_CODEGEN_55I9HM_XGB_B3" ("KEY", "Score_0", "Score_1", "Score_2", "Score_3") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1", "U"."Score_2", "U"."Score_3" 
...
-- Code For temporary table 0516_CODEGEN_AQRGO3_XGB_B4 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "0516_CODEGEN_AQRGO3_XGB_B4" (
	"KEY" NUMBER(19), 
	"Score_0" BINARY_DOUBLE, 
	"Score_1" BINARY_DOUBLE, 
	"Score_2" BINARY_DOUBLE, 
...
-- Code For temporary table 0516_CODEGEN_AQRGO3_XGB_B4 part 2. Populate

INSERT INTO "0516_CODEGEN_AQRGO3_XGB_B4" ("KEY", "Score_0", "Score_1", "Score_2", "Score_3") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1", "U"."Score_2", "U"."Score_3" 
...
-- Code For temporary table 0516_CODEGEN_NL9D9W_XGB_B5 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "0516_CODEGEN_NL9D9W_XGB_B5" (
	"KEY" NUMBER(19), 
	"Score_0" BINARY_DOUBLE, 
	"Score_1" BINARY_DOUBLE, 
	"Score_2" BINARY_DOUBLE, 
...
-- Code For temporary table 0516_CODEGEN_NL9D9W_XGB_B5 part 2. Populate

INSERT INTO "0516_CODEGEN_NL9D9W_XGB_B5" ("KEY", "Score_0", "Score_1", "Score_2", "Score_3") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1", "U"."Score_2", "U"."Score_3" 
...
-- Code For temporary table 0516_CODEGEN_EUA7VS_XGB_B6 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "0516_CODEGEN_EUA7VS_XGB_B6" (
	"KEY" NUMBER(19), 
	"Score_0" BINARY_DOUBLE, 
	"Score_1" BINARY_DOUBLE, 
	"Score_2" BINARY_DOUBLE, 
...
-- Code For temporary table 0516_CODEGEN_EUA7VS_XGB_B6 part 2. Populate

INSERT INTO "0516_CODEGEN_EUA7VS_XGB_B6" ("KEY", "Score_0", "Score_1", "Score_2", "Score_3") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1", "U"."Score_2", "U"."Score_3" 
...
-- Code For temporary table 516_CODEGEN_S33IL1_XGB_SUM part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "516_CODEGEN_S33IL1_XGB_SUM" (
	"KEY" NUMBER(19), 
	"Score_0" BINARY_DOUBLE, 
	"Score_1" BINARY_DOUBLE, 
	"Score_2" BINARY_DOUBLE, 
...
-- Code For temporary table 516_CODEGEN_S33IL1_XGB_SUM part 2. Populate

INSERT INTO "516_CODEGEN_S33IL1_XGB_SUM" ("KEY", "Score_0", "Score_1", "Score_2", "Score_3") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1", "U"."Score_2", "U"."Score_3" 
...
FROM "0516_CODEGEN_AT5L45_XGB_B0" "XGB_B0" UNION ALL SELECT "XGB_B1"."KEY" AS "KEY", "XGB_B1"."Score_0" AS "Score_0", "XGB_B1"."Score_1" AS "Score_1", "XGB_B1"."Score_2" AS "Score_2", "XGB_B1"."Score_3" AS "Score_3" 
FROM "0516_CODEGEN_W53TMU_XGB_B1" "XGB_B1" UNION ALL SELECT "XGB_B2"."KEY" AS "KEY", "XGB_B2"."Score_0" AS "Score_0", "XGB_B2"."Score_1" AS "Score_1", "XGB_B2"."Score_2" AS "Score_2", "XGB_B2"."Score_3" AS "Score_3" 
FROM "0516_CODEGEN_NSVA1Q_XGB_B2" "XGB_B2" UNION ALL SELECT "XGB_B3"."KEY" AS "KEY", "XGB_B3"."Score_0" AS "Score_0", "XGB_B3"."Score_1" AS "Score_1", "XGB_B3"."Score_2" AS "Score_2", "XGB_B3"."Score_3" AS "Score_3" 
FROM "0516_CODEGEN_55I9HM_XGB_B3" "XGB_B3" UNION ALL SELECT "XGB_B4"."KEY" AS "KEY", "XGB_B4"."Score_0" AS "Score_0", "XGB_B4"."Score_1" AS "Score_1", "XGB_B4"."Score_2" AS "Score_2", "XGB_B4"."Score_3" AS "Score_3" 
FROM "0516_CODEGEN_AQRGO3_XGB_B4" "XGB_B4" UNION ALL SELECT "XGB_B5"."KEY" AS "KEY", "XGB_B5"."Score_0" AS "Score_0", "XGB_B5"."Score_1" AS "Score_1", "XGB_B5"."Score_2" AS "Score_2", "XGB_B5"."Score_3" AS "Score_3" 
FROM "0516_CODEGEN_NL9D9W_XGB_B5" "XGB_B5" UNION ALL SELECT "XGB_B6"."KEY" AS "KEY", "XGB_B6"."Score_0" AS "Score_0", "XGB_B6"."Score_1" AS "Score_1", "XGB_B6"."Score_2" AS "Score_2", "XGB_B6"."Score_3" AS "Score_3" 
FROM "0516_CODEGEN_EUA7VS_XGB_B6" "XGB_B6") "XGB_EnsembleUnion")
...
FROM "516_CODEGEN_S33IL1_XGB_SUM" "XGB_sum"), 
