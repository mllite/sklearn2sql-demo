...
-- Code For temporary table tmp_20180508182101_codegen_fam9d3_ads_imp_1_out part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180508182101_codegen_fam9d3_ads_imp_1_out (
	"KEY" BIGINT, 
	impter_2 DOUBLE, 
	impter_3 DOUBLE, 
	impter_4 DOUBLE, 
...
-- Code For temporary table tmp_20180508182101_codegen_dnwpxo_ads_sca_2_out part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180508182101_codegen_dnwpxo_ads_sca_2_out (
	"KEY" BIGINT, 
	scaler_2 DOUBLE, 
	scaler_3 DOUBLE, 
	scaler_4 DOUBLE, 
...
FROM tmp_20180508182101_codegen_fam9d3_ads_imp_1_out AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT"

-- Code For temporary table tmp_20180508182101_codegen_3adchl_xgb_b0 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180508182101_codegen_3adchl_xgb_b0 (
	"KEY" BIGINT, 
	"Score_0" DOUBLE, 
	"Score_1" DOUBLE, 
	"Score_2" DOUBLE, 
...
-- Code For temporary table tmp_20180508182101_codegen_3adchl_xgb_b0 part 2. Populate

INSERT INTO tmp_20180508182101_codegen_3adchl_xgb_b0 WITH "DT_node_lookup" AS 
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", CASE WHEN ("ADS_sca_2_OUT".scaler_80 < -0.1553783416748047) THEN 1 ELSE 2 END AS node_id_2 
FROM tmp_20180508182101_codegen_dnwpxo_ads_sca_2_out AS "ADS_sca_2_OUT"), 
"DT_node_data" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE) AS "Score" 
FROM (SELECT 1 AS nid, -0.052054792642593384 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 2 AS nid, 0.0481012687087059 AS "Score" FROM SYSIBM.SYSDUMMY1) AS "Values"), 
"DT_Output" AS 
...
"DT_node_data_1" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE) AS "Score" 
FROM (SELECT 1 AS nid, -0.04137931391596794 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 3 AS nid, -0.017391305416822433 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 4 AS nid, 0.06923077255487442 AS "Score" FROM SYSIBM.SYSDUMMY1) AS "Values"), 
"DT_Output_1" AS 
...
"DT_node_data_2" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE) AS "Score" 
FROM (SELECT 1 AS nid, 0.07415730506181717 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 3 AS nid, -0.06218487769365311 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 4 AS nid, 0 AS "Score" FROM SYSIBM.SYSDUMMY1) AS "Values"), 
"DT_Output_2" AS 
...
"DT_node_data_3" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE) AS "Score" 
FROM (SELECT 2 AS nid, 0.0579439215362072 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 3 AS nid, -0.061538465321063995 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 4 AS nid, 0.0019801980815827847 AS "Score" FROM SYSIBM.SYSDUMMY1) AS "Values"), 
"DT_Output_3" AS 
...
"DT_node_data_4" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE) AS "Score" 
FROM (SELECT 1 AS nid, -0.050786226987838745 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 2 AS nid, 0.044583071023225784 AS "Score" FROM SYSIBM.SYSDUMMY1) AS "Values"), 
"DT_Output_4" AS 
...
"DT_node_data_5" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE) AS "Score" 
FROM (SELECT 1 AS nid, -0.04009634628891945 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 3 AS nid, -0.018268993124365807 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 4 AS nid, 0.06609376519918442 AS "Score" FROM SYSIBM.SYSDUMMY1) AS "Values"), 
"DT_Output_5" AS 
...
"DT_node_data_6" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE) AS "Score" 
FROM (SELECT 1 AS nid, 0.07125314325094223 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 3 AS nid, -0.06083786487579346 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 4 AS nid, -0.0017260321183130145 AS "Score" FROM SYSIBM.SYSDUMMY1) AS "Values"), 
"DT_Output_6" AS 
...
"DT_node_data_7" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE) AS "Score" 
FROM (SELECT 2 AS nid, 0.0534663088619709 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 3 AS nid, -0.06037139520049095 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 4 AS nid, 0.001931775943376124 AS "Score" FROM SYSIBM.SYSDUMMY1) AS "Values"), 
"DT_Output_7" AS 
...
"DT_node_data_8" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE) AS "Score" 
FROM (SELECT 1 AS nid, -0.04955817386507988 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 2 AS nid, 0.04143565520644188 AS "Score" FROM SYSIBM.SYSDUMMY1) AS "Values"), 
"DT_Output_8" AS 
...
"DT_node_data_9" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE) AS "Score" 
FROM (SELECT 1 AS nid, -0.03688141331076622 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 3 AS nid, -0.019681675359606743 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 4 AS nid, 0.07987216860055923 AS "Score" FROM SYSIBM.SYSDUMMY1) AS "Values"), 
"DT_Output_9" AS 
...
-- Code For temporary table tmp_20180508182102_codegen_ala29t_xgb_b1 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180508182102_codegen_ala29t_xgb_b1 (
	"KEY" BIGINT, 
	"Score_0" DOUBLE, 
	"Score_1" DOUBLE, 
	"Score_2" DOUBLE, 
...
-- Code For temporary table tmp_20180508182102_codegen_ala29t_xgb_b1 part 2. Populate

INSERT INTO tmp_20180508182102_codegen_ala29t_xgb_b1 WITH "DT_node_lookup_10" AS 
...
"DT_node_data_10" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE) AS "Score" 
FROM (SELECT 1 AS nid, 0.06912286579608917 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 3 AS nid, -0.0598834753036499 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 4 AS nid, -0.001493054791353643 AS "Score" FROM SYSIBM.SYSDUMMY1) AS "Values"), 
"DT_Output_10" AS 
...
"DT_node_data_11" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE) AS "Score" 
FROM (SELECT 1 AS nid, 0.04155581817030907 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 2 AS nid, -0.038169365376234055 AS "Score" FROM SYSIBM.SYSDUMMY1) AS "Values"), 
"DT_Output_11" AS 
...
"DT_node_data_12" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE) AS "Score" 
FROM (SELECT 1 AS nid, -0.048469457775354385 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 3 AS nid, 0.018819978460669518 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 4 AS nid, 0.0552968792617321 AS "Score" FROM SYSIBM.SYSDUMMY1) AS "Values"), 
"DT_Output_12" AS 
...
"DT_node_data_13" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE) AS "Score" 
FROM (SELECT 1 AS nid, -0.0359056182205677 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 3 AS nid, -0.020401278510689735 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 4 AS nid, 0.07861651480197906 AS "Score" FROM SYSIBM.SYSDUMMY1) AS "Values"), 
"DT_Output_13" AS 
...
"DT_node_data_14" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE) AS "Score" 
FROM (SELECT 1 AS nid, 0.039184436202049255 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 2 AS nid, -0.05036511644721031 AS "Score" FROM SYSIBM.SYSDUMMY1) AS "Values"), 
"DT_Output_14" AS 
...
"DT_node_data_15" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE) AS "Score" 
FROM (SELECT 2 AS nid, 0.04913122579455376 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 3 AS nid, -0.060412466526031494 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 4 AS nid, 0.008223329670727253 AS "Score" FROM SYSIBM.SYSDUMMY1) AS "Values"), 
"DT_Output_15" AS 
...
"DT_node_data_16" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE) AS "Score" 
FROM (SELECT 1 AS nid, -0.04732387885451317 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 3 AS nid, 0.07807334512472153 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 4 AS nid, -0.009380743838846684 AS "Score" FROM SYSIBM.SYSDUMMY1) AS "Values"), 
"DT_Output_16" AS 
...
"DT_node_data_17" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE) AS "Score" 
FROM (SELECT 1 AS nid, -0.032732367515563965 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 3 AS nid, 0.06518294662237167 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 4 AS nid, -0.008463182486593723 AS "Score" FROM SYSIBM.SYSDUMMY1) AS "Values"), 
"DT_Output_17" AS 
...
"DT_node_data_18" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE) AS "Score" 
FROM (SELECT 1 AS nid, 0.06189613416790962 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 3 AS nid, -0.05855947360396385 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 4 AS nid, -0.0012123392662033439 AS "Score" FROM SYSIBM.SYSDUMMY1) AS "Values"), 
"DT_Output_18" AS 
...
"DT_node_data_19" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE) AS "Score" 
FROM (SELECT 1 AS nid, 0.03795481100678444 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 2 AS nid, -0.03669613599777222 AS "Score" FROM SYSIBM.SYSDUMMY1) AS "Values"), 
"DT_Output_19" AS 
...
-- Code For temporary table tmp_20180508182102_codegen_ug9d6l_xgb_b2 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180508182102_codegen_ug9d6l_xgb_b2 (
	"KEY" BIGINT, 
	"Score_0" DOUBLE, 
	"Score_1" DOUBLE, 
	"Score_2" DOUBLE, 
...
-- Code For temporary table tmp_20180508182102_codegen_ug9d6l_xgb_b2 part 2. Populate

INSERT INTO tmp_20180508182102_codegen_ug9d6l_xgb_b2 WITH "DT_node_lookup_20" AS 
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", CASE WHEN ("ADS_sca_2_OUT".scaler_94 < 0.05711609870195389) THEN 1 ELSE 2 END AS node_id_2 
FROM tmp_20180508182101_codegen_dnwpxo_ads_sca_2_out AS "ADS_sca_2_OUT"), 
"DT_node_data_20" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE) AS "Score" 
FROM (SELECT 1 AS nid, 0.038793642073869705 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 2 AS nid, -0.04074731841683388 AS "Score" FROM SYSIBM.SYSDUMMY1) AS "Values"), 
"DT_Output_20" AS 
...
"DT_node_data_21" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE) AS "Score" 
FROM (SELECT 1 AS nid, -0.03825074061751366 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 3 AS nid, -0.017761098220944405 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 4 AS nid, 0.05829000473022461 AS "Score" FROM SYSIBM.SYSDUMMY1) AS "Values"), 
"DT_Output_21" AS 
...
"DT_node_data_22" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE) AS "Score" 
FROM (SELECT 1 AS nid, 0.03523324057459831 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 2 AS nid, -0.04865545406937599 AS "Score" FROM SYSIBM.SYSDUMMY1) AS "Values"), 
"DT_Output_22" AS 
...
"DT_node_data_23" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE) AS "Score" 
FROM (SELECT 2 AS nid, 0.04501606896519661 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 3 AS nid, -0.059206631034612656 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 4 AS nid, 0.007713259197771549 AS "Score" FROM SYSIBM.SYSDUMMY1) AS "Values"), 
"DT_Output_23" AS 
...
"DT_node_data_24" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE) AS "Score" 
FROM (SELECT 1 AS nid, -0.04601466283202171 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 3 AS nid, -0.011126256547868252 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 4 AS nid, 0.07597658783197403 AS "Score" FROM SYSIBM.SYSDUMMY1) AS "Values"), 
"DT_Output_24" AS 
...
"DT_node_data_25" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE) AS "Score" 
FROM (SELECT 1 AS nid, -0.03467597812414169 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 3 AS nid, -0.0197126604616642 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 4 AS nid, 0.0716351866722107 AS "Score" FROM SYSIBM.SYSDUMMY1) AS "Values"), 
"DT_Output_25" AS 
...
"DT_node_data_26" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE) AS "Score" 
FROM (SELECT 1 AS nid, 0.0556979775428772 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 3 AS nid, 0.003811382222920656 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 4 AS nid, -0.05321931838989258 AS "Score" FROM SYSIBM.SYSDUMMY1) AS "Values"), 
"DT_Output_26" AS 
...
"DT_node_data_27" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE) AS "Score" 
FROM (SELECT 1 AS nid, 0.035067666321992874 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 2 AS nid, -0.03533443436026573 AS "Score" FROM SYSIBM.SYSDUMMY1) AS "Values"), 
"DT_Output_27" AS 
...
"DT_node_data_28" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE) AS "Score" 
FROM (SELECT 1 AS nid, -0.045059967786073685 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 3 AS nid, 0.07510359585285187 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 4 AS nid, -0.012098641134798527 AS "Score" FROM SYSIBM.SYSDUMMY1) AS "Values"), 
"DT_Output_28" AS 
...
"DT_node_data_29" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE) AS "Score" 
FROM (SELECT 1 AS nid, -0.0427701435983181 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 3 AS nid, -0.02681289054453373 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 4 AS nid, 0.05543297156691551 AS "Score" FROM SYSIBM.SYSDUMMY1) AS "Values"), 
"DT_Output_29" AS 
...
-- Code For temporary table tmp_20180508182102_codegen_8746k9_xgb_b3 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180508182102_codegen_8746k9_xgb_b3 (
	"KEY" BIGINT, 
	"Score_0" DOUBLE, 
	"Score_1" DOUBLE, 
	"Score_2" DOUBLE, 
...
-- Code For temporary table tmp_20180508182102_codegen_8746k9_xgb_b3 part 2. Populate

INSERT INTO tmp_20180508182102_codegen_8746k9_xgb_b3 WITH "DT_node_lookup_30" AS 
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", CASE WHEN ("ADS_sca_2_OUT".scaler_58 < 0.04468822479248047) THEN 1 ELSE 2 END AS node_id_2 
FROM tmp_20180508182101_codegen_dnwpxo_ads_sca_2_out AS "ADS_sca_2_OUT"), 
"DT_node_data_30" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE) AS "Score" 
FROM (SELECT 1 AS nid, 0.032271843403577805 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 2 AS nid, -0.04722842201590538 AS "Score" FROM SYSIBM.SYSDUMMY1) AS "Values"), 
"DT_Output_30" AS 
...
"DT_node_data_31" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE) AS "Score" 
FROM (SELECT 2 AS nid, 0.04335922747850418 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 3 AS nid, -0.058671075850725174 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 4 AS nid, 0.0048435586504638195 AS "Score" FROM SYSIBM.SYSDUMMY1) AS "Values"), 
"DT_Output_31" AS 
...
"DT_node_data_32" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE) AS "Score" 
FROM (SELECT 1 AS nid, -0.04403754323720932 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 3 AS nid, 0.06974812597036362 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 4 AS nid, -0.011473114602267742 AS "Score" FROM SYSIBM.SYSDUMMY1) AS "Values"), 
"DT_Output_32" AS 
...
"DT_node_data_33" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE) AS "Score" 
FROM (SELECT 1 AS nid, -0.04246225208044052 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 3 AS nid, -0.034165360033512115 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 4 AS nid, 0.05870286375284195 AS "Score" FROM SYSIBM.SYSDUMMY1) AS "Values"), 
"DT_Output_33" AS 
...
"DT_node_data_34" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE) AS "Score" 
FROM (SELECT 1 AS nid, -0.058462876826524734 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 3 AS nid, 0.060109447687864304 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 4 AS nid, -0.026071613654494286 AS "Score" FROM SYSIBM.SYSDUMMY1) AS "Values"), 
"DT_Output_34" AS 
...
"DT_node_data_35" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE) AS "Score" 
FROM (SELECT 2 AS nid, 0.04106998071074486 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 3 AS nid, -0.05915072560310364 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 4 AS nid, 0.0074475849978625774 AS "Score" FROM SYSIBM.SYSDUMMY1) AS "Values"), 
"DT_Output_35" AS 
...
"DT_node_data_36" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE) AS "Score" 
FROM (SELECT 1 AS nid, 0.032571326941251755 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 2 AS nid, -0.037588607519865036 AS "Score" FROM SYSIBM.SYSDUMMY1) AS "Values"), 
"DT_Output_36" AS 
...
"DT_node_data_37" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE) AS "Score" 
FROM (SELECT 1 AS nid, -0.03335636481642723 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 3 AS nid, -0.018563982099294662 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 4 AS nid, 0.06435927003622055 AS "Score" FROM SYSIBM.SYSDUMMY1) AS "Values"), 
"DT_Output_37" AS 
...
"DT_node_data_38" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE) AS "Score" 
FROM (SELECT 1 AS nid, 0.03470521792769432 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 2 AS nid, -0.038759227842092514 AS "Score" FROM SYSIBM.SYSDUMMY1) AS "Values"), 
"DT_Output_38" AS 
...
"DT_node_data_39" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE) AS "Score" 
FROM (SELECT 2 AS nid, 0.04294843226671219 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 3 AS nid, 0.014535215683281422 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 4 AS nid, -0.05950593948364258 AS "Score" FROM SYSIBM.SYSDUMMY1) AS "Values"), 
"DT_Output_39" AS 
...
-- Code For temporary table tmp_20180508182102_codegen_b7stmb_xgb_b4 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180508182102_codegen_b7stmb_xgb_b4 (
	"KEY" BIGINT, 
	"Score_0" DOUBLE, 
	"Score_1" DOUBLE, 
	"Score_2" DOUBLE, 
...
-- Code For temporary table tmp_20180508182102_codegen_b7stmb_xgb_b4 part 2. Populate

INSERT INTO tmp_20180508182102_codegen_b7stmb_xgb_b4 WITH "DT_node_lookup_40" AS 
...
"DT_node_data_40" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE) AS "Score" 
FROM (SELECT 1 AS nid, -0.04267590120434761 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 3 AS nid, 0.0663042664527893 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 4 AS nid, -0.009739220142364502 AS "Score" FROM SYSIBM.SYSDUMMY1) AS "Values"), 
"DT_Output_40" AS 
...
"DT_node_data_41" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE) AS "Score" 
FROM (SELECT 1 AS nid, -0.0363822840154171 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 3 AS nid, -0.008562571369111538 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 4 AS nid, 0.060015060007572174 AS "Score" FROM SYSIBM.SYSDUMMY1) AS "Values"), 
"DT_Output_41" AS 
...
"DT_node_data_42" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE) AS "Score" 
FROM (SELECT 1 AS nid, 0.04807698354125023 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 3 AS nid, -0.055943477898836136 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 4 AS nid, 7.369937520707026e-05 AS "Score" FROM SYSIBM.SYSDUMMY1) AS "Values"), 
"DT_Output_42" AS 
...
"DT_node_data_43" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE) AS "Score" 
FROM (SELECT 2 AS nid, 0.039890434592962265 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 3 AS nid, -0.05755959078669548 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 4 AS nid, 0.005057879723608494 AS "Score" FROM SYSIBM.SYSDUMMY1) AS "Values"), 
"DT_Output_43" AS 
...
"DT_node_data_44" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE) AS "Score" 
FROM (SELECT 1 AS nid, 0.030114417895674706 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 2 AS nid, -0.036143820732831955 AS "Score" FROM SYSIBM.SYSDUMMY1) AS "Values"), 
"DT_Output_44" AS 
...
"DT_node_data_45" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE) AS "Score" 
FROM (SELECT 1 AS nid, -0.029911357909440994 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 3 AS nid, 0.0523921363055706 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 4 AS nid, -0.004095575772225857 AS "Score" FROM SYSIBM.SYSDUMMY1) AS "Values"), 
"DT_Output_45" AS 
...
"DT_node_data_46" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE) AS "Score" 
FROM (SELECT 2 AS nid, -0.044225916266441345 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 3 AS nid, 0.06993673741817474 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 4 AS nid, -0.01940912939608097 AS "Score" FROM SYSIBM.SYSDUMMY1) AS "Values"), 
"DT_Output_46" AS 
...
"DT_node_data_47" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE) AS "Score" 
FROM (SELECT 1 AS nid, 0.03050278127193451 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 2 AS nid, -0.03284749016165733 AS "Score" FROM SYSIBM.SYSDUMMY1) AS "Values"), 
"DT_Output_47" AS 
...
"DT_node_data_48" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE) AS "Score" 
FROM (SELECT 1 AS nid, -0.041426461189985275 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 3 AS nid, 0.05845677852630615 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 4 AS nid, -0.012976204045116901 AS "Score" FROM SYSIBM.SYSDUMMY1) AS "Values"), 
"DT_Output_48" AS 
...
"DT_node_data_49" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE) AS "Score" 
FROM (SELECT 1 AS nid, -0.032276857644319534 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 3 AS nid, -0.01732075773179531 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 4 AS nid, 0.05907256156206131 AS "Score" FROM SYSIBM.SYSDUMMY1) AS "Values"), 
"DT_Output_49" AS 
...
-- Code For temporary table tmp_20180508182102_codegen_wc7ofo_xgb_b5 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180508182102_codegen_wc7ofo_xgb_b5 (
	"KEY" BIGINT, 
	"Score_0" DOUBLE, 
	"Score_1" DOUBLE, 
	"Score_2" DOUBLE, 
...
-- Code For temporary table tmp_20180508182102_codegen_wc7ofo_xgb_b5 part 2. Populate

INSERT INTO tmp_20180508182102_codegen_wc7ofo_xgb_b5 WITH "DT_node_lookup_50" AS 
...
"DT_node_data_50" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE) AS "Score" 
FROM (SELECT 1 AS nid, -0.050980597734451294 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 3 AS nid, 0.05940955504775047 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 4 AS nid, -0.015090443193912506 AS "Score" FROM SYSIBM.SYSDUMMY1) AS "Values"), 
"DT_Output_50" AS 
...
"DT_node_data_51" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE) AS "Score" 
FROM (SELECT 2 AS nid, 0.03785286098718643 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 3 AS nid, -0.057832468301057816 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 4 AS nid, 0.005997552536427975 AS "Score" FROM SYSIBM.SYSDUMMY1) AS "Values"), 
"DT_Output_51" AS 
...
"DT_node_data_52" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE) AS "Score" 
FROM (SELECT 1 AS nid, 0.0327979177236557 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 2 AS nid, -0.031284164637327194 AS "Score" FROM SYSIBM.SYSDUMMY1) AS "Values"), 
"DT_Output_52" AS 
...
"DT_node_data_53" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE) AS "Score" 
FROM (SELECT 1 AS nid, -0.029334494844079018 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 3 AS nid, 0.055296625941991806 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 4 AS nid, -0.011148530058562756 AS "Score" FROM SYSIBM.SYSDUMMY1) AS "Values"), 
"DT_Output_53" AS 
...
"DT_node_data_54" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE) AS "Score" 
FROM (SELECT 2 AS nid, -0.04753139987587929 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 3 AS nid, 0.061463143676519394 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 4 AS nid, -0.016558878123760223 AS "Score" FROM SYSIBM.SYSDUMMY1) AS "Values"), 
"DT_Output_54" AS 
...
"DT_node_data_55" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE) AS "Score" 
FROM (SELECT 2 AS nid, 0.03880971297621727 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 3 AS nid, 0.011489260010421276 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 4 AS nid, -0.05774012953042984 AS "Score" FROM SYSIBM.SYSDUMMY1) AS "Values"), 
"DT_Output_55" AS 
...
"DT_node_data_56" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE) AS "Score" 
FROM (SELECT 1 AS nid, -0.040287598967552185 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 3 AS nid, -0.010592608712613583 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 4 AS nid, 0.0577520988881588 AS "Score" FROM SYSIBM.SYSDUMMY1) AS "Values"), 
"DT_Output_56" AS 
...
"DT_node_data_57" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE) AS "Score" 
FROM (SELECT 1 AS nid, -0.0344601571559906 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 3 AS nid, -0.016913842409849167 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 4 AS nid, 0.04708032310009003 AS "Score" FROM SYSIBM.SYSDUMMY1) AS "Values"), 
"DT_Output_57" AS 
...
"DT_node_data_58" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE) AS "Score" 
FROM (SELECT 2 AS nid, 0.04382986202836037 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 3 AS nid, 0.009259114973247051 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 4 AS nid, -0.05783044919371605 AS "Score" FROM SYSIBM.SYSDUMMY1) AS "Values"), 
"DT_Output_58" AS 
...
"DT_node_data_59" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE) AS "Score" 
FROM (SELECT 1 AS nid, -0.03965549170970917 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 3 AS nid, 0.0655134916305542 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 4 AS nid, -0.018140515312552452 AS "Score" FROM SYSIBM.SYSDUMMY1) AS "Values"), 
"DT_Output_59" AS 
...
-- Code For temporary table tmp_20180508182102_codegen_rwykbq_xgb_b6 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180508182102_codegen_rwykbq_xgb_b6 (
	"KEY" BIGINT, 
	"Score_0" DOUBLE, 
	"Score_1" DOUBLE, 
	"Score_2" DOUBLE, 
...
-- Code For temporary table tmp_20180508182102_codegen_rwykbq_xgb_b6 part 2. Populate

INSERT INTO tmp_20180508182102_codegen_rwykbq_xgb_b6 WITH "DT_node_lookup_60" AS 
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", CASE WHEN ("ADS_sca_2_OUT".scaler_94 < 0.05711609870195389) THEN 1 ELSE 2 END AS node_id_2 
FROM tmp_20180508182101_codegen_dnwpxo_ads_sca_2_out AS "ADS_sca_2_OUT"), 
"DT_node_data_60" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE) AS "Score" 
FROM (SELECT 1 AS nid, 0.026960110291838646 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 2 AS nid, -0.03415247052907944 AS "Score" FROM SYSIBM.SYSDUMMY1) AS "Values"), 
"DT_Output_60" AS 
...
"DT_node_data_61" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE) AS "Score" 
FROM (SELECT 2 AS nid, 0.03468397632241249 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 3 AS nid, -0.05121353268623352 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 4 AS nid, 0.019274404272437096 AS "Score" FROM SYSIBM.SYSDUMMY1) AS "Values"), 
"DT_Output_61" AS 
...
"DT_node_data_62" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE) AS "Score" 
FROM (SELECT 2 AS nid, -0.041770465672016144 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 3 AS nid, 0.062389638274908066 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 4 AS nid, -0.018580978736281395 AS "Score" FROM SYSIBM.SYSDUMMY1) AS "Values"), 
"DT_Output_62" AS 
...
"DT_node_data_63" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE) AS "Score" 
FROM (SELECT 1 AS nid, -0.04381858557462692 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 3 AS nid, 0.05424414947628975 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 4 AS nid, -0.022549962624907494 AS "Score" FROM SYSIBM.SYSDUMMY1) AS "Values"), 
"DT_Output_63" AS 
...
-- Code For temporary table tmp_20180508182102_codegen_wie8wf_xgb_union part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180508182102_codegen_wie8wf_xgb_union (
	"KEY" BIGINT, 
	"Score_0" DOUBLE, 
	"Score_1" DOUBLE, 
	"Score_2" DOUBLE, 
...
-- Code For temporary table tmp_20180508182102_codegen_wie8wf_xgb_union part 2. Populate

INSERT INTO tmp_20180508182102_codegen_wie8wf_xgb_union SELECT "XGB_Union"."KEY", "XGB_Union"."Score_0", "XGB_Union"."Score_1", "XGB_Union"."Score_2", "XGB_Union"."Score_3" 
...
FROM tmp_20180508182101_codegen_3adchl_xgb_b0 AS "XGB_B0" UNION ALL SELECT "XGB_B1"."KEY" AS "KEY", "XGB_B1"."Score_0" AS "Score_0", "XGB_B1"."Score_1" AS "Score_1", "XGB_B1"."Score_2" AS "Score_2", "XGB_B1"."Score_3" AS "Score_3" 
FROM tmp_20180508182102_codegen_ala29t_xgb_b1 AS "XGB_B1" UNION ALL SELECT "XGB_B2"."KEY" AS "KEY", "XGB_B2"."Score_0" AS "Score_0", "XGB_B2"."Score_1" AS "Score_1", "XGB_B2"."Score_2" AS "Score_2", "XGB_B2"."Score_3" AS "Score_3" 
FROM tmp_20180508182102_codegen_ug9d6l_xgb_b2 AS "XGB_B2" UNION ALL SELECT "XGB_B3"."KEY" AS "KEY", "XGB_B3"."Score_0" AS "Score_0", "XGB_B3"."Score_1" AS "Score_1", "XGB_B3"."Score_2" AS "Score_2", "XGB_B3"."Score_3" AS "Score_3" 
FROM tmp_20180508182102_codegen_8746k9_xgb_b3 AS "XGB_B3" UNION ALL SELECT "XGB_B4"."KEY" AS "KEY", "XGB_B4"."Score_0" AS "Score_0", "XGB_B4"."Score_1" AS "Score_1", "XGB_B4"."Score_2" AS "Score_2", "XGB_B4"."Score_3" AS "Score_3" 
FROM tmp_20180508182102_codegen_b7stmb_xgb_b4 AS "XGB_B4" UNION ALL SELECT "XGB_B5"."KEY" AS "KEY", "XGB_B5"."Score_0" AS "Score_0", "XGB_B5"."Score_1" AS "Score_1", "XGB_B5"."Score_2" AS "Score_2", "XGB_B5"."Score_3" AS "Score_3" 
FROM tmp_20180508182102_codegen_wc7ofo_xgb_b5 AS "XGB_B5" UNION ALL SELECT "XGB_B6"."KEY" AS "KEY", "XGB_B6"."Score_0" AS "Score_0", "XGB_B6"."Score_1" AS "Score_1", "XGB_B6"."Score_2" AS "Score_2", "XGB_B6"."Score_3" AS "Score_3" 
FROM tmp_20180508182102_codegen_rwykbq_xgb_b6 AS "XGB_B6") AS "XGB_EnsembleUnion") AS "XGB_Union"

-- Code For temporary table tmp_20180508182102_codegen_q0ivpk_xgb_sum part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180508182102_codegen_q0ivpk_xgb_sum (
	"KEY" BIGINT, 
	"Score_0" DOUBLE, 
	"Score_1" DOUBLE, 
	"Score_2" DOUBLE, 
...
-- Code For temporary table tmp_20180508182102_codegen_q0ivpk_xgb_sum part 2. Populate

INSERT INTO tmp_20180508182102_codegen_q0ivpk_xgb_sum SELECT "XGB_sum"."KEY", "XGB_sum"."Score_0", "XGB_sum"."Score_1", "XGB_sum"."Score_2", "XGB_sum"."Score_3" 
...
FROM tmp_20180508182102_codegen_wie8wf_xgb_union AS "XGB_Union" GROUP BY "XGB_Union"."KEY") AS "T") AS "XGB_sum"
...
FROM tmp_20180508182102_codegen_q0ivpk_xgb_sum AS "XGB_sum"), 
