...
-- Code For temporary table tmp_20180516113506_codegen_mgdbhp_ads_imp_1_out part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180516113506_codegen_mgdbhp_ads_imp_1_out (
	"KEY" BIGINT, 
	impter_2 DOUBLE, 
	impter_3 DOUBLE, 
	impter_4 DOUBLE, 
...
-- Code For temporary table tmp_20180516113506_codegen_634uqz_ads_sca_2_out part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180516113506_codegen_634uqz_ads_sca_2_out (
	"KEY" BIGINT, 
	scaler_2 DOUBLE, 
	scaler_3 DOUBLE, 
	scaler_4 DOUBLE, 
...
FROM tmp_20180516113506_codegen_mgdbhp_ads_imp_1_out AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT"

-- Code For temporary table tmp_20180516113506_codegen_sg8nrr_xgb_b0 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180516113506_codegen_sg8nrr_xgb_b0 (
	"KEY" BIGINT, 
	"Score_0" DOUBLE, 
	"Score_1" DOUBLE, 
	"Score_2" DOUBLE, 
...
-- Code For temporary table tmp_20180516113506_codegen_sg8nrr_xgb_b0 part 2. Populate

INSERT INTO tmp_20180516113506_codegen_sg8nrr_xgb_b0 WITH "DT_node_lookup" AS 
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", CASE WHEN ("ADS_sca_2_OUT".scaler_80 < -0.1553783416748047) THEN 1 ELSE 2 END AS node_id_2 
FROM tmp_20180516113506_codegen_634uqz_ads_sca_2_out AS "ADS_sca_2_OUT"), 
"DT_node_data" AS 
...
-- Code For temporary table tmp_20180516113506_codegen_z1i905_xgb_b1 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180516113506_codegen_z1i905_xgb_b1 (
	"KEY" BIGINT, 
	"Score_0" DOUBLE, 
	"Score_1" DOUBLE, 
	"Score_2" DOUBLE, 
...
-- Code For temporary table tmp_20180516113506_codegen_z1i905_xgb_b1 part 2. Populate

INSERT INTO tmp_20180516113506_codegen_z1i905_xgb_b1 WITH "DT_node_lookup_10" AS 
...
-- Code For temporary table tmp_20180516113506_codegen_r0euwn_xgb_b2 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180516113506_codegen_r0euwn_xgb_b2 (
	"KEY" BIGINT, 
	"Score_0" DOUBLE, 
	"Score_1" DOUBLE, 
	"Score_2" DOUBLE, 
...
-- Code For temporary table tmp_20180516113506_codegen_r0euwn_xgb_b2 part 2. Populate

INSERT INTO tmp_20180516113506_codegen_r0euwn_xgb_b2 WITH "DT_node_lookup_20" AS 
...
-- Code For temporary table tmp_20180516113506_codegen_aoyjg3_xgb_b3 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180516113506_codegen_aoyjg3_xgb_b3 (
	"KEY" BIGINT, 
	"Score_0" DOUBLE, 
	"Score_1" DOUBLE, 
	"Score_2" DOUBLE, 
...
-- Code For temporary table tmp_20180516113506_codegen_aoyjg3_xgb_b3 part 2. Populate

INSERT INTO tmp_20180516113506_codegen_aoyjg3_xgb_b3 WITH "DT_node_lookup_30" AS 
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", CASE WHEN ("ADS_sca_2_OUT".scaler_58 < 0.04468822479248047) THEN 1 ELSE 2 END AS node_id_2 
FROM tmp_20180516113506_codegen_634uqz_ads_sca_2_out AS "ADS_sca_2_OUT"), 
"DT_node_data_30" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE) AS "Score" 
...
-- Code For temporary table tmp_20180516113506_codegen_iy9o07_xgb_b4 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180516113506_codegen_iy9o07_xgb_b4 (
	"KEY" BIGINT, 
	"Score_0" DOUBLE, 
	"Score_1" DOUBLE, 
	"Score_2" DOUBLE, 
...
-- Code For temporary table tmp_20180516113506_codegen_iy9o07_xgb_b4 part 2. Populate

INSERT INTO tmp_20180516113506_codegen_iy9o07_xgb_b4 WITH "DT_node_lookup_40" AS 
...
-- Code For temporary table tmp_20180516113506_codegen_yd3hn5_xgb_b5 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180516113506_codegen_yd3hn5_xgb_b5 (
	"KEY" BIGINT, 
	"Score_0" DOUBLE, 
	"Score_1" DOUBLE, 
	"Score_2" DOUBLE, 
...
-- Code For temporary table tmp_20180516113506_codegen_yd3hn5_xgb_b5 part 2. Populate

INSERT INTO tmp_20180516113506_codegen_yd3hn5_xgb_b5 WITH "DT_node_lookup_50" AS 
...
-- Code For temporary table tmp_20180516113506_codegen_f85e6z_xgb_b6 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180516113506_codegen_f85e6z_xgb_b6 (
	"KEY" BIGINT, 
	"Score_0" DOUBLE, 
	"Score_1" DOUBLE, 
	"Score_2" DOUBLE, 
...
-- Code For temporary table tmp_20180516113506_codegen_f85e6z_xgb_b6 part 2. Populate

INSERT INTO tmp_20180516113506_codegen_f85e6z_xgb_b6 WITH "DT_node_lookup_60" AS 
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", CASE WHEN ("ADS_sca_2_OUT".scaler_94 < 0.05711609870195389) THEN 1 ELSE 2 END AS node_id_2 
FROM tmp_20180516113506_codegen_634uqz_ads_sca_2_out AS "ADS_sca_2_OUT"), 
"DT_node_data_60" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE) AS "Score" 
...
-- Code For temporary table tmp_20180516113506_codegen_41vqae_xgb_sum part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180516113506_codegen_41vqae_xgb_sum (
	"KEY" BIGINT, 
	"Score_0" DOUBLE, 
	"Score_1" DOUBLE, 
	"Score_2" DOUBLE, 
...
-- Code For temporary table tmp_20180516113506_codegen_41vqae_xgb_sum part 2. Populate

INSERT INTO tmp_20180516113506_codegen_41vqae_xgb_sum WITH "XGB_Union" AS 
...
FROM tmp_20180516113506_codegen_sg8nrr_xgb_b0 AS "XGB_B0" UNION ALL SELECT "XGB_B1"."KEY" AS "KEY", "XGB_B1"."Score_0" AS "Score_0", "XGB_B1"."Score_1" AS "Score_1", "XGB_B1"."Score_2" AS "Score_2", "XGB_B1"."Score_3" AS "Score_3" 
FROM tmp_20180516113506_codegen_z1i905_xgb_b1 AS "XGB_B1" UNION ALL SELECT "XGB_B2"."KEY" AS "KEY", "XGB_B2"."Score_0" AS "Score_0", "XGB_B2"."Score_1" AS "Score_1", "XGB_B2"."Score_2" AS "Score_2", "XGB_B2"."Score_3" AS "Score_3" 
FROM tmp_20180516113506_codegen_r0euwn_xgb_b2 AS "XGB_B2" UNION ALL SELECT "XGB_B3"."KEY" AS "KEY", "XGB_B3"."Score_0" AS "Score_0", "XGB_B3"."Score_1" AS "Score_1", "XGB_B3"."Score_2" AS "Score_2", "XGB_B3"."Score_3" AS "Score_3" 
FROM tmp_20180516113506_codegen_aoyjg3_xgb_b3 AS "XGB_B3" UNION ALL SELECT "XGB_B4"."KEY" AS "KEY", "XGB_B4"."Score_0" AS "Score_0", "XGB_B4"."Score_1" AS "Score_1", "XGB_B4"."Score_2" AS "Score_2", "XGB_B4"."Score_3" AS "Score_3" 
FROM tmp_20180516113506_codegen_iy9o07_xgb_b4 AS "XGB_B4" UNION ALL SELECT "XGB_B5"."KEY" AS "KEY", "XGB_B5"."Score_0" AS "Score_0", "XGB_B5"."Score_1" AS "Score_1", "XGB_B5"."Score_2" AS "Score_2", "XGB_B5"."Score_3" AS "Score_3" 
FROM tmp_20180516113506_codegen_yd3hn5_xgb_b5 AS "XGB_B5" UNION ALL SELECT "XGB_B6"."KEY" AS "KEY", "XGB_B6"."Score_0" AS "Score_0", "XGB_B6"."Score_1" AS "Score_1", "XGB_B6"."Score_2" AS "Score_2", "XGB_B6"."Score_3" AS "Score_3" 
FROM tmp_20180516113506_codegen_f85e6z_xgb_b6 AS "XGB_B6") AS "XGB_EnsembleUnion")
...
FROM tmp_20180516113506_codegen_41vqae_xgb_sum AS "XGB_sum"), 
