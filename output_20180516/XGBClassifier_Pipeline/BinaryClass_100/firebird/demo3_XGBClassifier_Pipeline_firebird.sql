...
-- Code For temporary table TMP_20180602_2UO_ADS_IMP_1_OUT part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180602_2UO_ADS_IMP_1_OUT" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20180602_2UO_ADS_IMP_1_OUT part 3. Create Index 

CREATE INDEX "ix_TMP_20180602_2UO_ADS_ea53" ON "TMP_20180602_2UO_ADS_IMP_1_OUT" ("KEY")

-- Code For temporary table TMP_20180602_ML9_ADS_SCA_2_OUT part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180602_ML9_ADS_SCA_2_OUT" (
	"KEY" BIGINT NOT NULL, 
...
FROM "TMP_20180602_2UO_ADS_IMP_1_OUT" AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT") AS "U"

-- Code For temporary table TMP_20180602_ML9_ADS_SCA_2_OUT part 3. Create Index 

CREATE INDEX "ix_TMP_20180602_ML9_ADS_99a7" ON "TMP_20180602_ML9_ADS_SCA_2_OUT" ("KEY")

-- Code For temporary table TMP_20180602_KC8_XGB_B0 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180602_KC8_XGB_B0" (
	"KEY" BIGINT, 
...
-- Code For temporary table TMP_20180602_KC8_XGB_B0 part 2. Populate

INSERT INTO "TMP_20180602_KC8_XGB_B0" ("KEY", "Score_0") SELECT "U"."KEY", "U"."Score_0" 
FROM (WITH "DT_node_lookup" AS 
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", CASE WHEN ("ADS_sca_2_OUT".scaler_59 < -0.1959642767906189) THEN 1 ELSE 2 END AS node_id_2 
FROM "TMP_20180602_ML9_ADS_SCA_2_OUT" AS "ADS_sca_2_OUT"), 
"DT_node_data" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE PRECISION) AS "Score" 
FROM (SELECT 1 AS nid, -0.13636364042758942 AS "Score" FROM rdb$database UNION ALL SELECT 2 AS nid, 0.11818181723356247 AS "Score" FROM rdb$database) AS "Values"), 
"DT_Output" AS 
...
"DT_node_data_1" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE PRECISION) AS "Score" 
FROM (SELECT 0 AS nid, -0.008695119060575962 AS "Score" FROM rdb$database) AS "Values"), 
"DT_Output_1" AS 
...
"DT_node_data_2" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE PRECISION) AS "Score" 
FROM (SELECT 0 AS nid, -0.007867632433772087 AS "Score" FROM rdb$database) AS "Values"), 
"DT_Output_2" AS 
...
"DT_node_data_3" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE PRECISION) AS "Score" 
FROM (SELECT 0 AS nid, -0.007119080517441034 AS "Score" FROM rdb$database) AS "Values"), 
"DT_Output_3" AS 
...
"DT_node_data_4" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE PRECISION) AS "Score" 
FROM (SELECT 0 AS nid, -0.006441877223551273 AS "Score" FROM rdb$database) AS "Values"), 
"DT_Output_4" AS 
...
FROM "XGB_Model_0_4") AS "XGB_esu_0") AS "XGB_B0") AS "U"

-- Code For temporary table TMP_20180602_OH2_XGB_B1 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180602_OH2_XGB_B1" (
	"KEY" BIGINT, 
	"Score_0" DOUBLE PRECISION
)
...
-- Code For temporary table TMP_20180602_OH2_XGB_B1 part 2. Populate

INSERT INTO "TMP_20180602_OH2_XGB_B1" ("KEY", "Score_0") SELECT "U"."KEY", "U"."Score_0" 
FROM (WITH "DT_node_lookup_5" AS 
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", 0 AS node_id_2 
FROM "TMP_20180602_ML9_ADS_SCA_2_OUT" AS "ADS_sca_2_OUT"), 
"DT_node_data_5" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE PRECISION) AS "Score" 
FROM (SELECT 0 AS nid, -0.005829159170389175 AS "Score" FROM rdb$database) AS "Values"), 
"DT_Output_5" AS 
...
"DT_node_data_6" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE PRECISION) AS "Score" 
FROM (SELECT 0 AS nid, -0.0052747568115592 AS "Score" FROM rdb$database) AS "Values"), 
"DT_Output_6" AS 
...
"DT_node_data_7" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE PRECISION) AS "Score" 
FROM (SELECT 0 AS nid, -0.00477311247959733 AS "Score" FROM rdb$database) AS "Values"), 
"DT_Output_7" AS 
...
"DT_node_data_8" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE PRECISION) AS "Score" 
FROM (SELECT 0 AS nid, -0.004319168161600828 AS "Score" FROM rdb$database) AS "Values"), 
"DT_Output_8" AS 
...
"DT_node_data_9" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE PRECISION) AS "Score" 
FROM (SELECT 0 AS nid, -0.003908377606421709 AS "Score" FROM rdb$database) AS "Values"), 
"DT_Output_9" AS 
...
FROM (SELECT "XGB_Model_0_5"."KEY" AS "KEY", "XGB_Model_0_5"."Score_0" AS "Score_0" 
...
FROM "XGB_Model_0_9") AS "XGB_esu_1") AS "XGB_B1") AS "U"

-- Code For temporary table TMP_20180602_N5Z_XGB_B2 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180602_N5Z_XGB_B2" (
	"KEY" BIGINT, 
	"Score_0" DOUBLE PRECISION
)
...
-- Code For temporary table TMP_20180602_N5Z_XGB_B2 part 2. Populate

INSERT INTO "TMP_20180602_N5Z_XGB_B2" ("KEY", "Score_0") SELECT "U"."KEY", "U"."Score_0" 
FROM (WITH "DT_node_lookup_10" AS 
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", 0 AS node_id_2 
FROM "TMP_20180602_ML9_ADS_SCA_2_OUT" AS "ADS_sca_2_OUT"), 
"DT_node_data_10" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE PRECISION) AS "Score" 
FROM (SELECT 0 AS nid, -0.0035366646479815245 AS "Score" FROM rdb$database) AS "Values"), 
"DT_Output_10" AS 
...
"DT_node_data_11" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE PRECISION) AS "Score" 
FROM (SELECT 0 AS nid, -0.00320029235444963 AS "Score" FROM rdb$database) AS "Values"), 
"DT_Output_11" AS 
...
"DT_node_data_12" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE PRECISION) AS "Score" 
FROM (SELECT 0 AS nid, -0.0028958830516785383 AS "Score" FROM rdb$database) AS "Values"), 
"DT_Output_12" AS 
...
"DT_node_data_13" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE PRECISION) AS "Score" 
FROM (SELECT 0 AS nid, -0.0026204369496554136 AS "Score" FROM rdb$database) AS "Values"), 
"DT_Output_13" AS 
...
"DT_node_data_14" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE PRECISION) AS "Score" 
FROM (SELECT 0 AS nid, -0.002371155424043536 AS "Score" FROM rdb$database) AS "Values"), 
"DT_Output_14" AS 
...
FROM "DT_Output_14")
 SELECT "XGB_B2"."KEY", "XGB_B2"."Score_0" 
FROM (SELECT "XGB_esu_2"."KEY" AS "KEY", "XGB_esu_2"."Score_0" AS "Score_0" 
...
FROM "XGB_Model_0_14") AS "XGB_esu_2") AS "XGB_B2") AS "U"

-- Code For temporary table TMP_20180602_RQM_XGB_B3 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180602_RQM_XGB_B3" (
	"KEY" BIGINT, 
	"Score_0" DOUBLE PRECISION
)
...
-- Code For temporary table TMP_20180602_RQM_XGB_B3 part 2. Populate

INSERT INTO "TMP_20180602_RQM_XGB_B3" ("KEY", "Score_0") SELECT "U"."KEY", "U"."Score_0" 
FROM (WITH "DT_node_lookup_15" AS 
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", 0 AS node_id_2 
FROM "TMP_20180602_ML9_ADS_SCA_2_OUT" AS "ADS_sca_2_OUT"), 
"DT_node_data_15" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE PRECISION) AS "Score" 
FROM (SELECT 0 AS nid, -0.0021455788519233465 AS "Score" FROM rdb$database) AS "Values"), 
"DT_Output_15" AS 
...
FROM "DT_Output_15")
 SELECT "XGB_B3"."KEY", "XGB_B3"."Score_0" 
FROM (SELECT "XGB_esu_3"."KEY" AS "KEY", "XGB_esu_3"."Score_0" AS "Score_0" 
FROM (SELECT "XGB_Model_0_15"."KEY" AS "KEY", "XGB_Model_0_15"."Score_0" AS "Score_0" 
FROM "XGB_Model_0_15") AS "XGB_esu_3") AS "XGB_B3") AS "U"

-- Code For temporary table TMP_20180602_1O9_XGB_SUM part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180602_1O9_XGB_SUM" (
	"KEY" BIGINT NOT NULL, 
	"Score_0" DOUBLE PRECISION, 
	PRIMARY KEY ("KEY")
)
...
-- Code For temporary table TMP_20180602_1O9_XGB_SUM part 2. Populate

INSERT INTO "TMP_20180602_1O9_XGB_SUM" ("KEY", "Score_0") SELECT "U"."KEY", "U"."Score_0" 
...
FROM "TMP_20180602_KC8_XGB_B0" AS "XGB_B0" UNION ALL SELECT "XGB_B1"."KEY" AS "KEY", "XGB_B1"."Score_0" AS "Score_0" 
FROM "TMP_20180602_OH2_XGB_B1" AS "XGB_B1" UNION ALL SELECT "XGB_B2"."KEY" AS "KEY", "XGB_B2"."Score_0" AS "Score_0" 
FROM "TMP_20180602_N5Z_XGB_B2" AS "XGB_B2" UNION ALL SELECT "XGB_B3"."KEY" AS "KEY", "XGB_B3"."Score_0" AS "Score_0" 
FROM "TMP_20180602_RQM_XGB_B3" AS "XGB_B3") AS "XGB_EnsembleUnion")
...
-- Code For temporary table TMP_20180602_1O9_XGB_SUM part 3. Create Index 

CREATE INDEX "ix_TMP_20180602_1O9_XGB_SUM_KEY" ON "TMP_20180602_1O9_XGB_SUM" ("KEY")

-- Model deployment code

WITH orig_cte AS 
(SELECT "XGB_sum"."KEY" AS "KEY", "XGB_sum"."Score_0" AS "Score_0", CAST(NULL AS DOUBLE PRECISION) AS "Score_1", 1.0 - 1.0 / (1.0 + exp(CASE WHEN (minvalue(maxvalue(-100.0, -"XGB_sum"."Score_0"), 100.0) >= -709.782712893384) THEN minvalue(maxvalue(-100.0, -"XGB_sum"."Score_0"), 100.0) ELSE -709.782712893384 END)) AS "Proba_0", 1.0 / (1.0 + exp(CASE WHEN (minvalue(maxvalue(-100.0, -"XGB_sum"."Score_0"), 100.0) >= -709.782712893384) THEN minvalue(maxvalue(-100.0, -"XGB_sum"."Score_0"), 100.0) ELSE -709.782712893384 END)) AS "Proba_1", CAST(NULL AS DOUBLE PRECISION) AS "LogProba_0", CAST(NULL AS DOUBLE PRECISION) AS "LogProba_1", CAST(NULL AS BIGINT) AS "Decision", CAST(NULL AS DOUBLE PRECISION) AS "DecisionProba" 
FROM "TMP_20180602_1O9_XGB_SUM" AS "XGB_sum"), 
