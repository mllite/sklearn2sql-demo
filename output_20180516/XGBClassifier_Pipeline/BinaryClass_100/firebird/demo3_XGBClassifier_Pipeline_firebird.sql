...
-- Code For temporary table TMP_20180516_CODEGEN_G19AL7_ADS part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180516_CODEGEN_G19AL7_ADS" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20180516_CODEGEN_G19AL7_ADS part 3. Create Index 

CREATE INDEX "ix_TMP_20180516_CODEGEN_a0af" ON "TMP_20180516_CODEGEN_G19AL7_ADS" ("KEY")

-- Code For temporary table TMP_20180516_CODEGEN_0AZMPV_ADS part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180516_CODEGEN_0AZMPV_ADS" (
	"KEY" BIGINT NOT NULL, 
...
FROM "TMP_20180516_CODEGEN_G19AL7_ADS" AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT") AS "U"

-- Code For temporary table TMP_20180516_CODEGEN_0AZMPV_ADS part 3. Create Index 

CREATE INDEX "ix_TMP_20180516_CODEGEN_6329" ON "TMP_20180516_CODEGEN_0AZMPV_ADS" ("KEY")

-- Code For temporary table TMP_20180516_CODEGEN_BUE3LS_XGB part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180516_CODEGEN_BUE3LS_XGB" (
	"KEY" BIGINT, 
...
-- Code For temporary table TMP_20180516_CODEGEN_BUE3LS_XGB part 2. Populate

INSERT INTO "TMP_20180516_CODEGEN_BUE3LS_XGB" ("KEY", "Score_0") SELECT "U"."KEY", "U"."Score_0" 
FROM (WITH "DT_node_lookup" AS 
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", CASE WHEN ("ADS_sca_2_OUT".scaler_59 < -0.1959642767906189) THEN 1 ELSE 2 END AS node_id_2 
FROM "TMP_20180516_CODEGEN_0AZMPV_ADS" AS "ADS_sca_2_OUT"), 
"DT_node_data" AS 
...
-- Code For temporary table TMP_20180516_CODEGEN_X9DMJ2_XGB part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180516_CODEGEN_X9DMJ2_XGB" (
	"KEY" BIGINT, 
	"Score_0" DOUBLE PRECISION
)
...
-- Code For temporary table TMP_20180516_CODEGEN_X9DMJ2_XGB part 2. Populate

INSERT INTO "TMP_20180516_CODEGEN_X9DMJ2_XGB" ("KEY", "Score_0") SELECT "U"."KEY", "U"."Score_0" 
...
-- Code For temporary table TMP_20180516_CODEGEN_LSVHMC_XGB part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180516_CODEGEN_LSVHMC_XGB" (
	"KEY" BIGINT NOT NULL, 
	"Score_0" DOUBLE PRECISION, 
	PRIMARY KEY ("KEY")
)
...
-- Code For temporary table TMP_20180516_CODEGEN_LSVHMC_XGB part 2. Populate

INSERT INTO "TMP_20180516_CODEGEN_LSVHMC_XGB" ("KEY", "Score_0") SELECT "U"."KEY", "U"."Score_0" 
...
FROM "TMP_20180516_CODEGEN_BUE3LS_XGB" AS "XGB_B0" UNION ALL SELECT "XGB_B1"."KEY" AS "KEY", "XGB_B1"."Score_0" AS "Score_0" 
FROM "TMP_20180516_CODEGEN_X9DMJ2_XGB" AS "XGB_B1") AS "XGB_EnsembleUnion")
...
-- Code For temporary table TMP_20180516_CODEGEN_LSVHMC_XGB part 3. Create Index 

CREATE INDEX "ix_TMP_20180516_CODEGEN_5488" ON "TMP_20180516_CODEGEN_LSVHMC_XGB" ("KEY")
...
FROM "TMP_20180516_CODEGEN_LSVHMC_XGB" AS "XGB_sum"), 
