...
-- Code For temporary table TMP_20180508180600_CODEGEN_RZ2B part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508180600_CODEGEN_RZ2B" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20180508180600_CODEGEN_RZ2B part 3. Create Index 

CREATE INDEX "ix_TMP_20180508180600_C_50e6" ON "TMP_20180508180600_CODEGEN_RZ2B" ("KEY")

-- Code For temporary table TMP_20180508180600_CODEGEN_QJ8R part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508180600_CODEGEN_QJ8R" (
	"KEY" BIGINT NOT NULL, 
...
FROM "TMP_20180508180600_CODEGEN_RZ2B" AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT") AS "U"

-- Code For temporary table TMP_20180508180600_CODEGEN_QJ8R part 3. Create Index 

CREATE INDEX "ix_TMP_20180508180600_C_646c" ON "TMP_20180508180600_CODEGEN_QJ8R" ("KEY")

-- Code For temporary table TMP_20180508180600_CODEGEN_JBH5 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508180600_CODEGEN_JBH5" (
	"KEY" BIGINT, 
...
-- Code For temporary table TMP_20180508180600_CODEGEN_JBH5 part 2. Populate

INSERT INTO "TMP_20180508180600_CODEGEN_JBH5" ("KEY", "Score_0") SELECT "U"."KEY", "U"."Score_0" 
FROM (WITH "DT_node_lookup" AS 
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", CASE WHEN ("ADS_sca_2_OUT".scaler_59 < -0.1959642767906189) THEN 1 ELSE 2 END AS node_id_2 
FROM "TMP_20180508180600_CODEGEN_QJ8R" AS "ADS_sca_2_OUT"), 
"DT_node_data" AS 
...
-- Code For temporary table TMP_20180508180600_CODEGEN_T2SD part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508180600_CODEGEN_T2SD" (
	"KEY" BIGINT, 
	"Score_0" DOUBLE PRECISION
)
...
-- Code For temporary table TMP_20180508180600_CODEGEN_T2SD part 2. Populate

INSERT INTO "TMP_20180508180600_CODEGEN_T2SD" ("KEY", "Score_0") SELECT "U"."KEY", "U"."Score_0" 
...
-- Code For temporary table TMP_20180508180600_CODEGEN_JTSS part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508180600_CODEGEN_JTSS" (
	"KEY" BIGINT, 
	"Score_0" DOUBLE PRECISION
)
...
-- Code For temporary table TMP_20180508180600_CODEGEN_JTSS part 2. Populate

INSERT INTO "TMP_20180508180600_CODEGEN_JTSS" ("KEY", "Score_0") SELECT "U"."KEY", "U"."Score_0" 
...
FROM "TMP_20180508180600_CODEGEN_JBH5" AS "XGB_B0" UNION ALL SELECT "XGB_B1"."KEY" AS "KEY", "XGB_B1"."Score_0" AS "Score_0" 
FROM "TMP_20180508180600_CODEGEN_T2SD" AS "XGB_B1") AS "XGB_EnsembleUnion") AS "XGB_Union") AS "U"

-- Code For temporary table TMP_20180508180600_CODEGEN_3DHO part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508180600_CODEGEN_3DHO" (
	"KEY" BIGINT NOT NULL, 
	"Score_0" DOUBLE PRECISION, 
	PRIMARY KEY ("KEY")
)
...
-- Code For temporary table TMP_20180508180600_CODEGEN_3DHO part 2. Populate

INSERT INTO "TMP_20180508180600_CODEGEN_3DHO" ("KEY", "Score_0") SELECT "U"."KEY", "U"."Score_0" 
...
FROM "TMP_20180508180600_CODEGEN_JTSS" AS "XGB_Union" GROUP BY "XGB_Union"."KEY") AS "T") AS "XGB_sum") AS "U"

-- Code For temporary table TMP_20180508180600_CODEGEN_3DHO part 3. Create Index 

CREATE INDEX "ix_TMP_20180508180600_C_6339" ON "TMP_20180508180600_CODEGEN_3DHO" ("KEY")
...
FROM "TMP_20180508180600_CODEGEN_3DHO" AS "XGB_sum"), 
