...
-- Code For temporary table DEGEN_Q5FXC0_ADS_IMP_1_OUT part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "DEGEN_Q5FXC0_ADS_IMP_1_OUT" (
	"KEY" NUMBER(19), 
...
-- Code For temporary table DEGEN_US7WIP_ADS_SCA_2_OUT part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "DEGEN_US7WIP_ADS_SCA_2_OUT" (
	"KEY" NUMBER(19), 
...
FROM "DEGEN_Q5FXC0_ADS_IMP_1_OUT" "ADS_imp_1_OUT") "ADS_sca_2_OUT") "U"

-- Code For temporary table 0516_CODEGEN_V6JSV0_XGB_B0 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "0516_CODEGEN_V6JSV0_XGB_B0" (
	"KEY" NUMBER(19), 
...
-- Code For temporary table 0516_CODEGEN_V6JSV0_XGB_B0 part 2. Populate

INSERT INTO "0516_CODEGEN_V6JSV0_XGB_B0" ("KEY", "Score_0") SELECT "U"."KEY", "U"."Score_0" 
FROM (WITH "DT_node_lookup" AS 
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", CASE WHEN ("ADS_sca_2_OUT".scaler_59 < -0.1959642767906189) THEN 1 ELSE 2 END AS node_id_2 
FROM "DEGEN_US7WIP_ADS_SCA_2_OUT" "ADS_sca_2_OUT"), 
"DT_node_data" AS 
...
-- Code For temporary table 0516_CODEGEN_N5NJSV_XGB_B1 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "0516_CODEGEN_N5NJSV_XGB_B1" (
	"KEY" NUMBER(19), 
	"Score_0" BINARY_DOUBLE
)
...
-- Code For temporary table 0516_CODEGEN_N5NJSV_XGB_B1 part 2. Populate

INSERT INTO "0516_CODEGEN_N5NJSV_XGB_B1" ("KEY", "Score_0") SELECT "U"."KEY", "U"."Score_0" 
...
-- Code For temporary table 516_CODEGEN_VE766P_XGB_SUM part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "516_CODEGEN_VE766P_XGB_SUM" (
	"KEY" NUMBER(19), 
	"Score_0" BINARY_DOUBLE
)
...
-- Code For temporary table 516_CODEGEN_VE766P_XGB_SUM part 2. Populate

INSERT INTO "516_CODEGEN_VE766P_XGB_SUM" ("KEY", "Score_0") SELECT "U"."KEY", "U"."Score_0" 
...
FROM "0516_CODEGEN_V6JSV0_XGB_B0" "XGB_B0" UNION ALL SELECT "XGB_B1"."KEY" AS "KEY", "XGB_B1"."Score_0" AS "Score_0" 
FROM "0516_CODEGEN_N5NJSV_XGB_B1" "XGB_B1") "XGB_EnsembleUnion")
...
FROM "516_CODEGEN_VE766P_XGB_SUM" "XGB_sum"), 
