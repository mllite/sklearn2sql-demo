...
FROM `tmp_20180516111358_codegen_29uqtw_ads_imp_1_out` AS `ADS_imp_1_OUT`) AS `ADS_sca_2_OUT`

-- Code For temporary table tmp_20180516111358_codegen_ikf913_ads_sca_2_out part 2. Populate

SELECT * FROM `tmp_20180516111358_codegen_ikf913_ads_sca_2_out`

-- Code For temporary table tmp_20180516111358_codegen_vvmc02_xgb_b0 part 1. Create 

CREATE TEMPORARY TABLE `tmp_20180516111358_codegen_vvmc02_xgb_b0` STORED AS ORC AS WITH `DT_node_lookup` AS 
(SELECT `ADS_sca_2_OUT`.`KEY` AS `KEY`, CASE WHEN (`ADS_sca_2_OUT`.`scaler_59` < -0.1959642767906189) THEN 1 ELSE 2 END AS `node_id_2` 
FROM `tmp_20180516111358_codegen_ikf913_ads_sca_2_out` AS `ADS_sca_2_OUT`), 
`DT_node_data` AS 
...
-- Code For temporary table tmp_20180516111358_codegen_vvmc02_xgb_b0 part 2. Populate

SELECT * FROM `tmp_20180516111358_codegen_vvmc02_xgb_b0`

-- Code For temporary table tmp_20180516111358_codegen_2xeako_xgb_b1 part 1. Create 

CREATE TEMPORARY TABLE `tmp_20180516111358_codegen_2xeako_xgb_b1` STORED AS ORC AS WITH `DT_node_lookup_10` AS 
(SELECT `ADS_sca_2_OUT`.`KEY` AS `KEY`, 0 AS `node_id_2` 
FROM `tmp_20180516111358_codegen_ikf913_ads_sca_2_out` AS `ADS_sca_2_OUT`), 
`DT_node_data_10` AS 
(SELECT `Values`.`nid` AS `nid`, CAST(`Values`.`Score` AS DOUBLE) AS `Score` 
...
-- Code For temporary table tmp_20180516111358_codegen_2xeako_xgb_b1 part 2. Populate

SELECT * FROM `tmp_20180516111358_codegen_2xeako_xgb_b1`

-- Code For temporary table tmp_20180516111358_codegen_neguhp_xgb_sum part 1. Create 

CREATE TEMPORARY TABLE `tmp_20180516111358_codegen_neguhp_xgb_sum` STORED AS ORC AS WITH `XGB_Union` AS 
...
FROM `tmp_20180516111358_codegen_vvmc02_xgb_b0` AS `XGB_B0` UNION ALL SELECT `XGB_B1`.`KEY` AS `KEY`, `XGB_B1`.`Score_0` AS `Score_0` 
FROM `tmp_20180516111358_codegen_2xeako_xgb_b1` AS `XGB_B1`) AS `XGB_EnsembleUnion`)
...
-- Code For temporary table tmp_20180516111358_codegen_neguhp_xgb_sum part 2. Populate

SELECT * FROM `tmp_20180516111358_codegen_neguhp_xgb_sum`
...
FROM `tmp_20180516111358_codegen_neguhp_xgb_sum` AS `XGB_sum`), 
