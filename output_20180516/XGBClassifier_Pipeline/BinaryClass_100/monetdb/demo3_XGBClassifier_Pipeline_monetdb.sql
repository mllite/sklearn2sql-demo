...
-- Code For temporary table tmp_20180508180559_codegen_ad2vjr_ads_imp_1_out part 1. Create 


CREATE TEMPORARY TABLE tmp_20180508180559_codegen_ad2vjr_ads_imp_1_out (
	"KEY" BIGINT, 
	impter_2 DOUBLE, 
	impter_3 DOUBLE, 
	impter_4 DOUBLE, 
...
-- Code For temporary table tmp_20180508180559_codegen_sfnmhf_ads_sca_2_out part 1. Create 


CREATE TEMPORARY TABLE tmp_20180508180559_codegen_sfnmhf_ads_sca_2_out (
	"KEY" BIGINT, 
	scaler_2 DOUBLE, 
	scaler_3 DOUBLE, 
	scaler_4 DOUBLE, 
...
FROM tmp_20180508180559_codegen_ad2vjr_ads_imp_1_out AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT") AS "U"

-- Code For temporary table tmp_20180508180559_codegen_c96xhi_xgb_b0 part 1. Create 


CREATE TEMPORARY TABLE tmp_20180508180559_codegen_c96xhi_xgb_b0 (
	"KEY" BIGINT, 
	"Score_0" DOUBLE
)
...
-- Code For temporary table tmp_20180508180559_codegen_c96xhi_xgb_b0 part 2. Populate

INSERT INTO tmp_20180508180559_codegen_c96xhi_xgb_b0 ("KEY", "Score_0") SELECT "U"."KEY", "U"."Score_0" 
FROM (WITH "DT_node_lookup" AS 
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", CASE WHEN ("ADS_sca_2_OUT".scaler_59 < -0.1959642767906189) THEN 1 ELSE 2 END AS node_id_2 
FROM tmp_20180508180559_codegen_sfnmhf_ads_sca_2_out AS "ADS_sca_2_OUT"), 
"DT_node_data" AS 
...
-- Code For temporary table tmp_20180508180559_codegen_d0nvsf_xgb_b1 part 1. Create 


CREATE TEMPORARY TABLE tmp_20180508180559_codegen_d0nvsf_xgb_b1 (
	"KEY" BIGINT, 
	"Score_0" DOUBLE
)
...
-- Code For temporary table tmp_20180508180559_codegen_d0nvsf_xgb_b1 part 2. Populate

INSERT INTO tmp_20180508180559_codegen_d0nvsf_xgb_b1 ("KEY", "Score_0") SELECT "U"."KEY", "U"."Score_0" 
...
-- Code For temporary table tmp_20180508180559_codegen_el50co_xgb_union part 1. Create 


CREATE TEMPORARY TABLE tmp_20180508180559_codegen_el50co_xgb_union (
	"KEY" BIGINT, 
	"Score_0" DOUBLE
)
...
-- Code For temporary table tmp_20180508180559_codegen_el50co_xgb_union part 2. Populate

INSERT INTO tmp_20180508180559_codegen_el50co_xgb_union ("KEY", "Score_0") SELECT "U"."KEY", "U"."Score_0" 
...
FROM tmp_20180508180559_codegen_c96xhi_xgb_b0 AS "XGB_B0" UNION ALL SELECT "XGB_B1"."KEY" AS "KEY", "XGB_B1"."Score_0" AS "Score_0" 
FROM tmp_20180508180559_codegen_d0nvsf_xgb_b1 AS "XGB_B1") AS "XGB_EnsembleUnion") AS "XGB_Union") AS "U"

-- Code For temporary table tmp_20180508180559_codegen_gigss2_xgb_sum part 1. Create 


CREATE TEMPORARY TABLE tmp_20180508180559_codegen_gigss2_xgb_sum (
	"KEY" BIGINT, 
	"Score_0" DOUBLE
)
...
-- Code For temporary table tmp_20180508180559_codegen_gigss2_xgb_sum part 2. Populate

INSERT INTO tmp_20180508180559_codegen_gigss2_xgb_sum ("KEY", "Score_0") SELECT "U"."KEY", "U"."Score_0" 
...
FROM tmp_20180508180559_codegen_el50co_xgb_union AS "XGB_Union" GROUP BY "XGB_Union"."KEY") AS "T") AS "XGB_sum") AS "U"
...
FROM tmp_20180508180559_codegen_gigss2_xgb_sum AS "XGB_sum"), 
