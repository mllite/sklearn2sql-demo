...
-- Code For temporary table tmp_20180516111519_codegen_qssq9b_ads_imp_1_out part 1. Create 


CREATE TABLE tmp_20180516111519_codegen_qssq9b_ads_imp_1_out (
	`KEY` BIGINT, 
	impter_2 DOUBLE, 
	impter_3 DOUBLE, 
	impter_4 DOUBLE, 
...
-- Code For temporary table tmp_20180516111519_codegen_c672kz_ads_sca_2_out part 1. Create 


CREATE TABLE tmp_20180516111519_codegen_c672kz_ads_sca_2_out (
	`KEY` BIGINT, 
	scaler_2 DOUBLE, 
	scaler_3 DOUBLE, 
	scaler_4 DOUBLE, 
...
FROM tmp_20180516111519_codegen_qssq9b_ads_imp_1_out AS `ADS_imp_1_OUT`) AS `ADS_sca_2_OUT`

-- Code For temporary table tmp_20180516111519_codegen_1gzn1u_calprob_b0 part 1. Create 


CREATE TABLE tmp_20180516111519_codegen_1gzn1u_calprob_b0 (
	`KEY` BIGINT, 
	`Proba_1` DOUBLE, 
	`Proba_0` DOUBLE
)
...
-- Code For temporary table tmp_20180516111519_codegen_1gzn1u_calprob_b0 part 2. Populate
...
FROM tmp_20180516111519_codegen_c672kz_ads_sca_2_out AS `ADS_sca_2_OUT`), 
`DT_node_data` AS 
...
FROM isotonic_cte_3)
 INSERT INTO tmp_20180516111519_codegen_1gzn1u_calprob_b0 (`KEY`, `Proba_1`, `Proba_0`) SELECT `CalProb_B0`.`KEY`, `CalProb_B0`.`Proba_1`, `CalProb_B0`.`Proba_0` 
...
-- Code For temporary table tmp_20180516111519_codegen_39ijgw_calprob_avg part 1. Create 


CREATE TABLE tmp_20180516111519_codegen_39ijgw_calprob_avg (
	`KEY` BIGINT, 
	`Proba_1` DOUBLE, 
	`Proba_0` DOUBLE
)
...
-- Code For temporary table tmp_20180516111519_codegen_39ijgw_calprob_avg part 2. Populate
...
FROM tmp_20180516111519_codegen_1gzn1u_calprob_b0 AS `CalProb_B0`) AS `CalProb_EnsembleUnion`)
 INSERT INTO tmp_20180516111519_codegen_39ijgw_calprob_avg (`KEY`, `Proba_1`, `Proba_0`) SELECT `CalProb_avg`.`KEY`, `CalProb_avg`.`Proba_1`, `CalProb_avg`.`Proba_0` 
...
FROM tmp_20180516111519_codegen_39ijgw_calprob_avg AS `CalProb_avg`), 
