...
-- Code For temporary table tmp_20180508180657_codegen_faesw8_ads_imp_1_out part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180508180657_codegen_faesw8_ads_imp_1_out  (
	"KEY" BIGINT, 
...
-- Code For temporary table tmp_20180508180657_codegen_faesw8_ads_imp_1_out part 2. Populate

INSERT INTO tmp_20180508180657_codegen_faesw8_ads_imp_1_out ("KEY", impter_2, impter_3, impter_4, impter_5, impter_6, impter_7, impter_8, impter_9, impter_10, impter_11, impter_12, impter_13, impter_14, impter_15, impter_16, impter_17, impter_18, impter_19, impter_20, impter_21, impter_22, impter_23, impter_24, impter_25, impter_26, impter_27, impter_28, impter_29, impter_30, impter_31) SELECT "U"."KEY", "U".impter_2, "U".impter_3, "U".impter_4, "U".impter_5, "U".impter_6, "U".impter_7, "U".impter_8, "U".impter_9, "U".impter_10, "U".impter_11, "U".impter_12, "U".impter_13, "U".impter_14, "U".impter_15, "U".impter_16, "U".impter_17, "U".impter_18, "U".impter_19, "U".impter_20, "U".impter_21, "U".impter_22, "U".impter_23, "U".impter_24, "U".impter_25, "U".impter_26, "U".impter_27, "U".impter_28, "U".impter_29, "U".impter_30, "U".impter_31 
...
-- Code For temporary table tmp_20180508180657_codegen_2n4ug8_ads_sca_2_out part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180508180657_codegen_2n4ug8_ads_sca_2_out  (
	"KEY" BIGINT, 
...
FROM tmp_20180508180657_codegen_faesw8_ads_imp_1_out AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT") AS "U"

-- Code For temporary table tmp_20180508180657_codegen_ga17jz_calprob_b0 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180508180657_codegen_ga17jz_calprob_b0  (
	"KEY" BIGINT, 
...
-- Code For temporary table tmp_20180508180657_codegen_ga17jz_calprob_b0 part 2. Populate

INSERT INTO tmp_20180508180657_codegen_ga17jz_calprob_b0 ("KEY", "Proba_1", "Proba_0") SELECT "U"."KEY", "U"."Proba_1", "U"."Proba_0" 
...
FROM tmp_20180508180657_codegen_2n4ug8_ads_sca_2_out AS "ADS_sca_2_OUT"), 
dummy_cte AS 
...
FROM "DT_Output"), 
isotonic_cte_0 AS 
(SELECT "Calibrated_Model_0"."KEY" AS "KEY", CASE WHEN ("Calibrated_Model_0"."ScoreOrProba_1" < CAST(0.0 AS DOUBLE PRECISION)) THEN CAST(0.05 AS DOUBLE PRECISION) WHEN ("Calibrated_Model_0"."ScoreOrProba_1" < CAST(1.0 AS DOUBLE PRECISION)) THEN ("Calibrated_Model_0"."ScoreOrProba_1" - CAST(0.0 AS DOUBLE PRECISION)) * CAST(0.922972972972973 AS DOUBLE PRECISION) + CAST(0.05 AS DOUBLE PRECISION) ELSE CAST(0.972972972972973 AS DOUBLE PRECISION) END AS "Proba_1", CAST(1.0 AS DOUBLE PRECISION) - CASE WHEN ("Calibrated_Model_0"."ScoreOrProba_1" < CAST(0.0 AS DOUBLE PRECISION)) THEN CAST(0.05 AS DOUBLE PRECISION) WHEN ("Calibrated_Model_0"."ScoreOrProba_1" < CAST(1.0 AS DOUBLE PRECISION)) THEN ("Calibrated_Model_0"."ScoreOrProba_1" - CAST(0.0 AS DOUBLE PRECISION)) * CAST(0.922972972972973 AS DOUBLE PRECISION) + CAST(0.05 AS DOUBLE PRECISION) ELSE CAST(0.972972972972973 AS DOUBLE PRECISION) END AS "Proba_0" 
...
FROM "DT_Output_1"), 
isotonic_cte_1 AS 
(SELECT "Calibrated_Model_1"."KEY" AS "KEY", CASE WHEN ("Calibrated_Model_1"."ScoreOrProba_1" < CAST(0.0 AS DOUBLE PRECISION)) THEN CAST(0.076923076923077 AS DOUBLE PRECISION) WHEN ("Calibrated_Model_1"."ScoreOrProba_1" < CAST(0.333333333333333 AS DOUBLE PRECISION)) THEN ("Calibrated_Model_1"."ScoreOrProba_1" - CAST(0.0 AS DOUBLE PRECISION)) * CAST(2.685897435897436 AS DOUBLE PRECISION) + CAST(0.076923076923077 AS DOUBLE PRECISION) WHEN ("Calibrated_Model_1"."ScoreOrProba_1" < CAST(1.0 AS DOUBLE PRECISION)) THEN ("Calibrated_Model_1"."ScoreOrProba_1" - CAST(0.333333333333333 AS DOUBLE PRECISION)) * CAST(0.0 AS DOUBLE PRECISION) + CAST(0.972222222222222 AS DOUBLE PRECISION) ELSE CAST(0.972222222222222 AS DOUBLE PRECISION) END AS "Proba_1", CAST(1.0 AS DOUBLE PRECISION) - CASE WHEN ("Calibrated_Model_1"."ScoreOrProba_1" < CAST(0.0 AS DOUBLE PRECISION)) THEN CAST(0.076923076923077 AS DOUBLE PRECISION) WHEN ("Calibrated_Model_1"."ScoreOrProba_1" < CAST(0.333333333333333 AS DOUBLE PRECISION)) THEN ("Calibrated_Model_1"."ScoreOrProba_1" - CAST(0.0 AS DOUBLE PRECISION)) * CAST(2.685897435897436 AS DOUBLE PRECISION) + CAST(0.076923076923077 AS DOUBLE PRECISION) WHEN ("Calibrated_Model_1"."ScoreOrProba_1" < CAST(1.0 AS DOUBLE PRECISION)) THEN ("Calibrated_Model_1"."ScoreOrProba_1" - CAST(0.333333333333333 AS DOUBLE PRECISION)) * CAST(0.0 AS DOUBLE PRECISION) + CAST(0.972222222222222 AS DOUBLE PRECISION) ELSE CAST(0.972222222222222 AS DOUBLE PRECISION) END AS "Proba_0" 
...
FROM "DT_Output_2"), 
isotonic_cte_2 AS 
(SELECT "Calibrated_Model_2"."KEY" AS "KEY", CASE WHEN ("Calibrated_Model_2"."ScoreOrProba_1" < CAST(0.0 AS DOUBLE PRECISION)) THEN CAST(0.073170731707317 AS DOUBLE PRECISION) WHEN ("Calibrated_Model_2"."ScoreOrProba_1" < CAST(0.933333333333333 AS DOUBLE PRECISION)) THEN ("Calibrated_Model_2"."ScoreOrProba_1" - CAST(0.0 AS DOUBLE PRECISION)) * CAST(0.97794081562546 AS DOUBLE PRECISION) + CAST(0.073170731707317 AS DOUBLE PRECISION) WHEN ("Calibrated_Model_2"."ScoreOrProba_1" < CAST(1.0 AS DOUBLE PRECISION)) THEN ("Calibrated_Model_2"."ScoreOrProba_1" - CAST(0.933333333333333 AS DOUBLE PRECISION)) * CAST(0.0 AS DOUBLE PRECISION) + CAST(0.985915492957746 AS DOUBLE PRECISION) ELSE CAST(0.985915492957746 AS DOUBLE PRECISION) END AS "Proba_1", CAST(1.0 AS DOUBLE PRECISION) - CASE WHEN ("Calibrated_Model_2"."ScoreOrProba_1" < CAST(0.0 AS DOUBLE PRECISION)) THEN CAST(0.073170731707317 AS DOUBLE PRECISION) WHEN ("Calibrated_Model_2"."ScoreOrProba_1" < CAST(0.933333333333333 AS DOUBLE PRECISION)) THEN ("Calibrated_Model_2"."ScoreOrProba_1" - CAST(0.0 AS DOUBLE PRECISION)) * CAST(0.97794081562546 AS DOUBLE PRECISION) + CAST(0.073170731707317 AS DOUBLE PRECISION) WHEN ("Calibrated_Model_2"."ScoreOrProba_1" < CAST(1.0 AS DOUBLE PRECISION)) THEN ("Calibrated_Model_2"."ScoreOrProba_1" - CAST(0.933333333333333 AS DOUBLE PRECISION)) * CAST(0.0 AS DOUBLE PRECISION) + CAST(0.985915492957746 AS DOUBLE PRECISION) ELSE CAST(0.985915492957746 AS DOUBLE PRECISION) END AS "Proba_0" 
...
FROM "DT_Output_3"), 
isotonic_cte_3 AS 
(SELECT "Calibrated_Model_3"."KEY" AS "KEY", CASE WHEN ("Calibrated_Model_3"."ScoreOrProba_1" < CAST(0.0 AS DOUBLE PRECISION)) THEN CAST(0.097560975609756 AS DOUBLE PRECISION) WHEN ("Calibrated_Model_3"."ScoreOrProba_1" < CAST(0.952380952380952 AS DOUBLE PRECISION)) THEN ("Calibrated_Model_3"."ScoreOrProba_1" - CAST(0.0 AS DOUBLE PRECISION)) * CAST(0.597560975609756 AS DOUBLE PRECISION) + CAST(0.097560975609756 AS DOUBLE PRECISION) WHEN ("Calibrated_Model_3"."ScoreOrProba_1" < CAST(1.0 AS DOUBLE PRECISION)) THEN ("Calibrated_Model_3"."ScoreOrProba_1" - CAST(0.952380952380952 AS DOUBLE PRECISION)) * CAST(6.681818181818175 AS DOUBLE PRECISION) + CAST(0.666666666666667 AS DOUBLE PRECISION) ELSE CAST(0.984848484848485 AS DOUBLE PRECISION) END AS "Proba_1", CAST(1.0 AS DOUBLE PRECISION) - CASE WHEN ("Calibrated_Model_3"."ScoreOrProba_1" < CAST(0.0 AS DOUBLE PRECISION)) THEN CAST(0.097560975609756 AS DOUBLE PRECISION) WHEN ("Calibrated_Model_3"."ScoreOrProba_1" < CAST(0.952380952380952 AS DOUBLE PRECISION)) THEN ("Calibrated_Model_3"."ScoreOrProba_1" - CAST(0.0 AS DOUBLE PRECISION)) * CAST(0.597560975609756 AS DOUBLE PRECISION) + CAST(0.097560975609756 AS DOUBLE PRECISION) WHEN ("Calibrated_Model_3"."ScoreOrProba_1" < CAST(1.0 AS DOUBLE PRECISION)) THEN ("Calibrated_Model_3"."ScoreOrProba_1" - CAST(0.952380952380952 AS DOUBLE PRECISION)) * CAST(6.681818181818175 AS DOUBLE PRECISION) + CAST(0.666666666666667 AS DOUBLE PRECISION) ELSE CAST(0.984848484848485 AS DOUBLE PRECISION) END AS "Proba_0" 
...
-- Code For temporary table tmp_20180508180657_codegen_oex5lm_calprob_union part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180508180657_codegen_oex5lm_calprob_union  (
	"KEY" BIGINT, 
	"Proba_1" DOUBLE PRECISION, 
	"Proba_0" DOUBLE PRECISION
)
...
-- Code For temporary table tmp_20180508180657_codegen_oex5lm_calprob_union part 2. Populate

INSERT INTO tmp_20180508180657_codegen_oex5lm_calprob_union ("KEY", "Proba_1", "Proba_0") SELECT "U"."KEY", "U"."Proba_1", "U"."Proba_0" 
...
FROM tmp_20180508180657_codegen_ga17jz_calprob_b0 AS "CalProb_B0") AS "CalProb_EnsembleUnion") AS "CalProb_Union") AS "U"

-- Code For temporary table tmp_20180508180657_codegen_qxcs75_calprob_avg part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180508180657_codegen_qxcs75_calprob_avg  (
	"KEY" BIGINT, 
	"Proba_1" DOUBLE PRECISION, 
	"Proba_0" DOUBLE PRECISION
)
...
-- Code For temporary table tmp_20180508180657_codegen_qxcs75_calprob_avg part 2. Populate

INSERT INTO tmp_20180508180657_codegen_qxcs75_calprob_avg ("KEY", "Proba_1", "Proba_0") SELECT "U"."KEY", "U"."Proba_1", "U"."Proba_0" 
...
FROM tmp_20180508180657_codegen_oex5lm_calprob_union AS "CalProb_Union" GROUP BY "CalProb_Union"."KEY") AS "T") AS "CalProb_avg") AS "U"
...
FROM tmp_20180508180657_codegen_qxcs75_calprob_avg AS "CalProb_avg"), 
