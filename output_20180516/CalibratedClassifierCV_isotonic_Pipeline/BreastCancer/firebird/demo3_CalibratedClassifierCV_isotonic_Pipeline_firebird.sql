...
-- Code For temporary table TMP_20180516_CODEGEN_1YJMYA_ADS part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180516_CODEGEN_1YJMYA_ADS" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20180516_CODEGEN_1YJMYA_ADS part 3. Create Index 

CREATE INDEX "ix_TMP_20180516_CODEGEN_7e60" ON "TMP_20180516_CODEGEN_1YJMYA_ADS" ("KEY")

-- Code For temporary table TMP_20180516_CODEGEN_YUD5D5_ADS part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180516_CODEGEN_YUD5D5_ADS" (
	"KEY" BIGINT NOT NULL, 
...
FROM "TMP_20180516_CODEGEN_1YJMYA_ADS" AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT") AS "U"

-- Code For temporary table TMP_20180516_CODEGEN_YUD5D5_ADS part 3. Create Index 

CREATE INDEX "ix_TMP_20180516_CODEGEN_e9af" ON "TMP_20180516_CODEGEN_YUD5D5_ADS" ("KEY")

-- Code For temporary table TMP_20180516_CODEGEN_6LQN7Q_CAL part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180516_CODEGEN_6LQN7Q_CAL" (
	"KEY" BIGINT, 
...
-- Code For temporary table TMP_20180516_CODEGEN_6LQN7Q_CAL part 2. Populate

INSERT INTO "TMP_20180516_CODEGEN_6LQN7Q_CAL" ("KEY", "Proba_1", "Proba_0") SELECT "U"."KEY", "U"."Proba_1", "U"."Proba_0" 
...
FROM "TMP_20180516_CODEGEN_YUD5D5_ADS" AS "ADS_sca_2_OUT"), 
"DT_node_data" AS 
...
-- Code For temporary table TMP_20180516_CODEGEN_QJ6GY8_CAL part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180516_CODEGEN_QJ6GY8_CAL" (
	"KEY" BIGINT NOT NULL, 
	"Proba_1" DOUBLE PRECISION, 
	"Proba_0" DOUBLE PRECISION, 
	PRIMARY KEY ("KEY")
...
-- Code For temporary table TMP_20180516_CODEGEN_QJ6GY8_CAL part 2. Populate

INSERT INTO "TMP_20180516_CODEGEN_QJ6GY8_CAL" ("KEY", "Proba_1", "Proba_0") SELECT "U"."KEY", "U"."Proba_1", "U"."Proba_0" 
...
FROM "TMP_20180516_CODEGEN_6LQN7Q_CAL" AS "CalProb_B0") AS "CalProb_EnsembleUnion")
...
-- Code For temporary table TMP_20180516_CODEGEN_QJ6GY8_CAL part 3. Create Index 

CREATE INDEX "ix_TMP_20180516_CODEGEN_223e" ON "TMP_20180516_CODEGEN_QJ6GY8_CAL" ("KEY")
...
FROM "TMP_20180516_CODEGEN_QJ6GY8_CAL" AS "CalProb_avg"), 
