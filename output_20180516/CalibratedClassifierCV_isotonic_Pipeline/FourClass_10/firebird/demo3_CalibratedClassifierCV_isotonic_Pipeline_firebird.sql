...
-- Code For temporary table TMP_20180516_CODEGEN_MRUN82_ADS part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180516_CODEGEN_MRUN82_ADS" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20180516_CODEGEN_MRUN82_ADS part 2. Populate

INSERT INTO "TMP_20180516_CODEGEN_MRUN82_ADS" ("KEY", impter_2, impter_3, impter_4, impter_5, impter_6, impter_7, impter_8, impter_9, impter_10, impter_11) SELECT "U"."KEY", "U".impter_2, "U".impter_3, "U".impter_4, "U".impter_5, "U".impter_6, "U".impter_7, "U".impter_8, "U".impter_9, "U".impter_10, "U".impter_11 
...
-- Code For temporary table TMP_20180516_CODEGEN_MRUN82_ADS part 3. Create Index 

CREATE INDEX "ix_TMP_20180516_CODEGEN_ebef" ON "TMP_20180516_CODEGEN_MRUN82_ADS" ("KEY")

-- Code For temporary table TMP_20180516_CODEGEN_2Y3SQD_ADS part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180516_CODEGEN_2Y3SQD_ADS" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20180516_CODEGEN_2Y3SQD_ADS part 2. Populate

INSERT INTO "TMP_20180516_CODEGEN_2Y3SQD_ADS" ("KEY", scaler_2, scaler_3, scaler_4, scaler_5, scaler_6, scaler_7, scaler_8, scaler_9, scaler_10, scaler_11) SELECT "U"."KEY", "U".scaler_2, "U".scaler_3, "U".scaler_4, "U".scaler_5, "U".scaler_6, "U".scaler_7, "U".scaler_8, "U".scaler_9, "U".scaler_10, "U".scaler_11 
...
FROM "TMP_20180516_CODEGEN_MRUN82_ADS" AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT") AS "U"

-- Code For temporary table TMP_20180516_CODEGEN_2Y3SQD_ADS part 3. Create Index 

CREATE INDEX "ix_TMP_20180516_CODEGEN_2708" ON "TMP_20180516_CODEGEN_2Y3SQD_ADS" ("KEY")

-- Code For temporary table TMP_20180516_CODEGEN_DRNOMK_CAL part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180516_CODEGEN_DRNOMK_CAL" (
	"KEY" BIGINT, 
...
-- Code For temporary table TMP_20180516_CODEGEN_DRNOMK_CAL part 2. Populate

INSERT INTO "TMP_20180516_CODEGEN_DRNOMK_CAL" ("KEY", "Proba_0", "Proba_1", "Proba_2", "Proba_3") SELECT "U"."KEY", "U"."Proba_0", "U"."Proba_1", "U"."Proba_2", "U"."Proba_3" 
...
FROM "TMP_20180516_CODEGEN_2Y3SQD_ADS" AS "ADS_sca_2_OUT"), 
"DT_node_data" AS 
...
-- Code For temporary table TMP_20180516_CODEGEN_K8AAVG_CAL part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180516_CODEGEN_K8AAVG_CAL" (
	"KEY" BIGINT NOT NULL, 
	"Proba_0" DOUBLE PRECISION, 
	"Proba_1" DOUBLE PRECISION, 
	"Proba_2" DOUBLE PRECISION, 
...
-- Code For temporary table TMP_20180516_CODEGEN_K8AAVG_CAL part 2. Populate

INSERT INTO "TMP_20180516_CODEGEN_K8AAVG_CAL" ("KEY", "Proba_0", "Proba_1", "Proba_2", "Proba_3") SELECT "U"."KEY", "U"."Proba_0", "U"."Proba_1", "U"."Proba_2", "U"."Proba_3" 
...
FROM "TMP_20180516_CODEGEN_DRNOMK_CAL" AS "CalProb_B0") AS "CalProb_EnsembleUnion")
...
-- Code For temporary table TMP_20180516_CODEGEN_K8AAVG_CAL part 3. Create Index 

CREATE INDEX "ix_TMP_20180516_CODEGEN_25e9" ON "TMP_20180516_CODEGEN_K8AAVG_CAL" ("KEY")
...
FROM "TMP_20180516_CODEGEN_K8AAVG_CAL" AS "CalProb_avg"), 
