...
-- Code For temporary table TMP_20180516_CODEGEN_3XUSPR_ADS part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180516_CODEGEN_3XUSPR_ADS" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20180516_CODEGEN_3XUSPR_ADS part 3. Create Index 

CREATE INDEX "ix_TMP_20180516_CODEGEN_6db0" ON "TMP_20180516_CODEGEN_3XUSPR_ADS" ("KEY")

-- Code For temporary table TMP_20180516_CODEGEN_A2AF9X_ADS part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180516_CODEGEN_A2AF9X_ADS" (
	"KEY" BIGINT NOT NULL, 
...
FROM "TMP_20180516_CODEGEN_3XUSPR_ADS" AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT") AS "U"

-- Code For temporary table TMP_20180516_CODEGEN_A2AF9X_ADS part 3. Create Index 

CREATE INDEX "ix_TMP_20180516_CODEGEN_9569" ON "TMP_20180516_CODEGEN_A2AF9X_ADS" ("KEY")

-- Code For temporary table TMP_20180516_CODEGEN_L8PLPL_CAL part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180516_CODEGEN_L8PLPL_CAL" (
	"KEY" BIGINT, 
...
-- Code For temporary table TMP_20180516_CODEGEN_L8PLPL_CAL part 2. Populate

INSERT INTO "TMP_20180516_CODEGEN_L8PLPL_CAL" ("KEY", "Proba_1", "Proba_0") SELECT "U"."KEY", "U"."Proba_1", "U"."Proba_0" 
...
FROM "TMP_20180516_CODEGEN_A2AF9X_ADS" AS "ADS_sca_2_OUT"), 
"DT_node_data" AS 
...
-- Code For temporary table TMP_20180516_CODEGEN_L3VGYH_CAL part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180516_CODEGEN_L3VGYH_CAL" (
	"KEY" BIGINT NOT NULL, 
	"Proba_1" DOUBLE PRECISION, 
	"Proba_0" DOUBLE PRECISION, 
	PRIMARY KEY ("KEY")
...
-- Code For temporary table TMP_20180516_CODEGEN_L3VGYH_CAL part 2. Populate

INSERT INTO "TMP_20180516_CODEGEN_L3VGYH_CAL" ("KEY", "Proba_1", "Proba_0") SELECT "U"."KEY", "U"."Proba_1", "U"."Proba_0" 
...
FROM "TMP_20180516_CODEGEN_L8PLPL_CAL" AS "CalProb_B0") AS "CalProb_EnsembleUnion")
...
-- Code For temporary table TMP_20180516_CODEGEN_L3VGYH_CAL part 3. Create Index 

CREATE INDEX "ix_TMP_20180516_CODEGEN_6052" ON "TMP_20180516_CODEGEN_L3VGYH_CAL" ("KEY")
...
FROM "TMP_20180516_CODEGEN_L3VGYH_CAL" AS "CalProb_avg"), 
