...
-- Code For temporary table TMP_20180508180206_CODEGEN_V0NW part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508180206_CODEGEN_V0NW" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20180508180206_CODEGEN_V0NW part 3. Create Index 

CREATE INDEX "ix_TMP_20180508180206_C_a5fd" ON "TMP_20180508180206_CODEGEN_V0NW" ("KEY")

-- Code For temporary table TMP_20180508180206_CODEGEN_UJOG part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508180206_CODEGEN_UJOG" (
	"KEY" BIGINT NOT NULL, 
...
FROM "TMP_20180508180206_CODEGEN_V0NW" AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT") AS "U"

-- Code For temporary table TMP_20180508180206_CODEGEN_UJOG part 3. Create Index 

CREATE INDEX "ix_TMP_20180508180206_C_bf5e" ON "TMP_20180508180206_CODEGEN_UJOG" ("KEY")

-- Code For temporary table TMP_20180508180206_CODEGEN_IPU5 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508180206_CODEGEN_IPU5" (
	"KEY" BIGINT, 
...
-- Code For temporary table TMP_20180508180206_CODEGEN_IPU5 part 2. Populate

INSERT INTO "TMP_20180508180206_CODEGEN_IPU5" ("KEY", "Proba_1", "Proba_0") SELECT "U"."KEY", "U"."Proba_1", "U"."Proba_0" 
...
FROM "TMP_20180508180206_CODEGEN_UJOG" AS "ADS_sca_2_OUT"), 
"DT_node_data" AS 
...
-- Code For temporary table TMP_20180508180206_CODEGEN_K50B part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508180206_CODEGEN_K50B" (
	"KEY" BIGINT, 
	"Proba_1" DOUBLE PRECISION, 
	"Proba_0" DOUBLE PRECISION
)
...
-- Code For temporary table TMP_20180508180206_CODEGEN_K50B part 2. Populate

INSERT INTO "TMP_20180508180206_CODEGEN_K50B" ("KEY", "Proba_1", "Proba_0") SELECT "U"."KEY", "U"."Proba_1", "U"."Proba_0" 
...
FROM "TMP_20180508180206_CODEGEN_IPU5" AS "CalProb_B0") AS "CalProb_EnsembleUnion") AS "CalProb_Union") AS "U"

-- Code For temporary table TMP_20180508180206_CODEGEN_KYI8 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508180206_CODEGEN_KYI8" (
	"KEY" BIGINT NOT NULL, 
	"Proba_1" DOUBLE PRECISION, 
	"Proba_0" DOUBLE PRECISION, 
	PRIMARY KEY ("KEY")
...
-- Code For temporary table TMP_20180508180206_CODEGEN_KYI8 part 2. Populate

INSERT INTO "TMP_20180508180206_CODEGEN_KYI8" ("KEY", "Proba_1", "Proba_0") SELECT "U"."KEY", "U"."Proba_1", "U"."Proba_0" 
...
FROM "TMP_20180508180206_CODEGEN_K50B" AS "CalProb_Union" GROUP BY "CalProb_Union"."KEY") AS "T") AS "CalProb_avg") AS "U"

-- Code For temporary table TMP_20180508180206_CODEGEN_KYI8 part 3. Create Index 

CREATE INDEX "ix_TMP_20180508180206_C_803e" ON "TMP_20180508180206_CODEGEN_KYI8" ("KEY")
...
FROM "TMP_20180508180206_CODEGEN_KYI8" AS "CalProb_avg"), 
