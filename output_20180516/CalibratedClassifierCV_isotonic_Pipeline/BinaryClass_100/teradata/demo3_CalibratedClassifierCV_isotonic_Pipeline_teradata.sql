...
-- Code For temporary table tmp_20180602141724_4uh_ads_imp_1_out part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180602141724_4uh_ads_imp_1_out  (
	"KEY" BIGINT, 
...
-- Code For temporary table tmp_20180602141724_grl_ads_sca_2_out part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180602141724_grl_ads_sca_2_out  (
	"KEY" BIGINT, 
...
FROM tmp_20180602141724_4uh_ads_imp_1_out AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT") AS "U"

-- Code For temporary table tmp_20180602141724_fd0_calprob_b0 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180602141724_fd0_calprob_b0  (
	"KEY" BIGINT, 
...
-- Code For temporary table tmp_20180602141724_fd0_calprob_b0 part 2. Populate

INSERT INTO tmp_20180602141724_fd0_calprob_b0 ("KEY", "Proba_1", "Proba_0") SELECT "U"."KEY", "U"."Proba_1", "U"."Proba_0" 
...
FROM tmp_20180602141724_grl_ads_sca_2_out AS "ADS_sca_2_OUT"), 
dummy_cte AS 
...
-- Code For temporary table tmp_20180602141724_6wy_calprob_avg part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180602141724_6wy_calprob_avg  (
	"KEY" BIGINT, 
	"Proba_1" DOUBLE PRECISION, 
	"Proba_0" DOUBLE PRECISION
)
...
-- Code For temporary table tmp_20180602141724_6wy_calprob_avg part 2. Populate

INSERT INTO tmp_20180602141724_6wy_calprob_avg ("KEY", "Proba_1", "Proba_0") SELECT "U"."KEY", "U"."Proba_1", "U"."Proba_0" 
...
FROM tmp_20180602141724_fd0_calprob_b0 AS "CalProb_B0") AS "CalProb_EnsembleUnion")
...
FROM tmp_20180602141724_6wy_calprob_avg AS "CalProb_avg"), 
