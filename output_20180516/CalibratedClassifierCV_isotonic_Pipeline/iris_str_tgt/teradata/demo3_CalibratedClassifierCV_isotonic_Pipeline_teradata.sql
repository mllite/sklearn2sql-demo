...
-- Code For temporary table tmp_20180508190452_codegen_254fd1_ads_imp_1_out part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180508190452_codegen_254fd1_ads_imp_1_out  (
	"KEY" BIGINT, 
...
-- Code For temporary table tmp_20180508190452_codegen_254fd1_ads_imp_1_out part 2. Populate

INSERT INTO tmp_20180508190452_codegen_254fd1_ads_imp_1_out ("KEY", imputer_output_2, imputer_output_3, imputer_output_4, imputer_output_5) SELECT "U"."KEY", "U".imputer_output_2, "U".imputer_output_3, "U".imputer_output_4, "U".imputer_output_5 
...
-- Code For temporary table tmp_20180508190452_codegen_3cbzb0_ads_sca_2_out part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180508190452_codegen_3cbzb0_ads_sca_2_out  (
	"KEY" BIGINT, 
...
-- Code For temporary table tmp_20180508190452_codegen_3cbzb0_ads_sca_2_out part 2. Populate

INSERT INTO tmp_20180508190452_codegen_3cbzb0_ads_sca_2_out ("KEY", scaler_output_2, scaler_output_3, scaler_output_4, scaler_output_5) SELECT "U"."KEY", "U".scaler_output_2, "U".scaler_output_3, "U".scaler_output_4, "U".scaler_output_5 
...
FROM tmp_20180508190452_codegen_254fd1_ads_imp_1_out AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT") AS "U"

-- Code For temporary table tmp_20180508190452_codegen_en95fm_calprob_b0 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180508190452_codegen_en95fm_calprob_b0  (
	"KEY" BIGINT, 
...
-- Code For temporary table tmp_20180508190452_codegen_en95fm_calprob_b0 part 2. Populate

INSERT INTO tmp_20180508190452_codegen_en95fm_calprob_b0 ("KEY", "Proba_CLASS_0", "Proba_CLASS_1", "Proba_CLASS_2") SELECT "U"."KEY", "U"."Proba_CLASS_0", "U"."Proba_CLASS_1", "U"."Proba_CLASS_2" 
...
FROM tmp_20180508190452_codegen_3cbzb0_ads_sca_2_out AS "ADS_sca_2_OUT"), 
dummy_cte AS 
...
FROM "DT_Output"), 
isotonic_cte_0 AS 
(SELECT "Calibrated_Model_0"."KEY" AS "KEY", CASE WHEN ("Calibrated_Model_0"."ScoreOrProba_CLASS_0" < CAST(0.0 AS DOUBLE PRECISION)) THEN CAST(0.0 AS DOUBLE PRECISION) WHEN ("Calibrated_Model_0"."ScoreOrProba_CLASS_0" < CAST(1.0 AS DOUBLE PRECISION)) THEN ("Calibrated_Model_0"."ScoreOrProba_CLASS_0" - CAST(0.0 AS DOUBLE PRECISION)) * CAST(1.0 AS DOUBLE PRECISION) + CAST(0.0 AS DOUBLE PRECISION) ELSE CAST(1.0 AS DOUBLE PRECISION) END AS "Proba_CLASS_0", CASE WHEN ("Calibrated_Model_0"."ScoreOrProba_CLASS_1" < CAST(0.0 AS DOUBLE PRECISION)) THEN CAST(0.0 AS DOUBLE PRECISION) WHEN ("Calibrated_Model_0"."ScoreOrProba_CLASS_1" < CAST(0.666666666666667 AS DOUBLE PRECISION)) THEN ("Calibrated_Model_0"."ScoreOrProba_CLASS_1" - CAST(0.0 AS DOUBLE PRECISION)) * CAST(1.425 AS DOUBLE PRECISION) + CAST(0.0 AS DOUBLE PRECISION) WHEN ("Calibrated_Model_0"."ScoreOrProba_CLASS_1" < CAST(1.0 AS DOUBLE PRECISION)) THEN ("Calibrated_Model_0"."ScoreOrProba_CLASS_1" - CAST(0.666666666666667 AS DOUBLE PRECISION)) * CAST(0.0 AS DOUBLE PRECISION) + CAST(0.95 AS DOUBLE PRECISION) ELSE CAST(0.95 AS DOUBLE PRECISION) END AS "Proba_CLASS_1", CASE WHEN ("Calibrated_Model_0"."ScoreOrProba_CLASS_2" < CAST(0.0 AS DOUBLE PRECISION)) THEN CAST(0.025 AS DOUBLE PRECISION) WHEN ("Calibrated_Model_0"."ScoreOrProba_CLASS_2" < CAST(0.333333333333333 AS DOUBLE PRECISION)) THEN ("Calibrated_Model_0"."ScoreOrProba_CLASS_2" - CAST(0.0 AS DOUBLE PRECISION)) * CAST(0.0 AS DOUBLE PRECISION) + CAST(0.025 AS DOUBLE PRECISION) WHEN ("Calibrated_Model_0"."ScoreOrProba_CLASS_2" < CAST(1.0 AS DOUBLE PRECISION)) THEN ("Calibrated_Model_0"."ScoreOrProba_CLASS_2" - CAST(0.333333333333333 AS DOUBLE PRECISION)) * CAST(1.4625 AS DOUBLE PRECISION) + CAST(0.025 AS DOUBLE PRECISION) ELSE CAST(1.0 AS DOUBLE PRECISION) END AS "Proba_CLASS_2" 
...
FROM "DT_Output_1"), 
isotonic_cte_1 AS 
(SELECT "Calibrated_Model_1"."KEY" AS "KEY", CASE WHEN ("Calibrated_Model_1"."ScoreOrProba_CLASS_0" < CAST(0.0 AS DOUBLE PRECISION)) THEN CAST(0.0 AS DOUBLE PRECISION) WHEN ("Calibrated_Model_1"."ScoreOrProba_CLASS_0" < CAST(1.0 AS DOUBLE PRECISION)) THEN ("Calibrated_Model_1"."ScoreOrProba_CLASS_0" - CAST(0.0 AS DOUBLE PRECISION)) * CAST(1.0 AS DOUBLE PRECISION) + CAST(0.0 AS DOUBLE PRECISION) ELSE CAST(1.0 AS DOUBLE PRECISION) END AS "Proba_CLASS_0", CASE WHEN ("Calibrated_Model_1"."ScoreOrProba_CLASS_1" < CAST(0.0 AS DOUBLE PRECISION)) THEN CAST(0.0 AS DOUBLE PRECISION) WHEN ("Calibrated_Model_1"."ScoreOrProba_CLASS_1" < CAST(1.0 AS DOUBLE PRECISION)) THEN ("Calibrated_Model_1"."ScoreOrProba_CLASS_1" - CAST(0.0 AS DOUBLE PRECISION)) * CAST(1.0 AS DOUBLE PRECISION) + CAST(0.0 AS DOUBLE PRECISION) ELSE CAST(1.0 AS DOUBLE PRECISION) END AS "Proba_CLASS_1", CASE WHEN ("Calibrated_Model_1"."ScoreOrProba_CLASS_2" < CAST(0.0 AS DOUBLE PRECISION)) THEN CAST(0.0 AS DOUBLE PRECISION) WHEN ("Calibrated_Model_1"."ScoreOrProba_CLASS_2" < CAST(1.0 AS DOUBLE PRECISION)) THEN ("Calibrated_Model_1"."ScoreOrProba_CLASS_2" - CAST(0.0 AS DOUBLE PRECISION)) * CAST(1.0 AS DOUBLE PRECISION) + CAST(0.0 AS DOUBLE PRECISION) ELSE CAST(1.0 AS DOUBLE PRECISION) END AS "Proba_CLASS_2" 
...
FROM "DT_Output_2"), 
isotonic_cte_2 AS 
(SELECT "Calibrated_Model_2"."KEY" AS "KEY", CASE WHEN ("Calibrated_Model_2"."ScoreOrProba_CLASS_0" < CAST(0.0 AS DOUBLE PRECISION)) THEN CAST(0.0 AS DOUBLE PRECISION) WHEN ("Calibrated_Model_2"."ScoreOrProba_CLASS_0" < CAST(1.0 AS DOUBLE PRECISION)) THEN ("Calibrated_Model_2"."ScoreOrProba_CLASS_0" - CAST(0.0 AS DOUBLE PRECISION)) * CAST(1.0 AS DOUBLE PRECISION) + CAST(0.0 AS DOUBLE PRECISION) ELSE CAST(1.0 AS DOUBLE PRECISION) END AS "Proba_CLASS_0", CASE WHEN ("Calibrated_Model_2"."ScoreOrProba_CLASS_1" < CAST(0.0 AS DOUBLE PRECISION)) THEN CAST(0.090909090909091 AS DOUBLE PRECISION) WHEN ("Calibrated_Model_2"."ScoreOrProba_CLASS_1" < CAST(1.0 AS DOUBLE PRECISION)) THEN ("Calibrated_Model_2"."ScoreOrProba_CLASS_1" - CAST(0.0 AS DOUBLE PRECISION)) * CAST(0.909090909090909 AS DOUBLE PRECISION) + CAST(0.090909090909091 AS DOUBLE PRECISION) ELSE CAST(1.0 AS DOUBLE PRECISION) END AS "Proba_CLASS_1", CASE WHEN ("Calibrated_Model_2"."ScoreOrProba_CLASS_2" < CAST(0.0 AS DOUBLE PRECISION)) THEN CAST(0.0 AS DOUBLE PRECISION) WHEN ("Calibrated_Model_2"."ScoreOrProba_CLASS_2" < CAST(1.0 AS DOUBLE PRECISION)) THEN ("Calibrated_Model_2"."ScoreOrProba_CLASS_2" - CAST(0.0 AS DOUBLE PRECISION)) * CAST(0.846153846153846 AS DOUBLE PRECISION) + CAST(0.0 AS DOUBLE PRECISION) ELSE CAST(0.846153846153846 AS DOUBLE PRECISION) END AS "Proba_CLASS_2" 
...
FROM "DT_Output_3"), 
isotonic_cte_3 AS 
(SELECT "Calibrated_Model_3"."KEY" AS "KEY", CASE WHEN ("Calibrated_Model_3"."ScoreOrProba_CLASS_0" < CAST(0.0 AS DOUBLE PRECISION)) THEN CAST(0.0 AS DOUBLE PRECISION) WHEN ("Calibrated_Model_3"."ScoreOrProba_CLASS_0" < CAST(1.0 AS DOUBLE PRECISION)) THEN ("Calibrated_Model_3"."ScoreOrProba_CLASS_0" - CAST(0.0 AS DOUBLE PRECISION)) * CAST(1.0 AS DOUBLE PRECISION) + CAST(0.0 AS DOUBLE PRECISION) ELSE CAST(1.0 AS DOUBLE PRECISION) END AS "Proba_CLASS_0", CASE WHEN ("Calibrated_Model_3"."ScoreOrProba_CLASS_1" < CAST(0.0 AS DOUBLE PRECISION)) THEN CAST(0.095238095238095 AS DOUBLE PRECISION) WHEN ("Calibrated_Model_3"."ScoreOrProba_CLASS_1" < CAST(1.0 AS DOUBLE PRECISION)) THEN ("Calibrated_Model_3"."ScoreOrProba_CLASS_1" - CAST(0.0 AS DOUBLE PRECISION)) * CAST(0.904761904761905 AS DOUBLE PRECISION) + CAST(0.095238095238095 AS DOUBLE PRECISION) ELSE CAST(1.0 AS DOUBLE PRECISION) END AS "Proba_CLASS_1", CASE WHEN ("Calibrated_Model_3"."ScoreOrProba_CLASS_2" < CAST(0.0 AS DOUBLE PRECISION)) THEN CAST(0.0 AS DOUBLE PRECISION) WHEN ("Calibrated_Model_3"."ScoreOrProba_CLASS_2" < CAST(1.0 AS DOUBLE PRECISION)) THEN ("Calibrated_Model_3"."ScoreOrProba_CLASS_2" - CAST(0.0 AS DOUBLE PRECISION)) * CAST(0.833333333333333 AS DOUBLE PRECISION) + CAST(0.0 AS DOUBLE PRECISION) ELSE CAST(0.833333333333333 AS DOUBLE PRECISION) END AS "Proba_CLASS_2" 
...
-- Code For temporary table tmp_20180508190452_codegen_ik9mwk_calprob_union part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180508190452_codegen_ik9mwk_calprob_union  (
	"KEY" BIGINT, 
	"Proba_CLASS_0" DOUBLE PRECISION, 
	"Proba_CLASS_1" DOUBLE PRECISION, 
	"Proba_CLASS_2" DOUBLE PRECISION
...
-- Code For temporary table tmp_20180508190452_codegen_ik9mwk_calprob_union part 2. Populate

INSERT INTO tmp_20180508190452_codegen_ik9mwk_calprob_union ("KEY", "Proba_CLASS_0", "Proba_CLASS_1", "Proba_CLASS_2") SELECT "U"."KEY", "U"."Proba_CLASS_0", "U"."Proba_CLASS_1", "U"."Proba_CLASS_2" 
...
FROM tmp_20180508190452_codegen_en95fm_calprob_b0 AS "CalProb_B0") AS "CalProb_EnsembleUnion") AS "CalProb_Union") AS "U"

-- Code For temporary table tmp_20180508190452_codegen_xn500e_calprob_avg part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180508190452_codegen_xn500e_calprob_avg  (
	"KEY" BIGINT, 
	"Proba_CLASS_0" DOUBLE PRECISION, 
	"Proba_CLASS_1" DOUBLE PRECISION, 
	"Proba_CLASS_2" DOUBLE PRECISION
...
-- Code For temporary table tmp_20180508190452_codegen_xn500e_calprob_avg part 2. Populate

INSERT INTO tmp_20180508190452_codegen_xn500e_calprob_avg ("KEY", "Proba_CLASS_0", "Proba_CLASS_1", "Proba_CLASS_2") SELECT "U"."KEY", "U"."Proba_CLASS_0", "U"."Proba_CLASS_1", "U"."Proba_CLASS_2" 
...
FROM tmp_20180508190452_codegen_ik9mwk_calprob_union AS "CalProb_Union" GROUP BY "CalProb_Union"."KEY") AS "T") AS "CalProb_avg") AS "U"
...
FROM tmp_20180508190452_codegen_xn500e_calprob_avg AS "CalProb_avg"), 
