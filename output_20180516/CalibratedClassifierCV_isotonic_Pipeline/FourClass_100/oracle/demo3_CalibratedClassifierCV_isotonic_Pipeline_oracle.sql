...
-- Code For temporary table DEGEN_ZYFL4A_ADS_IMP_1_OUT part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "DEGEN_ZYFL4A_ADS_IMP_1_OUT" (
	"KEY" NUMBER(19), 
...
-- Code For temporary table DEGEN_3078XU_ADS_SCA_2_OUT part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "DEGEN_3078XU_ADS_SCA_2_OUT" (
	"KEY" NUMBER(19), 
...
FROM "DEGEN_ZYFL4A_ADS_IMP_1_OUT" "ADS_imp_1_OUT") "ADS_sca_2_OUT") "U"

-- Code For temporary table _CODEGEN_191OWE_CALPROB_B0 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "_CODEGEN_191OWE_CALPROB_B0" (
	"KEY" NUMBER(19), 
...
-- Code For temporary table _CODEGEN_191OWE_CALPROB_B0 part 2. Populate

INSERT INTO "_CODEGEN_191OWE_CALPROB_B0" ("KEY", "Proba_0", "Proba_1", "Proba_2", "Proba_3") SELECT "U"."KEY", "U"."Proba_0", "U"."Proba_1", "U"."Proba_2", "U"."Proba_3" 
...
FROM "DEGEN_3078XU_ADS_SCA_2_OUT" "ADS_sca_2_OUT"), 
"DT_node_data" AS 
...
-- Code For temporary table CODEGEN_DPC1E2_CALPROB_AVG part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "CODEGEN_DPC1E2_CALPROB_AVG" (
	"KEY" NUMBER(19), 
	"Proba_0" BINARY_DOUBLE, 
	"Proba_1" BINARY_DOUBLE, 
	"Proba_2" BINARY_DOUBLE, 
...
-- Code For temporary table CODEGEN_DPC1E2_CALPROB_AVG part 2. Populate

INSERT INTO "CODEGEN_DPC1E2_CALPROB_AVG" ("KEY", "Proba_0", "Proba_1", "Proba_2", "Proba_3") SELECT "U"."KEY", "U"."Proba_0", "U"."Proba_1", "U"."Proba_2", "U"."Proba_3" 
...
FROM "_CODEGEN_191OWE_CALPROB_B0" "CalProb_B0") "CalProb_EnsembleUnion")
...
FROM "CODEGEN_DPC1E2_CALPROB_AVG" "CalProb_avg"), 
