...
-- Code For temporary table TMP_20180516_CODEGEN_UEV63C_ADS part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180516_CODEGEN_UEV63C_ADS" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20180516_CODEGEN_UEV63C_ADS part 3. Create Index 

CREATE INDEX "ix_TMP_20180516_CODEGEN_a8bd" ON "TMP_20180516_CODEGEN_UEV63C_ADS" ("KEY")

-- Code For temporary table TMP_20180516_CODEGEN_L4FDQO_ADS part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180516_CODEGEN_L4FDQO_ADS" (
	"KEY" BIGINT NOT NULL, 
...
FROM "TMP_20180516_CODEGEN_UEV63C_ADS" AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT") AS "U"

-- Code For temporary table TMP_20180516_CODEGEN_L4FDQO_ADS part 3. Create Index 

CREATE INDEX "ix_TMP_20180516_CODEGEN_623d" ON "TMP_20180516_CODEGEN_L4FDQO_ADS" ("KEY")

-- Code For temporary table TMP_20180516_CODEGEN_TZZ5A4_CAL part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180516_CODEGEN_TZZ5A4_CAL" (
	"KEY" BIGINT, 
...
-- Code For temporary table TMP_20180516_CODEGEN_TZZ5A4_CAL part 2. Populate

INSERT INTO "TMP_20180516_CODEGEN_TZZ5A4_CAL" ("KEY", "Proba_0", "Proba_1", "Proba_2", "Proba_3") SELECT "U"."KEY", "U"."Proba_0", "U"."Proba_1", "U"."Proba_2", "U"."Proba_3" 
...
FROM "TMP_20180516_CODEGEN_L4FDQO_ADS" AS "ADS_sca_2_OUT"), 
"DT_node_data" AS 
...
-- Code For temporary table TMP_20180516_CODEGEN_TJ3JWN_CAL part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180516_CODEGEN_TJ3JWN_CAL" (
	"KEY" BIGINT NOT NULL, 
	"Proba_0" DOUBLE PRECISION, 
	"Proba_1" DOUBLE PRECISION, 
	"Proba_2" DOUBLE PRECISION, 
...
-- Code For temporary table TMP_20180516_CODEGEN_TJ3JWN_CAL part 2. Populate

INSERT INTO "TMP_20180516_CODEGEN_TJ3JWN_CAL" ("KEY", "Proba_0", "Proba_1", "Proba_2", "Proba_3") SELECT "U"."KEY", "U"."Proba_0", "U"."Proba_1", "U"."Proba_2", "U"."Proba_3" 
...
FROM "TMP_20180516_CODEGEN_TZZ5A4_CAL" AS "CalProb_B0") AS "CalProb_EnsembleUnion")
...
-- Code For temporary table TMP_20180516_CODEGEN_TJ3JWN_CAL part 3. Create Index 

CREATE INDEX "ix_TMP_20180516_CODEGEN_fa22" ON "TMP_20180516_CODEGEN_TJ3JWN_CAL" ("KEY")
...
FROM "TMP_20180516_CODEGEN_TJ3JWN_CAL" AS "CalProb_avg"), 
