...
-- Code For temporary table TMP_20180508181628_CODEGEN_OQI7 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508181628_CODEGEN_OQI7" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20180508181628_CODEGEN_OQI7 part 3. Create Index 

CREATE INDEX "ix_TMP_20180508181628_C_23e7" ON "TMP_20180508181628_CODEGEN_OQI7" ("KEY")

-- Code For temporary table TMP_20180508181628_CODEGEN_27UC part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508181628_CODEGEN_27UC" (
	"KEY" BIGINT NOT NULL, 
...
FROM "TMP_20180508181628_CODEGEN_OQI7" AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT") AS "U"

-- Code For temporary table TMP_20180508181628_CODEGEN_27UC part 3. Create Index 

CREATE INDEX "ix_TMP_20180508181628_C_146a" ON "TMP_20180508181628_CODEGEN_27UC" ("KEY")

-- Code For temporary table TMP_20180508181628_CODEGEN_S92N part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508181628_CODEGEN_S92N" (
	"KEY" BIGINT, 
...
-- Code For temporary table TMP_20180508181628_CODEGEN_S92N part 2. Populate

INSERT INTO "TMP_20180508181628_CODEGEN_S92N" ("KEY", "Proba_0", "Proba_1", "Proba_2", "Proba_3") SELECT "U"."KEY", "U"."Proba_0", "U"."Proba_1", "U"."Proba_2", "U"."Proba_3" 
...
FROM "TMP_20180508181628_CODEGEN_27UC" AS "ADS_sca_2_OUT"), 
"DT_node_data" AS 
...
-- Code For temporary table TMP_20180508181628_CODEGEN_5SDU part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508181628_CODEGEN_5SDU" (
	"KEY" BIGINT, 
	"Proba_0" DOUBLE PRECISION, 
	"Proba_1" DOUBLE PRECISION, 
	"Proba_2" DOUBLE PRECISION, 
...
-- Code For temporary table TMP_20180508181628_CODEGEN_5SDU part 2. Populate

INSERT INTO "TMP_20180508181628_CODEGEN_5SDU" ("KEY", "Proba_0", "Proba_1", "Proba_2", "Proba_3") SELECT "U"."KEY", "U"."Proba_0", "U"."Proba_1", "U"."Proba_2", "U"."Proba_3" 
...
FROM "TMP_20180508181628_CODEGEN_S92N" AS "CalProb_B0") AS "CalProb_EnsembleUnion") AS "CalProb_Union") AS "U"

-- Code For temporary table TMP_20180508181628_CODEGEN_3B1G part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508181628_CODEGEN_3B1G" (
	"KEY" BIGINT NOT NULL, 
	"Proba_0" DOUBLE PRECISION, 
	"Proba_1" DOUBLE PRECISION, 
	"Proba_2" DOUBLE PRECISION, 
...
-- Code For temporary table TMP_20180508181628_CODEGEN_3B1G part 2. Populate

INSERT INTO "TMP_20180508181628_CODEGEN_3B1G" ("KEY", "Proba_0", "Proba_1", "Proba_2", "Proba_3") SELECT "U"."KEY", "U"."Proba_0", "U"."Proba_1", "U"."Proba_2", "U"."Proba_3" 
...
FROM "TMP_20180508181628_CODEGEN_5SDU" AS "CalProb_Union" GROUP BY "CalProb_Union"."KEY") AS "T") AS "CalProb_avg") AS "U"

-- Code For temporary table TMP_20180508181628_CODEGEN_3B1G part 3. Create Index 

CREATE INDEX "ix_TMP_20180508181628_C_77c8" ON "TMP_20180508181628_CODEGEN_3B1G" ("KEY")
...
FROM "TMP_20180508181628_CODEGEN_3B1G" AS "CalProb_avg"), 
