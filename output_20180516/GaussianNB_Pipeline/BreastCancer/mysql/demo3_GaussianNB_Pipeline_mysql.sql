...
-- Code For temporary table TMP_20180508180751_CODEGEN_8FIK9R_ADS_imp_1_OUT part 1. Create 


CREATE TEMPORARY TABLE `TMP_20180508180751_CODEGEN_8FIK9R_ADS_imp_1_OUT` (
	`KEY` BIGINT NOT NULL, 
	impter_2 DOUBLE, 
	impter_3 DOUBLE, 
	impter_4 DOUBLE, 
...
-- Code For temporary table TMP_20180508180751_CODEGEN_8FIK9R_ADS_imp_1_OUT part 2. Populate

INSERT INTO `TMP_20180508180751_CODEGEN_8FIK9R_ADS_imp_1_OUT` (`KEY`, impter_2, impter_3, impter_4, impter_5, impter_6, impter_7, impter_8, impter_9, impter_10, impter_11, impter_12, impter_13, impter_14, impter_15, impter_16, impter_17, impter_18, impter_19, impter_20, impter_21, impter_22, impter_23, impter_24, impter_25, impter_26, impter_27, impter_28, impter_29, impter_30, impter_31) SELECT `U`.`KEY`, `U`.impter_2, `U`.impter_3, `U`.impter_4, `U`.impter_5, `U`.impter_6, `U`.impter_7, `U`.impter_8, `U`.impter_9, `U`.impter_10, `U`.impter_11, `U`.impter_12, `U`.impter_13, `U`.impter_14, `U`.impter_15, `U`.impter_16, `U`.impter_17, `U`.impter_18, `U`.impter_19, `U`.impter_20, `U`.impter_21, `U`.impter_22, `U`.impter_23, `U`.impter_24, `U`.impter_25, `U`.impter_26, `U`.impter_27, `U`.impter_28, `U`.impter_29, `U`.impter_30, `U`.impter_31 
...
-- Code For temporary table TMP_20180508180751_CODEGEN_8FIK9R_ADS_imp_1_OUT part 3. Create Index 

CREATE INDEX `ix_TMP_20180508180751_CODEGEN_8FIK9R_ADS_imp_1_OUT_KEY` ON `TMP_20180508180751_CODEGEN_8FIK9R_ADS_imp_1_OUT` (`KEY`)

-- Code For temporary table TMP_20180508180751_CODEGEN_1X1D2J_ADS_sca_2_OUT part 1. Create 


CREATE TEMPORARY TABLE `TMP_20180508180751_CODEGEN_1X1D2J_ADS_sca_2_OUT` (
	`KEY` BIGINT NOT NULL, 
	scaler_2 DOUBLE, 
	scaler_3 DOUBLE, 
	scaler_4 DOUBLE, 
...
FROM `TMP_20180508180751_CODEGEN_8FIK9R_ADS_imp_1_OUT` AS `ADS_imp_1_OUT`) AS `ADS_sca_2_OUT`) AS `U`

-- Code For temporary table TMP_20180508180751_CODEGEN_1X1D2J_ADS_sca_2_OUT part 3. Create Index 

CREATE INDEX `ix_TMP_20180508180751_CODEGEN_1X1D2J_ADS_sca_2_OUT_KEY` ON `TMP_20180508180751_CODEGEN_1X1D2J_ADS_sca_2_OUT` (`KEY`)

-- Model deployment code

WITH centered_data AS 
(SELECT `ADS_sca_2_OUT`.`KEY` AS `KEY`, `ADS_sca_2_OUT`.scaler_2 - 1.0049577921568156 AS scaler_2_0, `ADS_sca_2_OUT`.scaler_3 - 0.5272347157440817 AS scaler_3_0, `ADS_sca_2_OUT`.scaler_4 - 1.0224656573233908 AS scaler_4_0, `ADS_sca_2_OUT`.scaler_5 - 0.9755487167792978 AS scaler_5_0, `ADS_sca_2_OUT`.scaler_6 - 0.5109783768435309 AS scaler_6_0, `ADS_sca_2_OUT`.scaler_7 - 0.8454996589862851 AS scaler_7_0, `ADS_sca_2_OUT`.scaler_8 - 0.9501566820680749 AS scaler_8_0, `ADS_sca_2_OUT`.scaler_9 - 1.079373194450925 AS scaler_9_0, `ADS_sca_2_OUT`.scaler_10 - 0.4804840066713879 AS scaler_10_0, `ADS_sca_2_OUT`.scaler_11 - 0.008254648911233958 AS scaler_11_0, `ADS_sca_2_OUT`.scaler_12 - 0.7963129136236985 AS scaler_12_0, `ADS_sca_2_OUT`.scaler_13 - 0.025859092767011576 AS scaler_13_0, `ADS_sca_2_OUT`.scaler_14 - 0.7829342356917925 AS scaler_14_0, `ADS_sca_2_OUT`.scaler_15 - 0.7527459637163599 AS scaler_15_0, `ADS_sca_2_OUT`.scaler_16 - -0.07879019714350678 AS scaler_16_0, `ADS_sca_2_OUT`.scaler_17 - 0.41895691591652995 AS scaler_17_0, `ADS_sca_2_OUT`.scaler_18 - 0.32372735579628725 AS scaler_18_0, `ADS_sca_2_OUT`.scaler_19 - 0.5778838844193583 AS scaler_19_0, `ADS_sca_2_OUT`.scaler_20 - 0.05466531696521439 AS scaler_20_0, `ADS_sca_2_OUT`.scaler_21 - 0.10668595002277066 AS scaler_21_0, `ADS_sca_2_OUT`.scaler_22 - 1.0714383582224667 AS scaler_22_0, `ADS_sca_2_OUT`.scaler_23 - 0.5811783181481854 AS scaler_23_0, `ADS_sca_2_OUT`.scaler_24 - 1.0800043767778378 AS scaler_24_0, `ADS_sca_2_OUT`.scaler_25 - 1.0129008849222247 AS scaler_25_0, `ADS_sca_2_OUT`.scaler_26 - 0.5815788803349367 AS scaler_26_0, `ADS_sca_2_OUT`.scaler_27 - 0.8321432517733914 AS scaler_27_0, `ADS_sca_2_OUT`.scaler_28 - 0.8907311579327978 AS scaler_28_0, `ADS_sca_2_OUT`.scaler_29 - 1.097339665184901 AS scaler_29_0, `ADS_sca_2_OUT`.scaler_30 - 0.5790457036351542 AS scaler_30_0, `ADS_sca_2_OUT`.scaler_31 - 0.44698120583557815 AS scaler_31_0, `ADS_sca_2_OUT`.scaler_2 - -0.5450618533731864 AS scaler_2_1, `ADS_sca_2_OUT`.scaler_3 - -0.2859578119289954 AS scaler_3_1, `ADS_sca_2_OUT`.scaler_4 - -0.5545576446499755 AS scaler_4_1, `ADS_sca_2_OUT`.scaler_5 - -0.5291111684226707 AS scaler_5_1, `ADS_sca_2_OUT`.scaler_6 - -0.2771408145592028 AS scaler_6_1, `ADS_sca_2_OUT`.scaler_7 - -0.45857608622985074 AS scaler_7_1, `ADS_sca_2_OUT`.scaler_8 - -0.5153392173928566 AS scaler_8_1, `ADS_sca_2_OUT`.scaler_9 - -0.5854227495327037 AS scaler_9_1, `ADS_sca_2_OUT`.scaler_10 - -0.26060149514380665 AS scaler_10_1, `ADS_sca_2_OUT`.scaler_11 - -0.004477097714565806 AS scaler_11_1, `ADS_sca_2_OUT`.scaler_12 - -0.4318985294230235 AS scaler_12_1, `ADS_sca_2_OUT`.scaler_13 - -0.014025270653293244 AS scaler_13_1, `ADS_sca_2_OUT`.scaler_14 - -0.4246422973243612 AS scaler_14_1, `ADS_sca_2_OUT`.scaler_15 - -0.40826899726989013 AS scaler_15_1, `ADS_sca_2_OUT`.scaler_16 - 0.04273366624732332 AS scaler_16_1, `ADS_sca_2_OUT`.scaler_17 - -0.22723086964964412 AS scaler_17_1, `ADS_sca_2_OUT`.scaler_18 - -0.17558093873696776 AS scaler_18_1, `ADS_sca_2_OUT`.scaler_19 - -0.31342854748168736 AS scaler_19_1, `ADS_sca_2_OUT`.scaler_20 - -0.029648985472661257 AS scaler_20_1, `ADS_sca_2_OUT`.scaler_21 - -0.057863566114043155 AS scaler_21_1, `ADS_sca_2_OUT`.scaler_22 - -0.5811191095443907 AS scaler_22_1, `ADS_sca_2_OUT`.scaler_23 - -0.3152153589956243 AS scaler_23_1, `ADS_sca_2_OUT`.scaler_24 - -0.5857650857100123 AS scaler_24_1, `ADS_sca_2_OUT`.scaler_25 - -0.5493699714832421 AS scaler_25_1, `ADS_sca_2_OUT`.scaler_26 - -0.315432613063021 AS scaler_26_1, `ADS_sca_2_OUT`.scaler_27 - -0.45133193316522807 AS scaler_27_1, `ADS_sca_2_OUT`.scaler_28 - -0.4831084246415161 AS scaler_28_1, `ADS_sca_2_OUT`.scaler_29 - -0.5951672760324885 AS scaler_29_1, `ADS_sca_2_OUT`.scaler_30 - -0.31405868671737264 AS scaler_30_1, `ADS_sca_2_OUT`.scaler_31 - -0.2424304845209864 AS scaler_31_1 
FROM `TMP_20180508180751_CODEGEN_1X1D2J_ADS_sca_2_OUT` AS `ADS_sca_2_OUT`), 
`NaiveBayes_data` AS 
