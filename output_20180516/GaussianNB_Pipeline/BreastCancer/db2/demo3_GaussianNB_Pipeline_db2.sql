...
-- Code For temporary table tmp_20180516111646_codegen_9o4hp7_ads_imp_1_out part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180516111646_codegen_9o4hp7_ads_imp_1_out (
	"KEY" BIGINT, 
	impter_2 DOUBLE, 
	impter_3 DOUBLE, 
	impter_4 DOUBLE, 
...
-- Code For temporary table tmp_20180516111646_codegen_85skrt_ads_sca_2_out part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180516111646_codegen_85skrt_ads_sca_2_out (
	"KEY" BIGINT, 
	scaler_2 DOUBLE, 
	scaler_3 DOUBLE, 
	scaler_4 DOUBLE, 
...
FROM tmp_20180516111646_codegen_9o4hp7_ads_imp_1_out AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT"

-- Code For temporary table tmp_20180516111646_codegen_gxezt1_naivebayes_scores part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180516111646_codegen_gxezt1_naivebayes_scores (
	"KEY" BIGINT, 
	"Score_0" DOUBLE, 
	"Score_1" DOUBLE
)
...
-- Code For temporary table tmp_20180516111646_codegen_gxezt1_naivebayes_scores part 2. Populate

INSERT INTO tmp_20180516111646_codegen_gxezt1_naivebayes_scores WITH centered_data AS 
...
FROM tmp_20180516111646_codegen_85skrt_ads_sca_2_out AS "ADS_sca_2_OUT"), 
"NaiveBayes_data" AS 
...
FROM tmp_20180516111646_codegen_gxezt1_naivebayes_scores AS "NaiveBayes_Scores"), 
