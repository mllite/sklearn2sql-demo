...
-- Code For temporary table TMP_20180516_CODEGEN_D946AW_ADS part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180516_CODEGEN_D946AW_ADS" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20180516_CODEGEN_D946AW_ADS part 2. Populate

INSERT INTO "TMP_20180516_CODEGEN_D946AW_ADS" ("KEY", impter_2, impter_3, impter_4, impter_5, impter_6, impter_7, impter_8, impter_9, impter_10, impter_11, impter_12, impter_13, impter_14, impter_15, impter_16, impter_17, impter_18, impter_19, impter_20, impter_21, impter_22, impter_23, impter_24, impter_25, impter_26, impter_27, impter_28, impter_29, impter_30, impter_31) SELECT "U"."KEY", "U".impter_2, "U".impter_3, "U".impter_4, "U".impter_5, "U".impter_6, "U".impter_7, "U".impter_8, "U".impter_9, "U".impter_10, "U".impter_11, "U".impter_12, "U".impter_13, "U".impter_14, "U".impter_15, "U".impter_16, "U".impter_17, "U".impter_18, "U".impter_19, "U".impter_20, "U".impter_21, "U".impter_22, "U".impter_23, "U".impter_24, "U".impter_25, "U".impter_26, "U".impter_27, "U".impter_28, "U".impter_29, "U".impter_30, "U".impter_31 
...
-- Code For temporary table TMP_20180516_CODEGEN_D946AW_ADS part 3. Create Index 

CREATE INDEX "ix_TMP_20180516_CODEGEN_85e6" ON "TMP_20180516_CODEGEN_D946AW_ADS" ("KEY")

-- Code For temporary table TMP_20180516_CODEGEN_YJ7TW0_ADS part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180516_CODEGEN_YJ7TW0_ADS" (
	"KEY" BIGINT NOT NULL, 
...
FROM "TMP_20180516_CODEGEN_D946AW_ADS" AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT") AS "U"

-- Code For temporary table TMP_20180516_CODEGEN_YJ7TW0_ADS part 3. Create Index 

CREATE INDEX "ix_TMP_20180516_CODEGEN_df69" ON "TMP_20180516_CODEGEN_YJ7TW0_ADS" ("KEY")

-- Code For temporary table TMP_20180516_CODEGEN_TMMK96_NAI part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180516_CODEGEN_TMMK96_NAI" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20180516_CODEGEN_TMMK96_NAI part 2. Populate

INSERT INTO "TMP_20180516_CODEGEN_TMMK96_NAI" ("KEY", "Score_0", "Score_1") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1" 
FROM (WITH centered_data AS 
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", CAST("ADS_sca_2_OUT".scaler_2 AS DOUBLE PRECISION) - 1.0049577921568156 AS scaler_2_0, CAST("ADS_sca_2_OUT".scaler_3 AS DOUBLE PRECISION) - 0.5272347157440817 AS scaler_3_0, CAST("ADS_sca_2_OUT".scaler_4 AS DOUBLE PRECISION) - 1.0224656573233908 AS scaler_4_0, CAST("ADS_sca_2_OUT".scaler_5 AS DOUBLE PRECISION) - 0.9755487167792978 AS scaler_5_0, CAST("ADS_sca_2_OUT".scaler_6 AS DOUBLE PRECISION) - 0.5109783768435309 AS scaler_6_0, CAST("ADS_sca_2_OUT".scaler_7 AS DOUBLE PRECISION) - 0.8454996589862851 AS scaler_7_0, CAST("ADS_sca_2_OUT".scaler_8 AS DOUBLE PRECISION) - 0.9501566820680749 AS scaler_8_0, CAST("ADS_sca_2_OUT".scaler_9 AS DOUBLE PRECISION) - 1.079373194450925 AS scaler_9_0, CAST("ADS_sca_2_OUT".scaler_10 AS DOUBLE PRECISION) - 0.4804840066713879 AS scaler_10_0, CAST("ADS_sca_2_OUT".scaler_11 AS DOUBLE PRECISION) - 0.008254648911233958 AS scaler_11_0, CAST("ADS_sca_2_OUT".scaler_12 AS DOUBLE PRECISION) - 0.7963129136236985 AS scaler_12_0, CAST("ADS_sca_2_OUT".scaler_13 AS DOUBLE PRECISION) - 0.025859092767011576 AS scaler_13_0, CAST("ADS_sca_2_OUT".scaler_14 AS DOUBLE PRECISION) - 0.7829342356917925 AS scaler_14_0, CAST("ADS_sca_2_OUT".scaler_15 AS DOUBLE PRECISION) - 0.7527459637163599 AS scaler_15_0, CAST("ADS_sca_2_OUT".scaler_16 AS DOUBLE PRECISION) - -0.07879019714350678 AS scaler_16_0, CAST("ADS_sca_2_OUT".scaler_17 AS DOUBLE PRECISION) - 0.41895691591652995 AS scaler_17_0, CAST("ADS_sca_2_OUT".scaler_18 AS DOUBLE PRECISION) - 0.32372735579628725 AS scaler_18_0, CAST("ADS_sca_2_OUT".scaler_19 AS DOUBLE PRECISION) - 0.5778838844193583 AS scaler_19_0, CAST("ADS_sca_2_OUT".scaler_20 AS DOUBLE PRECISION) - 0.05466531696521439 AS scaler_20_0, CAST("ADS_sca_2_OUT".scaler_21 AS DOUBLE PRECISION) - 0.10668595002277066 AS scaler_21_0, CAST("ADS_sca_2_OUT".scaler_22 AS DOUBLE PRECISION) - 1.0714383582224667 AS scaler_22_0, CAST("ADS_sca_2_OUT".scaler_23 AS DOUBLE PRECISION) - 0.5811783181481854 AS scaler_23_0, CAST("ADS_sca_2_OUT".scaler_24 AS DOUBLE PRECISION) - 1.0800043767778378 AS scaler_24_0, CAST("ADS_sca_2_OUT".scaler_25 AS DOUBLE PRECISION) - 1.0129008849222247 AS scaler_25_0, CAST("ADS_sca_2_OUT".scaler_26 AS DOUBLE PRECISION) - 0.5815788803349367 AS scaler_26_0, CAST("ADS_sca_2_OUT".scaler_27 AS DOUBLE PRECISION) - 0.8321432517733914 AS scaler_27_0, CAST("ADS_sca_2_OUT".scaler_28 AS DOUBLE PRECISION) - 0.8907311579327978 AS scaler_28_0, CAST("ADS_sca_2_OUT".scaler_29 AS DOUBLE PRECISION) - 1.097339665184901 AS scaler_29_0, CAST("ADS_sca_2_OUT".scaler_30 AS DOUBLE PRECISION) - 0.5790457036351542 AS scaler_30_0, CAST("ADS_sca_2_OUT".scaler_31 AS DOUBLE PRECISION) - 0.44698120583557815 AS scaler_31_0, CAST("ADS_sca_2_OUT".scaler_2 AS DOUBLE PRECISION) - -0.5450618533731864 AS scaler_2_1, CAST("ADS_sca_2_OUT".scaler_3 AS DOUBLE PRECISION) - -0.2859578119289954 AS scaler_3_1, CAST("ADS_sca_2_OUT".scaler_4 AS DOUBLE PRECISION) - -0.5545576446499755 AS scaler_4_1, CAST("ADS_sca_2_OUT".scaler_5 AS DOUBLE PRECISION) - -0.5291111684226707 AS scaler_5_1, CAST("ADS_sca_2_OUT".scaler_6 AS DOUBLE PRECISION) - -0.2771408145592028 AS scaler_6_1, CAST("ADS_sca_2_OUT".scaler_7 AS DOUBLE PRECISION) - -0.45857608622985074 AS scaler_7_1, CAST("ADS_sca_2_OUT".scaler_8 AS DOUBLE PRECISION) - -0.5153392173928566 AS scaler_8_1, CAST("ADS_sca_2_OUT".scaler_9 AS DOUBLE PRECISION) - -0.5854227495327037 AS scaler_9_1, CAST("ADS_sca_2_OUT".scaler_10 AS DOUBLE PRECISION) - -0.26060149514380665 AS scaler_10_1, CAST("ADS_sca_2_OUT".scaler_11 AS DOUBLE PRECISION) - -0.004477097714565806 AS scaler_11_1, CAST("ADS_sca_2_OUT".scaler_12 AS DOUBLE PRECISION) - -0.4318985294230235 AS scaler_12_1, CAST("ADS_sca_2_OUT".scaler_13 AS DOUBLE PRECISION) - -0.014025270653293244 AS scaler_13_1, CAST("ADS_sca_2_OUT".scaler_14 AS DOUBLE PRECISION) - -0.4246422973243612 AS scaler_14_1, CAST("ADS_sca_2_OUT".scaler_15 AS DOUBLE PRECISION) - -0.40826899726989013 AS scaler_15_1, CAST("ADS_sca_2_OUT".scaler_16 AS DOUBLE PRECISION) - 0.04273366624732332 AS scaler_16_1, CAST("ADS_sca_2_OUT".scaler_17 AS DOUBLE PRECISION) - -0.22723086964964412 AS scaler_17_1, CAST("ADS_sca_2_OUT".scaler_18 AS DOUBLE PRECISION) - -0.17558093873696776 AS scaler_18_1, CAST("ADS_sca_2_OUT".scaler_19 AS DOUBLE PRECISION) - -0.31342854748168736 AS scaler_19_1, CAST("ADS_sca_2_OUT".scaler_20 AS DOUBLE PRECISION) - -0.029648985472661257 AS scaler_20_1, CAST("ADS_sca_2_OUT".scaler_21 AS DOUBLE PRECISION) - -0.057863566114043155 AS scaler_21_1, CAST("ADS_sca_2_OUT".scaler_22 AS DOUBLE PRECISION) - -0.5811191095443907 AS scaler_22_1, CAST("ADS_sca_2_OUT".scaler_23 AS DOUBLE PRECISION) - -0.3152153589956243 AS scaler_23_1, CAST("ADS_sca_2_OUT".scaler_24 AS DOUBLE PRECISION) - -0.5857650857100123 AS scaler_24_1, CAST("ADS_sca_2_OUT".scaler_25 AS DOUBLE PRECISION) - -0.5493699714832421 AS scaler_25_1, CAST("ADS_sca_2_OUT".scaler_26 AS DOUBLE PRECISION) - -0.315432613063021 AS scaler_26_1, CAST("ADS_sca_2_OUT".scaler_27 AS DOUBLE PRECISION) - -0.45133193316522807 AS scaler_27_1, CAST("ADS_sca_2_OUT".scaler_28 AS DOUBLE PRECISION) - -0.4831084246415161 AS scaler_28_1, CAST("ADS_sca_2_OUT".scaler_29 AS DOUBLE PRECISION) - -0.5951672760324885 AS scaler_29_1, CAST("ADS_sca_2_OUT".scaler_30 AS DOUBLE PRECISION) - -0.31405868671737264 AS scaler_30_1, CAST("ADS_sca_2_OUT".scaler_31 AS DOUBLE PRECISION) - -0.2424304845209864 AS scaler_31_1 
FROM "TMP_20180516_CODEGEN_YJ7TW0_ADS" AS "ADS_sca_2_OUT"), 
"NaiveBayes_data" AS 
...
-- Code For temporary table TMP_20180516_CODEGEN_TMMK96_NAI part 3. Create Index 

CREATE INDEX "ix_TMP_20180516_CODEGEN_3100" ON "TMP_20180516_CODEGEN_TMMK96_NAI" ("KEY")
...
FROM "TMP_20180516_CODEGEN_TMMK96_NAI" AS "NaiveBayes_Scores"), 
