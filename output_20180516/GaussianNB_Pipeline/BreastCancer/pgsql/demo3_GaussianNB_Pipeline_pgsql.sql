...
-- Code For temporary table TMP_20180516111638_CODEGEN_LQWXLS_ADS_imp_1_OUT part 1. Create 


CREATE TEMPORARY TABLE "TMP_20180516111638_CODEGEN_LQWXLS_ADS_imp_1_OUT" (
	"KEY" BIGINT NOT NULL, 
	impter_2 FLOAT, 
	impter_3 FLOAT, 
	impter_4 FLOAT, 
...
-- Code For temporary table TMP_20180516111638_CODEGEN_LQWXLS_ADS_imp_1_OUT part 3. Create Index 

CREATE INDEX "ix_TMP_20180516111638_CODEGEN_LQWXLS_ADS_imp_1_OUT_KEY" ON "TMP_20180516111638_CODEGEN_LQWXLS_ADS_imp_1_OUT" ("KEY")

-- Code For temporary table TMP_20180516111638_CODEGEN_FACSIQ_ADS_sca_2_OUT part 1. Create 


CREATE TEMPORARY TABLE "TMP_20180516111638_CODEGEN_FACSIQ_ADS_sca_2_OUT" (
	"KEY" BIGINT NOT NULL, 
	scaler_2 FLOAT, 
	scaler_3 FLOAT, 
	scaler_4 FLOAT, 
...
FROM "TMP_20180516111638_CODEGEN_LQWXLS_ADS_imp_1_OUT" AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT"

-- Code For temporary table TMP_20180516111638_CODEGEN_FACSIQ_ADS_sca_2_OUT part 3. Create Index 

CREATE INDEX "ix_TMP_20180516111638_CODEGEN_FACSIQ_ADS_sca_2_OUT_KEY" ON "TMP_20180516111638_CODEGEN_FACSIQ_ADS_sca_2_OUT" ("KEY")

-- Code For temporary table TMP_20180516111638_CODEGEN_7L8DYI_NaiveBayes_Scores part 1. Create 


CREATE TEMPORARY TABLE "TMP_20180516111638_CODEGEN_7L8DYI_NaiveBayes_Scores" (
	"KEY" BIGINT NOT NULL, 
	"Score_0" FLOAT, 
	"Score_1" FLOAT, 
	PRIMARY KEY ("KEY")
...
-- Code For temporary table TMP_20180516111638_CODEGEN_7L8DYI_NaiveBayes_Scores part 2. Populate
...
FROM "TMP_20180516111638_CODEGEN_FACSIQ_ADS_sca_2_OUT" AS "ADS_sca_2_OUT"), 
"NaiveBayes_data" AS 
...
FROM centered_data) AS "Values")
 INSERT INTO "TMP_20180516111638_CODEGEN_7L8DYI_NaiveBayes_Scores" ("KEY", "Score_0", "Score_1") SELECT "NaiveBayes_Scores"."KEY", "NaiveBayes_Scores"."Score_0", "NaiveBayes_Scores"."Score_1" 
...
-- Code For temporary table TMP_20180516111638_CODEGEN_7L8DYI_NaiveBayes_Scores part 3. Create Index 

CREATE INDEX "ix_TMP_20180516111638_CODEGEN_7L8DYI_NaiveBayes_Scores_KEY" ON "TMP_20180516111638_CODEGEN_7L8DYI_NaiveBayes_Scores" ("KEY")
...
FROM "TMP_20180516111638_CODEGEN_7L8DYI_NaiveBayes_Scores" AS "NaiveBayes_Scores"), 
