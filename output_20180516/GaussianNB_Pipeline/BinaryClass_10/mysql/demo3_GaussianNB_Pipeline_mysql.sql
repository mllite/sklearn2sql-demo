...
-- Code For temporary table TMP_20180508175820_CODEGEN_4GUR83_ADS_imp_1_OUT part 1. Create 


CREATE TEMPORARY TABLE `TMP_20180508175820_CODEGEN_4GUR83_ADS_imp_1_OUT` (
	`KEY` BIGINT NOT NULL, 
	impter_2 DOUBLE, 
	impter_3 DOUBLE, 
	impter_4 DOUBLE, 
...
-- Code For temporary table TMP_20180508175820_CODEGEN_4GUR83_ADS_imp_1_OUT part 2. Populate

INSERT INTO `TMP_20180508175820_CODEGEN_4GUR83_ADS_imp_1_OUT` (`KEY`, impter_2, impter_3, impter_4, impter_5, impter_6, impter_7, impter_8, impter_9, impter_10, impter_11) SELECT `U`.`KEY`, `U`.impter_2, `U`.impter_3, `U`.impter_4, `U`.impter_5, `U`.impter_6, `U`.impter_7, `U`.impter_8, `U`.impter_9, `U`.impter_10, `U`.impter_11 
...
-- Code For temporary table TMP_20180508175820_CODEGEN_4GUR83_ADS_imp_1_OUT part 3. Create Index 

CREATE INDEX `ix_TMP_20180508175820_CODEGEN_4GUR83_ADS_imp_1_OUT_KEY` ON `TMP_20180508175820_CODEGEN_4GUR83_ADS_imp_1_OUT` (`KEY`)

-- Code For temporary table TMP_20180508175820_CODEGEN_U0746H_ADS_sca_2_OUT part 1. Create 


CREATE TEMPORARY TABLE `TMP_20180508175820_CODEGEN_U0746H_ADS_sca_2_OUT` (
	`KEY` BIGINT NOT NULL, 
	scaler_2 DOUBLE, 
	scaler_3 DOUBLE, 
	scaler_4 DOUBLE, 
...
-- Code For temporary table TMP_20180508175820_CODEGEN_U0746H_ADS_sca_2_OUT part 2. Populate

INSERT INTO `TMP_20180508175820_CODEGEN_U0746H_ADS_sca_2_OUT` (`KEY`, scaler_2, scaler_3, scaler_4, scaler_5, scaler_6, scaler_7, scaler_8, scaler_9, scaler_10, scaler_11) SELECT `U`.`KEY`, `U`.scaler_2, `U`.scaler_3, `U`.scaler_4, `U`.scaler_5, `U`.scaler_6, `U`.scaler_7, `U`.scaler_8, `U`.scaler_9, `U`.scaler_10, `U`.scaler_11 
...
FROM `TMP_20180508175820_CODEGEN_4GUR83_ADS_imp_1_OUT` AS `ADS_imp_1_OUT`) AS `ADS_sca_2_OUT`) AS `U`

-- Code For temporary table TMP_20180508175820_CODEGEN_U0746H_ADS_sca_2_OUT part 3. Create Index 

CREATE INDEX `ix_TMP_20180508175820_CODEGEN_U0746H_ADS_sca_2_OUT_KEY` ON `TMP_20180508175820_CODEGEN_U0746H_ADS_sca_2_OUT` (`KEY`)

-- Model deployment code

WITH centered_data AS 
(SELECT `ADS_sca_2_OUT`.`KEY` AS `KEY`, `ADS_sca_2_OUT`.scaler_2 - 0.6608885522985145 AS scaler_2_0, `ADS_sca_2_OUT`.scaler_3 - 0.05011958986810387 AS scaler_3_0, `ADS_sca_2_OUT`.scaler_4 - 0.010237135493869304 AS scaler_4_0, `ADS_sca_2_OUT`.scaler_5 - -0.1134260581927905 AS scaler_5_0, `ADS_sca_2_OUT`.scaler_6 - 0.091931902073065 AS scaler_6_0, `ADS_sca_2_OUT`.scaler_7 - 0.026957993139275754 AS scaler_7_0, `ADS_sca_2_OUT`.scaler_8 - 0.19931034565274267 AS scaler_8_0, `ADS_sca_2_OUT`.scaler_9 - 0.6831306672271085 AS scaler_9_0, `ADS_sca_2_OUT`.scaler_10 - -0.05290181072678812 AS scaler_10_0, `ADS_sca_2_OUT`.scaler_11 - -0.6905707153132041 AS scaler_11_0, `ADS_sca_2_OUT`.scaler_2 - -0.6608885522985144 AS scaler_2_1, `ADS_sca_2_OUT`.scaler_3 - -0.05011958986810381 AS scaler_3_1, `ADS_sca_2_OUT`.scaler_4 - -0.010237135493869402 AS scaler_4_1, `ADS_sca_2_OUT`.scaler_5 - 0.11342605819279053 AS scaler_5_1, `ADS_sca_2_OUT`.scaler_6 - -0.09193190207306502 AS scaler_6_1, `ADS_sca_2_OUT`.scaler_7 - -0.02695799313927582 AS scaler_7_1, `ADS_sca_2_OUT`.scaler_8 - -0.19931034565274264 AS scaler_8_1, `ADS_sca_2_OUT`.scaler_9 - -0.6831306672271085 AS scaler_9_1, `ADS_sca_2_OUT`.scaler_10 - 0.05290181072678807 AS scaler_10_1, `ADS_sca_2_OUT`.scaler_11 - 0.6905707153132041 AS scaler_11_1 
FROM `TMP_20180508175820_CODEGEN_U0746H_ADS_sca_2_OUT` AS `ADS_sca_2_OUT`), 
`NaiveBayes_data` AS 
