...
-- Code For temporary table ##TMP_20180516110324_CODEGEN_APB7SQ_ADS_imp_1_OUT part 1. Create 


CREATE TABLE ##TMP_20180516110324_CODEGEN_APB7SQ_ADS_imp_1_OUT (
	[KEY] BIGINT NULL, 
...
-- Code For temporary table ##TMP_20180516110324_CODEGEN_APB7SQ_ADS_imp_1_OUT part 2. Populate

INSERT INTO ##TMP_20180516110324_CODEGEN_APB7SQ_ADS_imp_1_OUT ([KEY], impter_2, impter_3, impter_4, impter_5, impter_6, impter_7, impter_8, impter_9, impter_10, impter_11) SELECT [ADS_imp_1_OUT].[KEY], [ADS_imp_1_OUT].impter_2, [ADS_imp_1_OUT].impter_3, [ADS_imp_1_OUT].impter_4, [ADS_imp_1_OUT].impter_5, [ADS_imp_1_OUT].impter_6, [ADS_imp_1_OUT].impter_7, [ADS_imp_1_OUT].impter_8, [ADS_imp_1_OUT].impter_9, [ADS_imp_1_OUT].impter_10, [ADS_imp_1_OUT].impter_11 
...
-- Code For temporary table ##TMP_20180516110324_CODEGEN_UWEHAP_ADS_sca_2_OUT part 1. Create 


CREATE TABLE ##TMP_20180516110324_CODEGEN_UWEHAP_ADS_sca_2_OUT (
	[KEY] BIGINT NULL, 
	scaler_2 FLOAT NULL, 
	scaler_3 FLOAT NULL, 
	scaler_4 FLOAT NULL, 
...
FROM ##TMP_20180516110324_CODEGEN_APB7SQ_ADS_imp_1_OUT AS [ADS_imp_1_OUT]) AS [ADS_sca_2_OUT]

-- Code For temporary table ##TMP_20180516110324_CODEGEN_LPT2EA_NaiveBayes_Scores part 1. Create 


CREATE TABLE ##TMP_20180516110324_CODEGEN_LPT2EA_NaiveBayes_Scores (
	[KEY] BIGINT NULL, 
	[Score_0] FLOAT NULL, 
	[Score_1] FLOAT NULL
)
...
-- Code For temporary table ##TMP_20180516110324_CODEGEN_LPT2EA_NaiveBayes_Scores part 2. Populate

WITH centered_data AS 
(SELECT [ADS_sca_2_OUT].[KEY] AS [KEY], CAST([ADS_sca_2_OUT].scaler_2 AS FLOAT(53)) - 0.6608885522985145 AS scaler_2_0, CAST([ADS_sca_2_OUT].scaler_3 AS FLOAT(53)) - 0.05011958986810387 AS scaler_3_0, CAST([ADS_sca_2_OUT].scaler_4 AS FLOAT(53)) - 0.010237135493869304 AS scaler_4_0, CAST([ADS_sca_2_OUT].scaler_5 AS FLOAT(53)) - -0.1134260581927905 AS scaler_5_0, CAST([ADS_sca_2_OUT].scaler_6 AS FLOAT(53)) - 0.091931902073065 AS scaler_6_0, CAST([ADS_sca_2_OUT].scaler_7 AS FLOAT(53)) - 0.026957993139275754 AS scaler_7_0, CAST([ADS_sca_2_OUT].scaler_8 AS FLOAT(53)) - 0.19931034565274267 AS scaler_8_0, CAST([ADS_sca_2_OUT].scaler_9 AS FLOAT(53)) - 0.6831306672271085 AS scaler_9_0, CAST([ADS_sca_2_OUT].scaler_10 AS FLOAT(53)) - -0.05290181072678812 AS scaler_10_0, CAST([ADS_sca_2_OUT].scaler_11 AS FLOAT(53)) - -0.6905707153132041 AS scaler_11_0, CAST([ADS_sca_2_OUT].scaler_2 AS FLOAT(53)) - -0.6608885522985144 AS scaler_2_1, CAST([ADS_sca_2_OUT].scaler_3 AS FLOAT(53)) - -0.05011958986810381 AS scaler_3_1, CAST([ADS_sca_2_OUT].scaler_4 AS FLOAT(53)) - -0.010237135493869402 AS scaler_4_1, CAST([ADS_sca_2_OUT].scaler_5 AS FLOAT(53)) - 0.11342605819279053 AS scaler_5_1, CAST([ADS_sca_2_OUT].scaler_6 AS FLOAT(53)) - -0.09193190207306502 AS scaler_6_1, CAST([ADS_sca_2_OUT].scaler_7 AS FLOAT(53)) - -0.02695799313927582 AS scaler_7_1, CAST([ADS_sca_2_OUT].scaler_8 AS FLOAT(53)) - -0.19931034565274264 AS scaler_8_1, CAST([ADS_sca_2_OUT].scaler_9 AS FLOAT(53)) - -0.6831306672271085 AS scaler_9_1, CAST([ADS_sca_2_OUT].scaler_10 AS FLOAT(53)) - 0.05290181072678807 AS scaler_10_1, CAST([ADS_sca_2_OUT].scaler_11 AS FLOAT(53)) - 0.6905707153132041 AS scaler_11_1 
FROM ##TMP_20180516110324_CODEGEN_UWEHAP_ADS_sca_2_OUT AS [ADS_sca_2_OUT]), 
[NaiveBayes_data] AS 
...
FROM centered_data) AS [Values])
 INSERT INTO ##TMP_20180516110324_CODEGEN_LPT2EA_NaiveBayes_Scores ([KEY], [Score_0], [Score_1]) SELECT [NaiveBayes_Scores].[KEY], [NaiveBayes_Scores].[Score_0], [NaiveBayes_Scores].[Score_1] 
...
FROM ##TMP_20180516110324_CODEGEN_LPT2EA_NaiveBayes_Scores AS [NaiveBayes_Scores]), 
