...
-- Code For temporary table TMP_20180516_CODEGEN_RO3A5N_ADS part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180516_CODEGEN_RO3A5N_ADS" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20180516_CODEGEN_RO3A5N_ADS part 2. Populate

INSERT INTO "TMP_20180516_CODEGEN_RO3A5N_ADS" ("KEY", impter_2, impter_3, impter_4, impter_5, impter_6, impter_7, impter_8, impter_9, impter_10, impter_11) SELECT "U"."KEY", "U".impter_2, "U".impter_3, "U".impter_4, "U".impter_5, "U".impter_6, "U".impter_7, "U".impter_8, "U".impter_9, "U".impter_10, "U".impter_11 
...
-- Code For temporary table TMP_20180516_CODEGEN_RO3A5N_ADS part 3. Create Index 

CREATE INDEX "ix_TMP_20180516_CODEGEN_c750" ON "TMP_20180516_CODEGEN_RO3A5N_ADS" ("KEY")

-- Code For temporary table TMP_20180516_CODEGEN_MG93KP_ADS part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180516_CODEGEN_MG93KP_ADS" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20180516_CODEGEN_MG93KP_ADS part 2. Populate

INSERT INTO "TMP_20180516_CODEGEN_MG93KP_ADS" ("KEY", scaler_2, scaler_3, scaler_4, scaler_5, scaler_6, scaler_7, scaler_8, scaler_9, scaler_10, scaler_11) SELECT "U"."KEY", "U".scaler_2, "U".scaler_3, "U".scaler_4, "U".scaler_5, "U".scaler_6, "U".scaler_7, "U".scaler_8, "U".scaler_9, "U".scaler_10, "U".scaler_11 
...
FROM "TMP_20180516_CODEGEN_RO3A5N_ADS" AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT") AS "U"

-- Code For temporary table TMP_20180516_CODEGEN_MG93KP_ADS part 3. Create Index 

CREATE INDEX "ix_TMP_20180516_CODEGEN_2338" ON "TMP_20180516_CODEGEN_MG93KP_ADS" ("KEY")

-- Code For temporary table TMP_20180516_CODEGEN_EZKGM7_NAI part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180516_CODEGEN_EZKGM7_NAI" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20180516_CODEGEN_EZKGM7_NAI part 2. Populate

INSERT INTO "TMP_20180516_CODEGEN_EZKGM7_NAI" ("KEY", "Score_0", "Score_1") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1" 
FROM (WITH centered_data AS 
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", CAST("ADS_sca_2_OUT".scaler_2 AS DOUBLE PRECISION) - 0.6608885522985145 AS scaler_2_0, CAST("ADS_sca_2_OUT".scaler_3 AS DOUBLE PRECISION) - 0.05011958986810387 AS scaler_3_0, CAST("ADS_sca_2_OUT".scaler_4 AS DOUBLE PRECISION) - 0.010237135493869304 AS scaler_4_0, CAST("ADS_sca_2_OUT".scaler_5 AS DOUBLE PRECISION) - -0.1134260581927905 AS scaler_5_0, CAST("ADS_sca_2_OUT".scaler_6 AS DOUBLE PRECISION) - 0.091931902073065 AS scaler_6_0, CAST("ADS_sca_2_OUT".scaler_7 AS DOUBLE PRECISION) - 0.026957993139275754 AS scaler_7_0, CAST("ADS_sca_2_OUT".scaler_8 AS DOUBLE PRECISION) - 0.19931034565274267 AS scaler_8_0, CAST("ADS_sca_2_OUT".scaler_9 AS DOUBLE PRECISION) - 0.6831306672271085 AS scaler_9_0, CAST("ADS_sca_2_OUT".scaler_10 AS DOUBLE PRECISION) - -0.05290181072678812 AS scaler_10_0, CAST("ADS_sca_2_OUT".scaler_11 AS DOUBLE PRECISION) - -0.6905707153132041 AS scaler_11_0, CAST("ADS_sca_2_OUT".scaler_2 AS DOUBLE PRECISION) - -0.6608885522985144 AS scaler_2_1, CAST("ADS_sca_2_OUT".scaler_3 AS DOUBLE PRECISION) - -0.05011958986810381 AS scaler_3_1, CAST("ADS_sca_2_OUT".scaler_4 AS DOUBLE PRECISION) - -0.010237135493869402 AS scaler_4_1, CAST("ADS_sca_2_OUT".scaler_5 AS DOUBLE PRECISION) - 0.11342605819279053 AS scaler_5_1, CAST("ADS_sca_2_OUT".scaler_6 AS DOUBLE PRECISION) - -0.09193190207306502 AS scaler_6_1, CAST("ADS_sca_2_OUT".scaler_7 AS DOUBLE PRECISION) - -0.02695799313927582 AS scaler_7_1, CAST("ADS_sca_2_OUT".scaler_8 AS DOUBLE PRECISION) - -0.19931034565274264 AS scaler_8_1, CAST("ADS_sca_2_OUT".scaler_9 AS DOUBLE PRECISION) - -0.6831306672271085 AS scaler_9_1, CAST("ADS_sca_2_OUT".scaler_10 AS DOUBLE PRECISION) - 0.05290181072678807 AS scaler_10_1, CAST("ADS_sca_2_OUT".scaler_11 AS DOUBLE PRECISION) - 0.6905707153132041 AS scaler_11_1 
FROM "TMP_20180516_CODEGEN_MG93KP_ADS" AS "ADS_sca_2_OUT"), 
"NaiveBayes_data" AS 
...
-- Code For temporary table TMP_20180516_CODEGEN_EZKGM7_NAI part 3. Create Index 

CREATE INDEX "ix_TMP_20180516_CODEGEN_2ec9" ON "TMP_20180516_CODEGEN_EZKGM7_NAI" ("KEY")
...
FROM "TMP_20180516_CODEGEN_EZKGM7_NAI" AS "NaiveBayes_Scores"), 
