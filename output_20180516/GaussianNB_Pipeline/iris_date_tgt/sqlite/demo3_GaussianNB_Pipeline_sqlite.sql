...
-- Code For temporary table TMP_20180602153416_WSY_ADS_imp_1_OUT part 1. Create 


CREATE TEMPORARY TABLE "TMP_20180602153416_WSY_ADS_imp_1_OUT" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20180602153416_WSY_ADS_imp_1_OUT part 2. Populate

INSERT INTO "TMP_20180602153416_WSY_ADS_imp_1_OUT" ("KEY", imputer_output_2, imputer_output_3, imputer_output_4, imputer_output_5) SELECT "ADS_imp_1_OUT"."KEY", "ADS_imp_1_OUT".imputer_output_2, "ADS_imp_1_OUT".imputer_output_3, "ADS_imp_1_OUT".imputer_output_4, "ADS_imp_1_OUT".imputer_output_5 
...
-- Code For temporary table TMP_20180602153416_WSY_ADS_imp_1_OUT part 3. Create Index 

CREATE INDEX "ix_TMP_20180602153416_WSY_ADS_imp_1_OUT_KEY" ON "TMP_20180602153416_WSY_ADS_imp_1_OUT" ("KEY")

-- Code For temporary table TMP_20180602153416_YV3_ADS_sca_2_OUT part 1. Create 


CREATE TEMPORARY TABLE "TMP_20180602153416_YV3_ADS_sca_2_OUT" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20180602153416_YV3_ADS_sca_2_OUT part 2. Populate

INSERT INTO "TMP_20180602153416_YV3_ADS_sca_2_OUT" ("KEY", scaler_output_2, scaler_output_3, scaler_output_4, scaler_output_5) SELECT "ADS_sca_2_OUT"."KEY", "ADS_sca_2_OUT".scaler_output_2, "ADS_sca_2_OUT".scaler_output_3, "ADS_sca_2_OUT".scaler_output_4, "ADS_sca_2_OUT".scaler_output_5 
...
FROM "TMP_20180602153416_WSY_ADS_imp_1_OUT" AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT"

-- Code For temporary table TMP_20180602153416_YV3_ADS_sca_2_OUT part 3. Create Index 

CREATE INDEX "ix_TMP_20180602153416_YV3_ADS_sca_2_OUT_KEY" ON "TMP_20180602153416_YV3_ADS_sca_2_OUT" ("KEY")

-- Code For temporary table TMP_20180602153416_X2L_NaiveBayes_Scores part 1. Create 


CREATE TEMPORARY TABLE "TMP_20180602153416_X2L_NaiveBayes_Scores" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20180602153416_X2L_NaiveBayes_Scores part 2. Populate

WITH centered_data AS 
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", CAST("ADS_sca_2_OUT".scaler_output_2 AS FLOAT) - -1.0737587745357238 AS "scaler_output_2_1789-07-14T00:00:00.000000000", CAST("ADS_sca_2_OUT".scaler_output_3 AS FLOAT) - 0.870008970111042 AS "scaler_output_3_1789-07-14T00:00:00.000000000", CAST("ADS_sca_2_OUT".scaler_output_4 AS FLOAT) - -1.3793950932290453 AS "scaler_output_4_1789-07-14T00:00:00.000000000", CAST("ADS_sca_2_OUT".scaler_output_5 AS FLOAT) - -1.3142779871589043 AS "scaler_output_5_1789-07-14T00:00:00.000000000", CAST("ADS_sca_2_OUT".scaler_output_2 AS FLOAT) - 0.08161645102040865 AS "scaler_output_2_1789-08-14T00:00:00.000000000", CAST("ADS_sca_2_OUT".scaler_output_3 AS FLOAT) - -0.6341793371020635 AS "scaler_output_3_1789-08-14T00:00:00.000000000", CAST("ADS_sca_2_OUT".scaler_output_4 AS FLOAT) - 0.23394313160820315 AS "scaler_output_4_1789-08-14T00:00:00.000000000", CAST("ADS_sca_2_OUT".scaler_output_5 AS FLOAT) - 0.10668484415166186 AS "scaler_output_5_1789-08-14T00:00:00.000000000", CAST("ADS_sca_2_OUT".scaler_output_2 AS FLOAT) - 0.8480096887675768 AS "scaler_output_2_1789-09-14T00:00:00.000000000", CAST("ADS_sca_2_OUT".scaler_output_3 AS FLOAT) - -0.15867810255873832 AS "scaler_output_3_1789-09-14T00:00:00.000000000", CAST("ADS_sca_2_OUT".scaler_output_4 AS FLOAT) - 0.9692998415150353 AS "scaler_output_4_1789-09-14T00:00:00.000000000", CAST("ADS_sca_2_OUT".scaler_output_5 AS FLOAT) - 1.0316486455537892 AS "scaler_output_5_1789-09-14T00:00:00.000000000" 
FROM "TMP_20180602153416_YV3_ADS_sca_2_OUT" AS "ADS_sca_2_OUT"), 
"NaiveBayes_data" AS 
(SELECT "Values"."KEY" AS "KEY", CAST("Values"."Feature" AS FLOAT) AS "Feature", CAST("Values"."log_proba_1789-07-14T00:00:00.000000000" AS FLOAT) AS "log_proba_1789-07-14T00:00:00.000000000", CAST("Values"."log_proba_1789-08-14T00:00:00.000000000" AS FLOAT) AS "log_proba_1789-08-14T00:00:00.000000000", CAST("Values"."log_proba_1789-09-14T00:00:00.000000000" AS FLOAT) AS "log_proba_1789-09-14T00:00:00.000000000" 
...
FROM centered_data) AS "Values")
 INSERT INTO "TMP_20180602153416_X2L_NaiveBayes_Scores" ("KEY", "Score_1789-07-14T00:00:00.000000000", "Score_1789-08-14T00:00:00.000000000", "Score_1789-09-14T00:00:00.000000000") SELECT "NaiveBayes_Scores"."KEY", "NaiveBayes_Scores"."Score_1789-07-14T00:00:00.000000000", "NaiveBayes_Scores"."Score_1789-08-14T00:00:00.000000000", "NaiveBayes_Scores"."Score_1789-09-14T00:00:00.000000000" 
...
-- Code For temporary table TMP_20180602153416_X2L_NaiveBayes_Scores part 3. Create Index 

CREATE INDEX "ix_TMP_20180602153416_X2L_NaiveBayes_Scores_KEY" ON "TMP_20180602153416_X2L_NaiveBayes_Scores" ("KEY")
...
FROM "TMP_20180602153416_X2L_NaiveBayes_Scores" AS "NaiveBayes_Scores"), 
