...
-- Code For temporary table TMP_20180508181234_CODEGEN_OZ7E part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508181234_CODEGEN_OZ7E" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20180508181234_CODEGEN_OZ7E part 2. Populate

INSERT INTO "TMP_20180508181234_CODEGEN_OZ7E" ("KEY", impter_2, impter_3, impter_4, impter_5, impter_6, impter_7, impter_8, impter_9, impter_10, impter_11) SELECT "U"."KEY", "U".impter_2, "U".impter_3, "U".impter_4, "U".impter_5, "U".impter_6, "U".impter_7, "U".impter_8, "U".impter_9, "U".impter_10, "U".impter_11 
...
-- Code For temporary table TMP_20180508181234_CODEGEN_OZ7E part 3. Create Index 

CREATE INDEX "ix_TMP_20180508181234_C_e33f" ON "TMP_20180508181234_CODEGEN_OZ7E" ("KEY")

-- Code For temporary table TMP_20180508181234_CODEGEN_YKGT part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508181234_CODEGEN_YKGT" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20180508181234_CODEGEN_YKGT part 2. Populate

INSERT INTO "TMP_20180508181234_CODEGEN_YKGT" ("KEY", scaler_2, scaler_3, scaler_4, scaler_5, scaler_6, scaler_7, scaler_8, scaler_9, scaler_10, scaler_11) SELECT "U"."KEY", "U".scaler_2, "U".scaler_3, "U".scaler_4, "U".scaler_5, "U".scaler_6, "U".scaler_7, "U".scaler_8, "U".scaler_9, "U".scaler_10, "U".scaler_11 
...
FROM "TMP_20180508181234_CODEGEN_OZ7E" AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT") AS "U"

-- Code For temporary table TMP_20180508181234_CODEGEN_YKGT part 3. Create Index 

CREATE INDEX "ix_TMP_20180508181234_C_c2fe" ON "TMP_20180508181234_CODEGEN_YKGT" ("KEY")
...
FROM "TMP_20180508181234_CODEGEN_YKGT" AS "ADS_sca_2_OUT"), 
"NaiveBayes_data" AS 
