...
-- Code For temporary table ##TMP_20180602160309_O2M_ADS_imp_1_OUT part 1. Create 


CREATE TABLE ##TMP_20180602160309_O2M_ADS_imp_1_OUT (
	[KEY] BIGINT NULL, 
...
-- Code For temporary table ##TMP_20180602160309_O2M_ADS_imp_1_OUT part 2. Populate

INSERT INTO ##TMP_20180602160309_O2M_ADS_imp_1_OUT ([KEY], imputer_output_2, imputer_output_3, imputer_output_4, imputer_output_5) SELECT [ADS_imp_1_OUT].[KEY], [ADS_imp_1_OUT].imputer_output_2, [ADS_imp_1_OUT].imputer_output_3, [ADS_imp_1_OUT].imputer_output_4, [ADS_imp_1_OUT].imputer_output_5 
...
-- Code For temporary table ##TMP_20180602160309_5QQ_ADS_sca_2_OUT part 1. Create 


CREATE TABLE ##TMP_20180602160309_5QQ_ADS_sca_2_OUT (
	[KEY] BIGINT NULL, 
...
-- Code For temporary table ##TMP_20180602160309_5QQ_ADS_sca_2_OUT part 2. Populate

INSERT INTO ##TMP_20180602160309_5QQ_ADS_sca_2_OUT ([KEY], scaler_output_2, scaler_output_3, scaler_output_4, scaler_output_5) SELECT [ADS_sca_2_OUT].[KEY], [ADS_sca_2_OUT].scaler_output_2, [ADS_sca_2_OUT].scaler_output_3, [ADS_sca_2_OUT].scaler_output_4, [ADS_sca_2_OUT].scaler_output_5 
...
FROM ##TMP_20180602160309_O2M_ADS_imp_1_OUT AS [ADS_imp_1_OUT]) AS [ADS_sca_2_OUT]

-- Code For temporary table ##TMP_20180602160309_1XM_NaiveBayes_Scores part 1. Create 


CREATE TABLE ##TMP_20180602160309_1XM_NaiveBayes_Scores (
	[KEY] BIGINT NULL, 
...
-- Code For temporary table ##TMP_20180602160309_1XM_NaiveBayes_Scores part 2. Populate

WITH centered_data AS 
(SELECT [ADS_sca_2_OUT].[KEY] AS [KEY], CAST([ADS_sca_2_OUT].scaler_output_2 AS FLOAT(53)) - -1.0737587745357238 AS [scaler_output_2_CLASS_0], CAST([ADS_sca_2_OUT].scaler_output_3 AS FLOAT(53)) - 0.870008970111042 AS [scaler_output_3_CLASS_0], CAST([ADS_sca_2_OUT].scaler_output_4 AS FLOAT(53)) - -1.3793950932290453 AS [scaler_output_4_CLASS_0], CAST([ADS_sca_2_OUT].scaler_output_5 AS FLOAT(53)) - -1.3142779871589043 AS [scaler_output_5_CLASS_0], CAST([ADS_sca_2_OUT].scaler_output_2 AS FLOAT(53)) - 0.08161645102040865 AS [scaler_output_2_CLASS_1], CAST([ADS_sca_2_OUT].scaler_output_3 AS FLOAT(53)) - -0.6341793371020635 AS [scaler_output_3_CLASS_1], CAST([ADS_sca_2_OUT].scaler_output_4 AS FLOAT(53)) - 0.23394313160820315 AS [scaler_output_4_CLASS_1], CAST([ADS_sca_2_OUT].scaler_output_5 AS FLOAT(53)) - 0.10668484415166186 AS [scaler_output_5_CLASS_1], CAST([ADS_sca_2_OUT].scaler_output_2 AS FLOAT(53)) - 0.8480096887675768 AS [scaler_output_2_CLASS_2], CAST([ADS_sca_2_OUT].scaler_output_3 AS FLOAT(53)) - -0.15867810255873832 AS [scaler_output_3_CLASS_2], CAST([ADS_sca_2_OUT].scaler_output_4 AS FLOAT(53)) - 0.9692998415150353 AS [scaler_output_4_CLASS_2], CAST([ADS_sca_2_OUT].scaler_output_5 AS FLOAT(53)) - 1.0316486455537892 AS [scaler_output_5_CLASS_2] 
FROM ##TMP_20180602160309_5QQ_ADS_sca_2_OUT AS [ADS_sca_2_OUT]), 
[NaiveBayes_data] AS 
(SELECT [Values].[KEY] AS [KEY], CAST([Values].[Feature] AS FLOAT(53)) AS [Feature], CAST([Values].[log_proba_CLASS_0] AS FLOAT(53)) AS [log_proba_CLASS_0], CAST([Values].[log_proba_CLASS_1] AS FLOAT(53)) AS [log_proba_CLASS_1], CAST([Values].[log_proba_CLASS_2] AS FLOAT(53)) AS [log_proba_CLASS_2] 
...
FROM centered_data) AS [Values])
 INSERT INTO ##TMP_20180602160309_1XM_NaiveBayes_Scores ([KEY], [Score_CLASS_0], [Score_CLASS_1], [Score_CLASS_2]) SELECT [NaiveBayes_Scores].[KEY], [NaiveBayes_Scores].[Score_CLASS_0], [NaiveBayes_Scores].[Score_CLASS_1], [NaiveBayes_Scores].[Score_CLASS_2] 
...
FROM ##TMP_20180602160309_1XM_NaiveBayes_Scores AS [NaiveBayes_Scores]), 
