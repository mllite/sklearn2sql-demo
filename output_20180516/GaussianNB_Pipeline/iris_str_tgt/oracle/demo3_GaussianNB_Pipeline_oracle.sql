...
-- Code For temporary table 20180602_TJR_ADS_IMP_1_OUT part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "20180602_TJR_ADS_IMP_1_OUT" (
	"KEY" NUMBER(19), 
...
-- Code For temporary table 20180602_TJR_ADS_IMP_1_OUT part 2. Populate

INSERT INTO "20180602_TJR_ADS_IMP_1_OUT" ("KEY", imputer_output_2, imputer_output_3, imputer_output_4, imputer_output_5) SELECT "U"."KEY", "U".imputer_output_2, "U".imputer_output_3, "U".imputer_output_4, "U".imputer_output_5 
...
-- Code For temporary table 20180602_0GP_ADS_SCA_2_OUT part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "20180602_0GP_ADS_SCA_2_OUT" (
	"KEY" NUMBER(19), 
...
-- Code For temporary table 20180602_0GP_ADS_SCA_2_OUT part 2. Populate

INSERT INTO "20180602_0GP_ADS_SCA_2_OUT" ("KEY", scaler_output_2, scaler_output_3, scaler_output_4, scaler_output_5) SELECT "U"."KEY", "U".scaler_output_2, "U".scaler_output_3, "U".scaler_output_4, "U".scaler_output_5 
...
FROM "20180602_TJR_ADS_IMP_1_OUT" "ADS_imp_1_OUT") "ADS_sca_2_OUT") "U"

-- Code For temporary table 0602_X8P_NAIVEBAYES_SCORES part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "0602_X8P_NAIVEBAYES_SCORES" (
	"KEY" NUMBER(19), 
...
-- Code For temporary table 0602_X8P_NAIVEBAYES_SCORES part 2. Populate

INSERT INTO "0602_X8P_NAIVEBAYES_SCORES" ("KEY", "Score_CLASS_0", "Score_CLASS_1", "Score_CLASS_2") SELECT "U"."KEY", "U"."Score_CLASS_0", "U"."Score_CLASS_1", "U"."Score_CLASS_2" 
FROM (WITH centered_data AS 
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", CAST("ADS_sca_2_OUT".scaler_output_2 AS BINARY_DOUBLE) - -1.0737587745357238 AS "scaler_output_2_CLASS_0", CAST("ADS_sca_2_OUT".scaler_output_3 AS BINARY_DOUBLE) - 0.870008970111042 AS "scaler_output_3_CLASS_0", CAST("ADS_sca_2_OUT".scaler_output_4 AS BINARY_DOUBLE) - -1.3793950932290453 AS "scaler_output_4_CLASS_0", CAST("ADS_sca_2_OUT".scaler_output_5 AS BINARY_DOUBLE) - -1.3142779871589043 AS "scaler_output_5_CLASS_0", CAST("ADS_sca_2_OUT".scaler_output_2 AS BINARY_DOUBLE) - 0.08161645102040865 AS "scaler_output_2_CLASS_1", CAST("ADS_sca_2_OUT".scaler_output_3 AS BINARY_DOUBLE) - -0.6341793371020635 AS "scaler_output_3_CLASS_1", CAST("ADS_sca_2_OUT".scaler_output_4 AS BINARY_DOUBLE) - 0.23394313160820315 AS "scaler_output_4_CLASS_1", CAST("ADS_sca_2_OUT".scaler_output_5 AS BINARY_DOUBLE) - 0.10668484415166186 AS "scaler_output_5_CLASS_1", CAST("ADS_sca_2_OUT".scaler_output_2 AS BINARY_DOUBLE) - 0.8480096887675768 AS "scaler_output_2_CLASS_2", CAST("ADS_sca_2_OUT".scaler_output_3 AS BINARY_DOUBLE) - -0.15867810255873832 AS "scaler_output_3_CLASS_2", CAST("ADS_sca_2_OUT".scaler_output_4 AS BINARY_DOUBLE) - 0.9692998415150353 AS "scaler_output_4_CLASS_2", CAST("ADS_sca_2_OUT".scaler_output_5 AS BINARY_DOUBLE) - 1.0316486455537892 AS "scaler_output_5_CLASS_2" 
FROM "20180602_0GP_ADS_SCA_2_OUT" "ADS_sca_2_OUT"), 
"NaiveBayes_data" AS 
(SELECT "Values"."KEY" AS "KEY", CAST("Values"."Feature" AS BINARY_DOUBLE) AS "Feature", CAST("Values"."log_proba_CLASS_0" AS BINARY_DOUBLE) AS "log_proba_CLASS_0", CAST("Values"."log_proba_CLASS_1" AS BINARY_DOUBLE) AS "log_proba_CLASS_1", CAST("Values"."log_proba_CLASS_2" AS BINARY_DOUBLE) AS "log_proba_CLASS_2" 
...
FROM "0602_X8P_NAIVEBAYES_SCORES" "NaiveBayes_Scores"), 
