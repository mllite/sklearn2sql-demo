...
-- Code For temporary table tmp_20180602160309_uwp_ads_imp_1_out part 1. Create 


CREATE TABLE tmp_20180602160309_uwp_ads_imp_1_out (
	`KEY` BIGINT, 
...
-- Code For temporary table tmp_20180602160309_uwp_ads_imp_1_out part 2. Populate

INSERT INTO tmp_20180602160309_uwp_ads_imp_1_out (`KEY`, imputer_output_2, imputer_output_3, imputer_output_4, imputer_output_5) SELECT `ADS_imp_1_OUT`.`KEY`, `ADS_imp_1_OUT`.imputer_output_2, `ADS_imp_1_OUT`.imputer_output_3, `ADS_imp_1_OUT`.imputer_output_4, `ADS_imp_1_OUT`.imputer_output_5 
...
-- Code For temporary table tmp_20180602160309_l4r_ads_sca_2_out part 1. Create 


CREATE TABLE tmp_20180602160309_l4r_ads_sca_2_out (
	`KEY` BIGINT, 
...
-- Code For temporary table tmp_20180602160309_l4r_ads_sca_2_out part 2. Populate

INSERT INTO tmp_20180602160309_l4r_ads_sca_2_out (`KEY`, scaler_output_2, scaler_output_3, scaler_output_4, scaler_output_5) SELECT `ADS_sca_2_OUT`.`KEY`, `ADS_sca_2_OUT`.scaler_output_2, `ADS_sca_2_OUT`.scaler_output_3, `ADS_sca_2_OUT`.scaler_output_4, `ADS_sca_2_OUT`.scaler_output_5 
...
FROM tmp_20180602160309_uwp_ads_imp_1_out AS `ADS_imp_1_OUT`) AS `ADS_sca_2_OUT`

-- Code For temporary table tmp_20180602160309_dzi_naivebayes_scores part 1. Create 


CREATE TABLE tmp_20180602160309_dzi_naivebayes_scores (
	`KEY` BIGINT, 
...
-- Code For temporary table tmp_20180602160309_dzi_naivebayes_scores part 2. Populate
...
FROM tmp_20180602160309_l4r_ads_sca_2_out AS `ADS_sca_2_OUT`), 
`NaiveBayes_data` AS 
...
FROM centered_data) AS `Values`)
 INSERT INTO tmp_20180602160309_dzi_naivebayes_scores (`KEY`, `Score_CLASS_0`, `Score_CLASS_1`, `Score_CLASS_2`) SELECT `NaiveBayes_Scores`.`KEY`, `NaiveBayes_Scores`.`Score_CLASS_0`, `NaiveBayes_Scores`.`Score_CLASS_1`, `NaiveBayes_Scores`.`Score_CLASS_2` 
...
FROM tmp_20180602160309_dzi_naivebayes_scores AS `NaiveBayes_Scores`), 
