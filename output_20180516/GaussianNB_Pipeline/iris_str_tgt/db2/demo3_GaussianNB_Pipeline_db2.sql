...
-- Code For temporary table tmp_20180602160313_zn3_ads_imp_1_out part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180602160313_zn3_ads_imp_1_out (
	"KEY" BIGINT, 
...
-- Code For temporary table tmp_20180602160313_zn3_ads_imp_1_out part 2. Populate

INSERT INTO tmp_20180602160313_zn3_ads_imp_1_out SELECT "ADS_imp_1_OUT"."KEY", "ADS_imp_1_OUT".imputer_output_2, "ADS_imp_1_OUT".imputer_output_3, "ADS_imp_1_OUT".imputer_output_4, "ADS_imp_1_OUT".imputer_output_5 
...
-- Code For temporary table tmp_20180602160313_29t_ads_sca_2_out part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180602160313_29t_ads_sca_2_out (
	"KEY" BIGINT, 
...
-- Code For temporary table tmp_20180602160313_29t_ads_sca_2_out part 2. Populate

INSERT INTO tmp_20180602160313_29t_ads_sca_2_out SELECT "ADS_sca_2_OUT"."KEY", "ADS_sca_2_OUT".scaler_output_2, "ADS_sca_2_OUT".scaler_output_3, "ADS_sca_2_OUT".scaler_output_4, "ADS_sca_2_OUT".scaler_output_5 
...
FROM tmp_20180602160313_zn3_ads_imp_1_out AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT"

-- Code For temporary table tmp_20180602160313_uwn_naivebayes_scores part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180602160313_uwn_naivebayes_scores (
	"KEY" BIGINT, 
...
-- Code For temporary table tmp_20180602160313_uwn_naivebayes_scores part 2. Populate

INSERT INTO tmp_20180602160313_uwn_naivebayes_scores WITH centered_data AS 
...
FROM tmp_20180602160313_29t_ads_sca_2_out AS "ADS_sca_2_OUT"), 
"NaiveBayes_data" AS 
...
FROM tmp_20180602160313_uwn_naivebayes_scores AS "NaiveBayes_Scores"), 
