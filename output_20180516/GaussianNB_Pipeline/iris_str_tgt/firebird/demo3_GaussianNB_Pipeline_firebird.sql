...
-- Code For temporary table TMP_20180602_M8V_ADS_IMP_1_OUT part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180602_M8V_ADS_IMP_1_OUT" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20180602_M8V_ADS_IMP_1_OUT part 2. Populate

INSERT INTO "TMP_20180602_M8V_ADS_IMP_1_OUT" ("KEY", imputer_output_2, imputer_output_3, imputer_output_4, imputer_output_5) SELECT "U"."KEY", "U".imputer_output_2, "U".imputer_output_3, "U".imputer_output_4, "U".imputer_output_5 
...
-- Code For temporary table TMP_20180602_M8V_ADS_IMP_1_OUT part 3. Create Index 

CREATE INDEX "ix_TMP_20180602_M8V_ADS_2154" ON "TMP_20180602_M8V_ADS_IMP_1_OUT" ("KEY")

-- Code For temporary table TMP_20180602_PJZ_ADS_SCA_2_OUT part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180602_PJZ_ADS_SCA_2_OUT" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20180602_PJZ_ADS_SCA_2_OUT part 2. Populate

INSERT INTO "TMP_20180602_PJZ_ADS_SCA_2_OUT" ("KEY", scaler_output_2, scaler_output_3, scaler_output_4, scaler_output_5) SELECT "U"."KEY", "U".scaler_output_2, "U".scaler_output_3, "U".scaler_output_4, "U".scaler_output_5 
...
FROM "TMP_20180602_M8V_ADS_IMP_1_OUT" AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT") AS "U"

-- Code For temporary table TMP_20180602_PJZ_ADS_SCA_2_OUT part 3. Create Index 

CREATE INDEX "ix_TMP_20180602_PJZ_ADS_1b6a" ON "TMP_20180602_PJZ_ADS_SCA_2_OUT" ("KEY")

-- Code For temporary table TMP_20180602_QAN_NAIVEBAYES_SCO part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180602_QAN_NAIVEBAYES_SCO" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20180602_QAN_NAIVEBAYES_SCO part 2. Populate

INSERT INTO "TMP_20180602_QAN_NAIVEBAYES_SCO" ("KEY", "Score_CLASS_0", "Score_CLASS_1", "Score_CLASS_2") SELECT "U"."KEY", "U"."Score_CLASS_0", "U"."Score_CLASS_1", "U"."Score_CLASS_2" 
FROM (WITH centered_data AS 
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", CAST("ADS_sca_2_OUT".scaler_output_2 AS DOUBLE PRECISION) - -1.0737587745357238 AS "scaler_output_2_CLASS_0", CAST("ADS_sca_2_OUT".scaler_output_3 AS DOUBLE PRECISION) - 0.870008970111042 AS "scaler_output_3_CLASS_0", CAST("ADS_sca_2_OUT".scaler_output_4 AS DOUBLE PRECISION) - -1.3793950932290453 AS "scaler_output_4_CLASS_0", CAST("ADS_sca_2_OUT".scaler_output_5 AS DOUBLE PRECISION) - -1.3142779871589043 AS "scaler_output_5_CLASS_0", CAST("ADS_sca_2_OUT".scaler_output_2 AS DOUBLE PRECISION) - 0.08161645102040865 AS "scaler_output_2_CLASS_1", CAST("ADS_sca_2_OUT".scaler_output_3 AS DOUBLE PRECISION) - -0.6341793371020635 AS "scaler_output_3_CLASS_1", CAST("ADS_sca_2_OUT".scaler_output_4 AS DOUBLE PRECISION) - 0.23394313160820315 AS "scaler_output_4_CLASS_1", CAST("ADS_sca_2_OUT".scaler_output_5 AS DOUBLE PRECISION) - 0.10668484415166186 AS "scaler_output_5_CLASS_1", CAST("ADS_sca_2_OUT".scaler_output_2 AS DOUBLE PRECISION) - 0.8480096887675768 AS "scaler_output_2_CLASS_2", CAST("ADS_sca_2_OUT".scaler_output_3 AS DOUBLE PRECISION) - -0.15867810255873832 AS "scaler_output_3_CLASS_2", CAST("ADS_sca_2_OUT".scaler_output_4 AS DOUBLE PRECISION) - 0.9692998415150353 AS "scaler_output_4_CLASS_2", CAST("ADS_sca_2_OUT".scaler_output_5 AS DOUBLE PRECISION) - 1.0316486455537892 AS "scaler_output_5_CLASS_2" 
FROM "TMP_20180602_PJZ_ADS_SCA_2_OUT" AS "ADS_sca_2_OUT"), 
"NaiveBayes_data" AS 
...
FROM centered_data UNION ALL SELECT centered_data."KEY" AS "KEY", 1 AS "Feature", -0.5 * 1.6176992712861724 - (0.5 * centered_data."scaler_output_3_CLASS_0" * centered_data."scaler_output_3_CLASS_0") / 0.8023761267174477 AS "log_proba_CLASS_0", -0.5 * 1.2703633982695903 - (0.5 * centered_data."scaler_output_3_CLASS_1" * centered_data."scaler_output_3_CLASS_1") / 0.566933272060774 AS "log_proba_CLASS_1", -0.5 * 1.188361783672836 - (0.5 * centered_data."scaler_output_3_CLASS_2" * centered_data."scaler_output_3_CLASS_2") / 0.5222988826987977 AS "log_proba_CLASS_2" 
FROM centered_data UNION ALL SELECT centered_data."KEY" AS "KEY", 2 AS "Feature", -0.5 * -2.8627124529802606 - (0.5 * centered_data."scaler_output_4_CLASS_0" * centered_data."scaler_output_4_CLASS_0") / 0.009089916839634978 AS "log_proba_CLASS_0", -0.5 * -0.704680569700576 - (0.5 * centered_data."scaler_output_4_CLASS_1" * centered_data."scaler_output_4_CLASS_1") / 0.0786649459713098 AS "log_proba_CLASS_1", -0.5 * -0.6630042730802398 - (0.5 * centered_data."scaler_output_4_CLASS_2" * centered_data."scaler_output_4_CLASS_2") / 0.08201268574388819 AS "log_proba_CLASS_2" 
FROM centered_data UNION ALL SELECT centered_data."KEY" AS "KEY", 3 AS "Feature", -0.5 * -1.9540850615939565 - (0.5 * centered_data."scaler_output_5_CLASS_0" * centered_data."scaler_output_5_CLASS_0") / 0.022551309855470963 AS "log_proba_CLASS_0", -0.5 * -0.7476146898927448 - (0.5 * centered_data."scaler_output_5_CLASS_1" * centered_data."scaler_output_5_CLASS_1") / 0.07535901221863746 AS "log_proba_CLASS_1", -0.5 * -0.1282298413813872 - (0.5 * centered_data."scaler_output_5_CLASS_2" * centered_data."scaler_output_5_CLASS_2") / 0.14000083280397102 AS "log_proba_CLASS_2" 
...
-- Code For temporary table TMP_20180602_QAN_NAIVEBAYES_SCO part 3. Create Index 

CREATE INDEX "ix_TMP_20180602_QAN_NAI_17db" ON "TMP_20180602_QAN_NAIVEBAYES_SCO" ("KEY")
...
FROM "TMP_20180602_QAN_NAIVEBAYES_SCO" AS "NaiveBayes_Scores"), 
