...
-- Code For temporary table tmp_20180602160310_j2n_ads_imp_1_out part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180602160310_j2n_ads_imp_1_out  (
	"KEY" BIGINT, 
...
-- Code For temporary table tmp_20180602160310_j2n_ads_imp_1_out part 2. Populate

INSERT INTO tmp_20180602160310_j2n_ads_imp_1_out ("KEY", imputer_output_2, imputer_output_3, imputer_output_4, imputer_output_5) SELECT "U"."KEY", "U".imputer_output_2, "U".imputer_output_3, "U".imputer_output_4, "U".imputer_output_5 
...
-- Code For temporary table tmp_20180602160310_kg4_ads_sca_2_out part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180602160310_kg4_ads_sca_2_out  (
	"KEY" BIGINT, 
...
-- Code For temporary table tmp_20180602160310_kg4_ads_sca_2_out part 2. Populate

INSERT INTO tmp_20180602160310_kg4_ads_sca_2_out ("KEY", scaler_output_2, scaler_output_3, scaler_output_4, scaler_output_5) SELECT "U"."KEY", "U".scaler_output_2, "U".scaler_output_3, "U".scaler_output_4, "U".scaler_output_5 
...
FROM tmp_20180602160310_j2n_ads_imp_1_out AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT") AS "U"

-- Code For temporary table tmp_20180602160310_ndi_naivebayes_scores part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180602160310_ndi_naivebayes_scores  (
	"KEY" BIGINT, 
...
-- Code For temporary table tmp_20180602160310_ndi_naivebayes_scores part 2. Populate

INSERT INTO tmp_20180602160310_ndi_naivebayes_scores ("KEY", "Score_CLASS_0", "Score_CLASS_1", "Score_CLASS_2") SELECT "U"."KEY", "U"."Score_CLASS_0", "U"."Score_CLASS_1", "U"."Score_CLASS_2" 
FROM (WITH centered_data AS 
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", CAST("ADS_sca_2_OUT".scaler_output_2 AS DOUBLE PRECISION) - CAST(-1.073758774535724 AS DOUBLE PRECISION) AS "scaler_output_2_CLASS_0", CAST("ADS_sca_2_OUT".scaler_output_3 AS DOUBLE PRECISION) - CAST(0.870008970111042 AS DOUBLE PRECISION) AS "scaler_output_3_CLASS_0", CAST("ADS_sca_2_OUT".scaler_output_4 AS DOUBLE PRECISION) - CAST(-1.379395093229045 AS DOUBLE PRECISION) AS "scaler_output_4_CLASS_0", CAST("ADS_sca_2_OUT".scaler_output_5 AS DOUBLE PRECISION) - CAST(-1.314277987158904 AS DOUBLE PRECISION) AS "scaler_output_5_CLASS_0", CAST("ADS_sca_2_OUT".scaler_output_2 AS DOUBLE PRECISION) - CAST(0.081616451020409 AS DOUBLE PRECISION) AS "scaler_output_2_CLASS_1", CAST("ADS_sca_2_OUT".scaler_output_3 AS DOUBLE PRECISION) - CAST(-0.634179337102064 AS DOUBLE PRECISION) AS "scaler_output_3_CLASS_1", CAST("ADS_sca_2_OUT".scaler_output_4 AS DOUBLE PRECISION) - CAST(0.233943131608203 AS DOUBLE PRECISION) AS "scaler_output_4_CLASS_1", CAST("ADS_sca_2_OUT".scaler_output_5 AS DOUBLE PRECISION) - CAST(0.106684844151662 AS DOUBLE PRECISION) AS "scaler_output_5_CLASS_1", CAST("ADS_sca_2_OUT".scaler_output_2 AS DOUBLE PRECISION) - CAST(0.848009688767577 AS DOUBLE PRECISION) AS "scaler_output_2_CLASS_2", CAST("ADS_sca_2_OUT".scaler_output_3 AS DOUBLE PRECISION) - CAST(-0.158678102558738 AS DOUBLE PRECISION) AS "scaler_output_3_CLASS_2", CAST("ADS_sca_2_OUT".scaler_output_4 AS DOUBLE PRECISION) - CAST(0.969299841515035 AS DOUBLE PRECISION) AS "scaler_output_4_CLASS_2", CAST("ADS_sca_2_OUT".scaler_output_5 AS DOUBLE PRECISION) - CAST(1.031648645553789 AS DOUBLE PRECISION) AS "scaler_output_5_CLASS_2" 
FROM tmp_20180602160310_kg4_ads_sca_2_out AS "ADS_sca_2_OUT"), 
dummy_cte AS 
(SELECT CAST(0.0 AS DOUBLE PRECISION) AS "X"), 
"NaiveBayes_data" AS 
(SELECT "Values"."KEY" AS "KEY", CAST("Values"."Feature" AS DOUBLE PRECISION) AS "Feature", CAST("Values"."log_proba_CLASS_0" AS DOUBLE PRECISION) AS "log_proba_CLASS_0", CAST("Values"."log_proba_CLASS_1" AS DOUBLE PRECISION) AS "log_proba_CLASS_1", CAST("Values"."log_proba_CLASS_2" AS DOUBLE PRECISION) AS "log_proba_CLASS_2" 
FROM (SELECT centered_data."KEY" AS "KEY", 0 AS "Feature", CAST(-0.5 AS DOUBLE PRECISION) * CAST(0.103972660985363 AS DOUBLE PRECISION) - (CAST(0.5 AS DOUBLE PRECISION) * centered_data."scaler_output_2_CLASS_0" * centered_data."scaler_output_2_CLASS_0") / CAST(0.176593569296659 AS DOUBLE PRECISION) AS "log_proba_CLASS_0", CAST(-0.5 AS DOUBLE PRECISION) * CAST(0.987623428488565 AS DOUBLE PRECISION) - (CAST(0.5 AS DOUBLE PRECISION) * centered_data."scaler_output_2_CLASS_1" * centered_data."scaler_output_2_CLASS_1") / CAST(0.427306537061185 AS DOUBLE PRECISION) AS "log_proba_CLASS_1", CAST(-0.5 AS DOUBLE PRECISION) * CAST(1.191334081843338 AS DOUBLE PRECISION) - (CAST(0.5 AS DOUBLE PRECISION) * centered_data."scaler_output_2_CLASS_2" * centered_data."scaler_output_2_CLASS_2") / CAST(0.523853620139306 AS DOUBLE PRECISION) AS "log_proba_CLASS_2" 
FROM centered_data, dummy_cte UNION ALL SELECT centered_data."KEY" AS "KEY", 1 AS "Feature", CAST(-0.5 AS DOUBLE PRECISION) * CAST(1.617699271286172 AS DOUBLE PRECISION) - (CAST(0.5 AS DOUBLE PRECISION) * centered_data."scaler_output_3_CLASS_0" * centered_data."scaler_output_3_CLASS_0") / CAST(0.802376126717448 AS DOUBLE PRECISION) AS "log_proba_CLASS_0", CAST(-0.5 AS DOUBLE PRECISION) * CAST(1.27036339826959 AS DOUBLE PRECISION) - (CAST(0.5 AS DOUBLE PRECISION) * centered_data."scaler_output_3_CLASS_1" * centered_data."scaler_output_3_CLASS_1") / CAST(0.566933272060774 AS DOUBLE PRECISION) AS "log_proba_CLASS_1", CAST(-0.5 AS DOUBLE PRECISION) * CAST(1.188361783672836 AS DOUBLE PRECISION) - (CAST(0.5 AS DOUBLE PRECISION) * centered_data."scaler_output_3_CLASS_2" * centered_data."scaler_output_3_CLASS_2") / CAST(0.522298882698798 AS DOUBLE PRECISION) AS "log_proba_CLASS_2" 
FROM centered_data, dummy_cte UNION ALL SELECT centered_data."KEY" AS "KEY", 2 AS "Feature", CAST(-0.5 AS DOUBLE PRECISION) * CAST(-2.86271245298026 AS DOUBLE PRECISION) - (CAST(0.5 AS DOUBLE PRECISION) * centered_data."scaler_output_4_CLASS_0" * centered_data."scaler_output_4_CLASS_0") / CAST(0.009089916839635 AS DOUBLE PRECISION) AS "log_proba_CLASS_0", CAST(-0.5 AS DOUBLE PRECISION) * CAST(-0.704680569700576 AS DOUBLE PRECISION) - (CAST(0.5 AS DOUBLE PRECISION) * centered_data."scaler_output_4_CLASS_1" * centered_data."scaler_output_4_CLASS_1") / CAST(0.07866494597131 AS DOUBLE PRECISION) AS "log_proba_CLASS_1", CAST(-0.5 AS DOUBLE PRECISION) * CAST(-0.66300427308024 AS DOUBLE PRECISION) - (CAST(0.5 AS DOUBLE PRECISION) * centered_data."scaler_output_4_CLASS_2" * centered_data."scaler_output_4_CLASS_2") / CAST(0.082012685743888 AS DOUBLE PRECISION) AS "log_proba_CLASS_2" 
FROM centered_data, dummy_cte UNION ALL SELECT centered_data."KEY" AS "KEY", 3 AS "Feature", CAST(-0.5 AS DOUBLE PRECISION) * CAST(-1.954085061593956 AS DOUBLE PRECISION) - (CAST(0.5 AS DOUBLE PRECISION) * centered_data."scaler_output_5_CLASS_0" * centered_data."scaler_output_5_CLASS_0") / CAST(0.022551309855471 AS DOUBLE PRECISION) AS "log_proba_CLASS_0", CAST(-0.5 AS DOUBLE PRECISION) * CAST(-0.747614689892745 AS DOUBLE PRECISION) - (CAST(0.5 AS DOUBLE PRECISION) * centered_data."scaler_output_5_CLASS_1" * centered_data."scaler_output_5_CLASS_1") / CAST(0.075359012218637 AS DOUBLE PRECISION) AS "log_proba_CLASS_1", CAST(-0.5 AS DOUBLE PRECISION) * CAST(-0.128229841381387 AS DOUBLE PRECISION) - (CAST(0.5 AS DOUBLE PRECISION) * centered_data."scaler_output_5_CLASS_2" * centered_data."scaler_output_5_CLASS_2") / CAST(0.140000832803971 AS DOUBLE PRECISION) AS "log_proba_CLASS_2" 
FROM centered_data, dummy_cte) AS "Values")
 SELECT "NaiveBayes_Scores"."KEY", "NaiveBayes_Scores"."Score_CLASS_0", "NaiveBayes_Scores"."Score_CLASS_1", "NaiveBayes_Scores"."Score_CLASS_2" 
...
FROM (SELECT "NaiveBayes_data"."KEY" AS "KEY", CAST(-1.176573830137822 AS DOUBLE PRECISION) + sum("NaiveBayes_data"."log_proba_CLASS_0") AS "Score_CLASS_0", CAST(-1.09861228866811 AS DOUBLE PRECISION) + sum("NaiveBayes_data"."log_proba_CLASS_1") AS "Score_CLASS_1", CAST(-1.026291627088484 AS DOUBLE PRECISION) + sum("NaiveBayes_data"."log_proba_CLASS_2") AS "Score_CLASS_2" 
...
FROM tmp_20180602160310_ndi_naivebayes_scores AS "NaiveBayes_Scores"), 
