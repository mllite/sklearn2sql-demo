...
-- Code For temporary table TMP_20180508185612_CODEGEN_3IDI26_ADS_imp_1_OUT part 1. Create 


CREATE TEMPORARY TABLE `TMP_20180508185612_CODEGEN_3IDI26_ADS_imp_1_OUT` (
	`KEY` BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20180508185612_CODEGEN_3IDI26_ADS_imp_1_OUT part 2. Populate

INSERT INTO `TMP_20180508185612_CODEGEN_3IDI26_ADS_imp_1_OUT` (`KEY`, imputer_output_2, imputer_output_3, imputer_output_4, imputer_output_5) SELECT `U`.`KEY`, `U`.imputer_output_2, `U`.imputer_output_3, `U`.imputer_output_4, `U`.imputer_output_5 
...
-- Code For temporary table TMP_20180508185612_CODEGEN_3IDI26_ADS_imp_1_OUT part 3. Create Index 

CREATE INDEX `ix_TMP_20180508185612_CODEGEN_3IDI26_ADS_imp_1_OUT_KEY` ON `TMP_20180508185612_CODEGEN_3IDI26_ADS_imp_1_OUT` (`KEY`)

-- Code For temporary table TMP_20180508185612_CODEGEN_PRMCN2_ADS_sca_2_OUT part 1. Create 


CREATE TEMPORARY TABLE `TMP_20180508185612_CODEGEN_PRMCN2_ADS_sca_2_OUT` (
	`KEY` BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20180508185612_CODEGEN_PRMCN2_ADS_sca_2_OUT part 2. Populate

INSERT INTO `TMP_20180508185612_CODEGEN_PRMCN2_ADS_sca_2_OUT` (`KEY`, scaler_output_2, scaler_output_3, scaler_output_4, scaler_output_5) SELECT `U`.`KEY`, `U`.scaler_output_2, `U`.scaler_output_3, `U`.scaler_output_4, `U`.scaler_output_5 
...
FROM `TMP_20180508185612_CODEGEN_3IDI26_ADS_imp_1_OUT` AS `ADS_imp_1_OUT`) AS `ADS_sca_2_OUT`) AS `U`

-- Code For temporary table TMP_20180508185612_CODEGEN_PRMCN2_ADS_sca_2_OUT part 3. Create Index 

CREATE INDEX `ix_TMP_20180508185612_CODEGEN_PRMCN2_ADS_sca_2_OUT_KEY` ON `TMP_20180508185612_CODEGEN_PRMCN2_ADS_sca_2_OUT` (`KEY`)

-- Model deployment code

WITH centered_data AS 
(SELECT `ADS_sca_2_OUT`.`KEY` AS `KEY`, `ADS_sca_2_OUT`.scaler_output_2 - -1.0737587745357238 AS scaler_output_2_0, `ADS_sca_2_OUT`.scaler_output_3 - 0.870008970111042 AS scaler_output_3_0, `ADS_sca_2_OUT`.scaler_output_4 - -1.3793950932290453 AS scaler_output_4_0, `ADS_sca_2_OUT`.scaler_output_5 - -1.3142779871589043 AS scaler_output_5_0, `ADS_sca_2_OUT`.scaler_output_2 - 0.08161645102040865 AS scaler_output_2_1, `ADS_sca_2_OUT`.scaler_output_3 - -0.6341793371020635 AS scaler_output_3_1, `ADS_sca_2_OUT`.scaler_output_4 - 0.23394313160820315 AS scaler_output_4_1, `ADS_sca_2_OUT`.scaler_output_5 - 0.10668484415166186 AS scaler_output_5_1, `ADS_sca_2_OUT`.scaler_output_2 - 0.8480096887675768 AS scaler_output_2_2, `ADS_sca_2_OUT`.scaler_output_3 - -0.15867810255873832 AS scaler_output_3_2, `ADS_sca_2_OUT`.scaler_output_4 - 0.9692998415150353 AS scaler_output_4_2, `ADS_sca_2_OUT`.scaler_output_5 - 1.0316486455537892 AS scaler_output_5_2 
FROM `TMP_20180508185612_CODEGEN_PRMCN2_ADS_sca_2_OUT` AS `ADS_sca_2_OUT`), 
`NaiveBayes_data` AS 
