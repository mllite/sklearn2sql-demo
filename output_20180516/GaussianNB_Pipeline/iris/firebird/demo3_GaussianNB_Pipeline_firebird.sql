...
-- Code For temporary table TMP_20180516_CODEGEN_KWXM01_ADS part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180516_CODEGEN_KWXM01_ADS" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20180516_CODEGEN_KWXM01_ADS part 2. Populate

INSERT INTO "TMP_20180516_CODEGEN_KWXM01_ADS" ("KEY", imputer_output_2, imputer_output_3, imputer_output_4, imputer_output_5) SELECT "U"."KEY", "U".imputer_output_2, "U".imputer_output_3, "U".imputer_output_4, "U".imputer_output_5 
...
-- Code For temporary table TMP_20180516_CODEGEN_KWXM01_ADS part 3. Create Index 

CREATE INDEX "ix_TMP_20180516_CODEGEN_92d9" ON "TMP_20180516_CODEGEN_KWXM01_ADS" ("KEY")

-- Code For temporary table TMP_20180516_CODEGEN_149LE7_ADS part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180516_CODEGEN_149LE7_ADS" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20180516_CODEGEN_149LE7_ADS part 2. Populate

INSERT INTO "TMP_20180516_CODEGEN_149LE7_ADS" ("KEY", scaler_output_2, scaler_output_3, scaler_output_4, scaler_output_5) SELECT "U"."KEY", "U".scaler_output_2, "U".scaler_output_3, "U".scaler_output_4, "U".scaler_output_5 
...
FROM "TMP_20180516_CODEGEN_KWXM01_ADS" AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT") AS "U"

-- Code For temporary table TMP_20180516_CODEGEN_149LE7_ADS part 3. Create Index 

CREATE INDEX "ix_TMP_20180516_CODEGEN_f4ee" ON "TMP_20180516_CODEGEN_149LE7_ADS" ("KEY")

-- Code For temporary table TMP_20180516_CODEGEN_KDPJOQ_NAI part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180516_CODEGEN_KDPJOQ_NAI" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20180516_CODEGEN_KDPJOQ_NAI part 2. Populate

INSERT INTO "TMP_20180516_CODEGEN_KDPJOQ_NAI" ("KEY", "Score_0", "Score_1", "Score_2") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1", "U"."Score_2" 
FROM (WITH centered_data AS 
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", CAST("ADS_sca_2_OUT".scaler_output_2 AS DOUBLE PRECISION) - -1.0737587745357238 AS scaler_output_2_0, CAST("ADS_sca_2_OUT".scaler_output_3 AS DOUBLE PRECISION) - 0.870008970111042 AS scaler_output_3_0, CAST("ADS_sca_2_OUT".scaler_output_4 AS DOUBLE PRECISION) - -1.3793950932290453 AS scaler_output_4_0, CAST("ADS_sca_2_OUT".scaler_output_5 AS DOUBLE PRECISION) - -1.3142779871589043 AS scaler_output_5_0, CAST("ADS_sca_2_OUT".scaler_output_2 AS DOUBLE PRECISION) - 0.08161645102040865 AS scaler_output_2_1, CAST("ADS_sca_2_OUT".scaler_output_3 AS DOUBLE PRECISION) - -0.6341793371020635 AS scaler_output_3_1, CAST("ADS_sca_2_OUT".scaler_output_4 AS DOUBLE PRECISION) - 0.23394313160820315 AS scaler_output_4_1, CAST("ADS_sca_2_OUT".scaler_output_5 AS DOUBLE PRECISION) - 0.10668484415166186 AS scaler_output_5_1, CAST("ADS_sca_2_OUT".scaler_output_2 AS DOUBLE PRECISION) - 0.8480096887675768 AS scaler_output_2_2, CAST("ADS_sca_2_OUT".scaler_output_3 AS DOUBLE PRECISION) - -0.15867810255873832 AS scaler_output_3_2, CAST("ADS_sca_2_OUT".scaler_output_4 AS DOUBLE PRECISION) - 0.9692998415150353 AS scaler_output_4_2, CAST("ADS_sca_2_OUT".scaler_output_5 AS DOUBLE PRECISION) - 1.0316486455537892 AS scaler_output_5_2 
FROM "TMP_20180516_CODEGEN_149LE7_ADS" AS "ADS_sca_2_OUT"), 
"NaiveBayes_data" AS 
...
-- Code For temporary table TMP_20180516_CODEGEN_KDPJOQ_NAI part 3. Create Index 

CREATE INDEX "ix_TMP_20180516_CODEGEN_7e4c" ON "TMP_20180516_CODEGEN_KDPJOQ_NAI" ("KEY")
...
FROM "TMP_20180516_CODEGEN_KDPJOQ_NAI" AS "NaiveBayes_Scores"), 
