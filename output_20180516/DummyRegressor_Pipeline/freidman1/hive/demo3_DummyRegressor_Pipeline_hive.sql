...
-- Code For temporary table tmp_20180509003958_codegen_7k518q_ads_imp_1_out part 1. Create 

CREATE TEMPORARY TABLE `tmp_20180509003958_codegen_7k518q_ads_imp_1_out` STORED AS ORC AS SELECT `ADS_imp_1_OUT`.`KEY`, `ADS_imp_1_OUT`.`impter_2`, `ADS_imp_1_OUT`.`impter_3`, `ADS_imp_1_OUT`.`impter_4`, `ADS_imp_1_OUT`.`impter_5`, `ADS_imp_1_OUT`.`impter_6`, `ADS_imp_1_OUT`.`impter_7`, `ADS_imp_1_OUT`.`impter_8`, `ADS_imp_1_OUT`.`impter_9`, `ADS_imp_1_OUT`.`impter_10`, `ADS_imp_1_OUT`.`impter_11` 
...
-- Code For temporary table tmp_20180509003958_codegen_7k518q_ads_imp_1_out part 2. Populate

SELECT * FROM `tmp_20180509003958_codegen_7k518q_ads_imp_1_out`

-- Code For temporary table tmp_20180509003958_codegen_l92mv9_ads_sca_2_out part 1. Create 

CREATE TEMPORARY TABLE `tmp_20180509003958_codegen_l92mv9_ads_sca_2_out` STORED AS ORC AS SELECT `ADS_sca_2_OUT`.`KEY`, `ADS_sca_2_OUT`.`scaler_2`, `ADS_sca_2_OUT`.`scaler_3`, `ADS_sca_2_OUT`.`scaler_4`, `ADS_sca_2_OUT`.`scaler_5`, `ADS_sca_2_OUT`.`scaler_6`, `ADS_sca_2_OUT`.`scaler_7`, `ADS_sca_2_OUT`.`scaler_8`, `ADS_sca_2_OUT`.`scaler_9`, `ADS_sca_2_OUT`.`scaler_10`, `ADS_sca_2_OUT`.`scaler_11` 
...
FROM `tmp_20180509003958_codegen_7k518q_ads_imp_1_out` AS `ADS_imp_1_OUT`) AS `ADS_sca_2_OUT`

-- Code For temporary table tmp_20180509003958_codegen_l92mv9_ads_sca_2_out part 2. Populate

SELECT * FROM `tmp_20180509003958_codegen_l92mv9_ads_sca_2_out`

-- Model deployment code

WITH `dummy_class_reg_cte` AS 
(SELECT `ADS_sca_2_OUT`.`KEY` AS `KEY`, 15.3537633818605 AS `Constant` 
FROM `tmp_20180509003958_codegen_l92mv9_ads_sca_2_out` AS `ADS_sca_2_OUT`)
