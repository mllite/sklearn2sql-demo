...
-- Code For temporary table TMP_20180516_CODEGEN_XPB4KH_ADS part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180516_CODEGEN_XPB4KH_ADS" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20180516_CODEGEN_XPB4KH_ADS part 3. Create Index 

CREATE INDEX "ix_TMP_20180516_CODEGEN_36c1" ON "TMP_20180516_CODEGEN_XPB4KH_ADS" ("KEY")

-- Code For temporary table TMP_20180516_CODEGEN_SQ78OW_ADS part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180516_CODEGEN_SQ78OW_ADS" (
	"KEY" BIGINT NOT NULL, 
...
FROM "TMP_20180516_CODEGEN_XPB4KH_ADS" AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT") AS "U"

-- Code For temporary table TMP_20180516_CODEGEN_SQ78OW_ADS part 3. Create Index 

CREATE INDEX "ix_TMP_20180516_CODEGEN_fb64" ON "TMP_20180516_CODEGEN_SQ78OW_ADS" ("KEY")

-- Model deployment code

WITH dummy_class_reg_cte AS 
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", -11.471614782695335 AS "Constant" 
FROM "TMP_20180516_CODEGEN_SQ78OW_ADS" AS "ADS_sca_2_OUT")
