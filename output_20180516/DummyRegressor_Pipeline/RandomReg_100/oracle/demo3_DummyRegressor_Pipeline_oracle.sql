...
-- Code For temporary table DEGEN_XCUN9F_ADS_IMP_1_OUT part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "DEGEN_XCUN9F_ADS_IMP_1_OUT" (
	"KEY" NUMBER(19), 
...
-- Code For temporary table DEGEN_S07M88_ADS_SCA_2_OUT part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "DEGEN_S07M88_ADS_SCA_2_OUT" (
	"KEY" NUMBER(19), 
...
FROM "DEGEN_XCUN9F_ADS_IMP_1_OUT" "ADS_imp_1_OUT") "ADS_sca_2_OUT") "U"

-- Model deployment code

WITH dummy_class_reg_cte AS 
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", -11.471614782695335 AS "Constant" 
FROM "DEGEN_S07M88_ADS_SCA_2_OUT" "ADS_sca_2_OUT")
