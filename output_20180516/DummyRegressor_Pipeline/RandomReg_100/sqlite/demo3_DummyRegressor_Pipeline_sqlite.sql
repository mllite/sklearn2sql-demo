...
-- Code For temporary table TMP_20180508182547_CODEGEN_4KL3V6_ADS_imp_1_OUT part 1. Create 


CREATE TEMPORARY TABLE "TMP_20180508182547_CODEGEN_4KL3V6_ADS_imp_1_OUT" (
	"KEY" BIGINT NOT NULL, 
	impter_2 FLOAT, 
	impter_3 FLOAT, 
	impter_4 FLOAT, 
...
-- Code For temporary table TMP_20180508182547_CODEGEN_4KL3V6_ADS_imp_1_OUT part 3. Create Index 

CREATE INDEX "ix_TMP_20180508182547_CODEGEN_4KL3V6_ADS_imp_1_OUT_KEY" ON "TMP_20180508182547_CODEGEN_4KL3V6_ADS_imp_1_OUT" ("KEY")

-- Code For temporary table TMP_20180508182547_CODEGEN_O4IET6_ADS_sca_2_OUT part 1. Create 


CREATE TEMPORARY TABLE "TMP_20180508182547_CODEGEN_O4IET6_ADS_sca_2_OUT" (
	"KEY" BIGINT NOT NULL, 
	scaler_2 FLOAT, 
	scaler_3 FLOAT, 
	scaler_4 FLOAT, 
...
FROM "TMP_20180508182547_CODEGEN_4KL3V6_ADS_imp_1_OUT" AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT"

-- Code For temporary table TMP_20180508182547_CODEGEN_O4IET6_ADS_sca_2_OUT part 3. Create Index 

CREATE INDEX "ix_TMP_20180508182547_CODEGEN_O4IET6_ADS_sca_2_OUT_KEY" ON "TMP_20180508182547_CODEGEN_O4IET6_ADS_sca_2_OUT" ("KEY")

-- Model deployment code

WITH dummy_class_reg_cte AS 
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", -11.471614782695335 AS "Constant" 
FROM "TMP_20180508182547_CODEGEN_O4IET6_ADS_sca_2_OUT" AS "ADS_sca_2_OUT")
