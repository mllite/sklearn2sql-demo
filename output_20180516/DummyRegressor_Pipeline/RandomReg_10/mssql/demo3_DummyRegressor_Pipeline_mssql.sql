...
-- Code For temporary table ##TMP_20180516113642_CODEGEN_XHXK3X_ADS_imp_1_OUT part 1. Create 


CREATE TABLE ##TMP_20180516113642_CODEGEN_XHXK3X_ADS_imp_1_OUT (
	[KEY] BIGINT NULL, 
...
-- Code For temporary table ##TMP_20180516113642_CODEGEN_J0KDA7_ADS_sca_2_OUT part 1. Create 


CREATE TABLE ##TMP_20180516113642_CODEGEN_J0KDA7_ADS_sca_2_OUT (
	[KEY] BIGINT NULL, 
	scaler_2 FLOAT NULL, 
	scaler_3 FLOAT NULL, 
	scaler_4 FLOAT NULL, 
...
FROM ##TMP_20180516113642_CODEGEN_XHXK3X_ADS_imp_1_OUT AS [ADS_imp_1_OUT]) AS [ADS_sca_2_OUT]

-- Model deployment code

WITH dummy_class_reg_cte AS 
(SELECT [ADS_sca_2_OUT].[KEY] AS [KEY], 26.405852730652413 AS [Constant] 
FROM ##TMP_20180516113642_CODEGEN_J0KDA7_ADS_sca_2_OUT AS [ADS_sca_2_OUT])
