...
-- Code For temporary table tmp_20180516122705_codegen_sryjn8_ads_imp_1_out part 1. Create 


CREATE TABLE tmp_20180516122705_codegen_sryjn8_ads_imp_1_out (
	`KEY` BIGINT, 
...
-- Code For temporary table tmp_20180516122705_codegen_sryjn8_ads_imp_1_out part 2. Populate

INSERT INTO tmp_20180516122705_codegen_sryjn8_ads_imp_1_out (`KEY`, imputer_output_2, imputer_output_3, imputer_output_4, imputer_output_5) SELECT `ADS_imp_1_OUT`.`KEY`, `ADS_imp_1_OUT`.imputer_output_2, `ADS_imp_1_OUT`.imputer_output_3, `ADS_imp_1_OUT`.imputer_output_4, `ADS_imp_1_OUT`.imputer_output_5 
FROM (SELECT `ADS`.`KEY` AS `KEY`, CASE WHEN (`ADS`.`Feature_0` IS NULL) THEN 5.8474999999999975 ELSE `ADS`.`Feature_0` END AS imputer_output_2, CASE WHEN (`ADS`.`Feature_1` IS NULL) THEN 3.0366666666666657 ELSE `ADS`.`Feature_1` END AS imputer_output_3, CASE WHEN (`ADS`.`Feature_2` IS NULL) THEN 3.8450000000000006 ELSE `ADS`.`Feature_2` END AS imputer_output_4, CASE WHEN (`ADS`.`Feature_3` IS NULL) THEN 1.245 ELSE `ADS`.`Feature_3` END AS imputer_output_5 
FROM iris AS `ADS`) AS `ADS_imp_1_OUT`

-- Code For temporary table tmp_20180516122705_codegen_lk9m2s_ads_sca_2_out part 1. Create 


CREATE TABLE tmp_20180516122705_codegen_lk9m2s_ads_sca_2_out (
	`KEY` BIGINT, 
...
-- Code For temporary table tmp_20180516122705_codegen_lk9m2s_ads_sca_2_out part 2. Populate

INSERT INTO tmp_20180516122705_codegen_lk9m2s_ads_sca_2_out (`KEY`, scaler_output_2, scaler_output_3, scaler_output_4, scaler_output_5) SELECT `ADS_sca_2_OUT`.`KEY`, `ADS_sca_2_OUT`.scaler_output_2, `ADS_sca_2_OUT`.scaler_output_3, `ADS_sca_2_OUT`.scaler_output_4, `ADS_sca_2_OUT`.scaler_output_5 
...
FROM tmp_20180516122705_codegen_sryjn8_ads_imp_1_out AS `ADS_imp_1_OUT`) AS `ADS_sca_2_OUT`

-- Code For temporary table tmp_20180516122705_codegen_n8wsy9_kernagg_b0 part 1. Create 


CREATE TABLE tmp_20180516122705_codegen_n8wsy9_kernagg_b0 (
	`KEY` BIGINT, 
	`OVO_Class1` BIGINT, 
	`OVO_Class2` BIGINT, 
	`OVO_Decision` BIGINT, 
...
-- Code For temporary table tmp_20180516122705_codegen_n8wsy9_kernagg_b0 part 2. Populate
...
FROM tmp_20180516122705_codegen_lk9m2s_ads_sca_2_out AS `ADS_sca_2_OUT`), 
`SV_data_0_1` AS 
...
FROM (SELECT kernel_input.`KEY` AS `KEY`, `SV_data_0_1`.dual_coeff * exp(CASE WHEN (CASE WHEN (-100.0 <= -0.25 * (power(kernel_input.scaler_output_2 - `SV_data_0_1`.sv_0, 2) + power(kernel_input.scaler_output_3 - `SV_data_0_1`.sv_1, 2) + power(kernel_input.scaler_output_4 - `SV_data_0_1`.sv_2, 2) + power(kernel_input.scaler_output_5 - `SV_data_0_1`.sv_3, 2))) THEN -0.25 * (power(kernel_input.scaler_output_2 - `SV_data_0_1`.sv_0, 2) + power(kernel_input.scaler_output_3 - `SV_data_0_1`.sv_1, 2) + power(kernel_input.scaler_output_4 - `SV_data_0_1`.sv_2, 2) + power(kernel_input.scaler_output_5 - `SV_data_0_1`.sv_3, 2)) ELSE -100.0 END <= 100.0) THEN CASE WHEN (-100.0 <= -0.25 * (power(kernel_input.scaler_output_2 - `SV_data_0_1`.sv_0, 2) + power(kernel_input.scaler_output_3 - `SV_data_0_1`.sv_1, 2) + power(kernel_input.scaler_output_4 - `SV_data_0_1`.sv_2, 2) + power(kernel_input.scaler_output_5 - `SV_data_0_1`.sv_3, 2))) THEN -0.25 * (power(kernel_input.scaler_output_2 - `SV_data_0_1`.sv_0, 2) + power(kernel_input.scaler_output_3 - `SV_data_0_1`.sv_1, 2) + power(kernel_input.scaler_output_4 - `SV_data_0_1`.sv_2, 2) + power(kernel_input.scaler_output_5 - `SV_data_0_1`.sv_3, 2)) ELSE -100.0 END ELSE 100.0 END) AS dot_prod1 
FROM kernel_input, `SV_data_0_1`) AS full_join_data_sv GROUP BY full_join_data_sv.`KEY`) AS t), 
kernel_cte_0_1 AS 
(SELECT kernel_dp_0_1.`KEY` AS `KEY`, 0 AS `OVO_Class1`, 1 AS `OVO_Class2`, CASE WHEN (-kernel_dp_0_1.dot_product >= 0.0) THEN 1 ELSE 0 END AS `OVO_Decision`, coalesce(-kernel_dp_0_1.dot_product, 1.0 / (1.0 + exp(CASE WHEN (CASE WHEN (-100.0 <= -(-((-kernel_dp_0_1.dot_product) * -3.447461069015017 + -0.25466478067081744))) THEN -(-((-kernel_dp_0_1.dot_product) * -3.447461069015017 + -0.25466478067081744)) ELSE -100.0 END <= 100.0) THEN CASE WHEN (-100.0 <= -(-((-kernel_dp_0_1.dot_product) * -3.447461069015017 + -0.25466478067081744))) THEN -(-((-kernel_dp_0_1.dot_product) * -3.447461069015017 + -0.25466478067081744)) ELSE -100.0 END ELSE 100.0 END))) AS `OVO_Confidence` 
FROM kernel_dp_0_1)
 INSERT INTO tmp_20180516122705_codegen_n8wsy9_kernagg_b0 (`KEY`, `OVO_Class1`, `OVO_Class2`, `OVO_Decision`, `OVO_Confidence`) SELECT `KernAgg_B0`.`KEY`, `KernAgg_B0`.`OVO_Class1`, `KernAgg_B0`.`OVO_Class2`, `KernAgg_B0`.`OVO_Decision`, `KernAgg_B0`.`OVO_Confidence` 
...
-- Code For temporary table tmp_20180516122705_codegen_4mi02t_kernagg_b1 part 1. Create 


CREATE TABLE tmp_20180516122705_codegen_4mi02t_kernagg_b1 (
	`KEY` BIGINT, 
	`OVO_Class1` BIGINT, 
	`OVO_Class2` BIGINT, 
	`OVO_Decision` BIGINT, 
...
-- Code For temporary table tmp_20180516122705_codegen_4mi02t_kernagg_b1 part 2. Populate
...
FROM (SELECT kernel_input.`KEY` AS `KEY`, `SV_data_0_2`.dual_coeff * exp(CASE WHEN (CASE WHEN (-100.0 <= -0.25 * (power(kernel_input.scaler_output_2 - `SV_data_0_2`.sv_0, 2) + power(kernel_input.scaler_output_3 - `SV_data_0_2`.sv_1, 2) + power(kernel_input.scaler_output_4 - `SV_data_0_2`.sv_2, 2) + power(kernel_input.scaler_output_5 - `SV_data_0_2`.sv_3, 2))) THEN -0.25 * (power(kernel_input.scaler_output_2 - `SV_data_0_2`.sv_0, 2) + power(kernel_input.scaler_output_3 - `SV_data_0_2`.sv_1, 2) + power(kernel_input.scaler_output_4 - `SV_data_0_2`.sv_2, 2) + power(kernel_input.scaler_output_5 - `SV_data_0_2`.sv_3, 2)) ELSE -100.0 END <= 100.0) THEN CASE WHEN (-100.0 <= -0.25 * (power(kernel_input.scaler_output_2 - `SV_data_0_2`.sv_0, 2) + power(kernel_input.scaler_output_3 - `SV_data_0_2`.sv_1, 2) + power(kernel_input.scaler_output_4 - `SV_data_0_2`.sv_2, 2) + power(kernel_input.scaler_output_5 - `SV_data_0_2`.sv_3, 2))) THEN -0.25 * (power(kernel_input.scaler_output_2 - `SV_data_0_2`.sv_0, 2) + power(kernel_input.scaler_output_3 - `SV_data_0_2`.sv_1, 2) + power(kernel_input.scaler_output_4 - `SV_data_0_2`.sv_2, 2) + power(kernel_input.scaler_output_5 - `SV_data_0_2`.sv_3, 2)) ELSE -100.0 END ELSE 100.0 END) AS dot_prod1 
FROM kernel_input, `SV_data_0_2`) AS full_join_data_sv_1 GROUP BY full_join_data_sv_1.`KEY`) AS t_1), 
kernel_cte_0_2 AS 
(SELECT kernel_dp_0_2.`KEY` AS `KEY`, 0 AS `OVO_Class1`, 2 AS `OVO_Class2`, CASE WHEN (-kernel_dp_0_2.dot_product >= 0.0) THEN 1 ELSE 0 END AS `OVO_Decision`, coalesce(-kernel_dp_0_2.dot_product, 1.0 / (1.0 + exp(CASE WHEN (CASE WHEN (-100.0 <= -(-((-kernel_dp_0_2.dot_product) * -3.6067194214027145 + 0.002587615102278322))) THEN -(-((-kernel_dp_0_2.dot_product) * -3.6067194214027145 + 0.002587615102278322)) ELSE -100.0 END <= 100.0) THEN CASE WHEN (-100.0 <= -(-((-kernel_dp_0_2.dot_product) * -3.6067194214027145 + 0.002587615102278322))) THEN -(-((-kernel_dp_0_2.dot_product) * -3.6067194214027145 + 0.002587615102278322)) ELSE -100.0 END ELSE 100.0 END))) AS `OVO_Confidence` 
FROM kernel_dp_0_2)
 INSERT INTO tmp_20180516122705_codegen_4mi02t_kernagg_b1 (`KEY`, `OVO_Class1`, `OVO_Class2`, `OVO_Decision`, `OVO_Confidence`) SELECT `KernAgg_B1`.`KEY`, `KernAgg_B1`.`OVO_Class1`, `KernAgg_B1`.`OVO_Class2`, `KernAgg_B1`.`OVO_Decision`, `KernAgg_B1`.`OVO_Confidence` 
...
-- Code For temporary table tmp_20180516122705_codegen_dvy5a3_kernagg_b2 part 1. Create 


CREATE TABLE tmp_20180516122705_codegen_dvy5a3_kernagg_b2 (
	`KEY` BIGINT, 
	`OVO_Class1` BIGINT, 
	`OVO_Class2` BIGINT, 
	`OVO_Decision` BIGINT, 
...
-- Code For temporary table tmp_20180516122705_codegen_dvy5a3_kernagg_b2 part 2. Populate
...
FROM (SELECT kernel_input.`KEY` AS `KEY`, `SV_data_1_2`.dual_coeff * exp(CASE WHEN (CASE WHEN (-100.0 <= -0.25 * (power(kernel_input.scaler_output_2 - `SV_data_1_2`.sv_0, 2) + power(kernel_input.scaler_output_3 - `SV_data_1_2`.sv_1, 2) + power(kernel_input.scaler_output_4 - `SV_data_1_2`.sv_2, 2) + power(kernel_input.scaler_output_5 - `SV_data_1_2`.sv_3, 2))) THEN -0.25 * (power(kernel_input.scaler_output_2 - `SV_data_1_2`.sv_0, 2) + power(kernel_input.scaler_output_3 - `SV_data_1_2`.sv_1, 2) + power(kernel_input.scaler_output_4 - `SV_data_1_2`.sv_2, 2) + power(kernel_input.scaler_output_5 - `SV_data_1_2`.sv_3, 2)) ELSE -100.0 END <= 100.0) THEN CASE WHEN (-100.0 <= -0.25 * (power(kernel_input.scaler_output_2 - `SV_data_1_2`.sv_0, 2) + power(kernel_input.scaler_output_3 - `SV_data_1_2`.sv_1, 2) + power(kernel_input.scaler_output_4 - `SV_data_1_2`.sv_2, 2) + power(kernel_input.scaler_output_5 - `SV_data_1_2`.sv_3, 2))) THEN -0.25 * (power(kernel_input.scaler_output_2 - `SV_data_1_2`.sv_0, 2) + power(kernel_input.scaler_output_3 - `SV_data_1_2`.sv_1, 2) + power(kernel_input.scaler_output_4 - `SV_data_1_2`.sv_2, 2) + power(kernel_input.scaler_output_5 - `SV_data_1_2`.sv_3, 2)) ELSE -100.0 END ELSE 100.0 END) AS dot_prod1 
FROM kernel_input, `SV_data_1_2`) AS full_join_data_sv_2 GROUP BY full_join_data_sv_2.`KEY`) AS t_2), 
kernel_cte_1_2 AS 
(SELECT kernel_dp_1_2.`KEY` AS `KEY`, 1 AS `OVO_Class1`, 2 AS `OVO_Class2`, CASE WHEN (-kernel_dp_1_2.dot_product >= 0.0) THEN 1 ELSE 0 END AS `OVO_Decision`, coalesce(-kernel_dp_1_2.dot_product, 1.0 / (1.0 + exp(CASE WHEN (CASE WHEN (-100.0 <= -(-((-kernel_dp_1_2.dot_product) * -3.678122763785029 + 0.20666788665949642))) THEN -(-((-kernel_dp_1_2.dot_product) * -3.678122763785029 + 0.20666788665949642)) ELSE -100.0 END <= 100.0) THEN CASE WHEN (-100.0 <= -(-((-kernel_dp_1_2.dot_product) * -3.678122763785029 + 0.20666788665949642))) THEN -(-((-kernel_dp_1_2.dot_product) * -3.678122763785029 + 0.20666788665949642)) ELSE -100.0 END ELSE 100.0 END))) AS `OVO_Confidence` 
FROM kernel_dp_1_2)
 INSERT INTO tmp_20180516122705_codegen_dvy5a3_kernagg_b2 (`KEY`, `OVO_Class1`, `OVO_Class2`, `OVO_Decision`, `OVO_Confidence`) SELECT `KernAgg_B2`.`KEY`, `KernAgg_B2`.`OVO_Class1`, `KernAgg_B2`.`OVO_Class2`, `KernAgg_B2`.`OVO_Decision`, `KernAgg_B2`.`OVO_Confidence` 
...
-- Code For temporary table tmp_20180516122705_codegen_qo2eau_kernagg part 1. Create 


CREATE TABLE tmp_20180516122705_codegen_qo2eau_kernagg (
	`KEY` BIGINT, 
	`OVO_Vote_0` BIGINT, 
...
-- Code For temporary table tmp_20180516122705_codegen_qo2eau_kernagg part 2. Populate
...
FROM tmp_20180516122705_codegen_n8wsy9_kernagg_b0 AS `KernAgg_B0` UNION ALL SELECT `KernAgg_B1`.`KEY` AS `KEY`, `KernAgg_B1`.`OVO_Class1` AS `OVO_Class1`, `KernAgg_B1`.`OVO_Class2` AS `OVO_Class2`, `KernAgg_B1`.`OVO_Decision` AS `OVO_Decision`, `KernAgg_B1`.`OVO_Confidence` AS `OVO_Confidence` 
FROM tmp_20180516122705_codegen_4mi02t_kernagg_b1 AS `KernAgg_B1` UNION ALL SELECT `KernAgg_B2`.`KEY` AS `KEY`, `KernAgg_B2`.`OVO_Class1` AS `OVO_Class1`, `KernAgg_B2`.`OVO_Class2` AS `OVO_Class2`, `KernAgg_B2`.`OVO_Decision` AS `OVO_Decision`, `KernAgg_B2`.`OVO_Confidence` AS `OVO_Confidence` 
FROM tmp_20180516122705_codegen_dvy5a3_kernagg_b2 AS `KernAgg_B2`) AS `KernAgg_EnsembleUnion`), 
`OVO_Votes` AS 
...
FROM tmp_20180516122705_codegen_qo2eau_kernagg AS `KernAgg`), 
