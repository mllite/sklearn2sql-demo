...
-- Code For temporary table TMP_20180516122705_CODEGEN_ZOI9T2_ADS_imp_1_OUT part 1. Create 


CREATE TEMPORARY TABLE `TMP_20180516122705_CODEGEN_ZOI9T2_ADS_imp_1_OUT` (
	`KEY` BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20180516122705_CODEGEN_ZOI9T2_ADS_imp_1_OUT part 2. Populate

INSERT INTO `TMP_20180516122705_CODEGEN_ZOI9T2_ADS_imp_1_OUT` (`KEY`, imputer_output_2, imputer_output_3, imputer_output_4, imputer_output_5) SELECT `U`.`KEY`, `U`.imputer_output_2, `U`.imputer_output_3, `U`.imputer_output_4, `U`.imputer_output_5 
...
-- Code For temporary table TMP_20180516122705_CODEGEN_ZOI9T2_ADS_imp_1_OUT part 3. Create Index 

CREATE INDEX `ix_TMP_20180516122705_CODEGEN_ZOI9T2_ADS_imp_1_OUT_KEY` ON `TMP_20180516122705_CODEGEN_ZOI9T2_ADS_imp_1_OUT` (`KEY`)

-- Code For temporary table TMP_20180516122705_CODEGEN_5AO9HN_ADS_sca_2_OUT part 1. Create 


CREATE TEMPORARY TABLE `TMP_20180516122705_CODEGEN_5AO9HN_ADS_sca_2_OUT` (
	`KEY` BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20180516122705_CODEGEN_5AO9HN_ADS_sca_2_OUT part 2. Populate

INSERT INTO `TMP_20180516122705_CODEGEN_5AO9HN_ADS_sca_2_OUT` (`KEY`, scaler_output_2, scaler_output_3, scaler_output_4, scaler_output_5) SELECT `U`.`KEY`, `U`.scaler_output_2, `U`.scaler_output_3, `U`.scaler_output_4, `U`.scaler_output_5 
...
FROM `TMP_20180516122705_CODEGEN_ZOI9T2_ADS_imp_1_OUT` AS `ADS_imp_1_OUT`) AS `ADS_sca_2_OUT`) AS `U`

-- Code For temporary table TMP_20180516122705_CODEGEN_5AO9HN_ADS_sca_2_OUT part 3. Create Index 

CREATE INDEX `ix_TMP_20180516122705_CODEGEN_5AO9HN_ADS_sca_2_OUT_KEY` ON `TMP_20180516122705_CODEGEN_5AO9HN_ADS_sca_2_OUT` (`KEY`)

-- Code For temporary table TMP_20180516122705_CODEGEN_XC29EC_KernAgg_B0 part 1. Create 


CREATE TEMPORARY TABLE `TMP_20180516122705_CODEGEN_XC29EC_KernAgg_B0` (
	`KEY` BIGINT, 
	`OVO_Class1` BIGINT, 
	`OVO_Class2` BIGINT, 
	`OVO_Decision` BIGINT, 
...
-- Code For temporary table TMP_20180516122705_CODEGEN_XC29EC_KernAgg_B0 part 2. Populate

INSERT INTO `TMP_20180516122705_CODEGEN_XC29EC_KernAgg_B0` (`KEY`, `OVO_Class1`, `OVO_Class2`, `OVO_Decision`, `OVO_Confidence`) SELECT `U`.`KEY`, `U`.`OVO_Class1`, `U`.`OVO_Class2`, `U`.`OVO_Decision`, `U`.`OVO_Confidence` 
...
FROM `TMP_20180516122705_CODEGEN_5AO9HN_ADS_sca_2_OUT` AS `ADS_sca_2_OUT`), 
`SV_data_0_1` AS 
...
-- Code For temporary table TMP_20180516122705_CODEGEN_F8T26S_KernAgg_B1 part 1. Create 


CREATE TEMPORARY TABLE `TMP_20180516122705_CODEGEN_F8T26S_KernAgg_B1` (
	`KEY` BIGINT, 
	`OVO_Class1` BIGINT, 
	`OVO_Class2` BIGINT, 
	`OVO_Decision` BIGINT, 
...
-- Code For temporary table TMP_20180516122705_CODEGEN_F8T26S_KernAgg_B1 part 2. Populate

INSERT INTO `TMP_20180516122705_CODEGEN_F8T26S_KernAgg_B1` (`KEY`, `OVO_Class1`, `OVO_Class2`, `OVO_Decision`, `OVO_Confidence`) SELECT `U`.`KEY`, `U`.`OVO_Class1`, `U`.`OVO_Class2`, `U`.`OVO_Decision`, `U`.`OVO_Confidence` 
FROM (WITH kernel_input AS 
(SELECT `ADS_sca_2_OUT`.`KEY` AS `KEY`, CAST(`ADS_sca_2_OUT`.scaler_output_2 AS DOUBLE) AS scaler_output_2, CAST(`ADS_sca_2_OUT`.scaler_output_3 AS DOUBLE) AS scaler_output_3, CAST(`ADS_sca_2_OUT`.scaler_output_4 AS DOUBLE) AS scaler_output_4, CAST(`ADS_sca_2_OUT`.scaler_output_5 AS DOUBLE) AS scaler_output_5 
FROM `TMP_20180516122705_CODEGEN_5AO9HN_ADS_sca_2_OUT` AS `ADS_sca_2_OUT`), 
`SV_data_0_2` AS 
...
-- Code For temporary table TMP_20180516122705_CODEGEN_JFSNHH_KernAgg_B2 part 1. Create 


CREATE TEMPORARY TABLE `TMP_20180516122705_CODEGEN_JFSNHH_KernAgg_B2` (
	`KEY` BIGINT, 
	`OVO_Class1` BIGINT, 
	`OVO_Class2` BIGINT, 
	`OVO_Decision` BIGINT, 
...
-- Code For temporary table TMP_20180516122705_CODEGEN_JFSNHH_KernAgg_B2 part 2. Populate

INSERT INTO `TMP_20180516122705_CODEGEN_JFSNHH_KernAgg_B2` (`KEY`, `OVO_Class1`, `OVO_Class2`, `OVO_Decision`, `OVO_Confidence`) SELECT `U`.`KEY`, `U`.`OVO_Class1`, `U`.`OVO_Class2`, `U`.`OVO_Decision`, `U`.`OVO_Confidence` 
FROM (WITH kernel_input AS 
(SELECT `ADS_sca_2_OUT`.`KEY` AS `KEY`, CAST(`ADS_sca_2_OUT`.scaler_output_2 AS DOUBLE) AS scaler_output_2, CAST(`ADS_sca_2_OUT`.scaler_output_3 AS DOUBLE) AS scaler_output_3, CAST(`ADS_sca_2_OUT`.scaler_output_4 AS DOUBLE) AS scaler_output_4, CAST(`ADS_sca_2_OUT`.scaler_output_5 AS DOUBLE) AS scaler_output_5 
FROM `TMP_20180516122705_CODEGEN_5AO9HN_ADS_sca_2_OUT` AS `ADS_sca_2_OUT`), 
`SV_data_1_2` AS 
...
-- Code For temporary table TMP_20180516122705_CODEGEN_RLKHSO_KernAgg part 1. Create 


CREATE TEMPORARY TABLE `TMP_20180516122705_CODEGEN_RLKHSO_KernAgg` (
	`KEY` BIGINT NOT NULL, 
	`OVO_Vote_0` BIGINT, 
...
-- Code For temporary table TMP_20180516122705_CODEGEN_RLKHSO_KernAgg part 2. Populate

INSERT INTO `TMP_20180516122705_CODEGEN_RLKHSO_KernAgg` (`KEY`, `OVO_Vote_0`, `OVO_SumConfidence_0`, `OVO_Vote_1`, `OVO_SumConfidence_1`, `OVO_Vote_2`, `OVO_SumConfidence_2`, max_abs_confidence, `OVO_Scale`, `Score_0`, `Score_1`, `Score_2`) SELECT `U`.`KEY`, `U`.`OVO_Vote_0`, `U`.`OVO_SumConfidence_0`, `U`.`OVO_Vote_1`, `U`.`OVO_SumConfidence_1`, `U`.`OVO_Vote_2`, `U`.`OVO_SumConfidence_2`, `U`.max_abs_confidence, `U`.`OVO_Scale`, `U`.`Score_0`, `U`.`Score_1`, `U`.`Score_2` 
...
FROM `TMP_20180516122705_CODEGEN_XC29EC_KernAgg_B0` AS `KernAgg_B0` UNION ALL SELECT `KernAgg_B1`.`KEY` AS `KEY`, `KernAgg_B1`.`OVO_Class1` AS `OVO_Class1`, `KernAgg_B1`.`OVO_Class2` AS `OVO_Class2`, `KernAgg_B1`.`OVO_Decision` AS `OVO_Decision`, `KernAgg_B1`.`OVO_Confidence` AS `OVO_Confidence` 
FROM `TMP_20180516122705_CODEGEN_F8T26S_KernAgg_B1` AS `KernAgg_B1` UNION ALL SELECT `KernAgg_B2`.`KEY` AS `KEY`, `KernAgg_B2`.`OVO_Class1` AS `OVO_Class1`, `KernAgg_B2`.`OVO_Class2` AS `OVO_Class2`, `KernAgg_B2`.`OVO_Decision` AS `OVO_Decision`, `KernAgg_B2`.`OVO_Confidence` AS `OVO_Confidence` 
FROM `TMP_20180516122705_CODEGEN_JFSNHH_KernAgg_B2` AS `KernAgg_B2`) AS `KernAgg_EnsembleUnion`), 
`OVO_Votes` AS 
...
-- Code For temporary table TMP_20180516122705_CODEGEN_RLKHSO_KernAgg part 3. Create Index 

CREATE INDEX `ix_TMP_20180516122705_CODEGEN_RLKHSO_KernAgg_KEY` ON `TMP_20180516122705_CODEGEN_RLKHSO_KernAgg` (`KEY`)
...
FROM `TMP_20180516122705_CODEGEN_RLKHSO_KernAgg` AS `KernAgg`), 
