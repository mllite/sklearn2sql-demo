...
-- Code For temporary table TMP_20180516122705_CODEGEN_QNIUOU_ADS_imp_1_OUT part 1. Create 


CREATE TEMPORARY TABLE "TMP_20180516122705_CODEGEN_QNIUOU_ADS_imp_1_OUT" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20180516122705_CODEGEN_QNIUOU_ADS_imp_1_OUT part 2. Populate

INSERT INTO "TMP_20180516122705_CODEGEN_QNIUOU_ADS_imp_1_OUT" ("KEY", imputer_output_2, imputer_output_3, imputer_output_4, imputer_output_5) SELECT "ADS_imp_1_OUT"."KEY", "ADS_imp_1_OUT".imputer_output_2, "ADS_imp_1_OUT".imputer_output_3, "ADS_imp_1_OUT".imputer_output_4, "ADS_imp_1_OUT".imputer_output_5 
FROM (SELECT "ADS"."KEY" AS "KEY", CASE WHEN ("ADS"."Feature_0" IS NULL) THEN 5.8474999999999975 ELSE "ADS"."Feature_0" END AS imputer_output_2, CASE WHEN ("ADS"."Feature_1" IS NULL) THEN 3.0366666666666657 ELSE "ADS"."Feature_1" END AS imputer_output_3, CASE WHEN ("ADS"."Feature_2" IS NULL) THEN 3.8450000000000006 ELSE "ADS"."Feature_2" END AS imputer_output_4, CASE WHEN ("ADS"."Feature_3" IS NULL) THEN 1.245 ELSE "ADS"."Feature_3" END AS imputer_output_5 
FROM iris AS "ADS") AS "ADS_imp_1_OUT"

-- Code For temporary table TMP_20180516122705_CODEGEN_QNIUOU_ADS_imp_1_OUT part 3. Create Index 

CREATE INDEX "ix_TMP_20180516122705_CODEGEN_QNIUOU_ADS_imp_1_OUT_KEY" ON "TMP_20180516122705_CODEGEN_QNIUOU_ADS_imp_1_OUT" ("KEY")

-- Code For temporary table TMP_20180516122705_CODEGEN_ZTN42Z_ADS_sca_2_OUT part 1. Create 


CREATE TEMPORARY TABLE "TMP_20180516122705_CODEGEN_ZTN42Z_ADS_sca_2_OUT" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20180516122705_CODEGEN_ZTN42Z_ADS_sca_2_OUT part 2. Populate

INSERT INTO "TMP_20180516122705_CODEGEN_ZTN42Z_ADS_sca_2_OUT" ("KEY", scaler_output_2, scaler_output_3, scaler_output_4, scaler_output_5) SELECT "ADS_sca_2_OUT"."KEY", "ADS_sca_2_OUT".scaler_output_2, "ADS_sca_2_OUT".scaler_output_3, "ADS_sca_2_OUT".scaler_output_4, "ADS_sca_2_OUT".scaler_output_5 
...
FROM "TMP_20180516122705_CODEGEN_QNIUOU_ADS_imp_1_OUT" AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT"

-- Code For temporary table TMP_20180516122705_CODEGEN_ZTN42Z_ADS_sca_2_OUT part 3. Create Index 

CREATE INDEX "ix_TMP_20180516122705_CODEGEN_ZTN42Z_ADS_sca_2_OUT_KEY" ON "TMP_20180516122705_CODEGEN_ZTN42Z_ADS_sca_2_OUT" ("KEY")

-- Code For temporary table TMP_20180516122705_CODEGEN_CJ0NEJ_KernAgg_B0 part 1. Create 


CREATE TEMPORARY TABLE "TMP_20180516122705_CODEGEN_CJ0NEJ_KernAgg_B0" (
	"KEY" BIGINT, 
	"OVO_Class1" BIGINT, 
	"OVO_Class2" BIGINT, 
	"OVO_Decision" BIGINT, 
...
-- Code For temporary table TMP_20180516122705_CODEGEN_CJ0NEJ_KernAgg_B0 part 2. Populate
...
FROM "TMP_20180516122705_CODEGEN_ZTN42Z_ADS_sca_2_OUT" AS "ADS_sca_2_OUT"), 
"SV_data_0_1" AS 
...
FROM (SELECT kernel_input."KEY" AS "KEY", "SV_data_0_1".dual_coeff * exp(min(max(-100.0, -0.25 * (power(kernel_input.scaler_output_2 - "SV_data_0_1".sv_0, 2) + power(kernel_input.scaler_output_3 - "SV_data_0_1".sv_1, 2) + power(kernel_input.scaler_output_4 - "SV_data_0_1".sv_2, 2) + power(kernel_input.scaler_output_5 - "SV_data_0_1".sv_3, 2))), 100.0)) AS dot_prod1 
FROM kernel_input, "SV_data_0_1") AS full_join_data_sv GROUP BY full_join_data_sv."KEY") AS t), 
kernel_cte_0_1 AS 
(SELECT kernel_dp_0_1."KEY" AS "KEY", 0 AS "OVO_Class1", 1 AS "OVO_Class2", CASE WHEN (-kernel_dp_0_1.dot_product >= 0.0) THEN 1 ELSE 0 END AS "OVO_Decision", coalesce(-kernel_dp_0_1.dot_product, 1.0 / (1.0 + exp(min(max(-100.0, -(-((-kernel_dp_0_1.dot_product) * -3.447461069015017 + -0.25466478067081744))), 100.0)))) AS "OVO_Confidence" 
FROM kernel_dp_0_1)
 INSERT INTO "TMP_20180516122705_CODEGEN_CJ0NEJ_KernAgg_B0" ("KEY", "OVO_Class1", "OVO_Class2", "OVO_Decision", "OVO_Confidence") SELECT "KernAgg_B0"."KEY", "KernAgg_B0"."OVO_Class1", "KernAgg_B0"."OVO_Class2", "KernAgg_B0"."OVO_Decision", "KernAgg_B0"."OVO_Confidence" 
...
-- Code For temporary table TMP_20180516122705_CODEGEN_80K88V_KernAgg_B1 part 1. Create 


CREATE TEMPORARY TABLE "TMP_20180516122705_CODEGEN_80K88V_KernAgg_B1" (
	"KEY" BIGINT, 
	"OVO_Class1" BIGINT, 
	"OVO_Class2" BIGINT, 
	"OVO_Decision" BIGINT, 
...
-- Code For temporary table TMP_20180516122705_CODEGEN_80K88V_KernAgg_B1 part 2. Populate
...
FROM (SELECT kernel_input."KEY" AS "KEY", "SV_data_0_2".dual_coeff * exp(min(max(-100.0, -0.25 * (power(kernel_input.scaler_output_2 - "SV_data_0_2".sv_0, 2) + power(kernel_input.scaler_output_3 - "SV_data_0_2".sv_1, 2) + power(kernel_input.scaler_output_4 - "SV_data_0_2".sv_2, 2) + power(kernel_input.scaler_output_5 - "SV_data_0_2".sv_3, 2))), 100.0)) AS dot_prod1 
FROM kernel_input, "SV_data_0_2") AS full_join_data_sv_1 GROUP BY full_join_data_sv_1."KEY") AS t_1), 
kernel_cte_0_2 AS 
(SELECT kernel_dp_0_2."KEY" AS "KEY", 0 AS "OVO_Class1", 2 AS "OVO_Class2", CASE WHEN (-kernel_dp_0_2.dot_product >= 0.0) THEN 1 ELSE 0 END AS "OVO_Decision", coalesce(-kernel_dp_0_2.dot_product, 1.0 / (1.0 + exp(min(max(-100.0, -(-((-kernel_dp_0_2.dot_product) * -3.6067194214027145 + 0.002587615102278322))), 100.0)))) AS "OVO_Confidence" 
FROM kernel_dp_0_2)
 INSERT INTO "TMP_20180516122705_CODEGEN_80K88V_KernAgg_B1" ("KEY", "OVO_Class1", "OVO_Class2", "OVO_Decision", "OVO_Confidence") SELECT "KernAgg_B1"."KEY", "KernAgg_B1"."OVO_Class1", "KernAgg_B1"."OVO_Class2", "KernAgg_B1"."OVO_Decision", "KernAgg_B1"."OVO_Confidence" 
...
-- Code For temporary table TMP_20180516122705_CODEGEN_VPWH8W_KernAgg_B2 part 1. Create 


CREATE TEMPORARY TABLE "TMP_20180516122705_CODEGEN_VPWH8W_KernAgg_B2" (
	"KEY" BIGINT, 
	"OVO_Class1" BIGINT, 
	"OVO_Class2" BIGINT, 
	"OVO_Decision" BIGINT, 
...
-- Code For temporary table TMP_20180516122705_CODEGEN_VPWH8W_KernAgg_B2 part 2. Populate
...
FROM (SELECT kernel_input."KEY" AS "KEY", "SV_data_1_2".dual_coeff * exp(min(max(-100.0, -0.25 * (power(kernel_input.scaler_output_2 - "SV_data_1_2".sv_0, 2) + power(kernel_input.scaler_output_3 - "SV_data_1_2".sv_1, 2) + power(kernel_input.scaler_output_4 - "SV_data_1_2".sv_2, 2) + power(kernel_input.scaler_output_5 - "SV_data_1_2".sv_3, 2))), 100.0)) AS dot_prod1 
FROM kernel_input, "SV_data_1_2") AS full_join_data_sv_2 GROUP BY full_join_data_sv_2."KEY") AS t_2), 
kernel_cte_1_2 AS 
(SELECT kernel_dp_1_2."KEY" AS "KEY", 1 AS "OVO_Class1", 2 AS "OVO_Class2", CASE WHEN (-kernel_dp_1_2.dot_product >= 0.0) THEN 1 ELSE 0 END AS "OVO_Decision", coalesce(-kernel_dp_1_2.dot_product, 1.0 / (1.0 + exp(min(max(-100.0, -(-((-kernel_dp_1_2.dot_product) * -3.678122763785029 + 0.20666788665949642))), 100.0)))) AS "OVO_Confidence" 
FROM kernel_dp_1_2)
 INSERT INTO "TMP_20180516122705_CODEGEN_VPWH8W_KernAgg_B2" ("KEY", "OVO_Class1", "OVO_Class2", "OVO_Decision", "OVO_Confidence") SELECT "KernAgg_B2"."KEY", "KernAgg_B2"."OVO_Class1", "KernAgg_B2"."OVO_Class2", "KernAgg_B2"."OVO_Decision", "KernAgg_B2"."OVO_Confidence" 
...
-- Code For temporary table TMP_20180516122705_CODEGEN_KM5O5S_KernAgg part 1. Create 


CREATE TEMPORARY TABLE "TMP_20180516122705_CODEGEN_KM5O5S_KernAgg" (
	"KEY" BIGINT NOT NULL, 
	"OVO_Vote_0" BIGINT, 
...
-- Code For temporary table TMP_20180516122705_CODEGEN_KM5O5S_KernAgg part 2. Populate
...
FROM "TMP_20180516122705_CODEGEN_CJ0NEJ_KernAgg_B0" AS "KernAgg_B0" UNION ALL SELECT "KernAgg_B1"."KEY" AS "KEY", "KernAgg_B1"."OVO_Class1" AS "OVO_Class1", "KernAgg_B1"."OVO_Class2" AS "OVO_Class2", "KernAgg_B1"."OVO_Decision" AS "OVO_Decision", "KernAgg_B1"."OVO_Confidence" AS "OVO_Confidence" 
FROM "TMP_20180516122705_CODEGEN_80K88V_KernAgg_B1" AS "KernAgg_B1" UNION ALL SELECT "KernAgg_B2"."KEY" AS "KEY", "KernAgg_B2"."OVO_Class1" AS "OVO_Class1", "KernAgg_B2"."OVO_Class2" AS "OVO_Class2", "KernAgg_B2"."OVO_Decision" AS "OVO_Decision", "KernAgg_B2"."OVO_Confidence" AS "OVO_Confidence" 
FROM "TMP_20180516122705_CODEGEN_VPWH8W_KernAgg_B2" AS "KernAgg_B2") AS "KernAgg_EnsembleUnion"), 
"OVO_Votes" AS 
...
FROM "OVO_Votes", "MinMaxConf")
 INSERT INTO "TMP_20180516122705_CODEGEN_KM5O5S_KernAgg" ("KEY", "OVO_Vote_0", "OVO_SumConfidence_0", "OVO_Vote_1", "OVO_SumConfidence_1", "OVO_Vote_2", "OVO_SumConfidence_2", max_abs_confidence, "OVO_Scale", "Score_0", "Score_1", "Score_2") SELECT "KernAgg"."KEY", "KernAgg"."OVO_Vote_0", "KernAgg"."OVO_SumConfidence_0", "KernAgg"."OVO_Vote_1", "KernAgg"."OVO_SumConfidence_1", "KernAgg"."OVO_Vote_2", "KernAgg"."OVO_SumConfidence_2", "KernAgg".max_abs_confidence, "KernAgg"."OVO_Scale", "KernAgg"."Score_0", "KernAgg"."Score_1", "KernAgg"."Score_2" 
...
-- Code For temporary table TMP_20180516122705_CODEGEN_KM5O5S_KernAgg part 3. Create Index 

CREATE INDEX "ix_TMP_20180516122705_CODEGEN_KM5O5S_KernAgg_KEY" ON "TMP_20180516122705_CODEGEN_KM5O5S_KernAgg" ("KEY")
...
FROM "TMP_20180516122705_CODEGEN_KM5O5S_KernAgg" AS "KernAgg"), 
