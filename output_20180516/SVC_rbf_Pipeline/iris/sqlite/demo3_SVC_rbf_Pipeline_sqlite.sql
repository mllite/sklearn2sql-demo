...
-- Code For temporary table TMP_20180508185813_CODEGEN_PHSC8G_ADS_imp_1_OUT part 1. Create 


CREATE TEMPORARY TABLE "TMP_20180508185813_CODEGEN_PHSC8G_ADS_imp_1_OUT" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20180508185813_CODEGEN_PHSC8G_ADS_imp_1_OUT part 2. Populate

INSERT INTO "TMP_20180508185813_CODEGEN_PHSC8G_ADS_imp_1_OUT" ("KEY", imputer_output_2, imputer_output_3, imputer_output_4, imputer_output_5) SELECT "ADS_imp_1_OUT"."KEY", "ADS_imp_1_OUT".imputer_output_2, "ADS_imp_1_OUT".imputer_output_3, "ADS_imp_1_OUT".imputer_output_4, "ADS_imp_1_OUT".imputer_output_5 
FROM (SELECT "ADS"."KEY" AS "KEY", CASE WHEN ("ADS"."Feature_0" IS NULL) THEN 5.8474999999999975 ELSE "ADS"."Feature_0" END AS imputer_output_2, CASE WHEN ("ADS"."Feature_1" IS NULL) THEN 3.0366666666666657 ELSE "ADS"."Feature_1" END AS imputer_output_3, CASE WHEN ("ADS"."Feature_2" IS NULL) THEN 3.8450000000000006 ELSE "ADS"."Feature_2" END AS imputer_output_4, CASE WHEN ("ADS"."Feature_3" IS NULL) THEN 1.245 ELSE "ADS"."Feature_3" END AS imputer_output_5 
FROM iris AS "ADS") AS "ADS_imp_1_OUT"

-- Code For temporary table TMP_20180508185813_CODEGEN_PHSC8G_ADS_imp_1_OUT part 3. Create Index 

CREATE INDEX "ix_TMP_20180508185813_CODEGEN_PHSC8G_ADS_imp_1_OUT_KEY" ON "TMP_20180508185813_CODEGEN_PHSC8G_ADS_imp_1_OUT" ("KEY")

-- Code For temporary table TMP_20180508185813_CODEGEN_94PHWX_ADS_sca_2_OUT part 1. Create 


CREATE TEMPORARY TABLE "TMP_20180508185813_CODEGEN_94PHWX_ADS_sca_2_OUT" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20180508185813_CODEGEN_94PHWX_ADS_sca_2_OUT part 2. Populate

INSERT INTO "TMP_20180508185813_CODEGEN_94PHWX_ADS_sca_2_OUT" ("KEY", scaler_output_2, scaler_output_3, scaler_output_4, scaler_output_5) SELECT "ADS_sca_2_OUT"."KEY", "ADS_sca_2_OUT".scaler_output_2, "ADS_sca_2_OUT".scaler_output_3, "ADS_sca_2_OUT".scaler_output_4, "ADS_sca_2_OUT".scaler_output_5 
...
FROM "TMP_20180508185813_CODEGEN_PHSC8G_ADS_imp_1_OUT" AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT"

-- Code For temporary table TMP_20180508185813_CODEGEN_94PHWX_ADS_sca_2_OUT part 3. Create Index 

CREATE INDEX "ix_TMP_20180508185813_CODEGEN_94PHWX_ADS_sca_2_OUT_KEY" ON "TMP_20180508185813_CODEGEN_94PHWX_ADS_sca_2_OUT" ("KEY")

-- Code For temporary table TMP_20180508185813_CODEGEN_SY80OA_KernAgg_B0 part 1. Create 


CREATE TEMPORARY TABLE "TMP_20180508185813_CODEGEN_SY80OA_KernAgg_B0" (
	"KEY" BIGINT, 
	"OVO_Class1" BIGINT, 
	"OVO_Class2" BIGINT, 
	"OVO_Decision" BIGINT, 
...
-- Code For temporary table TMP_20180508185813_CODEGEN_SY80OA_KernAgg_B0 part 2. Populate
...
FROM "TMP_20180508185813_CODEGEN_94PHWX_ADS_sca_2_OUT" AS "ADS_sca_2_OUT"), 
"SV_data_0_1" AS 
...
kernel_cte_0_1 AS 
(SELECT kernel_dp_0_1."KEY" AS "KEY", 0 AS "OVO_Class1", 1 AS "OVO_Class2", CASE WHEN (-kernel_dp_0_1.dot_product >= 0.0) THEN 1 ELSE 0 END AS "OVO_Decision", coalesce(-kernel_dp_0_1.dot_product, 1.0 / (1.0 + exp(min(max(-100.0, -(-((-kernel_dp_0_1.dot_product) * -3.3975324453417444 + -0.22476246148702106))), 100.0)))) AS "OVO_Confidence" 
FROM kernel_dp_0_1), 
"SV_data_0_2" AS 
(SELECT "Values".sv_idx AS sv_idx, CAST("Values".dual_coeff AS FLOAT) AS dual_coeff, CAST("Values".sv_0 AS FLOAT) AS sv_0, CAST("Values".sv_1 AS FLOAT) AS sv_1, CAST("Values".sv_2 AS FLOAT) AS sv_2, CAST("Values".sv_3 AS FLOAT) AS sv_3 
...
kernel_cte_0_2 AS 
(SELECT kernel_dp_0_2."KEY" AS "KEY", 0 AS "OVO_Class1", 2 AS "OVO_Class2", CASE WHEN (-kernel_dp_0_2.dot_product >= 0.0) THEN 1 ELSE 0 END AS "OVO_Decision", coalesce(-kernel_dp_0_2.dot_product, 1.0 / (1.0 + exp(min(max(-100.0, -(-((-kernel_dp_0_2.dot_product) * -3.60316077533339 + 0.06595347202288708))), 100.0)))) AS "OVO_Confidence" 
FROM kernel_dp_0_2), 
"SV_data_1_2" AS 
(SELECT "Values".sv_idx AS sv_idx, CAST("Values".dual_coeff AS FLOAT) AS dual_coeff, CAST("Values".sv_0 AS FLOAT) AS sv_0, CAST("Values".sv_1 AS FLOAT) AS sv_1, CAST("Values".sv_2 AS FLOAT) AS sv_2, CAST("Values".sv_3 AS FLOAT) AS sv_3 
...
kernel_cte_1_2 AS 
(SELECT kernel_dp_1_2."KEY" AS "KEY", 1 AS "OVO_Class1", 2 AS "OVO_Class2", CASE WHEN (-kernel_dp_1_2.dot_product >= 0.0) THEN 1 ELSE 0 END AS "OVO_Decision", coalesce(-kernel_dp_1_2.dot_product, 1.0 / (1.0 + exp(min(max(-100.0, -(-((-kernel_dp_1_2.dot_product) * -3.5818010406071403 + 0.3035369293103044))), 100.0)))) AS "OVO_Confidence" 
FROM kernel_dp_1_2)
 INSERT INTO "TMP_20180508185813_CODEGEN_SY80OA_KernAgg_B0" ("KEY", "OVO_Class1", "OVO_Class2", "OVO_Decision", "OVO_Confidence") SELECT "KernAgg_B0"."KEY", "KernAgg_B0"."OVO_Class1", "KernAgg_B0"."OVO_Class2", "KernAgg_B0"."OVO_Decision", "KernAgg_B0"."OVO_Confidence" 
...
-- Code For temporary table TMP_20180508185813_CODEGEN_3B8X46_KernAgg_Union part 1. Create 


CREATE TEMPORARY TABLE "TMP_20180508185813_CODEGEN_3B8X46_KernAgg_Union" (
	"KEY" BIGINT, 
	"OVO_Class1" BIGINT, 
	"OVO_Class2" BIGINT, 
	"OVO_Decision" BIGINT, 
...
-- Code For temporary table TMP_20180508185813_CODEGEN_3B8X46_KernAgg_Union part 2. Populate

INSERT INTO "TMP_20180508185813_CODEGEN_3B8X46_KernAgg_Union" ("KEY", "OVO_Class1", "OVO_Class2", "OVO_Decision", "OVO_Confidence") SELECT "KernAgg_Union"."KEY", "KernAgg_Union"."OVO_Class1", "KernAgg_Union"."OVO_Class2", "KernAgg_Union"."OVO_Decision", "KernAgg_Union"."OVO_Confidence" 
...
FROM "TMP_20180508185813_CODEGEN_SY80OA_KernAgg_B0" AS "KernAgg_B0") AS "KernAgg_EnsembleUnion") AS "KernAgg_Union"

-- Code For temporary table TMP_20180508185813_CODEGEN_JPXWHH_KernAgg part 1. Create 


CREATE TEMPORARY TABLE "TMP_20180508185813_CODEGEN_JPXWHH_KernAgg" (
	"KEY" BIGINT NOT NULL, 
	"OVO_Vote_0" BIGINT, 
...
-- Code For temporary table TMP_20180508185813_CODEGEN_JPXWHH_KernAgg part 2. Populate
...
FROM "TMP_20180508185813_CODEGEN_3B8X46_KernAgg_Union" AS "KernAgg_Union" GROUP BY "KernAgg_Union"."KEY") AS "Votes_Sel"), 
"OVO_SumConf_CTE" AS 
...
FROM "OVO_Votes", "MinMaxConf")
 INSERT INTO "TMP_20180508185813_CODEGEN_JPXWHH_KernAgg" ("KEY", "OVO_Vote_0", "OVO_SumConfidence_0", "OVO_Vote_1", "OVO_SumConfidence_1", "OVO_Vote_2", "OVO_SumConfidence_2", max_abs_confidence, "OVO_Scale", "Score_0", "Score_1", "Score_2") SELECT "KernAgg"."KEY", "KernAgg"."OVO_Vote_0", "KernAgg"."OVO_SumConfidence_0", "KernAgg"."OVO_Vote_1", "KernAgg"."OVO_SumConfidence_1", "KernAgg"."OVO_Vote_2", "KernAgg"."OVO_SumConfidence_2", "KernAgg".max_abs_confidence, "KernAgg"."OVO_Scale", "KernAgg"."Score_0", "KernAgg"."Score_1", "KernAgg"."Score_2" 
...
-- Code For temporary table TMP_20180508185813_CODEGEN_JPXWHH_KernAgg part 3. Create Index 

CREATE INDEX "ix_TMP_20180508185813_CODEGEN_JPXWHH_KernAgg_KEY" ON "TMP_20180508185813_CODEGEN_JPXWHH_KernAgg" ("KEY")
...
FROM "TMP_20180508185813_CODEGEN_JPXWHH_KernAgg" AS "KernAgg"), 
