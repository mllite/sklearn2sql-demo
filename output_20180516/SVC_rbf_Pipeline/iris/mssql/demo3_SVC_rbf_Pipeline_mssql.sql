...
-- Code For temporary table ##TMP_20180602153031_2BF_ADS_imp_1_OUT part 1. Create 


CREATE TABLE ##TMP_20180602153031_2BF_ADS_imp_1_OUT (
	[KEY] BIGINT NULL, 
...
-- Code For temporary table ##TMP_20180602153031_2BF_ADS_imp_1_OUT part 2. Populate

INSERT INTO ##TMP_20180602153031_2BF_ADS_imp_1_OUT ([KEY], imputer_output_2, imputer_output_3, imputer_output_4, imputer_output_5) SELECT [ADS_imp_1_OUT].[KEY], [ADS_imp_1_OUT].imputer_output_2, [ADS_imp_1_OUT].imputer_output_3, [ADS_imp_1_OUT].imputer_output_4, [ADS_imp_1_OUT].imputer_output_5 
FROM (SELECT [ADS].[KEY] AS [KEY], CASE WHEN ([ADS].[Feature_0] IS NULL) THEN 5.8474999999999975 ELSE [ADS].[Feature_0] END AS imputer_output_2, CASE WHEN ([ADS].[Feature_1] IS NULL) THEN 3.0366666666666657 ELSE [ADS].[Feature_1] END AS imputer_output_3, CASE WHEN ([ADS].[Feature_2] IS NULL) THEN 3.8450000000000006 ELSE [ADS].[Feature_2] END AS imputer_output_4, CASE WHEN ([ADS].[Feature_3] IS NULL) THEN 1.245 ELSE [ADS].[Feature_3] END AS imputer_output_5 
FROM iris AS [ADS]) AS [ADS_imp_1_OUT]

-- Code For temporary table ##TMP_20180602153031_SCK_ADS_sca_2_OUT part 1. Create 


CREATE TABLE ##TMP_20180602153031_SCK_ADS_sca_2_OUT (
	[KEY] BIGINT NULL, 
...
-- Code For temporary table ##TMP_20180602153031_SCK_ADS_sca_2_OUT part 2. Populate

INSERT INTO ##TMP_20180602153031_SCK_ADS_sca_2_OUT ([KEY], scaler_output_2, scaler_output_3, scaler_output_4, scaler_output_5) SELECT [ADS_sca_2_OUT].[KEY], [ADS_sca_2_OUT].scaler_output_2, [ADS_sca_2_OUT].scaler_output_3, [ADS_sca_2_OUT].scaler_output_4, [ADS_sca_2_OUT].scaler_output_5 
...
FROM ##TMP_20180602153031_2BF_ADS_imp_1_OUT AS [ADS_imp_1_OUT]) AS [ADS_sca_2_OUT]

-- Code For temporary table ##TMP_20180602153031_E45_KernAgg_B0 part 1. Create 


CREATE TABLE ##TMP_20180602153031_E45_KernAgg_B0 (
	[KEY] BIGINT NULL, 
...
-- Code For temporary table ##TMP_20180602153031_E45_KernAgg_B0 part 2. Populate
...
FROM ##TMP_20180602153031_SCK_ADS_sca_2_OUT AS [ADS_sca_2_OUT]), 
[SV_data_0_1] AS 
...
FROM (SELECT kernel_input.[KEY] AS [KEY], [SV_data_0_1].dual_coeff * exp(CASE WHEN (CASE WHEN (-100.0 <= -0.25 * (power(CAST(kernel_input.scaler_output_2 - [SV_data_0_1].sv_0 AS FLOAT(53)), 2) + power(CAST(kernel_input.scaler_output_3 - [SV_data_0_1].sv_1 AS FLOAT(53)), 2) + power(CAST(kernel_input.scaler_output_4 - [SV_data_0_1].sv_2 AS FLOAT(53)), 2) + power(CAST(kernel_input.scaler_output_5 - [SV_data_0_1].sv_3 AS FLOAT(53)), 2))) THEN -0.25 * (power(CAST(kernel_input.scaler_output_2 - [SV_data_0_1].sv_0 AS FLOAT(53)), 2) + power(CAST(kernel_input.scaler_output_3 - [SV_data_0_1].sv_1 AS FLOAT(53)), 2) + power(CAST(kernel_input.scaler_output_4 - [SV_data_0_1].sv_2 AS FLOAT(53)), 2) + power(CAST(kernel_input.scaler_output_5 - [SV_data_0_1].sv_3 AS FLOAT(53)), 2)) ELSE -100.0 END <= 100.0) THEN CASE WHEN (-100.0 <= -0.25 * (power(CAST(kernel_input.scaler_output_2 - [SV_data_0_1].sv_0 AS FLOAT(53)), 2) + power(CAST(kernel_input.scaler_output_3 - [SV_data_0_1].sv_1 AS FLOAT(53)), 2) + power(CAST(kernel_input.scaler_output_4 - [SV_data_0_1].sv_2 AS FLOAT(53)), 2) + power(CAST(kernel_input.scaler_output_5 - [SV_data_0_1].sv_3 AS FLOAT(53)), 2))) THEN -0.25 * (power(CAST(kernel_input.scaler_output_2 - [SV_data_0_1].sv_0 AS FLOAT(53)), 2) + power(CAST(kernel_input.scaler_output_3 - [SV_data_0_1].sv_1 AS FLOAT(53)), 2) + power(CAST(kernel_input.scaler_output_4 - [SV_data_0_1].sv_2 AS FLOAT(53)), 2) + power(CAST(kernel_input.scaler_output_5 - [SV_data_0_1].sv_3 AS FLOAT(53)), 2)) ELSE -100.0 END ELSE 100.0 END) AS dot_prod1 
...
FROM kernel_dp_0_1)
 INSERT INTO ##TMP_20180602153031_E45_KernAgg_B0 ([KEY], [OVO_Class1], [OVO_Class2], [OVO_Decision], [OVO_Conf]) SELECT [KernAgg_B0].[KEY], [KernAgg_B0].[OVO_Class1], [KernAgg_B0].[OVO_Class2], [KernAgg_B0].[OVO_Decision], [KernAgg_B0].[OVO_Conf] 
...
-- Code For temporary table ##TMP_20180602153031_3EK_KernAgg_B1 part 1. Create 


CREATE TABLE ##TMP_20180602153031_3EK_KernAgg_B1 (
	[KEY] BIGINT NULL, 
	[OVO_Class1] BIGINT NULL, 
	[OVO_Class2] BIGINT NULL, 
	[OVO_Decision] BIGINT NULL, 
...
-- Code For temporary table ##TMP_20180602153031_3EK_KernAgg_B1 part 2. Populate
...
FROM (SELECT kernel_input.[KEY] AS [KEY], [SV_data_0_2].dual_coeff * exp(CASE WHEN (CASE WHEN (-100.0 <= -0.25 * (power(CAST(kernel_input.scaler_output_2 - [SV_data_0_2].sv_0 AS FLOAT(53)), 2) + power(CAST(kernel_input.scaler_output_3 - [SV_data_0_2].sv_1 AS FLOAT(53)), 2) + power(CAST(kernel_input.scaler_output_4 - [SV_data_0_2].sv_2 AS FLOAT(53)), 2) + power(CAST(kernel_input.scaler_output_5 - [SV_data_0_2].sv_3 AS FLOAT(53)), 2))) THEN -0.25 * (power(CAST(kernel_input.scaler_output_2 - [SV_data_0_2].sv_0 AS FLOAT(53)), 2) + power(CAST(kernel_input.scaler_output_3 - [SV_data_0_2].sv_1 AS FLOAT(53)), 2) + power(CAST(kernel_input.scaler_output_4 - [SV_data_0_2].sv_2 AS FLOAT(53)), 2) + power(CAST(kernel_input.scaler_output_5 - [SV_data_0_2].sv_3 AS FLOAT(53)), 2)) ELSE -100.0 END <= 100.0) THEN CASE WHEN (-100.0 <= -0.25 * (power(CAST(kernel_input.scaler_output_2 - [SV_data_0_2].sv_0 AS FLOAT(53)), 2) + power(CAST(kernel_input.scaler_output_3 - [SV_data_0_2].sv_1 AS FLOAT(53)), 2) + power(CAST(kernel_input.scaler_output_4 - [SV_data_0_2].sv_2 AS FLOAT(53)), 2) + power(CAST(kernel_input.scaler_output_5 - [SV_data_0_2].sv_3 AS FLOAT(53)), 2))) THEN -0.25 * (power(CAST(kernel_input.scaler_output_2 - [SV_data_0_2].sv_0 AS FLOAT(53)), 2) + power(CAST(kernel_input.scaler_output_3 - [SV_data_0_2].sv_1 AS FLOAT(53)), 2) + power(CAST(kernel_input.scaler_output_4 - [SV_data_0_2].sv_2 AS FLOAT(53)), 2) + power(CAST(kernel_input.scaler_output_5 - [SV_data_0_2].sv_3 AS FLOAT(53)), 2)) ELSE -100.0 END ELSE 100.0 END) AS dot_prod1 
...
FROM kernel_dp_0_2)
 INSERT INTO ##TMP_20180602153031_3EK_KernAgg_B1 ([KEY], [OVO_Class1], [OVO_Class2], [OVO_Decision], [OVO_Conf]) SELECT [KernAgg_B1].[KEY], [KernAgg_B1].[OVO_Class1], [KernAgg_B1].[OVO_Class2], [KernAgg_B1].[OVO_Decision], [KernAgg_B1].[OVO_Conf] 
...
-- Code For temporary table ##TMP_20180602153031_E67_KernAgg_B2 part 1. Create 


CREATE TABLE ##TMP_20180602153031_E67_KernAgg_B2 (
	[KEY] BIGINT NULL, 
	[OVO_Class1] BIGINT NULL, 
	[OVO_Class2] BIGINT NULL, 
	[OVO_Decision] BIGINT NULL, 
...
-- Code For temporary table ##TMP_20180602153031_E67_KernAgg_B2 part 2. Populate
...
FROM (SELECT kernel_input.[KEY] AS [KEY], [SV_data_1_2].dual_coeff * exp(CASE WHEN (CASE WHEN (-100.0 <= -0.25 * (power(CAST(kernel_input.scaler_output_2 - [SV_data_1_2].sv_0 AS FLOAT(53)), 2) + power(CAST(kernel_input.scaler_output_3 - [SV_data_1_2].sv_1 AS FLOAT(53)), 2) + power(CAST(kernel_input.scaler_output_4 - [SV_data_1_2].sv_2 AS FLOAT(53)), 2) + power(CAST(kernel_input.scaler_output_5 - [SV_data_1_2].sv_3 AS FLOAT(53)), 2))) THEN -0.25 * (power(CAST(kernel_input.scaler_output_2 - [SV_data_1_2].sv_0 AS FLOAT(53)), 2) + power(CAST(kernel_input.scaler_output_3 - [SV_data_1_2].sv_1 AS FLOAT(53)), 2) + power(CAST(kernel_input.scaler_output_4 - [SV_data_1_2].sv_2 AS FLOAT(53)), 2) + power(CAST(kernel_input.scaler_output_5 - [SV_data_1_2].sv_3 AS FLOAT(53)), 2)) ELSE -100.0 END <= 100.0) THEN CASE WHEN (-100.0 <= -0.25 * (power(CAST(kernel_input.scaler_output_2 - [SV_data_1_2].sv_0 AS FLOAT(53)), 2) + power(CAST(kernel_input.scaler_output_3 - [SV_data_1_2].sv_1 AS FLOAT(53)), 2) + power(CAST(kernel_input.scaler_output_4 - [SV_data_1_2].sv_2 AS FLOAT(53)), 2) + power(CAST(kernel_input.scaler_output_5 - [SV_data_1_2].sv_3 AS FLOAT(53)), 2))) THEN -0.25 * (power(CAST(kernel_input.scaler_output_2 - [SV_data_1_2].sv_0 AS FLOAT(53)), 2) + power(CAST(kernel_input.scaler_output_3 - [SV_data_1_2].sv_1 AS FLOAT(53)), 2) + power(CAST(kernel_input.scaler_output_4 - [SV_data_1_2].sv_2 AS FLOAT(53)), 2) + power(CAST(kernel_input.scaler_output_5 - [SV_data_1_2].sv_3 AS FLOAT(53)), 2)) ELSE -100.0 END ELSE 100.0 END) AS dot_prod1 
...
FROM kernel_dp_1_2)
 INSERT INTO ##TMP_20180602153031_E67_KernAgg_B2 ([KEY], [OVO_Class1], [OVO_Class2], [OVO_Decision], [OVO_Conf]) SELECT [KernAgg_B2].[KEY], [KernAgg_B2].[OVO_Class1], [KernAgg_B2].[OVO_Class2], [KernAgg_B2].[OVO_Decision], [KernAgg_B2].[OVO_Conf] 
...
-- Code For temporary table ##TMP_20180602153031_7YP_KernAgg_agg part 1. Create 


CREATE TABLE ##TMP_20180602153031_7YP_KernAgg_agg (
	[KEY] BIGINT NULL, 
...
-- Code For temporary table ##TMP_20180602153031_7YP_KernAgg_agg part 2. Populate
...
FROM ##TMP_20180602153031_E45_KernAgg_B0 AS [KernAgg_B0] UNION ALL SELECT [KernAgg_B1].[KEY] AS [KEY], [KernAgg_B1].[OVO_Class1] AS [OVO_Class1], [KernAgg_B1].[OVO_Class2] AS [OVO_Class2], [KernAgg_B1].[OVO_Decision] AS [OVO_Decision], [KernAgg_B1].[OVO_Conf] AS [OVO_Conf] 
FROM ##TMP_20180602153031_3EK_KernAgg_B1 AS [KernAgg_B1] UNION ALL SELECT [KernAgg_B2].[KEY] AS [KEY], [KernAgg_B2].[OVO_Class1] AS [OVO_Class1], [KernAgg_B2].[OVO_Class2] AS [OVO_Class2], [KernAgg_B2].[OVO_Decision] AS [OVO_Decision], [KernAgg_B2].[OVO_Conf] AS [OVO_Conf] 
FROM ##TMP_20180602153031_E67_KernAgg_B2 AS [KernAgg_B2]) AS [KernAgg_EnsembleUnion]), 
[OVO_Votes] AS 
...
FROM [OVO_Votes], [MinMaxConf])
 INSERT INTO ##TMP_20180602153031_7YP_KernAgg_agg ([KEY], [OVO_Vote_0], [OVO_SumConfidence_0], [OVO_Vote_1], [OVO_SumConfidence_1], [OVO_Vote_2], [OVO_SumConfidence_2], max_abs_confidence, [OVO_Scale], [Score_0], [Score_1], [Score_2]) SELECT [KernAgg_agg].[KEY], [KernAgg_agg].[OVO_Vote_0], [KernAgg_agg].[OVO_SumConfidence_0], [KernAgg_agg].[OVO_Vote_1], [KernAgg_agg].[OVO_SumConfidence_1], [KernAgg_agg].[OVO_Vote_2], [KernAgg_agg].[OVO_SumConfidence_2], [KernAgg_agg].max_abs_confidence, [KernAgg_agg].[OVO_Scale], [KernAgg_agg].[Score_0], [KernAgg_agg].[Score_1], [KernAgg_agg].[Score_2] 
...
FROM ##TMP_20180602153031_7YP_KernAgg_agg AS [KernAgg_agg]), 
