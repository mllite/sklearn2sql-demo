...
-- Code For temporary table ##TMP_20180602155137_M2K_ADS_imp_1_OUT part 1. Create 


CREATE TABLE ##TMP_20180602155137_M2K_ADS_imp_1_OUT (
	[KEY] BIGINT NULL, 
...
-- Code For temporary table ##TMP_20180602155137_M2K_ADS_imp_1_OUT part 2. Populate

INSERT INTO ##TMP_20180602155137_M2K_ADS_imp_1_OUT ([KEY], imputer_output_2, imputer_output_3, imputer_output_4, imputer_output_5) SELECT [ADS_imp_1_OUT].[KEY], [ADS_imp_1_OUT].imputer_output_2, [ADS_imp_1_OUT].imputer_output_3, [ADS_imp_1_OUT].imputer_output_4, [ADS_imp_1_OUT].imputer_output_5 
...
-- Code For temporary table ##TMP_20180602155137_2S8_ADS_sca_2_OUT part 1. Create 


CREATE TABLE ##TMP_20180602155137_2S8_ADS_sca_2_OUT (
	[KEY] BIGINT NULL, 
...
-- Code For temporary table ##TMP_20180602155137_2S8_ADS_sca_2_OUT part 2. Populate

INSERT INTO ##TMP_20180602155137_2S8_ADS_sca_2_OUT ([KEY], scaler_output_2, scaler_output_3, scaler_output_4, scaler_output_5) SELECT [ADS_sca_2_OUT].[KEY], [ADS_sca_2_OUT].scaler_output_2, [ADS_sca_2_OUT].scaler_output_3, [ADS_sca_2_OUT].scaler_output_4, [ADS_sca_2_OUT].scaler_output_5 
...
FROM ##TMP_20180602155137_M2K_ADS_imp_1_OUT AS [ADS_imp_1_OUT]) AS [ADS_sca_2_OUT]

-- Code For temporary table ##TMP_20180602155137_2MR_KernAgg_B0 part 1. Create 


CREATE TABLE ##TMP_20180602155137_2MR_KernAgg_B0 (
	[KEY] BIGINT NULL, 
...
-- Code For temporary table ##TMP_20180602155137_2MR_KernAgg_B0 part 2. Populate
...
FROM ##TMP_20180602155137_2S8_ADS_sca_2_OUT AS [ADS_sca_2_OUT]), 
...
FROM [kernel_dp_1789-07-14T00:00:00.000000000_1789-08-14T00:00:00.000000000])
 INSERT INTO ##TMP_20180602155137_2MR_KernAgg_B0 ([KEY], [OVO_Class1], [OVO_Class2], [OVO_Decision], [OVO_Conf]) SELECT [KernAgg_B0].[KEY], [KernAgg_B0].[OVO_Class1], [KernAgg_B0].[OVO_Class2], [KernAgg_B0].[OVO_Decision], [KernAgg_B0].[OVO_Conf] 
...
-- Code For temporary table ##TMP_20180602155137_1SS_KernAgg_B1 part 1. Create 


CREATE TABLE ##TMP_20180602155137_1SS_KernAgg_B1 (
	[KEY] BIGINT NULL, 
	[OVO_Class1] VARCHAR(max) COLLATE utf8 NULL, 
	[OVO_Class2] VARCHAR(max) COLLATE utf8 NULL, 
	[OVO_Decision] BIGINT NULL, 
...
-- Code For temporary table ##TMP_20180602155137_1SS_KernAgg_B1 part 2. Populate
...
FROM [kernel_dp_1789-07-14T00:00:00.000000000_1789-09-14T00:00:00.000000000])
 INSERT INTO ##TMP_20180602155137_1SS_KernAgg_B1 ([KEY], [OVO_Class1], [OVO_Class2], [OVO_Decision], [OVO_Conf]) SELECT [KernAgg_B1].[KEY], [KernAgg_B1].[OVO_Class1], [KernAgg_B1].[OVO_Class2], [KernAgg_B1].[OVO_Decision], [KernAgg_B1].[OVO_Conf] 
...
-- Code For temporary table ##TMP_20180602155137_GL7_KernAgg_B2 part 1. Create 


CREATE TABLE ##TMP_20180602155137_GL7_KernAgg_B2 (
	[KEY] BIGINT NULL, 
	[OVO_Class1] VARCHAR(max) COLLATE utf8 NULL, 
	[OVO_Class2] VARCHAR(max) COLLATE utf8 NULL, 
	[OVO_Decision] BIGINT NULL, 
...
-- Code For temporary table ##TMP_20180602155137_GL7_KernAgg_B2 part 2. Populate
...
FROM [kernel_dp_1789-08-14T00:00:00.000000000_1789-09-14T00:00:00.000000000])
 INSERT INTO ##TMP_20180602155137_GL7_KernAgg_B2 ([KEY], [OVO_Class1], [OVO_Class2], [OVO_Decision], [OVO_Conf]) SELECT [KernAgg_B2].[KEY], [KernAgg_B2].[OVO_Class1], [KernAgg_B2].[OVO_Class2], [KernAgg_B2].[OVO_Decision], [KernAgg_B2].[OVO_Conf] 
...
-- Code For temporary table ##TMP_20180602155137_O7G_KernAgg_agg part 1. Create 


CREATE TABLE ##TMP_20180602155137_O7G_KernAgg_agg (
	[KEY] BIGINT NULL, 
...
-- Code For temporary table ##TMP_20180602155137_O7G_KernAgg_agg part 2. Populate
...
FROM ##TMP_20180602155137_2MR_KernAgg_B0 AS [KernAgg_B0] UNION ALL SELECT [KernAgg_B1].[KEY] AS [KEY], [KernAgg_B1].[OVO_Class1] AS [OVO_Class1], [KernAgg_B1].[OVO_Class2] AS [OVO_Class2], [KernAgg_B1].[OVO_Decision] AS [OVO_Decision], [KernAgg_B1].[OVO_Conf] AS [OVO_Conf] 
FROM ##TMP_20180602155137_1SS_KernAgg_B1 AS [KernAgg_B1] UNION ALL SELECT [KernAgg_B2].[KEY] AS [KEY], [KernAgg_B2].[OVO_Class1] AS [OVO_Class1], [KernAgg_B2].[OVO_Class2] AS [OVO_Class2], [KernAgg_B2].[OVO_Decision] AS [OVO_Decision], [KernAgg_B2].[OVO_Conf] AS [OVO_Conf] 
FROM ##TMP_20180602155137_GL7_KernAgg_B2 AS [KernAgg_B2]) AS [KernAgg_EnsembleUnion]), 
[OVO_Votes] AS 
...
FROM ##TMP_20180602155137_O7G_KernAgg_agg AS [KernAgg_agg]), 
