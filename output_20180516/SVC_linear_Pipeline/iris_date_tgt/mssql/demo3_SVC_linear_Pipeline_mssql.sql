...
-- Code For temporary table ##TMP_20180516125416_CODEGEN_HQM7BB_ADS_imp_1_OUT part 1. Create 


CREATE TABLE ##TMP_20180516125416_CODEGEN_HQM7BB_ADS_imp_1_OUT (
	[KEY] BIGINT NULL, 
...
-- Code For temporary table ##TMP_20180516125416_CODEGEN_HQM7BB_ADS_imp_1_OUT part 2. Populate

INSERT INTO ##TMP_20180516125416_CODEGEN_HQM7BB_ADS_imp_1_OUT ([KEY], imputer_output_2, imputer_output_3, imputer_output_4, imputer_output_5) SELECT [ADS_imp_1_OUT].[KEY], [ADS_imp_1_OUT].imputer_output_2, [ADS_imp_1_OUT].imputer_output_3, [ADS_imp_1_OUT].imputer_output_4, [ADS_imp_1_OUT].imputer_output_5 
...
-- Code For temporary table ##TMP_20180516125416_CODEGEN_0M9MKP_ADS_sca_2_OUT part 1. Create 


CREATE TABLE ##TMP_20180516125416_CODEGEN_0M9MKP_ADS_sca_2_OUT (
	[KEY] BIGINT NULL, 
...
-- Code For temporary table ##TMP_20180516125416_CODEGEN_0M9MKP_ADS_sca_2_OUT part 2. Populate

INSERT INTO ##TMP_20180516125416_CODEGEN_0M9MKP_ADS_sca_2_OUT ([KEY], scaler_output_2, scaler_output_3, scaler_output_4, scaler_output_5) SELECT [ADS_sca_2_OUT].[KEY], [ADS_sca_2_OUT].scaler_output_2, [ADS_sca_2_OUT].scaler_output_3, [ADS_sca_2_OUT].scaler_output_4, [ADS_sca_2_OUT].scaler_output_5 
...
FROM ##TMP_20180516125416_CODEGEN_HQM7BB_ADS_imp_1_OUT AS [ADS_imp_1_OUT]) AS [ADS_sca_2_OUT]

-- Code For temporary table ##TMP_20180516125416_CODEGEN_4OA8VO_KernAgg_B0 part 1. Create 


CREATE TABLE ##TMP_20180516125416_CODEGEN_4OA8VO_KernAgg_B0 (
	[KEY] BIGINT NULL, 
...
-- Code For temporary table ##TMP_20180516125416_CODEGEN_4OA8VO_KernAgg_B0 part 2. Populate
...
FROM ##TMP_20180516125416_CODEGEN_0M9MKP_ADS_sca_2_OUT AS [ADS_sca_2_OUT]), 
...
FROM (SELECT full_join_data_sv.[KEY] AS [KEY], sum(CAST(full_join_data_sv.dot_prod1 AS FLOAT(53))) + -1.5900231216431768 AS dot_product 
...
FROM [kernel_dp_1789-07-14T00:00:00.000000000_1789-08-14T00:00:00.000000000])
 INSERT INTO ##TMP_20180516125416_CODEGEN_4OA8VO_KernAgg_B0 ([KEY], [OVO_Class1], [OVO_Class2], [OVO_Decision], [OVO_Confidence]) SELECT [KernAgg_B0].[KEY], [KernAgg_B0].[OVO_Class1], [KernAgg_B0].[OVO_Class2], [KernAgg_B0].[OVO_Decision], [KernAgg_B0].[OVO_Confidence] 
...
-- Code For temporary table ##TMP_20180516125416_CODEGEN_C0UBEB_KernAgg_B1 part 1. Create 


CREATE TABLE ##TMP_20180516125416_CODEGEN_C0UBEB_KernAgg_B1 (
	[KEY] BIGINT NULL, 
	[OVO_Class1] VARCHAR(max) COLLATE utf8 NULL, 
	[OVO_Class2] VARCHAR(max) COLLATE utf8 NULL, 
	[OVO_Decision] BIGINT NULL, 
...
-- Code For temporary table ##TMP_20180516125416_CODEGEN_C0UBEB_KernAgg_B1 part 2. Populate
...
FROM (SELECT full_join_data_sv_1.[KEY] AS [KEY], sum(CAST(full_join_data_sv_1.dot_prod1 AS FLOAT(53))) + -0.361186144126904 AS dot_product 
...
FROM [kernel_dp_1789-07-14T00:00:00.000000000_1789-09-14T00:00:00.000000000])
 INSERT INTO ##TMP_20180516125416_CODEGEN_C0UBEB_KernAgg_B1 ([KEY], [OVO_Class1], [OVO_Class2], [OVO_Decision], [OVO_Confidence]) SELECT [KernAgg_B1].[KEY], [KernAgg_B1].[OVO_Class1], [KernAgg_B1].[OVO_Class2], [KernAgg_B1].[OVO_Decision], [KernAgg_B1].[OVO_Confidence] 
...
-- Code For temporary table ##TMP_20180516125416_CODEGEN_P36VEN_KernAgg_B2 part 1. Create 


CREATE TABLE ##TMP_20180516125416_CODEGEN_P36VEN_KernAgg_B2 (
	[KEY] BIGINT NULL, 
	[OVO_Class1] VARCHAR(max) COLLATE utf8 NULL, 
	[OVO_Class2] VARCHAR(max) COLLATE utf8 NULL, 
	[OVO_Decision] BIGINT NULL, 
...
-- Code For temporary table ##TMP_20180516125416_CODEGEN_P36VEN_KernAgg_B2 part 2. Populate
...
FROM (SELECT full_join_data_sv_2.[KEY] AS [KEY], sum(CAST(full_join_data_sv_2.dot_prod1 AS FLOAT(53))) + 2.70975831744 AS dot_product 
...
FROM [kernel_dp_1789-08-14T00:00:00.000000000_1789-09-14T00:00:00.000000000])
 INSERT INTO ##TMP_20180516125416_CODEGEN_P36VEN_KernAgg_B2 ([KEY], [OVO_Class1], [OVO_Class2], [OVO_Decision], [OVO_Confidence]) SELECT [KernAgg_B2].[KEY], [KernAgg_B2].[OVO_Class1], [KernAgg_B2].[OVO_Class2], [KernAgg_B2].[OVO_Decision], [KernAgg_B2].[OVO_Confidence] 
...
-- Code For temporary table ##TMP_20180516125416_CODEGEN_JJMQ0I_KernAgg part 1. Create 


CREATE TABLE ##TMP_20180516125416_CODEGEN_JJMQ0I_KernAgg (
	[KEY] BIGINT NULL, 
...
-- Code For temporary table ##TMP_20180516125416_CODEGEN_JJMQ0I_KernAgg part 2. Populate
...
FROM ##TMP_20180516125416_CODEGEN_4OA8VO_KernAgg_B0 AS [KernAgg_B0] UNION ALL SELECT [KernAgg_B1].[KEY] AS [KEY], [KernAgg_B1].[OVO_Class1] AS [OVO_Class1], [KernAgg_B1].[OVO_Class2] AS [OVO_Class2], [KernAgg_B1].[OVO_Decision] AS [OVO_Decision], [KernAgg_B1].[OVO_Confidence] AS [OVO_Confidence] 
FROM ##TMP_20180516125416_CODEGEN_C0UBEB_KernAgg_B1 AS [KernAgg_B1] UNION ALL SELECT [KernAgg_B2].[KEY] AS [KEY], [KernAgg_B2].[OVO_Class1] AS [OVO_Class1], [KernAgg_B2].[OVO_Class2] AS [OVO_Class2], [KernAgg_B2].[OVO_Decision] AS [OVO_Decision], [KernAgg_B2].[OVO_Confidence] AS [OVO_Confidence] 
FROM ##TMP_20180516125416_CODEGEN_P36VEN_KernAgg_B2 AS [KernAgg_B2]) AS [KernAgg_EnsembleUnion]), 
[OVO_Votes] AS 
