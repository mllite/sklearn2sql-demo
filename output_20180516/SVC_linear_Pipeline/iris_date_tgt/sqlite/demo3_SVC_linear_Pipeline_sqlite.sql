...
-- Code For temporary table TMP_20180516125416_CODEGEN_RN05I2_ADS_imp_1_OUT part 1. Create 


CREATE TEMPORARY TABLE "TMP_20180516125416_CODEGEN_RN05I2_ADS_imp_1_OUT" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20180516125416_CODEGEN_RN05I2_ADS_imp_1_OUT part 2. Populate

INSERT INTO "TMP_20180516125416_CODEGEN_RN05I2_ADS_imp_1_OUT" ("KEY", imputer_output_2, imputer_output_3, imputer_output_4, imputer_output_5) SELECT "ADS_imp_1_OUT"."KEY", "ADS_imp_1_OUT".imputer_output_2, "ADS_imp_1_OUT".imputer_output_3, "ADS_imp_1_OUT".imputer_output_4, "ADS_imp_1_OUT".imputer_output_5 
...
-- Code For temporary table TMP_20180516125416_CODEGEN_RN05I2_ADS_imp_1_OUT part 3. Create Index 

CREATE INDEX "ix_TMP_20180516125416_CODEGEN_RN05I2_ADS_imp_1_OUT_KEY" ON "TMP_20180516125416_CODEGEN_RN05I2_ADS_imp_1_OUT" ("KEY")

-- Code For temporary table TMP_20180516125416_CODEGEN_OGXABW_ADS_sca_2_OUT part 1. Create 


CREATE TEMPORARY TABLE "TMP_20180516125416_CODEGEN_OGXABW_ADS_sca_2_OUT" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20180516125416_CODEGEN_OGXABW_ADS_sca_2_OUT part 2. Populate

INSERT INTO "TMP_20180516125416_CODEGEN_OGXABW_ADS_sca_2_OUT" ("KEY", scaler_output_2, scaler_output_3, scaler_output_4, scaler_output_5) SELECT "ADS_sca_2_OUT"."KEY", "ADS_sca_2_OUT".scaler_output_2, "ADS_sca_2_OUT".scaler_output_3, "ADS_sca_2_OUT".scaler_output_4, "ADS_sca_2_OUT".scaler_output_5 
...
FROM "TMP_20180516125416_CODEGEN_RN05I2_ADS_imp_1_OUT" AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT"

-- Code For temporary table TMP_20180516125416_CODEGEN_OGXABW_ADS_sca_2_OUT part 3. Create Index 

CREATE INDEX "ix_TMP_20180516125416_CODEGEN_OGXABW_ADS_sca_2_OUT_KEY" ON "TMP_20180516125416_CODEGEN_OGXABW_ADS_sca_2_OUT" ("KEY")

-- Code For temporary table TMP_20180516125416_CODEGEN_6P4UTW_KernAgg_B0 part 1. Create 


CREATE TEMPORARY TABLE "TMP_20180516125416_CODEGEN_6P4UTW_KernAgg_B0" (
	"KEY" BIGINT, 
...
-- Code For temporary table TMP_20180516125416_CODEGEN_6P4UTW_KernAgg_B0 part 2. Populate
...
FROM "TMP_20180516125416_CODEGEN_OGXABW_ADS_sca_2_OUT" AS "ADS_sca_2_OUT"), 
...
FROM (SELECT full_join_data_sv."KEY" AS "KEY", sum(CAST(full_join_data_sv.dot_prod1 AS FLOAT)) + -1.5900231216431768 AS dot_product 
...
-- Code For temporary table TMP_20180516125416_CODEGEN_JJQGKX_KernAgg_B1 part 1. Create 


CREATE TEMPORARY TABLE "TMP_20180516125416_CODEGEN_JJQGKX_KernAgg_B1" (
	"KEY" BIGINT, 
	"OVO_Class1" VARCHAR COLLATE "utf8", 
	"OVO_Class2" VARCHAR COLLATE "utf8", 
	"OVO_Decision" BIGINT, 
...
-- Code For temporary table TMP_20180516125416_CODEGEN_JJQGKX_KernAgg_B1 part 2. Populate
...
FROM (SELECT full_join_data_sv_1."KEY" AS "KEY", sum(CAST(full_join_data_sv_1.dot_prod1 AS FLOAT)) + -0.361186144126904 AS dot_product 
...
(SELECT "kernel_dp_1789-07-14T00:00:00.000000000_1789-09-14T00:00:00.000000000"."KEY" AS "KEY", '1789-07-14T00:00:00.000000000' AS "OVO_Class1", '1789-09-14T00:00:00.000000000' AS "OVO_Class2", CASE WHEN (-"kernel_dp_1789-07-14T00:00:00.000000000_1789-09-14T00:00:00.000000000".dot_product >= 0.0) THEN 1 ELSE 0 END AS "OVO_Decision", coalesce(-"kernel_dp_1789-07-14T00:00:00.000000000_1789-09-14T00:00:00.000000000".dot_product, 1.0 / (1.0 + exp(min(max(-100.0, -(-((-"kernel_dp_1789-07-14T00:00:00.000000000_1789-09-14T00:00:00.000000000".dot_product) * -2.7272315930659214 + -0.14950093865677996))), 100.0)))) AS "OVO_Confidence" 
FROM "kernel_dp_1789-07-14T00:00:00.000000000_1789-09-14T00:00:00.000000000")
 INSERT INTO "TMP_20180516125416_CODEGEN_JJQGKX_KernAgg_B1" ("KEY", "OVO_Class1", "OVO_Class2", "OVO_Decision", "OVO_Confidence") SELECT "KernAgg_B1"."KEY", "KernAgg_B1"."OVO_Class1", "KernAgg_B1"."OVO_Class2", "KernAgg_B1"."OVO_Decision", "KernAgg_B1"."OVO_Confidence" 
...
-- Code For temporary table TMP_20180516125416_CODEGEN_7KUIYK_KernAgg_B2 part 1. Create 


CREATE TEMPORARY TABLE "TMP_20180516125416_CODEGEN_7KUIYK_KernAgg_B2" (
	"KEY" BIGINT, 
	"OVO_Class1" VARCHAR COLLATE "utf8", 
	"OVO_Class2" VARCHAR COLLATE "utf8", 
	"OVO_Decision" BIGINT, 
...
-- Code For temporary table TMP_20180516125416_CODEGEN_7KUIYK_KernAgg_B2 part 2. Populate
...
FROM (SELECT full_join_data_sv_2."KEY" AS "KEY", sum(CAST(full_join_data_sv_2.dot_prod1 AS FLOAT)) + 2.70975831744 AS dot_product 
...
(SELECT "kernel_dp_1789-08-14T00:00:00.000000000_1789-09-14T00:00:00.000000000"."KEY" AS "KEY", '1789-08-14T00:00:00.000000000' AS "OVO_Class1", '1789-09-14T00:00:00.000000000' AS "OVO_Class2", CASE WHEN (-"kernel_dp_1789-08-14T00:00:00.000000000_1789-09-14T00:00:00.000000000".dot_product >= 0.0) THEN 1 ELSE 0 END AS "OVO_Decision", coalesce(-"kernel_dp_1789-08-14T00:00:00.000000000_1789-09-14T00:00:00.000000000".dot_product, 1.0 / (1.0 + exp(min(max(-100.0, -(-((-"kernel_dp_1789-08-14T00:00:00.000000000_1789-09-14T00:00:00.000000000".dot_product) * -2.4719962927037415 + -0.01727524843058014))), 100.0)))) AS "OVO_Confidence" 
FROM "kernel_dp_1789-08-14T00:00:00.000000000_1789-09-14T00:00:00.000000000")
 INSERT INTO "TMP_20180516125416_CODEGEN_7KUIYK_KernAgg_B2" ("KEY", "OVO_Class1", "OVO_Class2", "OVO_Decision", "OVO_Confidence") SELECT "KernAgg_B2"."KEY", "KernAgg_B2"."OVO_Class1", "KernAgg_B2"."OVO_Class2", "KernAgg_B2"."OVO_Decision", "KernAgg_B2"."OVO_Confidence" 
...
-- Code For temporary table TMP_20180516125416_CODEGEN_RN600N_KernAgg part 1. Create 


CREATE TEMPORARY TABLE "TMP_20180516125416_CODEGEN_RN600N_KernAgg" (
	"KEY" BIGINT NOT NULL, 
	"OVO_Vote_1789-07-14T00:00:00.000000000" BIGINT, 
	"OVO_SumConfidence_1789-07-14T00:00:00.000000000" FLOAT, 
	"OVO_Vote_1789-08-14T00:00:00.000000000" BIGINT, 
	"OVO_SumConfidence_1789-08-14T00:00:00.000000000" FLOAT, 
	"OVO_Vote_1789-09-14T00:00:00.000000000" BIGINT, 
	"OVO_SumConfidence_1789-09-14T00:00:00.000000000" FLOAT, 
...
-- Code For temporary table TMP_20180516125416_CODEGEN_RN600N_KernAgg part 2. Populate
...
FROM "TMP_20180516125416_CODEGEN_6P4UTW_KernAgg_B0" AS "KernAgg_B0" UNION ALL SELECT "KernAgg_B1"."KEY" AS "KEY", "KernAgg_B1"."OVO_Class1" AS "OVO_Class1", "KernAgg_B1"."OVO_Class2" AS "OVO_Class2", "KernAgg_B1"."OVO_Decision" AS "OVO_Decision", "KernAgg_B1"."OVO_Confidence" AS "OVO_Confidence" 
FROM "TMP_20180516125416_CODEGEN_JJQGKX_KernAgg_B1" AS "KernAgg_B1" UNION ALL SELECT "KernAgg_B2"."KEY" AS "KEY", "KernAgg_B2"."OVO_Class1" AS "OVO_Class1", "KernAgg_B2"."OVO_Class2" AS "OVO_Class2", "KernAgg_B2"."OVO_Decision" AS "OVO_Decision", "KernAgg_B2"."OVO_Confidence" AS "OVO_Confidence" 
FROM "TMP_20180516125416_CODEGEN_7KUIYK_KernAgg_B2" AS "KernAgg_B2") AS "KernAgg_EnsembleUnion"), 
"OVO_Votes" AS 
...
-- Code For temporary table TMP_20180516125416_CODEGEN_RN600N_KernAgg part 3. Create Index 

CREATE INDEX "ix_TMP_20180516125416_CODEGEN_RN600N_KernAgg_KEY" ON "TMP_20180516125416_CODEGEN_RN600N_KernAgg" ("KEY")

-- Model deployment code

WITH orig_cte AS 
(SELECT "KernAgg"."KEY" AS "KEY", "KernAgg"."Score_1789-07-14T00:00:00.000000000" AS "Score_1789-07-14T00:00:00.000000000", "KernAgg"."Score_1789-08-14T00:00:00.000000000" AS "Score_1789-08-14T00:00:00.000000000", "KernAgg"."Score_1789-09-14T00:00:00.000000000" AS "Score_1789-09-14T00:00:00.000000000", CAST(NULL AS FLOAT) AS "Proba_1789-07-14T00:00:00.000000000", CAST(NULL AS FLOAT) AS "Proba_1789-08-14T00:00:00.000000000", CAST(NULL AS FLOAT) AS "Proba_1789-09-14T00:00:00.000000000", CAST(NULL AS FLOAT) AS "LogProba_1789-07-14T00:00:00.000000000", CAST(NULL AS FLOAT) AS "LogProba_1789-08-14T00:00:00.000000000", CAST(NULL AS FLOAT) AS "LogProba_1789-09-14T00:00:00.000000000", CAST(NULL AS BIGINT) AS "Decision", CAST(NULL AS FLOAT) AS "DecisionProba" 
FROM "TMP_20180516125416_CODEGEN_RN600N_KernAgg" AS "KernAgg"), 
