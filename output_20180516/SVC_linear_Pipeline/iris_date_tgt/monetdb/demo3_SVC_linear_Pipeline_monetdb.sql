...
-- Code For temporary table tmp_20180516125416_codegen_pervqv_ads_imp_1_out part 1. Create 


CREATE TEMPORARY TABLE tmp_20180516125416_codegen_pervqv_ads_imp_1_out (
	"KEY" BIGINT, 
...
-- Code For temporary table tmp_20180516125416_codegen_pervqv_ads_imp_1_out part 2. Populate

INSERT INTO tmp_20180516125416_codegen_pervqv_ads_imp_1_out ("KEY", imputer_output_2, imputer_output_3, imputer_output_4, imputer_output_5) SELECT "U"."KEY", "U".imputer_output_2, "U".imputer_output_3, "U".imputer_output_4, "U".imputer_output_5 
...
-- Code For temporary table tmp_20180516125416_codegen_udbr7g_ads_sca_2_out part 1. Create 


CREATE TEMPORARY TABLE tmp_20180516125416_codegen_udbr7g_ads_sca_2_out (
	"KEY" BIGINT, 
...
-- Code For temporary table tmp_20180516125416_codegen_udbr7g_ads_sca_2_out part 2. Populate

INSERT INTO tmp_20180516125416_codegen_udbr7g_ads_sca_2_out ("KEY", scaler_output_2, scaler_output_3, scaler_output_4, scaler_output_5) SELECT "U"."KEY", "U".scaler_output_2, "U".scaler_output_3, "U".scaler_output_4, "U".scaler_output_5 
...
FROM tmp_20180516125416_codegen_pervqv_ads_imp_1_out AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT") AS "U"

-- Code For temporary table tmp_20180516125416_codegen_27ymtk_kernagg_b0 part 1. Create 


CREATE TEMPORARY TABLE tmp_20180516125416_codegen_27ymtk_kernagg_b0 (
	"KEY" BIGINT, 
	"OVO_Class1" CLOB, 
	"OVO_Class2" CLOB, 
	"OVO_Decision" BIGINT, 
...
-- Code For temporary table tmp_20180516125416_codegen_27ymtk_kernagg_b0 part 2. Populate

INSERT INTO tmp_20180516125416_codegen_27ymtk_kernagg_b0 ("KEY", "OVO_Class1", "OVO_Class2", "OVO_Decision", "OVO_Confidence") SELECT "U"."KEY", "U"."OVO_Class1", "U"."OVO_Class2", "U"."OVO_Decision", "U"."OVO_Confidence" 
...
FROM tmp_20180516125416_codegen_udbr7g_ads_sca_2_out AS "ADS_sca_2_OUT"), 
...
FROM (SELECT 0 AS sv_idx, 0.3313142741679064 AS dual_coeff, -0.903826624263008 AS sv_0, 0.6036164774826909 AS sv_1, -1.2545200432489911 AS sv_2, -0.9935026111623527 AS sv_3 UNION ALL SELECT 1 AS sv_idx, 0.6120084742534154 AS dual_coeff, -1.6293061888888354 AS sv_0, -1.6885979939705589 AS sv_1, -1.4884631748571948 AS sv_2, -1.2602147215415076 AS sv_3 UNION ALL SELECT 2 AS sv_idx, -0.0 AS dual_coeff, 0.1843927226757343 AS sv_0, -0.3132693110986089 AS sv_1, 0.38308187800843274 AS sv_2, 0.34005794073342255 AS sv_3 UNION ALL SELECT 3 AS sv_idx, -0.0 AS dual_coeff, 1.1516988088435047 AS sv_0, -0.542490758243934 AS sv_1, 0.5585392267145852 AS sv_2, 0.2067018855438449 AS sv_3 UNION ALL SELECT 4 AS sv_idx, -0.0 AS dual_coeff, -0.29926032040815137 AS sv_0, -0.08404786395328369 AS sv_1, 0.38308187800843274 AS sv_2, 0.34005794073342255 AS sv_3 UNION ALL SELECT 5 AS sv_idx, -0.9163937780265576 AS dual_coeff, -0.903826624263008 AS sv_0, -1.2301550996799087 AS sv_1, -0.4942048655223301 AS sv_2, -0.19336628002488743 AS sv_3 UNION ALL SELECT 6 AS sv_idx, -0.0 AS dual_coeff, 0.5471325049886481 AS sv_0, -1.6885979939705589 AS sv_1, 0.3245960951063821 AS sv_2, 0.07334583035426756 AS sv_3 UNION ALL SELECT 7 AS sv_idx, -0.0 AS dual_coeff, 0.42621924421767715 AS sv_0, -1.917819441115883 AS sv_1, 0.38308187800843274 AS sv_2, 0.34005794073342255 AS sv_3 UNION ALL SELECT 8 AS sv_idx, -0.026928970394764388 AS dual_coeff, -1.1456531458049497 AS sv_0, -1.4593765468252338 AS sv_1, -0.31874751681617763 AS sv_2, -0.3267223352144651 AS sv_3 UNION ALL SELECT 9 AS sv_idx, -0.0 AS dual_coeff, 0.06347946190476342 AS sv_0, 0.37439503033736665 AS sv_1, 0.5585392267145852 AS sv_2, 0.7401261063021551 AS sv_3 UNION ALL SELECT 10 AS sv_idx, -0.0 AS dual_coeff, 0.5471325049886481 AS sv_0, -1.2301550996799087 AS sv_1, 0.6170250096166364 AS sv_2, 0.34005794073342255 AS sv_3 UNION ALL SELECT 11 AS sv_idx, -0.0 AS dual_coeff, 0.3053059834467052 AS sv_0, -0.3132693110986089 AS sv_1, 0.5000534438125346 AS sv_2, 0.2067018855438449 AS sv_3 UNION ALL SELECT 12 AS sv_idx, -0.0 AS dual_coeff, -0.5410868419500932 AS sv_0, -0.08404786395328369 AS sv_1, 0.38308187800843274 AS sv_2, 0.34005794073342255 AS sv_3 UNION ALL SELECT 13 AS sv_idx, -0.0 AS dual_coeff, 1.0307855480725336 AS sv_0, -0.08404786395328369 AS sv_1, 0.6755107925186871 AS sv_2, 0.6067700511125775 AS sv_3 UNION ALL SELECT 14 AS sv_idx, -0.0 AS dual_coeff, 1.2726120696144765 AS sv_0, 0.1451735831920415 AS sv_1, 0.6170250096166364 AS sv_2, 0.34005794073342255 AS sv_3) AS "Values"), 
...
-- Code For temporary table tmp_20180516125416_codegen_6v8qt2_kernagg_b1 part 1. Create 


CREATE TEMPORARY TABLE tmp_20180516125416_codegen_6v8qt2_kernagg_b1 (
	"KEY" BIGINT, 
	"OVO_Class1" CLOB, 
	"OVO_Class2" CLOB, 
	"OVO_Decision" BIGINT, 
...
-- Code For temporary table tmp_20180516125416_codegen_6v8qt2_kernagg_b1 part 2. Populate

INSERT INTO tmp_20180516125416_codegen_6v8qt2_kernagg_b1 ("KEY", "OVO_Class1", "OVO_Class2", "OVO_Decision", "OVO_Confidence") SELECT "U"."KEY", "U"."OVO_Class1", "U"."OVO_Class2", "U"."OVO_Decision", "U"."OVO_Confidence" 
FROM (WITH kernel_input AS 
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", CAST("ADS_sca_2_OUT".scaler_output_2 AS DOUBLE) AS scaler_output_2, CAST("ADS_sca_2_OUT".scaler_output_3 AS DOUBLE) AS scaler_output_3, CAST("ADS_sca_2_OUT".scaler_output_4 AS DOUBLE) AS scaler_output_4, CAST("ADS_sca_2_OUT".scaler_output_5 AS DOUBLE) AS scaler_output_5 
FROM tmp_20180516125416_codegen_udbr7g_ads_sca_2_out AS "ADS_sca_2_OUT"), 
"SV_data_1789-07-14T00:00:00.000000000_1789-09-14T00:00:00.000000000" AS 
(SELECT "Values".sv_idx AS sv_idx, CAST("Values".dual_coeff AS DOUBLE) AS dual_coeff, CAST("Values".sv_0 AS DOUBLE) AS sv_0, CAST("Values".sv_1 AS DOUBLE) AS sv_1, CAST("Values".sv_2 AS DOUBLE) AS sv_2, CAST("Values".sv_3 AS DOUBLE) AS sv_3 
FROM (SELECT 0 AS sv_idx, 0.12171329143501097 AS dual_coeff, -0.903826624263008 AS sv_0, 0.6036164774826909 AS sv_1, -1.2545200432489911 AS sv_2, -0.9935026111623527 AS sv_3 UNION ALL SELECT 1 AS sv_idx, 0.18557788786333185 AS dual_coeff, -1.6293061888888354 AS sv_0, -1.6885979939705589 AS sv_1, -1.4884631748571948 AS sv_2, -1.2602147215415076 AS sv_3 UNION ALL SELECT 15 AS sv_idx, -0.0 AS dual_coeff, 0.3053059834467052 AS sv_0, -0.08404786395328369 AS sv_1, 0.6170250096166364 AS sv_2, 0.7401261063021551 AS sv_3 UNION ALL SELECT 16 AS sv_idx, -0.30729117929834293 AS dual_coeff, -1.1456531458049497 AS sv_0, -1.2301550996799087 AS sv_1, 0.38308187800843274 AS sv_2, 0.6067700511125775 AS sv_3 UNION ALL SELECT 17 AS sv_idx, -0.0 AS dual_coeff, 0.7889590265305909 AS sv_0, 0.37439503033736665 AS sv_1, 0.7339965754207377 AS sv_2, 1.0068382166813101 AS sv_3 UNION ALL SELECT 18 AS sv_idx, -0.0 AS dual_coeff, 0.5471325049886481 AS sv_0, -0.7717122053892582 AS sv_1, 0.6170250096166364 AS sv_2, 0.7401261063021551 AS sv_3 UNION ALL SELECT 19 AS sv_idx, -0.0 AS dual_coeff, 0.06347946190476342 AS sv_0, -0.08404786395328369 AS sv_1, 0.7339965754207377 AS sv_2, 0.7401261063021551 AS sv_3 UNION ALL SELECT 20 AS sv_idx, -0.0 AS dual_coeff, 0.1843927226757343 AS sv_0, -0.08404786395328369 AS sv_1, 0.5585392267145852 AS sv_2, 0.7401261063021551 AS sv_3 UNION ALL SELECT 21 AS sv_idx, -0.0 AS dual_coeff, 0.3053059834467052 AS sv_0, -1.0009336525345833 AS sv_1, 1.026425489930992 AS sv_2, 0.2067018855438449 AS sv_3 UNION ALL SELECT 22 AS sv_idx, -0.0 AS dual_coeff, 0.5471325049886481 AS sv_0, -0.542490758243934 AS sv_1, 0.7339965754207377 AS sv_2, 0.34005794073342255 AS sv_3 UNION ALL SELECT 23 AS sv_idx, -0.0 AS dual_coeff, 0.7889590265305909 AS sv_0, -0.08404786395328369 AS sv_1, 0.9679397070289413 AS sv_2, 0.7401261063021551 AS sv_3 UNION ALL SELECT 24 AS sv_idx, -0.0 AS dual_coeff, 1.6353518519273904 AS sv_0, -0.08404786395328369 AS sv_1, 1.1433970557350939 AS sv_2, 0.4734139959230002 AS sv_3 UNION ALL SELECT 25 AS sv_idx, -0.0 AS dual_coeff, 0.1843927226757343 AS sv_0, -1.917819441115883 AS sv_1, 0.6755107925186871 AS sv_2, 0.34005794073342255 AS sv_3) AS "Values"), 
...
(SELECT "kernel_dp_1789-07-14T00:00:00.000000000_1789-09-14T00:00:00.000000000"."KEY" AS "KEY", '1789-07-14T00:00:00.000000000' AS "OVO_Class1", '1789-09-14T00:00:00.000000000' AS "OVO_Class2", CASE WHEN (-"kernel_dp_1789-07-14T00:00:00.000000000_1789-09-14T00:00:00.000000000".dot_product >= 0.0) THEN 1 ELSE 0 END AS "OVO_Decision", coalesce(-"kernel_dp_1789-07-14T00:00:00.000000000_1789-09-14T00:00:00.000000000".dot_product, 1.0 / (1.0 + exp(CASE WHEN (CASE WHEN (-100.0 <= -(-((-"kernel_dp_1789-07-14T00:00:00.000000000_1789-09-14T00:00:00.000000000".dot_product) * -2.7272315930659214 + -0.14950093865677996))) THEN -(-((-"kernel_dp_1789-07-14T00:00:00.000000000_1789-09-14T00:00:00.000000000".dot_product) * -2.7272315930659214 + -0.14950093865677996)) ELSE -100.0 END <= 100.0) THEN CASE WHEN (-100.0 <= -(-((-"kernel_dp_1789-07-14T00:00:00.000000000_1789-09-14T00:00:00.000000000".dot_product) * -2.7272315930659214 + -0.14950093865677996))) THEN -(-((-"kernel_dp_1789-07-14T00:00:00.000000000_1789-09-14T00:00:00.000000000".dot_product) * -2.7272315930659214 + -0.14950093865677996)) ELSE -100.0 END ELSE 100.0 END))) AS "OVO_Confidence" 
...
-- Code For temporary table tmp_20180516125416_codegen_ejy6h7_kernagg_b2 part 1. Create 


CREATE TEMPORARY TABLE tmp_20180516125416_codegen_ejy6h7_kernagg_b2 (
	"KEY" BIGINT, 
	"OVO_Class1" CLOB, 
	"OVO_Class2" CLOB, 
	"OVO_Decision" BIGINT, 
...
-- Code For temporary table tmp_20180516125416_codegen_ejy6h7_kernagg_b2 part 2. Populate

INSERT INTO tmp_20180516125416_codegen_ejy6h7_kernagg_b2 ("KEY", "OVO_Class1", "OVO_Class2", "OVO_Decision", "OVO_Confidence") SELECT "U"."KEY", "U"."OVO_Class1", "U"."OVO_Class2", "U"."OVO_Decision", "U"."OVO_Confidence" 
FROM (WITH kernel_input AS 
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", CAST("ADS_sca_2_OUT".scaler_output_2 AS DOUBLE) AS scaler_output_2, CAST("ADS_sca_2_OUT".scaler_output_3 AS DOUBLE) AS scaler_output_3, CAST("ADS_sca_2_OUT".scaler_output_4 AS DOUBLE) AS scaler_output_4, CAST("ADS_sca_2_OUT".scaler_output_5 AS DOUBLE) AS scaler_output_5 
FROM tmp_20180516125416_codegen_udbr7g_ads_sca_2_out AS "ADS_sca_2_OUT"), 
"SV_data_1789-08-14T00:00:00.000000000_1789-09-14T00:00:00.000000000" AS 
(SELECT "Values".sv_idx AS sv_idx, CAST("Values".dual_coeff AS DOUBLE) AS dual_coeff, CAST("Values".sv_0 AS DOUBLE) AS sv_0, CAST("Values".sv_1 AS DOUBLE) AS sv_1, CAST("Values".sv_2 AS DOUBLE) AS sv_2, CAST("Values".sv_3 AS DOUBLE) AS sv_3 
FROM (SELECT 2 AS sv_idx, 1.0 AS dual_coeff, 0.1843927226757343 AS sv_0, -0.3132693110986089 AS sv_1, 0.38308187800843274 AS sv_2, 0.34005794073342255 AS sv_3 UNION ALL SELECT 3 AS sv_idx, 0.32430979924616193 AS dual_coeff, 1.1516988088435047 AS sv_0, -0.542490758243934 AS sv_1, 0.5585392267145852 AS sv_2, 0.2067018855438449 AS sv_3 UNION ALL SELECT 4 AS sv_idx, 1.0 AS dual_coeff, -0.29926032040815137 AS sv_0, -0.08404786395328369 AS sv_1, 0.38308187800843274 AS sv_2, 0.34005794073342255 AS sv_3 UNION ALL SELECT 5 AS sv_idx, 0.0 AS dual_coeff, -0.903826624263008 AS sv_0, -1.2301550996799087 AS sv_1, -0.4942048655223301 AS sv_2, -0.19336628002488743 AS sv_3 UNION ALL SELECT 6 AS sv_idx, 0.6962589219847841 AS dual_coeff, 0.5471325049886481 AS sv_0, -1.6885979939705589 AS sv_1, 0.3245960951063821 AS sv_2, 0.07334583035426756 AS sv_3 UNION ALL SELECT 7 AS sv_idx, 1.0 AS dual_coeff, 0.42621924421767715 AS sv_0, -1.917819441115883 AS sv_1, 0.38308187800843274 AS sv_2, 0.34005794073342255 AS sv_3 UNION ALL SELECT 8 AS sv_idx, 0.0 AS dual_coeff, -1.1456531458049497 AS sv_0, -1.4593765468252338 AS sv_1, -0.31874751681617763 AS sv_2, -0.3267223352144651 AS sv_3 UNION ALL SELECT 9 AS sv_idx, 1.0 AS dual_coeff, 0.06347946190476342 AS sv_0, 0.37439503033736665 AS sv_1, 0.5585392267145852 AS sv_2, 0.7401261063021551 AS sv_3 UNION ALL SELECT 10 AS sv_idx, 1.0 AS dual_coeff, 0.5471325049886481 AS sv_0, -1.2301550996799087 AS sv_1, 0.6170250096166364 AS sv_2, 0.34005794073342255 AS sv_3 UNION ALL SELECT 11 AS sv_idx, 0.9928455350642991 AS dual_coeff, 0.3053059834467052 AS sv_0, -0.3132693110986089 AS sv_1, 0.5000534438125346 AS sv_2, 0.2067018855438449 AS sv_3 UNION ALL SELECT 12 AS sv_idx, 1.0 AS dual_coeff, -0.5410868419500932 AS sv_0, -0.08404786395328369 AS sv_1, 0.38308187800843274 AS sv_2, 0.34005794073342255 AS sv_3 UNION ALL SELECT 13 AS sv_idx, 1.0 AS dual_coeff, 1.0307855480725336 AS sv_0, -0.08404786395328369 AS sv_1, 0.6755107925186871 AS sv_2, 0.6067700511125775 AS sv_3 UNION ALL SELECT 14 AS sv_idx, 1.0 AS dual_coeff, 1.2726120696144765 AS sv_0, 0.1451735831920415 AS sv_1, 0.6170250096166364 AS sv_2, 0.34005794073342255 AS sv_3 UNION ALL SELECT 15 AS sv_idx, -1.0 AS dual_coeff, 0.3053059834467052 AS sv_0, -0.08404786395328369 AS sv_1, 0.6170250096166364 AS sv_2, 0.7401261063021551 AS sv_3 UNION ALL SELECT 16 AS sv_idx, -1.0 AS dual_coeff, -1.1456531458049497 AS sv_0, -1.2301550996799087 AS sv_1, 0.38308187800843274 AS sv_2, 0.6067700511125775 AS sv_3 UNION ALL SELECT 17 AS sv_idx, -1.0 AS dual_coeff, 0.7889590265305909 AS sv_0, 0.37439503033736665 AS sv_1, 0.7339965754207377 AS sv_2, 1.0068382166813101 AS sv_3 UNION ALL SELECT 18 AS sv_idx, -1.0 AS dual_coeff, 0.5471325049886481 AS sv_0, -0.7717122053892582 AS sv_1, 0.6170250096166364 AS sv_2, 0.7401261063021551 AS sv_3 UNION ALL SELECT 19 AS sv_idx, -1.0 AS dual_coeff, 0.06347946190476342 AS sv_0, -0.08404786395328369 AS sv_1, 0.7339965754207377 AS sv_2, 0.7401261063021551 AS sv_3 UNION ALL SELECT 20 AS sv_idx, -1.0 AS dual_coeff, 0.1843927226757343 AS sv_0, -0.08404786395328369 AS sv_1, 0.5585392267145852 AS sv_2, 0.7401261063021551 AS sv_3 UNION ALL SELECT 21 AS sv_idx, -1.0 AS dual_coeff, 0.3053059834467052 AS sv_0, -1.0009336525345833 AS sv_1, 1.026425489930992 AS sv_2, 0.2067018855438449 AS sv_3 UNION ALL SELECT 22 AS sv_idx, -1.0 AS dual_coeff, 0.5471325049886481 AS sv_0, -0.542490758243934 AS sv_1, 0.7339965754207377 AS sv_2, 0.34005794073342255 AS sv_3 UNION ALL SELECT 23 AS sv_idx, -0.013414256295245043 AS dual_coeff, 0.7889590265305909 AS sv_0, -0.08404786395328369 AS sv_1, 0.9679397070289413 AS sv_2, 0.7401261063021551 AS sv_3 UNION ALL SELECT 24 AS sv_idx, -1.0 AS dual_coeff, 1.6353518519273904 AS sv_0, -0.08404786395328369 AS sv_1, 1.1433970557350939 AS sv_2, 0.4734139959230002 AS sv_3 UNION ALL SELECT 25 AS sv_idx, -1.0 AS dual_coeff, 0.1843927226757343 AS sv_0, -1.917819441115883 AS sv_1, 0.6755107925186871 AS sv_2, 0.34005794073342255 AS sv_3) AS "Values"), 
...
-- Code For temporary table tmp_20180516125416_codegen_7aclsb_kernagg part 1. Create 


CREATE TEMPORARY TABLE tmp_20180516125416_codegen_7aclsb_kernagg (
	"KEY" BIGINT, 
	"OVO_Vote_1789-07-14T00:00:00.000000000" BIGINT, 
	"OVO_SumConfidence_1789-07-14T00:00:00.000000000" DOUBLE, 
	"OVO_Vote_1789-08-14T00:00:00.000000000" BIGINT, 
	"OVO_SumConfidence_1789-08-14T00:00:00.000000000" DOUBLE, 
	"OVO_Vote_1789-09-14T00:00:00.000000000" BIGINT, 
	"OVO_SumConfidence_1789-09-14T00:00:00.000000000" DOUBLE, 
...
FROM tmp_20180516125416_codegen_27ymtk_kernagg_b0 AS "KernAgg_B0" UNION ALL SELECT "KernAgg_B1"."KEY" AS "KEY", "KernAgg_B1"."OVO_Class1" AS "OVO_Class1", "KernAgg_B1"."OVO_Class2" AS "OVO_Class2", "KernAgg_B1"."OVO_Decision" AS "OVO_Decision", "KernAgg_B1"."OVO_Confidence" AS "OVO_Confidence" 
FROM tmp_20180516125416_codegen_6v8qt2_kernagg_b1 AS "KernAgg_B1" UNION ALL SELECT "KernAgg_B2"."KEY" AS "KEY", "KernAgg_B2"."OVO_Class1" AS "OVO_Class1", "KernAgg_B2"."OVO_Class2" AS "OVO_Class2", "KernAgg_B2"."OVO_Decision" AS "OVO_Decision", "KernAgg_B2"."OVO_Confidence" AS "OVO_Confidence" 
FROM tmp_20180516125416_codegen_ejy6h7_kernagg_b2 AS "KernAgg_B2") AS "KernAgg_EnsembleUnion"), 
"OVO_Votes" AS 
...
(SELECT "OVO_Votes"."KEY" AS "KEY", "OVO_Votes"."OVO_Vote_1789-07-14T00:00:00.000000000" AS "OVO_Vote_1789-07-14T00:00:00.000000000", "OVO_Votes"."OVO_SumConfidence_1789-07-14T00:00:00.000000000" AS "OVO_SumConfidence_1789-07-14T00:00:00.000000000", "OVO_Votes"."OVO_Vote_1789-08-14T00:00:00.000000000" AS "OVO_Vote_1789-08-14T00:00:00.000000000", "OVO_Votes"."OVO_SumConfidence_1789-08-14T00:00:00.000000000" AS "OVO_SumConfidence_1789-08-14T00:00:00.000000000", "OVO_Votes"."OVO_Vote_1789-09-14T00:00:00.000000000" AS "OVO_Vote_1789-09-14T00:00:00.000000000", "OVO_Votes"."OVO_SumConfidence_1789-09-14T00:00:00.000000000" AS "OVO_SumConfidence_1789-09-14T00:00:00.000000000", CAST(CASE WHEN (abs("MinMaxConf"."OVO_min_conf") >= abs("MinMaxConf"."OVO_max_conf")) THEN abs("MinMaxConf"."OVO_min_conf") ELSE abs("MinMaxConf"."OVO_max_conf") END AS DOUBLE) AS max_abs_confidence, CASE WHEN ("MinMaxConf"."OVO_max_conf" - "MinMaxConf"."OVO_min_conf" <= 0.0) THEN 0.0 ELSE 0.4999999999999998 / CAST(CASE WHEN (abs("MinMaxConf"."OVO_min_conf") >= abs("MinMaxConf"."OVO_max_conf")) THEN abs("MinMaxConf"."OVO_min_conf") ELSE abs("MinMaxConf"."OVO_max_conf") END AS DOUBLE) END AS "OVO_Scale" 
