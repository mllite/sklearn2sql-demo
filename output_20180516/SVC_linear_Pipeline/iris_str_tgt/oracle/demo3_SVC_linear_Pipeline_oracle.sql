...
-- Code For temporary table 20180602_W8H_ADS_IMP_1_OUT part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "20180602_W8H_ADS_IMP_1_OUT" (
	"KEY" NUMBER(19), 
...
-- Code For temporary table 20180602_W8H_ADS_IMP_1_OUT part 2. Populate

INSERT INTO "20180602_W8H_ADS_IMP_1_OUT" ("KEY", imputer_output_2, imputer_output_3, imputer_output_4, imputer_output_5) SELECT "U"."KEY", "U".imputer_output_2, "U".imputer_output_3, "U".imputer_output_4, "U".imputer_output_5 
...
-- Code For temporary table 20180602_X8F_ADS_SCA_2_OUT part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "20180602_X8F_ADS_SCA_2_OUT" (
	"KEY" NUMBER(19), 
...
-- Code For temporary table 20180602_X8F_ADS_SCA_2_OUT part 2. Populate

INSERT INTO "20180602_X8F_ADS_SCA_2_OUT" ("KEY", scaler_output_2, scaler_output_3, scaler_output_4, scaler_output_5) SELECT "U"."KEY", "U".scaler_output_2, "U".scaler_output_3, "U".scaler_output_4, "U".scaler_output_5 
...
FROM "20180602_W8H_ADS_IMP_1_OUT" "ADS_imp_1_OUT") "ADS_sca_2_OUT") "U"

-- Code For temporary table MP_20180602_CT6_KERNAGG_B0 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "MP_20180602_CT6_KERNAGG_B0" (
	"KEY" NUMBER(19), 
	"OVO_Class1" VARCHAR2, 
	"OVO_Class2" VARCHAR2, 
...
-- Code For temporary table MP_20180602_CT6_KERNAGG_B0 part 2. Populate

INSERT INTO "MP_20180602_CT6_KERNAGG_B0" ("KEY", "OVO_Class1", "OVO_Class2", "OVO_Decision", "OVO_Conf") SELECT "U"."KEY", "U"."OVO_Class1", "U"."OVO_Class2", "U"."OVO_Decision", "U"."OVO_Conf" 
...
FROM "20180602_X8F_ADS_SCA_2_OUT" "ADS_sca_2_OUT"), 
...
-- Code For temporary table MP_20180602_5HL_KERNAGG_B1 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "MP_20180602_5HL_KERNAGG_B1" (
	"KEY" NUMBER(19), 
	"OVO_Class1" VARCHAR2, 
	"OVO_Class2" VARCHAR2, 
	"OVO_Decision" NUMBER(19), 
...
-- Code For temporary table MP_20180602_5HL_KERNAGG_B1 part 2. Populate

INSERT INTO "MP_20180602_5HL_KERNAGG_B1" ("KEY", "OVO_Class1", "OVO_Class2", "OVO_Decision", "OVO_Conf") SELECT "U"."KEY", "U"."OVO_Class1", "U"."OVO_Class2", "U"."OVO_Decision", "U"."OVO_Conf" 
FROM (WITH kernel_input AS 
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", CAST("ADS_sca_2_OUT".scaler_output_2 AS BINARY_DOUBLE) AS scaler_output_2, CAST("ADS_sca_2_OUT".scaler_output_3 AS BINARY_DOUBLE) AS scaler_output_3, CAST("ADS_sca_2_OUT".scaler_output_4 AS BINARY_DOUBLE) AS scaler_output_4, CAST("ADS_sca_2_OUT".scaler_output_5 AS BINARY_DOUBLE) AS scaler_output_5 
FROM "20180602_X8F_ADS_SCA_2_OUT" "ADS_sca_2_OUT"), 
...
-- Code For temporary table MP_20180602_CPC_KERNAGG_B2 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "MP_20180602_CPC_KERNAGG_B2" (
	"KEY" NUMBER(19), 
	"OVO_Class1" VARCHAR2, 
	"OVO_Class2" VARCHAR2, 
	"OVO_Decision" NUMBER(19), 
...
-- Code For temporary table MP_20180602_CPC_KERNAGG_B2 part 2. Populate

INSERT INTO "MP_20180602_CPC_KERNAGG_B2" ("KEY", "OVO_Class1", "OVO_Class2", "OVO_Decision", "OVO_Conf") SELECT "U"."KEY", "U"."OVO_Class1", "U"."OVO_Class2", "U"."OVO_Decision", "U"."OVO_Conf" 
FROM (WITH kernel_input AS 
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", CAST("ADS_sca_2_OUT".scaler_output_2 AS BINARY_DOUBLE) AS scaler_output_2, CAST("ADS_sca_2_OUT".scaler_output_3 AS BINARY_DOUBLE) AS scaler_output_3, CAST("ADS_sca_2_OUT".scaler_output_4 AS BINARY_DOUBLE) AS scaler_output_4, CAST("ADS_sca_2_OUT".scaler_output_5 AS BINARY_DOUBLE) AS scaler_output_5 
FROM "20180602_X8F_ADS_SCA_2_OUT" "ADS_sca_2_OUT"), 
...
-- Code For temporary table P_20180602_ACY_KERNAGG_AGG part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "P_20180602_ACY_KERNAGG_AGG" (
	"KEY" NUMBER(19), 
...
-- Code For temporary table P_20180602_ACY_KERNAGG_AGG part 2. Populate

INSERT INTO "P_20180602_ACY_KERNAGG_AGG" ("KEY", "OVO_Vote_CLASS_0", "OVO_SumConfidence_CLASS_0", "OVO_Vote_CLASS_1", "OVO_SumConfidence_CLASS_1", "OVO_Vote_CLASS_2", "OVO_SumConfidence_CLASS_2", max_abs_confidence, "OVO_Scale", "Score_CLASS_0", "Score_CLASS_1", "Score_CLASS_2") SELECT "U"."KEY", "U"."OVO_Vote_CLASS_0", "U"."OVO_SumConfidence_CLASS__1", "U"."OVO_Vote_CLASS_1", "U"."OVO_SumConfidence_CLASS__2", "U"."OVO_Vote_CLASS_2", "U"."OVO_SumConfidence_CLASS__3", "U".max_abs_confidence, "U"."OVO_Scale", "U"."Score_CLASS_0", "U"."Score_CLASS_1", "U"."Score_CLASS_2" 
...
FROM "MP_20180602_CT6_KERNAGG_B0" "KernAgg_B0" UNION ALL SELECT "KernAgg_B1"."KEY" AS "KEY", "KernAgg_B1"."OVO_Class1" AS "OVO_Class1", "KernAgg_B1"."OVO_Class2" AS "OVO_Class2", "KernAgg_B1"."OVO_Decision" AS "OVO_Decision", "KernAgg_B1"."OVO_Conf" AS "OVO_Conf" 
FROM "MP_20180602_5HL_KERNAGG_B1" "KernAgg_B1" UNION ALL SELECT "KernAgg_B2"."KEY" AS "KEY", "KernAgg_B2"."OVO_Class1" AS "OVO_Class1", "KernAgg_B2"."OVO_Class2" AS "OVO_Class2", "KernAgg_B2"."OVO_Decision" AS "OVO_Decision", "KernAgg_B2"."OVO_Conf" AS "OVO_Conf" 
FROM "MP_20180602_CPC_KERNAGG_B2" "KernAgg_B2") "KernAgg_EnsembleUnion"), 
"OVO_Votes" AS 
...
FROM "P_20180602_ACY_KERNAGG_AGG" "KernAgg_agg"), 
