...
-- Code For temporary table ##TMP_20180516132908_CODEGEN_UJ6FBH_ADS_imp_1_OUT part 1. Create 


CREATE TABLE ##TMP_20180516132908_CODEGEN_UJ6FBH_ADS_imp_1_OUT (
	[KEY] BIGINT NULL, 
...
-- Code For temporary table ##TMP_20180516132908_CODEGEN_UJ6FBH_ADS_imp_1_OUT part 2. Populate

INSERT INTO ##TMP_20180516132908_CODEGEN_UJ6FBH_ADS_imp_1_OUT ([KEY], imputer_output_2, imputer_output_3, imputer_output_4, imputer_output_5) SELECT [ADS_imp_1_OUT].[KEY], [ADS_imp_1_OUT].imputer_output_2, [ADS_imp_1_OUT].imputer_output_3, [ADS_imp_1_OUT].imputer_output_4, [ADS_imp_1_OUT].imputer_output_5 
...
-- Code For temporary table ##TMP_20180516132908_CODEGEN_SBHO0O_ADS_sca_2_OUT part 1. Create 


CREATE TABLE ##TMP_20180516132908_CODEGEN_SBHO0O_ADS_sca_2_OUT (
	[KEY] BIGINT NULL, 
...
-- Code For temporary table ##TMP_20180516132908_CODEGEN_SBHO0O_ADS_sca_2_OUT part 2. Populate

INSERT INTO ##TMP_20180516132908_CODEGEN_SBHO0O_ADS_sca_2_OUT ([KEY], scaler_output_2, scaler_output_3, scaler_output_4, scaler_output_5) SELECT [ADS_sca_2_OUT].[KEY], [ADS_sca_2_OUT].scaler_output_2, [ADS_sca_2_OUT].scaler_output_3, [ADS_sca_2_OUT].scaler_output_4, [ADS_sca_2_OUT].scaler_output_5 
...
FROM ##TMP_20180516132908_CODEGEN_UJ6FBH_ADS_imp_1_OUT AS [ADS_imp_1_OUT]) AS [ADS_sca_2_OUT]

-- Code For temporary table ##TMP_20180516132908_CODEGEN_0RFEQZ_KernAgg_B0 part 1. Create 


CREATE TABLE ##TMP_20180516132908_CODEGEN_0RFEQZ_KernAgg_B0 (
	[KEY] BIGINT NULL, 
...
-- Code For temporary table ##TMP_20180516132908_CODEGEN_0RFEQZ_KernAgg_B0 part 2. Populate
...
FROM ##TMP_20180516132908_CODEGEN_SBHO0O_ADS_sca_2_OUT AS [ADS_sca_2_OUT]), 
...
(SELECT [kernel_dp_CLASS_0_CLASS_1].[KEY] AS [KEY], 'CLASS_0' AS [OVO_Class1], 'CLASS_1' AS [OVO_Class2], CASE WHEN (-[kernel_dp_CLASS_0_CLASS_1].dot_product >= 0.0) THEN 1 ELSE 0 END AS [OVO_Decision], coalesce(-[kernel_dp_CLASS_0_CLASS_1].dot_product, 1.0 / (1.0 + exp(CASE WHEN (CASE WHEN (-100.0 <= -(-((-[kernel_dp_CLASS_0_CLASS_1].dot_product) * -2.2118454585300618 + -0.43076807476199186))) THEN -(-((-[kernel_dp_CLASS_0_CLASS_1].dot_product) * -2.2118454585300618 + -0.43076807476199186)) ELSE -100.0 END <= 100.0) THEN CASE WHEN (-100.0 <= -(-((-[kernel_dp_CLASS_0_CLASS_1].dot_product) * -2.2118454585300618 + -0.43076807476199186))) THEN -(-((-[kernel_dp_CLASS_0_CLASS_1].dot_product) * -2.2118454585300618 + -0.43076807476199186)) ELSE -100.0 END ELSE 100.0 END))) AS [OVO_Confidence] 
FROM [kernel_dp_CLASS_0_CLASS_1])
 INSERT INTO ##TMP_20180516132908_CODEGEN_0RFEQZ_KernAgg_B0 ([KEY], [OVO_Class1], [OVO_Class2], [OVO_Decision], [OVO_Confidence]) SELECT [KernAgg_B0].[KEY], [KernAgg_B0].[OVO_Class1], [KernAgg_B0].[OVO_Class2], [KernAgg_B0].[OVO_Decision], [KernAgg_B0].[OVO_Confidence] 
...
-- Code For temporary table ##TMP_20180516132908_CODEGEN_9LU60X_KernAgg_B1 part 1. Create 


CREATE TABLE ##TMP_20180516132908_CODEGEN_9LU60X_KernAgg_B1 (
	[KEY] BIGINT NULL, 
	[OVO_Class1] VARCHAR(max) COLLATE utf8 NULL, 
	[OVO_Class2] VARCHAR(max) COLLATE utf8 NULL, 
	[OVO_Decision] BIGINT NULL, 
...
-- Code For temporary table ##TMP_20180516132908_CODEGEN_9LU60X_KernAgg_B1 part 2. Populate
...
(SELECT [kernel_dp_CLASS_0_CLASS_2].[KEY] AS [KEY], 'CLASS_0' AS [OVO_Class1], 'CLASS_2' AS [OVO_Class2], CASE WHEN (-[kernel_dp_CLASS_0_CLASS_2].dot_product >= 0.0) THEN 1 ELSE 0 END AS [OVO_Decision], coalesce(-[kernel_dp_CLASS_0_CLASS_2].dot_product, 1.0 / (1.0 + exp(CASE WHEN (CASE WHEN (-100.0 <= -(-((-[kernel_dp_CLASS_0_CLASS_2].dot_product) * -2.747095375213445 + -0.10597746281060981))) THEN -(-((-[kernel_dp_CLASS_0_CLASS_2].dot_product) * -2.747095375213445 + -0.10597746281060981)) ELSE -100.0 END <= 100.0) THEN CASE WHEN (-100.0 <= -(-((-[kernel_dp_CLASS_0_CLASS_2].dot_product) * -2.747095375213445 + -0.10597746281060981))) THEN -(-((-[kernel_dp_CLASS_0_CLASS_2].dot_product) * -2.747095375213445 + -0.10597746281060981)) ELSE -100.0 END ELSE 100.0 END))) AS [OVO_Confidence] 
FROM [kernel_dp_CLASS_0_CLASS_2])
 INSERT INTO ##TMP_20180516132908_CODEGEN_9LU60X_KernAgg_B1 ([KEY], [OVO_Class1], [OVO_Class2], [OVO_Decision], [OVO_Confidence]) SELECT [KernAgg_B1].[KEY], [KernAgg_B1].[OVO_Class1], [KernAgg_B1].[OVO_Class2], [KernAgg_B1].[OVO_Decision], [KernAgg_B1].[OVO_Confidence] 
...
-- Code For temporary table ##TMP_20180516132908_CODEGEN_0JQGFC_KernAgg_B2 part 1. Create 


CREATE TABLE ##TMP_20180516132908_CODEGEN_0JQGFC_KernAgg_B2 (
	[KEY] BIGINT NULL, 
	[OVO_Class1] VARCHAR(max) COLLATE utf8 NULL, 
	[OVO_Class2] VARCHAR(max) COLLATE utf8 NULL, 
	[OVO_Decision] BIGINT NULL, 
...
-- Code For temporary table ##TMP_20180516132908_CODEGEN_0JQGFC_KernAgg_B2 part 2. Populate
...
(SELECT [kernel_dp_CLASS_1_CLASS_2].[KEY] AS [KEY], 'CLASS_1' AS [OVO_Class1], 'CLASS_2' AS [OVO_Class2], CASE WHEN (-[kernel_dp_CLASS_1_CLASS_2].dot_product >= 0.0) THEN 1 ELSE 0 END AS [OVO_Decision], coalesce(-[kernel_dp_CLASS_1_CLASS_2].dot_product, 1.0 / (1.0 + exp(CASE WHEN (CASE WHEN (-100.0 <= -(-((-[kernel_dp_CLASS_1_CLASS_2].dot_product) * -2.467237989194626 + -0.06402060429027978))) THEN -(-((-[kernel_dp_CLASS_1_CLASS_2].dot_product) * -2.467237989194626 + -0.06402060429027978)) ELSE -100.0 END <= 100.0) THEN CASE WHEN (-100.0 <= -(-((-[kernel_dp_CLASS_1_CLASS_2].dot_product) * -2.467237989194626 + -0.06402060429027978))) THEN -(-((-[kernel_dp_CLASS_1_CLASS_2].dot_product) * -2.467237989194626 + -0.06402060429027978)) ELSE -100.0 END ELSE 100.0 END))) AS [OVO_Confidence] 
FROM [kernel_dp_CLASS_1_CLASS_2])
 INSERT INTO ##TMP_20180516132908_CODEGEN_0JQGFC_KernAgg_B2 ([KEY], [OVO_Class1], [OVO_Class2], [OVO_Decision], [OVO_Confidence]) SELECT [KernAgg_B2].[KEY], [KernAgg_B2].[OVO_Class1], [KernAgg_B2].[OVO_Class2], [KernAgg_B2].[OVO_Decision], [KernAgg_B2].[OVO_Confidence] 
...
-- Code For temporary table ##TMP_20180516132908_CODEGEN_ALJT0A_KernAgg part 1. Create 


CREATE TABLE ##TMP_20180516132908_CODEGEN_ALJT0A_KernAgg (
	[KEY] BIGINT NULL, 
...
-- Code For temporary table ##TMP_20180516132908_CODEGEN_ALJT0A_KernAgg part 2. Populate
...
FROM ##TMP_20180516132908_CODEGEN_0RFEQZ_KernAgg_B0 AS [KernAgg_B0] UNION ALL SELECT [KernAgg_B1].[KEY] AS [KEY], [KernAgg_B1].[OVO_Class1] AS [OVO_Class1], [KernAgg_B1].[OVO_Class2] AS [OVO_Class2], [KernAgg_B1].[OVO_Decision] AS [OVO_Decision], [KernAgg_B1].[OVO_Confidence] AS [OVO_Confidence] 
FROM ##TMP_20180516132908_CODEGEN_9LU60X_KernAgg_B1 AS [KernAgg_B1] UNION ALL SELECT [KernAgg_B2].[KEY] AS [KEY], [KernAgg_B2].[OVO_Class1] AS [OVO_Class1], [KernAgg_B2].[OVO_Class2] AS [OVO_Class2], [KernAgg_B2].[OVO_Decision] AS [OVO_Decision], [KernAgg_B2].[OVO_Confidence] AS [OVO_Confidence] 
FROM ##TMP_20180516132908_CODEGEN_0JQGFC_KernAgg_B2 AS [KernAgg_B2]) AS [KernAgg_EnsembleUnion]), 
[OVO_Votes] AS 
...
FROM ##TMP_20180516132908_CODEGEN_ALJT0A_KernAgg AS [KernAgg]), 
