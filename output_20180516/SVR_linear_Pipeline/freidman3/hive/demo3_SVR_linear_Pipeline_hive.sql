...
-- Code For temporary table tmp_20180516122043_codegen_qw841n_ads_imp_1_out part 1. Create 

CREATE TEMPORARY TABLE `tmp_20180516122043_codegen_qw841n_ads_imp_1_out` STORED AS ORC AS SELECT `ADS_imp_1_OUT`.`KEY`, `ADS_imp_1_OUT`.`imputer_output_2`, `ADS_imp_1_OUT`.`imputer_output_3`, `ADS_imp_1_OUT`.`imputer_output_4`, `ADS_imp_1_OUT`.`imputer_output_5` 
...
-- Code For temporary table tmp_20180516122043_codegen_qw841n_ads_imp_1_out part 2. Populate

SELECT * FROM `tmp_20180516122043_codegen_qw841n_ads_imp_1_out`

-- Code For temporary table tmp_20180516122043_codegen_2b9e8s_ads_sca_2_out part 1. Create 

CREATE TEMPORARY TABLE `tmp_20180516122043_codegen_2b9e8s_ads_sca_2_out` STORED AS ORC AS SELECT `ADS_sca_2_OUT`.`KEY`, `ADS_sca_2_OUT`.`scaler_output_2`, `ADS_sca_2_OUT`.`scaler_output_3`, `ADS_sca_2_OUT`.`scaler_output_4`, `ADS_sca_2_OUT`.`scaler_output_5` 
...
FROM `tmp_20180516122043_codegen_qw841n_ads_imp_1_out` AS `ADS_imp_1_OUT`) AS `ADS_sca_2_OUT`

-- Code For temporary table tmp_20180516122043_codegen_2b9e8s_ads_sca_2_out part 2. Populate

SELECT * FROM `tmp_20180516122043_codegen_2b9e8s_ads_sca_2_out`
...
FROM `tmp_20180516122043_codegen_2b9e8s_ads_sca_2_out` AS `ADS_sca_2_OUT`), 
`SV_data` AS 
