...
-- Code For temporary table tmp_20180516111841_codegen_rw5e4t_ads_imp_1_out part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180516111841_codegen_rw5e4t_ads_imp_1_out  (
	"KEY" BIGINT, 
...
-- Code For temporary table tmp_20180516111841_codegen_rw5e4t_ads_imp_1_out part 2. Populate

INSERT INTO tmp_20180516111841_codegen_rw5e4t_ads_imp_1_out ("KEY", impter_2, impter_3, impter_4, impter_5, impter_6, impter_7, impter_8, impter_9, impter_10, impter_11, impter_12, impter_13, impter_14, impter_15, impter_16, impter_17, impter_18, impter_19, impter_20, impter_21, impter_22, impter_23, impter_24, impter_25, impter_26, impter_27, impter_28, impter_29, impter_30, impter_31) SELECT "U"."KEY", "U".impter_2, "U".impter_3, "U".impter_4, "U".impter_5, "U".impter_6, "U".impter_7, "U".impter_8, "U".impter_9, "U".impter_10, "U".impter_11, "U".impter_12, "U".impter_13, "U".impter_14, "U".impter_15, "U".impter_16, "U".impter_17, "U".impter_18, "U".impter_19, "U".impter_20, "U".impter_21, "U".impter_22, "U".impter_23, "U".impter_24, "U".impter_25, "U".impter_26, "U".impter_27, "U".impter_28, "U".impter_29, "U".impter_30, "U".impter_31 
...
-- Code For temporary table tmp_20180516111842_codegen_siwggg_ads_sca_2_out part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180516111842_codegen_siwggg_ads_sca_2_out  (
	"KEY" BIGINT, 
...
FROM tmp_20180516111841_codegen_rw5e4t_ads_imp_1_out AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT") AS "U"
...
FROM tmp_20180516111842_codegen_siwggg_ads_sca_2_out AS "ADS_sca_2_OUT"), 
linear_model_cte AS 
(SELECT linear_input."KEY" AS "KEY", CAST(-0.180223887127939 AS DOUBLE PRECISION) * linear_input.scaler_2 + CAST(-0.015925862855607 AS DOUBLE PRECISION) * linear_input.scaler_3 + CAST(-0.109803039656955 AS DOUBLE PRECISION) * linear_input.scaler_4 + CAST(0.239624364569416 AS DOUBLE PRECISION) * linear_input.scaler_5 + CAST(0.060096767972787 AS DOUBLE PRECISION) * linear_input.scaler_6 + CAST(0.315330256166869 AS DOUBLE PRECISION) * linear_input.scaler_7 + CAST(-0.122906262655359 AS DOUBLE PRECISION) * linear_input.scaler_8 + CAST(-0.301729463039258 AS DOUBLE PRECISION) * linear_input.scaler_9 + CAST(-0.000376309767502 AS DOUBLE PRECISION) * linear_input.scaler_10 + CAST(-0.009533035008003 AS DOUBLE PRECISION) * linear_input.scaler_11 + CAST(-0.444492040751962 AS DOUBLE PRECISION) * linear_input.scaler_12 + CAST(0.02549617211024 AS DOUBLE PRECISION) * linear_input.scaler_13 + CAST(0.043533243841704 AS DOUBLE PRECISION) * linear_input.scaler_14 + CAST(0.275310282513324 AS DOUBLE PRECISION) * linear_input.scaler_15 + CAST(-0.076561646650147 AS DOUBLE PRECISION) * linear_input.scaler_16 + CAST(0.053464139497877 AS DOUBLE PRECISION) * linear_input.scaler_17 + CAST(0.202456974440715 AS DOUBLE PRECISION) * linear_input.scaler_18 + CAST(-0.090436816170214 AS DOUBLE PRECISION) * linear_input.scaler_19 + CAST(-0.015032628365407 AS DOUBLE PRECISION) * linear_input.scaler_20 + CAST(0.01276885327629 AS DOUBLE PRECISION) * linear_input.scaler_21 + CAST(-0.678174248128468 AS DOUBLE PRECISION) * linear_input.scaler_22 + CAST(-0.094857145408031 AS DOUBLE PRECISION) * linear_input.scaler_23 + CAST(0.097383622230701 AS DOUBLE PRECISION) * linear_input.scaler_24 + CAST(0.351663479285275 AS DOUBLE PRECISION) * linear_input.scaler_25 + CAST(-0.05399196081726 AS DOUBLE PRECISION) * linear_input.scaler_26 + CAST(-0.03775909348742 AS DOUBLE PRECISION) * linear_input.scaler_27 + CAST(-0.164045603183931 AS DOUBLE PRECISION) * linear_input.scaler_28 + CAST(-0.090577355401964 AS DOUBLE PRECISION) * linear_input.scaler_29 + CAST(-0.094869924243738 AS DOUBLE PRECISION) * linear_input.scaler_30 + CAST(-0.122632414121873 AS DOUBLE PRECISION) * linear_input.scaler_31 + CAST(0.296703296703297 AS DOUBLE PRECISION) AS lincomb 
FROM linear_input), 
