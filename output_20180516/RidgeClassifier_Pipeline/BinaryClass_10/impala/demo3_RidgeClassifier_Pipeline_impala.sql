...
-- Code For temporary table tmp_20180508192003_codegen_c3ev9l_ads_imp_1_out part 1. Create 


CREATE TABLE tmp_20180508192003_codegen_c3ev9l_ads_imp_1_out (
	`KEY` BIGINT, 
	impter_2 DOUBLE, 
	impter_3 DOUBLE, 
	impter_4 DOUBLE, 
...
-- Code For temporary table tmp_20180508192003_codegen_c3ev9l_ads_imp_1_out part 2. Populate

INSERT INTO tmp_20180508192003_codegen_c3ev9l_ads_imp_1_out (`KEY`, impter_2, impter_3, impter_4, impter_5, impter_6, impter_7, impter_8, impter_9, impter_10, impter_11) SELECT `ADS_imp_1_OUT`.`KEY`, `ADS_imp_1_OUT`.impter_2, `ADS_imp_1_OUT`.impter_3, `ADS_imp_1_OUT`.impter_4, `ADS_imp_1_OUT`.impter_5, `ADS_imp_1_OUT`.impter_6, `ADS_imp_1_OUT`.impter_7, `ADS_imp_1_OUT`.impter_8, `ADS_imp_1_OUT`.impter_9, `ADS_imp_1_OUT`.impter_10, `ADS_imp_1_OUT`.impter_11 
...
-- Code For temporary table tmp_20180508192003_codegen_lkmhym_ads_sca_2_out part 1. Create 


CREATE TABLE tmp_20180508192003_codegen_lkmhym_ads_sca_2_out (
	`KEY` BIGINT, 
	scaler_2 DOUBLE, 
	scaler_3 DOUBLE, 
	scaler_4 DOUBLE, 
...
-- Code For temporary table tmp_20180508192003_codegen_lkmhym_ads_sca_2_out part 2. Populate

INSERT INTO tmp_20180508192003_codegen_lkmhym_ads_sca_2_out (`KEY`, scaler_2, scaler_3, scaler_4, scaler_5, scaler_6, scaler_7, scaler_8, scaler_9, scaler_10, scaler_11) SELECT `ADS_sca_2_OUT`.`KEY`, `ADS_sca_2_OUT`.scaler_2, `ADS_sca_2_OUT`.scaler_3, `ADS_sca_2_OUT`.scaler_4, `ADS_sca_2_OUT`.scaler_5, `ADS_sca_2_OUT`.scaler_6, `ADS_sca_2_OUT`.scaler_7, `ADS_sca_2_OUT`.scaler_8, `ADS_sca_2_OUT`.scaler_9, `ADS_sca_2_OUT`.scaler_10, `ADS_sca_2_OUT`.scaler_11 
...
FROM tmp_20180508192003_codegen_c3ev9l_ads_imp_1_out AS `ADS_imp_1_OUT`) AS `ADS_sca_2_OUT`
...
FROM tmp_20180508192003_codegen_lkmhym_ads_sca_2_out AS `ADS_sca_2_OUT`), 
linear_model_cte AS 
