...
-- Code For temporary table tmp_20180508190227_codegen_1yr6np_ads_imp_1_out part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180508190227_codegen_1yr6np_ads_imp_1_out  (
	"KEY" BIGINT, 
...
-- Code For temporary table tmp_20180508190227_codegen_1yr6np_ads_imp_1_out part 2. Populate

INSERT INTO tmp_20180508190227_codegen_1yr6np_ads_imp_1_out ("KEY", imputer_output_2, imputer_output_3, imputer_output_4, imputer_output_5) SELECT "U"."KEY", "U".imputer_output_2, "U".imputer_output_3, "U".imputer_output_4, "U".imputer_output_5 
...
-- Code For temporary table tmp_20180508190227_codegen_u1ohr6_ads_sca_2_out part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180508190227_codegen_u1ohr6_ads_sca_2_out  (
	"KEY" BIGINT, 
...
-- Code For temporary table tmp_20180508190227_codegen_u1ohr6_ads_sca_2_out part 2. Populate

INSERT INTO tmp_20180508190227_codegen_u1ohr6_ads_sca_2_out ("KEY", scaler_output_2, scaler_output_3, scaler_output_4, scaler_output_5) SELECT "U"."KEY", "U".scaler_output_2, "U".scaler_output_3, "U".scaler_output_4, "U".scaler_output_5 
...
FROM tmp_20180508190227_codegen_1yr6np_ads_imp_1_out AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT") AS "U"
...
FROM tmp_20180508190227_codegen_u1ohr6_ads_sca_2_out AS "ADS_sca_2_OUT"), 
linear_model_cte AS 
(SELECT linear_input."KEY" AS "KEY", CAST(0.049025265861861 AS DOUBLE PRECISION) * linear_input.scaler_output_2 + CAST(0.232582266572878 AS DOUBLE PRECISION) * linear_input.scaler_output_3 + CAST(-0.661792036546098 AS DOUBLE PRECISION) * linear_input.scaler_output_4 + CAST(-0.139574406777555 AS DOUBLE PRECISION) * linear_input.scaler_output_5 + CAST(-0.383333333333334 AS DOUBLE PRECISION) AS "Score_1789-07-14T00:00:00.000000000", CAST(0.088630670738594 AS DOUBLE PRECISION) * linear_input.scaler_output_2 + CAST(-0.411550387069844 AS DOUBLE PRECISION) * linear_input.scaler_output_3 + CAST(0.466081272857524 AS DOUBLE PRECISION) * linear_input.scaler_output_4 + CAST(-0.576381522875229 AS DOUBLE PRECISION) * linear_input.scaler_output_5 + CAST(-0.333333333333333 AS DOUBLE PRECISION) AS "Score_1789-08-14T00:00:00.000000000", CAST(-0.137655936600453 AS DOUBLE PRECISION) * linear_input.scaler_output_2 + CAST(0.178968120496965 AS DOUBLE PRECISION) * linear_input.scaler_output_3 + CAST(0.195710763688574 AS DOUBLE PRECISION) * linear_input.scaler_output_4 + CAST(0.715955929652782 AS DOUBLE PRECISION) * linear_input.scaler_output_5 + CAST(-0.283333333333333 AS DOUBLE PRECISION) AS "Score_1789-09-14T00:00:00.000000000" 
FROM linear_input), 
