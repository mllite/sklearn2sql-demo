...
-- Code For temporary table tmp_20180516131341_codegen_eq3pln_ads_imp_1_out part 1. Create 

CREATE TEMPORARY TABLE `tmp_20180516131341_codegen_eq3pln_ads_imp_1_out` STORED AS ORC AS SELECT `ADS_imp_1_OUT`.`KEY`, `ADS_imp_1_OUT`.`imputer_output_2`, `ADS_imp_1_OUT`.`imputer_output_3`, `ADS_imp_1_OUT`.`imputer_output_4`, `ADS_imp_1_OUT`.`imputer_output_5` 
...
-- Code For temporary table tmp_20180516131341_codegen_eq3pln_ads_imp_1_out part 2. Populate

SELECT * FROM `tmp_20180516131341_codegen_eq3pln_ads_imp_1_out`

-- Code For temporary table tmp_20180516131341_codegen_on0hcm_ads_sca_2_out part 1. Create 

CREATE TEMPORARY TABLE `tmp_20180516131341_codegen_on0hcm_ads_sca_2_out` STORED AS ORC AS SELECT `ADS_sca_2_OUT`.`KEY`, `ADS_sca_2_OUT`.`scaler_output_2`, `ADS_sca_2_OUT`.`scaler_output_3`, `ADS_sca_2_OUT`.`scaler_output_4`, `ADS_sca_2_OUT`.`scaler_output_5` 
...
FROM `tmp_20180516131341_codegen_eq3pln_ads_imp_1_out` AS `ADS_imp_1_OUT`) AS `ADS_sca_2_OUT`

-- Code For temporary table tmp_20180516131341_codegen_on0hcm_ads_sca_2_out part 2. Populate

SELECT * FROM `tmp_20180516131341_codegen_on0hcm_ads_sca_2_out`
...
FROM `tmp_20180516131341_codegen_on0hcm_ads_sca_2_out` AS `ADS_sca_2_OUT`), 
`linear_model_cte` AS 
