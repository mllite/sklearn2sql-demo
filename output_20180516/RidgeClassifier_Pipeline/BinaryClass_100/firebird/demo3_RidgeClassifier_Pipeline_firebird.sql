...
-- Code For temporary table TMP_20180508180429_CODEGEN_OMAB part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508180429_CODEGEN_OMAB" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20180508180429_CODEGEN_OMAB part 3. Create Index 

CREATE INDEX "ix_TMP_20180508180429_C_b0d5" ON "TMP_20180508180429_CODEGEN_OMAB" ("KEY")

-- Code For temporary table TMP_20180508180429_CODEGEN_OXY6 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508180429_CODEGEN_OXY6" (
	"KEY" BIGINT NOT NULL, 
...
FROM "TMP_20180508180429_CODEGEN_OMAB" AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT") AS "U"

-- Code For temporary table TMP_20180508180429_CODEGEN_OXY6 part 3. Create Index 

CREATE INDEX "ix_TMP_20180508180429_C_1277" ON "TMP_20180508180429_CODEGEN_OXY6" ("KEY")
...
FROM "TMP_20180508180429_CODEGEN_OXY6" AS "ADS_sca_2_OUT"), 
linear_model_cte AS 
