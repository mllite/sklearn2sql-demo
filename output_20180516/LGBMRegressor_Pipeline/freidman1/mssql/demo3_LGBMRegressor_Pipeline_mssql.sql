...
-- Code For temporary table ##TMP_20180508184456_CODEGEN_A6E4KX_ADS_imp_1_OUT part 1. Create 


CREATE TABLE ##TMP_20180508184456_CODEGEN_A6E4KX_ADS_imp_1_OUT (
	[KEY] BIGINT NULL, 
...
-- Code For temporary table ##TMP_20180508184456_CODEGEN_A6E4KX_ADS_imp_1_OUT part 2. Populate

INSERT INTO ##TMP_20180508184456_CODEGEN_A6E4KX_ADS_imp_1_OUT ([KEY], impter_2, impter_3, impter_4, impter_5, impter_6, impter_7, impter_8, impter_9, impter_10, impter_11) SELECT [ADS_imp_1_OUT].[KEY], [ADS_imp_1_OUT].impter_2, [ADS_imp_1_OUT].impter_3, [ADS_imp_1_OUT].impter_4, [ADS_imp_1_OUT].impter_5, [ADS_imp_1_OUT].impter_6, [ADS_imp_1_OUT].impter_7, [ADS_imp_1_OUT].impter_8, [ADS_imp_1_OUT].impter_9, [ADS_imp_1_OUT].impter_10, [ADS_imp_1_OUT].impter_11 
...
-- Code For temporary table ##TMP_20180508184456_CODEGEN_VKYR5X_ADS_sca_2_OUT part 1. Create 


CREATE TABLE ##TMP_20180508184456_CODEGEN_VKYR5X_ADS_sca_2_OUT (
	[KEY] BIGINT NULL, 
	scaler_2 FLOAT NULL, 
	scaler_3 FLOAT NULL, 
	scaler_4 FLOAT NULL, 
...
FROM ##TMP_20180508184456_CODEGEN_A6E4KX_ADS_imp_1_OUT AS [ADS_imp_1_OUT]) AS [ADS_sca_2_OUT]

-- Code For temporary table ##TMP_20180508184456_CODEGEN_2KO22M_LGBM_B0 part 1. Create 


CREATE TABLE ##TMP_20180508184456_CODEGEN_2KO22M_LGBM_B0 (
	[KEY] BIGINT NULL, 
...
-- Code For temporary table ##TMP_20180508184456_CODEGEN_2KO22M_LGBM_B0 part 2. Populate
...
FROM ##TMP_20180508184456_CODEGEN_VKYR5X_ADS_sca_2_OUT AS [ADS_sca_2_OUT]), 
[DT_node_data] AS 
...
FROM [DT_Output_9])
 INSERT INTO ##TMP_20180508184456_CODEGEN_2KO22M_LGBM_B0 ([KEY], [Estimator]) SELECT [LGBM_B0].[KEY], [LGBM_B0].[Estimator] 
...
-- Code For temporary table ##TMP_20180508184456_CODEGEN_JLX2NP_LGBM_B1 part 1. Create 


CREATE TABLE ##TMP_20180508184456_CODEGEN_JLX2NP_LGBM_B1 (
	[KEY] BIGINT NULL, 
	[Estimator] FLOAT(53) NULL
)
...
-- Code For temporary table ##TMP_20180508184456_CODEGEN_JLX2NP_LGBM_B1 part 2. Populate
...
FROM [DT_Output_15])
 INSERT INTO ##TMP_20180508184456_CODEGEN_JLX2NP_LGBM_B1 ([KEY], [Estimator]) SELECT [LGBM_B1].[KEY], [LGBM_B1].[Estimator] 
...
-- Code For temporary table ##TMP_20180508184456_CODEGEN_QVXFKK_LGBM_Union part 1. Create 


CREATE TABLE ##TMP_20180508184456_CODEGEN_QVXFKK_LGBM_Union (
	[KEY] BIGINT NULL, 
	[Estimator] FLOAT(53) NULL
)
...
-- Code For temporary table ##TMP_20180508184456_CODEGEN_QVXFKK_LGBM_Union part 2. Populate

INSERT INTO ##TMP_20180508184456_CODEGEN_QVXFKK_LGBM_Union ([KEY], [Estimator]) SELECT [LGBM_Union].[KEY], [LGBM_Union].[Estimator] 
...
FROM ##TMP_20180508184456_CODEGEN_2KO22M_LGBM_B0 AS [LGBM_B0] UNION ALL SELECT [LGBM_B1].[KEY] AS [KEY], [LGBM_B1].[Estimator] AS [Estimator] 
FROM ##TMP_20180508184456_CODEGEN_JLX2NP_LGBM_B1 AS [LGBM_B1]) AS [LGBM_EnsembleUnion]) AS [LGBM_Union]

-- Code For temporary table ##TMP_20180508184456_CODEGEN_VYS18S_LGBM_sum part 1. Create 


CREATE TABLE ##TMP_20180508184456_CODEGEN_VYS18S_LGBM_sum (
	[KEY] BIGINT NULL, 
	[Estimator] FLOAT(53) NULL
)
...
-- Code For temporary table ##TMP_20180508184456_CODEGEN_VYS18S_LGBM_sum part 2. Populate

INSERT INTO ##TMP_20180508184456_CODEGEN_VYS18S_LGBM_sum ([KEY], [Estimator]) SELECT [LGBM_sum].[KEY], [LGBM_sum].[Estimator] 
...
FROM ##TMP_20180508184456_CODEGEN_QVXFKK_LGBM_Union AS [LGBM_Union] GROUP BY [LGBM_Union].[KEY]) AS [T]) AS [LGBM_sum]

-- Model deployment code

SELECT [LGBM_sum].[KEY] AS [KEY], [LGBM_sum].[Estimator] AS [Estimator] 
FROM ##TMP_20180508184456_CODEGEN_VYS18S_LGBM_sum AS [LGBM_sum]