...
-- Code For temporary table tmp_20180508194528_codegen_dpz710_ads_imp_1_out part 1. Create 


CREATE TABLE tmp_20180508194528_codegen_dpz710_ads_imp_1_out (
	`KEY` BIGINT, 
	impter_2 DOUBLE, 
	impter_3 DOUBLE, 
	impter_4 DOUBLE, 
...
-- Code For temporary table tmp_20180508194528_codegen_dpz710_ads_imp_1_out part 2. Populate

INSERT INTO tmp_20180508194528_codegen_dpz710_ads_imp_1_out (`KEY`, impter_2, impter_3, impter_4, impter_5, impter_6, impter_7, impter_8, impter_9, impter_10, impter_11) SELECT `ADS_imp_1_OUT`.`KEY`, `ADS_imp_1_OUT`.impter_2, `ADS_imp_1_OUT`.impter_3, `ADS_imp_1_OUT`.impter_4, `ADS_imp_1_OUT`.impter_5, `ADS_imp_1_OUT`.impter_6, `ADS_imp_1_OUT`.impter_7, `ADS_imp_1_OUT`.impter_8, `ADS_imp_1_OUT`.impter_9, `ADS_imp_1_OUT`.impter_10, `ADS_imp_1_OUT`.impter_11 
...
-- Code For temporary table tmp_20180508194528_codegen_vvqpns_ads_sca_2_out part 1. Create 


CREATE TABLE tmp_20180508194528_codegen_vvqpns_ads_sca_2_out (
	`KEY` BIGINT, 
	scaler_2 DOUBLE, 
	scaler_3 DOUBLE, 
	scaler_4 DOUBLE, 
...
FROM tmp_20180508194528_codegen_dpz710_ads_imp_1_out AS `ADS_imp_1_OUT`) AS `ADS_sca_2_OUT`

-- Code For temporary table tmp_20180508194528_codegen_oerdwh_lgbm_b0 part 1. Create 


CREATE TABLE tmp_20180508194528_codegen_oerdwh_lgbm_b0 (
	`KEY` BIGINT, 
	`Estimator` DOUBLE
)
...
-- Code For temporary table tmp_20180508194528_codegen_oerdwh_lgbm_b0 part 2. Populate
...
FROM tmp_20180508194528_codegen_vvqpns_ads_sca_2_out AS `ADS_sca_2_OUT`), 
`DT_node_data` AS 
...
FROM `DT_Output_9`)
 INSERT INTO tmp_20180508194528_codegen_oerdwh_lgbm_b0 (`KEY`, `Estimator`) SELECT `LGBM_B0`.`KEY`, `LGBM_B0`.`Estimator` 
...
-- Code For temporary table tmp_20180508194528_codegen_cwdywe_lgbm_b1 part 1. Create 


CREATE TABLE tmp_20180508194528_codegen_cwdywe_lgbm_b1 (
	`KEY` BIGINT, 
	`Estimator` DOUBLE
)
...
-- Code For temporary table tmp_20180508194528_codegen_cwdywe_lgbm_b1 part 2. Populate
...
FROM `DT_Output_15`)
 INSERT INTO tmp_20180508194528_codegen_cwdywe_lgbm_b1 (`KEY`, `Estimator`) SELECT `LGBM_B1`.`KEY`, `LGBM_B1`.`Estimator` 
...
-- Code For temporary table tmp_20180508194528_codegen_p797n0_lgbm_union part 1. Create 


CREATE TABLE tmp_20180508194528_codegen_p797n0_lgbm_union (
	`KEY` BIGINT, 
	`Estimator` DOUBLE
)
...
-- Code For temporary table tmp_20180508194528_codegen_p797n0_lgbm_union part 2. Populate

INSERT INTO tmp_20180508194528_codegen_p797n0_lgbm_union (`KEY`, `Estimator`) SELECT `LGBM_Union`.`KEY`, `LGBM_Union`.`Estimator` 
...
FROM tmp_20180508194528_codegen_oerdwh_lgbm_b0 AS `LGBM_B0` UNION ALL SELECT `LGBM_B1`.`KEY` AS `KEY`, `LGBM_B1`.`Estimator` AS `Estimator` 
FROM tmp_20180508194528_codegen_cwdywe_lgbm_b1 AS `LGBM_B1`) AS `LGBM_EnsembleUnion`) AS `LGBM_Union`

-- Code For temporary table tmp_20180508194528_codegen_yoogrg_lgbm_sum part 1. Create 


CREATE TABLE tmp_20180508194528_codegen_yoogrg_lgbm_sum (
	`KEY` BIGINT, 
	`Estimator` DOUBLE
)
...
-- Code For temporary table tmp_20180508194528_codegen_yoogrg_lgbm_sum part 2. Populate

INSERT INTO tmp_20180508194528_codegen_yoogrg_lgbm_sum (`KEY`, `Estimator`) SELECT `LGBM_sum`.`KEY`, `LGBM_sum`.`Estimator` 
...
FROM tmp_20180508194528_codegen_p797n0_lgbm_union AS `LGBM_Union` GROUP BY `LGBM_Union`.`KEY`) AS `T`) AS `LGBM_sum`

-- Model deployment code

SELECT `LGBM_sum`.`KEY` AS `KEY`, `LGBM_sum`.`Estimator` AS `Estimator` 
FROM tmp_20180508194528_codegen_yoogrg_lgbm_sum AS `LGBM_sum`