...
-- Code For temporary table tmp_20180602151257_se0_ads_imp_1_out part 1. Create 

CREATE TEMPORARY TABLE `tmp_20180602151257_se0_ads_imp_1_out` STORED AS ORC AS SELECT `ADS_imp_1_OUT`.`KEY`, `ADS_imp_1_OUT`.`impter_2`, `ADS_imp_1_OUT`.`impter_3`, `ADS_imp_1_OUT`.`impter_4`, `ADS_imp_1_OUT`.`impter_5`, `ADS_imp_1_OUT`.`impter_6`, `ADS_imp_1_OUT`.`impter_7`, `ADS_imp_1_OUT`.`impter_8`, `ADS_imp_1_OUT`.`impter_9`, `ADS_imp_1_OUT`.`impter_10`, `ADS_imp_1_OUT`.`impter_11` 
...
-- Code For temporary table tmp_20180602151257_se0_ads_imp_1_out part 2. Populate

SELECT * FROM `tmp_20180602151257_se0_ads_imp_1_out`

-- Code For temporary table tmp_20180602151257_e7h_ads_sca_2_out part 1. Create 

CREATE TEMPORARY TABLE `tmp_20180602151257_e7h_ads_sca_2_out` STORED AS ORC AS SELECT `ADS_sca_2_OUT`.`KEY`, `ADS_sca_2_OUT`.`scaler_2`, `ADS_sca_2_OUT`.`scaler_3`, `ADS_sca_2_OUT`.`scaler_4`, `ADS_sca_2_OUT`.`scaler_5`, `ADS_sca_2_OUT`.`scaler_6`, `ADS_sca_2_OUT`.`scaler_7`, `ADS_sca_2_OUT`.`scaler_8`, `ADS_sca_2_OUT`.`scaler_9`, `ADS_sca_2_OUT`.`scaler_10`, `ADS_sca_2_OUT`.`scaler_11` 
...
FROM `tmp_20180602151257_se0_ads_imp_1_out` AS `ADS_imp_1_OUT`) AS `ADS_sca_2_OUT`

-- Code For temporary table tmp_20180602151257_e7h_ads_sca_2_out part 2. Populate

SELECT * FROM `tmp_20180602151257_e7h_ads_sca_2_out`

-- Code For temporary table tmp_20180602151257_kiq_lgbm_b0 part 1. Create 

CREATE TEMPORARY TABLE `tmp_20180602151257_kiq_lgbm_b0` STORED AS ORC AS WITH `DT_node_lookup` AS 
...
FROM `tmp_20180602151257_e7h_ads_sca_2_out` AS `ADS_sca_2_OUT`), 
`DT_node_data` AS 
...
-- Code For temporary table tmp_20180602151257_kiq_lgbm_b0 part 2. Populate

SELECT * FROM `tmp_20180602151257_kiq_lgbm_b0`

-- Code For temporary table tmp_20180602151257_33i_lgbm_b1 part 1. Create 

CREATE TEMPORARY TABLE `tmp_20180602151257_33i_lgbm_b1` STORED AS ORC AS WITH `DT_node_lookup_10` AS 
(SELECT `ADS_sca_2_OUT`.`KEY` AS `KEY`, CASE WHEN (`ADS_sca_2_OUT`.`scaler_5` <= -0.1199268106081446) THEN 2 ELSE CASE WHEN (`ADS_sca_2_OUT`.`scaler_3` <= -0.03575253068147678) THEN 6 ELSE 7 END END AS `node_id_2` 
FROM `tmp_20180602151257_e7h_ads_sca_2_out` AS `ADS_sca_2_OUT`), 
`DT_node_data_10` AS 
(SELECT `Values`.`nid` AS `nid`, CAST(`Values`.`Estimator` AS DOUBLE) AS `Estimator` 
...
-- Code For temporary table tmp_20180602151257_33i_lgbm_b1 part 2. Populate

SELECT * FROM `tmp_20180602151257_33i_lgbm_b1`

-- Code For temporary table tmp_20180602151257_8i0_lgbm_sum part 1. Create 

CREATE TEMPORARY TABLE `tmp_20180602151257_8i0_lgbm_sum` STORED AS ORC AS WITH `LGBM_Union` AS 
...
FROM `tmp_20180602151257_kiq_lgbm_b0` AS `LGBM_B0` UNION ALL SELECT `LGBM_B1`.`KEY` AS `KEY`, `LGBM_B1`.`Estimator` AS `Estimator` 
FROM `tmp_20180602151257_33i_lgbm_b1` AS `LGBM_B1`) AS `LGBM_EnsembleUnion`)
...
-- Code For temporary table tmp_20180602151257_8i0_lgbm_sum part 2. Populate

SELECT * FROM `tmp_20180602151257_8i0_lgbm_sum`

-- Model deployment code

SELECT `LGBM_sum`.`KEY` AS `KEY`, `LGBM_sum`.`Estimator` AS `Estimator` 
FROM `tmp_20180602151257_8i0_lgbm_sum` AS `LGBM_sum`