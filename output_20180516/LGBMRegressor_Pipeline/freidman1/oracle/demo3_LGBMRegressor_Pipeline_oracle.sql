...
-- Code For temporary table DEGEN_5PRCEQ_ADS_IMP_1_OUT part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "DEGEN_5PRCEQ_ADS_IMP_1_OUT" (
	"KEY" NUMBER(19), 
...
-- Code For temporary table DEGEN_5PRCEQ_ADS_IMP_1_OUT part 2. Populate

INSERT INTO "DEGEN_5PRCEQ_ADS_IMP_1_OUT" ("KEY", impter_2, impter_3, impter_4, impter_5, impter_6, impter_7, impter_8, impter_9, impter_10, impter_11) SELECT "U"."KEY", "U".impter_2, "U".impter_3, "U".impter_4, "U".impter_5, "U".impter_6, "U".impter_7, "U".impter_8, "U".impter_9, "U".impter_10, "U".impter_11 
...
-- Code For temporary table DEGEN_T9TRNE_ADS_SCA_2_OUT part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "DEGEN_T9TRNE_ADS_SCA_2_OUT" (
	"KEY" NUMBER(19), 
...
-- Code For temporary table DEGEN_T9TRNE_ADS_SCA_2_OUT part 2. Populate

INSERT INTO "DEGEN_T9TRNE_ADS_SCA_2_OUT" ("KEY", scaler_2, scaler_3, scaler_4, scaler_5, scaler_6, scaler_7, scaler_8, scaler_9, scaler_10, scaler_11) SELECT "U"."KEY", "U".scaler_2, "U".scaler_3, "U".scaler_4, "U".scaler_5, "U".scaler_6, "U".scaler_7, "U".scaler_8, "U".scaler_9, "U".scaler_10, "U".scaler_11 
...
FROM "DEGEN_5PRCEQ_ADS_IMP_1_OUT" "ADS_imp_1_OUT") "ADS_sca_2_OUT") "U"

-- Code For temporary table 456_CODEGEN_DB6Q76_LGBM_B0 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "456_CODEGEN_DB6Q76_LGBM_B0" (
	"KEY" NUMBER(19), 
...
-- Code For temporary table 456_CODEGEN_DB6Q76_LGBM_B0 part 2. Populate

INSERT INTO "456_CODEGEN_DB6Q76_LGBM_B0" ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
FROM "DEGEN_T9TRNE_ADS_SCA_2_OUT" "ADS_sca_2_OUT"), 
"DT_node_data" AS 
...
-- Code For temporary table 456_CODEGEN_9X11M3_LGBM_B1 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "456_CODEGEN_9X11M3_LGBM_B1" (
	"KEY" NUMBER(19), 
	"Estimator" BINARY_DOUBLE
)
...
-- Code For temporary table 456_CODEGEN_9X11M3_LGBM_B1 part 2. Populate

INSERT INTO "456_CODEGEN_9X11M3_LGBM_B1" ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
-- Code For temporary table _CODEGEN_TJS33E_LGBM_UNION part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "_CODEGEN_TJS33E_LGBM_UNION" (
	"KEY" NUMBER(19), 
	"Estimator" BINARY_DOUBLE
)
...
-- Code For temporary table _CODEGEN_TJS33E_LGBM_UNION part 2. Populate

INSERT INTO "_CODEGEN_TJS33E_LGBM_UNION" ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
FROM "456_CODEGEN_DB6Q76_LGBM_B0" "LGBM_B0" UNION ALL SELECT "LGBM_B1"."KEY" AS "KEY", "LGBM_B1"."Estimator" AS "Estimator" 
FROM "456_CODEGEN_9X11M3_LGBM_B1" "LGBM_B1") "LGBM_EnsembleUnion") "LGBM_Union") "U"

-- Code For temporary table 56_CODEGEN_7XJ8YC_LGBM_SUM part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "56_CODEGEN_7XJ8YC_LGBM_SUM" (
	"KEY" NUMBER(19), 
	"Estimator" BINARY_DOUBLE
)
...
-- Code For temporary table 56_CODEGEN_7XJ8YC_LGBM_SUM part 2. Populate

INSERT INTO "56_CODEGEN_7XJ8YC_LGBM_SUM" ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
FROM "_CODEGEN_TJS33E_LGBM_UNION" "LGBM_Union" GROUP BY "LGBM_Union"."KEY") "T") "LGBM_sum") "U"

-- Model deployment code

SELECT "LGBM_sum"."KEY" AS "KEY", "LGBM_sum"."Estimator" AS "Estimator" 
FROM "56_CODEGEN_7XJ8YC_LGBM_SUM" "LGBM_sum"