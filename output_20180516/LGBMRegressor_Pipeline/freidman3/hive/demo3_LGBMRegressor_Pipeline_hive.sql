...
-- Code For temporary table tmp_20180602152248_dei_ads_imp_1_out part 1. Create 

CREATE TEMPORARY TABLE `tmp_20180602152248_dei_ads_imp_1_out` STORED AS ORC AS SELECT `ADS_imp_1_OUT`.`KEY`, `ADS_imp_1_OUT`.`imputer_output_2`, `ADS_imp_1_OUT`.`imputer_output_3`, `ADS_imp_1_OUT`.`imputer_output_4`, `ADS_imp_1_OUT`.`imputer_output_5` 
...
-- Code For temporary table tmp_20180602152248_dei_ads_imp_1_out part 2. Populate

SELECT * FROM `tmp_20180602152248_dei_ads_imp_1_out`

-- Code For temporary table tmp_20180602152248_ec9_ads_sca_2_out part 1. Create 

CREATE TEMPORARY TABLE `tmp_20180602152248_ec9_ads_sca_2_out` STORED AS ORC AS SELECT `ADS_sca_2_OUT`.`KEY`, `ADS_sca_2_OUT`.`scaler_output_2`, `ADS_sca_2_OUT`.`scaler_output_3`, `ADS_sca_2_OUT`.`scaler_output_4`, `ADS_sca_2_OUT`.`scaler_output_5` 
...
FROM `tmp_20180602152248_dei_ads_imp_1_out` AS `ADS_imp_1_OUT`) AS `ADS_sca_2_OUT`

-- Code For temporary table tmp_20180602152248_ec9_ads_sca_2_out part 2. Populate

SELECT * FROM `tmp_20180602152248_ec9_ads_sca_2_out`

-- Code For temporary table tmp_20180602152248_zqb_lgbm_b0 part 1. Create 

CREATE TEMPORARY TABLE `tmp_20180602152248_zqb_lgbm_b0` STORED AS ORC AS WITH `DT_node_lookup` AS 
...
FROM `tmp_20180602152248_ec9_ads_sca_2_out` AS `ADS_sca_2_OUT`), 
`DT_node_data` AS 
...
-- Code For temporary table tmp_20180602152248_zqb_lgbm_b0 part 2. Populate

SELECT * FROM `tmp_20180602152248_zqb_lgbm_b0`

-- Code For temporary table tmp_20180602152248_twi_lgbm_b1 part 1. Create 

CREATE TEMPORARY TABLE `tmp_20180602152248_twi_lgbm_b1` STORED AS ORC AS WITH `DT_node_lookup_10` AS 
(SELECT `ADS_sca_2_OUT`.`KEY` AS `KEY`, CASE WHEN (`ADS_sca_2_OUT`.`scaler_output_4` <= -0.778099550330666) THEN 2 ELSE CASE WHEN (`ADS_sca_2_OUT`.`scaler_output_2` <= 0.20899805514978842) THEN 6 ELSE 7 END END AS `node_id_2` 
FROM `tmp_20180602152248_ec9_ads_sca_2_out` AS `ADS_sca_2_OUT`), 
`DT_node_data_10` AS 
(SELECT `Values`.`nid` AS `nid`, CAST(`Values`.`Estimator` AS DOUBLE) AS `Estimator` 
...
-- Code For temporary table tmp_20180602152248_twi_lgbm_b1 part 2. Populate

SELECT * FROM `tmp_20180602152248_twi_lgbm_b1`

-- Code For temporary table tmp_20180602152248_0ay_lgbm_sum part 1. Create 

CREATE TEMPORARY TABLE `tmp_20180602152248_0ay_lgbm_sum` STORED AS ORC AS WITH `LGBM_Union` AS 
...
FROM `tmp_20180602152248_zqb_lgbm_b0` AS `LGBM_B0` UNION ALL SELECT `LGBM_B1`.`KEY` AS `KEY`, `LGBM_B1`.`Estimator` AS `Estimator` 
FROM `tmp_20180602152248_twi_lgbm_b1` AS `LGBM_B1`) AS `LGBM_EnsembleUnion`)
...
-- Code For temporary table tmp_20180602152248_0ay_lgbm_sum part 2. Populate

SELECT * FROM `tmp_20180602152248_0ay_lgbm_sum`

-- Model deployment code

SELECT `LGBM_sum`.`KEY` AS `KEY`, `LGBM_sum`.`Estimator` AS `Estimator` 
FROM `tmp_20180602152248_0ay_lgbm_sum` AS `LGBM_sum`