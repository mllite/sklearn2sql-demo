...
-- Code For temporary table ##TMP_20180508185216_CODEGEN_UQ1Z1E_ADS_imp_1_OUT part 1. Create 


CREATE TABLE ##TMP_20180508185216_CODEGEN_UQ1Z1E_ADS_imp_1_OUT (
	[KEY] BIGINT NULL, 
...
-- Code For temporary table ##TMP_20180508185216_CODEGEN_UQ1Z1E_ADS_imp_1_OUT part 2. Populate

INSERT INTO ##TMP_20180508185216_CODEGEN_UQ1Z1E_ADS_imp_1_OUT ([KEY], imputer_output_2, imputer_output_3, imputer_output_4, imputer_output_5) SELECT [ADS_imp_1_OUT].[KEY], [ADS_imp_1_OUT].imputer_output_2, [ADS_imp_1_OUT].imputer_output_3, [ADS_imp_1_OUT].imputer_output_4, [ADS_imp_1_OUT].imputer_output_5 
...
-- Code For temporary table ##TMP_20180508185216_CODEGEN_YLQYQN_ADS_sca_2_OUT part 1. Create 


CREATE TABLE ##TMP_20180508185216_CODEGEN_YLQYQN_ADS_sca_2_OUT (
	[KEY] BIGINT NULL, 
...
-- Code For temporary table ##TMP_20180508185216_CODEGEN_YLQYQN_ADS_sca_2_OUT part 2. Populate

INSERT INTO ##TMP_20180508185216_CODEGEN_YLQYQN_ADS_sca_2_OUT ([KEY], scaler_output_2, scaler_output_3, scaler_output_4, scaler_output_5) SELECT [ADS_sca_2_OUT].[KEY], [ADS_sca_2_OUT].scaler_output_2, [ADS_sca_2_OUT].scaler_output_3, [ADS_sca_2_OUT].scaler_output_4, [ADS_sca_2_OUT].scaler_output_5 
...
FROM ##TMP_20180508185216_CODEGEN_UQ1Z1E_ADS_imp_1_OUT AS [ADS_imp_1_OUT]) AS [ADS_sca_2_OUT]

-- Code For temporary table ##TMP_20180508185216_CODEGEN_3J7R6K_LGBM_B0 part 1. Create 


CREATE TABLE ##TMP_20180508185216_CODEGEN_3J7R6K_LGBM_B0 (
	[KEY] BIGINT NULL, 
...
-- Code For temporary table ##TMP_20180508185216_CODEGEN_3J7R6K_LGBM_B0 part 2. Populate
...
FROM ##TMP_20180508185216_CODEGEN_YLQYQN_ADS_sca_2_OUT AS [ADS_sca_2_OUT]), 
[DT_node_data] AS 
...
FROM [DT_Output_9])
 INSERT INTO ##TMP_20180508185216_CODEGEN_3J7R6K_LGBM_B0 ([KEY], [Estimator]) SELECT [LGBM_B0].[KEY], [LGBM_B0].[Estimator] 
...
-- Code For temporary table ##TMP_20180508185216_CODEGEN_IPFENQ_LGBM_B1 part 1. Create 


CREATE TABLE ##TMP_20180508185216_CODEGEN_IPFENQ_LGBM_B1 (
	[KEY] BIGINT NULL, 
	[Estimator] FLOAT(53) NULL
)
...
-- Code For temporary table ##TMP_20180508185216_CODEGEN_IPFENQ_LGBM_B1 part 2. Populate
...
FROM [DT_Output_15])
 INSERT INTO ##TMP_20180508185216_CODEGEN_IPFENQ_LGBM_B1 ([KEY], [Estimator]) SELECT [LGBM_B1].[KEY], [LGBM_B1].[Estimator] 
...
-- Code For temporary table ##TMP_20180508185216_CODEGEN_F430IO_LGBM_Union part 1. Create 


CREATE TABLE ##TMP_20180508185216_CODEGEN_F430IO_LGBM_Union (
	[KEY] BIGINT NULL, 
	[Estimator] FLOAT(53) NULL
)
...
-- Code For temporary table ##TMP_20180508185216_CODEGEN_F430IO_LGBM_Union part 2. Populate

INSERT INTO ##TMP_20180508185216_CODEGEN_F430IO_LGBM_Union ([KEY], [Estimator]) SELECT [LGBM_Union].[KEY], [LGBM_Union].[Estimator] 
...
FROM ##TMP_20180508185216_CODEGEN_3J7R6K_LGBM_B0 AS [LGBM_B0] UNION ALL SELECT [LGBM_B1].[KEY] AS [KEY], [LGBM_B1].[Estimator] AS [Estimator] 
FROM ##TMP_20180508185216_CODEGEN_IPFENQ_LGBM_B1 AS [LGBM_B1]) AS [LGBM_EnsembleUnion]) AS [LGBM_Union]

-- Code For temporary table ##TMP_20180508185216_CODEGEN_AY9YVE_LGBM_sum part 1. Create 


CREATE TABLE ##TMP_20180508185216_CODEGEN_AY9YVE_LGBM_sum (
	[KEY] BIGINT NULL, 
	[Estimator] FLOAT(53) NULL
)
...
-- Code For temporary table ##TMP_20180508185216_CODEGEN_AY9YVE_LGBM_sum part 2. Populate

INSERT INTO ##TMP_20180508185216_CODEGEN_AY9YVE_LGBM_sum ([KEY], [Estimator]) SELECT [LGBM_sum].[KEY], [LGBM_sum].[Estimator] 
...
FROM ##TMP_20180508185216_CODEGEN_F430IO_LGBM_Union AS [LGBM_Union] GROUP BY [LGBM_Union].[KEY]) AS [T]) AS [LGBM_sum]

-- Model deployment code

SELECT [LGBM_sum].[KEY] AS [KEY], [LGBM_sum].[Estimator] AS [Estimator] 
FROM ##TMP_20180508185216_CODEGEN_AY9YVE_LGBM_sum AS [LGBM_sum]