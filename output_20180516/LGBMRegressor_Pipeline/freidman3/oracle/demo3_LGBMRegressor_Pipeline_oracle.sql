...
-- Code For temporary table DEGEN_PWZ0L3_ADS_IMP_1_OUT part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "DEGEN_PWZ0L3_ADS_IMP_1_OUT" (
	"KEY" NUMBER(19), 
...
-- Code For temporary table DEGEN_PWZ0L3_ADS_IMP_1_OUT part 2. Populate

INSERT INTO "DEGEN_PWZ0L3_ADS_IMP_1_OUT" ("KEY", imputer_output_2, imputer_output_3, imputer_output_4, imputer_output_5) SELECT "U"."KEY", "U".imputer_output_2, "U".imputer_output_3, "U".imputer_output_4, "U".imputer_output_5 
...
-- Code For temporary table DEGEN_JEFFJ4_ADS_SCA_2_OUT part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "DEGEN_JEFFJ4_ADS_SCA_2_OUT" (
	"KEY" NUMBER(19), 
...
-- Code For temporary table DEGEN_JEFFJ4_ADS_SCA_2_OUT part 2. Populate

INSERT INTO "DEGEN_JEFFJ4_ADS_SCA_2_OUT" ("KEY", scaler_output_2, scaler_output_3, scaler_output_4, scaler_output_5) SELECT "U"."KEY", "U".scaler_output_2, "U".scaler_output_3, "U".scaler_output_4, "U".scaler_output_5 
...
FROM "DEGEN_PWZ0L3_ADS_IMP_1_OUT" "ADS_imp_1_OUT") "ADS_sca_2_OUT") "U"

-- Code For temporary table 516_CODEGEN_65MHBG_LGBM_B0 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "516_CODEGEN_65MHBG_LGBM_B0" (
	"KEY" NUMBER(19), 
...
-- Code For temporary table 516_CODEGEN_65MHBG_LGBM_B0 part 2. Populate

INSERT INTO "516_CODEGEN_65MHBG_LGBM_B0" ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
FROM "DEGEN_JEFFJ4_ADS_SCA_2_OUT" "ADS_sca_2_OUT"), 
"DT_node_data" AS 
...
-- Code For temporary table 516_CODEGEN_LF9XTH_LGBM_B1 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "516_CODEGEN_LF9XTH_LGBM_B1" (
	"KEY" NUMBER(19), 
	"Estimator" BINARY_DOUBLE
)
...
-- Code For temporary table 516_CODEGEN_LF9XTH_LGBM_B1 part 2. Populate

INSERT INTO "516_CODEGEN_LF9XTH_LGBM_B1" ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
-- Code For temporary table 16_CODEGEN_K8VPIL_LGBM_SUM part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "16_CODEGEN_K8VPIL_LGBM_SUM" (
	"KEY" NUMBER(19), 
	"Estimator" BINARY_DOUBLE
)
...
-- Code For temporary table 16_CODEGEN_K8VPIL_LGBM_SUM part 2. Populate

INSERT INTO "16_CODEGEN_K8VPIL_LGBM_SUM" ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
FROM "516_CODEGEN_65MHBG_LGBM_B0" "LGBM_B0" UNION ALL SELECT "LGBM_B1"."KEY" AS "KEY", "LGBM_B1"."Estimator" AS "Estimator" 
FROM "516_CODEGEN_LF9XTH_LGBM_B1" "LGBM_B1") "LGBM_EnsembleUnion")
...
FROM "16_CODEGEN_K8VPIL_LGBM_SUM" "LGBM_sum"