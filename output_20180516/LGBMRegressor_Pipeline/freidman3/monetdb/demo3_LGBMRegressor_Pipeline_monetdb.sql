...
-- Code For temporary table tmp_20180516121840_codegen_wp85eq_ads_imp_1_out part 1. Create 


CREATE TEMPORARY TABLE tmp_20180516121840_codegen_wp85eq_ads_imp_1_out (
	"KEY" BIGINT, 
...
-- Code For temporary table tmp_20180516121840_codegen_wp85eq_ads_imp_1_out part 2. Populate

INSERT INTO tmp_20180516121840_codegen_wp85eq_ads_imp_1_out ("KEY", imputer_output_2, imputer_output_3, imputer_output_4, imputer_output_5) SELECT "U"."KEY", "U".imputer_output_2, "U".imputer_output_3, "U".imputer_output_4, "U".imputer_output_5 
...
-- Code For temporary table tmp_20180516121840_codegen_4678ql_ads_sca_2_out part 1. Create 


CREATE TEMPORARY TABLE tmp_20180516121840_codegen_4678ql_ads_sca_2_out (
	"KEY" BIGINT, 
...
-- Code For temporary table tmp_20180516121840_codegen_4678ql_ads_sca_2_out part 2. Populate

INSERT INTO tmp_20180516121840_codegen_4678ql_ads_sca_2_out ("KEY", scaler_output_2, scaler_output_3, scaler_output_4, scaler_output_5) SELECT "U"."KEY", "U".scaler_output_2, "U".scaler_output_3, "U".scaler_output_4, "U".scaler_output_5 
...
FROM tmp_20180516121840_codegen_wp85eq_ads_imp_1_out AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT") AS "U"

-- Code For temporary table tmp_20180516121840_codegen_k52yox_lgbm_b0 part 1. Create 


CREATE TEMPORARY TABLE tmp_20180516121840_codegen_k52yox_lgbm_b0 (
	"KEY" BIGINT, 
	"Estimator" DOUBLE
)
...
-- Code For temporary table tmp_20180516121840_codegen_k52yox_lgbm_b0 part 2. Populate

INSERT INTO tmp_20180516121840_codegen_k52yox_lgbm_b0 ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
FROM tmp_20180516121840_codegen_4678ql_ads_sca_2_out AS "ADS_sca_2_OUT"), 
"DT_node_data" AS 
...
-- Code For temporary table tmp_20180516121840_codegen_1w4mly_lgbm_b1 part 1. Create 


CREATE TEMPORARY TABLE tmp_20180516121840_codegen_1w4mly_lgbm_b1 (
	"KEY" BIGINT, 
	"Estimator" DOUBLE
)
...
-- Code For temporary table tmp_20180516121840_codegen_1w4mly_lgbm_b1 part 2. Populate

INSERT INTO tmp_20180516121840_codegen_1w4mly_lgbm_b1 ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
-- Code For temporary table tmp_20180516121840_codegen_yrrxov_lgbm_sum part 1. Create 


CREATE TEMPORARY TABLE tmp_20180516121840_codegen_yrrxov_lgbm_sum (
	"KEY" BIGINT, 
	"Estimator" DOUBLE
)
...
-- Code For temporary table tmp_20180516121840_codegen_yrrxov_lgbm_sum part 2. Populate

INSERT INTO tmp_20180516121840_codegen_yrrxov_lgbm_sum ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
FROM tmp_20180516121840_codegen_k52yox_lgbm_b0 AS "LGBM_B0" UNION ALL SELECT "LGBM_B1"."KEY" AS "KEY", "LGBM_B1"."Estimator" AS "Estimator" 
FROM tmp_20180516121840_codegen_1w4mly_lgbm_b1 AS "LGBM_B1") AS "LGBM_EnsembleUnion")
...
FROM tmp_20180516121840_codegen_yrrxov_lgbm_sum AS "LGBM_sum"