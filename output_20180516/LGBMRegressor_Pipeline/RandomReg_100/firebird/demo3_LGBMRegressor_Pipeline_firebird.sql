...
-- Code For temporary table TMP_20180508182627_CODEGEN_1LB4 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508182627_CODEGEN_1LB4" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20180508182627_CODEGEN_1LB4 part 3. Create Index 

CREATE INDEX "ix_TMP_20180508182627_C_88e0" ON "TMP_20180508182627_CODEGEN_1LB4" ("KEY")

-- Code For temporary table TMP_20180508182627_CODEGEN_3GV1 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508182627_CODEGEN_3GV1" (
	"KEY" BIGINT NOT NULL, 
...
FROM "TMP_20180508182627_CODEGEN_1LB4" AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT") AS "U"

-- Code For temporary table TMP_20180508182627_CODEGEN_3GV1 part 3. Create Index 

CREATE INDEX "ix_TMP_20180508182627_C_e0f2" ON "TMP_20180508182627_CODEGEN_3GV1" ("KEY")

-- Code For temporary table TMP_20180508182627_CODEGEN_W0UI part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508182627_CODEGEN_W0UI" (
	"KEY" BIGINT, 
...
-- Code For temporary table TMP_20180508182627_CODEGEN_W0UI part 2. Populate

INSERT INTO "TMP_20180508182627_CODEGEN_W0UI" ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
FROM "TMP_20180508182627_CODEGEN_3GV1" AS "ADS_sca_2_OUT"), 
"DT_node_data" AS 
...
-- Code For temporary table TMP_20180508182627_CODEGEN_NTEN part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508182627_CODEGEN_NTEN" (
	"KEY" BIGINT, 
	"Estimator" DOUBLE PRECISION
)
...
-- Code For temporary table TMP_20180508182627_CODEGEN_NTEN part 2. Populate

INSERT INTO "TMP_20180508182627_CODEGEN_NTEN" ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
-- Code For temporary table TMP_20180508182627_CODEGEN_IX96 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508182627_CODEGEN_IX96" (
	"KEY" BIGINT, 
	"Estimator" DOUBLE PRECISION
)
...
-- Code For temporary table TMP_20180508182627_CODEGEN_IX96 part 2. Populate

INSERT INTO "TMP_20180508182627_CODEGEN_IX96" ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
FROM "TMP_20180508182627_CODEGEN_W0UI" AS "LGBM_B0" UNION ALL SELECT "LGBM_B1"."KEY" AS "KEY", "LGBM_B1"."Estimator" AS "Estimator" 
FROM "TMP_20180508182627_CODEGEN_NTEN" AS "LGBM_B1") AS "LGBM_EnsembleUnion") AS "LGBM_Union") AS "U"

-- Code For temporary table TMP_20180508182627_CODEGEN_KUNX part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508182627_CODEGEN_KUNX" (
	"KEY" BIGINT NOT NULL, 
	"Estimator" DOUBLE PRECISION, 
	PRIMARY KEY ("KEY")
)
...
-- Code For temporary table TMP_20180508182627_CODEGEN_KUNX part 2. Populate

INSERT INTO "TMP_20180508182627_CODEGEN_KUNX" ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
FROM "TMP_20180508182627_CODEGEN_IX96" AS "LGBM_Union" GROUP BY "LGBM_Union"."KEY") AS "T") AS "LGBM_sum") AS "U"

-- Code For temporary table TMP_20180508182627_CODEGEN_KUNX part 3. Create Index 

CREATE INDEX "ix_TMP_20180508182627_C_b0ed" ON "TMP_20180508182627_CODEGEN_KUNX" ("KEY")

-- Model deployment code

SELECT "LGBM_sum"."KEY" AS "KEY", "LGBM_sum"."Estimator" AS "Estimator" 
FROM "TMP_20180508182627_CODEGEN_KUNX" AS "LGBM_sum"