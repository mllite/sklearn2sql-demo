...
-- Code For temporary table tmp_20180602144932_5vg_ads_imp_1_out part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180602144932_5vg_ads_imp_1_out (
	"KEY" BIGINT, 
	impter_2 DOUBLE, 
	impter_3 DOUBLE, 
	impter_4 DOUBLE, 
...
-- Code For temporary table tmp_20180602144932_wvp_ads_sca_2_out part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180602144932_wvp_ads_sca_2_out (
	"KEY" BIGINT, 
	scaler_2 DOUBLE, 
	scaler_3 DOUBLE, 
	scaler_4 DOUBLE, 
...
FROM tmp_20180602144932_5vg_ads_imp_1_out AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT"

-- Code For temporary table tmp_20180602144932_2kt_lgbm_b0 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180602144932_2kt_lgbm_b0 (
	"KEY" BIGINT, 
	"Estimator" DOUBLE
)
...
-- Code For temporary table tmp_20180602144932_2kt_lgbm_b0 part 2. Populate

INSERT INTO tmp_20180602144932_2kt_lgbm_b0 WITH "DT_node_lookup" AS 
...
FROM tmp_20180602144932_wvp_ads_sca_2_out AS "ADS_sca_2_OUT"), 
"DT_node_data" AS 
...
-- Code For temporary table tmp_20180602144932_9k7_lgbm_b1 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180602144932_9k7_lgbm_b1 (
	"KEY" BIGINT, 
	"Estimator" DOUBLE
)
...
-- Code For temporary table tmp_20180602144932_9k7_lgbm_b1 part 2. Populate

INSERT INTO tmp_20180602144932_9k7_lgbm_b1 WITH "DT_node_lookup_10" AS 
...
-- Code For temporary table tmp_20180602144932_qad_lgbm_sum part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180602144932_qad_lgbm_sum (
	"KEY" BIGINT, 
	"Estimator" DOUBLE
)
...
-- Code For temporary table tmp_20180602144932_qad_lgbm_sum part 2. Populate

INSERT INTO tmp_20180602144932_qad_lgbm_sum WITH "LGBM_Union" AS 
...
FROM tmp_20180602144932_2kt_lgbm_b0 AS "LGBM_B0" UNION ALL SELECT "LGBM_B1"."KEY" AS "KEY", "LGBM_B1"."Estimator" AS "Estimator" 
FROM tmp_20180602144932_9k7_lgbm_b1 AS "LGBM_B1") AS "LGBM_EnsembleUnion")
...
FROM tmp_20180602144932_qad_lgbm_sum AS "LGBM_sum"