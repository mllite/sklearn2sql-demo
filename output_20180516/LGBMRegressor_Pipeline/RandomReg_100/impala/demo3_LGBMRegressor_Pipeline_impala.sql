...
-- Code For temporary table tmp_20180516114248_codegen_c6zmhy_ads_imp_1_out part 1. Create 


CREATE TABLE tmp_20180516114248_codegen_c6zmhy_ads_imp_1_out (
	`KEY` BIGINT, 
	impter_2 DOUBLE, 
	impter_3 DOUBLE, 
	impter_4 DOUBLE, 
...
-- Code For temporary table tmp_20180516114248_codegen_890tm6_ads_sca_2_out part 1. Create 


CREATE TABLE tmp_20180516114248_codegen_890tm6_ads_sca_2_out (
	`KEY` BIGINT, 
	scaler_2 DOUBLE, 
	scaler_3 DOUBLE, 
	scaler_4 DOUBLE, 
...
FROM tmp_20180516114248_codegen_c6zmhy_ads_imp_1_out AS `ADS_imp_1_OUT`) AS `ADS_sca_2_OUT`

-- Code For temporary table tmp_20180516114248_codegen_4tipl3_lgbm_b0 part 1. Create 


CREATE TABLE tmp_20180516114248_codegen_4tipl3_lgbm_b0 (
	`KEY` BIGINT, 
	`Estimator` DOUBLE
)
...
-- Code For temporary table tmp_20180516114248_codegen_4tipl3_lgbm_b0 part 2. Populate
...
FROM tmp_20180516114248_codegen_890tm6_ads_sca_2_out AS `ADS_sca_2_OUT`), 
`DT_node_data` AS 
...
FROM `DT_Output_9`)
 INSERT INTO tmp_20180516114248_codegen_4tipl3_lgbm_b0 (`KEY`, `Estimator`) SELECT `LGBM_B0`.`KEY`, `LGBM_B0`.`Estimator` 
...
-- Code For temporary table tmp_20180516114248_codegen_svtrc0_lgbm_b1 part 1. Create 


CREATE TABLE tmp_20180516114248_codegen_svtrc0_lgbm_b1 (
	`KEY` BIGINT, 
	`Estimator` DOUBLE
)
...
-- Code For temporary table tmp_20180516114248_codegen_svtrc0_lgbm_b1 part 2. Populate
...
FROM `DT_Output_15`)
 INSERT INTO tmp_20180516114248_codegen_svtrc0_lgbm_b1 (`KEY`, `Estimator`) SELECT `LGBM_B1`.`KEY`, `LGBM_B1`.`Estimator` 
...
-- Code For temporary table tmp_20180516114248_codegen_h1bc07_lgbm_sum part 1. Create 


CREATE TABLE tmp_20180516114248_codegen_h1bc07_lgbm_sum (
	`KEY` BIGINT, 
	`Estimator` DOUBLE
)
...
-- Code For temporary table tmp_20180516114248_codegen_h1bc07_lgbm_sum part 2. Populate
...
FROM tmp_20180516114248_codegen_4tipl3_lgbm_b0 AS `LGBM_B0` UNION ALL SELECT `LGBM_B1`.`KEY` AS `KEY`, `LGBM_B1`.`Estimator` AS `Estimator` 
FROM tmp_20180516114248_codegen_svtrc0_lgbm_b1 AS `LGBM_B1`) AS `LGBM_EnsembleUnion`)
 INSERT INTO tmp_20180516114248_codegen_h1bc07_lgbm_sum (`KEY`, `Estimator`) SELECT `LGBM_sum`.`KEY`, `LGBM_sum`.`Estimator` 
...
FROM tmp_20180516114248_codegen_h1bc07_lgbm_sum AS `LGBM_sum`