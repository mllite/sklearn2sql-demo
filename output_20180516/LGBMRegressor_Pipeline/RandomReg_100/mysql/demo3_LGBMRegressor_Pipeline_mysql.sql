...
-- Code For temporary table TMP_20180516114248_CODEGEN_Y10J3P_ADS_imp_1_OUT part 1. Create 


CREATE TEMPORARY TABLE `TMP_20180516114248_CODEGEN_Y10J3P_ADS_imp_1_OUT` (
	`KEY` BIGINT NOT NULL, 
	impter_2 DOUBLE, 
	impter_3 DOUBLE, 
	impter_4 DOUBLE, 
...
-- Code For temporary table TMP_20180516114248_CODEGEN_Y10J3P_ADS_imp_1_OUT part 3. Create Index 

CREATE INDEX `ix_TMP_20180516114248_CODEGEN_Y10J3P_ADS_imp_1_OUT_KEY` ON `TMP_20180516114248_CODEGEN_Y10J3P_ADS_imp_1_OUT` (`KEY`)

-- Code For temporary table TMP_20180516114248_CODEGEN_N783IT_ADS_sca_2_OUT part 1. Create 


CREATE TEMPORARY TABLE `TMP_20180516114248_CODEGEN_N783IT_ADS_sca_2_OUT` (
	`KEY` BIGINT NOT NULL, 
	scaler_2 DOUBLE, 
	scaler_3 DOUBLE, 
	scaler_4 DOUBLE, 
...
FROM `TMP_20180516114248_CODEGEN_Y10J3P_ADS_imp_1_OUT` AS `ADS_imp_1_OUT`) AS `ADS_sca_2_OUT`) AS `U`

-- Code For temporary table TMP_20180516114248_CODEGEN_N783IT_ADS_sca_2_OUT part 3. Create Index 

CREATE INDEX `ix_TMP_20180516114248_CODEGEN_N783IT_ADS_sca_2_OUT_KEY` ON `TMP_20180516114248_CODEGEN_N783IT_ADS_sca_2_OUT` (`KEY`)

-- Code For temporary table TMP_20180516114248_CODEGEN_OONXUG_LGBM_B0 part 1. Create 


CREATE TEMPORARY TABLE `TMP_20180516114248_CODEGEN_OONXUG_LGBM_B0` (
	`KEY` BIGINT, 
	`Estimator` DOUBLE
)
...
-- Code For temporary table TMP_20180516114248_CODEGEN_OONXUG_LGBM_B0 part 2. Populate

INSERT INTO `TMP_20180516114248_CODEGEN_OONXUG_LGBM_B0` (`KEY`, `Estimator`) SELECT `U`.`KEY`, `U`.`Estimator` 
...
FROM `TMP_20180516114248_CODEGEN_N783IT_ADS_sca_2_OUT` AS `ADS_sca_2_OUT`), 
`DT_node_data` AS 
...
`DT_node_data_1` AS 
(SELECT `Values`.nid AS nid, CAST(`Values`.`Estimator` AS DOUBLE) AS `Estimator` 
FROM (SELECT 2 AS nid, -6.643302178382874 AS `Estimator` UNION ALL SELECT 6 AS nid, 1.8620260331034661 AS `Estimator` UNION ALL SELECT 7 AS nid, 8.41326480905215 AS `Estimator`) AS `Values`), 
`DT_Output_1` AS 
...
`DT_node_data_2` AS 
(SELECT `Values`.nid AS nid, CAST(`Values`.`Estimator` AS DOUBLE) AS `Estimator` 
FROM (SELECT 2 AS nid, -6.311137093438043 AS `Estimator` UNION ALL SELECT 6 AS nid, 8.240821064555126 AS `Estimator` UNION ALL SELECT 7 AS nid, 1.7934311248007277 AS `Estimator`) AS `Values`), 
`DT_Output_2` AS 
...
`DT_node_data_3` AS 
(SELECT `Values`.nid AS nid, CAST(`Values`.`Estimator` AS DOUBLE) AS `Estimator` 
FROM (SELECT 2 AS nid, -5.995580262607999 AS `Estimator` UNION ALL SELECT 6 AS nid, 8.347382546663285 AS `Estimator` UNION ALL SELECT 7 AS nid, 2.0372182061274846 AS `Estimator`) AS `Values`), 
`DT_Output_3` AS 
...
`DT_node_data_4` AS 
(SELECT `Values`.nid AS nid, CAST(`Values`.`Estimator` AS DOUBLE) AS `Estimator` 
FROM (SELECT 2 AS nid, -7.318240388234456 AS `Estimator` UNION ALL SELECT 6 AS nid, -0.8202801658993675 AS `Estimator` UNION ALL SELECT 7 AS nid, 6.713073948025704 AS `Estimator`) AS `Values`), 
`DT_Output_4` AS 
...
`DT_node_data_5` AS 
(SELECT `Values`.nid AS nid, CAST(`Values`.`Estimator` AS DOUBLE) AS `Estimator` 
FROM (SELECT 2 AS nid, -6.608081002235413 AS `Estimator` UNION ALL SELECT 6 AS nid, 1.0472374431018172 AS `Estimator` UNION ALL SELECT 7 AS nid, 7.9939303171067015 AS `Estimator`) AS `Values`), 
`DT_Output_5` AS 
...
`DT_node_data_6` AS 
(SELECT `Values`.nid AS nid, CAST(`Values`.`Estimator` AS DOUBLE) AS `Estimator` 
FROM (SELECT 2 AS nid, -5.388630689515008 AS `Estimator` UNION ALL SELECT 6 AS nid, 7.273375240616177 AS `Estimator` UNION ALL SELECT 7 AS nid, 1.2715750478562855 AS `Estimator`) AS `Values`), 
`DT_Output_6` AS 
...
`DT_node_data_7` AS 
(SELECT `Values`.nid AS nid, CAST(`Values`.`Estimator` AS DOUBLE) AS `Estimator` 
FROM (SELECT 2 AS nid, -6.748947189472339 AS `Estimator` UNION ALL SELECT 6 AS nid, -0.7965929235730853 AS `Estimator` UNION ALL SELECT 7 AS nid, 6.217188206128776 AS `Estimator`) AS `Values`), 
`DT_Output_7` AS 
...
`DT_node_data_8` AS 
(SELECT `Values`.nid AS nid, CAST(`Values`.`Estimator` AS DOUBLE) AS `Estimator` 
FROM (SELECT 2 AS nid, -5.924813428719839 AS `Estimator` UNION ALL SELECT 6 AS nid, 0.9418199950251087 AS `Estimator` UNION ALL SELECT 7 AS nid, 7.163410550072079 AS `Estimator`) AS `Values`), 
`DT_Output_8` AS 
...
`DT_node_data_9` AS 
(SELECT `Values`.nid AS nid, CAST(`Values`.`Estimator` AS DOUBLE) AS `Estimator` 
FROM (SELECT 2 AS nid, -6.279372543758817 AS `Estimator` UNION ALL SELECT 6 AS nid, 0.26429674003658626 AS `Estimator` UNION ALL SELECT 7 AS nid, 6.744935405254364 AS `Estimator`) AS `Values`), 
`DT_Output_9` AS 
...
-- Code For temporary table TMP_20180516114248_CODEGEN_GVS1I1_LGBM_B1 part 1. Create 


CREATE TEMPORARY TABLE `TMP_20180516114248_CODEGEN_GVS1I1_LGBM_B1` (
	`KEY` BIGINT, 
	`Estimator` DOUBLE
)
...
-- Code For temporary table TMP_20180516114248_CODEGEN_GVS1I1_LGBM_B1 part 2. Populate

INSERT INTO `TMP_20180516114248_CODEGEN_GVS1I1_LGBM_B1` (`KEY`, `Estimator`) SELECT `U`.`KEY`, `U`.`Estimator` 
...
`DT_node_data_10` AS 
(SELECT `Values`.nid AS nid, CAST(`Values`.`Estimator` AS DOUBLE) AS `Estimator` 
FROM (SELECT 2 AS nid, -5.631274582544963 AS `Estimator` UNION ALL SELECT 6 AS nid, 0.4178266439288855 AS `Estimator` UNION ALL SELECT 7 AS nid, 6.339702880859376 AS `Estimator`) AS `Values`), 
`DT_Output_10` AS 
...
`DT_node_data_11` AS 
(SELECT `Values`.nid AS nid, CAST(`Values`.`Estimator` AS DOUBLE) AS `Estimator` 
FROM (SELECT 2 AS nid, -4.380714757014544 AS `Estimator` UNION ALL SELECT 6 AS nid, 6.958330497287569 AS `Estimator` UNION ALL SELECT 7 AS nid, 1.2361466693878176 AS `Estimator`) AS `Values`), 
`DT_Output_11` AS 
...
`DT_node_data_12` AS 
(SELECT `Values`.nid AS nid, CAST(`Values`.`Estimator` AS DOUBLE) AS `Estimator` 
FROM (SELECT 2 AS nid, -5.876025358835856 AS `Estimator` UNION ALL SELECT 6 AS nid, -0.8593776771000453 AS `Estimator` UNION ALL SELECT 7 AS nid, 5.5218630045652395 AS `Estimator`) AS `Values`), 
`DT_Output_12` AS 
...
`DT_node_data_13` AS 
(SELECT `Values`.nid AS nid, CAST(`Values`.`Estimator` AS DOUBLE) AS `Estimator` 
FROM (SELECT 2 AS nid, -5.214756147066752 AS `Estimator` UNION ALL SELECT 6 AS nid, 0.4195549581050873 AS `Estimator` UNION ALL SELECT 7 AS nid, 5.838152244567872 AS `Estimator`) AS `Values`), 
`DT_Output_13` AS 
...
`DT_node_data_14` AS 
(SELECT `Values`.nid AS nid, CAST(`Values`.`Estimator` AS DOUBLE) AS `Estimator` 
FROM (SELECT 2 AS nid, -4.062699776887894 AS `Estimator` UNION ALL SELECT 6 AS nid, 6.489241145905995 AS `Estimator` UNION ALL SELECT 7 AS nid, 1.108561372756958 AS `Estimator`) AS `Values`), 
`DT_Output_14` AS 
...
`DT_node_data_15` AS 
(SELECT `Values`.nid AS nid, CAST(`Values`.`Estimator` AS DOUBLE) AS `Estimator` 
FROM (SELECT 2 AS nid, -5.499722735087077 AS `Estimator` UNION ALL SELECT 6 AS nid, 0.07203617424800478 AS `Estimator` UNION ALL SELECT 7 AS nid, 6.1001444309949875 AS `Estimator`) AS `Values`), 
`DT_Output_15` AS 
...
-- Code For temporary table TMP_20180516114248_CODEGEN_ECDWDT_LGBM_sum part 1. Create 


CREATE TEMPORARY TABLE `TMP_20180516114248_CODEGEN_ECDWDT_LGBM_sum` (
	`KEY` BIGINT NOT NULL, 
	`Estimator` DOUBLE, 
	PRIMARY KEY (`KEY`)
)
...
-- Code For temporary table TMP_20180516114248_CODEGEN_ECDWDT_LGBM_sum part 2. Populate

INSERT INTO `TMP_20180516114248_CODEGEN_ECDWDT_LGBM_sum` (`KEY`, `Estimator`) SELECT `U`.`KEY`, `U`.`Estimator` 
...
FROM `TMP_20180516114248_CODEGEN_OONXUG_LGBM_B0` AS `LGBM_B0` UNION ALL SELECT `LGBM_B1`.`KEY` AS `KEY`, `LGBM_B1`.`Estimator` AS `Estimator` 
FROM `TMP_20180516114248_CODEGEN_GVS1I1_LGBM_B1` AS `LGBM_B1`) AS `LGBM_EnsembleUnion`)
...
-- Code For temporary table TMP_20180516114248_CODEGEN_ECDWDT_LGBM_sum part 3. Create Index 

CREATE INDEX `ix_TMP_20180516114248_CODEGEN_ECDWDT_LGBM_sum_KEY` ON `TMP_20180516114248_CODEGEN_ECDWDT_LGBM_sum` (`KEY`)

-- Model deployment code

SELECT `LGBM_sum`.`KEY` AS `KEY`, `LGBM_sum`.`Estimator` AS `Estimator` 
FROM `TMP_20180516114248_CODEGEN_ECDWDT_LGBM_sum` AS `LGBM_sum`