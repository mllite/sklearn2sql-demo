...
-- Code For temporary table TMP_20180516_CODEGEN_RO6J5Z_ADS part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180516_CODEGEN_RO6J5Z_ADS" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20180516_CODEGEN_RO6J5Z_ADS part 2. Populate

INSERT INTO "TMP_20180516_CODEGEN_RO6J5Z_ADS" ("KEY", impter_2, impter_3, impter_4, impter_5, impter_6, impter_7, impter_8, impter_9, impter_10, impter_11) SELECT "U"."KEY", "U".impter_2, "U".impter_3, "U".impter_4, "U".impter_5, "U".impter_6, "U".impter_7, "U".impter_8, "U".impter_9, "U".impter_10, "U".impter_11 
...
-- Code For temporary table TMP_20180516_CODEGEN_RO6J5Z_ADS part 3. Create Index 

CREATE INDEX "ix_TMP_20180516_CODEGEN_1df9" ON "TMP_20180516_CODEGEN_RO6J5Z_ADS" ("KEY")

-- Code For temporary table TMP_20180516_CODEGEN_71DYP1_ADS part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180516_CODEGEN_71DYP1_ADS" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20180516_CODEGEN_71DYP1_ADS part 2. Populate

INSERT INTO "TMP_20180516_CODEGEN_71DYP1_ADS" ("KEY", scaler_2, scaler_3, scaler_4, scaler_5, scaler_6, scaler_7, scaler_8, scaler_9, scaler_10, scaler_11) SELECT "U"."KEY", "U".scaler_2, "U".scaler_3, "U".scaler_4, "U".scaler_5, "U".scaler_6, "U".scaler_7, "U".scaler_8, "U".scaler_9, "U".scaler_10, "U".scaler_11 
...
FROM "TMP_20180516_CODEGEN_RO6J5Z_ADS" AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT") AS "U"

-- Code For temporary table TMP_20180516_CODEGEN_71DYP1_ADS part 3. Create Index 

CREATE INDEX "ix_TMP_20180516_CODEGEN_c957" ON "TMP_20180516_CODEGEN_71DYP1_ADS" ("KEY")

-- Code For temporary table TMP_20180516_CODEGEN_XHEO6P_LGB part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180516_CODEGEN_XHEO6P_LGB" (
	"KEY" BIGINT, 
...
-- Code For temporary table TMP_20180516_CODEGEN_XHEO6P_LGB part 2. Populate

INSERT INTO "TMP_20180516_CODEGEN_XHEO6P_LGB" ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
FROM "TMP_20180516_CODEGEN_71DYP1_ADS" AS "ADS_sca_2_OUT"), 
"DT_node_data" AS 
...
-- Code For temporary table TMP_20180516_CODEGEN_DG7C1E_LGB part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180516_CODEGEN_DG7C1E_LGB" (
	"KEY" BIGINT, 
	"Estimator" DOUBLE PRECISION
)
...
-- Code For temporary table TMP_20180516_CODEGEN_DG7C1E_LGB part 2. Populate

INSERT INTO "TMP_20180516_CODEGEN_DG7C1E_LGB" ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
-- Code For temporary table TMP_20180516_CODEGEN_JOL6X1_LGB part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180516_CODEGEN_JOL6X1_LGB" (
	"KEY" BIGINT NOT NULL, 
	"Estimator" DOUBLE PRECISION, 
	PRIMARY KEY ("KEY")
)
...
-- Code For temporary table TMP_20180516_CODEGEN_JOL6X1_LGB part 2. Populate

INSERT INTO "TMP_20180516_CODEGEN_JOL6X1_LGB" ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
FROM "TMP_20180516_CODEGEN_XHEO6P_LGB" AS "LGBM_B0" UNION ALL SELECT "LGBM_B1"."KEY" AS "KEY", "LGBM_B1"."Estimator" AS "Estimator" 
FROM "TMP_20180516_CODEGEN_DG7C1E_LGB" AS "LGBM_B1") AS "LGBM_EnsembleUnion")
...
-- Code For temporary table TMP_20180516_CODEGEN_JOL6X1_LGB part 3. Create Index 

CREATE INDEX "ix_TMP_20180516_CODEGEN_6924" ON "TMP_20180516_CODEGEN_JOL6X1_LGB" ("KEY")

-- Model deployment code

SELECT "LGBM_sum"."KEY" AS "KEY", "LGBM_sum"."Estimator" AS "Estimator" 
FROM "TMP_20180516_CODEGEN_JOL6X1_LGB" AS "LGBM_sum"