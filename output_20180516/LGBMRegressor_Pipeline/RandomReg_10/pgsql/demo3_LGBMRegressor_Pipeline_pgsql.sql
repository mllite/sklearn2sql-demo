...
-- Code For temporary table TMP_20180516113721_CODEGEN_BX4UCC_ADS_imp_1_OUT part 1. Create 


CREATE TEMPORARY TABLE "TMP_20180516113721_CODEGEN_BX4UCC_ADS_imp_1_OUT" (
	"KEY" BIGINT NOT NULL, 
	impter_2 FLOAT, 
	impter_3 FLOAT, 
	impter_4 FLOAT, 
...
-- Code For temporary table TMP_20180516113721_CODEGEN_BX4UCC_ADS_imp_1_OUT part 3. Create Index 

CREATE INDEX "ix_TMP_20180516113721_CODEGEN_BX4UCC_ADS_imp_1_OUT_KEY" ON "TMP_20180516113721_CODEGEN_BX4UCC_ADS_imp_1_OUT" ("KEY")

-- Code For temporary table TMP_20180516113721_CODEGEN_Y3OIP8_ADS_sca_2_OUT part 1. Create 


CREATE TEMPORARY TABLE "TMP_20180516113721_CODEGEN_Y3OIP8_ADS_sca_2_OUT" (
	"KEY" BIGINT NOT NULL, 
	scaler_2 FLOAT, 
	scaler_3 FLOAT, 
	scaler_4 FLOAT, 
...
-- Code For temporary table TMP_20180516113721_CODEGEN_Y3OIP8_ADS_sca_2_OUT part 2. Populate

INSERT INTO "TMP_20180516113721_CODEGEN_Y3OIP8_ADS_sca_2_OUT" ("KEY", scaler_2, scaler_3, scaler_4, scaler_5, scaler_6, scaler_7, scaler_8, scaler_9, scaler_10, scaler_11) SELECT "ADS_sca_2_OUT"."KEY", "ADS_sca_2_OUT".scaler_2, "ADS_sca_2_OUT".scaler_3, "ADS_sca_2_OUT".scaler_4, "ADS_sca_2_OUT".scaler_5, "ADS_sca_2_OUT".scaler_6, "ADS_sca_2_OUT".scaler_7, "ADS_sca_2_OUT".scaler_8, "ADS_sca_2_OUT".scaler_9, "ADS_sca_2_OUT".scaler_10, "ADS_sca_2_OUT".scaler_11 
...
FROM "TMP_20180516113721_CODEGEN_BX4UCC_ADS_imp_1_OUT" AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT"

-- Code For temporary table TMP_20180516113721_CODEGEN_Y3OIP8_ADS_sca_2_OUT part 3. Create Index 

CREATE INDEX "ix_TMP_20180516113721_CODEGEN_Y3OIP8_ADS_sca_2_OUT_KEY" ON "TMP_20180516113721_CODEGEN_Y3OIP8_ADS_sca_2_OUT" ("KEY")

-- Code For temporary table TMP_20180516113721_CODEGEN_7GE97F_LGBM_B0 part 1. Create 


CREATE TEMPORARY TABLE "TMP_20180516113721_CODEGEN_7GE97F_LGBM_B0" (
	"KEY" BIGINT, 
	"Estimator" FLOAT
)
...
-- Code For temporary table TMP_20180516113721_CODEGEN_7GE97F_LGBM_B0 part 2. Populate
...
FROM "TMP_20180516113721_CODEGEN_Y3OIP8_ADS_sca_2_OUT" AS "ADS_sca_2_OUT"), 
"DT_node_data" AS 
...
FROM "DT_Output_9")
 INSERT INTO "TMP_20180516113721_CODEGEN_7GE97F_LGBM_B0" ("KEY", "Estimator") SELECT "LGBM_B0"."KEY", "LGBM_B0"."Estimator" 
...
-- Code For temporary table TMP_20180516113721_CODEGEN_RJLAX2_LGBM_B1 part 1. Create 


CREATE TEMPORARY TABLE "TMP_20180516113721_CODEGEN_RJLAX2_LGBM_B1" (
	"KEY" BIGINT, 
	"Estimator" FLOAT
)
...
-- Code For temporary table TMP_20180516113721_CODEGEN_RJLAX2_LGBM_B1 part 2. Populate
...
FROM "DT_Output_15")
 INSERT INTO "TMP_20180516113721_CODEGEN_RJLAX2_LGBM_B1" ("KEY", "Estimator") SELECT "LGBM_B1"."KEY", "LGBM_B1"."Estimator" 
...
-- Code For temporary table TMP_20180516113721_CODEGEN_HL5YMJ_LGBM_sum part 1. Create 


CREATE TEMPORARY TABLE "TMP_20180516113721_CODEGEN_HL5YMJ_LGBM_sum" (
	"KEY" BIGINT NOT NULL, 
	"Estimator" FLOAT, 
	PRIMARY KEY ("KEY")
)
...
-- Code For temporary table TMP_20180516113721_CODEGEN_HL5YMJ_LGBM_sum part 2. Populate
...
FROM "TMP_20180516113721_CODEGEN_7GE97F_LGBM_B0" AS "LGBM_B0" UNION ALL SELECT "LGBM_B1"."KEY" AS "KEY", "LGBM_B1"."Estimator" AS "Estimator" 
FROM "TMP_20180516113721_CODEGEN_RJLAX2_LGBM_B1" AS "LGBM_B1") AS "LGBM_EnsembleUnion")
 INSERT INTO "TMP_20180516113721_CODEGEN_HL5YMJ_LGBM_sum" ("KEY", "Estimator") SELECT "LGBM_sum"."KEY", "LGBM_sum"."Estimator" 
...
-- Code For temporary table TMP_20180516113721_CODEGEN_HL5YMJ_LGBM_sum part 3. Create Index 

CREATE INDEX "ix_TMP_20180516113721_CODEGEN_HL5YMJ_LGBM_sum_KEY" ON "TMP_20180516113721_CODEGEN_HL5YMJ_LGBM_sum" ("KEY")

-- Model deployment code

SELECT "LGBM_sum"."KEY" AS "KEY", "LGBM_sum"."Estimator" AS "Estimator" 
FROM "TMP_20180516113721_CODEGEN_HL5YMJ_LGBM_sum" AS "LGBM_sum"