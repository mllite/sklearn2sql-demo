...
-- Code For temporary table TMP_20180508184836_CODEGEN_274XJ8_ADS_imp_1_OUT part 1. Create 


CREATE TEMPORARY TABLE "TMP_20180508184836_CODEGEN_274XJ8_ADS_imp_1_OUT" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20180508184836_CODEGEN_274XJ8_ADS_imp_1_OUT part 2. Populate

INSERT INTO "TMP_20180508184836_CODEGEN_274XJ8_ADS_imp_1_OUT" ("KEY", imputer_output_2, imputer_output_3, imputer_output_4, imputer_output_5) SELECT "ADS_imp_1_OUT"."KEY", "ADS_imp_1_OUT".imputer_output_2, "ADS_imp_1_OUT".imputer_output_3, "ADS_imp_1_OUT".imputer_output_4, "ADS_imp_1_OUT".imputer_output_5 
...
-- Code For temporary table TMP_20180508184836_CODEGEN_274XJ8_ADS_imp_1_OUT part 3. Create Index 

CREATE INDEX "ix_TMP_20180508184836_CODEGEN_274XJ8_ADS_imp_1_OUT_KEY" ON "TMP_20180508184836_CODEGEN_274XJ8_ADS_imp_1_OUT" ("KEY")

-- Code For temporary table TMP_20180508184836_CODEGEN_KHGXYQ_ADS_sca_2_OUT part 1. Create 


CREATE TEMPORARY TABLE "TMP_20180508184836_CODEGEN_KHGXYQ_ADS_sca_2_OUT" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20180508184836_CODEGEN_KHGXYQ_ADS_sca_2_OUT part 2. Populate

INSERT INTO "TMP_20180508184836_CODEGEN_KHGXYQ_ADS_sca_2_OUT" ("KEY", scaler_output_2, scaler_output_3, scaler_output_4, scaler_output_5) SELECT "ADS_sca_2_OUT"."KEY", "ADS_sca_2_OUT".scaler_output_2, "ADS_sca_2_OUT".scaler_output_3, "ADS_sca_2_OUT".scaler_output_4, "ADS_sca_2_OUT".scaler_output_5 
...
FROM "TMP_20180508184836_CODEGEN_274XJ8_ADS_imp_1_OUT" AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT"

-- Code For temporary table TMP_20180508184836_CODEGEN_KHGXYQ_ADS_sca_2_OUT part 3. Create Index 

CREATE INDEX "ix_TMP_20180508184836_CODEGEN_KHGXYQ_ADS_sca_2_OUT_KEY" ON "TMP_20180508184836_CODEGEN_KHGXYQ_ADS_sca_2_OUT" ("KEY")

-- Code For temporary table TMP_20180508184836_CODEGEN_ETGCYH_LGBM_B0 part 1. Create 


CREATE TEMPORARY TABLE "TMP_20180508184836_CODEGEN_ETGCYH_LGBM_B0" (
	"KEY" BIGINT, 
	"Estimator" FLOAT
)
...
-- Code For temporary table TMP_20180508184836_CODEGEN_ETGCYH_LGBM_B0 part 2. Populate
...
FROM "TMP_20180508184836_CODEGEN_KHGXYQ_ADS_sca_2_OUT" AS "ADS_sca_2_OUT"), 
"DT_node_data" AS 
...
"DT_node_data_1" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Estimator" AS FLOAT) AS "Estimator" 
FROM (SELECT 2 AS nid, -12.793630010941449 AS "Estimator" UNION ALL SELECT 6 AS nid, -4.030740521170876 AS "Estimator" UNION ALL SELECT 7 AS nid, 21.81915512084961 AS "Estimator") AS "Values"), 
"DT_Output_1" AS 
...
"DT_node_data_2" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Estimator" AS FLOAT) AS "Estimator" 
FROM (SELECT 2 AS nid, -14.749121114942762 AS "Estimator" UNION ALL SELECT 6 AS nid, -8.276600069999695 AS "Estimator" UNION ALL SELECT 7 AS nid, 17.083583760984016 AS "Estimator") AS "Values"), 
"DT_Output_2" AS 
...
"DT_node_data_3" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Estimator" AS FLOAT) AS "Estimator" 
FROM (SELECT 2 AS nid, -14.01166511818215 AS "Estimator" UNION ALL SELECT 6 AS nid, -7.86277027130127 AS "Estimator" UNION ALL SELECT 7 AS nid, 16.229404817927968 AS "Estimator") AS "Values"), 
"DT_Output_3" AS 
...
"DT_node_data_4" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Estimator" AS FLOAT) AS "Estimator" 
FROM (SELECT 2 AS nid, -11.136731574114632 AS "Estimator" UNION ALL SELECT 6 AS nid, -3.5841937027194284 AS "Estimator" UNION ALL SELECT 7 AS nid, 19.062547238667808 AS "Estimator") AS "Values"), 
"DT_Output_4" AS 
...
"DT_node_data_5" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Estimator" AS FLOAT) AS "Estimator" 
FROM (SELECT 2 AS nid, -11.770608433087666 AS "Estimator" UNION ALL SELECT 6 AS nid, -3.5561132691502575 AS "Estimator" UNION ALL SELECT 7 AS nid, 17.68084326553345 AS "Estimator") AS "Values"), 
"DT_Output_5" AS 
...
"DT_node_data_6" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Estimator" AS FLOAT) AS "Estimator" 
FROM (SELECT 2 AS nid, -12.393895325837313 AS "Estimator" UNION ALL SELECT 6 AS nid, -4.50346630525589 AS "Estimator" UNION ALL SELECT 7 AS nid, 15.9722086923463 AS "Estimator") AS "Values"), 
"DT_Output_6" AS 
...
"DT_node_data_7" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Estimator" AS FLOAT) AS "Estimator" 
FROM (SELECT 2 AS nid, -9.802862705903896 AS "Estimator" UNION ALL SELECT 6 AS nid, -2.9632945515892724 AS "Estimator" UNION ALL SELECT 7 AS nid, 16.603741993506752 AS "Estimator") AS "Values"), 
"DT_Output_7" AS 
...
"DT_node_data_8" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Estimator" AS FLOAT) AS "Estimator" 
FROM (SELECT 2 AS nid, -10.479942186673483 AS "Estimator" UNION ALL SELECT 6 AS nid, -2.9925001220703127 AS "Estimator" UNION ALL SELECT 7 AS nid, 15.568430654525756 AS "Estimator") AS "Values"), 
"DT_Output_8" AS 
...
"DT_node_data_9" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Estimator" AS FLOAT) AS "Estimator" 
FROM (SELECT 2 AS nid, -10.968044874403212 AS "Estimator" UNION ALL SELECT 6 AS nid, -1.8452249623835089 AS "Estimator" UNION ALL SELECT 7 AS nid, 16.913542956397645 AS "Estimator") AS "Values"), 
"DT_Output_9" AS 
...
FROM "DT_Output_9")
 INSERT INTO "TMP_20180508184836_CODEGEN_ETGCYH_LGBM_B0" ("KEY", "Estimator") SELECT "LGBM_B0"."KEY", "LGBM_B0"."Estimator" 
...
-- Code For temporary table TMP_20180508184836_CODEGEN_62ROKY_LGBM_B1 part 1. Create 


CREATE TEMPORARY TABLE "TMP_20180508184836_CODEGEN_62ROKY_LGBM_B1" (
	"KEY" BIGINT, 
	"Estimator" FLOAT
)
...
-- Code For temporary table TMP_20180508184836_CODEGEN_62ROKY_LGBM_B1 part 2. Populate
...
"DT_node_data_10" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Estimator" AS FLOAT) AS "Estimator" 
FROM (SELECT 2 AS nid, -9.681227424939474 AS "Estimator" UNION ALL SELECT 6 AS nid, -2.085434001463431 AS "Estimator" UNION ALL SELECT 7 AS nid, 15.075806097362353 AS "Estimator") AS "Values"), 
"DT_Output_10" AS 
...
"DT_node_data_11" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Estimator" AS FLOAT) AS "Estimator" 
FROM (SELECT 2 AS nid, -10.14657541204382 AS "Estimator" UNION ALL SELECT 6 AS nid, -1.7300191707909107 AS "Estimator" UNION ALL SELECT 7 AS nid, 15.681816484246935 AS "Estimator") AS "Values"), 
"DT_Output_11" AS 
...
"DT_node_data_12" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Estimator" AS FLOAT) AS "Estimator" 
FROM (SELECT 2 AS nid, -8.942333932717641 AS "Estimator" UNION ALL SELECT 6 AS nid, -1.9510654467123527 AS "Estimator" UNION ALL SELECT 7 AS nid, 13.954295237168024 AS "Estimator") AS "Values"), 
"DT_Output_12" AS 
...
"DT_node_data_13" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Estimator" AS FLOAT) AS "Estimator" 
FROM (SELECT 2 AS nid, -9.386331801944308 AS "Estimator" UNION ALL SELECT 6 AS nid, -1.6227087751030922 AS "Estimator" UNION ALL SELECT 7 AS nid, 14.54084018298558 AS "Estimator") AS "Values"), 
"DT_Output_13" AS 
...
"DT_node_data_14" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Estimator" AS FLOAT) AS "Estimator" 
FROM (SELECT 3 AS nid, 8.862405347824097 AS "Estimator" UNION ALL SELECT 4 AS nid, -10.147826476324173 AS "Estimator" UNION ALL SELECT 5 AS nid, -1.130419070489945 AS "Estimator") AS "Values"), 
"DT_Output_14" AS 
...
"DT_node_data_15" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Estimator" AS FLOAT) AS "Estimator" 
FROM (SELECT 2 AS nid, -8.947397152582806 AS "Estimator" UNION ALL SELECT 6 AS nid, -1.2455032962741275 AS "Estimator" UNION ALL SELECT 7 AS nid, 14.134066591262817 AS "Estimator") AS "Values"), 
"DT_Output_15" AS 
...
FROM "DT_Output_15")
 INSERT INTO "TMP_20180508184836_CODEGEN_62ROKY_LGBM_B1" ("KEY", "Estimator") SELECT "LGBM_B1"."KEY", "LGBM_B1"."Estimator" 
...
-- Code For temporary table TMP_20180508184836_CODEGEN_7C7H3M_LGBM_Union part 1. Create 


CREATE TEMPORARY TABLE "TMP_20180508184836_CODEGEN_7C7H3M_LGBM_Union" (
	"KEY" BIGINT, 
	"Estimator" FLOAT
)
...
-- Code For temporary table TMP_20180508184836_CODEGEN_7C7H3M_LGBM_Union part 2. Populate

INSERT INTO "TMP_20180508184836_CODEGEN_7C7H3M_LGBM_Union" ("KEY", "Estimator") SELECT "LGBM_Union"."KEY", "LGBM_Union"."Estimator" 
...
FROM "TMP_20180508184836_CODEGEN_ETGCYH_LGBM_B0" AS "LGBM_B0" UNION ALL SELECT "LGBM_B1"."KEY" AS "KEY", "LGBM_B1"."Estimator" AS "Estimator" 
FROM "TMP_20180508184836_CODEGEN_62ROKY_LGBM_B1" AS "LGBM_B1") AS "LGBM_EnsembleUnion") AS "LGBM_Union"

-- Code For temporary table TMP_20180508184836_CODEGEN_0OX3GV_LGBM_sum part 1. Create 


CREATE TEMPORARY TABLE "TMP_20180508184836_CODEGEN_0OX3GV_LGBM_sum" (
	"KEY" BIGINT NOT NULL, 
	"Estimator" FLOAT, 
	PRIMARY KEY ("KEY")
)
...
-- Code For temporary table TMP_20180508184836_CODEGEN_0OX3GV_LGBM_sum part 2. Populate

INSERT INTO "TMP_20180508184836_CODEGEN_0OX3GV_LGBM_sum" ("KEY", "Estimator") SELECT "LGBM_sum"."KEY", "LGBM_sum"."Estimator" 
...
FROM "TMP_20180508184836_CODEGEN_7C7H3M_LGBM_Union" AS "LGBM_Union" GROUP BY "LGBM_Union"."KEY") AS "T") AS "LGBM_sum"

-- Code For temporary table TMP_20180508184836_CODEGEN_0OX3GV_LGBM_sum part 3. Create Index 

CREATE INDEX "ix_TMP_20180508184836_CODEGEN_0OX3GV_LGBM_sum_KEY" ON "TMP_20180508184836_CODEGEN_0OX3GV_LGBM_sum" ("KEY")

-- Model deployment code

SELECT "LGBM_sum"."KEY" AS "KEY", "LGBM_sum"."Estimator" AS "Estimator" 
FROM "TMP_20180508184836_CODEGEN_0OX3GV_LGBM_sum" AS "LGBM_sum"