...
-- Code For temporary table TMP_20180508184836_CODEGEN_QEL2QE_ADS_imp_1_OUT part 1. Create 


CREATE TEMPORARY TABLE `TMP_20180508184836_CODEGEN_QEL2QE_ADS_imp_1_OUT` (
	`KEY` BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20180508184836_CODEGEN_QEL2QE_ADS_imp_1_OUT part 2. Populate

INSERT INTO `TMP_20180508184836_CODEGEN_QEL2QE_ADS_imp_1_OUT` (`KEY`, imputer_output_2, imputer_output_3, imputer_output_4, imputer_output_5) SELECT `U`.`KEY`, `U`.imputer_output_2, `U`.imputer_output_3, `U`.imputer_output_4, `U`.imputer_output_5 
...
-- Code For temporary table TMP_20180508184836_CODEGEN_QEL2QE_ADS_imp_1_OUT part 3. Create Index 

CREATE INDEX `ix_TMP_20180508184836_CODEGEN_QEL2QE_ADS_imp_1_OUT_KEY` ON `TMP_20180508184836_CODEGEN_QEL2QE_ADS_imp_1_OUT` (`KEY`)

-- Code For temporary table TMP_20180508184836_CODEGEN_47DJ26_ADS_sca_2_OUT part 1. Create 


CREATE TEMPORARY TABLE `TMP_20180508184836_CODEGEN_47DJ26_ADS_sca_2_OUT` (
	`KEY` BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20180508184836_CODEGEN_47DJ26_ADS_sca_2_OUT part 2. Populate

INSERT INTO `TMP_20180508184836_CODEGEN_47DJ26_ADS_sca_2_OUT` (`KEY`, scaler_output_2, scaler_output_3, scaler_output_4, scaler_output_5) SELECT `U`.`KEY`, `U`.scaler_output_2, `U`.scaler_output_3, `U`.scaler_output_4, `U`.scaler_output_5 
...
FROM `TMP_20180508184836_CODEGEN_QEL2QE_ADS_imp_1_OUT` AS `ADS_imp_1_OUT`) AS `ADS_sca_2_OUT`) AS `U`

-- Code For temporary table TMP_20180508184836_CODEGEN_47DJ26_ADS_sca_2_OUT part 3. Create Index 

CREATE INDEX `ix_TMP_20180508184836_CODEGEN_47DJ26_ADS_sca_2_OUT_KEY` ON `TMP_20180508184836_CODEGEN_47DJ26_ADS_sca_2_OUT` (`KEY`)

-- Code For temporary table TMP_20180508184836_CODEGEN_SD76FP_LGBM_B0 part 1. Create 


CREATE TEMPORARY TABLE `TMP_20180508184836_CODEGEN_SD76FP_LGBM_B0` (
	`KEY` BIGINT, 
	`Estimator` DOUBLE
)
...
-- Code For temporary table TMP_20180508184836_CODEGEN_SD76FP_LGBM_B0 part 2. Populate

INSERT INTO `TMP_20180508184836_CODEGEN_SD76FP_LGBM_B0` (`KEY`, `Estimator`) SELECT `U`.`KEY`, `U`.`Estimator` 
...
FROM `TMP_20180508184836_CODEGEN_47DJ26_ADS_sca_2_OUT` AS `ADS_sca_2_OUT`), 
`DT_node_data` AS 
...
-- Code For temporary table TMP_20180508184836_CODEGEN_AR2AH9_LGBM_B1 part 1. Create 


CREATE TEMPORARY TABLE `TMP_20180508184836_CODEGEN_AR2AH9_LGBM_B1` (
	`KEY` BIGINT, 
	`Estimator` DOUBLE
)
...
-- Code For temporary table TMP_20180508184836_CODEGEN_AR2AH9_LGBM_B1 part 2. Populate

INSERT INTO `TMP_20180508184836_CODEGEN_AR2AH9_LGBM_B1` (`KEY`, `Estimator`) SELECT `U`.`KEY`, `U`.`Estimator` 
...
-- Code For temporary table TMP_20180508184836_CODEGEN_IGKYH8_LGBM_Union part 1. Create 


CREATE TEMPORARY TABLE `TMP_20180508184836_CODEGEN_IGKYH8_LGBM_Union` (
	`KEY` BIGINT, 
	`Estimator` DOUBLE
)
...
-- Code For temporary table TMP_20180508184836_CODEGEN_IGKYH8_LGBM_Union part 2. Populate

INSERT INTO `TMP_20180508184836_CODEGEN_IGKYH8_LGBM_Union` (`KEY`, `Estimator`) SELECT `U`.`KEY`, `U`.`Estimator` 
...
FROM `TMP_20180508184836_CODEGEN_SD76FP_LGBM_B0` AS `LGBM_B0` UNION ALL SELECT `LGBM_B1`.`KEY` AS `KEY`, `LGBM_B1`.`Estimator` AS `Estimator` 
FROM `TMP_20180508184836_CODEGEN_AR2AH9_LGBM_B1` AS `LGBM_B1`) AS `LGBM_EnsembleUnion`) AS `LGBM_Union`) AS `U`

-- Code For temporary table TMP_20180508184836_CODEGEN_X7A0TU_LGBM_sum part 1. Create 


CREATE TEMPORARY TABLE `TMP_20180508184836_CODEGEN_X7A0TU_LGBM_sum` (
	`KEY` BIGINT NOT NULL, 
	`Estimator` DOUBLE, 
	PRIMARY KEY (`KEY`)
)
...
-- Code For temporary table TMP_20180508184836_CODEGEN_X7A0TU_LGBM_sum part 2. Populate

INSERT INTO `TMP_20180508184836_CODEGEN_X7A0TU_LGBM_sum` (`KEY`, `Estimator`) SELECT `U`.`KEY`, `U`.`Estimator` 
...
FROM `TMP_20180508184836_CODEGEN_IGKYH8_LGBM_Union` AS `LGBM_Union` GROUP BY `LGBM_Union`.`KEY`) AS `T`) AS `LGBM_sum`) AS `U`

-- Code For temporary table TMP_20180508184836_CODEGEN_X7A0TU_LGBM_sum part 3. Create Index 

CREATE INDEX `ix_TMP_20180508184836_CODEGEN_X7A0TU_LGBM_sum_KEY` ON `TMP_20180508184836_CODEGEN_X7A0TU_LGBM_sum` (`KEY`)

-- Model deployment code

SELECT `LGBM_sum`.`KEY` AS `KEY`, `LGBM_sum`.`Estimator` AS `Estimator` 
FROM `TMP_20180508184836_CODEGEN_X7A0TU_LGBM_sum` AS `LGBM_sum`