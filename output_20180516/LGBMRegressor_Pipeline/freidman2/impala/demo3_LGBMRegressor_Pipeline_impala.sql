...
-- Code For temporary table tmp_20180508194722_codegen_o325dl_ads_imp_1_out part 1. Create 


CREATE TABLE tmp_20180508194722_codegen_o325dl_ads_imp_1_out (
	`KEY` BIGINT, 
...
-- Code For temporary table tmp_20180508194722_codegen_o325dl_ads_imp_1_out part 2. Populate

INSERT INTO tmp_20180508194722_codegen_o325dl_ads_imp_1_out (`KEY`, imputer_output_2, imputer_output_3, imputer_output_4, imputer_output_5) SELECT `ADS_imp_1_OUT`.`KEY`, `ADS_imp_1_OUT`.imputer_output_2, `ADS_imp_1_OUT`.imputer_output_3, `ADS_imp_1_OUT`.imputer_output_4, `ADS_imp_1_OUT`.imputer_output_5 
...
-- Code For temporary table tmp_20180508194722_codegen_i6ax1h_ads_sca_2_out part 1. Create 


CREATE TABLE tmp_20180508194722_codegen_i6ax1h_ads_sca_2_out (
	`KEY` BIGINT, 
...
-- Code For temporary table tmp_20180508194722_codegen_i6ax1h_ads_sca_2_out part 2. Populate

INSERT INTO tmp_20180508194722_codegen_i6ax1h_ads_sca_2_out (`KEY`, scaler_output_2, scaler_output_3, scaler_output_4, scaler_output_5) SELECT `ADS_sca_2_OUT`.`KEY`, `ADS_sca_2_OUT`.scaler_output_2, `ADS_sca_2_OUT`.scaler_output_3, `ADS_sca_2_OUT`.scaler_output_4, `ADS_sca_2_OUT`.scaler_output_5 
...
FROM tmp_20180508194722_codegen_o325dl_ads_imp_1_out AS `ADS_imp_1_OUT`) AS `ADS_sca_2_OUT`

-- Code For temporary table tmp_20180508194722_codegen_xl22q9_lgbm_b0 part 1. Create 


CREATE TABLE tmp_20180508194722_codegen_xl22q9_lgbm_b0 (
	`KEY` BIGINT, 
	`Estimator` DOUBLE
)
...
-- Code For temporary table tmp_20180508194722_codegen_xl22q9_lgbm_b0 part 2. Populate
...
FROM tmp_20180508194722_codegen_i6ax1h_ads_sca_2_out AS `ADS_sca_2_OUT`), 
`DT_node_data` AS 
...
FROM `DT_Output_9`)
 INSERT INTO tmp_20180508194722_codegen_xl22q9_lgbm_b0 (`KEY`, `Estimator`) SELECT `LGBM_B0`.`KEY`, `LGBM_B0`.`Estimator` 
...
-- Code For temporary table tmp_20180508194722_codegen_48f1f0_lgbm_b1 part 1. Create 


CREATE TABLE tmp_20180508194722_codegen_48f1f0_lgbm_b1 (
	`KEY` BIGINT, 
	`Estimator` DOUBLE
)
...
-- Code For temporary table tmp_20180508194722_codegen_48f1f0_lgbm_b1 part 2. Populate
...
FROM `DT_Output_15`)
 INSERT INTO tmp_20180508194722_codegen_48f1f0_lgbm_b1 (`KEY`, `Estimator`) SELECT `LGBM_B1`.`KEY`, `LGBM_B1`.`Estimator` 
...
-- Code For temporary table tmp_20180508194722_codegen_s1evwe_lgbm_union part 1. Create 


CREATE TABLE tmp_20180508194722_codegen_s1evwe_lgbm_union (
	`KEY` BIGINT, 
	`Estimator` DOUBLE
)
...
-- Code For temporary table tmp_20180508194722_codegen_s1evwe_lgbm_union part 2. Populate

INSERT INTO tmp_20180508194722_codegen_s1evwe_lgbm_union (`KEY`, `Estimator`) SELECT `LGBM_Union`.`KEY`, `LGBM_Union`.`Estimator` 
...
FROM tmp_20180508194722_codegen_xl22q9_lgbm_b0 AS `LGBM_B0` UNION ALL SELECT `LGBM_B1`.`KEY` AS `KEY`, `LGBM_B1`.`Estimator` AS `Estimator` 
FROM tmp_20180508194722_codegen_48f1f0_lgbm_b1 AS `LGBM_B1`) AS `LGBM_EnsembleUnion`) AS `LGBM_Union`

-- Code For temporary table tmp_20180508194722_codegen_bkl5pd_lgbm_sum part 1. Create 


CREATE TABLE tmp_20180508194722_codegen_bkl5pd_lgbm_sum (
	`KEY` BIGINT, 
	`Estimator` DOUBLE
)
...
-- Code For temporary table tmp_20180508194722_codegen_bkl5pd_lgbm_sum part 2. Populate

INSERT INTO tmp_20180508194722_codegen_bkl5pd_lgbm_sum (`KEY`, `Estimator`) SELECT `LGBM_sum`.`KEY`, `LGBM_sum`.`Estimator` 
...
FROM tmp_20180508194722_codegen_s1evwe_lgbm_union AS `LGBM_Union` GROUP BY `LGBM_Union`.`KEY`) AS `T`) AS `LGBM_sum`

-- Model deployment code

SELECT `LGBM_sum`.`KEY` AS `KEY`, `LGBM_sum`.`Estimator` AS `Estimator` 
FROM tmp_20180508194722_codegen_bkl5pd_lgbm_sum AS `LGBM_sum`