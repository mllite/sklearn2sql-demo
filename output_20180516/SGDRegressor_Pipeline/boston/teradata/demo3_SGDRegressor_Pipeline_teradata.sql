...
-- Code For temporary table tmp_20180516114941_codegen_3e1j80_ads_imp_1_out part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180516114941_codegen_3e1j80_ads_imp_1_out  (
	"KEY" BIGINT, 
...
-- Code For temporary table tmp_20180516114941_codegen_qzjbc8_ads_sca_2_out part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180516114941_codegen_qzjbc8_ads_sca_2_out  (
	"KEY" BIGINT, 
...
FROM tmp_20180516114941_codegen_3e1j80_ads_imp_1_out AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT") AS "U"
...
FROM tmp_20180516114941_codegen_qzjbc8_ads_sca_2_out AS "ADS_sca_2_OUT"), 
linear_model_cte AS 
