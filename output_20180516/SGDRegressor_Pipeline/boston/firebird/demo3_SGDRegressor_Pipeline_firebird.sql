...
-- Code For temporary table TMP_20180508183126_CODEGEN_61W1 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508183126_CODEGEN_61W1" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20180508183126_CODEGEN_61W1 part 2. Populate

INSERT INTO "TMP_20180508183126_CODEGEN_61W1" ("KEY", impter_2, impter_3, impter_4, impter_5, impter_6, impter_7, impter_8, impter_9, impter_10, impter_11, impter_12, impter_13, impter_14) SELECT "U"."KEY", "U".impter_2, "U".impter_3, "U".impter_4, "U".impter_5, "U".impter_6, "U".impter_7, "U".impter_8, "U".impter_9, "U".impter_10, "U".impter_11, "U".impter_12, "U".impter_13, "U".impter_14 
...
-- Code For temporary table TMP_20180508183126_CODEGEN_61W1 part 3. Create Index 

CREATE INDEX "ix_TMP_20180508183126_C_c28c" ON "TMP_20180508183126_CODEGEN_61W1" ("KEY")

-- Code For temporary table TMP_20180508183126_CODEGEN_YFQQ part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508183126_CODEGEN_YFQQ" (
	"KEY" BIGINT NOT NULL, 
...
FROM "TMP_20180508183126_CODEGEN_61W1" AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT") AS "U"

-- Code For temporary table TMP_20180508183126_CODEGEN_YFQQ part 3. Create Index 

CREATE INDEX "ix_TMP_20180508183126_C_788c" ON "TMP_20180508183126_CODEGEN_YFQQ" ("KEY")
...
FROM "TMP_20180508183126_CODEGEN_YFQQ" AS "ADS_sca_2_OUT"), 
linear_model_cte AS 
