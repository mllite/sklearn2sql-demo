...
-- Code For temporary table ##TMP_20180508185311_CODEGEN_VJAJGW_ADS_imp_1_OUT part 1. Create 


CREATE TABLE ##TMP_20180508185311_CODEGEN_VJAJGW_ADS_imp_1_OUT (
	[KEY] BIGINT NULL, 
...
-- Code For temporary table ##TMP_20180508185311_CODEGEN_VJAJGW_ADS_imp_1_OUT part 2. Populate

INSERT INTO ##TMP_20180508185311_CODEGEN_VJAJGW_ADS_imp_1_OUT ([KEY], imputer_output_2, imputer_output_3, imputer_output_4, imputer_output_5) SELECT [ADS_imp_1_OUT].[KEY], [ADS_imp_1_OUT].imputer_output_2, [ADS_imp_1_OUT].imputer_output_3, [ADS_imp_1_OUT].imputer_output_4, [ADS_imp_1_OUT].imputer_output_5 
...
-- Code For temporary table ##TMP_20180508185311_CODEGEN_6811Z0_ADS_sca_2_OUT part 1. Create 


CREATE TABLE ##TMP_20180508185311_CODEGEN_6811Z0_ADS_sca_2_OUT (
	[KEY] BIGINT NULL, 
...
-- Code For temporary table ##TMP_20180508185311_CODEGEN_6811Z0_ADS_sca_2_OUT part 2. Populate

INSERT INTO ##TMP_20180508185311_CODEGEN_6811Z0_ADS_sca_2_OUT ([KEY], scaler_output_2, scaler_output_3, scaler_output_4, scaler_output_5) SELECT [ADS_sca_2_OUT].[KEY], [ADS_sca_2_OUT].scaler_output_2, [ADS_sca_2_OUT].scaler_output_3, [ADS_sca_2_OUT].scaler_output_4, [ADS_sca_2_OUT].scaler_output_5 
...
FROM ##TMP_20180508185311_CODEGEN_VJAJGW_ADS_imp_1_OUT AS [ADS_imp_1_OUT]) AS [ADS_sca_2_OUT]
...
FROM ##TMP_20180508185311_CODEGEN_6811Z0_ADS_sca_2_OUT AS [ADS_sca_2_OUT]), 
linear_model_cte AS 
