...
-- Code For temporary table TMP_20180516_CODEGEN_3JF22C_ADS part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180516_CODEGEN_3JF22C_ADS" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20180516_CODEGEN_3JF22C_ADS part 3. Create Index 

CREATE INDEX "ix_TMP_20180516_CODEGEN_eebb" ON "TMP_20180516_CODEGEN_3JF22C_ADS" ("KEY")

-- Code For temporary table TMP_20180516_CODEGEN_L7FI8Q_ADS part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180516_CODEGEN_L7FI8Q_ADS" (
	"KEY" BIGINT NOT NULL, 
...
FROM "TMP_20180516_CODEGEN_3JF22C_ADS" AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT") AS "U"

-- Code For temporary table TMP_20180516_CODEGEN_L7FI8Q_ADS part 3. Create Index 

CREATE INDEX "ix_TMP_20180516_CODEGEN_d786" ON "TMP_20180516_CODEGEN_L7FI8Q_ADS" ("KEY")
...
FROM "TMP_20180516_CODEGEN_L7FI8Q_ADS" AS "ADS_sca_2_OUT"), 
linear_model_cte AS 
