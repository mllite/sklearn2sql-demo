...
-- Code For temporary table tmp_20180508182331_codegen_0a90ao_ads_imp_1_out part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180508182331_codegen_0a90ao_ads_imp_1_out  (
	"KEY" BIGINT, 
...
-- Code For temporary table tmp_20180508182331_codegen_0a90ao_ads_imp_1_out part 2. Populate

INSERT INTO tmp_20180508182331_codegen_0a90ao_ads_imp_1_out ("KEY", impter_2, impter_3, impter_4, impter_5, impter_6, impter_7, impter_8, impter_9, impter_10, impter_11) SELECT "U"."KEY", "U".impter_2, "U".impter_3, "U".impter_4, "U".impter_5, "U".impter_6, "U".impter_7, "U".impter_8, "U".impter_9, "U".impter_10, "U".impter_11 
...
-- Code For temporary table tmp_20180508182331_codegen_l99sxk_ads_sca_2_out part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180508182331_codegen_l99sxk_ads_sca_2_out  (
	"KEY" BIGINT, 
...
-- Code For temporary table tmp_20180508182331_codegen_l99sxk_ads_sca_2_out part 2. Populate

INSERT INTO tmp_20180508182331_codegen_l99sxk_ads_sca_2_out ("KEY", scaler_2, scaler_3, scaler_4, scaler_5, scaler_6, scaler_7, scaler_8, scaler_9, scaler_10, scaler_11) SELECT "U"."KEY", "U".scaler_2, "U".scaler_3, "U".scaler_4, "U".scaler_5, "U".scaler_6, "U".scaler_7, "U".scaler_8, "U".scaler_9, "U".scaler_10, "U".scaler_11 
...
FROM tmp_20180508182331_codegen_0a90ao_ads_imp_1_out AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT") AS "U"
...
FROM tmp_20180508182331_codegen_l99sxk_ads_sca_2_out AS "ADS_sca_2_OUT"), 
linear_model_cte AS 
(SELECT linear_input."KEY" AS "KEY", CAST(27.47234926415581 AS DOUBLE PRECISION) * linear_input.scaler_2 + CAST(55.058999608561706 AS DOUBLE PRECISION) * linear_input.scaler_3 + CAST(66.05234096939769 AS DOUBLE PRECISION) * linear_input.scaler_4 + CAST(33.828318306544865 AS DOUBLE PRECISION) * linear_input.scaler_5 + CAST(43.37201281310904 AS DOUBLE PRECISION) * linear_input.scaler_6 + CAST(55.56899634206041 AS DOUBLE PRECISION) * linear_input.scaler_7 + CAST(22.84541388462431 AS DOUBLE PRECISION) * linear_input.scaler_8 + CAST(32.642963122076885 AS DOUBLE PRECISION) * linear_input.scaler_9 + CAST(68.23784430018478 AS DOUBLE PRECISION) * linear_input.scaler_10 + CAST(28.597451330145503 AS DOUBLE PRECISION) * linear_input.scaler_11 + CAST(17.846455791454694 AS DOUBLE PRECISION) AS "Estimator" 
FROM linear_input)
