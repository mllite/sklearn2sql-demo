...
-- Code For temporary table tmp_20180516115501_codegen_brslg4_ads_imp_1_out part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180516115501_codegen_brslg4_ads_imp_1_out  (
	"KEY" BIGINT, 
...
-- Code For temporary table tmp_20180516115501_codegen_brslg4_ads_imp_1_out part 2. Populate

INSERT INTO tmp_20180516115501_codegen_brslg4_ads_imp_1_out ("KEY", impter_2, impter_3, impter_4, impter_5, impter_6, impter_7, impter_8, impter_9, impter_10, impter_11) SELECT "U"."KEY", "U".impter_2, "U".impter_3, "U".impter_4, "U".impter_5, "U".impter_6, "U".impter_7, "U".impter_8, "U".impter_9, "U".impter_10, "U".impter_11 
...
-- Code For temporary table tmp_20180516115501_codegen_bah6nd_ads_sca_2_out part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180516115501_codegen_bah6nd_ads_sca_2_out  (
	"KEY" BIGINT, 
...
-- Code For temporary table tmp_20180516115501_codegen_bah6nd_ads_sca_2_out part 2. Populate

INSERT INTO tmp_20180516115501_codegen_bah6nd_ads_sca_2_out ("KEY", scaler_2, scaler_3, scaler_4, scaler_5, scaler_6, scaler_7, scaler_8, scaler_9, scaler_10, scaler_11) SELECT "U"."KEY", "U".scaler_2, "U".scaler_3, "U".scaler_4, "U".scaler_5, "U".scaler_6, "U".scaler_7, "U".scaler_8, "U".scaler_9, "U".scaler_10, "U".scaler_11 
...
FROM tmp_20180516115501_codegen_brslg4_ads_imp_1_out AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT") AS "U"
...
FROM tmp_20180516115501_codegen_bah6nd_ads_sca_2_out AS "ADS_sca_2_OUT"), 
linear_model_cte AS 
(SELECT linear_input."KEY" AS "KEY", CAST(-0.242463776609534 AS DOUBLE PRECISION) * linear_input.scaler_2 + CAST(-10.618748891714944 AS DOUBLE PRECISION) * linear_input.scaler_3 + CAST(23.679863091516292 AS DOUBLE PRECISION) * linear_input.scaler_4 + CAST(14.034052304047412 AS DOUBLE PRECISION) * linear_input.scaler_5 + CAST(-2.591970076308286 AS DOUBLE PRECISION) * linear_input.scaler_6 + CAST(-6.98451869475154 AS DOUBLE PRECISION) * linear_input.scaler_7 + CAST(-10.707911970680266 AS DOUBLE PRECISION) * linear_input.scaler_8 + CAST(4.290575492034916 AS DOUBLE PRECISION) * linear_input.scaler_9 + CAST(21.931423939628292 AS DOUBLE PRECISION) * linear_input.scaler_10 + CAST(4.522242711225028 AS DOUBLE PRECISION) * linear_input.scaler_11 + CAST(150.13677355116624 AS DOUBLE PRECISION) AS "Estimator" 
FROM linear_input)
