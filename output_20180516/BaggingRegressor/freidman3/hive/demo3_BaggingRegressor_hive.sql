...
-- Code For temporary table tmp_20180516121650_codegen_7eazwy_bag_b0 part 1. Create 

CREATE TEMPORARY TABLE `tmp_20180516121650_codegen_7eazwy_bag_b0` STORED AS ORC AS WITH `DT_node_lookup` AS 
...
-- Code For temporary table tmp_20180516121650_codegen_7eazwy_bag_b0 part 2. Populate

SELECT * FROM `tmp_20180516121650_codegen_7eazwy_bag_b0`

-- Code For temporary table tmp_20180516121650_codegen_626762_bag_b1 part 1. Create 

CREATE TEMPORARY TABLE `tmp_20180516121650_codegen_626762_bag_b1` STORED AS ORC AS WITH `DT_node_lookup_10` AS 
...
-- Code For temporary table tmp_20180516121650_codegen_626762_bag_b1 part 2. Populate

SELECT * FROM `tmp_20180516121650_codegen_626762_bag_b1`

-- Code For temporary table tmp_20180516121650_codegen_tti7f8_bag_avg part 1. Create 

CREATE TEMPORARY TABLE `tmp_20180516121650_codegen_tti7f8_bag_avg` STORED AS ORC AS WITH `BAG_Union` AS 
...
FROM `tmp_20180516121650_codegen_7eazwy_bag_b0` AS `BAG_B0` UNION ALL SELECT `BAG_B1`.`KEY` AS `KEY`, `BAG_B1`.`Estimator` AS `Estimator` 
FROM `tmp_20180516121650_codegen_626762_bag_b1` AS `BAG_B1`) AS `BAG_EnsembleUnion`)
...
-- Code For temporary table tmp_20180516121650_codegen_tti7f8_bag_avg part 2. Populate

SELECT * FROM `tmp_20180516121650_codegen_tti7f8_bag_avg`

-- Model deployment code

SELECT `BAG_avg`.`KEY` AS `KEY`, `BAG_avg`.`Estimator` AS `Estimator` 
FROM `tmp_20180516121650_codegen_tti7f8_bag_avg` AS `BAG_avg`