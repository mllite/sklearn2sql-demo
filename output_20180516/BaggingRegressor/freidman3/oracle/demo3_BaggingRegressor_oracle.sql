...
-- Code For temporary table 5101_CODEGEN_H9MM5E_BAG_B0 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "5101_CODEGEN_H9MM5E_BAG_B0" (
	"KEY" NUMBER(19), 
...
-- Code For temporary table 5101_CODEGEN_H9MM5E_BAG_B0 part 2. Populate

INSERT INTO "5101_CODEGEN_H9MM5E_BAG_B0" ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
-- Code For temporary table 5101_CODEGEN_1DKALR_BAG_B1 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "5101_CODEGEN_1DKALR_BAG_B1" (
	"KEY" NUMBER(19), 
	"Estimator" BINARY_DOUBLE
)
...
-- Code For temporary table 5101_CODEGEN_1DKALR_BAG_B1 part 2. Populate

INSERT INTO "5101_CODEGEN_1DKALR_BAG_B1" ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
-- Code For temporary table 1_CODEGEN_EIZPJ8_BAG_UNION part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "1_CODEGEN_EIZPJ8_BAG_UNION" (
	"KEY" NUMBER(19), 
	"Estimator" BINARY_DOUBLE
)
...
-- Code For temporary table 1_CODEGEN_EIZPJ8_BAG_UNION part 2. Populate

INSERT INTO "1_CODEGEN_EIZPJ8_BAG_UNION" ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
FROM "5101_CODEGEN_H9MM5E_BAG_B0" "BAG_B0" UNION ALL SELECT "BAG_B1"."KEY" AS "KEY", "BAG_B1"."Estimator" AS "Estimator" 
FROM "5101_CODEGEN_1DKALR_BAG_B1" "BAG_B1") "BAG_EnsembleUnion") "BAG_Union") "U"

-- Code For temporary table 101_CODEGEN_5TKT4Z_BAG_AVG part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "101_CODEGEN_5TKT4Z_BAG_AVG" (
	"KEY" NUMBER(19), 
	"Estimator" BINARY_DOUBLE
)
...
-- Code For temporary table 101_CODEGEN_5TKT4Z_BAG_AVG part 2. Populate

INSERT INTO "101_CODEGEN_5TKT4Z_BAG_AVG" ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
FROM "1_CODEGEN_EIZPJ8_BAG_UNION" "BAG_Union" GROUP BY "BAG_Union"."KEY") "T") "BAG_avg") "U"

-- Model deployment code

SELECT "BAG_avg"."KEY" AS "KEY", "BAG_avg"."Estimator" AS "Estimator" 
FROM "101_CODEGEN_5TKT4Z_BAG_AVG" "BAG_avg"