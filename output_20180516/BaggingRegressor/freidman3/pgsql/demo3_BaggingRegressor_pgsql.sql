...
-- Code For temporary table TMP_20180516121650_CODEGEN_DEFN2K_BAG_B0 part 1. Create 


CREATE TEMPORARY TABLE "TMP_20180516121650_CODEGEN_DEFN2K_BAG_B0" (
	"KEY" BIGINT, 
	"Estimator" FLOAT
)
...
-- Code For temporary table TMP_20180516121650_CODEGEN_DEFN2K_BAG_B0 part 2. Populate
...
FROM "DT_Output_9")
 INSERT INTO "TMP_20180516121650_CODEGEN_DEFN2K_BAG_B0" ("KEY", "Estimator") SELECT "BAG_B0"."KEY", "BAG_B0"."Estimator" 
...
-- Code For temporary table TMP_20180516121650_CODEGEN_BLJVOR_BAG_B1 part 1. Create 


CREATE TEMPORARY TABLE "TMP_20180516121650_CODEGEN_BLJVOR_BAG_B1" (
	"KEY" BIGINT, 
	"Estimator" FLOAT
)
...
-- Code For temporary table TMP_20180516121650_CODEGEN_BLJVOR_BAG_B1 part 2. Populate
...
FROM "DT_Output_15")
 INSERT INTO "TMP_20180516121650_CODEGEN_BLJVOR_BAG_B1" ("KEY", "Estimator") SELECT "BAG_B1"."KEY", "BAG_B1"."Estimator" 
...
-- Code For temporary table TMP_20180516121650_CODEGEN_S8QFTT_BAG_avg part 1. Create 


CREATE TEMPORARY TABLE "TMP_20180516121650_CODEGEN_S8QFTT_BAG_avg" (
	"KEY" BIGINT NOT NULL, 
	"Estimator" FLOAT, 
	PRIMARY KEY ("KEY")
)
...
-- Code For temporary table TMP_20180516121650_CODEGEN_S8QFTT_BAG_avg part 2. Populate
...
FROM "TMP_20180516121650_CODEGEN_DEFN2K_BAG_B0" AS "BAG_B0" UNION ALL SELECT "BAG_B1"."KEY" AS "KEY", "BAG_B1"."Estimator" AS "Estimator" 
FROM "TMP_20180516121650_CODEGEN_BLJVOR_BAG_B1" AS "BAG_B1") AS "BAG_EnsembleUnion")
 INSERT INTO "TMP_20180516121650_CODEGEN_S8QFTT_BAG_avg" ("KEY", "Estimator") SELECT "BAG_avg"."KEY", "BAG_avg"."Estimator" 
...
-- Code For temporary table TMP_20180516121650_CODEGEN_S8QFTT_BAG_avg part 3. Create Index 

CREATE INDEX "ix_TMP_20180516121650_CODEGEN_S8QFTT_BAG_avg_KEY" ON "TMP_20180516121650_CODEGEN_S8QFTT_BAG_avg" ("KEY")

-- Model deployment code

SELECT "BAG_avg"."KEY" AS "KEY", "BAG_avg"."Estimator" AS "Estimator" 
FROM "TMP_20180516121650_CODEGEN_S8QFTT_BAG_avg" AS "BAG_avg"