...
-- Code For temporary table tmp_20180516121650_codegen_s6unzw_bag_b0 part 1. Create 


CREATE TEMPORARY TABLE tmp_20180516121650_codegen_s6unzw_bag_b0 (
	"KEY" BIGINT, 
	"Estimator" DOUBLE
)
...
-- Code For temporary table tmp_20180516121650_codegen_s6unzw_bag_b0 part 2. Populate

INSERT INTO tmp_20180516121650_codegen_s6unzw_bag_b0 ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
-- Code For temporary table tmp_20180516121650_codegen_tualmz_bag_b1 part 1. Create 


CREATE TEMPORARY TABLE tmp_20180516121650_codegen_tualmz_bag_b1 (
	"KEY" BIGINT, 
	"Estimator" DOUBLE
)
...
-- Code For temporary table tmp_20180516121650_codegen_tualmz_bag_b1 part 2. Populate

INSERT INTO tmp_20180516121650_codegen_tualmz_bag_b1 ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
-- Code For temporary table tmp_20180516121650_codegen_ibg4o6_bag_avg part 1. Create 


CREATE TEMPORARY TABLE tmp_20180516121650_codegen_ibg4o6_bag_avg (
	"KEY" BIGINT, 
	"Estimator" DOUBLE
)
...
-- Code For temporary table tmp_20180516121650_codegen_ibg4o6_bag_avg part 2. Populate

INSERT INTO tmp_20180516121650_codegen_ibg4o6_bag_avg ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
FROM tmp_20180516121650_codegen_s6unzw_bag_b0 AS "BAG_B0" UNION ALL SELECT "BAG_B1"."KEY" AS "KEY", "BAG_B1"."Estimator" AS "Estimator" 
FROM tmp_20180516121650_codegen_tualmz_bag_b1 AS "BAG_B1") AS "BAG_EnsembleUnion")
...
FROM tmp_20180516121650_codegen_ibg4o6_bag_avg AS "BAG_avg"