...
-- Code For temporary table tmp_20180602152108_5dz_bag_b0 part 1. Create 


CREATE TABLE tmp_20180602152108_5dz_bag_b0 (
	`KEY` BIGINT, 
	`Estimator` DOUBLE
)
...
-- Code For temporary table tmp_20180602152108_5dz_bag_b0 part 2. Populate
...
FROM `DT_Output_9`)
 INSERT INTO tmp_20180602152108_5dz_bag_b0 (`KEY`, `Estimator`) SELECT `BAG_B0`.`KEY`, `BAG_B0`.`Estimator` 
...
-- Code For temporary table tmp_20180602152108_kgn_bag_b1 part 1. Create 


CREATE TABLE tmp_20180602152108_kgn_bag_b1 (
	`KEY` BIGINT, 
	`Estimator` DOUBLE
)
...
-- Code For temporary table tmp_20180602152108_kgn_bag_b1 part 2. Populate
...
FROM `DT_Output_15`)
 INSERT INTO tmp_20180602152108_kgn_bag_b1 (`KEY`, `Estimator`) SELECT `BAG_B1`.`KEY`, `BAG_B1`.`Estimator` 
...
-- Code For temporary table tmp_20180602152108_8xb_bag_avg part 1. Create 


CREATE TABLE tmp_20180602152108_8xb_bag_avg (
	`KEY` BIGINT, 
	`Estimator` DOUBLE
)
...
-- Code For temporary table tmp_20180602152108_8xb_bag_avg part 2. Populate
...
FROM tmp_20180602152108_5dz_bag_b0 AS `BAG_B0` UNION ALL SELECT `BAG_B1`.`KEY` AS `KEY`, `BAG_B1`.`Estimator` AS `Estimator` 
FROM tmp_20180602152108_kgn_bag_b1 AS `BAG_B1`) AS `BAG_EnsembleUnion`)
 INSERT INTO tmp_20180602152108_8xb_bag_avg (`KEY`, `Estimator`) SELECT `BAG_avg`.`KEY`, `BAG_avg`.`Estimator` 
...
FROM tmp_20180602152108_8xb_bag_avg AS `BAG_avg`