...
-- Code For temporary table ##TMP_20180602152109_M6M_BAG_B0 part 1. Create 


CREATE TABLE ##TMP_20180602152109_M6M_BAG_B0 (
	[KEY] BIGINT NULL, 
...
-- Code For temporary table ##TMP_20180602152109_M6M_BAG_B0 part 2. Populate
...
FROM [DT_Output_9])
 INSERT INTO ##TMP_20180602152109_M6M_BAG_B0 ([KEY], [Estimator]) SELECT [BAG_B0].[KEY], [BAG_B0].[Estimator] 
...
-- Code For temporary table ##TMP_20180602152109_2F1_BAG_B1 part 1. Create 


CREATE TABLE ##TMP_20180602152109_2F1_BAG_B1 (
	[KEY] BIGINT NULL, 
	[Estimator] FLOAT(53) NULL
)
...
-- Code For temporary table ##TMP_20180602152109_2F1_BAG_B1 part 2. Populate
...
FROM [DT_Output_15])
 INSERT INTO ##TMP_20180602152109_2F1_BAG_B1 ([KEY], [Estimator]) SELECT [BAG_B1].[KEY], [BAG_B1].[Estimator] 
...
-- Code For temporary table ##TMP_20180602152109_OBA_BAG_avg part 1. Create 


CREATE TABLE ##TMP_20180602152109_OBA_BAG_avg (
	[KEY] BIGINT NULL, 
	[Estimator] FLOAT(53) NULL
)
...
-- Code For temporary table ##TMP_20180602152109_OBA_BAG_avg part 2. Populate
...
FROM ##TMP_20180602152109_M6M_BAG_B0 AS [BAG_B0] UNION ALL SELECT [BAG_B1].[KEY] AS [KEY], [BAG_B1].[Estimator] AS [Estimator] 
FROM ##TMP_20180602152109_2F1_BAG_B1 AS [BAG_B1]) AS [BAG_EnsembleUnion])
 INSERT INTO ##TMP_20180602152109_OBA_BAG_avg ([KEY], [Estimator]) SELECT [BAG_avg].[KEY], [BAG_avg].[Estimator] 
...
FROM ##TMP_20180602152109_OBA_BAG_avg AS [BAG_avg]