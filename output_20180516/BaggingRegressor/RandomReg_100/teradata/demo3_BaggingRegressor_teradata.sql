...
-- Code For temporary table tmp_20180516114056_codegen_a0zq2v_bag_b0 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180516114056_codegen_a0zq2v_bag_b0  (
	"KEY" BIGINT, 
...
-- Code For temporary table tmp_20180516114056_codegen_a0zq2v_bag_b0 part 2. Populate

INSERT INTO tmp_20180516114056_codegen_a0zq2v_bag_b0 ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
-- Code For temporary table tmp_20180516114056_codegen_puz27g_bag_b1 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180516114056_codegen_puz27g_bag_b1  (
	"KEY" BIGINT, 
	"Estimator" DOUBLE PRECISION
)
...
-- Code For temporary table tmp_20180516114056_codegen_puz27g_bag_b1 part 2. Populate

INSERT INTO tmp_20180516114056_codegen_puz27g_bag_b1 ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
-- Code For temporary table tmp_20180516114056_codegen_quvhv4_bag_avg part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180516114056_codegen_quvhv4_bag_avg  (
	"KEY" BIGINT, 
	"Estimator" DOUBLE PRECISION
)
...
-- Code For temporary table tmp_20180516114056_codegen_quvhv4_bag_avg part 2. Populate

INSERT INTO tmp_20180516114056_codegen_quvhv4_bag_avg ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
FROM tmp_20180516114056_codegen_a0zq2v_bag_b0 AS "BAG_B0" UNION ALL SELECT "BAG_B1"."KEY" AS "KEY", "BAG_B1"."Estimator" AS "Estimator" 
FROM tmp_20180516114056_codegen_puz27g_bag_b1 AS "BAG_B1") AS "BAG_EnsembleUnion")
...
FROM tmp_20180516114056_codegen_quvhv4_bag_avg AS "BAG_avg"