...
-- Code For temporary table tmp_20180516123752_codegen_mhwgxu_ads_imp_1_out part 1. Create 

CREATE TEMPORARY TABLE `tmp_20180516123752_codegen_mhwgxu_ads_imp_1_out` STORED AS ORC AS SELECT `ADS_imp_1_OUT`.`KEY`, `ADS_imp_1_OUT`.`imputer_output_2`, `ADS_imp_1_OUT`.`imputer_output_3`, `ADS_imp_1_OUT`.`imputer_output_4`, `ADS_imp_1_OUT`.`imputer_output_5` 
...
-- Code For temporary table tmp_20180516123752_codegen_mhwgxu_ads_imp_1_out part 2. Populate

SELECT * FROM `tmp_20180516123752_codegen_mhwgxu_ads_imp_1_out`

-- Code For temporary table tmp_20180516123752_codegen_469ejs_ads_sca_2_out part 1. Create 

CREATE TEMPORARY TABLE `tmp_20180516123752_codegen_469ejs_ads_sca_2_out` STORED AS ORC AS SELECT `ADS_sca_2_OUT`.`KEY`, `ADS_sca_2_OUT`.`scaler_output_2`, `ADS_sca_2_OUT`.`scaler_output_3`, `ADS_sca_2_OUT`.`scaler_output_4`, `ADS_sca_2_OUT`.`scaler_output_5` 
...
FROM `tmp_20180516123752_codegen_mhwgxu_ads_imp_1_out` AS `ADS_imp_1_OUT`) AS `ADS_sca_2_OUT`

-- Code For temporary table tmp_20180516123752_codegen_469ejs_ads_sca_2_out part 2. Populate

SELECT * FROM `tmp_20180516123752_codegen_469ejs_ads_sca_2_out`
...
FROM `tmp_20180516123752_codegen_469ejs_ads_sca_2_out` AS `ADS_sca_2_OUT`), 
`linear_model_cte` AS 
...
(SELECT `linear_model_cte`.`KEY` AS `KEY`, `Score_1789-07-14T00:00:00.000000000` AS `Score_1789-07-14T00:00:00.000000000`, 1.0 / (1.0 + exp(-`Score_1789-07-14T00:00:00.000000000`)) AS `Logistic_1789-07-14T00:00:00.000000000`, `Score_1789-08-14T00:00:00.000000000` AS `Score_1789-08-14T00:00:00.000000000`, 1.0 / (1.0 + exp(-`Score_1789-08-14T00:00:00.000000000`)) AS `Logistic_1789-08-14T00:00:00.000000000`, `Score_1789-09-14T00:00:00.000000000` AS `Score_1789-09-14T00:00:00.000000000`, 1.0 / (1.0 + exp(-`Score_1789-09-14T00:00:00.000000000`)) AS `Logistic_1789-09-14T00:00:00.000000000` 
FROM `linear_model_cte`), 
`orig_cte` AS 
(SELECT `linear_model_cte_logistic`.`KEY` AS `KEY`, `Score_1789-07-14T00:00:00.000000000` AS `Score_1789-07-14T00:00:00.000000000`, `Score_1789-08-14T00:00:00.000000000` AS `Score_1789-08-14T00:00:00.000000000`, `Score_1789-09-14T00:00:00.000000000` AS `Score_1789-09-14T00:00:00.000000000`, `Logistic_1789-07-14T00:00:00.000000000` / (`Logistic_1789-07-14T00:00:00.000000000` + `Logistic_1789-08-14T00:00:00.000000000` + `Logistic_1789-09-14T00:00:00.000000000`) AS `Proba_1789-07-14T00:00:00.000000000`, `Logistic_1789-08-14T00:00:00.000000000` / (`Logistic_1789-07-14T00:00:00.000000000` + `Logistic_1789-08-14T00:00:00.000000000` + `Logistic_1789-09-14T00:00:00.000000000`) AS `Proba_1789-08-14T00:00:00.000000000`, `Logistic_1789-09-14T00:00:00.000000000` / (`Logistic_1789-07-14T00:00:00.000000000` + `Logistic_1789-08-14T00:00:00.000000000` + `Logistic_1789-09-14T00:00:00.000000000`) AS `Proba_1789-09-14T00:00:00.000000000`, CAST(NULL AS DOUBLE) AS `LogProba_1789-07-14T00:00:00.000000000`, CAST(NULL AS DOUBLE) AS `LogProba_1789-08-14T00:00:00.000000000`, CAST(NULL AS DOUBLE) AS `LogProba_1789-09-14T00:00:00.000000000`, CAST(NULL AS BIGINT) AS `Decision`, CAST(NULL AS DOUBLE) AS `DecisionProba` 
