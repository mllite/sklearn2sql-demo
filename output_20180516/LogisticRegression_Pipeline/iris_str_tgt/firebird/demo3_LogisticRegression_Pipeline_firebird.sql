...
-- Code For temporary table TMP_20180508190633_CODEGEN_P54G part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508190633_CODEGEN_P54G" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20180508190633_CODEGEN_P54G part 2. Populate

INSERT INTO "TMP_20180508190633_CODEGEN_P54G" ("KEY", imputer_output_2, imputer_output_3, imputer_output_4, imputer_output_5) SELECT "U"."KEY", "U".imputer_output_2, "U".imputer_output_3, "U".imputer_output_4, "U".imputer_output_5 
...
-- Code For temporary table TMP_20180508190633_CODEGEN_P54G part 3. Create Index 

CREATE INDEX "ix_TMP_20180508190633_C_8cbf" ON "TMP_20180508190633_CODEGEN_P54G" ("KEY")

-- Code For temporary table TMP_20180508190633_CODEGEN_P0HN part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508190633_CODEGEN_P0HN" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20180508190633_CODEGEN_P0HN part 2. Populate

INSERT INTO "TMP_20180508190633_CODEGEN_P0HN" ("KEY", scaler_output_2, scaler_output_3, scaler_output_4, scaler_output_5) SELECT "U"."KEY", "U".scaler_output_2, "U".scaler_output_3, "U".scaler_output_4, "U".scaler_output_5 
...
FROM "TMP_20180508190633_CODEGEN_P54G" AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT") AS "U"

-- Code For temporary table TMP_20180508190633_CODEGEN_P0HN part 3. Create Index 

CREATE INDEX "ix_TMP_20180508190633_C_e5a8" ON "TMP_20180508190633_CODEGEN_P0HN" ("KEY")
...
FROM "TMP_20180508190633_CODEGEN_P0HN" AS "ADS_sca_2_OUT"), 
linear_model_cte AS 
...
(SELECT linear_model_cte."KEY" AS "KEY", linear_model_cte."Score_CLASS_0" AS "Score_CLASS_0", 1.0 / (1.0 + exp(CASE WHEN (minvalue(maxvalue(-100.0, -linear_model_cte."Score_CLASS_0"), 100.0) >= -709.782712893384) THEN minvalue(maxvalue(-100.0, -linear_model_cte."Score_CLASS_0"), 100.0) ELSE -709.782712893384 END)) AS "Logistic_CLASS_0", linear_model_cte."Score_CLASS_1" AS "Score_CLASS_1", 1.0 / (1.0 + exp(CASE WHEN (minvalue(maxvalue(-100.0, -linear_model_cte."Score_CLASS_1"), 100.0) >= -709.782712893384) THEN minvalue(maxvalue(-100.0, -linear_model_cte."Score_CLASS_1"), 100.0) ELSE -709.782712893384 END)) AS "Logistic_CLASS_1", linear_model_cte."Score_CLASS_2" AS "Score_CLASS_2", 1.0 / (1.0 + exp(CASE WHEN (minvalue(maxvalue(-100.0, -linear_model_cte."Score_CLASS_2"), 100.0) >= -709.782712893384) THEN minvalue(maxvalue(-100.0, -linear_model_cte."Score_CLASS_2"), 100.0) ELSE -709.782712893384 END)) AS "Logistic_CLASS_2" 
