...
-- Code For temporary table tmp_20180516111740_codegen_nliz9j_ads_imp_1_out part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180516111740_codegen_nliz9j_ads_imp_1_out  (
	"KEY" BIGINT, 
...
-- Code For temporary table tmp_20180516111740_codegen_nliz9j_ads_imp_1_out part 2. Populate

INSERT INTO tmp_20180516111740_codegen_nliz9j_ads_imp_1_out ("KEY", impter_2, impter_3, impter_4, impter_5, impter_6, impter_7, impter_8, impter_9, impter_10, impter_11, impter_12, impter_13, impter_14, impter_15, impter_16, impter_17, impter_18, impter_19, impter_20, impter_21, impter_22, impter_23, impter_24, impter_25, impter_26, impter_27, impter_28, impter_29, impter_30, impter_31) SELECT "U"."KEY", "U".impter_2, "U".impter_3, "U".impter_4, "U".impter_5, "U".impter_6, "U".impter_7, "U".impter_8, "U".impter_9, "U".impter_10, "U".impter_11, "U".impter_12, "U".impter_13, "U".impter_14, "U".impter_15, "U".impter_16, "U".impter_17, "U".impter_18, "U".impter_19, "U".impter_20, "U".impter_21, "U".impter_22, "U".impter_23, "U".impter_24, "U".impter_25, "U".impter_26, "U".impter_27, "U".impter_28, "U".impter_29, "U".impter_30, "U".impter_31 
...
-- Code For temporary table tmp_20180516111740_codegen_qnqjko_ads_sca_2_out part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180516111740_codegen_qnqjko_ads_sca_2_out  (
	"KEY" BIGINT, 
...
FROM tmp_20180516111740_codegen_nliz9j_ads_imp_1_out AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT") AS "U"
...
FROM tmp_20180516111740_codegen_qnqjko_ads_sca_2_out AS "ADS_sca_2_OUT"), 
linear_model_cte AS 
(SELECT linear_input."KEY" AS "KEY", CAST(-0.388889977660523 AS DOUBLE PRECISION) * linear_input.scaler_2 + CAST(-0.471801196084478 AS DOUBLE PRECISION) * linear_input.scaler_3 + CAST(-0.341133464116003 AS DOUBLE PRECISION) * linear_input.scaler_4 + CAST(-0.512311998227288 AS DOUBLE PRECISION) * linear_input.scaler_5 + CAST(-0.104589377372137 AS DOUBLE PRECISION) * linear_input.scaler_6 + CAST(0.395690771291006 AS DOUBLE PRECISION) * linear_input.scaler_7 + CAST(-0.802840803208006 AS DOUBLE PRECISION) * linear_input.scaler_8 + CAST(-1.132865681950448 AS DOUBLE PRECISION) * linear_input.scaler_9 + CAST(0.034849735336112 AS DOUBLE PRECISION) * linear_input.scaler_10 + CAST(0.088584659379373 AS DOUBLE PRECISION) * linear_input.scaler_11 + CAST(-1.431858691745215 AS DOUBLE PRECISION) * linear_input.scaler_12 + CAST(-0.044925251976393 AS DOUBLE PRECISION) * linear_input.scaler_13 + CAST(-0.867584830211793 AS DOUBLE PRECISION) * linear_input.scaler_14 + CAST(-0.929518232211108 AS DOUBLE PRECISION) * linear_input.scaler_15 + CAST(0.21365225319239 AS DOUBLE PRECISION) * linear_input.scaler_16 + CAST(0.887860233692337 AS DOUBLE PRECISION) * linear_input.scaler_17 + CAST(0.241989132652767 AS DOUBLE PRECISION) * linear_input.scaler_18 + CAST(-0.362214874667008 AS DOUBLE PRECISION) * linear_input.scaler_19 + CAST(0.06423015632544 AS DOUBLE PRECISION) * linear_input.scaler_20 + CAST(0.565809436284143 AS DOUBLE PRECISION) * linear_input.scaler_21 + CAST(-0.852999945385823 AS DOUBLE PRECISION) * linear_input.scaler_22 + CAST(-0.848614296827982 AS DOUBLE PRECISION) * linear_input.scaler_23 + CAST(-0.689679796386834 AS DOUBLE PRECISION) * linear_input.scaler_24 + CAST(-0.851921628770982 AS DOUBLE PRECISION) * linear_input.scaler_25 + CAST(-0.670291701129988 AS DOUBLE PRECISION) * linear_input.scaler_26 + CAST(-0.024352018070713 AS DOUBLE PRECISION) * linear_input.scaler_27 + CAST(-0.888052788130278 AS DOUBLE PRECISION) * linear_input.scaler_28 + CAST(-0.981216140884796 AS DOUBLE PRECISION) * linear_input.scaler_29 + CAST(-0.853800610613817 AS DOUBLE PRECISION) * linear_input.scaler_30 + CAST(-0.092342714075253 AS DOUBLE PRECISION) * linear_input.scaler_31 + CAST(0.699544333215379 AS DOUBLE PRECISION) AS lincomb 
FROM linear_input), 
