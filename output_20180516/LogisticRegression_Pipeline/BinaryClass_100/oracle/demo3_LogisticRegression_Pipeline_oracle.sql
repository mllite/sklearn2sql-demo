...
-- Code For temporary table DEGEN_I55KY8_ADS_IMP_1_OUT part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "DEGEN_I55KY8_ADS_IMP_1_OUT" (
	"KEY" NUMBER(19), 
...
-- Code For temporary table DEGEN_DRI4X4_ADS_SCA_2_OUT part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "DEGEN_DRI4X4_ADS_SCA_2_OUT" (
	"KEY" NUMBER(19), 
...
FROM "DEGEN_I55KY8_ADS_IMP_1_OUT" "ADS_imp_1_OUT") "ADS_sca_2_OUT") "U"
...
FROM "DEGEN_DRI4X4_ADS_SCA_2_OUT" "ADS_sca_2_OUT"), 
linear_model_cte AS 
