...
-- Code For temporary table ##TMP_20180516111050_CODEGEN_9LW76I_ADS_imp_1_OUT part 1. Create 


CREATE TABLE ##TMP_20180516111050_CODEGEN_9LW76I_ADS_imp_1_OUT (
	[KEY] BIGINT NULL, 
...
-- Code For temporary table ##TMP_20180516111050_CODEGEN_A6EGTZ_ADS_sca_2_OUT part 1. Create 


CREATE TABLE ##TMP_20180516111050_CODEGEN_A6EGTZ_ADS_sca_2_OUT (
	[KEY] BIGINT NULL, 
	scaler_2 FLOAT NULL, 
	scaler_3 FLOAT NULL, 
	scaler_4 FLOAT NULL, 
...
FROM ##TMP_20180516111050_CODEGEN_9LW76I_ADS_imp_1_OUT AS [ADS_imp_1_OUT]) AS [ADS_sca_2_OUT]
...
FROM ##TMP_20180516111050_CODEGEN_A6EGTZ_ADS_sca_2_OUT AS [ADS_sca_2_OUT]), 
linear_model_cte AS 
...
(SELECT linear_model_cte.[KEY] AS [KEY], linear_model_cte.lincomb AS dot_prod, 1.0 / (1.0 + exp(CASE WHEN (CASE WHEN (-100.0 <= -linear_model_cte.lincomb) THEN -linear_model_cte.lincomb ELSE -100.0 END <= 100.0) THEN CASE WHEN (-100.0 <= -linear_model_cte.lincomb) THEN -linear_model_cte.lincomb ELSE -100.0 END ELSE 100.0 END)) AS logistic 
