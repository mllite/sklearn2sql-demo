...
-- Code For temporary table TMP_20180516112425_CODEGEN_TLPJQF_ADS_imp_1_OUT part 1. Create 


CREATE TEMPORARY TABLE "TMP_20180516112425_CODEGEN_TLPJQF_ADS_imp_1_OUT" (
	"KEY" BIGINT NOT NULL, 
	impter_2 FLOAT, 
	impter_3 FLOAT, 
	impter_4 FLOAT, 
...
-- Code For temporary table TMP_20180516112425_CODEGEN_TLPJQF_ADS_imp_1_OUT part 2. Populate

INSERT INTO "TMP_20180516112425_CODEGEN_TLPJQF_ADS_imp_1_OUT" ("KEY", impter_2, impter_3, impter_4, impter_5, impter_6, impter_7, impter_8, impter_9, impter_10, impter_11) SELECT "ADS_imp_1_OUT"."KEY", "ADS_imp_1_OUT".impter_2, "ADS_imp_1_OUT".impter_3, "ADS_imp_1_OUT".impter_4, "ADS_imp_1_OUT".impter_5, "ADS_imp_1_OUT".impter_6, "ADS_imp_1_OUT".impter_7, "ADS_imp_1_OUT".impter_8, "ADS_imp_1_OUT".impter_9, "ADS_imp_1_OUT".impter_10, "ADS_imp_1_OUT".impter_11 
...
-- Code For temporary table TMP_20180516112425_CODEGEN_TLPJQF_ADS_imp_1_OUT part 3. Create Index 

CREATE INDEX "ix_TMP_20180516112425_CODEGEN_TLPJQF_ADS_imp_1_OUT_KEY" ON "TMP_20180516112425_CODEGEN_TLPJQF_ADS_imp_1_OUT" ("KEY")

-- Code For temporary table TMP_20180516112425_CODEGEN_C8X5D5_ADS_sca_2_OUT part 1. Create 


CREATE TEMPORARY TABLE "TMP_20180516112425_CODEGEN_C8X5D5_ADS_sca_2_OUT" (
	"KEY" BIGINT NOT NULL, 
	scaler_2 FLOAT, 
	scaler_3 FLOAT, 
	scaler_4 FLOAT, 
...
FROM "TMP_20180516112425_CODEGEN_TLPJQF_ADS_imp_1_OUT" AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT"

-- Code For temporary table TMP_20180516112425_CODEGEN_C8X5D5_ADS_sca_2_OUT part 3. Create Index 

CREATE INDEX "ix_TMP_20180516112425_CODEGEN_C8X5D5_ADS_sca_2_OUT_KEY" ON "TMP_20180516112425_CODEGEN_C8X5D5_ADS_sca_2_OUT" ("KEY")
...
FROM "TMP_20180516112425_CODEGEN_C8X5D5_ADS_sca_2_OUT" AS "ADS_sca_2_OUT"), 
linear_model_cte AS 
...
(SELECT linear_model_cte."KEY" AS "KEY", linear_model_cte."Score_0" AS "Score_0", 1.0 / (1.0 + exp(min(max(-100.0, -linear_model_cte."Score_0"), 100.0))) AS "Logistic_0", linear_model_cte."Score_1" AS "Score_1", 1.0 / (1.0 + exp(min(max(-100.0, -linear_model_cte."Score_1"), 100.0))) AS "Logistic_1", linear_model_cte."Score_2" AS "Score_2", 1.0 / (1.0 + exp(min(max(-100.0, -linear_model_cte."Score_2"), 100.0))) AS "Logistic_2", linear_model_cte."Score_3" AS "Score_3", 1.0 / (1.0 + exp(min(max(-100.0, -linear_model_cte."Score_3"), 100.0))) AS "Logistic_3" 
