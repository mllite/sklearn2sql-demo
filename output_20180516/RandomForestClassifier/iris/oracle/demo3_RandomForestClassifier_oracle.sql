...
-- Code For temporary table 85716_CODEGEN_MELG9K_RF_B0 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "85716_CODEGEN_MELG9K_RF_B0" (
	"KEY" NUMBER(19), 
...
-- Code For temporary table 85716_CODEGEN_MELG9K_RF_B0 part 2. Populate

INSERT INTO "85716_CODEGEN_MELG9K_RF_B0" ("KEY", "Score_0", "Proba_0", "LogProba_0", "Score_1", "Proba_1", "LogProba_1", "Score_2", "Proba_2", "LogProba_2") SELECT "U"."KEY", "U"."Score_0", "U"."Proba_0", "U"."LogProba_0", "U"."Score_1", "U"."Proba_1", "U"."LogProba_1", "U"."Score_2", "U"."Proba_2", "U"."LogProba_2" 
...
"RF_Model_0" AS 
(SELECT "DT_Output"."KEY" AS "KEY", CAST(NULL AS BINARY_DOUBLE) AS "Score_0", "DT_Output"."P_0.0" AS "Proba_0", CASE WHEN ("DT_Output"."P_0.0" IS NULL OR "DT_Output"."P_0.0" > 0.0) THEN ln("DT_Output"."P_0.0") ELSE -BINARY_DOUBLE_INFINITY END AS "LogProba_0", CAST(NULL AS BINARY_DOUBLE) AS "Score_1", "DT_Output"."P_1.0" AS "Proba_1", CASE WHEN ("DT_Output"."P_1.0" IS NULL OR "DT_Output"."P_1.0" > 0.0) THEN ln("DT_Output"."P_1.0") ELSE -BINARY_DOUBLE_INFINITY END AS "LogProba_1", CAST(NULL AS BINARY_DOUBLE) AS "Score_2", "DT_Output"."P_2.0" AS "Proba_2", CASE WHEN ("DT_Output"."P_2.0" IS NULL OR "DT_Output"."P_2.0" > 0.0) THEN ln("DT_Output"."P_2.0") ELSE -BINARY_DOUBLE_INFINITY END AS "LogProba_2" 
FROM "DT_Output"), 
"DT_node_lookup_1" AS 
...
"RF_Model_1" AS 
(SELECT "DT_Output_1"."KEY" AS "KEY", CAST(NULL AS BINARY_DOUBLE) AS "Score_0", "DT_Output_1"."P_0.0" AS "Proba_0", CASE WHEN ("DT_Output_1"."P_0.0" IS NULL OR "DT_Output_1"."P_0.0" > 0.0) THEN ln("DT_Output_1"."P_0.0") ELSE -BINARY_DOUBLE_INFINITY END AS "LogProba_0", CAST(NULL AS BINARY_DOUBLE) AS "Score_1", "DT_Output_1"."P_1.0" AS "Proba_1", CASE WHEN ("DT_Output_1"."P_1.0" IS NULL OR "DT_Output_1"."P_1.0" > 0.0) THEN ln("DT_Output_1"."P_1.0") ELSE -BINARY_DOUBLE_INFINITY END AS "LogProba_1", CAST(NULL AS BINARY_DOUBLE) AS "Score_2", "DT_Output_1"."P_2.0" AS "Proba_2", CASE WHEN ("DT_Output_1"."P_2.0" IS NULL OR "DT_Output_1"."P_2.0" > 0.0) THEN ln("DT_Output_1"."P_2.0") ELSE -BINARY_DOUBLE_INFINITY END AS "LogProba_2" 
FROM "DT_Output_1"), 
"DT_node_lookup_2" AS 
...
"RF_Model_4" AS 
(SELECT "DT_Output_4"."KEY" AS "KEY", CAST(NULL AS BINARY_DOUBLE) AS "Score_0", "DT_Output_4"."P_0.0" AS "Proba_0", CASE WHEN ("DT_Output_4"."P_0.0" IS NULL OR "DT_Output_4"."P_0.0" > 0.0) THEN ln("DT_Output_4"."P_0.0") ELSE -BINARY_DOUBLE_INFINITY END AS "LogProba_0", CAST(NULL AS BINARY_DOUBLE) AS "Score_1", "DT_Output_4"."P_1.0" AS "Proba_1", CASE WHEN ("DT_Output_4"."P_1.0" IS NULL OR "DT_Output_4"."P_1.0" > 0.0) THEN ln("DT_Output_4"."P_1.0") ELSE -BINARY_DOUBLE_INFINITY END AS "LogProba_1", CAST(NULL AS BINARY_DOUBLE) AS "Score_2", "DT_Output_4"."P_2.0" AS "Proba_2", CASE WHEN ("DT_Output_4"."P_2.0" IS NULL OR "DT_Output_4"."P_2.0" > 0.0) THEN ln("DT_Output_4"."P_2.0") ELSE -BINARY_DOUBLE_INFINITY END AS "LogProba_2" 
FROM "DT_Output_4"), 
"DT_node_lookup_5" AS 
...
"RF_Model_5" AS 
(SELECT "DT_Output_5"."KEY" AS "KEY", CAST(NULL AS BINARY_DOUBLE) AS "Score_0", "DT_Output_5"."P_0.0" AS "Proba_0", CASE WHEN ("DT_Output_5"."P_0.0" IS NULL OR "DT_Output_5"."P_0.0" > 0.0) THEN ln("DT_Output_5"."P_0.0") ELSE -BINARY_DOUBLE_INFINITY END AS "LogProba_0", CAST(NULL AS BINARY_DOUBLE) AS "Score_1", "DT_Output_5"."P_1.0" AS "Proba_1", CASE WHEN ("DT_Output_5"."P_1.0" IS NULL OR "DT_Output_5"."P_1.0" > 0.0) THEN ln("DT_Output_5"."P_1.0") ELSE -BINARY_DOUBLE_INFINITY END AS "LogProba_1", CAST(NULL AS BINARY_DOUBLE) AS "Score_2", "DT_Output_5"."P_2.0" AS "Proba_2", CASE WHEN ("DT_Output_5"."P_2.0" IS NULL OR "DT_Output_5"."P_2.0" > 0.0) THEN ln("DT_Output_5"."P_2.0") ELSE -BINARY_DOUBLE_INFINITY END AS "LogProba_2" 
FROM "DT_Output_5"), 
"DT_node_lookup_6" AS 
...
"RF_Model_6" AS 
(SELECT "DT_Output_6"."KEY" AS "KEY", CAST(NULL AS BINARY_DOUBLE) AS "Score_0", "DT_Output_6"."P_0.0" AS "Proba_0", CASE WHEN ("DT_Output_6"."P_0.0" IS NULL OR "DT_Output_6"."P_0.0" > 0.0) THEN ln("DT_Output_6"."P_0.0") ELSE -BINARY_DOUBLE_INFINITY END AS "LogProba_0", CAST(NULL AS BINARY_DOUBLE) AS "Score_1", "DT_Output_6"."P_1.0" AS "Proba_1", CASE WHEN ("DT_Output_6"."P_1.0" IS NULL OR "DT_Output_6"."P_1.0" > 0.0) THEN ln("DT_Output_6"."P_1.0") ELSE -BINARY_DOUBLE_INFINITY END AS "LogProba_1", CAST(NULL AS BINARY_DOUBLE) AS "Score_2", "DT_Output_6"."P_2.0" AS "Proba_2", CASE WHEN ("DT_Output_6"."P_2.0" IS NULL OR "DT_Output_6"."P_2.0" > 0.0) THEN ln("DT_Output_6"."P_2.0") ELSE -BINARY_DOUBLE_INFINITY END AS "LogProba_2" 
FROM "DT_Output_6"), 
"DT_node_lookup_7" AS 
...
"RF_Model_7" AS 
(SELECT "DT_Output_7"."KEY" AS "KEY", CAST(NULL AS BINARY_DOUBLE) AS "Score_0", "DT_Output_7"."P_0.0" AS "Proba_0", CASE WHEN ("DT_Output_7"."P_0.0" IS NULL OR "DT_Output_7"."P_0.0" > 0.0) THEN ln("DT_Output_7"."P_0.0") ELSE -BINARY_DOUBLE_INFINITY END AS "LogProba_0", CAST(NULL AS BINARY_DOUBLE) AS "Score_1", "DT_Output_7"."P_1.0" AS "Proba_1", CASE WHEN ("DT_Output_7"."P_1.0" IS NULL OR "DT_Output_7"."P_1.0" > 0.0) THEN ln("DT_Output_7"."P_1.0") ELSE -BINARY_DOUBLE_INFINITY END AS "LogProba_1", CAST(NULL AS BINARY_DOUBLE) AS "Score_2", "DT_Output_7"."P_2.0" AS "Proba_2", CASE WHEN ("DT_Output_7"."P_2.0" IS NULL OR "DT_Output_7"."P_2.0" > 0.0) THEN ln("DT_Output_7"."P_2.0") ELSE -BINARY_DOUBLE_INFINITY END AS "LogProba_2" 
FROM "DT_Output_7"), 
"DT_node_lookup_8" AS 
...
-- Code For temporary table 85716_CODEGEN_8JNPW7_RF_B1 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "85716_CODEGEN_8JNPW7_RF_B1" (
	"KEY" NUMBER(19), 
	"Score_0" BINARY_DOUBLE, 
	"Proba_0" BINARY_DOUBLE, 
	"LogProba_0" BINARY_DOUBLE, 
...
-- Code For temporary table 85716_CODEGEN_8JNPW7_RF_B1 part 2. Populate

INSERT INTO "85716_CODEGEN_8JNPW7_RF_B1" ("KEY", "Score_0", "Proba_0", "LogProba_0", "Score_1", "Proba_1", "LogProba_1", "Score_2", "Proba_2", "LogProba_2") SELECT "U"."KEY", "U"."Score_0", "U"."Proba_0", "U"."LogProba_0", "U"."Score_1", "U"."Proba_1", "U"."LogProba_1", "U"."Score_2", "U"."Proba_2", "U"."LogProba_2" 
...
"RF_Model_10" AS 
(SELECT "DT_Output_10"."KEY" AS "KEY", CAST(NULL AS BINARY_DOUBLE) AS "Score_0", "DT_Output_10"."P_0.0" AS "Proba_0", CASE WHEN ("DT_Output_10"."P_0.0" IS NULL OR "DT_Output_10"."P_0.0" > 0.0) THEN ln("DT_Output_10"."P_0.0") ELSE -BINARY_DOUBLE_INFINITY END AS "LogProba_0", CAST(NULL AS BINARY_DOUBLE) AS "Score_1", "DT_Output_10"."P_1.0" AS "Proba_1", CASE WHEN ("DT_Output_10"."P_1.0" IS NULL OR "DT_Output_10"."P_1.0" > 0.0) THEN ln("DT_Output_10"."P_1.0") ELSE -BINARY_DOUBLE_INFINITY END AS "LogProba_1", CAST(NULL AS BINARY_DOUBLE) AS "Score_2", "DT_Output_10"."P_2.0" AS "Proba_2", CASE WHEN ("DT_Output_10"."P_2.0" IS NULL OR "DT_Output_10"."P_2.0" > 0.0) THEN ln("DT_Output_10"."P_2.0") ELSE -BINARY_DOUBLE_INFINITY END AS "LogProba_2" 
FROM "DT_Output_10"), 
...
"RF_Model_11" AS 
(SELECT "DT_Output_11"."KEY" AS "KEY", CAST(NULL AS BINARY_DOUBLE) AS "Score_0", "DT_Output_11"."P_0.0" AS "Proba_0", CASE WHEN ("DT_Output_11"."P_0.0" IS NULL OR "DT_Output_11"."P_0.0" > 0.0) THEN ln("DT_Output_11"."P_0.0") ELSE -BINARY_DOUBLE_INFINITY END AS "LogProba_0", CAST(NULL AS BINARY_DOUBLE) AS "Score_1", "DT_Output_11"."P_1.0" AS "Proba_1", CASE WHEN ("DT_Output_11"."P_1.0" IS NULL OR "DT_Output_11"."P_1.0" > 0.0) THEN ln("DT_Output_11"."P_1.0") ELSE -BINARY_DOUBLE_INFINITY END AS "LogProba_1", CAST(NULL AS BINARY_DOUBLE) AS "Score_2", "DT_Output_11"."P_2.0" AS "Proba_2", CASE WHEN ("DT_Output_11"."P_2.0" IS NULL OR "DT_Output_11"."P_2.0" > 0.0) THEN ln("DT_Output_11"."P_2.0") ELSE -BINARY_DOUBLE_INFINITY END AS "LogProba_2" 
FROM "DT_Output_11"), 
...
"RF_Model_12" AS 
(SELECT "DT_Output_12"."KEY" AS "KEY", CAST(NULL AS BINARY_DOUBLE) AS "Score_0", "DT_Output_12"."P_0.0" AS "Proba_0", CASE WHEN ("DT_Output_12"."P_0.0" IS NULL OR "DT_Output_12"."P_0.0" > 0.0) THEN ln("DT_Output_12"."P_0.0") ELSE -BINARY_DOUBLE_INFINITY END AS "LogProba_0", CAST(NULL AS BINARY_DOUBLE) AS "Score_1", "DT_Output_12"."P_1.0" AS "Proba_1", CASE WHEN ("DT_Output_12"."P_1.0" IS NULL OR "DT_Output_12"."P_1.0" > 0.0) THEN ln("DT_Output_12"."P_1.0") ELSE -BINARY_DOUBLE_INFINITY END AS "LogProba_1", CAST(NULL AS BINARY_DOUBLE) AS "Score_2", "DT_Output_12"."P_2.0" AS "Proba_2", CASE WHEN ("DT_Output_12"."P_2.0" IS NULL OR "DT_Output_12"."P_2.0" > 0.0) THEN ln("DT_Output_12"."P_2.0") ELSE -BINARY_DOUBLE_INFINITY END AS "LogProba_2" 
FROM "DT_Output_12"), 
...
"RF_Model_13" AS 
(SELECT "DT_Output_13"."KEY" AS "KEY", CAST(NULL AS BINARY_DOUBLE) AS "Score_0", "DT_Output_13"."P_0.0" AS "Proba_0", CASE WHEN ("DT_Output_13"."P_0.0" IS NULL OR "DT_Output_13"."P_0.0" > 0.0) THEN ln("DT_Output_13"."P_0.0") ELSE -BINARY_DOUBLE_INFINITY END AS "LogProba_0", CAST(NULL AS BINARY_DOUBLE) AS "Score_1", "DT_Output_13"."P_1.0" AS "Proba_1", CASE WHEN ("DT_Output_13"."P_1.0" IS NULL OR "DT_Output_13"."P_1.0" > 0.0) THEN ln("DT_Output_13"."P_1.0") ELSE -BINARY_DOUBLE_INFINITY END AS "LogProba_1", CAST(NULL AS BINARY_DOUBLE) AS "Score_2", "DT_Output_13"."P_2.0" AS "Proba_2", CASE WHEN ("DT_Output_13"."P_2.0" IS NULL OR "DT_Output_13"."P_2.0" > 0.0) THEN ln("DT_Output_13"."P_2.0") ELSE -BINARY_DOUBLE_INFINITY END AS "LogProba_2" 
FROM "DT_Output_13"), 
...
"RF_Model_14" AS 
(SELECT "DT_Output_14"."KEY" AS "KEY", CAST(NULL AS BINARY_DOUBLE) AS "Score_0", "DT_Output_14"."P_0.0" AS "Proba_0", CASE WHEN ("DT_Output_14"."P_0.0" IS NULL OR "DT_Output_14"."P_0.0" > 0.0) THEN ln("DT_Output_14"."P_0.0") ELSE -BINARY_DOUBLE_INFINITY END AS "LogProba_0", CAST(NULL AS BINARY_DOUBLE) AS "Score_1", "DT_Output_14"."P_1.0" AS "Proba_1", CASE WHEN ("DT_Output_14"."P_1.0" IS NULL OR "DT_Output_14"."P_1.0" > 0.0) THEN ln("DT_Output_14"."P_1.0") ELSE -BINARY_DOUBLE_INFINITY END AS "LogProba_1", CAST(NULL AS BINARY_DOUBLE) AS "Score_2", "DT_Output_14"."P_2.0" AS "Proba_2", CASE WHEN ("DT_Output_14"."P_2.0" IS NULL OR "DT_Output_14"."P_2.0" > 0.0) THEN ln("DT_Output_14"."P_2.0") ELSE -BINARY_DOUBLE_INFINITY END AS "LogProba_2" 
FROM "DT_Output_14"), 
...
-- Code For temporary table 16_CODEGEN_CFKDT6_RF_UNION part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "16_CODEGEN_CFKDT6_RF_UNION" (
	"KEY" NUMBER(19), 
	"Score_0" BINARY_DOUBLE, 
	"Proba_0" BINARY_DOUBLE, 
	"LogProba_0" BINARY_DOUBLE, 
...
-- Code For temporary table 16_CODEGEN_CFKDT6_RF_UNION part 2. Populate

INSERT INTO "16_CODEGEN_CFKDT6_RF_UNION" ("KEY", "Score_0", "Proba_0", "LogProba_0", "Score_1", "Proba_1", "LogProba_1", "Score_2", "Proba_2", "LogProba_2") SELECT "U"."KEY", "U"."Score_0", "U"."Proba_0", "U"."LogProba_0", "U"."Score_1", "U"."Proba_1", "U"."LogProba_1", "U"."Score_2", "U"."Proba_2", "U"."LogProba_2" 
...
FROM "85716_CODEGEN_MELG9K_RF_B0" "RF_B0" UNION ALL SELECT "RF_B1"."KEY" AS "KEY", "RF_B1"."Score_0" AS "Score_0", "RF_B1"."Proba_0" AS "Proba_0", "RF_B1"."LogProba_0" AS "LogProba_0", "RF_B1"."Score_1" AS "Score_1", "RF_B1"."Proba_1" AS "Proba_1", "RF_B1"."LogProba_1" AS "LogProba_1", "RF_B1"."Score_2" AS "Score_2", "RF_B1"."Proba_2" AS "Proba_2", "RF_B1"."LogProba_2" AS "LogProba_2" 
FROM "85716_CODEGEN_8JNPW7_RF_B1" "RF_B1") "RF_EnsembleUnion") "RF_Union") "U"

-- Code For temporary table 5716_CODEGEN_OK2QIP_RF_AVG part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "5716_CODEGEN_OK2QIP_RF_AVG" (
	"KEY" NUMBER(19), 
	"Score_0" BINARY_DOUBLE, 
	"Proba_0" BINARY_DOUBLE, 
	"LogProba_0" BINARY_DOUBLE, 
...
-- Code For temporary table 5716_CODEGEN_OK2QIP_RF_AVG part 2. Populate

INSERT INTO "5716_CODEGEN_OK2QIP_RF_AVG" ("KEY", "Score_0", "Proba_0", "LogProba_0", "Score_1", "Proba_1", "LogProba_1", "Score_2", "Proba_2", "LogProba_2") SELECT "U"."KEY", "U"."Score_0", "U"."Proba_0", "U"."LogProba_0", "U"."Score_1", "U"."Proba_1", "U"."LogProba_1", "U"."Score_2", "U"."Proba_2", "U"."LogProba_2" 
