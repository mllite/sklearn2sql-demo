...
-- Code For temporary table 80516_CODEGEN_RVIBF9_RF_B0 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "80516_CODEGEN_RVIBF9_RF_B0" (
	"KEY" NUMBER(19), 
...
-- Code For temporary table 80516_CODEGEN_RVIBF9_RF_B0 part 2. Populate

INSERT INTO "80516_CODEGEN_RVIBF9_RF_B0" ("KEY", "Score_0", "Proba_0", "LogProba_0", "Score_1", "Proba_1", "LogProba_1", "Score_2", "Proba_2", "LogProba_2") SELECT "U"."KEY", "U"."Score_0", "U"."Proba_0", "U"."LogProba_0", "U"."Score_1", "U"."Proba_1", "U"."LogProba_1", "U"."Score_2", "U"."Proba_2", "U"."LogProba_2" 
...
-- Code For temporary table 80516_CODEGEN_MBE2WL_RF_B1 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "80516_CODEGEN_MBE2WL_RF_B1" (
	"KEY" NUMBER(19), 
	"Score_0" BINARY_DOUBLE, 
	"Proba_0" BINARY_DOUBLE, 
	"LogProba_0" BINARY_DOUBLE, 
...
-- Code For temporary table 80516_CODEGEN_MBE2WL_RF_B1 part 2. Populate

INSERT INTO "80516_CODEGEN_MBE2WL_RF_B1" ("KEY", "Score_0", "Proba_0", "LogProba_0", "Score_1", "Proba_1", "LogProba_1", "Score_2", "Proba_2", "LogProba_2") SELECT "U"."KEY", "U"."Score_0", "U"."Proba_0", "U"."LogProba_0", "U"."Score_1", "U"."Proba_1", "U"."LogProba_1", "U"."Score_2", "U"."Proba_2", "U"."LogProba_2" 
...
-- Code For temporary table 0516_CODEGEN_YGUIJE_RF_AVG part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "0516_CODEGEN_YGUIJE_RF_AVG" (
	"KEY" NUMBER(19), 
	"Score_0" BINARY_DOUBLE, 
	"Proba_0" BINARY_DOUBLE, 
	"LogProba_0" BINARY_DOUBLE, 
...
-- Code For temporary table 0516_CODEGEN_YGUIJE_RF_AVG part 2. Populate

INSERT INTO "0516_CODEGEN_YGUIJE_RF_AVG" ("KEY", "Score_0", "Proba_0", "LogProba_0", "Score_1", "Proba_1", "LogProba_1", "Score_2", "Proba_2", "LogProba_2") SELECT "U"."KEY", "U"."Score_0", "U"."Proba_0", "U"."LogProba_0", "U"."Score_1", "U"."Proba_1", "U"."LogProba_1", "U"."Score_2", "U"."Proba_2", "U"."LogProba_2" 
...
FROM "0516_CODEGEN_YGUIJE_RF_AVG" "RF_avg"), 
