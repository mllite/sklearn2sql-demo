...
-- Code For temporary table tmp_20180508185717_codegen_57jogu_rf_b0 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180508185717_codegen_57jogu_rf_b0  (
	"KEY" BIGINT, 
...
-- Code For temporary table tmp_20180508185717_codegen_57jogu_rf_b0 part 2. Populate

INSERT INTO tmp_20180508185717_codegen_57jogu_rf_b0 ("KEY", "Score_0", "Proba_0", "LogProba_0", "Score_1", "Proba_1", "LogProba_1", "Score_2", "Proba_2", "LogProba_2") SELECT "U"."KEY", "U"."Score_0", "U"."Proba_0", "U"."LogProba_0", "U"."Score_1", "U"."Proba_1", "U"."LogProba_1", "U"."Score_2", "U"."Proba_2", "U"."LogProba_2" 
FROM (WITH "DT_node_lookup" AS 
(SELECT "ADS"."KEY" AS "KEY", CASE WHEN ("ADS"."Feature_0" <= CAST(5.449999809265137 AS DOUBLE PRECISION)) THEN CASE WHEN ("ADS"."Feature_3" <= CAST(0.800000011920929 AS DOUBLE PRECISION)) THEN 2 ELSE CASE WHEN ("ADS"."Feature_3" <= CAST(1.600000023841858 AS DOUBLE PRECISION)) THEN 4 ELSE 5 END END ELSE CASE WHEN ("ADS"."Feature_3" <= CAST(1.75 AS DOUBLE PRECISION)) THEN CASE WHEN ("ADS"."Feature_3" <= CAST(0.699999988079071 AS DOUBLE PRECISION)) THEN 8 ELSE CASE WHEN ("ADS"."Feature_2" <= CAST(4.949999809265137 AS DOUBLE PRECISION)) THEN 10 ELSE CASE WHEN ("ADS"."Feature_1" <= CAST(2.599999904632568 AS DOUBLE PRECISION)) THEN 12 ELSE 13 END END END ELSE 14 END END AS node_id_2 
FROM iris AS "ADS"), 
dummy_cte AS 
...
FROM "DT_Output_3"), 
"DT_node_lookup_4" AS 
(SELECT "ADS"."KEY" AS "KEY", CASE WHEN ("ADS"."Feature_2" <= CAST(2.450000047683716 AS DOUBLE PRECISION)) THEN 1 ELSE CASE WHEN ("ADS"."Feature_0" <= CAST(5.649999618530273 AS DOUBLE PRECISION)) THEN 3 ELSE CASE WHEN ("ADS"."Feature_3" <= CAST(1.75 AS DOUBLE PRECISION)) THEN CASE WHEN ("ADS"."Feature_2" <= CAST(4.949999809265137 AS DOUBLE PRECISION)) THEN 6 ELSE CASE WHEN ("ADS"."Feature_1" <= CAST(2.900000095367432 AS DOUBLE PRECISION)) THEN 8 ELSE CASE WHEN ("ADS"."Feature_0" <= CAST(6.949999809265137 AS DOUBLE PRECISION)) THEN 10 ELSE 11 END END END ELSE 12 END END END AS node_id_2 
FROM iris AS "ADS"), 
dummy_cte_4 AS 
(SELECT CAST(0.0 AS DOUBLE PRECISION) AS "X"), 
"DT_node_data_4" AS 
...
FROM "DT_Output_8"), 
"DT_node_lookup_9" AS 
(SELECT "ADS"."KEY" AS "KEY", CASE WHEN ("ADS"."Feature_3" <= CAST(0.800000011920929 AS DOUBLE PRECISION)) THEN 1 ELSE CASE WHEN ("ADS"."Feature_3" <= CAST(1.549999952316284 AS DOUBLE PRECISION)) THEN CASE WHEN ("ADS"."Feature_2" <= CAST(4.949999809265137 AS DOUBLE PRECISION)) THEN 4 ELSE 5 END ELSE 6 END END AS node_id_2 
FROM iris AS "ADS"), 
dummy_cte_9 AS 
(SELECT CAST(0.0 AS DOUBLE PRECISION) AS "X"), 
"DT_node_data_9" AS 
...
-- Code For temporary table tmp_20180508185717_codegen_7m3vsb_rf_b1 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180508185717_codegen_7m3vsb_rf_b1  (
	"KEY" BIGINT, 
	"Score_0" DOUBLE PRECISION, 
	"Proba_0" DOUBLE PRECISION, 
	"LogProba_0" DOUBLE PRECISION, 
...
-- Code For temporary table tmp_20180508185717_codegen_7m3vsb_rf_b1 part 2. Populate

INSERT INTO tmp_20180508185717_codegen_7m3vsb_rf_b1 ("KEY", "Score_0", "Proba_0", "LogProba_0", "Score_1", "Proba_1", "LogProba_1", "Score_2", "Proba_2", "LogProba_2") SELECT "U"."KEY", "U"."Score_0", "U"."Proba_0", "U"."LogProba_0", "U"."Score_1", "U"."Proba_1", "U"."LogProba_1", "U"."Score_2", "U"."Proba_2", "U"."LogProba_2" 
FROM (WITH "DT_node_lookup_10" AS 
(SELECT "ADS"."KEY" AS "KEY", CASE WHEN ("ADS"."Feature_0" <= CAST(5.449999809265137 AS DOUBLE PRECISION)) THEN CASE WHEN ("ADS"."Feature_2" <= CAST(2.599999904632568 AS DOUBLE PRECISION)) THEN 2 ELSE CASE WHEN ("ADS"."Feature_3" <= CAST(1.600000023841858 AS DOUBLE PRECISION)) THEN 4 ELSE 5 END END ELSE CASE WHEN ("ADS"."Feature_2" <= CAST(4.850000381469727 AS DOUBLE PRECISION)) THEN CASE WHEN ("ADS"."Feature_1" <= CAST(3.549999952316284 AS DOUBLE PRECISION)) THEN CASE WHEN ("ADS"."Feature_2" <= CAST(4.75 AS DOUBLE PRECISION)) THEN 9 ELSE CASE WHEN ("ADS"."Feature_0" <= CAST(5.949999809265137 AS DOUBLE PRECISION)) THEN 11 ELSE CASE WHEN ("ADS"."Feature_3" <= CAST(1.599999904632568 AS DOUBLE PRECISION)) THEN 13 ELSE 14 END END END ELSE 15 END ELSE CASE WHEN ("ADS"."Feature_2" <= CAST(4.949999809265137 AS DOUBLE PRECISION)) THEN CASE WHEN ("ADS"."Feature_0" <= CAST(6.199999809265137 AS DOUBLE PRECISION)) THEN 18 ELSE 19 END ELSE 20 END END END AS node_id_2 
FROM iris AS "ADS"), 
dummy_cte_10 AS 
(SELECT CAST(0.0 AS DOUBLE PRECISION) AS "X"), 
"DT_node_data_10" AS 
...
-- Code For temporary table tmp_20180508185717_codegen_nuraw4_rf_union part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180508185717_codegen_nuraw4_rf_union  (
	"KEY" BIGINT, 
	"Score_0" DOUBLE PRECISION, 
	"Proba_0" DOUBLE PRECISION, 
	"LogProba_0" DOUBLE PRECISION, 
...
-- Code For temporary table tmp_20180508185717_codegen_nuraw4_rf_union part 2. Populate

INSERT INTO tmp_20180508185717_codegen_nuraw4_rf_union ("KEY", "Score_0", "Proba_0", "LogProba_0", "Score_1", "Proba_1", "LogProba_1", "Score_2", "Proba_2", "LogProba_2") SELECT "U"."KEY", "U"."Score_0", "U"."Proba_0", "U"."LogProba_0", "U"."Score_1", "U"."Proba_1", "U"."LogProba_1", "U"."Score_2", "U"."Proba_2", "U"."LogProba_2" 
...
FROM tmp_20180508185717_codegen_57jogu_rf_b0 AS "RF_B0" UNION ALL SELECT "RF_B1"."KEY" AS "KEY", "RF_B1"."Score_0" AS "Score_0", "RF_B1"."Proba_0" AS "Proba_0", "RF_B1"."LogProba_0" AS "LogProba_0", "RF_B1"."Score_1" AS "Score_1", "RF_B1"."Proba_1" AS "Proba_1", "RF_B1"."LogProba_1" AS "LogProba_1", "RF_B1"."Score_2" AS "Score_2", "RF_B1"."Proba_2" AS "Proba_2", "RF_B1"."LogProba_2" AS "LogProba_2" 
FROM tmp_20180508185717_codegen_7m3vsb_rf_b1 AS "RF_B1") AS "RF_EnsembleUnion") AS "RF_Union") AS "U"

-- Code For temporary table tmp_20180508185717_codegen_6fm7y7_rf_avg part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180508185717_codegen_6fm7y7_rf_avg  (
	"KEY" BIGINT, 
	"Score_0" DOUBLE PRECISION, 
	"Proba_0" DOUBLE PRECISION, 
	"LogProba_0" DOUBLE PRECISION, 
...
-- Code For temporary table tmp_20180508185717_codegen_6fm7y7_rf_avg part 2. Populate

INSERT INTO tmp_20180508185717_codegen_6fm7y7_rf_avg ("KEY", "Score_0", "Proba_0", "LogProba_0", "Score_1", "Proba_1", "LogProba_1", "Score_2", "Proba_2", "LogProba_2") SELECT "U"."KEY", "U"."Score_0", "U"."Proba_0", "U"."LogProba_0", "U"."Score_1", "U"."Proba_1", "U"."LogProba_1", "U"."Score_2", "U"."Proba_2", "U"."LogProba_2" 
...
FROM tmp_20180508185717_codegen_nuraw4_rf_union AS "RF_Union" GROUP BY "RF_Union"."KEY") AS "T") AS "RF_avg") AS "U"
...
FROM tmp_20180508185717_codegen_6fm7y7_rf_avg AS "RF_avg"), 
