...
-- Code For temporary table TMP_20180516_CODEGEN_E0I3SO_RF_ part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180516_CODEGEN_E0I3SO_RF_" (
	"KEY" BIGINT, 
...
-- Code For temporary table TMP_20180516_CODEGEN_E0I3SO_RF_ part 2. Populate

INSERT INTO "TMP_20180516_CODEGEN_E0I3SO_RF_" ("KEY", "Score_0", "Proba_0", "LogProba_0", "Score_1", "Proba_1", "LogProba_1") SELECT "U"."KEY", "U"."Score_0", "U"."Proba_0", "U"."LogProba_0", "U"."Score_1", "U"."Proba_1", "U"."LogProba_1" 
...
-- Code For temporary table TMP_20180516_CODEGEN_TKSV2Q_RF_ part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180516_CODEGEN_TKSV2Q_RF_" (
	"KEY" BIGINT, 
	"Score_0" DOUBLE PRECISION, 
	"Proba_0" DOUBLE PRECISION, 
	"LogProba_0" DOUBLE PRECISION, 
...
-- Code For temporary table TMP_20180516_CODEGEN_TKSV2Q_RF_ part 2. Populate

INSERT INTO "TMP_20180516_CODEGEN_TKSV2Q_RF_" ("KEY", "Score_0", "Proba_0", "LogProba_0", "Score_1", "Proba_1", "LogProba_1") SELECT "U"."KEY", "U"."Score_0", "U"."Proba_0", "U"."LogProba_0", "U"."Score_1", "U"."Proba_1", "U"."LogProba_1" 
...
-- Code For temporary table TMP_20180516_CODEGEN_TIY0LV_RF_ part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180516_CODEGEN_TIY0LV_RF_" (
	"KEY" BIGINT NOT NULL, 
	"Score_0" DOUBLE PRECISION, 
	"Proba_0" DOUBLE PRECISION, 
	"LogProba_0" DOUBLE PRECISION, 
...
-- Code For temporary table TMP_20180516_CODEGEN_TIY0LV_RF_ part 2. Populate

INSERT INTO "TMP_20180516_CODEGEN_TIY0LV_RF_" ("KEY", "Score_0", "Proba_0", "LogProba_0", "Score_1", "Proba_1", "LogProba_1") SELECT "U"."KEY", "U"."Score_0", "U"."Proba_0", "U"."LogProba_0", "U"."Score_1", "U"."Proba_1", "U"."LogProba_1" 
...
FROM "TMP_20180516_CODEGEN_E0I3SO_RF_" AS "RF_B0" UNION ALL SELECT "RF_B1"."KEY" AS "KEY", "RF_B1"."Score_0" AS "Score_0", "RF_B1"."Proba_0" AS "Proba_0", "RF_B1"."LogProba_0" AS "LogProba_0", "RF_B1"."Score_1" AS "Score_1", "RF_B1"."Proba_1" AS "Proba_1", "RF_B1"."LogProba_1" AS "LogProba_1" 
FROM "TMP_20180516_CODEGEN_TKSV2Q_RF_" AS "RF_B1") AS "RF_EnsembleUnion")
...
-- Code For temporary table TMP_20180516_CODEGEN_TIY0LV_RF_ part 3. Create Index 

CREATE INDEX "ix_TMP_20180516_CODEGEN_3daf" ON "TMP_20180516_CODEGEN_TIY0LV_RF_" ("KEY")
...
FROM "TMP_20180516_CODEGEN_TIY0LV_RF_" AS "RF_avg"), 
