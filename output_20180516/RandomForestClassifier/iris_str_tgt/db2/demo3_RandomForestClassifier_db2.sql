...
-- Code For temporary table tmp_20180508190657_codegen_xtvgwo_rf_b0 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180508190657_codegen_xtvgwo_rf_b0 (
	"KEY" BIGINT, 
...
-- Code For temporary table tmp_20180508190657_codegen_xtvgwo_rf_b0 part 2. Populate

INSERT INTO tmp_20180508190657_codegen_xtvgwo_rf_b0 WITH "DT_node_lookup" AS 
...
-- Code For temporary table tmp_20180508190657_codegen_tmyo6b_rf_b1 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180508190657_codegen_tmyo6b_rf_b1 (
	"KEY" BIGINT, 
	"Score_CLASS_0" DOUBLE, 
	"Proba_CLASS_0" DOUBLE, 
	"LogProba_CLASS_0" DOUBLE, 
...
-- Code For temporary table tmp_20180508190657_codegen_tmyo6b_rf_b1 part 2. Populate

INSERT INTO tmp_20180508190657_codegen_tmyo6b_rf_b1 WITH "DT_node_lookup_10" AS 
...
-- Code For temporary table tmp_20180508190657_codegen_7jsvg2_rf_union part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180508190657_codegen_7jsvg2_rf_union (
	"KEY" BIGINT, 
	"Score_CLASS_0" DOUBLE, 
	"Proba_CLASS_0" DOUBLE, 
	"LogProba_CLASS_0" DOUBLE, 
...
-- Code For temporary table tmp_20180508190657_codegen_7jsvg2_rf_union part 2. Populate

INSERT INTO tmp_20180508190657_codegen_7jsvg2_rf_union SELECT "RF_Union"."KEY", "RF_Union"."Score_CLASS_0", "RF_Union"."Proba_CLASS_0", "RF_Union"."LogProba_CLASS_0", "RF_Union"."Score_CLASS_1", "RF_Union"."Proba_CLASS_1", "RF_Union"."LogProba_CLASS_1", "RF_Union"."Score_CLASS_2", "RF_Union"."Proba_CLASS_2", "RF_Union"."LogProba_CLASS_2" 
...
-- Code For temporary table tmp_20180508190657_codegen_evwnru_rf_avg part 2. Populate

INSERT INTO tmp_20180508190657_codegen_evwnru_rf_avg SELECT "RF_avg"."KEY", "RF_avg"."Score_CLASS_0", "RF_avg"."Proba_CLASS_0", "RF_avg"."LogProba_CLASS_0", "RF_avg"."Score_CLASS_1", "RF_avg"."Proba_CLASS_1", "RF_avg"."LogProba_CLASS_1", "RF_avg"."Score_CLASS_2", "RF_avg"."Proba_CLASS_2", "RF_avg"."LogProba_CLASS_2" 
...
FROM (SELECT "RF_Union"."KEY" AS "KEY", AVG(DOUBLE((CAST("RF_Union"."Score_CLASS_0" AS DOUBLE)))) AS "Score_CLASS_0", AVG(DOUBLE((CAST("RF_Union"."Proba_CLASS_0" AS DOUBLE)))) AS "Proba_CLASS_0", CAST(NULL AS DOUBLE) AS "LogProba_CLASS_0", AVG(DOUBLE((CAST("RF_Union"."Score_CLASS_1" AS DOUBLE)))) AS "Score_CLASS_1", AVG(DOUBLE((CAST("RF_Union"."Proba_CLASS_1" AS DOUBLE)))) AS "Proba_CLASS_1", CAST(NULL AS DOUBLE) AS "LogProba_CLASS_1", AVG(DOUBLE((CAST("RF_Union"."Score_CLASS_2" AS DOUBLE)))) AS "Score_CLASS_2", AVG(DOUBLE((CAST("RF_Union"."Proba_CLASS_2" AS DOUBLE)))) AS "Proba_CLASS_2", CAST(NULL AS DOUBLE) AS "LogProba_CLASS_2" 
FROM tmp_20180508190657_codegen_7jsvg2_rf_union AS "RF_Union" GROUP BY "RF_Union"."KEY") AS "T") AS "RF_avg"
...
FROM tmp_20180508190657_codegen_evwnru_rf_avg AS "RF_avg"), 
