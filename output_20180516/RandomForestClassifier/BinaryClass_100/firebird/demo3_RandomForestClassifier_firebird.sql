...
-- Code For temporary table TMP_20180508180406_CODEGEN_SYOZ part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508180406_CODEGEN_SYOZ" (
	"KEY" BIGINT, 
...
-- Code For temporary table TMP_20180508180406_CODEGEN_SYOZ part 2. Populate

INSERT INTO "TMP_20180508180406_CODEGEN_SYOZ" ("KEY", "Score_0", "Proba_0", "LogProba_0", "Score_1", "Proba_1", "LogProba_1") SELECT "U"."KEY", "U"."Score_0", "U"."Proba_0", "U"."LogProba_0", "U"."Score_1", "U"."Proba_1", "U"."LogProba_1" 
...
-- Code For temporary table TMP_20180508180406_CODEGEN_FAF5 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508180406_CODEGEN_FAF5" (
	"KEY" BIGINT, 
	"Score_0" DOUBLE PRECISION, 
	"Proba_0" DOUBLE PRECISION, 
	"LogProba_0" DOUBLE PRECISION, 
...
-- Code For temporary table TMP_20180508180406_CODEGEN_FAF5 part 2. Populate

INSERT INTO "TMP_20180508180406_CODEGEN_FAF5" ("KEY", "Score_0", "Proba_0", "LogProba_0", "Score_1", "Proba_1", "LogProba_1") SELECT "U"."KEY", "U"."Score_0", "U"."Proba_0", "U"."LogProba_0", "U"."Score_1", "U"."Proba_1", "U"."LogProba_1" 
...
-- Code For temporary table TMP_20180508180406_CODEGEN_MXTU part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508180406_CODEGEN_MXTU" (
	"KEY" BIGINT, 
	"Score_0" DOUBLE PRECISION, 
	"Proba_0" DOUBLE PRECISION, 
	"LogProba_0" DOUBLE PRECISION, 
...
-- Code For temporary table TMP_20180508180406_CODEGEN_MXTU part 2. Populate

INSERT INTO "TMP_20180508180406_CODEGEN_MXTU" ("KEY", "Score_0", "Proba_0", "LogProba_0", "Score_1", "Proba_1", "LogProba_1") SELECT "U"."KEY", "U"."Score_0", "U"."Proba_0", "U"."LogProba_0", "U"."Score_1", "U"."Proba_1", "U"."LogProba_1" 
...
FROM "TMP_20180508180406_CODEGEN_SYOZ" AS "RF_B0" UNION ALL SELECT "RF_B1"."KEY" AS "KEY", "RF_B1"."Score_0" AS "Score_0", "RF_B1"."Proba_0" AS "Proba_0", "RF_B1"."LogProba_0" AS "LogProba_0", "RF_B1"."Score_1" AS "Score_1", "RF_B1"."Proba_1" AS "Proba_1", "RF_B1"."LogProba_1" AS "LogProba_1" 
FROM "TMP_20180508180406_CODEGEN_FAF5" AS "RF_B1") AS "RF_EnsembleUnion") AS "RF_Union") AS "U"

-- Code For temporary table TMP_20180508180406_CODEGEN_59XJ part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508180406_CODEGEN_59XJ" (
	"KEY" BIGINT NOT NULL, 
	"Score_0" DOUBLE PRECISION, 
	"Proba_0" DOUBLE PRECISION, 
	"LogProba_0" DOUBLE PRECISION, 
...
-- Code For temporary table TMP_20180508180406_CODEGEN_59XJ part 2. Populate

INSERT INTO "TMP_20180508180406_CODEGEN_59XJ" ("KEY", "Score_0", "Proba_0", "LogProba_0", "Score_1", "Proba_1", "LogProba_1") SELECT "U"."KEY", "U"."Score_0", "U"."Proba_0", "U"."LogProba_0", "U"."Score_1", "U"."Proba_1", "U"."LogProba_1" 
...
FROM "TMP_20180508180406_CODEGEN_MXTU" AS "RF_Union" GROUP BY "RF_Union"."KEY") AS "T") AS "RF_avg") AS "U"

-- Code For temporary table TMP_20180508180406_CODEGEN_59XJ part 3. Create Index 

CREATE INDEX "ix_TMP_20180508180406_C_6632" ON "TMP_20180508180406_CODEGEN_59XJ" ("KEY")
...
FROM "TMP_20180508180406_CODEGEN_59XJ" AS "RF_avg"), 
