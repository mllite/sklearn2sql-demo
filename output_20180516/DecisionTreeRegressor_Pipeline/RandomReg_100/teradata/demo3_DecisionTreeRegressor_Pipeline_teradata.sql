...
-- Code For temporary table tmp_20180602144832_1rh_ads_imp_1_out part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180602144832_1rh_ads_imp_1_out  (
	"KEY" BIGINT, 
...
-- Code For temporary table tmp_20180602144832_nl3_ads_sca_2_out part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180602144832_nl3_ads_sca_2_out  (
	"KEY" BIGINT, 
...
FROM tmp_20180602144832_1rh_ads_imp_1_out AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT") AS "U"

-- Model deployment code

WITH "DT_node_lookup" AS 
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", CASE WHEN ("ADS_sca_2_OUT".scaler_82 <= CAST(-0.174784958362579 AS DOUBLE PRECISION)) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_43 <= CAST(-0.453179210424423 AS DOUBLE PRECISION)) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_57 <= CAST(0.615391910076141 AS DOUBLE PRECISION)) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_75 <= CAST(0.529340207576752 AS DOUBLE PRECISION)) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_65 <= CAST(0.070953287184238 AS DOUBLE PRECISION)) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_98 <= CAST(1.010844230651856 AS DOUBLE PRECISION)) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_48 <= CAST(-0.132389664649963 AS DOUBLE PRECISION)) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_84 <= CAST(-0.045632660388947 AS DOUBLE PRECISION)) THEN 8 ELSE 9 END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_94 <= CAST(-0.455541610717773 AS DOUBLE PRECISION)) THEN 11 ELSE 12 END END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_55 <= CAST(-0.45762225985527 AS DOUBLE PRECISION)) THEN 14 ELSE 15 END END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_8 <= CAST(0.403201580047607 AS DOUBLE PRECISION)) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_3 <= CAST(-0.201230704784393 AS DOUBLE PRECISION)) THEN 18 ELSE 19 END ELSE 20 END END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_80 <= CAST(-0.78593647480011 AS DOUBLE PRECISION)) THEN 22 ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_79 <= CAST(-0.734094202518463 AS DOUBLE PRECISION)) THEN 24 ELSE 25 END END END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_10 <= CAST(-1.348140716552734 AS DOUBLE PRECISION)) THEN 27 ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_25 <= CAST(0.246217042207718 AS DOUBLE PRECISION)) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_85 <= CAST(-0.140591561794281 AS DOUBLE PRECISION)) THEN 30 ELSE 31 END ELSE 32 END END END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_65 <= CAST(0.051973234862089 AS DOUBLE PRECISION)) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_15 <= CAST(-0.430732905864716 AS DOUBLE PRECISION)) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_33 <= CAST(-0.822840571403503 AS DOUBLE PRECISION)) THEN 36 ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_24 <= CAST(-1.630263209342956 AS DOUBLE PRECISION)) THEN 38 ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_85 <= CAST(0.78583437204361 AS DOUBLE PRECISION)) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_49 <= CAST(-0.278913199901581 AS DOUBLE PRECISION)) THEN 41 ELSE 42 END ELSE 43 END END END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_47 <= CAST(-1.151902675628662 AS DOUBLE PRECISION)) THEN 45 ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_8 <= CAST(0.191472992300987 AS DOUBLE PRECISION)) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_101 <= CAST(-0.368040651082993 AS DOUBLE PRECISION)) THEN 48 ELSE 49 END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_93 <= CAST(1.529849529266358 AS DOUBLE PRECISION)) THEN 51 ELSE 52 END END END END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_35 <= CAST(-0.348909139633179 AS DOUBLE PRECISION)) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_100 <= CAST(1.235696196556091 AS DOUBLE PRECISION)) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_87 <= CAST(-0.545033156871796 AS DOUBLE PRECISION)) THEN 56 ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_48 <= CAST(1.382486581802368 AS DOUBLE PRECISION)) THEN 58 ELSE 59 END END ELSE 60 END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_88 <= CAST(-0.190049052238464 AS DOUBLE PRECISION)) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_25 <= CAST(-0.628522634506226 AS DOUBLE PRECISION)) THEN 63 ELSE 64 END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_101 <= CAST(-0.971916556358337 AS DOUBLE PRECISION)) THEN 66 ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_28 <= CAST(0.431971102952957 AS DOUBLE PRECISION)) THEN 68 ELSE 69 END END END END END END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_41 <= CAST(0.435099840164185 AS DOUBLE PRECISION)) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_59 <= CAST(0.821180820465088 AS DOUBLE PRECISION)) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_96 <= CAST(-0.36030250787735 AS DOUBLE PRECISION)) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_82 <= CAST(-0.070550031960011 AS DOUBLE PRECISION)) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_47 <= CAST(-0.542614579200745 AS DOUBLE PRECISION)) THEN 75 ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_81 <= CAST(-1.780664324760437 AS DOUBLE PRECISION)) THEN 77 ELSE 78 END END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_33 <= CAST(-0.477522730827332 AS DOUBLE PRECISION)) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_47 <= CAST(-0.513156592845917 AS DOUBLE PRECISION)) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_7 <= CAST(-0.081703439354897 AS DOUBLE PRECISION)) THEN 82 ELSE 83 END ELSE 84 END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_21 <= CAST(-0.766914367675781 AS DOUBLE PRECISION)) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_88 <= CAST(1.629151940345764 AS DOUBLE PRECISION)) THEN 87 ELSE 88 END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_62 <= CAST(0.027995869517326 AS DOUBLE PRECISION)) THEN 90 ELSE 91 END END END END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_13 <= CAST(-0.319936841726303 AS DOUBLE PRECISION)) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_69 <= CAST(0.333236634731293 AS DOUBLE PRECISION)) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_100 <= CAST(0.405955672264099 AS DOUBLE PRECISION)) THEN 95 ELSE 96 END ELSE 97 END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_59 <= CAST(-0.323977917432785 AS DOUBLE PRECISION)) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_20 <= CAST(0.887065589427948 AS DOUBLE PRECISION)) THEN 100 ELSE 101 END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_76 <= CAST(-1.788067102432251 AS DOUBLE PRECISION)) THEN 103 ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_48 <= CAST(1.756808042526245 AS DOUBLE PRECISION)) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_54 <= CAST(0.751352250576019 AS DOUBLE PRECISION)) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_51 <= CAST(-0.577740430831909 AS DOUBLE PRECISION)) THEN 107 ELSE 108 END ELSE 109 END ELSE 110 END END END END END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_82 <= CAST(0.836567282676697 AS DOUBLE PRECISION)) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_60 <= CAST(-0.443085491657257 AS DOUBLE PRECISION)) THEN 113 ELSE 114 END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_54 <= CAST(-0.506225168704987 AS DOUBLE PRECISION)) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_22 <= CAST(1.006092429161072 AS DOUBLE PRECISION)) THEN 117 ELSE 118 END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_85 <= CAST(0.165345728397369 AS DOUBLE PRECISION)) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_78 <= CAST(1.000733256340027 AS DOUBLE PRECISION)) THEN 121 ELSE 122 END ELSE 123 END END END END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_3 <= CAST(1.518277406692505 AS DOUBLE PRECISION)) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_20 <= CAST(0.793058633804321 AS DOUBLE PRECISION)) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_4 <= CAST(-0.597478449344635 AS DOUBLE PRECISION)) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_54 <= CAST(1.059417486190796 AS DOUBLE PRECISION)) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_75 <= CAST(0.791956543922424 AS DOUBLE PRECISION)) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_68 <= CAST(-0.601453602313995 AS DOUBLE PRECISION)) THEN 130 ELSE 131 END ELSE 132 END ELSE 133 END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_82 <= CAST(0.417800605297089 AS DOUBLE PRECISION)) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_31 <= CAST(0.446644186973572 AS DOUBLE PRECISION)) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_15 <= CAST(0.203185111284256 AS DOUBLE PRECISION)) THEN 137 ELSE 138 END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_59 <= CAST(0.846244096755982 AS DOUBLE PRECISION)) THEN 140 ELSE 141 END END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_50 <= CAST(0.195936143398285 AS DOUBLE PRECISION)) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_30 <= CAST(-0.61854487657547 AS DOUBLE PRECISION)) THEN 144 ELSE 145 END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_2 <= CAST(1.229863524436951 AS DOUBLE PRECISION)) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_39 <= CAST(0.217698320746422 AS DOUBLE PRECISION)) THEN 148 ELSE 149 END ELSE 150 END END END END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_8 <= CAST(-0.301755219697952 AS DOUBLE PRECISION)) THEN 152 ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_70 <= CAST(0.329233765602112 AS DOUBLE PRECISION)) THEN 154 ELSE 155 END END END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_101 <= CAST(-0.418287754058838 AS DOUBLE PRECISION)) THEN 157 ELSE 158 END END END END AS node_id_2 
FROM tmp_20180602144832_nl3_ads_sca_2_out AS "ADS_sca_2_OUT"), 
dummy_cte AS 
