...
-- Code For temporary table DEGEN_XGTMUD_ADS_IMP_1_OUT part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "DEGEN_XGTMUD_ADS_IMP_1_OUT" (
	"KEY" NUMBER(19), 
...
-- Code For temporary table DEGEN_EDUGDC_ADS_SCA_2_OUT part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "DEGEN_EDUGDC_ADS_SCA_2_OUT" (
	"KEY" NUMBER(19), 
...
FROM "DEGEN_XGTMUD_ADS_IMP_1_OUT" "ADS_imp_1_OUT") "ADS_sca_2_OUT") "U"
...
FROM "DEGEN_EDUGDC_ADS_SCA_2_OUT" "ADS_sca_2_OUT"), 
"DT_node_data" AS 
