...
-- Code For temporary table tmp_20180508181709_codegen_fl0pj3_ads_imp_1_out part 1. Create 


CREATE TEMPORARY TABLE tmp_20180508181709_codegen_fl0pj3_ads_imp_1_out (
	"KEY" BIGINT, 
	impter_2 DOUBLE, 
	impter_3 DOUBLE, 
	impter_4 DOUBLE, 
...
-- Code For temporary table tmp_20180508181709_codegen_pey1hr_ads_sca_2_out part 1. Create 


CREATE TEMPORARY TABLE tmp_20180508181709_codegen_pey1hr_ads_sca_2_out (
	"KEY" BIGINT, 
	scaler_2 DOUBLE, 
	scaler_3 DOUBLE, 
	scaler_4 DOUBLE, 
...
FROM tmp_20180508181709_codegen_fl0pj3_ads_imp_1_out AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT") AS "U"

-- Model deployment code

WITH random_number_cte AS 
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", rand() AS uniform 
FROM tmp_20180508181709_codegen_pey1hr_ads_sca_2_out AS "ADS_sca_2_OUT"), 
multinomial_cte AS 
