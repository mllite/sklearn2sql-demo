...
-- Code For temporary table tmp_20180602141815_9t4_ads_imp_1_out part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180602141815_9t4_ads_imp_1_out  (
	"KEY" BIGINT, 
...
-- Code For temporary table tmp_20180602141816_nua_ads_sca_2_out part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180602141816_nua_ads_sca_2_out  (
	"KEY" BIGINT, 
...
FROM tmp_20180602141815_9t4_ads_imp_1_out AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT") AS "U"

-- Model deployment code

WITH random_number_cte AS 
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", random() AS uniform 
FROM tmp_20180602141816_nua_ads_sca_2_out AS "ADS_sca_2_OUT"), 
multinomial_cte AS 
