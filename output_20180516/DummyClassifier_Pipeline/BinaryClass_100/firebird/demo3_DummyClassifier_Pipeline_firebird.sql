...
-- Code For temporary table TMP_20180508180248_CODEGEN_F6HE part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508180248_CODEGEN_F6HE" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20180508180248_CODEGEN_F6HE part 3. Create Index 

CREATE INDEX "ix_TMP_20180508180248_C_f976" ON "TMP_20180508180248_CODEGEN_F6HE" ("KEY")

-- Code For temporary table TMP_20180508180248_CODEGEN_9QBA part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508180248_CODEGEN_9QBA" (
	"KEY" BIGINT NOT NULL, 
...
FROM "TMP_20180508180248_CODEGEN_F6HE" AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT") AS "U"

-- Code For temporary table TMP_20180508180248_CODEGEN_9QBA part 3. Create Index 

CREATE INDEX "ix_TMP_20180508180248_C_7efb" ON "TMP_20180508180248_CODEGEN_9QBA" ("KEY")

-- Model deployment code

WITH random_number_cte AS 
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", rand AS uniform 
FROM "TMP_20180508180248_CODEGEN_9QBA" AS "ADS_sca_2_OUT"), 
multinomial_cte AS 
...
(SELECT multinomial_cte."KEY" AS "KEY", 0.525 AS "Proba_0", CASE WHEN (0.525 IS NULL OR 0.525 > 0.0) THEN ln(0.525) ELSE -1e+20 END AS "LogProba_0", 0.475 AS "Proba_1", CASE WHEN (0.475 IS NULL OR 0.475 > 0.0) THEN ln(0.475) ELSE -1e+20 END AS "LogProba_1", multinomial_cte.multinomial_expr AS "Decision" 
