...
-- Code For temporary table tmp_20180508195340_codegen_dosa93_ads_imp_1_out part 1. Create 


CREATE TABLE tmp_20180508195340_codegen_dosa93_ads_imp_1_out (
	`KEY` BIGINT, 
...
-- Code For temporary table tmp_20180508195340_codegen_dosa93_ads_imp_1_out part 2. Populate

INSERT INTO tmp_20180508195340_codegen_dosa93_ads_imp_1_out (`KEY`, imputer_output_2, imputer_output_3, imputer_output_4, imputer_output_5) SELECT `ADS_imp_1_OUT`.`KEY`, `ADS_imp_1_OUT`.imputer_output_2, `ADS_imp_1_OUT`.imputer_output_3, `ADS_imp_1_OUT`.imputer_output_4, `ADS_imp_1_OUT`.imputer_output_5 
...
-- Code For temporary table tmp_20180508195341_codegen_zerqbd_ads_sca_2_out part 1. Create 


CREATE TABLE tmp_20180508195341_codegen_zerqbd_ads_sca_2_out (
	`KEY` BIGINT, 
...
-- Code For temporary table tmp_20180508195341_codegen_zerqbd_ads_sca_2_out part 2. Populate

INSERT INTO tmp_20180508195341_codegen_zerqbd_ads_sca_2_out (`KEY`, scaler_output_2, scaler_output_3, scaler_output_4, scaler_output_5) SELECT `ADS_sca_2_OUT`.`KEY`, `ADS_sca_2_OUT`.scaler_output_2, `ADS_sca_2_OUT`.scaler_output_3, `ADS_sca_2_OUT`.scaler_output_4, `ADS_sca_2_OUT`.scaler_output_5 
...
FROM tmp_20180508195340_codegen_dosa93_ads_imp_1_out AS `ADS_imp_1_OUT`) AS `ADS_sca_2_OUT`

-- Model deployment code

WITH random_number_cte AS 
(SELECT `ADS_sca_2_OUT`.`KEY` AS `KEY`, rand() AS uniform 
FROM tmp_20180508195341_codegen_zerqbd_ads_sca_2_out AS `ADS_sca_2_OUT`), 
multinomial_cte AS 
