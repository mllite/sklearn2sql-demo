...
-- Code For temporary table TMP_20180508190049_CODEGEN_9W0C part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508190049_CODEGEN_9W0C" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20180508190049_CODEGEN_9W0C part 2. Populate

INSERT INTO "TMP_20180508190049_CODEGEN_9W0C" ("KEY", imputer_output_2, imputer_output_3, imputer_output_4, imputer_output_5) SELECT "U"."KEY", "U".imputer_output_2, "U".imputer_output_3, "U".imputer_output_4, "U".imputer_output_5 
...
-- Code For temporary table TMP_20180508190049_CODEGEN_9W0C part 3. Create Index 

CREATE INDEX "ix_TMP_20180508190049_C_0c49" ON "TMP_20180508190049_CODEGEN_9W0C" ("KEY")

-- Code For temporary table TMP_20180508190049_CODEGEN_D5MI part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508190049_CODEGEN_D5MI" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20180508190049_CODEGEN_D5MI part 2. Populate

INSERT INTO "TMP_20180508190049_CODEGEN_D5MI" ("KEY", scaler_output_2, scaler_output_3, scaler_output_4, scaler_output_5) SELECT "U"."KEY", "U".scaler_output_2, "U".scaler_output_3, "U".scaler_output_4, "U".scaler_output_5 
...
FROM "TMP_20180508190049_CODEGEN_9W0C" AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT") AS "U"

-- Code For temporary table TMP_20180508190049_CODEGEN_D5MI part 3. Create Index 

CREATE INDEX "ix_TMP_20180508190049_C_3af6" ON "TMP_20180508190049_CODEGEN_D5MI" ("KEY")

-- Model deployment code

WITH random_number_cte AS 
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", rand AS uniform 
FROM "TMP_20180508190049_CODEGEN_D5MI" AS "ADS_sca_2_OUT"), 
multinomial_cte AS 
...
(SELECT multinomial_cte."KEY" AS "KEY", 0.30833333333333335 AS "Proba_1789-07-14T00:00:00.000000000", CASE WHEN (0.30833333333333335 IS NULL OR 0.30833333333333335 > 0.0) THEN ln(0.30833333333333335) ELSE -1e+20 END AS "LogProba_1789-07-14T00:00:00.000000000", 0.3333333333333333 AS "Proba_1789-08-14T00:00:00.000000000", CASE WHEN (0.3333333333333333 IS NULL OR 0.3333333333333333 > 0.0) THEN ln(0.3333333333333333) ELSE -1e+20 END AS "LogProba_1789-08-14T00:00:00.000000000", 0.35833333333333334 AS "Proba_1789-09-14T00:00:00.000000000", CASE WHEN (0.35833333333333334 IS NULL OR 0.35833333333333334 > 0.0) THEN ln(0.35833333333333334) ELSE -1e+20 END AS "LogProba_1789-09-14T00:00:00.000000000", multinomial_cte.multinomial_expr AS "Decision" 
