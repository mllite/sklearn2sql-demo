...
-- Code For temporary table TMP_20180516_CODEGEN_JBGY43_ADS part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180516_CODEGEN_JBGY43_ADS" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20180516_CODEGEN_JBGY43_ADS part 3. Create Index 

CREATE INDEX "ix_TMP_20180516_CODEGEN_9663" ON "TMP_20180516_CODEGEN_JBGY43_ADS" ("KEY")

-- Code For temporary table TMP_20180516_CODEGEN_H6YHQ8_ADS part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180516_CODEGEN_H6YHQ8_ADS" (
	"KEY" BIGINT NOT NULL, 
...
FROM "TMP_20180516_CODEGEN_JBGY43_ADS" AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT") AS "U"

-- Code For temporary table TMP_20180516_CODEGEN_H6YHQ8_ADS part 3. Create Index 

CREATE INDEX "ix_TMP_20180516_CODEGEN_eb0e" ON "TMP_20180516_CODEGEN_H6YHQ8_ADS" ("KEY")

-- Model deployment code

WITH random_number_cte AS 
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", rand AS uniform 
FROM "TMP_20180516_CODEGEN_H6YHQ8_ADS" AS "ADS_sca_2_OUT"), 
multinomial_cte AS 
