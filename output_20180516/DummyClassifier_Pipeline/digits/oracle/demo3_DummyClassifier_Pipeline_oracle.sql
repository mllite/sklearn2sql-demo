...
-- Code For temporary table DEGEN_XKV678_ADS_IMP_1_OUT part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "DEGEN_XKV678_ADS_IMP_1_OUT" (
	"KEY" NUMBER(19), 
...
-- Code For temporary table DEGEN_T7URE3_ADS_SCA_2_OUT part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "DEGEN_T7URE3_ADS_SCA_2_OUT" (
	"KEY" NUMBER(19), 
...
FROM "DEGEN_XKV678_ADS_IMP_1_OUT" "ADS_imp_1_OUT") "ADS_sca_2_OUT") "U"

-- Model deployment code

WITH random_number_cte AS 
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", dbms_random.value AS uniform 
FROM "DEGEN_T7URE3_ADS_SCA_2_OUT" "ADS_sca_2_OUT"), 
multinomial_cte AS 
