...
-- Code For temporary table 20180602_7C4_ADS_IMP_1_OUT part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "20180602_7C4_ADS_IMP_1_OUT" (
	"KEY" NUMBER(19), 
...
-- Code For temporary table 20180602_BYT_ADS_SCA_2_OUT part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "20180602_BYT_ADS_SCA_2_OUT" (
	"KEY" NUMBER(19), 
...
FROM "20180602_7C4_ADS_IMP_1_OUT" "ADS_imp_1_OUT") "ADS_sca_2_OUT") "U"

-- Model deployment code

WITH random_number_cte AS 
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", dbms_random.value AS uniform 
FROM "20180602_BYT_ADS_SCA_2_OUT" "ADS_sca_2_OUT"), 
multinomial_cte AS 
...
(SELECT multinomial_cte."KEY" AS "KEY", 0.09603340292275574 AS "Proba_0", CASE WHEN (0.09603340292275574 IS NULL OR 0.09603340292275574 > 0.0) THEN ln(0.09603340292275574) ELSE -BINARY_DOUBLE_INFINITY END AS "LogProba_0", 0.1022964509394572 AS "Proba_1", CASE WHEN (0.1022964509394572 IS NULL OR 0.1022964509394572 > 0.0) THEN ln(0.1022964509394572) ELSE -BINARY_DOUBLE_INFINITY END AS "LogProba_1", 0.10299234516353514 AS "Proba_2", CASE WHEN (0.10299234516353514 IS NULL OR 0.10299234516353514 > 0.0) THEN ln(0.10299234516353514) ELSE -BINARY_DOUBLE_INFINITY END AS "LogProba_2", 0.10090466249130133 AS "Proba_3", CASE WHEN (0.10090466249130133 IS NULL OR 0.10090466249130133 > 0.0) THEN ln(0.10090466249130133) ELSE -BINARY_DOUBLE_INFINITY END AS "LogProba_3", 0.10508002783576896 AS "Proba_4", CASE WHEN (0.10508002783576896 IS NULL OR 0.10508002783576896 > 0.0) THEN ln(0.10508002783576896) ELSE -BINARY_DOUBLE_INFINITY END AS "LogProba_4", 0.10020876826722339 AS "Proba_5", CASE WHEN (0.10020876826722339 IS NULL OR 0.10020876826722339 > 0.0) THEN ln(0.10020876826722339) ELSE -BINARY_DOUBLE_INFINITY END AS "LogProba_5", 0.09881697981906751 AS "Proba_6", CASE WHEN (0.09881697981906751 IS NULL OR 0.09881697981906751 > 0.0) THEN ln(0.09881697981906751) ELSE -BINARY_DOUBLE_INFINITY END AS "LogProba_6", 0.09742519137091162 AS "Proba_7", CASE WHEN (0.09742519137091162 IS NULL OR 0.09742519137091162 > 0.0) THEN ln(0.09742519137091162) ELSE -BINARY_DOUBLE_INFINITY END AS "LogProba_7", 0.09394572025052192 AS "Proba_8", CASE WHEN (0.09394572025052192 IS NULL OR 0.09394572025052192 > 0.0) THEN ln(0.09394572025052192) ELSE -BINARY_DOUBLE_INFINITY END AS "LogProba_8", 0.1022964509394572 AS "Proba_9", CASE WHEN (0.1022964509394572 IS NULL OR 0.1022964509394572 > 0.0) THEN ln(0.1022964509394572) ELSE -BINARY_DOUBLE_INFINITY END AS "LogProba_9", multinomial_cte.multinomial_expr AS "Decision", CASE WHEN (multinomial_cte.multinomial_expr = 0) THEN NULL WHEN (multinomial_cte.multinomial_expr = 1) THEN NULL WHEN (multinomial_cte.multinomial_expr = 2) THEN NULL WHEN (multinomial_cte.multinomial_expr = 3) THEN NULL WHEN (multinomial_cte.multinomial_expr = 4) THEN NULL WHEN (multinomial_cte.multinomial_expr = 5) THEN NULL WHEN (multinomial_cte.multinomial_expr = 6) THEN NULL WHEN (multinomial_cte.multinomial_expr = 7) THEN NULL WHEN (multinomial_cte.multinomial_expr = 8) THEN NULL WHEN (multinomial_cte.multinomial_expr = 9) THEN NULL END AS "DecisionProba" 
FROM multinomial_cte)
 SELECT dummy_class_reg_cte."KEY" AS "KEY", CAST(NULL AS BINARY_DOUBLE) AS "Score_0", CAST(NULL AS BINARY_DOUBLE) AS "Score_1", CAST(NULL AS BINARY_DOUBLE) AS "Score_2", CAST(NULL AS BINARY_DOUBLE) AS "Score_3", CAST(NULL AS BINARY_DOUBLE) AS "Score_4", CAST(NULL AS BINARY_DOUBLE) AS "Score_5", CAST(NULL AS BINARY_DOUBLE) AS "Score_6", CAST(NULL AS BINARY_DOUBLE) AS "Score_7", CAST(NULL AS BINARY_DOUBLE) AS "Score_8", CAST(NULL AS BINARY_DOUBLE) AS "Score_9", dummy_class_reg_cte."Proba_0" AS "Proba_0", dummy_class_reg_cte."Proba_1" AS "Proba_1", dummy_class_reg_cte."Proba_2" AS "Proba_2", dummy_class_reg_cte."Proba_3" AS "Proba_3", dummy_class_reg_cte."Proba_4" AS "Proba_4", dummy_class_reg_cte."Proba_5" AS "Proba_5", dummy_class_reg_cte."Proba_6" AS "Proba_6", dummy_class_reg_cte."Proba_7" AS "Proba_7", dummy_class_reg_cte."Proba_8" AS "Proba_8", dummy_class_reg_cte."Proba_9" AS "Proba_9", dummy_class_reg_cte."LogProba_0" AS "LogProba_0", dummy_class_reg_cte."LogProba_1" AS "LogProba_1", dummy_class_reg_cte."LogProba_2" AS "LogProba_2", dummy_class_reg_cte."LogProba_3" AS "LogProba_3", dummy_class_reg_cte."LogProba_4" AS "LogProba_4", dummy_class_reg_cte."LogProba_5" AS "LogProba_5", dummy_class_reg_cte."LogProba_6" AS "LogProba_6", dummy_class_reg_cte."LogProba_7" AS "LogProba_7", dummy_class_reg_cte."LogProba_8" AS "LogProba_8", dummy_class_reg_cte."LogProba_9" AS "LogProba_9", dummy_class_reg_cte."Decision" AS "Decision", dummy_class_reg_cte."DecisionProba" AS "DecisionProba" 
