...
-- Code For temporary table tmp_20180602150458_udu_ads_imp_1_out part 1. Create 


CREATE TEMPORARY TABLE tmp_20180602150458_udu_ads_imp_1_out (
	"KEY" BIGINT, 
	impter_2 DOUBLE, 
	impter_3 DOUBLE, 
	impter_4 DOUBLE, 
...
-- Code For temporary table tmp_20180602150458_5b1_ads_sca_2_out part 1. Create 


CREATE TEMPORARY TABLE tmp_20180602150458_5b1_ads_sca_2_out (
	"KEY" BIGINT, 
	scaler_2 DOUBLE, 
	scaler_3 DOUBLE, 
	scaler_4 DOUBLE, 
...
FROM tmp_20180602150458_udu_ads_imp_1_out AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT") AS "U"

-- Model deployment code

WITH random_number_cte AS 
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", rand() AS uniform 
FROM tmp_20180602150458_5b1_ads_sca_2_out AS "ADS_sca_2_OUT"), 
multinomial_cte AS 
...
(SELECT multinomial_cte."KEY" AS "KEY", 0.09603340292275574 AS "Proba_0", log(CASE WHEN (0.09603340292275574 IS NULL OR 0.09603340292275574 > 1e-100) THEN 0.09603340292275574 ELSE 1e-100 END) AS "LogProba_0", 0.1022964509394572 AS "Proba_1", log(CASE WHEN (0.1022964509394572 IS NULL OR 0.1022964509394572 > 1e-100) THEN 0.1022964509394572 ELSE 1e-100 END) AS "LogProba_1", 0.10299234516353514 AS "Proba_2", log(CASE WHEN (0.10299234516353514 IS NULL OR 0.10299234516353514 > 1e-100) THEN 0.10299234516353514 ELSE 1e-100 END) AS "LogProba_2", 0.10090466249130133 AS "Proba_3", log(CASE WHEN (0.10090466249130133 IS NULL OR 0.10090466249130133 > 1e-100) THEN 0.10090466249130133 ELSE 1e-100 END) AS "LogProba_3", 0.10508002783576896 AS "Proba_4", log(CASE WHEN (0.10508002783576896 IS NULL OR 0.10508002783576896 > 1e-100) THEN 0.10508002783576896 ELSE 1e-100 END) AS "LogProba_4", 0.10020876826722339 AS "Proba_5", log(CASE WHEN (0.10020876826722339 IS NULL OR 0.10020876826722339 > 1e-100) THEN 0.10020876826722339 ELSE 1e-100 END) AS "LogProba_5", 0.09881697981906751 AS "Proba_6", log(CASE WHEN (0.09881697981906751 IS NULL OR 0.09881697981906751 > 1e-100) THEN 0.09881697981906751 ELSE 1e-100 END) AS "LogProba_6", 0.09742519137091162 AS "Proba_7", log(CASE WHEN (0.09742519137091162 IS NULL OR 0.09742519137091162 > 1e-100) THEN 0.09742519137091162 ELSE 1e-100 END) AS "LogProba_7", 0.09394572025052192 AS "Proba_8", log(CASE WHEN (0.09394572025052192 IS NULL OR 0.09394572025052192 > 1e-100) THEN 0.09394572025052192 ELSE 1e-100 END) AS "LogProba_8", 0.1022964509394572 AS "Proba_9", log(CASE WHEN (0.1022964509394572 IS NULL OR 0.1022964509394572 > 1e-100) THEN 0.1022964509394572 ELSE 1e-100 END) AS "LogProba_9", multinomial_cte.multinomial_expr AS "Decision", CASE WHEN (multinomial_cte.multinomial_expr = 0) THEN NULL WHEN (multinomial_cte.multinomial_expr = 1) THEN NULL WHEN (multinomial_cte.multinomial_expr = 2) THEN NULL WHEN (multinomial_cte.multinomial_expr = 3) THEN NULL WHEN (multinomial_cte.multinomial_expr = 4) THEN NULL WHEN (multinomial_cte.multinomial_expr = 5) THEN NULL WHEN (multinomial_cte.multinomial_expr = 6) THEN NULL WHEN (multinomial_cte.multinomial_expr = 7) THEN NULL WHEN (multinomial_cte.multinomial_expr = 8) THEN NULL WHEN (multinomial_cte.multinomial_expr = 9) THEN NULL END AS "DecisionProba" 
