...
-- Code For temporary table TMP_20180508185545_CODEGEN_47BA part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508185545_CODEGEN_47BA" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20180508185545_CODEGEN_47BA part 2. Populate

INSERT INTO "TMP_20180508185545_CODEGEN_47BA" ("KEY", imputer_output_2, imputer_output_3, imputer_output_4, imputer_output_5) SELECT "U"."KEY", "U".imputer_output_2, "U".imputer_output_3, "U".imputer_output_4, "U".imputer_output_5 
...
-- Code For temporary table TMP_20180508185545_CODEGEN_47BA part 3. Create Index 

CREATE INDEX "ix_TMP_20180508185545_C_e3cd" ON "TMP_20180508185545_CODEGEN_47BA" ("KEY")

-- Code For temporary table TMP_20180508185545_CODEGEN_BJMA part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508185545_CODEGEN_BJMA" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20180508185545_CODEGEN_BJMA part 2. Populate

INSERT INTO "TMP_20180508185545_CODEGEN_BJMA" ("KEY", scaler_output_2, scaler_output_3, scaler_output_4, scaler_output_5) SELECT "U"."KEY", "U".scaler_output_2, "U".scaler_output_3, "U".scaler_output_4, "U".scaler_output_5 
...
FROM "TMP_20180508185545_CODEGEN_47BA" AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT") AS "U"

-- Code For temporary table TMP_20180508185545_CODEGEN_BJMA part 3. Create Index 

CREATE INDEX "ix_TMP_20180508185545_C_4f85" ON "TMP_20180508185545_CODEGEN_BJMA" ("KEY")
...
FROM "TMP_20180508185545_CODEGEN_BJMA" AS "ADS_sca_2_OUT"), 
"DT_node_data" AS 
