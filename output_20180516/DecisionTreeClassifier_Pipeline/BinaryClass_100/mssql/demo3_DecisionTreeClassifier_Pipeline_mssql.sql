...
-- Code For temporary table ##TMP_20180602141758_OEO_ADS_imp_1_OUT part 1. Create 


CREATE TABLE ##TMP_20180602141758_OEO_ADS_imp_1_OUT (
	[KEY] BIGINT NULL, 
...
-- Code For temporary table ##TMP_20180602141758_MO8_ADS_sca_2_OUT part 1. Create 


CREATE TABLE ##TMP_20180602141758_MO8_ADS_sca_2_OUT (
	[KEY] BIGINT NULL, 
	scaler_2 FLOAT NULL, 
	scaler_3 FLOAT NULL, 
	scaler_4 FLOAT NULL, 
...
FROM ##TMP_20180602141758_OEO_ADS_imp_1_OUT AS [ADS_imp_1_OUT]) AS [ADS_sca_2_OUT]
...
FROM ##TMP_20180602141758_MO8_ADS_sca_2_OUT AS [ADS_sca_2_OUT]), 
[DT_node_data] AS 
