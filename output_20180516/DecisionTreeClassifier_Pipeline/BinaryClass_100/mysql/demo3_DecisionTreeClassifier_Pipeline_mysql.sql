...
-- Code For temporary table TMP_20180508180233_CODEGEN_E0FZ3G_ADS_imp_1_OUT part 1. Create 


CREATE TEMPORARY TABLE `TMP_20180508180233_CODEGEN_E0FZ3G_ADS_imp_1_OUT` (
	`KEY` BIGINT NOT NULL, 
	impter_2 DOUBLE, 
	impter_3 DOUBLE, 
	impter_4 DOUBLE, 
...
-- Code For temporary table TMP_20180508180233_CODEGEN_E0FZ3G_ADS_imp_1_OUT part 3. Create Index 

CREATE INDEX `ix_TMP_20180508180233_CODEGEN_E0FZ3G_ADS_imp_1_OUT_KEY` ON `TMP_20180508180233_CODEGEN_E0FZ3G_ADS_imp_1_OUT` (`KEY`)

-- Code For temporary table TMP_20180508180233_CODEGEN_W8XY9D_ADS_sca_2_OUT part 1. Create 


CREATE TEMPORARY TABLE `TMP_20180508180233_CODEGEN_W8XY9D_ADS_sca_2_OUT` (
	`KEY` BIGINT NOT NULL, 
	scaler_2 DOUBLE, 
	scaler_3 DOUBLE, 
	scaler_4 DOUBLE, 
...
FROM `TMP_20180508180233_CODEGEN_E0FZ3G_ADS_imp_1_OUT` AS `ADS_imp_1_OUT`) AS `ADS_sca_2_OUT`) AS `U`

-- Code For temporary table TMP_20180508180233_CODEGEN_W8XY9D_ADS_sca_2_OUT part 3. Create Index 

CREATE INDEX `ix_TMP_20180508180233_CODEGEN_W8XY9D_ADS_sca_2_OUT_KEY` ON `TMP_20180508180233_CODEGEN_W8XY9D_ADS_sca_2_OUT` (`KEY`)
...
FROM `TMP_20180508180233_CODEGEN_W8XY9D_ADS_sca_2_OUT` AS `ADS_sca_2_OUT`), 
`DT_node_data` AS 
