...
-- Code For temporary table TMP_20180508180234_CODEGEN_VIQZ part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508180234_CODEGEN_VIQZ" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20180508180234_CODEGEN_VIQZ part 3. Create Index 

CREATE INDEX "ix_TMP_20180508180234_C_4948" ON "TMP_20180508180234_CODEGEN_VIQZ" ("KEY")

-- Code For temporary table TMP_20180508180234_CODEGEN_BLNM part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508180234_CODEGEN_BLNM" (
	"KEY" BIGINT NOT NULL, 
...
FROM "TMP_20180508180234_CODEGEN_VIQZ" AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT") AS "U"

-- Code For temporary table TMP_20180508180234_CODEGEN_BLNM part 3. Create Index 

CREATE INDEX "ix_TMP_20180508180234_C_8779" ON "TMP_20180508180234_CODEGEN_BLNM" ("KEY")
...
FROM "TMP_20180508180234_CODEGEN_BLNM" AS "ADS_sca_2_OUT"), 
"DT_node_data" AS 
...
FROM "DT_node_lookup" LEFT OUTER JOIN "DT_node_data" ON "DT_node_lookup".node_id_2 = "DT_node_data".nid)
 SELECT "DT_Output"."KEY" AS "KEY", CAST(NULL AS DOUBLE PRECISION) AS "Score_0", CAST(NULL AS DOUBLE PRECISION) AS "Score_1", "DT_Output"."P_0" AS "Proba_0", "DT_Output"."P_1" AS "Proba_1", CASE WHEN ("DT_Output"."P_0" IS NULL OR "DT_Output"."P_0" > 0.0) THEN ln("DT_Output"."P_0") ELSE -1e+20 END AS "LogProba_0", CASE WHEN ("DT_Output"."P_1" IS NULL OR "DT_Output"."P_1" > 0.0) THEN ln("DT_Output"."P_1") ELSE -1e+20 END AS "LogProba_1", "DT_Output"."D" AS "Decision", "DT_Output"."DP" AS "DecisionProba" 
FROM "DT_Output"