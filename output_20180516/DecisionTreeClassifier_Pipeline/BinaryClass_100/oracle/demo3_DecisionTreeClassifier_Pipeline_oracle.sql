...
-- Code For temporary table DEGEN_UL7YJX_ADS_IMP_1_OUT part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "DEGEN_UL7YJX_ADS_IMP_1_OUT" (
	"KEY" NUMBER(19), 
...
-- Code For temporary table DEGEN_DASNRM_ADS_SCA_2_OUT part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "DEGEN_DASNRM_ADS_SCA_2_OUT" (
	"KEY" NUMBER(19), 
...
FROM "DEGEN_UL7YJX_ADS_IMP_1_OUT" "ADS_imp_1_OUT") "ADS_sca_2_OUT") "U"
...
FROM "DEGEN_DASNRM_ADS_SCA_2_OUT" "ADS_sca_2_OUT"), 
"DT_node_data" AS 
