...
-- Code For temporary table tmp_20180516112927_codegen_gecxsm_ads_imp_1_out part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180516112927_codegen_gecxsm_ads_imp_1_out  (
	"KEY" BIGINT, 
...
-- Code For temporary table tmp_20180516112927_codegen_c2k3dn_ads_sca_2_out part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180516112927_codegen_c2k3dn_ads_sca_2_out  (
	"KEY" BIGINT, 
...
FROM tmp_20180516112927_codegen_gecxsm_ads_imp_1_out AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT") AS "U"
...
FROM tmp_20180516112927_codegen_c2k3dn_ads_sca_2_out AS "ADS_sca_2_OUT"), 
dummy_cte AS 
