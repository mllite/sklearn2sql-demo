...
-- Code For temporary table TMP_20180516_CODEGEN_LP8OW0_ADS part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180516_CODEGEN_LP8OW0_ADS" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20180516_CODEGEN_LP8OW0_ADS part 2. Populate

INSERT INTO "TMP_20180516_CODEGEN_LP8OW0_ADS" ("KEY", imputer_output_2, imputer_output_3, imputer_output_4, imputer_output_5) SELECT "U"."KEY", "U".imputer_output_2, "U".imputer_output_3, "U".imputer_output_4, "U".imputer_output_5 
...
-- Code For temporary table TMP_20180516_CODEGEN_LP8OW0_ADS part 3. Create Index 

CREATE INDEX "ix_TMP_20180516_CODEGEN_60c3" ON "TMP_20180516_CODEGEN_LP8OW0_ADS" ("KEY")

-- Code For temporary table TMP_20180516_CODEGEN_4E2I6F_ADS part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180516_CODEGEN_4E2I6F_ADS" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20180516_CODEGEN_4E2I6F_ADS part 2. Populate

INSERT INTO "TMP_20180516_CODEGEN_4E2I6F_ADS" ("KEY", scaler_output_2, scaler_output_3, scaler_output_4, scaler_output_5) SELECT "U"."KEY", "U".scaler_output_2, "U".scaler_output_3, "U".scaler_output_4, "U".scaler_output_5 
...
FROM "TMP_20180516_CODEGEN_LP8OW0_ADS" AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT") AS "U"

-- Code For temporary table TMP_20180516_CODEGEN_4E2I6F_ADS part 3. Create Index 

CREATE INDEX "ix_TMP_20180516_CODEGEN_3d49" ON "TMP_20180516_CODEGEN_4E2I6F_ADS" ("KEY")
...
FROM "TMP_20180516_CODEGEN_4E2I6F_ADS" AS "ADS_sca_2_OUT"), 
"DT_node_data" AS 
