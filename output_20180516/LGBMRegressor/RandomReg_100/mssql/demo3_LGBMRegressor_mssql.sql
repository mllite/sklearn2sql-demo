...
-- Code For temporary table ##TMP_20180602144918_25V_LGBM_B0 part 1. Create 


CREATE TABLE ##TMP_20180602144918_25V_LGBM_B0 (
	[KEY] BIGINT NULL, 
...
-- Code For temporary table ##TMP_20180602144918_25V_LGBM_B0 part 2. Populate
...
FROM [DT_Output_9])
 INSERT INTO ##TMP_20180602144918_25V_LGBM_B0 ([KEY], [Estimator]) SELECT [LGBM_B0].[KEY], [LGBM_B0].[Estimator] 
...
-- Code For temporary table ##TMP_20180602144918_3J3_LGBM_B1 part 1. Create 


CREATE TABLE ##TMP_20180602144918_3J3_LGBM_B1 (
	[KEY] BIGINT NULL, 
	[Estimator] FLOAT(53) NULL
)
...
-- Code For temporary table ##TMP_20180602144918_3J3_LGBM_B1 part 2. Populate
...
FROM [DT_Output_15])
 INSERT INTO ##TMP_20180602144918_3J3_LGBM_B1 ([KEY], [Estimator]) SELECT [LGBM_B1].[KEY], [LGBM_B1].[Estimator] 
...
-- Code For temporary table ##TMP_20180602144918_CYZ_LGBM_sum part 1. Create 


CREATE TABLE ##TMP_20180602144918_CYZ_LGBM_sum (
	[KEY] BIGINT NULL, 
	[Estimator] FLOAT(53) NULL
)
...
-- Code For temporary table ##TMP_20180602144918_CYZ_LGBM_sum part 2. Populate
...
FROM ##TMP_20180602144918_25V_LGBM_B0 AS [LGBM_B0] UNION ALL SELECT [LGBM_B1].[KEY] AS [KEY], [LGBM_B1].[Estimator] AS [Estimator] 
FROM ##TMP_20180602144918_3J3_LGBM_B1 AS [LGBM_B1]) AS [LGBM_EnsembleUnion])
 INSERT INTO ##TMP_20180602144918_CYZ_LGBM_sum ([KEY], [Estimator]) SELECT [LGBM_sum].[KEY], [LGBM_sum].[Estimator] 
...
FROM ##TMP_20180602144918_CYZ_LGBM_sum AS [LGBM_sum]