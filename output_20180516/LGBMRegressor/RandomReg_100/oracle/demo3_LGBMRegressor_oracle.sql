...
-- Code For temporary table 619_CODEGEN_XKP3RR_LGBM_B0 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "619_CODEGEN_XKP3RR_LGBM_B0" (
	"KEY" NUMBER(19), 
...
-- Code For temporary table 619_CODEGEN_XKP3RR_LGBM_B0 part 2. Populate

INSERT INTO "619_CODEGEN_XKP3RR_LGBM_B0" ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
"DT_node_data_1" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Estimator" AS BINARY_DOUBLE) AS "Estimator" 
FROM (SELECT 2 AS nid, -6.643302178382874 AS "Estimator" FROM DUAL UNION ALL SELECT 6 AS nid, 2.4311114964385827 AS "Estimator" FROM DUAL UNION ALL SELECT 7 AS nid, 9.040610008239746 AS "Estimator" FROM DUAL) "Values"), 
"DT_Output_1" AS 
...
"DT_node_data_2" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Estimator" AS BINARY_DOUBLE) AS "Estimator" 
FROM (SELECT 2 AS nid, -6.311137093438043 AS "Estimator" FROM DUAL UNION ALL SELECT 6 AS nid, 1.6578517192602158 AS "Estimator" FROM DUAL UNION ALL SELECT 7 AS nid, 8.085162813464802 AS "Estimator" FROM DUAL) "Values"), 
"DT_Output_2" AS 
...
"DT_node_data_3" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Estimator" AS BINARY_DOUBLE) AS "Estimator" 
FROM (SELECT 2 AS nid, -5.995580262607999 AS "Estimator" FROM DUAL UNION ALL SELECT 6 AS nid, 8.341395540237427 AS "Estimator" FROM DUAL UNION ALL SELECT 7 AS nid, 2.042207623521487 AS "Estimator" FROM DUAL) "Values"), 
"DT_Output_3" AS 
...
"DT_node_data_4" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Estimator" AS BINARY_DOUBLE) AS "Estimator" 
FROM (SELECT 2 AS nid, -6.698543651898702 AS "Estimator" FROM DUAL UNION ALL SELECT 6 AS nid, 0.8931106705218554 AS "Estimator" FROM DUAL UNION ALL SELECT 7 AS nid, 7.997691215168347 AS "Estimator" FROM DUAL) "Values"), 
"DT_Output_4" AS 
...
"DT_node_data_5" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Estimator" AS BINARY_DOUBLE) AS "Estimator" 
FROM (SELECT 2 AS nid, -7.1020388038070115 AS "Estimator" FROM DUAL UNION ALL SELECT 6 AS nid, -0.8222793996334077 AS "Estimator" FROM DUAL UNION ALL SELECT 7 AS nid, 6.531966066733003 AS "Estimator" FROM DUAL) "Values"), 
"DT_Output_5" AS 
...
"DT_node_data_6" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Estimator" AS BINARY_DOUBLE) AS "Estimator" 
FROM (SELECT 2 AS nid, -5.385779366890589 AS "Estimator" FROM DUAL UNION ALL SELECT 6 AS nid, 7.3185147981752054 AS "Estimator" FROM DUAL UNION ALL SELECT 7 AS nid, 1.4945787234739825 AS "Estimator" FROM DUAL) "Values"), 
"DT_Output_6" AS 
...
"DT_node_data_7" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Estimator" AS BINARY_DOUBLE) AS "Estimator" 
FROM (SELECT 2 AS nid, -6.693298738974112 AS "Estimator" FROM DUAL UNION ALL SELECT 6 AS nid, -0.7941725503830683 AS "Estimator" FROM DUAL UNION ALL SELECT 7 AS nid, 6.16864653583616 AS "Estimator" FROM DUAL) "Values"), 
"DT_Output_7" AS 
...
"DT_node_data_8" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Estimator" AS BINARY_DOUBLE) AS "Estimator" 
FROM (SELECT 2 AS nid, -5.923788514931997 AS "Estimator" FROM DUAL UNION ALL SELECT 6 AS nid, 0.8855262850012098 AS "Estimator" FROM DUAL UNION ALL SELECT 7 AS nid, 6.950860058177601 AS "Estimator" FROM DUAL) "Values"), 
"DT_Output_8" AS 
...
"DT_node_data_9" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Estimator" AS BINARY_DOUBLE) AS "Estimator" 
FROM (SELECT 2 AS nid, -6.224994532267253 AS "Estimator" FROM DUAL UNION ALL SELECT 6 AS nid, -0.7592293239775159 AS "Estimator" FROM DUAL UNION ALL SELECT 7 AS nid, 5.750583467073739 AS "Estimator" FROM DUAL) "Values"), 
"DT_Output_9" AS 
...
-- Code For temporary table 619_CODEGEN_NLML0D_LGBM_B1 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "619_CODEGEN_NLML0D_LGBM_B1" (
	"KEY" NUMBER(19), 
	"Estimator" BINARY_DOUBLE
)
...
-- Code For temporary table 619_CODEGEN_NLML0D_LGBM_B1 part 2. Populate

INSERT INTO "619_CODEGEN_NLML0D_LGBM_B1" ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
"DT_node_data_10" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Estimator" AS BINARY_DOUBLE) AS "Estimator" 
FROM (SELECT 2 AS nid, -4.456614064558958 AS "Estimator" FROM DUAL UNION ALL SELECT 6 AS nid, 7.188853326297942 AS "Estimator" FROM DUAL UNION ALL SELECT 7 AS nid, 1.1421011114120485 AS "Estimator" FROM DUAL) "Values"), 
"DT_Output_10" AS 
...
"DT_node_data_11" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Estimator" AS BINARY_DOUBLE) AS "Estimator" 
FROM (SELECT 2 AS nid, -5.520293836593628 AS "Estimator" FROM DUAL UNION ALL SELECT 6 AS nid, 0.39359403967857365 AS "Estimator" FROM DUAL UNION ALL SELECT 7 AS nid, 6.230758449554443 AS "Estimator" FROM DUAL) "Values"), 
"DT_Output_11" AS 
...
"DT_node_data_12" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Estimator" AS BINARY_DOUBLE) AS "Estimator" 
FROM (SELECT 2 AS nid, -5.825511769895201 AS "Estimator" FROM DUAL UNION ALL SELECT 6 AS nid, 0.5590839900753716 AS "Estimator" FROM DUAL UNION ALL SELECT 7 AS nid, 6.941952195167542 AS "Estimator" FROM DUAL) "Values"), 
"DT_Output_12" AS 
...
"DT_node_data_13" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Estimator" AS BINARY_DOUBLE) AS "Estimator" 
FROM (SELECT 2 AS nid, -5.197728889783224 AS "Estimator" FROM DUAL UNION ALL SELECT 6 AS nid, 0.3715192291736603 AS "Estimator" FROM DUAL UNION ALL SELECT 7 AS nid, 5.8657554931640625 AS "Estimator" FROM DUAL) "Values"), 
"DT_Output_13" AS 
...
"DT_node_data_14" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Estimator" AS BINARY_DOUBLE) AS "Estimator" 
FROM (SELECT 2 AS nid, -4.056467017913476 AS "Estimator" FROM DUAL UNION ALL SELECT 6 AS nid, 6.61835606779371 AS "Estimator" FROM DUAL UNION ALL SELECT 7 AS nid, 0.9608367323875427 AS "Estimator" FROM DUAL) "Values"), 
"DT_Output_14" AS 
...
"DT_node_data_15" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Estimator" AS BINARY_DOUBLE) AS "Estimator" 
FROM (SELECT 2 AS nid, -5.452503826000072 AS "Estimator" FROM DUAL UNION ALL SELECT 6 AS nid, 0.5112158493562178 AS "Estimator" FROM DUAL UNION ALL SELECT 7 AS nid, 6.517374126911164 AS "Estimator" FROM DUAL) "Values"), 
"DT_Output_15" AS 
...
-- Code For temporary table _CODEGEN_KNM27N_LGBM_UNION part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "_CODEGEN_KNM27N_LGBM_UNION" (
	"KEY" NUMBER(19), 
	"Estimator" BINARY_DOUBLE
)
...
-- Code For temporary table _CODEGEN_KNM27N_LGBM_UNION part 2. Populate

INSERT INTO "_CODEGEN_KNM27N_LGBM_UNION" ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
FROM "619_CODEGEN_XKP3RR_LGBM_B0" "LGBM_B0" UNION ALL SELECT "LGBM_B1"."KEY" AS "KEY", "LGBM_B1"."Estimator" AS "Estimator" 
FROM "619_CODEGEN_NLML0D_LGBM_B1" "LGBM_B1") "LGBM_EnsembleUnion") "LGBM_Union") "U"

-- Code For temporary table 19_CODEGEN_ZO2M9J_LGBM_SUM part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "19_CODEGEN_ZO2M9J_LGBM_SUM" (
	"KEY" NUMBER(19), 
	"Estimator" BINARY_DOUBLE
)
...
-- Code For temporary table 19_CODEGEN_ZO2M9J_LGBM_SUM part 2. Populate

INSERT INTO "19_CODEGEN_ZO2M9J_LGBM_SUM" ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
FROM "_CODEGEN_KNM27N_LGBM_UNION" "LGBM_Union" GROUP BY "LGBM_Union"."KEY") "T") "LGBM_sum") "U"

-- Model deployment code

SELECT "LGBM_sum"."KEY" AS "KEY", "LGBM_sum"."Estimator" AS "Estimator" 
FROM "19_CODEGEN_ZO2M9J_LGBM_SUM" "LGBM_sum"