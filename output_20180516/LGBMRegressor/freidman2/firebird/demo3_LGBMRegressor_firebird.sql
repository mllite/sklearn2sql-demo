...
-- Code For temporary table TMP_20180516_CODEGEN_K8BBW2_LGB part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180516_CODEGEN_K8BBW2_LGB" (
	"KEY" BIGINT, 
...
-- Code For temporary table TMP_20180516_CODEGEN_K8BBW2_LGB part 2. Populate

INSERT INTO "TMP_20180516_CODEGEN_K8BBW2_LGB" ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
-- Code For temporary table TMP_20180516_CODEGEN_2RW5F8_LGB part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180516_CODEGEN_2RW5F8_LGB" (
	"KEY" BIGINT, 
	"Estimator" DOUBLE PRECISION
)
...
-- Code For temporary table TMP_20180516_CODEGEN_2RW5F8_LGB part 2. Populate

INSERT INTO "TMP_20180516_CODEGEN_2RW5F8_LGB" ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
-- Code For temporary table TMP_20180516_CODEGEN_AV5J2P_LGB part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180516_CODEGEN_AV5J2P_LGB" (
	"KEY" BIGINT NOT NULL, 
	"Estimator" DOUBLE PRECISION, 
	PRIMARY KEY ("KEY")
)
...
-- Code For temporary table TMP_20180516_CODEGEN_AV5J2P_LGB part 2. Populate

INSERT INTO "TMP_20180516_CODEGEN_AV5J2P_LGB" ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
FROM "TMP_20180516_CODEGEN_K8BBW2_LGB" AS "LGBM_B0" UNION ALL SELECT "LGBM_B1"."KEY" AS "KEY", "LGBM_B1"."Estimator" AS "Estimator" 
FROM "TMP_20180516_CODEGEN_2RW5F8_LGB" AS "LGBM_B1") AS "LGBM_EnsembleUnion")
...
-- Code For temporary table TMP_20180516_CODEGEN_AV5J2P_LGB part 3. Create Index 

CREATE INDEX "ix_TMP_20180516_CODEGEN_9aa6" ON "TMP_20180516_CODEGEN_AV5J2P_LGB" ("KEY")

-- Model deployment code

SELECT "LGBM_sum"."KEY" AS "KEY", "LGBM_sum"."Estimator" AS "Estimator" 
FROM "TMP_20180516_CODEGEN_AV5J2P_LGB" AS "LGBM_sum"