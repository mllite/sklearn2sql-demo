...
-- Code For temporary table 829_CODEGEN_NI8P9X_LGBM_B0 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "829_CODEGEN_NI8P9X_LGBM_B0" (
	"KEY" NUMBER(19), 
...
-- Code For temporary table 829_CODEGEN_NI8P9X_LGBM_B0 part 2. Populate

INSERT INTO "829_CODEGEN_NI8P9X_LGBM_B0" ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
"DT_node_data_1" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Estimator" AS BINARY_DOUBLE) AS "Estimator" 
FROM (SELECT 2 AS nid, -15.388802726180465 AS "Estimator" FROM DUAL UNION ALL SELECT 6 AS nid, -8.543858757019043 AS "Estimator" FROM DUAL UNION ALL SELECT 7 AS nid, 17.768935145753805 AS "Estimator" FROM DUAL) "Values"), 
"DT_Output_1" AS 
...
"DT_node_data_2" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Estimator" AS BINARY_DOUBLE) AS "Estimator" 
FROM (SELECT 2 AS nid, -10.726046767601602 AS "Estimator" FROM DUAL UNION ALL SELECT 6 AS nid, -1.667014275278364 AS "Estimator" FROM DUAL UNION ALL SELECT 7 AS nid, 22.666155967712402 AS "Estimator" FROM DUAL) "Values"), 
"DT_Output_2" AS 
...
"DT_node_data_3" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Estimator" AS BINARY_DOUBLE) AS "Estimator" 
FROM (SELECT 2 AS nid, -14.083060087981048 AS "Estimator" FROM DUAL UNION ALL SELECT 6 AS nid, -7.920077376365661 AS "Estimator" FROM DUAL UNION ALL SELECT 7 AS nid, 16.322550692702787 AS "Estimator" FROM DUAL) "Values"), 
"DT_Output_3" AS 
...
"DT_node_data_4" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Estimator" AS BINARY_DOUBLE) AS "Estimator" 
FROM (SELECT 2 AS nid, -9.797968453627368 AS "Estimator" FROM DUAL UNION ALL SELECT 6 AS nid, -1.5339828502564203 AS "Estimator" FROM DUAL UNION ALL SELECT 7 AS nid, 20.71672082901001 AS "Estimator" FROM DUAL) "Values"), 
"DT_Output_4" AS 
...
"DT_node_data_5" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Estimator" AS BINARY_DOUBLE) AS "Estimator" 
FROM (SELECT 2 AS nid, -11.884413646062216 AS "Estimator" FROM DUAL UNION ALL SELECT 6 AS nid, -4.85117790482261 AS "Estimator" FROM DUAL UNION ALL SELECT 7 AS nid, 16.544940138714654 AS "Estimator" FROM DUAL) "Values"), 
"DT_Output_5" AS 
...
"DT_node_data_6" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Estimator" AS BINARY_DOUBLE) AS "Estimator" 
FROM (SELECT 2 AS nid, -12.490155735722295 AS "Estimator" FROM DUAL UNION ALL SELECT 6 AS nid, -4.6311378457546235 AS "Estimator" FROM DUAL UNION ALL SELECT 7 AS nid, 16.17902341570173 AS "Estimator" FROM DUAL) "Values"), 
"DT_Output_6" AS 
...
"DT_node_data_7" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Estimator" AS BINARY_DOUBLE) AS "Estimator" 
FROM (SELECT 2 AS nid, -11.86564800121166 AS "Estimator" FROM DUAL UNION ALL SELECT 6 AS nid, -6.660443513393402 AS "Estimator" FROM DUAL UNION ALL SELECT 7 AS nid, 13.744889736175537 AS "Estimator" FROM DUAL) "Values"), 
"DT_Output_7" AS 
...
"DT_node_data_8" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Estimator" AS BINARY_DOUBLE) AS "Estimator" 
FROM (SELECT 2 AS nid, -10.464329446156821 AS "Estimator" FROM DUAL UNION ALL SELECT 6 AS nid, -1.3253614552815756 AS "Estimator" FROM DUAL UNION ALL SELECT 7 AS nid, 17.684536533355715 AS "Estimator" FROM DUAL) "Values"), 
"DT_Output_8" AS 
...
"DT_node_data_9" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Estimator" AS BINARY_DOUBLE) AS "Estimator" 
FROM (SELECT 2 AS nid, -11.003009351094564 AS "Estimator" FROM DUAL UNION ALL SELECT 6 AS nid, -1.8635490983724594 AS "Estimator" FROM DUAL UNION ALL SELECT 7 AS nid, 16.98641973223005 AS "Estimator" FROM DUAL) "Values"), 
"DT_Output_9" AS 
...
-- Code For temporary table 829_CODEGEN_5RIBTC_LGBM_B1 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "829_CODEGEN_5RIBTC_LGBM_B1" (
	"KEY" NUMBER(19), 
	"Estimator" BINARY_DOUBLE
)
...
-- Code For temporary table 829_CODEGEN_5RIBTC_LGBM_B1 part 2. Populate

INSERT INTO "829_CODEGEN_5RIBTC_LGBM_B1" ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
FROM (WITH "DT_node_lookup_10" AS 
(SELECT "ADS"."KEY" AS "KEY", CASE WHEN ("ADS"."Feature_2" <= 0.5668879806967247) THEN 2 ELSE CASE WHEN ("ADS"."Feature_1" <= 989.364790234492) THEN 6 ELSE 7 END END AS node_id_2 
FROM "FREIDMAN2" "ADS"), 
"DT_node_data_10" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Estimator" AS BINARY_DOUBLE) AS "Estimator" 
FROM (SELECT 2 AS nid, -7.684462527739696 AS "Estimator" FROM DUAL UNION ALL SELECT 6 AS nid, -1.0598479997544061 AS "Estimator" FROM DUAL UNION ALL SELECT 7 AS nid, 16.097542555332183 AS "Estimator" FROM DUAL) "Values"), 
"DT_Output_10" AS 
...
"DT_node_data_11" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Estimator" AS BINARY_DOUBLE) AS "Estimator" 
FROM (SELECT 2 AS nid, -9.424456369082133 AS "Estimator" FROM DUAL UNION ALL SELECT 6 AS nid, -1.1272746229171753 AS "Estimator" FROM DUAL UNION ALL SELECT 7 AS nid, 15.827596826553345 AS "Estimator" FROM DUAL) "Values"), 
"DT_Output_11" AS 
...
"DT_node_data_12" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Estimator" AS BINARY_DOUBLE) AS "Estimator" 
FROM (SELECT 2 AS nid, -9.827890057033963 AS "Estimator" FROM DUAL UNION ALL SELECT 6 AS nid, -1.7008621197193863 AS "Estimator" FROM DUAL UNION ALL SELECT 7 AS nid, 15.22764831724621 AS "Estimator" FROM DUAL) "Values"), 
"DT_Output_12" AS 
...
"DT_node_data_13" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Estimator" AS BINARY_DOUBLE) AS "Estimator" 
FROM (SELECT 2 AS nid, -8.705650010108949 AS "Estimator" FROM DUAL UNION ALL SELECT 6 AS nid, -1.914779907685739 AS "Estimator" FROM DUAL UNION ALL SELECT 7 AS nid, 13.60298085504252 AS "Estimator" FROM DUAL) "Values"), 
"DT_Output_13" AS 
...
"DT_node_data_14" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Estimator" AS BINARY_DOUBLE) AS "Estimator" 
FROM (SELECT 2 AS nid, -9.089848415939896 AS "Estimator" FROM DUAL UNION ALL SELECT 6 AS nid, -1.5957981877028944 AS "Estimator" FROM DUAL UNION ALL SELECT 7 AS nid, 14.118640418279739 AS "Estimator" FROM DUAL) "Values"), 
"DT_Output_14" AS 
...
"DT_node_data_15" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Estimator" AS BINARY_DOUBLE) AS "Estimator" 
FROM (SELECT 2 AS nid, -8.770652904333891 AS "Estimator" FROM DUAL UNION ALL SELECT 6 AS nid, -4.67874755859375 AS "Estimator" FROM DUAL UNION ALL SELECT 7 AS nid, 10.470666643232107 AS "Estimator" FROM DUAL) "Values"), 
"DT_Output_15" AS 
...
-- Code For temporary table _CODEGEN_J5M1H9_LGBM_UNION part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "_CODEGEN_J5M1H9_LGBM_UNION" (
	"KEY" NUMBER(19), 
	"Estimator" BINARY_DOUBLE
)
...
-- Code For temporary table _CODEGEN_J5M1H9_LGBM_UNION part 2. Populate

INSERT INTO "_CODEGEN_J5M1H9_LGBM_UNION" ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
FROM "829_CODEGEN_NI8P9X_LGBM_B0" "LGBM_B0" UNION ALL SELECT "LGBM_B1"."KEY" AS "KEY", "LGBM_B1"."Estimator" AS "Estimator" 
FROM "829_CODEGEN_5RIBTC_LGBM_B1" "LGBM_B1") "LGBM_EnsembleUnion") "LGBM_Union") "U"

-- Code For temporary table 29_CODEGEN_YK0PNE_LGBM_SUM part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "29_CODEGEN_YK0PNE_LGBM_SUM" (
	"KEY" NUMBER(19), 
	"Estimator" BINARY_DOUBLE
)
...
-- Code For temporary table 29_CODEGEN_YK0PNE_LGBM_SUM part 2. Populate

INSERT INTO "29_CODEGEN_YK0PNE_LGBM_SUM" ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
FROM "_CODEGEN_J5M1H9_LGBM_UNION" "LGBM_Union" GROUP BY "LGBM_Union"."KEY") "T") "LGBM_sum") "U"

-- Model deployment code

SELECT "LGBM_sum"."KEY" AS "KEY", "LGBM_sum"."Estimator" AS "Estimator" 
FROM "29_CODEGEN_YK0PNE_LGBM_SUM" "LGBM_sum"