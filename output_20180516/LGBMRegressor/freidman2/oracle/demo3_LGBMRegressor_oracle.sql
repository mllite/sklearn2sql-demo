...
-- Code For temporary table 516_CODEGEN_XNSYG7_LGBM_B0 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "516_CODEGEN_XNSYG7_LGBM_B0" (
	"KEY" NUMBER(19), 
...
-- Code For temporary table 516_CODEGEN_XNSYG7_LGBM_B0 part 2. Populate

INSERT INTO "516_CODEGEN_XNSYG7_LGBM_B0" ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
-- Code For temporary table 516_CODEGEN_JV4I1X_LGBM_B1 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "516_CODEGEN_JV4I1X_LGBM_B1" (
	"KEY" NUMBER(19), 
	"Estimator" BINARY_DOUBLE
)
...
-- Code For temporary table 516_CODEGEN_JV4I1X_LGBM_B1 part 2. Populate

INSERT INTO "516_CODEGEN_JV4I1X_LGBM_B1" ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
-- Code For temporary table 16_CODEGEN_78U43W_LGBM_SUM part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "16_CODEGEN_78U43W_LGBM_SUM" (
	"KEY" NUMBER(19), 
	"Estimator" BINARY_DOUBLE
)
...
-- Code For temporary table 16_CODEGEN_78U43W_LGBM_SUM part 2. Populate

INSERT INTO "16_CODEGEN_78U43W_LGBM_SUM" ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
FROM "516_CODEGEN_XNSYG7_LGBM_B0" "LGBM_B0" UNION ALL SELECT "LGBM_B1"."KEY" AS "KEY", "LGBM_B1"."Estimator" AS "Estimator" 
FROM "516_CODEGEN_JV4I1X_LGBM_B1" "LGBM_B1") "LGBM_EnsembleUnion")
...
FROM "16_CODEGEN_78U43W_LGBM_SUM" "LGBM_sum"