...
-- Code For temporary table tmp_20180602152244_eog_lgbm_b0 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180602152244_eog_lgbm_b0 (
	"KEY" BIGINT, 
	"Estimator" DOUBLE
)
...
-- Code For temporary table tmp_20180602152244_eog_lgbm_b0 part 2. Populate

INSERT INTO tmp_20180602152244_eog_lgbm_b0 WITH "DT_node_lookup" AS 
...
-- Code For temporary table tmp_20180602152244_k9l_lgbm_b1 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180602152244_k9l_lgbm_b1 (
	"KEY" BIGINT, 
	"Estimator" DOUBLE
)
...
-- Code For temporary table tmp_20180602152244_k9l_lgbm_b1 part 2. Populate

INSERT INTO tmp_20180602152244_k9l_lgbm_b1 WITH "DT_node_lookup_10" AS 
(SELECT "ADS"."KEY" AS "KEY", CASE WHEN ("ADS"."Feature_2" <= 0.3052070585017281) THEN 2 ELSE CASE WHEN ("ADS"."Feature_0" <= 49.232675914117046) THEN 6 ELSE 7 END END AS node_id_2 
FROM "FREIDMAN3" AS "ADS"), 
"DT_node_data_10" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Estimator" AS DOUBLE) AS "Estimator" 
...
-- Code For temporary table tmp_20180602152244_klb_lgbm_sum part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180602152244_klb_lgbm_sum (
	"KEY" BIGINT, 
	"Estimator" DOUBLE
)
...
-- Code For temporary table tmp_20180602152244_klb_lgbm_sum part 2. Populate

INSERT INTO tmp_20180602152244_klb_lgbm_sum WITH "LGBM_Union" AS 
...
FROM tmp_20180602152244_eog_lgbm_b0 AS "LGBM_B0" UNION ALL SELECT "LGBM_B1"."KEY" AS "KEY", "LGBM_B1"."Estimator" AS "Estimator" 
FROM tmp_20180602152244_k9l_lgbm_b1 AS "LGBM_B1") AS "LGBM_EnsembleUnion")
...
FROM tmp_20180602152244_klb_lgbm_sum AS "LGBM_sum"