...
-- Code For temporary table tmp_20180508185209_codegen_mxdmmq_lgbm_b0 part 1. Create 


CREATE TEMPORARY TABLE tmp_20180508185209_codegen_mxdmmq_lgbm_b0 (
	"KEY" BIGINT, 
	"Estimator" DOUBLE
)
...
-- Code For temporary table tmp_20180508185209_codegen_mxdmmq_lgbm_b0 part 2. Populate

INSERT INTO tmp_20180508185209_codegen_mxdmmq_lgbm_b0 ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
-- Code For temporary table tmp_20180508185209_codegen_afg17i_lgbm_b1 part 1. Create 


CREATE TEMPORARY TABLE tmp_20180508185209_codegen_afg17i_lgbm_b1 (
	"KEY" BIGINT, 
	"Estimator" DOUBLE
)
...
-- Code For temporary table tmp_20180508185209_codegen_afg17i_lgbm_b1 part 2. Populate

INSERT INTO tmp_20180508185209_codegen_afg17i_lgbm_b1 ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
-- Code For temporary table tmp_20180508185209_codegen_hf98dd_lgbm_union part 1. Create 


CREATE TEMPORARY TABLE tmp_20180508185209_codegen_hf98dd_lgbm_union (
	"KEY" BIGINT, 
	"Estimator" DOUBLE
)
...
-- Code For temporary table tmp_20180508185209_codegen_hf98dd_lgbm_union part 2. Populate

INSERT INTO tmp_20180508185209_codegen_hf98dd_lgbm_union ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
FROM tmp_20180508185209_codegen_mxdmmq_lgbm_b0 AS "LGBM_B0" UNION ALL SELECT "LGBM_B1"."KEY" AS "KEY", "LGBM_B1"."Estimator" AS "Estimator" 
FROM tmp_20180508185209_codegen_afg17i_lgbm_b1 AS "LGBM_B1") AS "LGBM_EnsembleUnion") AS "LGBM_Union") AS "U"

-- Code For temporary table tmp_20180508185209_codegen_jec7ht_lgbm_sum part 1. Create 


CREATE TEMPORARY TABLE tmp_20180508185209_codegen_jec7ht_lgbm_sum (
	"KEY" BIGINT, 
	"Estimator" DOUBLE
)
...
-- Code For temporary table tmp_20180508185209_codegen_jec7ht_lgbm_sum part 2. Populate

INSERT INTO tmp_20180508185209_codegen_jec7ht_lgbm_sum ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
FROM tmp_20180508185209_codegen_hf98dd_lgbm_union AS "LGBM_Union" GROUP BY "LGBM_Union"."KEY") AS "T") AS "LGBM_sum") AS "U"

-- Model deployment code

SELECT "LGBM_sum"."KEY" AS "KEY", "LGBM_sum"."Estimator" AS "Estimator" 
FROM tmp_20180508185209_codegen_jec7ht_lgbm_sum AS "LGBM_sum"