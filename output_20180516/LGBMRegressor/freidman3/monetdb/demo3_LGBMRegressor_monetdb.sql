...
-- Code For temporary table tmp_20180516121831_codegen_4u7dny_lgbm_b0 part 1. Create 


CREATE TEMPORARY TABLE tmp_20180516121831_codegen_4u7dny_lgbm_b0 (
	"KEY" BIGINT, 
	"Estimator" DOUBLE
)
...
-- Code For temporary table tmp_20180516121831_codegen_4u7dny_lgbm_b0 part 2. Populate

INSERT INTO tmp_20180516121831_codegen_4u7dny_lgbm_b0 ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
-- Code For temporary table tmp_20180516121831_codegen_rhy1xl_lgbm_b1 part 1. Create 


CREATE TEMPORARY TABLE tmp_20180516121831_codegen_rhy1xl_lgbm_b1 (
	"KEY" BIGINT, 
	"Estimator" DOUBLE
)
...
-- Code For temporary table tmp_20180516121831_codegen_rhy1xl_lgbm_b1 part 2. Populate

INSERT INTO tmp_20180516121831_codegen_rhy1xl_lgbm_b1 ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
-- Code For temporary table tmp_20180516121831_codegen_1epm6w_lgbm_sum part 1. Create 


CREATE TEMPORARY TABLE tmp_20180516121831_codegen_1epm6w_lgbm_sum (
	"KEY" BIGINT, 
	"Estimator" DOUBLE
)
...
-- Code For temporary table tmp_20180516121831_codegen_1epm6w_lgbm_sum part 2. Populate

INSERT INTO tmp_20180516121831_codegen_1epm6w_lgbm_sum ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
FROM tmp_20180516121831_codegen_4u7dny_lgbm_b0 AS "LGBM_B0" UNION ALL SELECT "LGBM_B1"."KEY" AS "KEY", "LGBM_B1"."Estimator" AS "Estimator" 
FROM tmp_20180516121831_codegen_rhy1xl_lgbm_b1 AS "LGBM_B1") AS "LGBM_EnsembleUnion")
...
FROM tmp_20180516121831_codegen_1epm6w_lgbm_sum AS "LGBM_sum"