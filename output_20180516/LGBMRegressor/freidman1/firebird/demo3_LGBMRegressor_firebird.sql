...
-- Code For temporary table TMP_20180602_KK5_LGBM_B0 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180602_KK5_LGBM_B0" (
	"KEY" BIGINT, 
...
-- Code For temporary table TMP_20180602_KK5_LGBM_B0 part 2. Populate

INSERT INTO "TMP_20180602_KK5_LGBM_B0" ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
FROM (SELECT 2 AS nid, 15.200469904526686 AS "Estimator" FROM rdb$database UNION ALL SELECT 6 AS nid, 15.422595859425408 AS "Estimator" FROM rdb$database UNION ALL SELECT 7 AS nid, 15.580411407332868 AS "Estimator" FROM rdb$database) AS "Values"), 
"DT_Output" AS 
...
"DT_node_data_1" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Estimator" AS DOUBLE PRECISION) AS "Estimator" 
FROM (SELECT 2 AS nid, -0.1456287688169724 AS "Estimator" FROM rdb$database UNION ALL SELECT 6 AS nid, 0.06539088629540944 AS "Estimator" FROM rdb$database UNION ALL SELECT 7 AS nid, 0.2153156650811434 AS "Estimator" FROM rdb$database) AS "Values"), 
"DT_Output_1" AS 
...
"DT_node_data_2" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Estimator" AS DOUBLE PRECISION) AS "Estimator" 
FROM (SELECT 2 AS nid, -0.1383473269068278 AS "Estimator" FROM rdb$database UNION ALL SELECT 6 AS nid, 0.06212134771935997 AS "Estimator" FROM rdb$database UNION ALL SELECT 7 AS nid, 0.20454987809062006 AS "Estimator" FROM rdb$database) AS "Values"), 
"DT_Output_2" AS 
...
"DT_node_data_3" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Estimator" AS DOUBLE PRECISION) AS "Estimator" 
FROM (SELECT 2 AS nid, -0.1314299638454731 AS "Estimator" FROM rdb$database UNION ALL SELECT 6 AS nid, 0.05901527953821988 AS "Estimator" FROM rdb$database UNION ALL SELECT 7 AS nid, 0.1943223848938942 AS "Estimator" FROM rdb$database) AS "Values"), 
"DT_Output_3" AS 
...
"DT_node_data_4" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Estimator" AS DOUBLE PRECISION) AS "Estimator" 
FROM (SELECT 2 AS nid, -0.12485846152696281 AS "Estimator" FROM rdb$database UNION ALL SELECT 6 AS nid, 0.05606451522381533 AS "Estimator" FROM rdb$database UNION ALL SELECT 7 AS nid, 0.1846062703430653 AS "Estimator" FROM rdb$database) AS "Values"), 
"DT_Output_4" AS 
...
-- Code For temporary table TMP_20180602_BBN_LGBM_B1 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180602_BBN_LGBM_B1" (
	"KEY" BIGINT, 
	"Estimator" DOUBLE PRECISION
)
...
-- Code For temporary table TMP_20180602_BBN_LGBM_B1 part 2. Populate

INSERT INTO "TMP_20180602_BBN_LGBM_B1" ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
"DT_node_data_5" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Estimator" AS DOUBLE PRECISION) AS "Estimator" 
FROM (SELECT 2 AS nid, -0.1420501381384604 AS "Estimator" FROM rdb$database UNION ALL SELECT 6 AS nid, -0.006007910966873169 AS "Estimator" FROM rdb$database UNION ALL SELECT 7 AS nid, 0.1780671380184315 AS "Estimator" FROM rdb$database) AS "Values"), 
"DT_Output_5" AS 
...
"DT_node_data_6" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Estimator" AS DOUBLE PRECISION) AS "Estimator" 
FROM (SELECT 2 AS nid, -0.13494762923060494 AS "Estimator" FROM rdb$database UNION ALL SELECT 6 AS nid, -0.005707516670227051 AS "Estimator" FROM rdb$database UNION ALL SELECT 7 AS nid, 0.16916377941767377 AS "Estimator" FROM rdb$database) AS "Values"), 
"DT_Output_6" AS 
...
"DT_node_data_7" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Estimator" AS DOUBLE PRECISION) AS "Estimator" 
FROM (SELECT 2 AS nid, -0.11156776516865462 AS "Estimator" FROM rdb$database UNION ALL SELECT 6 AS nid, 0.045042541176080704 AS "Estimator" FROM rdb$database UNION ALL SELECT 7 AS nid, 0.16429961614665534 AS "Estimator" FROM rdb$database) AS "Values"), 
"DT_Output_7" AS 
...
"DT_node_data_8" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Estimator" AS DOUBLE PRECISION) AS "Estimator" 
FROM (SELECT 2 AS nid, -0.13752821845312913 AS "Estimator" FROM rdb$database UNION ALL SELECT 6 AS nid, -0.01659700522820155 AS "Estimator" FROM rdb$database UNION ALL SELECT 7 AS nid, 0.1542890925859583 AS "Estimator" FROM rdb$database) AS "Values"), 
"DT_Output_8" AS 
...
"DT_node_data_9" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Estimator" AS DOUBLE PRECISION) AS "Estimator" 
FROM (SELECT 2 AS nid, -0.12077955312349581 AS "Estimator" FROM rdb$database UNION ALL SELECT 6 AS nid, 0.0005588829517364502 AS "Estimator" FROM rdb$database UNION ALL SELECT 7 AS nid, 0.1472054673565759 AS "Estimator" FROM rdb$database) AS "Values"), 
"DT_Output_9" AS 
...
-- Code For temporary table TMP_20180602_B49_LGBM_B2 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180602_B49_LGBM_B2" (
	"KEY" BIGINT, 
	"Estimator" DOUBLE PRECISION
)
...
-- Code For temporary table TMP_20180602_B49_LGBM_B2 part 2. Populate

INSERT INTO "TMP_20180602_B49_LGBM_B2" ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
"DT_node_data_10" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Estimator" AS DOUBLE PRECISION) AS "Estimator" 
FROM (SELECT 2 AS nid, -0.1510502178221941 AS "Estimator" FROM rdb$database UNION ALL SELECT 6 AS nid, -0.07514725886285306 AS "Estimator" FROM rdb$database UNION ALL SELECT 7 AS nid, 0.14244862418207857 AS "Estimator" FROM rdb$database) AS "Values"), 
"DT_Output_10" AS 
...
"DT_node_data_11" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Estimator" AS DOUBLE PRECISION) AS "Estimator" 
FROM (SELECT 2 AS nid, -0.12236519093314807 AS "Estimator" FROM rdb$database UNION ALL SELECT 6 AS nid, -0.01273715723128546 AS "Estimator" FROM rdb$database UNION ALL SELECT 7 AS nid, 0.1358081385750195 AS "Estimator" FROM rdb$database) AS "Values"), 
"DT_Output_11" AS 
...
"DT_node_data_12" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Estimator" AS DOUBLE PRECISION) AS "Estimator" 
FROM (SELECT 2 AS nid, -0.14034854248166084 AS "Estimator" FROM rdb$database UNION ALL SELECT 6 AS nid, -0.07070917330682279 AS "Estimator" FROM rdb$database UNION ALL SELECT 7 AS nid, 0.13284856890224747 AS "Estimator" FROM rdb$database) AS "Values"), 
"DT_Output_12" AS 
...
"DT_node_data_13" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Estimator" AS DOUBLE PRECISION) AS "Estimator" 
FROM (SELECT 2 AS nid, -0.10578776543790645 AS "Estimator" FROM rdb$database UNION ALL SELECT 6 AS nid, 0.0050853342562913895 AS "Estimator" FROM rdb$database UNION ALL SELECT 7 AS nid, 0.12552924387984807 AS "Estimator" FROM rdb$database) AS "Values"), 
"DT_Output_13" AS 
...
"DT_node_data_14" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Estimator" AS DOUBLE PRECISION) AS "Estimator" 
FROM (SELECT 2 AS nid, -0.14409448930195398 AS "Estimator" FROM rdb$database UNION ALL SELECT 6 AS nid, -0.07628547797600428 AS "Estimator" FROM rdb$database UNION ALL SELECT 7 AS nid, 0.12178892919695693 AS "Estimator" FROM rdb$database) AS "Values"), 
"DT_Output_14" AS 
...
-- Code For temporary table TMP_20180602_VLL_LGBM_B3 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180602_VLL_LGBM_B3" (
	"KEY" BIGINT, 
	"Estimator" DOUBLE PRECISION
)
...
-- Code For temporary table TMP_20180602_VLL_LGBM_B3 part 2. Populate

INSERT INTO "TMP_20180602_VLL_LGBM_B3" ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
"DT_node_data_15" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Estimator" AS DOUBLE PRECISION) AS "Estimator" 
FROM (SELECT 2 AS nid, -0.08522149171584692 AS "Estimator" FROM rdb$database UNION ALL SELECT 6 AS nid, 0.031331977487674786 AS "Estimator" FROM rdb$database UNION ALL SELECT 7 AS nid, 0.13328333653509616 AS "Estimator" FROM rdb$database) AS "Values"), 
"DT_Output_15" AS 
...
-- Code For temporary table TMP_20180602_LJX_LGBM_SUM part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180602_LJX_LGBM_SUM" (
	"KEY" BIGINT NOT NULL, 
	"Estimator" DOUBLE PRECISION, 
	PRIMARY KEY ("KEY")
)
...
-- Code For temporary table TMP_20180602_LJX_LGBM_SUM part 2. Populate

INSERT INTO "TMP_20180602_LJX_LGBM_SUM" ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
FROM "TMP_20180602_KK5_LGBM_B0" AS "LGBM_B0" UNION ALL SELECT "LGBM_B1"."KEY" AS "KEY", "LGBM_B1"."Estimator" AS "Estimator" 
FROM "TMP_20180602_BBN_LGBM_B1" AS "LGBM_B1" UNION ALL SELECT "LGBM_B2"."KEY" AS "KEY", "LGBM_B2"."Estimator" AS "Estimator" 
FROM "TMP_20180602_B49_LGBM_B2" AS "LGBM_B2" UNION ALL SELECT "LGBM_B3"."KEY" AS "KEY", "LGBM_B3"."Estimator" AS "Estimator" 
FROM "TMP_20180602_VLL_LGBM_B3" AS "LGBM_B3") AS "LGBM_EnsembleUnion")
...
-- Code For temporary table TMP_20180602_LJX_LGBM_SUM part 3. Create Index 

CREATE INDEX "ix_TMP_20180602_LJX_LGB_7b3f" ON "TMP_20180602_LJX_LGBM_SUM" ("KEY")

-- Model deployment code

SELECT "LGBM_sum"."KEY" AS "KEY", "LGBM_sum"."Estimator" AS "Estimator" 
FROM "TMP_20180602_LJX_LGBM_SUM" AS "LGBM_sum"