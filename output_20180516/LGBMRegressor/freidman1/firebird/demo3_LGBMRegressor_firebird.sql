...
-- Code For temporary table TMP_20180508184450_CODEGEN_BBKO part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508184450_CODEGEN_BBKO" (
	"KEY" BIGINT, 
...
-- Code For temporary table TMP_20180508184450_CODEGEN_BBKO part 2. Populate

INSERT INTO "TMP_20180508184450_CODEGEN_BBKO" ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
-- Code For temporary table TMP_20180508184450_CODEGEN_0KSW part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508184450_CODEGEN_0KSW" (
	"KEY" BIGINT, 
	"Estimator" DOUBLE PRECISION
)
...
-- Code For temporary table TMP_20180508184450_CODEGEN_0KSW part 2. Populate

INSERT INTO "TMP_20180508184450_CODEGEN_0KSW" ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
-- Code For temporary table TMP_20180508184450_CODEGEN_UWY2 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508184450_CODEGEN_UWY2" (
	"KEY" BIGINT, 
	"Estimator" DOUBLE PRECISION
)
...
-- Code For temporary table TMP_20180508184450_CODEGEN_UWY2 part 2. Populate

INSERT INTO "TMP_20180508184450_CODEGEN_UWY2" ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
FROM "TMP_20180508184450_CODEGEN_BBKO" AS "LGBM_B0" UNION ALL SELECT "LGBM_B1"."KEY" AS "KEY", "LGBM_B1"."Estimator" AS "Estimator" 
FROM "TMP_20180508184450_CODEGEN_0KSW" AS "LGBM_B1") AS "LGBM_EnsembleUnion") AS "LGBM_Union") AS "U"

-- Code For temporary table TMP_20180508184450_CODEGEN_LAGH part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508184450_CODEGEN_LAGH" (
	"KEY" BIGINT NOT NULL, 
	"Estimator" DOUBLE PRECISION, 
	PRIMARY KEY ("KEY")
)
...
-- Code For temporary table TMP_20180508184450_CODEGEN_LAGH part 2. Populate

INSERT INTO "TMP_20180508184450_CODEGEN_LAGH" ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
FROM "TMP_20180508184450_CODEGEN_UWY2" AS "LGBM_Union" GROUP BY "LGBM_Union"."KEY") AS "T") AS "LGBM_sum") AS "U"

-- Code For temporary table TMP_20180508184450_CODEGEN_LAGH part 3. Create Index 

CREATE INDEX "ix_TMP_20180508184450_C_116d" ON "TMP_20180508184450_CODEGEN_LAGH" ("KEY")

-- Model deployment code

SELECT "LGBM_sum"."KEY" AS "KEY", "LGBM_sum"."Estimator" AS "Estimator" 
FROM "TMP_20180508184450_CODEGEN_LAGH" AS "LGBM_sum"