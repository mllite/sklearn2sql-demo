...
-- Code For temporary table TMP_20180602151248_N4V_LGBM_B0 part 1. Create 


CREATE TEMPORARY TABLE `TMP_20180602151248_N4V_LGBM_B0` (
	`KEY` BIGINT, 
	`Estimator` DOUBLE
)
...
-- Code For temporary table TMP_20180602151248_N4V_LGBM_B0 part 2. Populate

INSERT INTO `TMP_20180602151248_N4V_LGBM_B0` (`KEY`, `Estimator`) SELECT `U`.`KEY`, `U`.`Estimator` 
...
-- Code For temporary table TMP_20180602151248_HT4_LGBM_B1 part 1. Create 


CREATE TEMPORARY TABLE `TMP_20180602151248_HT4_LGBM_B1` (
	`KEY` BIGINT, 
	`Estimator` DOUBLE
)
...
-- Code For temporary table TMP_20180602151248_HT4_LGBM_B1 part 2. Populate

INSERT INTO `TMP_20180602151248_HT4_LGBM_B1` (`KEY`, `Estimator`) SELECT `U`.`KEY`, `U`.`Estimator` 
...
-- Code For temporary table TMP_20180602151248_ZJ5_LGBM_sum part 1. Create 


CREATE TEMPORARY TABLE `TMP_20180602151248_ZJ5_LGBM_sum` (
	`KEY` BIGINT NOT NULL, 
	`Estimator` DOUBLE, 
	PRIMARY KEY (`KEY`)
)
...
-- Code For temporary table TMP_20180602151248_ZJ5_LGBM_sum part 2. Populate

INSERT INTO `TMP_20180602151248_ZJ5_LGBM_sum` (`KEY`, `Estimator`) SELECT `U`.`KEY`, `U`.`Estimator` 
...
FROM `TMP_20180602151248_N4V_LGBM_B0` AS `LGBM_B0` UNION ALL SELECT `LGBM_B1`.`KEY` AS `KEY`, `LGBM_B1`.`Estimator` AS `Estimator` 
FROM `TMP_20180602151248_HT4_LGBM_B1` AS `LGBM_B1`) AS `LGBM_EnsembleUnion`)
...
-- Code For temporary table TMP_20180602151248_ZJ5_LGBM_sum part 3. Create Index 

CREATE INDEX `ix_TMP_20180602151248_ZJ5_LGBM_sum_KEY` ON `TMP_20180602151248_ZJ5_LGBM_sum` (`KEY`)

-- Model deployment code

SELECT `LGBM_sum`.`KEY` AS `KEY`, `LGBM_sum`.`Estimator` AS `Estimator` 
FROM `TMP_20180602151248_ZJ5_LGBM_sum` AS `LGBM_sum`