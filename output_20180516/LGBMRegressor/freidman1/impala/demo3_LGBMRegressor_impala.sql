...
-- Code For temporary table tmp_20180602151248_qps_lgbm_b0 part 1. Create 


CREATE TABLE tmp_20180602151248_qps_lgbm_b0 (
	`KEY` BIGINT, 
	`Estimator` DOUBLE
)
...
-- Code For temporary table tmp_20180602151248_qps_lgbm_b0 part 2. Populate
...
FROM `DT_Output_9`)
 INSERT INTO tmp_20180602151248_qps_lgbm_b0 (`KEY`, `Estimator`) SELECT `LGBM_B0`.`KEY`, `LGBM_B0`.`Estimator` 
...
-- Code For temporary table tmp_20180602151248_5zv_lgbm_b1 part 1. Create 


CREATE TABLE tmp_20180602151248_5zv_lgbm_b1 (
	`KEY` BIGINT, 
	`Estimator` DOUBLE
)
...
-- Code For temporary table tmp_20180602151248_5zv_lgbm_b1 part 2. Populate
...
FROM `DT_Output_15`)
 INSERT INTO tmp_20180602151248_5zv_lgbm_b1 (`KEY`, `Estimator`) SELECT `LGBM_B1`.`KEY`, `LGBM_B1`.`Estimator` 
...
-- Code For temporary table tmp_20180602151248_u7v_lgbm_sum part 1. Create 


CREATE TABLE tmp_20180602151248_u7v_lgbm_sum (
	`KEY` BIGINT, 
	`Estimator` DOUBLE
)
...
-- Code For temporary table tmp_20180602151248_u7v_lgbm_sum part 2. Populate
...
FROM tmp_20180602151248_qps_lgbm_b0 AS `LGBM_B0` UNION ALL SELECT `LGBM_B1`.`KEY` AS `KEY`, `LGBM_B1`.`Estimator` AS `Estimator` 
FROM tmp_20180602151248_5zv_lgbm_b1 AS `LGBM_B1`) AS `LGBM_EnsembleUnion`)
 INSERT INTO tmp_20180602151248_u7v_lgbm_sum (`KEY`, `Estimator`) SELECT `LGBM_sum`.`KEY`, `LGBM_sum`.`Estimator` 
...
FROM tmp_20180602151248_u7v_lgbm_sum AS `LGBM_sum`