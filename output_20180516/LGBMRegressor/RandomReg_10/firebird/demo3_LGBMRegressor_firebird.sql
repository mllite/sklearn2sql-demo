...
-- Code For temporary table TMP_20180508182228_CODEGEN_VNOK part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508182228_CODEGEN_VNOK" (
	"KEY" BIGINT, 
...
-- Code For temporary table TMP_20180508182228_CODEGEN_VNOK part 2. Populate

INSERT INTO "TMP_20180508182228_CODEGEN_VNOK" ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
-- Code For temporary table TMP_20180508182228_CODEGEN_7Z55 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508182228_CODEGEN_7Z55" (
	"KEY" BIGINT, 
	"Estimator" DOUBLE PRECISION
)
...
-- Code For temporary table TMP_20180508182228_CODEGEN_7Z55 part 2. Populate

INSERT INTO "TMP_20180508182228_CODEGEN_7Z55" ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
-- Code For temporary table TMP_20180508182228_CODEGEN_3INA part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508182228_CODEGEN_3INA" (
	"KEY" BIGINT, 
	"Estimator" DOUBLE PRECISION
)
...
-- Code For temporary table TMP_20180508182228_CODEGEN_3INA part 2. Populate

INSERT INTO "TMP_20180508182228_CODEGEN_3INA" ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
FROM "TMP_20180508182228_CODEGEN_VNOK" AS "LGBM_B0" UNION ALL SELECT "LGBM_B1"."KEY" AS "KEY", "LGBM_B1"."Estimator" AS "Estimator" 
FROM "TMP_20180508182228_CODEGEN_7Z55" AS "LGBM_B1") AS "LGBM_EnsembleUnion") AS "LGBM_Union") AS "U"

-- Code For temporary table TMP_20180508182228_CODEGEN_Q5GN part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508182228_CODEGEN_Q5GN" (
	"KEY" BIGINT NOT NULL, 
	"Estimator" DOUBLE PRECISION, 
	PRIMARY KEY ("KEY")
)
...
-- Code For temporary table TMP_20180508182228_CODEGEN_Q5GN part 2. Populate

INSERT INTO "TMP_20180508182228_CODEGEN_Q5GN" ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
FROM "TMP_20180508182228_CODEGEN_3INA" AS "LGBM_Union" GROUP BY "LGBM_Union"."KEY") AS "T") AS "LGBM_sum") AS "U"

-- Code For temporary table TMP_20180508182228_CODEGEN_Q5GN part 3. Create Index 

CREATE INDEX "ix_TMP_20180508182228_C_1a28" ON "TMP_20180508182228_CODEGEN_Q5GN" ("KEY")

-- Model deployment code

SELECT "LGBM_sum"."KEY" AS "KEY", "LGBM_sum"."Estimator" AS "Estimator" 
FROM "TMP_20180508182228_CODEGEN_Q5GN" AS "LGBM_sum"