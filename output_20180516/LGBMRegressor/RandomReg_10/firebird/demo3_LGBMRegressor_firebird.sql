...
-- Code For temporary table TMP_20180516_CODEGEN_RCXULC_LGB part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180516_CODEGEN_RCXULC_LGB" (
	"KEY" BIGINT, 
...
-- Code For temporary table TMP_20180516_CODEGEN_RCXULC_LGB part 2. Populate

INSERT INTO "TMP_20180516_CODEGEN_RCXULC_LGB" ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
-- Code For temporary table TMP_20180516_CODEGEN_38NVZQ_LGB part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180516_CODEGEN_38NVZQ_LGB" (
	"KEY" BIGINT, 
	"Estimator" DOUBLE PRECISION
)
...
-- Code For temporary table TMP_20180516_CODEGEN_38NVZQ_LGB part 2. Populate

INSERT INTO "TMP_20180516_CODEGEN_38NVZQ_LGB" ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
-- Code For temporary table TMP_20180516_CODEGEN_SQ8DB5_LGB part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180516_CODEGEN_SQ8DB5_LGB" (
	"KEY" BIGINT NOT NULL, 
	"Estimator" DOUBLE PRECISION, 
	PRIMARY KEY ("KEY")
)
...
-- Code For temporary table TMP_20180516_CODEGEN_SQ8DB5_LGB part 2. Populate

INSERT INTO "TMP_20180516_CODEGEN_SQ8DB5_LGB" ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
FROM "TMP_20180516_CODEGEN_RCXULC_LGB" AS "LGBM_B0" UNION ALL SELECT "LGBM_B1"."KEY" AS "KEY", "LGBM_B1"."Estimator" AS "Estimator" 
FROM "TMP_20180516_CODEGEN_38NVZQ_LGB" AS "LGBM_B1") AS "LGBM_EnsembleUnion")
...
-- Code For temporary table TMP_20180516_CODEGEN_SQ8DB5_LGB part 3. Create Index 

CREATE INDEX "ix_TMP_20180516_CODEGEN_8528" ON "TMP_20180516_CODEGEN_SQ8DB5_LGB" ("KEY")

-- Model deployment code

SELECT "LGBM_sum"."KEY" AS "KEY", "LGBM_sum"."Estimator" AS "Estimator" 
FROM "TMP_20180516_CODEGEN_SQ8DB5_LGB" AS "LGBM_sum"