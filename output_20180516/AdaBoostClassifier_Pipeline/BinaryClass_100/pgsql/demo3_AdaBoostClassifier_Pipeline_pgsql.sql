...
-- Code For temporary table TMP_20180516110734_CODEGEN_CYDL4F_ADS_imp_1_OUT part 1. Create 


CREATE TEMPORARY TABLE "TMP_20180516110734_CODEGEN_CYDL4F_ADS_imp_1_OUT" (
	"KEY" BIGINT NOT NULL, 
	impter_2 FLOAT, 
	impter_3 FLOAT, 
	impter_4 FLOAT, 
...
-- Code For temporary table TMP_20180516110734_CODEGEN_CYDL4F_ADS_imp_1_OUT part 3. Create Index 

CREATE INDEX "ix_TMP_20180516110734_CODEGEN_CYDL4F_ADS_imp_1_OUT_KEY" ON "TMP_20180516110734_CODEGEN_CYDL4F_ADS_imp_1_OUT" ("KEY")

-- Code For temporary table TMP_20180516110734_CODEGEN_05PDXD_ADS_sca_2_OUT part 1. Create 


CREATE TEMPORARY TABLE "TMP_20180516110734_CODEGEN_05PDXD_ADS_sca_2_OUT" (
	"KEY" BIGINT NOT NULL, 
	scaler_2 FLOAT, 
	scaler_3 FLOAT, 
	scaler_4 FLOAT, 
...
FROM "TMP_20180516110734_CODEGEN_CYDL4F_ADS_imp_1_OUT" AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT"

-- Code For temporary table TMP_20180516110734_CODEGEN_05PDXD_ADS_sca_2_OUT part 3. Create Index 

CREATE INDEX "ix_TMP_20180516110734_CODEGEN_05PDXD_ADS_sca_2_OUT_KEY" ON "TMP_20180516110734_CODEGEN_05PDXD_ADS_sca_2_OUT" ("KEY")

-- Code For temporary table TMP_20180516110735_CODEGEN_45381I_ADB_B0 part 1. Create 


CREATE TEMPORARY TABLE "TMP_20180516110735_CODEGEN_45381I_ADB_B0" (
	"KEY" BIGINT, 
	"Score_0" FLOAT, 
	"Proba_0" FLOAT, 
	"Score_1" FLOAT, 
...
-- Code For temporary table TMP_20180516110735_CODEGEN_45381I_ADB_B0 part 2. Populate

WITH "DT_node_lookup" AS 
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", CASE WHEN ("ADS_sca_2_OUT".scaler_59 <= 0.06653057038784027) THEN 1 ELSE 2 END AS node_id_2 
FROM "TMP_20180516110734_CODEGEN_05PDXD_ADS_sca_2_OUT" AS "ADS_sca_2_OUT"), 
"DT_node_data" AS 
...
FROM "DT_Output_9")
 INSERT INTO "TMP_20180516110735_CODEGEN_45381I_ADB_B0" ("KEY", "Score_0", "Proba_0", "Score_1", "Proba_1") SELECT "ADB_B0"."KEY", "ADB_B0"."Score_0", "ADB_B0"."Proba_0", "ADB_B0"."Score_1", "ADB_B0"."Proba_1" 
...
-- Code For temporary table TMP_20180516110735_CODEGEN_J93QU6_ADB_B1 part 1. Create 


CREATE TEMPORARY TABLE "TMP_20180516110735_CODEGEN_J93QU6_ADB_B1" (
	"KEY" BIGINT, 
	"Score_0" FLOAT, 
	"Proba_0" FLOAT, 
	"Score_1" FLOAT, 
...
-- Code For temporary table TMP_20180516110735_CODEGEN_J93QU6_ADB_B1 part 2. Populate
...
FROM "DT_Output_15")
 INSERT INTO "TMP_20180516110735_CODEGEN_J93QU6_ADB_B1" ("KEY", "Score_0", "Proba_0", "Score_1", "Proba_1") SELECT "ADB_B1"."KEY", "ADB_B1"."Score_0", "ADB_B1"."Proba_0", "ADB_B1"."Score_1", "ADB_B1"."Proba_1" 
...
-- Code For temporary table TMP_20180516110735_CODEGEN_2A9O28_ADB_sum part 1. Create 


CREATE TEMPORARY TABLE "TMP_20180516110735_CODEGEN_2A9O28_ADB_sum" (
	"KEY" BIGINT NOT NULL, 
	"Score_0" FLOAT, 
	"Proba_0" FLOAT, 
	"Score_1" FLOAT, 
...
-- Code For temporary table TMP_20180516110735_CODEGEN_2A9O28_ADB_sum part 2. Populate
...
FROM "TMP_20180516110735_CODEGEN_45381I_ADB_B0" AS "ADB_B0" UNION ALL SELECT "ADB_B1"."KEY" AS "KEY", "ADB_B1"."Score_0" AS "Score_0", "ADB_B1"."Proba_0" AS "Proba_0", "ADB_B1"."Score_1" AS "Score_1", "ADB_B1"."Proba_1" AS "Proba_1" 
FROM "TMP_20180516110735_CODEGEN_J93QU6_ADB_B1" AS "ADB_B1") AS "ADB_EnsembleUnion")
 INSERT INTO "TMP_20180516110735_CODEGEN_2A9O28_ADB_sum" ("KEY", "Score_0", "Proba_0", "Score_1", "Proba_1") SELECT "ADB_sum"."KEY", "ADB_sum"."Score_0", "ADB_sum"."Proba_0", "ADB_sum"."Score_1", "ADB_sum"."Proba_1" 
...
-- Code For temporary table TMP_20180516110735_CODEGEN_2A9O28_ADB_sum part 3. Create Index 

CREATE INDEX "ix_TMP_20180516110735_CODEGEN_2A9O28_ADB_sum_KEY" ON "TMP_20180516110735_CODEGEN_2A9O28_ADB_sum" ("KEY")
...
FROM "TMP_20180516110735_CODEGEN_2A9O28_ADB_sum" AS "ADB_sum"), 
