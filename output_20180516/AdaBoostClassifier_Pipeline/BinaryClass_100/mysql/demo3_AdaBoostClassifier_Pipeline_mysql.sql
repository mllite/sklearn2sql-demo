...
-- Code For temporary table TMP_20180602141622_K1H_ADS_imp_1_OUT part 1. Create 


CREATE TEMPORARY TABLE `TMP_20180602141622_K1H_ADS_imp_1_OUT` (
	`KEY` BIGINT NOT NULL, 
	impter_2 DOUBLE, 
	impter_3 DOUBLE, 
	impter_4 DOUBLE, 
...
-- Code For temporary table TMP_20180602141622_K1H_ADS_imp_1_OUT part 3. Create Index 

CREATE INDEX `ix_TMP_20180602141622_K1H_ADS_imp_1_OUT_KEY` ON `TMP_20180602141622_K1H_ADS_imp_1_OUT` (`KEY`)

-- Code For temporary table TMP_20180602141622_7J5_ADS_sca_2_OUT part 1. Create 


CREATE TEMPORARY TABLE `TMP_20180602141622_7J5_ADS_sca_2_OUT` (
	`KEY` BIGINT NOT NULL, 
	scaler_2 DOUBLE, 
	scaler_3 DOUBLE, 
	scaler_4 DOUBLE, 
...
FROM `TMP_20180602141622_K1H_ADS_imp_1_OUT` AS `ADS_imp_1_OUT`) AS `ADS_sca_2_OUT`) AS `U`

-- Code For temporary table TMP_20180602141622_7J5_ADS_sca_2_OUT part 3. Create Index 

CREATE INDEX `ix_TMP_20180602141622_7J5_ADS_sca_2_OUT_KEY` ON `TMP_20180602141622_7J5_ADS_sca_2_OUT` (`KEY`)

-- Code For temporary table TMP_20180602141622_1Q7_ADB_B0 part 1. Create 


CREATE TEMPORARY TABLE `TMP_20180602141622_1Q7_ADB_B0` (
	`KEY` BIGINT, 
	`Score_0` DOUBLE, 
	`Proba_0` DOUBLE, 
	`Score_1` DOUBLE, 
...
-- Code For temporary table TMP_20180602141622_1Q7_ADB_B0 part 2. Populate

INSERT INTO `TMP_20180602141622_1Q7_ADB_B0` (`KEY`, `Score_0`, `Proba_0`, `Score_1`, `Proba_1`) SELECT `U`.`KEY`, `U`.`Score_0`, `U`.`Proba_0`, `U`.`Score_1`, `U`.`Proba_1` 
...
FROM `TMP_20180602141622_7J5_ADS_sca_2_OUT` AS `ADS_sca_2_OUT`), 
`DT_node_data` AS 
...
-- Code For temporary table TMP_20180602141622_C8G_ADB_B1 part 1. Create 


CREATE TEMPORARY TABLE `TMP_20180602141622_C8G_ADB_B1` (
	`KEY` BIGINT, 
	`Score_0` DOUBLE, 
	`Proba_0` DOUBLE, 
	`Score_1` DOUBLE, 
...
-- Code For temporary table TMP_20180602141622_C8G_ADB_B1 part 2. Populate

INSERT INTO `TMP_20180602141622_C8G_ADB_B1` (`KEY`, `Score_0`, `Proba_0`, `Score_1`, `Proba_1`) SELECT `U`.`KEY`, `U`.`Score_0`, `U`.`Proba_0`, `U`.`Score_1`, `U`.`Proba_1` 
...
-- Code For temporary table TMP_20180602141622_0O1_ADB_sum part 1. Create 


CREATE TEMPORARY TABLE `TMP_20180602141622_0O1_ADB_sum` (
	`KEY` BIGINT NOT NULL, 
	`Score_0` DOUBLE, 
	`Proba_0` DOUBLE, 
	`Score_1` DOUBLE, 
...
-- Code For temporary table TMP_20180602141622_0O1_ADB_sum part 2. Populate

INSERT INTO `TMP_20180602141622_0O1_ADB_sum` (`KEY`, `Score_0`, `Proba_0`, `Score_1`, `Proba_1`) SELECT `U`.`KEY`, `U`.`Score_0`, `U`.`Proba_0`, `U`.`Score_1`, `U`.`Proba_1` 
...
FROM `TMP_20180602141622_1Q7_ADB_B0` AS `ADB_B0` UNION ALL SELECT `ADB_B1`.`KEY` AS `KEY`, `ADB_B1`.`Score_0` AS `Score_0`, `ADB_B1`.`Proba_0` AS `Proba_0`, `ADB_B1`.`Score_1` AS `Score_1`, `ADB_B1`.`Proba_1` AS `Proba_1` 
FROM `TMP_20180602141622_C8G_ADB_B1` AS `ADB_B1`) AS `ADB_EnsembleUnion`)
...
-- Code For temporary table TMP_20180602141622_0O1_ADB_sum part 3. Create Index 

CREATE INDEX `ix_TMP_20180602141622_0O1_ADB_sum_KEY` ON `TMP_20180602141622_0O1_ADB_sum` (`KEY`)
...
FROM `TMP_20180602141622_0O1_ADB_sum` AS `ADB_sum`), 
