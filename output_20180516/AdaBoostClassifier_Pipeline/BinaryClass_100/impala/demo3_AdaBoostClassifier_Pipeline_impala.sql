...
-- Code For temporary table tmp_20180602141622_ndd_ads_imp_1_out part 1. Create 


CREATE TABLE tmp_20180602141622_ndd_ads_imp_1_out (
	`KEY` BIGINT, 
	impter_2 DOUBLE, 
	impter_3 DOUBLE, 
	impter_4 DOUBLE, 
...
-- Code For temporary table tmp_20180602141622_nwi_ads_sca_2_out part 1. Create 


CREATE TABLE tmp_20180602141622_nwi_ads_sca_2_out (
	`KEY` BIGINT, 
	scaler_2 DOUBLE, 
	scaler_3 DOUBLE, 
	scaler_4 DOUBLE, 
...
FROM tmp_20180602141622_ndd_ads_imp_1_out AS `ADS_imp_1_OUT`) AS `ADS_sca_2_OUT`

-- Code For temporary table tmp_20180602141623_1ng_adb_b0 part 1. Create 


CREATE TABLE tmp_20180602141623_1ng_adb_b0 (
	`KEY` BIGINT, 
	`Score_0` DOUBLE, 
	`Proba_0` DOUBLE, 
	`Score_1` DOUBLE, 
...
-- Code For temporary table tmp_20180602141623_1ng_adb_b0 part 2. Populate

WITH `DT_node_lookup` AS 
(SELECT `ADS_sca_2_OUT`.`KEY` AS `KEY`, CASE WHEN (`ADS_sca_2_OUT`.scaler_59 <= 0.06653057038784027) THEN 1 ELSE 2 END AS node_id_2 
FROM tmp_20180602141622_nwi_ads_sca_2_out AS `ADS_sca_2_OUT`), 
`DT_node_data` AS 
...
FROM `DT_Output_9`)
 INSERT INTO tmp_20180602141623_1ng_adb_b0 (`KEY`, `Score_0`, `Proba_0`, `Score_1`, `Proba_1`) SELECT `ADB_B0`.`KEY`, `ADB_B0`.`Score_0`, `ADB_B0`.`Proba_0`, `ADB_B0`.`Score_1`, `ADB_B0`.`Proba_1` 
...
-- Code For temporary table tmp_20180602141623_j4p_adb_b1 part 1. Create 


CREATE TABLE tmp_20180602141623_j4p_adb_b1 (
	`KEY` BIGINT, 
	`Score_0` DOUBLE, 
	`Proba_0` DOUBLE, 
	`Score_1` DOUBLE, 
...
-- Code For temporary table tmp_20180602141623_j4p_adb_b1 part 2. Populate
...
FROM `DT_Output_15`)
 INSERT INTO tmp_20180602141623_j4p_adb_b1 (`KEY`, `Score_0`, `Proba_0`, `Score_1`, `Proba_1`) SELECT `ADB_B1`.`KEY`, `ADB_B1`.`Score_0`, `ADB_B1`.`Proba_0`, `ADB_B1`.`Score_1`, `ADB_B1`.`Proba_1` 
...
-- Code For temporary table tmp_20180602141623_o8q_adb_sum part 1. Create 


CREATE TABLE tmp_20180602141623_o8q_adb_sum (
	`KEY` BIGINT, 
	`Score_0` DOUBLE, 
	`Proba_0` DOUBLE, 
	`Score_1` DOUBLE, 
...
-- Code For temporary table tmp_20180602141623_o8q_adb_sum part 2. Populate
...
FROM tmp_20180602141623_1ng_adb_b0 AS `ADB_B0` UNION ALL SELECT `ADB_B1`.`KEY` AS `KEY`, `ADB_B1`.`Score_0` AS `Score_0`, `ADB_B1`.`Proba_0` AS `Proba_0`, `ADB_B1`.`Score_1` AS `Score_1`, `ADB_B1`.`Proba_1` AS `Proba_1` 
FROM tmp_20180602141623_j4p_adb_b1 AS `ADB_B1`) AS `ADB_EnsembleUnion`)
 INSERT INTO tmp_20180602141623_o8q_adb_sum (`KEY`, `Score_0`, `Proba_0`, `Score_1`, `Proba_1`) SELECT `ADB_sum`.`KEY`, `ADB_sum`.`Score_0`, `ADB_sum`.`Proba_0`, `ADB_sum`.`Score_1`, `ADB_sum`.`Proba_1` 
...
FROM tmp_20180602141623_o8q_adb_sum AS `ADB_sum`), 
