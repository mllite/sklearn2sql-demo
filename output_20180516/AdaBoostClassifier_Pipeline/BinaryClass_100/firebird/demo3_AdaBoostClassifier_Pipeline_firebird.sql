...
-- Code For temporary table TMP_20180508180124_CODEGEN_N9JE part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508180124_CODEGEN_N9JE" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20180508180124_CODEGEN_N9JE part 3. Create Index 

CREATE INDEX "ix_TMP_20180508180124_C_2859" ON "TMP_20180508180124_CODEGEN_N9JE" ("KEY")

-- Code For temporary table TMP_20180508180124_CODEGEN_J7O2 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508180124_CODEGEN_J7O2" (
	"KEY" BIGINT NOT NULL, 
...
FROM (SELECT "ADS_imp_1_OUT"."KEY" AS "KEY", (CAST("ADS_imp_1_OUT".impter_2 AS DOUBLE PRECISION) - 0.14903440845324958) / 0.8636609678928474 AS scaler_2, (CAST("ADS_imp_1_OUT".impter_3 AS DOUBLE PRECISION) - -0.03367636493032261) / 0.9578461188823892 AS scaler_3, (CAST("ADS_imp_1_OUT".impter_4 AS DOUBLE PRECISION) - 0.11933316355610842) / 0.988940710894537 AS scaler_4, (CAST("ADS_imp_1_OUT".impter_5 AS DOUBLE PRECISION) - -0.17369203130189262) / 0.9255555424369695 AS scaler_5, (CAST("ADS_imp_1_OUT".impter_6 AS DOUBLE PRECISION) - 0.06534355492106358) / 1.2549066590522007 AS scaler_6, (CAST("ADS_imp_1_OUT".impter_7 AS DOUBLE PRECISION) - 0.2436228993764152) / 1.0289985897454397 AS scaler_7, (CAST("ADS_imp_1_OUT".impter_8 AS DOUBLE PRECISION) - -0.11367357911147091) / 0.8923136895775531 AS scaler_8, (CAST("ADS_imp_1_OUT".impter_9 AS DOUBLE PRECISION) - -0.21176443876708548) / 0.9002988999952058 AS scaler_9, (CAST("ADS_imp_1_OUT".impter_10 AS DOUBLE PRECISION) - 0.11513979914587343) / 1.0407931178174141 AS scaler_10, (CAST("ADS_imp_1_OUT".impter_11 AS DOUBLE PRECISION) - 0.029111924938589835) / 0.8191882677751 AS scaler_11, (CAST("ADS_imp_1_OUT".impter_12 AS DOUBLE PRECISION) - 0.1107718926861467) / 1.1250344343026408 AS scaler_12, (CAST("ADS_imp_1_OUT".impter_13 AS DOUBLE PRECISION) - 0.0014580375424568769) / 1.0581752782303462 AS scaler_13, (CAST("ADS_imp_1_OUT".impter_14 AS DOUBLE PRECISION) - -0.0773739291867229) / 0.9419092604618728 AS scaler_14, (CAST("ADS_imp_1_OUT".impter_15 AS DOUBLE PRECISION) - -0.1139572875884789) / 0.9844340172570488 AS scaler_15, (CAST("ADS_imp_1_OUT".impter_16 AS DOUBLE PRECISION) - -0.12567631285043362) / 1.0696960659875883 AS scaler_16, (CAST("ADS_imp_1_OUT".impter_17 AS DOUBLE PRECISION) - -0.05799597833985687) / 0.9572246869765944 AS scaler_17, (CAST("ADS_imp_1_OUT".impter_18 AS DOUBLE PRECISION) - -0.14181264174476002) / 0.9402782318020427 AS scaler_18, (CAST("ADS_imp_1_OUT".impter_19 AS DOUBLE PRECISION) - -0.1265454286904762) / 1.0394075774622935 AS scaler_19, (CAST("ADS_imp_1_OUT".impter_20 AS DOUBLE PRECISION) - -0.07812248683518369) / 1.3223760230644108 AS scaler_20, (CAST("ADS_imp_1_OUT".impter_21 AS DOUBLE PRECISION) - -0.07648737683022465) / 0.9488949379248575 AS scaler_21, (CAST("ADS_imp_1_OUT".impter_22 AS DOUBLE PRECISION) - 0.05864262427869482) / 0.9538581426644901 AS scaler_22, (CAST("ADS_imp_1_OUT".impter_23 AS DOUBLE PRECISION) - 0.10844037074552852) / 1.210930082570065 AS scaler_23, (CAST("ADS_imp_1_OUT".impter_24 AS DOUBLE PRECISION) - 0.060065969333441514) / 0.9191502156507799 AS scaler_24, (CAST("ADS_imp_1_OUT".impter_25 AS DOUBLE PRECISION) - 0.15255771271935042) / 0.9299576154754636 AS scaler_25, (CAST("ADS_imp_1_OUT".impter_26 AS DOUBLE PRECISION) - -0.047123256877991036) / 0.7721855440773565 AS scaler_26, (CAST("ADS_imp_1_OUT".impter_27 AS DOUBLE PRECISION) - -0.05696296914089203) / 0.8655084393513448 AS scaler_27, (CAST("ADS_imp_1_OUT".impter_28 AS DOUBLE PRECISION) - 0.09614684099943512) / 0.96937898078964 AS scaler_28, (CAST("ADS_imp_1_OUT".impter_29 AS DOUBLE PRECISION) - 0.10433833409752227) / 1.0974731508769155 AS scaler_29, (CAST("ADS_imp_1_OUT".impter_30 AS DOUBLE PRECISION) - 0.03257716191960926) / 0.9435063968783003 AS scaler_30, (CAST("ADS_imp_1_OUT".impter_31 AS DOUBLE PRECISION) - 0.06142905749366723) / 1.1170732733267863 AS scaler_31, (CAST("ADS_imp_1_OUT".impter_32 AS DOUBLE PRECISION) - -0.014540423460679405) / 1.0573168197323033 AS scaler_32, (CAST("ADS_imp_1_OUT".impter_33 AS DOUBLE PRECISION) - -0.1123380099941879) / 0.9786151659749657 AS scaler_33, (CAST("ADS_imp_1_OUT".impter_34 AS DOUBLE PRECISION) - 0.1189128446049145) / 1.0063563400772833 AS scaler_34, (CAST("ADS_imp_1_OUT".impter_35 AS DOUBLE PRECISION) - 0.2286864930078044) / 0.9987517899102172 AS scaler_35, (CAST("ADS_imp_1_OUT".impter_36 AS DOUBLE PRECISION) - 0.23566181549921908) / 0.8892125575448739 AS scaler_36, (CAST("ADS_imp_1_OUT".impter_37 AS DOUBLE PRECISION) - 0.07316970399964386) / 0.8478593314579883 AS scaler_37, (CAST("ADS_imp_1_OUT".impter_38 AS DOUBLE PRECISION) - -0.03319409827469623) / 0.9417761591755847 AS scaler_38, (CAST("ADS_imp_1_OUT".impter_39 AS DOUBLE PRECISION) - 0.2734938774177451) / 0.8842710941098582 AS scaler_39, (CAST("ADS_imp_1_OUT".impter_40 AS DOUBLE PRECISION) - -0.023289567742236165) / 0.9947645749252034 AS scaler_40, (CAST("ADS_imp_1_OUT".impter_41 AS DOUBLE PRECISION) - 0.030288379260645946) / 1.038539402148216 AS scaler_41, (CAST("ADS_imp_1_OUT".impter_42 AS DOUBLE PRECISION) - -0.10736826233135917) / 0.9830117951146878 AS scaler_42, (CAST("ADS_imp_1_OUT".impter_43 AS DOUBLE PRECISION) - 0.026402950097887946) / 1.0398287539710105 AS scaler_43, (CAST("ADS_imp_1_OUT".impter_44 AS DOUBLE PRECISION) - -0.09677146654911453) / 1.0015225564098231 AS scaler_44, (CAST("ADS_imp_1_OUT".impter_45 AS DOUBLE PRECISION) - 0.005974248342970334) / 0.9192248357286628 AS scaler_45, (CAST("ADS_imp_1_OUT".impter_46 AS DOUBLE PRECISION) - 0.036917268127071114) / 1.069754938973098 AS scaler_46, (CAST("ADS_imp_1_OUT".impter_47 AS DOUBLE PRECISION) - -0.14525717382374131) / 1.0022143023048327 AS scaler_47, (CAST("ADS_imp_1_OUT".impter_48 AS DOUBLE PRECISION) - -0.16675269881177787) / 1.0264976173555715 AS scaler_48, (CAST("ADS_imp_1_OUT".impter_49 AS DOUBLE PRECISION) - 0.25084465695652713) / 1.0176351295531831 AS scaler_49, (CAST("ADS_imp_1_OUT".impter_50 AS DOUBLE PRECISION) - 0.14623398322257627) / 0.9499010882454708 AS scaler_50, (CAST("ADS_imp_1_OUT".impter_51 AS DOUBLE PRECISION) - 0.10185431133406106) / 1.0834913023248847 AS scaler_51, (CAST("ADS_imp_1_OUT".impter_52 AS DOUBLE PRECISION) - -0.13292560945085755) / 1.203043012940759 AS scaler_52, (CAST("ADS_imp_1_OUT".impter_53 AS DOUBLE PRECISION) - -0.042191791365440365) / 1.0890718481954653 AS scaler_53, (CAST("ADS_imp_1_OUT".impter_54 AS DOUBLE PRECISION) - 0.15214028404681929) / 1.0355928162656227 AS scaler_54, (CAST("ADS_imp_1_OUT".impter_55 AS DOUBLE PRECISION) - -0.15821372314298002) / 0.8130848573586256 AS scaler_55, (CAST("ADS_imp_1_OUT".impter_56 AS DOUBLE PRECISION) - 0.17926260535776073) / 1.0704671463335236 AS scaler_56, (CAST("ADS_imp_1_OUT".impter_57 AS DOUBLE PRECISION) - 0.05077533210437681) / 1.0052564941217246 AS scaler_57, (CAST("ADS_imp_1_OUT".impter_58 AS DOUBLE PRECISION) - -0.011884551362322174) / 0.9691413097866551 AS scaler_58, (CAST("ADS_imp_1_OUT".impter_59 AS DOUBLE PRECISION) - -0.04948745069141103) / 1.2609768269937562 AS scaler_59, (CAST("ADS_imp_1_OUT".impter_60 AS DOUBLE PRECISION) - -0.13256733552482858) / 0.8686251022330442 AS scaler_60, (CAST("ADS_imp_1_OUT".impter_61 AS DOUBLE PRECISION) - 0.11866238202513515) / 1.0631654849592418 AS scaler_61, (CAST("ADS_imp_1_OUT".impter_62 AS DOUBLE PRECISION) - -0.06590828520229039) / 1.0418727908296095 AS scaler_62, (CAST("ADS_imp_1_OUT".impter_63 AS DOUBLE PRECISION) - 0.1554857338869047) / 0.8946519794042862 AS scaler_63, (CAST("ADS_imp_1_OUT".impter_64 AS DOUBLE PRECISION) - -0.006608301490984002) / 0.9166153141716471 AS scaler_64, (CAST("ADS_imp_1_OUT".impter_65 AS DOUBLE PRECISION) - -0.01827580148493827) / 1.037281466599587 AS scaler_65, (CAST("ADS_imp_1_OUT".impter_66 AS DOUBLE PRECISION) - -0.027366317428668574) / 0.8876680722044222 AS scaler_66, (CAST("ADS_imp_1_OUT".impter_67 AS DOUBLE PRECISION) - 0.01436625003668961) / 0.9184976645949744 AS scaler_67, (CAST("ADS_imp_1_OUT".impter_68 AS DOUBLE PRECISION) - 0.054075300089557875) / 0.929588489370402 AS scaler_68, (CAST("ADS_imp_1_OUT".impter_69 AS DOUBLE PRECISION) - -0.23085273383923544) / 0.944088767881375 AS scaler_69, (CAST("ADS_imp_1_OUT".impter_70 AS DOUBLE PRECISION) - -0.24396528808375115) / 1.04592379692413 AS scaler_70, (CAST("ADS_imp_1_OUT".impter_71 AS DOUBLE PRECISION) - 0.06545065787659607) / 0.8967701639849762 AS scaler_71, (CAST("ADS_imp_1_OUT".impter_72 AS DOUBLE PRECISION) - 0.04266518302023082) / 0.8835391881690846 AS scaler_72, (CAST("ADS_imp_1_OUT".impter_73 AS DOUBLE PRECISION) - -0.1540451820349279) / 0.9869791561020547 AS scaler_73, (CAST("ADS_imp_1_OUT".impter_74 AS DOUBLE PRECISION) - -0.2222352564572451) / 0.9537927411956955 AS scaler_74, (CAST("ADS_imp_1_OUT".impter_75 AS DOUBLE PRECISION) - 0.0685606372972674) / 0.953717717145669 AS scaler_75, (CAST("ADS_imp_1_OUT".impter_76 AS DOUBLE PRECISION) - -0.09639592085393558) / 1.035877532027052 AS scaler_76, (CAST("ADS_imp_1_OUT".impter_77 AS DOUBLE PRECISION) - 0.20747518927524572) / 1.0611076222257592 AS scaler_77, (CAST("ADS_imp_1_OUT".impter_78 AS DOUBLE PRECISION) - -0.13945256367132464) / 1.022370053319208 AS scaler_78, (CAST("ADS_imp_1_OUT".impter_79 AS DOUBLE PRECISION) - 0.021954208773706758) / 0.48752447532965937 AS scaler_79, (CAST("ADS_imp_1_OUT".impter_80 AS DOUBLE PRECISION) - 0.07033517037026028) / 0.9984278761892057 AS scaler_80, (CAST("ADS_imp_1_OUT".impter_81 AS DOUBLE PRECISION) - 0.12062472190694748) / 1.0482914370539298 AS scaler_81, (CAST("ADS_imp_1_OUT".impter_82 AS DOUBLE PRECISION) - -0.03376594744247921) / 1.0120395039819923 AS scaler_82, (CAST("ADS_imp_1_OUT".impter_83 AS DOUBLE PRECISION) - -0.11063521313283846) / 0.8487965281981553 AS scaler_83, (CAST("ADS_imp_1_OUT".impter_84 AS DOUBLE PRECISION) - 0.040264280436689885) / 0.9278865519978795 AS scaler_84, (CAST("ADS_imp_1_OUT".impter_85 AS DOUBLE PRECISION) - 0.047619698634703535) / 1.0173681676828843 AS scaler_85, (CAST("ADS_imp_1_OUT".impter_86 AS DOUBLE PRECISION) - 0.10294542896565007) / 0.9363751138268347 AS scaler_86, (CAST("ADS_imp_1_OUT".impter_87 AS DOUBLE PRECISION) - 0.03543139086541035) / 0.9766573952044824 AS scaler_87, (CAST("ADS_imp_1_OUT".impter_88 AS DOUBLE PRECISION) - 0.15812674995414752) / 1.0065679998415296 AS scaler_88, (CAST("ADS_imp_1_OUT".impter_89 AS DOUBLE PRECISION) - -0.09370679202503561) / 0.9521441609239362 AS scaler_89, (CAST("ADS_imp_1_OUT".impter_90 AS DOUBLE PRECISION) - -0.05352174133125283) / 1.0336679876781851 AS scaler_90, (CAST("ADS_imp_1_OUT".impter_91 AS DOUBLE PRECISION) - -0.05671142135749989) / 1.0851107811586167 AS scaler_91, (CAST("ADS_imp_1_OUT".impter_92 AS DOUBLE PRECISION) - 0.1683501919918398) / 0.8286544432716997 AS scaler_92, (CAST("ADS_imp_1_OUT".impter_93 AS DOUBLE PRECISION) - -0.08014687785959375) / 1.070420432549587 AS scaler_93, (CAST("ADS_imp_1_OUT".impter_94 AS DOUBLE PRECISION) - 0.06732751721128641) / 1.1749792199760318 AS scaler_94, (CAST("ADS_imp_1_OUT".impter_95 AS DOUBLE PRECISION) - -0.00888651681786575) / 1.0750073377154254 AS scaler_95, (CAST("ADS_imp_1_OUT".impter_96 AS DOUBLE PRECISION) - 0.026095385517810564) / 1.1078183878209036 AS scaler_96, (CAST("ADS_imp_1_OUT".impter_97 AS DOUBLE PRECISION) - 0.04435425200996614) / 0.8861375411199117 AS scaler_97, (CAST("ADS_imp_1_OUT".impter_98 AS DOUBLE PRECISION) - 0.026895408070568623) / 1.0095288823928932 AS scaler_98, (CAST("ADS_imp_1_OUT".impter_99 AS DOUBLE PRECISION) - 0.18232971539070067) / 0.9551382056239349 AS scaler_99, (CAST("ADS_imp_1_OUT".impter_100 AS DOUBLE PRECISION) - -0.12132540363011564) / 0.9258857556869412 AS scaler_100, (CAST("ADS_imp_1_OUT".impter_101 AS DOUBLE PRECISION) - 0.004420132524286926) / 0.9371965982210728 AS scaler_101 
FROM "TMP_20180508180124_CODEGEN_N9JE" AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT") AS "U"

-- Code For temporary table TMP_20180508180124_CODEGEN_J7O2 part 3. Create Index 

CREATE INDEX "ix_TMP_20180508180124_C_6969" ON "TMP_20180508180124_CODEGEN_J7O2" ("KEY")

-- Code For temporary table TMP_20180508180124_CODEGEN_GC08 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508180124_CODEGEN_GC08" (
	"KEY" BIGINT, 
...
-- Code For temporary table TMP_20180508180124_CODEGEN_GC08 part 2. Populate

INSERT INTO "TMP_20180508180124_CODEGEN_GC08" ("KEY", "Score_0", "Proba_0", "Score_1", "Proba_1") SELECT "U"."KEY", "U"."Score_0", "U"."Proba_0", "U"."Score_1", "U"."Proba_1" 
...
FROM "TMP_20180508180124_CODEGEN_J7O2" AS "ADS_sca_2_OUT"), 
"DT_node_data" AS 
...
FROM (SELECT 1 AS nid, 0.8333333333333334 AS "P_0", 0.1666666666666666 AS "P_1", 0 AS "D", 0.8333333333333334 AS "DP" FROM rdb$database UNION ALL SELECT 2 AS nid, 0.06249999999999997 AS "P_0", 0.9375 AS "P_1", 1 AS "D", 0.9375 AS "DP" FROM rdb$database) AS "Values"), 
"DT_Output" AS 
...
"ADB_Model_0" AS 
(SELECT "DT_Output"."KEY" AS "KEY", (1.0 * (CASE WHEN ("DT_Output"."P_0" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE CASE WHEN ("DT_Output"."P_0" IS NULL OR "DT_Output"."P_0" > 0.0) THEN ln("DT_Output"."P_0") ELSE -1e+20 END END - (CASE WHEN ("DT_Output"."P_0" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE CASE WHEN ("DT_Output"."P_0" IS NULL OR "DT_Output"."P_0" > 0.0) THEN ln("DT_Output"."P_0") ELSE -1e+20 END END + CASE WHEN ("DT_Output"."P_1" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE CASE WHEN ("DT_Output"."P_1" IS NULL OR "DT_Output"."P_1" > 0.0) THEN ln("DT_Output"."P_1") ELSE -1e+20 END END) / 2)) / 16.0 AS "Score_0", 1.0 * (CASE WHEN ("DT_Output"."P_0" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE CASE WHEN ("DT_Output"."P_0" IS NULL OR "DT_Output"."P_0" > 0.0) THEN ln("DT_Output"."P_0") ELSE -1e+20 END END - (CASE WHEN ("DT_Output"."P_0" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE CASE WHEN ("DT_Output"."P_0" IS NULL OR "DT_Output"."P_0" > 0.0) THEN ln("DT_Output"."P_0") ELSE -1e+20 END END + CASE WHEN ("DT_Output"."P_1" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE CASE WHEN ("DT_Output"."P_1" IS NULL OR "DT_Output"."P_1" > 0.0) THEN ln("DT_Output"."P_1") ELSE -1e+20 END END) / 2) AS "Proba_0", (1.0 * (CASE WHEN ("DT_Output"."P_1" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE CASE WHEN ("DT_Output"."P_1" IS NULL OR "DT_Output"."P_1" > 0.0) THEN ln("DT_Output"."P_1") ELSE -1e+20 END END - (CASE WHEN ("DT_Output"."P_0" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE CASE WHEN ("DT_Output"."P_0" IS NULL OR "DT_Output"."P_0" > 0.0) THEN ln("DT_Output"."P_0") ELSE -1e+20 END END + CASE WHEN ("DT_Output"."P_1" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE CASE WHEN ("DT_Output"."P_1" IS NULL OR "DT_Output"."P_1" > 0.0) THEN ln("DT_Output"."P_1") ELSE -1e+20 END END) / 2)) / 16.0 AS "Score_1", 1.0 * (CASE WHEN ("DT_Output"."P_1" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE CASE WHEN ("DT_Output"."P_1" IS NULL OR "DT_Output"."P_1" > 0.0) THEN ln("DT_Output"."P_1") ELSE -1e+20 END END - (CASE WHEN ("DT_Output"."P_0" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE CASE WHEN ("DT_Output"."P_0" IS NULL OR "DT_Output"."P_0" > 0.0) THEN ln("DT_Output"."P_0") ELSE -1e+20 END END + CASE WHEN ("DT_Output"."P_1" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE CASE WHEN ("DT_Output"."P_1" IS NULL OR "DT_Output"."P_1" > 0.0) THEN ln("DT_Output"."P_1") ELSE -1e+20 END END) / 2) AS "Proba_1" 
FROM "DT_Output"), 
"DT_node_lookup_1" AS 
...
"DT_node_data_1" AS 
(SELECT "Values".nid AS nid, CAST("Values"."P_0" AS DOUBLE PRECISION) AS "P_0", CAST("Values"."P_1" AS DOUBLE PRECISION) AS "P_1", CAST("Values"."D" AS DOUBLE PRECISION) AS "D", CAST("Values"."DP" AS DOUBLE PRECISION) AS "DP" 
FROM (SELECT 1 AS nid, 0.8533673609548595 AS "P_0", 0.14663263904514046 AS "P_1", 0 AS "D", 0.8533673609548595 AS "DP" FROM rdb$database UNION ALL SELECT 2 AS nid, 0.25225431952498373 AS "P_0", 0.7477456804750163 AS "P_1", 1 AS "D", 0.7477456804750163 AS "DP" FROM rdb$database) AS "Values"), 
"DT_Output_1" AS 
...
"ADB_Model_1" AS 
(SELECT "DT_Output_1"."KEY" AS "KEY", (1.0 * (CASE WHEN ("DT_Output_1"."P_0" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE CASE WHEN ("DT_Output_1"."P_0" IS NULL OR "DT_Output_1"."P_0" > 0.0) THEN ln("DT_Output_1"."P_0") ELSE -1e+20 END END - (CASE WHEN ("DT_Output_1"."P_0" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE CASE WHEN ("DT_Output_1"."P_0" IS NULL OR "DT_Output_1"."P_0" > 0.0) THEN ln("DT_Output_1"."P_0") ELSE -1e+20 END END + CASE WHEN ("DT_Output_1"."P_1" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE CASE WHEN ("DT_Output_1"."P_1" IS NULL OR "DT_Output_1"."P_1" > 0.0) THEN ln("DT_Output_1"."P_1") ELSE -1e+20 END END) / 2)) / 16.0 AS "Score_0", 1.0 * (CASE WHEN ("DT_Output_1"."P_0" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE CASE WHEN ("DT_Output_1"."P_0" IS NULL OR "DT_Output_1"."P_0" > 0.0) THEN ln("DT_Output_1"."P_0") ELSE -1e+20 END END - (CASE WHEN ("DT_Output_1"."P_0" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE CASE WHEN ("DT_Output_1"."P_0" IS NULL OR "DT_Output_1"."P_0" > 0.0) THEN ln("DT_Output_1"."P_0") ELSE -1e+20 END END + CASE WHEN ("DT_Output_1"."P_1" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE CASE WHEN ("DT_Output_1"."P_1" IS NULL OR "DT_Output_1"."P_1" > 0.0) THEN ln("DT_Output_1"."P_1") ELSE -1e+20 END END) / 2) AS "Proba_0", (1.0 * (CASE WHEN ("DT_Output_1"."P_1" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE CASE WHEN ("DT_Output_1"."P_1" IS NULL OR "DT_Output_1"."P_1" > 0.0) THEN ln("DT_Output_1"."P_1") ELSE -1e+20 END END - (CASE WHEN ("DT_Output_1"."P_0" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE CASE WHEN ("DT_Output_1"."P_0" IS NULL OR "DT_Output_1"."P_0" > 0.0) THEN ln("DT_Output_1"."P_0") ELSE -1e+20 END END + CASE WHEN ("DT_Output_1"."P_1" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE CASE WHEN ("DT_Output_1"."P_1" IS NULL OR "DT_Output_1"."P_1" > 0.0) THEN ln("DT_Output_1"."P_1") ELSE -1e+20 END END) / 2)) / 16.0 AS "Score_1", 1.0 * (CASE WHEN ("DT_Output_1"."P_1" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE CASE WHEN ("DT_Output_1"."P_1" IS NULL OR "DT_Output_1"."P_1" > 0.0) THEN ln("DT_Output_1"."P_1") ELSE -1e+20 END END - (CASE WHEN ("DT_Output_1"."P_0" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE CASE WHEN ("DT_Output_1"."P_0" IS NULL OR "DT_Output_1"."P_0" > 0.0) THEN ln("DT_Output_1"."P_0") ELSE -1e+20 END END + CASE WHEN ("DT_Output_1"."P_1" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE CASE WHEN ("DT_Output_1"."P_1" IS NULL OR "DT_Output_1"."P_1" > 0.0) THEN ln("DT_Output_1"."P_1") ELSE -1e+20 END END) / 2) AS "Proba_1" 
FROM "DT_Output_1"), 
"DT_node_lookup_2" AS 
...
"DT_node_data_2" AS 
(SELECT "Values".nid AS nid, CAST("Values"."P_0" AS DOUBLE PRECISION) AS "P_0", CAST("Values"."P_1" AS DOUBLE PRECISION) AS "P_1", CAST("Values"."D" AS DOUBLE PRECISION) AS "D", CAST("Values"."DP" AS DOUBLE PRECISION) AS "DP" 
FROM (SELECT 1 AS nid, 0.320163468816651 AS "P_0", 0.6798365311833491 AS "P_1", 1 AS "D", 0.6798365311833491 AS "DP" FROM rdb$database UNION ALL SELECT 2 AS nid, 1.0 AS "P_0", 0.0 AS "P_1", 0 AS "D", 1.0 AS "DP" FROM rdb$database) AS "Values"), 
"DT_Output_2" AS 
...
"ADB_Model_2" AS 
(SELECT "DT_Output_2"."KEY" AS "KEY", (1.0 * (CASE WHEN ("DT_Output_2"."P_0" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE CASE WHEN ("DT_Output_2"."P_0" IS NULL OR "DT_Output_2"."P_0" > 0.0) THEN ln("DT_Output_2"."P_0") ELSE -1e+20 END END - (CASE WHEN ("DT_Output_2"."P_0" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE CASE WHEN ("DT_Output_2"."P_0" IS NULL OR "DT_Output_2"."P_0" > 0.0) THEN ln("DT_Output_2"."P_0") ELSE -1e+20 END END + CASE WHEN ("DT_Output_2"."P_1" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE CASE WHEN ("DT_Output_2"."P_1" IS NULL OR "DT_Output_2"."P_1" > 0.0) THEN ln("DT_Output_2"."P_1") ELSE -1e+20 END END) / 2)) / 16.0 AS "Score_0", 1.0 * (CASE WHEN ("DT_Output_2"."P_0" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE CASE WHEN ("DT_Output_2"."P_0" IS NULL OR "DT_Output_2"."P_0" > 0.0) THEN ln("DT_Output_2"."P_0") ELSE -1e+20 END END - (CASE WHEN ("DT_Output_2"."P_0" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE CASE WHEN ("DT_Output_2"."P_0" IS NULL OR "DT_Output_2"."P_0" > 0.0) THEN ln("DT_Output_2"."P_0") ELSE -1e+20 END END + CASE WHEN ("DT_Output_2"."P_1" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE CASE WHEN ("DT_Output_2"."P_1" IS NULL OR "DT_Output_2"."P_1" > 0.0) THEN ln("DT_Output_2"."P_1") ELSE -1e+20 END END) / 2) AS "Proba_0", (1.0 * (CASE WHEN ("DT_Output_2"."P_1" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE CASE WHEN ("DT_Output_2"."P_1" IS NULL OR "DT_Output_2"."P_1" > 0.0) THEN ln("DT_Output_2"."P_1") ELSE -1e+20 END END - (CASE WHEN ("DT_Output_2"."P_0" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE CASE WHEN ("DT_Output_2"."P_0" IS NULL OR "DT_Output_2"."P_0" > 0.0) THEN ln("DT_Output_2"."P_0") ELSE -1e+20 END END + CASE WHEN ("DT_Output_2"."P_1" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE CASE WHEN ("DT_Output_2"."P_1" IS NULL OR "DT_Output_2"."P_1" > 0.0) THEN ln("DT_Output_2"."P_1") ELSE -1e+20 END END) / 2)) / 16.0 AS "Score_1", 1.0 * (CASE WHEN ("DT_Output_2"."P_1" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE CASE WHEN ("DT_Output_2"."P_1" IS NULL OR "DT_Output_2"."P_1" > 0.0) THEN ln("DT_Output_2"."P_1") ELSE -1e+20 END END - (CASE WHEN ("DT_Output_2"."P_0" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE CASE WHEN ("DT_Output_2"."P_0" IS NULL OR "DT_Output_2"."P_0" > 0.0) THEN ln("DT_Output_2"."P_0") ELSE -1e+20 END END + CASE WHEN ("DT_Output_2"."P_1" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE CASE WHEN ("DT_Output_2"."P_1" IS NULL OR "DT_Output_2"."P_1" > 0.0) THEN ln("DT_Output_2"."P_1") ELSE -1e+20 END END) / 2) AS "Proba_1" 
FROM "DT_Output_2"), 
"DT_node_lookup_3" AS 
...
"DT_node_data_3" AS 
(SELECT "Values".nid AS nid, CAST("Values"."P_0" AS DOUBLE PRECISION) AS "P_0", CAST("Values"."P_1" AS DOUBLE PRECISION) AS "P_1", CAST("Values"."D" AS DOUBLE PRECISION) AS "D", CAST("Values"."DP" AS DOUBLE PRECISION) AS "DP" 
FROM (SELECT 1 AS nid, 0.2728653633528405 AS "P_0", 0.7271346366471595 AS "P_1", 1 AS "D", 0.7271346366471595 AS "DP" FROM rdb$database UNION ALL SELECT 2 AS nid, 0.9172429711861868 AS "P_0", 0.08275702881381317 AS "P_1", 0 AS "D", 0.9172429711861868 AS "DP" FROM rdb$database) AS "Values"), 
"DT_Output_3" AS 
...
"ADB_Model_3" AS 
(SELECT "DT_Output_3"."KEY" AS "KEY", (1.0 * (CASE WHEN ("DT_Output_3"."P_0" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE CASE WHEN ("DT_Output_3"."P_0" IS NULL OR "DT_Output_3"."P_0" > 0.0) THEN ln("DT_Output_3"."P_0") ELSE -1e+20 END END - (CASE WHEN ("DT_Output_3"."P_0" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE CASE WHEN ("DT_Output_3"."P_0" IS NULL OR "DT_Output_3"."P_0" > 0.0) THEN ln("DT_Output_3"."P_0") ELSE -1e+20 END END + CASE WHEN ("DT_Output_3"."P_1" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE CASE WHEN ("DT_Output_3"."P_1" IS NULL OR "DT_Output_3"."P_1" > 0.0) THEN ln("DT_Output_3"."P_1") ELSE -1e+20 END END) / 2)) / 16.0 AS "Score_0", 1.0 * (CASE WHEN ("DT_Output_3"."P_0" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE CASE WHEN ("DT_Output_3"."P_0" IS NULL OR "DT_Output_3"."P_0" > 0.0) THEN ln("DT_Output_3"."P_0") ELSE -1e+20 END END - (CASE WHEN ("DT_Output_3"."P_0" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE CASE WHEN ("DT_Output_3"."P_0" IS NULL OR "DT_Output_3"."P_0" > 0.0) THEN ln("DT_Output_3"."P_0") ELSE -1e+20 END END + CASE WHEN ("DT_Output_3"."P_1" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE CASE WHEN ("DT_Output_3"."P_1" IS NULL OR "DT_Output_3"."P_1" > 0.0) THEN ln("DT_Output_3"."P_1") ELSE -1e+20 END END) / 2) AS "Proba_0", (1.0 * (CASE WHEN ("DT_Output_3"."P_1" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE CASE WHEN ("DT_Output_3"."P_1" IS NULL OR "DT_Output_3"."P_1" > 0.0) THEN ln("DT_Output_3"."P_1") ELSE -1e+20 END END - (CASE WHEN ("DT_Output_3"."P_0" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE CASE WHEN ("DT_Output_3"."P_0" IS NULL OR "DT_Output_3"."P_0" > 0.0) THEN ln("DT_Output_3"."P_0") ELSE -1e+20 END END + CASE WHEN ("DT_Output_3"."P_1" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE CASE WHEN ("DT_Output_3"."P_1" IS NULL OR "DT_Output_3"."P_1" > 0.0) THEN ln("DT_Output_3"."P_1") ELSE -1e+20 END END) / 2)) / 16.0 AS "Score_1", 1.0 * (CASE WHEN ("DT_Output_3"."P_1" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE CASE WHEN ("DT_Output_3"."P_1" IS NULL OR "DT_Output_3"."P_1" > 0.0) THEN ln("DT_Output_3"."P_1") ELSE -1e+20 END END - (CASE WHEN ("DT_Output_3"."P_0" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE CASE WHEN ("DT_Output_3"."P_0" IS NULL OR "DT_Output_3"."P_0" > 0.0) THEN ln("DT_Output_3"."P_0") ELSE -1e+20 END END + CASE WHEN ("DT_Output_3"."P_1" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE CASE WHEN ("DT_Output_3"."P_1" IS NULL OR "DT_Output_3"."P_1" > 0.0) THEN ln("DT_Output_3"."P_1") ELSE -1e+20 END END) / 2) AS "Proba_1" 
FROM "DT_Output_3"), 
"DT_node_lookup_4" AS 
...
"DT_node_data_4" AS 
(SELECT "Values".nid AS nid, CAST("Values"."P_0" AS DOUBLE PRECISION) AS "P_0", CAST("Values"."P_1" AS DOUBLE PRECISION) AS "P_1", CAST("Values"."D" AS DOUBLE PRECISION) AS "D", CAST("Values"."DP" AS DOUBLE PRECISION) AS "DP" 
FROM (SELECT 1 AS nid, 0.08003790404936618 AS "P_0", 0.9199620959506338 AS "P_1", 1 AS "D", 0.9199620959506338 AS "DP" FROM rdb$database UNION ALL SELECT 2 AS nid, 0.7225015969128538 AS "P_0", 0.2774984030871463 AS "P_1", 0 AS "D", 0.7225015969128538 AS "DP" FROM rdb$database) AS "Values"), 
"DT_Output_4" AS 
...
"ADB_Model_4" AS 
(SELECT "DT_Output_4"."KEY" AS "KEY", (1.0 * (CASE WHEN ("DT_Output_4"."P_0" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE CASE WHEN ("DT_Output_4"."P_0" IS NULL OR "DT_Output_4"."P_0" > 0.0) THEN ln("DT_Output_4"."P_0") ELSE -1e+20 END END - (CASE WHEN ("DT_Output_4"."P_0" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE CASE WHEN ("DT_Output_4"."P_0" IS NULL OR "DT_Output_4"."P_0" > 0.0) THEN ln("DT_Output_4"."P_0") ELSE -1e+20 END END + CASE WHEN ("DT_Output_4"."P_1" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE CASE WHEN ("DT_Output_4"."P_1" IS NULL OR "DT_Output_4"."P_1" > 0.0) THEN ln("DT_Output_4"."P_1") ELSE -1e+20 END END) / 2)) / 16.0 AS "Score_0", 1.0 * (CASE WHEN ("DT_Output_4"."P_0" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE CASE WHEN ("DT_Output_4"."P_0" IS NULL OR "DT_Output_4"."P_0" > 0.0) THEN ln("DT_Output_4"."P_0") ELSE -1e+20 END END - (CASE WHEN ("DT_Output_4"."P_0" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE CASE WHEN ("DT_Output_4"."P_0" IS NULL OR "DT_Output_4"."P_0" > 0.0) THEN ln("DT_Output_4"."P_0") ELSE -1e+20 END END + CASE WHEN ("DT_Output_4"."P_1" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE CASE WHEN ("DT_Output_4"."P_1" IS NULL OR "DT_Output_4"."P_1" > 0.0) THEN ln("DT_Output_4"."P_1") ELSE -1e+20 END END) / 2) AS "Proba_0", (1.0 * (CASE WHEN ("DT_Output_4"."P_1" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE CASE WHEN ("DT_Output_4"."P_1" IS NULL OR "DT_Output_4"."P_1" > 0.0) THEN ln("DT_Output_4"."P_1") ELSE -1e+20 END END - (CASE WHEN ("DT_Output_4"."P_0" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE CASE WHEN ("DT_Output_4"."P_0" IS NULL OR "DT_Output_4"."P_0" > 0.0) THEN ln("DT_Output_4"."P_0") ELSE -1e+20 END END + CASE WHEN ("DT_Output_4"."P_1" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE CASE WHEN ("DT_Output_4"."P_1" IS NULL OR "DT_Output_4"."P_1" > 0.0) THEN ln("DT_Output_4"."P_1") ELSE -1e+20 END END) / 2)) / 16.0 AS "Score_1", 1.0 * (CASE WHEN ("DT_Output_4"."P_1" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE CASE WHEN ("DT_Output_4"."P_1" IS NULL OR "DT_Output_4"."P_1" > 0.0) THEN ln("DT_Output_4"."P_1") ELSE -1e+20 END END - (CASE WHEN ("DT_Output_4"."P_0" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE CASE WHEN ("DT_Output_4"."P_0" IS NULL OR "DT_Output_4"."P_0" > 0.0) THEN ln("DT_Output_4"."P_0") ELSE -1e+20 END END + CASE WHEN ("DT_Output_4"."P_1" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE CASE WHEN ("DT_Output_4"."P_1" IS NULL OR "DT_Output_4"."P_1" > 0.0) THEN ln("DT_Output_4"."P_1") ELSE -1e+20 END END) / 2) AS "Proba_1" 
FROM "DT_Output_4"), 
"DT_node_lookup_5" AS 
...
"DT_node_data_5" AS 
(SELECT "Values".nid AS nid, CAST("Values"."P_0" AS DOUBLE PRECISION) AS "P_0", CAST("Values"."P_1" AS DOUBLE PRECISION) AS "P_1", CAST("Values"."D" AS DOUBLE PRECISION) AS "D", CAST("Values"."DP" AS DOUBLE PRECISION) AS "DP" 
FROM (SELECT 1 AS nid, 0.23559095476468453 AS "P_0", 0.7644090452353155 AS "P_1", 1 AS "D", 0.7644090452353155 AS "DP" FROM rdb$database UNION ALL SELECT 2 AS nid, 0.7975392439655866 AS "P_0", 0.20246075603441344 AS "P_1", 0 AS "D", 0.7975392439655866 AS "DP" FROM rdb$database) AS "Values"), 
"DT_Output_5" AS 
...
"ADB_Model_5" AS 
(SELECT "DT_Output_5"."KEY" AS "KEY", (1.0 * (CASE WHEN ("DT_Output_5"."P_0" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE CASE WHEN ("DT_Output_5"."P_0" IS NULL OR "DT_Output_5"."P_0" > 0.0) THEN ln("DT_Output_5"."P_0") ELSE -1e+20 END END - (CASE WHEN ("DT_Output_5"."P_0" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE CASE WHEN ("DT_Output_5"."P_0" IS NULL OR "DT_Output_5"."P_0" > 0.0) THEN ln("DT_Output_5"."P_0") ELSE -1e+20 END END + CASE WHEN ("DT_Output_5"."P_1" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE CASE WHEN ("DT_Output_5"."P_1" IS NULL OR "DT_Output_5"."P_1" > 0.0) THEN ln("DT_Output_5"."P_1") ELSE -1e+20 END END) / 2)) / 16.0 AS "Score_0", 1.0 * (CASE WHEN ("DT_Output_5"."P_0" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE CASE WHEN ("DT_Output_5"."P_0" IS NULL OR "DT_Output_5"."P_0" > 0.0) THEN ln("DT_Output_5"."P_0") ELSE -1e+20 END END - (CASE WHEN ("DT_Output_5"."P_0" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE CASE WHEN ("DT_Output_5"."P_0" IS NULL OR "DT_Output_5"."P_0" > 0.0) THEN ln("DT_Output_5"."P_0") ELSE -1e+20 END END + CASE WHEN ("DT_Output_5"."P_1" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE CASE WHEN ("DT_Output_5"."P_1" IS NULL OR "DT_Output_5"."P_1" > 0.0) THEN ln("DT_Output_5"."P_1") ELSE -1e+20 END END) / 2) AS "Proba_0", (1.0 * (CASE WHEN ("DT_Output_5"."P_1" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE CASE WHEN ("DT_Output_5"."P_1" IS NULL OR "DT_Output_5"."P_1" > 0.0) THEN ln("DT_Output_5"."P_1") ELSE -1e+20 END END - (CASE WHEN ("DT_Output_5"."P_0" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE CASE WHEN ("DT_Output_5"."P_0" IS NULL OR "DT_Output_5"."P_0" > 0.0) THEN ln("DT_Output_5"."P_0") ELSE -1e+20 END END + CASE WHEN ("DT_Output_5"."P_1" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE CASE WHEN ("DT_Output_5"."P_1" IS NULL OR "DT_Output_5"."P_1" > 0.0) THEN ln("DT_Output_5"."P_1") ELSE -1e+20 END END) / 2)) / 16.0 AS "Score_1", 1.0 * (CASE WHEN ("DT_Output_5"."P_1" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE CASE WHEN ("DT_Output_5"."P_1" IS NULL OR "DT_Output_5"."P_1" > 0.0) THEN ln("DT_Output_5"."P_1") ELSE -1e+20 END END - (CASE WHEN ("DT_Output_5"."P_0" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE CASE WHEN ("DT_Output_5"."P_0" IS NULL OR "DT_Output_5"."P_0" > 0.0) THEN ln("DT_Output_5"."P_0") ELSE -1e+20 END END + CASE WHEN ("DT_Output_5"."P_1" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE CASE WHEN ("DT_Output_5"."P_1" IS NULL OR "DT_Output_5"."P_1" > 0.0) THEN ln("DT_Output_5"."P_1") ELSE -1e+20 END END) / 2) AS "Proba_1" 
FROM "DT_Output_5"), 
"DT_node_lookup_6" AS 
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", CASE WHEN ("ADS_sca_2_OUT".scaler_59 <= 0.06653057038784027) THEN 1 ELSE 2 END AS node_id_2 
FROM "TMP_20180508180124_CODEGEN_J7O2" AS "ADS_sca_2_OUT"), 
"DT_node_data_6" AS 
(SELECT "Values".nid AS nid, CAST("Values"."P_0" AS DOUBLE PRECISION) AS "P_0", CAST("Values"."P_1" AS DOUBLE PRECISION) AS "P_1", CAST("Values"."D" AS DOUBLE PRECISION) AS "D", CAST("Values"."DP" AS DOUBLE PRECISION) AS "DP" 
FROM (SELECT 1 AS nid, 0.7146779526640179 AS "P_0", 0.2853220473359822 AS "P_1", 0 AS "D", 0.7146779526640179 AS "DP" FROM rdb$database UNION ALL SELECT 2 AS nid, 0.09146984048309499 AS "P_0", 0.908530159516905 AS "P_1", 1 AS "D", 0.908530159516905 AS "DP" FROM rdb$database) AS "Values"), 
"DT_Output_6" AS 
...
"ADB_Model_6" AS 
(SELECT "DT_Output_6"."KEY" AS "KEY", (1.0 * (CASE WHEN ("DT_Output_6"."P_0" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE CASE WHEN ("DT_Output_6"."P_0" IS NULL OR "DT_Output_6"."P_0" > 0.0) THEN ln("DT_Output_6"."P_0") ELSE -1e+20 END END - (CASE WHEN ("DT_Output_6"."P_0" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE CASE WHEN ("DT_Output_6"."P_0" IS NULL OR "DT_Output_6"."P_0" > 0.0) THEN ln("DT_Output_6"."P_0") ELSE -1e+20 END END + CASE WHEN ("DT_Output_6"."P_1" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE CASE WHEN ("DT_Output_6"."P_1" IS NULL OR "DT_Output_6"."P_1" > 0.0) THEN ln("DT_Output_6"."P_1") ELSE -1e+20 END END) / 2)) / 16.0 AS "Score_0", 1.0 * (CASE WHEN ("DT_Output_6"."P_0" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE CASE WHEN ("DT_Output_6"."P_0" IS NULL OR "DT_Output_6"."P_0" > 0.0) THEN ln("DT_Output_6"."P_0") ELSE -1e+20 END END - (CASE WHEN ("DT_Output_6"."P_0" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE CASE WHEN ("DT_Output_6"."P_0" IS NULL OR "DT_Output_6"."P_0" > 0.0) THEN ln("DT_Output_6"."P_0") ELSE -1e+20 END END + CASE WHEN ("DT_Output_6"."P_1" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE CASE WHEN ("DT_Output_6"."P_1" IS NULL OR "DT_Output_6"."P_1" > 0.0) THEN ln("DT_Output_6"."P_1") ELSE -1e+20 END END) / 2) AS "Proba_0", (1.0 * (CASE WHEN ("DT_Output_6"."P_1" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE CASE WHEN ("DT_Output_6"."P_1" IS NULL OR "DT_Output_6"."P_1" > 0.0) THEN ln("DT_Output_6"."P_1") ELSE -1e+20 END END - (CASE WHEN ("DT_Output_6"."P_0" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE CASE WHEN ("DT_Output_6"."P_0" IS NULL OR "DT_Output_6"."P_0" > 0.0) THEN ln("DT_Output_6"."P_0") ELSE -1e+20 END END + CASE WHEN ("DT_Output_6"."P_1" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE CASE WHEN ("DT_Output_6"."P_1" IS NULL OR "DT_Output_6"."P_1" > 0.0) THEN ln("DT_Output_6"."P_1") ELSE -1e+20 END END) / 2)) / 16.0 AS "Score_1", 1.0 * (CASE WHEN ("DT_Output_6"."P_1" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE CASE WHEN ("DT_Output_6"."P_1" IS NULL OR "DT_Output_6"."P_1" > 0.0) THEN ln("DT_Output_6"."P_1") ELSE -1e+20 END END - (CASE WHEN ("DT_Output_6"."P_0" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE CASE WHEN ("DT_Output_6"."P_0" IS NULL OR "DT_Output_6"."P_0" > 0.0) THEN ln("DT_Output_6"."P_0") ELSE -1e+20 END END + CASE WHEN ("DT_Output_6"."P_1" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE CASE WHEN ("DT_Output_6"."P_1" IS NULL OR "DT_Output_6"."P_1" > 0.0) THEN ln("DT_Output_6"."P_1") ELSE -1e+20 END END) / 2) AS "Proba_1" 
FROM "DT_Output_6"), 
"DT_node_lookup_7" AS 
...
"DT_node_data_7" AS 
(SELECT "Values".nid AS nid, CAST("Values"."P_0" AS DOUBLE PRECISION) AS "P_0", CAST("Values"."P_1" AS DOUBLE PRECISION) AS "P_1", CAST("Values"."D" AS DOUBLE PRECISION) AS "D", CAST("Values"."DP" AS DOUBLE PRECISION) AS "DP" 
FROM (SELECT 1 AS nid, 0.8761591417176888 AS "P_0", 0.12384085828231128 AS "P_1", 0 AS "D", 0.8761591417176888 AS "DP" FROM rdb$database UNION ALL SELECT 2 AS nid, 0.2636984904122652 AS "P_0", 0.7363015095877348 AS "P_1", 1 AS "D", 0.7363015095877348 AS "DP" FROM rdb$database) AS "Values"), 
"DT_Output_7" AS 
...
"ADB_Model_7" AS 
(SELECT "DT_Output_7"."KEY" AS "KEY", (1.0 * (CASE WHEN ("DT_Output_7"."P_0" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE CASE WHEN ("DT_Output_7"."P_0" IS NULL OR "DT_Output_7"."P_0" > 0.0) THEN ln("DT_Output_7"."P_0") ELSE -1e+20 END END - (CASE WHEN ("DT_Output_7"."P_0" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE CASE WHEN ("DT_Output_7"."P_0" IS NULL OR "DT_Output_7"."P_0" > 0.0) THEN ln("DT_Output_7"."P_0") ELSE -1e+20 END END + CASE WHEN ("DT_Output_7"."P_1" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE CASE WHEN ("DT_Output_7"."P_1" IS NULL OR "DT_Output_7"."P_1" > 0.0) THEN ln("DT_Output_7"."P_1") ELSE -1e+20 END END) / 2)) / 16.0 AS "Score_0", 1.0 * (CASE WHEN ("DT_Output_7"."P_0" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE CASE WHEN ("DT_Output_7"."P_0" IS NULL OR "DT_Output_7"."P_0" > 0.0) THEN ln("DT_Output_7"."P_0") ELSE -1e+20 END END - (CASE WHEN ("DT_Output_7"."P_0" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE CASE WHEN ("DT_Output_7"."P_0" IS NULL OR "DT_Output_7"."P_0" > 0.0) THEN ln("DT_Output_7"."P_0") ELSE -1e+20 END END + CASE WHEN ("DT_Output_7"."P_1" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE CASE WHEN ("DT_Output_7"."P_1" IS NULL OR "DT_Output_7"."P_1" > 0.0) THEN ln("DT_Output_7"."P_1") ELSE -1e+20 END END) / 2) AS "Proba_0", (1.0 * (CASE WHEN ("DT_Output_7"."P_1" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE CASE WHEN ("DT_Output_7"."P_1" IS NULL OR "DT_Output_7"."P_1" > 0.0) THEN ln("DT_Output_7"."P_1") ELSE -1e+20 END END - (CASE WHEN ("DT_Output_7"."P_0" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE CASE WHEN ("DT_Output_7"."P_0" IS NULL OR "DT_Output_7"."P_0" > 0.0) THEN ln("DT_Output_7"."P_0") ELSE -1e+20 END END + CASE WHEN ("DT_Output_7"."P_1" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE CASE WHEN ("DT_Output_7"."P_1" IS NULL OR "DT_Output_7"."P_1" > 0.0) THEN ln("DT_Output_7"."P_1") ELSE -1e+20 END END) / 2)) / 16.0 AS "Score_1", 1.0 * (CASE WHEN ("DT_Output_7"."P_1" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE CASE WHEN ("DT_Output_7"."P_1" IS NULL OR "DT_Output_7"."P_1" > 0.0) THEN ln("DT_Output_7"."P_1") ELSE -1e+20 END END - (CASE WHEN ("DT_Output_7"."P_0" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE CASE WHEN ("DT_Output_7"."P_0" IS NULL OR "DT_Output_7"."P_0" > 0.0) THEN ln("DT_Output_7"."P_0") ELSE -1e+20 END END + CASE WHEN ("DT_Output_7"."P_1" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE CASE WHEN ("DT_Output_7"."P_1" IS NULL OR "DT_Output_7"."P_1" > 0.0) THEN ln("DT_Output_7"."P_1") ELSE -1e+20 END END) / 2) AS "Proba_1" 
FROM "DT_Output_7"), 
"DT_node_lookup_8" AS 
...
"DT_node_data_8" AS 
(SELECT "Values".nid AS nid, CAST("Values"."P_0" AS DOUBLE PRECISION) AS "P_0", CAST("Values"."P_1" AS DOUBLE PRECISION) AS "P_1", CAST("Values"."D" AS DOUBLE PRECISION) AS "D", CAST("Values"."DP" AS DOUBLE PRECISION) AS "DP" 
FROM (SELECT 1 AS nid, 0.10209880478775882 AS "P_0", 0.8979011952122412 AS "P_1", 1 AS "D", 0.8979011952122412 AS "DP" FROM rdb$database UNION ALL SELECT 2 AS nid, 0.7100131728976986 AS "P_0", 0.2899868271023014 AS "P_1", 0 AS "D", 0.7100131728976986 AS "DP" FROM rdb$database) AS "Values"), 
"DT_Output_8" AS 
...
"ADB_Model_8" AS 
(SELECT "DT_Output_8"."KEY" AS "KEY", (1.0 * (CASE WHEN ("DT_Output_8"."P_0" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE CASE WHEN ("DT_Output_8"."P_0" IS NULL OR "DT_Output_8"."P_0" > 0.0) THEN ln("DT_Output_8"."P_0") ELSE -1e+20 END END - (CASE WHEN ("DT_Output_8"."P_0" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE CASE WHEN ("DT_Output_8"."P_0" IS NULL OR "DT_Output_8"."P_0" > 0.0) THEN ln("DT_Output_8"."P_0") ELSE -1e+20 END END + CASE WHEN ("DT_Output_8"."P_1" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE CASE WHEN ("DT_Output_8"."P_1" IS NULL OR "DT_Output_8"."P_1" > 0.0) THEN ln("DT_Output_8"."P_1") ELSE -1e+20 END END) / 2)) / 16.0 AS "Score_0", 1.0 * (CASE WHEN ("DT_Output_8"."P_0" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE CASE WHEN ("DT_Output_8"."P_0" IS NULL OR "DT_Output_8"."P_0" > 0.0) THEN ln("DT_Output_8"."P_0") ELSE -1e+20 END END - (CASE WHEN ("DT_Output_8"."P_0" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE CASE WHEN ("DT_Output_8"."P_0" IS NULL OR "DT_Output_8"."P_0" > 0.0) THEN ln("DT_Output_8"."P_0") ELSE -1e+20 END END + CASE WHEN ("DT_Output_8"."P_1" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE CASE WHEN ("DT_Output_8"."P_1" IS NULL OR "DT_Output_8"."P_1" > 0.0) THEN ln("DT_Output_8"."P_1") ELSE -1e+20 END END) / 2) AS "Proba_0", (1.0 * (CASE WHEN ("DT_Output_8"."P_1" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE CASE WHEN ("DT_Output_8"."P_1" IS NULL OR "DT_Output_8"."P_1" > 0.0) THEN ln("DT_Output_8"."P_1") ELSE -1e+20 END END - (CASE WHEN ("DT_Output_8"."P_0" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE CASE WHEN ("DT_Output_8"."P_0" IS NULL OR "DT_Output_8"."P_0" > 0.0) THEN ln("DT_Output_8"."P_0") ELSE -1e+20 END END + CASE WHEN ("DT_Output_8"."P_1" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE CASE WHEN ("DT_Output_8"."P_1" IS NULL OR "DT_Output_8"."P_1" > 0.0) THEN ln("DT_Output_8"."P_1") ELSE -1e+20 END END) / 2)) / 16.0 AS "Score_1", 1.0 * (CASE WHEN ("DT_Output_8"."P_1" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE CASE WHEN ("DT_Output_8"."P_1" IS NULL OR "DT_Output_8"."P_1" > 0.0) THEN ln("DT_Output_8"."P_1") ELSE -1e+20 END END - (CASE WHEN ("DT_Output_8"."P_0" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE CASE WHEN ("DT_Output_8"."P_0" IS NULL OR "DT_Output_8"."P_0" > 0.0) THEN ln("DT_Output_8"."P_0") ELSE -1e+20 END END + CASE WHEN ("DT_Output_8"."P_1" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE CASE WHEN ("DT_Output_8"."P_1" IS NULL OR "DT_Output_8"."P_1" > 0.0) THEN ln("DT_Output_8"."P_1") ELSE -1e+20 END END) / 2) AS "Proba_1" 
FROM "DT_Output_8"), 
"DT_node_lookup_9" AS 
...
"DT_node_data_9" AS 
(SELECT "Values".nid AS nid, CAST("Values"."P_0" AS DOUBLE PRECISION) AS "P_0", CAST("Values"."P_1" AS DOUBLE PRECISION) AS "P_1", CAST("Values"."D" AS DOUBLE PRECISION) AS "D", CAST("Values"."DP" AS DOUBLE PRECISION) AS "DP" 
FROM (SELECT 1 AS nid, 0.21039538866326307 AS "P_0", 0.7896046113367369 AS "P_1", 1 AS "D", 0.7896046113367369 AS "DP" FROM rdb$database UNION ALL SELECT 2 AS nid, 0.8153077678684952 AS "P_0", 0.18469223213150485 AS "P_1", 0 AS "D", 0.8153077678684952 AS "DP" FROM rdb$database) AS "Values"), 
"DT_Output_9" AS 
...
"ADB_Model_9" AS 
(SELECT "DT_Output_9"."KEY" AS "KEY", (1.0 * (CASE WHEN ("DT_Output_9"."P_0" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE CASE WHEN ("DT_Output_9"."P_0" IS NULL OR "DT_Output_9"."P_0" > 0.0) THEN ln("DT_Output_9"."P_0") ELSE -1e+20 END END - (CASE WHEN ("DT_Output_9"."P_0" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE CASE WHEN ("DT_Output_9"."P_0" IS NULL OR "DT_Output_9"."P_0" > 0.0) THEN ln("DT_Output_9"."P_0") ELSE -1e+20 END END + CASE WHEN ("DT_Output_9"."P_1" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE CASE WHEN ("DT_Output_9"."P_1" IS NULL OR "DT_Output_9"."P_1" > 0.0) THEN ln("DT_Output_9"."P_1") ELSE -1e+20 END END) / 2)) / 16.0 AS "Score_0", 1.0 * (CASE WHEN ("DT_Output_9"."P_0" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE CASE WHEN ("DT_Output_9"."P_0" IS NULL OR "DT_Output_9"."P_0" > 0.0) THEN ln("DT_Output_9"."P_0") ELSE -1e+20 END END - (CASE WHEN ("DT_Output_9"."P_0" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE CASE WHEN ("DT_Output_9"."P_0" IS NULL OR "DT_Output_9"."P_0" > 0.0) THEN ln("DT_Output_9"."P_0") ELSE -1e+20 END END + CASE WHEN ("DT_Output_9"."P_1" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE CASE WHEN ("DT_Output_9"."P_1" IS NULL OR "DT_Output_9"."P_1" > 0.0) THEN ln("DT_Output_9"."P_1") ELSE -1e+20 END END) / 2) AS "Proba_0", (1.0 * (CASE WHEN ("DT_Output_9"."P_1" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE CASE WHEN ("DT_Output_9"."P_1" IS NULL OR "DT_Output_9"."P_1" > 0.0) THEN ln("DT_Output_9"."P_1") ELSE -1e+20 END END - (CASE WHEN ("DT_Output_9"."P_0" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE CASE WHEN ("DT_Output_9"."P_0" IS NULL OR "DT_Output_9"."P_0" > 0.0) THEN ln("DT_Output_9"."P_0") ELSE -1e+20 END END + CASE WHEN ("DT_Output_9"."P_1" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE CASE WHEN ("DT_Output_9"."P_1" IS NULL OR "DT_Output_9"."P_1" > 0.0) THEN ln("DT_Output_9"."P_1") ELSE -1e+20 END END) / 2)) / 16.0 AS "Score_1", 1.0 * (CASE WHEN ("DT_Output_9"."P_1" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE CASE WHEN ("DT_Output_9"."P_1" IS NULL OR "DT_Output_9"."P_1" > 0.0) THEN ln("DT_Output_9"."P_1") ELSE -1e+20 END END - (CASE WHEN ("DT_Output_9"."P_0" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE CASE WHEN ("DT_Output_9"."P_0" IS NULL OR "DT_Output_9"."P_0" > 0.0) THEN ln("DT_Output_9"."P_0") ELSE -1e+20 END END + CASE WHEN ("DT_Output_9"."P_1" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE CASE WHEN ("DT_Output_9"."P_1" IS NULL OR "DT_Output_9"."P_1" > 0.0) THEN ln("DT_Output_9"."P_1") ELSE -1e+20 END END) / 2) AS "Proba_1" 
FROM "DT_Output_9")
...
-- Code For temporary table TMP_20180508180124_CODEGEN_CRWC part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508180124_CODEGEN_CRWC" (
	"KEY" BIGINT, 
	"Score_0" DOUBLE PRECISION, 
	"Proba_0" DOUBLE PRECISION, 
	"Score_1" DOUBLE PRECISION, 
...
-- Code For temporary table TMP_20180508180124_CODEGEN_CRWC part 2. Populate

INSERT INTO "TMP_20180508180124_CODEGEN_CRWC" ("KEY", "Score_0", "Proba_0", "Score_1", "Proba_1") SELECT "U"."KEY", "U"."Score_0", "U"."Proba_0", "U"."Score_1", "U"."Proba_1" 
...
"DT_node_data_10" AS 
(SELECT "Values".nid AS nid, CAST("Values"."P_0" AS DOUBLE PRECISION) AS "P_0", CAST("Values"."P_1" AS DOUBLE PRECISION) AS "P_1", CAST("Values"."D" AS DOUBLE PRECISION) AS "D", CAST("Values"."DP" AS DOUBLE PRECISION) AS "DP" 
FROM (SELECT 1 AS nid, 0.8657233264038979 AS "P_0", 0.13427667359610215 AS "P_1", 0 AS "D", 0.8657233264038979 AS "DP" FROM rdb$database UNION ALL SELECT 2 AS nid, 0.26816108937076916 AS "P_0", 0.7318389106292308 AS "P_1", 1 AS "D", 0.7318389106292308 AS "DP" FROM rdb$database) AS "Values"), 
"DT_Output_10" AS 
...
"ADB_Model_10" AS 
(SELECT "DT_Output_10"."KEY" AS "KEY", (1.0 * (CASE WHEN ("DT_Output_10"."P_0" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE CASE WHEN ("DT_Output_10"."P_0" IS NULL OR "DT_Output_10"."P_0" > 0.0) THEN ln("DT_Output_10"."P_0") ELSE -1e+20 END END - (CASE WHEN ("DT_Output_10"."P_0" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE CASE WHEN ("DT_Output_10"."P_0" IS NULL OR "DT_Output_10"."P_0" > 0.0) THEN ln("DT_Output_10"."P_0") ELSE -1e+20 END END + CASE WHEN ("DT_Output_10"."P_1" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE CASE WHEN ("DT_Output_10"."P_1" IS NULL OR "DT_Output_10"."P_1" > 0.0) THEN ln("DT_Output_10"."P_1") ELSE -1e+20 END END) / 2)) / 16.0 AS "Score_0", 1.0 * (CASE WHEN ("DT_Output_10"."P_0" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE CASE WHEN ("DT_Output_10"."P_0" IS NULL OR "DT_Output_10"."P_0" > 0.0) THEN ln("DT_Output_10"."P_0") ELSE -1e+20 END END - (CASE WHEN ("DT_Output_10"."P_0" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE CASE WHEN ("DT_Output_10"."P_0" IS NULL OR "DT_Output_10"."P_0" > 0.0) THEN ln("DT_Output_10"."P_0") ELSE -1e+20 END END + CASE WHEN ("DT_Output_10"."P_1" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE CASE WHEN ("DT_Output_10"."P_1" IS NULL OR "DT_Output_10"."P_1" > 0.0) THEN ln("DT_Output_10"."P_1") ELSE -1e+20 END END) / 2) AS "Proba_0", (1.0 * (CASE WHEN ("DT_Output_10"."P_1" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE CASE WHEN ("DT_Output_10"."P_1" IS NULL OR "DT_Output_10"."P_1" > 0.0) THEN ln("DT_Output_10"."P_1") ELSE -1e+20 END END - (CASE WHEN ("DT_Output_10"."P_0" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE CASE WHEN ("DT_Output_10"."P_0" IS NULL OR "DT_Output_10"."P_0" > 0.0) THEN ln("DT_Output_10"."P_0") ELSE -1e+20 END END + CASE WHEN ("DT_Output_10"."P_1" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE CASE WHEN ("DT_Output_10"."P_1" IS NULL OR "DT_Output_10"."P_1" > 0.0) THEN ln("DT_Output_10"."P_1") ELSE -1e+20 END END) / 2)) / 16.0 AS "Score_1", 1.0 * (CASE WHEN ("DT_Output_10"."P_1" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE CASE WHEN ("DT_Output_10"."P_1" IS NULL OR "DT_Output_10"."P_1" > 0.0) THEN ln("DT_Output_10"."P_1") ELSE -1e+20 END END - (CASE WHEN ("DT_Output_10"."P_0" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE CASE WHEN ("DT_Output_10"."P_0" IS NULL OR "DT_Output_10"."P_0" > 0.0) THEN ln("DT_Output_10"."P_0") ELSE -1e+20 END END + CASE WHEN ("DT_Output_10"."P_1" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE CASE WHEN ("DT_Output_10"."P_1" IS NULL OR "DT_Output_10"."P_1" > 0.0) THEN ln("DT_Output_10"."P_1") ELSE -1e+20 END END) / 2) AS "Proba_1" 
FROM "DT_Output_10"), 
...
"DT_node_data_11" AS 
(SELECT "Values".nid AS nid, CAST("Values"."P_0" AS DOUBLE PRECISION) AS "P_0", CAST("Values"."P_1" AS DOUBLE PRECISION) AS "P_1", CAST("Values"."D" AS DOUBLE PRECISION) AS "D", CAST("Values"."DP" AS DOUBLE PRECISION) AS "DP" 
FROM (SELECT 1 AS nid, 0.27375122893621673 AS "P_0", 0.7262487710637833 AS "P_1", 1 AS "D", 0.7262487710637833 AS "DP" FROM rdb$database UNION ALL SELECT 2 AS nid, 0.914965960430189 AS "P_0", 0.08503403956981113 AS "P_1", 0 AS "D", 0.914965960430189 AS "DP" FROM rdb$database) AS "Values"), 
"DT_Output_11" AS 
...
"ADB_Model_11" AS 
(SELECT "DT_Output_11"."KEY" AS "KEY", (1.0 * (CASE WHEN ("DT_Output_11"."P_0" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE CASE WHEN ("DT_Output_11"."P_0" IS NULL OR "DT_Output_11"."P_0" > 0.0) THEN ln("DT_Output_11"."P_0") ELSE -1e+20 END END - (CASE WHEN ("DT_Output_11"."P_0" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE CASE WHEN ("DT_Output_11"."P_0" IS NULL OR "DT_Output_11"."P_0" > 0.0) THEN ln("DT_Output_11"."P_0") ELSE -1e+20 END END + CASE WHEN ("DT_Output_11"."P_1" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE CASE WHEN ("DT_Output_11"."P_1" IS NULL OR "DT_Output_11"."P_1" > 0.0) THEN ln("DT_Output_11"."P_1") ELSE -1e+20 END END) / 2)) / 16.0 AS "Score_0", 1.0 * (CASE WHEN ("DT_Output_11"."P_0" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE CASE WHEN ("DT_Output_11"."P_0" IS NULL OR "DT_Output_11"."P_0" > 0.0) THEN ln("DT_Output_11"."P_0") ELSE -1e+20 END END - (CASE WHEN ("DT_Output_11"."P_0" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE CASE WHEN ("DT_Output_11"."P_0" IS NULL OR "DT_Output_11"."P_0" > 0.0) THEN ln("DT_Output_11"."P_0") ELSE -1e+20 END END + CASE WHEN ("DT_Output_11"."P_1" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE CASE WHEN ("DT_Output_11"."P_1" IS NULL OR "DT_Output_11"."P_1" > 0.0) THEN ln("DT_Output_11"."P_1") ELSE -1e+20 END END) / 2) AS "Proba_0", (1.0 * (CASE WHEN ("DT_Output_11"."P_1" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE CASE WHEN ("DT_Output_11"."P_1" IS NULL OR "DT_Output_11"."P_1" > 0.0) THEN ln("DT_Output_11"."P_1") ELSE -1e+20 END END - (CASE WHEN ("DT_Output_11"."P_0" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE CASE WHEN ("DT_Output_11"."P_0" IS NULL OR "DT_Output_11"."P_0" > 0.0) THEN ln("DT_Output_11"."P_0") ELSE -1e+20 END END + CASE WHEN ("DT_Output_11"."P_1" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE CASE WHEN ("DT_Output_11"."P_1" IS NULL OR "DT_Output_11"."P_1" > 0.0) THEN ln("DT_Output_11"."P_1") ELSE -1e+20 END END) / 2)) / 16.0 AS "Score_1", 1.0 * (CASE WHEN ("DT_Output_11"."P_1" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE CASE WHEN ("DT_Output_11"."P_1" IS NULL OR "DT_Output_11"."P_1" > 0.0) THEN ln("DT_Output_11"."P_1") ELSE -1e+20 END END - (CASE WHEN ("DT_Output_11"."P_0" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE CASE WHEN ("DT_Output_11"."P_0" IS NULL OR "DT_Output_11"."P_0" > 0.0) THEN ln("DT_Output_11"."P_0") ELSE -1e+20 END END + CASE WHEN ("DT_Output_11"."P_1" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE CASE WHEN ("DT_Output_11"."P_1" IS NULL OR "DT_Output_11"."P_1" > 0.0) THEN ln("DT_Output_11"."P_1") ELSE -1e+20 END END) / 2) AS "Proba_1" 
FROM "DT_Output_11"), 
...
"DT_node_data_12" AS 
(SELECT "Values".nid AS nid, CAST("Values"."P_0" AS DOUBLE PRECISION) AS "P_0", CAST("Values"."P_1" AS DOUBLE PRECISION) AS "P_1", CAST("Values"."D" AS DOUBLE PRECISION) AS "D", CAST("Values"."DP" AS DOUBLE PRECISION) AS "DP" 
FROM (SELECT 1 AS nid, 0.039692646449534005 AS "P_0", 0.960307353550466 AS "P_1", 1 AS "D", 0.960307353550466 AS "DP" FROM rdb$database UNION ALL SELECT 2 AS nid, 0.6910502874384932 AS "P_0", 0.3089497125615069 AS "P_1", 0 AS "D", 0.6910502874384932 AS "DP" FROM rdb$database) AS "Values"), 
"DT_Output_12" AS 
...
"ADB_Model_12" AS 
(SELECT "DT_Output_12"."KEY" AS "KEY", (1.0 * (CASE WHEN ("DT_Output_12"."P_0" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE CASE WHEN ("DT_Output_12"."P_0" IS NULL OR "DT_Output_12"."P_0" > 0.0) THEN ln("DT_Output_12"."P_0") ELSE -1e+20 END END - (CASE WHEN ("DT_Output_12"."P_0" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE CASE WHEN ("DT_Output_12"."P_0" IS NULL OR "DT_Output_12"."P_0" > 0.0) THEN ln("DT_Output_12"."P_0") ELSE -1e+20 END END + CASE WHEN ("DT_Output_12"."P_1" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE CASE WHEN ("DT_Output_12"."P_1" IS NULL OR "DT_Output_12"."P_1" > 0.0) THEN ln("DT_Output_12"."P_1") ELSE -1e+20 END END) / 2)) / 16.0 AS "Score_0", 1.0 * (CASE WHEN ("DT_Output_12"."P_0" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE CASE WHEN ("DT_Output_12"."P_0" IS NULL OR "DT_Output_12"."P_0" > 0.0) THEN ln("DT_Output_12"."P_0") ELSE -1e+20 END END - (CASE WHEN ("DT_Output_12"."P_0" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE CASE WHEN ("DT_Output_12"."P_0" IS NULL OR "DT_Output_12"."P_0" > 0.0) THEN ln("DT_Output_12"."P_0") ELSE -1e+20 END END + CASE WHEN ("DT_Output_12"."P_1" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE CASE WHEN ("DT_Output_12"."P_1" IS NULL OR "DT_Output_12"."P_1" > 0.0) THEN ln("DT_Output_12"."P_1") ELSE -1e+20 END END) / 2) AS "Proba_0", (1.0 * (CASE WHEN ("DT_Output_12"."P_1" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE CASE WHEN ("DT_Output_12"."P_1" IS NULL OR "DT_Output_12"."P_1" > 0.0) THEN ln("DT_Output_12"."P_1") ELSE -1e+20 END END - (CASE WHEN ("DT_Output_12"."P_0" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE CASE WHEN ("DT_Output_12"."P_0" IS NULL OR "DT_Output_12"."P_0" > 0.0) THEN ln("DT_Output_12"."P_0") ELSE -1e+20 END END + CASE WHEN ("DT_Output_12"."P_1" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE CASE WHEN ("DT_Output_12"."P_1" IS NULL OR "DT_Output_12"."P_1" > 0.0) THEN ln("DT_Output_12"."P_1") ELSE -1e+20 END END) / 2)) / 16.0 AS "Score_1", 1.0 * (CASE WHEN ("DT_Output_12"."P_1" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE CASE WHEN ("DT_Output_12"."P_1" IS NULL OR "DT_Output_12"."P_1" > 0.0) THEN ln("DT_Output_12"."P_1") ELSE -1e+20 END END - (CASE WHEN ("DT_Output_12"."P_0" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE CASE WHEN ("DT_Output_12"."P_0" IS NULL OR "DT_Output_12"."P_0" > 0.0) THEN ln("DT_Output_12"."P_0") ELSE -1e+20 END END + CASE WHEN ("DT_Output_12"."P_1" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE CASE WHEN ("DT_Output_12"."P_1" IS NULL OR "DT_Output_12"."P_1" > 0.0) THEN ln("DT_Output_12"."P_1") ELSE -1e+20 END END) / 2) AS "Proba_1" 
FROM "DT_Output_12"), 
...
"DT_node_data_13" AS 
(SELECT "Values".nid AS nid, CAST("Values"."P_0" AS DOUBLE PRECISION) AS "P_0", CAST("Values"."P_1" AS DOUBLE PRECISION) AS "P_1", CAST("Values"."D" AS DOUBLE PRECISION) AS "D", CAST("Values"."DP" AS DOUBLE PRECISION) AS "DP" 
FROM (SELECT 1 AS nid, 0.12139284127328985 AS "P_0", 0.8786071587267102 AS "P_1", 1 AS "D", 0.8786071587267102 AS "DP" FROM rdb$database UNION ALL SELECT 2 AS nid, 0.7372866829662806 AS "P_0", 0.2627133170337193 AS "P_1", 0 AS "D", 0.7372866829662806 AS "DP" FROM rdb$database) AS "Values"), 
"DT_Output_13" AS 
...
"ADB_Model_13" AS 
(SELECT "DT_Output_13"."KEY" AS "KEY", (1.0 * (CASE WHEN ("DT_Output_13"."P_0" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE CASE WHEN ("DT_Output_13"."P_0" IS NULL OR "DT_Output_13"."P_0" > 0.0) THEN ln("DT_Output_13"."P_0") ELSE -1e+20 END END - (CASE WHEN ("DT_Output_13"."P_0" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE CASE WHEN ("DT_Output_13"."P_0" IS NULL OR "DT_Output_13"."P_0" > 0.0) THEN ln("DT_Output_13"."P_0") ELSE -1e+20 END END + CASE WHEN ("DT_Output_13"."P_1" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE CASE WHEN ("DT_Output_13"."P_1" IS NULL OR "DT_Output_13"."P_1" > 0.0) THEN ln("DT_Output_13"."P_1") ELSE -1e+20 END END) / 2)) / 16.0 AS "Score_0", 1.0 * (CASE WHEN ("DT_Output_13"."P_0" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE CASE WHEN ("DT_Output_13"."P_0" IS NULL OR "DT_Output_13"."P_0" > 0.0) THEN ln("DT_Output_13"."P_0") ELSE -1e+20 END END - (CASE WHEN ("DT_Output_13"."P_0" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE CASE WHEN ("DT_Output_13"."P_0" IS NULL OR "DT_Output_13"."P_0" > 0.0) THEN ln("DT_Output_13"."P_0") ELSE -1e+20 END END + CASE WHEN ("DT_Output_13"."P_1" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE CASE WHEN ("DT_Output_13"."P_1" IS NULL OR "DT_Output_13"."P_1" > 0.0) THEN ln("DT_Output_13"."P_1") ELSE -1e+20 END END) / 2) AS "Proba_0", (1.0 * (CASE WHEN ("DT_Output_13"."P_1" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE CASE WHEN ("DT_Output_13"."P_1" IS NULL OR "DT_Output_13"."P_1" > 0.0) THEN ln("DT_Output_13"."P_1") ELSE -1e+20 END END - (CASE WHEN ("DT_Output_13"."P_0" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE CASE WHEN ("DT_Output_13"."P_0" IS NULL OR "DT_Output_13"."P_0" > 0.0) THEN ln("DT_Output_13"."P_0") ELSE -1e+20 END END + CASE WHEN ("DT_Output_13"."P_1" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE CASE WHEN ("DT_Output_13"."P_1" IS NULL OR "DT_Output_13"."P_1" > 0.0) THEN ln("DT_Output_13"."P_1") ELSE -1e+20 END END) / 2)) / 16.0 AS "Score_1", 1.0 * (CASE WHEN ("DT_Output_13"."P_1" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE CASE WHEN ("DT_Output_13"."P_1" IS NULL OR "DT_Output_13"."P_1" > 0.0) THEN ln("DT_Output_13"."P_1") ELSE -1e+20 END END - (CASE WHEN ("DT_Output_13"."P_0" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE CASE WHEN ("DT_Output_13"."P_0" IS NULL OR "DT_Output_13"."P_0" > 0.0) THEN ln("DT_Output_13"."P_0") ELSE -1e+20 END END + CASE WHEN ("DT_Output_13"."P_1" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE CASE WHEN ("DT_Output_13"."P_1" IS NULL OR "DT_Output_13"."P_1" > 0.0) THEN ln("DT_Output_13"."P_1") ELSE -1e+20 END END) / 2) AS "Proba_1" 
FROM "DT_Output_13"), 
...
"DT_node_data_14" AS 
(SELECT "Values".nid AS nid, CAST("Values"."P_0" AS DOUBLE PRECISION) AS "P_0", CAST("Values"."P_1" AS DOUBLE PRECISION) AS "P_1", CAST("Values"."D" AS DOUBLE PRECISION) AS "D", CAST("Values"."DP" AS DOUBLE PRECISION) AS "DP" 
FROM (SELECT 1 AS nid, 0.7601093537278648 AS "P_0", 0.23989064627213516 AS "P_1", 0 AS "D", 0.7601093537278648 AS "DP" FROM rdb$database UNION ALL SELECT 2 AS nid, 0.026809015574647672 AS "P_0", 0.9731909844253523 AS "P_1", 1 AS "D", 0.9731909844253523 AS "DP" FROM rdb$database) AS "Values"), 
"DT_Output_14" AS 
...
"ADB_Model_14" AS 
(SELECT "DT_Output_14"."KEY" AS "KEY", (1.0 * (CASE WHEN ("DT_Output_14"."P_0" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE CASE WHEN ("DT_Output_14"."P_0" IS NULL OR "DT_Output_14"."P_0" > 0.0) THEN ln("DT_Output_14"."P_0") ELSE -1e+20 END END - (CASE WHEN ("DT_Output_14"."P_0" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE CASE WHEN ("DT_Output_14"."P_0" IS NULL OR "DT_Output_14"."P_0" > 0.0) THEN ln("DT_Output_14"."P_0") ELSE -1e+20 END END + CASE WHEN ("DT_Output_14"."P_1" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE CASE WHEN ("DT_Output_14"."P_1" IS NULL OR "DT_Output_14"."P_1" > 0.0) THEN ln("DT_Output_14"."P_1") ELSE -1e+20 END END) / 2)) / 16.0 AS "Score_0", 1.0 * (CASE WHEN ("DT_Output_14"."P_0" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE CASE WHEN ("DT_Output_14"."P_0" IS NULL OR "DT_Output_14"."P_0" > 0.0) THEN ln("DT_Output_14"."P_0") ELSE -1e+20 END END - (CASE WHEN ("DT_Output_14"."P_0" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE CASE WHEN ("DT_Output_14"."P_0" IS NULL OR "DT_Output_14"."P_0" > 0.0) THEN ln("DT_Output_14"."P_0") ELSE -1e+20 END END + CASE WHEN ("DT_Output_14"."P_1" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE CASE WHEN ("DT_Output_14"."P_1" IS NULL OR "DT_Output_14"."P_1" > 0.0) THEN ln("DT_Output_14"."P_1") ELSE -1e+20 END END) / 2) AS "Proba_0", (1.0 * (CASE WHEN ("DT_Output_14"."P_1" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE CASE WHEN ("DT_Output_14"."P_1" IS NULL OR "DT_Output_14"."P_1" > 0.0) THEN ln("DT_Output_14"."P_1") ELSE -1e+20 END END - (CASE WHEN ("DT_Output_14"."P_0" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE CASE WHEN ("DT_Output_14"."P_0" IS NULL OR "DT_Output_14"."P_0" > 0.0) THEN ln("DT_Output_14"."P_0") ELSE -1e+20 END END + CASE WHEN ("DT_Output_14"."P_1" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE CASE WHEN ("DT_Output_14"."P_1" IS NULL OR "DT_Output_14"."P_1" > 0.0) THEN ln("DT_Output_14"."P_1") ELSE -1e+20 END END) / 2)) / 16.0 AS "Score_1", 1.0 * (CASE WHEN ("DT_Output_14"."P_1" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE CASE WHEN ("DT_Output_14"."P_1" IS NULL OR "DT_Output_14"."P_1" > 0.0) THEN ln("DT_Output_14"."P_1") ELSE -1e+20 END END - (CASE WHEN ("DT_Output_14"."P_0" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE CASE WHEN ("DT_Output_14"."P_0" IS NULL OR "DT_Output_14"."P_0" > 0.0) THEN ln("DT_Output_14"."P_0") ELSE -1e+20 END END + CASE WHEN ("DT_Output_14"."P_1" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE CASE WHEN ("DT_Output_14"."P_1" IS NULL OR "DT_Output_14"."P_1" > 0.0) THEN ln("DT_Output_14"."P_1") ELSE -1e+20 END END) / 2) AS "Proba_1" 
FROM "DT_Output_14"), 
...
"DT_node_data_15" AS 
(SELECT "Values".nid AS nid, CAST("Values"."P_0" AS DOUBLE PRECISION) AS "P_0", CAST("Values"."P_1" AS DOUBLE PRECISION) AS "P_1", CAST("Values"."D" AS DOUBLE PRECISION) AS "D", CAST("Values"."DP" AS DOUBLE PRECISION) AS "DP" 
FROM (SELECT 1 AS nid, 1.9866316725807002e-06 AS "P_0", 0.9999980133683274 AS "P_1", 1 AS "D", 0.9999980133683274 AS "DP" FROM rdb$database UNION ALL SELECT 2 AS nid, 0.6897064028174626 AS "P_0", 0.31029359718253724 AS "P_1", 0 AS "D", 0.6897064028174626 AS "DP" FROM rdb$database) AS "Values"), 
"DT_Output_15" AS 
...
"ADB_Model_15" AS 
(SELECT "DT_Output_15"."KEY" AS "KEY", (1.0 * (CASE WHEN ("DT_Output_15"."P_0" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE CASE WHEN ("DT_Output_15"."P_0" IS NULL OR "DT_Output_15"."P_0" > 0.0) THEN ln("DT_Output_15"."P_0") ELSE -1e+20 END END - (CASE WHEN ("DT_Output_15"."P_0" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE CASE WHEN ("DT_Output_15"."P_0" IS NULL OR "DT_Output_15"."P_0" > 0.0) THEN ln("DT_Output_15"."P_0") ELSE -1e+20 END END + CASE WHEN ("DT_Output_15"."P_1" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE CASE WHEN ("DT_Output_15"."P_1" IS NULL OR "DT_Output_15"."P_1" > 0.0) THEN ln("DT_Output_15"."P_1") ELSE -1e+20 END END) / 2)) / 16.0 AS "Score_0", 1.0 * (CASE WHEN ("DT_Output_15"."P_0" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE CASE WHEN ("DT_Output_15"."P_0" IS NULL OR "DT_Output_15"."P_0" > 0.0) THEN ln("DT_Output_15"."P_0") ELSE -1e+20 END END - (CASE WHEN ("DT_Output_15"."P_0" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE CASE WHEN ("DT_Output_15"."P_0" IS NULL OR "DT_Output_15"."P_0" > 0.0) THEN ln("DT_Output_15"."P_0") ELSE -1e+20 END END + CASE WHEN ("DT_Output_15"."P_1" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE CASE WHEN ("DT_Output_15"."P_1" IS NULL OR "DT_Output_15"."P_1" > 0.0) THEN ln("DT_Output_15"."P_1") ELSE -1e+20 END END) / 2) AS "Proba_0", (1.0 * (CASE WHEN ("DT_Output_15"."P_1" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE CASE WHEN ("DT_Output_15"."P_1" IS NULL OR "DT_Output_15"."P_1" > 0.0) THEN ln("DT_Output_15"."P_1") ELSE -1e+20 END END - (CASE WHEN ("DT_Output_15"."P_0" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE CASE WHEN ("DT_Output_15"."P_0" IS NULL OR "DT_Output_15"."P_0" > 0.0) THEN ln("DT_Output_15"."P_0") ELSE -1e+20 END END + CASE WHEN ("DT_Output_15"."P_1" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE CASE WHEN ("DT_Output_15"."P_1" IS NULL OR "DT_Output_15"."P_1" > 0.0) THEN ln("DT_Output_15"."P_1") ELSE -1e+20 END END) / 2)) / 16.0 AS "Score_1", 1.0 * (CASE WHEN ("DT_Output_15"."P_1" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE CASE WHEN ("DT_Output_15"."P_1" IS NULL OR "DT_Output_15"."P_1" > 0.0) THEN ln("DT_Output_15"."P_1") ELSE -1e+20 END END - (CASE WHEN ("DT_Output_15"."P_0" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE CASE WHEN ("DT_Output_15"."P_0" IS NULL OR "DT_Output_15"."P_0" > 0.0) THEN ln("DT_Output_15"."P_0") ELSE -1e+20 END END + CASE WHEN ("DT_Output_15"."P_1" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE CASE WHEN ("DT_Output_15"."P_1" IS NULL OR "DT_Output_15"."P_1" > 0.0) THEN ln("DT_Output_15"."P_1") ELSE -1e+20 END END) / 2) AS "Proba_1" 
FROM "DT_Output_15")
...
-- Code For temporary table TMP_20180508180124_CODEGEN_V1TY part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508180124_CODEGEN_V1TY" (
	"KEY" BIGINT, 
	"Score_0" DOUBLE PRECISION, 
	"Proba_0" DOUBLE PRECISION, 
	"Score_1" DOUBLE PRECISION, 
...
-- Code For temporary table TMP_20180508180124_CODEGEN_V1TY part 2. Populate

INSERT INTO "TMP_20180508180124_CODEGEN_V1TY" ("KEY", "Score_0", "Proba_0", "Score_1", "Proba_1") SELECT "U"."KEY", "U"."Score_0", "U"."Proba_0", "U"."Score_1", "U"."Proba_1" 
...
FROM "TMP_20180508180124_CODEGEN_GC08" AS "ADB_B0" UNION ALL SELECT "ADB_B1"."KEY" AS "KEY", "ADB_B1"."Score_0" AS "Score_0", "ADB_B1"."Proba_0" AS "Proba_0", "ADB_B1"."Score_1" AS "Score_1", "ADB_B1"."Proba_1" AS "Proba_1" 
FROM "TMP_20180508180124_CODEGEN_CRWC" AS "ADB_B1") AS "ADB_EnsembleUnion") AS "ADB_Union") AS "U"

-- Code For temporary table TMP_20180508180124_CODEGEN_BGF1 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508180124_CODEGEN_BGF1" (
	"KEY" BIGINT NOT NULL, 
	"Score_0" DOUBLE PRECISION, 
	"Proba_0" DOUBLE PRECISION, 
	"Score_1" DOUBLE PRECISION, 
...
-- Code For temporary table TMP_20180508180124_CODEGEN_BGF1 part 2. Populate

INSERT INTO "TMP_20180508180124_CODEGEN_BGF1" ("KEY", "Score_0", "Proba_0", "Score_1", "Proba_1") SELECT "U"."KEY", "U"."Score_0", "U"."Proba_0", "U"."Score_1", "U"."Proba_1" 
...
FROM "TMP_20180508180124_CODEGEN_V1TY" AS "ADB_Union" GROUP BY "ADB_Union"."KEY") AS "T") AS "ADB_sum") AS "U"

-- Code For temporary table TMP_20180508180124_CODEGEN_BGF1 part 3. Create Index 

CREATE INDEX "ix_TMP_20180508180124_C_b1ec" ON "TMP_20180508180124_CODEGEN_BGF1" ("KEY")
...
FROM "TMP_20180508180124_CODEGEN_BGF1" AS "ADB_sum"), 
