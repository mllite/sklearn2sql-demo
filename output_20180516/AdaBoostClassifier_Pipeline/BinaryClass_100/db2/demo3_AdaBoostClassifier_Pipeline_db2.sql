...
-- Code For temporary table tmp_20180508180126_codegen_7of681_ads_imp_1_out part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180508180126_codegen_7of681_ads_imp_1_out (
	"KEY" BIGINT, 
	impter_2 DOUBLE, 
	impter_3 DOUBLE, 
	impter_4 DOUBLE, 
...
-- Code For temporary table tmp_20180508180126_codegen_6sk8ec_ads_sca_2_out part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180508180126_codegen_6sk8ec_ads_sca_2_out (
	"KEY" BIGINT, 
	scaler_2 DOUBLE, 
	scaler_3 DOUBLE, 
	scaler_4 DOUBLE, 
...
FROM tmp_20180508180126_codegen_7of681_ads_imp_1_out AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT"

-- Code For temporary table tmp_20180508180127_codegen_rb55gy_adb_b0 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180508180127_codegen_rb55gy_adb_b0 (
	"KEY" BIGINT, 
	"Score_0" DOUBLE, 
	"Proba_0" DOUBLE, 
	"Score_1" DOUBLE, 
...
-- Code For temporary table tmp_20180508180127_codegen_rb55gy_adb_b0 part 2. Populate

INSERT INTO tmp_20180508180127_codegen_rb55gy_adb_b0 WITH "DT_node_lookup" AS 
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", CASE WHEN ("ADS_sca_2_OUT".scaler_59 <= 0.06653057038784027) THEN 1 ELSE 2 END AS node_id_2 
FROM tmp_20180508180126_codegen_6sk8ec_ads_sca_2_out AS "ADS_sca_2_OUT"), 
"DT_node_data" AS 
...
FROM (SELECT 1 AS nid, 0.8333333333333334 AS "P_0", 0.1666666666666666 AS "P_1", 0 AS "D", 0.8333333333333334 AS "DP" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 2 AS nid, 0.06249999999999997 AS "P_0", 0.9375 AS "P_1", 1 AS "D", 0.9375 AS "DP" FROM SYSIBM.SYSDUMMY1) AS "Values"), 
"DT_Output" AS 
...
"DT_node_data_1" AS 
(SELECT "Values".nid AS nid, CAST("Values"."P_0" AS DOUBLE) AS "P_0", CAST("Values"."P_1" AS DOUBLE) AS "P_1", CAST("Values"."D" AS DOUBLE) AS "D", CAST("Values"."DP" AS DOUBLE) AS "DP" 
FROM (SELECT 1 AS nid, 0.8533673609548595 AS "P_0", 0.14663263904514046 AS "P_1", 0 AS "D", 0.8533673609548595 AS "DP" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 2 AS nid, 0.25225431952498373 AS "P_0", 0.7477456804750163 AS "P_1", 1 AS "D", 0.7477456804750163 AS "DP" FROM SYSIBM.SYSDUMMY1) AS "Values"), 
"DT_Output_1" AS 
...
"DT_node_data_2" AS 
(SELECT "Values".nid AS nid, CAST("Values"."P_0" AS DOUBLE) AS "P_0", CAST("Values"."P_1" AS DOUBLE) AS "P_1", CAST("Values"."D" AS DOUBLE) AS "D", CAST("Values"."DP" AS DOUBLE) AS "DP" 
FROM (SELECT 1 AS nid, 0.320163468816651 AS "P_0", 0.6798365311833491 AS "P_1", 1 AS "D", 0.6798365311833491 AS "DP" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 2 AS nid, 1.0 AS "P_0", 0.0 AS "P_1", 0 AS "D", 1.0 AS "DP" FROM SYSIBM.SYSDUMMY1) AS "Values"), 
"DT_Output_2" AS 
...
"DT_node_data_3" AS 
(SELECT "Values".nid AS nid, CAST("Values"."P_0" AS DOUBLE) AS "P_0", CAST("Values"."P_1" AS DOUBLE) AS "P_1", CAST("Values"."D" AS DOUBLE) AS "D", CAST("Values"."DP" AS DOUBLE) AS "DP" 
FROM (SELECT 1 AS nid, 0.2728653633528405 AS "P_0", 0.7271346366471595 AS "P_1", 1 AS "D", 0.7271346366471595 AS "DP" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 2 AS nid, 0.9172429711861868 AS "P_0", 0.08275702881381317 AS "P_1", 0 AS "D", 0.9172429711861868 AS "DP" FROM SYSIBM.SYSDUMMY1) AS "Values"), 
"DT_Output_3" AS 
...
"DT_node_data_4" AS 
(SELECT "Values".nid AS nid, CAST("Values"."P_0" AS DOUBLE) AS "P_0", CAST("Values"."P_1" AS DOUBLE) AS "P_1", CAST("Values"."D" AS DOUBLE) AS "D", CAST("Values"."DP" AS DOUBLE) AS "DP" 
FROM (SELECT 1 AS nid, 0.08003790404936618 AS "P_0", 0.9199620959506338 AS "P_1", 1 AS "D", 0.9199620959506338 AS "DP" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 2 AS nid, 0.7225015969128538 AS "P_0", 0.2774984030871463 AS "P_1", 0 AS "D", 0.7225015969128538 AS "DP" FROM SYSIBM.SYSDUMMY1) AS "Values"), 
"DT_Output_4" AS 
...
"DT_node_data_5" AS 
(SELECT "Values".nid AS nid, CAST("Values"."P_0" AS DOUBLE) AS "P_0", CAST("Values"."P_1" AS DOUBLE) AS "P_1", CAST("Values"."D" AS DOUBLE) AS "D", CAST("Values"."DP" AS DOUBLE) AS "DP" 
FROM (SELECT 1 AS nid, 0.23559095476468453 AS "P_0", 0.7644090452353155 AS "P_1", 1 AS "D", 0.7644090452353155 AS "DP" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 2 AS nid, 0.7975392439655866 AS "P_0", 0.20246075603441344 AS "P_1", 0 AS "D", 0.7975392439655866 AS "DP" FROM SYSIBM.SYSDUMMY1) AS "Values"), 
"DT_Output_5" AS 
...
"DT_node_data_6" AS 
(SELECT "Values".nid AS nid, CAST("Values"."P_0" AS DOUBLE) AS "P_0", CAST("Values"."P_1" AS DOUBLE) AS "P_1", CAST("Values"."D" AS DOUBLE) AS "D", CAST("Values"."DP" AS DOUBLE) AS "DP" 
FROM (SELECT 1 AS nid, 0.7146779526640179 AS "P_0", 0.2853220473359822 AS "P_1", 0 AS "D", 0.7146779526640179 AS "DP" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 2 AS nid, 0.09146984048309499 AS "P_0", 0.908530159516905 AS "P_1", 1 AS "D", 0.908530159516905 AS "DP" FROM SYSIBM.SYSDUMMY1) AS "Values"), 
"DT_Output_6" AS 
...
"DT_node_data_7" AS 
(SELECT "Values".nid AS nid, CAST("Values"."P_0" AS DOUBLE) AS "P_0", CAST("Values"."P_1" AS DOUBLE) AS "P_1", CAST("Values"."D" AS DOUBLE) AS "D", CAST("Values"."DP" AS DOUBLE) AS "DP" 
FROM (SELECT 1 AS nid, 0.8761591417176888 AS "P_0", 0.12384085828231128 AS "P_1", 0 AS "D", 0.8761591417176888 AS "DP" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 2 AS nid, 0.2636984904122652 AS "P_0", 0.7363015095877348 AS "P_1", 1 AS "D", 0.7363015095877348 AS "DP" FROM SYSIBM.SYSDUMMY1) AS "Values"), 
"DT_Output_7" AS 
...
"DT_node_data_8" AS 
(SELECT "Values".nid AS nid, CAST("Values"."P_0" AS DOUBLE) AS "P_0", CAST("Values"."P_1" AS DOUBLE) AS "P_1", CAST("Values"."D" AS DOUBLE) AS "D", CAST("Values"."DP" AS DOUBLE) AS "DP" 
FROM (SELECT 1 AS nid, 0.10209880478775882 AS "P_0", 0.8979011952122412 AS "P_1", 1 AS "D", 0.8979011952122412 AS "DP" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 2 AS nid, 0.7100131728976986 AS "P_0", 0.2899868271023014 AS "P_1", 0 AS "D", 0.7100131728976986 AS "DP" FROM SYSIBM.SYSDUMMY1) AS "Values"), 
"DT_Output_8" AS 
...
"DT_node_data_9" AS 
(SELECT "Values".nid AS nid, CAST("Values"."P_0" AS DOUBLE) AS "P_0", CAST("Values"."P_1" AS DOUBLE) AS "P_1", CAST("Values"."D" AS DOUBLE) AS "D", CAST("Values"."DP" AS DOUBLE) AS "DP" 
FROM (SELECT 1 AS nid, 0.21039538866326307 AS "P_0", 0.7896046113367369 AS "P_1", 1 AS "D", 0.7896046113367369 AS "DP" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 2 AS nid, 0.8153077678684952 AS "P_0", 0.18469223213150485 AS "P_1", 0 AS "D", 0.8153077678684952 AS "DP" FROM SYSIBM.SYSDUMMY1) AS "Values"), 
"DT_Output_9" AS 
...
-- Code For temporary table tmp_20180508180127_codegen_or91e4_adb_b1 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180508180127_codegen_or91e4_adb_b1 (
	"KEY" BIGINT, 
	"Score_0" DOUBLE, 
	"Proba_0" DOUBLE, 
	"Score_1" DOUBLE, 
...
-- Code For temporary table tmp_20180508180127_codegen_or91e4_adb_b1 part 2. Populate

INSERT INTO tmp_20180508180127_codegen_or91e4_adb_b1 WITH "DT_node_lookup_10" AS 
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", CASE WHEN ("ADS_sca_2_OUT".scaler_65 <= -0.3447141647338867) THEN 1 ELSE 2 END AS node_id_2 
FROM tmp_20180508180126_codegen_6sk8ec_ads_sca_2_out AS "ADS_sca_2_OUT"), 
"DT_node_data_10" AS 
(SELECT "Values".nid AS nid, CAST("Values"."P_0" AS DOUBLE) AS "P_0", CAST("Values"."P_1" AS DOUBLE) AS "P_1", CAST("Values"."D" AS DOUBLE) AS "D", CAST("Values"."DP" AS DOUBLE) AS "DP" 
FROM (SELECT 1 AS nid, 0.8657233264038979 AS "P_0", 0.13427667359610215 AS "P_1", 0 AS "D", 0.8657233264038979 AS "DP" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 2 AS nid, 0.26816108937076916 AS "P_0", 0.7318389106292308 AS "P_1", 1 AS "D", 0.7318389106292308 AS "DP" FROM SYSIBM.SYSDUMMY1) AS "Values"), 
"DT_Output_10" AS 
...
"DT_node_data_11" AS 
(SELECT "Values".nid AS nid, CAST("Values"."P_0" AS DOUBLE) AS "P_0", CAST("Values"."P_1" AS DOUBLE) AS "P_1", CAST("Values"."D" AS DOUBLE) AS "D", CAST("Values"."DP" AS DOUBLE) AS "DP" 
FROM (SELECT 1 AS nid, 0.27375122893621673 AS "P_0", 0.7262487710637833 AS "P_1", 1 AS "D", 0.7262487710637833 AS "DP" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 2 AS nid, 0.914965960430189 AS "P_0", 0.08503403956981113 AS "P_1", 0 AS "D", 0.914965960430189 AS "DP" FROM SYSIBM.SYSDUMMY1) AS "Values"), 
"DT_Output_11" AS 
...
"DT_node_data_12" AS 
(SELECT "Values".nid AS nid, CAST("Values"."P_0" AS DOUBLE) AS "P_0", CAST("Values"."P_1" AS DOUBLE) AS "P_1", CAST("Values"."D" AS DOUBLE) AS "D", CAST("Values"."DP" AS DOUBLE) AS "DP" 
FROM (SELECT 1 AS nid, 0.039692646449534005 AS "P_0", 0.960307353550466 AS "P_1", 1 AS "D", 0.960307353550466 AS "DP" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 2 AS nid, 0.6910502874384932 AS "P_0", 0.3089497125615069 AS "P_1", 0 AS "D", 0.6910502874384932 AS "DP" FROM SYSIBM.SYSDUMMY1) AS "Values"), 
"DT_Output_12" AS 
...
"DT_node_data_13" AS 
(SELECT "Values".nid AS nid, CAST("Values"."P_0" AS DOUBLE) AS "P_0", CAST("Values"."P_1" AS DOUBLE) AS "P_1", CAST("Values"."D" AS DOUBLE) AS "D", CAST("Values"."DP" AS DOUBLE) AS "DP" 
FROM (SELECT 1 AS nid, 0.12139284127328985 AS "P_0", 0.8786071587267102 AS "P_1", 1 AS "D", 0.8786071587267102 AS "DP" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 2 AS nid, 0.7372866829662806 AS "P_0", 0.2627133170337193 AS "P_1", 0 AS "D", 0.7372866829662806 AS "DP" FROM SYSIBM.SYSDUMMY1) AS "Values"), 
"DT_Output_13" AS 
...
"DT_node_data_14" AS 
(SELECT "Values".nid AS nid, CAST("Values"."P_0" AS DOUBLE) AS "P_0", CAST("Values"."P_1" AS DOUBLE) AS "P_1", CAST("Values"."D" AS DOUBLE) AS "D", CAST("Values"."DP" AS DOUBLE) AS "DP" 
FROM (SELECT 1 AS nid, 0.7601093537278648 AS "P_0", 0.23989064627213516 AS "P_1", 0 AS "D", 0.7601093537278648 AS "DP" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 2 AS nid, 0.026809015574647672 AS "P_0", 0.9731909844253523 AS "P_1", 1 AS "D", 0.9731909844253523 AS "DP" FROM SYSIBM.SYSDUMMY1) AS "Values"), 
"DT_Output_14" AS 
...
"DT_node_data_15" AS 
(SELECT "Values".nid AS nid, CAST("Values"."P_0" AS DOUBLE) AS "P_0", CAST("Values"."P_1" AS DOUBLE) AS "P_1", CAST("Values"."D" AS DOUBLE) AS "D", CAST("Values"."DP" AS DOUBLE) AS "DP" 
FROM (SELECT 1 AS nid, 1.9866316725807002e-06 AS "P_0", 0.9999980133683274 AS "P_1", 1 AS "D", 0.9999980133683274 AS "DP" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 2 AS nid, 0.6897064028174626 AS "P_0", 0.31029359718253724 AS "P_1", 0 AS "D", 0.6897064028174626 AS "DP" FROM SYSIBM.SYSDUMMY1) AS "Values"), 
"DT_Output_15" AS 
...
-- Code For temporary table tmp_20180508180127_codegen_dzs8f8_adb_union part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180508180127_codegen_dzs8f8_adb_union (
	"KEY" BIGINT, 
	"Score_0" DOUBLE, 
	"Proba_0" DOUBLE, 
	"Score_1" DOUBLE, 
...
-- Code For temporary table tmp_20180508180127_codegen_dzs8f8_adb_union part 2. Populate

INSERT INTO tmp_20180508180127_codegen_dzs8f8_adb_union SELECT "ADB_Union"."KEY", "ADB_Union"."Score_0", "ADB_Union"."Proba_0", "ADB_Union"."Score_1", "ADB_Union"."Proba_1" 
...
FROM tmp_20180508180127_codegen_rb55gy_adb_b0 AS "ADB_B0" UNION ALL SELECT "ADB_B1"."KEY" AS "KEY", "ADB_B1"."Score_0" AS "Score_0", "ADB_B1"."Proba_0" AS "Proba_0", "ADB_B1"."Score_1" AS "Score_1", "ADB_B1"."Proba_1" AS "Proba_1" 
FROM tmp_20180508180127_codegen_or91e4_adb_b1 AS "ADB_B1") AS "ADB_EnsembleUnion") AS "ADB_Union"

-- Code For temporary table tmp_20180508180127_codegen_mo1ej3_adb_sum part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180508180127_codegen_mo1ej3_adb_sum (
	"KEY" BIGINT, 
	"Score_0" DOUBLE, 
	"Proba_0" DOUBLE, 
	"Score_1" DOUBLE, 
...
-- Code For temporary table tmp_20180508180127_codegen_mo1ej3_adb_sum part 2. Populate

INSERT INTO tmp_20180508180127_codegen_mo1ej3_adb_sum SELECT "ADB_sum"."KEY", "ADB_sum"."Score_0", "ADB_sum"."Proba_0", "ADB_sum"."Score_1", "ADB_sum"."Proba_1" 
...
FROM tmp_20180508180127_codegen_dzs8f8_adb_union AS "ADB_Union" GROUP BY "ADB_Union"."KEY") AS "T") AS "ADB_sum"
...
FROM tmp_20180508180127_codegen_mo1ej3_adb_sum AS "ADB_sum"), 
