...
-- Code For temporary table tmp_20180508180123_codegen_w3hf50_ads_imp_1_out part 1. Create 


CREATE TEMPORARY TABLE tmp_20180508180123_codegen_w3hf50_ads_imp_1_out (
	"KEY" BIGINT, 
	impter_2 DOUBLE, 
	impter_3 DOUBLE, 
	impter_4 DOUBLE, 
...
-- Code For temporary table tmp_20180508180123_codegen_yxwl31_ads_sca_2_out part 1. Create 


CREATE TEMPORARY TABLE tmp_20180508180123_codegen_yxwl31_ads_sca_2_out (
	"KEY" BIGINT, 
	scaler_2 DOUBLE, 
	scaler_3 DOUBLE, 
	scaler_4 DOUBLE, 
...
FROM tmp_20180508180123_codegen_w3hf50_ads_imp_1_out AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT") AS "U"

-- Code For temporary table tmp_20180508180123_codegen_dfe5zp_adb_b0 part 1. Create 


CREATE TEMPORARY TABLE tmp_20180508180123_codegen_dfe5zp_adb_b0 (
	"KEY" BIGINT, 
	"Score_0" DOUBLE, 
	"Proba_0" DOUBLE, 
	"Score_1" DOUBLE, 
...
-- Code For temporary table tmp_20180508180123_codegen_dfe5zp_adb_b0 part 2. Populate

INSERT INTO tmp_20180508180123_codegen_dfe5zp_adb_b0 ("KEY", "Score_0", "Proba_0", "Score_1", "Proba_1") SELECT "U"."KEY", "U"."Score_0", "U"."Proba_0", "U"."Score_1", "U"."Proba_1" 
...
FROM tmp_20180508180123_codegen_yxwl31_ads_sca_2_out AS "ADS_sca_2_OUT"), 
"DT_node_data" AS 
...
"ADB_Model_0" AS 
(SELECT "DT_Output"."KEY" AS "KEY", (1.0 * (CASE WHEN ("DT_Output"."P_0" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE log(CASE WHEN ("DT_Output"."P_0" IS NULL OR "DT_Output"."P_0" > 1e-100) THEN "DT_Output"."P_0" ELSE 1e-100 END) END - (CASE WHEN ("DT_Output"."P_0" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE log(CASE WHEN ("DT_Output"."P_0" IS NULL OR "DT_Output"."P_0" > 1e-100) THEN "DT_Output"."P_0" ELSE 1e-100 END) END + CASE WHEN ("DT_Output"."P_1" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE log(CASE WHEN ("DT_Output"."P_1" IS NULL OR "DT_Output"."P_1" > 1e-100) THEN "DT_Output"."P_1" ELSE 1e-100 END) END) / 2)) / 16.0 AS "Score_0", 1.0 * (CASE WHEN ("DT_Output"."P_0" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE log(CASE WHEN ("DT_Output"."P_0" IS NULL OR "DT_Output"."P_0" > 1e-100) THEN "DT_Output"."P_0" ELSE 1e-100 END) END - (CASE WHEN ("DT_Output"."P_0" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE log(CASE WHEN ("DT_Output"."P_0" IS NULL OR "DT_Output"."P_0" > 1e-100) THEN "DT_Output"."P_0" ELSE 1e-100 END) END + CASE WHEN ("DT_Output"."P_1" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE log(CASE WHEN ("DT_Output"."P_1" IS NULL OR "DT_Output"."P_1" > 1e-100) THEN "DT_Output"."P_1" ELSE 1e-100 END) END) / 2) AS "Proba_0", (1.0 * (CASE WHEN ("DT_Output"."P_1" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE log(CASE WHEN ("DT_Output"."P_1" IS NULL OR "DT_Output"."P_1" > 1e-100) THEN "DT_Output"."P_1" ELSE 1e-100 END) END - (CASE WHEN ("DT_Output"."P_0" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE log(CASE WHEN ("DT_Output"."P_0" IS NULL OR "DT_Output"."P_0" > 1e-100) THEN "DT_Output"."P_0" ELSE 1e-100 END) END + CASE WHEN ("DT_Output"."P_1" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE log(CASE WHEN ("DT_Output"."P_1" IS NULL OR "DT_Output"."P_1" > 1e-100) THEN "DT_Output"."P_1" ELSE 1e-100 END) END) / 2)) / 16.0 AS "Score_1", 1.0 * (CASE WHEN ("DT_Output"."P_1" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE log(CASE WHEN ("DT_Output"."P_1" IS NULL OR "DT_Output"."P_1" > 1e-100) THEN "DT_Output"."P_1" ELSE 1e-100 END) END - (CASE WHEN ("DT_Output"."P_0" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE log(CASE WHEN ("DT_Output"."P_0" IS NULL OR "DT_Output"."P_0" > 1e-100) THEN "DT_Output"."P_0" ELSE 1e-100 END) END + CASE WHEN ("DT_Output"."P_1" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE log(CASE WHEN ("DT_Output"."P_1" IS NULL OR "DT_Output"."P_1" > 1e-100) THEN "DT_Output"."P_1" ELSE 1e-100 END) END) / 2) AS "Proba_1" 
FROM "DT_Output"), 
"DT_node_lookup_1" AS 
...
"ADB_Model_1" AS 
(SELECT "DT_Output_1"."KEY" AS "KEY", (1.0 * (CASE WHEN ("DT_Output_1"."P_0" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE log(CASE WHEN ("DT_Output_1"."P_0" IS NULL OR "DT_Output_1"."P_0" > 1e-100) THEN "DT_Output_1"."P_0" ELSE 1e-100 END) END - (CASE WHEN ("DT_Output_1"."P_0" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE log(CASE WHEN ("DT_Output_1"."P_0" IS NULL OR "DT_Output_1"."P_0" > 1e-100) THEN "DT_Output_1"."P_0" ELSE 1e-100 END) END + CASE WHEN ("DT_Output_1"."P_1" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE log(CASE WHEN ("DT_Output_1"."P_1" IS NULL OR "DT_Output_1"."P_1" > 1e-100) THEN "DT_Output_1"."P_1" ELSE 1e-100 END) END) / 2)) / 16.0 AS "Score_0", 1.0 * (CASE WHEN ("DT_Output_1"."P_0" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE log(CASE WHEN ("DT_Output_1"."P_0" IS NULL OR "DT_Output_1"."P_0" > 1e-100) THEN "DT_Output_1"."P_0" ELSE 1e-100 END) END - (CASE WHEN ("DT_Output_1"."P_0" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE log(CASE WHEN ("DT_Output_1"."P_0" IS NULL OR "DT_Output_1"."P_0" > 1e-100) THEN "DT_Output_1"."P_0" ELSE 1e-100 END) END + CASE WHEN ("DT_Output_1"."P_1" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE log(CASE WHEN ("DT_Output_1"."P_1" IS NULL OR "DT_Output_1"."P_1" > 1e-100) THEN "DT_Output_1"."P_1" ELSE 1e-100 END) END) / 2) AS "Proba_0", (1.0 * (CASE WHEN ("DT_Output_1"."P_1" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE log(CASE WHEN ("DT_Output_1"."P_1" IS NULL OR "DT_Output_1"."P_1" > 1e-100) THEN "DT_Output_1"."P_1" ELSE 1e-100 END) END - (CASE WHEN ("DT_Output_1"."P_0" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE log(CASE WHEN ("DT_Output_1"."P_0" IS NULL OR "DT_Output_1"."P_0" > 1e-100) THEN "DT_Output_1"."P_0" ELSE 1e-100 END) END + CASE WHEN ("DT_Output_1"."P_1" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE log(CASE WHEN ("DT_Output_1"."P_1" IS NULL OR "DT_Output_1"."P_1" > 1e-100) THEN "DT_Output_1"."P_1" ELSE 1e-100 END) END) / 2)) / 16.0 AS "Score_1", 1.0 * (CASE WHEN ("DT_Output_1"."P_1" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE log(CASE WHEN ("DT_Output_1"."P_1" IS NULL OR "DT_Output_1"."P_1" > 1e-100) THEN "DT_Output_1"."P_1" ELSE 1e-100 END) END - (CASE WHEN ("DT_Output_1"."P_0" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE log(CASE WHEN ("DT_Output_1"."P_0" IS NULL OR "DT_Output_1"."P_0" > 1e-100) THEN "DT_Output_1"."P_0" ELSE 1e-100 END) END + CASE WHEN ("DT_Output_1"."P_1" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE log(CASE WHEN ("DT_Output_1"."P_1" IS NULL OR "DT_Output_1"."P_1" > 1e-100) THEN "DT_Output_1"."P_1" ELSE 1e-100 END) END) / 2) AS "Proba_1" 
FROM "DT_Output_1"), 
"DT_node_lookup_2" AS 
...
"ADB_Model_2" AS 
(SELECT "DT_Output_2"."KEY" AS "KEY", (1.0 * (CASE WHEN ("DT_Output_2"."P_0" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE log(CASE WHEN ("DT_Output_2"."P_0" IS NULL OR "DT_Output_2"."P_0" > 1e-100) THEN "DT_Output_2"."P_0" ELSE 1e-100 END) END - (CASE WHEN ("DT_Output_2"."P_0" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE log(CASE WHEN ("DT_Output_2"."P_0" IS NULL OR "DT_Output_2"."P_0" > 1e-100) THEN "DT_Output_2"."P_0" ELSE 1e-100 END) END + CASE WHEN ("DT_Output_2"."P_1" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE log(CASE WHEN ("DT_Output_2"."P_1" IS NULL OR "DT_Output_2"."P_1" > 1e-100) THEN "DT_Output_2"."P_1" ELSE 1e-100 END) END) / 2)) / 16.0 AS "Score_0", 1.0 * (CASE WHEN ("DT_Output_2"."P_0" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE log(CASE WHEN ("DT_Output_2"."P_0" IS NULL OR "DT_Output_2"."P_0" > 1e-100) THEN "DT_Output_2"."P_0" ELSE 1e-100 END) END - (CASE WHEN ("DT_Output_2"."P_0" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE log(CASE WHEN ("DT_Output_2"."P_0" IS NULL OR "DT_Output_2"."P_0" > 1e-100) THEN "DT_Output_2"."P_0" ELSE 1e-100 END) END + CASE WHEN ("DT_Output_2"."P_1" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE log(CASE WHEN ("DT_Output_2"."P_1" IS NULL OR "DT_Output_2"."P_1" > 1e-100) THEN "DT_Output_2"."P_1" ELSE 1e-100 END) END) / 2) AS "Proba_0", (1.0 * (CASE WHEN ("DT_Output_2"."P_1" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE log(CASE WHEN ("DT_Output_2"."P_1" IS NULL OR "DT_Output_2"."P_1" > 1e-100) THEN "DT_Output_2"."P_1" ELSE 1e-100 END) END - (CASE WHEN ("DT_Output_2"."P_0" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE log(CASE WHEN ("DT_Output_2"."P_0" IS NULL OR "DT_Output_2"."P_0" > 1e-100) THEN "DT_Output_2"."P_0" ELSE 1e-100 END) END + CASE WHEN ("DT_Output_2"."P_1" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE log(CASE WHEN ("DT_Output_2"."P_1" IS NULL OR "DT_Output_2"."P_1" > 1e-100) THEN "DT_Output_2"."P_1" ELSE 1e-100 END) END) / 2)) / 16.0 AS "Score_1", 1.0 * (CASE WHEN ("DT_Output_2"."P_1" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE log(CASE WHEN ("DT_Output_2"."P_1" IS NULL OR "DT_Output_2"."P_1" > 1e-100) THEN "DT_Output_2"."P_1" ELSE 1e-100 END) END - (CASE WHEN ("DT_Output_2"."P_0" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE log(CASE WHEN ("DT_Output_2"."P_0" IS NULL OR "DT_Output_2"."P_0" > 1e-100) THEN "DT_Output_2"."P_0" ELSE 1e-100 END) END + CASE WHEN ("DT_Output_2"."P_1" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE log(CASE WHEN ("DT_Output_2"."P_1" IS NULL OR "DT_Output_2"."P_1" > 1e-100) THEN "DT_Output_2"."P_1" ELSE 1e-100 END) END) / 2) AS "Proba_1" 
FROM "DT_Output_2"), 
"DT_node_lookup_3" AS 
...
"ADB_Model_3" AS 
(SELECT "DT_Output_3"."KEY" AS "KEY", (1.0 * (CASE WHEN ("DT_Output_3"."P_0" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE log(CASE WHEN ("DT_Output_3"."P_0" IS NULL OR "DT_Output_3"."P_0" > 1e-100) THEN "DT_Output_3"."P_0" ELSE 1e-100 END) END - (CASE WHEN ("DT_Output_3"."P_0" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE log(CASE WHEN ("DT_Output_3"."P_0" IS NULL OR "DT_Output_3"."P_0" > 1e-100) THEN "DT_Output_3"."P_0" ELSE 1e-100 END) END + CASE WHEN ("DT_Output_3"."P_1" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE log(CASE WHEN ("DT_Output_3"."P_1" IS NULL OR "DT_Output_3"."P_1" > 1e-100) THEN "DT_Output_3"."P_1" ELSE 1e-100 END) END) / 2)) / 16.0 AS "Score_0", 1.0 * (CASE WHEN ("DT_Output_3"."P_0" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE log(CASE WHEN ("DT_Output_3"."P_0" IS NULL OR "DT_Output_3"."P_0" > 1e-100) THEN "DT_Output_3"."P_0" ELSE 1e-100 END) END - (CASE WHEN ("DT_Output_3"."P_0" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE log(CASE WHEN ("DT_Output_3"."P_0" IS NULL OR "DT_Output_3"."P_0" > 1e-100) THEN "DT_Output_3"."P_0" ELSE 1e-100 END) END + CASE WHEN ("DT_Output_3"."P_1" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE log(CASE WHEN ("DT_Output_3"."P_1" IS NULL OR "DT_Output_3"."P_1" > 1e-100) THEN "DT_Output_3"."P_1" ELSE 1e-100 END) END) / 2) AS "Proba_0", (1.0 * (CASE WHEN ("DT_Output_3"."P_1" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE log(CASE WHEN ("DT_Output_3"."P_1" IS NULL OR "DT_Output_3"."P_1" > 1e-100) THEN "DT_Output_3"."P_1" ELSE 1e-100 END) END - (CASE WHEN ("DT_Output_3"."P_0" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE log(CASE WHEN ("DT_Output_3"."P_0" IS NULL OR "DT_Output_3"."P_0" > 1e-100) THEN "DT_Output_3"."P_0" ELSE 1e-100 END) END + CASE WHEN ("DT_Output_3"."P_1" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE log(CASE WHEN ("DT_Output_3"."P_1" IS NULL OR "DT_Output_3"."P_1" > 1e-100) THEN "DT_Output_3"."P_1" ELSE 1e-100 END) END) / 2)) / 16.0 AS "Score_1", 1.0 * (CASE WHEN ("DT_Output_3"."P_1" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE log(CASE WHEN ("DT_Output_3"."P_1" IS NULL OR "DT_Output_3"."P_1" > 1e-100) THEN "DT_Output_3"."P_1" ELSE 1e-100 END) END - (CASE WHEN ("DT_Output_3"."P_0" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE log(CASE WHEN ("DT_Output_3"."P_0" IS NULL OR "DT_Output_3"."P_0" > 1e-100) THEN "DT_Output_3"."P_0" ELSE 1e-100 END) END + CASE WHEN ("DT_Output_3"."P_1" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE log(CASE WHEN ("DT_Output_3"."P_1" IS NULL OR "DT_Output_3"."P_1" > 1e-100) THEN "DT_Output_3"."P_1" ELSE 1e-100 END) END) / 2) AS "Proba_1" 
FROM "DT_Output_3"), 
"DT_node_lookup_4" AS 
...
"ADB_Model_4" AS 
(SELECT "DT_Output_4"."KEY" AS "KEY", (1.0 * (CASE WHEN ("DT_Output_4"."P_0" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE log(CASE WHEN ("DT_Output_4"."P_0" IS NULL OR "DT_Output_4"."P_0" > 1e-100) THEN "DT_Output_4"."P_0" ELSE 1e-100 END) END - (CASE WHEN ("DT_Output_4"."P_0" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE log(CASE WHEN ("DT_Output_4"."P_0" IS NULL OR "DT_Output_4"."P_0" > 1e-100) THEN "DT_Output_4"."P_0" ELSE 1e-100 END) END + CASE WHEN ("DT_Output_4"."P_1" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE log(CASE WHEN ("DT_Output_4"."P_1" IS NULL OR "DT_Output_4"."P_1" > 1e-100) THEN "DT_Output_4"."P_1" ELSE 1e-100 END) END) / 2)) / 16.0 AS "Score_0", 1.0 * (CASE WHEN ("DT_Output_4"."P_0" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE log(CASE WHEN ("DT_Output_4"."P_0" IS NULL OR "DT_Output_4"."P_0" > 1e-100) THEN "DT_Output_4"."P_0" ELSE 1e-100 END) END - (CASE WHEN ("DT_Output_4"."P_0" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE log(CASE WHEN ("DT_Output_4"."P_0" IS NULL OR "DT_Output_4"."P_0" > 1e-100) THEN "DT_Output_4"."P_0" ELSE 1e-100 END) END + CASE WHEN ("DT_Output_4"."P_1" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE log(CASE WHEN ("DT_Output_4"."P_1" IS NULL OR "DT_Output_4"."P_1" > 1e-100) THEN "DT_Output_4"."P_1" ELSE 1e-100 END) END) / 2) AS "Proba_0", (1.0 * (CASE WHEN ("DT_Output_4"."P_1" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE log(CASE WHEN ("DT_Output_4"."P_1" IS NULL OR "DT_Output_4"."P_1" > 1e-100) THEN "DT_Output_4"."P_1" ELSE 1e-100 END) END - (CASE WHEN ("DT_Output_4"."P_0" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE log(CASE WHEN ("DT_Output_4"."P_0" IS NULL OR "DT_Output_4"."P_0" > 1e-100) THEN "DT_Output_4"."P_0" ELSE 1e-100 END) END + CASE WHEN ("DT_Output_4"."P_1" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE log(CASE WHEN ("DT_Output_4"."P_1" IS NULL OR "DT_Output_4"."P_1" > 1e-100) THEN "DT_Output_4"."P_1" ELSE 1e-100 END) END) / 2)) / 16.0 AS "Score_1", 1.0 * (CASE WHEN ("DT_Output_4"."P_1" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE log(CASE WHEN ("DT_Output_4"."P_1" IS NULL OR "DT_Output_4"."P_1" > 1e-100) THEN "DT_Output_4"."P_1" ELSE 1e-100 END) END - (CASE WHEN ("DT_Output_4"."P_0" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE log(CASE WHEN ("DT_Output_4"."P_0" IS NULL OR "DT_Output_4"."P_0" > 1e-100) THEN "DT_Output_4"."P_0" ELSE 1e-100 END) END + CASE WHEN ("DT_Output_4"."P_1" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE log(CASE WHEN ("DT_Output_4"."P_1" IS NULL OR "DT_Output_4"."P_1" > 1e-100) THEN "DT_Output_4"."P_1" ELSE 1e-100 END) END) / 2) AS "Proba_1" 
FROM "DT_Output_4"), 
"DT_node_lookup_5" AS 
...
"ADB_Model_5" AS 
(SELECT "DT_Output_5"."KEY" AS "KEY", (1.0 * (CASE WHEN ("DT_Output_5"."P_0" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE log(CASE WHEN ("DT_Output_5"."P_0" IS NULL OR "DT_Output_5"."P_0" > 1e-100) THEN "DT_Output_5"."P_0" ELSE 1e-100 END) END - (CASE WHEN ("DT_Output_5"."P_0" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE log(CASE WHEN ("DT_Output_5"."P_0" IS NULL OR "DT_Output_5"."P_0" > 1e-100) THEN "DT_Output_5"."P_0" ELSE 1e-100 END) END + CASE WHEN ("DT_Output_5"."P_1" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE log(CASE WHEN ("DT_Output_5"."P_1" IS NULL OR "DT_Output_5"."P_1" > 1e-100) THEN "DT_Output_5"."P_1" ELSE 1e-100 END) END) / 2)) / 16.0 AS "Score_0", 1.0 * (CASE WHEN ("DT_Output_5"."P_0" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE log(CASE WHEN ("DT_Output_5"."P_0" IS NULL OR "DT_Output_5"."P_0" > 1e-100) THEN "DT_Output_5"."P_0" ELSE 1e-100 END) END - (CASE WHEN ("DT_Output_5"."P_0" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE log(CASE WHEN ("DT_Output_5"."P_0" IS NULL OR "DT_Output_5"."P_0" > 1e-100) THEN "DT_Output_5"."P_0" ELSE 1e-100 END) END + CASE WHEN ("DT_Output_5"."P_1" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE log(CASE WHEN ("DT_Output_5"."P_1" IS NULL OR "DT_Output_5"."P_1" > 1e-100) THEN "DT_Output_5"."P_1" ELSE 1e-100 END) END) / 2) AS "Proba_0", (1.0 * (CASE WHEN ("DT_Output_5"."P_1" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE log(CASE WHEN ("DT_Output_5"."P_1" IS NULL OR "DT_Output_5"."P_1" > 1e-100) THEN "DT_Output_5"."P_1" ELSE 1e-100 END) END - (CASE WHEN ("DT_Output_5"."P_0" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE log(CASE WHEN ("DT_Output_5"."P_0" IS NULL OR "DT_Output_5"."P_0" > 1e-100) THEN "DT_Output_5"."P_0" ELSE 1e-100 END) END + CASE WHEN ("DT_Output_5"."P_1" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE log(CASE WHEN ("DT_Output_5"."P_1" IS NULL OR "DT_Output_5"."P_1" > 1e-100) THEN "DT_Output_5"."P_1" ELSE 1e-100 END) END) / 2)) / 16.0 AS "Score_1", 1.0 * (CASE WHEN ("DT_Output_5"."P_1" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE log(CASE WHEN ("DT_Output_5"."P_1" IS NULL OR "DT_Output_5"."P_1" > 1e-100) THEN "DT_Output_5"."P_1" ELSE 1e-100 END) END - (CASE WHEN ("DT_Output_5"."P_0" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE log(CASE WHEN ("DT_Output_5"."P_0" IS NULL OR "DT_Output_5"."P_0" > 1e-100) THEN "DT_Output_5"."P_0" ELSE 1e-100 END) END + CASE WHEN ("DT_Output_5"."P_1" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE log(CASE WHEN ("DT_Output_5"."P_1" IS NULL OR "DT_Output_5"."P_1" > 1e-100) THEN "DT_Output_5"."P_1" ELSE 1e-100 END) END) / 2) AS "Proba_1" 
FROM "DT_Output_5"), 
"DT_node_lookup_6" AS 
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", CASE WHEN ("ADS_sca_2_OUT".scaler_59 <= 0.06653057038784027) THEN 1 ELSE 2 END AS node_id_2 
FROM tmp_20180508180123_codegen_yxwl31_ads_sca_2_out AS "ADS_sca_2_OUT"), 
...
"ADB_Model_6" AS 
(SELECT "DT_Output_6"."KEY" AS "KEY", (1.0 * (CASE WHEN ("DT_Output_6"."P_0" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE log(CASE WHEN ("DT_Output_6"."P_0" IS NULL OR "DT_Output_6"."P_0" > 1e-100) THEN "DT_Output_6"."P_0" ELSE 1e-100 END) END - (CASE WHEN ("DT_Output_6"."P_0" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE log(CASE WHEN ("DT_Output_6"."P_0" IS NULL OR "DT_Output_6"."P_0" > 1e-100) THEN "DT_Output_6"."P_0" ELSE 1e-100 END) END + CASE WHEN ("DT_Output_6"."P_1" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE log(CASE WHEN ("DT_Output_6"."P_1" IS NULL OR "DT_Output_6"."P_1" > 1e-100) THEN "DT_Output_6"."P_1" ELSE 1e-100 END) END) / 2)) / 16.0 AS "Score_0", 1.0 * (CASE WHEN ("DT_Output_6"."P_0" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE log(CASE WHEN ("DT_Output_6"."P_0" IS NULL OR "DT_Output_6"."P_0" > 1e-100) THEN "DT_Output_6"."P_0" ELSE 1e-100 END) END - (CASE WHEN ("DT_Output_6"."P_0" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE log(CASE WHEN ("DT_Output_6"."P_0" IS NULL OR "DT_Output_6"."P_0" > 1e-100) THEN "DT_Output_6"."P_0" ELSE 1e-100 END) END + CASE WHEN ("DT_Output_6"."P_1" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE log(CASE WHEN ("DT_Output_6"."P_1" IS NULL OR "DT_Output_6"."P_1" > 1e-100) THEN "DT_Output_6"."P_1" ELSE 1e-100 END) END) / 2) AS "Proba_0", (1.0 * (CASE WHEN ("DT_Output_6"."P_1" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE log(CASE WHEN ("DT_Output_6"."P_1" IS NULL OR "DT_Output_6"."P_1" > 1e-100) THEN "DT_Output_6"."P_1" ELSE 1e-100 END) END - (CASE WHEN ("DT_Output_6"."P_0" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE log(CASE WHEN ("DT_Output_6"."P_0" IS NULL OR "DT_Output_6"."P_0" > 1e-100) THEN "DT_Output_6"."P_0" ELSE 1e-100 END) END + CASE WHEN ("DT_Output_6"."P_1" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE log(CASE WHEN ("DT_Output_6"."P_1" IS NULL OR "DT_Output_6"."P_1" > 1e-100) THEN "DT_Output_6"."P_1" ELSE 1e-100 END) END) / 2)) / 16.0 AS "Score_1", 1.0 * (CASE WHEN ("DT_Output_6"."P_1" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE log(CASE WHEN ("DT_Output_6"."P_1" IS NULL OR "DT_Output_6"."P_1" > 1e-100) THEN "DT_Output_6"."P_1" ELSE 1e-100 END) END - (CASE WHEN ("DT_Output_6"."P_0" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE log(CASE WHEN ("DT_Output_6"."P_0" IS NULL OR "DT_Output_6"."P_0" > 1e-100) THEN "DT_Output_6"."P_0" ELSE 1e-100 END) END + CASE WHEN ("DT_Output_6"."P_1" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE log(CASE WHEN ("DT_Output_6"."P_1" IS NULL OR "DT_Output_6"."P_1" > 1e-100) THEN "DT_Output_6"."P_1" ELSE 1e-100 END) END) / 2) AS "Proba_1" 
FROM "DT_Output_6"), 
"DT_node_lookup_7" AS 
...
"ADB_Model_7" AS 
(SELECT "DT_Output_7"."KEY" AS "KEY", (1.0 * (CASE WHEN ("DT_Output_7"."P_0" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE log(CASE WHEN ("DT_Output_7"."P_0" IS NULL OR "DT_Output_7"."P_0" > 1e-100) THEN "DT_Output_7"."P_0" ELSE 1e-100 END) END - (CASE WHEN ("DT_Output_7"."P_0" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE log(CASE WHEN ("DT_Output_7"."P_0" IS NULL OR "DT_Output_7"."P_0" > 1e-100) THEN "DT_Output_7"."P_0" ELSE 1e-100 END) END + CASE WHEN ("DT_Output_7"."P_1" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE log(CASE WHEN ("DT_Output_7"."P_1" IS NULL OR "DT_Output_7"."P_1" > 1e-100) THEN "DT_Output_7"."P_1" ELSE 1e-100 END) END) / 2)) / 16.0 AS "Score_0", 1.0 * (CASE WHEN ("DT_Output_7"."P_0" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE log(CASE WHEN ("DT_Output_7"."P_0" IS NULL OR "DT_Output_7"."P_0" > 1e-100) THEN "DT_Output_7"."P_0" ELSE 1e-100 END) END - (CASE WHEN ("DT_Output_7"."P_0" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE log(CASE WHEN ("DT_Output_7"."P_0" IS NULL OR "DT_Output_7"."P_0" > 1e-100) THEN "DT_Output_7"."P_0" ELSE 1e-100 END) END + CASE WHEN ("DT_Output_7"."P_1" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE log(CASE WHEN ("DT_Output_7"."P_1" IS NULL OR "DT_Output_7"."P_1" > 1e-100) THEN "DT_Output_7"."P_1" ELSE 1e-100 END) END) / 2) AS "Proba_0", (1.0 * (CASE WHEN ("DT_Output_7"."P_1" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE log(CASE WHEN ("DT_Output_7"."P_1" IS NULL OR "DT_Output_7"."P_1" > 1e-100) THEN "DT_Output_7"."P_1" ELSE 1e-100 END) END - (CASE WHEN ("DT_Output_7"."P_0" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE log(CASE WHEN ("DT_Output_7"."P_0" IS NULL OR "DT_Output_7"."P_0" > 1e-100) THEN "DT_Output_7"."P_0" ELSE 1e-100 END) END + CASE WHEN ("DT_Output_7"."P_1" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE log(CASE WHEN ("DT_Output_7"."P_1" IS NULL OR "DT_Output_7"."P_1" > 1e-100) THEN "DT_Output_7"."P_1" ELSE 1e-100 END) END) / 2)) / 16.0 AS "Score_1", 1.0 * (CASE WHEN ("DT_Output_7"."P_1" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE log(CASE WHEN ("DT_Output_7"."P_1" IS NULL OR "DT_Output_7"."P_1" > 1e-100) THEN "DT_Output_7"."P_1" ELSE 1e-100 END) END - (CASE WHEN ("DT_Output_7"."P_0" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE log(CASE WHEN ("DT_Output_7"."P_0" IS NULL OR "DT_Output_7"."P_0" > 1e-100) THEN "DT_Output_7"."P_0" ELSE 1e-100 END) END + CASE WHEN ("DT_Output_7"."P_1" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE log(CASE WHEN ("DT_Output_7"."P_1" IS NULL OR "DT_Output_7"."P_1" > 1e-100) THEN "DT_Output_7"."P_1" ELSE 1e-100 END) END) / 2) AS "Proba_1" 
FROM "DT_Output_7"), 
"DT_node_lookup_8" AS 
...
"ADB_Model_8" AS 
(SELECT "DT_Output_8"."KEY" AS "KEY", (1.0 * (CASE WHEN ("DT_Output_8"."P_0" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE log(CASE WHEN ("DT_Output_8"."P_0" IS NULL OR "DT_Output_8"."P_0" > 1e-100) THEN "DT_Output_8"."P_0" ELSE 1e-100 END) END - (CASE WHEN ("DT_Output_8"."P_0" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE log(CASE WHEN ("DT_Output_8"."P_0" IS NULL OR "DT_Output_8"."P_0" > 1e-100) THEN "DT_Output_8"."P_0" ELSE 1e-100 END) END + CASE WHEN ("DT_Output_8"."P_1" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE log(CASE WHEN ("DT_Output_8"."P_1" IS NULL OR "DT_Output_8"."P_1" > 1e-100) THEN "DT_Output_8"."P_1" ELSE 1e-100 END) END) / 2)) / 16.0 AS "Score_0", 1.0 * (CASE WHEN ("DT_Output_8"."P_0" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE log(CASE WHEN ("DT_Output_8"."P_0" IS NULL OR "DT_Output_8"."P_0" > 1e-100) THEN "DT_Output_8"."P_0" ELSE 1e-100 END) END - (CASE WHEN ("DT_Output_8"."P_0" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE log(CASE WHEN ("DT_Output_8"."P_0" IS NULL OR "DT_Output_8"."P_0" > 1e-100) THEN "DT_Output_8"."P_0" ELSE 1e-100 END) END + CASE WHEN ("DT_Output_8"."P_1" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE log(CASE WHEN ("DT_Output_8"."P_1" IS NULL OR "DT_Output_8"."P_1" > 1e-100) THEN "DT_Output_8"."P_1" ELSE 1e-100 END) END) / 2) AS "Proba_0", (1.0 * (CASE WHEN ("DT_Output_8"."P_1" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE log(CASE WHEN ("DT_Output_8"."P_1" IS NULL OR "DT_Output_8"."P_1" > 1e-100) THEN "DT_Output_8"."P_1" ELSE 1e-100 END) END - (CASE WHEN ("DT_Output_8"."P_0" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE log(CASE WHEN ("DT_Output_8"."P_0" IS NULL OR "DT_Output_8"."P_0" > 1e-100) THEN "DT_Output_8"."P_0" ELSE 1e-100 END) END + CASE WHEN ("DT_Output_8"."P_1" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE log(CASE WHEN ("DT_Output_8"."P_1" IS NULL OR "DT_Output_8"."P_1" > 1e-100) THEN "DT_Output_8"."P_1" ELSE 1e-100 END) END) / 2)) / 16.0 AS "Score_1", 1.0 * (CASE WHEN ("DT_Output_8"."P_1" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE log(CASE WHEN ("DT_Output_8"."P_1" IS NULL OR "DT_Output_8"."P_1" > 1e-100) THEN "DT_Output_8"."P_1" ELSE 1e-100 END) END - (CASE WHEN ("DT_Output_8"."P_0" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE log(CASE WHEN ("DT_Output_8"."P_0" IS NULL OR "DT_Output_8"."P_0" > 1e-100) THEN "DT_Output_8"."P_0" ELSE 1e-100 END) END + CASE WHEN ("DT_Output_8"."P_1" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE log(CASE WHEN ("DT_Output_8"."P_1" IS NULL OR "DT_Output_8"."P_1" > 1e-100) THEN "DT_Output_8"."P_1" ELSE 1e-100 END) END) / 2) AS "Proba_1" 
FROM "DT_Output_8"), 
"DT_node_lookup_9" AS 
...
"ADB_Model_9" AS 
(SELECT "DT_Output_9"."KEY" AS "KEY", (1.0 * (CASE WHEN ("DT_Output_9"."P_0" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE log(CASE WHEN ("DT_Output_9"."P_0" IS NULL OR "DT_Output_9"."P_0" > 1e-100) THEN "DT_Output_9"."P_0" ELSE 1e-100 END) END - (CASE WHEN ("DT_Output_9"."P_0" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE log(CASE WHEN ("DT_Output_9"."P_0" IS NULL OR "DT_Output_9"."P_0" > 1e-100) THEN "DT_Output_9"."P_0" ELSE 1e-100 END) END + CASE WHEN ("DT_Output_9"."P_1" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE log(CASE WHEN ("DT_Output_9"."P_1" IS NULL OR "DT_Output_9"."P_1" > 1e-100) THEN "DT_Output_9"."P_1" ELSE 1e-100 END) END) / 2)) / 16.0 AS "Score_0", 1.0 * (CASE WHEN ("DT_Output_9"."P_0" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE log(CASE WHEN ("DT_Output_9"."P_0" IS NULL OR "DT_Output_9"."P_0" > 1e-100) THEN "DT_Output_9"."P_0" ELSE 1e-100 END) END - (CASE WHEN ("DT_Output_9"."P_0" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE log(CASE WHEN ("DT_Output_9"."P_0" IS NULL OR "DT_Output_9"."P_0" > 1e-100) THEN "DT_Output_9"."P_0" ELSE 1e-100 END) END + CASE WHEN ("DT_Output_9"."P_1" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE log(CASE WHEN ("DT_Output_9"."P_1" IS NULL OR "DT_Output_9"."P_1" > 1e-100) THEN "DT_Output_9"."P_1" ELSE 1e-100 END) END) / 2) AS "Proba_0", (1.0 * (CASE WHEN ("DT_Output_9"."P_1" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE log(CASE WHEN ("DT_Output_9"."P_1" IS NULL OR "DT_Output_9"."P_1" > 1e-100) THEN "DT_Output_9"."P_1" ELSE 1e-100 END) END - (CASE WHEN ("DT_Output_9"."P_0" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE log(CASE WHEN ("DT_Output_9"."P_0" IS NULL OR "DT_Output_9"."P_0" > 1e-100) THEN "DT_Output_9"."P_0" ELSE 1e-100 END) END + CASE WHEN ("DT_Output_9"."P_1" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE log(CASE WHEN ("DT_Output_9"."P_1" IS NULL OR "DT_Output_9"."P_1" > 1e-100) THEN "DT_Output_9"."P_1" ELSE 1e-100 END) END) / 2)) / 16.0 AS "Score_1", 1.0 * (CASE WHEN ("DT_Output_9"."P_1" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE log(CASE WHEN ("DT_Output_9"."P_1" IS NULL OR "DT_Output_9"."P_1" > 1e-100) THEN "DT_Output_9"."P_1" ELSE 1e-100 END) END - (CASE WHEN ("DT_Output_9"."P_0" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE log(CASE WHEN ("DT_Output_9"."P_0" IS NULL OR "DT_Output_9"."P_0" > 1e-100) THEN "DT_Output_9"."P_0" ELSE 1e-100 END) END + CASE WHEN ("DT_Output_9"."P_1" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE log(CASE WHEN ("DT_Output_9"."P_1" IS NULL OR "DT_Output_9"."P_1" > 1e-100) THEN "DT_Output_9"."P_1" ELSE 1e-100 END) END) / 2) AS "Proba_1" 
FROM "DT_Output_9")
...
-- Code For temporary table tmp_20180508180123_codegen_tsion1_adb_b1 part 1. Create 


CREATE TEMPORARY TABLE tmp_20180508180123_codegen_tsion1_adb_b1 (
	"KEY" BIGINT, 
	"Score_0" DOUBLE, 
	"Proba_0" DOUBLE, 
	"Score_1" DOUBLE, 
...
-- Code For temporary table tmp_20180508180123_codegen_tsion1_adb_b1 part 2. Populate

INSERT INTO tmp_20180508180123_codegen_tsion1_adb_b1 ("KEY", "Score_0", "Proba_0", "Score_1", "Proba_1") SELECT "U"."KEY", "U"."Score_0", "U"."Proba_0", "U"."Score_1", "U"."Proba_1" 
...
"ADB_Model_10" AS 
(SELECT "DT_Output_10"."KEY" AS "KEY", (1.0 * (CASE WHEN ("DT_Output_10"."P_0" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE log(CASE WHEN ("DT_Output_10"."P_0" IS NULL OR "DT_Output_10"."P_0" > 1e-100) THEN "DT_Output_10"."P_0" ELSE 1e-100 END) END - (CASE WHEN ("DT_Output_10"."P_0" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE log(CASE WHEN ("DT_Output_10"."P_0" IS NULL OR "DT_Output_10"."P_0" > 1e-100) THEN "DT_Output_10"."P_0" ELSE 1e-100 END) END + CASE WHEN ("DT_Output_10"."P_1" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE log(CASE WHEN ("DT_Output_10"."P_1" IS NULL OR "DT_Output_10"."P_1" > 1e-100) THEN "DT_Output_10"."P_1" ELSE 1e-100 END) END) / 2)) / 16.0 AS "Score_0", 1.0 * (CASE WHEN ("DT_Output_10"."P_0" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE log(CASE WHEN ("DT_Output_10"."P_0" IS NULL OR "DT_Output_10"."P_0" > 1e-100) THEN "DT_Output_10"."P_0" ELSE 1e-100 END) END - (CASE WHEN ("DT_Output_10"."P_0" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE log(CASE WHEN ("DT_Output_10"."P_0" IS NULL OR "DT_Output_10"."P_0" > 1e-100) THEN "DT_Output_10"."P_0" ELSE 1e-100 END) END + CASE WHEN ("DT_Output_10"."P_1" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE log(CASE WHEN ("DT_Output_10"."P_1" IS NULL OR "DT_Output_10"."P_1" > 1e-100) THEN "DT_Output_10"."P_1" ELSE 1e-100 END) END) / 2) AS "Proba_0", (1.0 * (CASE WHEN ("DT_Output_10"."P_1" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE log(CASE WHEN ("DT_Output_10"."P_1" IS NULL OR "DT_Output_10"."P_1" > 1e-100) THEN "DT_Output_10"."P_1" ELSE 1e-100 END) END - (CASE WHEN ("DT_Output_10"."P_0" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE log(CASE WHEN ("DT_Output_10"."P_0" IS NULL OR "DT_Output_10"."P_0" > 1e-100) THEN "DT_Output_10"."P_0" ELSE 1e-100 END) END + CASE WHEN ("DT_Output_10"."P_1" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE log(CASE WHEN ("DT_Output_10"."P_1" IS NULL OR "DT_Output_10"."P_1" > 1e-100) THEN "DT_Output_10"."P_1" ELSE 1e-100 END) END) / 2)) / 16.0 AS "Score_1", 1.0 * (CASE WHEN ("DT_Output_10"."P_1" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE log(CASE WHEN ("DT_Output_10"."P_1" IS NULL OR "DT_Output_10"."P_1" > 1e-100) THEN "DT_Output_10"."P_1" ELSE 1e-100 END) END - (CASE WHEN ("DT_Output_10"."P_0" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE log(CASE WHEN ("DT_Output_10"."P_0" IS NULL OR "DT_Output_10"."P_0" > 1e-100) THEN "DT_Output_10"."P_0" ELSE 1e-100 END) END + CASE WHEN ("DT_Output_10"."P_1" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE log(CASE WHEN ("DT_Output_10"."P_1" IS NULL OR "DT_Output_10"."P_1" > 1e-100) THEN "DT_Output_10"."P_1" ELSE 1e-100 END) END) / 2) AS "Proba_1" 
FROM "DT_Output_10"), 
...
"ADB_Model_11" AS 
(SELECT "DT_Output_11"."KEY" AS "KEY", (1.0 * (CASE WHEN ("DT_Output_11"."P_0" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE log(CASE WHEN ("DT_Output_11"."P_0" IS NULL OR "DT_Output_11"."P_0" > 1e-100) THEN "DT_Output_11"."P_0" ELSE 1e-100 END) END - (CASE WHEN ("DT_Output_11"."P_0" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE log(CASE WHEN ("DT_Output_11"."P_0" IS NULL OR "DT_Output_11"."P_0" > 1e-100) THEN "DT_Output_11"."P_0" ELSE 1e-100 END) END + CASE WHEN ("DT_Output_11"."P_1" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE log(CASE WHEN ("DT_Output_11"."P_1" IS NULL OR "DT_Output_11"."P_1" > 1e-100) THEN "DT_Output_11"."P_1" ELSE 1e-100 END) END) / 2)) / 16.0 AS "Score_0", 1.0 * (CASE WHEN ("DT_Output_11"."P_0" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE log(CASE WHEN ("DT_Output_11"."P_0" IS NULL OR "DT_Output_11"."P_0" > 1e-100) THEN "DT_Output_11"."P_0" ELSE 1e-100 END) END - (CASE WHEN ("DT_Output_11"."P_0" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE log(CASE WHEN ("DT_Output_11"."P_0" IS NULL OR "DT_Output_11"."P_0" > 1e-100) THEN "DT_Output_11"."P_0" ELSE 1e-100 END) END + CASE WHEN ("DT_Output_11"."P_1" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE log(CASE WHEN ("DT_Output_11"."P_1" IS NULL OR "DT_Output_11"."P_1" > 1e-100) THEN "DT_Output_11"."P_1" ELSE 1e-100 END) END) / 2) AS "Proba_0", (1.0 * (CASE WHEN ("DT_Output_11"."P_1" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE log(CASE WHEN ("DT_Output_11"."P_1" IS NULL OR "DT_Output_11"."P_1" > 1e-100) THEN "DT_Output_11"."P_1" ELSE 1e-100 END) END - (CASE WHEN ("DT_Output_11"."P_0" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE log(CASE WHEN ("DT_Output_11"."P_0" IS NULL OR "DT_Output_11"."P_0" > 1e-100) THEN "DT_Output_11"."P_0" ELSE 1e-100 END) END + CASE WHEN ("DT_Output_11"."P_1" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE log(CASE WHEN ("DT_Output_11"."P_1" IS NULL OR "DT_Output_11"."P_1" > 1e-100) THEN "DT_Output_11"."P_1" ELSE 1e-100 END) END) / 2)) / 16.0 AS "Score_1", 1.0 * (CASE WHEN ("DT_Output_11"."P_1" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE log(CASE WHEN ("DT_Output_11"."P_1" IS NULL OR "DT_Output_11"."P_1" > 1e-100) THEN "DT_Output_11"."P_1" ELSE 1e-100 END) END - (CASE WHEN ("DT_Output_11"."P_0" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE log(CASE WHEN ("DT_Output_11"."P_0" IS NULL OR "DT_Output_11"."P_0" > 1e-100) THEN "DT_Output_11"."P_0" ELSE 1e-100 END) END + CASE WHEN ("DT_Output_11"."P_1" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE log(CASE WHEN ("DT_Output_11"."P_1" IS NULL OR "DT_Output_11"."P_1" > 1e-100) THEN "DT_Output_11"."P_1" ELSE 1e-100 END) END) / 2) AS "Proba_1" 
FROM "DT_Output_11"), 
...
"ADB_Model_12" AS 
(SELECT "DT_Output_12"."KEY" AS "KEY", (1.0 * (CASE WHEN ("DT_Output_12"."P_0" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE log(CASE WHEN ("DT_Output_12"."P_0" IS NULL OR "DT_Output_12"."P_0" > 1e-100) THEN "DT_Output_12"."P_0" ELSE 1e-100 END) END - (CASE WHEN ("DT_Output_12"."P_0" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE log(CASE WHEN ("DT_Output_12"."P_0" IS NULL OR "DT_Output_12"."P_0" > 1e-100) THEN "DT_Output_12"."P_0" ELSE 1e-100 END) END + CASE WHEN ("DT_Output_12"."P_1" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE log(CASE WHEN ("DT_Output_12"."P_1" IS NULL OR "DT_Output_12"."P_1" > 1e-100) THEN "DT_Output_12"."P_1" ELSE 1e-100 END) END) / 2)) / 16.0 AS "Score_0", 1.0 * (CASE WHEN ("DT_Output_12"."P_0" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE log(CASE WHEN ("DT_Output_12"."P_0" IS NULL OR "DT_Output_12"."P_0" > 1e-100) THEN "DT_Output_12"."P_0" ELSE 1e-100 END) END - (CASE WHEN ("DT_Output_12"."P_0" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE log(CASE WHEN ("DT_Output_12"."P_0" IS NULL OR "DT_Output_12"."P_0" > 1e-100) THEN "DT_Output_12"."P_0" ELSE 1e-100 END) END + CASE WHEN ("DT_Output_12"."P_1" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE log(CASE WHEN ("DT_Output_12"."P_1" IS NULL OR "DT_Output_12"."P_1" > 1e-100) THEN "DT_Output_12"."P_1" ELSE 1e-100 END) END) / 2) AS "Proba_0", (1.0 * (CASE WHEN ("DT_Output_12"."P_1" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE log(CASE WHEN ("DT_Output_12"."P_1" IS NULL OR "DT_Output_12"."P_1" > 1e-100) THEN "DT_Output_12"."P_1" ELSE 1e-100 END) END - (CASE WHEN ("DT_Output_12"."P_0" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE log(CASE WHEN ("DT_Output_12"."P_0" IS NULL OR "DT_Output_12"."P_0" > 1e-100) THEN "DT_Output_12"."P_0" ELSE 1e-100 END) END + CASE WHEN ("DT_Output_12"."P_1" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE log(CASE WHEN ("DT_Output_12"."P_1" IS NULL OR "DT_Output_12"."P_1" > 1e-100) THEN "DT_Output_12"."P_1" ELSE 1e-100 END) END) / 2)) / 16.0 AS "Score_1", 1.0 * (CASE WHEN ("DT_Output_12"."P_1" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE log(CASE WHEN ("DT_Output_12"."P_1" IS NULL OR "DT_Output_12"."P_1" > 1e-100) THEN "DT_Output_12"."P_1" ELSE 1e-100 END) END - (CASE WHEN ("DT_Output_12"."P_0" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE log(CASE WHEN ("DT_Output_12"."P_0" IS NULL OR "DT_Output_12"."P_0" > 1e-100) THEN "DT_Output_12"."P_0" ELSE 1e-100 END) END + CASE WHEN ("DT_Output_12"."P_1" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE log(CASE WHEN ("DT_Output_12"."P_1" IS NULL OR "DT_Output_12"."P_1" > 1e-100) THEN "DT_Output_12"."P_1" ELSE 1e-100 END) END) / 2) AS "Proba_1" 
FROM "DT_Output_12"), 
...
"ADB_Model_13" AS 
(SELECT "DT_Output_13"."KEY" AS "KEY", (1.0 * (CASE WHEN ("DT_Output_13"."P_0" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE log(CASE WHEN ("DT_Output_13"."P_0" IS NULL OR "DT_Output_13"."P_0" > 1e-100) THEN "DT_Output_13"."P_0" ELSE 1e-100 END) END - (CASE WHEN ("DT_Output_13"."P_0" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE log(CASE WHEN ("DT_Output_13"."P_0" IS NULL OR "DT_Output_13"."P_0" > 1e-100) THEN "DT_Output_13"."P_0" ELSE 1e-100 END) END + CASE WHEN ("DT_Output_13"."P_1" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE log(CASE WHEN ("DT_Output_13"."P_1" IS NULL OR "DT_Output_13"."P_1" > 1e-100) THEN "DT_Output_13"."P_1" ELSE 1e-100 END) END) / 2)) / 16.0 AS "Score_0", 1.0 * (CASE WHEN ("DT_Output_13"."P_0" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE log(CASE WHEN ("DT_Output_13"."P_0" IS NULL OR "DT_Output_13"."P_0" > 1e-100) THEN "DT_Output_13"."P_0" ELSE 1e-100 END) END - (CASE WHEN ("DT_Output_13"."P_0" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE log(CASE WHEN ("DT_Output_13"."P_0" IS NULL OR "DT_Output_13"."P_0" > 1e-100) THEN "DT_Output_13"."P_0" ELSE 1e-100 END) END + CASE WHEN ("DT_Output_13"."P_1" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE log(CASE WHEN ("DT_Output_13"."P_1" IS NULL OR "DT_Output_13"."P_1" > 1e-100) THEN "DT_Output_13"."P_1" ELSE 1e-100 END) END) / 2) AS "Proba_0", (1.0 * (CASE WHEN ("DT_Output_13"."P_1" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE log(CASE WHEN ("DT_Output_13"."P_1" IS NULL OR "DT_Output_13"."P_1" > 1e-100) THEN "DT_Output_13"."P_1" ELSE 1e-100 END) END - (CASE WHEN ("DT_Output_13"."P_0" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE log(CASE WHEN ("DT_Output_13"."P_0" IS NULL OR "DT_Output_13"."P_0" > 1e-100) THEN "DT_Output_13"."P_0" ELSE 1e-100 END) END + CASE WHEN ("DT_Output_13"."P_1" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE log(CASE WHEN ("DT_Output_13"."P_1" IS NULL OR "DT_Output_13"."P_1" > 1e-100) THEN "DT_Output_13"."P_1" ELSE 1e-100 END) END) / 2)) / 16.0 AS "Score_1", 1.0 * (CASE WHEN ("DT_Output_13"."P_1" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE log(CASE WHEN ("DT_Output_13"."P_1" IS NULL OR "DT_Output_13"."P_1" > 1e-100) THEN "DT_Output_13"."P_1" ELSE 1e-100 END) END - (CASE WHEN ("DT_Output_13"."P_0" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE log(CASE WHEN ("DT_Output_13"."P_0" IS NULL OR "DT_Output_13"."P_0" > 1e-100) THEN "DT_Output_13"."P_0" ELSE 1e-100 END) END + CASE WHEN ("DT_Output_13"."P_1" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE log(CASE WHEN ("DT_Output_13"."P_1" IS NULL OR "DT_Output_13"."P_1" > 1e-100) THEN "DT_Output_13"."P_1" ELSE 1e-100 END) END) / 2) AS "Proba_1" 
FROM "DT_Output_13"), 
...
"ADB_Model_14" AS 
(SELECT "DT_Output_14"."KEY" AS "KEY", (1.0 * (CASE WHEN ("DT_Output_14"."P_0" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE log(CASE WHEN ("DT_Output_14"."P_0" IS NULL OR "DT_Output_14"."P_0" > 1e-100) THEN "DT_Output_14"."P_0" ELSE 1e-100 END) END - (CASE WHEN ("DT_Output_14"."P_0" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE log(CASE WHEN ("DT_Output_14"."P_0" IS NULL OR "DT_Output_14"."P_0" > 1e-100) THEN "DT_Output_14"."P_0" ELSE 1e-100 END) END + CASE WHEN ("DT_Output_14"."P_1" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE log(CASE WHEN ("DT_Output_14"."P_1" IS NULL OR "DT_Output_14"."P_1" > 1e-100) THEN "DT_Output_14"."P_1" ELSE 1e-100 END) END) / 2)) / 16.0 AS "Score_0", 1.0 * (CASE WHEN ("DT_Output_14"."P_0" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE log(CASE WHEN ("DT_Output_14"."P_0" IS NULL OR "DT_Output_14"."P_0" > 1e-100) THEN "DT_Output_14"."P_0" ELSE 1e-100 END) END - (CASE WHEN ("DT_Output_14"."P_0" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE log(CASE WHEN ("DT_Output_14"."P_0" IS NULL OR "DT_Output_14"."P_0" > 1e-100) THEN "DT_Output_14"."P_0" ELSE 1e-100 END) END + CASE WHEN ("DT_Output_14"."P_1" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE log(CASE WHEN ("DT_Output_14"."P_1" IS NULL OR "DT_Output_14"."P_1" > 1e-100) THEN "DT_Output_14"."P_1" ELSE 1e-100 END) END) / 2) AS "Proba_0", (1.0 * (CASE WHEN ("DT_Output_14"."P_1" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE log(CASE WHEN ("DT_Output_14"."P_1" IS NULL OR "DT_Output_14"."P_1" > 1e-100) THEN "DT_Output_14"."P_1" ELSE 1e-100 END) END - (CASE WHEN ("DT_Output_14"."P_0" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE log(CASE WHEN ("DT_Output_14"."P_0" IS NULL OR "DT_Output_14"."P_0" > 1e-100) THEN "DT_Output_14"."P_0" ELSE 1e-100 END) END + CASE WHEN ("DT_Output_14"."P_1" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE log(CASE WHEN ("DT_Output_14"."P_1" IS NULL OR "DT_Output_14"."P_1" > 1e-100) THEN "DT_Output_14"."P_1" ELSE 1e-100 END) END) / 2)) / 16.0 AS "Score_1", 1.0 * (CASE WHEN ("DT_Output_14"."P_1" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE log(CASE WHEN ("DT_Output_14"."P_1" IS NULL OR "DT_Output_14"."P_1" > 1e-100) THEN "DT_Output_14"."P_1" ELSE 1e-100 END) END - (CASE WHEN ("DT_Output_14"."P_0" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE log(CASE WHEN ("DT_Output_14"."P_0" IS NULL OR "DT_Output_14"."P_0" > 1e-100) THEN "DT_Output_14"."P_0" ELSE 1e-100 END) END + CASE WHEN ("DT_Output_14"."P_1" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE log(CASE WHEN ("DT_Output_14"."P_1" IS NULL OR "DT_Output_14"."P_1" > 1e-100) THEN "DT_Output_14"."P_1" ELSE 1e-100 END) END) / 2) AS "Proba_1" 
FROM "DT_Output_14"), 
...
"ADB_Model_15" AS 
(SELECT "DT_Output_15"."KEY" AS "KEY", (1.0 * (CASE WHEN ("DT_Output_15"."P_0" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE log(CASE WHEN ("DT_Output_15"."P_0" IS NULL OR "DT_Output_15"."P_0" > 1e-100) THEN "DT_Output_15"."P_0" ELSE 1e-100 END) END - (CASE WHEN ("DT_Output_15"."P_0" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE log(CASE WHEN ("DT_Output_15"."P_0" IS NULL OR "DT_Output_15"."P_0" > 1e-100) THEN "DT_Output_15"."P_0" ELSE 1e-100 END) END + CASE WHEN ("DT_Output_15"."P_1" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE log(CASE WHEN ("DT_Output_15"."P_1" IS NULL OR "DT_Output_15"."P_1" > 1e-100) THEN "DT_Output_15"."P_1" ELSE 1e-100 END) END) / 2)) / 16.0 AS "Score_0", 1.0 * (CASE WHEN ("DT_Output_15"."P_0" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE log(CASE WHEN ("DT_Output_15"."P_0" IS NULL OR "DT_Output_15"."P_0" > 1e-100) THEN "DT_Output_15"."P_0" ELSE 1e-100 END) END - (CASE WHEN ("DT_Output_15"."P_0" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE log(CASE WHEN ("DT_Output_15"."P_0" IS NULL OR "DT_Output_15"."P_0" > 1e-100) THEN "DT_Output_15"."P_0" ELSE 1e-100 END) END + CASE WHEN ("DT_Output_15"."P_1" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE log(CASE WHEN ("DT_Output_15"."P_1" IS NULL OR "DT_Output_15"."P_1" > 1e-100) THEN "DT_Output_15"."P_1" ELSE 1e-100 END) END) / 2) AS "Proba_0", (1.0 * (CASE WHEN ("DT_Output_15"."P_1" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE log(CASE WHEN ("DT_Output_15"."P_1" IS NULL OR "DT_Output_15"."P_1" > 1e-100) THEN "DT_Output_15"."P_1" ELSE 1e-100 END) END - (CASE WHEN ("DT_Output_15"."P_0" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE log(CASE WHEN ("DT_Output_15"."P_0" IS NULL OR "DT_Output_15"."P_0" > 1e-100) THEN "DT_Output_15"."P_0" ELSE 1e-100 END) END + CASE WHEN ("DT_Output_15"."P_1" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE log(CASE WHEN ("DT_Output_15"."P_1" IS NULL OR "DT_Output_15"."P_1" > 1e-100) THEN "DT_Output_15"."P_1" ELSE 1e-100 END) END) / 2)) / 16.0 AS "Score_1", 1.0 * (CASE WHEN ("DT_Output_15"."P_1" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE log(CASE WHEN ("DT_Output_15"."P_1" IS NULL OR "DT_Output_15"."P_1" > 1e-100) THEN "DT_Output_15"."P_1" ELSE 1e-100 END) END - (CASE WHEN ("DT_Output_15"."P_0" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE log(CASE WHEN ("DT_Output_15"."P_0" IS NULL OR "DT_Output_15"."P_0" > 1e-100) THEN "DT_Output_15"."P_0" ELSE 1e-100 END) END + CASE WHEN ("DT_Output_15"."P_1" <= 2.22044604925e-16) THEN -36.043653389117296 ELSE log(CASE WHEN ("DT_Output_15"."P_1" IS NULL OR "DT_Output_15"."P_1" > 1e-100) THEN "DT_Output_15"."P_1" ELSE 1e-100 END) END) / 2) AS "Proba_1" 
FROM "DT_Output_15")
...
-- Code For temporary table tmp_20180508180123_codegen_mejd84_adb_union part 1. Create 


CREATE TEMPORARY TABLE tmp_20180508180123_codegen_mejd84_adb_union (
	"KEY" BIGINT, 
	"Score_0" DOUBLE, 
	"Proba_0" DOUBLE, 
	"Score_1" DOUBLE, 
...
-- Code For temporary table tmp_20180508180123_codegen_mejd84_adb_union part 2. Populate

INSERT INTO tmp_20180508180123_codegen_mejd84_adb_union ("KEY", "Score_0", "Proba_0", "Score_1", "Proba_1") SELECT "U"."KEY", "U"."Score_0", "U"."Proba_0", "U"."Score_1", "U"."Proba_1" 
...
FROM tmp_20180508180123_codegen_dfe5zp_adb_b0 AS "ADB_B0" UNION ALL SELECT "ADB_B1"."KEY" AS "KEY", "ADB_B1"."Score_0" AS "Score_0", "ADB_B1"."Proba_0" AS "Proba_0", "ADB_B1"."Score_1" AS "Score_1", "ADB_B1"."Proba_1" AS "Proba_1" 
FROM tmp_20180508180123_codegen_tsion1_adb_b1 AS "ADB_B1") AS "ADB_EnsembleUnion") AS "ADB_Union") AS "U"

-- Code For temporary table tmp_20180508180123_codegen_2whp5h_adb_sum part 1. Create 


CREATE TEMPORARY TABLE tmp_20180508180123_codegen_2whp5h_adb_sum (
	"KEY" BIGINT, 
	"Score_0" DOUBLE, 
	"Proba_0" DOUBLE, 
	"Score_1" DOUBLE, 
...
-- Code For temporary table tmp_20180508180123_codegen_2whp5h_adb_sum part 2. Populate

INSERT INTO tmp_20180508180123_codegen_2whp5h_adb_sum ("KEY", "Score_0", "Proba_0", "Score_1", "Proba_1") SELECT "U"."KEY", "U"."Score_0", "U"."Proba_0", "U"."Score_1", "U"."Proba_1" 
...
FROM tmp_20180508180123_codegen_mejd84_adb_union AS "ADB_Union" GROUP BY "ADB_Union"."KEY") AS "T") AS "ADB_sum") AS "U"
...
FROM tmp_20180508180123_codegen_2whp5h_adb_sum AS "ADB_sum"), 
