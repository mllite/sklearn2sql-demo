...
-- Code For temporary table tmp_20180516110734_codegen_cxgvuk_ads_imp_1_out part 1. Create 


CREATE TEMPORARY TABLE tmp_20180516110734_codegen_cxgvuk_ads_imp_1_out (
	"KEY" BIGINT, 
	impter_2 DOUBLE, 
	impter_3 DOUBLE, 
	impter_4 DOUBLE, 
...
-- Code For temporary table tmp_20180516110734_codegen_eecr5c_ads_sca_2_out part 1. Create 


CREATE TEMPORARY TABLE tmp_20180516110734_codegen_eecr5c_ads_sca_2_out (
	"KEY" BIGINT, 
	scaler_2 DOUBLE, 
	scaler_3 DOUBLE, 
	scaler_4 DOUBLE, 
...
FROM tmp_20180516110734_codegen_cxgvuk_ads_imp_1_out AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT") AS "U"

-- Code For temporary table tmp_20180516110735_codegen_k8iz15_adb_b0 part 1. Create 


CREATE TEMPORARY TABLE tmp_20180516110735_codegen_k8iz15_adb_b0 (
	"KEY" BIGINT, 
	"Score_0" DOUBLE, 
	"Proba_0" DOUBLE, 
	"Score_1" DOUBLE, 
...
-- Code For temporary table tmp_20180516110735_codegen_k8iz15_adb_b0 part 2. Populate

INSERT INTO tmp_20180516110735_codegen_k8iz15_adb_b0 ("KEY", "Score_0", "Proba_0", "Score_1", "Proba_1") SELECT "U"."KEY", "U"."Score_0", "U"."Proba_0", "U"."Score_1", "U"."Proba_1" 
...
FROM tmp_20180516110734_codegen_eecr5c_ads_sca_2_out AS "ADS_sca_2_OUT"), 
"DT_node_data" AS 
...
-- Code For temporary table tmp_20180516110735_codegen_tl4zd3_adb_b1 part 1. Create 


CREATE TEMPORARY TABLE tmp_20180516110735_codegen_tl4zd3_adb_b1 (
	"KEY" BIGINT, 
	"Score_0" DOUBLE, 
	"Proba_0" DOUBLE, 
	"Score_1" DOUBLE, 
...
-- Code For temporary table tmp_20180516110735_codegen_tl4zd3_adb_b1 part 2. Populate

INSERT INTO tmp_20180516110735_codegen_tl4zd3_adb_b1 ("KEY", "Score_0", "Proba_0", "Score_1", "Proba_1") SELECT "U"."KEY", "U"."Score_0", "U"."Proba_0", "U"."Score_1", "U"."Proba_1" 
...
-- Code For temporary table tmp_20180516110735_codegen_00l79f_adb_sum part 1. Create 


CREATE TEMPORARY TABLE tmp_20180516110735_codegen_00l79f_adb_sum (
	"KEY" BIGINT, 
	"Score_0" DOUBLE, 
	"Proba_0" DOUBLE, 
	"Score_1" DOUBLE, 
...
-- Code For temporary table tmp_20180516110735_codegen_00l79f_adb_sum part 2. Populate

INSERT INTO tmp_20180516110735_codegen_00l79f_adb_sum ("KEY", "Score_0", "Proba_0", "Score_1", "Proba_1") SELECT "U"."KEY", "U"."Score_0", "U"."Proba_0", "U"."Score_1", "U"."Proba_1" 
...
FROM tmp_20180516110735_codegen_k8iz15_adb_b0 AS "ADB_B0" UNION ALL SELECT "ADB_B1"."KEY" AS "KEY", "ADB_B1"."Score_0" AS "Score_0", "ADB_B1"."Proba_0" AS "Proba_0", "ADB_B1"."Score_1" AS "Score_1", "ADB_B1"."Proba_1" AS "Proba_1" 
FROM tmp_20180516110735_codegen_tl4zd3_adb_b1 AS "ADB_B1") AS "ADB_EnsembleUnion")
...
FROM tmp_20180516110735_codegen_00l79f_adb_sum AS "ADB_sum"), 
