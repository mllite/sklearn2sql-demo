...
-- Code For temporary table TMP_20180602_Y2Q_ADS_IMP_1_OUT part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180602_Y2Q_ADS_IMP_1_OUT" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20180602_Y2Q_ADS_IMP_1_OUT part 2. Populate

INSERT INTO "TMP_20180602_Y2Q_ADS_IMP_1_OUT" ("KEY", impter_2, impter_3, impter_4, impter_5, impter_6, impter_7, impter_8, impter_9, impter_10, impter_11, impter_12, impter_13, impter_14, impter_15, impter_16, impter_17, impter_18, impter_19, impter_20, impter_21, impter_22, impter_23, impter_24, impter_25, impter_26, impter_27, impter_28, impter_29, impter_30, impter_31) SELECT "U"."KEY", "U".impter_2, "U".impter_3, "U".impter_4, "U".impter_5, "U".impter_6, "U".impter_7, "U".impter_8, "U".impter_9, "U".impter_10, "U".impter_11, "U".impter_12, "U".impter_13, "U".impter_14, "U".impter_15, "U".impter_16, "U".impter_17, "U".impter_18, "U".impter_19, "U".impter_20, "U".impter_21, "U".impter_22, "U".impter_23, "U".impter_24, "U".impter_25, "U".impter_26, "U".impter_27, "U".impter_28, "U".impter_29, "U".impter_30, "U".impter_31 
...
-- Code For temporary table TMP_20180602_Y2Q_ADS_IMP_1_OUT part 3. Create Index 

CREATE INDEX "ix_TMP_20180602_Y2Q_ADS_6c0c" ON "TMP_20180602_Y2Q_ADS_IMP_1_OUT" ("KEY")

-- Code For temporary table TMP_20180602_J74_ADS_SCA_2_OUT part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180602_J74_ADS_SCA_2_OUT" (
	"KEY" BIGINT NOT NULL, 
...
FROM "TMP_20180602_Y2Q_ADS_IMP_1_OUT" AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT") AS "U"

-- Code For temporary table TMP_20180602_J74_ADS_SCA_2_OUT part 3. Create Index 

CREATE INDEX "ix_TMP_20180602_J74_ADS_be33" ON "TMP_20180602_J74_ADS_SCA_2_OUT" ("KEY")

-- Code For temporary table TMP_20180602_IZH_ADB_B0 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180602_IZH_ADB_B0" (
	"KEY" BIGINT, 
...
-- Code For temporary table TMP_20180602_IZH_ADB_B0 part 2. Populate

INSERT INTO "TMP_20180602_IZH_ADB_B0" ("KEY", "Score_0", "Proba_0", "Score_1", "Proba_1") SELECT "U"."KEY", "U"."Score_0", "U"."Proba_0", "U"."Score_1", "U"."Proba_1" 
...
FROM "TMP_20180602_J74_ADS_SCA_2_OUT" AS "ADS_sca_2_OUT"), 
"DT_node_data" AS 
...
-- Code For temporary table TMP_20180602_K08_ADB_B1 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180602_K08_ADB_B1" (
	"KEY" BIGINT, 
	"Score_0" DOUBLE PRECISION, 
	"Proba_0" DOUBLE PRECISION, 
	"Score_1" DOUBLE PRECISION, 
...
-- Code For temporary table TMP_20180602_K08_ADB_B1 part 2. Populate

INSERT INTO "TMP_20180602_K08_ADB_B1" ("KEY", "Score_0", "Proba_0", "Score_1", "Proba_1") SELECT "U"."KEY", "U"."Score_0", "U"."Proba_0", "U"."Score_1", "U"."Proba_1" 
...
-- Code For temporary table TMP_20180602_52Y_ADB_B2 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180602_52Y_ADB_B2" (
	"KEY" BIGINT, 
	"Score_0" DOUBLE PRECISION, 
	"Proba_0" DOUBLE PRECISION, 
	"Score_1" DOUBLE PRECISION, 
...
-- Code For temporary table TMP_20180602_52Y_ADB_B2 part 2. Populate

INSERT INTO "TMP_20180602_52Y_ADB_B2" ("KEY", "Score_0", "Proba_0", "Score_1", "Proba_1") SELECT "U"."KEY", "U"."Score_0", "U"."Proba_0", "U"."Score_1", "U"."Proba_1" 
...
-- Code For temporary table TMP_20180602_2Z9_ADB_B3 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180602_2Z9_ADB_B3" (
	"KEY" BIGINT, 
	"Score_0" DOUBLE PRECISION, 
	"Proba_0" DOUBLE PRECISION, 
	"Score_1" DOUBLE PRECISION, 
...
-- Code For temporary table TMP_20180602_2Z9_ADB_B3 part 2. Populate

INSERT INTO "TMP_20180602_2Z9_ADB_B3" ("KEY", "Score_0", "Proba_0", "Score_1", "Proba_1") SELECT "U"."KEY", "U"."Score_0", "U"."Proba_0", "U"."Score_1", "U"."Proba_1" 
...
-- Code For temporary table TMP_20180602_5PX_ADB_SUM part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180602_5PX_ADB_SUM" (
	"KEY" BIGINT NOT NULL, 
	"Score_0" DOUBLE PRECISION, 
	"Proba_0" DOUBLE PRECISION, 
	"Score_1" DOUBLE PRECISION, 
...
-- Code For temporary table TMP_20180602_5PX_ADB_SUM part 2. Populate

INSERT INTO "TMP_20180602_5PX_ADB_SUM" ("KEY", "Score_0", "Proba_0", "Score_1", "Proba_1") SELECT "U"."KEY", "U"."Score_0", "U"."Proba_0", "U"."Score_1", "U"."Proba_1" 
...
FROM "TMP_20180602_IZH_ADB_B0" AS "ADB_B0" UNION ALL SELECT "ADB_B1"."KEY" AS "KEY", "ADB_B1"."Score_0" AS "Score_0", "ADB_B1"."Proba_0" AS "Proba_0", "ADB_B1"."Score_1" AS "Score_1", "ADB_B1"."Proba_1" AS "Proba_1" 
FROM "TMP_20180602_K08_ADB_B1" AS "ADB_B1" UNION ALL SELECT "ADB_B2"."KEY" AS "KEY", "ADB_B2"."Score_0" AS "Score_0", "ADB_B2"."Proba_0" AS "Proba_0", "ADB_B2"."Score_1" AS "Score_1", "ADB_B2"."Proba_1" AS "Proba_1" 
FROM "TMP_20180602_52Y_ADB_B2" AS "ADB_B2" UNION ALL SELECT "ADB_B3"."KEY" AS "KEY", "ADB_B3"."Score_0" AS "Score_0", "ADB_B3"."Proba_0" AS "Proba_0", "ADB_B3"."Score_1" AS "Score_1", "ADB_B3"."Proba_1" AS "Proba_1" 
FROM "TMP_20180602_2Z9_ADB_B3" AS "ADB_B3") AS "ADB_EnsembleUnion")
...
-- Code For temporary table TMP_20180602_5PX_ADB_SUM part 3. Create Index 

CREATE INDEX "ix_TMP_20180602_5PX_ADB_SUM_KEY" ON "TMP_20180602_5PX_ADB_SUM" ("KEY")
...
FROM "TMP_20180602_5PX_ADB_SUM" AS "ADB_sum"), 
