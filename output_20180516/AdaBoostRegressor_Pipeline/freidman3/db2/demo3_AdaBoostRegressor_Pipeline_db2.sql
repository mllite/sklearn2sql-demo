...
-- Code For temporary table tmp_20180516121646_codegen_eiy4xy_ads_imp_1_out part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180516121646_codegen_eiy4xy_ads_imp_1_out (
	"KEY" BIGINT, 
...
-- Code For temporary table tmp_20180516121646_codegen_eiy4xy_ads_imp_1_out part 2. Populate

INSERT INTO tmp_20180516121646_codegen_eiy4xy_ads_imp_1_out SELECT "ADS_imp_1_OUT"."KEY", "ADS_imp_1_OUT".imputer_output_2, "ADS_imp_1_OUT".imputer_output_3, "ADS_imp_1_OUT".imputer_output_4, "ADS_imp_1_OUT".imputer_output_5 
...
-- Code For temporary table tmp_20180516121646_codegen_ujyv1t_ads_sca_2_out part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180516121646_codegen_ujyv1t_ads_sca_2_out (
	"KEY" BIGINT, 
...
-- Code For temporary table tmp_20180516121646_codegen_ujyv1t_ads_sca_2_out part 2. Populate

INSERT INTO tmp_20180516121646_codegen_ujyv1t_ads_sca_2_out SELECT "ADS_sca_2_OUT"."KEY", "ADS_sca_2_OUT".scaler_output_2, "ADS_sca_2_OUT".scaler_output_3, "ADS_sca_2_OUT".scaler_output_4, "ADS_sca_2_OUT".scaler_output_5 
...
FROM tmp_20180516121646_codegen_eiy4xy_ads_imp_1_out AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT"

-- Code For temporary table tmp_20180516121646_codegen_0mfh40_quantiles part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180516121646_codegen_0mfh40_quantiles (
	"KEY" BIGINT, 
	"Quantile" DOUBLE
)
...
-- Code For temporary table tmp_20180516121646_codegen_0mfh40_quantiles part 2. Populate

INSERT INTO tmp_20180516121646_codegen_0mfh40_quantiles WITH "DT_node_lookup" AS 
...
FROM tmp_20180516121646_codegen_ujyv1t_ads_sca_2_out AS "ADS_sca_2_OUT"), 
"DT_node_data" AS 
(SELECT "Values".nid AS nid, CAST("Values"."E" AS DOUBLE) AS "E" 
FROM (SELECT 3 AS nid, 0.7050714675464733 AS "E" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 4 AS nid, 0.43001724369176697 AS "E" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 6 AS nid, 0.6100168381304848 AS "E" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 7 AS nid, 1.2443297616327034 AS "E" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 10 AS nid, 1.4733555133692287 AS "E" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 11 AS nid, 1.1552266207505864 AS "E" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 13 AS nid, 1.5354636129407508 AS "E" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 14 AS nid, 1.4648826319981552 AS "E" FROM SYSIBM.SYSDUMMY1) AS "Values"), 
"DT_Output" AS 
...
"DT_node_data_1" AS 
(SELECT "Values".nid AS nid, CAST("Values"."E" AS DOUBLE) AS "E" 
FROM (SELECT 2 AS nid, 0.38342473185592096 AS "E" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 3 AS nid, 0.4848669214064692 AS "E" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 6 AS nid, 0.5915392445044317 AS "E" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 7 AS nid, 1.2541519017473017 AS "E" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 9 AS nid, 1.5287311749770354 AS "E" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 10 AS nid, 1.3679828024550929 AS "E" FROM SYSIBM.SYSDUMMY1) AS "Values"), 
"DT_Output_1" AS 
...
"DT_node_data_2" AS 
(SELECT "Values".nid AS nid, CAST("Values"."E" AS DOUBLE) AS "E" 
FROM (SELECT 3 AS nid, 0.38342473185592096 AS "E" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 4 AS nid, 0.4848669214064692 AS "E" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 5 AS nid, 0.6100168381304848 AS "E" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 8 AS nid, 0.3751675659770648 AS "E" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 9 AS nid, 1.2189678231486023 AS "E" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 11 AS nid, 1.377641769292083 AS "E" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 12 AS nid, 1.5145094173378104 AS "E" FROM SYSIBM.SYSDUMMY1) AS "Values"), 
"DT_Output_2" AS 
...
"DT_node_data_3" AS 
(SELECT "Values".nid AS nid, CAST("Values"."E" AS DOUBLE) AS "E" 
FROM (SELECT 3 AS nid, 0.4848669214064692 AS "E" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 4 AS nid, 0.38177329868014975 AS "E" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 6 AS nid, 0.7736311045366903 AS "E" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 7 AS nid, 1.2168500273152194 AS "E" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 10 AS nid, 1.4286748402499525 AS "E" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 11 AS nid, 1.5097423878118206 AS "E" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 13 AS nid, 1.142622893040531 AS "E" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 14 AS nid, 1.398314530314508 AS "E" FROM SYSIBM.SYSDUMMY1) AS "Values"), 
"DT_Output_3" AS 
...
"DT_node_data_4" AS 
(SELECT "Values".nid AS nid, CAST("Values"."E" AS DOUBLE) AS "E" 
FROM (SELECT 3 AS nid, 1.4455967910671395 AS "E" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 4 AS nid, 1.3284094170198377 AS "E" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 6 AS nid, 0.8079109230317987 AS "E" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 7 AS nid, 1.1484121598646297 AS "E" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 10 AS nid, 1.225018295065725 AS "E" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 11 AS nid, 1.448477991055055 AS "E" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 13 AS nid, 1.5608250367469139 AS "E" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 14 AS nid, 1.5038401763272644 AS "E" FROM SYSIBM.SYSDUMMY1) AS "Values"), 
"DT_Output_4" AS 
...
"DT_node_data_5" AS 
(SELECT "Values".nid AS nid, CAST("Values"."E" AS DOUBLE) AS "E" 
FROM (SELECT 2 AS nid, 0.38342473185592096 AS "E" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 3 AS nid, 0.6100168381304848 AS "E" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 6 AS nid, 1.3689832528589367 AS "E" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 7 AS nid,