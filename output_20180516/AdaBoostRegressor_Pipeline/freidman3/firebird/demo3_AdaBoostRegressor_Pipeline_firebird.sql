...
-- Code For temporary table TMP_20180516_CODEGEN_NANEWS_ADS part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180516_CODEGEN_NANEWS_ADS" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20180516_CODEGEN_NANEWS_ADS part 2. Populate

INSERT INTO "TMP_20180516_CODEGEN_NANEWS_ADS" ("KEY", imputer_output_2, imputer_output_3, imputer_output_4, imputer_output_5) SELECT "U"."KEY", "U".imputer_output_2, "U".imputer_output_3, "U".imputer_output_4, "U".imputer_output_5 
...
-- Code For temporary table TMP_20180516_CODEGEN_NANEWS_ADS part 3. Create Index 

CREATE INDEX "ix_TMP_20180516_CODEGEN_4a21" ON "TMP_20180516_CODEGEN_NANEWS_ADS" ("KEY")

-- Code For temporary table TMP_20180516_CODEGEN_0OBOK7_ADS part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180516_CODEGEN_0OBOK7_ADS" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20180516_CODEGEN_0OBOK7_ADS part 2. Populate

INSERT INTO "TMP_20180516_CODEGEN_0OBOK7_ADS" ("KEY", scaler_output_2, scaler_output_3, scaler_output_4, scaler_output_5) SELECT "U"."KEY", "U".scaler_output_2, "U".scaler_output_3, "U".scaler_output_4, "U".scaler_output_5 
...
FROM "TMP_20180516_CODEGEN_NANEWS_ADS" AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT") AS "U"

-- Code For temporary table TMP_20180516_CODEGEN_0OBOK7_ADS part 3. Create Index 

CREATE INDEX "ix_TMP_20180516_CODEGEN_b8ce" ON "TMP_20180516_CODEGEN_0OBOK7_ADS" ("KEY")

-- Code For temporary table TMP_20180516_CODEGEN_TBS75A_QUA part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180516_CODEGEN_TBS75A_QUA" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20180516_CODEGEN_TBS75A_QUA part 2. Populate

INSERT INTO "TMP_20180516_CODEGEN_TBS75A_QUA" ("KEY", "Quantile") SELECT "U"."KEY", "U"."Quantile" 
...
FROM "TMP_20180516_CODEGEN_0OBOK7_ADS" AS "ADS_sca_2_OUT"), 
"DT_node_data" AS 
...
-- Code For temporary table TMP_20180516_CODEGEN_TBS75A_QUA part 3. Create Index 

CREATE INDEX "ix_TMP_20180516_CODEGEN_c1da" ON "TMP_20180516_CODEGEN_TBS75A_QUA" ("KEY")

-- Model deployment code

SELECT "Quantiles"."KEY" AS "KEY", "Quantiles"."Quantile" AS "Estimator" 
FROM "TMP_20180516_CODEGEN_TBS75A_QUA" AS "Quantiles"