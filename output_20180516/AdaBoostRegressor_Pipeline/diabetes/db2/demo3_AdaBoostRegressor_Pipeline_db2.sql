...
-- Code For temporary table tmp_20180508183252_codegen_r2e66q_ads_imp_1_out part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180508183252_codegen_r2e66q_ads_imp_1_out (
	"KEY" BIGINT, 
	impter_2 DOUBLE, 
	impter_3 DOUBLE, 
	impter_4 DOUBLE, 
...
-- Code For temporary table tmp_20180508183252_codegen_r2e66q_ads_imp_1_out part 2. Populate

INSERT INTO tmp_20180508183252_codegen_r2e66q_ads_imp_1_out SELECT "ADS_imp_1_OUT"."KEY", "ADS_imp_1_OUT".impter_2, "ADS_imp_1_OUT".impter_3, "ADS_imp_1_OUT".impter_4, "ADS_imp_1_OUT".impter_5, "ADS_imp_1_OUT".impter_6, "ADS_imp_1_OUT".impter_7, "ADS_imp_1_OUT".impter_8, "ADS_imp_1_OUT".impter_9, "ADS_imp_1_OUT".impter_10, "ADS_imp_1_OUT".impter_11 
...
-- Code For temporary table tmp_20180508183252_codegen_ahx7le_ads_sca_2_out part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180508183252_codegen_ahx7le_ads_sca_2_out (
	"KEY" BIGINT, 
	scaler_2 DOUBLE, 
	scaler_3 DOUBLE, 
	scaler_4 DOUBLE, 
...
-- Code For temporary table tmp_20180508183252_codegen_ahx7le_ads_sca_2_out part 2. Populate

INSERT INTO tmp_20180508183252_codegen_ahx7le_ads_sca_2_out SELECT "ADS_sca_2_OUT"."KEY", "ADS_sca_2_OUT".scaler_2, "ADS_sca_2_OUT".scaler_3, "ADS_sca_2_OUT".scaler_4, "ADS_sca_2_OUT".scaler_5, "ADS_sca_2_OUT".scaler_6, "ADS_sca_2_OUT".scaler_7, "ADS_sca_2_OUT".scaler_8, "ADS_sca_2_OUT".scaler_9, "ADS_sca_2_OUT".scaler_10, "ADS_sca_2_OUT".scaler_11 
...
FROM tmp_20180508183252_codegen_r2e66q_ads_imp_1_out AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT"

-- Code For temporary table tmp_20180508183252_codegen_gocquk_quantiles part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180508183252_codegen_gocquk_quantiles (
	"KEY" BIGINT, 
	"Quantile" DOUBLE
)
...
-- Code For temporary table tmp_20180508183252_codegen_gocquk_quantiles part 2. Populate

INSERT INTO tmp_20180508183252_codegen_gocquk_quantiles WITH "DT_node_lookup" AS 
...
FROM tmp_20180508183252_codegen_ahx7le_ads_sca_2_out AS "ADS_sca_2_OUT"), 
"DT_node_data" AS 
(SELECT "Values".nid AS nid, CAST("Values"."E" AS DOUBLE) AS "E" 
FROM (SELECT 3 AS nid, 76.73333333333333 AS "E" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 4 AS nid, 106.52808988764045 AS "E" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 6 AS nid, 244.0 AS "E" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 7 AS nid, 155.5185185185185 AS "E" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 10 AS nid, 155.5 AS "E" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 11 AS nid, 198.71428571428572 AS "E" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 13 AS nid, 297.3157894736842 AS "E" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 14 AS nid, 223.5 AS "E" FROM SYSIBM.SYSDUMMY1) AS "Values"), 
"DT_Output" AS 
...
"DT_node_data_1" AS 
(SELECT "Values".nid AS nid, CAST("Values"."E" AS DOUBLE) AS "E" 
FROM (SELECT 3 AS nid, 106.35754189944134 AS "E" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 4 AS nid, 219.66666666666666 AS "E" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 6 AS nid, 131.06666666666666 AS "E" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 7 AS nid, 197.14285714285714 AS "E" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 10 AS nid, 218.5064935064935 AS "E" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 11 AS nid, 291.26666666666665 AS "E" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 13 AS nid, 103.8 AS "E" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 14 AS nid, 201.0 AS "E" FROM SYSIBM.SYSDUMMY1) AS "Values"), 
"DT_Output_1" AS 
...
"DT_node_data_2" AS 
(SELECT "Values".nid AS nid, CAST("Values"."E" AS DOUBLE) AS "E" 
FROM (SELECT 3 AS nid, 95.83333333333333 AS "E" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 4 AS nid, 136.88888888888889 AS "E" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 6 AS nid, 235.25 AS "E" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 7 AS nid, 150.5 AS "E" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 10 AS nid, 162.04516129032257 AS "E" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 11 AS nid, 221.15686274509804 AS "E" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 13 AS nid, 298.1666666666667 AS "E" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 14 AS nid, 217.54545454545453 AS "E" FROM SYSIBM.SYSDUMMY1) AS "Values"), 
"DT_Output_2" AS 
...
"DT_node_data_3" AS 
(SELECT "Values".nid AS nid, CAST("Values"."E" AS DOUBLE) AS "E" 
FROM (SELECT 3 AS nid, 100.7 AS "E" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 4 AS nid, 253.0 AS "E" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 6 AS nid, 302.0 AS "E" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 7 AS nid, 158.17777777777778 AS "E" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 10 AS nid, 162.41176470588235 AS "E" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 11 AS nid, 232.24528301886792 AS "E" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 13 AS nid, 110.70833333333333 AS "E" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 14 AS nid, 246.66666666666666 AS "E" FROM SYSIBM.SYSDUMMY1) AS "Values"), 
"DT_Output_3" AS 
...
"DT_node_data_4" AS 
(SELECT "Values".nid AS nid, CAST("Values"."E" AS DOUBLE) AS "E" 
FROM (SELECT 3 AS nid, 104.24166666666666 AS "E" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 4 AS nid, 253.0 AS "E" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 6 AS nid, 192.66666666666666 AS "E" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 7 AS nid, 146.61855670103094 AS "E" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 10 AS nid, 68.0 AS "E" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 11 AS nid, 221.0 AS "E" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 13 AS nid, 146.4 AS "E" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 14 AS nid, 276.9848484848485 AS "E" FROM SYSIBM.SYSDUMMY1) AS "Values"), 
"DT_Output_4" AS 
...
"DT_node_data_5" AS 
(SELECT "Values".nid AS nid, CAST("Values"."E" AS DOUBLE) AS "E" 
FROM (SELECT 3 AS nid, 141.0 AS "E" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 4 AS nid, 218.10526315789474 AS "E" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 6 AS nid, 183.91666666666666 AS "E" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 7 AS nid, 113.04580152671755 AS "E" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 10 AS nid, 176.88888888888889 AS "E" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 11 AS nid, 87.84615384615384 AS "E" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 13 AS nid, 216.8230769230769 AS "E" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 14 AS nid, 301.4 AS "E" FROM SYSIBM.SYSDUMMY1) AS "Values"), 
"DT_Output_5" AS 
...
"DT_node_data_6" AS 
(SELECT "Values".nid AS nid, CAST("Values"."E" AS DOUBLE) AS "E" 
FROM (SELECT 3 AS nid, 124.10752688172043 AS "E" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 4 AS nid, 76.93181818181819 AS "E" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 6 AS nid, 228.33333333333334 AS "E" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 7 AS nid, 122.46153846153847 AS "E" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 10 AS nid, 172.0952380952381 AS "E" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 11 AS nid, 346.0 AS "E" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 13 AS nid, 128.0 AS "E" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 14 AS nid, 268.864406779661 AS "E" FROM SYSIBM.SYSDUMMY1) AS "Values"), 
"DT_Output_6" AS 
...
"DT_node_data_7" AS 
(SELECT "Values".nid AS nid, CAST("Values"."E" AS DOUBLE) AS "E" 
FROM (SELECT 3 AS nid, 75.9375 AS "E" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 4 AS nid, 125.2394366197183 AS "E" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 6 AS nid, 204.75 AS "E" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 7 AS nid, 257.5 AS "E" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 10 AS nid, 135.54310344827587 AS "E" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 11 AS nid, 266.22222222222223 AS "E" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 13 AS nid, 257.97297297297297 AS "E" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 14 AS nid, 159.33333333333334 AS "E" FROM SYSIBM.SYSDUMMY1) AS "Values"), 
"DT_Output_7" AS 
...
"DT_node_data_8" AS 
(SELECT "Values".nid AS nid, CAST("Values"."E" AS DOUBLE) AS "E" 
FROM (SELECT 3 AS nid, 120.27717391304348 AS "E" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 4 AS nid, 179.49382716049382 AS "E" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 6 AS nid, 102.0 AS "E" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 7 AS nid, 252.46808510638297 AS "E" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 10 AS nid, 296.0 AS "E" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 11 AS nid, 340.2307692307692 AS "E" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 13 AS nid, 128.0 AS "E" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 14 AS nid, 255.0 AS "E" FROM SYSIBM.SYSDUMMY1) AS "Values"), 
"DT_Output_8" AS 
...
"DT_node_data_9" AS 
(SELECT "Values".nid AS nid, CAST("Values"."E" AS DOUBLE) AS "E" 
FROM (SELECT 3 AS nid, 98.77669902912622 AS "E" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 4 AS nid, 250.0 AS "E" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 6 AS nid, 294.7142857142857 AS "E" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 7 AS nid, 166.1 AS "E" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 10 AS nid, 78.0 AS "E" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 11 AS nid, 140.6 AS "E" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 13 AS nid, 153.16666666666666 AS "E" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 14 AS nid, 270.6607142857143 AS "E" FROM SYSIBM.SYSDUMMY1) AS "Values"), 
"DT_Output_9" AS 
...
"DT_node_data_10" AS 
(SELECT "Values".nid AS nid, CAST("Values"."E" AS DOUBLE) AS "E" 
FROM (SELECT 3 AS nid, 133.5909090909091 AS "E" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 4 AS nid, 84.05263157894737 AS "E" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 5 AS nid, 253.0 AS "E" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 8 AS nid, 289.25 AS "E" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 9 AS nid, 152.87437185929647 AS "E" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 11 AS nid, 269.72340425531917 AS "E" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 12 AS nid, 134.5 AS "E" FROM SYSIBM.SYSDUMMY1) AS "Values"), 
"DT_Output_10" AS 
...
"DT_node_data_11" AS 
(SELECT "Values".nid AS nid, CAST("Values"."E" AS DOUBLE) AS "E" 
FROM (SELECT 3 AS nid, 126.87162162162163 AS "E" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 4 AS nid, 346.0 AS "E" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 6 AS nid, 251.56521739130434 AS "E" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 7 AS nid, 161.97368421052633 AS "E" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 10 AS nid, 133.33333333333334 AS "E" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 11 AS nid, 269.3114754098361 AS "E" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 13 AS nid, 236.58823529411765 AS "E" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 14 AS nid, 133.02380952380952 AS "E" FROM SYSIBM.SYSDUMMY1) AS "Values"), 
"DT_Output_11" AS 
...
"DT_node_data_12" AS 
(SELECT "Values".nid AS nid, CAST("Values"."E" AS DOUBLE) AS "E" 
FROM (SELECT 3 AS nid, 152.61421319796955 AS "E" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 4 AS nid, 85.84444444444445 AS "E" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 6 AS nid, 273.125 AS "E" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 7 AS nid, 346.0 AS "E" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 10 AS nid, 81.875 AS "E" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 11 AS nid, 137.875 AS "E" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 13 AS nid, 255.43589743589743 AS "E" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 14 AS nid, 84.0 AS "E" FROM SYSIBM.SYSDUMMY1) AS "Values"), 
"DT_Output_12" AS 
...
"DT_node_data_13" AS 
(SELECT "Values".nid AS nid, CAST("Values"."E" AS DOUBLE) AS "E" 
FROM (SELECT 3 AS nid, 228.0 AS "E" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 4 AS nid, 110.51162790697674 AS "E" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 6 AS nid, 192.25 AS "E" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 7 AS nid, 55.666666666666664 AS "E" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 10 AS nid, 213.66666666666666 AS "E" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 11 AS nid, 98.0 AS "E" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 13 AS nid, 133.25 AS "E" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 14 AS nid, 269.80645161290323 AS "E" FROM SYSIBM.SYSDUMMY1) AS "Values"), 
"DT_Output_13" AS 
...
"DT_node_data_14" AS 
(SELECT "Values".nid AS nid, CAST("Values"."E" AS DOUBLE) AS "E" 
FROM (SELECT 3 AS nid, 170.46153846153845 AS "E" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 4 AS nid, 90.02884615384616 AS "E" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 6 AS nid, 267.5 AS "E" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 7 AS nid, 140.875 AS "E" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 10 AS nid, 239.53658536585365 AS "E" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 11 AS nid, 153.47674418604652 AS "E" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 13 AS nid, 280.1509433962264 AS "E" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 14 AS nid, 84.0 AS "E" FROM SYSIBM.SYSDUMMY1) AS "Values"), 
"DT_Output_14" AS 
...
"DT_node_data_15" AS 
(SELECT "Values".nid AS nid, CAST("Values"."E" AS DOUBLE) AS "E" 
FROM (SELECT 3 AS nid, 160.54545454545453 AS "E" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 4 AS nid, 96.39506172839506 AS "E" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 6 AS nid, 165.86666666666667 AS "E" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 7 AS nid, 287.0 AS "E" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 10 AS nid, 160.95569620253164 AS "E" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 11 AS nid, 311.09090909090907 AS "E" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 13 AS nid, 259.07547169811323 AS "E" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 14 AS nid, 84.0 AS "E" FROM SYSIBM.SYSDUMMY1) AS "Values"), 
"DT_Output_15" AS 
...
FROM tmp_20180508183252_codegen_gocquk_quantiles AS "Quantiles"