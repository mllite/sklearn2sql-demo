...
-- Code For temporary table ##TMP_20180508183248_CODEGEN_RE5RKM_ADS_imp_1_OUT part 1. Create 


CREATE TABLE ##TMP_20180508183248_CODEGEN_RE5RKM_ADS_imp_1_OUT (
	[KEY] BIGINT NULL, 
...
-- Code For temporary table ##TMP_20180508183248_CODEGEN_RE5RKM_ADS_imp_1_OUT part 2. Populate

INSERT INTO ##TMP_20180508183248_CODEGEN_RE5RKM_ADS_imp_1_OUT ([KEY], impter_2, impter_3, impter_4, impter_5, impter_6, impter_7, impter_8, impter_9, impter_10, impter_11) SELECT [ADS_imp_1_OUT].[KEY], [ADS_imp_1_OUT].impter_2, [ADS_imp_1_OUT].impter_3, [ADS_imp_1_OUT].impter_4, [ADS_imp_1_OUT].impter_5, [ADS_imp_1_OUT].impter_6, [ADS_imp_1_OUT].impter_7, [ADS_imp_1_OUT].impter_8, [ADS_imp_1_OUT].impter_9, [ADS_imp_1_OUT].impter_10, [ADS_imp_1_OUT].impter_11 
...
-- Code For temporary table ##TMP_20180508183248_CODEGEN_IMDJZF_ADS_sca_2_OUT part 1. Create 


CREATE TABLE ##TMP_20180508183248_CODEGEN_IMDJZF_ADS_sca_2_OUT (
	[KEY] BIGINT NULL, 
	scaler_2 FLOAT NULL, 
	scaler_3 FLOAT NULL, 
	scaler_4 FLOAT NULL, 
...
FROM ##TMP_20180508183248_CODEGEN_RE5RKM_ADS_imp_1_OUT AS [ADS_imp_1_OUT]) AS [ADS_sca_2_OUT]

-- Code For temporary table ##TMP_20180508183248_CODEGEN_GB3O8P_Quantiles part 1. Create 


CREATE TABLE ##TMP_20180508183248_CODEGEN_GB3O8P_Quantiles (
	[KEY] BIGINT NULL, 
...
-- Code For temporary table ##TMP_20180508183248_CODEGEN_GB3O8P_Quantiles part 2. Populate
...
FROM ##TMP_20180508183248_CODEGEN_IMDJZF_ADS_sca_2_OUT AS [ADS_sca_2_OUT]), 
[DT_node_data] AS 
...
WHERE u1.[Estimator] >= u2.[Estimator] AND u1.[KEY] = u2.[KEY] GROUP BY u1.[KEY], u1.est_index, u1.[Estimator], u1.[Weight]) AS [CW])
 INSERT INTO ##TMP_20180508183248_CODEGEN_GB3O8P_Quantiles ([KEY], [Quantile]) SELECT [Quantiles].[KEY], [Quantiles].[Quantile] 
...
FROM ##TMP_20180508183248_CODEGEN_GB3O8P_Quantiles AS [Quantiles]