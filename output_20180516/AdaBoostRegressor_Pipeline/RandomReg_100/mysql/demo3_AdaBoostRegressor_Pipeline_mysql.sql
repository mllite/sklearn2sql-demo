...
-- Code For temporary table TMP_20180602144734_GYU_ADS_imp_1_OUT part 1. Create 


CREATE TEMPORARY TABLE `TMP_20180602144734_GYU_ADS_imp_1_OUT` (
	`KEY` BIGINT NOT NULL, 
	impter_2 DOUBLE, 
	impter_3 DOUBLE, 
	impter_4 DOUBLE, 
...
-- Code For temporary table TMP_20180602144734_GYU_ADS_imp_1_OUT part 3. Create Index 

CREATE INDEX `ix_TMP_20180602144734_GYU_ADS_imp_1_OUT_KEY` ON `TMP_20180602144734_GYU_ADS_imp_1_OUT` (`KEY`)

-- Code For temporary table TMP_20180602144734_BGB_ADS_sca_2_OUT part 1. Create 


CREATE TEMPORARY TABLE `TMP_20180602144734_BGB_ADS_sca_2_OUT` (
	`KEY` BIGINT NOT NULL, 
	scaler_2 DOUBLE, 
	scaler_3 DOUBLE, 
	scaler_4 DOUBLE, 
...
FROM `TMP_20180602144734_GYU_ADS_imp_1_OUT` AS `ADS_imp_1_OUT`) AS `ADS_sca_2_OUT`) AS `U`

-- Code For temporary table TMP_20180602144734_BGB_ADS_sca_2_OUT part 3. Create Index 

CREATE INDEX `ix_TMP_20180602144734_BGB_ADS_sca_2_OUT_KEY` ON `TMP_20180602144734_BGB_ADS_sca_2_OUT` (`KEY`)

-- Code For temporary table TMP_20180602144734_NSW_WE_B0 part 1. Create 


CREATE TEMPORARY TABLE `TMP_20180602144734_NSW_WE_B0` (
	`KEY` BIGINT, 
	`Estimator` DOUBLE, 
	`Weight` DOUBLE, 
	est_index BIGINT
...
-- Code For temporary table TMP_20180602144734_NSW_WE_B0 part 2. Populate

INSERT INTO `TMP_20180602144734_NSW_WE_B0` (`KEY`, `Estimator`, `Weight`, est_index) SELECT `U`.`KEY`, `U`.`Estimator`, `U`.`Weight`, `U`.est_index 
...
FROM `TMP_20180602144734_BGB_ADS_sca_2_OUT` AS `ADS_sca_2_OUT`), 
`DT_node_data` AS 
...
-- Code For temporary table TMP_20180602144734_UQC_WE_B1 part 1. Create 


CREATE TEMPORARY TABLE `TMP_20180602144734_UQC_WE_B1` (
	`KEY` BIGINT, 
	`Estimator` DOUBLE, 
	`Weight` DOUBLE, 
	est_index BIGINT
...
-- Code For temporary table TMP_20180602144734_UQC_WE_B1 part 2. Populate

INSERT INTO `TMP_20180602144734_UQC_WE_B1` (`KEY`, `Estimator`, `Weight`, est_index) SELECT `U`.`KEY`, `U`.`Estimator`, `U`.`Weight`, `U`.est_index 
...
-- Code For temporary table TMP_20180602144734_E09_Quantiles part 1. Create 


CREATE TEMPORARY TABLE `TMP_20180602144734_E09_Quantiles` (
	`KEY` BIGINT, 
	`Quantile` DOUBLE
)
...
-- Code For temporary table TMP_20180602144734_E09_Quantiles part 2. Populate

INSERT INTO `TMP_20180602144734_E09_Quantiles` (`KEY`, `Quantile`) SELECT `U`.`KEY`, `U`.`Quantile` 
...
FROM `TMP_20180602144734_NSW_WE_B0` AS `WE_B0` UNION ALL SELECT `WE_B1`.`KEY` AS `KEY`, `WE_B1`.`Estimator` AS `Estimator`, `WE_B1`.`Weight` AS `Weight`, `WE_B1`.est_index AS est_index 
FROM `TMP_20180602144734_UQC_WE_B1` AS `WE_B1`) AS `WE_EnsembleUnion`), 
...
FROM `TMP_20180602144734_E09_Quantiles` AS `Quantiles`