...
-- Code For temporary table tmp_20180508182452_codegen_vgq5vj_ads_imp_1_out part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180508182452_codegen_vgq5vj_ads_imp_1_out  (
	"KEY" BIGINT, 
...
-- Code For temporary table tmp_20180508182452_codegen_4klw74_ads_sca_2_out part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180508182452_codegen_4klw74_ads_sca_2_out  (
	"KEY" BIGINT, 
...
FROM tmp_20180508182452_codegen_vgq5vj_ads_imp_1_out AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT") AS "U"

-- Code For temporary table tmp_20180508182452_codegen_meh5qd_quantiles part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180508182452_codegen_meh5qd_quantiles  (
	"KEY" BIGINT, 
...
-- Code For temporary table tmp_20180508182452_codegen_meh5qd_quantiles part 2. Populate

INSERT INTO tmp_20180508182452_codegen_meh5qd_quantiles ("KEY", "Quantile") SELECT "U"."KEY", "U"."Quantile" 
...
FROM tmp_20180508182452_codegen_4klw74_ads_sca_2_out AS "ADS_sca_2_OUT"), 
dummy_cte AS 
...
FROM tmp_20180508182452_codegen_meh5qd_quantiles AS "Quantiles"