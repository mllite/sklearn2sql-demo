...
-- Code For temporary table 20180602_QC6_ADS_IMP_1_OUT part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "20180602_QC6_ADS_IMP_1_OUT" (
	"KEY" NUMBER(19), 
...
-- Code For temporary table 20180602_9E6_ADS_SCA_2_OUT part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "20180602_9E6_ADS_SCA_2_OUT" (
	"KEY" NUMBER(19), 
...
FROM "20180602_QC6_ADS_IMP_1_OUT" "ADS_imp_1_OUT") "ADS_sca_2_OUT") "U"

-- Code For temporary table TMP_20180602_MBV_QUANTILES part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180602_MBV_QUANTILES" (
	"KEY" NUMBER(19), 
...
-- Code For temporary table TMP_20180602_MBV_QUANTILES part 2. Populate

INSERT INTO "TMP_20180602_MBV_QUANTILES" ("KEY", "Quantile") SELECT "U"."KEY", "U"."Quantile" 
...
FROM "20180602_9E6_ADS_SCA_2_OUT" "ADS_sca_2_OUT"), 
"DT_node_data" AS 
...
FROM "TMP_20180602_MBV_QUANTILES" "Quantiles"