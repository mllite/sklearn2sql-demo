...
-- Code For temporary table TMP_20180602_4OO_ADS_IMP_1_OUT part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180602_4OO_ADS_IMP_1_OUT" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20180602_4OO_ADS_IMP_1_OUT part 3. Create Index 

CREATE INDEX "ix_TMP_20180602_4OO_ADS_76d0" ON "TMP_20180602_4OO_ADS_IMP_1_OUT" ("KEY")

-- Code For temporary table TMP_20180602_154_ADS_SCA_2_OUT part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180602_154_ADS_SCA_2_OUT" (
	"KEY" BIGINT NOT NULL, 
...
FROM "TMP_20180602_4OO_ADS_IMP_1_OUT" AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT") AS "U"

-- Code For temporary table TMP_20180602_154_ADS_SCA_2_OUT part 3. Create Index 

CREATE INDEX "ix_TMP_20180602_154_ADS_a3a4" ON "TMP_20180602_154_ADS_SCA_2_OUT" ("KEY")

-- Code For temporary table TMP_20180602_I05_QUANTILES part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180602_I05_QUANTILES" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20180602_I05_QUANTILES part 2. Populate

INSERT INTO "TMP_20180602_I05_QUANTILES" ("KEY", "Quantile") SELECT "U"."KEY", "U"."Quantile" 
...
FROM "TMP_20180602_154_ADS_SCA_2_OUT" AS "ADS_sca_2_OUT"), 
"DT_node_data" AS 
...
-- Code For temporary table TMP_20180602_I05_QUANTILES part 3. Create Index 

CREATE INDEX "ix_TMP_20180602_I05_QUA_27bb" ON "TMP_20180602_I05_QUANTILES" ("KEY")

-- Model deployment code

SELECT "Quantiles"."KEY" AS "KEY", "Quantiles"."Quantile" AS "Estimator" 
FROM "TMP_20180602_I05_QUANTILES" AS "Quantiles"