...
-- Code For temporary table TMP_20180516_CODEGEN_JJYE6P_ADS part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180516_CODEGEN_JJYE6P_ADS" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20180516_CODEGEN_JJYE6P_ADS part 3. Create Index 

CREATE INDEX "ix_TMP_20180516_CODEGEN_fbe7" ON "TMP_20180516_CODEGEN_JJYE6P_ADS" ("KEY")

-- Code For temporary table TMP_20180516_CODEGEN_0A26PY_ADS part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180516_CODEGEN_0A26PY_ADS" (
	"KEY" BIGINT NOT NULL, 
...
FROM "TMP_20180516_CODEGEN_JJYE6P_ADS" AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT") AS "U"

-- Code For temporary table TMP_20180516_CODEGEN_0A26PY_ADS part 3. Create Index 

CREATE INDEX "ix_TMP_20180516_CODEGEN_e31e" ON "TMP_20180516_CODEGEN_0A26PY_ADS" ("KEY")

-- Code For temporary table TMP_20180516_CODEGEN_UI7WXG_QUA part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180516_CODEGEN_UI7WXG_QUA" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20180516_CODEGEN_UI7WXG_QUA part 2. Populate

INSERT INTO "TMP_20180516_CODEGEN_UI7WXG_QUA" ("KEY", "Quantile") SELECT "U"."KEY", "U"."Quantile" 
...
FROM "TMP_20180516_CODEGEN_0A26PY_ADS" AS "ADS_sca_2_OUT"), 
"DT_node_data" AS 
...
-- Code For temporary table TMP_20180516_CODEGEN_UI7WXG_QUA part 3. Create Index 

CREATE INDEX "ix_TMP_20180516_CODEGEN_306e" ON "TMP_20180516_CODEGEN_UI7WXG_QUA" ("KEY")

-- Model deployment code

SELECT "Quantiles"."KEY" AS "KEY", "Quantiles"."Quantile" AS "Estimator" 
FROM "TMP_20180516_CODEGEN_UI7WXG_QUA" AS "Quantiles"