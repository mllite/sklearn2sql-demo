...
-- Code For temporary table ##TMP_20180516114046_CODEGEN_I0281P_ADS_imp_1_OUT part 1. Create 


CREATE TABLE ##TMP_20180516114046_CODEGEN_I0281P_ADS_imp_1_OUT (
	[KEY] BIGINT NULL, 
...
-- Code For temporary table ##TMP_20180516114046_CODEGEN_J17SEG_ADS_sca_2_OUT part 1. Create 


CREATE TABLE ##TMP_20180516114046_CODEGEN_J17SEG_ADS_sca_2_OUT (
	[KEY] BIGINT NULL, 
	scaler_2 FLOAT NULL, 
	scaler_3 FLOAT NULL, 
	scaler_4 FLOAT NULL, 
...
FROM ##TMP_20180516114046_CODEGEN_I0281P_ADS_imp_1_OUT AS [ADS_imp_1_OUT]) AS [ADS_sca_2_OUT]

-- Code For temporary table ##TMP_20180516114047_CODEGEN_RX3PKW_Quantiles part 1. Create 


CREATE TABLE ##TMP_20180516114047_CODEGEN_RX3PKW_Quantiles (
	[KEY] BIGINT NULL, 
...
-- Code For temporary table ##TMP_20180516114047_CODEGEN_RX3PKW_Quantiles part 2. Populate
...
FROM ##TMP_20180516114046_CODEGEN_J17SEG_ADS_sca_2_OUT AS [ADS_sca_2_OUT]), 
[DT_node_data] AS 
...
WHERE u1.[Estimator] >= u2.[Estimator] AND u1.[KEY] = u2.[KEY] GROUP BY u1.[KEY], u1.est_index, u1.[Estimator], u1.[Weight]) AS [CW])
 INSERT INTO ##TMP_20180516114047_CODEGEN_RX3PKW_Quantiles ([KEY], [Quantile]) SELECT [Quantiles].[KEY], [Quantiles].[Quantile] 
...
FROM ##TMP_20180516114047_CODEGEN_RX3PKW_Quantiles AS [Quantiles]