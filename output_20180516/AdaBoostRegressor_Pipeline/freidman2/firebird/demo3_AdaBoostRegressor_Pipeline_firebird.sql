...
-- Code For temporary table TMP_20180508184715_CODEGEN_24GC part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508184715_CODEGEN_24GC" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20180508184715_CODEGEN_24GC part 2. Populate

INSERT INTO "TMP_20180508184715_CODEGEN_24GC" ("KEY", imputer_output_2, imputer_output_3, imputer_output_4, imputer_output_5) SELECT "U"."KEY", "U".imputer_output_2, "U".imputer_output_3, "U".imputer_output_4, "U".imputer_output_5 
...
-- Code For temporary table TMP_20180508184715_CODEGEN_24GC part 3. Create Index 

CREATE INDEX "ix_TMP_20180508184715_C_e980" ON "TMP_20180508184715_CODEGEN_24GC" ("KEY")

-- Code For temporary table TMP_20180508184715_CODEGEN_E7SC part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508184715_CODEGEN_E7SC" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20180508184715_CODEGEN_E7SC part 2. Populate

INSERT INTO "TMP_20180508184715_CODEGEN_E7SC" ("KEY", scaler_output_2, scaler_output_3, scaler_output_4, scaler_output_5) SELECT "U"."KEY", "U".scaler_output_2, "U".scaler_output_3, "U".scaler_output_4, "U".scaler_output_5 
...
FROM "TMP_20180508184715_CODEGEN_24GC" AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT") AS "U"

-- Code For temporary table TMP_20180508184715_CODEGEN_E7SC part 3. Create Index 

CREATE INDEX "ix_TMP_20180508184715_C_3a69" ON "TMP_20180508184715_CODEGEN_E7SC" ("KEY")

-- Code For temporary table TMP_20180508184715_CODEGEN_980F part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508184715_CODEGEN_980F" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20180508184715_CODEGEN_980F part 2. Populate

INSERT INTO "TMP_20180508184715_CODEGEN_980F" ("KEY", "Quantile") SELECT "U"."KEY", "U"."Quantile" 
...
FROM "TMP_20180508184715_CODEGEN_E7SC" AS "ADS_sca_2_OUT"), 
"DT_node_data" AS 
...
-- Code For temporary table TMP_20180508184715_CODEGEN_980F part 3. Create Index 

CREATE INDEX "ix_TMP_20180508184715_C_f565" ON "TMP_20180508184715_CODEGEN_980F" ("KEY")

-- Model deployment code

SELECT "Quantiles"."KEY" AS "KEY", "Quantiles"."Quantile" AS "Estimator" 
FROM "TMP_20180508184715_CODEGEN_980F" AS "Quantiles"