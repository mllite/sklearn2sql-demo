...
-- Code For temporary table tmp_20180508184718_codegen_gjm3bo_ads_imp_1_out part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180508184718_codegen_gjm3bo_ads_imp_1_out (
	"KEY" BIGINT, 
...
-- Code For temporary table tmp_20180508184718_codegen_gjm3bo_ads_imp_1_out part 2. Populate

INSERT INTO tmp_20180508184718_codegen_gjm3bo_ads_imp_1_out SELECT "ADS_imp_1_OUT"."KEY", "ADS_imp_1_OUT".imputer_output_2, "ADS_imp_1_OUT".imputer_output_3, "ADS_imp_1_OUT".imputer_output_4, "ADS_imp_1_OUT".imputer_output_5 
...
-- Code For temporary table tmp_20180508184718_codegen_keeuj6_ads_sca_2_out part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180508184718_codegen_keeuj6_ads_sca_2_out (
	"KEY" BIGINT, 
...
-- Code For temporary table tmp_20180508184718_codegen_keeuj6_ads_sca_2_out part 2. Populate

INSERT INTO tmp_20180508184718_codegen_keeuj6_ads_sca_2_out SELECT "ADS_sca_2_OUT"."KEY", "ADS_sca_2_OUT".scaler_output_2, "ADS_sca_2_OUT".scaler_output_3, "ADS_sca_2_OUT".scaler_output_4, "ADS_sca_2_OUT".scaler_output_5 
...
FROM tmp_20180508184718_codegen_gjm3bo_ads_imp_1_out AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT"

-- Code For temporary table tmp_20180508184718_codegen_kmjgp5_quantiles part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180508184718_codegen_kmjgp5_quantiles (
	"KEY" BIGINT, 
	"Quantile" DOUBLE
)
...
-- Code For temporary table tmp_20180508184718_codegen_kmjgp5_quantiles part 2. Populate

INSERT INTO tmp_20180508184718_codegen_kmjgp5_quantiles WITH "DT_node_lookup" AS 
...
FROM tmp_20180508184718_codegen_keeuj6_ads_sca_2_out AS "ADS_sca_2_OUT"), 
"DT_node_data" AS 
...
FROM tmp_20180508184718_codegen_kmjgp5_quantiles AS "Quantiles"