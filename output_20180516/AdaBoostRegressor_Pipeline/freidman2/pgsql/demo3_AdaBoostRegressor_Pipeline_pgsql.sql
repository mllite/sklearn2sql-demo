...
-- Code For temporary table TMP_20180516121121_CODEGEN_NFTOQ5_ADS_imp_1_OUT part 1. Create 


CREATE TEMPORARY TABLE "TMP_20180516121121_CODEGEN_NFTOQ5_ADS_imp_1_OUT" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20180516121121_CODEGEN_NFTOQ5_ADS_imp_1_OUT part 2. Populate

INSERT INTO "TMP_20180516121121_CODEGEN_NFTOQ5_ADS_imp_1_OUT" ("KEY", imputer_output_2, imputer_output_3, imputer_output_4, imputer_output_5) SELECT "ADS_imp_1_OUT"."KEY", "ADS_imp_1_OUT".imputer_output_2, "ADS_imp_1_OUT".imputer_output_3, "ADS_imp_1_OUT".imputer_output_4, "ADS_imp_1_OUT".imputer_output_5 
...
-- Code For temporary table TMP_20180516121121_CODEGEN_NFTOQ5_ADS_imp_1_OUT part 3. Create Index 

CREATE INDEX "ix_TMP_20180516121121_CODEGEN_NFTOQ5_ADS_imp_1_OUT_KEY" ON "TMP_20180516121121_CODEGEN_NFTOQ5_ADS_imp_1_OUT" ("KEY")

-- Code For temporary table TMP_20180516121121_CODEGEN_BR9OVX_ADS_sca_2_OUT part 1. Create 


CREATE TEMPORARY TABLE "TMP_20180516121121_CODEGEN_BR9OVX_ADS_sca_2_OUT" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20180516121121_CODEGEN_BR9OVX_ADS_sca_2_OUT part 2. Populate

INSERT INTO "TMP_20180516121121_CODEGEN_BR9OVX_ADS_sca_2_OUT" ("KEY", scaler_output_2, scaler_output_3, scaler_output_4, scaler_output_5) SELECT "ADS_sca_2_OUT"."KEY", "ADS_sca_2_OUT".scaler_output_2, "ADS_sca_2_OUT".scaler_output_3, "ADS_sca_2_OUT".scaler_output_4, "ADS_sca_2_OUT".scaler_output_5 
...
FROM "TMP_20180516121121_CODEGEN_NFTOQ5_ADS_imp_1_OUT" AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT"

-- Code For temporary table TMP_20180516121121_CODEGEN_BR9OVX_ADS_sca_2_OUT part 3. Create Index 

CREATE INDEX "ix_TMP_20180516121121_CODEGEN_BR9OVX_ADS_sca_2_OUT_KEY" ON "TMP_20180516121121_CODEGEN_BR9OVX_ADS_sca_2_OUT" ("KEY")

-- Code For temporary table TMP_20180516121121_CODEGEN_UQ7S01_WE_B0 part 1. Create 


CREATE TEMPORARY TABLE "TMP_20180516121121_CODEGEN_UQ7S01_WE_B0" (
	"KEY" BIGINT, 
	"Estimator" FLOAT, 
	"Weight" FLOAT, 
	est_index BIGINT
...
-- Code For temporary table TMP_20180516121121_CODEGEN_UQ7S01_WE_B0 part 2. Populate
...
FROM "TMP_20180516121121_CODEGEN_BR9OVX_ADS_sca_2_OUT" AS "ADS_sca_2_OUT"), 
"DT_node_data" AS 
...
FROM "DT_Output_9")
 INSERT INTO "TMP_20180516121121_CODEGEN_UQ7S01_WE_B0" ("KEY", "Estimator", "Weight", est_index) SELECT "WE_B0"."KEY", "WE_B0"."Estimator", "WE_B0"."Weight", "WE_B0".est_index 
...
-- Code For temporary table TMP_20180516121121_CODEGEN_XTUDJY_WE_B1 part 1. Create 


CREATE TEMPORARY TABLE "TMP_20180516121121_CODEGEN_XTUDJY_WE_B1" (
	"KEY" BIGINT, 
	"Estimator" FLOAT, 
	"Weight" FLOAT, 
	est_index BIGINT
...
-- Code For temporary table TMP_20180516121121_CODEGEN_XTUDJY_WE_B1 part 2. Populate
...
FROM "DT_Output_15")
 INSERT INTO "TMP_20180516121121_CODEGEN_XTUDJY_WE_B1" ("KEY", "Estimator", "Weight", est_index) SELECT "WE_B1"."KEY", "WE_B1"."Estimator", "WE_B1"."Weight", "WE_B1".est_index 
...
-- Code For temporary table TMP_20180516121121_CODEGEN_6915JI_Quantiles part 1. Create 


CREATE TEMPORARY TABLE "TMP_20180516121121_CODEGEN_6915JI_Quantiles" (
	"KEY" BIGINT, 
	"Quantile" FLOAT
)
...
-- Code For temporary table TMP_20180516121121_CODEGEN_6915JI_Quantiles part 2. Populate
...
FROM "TMP_20180516121121_CODEGEN_UQ7S01_WE_B0" AS "WE_B0" UNION ALL SELECT "WE_B1"."KEY" AS "KEY", "WE_B1"."Estimator" AS "Estimator", "WE_B1"."Weight" AS "Weight", "WE_B1".est_index AS est_index 
FROM "TMP_20180516121121_CODEGEN_XTUDJY_WE_B1" AS "WE_B1") AS "WE_EnsembleUnion"), 
...
WHERE u1."Estimator" >= u2."Estimator" AND u1."KEY" = u2."KEY" GROUP BY u1."KEY", u1.est_index, u1."Estimator", u1."Weight") AS "CW")
 INSERT INTO "TMP_20180516121121_CODEGEN_6915JI_Quantiles" ("KEY", "Quantile") SELECT "Quantiles"."KEY", "Quantiles"."Quantile" 
...
FROM "TMP_20180516121121_CODEGEN_6915JI_Quantiles" AS "Quantiles"