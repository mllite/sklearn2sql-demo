...
-- Code For temporary table tmp_20180508194640_codegen_ueupgd_ads_imp_1_out part 1. Create 


CREATE TABLE tmp_20180508194640_codegen_ueupgd_ads_imp_1_out (
	`KEY` BIGINT, 
...
-- Code For temporary table tmp_20180508194640_codegen_ueupgd_ads_imp_1_out part 2. Populate

INSERT INTO tmp_20180508194640_codegen_ueupgd_ads_imp_1_out (`KEY`, imputer_output_2, imputer_output_3, imputer_output_4, imputer_output_5) SELECT `ADS_imp_1_OUT`.`KEY`, `ADS_imp_1_OUT`.imputer_output_2, `ADS_imp_1_OUT`.imputer_output_3, `ADS_imp_1_OUT`.imputer_output_4, `ADS_imp_1_OUT`.imputer_output_5 
...
-- Code For temporary table tmp_20180508194640_codegen_z6kp92_ads_sca_2_out part 1. Create 


CREATE TABLE tmp_20180508194640_codegen_z6kp92_ads_sca_2_out (
	`KEY` BIGINT, 
...
-- Code For temporary table tmp_20180508194640_codegen_z6kp92_ads_sca_2_out part 2. Populate

INSERT INTO tmp_20180508194640_codegen_z6kp92_ads_sca_2_out (`KEY`, scaler_output_2, scaler_output_3, scaler_output_4, scaler_output_5) SELECT `ADS_sca_2_OUT`.`KEY`, `ADS_sca_2_OUT`.scaler_output_2, `ADS_sca_2_OUT`.scaler_output_3, `ADS_sca_2_OUT`.scaler_output_4, `ADS_sca_2_OUT`.scaler_output_5 
...
FROM tmp_20180508194640_codegen_ueupgd_ads_imp_1_out AS `ADS_imp_1_OUT`) AS `ADS_sca_2_OUT`

-- Code For temporary table tmp_20180508194640_codegen_4bedj4_quantiles part 1. Create 


CREATE TABLE tmp_20180508194640_codegen_4bedj4_quantiles (
	`KEY` BIGINT, 
	`Quantile` DOUBLE
)
...
-- Code For temporary table tmp_20180508194640_codegen_4bedj4_quantiles part 2. Populate
...
FROM tmp_20180508194640_codegen_z6kp92_ads_sca_2_out AS `ADS_sca_2_OUT`), 
`DT_node_data` AS 
...
WHERE u1.`Estimator` >= u2.`Estimator` AND u1.`KEY` = u2.`KEY` GROUP BY u1.`KEY`, u1.est_index, u1.`Estimator`, u1.`Weight`) AS `CW`)
 INSERT INTO tmp_20180508194640_codegen_4bedj4_quantiles (`KEY`, `Quantile`) SELECT `Quantiles`.`KEY`, `Quantiles`.`Quantile` 
...
FROM tmp_20180508194640_codegen_4bedj4_quantiles AS `Quantiles`