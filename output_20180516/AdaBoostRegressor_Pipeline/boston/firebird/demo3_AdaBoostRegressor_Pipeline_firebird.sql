...
-- Code For temporary table TMP_20180508182858_CODEGEN_4ZJV part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508182858_CODEGEN_4ZJV" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20180508182858_CODEGEN_4ZJV part 2. Populate

INSERT INTO "TMP_20180508182858_CODEGEN_4ZJV" ("KEY", impter_2, impter_3, impter_4, impter_5, impter_6, impter_7, impter_8, impter_9, impter_10, impter_11, impter_12, impter_13, impter_14) SELECT "U"."KEY", "U".impter_2, "U".impter_3, "U".impter_4, "U".impter_5, "U".impter_6, "U".impter_7, "U".impter_8, "U".impter_9, "U".impter_10, "U".impter_11, "U".impter_12, "U".impter_13, "U".impter_14 
...
-- Code For temporary table TMP_20180508182858_CODEGEN_4ZJV part 3. Create Index 

CREATE INDEX "ix_TMP_20180508182858_C_6fd3" ON "TMP_20180508182858_CODEGEN_4ZJV" ("KEY")

-- Code For temporary table TMP_20180508182858_CODEGEN_UHZJ part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508182858_CODEGEN_UHZJ" (
	"KEY" BIGINT NOT NULL, 
...
FROM "TMP_20180508182858_CODEGEN_4ZJV" AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT") AS "U"

-- Code For temporary table TMP_20180508182858_CODEGEN_UHZJ part 3. Create Index 

CREATE INDEX "ix_TMP_20180508182858_C_2f14" ON "TMP_20180508182858_CODEGEN_UHZJ" ("KEY")

-- Code For temporary table TMP_20180508182859_CODEGEN_BEPM part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508182859_CODEGEN_BEPM" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20180508182859_CODEGEN_BEPM part 2. Populate

INSERT INTO "TMP_20180508182859_CODEGEN_BEPM" ("KEY", "Quantile") SELECT "U"."KEY", "U"."Quantile" 
...
FROM "TMP_20180508182858_CODEGEN_UHZJ" AS "ADS_sca_2_OUT"), 
"DT_node_data" AS 
(SELECT "Values".nid AS nid, CAST("Values"."E" AS DOUBLE PRECISION) AS "E" 
FROM (SELECT 3 AS nid, 21.239873417721512 AS "E" FROM rdb$database UNION ALL SELECT 4 AS nid, 26.69473684210526 AS "E" FROM rdb$database UNION ALL SELECT 6 AS nid, 18.847619047619048 AS "E" FROM rdb$database UNION ALL SELECT 7 AS nid, 13.593814432989692 AS "E" FROM rdb$database UNION ALL SELECT 10 AS nid, 31.662500000000005 AS "E" FROM rdb$database UNION ALL SELECT 11 AS nid, 20.266666666666666 AS "E" FROM rdb$database UNION ALL SELECT 13 AS nid, 47.33333333333333 AS "E" FROM rdb$database UNION ALL SELECT 14 AS nid, 21.9 AS "E" FROM rdb$database) AS "Values"), 
"DT_Output" AS 
...
"DT_node_data_1" AS 
(SELECT "Values".nid AS nid, CAST("Values"."E" AS DOUBLE PRECISION) AS "E" 
FROM (SELECT 3 AS nid, 25.84343434343436 AS "E" FROM rdb$database UNION ALL SELECT 4 AS nid, 42.544000000000004 AS "E" FROM rdb$database UNION ALL SELECT 6 AS nid, 39.333333333333336 AS "E" FROM rdb$database UNION ALL SELECT 7 AS nid, 50.0 AS "E" FROM rdb$database UNION ALL SELECT 10 AS nid, 20.889108910891103 AS "E" FROM rdb$database UNION ALL SELECT 11 AS nid, 29.925 AS "E" FROM rdb$database UNION ALL SELECT 13 AS nid, 18.241071428571438 AS "E" FROM rdb$database UNION ALL SELECT 14 AS nid, 13.107777777777775 AS "E" FROM rdb$database) AS "Values"), 
"DT_Output_1" AS 
...
"DT_node_data_2" AS 
(SELECT "Values".nid AS nid, CAST("Values"."E" AS DOUBLE PRECISION) AS "E" 
FROM (SELECT 3 AS nid, 50.0 AS "E" FROM rdb$database UNION ALL SELECT 4 AS nid, 27.253521126760557 AS "E" FROM rdb$database UNION ALL SELECT 6 AS nid, 46.27435897435897 AS "E" FROM rdb$database UNION ALL SELECT 7 AS nid, 21.9 AS "E" FROM rdb$database UNION ALL SELECT 10 AS nid, 23.99310344827586 AS "E" FROM rdb$database UNION ALL SELECT 11 AS nid, 19.357142857142875 AS "E" FROM rdb$database UNION ALL SELECT 13 AS nid, 10.359999999999998 AS "E" FROM rdb$database UNION ALL SELECT 14 AS nid, 16.58611111111111 AS "E" FROM rdb$database) AS "Values"), 
"DT_Output_2" AS 
...
"DT_node_data_3" AS 
(SELECT "Values".nid AS nid, CAST("Values"."E" AS DOUBLE PRECISION) AS "E" 
FROM (SELECT 3 AS nid, 23.897058823529413 AS "E" FROM rdb$database UNION ALL SELECT 4 AS nid, 32.84594594594594 AS "E" FROM rdb$database UNION ALL SELECT 6 AS nid, 45.74 AS "E" FROM rdb$database UNION ALL SELECT 7 AS nid, 21.9 AS "E" FROM rdb$database UNION ALL SELECT 9 AS nid, 50.0 AS "E" FROM rdb$database UNION ALL SELECT 11 AS nid, 21.02447916666667 AS "E" FROM rdb$database UNION ALL SELECT 12 AS nid, 13.23636363636364 AS "E" FROM rdb$database) AS "Values"), 
"DT_Output_3" AS 
...
"DT_node_data_4" AS 
(SELECT "Values".nid AS nid, CAST("Values"."E" AS DOUBLE PRECISION) AS "E" 
FROM (SELECT 2 AS nid, 50.0 AS "E" FROM rdb$database UNION ALL SELECT 4 AS nid, 20.112244897959176 AS "E" FROM rdb$database UNION ALL SELECT 5 AS nid, 12.72258064516128 AS "E" FROM rdb$database UNION ALL SELECT 8 AS nid, 35.90784313725492 AS "E" FROM rdb$database UNION ALL SELECT 9 AS nid, 49.30833333333334 AS "E" FROM rdb$database UNION ALL SELECT 11 AS nid, 29.792537313432838 AS "E" FROM rdb$database UNION ALL SELECT 12 AS nid, 15.984615384615385 AS "E" FROM rdb$database) AS "Values"), 
"DT_Output_4" AS 
...
"DT_node_data_5" AS 
(SELECT "Values".nid AS nid, CAST("Values"."E" AS DOUBLE PRECISION) AS "E" 
FROM (SELECT 3 AS nid, 50.0 AS "E" FROM rdb$database UNION ALL SELECT 4 AS nid, 25.989189189189197 AS "E" FROM rdb$database UNION ALL SELECT 6 AS nid, 47.066666666666656 AS "E" FROM rdb$database UNION ALL SELECT 7 AS nid, 21.899999999999995 AS "E" FROM rdb$database UNION ALL SELECT 10 AS nid, 30.8125 AS "E" FROM rdb$database UNION ALL SELECT 11 AS nid, 21.44852941176471 AS "E" FROM rdb$database UNION ALL SELECT 13 AS nid, 18.38139534883721 AS "E" FROM rdb$database UNION ALL SELECT 14 AS nid, 11.786842105263156 AS "E" FROM rdb$database) AS "Values"), 
"DT_Output_5" AS 
...
"DT_node_data_6" AS 
(SELECT "Values".nid AS nid, CAST("Values"."E" AS DOUBLE PRECISION) AS "E" 
FROM (SELECT 3 AS nid, 50.0 AS "E" FROM rdb$database UNION ALL SELECT 4 AS nid, 13.8 AS "E" FROM rdb$database UNION ALL SELECT 6 AS nid, 22.583035714285707 AS "E" FROM rdb$database UNION ALL SELECT 7 AS nid, 13.675177304964542 AS "E" FROM rdb$database UNION ALL SELECT 10 AS nid, 50.0 AS "E" FROM rdb$database UNION ALL SELECT 11 AS nid, 29.737931034482752 AS "E" FROM rdb$database UNION ALL SELECT 13 AS nid, 46.61249999999999 AS "E" FROM rdb$database UNION ALL SELECT 14 AS nid, 21.899999999999995 AS "E" FROM rdb$database) AS "Values"), 
"DT_Output_6" AS 
...
"DT_node_data_7" AS 
(SELECT "Values".nid AS nid, CAST("Values"."E" AS DOUBLE PRECISION) AS "E" 
FROM (SELECT 3 AS nid, 50.0 AS "E" FROM rdb$database UNION ALL SELECT 4 AS nid, 27.346753246753245 AS "E" FROM rdb$database UNION ALL SELECT 6 AS nid, 49.07000000000001 AS "E" FROM rdb$database UNION ALL SELECT 7 AS nid, 36.6294117647059 AS "E" FROM rdb$database UNION ALL SELECT 10 AS nid, 50.0 AS "E" FROM rdb$database UNION ALL SELECT 11 AS nid, 19.508629441624368 AS "E" FROM rdb$database UNION ALL SELECT 13 AS nid, 16.7 AS "E" FROM rdb$database UNION ALL SELECT 14 AS nid, 7.940384615384612 AS "E" FROM rdb$database) AS "Values"), 
"DT_Output_7" AS 
...
"DT_node_data_8" AS 
(SELECT "Values".nid AS nid, CAST("Values"."E" AS DOUBLE PRECISION) AS "E" 
FROM (SELECT 3 AS nid, 33.931428571428576 AS "E" FROM rdb$database UNION ALL SELECT 4 AS nid, 26.950000000000003 AS "E" FROM rdb$database UNION ALL SELECT 6 AS nid, 21.9 AS "E" FROM rdb$database UNION ALL SELECT 7 AS nid, 46.0483870967742 AS "E" FROM rdb$database UNION ALL SELECT 10 AS nid, 50.0 AS "E" FROM rdb$database UNION ALL SELECT 11 AS nid, 20.819565217391304 AS "E" FROM rdb$database UNION ALL SELECT 13 AS nid, 17.57 AS "E" FROM rdb$database UNION ALL SELECT 14 AS nid, 8.98846153846154 AS "E" FROM rdb$database) AS "Values"), 
"DT_Output_8" AS 
...
"DT_node_data_9" AS 
(SELECT "Values".nid AS nid, CAST("Values"."E" AS DOUBLE PRECISION) AS "E" 
FROM (SELECT 3 AS nid, 20.561111111111103 AS "E" FROM rdb$database UNION ALL SELECT 4 AS nid, 28.09016393442622 AS "E" FROM rdb$database UNION ALL SELECT 6 AS nid, 34.17352941176472 AS "E" FROM rdb$database UNION ALL SELECT 7 AS nid, 44.3076923076923 AS "E" FROM rdb$database UNION ALL SELECT 10 AS nid, 26.61818181818182 AS "E" FROM rdb$database UNION ALL SELECT 11 AS nid, 50.0 AS "E" FROM rdb$database UNION ALL SELECT 13 AS nid, 50.0 AS "E" FROM rdb$database UNION ALL SELECT 14 AS nid, 15.484905660377331 AS "E" FROM rdb$database) AS "Values"), 
"DT_Output_9" AS 
...
"DT_node_data_10" AS 
(SELECT "Values".nid AS nid, CAST("Values"."E" AS DOUBLE PRECISION) AS "E" 
FROM (SELECT 3 AS nid, 24.22000000000001 AS "E" FROM rdb$database UNION ALL SELECT 4 AS nid, 32.733707865168554 AS "E" FROM rdb$database UNION ALL SELECT 6 AS nid, 41.9923076923077 AS "E" FROM rdb$database UNION ALL SELECT 7 AS nid, 49.800000000000004 AS "E" FROM rdb$database UNION ALL SELECT 10 AS nid, 12.166666666666664 AS "E" FROM rdb$database UNION ALL SELECT 11 AS nid, 22.22214765100673 AS "E" FROM rdb$database UNION ALL SELECT 13 AS nid, 14.148000000000007 AS "E" FROM rdb$database UNION ALL SELECT 14 AS nid, 7.2631578947368425 AS "E" FROM rdb$database) AS "Values"), 
"DT_Output_10" AS 
...
"DT_node_data_11" AS 
(SELECT "Values".nid AS nid, CAST("Values"."E" AS DOUBLE PRECISION) AS "E" 
FROM (SELECT 3 AS nid, 44.93541666666667 AS "E" FROM rdb$database UNION ALL SELECT 4 AS nid, 31.890449438202264 AS "E" FROM rdb$database UNION ALL SELECT 6 AS nid, 12.39714285714285 AS "E" FROM rdb$database UNION ALL SELECT 7 AS nid, 22.46666666666667 AS "E" FROM rdb$database UNION ALL SELECT 10 AS nid, 12.98235294117647 AS "E" FROM rdb$database UNION ALL SELECT 11 AS nid, 23.597777777777786 AS "E" FROM rdb$database UNION ALL SELECT 13 AS nid, 9.455882352941174 AS "E" FROM rdb$database UNION ALL SELECT 14 AS nid, 21.25714285714286 AS "E" FROM rdb$database) AS "Values"), 
"DT_Output_11" AS 
...
"DT_node_data_12" AS 
(SELECT "Values".nid AS nid, CAST("Values"."E" AS DOUBLE PRECISION) AS "E" 
FROM (SELECT 3 AS nid, 50.0 AS "E" FROM rdb$database UNION ALL SELECT 4 AS nid, 13.8 AS "E" FROM rdb$database UNION ALL SELECT 6 AS nid, 15.877241379310343 AS "E" FROM rdb$database UNION ALL SELECT 7 AS nid, 24.18686131386861 AS "E" FROM rdb$database UNION ALL SELECT 10 AS nid, 34.71515151515151 AS "E" FROM rdb$database UNION ALL SELECT 11 AS nid, 15.0 AS "E" FROM rdb$database UNION ALL SELECT 13 AS nid, 21.899999999999995 AS "E" FROM rdb$database UNION ALL SELECT 14 AS nid, 46.337288135593205 AS "E" FROM rdb$database) AS "Values"), 
"DT_Output_12" AS 
...
"DT_node_data_13" AS 
(SELECT "Values".nid AS nid, CAST("Values"."E" AS DOUBLE PRECISION) AS "E" 
FROM (SELECT 3 AS nid, 21.5 AS "E" FROM rdb$database UNION ALL SELECT 4 AS nid, 26.628125 AS "E" FROM rdb$database UNION ALL SELECT 6 AS nid, 45.58874999999999 AS "E" FROM rdb$database UNION ALL SELECT 7 AS nid, 35.06730769230769 AS "E" FROM rdb$database UNION ALL SELECT 10 AS nid, 50.0 AS "E" FROM rdb$database UNION ALL SELECT 11 AS nid, 13.8 AS "E" FROM rdb$database UNION ALL SELECT 13 AS nid, 19.993333333333332 AS "E" FROM rdb$database UNION ALL SELECT 14 AS nid, 10.82205882352941 AS "E" FROM rdb$database) AS "Values"), 
"DT_Output_13" AS 
...
"DT_node_data_14" AS 
(SELECT "Values".nid AS nid, CAST("Values"."E" AS DOUBLE PRECISION) AS "E" 
FROM (SELECT 3 AS nid, 49.655102040816324 AS "E" FROM rdb$database UNION ALL SELECT 4 AS nid, 39.29354838709678 AS "E" FROM rdb$database UNION ALL SELECT 6 AS nid, 45.122727272727275 AS "E" FROM rdb$database UNION ALL SELECT 7 AS nid, 29.700000000000006 AS "E" FROM rdb$database UNION ALL SELECT 10 AS nid, 50.0 AS "E" FROM rdb$database UNION ALL SELECT 11 AS nid, 13.8 AS "E" FROM rdb$database UNION ALL SELECT 13 AS nid, 20.848407643312097 AS "E" FROM rdb$database UNION ALL SELECT 14 AS nid, 11.453030303030296 AS "E" FROM rdb$database) AS "Values"), 
"DT_Output_14" AS 
...
"DT_node_data_15" AS 
(SELECT "Values".nid AS nid, CAST("Values"."E" AS DOUBLE PRECISION) AS "E" 
FROM (SELECT 3 AS nid, 50.0 AS "E" FROM rdb$database UNION ALL SELECT 4 AS nid, 29.445833333333326 AS "E" FROM rdb$database UNION ALL SELECT 6 AS nid, 48.48292682926829 AS "E" FROM rdb$database UNION ALL SELECT 7 AS nid, 37.76 AS "E" FROM rdb$database UNION ALL SELECT 10 AS nid, 22.579999999999995 AS "E" FROM rdb$database UNION ALL SELECT 11 AS nid, 12.641666666666689 AS "E" FROM rdb$database UNION ALL SELECT 13 AS nid, 28.69397590361445 AS "E" FROM rdb$database UNION ALL SELECT 14 AS nid, 13.28055555555555 AS "E" FROM rdb$database) AS "Values"), 
"DT_Output_15" AS 
...
-- Code For temporary table TMP_20180508182859_CODEGEN_BEPM part 3. Create Index 

CREATE INDEX "ix_TMP_20180508182859_C_cc5a" ON "TMP_20180508182859_CODEGEN_BEPM" ("KEY")

-- Model deployment code

SELECT "Quantiles"."KEY" AS "KEY", "Quantiles"."Quantile" AS "Estimator" 
FROM "TMP_20180508182859_CODEGEN_BEPM" AS "Quantiles"