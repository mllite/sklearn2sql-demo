...
-- Code For temporary table TMP_20180602_D69_ADS_IMP_1_OUT part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180602_D69_ADS_IMP_1_OUT" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20180602_D69_ADS_IMP_1_OUT part 2. Populate

INSERT INTO "TMP_20180602_D69_ADS_IMP_1_OUT" ("KEY", impter_2, impter_3, impter_4, impter_5, impter_6, impter_7, impter_8, impter_9, impter_10, impter_11, impter_12, impter_13, impter_14) SELECT "U"."KEY", "U".impter_2, "U".impter_3, "U".impter_4, "U".impter_5, "U".impter_6, "U".impter_7, "U".impter_8, "U".impter_9, "U".impter_10, "U".impter_11, "U".impter_12, "U".impter_13, "U".impter_14 
...
-- Code For temporary table TMP_20180602_D69_ADS_IMP_1_OUT part 3. Create Index 

CREATE INDEX "ix_TMP_20180602_D69_ADS_8a7e" ON "TMP_20180602_D69_ADS_IMP_1_OUT" ("KEY")

-- Code For temporary table TMP_20180602_BOI_ADS_SCA_2_OUT part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180602_BOI_ADS_SCA_2_OUT" (
	"KEY" BIGINT NOT NULL, 
...
FROM "TMP_20180602_D69_ADS_IMP_1_OUT" AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT") AS "U"

-- Code For temporary table TMP_20180602_BOI_ADS_SCA_2_OUT part 3. Create Index 

CREATE INDEX "ix_TMP_20180602_BOI_ADS_f93a" ON "TMP_20180602_BOI_ADS_SCA_2_OUT" ("KEY")

-- Code For temporary table TMP_20180602_AZV_QUANTILES part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180602_AZV_QUANTILES" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20180602_AZV_QUANTILES part 2. Populate

INSERT INTO "TMP_20180602_AZV_QUANTILES" ("KEY", "Quantile") SELECT "U"."KEY", "U"."Quantile" 
...
FROM "TMP_20180602_BOI_ADS_SCA_2_OUT" AS "ADS_sca_2_OUT"), 
"DT_node_data" AS 
...
-- Code For temporary table TMP_20180602_AZV_QUANTILES part 3. Create Index 

CREATE INDEX "ix_TMP_20180602_AZV_QUA_d3fb" ON "TMP_20180602_AZV_QUANTILES" ("KEY")

-- Model deployment code

SELECT "Quantiles"."KEY" AS "KEY", "Quantiles"."Quantile" AS "Estimator" 
FROM "TMP_20180602_AZV_QUANTILES" AS "Quantiles"