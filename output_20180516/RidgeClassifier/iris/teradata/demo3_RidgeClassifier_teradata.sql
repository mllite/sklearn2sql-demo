...
FROM iris AS "ADS"), 
linear_model_cte AS 
(SELECT linear_input."KEY" AS "KEY", CAST(0.11193795454575 AS DOUBLE PRECISION) * linear_input."Feature_0" + CAST(0.468127134852417 AS DOUBLE PRECISION) * linear_input."Feature_1" + CAST(-0.45688479499295 AS DOUBLE PRECISION) * linear_input."Feature_2" + CAST(-0.093262002076467 AS DOUBLE PRECISION) * linear_input."Feature_3" + CAST(-0.586603359375013 AS DOUBLE PRECISION) AS "Score_0", CAST(0.056699806292054 AS DOUBLE PRECISION) * linear_input."Feature_0" + CAST(-0.873462688641896 AS DOUBLE PRECISION) * linear_input."Feature_1" + CAST(0.308123089458302 AS DOUBLE PRECISION) * linear_input."Feature_2" + CAST(-0.782414188107933 AS DOUBLE PRECISION) * linear_input."Feature_3" + CAST(1.776901965776979 AS DOUBLE PRECISION) AS "Score_1", CAST(-0.168637760837801 AS DOUBLE PRECISION) * linear_input."Feature_0" + CAST(0.405335553789477 AS DOUBLE PRECISION) * linear_input."Feature_1" + CAST(0.148761705534641 AS DOUBLE PRECISION) * linear_input."Feature_2" + CAST(0.875676190184415 AS DOUBLE PRECISION) * linear_input."Feature_3" + CAST(-2.190298606401961 AS DOUBLE PRECISION) AS "Score_2" 
FROM linear_input), 
