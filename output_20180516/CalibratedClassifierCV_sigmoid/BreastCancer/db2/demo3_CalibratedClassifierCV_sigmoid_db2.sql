...
-- Code For temporary table tmp_20180508180638_codegen_117zzj_calprob_b0 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180508180638_codegen_117zzj_calprob_b0 (
	"KEY" BIGINT, 
	"Proba_1" DOUBLE, 
	"Proba_0" DOUBLE
)
...
-- Code For temporary table tmp_20180508180638_codegen_117zzj_calprob_b0 part 2. Populate

INSERT INTO tmp_20180508180638_codegen_117zzj_calprob_b0 WITH "DT_node_lookup" AS 
...
-- Code For temporary table tmp_20180508180638_codegen_pt8le1_calprob_union part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180508180638_codegen_pt8le1_calprob_union (
	"KEY" BIGINT, 
	"Proba_1" DOUBLE, 
	"Proba_0" DOUBLE
)
...
-- Code For temporary table tmp_20180508180638_codegen_pt8le1_calprob_union part 2. Populate

INSERT INTO tmp_20180508180638_codegen_pt8le1_calprob_union SELECT "CalProb_Union"."KEY", "CalProb_Union"."Proba_1", "CalProb_Union"."Proba_0" 
...
FROM tmp_20180508180638_codegen_117zzj_calprob_b0 AS "CalProb_B0") AS "CalProb_EnsembleUnion") AS "CalProb_Union"

-- Code For temporary table tmp_20180508180638_codegen_13cul0_calprob_avg part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180508180638_codegen_13cul0_calprob_avg (
	"KEY" BIGINT, 
	"Proba_1" DOUBLE, 
	"Proba_0" DOUBLE
)
...
-- Code For temporary table tmp_20180508180638_codegen_13cul0_calprob_avg part 2. Populate

INSERT INTO tmp_20180508180638_codegen_13cul0_calprob_avg SELECT "CalProb_avg"."KEY", "CalProb_avg"."Proba_1", "CalProb_avg"."Proba_0" 
...
FROM tmp_20180508180638_codegen_pt8le1_calprob_union AS "CalProb_Union" GROUP BY "CalProb_Union"."KEY") AS "T") AS "CalProb_avg"
...
FROM tmp_20180508180638_codegen_13cul0_calprob_avg AS "CalProb_avg"), 
