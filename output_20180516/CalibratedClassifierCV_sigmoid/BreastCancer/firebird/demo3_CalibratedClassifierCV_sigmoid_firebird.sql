...
-- Code For temporary table TMP_20180516_CODEGEN_06K2C9_CAL part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180516_CODEGEN_06K2C9_CAL" (
	"KEY" BIGINT, 
...
-- Code For temporary table TMP_20180516_CODEGEN_06K2C9_CAL part 2. Populate

INSERT INTO "TMP_20180516_CODEGEN_06K2C9_CAL" ("KEY", "Proba_1", "Proba_0") SELECT "U"."KEY", "U"."Proba_1", "U"."Proba_0" 
...
-- Code For temporary table TMP_20180516_CODEGEN_IOXINO_CAL part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180516_CODEGEN_IOXINO_CAL" (
	"KEY" BIGINT NOT NULL, 
	"Proba_1" DOUBLE PRECISION, 
	"Proba_0" DOUBLE PRECISION, 
	PRIMARY KEY ("KEY")
...
-- Code For temporary table TMP_20180516_CODEGEN_IOXINO_CAL part 2. Populate

INSERT INTO "TMP_20180516_CODEGEN_IOXINO_CAL" ("KEY", "Proba_1", "Proba_0") SELECT "U"."KEY", "U"."Proba_1", "U"."Proba_0" 
...
FROM "TMP_20180516_CODEGEN_06K2C9_CAL" AS "CalProb_B0") AS "CalProb_EnsembleUnion")
...
-- Code For temporary table TMP_20180516_CODEGEN_IOXINO_CAL part 3. Create Index 

CREATE INDEX "ix_TMP_20180516_CODEGEN_ee87" ON "TMP_20180516_CODEGEN_IOXINO_CAL" ("KEY")
...
FROM "TMP_20180516_CODEGEN_IOXINO_CAL" AS "CalProb_avg"), 
