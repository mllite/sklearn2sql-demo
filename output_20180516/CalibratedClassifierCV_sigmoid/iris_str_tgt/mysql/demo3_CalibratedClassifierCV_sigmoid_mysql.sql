...
-- Code For temporary table TMP_20180602160133_PRM_CalProb_B0 part 1. Create 


CREATE TEMPORARY TABLE `TMP_20180602160133_PRM_CalProb_B0` (
	`KEY` BIGINT, 
...
-- Code For temporary table TMP_20180602160133_PRM_CalProb_B0 part 2. Populate

INSERT INTO `TMP_20180602160133_PRM_CalProb_B0` (`KEY`, `Proba_CLASS_0`, `Proba_CLASS_1`, `Proba_CLASS_2`) SELECT `U`.`KEY`, `U`.`Proba_CLASS_0`, `U`.`Proba_CLASS_1`, `U`.`Proba_CLASS_2` 
...
-- Code For temporary table TMP_20180602160133_42C_CalProb_avg part 1. Create 


CREATE TEMPORARY TABLE `TMP_20180602160133_42C_CalProb_avg` (
	`KEY` BIGINT NOT NULL, 
	`Proba_CLASS_0` DOUBLE, 
	`Proba_CLASS_1` DOUBLE, 
	`Proba_CLASS_2` DOUBLE, 
...
-- Code For temporary table TMP_20180602160133_42C_CalProb_avg part 2. Populate

INSERT INTO `TMP_20180602160133_42C_CalProb_avg` (`KEY`, `Proba_CLASS_0`, `Proba_CLASS_1`, `Proba_CLASS_2`) SELECT `U`.`KEY`, `U`.`Proba_CLASS_0`, `U`.`Proba_CLASS_1`, `U`.`Proba_CLASS_2` 
...
FROM `TMP_20180602160133_PRM_CalProb_B0` AS `CalProb_B0`) AS `CalProb_EnsembleUnion`)
...
-- Code For temporary table TMP_20180602160133_42C_CalProb_avg part 3. Create Index 

CREATE INDEX `ix_TMP_20180602160133_42C_CalProb_avg_KEY` ON `TMP_20180602160133_42C_CalProb_avg` (`KEY`)
...
FROM `TMP_20180602160133_42C_CalProb_avg` AS `CalProb_avg`), 
