...
-- Code For temporary table TMP_20180508190430_CODEGEN_4UIY2J_CalProb_B0 part 1. Create 


CREATE TEMPORARY TABLE `TMP_20180508190430_CODEGEN_4UIY2J_CalProb_B0` (
	`KEY` BIGINT, 
...
-- Code For temporary table TMP_20180508190430_CODEGEN_4UIY2J_CalProb_B0 part 2. Populate

INSERT INTO `TMP_20180508190430_CODEGEN_4UIY2J_CalProb_B0` (`KEY`, `Proba_CLASS_0`, `Proba_CLASS_1`, `Proba_CLASS_2`) SELECT `U`.`KEY`, `U`.`Proba_CLASS_0`, `U`.`Proba_CLASS_1`, `U`.`Proba_CLASS_2` 
...
-- Code For temporary table TMP_20180508190430_CODEGEN_VMXEX6_CalProb_Union part 1. Create 


CREATE TEMPORARY TABLE `TMP_20180508190430_CODEGEN_VMXEX6_CalProb_Union` (
	`KEY` BIGINT, 
	`Proba_CLASS_0` DOUBLE, 
	`Proba_CLASS_1` DOUBLE, 
	`Proba_CLASS_2` DOUBLE
...
-- Code For temporary table TMP_20180508190430_CODEGEN_VMXEX6_CalProb_Union part 2. Populate

INSERT INTO `TMP_20180508190430_CODEGEN_VMXEX6_CalProb_Union` (`KEY`, `Proba_CLASS_0`, `Proba_CLASS_1`, `Proba_CLASS_2`) SELECT `U`.`KEY`, `U`.`Proba_CLASS_0`, `U`.`Proba_CLASS_1`, `U`.`Proba_CLASS_2` 
...
FROM `TMP_20180508190430_CODEGEN_4UIY2J_CalProb_B0` AS `CalProb_B0`) AS `CalProb_EnsembleUnion`) AS `CalProb_Union`) AS `U`

-- Code For temporary table TMP_20180508190430_CODEGEN_J2FGXP_CalProb_avg part 1. Create 


CREATE TEMPORARY TABLE `TMP_20180508190430_CODEGEN_J2FGXP_CalProb_avg` (
	`KEY` BIGINT NOT NULL, 
	`Proba_CLASS_0` DOUBLE, 
	`Proba_CLASS_1` DOUBLE, 
	`Proba_CLASS_2` DOUBLE, 
...
-- Code For temporary table TMP_20180508190430_CODEGEN_J2FGXP_CalProb_avg part 2. Populate

INSERT INTO `TMP_20180508190430_CODEGEN_J2FGXP_CalProb_avg` (`KEY`, `Proba_CLASS_0`, `Proba_CLASS_1`, `Proba_CLASS_2`) SELECT `U`.`KEY`, `U`.`Proba_CLASS_0`, `U`.`Proba_CLASS_1`, `U`.`Proba_CLASS_2` 
...
FROM `TMP_20180508190430_CODEGEN_VMXEX6_CalProb_Union` AS `CalProb_Union` GROUP BY `CalProb_Union`.`KEY`) AS `T`) AS `CalProb_avg`) AS `U`

-- Code For temporary table TMP_20180508190430_CODEGEN_J2FGXP_CalProb_avg part 3. Create Index 

CREATE INDEX `ix_TMP_20180508190430_CODEGEN_J2FGXP_CalProb_avg_KEY` ON `TMP_20180508190430_CODEGEN_J2FGXP_CalProb_avg` (`KEY`)
...
FROM `TMP_20180508190430_CODEGEN_J2FGXP_CalProb_avg` AS `CalProb_avg`), 
