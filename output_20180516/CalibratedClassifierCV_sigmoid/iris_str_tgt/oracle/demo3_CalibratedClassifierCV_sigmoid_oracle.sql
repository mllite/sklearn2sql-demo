...
-- Code For temporary table _CODEGEN_M8WKC6_CALPROB_B0 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "_CODEGEN_M8WKC6_CALPROB_B0" (
	"KEY" NUMBER(19), 
...
-- Code For temporary table _CODEGEN_M8WKC6_CALPROB_B0 part 2. Populate

INSERT INTO "_CODEGEN_M8WKC6_CALPROB_B0" ("KEY", "Proba_CLASS_0", "Proba_CLASS_1", "Proba_CLASS_2") SELECT "U"."KEY", "U"."Proba_CLASS_0", "U"."Proba_CLASS_1", "U"."Proba_CLASS_2" 
...
-- Code For temporary table CODEGEN_66QKQA_CALPROB_AVG part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "CODEGEN_66QKQA_CALPROB_AVG" (
	"KEY" NUMBER(19), 
	"Proba_CLASS_0" BINARY_DOUBLE, 
	"Proba_CLASS_1" BINARY_DOUBLE, 
	"Proba_CLASS_2" BINARY_DOUBLE
...
-- Code For temporary table CODEGEN_66QKQA_CALPROB_AVG part 2. Populate

INSERT INTO "CODEGEN_66QKQA_CALPROB_AVG" ("KEY", "Proba_CLASS_0", "Proba_CLASS_1", "Proba_CLASS_2") SELECT "U"."KEY", "U"."Proba_CLASS_0", "U"."Proba_CLASS_1", "U"."Proba_CLASS_2" 
...
FROM "_CODEGEN_M8WKC6_CALPROB_B0" "CalProb_B0") "CalProb_EnsembleUnion")
...
FROM "CODEGEN_66QKQA_CALPROB_AVG" "CalProb_avg"), 
