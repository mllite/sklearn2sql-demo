...
-- Code For temporary table tmp_20180508175705_codegen_ewd552_calprob_b0 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180508175705_codegen_ewd552_calprob_b0  (
	"KEY" BIGINT, 
...
-- Code For temporary table tmp_20180508175705_codegen_ewd552_calprob_b0 part 2. Populate

INSERT INTO tmp_20180508175705_codegen_ewd552_calprob_b0 ("KEY", "Proba_1", "Proba_0") SELECT "U"."KEY", "U"."Proba_1", "U"."Proba_0" 
...
-- Code For temporary table tmp_20180508175705_codegen_slebfp_calprob_union part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180508175705_codegen_slebfp_calprob_union  (
	"KEY" BIGINT, 
	"Proba_1" DOUBLE PRECISION, 
	"Proba_0" DOUBLE PRECISION
)
...
-- Code For temporary table tmp_20180508175705_codegen_slebfp_calprob_union part 2. Populate

INSERT INTO tmp_20180508175705_codegen_slebfp_calprob_union ("KEY", "Proba_1", "Proba_0") SELECT "U"."KEY", "U"."Proba_1", "U"."Proba_0" 
...
FROM tmp_20180508175705_codegen_ewd552_calprob_b0 AS "CalProb_B0") AS "CalProb_EnsembleUnion") AS "CalProb_Union") AS "U"

-- Code For temporary table tmp_20180508175705_codegen_0pbsy3_calprob_avg part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180508175705_codegen_0pbsy3_calprob_avg  (
	"KEY" BIGINT, 
	"Proba_1" DOUBLE PRECISION, 
	"Proba_0" DOUBLE PRECISION
)
...
-- Code For temporary table tmp_20180508175705_codegen_0pbsy3_calprob_avg part 2. Populate

INSERT INTO tmp_20180508175705_codegen_0pbsy3_calprob_avg ("KEY", "Proba_1", "Proba_0") SELECT "U"."KEY", "U"."Proba_1", "U"."Proba_0" 
...
FROM tmp_20180508175705_codegen_slebfp_calprob_union AS "CalProb_Union" GROUP BY "CalProb_Union"."KEY") AS "T") AS "CalProb_avg") AS "U"
...
FROM tmp_20180508175705_codegen_0pbsy3_calprob_avg AS "CalProb_avg"), 
