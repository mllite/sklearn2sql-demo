...
-- Code For temporary table tmp_20180516122233_codegen_2uxgcq_calprob_b0 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180516122233_codegen_2uxgcq_calprob_b0  (
	"KEY" BIGINT, 
...
-- Code For temporary table tmp_20180516122233_codegen_2uxgcq_calprob_b0 part 2. Populate

INSERT INTO tmp_20180516122233_codegen_2uxgcq_calprob_b0 ("KEY", "Proba_0", "Proba_1", "Proba_2") SELECT "U"."KEY", "U"."Proba_0", "U"."Proba_1", "U"."Proba_2" 
...
-- Code For temporary table tmp_20180516122233_codegen_szn8o4_calprob_avg part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180516122233_codegen_szn8o4_calprob_avg  (
	"KEY" BIGINT, 
	"Proba_0" DOUBLE PRECISION, 
	"Proba_1" DOUBLE PRECISION, 
	"Proba_2" DOUBLE PRECISION
...
-- Code For temporary table tmp_20180516122233_codegen_szn8o4_calprob_avg part 2. Populate

INSERT INTO tmp_20180516122233_codegen_szn8o4_calprob_avg ("KEY", "Proba_0", "Proba_1", "Proba_2") SELECT "U"."KEY", "U"."Proba_0", "U"."Proba_1", "U"."Proba_2" 
...
FROM tmp_20180516122233_codegen_2uxgcq_calprob_b0 AS "CalProb_B0") AS "CalProb_EnsembleUnion")
...
FROM tmp_20180516122233_codegen_szn8o4_calprob_avg AS "CalProb_avg"), 
