...
-- Code For temporary table tmp_20180602152622_vis_calprob_b0 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180602152622_vis_calprob_b0 (
	"KEY" BIGINT, 
	"Proba_0" DOUBLE, 
	"Proba_1" DOUBLE, 
	"Proba_2" DOUBLE
...
-- Code For temporary table tmp_20180602152622_vis_calprob_b0 part 2. Populate

INSERT INTO tmp_20180602152622_vis_calprob_b0 WITH "DT_node_lookup" AS 
...
-- Code For temporary table tmp_20180602152622_4u8_calprob_avg part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180602152622_4u8_calprob_avg (
	"KEY" BIGINT, 
	"Proba_0" DOUBLE, 
	"Proba_1" DOUBLE, 
	"Proba_2" DOUBLE
...
-- Code For temporary table tmp_20180602152622_4u8_calprob_avg part 2. Populate

INSERT INTO tmp_20180602152622_4u8_calprob_avg WITH "CalProb_Union" AS 
...
FROM tmp_20180602152622_vis_calprob_b0 AS "CalProb_B0") AS "CalProb_EnsembleUnion")
...
FROM tmp_20180602152622_4u8_calprob_avg AS "CalProb_avg"), 
