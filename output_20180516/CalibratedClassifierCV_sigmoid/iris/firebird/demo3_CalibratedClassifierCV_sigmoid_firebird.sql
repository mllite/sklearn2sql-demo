...
-- Code For temporary table TMP_20180516_CODEGEN_Q8LVP8_CAL part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180516_CODEGEN_Q8LVP8_CAL" (
	"KEY" BIGINT, 
...
-- Code For temporary table TMP_20180516_CODEGEN_Q8LVP8_CAL part 2. Populate

INSERT INTO "TMP_20180516_CODEGEN_Q8LVP8_CAL" ("KEY", "Proba_0", "Proba_1", "Proba_2") SELECT "U"."KEY", "U"."Proba_0", "U"."Proba_1", "U"."Proba_2" 
...
-- Code For temporary table TMP_20180516_CODEGEN_OQ6PN8_CAL part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180516_CODEGEN_OQ6PN8_CAL" (
	"KEY" BIGINT NOT NULL, 
	"Proba_0" DOUBLE PRECISION, 
	"Proba_1" DOUBLE PRECISION, 
	"Proba_2" DOUBLE PRECISION, 
...
-- Code For temporary table TMP_20180516_CODEGEN_OQ6PN8_CAL part 2. Populate

INSERT INTO "TMP_20180516_CODEGEN_OQ6PN8_CAL" ("KEY", "Proba_0", "Proba_1", "Proba_2") SELECT "U"."KEY", "U"."Proba_0", "U"."Proba_1", "U"."Proba_2" 
...
FROM "TMP_20180516_CODEGEN_Q8LVP8_CAL" AS "CalProb_B0") AS "CalProb_EnsembleUnion")
...
-- Code For temporary table TMP_20180516_CODEGEN_OQ6PN8_CAL part 3. Create Index 

CREATE INDEX "ix_TMP_20180516_CODEGEN_feb2" ON "TMP_20180516_CODEGEN_OQ6PN8_CAL" ("KEY")
...
FROM "TMP_20180516_CODEGEN_OQ6PN8_CAL" AS "CalProb_avg"), 
