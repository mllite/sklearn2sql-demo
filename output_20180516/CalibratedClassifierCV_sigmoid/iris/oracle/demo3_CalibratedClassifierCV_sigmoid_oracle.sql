...
-- Code For temporary table _CODEGEN_IMAZBC_CALPROB_B0 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "_CODEGEN_IMAZBC_CALPROB_B0" (
	"KEY" NUMBER(19), 
...
-- Code For temporary table _CODEGEN_IMAZBC_CALPROB_B0 part 2. Populate

INSERT INTO "_CODEGEN_IMAZBC_CALPROB_B0" ("KEY", "Proba_0", "Proba_1", "Proba_2") SELECT "U"."KEY", "U"."Proba_0", "U"."Proba_1", "U"."Proba_2" 
...
-- Code For temporary table CODEGEN_GSKYZS_CALPROB_AVG part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "CODEGEN_GSKYZS_CALPROB_AVG" (
	"KEY" NUMBER(19), 
	"Proba_0" BINARY_DOUBLE, 
	"Proba_1" BINARY_DOUBLE, 
	"Proba_2" BINARY_DOUBLE
...
-- Code For temporary table CODEGEN_GSKYZS_CALPROB_AVG part 2. Populate

INSERT INTO "CODEGEN_GSKYZS_CALPROB_AVG" ("KEY", "Proba_0", "Proba_1", "Proba_2") SELECT "U"."KEY", "U"."Proba_0", "U"."Proba_1", "U"."Proba_2" 
...
FROM "_CODEGEN_IMAZBC_CALPROB_B0" "CalProb_B0") "CalProb_EnsembleUnion")
...
FROM "CODEGEN_GSKYZS_CALPROB_AVG" "CalProb_avg"), 
