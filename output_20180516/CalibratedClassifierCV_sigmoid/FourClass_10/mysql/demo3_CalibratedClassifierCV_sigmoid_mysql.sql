...
-- Code For temporary table TMP_20180516112132_CODEGEN_VKS62L_CalProb_B0 part 1. Create 


CREATE TEMPORARY TABLE `TMP_20180516112132_CODEGEN_VKS62L_CalProb_B0` (
	`KEY` BIGINT, 
	`Proba_0` DOUBLE, 
	`Proba_1` DOUBLE, 
	`Proba_2` DOUBLE, 
...
-- Code For temporary table TMP_20180516112132_CODEGEN_VKS62L_CalProb_B0 part 2. Populate

INSERT INTO `TMP_20180516112132_CODEGEN_VKS62L_CalProb_B0` (`KEY`, `Proba_0`, `Proba_1`, `Proba_2`, `Proba_3`) SELECT `U`.`KEY`, `U`.`Proba_0`, `U`.`Proba_1`, `U`.`Proba_2`, `U`.`Proba_3` 
...
-- Code For temporary table TMP_20180516112132_CODEGEN_DYTA2F_CalProb_avg part 1. Create 


CREATE TEMPORARY TABLE `TMP_20180516112132_CODEGEN_DYTA2F_CalProb_avg` (
	`KEY` BIGINT NOT NULL, 
	`Proba_0` DOUBLE, 
	`Proba_1` DOUBLE, 
	`Proba_2` DOUBLE, 
...
-- Code For temporary table TMP_20180516112132_CODEGEN_DYTA2F_CalProb_avg part 2. Populate

INSERT INTO `TMP_20180516112132_CODEGEN_DYTA2F_CalProb_avg` (`KEY`, `Proba_0`, `Proba_1`, `Proba_2`, `Proba_3`) SELECT `U`.`KEY`, `U`.`Proba_0`, `U`.`Proba_1`, `U`.`Proba_2`, `U`.`Proba_3` 
...
FROM `TMP_20180516112132_CODEGEN_VKS62L_CalProb_B0` AS `CalProb_B0`) AS `CalProb_EnsembleUnion`)
...
-- Code For temporary table TMP_20180516112132_CODEGEN_DYTA2F_CalProb_avg part 3. Create Index 

CREATE INDEX `ix_TMP_20180516112132_CODEGEN_DYTA2F_CalProb_avg_KEY` ON `TMP_20180516112132_CODEGEN_DYTA2F_CalProb_avg` (`KEY`)
...
FROM `TMP_20180516112132_CODEGEN_DYTA2F_CalProb_avg` AS `CalProb_avg`), 
