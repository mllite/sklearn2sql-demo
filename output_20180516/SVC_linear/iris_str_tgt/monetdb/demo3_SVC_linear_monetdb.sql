...
-- Code For temporary table tmp_20180516132608_codegen_yqw6id_kernagg_b0 part 1. Create 


CREATE TEMPORARY TABLE tmp_20180516132608_codegen_yqw6id_kernagg_b0 (
	"KEY" BIGINT, 
	"OVO_Class1" CLOB, 
	"OVO_Class2" CLOB, 
	"OVO_Decision" BIGINT, 
...
-- Code For temporary table tmp_20180516132608_codegen_yqw6id_kernagg_b0 part 2. Populate

INSERT INTO tmp_20180516132608_codegen_yqw6id_kernagg_b0 ("KEY", "OVO_Class1", "OVO_Class2", "OVO_Decision", "OVO_Confidence") SELECT "U"."KEY", "U"."OVO_Class1", "U"."OVO_Class2", "U"."OVO_Decision", "U"."OVO_Confidence" 
...
-- Code For temporary table tmp_20180516132608_codegen_j6606m_kernagg_b1 part 1. Create 


CREATE TEMPORARY TABLE tmp_20180516132608_codegen_j6606m_kernagg_b1 (
	"KEY" BIGINT, 
	"OVO_Class1" CLOB, 
	"OVO_Class2" CLOB, 
	"OVO_Decision" BIGINT, 
...
-- Code For temporary table tmp_20180516132608_codegen_j6606m_kernagg_b1 part 2. Populate

INSERT INTO tmp_20180516132608_codegen_j6606m_kernagg_b1 ("KEY", "OVO_Class1", "OVO_Class2", "OVO_Decision", "OVO_Confidence") SELECT "U"."KEY", "U"."OVO_Class1", "U"."OVO_Class2", "U"."OVO_Decision", "U"."OVO_Confidence" 
FROM (WITH kernel_input AS 
(SELECT "ADS"."KEY" AS "KEY", CAST("ADS"."Feature_0" AS DOUBLE) AS "Feature_0", CAST("ADS"."Feature_1" AS DOUBLE) AS "Feature_1", CAST("ADS"."Feature_2" AS DOUBLE) AS "Feature_2", CAST("ADS"."Feature_3" AS DOUBLE) AS "Feature_3", CAST("ADS"."TGT" AS DOUBLE) AS "TGT" 
FROM iris_str_tgt AS "ADS"), 
...
-- Code For temporary table tmp_20180516132608_codegen_4ex6lz_kernagg_b2 part 1. Create 


CREATE TEMPORARY TABLE tmp_20180516132608_codegen_4ex6lz_kernagg_b2 (
	"KEY" BIGINT, 
	"OVO_Class1" CLOB, 
	"OVO_Class2" CLOB, 
	"OVO_Decision" BIGINT, 
...
-- Code For temporary table tmp_20180516132608_codegen_4ex6lz_kernagg_b2 part 2. Populate

INSERT INTO tmp_20180516132608_codegen_4ex6lz_kernagg_b2 ("KEY", "OVO_Class1", "OVO_Class2", "OVO_Decision", "OVO_Confidence") SELECT "U"."KEY", "U"."OVO_Class1", "U"."OVO_Class2", "U"."OVO_Decision", "U"."OVO_Confidence" 
FROM (WITH kernel_input AS 
(SELECT "ADS"."KEY" AS "KEY", CAST("ADS"."Feature_0" AS DOUBLE) AS "Feature_0", CAST("ADS"."Feature_1" AS DOUBLE) AS "Feature_1", CAST("ADS"."Feature_2" AS DOUBLE) AS "Feature_2", CAST("ADS"."Feature_3" AS DOUBLE) AS "Feature_3", CAST("ADS"."TGT" AS DOUBLE) AS "TGT" 
FROM iris_str_tgt AS "ADS"), 
...
-- Code For temporary table tmp_20180516132608_codegen_57jszb_kernagg part 1. Create 


CREATE TEMPORARY TABLE tmp_20180516132608_codegen_57jszb_kernagg (
	"KEY" BIGINT, 
...
FROM tmp_20180516132608_codegen_yqw6id_kernagg_b0 AS "KernAgg_B0" UNION ALL SELECT "KernAgg_B1"."KEY" AS "KEY", "KernAgg_B1"."OVO_Class1" AS "OVO_Class1", "KernAgg_B1"."OVO_Class2" AS "OVO_Class2", "KernAgg_B1"."OVO_Decision" AS "OVO_Decision", "KernAgg_B1"."OVO_Confidence" AS "OVO_Confidence" 
FROM tmp_20180516132608_codegen_j6606m_kernagg_b1 AS "KernAgg_B1" UNION ALL SELECT "KernAgg_B2"."KEY" AS "KEY", "KernAgg_B2"."OVO_Class1" AS "OVO_Class1", "KernAgg_B2"."OVO_Class2" AS "OVO_Class2", "KernAgg_B2"."OVO_Decision" AS "OVO_Decision", "KernAgg_B2"."OVO_Confidence" AS "OVO_Confidence" 
FROM tmp_20180516132608_codegen_4ex6lz_kernagg_b2 AS "KernAgg_B2") AS "KernAgg_EnsembleUnion"), 
"OVO_Votes" AS 
...
FROM tmp_20180516132608_codegen_57jszb_kernagg AS "KernAgg"), 
