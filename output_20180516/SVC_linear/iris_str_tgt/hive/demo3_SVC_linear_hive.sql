...
-- Code For temporary table tmp_20180602161438_l1g_kernagg_b0 part 1. Create 

CREATE TEMPORARY TABLE `tmp_20180602161438_l1g_kernagg_b0` STORED AS ORC AS WITH `kernel_input` AS 
...
-- Code For temporary table tmp_20180602161438_l1g_kernagg_b0 part 2. Populate

SELECT * FROM `tmp_20180602161438_l1g_kernagg_b0`

-- Code For temporary table tmp_20180602161438_t8d_kernagg_b1 part 1. Create 

CREATE TEMPORARY TABLE `tmp_20180602161438_t8d_kernagg_b1` STORED AS ORC AS WITH `kernel_input` AS 
(SELECT `ADS`.`KEY` AS `KEY`, CAST(`ADS`.`Feature_0` AS DOUBLE) AS `Feature_0`, CAST(`ADS`.`Feature_1` AS DOUBLE) AS `Feature_1`, CAST(`ADS`.`Feature_2` AS DOUBLE) AS `Feature_2`, CAST(`ADS`.`Feature_3` AS DOUBLE) AS `Feature_3`, CAST(`ADS`.`TGT` AS DOUBLE) AS `TGT` 
FROM `iris_str_tgt` AS `ADS`), 
...
(SELECT `kernel_dp_CLASS_0_CLASS_2`.`KEY` AS `KEY`, 'CLASS_0' AS `OVO_Class1`, 'CLASS_2' AS `OVO_Class2`, CASE WHEN (-`kernel_dp_CLASS_0_CLASS_2`.`dot_product` >= 0.0) THEN 1 ELSE 0 END AS `OVO_Decision`, coalesce(-`kernel_dp_CLASS_0_CLASS_2`.`dot_product`, 1.0 / (1.0 + exp(-(-((-`kernel_dp_CLASS_0_CLASS_2`.`dot_product`) * -2.7959674026103736 + -0.2560355589431964))))) AS `OVO_Conf` 
...
-- Code For temporary table tmp_20180602161438_t8d_kernagg_b1 part 2. Populate

SELECT * FROM `tmp_20180602161438_t8d_kernagg_b1`

-- Code For temporary table tmp_20180602161438_inv_kernagg_b2 part 1. Create 

CREATE TEMPORARY TABLE `tmp_20180602161438_inv_kernagg_b2` STORED AS ORC AS WITH `kernel_input` AS 
(SELECT `ADS`.`KEY` AS `KEY`, CAST(`ADS`.`Feature_0` AS DOUBLE) AS `Feature_0`, CAST(`ADS`.`Feature_1` AS DOUBLE) AS `Feature_1`, CAST(`ADS`.`Feature_2` AS DOUBLE) AS `Feature_2`, CAST(`ADS`.`Feature_3` AS DOUBLE) AS `Feature_3`, CAST(`ADS`.`TGT` AS DOUBLE) AS `TGT` 
FROM `iris_str_tgt` AS `ADS`), 
...
-- Code For temporary table tmp_20180602161438_inv_kernagg_b2 part 2. Populate

SELECT * FROM `tmp_20180602161438_inv_kernagg_b2`

-- Code For temporary table tmp_20180602161438_z8t_kernagg_agg part 1. Create 

CREATE TEMPORARY TABLE `tmp_20180602161438_z8t_kernagg_agg` STORED AS ORC AS WITH `KernAgg_Union` AS 
...
FROM `tmp_20180602161438_l1g_kernagg_b0` AS `KernAgg_B0` UNION ALL SELECT `KernAgg_B1`.`KEY` AS `KEY`, `KernAgg_B1`.`OVO_Class1` AS `OVO_Class1`, `KernAgg_B1`.`OVO_Class2` AS `OVO_Class2`, `KernAgg_B1`.`OVO_Decision` AS `OVO_Decision`, `KernAgg_B1`.`OVO_Conf` AS `OVO_Conf` 
FROM `tmp_20180602161438_t8d_kernagg_b1` AS `KernAgg_B1` UNION ALL SELECT `KernAgg_B2`.`KEY` AS `KEY`, `KernAgg_B2`.`OVO_Class1` AS `OVO_Class1`, `KernAgg_B2`.`OVO_Class2` AS `OVO_Class2`, `KernAgg_B2`.`OVO_Decision` AS `OVO_Decision`, `KernAgg_B2`.`OVO_Conf` AS `OVO_Conf` 
FROM `tmp_20180602161438_inv_kernagg_b2` AS `KernAgg_B2`) AS `KernAgg_EnsembleUnion`), 
`OVO_Votes` AS 
...
-- Code For temporary table tmp_20180602161438_z8t_kernagg_agg part 2. Populate

SELECT * FROM `tmp_20180602161438_z8t_kernagg_agg`
...
FROM `tmp_20180602161438_z8t_kernagg_agg` AS `KernAgg_agg`), 
