...
-- Code For temporary table tmp_20180508190804_codegen_o78au0_kernagg_b0 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180508190804_codegen_o78au0_kernagg_b0  (
	"KEY" BIGINT, 
...
-- Code For temporary table tmp_20180508190804_codegen_o78au0_kernagg_b0 part 2. Populate

INSERT INTO tmp_20180508190804_codegen_o78au0_kernagg_b0 ("KEY", "OVO_Class1", "OVO_Class2", "OVO_Decision", "OVO_Confidence") SELECT "U"."KEY", "U"."OVO_Class1", "U"."OVO_Class2", "U"."OVO_Decision", "U"."OVO_Confidence" 
...
-- Code For temporary table tmp_20180508190804_codegen_bvs68n_kernagg_union part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180508190804_codegen_bvs68n_kernagg_union  (
	"KEY" BIGINT, 
	"OVO_Class1" LONG VARCHAR, 
	"OVO_Class2" LONG VARCHAR, 
	"OVO_Decision" BIGINT, 
...
-- Code For temporary table tmp_20180508190804_codegen_bvs68n_kernagg_union part 2. Populate

INSERT INTO tmp_20180508190804_codegen_bvs68n_kernagg_union ("KEY", "OVO_Class1", "OVO_Class2", "OVO_Decision", "OVO_Confidence") SELECT "U"."KEY", "U"."OVO_Class1", "U"."OVO_Class2", "U"."OVO_Decision", "U"."OVO_Confidence" 
...
FROM tmp_20180508190804_codegen_o78au0_kernagg_b0 AS "KernAgg_B0") AS "KernAgg_EnsembleUnion") AS "KernAgg_Union") AS "U"

-- Code For temporary table tmp_20180508190804_codegen_9w7kux_kernagg part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180508190804_codegen_9w7kux_kernagg  (
	"KEY" BIGINT, 
...
-- Code For temporary table tmp_20180508190804_codegen_9w7kux_kernagg part 2. Populate

INSERT INTO tmp_20180508190804_codegen_9w7kux_kernagg ("KEY", "OVO_Vote_CLASS_0", "OVO_SumConfidence_CLASS_0", "OVO_Vote_CLASS_1", "OVO_SumConfidence_CLASS_1", "OVO_Vote_CLASS_2", "OVO_SumConfidence_CLASS_2", max_abs_confidence, "OVO_Scale", "Score_CLASS_0", "Score_CLASS_1", "Score_CLASS_2") SELECT "U"."KEY", "U"."OVO_Vote_CLASS_0", "U"."OVO_SumConfidence_CLASS_0", "U"."OVO_Vote_CLASS_1", "U"."OVO_SumConfidence_CLASS_1", "U"."OVO_Vote_CLASS_2", "U"."OVO_SumConfidence_CLASS_2", "U".max_abs_confidence, "U"."OVO_Scale", "U"."Score_CLASS_0", "U"."Score_CLASS_1", "U"."Score_CLASS_2" 
...
FROM tmp_20180508190804_codegen_bvs68n_kernagg_union AS "KernAgg_Union" GROUP BY "KernAgg_Union"."KEY") AS "Votes_Sel"), 
dummy_cte AS 
(SELECT CAST(0.0 AS DOUBLE PRECISION) AS "X"), 
"OVO_SumConf_CTE" AS 
...
FROM tmp_20180508190804_codegen_9w7kux_kernagg AS "KernAgg"), 
