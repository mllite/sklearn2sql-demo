...
-- Code For temporary table ##TMP_20180516122739_CODEGEN_MCT8H4_KernAgg_B0 part 1. Create 


CREATE TABLE ##TMP_20180516122739_CODEGEN_MCT8H4_KernAgg_B0 (
	[KEY] BIGINT NULL, 
...
-- Code For temporary table ##TMP_20180516122739_CODEGEN_MCT8H4_KernAgg_B0 part 2. Populate
...
kernel_cte_0_1 AS 
(SELECT kernel_dp_0_1.[KEY] AS [KEY], 0 AS [OVO_Class1], 1 AS [OVO_Class2], CASE WHEN (-kernel_dp_0_1.dot_product >= 0.0) THEN 1 ELSE 0 END AS [OVO_Decision], coalesce(-kernel_dp_0_1.dot_product, 1.0 / (1.0 + exp(CASE WHEN (CASE WHEN (-100.0 <= -(-((-kernel_dp_0_1.dot_product) * -2.1794381146878 + -0.5515687986009299))) THEN -(-((-kernel_dp_0_1.dot_product) * -2.1794381146878 + -0.5515687986009299)) ELSE -100.0 END <= 100.0) THEN CASE WHEN (-100.0 <= -(-((-kernel_dp_0_1.dot_product) * -2.1794381146878 + -0.5515687986009299))) THEN -(-((-kernel_dp_0_1.dot_product) * -2.1794381146878 + -0.5515687986009299)) ELSE -100.0 END ELSE 100.0 END))) AS [OVO_Confidence] 
FROM kernel_dp_0_1)
 INSERT INTO ##TMP_20180516122739_CODEGEN_MCT8H4_KernAgg_B0 ([KEY], [OVO_Class1], [OVO_Class2], [OVO_Decision], [OVO_Confidence]) SELECT [KernAgg_B0].[KEY], [KernAgg_B0].[OVO_Class1], [KernAgg_B0].[OVO_Class2], [KernAgg_B0].[OVO_Decision], [KernAgg_B0].[OVO_Confidence] 
...
-- Code For temporary table ##TMP_20180516122739_CODEGEN_44249P_KernAgg_B1 part 1. Create 


CREATE TABLE ##TMP_20180516122739_CODEGEN_44249P_KernAgg_B1 (
	[KEY] BIGINT NULL, 
	[OVO_Class1] BIGINT NULL, 
	[OVO_Class2] BIGINT NULL, 
	[OVO_Decision] BIGINT NULL, 
...
-- Code For temporary table ##TMP_20180516122739_CODEGEN_44249P_KernAgg_B1 part 2. Populate
...
kernel_cte_0_2 AS 
(SELECT kernel_dp_0_2.[KEY] AS [KEY], 0 AS [OVO_Class1], 2 AS [OVO_Class2], CASE WHEN (-kernel_dp_0_2.dot_product >= 0.0) THEN 1 ELSE 0 END AS [OVO_Decision], coalesce(-kernel_dp_0_2.dot_product, 1.0 / (1.0 + exp(CASE WHEN (CASE WHEN (-100.0 <= -(-((-kernel_dp_0_2.dot_product) * -2.7771425999234127 + -0.22635405937075895))) THEN -(-((-kernel_dp_0_2.dot_product) * -2.7771425999234127 + -0.22635405937075895)) ELSE -100.0 END <= 100.0) THEN CASE WHEN (-100.0 <= -(-((-kernel_dp_0_2.dot_product) * -2.7771425999234127 + -0.22635405937075895))) THEN -(-((-kernel_dp_0_2.dot_product) * -2.7771425999234127 + -0.22635405937075895)) ELSE -100.0 END ELSE 100.0 END))) AS [OVO_Confidence] 
FROM kernel_dp_0_2)
 INSERT INTO ##TMP_20180516122739_CODEGEN_44249P_KernAgg_B1 ([KEY], [OVO_Class1], [OVO_Class2], [OVO_Decision], [OVO_Confidence]) SELECT [KernAgg_B1].[KEY], [KernAgg_B1].[OVO_Class1], [KernAgg_B1].[OVO_Class2], [KernAgg_B1].[OVO_Decision], [KernAgg_B1].[OVO_Confidence] 
...
-- Code For temporary table ##TMP_20180516122739_CODEGEN_3V05BV_KernAgg_B2 part 1. Create 


CREATE TABLE ##TMP_20180516122739_CODEGEN_3V05BV_KernAgg_B2 (
	[KEY] BIGINT NULL, 
	[OVO_Class1] BIGINT NULL, 
	[OVO_Class2] BIGINT NULL, 
	[OVO_Decision] BIGINT NULL, 
...
-- Code For temporary table ##TMP_20180516122739_CODEGEN_3V05BV_KernAgg_B2 part 2. Populate
...
kernel_cte_1_2 AS 
(SELECT kernel_dp_1_2.[KEY] AS [KEY], 1 AS [OVO_Class1], 2 AS [OVO_Class2], CASE WHEN (-kernel_dp_1_2.dot_product >= 0.0) THEN 1 ELSE 0 END AS [OVO_Decision], coalesce(-kernel_dp_1_2.dot_product, 1.0 / (1.0 + exp(CASE WHEN (CASE WHEN (-100.0 <= -(-((-kernel_dp_1_2.dot_product) * -2.2814207267964486 + 0.09246370690294264))) THEN -(-((-kernel_dp_1_2.dot_product) * -2.2814207267964486 + 0.09246370690294264)) ELSE -100.0 END <= 100.0) THEN CASE WHEN (-100.0 <= -(-((-kernel_dp_1_2.dot_product) * -2.2814207267964486 + 0.09246370690294264))) THEN -(-((-kernel_dp_1_2.dot_product) * -2.2814207267964486 + 0.09246370690294264)) ELSE -100.0 END ELSE 100.0 END))) AS [OVO_Confidence] 
FROM kernel_dp_1_2)
 INSERT INTO ##TMP_20180516122739_CODEGEN_3V05BV_KernAgg_B2 ([KEY], [OVO_Class1], [OVO_Class2], [OVO_Decision], [OVO_Confidence]) SELECT [KernAgg_B2].[KEY], [KernAgg_B2].[OVO_Class1], [KernAgg_B2].[OVO_Class2], [KernAgg_B2].[OVO_Decision], [KernAgg_B2].[OVO_Confidence] 
...
-- Code For temporary table ##TMP_20180516122739_CODEGEN_NWSA7S_KernAgg part 1. Create 


CREATE TABLE ##TMP_20180516122739_CODEGEN_NWSA7S_KernAgg (
	[KEY] BIGINT NULL, 
...
-- Code For temporary table ##TMP_20180516122739_CODEGEN_NWSA7S_KernAgg part 2. Populate
...
FROM ##TMP_20180516122739_CODEGEN_MCT8H4_KernAgg_B0 AS [KernAgg_B0] UNION ALL SELECT [KernAgg_B1].[KEY] AS [KEY], [KernAgg_B1].[OVO_Class1] AS [OVO_Class1], [KernAgg_B1].[OVO_Class2] AS [OVO_Class2], [KernAgg_B1].[OVO_Decision] AS [OVO_Decision], [KernAgg_B1].[OVO_Confidence] AS [OVO_Confidence] 
FROM ##TMP_20180516122739_CODEGEN_44249P_KernAgg_B1 AS [KernAgg_B1] UNION ALL SELECT [KernAgg_B2].[KEY] AS [KEY], [KernAgg_B2].[OVO_Class1] AS [OVO_Class1], [KernAgg_B2].[OVO_Class2] AS [OVO_Class2], [KernAgg_B2].[OVO_Decision] AS [OVO_Decision], [KernAgg_B2].[OVO_Confidence] AS [OVO_Confidence] 
FROM ##TMP_20180516122739_CODEGEN_3V05BV_KernAgg_B2 AS [KernAgg_B2]) AS [KernAgg_EnsembleUnion]), 
[OVO_Votes] AS 
...
FROM [OVO_Votes], [MinMaxConf])
 INSERT INTO ##TMP_20180516122739_CODEGEN_NWSA7S_KernAgg ([KEY], [OVO_Vote_0], [OVO_SumConfidence_0], [OVO_Vote_1], [OVO_SumConfidence_1], [OVO_Vote_2], [OVO_SumConfidence_2], max_abs_confidence, [OVO_Scale], [Score_0], [Score_1], [Score_2]) SELECT [KernAgg].[KEY], [KernAgg].[OVO_Vote_0], [KernAgg].[OVO_SumConfidence_0], [KernAgg].[OVO_Vote_1], [KernAgg].[OVO_SumConfidence_1], [KernAgg].[OVO_Vote_2], [KernAgg].[OVO_SumConfidence_2], [KernAgg].max_abs_confidence, [KernAgg].[OVO_Scale], [KernAgg].[Score_0], [KernAgg].[Score_1], [KernAgg].[Score_2] 
...
FROM ##TMP_20180516122739_CODEGEN_NWSA7S_KernAgg AS [KernAgg]), 
