...
-- Code For temporary table ##TMP_20180602153057_M4T_KernAgg_B0 part 1. Create 


CREATE TABLE ##TMP_20180602153057_M4T_KernAgg_B0 (
	[KEY] BIGINT NULL, 
...
-- Code For temporary table ##TMP_20180602153057_M4T_KernAgg_B0 part 2. Populate
...
kernel_cte_0_1 AS 
(SELECT kernel_dp_0_1.[KEY] AS [KEY], 0 AS [OVO_Class1], 1 AS [OVO_Class2], CASE WHEN (-kernel_dp_0_1.dot_product >= 0.0) THEN 1 ELSE 0 END AS [OVO_Decision], coalesce(-kernel_dp_0_1.dot_product, 1.0 / (1.0 + exp(CASE WHEN (CASE WHEN (-100.0 <= -(-((-kernel_dp_0_1.dot_product) * -2.173342142583008 + -0.5426918309050354))) THEN -(-((-kernel_dp_0_1.dot_product) * -2.173342142583008 + -0.5426918309050354)) ELSE -100.0 END <= 100.0) THEN CASE WHEN (-100.0 <= -(-((-kernel_dp_0_1.dot_product) * -2.173342142583008 + -0.5426918309050354))) THEN -(-((-kernel_dp_0_1.dot_product) * -2.173342142583008 + -0.5426918309050354)) ELSE -100.0 END ELSE 100.0 END))) AS [OVO_Conf] 
FROM kernel_dp_0_1)
 INSERT INTO ##TMP_20180602153057_M4T_KernAgg_B0 ([KEY], [OVO_Class1], [OVO_Class2], [OVO_Decision], [OVO_Conf]) SELECT [KernAgg_B0].[KEY], [KernAgg_B0].[OVO_Class1], [KernAgg_B0].[OVO_Class2], [KernAgg_B0].[OVO_Decision], [KernAgg_B0].[OVO_Conf] 
...
-- Code For temporary table ##TMP_20180602153057_MM4_KernAgg_B1 part 1. Create 


CREATE TABLE ##TMP_20180602153057_MM4_KernAgg_B1 (
	[KEY] BIGINT NULL, 
	[OVO_Class1] BIGINT NULL, 
	[OVO_Class2] BIGINT NULL, 
	[OVO_Decision] BIGINT NULL, 
...
-- Code For temporary table ##TMP_20180602153057_MM4_KernAgg_B1 part 2. Populate
...
kernel_cte_0_2 AS 
(SELECT kernel_dp_0_2.[KEY] AS [KEY], 0 AS [OVO_Class1], 2 AS [OVO_Class2], CASE WHEN (-kernel_dp_0_2.dot_product >= 0.0) THEN 1 ELSE 0 END AS [OVO_Decision], coalesce(-kernel_dp_0_2.dot_product, 1.0 / (1.0 + exp(CASE WHEN (CASE WHEN (-100.0 <= -(-((-kernel_dp_0_2.dot_product) * -2.772557226843784 + -0.24007290453975966))) THEN -(-((-kernel_dp_0_2.dot_product) * -2.772557226843784 + -0.24007290453975966)) ELSE -100.0 END <= 100.0) THEN CASE WHEN (-100.0 <= -(-((-kernel_dp_0_2.dot_product) * -2.772557226843784 + -0.24007290453975966))) THEN -(-((-kernel_dp_0_2.dot_product) * -2.772557226843784 + -0.24007290453975966)) ELSE -100.0 END ELSE 100.0 END))) AS [OVO_Conf] 
FROM kernel_dp_0_2)
 INSERT INTO ##TMP_20180602153057_MM4_KernAgg_B1 ([KEY], [OVO_Class1], [OVO_Class2], [OVO_Decision], [OVO_Conf]) SELECT [KernAgg_B1].[KEY], [KernAgg_B1].[OVO_Class1], [KernAgg_B1].[OVO_Class2], [KernAgg_B1].[OVO_Decision], [KernAgg_B1].[OVO_Conf] 
...
-- Code For temporary table ##TMP_20180602153057_RF0_KernAgg_B2 part 1. Create 


CREATE TABLE ##TMP_20180602153057_RF0_KernAgg_B2 (
	[KEY] BIGINT NULL, 
	[OVO_Class1] BIGINT NULL, 
	[OVO_Class2] BIGINT NULL, 
	[OVO_Decision] BIGINT NULL, 
...
-- Code For temporary table ##TMP_20180602153057_RF0_KernAgg_B2 part 2. Populate
...
kernel_cte_1_2 AS 
(SELECT kernel_dp_1_2.[KEY] AS [KEY], 1 AS [OVO_Class1], 2 AS [OVO_Class2], CASE WHEN (-kernel_dp_1_2.dot_product >= 0.0) THEN 1 ELSE 0 END AS [OVO_Decision], coalesce(-kernel_dp_1_2.dot_product, 1.0 / (1.0 + exp(CASE WHEN (CASE WHEN (-100.0 <= -(-((-kernel_dp_1_2.dot_product) * -2.3995329040757887 + 0.08036647181917947))) THEN -(-((-kernel_dp_1_2.dot_product) * -2.3995329040757887 + 0.08036647181917947)) ELSE -100.0 END <= 100.0) THEN CASE WHEN (-100.0 <= -(-((-kernel_dp_1_2.dot_product) * -2.3995329040757887 + 0.08036647181917947))) THEN -(-((-kernel_dp_1_2.dot_product) * -2.3995329040757887 + 0.08036647181917947)) ELSE -100.0 END ELSE 100.0 END))) AS [OVO_Conf] 
FROM kernel_dp_1_2)
 INSERT INTO ##TMP_20180602153057_RF0_KernAgg_B2 ([KEY], [OVO_Class1], [OVO_Class2], [OVO_Decision], [OVO_Conf]) SELECT [KernAgg_B2].[KEY], [KernAgg_B2].[OVO_Class1], [KernAgg_B2].[OVO_Class2], [KernAgg_B2].[OVO_Decision], [KernAgg_B2].[OVO_Conf] 
...
-- Code For temporary table ##TMP_20180602153057_VEX_KernAgg_agg part 1. Create 


CREATE TABLE ##TMP_20180602153057_VEX_KernAgg_agg (
	[KEY] BIGINT NULL, 
...
-- Code For temporary table ##TMP_20180602153057_VEX_KernAgg_agg part 2. Populate
...
FROM ##TMP_20180602153057_M4T_KernAgg_B0 AS [KernAgg_B0] UNION ALL SELECT [KernAgg_B1].[KEY] AS [KEY], [KernAgg_B1].[OVO_Class1] AS [OVO_Class1], [KernAgg_B1].[OVO_Class2] AS [OVO_Class2], [KernAgg_B1].[OVO_Decision] AS [OVO_Decision], [KernAgg_B1].[OVO_Conf] AS [OVO_Conf] 
FROM ##TMP_20180602153057_MM4_KernAgg_B1 AS [KernAgg_B1] UNION ALL SELECT [KernAgg_B2].[KEY] AS [KEY], [KernAgg_B2].[OVO_Class1] AS [OVO_Class1], [KernAgg_B2].[OVO_Class2] AS [OVO_Class2], [KernAgg_B2].[OVO_Decision] AS [OVO_Decision], [KernAgg_B2].[OVO_Conf] AS [OVO_Conf] 
FROM ##TMP_20180602153057_RF0_KernAgg_B2 AS [KernAgg_B2]) AS [KernAgg_EnsembleUnion]), 
[OVO_Votes] AS 
...
FROM ##TMP_20180602153057_VEX_KernAgg_agg AS [KernAgg_agg]), 
