...
-- Code For temporary table tmp_20180516122739_codegen_lvuywq_kernagg_b0 part 1. Create 

CREATE TEMPORARY TABLE `tmp_20180516122739_codegen_lvuywq_kernagg_b0` STORED AS ORC AS WITH `kernel_input` AS 
...
`kernel_cte_0_1` AS 
(SELECT `kernel_dp_0_1`.`KEY` AS `KEY`, 0 AS `OVO_Class1`, 1 AS `OVO_Class2`, CASE WHEN (-`kernel_dp_0_1`.`dot_product` >= 0.0) THEN 1 ELSE 0 END AS `OVO_Decision`, coalesce(-`kernel_dp_0_1`.`dot_product`, 1.0 / (1.0 + exp(-(-((-`kernel_dp_0_1`.`dot_product`) * -2.1794381146878 + -0.5515687986009299))))) AS `OVO_Confidence` 
FROM `kernel_dp_0_1`)
...
-- Code For temporary table tmp_20180516122739_codegen_lvuywq_kernagg_b0 part 2. Populate

SELECT * FROM `tmp_20180516122739_codegen_lvuywq_kernagg_b0`

-- Code For temporary table tmp_20180516122739_codegen_ngi3p9_kernagg_b1 part 1. Create 

CREATE TEMPORARY TABLE `tmp_20180516122739_codegen_ngi3p9_kernagg_b1` STORED AS ORC AS WITH `kernel_input` AS 
(SELECT `ADS`.`KEY` AS `KEY`, CAST(`ADS`.`Feature_0` AS DOUBLE) AS `Feature_0`, CAST(`ADS`.`Feature_1` AS DOUBLE) AS `Feature_1`, CAST(`ADS`.`Feature_2` AS DOUBLE) AS `Feature_2`, CAST(`ADS`.`Feature_3` AS DOUBLE) AS `Feature_3`, CAST(`ADS`.`TGT` AS DOUBLE) AS `TGT` 
FROM `iris` AS `ADS`), 
`SV_data_0_2` AS 
(SELECT `Values`.`sv_idx` AS `sv_idx`, CAST(`Values`.`dual_coeff` AS DOUBLE) AS `dual_coeff`, CAST(`Values`.`sv_0` AS DOUBLE) AS `sv_0`, CAST(`Values`.`sv_1` AS DOUBLE) AS `sv_1`, CAST(`Values`.`sv_2` AS DOUBLE) AS `sv_2`, CAST(`Values`.`sv_3` AS DOUBLE) AS `sv_3` 
...
`kernel_cte_0_2` AS 
(SELECT `kernel_dp_0_2`.`KEY` AS `KEY`, 0 AS `OVO_Class1`, 2 AS `OVO_Class2`, CASE WHEN (-`kernel_dp_0_2`.`dot_product` >= 0.0) THEN 1 ELSE 0 END AS `OVO_Decision`, coalesce(-`kernel_dp_0_2`.`dot_product`, 1.0 / (1.0 + exp(-(-((-`kernel_dp_0_2`.`dot_product`) * -2.7771425999234127 + -0.22635405937075895))))) AS `OVO_Confidence` 
FROM `kernel_dp_0_2`)
...
-- Code For temporary table tmp_20180516122739_codegen_ngi3p9_kernagg_b1 part 2. Populate

SELECT * FROM `tmp_20180516122739_codegen_ngi3p9_kernagg_b1`

-- Code For temporary table tmp_20180516122739_codegen_he1dwc_kernagg_b2 part 1. Create 

CREATE TEMPORARY TABLE `tmp_20180516122739_codegen_he1dwc_kernagg_b2` STORED AS ORC AS WITH `kernel_input` AS 
(SELECT `ADS`.`KEY` AS `KEY`, CAST(`ADS`.`Feature_0` AS DOUBLE) AS `Feature_0`, CAST(`ADS`.`Feature_1` AS DOUBLE) AS `Feature_1`, CAST(`ADS`.`Feature_2` AS DOUBLE) AS `Feature_2`, CAST(`ADS`.`Feature_3` AS DOUBLE) AS `Feature_3`, CAST(`ADS`.`TGT` AS DOUBLE) AS `TGT` 
FROM `iris` AS `ADS`), 
`SV_data_1_2` AS 
(SELECT `Values`.`sv_idx` AS `sv_idx`, CAST(`Values`.`dual_coeff` AS DOUBLE) AS `dual_coeff`, CAST(`Values`.`sv_0` AS DOUBLE) AS `sv_0`, CAST(`Values`.`sv_1` AS DOUBLE) AS `sv_1`, CAST(`Values`.`sv_2` AS DOUBLE) AS `sv_2`, CAST(`Values`.`sv_3` AS DOUBLE) AS `sv_3` 
...
`kernel_cte_1_2` AS 
(SELECT `kernel_dp_1_2`.`KEY` AS `KEY`, 1 AS `OVO_Class1`, 2 AS `OVO_Class2`, CASE WHEN (-`kernel_dp_1_2`.`dot_product` >= 0.0) THEN 1 ELSE 0 END AS `OVO_Decision`, coalesce(-`kernel_dp_1_2`.`dot_product`, 1.0 / (1.0 + exp(-(-((-`kernel_dp_1_2`.`dot_product`) * -2.2814207267964486 + 0.09246370690294264))))) AS `OVO_Confidence` 
FROM `kernel_dp_1_2`)
...
-- Code For temporary table tmp_20180516122739_codegen_he1dwc_kernagg_b2 part 2. Populate

SELECT * FROM `tmp_20180516122739_codegen_he1dwc_kernagg_b2`

-- Code For temporary table tmp_20180516122739_codegen_jaqw0u_kernagg part 1. Create 

CREATE TEMPORARY TABLE `tmp_20180516122739_codegen_jaqw0u_kernagg` STORED AS ORC AS WITH `KernAgg_Union` AS 
...
FROM `tmp_20180516122739_codegen_lvuywq_kernagg_b0` AS `KernAgg_B0` UNION ALL SELECT `KernAgg_B1`.`KEY` AS `KEY`, `KernAgg_B1`.`OVO_Class1` AS `OVO_Class1`, `KernAgg_B1`.`OVO_Class2` AS `OVO_Class2`, `KernAgg_B1`.`OVO_Decision` AS `OVO_Decision`, `KernAgg_B1`.`OVO_Confidence` AS `OVO_Confidence` 
FROM `tmp_20180516122739_codegen_ngi3p9_kernagg_b1` AS `KernAgg_B1` UNION ALL SELECT `KernAgg_B2`.`KEY` AS `KEY`, `KernAgg_B2`.`OVO_Class1` AS `OVO_Class1`, `KernAgg_B2`.`OVO_Class2` AS `OVO_Class2`, `KernAgg_B2`.`OVO_Decision` AS `OVO_Decision`, `KernAgg_B2`.`OVO_Confidence` AS `OVO_Confidence` 
FROM `tmp_20180516122739_codegen_he1dwc_kernagg_b2` AS `KernAgg_B2`) AS `KernAgg_EnsembleUnion`), 
`OVO_Votes` AS 
...
-- Code For temporary table tmp_20180516122739_codegen_jaqw0u_kernagg part 2. Populate

SELECT * FROM `tmp_20180516122739_codegen_jaqw0u_kernagg`
...
FROM `tmp_20180516122739_codegen_jaqw0u_kernagg` AS `KernAgg`), 
