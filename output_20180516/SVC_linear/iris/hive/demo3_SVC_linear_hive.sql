...
-- Code For temporary table tmp_20180509004608_codegen_d0he9l_kernagg_b0 part 1. Create 

CREATE TEMPORARY TABLE `tmp_20180509004608_codegen_d0he9l_kernagg_b0` STORED AS ORC AS WITH `kernel_input` AS 
...
`kernel_cte_0_1` AS 
(SELECT `kernel_dp_0_1`.`KEY` AS `KEY`, 0 AS `OVO_Class1`, 1 AS `OVO_Class2`, CASE WHEN (-`kernel_dp_0_1`.`dot_product` >= 0.0) THEN 1 ELSE 0 END AS `OVO_Decision`, coalesce(-`kernel_dp_0_1`.`dot_product`, 1.0 / (1.0 + exp(-(-((-`kernel_dp_0_1`.`dot_product`) * -2.1900631925091005 + -0.5447682610355996))))) AS `OVO_Confidence` 
FROM `kernel_dp_0_1`), 
`SV_data_0_2` AS 
(SELECT `Values`.`sv_idx` AS `sv_idx`, CAST(`Values`.`dual_coeff` AS DOUBLE) AS `dual_coeff`, CAST(`Values`.`sv_0` AS DOUBLE) AS `sv_0`, CAST(`Values`.`sv_1` AS DOUBLE) AS `sv_1`, CAST(`Values`.`sv_2` AS DOUBLE) AS `sv_2`, CAST(`Values`.`sv_3` AS DOUBLE) AS `sv_3` 
...
`kernel_cte_0_2` AS 
(SELECT `kernel_dp_0_2`.`KEY` AS `KEY`, 0 AS `OVO_Class1`, 2 AS `OVO_Class2`, CASE WHEN (-`kernel_dp_0_2`.`dot_product` >= 0.0) THEN 1 ELSE 0 END AS `OVO_Decision`, coalesce(-`kernel_dp_0_2`.`dot_product`, 1.0 / (1.0 + exp(-(-((-`kernel_dp_0_2`.`dot_product`) * -2.786515017444998 + -0.2802567601562554))))) AS `OVO_Confidence` 
FROM `kernel_dp_0_2`), 
`SV_data_1_2` AS 
(SELECT `Values`.`sv_idx` AS `sv_idx`, CAST(`Values`.`dual_coeff` AS DOUBLE) AS `dual_coeff`, CAST(`Values`.`sv_0` AS DOUBLE) AS `sv_0`, CAST(`Values`.`sv_1` AS DOUBLE) AS `sv_1`, CAST(`Values`.`sv_2` AS DOUBLE) AS `sv_2`, CAST(`Values`.`sv_3` AS DOUBLE) AS `sv_3` 
...
`kernel_cte_1_2` AS 
(SELECT `kernel_dp_1_2`.`KEY` AS `KEY`, 1 AS `OVO_Class1`, 2 AS `OVO_Class2`, CASE WHEN (-`kernel_dp_1_2`.`dot_product` >= 0.0) THEN 1 ELSE 0 END AS `OVO_Decision`, coalesce(-`kernel_dp_1_2`.`dot_product`, 1.0 / (1.0 + exp(-(-((-`kernel_dp_1_2`.`dot_product`) * -2.4105670269730624 + 0.059622871511643284))))) AS `OVO_Confidence` 
FROM `kernel_dp_1_2`)
...
-- Code For temporary table tmp_20180509004608_codegen_d0he9l_kernagg_b0 part 2. Populate

SELECT * FROM `tmp_20180509004608_codegen_d0he9l_kernagg_b0`

-- Code For temporary table tmp_20180509004608_codegen_osueqb_kernagg_union part 1. Create 

CREATE TEMPORARY TABLE `tmp_20180509004608_codegen_osueqb_kernagg_union` STORED AS ORC AS SELECT `KernAgg_Union`.`KEY`, `KernAgg_Union`.`OVO_Class1`, `KernAgg_Union`.`OVO_Class2`, `KernAgg_Union`.`OVO_Decision`, `KernAgg_Union`.`OVO_Confidence` 
...
FROM `tmp_20180509004608_codegen_d0he9l_kernagg_b0` AS `KernAgg_B0`) AS `KernAgg_EnsembleUnion`) AS `KernAgg_Union`

-- Code For temporary table tmp_20180509004608_codegen_osueqb_kernagg_union part 2. Populate

SELECT * FROM `tmp_20180509004608_codegen_osueqb_kernagg_union`

-- Code For temporary table tmp_20180509004608_codegen_33c8be_kernagg part 1. Create 

CREATE TEMPORARY TABLE `tmp_20180509004608_codegen_33c8be_kernagg` STORED AS ORC AS WITH `OVO_Votes` AS 
...
FROM `tmp_20180509004608_codegen_osueqb_kernagg_union` AS `KernAgg_Union` GROUP BY `KernAgg_Union`.`KEY`) AS `Votes_Sel`), 
`OVO_SumConf_CTE` AS 
...
-- Code For temporary table tmp_20180509004608_codegen_33c8be_kernagg part 2. Populate

SELECT * FROM `tmp_20180509004608_codegen_33c8be_kernagg`
...
FROM `tmp_20180509004608_codegen_33c8be_kernagg` AS `KernAgg`), 
