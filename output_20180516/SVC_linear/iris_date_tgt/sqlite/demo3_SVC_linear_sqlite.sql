...
-- Code For temporary table TMP_20180602154837_0QA_KernAgg_B0 part 1. Create 


CREATE TEMPORARY TABLE "TMP_20180602154837_0QA_KernAgg_B0" (
	"KEY" BIGINT, 
...
-- Code For temporary table TMP_20180602154837_0QA_KernAgg_B0 part 2. Populate
...
FROM "kernel_dp_1789-07-14T00:00:00.000000000_1789-08-14T00:00:00.000000000")
 INSERT INTO "TMP_20180602154837_0QA_KernAgg_B0" ("KEY", "OVO_Class1", "OVO_Class2", "OVO_Decision", "OVO_Conf") SELECT "KernAgg_B0"."KEY", "KernAgg_B0"."OVO_Class1", "KernAgg_B0"."OVO_Class2", "KernAgg_B0"."OVO_Decision", "KernAgg_B0"."OVO_Conf" 
...
-- Code For temporary table TMP_20180602154837_9UZ_KernAgg_B1 part 1. Create 


CREATE TEMPORARY TABLE "TMP_20180602154837_9UZ_KernAgg_B1" (
	"KEY" BIGINT, 
	"OVO_Class1" VARCHAR COLLATE "utf8", 
	"OVO_Class2" VARCHAR COLLATE "utf8", 
	"OVO_Decision" BIGINT, 
...
-- Code For temporary table TMP_20180602154837_9UZ_KernAgg_B1 part 2. Populate
...
(SELECT "kernel_dp_1789-07-14T00:00:00.000000000_1789-09-14T00:00:00.000000000"."KEY" AS "KEY", '1789-07-14T00:00:00.000000000' AS "OVO_Class1", '1789-09-14T00:00:00.000000000' AS "OVO_Class2", CASE WHEN (-"kernel_dp_1789-07-14T00:00:00.000000000_1789-09-14T00:00:00.000000000".dot_product >= 0.0) THEN 1 ELSE 0 END AS "OVO_Decision", coalesce(-"kernel_dp_1789-07-14T00:00:00.000000000_1789-09-14T00:00:00.000000000".dot_product, 1.0 / (1.0 + exp(min(max(-100.0, -(-((-"kernel_dp_1789-07-14T00:00:00.000000000_1789-09-14T00:00:00.000000000".dot_product) * -2.781913616888565 + -0.24170497967339974))), 100.0)))) AS "OVO_Conf" 
FROM "kernel_dp_1789-07-14T00:00:00.000000000_1789-09-14T00:00:00.000000000")
 INSERT INTO "TMP_20180602154837_9UZ_KernAgg_B1" ("KEY", "OVO_Class1", "OVO_Class2", "OVO_Decision", "OVO_Conf") SELECT "KernAgg_B1"."KEY", "KernAgg_B1"."OVO_Class1", "KernAgg_B1"."OVO_Class2", "KernAgg_B1"."OVO_Decision", "KernAgg_B1"."OVO_Conf" 
...
-- Code For temporary table TMP_20180602154837_PL3_KernAgg_B2 part 1. Create 


CREATE TEMPORARY TABLE "TMP_20180602154837_PL3_KernAgg_B2" (
	"KEY" BIGINT, 
	"OVO_Class1" VARCHAR COLLATE "utf8", 
	"OVO_Class2" VARCHAR COLLATE "utf8", 
	"OVO_Decision" BIGINT, 
...
-- Code For temporary table TMP_20180602154837_PL3_KernAgg_B2 part 2. Populate
...
FROM "kernel_dp_1789-08-14T00:00:00.000000000_1789-09-14T00:00:00.000000000")
 INSERT INTO "TMP_20180602154837_PL3_KernAgg_B2" ("KEY", "OVO_Class1", "OVO_Class2", "OVO_Decision", "OVO_Conf") SELECT "KernAgg_B2"."KEY", "KernAgg_B2"."OVO_Class1", "KernAgg_B2"."OVO_Class2", "KernAgg_B2"."OVO_Decision", "KernAgg_B2"."OVO_Conf" 
...
-- Code For temporary table TMP_20180602154837_WAR_KernAgg_agg part 1. Create 


CREATE TEMPORARY TABLE "TMP_20180602154837_WAR_KernAgg_agg" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20180602154837_WAR_KernAgg_agg part 2. Populate
...
FROM "TMP_20180602154837_0QA_KernAgg_B0" AS "KernAgg_B0" UNION ALL SELECT "KernAgg_B1"."KEY" AS "KEY", "KernAgg_B1"."OVO_Class1" AS "OVO_Class1", "KernAgg_B1"."OVO_Class2" AS "OVO_Class2", "KernAgg_B1"."OVO_Decision" AS "OVO_Decision", "KernAgg_B1"."OVO_Conf" AS "OVO_Conf" 
FROM "TMP_20180602154837_9UZ_KernAgg_B1" AS "KernAgg_B1" UNION ALL SELECT "KernAgg_B2"."KEY" AS "KEY", "KernAgg_B2"."OVO_Class1" AS "OVO_Class1", "KernAgg_B2"."OVO_Class2" AS "OVO_Class2", "KernAgg_B2"."OVO_Decision" AS "OVO_Decision", "KernAgg_B2"."OVO_Conf" AS "OVO_Conf" 
FROM "TMP_20180602154837_PL3_KernAgg_B2" AS "KernAgg_B2") AS "KernAgg_EnsembleUnion"), 
"OVO_Votes" AS 
...
-- Code For temporary table TMP_20180602154837_WAR_KernAgg_agg part 3. Create Index 

CREATE INDEX "ix_TMP_20180602154837_WAR_KernAgg_agg_KEY" ON "TMP_20180602154837_WAR_KernAgg_agg" ("KEY")
...
FROM "TMP_20180602154837_WAR_KernAgg_agg" AS "KernAgg_agg"), 
