...
-- Code For temporary table tmp_20180602154838_uyu_kernagg_b0 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180602154838_uyu_kernagg_b0  (
	"KEY" BIGINT, 
...
-- Code For temporary table tmp_20180602154838_uyu_kernagg_b0 part 2. Populate

INSERT INTO tmp_20180602154838_uyu_kernagg_b0 ("KEY", "OVO_Class1", "OVO_Class2", "OVO_Decision", "OVO_Conf") SELECT "U"."KEY", "U"."OVO_Class1", "U"."OVO_Class2", "U"."OVO_Decision", "U"."OVO_Conf" 
...
-- Code For temporary table tmp_20180602154838_pq1_kernagg_b1 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180602154838_pq1_kernagg_b1  (
	"KEY" BIGINT, 
	"OVO_Class1" LONG VARCHAR, 
	"OVO_Class2" LONG VARCHAR, 
	"OVO_Decision" BIGINT, 
...
-- Code For temporary table tmp_20180602154838_pq1_kernagg_b1 part 2. Populate

INSERT INTO tmp_20180602154838_pq1_kernagg_b1 ("KEY", "OVO_Class1", "OVO_Class2", "OVO_Decision", "OVO_Conf") SELECT "U"."KEY", "U"."OVO_Class1", "U"."OVO_Class2", "U"."OVO_Decision", "U"."OVO_Conf" 
FROM (WITH kernel_input AS 
(SELECT "ADS"."KEY" AS "KEY", CAST("ADS"."Feature_0" AS DOUBLE PRECISION) AS "Feature_0", CAST("ADS"."Feature_1" AS DOUBLE PRECISION) AS "Feature_1", CAST("ADS"."Feature_2" AS DOUBLE PRECISION) AS "Feature_2", CAST("ADS"."Feature_3" AS DOUBLE PRECISION) AS "Feature_3", CAST("ADS"."TGT" AS DOUBLE PRECISION) AS "TGT" 
FROM iris_date_tgt AS "ADS"), 
dummy_cte AS 
...
-- Code For temporary table tmp_20180602154838_kgd_kernagg_b2 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180602154838_kgd_kernagg_b2  (
	"KEY" BIGINT, 
	"OVO_Class1" LONG VARCHAR, 
	"OVO_Class2" LONG VARCHAR, 
	"OVO_Decision" BIGINT, 
...
-- Code For temporary table tmp_20180602154838_kgd_kernagg_b2 part 2. Populate

INSERT INTO tmp_20180602154838_kgd_kernagg_b2 ("KEY", "OVO_Class1", "OVO_Class2", "OVO_Decision", "OVO_Conf") SELECT "U"."KEY", "U"."OVO_Class1", "U"."OVO_Class2", "U"."OVO_Decision", "U"."OVO_Conf" 
FROM (WITH kernel_input AS 
(SELECT "ADS"."KEY" AS "KEY", CAST("ADS"."Feature_0" AS DOUBLE PRECISION) AS "Feature_0", CAST("ADS"."Feature_1" AS DOUBLE PRECISION) AS "Feature_1", CAST("ADS"."Feature_2" AS DOUBLE PRECISION) AS "Feature_2", CAST("ADS"."Feature_3" AS DOUBLE PRECISION) AS "Feature_3", CAST("ADS"."TGT" AS DOUBLE PRECISION) AS "TGT" 
FROM iris_date_tgt AS "ADS"), 
dummy_cte AS 
...
-- Code For temporary table tmp_20180602154838_ksm_kernagg_agg part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180602154838_ksm_kernagg_agg  (
	"KEY" BIGINT, 
...
FROM tmp_20180602154838_uyu_kernagg_b0 AS "KernAgg_B0" UNION ALL SELECT "KernAgg_B1"."KEY" AS "KEY", "KernAgg_B1"."OVO_Class1" AS "OVO_Class1", "KernAgg_B1"."OVO_Class2" AS "OVO_Class2", "KernAgg_B1"."OVO_Decision" AS "OVO_Decision", "KernAgg_B1"."OVO_Conf" AS "OVO_Conf" 
FROM tmp_20180602154838_pq1_kernagg_b1 AS "KernAgg_B1" UNION ALL SELECT "KernAgg_B2"."KEY" AS "KEY", "KernAgg_B2"."OVO_Class1" AS "OVO_Class1", "KernAgg_B2"."OVO_Class2" AS "OVO_Class2", "KernAgg_B2"."OVO_Decision" AS "OVO_Decision", "KernAgg_B2"."OVO_Conf" AS "OVO_Conf" 
FROM tmp_20180602154838_kgd_kernagg_b2 AS "KernAgg_B2") AS "KernAgg_EnsembleUnion"), 
"OVO_Votes" AS 
...
FROM tmp_20180602154838_ksm_kernagg_agg AS "KernAgg_agg"), 
