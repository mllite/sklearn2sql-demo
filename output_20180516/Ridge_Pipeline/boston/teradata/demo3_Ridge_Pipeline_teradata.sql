...
-- Code For temporary table tmp_20180508183112_codegen_plffv2_ads_imp_1_out part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180508183112_codegen_plffv2_ads_imp_1_out  (
	"KEY" BIGINT, 
...
-- Code For temporary table tmp_20180508183112_codegen_v0k4by_ads_sca_2_out part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180508183112_codegen_v0k4by_ads_sca_2_out  (
	"KEY" BIGINT, 
...
FROM tmp_20180508183112_codegen_plffv2_ads_imp_1_out AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT") AS "U"
...
FROM tmp_20180508183112_codegen_v0k4by_ads_sca_2_out AS "ADS_sca_2_OUT"), 
linear_model_cte AS 
