...
-- Code For temporary table tmp_20180602145537_829_ads_imp_1_out part 2. Populate

SELECT * FROM `tmp_20180602145537_829_ads_imp_1_out`

-- Code For temporary table tmp_20180602145537_pva_ads_sca_2_out part 1. Create 

CREATE TEMPORARY TABLE `tmp_20180602145537_pva_ads_sca_2_out` STORED AS ORC AS SELECT `ADS_sca_2_OUT`.`KEY`, `ADS_sca_2_OUT`.`scaler_2`, `ADS_sca_2_OUT`.`scaler_3`, `ADS_sca_2_OUT`.`scaler_4`, `ADS_sca_2_OUT`.`scaler_5`, `ADS_sca_2_OUT`.`scaler_6`, `ADS_sca_2_OUT`.`scaler_7`, `ADS_sca_2_OUT`.`scaler_8`, `ADS_sca_2_OUT`.`scaler_9`, `ADS_sca_2_OUT`.`scaler_10`, `ADS_sca_2_OUT`.`scaler_11`, `ADS_sca_2_OUT`.`scaler_12`, `ADS_sca_2_OUT`.`scaler_13`, `ADS_sca_2_OUT`.`scaler_14` 
...
FROM `tmp_20180602145537_829_ads_imp_1_out` AS `ADS_imp_1_OUT`) AS `ADS_sca_2_OUT`

-- Code For temporary table tmp_20180602145537_pva_ads_sca_2_out part 2. Populate

SELECT * FROM `tmp_20180602145537_pva_ads_sca_2_out`
...
FROM `tmp_20180602145537_pva_ads_sca_2_out` AS `ADS_sca_2_OUT`), 
`linear_model_cte` AS 
