...
-- Code For temporary table TMP_20180508182712_CODEGEN_ED3X part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508182712_CODEGEN_ED3X" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20180508182712_CODEGEN_ED3X part 3. Create Index 

CREATE INDEX "ix_TMP_20180508182712_C_f218" ON "TMP_20180508182712_CODEGEN_ED3X" ("KEY")

-- Code For temporary table TMP_20180508182712_CODEGEN_DRHC part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508182712_CODEGEN_DRHC" (
	"KEY" BIGINT NOT NULL, 
...
FROM "TMP_20180508182712_CODEGEN_ED3X" AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT") AS "U"

-- Code For temporary table TMP_20180508182712_CODEGEN_DRHC part 3. Create Index 

CREATE INDEX "ix_TMP_20180508182712_C_0bee" ON "TMP_20180508182712_CODEGEN_DRHC" ("KEY")
...
FROM "TMP_20180508182712_CODEGEN_DRHC" AS "ADS_sca_2_OUT"), 
linear_model_cte AS 
