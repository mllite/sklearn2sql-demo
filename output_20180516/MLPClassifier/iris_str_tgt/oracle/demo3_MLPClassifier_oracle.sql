...
-- Code For temporary table CODEGEN_YFMLKG_HL_1_RELU_1 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "CODEGEN_YFMLKG_HL_1_RELU_1" (
	"KEY" NUMBER(19), 
...
-- Code For temporary table CODEGEN_YFMLKG_HL_1_RELU_1 part 2. Populate

INSERT INTO "CODEGEN_YFMLKG_HL_1_RELU_1" ("KEY", "NEUR_1_1", "NEUR_1_2", "NEUR_1_3") SELECT "U"."KEY", "U"."NEUR_1_1", "U"."NEUR_1_2", "U"."NEUR_1_3" 
FROM (WITH "IL" AS 
...
-- Code For temporary table ODEGEN_6196NZ_OL_SOFTMAX_1 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "ODEGEN_6196NZ_OL_SOFTMAX_1" (
	"KEY" NUMBER(19), 
...
-- Code For temporary table ODEGEN_6196NZ_OL_SOFTMAX_1 part 2. Populate

INSERT INTO "ODEGEN_6196NZ_OL_SOFTMAX_1" ("KEY", "NEUR_3_1", "NEUR_3_2", "NEUR_3_3") SELECT "U"."KEY", "U"."NEUR_3_1", "U"."NEUR_3_2", "U"."NEUR_3_3" 
...
FROM "CODEGEN_YFMLKG_HL_1_RELU_1" "HL_1_relu_1"), 
"HL_2_relu" AS 
...
FROM "ODEGEN_6196NZ_OL_SOFTMAX_1" "OL_softmax_1"), 
