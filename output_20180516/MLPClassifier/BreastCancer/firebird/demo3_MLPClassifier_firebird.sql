...
-- Code For temporary table TMP_20180602_555_HL_1_RELU_1 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180602_555_HL_1_RELU_1" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20180602_555_HL_1_RELU_1 part 2. Populate

INSERT INTO "TMP_20180602_555_HL_1_RELU_1" ("KEY", "NEUR_1_1", "NEUR_1_2", "NEUR_1_3") SELECT "U"."KEY", "U"."NEUR_1_1", "U"."NEUR_1_2", "U"."NEUR_1_3" 
FROM (WITH "IL" AS 
...
-- Code For temporary table TMP_20180602_555_HL_1_RELU_1 part 3. Create Index 

CREATE INDEX "ix_TMP_20180602_555_HL__0dc7" ON "TMP_20180602_555_HL_1_RELU_1" ("KEY")

-- Code For temporary table TMP_20180602_FWH_OL_LOGISTIC_1 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180602_FWH_OL_LOGISTIC_1" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20180602_FWH_OL_LOGISTIC_1 part 2. Populate

INSERT INTO "TMP_20180602_FWH_OL_LOGISTIC_1" ("KEY", "NEUR_3_1") SELECT "U"."KEY", "U"."NEUR_3_1" 
...
FROM "TMP_20180602_555_HL_1_RELU_1" AS "HL_1_relu_1"), 
"HL_2_relu" AS 
...
-- Code For temporary table TMP_20180602_FWH_OL_LOGISTIC_1 part 3. Create Index 

CREATE INDEX "ix_TMP_20180602_FWH_OL__e1fe" ON "TMP_20180602_FWH_OL_LOGISTIC_1" ("KEY")
...
FROM "TMP_20180602_FWH_OL_LOGISTIC_1" AS "OL_logistic_1"), 
