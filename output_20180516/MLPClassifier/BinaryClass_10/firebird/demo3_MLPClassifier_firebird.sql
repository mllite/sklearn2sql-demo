...
-- Code For temporary table TMP_20180508175910_CODEGEN_370W part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508175910_CODEGEN_370W" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20180508175910_CODEGEN_370W part 2. Populate

INSERT INTO "TMP_20180508175910_CODEGEN_370W" ("KEY", "NEUR_1_1", "NEUR_1_2", "NEUR_1_3") SELECT "U"."KEY", "U"."NEUR_1_1", "U"."NEUR_1_2", "U"."NEUR_1_3" 
FROM (WITH "IL" AS 
...
-- Code For temporary table TMP_20180508175910_CODEGEN_370W part 3. Create Index 

CREATE INDEX "ix_TMP_20180508175910_C_ce76" ON "TMP_20180508175910_CODEGEN_370W" ("KEY")

-- Code For temporary table TMP_20180508175910_CODEGEN_KXF5 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508175910_CODEGEN_KXF5" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20180508175910_CODEGEN_KXF5 part 2. Populate

INSERT INTO "TMP_20180508175910_CODEGEN_KXF5" ("KEY", "NEUR_3_1") SELECT "U"."KEY", "U"."NEUR_3_1" 
...
FROM "TMP_20180508175910_CODEGEN_370W" AS "HL_1_relu_1"), 
"HL_2_relu" AS 
...
-- Code For temporary table TMP_20180508175910_CODEGEN_KXF5 part 3. Create Index 

CREATE INDEX "ix_TMP_20180508175910_C_b70e" ON "TMP_20180508175910_CODEGEN_KXF5" ("KEY")
...
FROM "TMP_20180508175910_CODEGEN_KXF5" AS "OL_logistic_1"), 
