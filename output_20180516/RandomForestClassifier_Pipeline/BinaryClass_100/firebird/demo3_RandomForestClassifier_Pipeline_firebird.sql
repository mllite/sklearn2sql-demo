...
-- Code For temporary table TMP_20180516_CODEGEN_2C1LEW_ADS part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180516_CODEGEN_2C1LEW_ADS" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20180516_CODEGEN_2C1LEW_ADS part 3. Create Index 

CREATE INDEX "ix_TMP_20180516_CODEGEN_0759" ON "TMP_20180516_CODEGEN_2C1LEW_ADS" ("KEY")

-- Code For temporary table TMP_20180516_CODEGEN_RC1KKN_ADS part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180516_CODEGEN_RC1KKN_ADS" (
	"KEY" BIGINT NOT NULL, 
...
FROM "TMP_20180516_CODEGEN_2C1LEW_ADS" AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT") AS "U"

-- Code For temporary table TMP_20180516_CODEGEN_RC1KKN_ADS part 3. Create Index 

CREATE INDEX "ix_TMP_20180516_CODEGEN_9c71" ON "TMP_20180516_CODEGEN_RC1KKN_ADS" ("KEY")

-- Code For temporary table TMP_20180516_CODEGEN_FU4DCO_RF_ part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180516_CODEGEN_FU4DCO_RF_" (
	"KEY" BIGINT, 
...
-- Code For temporary table TMP_20180516_CODEGEN_FU4DCO_RF_ part 2. Populate

INSERT INTO "TMP_20180516_CODEGEN_FU4DCO_RF_" ("KEY", "Score_0", "Proba_0", "LogProba_0", "Score_1", "Proba_1", "LogProba_1") SELECT "U"."KEY", "U"."Score_0", "U"."Proba_0", "U"."LogProba_0", "U"."Score_1", "U"."Proba_1", "U"."LogProba_1" 
...
FROM "TMP_20180516_CODEGEN_RC1KKN_ADS" AS "ADS_sca_2_OUT"), 
"DT_node_data" AS 
...
-- Code For temporary table TMP_20180516_CODEGEN_OSLRUM_RF_ part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180516_CODEGEN_OSLRUM_RF_" (
	"KEY" BIGINT, 
	"Score_0" DOUBLE PRECISION, 
	"Proba_0" DOUBLE PRECISION, 
	"LogProba_0" DOUBLE PRECISION, 
...
-- Code For temporary table TMP_20180516_CODEGEN_OSLRUM_RF_ part 2. Populate

INSERT INTO "TMP_20180516_CODEGEN_OSLRUM_RF_" ("KEY", "Score_0", "Proba_0", "LogProba_0", "Score_1", "Proba_1", "LogProba_1") SELECT "U"."KEY", "U"."Score_0", "U"."Proba_0", "U"."LogProba_0", "U"."Score_1", "U"."Proba_1", "U"."LogProba_1" 
...
-- Code For temporary table TMP_20180516_CODEGEN_DIIX1S_RF_ part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180516_CODEGEN_DIIX1S_RF_" (
	"KEY" BIGINT NOT NULL, 
	"Score_0" DOUBLE PRECISION, 
	"Proba_0" DOUBLE PRECISION, 
	"LogProba_0" DOUBLE PRECISION, 
...
-- Code For temporary table TMP_20180516_CODEGEN_DIIX1S_RF_ part 2. Populate

INSERT INTO "TMP_20180516_CODEGEN_DIIX1S_RF_" ("KEY", "Score_0", "Proba_0", "LogProba_0", "Score_1", "Proba_1", "LogProba_1") SELECT "U"."KEY", "U"."Score_0", "U"."Proba_0", "U"."LogProba_0", "U"."Score_1", "U"."Proba_1", "U"."LogProba_1" 
...
FROM "TMP_20180516_CODEGEN_FU4DCO_RF_" AS "RF_B0" UNION ALL SELECT "RF_B1"."KEY" AS "KEY", "RF_B1"."Score_0" AS "Score_0", "RF_B1"."Proba_0" AS "Proba_0", "RF_B1"."LogProba_0" AS "LogProba_0", "RF_B1"."Score_1" AS "Score_1", "RF_B1"."Proba_1" AS "Proba_1", "RF_B1"."LogProba_1" AS "LogProba_1" 
FROM "TMP_20180516_CODEGEN_OSLRUM_RF_" AS "RF_B1") AS "RF_EnsembleUnion")
...
-- Code For temporary table TMP_20180516_CODEGEN_DIIX1S_RF_ part 3. Create Index 

CREATE INDEX "ix_TMP_20180516_CODEGEN_d721" ON "TMP_20180516_CODEGEN_DIIX1S_RF_" ("KEY")
...
FROM "TMP_20180516_CODEGEN_DIIX1S_RF_" AS "RF_avg"), 
