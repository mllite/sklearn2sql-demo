...
-- Code For temporary table TMP_20180508180414_CODEGEN_N4M3 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508180414_CODEGEN_N4M3" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20180508180414_CODEGEN_N4M3 part 3. Create Index 

CREATE INDEX "ix_TMP_20180508180414_C_a9c4" ON "TMP_20180508180414_CODEGEN_N4M3" ("KEY")

-- Code For temporary table TMP_20180508180414_CODEGEN_CEKH part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508180414_CODEGEN_CEKH" (
	"KEY" BIGINT NOT NULL, 
...
FROM "TMP_20180508180414_CODEGEN_N4M3" AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT") AS "U"

-- Code For temporary table TMP_20180508180414_CODEGEN_CEKH part 3. Create Index 

CREATE INDEX "ix_TMP_20180508180414_C_b3f3" ON "TMP_20180508180414_CODEGEN_CEKH" ("KEY")

-- Code For temporary table TMP_20180508180414_CODEGEN_Z3UX part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508180414_CODEGEN_Z3UX" (
	"KEY" BIGINT, 
...
-- Code For temporary table TMP_20180508180414_CODEGEN_Z3UX part 2. Populate

INSERT INTO "TMP_20180508180414_CODEGEN_Z3UX" ("KEY", "Score_0", "Proba_0", "LogProba_0", "Score_1", "Proba_1", "LogProba_1") SELECT "U"."KEY", "U"."Score_0", "U"."Proba_0", "U"."LogProba_0", "U"."Score_1", "U"."Proba_1", "U"."LogProba_1" 
...
FROM "TMP_20180508180414_CODEGEN_CEKH" AS "ADS_sca_2_OUT"), 
"DT_node_data" AS 
...
FROM (SELECT 4 AS nid, 0.0 AS "P_0.0", 1.0 AS "P_1.0", 1.0 AS "D", 1.0 AS "DP" FROM rdb$database UNION ALL SELECT 5 AS nid, 1.0 AS "P_0.0", 0.0 AS "P_1.0", 0.0 AS "D", 1.0 AS "DP" FROM rdb$database UNION ALL SELECT 6 AS nid, 1.0 AS "P_0.0", 0.0 AS "P_1.0", 0.0 AS "D", 1.0 AS "DP" FROM rdb$database UNION ALL SELECT 7 AS nid, 1.0 AS "P_0.0", 0.0 AS "P_1.0", 0.0 AS "D", 1.0 AS "DP" FROM rdb$database UNION ALL SELECT 10 AS nid, 0.0 AS "P_0.0", 1.0 AS "P_1.0", 1.0 AS "D", 1.0 AS "DP" FROM rdb$database UNION ALL SELECT 11 AS nid, 1.0 AS "P_0.0", 0.0 AS "P_1.0", 0.0 AS "D", 1.0 AS "DP" FROM rdb$database UNION ALL SELECT 14 AS nid, 0.0 AS "P_0.0", 1.0 AS "P_1.0", 1.0 AS "D", 1.0 AS "DP" FROM rdb$database UNION ALL SELECT 15 AS nid, 1.0 AS "P_0.0", 0.0 AS "P_1.0", 0.0 AS "D", 1.0 AS "DP" FROM rdb$database UNION ALL SELECT 17 AS nid, 0.0 AS "P_0.0", 1.0 AS "P_1.0", 1.0 AS "D", 1.0 AS "DP" FROM rdb$database UNION ALL SELECT 18 AS nid, 1.0 AS "P_0.0", 0.0 AS "P_1.0", 0.0 AS "D", 1.0 AS "DP" FROM rdb$database) AS "Values"), 
"DT_Output" AS 
...
"RF_Model_0" AS 
(SELECT "DT_Output"."KEY" AS "KEY", CAST(NULL AS DOUBLE PRECISION) AS "Score_0", "DT_Output"."P_0.0" AS "Proba_0", CASE WHEN ("DT_Output"."P_0.0" IS NULL OR "DT_Output"."P_0.0" > 0.0) THEN ln("DT_Output"."P_0.0") ELSE -1e+20 END AS "LogProba_0", CAST(NULL AS DOUBLE PRECISION) AS "Score_1", "DT_Output"."P_1.0" AS "Proba_1", CASE WHEN ("DT_Output"."P_1.0" IS NULL OR "DT_Output"."P_1.0" > 0.0) THEN ln("DT_Output"."P_1.0") ELSE -1e+20 END AS "LogProba_1" 
FROM "DT_Output"), 
"DT_node_lookup_1" AS 
...
"DT_node_data_1" AS 
(SELECT "Values".nid AS nid, CAST("Values"."P_0.0" AS DOUBLE PRECISION) AS "P_0.0", CAST("Values"."P_1.0" AS DOUBLE PRECISION) AS "P_1.0", CAST("Values"."D" AS DOUBLE PRECISION) AS "D", CAST("Values"."DP" AS DOUBLE PRECISION) AS "DP" 
FROM (SELECT 2 AS nid, 0.0 AS "P_0.0", 1.0 AS "P_1.0", 1.0 AS "D", 1.0 AS "DP" FROM rdb$database UNION ALL SELECT 5 AS nid, 0.0 AS "P_0.0", 1.0 AS "P_1.0", 1.0 AS "D", 1.0 AS "DP" FROM rdb$database UNION ALL SELECT 8 AS nid, 0.0 AS "P_0.0", 1.0 AS "P_1.0", 1.0 AS "D", 1.0 AS "DP" FROM rdb$database UNION ALL SELECT 9 AS nid, 1.0 AS "P_0.0", 0.0 AS "P_1.0", 0.0 AS "D", 1.0 AS "DP" FROM rdb$database UNION ALL SELECT 11 AS nid, 1.0 AS "P_0.0", 0.0 AS "P_1.0", 0.0 AS "D", 1.0 AS "DP" FROM rdb$database UNION ALL SELECT 13 AS nid, 0.0 AS "P_0.0", 1.0 AS "P_1.0", 1.0 AS "D", 1.0 AS "DP" FROM rdb$database UNION ALL SELECT 14 AS nid, 1.0 AS "P_0.0", 0.0 AS "P_1.0", 0.0 AS "D", 1.0 AS "DP" FROM rdb$database UNION ALL SELECT 15 AS nid, 0.0 AS "P_0.0", 1.0 AS "P_1.0", 1.0 AS "D", 1.0 AS "DP" FROM rdb$database UNION ALL SELECT 17 AS nid, 0.0 AS "P_0.0", 1.0 AS "P_1.0", 1.0 AS "D", 1.0 AS "DP" FROM rdb$database UNION ALL SELECT 19 AS nid, 1.0 AS "P_0.0", 0.0 AS "P_1.0", 0.0 AS "D", 1.0 AS "DP" FROM rdb$database UNION ALL SELECT 20 AS nid, 0.0 AS "P_0.0", 1.0 AS "P_1.0", 1.0 AS "D", 1.0 AS "DP" FROM rdb$database) AS "Values"), 
"DT_Output_1" AS 
...
"RF_Model_1" AS 
(SELECT "DT_Output_1"."KEY" AS "KEY", CAST(NULL AS DOUBLE PRECISION) AS "Score_0", "DT_Output_1"."P_0.0" AS "Proba_0", CASE WHEN ("DT_Output_1"."P_0.0" IS NULL OR "DT_Output_1"."P_0.0" > 0.0) THEN ln("DT_Output_1"."P_0.0") ELSE -1e+20 END AS "LogProba_0", CAST(NULL AS DOUBLE PRECISION) AS "Score_1", "DT_Output_1"."P_1.0" AS "Proba_1", CASE WHEN ("DT_Output_1"."P_1.0" IS NULL OR "DT_Output_1"."P_1.0" > 0.0) THEN ln("DT_Output_1"."P_1.0") ELSE -1e+20 END AS "LogProba_1" 
FROM "DT_Output_1"), 
"DT_node_lookup_2" AS 
...
"DT_node_data_2" AS 
(SELECT "Values".nid AS nid, CAST("Values"."P_0.0" AS DOUBLE PRECISION) AS "P_0.0", CAST("Values"."P_1.0" AS DOUBLE PRECISION) AS "P_1.0", CAST("Values"."D" AS DOUBLE PRECISION) AS "D", CAST("Values"."DP" AS DOUBLE PRECISION) AS "DP" 
FROM (SELECT 2 AS nid, 0.0 AS "P_0.0", 1.0 AS "P_1.0", 1.0 AS "D", 1.0 AS "DP" FROM rdb$database UNION ALL SELECT 4 AS nid, 1.0 AS "P_0.0", 0.0 AS "P_1.0", 0.0 AS "D", 1.0 AS "DP" FROM rdb$database UNION ALL SELECT 6 AS nid, 0.0 AS "P_0.0", 1.0 AS "P_1.0", 1.0 AS "D", 1.0 AS "DP" FROM rdb$database UNION ALL SELECT 7 AS nid, 1.0 AS "P_0.0", 0.0 AS "P_1.0", 0.0 AS "D", 1.0 AS "DP" FROM rdb$database UNION ALL SELECT 11 AS nid, 0.0 AS "P_0.0", 1.0 AS "P_1.0", 1.0 AS "D", 1.0 AS "DP" FROM rdb$database UNION ALL SELECT 12 AS nid, 1.0 AS "P_0.0", 0.0 AS "P_1.0", 0.0 AS "D", 1.0 AS "DP" FROM rdb$database UNION ALL SELECT 15 AS nid, 0.0 AS "P_0.0", 1.0 AS "P_1.0", 1.0 AS "D", 1.0 AS "DP" FROM rdb$database UNION ALL SELECT 16 AS nid, 1.0 AS "P_0.0", 0.0 AS "P_1.0", 0.0 AS "D", 1.0 AS "DP" FROM rdb$database UNION ALL SELECT 17 AS nid, 1.0 AS "P_0.0", 0.0 AS "P_1.0", 0.0 AS "D", 1.0 AS "DP" FROM rdb$database UNION ALL SELECT 18 AS nid, 0.0 AS "P_0.0", 1.0 AS "P_1.0", 1.0 AS "D", 1.0 AS "DP" FROM rdb$database) AS "Values"), 
"DT_Output_2" AS 
...
"DT_node_data_3" AS 
(SELECT "Values".nid AS nid, CAST("Values"."P_0.0" AS DOUBLE PRECISION) AS "P_0.0", CAST("Values"."P_1.0" AS DOUBLE PRECISION) AS "P_1.0", CAST("Values"."D" AS DOUBLE PRECISION) AS "D", CAST("Values"."DP" AS DOUBLE PRECISION) AS "DP" 
FROM (SELECT 2 AS nid, 0.0 AS "P_0.0", 1.0 AS "P_1.0", 1.0 AS "D", 1.0 AS "DP" FROM rdb$database UNION ALL SELECT 4 AS nid, 0.0 AS "P_0.0", 1.0 AS "P_1.0", 1.0 AS "D", 1.0 AS "DP" FROM rdb$database UNION ALL SELECT 5 AS nid, 1.0 AS "P_0.0", 0.0 AS "P_1.0", 0.0 AS "D", 1.0 AS "DP" FROM rdb$database UNION ALL SELECT 10 AS nid, 0.0 AS "P_0.0", 1.0 AS "P_1.0", 1.0 AS "D", 1.0 AS "DP" FROM rdb$database UNION ALL SELECT 13 AS nid, 0.0 AS "P_0.0", 1.0 AS "P_1.0", 1.0 AS "D", 1.0 AS "DP" FROM rdb$database UNION ALL SELECT 14 AS nid, 1.0 AS "P_0.0", 0.0 AS "P_1.0", 0.0 AS "D", 1.0 AS "DP" FROM rdb$database UNION ALL SELECT 15 AS nid, 0.0 AS "P_0.0", 1.0 AS "P_1.0", 1.0 AS "D", 1.0 AS "DP" FROM rdb$database UNION ALL SELECT 16 AS nid, 0.0 AS "P_0.0", 1.0 AS "P_1.0", 1.0 AS "D", 1.0 AS "DP" FROM rdb$database UNION ALL SELECT 18 AS nid, 0.0 AS "P_0.0", 1.0 AS "P_1.0", 1.0 AS "D", 1.0 AS "DP" FROM rdb$database UNION ALL SELECT 19 AS nid, 1.0 AS "P_0.0", 0.0 AS "P_1.0", 0.0 AS "D", 1.0 AS "DP" FROM rdb$database UNION ALL SELECT 20 AS nid, 1.0 AS "P_0.0", 0.0 AS "P_1.0", 0.0 AS "D", 1.0 AS "DP" FROM rdb$database) AS "Values"), 
"DT_Output_3" AS 
...
"DT_node_data_4" AS 
(SELECT "Values".nid AS nid, CAST("Values"."P_0.0" AS DOUBLE PRECISION) AS "P_0.0", CAST("Values"."P_1.0" AS DOUBLE PRECISION) AS "P_1.0", CAST("Values"."D" AS DOUBLE PRECISION) AS "D", CAST("Values"."DP" AS DOUBLE PRECISION) AS "DP" 
FROM (SELECT 1 AS nid, 0.0 AS "P_0.0", 1.0 AS "P_1.0", 1.0 AS "D", 1.0 AS "DP" FROM rdb$database UNION ALL SELECT 6 AS nid, 0.0 AS "P_0.0", 1.0 AS "P_1.0", 1.0 AS "D", 1.0 AS "DP" FROM rdb$database UNION ALL SELECT 7 AS nid, 1.0 AS "P_0.0", 0.0 AS "P_1.0", 0.0 AS "D", 1.0 AS "DP" FROM rdb$database UNION ALL SELECT 8 AS nid, 0.0 AS "P_0.0", 1.0 AS "P_1.0", 1.0 AS "D", 1.0 AS "DP" FROM rdb$database UNION ALL SELECT 9 AS nid, 0.0 AS "P_0.0", 1.0 AS "P_1.0", 1.0 AS "D", 1.0 AS "DP" FROM rdb$database UNION ALL SELECT 10 AS nid, 0.0 AS "P_0.0", 1.0 AS "P_1.0", 1.0 AS "D", 1.0 AS "DP" FROM rdb$database) AS "Values"), 
"DT_Output_4" AS 
...
"RF_Model_4" AS 
(SELECT "DT_Output_4"."KEY" AS "KEY", CAST(NULL AS DOUBLE PRECISION) AS "Score_0", "DT_Output_4"."P_0.0" AS "Proba_0", CASE WHEN ("DT_Output_4"."P_0.0" IS NULL OR "DT_Output_4"."P_0.0" > 0.0) THEN ln("DT_Output_4"."P_0.0") ELSE -1e+20 END AS "LogProba_0", CAST(NULL AS DOUBLE PRECISION) AS "Score_1", "DT_Output_4"."P_1.0" AS "Proba_1", CASE WHEN ("DT_Output_4"."P_1.0" IS NULL OR "DT_Output_4"."P_1.0" > 0.0) THEN ln("DT_Output_4"."P_1.0") ELSE -1e+20 END AS "LogProba_1" 
FROM "DT_Output_4"), 
"DT_node_lookup_5" AS 
...
"DT_node_data_5" AS 
(SELECT "Values".nid AS nid, CAST("Values"."P_0.0" AS DOUBLE PRECISION) AS "P_0.0", CAST("Values"."P_1.0" AS DOUBLE PRECISION) AS "P_1.0", CAST("Values"."D" AS DOUBLE PRECISION) AS "D", CAST("Values"."DP" AS DOUBLE PRECISION) AS "DP" 
FROM (SELECT 4 AS nid, 0.0 AS "P_0.0", 1.0 AS "P_1.0", 1.0 AS "D", 1.0 AS "DP" FROM rdb$database UNION ALL SELECT 5 AS nid, 1.0 AS "P_0.0", 0.0 AS "P_1.0", 0.0 AS "D", 1.0 AS "DP" FROM rdb$database UNION ALL SELECT 6 AS nid, 1.0 AS "P_0.0", 0.0 AS "P_1.0", 0.0 AS "D", 1.0 AS "DP" FROM rdb$database UNION ALL SELECT 8 AS nid, 1.0 AS "P_0.0", 0.0 AS "P_1.0", 0.0 AS "D", 1.0 AS "DP" FROM rdb$database UNION ALL SELECT 9 AS nid, 0.0 AS "P_0.0", 1.0 AS "P_1.0", 1.0 AS "D", 1.0 AS "DP" FROM rdb$database UNION ALL SELECT 12 AS nid, 1.0 AS "P_0.0", 0.0 AS "P_1.0", 0.0 AS "D", 1.0 AS "DP" FROM rdb$database UNION ALL SELECT 14 AS nid, 1.0 AS "P_0.0", 0.0 AS "P_1.0", 0.0 AS "D", 1.0 AS "DP" FROM rdb$database UNION ALL SELECT 15 AS nid, 0.0 AS "P_0.0", 1.0 AS "P_1.0", 1.0 AS "D", 1.0 AS "DP" FROM rdb$database UNION ALL SELECT 19 AS nid, 1.0 AS "P_0.0", 0.0 AS "P_1.0", 0.0 AS "D", 1.0 AS "DP" FROM rdb$database UNION ALL SELECT 20 AS nid, 0.0 AS "P_0.0", 1.0 AS "P_1.0", 1.0 AS "D", 1.0 AS "DP" FROM rdb$database UNION ALL SELECT 21 AS nid, 1.0 AS "P_0.0", 0.0 AS "P_1.0", 0.0 AS "D", 1.0 AS "DP" FROM rdb$database UNION ALL SELECT 22 AS nid, 1.0 AS "P_0.0", 0.0 AS "P_1.0", 0.0 AS "D", 1.0 AS "DP" FROM rdb$database) AS "Values"), 
"DT_Output_5" AS 
...
"RF_Model_5" AS 
(SELECT "DT_Output_5"."KEY" AS "KEY", CAST(NULL AS DOUBLE PRECISION) AS "Score_0", "DT_Output_5"."P_0.0" AS "Proba_0", CASE WHEN ("DT_Output_5"."P_0.0" IS NULL OR "DT_Output_5"."P_0.0" > 0.0) THEN ln("DT_Output_5"."P_0.0") ELSE -1e+20 END AS "LogProba_0", CAST(NULL AS DOUBLE PRECISION) AS "Score_1", "DT_Output_5"."P_1.0" AS "Proba_1", CASE WHEN ("DT_Output_5"."P_1.0" IS NULL OR "DT_Output_5"."P_1.0" > 0.0) THEN ln("DT_Output_5"."P_1.0") ELSE -1e+20 END AS "LogProba_1" 
FROM "DT_Output_5"), 
"DT_node_lookup_6" AS 
...
"DT_node_data_6" AS 
(SELECT "Values".nid AS nid, CAST("Values"."P_0.0" AS DOUBLE PRECISION) AS "P_0.0", CAST("Values"."P_1.0" AS DOUBLE PRECISION) AS "P_1.0", CAST("Values"."D" AS DOUBLE PRECISION) AS "D", CAST("Values"."DP" AS DOUBLE PRECISION) AS "DP" 
FROM (SELECT 2 AS nid, 0.0 AS "P_0.0", 1.0 AS "P_1.0", 1.0 AS "D", 1.0 AS "DP" FROM rdb$database UNION ALL SELECT 3 AS nid, 1.0 AS "P_0.0", 0.0 AS "P_1.0", 0.0 AS "D", 1.0 AS "DP" FROM rdb$database UNION ALL SELECT 7 AS nid, 1.0 AS "P_0.0", 0.0 AS "P_1.0", 0.0 AS "D", 1.0 AS "DP" FROM rdb$database UNION ALL SELECT 8 AS nid, 0.0 AS "P_0.0", 1.0 AS "P_1.0", 1.0 AS "D", 1.0 AS "DP" FROM rdb$database UNION ALL SELECT 9 AS nid, 1.0 AS "P_0.0", 0.0 AS "P_1.0", 0.0 AS "D", 1.0 AS "DP" FROM rdb$database UNION ALL SELECT 12 AS nid, 1.0 AS "P_0.0", 0.0 AS "P_1.0", 0.0 AS "D", 1.0 AS "DP" FROM rdb$database UNION ALL SELECT 13 AS nid, 0.0 AS "P_0.0", 1.0 AS "P_1.0", 1.0 AS "D", 1.0 AS "DP" FROM rdb$database UNION ALL SELECT 15 AS nid, 1.0 AS "P_0.0", 0.0 AS "P_1.0", 0.0 AS "D", 1.0 AS "DP" FROM rdb$database UNION ALL SELECT 17 AS nid, 0.0 AS "P_0.0", 1.0 AS "P_1.0", 1.0 AS "D", 1.0 AS "DP" FROM rdb$database UNION ALL SELECT 18 AS nid, 1.0 AS "P_0.0", 0.0 AS "P_1.0", 0.0 AS "D", 1.0 AS "DP" FROM rdb$database) AS "Values"), 
"DT_Output_6" AS 
...
"RF_Model_6" AS 
(SELECT "DT_Output_6"."KEY" AS "KEY", CAST(NULL AS DOUBLE PRECISION) AS "Score_0", "DT_Output_6"."P_0.0" AS "Proba_0", CASE WHEN ("DT_Output_6"."P_0.0" IS NULL OR "DT_Output_6"."P_0.0" > 0.0) THEN ln("DT_Output_6"."P_0.0") ELSE -1e+20 END AS "LogProba_0", CAST(NULL AS DOUBLE PRECISION) AS "Score_1", "DT_Output_6"."P_1.0" AS "Proba_1", CASE WHEN ("DT_Output_6"."P_1.0" IS NULL OR "DT_Output_6"."P_1.0" > 0.0) THEN ln("DT_Output_6"."P_1.0") ELSE -1e+20 END AS "LogProba_1" 
FROM "DT_Output_6"), 
"DT_node_lookup_7" AS 
...
"DT_node_data_7" AS 
(SELECT "Values".nid AS nid, CAST("Values"."P_0.0" AS DOUBLE PRECISION) AS "P_0.0", CAST("Values"."P_1.0" AS DOUBLE PRECISION) AS "P_1.0", CAST("Values"."D" AS DOUBLE PRECISION) AS "D", CAST("Values"."DP" AS DOUBLE PRECISION) AS "DP" 
FROM (SELECT 4 AS nid, 1.0 AS "P_0.0", 0.0 AS "P_1.0", 0.0 AS "D", 1.0 AS "DP" FROM rdb$database UNION ALL SELECT 5 AS nid, 0.0 AS "P_0.0", 1.0 AS "P_1.0", 1.0 AS "D", 1.0 AS "DP" FROM rdb$database UNION ALL SELECT 6 AS nid, 1.0 AS "P_0.0", 0.0 AS "P_1.0", 0.0 AS "D", 1.0 AS "DP" FROM rdb$database UNION ALL SELECT 10 AS nid, 1.0 AS "P_0.0", 0.0 AS "P_1.0", 0.0 AS "D", 1.0 AS "DP" FROM rdb$database UNION ALL SELECT 11 AS nid, 0.0 AS "P_0.0", 1.0 AS "P_1.0", 1.0 AS "D", 1.0 AS "DP" FROM rdb$database UNION ALL SELECT 12 AS nid, 1.0 AS "P_0.0", 0.0 AS "P_1.0", 0.0 AS "D", 1.0 AS "DP" FROM rdb$database UNION ALL SELECT 13 AS nid, 0.0 AS "P_0.0", 1.0 AS "P_1.0", 1.0 AS "D", 1.0 AS "DP" FROM rdb$database UNION ALL SELECT 16 AS nid, 0.0 AS "P_0.0", 1.0 AS "P_1.0", 1.0 AS "D", 1.0 AS "DP" FROM rdb$database UNION ALL SELECT 17 AS nid, 1.0 AS "P_0.0", 0.0 AS "P_1.0", 0.0 AS "D", 1.0 AS "DP" FROM rdb$database UNION ALL SELECT 19 AS nid, 1.0 AS "P_0.0", 0.0 AS "P_1.0", 0.0 AS "D", 1.0 AS "DP" FROM rdb$database UNION ALL SELECT 20 AS nid, 0.0 AS "P_0.0", 1.0 AS "P_1.0", 1.0 AS "D", 1.0 AS "DP" FROM rdb$database) AS "Values"), 
"DT_Output_7" AS 
...
"RF_Model_7" AS 
(SELECT "DT_Output_7"."KEY" AS "KEY", CAST(NULL AS DOUBLE PRECISION) AS "Score_0", "DT_Output_7"."P_0.0" AS "Proba_0", CASE WHEN ("DT_Output_7"."P_0.0" IS NULL OR "DT_Output_7"."P_0.0" > 0.0) THEN ln("DT_Output_7"."P_0.0") ELSE -1e+20 END AS "LogProba_0", CAST(NULL AS DOUBLE PRECISION) AS "Score_1", "DT_Output_7"."P_1.0" AS "Proba_1", CASE WHEN ("DT_Output_7"."P_1.0" IS NULL OR "DT_Output_7"."P_1.0" > 0.0) THEN ln("DT_Output_7"."P_1.0") ELSE -1e+20 END AS "LogProba_1" 
FROM "DT_Output_7"), 
"DT_node_lookup_8" AS 
...
"DT_node_data_8" AS 
(SELECT "Values".nid AS nid, CAST("Values"."P_0.0" AS DOUBLE PRECISION) AS "P_0.0", CAST("Values"."P_1.0" AS DOUBLE PRECISION) AS "P_1.0", CAST("Values"."D" AS DOUBLE PRECISION) AS "D", CAST("Values"."DP" AS DOUBLE PRECISION) AS "DP" 
FROM (SELECT 3 AS nid, 1.0 AS "P_0.0", 0.0 AS "P_1.0", 0.0 AS "D", 1.0 AS "DP" FROM rdb$database UNION ALL SELECT 5 AS nid, 0.0 AS "P_0.0", 1.0 AS "P_1.0", 1.0 AS "D", 1.0 AS "DP" FROM rdb$database UNION ALL SELECT 6 AS nid, 1.0 AS "P_0.0", 0.0 AS "P_1.0", 0.0 AS "D", 1.0 AS "DP" FROM rdb$database UNION ALL SELECT 8 AS nid, 1.0 AS "P_0.0", 0.0 AS "P_1.0", 0.0 AS "D", 1.0 AS "DP" FROM rdb$database UNION ALL SELECT 10 AS nid, 1.0 AS "P_0.0", 0.0 AS "P_1.0", 0.0 AS "D", 1.0 AS "DP" FROM rdb$database UNION ALL SELECT 11 AS nid, 0.0 AS "P_0.0", 1.0 AS "P_1.0", 1.0 AS "D", 1.0 AS "DP" FROM rdb$database UNION ALL SELECT 15 AS nid, 1.0 AS "P_0.0", 0.0 AS "P_1.0", 0.0 AS "D", 1.0 AS "DP" FROM rdb$database UNION ALL SELECT 17 AS nid, 0.0 AS "P_0.0", 1.0 AS "P_1.0", 1.0 AS "D", 1.0 AS "DP" FROM rdb$database UNION ALL SELECT 19 AS nid, 1.0 AS "P_0.0", 0.0 AS "P_1.0", 0.0 AS "D", 1.0 AS "DP" FROM rdb$database UNION ALL SELECT 20 AS nid, 0.0 AS "P_0.0", 1.0 AS "P_1.0", 1.0 AS "D", 1.0 AS "DP" FROM rdb$database UNION ALL SELECT 21 AS nid, 1.0 AS "P_0.0", 0.0 AS "P_1.0", 0.0 AS "D", 1.0 AS "DP" FROM rdb$database UNION ALL SELECT 24 AS nid, 1.0 AS "P_0.0", 0.0 AS "P_1.0", 0.0 AS "D", 1.0 AS "DP" FROM rdb$database UNION ALL SELECT 25 AS nid, 0.0 AS "P_0.0", 1.0 AS "P_1.0", 1.0 AS "D", 1.0 AS "DP" FROM rdb$database UNION ALL SELECT 26 AS nid, 1.0 AS "P_0.0", 0.0 AS "P_1.0", 0.0 AS "D", 1.0 AS "DP" FROM rdb$database) AS "Values"), 
"DT_Output_8" AS 
...
"RF_Model_8" AS 
(SELECT "DT_Output_8"."KEY" AS "KEY", CAST(NULL AS DOUBLE PRECISION) AS "Score_0", "DT_Output_8"."P_0.0" AS "Proba_0", CASE WHEN ("DT_Output_8"."P_0.0" IS NULL OR "DT_Output_8"."P_0.0" > 0.0) THEN ln("DT_Output_8"."P_0.0") ELSE -1e+20 END AS "LogProba_0", CAST(NULL AS DOUBLE PRECISION) AS "Score_1", "DT_Output_8"."P_1.0" AS "Proba_1", CASE WHEN ("DT_Output_8"."P_1.0" IS NULL OR "DT_Output_8"."P_1.0" > 0.0) THEN ln("DT_Output_8"."P_1.0") ELSE -1e+20 END AS "LogProba_1" 
FROM "DT_Output_8"), 
"DT_node_lookup_9" AS 
...
"DT_node_data_9" AS 
(SELECT "Values".nid AS nid, CAST("Values"."P_0.0" AS DOUBLE PRECISION) AS "P_0.0", CAST("Values"."P_1.0" AS DOUBLE PRECISION) AS "P_1.0", CAST("Values"."D" AS DOUBLE PRECISION) AS "D", CAST("Values"."DP" AS DOUBLE PRECISION) AS "DP" 
FROM (SELECT 2 AS nid, 1.0 AS "P_0.0", 0.0 AS "P_1.0", 0.0 AS "D", 1.0 AS "DP" FROM rdb$database UNION ALL SELECT 5 AS nid, 0.0 AS "P_0.0", 1.0 AS "P_1.0", 1.0 AS "D", 1.0 AS "DP" FROM rdb$database UNION ALL SELECT 6 AS nid, 1.0 AS "P_0.0", 0.0 AS "P_1.0", 0.0 AS "D", 1.0 AS "DP" FROM rdb$database UNION ALL SELECT 7 AS nid, 1.0 AS "P_0.0", 0.0 AS "P_1.0", 0.0 AS "D", 1.0 AS "DP" FROM rdb$database UNION ALL SELECT 11 AS nid, 1.0 AS "P_0.0", 0.0 AS "P_1.0", 0.0 AS "D", 1.0 AS "DP" FROM rdb$database UNION ALL SELECT 12 AS nid, 0.0 AS "P_0.0", 1.0 AS "P_1.0", 1.0 AS "D", 1.0 AS "DP" FROM rdb$database UNION ALL SELECT 15 AS nid, 1.0 AS "P_0.0", 0.0 AS "P_1.0", 0.0 AS "D", 1.0 AS "DP" FROM rdb$database UNION ALL SELECT 16 AS nid, 0.0 AS "P_0.0", 1.0 AS "P_1.0", 1.0 AS "D", 1.0 AS "DP" FROM rdb$database UNION ALL SELECT 17 AS nid, 1.0 AS "P_0.0", 0.0 AS "P_1.0", 0.0 AS "D", 1.0 AS "DP" FROM rdb$database UNION ALL SELECT 18 AS nid, 0.0 AS "P_0.0", 1.0 AS "P_1.0", 1.0 AS "D", 1.0 AS "DP" FROM rdb$database) AS "Values"), 
"DT_Output_9" AS 
...
-- Code For temporary table TMP_20180508180414_CODEGEN_Z9FM part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508180414_CODEGEN_Z9FM" (
	"KEY" BIGINT, 
	"Score_0" DOUBLE PRECISION, 
	"Proba_0" DOUBLE PRECISION, 
	"LogProba_0" DOUBLE PRECISION, 
...
-- Code For temporary table TMP_20180508180414_CODEGEN_Z9FM part 2. Populate

INSERT INTO "TMP_20180508180414_CODEGEN_Z9FM" ("KEY", "Score_0", "Proba_0", "LogProba_0", "Score_1", "Proba_1", "LogProba_1") SELECT "U"."KEY", "U"."Score_0", "U"."Proba_0", "U"."LogProba_0", "U"."Score_1", "U"."Proba_1", "U"."LogProba_1" 
...
"DT_node_data_10" AS 
(SELECT "Values".nid AS nid, CAST("Values"."P_0.0" AS DOUBLE PRECISION) AS "P_0.0", CAST("Values"."P_1.0" AS DOUBLE PRECISION) AS "P_1.0", CAST("Values"."D" AS DOUBLE PRECISION) AS "D", CAST("Values"."DP" AS DOUBLE PRECISION) AS "DP" 
FROM (SELECT 3 AS nid, 0.0 AS "P_0.0", 1.0 AS "P_1.0", 1.0 AS "D", 1.0 AS "DP" FROM rdb$database UNION ALL SELECT 5 AS nid, 1.0 AS "P_0.0", 0.0 AS "P_1.0", 0.0 AS "D", 1.0 AS "DP" FROM rdb$database UNION ALL SELECT 6 AS nid, 0.0 AS "P_0.0", 1.0 AS "P_1.0", 1.0 AS "D", 1.0 AS "DP" FROM rdb$database UNION ALL SELECT 7 AS nid, 1.0 AS "P_0.0", 0.0 AS "P_1.0", 0.0 AS "D", 1.0 AS "DP" FROM rdb$database UNION ALL SELECT 11 AS nid, 0.0 AS "P_0.0", 1.0 AS "P_1.0", 1.0 AS "D", 1.0 AS "DP" FROM rdb$database UNION ALL SELECT 12 AS nid, 1.0 AS "P_0.0", 0.0 AS "P_1.0", 0.0 AS "D", 1.0 AS "DP" FROM rdb$database UNION ALL SELECT 13 AS nid, 1.0 AS "P_0.0", 0.0 AS "P_1.0", 0.0 AS "D", 1.0 AS "DP" FROM rdb$database UNION ALL SELECT 16 AS nid, 1.0 AS "P_0.0", 0.0 AS "P_1.0", 0.0 AS "D", 1.0 AS "DP" FROM rdb$database UNION ALL SELECT 18 AS nid, 1.0 AS "P_0.0", 0.0 AS "P_1.0", 0.0 AS "D", 1.0 AS "DP" FROM rdb$database UNION ALL SELECT 19 AS nid, 0.0 AS "P_0.0", 1.0 AS "P_1.0", 1.0 AS "D", 1.0 AS "DP" FROM rdb$database UNION ALL SELECT 21 AS nid, 1.0 AS "P_0.0", 0.0 AS "P_1.0", 0.0 AS "D", 1.0 AS "DP" FROM rdb$database UNION ALL SELECT 22 AS nid, 0.0 AS "P_0.0", 1.0 AS "P_1.0", 1.0 AS "D", 1.0 AS "DP" FROM rdb$database) AS "Values"), 
"DT_Output_10" AS 
...
"RF_Model_10" AS 
(SELECT "DT_Output_10"."KEY" AS "KEY", CAST(NULL AS DOUBLE PRECISION) AS "Score_0", "DT_Output_10"."P_0.0" AS "Proba_0", CASE WHEN ("DT_Output_10"."P_0.0" IS NULL OR "DT_Output_10"."P_0.0" > 0.0) THEN ln("DT_Output_10"."P_0.0") ELSE -1e+20 END AS "LogProba_0", CAST(NULL AS DOUBLE PRECISION) AS "Score_1", "DT_Output_10"."P_1.0" AS "Proba_1", CASE WHEN ("DT_Output_10"."P_1.0" IS NULL OR "DT_Output_10"."P_1.0" > 0.0) THEN ln("DT_Output_10"."P_1.0") ELSE -1e+20 END AS "LogProba_1" 
FROM "DT_Output_10"), 
...
"DT_node_data_11" AS 
(SELECT "Values".nid AS nid, CAST("Values"."P_0.0" AS DOUBLE PRECISION) AS "P_0.0", CAST("Values"."P_1.0" AS DOUBLE PRECISION) AS "P_1.0", CAST("Values"."D" AS DOUBLE PRECISION) AS "D", CAST("Values"."DP" AS DOUBLE PRECISION) AS "DP" 
FROM (SELECT 4 AS nid, 1.0 AS "P_0.0", 0.0 AS "P_1.0", 0.0 AS "D", 1.0 AS "DP" FROM rdb$database UNION ALL SELECT 5 AS nid, 0.0 AS "P_0.0", 1.0 AS "P_1.0", 1.0 AS "D", 1.0 AS "DP" FROM rdb$database UNION ALL SELECT 8 AS nid, 0.0 AS "P_0.0", 1.0 AS "P_1.0", 1.0 AS "D", 1.0 AS "DP" FROM rdb$database UNION ALL SELECT 9 AS nid, 1.0 AS "P_0.0", 0.0 AS "P_1.0", 0.0 AS "D", 1.0 AS "DP" FROM rdb$database UNION ALL SELECT 10 AS nid, 1.0 AS "P_0.0", 0.0 AS "P_1.0", 0.0 AS "D", 1.0 AS "DP" FROM rdb$database UNION ALL SELECT 12 AS nid, 0.0 AS "P_0.0", 1.0 AS "P_1.0", 1.0 AS "D", 1.0 AS "DP" FROM rdb$database UNION ALL SELECT 13 AS nid, 1.0 AS "P_0.0", 0.0 AS "P_1.0", 0.0 AS "D", 1.0 AS "DP" FROM rdb$database UNION ALL SELECT 15 AS nid, 0.0 AS "P_0.0", 1.0 AS "P_1.0", 1.0 AS "D", 1.0 AS "DP" FROM rdb$database UNION ALL SELECT 17 AS nid, 0.0 AS "P_0.0", 1.0 AS "P_1.0", 1.0 AS "D", 1.0 AS "DP" FROM rdb$database UNION ALL SELECT 18 AS nid, 1.0 AS "P_0.0", 0.0 AS "P_1.0", 0.0 AS "D", 1.0 AS "DP" FROM rdb$database) AS "Values"), 
"DT_Output_11" AS 
...
"RF_Model_11" AS 
(SELECT "DT_Output_11"."KEY" AS "KEY", CAST(NULL AS DOUBLE PRECISION) AS "Score_0", "DT_Output_11"."P_0.0" AS "Proba_0", CASE WHEN ("DT_Output_11"."P_0.0" IS NULL OR "DT_Output_11"."P_0.0" > 0.0) THEN ln("DT_Output_11"."P_0.0") ELSE -1e+20 END AS "LogProba_0", CAST(NULL AS DOUBLE PRECISION) AS "Score_1", "DT_Output_11"."P_1.0" AS "Proba_1", CASE WHEN ("DT_Output_11"."P_1.0" IS NULL OR "DT_Output_11"."P_1.0" > 0.0) THEN ln("DT_Output_11"."P_1.0") ELSE -1e+20 END AS "LogProba_1" 
FROM "DT_Output_11"), 
...
"DT_node_data_12" AS 
(SELECT "Values".nid AS nid, CAST("Values"."P_0.0" AS DOUBLE PRECISION) AS "P_0.0", CAST("Values"."P_1.0" AS DOUBLE PRECISION) AS "P_1.0", CAST("Values"."D" AS DOUBLE PRECISION) AS "D", CAST("Values"."DP" AS DOUBLE PRECISION) AS "DP" 
FROM (SELECT 4 AS nid, 1.0 AS "P_0.0", 0.0 AS "P_1.0", 0.0 AS "D", 1.0 AS "DP" FROM rdb$database UNION ALL SELECT 5 AS nid, 0.0 AS "P_0.0", 1.0 AS "P_1.0", 1.0 AS "D", 1.0 AS "DP" FROM rdb$database UNION ALL SELECT 6 AS nid, 1.0 AS "P_0.0", 0.0 AS "P_1.0", 0.0 AS "D", 1.0 AS "DP" FROM rdb$database UNION ALL SELECT 9 AS nid, 0.0 AS "P_0.0", 1.0 AS "P_1.0", 1.0 AS "D", 1.0 AS "DP" FROM rdb$database UNION ALL SELECT 10 AS nid, 1.0 AS "P_0.0", 0.0 AS "P_1.0", 0.0 AS "D", 1.0 AS "DP" FROM rdb$database UNION ALL SELECT 11 AS nid, 0.0 AS "P_0.0", 1.0 AS "P_1.0", 1.0 AS "D", 1.0 AS "DP" FROM rdb$database UNION ALL SELECT 14 AS nid, 0.0 AS "P_0.0", 1.0 AS "P_1.0", 1.0 AS "D", 1.0 AS "DP" FROM rdb$database UNION ALL SELECT 16 AS nid, 1.0 AS "P_0.0", 0.0 AS "P_1.0", 0.0 AS "D", 1.0 AS "DP" FROM rdb$database UNION ALL SELECT 17 AS nid, 0.0 AS "P_0.0", 1.0 AS "P_1.0", 1.0 AS "D", 1.0 AS "DP" FROM rdb$database UNION ALL SELECT 19 AS nid, 0.0 AS "P_0.0", 1.0 AS "P_1.0", 1.0 AS "D", 1.0 AS "DP" FROM rdb$database UNION ALL SELECT 20 AS nid, 1.0 AS "P_0.0", 0.0 AS "P_1.0", 0.0 AS "D", 1.0 AS "DP" FROM rdb$database) AS "Values"), 
"DT_Output_12" AS 
...
"RF_Model_12" AS 
(SELECT "DT_Output_12"."KEY" AS "KEY", CAST(NULL AS DOUBLE PRECISION) AS "Score_0", "DT_Output_12"."P_0.0" AS "Proba_0", CASE WHEN ("DT_Output_12"."P_0.0" IS NULL OR "DT_Output_12"."P_0.0" > 0.0) THEN ln("DT_Output_12"."P_0.0") ELSE -1e+20 END AS "LogProba_0", CAST(NULL AS DOUBLE PRECISION) AS "Score_1", "DT_Output_12"."P_1.0" AS "Proba_1", CASE WHEN ("DT_Output_12"."P_1.0" IS NULL OR "DT_Output_12"."P_1.0" > 0.0) THEN ln("DT_Output_12"."P_1.0") ELSE -1e+20 END AS "LogProba_1" 
FROM "DT_Output_12"), 
...
"DT_node_data_13" AS 
(SELECT "Values".nid AS nid, CAST("Values"."P_0.0" AS DOUBLE PRECISION) AS "P_0.0", CAST("Values"."P_1.0" AS DOUBLE PRECISION) AS "P_1.0", CAST("Values"."D" AS DOUBLE PRECISION) AS "D", CAST("Values"."DP" AS DOUBLE PRECISION) AS "DP" 
FROM (SELECT 3 AS nid, 1.0 AS "P_0.0", 0.0 AS "P_1.0", 0.0 AS "D", 1.0 AS "DP" FROM rdb$database UNION ALL SELECT 4 AS nid, 0.0 AS "P_0.0", 1.0 AS "P_1.0", 1.0 AS "D", 1.0 AS "DP" FROM rdb$database UNION ALL SELECT 6 AS nid, 1.0 AS "P_0.0", 0.0 AS "P_1.0", 0.0 AS "D", 1.0 AS "DP" FROM rdb$database UNION ALL SELECT 7 AS nid, 0.0 AS "P_0.0", 1.0 AS "P_1.0", 1.0 AS "D", 1.0 AS "DP" FROM rdb$database UNION ALL SELECT 9 AS nid, 0.0 AS "P_0.0", 1.0 AS "P_1.0", 1.0 AS "D", 1.0 AS "DP" FROM rdb$database UNION ALL SELECT 12 AS nid, 1.0 AS "P_0.0", 0.0 AS "P_1.0", 0.0 AS "D", 1.0 AS "DP" FROM rdb$database UNION ALL SELECT 13 AS nid, 0.0 AS "P_0.0", 1.0 AS "P_1.0", 1.0 AS "D", 1.0 AS "DP" FROM rdb$database UNION ALL SELECT 15 AS nid, 1.0 AS "P_0.0", 0.0 AS "P_1.0", 0.0 AS "D", 1.0 AS "DP" FROM rdb$database UNION ALL SELECT 16 AS nid, 0.0 AS "P_0.0", 1.0 AS "P_1.0", 1.0 AS "D", 1.0 AS "DP" FROM rdb$database) AS "Values"), 
"DT_Output_13" AS 
...
"RF_Model_13" AS 
(SELECT "DT_Output_13"."KEY" AS "KEY", CAST(NULL AS DOUBLE PRECISION) AS "Score_0", "DT_Output_13"."P_0.0" AS "Proba_0", CASE WHEN ("DT_Output_13"."P_0.0" IS NULL OR "DT_Output_13"."P_0.0" > 0.0) THEN ln("DT_Output_13"."P_0.0") ELSE -1e+20 END AS "LogProba_0", CAST(NULL AS DOUBLE PRECISION) AS "Score_1", "DT_Output_13"."P_1.0" AS "Proba_1", CASE WHEN ("DT_Output_13"."P_1.0" IS NULL OR "DT_Output_13"."P_1.0" > 0.0) THEN ln("DT_Output_13"."P_1.0") ELSE -1e+20 END AS "LogProba_1" 
FROM "DT_Output_13"), 
...
"RF_Model_14" AS 
(SELECT "DT_Output_14"."KEY" AS "KEY", CAST(NULL AS DOUBLE PRECISION) AS "Score_0", "DT_Output_14"."P_0.0" AS "Proba_0", CASE WHEN ("DT_Output_14"."P_0.0" IS NULL OR "DT_Output_14"."P_0.0" > 0.0) THEN ln("DT_Output_14"."P_0.0") ELSE -1e+20 END AS "LogProba_0", CAST(NULL AS DOUBLE PRECISION) AS "Score_1", "DT_Output_14"."P_1.0" AS "Proba_1", CASE WHEN ("DT_Output_14"."P_1.0" IS NULL OR "DT_Output_14"."P_1.0" > 0.0) THEN ln("DT_Output_14"."P_1.0") ELSE -1e+20 END AS "LogProba_1" 
FROM "DT_Output_14"), 
...
"DT_node_data_15" AS 
(SELECT "Values".nid AS nid, CAST("Values"."P_0.0" AS DOUBLE PRECISION) AS "P_0.0", CAST("Values"."P_1.0" AS DOUBLE PRECISION) AS "P_1.0", CAST("Values"."D" AS DOUBLE PRECISION) AS "D", CAST("Values"."DP" AS DOUBLE PRECISION) AS "DP" 
FROM (SELECT 1 AS nid, 0.0 AS "P_0.0", 1.0 AS "P_1.0", 1.0 AS "D", 1.0 AS "DP" FROM rdb$database UNION ALL SELECT 3 AS nid, 0.0 AS "P_0.0", 1.0 AS "P_1.0", 1.0 AS "D", 1.0 AS "DP" FROM rdb$database UNION ALL SELECT 7 AS nid, 0.0 AS "P_0.0", 1.0 AS "P_1.0", 1.0 AS "D", 1.0 AS "DP" FROM rdb$database UNION ALL SELECT 10 AS nid, 1.0 AS "P_0.0", 0.0 AS "P_1.0", 0.0 AS "D", 1.0 AS "DP" FROM rdb$database UNION ALL SELECT 11 AS nid, 0.0 AS "P_0.0", 1.0 AS "P_1.0", 1.0 AS "D", 1.0 AS "DP" FROM rdb$database UNION ALL SELECT 12 AS nid, 1.0 AS "P_0.0", 0.0 AS "P_1.0", 0.0 AS "D", 1.0 AS "DP" FROM rdb$database UNION ALL SELECT 14 AS nid, 0.0 AS "P_0.0", 1.0 AS "P_1.0", 1.0 AS "D", 1.0 AS "DP" FROM rdb$database UNION ALL SELECT 15 AS nid, 1.0 AS "P_0.0", 0.0 AS "P_1.0", 0.0 AS "D", 1.0 AS "DP" FROM rdb$database UNION ALL SELECT 17 AS nid, 1.0 AS "P_0.0", 0.0 AS "P_1.0", 0.0 AS "D", 1.0 AS "DP" FROM rdb$database UNION ALL SELECT 18 AS nid, 0.0 AS "P_0.0", 1.0 AS "P_1.0", 1.0 AS "D", 1.0 AS "DP" FROM rdb$database) AS "Values"), 
"DT_Output_15" AS 
...
"RF_Model_15" AS 
(SELECT "DT_Output_15"."KEY" AS "KEY", CAST(NULL AS DOUBLE PRECISION) AS "Score_0", "DT_Output_15"."P_0.0" AS "Proba_0", CASE WHEN ("DT_Output_15"."P_0.0" IS NULL OR "DT_Output_15"."P_0.0" > 0.0) THEN ln("DT_Output_15"."P_0.0") ELSE -1e+20 END AS "LogProba_0", CAST(NULL AS DOUBLE PRECISION) AS "Score_1", "DT_Output_15"."P_1.0" AS "Proba_1", CASE WHEN ("DT_Output_15"."P_1.0" IS NULL OR "DT_Output_15"."P_1.0" > 0.0) THEN ln("DT_Output_15"."P_1.0") ELSE -1e+20 END AS "LogProba_1" 
FROM "DT_Output_15")
...
-- Code For temporary table TMP_20180508180414_CODEGEN_2E9K part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508180414_CODEGEN_2E9K" (
	"KEY" BIGINT, 
	"Score_0" DOUBLE PRECISION, 
	"Proba_0" DOUBLE PRECISION, 
	"LogProba_0" DOUBLE PRECISION, 
...
-- Code For temporary table TMP_20180508180414_CODEGEN_2E9K part 2. Populate

INSERT INTO "TMP_20180508180414_CODEGEN_2E9K" ("KEY", "Score_0", "Proba_0", "LogProba_0", "Score_1", "Proba_1", "LogProba_1") SELECT "U"."KEY", "U"."Score_0", "U"."Proba_0", "U"."LogProba_0", "U"."Score_1", "U"."Proba_1", "U"."LogProba_1" 
...
FROM "TMP_20180508180414_CODEGEN_Z3UX" AS "RF_B0" UNION ALL SELECT "RF_B1"."KEY" AS "KEY", "RF_B1"."Score_0" AS "Score_0", "RF_B1"."Proba_0" AS "Proba_0", "RF_B1"."LogProba_0" AS "LogProba_0", "RF_B1"."Score_1" AS "Score_1", "RF_B1"."Proba_1" AS "Proba_1", "RF_B1"."LogProba_1" AS "LogProba_1" 
FROM "TMP_20180508180414_CODEGEN_Z9FM" AS "RF_B1") AS "RF_EnsembleUnion") AS "RF_Union") AS "U"

-- Code For temporary table TMP_20180508180414_CODEGEN_RJSL part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508180414_CODEGEN_RJSL" (
	"KEY" BIGINT NOT NULL, 
	"Score_0" DOUBLE PRECISION, 
	"Proba_0" DOUBLE PRECISION, 
	"LogProba_0" DOUBLE PRECISION, 
...
-- Code For temporary table TMP_20180508180414_CODEGEN_RJSL part 2. Populate

INSERT INTO "TMP_20180508180414_CODEGEN_RJSL" ("KEY", "Score_0", "Proba_0", "LogProba_0", "Score_1", "Proba_1", "LogProba_1") SELECT "U"."KEY", "U"."Score_0", "U"."Proba_0", "U"."LogProba_0", "U"."Score_1", "U"."Proba_1", "U"."LogProba_1" 
...
FROM "TMP_20180508180414_CODEGEN_2E9K" AS "RF_Union" GROUP BY "RF_Union"."KEY") AS "T") AS "RF_avg") AS "U"

-- Code For temporary table TMP_20180508180414_CODEGEN_RJSL part 3. Create Index 

CREATE INDEX "ix_TMP_20180508180414_C_0cd2" ON "TMP_20180508180414_CODEGEN_RJSL" ("KEY")
...
FROM "TMP_20180508180414_CODEGEN_RJSL" AS "RF_avg"), 
