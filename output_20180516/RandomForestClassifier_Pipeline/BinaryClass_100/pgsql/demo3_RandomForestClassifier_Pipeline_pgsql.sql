...
-- Code For temporary table TMP_20180516111131_CODEGEN_J5YODP_ADS_imp_1_OUT part 1. Create 


CREATE TEMPORARY TABLE "TMP_20180516111131_CODEGEN_J5YODP_ADS_imp_1_OUT" (
	"KEY" BIGINT NOT NULL, 
	impter_2 FLOAT, 
	impter_3 FLOAT, 
	impter_4 FLOAT, 
...
-- Code For temporary table TMP_20180516111131_CODEGEN_J5YODP_ADS_imp_1_OUT part 3. Create Index 

CREATE INDEX "ix_TMP_20180516111131_CODEGEN_J5YODP_ADS_imp_1_OUT_KEY" ON "TMP_20180516111131_CODEGEN_J5YODP_ADS_imp_1_OUT" ("KEY")

-- Code For temporary table TMP_20180516111131_CODEGEN_1RB0UH_ADS_sca_2_OUT part 1. Create 


CREATE TEMPORARY TABLE "TMP_20180516111131_CODEGEN_1RB0UH_ADS_sca_2_OUT" (
	"KEY" BIGINT NOT NULL, 
	scaler_2 FLOAT, 
	scaler_3 FLOAT, 
	scaler_4 FLOAT, 
...
FROM "TMP_20180516111131_CODEGEN_J5YODP_ADS_imp_1_OUT" AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT"

-- Code For temporary table TMP_20180516111131_CODEGEN_1RB0UH_ADS_sca_2_OUT part 3. Create Index 

CREATE INDEX "ix_TMP_20180516111131_CODEGEN_1RB0UH_ADS_sca_2_OUT_KEY" ON "TMP_20180516111131_CODEGEN_1RB0UH_ADS_sca_2_OUT" ("KEY")

-- Code For temporary table TMP_20180516111131_CODEGEN_UTCP56_RF_B0 part 1. Create 


CREATE TEMPORARY TABLE "TMP_20180516111131_CODEGEN_UTCP56_RF_B0" (
	"KEY" BIGINT, 
	"Score_0" FLOAT, 
	"Proba_0" FLOAT, 
	"LogProba_0" FLOAT, 
...
-- Code For temporary table TMP_20180516111131_CODEGEN_UTCP56_RF_B0 part 2. Populate
...
FROM "TMP_20180516111131_CODEGEN_1RB0UH_ADS_sca_2_OUT" AS "ADS_sca_2_OUT"), 
"DT_node_data" AS 
...
FROM "DT_Output_9")
 INSERT INTO "TMP_20180516111131_CODEGEN_UTCP56_RF_B0" ("KEY", "Score_0", "Proba_0", "LogProba_0", "Score_1", "Proba_1", "LogProba_1") SELECT "RF_B0"."KEY", "RF_B0"."Score_0", "RF_B0"."Proba_0", "RF_B0"."LogProba_0", "RF_B0"."Score_1", "RF_B0"."Proba_1", "RF_B0"."LogProba_1" 
...
-- Code For temporary table TMP_20180516111131_CODEGEN_XM09GJ_RF_B1 part 1. Create 


CREATE TEMPORARY TABLE "TMP_20180516111131_CODEGEN_XM09GJ_RF_B1" (
	"KEY" BIGINT, 
	"Score_0" FLOAT, 
	"Proba_0" FLOAT, 
	"LogProba_0" FLOAT, 
...
-- Code For temporary table TMP_20180516111131_CODEGEN_XM09GJ_RF_B1 part 2. Populate
...
FROM "DT_Output_15")
 INSERT INTO "TMP_20180516111131_CODEGEN_XM09GJ_RF_B1" ("KEY", "Score_0", "Proba_0", "LogProba_0", "Score_1", "Proba_1", "LogProba_1") SELECT "RF_B1"."KEY", "RF_B1"."Score_0", "RF_B1"."Proba_0", "RF_B1"."LogProba_0", "RF_B1"."Score_1", "RF_B1"."Proba_1", "RF_B1"."LogProba_1" 
...
-- Code For temporary table TMP_20180516111131_CODEGEN_3CU6HP_RF_avg part 1. Create 


CREATE TEMPORARY TABLE "TMP_20180516111131_CODEGEN_3CU6HP_RF_avg" (
	"KEY" BIGINT NOT NULL, 
	"Score_0" FLOAT, 
	"Proba_0" FLOAT, 
	"LogProba_0" FLOAT, 
...
-- Code For temporary table TMP_20180516111131_CODEGEN_3CU6HP_RF_avg part 2. Populate
...
FROM "TMP_20180516111131_CODEGEN_UTCP56_RF_B0" AS "RF_B0" UNION ALL SELECT "RF_B1"."KEY" AS "KEY", "RF_B1"."Score_0" AS "Score_0", "RF_B1"."Proba_0" AS "Proba_0", "RF_B1"."LogProba_0" AS "LogProba_0", "RF_B1"."Score_1" AS "Score_1", "RF_B1"."Proba_1" AS "Proba_1", "RF_B1"."LogProba_1" AS "LogProba_1" 
FROM "TMP_20180516111131_CODEGEN_XM09GJ_RF_B1" AS "RF_B1") AS "RF_EnsembleUnion")
 INSERT INTO "TMP_20180516111131_CODEGEN_3CU6HP_RF_avg" ("KEY", "Score_0", "Proba_0", "LogProba_0", "Score_1", "Proba_1", "LogProba_1") SELECT "RF_avg"."KEY", "RF_avg"."Score_0", "RF_avg"."Proba_0", "RF_avg"."LogProba_0", "RF_avg"."Score_1", "RF_avg"."Proba_1", "RF_avg"."LogProba_1" 
...
-- Code For temporary table TMP_20180516111131_CODEGEN_3CU6HP_RF_avg part 3. Create Index 

CREATE INDEX "ix_TMP_20180516111131_CODEGEN_3CU6HP_RF_avg_KEY" ON "TMP_20180516111131_CODEGEN_3CU6HP_RF_avg" ("KEY")
...
FROM "TMP_20180516111131_CODEGEN_3CU6HP_RF_avg" AS "RF_avg"), 
