...
-- Code For temporary table tmp_20180508180413_codegen_9ghc9y_ads_imp_1_out part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180508180413_codegen_9ghc9y_ads_imp_1_out  (
	"KEY" BIGINT, 
...
-- Code For temporary table tmp_20180508180413_codegen_iis3b7_ads_sca_2_out part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180508180413_codegen_iis3b7_ads_sca_2_out  (
	"KEY" BIGINT, 
...
FROM tmp_20180508180413_codegen_9ghc9y_ads_imp_1_out AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT") AS "U"

-- Code For temporary table tmp_20180508180414_codegen_wq5dun_rf_b0 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180508180414_codegen_wq5dun_rf_b0  (
	"KEY" BIGINT, 
...
-- Code For temporary table tmp_20180508180414_codegen_wq5dun_rf_b0 part 2. Populate

INSERT INTO tmp_20180508180414_codegen_wq5dun_rf_b0 ("KEY", "Score_0", "Proba_0", "LogProba_0", "Score_1", "Proba_1", "LogProba_1") SELECT "U"."KEY", "U"."Score_0", "U"."Proba_0", "U"."LogProba_0", "U"."Score_1", "U"."Proba_1", "U"."LogProba_1" 
FROM (WITH "DT_node_lookup" AS 
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", CASE WHEN ("ADS_sca_2_OUT".scaler_18 <= CAST(-0.403450787067413 AS DOUBLE PRECISION)) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_47 <= CAST(0.759631037712097 AS DOUBLE PRECISION)) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_61 <= CAST(0.976247668266296 AS DOUBLE PRECISION)) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_12 <= CAST(1.848315715789795 AS DOUBLE PRECISION)) THEN 4 ELSE 5 END ELSE 6 END ELSE 7 END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_96 <= CAST(0.45280796289444 AS DOUBLE PRECISION)) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_6 <= CAST(-0.812352240085602 AS DOUBLE PRECISION)) THEN 10 ELSE 11 END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_52 <= CAST(0.169348046183586 AS DOUBLE PRECISION)) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_100 <= CAST(1.048274278640747 AS DOUBLE PRECISION)) THEN 14 ELSE 15 END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_71 <= CAST(-0.253114432096481 AS DOUBLE PRECISION)) THEN 17 ELSE 18 END END END END AS node_id_2 
FROM tmp_20180508180413_codegen_iis3b7_ads_sca_2_out AS "ADS_sca_2_OUT"), 
dummy_cte AS 
...
FROM "DT_Output"), 
"DT_node_lookup_1" AS 
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", CASE WHEN ("ADS_sca_2_OUT".scaler_59 <= CAST(-0.116237014532089 AS DOUBLE PRECISION)) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_73 <= CAST(-2.054789066314697 AS DOUBLE PRECISION)) THEN 2 ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_37 <= CAST(1.179149746894836 AS DOUBLE PRECISION)) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_51 <= CAST(-1.550766229629516 AS DOUBLE PRECISION)) THEN 5 ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_31 <= CAST(-1.296807408332825 AS DOUBLE PRECISION)) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_99 <= CAST(-0.702167272567749 AS DOUBLE PRECISION)) THEN 8 ELSE 9 END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_76 <= CAST(1.270103693008423 AS DOUBLE PRECISION)) THEN 11 ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_71 <= CAST(0.14787831902504 AS DOUBLE PRECISION)) THEN 13 ELSE 14 END END END END ELSE 15 END END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_88 <= CAST(0.625777006149292 AS DOUBLE PRECISION)) THEN 17 ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_82 <= CAST(0.174378246068954 AS DOUBLE PRECISION)) THEN 19 ELSE 20 END END END AS node_id_2 
FROM tmp_20180508180413_codegen_iis3b7_ads_sca_2_out AS "ADS_sca_2_OUT"), 
dummy_cte_1 AS 
(SELECT CAST(0.0 AS DOUBLE PRECISION) AS "X"), 
"DT_node_data_1" AS 
...
FROM "DT_Output_1"), 
"DT_node_lookup_2" AS 
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", CASE WHEN ("ADS_sca_2_OUT".scaler_62 <= CAST(-0.304730713367462 AS DOUBLE PRECISION)) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_4 <= CAST(0.336807250976562 AS DOUBLE PRECISION)) THEN 2 ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_76 <= CAST(-0.384797930717468 AS DOUBLE PRECISION)) THEN 4 ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_6 <= CAST(0.002933189272881 AS DOUBLE PRECISION)) THEN 6 ELSE 7 END END END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_12 <= CAST(1.287145614624024 AS DOUBLE PRECISION)) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_90 <= CAST(0.518926322460175 AS DOUBLE PRECISION)) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_66 <= CAST(-2.092247247695923 AS DOUBLE PRECISION)) THEN 11 ELSE 12 END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_47 <= CAST(2.189015865325928 AS DOUBLE PRECISION)) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_71 <= CAST(1.57521915435791 AS DOUBLE PRECISION)) THEN 15 ELSE 16 END ELSE 17 END END ELSE 18 END END AS node_id_2 
FROM tmp_20180508180413_codegen_iis3b7_ads_sca_2_out AS "ADS_sca_2_OUT"), 
dummy_cte_2 AS 
(SELECT CAST(0.0 AS DOUBLE PRECISION) AS "X"), 
"DT_node_data_2" AS 
...
FROM "DT_Output_2"), 
"DT_node_lookup_3" AS 
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", CASE WHEN ("ADS_sca_2_OUT".scaler_43 <= CAST(-0.481872528791428 AS DOUBLE PRECISION)) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_6 <= CAST(0.423188745975494 AS DOUBLE PRECISION)) THEN 2 ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_85 <= CAST(-0.307984739542007 AS DOUBLE PRECISION)) THEN 4 ELSE 5 END END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_56 <= CAST(0.990114212036133 AS DOUBLE PRECISION)) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_7 <= CAST(1.240499377250672 AS DOUBLE PRECISION)) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_87 <= CAST(1.531145095825195 AS DOUBLE PRECISION)) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_12 <= CAST(-1.850090861320496 AS DOUBLE PRECISION)) THEN 10 ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_72 <= CAST(1.07930326461792 AS DOUBLE PRECISION)) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_21 <= CAST(-1.98653793334961 AS DOUBLE PRECISION)) THEN 13 ELSE 14 END ELSE 15 END END ELSE 16 END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_72 <= CAST(0.29861980676651 AS DOUBLE PRECISION)) THEN 18 ELSE 19 END END ELSE 20 END END AS node_id_2 
FROM tmp_20180508180413_codegen_iis3b7_ads_sca_2_out AS "ADS_sca_2_OUT"), 
dummy_cte_3 AS 
(SELECT CAST(0.0 AS DOUBLE PRECISION) AS "X"), 
"DT_node_data_3" AS 
...
FROM "DT_Output_3"), 
"DT_node_lookup_4" AS 
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", CASE WHEN ("ADS_sca_2_OUT".scaler_79 <= CAST(-0.617430210113525 AS DOUBLE PRECISION)) THEN 1 ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_13 <= CAST(1.613402843475342 AS DOUBLE PRECISION)) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_29 <= CAST(0.825693488121033 AS DOUBLE PRECISION)) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_60 <= CAST(0.968582451343536 AS DOUBLE PRECISION)) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_90 <= CAST(-2.242637634277344 AS DOUBLE PRECISION)) THEN 6 ELSE 7 END ELSE 8 END ELSE 9 END ELSE 10 END END AS node_id_2 
FROM tmp_20180508180413_codegen_iis3b7_ads_sca_2_out AS "ADS_sca_2_OUT"), 
dummy_cte_4 AS 
(SELECT CAST(0.0 AS DOUBLE PRECISION) AS "X"), 
"DT_node_data_4" AS 
...
FROM "DT_Output_4"), 
"DT_node_lookup_5" AS 
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", CASE WHEN ("ADS_sca_2_OUT".scaler_63 <= CAST(-0.460159510374069 AS DOUBLE PRECISION)) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_5 <= CAST(-0.379783391952515 AS DOUBLE PRECISION)) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_71 <= CAST(1.486094236373901 AS DOUBLE PRECISION)) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_23 <= CAST(0.464598059654236 AS DOUBLE PRECISION)) THEN 4 ELSE 5 END ELSE 6 END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_58 <= CAST(1.524499893188476 AS DOUBLE PRECISION)) THEN 8 ELSE 9 END END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_50 <= CAST(-0.246095687150955 AS DOUBLE PRECISION)) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_48 <= CAST(-1.009908437728882 AS DOUBLE PRECISION)) THEN 12 ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_81 <= CAST(-1.39120101928711 AS DOUBLE PRECISION)) THEN 14 ELSE 15 END END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_60 <= CAST(0.589804530143738 AS DOUBLE PRECISION)) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_75 <= CAST(0.860435843467712 AS DOUBLE PRECISION)) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_61 <= CAST(-1.334168910980224 AS DOUBLE PRECISION)) THEN 19 ELSE 20 END ELSE 21 END ELSE 22 END END END AS node_id_2 
FROM tmp_20180508180413_codegen_iis3b7_ads_sca_2_out AS "ADS_sca_2_OUT"), 
dummy_cte_5 AS 
(SELECT CAST(0.0 AS DOUBLE PRECISION) AS "X"), 
"DT_node_data_5" AS 
...
FROM "DT_Output_5"), 
"DT_node_lookup_6" AS 
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", CASE WHEN ("ADS_sca_2_OUT".scaler_17 <= CAST(-0.744648456573486 AS DOUBLE PRECISION)) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_47 <= CAST(1.025577068328857 AS DOUBLE PRECISION)) THEN 2 ELSE 3 END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_84 <= CAST(0.030773235484958 AS DOUBLE PRECISION)) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_23 <= CAST(-0.346953690052032 AS DOUBLE PRECISION)) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_59 <= CAST(-0.446512639522552 AS DOUBLE PRECISION)) THEN 7 ELSE 8 END ELSE 9 END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_8 <= CAST(0.250704944133759 AS DOUBLE PRECISION)) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_89 <= CAST(-0.984940886497498 AS DOUBLE PRECISION)) THEN 12 ELSE 13 END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_93 <= CAST(-0.110806703567505 AS DOUBLE PRECISION)) THEN 15 ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_99 <= CAST(0.929567456245422 AS DOUBLE PRECISION)) THEN 17 ELSE 18 END END END END END AS node_id_2 
FROM tmp_20180508180413_codegen_iis3b7_ads_sca_2_out AS "ADS_sca_2_OUT"), 
dummy_cte_6 AS 
(SELECT CAST(0.0 AS DOUBLE PRECISION) AS "X"), 
"DT_node_data_6" AS 
...
FROM "DT_Output_6"), 
"DT_node_lookup_7" AS 
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", CASE WHEN ("ADS_sca_2_OUT".scaler_98 <= CAST(0.941371202468872 AS DOUBLE PRECISION)) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_46 <= CAST(0.094082430005074 AS DOUBLE PRECISION)) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_24 <= CAST(1.08374011516571 AS DOUBLE PRECISION)) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_34 <= CAST(-1.337204098701477 AS DOUBLE PRECISION)) THEN 4 ELSE 5 END ELSE 6 END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_43 <= CAST(1.116184234619141 AS DOUBLE PRECISION)) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_79 <= CAST(-0.153110593557358 AS DOUBLE PRECISION)) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_35 <= CAST(-0.568303942680359 AS DOUBLE PRECISION)) THEN 10 ELSE 11 END ELSE 12 END ELSE 13 END END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_19 <= CAST(1.096537113189697 AS DOUBLE PRECISION)) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_82 <= CAST(-1.593812465667724 AS DOUBLE PRECISION)) THEN 16 ELSE 17 END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_42 <= CAST(-0.069496899843216 AS DOUBLE PRECISION)) THEN 19 ELSE 20 END END END AS node_id_2 
FROM tmp_20180508180413_codegen_iis3b7_ads_sca_2_out AS "ADS_sca_2_OUT"), 
dummy_cte_7 AS 
(SELECT CAST(0.0 AS DOUBLE PRECISION) AS "X"), 
"DT_node_data_7" AS 
...
FROM "DT_Output_7"), 
"DT_node_lookup_8" AS 
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", CASE WHEN ("ADS_sca_2_OUT".scaler_29 <= CAST(-0.093676157295704 AS DOUBLE PRECISION)) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_96 <= CAST(1.102672576904297 AS DOUBLE PRECISION)) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_69 <= CAST(0.537236511707306 AS DOUBLE PRECISION)) THEN 3 ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_42 <= CAST(0.653149843215942 AS DOUBLE PRECISION)) THEN 5 ELSE 6 END END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_43 <= CAST(-0.264672100543976 AS DOUBLE PRECISION)) THEN 8 ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_2 <= CAST(-0.493260771036148 AS DOUBLE PRECISION)) THEN 10 ELSE 11 END END END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_72 <= CAST(0.40604105591774 AS DOUBLE PRECISION)) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_83 <= CAST(1.117916584014893 AS DOUBLE PRECISION)) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_49 <= CAST(-0.763413190841675 AS DOUBLE PRECISION)) THEN 15 ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_100 <= CAST(0.130161643028259 AS DOUBLE PRECISION)) THEN 17 ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_6 <= CAST(-0.068035282194614 AS DOUBLE PRECISION)) THEN 19 ELSE 20 END END END ELSE 21 END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_21 <= CAST(0.6836838722229 AS DOUBLE PRECISION)) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_44 <= CAST(-1.661368012428284 AS DOUBLE PRECISION)) THEN 24 ELSE 25 END ELSE 26 END END END AS node_id_2 
FROM tmp_20180508180413_codegen_iis3b7_ads_sca_2_out AS "ADS_sca_2_OUT"), 
dummy_cte_8 AS 
(SELECT CAST(0.0 AS DOUBLE PRECISION) AS "X"), 
"DT_node_data_8" AS 
...
FROM "DT_Output_8"), 
"DT_node_lookup_9" AS 
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", CASE WHEN ("ADS_sca_2_OUT".scaler_97 <= CAST(-0.303664267063141 AS DOUBLE PRECISION)) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_18 <= CAST(-1.131396055221558 AS DOUBLE PRECISION)) THEN 2 ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_46 <= CAST(1.294880390167236 AS DOUBLE PRECISION)) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_6 <= CAST(0.739270210266113 AS DOUBLE PRECISION)) THEN 5 ELSE 6 END ELSE 7 END END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_94 <= CAST(1.022408604621887 AS DOUBLE PRECISION)) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_43 <= CAST(-0.751618921756744 AS DOUBLE PRECISION)) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_78 <= CAST(0.376048862934113 AS DOUBLE PRECISION)) THEN 11 ELSE 12 END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_31 <= CAST(-0.681926608085632 AS DOUBLE PRECISION)) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_60 <= CAST(-0.103796795010567 AS DOUBLE PRECISION)) THEN 15 ELSE 16 END ELSE 17 END END ELSE 18 END END AS node_id_2 
FROM tmp_20180508180413_codegen_iis3b7_ads_sca_2_out AS "ADS_sca_2_OUT"), 
dummy_cte_9 AS 
(SELECT CAST(0.0 AS DOUBLE PRECISION) AS "X"), 
"DT_node_data_9" AS 
...
-- Code For temporary table tmp_20180508180414_codegen_e7amdf_rf_b1 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180508180414_codegen_e7amdf_rf_b1  (
	"KEY" BIGINT, 
	"Score_0" DOUBLE PRECISION, 
	"Proba_0" DOUBLE PRECISION, 
	"LogProba_0" DOUBLE PRECISION, 
...
-- Code For temporary table tmp_20180508180414_codegen_e7amdf_rf_b1 part 2. Populate

INSERT INTO tmp_20180508180414_codegen_e7amdf_rf_b1 ("KEY", "Score_0", "Proba_0", "LogProba_0", "Score_1", "Proba_1", "LogProba_1") SELECT "U"."KEY", "U"."Score_0", "U"."Proba_0", "U"."LogProba_0", "U"."Score_1", "U"."Proba_1", "U"."LogProba_1" 
FROM (WITH "DT_node_lookup_10" AS 
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", CASE WHEN ("ADS_sca_2_OUT".scaler_79 <= CAST(0.025642074644566 AS DOUBLE PRECISION)) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_75 <= CAST(1.652859687805176 AS DOUBLE PRECISION)) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_20 <= CAST(0.873644053936005 AS DOUBLE PRECISION)) THEN 3 ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_19 <= CAST(-0.40332043170929 AS DOUBLE PRECISION)) THEN 5 ELSE 6 END END ELSE 7 END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_71 <= CAST(-0.59025102853775 AS DOUBLE PRECISION)) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_8 <= CAST(0.562916159629822 AS DOUBLE PRECISION)) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_96 <= CAST(1.113999247550964 AS DOUBLE PRECISION)) THEN 11 ELSE 12 END ELSE 13 END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_10 <= CAST(1.108550071716309 AS DOUBLE PRECISION)) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_86 <= CAST(1.684051156044006 AS DOUBLE PRECISION)) THEN 16 ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_7 <= CAST(0.218456253409386 AS DOUBLE PRECISION)) THEN 18 ELSE 19 END END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_98 <= CAST(0.195500656962395 AS DOUBLE PRECISION)) THEN 21 ELSE 22 END END END END AS node_id_2 
FROM tmp_20180508180413_codegen_iis3b7_ads_sca_2_out AS "ADS_sca_2_OUT"), 
dummy_cte_10 AS 
(SELECT CAST(0.0 AS DOUBLE PRECISION) AS "X"), 
"DT_node_data_10" AS 
...
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", CASE WHEN ("ADS_sca_2_OUT".scaler_44 <= CAST(0.734885334968567 AS DOUBLE PRECISION)) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_43 <= CAST(0.551057696342468 AS DOUBLE PRECISION)) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_60 <= CAST(-0.036946788430214 AS DOUBLE PRECISION)) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_100 <= CAST(-1.240503787994385 AS DOUBLE PRECISION)) THEN 4 ELSE 5 END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_8 <= CAST(0.440347641706467 AS DOUBLE PRECISION)) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_17 <= CAST(0.530218183994293 AS DOUBLE PRECISION)) THEN 8 ELSE 9 END ELSE 10 END END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_62 <= CAST(-0.895179688930512 AS DOUBLE PRECISION)) THEN 12 ELSE 13 END END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_82 <= CAST(-1.583694696426392 AS DOUBLE PRECISION)) THEN 15 ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_65 <= CAST(-1.879740953445434 AS DOUBLE PRECISION)) THEN 17 ELSE 18 END END END AS node_id_2 
FROM tmp_20180508180413_codegen_iis3b7_ads_sca_2_out AS "ADS_sca_2_OUT"), 
dummy_cte_11 AS 
(SELECT CAST(0.0 AS DOUBLE PRECISION) AS "X"), 
"DT_node_data_11" AS 
...
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", CASE WHEN ("ADS_sca_2_OUT".scaler_20 <= CAST(0.434743523597717 AS DOUBLE PRECISION)) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_87 <= CAST(0.223245352506638 AS DOUBLE PRECISION)) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_35 <= CAST(0.92091304063797 AS DOUBLE PRECISION)) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_59 <= CAST(-0.750502943992615 AS DOUBLE PRECISION)) THEN 4 ELSE 5 END ELSE 6 END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_43 <= CAST(1.239564657211304 AS DOUBLE PRECISION)) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_5 <= CAST(-1.475375294685364 AS DOUBLE PRECISION)) THEN 9 ELSE 10 END ELSE 11 END END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_90 <= CAST(0.652091085910797 AS DOUBLE PRECISION)) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_44 <= CAST(-1.504408001899719 AS DOUBLE PRECISION)) THEN 14 ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_47 <= CAST(1.24961268901825 AS DOUBLE PRECISION)) THEN 16 ELSE 17 END END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_19 <= CAST(-0.398258626461029 AS DOUBLE PRECISION)) THEN 19 ELSE 20 END END END AS node_id_2 
FROM tmp_20180508180413_codegen_iis3b7_ads_sca_2_out AS "ADS_sca_2_OUT"), 
dummy_cte_12 AS 
(SELECT CAST(0.0 AS DOUBLE PRECISION) AS "X"), 
"DT_node_data_12" AS 
...
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", CASE WHEN ("ADS_sca_2_OUT".scaler_94 <= CAST(-0.362537562847137 AS DOUBLE PRECISION)) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_20 <= CAST(-0.776340484619141 AS DOUBLE PRECISION)) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_47 <= CAST(-1.459884166717529 AS DOUBLE PRECISION)) THEN 3 ELSE 4 END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_59 <= CAST(0.889412045478821 AS DOUBLE PRECISION)) THEN 6 ELSE 7 END END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_62 <= CAST(-0.568029999732971 AS DOUBLE PRECISION)) THEN 9 ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_6 <= CAST(0.052694287151098 AS DOUBLE PRECISION)) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_14 <= CAST(-0.407302916049957 AS DOUBLE PRECISION)) THEN 12 ELSE 13 END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_65 <= CAST(1.824661016464234 AS DOUBLE PRECISION)) THEN 15 ELSE 16 END END END END AS node_id_2 
FROM tmp_20180508180413_codegen_iis3b7_ads_sca_2_out AS "ADS_sca_2_OUT"), 
dummy_cte_13 AS 
(SELECT CAST(0.0 AS DOUBLE PRECISION) AS "X"), 
"DT_node_data_13" AS 
...
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", CASE WHEN ("ADS_sca_2_OUT".scaler_2 <= CAST(-0.80558967590332 AS DOUBLE PRECISION)) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_92 <= CAST(-1.238253593444824 AS DOUBLE PRECISION)) THEN 2 ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_100 <= CAST(1.676503419876099 AS DOUBLE PRECISION)) THEN 4 ELSE 5 END END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_75 <= CAST(0.860435843467712 AS DOUBLE PRECISION)) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_59 <= CAST(-0.322433888912201 AS DOUBLE PRECISION)) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_12 <= CAST(-0.764499306678772 AS DOUBLE PRECISION)) THEN 9 ELSE 10 END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_92 <= CAST(0.924506723880768 AS DOUBLE PRECISION)) THEN 12 ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_60 <= CAST(-0.260886788368225 AS DOUBLE PRECISION)) THEN 14 ELSE 15 END END END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_2 <= CAST(-0.291721880435944 AS DOUBLE PRECISION)) THEN 17 ELSE 18 END END END AS node_id_2 
FROM tmp_20180508180413_codegen_iis3b7_ads_sca_2_out AS "ADS_sca_2_OUT"), 
dummy_cte_14 AS 
(SELECT CAST(0.0 AS DOUBLE PRECISION) AS "X"), 
"DT_node_data_14" AS 
...
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", CASE WHEN ("ADS_sca_2_OUT".scaler_79 <= CAST(-0.251100361347198 AS DOUBLE PRECISION)) THEN 1 ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_49 <= CAST(-2.046813488006592 AS DOUBLE PRECISION)) THEN 3 ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_53 <= CAST(1.831795454025268 AS DOUBLE PRECISION)) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_69 <= CAST(1.297329187393188 AS DOUBLE PRECISION)) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_17 <= CAST(-0.744648456573486 AS DOUBLE PRECISION)) THEN 7 ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_24 <= CAST(-1.675848245620728 AS DOUBLE PRECISION)) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_94 <= CAST(-0.255981653928757 AS DOUBLE PRECISION)) THEN 10 ELSE 11 END ELSE 12 END END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_40 <= CAST(-0.133449077606201 AS DOUBLE PRECISION)) THEN 14 ELSE 15 END END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_70 <= CAST(-0.561357915401459 AS DOUBLE PRECISION)) THEN 17 ELSE 18 END END END END AS node_id_2 
FROM tmp_20180508180413_codegen_iis3b7_ads_sca_2_out AS "ADS_sca_2_OUT"), 
dummy_cte_15 AS 
(SELECT CAST(0.0 AS DOUBLE PRECISION) AS "X"), 
"DT_node_data_15" AS 
...
-- Code For temporary table tmp_20180508180414_codegen_d1inv5_rf_union part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180508180414_codegen_d1inv5_rf_union  (
	"KEY" BIGINT, 
	"Score_0" DOUBLE PRECISION, 
	"Proba_0" DOUBLE PRECISION, 
	"LogProba_0" DOUBLE PRECISION, 
...
-- Code For temporary table tmp_20180508180414_codegen_d1inv5_rf_union part 2. Populate

INSERT INTO tmp_20180508180414_codegen_d1inv5_rf_union ("KEY", "Score_0", "Proba_0", "LogProba_0", "Score_1", "Proba_1", "LogProba_1") SELECT "U"."KEY", "U"."Score_0", "U"."Proba_0", "U"."LogProba_0", "U"."Score_1", "U"."Proba_1", "U"."LogProba_1" 
...
FROM tmp_20180508180414_codegen_wq5dun_rf_b0 AS "RF_B0" UNION ALL SELECT "RF_B1"."KEY" AS "KEY", "RF_B1"."Score_0" AS "Score_0", "RF_B1"."Proba_0" AS "Proba_0", "RF_B1"."LogProba_0" AS "LogProba_0", "RF_B1"."Score_1" AS "Score_1", "RF_B1"."Proba_1" AS "Proba_1", "RF_B1"."LogProba_1" AS "LogProba_1" 
FROM tmp_20180508180414_codegen_e7amdf_rf_b1 AS "RF_B1") AS "RF_EnsembleUnion") AS "RF_Union") AS "U"

-- Code For temporary table tmp_20180508180414_codegen_k5qm2d_rf_avg part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180508180414_codegen_k5qm2d_rf_avg  (
	"KEY" BIGINT, 
	"Score_0" DOUBLE PRECISION, 
	"Proba_0" DOUBLE PRECISION, 
	"LogProba_0" DOUBLE PRECISION, 
...
-- Code For temporary table tmp_20180508180414_codegen_k5qm2d_rf_avg part 2. Populate

INSERT INTO tmp_20180508180414_codegen_k5qm2d_rf_avg ("KEY", "Score_0", "Proba_0", "LogProba_0", "Score_1", "Proba_1", "LogProba_1") SELECT "U"."KEY", "U"."Score_0", "U"."Proba_0", "U"."LogProba_0", "U"."Score_1", "U"."Proba_1", "U"."LogProba_1" 
...
FROM tmp_20180508180414_codegen_d1inv5_rf_union AS "RF_Union" GROUP BY "RF_Union"."KEY") AS "T") AS "RF_avg") AS "U"
...
FROM tmp_20180508180414_codegen_k5qm2d_rf_avg AS "RF_avg"), 
