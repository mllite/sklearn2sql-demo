...
-- Code For temporary table tmp_20180516131320_codegen_qw8l2z_ads_imp_1_out part 1. Create 


CREATE TABLE tmp_20180516131320_codegen_qw8l2z_ads_imp_1_out (
	`KEY` BIGINT, 
...
-- Code For temporary table tmp_20180516131320_codegen_qw8l2z_ads_imp_1_out part 2. Populate

INSERT INTO tmp_20180516131320_codegen_qw8l2z_ads_imp_1_out (`KEY`, imputer_output_2, imputer_output_3, imputer_output_4, imputer_output_5) SELECT `ADS_imp_1_OUT`.`KEY`, `ADS_imp_1_OUT`.imputer_output_2, `ADS_imp_1_OUT`.imputer_output_3, `ADS_imp_1_OUT`.imputer_output_4, `ADS_imp_1_OUT`.imputer_output_5 
...
-- Code For temporary table tmp_20180516131320_codegen_ihzd36_ads_sca_2_out part 1. Create 


CREATE TABLE tmp_20180516131320_codegen_ihzd36_ads_sca_2_out (
	`KEY` BIGINT, 
...
-- Code For temporary table tmp_20180516131320_codegen_ihzd36_ads_sca_2_out part 2. Populate

INSERT INTO tmp_20180516131320_codegen_ihzd36_ads_sca_2_out (`KEY`, scaler_output_2, scaler_output_3, scaler_output_4, scaler_output_5) SELECT `ADS_sca_2_OUT`.`KEY`, `ADS_sca_2_OUT`.scaler_output_2, `ADS_sca_2_OUT`.scaler_output_3, `ADS_sca_2_OUT`.scaler_output_4, `ADS_sca_2_OUT`.scaler_output_5 
...
FROM tmp_20180516131320_codegen_qw8l2z_ads_imp_1_out AS `ADS_imp_1_OUT`) AS `ADS_sca_2_OUT`

-- Code For temporary table tmp_20180516131320_codegen_twzej6_rf_b0 part 1. Create 


CREATE TABLE tmp_20180516131320_codegen_twzej6_rf_b0 (
	`KEY` BIGINT, 
...
-- Code For temporary table tmp_20180516131320_codegen_twzej6_rf_b0 part 2. Populate
...
FROM tmp_20180516131320_codegen_ihzd36_ads_sca_2_out AS `ADS_sca_2_OUT`), 
`DT_node_data` AS 
...
-- Code For temporary table tmp_20180516131320_codegen_vei8cz_rf_b1 part 1. Create 


CREATE TABLE tmp_20180516131320_codegen_vei8cz_rf_b1 (
	`KEY` BIGINT, 
	`Score_CLASS_0` DOUBLE, 
	`Proba_CLASS_0` DOUBLE, 
	`LogProba_CLASS_0` DOUBLE, 
...
-- Code For temporary table tmp_20180516131320_codegen_vei8cz_rf_b1 part 2. Populate
...
-- Code For temporary table tmp_20180516131320_codegen_z5miuh_rf_avg part 1. Create 


CREATE TABLE tmp_20180516131320_codegen_z5miuh_rf_avg (
	`KEY` BIGINT, 
	`Score_CLASS_0` DOUBLE, 
	`Proba_CLASS_0` DOUBLE, 
	`LogProba_CLASS_0` DOUBLE, 
...
-- Code For temporary table tmp_20180516131320_codegen_z5miuh_rf_avg part 2. Populate
...
FROM tmp_20180516131320_codegen_z5miuh_rf_avg AS `RF_avg`), 
