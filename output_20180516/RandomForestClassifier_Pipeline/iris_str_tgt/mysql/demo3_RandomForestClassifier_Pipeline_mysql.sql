...
-- Code For temporary table TMP_20180508190700_CODEGEN_0F0FC8_ADS_imp_1_OUT part 1. Create 


CREATE TEMPORARY TABLE `TMP_20180508190700_CODEGEN_0F0FC8_ADS_imp_1_OUT` (
	`KEY` BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20180508190700_CODEGEN_0F0FC8_ADS_imp_1_OUT part 2. Populate

INSERT INTO `TMP_20180508190700_CODEGEN_0F0FC8_ADS_imp_1_OUT` (`KEY`, imputer_output_2, imputer_output_3, imputer_output_4, imputer_output_5) SELECT `U`.`KEY`, `U`.imputer_output_2, `U`.imputer_output_3, `U`.imputer_output_4, `U`.imputer_output_5 
...
-- Code For temporary table TMP_20180508190700_CODEGEN_0F0FC8_ADS_imp_1_OUT part 3. Create Index 

CREATE INDEX `ix_TMP_20180508190700_CODEGEN_0F0FC8_ADS_imp_1_OUT_KEY` ON `TMP_20180508190700_CODEGEN_0F0FC8_ADS_imp_1_OUT` (`KEY`)

-- Code For temporary table TMP_20180508190700_CODEGEN_R37ENF_ADS_sca_2_OUT part 1. Create 


CREATE TEMPORARY TABLE `TMP_20180508190700_CODEGEN_R37ENF_ADS_sca_2_OUT` (
	`KEY` BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20180508190700_CODEGEN_R37ENF_ADS_sca_2_OUT part 2. Populate

INSERT INTO `TMP_20180508190700_CODEGEN_R37ENF_ADS_sca_2_OUT` (`KEY`, scaler_output_2, scaler_output_3, scaler_output_4, scaler_output_5) SELECT `U`.`KEY`, `U`.scaler_output_2, `U`.scaler_output_3, `U`.scaler_output_4, `U`.scaler_output_5 
...
FROM `TMP_20180508190700_CODEGEN_0F0FC8_ADS_imp_1_OUT` AS `ADS_imp_1_OUT`) AS `ADS_sca_2_OUT`) AS `U`

-- Code For temporary table TMP_20180508190700_CODEGEN_R37ENF_ADS_sca_2_OUT part 3. Create Index 

CREATE INDEX `ix_TMP_20180508190700_CODEGEN_R37ENF_ADS_sca_2_OUT_KEY` ON `TMP_20180508190700_CODEGEN_R37ENF_ADS_sca_2_OUT` (`KEY`)

-- Code For temporary table TMP_20180508190701_CODEGEN_ENI04H_RF_B0 part 1. Create 


CREATE TEMPORARY TABLE `TMP_20180508190701_CODEGEN_ENI04H_RF_B0` (
	`KEY` BIGINT, 
...
FROM `TMP_20180508190700_CODEGEN_R37ENF_ADS_sca_2_OUT` AS `ADS_sca_2_OUT`), 
`DT_node_data` AS 
...
-- Code For temporary table TMP_20180508190701_CODEGEN_QDNZB8_RF_B1 part 1. Create 


CREATE TEMPORARY TABLE `TMP_20180508190701_CODEGEN_QDNZB8_RF_B1` (
	`KEY` BIGINT, 
	`Score_CLASS_0` DOUBLE, 
	`Proba_CLASS_0` DOUBLE, 
	`LogProba_CLASS_0` DOUBLE, 
...
-- Code For temporary table TMP_20180508190701_CODEGEN_QDNZB8_RF_B1 part 2. Populate

INSERT INTO `TMP_20180508190701_CODEGEN_QDNZB8_RF_B1` (`KEY`, `Score_CLASS_0`, `Proba_CLASS_0`, `LogProba_CLASS_0`, `Score_CLASS_1`, `Proba_CLASS_1`, `LogProba_CLASS_1`, `Score_CLASS_2`, `Proba_CLASS_2`, `LogProba_CLASS_2`) SELECT `U`.`KEY`, `U`.`Score_CLASS_0`, `U`.`Proba_CLASS_0`, `U`.`LogProba_CLASS_0`, `U`.`Score_CLASS_1`, `U`.`Proba_CLASS_1`, `U`.`LogProba_CLASS_1`, `U`.`Score_CLASS_2`, `U`.`Proba_CLASS_2`, `U`.`LogProba_CLASS_2` 
...
-- Code For temporary table TMP_20180508190701_CODEGEN_ZGFBNF_RF_Union part 1. Create 


CREATE TEMPORARY TABLE `TMP_20180508190701_CODEGEN_ZGFBNF_RF_Union` (
	`KEY` BIGINT, 
	`Score_CLASS_0` DOUBLE, 
	`Proba_CLASS_0` DOUBLE, 
	`LogProba_CLASS_0` DOUBLE, 
...
-- Code For temporary table TMP_20180508190701_CODEGEN_ZGFBNF_RF_Union part 2. Populate

INSERT INTO `TMP_20180508190701_CODEGEN_ZGFBNF_RF_Union` (`KEY`, `Score_CLASS_0`, `Proba_CLASS_0`, `LogProba_CLASS_0`, `Score_CLASS_1`, `Proba_CLASS_1`, `LogProba_CLASS_1`, `Score_CLASS_2`, `Proba_CLASS_2`, `LogProba_CLASS_2`) SELECT `U`.`KEY`, `U`.`Score_CLASS_0`, `U`.`Proba_CLASS_0`, `U`.`LogProba_CLASS_0`, `U`.`Score_CLASS_1`, `U`.`Proba_CLASS_1`, `U`.`LogProba_CLASS_1`, `U`.`Score_CLASS_2`, `U`.`Proba_CLASS_2`, `U`.`LogProba_CLASS_2` 
...
-- Code For temporary table TMP_20180508190701_CODEGEN_7N8CCD_RF_avg part 2. Populate

INSERT INTO `TMP_20180508190701_CODEGEN_7N8CCD_RF_avg` (`KEY`, `Score_CLASS_0`, `Proba_CLASS_0`, `LogProba_CLASS_0`, `Score_CLASS_1`, `Proba_CLASS_1`, `LogProba_CLASS_1`, `Score_CLASS_2`, `Proba_CLASS_2`, `LogProba_CLASS_2`) SELECT `U`.`KEY`, `U`.`Score_CLASS_0`, `U`.`Proba_CLASS_0`, `U`.`LogProba_CLASS_0`, `U`.`Score_CLASS_1`, `U`.`Proba_CLASS_1`, `U`.`LogProba_CLASS_1`, `U`.`Score_CLASS_2`, `U`.`Proba_CLASS_2`, `U`.`LogProba_CLASS_2` 
...
FROM `TMP_20180508190701_CODEGEN_ZGFBNF_RF_Union` AS `RF_Union` GROUP BY `RF_Union`.`KEY`) AS `T`) AS `RF_avg`) AS `U`

-- Code For temporary table TMP_20180508190701_CODEGEN_7N8CCD_RF_avg part 3. Create Index 

CREATE INDEX `ix_TMP_20180508190701_CODEGEN_7N8CCD_RF_avg_KEY` ON `TMP_20180508190701_CODEGEN_7N8CCD_RF_avg` (`KEY`)
...
FROM `TMP_20180508190701_CODEGEN_7N8CCD_RF_avg` AS `RF_avg`), 
