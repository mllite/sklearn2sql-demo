...
-- Code For temporary table ##TMP_20180508190701_CODEGEN_ZUM8JW_ADS_imp_1_OUT part 1. Create 


CREATE TABLE ##TMP_20180508190701_CODEGEN_ZUM8JW_ADS_imp_1_OUT (
	[KEY] BIGINT NULL, 
...
-- Code For temporary table ##TMP_20180508190701_CODEGEN_ZUM8JW_ADS_imp_1_OUT part 2. Populate

INSERT INTO ##TMP_20180508190701_CODEGEN_ZUM8JW_ADS_imp_1_OUT ([KEY], imputer_output_2, imputer_output_3, imputer_output_4, imputer_output_5) SELECT [ADS_imp_1_OUT].[KEY], [ADS_imp_1_OUT].imputer_output_2, [ADS_imp_1_OUT].imputer_output_3, [ADS_imp_1_OUT].imputer_output_4, [ADS_imp_1_OUT].imputer_output_5 
...
-- Code For temporary table ##TMP_20180508190701_CODEGEN_T9XPS0_ADS_sca_2_OUT part 1. Create 


CREATE TABLE ##TMP_20180508190701_CODEGEN_T9XPS0_ADS_sca_2_OUT (
	[KEY] BIGINT NULL, 
...
-- Code For temporary table ##TMP_20180508190701_CODEGEN_T9XPS0_ADS_sca_2_OUT part 2. Populate

INSERT INTO ##TMP_20180508190701_CODEGEN_T9XPS0_ADS_sca_2_OUT ([KEY], scaler_output_2, scaler_output_3, scaler_output_4, scaler_output_5) SELECT [ADS_sca_2_OUT].[KEY], [ADS_sca_2_OUT].scaler_output_2, [ADS_sca_2_OUT].scaler_output_3, [ADS_sca_2_OUT].scaler_output_4, [ADS_sca_2_OUT].scaler_output_5 
...
FROM ##TMP_20180508190701_CODEGEN_ZUM8JW_ADS_imp_1_OUT AS [ADS_imp_1_OUT]) AS [ADS_sca_2_OUT]

-- Code For temporary table ##TMP_20180508190701_CODEGEN_H29IVP_RF_B0 part 1. Create 


CREATE TABLE ##TMP_20180508190701_CODEGEN_H29IVP_RF_B0 (
	[KEY] BIGINT NULL, 
...
-- Code For temporary table ##TMP_20180508190701_CODEGEN_H29IVP_RF_B0 part 2. Populate
...
FROM ##TMP_20180508190701_CODEGEN_T9XPS0_ADS_sca_2_OUT AS [ADS_sca_2_OUT]), 
[DT_node_data] AS 
...
-- Code For temporary table ##TMP_20180508190701_CODEGEN_UDH1GL_RF_B1 part 1. Create 


CREATE TABLE ##TMP_20180508190701_CODEGEN_UDH1GL_RF_B1 (
	[KEY] BIGINT NULL, 
	[Score_CLASS_0] FLOAT(53) NULL, 
	[Proba_CLASS_0] FLOAT(53) NULL, 
	[LogProba_CLASS_0] FLOAT(53) NULL, 
...
-- Code For temporary table ##TMP_20180508190701_CODEGEN_UDH1GL_RF_B1 part 2. Populate
...
-- Code For temporary table ##TMP_20180508190701_CODEGEN_KIQ48H_RF_Union part 1. Create 


CREATE TABLE ##TMP_20180508190701_CODEGEN_KIQ48H_RF_Union (
	[KEY] BIGINT NULL, 
	[Score_CLASS_0] FLOAT(53) NULL, 
	[Proba_CLASS_0] FLOAT(53) NULL, 
	[LogProba_CLASS_0] FLOAT(53) NULL, 
...
FROM ##TMP_20180508190701_CODEGEN_KIQ48H_RF_Union AS [RF_Union] GROUP BY [RF_Union].[KEY]) AS [T]) AS [RF_avg]
...
FROM ##TMP_20180508190701_CODEGEN_K451L0_RF_avg AS [RF_avg]), 
