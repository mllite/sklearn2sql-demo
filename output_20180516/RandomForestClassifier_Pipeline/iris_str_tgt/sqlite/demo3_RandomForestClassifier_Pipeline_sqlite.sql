...
-- Code For temporary table TMP_20180508190700_CODEGEN_I6JI3D_ADS_imp_1_OUT part 1. Create 


CREATE TEMPORARY TABLE "TMP_20180508190700_CODEGEN_I6JI3D_ADS_imp_1_OUT" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20180508190700_CODEGEN_I6JI3D_ADS_imp_1_OUT part 2. Populate

INSERT INTO "TMP_20180508190700_CODEGEN_I6JI3D_ADS_imp_1_OUT" ("KEY", imputer_output_2, imputer_output_3, imputer_output_4, imputer_output_5) SELECT "ADS_imp_1_OUT"."KEY", "ADS_imp_1_OUT".imputer_output_2, "ADS_imp_1_OUT".imputer_output_3, "ADS_imp_1_OUT".imputer_output_4, "ADS_imp_1_OUT".imputer_output_5 
...
-- Code For temporary table TMP_20180508190700_CODEGEN_I6JI3D_ADS_imp_1_OUT part 3. Create Index 

CREATE INDEX "ix_TMP_20180508190700_CODEGEN_I6JI3D_ADS_imp_1_OUT_KEY" ON "TMP_20180508190700_CODEGEN_I6JI3D_ADS_imp_1_OUT" ("KEY")

-- Code For temporary table TMP_20180508190700_CODEGEN_K7V59I_ADS_sca_2_OUT part 1. Create 


CREATE TEMPORARY TABLE "TMP_20180508190700_CODEGEN_K7V59I_ADS_sca_2_OUT" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20180508190700_CODEGEN_K7V59I_ADS_sca_2_OUT part 2. Populate

INSERT INTO "TMP_20180508190700_CODEGEN_K7V59I_ADS_sca_2_OUT" ("KEY", scaler_output_2, scaler_output_3, scaler_output_4, scaler_output_5) SELECT "ADS_sca_2_OUT"."KEY", "ADS_sca_2_OUT".scaler_output_2, "ADS_sca_2_OUT".scaler_output_3, "ADS_sca_2_OUT".scaler_output_4, "ADS_sca_2_OUT".scaler_output_5 
...
FROM "TMP_20180508190700_CODEGEN_I6JI3D_ADS_imp_1_OUT" AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT"

-- Code For temporary table TMP_20180508190700_CODEGEN_K7V59I_ADS_sca_2_OUT part 3. Create Index 

CREATE INDEX "ix_TMP_20180508190700_CODEGEN_K7V59I_ADS_sca_2_OUT_KEY" ON "TMP_20180508190700_CODEGEN_K7V59I_ADS_sca_2_OUT" ("KEY")

-- Code For temporary table TMP_20180508190701_CODEGEN_LEML8M_RF_B0 part 1. Create 


CREATE TEMPORARY TABLE "TMP_20180508190701_CODEGEN_LEML8M_RF_B0" (
	"KEY" BIGINT, 
	"Score_CLASS_0" FLOAT, 
	"Proba_CLASS_0" FLOAT, 
...
-- Code For temporary table TMP_20180508190701_CODEGEN_LEML8M_RF_B0 part 2. Populate
...
FROM "TMP_20180508190700_CODEGEN_K7V59I_ADS_sca_2_OUT" AS "ADS_sca_2_OUT"), 
"DT_node_data" AS 
...
-- Code For temporary table TMP_20180508190701_CODEGEN_7NBM28_RF_B1 part 1. Create 


CREATE TEMPORARY TABLE "TMP_20180508190701_CODEGEN_7NBM28_RF_B1" (
	"KEY" BIGINT, 
	"Score_CLASS_0" FLOAT, 
	"Proba_CLASS_0" FLOAT, 
	"LogProba_CLASS_0" FLOAT, 
...
-- Code For temporary table TMP_20180508190701_CODEGEN_7NBM28_RF_B1 part 2. Populate
...
-- Code For temporary table TMP_20180508190701_CODEGEN_UBJ8PW_RF_Union part 1. Create 


CREATE TEMPORARY TABLE "TMP_20180508190701_CODEGEN_UBJ8PW_RF_Union" (
	"KEY" BIGINT, 
	"Score_CLASS_0" FLOAT, 
	"Proba_CLASS_0" FLOAT, 
	"LogProba_CLASS_0" FLOAT, 
...
FROM "TMP_20180508190701_CODEGEN_LEML8M_RF_B0" AS "RF_B0" UNION ALL SELECT "RF_B1"."KEY" AS "KEY", "RF_B1"."Score_CLASS_0" AS "Score_CLASS_0", "RF_B1"."Proba_CLASS_0" AS "Proba_CLASS_0", "RF_B1"."LogProba_CLASS_0" AS "LogProba_CLASS_0", "RF_B1"."Score_CLASS_1" AS "Score_CLASS_1", "RF_B1"."Proba_CLASS_1" AS "Proba_CLASS_1", "RF_B1"."LogProba_CLASS_1" AS "LogProba_CLASS_1", "RF_B1"."Score_CLASS_2" AS "Score_CLASS_2", "RF_B1"."Proba_CLASS_2" AS "Proba_CLASS_2", "RF_B1"."LogProba_CLASS_2" AS "LogProba_CLASS_2" 
FROM "TMP_20180508190701_CODEGEN_7NBM28_RF_B1" AS "RF_B1") AS "RF_EnsembleUnion") AS "RF_Union"

-- Code For temporary table TMP_20180508190701_CODEGEN_AUVCBL_RF_avg part 1. Create 


CREATE TEMPORARY TABLE "TMP_20180508190701_CODEGEN_AUVCBL_RF_avg" (
	"KEY" BIGINT NOT NULL, 
	"Score_CLASS_0" FLOAT, 
	"Proba_CLASS_0" FLOAT, 
	"LogProba_CLASS_0" FLOAT, 
...
FROM "TMP_20180508190701_CODEGEN_UBJ8PW_RF_Union" AS "RF_Union" GROUP BY "RF_Union"."KEY") AS "T") AS "RF_avg"

-- Code For temporary table TMP_20180508190701_CODEGEN_AUVCBL_RF_avg part 3. Create Index 

CREATE INDEX "ix_TMP_20180508190701_CODEGEN_AUVCBL_RF_avg_KEY" ON "TMP_20180508190701_CODEGEN_AUVCBL_RF_avg" ("KEY")
...
FROM "TMP_20180508190701_CODEGEN_AUVCBL_RF_avg" AS "RF_avg"), 
