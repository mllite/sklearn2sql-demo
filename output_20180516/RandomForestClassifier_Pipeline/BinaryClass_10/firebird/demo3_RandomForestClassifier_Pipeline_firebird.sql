...
-- Code For temporary table TMP_20180516_CODEGEN_WS9BW5_ADS part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180516_CODEGEN_WS9BW5_ADS" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20180516_CODEGEN_WS9BW5_ADS part 2. Populate

INSERT INTO "TMP_20180516_CODEGEN_WS9BW5_ADS" ("KEY", impter_2, impter_3, impter_4, impter_5, impter_6, impter_7, impter_8, impter_9, impter_10, impter_11) SELECT "U"."KEY", "U".impter_2, "U".impter_3, "U".impter_4, "U".impter_5, "U".impter_6, "U".impter_7, "U".impter_8, "U".impter_9, "U".impter_10, "U".impter_11 
...
-- Code For temporary table TMP_20180516_CODEGEN_WS9BW5_ADS part 3. Create Index 

CREATE INDEX "ix_TMP_20180516_CODEGEN_f148" ON "TMP_20180516_CODEGEN_WS9BW5_ADS" ("KEY")

-- Code For temporary table TMP_20180516_CODEGEN_F4EFVA_ADS part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180516_CODEGEN_F4EFVA_ADS" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20180516_CODEGEN_F4EFVA_ADS part 2. Populate

INSERT INTO "TMP_20180516_CODEGEN_F4EFVA_ADS" ("KEY", scaler_2, scaler_3, scaler_4, scaler_5, scaler_6, scaler_7, scaler_8, scaler_9, scaler_10, scaler_11) SELECT "U"."KEY", "U".scaler_2, "U".scaler_3, "U".scaler_4, "U".scaler_5, "U".scaler_6, "U".scaler_7, "U".scaler_8, "U".scaler_9, "U".scaler_10, "U".scaler_11 
...
FROM "TMP_20180516_CODEGEN_WS9BW5_ADS" AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT") AS "U"

-- Code For temporary table TMP_20180516_CODEGEN_F4EFVA_ADS part 3. Create Index 

CREATE INDEX "ix_TMP_20180516_CODEGEN_45e1" ON "TMP_20180516_CODEGEN_F4EFVA_ADS" ("KEY")

-- Code For temporary table TMP_20180516_CODEGEN_IG73O3_RF_ part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180516_CODEGEN_IG73O3_RF_" (
	"KEY" BIGINT, 
...
-- Code For temporary table TMP_20180516_CODEGEN_IG73O3_RF_ part 2. Populate

INSERT INTO "TMP_20180516_CODEGEN_IG73O3_RF_" ("KEY", "Score_0", "Proba_0", "LogProba_0", "Score_1", "Proba_1", "LogProba_1") SELECT "U"."KEY", "U"."Score_0", "U"."Proba_0", "U"."LogProba_0", "U"."Score_1", "U"."Proba_1", "U"."LogProba_1" 
...
FROM "TMP_20180516_CODEGEN_F4EFVA_ADS" AS "ADS_sca_2_OUT"), 
"DT_node_data" AS 
...
-- Code For temporary table TMP_20180516_CODEGEN_S3DLEI_RF_ part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180516_CODEGEN_S3DLEI_RF_" (
	"KEY" BIGINT, 
	"Score_0" DOUBLE PRECISION, 
	"Proba_0" DOUBLE PRECISION, 
	"LogProba_0" DOUBLE PRECISION, 
...
-- Code For temporary table TMP_20180516_CODEGEN_S3DLEI_RF_ part 2. Populate

INSERT INTO "TMP_20180516_CODEGEN_S3DLEI_RF_" ("KEY", "Score_0", "Proba_0", "LogProba_0", "Score_1", "Proba_1", "LogProba_1") SELECT "U"."KEY", "U"."Score_0", "U"."Proba_0", "U"."LogProba_0", "U"."Score_1", "U"."Proba_1", "U"."LogProba_1" 
...
-- Code For temporary table TMP_20180516_CODEGEN_WLU9DJ_RF_ part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180516_CODEGEN_WLU9DJ_RF_" (
	"KEY" BIGINT NOT NULL, 
	"Score_0" DOUBLE PRECISION, 
	"Proba_0" DOUBLE PRECISION, 
	"LogProba_0" DOUBLE PRECISION, 
...
-- Code For temporary table TMP_20180516_CODEGEN_WLU9DJ_RF_ part 2. Populate

INSERT INTO "TMP_20180516_CODEGEN_WLU9DJ_RF_" ("KEY", "Score_0", "Proba_0", "LogProba_0", "Score_1", "Proba_1", "LogProba_1") SELECT "U"."KEY", "U"."Score_0", "U"."Proba_0", "U"."LogProba_0", "U"."Score_1", "U"."Proba_1", "U"."LogProba_1" 
...
FROM "TMP_20180516_CODEGEN_IG73O3_RF_" AS "RF_B0" UNION ALL SELECT "RF_B1"."KEY" AS "KEY", "RF_B1"."Score_0" AS "Score_0", "RF_B1"."Proba_0" AS "Proba_0", "RF_B1"."LogProba_0" AS "LogProba_0", "RF_B1"."Score_1" AS "Score_1", "RF_B1"."Proba_1" AS "Proba_1", "RF_B1"."LogProba_1" AS "LogProba_1" 
FROM "TMP_20180516_CODEGEN_S3DLEI_RF_" AS "RF_B1") AS "RF_EnsembleUnion")
...
-- Code For temporary table TMP_20180516_CODEGEN_WLU9DJ_RF_ part 3. Create Index 

CREATE INDEX "ix_TMP_20180516_CODEGEN_c4c0" ON "TMP_20180516_CODEGEN_WLU9DJ_RF_" ("KEY")
...
FROM "TMP_20180516_CODEGEN_WLU9DJ_RF_" AS "RF_avg"), 
