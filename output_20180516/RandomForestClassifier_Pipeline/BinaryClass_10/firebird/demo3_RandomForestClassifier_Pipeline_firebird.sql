...
-- Code For temporary table TMP_20180508175932_CODEGEN_SV85 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508175932_CODEGEN_SV85" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20180508175932_CODEGEN_SV85 part 2. Populate

INSERT INTO "TMP_20180508175932_CODEGEN_SV85" ("KEY", impter_2, impter_3, impter_4, impter_5, impter_6, impter_7, impter_8, impter_9, impter_10, impter_11) SELECT "U"."KEY", "U".impter_2, "U".impter_3, "U".impter_4, "U".impter_5, "U".impter_6, "U".impter_7, "U".impter_8, "U".impter_9, "U".impter_10, "U".impter_11 
...
-- Code For temporary table TMP_20180508175932_CODEGEN_SV85 part 3. Create Index 

CREATE INDEX "ix_TMP_20180508175932_C_1697" ON "TMP_20180508175932_CODEGEN_SV85" ("KEY")

-- Code For temporary table TMP_20180508175932_CODEGEN_VT6S part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508175932_CODEGEN_VT6S" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20180508175932_CODEGEN_VT6S part 2. Populate

INSERT INTO "TMP_20180508175932_CODEGEN_VT6S" ("KEY", scaler_2, scaler_3, scaler_4, scaler_5, scaler_6, scaler_7, scaler_8, scaler_9, scaler_10, scaler_11) SELECT "U"."KEY", "U".scaler_2, "U".scaler_3, "U".scaler_4, "U".scaler_5, "U".scaler_6, "U".scaler_7, "U".scaler_8, "U".scaler_9, "U".scaler_10, "U".scaler_11 
...
FROM "TMP_20180508175932_CODEGEN_SV85" AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT") AS "U"

-- Code For temporary table TMP_20180508175932_CODEGEN_VT6S part 3. Create Index 

CREATE INDEX "ix_TMP_20180508175932_C_459c" ON "TMP_20180508175932_CODEGEN_VT6S" ("KEY")

-- Code For temporary table TMP_20180508175932_CODEGEN_9IRJ part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508175932_CODEGEN_9IRJ" (
	"KEY" BIGINT, 
...
-- Code For temporary table TMP_20180508175932_CODEGEN_9IRJ part 2. Populate

INSERT INTO "TMP_20180508175932_CODEGEN_9IRJ" ("KEY", "Score_0", "Proba_0", "LogProba_0", "Score_1", "Proba_1", "LogProba_1") SELECT "U"."KEY", "U"."Score_0", "U"."Proba_0", "U"."LogProba_0", "U"."Score_1", "U"."Proba_1", "U"."LogProba_1" 
...
FROM "TMP_20180508175932_CODEGEN_VT6S" AS "ADS_sca_2_OUT"), 
"DT_node_data" AS 
...
"DT_node_data_7" AS 
(SELECT "Values".nid AS nid, CAST("Values"."P_0.0" AS DOUBLE PRECISION) AS "P_0.0", CAST("Values"."P_1.0" AS DOUBLE PRECISION) AS "P_1.0", CAST("Values"."D" AS DOUBLE PRECISION) AS "D", CAST("Values"."DP" AS DOUBLE PRECISION) AS "DP" 
FROM (SELECT 2 AS nid, 0.0 AS "P_0.0", 1.0 AS "P_1.0", 1.0 AS "D", 1.0 AS "DP" FROM rdb$database UNION ALL SELECT 6 AS nid, 0.0 AS "P_0.0", 1.0 AS "P_1.0", 1.0 AS "D", 1.0 AS "DP" FROM rdb$database UNION ALL SELECT 7 AS nid, 1.0 AS "P_0.0", 0.0 AS "P_1.0", 0.0 AS "D", 1.0 AS "DP" FROM rdb$database UNION ALL SELECT 10 AS nid, 0.0 AS "P_0.0", 1.0 AS "P_1.0", 1.0 AS "D", 1.0 AS "DP" FROM rdb$database UNION ALL SELECT 11 AS nid, 1.0 AS "P_0.0", 0.0 AS "P_1.0", 0.0 AS "D", 1.0 AS "DP" FROM rdb$database UNION ALL SELECT 12 AS nid, 0.0 AS "P_0.0", 1.0 AS "P_1.0", 1.0 AS "D", 1.0 AS "DP" FROM rdb$database UNION ALL SELECT 15 AS nid, 1.0 AS "P_0.0", 0.0 AS "P_1.0", 0.0 AS "D", 1.0 AS "DP" FROM rdb$database UNION ALL SELECT 16 AS nid, 0.0 AS "P_0.0", 1.0 AS "P_1.0", 1.0 AS "D", 1.0 AS "DP" FROM rdb$database UNION ALL SELECT 18 AS nid, 1.0 AS "P_0.0", 0.0 AS "P_1.0", 0.0 AS "D", 1.0 AS "DP" FROM rdb$database UNION ALL SELECT 19 AS nid, 0.0 AS "P_0.0", 1.0 AS "P_1.0", 1.0 AS "D", 1.0 AS "DP" FROM rdb$database UNION ALL SELECT 23 AS nid, 1.0 AS "P_0.0", 0.0 AS "P_1.0", 0.0 AS "D", 1.0 AS "DP" FROM rdb$database UNION ALL SELECT 24 AS nid, 0.0 AS "P_0.0", 1.0 AS "P_1.0", 1.0 AS "D", 1.0 AS "DP" FROM rdb$database UNION ALL SELECT 25 AS nid, 1.0 AS "P_0.0", 0.0 AS "P_1.0", 0.0 AS "D", 1.0 AS "DP" FROM rdb$database UNION ALL SELECT 26 AS nid, 0.0 AS "P_0.0", 1.0 AS "P_1.0", 1.0 AS "D", 1.0 AS "DP" FROM rdb$database) AS "Values"), 
"DT_Output_7" AS 
...
"DT_node_data_8" AS 
(SELECT "Values".nid AS nid, CAST("Values"."P_0.0" AS DOUBLE PRECISION) AS "P_0.0", CAST("Values"."P_1.0" AS DOUBLE PRECISION) AS "P_1.0", CAST("Values"."D" AS DOUBLE PRECISION) AS "D", CAST("Values"."DP" AS DOUBLE PRECISION) AS "DP" 
FROM (SELECT 2 AS nid, 1.0 AS "P_0.0", 0.0 AS "P_1.0", 0.0 AS "D", 1.0 AS "DP" FROM rdb$database UNION ALL SELECT 3 AS nid, 0.0 AS "P_0.0", 1.0 AS "P_1.0", 1.0 AS "D", 1.0 AS "DP" FROM rdb$database UNION ALL SELECT 8 AS nid, 1.0 AS "P_0.0", 0.0 AS "P_1.0", 0.0 AS "D", 1.0 AS "DP" FROM rdb$database UNION ALL SELECT 9 AS nid, 0.0 AS "P_0.0", 1.0 AS "P_1.0", 1.0 AS "D", 1.0 AS "DP" FROM rdb$database UNION ALL SELECT 10 AS nid, 0.0 AS "P_0.0", 1.0 AS "P_1.0", 1.0 AS "D", 1.0 AS "DP" FROM rdb$database UNION ALL SELECT 11 AS nid, 0.0 AS "P_0.0", 1.0 AS "P_1.0", 1.0 AS "D", 1.0 AS "DP" FROM rdb$database UNION ALL SELECT 13 AS nid, 0.0 AS "P_0.0", 1.0 AS "P_1.0", 1.0 AS "D", 1.0 AS "DP" FROM rdb$database UNION ALL SELECT 15 AS nid, 1.0 AS "P_0.0", 0.0 AS "P_1.0", 0.0 AS "D", 1.0 AS "DP" FROM rdb$database UNION ALL SELECT 16 AS nid, 0.0 AS "P_0.0", 1.0 AS "P_1.0", 1.0 AS "D", 1.0 AS "DP" FROM rdb$database) AS "Values"), 
"DT_Output_8" AS 
...
-- Code For temporary table TMP_20180508175932_CODEGEN_Z6HB part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508175932_CODEGEN_Z6HB" (
	"KEY" BIGINT, 
	"Score_0" DOUBLE PRECISION, 
	"Proba_0" DOUBLE PRECISION, 
	"LogProba_0" DOUBLE PRECISION, 
...
-- Code For temporary table TMP_20180508175932_CODEGEN_Z6HB part 2. Populate

INSERT INTO "TMP_20180508175932_CODEGEN_Z6HB" ("KEY", "Score_0", "Proba_0", "LogProba_0", "Score_1", "Proba_1", "LogProba_1") SELECT "U"."KEY", "U"."Score_0", "U"."Proba_0", "U"."LogProba_0", "U"."Score_1", "U"."Proba_1", "U"."LogProba_1" 
...
-- Code For temporary table TMP_20180508175932_CODEGEN_TMKD part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508175932_CODEGEN_TMKD" (
	"KEY" BIGINT, 
	"Score_0" DOUBLE PRECISION, 
	"Proba_0" DOUBLE PRECISION, 
	"LogProba_0" DOUBLE PRECISION, 
...
-- Code For temporary table TMP_20180508175932_CODEGEN_TMKD part 2. Populate

INSERT INTO "TMP_20180508175932_CODEGEN_TMKD" ("KEY", "Score_0", "Proba_0", "LogProba_0", "Score_1", "Proba_1", "LogProba_1") SELECT "U"."KEY", "U"."Score_0", "U"."Proba_0", "U"."LogProba_0", "U"."Score_1", "U"."Proba_1", "U"."LogProba_1" 
...
FROM "TMP_20180508175932_CODEGEN_9IRJ" AS "RF_B0" UNION ALL SELECT "RF_B1"."KEY" AS "KEY", "RF_B1"."Score_0" AS "Score_0", "RF_B1"."Proba_0" AS "Proba_0", "RF_B1"."LogProba_0" AS "LogProba_0", "RF_B1"."Score_1" AS "Score_1", "RF_B1"."Proba_1" AS "Proba_1", "RF_B1"."LogProba_1" AS "LogProba_1" 
FROM "TMP_20180508175932_CODEGEN_Z6HB" AS "RF_B1") AS "RF_EnsembleUnion") AS "RF_Union") AS "U"

-- Code For temporary table TMP_20180508175932_CODEGEN_Y20J part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508175932_CODEGEN_Y20J" (
	"KEY" BIGINT NOT NULL, 
	"Score_0" DOUBLE PRECISION, 
	"Proba_0" DOUBLE PRECISION, 
	"LogProba_0" DOUBLE PRECISION, 
...
-- Code For temporary table TMP_20180508175932_CODEGEN_Y20J part 2. Populate

INSERT INTO "TMP_20180508175932_CODEGEN_Y20J" ("KEY", "Score_0", "Proba_0", "LogProba_0", "Score_1", "Proba_1", "LogProba_1") SELECT "U"."KEY", "U"."Score_0", "U"."Proba_0", "U"."LogProba_0", "U"."Score_1", "U"."Proba_1", "U"."LogProba_1" 
...
FROM "TMP_20180508175932_CODEGEN_TMKD" AS "RF_Union" GROUP BY "RF_Union"."KEY") AS "T") AS "RF_avg") AS "U"

-- Code For temporary table TMP_20180508175932_CODEGEN_Y20J part 3. Create Index 

CREATE INDEX "ix_TMP_20180508175932_C_3fcf" ON "TMP_20180508175932_CODEGEN_Y20J" ("KEY")
...
FROM "TMP_20180508175932_CODEGEN_Y20J" AS "RF_avg"), 
