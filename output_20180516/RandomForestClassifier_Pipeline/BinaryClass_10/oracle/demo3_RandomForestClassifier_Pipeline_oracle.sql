...
-- Code For temporary table DEGEN_JUYKK0_ADS_IMP_1_OUT part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "DEGEN_JUYKK0_ADS_IMP_1_OUT" (
	"KEY" NUMBER(19), 
...
-- Code For temporary table DEGEN_JUYKK0_ADS_IMP_1_OUT part 2. Populate

INSERT INTO "DEGEN_JUYKK0_ADS_IMP_1_OUT" ("KEY", impter_2, impter_3, impter_4, impter_5, impter_6, impter_7, impter_8, impter_9, impter_10, impter_11) SELECT "U"."KEY", "U".impter_2, "U".impter_3, "U".impter_4, "U".impter_5, "U".impter_6, "U".impter_7, "U".impter_8, "U".impter_9, "U".impter_10, "U".impter_11 
...
-- Code For temporary table DEGEN_DML98S_ADS_SCA_2_OUT part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "DEGEN_DML98S_ADS_SCA_2_OUT" (
	"KEY" NUMBER(19), 
...
-- Code For temporary table DEGEN_DML98S_ADS_SCA_2_OUT part 2. Populate

INSERT INTO "DEGEN_DML98S_ADS_SCA_2_OUT" ("KEY", scaler_2, scaler_3, scaler_4, scaler_5, scaler_6, scaler_7, scaler_8, scaler_9, scaler_10, scaler_11) SELECT "U"."KEY", "U".scaler_2, "U".scaler_3, "U".scaler_4, "U".scaler_5, "U".scaler_6, "U".scaler_7, "U".scaler_8, "U".scaler_9, "U".scaler_10, "U".scaler_11 
...
FROM "DEGEN_JUYKK0_ADS_IMP_1_OUT" "ADS_imp_1_OUT") "ADS_sca_2_OUT") "U"

-- Code For temporary table 75931_CODEGEN_657VC9_RF_B0 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "75931_CODEGEN_657VC9_RF_B0" (
	"KEY" NUMBER(19), 
...
-- Code For temporary table 75931_CODEGEN_657VC9_RF_B0 part 2. Populate

INSERT INTO "75931_CODEGEN_657VC9_RF_B0" ("KEY", "Score_0", "Proba_0", "LogProba_0", "Score_1", "Proba_1", "LogProba_1") SELECT "U"."KEY", "U"."Score_0", "U"."Proba_0", "U"."LogProba_0", "U"."Score_1", "U"."Proba_1", "U"."LogProba_1" 
...
FROM "DEGEN_DML98S_ADS_SCA_2_OUT" "ADS_sca_2_OUT"), 
"DT_node_data" AS 
...
"DT_node_data_7" AS 
(SELECT "Values".nid AS nid, CAST("Values"."P_0.0" AS BINARY_DOUBLE) AS "P_0.0", CAST("Values"."P_1.0" AS BINARY_DOUBLE) AS "P_1.0", CAST("Values"."D" AS BINARY_DOUBLE) AS "D", CAST("Values"."DP" AS BINARY_DOUBLE) AS "DP" 
FROM (SELECT 2 AS nid, 0.0 AS "P_0.0", 1.0 AS "P_1.0", 1.0 AS "D", 1.0 AS "DP" FROM DUAL UNION ALL SELECT 6 AS nid, 0.0 AS "P_0.0", 1.0 AS "P_1.0", 1.0 AS "D", 1.0 AS "DP" FROM DUAL UNION ALL SELECT 7 AS nid, 1.0 AS "P_0.0", 0.0 AS "P_1.0", 0.0 AS "D", 1.0 AS "DP" FROM DUAL UNION ALL SELECT 10 AS nid, 0.0 AS "P_0.0", 1.0 AS "P_1.0", 1.0 AS "D", 1.0 AS "DP" FROM DUAL UNION ALL SELECT 11 AS nid, 1.0 AS "P_0.0", 0.0 AS "P_1.0", 0.0 AS "D", 1.0 AS "DP" FROM DUAL UNION ALL SELECT 12 AS nid, 0.0 AS "P_0.0", 1.0 AS "P_1.0", 1.0 AS "D", 1.0 AS "DP" FROM DUAL UNION ALL SELECT 15 AS nid, 1.0 AS "P_0.0", 0.0 AS "P_1.0", 0.0 AS "D", 1.0 AS "DP" FROM DUAL UNION ALL SELECT 16 AS nid, 0.0 AS "P_0.0", 1.0 AS "P_1.0", 1.0 AS "D", 1.0 AS "DP" FROM DUAL UNION ALL SELECT 18 AS nid, 1.0 AS "P_0.0", 0.0 AS "P_1.0", 0.0 AS "D", 1.0 AS "DP" FROM DUAL UNION ALL SELECT 19 AS nid, 0.0 AS "P_0.0", 1.0 AS "P_1.0", 1.0 AS "D", 1.0 AS "DP" FROM DUAL UNION ALL SELECT 23 AS nid, 1.0 AS "P_0.0", 0.0 AS "P_1.0", 0.0 AS "D", 1.0 AS "DP" FROM DUAL UNION ALL SELECT 24 AS nid, 0.0 AS "P_0.0", 1.0 AS "P_1.0", 1.0 AS "D", 1.0 AS "DP" FROM DUAL UNION ALL SELECT 25 AS nid, 1.0 AS "P_0.0", 0.0 AS "P_1.0", 0.0 AS "D", 1.0 AS "DP" FROM DUAL UNION ALL SELECT 26 AS nid, 0.0 AS "P_0.0", 1.0 AS "P_1.0", 1.0 AS "D", 1.0 AS "DP" FROM DUAL) "Values"), 
"DT_Output_7" AS 
...
"DT_node_data_8" AS 
(SELECT "Values".nid AS nid, CAST("Values"."P_0.0" AS BINARY_DOUBLE) AS "P_0.0", CAST("Values"."P_1.0" AS BINARY_DOUBLE) AS "P_1.0", CAST("Values"."D" AS BINARY_DOUBLE) AS "D", CAST("Values"."DP" AS BINARY_DOUBLE) AS "DP" 
FROM (SELECT 2 AS nid, 1.0 AS "P_0.0", 0.0 AS "P_1.0", 0.0 AS "D", 1.0 AS "DP" FROM DUAL UNION ALL SELECT 3 AS nid, 0.0 AS "P_0.0", 1.0 AS "P_1.0", 1.0 AS "D", 1.0 AS "DP" FROM DUAL UNION ALL SELECT 8 AS nid, 1.0 AS "P_0.0", 0.0 AS "P_1.0", 0.0 AS "D", 1.0 AS "DP" FROM DUAL UNION ALL SELECT 9 AS nid, 0.0 AS "P_0.0", 1.0 AS "P_1.0", 1.0 AS "D", 1.0 AS "DP" FROM DUAL UNION ALL SELECT 10 AS nid, 0.0 AS "P_0.0", 1.0 AS "P_1.0", 1.0 AS "D", 1.0 AS "DP" FROM DUAL UNION ALL SELECT 11 AS nid, 0.0 AS "P_0.0", 1.0 AS "P_1.0", 1.0 AS "D", 1.0 AS "DP" FROM DUAL UNION ALL SELECT 13 AS nid, 0.0 AS "P_0.0", 1.0 AS "P_1.0", 1.0 AS "D", 1.0 AS "DP" FROM DUAL UNION ALL SELECT 15 AS nid, 1.0 AS "P_0.0", 0.0 AS "P_1.0", 0.0 AS "D", 1.0 AS "DP" FROM DUAL UNION ALL SELECT 16 AS nid, 0.0 AS "P_0.0", 1.0 AS "P_1.0", 1.0 AS "D", 1.0 AS "DP" FROM DUAL) "Values"), 
"DT_Output_8" AS 
...
-- Code For temporary table 75931_CODEGEN_UD0MZN_RF_B1 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "75931_CODEGEN_UD0MZN_RF_B1" (
	"KEY" NUMBER(19), 
	"Score_0" BINARY_DOUBLE, 
	"Proba_0" BINARY_DOUBLE, 
	"LogProba_0" BINARY_DOUBLE, 
...
-- Code For temporary table 75931_CODEGEN_UD0MZN_RF_B1 part 2. Populate

INSERT INTO "75931_CODEGEN_UD0MZN_RF_B1" ("KEY", "Score_0", "Proba_0", "LogProba_0", "Score_1", "Proba_1", "LogProba_1") SELECT "U"."KEY", "U"."Score_0", "U"."Proba_0", "U"."LogProba_0", "U"."Score_1", "U"."Proba_1", "U"."LogProba_1" 
...
-- Code For temporary table 31_CODEGEN_S2CD45_RF_UNION part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "31_CODEGEN_S2CD45_RF_UNION" (
	"KEY" NUMBER(19), 
	"Score_0" BINARY_DOUBLE, 
	"Proba_0" BINARY_DOUBLE, 
	"LogProba_0" BINARY_DOUBLE, 
...
-- Code For temporary table 31_CODEGEN_S2CD45_RF_UNION part 2. Populate

INSERT INTO "31_CODEGEN_S2CD45_RF_UNION" ("KEY", "Score_0", "Proba_0", "LogProba_0", "Score_1", "Proba_1", "LogProba_1") SELECT "U"."KEY", "U"."Score_0", "U"."Proba_0", "U"."LogProba_0", "U"."Score_1", "U"."Proba_1", "U"."LogProba_1" 
...
FROM "75931_CODEGEN_657VC9_RF_B0" "RF_B0" UNION ALL SELECT "RF_B1"."KEY" AS "KEY", "RF_B1"."Score_0" AS "Score_0", "RF_B1"."Proba_0" AS "Proba_0", "RF_B1"."LogProba_0" AS "LogProba_0", "RF_B1"."Score_1" AS "Score_1", "RF_B1"."Proba_1" AS "Proba_1", "RF_B1"."LogProba_1" AS "LogProba_1" 
FROM "75931_CODEGEN_UD0MZN_RF_B1" "RF_B1") "RF_EnsembleUnion") "RF_Union") "U"

-- Code For temporary table 5931_CODEGEN_HGY8B6_RF_AVG part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "5931_CODEGEN_HGY8B6_RF_AVG" (
	"KEY" NUMBER(19), 
	"Score_0" BINARY_DOUBLE, 
	"Proba_0" BINARY_DOUBLE, 
	"LogProba_0" BINARY_DOUBLE, 
...
-- Code For temporary table 5931_CODEGEN_HGY8B6_RF_AVG part 2. Populate

INSERT INTO "5931_CODEGEN_HGY8B6_RF_AVG" ("KEY", "Score_0", "Proba_0", "LogProba_0", "Score_1", "Proba_1", "LogProba_1") SELECT "U"."KEY", "U"."Score_0", "U"."Proba_0", "U"."LogProba_0", "U"."Score_1", "U"."Proba_1", "U"."LogProba_1" 
...
FROM "31_CODEGEN_S2CD45_RF_UNION" "RF_Union" GROUP BY "RF_Union"."KEY") "T") "RF_avg") "U"
...
FROM "5931_CODEGEN_HGY8B6_RF_AVG" "RF_avg"), 
