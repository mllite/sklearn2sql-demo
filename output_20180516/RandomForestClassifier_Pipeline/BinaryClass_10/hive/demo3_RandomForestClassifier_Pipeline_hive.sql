...
-- Code For temporary table tmp_20180509001853_codegen_hwpx51_ads_imp_1_out part 1. Create 

CREATE TEMPORARY TABLE `tmp_20180509001853_codegen_hwpx51_ads_imp_1_out` STORED AS ORC AS SELECT `ADS_imp_1_OUT`.`KEY`, `ADS_imp_1_OUT`.`impter_2`, `ADS_imp_1_OUT`.`impter_3`, `ADS_imp_1_OUT`.`impter_4`, `ADS_imp_1_OUT`.`impter_5`, `ADS_imp_1_OUT`.`impter_6`, `ADS_imp_1_OUT`.`impter_7`, `ADS_imp_1_OUT`.`impter_8`, `ADS_imp_1_OUT`.`impter_9`, `ADS_imp_1_OUT`.`impter_10`, `ADS_imp_1_OUT`.`impter_11` 
...
-- Code For temporary table tmp_20180509001853_codegen_hwpx51_ads_imp_1_out part 2. Populate

SELECT * FROM `tmp_20180509001853_codegen_hwpx51_ads_imp_1_out`

-- Code For temporary table tmp_20180509001853_codegen_4vkum7_ads_sca_2_out part 1. Create 

CREATE TEMPORARY TABLE `tmp_20180509001853_codegen_4vkum7_ads_sca_2_out` STORED AS ORC AS SELECT `ADS_sca_2_OUT`.`KEY`, `ADS_sca_2_OUT`.`scaler_2`, `ADS_sca_2_OUT`.`scaler_3`, `ADS_sca_2_OUT`.`scaler_4`, `ADS_sca_2_OUT`.`scaler_5`, `ADS_sca_2_OUT`.`scaler_6`, `ADS_sca_2_OUT`.`scaler_7`, `ADS_sca_2_OUT`.`scaler_8`, `ADS_sca_2_OUT`.`scaler_9`, `ADS_sca_2_OUT`.`scaler_10`, `ADS_sca_2_OUT`.`scaler_11` 
...
FROM `tmp_20180509001853_codegen_hwpx51_ads_imp_1_out` AS `ADS_imp_1_OUT`) AS `ADS_sca_2_OUT`

-- Code For temporary table tmp_20180509001853_codegen_4vkum7_ads_sca_2_out part 2. Populate

SELECT * FROM `tmp_20180509001853_codegen_4vkum7_ads_sca_2_out`

-- Code For temporary table tmp_20180509001853_codegen_x54p79_rf_b0 part 1. Create 

CREATE TEMPORARY TABLE `tmp_20180509001853_codegen_x54p79_rf_b0` STORED AS ORC AS WITH `DT_node_lookup` AS 
...
FROM `tmp_20180509001853_codegen_4vkum7_ads_sca_2_out` AS `ADS_sca_2_OUT`), 
`DT_node_data` AS 
(SELECT `Values`.`nid` AS `nid`, CAST(`P_0.0` AS DOUBLE) AS `P_0.0`, CAST(`P_1.0` AS DOUBLE) AS `P_1.0`, CAST(`Values`.`D` AS DOUBLE) AS `D`, CAST(`Values`.`DP` AS DOUBLE) AS `DP` 
...
`DT_Output` AS 
(SELECT `DT_node_lookup`.`KEY` AS `KEY`, `DT_node_lookup`.`node_id_2` AS `node_id_2`, `DT_node_data`.`nid` AS `nid`, `P_0.0` AS `P_0.0`, `P_1.0` AS `P_1.0`, `DT_node_data`.`D` AS `D`, `DT_node_data`.`DP` AS `DP` 
...
`DT_Output_1` AS 
(SELECT `DT_node_lookup_1`.`KEY` AS `KEY`, `DT_node_lookup_1`.`node_id_2` AS `node_id_2`, `DT_node_data_1`.`nid` AS `nid`, `P_0.0` AS `P_0.0`, `P_1.0` AS `P_1.0`, `DT_node_data_1`.`D` AS `D`, `DT_node_data_1`.`DP` AS `DP` 
...
`DT_Output_2` AS 
(SELECT `DT_node_lookup_2`.`KEY` AS `KEY`, `DT_node_lookup_2`.`node_id_2` AS `node_id_2`, `DT_node_data_2`.`nid` AS `nid`, `P_0.0` AS `P_0.0`, `P_1.0` AS `P_1.0`, `DT_node_data_2`.`D` AS `D`, `DT_node_data_2`.`DP` AS `DP` 
...
`DT_Output_3` AS 
(SELECT `DT_node_lookup_3`.`KEY` AS `KEY`, `DT_node_lookup_3`.`node_id_2` AS `node_id_2`, `DT_node_data_3`.`nid` AS `nid`, `P_0.0` AS `P_0.0`, `P_1.0` AS `P_1.0`, `DT_node_data_3`.`D` AS `D`, `DT_node_data_3`.`DP` AS `DP` 
...
`DT_Output_4` AS 
(SELECT `DT_node_lookup_4`.`KEY` AS `KEY`, `DT_node_lookup_4`.`node_id_2` AS `node_id_2`, `DT_node_data_4`.`nid` AS `nid`, `P_0.0` AS `P_0.0`, `P_1.0` AS `P_1.0`, `DT_node_data_4`.`D` AS `D`, `DT_node_data_4`.`DP` AS `DP` 
...
`DT_Output_5` AS 
(SELECT `DT_node_lookup_5`.`KEY` AS `KEY`, `DT_node_lookup_5`.`node_id_2` AS `node_id_2`, `DT_node_data_5`.`nid` AS `nid`, `P_0.0` AS `P_0.0`, `P_1.0` AS `P_1.0`, `DT_node_data_5`.`D` AS `D`, `DT_node_data_5`.`DP` AS `DP` 
...
`DT_Output_6` AS 
(SELECT `DT_node_lookup_6`.`KEY` AS `KEY`, `DT_node_lookup_6`.`node_id_2` AS `node_id_2`, `DT_node_data_6`.`nid` AS `nid`, `P_0.0` AS `P_0.0`, `P_1.0` AS `P_1.0`, `DT_node_data_6`.`D` AS `D`, `DT_node_data_6`.`DP` AS `DP` 
...
`DT_Output_7` AS 
(SELECT `DT_node_lookup_7`.`KEY` AS `KEY`, `DT_node_lookup_7`.`node_id_2` AS `node_id_2`, `DT_node_data_7`.`nid` AS `nid`, `P_0.0` AS `P_0.0`, `P_1.0` AS `P_1.0`, `DT_node_data_7`.`D` AS `D`, `DT_node_data_7`.`DP` AS `DP` 
...
`DT_Output_8` AS 
(SELECT `DT_node_lookup_8`.`KEY` AS `KEY`, `DT_node_lookup_8`.`node_id_2` AS `node_id_2`, `DT_node_data_8`.`nid` AS `nid`, `P_0.0` AS `P_0.0`, `P_1.0` AS `P_1.0`, `DT_node_data_8`.`D` AS `D`, `DT_node_data_8`.`DP` AS `DP` 
...
`DT_Output_9` AS 
(SELECT `DT_node_lookup_9`.`KEY` AS `KEY`, `DT_node_lookup_9`.`node_id_2` AS `node_id_2`, `DT_node_data_9`.`nid` AS `nid`, `P_0.0` AS `P_0.0`, `P_1.0` AS `P_1.0`, `DT_node_data_9`.`D` AS `D`, `DT_node_data_9`.`DP` AS `DP` 
...
-- Code For temporary table tmp_20180509001853_codegen_x54p79_rf_b0 part 2. Populate

SELECT * FROM `tmp_20180509001853_codegen_x54p79_rf_b0`

-- Code For temporary table tmp_20180509001853_codegen_ktucot_rf_b1 part 1. Create 

CREATE TEMPORARY TABLE `tmp_20180509001853_codegen_ktucot_rf_b1` STORED AS ORC AS WITH `DT_node_lookup_10` AS 
...
`DT_Output_10` AS 
(SELECT `DT_node_lookup_10`.`KEY` AS `KEY`, `DT_node_lookup_10`.`node_id_2` AS `node_id_2`, `DT_node_data_10`.`nid` AS `nid`, `P_0.0` AS `P_0.0`, `P_1.0` AS `P_1.0`, `DT_node_data_10`.`D` AS `D`, `DT_node_data_10`.`DP` AS `DP` 
...
`DT_Output_11` AS 
(SELECT `DT_node_lookup_11`.`KEY` AS `KEY`, `DT_node_lookup_11`.`node_id_2` AS `node_id_2`, `DT_node_data_11`.`nid` AS `nid`, `P_0.0` AS `P_0.0`, `P_1.0` AS `P_1.0`, `DT_node_data_11`.`D` AS `D`, `DT_node_data_11`.`DP` AS `DP` 
...
`DT_Output_12` AS 
(SELECT `DT_node_lookup_12`.`KEY` AS `KEY`, `DT_node_lookup_12`.`node_id_2` AS `node_id_2`, `DT_node_data_12`.`nid` AS `nid`, `P_0.0` AS `P_0.0`, `P_1.0` AS `P_1.0`, `DT_node_data_12`.`D` AS `D`, `DT_node_data_12`.`DP` AS `DP` 
...
`DT_Output_13` AS 
(SELECT `DT_node_lookup_13`.`KEY` AS `KEY`, `DT_node_lookup_13`.`node_id_2` AS `node_id_2`, `DT_node_data_13`.`nid` AS `nid`, `P_0.0` AS `P_0.0`, `P_1.0` AS `P_1.0`, `DT_node_data_13`.`D` AS `D`, `DT_node_data_13`.`DP` AS `DP` 
...
`DT_Output_14` AS 
(SELECT `DT_node_lookup_14`.`KEY` AS `KEY`, `DT_node_lookup_14`.`node_id_2` AS `node_id_2`, `DT_node_data_14`.`nid` AS `nid`, `P_0.0` AS `P_0.0`, `P_1.0` AS `P_1.0`, `DT_node_data_14`.`D` AS `D`, `DT_node_data_14`.`DP` AS `DP` 
...
`DT_Output_15` AS 
(SELECT `DT_node_lookup_15`.`KEY` AS `KEY`, `DT_node_lookup_15`.`node_id_2` AS `node_id_2`, `DT_node_data_15`.`nid` AS `nid`, `P_0.0` AS `P_0.0`, `P_1.0` AS `P_1.0`, `DT_node_data_15`.`D` AS `D`, `DT_node_data_15`.`DP` AS `DP` 
...
-- Code For temporary table tmp_20180509001853_codegen_ktucot_rf_b1 part 2. Populate

SELECT * FROM `tmp_20180509001853_codegen_ktucot_rf_b1`

-- Code For temporary table tmp_20180509001853_codegen_ny5dzx_rf_union part 1. Create 

CREATE TEMPORARY TABLE `tmp_20180509001853_codegen_ny5dzx_rf_union` STORED AS ORC AS SELECT `RF_Union`.`KEY`, `RF_Union`.`Score_0`, `RF_Union`.`Proba_0`, `RF_Union`.`LogProba_0`, `RF_Union`.`Score_1`, `RF_Union`.`Proba_1`, `RF_Union`.`LogProba_1` 
...
FROM `tmp_20180509001853_codegen_x54p79_rf_b0` AS `RF_B0` UNION ALL SELECT `RF_B1`.`KEY` AS `KEY`, `RF_B1`.`Score_0` AS `Score_0`, `RF_B1`.`Proba_0` AS `Proba_0`, `RF_B1`.`LogProba_0` AS `LogProba_0`, `RF_B1`.`Score_1` AS `Score_1`, `RF_B1`.`Proba_1` AS `Proba_1`, `RF_B1`.`LogProba_1` AS `LogProba_1` 
FROM `tmp_20180509001853_codegen_ktucot_rf_b1` AS `RF_B1`) AS `RF_EnsembleUnion`) AS `RF_Union`

-- Code For temporary table tmp_20180509001853_codegen_ny5dzx_rf_union part 2. Populate

SELECT * FROM `tmp_20180509001853_codegen_ny5dzx_rf_union`

-- Code For temporary table tmp_20180509001853_codegen_04c9jj_rf_avg part 1. Create 

CREATE TEMPORARY TABLE `tmp_20180509001853_codegen_04c9jj_rf_avg` STORED AS ORC AS SELECT `RF_avg`.`KEY`, `RF_avg`.`Score_0`, `RF_avg`.`Proba_0`, `RF_avg`.`LogProba_0`, `RF_avg`.`Score_1`, `RF_avg`.`Proba_1`, `RF_avg`.`LogProba_1` 
...
FROM `tmp_20180509001853_codegen_ny5dzx_rf_union` AS `RF_Union` GROUP BY `RF_Union`.`KEY`) AS `T`) AS `RF_avg`

-- Code For temporary table tmp_20180509001853_codegen_04c9jj_rf_avg part 2. Populate

SELECT * FROM `tmp_20180509001853_codegen_04c9jj_rf_avg`
...
FROM `tmp_20180509001853_codegen_04c9jj_rf_avg` AS `RF_avg`), 
