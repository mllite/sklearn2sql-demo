...
-- Code For temporary table tmp_20180516110500_codegen_ytit2x_ads_imp_1_out part 1. Create 


CREATE TABLE tmp_20180516110500_codegen_ytit2x_ads_imp_1_out (
	`KEY` BIGINT, 
	impter_2 DOUBLE, 
	impter_3 DOUBLE, 
	impter_4 DOUBLE, 
...
-- Code For temporary table tmp_20180516110500_codegen_ytit2x_ads_imp_1_out part 2. Populate

INSERT INTO tmp_20180516110500_codegen_ytit2x_ads_imp_1_out (`KEY`, impter_2, impter_3, impter_4, impter_5, impter_6, impter_7, impter_8, impter_9, impter_10, impter_11) SELECT `ADS_imp_1_OUT`.`KEY`, `ADS_imp_1_OUT`.impter_2, `ADS_imp_1_OUT`.impter_3, `ADS_imp_1_OUT`.impter_4, `ADS_imp_1_OUT`.impter_5, `ADS_imp_1_OUT`.impter_6, `ADS_imp_1_OUT`.impter_7, `ADS_imp_1_OUT`.impter_8, `ADS_imp_1_OUT`.impter_9, `ADS_imp_1_OUT`.impter_10, `ADS_imp_1_OUT`.impter_11 
...
-- Code For temporary table tmp_20180516110500_codegen_pwe1w5_ads_sca_2_out part 1. Create 


CREATE TABLE tmp_20180516110500_codegen_pwe1w5_ads_sca_2_out (
	`KEY` BIGINT, 
	scaler_2 DOUBLE, 
	scaler_3 DOUBLE, 
	scaler_4 DOUBLE, 
...
FROM tmp_20180516110500_codegen_ytit2x_ads_imp_1_out AS `ADS_imp_1_OUT`) AS `ADS_sca_2_OUT`

-- Code For temporary table tmp_20180516110501_codegen_3c3bfg_rf_b0 part 1. Create 


CREATE TABLE tmp_20180516110501_codegen_3c3bfg_rf_b0 (
	`KEY` BIGINT, 
	`Score_0` DOUBLE, 
	`Proba_0` DOUBLE, 
	`LogProba_0` DOUBLE, 
...
-- Code For temporary table tmp_20180516110501_codegen_3c3bfg_rf_b0 part 2. Populate
...
FROM tmp_20180516110500_codegen_pwe1w5_ads_sca_2_out AS `ADS_sca_2_OUT`), 
`DT_node_data` AS 
...
FROM `DT_Output_9`)
 INSERT INTO tmp_20180516110501_codegen_3c3bfg_rf_b0 (`KEY`, `Score_0`, `Proba_0`, `LogProba_0`, `Score_1`, `Proba_1`, `LogProba_1`) SELECT `RF_B0`.`KEY`, `RF_B0`.`Score_0`, `RF_B0`.`Proba_0`, `RF_B0`.`LogProba_0`, `RF_B0`.`Score_1`, `RF_B0`.`Proba_1`, `RF_B0`.`LogProba_1` 
...
-- Code For temporary table tmp_20180516110501_codegen_om3qw3_rf_b1 part 1. Create 


CREATE TABLE tmp_20180516110501_codegen_om3qw3_rf_b1 (
	`KEY` BIGINT, 
	`Score_0` DOUBLE, 
	`Proba_0` DOUBLE, 
	`LogProba_0` DOUBLE, 
...
-- Code For temporary table tmp_20180516110501_codegen_om3qw3_rf_b1 part 2. Populate
...
FROM `DT_Output_15`)
 INSERT INTO tmp_20180516110501_codegen_om3qw3_rf_b1 (`KEY`, `Score_0`, `Proba_0`, `LogProba_0`, `Score_1`, `Proba_1`, `LogProba_1`) SELECT `RF_B1`.`KEY`, `RF_B1`.`Score_0`, `RF_B1`.`Proba_0`, `RF_B1`.`LogProba_0`, `RF_B1`.`Score_1`, `RF_B1`.`Proba_1`, `RF_B1`.`LogProba_1` 
...
-- Code For temporary table tmp_20180516110501_codegen_y3g5oc_rf_avg part 1. Create 


CREATE TABLE tmp_20180516110501_codegen_y3g5oc_rf_avg (
	`KEY` BIGINT, 
	`Score_0` DOUBLE, 
	`Proba_0` DOUBLE, 
	`LogProba_0` DOUBLE, 
...
-- Code For temporary table tmp_20180516110501_codegen_y3g5oc_rf_avg part 2. Populate
...
FROM tmp_20180516110501_codegen_3c3bfg_rf_b0 AS `RF_B0` UNION ALL SELECT `RF_B1`.`KEY` AS `KEY`, `RF_B1`.`Score_0` AS `Score_0`, `RF_B1`.`Proba_0` AS `Proba_0`, `RF_B1`.`LogProba_0` AS `LogProba_0`, `RF_B1`.`Score_1` AS `Score_1`, `RF_B1`.`Proba_1` AS `Proba_1`, `RF_B1`.`LogProba_1` AS `LogProba_1` 
FROM tmp_20180516110501_codegen_om3qw3_rf_b1 AS `RF_B1`) AS `RF_EnsembleUnion`)
 INSERT INTO tmp_20180516110501_codegen_y3g5oc_rf_avg (`KEY`, `Score_0`, `Proba_0`, `LogProba_0`, `Score_1`, `Proba_1`, `LogProba_1`) SELECT `RF_avg`.`KEY`, `RF_avg`.`Score_0`, `RF_avg`.`Proba_0`, `RF_avg`.`LogProba_0`, `RF_avg`.`Score_1`, `RF_avg`.`Proba_1`, `RF_avg`.`LogProba_1` 
...
FROM tmp_20180516110501_codegen_y3g5oc_rf_avg AS `RF_avg`), 
