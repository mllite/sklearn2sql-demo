...
-- Code For temporary table tmp_20180508191956_codegen_nqyf65_ads_imp_1_out part 1. Create 


CREATE TABLE tmp_20180508191956_codegen_nqyf65_ads_imp_1_out (
	`KEY` BIGINT, 
	impter_2 DOUBLE, 
	impter_3 DOUBLE, 
	impter_4 DOUBLE, 
...
-- Code For temporary table tmp_20180508191956_codegen_nqyf65_ads_imp_1_out part 2. Populate

INSERT INTO tmp_20180508191956_codegen_nqyf65_ads_imp_1_out (`KEY`, impter_2, impter_3, impter_4, impter_5, impter_6, impter_7, impter_8, impter_9, impter_10, impter_11) SELECT `ADS_imp_1_OUT`.`KEY`, `ADS_imp_1_OUT`.impter_2, `ADS_imp_1_OUT`.impter_3, `ADS_imp_1_OUT`.impter_4, `ADS_imp_1_OUT`.impter_5, `ADS_imp_1_OUT`.impter_6, `ADS_imp_1_OUT`.impter_7, `ADS_imp_1_OUT`.impter_8, `ADS_imp_1_OUT`.impter_9, `ADS_imp_1_OUT`.impter_10, `ADS_imp_1_OUT`.impter_11 
...
-- Code For temporary table tmp_20180508191956_codegen_ubk7c2_ads_sca_2_out part 1. Create 


CREATE TABLE tmp_20180508191956_codegen_ubk7c2_ads_sca_2_out (
	`KEY` BIGINT, 
	scaler_2 DOUBLE, 
	scaler_3 DOUBLE, 
	scaler_4 DOUBLE, 
...
-- Code For temporary table tmp_20180508191956_codegen_ubk7c2_ads_sca_2_out part 2. Populate

INSERT INTO tmp_20180508191956_codegen_ubk7c2_ads_sca_2_out (`KEY`, scaler_2, scaler_3, scaler_4, scaler_5, scaler_6, scaler_7, scaler_8, scaler_9, scaler_10, scaler_11) SELECT `ADS_sca_2_OUT`.`KEY`, `ADS_sca_2_OUT`.scaler_2, `ADS_sca_2_OUT`.scaler_3, `ADS_sca_2_OUT`.scaler_4, `ADS_sca_2_OUT`.scaler_5, `ADS_sca_2_OUT`.scaler_6, `ADS_sca_2_OUT`.scaler_7, `ADS_sca_2_OUT`.scaler_8, `ADS_sca_2_OUT`.scaler_9, `ADS_sca_2_OUT`.scaler_10, `ADS_sca_2_OUT`.scaler_11 
...
FROM tmp_20180508191956_codegen_nqyf65_ads_imp_1_out AS `ADS_imp_1_OUT`) AS `ADS_sca_2_OUT`

-- Code For temporary table tmp_20180508191956_codegen_wveld3_rf_b0 part 1. Create 


CREATE TABLE tmp_20180508191956_codegen_wveld3_rf_b0 (
	`KEY` BIGINT, 
	`Score_0` DOUBLE, 
	`Proba_0` DOUBLE, 
	`LogProba_0` DOUBLE, 
...
-- Code For temporary table tmp_20180508191956_codegen_wveld3_rf_b0 part 2. Populate
...
FROM tmp_20180508191956_codegen_ubk7c2_ads_sca_2_out AS `ADS_sca_2_OUT`), 
`DT_node_data` AS 
...
FROM `DT_Output_9`)
 INSERT INTO tmp_20180508191956_codegen_wveld3_rf_b0 (`KEY`, `Score_0`, `Proba_0`, `LogProba_0`, `Score_1`, `Proba_1`, `LogProba_1`) SELECT `RF_B0`.`KEY`, `RF_B0`.`Score_0`, `RF_B0`.`Proba_0`, `RF_B0`.`LogProba_0`, `RF_B0`.`Score_1`, `RF_B0`.`Proba_1`, `RF_B0`.`LogProba_1` 
...
-- Code For temporary table tmp_20180508191956_codegen_73tmip_rf_b1 part 1. Create 


CREATE TABLE tmp_20180508191956_codegen_73tmip_rf_b1 (
	`KEY` BIGINT, 
	`Score_0` DOUBLE, 
	`Proba_0` DOUBLE, 
	`LogProba_0` DOUBLE, 
...
-- Code For temporary table tmp_20180508191956_codegen_73tmip_rf_b1 part 2. Populate
...
FROM `DT_Output_15`)
 INSERT INTO tmp_20180508191956_codegen_73tmip_rf_b1 (`KEY`, `Score_0`, `Proba_0`, `LogProba_0`, `Score_1`, `Proba_1`, `LogProba_1`) SELECT `RF_B1`.`KEY`, `RF_B1`.`Score_0`, `RF_B1`.`Proba_0`, `RF_B1`.`LogProba_0`, `RF_B1`.`Score_1`, `RF_B1`.`Proba_1`, `RF_B1`.`LogProba_1` 
...
-- Code For temporary table tmp_20180508191956_codegen_a1cwp7_rf_union part 1. Create 


CREATE TABLE tmp_20180508191956_codegen_a1cwp7_rf_union (
	`KEY` BIGINT, 
	`Score_0` DOUBLE, 
	`Proba_0` DOUBLE, 
	`LogProba_0` DOUBLE, 
...
-- Code For temporary table tmp_20180508191956_codegen_a1cwp7_rf_union part 2. Populate

INSERT INTO tmp_20180508191956_codegen_a1cwp7_rf_union (`KEY`, `Score_0`, `Proba_0`, `LogProba_0`, `Score_1`, `Proba_1`, `LogProba_1`) SELECT `RF_Union`.`KEY`, `RF_Union`.`Score_0`, `RF_Union`.`Proba_0`, `RF_Union`.`LogProba_0`, `RF_Union`.`Score_1`, `RF_Union`.`Proba_1`, `RF_Union`.`LogProba_1` 
...
FROM tmp_20180508191956_codegen_wveld3_rf_b0 AS `RF_B0` UNION ALL SELECT `RF_B1`.`KEY` AS `KEY`, `RF_B1`.`Score_0` AS `Score_0`, `RF_B1`.`Proba_0` AS `Proba_0`, `RF_B1`.`LogProba_0` AS `LogProba_0`, `RF_B1`.`Score_1` AS `Score_1`, `RF_B1`.`Proba_1` AS `Proba_1`, `RF_B1`.`LogProba_1` AS `LogProba_1` 
FROM tmp_20180508191956_codegen_73tmip_rf_b1 AS `RF_B1`) AS `RF_EnsembleUnion`) AS `RF_Union`

-- Code For temporary table tmp_20180508191956_codegen_xsw3nk_rf_avg part 1. Create 


CREATE TABLE tmp_20180508191956_codegen_xsw3nk_rf_avg (
	`KEY` BIGINT, 
	`Score_0` DOUBLE, 
	`Proba_0` DOUBLE, 
	`LogProba_0` DOUBLE, 
...
-- Code For temporary table tmp_20180508191956_codegen_xsw3nk_rf_avg part 2. Populate

INSERT INTO tmp_20180508191956_codegen_xsw3nk_rf_avg (`KEY`, `Score_0`, `Proba_0`, `LogProba_0`, `Score_1`, `Proba_1`, `LogProba_1`) SELECT `RF_avg`.`KEY`, `RF_avg`.`Score_0`, `RF_avg`.`Proba_0`, `RF_avg`.`LogProba_0`, `RF_avg`.`Score_1`, `RF_avg`.`Proba_1`, `RF_avg`.`LogProba_1` 
...
FROM tmp_20180508191956_codegen_a1cwp7_rf_union AS `RF_Union` GROUP BY `RF_Union`.`KEY`) AS `T`) AS `RF_avg`
...
FROM tmp_20180508191956_codegen_xsw3nk_rf_avg AS `RF_avg`), 
