...
-- Code For temporary table TMP_20180508185723_CODEGEN_ALZD3K_ADS_imp_1_OUT part 1. Create 


CREATE TEMPORARY TABLE "TMP_20180508185723_CODEGEN_ALZD3K_ADS_imp_1_OUT" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20180508185723_CODEGEN_ALZD3K_ADS_imp_1_OUT part 2. Populate

INSERT INTO "TMP_20180508185723_CODEGEN_ALZD3K_ADS_imp_1_OUT" ("KEY", imputer_output_2, imputer_output_3, imputer_output_4, imputer_output_5) SELECT "ADS_imp_1_OUT"."KEY", "ADS_imp_1_OUT".imputer_output_2, "ADS_imp_1_OUT".imputer_output_3, "ADS_imp_1_OUT".imputer_output_4, "ADS_imp_1_OUT".imputer_output_5 
FROM (SELECT "ADS"."KEY" AS "KEY", CASE WHEN ("ADS"."Feature_0" IS NULL) THEN 5.8474999999999975 ELSE "ADS"."Feature_0" END AS imputer_output_2, CASE WHEN ("ADS"."Feature_1" IS NULL) THEN 3.0366666666666657 ELSE "ADS"."Feature_1" END AS imputer_output_3, CASE WHEN ("ADS"."Feature_2" IS NULL) THEN 3.8450000000000006 ELSE "ADS"."Feature_2" END AS imputer_output_4, CASE WHEN ("ADS"."Feature_3" IS NULL) THEN 1.245 ELSE "ADS"."Feature_3" END AS imputer_output_5 
FROM iris AS "ADS") AS "ADS_imp_1_OUT"

-- Code For temporary table TMP_20180508185723_CODEGEN_ALZD3K_ADS_imp_1_OUT part 3. Create Index 

CREATE INDEX "ix_TMP_20180508185723_CODEGEN_ALZD3K_ADS_imp_1_OUT_KEY" ON "TMP_20180508185723_CODEGEN_ALZD3K_ADS_imp_1_OUT" ("KEY")

-- Code For temporary table TMP_20180508185723_CODEGEN_O6W2Q7_ADS_sca_2_OUT part 1. Create 


CREATE TEMPORARY TABLE "TMP_20180508185723_CODEGEN_O6W2Q7_ADS_sca_2_OUT" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20180508185723_CODEGEN_O6W2Q7_ADS_sca_2_OUT part 2. Populate

INSERT INTO "TMP_20180508185723_CODEGEN_O6W2Q7_ADS_sca_2_OUT" ("KEY", scaler_output_2, scaler_output_3, scaler_output_4, scaler_output_5) SELECT "ADS_sca_2_OUT"."KEY", "ADS_sca_2_OUT".scaler_output_2, "ADS_sca_2_OUT".scaler_output_3, "ADS_sca_2_OUT".scaler_output_4, "ADS_sca_2_OUT".scaler_output_5 
...
FROM "TMP_20180508185723_CODEGEN_ALZD3K_ADS_imp_1_OUT" AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT"

-- Code For temporary table TMP_20180508185723_CODEGEN_O6W2Q7_ADS_sca_2_OUT part 3. Create Index 

CREATE INDEX "ix_TMP_20180508185723_CODEGEN_O6W2Q7_ADS_sca_2_OUT_KEY" ON "TMP_20180508185723_CODEGEN_O6W2Q7_ADS_sca_2_OUT" ("KEY")

-- Code For temporary table TMP_20180508185724_CODEGEN_YMK7TN_RF_B0 part 1. Create 


CREATE TEMPORARY TABLE "TMP_20180508185724_CODEGEN_YMK7TN_RF_B0" (
	"KEY" BIGINT, 
	"Score_0" FLOAT, 
	"Proba_0" FLOAT, 
	"LogProba_0" FLOAT, 
...
-- Code For temporary table TMP_20180508185724_CODEGEN_YMK7TN_RF_B0 part 2. Populate
...
FROM "TMP_20180508185723_CODEGEN_O6W2Q7_ADS_sca_2_OUT" AS "ADS_sca_2_OUT"), 
"DT_node_data" AS 
...
FROM "DT_Output_9")
 INSERT INTO "TMP_20180508185724_CODEGEN_YMK7TN_RF_B0" ("KEY", "Score_0", "Proba_0", "LogProba_0", "Score_1", "Proba_1", "LogProba_1", "Score_2", "Proba_2", "LogProba_2") SELECT "RF_B0"."KEY", "RF_B0"."Score_0", "RF_B0"."Proba_0", "RF_B0"."LogProba_0", "RF_B0"."Score_1", "RF_B0"."Proba_1", "RF_B0"."LogProba_1", "RF_B0"."Score_2", "RF_B0"."Proba_2", "RF_B0"."LogProba_2" 
...
-- Code For temporary table TMP_20180508185724_CODEGEN_V1KN5K_RF_B1 part 1. Create 


CREATE TEMPORARY TABLE "TMP_20180508185724_CODEGEN_V1KN5K_RF_B1" (
	"KEY" BIGINT, 
	"Score_0" FLOAT, 
	"Proba_0" FLOAT, 
	"LogProba_0" FLOAT, 
...
-- Code For temporary table TMP_20180508185724_CODEGEN_V1KN5K_RF_B1 part 2. Populate
...
FROM "DT_Output_15")
 INSERT INTO "TMP_20180508185724_CODEGEN_V1KN5K_RF_B1" ("KEY", "Score_0", "Proba_0", "LogProba_0", "Score_1", "Proba_1", "LogProba_1", "Score_2", "Proba_2", "LogProba_2") SELECT "RF_B1"."KEY", "RF_B1"."Score_0", "RF_B1"."Proba_0", "RF_B1"."LogProba_0", "RF_B1"."Score_1", "RF_B1"."Proba_1", "RF_B1"."LogProba_1", "RF_B1"."Score_2", "RF_B1"."Proba_2", "RF_B1"."LogProba_2" 
...
-- Code For temporary table TMP_20180508185724_CODEGEN_E68D26_RF_Union part 1. Create 


CREATE TEMPORARY TABLE "TMP_20180508185724_CODEGEN_E68D26_RF_Union" (
	"KEY" BIGINT, 
	"Score_0" FLOAT, 
	"Proba_0" FLOAT, 
	"LogProba_0" FLOAT, 
...
-- Code For temporary table TMP_20180508185724_CODEGEN_E68D26_RF_Union part 2. Populate

INSERT INTO "TMP_20180508185724_CODEGEN_E68D26_RF_Union" ("KEY", "Score_0", "Proba_0", "LogProba_0", "Score_1", "Proba_1", "LogProba_1", "Score_2", "Proba_2", "LogProba_2") SELECT "RF_Union"."KEY", "RF_Union"."Score_0", "RF_Union"."Proba_0", "RF_Union"."LogProba_0", "RF_Union"."Score_1", "RF_Union"."Proba_1", "RF_Union"."LogProba_1", "RF_Union"."Score_2", "RF_Union"."Proba_2", "RF_Union"."LogProba_2" 
...
FROM "TMP_20180508185724_CODEGEN_YMK7TN_RF_B0" AS "RF_B0" UNION ALL SELECT "RF_B1"."KEY" AS "KEY", "RF_B1"."Score_0" AS "Score_0", "RF_B1"."Proba_0" AS "Proba_0", "RF_B1"."LogProba_0" AS "LogProba_0", "RF_B1"."Score_1" AS "Score_1", "RF_B1"."Proba_1" AS "Proba_1", "RF_B1"."LogProba_1" AS "LogProba_1", "RF_B1"."Score_2" AS "Score_2", "RF_B1"."Proba_2" AS "Proba_2", "RF_B1"."LogProba_2" AS "LogProba_2" 
FROM "TMP_20180508185724_CODEGEN_V1KN5K_RF_B1" AS "RF_B1") AS "RF_EnsembleUnion") AS "RF_Union"

-- Code For temporary table TMP_20180508185724_CODEGEN_U3M64J_RF_avg part 1. Create 


CREATE TEMPORARY TABLE "TMP_20180508185724_CODEGEN_U3M64J_RF_avg" (
	"KEY" BIGINT NOT NULL, 
	"Score_0" FLOAT, 
	"Proba_0" FLOAT, 
	"LogProba_0" FLOAT, 
...
-- Code For temporary table TMP_20180508185724_CODEGEN_U3M64J_RF_avg part 2. Populate

INSERT INTO "TMP_20180508185724_CODEGEN_U3M64J_RF_avg" ("KEY", "Score_0", "Proba_0", "LogProba_0", "Score_1", "Proba_1", "LogProba_1", "Score_2", "Proba_2", "LogProba_2") SELECT "RF_avg"."KEY", "RF_avg"."Score_0", "RF_avg"."Proba_0", "RF_avg"."LogProba_0", "RF_avg"."Score_1", "RF_avg"."Proba_1", "RF_avg"."LogProba_1", "RF_avg"."Score_2", "RF_avg"."Proba_2", "RF_avg"."LogProba_2" 
...
FROM "TMP_20180508185724_CODEGEN_E68D26_RF_Union" AS "RF_Union" GROUP BY "RF_Union"."KEY") AS "T") AS "RF_avg"

-- Code For temporary table TMP_20180508185724_CODEGEN_U3M64J_RF_avg part 3. Create Index 

CREATE INDEX "ix_TMP_20180508185724_CODEGEN_U3M64J_RF_avg_KEY" ON "TMP_20180508185724_CODEGEN_U3M64J_RF_avg" ("KEY")
...
FROM "TMP_20180508185724_CODEGEN_U3M64J_RF_avg" AS "RF_avg"), 
