...
-- Code For temporary table tmp_20180516111428_codegen_5uz55b_bag_b0 part 1. Create 


CREATE TEMPORARY TABLE tmp_20180516111428_codegen_5uz55b_bag_b0 (
	"KEY" BIGINT, 
	"Score_0" DOUBLE, 
	"Proba_0" DOUBLE, 
	"LogProba_0" DOUBLE, 
...
-- Code For temporary table tmp_20180516111428_codegen_5uz55b_bag_b0 part 2. Populate

INSERT INTO tmp_20180516111428_codegen_5uz55b_bag_b0 ("KEY", "Score_0", "Proba_0", "LogProba_0", "Score_1", "Proba_1", "LogProba_1") SELECT "U"."KEY", "U"."Score_0", "U"."Proba_0", "U"."LogProba_0", "U"."Score_1", "U"."Proba_1", "U"."LogProba_1" 
...
-- Code For temporary table tmp_20180516111428_codegen_sjkerx_bag_b1 part 1. Create 


CREATE TEMPORARY TABLE tmp_20180516111428_codegen_sjkerx_bag_b1 (
	"KEY" BIGINT, 
	"Score_0" DOUBLE, 
	"Proba_0" DOUBLE, 
	"LogProba_0" DOUBLE, 
...
-- Code For temporary table tmp_20180516111428_codegen_sjkerx_bag_b1 part 2. Populate

INSERT INTO tmp_20180516111428_codegen_sjkerx_bag_b1 ("KEY", "Score_0", "Proba_0", "LogProba_0", "Score_1", "Proba_1", "LogProba_1") SELECT "U"."KEY", "U"."Score_0", "U"."Proba_0", "U"."LogProba_0", "U"."Score_1", "U"."Proba_1", "U"."LogProba_1" 
...
-- Code For temporary table tmp_20180516111428_codegen_72ia65_bag_avg part 1. Create 


CREATE TEMPORARY TABLE tmp_20180516111428_codegen_72ia65_bag_avg (
	"KEY" BIGINT, 
	"Score_0" DOUBLE, 
	"Proba_0" DOUBLE, 
	"LogProba_0" DOUBLE, 
...
-- Code For temporary table tmp_20180516111428_codegen_72ia65_bag_avg part 2. Populate

INSERT INTO tmp_20180516111428_codegen_72ia65_bag_avg ("KEY", "Score_0", "Proba_0", "LogProba_0", "Score_1", "Proba_1", "LogProba_1") SELECT "U"."KEY", "U"."Score_0", "U"."Proba_0", "U"."LogProba_0", "U"."Score_1", "U"."Proba_1", "U"."LogProba_1" 
...
FROM tmp_20180516111428_codegen_5uz55b_bag_b0 AS "BAG_B0" UNION ALL SELECT "BAG_B1"."KEY" AS "KEY", "BAG_B1"."Score_0" AS "Score_0", "BAG_B1"."Proba_0" AS "Proba_0", "BAG_B1"."LogProba_0" AS "LogProba_0", "BAG_B1"."Score_1" AS "Score_1", "BAG_B1"."Proba_1" AS "Proba_1", "BAG_B1"."LogProba_1" AS "LogProba_1" 
FROM tmp_20180516111428_codegen_sjkerx_bag_b1 AS "BAG_B1") AS "BAG_EnsembleUnion")
...
FROM tmp_20180516111428_codegen_72ia65_bag_avg AS "BAG_avg"), 
