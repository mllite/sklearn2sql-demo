...
-- Code For temporary table TMP_20180516_CODEGEN_A2S2IQ_BAG part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180516_CODEGEN_A2S2IQ_BAG" (
	"KEY" BIGINT, 
...
-- Code For temporary table TMP_20180516_CODEGEN_A2S2IQ_BAG part 2. Populate

INSERT INTO "TMP_20180516_CODEGEN_A2S2IQ_BAG" ("KEY", "Score_0", "Proba_0", "LogProba_0", "Score_1", "Proba_1", "LogProba_1") SELECT "U"."KEY", "U"."Score_0", "U"."Proba_0", "U"."LogProba_0", "U"."Score_1", "U"."Proba_1", "U"."LogProba_1" 
...
-- Code For temporary table TMP_20180516_CODEGEN_B9G2SJ_BAG part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180516_CODEGEN_B9G2SJ_BAG" (
	"KEY" BIGINT, 
	"Score_0" DOUBLE PRECISION, 
	"Proba_0" DOUBLE PRECISION, 
	"LogProba_0" DOUBLE PRECISION, 
...
-- Code For temporary table TMP_20180516_CODEGEN_B9G2SJ_BAG part 2. Populate

INSERT INTO "TMP_20180516_CODEGEN_B9G2SJ_BAG" ("KEY", "Score_0", "Proba_0", "LogProba_0", "Score_1", "Proba_1", "LogProba_1") SELECT "U"."KEY", "U"."Score_0", "U"."Proba_0", "U"."LogProba_0", "U"."Score_1", "U"."Proba_1", "U"."LogProba_1" 
...
-- Code For temporary table TMP_20180516_CODEGEN_LC63Z2_BAG part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180516_CODEGEN_LC63Z2_BAG" (
	"KEY" BIGINT NOT NULL, 
	"Score_0" DOUBLE PRECISION, 
	"Proba_0" DOUBLE PRECISION, 
	"LogProba_0" DOUBLE PRECISION, 
...
-- Code For temporary table TMP_20180516_CODEGEN_LC63Z2_BAG part 2. Populate

INSERT INTO "TMP_20180516_CODEGEN_LC63Z2_BAG" ("KEY", "Score_0", "Proba_0", "LogProba_0", "Score_1", "Proba_1", "LogProba_1") SELECT "U"."KEY", "U"."Score_0", "U"."Proba_0", "U"."LogProba_0", "U"."Score_1", "U"."Proba_1", "U"."LogProba_1" 
...
FROM "TMP_20180516_CODEGEN_A2S2IQ_BAG" AS "BAG_B0" UNION ALL SELECT "BAG_B1"."KEY" AS "KEY", "BAG_B1"."Score_0" AS "Score_0", "BAG_B1"."Proba_0" AS "Proba_0", "BAG_B1"."LogProba_0" AS "LogProba_0", "BAG_B1"."Score_1" AS "Score_1", "BAG_B1"."Proba_1" AS "Proba_1", "BAG_B1"."LogProba_1" AS "LogProba_1" 
FROM "TMP_20180516_CODEGEN_B9G2SJ_BAG" AS "BAG_B1") AS "BAG_EnsembleUnion")
...
-- Code For temporary table TMP_20180516_CODEGEN_LC63Z2_BAG part 3. Create Index 

CREATE INDEX "ix_TMP_20180516_CODEGEN_1b07" ON "TMP_20180516_CODEGEN_LC63Z2_BAG" ("KEY")
...
FROM "TMP_20180516_CODEGEN_LC63Z2_BAG" AS "BAG_avg"), 
