...
-- Code For temporary table TMP_20180508175651_CODEGEN_LRZQ part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508175651_CODEGEN_LRZQ" (
	"KEY" BIGINT, 
...
-- Code For temporary table TMP_20180508175651_CODEGEN_LRZQ part 2. Populate

INSERT INTO "TMP_20180508175651_CODEGEN_LRZQ" ("KEY", "Score_0", "Proba_0", "LogProba_0", "Score_1", "Proba_1", "LogProba_1") SELECT "U"."KEY", "U"."Score_0", "U"."Proba_0", "U"."LogProba_0", "U"."Score_1", "U"."Proba_1", "U"."LogProba_1" 
...
-- Code For temporary table TMP_20180508175651_CODEGEN_X67M part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508175651_CODEGEN_X67M" (
	"KEY" BIGINT, 
	"Score_0" DOUBLE PRECISION, 
	"Proba_0" DOUBLE PRECISION, 
	"LogProba_0" DOUBLE PRECISION, 
...
-- Code For temporary table TMP_20180508175651_CODEGEN_X67M part 2. Populate

INSERT INTO "TMP_20180508175651_CODEGEN_X67M" ("KEY", "Score_0", "Proba_0", "LogProba_0", "Score_1", "Proba_1", "LogProba_1") SELECT "U"."KEY", "U"."Score_0", "U"."Proba_0", "U"."LogProba_0", "U"."Score_1", "U"."Proba_1", "U"."LogProba_1" 
...
-- Code For temporary table TMP_20180508175651_CODEGEN_3Z3E part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508175651_CODEGEN_3Z3E" (
	"KEY" BIGINT, 
	"Score_0" DOUBLE PRECISION, 
	"Proba_0" DOUBLE PRECISION, 
	"LogProba_0" DOUBLE PRECISION, 
...
-- Code For temporary table TMP_20180508175651_CODEGEN_3Z3E part 2. Populate

INSERT INTO "TMP_20180508175651_CODEGEN_3Z3E" ("KEY", "Score_0", "Proba_0", "LogProba_0", "Score_1", "Proba_1", "LogProba_1") SELECT "U"."KEY", "U"."Score_0", "U"."Proba_0", "U"."LogProba_0", "U"."Score_1", "U"."Proba_1", "U"."LogProba_1" 
...
FROM "TMP_20180508175651_CODEGEN_LRZQ" AS "BAG_B0" UNION ALL SELECT "BAG_B1"."KEY" AS "KEY", "BAG_B1"."Score_0" AS "Score_0", "BAG_B1"."Proba_0" AS "Proba_0", "BAG_B1"."LogProba_0" AS "LogProba_0", "BAG_B1"."Score_1" AS "Score_1", "BAG_B1"."Proba_1" AS "Proba_1", "BAG_B1"."LogProba_1" AS "LogProba_1" 
FROM "TMP_20180508175651_CODEGEN_X67M" AS "BAG_B1") AS "BAG_EnsembleUnion") AS "BAG_Union") AS "U"

-- Code For temporary table TMP_20180508175651_CODEGEN_NJ5S part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508175651_CODEGEN_NJ5S" (
	"KEY" BIGINT NOT NULL, 
	"Score_0" DOUBLE PRECISION, 
	"Proba_0" DOUBLE PRECISION, 
	"LogProba_0" DOUBLE PRECISION, 
...
-- Code For temporary table TMP_20180508175651_CODEGEN_NJ5S part 2. Populate

INSERT INTO "TMP_20180508175651_CODEGEN_NJ5S" ("KEY", "Score_0", "Proba_0", "LogProba_0", "Score_1", "Proba_1", "LogProba_1") SELECT "U"."KEY", "U"."Score_0", "U"."Proba_0", "U"."LogProba_0", "U"."Score_1", "U"."Proba_1", "U"."LogProba_1" 
...
FROM "TMP_20180508175651_CODEGEN_3Z3E" AS "BAG_Union" GROUP BY "BAG_Union"."KEY") AS "T") AS "BAG_avg") AS "U"

-- Code For temporary table TMP_20180508175651_CODEGEN_NJ5S part 3. Create Index 

CREATE INDEX "ix_TMP_20180508175651_C_3617" ON "TMP_20180508175651_CODEGEN_NJ5S" ("KEY")
...
FROM "TMP_20180508175651_CODEGEN_NJ5S" AS "BAG_avg"), 
