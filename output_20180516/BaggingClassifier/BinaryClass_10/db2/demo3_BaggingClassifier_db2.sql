...
-- Code For temporary table tmp_20180508175653_codegen_hb14a1_bag_b0 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180508175653_codegen_hb14a1_bag_b0 (
	"KEY" BIGINT, 
	"Score_0" DOUBLE, 
	"Proba_0" DOUBLE, 
	"LogProba_0" DOUBLE, 
...
-- Code For temporary table tmp_20180508175653_codegen_hb14a1_bag_b0 part 2. Populate

INSERT INTO tmp_20180508175653_codegen_hb14a1_bag_b0 WITH "DT_node_lookup" AS 
...
"DT_node_data_2" AS 
(SELECT "Values".nid AS nid, CAST("Values"."P_0" AS DOUBLE) AS "P_0", CAST("Values"."P_1" AS DOUBLE) AS "P_1", CAST("Values"."D" AS DOUBLE) AS "D", CAST("Values"."DP" AS DOUBLE) AS "DP" 
FROM (SELECT 5 AS nid, 0.9767441860465116 AS "P_0", 0.023255813953488372 AS "P_1", 0 AS "D", 0.9767441860465116 AS "DP" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 6 AS nid, 0.0 AS "P_0", 1.0 AS "P_1", 1 AS "D", 1.0 AS "DP" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 7 AS nid, 0.0 AS "P_0", 1.0 AS "P_1", 1 AS "D", 1.0 AS "DP" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 8 AS nid, 0.0 AS "P_0", 1.0 AS "P_1", 1 AS "D", 1.0 AS "DP" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 9 AS nid, 0.0 AS "P_0", 1.0 AS "P_1", 1 AS "D", 1.0 AS "DP" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 10 AS nid, 0.0 AS "P_0", 1.0 AS "P_1", 1 AS "D", 1.0 AS "DP" FROM SYSIBM.SYSDUMMY1) AS "Values"), 
"DT_Output_2" AS 
...
-- Code For temporary table tmp_20180508175653_codegen_m69thw_bag_b1 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180508175653_codegen_m69thw_bag_b1 (
	"KEY" BIGINT, 
	"Score_0" DOUBLE, 
	"Proba_0" DOUBLE, 
	"LogProba_0" DOUBLE, 
...
-- Code For temporary table tmp_20180508175653_codegen_m69thw_bag_b1 part 2. Populate

INSERT INTO tmp_20180508175653_codegen_m69thw_bag_b1 WITH "DT_node_lookup_10" AS 
...
-- Code For temporary table tmp_20180508175653_codegen_7o7brj_bag_union part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180508175653_codegen_7o7brj_bag_union (
	"KEY" BIGINT, 
	"Score_0" DOUBLE, 
	"Proba_0" DOUBLE, 
	"LogProba_0" DOUBLE, 
...
-- Code For temporary table tmp_20180508175653_codegen_7o7brj_bag_union part 2. Populate

INSERT INTO tmp_20180508175653_codegen_7o7brj_bag_union SELECT "BAG_Union"."KEY", "BAG_Union"."Score_0", "BAG_Union"."Proba_0", "BAG_Union"."LogProba_0", "BAG_Union"."Score_1", "BAG_Union"."Proba_1", "BAG_Union"."LogProba_1" 
...
FROM tmp_20180508175653_codegen_hb14a1_bag_b0 AS "BAG_B0" UNION ALL SELECT "BAG_B1"."KEY" AS "KEY", "BAG_B1"."Score_0" AS "Score_0", "BAG_B1"."Proba_0" AS "Proba_0", "BAG_B1"."LogProba_0" AS "LogProba_0", "BAG_B1"."Score_1" AS "Score_1", "BAG_B1"."Proba_1" AS "Proba_1", "BAG_B1"."LogProba_1" AS "LogProba_1" 
FROM tmp_20180508175653_codegen_m69thw_bag_b1 AS "BAG_B1") AS "BAG_EnsembleUnion") AS "BAG_Union"

-- Code For temporary table tmp_20180508175653_codegen_1ol3wu_bag_avg part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180508175653_codegen_1ol3wu_bag_avg (
	"KEY" BIGINT, 
	"Score_0" DOUBLE, 
	"Proba_0" DOUBLE, 
	"LogProba_0" DOUBLE, 
...
-- Code For temporary table tmp_20180508175653_codegen_1ol3wu_bag_avg part 2. Populate

INSERT INTO tmp_20180508175653_codegen_1ol3wu_bag_avg SELECT "BAG_avg"."KEY", "BAG_avg"."Score_0", "BAG_avg"."Proba_0", "BAG_avg"."LogProba_0", "BAG_avg"."Score_1", "BAG_avg"."Proba_1", "BAG_avg"."LogProba_1" 
...
FROM tmp_20180508175653_codegen_7o7brj_bag_union AS "BAG_Union" GROUP BY "BAG_Union"."KEY") AS "T") AS "BAG_avg"
...
FROM tmp_20180508175653_codegen_1ol3wu_bag_avg AS "BAG_avg"), 
