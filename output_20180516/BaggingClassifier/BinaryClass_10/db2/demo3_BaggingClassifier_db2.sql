...
-- Code For temporary table tmp_20180516110125_codegen_17agb5_bag_b0 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180516110125_codegen_17agb5_bag_b0 (
	"KEY" BIGINT, 
	"Score_0" DOUBLE, 
	"Proba_0" DOUBLE, 
	"LogProba_0" DOUBLE, 
...
-- Code For temporary table tmp_20180516110125_codegen_17agb5_bag_b0 part 2. Populate

INSERT INTO tmp_20180516110125_codegen_17agb5_bag_b0 WITH "DT_node_lookup" AS 
...
-- Code For temporary table tmp_20180516110125_codegen_pkydij_bag_b1 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180516110125_codegen_pkydij_bag_b1 (
	"KEY" BIGINT, 
	"Score_0" DOUBLE, 
	"Proba_0" DOUBLE, 
	"LogProba_0" DOUBLE, 
...
-- Code For temporary table tmp_20180516110125_codegen_pkydij_bag_b1 part 2. Populate

INSERT INTO tmp_20180516110125_codegen_pkydij_bag_b1 WITH "DT_node_lookup_10" AS 
...
-- Code For temporary table tmp_20180516110125_codegen_7y3gsv_bag_avg part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180516110125_codegen_7y3gsv_bag_avg (
	"KEY" BIGINT, 
	"Score_0" DOUBLE, 
	"Proba_0" DOUBLE, 
	"LogProba_0" DOUBLE, 
...
-- Code For temporary table tmp_20180516110125_codegen_7y3gsv_bag_avg part 2. Populate

INSERT INTO tmp_20180516110125_codegen_7y3gsv_bag_avg WITH "BAG_Union" AS 
...
FROM tmp_20180516110125_codegen_17agb5_bag_b0 AS "BAG_B0" UNION ALL SELECT "BAG_B1"."KEY" AS "KEY", "BAG_B1"."Score_0" AS "Score_0", "BAG_B1"."Proba_0" AS "Proba_0", "BAG_B1"."LogProba_0" AS "LogProba_0", "BAG_B1"."Score_1" AS "Score_1", "BAG_B1"."Proba_1" AS "Proba_1", "BAG_B1"."LogProba_1" AS "LogProba_1" 
FROM tmp_20180516110125_codegen_pkydij_bag_b1 AS "BAG_B1") AS "BAG_EnsembleUnion")
...
FROM tmp_20180516110125_codegen_7y3gsv_bag_avg AS "BAG_avg"), 
