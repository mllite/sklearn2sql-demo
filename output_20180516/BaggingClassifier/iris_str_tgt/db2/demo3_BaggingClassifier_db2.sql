...
-- Code For temporary table tmp_20180508190419_codegen_rv7ga5_bag_b0 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180508190419_codegen_rv7ga5_bag_b0 (
	"KEY" BIGINT, 
...
-- Code For temporary table tmp_20180508190419_codegen_rv7ga5_bag_b0 part 2. Populate

INSERT INTO tmp_20180508190419_codegen_rv7ga5_bag_b0 WITH "DT_node_lookup" AS 
...
-- Code For temporary table tmp_20180508190419_codegen_j3wosf_bag_b1 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180508190419_codegen_j3wosf_bag_b1 (
	"KEY" BIGINT, 
	"Score_CLASS_0" DOUBLE, 
	"Proba_CLASS_0" DOUBLE, 
	"LogProba_CLASS_0" DOUBLE, 
...
-- Code For temporary table tmp_20180508190419_codegen_j3wosf_bag_b1 part 2. Populate

INSERT INTO tmp_20180508190419_codegen_j3wosf_bag_b1 WITH "DT_node_lookup_10" AS 
...
-- Code For temporary table tmp_20180508190419_codegen_la22to_bag_union part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180508190419_codegen_la22to_bag_union (
	"KEY" BIGINT, 
	"Score_CLASS_0" DOUBLE, 
	"Proba_CLASS_0" DOUBLE, 
	"LogProba_CLASS_0" DOUBLE, 
...
-- Code For temporary table tmp_20180508190419_codegen_la22to_bag_union part 2. Populate

INSERT INTO tmp_20180508190419_codegen_la22to_bag_union SELECT "BAG_Union"."KEY", "BAG_Union"."Score_CLASS_0", "BAG_Union"."Proba_CLASS_0", "BAG_Union"."LogProba_CLASS_0", "BAG_Union"."Score_CLASS_1", "BAG_Union"."Proba_CLASS_1", "BAG_Union"."LogProba_CLASS_1", "BAG_Union"."Score_CLASS_2", "BAG_Union"."Proba_CLASS_2", "BAG_Union"."LogProba_CLASS_2" 
...
-- Code For temporary table tmp_20180508190419_codegen_77nw8g_bag_avg part 2. Populate

INSERT INTO tmp_20180508190419_codegen_77nw8g_bag_avg SELECT "BAG_avg"."KEY", "BAG_avg"."Score_CLASS_0", "BAG_avg"."Proba_CLASS_0", "BAG_avg"."LogProba_CLASS_0", "BAG_avg"."Score_CLASS_1", "BAG_avg"."Proba_CLASS_1", "BAG_avg"."LogProba_CLASS_1", "BAG_avg"."Score_CLASS_2", "BAG_avg"."Proba_CLASS_2", "BAG_avg"."LogProba_CLASS_2" 
...
FROM (SELECT "BAG_Union"."KEY" AS "KEY", AVG(DOUBLE((CAST("BAG_Union"."Score_CLASS_0" AS DOUBLE)))) AS "Score_CLASS_0", AVG(DOUBLE((CAST("BAG_Union"."Proba_CLASS_0" AS DOUBLE)))) AS "Proba_CLASS_0", CAST(NULL AS DOUBLE) AS "LogProba_CLASS_0", AVG(DOUBLE((CAST("BAG_Union"."Score_CLASS_1" AS DOUBLE)))) AS "Score_CLASS_1", AVG(DOUBLE((CAST("BAG_Union"."Proba_CLASS_1" AS DOUBLE)))) AS "Proba_CLASS_1", CAST(NULL AS DOUBLE) AS "LogProba_CLASS_1", AVG(DOUBLE((CAST("BAG_Union"."Score_CLASS_2" AS DOUBLE)))) AS "Score_CLASS_2", AVG(DOUBLE((CAST("BAG_Union"."Proba_CLASS_2" AS DOUBLE)))) AS "Proba_CLASS_2", CAST(NULL AS DOUBLE) AS "LogProba_CLASS_2" 
FROM tmp_20180508190419_codegen_la22to_bag_union AS "BAG_Union" GROUP BY "BAG_Union"."KEY") AS "T") AS "BAG_avg"

-- Model deployment code

WITH orig_cte AS 
(SELECT "BAG_avg"."KEY" AS "KEY", "BAG_avg"."Score_CLASS_0" AS "Score_CLASS_0", "BAG_avg"."Score_CLASS_1" AS "Score_CLASS_1", "BAG_avg"."Score_CLASS_2" AS "Score_CLASS_2", "BAG_avg"."Proba_CLASS_0" AS "Proba_CLASS_0", "BAG_avg"."Proba_CLASS_1" AS "Proba_CLASS_1", "BAG_avg"."Proba_CLASS_2" AS "Proba_CLASS_2", "BAG_avg"."LogProba_CLASS_0" AS "LogProba_CLASS_0", "BAG_avg"."LogProba_CLASS_1" AS "LogProba_CLASS_1", "BAG_avg"."LogProba_CLASS_2" AS "LogProba_CLASS_2", NULL AS "Decision", CAST(NULL AS DOUBLE) AS "DecisionProba" 
FROM tmp_20180508190419_codegen_77nw8g_bag_avg AS "BAG_avg"), 
