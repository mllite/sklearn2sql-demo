...
-- Code For temporary table tmp_20180508195529_codegen_twm4zd_bag_b0 part 1. Create 


CREATE TABLE tmp_20180508195529_codegen_twm4zd_bag_b0 (
	`KEY` BIGINT, 
...
-- Code For temporary table tmp_20180508195529_codegen_twm4zd_bag_b0 part 2. Populate
...
-- Code For temporary table tmp_20180508195529_codegen_wowjci_bag_b1 part 1. Create 


CREATE TABLE tmp_20180508195529_codegen_wowjci_bag_b1 (
	`KEY` BIGINT, 
	`Score_CLASS_0` DOUBLE, 
	`Proba_CLASS_0` DOUBLE, 
	`LogProba_CLASS_0` DOUBLE, 
...
-- Code For temporary table tmp_20180508195529_codegen_wowjci_bag_b1 part 2. Populate
...
-- Code For temporary table tmp_20180508195529_codegen_gav47i_bag_union part 1. Create 


CREATE TABLE tmp_20180508195529_codegen_gav47i_bag_union (
	`KEY` BIGINT, 
	`Score_CLASS_0` DOUBLE, 
	`Proba_CLASS_0` DOUBLE, 
	`LogProba_CLASS_0` DOUBLE, 
...
FROM tmp_20180508195529_codegen_gav47i_bag_union AS `BAG_Union` GROUP BY `BAG_Union`.`KEY`) AS `T`) AS `BAG_avg`
...
FROM tmp_20180508195529_codegen_x3rqto_bag_avg AS `BAG_avg`), 
