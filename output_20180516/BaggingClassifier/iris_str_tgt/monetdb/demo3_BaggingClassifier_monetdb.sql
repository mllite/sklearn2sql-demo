...
-- Code For temporary table tmp_20180516130356_codegen_tlv8bm_bag_b0 part 1. Create 


CREATE TEMPORARY TABLE tmp_20180516130356_codegen_tlv8bm_bag_b0 (
	"KEY" BIGINT, 
...
-- Code For temporary table tmp_20180516130356_codegen_g9ltea_bag_b1 part 1. Create 


CREATE TEMPORARY TABLE tmp_20180516130356_codegen_g9ltea_bag_b1 (
	"KEY" BIGINT, 
	"Score_CLASS_0" DOUBLE, 
	"Proba_CLASS_0" DOUBLE, 
	"LogProba_CLASS_0" DOUBLE, 
...
-- Code For temporary table tmp_20180516130356_codegen_g9ltea_bag_b1 part 2. Populate

INSERT INTO tmp_20180516130356_codegen_g9ltea_bag_b1 ("KEY", "Score_CLASS_0", "Proba_CLASS_0", "LogProba_CLASS_0", "Score_CLASS_1", "Proba_CLASS_1", "LogProba_CLASS_1", "Score_CLASS_2", "Proba_CLASS_2", "LogProba_CLASS_2") SELECT "U"."KEY", "U"."Score_CLASS_0", "U"."Proba_CLASS_0", "U"."LogProba_CLASS_0", "U"."Score_CLASS_1", "U"."Proba_CLASS_1", "U"."LogProba_CLASS_1", "U"."Score_CLASS_2", "U"."Proba_CLASS_2", "U"."LogProba_CLASS_2" 
...
-- Code For temporary table tmp_20180516130356_codegen_4t40zc_bag_avg part 1. Create 


CREATE TEMPORARY TABLE tmp_20180516130356_codegen_4t40zc_bag_avg (
	"KEY" BIGINT, 
	"Score_CLASS_0" DOUBLE, 
	"Proba_CLASS_0" DOUBLE, 
	"LogProba_CLASS_0" DOUBLE, 
...
-- Code For temporary table tmp_20180516130356_codegen_4t40zc_bag_avg part 2. Populate

INSERT INTO tmp_20180516130356_codegen_4t40zc_bag_avg ("KEY", "Score_CLASS_0", "Proba_CLASS_0", "LogProba_CLASS_0", "Score_CLASS_1", "Proba_CLASS_1", "LogProba_CLASS_1", "Score_CLASS_2", "Proba_CLASS_2", "LogProba_CLASS_2") SELECT "U"."KEY", "U"."Score_CLASS_0", "U"."Proba_CLASS_0", "U"."LogProba_CLASS_0", "U"."Score_CLASS_1", "U"."Proba_CLASS_1", "U"."LogProba_CLASS_1", "U"."Score_CLASS_2", "U"."Proba_CLASS_2", "U"."LogProba_CLASS_2" 
...
FROM tmp_20180516130356_codegen_4t40zc_bag_avg AS "BAG_avg"), 
