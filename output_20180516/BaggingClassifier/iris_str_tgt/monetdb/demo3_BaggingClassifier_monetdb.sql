...
-- Code For temporary table tmp_20180508190416_codegen_omjlm6_bag_b0 part 1. Create 


CREATE TEMPORARY TABLE tmp_20180508190416_codegen_omjlm6_bag_b0 (
	"KEY" BIGINT, 
...
"BAG_Model_0" AS 
(SELECT "DT_Output"."KEY" AS "KEY", CAST(NULL AS DOUBLE) AS "Score_CLASS_0", "DT_Output"."P_0" AS "Proba_CLASS_0", log(CASE WHEN ("DT_Output"."P_0" IS NULL OR "DT_Output"."P_0" > 1e-100) THEN "DT_Output"."P_0" ELSE 1e-100 END) AS "LogProba_CLASS_0", CAST(NULL AS DOUBLE) AS "Score_CLASS_1", "DT_Output"."P_1" AS "Proba_CLASS_1", log(CASE WHEN ("DT_Output"."P_1" IS NULL OR "DT_Output"."P_1" > 1e-100) THEN "DT_Output"."P_1" ELSE 1e-100 END) AS "LogProba_CLASS_1", CAST(NULL AS DOUBLE) AS "Score_CLASS_2", "DT_Output"."P_2" AS "Proba_CLASS_2", log(CASE WHEN ("DT_Output"."P_2" IS NULL OR "DT_Output"."P_2" > 1e-100) THEN "DT_Output"."P_2" ELSE 1e-100 END) AS "LogProba_CLASS_2" 
FROM "DT_Output"), 
"DT_node_lookup_1" AS 
...
"BAG_Model_1" AS 
(SELECT "DT_Output_1"."KEY" AS "KEY", CAST(NULL AS DOUBLE) AS "Score_CLASS_0", "DT_Output_1"."P_0" AS "Proba_CLASS_0", log(CASE WHEN ("DT_Output_1"."P_0" IS NULL OR "DT_Output_1"."P_0" > 1e-100) THEN "DT_Output_1"."P_0" ELSE 1e-100 END) AS "LogProba_CLASS_0", CAST(NULL AS DOUBLE) AS "Score_CLASS_1", "DT_Output_1"."P_1" AS "Proba_CLASS_1", log(CASE WHEN ("DT_Output_1"."P_1" IS NULL OR "DT_Output_1"."P_1" > 1e-100) THEN "DT_Output_1"."P_1" ELSE 1e-100 END) AS "LogProba_CLASS_1", CAST(NULL AS DOUBLE) AS "Score_CLASS_2", "DT_Output_1"."P_2" AS "Proba_CLASS_2", log(CASE WHEN ("DT_Output_1"."P_2" IS NULL OR "DT_Output_1"."P_2" > 1e-100) THEN "DT_Output_1"."P_2" ELSE 1e-100 END) AS "LogProba_CLASS_2" 
FROM "DT_Output_1"), 
"DT_node_lookup_2" AS 
...
"BAG_Model_2" AS 
(SELECT "DT_Output_2"."KEY" AS "KEY", CAST(NULL AS DOUBLE) AS "Score_CLASS_0", "DT_Output_2"."P_0" AS "Proba_CLASS_0", log(CASE WHEN ("DT_Output_2"."P_0" IS NULL OR "DT_Output_2"."P_0" > 1e-100) THEN "DT_Output_2"."P_0" ELSE 1e-100 END) AS "LogProba_CLASS_0", CAST(NULL AS DOUBLE) AS "Score_CLASS_1", "DT_Output_2"."P_1" AS "Proba_CLASS_1", log(CASE WHEN ("DT_Output_2"."P_1" IS NULL OR "DT_Output_2"."P_1" > 1e-100) THEN "DT_Output_2"."P_1" ELSE 1e-100 END) AS "LogProba_CLASS_1", CAST(NULL AS DOUBLE) AS "Score_CLASS_2", "DT_Output_2"."P_2" AS "Proba_CLASS_2", log(CASE WHEN ("DT_Output_2"."P_2" IS NULL OR "DT_Output_2"."P_2" > 1e-100) THEN "DT_Output_2"."P_2" ELSE 1e-100 END) AS "LogProba_CLASS_2" 
FROM "DT_Output_2"), 
"DT_node_lookup_3" AS 
...
"BAG_Model_3" AS 
(SELECT "DT_Output_3"."KEY" AS "KEY", CAST(NULL AS DOUBLE) AS "Score_CLASS_0", "DT_Output_3"."P_0" AS "Proba_CLASS_0", log(CASE WHEN ("DT_Output_3"."P_0" IS NULL OR "DT_Output_3"."P_0" > 1e-100) THEN "DT_Output_3"."P_0" ELSE 1e-100 END) AS "LogProba_CLASS_0", CAST(NULL AS DOUBLE) AS "Score_CLASS_1", "DT_Output_3"."P_1" AS "Proba_CLASS_1", log(CASE WHEN ("DT_Output_3"."P_1" IS NULL OR "DT_Output_3"."P_1" > 1e-100) THEN "DT_Output_3"."P_1" ELSE 1e-100 END) AS "LogProba_CLASS_1", CAST(NULL AS DOUBLE) AS "Score_CLASS_2", "DT_Output_3"."P_2" AS "Proba_CLASS_2", log(CASE WHEN ("DT_Output_3"."P_2" IS NULL OR "DT_Output_3"."P_2" > 1e-100) THEN "DT_Output_3"."P_2" ELSE 1e-100 END) AS "LogProba_CLASS_2" 
FROM "DT_Output_3"), 
"DT_node_lookup_4" AS 
...
"BAG_Model_4" AS 
(SELECT "DT_Output_4"."KEY" AS "KEY", CAST(NULL AS DOUBLE) AS "Score_CLASS_0", "DT_Output_4"."P_0" AS "Proba_CLASS_0", log(CASE WHEN ("DT_Output_4"."P_0" IS NULL OR "DT_Output_4"."P_0" > 1e-100) THEN "DT_Output_4"."P_0" ELSE 1e-100 END) AS "LogProba_CLASS_0", CAST(NULL AS DOUBLE) AS "Score_CLASS_1", "DT_Output_4"."P_1" AS "Proba_CLASS_1", log(CASE WHEN ("DT_Output_4"."P_1" IS NULL OR "DT_Output_4"."P_1" > 1e-100) THEN "DT_Output_4"."P_1" ELSE 1e-100 END) AS "LogProba_CLASS_1", CAST(NULL AS DOUBLE) AS "Score_CLASS_2", "DT_Output_4"."P_2" AS "Proba_CLASS_2", log(CASE WHEN ("DT_Output_4"."P_2" IS NULL OR "DT_Output_4"."P_2" > 1e-100) THEN "DT_Output_4"."P_2" ELSE 1e-100 END) AS "LogProba_CLASS_2" 
FROM "DT_Output_4"), 
"DT_node_lookup_5" AS 
...
"BAG_Model_5" AS 
(SELECT "DT_Output_5"."KEY" AS "KEY", CAST(NULL AS DOUBLE) AS "Score_CLASS_0", "DT_Output_5"."P_0" AS "Proba_CLASS_0", log(CASE WHEN ("DT_Output_5"."P_0" IS NULL OR "DT_Output_5"."P_0" > 1e-100) THEN "DT_Output_5"."P_0" ELSE 1e-100 END) AS "LogProba_CLASS_0", CAST(NULL AS DOUBLE) AS "Score_CLASS_1", "DT_Output_5"."P_1" AS "Proba_CLASS_1", log(CASE WHEN ("DT_Output_5"."P_1" IS NULL OR "DT_Output_5"."P_1" > 1e-100) THEN "DT_Output_5"."P_1" ELSE 1e-100 END) AS "LogProba_CLASS_1", CAST(NULL AS DOUBLE) AS "Score_CLASS_2", "DT_Output_5"."P_2" AS "Proba_CLASS_2", log(CASE WHEN ("DT_Output_5"."P_2" IS NULL OR "DT_Output_5"."P_2" > 1e-100) THEN "DT_Output_5"."P_2" ELSE 1e-100 END) AS "LogProba_CLASS_2" 
FROM "DT_Output_5"), 
"DT_node_lookup_6" AS 
...
"BAG_Model_6" AS 
(SELECT "DT_Output_6"."KEY" AS "KEY", CAST(NULL AS DOUBLE) AS "Score_CLASS_0", "DT_Output_6"."P_0" AS "Proba_CLASS_0", log(CASE WHEN ("DT_Output_6"."P_0" IS NULL OR "DT_Output_6"."P_0" > 1e-100) THEN "DT_Output_6"."P_0" ELSE 1e-100 END) AS "LogProba_CLASS_0", CAST(NULL AS DOUBLE) AS "Score_CLASS_1", "DT_Output_6"."P_1" AS "Proba_CLASS_1", log(CASE WHEN ("DT_Output_6"."P_1" IS NULL OR "DT_Output_6"."P_1" > 1e-100) THEN "DT_Output_6"."P_1" ELSE 1e-100 END) AS "LogProba_CLASS_1", CAST(NULL AS DOUBLE) AS "Score_CLASS_2", "DT_Output_6"."P_2" AS "Proba_CLASS_2", log(CASE WHEN ("DT_Output_6"."P_2" IS NULL OR "DT_Output_6"."P_2" > 1e-100) THEN "DT_Output_6"."P_2" ELSE 1e-100 END) AS "LogProba_CLASS_2" 
FROM "DT_Output_6"), 
"DT_node_lookup_7" AS 
...
"BAG_Model_7" AS 
(SELECT "DT_Output_7"."KEY" AS "KEY", CAST(NULL AS DOUBLE) AS "Score_CLASS_0", "DT_Output_7"."P_0" AS "Proba_CLASS_0", log(CASE WHEN ("DT_Output_7"."P_0" IS NULL OR "DT_Output_7"."P_0" > 1e-100) THEN "DT_Output_7"."P_0" ELSE 1e-100 END) AS "LogProba_CLASS_0", CAST(NULL AS DOUBLE) AS "Score_CLASS_1", "DT_Output_7"."P_1" AS "Proba_CLASS_1", log(CASE WHEN ("DT_Output_7"."P_1" IS NULL OR "DT_Output_7"."P_1" > 1e-100) THEN "DT_Output_7"."P_1" ELSE 1e-100 END) AS "LogProba_CLASS_1", CAST(NULL AS DOUBLE) AS "Score_CLASS_2", "DT_Output_7"."P_2" AS "Proba_CLASS_2", log(CASE WHEN ("DT_Output_7"."P_2" IS NULL OR "DT_Output_7"."P_2" > 1e-100) THEN "DT_Output_7"."P_2" ELSE 1e-100 END) AS "LogProba_CLASS_2" 
FROM "DT_Output_7"), 
"DT_node_lookup_8" AS 
...
"BAG_Model_8" AS 
(SELECT "DT_Output_8"."KEY" AS "KEY", CAST(NULL AS DOUBLE) AS "Score_CLASS_0", "DT_Output_8"."P_0" AS "Proba_CLASS_0", log(CASE WHEN ("DT_Output_8"."P_0" IS NULL OR "DT_Output_8"."P_0" > 1e-100) THEN "DT_Output_8"."P_0" ELSE 1e-100 END) AS "LogProba_CLASS_0", CAST(NULL AS DOUBLE) AS "Score_CLASS_1", "DT_Output_8"."P_1" AS "Proba_CLASS_1", log(CASE WHEN ("DT_Output_8"."P_1" IS NULL OR "DT_Output_8"."P_1" > 1e-100) THEN "DT_Output_8"."P_1" ELSE 1e-100 END) AS "LogProba_CLASS_1", CAST(NULL AS DOUBLE) AS "Score_CLASS_2", "DT_Output_8"."P_2" AS "Proba_CLASS_2", log(CASE WHEN ("DT_Output_8"."P_2" IS NULL OR "DT_Output_8"."P_2" > 1e-100) THEN "DT_Output_8"."P_2" ELSE 1e-100 END) AS "LogProba_CLASS_2" 
FROM "DT_Output_8"), 
"DT_node_lookup_9" AS 
...
"BAG_Model_9" AS 
(SELECT "DT_Output_9"."KEY" AS "KEY", CAST(NULL AS DOUBLE) AS "Score_CLASS_0", "DT_Output_9"."P_0" AS "Proba_CLASS_0", log(CASE WHEN ("DT_Output_9"."P_0" IS NULL OR "DT_Output_9"."P_0" > 1e-100) THEN "DT_Output_9"."P_0" ELSE 1e-100 END) AS "LogProba_CLASS_0", CAST(NULL AS DOUBLE) AS "Score_CLASS_1", "DT_Output_9"."P_1" AS "Proba_CLASS_1", log(CASE WHEN ("DT_Output_9"."P_1" IS NULL OR "DT_Output_9"."P_1" > 1e-100) THEN "DT_Output_9"."P_1" ELSE 1e-100 END) AS "LogProba_CLASS_1", CAST(NULL AS DOUBLE) AS "Score_CLASS_2", "DT_Output_9"."P_2" AS "Proba_CLASS_2", log(CASE WHEN ("DT_Output_9"."P_2" IS NULL OR "DT_Output_9"."P_2" > 1e-100) THEN "DT_Output_9"."P_2" ELSE 1e-100 END) AS "LogProba_CLASS_2" 
FROM "DT_Output_9")
...
-- Code For temporary table tmp_20180508190416_codegen_l9fryt_bag_b1 part 1. Create 


CREATE TEMPORARY TABLE tmp_20180508190416_codegen_l9fryt_bag_b1 (
	"KEY" BIGINT, 
	"Score_CLASS_0" DOUBLE, 
	"Proba_CLASS_0" DOUBLE, 
	"LogProba_CLASS_0" DOUBLE, 
...
-- Code For temporary table tmp_20180508190416_codegen_l9fryt_bag_b1 part 2. Populate

INSERT INTO tmp_20180508190416_codegen_l9fryt_bag_b1 ("KEY", "Score_CLASS_0", "Proba_CLASS_0", "LogProba_CLASS_0", "Score_CLASS_1", "Proba_CLASS_1", "LogProba_CLASS_1", "Score_CLASS_2", "Proba_CLASS_2", "LogProba_CLASS_2") SELECT "U"."KEY", "U"."Score_CLASS_0", "U"."Proba_CLASS_0", "U"."LogProba_CLASS_0", "U"."Score_CLASS_1", "U"."Proba_CLASS_1", "U"."LogProba_CLASS_1", "U"."Score_CLASS_2", "U"."Proba_CLASS_2", "U"."LogProba_CLASS_2" 
...
"BAG_Model_10" AS 
(SELECT "DT_Output_10"."KEY" AS "KEY", CAST(NULL AS DOUBLE) AS "Score_CLASS_0", "DT_Output_10"."P_0" AS "Proba_CLASS_0", log(CASE WHEN ("DT_Output_10"."P_0" IS NULL OR "DT_Output_10"."P_0" > 1e-100) THEN "DT_Output_10"."P_0" ELSE 1e-100 END) AS "LogProba_CLASS_0", CAST(NULL AS DOUBLE) AS "Score_CLASS_1", "DT_Output_10"."P_1" AS "Proba_CLASS_1", log(CASE WHEN ("DT_Output_10"."P_1" IS NULL OR "DT_Output_10"."P_1" > 1e-100) THEN "DT_Output_10"."P_1" ELSE 1e-100 END) AS "LogProba_CLASS_1", CAST(NULL AS DOUBLE) AS "Score_CLASS_2", "DT_Output_10"."P_2" AS "Proba_CLASS_2", log(CASE WHEN ("DT_Output_10"."P_2" IS NULL OR "DT_Output_10"."P_2" > 1e-100) THEN "DT_Output_10"."P_2" ELSE 1e-100 END) AS "LogProba_CLASS_2" 
FROM "DT_Output_10"), 
...
"BAG_Model_11" AS 
(SELECT "DT_Output_11"."KEY" AS "KEY", CAST(NULL AS DOUBLE) AS "Score_CLASS_0", "DT_Output_11"."P_0" AS "Proba_CLASS_0", log(CASE WHEN ("DT_Output_11"."P_0" IS NULL OR "DT_Output_11"."P_0" > 1e-100) THEN "DT_Output_11"."P_0" ELSE 1e-100 END) AS "LogProba_CLASS_0", CAST(NULL AS DOUBLE) AS "Score_CLASS_1", "DT_Output_11"."P_1" AS "Proba_CLASS_1", log(CASE WHEN ("DT_Output_11"."P_1" IS NULL OR "DT_Output_11"."P_1" > 1e-100) THEN "DT_Output_11"."P_1" ELSE 1e-100 END) AS "LogProba_CLASS_1", CAST(NULL AS DOUBLE) AS "Score_CLASS_2", "DT_Output_11"."P_2" AS "Proba_CLASS_2", log(CASE WHEN ("DT_Output_11"."P_2" IS NULL OR "DT_Output_11"."P_2" > 1e-100) THEN "DT_Output_11"."P_2" ELSE 1e-100 END) AS "LogProba_CLASS_2" 
FROM "DT_Output_11"), 
...
"BAG_Model_12" AS 
(SELECT "DT_Output_12"."KEY" AS "KEY", CAST(NULL AS DOUBLE) AS "Score_CLASS_0", "DT_Output_12"."P_0" AS "Proba_CLASS_0", log(CASE WHEN ("DT_Output_12"."P_0" IS NULL OR "DT_Output_12"."P_0" > 1e-100) THEN "DT_Output_12"."P_0" ELSE 1e-100 END) AS "LogProba_CLASS_0", CAST(NULL AS DOUBLE) AS "Score_CLASS_1", "DT_Output_12"."P_1" AS "Proba_CLASS_1", log(CASE WHEN ("DT_Output_12"."P_1" IS NULL OR "DT_Output_12"."P_1" > 1e-100) THEN "DT_Output_12"."P_1" ELSE 1e-100 END) AS "LogProba_CLASS_1", CAST(NULL AS DOUBLE) AS "Score_CLASS_2", "DT_Output_12"."P_2" AS "Proba_CLASS_2", log(CASE WHEN ("DT_Output_12"."P_2" IS NULL OR "DT_Output_12"."P_2" > 1e-100) THEN "DT_Output_12"."P_2" ELSE 1e-100 END) AS "LogProba_CLASS_2" 
FROM "DT_Output_12"), 
...
"BAG_Model_13" AS 
(SELECT "DT_Output_13"."KEY" AS "KEY", CAST(NULL AS DOUBLE) AS "Score_CLASS_0", "DT_Output_13"."P_0" AS "Proba_CLASS_0", log(CASE WHEN ("DT_Output_13"."P_0" IS NULL OR "DT_Output_13"."P_0" > 1e-100) THEN "DT_Output_13"."P_0" ELSE 1e-100 END) AS "LogProba_CLASS_0", CAST(NULL AS DOUBLE) AS "Score_CLASS_1", "DT_Output_13"."P_1" AS "Proba_CLASS_1", log(CASE WHEN ("DT_Output_13"."P_1" IS NULL OR "DT_Output_13"."P_1" > 1e-100) THEN "DT_Output_13"."P_1" ELSE 1e-100 END) AS "LogProba_CLASS_1", CAST(NULL AS DOUBLE) AS "Score_CLASS_2", "DT_Output_13"."P_2" AS "Proba_CLASS_2", log(CASE WHEN ("DT_Output_13"."P_2" IS NULL OR "DT_Output_13"."P_2" > 1e-100) THEN "DT_Output_13"."P_2" ELSE 1e-100 END) AS "LogProba_CLASS_2" 
FROM "DT_Output_13"), 
...
"BAG_Model_14" AS 
(SELECT "DT_Output_14"."KEY" AS "KEY", CAST(NULL AS DOUBLE) AS "Score_CLASS_0", "DT_Output_14"."P_0" AS "Proba_CLASS_0", log(CASE WHEN ("DT_Output_14"."P_0" IS NULL OR "DT_Output_14"."P_0" > 1e-100) THEN "DT_Output_14"."P_0" ELSE 1e-100 END) AS "LogProba_CLASS_0", CAST(NULL AS DOUBLE) AS "Score_CLASS_1", "DT_Output_14"."P_1" AS "Proba_CLASS_1", log(CASE WHEN ("DT_Output_14"."P_1" IS NULL OR "DT_Output_14"."P_1" > 1e-100) THEN "DT_Output_14"."P_1" ELSE 1e-100 END) AS "LogProba_CLASS_1", CAST(NULL AS DOUBLE) AS "Score_CLASS_2", "DT_Output_14"."P_2" AS "Proba_CLASS_2", log(CASE WHEN ("DT_Output_14"."P_2" IS NULL OR "DT_Output_14"."P_2" > 1e-100) THEN "DT_Output_14"."P_2" ELSE 1e-100 END) AS "LogProba_CLASS_2" 
FROM "DT_Output_14"), 
...
"BAG_Model_15" AS 
(SELECT "DT_Output_15"."KEY" AS "KEY", CAST(NULL AS DOUBLE) AS "Score_CLASS_0", "DT_Output_15"."P_0" AS "Proba_CLASS_0", log(CASE WHEN ("DT_Output_15"."P_0" IS NULL OR "DT_Output_15"."P_0" > 1e-100) THEN "DT_Output_15"."P_0" ELSE 1e-100 END) AS "LogProba_CLASS_0", CAST(NULL AS DOUBLE) AS "Score_CLASS_1", "DT_Output_15"."P_1" AS "Proba_CLASS_1", log(CASE WHEN ("DT_Output_15"."P_1" IS NULL OR "DT_Output_15"."P_1" > 1e-100) THEN "DT_Output_15"."P_1" ELSE 1e-100 END) AS "LogProba_CLASS_1", CAST(NULL AS DOUBLE) AS "Score_CLASS_2", "DT_Output_15"."P_2" AS "Proba_CLASS_2", log(CASE WHEN ("DT_Output_15"."P_2" IS NULL OR "DT_Output_15"."P_2" > 1e-100) THEN "DT_Output_15"."P_2" ELSE 1e-100 END) AS "LogProba_CLASS_2" 
FROM "DT_Output_15")
...
-- Code For temporary table tmp_20180508190416_codegen_9ih8xw_bag_union part 1. Create 


CREATE TEMPORARY TABLE tmp_20180508190416_codegen_9ih8xw_bag_union (
	"KEY" BIGINT, 
	"Score_CLASS_0" DOUBLE, 
	"Proba_CLASS_0" DOUBLE, 
	"LogProba_CLASS_0" DOUBLE, 
...
-- Code For temporary table tmp_20180508190416_codegen_9ih8xw_bag_union part 2. Populate

INSERT INTO tmp_20180508190416_codegen_9ih8xw_bag_union ("KEY", "Score_CLASS_0", "Proba_CLASS_0", "LogProba_CLASS_0", "Score_CLASS_1", "Proba_CLASS_1", "LogProba_CLASS_1", "Score_CLASS_2", "Proba_CLASS_2", "LogProba_CLASS_2") SELECT "U"."KEY", "U"."Score_CLASS_0", "U"."Proba_CLASS_0", "U"."LogProba_CLASS_0", "U"."Score_CLASS_1", "U"."Proba_CLASS_1", "U"."LogProba_CLASS_1", "U"."Score_CLASS_2", "U"."Proba_CLASS_2", "U"."LogProba_CLASS_2" 
...
FROM tmp_20180508190416_codegen_omjlm6_bag_b0 AS "BAG_B0" UNION ALL SELECT "BAG_B1"."KEY" AS "KEY", "BAG_B1"."Score_CLASS_0" AS "Score_CLASS_0", "BAG_B1"."Proba_CLASS_0" AS "Proba_CLASS_0", "BAG_B1"."LogProba_CLASS_0" AS "LogProba_CLASS_0", "BAG_B1"."Score_CLASS_1" AS "Score_CLASS_1", "BAG_B1"."Proba_CLASS_1" AS "Proba_CLASS_1", "BAG_B1"."LogProba_CLASS_1" AS "LogProba_CLASS_1", "BAG_B1"."Score_CLASS_2" AS "Score_CLASS_2", "BAG_B1"."Proba_CLASS_2" AS "Proba_CLASS_2", "BAG_B1"."LogProba_CLASS_2" AS "LogProba_CLASS_2" 
FROM tmp_20180508190416_codegen_l9fryt_bag_b1 AS "BAG_B1") AS "BAG_EnsembleUnion") AS "BAG_Union") AS "U"

-- Code For temporary table tmp_20180508190416_codegen_7m0pzb_bag_avg part 1. Create 


CREATE TEMPORARY TABLE tmp_20180508190416_codegen_7m0pzb_bag_avg (
	"KEY" BIGINT, 
	"Score_CLASS_0" DOUBLE, 
	"Proba_CLASS_0" DOUBLE, 
	"LogProba_CLASS_0" DOUBLE, 
...
-- Code For temporary table tmp_20180508190416_codegen_7m0pzb_bag_avg part 2. Populate

INSERT INTO tmp_20180508190416_codegen_7m0pzb_bag_avg ("KEY", "Score_CLASS_0", "Proba_CLASS_0", "LogProba_CLASS_0", "Score_CLASS_1", "Proba_CLASS_1", "LogProba_CLASS_1", "Score_CLASS_2", "Proba_CLASS_2", "LogProba_CLASS_2") SELECT "U"."KEY", "U"."Score_CLASS_0", "U"."Proba_CLASS_0", "U"."LogProba_CLASS_0", "U"."Score_CLASS_1", "U"."Proba_CLASS_1", "U"."LogProba_CLASS_1", "U"."Score_CLASS_2", "U"."Proba_CLASS_2", "U"."LogProba_CLASS_2" 
...
FROM (SELECT "BAG_Union"."KEY" AS "KEY", avg(CAST("BAG_Union"."Score_CLASS_0" AS DOUBLE)) AS "Score_CLASS_0", avg(CAST("BAG_Union"."Proba_CLASS_0" AS DOUBLE)) AS "Proba_CLASS_0", CAST(NULL AS DOUBLE) AS "LogProba_CLASS_0", avg(CAST("BAG_Union"."Score_CLASS_1" AS DOUBLE)) AS "Score_CLASS_1", avg(CAST("BAG_Union"."Proba_CLASS_1" AS DOUBLE)) AS "Proba_CLASS_1", CAST(NULL AS DOUBLE) AS "LogProba_CLASS_1", avg(CAST("BAG_Union"."Score_CLASS_2" AS DOUBLE)) AS "Score_CLASS_2", avg(CAST("BAG_Union"."Proba_CLASS_2" AS DOUBLE)) AS "Proba_CLASS_2", CAST(NULL AS DOUBLE) AS "LogProba_CLASS_2" 
FROM tmp_20180508190416_codegen_9ih8xw_bag_union AS "BAG_Union" GROUP BY "BAG_Union"."KEY") AS "T") AS "BAG_avg") AS "U"
...
FROM tmp_20180508190416_codegen_7m0pzb_bag_avg AS "BAG_avg"), 
