...
-- Code For temporary table TMP_20180602160114_EHX_BAG_B0 part 1. Create 


CREATE TEMPORARY TABLE "TMP_20180602160114_EHX_BAG_B0" (
	"KEY" BIGINT, 
	"Score_CLASS_0" FLOAT, 
	"Proba_CLASS_0" FLOAT, 
...
-- Code For temporary table TMP_20180602160114_EHX_BAG_B0 part 2. Populate
...
-- Code For temporary table TMP_20180602160114_K91_BAG_B1 part 1. Create 


CREATE TEMPORARY TABLE "TMP_20180602160114_K91_BAG_B1" (
	"KEY" BIGINT, 
	"Score_CLASS_0" FLOAT, 
	"Proba_CLASS_0" FLOAT, 
	"LogProba_CLASS_0" FLOAT, 
...
-- Code For temporary table TMP_20180602160114_K91_BAG_B1 part 2. Populate
...
-- Code For temporary table TMP_20180602160114_8FR_BAG_avg part 1. Create 


CREATE TEMPORARY TABLE "TMP_20180602160114_8FR_BAG_avg" (
	"KEY" BIGINT NOT NULL, 
	"Score_CLASS_0" FLOAT, 
	"Proba_CLASS_0" FLOAT, 
	"LogProba_CLASS_0" FLOAT, 
...
-- Code For temporary table TMP_20180602160114_8FR_BAG_avg part 2. Populate
...
-- Code For temporary table TMP_20180602160114_8FR_BAG_avg part 3. Create Index 

CREATE INDEX "ix_TMP_20180602160114_8FR_BAG_avg_KEY" ON "TMP_20180602160114_8FR_BAG_avg" ("KEY")
...
FROM "TMP_20180602160114_8FR_BAG_avg" AS "BAG_avg"), 
