...
-- Code For temporary table ##TMP_20180516130356_CODEGEN_CXB0KB_BAG_B0 part 1. Create 


CREATE TABLE ##TMP_20180516130356_CODEGEN_CXB0KB_BAG_B0 (
	[KEY] BIGINT NULL, 
...
-- Code For temporary table ##TMP_20180516130356_CODEGEN_CXB0KB_BAG_B0 part 2. Populate
...
-- Code For temporary table ##TMP_20180516130356_CODEGEN_IVAY2M_BAG_B1 part 1. Create 


CREATE TABLE ##TMP_20180516130356_CODEGEN_IVAY2M_BAG_B1 (
	[KEY] BIGINT NULL, 
	[Score_CLASS_0] FLOAT(53) NULL, 
	[Proba_CLASS_0] FLOAT(53) NULL, 
	[LogProba_CLASS_0] FLOAT(53) NULL, 
...
-- Code For temporary table ##TMP_20180516130356_CODEGEN_IVAY2M_BAG_B1 part 2. Populate
...
-- Code For temporary table ##TMP_20180516130356_CODEGEN_KRIQ9S_BAG_avg part 1. Create 


CREATE TABLE ##TMP_20180516130356_CODEGEN_KRIQ9S_BAG_avg (
	[KEY] BIGINT NULL, 
	[Score_CLASS_0] FLOAT(53) NULL, 
	[Proba_CLASS_0] FLOAT(53) NULL, 
	[LogProba_CLASS_0] FLOAT(53) NULL, 
...
-- Code For temporary table ##TMP_20180516130356_CODEGEN_KRIQ9S_BAG_avg part 2. Populate
...
FROM ##TMP_20180516130356_CODEGEN_KRIQ9S_BAG_avg AS [BAG_avg]), 
