...
-- Code For temporary table ##TMP_20180508190416_CODEGEN_WLHQD8_BAG_B0 part 1. Create 


CREATE TABLE ##TMP_20180508190416_CODEGEN_WLHQD8_BAG_B0 (
	[KEY] BIGINT NULL, 
...
-- Code For temporary table ##TMP_20180508190416_CODEGEN_WLHQD8_BAG_B0 part 2. Populate
...
[DT_node_data] AS 
(SELECT [Values].nid AS nid, CAST([Values].[P_0] AS FLOAT(53)) AS [P_0], CAST([Values].[P_1] AS FLOAT(53)) AS [P_1], CAST([Values].[P_2] AS FLOAT(53)) AS [P_2], CAST([Values].[D] AS FLOAT(53)) AS [D], CAST([Values].[DP] AS FLOAT(53)) AS [DP] 
...
[BAG_Model_0] AS 
(SELECT [DT_Output].[KEY] AS [KEY], CAST(NULL AS FLOAT(53)) AS [Score_CLASS_0], [DT_Output].[P_0] AS [Proba_CLASS_0], CASE WHEN ([DT_Output].[P_0] IS NULL OR [DT_Output].[P_0] > 0.0) THEN log([DT_Output].[P_0]) ELSE -1.79769313486231e+308 END AS [LogProba_CLASS_0], CAST(NULL AS FLOAT(53)) AS [Score_CLASS_1], [DT_Output].[P_1] AS [Proba_CLASS_1], CASE WHEN ([DT_Output].[P_1] IS NULL OR [DT_Output].[P_1] > 0.0) THEN log([DT_Output].[P_1]) ELSE -1.79769313486231e+308 END AS [LogProba_CLASS_1], CAST(NULL AS FLOAT(53)) AS [Score_CLASS_2], [DT_Output].[P_2] AS [Proba_CLASS_2], CASE WHEN ([DT_Output].[P_2] IS NULL OR [DT_Output].[P_2] > 0.0) THEN log([DT_Output].[P_2]) ELSE -1.79769313486231e+308 END AS [LogProba_CLASS_2] 
FROM [DT_Output]), 
[DT_node_lookup_1] AS 
...
[BAG_Model_1] AS 
(SELECT [DT_Output_1].[KEY] AS [KEY], CAST(NULL AS FLOAT(53)) AS [Score_CLASS_0], [DT_Output_1].[P_0] AS [Proba_CLASS_0], CASE WHEN ([DT_Output_1].[P_0] IS NULL OR [DT_Output_1].[P_0] > 0.0) THEN log([DT_Output_1].[P_0]) ELSE -1.79769313486231e+308 END AS [LogProba_CLASS_0], CAST(NULL AS FLOAT(53)) AS [Score_CLASS_1], [DT_Output_1].[P_1] AS [Proba_CLASS_1], CASE WHEN ([DT_Output_1].[P_1] IS NULL OR [DT_Output_1].[P_1] > 0.0) THEN log([DT_Output_1].[P_1]) ELSE -1.79769313486231e+308 END AS [LogProba_CLASS_1], CAST(NULL AS FLOAT(53)) AS [Score_CLASS_2], [DT_Output_1].[P_2] AS [Proba_CLASS_2], CASE WHEN ([DT_Output_1].[P_2] IS NULL OR [DT_Output_1].[P_2] > 0.0) THEN log([DT_Output_1].[P_2]) ELSE -1.79769313486231e+308 END AS [LogProba_CLASS_2] 
FROM [DT_Output_1]), 
[DT_node_lookup_2] AS 
...
[BAG_Model_4] AS 
(SELECT [DT_Output_4].[KEY] AS [KEY], CAST(NULL AS FLOAT(53)) AS [Score_CLASS_0], [DT_Output_4].[P_0] AS [Proba_CLASS_0], CASE WHEN ([DT_Output_4].[P_0] IS NULL OR [DT_Output_4].[P_0] > 0.0) THEN log([DT_Output_4].[P_0]) ELSE -1.79769313486231e+308 END AS [LogProba_CLASS_0], CAST(NULL AS FLOAT(53)) AS [Score_CLASS_1], [DT_Output_4].[P_1] AS [Proba_CLASS_1], CASE WHEN ([DT_Output_4].[P_1] IS NULL OR [DT_Output_4].[P_1] > 0.0) THEN log([DT_Output_4].[P_1]) ELSE -1.79769313486231e+308 END AS [LogProba_CLASS_1], CAST(NULL AS FLOAT(53)) AS [Score_CLASS_2], [DT_Output_4].[P_2] AS [Proba_CLASS_2], CASE WHEN ([DT_Output_4].[P_2] IS NULL OR [DT_Output_4].[P_2] > 0.0) THEN log([DT_Output_4].[P_2]) ELSE -1.79769313486231e+308 END AS [LogProba_CLASS_2] 
FROM [DT_Output_4]), 
[DT_node_lookup_5] AS 
...
[BAG_Model_5] AS 
(SELECT [DT_Output_5].[KEY] AS [KEY], CAST(NULL AS FLOAT(53)) AS [Score_CLASS_0], [DT_Output_5].[P_0] AS [Proba_CLASS_0], CASE WHEN ([DT_Output_5].[P_0] IS NULL OR [DT_Output_5].[P_0] > 0.0) THEN log([DT_Output_5].[P_0]) ELSE -1.79769313486231e+308 END AS [LogProba_CLASS_0], CAST(NULL AS FLOAT(53)) AS [Score_CLASS_1], [DT_Output_5].[P_1] AS [Proba_CLASS_1], CASE WHEN ([DT_Output_5].[P_1] IS NULL OR [DT_Output_5].[P_1] > 0.0) THEN log([DT_Output_5].[P_1]) ELSE -1.79769313486231e+308 END AS [LogProba_CLASS_1], CAST(NULL AS FLOAT(53)) AS [Score_CLASS_2], [DT_Output_5].[P_2] AS [Proba_CLASS_2], CASE WHEN ([DT_Output_5].[P_2] IS NULL OR [DT_Output_5].[P_2] > 0.0) THEN log([DT_Output_5].[P_2]) ELSE -1.79769313486231e+308 END AS [LogProba_CLASS_2] 
FROM [DT_Output_5]), 
[DT_node_lookup_6] AS 
...
[BAG_Model_6] AS 
(SELECT [DT_Output_6].[KEY] AS [KEY], CAST(NULL AS FLOAT(53)) AS [Score_CLASS_0], [DT_Output_6].[P_0] AS [Proba_CLASS_0], CASE WHEN ([DT_Output_6].[P_0] IS NULL OR [DT_Output_6].[P_0] > 0.0) THEN log([DT_Output_6].[P_0]) ELSE -1.79769313486231e+308 END AS [LogProba_CLASS_0], CAST(NULL AS FLOAT(53)) AS [Score_CLASS_1], [DT_Output_6].[P_1] AS [Proba_CLASS_1], CASE WHEN ([DT_Output_6].[P_1] IS NULL OR [DT_Output_6].[P_1] > 0.0) THEN log([DT_Output_6].[P_1]) ELSE -1.79769313486231e+308 END AS [LogProba_CLASS_1], CAST(NULL AS FLOAT(53)) AS [Score_CLASS_2], [DT_Output_6].[P_2] AS [Proba_CLASS_2], CASE WHEN ([DT_Output_6].[P_2] IS NULL OR [DT_Output_6].[P_2] > 0.0) THEN log([DT_Output_6].[P_2]) ELSE -1.79769313486231e+308 END AS [LogProba_CLASS_2] 
FROM [DT_Output_6]), 
[DT_node_lookup_7] AS 
...
[BAG_Model_7] AS 
(SELECT [DT_Output_7].[KEY] AS [KEY], CAST(NULL AS FLOAT(53)) AS [Score_CLASS_0], [DT_Output_7].[P_0] AS [Proba_CLASS_0], CASE WHEN ([DT_Output_7].[P_0] IS NULL OR [DT_Output_7].[P_0] > 0.0) THEN log([DT_Output_7].[P_0]) ELSE -1.79769313486231e+308 END AS [LogProba_CLASS_0], CAST(NULL AS FLOAT(53)) AS [Score_CLASS_1], [DT_Output_7].[P_1] AS [Proba_CLASS_1], CASE WHEN ([DT_Output_7].[P_1] IS NULL OR [DT_Output_7].[P_1] > 0.0) THEN log([DT_Output_7].[P_1]) ELSE -1.79769313486231e+308 END AS [LogProba_CLASS_1], CAST(NULL AS FLOAT(53)) AS [Score_CLASS_2], [DT_Output_7].[P_2] AS [Proba_CLASS_2], CASE WHEN ([DT_Output_7].[P_2] IS NULL OR [DT_Output_7].[P_2] > 0.0) THEN log([DT_Output_7].[P_2]) ELSE -1.79769313486231e+308 END AS [LogProba_CLASS_2] 
FROM [DT_Output_7]), 
[DT_node_lookup_8] AS 
...
-- Code For temporary table ##TMP_20180508190416_CODEGEN_LJ5AJD_BAG_B1 part 1. Create 


CREATE TABLE ##TMP_20180508190416_CODEGEN_LJ5AJD_BAG_B1 (
	[KEY] BIGINT NULL, 
	[Score_CLASS_0] FLOAT(53) NULL, 
	[Proba_CLASS_0] FLOAT(53) NULL, 
	[LogProba_CLASS_0] FLOAT(53) NULL, 
...
-- Code For temporary table ##TMP_20180508190416_CODEGEN_LJ5AJD_BAG_B1 part 2. Populate
...
[BAG_Model_10] AS 
(SELECT [DT_Output_10].[KEY] AS [KEY], CAST(NULL AS FLOAT(53)) AS [Score_CLASS_0], [DT_Output_10].[P_0] AS [Proba_CLASS_0], CASE WHEN ([DT_Output_10].[P_0] IS NULL OR [DT_Output_10].[P_0] > 0.0) THEN log([DT_Output_10].[P_0]) ELSE -1.79769313486231e+308 END AS [LogProba_CLASS_0], CAST(NULL AS FLOAT(53)) AS [Score_CLASS_1], [DT_Output_10].[P_1] AS [Proba_CLASS_1], CASE WHEN ([DT_Output_10].[P_1] IS NULL OR [DT_Output_10].[P_1] > 0.0) THEN log([DT_Output_10].[P_1]) ELSE -1.79769313486231e+308 END AS [LogProba_CLASS_1], CAST(NULL AS FLOAT(53)) AS [Score_CLASS_2], [DT_Output_10].[P_2] AS [Proba_CLASS_2], CASE WHEN ([DT_Output_10].[P_2] IS NULL OR [DT_Output_10].[P_2] > 0.0) THEN log([DT_Output_10].[P_2]) ELSE -1.79769313486231e+308 END AS [LogProba_CLASS_2] 
FROM [DT_Output_10]), 
...
[BAG_Model_11] AS 
(SELECT [DT_Output_11].[KEY] AS [KEY], CAST(NULL AS FLOAT(53)) AS [Score_CLASS_0], [DT_Output_11].[P_0] AS [Proba_CLASS_0], CASE WHEN ([DT_Output_11].[P_0] IS NULL OR [DT_Output_11].[P_0] > 0.0) THEN log([DT_Output_11].[P_0]) ELSE -1.79769313486231e+308 END AS [LogProba_CLASS_0], CAST(NULL AS FLOAT(53)) AS [Score_CLASS_1], [DT_Output_11].[P_1] AS [Proba_CLASS_1], CASE WHEN ([DT_Output_11].[P_1] IS NULL OR [DT_Output_11].[P_1] > 0.0) THEN log([DT_Output_11].[P_1]) ELSE -1.79769313486231e+308 END AS [LogProba_CLASS_1], CAST(NULL AS FLOAT(53)) AS [Score_CLASS_2], [DT_Output_11].[P_2] AS [Proba_CLASS_2], CASE WHEN ([DT_Output_11].[P_2] IS NULL OR [DT_Output_11].[P_2] > 0.0) THEN log([DT_Output_11].[P_2]) ELSE -1.79769313486231e+308 END AS [LogProba_CLASS_2] 
FROM [DT_Output_11]), 
...
[BAG_Model_12] AS 
(SELECT [DT_Output_12].[KEY] AS [KEY], CAST(NULL AS FLOAT(53)) AS [Score_CLASS_0], [DT_Output_12].[P_0] AS [Proba_CLASS_0], CASE WHEN ([DT_Output_12].[P_0] IS NULL OR [DT_Output_12].[P_0] > 0.0) THEN log([DT_Output_12].[P_0]) ELSE -1.79769313486231e+308 END AS [LogProba_CLASS_0], CAST(NULL AS FLOAT(53)) AS [Score_CLASS_1], [DT_Output_12].[P_1] AS [Proba_CLASS_1], CASE WHEN ([DT_Output_12].[P_1] IS NULL OR [DT_Output_12].[P_1] > 0.0) THEN log([DT_Output_12].[P_1]) ELSE -1.79769313486231e+308 END AS [LogProba_CLASS_1], CAST(NULL AS FLOAT(53)) AS [Score_CLASS_2], [DT_Output_12].[P_2] AS [Proba_CLASS_2], CASE WHEN ([DT_Output_12].[P_2] IS NULL OR [DT_Output_12].[P_2] > 0.0) THEN log([DT_Output_12].[P_2]) ELSE -1.79769313486231e+308 END AS [LogProba_CLASS_2] 
FROM [DT_Output_12]), 
...
[BAG_Model_13] AS 
(SELECT [DT_Output_13].[KEY] AS [KEY], CAST(NULL AS FLOAT(53)) AS [Score_CLASS_0], [DT_Output_13].[P_0] AS [Proba_CLASS_0], CASE WHEN ([DT_Output_13].[P_0] IS NULL OR [DT_Output_13].[P_0] > 0.0) THEN log([DT_Output_13].[P_0]) ELSE -1.79769313486231e+308 END AS [LogProba_CLASS_0], CAST(NULL AS FLOAT(53)) AS [Score_CLASS_1], [DT_Output_13].[P_1] AS [Proba_CLASS_1], CASE WHEN ([DT_Output_13].[P_1] IS NULL OR [DT_Output_13].[P_1] > 0.0) THEN log([DT_Output_13].[P_1]) ELSE -1.79769313486231e+308 END AS [LogProba_CLASS_1], CAST(NULL AS FLOAT(53)) AS [Score_CLASS_2], [DT_Output_13].[P_2] AS [Proba_CLASS_2], CASE WHEN ([DT_Output_13].[P_2] IS NULL OR [DT_Output_13].[P_2] > 0.0) THEN log([DT_Output_13].[P_2]) ELSE -1.79769313486231e+308 END AS [LogProba_CLASS_2] 
FROM [DT_Output_13]), 
...
[BAG_Model_14] AS 
(SELECT [DT_Output_14].[KEY] AS [KEY], CAST(NULL AS FLOAT(53)) AS [Score_CLASS_0], [DT_Output_14].[P_0] AS [Proba_CLASS_0], CASE WHEN ([DT_Output_14].[P_0] IS NULL OR [DT_Output_14].[P_0] > 0.0) THEN log([DT_Output_14].[P_0]) ELSE -1.79769313486231e+308 END AS [LogProba_CLASS_0], CAST(NULL AS FLOAT(53)) AS [Score_CLASS_1], [DT_Output_14].[P_1] AS [Proba_CLASS_1], CASE WHEN ([DT_Output_14].[P_1] IS NULL OR [DT_Output_14].[P_1] > 0.0) THEN log([DT_Output_14].[P_1]) ELSE -1.79769313486231e+308 END AS [LogProba_CLASS_1], CAST(NULL AS FLOAT(53)) AS [Score_CLASS_2], [DT_Output_14].[P_2] AS [Proba_CLASS_2], CASE WHEN ([DT_Output_14].[P_2] IS NULL OR [DT_Output_14].[P_2] > 0.0) THEN log([DT_Output_14].[P_2]) ELSE -1.79769313486231e+308 END AS [LogProba_CLASS_2] 
FROM [DT_Output_14]), 
...
[BAG_Model_15] AS 
(SELECT [DT_Output_15].[KEY] AS [KEY], CAST(NULL AS FLOAT(53)) AS [Score_CLASS_0], [DT_Output_15].[P_0] AS [Proba_CLASS_0], CASE WHEN ([DT_Output_15].[P_0] IS NULL OR [DT_Output_15].[P_0] > 0.0) THEN log([DT_Output_15].[P_0]) ELSE -1.79769313486231e+308 END AS [LogProba_CLASS_0], CAST(NULL AS FLOAT(53)) AS [Score_CLASS_1], [DT_Output_15].[P_1] AS [Proba_CLASS_1], CASE WHEN ([DT_Output_15].[P_1] IS NULL OR [DT_Output_15].[P_1] > 0.0) THEN log([DT_Output_15].[P_1]) ELSE -1.79769313486231e+308 END AS [LogProba_CLASS_1], CAST(NULL AS FLOAT(53)) AS [Score_CLASS_2], [DT_Output_15].[P_2] AS [Proba_CLASS_2], CASE WHEN ([DT_Output_15].[P_2] IS NULL OR [DT_Output_15].[P_2] > 0.0) THEN log([DT_Output_15].[P_2]) ELSE -1.79769313486231e+308 END AS [LogProba_CLASS_2] 
FROM [DT_Output_15])
 INSERT INTO ##TMP_20180508190416_CODEGEN_LJ5AJD_BAG_B1 ([KEY], [Score_CLASS_0], [Proba_CLASS_0], [LogProba_CLASS_0], [Score_CLASS_1], [Proba_CLASS_1], [LogProba_CLASS_1], [Score_CLASS_2], [Proba_CLASS_2], [LogProba_CLASS_2]) SELECT [BAG_B1].[KEY], [BAG_B1].[Score_CLASS_0], [BAG_B1].[Proba_CLASS_0], [BAG_B1].[LogProba_CLASS_0], [BAG_B1].[Score_CLASS_1], [BAG_B1].[Proba_CLASS_1], [BAG_B1].[LogProba_CLASS_1], [BAG_B1].[Score_CLASS_2], [BAG_B1].[Proba_CLASS_2], [BAG_B1].[LogProba_CLASS_2] 
...
-- Code For temporary table ##TMP_20180508190416_CODEGEN_807C49_BAG_Union part 1. Create 


CREATE TABLE ##TMP_20180508190416_CODEGEN_807C49_BAG_Union (
	[KEY] BIGINT NULL, 
	[Score_CLASS_0] FLOAT(53) NULL, 
	[Proba_CLASS_0] FLOAT(53) NULL, 
	[LogProba_CLASS_0] FLOAT(53) NULL, 
...
-- Code For temporary table ##TMP_20180508190416_CODEGEN_807C49_BAG_Union part 2. Populate

INSERT INTO ##TMP_20180508190416_CODEGEN_807C49_BAG_Union ([KEY], [Score_CLASS_0], [Proba_CLASS_0], [LogProba_CLASS_0], [Score_CLASS_1], [Proba_CLASS_1], [LogProba_CLASS_1], [Score_CLASS_2], [Proba_CLASS_2], [LogProba_CLASS_2]) SELECT [BAG_Union].[KEY], [BAG_Union].[Score_CLASS_0], [BAG_Union].[Proba_CLASS_0], [BAG_Union].[LogProba_CLASS_0], [BAG_Union].[Score_CLASS_1], [BAG_Union].[Proba_CLASS_1], [BAG_Union].[LogProba_CLASS_1], [BAG_Union].[Score_CLASS_2], [BAG_Union].[Proba_CLASS_2], [BAG_Union].[LogProba_CLASS_2] 
...
-- Code For temporary table ##TMP_20180508190416_CODEGEN_EWMWWE_BAG_avg part 2. Populate

INSERT INTO ##TMP_20180508190416_CODEGEN_EWMWWE_BAG_avg ([KEY], [Score_CLASS_0], [Proba_CLASS_0], [LogProba_CLASS_0], [Score_CLASS_1], [Proba_CLASS_1], [LogProba_CLASS_1], [Score_CLASS_2], [Proba_CLASS_2], [LogProba_CLASS_2]) SELECT [BAG_avg].[KEY], [BAG_avg].[Score_CLASS_0], [BAG_avg].[Proba_CLASS_0], [BAG_avg].[LogProba_CLASS_0], [BAG_avg].[Score_CLASS_1], [BAG_avg].[Proba_CLASS_1], [BAG_avg].[LogProba_CLASS_1], [BAG_avg].[Score_CLASS_2], [BAG_avg].[Proba_CLASS_2], [BAG_avg].[LogProba_CLASS_2] 
...
FROM (SELECT [BAG_Union].[KEY] AS [KEY], avg(CAST([BAG_Union].[Score_CLASS_0] AS FLOAT(53))) AS [Score_CLASS_0], avg(CAST([BAG_Union].[Proba_CLASS_0] AS FLOAT(53))) AS [Proba_CLASS_0], CAST(NULL AS FLOAT(53)) AS [LogProba_CLASS_0], avg(CAST([BAG_Union].[Score_CLASS_1] AS FLOAT(53))) AS [Score_CLASS_1], avg(CAST([BAG_Union].[Proba_CLASS_1] AS FLOAT(53))) AS [Proba_CLASS_1], CAST(NULL AS FLOAT(53)) AS [LogProba_CLASS_1], avg(CAST([BAG_Union].[Score_CLASS_2] AS FLOAT(53))) AS [Score_CLASS_2], avg(CAST([BAG_Union].[Proba_CLASS_2] AS FLOAT(53))) AS [Proba_CLASS_2], CAST(NULL AS FLOAT(53)) AS [LogProba_CLASS_2] 
FROM ##TMP_20180508190416_CODEGEN_807C49_BAG_Union AS [BAG_Union] GROUP BY [BAG_Union].[KEY]) AS [T]) AS [BAG_avg]
...
FROM ##TMP_20180508190416_CODEGEN_EWMWWE_BAG_avg AS [BAG_avg]), 
