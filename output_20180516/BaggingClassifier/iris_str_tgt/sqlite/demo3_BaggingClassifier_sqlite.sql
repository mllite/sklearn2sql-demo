...
-- Code For temporary table TMP_20180508190416_CODEGEN_IXBPM1_BAG_B0 part 1. Create 


CREATE TEMPORARY TABLE "TMP_20180508190416_CODEGEN_IXBPM1_BAG_B0" (
	"KEY" BIGINT, 
	"Score_CLASS_0" FLOAT, 
	"Proba_CLASS_0" FLOAT, 
...
-- Code For temporary table TMP_20180508190416_CODEGEN_IXBPM1_BAG_B0 part 2. Populate
...
-- Code For temporary table TMP_20180508190416_CODEGEN_2EKQ21_BAG_B1 part 1. Create 


CREATE TEMPORARY TABLE "TMP_20180508190416_CODEGEN_2EKQ21_BAG_B1" (
	"KEY" BIGINT, 
	"Score_CLASS_0" FLOAT, 
	"Proba_CLASS_0" FLOAT, 
	"LogProba_CLASS_0" FLOAT, 
...
-- Code For temporary table TMP_20180508190416_CODEGEN_2EKQ21_BAG_B1 part 2. Populate
...
-- Code For temporary table TMP_20180508190416_CODEGEN_FW4ODN_BAG_Union part 1. Create 


CREATE TEMPORARY TABLE "TMP_20180508190416_CODEGEN_FW4ODN_BAG_Union" (
	"KEY" BIGINT, 
	"Score_CLASS_0" FLOAT, 
	"Proba_CLASS_0" FLOAT, 
	"LogProba_CLASS_0" FLOAT, 
...
FROM "TMP_20180508190416_CODEGEN_IXBPM1_BAG_B0" AS "BAG_B0" UNION ALL SELECT "BAG_B1"."KEY" AS "KEY", "BAG_B1"."Score_CLASS_0" AS "Score_CLASS_0", "BAG_B1"."Proba_CLASS_0" AS "Proba_CLASS_0", "BAG_B1"."LogProba_CLASS_0" AS "LogProba_CLASS_0", "BAG_B1"."Score_CLASS_1" AS "Score_CLASS_1", "BAG_B1"."Proba_CLASS_1" AS "Proba_CLASS_1", "BAG_B1"."LogProba_CLASS_1" AS "LogProba_CLASS_1", "BAG_B1"."Score_CLASS_2" AS "Score_CLASS_2", "BAG_B1"."Proba_CLASS_2" AS "Proba_CLASS_2", "BAG_B1"."LogProba_CLASS_2" AS "LogProba_CLASS_2" 
FROM "TMP_20180508190416_CODEGEN_2EKQ21_BAG_B1" AS "BAG_B1") AS "BAG_EnsembleUnion") AS "BAG_Union"

-- Code For temporary table TMP_20180508190416_CODEGEN_F85K3L_BAG_avg part 1. Create 


CREATE TEMPORARY TABLE "TMP_20180508190416_CODEGEN_F85K3L_BAG_avg" (
	"KEY" BIGINT NOT NULL, 
	"Score_CLASS_0" FLOAT, 
	"Proba_CLASS_0" FLOAT, 
	"LogProba_CLASS_0" FLOAT, 
...
FROM "TMP_20180508190416_CODEGEN_FW4ODN_BAG_Union" AS "BAG_Union" GROUP BY "BAG_Union"."KEY") AS "T") AS "BAG_avg"

-- Code For temporary table TMP_20180508190416_CODEGEN_F85K3L_BAG_avg part 3. Create Index 

CREATE INDEX "ix_TMP_20180508190416_CODEGEN_F85K3L_BAG_avg_KEY" ON "TMP_20180508190416_CODEGEN_F85K3L_BAG_avg" ("KEY")
...
FROM "TMP_20180508190416_CODEGEN_F85K3L_BAG_avg" AS "BAG_avg"), 
