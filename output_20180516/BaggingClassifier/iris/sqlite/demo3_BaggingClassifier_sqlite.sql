...
-- Code For temporary table TMP_20180516122213_CODEGEN_21XFD1_BAG_B0 part 1. Create 


CREATE TEMPORARY TABLE "TMP_20180516122213_CODEGEN_21XFD1_BAG_B0" (
	"KEY" BIGINT, 
	"Score_0" FLOAT, 
	"Proba_0" FLOAT, 
	"LogProba_0" FLOAT, 
...
-- Code For temporary table TMP_20180516122213_CODEGEN_21XFD1_BAG_B0 part 2. Populate
...
FROM "DT_Output_9")
 INSERT INTO "TMP_20180516122213_CODEGEN_21XFD1_BAG_B0" ("KEY", "Score_0", "Proba_0", "LogProba_0", "Score_1", "Proba_1", "LogProba_1", "Score_2", "Proba_2", "LogProba_2") SELECT "BAG_B0"."KEY", "BAG_B0"."Score_0", "BAG_B0"."Proba_0", "BAG_B0"."LogProba_0", "BAG_B0"."Score_1", "BAG_B0"."Proba_1", "BAG_B0"."LogProba_1", "BAG_B0"."Score_2", "BAG_B0"."Proba_2", "BAG_B0"."LogProba_2" 
...
-- Code For temporary table TMP_20180516122213_CODEGEN_7RXJXI_BAG_B1 part 1. Create 


CREATE TEMPORARY TABLE "TMP_20180516122213_CODEGEN_7RXJXI_BAG_B1" (
	"KEY" BIGINT, 
	"Score_0" FLOAT, 
	"Proba_0" FLOAT, 
	"LogProba_0" FLOAT, 
...
-- Code For temporary table TMP_20180516122213_CODEGEN_7RXJXI_BAG_B1 part 2. Populate
...
FROM "DT_Output_15")
 INSERT INTO "TMP_20180516122213_CODEGEN_7RXJXI_BAG_B1" ("KEY", "Score_0", "Proba_0", "LogProba_0", "Score_1", "Proba_1", "LogProba_1", "Score_2", "Proba_2", "LogProba_2") SELECT "BAG_B1"."KEY", "BAG_B1"."Score_0", "BAG_B1"."Proba_0", "BAG_B1"."LogProba_0", "BAG_B1"."Score_1", "BAG_B1"."Proba_1", "BAG_B1"."LogProba_1", "BAG_B1"."Score_2", "BAG_B1"."Proba_2", "BAG_B1"."LogProba_2" 
...
-- Code For temporary table TMP_20180516122213_CODEGEN_DE053Z_BAG_avg part 1. Create 


CREATE TEMPORARY TABLE "TMP_20180516122213_CODEGEN_DE053Z_BAG_avg" (
	"KEY" BIGINT NOT NULL, 
	"Score_0" FLOAT, 
	"Proba_0" FLOAT, 
	"LogProba_0" FLOAT, 
...
-- Code For temporary table TMP_20180516122213_CODEGEN_DE053Z_BAG_avg part 2. Populate
...
-- Code For temporary table TMP_20180516122213_CODEGEN_DE053Z_BAG_avg part 3. Create Index 

CREATE INDEX "ix_TMP_20180516122213_CODEGEN_DE053Z_BAG_avg_KEY" ON "TMP_20180516122213_CODEGEN_DE053Z_BAG_avg" ("KEY")
...
FROM "TMP_20180516122213_CODEGEN_DE053Z_BAG_avg" AS "BAG_avg"), 
