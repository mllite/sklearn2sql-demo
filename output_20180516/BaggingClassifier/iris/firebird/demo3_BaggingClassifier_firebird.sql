...
-- Code For temporary table TMP_20180516_CODEGEN_WEVIJV_BAG part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180516_CODEGEN_WEVIJV_BAG" (
	"KEY" BIGINT, 
...
-- Code For temporary table TMP_20180516_CODEGEN_WEVIJV_BAG part 2. Populate

INSERT INTO "TMP_20180516_CODEGEN_WEVIJV_BAG" ("KEY", "Score_0", "Proba_0", "LogProba_0", "Score_1", "Proba_1", "LogProba_1", "Score_2", "Proba_2", "LogProba_2") SELECT "U"."KEY", "U"."Score_0", "U"."Proba_0", "U"."LogProba_0", "U"."Score_1", "U"."Proba_1", "U"."LogProba_1", "U"."Score_2", "U"."Proba_2", "U"."LogProba_2" 
...
-- Code For temporary table TMP_20180516_CODEGEN_4QFWUU_BAG part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180516_CODEGEN_4QFWUU_BAG" (
	"KEY" BIGINT, 
	"Score_0" DOUBLE PRECISION, 
	"Proba_0" DOUBLE PRECISION, 
	"LogProba_0" DOUBLE PRECISION, 
...
-- Code For temporary table TMP_20180516_CODEGEN_4QFWUU_BAG part 2. Populate

INSERT INTO "TMP_20180516_CODEGEN_4QFWUU_BAG" ("KEY", "Score_0", "Proba_0", "LogProba_0", "Score_1", "Proba_1", "LogProba_1", "Score_2", "Proba_2", "LogProba_2") SELECT "U"."KEY", "U"."Score_0", "U"."Proba_0", "U"."LogProba_0", "U"."Score_1", "U"."Proba_1", "U"."LogProba_1", "U"."Score_2", "U"."Proba_2", "U"."LogProba_2" 
...
-- Code For temporary table TMP_20180516_CODEGEN_4EXTIL_BAG part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180516_CODEGEN_4EXTIL_BAG" (
	"KEY" BIGINT NOT NULL, 
	"Score_0" DOUBLE PRECISION, 
	"Proba_0" DOUBLE PRECISION, 
	"LogProba_0" DOUBLE PRECISION, 
...
-- Code For temporary table TMP_20180516_CODEGEN_4EXTIL_BAG part 2. Populate

INSERT INTO "TMP_20180516_CODEGEN_4EXTIL_BAG" ("KEY", "Score_0", "Proba_0", "LogProba_0", "Score_1", "Proba_1", "LogProba_1", "Score_2", "Proba_2", "LogProba_2") SELECT "U"."KEY", "U"."Score_0", "U"."Proba_0", "U"."LogProba_0", "U"."Score_1", "U"."Proba_1", "U"."LogProba_1", "U"."Score_2", "U"."Proba_2", "U"."LogProba_2" 
...
-- Code For temporary table TMP_20180516_CODEGEN_4EXTIL_BAG part 3. Create Index 

CREATE INDEX "ix_TMP_20180516_CODEGEN_05a2" ON "TMP_20180516_CODEGEN_4EXTIL_BAG" ("KEY")
...
FROM "TMP_20180516_CODEGEN_4EXTIL_BAG" AS "BAG_avg"), 
