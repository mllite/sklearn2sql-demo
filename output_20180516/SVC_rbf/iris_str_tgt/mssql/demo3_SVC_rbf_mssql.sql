...
-- Code For temporary table ##TMP_20180516131408_CODEGEN_FB1LC4_KernAgg_B0 part 1. Create 


CREATE TABLE ##TMP_20180516131408_CODEGEN_FB1LC4_KernAgg_B0 (
	[KEY] BIGINT NULL, 
...
-- Code For temporary table ##TMP_20180516131408_CODEGEN_FB1LC4_KernAgg_B0 part 2. Populate
...
FROM (SELECT kernel_input.[KEY] AS [KEY], [SV_data_CLASS_0_CLASS_1].dual_coeff * exp(CASE WHEN (CASE WHEN (-100.0 <= -0.25 * (power(kernel_input.[Feature_0] - [SV_data_CLASS_0_CLASS_1].sv_0, 2) + power(kernel_input.[Feature_1] - [SV_data_CLASS_0_CLASS_1].sv_1, 2) + power(kernel_input.[Feature_2] - [SV_data_CLASS_0_CLASS_1].sv_2, 2) + power(kernel_input.[Feature_3] - [SV_data_CLASS_0_CLASS_1].sv_3, 2))) THEN -0.25 * (power(kernel_input.[Feature_0] - [SV_data_CLASS_0_CLASS_1].sv_0, 2) + power(kernel_input.[Feature_1] - [SV_data_CLASS_0_CLASS_1].sv_1, 2) + power(kernel_input.[Feature_2] - [SV_data_CLASS_0_CLASS_1].sv_2, 2) + power(kernel_input.[Feature_3] - [SV_data_CLASS_0_CLASS_1].sv_3, 2)) ELSE -100.0 END <= 100.0) THEN CASE WHEN (-100.0 <= -0.25 * (power(kernel_input.[Feature_0] - [SV_data_CLASS_0_CLASS_1].sv_0, 2) + power(kernel_input.[Feature_1] - [SV_data_CLASS_0_CLASS_1].sv_1, 2) + power(kernel_input.[Feature_2] - [SV_data_CLASS_0_CLASS_1].sv_2, 2) + power(kernel_input.[Feature_3] - [SV_data_CLASS_0_CLASS_1].sv_3, 2))) THEN -0.25 * (power(kernel_input.[Feature_0] - [SV_data_CLASS_0_CLASS_1].sv_0, 2) + power(kernel_input.[Feature_1] - [SV_data_CLASS_0_CLASS_1].sv_1, 2) + power(kernel_input.[Feature_2] - [SV_data_CLASS_0_CLASS_1].sv_2, 2) + power(kernel_input.[Feature_3] - [SV_data_CLASS_0_CLASS_1].sv_3, 2)) ELSE -100.0 END ELSE 100.0 END) AS dot_prod1 
...
(SELECT [kernel_dp_CLASS_0_CLASS_1].[KEY] AS [KEY], 'CLASS_0' AS [OVO_Class1], 'CLASS_1' AS [OVO_Class2], CASE WHEN (-[kernel_dp_CLASS_0_CLASS_1].dot_product >= 0.0) THEN 1 ELSE 0 END AS [OVO_Decision], coalesce(-[kernel_dp_CLASS_0_CLASS_1].dot_product, 1.0 / (1.0 + exp(CASE WHEN (CASE WHEN (-100.0 <= -(-((-[kernel_dp_CLASS_0_CLASS_1].dot_product) * -3.3007552723547953 + 0.07918962399908774))) THEN -(-((-[kernel_dp_CLASS_0_CLASS_1].dot_product) * -3.3007552723547953 + 0.07918962399908774)) ELSE -100.0 END <= 100.0) THEN CASE WHEN (-100.0 <= -(-((-[kernel_dp_CLASS_0_CLASS_1].dot_product) * -3.3007552723547953 + 0.07918962399908774))) THEN -(-((-[kernel_dp_CLASS_0_CLASS_1].dot_product) * -3.3007552723547953 + 0.07918962399908774)) ELSE -100.0 END ELSE 100.0 END))) AS [OVO_Confidence] 
FROM [kernel_dp_CLASS_0_CLASS_1])
 INSERT INTO ##TMP_20180516131408_CODEGEN_FB1LC4_KernAgg_B0 ([KEY], [OVO_Class1], [OVO_Class2], [OVO_Decision], [OVO_Confidence]) SELECT [KernAgg_B0].[KEY], [KernAgg_B0].[OVO_Class1], [KernAgg_B0].[OVO_Class2], [KernAgg_B0].[OVO_Decision], [KernAgg_B0].[OVO_Confidence] 
...
-- Code For temporary table ##TMP_20180516131408_CODEGEN_5VK0UP_KernAgg_B1 part 1. Create 


CREATE TABLE ##TMP_20180516131408_CODEGEN_5VK0UP_KernAgg_B1 (
	[KEY] BIGINT NULL, 
	[OVO_Class1] VARCHAR(max) COLLATE utf8 NULL, 
	[OVO_Class2] VARCHAR(max) COLLATE utf8 NULL, 
	[OVO_Decision] BIGINT NULL, 
...
-- Code For temporary table ##TMP_20180516131408_CODEGEN_5VK0UP_KernAgg_B1 part 2. Populate
...
FROM (SELECT kernel_input.[KEY] AS [KEY], [SV_data_CLASS_0_CLASS_2].dual_coeff * exp(CASE WHEN (CASE WHEN (-100.0 <= -0.25 * (power(kernel_input.[Feature_0] - [SV_data_CLASS_0_CLASS_2].sv_0, 2) + power(kernel_input.[Feature_1] - [SV_data_CLASS_0_CLASS_2].sv_1, 2) + power(kernel_input.[Feature_2] - [SV_data_CLASS_0_CLASS_2].sv_2, 2) + power(kernel_input.[Feature_3] - [SV_data_CLASS_0_CLASS_2].sv_3, 2))) THEN -0.25 * (power(kernel_input.[Feature_0] - [SV_data_CLASS_0_CLASS_2].sv_0, 2) + power(kernel_input.[Feature_1] - [SV_data_CLASS_0_CLASS_2].sv_1, 2) + power(kernel_input.[Feature_2] - [SV_data_CLASS_0_CLASS_2].sv_2, 2) + power(kernel_input.[Feature_3] - [SV_data_CLASS_0_CLASS_2].sv_3, 2)) ELSE -100.0 END <= 100.0) THEN CASE WHEN (-100.0 <= -0.25 * (power(kernel_input.[Feature_0] - [SV_data_CLASS_0_CLASS_2].sv_0, 2) + power(kernel_input.[Feature_1] - [SV_data_CLASS_0_CLASS_2].sv_1, 2) + power(kernel_input.[Feature_2] - [SV_data_CLASS_0_CLASS_2].sv_2, 2) + power(kernel_input.[Feature_3] - [SV_data_CLASS_0_CLASS_2].sv_3, 2))) THEN -0.25 * (power(kernel_input.[Feature_0] - [SV_data_CLASS_0_CLASS_2].sv_0, 2) + power(kernel_input.[Feature_1] - [SV_data_CLASS_0_CLASS_2].sv_1, 2) + power(kernel_input.[Feature_2] - [SV_data_CLASS_0_CLASS_2].sv_2, 2) + power(kernel_input.[Feature_3] - [SV_data_CLASS_0_CLASS_2].sv_3, 2)) ELSE -100.0 END ELSE 100.0 END) AS dot_prod1 
...
(SELECT [kernel_dp_CLASS_0_CLASS_2].[KEY] AS [KEY], 'CLASS_0' AS [OVO_Class1], 'CLASS_2' AS [OVO_Class2], CASE WHEN (-[kernel_dp_CLASS_0_CLASS_2].dot_product >= 0.0) THEN 1 ELSE 0 END AS [OVO_Decision], coalesce(-[kernel_dp_CLASS_0_CLASS_2].dot_product, 1.0 / (1.0 + exp(CASE WHEN (CASE WHEN (-100.0 <= -(-((-[kernel_dp_CLASS_0_CLASS_2].dot_product) * -3.534211902353646 + 0.12642575386549185))) THEN -(-((-[kernel_dp_CLASS_0_CLASS_2].dot_product) * -3.534211902353646 + 0.12642575386549185)) ELSE -100.0 END <= 100.0) THEN CASE WHEN (-100.0 <= -(-((-[kernel_dp_CLASS_0_CLASS_2].dot_product) * -3.534211902353646 + 0.12642575386549185))) THEN -(-((-[kernel_dp_CLASS_0_CLASS_2].dot_product) * -3.534211902353646 + 0.12642575386549185)) ELSE -100.0 END ELSE 100.0 END))) AS [OVO_Confidence] 
FROM [kernel_dp_CLASS_0_CLASS_2])
 INSERT INTO ##TMP_20180516131408_CODEGEN_5VK0UP_KernAgg_B1 ([KEY], [OVO_Class1], [OVO_Class2], [OVO_Decision], [OVO_Confidence]) SELECT [KernAgg_B1].[KEY], [KernAgg_B1].[OVO_Class1], [KernAgg_B1].[OVO_Class2], [KernAgg_B1].[OVO_Decision], [KernAgg_B1].[OVO_Confidence] 
...
-- Code For temporary table ##TMP_20180516131408_CODEGEN_DD6T8Z_KernAgg_B2 part 1. Create 


CREATE TABLE ##TMP_20180516131408_CODEGEN_DD6T8Z_KernAgg_B2 (
	[KEY] BIGINT NULL, 
	[OVO_Class1] VARCHAR(max) COLLATE utf8 NULL, 
	[OVO_Class2] VARCHAR(max) COLLATE utf8 NULL, 
	[OVO_Decision] BIGINT NULL, 
...
-- Code For temporary table ##TMP_20180516131408_CODEGEN_DD6T8Z_KernAgg_B2 part 2. Populate
...
FROM (SELECT kernel_input.[KEY] AS [KEY], [SV_data_CLASS_1_CLASS_2].dual_coeff * exp(CASE WHEN (CASE WHEN (-100.0 <= -0.25 * (power(kernel_input.[Feature_0] - [SV_data_CLASS_1_CLASS_2].sv_0, 2) + power(kernel_input.[Feature_1] - [SV_data_CLASS_1_CLASS_2].sv_1, 2) + power(kernel_input.[Feature_2] - [SV_data_CLASS_1_CLASS_2].sv_2, 2) + power(kernel_input.[Feature_3] - [SV_data_CLASS_1_CLASS_2].sv_3, 2))) THEN -0.25 * (power(kernel_input.[Feature_0] - [SV_data_CLASS_1_CLASS_2].sv_0, 2) + power(kernel_input.[Feature_1] - [SV_data_CLASS_1_CLASS_2].sv_1, 2) + power(kernel_input.[Feature_2] - [SV_data_CLASS_1_CLASS_2].sv_2, 2) + power(kernel_input.[Feature_3] - [SV_data_CLASS_1_CLASS_2].sv_3, 2)) ELSE -100.0 END <= 100.0) THEN CASE WHEN (-100.0 <= -0.25 * (power(kernel_input.[Feature_0] - [SV_data_CLASS_1_CLASS_2].sv_0, 2) + power(kernel_input.[Feature_1] - [SV_data_CLASS_1_CLASS_2].sv_1, 2) + power(kernel_input.[Feature_2] - [SV_data_CLASS_1_CLASS_2].sv_2, 2) + power(kernel_input.[Feature_3] - [SV_data_CLASS_1_CLASS_2].sv_3, 2))) THEN -0.25 * (power(kernel_input.[Feature_0] - [SV_data_CLASS_1_CLASS_2].sv_0, 2) + power(kernel_input.[Feature_1] - [SV_data_CLASS_1_CLASS_2].sv_1, 2) + power(kernel_input.[Feature_2] - [SV_data_CLASS_1_CLASS_2].sv_2, 2) + power(kernel_input.[Feature_3] - [SV_data_CLASS_1_CLASS_2].sv_3, 2)) ELSE -100.0 END ELSE 100.0 END) AS dot_prod1 
...
(SELECT [kernel_dp_CLASS_1_CLASS_2].[KEY] AS [KEY], 'CLASS_1' AS [OVO_Class1], 'CLASS_2' AS [OVO_Class2], CASE WHEN (-[kernel_dp_CLASS_1_CLASS_2].dot_product >= 0.0) THEN 1 ELSE 0 END AS [OVO_Decision], coalesce(-[kernel_dp_CLASS_1_CLASS_2].dot_product, 1.0 / (1.0 + exp(CASE WHEN (CASE WHEN (-100.0 <= -(-((-[kernel_dp_CLASS_1_CLASS_2].dot_product) * -3.6498008404174227 + 0.1760913332929604))) THEN -(-((-[kernel_dp_CLASS_1_CLASS_2].dot_product) * -3.6498008404174227 + 0.1760913332929604)) ELSE -100.0 END <= 100.0) THEN CASE WHEN (-100.0 <= -(-((-[kernel_dp_CLASS_1_CLASS_2].dot_product) * -3.6498008404174227 + 0.1760913332929604))) THEN -(-((-[kernel_dp_CLASS_1_CLASS_2].dot_product) * -3.6498008404174227 + 0.1760913332929604)) ELSE -100.0 END ELSE 100.0 END))) AS [OVO_Confidence] 
FROM [kernel_dp_CLASS_1_CLASS_2])
 INSERT INTO ##TMP_20180516131408_CODEGEN_DD6T8Z_KernAgg_B2 ([KEY], [OVO_Class1], [OVO_Class2], [OVO_Decision], [OVO_Confidence]) SELECT [KernAgg_B2].[KEY], [KernAgg_B2].[OVO_Class1], [KernAgg_B2].[OVO_Class2], [KernAgg_B2].[OVO_Decision], [KernAgg_B2].[OVO_Confidence] 
...
-- Code For temporary table ##TMP_20180516131408_CODEGEN_19QSMU_KernAgg part 1. Create 


CREATE TABLE ##TMP_20180516131408_CODEGEN_19QSMU_KernAgg (
	[KEY] BIGINT NULL, 
...
-- Code For temporary table ##TMP_20180516131408_CODEGEN_19QSMU_KernAgg part 2. Populate
...
FROM ##TMP_20180516131408_CODEGEN_FB1LC4_KernAgg_B0 AS [KernAgg_B0] UNION ALL SELECT [KernAgg_B1].[KEY] AS [KEY], [KernAgg_B1].[OVO_Class1] AS [OVO_Class1], [KernAgg_B1].[OVO_Class2] AS [OVO_Class2], [KernAgg_B1].[OVO_Decision] AS [OVO_Decision], [KernAgg_B1].[OVO_Confidence] AS [OVO_Confidence] 
FROM ##TMP_20180516131408_CODEGEN_5VK0UP_KernAgg_B1 AS [KernAgg_B1] UNION ALL SELECT [KernAgg_B2].[KEY] AS [KEY], [KernAgg_B2].[OVO_Class1] AS [OVO_Class1], [KernAgg_B2].[OVO_Class2] AS [OVO_Class2], [KernAgg_B2].[OVO_Decision] AS [OVO_Decision], [KernAgg_B2].[OVO_Confidence] AS [OVO_Confidence] 
FROM ##TMP_20180516131408_CODEGEN_DD6T8Z_KernAgg_B2 AS [KernAgg_B2]) AS [KernAgg_EnsembleUnion]), 
[OVO_Votes] AS 
...
FROM ##TMP_20180516131408_CODEGEN_19QSMU_KernAgg AS [KernAgg]), 
