...
-- Code For temporary table _CODEGEN_G8WWK5_KERNAGG_B0 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "_CODEGEN_G8WWK5_KERNAGG_B0" (
	"KEY" NUMBER(19), 
	"OVO_Class1" VARCHAR2, 
	"OVO_Class2" VARCHAR2, 
...
-- Code For temporary table _CODEGEN_G8WWK5_KERNAGG_B0 part 2. Populate

INSERT INTO "_CODEGEN_G8WWK5_KERNAGG_B0" ("KEY", "OVO_Class1", "OVO_Class2", "OVO_Decision", "OVO_Confidence") SELECT "U"."KEY", "U"."OVO_Class1", "U"."OVO_Class2", "U"."OVO_Decision", "U"."OVO_Confidence" 
...
-- Code For temporary table _CODEGEN_58W0LD_KERNAGG_B1 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "_CODEGEN_58W0LD_KERNAGG_B1" (
	"KEY" NUMBER(19), 
	"OVO_Class1" VARCHAR2, 
	"OVO_Class2" VARCHAR2, 
	"OVO_Decision" NUMBER(19), 
...
-- Code For temporary table _CODEGEN_58W0LD_KERNAGG_B1 part 2. Populate

INSERT INTO "_CODEGEN_58W0LD_KERNAGG_B1" ("KEY", "OVO_Class1", "OVO_Class2", "OVO_Decision", "OVO_Confidence") SELECT "U"."KEY", "U"."OVO_Class1", "U"."OVO_Class2", "U"."OVO_Decision", "U"."OVO_Confidence" 
FROM (WITH kernel_input AS 
(SELECT "ADS"."KEY" AS "KEY", CAST("ADS"."Feature_0" AS BINARY_DOUBLE) AS "Feature_0", CAST("ADS"."Feature_1" AS BINARY_DOUBLE) AS "Feature_1", CAST("ADS"."Feature_2" AS BINARY_DOUBLE) AS "Feature_2", CAST("ADS"."Feature_3" AS BINARY_DOUBLE) AS "Feature_3", CAST("ADS"."TGT" AS BINARY_DOUBLE) AS "TGT" 
FROM "IRIS_STR_TGT" "ADS"), 
...
-- Code For temporary table _CODEGEN_E1WIOP_KERNAGG_B2 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "_CODEGEN_E1WIOP_KERNAGG_B2" (
	"KEY" NUMBER(19), 
	"OVO_Class1" VARCHAR2, 
	"OVO_Class2" VARCHAR2, 
	"OVO_Decision" NUMBER(19), 
...
-- Code For temporary table _CODEGEN_E1WIOP_KERNAGG_B2 part 2. Populate

INSERT INTO "_CODEGEN_E1WIOP_KERNAGG_B2" ("KEY", "OVO_Class1", "OVO_Class2", "OVO_Decision", "OVO_Confidence") SELECT "U"."KEY", "U"."OVO_Class1", "U"."OVO_Class2", "U"."OVO_Decision", "U"."OVO_Confidence" 
FROM (WITH kernel_input AS 
(SELECT "ADS"."KEY" AS "KEY", CAST("ADS"."Feature_0" AS BINARY_DOUBLE) AS "Feature_0", CAST("ADS"."Feature_1" AS BINARY_DOUBLE) AS "Feature_1", CAST("ADS"."Feature_2" AS BINARY_DOUBLE) AS "Feature_2", CAST("ADS"."Feature_3" AS BINARY_DOUBLE) AS "Feature_3", CAST("ADS"."TGT" AS BINARY_DOUBLE) AS "TGT" 
FROM "IRIS_STR_TGT" "ADS"), 
...
-- Code For temporary table 516_CODEGEN_83IVHH_KERNAGG part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "516_CODEGEN_83IVHH_KERNAGG" (
	"KEY" NUMBER(19), 
...
FROM "_CODEGEN_G8WWK5_KERNAGG_B0" "KernAgg_B0" UNION ALL SELECT "KernAgg_B1"."KEY" AS "KEY", "KernAgg_B1"."OVO_Class1" AS "OVO_Class1", "KernAgg_B1"."OVO_Class2" AS "OVO_Class2", "KernAgg_B1"."OVO_Decision" AS "OVO_Decision", "KernAgg_B1"."OVO_Confidence" AS "OVO_Confidence" 
FROM "_CODEGEN_58W0LD_KERNAGG_B1" "KernAgg_B1" UNION ALL SELECT "KernAgg_B2"."KEY" AS "KEY", "KernAgg_B2"."OVO_Class1" AS "OVO_Class1", "KernAgg_B2"."OVO_Class2" AS "OVO_Class2", "KernAgg_B2"."OVO_Decision" AS "OVO_Decision", "KernAgg_B2"."OVO_Confidence" AS "OVO_Confidence" 
FROM "_CODEGEN_E1WIOP_KERNAGG_B2" "KernAgg_B2") "KernAgg_EnsembleUnion"), 
"OVO_Votes" AS 
...
FROM "516_CODEGEN_83IVHH_KERNAGG" "KernAgg"), 
