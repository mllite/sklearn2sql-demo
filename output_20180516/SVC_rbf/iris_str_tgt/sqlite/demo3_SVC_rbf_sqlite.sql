...
-- Code For temporary table TMP_20180508190736_CODEGEN_TMRPWA_KernAgg_B0 part 1. Create 


CREATE TEMPORARY TABLE "TMP_20180508190736_CODEGEN_TMRPWA_KernAgg_B0" (
	"KEY" BIGINT, 
...
-- Code For temporary table TMP_20180508190736_CODEGEN_TMRPWA_KernAgg_B0 part 2. Populate
...
(SELECT "kernel_dp_CLASS_0_CLASS_2"."KEY" AS "KEY", 'CLASS_0' AS "OVO_Class1", 'CLASS_2' AS "OVO_Class2", CASE WHEN (-"kernel_dp_CLASS_0_CLASS_2".dot_product >= 0.0) THEN 1 ELSE 0 END AS "OVO_Decision", coalesce(-"kernel_dp_CLASS_0_CLASS_2".dot_product, 1.0 / (1.0 + exp(min(max(-100.0, -(-((-"kernel_dp_CLASS_0_CLASS_2".dot_product) * -3.5069942505066964 + 0.1426270386387099))), 100.0)))) AS "OVO_Confidence" 
...
(SELECT "kernel_dp_CLASS_1_CLASS_2"."KEY" AS "KEY", 'CLASS_1' AS "OVO_Class1", 'CLASS_2' AS "OVO_Class2", CASE WHEN (-"kernel_dp_CLASS_1_CLASS_2".dot_product >= 0.0) THEN 1 ELSE 0 END AS "OVO_Decision", coalesce(-"kernel_dp_CLASS_1_CLASS_2".dot_product, 1.0 / (1.0 + exp(min(max(-100.0, -(-((-"kernel_dp_CLASS_1_CLASS_2".dot_product) * -3.378325255419959 + 0.026046182976164706))), 100.0)))) AS "OVO_Confidence" 
FROM "kernel_dp_CLASS_1_CLASS_2")
 INSERT INTO "TMP_20180508190736_CODEGEN_TMRPWA_KernAgg_B0" ("KEY", "OVO_Class1", "OVO_Class2", "OVO_Decision", "OVO_Confidence") SELECT "KernAgg_B0"."KEY", "KernAgg_B0"."OVO_Class1", "KernAgg_B0"."OVO_Class2", "KernAgg_B0"."OVO_Decision", "KernAgg_B0"."OVO_Confidence" 
...
-- Code For temporary table TMP_20180508190736_CODEGEN_4W8EIR_KernAgg_Union part 1. Create 


CREATE TEMPORARY TABLE "TMP_20180508190736_CODEGEN_4W8EIR_KernAgg_Union" (
	"KEY" BIGINT, 
	"OVO_Class1" VARCHAR COLLATE "utf8", 
	"OVO_Class2" VARCHAR COLLATE "utf8", 
	"OVO_Decision" BIGINT, 
...
-- Code For temporary table TMP_20180508190736_CODEGEN_4W8EIR_KernAgg_Union part 2. Populate

INSERT INTO "TMP_20180508190736_CODEGEN_4W8EIR_KernAgg_Union" ("KEY", "OVO_Class1", "OVO_Class2", "OVO_Decision", "OVO_Confidence") SELECT "KernAgg_Union"."KEY", "KernAgg_Union"."OVO_Class1", "KernAgg_Union"."OVO_Class2", "KernAgg_Union"."OVO_Decision", "KernAgg_Union"."OVO_Confidence" 
...
FROM "TMP_20180508190736_CODEGEN_TMRPWA_KernAgg_B0" AS "KernAgg_B0") AS "KernAgg_EnsembleUnion") AS "KernAgg_Union"

-- Code For temporary table TMP_20180508190736_CODEGEN_KW888Q_KernAgg part 1. Create 


CREATE TEMPORARY TABLE "TMP_20180508190736_CODEGEN_KW888Q_KernAgg" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20180508190736_CODEGEN_KW888Q_KernAgg part 2. Populate
...
FROM "TMP_20180508190736_CODEGEN_4W8EIR_KernAgg_Union" AS "KernAgg_Union" GROUP BY "KernAgg_Union"."KEY") AS "Votes_Sel"), 
"OVO_SumConf_CTE" AS 
...
-- Code For temporary table TMP_20180508190736_CODEGEN_KW888Q_KernAgg part 3. Create Index 

CREATE INDEX "ix_TMP_20180508190736_CODEGEN_KW888Q_KernAgg_KEY" ON "TMP_20180508190736_CODEGEN_KW888Q_KernAgg" ("KEY")
...
FROM "TMP_20180508190736_CODEGEN_KW888Q_KernAgg" AS "KernAgg"), 
