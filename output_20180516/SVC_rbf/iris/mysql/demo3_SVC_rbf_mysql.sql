...
-- Code For temporary table TMP_20180516122655_CODEGEN_QL0OZ2_KernAgg_B0 part 1. Create 


CREATE TEMPORARY TABLE `TMP_20180516122655_CODEGEN_QL0OZ2_KernAgg_B0` (
	`KEY` BIGINT, 
	`OVO_Class1` BIGINT, 
	`OVO_Class2` BIGINT, 
	`OVO_Decision` BIGINT, 
...
-- Code For temporary table TMP_20180516122655_CODEGEN_QL0OZ2_KernAgg_B0 part 2. Populate

INSERT INTO `TMP_20180516122655_CODEGEN_QL0OZ2_KernAgg_B0` (`KEY`, `OVO_Class1`, `OVO_Class2`, `OVO_Decision`, `OVO_Confidence`) SELECT `U`.`KEY`, `U`.`OVO_Class1`, `U`.`OVO_Class2`, `U`.`OVO_Decision`, `U`.`OVO_Confidence` 
...
-- Code For temporary table TMP_20180516122655_CODEGEN_HNGM0G_KernAgg_B1 part 1. Create 


CREATE TEMPORARY TABLE `TMP_20180516122655_CODEGEN_HNGM0G_KernAgg_B1` (
	`KEY` BIGINT, 
	`OVO_Class1` BIGINT, 
	`OVO_Class2` BIGINT, 
	`OVO_Decision` BIGINT, 
...
-- Code For temporary table TMP_20180516122655_CODEGEN_HNGM0G_KernAgg_B1 part 2. Populate

INSERT INTO `TMP_20180516122655_CODEGEN_HNGM0G_KernAgg_B1` (`KEY`, `OVO_Class1`, `OVO_Class2`, `OVO_Decision`, `OVO_Confidence`) SELECT `U`.`KEY`, `U`.`OVO_Class1`, `U`.`OVO_Class2`, `U`.`OVO_Decision`, `U`.`OVO_Confidence` 
FROM (WITH kernel_input AS 
(SELECT `ADS`.`KEY` AS `KEY`, CAST(`ADS`.`Feature_0` AS DOUBLE) AS `Feature_0`, CAST(`ADS`.`Feature_1` AS DOUBLE) AS `Feature_1`, CAST(`ADS`.`Feature_2` AS DOUBLE) AS `Feature_2`, CAST(`ADS`.`Feature_3` AS DOUBLE) AS `Feature_3`, CAST(`ADS`.`TGT` AS DOUBLE) AS `TGT` 
FROM iris AS `ADS`), 
`SV_data_0_2` AS 
...
-- Code For temporary table TMP_20180516122655_CODEGEN_7GJWH5_KernAgg_B2 part 1. Create 


CREATE TEMPORARY TABLE `TMP_20180516122655_CODEGEN_7GJWH5_KernAgg_B2` (
	`KEY` BIGINT, 
	`OVO_Class1` BIGINT, 
	`OVO_Class2` BIGINT, 
	`OVO_Decision` BIGINT, 
...
-- Code For temporary table TMP_20180516122655_CODEGEN_7GJWH5_KernAgg_B2 part 2. Populate

INSERT INTO `TMP_20180516122655_CODEGEN_7GJWH5_KernAgg_B2` (`KEY`, `OVO_Class1`, `OVO_Class2`, `OVO_Decision`, `OVO_Confidence`) SELECT `U`.`KEY`, `U`.`OVO_Class1`, `U`.`OVO_Class2`, `U`.`OVO_Decision`, `U`.`OVO_Confidence` 
FROM (WITH kernel_input AS 
(SELECT `ADS`.`KEY` AS `KEY`, CAST(`ADS`.`Feature_0` AS DOUBLE) AS `Feature_0`, CAST(`ADS`.`Feature_1` AS DOUBLE) AS `Feature_1`, CAST(`ADS`.`Feature_2` AS DOUBLE) AS `Feature_2`, CAST(`ADS`.`Feature_3` AS DOUBLE) AS `Feature_3`, CAST(`ADS`.`TGT` AS DOUBLE) AS `TGT` 
FROM iris AS `ADS`), 
`SV_data_1_2` AS 
...
-- Code For temporary table TMP_20180516122655_CODEGEN_5WJC2H_KernAgg part 1. Create 


CREATE TEMPORARY TABLE `TMP_20180516122655_CODEGEN_5WJC2H_KernAgg` (
	`KEY` BIGINT NOT NULL, 
	`OVO_Vote_0` BIGINT, 
...
FROM `TMP_20180516122655_CODEGEN_QL0OZ2_KernAgg_B0` AS `KernAgg_B0` UNION ALL SELECT `KernAgg_B1`.`KEY` AS `KEY`, `KernAgg_B1`.`OVO_Class1` AS `OVO_Class1`, `KernAgg_B1`.`OVO_Class2` AS `OVO_Class2`, `KernAgg_B1`.`OVO_Decision` AS `OVO_Decision`, `KernAgg_B1`.`OVO_Confidence` AS `OVO_Confidence` 
FROM `TMP_20180516122655_CODEGEN_HNGM0G_KernAgg_B1` AS `KernAgg_B1` UNION ALL SELECT `KernAgg_B2`.`KEY` AS `KEY`, `KernAgg_B2`.`OVO_Class1` AS `OVO_Class1`, `KernAgg_B2`.`OVO_Class2` AS `OVO_Class2`, `KernAgg_B2`.`OVO_Decision` AS `OVO_Decision`, `KernAgg_B2`.`OVO_Confidence` AS `OVO_Confidence` 
FROM `TMP_20180516122655_CODEGEN_7GJWH5_KernAgg_B2` AS `KernAgg_B2`) AS `KernAgg_EnsembleUnion`), 
`OVO_Votes` AS 
...
-- Code For temporary table TMP_20180516122655_CODEGEN_5WJC2H_KernAgg part 3. Create Index 

CREATE INDEX `ix_TMP_20180516122655_CODEGEN_5WJC2H_KernAgg_KEY` ON `TMP_20180516122655_CODEGEN_5WJC2H_KernAgg` (`KEY`)
...
FROM `TMP_20180516122655_CODEGEN_5WJC2H_KernAgg` AS `KernAgg`), 
