...
-- Code For temporary table tmp_20180516122655_codegen_dlrnxs_kernagg_b0 part 1. Create 


CREATE TEMPORARY TABLE tmp_20180516122655_codegen_dlrnxs_kernagg_b0 (
	"KEY" BIGINT, 
	"OVO_Class1" BIGINT, 
	"OVO_Class2" BIGINT, 
	"OVO_Decision" BIGINT, 
...
-- Code For temporary table tmp_20180516122655_codegen_dlrnxs_kernagg_b0 part 2. Populate

INSERT INTO tmp_20180516122655_codegen_dlrnxs_kernagg_b0 ("KEY", "OVO_Class1", "OVO_Class2", "OVO_Decision", "OVO_Confidence") SELECT "U"."KEY", "U"."OVO_Class1", "U"."OVO_Class2", "U"."OVO_Decision", "U"."OVO_Confidence" 
...
-- Code For temporary table tmp_20180516122655_codegen_rh472a_kernagg_b1 part 1. Create 


CREATE TEMPORARY TABLE tmp_20180516122655_codegen_rh472a_kernagg_b1 (
	"KEY" BIGINT, 
	"OVO_Class1" BIGINT, 
	"OVO_Class2" BIGINT, 
	"OVO_Decision" BIGINT, 
...
-- Code For temporary table tmp_20180516122655_codegen_rh472a_kernagg_b1 part 2. Populate

INSERT INTO tmp_20180516122655_codegen_rh472a_kernagg_b1 ("KEY", "OVO_Class1", "OVO_Class2", "OVO_Decision", "OVO_Confidence") SELECT "U"."KEY", "U"."OVO_Class1", "U"."OVO_Class2", "U"."OVO_Decision", "U"."OVO_Confidence" 
FROM (WITH kernel_input AS 
(SELECT "ADS"."KEY" AS "KEY", CAST("ADS"."Feature_0" AS DOUBLE) AS "Feature_0", CAST("ADS"."Feature_1" AS DOUBLE) AS "Feature_1", CAST("ADS"."Feature_2" AS DOUBLE) AS "Feature_2", CAST("ADS"."Feature_3" AS DOUBLE) AS "Feature_3", CAST("ADS"."TGT" AS DOUBLE) AS "TGT" 
FROM iris AS "ADS"), 
"SV_data_0_2" AS 
...
-- Code For temporary table tmp_20180516122655_codegen_857yvj_kernagg_b2 part 1. Create 


CREATE TEMPORARY TABLE tmp_20180516122655_codegen_857yvj_kernagg_b2 (
	"KEY" BIGINT, 
	"OVO_Class1" BIGINT, 
	"OVO_Class2" BIGINT, 
	"OVO_Decision" BIGINT, 
...
-- Code For temporary table tmp_20180516122655_codegen_857yvj_kernagg_b2 part 2. Populate

INSERT INTO tmp_20180516122655_codegen_857yvj_kernagg_b2 ("KEY", "OVO_Class1", "OVO_Class2", "OVO_Decision", "OVO_Confidence") SELECT "U"."KEY", "U"."OVO_Class1", "U"."OVO_Class2", "U"."OVO_Decision", "U"."OVO_Confidence" 
FROM (WITH kernel_input AS 
(SELECT "ADS"."KEY" AS "KEY", CAST("ADS"."Feature_0" AS DOUBLE) AS "Feature_0", CAST("ADS"."Feature_1" AS DOUBLE) AS "Feature_1", CAST("ADS"."Feature_2" AS DOUBLE) AS "Feature_2", CAST("ADS"."Feature_3" AS DOUBLE) AS "Feature_3", CAST("ADS"."TGT" AS DOUBLE) AS "TGT" 
FROM iris AS "ADS"), 
"SV_data_1_2" AS 
...
-- Code For temporary table tmp_20180516122655_codegen_ibxqbk_kernagg part 1. Create 


CREATE TEMPORARY TABLE tmp_20180516122655_codegen_ibxqbk_kernagg (
	"KEY" BIGINT, 
	"OVO_Vote_0" BIGINT, 
...
-- Code For temporary table tmp_20180516122655_codegen_ibxqbk_kernagg part 2. Populate

INSERT INTO tmp_20180516122655_codegen_ibxqbk_kernagg ("KEY", "OVO_Vote_0", "OVO_SumConfidence_0", "OVO_Vote_1", "OVO_SumConfidence_1", "OVO_Vote_2", "OVO_SumConfidence_2", max_abs_confidence, "OVO_Scale", "Score_0", "Score_1", "Score_2") SELECT "U"."KEY", "U"."OVO_Vote_0", "U"."OVO_SumConfidence_0", "U"."OVO_Vote_1", "U"."OVO_SumConfidence_1", "U"."OVO_Vote_2", "U"."OVO_SumConfidence_2", "U".max_abs_confidence, "U"."OVO_Scale", "U"."Score_0", "U"."Score_1", "U"."Score_2" 
...
FROM tmp_20180516122655_codegen_dlrnxs_kernagg_b0 AS "KernAgg_B0" UNION ALL SELECT "KernAgg_B1"."KEY" AS "KEY", "KernAgg_B1"."OVO_Class1" AS "OVO_Class1", "KernAgg_B1"."OVO_Class2" AS "OVO_Class2", "KernAgg_B1"."OVO_Decision" AS "OVO_Decision", "KernAgg_B1"."OVO_Confidence" AS "OVO_Confidence" 
FROM tmp_20180516122655_codegen_rh472a_kernagg_b1 AS "KernAgg_B1" UNION ALL SELECT "KernAgg_B2"."KEY" AS "KEY", "KernAgg_B2"."OVO_Class1" AS "OVO_Class1", "KernAgg_B2"."OVO_Class2" AS "OVO_Class2", "KernAgg_B2"."OVO_Decision" AS "OVO_Decision", "KernAgg_B2"."OVO_Confidence" AS "OVO_Confidence" 
FROM tmp_20180516122655_codegen_857yvj_kernagg_b2 AS "KernAgg_B2") AS "KernAgg_EnsembleUnion"), 
"OVO_Votes" AS 
...
FROM tmp_20180516122655_codegen_ibxqbk_kernagg AS "KernAgg"), 
