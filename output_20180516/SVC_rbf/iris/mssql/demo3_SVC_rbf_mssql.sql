...
-- Code For temporary table ##TMP_20180516122655_CODEGEN_779JWA_KernAgg_B0 part 1. Create 


CREATE TABLE ##TMP_20180516122655_CODEGEN_779JWA_KernAgg_B0 (
	[KEY] BIGINT NULL, 
...
-- Code For temporary table ##TMP_20180516122655_CODEGEN_779JWA_KernAgg_B0 part 2. Populate
...
FROM (SELECT kernel_input.[KEY] AS [KEY], [SV_data_0_1].dual_coeff * exp(CASE WHEN (CASE WHEN (-100.0 <= -0.25 * (power(kernel_input.[Feature_0] - [SV_data_0_1].sv_0, 2) + power(kernel_input.[Feature_1] - [SV_data_0_1].sv_1, 2) + power(kernel_input.[Feature_2] - [SV_data_0_1].sv_2, 2) + power(kernel_input.[Feature_3] - [SV_data_0_1].sv_3, 2))) THEN -0.25 * (power(kernel_input.[Feature_0] - [SV_data_0_1].sv_0, 2) + power(kernel_input.[Feature_1] - [SV_data_0_1].sv_1, 2) + power(kernel_input.[Feature_2] - [SV_data_0_1].sv_2, 2) + power(kernel_input.[Feature_3] - [SV_data_0_1].sv_3, 2)) ELSE -100.0 END <= 100.0) THEN CASE WHEN (-100.0 <= -0.25 * (power(kernel_input.[Feature_0] - [SV_data_0_1].sv_0, 2) + power(kernel_input.[Feature_1] - [SV_data_0_1].sv_1, 2) + power(kernel_input.[Feature_2] - [SV_data_0_1].sv_2, 2) + power(kernel_input.[Feature_3] - [SV_data_0_1].sv_3, 2))) THEN -0.25 * (power(kernel_input.[Feature_0] - [SV_data_0_1].sv_0, 2) + power(kernel_input.[Feature_1] - [SV_data_0_1].sv_1, 2) + power(kernel_input.[Feature_2] - [SV_data_0_1].sv_2, 2) + power(kernel_input.[Feature_3] - [SV_data_0_1].sv_3, 2)) ELSE -100.0 END ELSE 100.0 END) AS dot_prod1 
FROM kernel_input, [SV_data_0_1]) AS full_join_data_sv GROUP BY full_join_data_sv.[KEY]) AS t), 
kernel_cte_0_1 AS 
(SELECT kernel_dp_0_1.[KEY] AS [KEY], 0 AS [OVO_Class1], 1 AS [OVO_Class2], CASE WHEN (-kernel_dp_0_1.dot_product >= 0.0) THEN 1 ELSE 0 END AS [OVO_Decision], coalesce(-kernel_dp_0_1.dot_product, 1.0 / (1.0 + exp(CASE WHEN (CASE WHEN (-100.0 <= -(-((-kernel_dp_0_1.dot_product) * -3.300126858232295 + 0.061958098453398024))) THEN -(-((-kernel_dp_0_1.dot_product) * -3.300126858232295 + 0.061958098453398024)) ELSE -100.0 END <= 100.0) THEN CASE WHEN (-100.0 <= -(-((-kernel_dp_0_1.dot_product) * -3.300126858232295 + 0.061958098453398024))) THEN -(-((-kernel_dp_0_1.dot_product) * -3.300126858232295 + 0.061958098453398024)) ELSE -100.0 END ELSE 100.0 END))) AS [OVO_Confidence] 
FROM kernel_dp_0_1)
 INSERT INTO ##TMP_20180516122655_CODEGEN_779JWA_KernAgg_B0 ([KEY], [OVO_Class1], [OVO_Class2], [OVO_Decision], [OVO_Confidence]) SELECT [KernAgg_B0].[KEY], [KernAgg_B0].[OVO_Class1], [KernAgg_B0].[OVO_Class2], [KernAgg_B0].[OVO_Decision], [KernAgg_B0].[OVO_Confidence] 
...
-- Code For temporary table ##TMP_20180516122655_CODEGEN_FXQ9M2_KernAgg_B1 part 1. Create 


CREATE TABLE ##TMP_20180516122655_CODEGEN_FXQ9M2_KernAgg_B1 (
	[KEY] BIGINT NULL, 
	[OVO_Class1] BIGINT NULL, 
	[OVO_Class2] BIGINT NULL, 
	[OVO_Decision] BIGINT NULL, 
...
-- Code For temporary table ##TMP_20180516122655_CODEGEN_FXQ9M2_KernAgg_B1 part 2. Populate
...
FROM (SELECT kernel_input.[KEY] AS [KEY], [SV_data_0_2].dual_coeff * exp(CASE WHEN (CASE WHEN (-100.0 <= -0.25 * (power(kernel_input.[Feature_0] - [SV_data_0_2].sv_0, 2) + power(kernel_input.[Feature_1] - [SV_data_0_2].sv_1, 2) + power(kernel_input.[Feature_2] - [SV_data_0_2].sv_2, 2) + power(kernel_input.[Feature_3] - [SV_data_0_2].sv_3, 2))) THEN -0.25 * (power(kernel_input.[Feature_0] - [SV_data_0_2].sv_0, 2) + power(kernel_input.[Feature_1] - [SV_data_0_2].sv_1, 2) + power(kernel_input.[Feature_2] - [SV_data_0_2].sv_2, 2) + power(kernel_input.[Feature_3] - [SV_data_0_2].sv_3, 2)) ELSE -100.0 END <= 100.0) THEN CASE WHEN (-100.0 <= -0.25 * (power(kernel_input.[Feature_0] - [SV_data_0_2].sv_0, 2) + power(kernel_input.[Feature_1] - [SV_data_0_2].sv_1, 2) + power(kernel_input.[Feature_2] - [SV_data_0_2].sv_2, 2) + power(kernel_input.[Feature_3] - [SV_data_0_2].sv_3, 2))) THEN -0.25 * (power(kernel_input.[Feature_0] - [SV_data_0_2].sv_0, 2) + power(kernel_input.[Feature_1] - [SV_data_0_2].sv_1, 2) + power(kernel_input.[Feature_2] - [SV_data_0_2].sv_2, 2) + power(kernel_input.[Feature_3] - [SV_data_0_2].sv_3, 2)) ELSE -100.0 END ELSE 100.0 END) AS dot_prod1 
FROM kernel_input, [SV_data_0_2]) AS full_join_data_sv_1 GROUP BY full_join_data_sv_1.[KEY]) AS t_1), 
kernel_cte_0_2 AS 
(SELECT kernel_dp_0_2.[KEY] AS [KEY], 0 AS [OVO_Class1], 2 AS [OVO_Class2], CASE WHEN (-kernel_dp_0_2.dot_product >= 0.0) THEN 1 ELSE 0 END AS [OVO_Decision], coalesce(-kernel_dp_0_2.dot_product, 1.0 / (1.0 + exp(CASE WHEN (CASE WHEN (-100.0 <= -(-((-kernel_dp_0_2.dot_product) * -3.5248309000457456 + 0.15296587557598648))) THEN -(-((-kernel_dp_0_2.dot_product) * -3.5248309000457456 + 0.15296587557598648)) ELSE -100.0 END <= 100.0) THEN CASE WHEN (-100.0 <= -(-((-kernel_dp_0_2.dot_product) * -3.5248309000457456 + 0.15296587557598648))) THEN -(-((-kernel_dp_0_2.dot_product) * -3.5248309000457456 + 0.15296587557598648)) ELSE -100.0 END ELSE 100.0 END))) AS [OVO_Confidence] 
FROM kernel_dp_0_2)
 INSERT INTO ##TMP_20180516122655_CODEGEN_FXQ9M2_KernAgg_B1 ([KEY], [OVO_Class1], [OVO_Class2], [OVO_Decision], [OVO_Confidence]) SELECT [KernAgg_B1].[KEY], [KernAgg_B1].[OVO_Class1], [KernAgg_B1].[OVO_Class2], [KernAgg_B1].[OVO_Decision], [KernAgg_B1].[OVO_Confidence] 
...
-- Code For temporary table ##TMP_20180516122655_CODEGEN_WGEYIK_KernAgg_B2 part 1. Create 


CREATE TABLE ##TMP_20180516122655_CODEGEN_WGEYIK_KernAgg_B2 (
	[KEY] BIGINT NULL, 
	[OVO_Class1] BIGINT NULL, 
	[OVO_Class2] BIGINT NULL, 
	[OVO_Decision] BIGINT NULL, 
...
-- Code For temporary table ##TMP_20180516122655_CODEGEN_WGEYIK_KernAgg_B2 part 2. Populate
...
FROM (SELECT kernel_input.[KEY] AS [KEY], [SV_data_1_2].dual_coeff * exp(CASE WHEN (CASE WHEN (-100.0 <= -0.25 * (power(kernel_input.[Feature_0] - [SV_data_1_2].sv_0, 2) + power(kernel_input.[Feature_1] - [SV_data_1_2].sv_1, 2) + power(kernel_input.[Feature_2] - [SV_data_1_2].sv_2, 2) + power(kernel_input.[Feature_3] - [SV_data_1_2].sv_3, 2))) THEN -0.25 * (power(kernel_input.[Feature_0] - [SV_data_1_2].sv_0, 2) + power(kernel_input.[Feature_1] - [SV_data_1_2].sv_1, 2) + power(kernel_input.[Feature_2] - [SV_data_1_2].sv_2, 2) + power(kernel_input.[Feature_3] - [SV_data_1_2].sv_3, 2)) ELSE -100.0 END <= 100.0) THEN CASE WHEN (-100.0 <= -0.25 * (power(kernel_input.[Feature_0] - [SV_data_1_2].sv_0, 2) + power(kernel_input.[Feature_1] - [SV_data_1_2].sv_1, 2) + power(kernel_input.[Feature_2] - [SV_data_1_2].sv_2, 2) + power(kernel_input.[Feature_3] - [SV_data_1_2].sv_3, 2))) THEN -0.25 * (power(kernel_input.[Feature_0] - [SV_data_1_2].sv_0, 2) + power(kernel_input.[Feature_1] - [SV_data_1_2].sv_1, 2) + power(kernel_input.[Feature_2] - [SV_data_1_2].sv_2, 2) + power(kernel_input.[Feature_3] - [SV_data_1_2].sv_3, 2)) ELSE -100.0 END ELSE 100.0 END) AS dot_prod1 
FROM kernel_input, [SV_data_1_2]) AS full_join_data_sv_2 GROUP BY full_join_data_sv_2.[KEY]) AS t_2), 
kernel_cte_1_2 AS 
(SELECT kernel_dp_1_2.[KEY] AS [KEY], 1 AS [OVO_Class1], 2 AS [OVO_Class2], CASE WHEN (-kernel_dp_1_2.dot_product >= 0.0) THEN 1 ELSE 0 END AS [OVO_Decision], coalesce(-kernel_dp_1_2.dot_product, 1.0 / (1.0 + exp(CASE WHEN (CASE WHEN (-100.0 <= -(-((-kernel_dp_1_2.dot_product) * -3.333770732591944 + 0.1292996798549987))) THEN -(-((-kernel_dp_1_2.dot_product) * -3.333770732591944 + 0.1292996798549987)) ELSE -100.0 END <= 100.0) THEN CASE WHEN (-100.0 <= -(-((-kernel_dp_1_2.dot_product) * -3.333770732591944 + 0.1292996798549987))) THEN -(-((-kernel_dp_1_2.dot_product) * -3.333770732591944 + 0.1292996798549987)) ELSE -100.0 END ELSE 100.0 END))) AS [OVO_Confidence] 
FROM kernel_dp_1_2)
 INSERT INTO ##TMP_20180516122655_CODEGEN_WGEYIK_KernAgg_B2 ([KEY], [OVO_Class1], [OVO_Class2], [OVO_Decision], [OVO_Confidence]) SELECT [KernAgg_B2].[KEY], [KernAgg_B2].[OVO_Class1], [KernAgg_B2].[OVO_Class2], [KernAgg_B2].[OVO_Decision], [KernAgg_B2].[OVO_Confidence] 
...
-- Code For temporary table ##TMP_20180516122655_CODEGEN_P20VG4_KernAgg part 1. Create 


CREATE TABLE ##TMP_20180516122655_CODEGEN_P20VG4_KernAgg (
	[KEY] BIGINT NULL, 
...
-- Code For temporary table ##TMP_20180516122655_CODEGEN_P20VG4_KernAgg part 2. Populate
...
FROM ##TMP_20180516122655_CODEGEN_779JWA_KernAgg_B0 AS [KernAgg_B0] UNION ALL SELECT [KernAgg_B1].[KEY] AS [KEY], [KernAgg_B1].[OVO_Class1] AS [OVO_Class1], [KernAgg_B1].[OVO_Class2] AS [OVO_Class2], [KernAgg_B1].[OVO_Decision] AS [OVO_Decision], [KernAgg_B1].[OVO_Confidence] AS [OVO_Confidence] 
FROM ##TMP_20180516122655_CODEGEN_FXQ9M2_KernAgg_B1 AS [KernAgg_B1] UNION ALL SELECT [KernAgg_B2].[KEY] AS [KEY], [KernAgg_B2].[OVO_Class1] AS [OVO_Class1], [KernAgg_B2].[OVO_Class2] AS [OVO_Class2], [KernAgg_B2].[OVO_Decision] AS [OVO_Decision], [KernAgg_B2].[OVO_Confidence] AS [OVO_Confidence] 
FROM ##TMP_20180516122655_CODEGEN_WGEYIK_KernAgg_B2 AS [KernAgg_B2]) AS [KernAgg_EnsembleUnion]), 
[OVO_Votes] AS 
...
FROM [OVO_Votes], [MinMaxConf])
 INSERT INTO ##TMP_20180516122655_CODEGEN_P20VG4_KernAgg ([KEY], [OVO_Vote_0], [OVO_SumConfidence_0], [OVO_Vote_1], [OVO_SumConfidence_1], [OVO_Vote_2], [OVO_SumConfidence_2], max_abs_confidence, [OVO_Scale], [Score_0], [Score_1], [Score_2]) SELECT [KernAgg].[KEY], [KernAgg].[OVO_Vote_0], [KernAgg].[OVO_SumConfidence_0], [KernAgg].[OVO_Vote_1], [KernAgg].[OVO_SumConfidence_1], [KernAgg].[OVO_Vote_2], [KernAgg].[OVO_SumConfidence_2], [KernAgg].max_abs_confidence, [KernAgg].[OVO_Scale], [KernAgg].[Score_0], [KernAgg].[Score_1], [KernAgg].[Score_2] 
...
FROM ##TMP_20180516122655_CODEGEN_P20VG4_KernAgg AS [KernAgg]), 
