...
-- Code For temporary table ##TMP_20180602153022_6XN_KernAgg_B0 part 1. Create 


CREATE TABLE ##TMP_20180602153022_6XN_KernAgg_B0 (
	[KEY] BIGINT NULL, 
...
-- Code For temporary table ##TMP_20180602153022_6XN_KernAgg_B0 part 2. Populate
...
FROM (SELECT full_join_data_sv.[KEY] AS [KEY], sum(CAST(full_join_data_sv.dot_prod1 AS FLOAT(53))) + -0.03811269428735201 AS dot_product 
FROM (SELECT kernel_input.[KEY] AS [KEY], [SV_data_0_1].dual_coeff * exp(CASE WHEN (CASE WHEN (-100.0 <= -0.25 * (power(CAST(kernel_input.[Feature_0] - [SV_data_0_1].sv_0 AS FLOAT(53)), 2) + power(CAST(kernel_input.[Feature_1] - [SV_data_0_1].sv_1 AS FLOAT(53)), 2) + power(CAST(kernel_input.[Feature_2] - [SV_data_0_1].sv_2 AS FLOAT(53)), 2) + power(CAST(kernel_input.[Feature_3] - [SV_data_0_1].sv_3 AS FLOAT(53)), 2))) THEN -0.25 * (power(CAST(kernel_input.[Feature_0] - [SV_data_0_1].sv_0 AS FLOAT(53)), 2) + power(CAST(kernel_input.[Feature_1] - [SV_data_0_1].sv_1 AS FLOAT(53)), 2) + power(CAST(kernel_input.[Feature_2] - [SV_data_0_1].sv_2 AS FLOAT(53)), 2) + power(CAST(kernel_input.[Feature_3] - [SV_data_0_1].sv_3 AS FLOAT(53)), 2)) ELSE -100.0 END <= 100.0) THEN CASE WHEN (-100.0 <= -0.25 * (power(CAST(kernel_input.[Feature_0] - [SV_data_0_1].sv_0 AS FLOAT(53)), 2) + power(CAST(kernel_input.[Feature_1] - [SV_data_0_1].sv_1 AS FLOAT(53)), 2) + power(CAST(kernel_input.[Feature_2] - [SV_data_0_1].sv_2 AS FLOAT(53)), 2) + power(CAST(kernel_input.[Feature_3] - [SV_data_0_1].sv_3 AS FLOAT(53)), 2))) THEN -0.25 * (power(CAST(kernel_input.[Feature_0] - [SV_data_0_1].sv_0 AS FLOAT(53)), 2) + power(CAST(kernel_input.[Feature_1] - [SV_data_0_1].sv_1 AS FLOAT(53)), 2) + power(CAST(kernel_input.[Feature_2] - [SV_data_0_1].sv_2 AS FLOAT(53)), 2) + power(CAST(kernel_input.[Feature_3] - [SV_data_0_1].sv_3 AS FLOAT(53)), 2)) ELSE -100.0 END ELSE 100.0 END) AS dot_prod1 
FROM kernel_input, [SV_data_0_1]) AS full_join_data_sv GROUP BY full_join_data_sv.[KEY]) AS t), 
kernel_cte_0_1 AS 
(SELECT kernel_dp_0_1.[KEY] AS [KEY], 0 AS [OVO_Class1], 1 AS [OVO_Class2], CASE WHEN (-kernel_dp_0_1.dot_product >= 0.0) THEN 1 ELSE 0 END AS [OVO_Decision], coalesce(-kernel_dp_0_1.dot_product, 1.0 / (1.0 + exp(CASE WHEN (CASE WHEN (-100.0 <= -(-((-kernel_dp_0_1.dot_product) * -3.3041359049607313 + 0.054020773681534004))) THEN -(-((-kernel_dp_0_1.dot_product) * -3.3041359049607313 + 0.054020773681534004)) ELSE -100.0 END <= 100.0) THEN CASE WHEN (-100.0 <= -(-((-kernel_dp_0_1.dot_product) * -3.3041359049607313 + 0.054020773681534004))) THEN -(-((-kernel_dp_0_1.dot_product) * -3.3041359049607313 + 0.054020773681534004)) ELSE -100.0 END ELSE 100.0 END))) AS [OVO_Conf] 
FROM kernel_dp_0_1)
 INSERT INTO ##TMP_20180602153022_6XN_KernAgg_B0 ([KEY], [OVO_Class1], [OVO_Class2], [OVO_Decision], [OVO_Conf]) SELECT [KernAgg_B0].[KEY], [KernAgg_B0].[OVO_Class1], [KernAgg_B0].[OVO_Class2], [KernAgg_B0].[OVO_Decision], [KernAgg_B0].[OVO_Conf] 
...
-- Code For temporary table ##TMP_20180602153022_PMV_KernAgg_B1 part 1. Create 


CREATE TABLE ##TMP_20180602153022_PMV_KernAgg_B1 (
	[KEY] BIGINT NULL, 
	[OVO_Class1] BIGINT NULL, 
	[OVO_Class2] BIGINT NULL, 
	[OVO_Decision] BIGINT NULL, 
...
-- Code For temporary table ##TMP_20180602153022_PMV_KernAgg_B1 part 2. Populate
...
FROM (SELECT full_join_data_sv_1.[KEY] AS [KEY], sum(CAST(full_join_data_sv_1.dot_prod1 AS FLOAT(53))) + -0.16779169441679273 AS dot_product 
FROM (SELECT kernel_input.[KEY] AS [KEY], [SV_data_0_2].dual_coeff * exp(CASE WHEN (CASE WHEN (-100.0 <= -0.25 * (power(CAST(kernel_input.[Feature_0] - [SV_data_0_2].sv_0 AS FLOAT(53)), 2) + power(CAST(kernel_input.[Feature_1] - [SV_data_0_2].sv_1 AS FLOAT(53)), 2) + power(CAST(kernel_input.[Feature_2] - [SV_data_0_2].sv_2 AS FLOAT(53)), 2) + power(CAST(kernel_input.[Feature_3] - [SV_data_0_2].sv_3 AS FLOAT(53)), 2))) THEN -0.25 * (power(CAST(kernel_input.[Feature_0] - [SV_data_0_2].sv_0 AS FLOAT(53)), 2) + power(CAST(kernel_input.[Feature_1] - [SV_data_0_2].sv_1 AS FLOAT(53)), 2) + power(CAST(kernel_input.[Feature_2] - [SV_data_0_2].sv_2 AS FLOAT(53)), 2) + power(CAST(kernel_input.[Feature_3] - [SV_data_0_2].sv_3 AS FLOAT(53)), 2)) ELSE -100.0 END <= 100.0) THEN CASE WHEN (-100.0 <= -0.25 * (power(CAST(kernel_input.[Feature_0] - [SV_data_0_2].sv_0 AS FLOAT(53)), 2) + power(CAST(kernel_input.[Feature_1] - [SV_data_0_2].sv_1 AS FLOAT(53)), 2) + power(CAST(kernel_input.[Feature_2] - [SV_data_0_2].sv_2 AS FLOAT(53)), 2) + power(CAST(kernel_input.[Feature_3] - [SV_data_0_2].sv_3 AS FLOAT(53)), 2))) THEN -0.25 * (power(CAST(kernel_input.[Feature_0] - [SV_data_0_2].sv_0 AS FLOAT(53)), 2) + power(CAST(kernel_input.[Feature_1] - [SV_data_0_2].sv_1 AS FLOAT(53)), 2) + power(CAST(kernel_input.[Feature_2] - [SV_data_0_2].sv_2 AS FLOAT(53)), 2) + power(CAST(kernel_input.[Feature_3] - [SV_data_0_2].sv_3 AS FLOAT(53)), 2)) ELSE -100.0 END ELSE 100.0 END) AS dot_prod1 
FROM kernel_input, [SV_data_0_2]) AS full_join_data_sv_1 GROUP BY full_join_data_sv_1.[KEY]) AS t_1), 
kernel_cte_0_2 AS 
(SELECT kernel_dp_0_2.[KEY] AS [KEY], 0 AS [OVO_Class1], 2 AS [OVO_Class2], CASE WHEN (-kernel_dp_0_2.dot_product >= 0.0) THEN 1 ELSE 0 END AS [OVO_Decision], coalesce(-kernel_dp_0_2.dot_product, 1.0 / (1.0 + exp(CASE WHEN (CASE WHEN (-100.0 <= -(-((-kernel_dp_0_2.dot_product) * -3.5244234461040014 + 0.15031236456534414))) THEN -(-((-kernel_dp_0_2.dot_product) * -3.5244234461040014 + 0.15031236456534414)) ELSE -100.0 END <= 100.0) THEN CASE WHEN (-100.0 <= -(-((-kernel_dp_0_2.dot_product) * -3.5244234461040014 + 0.15031236456534414))) THEN -(-((-kernel_dp_0_2.dot_product) * -3.5244234461040014 + 0.15031236456534414)) ELSE -100.0 END ELSE 100.0 END))) AS [OVO_Conf] 
FROM kernel_dp_0_2)
 INSERT INTO ##TMP_20180602153022_PMV_KernAgg_B1 ([KEY], [OVO_Class1], [OVO_Class2], [OVO_Decision], [OVO_Conf]) SELECT [KernAgg_B1].[KEY], [KernAgg_B1].[OVO_Class1], [KernAgg_B1].[OVO_Class2], [KernAgg_B1].[OVO_Decision], [KernAgg_B1].[OVO_Conf] 
...
-- Code For temporary table ##TMP_20180602153022_L62_KernAgg_B2 part 1. Create 


CREATE TABLE ##TMP_20180602153022_L62_KernAgg_B2 (
	[KEY] BIGINT NULL, 
	[OVO_Class1] BIGINT NULL, 
	[OVO_Class2] BIGINT NULL, 
	[OVO_Decision] BIGINT NULL, 
...
-- Code For temporary table ##TMP_20180602153022_L62_KernAgg_B2 part 2. Populate
...
FROM (SELECT full_join_data_sv_2.[KEY] AS [KEY], sum(CAST(full_join_data_sv_2.dot_prod1 AS FLOAT(53))) + -0.12998158283503197 AS dot_product 
FROM (SELECT kernel_input.[KEY] AS [KEY], [SV_data_1_2].dual_coeff * exp(CASE WHEN (CASE WHEN (-100.0 <= -0.25 * (power(CAST(kernel_input.[Feature_0] - [SV_data_1_2].sv_0 AS FLOAT(53)), 2) + power(CAST(kernel_input.[Feature_1] - [SV_data_1_2].sv_1 AS FLOAT(53)), 2) + power(CAST(kernel_input.[Feature_2] - [SV_data_1_2].sv_2 AS FLOAT(53)), 2) + power(CAST(kernel_input.[Feature_3] - [SV_data_1_2].sv_3 AS FLOAT(53)), 2))) THEN -0.25 * (power(CAST(kernel_input.[Feature_0] - [SV_data_1_2].sv_0 AS FLOAT(53)), 2) + power(CAST(kernel_input.[Feature_1] - [SV_data_1_2].sv_1 AS FLOAT(53)), 2) + power(CAST(kernel_input.[Feature_2] - [SV_data_1_2].sv_2 AS FLOAT(53)), 2) + power(CAST(kernel_input.[Feature_3] - [SV_data_1_2].sv_3 AS FLOAT(53)), 2)) ELSE -100.0 END <= 100.0) THEN CASE WHEN (-100.0 <= -0.25 * (power(CAST(kernel_input.[Feature_0] - [SV_data_1_2].sv_0 AS FLOAT(53)), 2) + power(CAST(kernel_input.[Feature_1] - [SV_data_1_2].sv_1 AS FLOAT(53)), 2) + power(CAST(kernel_input.[Feature_2] - [SV_data_1_2].sv_2 AS FLOAT(53)), 2) + power(CAST(kernel_input.[Feature_3] - [SV_data_1_2].sv_3 AS FLOAT(53)), 2))) THEN -0.25 * (power(CAST(kernel_input.[Feature_0] - [SV_data_1_2].sv_0 AS FLOAT(53)), 2) + power(CAST(kernel_input.[Feature_1] - [SV_data_1_2].sv_1 AS FLOAT(53)), 2) + power(CAST(kernel_input.[Feature_2] - [SV_data_1_2].sv_2 AS FLOAT(53)), 2) + power(CAST(kernel_input.[Feature_3] - [SV_data_1_2].sv_3 AS FLOAT(53)), 2)) ELSE -100.0 END ELSE 100.0 END) AS dot_prod1 
FROM kernel_input, [SV_data_1_2]) AS full_join_data_sv_2 GROUP BY full_join_data_sv_2.[KEY]) AS t_2), 
kernel_cte_1_2 AS 
(SELECT kernel_dp_1_2.[KEY] AS [KEY], 1 AS [OVO_Class1], 2 AS [OVO_Class2], CASE WHEN (-kernel_dp_1_2.dot_product >= 0.0) THEN 1 ELSE 0 END AS [OVO_Decision], coalesce(-kernel_dp_1_2.dot_product, 1.0 / (1.0 + exp(CASE WHEN (CASE WHEN (-100.0 <= -(-((-kernel_dp_1_2.dot_product) * -3.383328758242092 + 0.09415345653595314))) THEN -(-((-kernel_dp_1_2.dot_product) * -3.383328758242092 + 0.09415345653595314)) ELSE -100.0 END <= 100.0) THEN CASE WHEN (-100.0 <= -(-((-kernel_dp_1_2.dot_product) * -3.383328758242092 + 0.09415345653595314))) THEN -(-((-kernel_dp_1_2.dot_product) * -3.383328758242092 + 0.09415345653595314)) ELSE -100.0 END ELSE 100.0 END))) AS [OVO_Conf] 
FROM kernel_dp_1_2)
 INSERT INTO ##TMP_20180602153022_L62_KernAgg_B2 ([KEY], [OVO_Class1], [OVO_Class2], [OVO_Decision], [OVO_Conf]) SELECT [KernAgg_B2].[KEY], [KernAgg_B2].[OVO_Class1], [KernAgg_B2].[OVO_Class2], [KernAgg_B2].[OVO_Decision], [KernAgg_B2].[OVO_Conf] 
...
-- Code For temporary table ##TMP_20180602153022_QKX_KernAgg_agg part 1. Create 


CREATE TABLE ##TMP_20180602153022_QKX_KernAgg_agg (
	[KEY] BIGINT NULL, 
...
-- Code For temporary table ##TMP_20180602153022_QKX_KernAgg_agg part 2. Populate
...
FROM ##TMP_20180602153022_6XN_KernAgg_B0 AS [KernAgg_B0] UNION ALL SELECT [KernAgg_B1].[KEY] AS [KEY], [KernAgg_B1].[OVO_Class1] AS [OVO_Class1], [KernAgg_B1].[OVO_Class2] AS [OVO_Class2], [KernAgg_B1].[OVO_Decision] AS [OVO_Decision], [KernAgg_B1].[OVO_Conf] AS [OVO_Conf] 
FROM ##TMP_20180602153022_PMV_KernAgg_B1 AS [KernAgg_B1] UNION ALL SELECT [KernAgg_B2].[KEY] AS [KEY], [KernAgg_B2].[OVO_Class1] AS [OVO_Class1], [KernAgg_B2].[OVO_Class2] AS [OVO_Class2], [KernAgg_B2].[OVO_Decision] AS [OVO_Decision], [KernAgg_B2].[OVO_Conf] AS [OVO_Conf] 
FROM ##TMP_20180602153022_L62_KernAgg_B2 AS [KernAgg_B2]) AS [KernAgg_EnsembleUnion]), 
[OVO_Votes] AS 
...
FROM ##TMP_20180602153022_QKX_KernAgg_agg AS [KernAgg_agg]), 
