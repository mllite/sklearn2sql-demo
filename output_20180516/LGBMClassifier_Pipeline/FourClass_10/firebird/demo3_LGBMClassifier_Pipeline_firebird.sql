...
-- Code For temporary table TMP_20180508181304_CODEGEN_DBGY part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508181304_CODEGEN_DBGY" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20180508181304_CODEGEN_DBGY part 2. Populate

INSERT INTO "TMP_20180508181304_CODEGEN_DBGY" ("KEY", impter_2, impter_3, impter_4, impter_5, impter_6, impter_7, impter_8, impter_9, impter_10, impter_11) SELECT "U"."KEY", "U".impter_2, "U".impter_3, "U".impter_4, "U".impter_5, "U".impter_6, "U".impter_7, "U".impter_8, "U".impter_9, "U".impter_10, "U".impter_11 
...
-- Code For temporary table TMP_20180508181304_CODEGEN_DBGY part 3. Create Index 

CREATE INDEX "ix_TMP_20180508181304_C_2149" ON "TMP_20180508181304_CODEGEN_DBGY" ("KEY")

-- Code For temporary table TMP_20180508181304_CODEGEN_NU15 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508181304_CODEGEN_NU15" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20180508181304_CODEGEN_NU15 part 2. Populate

INSERT INTO "TMP_20180508181304_CODEGEN_NU15" ("KEY", scaler_2, scaler_3, scaler_4, scaler_5, scaler_6, scaler_7, scaler_8, scaler_9, scaler_10, scaler_11) SELECT "U"."KEY", "U".scaler_2, "U".scaler_3, "U".scaler_4, "U".scaler_5, "U".scaler_6, "U".scaler_7, "U".scaler_8, "U".scaler_9, "U".scaler_10, "U".scaler_11 
...
FROM "TMP_20180508181304_CODEGEN_DBGY" AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT") AS "U"

-- Code For temporary table TMP_20180508181304_CODEGEN_NU15 part 3. Create Index 

CREATE INDEX "ix_TMP_20180508181304_C_0a01" ON "TMP_20180508181304_CODEGEN_NU15" ("KEY")

-- Code For temporary table TMP_20180508181304_CODEGEN_653R part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508181304_CODEGEN_653R" (
	"KEY" BIGINT, 
...
-- Code For temporary table TMP_20180508181304_CODEGEN_653R part 2. Populate

INSERT INTO "TMP_20180508181304_CODEGEN_653R" ("KEY", "Score_0", "Score_1", "Score_2", "Score_3") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1", "U"."Score_2", "U"."Score_3" 
...
FROM "TMP_20180508181304_CODEGEN_NU15" AS "ADS_sca_2_OUT"), 
"DT_node_data" AS 
...
-- Code For temporary table TMP_20180508181304_CODEGEN_ORL6 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508181304_CODEGEN_ORL6" (
	"KEY" BIGINT, 
	"Score_0" DOUBLE PRECISION, 
	"Score_1" DOUBLE PRECISION, 
	"Score_2" DOUBLE PRECISION, 
...
-- Code For temporary table TMP_20180508181304_CODEGEN_ORL6 part 2. Populate

INSERT INTO "TMP_20180508181304_CODEGEN_ORL6" ("KEY", "Score_0", "Score_1", "Score_2", "Score_3") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1", "U"."Score_2", "U"."Score_3" 
...
-- Code For temporary table TMP_20180508181304_CODEGEN_8KGE part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508181304_CODEGEN_8KGE" (
	"KEY" BIGINT, 
	"Score_0" DOUBLE PRECISION, 
	"Score_1" DOUBLE PRECISION, 
	"Score_2" DOUBLE PRECISION, 
...
-- Code For temporary table TMP_20180508181304_CODEGEN_8KGE part 2. Populate

INSERT INTO "TMP_20180508181304_CODEGEN_8KGE" ("KEY", "Score_0", "Score_1", "Score_2", "Score_3") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1", "U"."Score_2", "U"."Score_3" 
...
-- Code For temporary table TMP_20180508181304_CODEGEN_OL9J part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508181304_CODEGEN_OL9J" (
	"KEY" BIGINT, 
	"Score_0" DOUBLE PRECISION, 
	"Score_1" DOUBLE PRECISION, 
	"Score_2" DOUBLE PRECISION, 
...
-- Code For temporary table TMP_20180508181304_CODEGEN_OL9J part 2. Populate

INSERT INTO "TMP_20180508181304_CODEGEN_OL9J" ("KEY", "Score_0", "Score_1", "Score_2", "Score_3") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1", "U"."Score_2", "U"."Score_3" 
...
-- Code For temporary table TMP_20180508181304_CODEGEN_XFG1 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508181304_CODEGEN_XFG1" (
	"KEY" BIGINT, 
	"Score_0" DOUBLE PRECISION, 
	"Score_1" DOUBLE PRECISION, 
	"Score_2" DOUBLE PRECISION, 
...
-- Code For temporary table TMP_20180508181304_CODEGEN_XFG1 part 2. Populate

INSERT INTO "TMP_20180508181304_CODEGEN_XFG1" ("KEY", "Score_0", "Score_1", "Score_2", "Score_3") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1", "U"."Score_2", "U"."Score_3" 
...
-- Code For temporary table TMP_20180508181304_CODEGEN_S2XO part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508181304_CODEGEN_S2XO" (
	"KEY" BIGINT, 
	"Score_0" DOUBLE PRECISION, 
	"Score_1" DOUBLE PRECISION, 
	"Score_2" DOUBLE PRECISION, 
...
-- Code For temporary table TMP_20180508181304_CODEGEN_S2XO part 2. Populate

INSERT INTO "TMP_20180508181304_CODEGEN_S2XO" ("KEY", "Score_0", "Score_1", "Score_2", "Score_3") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1", "U"."Score_2", "U"."Score_3" 
...
-- Code For temporary table TMP_20180508181304_CODEGEN_74V6 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508181304_CODEGEN_74V6" (
	"KEY" BIGINT, 
	"Score_0" DOUBLE PRECISION, 
	"Score_1" DOUBLE PRECISION, 
	"Score_2" DOUBLE PRECISION, 
...
-- Code For temporary table TMP_20180508181304_CODEGEN_74V6 part 2. Populate

INSERT INTO "TMP_20180508181304_CODEGEN_74V6" ("KEY", "Score_0", "Score_1", "Score_2", "Score_3") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1", "U"."Score_2", "U"."Score_3" 
...
-- Code For temporary table TMP_20180508181304_CODEGEN_RSLT part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508181304_CODEGEN_RSLT" (
	"KEY" BIGINT, 
	"Score_0" DOUBLE PRECISION, 
	"Score_1" DOUBLE PRECISION, 
	"Score_2" DOUBLE PRECISION, 
...
-- Code For temporary table TMP_20180508181304_CODEGEN_RSLT part 2. Populate

INSERT INTO "TMP_20180508181304_CODEGEN_RSLT" ("KEY", "Score_0", "Score_1", "Score_2", "Score_3") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1", "U"."Score_2", "U"."Score_3" 
...
FROM "TMP_20180508181304_CODEGEN_653R" AS "LGBM_B0" UNION ALL SELECT "LGBM_B1"."KEY" AS "KEY", "LGBM_B1"."Score_0" AS "Score_0", "LGBM_B1"."Score_1" AS "Score_1", "LGBM_B1"."Score_2" AS "Score_2", "LGBM_B1"."Score_3" AS "Score_3" 
FROM "TMP_20180508181304_CODEGEN_ORL6" AS "LGBM_B1" UNION ALL SELECT "LGBM_B2"."KEY" AS "KEY", "LGBM_B2"."Score_0" AS "Score_0", "LGBM_B2"."Score_1" AS "Score_1", "LGBM_B2"."Score_2" AS "Score_2", "LGBM_B2"."Score_3" AS "Score_3" 
FROM "TMP_20180508181304_CODEGEN_8KGE" AS "LGBM_B2" UNION ALL SELECT "LGBM_B3"."KEY" AS "KEY", "LGBM_B3"."Score_0" AS "Score_0", "LGBM_B3"."Score_1" AS "Score_1", "LGBM_B3"."Score_2" AS "Score_2", "LGBM_B3"."Score_3" AS "Score_3" 
FROM "TMP_20180508181304_CODEGEN_OL9J" AS "LGBM_B3" UNION ALL SELECT "LGBM_B4"."KEY" AS "KEY", "LGBM_B4"."Score_0" AS "Score_0", "LGBM_B4"."Score_1" AS "Score_1", "LGBM_B4"."Score_2" AS "Score_2", "LGBM_B4"."Score_3" AS "Score_3" 
FROM "TMP_20180508181304_CODEGEN_XFG1" AS "LGBM_B4" UNION ALL SELECT "LGBM_B5"."KEY" AS "KEY", "LGBM_B5"."Score_0" AS "Score_0", "LGBM_B5"."Score_1" AS "Score_1", "LGBM_B5"."Score_2" AS "Score_2", "LGBM_B5"."Score_3" AS "Score_3" 
FROM "TMP_20180508181304_CODEGEN_S2XO" AS "LGBM_B5" UNION ALL SELECT "LGBM_B6"."KEY" AS "KEY", "LGBM_B6"."Score_0" AS "Score_0", "LGBM_B6"."Score_1" AS "Score_1", "LGBM_B6"."Score_2" AS "Score_2", "LGBM_B6"."Score_3" AS "Score_3" 
FROM "TMP_20180508181304_CODEGEN_74V6" AS "LGBM_B6") AS "LGBM_EnsembleUnion") AS "LGBM_Union") AS "U"

-- Code For temporary table TMP_20180508181304_CODEGEN_0ATL part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508181304_CODEGEN_0ATL" (
	"KEY" BIGINT NOT NULL, 
	"Score_0" DOUBLE PRECISION, 
	"Score_1" DOUBLE PRECISION, 
	"Score_2" DOUBLE PRECISION, 
...
-- Code For temporary table TMP_20180508181304_CODEGEN_0ATL part 2. Populate

INSERT INTO "TMP_20180508181304_CODEGEN_0ATL" ("KEY", "Score_0", "Score_1", "Score_2", "Score_3") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1", "U"."Score_2", "U"."Score_3" 
...
FROM "TMP_20180508181304_CODEGEN_RSLT" AS "LGBM_Union" GROUP BY "LGBM_Union"."KEY") AS "T") AS "LGBM_sum") AS "U"

-- Code For temporary table TMP_20180508181304_CODEGEN_0ATL part 3. Create Index 

CREATE INDEX "ix_TMP_20180508181304_C_1ed9" ON "TMP_20180508181304_CODEGEN_0ATL" ("KEY")
...
FROM "TMP_20180508181304_CODEGEN_0ATL" AS "LGBM_sum"), 
