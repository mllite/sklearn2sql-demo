...
-- Code For temporary table TMP_20180516112404_CODEGEN_DA27TC_ADS_imp_1_OUT part 1. Create 


CREATE TEMPORARY TABLE "TMP_20180516112404_CODEGEN_DA27TC_ADS_imp_1_OUT" (
	"KEY" BIGINT NOT NULL, 
	impter_2 FLOAT, 
	impter_3 FLOAT, 
	impter_4 FLOAT, 
...
-- Code For temporary table TMP_20180516112404_CODEGEN_DA27TC_ADS_imp_1_OUT part 2. Populate

INSERT INTO "TMP_20180516112404_CODEGEN_DA27TC_ADS_imp_1_OUT" ("KEY", impter_2, impter_3, impter_4, impter_5, impter_6, impter_7, impter_8, impter_9, impter_10, impter_11) SELECT "ADS_imp_1_OUT"."KEY", "ADS_imp_1_OUT".impter_2, "ADS_imp_1_OUT".impter_3, "ADS_imp_1_OUT".impter_4, "ADS_imp_1_OUT".impter_5, "ADS_imp_1_OUT".impter_6, "ADS_imp_1_OUT".impter_7, "ADS_imp_1_OUT".impter_8, "ADS_imp_1_OUT".impter_9, "ADS_imp_1_OUT".impter_10, "ADS_imp_1_OUT".impter_11 
...
-- Code For temporary table TMP_20180516112404_CODEGEN_DA27TC_ADS_imp_1_OUT part 3. Create Index 

CREATE INDEX "ix_TMP_20180516112404_CODEGEN_DA27TC_ADS_imp_1_OUT_KEY" ON "TMP_20180516112404_CODEGEN_DA27TC_ADS_imp_1_OUT" ("KEY")

-- Code For temporary table TMP_20180516112404_CODEGEN_JACDHH_ADS_sca_2_OUT part 1. Create 


CREATE TEMPORARY TABLE "TMP_20180516112404_CODEGEN_JACDHH_ADS_sca_2_OUT" (
	"KEY" BIGINT NOT NULL, 
	scaler_2 FLOAT, 
	scaler_3 FLOAT, 
	scaler_4 FLOAT, 
...
-- Code For temporary table TMP_20180516112404_CODEGEN_JACDHH_ADS_sca_2_OUT part 2. Populate

INSERT INTO "TMP_20180516112404_CODEGEN_JACDHH_ADS_sca_2_OUT" ("KEY", scaler_2, scaler_3, scaler_4, scaler_5, scaler_6, scaler_7, scaler_8, scaler_9, scaler_10, scaler_11) SELECT "ADS_sca_2_OUT"."KEY", "ADS_sca_2_OUT".scaler_2, "ADS_sca_2_OUT".scaler_3, "ADS_sca_2_OUT".scaler_4, "ADS_sca_2_OUT".scaler_5, "ADS_sca_2_OUT".scaler_6, "ADS_sca_2_OUT".scaler_7, "ADS_sca_2_OUT".scaler_8, "ADS_sca_2_OUT".scaler_9, "ADS_sca_2_OUT".scaler_10, "ADS_sca_2_OUT".scaler_11 
...
FROM "TMP_20180516112404_CODEGEN_DA27TC_ADS_imp_1_OUT" AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT"

-- Code For temporary table TMP_20180516112404_CODEGEN_JACDHH_ADS_sca_2_OUT part 3. Create Index 

CREATE INDEX "ix_TMP_20180516112404_CODEGEN_JACDHH_ADS_sca_2_OUT_KEY" ON "TMP_20180516112404_CODEGEN_JACDHH_ADS_sca_2_OUT" ("KEY")

-- Code For temporary table TMP_20180516112405_CODEGEN_XDYBR9_LGBM_B0 part 1. Create 


CREATE TEMPORARY TABLE "TMP_20180516112405_CODEGEN_XDYBR9_LGBM_B0" (
	"KEY" BIGINT, 
	"Score_0" FLOAT, 
	"Score_1" FLOAT, 
	"Score_2" FLOAT, 
...
-- Code For temporary table TMP_20180516112405_CODEGEN_XDYBR9_LGBM_B0 part 2. Populate
...
FROM "TMP_20180516112404_CODEGEN_JACDHH_ADS_sca_2_OUT" AS "ADS_sca_2_OUT"), 
"DT_node_data" AS 
...
FROM "DT_Output_9")
 INSERT INTO "TMP_20180516112405_CODEGEN_XDYBR9_LGBM_B0" ("KEY", "Score_0", "Score_1", "Score_2", "Score_3") SELECT "LGBM_B0"."KEY", "LGBM_B0"."Score_0", "LGBM_B0"."Score_1", "LGBM_B0"."Score_2", "LGBM_B0"."Score_3" 
...
-- Code For temporary table TMP_20180516112405_CODEGEN_H52FCZ_LGBM_B1 part 1. Create 


CREATE TEMPORARY TABLE "TMP_20180516112405_CODEGEN_H52FCZ_LGBM_B1" (
	"KEY" BIGINT, 
	"Score_0" FLOAT, 
	"Score_1" FLOAT, 
	"Score_2" FLOAT, 
...
-- Code For temporary table TMP_20180516112405_CODEGEN_H52FCZ_LGBM_B1 part 2. Populate
...
FROM "DT_Output_19")
 INSERT INTO "TMP_20180516112405_CODEGEN_H52FCZ_LGBM_B1" ("KEY", "Score_0", "Score_1", "Score_2", "Score_3") SELECT "LGBM_B1"."KEY", "LGBM_B1"."Score_0", "LGBM_B1"."Score_1", "LGBM_B1"."Score_2", "LGBM_B1"."Score_3" 
...
-- Code For temporary table TMP_20180516112405_CODEGEN_QBEPT8_LGBM_B2 part 1. Create 


CREATE TEMPORARY TABLE "TMP_20180516112405_CODEGEN_QBEPT8_LGBM_B2" (
	"KEY" BIGINT, 
	"Score_0" FLOAT, 
	"Score_1" FLOAT, 
	"Score_2" FLOAT, 
...
-- Code For temporary table TMP_20180516112405_CODEGEN_QBEPT8_LGBM_B2 part 2. Populate
...
FROM "DT_Output_29")
 INSERT INTO "TMP_20180516112405_CODEGEN_QBEPT8_LGBM_B2" ("KEY", "Score_0", "Score_1", "Score_2", "Score_3") SELECT "LGBM_B2"."KEY", "LGBM_B2"."Score_0", "LGBM_B2"."Score_1", "LGBM_B2"."Score_2", "LGBM_B2"."Score_3" 
...
-- Code For temporary table TMP_20180516112405_CODEGEN_BR718Y_LGBM_B3 part 1. Create 


CREATE TEMPORARY TABLE "TMP_20180516112405_CODEGEN_BR718Y_LGBM_B3" (
	"KEY" BIGINT, 
	"Score_0" FLOAT, 
	"Score_1" FLOAT, 
	"Score_2" FLOAT, 
...
-- Code For temporary table TMP_20180516112405_CODEGEN_BR718Y_LGBM_B3 part 2. Populate
...
FROM "DT_Output_39")
 INSERT INTO "TMP_20180516112405_CODEGEN_BR718Y_LGBM_B3" ("KEY", "Score_0", "Score_1", "Score_2", "Score_3") SELECT "LGBM_B3"."KEY", "LGBM_B3"."Score_0", "LGBM_B3"."Score_1", "LGBM_B3"."Score_2", "LGBM_B3"."Score_3" 
...
-- Code For temporary table TMP_20180516112405_CODEGEN_L9TSO6_LGBM_B4 part 1. Create 


CREATE TEMPORARY TABLE "TMP_20180516112405_CODEGEN_L9TSO6_LGBM_B4" (
	"KEY" BIGINT, 
	"Score_0" FLOAT, 
	"Score_1" FLOAT, 
	"Score_2" FLOAT, 
...
-- Code For temporary table TMP_20180516112405_CODEGEN_L9TSO6_LGBM_B4 part 2. Populate
...
FROM "DT_Output_49")
 INSERT INTO "TMP_20180516112405_CODEGEN_L9TSO6_LGBM_B4" ("KEY", "Score_0", "Score_1", "Score_2", "Score_3") SELECT "LGBM_B4"."KEY", "LGBM_B4"."Score_0", "LGBM_B4"."Score_1", "LGBM_B4"."Score_2", "LGBM_B4"."Score_3" 
...
-- Code For temporary table TMP_20180516112405_CODEGEN_O2V2LN_LGBM_B5 part 1. Create 


CREATE TEMPORARY TABLE "TMP_20180516112405_CODEGEN_O2V2LN_LGBM_B5" (
	"KEY" BIGINT, 
	"Score_0" FLOAT, 
	"Score_1" FLOAT, 
	"Score_2" FLOAT, 
...
-- Code For temporary table TMP_20180516112405_CODEGEN_O2V2LN_LGBM_B5 part 2. Populate
...
FROM "DT_Output_59")
 INSERT INTO "TMP_20180516112405_CODEGEN_O2V2LN_LGBM_B5" ("KEY", "Score_0", "Score_1", "Score_2", "Score_3") SELECT "LGBM_B5"."KEY", "LGBM_B5"."Score_0", "LGBM_B5"."Score_1", "LGBM_B5"."Score_2", "LGBM_B5"."Score_3" 
...
-- Code For temporary table TMP_20180516112405_CODEGEN_DB0VC8_LGBM_B6 part 1. Create 


CREATE TEMPORARY TABLE "TMP_20180516112405_CODEGEN_DB0VC8_LGBM_B6" (
	"KEY" BIGINT, 
	"Score_0" FLOAT, 
	"Score_1" FLOAT, 
	"Score_2" FLOAT, 
...
-- Code For temporary table TMP_20180516112405_CODEGEN_DB0VC8_LGBM_B6 part 2. Populate
...
FROM "DT_Output_63")
 INSERT INTO "TMP_20180516112405_CODEGEN_DB0VC8_LGBM_B6" ("KEY", "Score_0", "Score_1", "Score_2", "Score_3") SELECT "LGBM_B6"."KEY", "LGBM_B6"."Score_0", "LGBM_B6"."Score_1", "LGBM_B6"."Score_2", "LGBM_B6"."Score_3" 
...
-- Code For temporary table TMP_20180516112405_CODEGEN_2LWALP_LGBM_sum part 1. Create 


CREATE TEMPORARY TABLE "TMP_20180516112405_CODEGEN_2LWALP_LGBM_sum" (
	"KEY" BIGINT NOT NULL, 
	"Score_0" FLOAT, 
	"Score_1" FLOAT, 
	"Score_2" FLOAT, 
...
-- Code For temporary table TMP_20180516112405_CODEGEN_2LWALP_LGBM_sum part 2. Populate
...
FROM "TMP_20180516112405_CODEGEN_XDYBR9_LGBM_B0" AS "LGBM_B0" UNION ALL SELECT "LGBM_B1"."KEY" AS "KEY", "LGBM_B1"."Score_0" AS "Score_0", "LGBM_B1"."Score_1" AS "Score_1", "LGBM_B1"."Score_2" AS "Score_2", "LGBM_B1"."Score_3" AS "Score_3" 
FROM "TMP_20180516112405_CODEGEN_H52FCZ_LGBM_B1" AS "LGBM_B1" UNION ALL SELECT "LGBM_B2"."KEY" AS "KEY", "LGBM_B2"."Score_0" AS "Score_0", "LGBM_B2"."Score_1" AS "Score_1", "LGBM_B2"."Score_2" AS "Score_2", "LGBM_B2"."Score_3" AS "Score_3" 
FROM "TMP_20180516112405_CODEGEN_QBEPT8_LGBM_B2" AS "LGBM_B2" UNION ALL SELECT "LGBM_B3"."KEY" AS "KEY", "LGBM_B3"."Score_0" AS "Score_0", "LGBM_B3"."Score_1" AS "Score_1", "LGBM_B3"."Score_2" AS "Score_2", "LGBM_B3"."Score_3" AS "Score_3" 
FROM "TMP_20180516112405_CODEGEN_BR718Y_LGBM_B3" AS "LGBM_B3" UNION ALL SELECT "LGBM_B4"."KEY" AS "KEY", "LGBM_B4"."Score_0" AS "Score_0", "LGBM_B4"."Score_1" AS "Score_1", "LGBM_B4"."Score_2" AS "Score_2", "LGBM_B4"."Score_3" AS "Score_3" 
FROM "TMP_20180516112405_CODEGEN_L9TSO6_LGBM_B4" AS "LGBM_B4" UNION ALL SELECT "LGBM_B5"."KEY" AS "KEY", "LGBM_B5"."Score_0" AS "Score_0", "LGBM_B5"."Score_1" AS "Score_1", "LGBM_B5"."Score_2" AS "Score_2", "LGBM_B5"."Score_3" AS "Score_3" 
FROM "TMP_20180516112405_CODEGEN_O2V2LN_LGBM_B5" AS "LGBM_B5" UNION ALL SELECT "LGBM_B6"."KEY" AS "KEY", "LGBM_B6"."Score_0" AS "Score_0", "LGBM_B6"."Score_1" AS "Score_1", "LGBM_B6"."Score_2" AS "Score_2", "LGBM_B6"."Score_3" AS "Score_3" 
FROM "TMP_20180516112405_CODEGEN_DB0VC8_LGBM_B6" AS "LGBM_B6") AS "LGBM_EnsembleUnion")
 INSERT INTO "TMP_20180516112405_CODEGEN_2LWALP_LGBM_sum" ("KEY", "Score_0", "Score_1", "Score_2", "Score_3") SELECT "LGBM_sum"."KEY", "LGBM_sum"."Score_0", "LGBM_sum"."Score_1", "LGBM_sum"."Score_2", "LGBM_sum"."Score_3" 
...
-- Code For temporary table TMP_20180516112405_CODEGEN_2LWALP_LGBM_sum part 3. Create Index 

CREATE INDEX "ix_TMP_20180516112405_CODEGEN_2LWALP_LGBM_sum_KEY" ON "TMP_20180516112405_CODEGEN_2LWALP_LGBM_sum" ("KEY")
...
FROM "TMP_20180516112405_CODEGEN_2LWALP_LGBM_sum" AS "LGBM_sum"), 
