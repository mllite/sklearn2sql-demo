...
-- Code For temporary table DEGEN_04AQ7F_ADS_IMP_1_OUT part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "DEGEN_04AQ7F_ADS_IMP_1_OUT" (
	"KEY" NUMBER(19), 
...
-- Code For temporary table DEGEN_04AQ7F_ADS_IMP_1_OUT part 2. Populate

INSERT INTO "DEGEN_04AQ7F_ADS_IMP_1_OUT" ("KEY", impter_2, impter_3, impter_4, impter_5, impter_6, impter_7, impter_8, impter_9, impter_10, impter_11) SELECT "U"."KEY", "U".impter_2, "U".impter_3, "U".impter_4, "U".impter_5, "U".impter_6, "U".impter_7, "U".impter_8, "U".impter_9, "U".impter_10, "U".impter_11 
...
-- Code For temporary table DEGEN_60OFTV_ADS_SCA_2_OUT part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "DEGEN_60OFTV_ADS_SCA_2_OUT" (
	"KEY" NUMBER(19), 
...
-- Code For temporary table DEGEN_60OFTV_ADS_SCA_2_OUT part 2. Populate

INSERT INTO "DEGEN_60OFTV_ADS_SCA_2_OUT" ("KEY", scaler_2, scaler_3, scaler_4, scaler_5, scaler_6, scaler_7, scaler_8, scaler_9, scaler_10, scaler_11) SELECT "U"."KEY", "U".scaler_2, "U".scaler_3, "U".scaler_4, "U".scaler_5, "U".scaler_6, "U".scaler_7, "U".scaler_8, "U".scaler_9, "U".scaler_10, "U".scaler_11 
...
FROM "DEGEN_04AQ7F_ADS_IMP_1_OUT" "ADS_imp_1_OUT") "ADS_sca_2_OUT") "U"

-- Code For temporary table 303_CODEGEN_1T6B1K_LGBM_B0 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "303_CODEGEN_1T6B1K_LGBM_B0" (
	"KEY" NUMBER(19), 
...
-- Code For temporary table 303_CODEGEN_1T6B1K_LGBM_B0 part 2. Populate

INSERT INTO "303_CODEGEN_1T6B1K_LGBM_B0" ("KEY", "Score_0", "Score_1", "Score_2", "Score_3") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1", "U"."Score_2", "U"."Score_3" 
...
FROM "DEGEN_60OFTV_ADS_SCA_2_OUT" "ADS_sca_2_OUT"), 
"DT_node_data" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS BINARY_DOUBLE) AS "Score" 
FROM (SELECT 3 AS nid, 0.031313131313131314 AS "Score" FROM DUAL UNION ALL SELECT 4 AS nid, -0.019999999999999983 AS "Score" FROM DUAL UNION ALL SELECT 5 AS nid, -0.03333333333333333 AS "Score" FROM DUAL) "Values"), 
"DT_Output" AS 
...
"DT_node_data_1" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS BINARY_DOUBLE) AS "Score" 
FROM (SELECT 3 AS nid, 0.03904761904761905 AS "Score" FROM DUAL UNION ALL SELECT 4 AS nid, -0.026666666666666644 AS "Score" FROM DUAL UNION ALL SELECT 5 AS nid, -0.03333333333333333 AS "Score" FROM DUAL) "Values"), 
"DT_Output_1" AS 
...
"DT_node_data_2" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS BINARY_DOUBLE) AS "Score" 
FROM (SELECT 2 AS nid, 0.049206349206349184 AS "Score" FROM DUAL UNION ALL SELECT 6 AS nid, -0.02991452991452991 AS "Score" FROM DUAL UNION ALL SELECT 7 AS nid, 0.006666666666666667 AS "Score" FROM DUAL) "Values"), 
"DT_Output_2" AS 
...
"DT_node_data_3" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS BINARY_DOUBLE) AS "Score" 
FROM (SELECT 3 AS nid, -0.02631578947368421 AS "Score" FROM DUAL UNION ALL SELECT 4 AS nid, -0.020000000000000004 AS "Score" FROM DUAL UNION ALL SELECT 5 AS nid, 0.07575757575757573 AS "Score" FROM DUAL) "Values"), 
"DT_Output_3" AS 
...
"DT_node_data_4" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS BINARY_DOUBLE) AS "Score" 
FROM (SELECT 3 AS nid, 0.029890324834214107 AS "Score" FROM DUAL UNION ALL SELECT 4 AS nid, -0.019714634838852194 AS "Score" FROM DUAL UNION ALL SELECT 5 AS nid, -0.03297533651631214 AS "Score" FROM DUAL) "Values"), 
"DT_Output_4" AS 
...
"DT_node_data_5" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS BINARY_DOUBLE) AS "Score" 
FROM (SELECT 3 AS nid, 0.03717740036133148 AS "Score" FROM DUAL UNION ALL SELECT 4 AS nid, -0.03308250629190587 AS "Score" FROM DUAL UNION ALL SELECT 5 AS nid, -0.026220112378153138 AS "Score" FROM DUAL) "Values"), 
"DT_Output_5" AS 
...
"DT_node_data_6" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS BINARY_DOUBLE) AS "Score" 
FROM (SELECT 2 AS nid, 0.046008569905713594 AS "Score" FROM DUAL UNION ALL SELECT 6 AS nid, -0.029513965960217145 AS "Score" FROM DUAL UNION ALL SELECT 7 AS nid, 0.006449369627631251 AS "Score" FROM DUAL) "Values"), 
"DT_Output_6" AS 
...
"DT_node_data_7" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS BINARY_DOUBLE) AS "Score" 
FROM (SELECT 3 AS nid, -0.025955223757078746 AS "Score" FROM DUAL UNION ALL SELECT 4 AS nid, -0.01964779378979445 AS "Score" FROM DUAL UNION ALL SELECT 5 AS nid, 0.0703825874558374 AS "Score" FROM DUAL) "Values"), 
"DT_Output_7" AS 
...
"DT_node_data_8" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS BINARY_DOUBLE) AS "Score" 
FROM (SELECT 3 AS nid, 0.0285978567817166 AS "Score" FROM DUAL UNION ALL SELECT 4 AS nid, -0.019452834179893068 AS "Score" FROM DUAL UNION ALL SELECT 5 AS nid, -0.032635413729619485 AS "Score" FROM DUAL) "Values"), 
"DT_Output_8" AS 
...
"DT_node_data_9" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS BINARY_DOUBLE) AS "Score" 
FROM (SELECT 3 AS nid, 0.03544923946712726 AS "Score" FROM DUAL UNION ALL SELECT 4 AS nid, -0.032823151318331724 AS "Score" FROM DUAL UNION ALL SELECT 5 AS nid, -0.025812254270148036 AS "Score" FROM DUAL) "Values"), 
"DT_Output_9" AS 
...
-- Code For temporary table 303_CODEGEN_RY3T9J_LGBM_B1 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "303_CODEGEN_RY3T9J_LGBM_B1" (
	"KEY" NUMBER(19), 
	"Score_0" BINARY_DOUBLE, 
	"Score_1" BINARY_DOUBLE, 
	"Score_2" BINARY_DOUBLE, 
...
-- Code For temporary table 303_CODEGEN_RY3T9J_LGBM_B1 part 2. Populate

INSERT INTO "303_CODEGEN_RY3T9J_LGBM_B1" ("KEY", "Score_0", "Score_1", "Score_2", "Score_3") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1", "U"."Score_2", "U"."Score_3" 
FROM (WITH "DT_node_lookup_10" AS 
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", CASE WHEN ("ADS_sca_2_OUT".scaler_5 <= -0.8025107564584706) THEN 2 ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_9 <= 0.71876447268539) THEN 6 ELSE 7 END END AS node_id_2 
FROM "DEGEN_60OFTV_ADS_SCA_2_OUT" "ADS_sca_2_OUT"), 
"DT_node_data_10" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS BINARY_DOUBLE) AS "Score" 
FROM (SELECT 2 AS nid, 0.0431832511697326 AS "Score" FROM DUAL UNION ALL SELECT 6 AS nid, -0.02913558879468703 AS "Score" FROM DUAL UNION ALL SELECT 7 AS nid, 0.00624110770136043 AS "Score" FROM DUAL) "Values"), 
"DT_Output_10" AS 
...
"DT_node_data_11" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS BINARY_DOUBLE) AS "Score" 
FROM (SELECT 3 AS nid, -0.02560701863704122 AS "Score" FROM DUAL UNION ALL SELECT 4 AS nid, -0.01929002108837167 AS "Score" FROM DUAL UNION ALL SELECT 5 AS nid, 0.06573552661664604 AS "Score" FROM DUAL) "Values"), 
"DT_Output_11" AS 
...
"DT_node_data_12" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS BINARY_DOUBLE) AS "Score" 
FROM (SELECT 3 AS nid, 0.02736072525190103 AS "Score" FROM DUAL UNION ALL SELECT 4 AS nid, -0.0191798429109147 AS "Score" FROM DUAL UNION ALL SELECT 5 AS nid, -0.032311813591920355 AS "Score" FROM DUAL) "Values"), 
"DT_Output_12" AS 
...
"DT_node_data_13" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS BINARY_DOUBLE) AS "Score" 
FROM (SELECT 3 AS nid, 0.03387608543774436 AS "Score" FROM DUAL UNION ALL SELECT 4 AS nid, -0.032584416091167065 AS "Score" FROM DUAL UNION ALL SELECT 5 AS nid, -0.02539859827140601 AS "Score" FROM DUAL) "Values"), 
"DT_Output_13" AS 
...
"DT_node_data_14" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS BINARY_DOUBLE) AS "Score" 
FROM (SELECT 2 AS nid, 0.03728734788217111 AS "Score" FROM DUAL UNION ALL SELECT 6 AS nid, -0.028691910399327832 AS "Score" FROM DUAL UNION ALL SELECT 7 AS nid, -0.00034229396238252504 AS "Score" FROM DUAL) "Values"), 
"DT_Output_14" AS 
...
"DT_node_data_15" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS BINARY_DOUBLE) AS "Score" 
FROM (SELECT 3 AS nid, -0.025269663451468923 AS "Score" FROM DUAL UNION ALL SELECT 4 AS nid, -0.018940698726507485 AS "Score" FROM DUAL UNION ALL SELECT 5 AS nid, 0.061717406145225695 AS "Score" FROM DUAL) "Values"), 
"DT_Output_15" AS 
...
"DT_node_data_16" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS BINARY_DOUBLE) AS "Score" 
FROM (SELECT 3 AS nid, 0.02621322338655387 AS "Score" FROM DUAL UNION ALL SELECT 4 AS nid, -0.01890024522731836 AS "Score" FROM DUAL UNION ALL SELECT 5 AS nid, -0.03201070555962875 AS "Score" FROM DUAL) "Values"), 
"DT_Output_16" AS 
...
"DT_node_data_17" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS BINARY_DOUBLE) AS "Score" 
FROM (SELECT 3 AS nid, 0.0323415327338531 AS "Score" FROM DUAL UNION ALL SELECT 4 AS nid, -0.032334297969740085 AS "Score" FROM DUAL UNION ALL SELECT 5 AS nid, -0.025000167996277578 AS "Score" FROM DUAL) "Values"), 
"DT_Output_17" AS 
...
"DT_node_data_18" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS BINARY_DOUBLE) AS "Score" 
FROM (SELECT 2 AS nid, 0.035189674473246745 AS "Score" FROM DUAL UNION ALL SELECT 6 AS nid, -0.028324946667386292 AS "Score" FROM DUAL UNION ALL SELECT 7 AS nid, -0.0002976243257456839 AS "Score" FROM DUAL) "Values"), 
"DT_Output_18" AS 
...
"DT_node_data_19" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS BINARY_DOUBLE) AS "Score" 
FROM (SELECT 3 AS nid, -0.0249572675939385 AS "Score" FROM DUAL UNION ALL SELECT 4 AS nid, -0.01857667021518673 AS "Score" FROM DUAL UNION ALL SELECT 5 AS nid, 0.05827622543899208 AS "Score" FROM DUAL) "Values"), 
"DT_Output_19" AS 
...
-- Code For temporary table 303_CODEGEN_WSQJQU_LGBM_B2 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "303_CODEGEN_WSQJQU_LGBM_B2" (
	"KEY" NUMBER(19), 
	"Score_0" BINARY_DOUBLE, 
	"Score_1" BINARY_DOUBLE, 
	"Score_2" BINARY_DOUBLE, 
...
-- Code For temporary table 303_CODEGEN_WSQJQU_LGBM_B2 part 2. Populate

INSERT INTO "303_CODEGEN_WSQJQU_LGBM_B2" ("KEY", "Score_0", "Score_1", "Score_2", "Score_3") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1", "U"."Score_2", "U"."Score_3" 
FROM (WITH "DT_node_lookup_20" AS 
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", CASE WHEN ("ADS_sca_2_OUT".scaler_6 <= 0.055714449355834215) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_5 <= -0.1482588162892825) THEN 4 ELSE 5 END ELSE 3 END AS node_id_2 
FROM "DEGEN_60OFTV_ADS_SCA_2_OUT" "ADS_sca_2_OUT"), 
"DT_node_data_20" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS BINARY_DOUBLE) AS "Score" 
FROM (SELECT 3 AS nid, 0.025109701183425395 AS "Score" FROM DUAL UNION ALL SELECT 4 AS nid, -0.018632246772023003 AS "Score" FROM DUAL UNION ALL SELECT 5 AS nid, -0.031717866496513474 AS "Score" FROM DUAL) "Values"), 
"DT_Output_20" AS 
...
"DT_node_data_21" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS BINARY_DOUBLE) AS "Score" 
FROM (SELECT 3 AS nid, 0.030936942691623344 AS "Score" FROM DUAL UNION ALL SELECT 4 AS nid, -0.032108989387277666 AS "Score" FROM DUAL UNION ALL SELECT 5 AS nid, -0.024579348608244136 AS "Score" FROM DUAL) "Values"), 
"DT_Output_21" AS 
...
"DT_node_data_22" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS BINARY_DOUBLE) AS "Score" 
FROM (SELECT 2 AS nid, 0.03645138551967693 AS "Score" FROM DUAL UNION ALL SELECT 6 AS nid, -0.028354158790512604 AS "Score" FROM DUAL UNION ALL SELECT 7 AS nid, 0.00680836012772499 AS "Score" FROM DUAL) "Values"), 
"DT_Output_22" AS 
...
"DT_node_data_23" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS BINARY_DOUBLE) AS "Score" 
FROM (SELECT 3 AS nid, -0.02465253684264244 AS "Score" FROM DUAL UNION ALL SELECT 4 AS nid, -0.018220309940876707 AS "Score" FROM DUAL UNION ALL SELECT 5 AS nid, 0.055245575702899445 AS "Score" FROM DUAL) "Values"), 
"DT_Output_23" AS 
...
"DT_node_data_24" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS BINARY_DOUBLE) AS "Score" 
FROM (SELECT 3 AS nid, 0.024131578794952688 AS "Score" FROM DUAL UNION ALL SELECT 4 AS nid, -0.01835564381144864 AS "Score" FROM DUAL UNION ALL SELECT 5 AS nid, -0.03145236478562127 AS "Score" FROM DUAL) "Values"), 
"DT_Output_24" AS 
...
"DT_node_data_25" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS BINARY_DOUBLE) AS "Score" 
FROM (SELECT 3 AS nid, 0.02968789686507344 AS "Score" FROM DUAL UNION ALL SELECT 4 AS nid, -0.03188977571793548 AS "Score" FROM DUAL UNION ALL SELECT 5 AS nid, -0.024211533228001902 AS "Score" FROM DUAL) "Values"), 
"DT_Output_25" AS 
...
"DT_node_data_26" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS BINARY_DOUBLE) AS "Score" 
FROM (SELECT 2 AS nid, 0.03161750505825809 AS "Score" FROM DUAL UNION ALL SELECT 6 AS nid, -0.02775253817941424 AS "Score" FROM DUAL UNION ALL SELECT 7 AS nid, 0.00015564562837652775 AS "Score" FROM DUAL) "Values"), 
"DT_Output_26" AS 
...
"DT_node_data_27" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS BINARY_DOUBLE) AS "Score" 
FROM (SELECT 3 AS nid, -0.02433275081049226 AS "Score" FROM DUAL UNION ALL SELECT 4 AS nid, -0.017883791422397283 AS "Score" FROM DUAL UNION ALL SELECT 5 AS nid, 0.052406394193815445 AS "Score" FROM DUAL) "Values"), 
"DT_Output_27" AS 
...
"DT_node_data_28" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS BINARY_DOUBLE) AS "Score" 
FROM (SELECT 3 AS nid, 0.02315918188134441 AS "Score" FROM DUAL UNION ALL SELECT 4 AS nid, -0.018090089820374057 AS "Score" FROM DUAL UNION ALL SELECT 5 AS nid, -0.031188908876405713 AS "Score" FROM DUAL) "Values"), 
"DT_Output_28" AS 
...
"DT_node_data_29" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS BINARY_DOUBLE) AS "Score" 
FROM (SELECT 3 AS nid, 0.028473930395623705 AS "Score" FROM DUAL UNION ALL SELECT 4 AS nid, -0.031675839936002446 AS "Score" FROM DUAL UNION ALL SELECT 5 AS nid, -0.023816324426846683 AS "Score" FROM DUAL) "Values"), 
"DT_Output_29" AS 
...
-- Code For temporary table 303_CODEGEN_GCFWIU_LGBM_B3 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "303_CODEGEN_GCFWIU_LGBM_B3" (
	"KEY" NUMBER(19), 
	"Score_0" BINARY_DOUBLE, 
	"Score_1" BINARY_DOUBLE, 
	"Score_2" BINARY_DOUBLE, 
...
-- Code For temporary table 303_CODEGEN_GCFWIU_LGBM_B3 part 2. Populate

INSERT INTO "303_CODEGEN_GCFWIU_LGBM_B3" ("KEY", "Score_0", "Score_1", "Score_2", "Score_3") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1", "U"."Score_2", "U"."Score_3" 
...
"DT_node_data_30" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS BINARY_DOUBLE) AS "Score" 
FROM (SELECT 3 AS nid, -0.028043301533542016 AS "Score" FROM DUAL UNION ALL SELECT 4 AS nid, 0.03962755935904942 AS "Score" FROM DUAL UNION ALL SELECT 5 AS nid, -0.0014030151849566191 AS "Score" FROM DUAL) "Values"), 
"DT_Output_30" AS 
...
"DT_node_data_31" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS BINARY_DOUBLE) AS "Score" 
FROM (SELECT 3 AS nid, -0.024038677145539897 AS "Score" FROM DUAL UNION ALL SELECT 4 AS nid, -0.017536804038546742 AS "Score" FROM DUAL UNION ALL SELECT 5 AS nid, 0.04998003758456435 AS "Score" FROM DUAL) "Values"), 
"DT_Output_31" AS 
...
"DT_node_data_32" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS BINARY_DOUBLE) AS "Score" 
FROM (SELECT 3 AS nid, 0.02221863695485424 AS "Score" FROM DUAL UNION ALL SELECT 4 AS nid, -0.017738908559544433 AS "Score" FROM DUAL UNION ALL SELECT 5 AS nid, -0.030963840846490717 AS "Score" FROM DUAL) "Values"), 
"DT_Output_32" AS 
...
"DT_node_data_33" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS BINARY_DOUBLE) AS "Score" 
FROM (SELECT 3 AS nid, 0.027290688042628203 AS "Score" FROM DUAL UNION ALL SELECT 4 AS nid, -0.03144999010447301 AS "Score" FROM DUAL UNION ALL SELECT 5 AS nid, -0.023455731464001206 AS "Score" FROM DUAL) "Values"), 
"DT_Output_33" AS 
...
"DT_node_data_34" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS BINARY_DOUBLE) AS "Score" 
FROM (SELECT 3 AS nid, -0.027709487030797154 AS "Score" FROM DUAL UNION ALL SELECT 4 AS nid, 0.03748134207636105 AS "Score" FROM DUAL UNION ALL SELECT 5 AS nid, -0.0013296170151426776 AS "Score" FROM DUAL) "Values"), 
"DT_Output_34" AS 
...
"DT_node_data_35" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS BINARY_DOUBLE) AS "Score" 
FROM (SELECT 3 AS nid, -0.023739716790364983 AS "Score" FROM DUAL UNION ALL SELECT 4 AS nid, -0.01721088781628218 AS "Score" FROM DUAL UNION ALL SELECT 5 AS nid, 0.047804333295890886 AS "Score" FROM DUAL) "Values"), 
"DT_Output_35" AS 
...
"DT_node_data_36" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS BINARY_DOUBLE) AS "Score" 
FROM (SELECT 3 AS nid, 0.021302556660788056 AS "Score" FROM DUAL UNION ALL SELECT 4 AS nid, -0.017401591710193173 AS "Score" FROM DUAL UNION ALL SELECT 5 AS nid, -0.03073682349968447 AS "Score" FROM DUAL) "Values"), 
"DT_Output_36" AS 
...
"DT_node_data_37" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS BINARY_DOUBLE) AS "Score" 
FROM (SELECT 3 AS nid, 0.026175088462979043 AS "Score" FROM DUAL UNION ALL SELECT 4 AS nid, -0.031216763498756996 AS "Score" FROM DUAL UNION ALL SELECT 5 AS nid, -0.023117803318869545 AS "Score" FROM DUAL) "Values"), 
"DT_Output_37" AS 
...
"DT_node_data_38" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS BINARY_DOUBLE) AS "Score" 
FROM (SELECT 3 AS nid, -0.027390614272046622 AS "Score" FROM DUAL UNION ALL SELECT 4 AS nid, 0.03549264653026553 AS "Score" FROM DUAL UNION ALL SELECT 5 AS nid, -0.0012300897884915684 AS "Score" FROM DUAL) "Values"), 
"DT_Output_38" AS 
...
"DT_node_data_39" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS BINARY_DOUBLE) AS "Score" 
FROM (SELECT 3 AS nid, -0.023450771210854635 AS "Score" FROM DUAL UNION ALL SELECT 4 AS nid, -0.01689018935335381 AS "Score" FROM DUAL UNION ALL SELECT 5 AS nid, 0.04587317770681169 AS "Score" FROM DUAL) "Values"), 
"DT_Output_39" AS 
...
-- Code For temporary table 303_CODEGEN_MVFA58_LGBM_B4 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "303_CODEGEN_MVFA58_LGBM_B4" (
	"KEY" NUMBER(19), 
	"Score_0" BINARY_DOUBLE, 
	"Score_1" BINARY_DOUBLE, 
	"Score_2" BINARY_DOUBLE, 
...
-- Code For temporary table 303_CODEGEN_MVFA58_LGBM_B4 part 2. Populate

INSERT INTO "303_CODEGEN_MVFA58_LGBM_B4" ("KEY", "Score_0", "Score_1", "Score_2", "Score_3") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1", "U"."Score_2", "U"."Score_3" 
FROM (WITH "DT_node_lookup_40" AS 
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", CASE WHEN ("ADS_sca_2_OUT".scaler_6 <= 0.055714449355834215) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_5 <= -0.1482588162892825) THEN 4 ELSE 5 END ELSE 3 END AS node_id_2 
FROM "DEGEN_60OFTV_ADS_SCA_2_OUT" "ADS_sca_2_OUT"), 
"DT_node_data_40" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS BINARY_DOUBLE) AS "Score" 
FROM (SELECT 3 AS nid, 0.020469266999759247 AS "Score" FROM DUAL UNION ALL SELECT 4 AS nid, -0.017077195588261634 AS "Score" FROM DUAL UNION ALL SELECT 5 AS nid, -0.03052388593827371 AS "Score" FROM DUAL) "Values"), 
"DT_Output_40" AS 
...
"DT_node_data_41" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS BINARY_DOUBLE) AS "Score" 
FROM (SELECT 3 AS nid, 0.02513226379460015 AS "Score" FROM DUAL UNION ALL SELECT 4 AS nid, -0.031022810601005375 AS "Score" FROM DUAL UNION ALL SELECT 5 AS nid, -0.02273572238301888 AS "Score" FROM DUAL) "Values"), 
"DT_Output_41" AS 
...
"DT_node_data_42" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS BINARY_DOUBLE) AS "Score" 
FROM (SELECT 3 AS nid, -0.027076470931170826 AS "Score" FROM DUAL UNION ALL SELECT 4 AS nid, 0.03368657382870038 AS "Score" FROM DUAL UNION ALL SELECT 5 AS nid, -0.0011506413927733785 AS "Score" FROM DUAL) "Values"), 
"DT_Output_42" AS 
...
"DT_node_data_43" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS BINARY_DOUBLE) AS "Score" 
FROM (SELECT 3 AS nid, -0.023161081754743316 AS "Score" FROM DUAL UNION ALL SELECT 4 AS nid, -0.016571486469829016 AS "Score" FROM DUAL UNION ALL SELECT 5 AS nid, 0.044070438093100836 AS "Score" FROM DUAL) "Values"), 
"DT_Output_43" AS 
...
"DT_node_data_44" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS BINARY_DOUBLE) AS "Score" 
FROM (SELECT 2 AS nid, 0.018658428499297178 AS "Score" FROM DUAL UNION ALL SELECT 6 AS nid, -0.03260987603184729 AS "Score" FROM DUAL UNION ALL SELECT 7 AS nid, -0.017758235794657004 AS "Score" FROM DUAL) "Values"), 
"DT_Output_44" AS 
...
"DT_node_data_45" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS BINARY_DOUBLE) AS "Score" 
FROM (SELECT 2 AS nid, -0.030813174430031866 AS "Score" FROM DUAL UNION ALL SELECT 6 AS nid, 0.03731079189617404 AS "Score" FROM DUAL UNION ALL SELECT 7 AS nid, 0.005270919377759695 AS "Score" FROM DUAL) "Values"), 
"DT_Output_45" AS 
...
"DT_node_data_46" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS BINARY_DOUBLE) AS "Score" 
FROM (SELECT 3 AS nid, -0.02677395187210831 AS "Score" FROM DUAL UNION ALL SELECT 4 AS nid, 0.03199675372219245 AS "Score" FROM DUAL UNION ALL SELECT 5 AS nid, -0.0010504514694104252 AS "Score" FROM DUAL) "Values"), 
"DT_Output_46" AS 
...
"DT_node_data_47" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS BINARY_DOUBLE) AS "Score" 
FROM (SELECT 3 AS nid, -0.027365666170626732 AS "Score" FROM DUAL UNION ALL SELECT 4 AS nid, 0.03578283124823388 AS "Score" FROM DUAL UNION ALL SELECT 5 AS nid, -0.017168784338711263 AS "Score" FROM DUAL) "Values"), 
"DT_Output_47" AS 
...
"DT_node_data_48" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS BINARY_DOUBLE) AS "Score" 
FROM (SELECT 3 AS nid, 0.019399343609960207 AS "Score" FROM DUAL UNION ALL SELECT 4 AS nid, -0.016781662454383093 AS "Score" FROM DUAL UNION ALL SELECT 5 AS nid, -0.03017738796273896 AS "Score" FROM DUAL) "Values"), 
"DT_Output_48" AS 
...
"DT_node_data_49" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS BINARY_DOUBLE) AS "Score" 
FROM (SELECT 2 AS nid, -0.030566095218364904 AS "Score" FROM DUAL UNION ALL SELECT 6 AS nid, 0.03527523422852007 AS "Score" FROM DUAL UNION ALL SELECT 7 AS nid, 0.004913132968129154 AS "Score" FROM DUAL) "Values"), 
"DT_Output_49" AS 
...
-- Code For temporary table 303_CODEGEN_KIS3X3_LGBM_B5 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "303_CODEGEN_KIS3X3_LGBM_B5" (
	"KEY" NUMBER(19), 
	"Score_0" BINARY_DOUBLE, 
	"Score_1" BINARY_DOUBLE, 
	"Score_2" BINARY_DOUBLE, 
...
-- Code For temporary table 303_CODEGEN_KIS3X3_LGBM_B5 part 2. Populate

INSERT INTO "303_CODEGEN_KIS3X3_LGBM_B5" ("KEY", "Score_0", "Score_1", "Score_2", "Score_3") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1", "U"."Score_2", "U"."Score_3" 
...
"DT_node_data_50" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS BINARY_DOUBLE) AS "Score" 
FROM (SELECT 3 AS nid, -0.02652498632776681 AS "Score" FROM DUAL UNION ALL SELECT 4 AS nid, 0.029617238255104955 AS "Score" FROM DUAL UNION ALL SELECT 5 AS nid, -0.0028003663989493973 AS "Score" FROM DUAL) "Values"), 
"DT_Output_50" AS 
...
"DT_node_data_51" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS BINARY_DOUBLE) AS "Score" 
FROM (SELECT 3 AS nid, -0.02711818747874117 AS "Score" FROM DUAL UNION ALL SELECT 4 AS nid, 0.03460778675010591 AS "Score" FROM DUAL UNION ALL SELECT 5 AS nid, -0.01689154456366618 AS "Score" FROM DUAL) "Values"), 
"DT_Output_51" AS 
...
"DT_node_data_52" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS BINARY_DOUBLE) AS "Score" 
FROM (SELECT 2 AS nid, 0.01799387049362078 AS "Score" FROM DUAL UNION ALL SELECT 6 AS nid, -0.03242224960498887 AS "Score" FROM DUAL UNION ALL SELECT 7 AS nid, -0.017362377465571628 AS "Score" FROM DUAL) "Values"), 
"DT_Output_52" AS 
...
"DT_node_data_53" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS BINARY_DOUBLE) AS "Score" 
FROM (SELECT 2 AS nid, -0.030360776239920728 AS "Score" FROM DUAL UNION ALL SELECT 6 AS nid, 0.03370260734847042 AS "Score" FROM DUAL UNION ALL SELECT 7 AS nid, 0.004697138806699121 AS "Score" FROM DUAL) "Values"), 
"DT_Output_53" AS 
...
"DT_node_data_54" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS BINARY_DOUBLE) AS "Score" 
FROM (SELECT 3 AS nid, -0.026234738761463622 AS "Score" FROM DUAL UNION ALL SELECT 4 AS nid, 0.03007408578767223 AS "Score" FROM DUAL UNION ALL SELECT 5 AS nid, -0.0011295133097756432 AS "Score" FROM DUAL) "Values"), 
"DT_Output_54" AS 
...
"DT_node_data_55" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS BINARY_DOUBLE) AS "Score" 
FROM (SELECT 2 AS nid, -0.031806736092987155 AS "Score" FROM DUAL UNION ALL SELECT 6 AS nid, 0.04021603573903312 AS "Score" FROM DUAL UNION ALL SELECT 7 AS nid, -0.01591202041045947 AS "Score" FROM DUAL) "Values"), 
"DT_Output_55" AS 
...
"DT_node_data_56" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS BINARY_DOUBLE) AS "Score" 
FROM (SELECT 3 AS nid, -0.03225119283402652 AS "Score" FROM DUAL UNION ALL SELECT 4 AS nid, -0.01976446307793822 AS "Score" FROM DUAL UNION ALL SELECT 5 AS nid, 0.039915884728708245 AS "Score" FROM DUAL) "Values"), 
"DT_Output_56" AS 
...
"DT_node_data_57" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS BINARY_DOUBLE) AS "Score" 
FROM (SELECT 2 AS nid, -0.03015049998757883 AS "Score" FROM DUAL UNION ALL SELECT 6 AS nid, 0.03203891921656793 AS "Score" FROM DUAL UNION ALL SELECT 7 AS nid, 0.004457387363194946 AS "Score" FROM DUAL) "Values"), 
"DT_Output_57" AS 
...
"DT_node_data_58" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS BINARY_DOUBLE) AS "Score" 
FROM (SELECT 3 AS nid, -0.025979844818296217 AS "Score" FROM DUAL UNION ALL SELECT 4 AS nid, 0.02773191497746488 AS "Score" FROM DUAL UNION ALL SELECT 5 AS nid, -0.002789908594225367 AS "Score" FROM DUAL) "Values"), 
"DT_Output_58" AS 
...
"DT_node_data_59" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS BINARY_DOUBLE) AS "Score" 
FROM (SELECT 2 AS nid, -0.03156024217647395 AS "Score" FROM DUAL UNION ALL SELECT 6 AS nid, 0.038805513789723384 AS "Score" FROM DUAL UNION ALL SELECT 7 AS nid, -0.015675049816415466 AS "Score" FROM DUAL) "Values"), 
"DT_Output_59" AS 
...
-- Code For temporary table 303_CODEGEN_UKHICB_LGBM_B6 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "303_CODEGEN_UKHICB_LGBM_B6" (
	"KEY" NUMBER(19), 
	"Score_0" BINARY_DOUBLE, 
	"Score_1" BINARY_DOUBLE, 
	"Score_2" BINARY_DOUBLE, 
...
-- Code For temporary table 303_CODEGEN_UKHICB_LGBM_B6 part 2. Populate

INSERT INTO "303_CODEGEN_UKHICB_LGBM_B6" ("KEY", "Score_0", "Score_1", "Score_2", "Score_3") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1", "U"."Score_2", "U"."Score_3" 
FROM (WITH "DT_node_lookup_60" AS 
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", CASE WHEN ("ADS_sca_2_OUT".scaler_5 <= 0.344243040080636) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_6 <= 0.055714449355834215) THEN 4 ELSE 5 END ELSE 3 END AS node_id_2 
FROM "DEGEN_60OFTV_ADS_SCA_2_OUT" "ADS_sca_2_OUT"), 
"DT_node_data_60" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS BINARY_DOUBLE) AS "Score" 
FROM (SELECT 3 AS nid, -0.03203045188723382 AS "Score" FROM DUAL UNION ALL SELECT 4 AS nid, -0.0194325039320264 AS "Score" FROM DUAL UNION ALL SELECT 5 AS nid, 0.03831629017934781 AS "Score" FROM DUAL) "Values"), 
"DT_Output_60" AS 
...
"DT_node_data_61" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS BINARY_DOUBLE) AS "Score" 
FROM (SELECT 2 AS nid, -0.029954062436785035 AS "Score" FROM DUAL UNION ALL SELECT 6 AS nid, 0.030625324171968546 AS "Score" FROM DUAL UNION ALL SELECT 7 AS nid, 0.0042133454582570255 AS "Score" FROM DUAL) "Values"), 
"DT_Output_61" AS 
...
"DT_node_data_62" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS BINARY_DOUBLE) AS "Score" 
FROM (SELECT 3 AS nid, -0.02568998830913531 AS "Score" FROM DUAL UNION ALL SELECT 4 AS nid, 0.0266585570637636 AS "Score" FROM DUAL UNION ALL SELECT 5 AS nid, -0.002652867510226685 AS "Score" FROM DUAL) "Values"), 
"DT_Output_62" AS 
...
"DT_node_data_63" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS BINARY_DOUBLE) AS "Score" 
FROM (SELECT 2 AS nid, -0.031342527343797326 AS "Score" FROM DUAL UNION ALL SELECT 6 AS nid, 0.037530688497719726 AS "Score" FROM DUAL UNION ALL SELECT 7 AS nid, -0.015444268808238635 AS "Score" FROM DUAL) "Values"), 
"DT_Output_63" AS 
...
-- Code For temporary table _CODEGEN_93GIW4_LGBM_UNION part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "_CODEGEN_93GIW4_LGBM_UNION" (
	"KEY" NUMBER(19), 
	"Score_0" BINARY_DOUBLE, 
	"Score_1" BINARY_DOUBLE, 
	"Score_2" BINARY_DOUBLE, 
...
-- Code For temporary table _CODEGEN_93GIW4_LGBM_UNION part 2. Populate

INSERT INTO "_CODEGEN_93GIW4_LGBM_UNION" ("KEY", "Score_0", "Score_1", "Score_2", "Score_3") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1", "U"."Score_2", "U"."Score_3" 
...
FROM "303_CODEGEN_1T6B1K_LGBM_B0" "LGBM_B0" UNION ALL SELECT "LGBM_B1"."KEY" AS "KEY", "LGBM_B1"."Score_0" AS "Score_0", "LGBM_B1"."Score_1" AS "Score_1", "LGBM_B1"."Score_2" AS "Score_2", "LGBM_B1"."Score_3" AS "Score_3" 
FROM "303_CODEGEN_RY3T9J_LGBM_B1" "LGBM_B1" UNION ALL SELECT "LGBM_B2"."KEY" AS "KEY", "LGBM_B2"."Score_0" AS "Score_0", "LGBM_B2"."Score_1" AS "Score_1", "LGBM_B2"."Score_2" AS "Score_2", "LGBM_B2"."Score_3" AS "Score_3" 
FROM "303_CODEGEN_WSQJQU_LGBM_B2" "LGBM_B2" UNION ALL SELECT "LGBM_B3"."KEY" AS "KEY", "LGBM_B3"."Score_0" AS "Score_0", "LGBM_B3"."Score_1" AS "Score_1", "LGBM_B3"."Score_2" AS "Score_2", "LGBM_B3"."Score_3" AS "Score_3" 
FROM "303_CODEGEN_GCFWIU_LGBM_B3" "LGBM_B3" UNION ALL SELECT "LGBM_B4"."KEY" AS "KEY", "LGBM_B4"."Score_0" AS "Score_0", "LGBM_B4"."Score_1" AS "Score_1", "LGBM_B4"."Score_2" AS "Score_2", "LGBM_B4"."Score_3" AS "Score_3" 
FROM "303_CODEGEN_MVFA58_LGBM_B4" "LGBM_B4" UNION ALL SELECT "LGBM_B5"."KEY" AS "KEY", "LGBM_B5"."Score_0" AS "Score_0", "LGBM_B5"."Score_1" AS "Score_1", "LGBM_B5"."Score_2" AS "Score_2", "LGBM_B5"."Score_3" AS "Score_3" 
FROM "303_CODEGEN_KIS3X3_LGBM_B5" "LGBM_B5" UNION ALL SELECT "LGBM_B6"."KEY" AS "KEY", "LGBM_B6"."Score_0" AS "Score_0", "LGBM_B6"."Score_1" AS "Score_1", "LGBM_B6"."Score_2" AS "Score_2", "LGBM_B6"."Score_3" AS "Score_3" 
FROM "303_CODEGEN_UKHICB_LGBM_B6" "LGBM_B6") "LGBM_EnsembleUnion") "LGBM_Union") "U"

-- Code For temporary table 03_CODEGEN_EPBOFB_LGBM_SUM part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "03_CODEGEN_EPBOFB_LGBM_SUM" (
	"KEY" NUMBER(19), 
	"Score_0" BINARY_DOUBLE, 
	"Score_1" BINARY_DOUBLE, 
	"Score_2" BINARY_DOUBLE, 
...
-- Code For temporary table 03_CODEGEN_EPBOFB_LGBM_SUM part 2. Populate

INSERT INTO "03_CODEGEN_EPBOFB_LGBM_SUM" ("KEY", "Score_0", "Score_1", "Score_2", "Score_3") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1", "U"."Score_2", "U"."Score_3" 
...
FROM "_CODEGEN_93GIW4_LGBM_UNION" "LGBM_Union" GROUP BY "LGBM_Union"."KEY") "T") "LGBM_sum") "U"
...
FROM "03_CODEGEN_EPBOFB_LGBM_SUM" "LGBM_sum"), 
