...
-- Code For temporary table tmp_20180508180823_codegen_feejfq_ads_imp_1_out part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180508180823_codegen_feejfq_ads_imp_1_out (
	"KEY" BIGINT, 
	impter_2 DOUBLE, 
	impter_3 DOUBLE, 
	impter_4 DOUBLE, 
...
-- Code For temporary table tmp_20180508180823_codegen_hz3ylc_ads_sca_2_out part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180508180823_codegen_hz3ylc_ads_sca_2_out (
	"KEY" BIGINT, 
	scaler_2 DOUBLE, 
	scaler_3 DOUBLE, 
	scaler_4 DOUBLE, 
...
-- Code For temporary table tmp_20180508180823_codegen_hz3ylc_ads_sca_2_out part 2. Populate

INSERT INTO tmp_20180508180823_codegen_hz3ylc_ads_sca_2_out SELECT "ADS_sca_2_OUT"."KEY", "ADS_sca_2_OUT".scaler_2, "ADS_sca_2_OUT".scaler_3, "ADS_sca_2_OUT".scaler_4, "ADS_sca_2_OUT".scaler_5, "ADS_sca_2_OUT".scaler_6, "ADS_sca_2_OUT".scaler_7, "ADS_sca_2_OUT".scaler_8, "ADS_sca_2_OUT".scaler_9, "ADS_sca_2_OUT".scaler_10, "ADS_sca_2_OUT".scaler_11, "ADS_sca_2_OUT".scaler_12, "ADS_sca_2_OUT".scaler_13, "ADS_sca_2_OUT".scaler_14, "ADS_sca_2_OUT".scaler_15, "ADS_sca_2_OUT".scaler_16, "ADS_sca_2_OUT".scaler_17, "ADS_sca_2_OUT".scaler_18, "ADS_sca_2_OUT".scaler_19, "ADS_sca_2_OUT".scaler_20, "ADS_sca_2_OUT".scaler_21, "ADS_sca_2_OUT".scaler_22, "ADS_sca_2_OUT".scaler_23, "ADS_sca_2_OUT".scaler_24, "ADS_sca_2_OUT".scaler_25, "ADS_sca_2_OUT".scaler_26, "ADS_sca_2_OUT".scaler_27, "ADS_sca_2_OUT".scaler_28, "ADS_sca_2_OUT".scaler_29, "ADS_sca_2_OUT".scaler_30, "ADS_sca_2_OUT".scaler_31 
...
FROM tmp_20180508180823_codegen_feejfq_ads_imp_1_out AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT"

-- Code For temporary table tmp_20180508180823_codegen_07gbag_lgbm_b0 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180508180823_codegen_07gbag_lgbm_b0 (
	"KEY" BIGINT, 
	"Score_0" DOUBLE
)
...
-- Code For temporary table tmp_20180508180823_codegen_07gbag_lgbm_b0 part 2. Populate

INSERT INTO tmp_20180508180823_codegen_07gbag_lgbm_b0 WITH "DT_node_lookup" AS 
...
"DT_node_data_1" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE) AS "Score" 
FROM (SELECT 5 AS nid, -0.03872342243693988 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 6 AS nid, -0.03801546607982693 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 7 AS nid, -0.09524187224606034 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 9 AS nid, 0.06415724277379706 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 16 AS nid, 0.08526081895893341 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 34 AS nid, 0.09524187224606034 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 35 AS nid, 0.09667714578913264 AS "Score" FROM SYSIBM.SYSDUMMY1) AS "Values"), 
"DT_Output_1" AS 
...
"DT_node_data_2" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE) AS "Score" 
FROM (SELECT 5 AS nid, -0.03682030457504874 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 6 AS nid, -0.03615616348273377 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 9 AS nid, 0.054007699282570654 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 14 AS nid, -0.09113178077572358 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 15 AS nid, -0.09113178077572359 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 17 AS nid, 0.07235729037003415 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 33 AS nid, 0.09180259785402088 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 64 AS nid, 0.0914854829751507 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 131 AS nid, 0.09124156037379381 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 260 AS nid, 0.09113178077572362 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 261 AS nid, 0.09113178077572359 AS "Score" FROM SYSIBM.SYSDUMMY1) AS "Values"), 
"DT_Output_2" AS 
...
"DT_node_data_3" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE) AS "Score" 
FROM (SELECT 5 AS nid, -0.03557196879802641 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 6 AS nid, -0.034409502171933046 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 9 AS nid, 0.05079859401202999 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 14 AS nid, -0.08754910073915208 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 15 AS nid, -0.08754910073915209 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 16 AS nid, 0.06887692755809435 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 35 AS nid, 0.09090627295655655 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 69 AS nid, 0.08875538456969538 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 136 AS nid, 0.0877887073887226 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 275 AS nid, 0.08766171146740767 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 549 AS nid, 0.08761451313923382 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 1097 AS nid, 0.08754617059923987 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 2192 AS nid, 0.08754910073915212 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 2193 AS nid, 0.08754786335035256 AS "Score" FROM SYSIBM.SYSDUMMY1) AS "Values"), 
"DT_Output_3" AS 
...
"DT_node_data_4" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE) AS "Score" 
FROM (SELECT 5 AS nid, -0.0339628630043236 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 6 AS nid, -0.03276474964490477 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 9 AS nid, 0.05464668129194551 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 15 AS nid, -0.0844015024275224 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 17 AS nid, 0.07441013570278752 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 28 AS nid, -0.08440150242752234 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 29 AS nid, -0.0844015024275224 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 33 AS nid, 0.08758162396382087 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 64 AS nid, 0.08488337578474006 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 130 AS nid, 0.08466538181316721 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 263 AS nid, 0.08437601828006863 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 525 AS nid, 0.08439521116260168 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 1049 AS nid, 0.0843980234984501 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 2097 AS nid, 0.08440046506340697 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 4193 AS nid, 0.08440106267178245 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 8385 AS nid, 0.08440152277024804 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 16768 AS nid, 0.08440150242752241 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 16769 AS nid, 0.08440150242752237 AS "Score" FROM SYSIBM.SYSDUMMY1) AS "Values"), 
"DT_Output_4" AS 
...
"DT_node_data_5" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE) AS "Score" 
FROM (SELECT 5 AS nid, -0.032876653894358364 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 6 AS nid, -0.031212692907520073 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 7 AS nid, -0.08161712202378635 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 9 AS nid, 0.045206619562706093 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 17 AS nid, 0.0625244689531874 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 33 AS nid, 0.0850521141342685 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 64 AS nid, 0.0832784031223782 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 130 AS nid, 0.08190545585374014 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 263 AS nid, 0.08185682540206007 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 524 AS nid, 0.08179173169763698 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 1051 AS nid, 0.08165700818932689 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 2101 AS nid, 0.08160079310223653 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 4201 AS nid, 0.08161343521572201 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 8401 AS nid, 0.08161621426304494 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 16801 AS nid, 0.0816171569277635 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 33600 AS nid, 0.08161712202378638 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 33601 AS nid, 0.08161713305824708 AS "Score" FROM SYSIBM.SYSDUMMY1) AS "Values"), 
"DT_Output_5" AS 
...
"DT_node_data_6" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE) AS "Score" 
FROM (SELECT 5 AS nid, -0.03139507945384355 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 6 AS nid, -0.030614014856393115 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 9 AS nid, 0.049351077340023954 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 14 AS nid, -0.08033099401564248 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 16 AS nid, 0.06890795228439286 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 30 AS nid, -0.07913912415567703 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 31 AS nid, -0.07913912415567705 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 35 AS nid, 0.08309092995698653 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 69 AS nid, 0.07968362284618594 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 136 AS nid, 0.07940581388226561 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 275 AS nid, 0.07930333675277955 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 548 AS nid, 0.07911128510259312 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 1099 AS nid, 0.07912469798670464 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 2196 AS nid, 0.07913383982101248 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 4395 AS nid, 0.0791350426103549 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 8789 AS nid, 0.07913769786279123 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 17576 AS nid, 0.07913914746517438 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 17577 AS nid, 0.07913864890481614 AS "Score" FROM SYSIBM.SYSDUMMY1) AS "Values"), 
"DT_Output_6" AS 
...
"DT_node_data_7" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE) AS "Score" 
FROM (SELECT 5 AS nid, -0.016778388263403898 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 6 AS nid, -0.028086185830407354 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 9 AS nid, 0.055306028713149075 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 14 AS nid, -0.0771139897895199 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 17 AS nid, 0.07896869779926916 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 30 AS nid, -0.07690433051439245 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 33 AS nid, 0.07846163444505044 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 62 AS nid, -0.07692196744668278 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 63 AS nid, -0.07692196744668282 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 65 AS nid, 0.07736585274070729 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 128 AS nid, 0.07722560876409244 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 258 AS nid, 0.07716093984136602 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 519 AS nid, 0.07704253327303179 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 1036 AS nid, 0.07691571086825517 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 2075 AS nid, 0.07691932391319566 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 4149 AS nid, 0.0769208072538407 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 8296 AS nid, 0.0769222110722792 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 8297 AS nid, 0.07692196838943438 AS "Score" FROM SYSIBM.SYSDUMMY1) AS "Values"), 
"DT_Output_7" AS 
...
"DT_node_data_8" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE) AS "Score" 
FROM (SELECT 5 AS nid, -0.03089283383083773 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 6 AS nid, -0.027649083273576753 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 9 AS nid, 0.037863760180938115 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 14 AS nid, -0.07613426848391092 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 16 AS nid, 0.055770223392602306 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 30 AS nid, -0.07492639160078489 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 35 AS nid, 0.08032083599377728 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 62 AS nid, -0.07492885075612388 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 63 AS nid, -0.07492871773403978 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 69 AS nid, 0.07718929054527812 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 137 AS nid, 0.07533201350278079 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 272 AS nid, 0.07522097039612041 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 546 AS nid, 0.07508475912789513 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 1095 AS nid, 0.0750119643504328 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 2188 AS nid, 0.07490211625255971 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 4379 AS nid, 0.07493812382276714 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 8757 AS nid, 0.07491650088909606 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 17512 AS nid, 0.0749283044022344 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 17513 AS nid, 0.07492529549588277 AS "Score" FROM SYSIBM.SYSDUMMY1) AS "Values"), 
"DT_Output_8" AS 
...
"DT_node_data_9" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE) AS "Score" 
FROM (SELECT 5 AS nid, -0.042089312546468235 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 6 AS nid, -0.03690609000317493 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 9 AS nid, 0.03519682417988506 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 14 AS nid, -0.08170311154688632 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 17 AS nid, 0.05967774251690508 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 30 AS nid, -0.07310613497336384 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 33 AS nid, 0.08316719964603045 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 62 AS nid, -0.0731286787614261 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 65 AS nid, 0.07522094380484144 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 126 AS nid, -0.07312914902028507 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 127 AS nid, -0.07312910831310288 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 128 AS nid, 0.07370378547675407 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 258 AS nid, 0.07337009415963981 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 519 AS nid, 0.07326924597017977 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 1036 AS nid, 0.0731146785607607 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 2075 AS nid, 0.0731181590778487 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 4148 AS nid, 0.07312399367335531 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 8298 AS nid, 0.07312765052508306 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 16598 AS nid, 0.07312935638410367 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 16599 AS nid, 0.07312838563478911 AS "Score" FROM SYSIBM.SYSDUMMY1) AS "Values"), 
"DT_Output_9" AS 
...
-- Code For temporary table tmp_20180508180823_codegen_o24e64_lgbm_b1 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180508180823_codegen_o24e64_lgbm_b1 (
	"KEY" BIGINT, 
	"Score_0" DOUBLE
)
...
-- Code For temporary table tmp_20180508180823_codegen_o24e64_lgbm_b1 part 2. Populate

INSERT INTO tmp_20180508180823_codegen_o24e64_lgbm_b1 WITH "DT_node_lookup_10" AS 
...
"DT_node_data_10" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE) AS "Score" 
FROM (SELECT 5 AS nid, -0.016514786348657554 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 6 AS nid, -0.02414362157884811 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 9 AS nid, 0.04995929137393105 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 14 AS nid, -0.07263837364939374 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 17 AS nid, 0.0737043166133568 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 33 AS nid, 0.07323087476710446 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 60 AS nid, -0.0714097418227018 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 61 AS nid, -0.07149603760655208 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 62 AS nid, -0.0715353350707039 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 64 AS nid, 0.07217903901790801 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 126 AS nid, -0.07148530502974197 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 127 AS nid, -0.07149814345095516 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 131 AS nid, 0.07197093490336108 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 260 AS nid, 0.07171661376535457 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 523 AS nid, 0.0715872979200132 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 1044 AS nid, 0.07152535318811849 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 2091 AS nid, 0.07148303058681718 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 4180 AS nid, 0.07149262730041803 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 8363 AS nid, 0.07149615994915863 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 16724 AS nid, 0.0714980665472603 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 16725 AS nid, 0.07149725696643605 AS "Score" FROM SYSIBM.SYSDUMMY1) AS "Values"), 
"DT_Output_10" AS 
...
"DT_node_data_11" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE) AS "Score" 
FROM (SELECT 5 AS nid, -0.03896400917783613 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 6 AS nid, -0.034261966311745044 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 9 AS nid, 0.03285546687934552 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 14 AS nid, -0.07857453577600587 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 17 AS nid, 0.05623692404833569 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 30 AS nid, -0.0699949292362282 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 33 AS nid, 0.07949698969077551 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 63 AS nid, -0.07001313721574971 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 65 AS nid, 0.07218446711620323 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 124 AS nid, -0.07001493487885747 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 125 AS nid, -0.0700143695171359 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 128 AS nid, 0.07048556108103786 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 258 AS nid, 0.0702114718645677 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 519 AS nid, 0.07013156900150673 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 1037 AS nid, 0.06999094476836583 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 2072 AS nid, 0.07000135884465551 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 4146 AS nid, 0.07000980975147011 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 8294 AS nid, 0.07001477641139196 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 16590 AS nid, 0.07001438351936916 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 16591 AS nid, 0.07001282446340361 AS "Score" FROM SYSIBM.SYSDUMMY1) AS "Values"), 
"DT_Output_11" AS 
...
"DT_node_data_12" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE) AS "Score" 
FROM (SELECT 5 AS nid, -0.015076628880380326 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 6 AS nid, -0.022017427329214245 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 9 AS nid, 0.046524181609464366 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 14 AS nid, -0.07039083550484013 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 17 AS nid, 0.07100951018552396 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 33 AS nid, 0.07022428794674981 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 60 AS nid, -0.06852366596585376 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 61 AS nid, -0.0686596268284067 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 62 AS nid, -0.06872993029305652 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 65 AS nid, 0.06948505898906011 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 126 AS nid, -0.06864268554991465 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 127 AS nid, -0.06866118982427533 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 128 AS nid, 0.06906571614708823 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 258 AS nid, 0.06884132684665632 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 519 AS nid, 0.06876812215248128 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 1037 AS nid, 0.06864689278822284 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 2072 AS nid, 0.06865521315868599 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 4147 AS nid, 0.06865919011292825 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 8292 AS nid, 0.06866127328768673 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 8293 AS nid, 0.0686605654503328 AS "Score" FROM SYSIBM.SYSDUMMY1) AS "Values"), 
"DT_Output_12" AS 
...
"DT_node_data_13" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE) AS "Score" 
FROM (SELECT 5 AS nid, -0.03611097851581999 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 6 AS nid, -0.03181932313553328 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 9 AS nid, 0.03068749502889036 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 14 AS nid, -0.07593983332859662 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 17 AS nid, 0.05316577334276195 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 30 AS nid, -0.06740549436705828 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 33 AS nid, 0.07648150800105012 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 62 AS nid, -0.06742030724344228 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 65 AS nid, 0.069641134045665 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 126 AS nid, -0.06742374825494978 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 127 AS nid, -0.06742273945317455 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 128 AS nid, 0.06781425282372186 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 258 AS nid, 0.06758582987395294 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 519 AS nid, 0.06752088824794668 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 1037 AS nid, 0.0673944395621863 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 2072 AS nid, 0.06740833079066924 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 4146 AS nid, 0.06741891414594693 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 8294 AS nid, 0.06742313452165187 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 16590 AS nid, 0.0674227506978624 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 16591 AS nid, 0.0674214378807726 AS "Score" FROM SYSIBM.SYSDUMMY1) AS "Values"), 
"DT_Output_13" AS 
...
"DT_node_data_14" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE) AS "Score" 
FROM (SELECT 5 AS nid, 0.030674450042139412 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 6 AS nid, 0.017952804520307883 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 8 AS nid, 0.04563238890651711 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 14 AS nid, -0.03861139037074292 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 19 AS nid, 0.08110440310858931 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 30 AS nid, -0.07699989633468136 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 37 AS nid, 0.056944838061214344 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 62 AS nid, -0.07008774459703444 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 73 AS nid, 0.07399910716833029 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 126 AS nid, -0.06628173390860316 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 145 AS nid, 0.06853202813853372 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 254 AS nid, -0.06628742799718611 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 288 AS nid, 0.06640724828109161 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 510 AS nid, -0.06628628749893971 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 511 AS nid, -0.06628701179942759 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 579 AS nid, 0.0663753081290589 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 1157 AS nid, 0.06625069259920188 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 2313 AS nid, 0.0663168015673976 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 4624 AS nid, 0.06628587482561724 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 4625 AS nid, 0.06627875257528591 AS "Score" FROM SYSIBM.SYSDUMMY1) AS "Values"), 
"DT_Output_14" AS 
...
"DT_node_data_15" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE) AS "Score" 
FROM (SELECT 5 AS nid, -0.017762811687231254 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 6 AS nid, -0.019401130940274357 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 9 AS nid, 0.035213039116728885 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 14 AS nid, -0.07739550748649766 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 17 AS nid, 0.06937844640628348 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 30 AS nid, -0.05387365054022436 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 33 AS nid, 0.06673518963867736 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 62 AS nid, -0.06730001856539584 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 65 AS nid, 0.06618191350679944 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 126 AS nid, -0.06508203525367383 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 128 AS nid, 0.06583527634164521 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 254 AS nid, -0.06524177482725951 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 255 AS nid, -0.06524246238157791 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 258 AS nid, 0.06546885743343826 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 519 AS nid, 0.06533851134014357 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 1037 AS nid, 0.06529080587320826 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 2073 AS nid, 0.06519795516001435 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 4145 AS nid, 0.06526947208504051 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 8288 AS nid, 0.06524127510291594 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 8289 AS nid, 0.06523066211444702 AS "Score" FROM SYSIBM.SYSDUMMY1) AS "Values"), 
"DT_Output_15" AS 
...
-- Code For temporary table tmp_20180508180823_codegen_5752gr_lgbm_union part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180508180823_codegen_5752gr_lgbm_union (
	"KEY" BIGINT, 
	"Score_0" DOUBLE
)
...
-- Code For temporary table tmp_20180508180823_codegen_5752gr_lgbm_union part 2. Populate

INSERT INTO tmp_20180508180823_codegen_5752gr_lgbm_union SELECT "LGBM_Union"."KEY", "LGBM_Union"."Score_0" 
...
FROM tmp_20180508180823_codegen_07gbag_lgbm_b0 AS "LGBM_B0" UNION ALL SELECT "LGBM_B1"."KEY" AS "KEY", "LGBM_B1"."Score_0" AS "Score_0" 
FROM tmp_20180508180823_codegen_o24e64_lgbm_b1 AS "LGBM_B1") AS "LGBM_EnsembleUnion") AS "LGBM_Union"

-- Code For temporary table tmp_20180508180823_codegen_958exo_lgbm_sum part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180508180823_codegen_958exo_lgbm_sum (
	"KEY" BIGINT, 
	"Score_0" DOUBLE
)
...
-- Code For temporary table tmp_20180508180823_codegen_958exo_lgbm_sum part 2. Populate

INSERT INTO tmp_20180508180823_codegen_958exo_lgbm_sum SELECT "LGBM_sum"."KEY", "LGBM_sum"."Score_0" 
...
FROM tmp_20180508180823_codegen_5752gr_lgbm_union AS "LGBM_Union" GROUP BY "LGBM_Union"."KEY") AS "T") AS "LGBM_sum"
...
FROM tmp_20180508180823_codegen_958exo_lgbm_sum AS "LGBM_sum"), 
