...
FROM `tmp_20180509002042_codegen_r8tglc_ads_imp_1_out` AS `ADS_imp_1_OUT`) AS `ADS_sca_2_OUT`

-- Code For temporary table tmp_20180509002042_codegen_w8ow0j_ads_sca_2_out part 2. Populate

SELECT * FROM `tmp_20180509002042_codegen_w8ow0j_ads_sca_2_out`

-- Code For temporary table tmp_20180509002042_codegen_cnkckk_lgbm_b0 part 1. Create 

CREATE TEMPORARY TABLE `tmp_20180509002042_codegen_cnkckk_lgbm_b0` STORED AS ORC AS WITH `DT_node_lookup` AS 
...
FROM `tmp_20180509002042_codegen_w8ow0j_ads_sca_2_out` AS `ADS_sca_2_OUT`), 
`DT_node_data` AS 
...
-- Code For temporary table tmp_20180509002042_codegen_cnkckk_lgbm_b0 part 2. Populate

SELECT * FROM `tmp_20180509002042_codegen_cnkckk_lgbm_b0`

-- Code For temporary table tmp_20180509002042_codegen_yygdrg_lgbm_b1 part 1. Create 

CREATE TEMPORARY TABLE `tmp_20180509002042_codegen_yygdrg_lgbm_b1` STORED AS ORC AS WITH `DT_node_lookup_10` AS 
(SELECT `ADS_sca_2_OUT`.`KEY` AS `KEY`, CASE WHEN (`ADS_sca_2_OUT`.`scaler_59` <= 0.43659448686368074) THEN CASE WHEN (`ADS_sca_2_OUT`.`scaler_69` <= -1.0000000180025095e-35) THEN 4 ELSE 5 END ELSE 3 END AS `node_id_2` 
FROM `tmp_20180509002042_codegen_w8ow0j_ads_sca_2_out` AS `ADS_sca_2_OUT`), 
`DT_node_data_10` AS 
(SELECT `Values`.`nid` AS `nid`, CAST(`Values`.`Score` AS DOUBLE) AS `Score` 
...
-- Code For temporary table tmp_20180509002042_codegen_yygdrg_lgbm_b1 part 2. Populate

SELECT * FROM `tmp_20180509002042_codegen_yygdrg_lgbm_b1`

-- Code For temporary table tmp_20180509002042_codegen_21rmd8_lgbm_union part 1. Create 

CREATE TEMPORARY TABLE `tmp_20180509002042_codegen_21rmd8_lgbm_union` STORED AS ORC AS SELECT `LGBM_Union`.`KEY`, `LGBM_Union`.`Score_0` 
...
FROM `tmp_20180509002042_codegen_cnkckk_lgbm_b0` AS `LGBM_B0` UNION ALL SELECT `LGBM_B1`.`KEY` AS `KEY`, `LGBM_B1`.`Score_0` AS `Score_0` 
FROM `tmp_20180509002042_codegen_yygdrg_lgbm_b1` AS `LGBM_B1`) AS `LGBM_EnsembleUnion`) AS `LGBM_Union`

-- Code For temporary table tmp_20180509002042_codegen_21rmd8_lgbm_union part 2. Populate

SELECT * FROM `tmp_20180509002042_codegen_21rmd8_lgbm_union`

-- Code For temporary table tmp_20180509002042_codegen_6heiff_lgbm_sum part 1. Create 

CREATE TEMPORARY TABLE `tmp_20180509002042_codegen_6heiff_lgbm_sum` STORED AS ORC AS SELECT `LGBM_sum`.`KEY`, `LGBM_sum`.`Score_0` 
...
FROM `tmp_20180509002042_codegen_21rmd8_lgbm_union` AS `LGBM_Union` GROUP BY `LGBM_Union`.`KEY`) AS `T`) AS `LGBM_sum`

-- Code For temporary table tmp_20180509002042_codegen_6heiff_lgbm_sum part 2. Populate

SELECT * FROM `tmp_20180509002042_codegen_6heiff_lgbm_sum`
...
FROM `tmp_20180509002042_codegen_6heiff_lgbm_sum` AS `LGBM_sum`), 
