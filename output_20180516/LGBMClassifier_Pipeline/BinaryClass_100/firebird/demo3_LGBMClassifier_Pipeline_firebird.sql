...
-- Code For temporary table TMP_20180516_CODEGEN_OW44JK_ADS part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180516_CODEGEN_OW44JK_ADS" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20180516_CODEGEN_OW44JK_ADS part 3. Create Index 

CREATE INDEX "ix_TMP_20180516_CODEGEN_08b2" ON "TMP_20180516_CODEGEN_OW44JK_ADS" ("KEY")

-- Code For temporary table TMP_20180516_CODEGEN_86ILXG_ADS part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180516_CODEGEN_86ILXG_ADS" (
	"KEY" BIGINT NOT NULL, 
...
FROM "TMP_20180516_CODEGEN_OW44JK_ADS" AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT") AS "U"

-- Code For temporary table TMP_20180516_CODEGEN_86ILXG_ADS part 3. Create Index 

CREATE INDEX "ix_TMP_20180516_CODEGEN_5410" ON "TMP_20180516_CODEGEN_86ILXG_ADS" ("KEY")

-- Code For temporary table TMP_20180516_CODEGEN_RZ4CO8_LGB part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180516_CODEGEN_RZ4CO8_LGB" (
	"KEY" BIGINT, 
...
-- Code For temporary table TMP_20180516_CODEGEN_RZ4CO8_LGB part 2. Populate

INSERT INTO "TMP_20180516_CODEGEN_RZ4CO8_LGB" ("KEY", "Score_0") SELECT "U"."KEY", "U"."Score_0" 
...
FROM "TMP_20180516_CODEGEN_86ILXG_ADS" AS "ADS_sca_2_OUT"), 
"DT_node_data" AS 
...
-- Code For temporary table TMP_20180516_CODEGEN_OY6OMQ_LGB part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180516_CODEGEN_OY6OMQ_LGB" (
	"KEY" BIGINT, 
	"Score_0" DOUBLE PRECISION
)
...
-- Code For temporary table TMP_20180516_CODEGEN_OY6OMQ_LGB part 2. Populate

INSERT INTO "TMP_20180516_CODEGEN_OY6OMQ_LGB" ("KEY", "Score_0") SELECT "U"."KEY", "U"."Score_0" 
...
-- Code For temporary table TMP_20180516_CODEGEN_GRDPXZ_LGB part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180516_CODEGEN_GRDPXZ_LGB" (
	"KEY" BIGINT NOT NULL, 
	"Score_0" DOUBLE PRECISION, 
	PRIMARY KEY ("KEY")
)
...
-- Code For temporary table TMP_20180516_CODEGEN_GRDPXZ_LGB part 2. Populate

INSERT INTO "TMP_20180516_CODEGEN_GRDPXZ_LGB" ("KEY", "Score_0") SELECT "U"."KEY", "U"."Score_0" 
...
FROM "TMP_20180516_CODEGEN_RZ4CO8_LGB" AS "LGBM_B0" UNION ALL SELECT "LGBM_B1"."KEY" AS "KEY", "LGBM_B1"."Score_0" AS "Score_0" 
FROM "TMP_20180516_CODEGEN_OY6OMQ_LGB" AS "LGBM_B1") AS "LGBM_EnsembleUnion")
...
-- Code For temporary table TMP_20180516_CODEGEN_GRDPXZ_LGB part 3. Create Index 

CREATE INDEX "ix_TMP_20180516_CODEGEN_13eb" ON "TMP_20180516_CODEGEN_GRDPXZ_LGB" ("KEY")
...
FROM "TMP_20180516_CODEGEN_GRDPXZ_LGB" AS "LGBM_sum"), 
