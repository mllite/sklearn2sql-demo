...
-- Code For temporary table TMP_20180602_TYQ_ADS_IMP_1_OUT part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180602_TYQ_ADS_IMP_1_OUT" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20180602_TYQ_ADS_IMP_1_OUT part 3. Create Index 

CREATE INDEX "ix_TMP_20180602_TYQ_ADS_a9d0" ON "TMP_20180602_TYQ_ADS_IMP_1_OUT" ("KEY")

-- Code For temporary table TMP_20180602_3J2_ADS_SCA_2_OUT part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180602_3J2_ADS_SCA_2_OUT" (
	"KEY" BIGINT NOT NULL, 
...
FROM "TMP_20180602_TYQ_ADS_IMP_1_OUT" AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT") AS "U"

-- Code For temporary table TMP_20180602_3J2_ADS_SCA_2_OUT part 3. Create Index 

CREATE INDEX "ix_TMP_20180602_3J2_ADS_60a2" ON "TMP_20180602_3J2_ADS_SCA_2_OUT" ("KEY")

-- Code For temporary table TMP_20180602_Z0V_LGBM_B0 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180602_Z0V_LGBM_B0" (
	"KEY" BIGINT, 
...
-- Code For temporary table TMP_20180602_Z0V_LGBM_B0 part 2. Populate

INSERT INTO "TMP_20180602_Z0V_LGBM_B0" ("KEY", "Score_0") SELECT "U"."KEY", "U"."Score_0" 
...
FROM "TMP_20180602_3J2_ADS_SCA_2_OUT" AS "ADS_sca_2_OUT"), 
"DT_node_data" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE PRECISION) AS "Score" 
FROM (SELECT 3 AS nid, 0.08181818181818183 AS "Score" FROM rdb$database UNION ALL SELECT 4 AS nid, -0.03599999999999998 AS "Score" FROM rdb$database UNION ALL SELECT 5 AS nid, -0.09999999999999999 AS "Score" FROM rdb$database) AS "Values"), 
"DT_Output" AS 
...
"DT_node_data_1" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE PRECISION) AS "Score" 
FROM (SELECT 3 AS nid, 0.07785970941192365 AS "Score" FROM rdb$database UNION ALL SELECT 4 AS nid, -0.09673857117668469 AS "Score" FROM rdb$database UNION ALL SELECT 5 AS nid, -0.03283595664042763 AS "Score" FROM rdb$database) AS "Values"), 
"DT_Output_1" AS 
...
"DT_node_data_2" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE PRECISION) AS "Score" 
FROM (SELECT 3 AS nid, 0.07432295598691702 AS "Score" FROM rdb$database UNION ALL SELECT 4 AS nid, -0.030996531781855366 AS "Score" FROM rdb$database UNION ALL SELECT 5 AS nid, -0.09267555851824433 AS "Score" FROM rdb$database) AS "Values"), 
"DT_Output_2" AS 
...
"DT_node_data_3" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE PRECISION) AS "Score" 
FROM (SELECT 3 AS nid, 0.06741724615167421 AS "Score" FROM rdb$database UNION ALL SELECT 4 AS nid, -0.027380638961790382 AS "Score" FROM rdb$database UNION ALL SELECT 5 AS nid, -0.09119865708847386 AS "Score" FROM rdb$database) AS "Values"), 
"DT_Output_3" AS 
...
"DT_node_data_4" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE PRECISION) AS "Score" 
FROM (SELECT 3 AS nid, 0.06839050087526723 AS "Score" FROM rdb$database UNION ALL SELECT 4 AS nid, -0.08785355253204136 AS "Score" FROM rdb$database UNION ALL SELECT 5 AS nid, -0.025913580168755546 AS "Score" FROM rdb$database) AS "Values"), 
"DT_Output_4" AS 
...
-- Code For temporary table TMP_20180602_3WG_LGBM_B1 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180602_3WG_LGBM_B1" (
	"KEY" BIGINT, 
	"Score_0" DOUBLE PRECISION
)
...
-- Code For temporary table TMP_20180602_3WG_LGBM_B1 part 2. Populate

INSERT INTO "TMP_20180602_3WG_LGBM_B1" ("KEY", "Score_0") SELECT "U"."KEY", "U"."Score_0" 
FROM (WITH "DT_node_lookup_5" AS 
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", CASE WHEN ("ADS_sca_2_OUT".scaler_59 <= -0.12473853899602892) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_35 <= -0.12595241060847376) THEN 4 ELSE 5 END ELSE 3 END AS node_id_2 
FROM "TMP_20180602_3J2_ADS_SCA_2_OUT" AS "ADS_sca_2_OUT"), 
"DT_node_data_5" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE PRECISION) AS "Score" 
FROM (SELECT 3 AS nid, 0.062228331449722674 AS "Score" FROM rdb$database UNION ALL SELECT 4 AS nid, -0.023575173547320145 AS "Score" FROM rdb$database UNION ALL SELECT 5 AS nid, -0.08564442830549451 AS "Score" FROM rdb$database) AS "Values"), 
"DT_Output_5" AS 
...
"DT_node_data_6" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE PRECISION) AS "Score" 
FROM (SELECT 3 AS nid, 0.08245927048178334 AS "Score" FROM rdb$database UNION ALL SELECT 4 AS nid, -0.013365798467164647 AS "Score" FROM rdb$database UNION ALL SELECT 5 AS nid, -0.08291398123871146 AS "Score" FROM rdb$database) AS "Values"), 
"DT_Output_6" AS 
...
"DT_node_data_7" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE PRECISION) AS "Score" 
FROM (SELECT 3 AS nid, 0.06142804449865933 AS "Score" FROM rdb$database UNION ALL SELECT 4 AS nid, -0.08162877916120868 AS "Score" FROM rdb$database UNION ALL SELECT 5 AS nid, -0.02040059253644598 AS "Score" FROM rdb$database) AS "Values"), 
"DT_Output_7" AS 
...
"DT_node_data_8" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE PRECISION) AS "Score" 
FROM (SELECT 3 AS nid, 0.07810925053835979 AS "Score" FROM rdb$database UNION ALL SELECT 4 AS nid, -0.07294274026665538 AS "Score" FROM rdb$database UNION ALL SELECT 5 AS nid, -0.005863559300908972 AS "Score" FROM rdb$database) AS "Values"), 
"DT_Output_8" AS 
...
"DT_node_data_9" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE PRECISION) AS "Score" 
FROM (SELECT 3 AS nid, 0.054859981056349455 AS "Score" FROM rdb$database UNION ALL SELECT 4 AS nid, -0.01648023217582348 AS "Score" FROM rdb$database UNION ALL SELECT 5 AS nid, -0.07894508830748041 AS "Score" FROM rdb$database) AS "Values"), 
"DT_Output_9" AS 
...
-- Code For temporary table TMP_20180602_16V_LGBM_B2 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180602_16V_LGBM_B2" (
	"KEY" BIGINT, 
	"Score_0" DOUBLE PRECISION
)
...
-- Code For temporary table TMP_20180602_16V_LGBM_B2 part 2. Populate

INSERT INTO "TMP_20180602_16V_LGBM_B2" ("KEY", "Score_0") SELECT "U"."KEY", "U"."Score_0" 
FROM (WITH "DT_node_lookup_10" AS 
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", CASE WHEN ("ADS_sca_2_OUT".scaler_59 <= 0.43659448686368074) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_69 <= -1.0000000180025095e-35) THEN 4 ELSE 5 END ELSE 3 END AS node_id_2 
FROM "TMP_20180602_3J2_ADS_SCA_2_OUT" AS "ADS_sca_2_OUT"), 
"DT_node_data_10" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE PRECISION) AS "Score" 
FROM (SELECT 3 AS nid, 0.07460942774447822 AS "Score" FROM rdb$database UNION ALL SELECT 4 AS nid, -0.07006385064146675 AS "Score" FROM rdb$database UNION ALL SELECT 5 AS nid, -0.004144784333954733 AS "Score" FROM rdb$database) AS "Values"), 
"DT_Output_10" AS 
...
"DT_node_data_11" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE PRECISION) AS "Score" 
FROM (SELECT 3 AS nid, 0.07284015624878848 AS "Score" FROM rdb$database UNION ALL SELECT 4 AS nid, -0.007785792508336553 AS "Score" FROM rdb$database UNION ALL SELECT 5 AS nid, -0.07585509271957948 AS "Score" FROM rdb$database) AS "Values"), 
"DT_Output_11" AS 
...
"DT_node_data_12" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE PRECISION) AS "Score" 
FROM (SELECT 3 AS nid, 0.05060905874934717 AS "Score" FROM rdb$database UNION ALL SELECT 4 AS nid, -0.0123554001606472 AS "Score" FROM rdb$database UNION ALL SELECT 5 AS nid, -0.0751030280309172 AS "Score" FROM rdb$database) AS "Values"), 
"DT_Output_12" AS 
...
"DT_node_data_13" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE PRECISION) AS "Score" 
FROM (SELECT 3 AS nid, 0.07018764956421157 AS "Score" FROM rdb$database UNION ALL SELECT 4 AS nid, -0.06675491108606207 AS "Score" FROM rdb$database UNION ALL SELECT 5 AS nid, -0.001022453214534634 AS "Score" FROM rdb$database) AS "Values"), 
"DT_Output_13" AS 
...
"DT_node_data_14" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE PRECISION) AS "Score" 
FROM (SELECT 3 AS nid, 0.06881930045814363 AS "Score" FROM rdb$database UNION ALL SELECT 4 AS nid, -0.0053395535624281565 AS "Score" FROM rdb$database UNION ALL SELECT 5 AS nid, -0.07247379904915023 AS "Score" FROM rdb$database) AS "Values"), 
"DT_Output_14" AS 
...
-- Code For temporary table TMP_20180602_15J_LGBM_B3 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180602_15J_LGBM_B3" (
	"KEY" BIGINT, 
	"Score_0" DOUBLE PRECISION
)
...
-- Code For temporary table TMP_20180602_15J_LGBM_B3 part 2. Populate

INSERT INTO "TMP_20180602_15J_LGBM_B3" ("KEY", "Score_0") SELECT "U"."KEY", "U"."Score_0" 
...
"DT_node_data_15" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE PRECISION) AS "Score" 
FROM (SELECT 3 AS nid, 0.06756773879157398 AS "Score" FROM rdb$database UNION ALL SELECT 4 AS nid, 0.00971361452718884 AS "Score" FROM rdb$database UNION ALL SELECT 5 AS nid, -0.05611229182065938 AS "Score" FROM rdb$database) AS "Values"), 
"DT_Output_15" AS 
...
-- Code For temporary table TMP_20180602_258_LGBM_SUM part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180602_258_LGBM_SUM" (
	"KEY" BIGINT NOT NULL, 
	"Score_0" DOUBLE PRECISION, 
	PRIMARY KEY ("KEY")
)
...
-- Code For temporary table TMP_20180602_258_LGBM_SUM part 2. Populate

INSERT INTO "TMP_20180602_258_LGBM_SUM" ("KEY", "Score_0") SELECT "U"."KEY", "U"."Score_0" 
...
FROM "TMP_20180602_Z0V_LGBM_B0" AS "LGBM_B0" UNION ALL SELECT "LGBM_B1"."KEY" AS "KEY", "LGBM_B1"."Score_0" AS "Score_0" 
FROM "TMP_20180602_3WG_LGBM_B1" AS "LGBM_B1" UNION ALL SELECT "LGBM_B2"."KEY" AS "KEY", "LGBM_B2"."Score_0" AS "Score_0" 
FROM "TMP_20180602_16V_LGBM_B2" AS "LGBM_B2" UNION ALL SELECT "LGBM_B3"."KEY" AS "KEY", "LGBM_B3"."Score_0" AS "Score_0" 
FROM "TMP_20180602_15J_LGBM_B3" AS "LGBM_B3") AS "LGBM_EnsembleUnion")
...
-- Code For temporary table TMP_20180602_258_LGBM_SUM part 3. Create Index 

CREATE INDEX "ix_TMP_20180602_258_LGB_d5a5" ON "TMP_20180602_258_LGBM_SUM" ("KEY")
...
FROM "TMP_20180602_258_LGBM_SUM" AS "LGBM_sum"), 
