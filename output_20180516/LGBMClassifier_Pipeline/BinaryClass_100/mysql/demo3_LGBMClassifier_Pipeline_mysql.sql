...
-- Code For temporary table TMP_20180516111032_CODEGEN_TK2LG6_ADS_imp_1_OUT part 1. Create 


CREATE TEMPORARY TABLE `TMP_20180516111032_CODEGEN_TK2LG6_ADS_imp_1_OUT` (
	`KEY` BIGINT NOT NULL, 
	impter_2 DOUBLE, 
	impter_3 DOUBLE, 
	impter_4 DOUBLE, 
...
-- Code For temporary table TMP_20180516111032_CODEGEN_TK2LG6_ADS_imp_1_OUT part 3. Create Index 

CREATE INDEX `ix_TMP_20180516111032_CODEGEN_TK2LG6_ADS_imp_1_OUT_KEY` ON `TMP_20180516111032_CODEGEN_TK2LG6_ADS_imp_1_OUT` (`KEY`)

-- Code For temporary table TMP_20180516111032_CODEGEN_1CWJ6K_ADS_sca_2_OUT part 1. Create 


CREATE TEMPORARY TABLE `TMP_20180516111032_CODEGEN_1CWJ6K_ADS_sca_2_OUT` (
	`KEY` BIGINT NOT NULL, 
	scaler_2 DOUBLE, 
	scaler_3 DOUBLE, 
	scaler_4 DOUBLE, 
...
FROM `TMP_20180516111032_CODEGEN_TK2LG6_ADS_imp_1_OUT` AS `ADS_imp_1_OUT`) AS `ADS_sca_2_OUT`) AS `U`

-- Code For temporary table TMP_20180516111032_CODEGEN_1CWJ6K_ADS_sca_2_OUT part 3. Create Index 

CREATE INDEX `ix_TMP_20180516111032_CODEGEN_1CWJ6K_ADS_sca_2_OUT_KEY` ON `TMP_20180516111032_CODEGEN_1CWJ6K_ADS_sca_2_OUT` (`KEY`)

-- Code For temporary table TMP_20180516111032_CODEGEN_XOWA21_LGBM_B0 part 1. Create 


CREATE TEMPORARY TABLE `TMP_20180516111032_CODEGEN_XOWA21_LGBM_B0` (
	`KEY` BIGINT, 
	`Score_0` DOUBLE
)
...
-- Code For temporary table TMP_20180516111032_CODEGEN_XOWA21_LGBM_B0 part 2. Populate

INSERT INTO `TMP_20180516111032_CODEGEN_XOWA21_LGBM_B0` (`KEY`, `Score_0`) SELECT `U`.`KEY`, `U`.`Score_0` 
...
FROM `TMP_20180516111032_CODEGEN_1CWJ6K_ADS_sca_2_OUT` AS `ADS_sca_2_OUT`), 
`DT_node_data` AS 
...
-- Code For temporary table TMP_20180516111032_CODEGEN_XBFZHK_LGBM_B1 part 1. Create 


CREATE TEMPORARY TABLE `TMP_20180516111032_CODEGEN_XBFZHK_LGBM_B1` (
	`KEY` BIGINT, 
	`Score_0` DOUBLE
)
...
-- Code For temporary table TMP_20180516111032_CODEGEN_XBFZHK_LGBM_B1 part 2. Populate

INSERT INTO `TMP_20180516111032_CODEGEN_XBFZHK_LGBM_B1` (`KEY`, `Score_0`) SELECT `U`.`KEY`, `U`.`Score_0` 
...
-- Code For temporary table TMP_20180516111032_CODEGEN_0Y5FDP_LGBM_sum part 1. Create 


CREATE TEMPORARY TABLE `TMP_20180516111032_CODEGEN_0Y5FDP_LGBM_sum` (
	`KEY` BIGINT NOT NULL, 
	`Score_0` DOUBLE, 
	PRIMARY KEY (`KEY`)
)
...
-- Code For temporary table TMP_20180516111032_CODEGEN_0Y5FDP_LGBM_sum part 2. Populate

INSERT INTO `TMP_20180516111032_CODEGEN_0Y5FDP_LGBM_sum` (`KEY`, `Score_0`) SELECT `U`.`KEY`, `U`.`Score_0` 
...
FROM `TMP_20180516111032_CODEGEN_XOWA21_LGBM_B0` AS `LGBM_B0` UNION ALL SELECT `LGBM_B1`.`KEY` AS `KEY`, `LGBM_B1`.`Score_0` AS `Score_0` 
FROM `TMP_20180516111032_CODEGEN_XBFZHK_LGBM_B1` AS `LGBM_B1`) AS `LGBM_EnsembleUnion`)
...
-- Code For temporary table TMP_20180516111032_CODEGEN_0Y5FDP_LGBM_sum part 3. Create Index 

CREATE INDEX `ix_TMP_20180516111032_CODEGEN_0Y5FDP_LGBM_sum_KEY` ON `TMP_20180516111032_CODEGEN_0Y5FDP_LGBM_sum` (`KEY`)
...
FROM `TMP_20180516111032_CODEGEN_0Y5FDP_LGBM_sum` AS `LGBM_sum`), 
