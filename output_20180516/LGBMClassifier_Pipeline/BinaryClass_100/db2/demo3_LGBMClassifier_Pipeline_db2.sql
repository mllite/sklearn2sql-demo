...
-- Code For temporary table tmp_20180516111036_codegen_f0mkcp_ads_imp_1_out part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180516111036_codegen_f0mkcp_ads_imp_1_out (
	"KEY" BIGINT, 
	impter_2 DOUBLE, 
	impter_3 DOUBLE, 
	impter_4 DOUBLE, 
...
-- Code For temporary table tmp_20180516111036_codegen_10h2ux_ads_sca_2_out part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180516111036_codegen_10h2ux_ads_sca_2_out (
	"KEY" BIGINT, 
	scaler_2 DOUBLE, 
	scaler_3 DOUBLE, 
	scaler_4 DOUBLE, 
...
FROM tmp_20180516111036_codegen_f0mkcp_ads_imp_1_out AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT"

-- Code For temporary table tmp_20180516111036_codegen_t86ttk_lgbm_b0 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180516111036_codegen_t86ttk_lgbm_b0 (
	"KEY" BIGINT, 
	"Score_0" DOUBLE
)
...
-- Code For temporary table tmp_20180516111036_codegen_t86ttk_lgbm_b0 part 2. Populate

INSERT INTO tmp_20180516111036_codegen_t86ttk_lgbm_b0 WITH "DT_node_lookup" AS 
...
FROM tmp_20180516111036_codegen_10h2ux_ads_sca_2_out AS "ADS_sca_2_OUT"), 
"DT_node_data" AS 
...
-- Code For temporary table tmp_20180516111036_codegen_1cek0c_lgbm_b1 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180516111036_codegen_1cek0c_lgbm_b1 (
	"KEY" BIGINT, 
	"Score_0" DOUBLE
)
...
-- Code For temporary table tmp_20180516111036_codegen_1cek0c_lgbm_b1 part 2. Populate

INSERT INTO tmp_20180516111036_codegen_1cek0c_lgbm_b1 WITH "DT_node_lookup_10" AS 
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", CASE WHEN ("ADS_sca_2_OUT".scaler_59 <= 0.43659448686368074) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_69 <= -1.0000000180025095e-35) THEN 4 ELSE 5 END ELSE 3 END AS node_id_2 
FROM tmp_20180516111036_codegen_10h2ux_ads_sca_2_out AS "ADS_sca_2_OUT"), 
"DT_node_data_10" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE) AS "Score" 
...
-- Code For temporary table tmp_20180516111036_codegen_ltwecs_lgbm_sum part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180516111036_codegen_ltwecs_lgbm_sum (
	"KEY" BIGINT, 
	"Score_0" DOUBLE
)
...
-- Code For temporary table tmp_20180516111036_codegen_ltwecs_lgbm_sum part 2. Populate

INSERT INTO tmp_20180516111036_codegen_ltwecs_lgbm_sum WITH "LGBM_Union" AS 
...
FROM tmp_20180516111036_codegen_t86ttk_lgbm_b0 AS "LGBM_B0" UNION ALL SELECT "LGBM_B1"."KEY" AS "KEY", "LGBM_B1"."Score_0" AS "Score_0" 
FROM tmp_20180516111036_codegen_1cek0c_lgbm_b1 AS "LGBM_B1") AS "LGBM_EnsembleUnion")
...
FROM tmp_20180516111036_codegen_ltwecs_lgbm_sum AS "LGBM_sum"), 
