...
-- Code For temporary table DEGEN_5IAQ3S_ADS_IMP_1_OUT part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "DEGEN_5IAQ3S_ADS_IMP_1_OUT" (
	"KEY" NUMBER(19), 
...
-- Code For temporary table DEGEN_5IAQ3S_ADS_IMP_1_OUT part 2. Populate

INSERT INTO "DEGEN_5IAQ3S_ADS_IMP_1_OUT" ("KEY", imputer_output_2, imputer_output_3, imputer_output_4, imputer_output_5) SELECT "U"."KEY", "U".imputer_output_2, "U".imputer_output_3, "U".imputer_output_4, "U".imputer_output_5 
...
-- Code For temporary table DEGEN_54AMBT_ADS_SCA_2_OUT part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "DEGEN_54AMBT_ADS_SCA_2_OUT" (
	"KEY" NUMBER(19), 
...
-- Code For temporary table DEGEN_54AMBT_ADS_SCA_2_OUT part 2. Populate

INSERT INTO "DEGEN_54AMBT_ADS_SCA_2_OUT" ("KEY", scaler_output_2, scaler_output_3, scaler_output_4, scaler_output_5) SELECT "U"."KEY", "U".scaler_output_2, "U".scaler_output_3, "U".scaler_output_4, "U".scaler_output_5 
...
FROM "DEGEN_5IAQ3S_ADS_IMP_1_OUT" "ADS_imp_1_OUT") "ADS_sca_2_OUT") "U"

-- Code For temporary table 516_CODEGEN_FHZ0YS_LGBM_B0 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "516_CODEGEN_FHZ0YS_LGBM_B0" (
	"KEY" NUMBER(19), 
...
-- Code For temporary table 516_CODEGEN_FHZ0YS_LGBM_B0 part 2. Populate

INSERT INTO "516_CODEGEN_FHZ0YS_LGBM_B0" ("KEY", "Score_0", "Score_1", "Score_2") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1", "U"."Score_2" 
...
FROM "DEGEN_54AMBT_ADS_SCA_2_OUT" "ADS_sca_2_OUT"), 
"DT_node_data" AS 
...
-- Code For temporary table 516_CODEGEN_6ZP9XJ_LGBM_B1 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "516_CODEGEN_6ZP9XJ_LGBM_B1" (
	"KEY" NUMBER(19), 
	"Score_0" BINARY_DOUBLE, 
	"Score_1" BINARY_DOUBLE, 
	"Score_2" BINARY_DOUBLE
...
-- Code For temporary table 516_CODEGEN_6ZP9XJ_LGBM_B1 part 2. Populate

INSERT INTO "516_CODEGEN_6ZP9XJ_LGBM_B1" ("KEY", "Score_0", "Score_1", "Score_2") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1", "U"."Score_2" 
...
-- Code For temporary table 516_CODEGEN_XFBS0L_LGBM_B2 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "516_CODEGEN_XFBS0L_LGBM_B2" (
	"KEY" NUMBER(19), 
	"Score_0" BINARY_DOUBLE, 
	"Score_1" BINARY_DOUBLE, 
	"Score_2" BINARY_DOUBLE
...
-- Code For temporary table 516_CODEGEN_XFBS0L_LGBM_B2 part 2. Populate

INSERT INTO "516_CODEGEN_XFBS0L_LGBM_B2" ("KEY", "Score_0", "Score_1", "Score_2") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1", "U"."Score_2" 
...
-- Code For temporary table 516_CODEGEN_SULWQR_LGBM_B3 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "516_CODEGEN_SULWQR_LGBM_B3" (
	"KEY" NUMBER(19), 
	"Score_0" BINARY_DOUBLE, 
	"Score_1" BINARY_DOUBLE, 
	"Score_2" BINARY_DOUBLE
...
-- Code For temporary table 516_CODEGEN_SULWQR_LGBM_B3 part 2. Populate

INSERT INTO "516_CODEGEN_SULWQR_LGBM_B3" ("KEY", "Score_0", "Score_1", "Score_2") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1", "U"."Score_2" 
...
-- Code For temporary table 516_CODEGEN_H2SWPU_LGBM_B4 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "516_CODEGEN_H2SWPU_LGBM_B4" (
	"KEY" NUMBER(19), 
	"Score_0" BINARY_DOUBLE, 
	"Score_1" BINARY_DOUBLE, 
	"Score_2" BINARY_DOUBLE
...
-- Code For temporary table 516_CODEGEN_H2SWPU_LGBM_B4 part 2. Populate

INSERT INTO "516_CODEGEN_H2SWPU_LGBM_B4" ("KEY", "Score_0", "Score_1", "Score_2") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1", "U"."Score_2" 
...
-- Code For temporary table 16_CODEGEN_JCD631_LGBM_SUM part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "16_CODEGEN_JCD631_LGBM_SUM" (
	"KEY" NUMBER(19), 
	"Score_0" BINARY_DOUBLE, 
	"Score_1" BINARY_DOUBLE, 
	"Score_2" BINARY_DOUBLE
...
-- Code For temporary table 16_CODEGEN_JCD631_LGBM_SUM part 2. Populate

INSERT INTO "16_CODEGEN_JCD631_LGBM_SUM" ("KEY", "Score_0", "Score_1", "Score_2") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1", "U"."Score_2" 
...
FROM "516_CODEGEN_FHZ0YS_LGBM_B0" "LGBM_B0" UNION ALL SELECT "LGBM_B1"."KEY" AS "KEY", "LGBM_B1"."Score_0" AS "Score_0", "LGBM_B1"."Score_1" AS "Score_1", "LGBM_B1"."Score_2" AS "Score_2" 
FROM "516_CODEGEN_6ZP9XJ_LGBM_B1" "LGBM_B1" UNION ALL SELECT "LGBM_B2"."KEY" AS "KEY", "LGBM_B2"."Score_0" AS "Score_0", "LGBM_B2"."Score_1" AS "Score_1", "LGBM_B2"."Score_2" AS "Score_2" 
FROM "516_CODEGEN_XFBS0L_LGBM_B2" "LGBM_B2" UNION ALL SELECT "LGBM_B3"."KEY" AS "KEY", "LGBM_B3"."Score_0" AS "Score_0", "LGBM_B3"."Score_1" AS "Score_1", "LGBM_B3"."Score_2" AS "Score_2" 
FROM "516_CODEGEN_SULWQR_LGBM_B3" "LGBM_B3" UNION ALL SELECT "LGBM_B4"."KEY" AS "KEY", "LGBM_B4"."Score_0" AS "Score_0", "LGBM_B4"."Score_1" AS "Score_1", "LGBM_B4"."Score_2" AS "Score_2" 
FROM "516_CODEGEN_H2SWPU_LGBM_B4" "LGBM_B4") "LGBM_EnsembleUnion")
...
FROM "16_CODEGEN_JCD631_LGBM_SUM" "LGBM_sum"), 
