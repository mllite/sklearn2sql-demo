...
-- Code For temporary table TMP_20180508185642_CODEGEN_JJXF part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508185642_CODEGEN_JJXF" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20180508185642_CODEGEN_JJXF part 2. Populate

INSERT INTO "TMP_20180508185642_CODEGEN_JJXF" ("KEY", imputer_output_2, imputer_output_3, imputer_output_4, imputer_output_5) SELECT "U"."KEY", "U".imputer_output_2, "U".imputer_output_3, "U".imputer_output_4, "U".imputer_output_5 
...
-- Code For temporary table TMP_20180508185642_CODEGEN_JJXF part 3. Create Index 

CREATE INDEX "ix_TMP_20180508185642_C_7613" ON "TMP_20180508185642_CODEGEN_JJXF" ("KEY")

-- Code For temporary table TMP_20180508185642_CODEGEN_Q7IE part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508185642_CODEGEN_Q7IE" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20180508185642_CODEGEN_Q7IE part 2. Populate

INSERT INTO "TMP_20180508185642_CODEGEN_Q7IE" ("KEY", scaler_output_2, scaler_output_3, scaler_output_4, scaler_output_5) SELECT "U"."KEY", "U".scaler_output_2, "U".scaler_output_3, "U".scaler_output_4, "U".scaler_output_5 
...
FROM "TMP_20180508185642_CODEGEN_JJXF" AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT") AS "U"

-- Code For temporary table TMP_20180508185642_CODEGEN_Q7IE part 3. Create Index 

CREATE INDEX "ix_TMP_20180508185642_C_4454" ON "TMP_20180508185642_CODEGEN_Q7IE" ("KEY")

-- Code For temporary table TMP_20180508185642_CODEGEN_B4KJ part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508185642_CODEGEN_B4KJ" (
	"KEY" BIGINT, 
...
-- Code For temporary table TMP_20180508185642_CODEGEN_B4KJ part 2. Populate

INSERT INTO "TMP_20180508185642_CODEGEN_B4KJ" ("KEY", "Score_0", "Score_1", "Score_2") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1", "U"."Score_2" 
...
FROM "TMP_20180508185642_CODEGEN_Q7IE" AS "ADS_sca_2_OUT"), 
"DT_node_data" AS 
...
-- Code For temporary table TMP_20180508185642_CODEGEN_PCGC part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508185642_CODEGEN_PCGC" (
	"KEY" BIGINT, 
	"Score_0" DOUBLE PRECISION, 
	"Score_1" DOUBLE PRECISION, 
	"Score_2" DOUBLE PRECISION
...
-- Code For temporary table TMP_20180508185642_CODEGEN_PCGC part 2. Populate

INSERT INTO "TMP_20180508185642_CODEGEN_PCGC" ("KEY", "Score_0", "Score_1", "Score_2") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1", "U"."Score_2" 
...
-- Code For temporary table TMP_20180508185642_CODEGEN_NWIJ part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508185642_CODEGEN_NWIJ" (
	"KEY" BIGINT, 
	"Score_0" DOUBLE PRECISION, 
	"Score_1" DOUBLE PRECISION, 
	"Score_2" DOUBLE PRECISION
...
-- Code For temporary table TMP_20180508185642_CODEGEN_NWIJ part 2. Populate

INSERT INTO "TMP_20180508185642_CODEGEN_NWIJ" ("KEY", "Score_0", "Score_1", "Score_2") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1", "U"."Score_2" 
...
-- Code For temporary table TMP_20180508185642_CODEGEN_KBUQ part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508185642_CODEGEN_KBUQ" (
	"KEY" BIGINT, 
	"Score_0" DOUBLE PRECISION, 
	"Score_1" DOUBLE PRECISION, 
	"Score_2" DOUBLE PRECISION
...
-- Code For temporary table TMP_20180508185642_CODEGEN_KBUQ part 2. Populate

INSERT INTO "TMP_20180508185642_CODEGEN_KBUQ" ("KEY", "Score_0", "Score_1", "Score_2") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1", "U"."Score_2" 
...
-- Code For temporary table TMP_20180508185642_CODEGEN_U715 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508185642_CODEGEN_U715" (
	"KEY" BIGINT, 
	"Score_0" DOUBLE PRECISION, 
	"Score_1" DOUBLE PRECISION, 
	"Score_2" DOUBLE PRECISION
...
-- Code For temporary table TMP_20180508185642_CODEGEN_U715 part 2. Populate

INSERT INTO "TMP_20180508185642_CODEGEN_U715" ("KEY", "Score_0", "Score_1", "Score_2") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1", "U"."Score_2" 
...
-- Code For temporary table TMP_20180508185642_CODEGEN_YG82 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508185642_CODEGEN_YG82" (
	"KEY" BIGINT, 
	"Score_0" DOUBLE PRECISION, 
	"Score_1" DOUBLE PRECISION, 
	"Score_2" DOUBLE PRECISION
...
-- Code For temporary table TMP_20180508185642_CODEGEN_YG82 part 2. Populate

INSERT INTO "TMP_20180508185642_CODEGEN_YG82" ("KEY", "Score_0", "Score_1", "Score_2") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1", "U"."Score_2" 
...
FROM "TMP_20180508185642_CODEGEN_B4KJ" AS "LGBM_B0" UNION ALL SELECT "LGBM_B1"."KEY" AS "KEY", "LGBM_B1"."Score_0" AS "Score_0", "LGBM_B1"."Score_1" AS "Score_1", "LGBM_B1"."Score_2" AS "Score_2" 
FROM "TMP_20180508185642_CODEGEN_PCGC" AS "LGBM_B1" UNION ALL SELECT "LGBM_B2"."KEY" AS "KEY", "LGBM_B2"."Score_0" AS "Score_0", "LGBM_B2"."Score_1" AS "Score_1", "LGBM_B2"."Score_2" AS "Score_2" 
FROM "TMP_20180508185642_CODEGEN_NWIJ" AS "LGBM_B2" UNION ALL SELECT "LGBM_B3"."KEY" AS "KEY", "LGBM_B3"."Score_0" AS "Score_0", "LGBM_B3"."Score_1" AS "Score_1", "LGBM_B3"."Score_2" AS "Score_2" 
FROM "TMP_20180508185642_CODEGEN_KBUQ" AS "LGBM_B3" UNION ALL SELECT "LGBM_B4"."KEY" AS "KEY", "LGBM_B4"."Score_0" AS "Score_0", "LGBM_B4"."Score_1" AS "Score_1", "LGBM_B4"."Score_2" AS "Score_2" 
FROM "TMP_20180508185642_CODEGEN_U715" AS "LGBM_B4") AS "LGBM_EnsembleUnion") AS "LGBM_Union") AS "U"

-- Code For temporary table TMP_20180508185642_CODEGEN_TXCM part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508185642_CODEGEN_TXCM" (
	"KEY" BIGINT NOT NULL, 
	"Score_0" DOUBLE PRECISION, 
	"Score_1" DOUBLE PRECISION, 
	"Score_2" DOUBLE PRECISION, 
...
-- Code For temporary table TMP_20180508185642_CODEGEN_TXCM part 2. Populate

INSERT INTO "TMP_20180508185642_CODEGEN_TXCM" ("KEY", "Score_0", "Score_1", "Score_2") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1", "U"."Score_2" 
...
FROM "TMP_20180508185642_CODEGEN_YG82" AS "LGBM_Union" GROUP BY "LGBM_Union"."KEY") AS "T") AS "LGBM_sum") AS "U"

-- Code For temporary table TMP_20180508185642_CODEGEN_TXCM part 3. Create Index 

CREATE INDEX "ix_TMP_20180508185642_C_fdb0" ON "TMP_20180508185642_CODEGEN_TXCM" ("KEY")
...
FROM "TMP_20180508185642_CODEGEN_TXCM" AS "LGBM_sum"), 
