...
-- Code For temporary table TMP_20180508185641_CODEGEN_WK43R6_ADS_imp_1_OUT part 1. Create 


CREATE TEMPORARY TABLE "TMP_20180508185641_CODEGEN_WK43R6_ADS_imp_1_OUT" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20180508185641_CODEGEN_WK43R6_ADS_imp_1_OUT part 2. Populate

INSERT INTO "TMP_20180508185641_CODEGEN_WK43R6_ADS_imp_1_OUT" ("KEY", imputer_output_2, imputer_output_3, imputer_output_4, imputer_output_5) SELECT "ADS_imp_1_OUT"."KEY", "ADS_imp_1_OUT".imputer_output_2, "ADS_imp_1_OUT".imputer_output_3, "ADS_imp_1_OUT".imputer_output_4, "ADS_imp_1_OUT".imputer_output_5 
FROM (SELECT "ADS"."KEY" AS "KEY", CASE WHEN ("ADS"."Feature_0" IS NULL) THEN 5.8474999999999975 ELSE "ADS"."Feature_0" END AS imputer_output_2, CASE WHEN ("ADS"."Feature_1" IS NULL) THEN 3.0366666666666657 ELSE "ADS"."Feature_1" END AS imputer_output_3, CASE WHEN ("ADS"."Feature_2" IS NULL) THEN 3.8450000000000006 ELSE "ADS"."Feature_2" END AS imputer_output_4, CASE WHEN ("ADS"."Feature_3" IS NULL) THEN 1.245 ELSE "ADS"."Feature_3" END AS imputer_output_5 
FROM iris AS "ADS") AS "ADS_imp_1_OUT"

-- Code For temporary table TMP_20180508185641_CODEGEN_WK43R6_ADS_imp_1_OUT part 3. Create Index 

CREATE INDEX "ix_TMP_20180508185641_CODEGEN_WK43R6_ADS_imp_1_OUT_KEY" ON "TMP_20180508185641_CODEGEN_WK43R6_ADS_imp_1_OUT" ("KEY")

-- Code For temporary table TMP_20180508185641_CODEGEN_VR7ODZ_ADS_sca_2_OUT part 1. Create 


CREATE TEMPORARY TABLE "TMP_20180508185641_CODEGEN_VR7ODZ_ADS_sca_2_OUT" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20180508185641_CODEGEN_VR7ODZ_ADS_sca_2_OUT part 2. Populate

INSERT INTO "TMP_20180508185641_CODEGEN_VR7ODZ_ADS_sca_2_OUT" ("KEY", scaler_output_2, scaler_output_3, scaler_output_4, scaler_output_5) SELECT "ADS_sca_2_OUT"."KEY", "ADS_sca_2_OUT".scaler_output_2, "ADS_sca_2_OUT".scaler_output_3, "ADS_sca_2_OUT".scaler_output_4, "ADS_sca_2_OUT".scaler_output_5 
...
FROM "TMP_20180508185641_CODEGEN_WK43R6_ADS_imp_1_OUT" AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT"

-- Code For temporary table TMP_20180508185641_CODEGEN_VR7ODZ_ADS_sca_2_OUT part 3. Create Index 

CREATE INDEX "ix_TMP_20180508185641_CODEGEN_VR7ODZ_ADS_sca_2_OUT_KEY" ON "TMP_20180508185641_CODEGEN_VR7ODZ_ADS_sca_2_OUT" ("KEY")

-- Code For temporary table TMP_20180508185641_CODEGEN_SPGHH2_LGBM_B0 part 1. Create 


CREATE TEMPORARY TABLE "TMP_20180508185641_CODEGEN_SPGHH2_LGBM_B0" (
	"KEY" BIGINT, 
	"Score_0" FLOAT, 
	"Score_1" FLOAT, 
	"Score_2" FLOAT
...
-- Code For temporary table TMP_20180508185641_CODEGEN_SPGHH2_LGBM_B0 part 2. Populate
...
FROM "TMP_20180508185641_CODEGEN_VR7ODZ_ADS_sca_2_OUT" AS "ADS_sca_2_OUT"), 
"DT_node_data" AS 
...
FROM "DT_Output_9")
 INSERT INTO "TMP_20180508185641_CODEGEN_SPGHH2_LGBM_B0" ("KEY", "Score_0", "Score_1", "Score_2") SELECT "LGBM_B0"."KEY", "LGBM_B0"."Score_0", "LGBM_B0"."Score_1", "LGBM_B0"."Score_2" 
...
-- Code For temporary table TMP_20180508185641_CODEGEN_U3I7RL_LGBM_B1 part 1. Create 


CREATE TEMPORARY TABLE "TMP_20180508185641_CODEGEN_U3I7RL_LGBM_B1" (
	"KEY" BIGINT, 
	"Score_0" FLOAT, 
	"Score_1" FLOAT, 
	"Score_2" FLOAT
...
-- Code For temporary table TMP_20180508185641_CODEGEN_U3I7RL_LGBM_B1 part 2. Populate
...
FROM "DT_Output_19")
 INSERT INTO "TMP_20180508185641_CODEGEN_U3I7RL_LGBM_B1" ("KEY", "Score_0", "Score_1", "Score_2") SELECT "LGBM_B1"."KEY", "LGBM_B1"."Score_0", "LGBM_B1"."Score_1", "LGBM_B1"."Score_2" 
...
-- Code For temporary table TMP_20180508185641_CODEGEN_0DM147_LGBM_B2 part 1. Create 


CREATE TEMPORARY TABLE "TMP_20180508185641_CODEGEN_0DM147_LGBM_B2" (
	"KEY" BIGINT, 
	"Score_0" FLOAT, 
	"Score_1" FLOAT, 
	"Score_2" FLOAT
...
-- Code For temporary table TMP_20180508185641_CODEGEN_0DM147_LGBM_B2 part 2. Populate
...
FROM "DT_Output_29")
 INSERT INTO "TMP_20180508185641_CODEGEN_0DM147_LGBM_B2" ("KEY", "Score_0", "Score_1", "Score_2") SELECT "LGBM_B2"."KEY", "LGBM_B2"."Score_0", "LGBM_B2"."Score_1", "LGBM_B2"."Score_2" 
...
-- Code For temporary table TMP_20180508185641_CODEGEN_VIF0TI_LGBM_B3 part 1. Create 


CREATE TEMPORARY TABLE "TMP_20180508185641_CODEGEN_VIF0TI_LGBM_B3" (
	"KEY" BIGINT, 
	"Score_0" FLOAT, 
	"Score_1" FLOAT, 
	"Score_2" FLOAT
...
-- Code For temporary table TMP_20180508185641_CODEGEN_VIF0TI_LGBM_B3 part 2. Populate
...
FROM "DT_Output_39")
 INSERT INTO "TMP_20180508185641_CODEGEN_VIF0TI_LGBM_B3" ("KEY", "Score_0", "Score_1", "Score_2") SELECT "LGBM_B3"."KEY", "LGBM_B3"."Score_0", "LGBM_B3"."Score_1", "LGBM_B3"."Score_2" 
...
-- Code For temporary table TMP_20180508185641_CODEGEN_LO2HVR_LGBM_B4 part 1. Create 


CREATE TEMPORARY TABLE "TMP_20180508185641_CODEGEN_LO2HVR_LGBM_B4" (
	"KEY" BIGINT, 
	"Score_0" FLOAT, 
	"Score_1" FLOAT, 
	"Score_2" FLOAT
...
-- Code For temporary table TMP_20180508185641_CODEGEN_LO2HVR_LGBM_B4 part 2. Populate
...
FROM "DT_Output_47")
 INSERT INTO "TMP_20180508185641_CODEGEN_LO2HVR_LGBM_B4" ("KEY", "Score_0", "Score_1", "Score_2") SELECT "LGBM_B4"."KEY", "LGBM_B4"."Score_0", "LGBM_B4"."Score_1", "LGBM_B4"."Score_2" 
...
-- Code For temporary table TMP_20180508185641_CODEGEN_44CX8C_LGBM_Union part 1. Create 


CREATE TEMPORARY TABLE "TMP_20180508185641_CODEGEN_44CX8C_LGBM_Union" (
	"KEY" BIGINT, 
	"Score_0" FLOAT, 
	"Score_1" FLOAT, 
	"Score_2" FLOAT
...
-- Code For temporary table TMP_20180508185641_CODEGEN_44CX8C_LGBM_Union part 2. Populate

INSERT INTO "TMP_20180508185641_CODEGEN_44CX8C_LGBM_Union" ("KEY", "Score_0", "Score_1", "Score_2") SELECT "LGBM_Union"."KEY", "LGBM_Union"."Score_0", "LGBM_Union"."Score_1", "LGBM_Union"."Score_2" 
...
FROM "TMP_20180508185641_CODEGEN_SPGHH2_LGBM_B0" AS "LGBM_B0" UNION ALL SELECT "LGBM_B1"."KEY" AS "KEY", "LGBM_B1"."Score_0" AS "Score_0", "LGBM_B1"."Score_1" AS "Score_1", "LGBM_B1"."Score_2" AS "Score_2" 
FROM "TMP_20180508185641_CODEGEN_U3I7RL_LGBM_B1" AS "LGBM_B1" UNION ALL SELECT "LGBM_B2"."KEY" AS "KEY", "LGBM_B2"."Score_0" AS "Score_0", "LGBM_B2"."Score_1" AS "Score_1", "LGBM_B2"."Score_2" AS "Score_2" 
FROM "TMP_20180508185641_CODEGEN_0DM147_LGBM_B2" AS "LGBM_B2" UNION ALL SELECT "LGBM_B3"."KEY" AS "KEY", "LGBM_B3"."Score_0" AS "Score_0", "LGBM_B3"."Score_1" AS "Score_1", "LGBM_B3"."Score_2" AS "Score_2" 
FROM "TMP_20180508185641_CODEGEN_VIF0TI_LGBM_B3" AS "LGBM_B3" UNION ALL SELECT "LGBM_B4"."KEY" AS "KEY", "LGBM_B4"."Score_0" AS "Score_0", "LGBM_B4"."Score_1" AS "Score_1", "LGBM_B4"."Score_2" AS "Score_2" 
FROM "TMP_20180508185641_CODEGEN_LO2HVR_LGBM_B4" AS "LGBM_B4") AS "LGBM_EnsembleUnion") AS "LGBM_Union"

-- Code For temporary table TMP_20180508185641_CODEGEN_UYCND5_LGBM_sum part 1. Create 


CREATE TEMPORARY TABLE "TMP_20180508185641_CODEGEN_UYCND5_LGBM_sum" (
	"KEY" BIGINT NOT NULL, 
	"Score_0" FLOAT, 
	"Score_1" FLOAT, 
	"Score_2" FLOAT, 
...
-- Code For temporary table TMP_20180508185641_CODEGEN_UYCND5_LGBM_sum part 2. Populate

INSERT INTO "TMP_20180508185641_CODEGEN_UYCND5_LGBM_sum" ("KEY", "Score_0", "Score_1", "Score_2") SELECT "LGBM_sum"."KEY", "LGBM_sum"."Score_0", "LGBM_sum"."Score_1", "LGBM_sum"."Score_2" 
...
FROM "TMP_20180508185641_CODEGEN_44CX8C_LGBM_Union" AS "LGBM_Union" GROUP BY "LGBM_Union"."KEY") AS "T") AS "LGBM_sum"

-- Code For temporary table TMP_20180508185641_CODEGEN_UYCND5_LGBM_sum part 3. Create Index 

CREATE INDEX "ix_TMP_20180508185641_CODEGEN_UYCND5_LGBM_sum_KEY" ON "TMP_20180508185641_CODEGEN_UYCND5_LGBM_sum" ("KEY")
...
FROM "TMP_20180508185641_CODEGEN_UYCND5_LGBM_sum" AS "LGBM_sum"), 
