...
-- Code For temporary table tmp_20180516122507_codegen_oejbhu_ads_imp_1_out part 1. Create 


CREATE TEMPORARY TABLE tmp_20180516122507_codegen_oejbhu_ads_imp_1_out (
	"KEY" BIGINT, 
...
-- Code For temporary table tmp_20180516122507_codegen_oejbhu_ads_imp_1_out part 2. Populate

INSERT INTO tmp_20180516122507_codegen_oejbhu_ads_imp_1_out ("KEY", imputer_output_2, imputer_output_3, imputer_output_4, imputer_output_5) SELECT "U"."KEY", "U".imputer_output_2, "U".imputer_output_3, "U".imputer_output_4, "U".imputer_output_5 
...
-- Code For temporary table tmp_20180516122507_codegen_iz38ze_ads_sca_2_out part 1. Create 


CREATE TEMPORARY TABLE tmp_20180516122507_codegen_iz38ze_ads_sca_2_out (
	"KEY" BIGINT, 
...
-- Code For temporary table tmp_20180516122507_codegen_iz38ze_ads_sca_2_out part 2. Populate

INSERT INTO tmp_20180516122507_codegen_iz38ze_ads_sca_2_out ("KEY", scaler_output_2, scaler_output_3, scaler_output_4, scaler_output_5) SELECT "U"."KEY", "U".scaler_output_2, "U".scaler_output_3, "U".scaler_output_4, "U".scaler_output_5 
...
FROM tmp_20180516122507_codegen_oejbhu_ads_imp_1_out AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT") AS "U"

-- Code For temporary table tmp_20180516122508_codegen_2c76sp_lgbm_b0 part 1. Create 


CREATE TEMPORARY TABLE tmp_20180516122508_codegen_2c76sp_lgbm_b0 (
	"KEY" BIGINT, 
	"Score_0" DOUBLE, 
	"Score_1" DOUBLE, 
	"Score_2" DOUBLE
...
-- Code For temporary table tmp_20180516122508_codegen_2c76sp_lgbm_b0 part 2. Populate

INSERT INTO tmp_20180516122508_codegen_2c76sp_lgbm_b0 ("KEY", "Score_0", "Score_1", "Score_2") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1", "U"."Score_2" 
...
FROM tmp_20180516122507_codegen_iz38ze_ads_sca_2_out AS "ADS_sca_2_OUT"), 
"DT_node_data" AS 
...
-- Code For temporary table tmp_20180516122508_codegen_2u6xz4_lgbm_b1 part 1. Create 


CREATE TEMPORARY TABLE tmp_20180516122508_codegen_2u6xz4_lgbm_b1 (
	"KEY" BIGINT, 
	"Score_0" DOUBLE, 
	"Score_1" DOUBLE, 
	"Score_2" DOUBLE
...
-- Code For temporary table tmp_20180516122508_codegen_2u6xz4_lgbm_b1 part 2. Populate

INSERT INTO tmp_20180516122508_codegen_2u6xz4_lgbm_b1 ("KEY", "Score_0", "Score_1", "Score_2") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1", "U"."Score_2" 
...
-- Code For temporary table tmp_20180516122508_codegen_hdd2rx_lgbm_b2 part 1. Create 


CREATE TEMPORARY TABLE tmp_20180516122508_codegen_hdd2rx_lgbm_b2 (
	"KEY" BIGINT, 
	"Score_0" DOUBLE, 
	"Score_1" DOUBLE, 
	"Score_2" DOUBLE
...
-- Code For temporary table tmp_20180516122508_codegen_hdd2rx_lgbm_b2 part 2. Populate

INSERT INTO tmp_20180516122508_codegen_hdd2rx_lgbm_b2 ("KEY", "Score_0", "Score_1", "Score_2") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1", "U"."Score_2" 
...
-- Code For temporary table tmp_20180516122508_codegen_2cnh8b_lgbm_b3 part 1. Create 


CREATE TEMPORARY TABLE tmp_20180516122508_codegen_2cnh8b_lgbm_b3 (
	"KEY" BIGINT, 
	"Score_0" DOUBLE, 
	"Score_1" DOUBLE, 
	"Score_2" DOUBLE
...
-- Code For temporary table tmp_20180516122508_codegen_2cnh8b_lgbm_b3 part 2. Populate

INSERT INTO tmp_20180516122508_codegen_2cnh8b_lgbm_b3 ("KEY", "Score_0", "Score_1", "Score_2") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1", "U"."Score_2" 
...
-- Code For temporary table tmp_20180516122508_codegen_o0cxka_lgbm_b4 part 1. Create 


CREATE TEMPORARY TABLE tmp_20180516122508_codegen_o0cxka_lgbm_b4 (
	"KEY" BIGINT, 
	"Score_0" DOUBLE, 
	"Score_1" DOUBLE, 
	"Score_2" DOUBLE
...
-- Code For temporary table tmp_20180516122508_codegen_o0cxka_lgbm_b4 part 2. Populate

INSERT INTO tmp_20180516122508_codegen_o0cxka_lgbm_b4 ("KEY", "Score_0", "Score_1", "Score_2") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1", "U"."Score_2" 
...
-- Code For temporary table tmp_20180516122508_codegen_omk7r9_lgbm_sum part 1. Create 


CREATE TEMPORARY TABLE tmp_20180516122508_codegen_omk7r9_lgbm_sum (
	"KEY" BIGINT, 
	"Score_0" DOUBLE, 
	"Score_1" DOUBLE, 
	"Score_2" DOUBLE
...
-- Code For temporary table tmp_20180516122508_codegen_omk7r9_lgbm_sum part 2. Populate

INSERT INTO tmp_20180516122508_codegen_omk7r9_lgbm_sum ("KEY", "Score_0", "Score_1", "Score_2") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1", "U"."Score_2" 
...
FROM tmp_20180516122508_codegen_2c76sp_lgbm_b0 AS "LGBM_B0" UNION ALL SELECT "LGBM_B1"."KEY" AS "KEY", "LGBM_B1"."Score_0" AS "Score_0", "LGBM_B1"."Score_1" AS "Score_1", "LGBM_B1"."Score_2" AS "Score_2" 
FROM tmp_20180516122508_codegen_2u6xz4_lgbm_b1 AS "LGBM_B1" UNION ALL SELECT "LGBM_B2"."KEY" AS "KEY", "LGBM_B2"."Score_0" AS "Score_0", "LGBM_B2"."Score_1" AS "Score_1", "LGBM_B2"."Score_2" AS "Score_2" 
FROM tmp_20180516122508_codegen_hdd2rx_lgbm_b2 AS "LGBM_B2" UNION ALL SELECT "LGBM_B3"."KEY" AS "KEY", "LGBM_B3"."Score_0" AS "Score_0", "LGBM_B3"."Score_1" AS "Score_1", "LGBM_B3"."Score_2" AS "Score_2" 
FROM tmp_20180516122508_codegen_2cnh8b_lgbm_b3 AS "LGBM_B3" UNION ALL SELECT "LGBM_B4"."KEY" AS "KEY", "LGBM_B4"."Score_0" AS "Score_0", "LGBM_B4"."Score_1" AS "Score_1", "LGBM_B4"."Score_2" AS "Score_2" 
FROM tmp_20180516122508_codegen_o0cxka_lgbm_b4 AS "LGBM_B4") AS "LGBM_EnsembleUnion")
...
FROM tmp_20180516122508_codegen_omk7r9_lgbm_sum AS "LGBM_sum"), 
