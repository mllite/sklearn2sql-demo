...
-- Code For temporary table tmp_20180516122508_codegen_b3y10v_ads_imp_1_out part 1. Create 


CREATE TABLE tmp_20180516122508_codegen_b3y10v_ads_imp_1_out (
	`KEY` BIGINT, 
...
-- Code For temporary table tmp_20180516122508_codegen_b3y10v_ads_imp_1_out part 2. Populate

INSERT INTO tmp_20180516122508_codegen_b3y10v_ads_imp_1_out (`KEY`, imputer_output_2, imputer_output_3, imputer_output_4, imputer_output_5) SELECT `ADS_imp_1_OUT`.`KEY`, `ADS_imp_1_OUT`.imputer_output_2, `ADS_imp_1_OUT`.imputer_output_3, `ADS_imp_1_OUT`.imputer_output_4, `ADS_imp_1_OUT`.imputer_output_5 
FROM (SELECT `ADS`.`KEY` AS `KEY`, CASE WHEN (`ADS`.`Feature_0` IS NULL) THEN 5.8474999999999975 ELSE `ADS`.`Feature_0` END AS imputer_output_2, CASE WHEN (`ADS`.`Feature_1` IS NULL) THEN 3.0366666666666657 ELSE `ADS`.`Feature_1` END AS imputer_output_3, CASE WHEN (`ADS`.`Feature_2` IS NULL) THEN 3.8450000000000006 ELSE `ADS`.`Feature_2` END AS imputer_output_4, CASE WHEN (`ADS`.`Feature_3` IS NULL) THEN 1.245 ELSE `ADS`.`Feature_3` END AS imputer_output_5 
FROM iris AS `ADS`) AS `ADS_imp_1_OUT`

-- Code For temporary table tmp_20180516122508_codegen_qi7cum_ads_sca_2_out part 1. Create 


CREATE TABLE tmp_20180516122508_codegen_qi7cum_ads_sca_2_out (
	`KEY` BIGINT, 
...
-- Code For temporary table tmp_20180516122508_codegen_qi7cum_ads_sca_2_out part 2. Populate

INSERT INTO tmp_20180516122508_codegen_qi7cum_ads_sca_2_out (`KEY`, scaler_output_2, scaler_output_3, scaler_output_4, scaler_output_5) SELECT `ADS_sca_2_OUT`.`KEY`, `ADS_sca_2_OUT`.scaler_output_2, `ADS_sca_2_OUT`.scaler_output_3, `ADS_sca_2_OUT`.scaler_output_4, `ADS_sca_2_OUT`.scaler_output_5 
...
FROM tmp_20180516122508_codegen_b3y10v_ads_imp_1_out AS `ADS_imp_1_OUT`) AS `ADS_sca_2_OUT`

-- Code For temporary table tmp_20180516122508_codegen_3uw30j_lgbm_b0 part 1. Create 


CREATE TABLE tmp_20180516122508_codegen_3uw30j_lgbm_b0 (
	`KEY` BIGINT, 
	`Score_0` DOUBLE, 
	`Score_1` DOUBLE, 
	`Score_2` DOUBLE
...
-- Code For temporary table tmp_20180516122508_codegen_3uw30j_lgbm_b0 part 2. Populate
...
FROM tmp_20180516122508_codegen_qi7cum_ads_sca_2_out AS `ADS_sca_2_OUT`), 
`DT_node_data` AS 
...
FROM `DT_Output_9`)
 INSERT INTO tmp_20180516122508_codegen_3uw30j_lgbm_b0 (`KEY`, `Score_0`, `Score_1`, `Score_2`) SELECT `LGBM_B0`.`KEY`, `LGBM_B0`.`Score_0`, `LGBM_B0`.`Score_1`, `LGBM_B0`.`Score_2` 
...
-- Code For temporary table tmp_20180516122508_codegen_440y5b_lgbm_b1 part 1. Create 


CREATE TABLE tmp_20180516122508_codegen_440y5b_lgbm_b1 (
	`KEY` BIGINT, 
	`Score_0` DOUBLE, 
	`Score_1` DOUBLE, 
	`Score_2` DOUBLE
...
-- Code For temporary table tmp_20180516122508_codegen_440y5b_lgbm_b1 part 2. Populate
...
FROM `DT_Output_19`)
 INSERT INTO tmp_20180516122508_codegen_440y5b_lgbm_b1 (`KEY`, `Score_0`, `Score_1`, `Score_2`) SELECT `LGBM_B1`.`KEY`, `LGBM_B1`.`Score_0`, `LGBM_B1`.`Score_1`, `LGBM_B1`.`Score_2` 
...
-- Code For temporary table tmp_20180516122508_codegen_9v7j0o_lgbm_b2 part 1. Create 


CREATE TABLE tmp_20180516122508_codegen_9v7j0o_lgbm_b2 (
	`KEY` BIGINT, 
	`Score_0` DOUBLE, 
	`Score_1` DOUBLE, 
	`Score_2` DOUBLE
...
-- Code For temporary table tmp_20180516122508_codegen_9v7j0o_lgbm_b2 part 2. Populate
...
FROM `DT_Output_29`)
 INSERT INTO tmp_20180516122508_codegen_9v7j0o_lgbm_b2 (`KEY`, `Score_0`, `Score_1`, `Score_2`) SELECT `LGBM_B2`.`KEY`, `LGBM_B2`.`Score_0`, `LGBM_B2`.`Score_1`, `LGBM_B2`.`Score_2` 
...
-- Code For temporary table tmp_20180516122508_codegen_g7ff5v_lgbm_b3 part 1. Create 


CREATE TABLE tmp_20180516122508_codegen_g7ff5v_lgbm_b3 (
	`KEY` BIGINT, 
	`Score_0` DOUBLE, 
	`Score_1` DOUBLE, 
	`Score_2` DOUBLE
...
-- Code For temporary table tmp_20180516122508_codegen_g7ff5v_lgbm_b3 part 2. Populate
...
FROM `DT_Output_39`)
 INSERT INTO tmp_20180516122508_codegen_g7ff5v_lgbm_b3 (`KEY`, `Score_0`, `Score_1`, `Score_2`) SELECT `LGBM_B3`.`KEY`, `LGBM_B3`.`Score_0`, `LGBM_B3`.`Score_1`, `LGBM_B3`.`Score_2` 
...
-- Code For temporary table tmp_20180516122508_codegen_foelhq_lgbm_b4 part 1. Create 


CREATE TABLE tmp_20180516122508_codegen_foelhq_lgbm_b4 (
	`KEY` BIGINT, 
	`Score_0` DOUBLE, 
	`Score_1` DOUBLE, 
	`Score_2` DOUBLE
...
-- Code For temporary table tmp_20180516122508_codegen_foelhq_lgbm_b4 part 2. Populate
...
FROM `DT_Output_47`)
 INSERT INTO tmp_20180516122508_codegen_foelhq_lgbm_b4 (`KEY`, `Score_0`, `Score_1`, `Score_2`) SELECT `LGBM_B4`.`KEY`, `LGBM_B4`.`Score_0`, `LGBM_B4`.`Score_1`, `LGBM_B4`.`Score_2` 
...
-- Code For temporary table tmp_20180516122508_codegen_a5x2ck_lgbm_sum part 1. Create 


CREATE TABLE tmp_20180516122508_codegen_a5x2ck_lgbm_sum (
	`KEY` BIGINT, 
	`Score_0` DOUBLE, 
	`Score_1` DOUBLE, 
	`Score_2` DOUBLE
...
-- Code For temporary table tmp_20180516122508_codegen_a5x2ck_lgbm_sum part 2. Populate
...
FROM tmp_20180516122508_codegen_3uw30j_lgbm_b0 AS `LGBM_B0` UNION ALL SELECT `LGBM_B1`.`KEY` AS `KEY`, `LGBM_B1`.`Score_0` AS `Score_0`, `LGBM_B1`.`Score_1` AS `Score_1`, `LGBM_B1`.`Score_2` AS `Score_2` 
FROM tmp_20180516122508_codegen_440y5b_lgbm_b1 AS `LGBM_B1` UNION ALL SELECT `LGBM_B2`.`KEY` AS `KEY`, `LGBM_B2`.`Score_0` AS `Score_0`, `LGBM_B2`.`Score_1` AS `Score_1`, `LGBM_B2`.`Score_2` AS `Score_2` 
FROM tmp_20180516122508_codegen_9v7j0o_lgbm_b2 AS `LGBM_B2` UNION ALL SELECT `LGBM_B3`.`KEY` AS `KEY`, `LGBM_B3`.`Score_0` AS `Score_0`, `LGBM_B3`.`Score_1` AS `Score_1`, `LGBM_B3`.`Score_2` AS `Score_2` 
FROM tmp_20180516122508_codegen_g7ff5v_lgbm_b3 AS `LGBM_B3` UNION ALL SELECT `LGBM_B4`.`KEY` AS `KEY`, `LGBM_B4`.`Score_0` AS `Score_0`, `LGBM_B4`.`Score_1` AS `Score_1`, `LGBM_B4`.`Score_2` AS `Score_2` 
FROM tmp_20180516122508_codegen_foelhq_lgbm_b4 AS `LGBM_B4`) AS `LGBM_EnsembleUnion`)
 INSERT INTO tmp_20180516122508_codegen_a5x2ck_lgbm_sum (`KEY`, `Score_0`, `Score_1`, `Score_2`) SELECT `LGBM_sum`.`KEY`, `LGBM_sum`.`Score_0`, `LGBM_sum`.`Score_1`, `LGBM_sum`.`Score_2` 
...
FROM tmp_20180516122508_codegen_a5x2ck_lgbm_sum AS `LGBM_sum`), 
