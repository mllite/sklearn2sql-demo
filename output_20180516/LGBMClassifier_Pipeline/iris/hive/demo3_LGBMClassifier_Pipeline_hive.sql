...
-- Code For temporary table tmp_20180509004521_codegen_lsd60g_ads_imp_1_out part 1. Create 

CREATE TEMPORARY TABLE `tmp_20180509004521_codegen_lsd60g_ads_imp_1_out` STORED AS ORC AS SELECT `ADS_imp_1_OUT`.`KEY`, `ADS_imp_1_OUT`.`imputer_output_2`, `ADS_imp_1_OUT`.`imputer_output_3`, `ADS_imp_1_OUT`.`imputer_output_4`, `ADS_imp_1_OUT`.`imputer_output_5` 
FROM (SELECT `ADS`.`KEY` AS `KEY`, CASE WHEN (`ADS`.`Feature_0` IS NULL) THEN 5.8474999999999975 ELSE `ADS`.`Feature_0` END AS `imputer_output_2`, CASE WHEN (`ADS`.`Feature_1` IS NULL) THEN 3.0366666666666657 ELSE `ADS`.`Feature_1` END AS `imputer_output_3`, CASE WHEN (`ADS`.`Feature_2` IS NULL) THEN 3.8450000000000006 ELSE `ADS`.`Feature_2` END AS `imputer_output_4`, CASE WHEN (`ADS`.`Feature_3` IS NULL) THEN 1.245 ELSE `ADS`.`Feature_3` END AS `imputer_output_5` 
FROM `iris` AS `ADS`) AS `ADS_imp_1_OUT`

-- Code For temporary table tmp_20180509004521_codegen_lsd60g_ads_imp_1_out part 2. Populate

SELECT * FROM `tmp_20180509004521_codegen_lsd60g_ads_imp_1_out`

-- Code For temporary table tmp_20180509004521_codegen_sa0ef0_ads_sca_2_out part 1. Create 

CREATE TEMPORARY TABLE `tmp_20180509004521_codegen_sa0ef0_ads_sca_2_out` STORED AS ORC AS SELECT `ADS_sca_2_OUT`.`KEY`, `ADS_sca_2_OUT`.`scaler_output_2`, `ADS_sca_2_OUT`.`scaler_output_3`, `ADS_sca_2_OUT`.`scaler_output_4`, `ADS_sca_2_OUT`.`scaler_output_5` 
...
FROM `tmp_20180509004521_codegen_lsd60g_ads_imp_1_out` AS `ADS_imp_1_OUT`) AS `ADS_sca_2_OUT`

-- Code For temporary table tmp_20180509004521_codegen_sa0ef0_ads_sca_2_out part 2. Populate

SELECT * FROM `tmp_20180509004521_codegen_sa0ef0_ads_sca_2_out`

-- Code For temporary table tmp_20180509004521_codegen_g6sq4w_lgbm_b0 part 1. Create 

CREATE TEMPORARY TABLE `tmp_20180509004521_codegen_g6sq4w_lgbm_b0` STORED AS ORC AS WITH `DT_node_lookup` AS 
...
FROM `tmp_20180509004521_codegen_sa0ef0_ads_sca_2_out` AS `ADS_sca_2_OUT`), 
`DT_node_data` AS 
...
-- Code For temporary table tmp_20180509004521_codegen_g6sq4w_lgbm_b0 part 2. Populate

SELECT * FROM `tmp_20180509004521_codegen_g6sq4w_lgbm_b0`

-- Code For temporary table tmp_20180509004521_codegen_a9elwt_lgbm_b1 part 1. Create 

CREATE TEMPORARY TABLE `tmp_20180509004521_codegen_a9elwt_lgbm_b1` STORED AS ORC AS WITH `DT_node_lookup_10` AS 
...
-- Code For temporary table tmp_20180509004521_codegen_a9elwt_lgbm_b1 part 2. Populate

SELECT * FROM `tmp_20180509004521_codegen_a9elwt_lgbm_b1`

-- Code For temporary table tmp_20180509004521_codegen_gyy40h_lgbm_b2 part 1. Create 

CREATE TEMPORARY TABLE `tmp_20180509004521_codegen_gyy40h_lgbm_b2` STORED AS ORC AS WITH `DT_node_lookup_20` AS 
...
-- Code For temporary table tmp_20180509004521_codegen_gyy40h_lgbm_b2 part 2. Populate

SELECT * FROM `tmp_20180509004521_codegen_gyy40h_lgbm_b2`

-- Code For temporary table tmp_20180509004521_codegen_4l8ysu_lgbm_b3 part 1. Create 

CREATE TEMPORARY TABLE `tmp_20180509004521_codegen_4l8ysu_lgbm_b3` STORED AS ORC AS WITH `DT_node_lookup_30` AS 
...
-- Code For temporary table tmp_20180509004521_codegen_4l8ysu_lgbm_b3 part 2. Populate

SELECT * FROM `tmp_20180509004521_codegen_4l8ysu_lgbm_b3`

-- Code For temporary table tmp_20180509004521_codegen_34u0va_lgbm_b4 part 1. Create 

CREATE TEMPORARY TABLE `tmp_20180509004521_codegen_34u0va_lgbm_b4` STORED AS ORC AS WITH `DT_node_lookup_40` AS 
...
-- Code For temporary table tmp_20180509004521_codegen_34u0va_lgbm_b4 part 2. Populate

SELECT * FROM `tmp_20180509004521_codegen_34u0va_lgbm_b4`

-- Code For temporary table tmp_20180509004521_codegen_lge6ba_lgbm_union part 1. Create 

CREATE TEMPORARY TABLE `tmp_20180509004521_codegen_lge6ba_lgbm_union` STORED AS ORC AS SELECT `LGBM_Union`.`KEY`, `LGBM_Union`.`Score_0`, `LGBM_Union`.`Score_1`, `LGBM_Union`.`Score_2` 
...
FROM `tmp_20180509004521_codegen_g6sq4w_lgbm_b0` AS `LGBM_B0` UNION ALL SELECT `LGBM_B1`.`KEY` AS `KEY`, `LGBM_B1`.`Score_0` AS `Score_0`, `LGBM_B1`.`Score_1` AS `Score_1`, `LGBM_B1`.`Score_2` AS `Score_2` 
FROM `tmp_20180509004521_codegen_a9elwt_lgbm_b1` AS `LGBM_B1` UNION ALL SELECT `LGBM_B2`.`KEY` AS `KEY`, `LGBM_B2`.`Score_0` AS `Score_0`, `LGBM_B2`.`Score_1` AS `Score_1`, `LGBM_B2`.`Score_2` AS `Score_2` 
FROM `tmp_20180509004521_codegen_gyy40h_lgbm_b2` AS `LGBM_B2` UNION ALL SELECT `LGBM_B3`.`KEY` AS `KEY`, `LGBM_B3`.`Score_0` AS `Score_0`, `LGBM_B3`.`Score_1` AS `Score_1`, `LGBM_B3`.`Score_2` AS `Score_2` 
FROM `tmp_20180509004521_codegen_4l8ysu_lgbm_b3` AS `LGBM_B3` UNION ALL SELECT `LGBM_B4`.`KEY` AS `KEY`, `LGBM_B4`.`Score_0` AS `Score_0`, `LGBM_B4`.`Score_1` AS `Score_1`, `LGBM_B4`.`Score_2` AS `Score_2` 
FROM `tmp_20180509004521_codegen_34u0va_lgbm_b4` AS `LGBM_B4`) AS `LGBM_EnsembleUnion`) AS `LGBM_Union`

-- Code For temporary table tmp_20180509004521_codegen_lge6ba_lgbm_union part 2. Populate

SELECT * FROM `tmp_20180509004521_codegen_lge6ba_lgbm_union`

-- Code For temporary table tmp_20180509004521_codegen_727gee_lgbm_sum part 1. Create 

CREATE TEMPORARY TABLE `tmp_20180509004521_codegen_727gee_lgbm_sum` STORED AS ORC AS SELECT `LGBM_sum`.`KEY`, `LGBM_sum`.`Score_0`, `LGBM_sum`.`Score_1`, `LGBM_sum`.`Score_2` 
...
FROM `tmp_20180509004521_codegen_lge6ba_lgbm_union` AS `LGBM_Union` GROUP BY `LGBM_Union`.`KEY`) AS `T`) AS `LGBM_sum`

-- Code For temporary table tmp_20180509004521_codegen_727gee_lgbm_sum part 2. Populate

SELECT * FROM `tmp_20180509004521_codegen_727gee_lgbm_sum`
...
FROM `tmp_20180509004521_codegen_727gee_lgbm_sum` AS `LGBM_sum`), 
