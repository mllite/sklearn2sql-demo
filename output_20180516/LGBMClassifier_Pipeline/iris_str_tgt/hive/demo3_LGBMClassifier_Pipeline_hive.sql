...
-- Code For temporary table tmp_20180516131223_codegen_6kmxhf_ads_imp_1_out part 1. Create 

CREATE TEMPORARY TABLE `tmp_20180516131223_codegen_6kmxhf_ads_imp_1_out` STORED AS ORC AS SELECT `ADS_imp_1_OUT`.`KEY`, `ADS_imp_1_OUT`.`imputer_output_2`, `ADS_imp_1_OUT`.`imputer_output_3`, `ADS_imp_1_OUT`.`imputer_output_4`, `ADS_imp_1_OUT`.`imputer_output_5` 
...
-- Code For temporary table tmp_20180516131223_codegen_6kmxhf_ads_imp_1_out part 2. Populate

SELECT * FROM `tmp_20180516131223_codegen_6kmxhf_ads_imp_1_out`

-- Code For temporary table tmp_20180516131223_codegen_6u2vok_ads_sca_2_out part 1. Create 

CREATE TEMPORARY TABLE `tmp_20180516131223_codegen_6u2vok_ads_sca_2_out` STORED AS ORC AS SELECT `ADS_sca_2_OUT`.`KEY`, `ADS_sca_2_OUT`.`scaler_output_2`, `ADS_sca_2_OUT`.`scaler_output_3`, `ADS_sca_2_OUT`.`scaler_output_4`, `ADS_sca_2_OUT`.`scaler_output_5` 
...
FROM `tmp_20180516131223_codegen_6kmxhf_ads_imp_1_out` AS `ADS_imp_1_OUT`) AS `ADS_sca_2_OUT`

-- Code For temporary table tmp_20180516131223_codegen_6u2vok_ads_sca_2_out part 2. Populate

SELECT * FROM `tmp_20180516131223_codegen_6u2vok_ads_sca_2_out`

-- Code For temporary table tmp_20180516131224_codegen_v4fr1s_lgbm_b0 part 1. Create 

CREATE TEMPORARY TABLE `tmp_20180516131224_codegen_v4fr1s_lgbm_b0` STORED AS ORC AS WITH `DT_node_lookup` AS 
...
FROM `tmp_20180516131223_codegen_6u2vok_ads_sca_2_out` AS `ADS_sca_2_OUT`), 
`DT_node_data` AS 
...
-- Code For temporary table tmp_20180516131224_codegen_v4fr1s_lgbm_b0 part 2. Populate

SELECT * FROM `tmp_20180516131224_codegen_v4fr1s_lgbm_b0`

-- Code For temporary table tmp_20180516131224_codegen_wde08n_lgbm_b1 part 1. Create 

CREATE TEMPORARY TABLE `tmp_20180516131224_codegen_wde08n_lgbm_b1` STORED AS ORC AS WITH `DT_node_lookup_10` AS 
...
-- Code For temporary table tmp_20180516131224_codegen_wde08n_lgbm_b1 part 2. Populate

SELECT * FROM `tmp_20180516131224_codegen_wde08n_lgbm_b1`

-- Code For temporary table tmp_20180516131224_codegen_4djx3e_lgbm_b2 part 1. Create 

CREATE TEMPORARY TABLE `tmp_20180516131224_codegen_4djx3e_lgbm_b2` STORED AS ORC AS WITH `DT_node_lookup_20` AS 
...
-- Code For temporary table tmp_20180516131224_codegen_4djx3e_lgbm_b2 part 2. Populate

SELECT * FROM `tmp_20180516131224_codegen_4djx3e_lgbm_b2`

-- Code For temporary table tmp_20180516131224_codegen_i0t5dk_lgbm_b3 part 1. Create 

CREATE TEMPORARY TABLE `tmp_20180516131224_codegen_i0t5dk_lgbm_b3` STORED AS ORC AS WITH `DT_node_lookup_30` AS 
...
-- Code For temporary table tmp_20180516131224_codegen_i0t5dk_lgbm_b3 part 2. Populate

SELECT * FROM `tmp_20180516131224_codegen_i0t5dk_lgbm_b3`

-- Code For temporary table tmp_20180516131224_codegen_6r84n1_lgbm_b4 part 1. Create 

CREATE TEMPORARY TABLE `tmp_20180516131224_codegen_6r84n1_lgbm_b4` STORED AS ORC AS WITH `DT_node_lookup_40` AS 
...
-- Code For temporary table tmp_20180516131224_codegen_6r84n1_lgbm_b4 part 2. Populate

SELECT * FROM `tmp_20180516131224_codegen_6r84n1_lgbm_b4`

-- Code For temporary table tmp_20180516131224_codegen_n1u8vy_lgbm_sum part 1. Create 

CREATE TEMPORARY TABLE `tmp_20180516131224_codegen_n1u8vy_lgbm_sum` STORED AS ORC AS WITH `LGBM_Union` AS 
...
FROM `tmp_20180516131224_codegen_v4fr1s_lgbm_b0` AS `LGBM_B0` UNION ALL SELECT `LGBM_B1`.`KEY` AS `KEY`, `LGBM_B1`.`Score_CLASS_0` AS `Score_CLASS_0`, `LGBM_B1`.`Score_CLASS_1` AS `Score_CLASS_1`, `LGBM_B1`.`Score_CLASS_2` AS `Score_CLASS_2` 
FROM `tmp_20180516131224_codegen_wde08n_lgbm_b1` AS `LGBM_B1` UNION ALL SELECT `LGBM_B2`.`KEY` AS `KEY`, `LGBM_B2`.`Score_CLASS_0` AS `Score_CLASS_0`, `LGBM_B2`.`Score_CLASS_1` AS `Score_CLASS_1`, `LGBM_B2`.`Score_CLASS_2` AS `Score_CLASS_2` 
FROM `tmp_20180516131224_codegen_4djx3e_lgbm_b2` AS `LGBM_B2` UNION ALL SELECT `LGBM_B3`.`KEY` AS `KEY`, `LGBM_B3`.`Score_CLASS_0` AS `Score_CLASS_0`, `LGBM_B3`.`Score_CLASS_1` AS `Score_CLASS_1`, `LGBM_B3`.`Score_CLASS_2` AS `Score_CLASS_2` 
FROM `tmp_20180516131224_codegen_i0t5dk_lgbm_b3` AS `LGBM_B3` UNION ALL SELECT `LGBM_B4`.`KEY` AS `KEY`, `LGBM_B4`.`Score_CLASS_0` AS `Score_CLASS_0`, `LGBM_B4`.`Score_CLASS_1` AS `Score_CLASS_1`, `LGBM_B4`.`Score_CLASS_2` AS `Score_CLASS_2` 
FROM `tmp_20180516131224_codegen_6r84n1_lgbm_b4` AS `LGBM_B4`) AS `LGBM_EnsembleUnion`)
...
-- Code For temporary table tmp_20180516131224_codegen_n1u8vy_lgbm_sum part 2. Populate

SELECT * FROM `tmp_20180516131224_codegen_n1u8vy_lgbm_sum`
...
FROM `tmp_20180516131224_codegen_n1u8vy_lgbm_sum` AS `LGBM_sum`), 
