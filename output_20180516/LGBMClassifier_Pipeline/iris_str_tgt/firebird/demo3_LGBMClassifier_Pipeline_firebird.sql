...
-- Code For temporary table TMP_20180516_CODEGEN_34JFC0_ADS part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180516_CODEGEN_34JFC0_ADS" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20180516_CODEGEN_34JFC0_ADS part 2. Populate

INSERT INTO "TMP_20180516_CODEGEN_34JFC0_ADS" ("KEY", imputer_output_2, imputer_output_3, imputer_output_4, imputer_output_5) SELECT "U"."KEY", "U".imputer_output_2, "U".imputer_output_3, "U".imputer_output_4, "U".imputer_output_5 
...
-- Code For temporary table TMP_20180516_CODEGEN_34JFC0_ADS part 3. Create Index 

CREATE INDEX "ix_TMP_20180516_CODEGEN_6f98" ON "TMP_20180516_CODEGEN_34JFC0_ADS" ("KEY")

-- Code For temporary table TMP_20180516_CODEGEN_BCVC0W_ADS part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180516_CODEGEN_BCVC0W_ADS" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20180516_CODEGEN_BCVC0W_ADS part 2. Populate

INSERT INTO "TMP_20180516_CODEGEN_BCVC0W_ADS" ("KEY", scaler_output_2, scaler_output_3, scaler_output_4, scaler_output_5) SELECT "U"."KEY", "U".scaler_output_2, "U".scaler_output_3, "U".scaler_output_4, "U".scaler_output_5 
...
FROM "TMP_20180516_CODEGEN_34JFC0_ADS" AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT") AS "U"

-- Code For temporary table TMP_20180516_CODEGEN_BCVC0W_ADS part 3. Create Index 

CREATE INDEX "ix_TMP_20180516_CODEGEN_46ed" ON "TMP_20180516_CODEGEN_BCVC0W_ADS" ("KEY")

-- Code For temporary table TMP_20180516_CODEGEN_RTU8G9_LGB part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180516_CODEGEN_RTU8G9_LGB" (
	"KEY" BIGINT, 
...
-- Code For temporary table TMP_20180516_CODEGEN_RTU8G9_LGB part 2. Populate

INSERT INTO "TMP_20180516_CODEGEN_RTU8G9_LGB" ("KEY", "Score_CLASS_0", "Score_CLASS_1", "Score_CLASS_2") SELECT "U"."KEY", "U"."Score_CLASS_0", "U"."Score_CLASS_1", "U"."Score_CLASS_2" 
...
FROM "TMP_20180516_CODEGEN_BCVC0W_ADS" AS "ADS_sca_2_OUT"), 
"DT_node_data" AS 
...
-- Code For temporary table TMP_20180516_CODEGEN_939U8M_LGB part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180516_CODEGEN_939U8M_LGB" (
	"KEY" BIGINT, 
	"Score_CLASS_0" DOUBLE PRECISION, 
	"Score_CLASS_1" DOUBLE PRECISION, 
	"Score_CLASS_2" DOUBLE PRECISION
...
-- Code For temporary table TMP_20180516_CODEGEN_939U8M_LGB part 2. Populate

INSERT INTO "TMP_20180516_CODEGEN_939U8M_LGB" ("KEY", "Score_CLASS_0", "Score_CLASS_1", "Score_CLASS_2") SELECT "U"."KEY", "U"."Score_CLASS_0", "U"."Score_CLASS_1", "U"."Score_CLASS_2" 
...
-- Code For temporary table TMP_20180516_CODEGEN_AR5W75_LGB part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180516_CODEGEN_AR5W75_LGB" (
	"KEY" BIGINT, 
	"Score_CLASS_0" DOUBLE PRECISION, 
	"Score_CLASS_1" DOUBLE PRECISION, 
	"Score_CLASS_2" DOUBLE PRECISION
...
-- Code For temporary table TMP_20180516_CODEGEN_AR5W75_LGB part 2. Populate

INSERT INTO "TMP_20180516_CODEGEN_AR5W75_LGB" ("KEY", "Score_CLASS_0", "Score_CLASS_1", "Score_CLASS_2") SELECT "U"."KEY", "U"."Score_CLASS_0", "U"."Score_CLASS_1", "U"."Score_CLASS_2" 
...
-- Code For temporary table TMP_20180516_CODEGEN_AWHFRM_LGB part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180516_CODEGEN_AWHFRM_LGB" (
	"KEY" BIGINT, 
	"Score_CLASS_0" DOUBLE PRECISION, 
	"Score_CLASS_1" DOUBLE PRECISION, 
	"Score_CLASS_2" DOUBLE PRECISION
...
-- Code For temporary table TMP_20180516_CODEGEN_AWHFRM_LGB part 2. Populate

INSERT INTO "TMP_20180516_CODEGEN_AWHFRM_LGB" ("KEY", "Score_CLASS_0", "Score_CLASS_1", "Score_CLASS_2") SELECT "U"."KEY", "U"."Score_CLASS_0", "U"."Score_CLASS_1", "U"."Score_CLASS_2" 
...
-- Code For temporary table TMP_20180516_CODEGEN_GDZPJE_LGB part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180516_CODEGEN_GDZPJE_LGB" (
	"KEY" BIGINT, 
	"Score_CLASS_0" DOUBLE PRECISION, 
	"Score_CLASS_1" DOUBLE PRECISION, 
	"Score_CLASS_2" DOUBLE PRECISION
...
-- Code For temporary table TMP_20180516_CODEGEN_GDZPJE_LGB part 2. Populate

INSERT INTO "TMP_20180516_CODEGEN_GDZPJE_LGB" ("KEY", "Score_CLASS_0", "Score_CLASS_1", "Score_CLASS_2") SELECT "U"."KEY", "U"."Score_CLASS_0", "U"."Score_CLASS_1", "U"."Score_CLASS_2" 
...
-- Code For temporary table TMP_20180516_CODEGEN_IDE1VS_LGB part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180516_CODEGEN_IDE1VS_LGB" (
	"KEY" BIGINT NOT NULL, 
	"Score_CLASS_0" DOUBLE PRECISION, 
	"Score_CLASS_1" DOUBLE PRECISION, 
	"Score_CLASS_2" DOUBLE PRECISION, 
...
-- Code For temporary table TMP_20180516_CODEGEN_IDE1VS_LGB part 2. Populate

INSERT INTO "TMP_20180516_CODEGEN_IDE1VS_LGB" ("KEY", "Score_CLASS_0", "Score_CLASS_1", "Score_CLASS_2") SELECT "U"."KEY", "U"."Score_CLASS_0", "U"."Score_CLASS_1", "U"."Score_CLASS_2" 
...
FROM "TMP_20180516_CODEGEN_RTU8G9_LGB" AS "LGBM_B0" UNION ALL SELECT "LGBM_B1"."KEY" AS "KEY", "LGBM_B1"."Score_CLASS_0" AS "Score_CLASS_0", "LGBM_B1"."Score_CLASS_1" AS "Score_CLASS_1", "LGBM_B1"."Score_CLASS_2" AS "Score_CLASS_2" 
FROM "TMP_20180516_CODEGEN_939U8M_LGB" AS "LGBM_B1" UNION ALL SELECT "LGBM_B2"."KEY" AS "KEY", "LGBM_B2"."Score_CLASS_0" AS "Score_CLASS_0", "LGBM_B2"."Score_CLASS_1" AS "Score_CLASS_1", "LGBM_B2"."Score_CLASS_2" AS "Score_CLASS_2" 
FROM "TMP_20180516_CODEGEN_AR5W75_LGB" AS "LGBM_B2" UNION ALL SELECT "LGBM_B3"."KEY" AS "KEY", "LGBM_B3"."Score_CLASS_0" AS "Score_CLASS_0", "LGBM_B3"."Score_CLASS_1" AS "Score_CLASS_1", "LGBM_B3"."Score_CLASS_2" AS "Score_CLASS_2" 
FROM "TMP_20180516_CODEGEN_AWHFRM_LGB" AS "LGBM_B3" UNION ALL SELECT "LGBM_B4"."KEY" AS "KEY", "LGBM_B4"."Score_CLASS_0" AS "Score_CLASS_0", "LGBM_B4"."Score_CLASS_1" AS "Score_CLASS_1", "LGBM_B4"."Score_CLASS_2" AS "Score_CLASS_2" 
FROM "TMP_20180516_CODEGEN_GDZPJE_LGB" AS "LGBM_B4") AS "LGBM_EnsembleUnion")
...
-- Code For temporary table TMP_20180516_CODEGEN_IDE1VS_LGB part 3. Create Index 

CREATE INDEX "ix_TMP_20180516_CODEGEN_6a8b" ON "TMP_20180516_CODEGEN_IDE1VS_LGB" ("KEY")
...
FROM "TMP_20180516_CODEGEN_IDE1VS_LGB" AS "LGBM_sum"), 
