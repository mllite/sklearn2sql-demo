...
-- Code For temporary table TMP_20180508190619_CODEGEN_0DYE part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508190619_CODEGEN_0DYE" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20180508190619_CODEGEN_0DYE part 2. Populate

INSERT INTO "TMP_20180508190619_CODEGEN_0DYE" ("KEY", imputer_output_2, imputer_output_3, imputer_output_4, imputer_output_5) SELECT "U"."KEY", "U".imputer_output_2, "U".imputer_output_3, "U".imputer_output_4, "U".imputer_output_5 
...
-- Code For temporary table TMP_20180508190619_CODEGEN_0DYE part 3. Create Index 

CREATE INDEX "ix_TMP_20180508190619_C_4fa3" ON "TMP_20180508190619_CODEGEN_0DYE" ("KEY")

-- Code For temporary table TMP_20180508190619_CODEGEN_DSAL part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508190619_CODEGEN_DSAL" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20180508190619_CODEGEN_DSAL part 2. Populate

INSERT INTO "TMP_20180508190619_CODEGEN_DSAL" ("KEY", scaler_output_2, scaler_output_3, scaler_output_4, scaler_output_5) SELECT "U"."KEY", "U".scaler_output_2, "U".scaler_output_3, "U".scaler_output_4, "U".scaler_output_5 
...
FROM "TMP_20180508190619_CODEGEN_0DYE" AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT") AS "U"

-- Code For temporary table TMP_20180508190619_CODEGEN_DSAL part 3. Create Index 

CREATE INDEX "ix_TMP_20180508190619_C_1d64" ON "TMP_20180508190619_CODEGEN_DSAL" ("KEY")

-- Code For temporary table TMP_20180508190619_CODEGEN_RHTF part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508190619_CODEGEN_RHTF" (
	"KEY" BIGINT, 
...
-- Code For temporary table TMP_20180508190619_CODEGEN_RHTF part 2. Populate

INSERT INTO "TMP_20180508190619_CODEGEN_RHTF" ("KEY", "Score_CLASS_0", "Score_CLASS_1", "Score_CLASS_2") SELECT "U"."KEY", "U"."Score_CLASS_0", "U"."Score_CLASS_1", "U"."Score_CLASS_2" 
...
FROM "TMP_20180508190619_CODEGEN_DSAL" AS "ADS_sca_2_OUT"), 
"DT_node_data" AS 
...
-- Code For temporary table TMP_20180508190619_CODEGEN_W00A part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508190619_CODEGEN_W00A" (
	"KEY" BIGINT, 
	"Score_CLASS_0" DOUBLE PRECISION, 
	"Score_CLASS_1" DOUBLE PRECISION, 
	"Score_CLASS_2" DOUBLE PRECISION
...
-- Code For temporary table TMP_20180508190619_CODEGEN_W00A part 2. Populate

INSERT INTO "TMP_20180508190619_CODEGEN_W00A" ("KEY", "Score_CLASS_0", "Score_CLASS_1", "Score_CLASS_2") SELECT "U"."KEY", "U"."Score_CLASS_0", "U"."Score_CLASS_1", "U"."Score_CLASS_2" 
...
-- Code For temporary table TMP_20180508190619_CODEGEN_9J0D part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508190619_CODEGEN_9J0D" (
	"KEY" BIGINT, 
	"Score_CLASS_0" DOUBLE PRECISION, 
	"Score_CLASS_1" DOUBLE PRECISION, 
	"Score_CLASS_2" DOUBLE PRECISION
...
-- Code For temporary table TMP_20180508190619_CODEGEN_9J0D part 2. Populate

INSERT INTO "TMP_20180508190619_CODEGEN_9J0D" ("KEY", "Score_CLASS_0", "Score_CLASS_1", "Score_CLASS_2") SELECT "U"."KEY", "U"."Score_CLASS_0", "U"."Score_CLASS_1", "U"."Score_CLASS_2" 
...
-- Code For temporary table TMP_20180508190619_CODEGEN_7XGF part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508190619_CODEGEN_7XGF" (
	"KEY" BIGINT, 
	"Score_CLASS_0" DOUBLE PRECISION, 
	"Score_CLASS_1" DOUBLE PRECISION, 
	"Score_CLASS_2" DOUBLE PRECISION
...
-- Code For temporary table TMP_20180508190619_CODEGEN_7XGF part 2. Populate

INSERT INTO "TMP_20180508190619_CODEGEN_7XGF" ("KEY", "Score_CLASS_0", "Score_CLASS_1", "Score_CLASS_2") SELECT "U"."KEY", "U"."Score_CLASS_0", "U"."Score_CLASS_1", "U"."Score_CLASS_2" 
...
-- Code For temporary table TMP_20180508190619_CODEGEN_H4T9 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508190619_CODEGEN_H4T9" (
	"KEY" BIGINT, 
	"Score_CLASS_0" DOUBLE PRECISION, 
	"Score_CLASS_1" DOUBLE PRECISION, 
	"Score_CLASS_2" DOUBLE PRECISION
...
-- Code For temporary table TMP_20180508190619_CODEGEN_H4T9 part 2. Populate

INSERT INTO "TMP_20180508190619_CODEGEN_H4T9" ("KEY", "Score_CLASS_0", "Score_CLASS_1", "Score_CLASS_2") SELECT "U"."KEY", "U"."Score_CLASS_0", "U"."Score_CLASS_1", "U"."Score_CLASS_2" 
...
-- Code For temporary table TMP_20180508190619_CODEGEN_RC1J part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508190619_CODEGEN_RC1J" (
	"KEY" BIGINT, 
	"Score_CLASS_0" DOUBLE PRECISION, 
	"Score_CLASS_1" DOUBLE PRECISION, 
	"Score_CLASS_2" DOUBLE PRECISION
...
-- Code For temporary table TMP_20180508190619_CODEGEN_RC1J part 2. Populate

INSERT INTO "TMP_20180508190619_CODEGEN_RC1J" ("KEY", "Score_CLASS_0", "Score_CLASS_1", "Score_CLASS_2") SELECT "U"."KEY", "U"."Score_CLASS_0", "U"."Score_CLASS_1", "U"."Score_CLASS_2" 
...
FROM "TMP_20180508190619_CODEGEN_RHTF" AS "LGBM_B0" UNION ALL SELECT "LGBM_B1"."KEY" AS "KEY", "LGBM_B1"."Score_CLASS_0" AS "Score_CLASS_0", "LGBM_B1"."Score_CLASS_1" AS "Score_CLASS_1", "LGBM_B1"."Score_CLASS_2" AS "Score_CLASS_2" 
FROM "TMP_20180508190619_CODEGEN_W00A" AS "LGBM_B1" UNION ALL SELECT "LGBM_B2"."KEY" AS "KEY", "LGBM_B2"."Score_CLASS_0" AS "Score_CLASS_0", "LGBM_B2"."Score_CLASS_1" AS "Score_CLASS_1", "LGBM_B2"."Score_CLASS_2" AS "Score_CLASS_2" 
FROM "TMP_20180508190619_CODEGEN_9J0D" AS "LGBM_B2" UNION ALL SELECT "LGBM_B3"."KEY" AS "KEY", "LGBM_B3"."Score_CLASS_0" AS "Score_CLASS_0", "LGBM_B3"."Score_CLASS_1" AS "Score_CLASS_1", "LGBM_B3"."Score_CLASS_2" AS "Score_CLASS_2" 
FROM "TMP_20180508190619_CODEGEN_7XGF" AS "LGBM_B3" UNION ALL SELECT "LGBM_B4"."KEY" AS "KEY", "LGBM_B4"."Score_CLASS_0" AS "Score_CLASS_0", "LGBM_B4"."Score_CLASS_1" AS "Score_CLASS_1", "LGBM_B4"."Score_CLASS_2" AS "Score_CLASS_2" 
FROM "TMP_20180508190619_CODEGEN_H4T9" AS "LGBM_B4") AS "LGBM_EnsembleUnion") AS "LGBM_Union") AS "U"

-- Code For temporary table TMP_20180508190619_CODEGEN_B0RE part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508190619_CODEGEN_B0RE" (
	"KEY" BIGINT NOT NULL, 
	"Score_CLASS_0" DOUBLE PRECISION, 
	"Score_CLASS_1" DOUBLE PRECISION, 
	"Score_CLASS_2" DOUBLE PRECISION, 
...
-- Code For temporary table TMP_20180508190619_CODEGEN_B0RE part 2. Populate

INSERT INTO "TMP_20180508190619_CODEGEN_B0RE" ("KEY", "Score_CLASS_0", "Score_CLASS_1", "Score_CLASS_2") SELECT "U"."KEY", "U"."Score_CLASS_0", "U"."Score_CLASS_1", "U"."Score_CLASS_2" 
...
FROM "TMP_20180508190619_CODEGEN_RC1J" AS "LGBM_Union" GROUP BY "LGBM_Union"."KEY") AS "T") AS "LGBM_sum") AS "U"

-- Code For temporary table TMP_20180508190619_CODEGEN_B0RE part 3. Create Index 

CREATE INDEX "ix_TMP_20180508190619_C_a849" ON "TMP_20180508190619_CODEGEN_B0RE" ("KEY")
...
FROM "TMP_20180508190619_CODEGEN_B0RE" AS "LGBM_sum"), 
