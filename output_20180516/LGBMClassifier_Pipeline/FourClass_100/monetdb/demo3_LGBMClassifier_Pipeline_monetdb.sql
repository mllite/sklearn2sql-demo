...
-- Code For temporary table tmp_20180516113053_codegen_tym2ui_ads_imp_1_out part 1. Create 


CREATE TEMPORARY TABLE tmp_20180516113053_codegen_tym2ui_ads_imp_1_out (
	"KEY" BIGINT, 
	impter_2 DOUBLE, 
	impter_3 DOUBLE, 
	impter_4 DOUBLE, 
...
-- Code For temporary table tmp_20180516113053_codegen_3oxnh9_ads_sca_2_out part 1. Create 


CREATE TEMPORARY TABLE tmp_20180516113053_codegen_3oxnh9_ads_sca_2_out (
	"KEY" BIGINT, 
	scaler_2 DOUBLE, 
	scaler_3 DOUBLE, 
	scaler_4 DOUBLE, 
...
FROM tmp_20180516113053_codegen_tym2ui_ads_imp_1_out AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT") AS "U"

-- Code For temporary table tmp_20180516113054_codegen_envpiw_lgbm_b0 part 1. Create 


CREATE TEMPORARY TABLE tmp_20180516113054_codegen_envpiw_lgbm_b0 (
	"KEY" BIGINT, 
	"Score_0" DOUBLE, 
	"Score_1" DOUBLE, 
	"Score_2" DOUBLE, 
...
-- Code For temporary table tmp_20180516113054_codegen_envpiw_lgbm_b0 part 2. Populate

INSERT INTO tmp_20180516113054_codegen_envpiw_lgbm_b0 ("KEY", "Score_0", "Score_1", "Score_2", "Score_3") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1", "U"."Score_2", "U"."Score_3" 
...
FROM tmp_20180516113053_codegen_3oxnh9_ads_sca_2_out AS "ADS_sca_2_OUT"), 
"DT_node_data" AS 
...
-- Code For temporary table tmp_20180516113054_codegen_nj5m40_lgbm_b1 part 1. Create 


CREATE TEMPORARY TABLE tmp_20180516113054_codegen_nj5m40_lgbm_b1 (
	"KEY" BIGINT, 
	"Score_0" DOUBLE, 
	"Score_1" DOUBLE, 
	"Score_2" DOUBLE, 
...
-- Code For temporary table tmp_20180516113054_codegen_nj5m40_lgbm_b1 part 2. Populate

INSERT INTO tmp_20180516113054_codegen_nj5m40_lgbm_b1 ("KEY", "Score_0", "Score_1", "Score_2", "Score_3") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1", "U"."Score_2", "U"."Score_3" 
...
-- Code For temporary table tmp_20180516113054_codegen_49i1yt_lgbm_b2 part 1. Create 


CREATE TEMPORARY TABLE tmp_20180516113054_codegen_49i1yt_lgbm_b2 (
	"KEY" BIGINT, 
	"Score_0" DOUBLE, 
	"Score_1" DOUBLE, 
	"Score_2" DOUBLE, 
...
-- Code For temporary table tmp_20180516113054_codegen_49i1yt_lgbm_b2 part 2. Populate

INSERT INTO tmp_20180516113054_codegen_49i1yt_lgbm_b2 ("KEY", "Score_0", "Score_1", "Score_2", "Score_3") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1", "U"."Score_2", "U"."Score_3" 
...
-- Code For temporary table tmp_20180516113054_codegen_cjers8_lgbm_b3 part 1. Create 


CREATE TEMPORARY TABLE tmp_20180516113054_codegen_cjers8_lgbm_b3 (
	"KEY" BIGINT, 
	"Score_0" DOUBLE, 
	"Score_1" DOUBLE, 
	"Score_2" DOUBLE, 
...
-- Code For temporary table tmp_20180516113054_codegen_cjers8_lgbm_b3 part 2. Populate

INSERT INTO tmp_20180516113054_codegen_cjers8_lgbm_b3 ("KEY", "Score_0", "Score_1", "Score_2", "Score_3") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1", "U"."Score_2", "U"."Score_3" 
...
-- Code For temporary table tmp_20180516113054_codegen_ijxv4o_lgbm_b4 part 1. Create 


CREATE TEMPORARY TABLE tmp_20180516113054_codegen_ijxv4o_lgbm_b4 (
	"KEY" BIGINT, 
	"Score_0" DOUBLE, 
	"Score_1" DOUBLE, 
	"Score_2" DOUBLE, 
...
-- Code For temporary table tmp_20180516113054_codegen_ijxv4o_lgbm_b4 part 2. Populate

INSERT INTO tmp_20180516113054_codegen_ijxv4o_lgbm_b4 ("KEY", "Score_0", "Score_1", "Score_2", "Score_3") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1", "U"."Score_2", "U"."Score_3" 
...
-- Code For temporary table tmp_20180516113054_codegen_vjahyk_lgbm_b5 part 1. Create 


CREATE TEMPORARY TABLE tmp_20180516113054_codegen_vjahyk_lgbm_b5 (
	"KEY" BIGINT, 
	"Score_0" DOUBLE, 
	"Score_1" DOUBLE, 
	"Score_2" DOUBLE, 
...
-- Code For temporary table tmp_20180516113054_codegen_vjahyk_lgbm_b5 part 2. Populate

INSERT INTO tmp_20180516113054_codegen_vjahyk_lgbm_b5 ("KEY", "Score_0", "Score_1", "Score_2", "Score_3") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1", "U"."Score_2", "U"."Score_3" 
...
-- Code For temporary table tmp_20180516113054_codegen_lj18sv_lgbm_b6 part 1. Create 


CREATE TEMPORARY TABLE tmp_20180516113054_codegen_lj18sv_lgbm_b6 (
	"KEY" BIGINT, 
	"Score_0" DOUBLE, 
	"Score_1" DOUBLE, 
	"Score_2" DOUBLE, 
...
-- Code For temporary table tmp_20180516113054_codegen_lj18sv_lgbm_b6 part 2. Populate

INSERT INTO tmp_20180516113054_codegen_lj18sv_lgbm_b6 ("KEY", "Score_0", "Score_1", "Score_2", "Score_3") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1", "U"."Score_2", "U"."Score_3" 
...
-- Code For temporary table tmp_20180516113054_codegen_k9rd4v_lgbm_sum part 1. Create 


CREATE TEMPORARY TABLE tmp_20180516113054_codegen_k9rd4v_lgbm_sum (
	"KEY" BIGINT, 
	"Score_0" DOUBLE, 
	"Score_1" DOUBLE, 
	"Score_2" DOUBLE, 
...
-- Code For temporary table tmp_20180516113054_codegen_k9rd4v_lgbm_sum part 2. Populate

INSERT INTO tmp_20180516113054_codegen_k9rd4v_lgbm_sum ("KEY", "Score_0", "Score_1", "Score_2", "Score_3") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1", "U"."Score_2", "U"."Score_3" 
...
FROM tmp_20180516113054_codegen_envpiw_lgbm_b0 AS "LGBM_B0" UNION ALL SELECT "LGBM_B1"."KEY" AS "KEY", "LGBM_B1"."Score_0" AS "Score_0", "LGBM_B1"."Score_1" AS "Score_1", "LGBM_B1"."Score_2" AS "Score_2", "LGBM_B1"."Score_3" AS "Score_3" 
FROM tmp_20180516113054_codegen_nj5m40_lgbm_b1 AS "LGBM_B1" UNION ALL SELECT "LGBM_B2"."KEY" AS "KEY", "LGBM_B2"."Score_0" AS "Score_0", "LGBM_B2"."Score_1" AS "Score_1", "LGBM_B2"."Score_2" AS "Score_2", "LGBM_B2"."Score_3" AS "Score_3" 
FROM tmp_20180516113054_codegen_49i1yt_lgbm_b2 AS "LGBM_B2" UNION ALL SELECT "LGBM_B3"."KEY" AS "KEY", "LGBM_B3"."Score_0" AS "Score_0", "LGBM_B3"."Score_1" AS "Score_1", "LGBM_B3"."Score_2" AS "Score_2", "LGBM_B3"."Score_3" AS "Score_3" 
FROM tmp_20180516113054_codegen_cjers8_lgbm_b3 AS "LGBM_B3" UNION ALL SELECT "LGBM_B4"."KEY" AS "KEY", "LGBM_B4"."Score_0" AS "Score_0", "LGBM_B4"."Score_1" AS "Score_1", "LGBM_B4"."Score_2" AS "Score_2", "LGBM_B4"."Score_3" AS "Score_3" 
FROM tmp_20180516113054_codegen_ijxv4o_lgbm_b4 AS "LGBM_B4" UNION ALL SELECT "LGBM_B5"."KEY" AS "KEY", "LGBM_B5"."Score_0" AS "Score_0", "LGBM_B5"."Score_1" AS "Score_1", "LGBM_B5"."Score_2" AS "Score_2", "LGBM_B5"."Score_3" AS "Score_3" 
FROM tmp_20180516113054_codegen_vjahyk_lgbm_b5 AS "LGBM_B5" UNION ALL SELECT "LGBM_B6"."KEY" AS "KEY", "LGBM_B6"."Score_0" AS "Score_0", "LGBM_B6"."Score_1" AS "Score_1", "LGBM_B6"."Score_2" AS "Score_2", "LGBM_B6"."Score_3" AS "Score_3" 
FROM tmp_20180516113054_codegen_lj18sv_lgbm_b6 AS "LGBM_B6") AS "LGBM_EnsembleUnion")
...
FROM tmp_20180516113054_codegen_k9rd4v_lgbm_sum AS "LGBM_sum"), 
