...
FROM `tmp_20180516113054_codegen_wt1ntp_ads_imp_1_out` AS `ADS_imp_1_OUT`) AS `ADS_sca_2_OUT`

-- Code For temporary table tmp_20180516113054_codegen_fgohgd_ads_sca_2_out part 2. Populate

SELECT * FROM `tmp_20180516113054_codegen_fgohgd_ads_sca_2_out`

-- Code For temporary table tmp_20180516113054_codegen_3bu2ra_lgbm_b0 part 1. Create 

CREATE TEMPORARY TABLE `tmp_20180516113054_codegen_3bu2ra_lgbm_b0` STORED AS ORC AS WITH `DT_node_lookup` AS 
...
FROM `tmp_20180516113054_codegen_fgohgd_ads_sca_2_out` AS `ADS_sca_2_OUT`), 
`DT_node_data` AS 
...
-- Code For temporary table tmp_20180516113054_codegen_3bu2ra_lgbm_b0 part 2. Populate

SELECT * FROM `tmp_20180516113054_codegen_3bu2ra_lgbm_b0`

-- Code For temporary table tmp_20180516113054_codegen_mka0as_lgbm_b1 part 1. Create 

CREATE TEMPORARY TABLE `tmp_20180516113054_codegen_mka0as_lgbm_b1` STORED AS ORC AS WITH `DT_node_lookup_10` AS 
...
-- Code For temporary table tmp_20180516113054_codegen_mka0as_lgbm_b1 part 2. Populate

SELECT * FROM `tmp_20180516113054_codegen_mka0as_lgbm_b1`

-- Code For temporary table tmp_20180516113054_codegen_osipon_lgbm_b2 part 1. Create 

CREATE TEMPORARY TABLE `tmp_20180516113054_codegen_osipon_lgbm_b2` STORED AS ORC AS WITH `DT_node_lookup_20` AS 
...
-- Code For temporary table tmp_20180516113054_codegen_osipon_lgbm_b2 part 2. Populate

SELECT * FROM `tmp_20180516113054_codegen_osipon_lgbm_b2`

-- Code For temporary table tmp_20180516113054_codegen_mcw0tp_lgbm_b3 part 1. Create 

CREATE TEMPORARY TABLE `tmp_20180516113054_codegen_mcw0tp_lgbm_b3` STORED AS ORC AS WITH `DT_node_lookup_30` AS 
(SELECT `ADS_sca_2_OUT`.`KEY` AS `KEY`, CASE WHEN (`ADS_sca_2_OUT`.`scaler_58` <= -0.22148632814087912) THEN CASE WHEN (`ADS_sca_2_OUT`.`scaler_56` <= 0.20615032458101307) THEN 4 ELSE 5 END ELSE CASE WHEN (`ADS_sca_2_OUT`.`scaler_97` <= 0.2681499738371736) THEN 6 ELSE 7 END END AS `node_id_2` 
FROM `tmp_20180516113054_codegen_fgohgd_ads_sca_2_out` AS `ADS_sca_2_OUT`), 
`DT_node_data_30` AS 
(SELECT `Values`.`nid` AS `nid`, CAST(`Values`.`Score` AS DOUBLE) AS `Score` 
...
-- Code For temporary table tmp_20180516113054_codegen_mcw0tp_lgbm_b3 part 2. Populate

SELECT * FROM `tmp_20180516113054_codegen_mcw0tp_lgbm_b3`

-- Code For temporary table tmp_20180516113054_codegen_4x9xuw_lgbm_b4 part 1. Create 

CREATE TEMPORARY TABLE `tmp_20180516113054_codegen_4x9xuw_lgbm_b4` STORED AS ORC AS WITH `DT_node_lookup_40` AS 
...
-- Code For temporary table tmp_20180516113054_codegen_4x9xuw_lgbm_b4 part 2. Populate

SELECT * FROM `tmp_20180516113054_codegen_4x9xuw_lgbm_b4`

-- Code For temporary table tmp_20180516113054_codegen_cg673m_lgbm_b5 part 1. Create 

CREATE TEMPORARY TABLE `tmp_20180516113054_codegen_cg673m_lgbm_b5` STORED AS ORC AS WITH `DT_node_lookup_50` AS 
...
-- Code For temporary table tmp_20180516113054_codegen_cg673m_lgbm_b5 part 2. Populate

SELECT * FROM `tmp_20180516113054_codegen_cg673m_lgbm_b5`

-- Code For temporary table tmp_20180516113054_codegen_lxvjzh_lgbm_b6 part 1. Create 

CREATE TEMPORARY TABLE `tmp_20180516113054_codegen_lxvjzh_lgbm_b6` STORED AS ORC AS WITH `DT_node_lookup_60` AS 
...
-- Code For temporary table tmp_20180516113054_codegen_lxvjzh_lgbm_b6 part 2. Populate

SELECT * FROM `tmp_20180516113054_codegen_lxvjzh_lgbm_b6`

-- Code For temporary table tmp_20180516113054_codegen_hpx32z_lgbm_sum part 1. Create 

CREATE TEMPORARY TABLE `tmp_20180516113054_codegen_hpx32z_lgbm_sum` STORED AS ORC AS WITH `LGBM_Union` AS 
...
FROM `tmp_20180516113054_codegen_3bu2ra_lgbm_b0` AS `LGBM_B0` UNION ALL SELECT `LGBM_B1`.`KEY` AS `KEY`, `LGBM_B1`.`Score_0` AS `Score_0`, `LGBM_B1`.`Score_1` AS `Score_1`, `LGBM_B1`.`Score_2` AS `Score_2`, `LGBM_B1`.`Score_3` AS `Score_3` 
FROM `tmp_20180516113054_codegen_mka0as_lgbm_b1` AS `LGBM_B1` UNION ALL SELECT `LGBM_B2`.`KEY` AS `KEY`, `LGBM_B2`.`Score_0` AS `Score_0`, `LGBM_B2`.`Score_1` AS `Score_1`, `LGBM_B2`.`Score_2` AS `Score_2`, `LGBM_B2`.`Score_3` AS `Score_3` 
FROM `tmp_20180516113054_codegen_osipon_lgbm_b2` AS `LGBM_B2` UNION ALL SELECT `LGBM_B3`.`KEY` AS `KEY`, `LGBM_B3`.`Score_0` AS `Score_0`, `LGBM_B3`.`Score_1` AS `Score_1`, `LGBM_B3`.`Score_2` AS `Score_2`, `LGBM_B3`.`Score_3` AS `Score_3` 
FROM `tmp_20180516113054_codegen_mcw0tp_lgbm_b3` AS `LGBM_B3` UNION ALL SELECT `LGBM_B4`.`KEY` AS `KEY`, `LGBM_B4`.`Score_0` AS `Score_0`, `LGBM_B4`.`Score_1` AS `Score_1`, `LGBM_B4`.`Score_2` AS `Score_2`, `LGBM_B4`.`Score_3` AS `Score_3` 
FROM `tmp_20180516113054_codegen_4x9xuw_lgbm_b4` AS `LGBM_B4` UNION ALL SELECT `LGBM_B5`.`KEY` AS `KEY`, `LGBM_B5`.`Score_0` AS `Score_0`, `LGBM_B5`.`Score_1` AS `Score_1`, `LGBM_B5`.`Score_2` AS `Score_2`, `LGBM_B5`.`Score_3` AS `Score_3` 
FROM `tmp_20180516113054_codegen_cg673m_lgbm_b5` AS `LGBM_B5` UNION ALL SELECT `LGBM_B6`.`KEY` AS `KEY`, `LGBM_B6`.`Score_0` AS `Score_0`, `LGBM_B6`.`Score_1` AS `Score_1`, `LGBM_B6`.`Score_2` AS `Score_2`, `LGBM_B6`.`Score_3` AS `Score_3` 
FROM `tmp_20180516113054_codegen_lxvjzh_lgbm_b6` AS `LGBM_B6`) AS `LGBM_EnsembleUnion`)
...
-- Code For temporary table tmp_20180516113054_codegen_hpx32z_lgbm_sum part 2. Populate

SELECT * FROM `tmp_20180516113054_codegen_hpx32z_lgbm_sum`
...
FROM `tmp_20180516113054_codegen_hpx32z_lgbm_sum` AS `LGBM_sum`), 
