...
-- Code For temporary table TMP_20180508181756_CODEGEN_IRLJ part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508181756_CODEGEN_IRLJ" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20180508181756_CODEGEN_IRLJ part 3. Create Index 

CREATE INDEX "ix_TMP_20180508181756_C_e901" ON "TMP_20180508181756_CODEGEN_IRLJ" ("KEY")

-- Code For temporary table TMP_20180508181756_CODEGEN_DMDA part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508181756_CODEGEN_DMDA" (
	"KEY" BIGINT NOT NULL, 
...
FROM "TMP_20180508181756_CODEGEN_IRLJ" AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT") AS "U"

-- Code For temporary table TMP_20180508181756_CODEGEN_DMDA part 3. Create Index 

CREATE INDEX "ix_TMP_20180508181756_C_3fde" ON "TMP_20180508181756_CODEGEN_DMDA" ("KEY")

-- Code For temporary table TMP_20180508181756_CODEGEN_NAC0 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508181756_CODEGEN_NAC0" (
	"KEY" BIGINT, 
...
-- Code For temporary table TMP_20180508181756_CODEGEN_NAC0 part 2. Populate

INSERT INTO "TMP_20180508181756_CODEGEN_NAC0" ("KEY", "Score_0", "Score_1", "Score_2", "Score_3") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1", "U"."Score_2", "U"."Score_3" 
...
FROM "TMP_20180508181756_CODEGEN_DMDA" AS "ADS_sca_2_OUT"), 
"DT_node_data" AS 
...
-- Code For temporary table TMP_20180508181756_CODEGEN_F35P part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508181756_CODEGEN_F35P" (
	"KEY" BIGINT, 
	"Score_0" DOUBLE PRECISION, 
	"Score_1" DOUBLE PRECISION, 
	"Score_2" DOUBLE PRECISION, 
...
-- Code For temporary table TMP_20180508181756_CODEGEN_F35P part 2. Populate

INSERT INTO "TMP_20180508181756_CODEGEN_F35P" ("KEY", "Score_0", "Score_1", "Score_2", "Score_3") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1", "U"."Score_2", "U"."Score_3" 
...
-- Code For temporary table TMP_20180508181756_CODEGEN_F3V3 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508181756_CODEGEN_F3V3" (
	"KEY" BIGINT, 
	"Score_0" DOUBLE PRECISION, 
	"Score_1" DOUBLE PRECISION, 
	"Score_2" DOUBLE PRECISION, 
...
-- Code For temporary table TMP_20180508181756_CODEGEN_F3V3 part 2. Populate

INSERT INTO "TMP_20180508181756_CODEGEN_F3V3" ("KEY", "Score_0", "Score_1", "Score_2", "Score_3") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1", "U"."Score_2", "U"."Score_3" 
...
-- Code For temporary table TMP_20180508181756_CODEGEN_XO7A part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508181756_CODEGEN_XO7A" (
	"KEY" BIGINT, 
	"Score_0" DOUBLE PRECISION, 
	"Score_1" DOUBLE PRECISION, 
	"Score_2" DOUBLE PRECISION, 
...
-- Code For temporary table TMP_20180508181756_CODEGEN_XO7A part 2. Populate

INSERT INTO "TMP_20180508181756_CODEGEN_XO7A" ("KEY", "Score_0", "Score_1", "Score_2", "Score_3") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1", "U"."Score_2", "U"."Score_3" 
...
-- Code For temporary table TMP_20180508181756_CODEGEN_Z90P part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508181756_CODEGEN_Z90P" (
	"KEY" BIGINT, 
	"Score_0" DOUBLE PRECISION, 
	"Score_1" DOUBLE PRECISION, 
	"Score_2" DOUBLE PRECISION, 
...
-- Code For temporary table TMP_20180508181756_CODEGEN_Z90P part 2. Populate

INSERT INTO "TMP_20180508181756_CODEGEN_Z90P" ("KEY", "Score_0", "Score_1", "Score_2", "Score_3") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1", "U"."Score_2", "U"."Score_3" 
...
-- Code For temporary table TMP_20180508181756_CODEGEN_H71Q part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508181756_CODEGEN_H71Q" (
	"KEY" BIGINT, 
	"Score_0" DOUBLE PRECISION, 
	"Score_1" DOUBLE PRECISION, 
	"Score_2" DOUBLE PRECISION, 
...
-- Code For temporary table TMP_20180508181756_CODEGEN_H71Q part 2. Populate

INSERT INTO "TMP_20180508181756_CODEGEN_H71Q" ("KEY", "Score_0", "Score_1", "Score_2", "Score_3") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1", "U"."Score_2", "U"."Score_3" 
...
-- Code For temporary table TMP_20180508181756_CODEGEN_BV88 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508181756_CODEGEN_BV88" (
	"KEY" BIGINT, 
	"Score_0" DOUBLE PRECISION, 
	"Score_1" DOUBLE PRECISION, 
	"Score_2" DOUBLE PRECISION, 
...
-- Code For temporary table TMP_20180508181756_CODEGEN_BV88 part 2. Populate

INSERT INTO "TMP_20180508181756_CODEGEN_BV88" ("KEY", "Score_0", "Score_1", "Score_2", "Score_3") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1", "U"."Score_2", "U"."Score_3" 
...
-- Code For temporary table TMP_20180508181756_CODEGEN_EL86 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508181756_CODEGEN_EL86" (
	"KEY" BIGINT, 
	"Score_0" DOUBLE PRECISION, 
	"Score_1" DOUBLE PRECISION, 
	"Score_2" DOUBLE PRECISION, 
...
-- Code For temporary table TMP_20180508181756_CODEGEN_EL86 part 2. Populate

INSERT INTO "TMP_20180508181756_CODEGEN_EL86" ("KEY", "Score_0", "Score_1", "Score_2", "Score_3") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1", "U"."Score_2", "U"."Score_3" 
...
FROM "TMP_20180508181756_CODEGEN_NAC0" AS "LGBM_B0" UNION ALL SELECT "LGBM_B1"."KEY" AS "KEY", "LGBM_B1"."Score_0" AS "Score_0", "LGBM_B1"."Score_1" AS "Score_1", "LGBM_B1"."Score_2" AS "Score_2", "LGBM_B1"."Score_3" AS "Score_3" 
FROM "TMP_20180508181756_CODEGEN_F35P" AS "LGBM_B1" UNION ALL SELECT "LGBM_B2"."KEY" AS "KEY", "LGBM_B2"."Score_0" AS "Score_0", "LGBM_B2"."Score_1" AS "Score_1", "LGBM_B2"."Score_2" AS "Score_2", "LGBM_B2"."Score_3" AS "Score_3" 
FROM "TMP_20180508181756_CODEGEN_F3V3" AS "LGBM_B2" UNION ALL SELECT "LGBM_B3"."KEY" AS "KEY", "LGBM_B3"."Score_0" AS "Score_0", "LGBM_B3"."Score_1" AS "Score_1", "LGBM_B3"."Score_2" AS "Score_2", "LGBM_B3"."Score_3" AS "Score_3" 
FROM "TMP_20180508181756_CODEGEN_XO7A" AS "LGBM_B3" UNION ALL SELECT "LGBM_B4"."KEY" AS "KEY", "LGBM_B4"."Score_0" AS "Score_0", "LGBM_B4"."Score_1" AS "Score_1", "LGBM_B4"."Score_2" AS "Score_2", "LGBM_B4"."Score_3" AS "Score_3" 
FROM "TMP_20180508181756_CODEGEN_Z90P" AS "LGBM_B4" UNION ALL SELECT "LGBM_B5"."KEY" AS "KEY", "LGBM_B5"."Score_0" AS "Score_0", "LGBM_B5"."Score_1" AS "Score_1", "LGBM_B5"."Score_2" AS "Score_2", "LGBM_B5"."Score_3" AS "Score_3" 
FROM "TMP_20180508181756_CODEGEN_H71Q" AS "LGBM_B5" UNION ALL SELECT "LGBM_B6"."KEY" AS "KEY", "LGBM_B6"."Score_0" AS "Score_0", "LGBM_B6"."Score_1" AS "Score_1", "LGBM_B6"."Score_2" AS "Score_2", "LGBM_B6"."Score_3" AS "Score_3" 
FROM "TMP_20180508181756_CODEGEN_BV88" AS "LGBM_B6") AS "LGBM_EnsembleUnion") AS "LGBM_Union") AS "U"

-- Code For temporary table TMP_20180508181756_CODEGEN_4C2C part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508181756_CODEGEN_4C2C" (
	"KEY" BIGINT NOT NULL, 
	"Score_0" DOUBLE PRECISION, 
	"Score_1" DOUBLE PRECISION, 
	"Score_2" DOUBLE PRECISION, 
...
-- Code For temporary table TMP_20180508181756_CODEGEN_4C2C part 2. Populate

INSERT INTO "TMP_20180508181756_CODEGEN_4C2C" ("KEY", "Score_0", "Score_1", "Score_2", "Score_3") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1", "U"."Score_2", "U"."Score_3" 
...
FROM "TMP_20180508181756_CODEGEN_EL86" AS "LGBM_Union" GROUP BY "LGBM_Union"."KEY") AS "T") AS "LGBM_sum") AS "U"

-- Code For temporary table TMP_20180508181756_CODEGEN_4C2C part 3. Create Index 

CREATE INDEX "ix_TMP_20180508181756_C_fa74" ON "TMP_20180508181756_CODEGEN_4C2C" ("KEY")
...
FROM "TMP_20180508181756_CODEGEN_4C2C" AS "LGBM_sum"), 
