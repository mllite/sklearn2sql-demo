...
-- Code For temporary table TMP_20180508175850_CODEGEN_PWN5 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508175850_CODEGEN_PWN5" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20180508175850_CODEGEN_PWN5 part 2. Populate

INSERT INTO "TMP_20180508175850_CODEGEN_PWN5" ("KEY", impter_2, impter_3, impter_4, impter_5, impter_6, impter_7, impter_8, impter_9, impter_10, impter_11) SELECT "U"."KEY", "U".impter_2, "U".impter_3, "U".impter_4, "U".impter_5, "U".impter_6, "U".impter_7, "U".impter_8, "U".impter_9, "U".impter_10, "U".impter_11 
...
-- Code For temporary table TMP_20180508175850_CODEGEN_PWN5 part 3. Create Index 

CREATE INDEX "ix_TMP_20180508175850_C_f68f" ON "TMP_20180508175850_CODEGEN_PWN5" ("KEY")

-- Code For temporary table TMP_20180508175850_CODEGEN_RGJX part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508175850_CODEGEN_RGJX" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20180508175850_CODEGEN_RGJX part 2. Populate

INSERT INTO "TMP_20180508175850_CODEGEN_RGJX" ("KEY", scaler_2, scaler_3, scaler_4, scaler_5, scaler_6, scaler_7, scaler_8, scaler_9, scaler_10, scaler_11) SELECT "U"."KEY", "U".scaler_2, "U".scaler_3, "U".scaler_4, "U".scaler_5, "U".scaler_6, "U".scaler_7, "U".scaler_8, "U".scaler_9, "U".scaler_10, "U".scaler_11 
...
FROM "TMP_20180508175850_CODEGEN_PWN5" AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT") AS "U"

-- Code For temporary table TMP_20180508175850_CODEGEN_RGJX part 3. Create Index 

CREATE INDEX "ix_TMP_20180508175850_C_e3bb" ON "TMP_20180508175850_CODEGEN_RGJX" ("KEY")

-- Code For temporary table TMP_20180508175850_CODEGEN_64KW part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508175850_CODEGEN_64KW" (
	"KEY" BIGINT, 
...
-- Code For temporary table TMP_20180508175850_CODEGEN_64KW part 2. Populate

INSERT INTO "TMP_20180508175850_CODEGEN_64KW" ("KEY", "Score_0") SELECT "U"."KEY", "U"."Score_0" 
...
FROM "TMP_20180508175850_CODEGEN_RGJX" AS "ADS_sca_2_OUT"), 
"DT_node_data" AS 
...
-- Code For temporary table TMP_20180508175850_CODEGEN_189C part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508175850_CODEGEN_189C" (
	"KEY" BIGINT, 
	"Score_0" DOUBLE PRECISION
)
...
-- Code For temporary table TMP_20180508175850_CODEGEN_189C part 2. Populate

INSERT INTO "TMP_20180508175850_CODEGEN_189C" ("KEY", "Score_0") SELECT "U"."KEY", "U"."Score_0" 
...
-- Code For temporary table TMP_20180508175850_CODEGEN_CU80 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508175850_CODEGEN_CU80" (
	"KEY" BIGINT, 
	"Score_0" DOUBLE PRECISION
)
...
-- Code For temporary table TMP_20180508175850_CODEGEN_CU80 part 2. Populate

INSERT INTO "TMP_20180508175850_CODEGEN_CU80" ("KEY", "Score_0") SELECT "U"."KEY", "U"."Score_0" 
...
FROM "TMP_20180508175850_CODEGEN_64KW" AS "LGBM_B0" UNION ALL SELECT "LGBM_B1"."KEY" AS "KEY", "LGBM_B1"."Score_0" AS "Score_0" 
FROM "TMP_20180508175850_CODEGEN_189C" AS "LGBM_B1") AS "LGBM_EnsembleUnion") AS "LGBM_Union") AS "U"

-- Code For temporary table TMP_20180508175850_CODEGEN_NJ9N part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508175850_CODEGEN_NJ9N" (
	"KEY" BIGINT NOT NULL, 
	"Score_0" DOUBLE PRECISION, 
	PRIMARY KEY ("KEY")
)
...
-- Code For temporary table TMP_20180508175850_CODEGEN_NJ9N part 2. Populate

INSERT INTO "TMP_20180508175850_CODEGEN_NJ9N" ("KEY", "Score_0") SELECT "U"."KEY", "U"."Score_0" 
...
FROM "TMP_20180508175850_CODEGEN_CU80" AS "LGBM_Union" GROUP BY "LGBM_Union"."KEY") AS "T") AS "LGBM_sum") AS "U"

-- Code For temporary table TMP_20180508175850_CODEGEN_NJ9N part 3. Create Index 

CREATE INDEX "ix_TMP_20180508175850_C_44bd" ON "TMP_20180508175850_CODEGEN_NJ9N" ("KEY")
...
FROM "TMP_20180508175850_CODEGEN_NJ9N" AS "LGBM_sum"), 
