...
-- Code For temporary table tmp_20180508175853_codegen_djb6ci_ads_imp_1_out part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180508175853_codegen_djb6ci_ads_imp_1_out (
	"KEY" BIGINT, 
	impter_2 DOUBLE, 
	impter_3 DOUBLE, 
	impter_4 DOUBLE, 
...
-- Code For temporary table tmp_20180508175853_codegen_djb6ci_ads_imp_1_out part 2. Populate

INSERT INTO tmp_20180508175853_codegen_djb6ci_ads_imp_1_out SELECT "ADS_imp_1_OUT"."KEY", "ADS_imp_1_OUT".impter_2, "ADS_imp_1_OUT".impter_3, "ADS_imp_1_OUT".impter_4, "ADS_imp_1_OUT".impter_5, "ADS_imp_1_OUT".impter_6, "ADS_imp_1_OUT".impter_7, "ADS_imp_1_OUT".impter_8, "ADS_imp_1_OUT".impter_9, "ADS_imp_1_OUT".impter_10, "ADS_imp_1_OUT".impter_11 
...
-- Code For temporary table tmp_20180508175853_codegen_f0md0p_ads_sca_2_out part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180508175853_codegen_f0md0p_ads_sca_2_out (
	"KEY" BIGINT, 
	scaler_2 DOUBLE, 
	scaler_3 DOUBLE, 
	scaler_4 DOUBLE, 
...
-- Code For temporary table tmp_20180508175853_codegen_f0md0p_ads_sca_2_out part 2. Populate

INSERT INTO tmp_20180508175853_codegen_f0md0p_ads_sca_2_out SELECT "ADS_sca_2_OUT"."KEY", "ADS_sca_2_OUT".scaler_2, "ADS_sca_2_OUT".scaler_3, "ADS_sca_2_OUT".scaler_4, "ADS_sca_2_OUT".scaler_5, "ADS_sca_2_OUT".scaler_6, "ADS_sca_2_OUT".scaler_7, "ADS_sca_2_OUT".scaler_8, "ADS_sca_2_OUT".scaler_9, "ADS_sca_2_OUT".scaler_10, "ADS_sca_2_OUT".scaler_11 
...
FROM tmp_20180508175853_codegen_djb6ci_ads_imp_1_out AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT"

-- Code For temporary table tmp_20180508175853_codegen_0pa4va_lgbm_b0 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180508175853_codegen_0pa4va_lgbm_b0 (
	"KEY" BIGINT, 
	"Score_0" DOUBLE
)
...
-- Code For temporary table tmp_20180508175853_codegen_0pa4va_lgbm_b0 part 2. Populate

INSERT INTO tmp_20180508175853_codegen_0pa4va_lgbm_b0 WITH "DT_node_lookup" AS 
...
FROM tmp_20180508175853_codegen_f0md0p_ads_sca_2_out AS "ADS_sca_2_OUT"), 
"DT_node_data" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE) AS "Score" 
FROM (SELECT 3 AS nid, 0.08235294117647059 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 4 AS nid, -0.027999999999999987 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 5 AS nid, -0.09999999999999998 AS "Score" FROM SYSIBM.SYSDUMMY1) AS "Values"), 
"DT_Output" AS 
...
"DT_node_data_1" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE) AS "Score" 
FROM (SELECT 3 AS nid, 0.07837035044971821 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 4 AS nid, -0.026605303659345617 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 5 AS nid, -0.09524187224606032 AS "Score" FROM SYSIBM.SYSDUMMY1) AS "Values"), 
"DT_Output_1" AS 
...
"DT_node_data_2" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE) AS "Score" 
FROM (SELECT 3 AS nid, 0.0748151115307271 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 4 AS nid, -0.025289255362273944 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 5 AS nid, -0.09113178077572359 AS "Score" FROM SYSIBM.SYSDUMMY1) AS "Values"), 
"DT_Output_2" AS 
...
"DT_node_data_3" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE) AS "Score" 
FROM (SELECT 3 AS nid, 0.071614314717172 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 4 AS nid, -0.024045725278666764 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 5 AS nid, -0.08754910073915208 AS "Score" FROM SYSIBM.SYSDUMMY1) AS "Values"), 
"DT_Output_3" AS 
...
"DT_node_data_4" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE) AS "Score" 
FROM (SELECT 3 AS nid, 0.06871035665405786 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 4 AS nid, -0.022869317111467467 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 5 AS nid, -0.08440150242752237 AS "Score" FROM SYSIBM.SYSDUMMY1) AS "Values"), 
"DT_Output_4" AS 
...
"DT_node_data_5" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE) AS "Score" 
FROM (SELECT 3 AS nid, 0.059595956972506386 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 4 AS nid, -0.027110032871235364 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 5 AS nid, -0.08161712202378635 AS "Score" FROM SYSIBM.SYSDUMMY1) AS "Values"), 
"DT_Output_5" AS 
...
"DT_node_data_6" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE) AS "Score" 
FROM (SELECT 3 AS nid, 0.07486152326152701 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 4 AS nid, 0.0023210491773776347 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 5 AS nid, -0.06595671598622808 AS "Score" FROM SYSIBM.SYSDUMMY1) AS "Values"), 
"DT_Output_6" AS 
...
"DT_node_data_7" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE) AS "Score" 
FROM (SELECT 3 AS nid, 0.06188623697833565 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 4 AS nid, -0.018862290134270196 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 5 AS nid, -0.07820626677164517 AS "Score" FROM SYSIBM.SYSDUMMY1) AS "Values"), 
"DT_Output_7" AS 
...
"DT_node_data_8" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE) AS "Score" 
FROM (SELECT 3 AS nid, 0.07047027834389967 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 4 AS nid, 0.004022998695700831 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 5 AS nid, -0.06230516020006064 AS "Score" FROM SYSIBM.SYSDUMMY1) AS "Values"), 
"DT_Output_8" AS 
...
"DT_node_data_9" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE) AS "Score" 
FROM (SELECT 3 AS nid, 0.05231955959263856 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 4 AS nid, -0.02035350498816686 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 5 AS nid, -0.07536714519161476 AS "Score" FROM SYSIBM.SYSDUMMY1) AS "Values"), 
"DT_Output_9" AS 
...
-- Code For temporary table tmp_20180508175853_codegen_rd2kwo_lgbm_b1 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180508175853_codegen_rd2kwo_lgbm_b1 (
	"KEY" BIGINT, 
	"Score_0" DOUBLE
)
...
-- Code For temporary table tmp_20180508175853_codegen_rd2kwo_lgbm_b1 part 2. Populate

INSERT INTO tmp_20180508175853_codegen_rd2kwo_lgbm_b1 WITH "DT_node_lookup_10" AS 
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", CASE WHEN ("ADS_sca_2_OUT".scaler_11 <= 0.3589642958583995) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_7 <= -0.5745946464846209) THEN 4 ELSE 5 END ELSE 3 END AS node_id_2 
FROM tmp_20180508175853_codegen_f0md0p_ads_sca_2_out AS "ADS_sca_2_OUT"), 
"DT_node_data_10" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE) AS "Score" 
FROM (SELECT 3 AS nid, 0.06691312663348535 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 4 AS nid, 0.005292289748671965 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 5 AS nid, -0.05919259942894903 AS "Score" FROM SYSIBM.SYSDUMMY1) AS "Values"), 
"DT_Output_10" AS 
...
"DT_node_data_11" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE) AS "Score" 
FROM (SELECT 3 AS nid, 0.06510810739079739 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 4 AS nid, -0.008834303420740033 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 5 AS nid, -0.07297687605873576 AS "Score" FROM SYSIBM.SYSDUMMY1) AS "Values"), 
"DT_Output_11" AS 
...
"DT_node_data_12" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE) AS "Score" 
FROM (SELECT 3 AS nid, 0.04784236000783367 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 4 AS nid, -0.06830307132273603 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 5 AS nid, -0.013504348996642582 AS "Score" FROM SYSIBM.SYSDUMMY1) AS "Values"), 
"DT_Output_12" AS 
...
"DT_node_data_13" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE) AS "Score" 
FROM (SELECT 3 AS nid, 0.062246974561665724 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 4 AS nid, 0.007801871478657589 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 5 AS nid, -0.055235812354027004 AS "Score" FROM SYSIBM.SYSDUMMY1) AS "Values"), 
"DT_Output_13" AS 
...
"DT_node_data_14" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE) AS "Score" 
FROM (SELECT 3 AS nid, 0.06075878684613041 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 4 AS nid, -0.006110172514187426 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 5 AS nid, -0.0701333631064847 AS "Score" FROM SYSIBM.SYSDUMMY1) AS "Values"), 
"DT_Output_14" AS 
...
"DT_node_data_15" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE) AS "Score" 
FROM (SELECT 3 AS nid, 0.05935977931003451 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 4 AS nid, 0.00930785555088631 AS "Score" FROM SYSIBM.SYSDUMMY1 UNION ALL SELECT 5 AS nid, -0.052557328780064874 AS "Score" FROM SYSIBM.SYSDUMMY1) AS "Values"), 
"DT_Output_15" AS 
...
-- Code For temporary table tmp_20180508175853_codegen_4cy5cm_lgbm_union part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180508175853_codegen_4cy5cm_lgbm_union (
	"KEY" BIGINT, 
	"Score_0" DOUBLE
)
...
-- Code For temporary table tmp_20180508175853_codegen_4cy5cm_lgbm_union part 2. Populate

INSERT INTO tmp_20180508175853_codegen_4cy5cm_lgbm_union SELECT "LGBM_Union"."KEY", "LGBM_Union"."Score_0" 
...
FROM tmp_20180508175853_codegen_0pa4va_lgbm_b0 AS "LGBM_B0" UNION ALL SELECT "LGBM_B1"."KEY" AS "KEY", "LGBM_B1"."Score_0" AS "Score_0" 
FROM tmp_20180508175853_codegen_rd2kwo_lgbm_b1 AS "LGBM_B1") AS "LGBM_EnsembleUnion") AS "LGBM_Union"

-- Code For temporary table tmp_20180508175853_codegen_0qbak0_lgbm_sum part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180508175853_codegen_0qbak0_lgbm_sum (
	"KEY" BIGINT, 
	"Score_0" DOUBLE
)
...
-- Code For temporary table tmp_20180508175853_codegen_0qbak0_lgbm_sum part 2. Populate

INSERT INTO tmp_20180508175853_codegen_0qbak0_lgbm_sum SELECT "LGBM_sum"."KEY", "LGBM_sum"."Score_0" 
...
FROM tmp_20180508175853_codegen_4cy5cm_lgbm_union AS "LGBM_Union" GROUP BY "LGBM_Union"."KEY") AS "T") AS "LGBM_sum"
...
FROM tmp_20180508175853_codegen_0qbak0_lgbm_sum AS "LGBM_sum"), 
