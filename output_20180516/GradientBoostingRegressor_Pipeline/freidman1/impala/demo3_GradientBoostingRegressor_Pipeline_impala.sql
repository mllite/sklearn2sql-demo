...
-- Code For temporary table tmp_20180516120740_codegen_4sfgb5_ads_imp_1_out part 1. Create 


CREATE TABLE tmp_20180516120740_codegen_4sfgb5_ads_imp_1_out (
	`KEY` BIGINT, 
	impter_2 DOUBLE, 
	impter_3 DOUBLE, 
	impter_4 DOUBLE, 
...
-- Code For temporary table tmp_20180516120740_codegen_hz3kli_ads_sca_2_out part 1. Create 


CREATE TABLE tmp_20180516120740_codegen_hz3kli_ads_sca_2_out (
	`KEY` BIGINT, 
	scaler_2 DOUBLE, 
	scaler_3 DOUBLE, 
	scaler_4 DOUBLE, 
...
-- Code For temporary table tmp_20180516120740_codegen_hz3kli_ads_sca_2_out part 2. Populate

INSERT INTO tmp_20180516120740_codegen_hz3kli_ads_sca_2_out (`KEY`, scaler_2, scaler_3, scaler_4, scaler_5, scaler_6, scaler_7, scaler_8, scaler_9, scaler_10, scaler_11) SELECT `ADS_sca_2_OUT`.`KEY`, `ADS_sca_2_OUT`.scaler_2, `ADS_sca_2_OUT`.scaler_3, `ADS_sca_2_OUT`.scaler_4, `ADS_sca_2_OUT`.scaler_5, `ADS_sca_2_OUT`.scaler_6, `ADS_sca_2_OUT`.scaler_7, `ADS_sca_2_OUT`.scaler_8, `ADS_sca_2_OUT`.scaler_9, `ADS_sca_2_OUT`.scaler_10, `ADS_sca_2_OUT`.scaler_11 
...
FROM tmp_20180516120740_codegen_4sfgb5_ads_imp_1_out AS `ADS_imp_1_OUT`) AS `ADS_sca_2_OUT`

-- Code For temporary table tmp_20180516120740_codegen_k6p2ri_gb_b0 part 1. Create 


CREATE TABLE tmp_20180516120740_codegen_k6p2ri_gb_b0 (
	`KEY` BIGINT, 
	`Estimator` DOUBLE
)
...
-- Code For temporary table tmp_20180516120740_codegen_k6p2ri_gb_b0 part 2. Populate
...
FROM tmp_20180516120740_codegen_hz3kli_ads_sca_2_out AS `ADS_sca_2_OUT`), 
`DT_node_data` AS 
...
FROM `DT_Output_9`)
 INSERT INTO tmp_20180516120740_codegen_k6p2ri_gb_b0 (`KEY`, `Estimator`) SELECT `GB_B0`.`KEY`, `GB_B0`.`Estimator` 
...
-- Code For temporary table tmp_20180516120740_codegen_pi56u9_gb_b1 part 1. Create 


CREATE TABLE tmp_20180516120740_codegen_pi56u9_gb_b1 (
	`KEY` BIGINT, 
	`Estimator` DOUBLE
)
...
-- Code For temporary table tmp_20180516120740_codegen_pi56u9_gb_b1 part 2. Populate
...
FROM `DT_Output_15`)
 INSERT INTO tmp_20180516120740_codegen_pi56u9_gb_b1 (`KEY`, `Estimator`) SELECT `GB_B1`.`KEY`, `GB_B1`.`Estimator` 
...
-- Code For temporary table tmp_20180516120740_codegen_o54lk2_gb_sum part 1. Create 


CREATE TABLE tmp_20180516120740_codegen_o54lk2_gb_sum (
	`KEY` BIGINT, 
	`Estimator` DOUBLE
)
...
-- Code For temporary table tmp_20180516120740_codegen_o54lk2_gb_sum part 2. Populate
...
FROM tmp_20180516120740_codegen_k6p2ri_gb_b0 AS `GB_B0` UNION ALL SELECT `GB_B1`.`KEY` AS `KEY`, `GB_B1`.`Estimator` AS `Estimator` 
FROM tmp_20180516120740_codegen_pi56u9_gb_b1 AS `GB_B1`) AS `GB_EnsembleUnion`)
 INSERT INTO tmp_20180516120740_codegen_o54lk2_gb_sum (`KEY`, `Estimator`) SELECT `GB_sum`.`KEY`, `GB_sum`.`Estimator` 
...
FROM tmp_20180516120740_codegen_o54lk2_gb_sum AS `GB_sum`