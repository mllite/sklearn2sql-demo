...
-- Code For temporary table TMP_20180602145411_APP_ADS_imp_1_OUT part 1. Create 


CREATE TEMPORARY TABLE `TMP_20180602145411_APP_ADS_imp_1_OUT` (
	`KEY` BIGINT NOT NULL, 
	impter_2 DOUBLE, 
	impter_3 DOUBLE, 
	impter_4 DOUBLE, 
...
-- Code For temporary table TMP_20180602145411_APP_ADS_imp_1_OUT part 2. Populate

INSERT INTO `TMP_20180602145411_APP_ADS_imp_1_OUT` (`KEY`, impter_2, impter_3, impter_4, impter_5, impter_6, impter_7, impter_8, impter_9, impter_10, impter_11, impter_12, impter_13, impter_14) SELECT `U`.`KEY`, `U`.impter_2, `U`.impter_3, `U`.impter_4, `U`.impter_5, `U`.impter_6, `U`.impter_7, `U`.impter_8, `U`.impter_9, `U`.impter_10, `U`.impter_11, `U`.impter_12, `U`.impter_13, `U`.impter_14 
...
-- Code For temporary table TMP_20180602145411_APP_ADS_imp_1_OUT part 3. Create Index 

CREATE INDEX `ix_TMP_20180602145411_APP_ADS_imp_1_OUT_KEY` ON `TMP_20180602145411_APP_ADS_imp_1_OUT` (`KEY`)

-- Code For temporary table TMP_20180602145411_TXO_ADS_sca_2_OUT part 1. Create 


CREATE TEMPORARY TABLE `TMP_20180602145411_TXO_ADS_sca_2_OUT` (
	`KEY` BIGINT NOT NULL, 
	scaler_2 DOUBLE, 
	scaler_3 DOUBLE, 
	scaler_4 DOUBLE, 
...
FROM `TMP_20180602145411_APP_ADS_imp_1_OUT` AS `ADS_imp_1_OUT`) AS `ADS_sca_2_OUT`) AS `U`

-- Code For temporary table TMP_20180602145411_TXO_ADS_sca_2_OUT part 3. Create Index 

CREATE INDEX `ix_TMP_20180602145411_TXO_ADS_sca_2_OUT_KEY` ON `TMP_20180602145411_TXO_ADS_sca_2_OUT` (`KEY`)

-- Code For temporary table TMP_20180602145411_RX3_GB_B0 part 1. Create 


CREATE TEMPORARY TABLE `TMP_20180602145411_RX3_GB_B0` (
	`KEY` BIGINT, 
	`Estimator` DOUBLE
)
...
-- Code For temporary table TMP_20180602145411_RX3_GB_B0 part 2. Populate

INSERT INTO `TMP_20180602145411_RX3_GB_B0` (`KEY`, `Estimator`) SELECT `U`.`KEY`, `U`.`Estimator` 
...
FROM `TMP_20180602145411_TXO_ADS_sca_2_OUT` AS `ADS_sca_2_OUT`), 
`DT_node_data` AS 
...
-- Code For temporary table TMP_20180602145411_D1Q_GB_B1 part 1. Create 


CREATE TEMPORARY TABLE `TMP_20180602145411_D1Q_GB_B1` (
	`KEY` BIGINT, 
	`Estimator` DOUBLE
)
...
-- Code For temporary table TMP_20180602145411_D1Q_GB_B1 part 2. Populate

INSERT INTO `TMP_20180602145411_D1Q_GB_B1` (`KEY`, `Estimator`) SELECT `U`.`KEY`, `U`.`Estimator` 
...
-- Code For temporary table TMP_20180602145411_8GL_GB_sum part 1. Create 


CREATE TEMPORARY TABLE `TMP_20180602145411_8GL_GB_sum` (
	`KEY` BIGINT NOT NULL, 
	`Estimator` DOUBLE, 
	PRIMARY KEY (`KEY`)
)
...
-- Code For temporary table TMP_20180602145411_8GL_GB_sum part 2. Populate

INSERT INTO `TMP_20180602145411_8GL_GB_sum` (`KEY`, `Estimator`) SELECT `U`.`KEY`, `U`.`Estimator` 
...
FROM `TMP_20180602145411_RX3_GB_B0` AS `GB_B0` UNION ALL SELECT `GB_B1`.`KEY` AS `KEY`, `GB_B1`.`Estimator` AS `Estimator` 
FROM `TMP_20180602145411_D1Q_GB_B1` AS `GB_B1`) AS `GB_EnsembleUnion`)
...
-- Code For temporary table TMP_20180602145411_8GL_GB_sum part 3. Create Index 

CREATE INDEX `ix_TMP_20180602145411_8GL_GB_sum_KEY` ON `TMP_20180602145411_8GL_GB_sum` (`KEY`)

-- Model deployment code

SELECT `GB_sum`.`KEY` AS `KEY`, 22.5789603960396 + 0.1 * `GB_sum`.`Estimator` AS `Estimator` 
FROM `TMP_20180602145411_8GL_GB_sum` AS `GB_sum`