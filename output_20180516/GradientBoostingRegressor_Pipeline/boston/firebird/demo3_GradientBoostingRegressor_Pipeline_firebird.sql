...
-- Code For temporary table TMP_20180516_CODEGEN_XWTZTU_ADS part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180516_CODEGEN_XWTZTU_ADS" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20180516_CODEGEN_XWTZTU_ADS part 2. Populate

INSERT INTO "TMP_20180516_CODEGEN_XWTZTU_ADS" ("KEY", impter_2, impter_3, impter_4, impter_5, impter_6, impter_7, impter_8, impter_9, impter_10, impter_11, impter_12, impter_13, impter_14) SELECT "U"."KEY", "U".impter_2, "U".impter_3, "U".impter_4, "U".impter_5, "U".impter_6, "U".impter_7, "U".impter_8, "U".impter_9, "U".impter_10, "U".impter_11, "U".impter_12, "U".impter_13, "U".impter_14 
...
-- Code For temporary table TMP_20180516_CODEGEN_XWTZTU_ADS part 3. Create Index 

CREATE INDEX "ix_TMP_20180516_CODEGEN_b8c4" ON "TMP_20180516_CODEGEN_XWTZTU_ADS" ("KEY")

-- Code For temporary table TMP_20180516_CODEGEN_9SH5H8_ADS part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180516_CODEGEN_9SH5H8_ADS" (
	"KEY" BIGINT NOT NULL, 
...
FROM "TMP_20180516_CODEGEN_XWTZTU_ADS" AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT") AS "U"

-- Code For temporary table TMP_20180516_CODEGEN_9SH5H8_ADS part 3. Create Index 

CREATE INDEX "ix_TMP_20180516_CODEGEN_cd3b" ON "TMP_20180516_CODEGEN_9SH5H8_ADS" ("KEY")

-- Code For temporary table TMP_20180516_CODEGEN_LN5GH6_GB_ part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180516_CODEGEN_LN5GH6_GB_" (
	"KEY" BIGINT, 
...
-- Code For temporary table TMP_20180516_CODEGEN_LN5GH6_GB_ part 2. Populate

INSERT INTO "TMP_20180516_CODEGEN_LN5GH6_GB_" ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
FROM "TMP_20180516_CODEGEN_9SH5H8_ADS" AS "ADS_sca_2_OUT"), 
"DT_node_data" AS 
...
-- Code For temporary table TMP_20180516_CODEGEN_Y57C5C_GB_ part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180516_CODEGEN_Y57C5C_GB_" (
	"KEY" BIGINT, 
	"Estimator" DOUBLE PRECISION
)
...
-- Code For temporary table TMP_20180516_CODEGEN_Y57C5C_GB_ part 2. Populate

INSERT INTO "TMP_20180516_CODEGEN_Y57C5C_GB_" ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
-- Code For temporary table TMP_20180516_CODEGEN_MCI3OR_GB_ part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180516_CODEGEN_MCI3OR_GB_" (
	"KEY" BIGINT NOT NULL, 
	"Estimator" DOUBLE PRECISION, 
	PRIMARY KEY ("KEY")
)
...
-- Code For temporary table TMP_20180516_CODEGEN_MCI3OR_GB_ part 2. Populate

INSERT INTO "TMP_20180516_CODEGEN_MCI3OR_GB_" ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
FROM "TMP_20180516_CODEGEN_LN5GH6_GB_" AS "GB_B0" UNION ALL SELECT "GB_B1"."KEY" AS "KEY", "GB_B1"."Estimator" AS "Estimator" 
FROM "TMP_20180516_CODEGEN_Y57C5C_GB_" AS "GB_B1") AS "GB_EnsembleUnion")
...
-- Code For temporary table TMP_20180516_CODEGEN_MCI3OR_GB_ part 3. Create Index 

CREATE INDEX "ix_TMP_20180516_CODEGEN_cc08" ON "TMP_20180516_CODEGEN_MCI3OR_GB_" ("KEY")

-- Model deployment code

SELECT "GB_sum"."KEY" AS "KEY", 22.5789603960396 + 0.1 * "GB_sum"."Estimator" AS "Estimator" 
FROM "TMP_20180516_CODEGEN_MCI3OR_GB_" AS "GB_sum"