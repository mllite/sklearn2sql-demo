...
-- Code For temporary table TMP_20180602_Z2H_ADS_IMP_1_OUT part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180602_Z2H_ADS_IMP_1_OUT" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20180602_Z2H_ADS_IMP_1_OUT part 2. Populate

INSERT INTO "TMP_20180602_Z2H_ADS_IMP_1_OUT" ("KEY", impter_2, impter_3, impter_4, impter_5, impter_6, impter_7, impter_8, impter_9, impter_10, impter_11, impter_12, impter_13, impter_14) SELECT "U"."KEY", "U".impter_2, "U".impter_3, "U".impter_4, "U".impter_5, "U".impter_6, "U".impter_7, "U".impter_8, "U".impter_9, "U".impter_10, "U".impter_11, "U".impter_12, "U".impter_13, "U".impter_14 
...
-- Code For temporary table TMP_20180602_Z2H_ADS_IMP_1_OUT part 3. Create Index 

CREATE INDEX "ix_TMP_20180602_Z2H_ADS_cfc6" ON "TMP_20180602_Z2H_ADS_IMP_1_OUT" ("KEY")

-- Code For temporary table TMP_20180602_R3V_ADS_SCA_2_OUT part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180602_R3V_ADS_SCA_2_OUT" (
	"KEY" BIGINT NOT NULL, 
...
FROM "TMP_20180602_Z2H_ADS_IMP_1_OUT" AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT") AS "U"

-- Code For temporary table TMP_20180602_R3V_ADS_SCA_2_OUT part 3. Create Index 

CREATE INDEX "ix_TMP_20180602_R3V_ADS_3862" ON "TMP_20180602_R3V_ADS_SCA_2_OUT" ("KEY")

-- Code For temporary table TMP_20180602_7OC_GB_B0 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180602_7OC_GB_B0" (
	"KEY" BIGINT, 
...
-- Code For temporary table TMP_20180602_7OC_GB_B0 part 2. Populate

INSERT INTO "TMP_20180602_7OC_GB_B0" ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
FROM "TMP_20180602_R3V_ADS_SCA_2_OUT" AS "ADS_sca_2_OUT"), 
"DT_node_data" AS 
...
-- Code For temporary table TMP_20180602_WFJ_GB_B1 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180602_WFJ_GB_B1" (
	"KEY" BIGINT, 
	"Estimator" DOUBLE PRECISION
)
...
-- Code For temporary table TMP_20180602_WFJ_GB_B1 part 2. Populate

INSERT INTO "TMP_20180602_WFJ_GB_B1" ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
-- Code For temporary table TMP_20180602_DOG_GB_B2 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180602_DOG_GB_B2" (
	"KEY" BIGINT, 
	"Estimator" DOUBLE PRECISION
)
...
-- Code For temporary table TMP_20180602_DOG_GB_B2 part 2. Populate

INSERT INTO "TMP_20180602_DOG_GB_B2" ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
-- Code For temporary table TMP_20180602_C5R_GB_B3 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180602_C5R_GB_B3" (
	"KEY" BIGINT, 
	"Estimator" DOUBLE PRECISION
)
...
-- Code For temporary table TMP_20180602_C5R_GB_B3 part 2. Populate

INSERT INTO "TMP_20180602_C5R_GB_B3" ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
-- Code For temporary table TMP_20180602_F68_GB_SUM part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180602_F68_GB_SUM" (
	"KEY" BIGINT NOT NULL, 
	"Estimator" DOUBLE PRECISION, 
	PRIMARY KEY ("KEY")
)
...
-- Code For temporary table TMP_20180602_F68_GB_SUM part 2. Populate

INSERT INTO "TMP_20180602_F68_GB_SUM" ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
FROM "TMP_20180602_7OC_GB_B0" AS "GB_B0" UNION ALL SELECT "GB_B1"."KEY" AS "KEY", "GB_B1"."Estimator" AS "Estimator" 
FROM "TMP_20180602_WFJ_GB_B1" AS "GB_B1" UNION ALL SELECT "GB_B2"."KEY" AS "KEY", "GB_B2"."Estimator" AS "Estimator" 
FROM "TMP_20180602_DOG_GB_B2" AS "GB_B2" UNION ALL SELECT "GB_B3"."KEY" AS "KEY", "GB_B3"."Estimator" AS "Estimator" 
FROM "TMP_20180602_C5R_GB_B3" AS "GB_B3") AS "GB_EnsembleUnion")
...
-- Code For temporary table TMP_20180602_F68_GB_SUM part 3. Create Index 

CREATE INDEX "ix_TMP_20180602_F68_GB_SUM_KEY" ON "TMP_20180602_F68_GB_SUM" ("KEY")

-- Model deployment code

SELECT "GB_sum"."KEY" AS "KEY", 22.5789603960396 + 0.1 * "GB_sum"."Estimator" AS "Estimator" 
FROM "TMP_20180602_F68_GB_SUM" AS "GB_sum"