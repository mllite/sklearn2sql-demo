...
-- Code For temporary table DEGEN_C8P5EW_ADS_IMP_1_OUT part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "DEGEN_C8P5EW_ADS_IMP_1_OUT" (
	"KEY" NUMBER(19), 
...
-- Code For temporary table DEGEN_C8P5EW_ADS_IMP_1_OUT part 2. Populate

INSERT INTO "DEGEN_C8P5EW_ADS_IMP_1_OUT" ("KEY", impter_2, impter_3, impter_4, impter_5, impter_6, impter_7, impter_8, impter_9, impter_10, impter_11, impter_12, impter_13, impter_14) SELECT "U"."KEY", "U".impter_2, "U".impter_3, "U".impter_4, "U".impter_5, "U".impter_6, "U".impter_7, "U".impter_8, "U".impter_9, "U".impter_10, "U".impter_11, "U".impter_12, "U".impter_13, "U".impter_14 
...
-- Code For temporary table DEGEN_6N4GDN_ADS_SCA_2_OUT part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "DEGEN_6N4GDN_ADS_SCA_2_OUT" (
	"KEY" NUMBER(19), 
...
FROM "DEGEN_C8P5EW_ADS_IMP_1_OUT" "ADS_imp_1_OUT") "ADS_sca_2_OUT") "U"

-- Code For temporary table 83008_CODEGEN_OE1RNL_GB_B0 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "83008_CODEGEN_OE1RNL_GB_B0" (
	"KEY" NUMBER(19), 
...
-- Code For temporary table 83008_CODEGEN_OE1RNL_GB_B0 part 2. Populate

INSERT INTO "83008_CODEGEN_OE1RNL_GB_B0" ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
FROM "DEGEN_6N4GDN_ADS_SCA_2_OUT" "ADS_sca_2_OUT"), 
"DT_node_data" AS 
(SELECT "Values".nid AS nid, CAST("Values"."E" AS BINARY_DOUBLE) AS "E" 
FROM (SELECT 3 AS nid, -0.8483721607454837 AS "E" FROM DUAL UNION ALL SELECT 4 AS nid, 5.778934340802502 AS "E" FROM DUAL UNION ALL SELECT 6 AS nid, -4.564066779018324 AS "E" FROM DUAL UNION ALL SELECT 7 AS nid, -9.700210396039603 AS "E" FROM DUAL UNION ALL SELECT 10 AS nid, 11.0210396039604 AS "E" FROM DUAL UNION ALL SELECT 11 AS nid, -3.3122937293729344 AS "E" FROM DUAL UNION ALL SELECT 13 AS nid, 23.381039603960392 AS "E" FROM DUAL UNION ALL SELECT 14 AS nid, -0.6789603960396029 AS "E" FROM DUAL) "Values"), 
"DT_Output" AS 
...
"DT_node_data_1" AS 
(SELECT "Values".nid AS nid, CAST("Values"."E" AS BINARY_DOUBLE) AS "E" 
FROM (SELECT 3 AS nid, 21.815194157496244 AS "E" FROM DUAL UNION ALL SELECT 4 AS nid, -0.2396463855716492 AS "E" FROM DUAL UNION ALL SELECT 6 AS nid, -4.805447210491492 AS "E" FROM DUAL UNION ALL SELECT 7 AS nid, -9.581208416719333 AS "E" FROM DUAL UNION ALL SELECT 10 AS nid, 7.94163458537708 AS "E" FROM DUAL UNION ALL SELECT 11 AS nid, -7.634800467546751 AS "E" FROM DUAL UNION ALL SELECT 13 AS nid, 21.04293564356436 AS "E" FROM DUAL UNION ALL SELECT 14 AS nid, -0.6110643564356408 AS "E" FROM DUAL) "Values"), 
"DT_Output_1" AS 
...
"DT_node_data_2" AS 
(SELECT "Values".nid AS nid, CAST("Values"."E" AS BINARY_DOUBLE) AS "E" 
FROM (SELECT 3 AS nid, 25.103447187567056 AS "E" FROM DUAL UNION ALL SELECT 4 AS nid, 2.484205273659576 AS "E" FROM DUAL UNION ALL SELECT 6 AS nid, 10.139057899312366 AS "E" FROM DUAL UNION ALL SELECT 7 AS nid, 18.18908054074639 AS "E" FROM DUAL UNION ALL SELECT 10 AS nid, -7.359879756146922 AS "E" FROM DUAL UNION ALL SELECT 11 AS nid, -2.4218652961991904 AS "E" FROM DUAL UNION ALL SELECT 13 AS nid, -4.342721902787801 AS "E" FROM DUAL UNION ALL SELECT 14 AS nid, -9.80502580423983 AS "E" FROM DUAL) "Values"), 
"DT_Output_2" AS 
...
"DT_node_data_3" AS 
(SELECT "Values".nid AS nid, CAST("Values"."E" AS BINARY_DOUBLE) AS "E" 
FROM (SELECT 3 AS nid, 0.9564209312261512 AS "E" FROM DUAL UNION ALL SELECT 4 AS nid, 6.484731479394312 AS "E" FROM DUAL UNION ALL SELECT 6 AS nid, -2.3688659748667185 AS "E" FROM DUAL UNION ALL SELECT 7 AS nid, 17.119734025133283 AS "E" FROM DUAL UNION ALL SELECT 10 AS nid, 22.814012685528617 AS "E" FROM DUAL UNION ALL SELECT 11 AS nid, -1.1245083937503437 AS "E" FROM DUAL UNION ALL SELECT 13 AS nid, -3.8619717533611166 AS "E" FROM DUAL UNION ALL SELECT 14 AS nid, -7.680560208782768 AS "E" FROM DUAL) "Values"), 
"DT_Output_3" AS 
...
"DT_node_data_4" AS 
(SELECT "Values".nid AS nid, CAST("Values"."E" AS BINARY_DOUBLE) AS "E" 
FROM (SELECT 3 AS nid, 0.8607788381035378 AS "E" FROM DUAL UNION ALL SELECT 4 AS nid, 5.836258331454881 AS "E" FROM DUAL UNION ALL SELECT 6 AS nid, 15.407760622619955 AS "E" FROM DUAL UNION ALL SELECT 7 AS nid, -2.1319793773800484 AS "E" FROM DUAL UNION ALL SELECT 10 AS nid, 20.532611416975755 AS "E" FROM DUAL UNION ALL SELECT 11 AS nid, -1.1975617354332486 AS "E" FROM DUAL UNION ALL SELECT 13 AS nid, -2.8272705763317787 AS "E" FROM DUAL UNION ALL SELECT 14 AS nid, -6.76966368664234 AS "E" FROM DUAL) "Values"), 
"DT_Output_4" AS 
...
"DT_node_data_5" AS 
(SELECT "Values".nid AS nid, CAST("Values"."E" AS BINARY_DOUBLE) AS "E" 
FROM (SELECT 3 AS nid, 15.394158637917217 AS "E" FROM DUAL UNION ALL SELECT 4 AS nid, -0.0862720289231399 AS "E" FROM DUAL UNION ALL SELECT 6 AS nid, -6.463808470986295 AS "E" FROM DUAL UNION ALL SELECT 7 AS nid, -2.8557554273301307 AS "E" FROM DUAL UNION ALL SELECT 10 AS nid, 5.81169995972859 AS "E" FROM DUAL UNION ALL SELECT 11 AS nid, -5.588383293837697 AS "E" FROM DUAL UNION ALL SELECT 13 AS nid, 13.866984560357956 AS "E" FROM DUAL UNION ALL SELECT 14 AS nid, -1.9187814396420428 AS "E" FROM DUAL) "Values"), 
"DT_Output_5" AS 
...
"DT_node_data_6" AS 
(SELECT "Values".nid AS nid, CAST("Values"."E" AS BINARY_DOUBLE) AS "E" 
FROM (SELECT 3 AS nid, 17.75321200449003 AS "E" FROM DUAL UNION ALL SELECT 4 AS nid, 1.6591435216962147 AS "E" FROM DUAL UNION ALL SELECT 6 AS nid, 12.796594507036893 AS "E" FROM DUAL UNION ALL SELECT 7 AS nid, 8.266752204906313 AS "E" FROM DUAL UNION ALL SELECT 10 AS nid, -1.926331818462883 AS "E" FROM DUAL UNION ALL SELECT 11 AS nid, 6.092732573697336 AS "E" FROM DUAL UNION ALL SELECT 13 AS nid, -3.778369007299135 AS "E" FROM DUAL UNION ALL SELECT 14 AS nid, -6.937024667785336 AS "E" FROM DUAL) "Values"), 
"DT_Output_6" AS 
...
"DT_node_data_7" AS 
(SELECT "Values".nid AS nid, CAST("Values"."E" AS BINARY_DOUBLE) AS "E" 
FROM (SELECT 3 AS nid, 1.957581564285816 AS "E" FROM DUAL UNION ALL SELECT 4 AS nid, 6.914444562849308 AS "E" FROM DUAL UNION ALL SELECT 6 AS nid, 13.947995739948368 AS "E" FROM DUAL UNION ALL SELECT 7 AS nid, 10.023002777579354 AS "E" FROM DUAL UNION ALL SELECT 10 AS nid, 0.401168739240097 AS "E" FROM DUAL UNION ALL SELECT 11 AS nid, 6.656375521084428 AS "E" FROM DUAL UNION ALL SELECT 13 AS nid, -1.819744042370566 AS "E" FROM DUAL UNION ALL SELECT 14 AS nid, -4.813677124435982 AS "E" FROM DUAL) "Values"), 
"DT_Output_7" AS 
...
"DT_node_data_8" AS 
(SELECT "Values".nid AS nid, CAST("Values"."E" AS BINARY_DOUBLE) AS "E" 
FROM (SELECT 3 AS nid, 5.346084613071413 AS "E" FROM DUAL UNION ALL SELECT 4 AS nid, 1.709044700366004 AS "E" FROM DUAL UNION ALL SELECT 6 AS nid, 10.325905698462392 AS "E" FROM DUAL UNION ALL SELECT 7 AS nid, -3.219216068276914 AS "E" FROM DUAL UNION ALL SELECT 10 AS nid, 15.124496337113442 AS "E" FROM DUAL UNION ALL SELECT 11 AS nid, -1.1814593983125241 AS "E" FROM DUAL UNION ALL SELECT 13 AS nid, -2.192314557866565 AS "E" FROM DUAL UNION ALL SELECT 14 AS nid, -5.8546149874711295 AS "E" FROM DUAL) "Values"), 
"DT_Output_8" AS 
...
"DT_node_data_9" AS 
(SELECT "Values".nid AS nid, CAST("Values"."E" AS BINARY_DOUBLE) AS "E" 
FROM (SELECT 3 AS nid, 13.6120467034021 AS "E" FROM DUAL UNION ALL SELECT 4 AS nid, -0.9948407576948689 AS "E" FROM DUAL UNION ALL SELECT 6 AS nid, -1.3137722426799754 AS "E" FROM DUAL UNION ALL SELECT 7 AS nid, -4.870926422275086 AS "E" FROM DUAL UNION ALL SELECT 10 AS nid, 3.479706009560154 AS "E" FROM DUAL UNION ALL SELECT 11 AS nid, 9.293315128616154 AS "E" FROM DUAL UNION ALL SELECT 13 AS nid, -6.464029502259475 AS "E" FROM DUAL UNION ALL SELECT 14 AS nid, -2.726194547802579 AS "E" FROM DUAL) "Values"), 
"DT_Output_9" AS 
...
-- Code For temporary table 83008_CODEGEN_5QE7DL_GB_B1 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "83008_CODEGEN_5QE7DL_GB_B1" (
	"KEY" NUMBER(19), 
	"Estimator" BINARY_DOUBLE
)
...
-- Code For temporary table 83008_CODEGEN_5QE7DL_GB_B1 part 2. Populate

INSERT INTO "83008_CODEGEN_5QE7DL_GB_B1" ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
"DT_node_data_10" AS 
(SELECT "Values".nid AS nid, CAST("Values"."E" AS BINARY_DOUBLE) AS "E" 
FROM (SELECT 3 AS nid, 16.03042247150008 AS "E" FROM DUAL UNION ALL SELECT 4 AS nid, 1.821409955429755 AS "E" FROM DUAL UNION ALL SELECT 6 AS nid, 9.249655724557512 AS "E" FROM DUAL UNION ALL SELECT 7 AS nid, 5.393094924998318 AS "E" FROM DUAL UNION ALL SELECT 10 AS nid, -1.097192260753167 AS "E" FROM DUAL UNION ALL SELECT 11 AS nid, 2.9672046090800324 AS "E" FROM DUAL UNION ALL SELECT 13 AS nid, -2.320706273272657 AS "E" FROM DUAL UNION ALL SELECT 14 AS nid, -5.920274456589774 AS "E" FROM DUAL) "Values"), 
"DT_Output_10" AS 
...
"DT_node_data_11" AS 
(SELECT "Values".nid AS nid, CAST("Values"."E" AS BINARY_DOUBLE) AS "E" 
FROM (SELECT 3 AS nid, 4.45893942446002 AS "E" FROM DUAL UNION ALL SELECT 4 AS nid, 10.679274034730696 AS "E" FROM DUAL UNION ALL SELECT 6 AS nid, 5.049649593801159 AS "E" FROM DUAL UNION ALL SELECT 7 AS nid, 0.1548636905527001 AS "E" FROM DUAL UNION ALL SELECT 10 AS nid, -0.34880846594333415 AS "E" FROM DUAL UNION ALL SELECT 11 AS nid, 3.0415724083043774 AS "E" FROM DUAL UNION ALL SELECT 13 AS nid, 7.66672001954712 AS "E" FROM DUAL UNION ALL SELECT 14 AS nid, -2.588318526317513 AS "E" FROM DUAL) "Values"), 
"DT_Output_11" AS 
...
"DT_node_data_12" AS 
(SELECT "Values".nid AS nid, CAST("Values"."E" AS BINARY_DOUBLE) AS "E" 
FROM (SELECT 3 AS nid, 9.963139704387164 AS "E" FROM DUAL UNION ALL SELECT 4 AS nid, -0.08025550887970825 AS "E" FROM DUAL UNION ALL SELECT 6 AS nid, -0.5914923147357894 AS "E" FROM DUAL UNION ALL SELECT 7 AS nid, -3.2386349549117512 AS "E" FROM DUAL UNION ALL SELECT 10 AS nid, 3.298261314433055 AS "E" FROM DUAL UNION ALL SELECT 11 AS nid, 7.22979934684516 AS "E" FROM DUAL UNION ALL SELECT 13 AS nid, -1.8596300631661944 AS "E" FROM DUAL UNION ALL SELECT 14 AS nid, -5.822959015412992 AS "E" FROM DUAL) "Values"), 
"DT_Output_12" AS 
...
"DT_node_data_13" AS 
(SELECT "Values".nid AS nid, CAST("Values"."E" AS BINARY_DOUBLE) AS "E" 
FROM (SELECT 3 AS nid, 11.186096474641952 AS "E" FROM DUAL UNION ALL SELECT 4 AS nid, 0.7950189600237958 AS "E" FROM DUAL UNION ALL SELECT 6 AS nid, 6.685315566575873 AS "E" FROM DUAL UNION ALL SELECT 7 AS nid, 3.8872203528188716 AS "E" FROM DUAL UNION ALL SELECT 10 AS nid, -6.0146691120059375 AS "E" FROM DUAL UNION ALL SELECT 11 AS nid, -2.638999622315692 AS "E" FROM DUAL UNION ALL SELECT 13 AS nid, 0.7806885165178139 AS "E" FROM DUAL UNION ALL SELECT 14 AS nid, -1.1256769388015495 AS "E" FROM DUAL) "Values"), 
"DT_Output_13" AS 
...
"DT_node_data_14" AS 
(SELECT "Values".nid AS nid, CAST("Values"."E" AS BINARY_DOUBLE) AS "E" 
FROM (SELECT 3 AS nid, 9.478965639279586 AS "E" FROM DUAL UNION ALL SELECT 4 AS nid, -0.6499702953553841 AS "E" FROM DUAL UNION ALL SELECT 6 AS nid, -1.233527298074414 AS "E" FROM DUAL UNION ALL SELECT 7 AS nid, -3.676696947229039 AS "E" FROM DUAL UNION ALL SELECT 10 AS nid, 2.5270905093722926 AS "E" FROM DUAL UNION ALL SELECT 11 AS nid, 5.959944169144661 AS "E" FROM DUAL UNION ALL SELECT 13 AS nid, 11.244529202974093 AS "E" FROM DUAL UNION ALL SELECT 14 AS nid, -1.2220960075581273 AS "E" FROM DUAL) "Values"), 
"DT_Output_14" AS 
...
"DT_node_data_15" AS 
(SELECT "Values".nid AS nid, CAST("Values"."E" AS BINARY_DOUBLE) AS "E" 
FROM (SELECT 3 AS nid, 5.00442683276913 AS "E" FROM DUAL UNION ALL SELECT 4 AS nid, 1.1985510005554418 AS "E" FROM DUAL UNION ALL SELECT 6 AS nid, 5.943336196435719 AS "E" FROM DUAL UNION ALL SELECT 7 AS nid, 0.7774532662097009 AS "E" FROM DUAL UNION ALL SELECT 10 AS nid, 8.531069075351624 AS "E" FROM DUAL UNION ALL SELECT 11 AS nid, -0.5351569767333489 AS "E" FROM DUAL UNION ALL SELECT 13 AS nid, -1.4468251981974587 AS "E" FROM DUAL UNION ALL SELECT 14 AS nid, -3.730065268370492 AS "E" FROM DUAL) "Values"), 
"DT_Output_15" AS 
...
-- Code For temporary table 08_CODEGEN_R638EP_GB_UNION part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "08_CODEGEN_R638EP_GB_UNION" (
	"KEY" NUMBER(19), 
	"Estimator" BINARY_DOUBLE
)
...
-- Code For temporary table 08_CODEGEN_R638EP_GB_UNION part 2. Populate

INSERT INTO "08_CODEGEN_R638EP_GB_UNION" ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
FROM "83008_CODEGEN_OE1RNL_GB_B0" "GB_B0" UNION ALL SELECT "GB_B1"."KEY" AS "KEY", "GB_B1"."Estimator" AS "Estimator" 
FROM "83008_CODEGEN_5QE7DL_GB_B1" "GB_B1") "GB_EnsembleUnion") "GB_Union") "U"

-- Code For temporary table 3008_CODEGEN_5QMJHV_GB_SUM part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "3008_CODEGEN_5QMJHV_GB_SUM" (
	"KEY" NUMBER(19), 
	"Estimator" BINARY_DOUBLE
)
...
-- Code For temporary table 3008_CODEGEN_5QMJHV_GB_SUM part 2. Populate

INSERT INTO "3008_CODEGEN_5QMJHV_GB_SUM" ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
FROM "08_CODEGEN_R638EP_GB_UNION" "GB_Union" GROUP BY "GB_Union"."KEY") "T") "GB_sum") "U"

-- Model deployment code

SELECT "GB_sum"."KEY" AS "KEY", 22.5789603960396 + 0.1 * "GB_sum"."Estimator" AS "Estimator" 
FROM "3008_CODEGEN_5QMJHV_GB_SUM" "GB_sum"