...
-- Code For temporary table tmp_20180508183008_codegen_xlgo1z_ads_imp_1_out part 1. Create 


CREATE TEMPORARY TABLE tmp_20180508183008_codegen_xlgo1z_ads_imp_1_out (
	"KEY" BIGINT, 
	impter_2 DOUBLE, 
	impter_3 DOUBLE, 
	impter_4 DOUBLE, 
...
-- Code For temporary table tmp_20180508183008_codegen_xlgo1z_ads_imp_1_out part 2. Populate

INSERT INTO tmp_20180508183008_codegen_xlgo1z_ads_imp_1_out ("KEY", impter_2, impter_3, impter_4, impter_5, impter_6, impter_7, impter_8, impter_9, impter_10, impter_11, impter_12, impter_13, impter_14) SELECT "U"."KEY", "U".impter_2, "U".impter_3, "U".impter_4, "U".impter_5, "U".impter_6, "U".impter_7, "U".impter_8, "U".impter_9, "U".impter_10, "U".impter_11, "U".impter_12, "U".impter_13, "U".impter_14 
...
-- Code For temporary table tmp_20180508183008_codegen_kd3kja_ads_sca_2_out part 1. Create 


CREATE TEMPORARY TABLE tmp_20180508183008_codegen_kd3kja_ads_sca_2_out (
	"KEY" BIGINT, 
	scaler_2 DOUBLE, 
	scaler_3 DOUBLE, 
	scaler_4 DOUBLE, 
...
FROM tmp_20180508183008_codegen_xlgo1z_ads_imp_1_out AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT") AS "U"

-- Code For temporary table tmp_20180508183008_codegen_sew3cv_gb_b0 part 1. Create 


CREATE TEMPORARY TABLE tmp_20180508183008_codegen_sew3cv_gb_b0 (
	"KEY" BIGINT, 
	"Estimator" DOUBLE
)
...
-- Code For temporary table tmp_20180508183008_codegen_sew3cv_gb_b0 part 2. Populate

INSERT INTO tmp_20180508183008_codegen_sew3cv_gb_b0 ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
FROM tmp_20180508183008_codegen_kd3kja_ads_sca_2_out AS "ADS_sca_2_OUT"), 
"DT_node_data" AS 
...
-- Code For temporary table tmp_20180508183008_codegen_zg0bwr_gb_b1 part 1. Create 


CREATE TEMPORARY TABLE tmp_20180508183008_codegen_zg0bwr_gb_b1 (
	"KEY" BIGINT, 
	"Estimator" DOUBLE
)
...
-- Code For temporary table tmp_20180508183008_codegen_zg0bwr_gb_b1 part 2. Populate

INSERT INTO tmp_20180508183008_codegen_zg0bwr_gb_b1 ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
-- Code For temporary table tmp_20180508183008_codegen_gzeotq_gb_union part 1. Create 


CREATE TEMPORARY TABLE tmp_20180508183008_codegen_gzeotq_gb_union (
	"KEY" BIGINT, 
	"Estimator" DOUBLE
)
...
-- Code For temporary table tmp_20180508183008_codegen_gzeotq_gb_union part 2. Populate

INSERT INTO tmp_20180508183008_codegen_gzeotq_gb_union ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
FROM tmp_20180508183008_codegen_sew3cv_gb_b0 AS "GB_B0" UNION ALL SELECT "GB_B1"."KEY" AS "KEY", "GB_B1"."Estimator" AS "Estimator" 
FROM tmp_20180508183008_codegen_zg0bwr_gb_b1 AS "GB_B1") AS "GB_EnsembleUnion") AS "GB_Union") AS "U"

-- Code For temporary table tmp_20180508183008_codegen_gyw79q_gb_sum part 1. Create 


CREATE TEMPORARY TABLE tmp_20180508183008_codegen_gyw79q_gb_sum (
	"KEY" BIGINT, 
	"Estimator" DOUBLE
)
...
-- Code For temporary table tmp_20180508183008_codegen_gyw79q_gb_sum part 2. Populate

INSERT INTO tmp_20180508183008_codegen_gyw79q_gb_sum ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
FROM tmp_20180508183008_codegen_gzeotq_gb_union AS "GB_Union" GROUP BY "GB_Union"."KEY") AS "T") AS "GB_sum") AS "U"

-- Model deployment code

SELECT "GB_sum"."KEY" AS "KEY", 22.5789603960396 + 0.1 * "GB_sum"."Estimator" AS "Estimator" 
FROM tmp_20180508183008_codegen_gyw79q_gb_sum AS "GB_sum"