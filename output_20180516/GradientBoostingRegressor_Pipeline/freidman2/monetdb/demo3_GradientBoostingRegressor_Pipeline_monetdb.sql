...
-- Code For temporary table tmp_20180508184822_codegen_tnw230_ads_imp_1_out part 1. Create 


CREATE TEMPORARY TABLE tmp_20180508184822_codegen_tnw230_ads_imp_1_out (
	"KEY" BIGINT, 
...
-- Code For temporary table tmp_20180508184822_codegen_tnw230_ads_imp_1_out part 2. Populate

INSERT INTO tmp_20180508184822_codegen_tnw230_ads_imp_1_out ("KEY", imputer_output_2, imputer_output_3, imputer_output_4, imputer_output_5) SELECT "U"."KEY", "U".imputer_output_2, "U".imputer_output_3, "U".imputer_output_4, "U".imputer_output_5 
...
-- Code For temporary table tmp_20180508184822_codegen_sai95k_ads_sca_2_out part 1. Create 


CREATE TEMPORARY TABLE tmp_20180508184822_codegen_sai95k_ads_sca_2_out (
	"KEY" BIGINT, 
...
-- Code For temporary table tmp_20180508184822_codegen_sai95k_ads_sca_2_out part 2. Populate

INSERT INTO tmp_20180508184822_codegen_sai95k_ads_sca_2_out ("KEY", scaler_output_2, scaler_output_3, scaler_output_4, scaler_output_5) SELECT "U"."KEY", "U".scaler_output_2, "U".scaler_output_3, "U".scaler_output_4, "U".scaler_output_5 
...
FROM tmp_20180508184822_codegen_tnw230_ads_imp_1_out AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT") AS "U"

-- Code For temporary table tmp_20180508184822_codegen_fic9ub_gb_b0 part 1. Create 


CREATE TEMPORARY TABLE tmp_20180508184822_codegen_fic9ub_gb_b0 (
	"KEY" BIGINT, 
	"Estimator" DOUBLE
)
...
-- Code For temporary table tmp_20180508184822_codegen_fic9ub_gb_b0 part 2. Populate

INSERT INTO tmp_20180508184822_codegen_fic9ub_gb_b0 ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
FROM tmp_20180508184822_codegen_sai95k_ads_sca_2_out AS "ADS_sca_2_OUT"), 
"DT_node_data" AS 
...
-- Code For temporary table tmp_20180508184822_codegen_xsjcu3_gb_b1 part 1. Create 


CREATE TEMPORARY TABLE tmp_20180508184822_codegen_xsjcu3_gb_b1 (
	"KEY" BIGINT, 
	"Estimator" DOUBLE
)
...
-- Code For temporary table tmp_20180508184822_codegen_xsjcu3_gb_b1 part 2. Populate

INSERT INTO tmp_20180508184822_codegen_xsjcu3_gb_b1 ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
-- Code For temporary table tmp_20180508184822_codegen_7dtil8_gb_union part 1. Create 


CREATE TEMPORARY TABLE tmp_20180508184822_codegen_7dtil8_gb_union (
	"KEY" BIGINT, 
	"Estimator" DOUBLE
)
...
-- Code For temporary table tmp_20180508184822_codegen_7dtil8_gb_union part 2. Populate

INSERT INTO tmp_20180508184822_codegen_7dtil8_gb_union ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
FROM tmp_20180508184822_codegen_fic9ub_gb_b0 AS "GB_B0" UNION ALL SELECT "GB_B1"."KEY" AS "KEY", "GB_B1"."Estimator" AS "Estimator" 
FROM tmp_20180508184822_codegen_xsjcu3_gb_b1 AS "GB_B1") AS "GB_EnsembleUnion") AS "GB_Union") AS "U"

-- Code For temporary table tmp_20180508184822_codegen_oi1omz_gb_sum part 1. Create 


CREATE TEMPORARY TABLE tmp_20180508184822_codegen_oi1omz_gb_sum (
	"KEY" BIGINT, 
	"Estimator" DOUBLE
)
...
-- Code For temporary table tmp_20180508184822_codegen_oi1omz_gb_sum part 2. Populate

INSERT INTO tmp_20180508184822_codegen_oi1omz_gb_sum ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
FROM tmp_20180508184822_codegen_7dtil8_gb_union AS "GB_Union" GROUP BY "GB_Union"."KEY") AS "T") AS "GB_sum") AS "U"

-- Model deployment code

SELECT "GB_sum"."KEY" AS "KEY", 499.09288446517394 + 0.1 * "GB_sum"."Estimator" AS "Estimator" 
FROM tmp_20180508184822_codegen_oi1omz_gb_sum AS "GB_sum"