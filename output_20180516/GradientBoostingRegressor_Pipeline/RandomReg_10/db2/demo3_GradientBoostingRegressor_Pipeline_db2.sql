...
-- Code For temporary table tmp_20180602144422_qow_ads_imp_1_out part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180602144422_qow_ads_imp_1_out (
	"KEY" BIGINT, 
	impter_2 DOUBLE, 
	impter_3 DOUBLE, 
	impter_4 DOUBLE, 
...
-- Code For temporary table tmp_20180602144422_o23_ads_sca_2_out part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180602144422_o23_ads_sca_2_out (
	"KEY" BIGINT, 
	scaler_2 DOUBLE, 
	scaler_3 DOUBLE, 
	scaler_4 DOUBLE, 
...
-- Code For temporary table tmp_20180602144422_o23_ads_sca_2_out part 2. Populate

INSERT INTO tmp_20180602144422_o23_ads_sca_2_out SELECT "ADS_sca_2_OUT"."KEY", "ADS_sca_2_OUT".scaler_2, "ADS_sca_2_OUT".scaler_3, "ADS_sca_2_OUT".scaler_4, "ADS_sca_2_OUT".scaler_5, "ADS_sca_2_OUT".scaler_6, "ADS_sca_2_OUT".scaler_7, "ADS_sca_2_OUT".scaler_8, "ADS_sca_2_OUT".scaler_9, "ADS_sca_2_OUT".scaler_10, "ADS_sca_2_OUT".scaler_11 
...
FROM tmp_20180602144422_qow_ads_imp_1_out AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT"

-- Code For temporary table tmp_20180602144422_qs3_gb_b0 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180602144422_qs3_gb_b0 (
	"KEY" BIGINT, 
	"Estimator" DOUBLE
)
...
-- Code For temporary table tmp_20180602144422_qs3_gb_b0 part 2. Populate

INSERT INTO tmp_20180602144422_qs3_gb_b0 WITH "DT_node_lookup" AS 
...
FROM tmp_20180602144422_o23_ads_sca_2_out AS "ADS_sca_2_OUT"), 
"DT_node_data" AS 
...
-- Code For temporary table tmp_20180602144422_jg4_gb_b1 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180602144422_jg4_gb_b1 (
	"KEY" BIGINT, 
	"Estimator" DOUBLE
)
...
-- Code For temporary table tmp_20180602144422_jg4_gb_b1 part 2. Populate

INSERT INTO tmp_20180602144422_jg4_gb_b1 WITH "DT_node_lookup_10" AS 
...
-- Code For temporary table tmp_20180602144422_u9g_gb_sum part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180602144422_u9g_gb_sum (
	"KEY" BIGINT, 
	"Estimator" DOUBLE
)
...
-- Code For temporary table tmp_20180602144422_u9g_gb_sum part 2. Populate

INSERT INTO tmp_20180602144422_u9g_gb_sum WITH "GB_Union" AS 
...
FROM tmp_20180602144422_qs3_gb_b0 AS "GB_B0" UNION ALL SELECT "GB_B1"."KEY" AS "KEY", "GB_B1"."Estimator" AS "Estimator" 
FROM tmp_20180602144422_jg4_gb_b1 AS "GB_B1") AS "GB_EnsembleUnion")
...
FROM tmp_20180602144422_u9g_gb_sum AS "GB_sum"