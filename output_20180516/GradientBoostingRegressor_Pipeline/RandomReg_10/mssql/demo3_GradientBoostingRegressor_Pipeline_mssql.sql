...
-- Code For temporary table ##TMP_20180516113701_CODEGEN_0AM2SA_ADS_imp_1_OUT part 1. Create 


CREATE TABLE ##TMP_20180516113701_CODEGEN_0AM2SA_ADS_imp_1_OUT (
	[KEY] BIGINT NULL, 
...
-- Code For temporary table ##TMP_20180516113701_CODEGEN_A3JXAD_ADS_sca_2_OUT part 1. Create 


CREATE TABLE ##TMP_20180516113701_CODEGEN_A3JXAD_ADS_sca_2_OUT (
	[KEY] BIGINT NULL, 
	scaler_2 FLOAT NULL, 
	scaler_3 FLOAT NULL, 
	scaler_4 FLOAT NULL, 
...
-- Code For temporary table ##TMP_20180516113701_CODEGEN_A3JXAD_ADS_sca_2_OUT part 2. Populate

INSERT INTO ##TMP_20180516113701_CODEGEN_A3JXAD_ADS_sca_2_OUT ([KEY], scaler_2, scaler_3, scaler_4, scaler_5, scaler_6, scaler_7, scaler_8, scaler_9, scaler_10, scaler_11) SELECT [ADS_sca_2_OUT].[KEY], [ADS_sca_2_OUT].scaler_2, [ADS_sca_2_OUT].scaler_3, [ADS_sca_2_OUT].scaler_4, [ADS_sca_2_OUT].scaler_5, [ADS_sca_2_OUT].scaler_6, [ADS_sca_2_OUT].scaler_7, [ADS_sca_2_OUT].scaler_8, [ADS_sca_2_OUT].scaler_9, [ADS_sca_2_OUT].scaler_10, [ADS_sca_2_OUT].scaler_11 
...
FROM ##TMP_20180516113701_CODEGEN_0AM2SA_ADS_imp_1_OUT AS [ADS_imp_1_OUT]) AS [ADS_sca_2_OUT]

-- Code For temporary table ##TMP_20180516113701_CODEGEN_2KBGZ8_GB_B0 part 1. Create 


CREATE TABLE ##TMP_20180516113701_CODEGEN_2KBGZ8_GB_B0 (
	[KEY] BIGINT NULL, 
...
-- Code For temporary table ##TMP_20180516113701_CODEGEN_2KBGZ8_GB_B0 part 2. Populate
...
FROM ##TMP_20180516113701_CODEGEN_A3JXAD_ADS_sca_2_OUT AS [ADS_sca_2_OUT]), 
[DT_node_data] AS 
...
FROM [DT_Output_9])
 INSERT INTO ##TMP_20180516113701_CODEGEN_2KBGZ8_GB_B0 ([KEY], [Estimator]) SELECT [GB_B0].[KEY], [GB_B0].[Estimator] 
...
-- Code For temporary table ##TMP_20180516113701_CODEGEN_EYDRSP_GB_B1 part 1. Create 


CREATE TABLE ##TMP_20180516113701_CODEGEN_EYDRSP_GB_B1 (
	[KEY] BIGINT NULL, 
	[Estimator] FLOAT(53) NULL
)
...
-- Code For temporary table ##TMP_20180516113701_CODEGEN_EYDRSP_GB_B1 part 2. Populate
...
FROM [DT_Output_15])
 INSERT INTO ##TMP_20180516113701_CODEGEN_EYDRSP_GB_B1 ([KEY], [Estimator]) SELECT [GB_B1].[KEY], [GB_B1].[Estimator] 
...
-- Code For temporary table ##TMP_20180516113701_CODEGEN_L9388A_GB_sum part 1. Create 


CREATE TABLE ##TMP_20180516113701_CODEGEN_L9388A_GB_sum (
	[KEY] BIGINT NULL, 
	[Estimator] FLOAT(53) NULL
)
...
-- Code For temporary table ##TMP_20180516113701_CODEGEN_L9388A_GB_sum part 2. Populate
...
FROM ##TMP_20180516113701_CODEGEN_2KBGZ8_GB_B0 AS [GB_B0] UNION ALL SELECT [GB_B1].[KEY] AS [KEY], [GB_B1].[Estimator] AS [Estimator] 
FROM ##TMP_20180516113701_CODEGEN_EYDRSP_GB_B1 AS [GB_B1]) AS [GB_EnsembleUnion])
 INSERT INTO ##TMP_20180516113701_CODEGEN_L9388A_GB_sum ([KEY], [Estimator]) SELECT [GB_sum].[KEY], [GB_sum].[Estimator] 
...
FROM ##TMP_20180516113701_CODEGEN_L9388A_GB_sum AS [GB_sum]