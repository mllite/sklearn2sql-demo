...
-- Code For temporary table tmp_20180602144417_muu_ads_imp_1_out part 1. Create 

CREATE TEMPORARY TABLE `tmp_20180602144417_muu_ads_imp_1_out` STORED AS ORC AS SELECT `ADS_imp_1_OUT`.`KEY`, `ADS_imp_1_OUT`.`impter_2`, `ADS_imp_1_OUT`.`impter_3`, `ADS_imp_1_OUT`.`impter_4`, `ADS_imp_1_OUT`.`impter_5`, `ADS_imp_1_OUT`.`impter_6`, `ADS_imp_1_OUT`.`impter_7`, `ADS_imp_1_OUT`.`impter_8`, `ADS_imp_1_OUT`.`impter_9`, `ADS_imp_1_OUT`.`impter_10`, `ADS_imp_1_OUT`.`impter_11` 
...
-- Code For temporary table tmp_20180602144417_muu_ads_imp_1_out part 2. Populate

SELECT * FROM `tmp_20180602144417_muu_ads_imp_1_out`

-- Code For temporary table tmp_20180602144417_rno_ads_sca_2_out part 1. Create 

CREATE TEMPORARY TABLE `tmp_20180602144417_rno_ads_sca_2_out` STORED AS ORC AS SELECT `ADS_sca_2_OUT`.`KEY`, `ADS_sca_2_OUT`.`scaler_2`, `ADS_sca_2_OUT`.`scaler_3`, `ADS_sca_2_OUT`.`scaler_4`, `ADS_sca_2_OUT`.`scaler_5`, `ADS_sca_2_OUT`.`scaler_6`, `ADS_sca_2_OUT`.`scaler_7`, `ADS_sca_2_OUT`.`scaler_8`, `ADS_sca_2_OUT`.`scaler_9`, `ADS_sca_2_OUT`.`scaler_10`, `ADS_sca_2_OUT`.`scaler_11` 
...
FROM `tmp_20180602144417_muu_ads_imp_1_out` AS `ADS_imp_1_OUT`) AS `ADS_sca_2_OUT`

-- Code For temporary table tmp_20180602144417_rno_ads_sca_2_out part 2. Populate

SELECT * FROM `tmp_20180602144417_rno_ads_sca_2_out`

-- Code For temporary table tmp_20180602144418_mx4_gb_b0 part 1. Create 

CREATE TEMPORARY TABLE `tmp_20180602144418_mx4_gb_b0` STORED AS ORC AS WITH `DT_node_lookup` AS 
...
FROM `tmp_20180602144417_rno_ads_sca_2_out` AS `ADS_sca_2_OUT`), 
`DT_node_data` AS 
...
-- Code For temporary table tmp_20180602144418_mx4_gb_b0 part 2. Populate

SELECT * FROM `tmp_20180602144418_mx4_gb_b0`

-- Code For temporary table tmp_20180602144418_m8x_gb_b1 part 1. Create 

CREATE TEMPORARY TABLE `tmp_20180602144418_m8x_gb_b1` STORED AS ORC AS WITH `DT_node_lookup_10` AS 
...
-- Code For temporary table tmp_20180602144418_m8x_gb_b1 part 2. Populate

SELECT * FROM `tmp_20180602144418_m8x_gb_b1`

-- Code For temporary table tmp_20180602144418_e5y_gb_sum part 1. Create 

CREATE TEMPORARY TABLE `tmp_20180602144418_e5y_gb_sum` STORED AS ORC AS WITH `GB_Union` AS 
...
FROM `tmp_20180602144418_mx4_gb_b0` AS `GB_B0` UNION ALL SELECT `GB_B1`.`KEY` AS `KEY`, `GB_B1`.`Estimator` AS `Estimator` 
FROM `tmp_20180602144418_m8x_gb_b1` AS `GB_B1`) AS `GB_EnsembleUnion`)
...
-- Code For temporary table tmp_20180602144418_e5y_gb_sum part 2. Populate

SELECT * FROM `tmp_20180602144418_e5y_gb_sum`

-- Model deployment code

SELECT `GB_sum`.`KEY` AS `KEY`, 26.405852730652413 + 0.1 * `GB_sum`.`Estimator` AS `Estimator` 
FROM `tmp_20180602144418_e5y_gb_sum` AS `GB_sum`