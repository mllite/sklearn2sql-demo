...
-- Code For temporary table TMP_20180516121819_CODEGEN_L2TG0X_ADS_imp_1_OUT part 1. Create 


CREATE TEMPORARY TABLE `TMP_20180516121819_CODEGEN_L2TG0X_ADS_imp_1_OUT` (
	`KEY` BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20180516121819_CODEGEN_L2TG0X_ADS_imp_1_OUT part 2. Populate

INSERT INTO `TMP_20180516121819_CODEGEN_L2TG0X_ADS_imp_1_OUT` (`KEY`, imputer_output_2, imputer_output_3, imputer_output_4, imputer_output_5) SELECT `U`.`KEY`, `U`.imputer_output_2, `U`.imputer_output_3, `U`.imputer_output_4, `U`.imputer_output_5 
...
-- Code For temporary table TMP_20180516121819_CODEGEN_L2TG0X_ADS_imp_1_OUT part 3. Create Index 

CREATE INDEX `ix_TMP_20180516121819_CODEGEN_L2TG0X_ADS_imp_1_OUT_KEY` ON `TMP_20180516121819_CODEGEN_L2TG0X_ADS_imp_1_OUT` (`KEY`)

-- Code For temporary table TMP_20180516121819_CODEGEN_L13OGW_ADS_sca_2_OUT part 1. Create 


CREATE TEMPORARY TABLE `TMP_20180516121819_CODEGEN_L13OGW_ADS_sca_2_OUT` (
	`KEY` BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20180516121819_CODEGEN_L13OGW_ADS_sca_2_OUT part 2. Populate

INSERT INTO `TMP_20180516121819_CODEGEN_L13OGW_ADS_sca_2_OUT` (`KEY`, scaler_output_2, scaler_output_3, scaler_output_4, scaler_output_5) SELECT `U`.`KEY`, `U`.scaler_output_2, `U`.scaler_output_3, `U`.scaler_output_4, `U`.scaler_output_5 
...
FROM `TMP_20180516121819_CODEGEN_L2TG0X_ADS_imp_1_OUT` AS `ADS_imp_1_OUT`) AS `ADS_sca_2_OUT`) AS `U`

-- Code For temporary table TMP_20180516121819_CODEGEN_L13OGW_ADS_sca_2_OUT part 3. Create Index 

CREATE INDEX `ix_TMP_20180516121819_CODEGEN_L13OGW_ADS_sca_2_OUT_KEY` ON `TMP_20180516121819_CODEGEN_L13OGW_ADS_sca_2_OUT` (`KEY`)

-- Code For temporary table TMP_20180516121819_CODEGEN_JWSFL8_GB_B0 part 1. Create 


CREATE TEMPORARY TABLE `TMP_20180516121819_CODEGEN_JWSFL8_GB_B0` (
	`KEY` BIGINT, 
	`Estimator` DOUBLE
)
...
-- Code For temporary table TMP_20180516121819_CODEGEN_JWSFL8_GB_B0 part 2. Populate

INSERT INTO `TMP_20180516121819_CODEGEN_JWSFL8_GB_B0` (`KEY`, `Estimator`) SELECT `U`.`KEY`, `U`.`Estimator` 
...
FROM `TMP_20180516121819_CODEGEN_L13OGW_ADS_sca_2_OUT` AS `ADS_sca_2_OUT`), 
`DT_node_data` AS 
...
-- Code For temporary table TMP_20180516121819_CODEGEN_1FFVK2_GB_B1 part 1. Create 


CREATE TEMPORARY TABLE `TMP_20180516121819_CODEGEN_1FFVK2_GB_B1` (
	`KEY` BIGINT, 
	`Estimator` DOUBLE
)
...
-- Code For temporary table TMP_20180516121819_CODEGEN_1FFVK2_GB_B1 part 2. Populate

INSERT INTO `TMP_20180516121819_CODEGEN_1FFVK2_GB_B1` (`KEY`, `Estimator`) SELECT `U`.`KEY`, `U`.`Estimator` 
...
-- Code For temporary table TMP_20180516121819_CODEGEN_UGZABT_GB_sum part 1. Create 


CREATE TEMPORARY TABLE `TMP_20180516121819_CODEGEN_UGZABT_GB_sum` (
	`KEY` BIGINT NOT NULL, 
	`Estimator` DOUBLE, 
	PRIMARY KEY (`KEY`)
)
...
-- Code For temporary table TMP_20180516121819_CODEGEN_UGZABT_GB_sum part 2. Populate

INSERT INTO `TMP_20180516121819_CODEGEN_UGZABT_GB_sum` (`KEY`, `Estimator`) SELECT `U`.`KEY`, `U`.`Estimator` 
...
FROM `TMP_20180516121819_CODEGEN_JWSFL8_GB_B0` AS `GB_B0` UNION ALL SELECT `GB_B1`.`KEY` AS `KEY`, `GB_B1`.`Estimator` AS `Estimator` 
FROM `TMP_20180516121819_CODEGEN_1FFVK2_GB_B1` AS `GB_B1`) AS `GB_EnsembleUnion`)
...
-- Code For temporary table TMP_20180516121819_CODEGEN_UGZABT_GB_sum part 3. Create Index 

CREATE INDEX `ix_TMP_20180516121819_CODEGEN_UGZABT_GB_sum_KEY` ON `TMP_20180516121819_CODEGEN_UGZABT_GB_sum` (`KEY`)

-- Model deployment code

SELECT `GB_sum`.`KEY` AS `KEY`, 1.3612342030259192 + 0.1 * `GB_sum`.`Estimator` AS `Estimator` 
FROM `TMP_20180516121819_CODEGEN_UGZABT_GB_sum` AS `GB_sum`