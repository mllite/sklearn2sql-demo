...
-- Code For temporary table DEGEN_LTVVBE_ADS_IMP_1_OUT part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "DEGEN_LTVVBE_ADS_IMP_1_OUT" (
	"KEY" NUMBER(19), 
...
-- Code For temporary table DEGEN_TP60VJ_ADS_SCA_2_OUT part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "DEGEN_TP60VJ_ADS_SCA_2_OUT" (
	"KEY" NUMBER(19), 
...
FROM "DEGEN_LTVVBE_ADS_IMP_1_OUT" "ADS_imp_1_OUT") "ADS_sca_2_OUT") "U"

-- Code For temporary table 82612_CODEGEN_O7HIG2_GB_B0 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "82612_CODEGEN_O7HIG2_GB_B0" (
	"KEY" NUMBER(19), 
...
-- Code For temporary table 82612_CODEGEN_O7HIG2_GB_B0 part 2. Populate

INSERT INTO "82612_CODEGEN_O7HIG2_GB_B0" ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
FROM "DEGEN_TP60VJ_ADS_SCA_2_OUT" "ADS_sca_2_OUT"), 
"DT_node_data" AS 
...
-- Code For temporary table 82612_CODEGEN_KLHZD8_GB_B1 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "82612_CODEGEN_KLHZD8_GB_B1" (
	"KEY" NUMBER(19), 
	"Estimator" BINARY_DOUBLE
)
...
-- Code For temporary table 82612_CODEGEN_KLHZD8_GB_B1 part 2. Populate

INSERT INTO "82612_CODEGEN_KLHZD8_GB_B1" ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
-- Code For temporary table 12_CODEGEN_41TXEN_GB_UNION part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "12_CODEGEN_41TXEN_GB_UNION" (
	"KEY" NUMBER(19), 
	"Estimator" BINARY_DOUBLE
)
...
-- Code For temporary table 12_CODEGEN_41TXEN_GB_UNION part 2. Populate

INSERT INTO "12_CODEGEN_41TXEN_GB_UNION" ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
FROM "82612_CODEGEN_O7HIG2_GB_B0" "GB_B0" UNION ALL SELECT "GB_B1"."KEY" AS "KEY", "GB_B1"."Estimator" AS "Estimator" 
FROM "82612_CODEGEN_KLHZD8_GB_B1" "GB_B1") "GB_EnsembleUnion") "GB_Union") "U"

-- Code For temporary table 2612_CODEGEN_CBC66M_GB_SUM part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "2612_CODEGEN_CBC66M_GB_SUM" (
	"KEY" NUMBER(19), 
	"Estimator" BINARY_DOUBLE
)
...
-- Code For temporary table 2612_CODEGEN_CBC66M_GB_SUM part 2. Populate

INSERT INTO "2612_CODEGEN_CBC66M_GB_SUM" ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
FROM "12_CODEGEN_41TXEN_GB_UNION" "GB_Union" GROUP BY "GB_Union"."KEY") "T") "GB_sum") "U"

-- Model deployment code

SELECT "GB_sum"."KEY" AS "KEY", -11.471614782695335 + 0.1 * "GB_sum"."Estimator" AS "Estimator" 
FROM "2612_CODEGEN_CBC66M_GB_SUM" "GB_sum"