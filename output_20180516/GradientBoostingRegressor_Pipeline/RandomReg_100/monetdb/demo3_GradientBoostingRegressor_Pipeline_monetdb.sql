...
-- Code For temporary table tmp_20180508182611_codegen_two0ce_ads_imp_1_out part 1. Create 


CREATE TEMPORARY TABLE tmp_20180508182611_codegen_two0ce_ads_imp_1_out (
	"KEY" BIGINT, 
	impter_2 DOUBLE, 
	impter_3 DOUBLE, 
	impter_4 DOUBLE, 
...
-- Code For temporary table tmp_20180508182611_codegen_fsdufz_ads_sca_2_out part 1. Create 


CREATE TEMPORARY TABLE tmp_20180508182611_codegen_fsdufz_ads_sca_2_out (
	"KEY" BIGINT, 
	scaler_2 DOUBLE, 
	scaler_3 DOUBLE, 
	scaler_4 DOUBLE, 
...
FROM tmp_20180508182611_codegen_two0ce_ads_imp_1_out AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT") AS "U"

-- Code For temporary table tmp_20180508182612_codegen_uhk37r_gb_b0 part 1. Create 


CREATE TEMPORARY TABLE tmp_20180508182612_codegen_uhk37r_gb_b0 (
	"KEY" BIGINT, 
	"Estimator" DOUBLE
)
...
-- Code For temporary table tmp_20180508182612_codegen_uhk37r_gb_b0 part 2. Populate

INSERT INTO tmp_20180508182612_codegen_uhk37r_gb_b0 ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
FROM tmp_20180508182611_codegen_fsdufz_ads_sca_2_out AS "ADS_sca_2_OUT"), 
"DT_node_data" AS 
...
-- Code For temporary table tmp_20180508182612_codegen_302cai_gb_b1 part 1. Create 


CREATE TEMPORARY TABLE tmp_20180508182612_codegen_302cai_gb_b1 (
	"KEY" BIGINT, 
	"Estimator" DOUBLE
)
...
-- Code For temporary table tmp_20180508182612_codegen_302cai_gb_b1 part 2. Populate

INSERT INTO tmp_20180508182612_codegen_302cai_gb_b1 ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
-- Code For temporary table tmp_20180508182612_codegen_5f57rq_gb_union part 1. Create 


CREATE TEMPORARY TABLE tmp_20180508182612_codegen_5f57rq_gb_union (
	"KEY" BIGINT, 
	"Estimator" DOUBLE
)
...
-- Code For temporary table tmp_20180508182612_codegen_5f57rq_gb_union part 2. Populate

INSERT INTO tmp_20180508182612_codegen_5f57rq_gb_union ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
FROM tmp_20180508182612_codegen_uhk37r_gb_b0 AS "GB_B0" UNION ALL SELECT "GB_B1"."KEY" AS "KEY", "GB_B1"."Estimator" AS "Estimator" 
FROM tmp_20180508182612_codegen_302cai_gb_b1 AS "GB_B1") AS "GB_EnsembleUnion") AS "GB_Union") AS "U"

-- Code For temporary table tmp_20180508182612_codegen_56bw8m_gb_sum part 1. Create 


CREATE TEMPORARY TABLE tmp_20180508182612_codegen_56bw8m_gb_sum (
	"KEY" BIGINT, 
	"Estimator" DOUBLE
)
...
-- Code For temporary table tmp_20180508182612_codegen_56bw8m_gb_sum part 2. Populate

INSERT INTO tmp_20180508182612_codegen_56bw8m_gb_sum ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
FROM tmp_20180508182612_codegen_5f57rq_gb_union AS "GB_Union" GROUP BY "GB_Union"."KEY") AS "T") AS "GB_sum") AS "U"

-- Model deployment code

SELECT "GB_sum"."KEY" AS "KEY", -11.471614782695335 + 0.1 * "GB_sum"."Estimator" AS "Estimator" 
FROM tmp_20180508182612_codegen_56bw8m_gb_sum AS "GB_sum"