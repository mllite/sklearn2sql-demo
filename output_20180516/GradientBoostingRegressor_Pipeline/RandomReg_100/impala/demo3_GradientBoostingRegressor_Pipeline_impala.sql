...
-- Code For temporary table tmp_20180516114227_codegen_0ecn4l_ads_imp_1_out part 1. Create 


CREATE TABLE tmp_20180516114227_codegen_0ecn4l_ads_imp_1_out (
	`KEY` BIGINT, 
	impter_2 DOUBLE, 
	impter_3 DOUBLE, 
	impter_4 DOUBLE, 
...
-- Code For temporary table tmp_20180516114227_codegen_t30pio_ads_sca_2_out part 1. Create 


CREATE TABLE tmp_20180516114227_codegen_t30pio_ads_sca_2_out (
	`KEY` BIGINT, 
	scaler_2 DOUBLE, 
	scaler_3 DOUBLE, 
	scaler_4 DOUBLE, 
...
FROM tmp_20180516114227_codegen_0ecn4l_ads_imp_1_out AS `ADS_imp_1_OUT`) AS `ADS_sca_2_OUT`

-- Code For temporary table tmp_20180516114227_codegen_fo7y05_gb_b0 part 1. Create 


CREATE TABLE tmp_20180516114227_codegen_fo7y05_gb_b0 (
	`KEY` BIGINT, 
	`Estimator` DOUBLE
)
...
-- Code For temporary table tmp_20180516114227_codegen_fo7y05_gb_b0 part 2. Populate
...
FROM tmp_20180516114227_codegen_t30pio_ads_sca_2_out AS `ADS_sca_2_OUT`), 
`DT_node_data` AS 
...
FROM `DT_Output_9`)
 INSERT INTO tmp_20180516114227_codegen_fo7y05_gb_b0 (`KEY`, `Estimator`) SELECT `GB_B0`.`KEY`, `GB_B0`.`Estimator` 
...
-- Code For temporary table tmp_20180516114227_codegen_n54kke_gb_b1 part 1. Create 


CREATE TABLE tmp_20180516114227_codegen_n54kke_gb_b1 (
	`KEY` BIGINT, 
	`Estimator` DOUBLE
)
...
-- Code For temporary table tmp_20180516114227_codegen_n54kke_gb_b1 part 2. Populate
...
FROM `DT_Output_15`)
 INSERT INTO tmp_20180516114227_codegen_n54kke_gb_b1 (`KEY`, `Estimator`) SELECT `GB_B1`.`KEY`, `GB_B1`.`Estimator` 
...
-- Code For temporary table tmp_20180516114227_codegen_j0qoxl_gb_sum part 1. Create 


CREATE TABLE tmp_20180516114227_codegen_j0qoxl_gb_sum (
	`KEY` BIGINT, 
	`Estimator` DOUBLE
)
...
-- Code For temporary table tmp_20180516114227_codegen_j0qoxl_gb_sum part 2. Populate
...
FROM tmp_20180516114227_codegen_fo7y05_gb_b0 AS `GB_B0` UNION ALL SELECT `GB_B1`.`KEY` AS `KEY`, `GB_B1`.`Estimator` AS `Estimator` 
FROM tmp_20180516114227_codegen_n54kke_gb_b1 AS `GB_B1`) AS `GB_EnsembleUnion`)
 INSERT INTO tmp_20180516114227_codegen_j0qoxl_gb_sum (`KEY`, `Estimator`) SELECT `GB_sum`.`KEY`, `GB_sum`.`Estimator` 
...
FROM tmp_20180516114227_codegen_j0qoxl_gb_sum AS `GB_sum`