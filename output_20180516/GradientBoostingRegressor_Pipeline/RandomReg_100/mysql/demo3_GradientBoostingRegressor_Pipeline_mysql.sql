...
-- Code For temporary table TMP_20180516114226_CODEGEN_PD4K27_ADS_imp_1_OUT part 1. Create 


CREATE TEMPORARY TABLE `TMP_20180516114226_CODEGEN_PD4K27_ADS_imp_1_OUT` (
	`KEY` BIGINT NOT NULL, 
	impter_2 DOUBLE, 
	impter_3 DOUBLE, 
	impter_4 DOUBLE, 
...
-- Code For temporary table TMP_20180516114226_CODEGEN_PD4K27_ADS_imp_1_OUT part 3. Create Index 

CREATE INDEX `ix_TMP_20180516114226_CODEGEN_PD4K27_ADS_imp_1_OUT_KEY` ON `TMP_20180516114226_CODEGEN_PD4K27_ADS_imp_1_OUT` (`KEY`)

-- Code For temporary table TMP_20180516114226_CODEGEN_YT67BW_ADS_sca_2_OUT part 1. Create 


CREATE TEMPORARY TABLE `TMP_20180516114226_CODEGEN_YT67BW_ADS_sca_2_OUT` (
	`KEY` BIGINT NOT NULL, 
	scaler_2 DOUBLE, 
	scaler_3 DOUBLE, 
	scaler_4 DOUBLE, 
...
FROM `TMP_20180516114226_CODEGEN_PD4K27_ADS_imp_1_OUT` AS `ADS_imp_1_OUT`) AS `ADS_sca_2_OUT`) AS `U`

-- Code For temporary table TMP_20180516114226_CODEGEN_YT67BW_ADS_sca_2_OUT part 3. Create Index 

CREATE INDEX `ix_TMP_20180516114226_CODEGEN_YT67BW_ADS_sca_2_OUT_KEY` ON `TMP_20180516114226_CODEGEN_YT67BW_ADS_sca_2_OUT` (`KEY`)

-- Code For temporary table TMP_20180516114227_CODEGEN_OR730W_GB_B0 part 1. Create 


CREATE TEMPORARY TABLE `TMP_20180516114227_CODEGEN_OR730W_GB_B0` (
	`KEY` BIGINT, 
	`Estimator` DOUBLE
)
...
-- Code For temporary table TMP_20180516114227_CODEGEN_OR730W_GB_B0 part 2. Populate

INSERT INTO `TMP_20180516114227_CODEGEN_OR730W_GB_B0` (`KEY`, `Estimator`) SELECT `U`.`KEY`, `U`.`Estimator` 
...
FROM `TMP_20180516114226_CODEGEN_YT67BW_ADS_sca_2_OUT` AS `ADS_sca_2_OUT`), 
`DT_node_data` AS 
...
-- Code For temporary table TMP_20180516114227_CODEGEN_MX5QZT_GB_B1 part 1. Create 


CREATE TEMPORARY TABLE `TMP_20180516114227_CODEGEN_MX5QZT_GB_B1` (
	`KEY` BIGINT, 
	`Estimator` DOUBLE
)
...
-- Code For temporary table TMP_20180516114227_CODEGEN_MX5QZT_GB_B1 part 2. Populate

INSERT INTO `TMP_20180516114227_CODEGEN_MX5QZT_GB_B1` (`KEY`, `Estimator`) SELECT `U`.`KEY`, `U`.`Estimator` 
...
-- Code For temporary table TMP_20180516114227_CODEGEN_7K9CIF_GB_sum part 1. Create 


CREATE TEMPORARY TABLE `TMP_20180516114227_CODEGEN_7K9CIF_GB_sum` (
	`KEY` BIGINT NOT NULL, 
	`Estimator` DOUBLE, 
	PRIMARY KEY (`KEY`)
)
...
-- Code For temporary table TMP_20180516114227_CODEGEN_7K9CIF_GB_sum part 2. Populate

INSERT INTO `TMP_20180516114227_CODEGEN_7K9CIF_GB_sum` (`KEY`, `Estimator`) SELECT `U`.`KEY`, `U`.`Estimator` 
...
FROM `TMP_20180516114227_CODEGEN_OR730W_GB_B0` AS `GB_B0` UNION ALL SELECT `GB_B1`.`KEY` AS `KEY`, `GB_B1`.`Estimator` AS `Estimator` 
FROM `TMP_20180516114227_CODEGEN_MX5QZT_GB_B1` AS `GB_B1`) AS `GB_EnsembleUnion`)
...
-- Code For temporary table TMP_20180516114227_CODEGEN_7K9CIF_GB_sum part 3. Create Index 

CREATE INDEX `ix_TMP_20180516114227_CODEGEN_7K9CIF_GB_sum_KEY` ON `TMP_20180516114227_CODEGEN_7K9CIF_GB_sum` (`KEY`)

-- Model deployment code

SELECT `GB_sum`.`KEY` AS `KEY`, -11.471614782695335 + 0.1 * `GB_sum`.`Estimator` AS `Estimator` 
FROM `TMP_20180516114227_CODEGEN_7K9CIF_GB_sum` AS `GB_sum`