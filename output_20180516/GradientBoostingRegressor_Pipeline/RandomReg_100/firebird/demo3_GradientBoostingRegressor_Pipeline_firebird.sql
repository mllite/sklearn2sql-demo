...
-- Code For temporary table TMP_20180516_CODEGEN_N3Z9U3_ADS part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180516_CODEGEN_N3Z9U3_ADS" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20180516_CODEGEN_N3Z9U3_ADS part 3. Create Index 

CREATE INDEX "ix_TMP_20180516_CODEGEN_6b48" ON "TMP_20180516_CODEGEN_N3Z9U3_ADS" ("KEY")

-- Code For temporary table TMP_20180516_CODEGEN_S9S9ML_ADS part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180516_CODEGEN_S9S9ML_ADS" (
	"KEY" BIGINT NOT NULL, 
...
FROM "TMP_20180516_CODEGEN_N3Z9U3_ADS" AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT") AS "U"

-- Code For temporary table TMP_20180516_CODEGEN_S9S9ML_ADS part 3. Create Index 

CREATE INDEX "ix_TMP_20180516_CODEGEN_22ac" ON "TMP_20180516_CODEGEN_S9S9ML_ADS" ("KEY")

-- Code For temporary table TMP_20180516_CODEGEN_CVKZXQ_GB_ part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180516_CODEGEN_CVKZXQ_GB_" (
	"KEY" BIGINT, 
...
-- Code For temporary table TMP_20180516_CODEGEN_CVKZXQ_GB_ part 2. Populate

INSERT INTO "TMP_20180516_CODEGEN_CVKZXQ_GB_" ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
FROM "TMP_20180516_CODEGEN_S9S9ML_ADS" AS "ADS_sca_2_OUT"), 
"DT_node_data" AS 
...
-- Code For temporary table TMP_20180516_CODEGEN_D0KVV2_GB_ part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180516_CODEGEN_D0KVV2_GB_" (
	"KEY" BIGINT, 
	"Estimator" DOUBLE PRECISION
)
...
-- Code For temporary table TMP_20180516_CODEGEN_D0KVV2_GB_ part 2. Populate

INSERT INTO "TMP_20180516_CODEGEN_D0KVV2_GB_" ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
-- Code For temporary table TMP_20180516_CODEGEN_BKRRKE_GB_ part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180516_CODEGEN_BKRRKE_GB_" (
	"KEY" BIGINT NOT NULL, 
	"Estimator" DOUBLE PRECISION, 
	PRIMARY KEY ("KEY")
)
...
-- Code For temporary table TMP_20180516_CODEGEN_BKRRKE_GB_ part 2. Populate

INSERT INTO "TMP_20180516_CODEGEN_BKRRKE_GB_" ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
FROM "TMP_20180516_CODEGEN_CVKZXQ_GB_" AS "GB_B0" UNION ALL SELECT "GB_B1"."KEY" AS "KEY", "GB_B1"."Estimator" AS "Estimator" 
FROM "TMP_20180516_CODEGEN_D0KVV2_GB_" AS "GB_B1") AS "GB_EnsembleUnion")
...
-- Code For temporary table TMP_20180516_CODEGEN_BKRRKE_GB_ part 3. Create Index 

CREATE INDEX "ix_TMP_20180516_CODEGEN_6262" ON "TMP_20180516_CODEGEN_BKRRKE_GB_" ("KEY")

-- Model deployment code

SELECT "GB_sum"."KEY" AS "KEY", -11.471614782695335 + 0.1 * "GB_sum"."Estimator" AS "Estimator" 
FROM "TMP_20180516_CODEGEN_BKRRKE_GB_" AS "GB_sum"