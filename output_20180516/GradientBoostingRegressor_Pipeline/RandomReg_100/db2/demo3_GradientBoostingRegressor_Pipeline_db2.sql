...
-- Code For temporary table tmp_20180516114235_codegen_o89v82_ads_imp_1_out part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180516114235_codegen_o89v82_ads_imp_1_out (
	"KEY" BIGINT, 
	impter_2 DOUBLE, 
	impter_3 DOUBLE, 
	impter_4 DOUBLE, 
...
-- Code For temporary table tmp_20180516114235_codegen_zkgdqj_ads_sca_2_out part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180516114235_codegen_zkgdqj_ads_sca_2_out (
	"KEY" BIGINT, 
	scaler_2 DOUBLE, 
	scaler_3 DOUBLE, 
	scaler_4 DOUBLE, 
...
FROM tmp_20180516114235_codegen_o89v82_ads_imp_1_out AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT"

-- Code For temporary table tmp_20180516114235_codegen_w976uv_gb_b0 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180516114235_codegen_w976uv_gb_b0 (
	"KEY" BIGINT, 
	"Estimator" DOUBLE
)
...
-- Code For temporary table tmp_20180516114235_codegen_w976uv_gb_b0 part 2. Populate

INSERT INTO tmp_20180516114235_codegen_w976uv_gb_b0 WITH "DT_node_lookup" AS 
...
FROM tmp_20180516114235_codegen_zkgdqj_ads_sca_2_out AS "ADS_sca_2_OUT"), 
"DT_node_data" AS 
...
-- Code For temporary table tmp_20180516114235_codegen_huzhnm_gb_b1 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180516114235_codegen_huzhnm_gb_b1 (
	"KEY" BIGINT, 
	"Estimator" DOUBLE
)
...
-- Code For temporary table tmp_20180516114235_codegen_huzhnm_gb_b1 part 2. Populate

INSERT INTO tmp_20180516114235_codegen_huzhnm_gb_b1 WITH "DT_node_lookup_10" AS 
...
-- Code For temporary table tmp_20180516114235_codegen_gm9euz_gb_sum part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180516114235_codegen_gm9euz_gb_sum (
	"KEY" BIGINT, 
	"Estimator" DOUBLE
)
...
-- Code For temporary table tmp_20180516114235_codegen_gm9euz_gb_sum part 2. Populate

INSERT INTO tmp_20180516114235_codegen_gm9euz_gb_sum WITH "GB_Union" AS 
...
FROM tmp_20180516114235_codegen_w976uv_gb_b0 AS "GB_B0" UNION ALL SELECT "GB_B1"."KEY" AS "KEY", "GB_B1"."Estimator" AS "Estimator" 
FROM tmp_20180516114235_codegen_huzhnm_gb_b1 AS "GB_B1") AS "GB_EnsembleUnion")
...
FROM tmp_20180516114235_codegen_gm9euz_gb_sum AS "GB_sum"