...
FROM iris AS "ADS"), 
linear_model_cte AS 
(SELECT linear_input."KEY" AS "KEY", 13.758599124452747 * linear_input."Feature_0" + 46.27892432770464 * linear_input."Feature_1" + -63.164477798623885 * linear_input."Feature_2" + -26.26641651031884 * linear_input."Feature_3" + 9.771784785528839 AS "Score_0", 23.764853033145435 * linear_input."Feature_0" + -135.08442776735436 * linear_input."Feature_1" + -8.130081300813004 * linear_input."Feature_2" + -71.91994996873042 * linear_input."Feature_3" + 39.25300669771319 AS "Score_1", -117.57348342714158 * linear_input."Feature_0" + -99.43714821763571 * linear_input."Feature_1" + 176.36022514071246 * linear_input."Feature_2" + 135.08442776735419 * linear_input."Feature_3" + -75.97597864541908 AS "Score_2" 
FROM linear_input), 
