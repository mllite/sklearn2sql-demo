...
-- Code For temporary table ##TMP_20180602143619_5VP_ADS_imp_1_OUT part 1. Create 


CREATE TABLE ##TMP_20180602143619_5VP_ADS_imp_1_OUT (
	[KEY] BIGINT NULL, 
...
-- Code For temporary table ##TMP_20180602143619_B48_ADS_sca_2_OUT part 1. Create 


CREATE TABLE ##TMP_20180602143619_B48_ADS_sca_2_OUT (
	[KEY] BIGINT NULL, 
	scaler_2 FLOAT NULL, 
	scaler_3 FLOAT NULL, 
	scaler_4 FLOAT NULL, 
...
FROM ##TMP_20180602143619_5VP_ADS_imp_1_OUT AS [ADS_imp_1_OUT]) AS [ADS_sca_2_OUT]

-- Code For temporary table ##TMP_20180602143620_A4Q_CalProb_B0 part 1. Create 


CREATE TABLE ##TMP_20180602143620_A4Q_CalProb_B0 (
	[KEY] BIGINT NULL, 
	[Proba_0] FLOAT NULL, 
	[Proba_1] FLOAT NULL, 
	[Proba_2] FLOAT NULL, 
...
-- Code For temporary table ##TMP_20180602143620_A4Q_CalProb_B0 part 2. Populate
...
FROM ##TMP_20180602143619_B48_ADS_sca_2_OUT AS [ADS_sca_2_OUT]), 
[DT_node_data] AS 
...
FROM sigmoid_calibration_3)
 INSERT INTO ##TMP_20180602143620_A4Q_CalProb_B0 ([KEY], [Proba_0], [Proba_1], [Proba_2], [Proba_3]) SELECT [CalProb_B0].[KEY], [CalProb_B0].[Proba_0], [CalProb_B0].[Proba_1], [CalProb_B0].[Proba_2], [CalProb_B0].[Proba_3] 
...
-- Code For temporary table ##TMP_20180602143620_NC6_CalProb_avg part 1. Create 


CREATE TABLE ##TMP_20180602143620_NC6_CalProb_avg (
	[KEY] BIGINT NULL, 
...
-- Code For temporary table ##TMP_20180602143620_NC6_CalProb_avg part 2. Populate
...
FROM ##TMP_20180602143620_A4Q_CalProb_B0 AS [CalProb_B0]) AS [CalProb_EnsembleUnion])
 INSERT INTO ##TMP_20180602143620_NC6_CalProb_avg ([KEY], [Proba_0], [Proba_1], [Proba_2], [Proba_3]) SELECT [CalProb_avg].[KEY], [CalProb_avg].[Proba_0], [CalProb_avg].[Proba_1], [CalProb_avg].[Proba_2], [CalProb_avg].[Proba_3] 
...
FROM ##TMP_20180602143620_NC6_CalProb_avg AS [CalProb_avg]), 
