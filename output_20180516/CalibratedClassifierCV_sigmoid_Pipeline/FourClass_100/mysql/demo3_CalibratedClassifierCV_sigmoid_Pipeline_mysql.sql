...
-- Code For temporary table TMP_20180508181612_CODEGEN_SJOWHB_ADS_imp_1_OUT part 1. Create 


CREATE TEMPORARY TABLE `TMP_20180508181612_CODEGEN_SJOWHB_ADS_imp_1_OUT` (
	`KEY` BIGINT NOT NULL, 
	impter_2 DOUBLE, 
	impter_3 DOUBLE, 
	impter_4 DOUBLE, 
...
-- Code For temporary table TMP_20180508181612_CODEGEN_SJOWHB_ADS_imp_1_OUT part 3. Create Index 

CREATE INDEX `ix_TMP_20180508181612_CODEGEN_SJOWHB_ADS_imp_1_OUT_KEY` ON `TMP_20180508181612_CODEGEN_SJOWHB_ADS_imp_1_OUT` (`KEY`)

-- Code For temporary table TMP_20180508181612_CODEGEN_SX9AAB_ADS_sca_2_OUT part 1. Create 


CREATE TEMPORARY TABLE `TMP_20180508181612_CODEGEN_SX9AAB_ADS_sca_2_OUT` (
	`KEY` BIGINT NOT NULL, 
	scaler_2 DOUBLE, 
	scaler_3 DOUBLE, 
	scaler_4 DOUBLE, 
...
FROM `TMP_20180508181612_CODEGEN_SJOWHB_ADS_imp_1_OUT` AS `ADS_imp_1_OUT`) AS `ADS_sca_2_OUT`) AS `U`

-- Code For temporary table TMP_20180508181612_CODEGEN_SX9AAB_ADS_sca_2_OUT part 3. Create Index 

CREATE INDEX `ix_TMP_20180508181612_CODEGEN_SX9AAB_ADS_sca_2_OUT_KEY` ON `TMP_20180508181612_CODEGEN_SX9AAB_ADS_sca_2_OUT` (`KEY`)

-- Code For temporary table TMP_20180508181612_CODEGEN_CL4IG8_CalProb_B0 part 1. Create 


CREATE TEMPORARY TABLE `TMP_20180508181612_CODEGEN_CL4IG8_CalProb_B0` (
	`KEY` BIGINT, 
	`Proba_0` DOUBLE, 
	`Proba_1` DOUBLE, 
	`Proba_2` DOUBLE, 
...
-- Code For temporary table TMP_20180508181612_CODEGEN_CL4IG8_CalProb_B0 part 2. Populate

INSERT INTO `TMP_20180508181612_CODEGEN_CL4IG8_CalProb_B0` (`KEY`, `Proba_0`, `Proba_1`, `Proba_2`, `Proba_3`) SELECT `U`.`KEY`, `U`.`Proba_0`, `U`.`Proba_1`, `U`.`Proba_2`, `U`.`Proba_3` 
...
FROM `TMP_20180508181612_CODEGEN_SX9AAB_ADS_sca_2_OUT` AS `ADS_sca_2_OUT`), 
`DT_node_data` AS 
...
-- Code For temporary table TMP_20180508181612_CODEGEN_UKZH5W_CalProb_Union part 1. Create 


CREATE TEMPORARY TABLE `TMP_20180508181612_CODEGEN_UKZH5W_CalProb_Union` (
	`KEY` BIGINT, 
	`Proba_0` DOUBLE, 
	`Proba_1` DOUBLE, 
	`Proba_2` DOUBLE, 
...
-- Code For temporary table TMP_20180508181612_CODEGEN_UKZH5W_CalProb_Union part 2. Populate

INSERT INTO `TMP_20180508181612_CODEGEN_UKZH5W_CalProb_Union` (`KEY`, `Proba_0`, `Proba_1`, `Proba_2`, `Proba_3`) SELECT `U`.`KEY`, `U`.`Proba_0`, `U`.`Proba_1`, `U`.`Proba_2`, `U`.`Proba_3` 
...
FROM `TMP_20180508181612_CODEGEN_CL4IG8_CalProb_B0` AS `CalProb_B0`) AS `CalProb_EnsembleUnion`) AS `CalProb_Union`) AS `U`

-- Code For temporary table TMP_20180508181612_CODEGEN_H85UTS_CalProb_avg part 1. Create 


CREATE TEMPORARY TABLE `TMP_20180508181612_CODEGEN_H85UTS_CalProb_avg` (
	`KEY` BIGINT NOT NULL, 
	`Proba_0` DOUBLE, 
	`Proba_1` DOUBLE, 
	`Proba_2` DOUBLE, 
...
-- Code For temporary table TMP_20180508181612_CODEGEN_H85UTS_CalProb_avg part 2. Populate

INSERT INTO `TMP_20180508181612_CODEGEN_H85UTS_CalProb_avg` (`KEY`, `Proba_0`, `Proba_1`, `Proba_2`, `Proba_3`) SELECT `U`.`KEY`, `U`.`Proba_0`, `U`.`Proba_1`, `U`.`Proba_2`, `U`.`Proba_3` 
...
FROM `TMP_20180508181612_CODEGEN_UKZH5W_CalProb_Union` AS `CalProb_Union` GROUP BY `CalProb_Union`.`KEY`) AS `T`) AS `CalProb_avg`) AS `U`

-- Code For temporary table TMP_20180508181612_CODEGEN_H85UTS_CalProb_avg part 3. Create Index 

CREATE INDEX `ix_TMP_20180508181612_CODEGEN_H85UTS_CalProb_avg_KEY` ON `TMP_20180508181612_CODEGEN_H85UTS_CalProb_avg` (`KEY`)
...
FROM `TMP_20180508181612_CODEGEN_H85UTS_CalProb_avg` AS `CalProb_avg`), 
