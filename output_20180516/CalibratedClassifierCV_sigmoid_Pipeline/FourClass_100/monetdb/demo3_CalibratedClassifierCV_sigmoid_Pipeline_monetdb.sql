...
-- Code For temporary table tmp_20180508181612_codegen_bayzgl_ads_imp_1_out part 1. Create 


CREATE TEMPORARY TABLE tmp_20180508181612_codegen_bayzgl_ads_imp_1_out (
	"KEY" BIGINT, 
	impter_2 DOUBLE, 
	impter_3 DOUBLE, 
	impter_4 DOUBLE, 
...
-- Code For temporary table tmp_20180508181612_codegen_jnzz7q_ads_sca_2_out part 1. Create 


CREATE TEMPORARY TABLE tmp_20180508181612_codegen_jnzz7q_ads_sca_2_out (
	"KEY" BIGINT, 
	scaler_2 DOUBLE, 
	scaler_3 DOUBLE, 
	scaler_4 DOUBLE, 
...
FROM tmp_20180508181612_codegen_bayzgl_ads_imp_1_out AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT") AS "U"

-- Code For temporary table tmp_20180508181612_codegen_pse3xp_calprob_b0 part 1. Create 


CREATE TEMPORARY TABLE tmp_20180508181612_codegen_pse3xp_calprob_b0 (
	"KEY" BIGINT, 
	"Proba_0" DOUBLE, 
	"Proba_1" DOUBLE, 
	"Proba_2" DOUBLE, 
...
-- Code For temporary table tmp_20180508181612_codegen_pse3xp_calprob_b0 part 2. Populate

INSERT INTO tmp_20180508181612_codegen_pse3xp_calprob_b0 ("KEY", "Proba_0", "Proba_1", "Proba_2", "Proba_3") SELECT "U"."KEY", "U"."Proba_0", "U"."Proba_1", "U"."Proba_2", "U"."Proba_3" 
...
FROM tmp_20180508181612_codegen_jnzz7q_ads_sca_2_out AS "ADS_sca_2_OUT"), 
"DT_node_data" AS 
...
(SELECT "Calibrated_Model_0"."KEY" AS "KEY", 1.0 / (1.0 + exp(CASE WHEN (CASE WHEN (-100.0 <= -(1.00568628681973 * "Calibrated_Model_0"."ScoreOrProba_0" + -1.4701027466284406)) THEN -(1.00568628681973 * "Calibrated_Model_0"."ScoreOrProba_0" + -1.4701027466284406) ELSE -100.0 END <= 100.0) THEN CASE WHEN (-100.0 <= -(1.00568628681973 * "Calibrated_Model_0"."ScoreOrProba_0" + -1.4701027466284406)) THEN -(1.00568628681973 * "Calibrated_Model_0"."ScoreOrProba_0" + -1.4701027466284406) ELSE -100.0 END ELSE 100.0 END)) AS "Proba_0", 1.0 / (1.0 + exp(CASE WHEN (CASE WHEN (-100.0 <= -(0.4904074089858073 * "Calibrated_Model_0"."ScoreOrProba_1" + -1.0534679407644512)) THEN -(0.4904074089858073 * "Calibrated_Model_0"."ScoreOrProba_1" + -1.0534679407644512) ELSE -100.0 END <= 100.0) THEN CASE WHEN (-100.0 <= -(0.4904074089858073 * "Calibrated_Model_0"."ScoreOrProba_1" + -1.0534679407644512)) THEN -(0.4904074089858073 * "Calibrated_Model_0"."ScoreOrProba_1" + -1.0534679407644512) ELSE -100.0 END ELSE 100.0 END)) AS "Proba_1", 1.0 / (1.0 + exp(CASE WHEN (CASE WHEN (-100.0 <= -(-0.05354705495103326 * "Calibrated_Model_0"."ScoreOrProba_2" + -1.1098503406893812)) THEN -(-0.05354705495103326 * "Calibrated_Model_0"."ScoreOrProba_2" + -1.1098503406893812) ELSE -100.0 END <= 100.0) THEN CASE WHEN (-100.0 <= -(-0.05354705495103326 * "Calibrated_Model_0"."ScoreOrProba_2" + -1.1098503406893812)) THEN -(-0.05354705495103326 * "Calibrated_Model_0"."ScoreOrProba_2" + -1.1098503406893812) ELSE -100.0 END ELSE 100.0 END)) AS "Proba_2", 1.0 / (1.0 + exp(CASE WHEN (CASE WHEN (-100.0 <= -(-0.6981963782957894 * "Calibrated_Model_0"."ScoreOrProba_3" + -0.9507144468287336)) THEN -(-0.6981963782957894 * "Calibrated_Model_0"."ScoreOrProba_3" + -0.9507144468287336) ELSE -100.0 END <= 100.0) THEN CASE WHEN (-100.0 <= -(-0.6981963782957894 * "Calibrated_Model_0"."ScoreOrProba_3" + -0.9507144468287336)) THEN -(-0.6981963782957894 * "Calibrated_Model_0"."ScoreOrProba_3" + -0.9507144468287336) ELSE -100.0 END ELSE 100.0 END)) AS "Proba_3" 
...
(SELECT "Calibrated_Model_1"."KEY" AS "KEY", 1.0 / (1.0 + exp(CASE WHEN (CASE WHEN (-100.0 <= -(0.21394252761946847 * "Calibrated_Model_1"."ScoreOrProba_0" + -1.1302338593460968)) THEN -(0.21394252761946847 * "Calibrated_Model_1"."ScoreOrProba_0" + -1.1302338593460968) ELSE -100.0 END <= 100.0) THEN CASE WHEN (-100.0 <= -(0.21394252761946847 * "Calibrated_Model_1"."ScoreOrProba_0" + -1.1302338593460968)) THEN -(0.21394252761946847 * "Calibrated_Model_1"."ScoreOrProba_0" + -1.1302338593460968) ELSE -100.0 END ELSE 100.0 END)) AS "Proba_0", 1.0 / (1.0 + exp(CASE WHEN (CASE WHEN (-100.0 <= -(-0.7183281215311701 * "Calibrated_Model_1"."ScoreOrProba_1" + -0.8825624769332785)) THEN -(-0.7183281215311701 * "Calibrated_Model_1"."ScoreOrProba_1" + -0.8825624769332785) ELSE -100.0 END <= 100.0) THEN CASE WHEN (-100.0 <= -(-0.7183281215311701 * "Calibrated_Model_1"."ScoreOrProba_1" + -0.8825624769332785)) THEN -(-0.7183281215311701 * "Calibrated_Model_1"."ScoreOrProba_1" + -0.8825624769332785) ELSE -100.0 END ELSE 100.0 END)) AS "Proba_1", 1.0 / (1.0 + exp(CASE WHEN (CASE WHEN (-100.0 <= -(2.737153903483464 * "Calibrated_Model_1"."ScoreOrProba_2" + -1.8417698417441246)) THEN -(2.737153903483464 * "Calibrated_Model_1"."ScoreOrProba_2" + -1.8417698417441246) ELSE -100.0 END <= 100.0) THEN CASE WHEN (-100.0 <= -(2.737153903483464 * "Calibrated_Model_1"."ScoreOrProba_2" + -1.8417698417441246)) THEN -(2.737153903483464 * "Calibrated_Model_1"."ScoreOrProba_2" + -1.8417698417441246) ELSE -100.0 END ELSE 100.0 END)) AS "Proba_2", 1.0 / (1.0 + exp(CASE WHEN (CASE WHEN (-100.0 <= -(-0.285686600159873 * "Calibrated_Model_1"."ScoreOrProba_3" + -1.0093591526805594)) THEN -(-0.285686600159873 * "Calibrated_Model_1"."ScoreOrProba_3" + -1.0093591526805594) ELSE -100.0 END <= 100.0) THEN CASE WHEN (-100.0 <= -(-0.285686600159873 * "Calibrated_Model_1"."ScoreOrProba_3" + -1.0093591526805594)) THEN -(-0.285686600159873 * "Calibrated_Model_1"."ScoreOrProba_3" + -1.0093591526805594) ELSE -100.0 END ELSE 100.0 END)) AS "Proba_3" 
...
(SELECT "Calibrated_Model_2"."KEY" AS "KEY", 1.0 / (1.0 + exp(CASE WHEN (CASE WHEN (-100.0 <= -(1.8436247099820837 * "Calibrated_Model_2"."ScoreOrProba_0" + -1.757857880020436)) THEN -(1.8436247099820837 * "Calibrated_Model_2"."ScoreOrProba_0" + -1.757857880020436) ELSE -100.0 END <= 100.0) THEN CASE WHEN (-100.0 <= -(1.8436247099820837 * "Calibrated_Model_2"."ScoreOrProba_0" + -1.757857880020436)) THEN -(1.8436247099820837 * "Calibrated_Model_2"."ScoreOrProba_0" + -1.757857880020436) ELSE -100.0 END ELSE 100.0 END)) AS "Proba_0", 1.0 / (1.0 + exp(CASE WHEN (CASE WHEN (-100.0 <= -(-1.583104098016066 * "Calibrated_Model_2"."ScoreOrProba_1" + -0.9462183936537009)) THEN -(-1.583104098016066 * "Calibrated_Model_2"."ScoreOrProba_1" + -0.9462183936537009) ELSE -100.0 END <= 100.0) THEN CASE WHEN (-100.0 <= -(-1.583104098016066 * "Calibrated_Model_2"."ScoreOrProba_1" + -0.9462183936537009)) THEN -(-1.583104098016066 * "Calibrated_Model_2"."ScoreOrProba_1" + -0.9462183936537009) ELSE -100.0 END ELSE 100.0 END)) AS "Proba_1", 1.0 / (1.0 + exp(CASE WHEN (CASE WHEN (-100.0 <= -(3.277420526455033 * "Calibrated_Model_2"."ScoreOrProba_2" + -2.2444049551885428)) THEN -(3.277420526455033 * "Calibrated_Model_2"."ScoreOrProba_2" + -2.2444049551885428) ELSE -100.0 END <= 100.0) THEN CASE WHEN (-100.0 <= -(3.277420526455033 * "Calibrated_Model_2"."ScoreOrProba_2" + -2.2444049551885428)) THEN -(3.277420526455033 * "Calibrated_Model_2"."ScoreOrProba_2" + -2.2444049551885428) ELSE -100.0 END ELSE 100.0 END)) AS "Proba_2", 1.0 / (1.0 + exp(CASE WHEN (CASE WHEN (-100.0 <= -(1.4269233631128861 * "Calibrated_Model_2"."ScoreOrProba_3" + -1.6723071852272757)) THEN -(1.4269233631128861 * "Calibrated_Model_2"."ScoreOrProba_3" + -1.6723071852272757) ELSE -100.0 END <= 100.0) THEN CASE WHEN (-100.0 <= -(1.4269233631128861 * "Calibrated_Model_2"."ScoreOrProba_3" + -1.6723071852272757)) THEN -(1.4269233631128861 * "Calibrated_Model_2"."ScoreOrProba_3" + -1.6723071852272757) ELSE -100.0 END ELSE 100.0 END)) AS "Proba_3" 
...
(SELECT "Calibrated_Model_3"."KEY" AS "KEY", 1.0 / (1.0 + exp(CASE WHEN (CASE WHEN (-100.0 <= -(0.6206414655992062 * "Calibrated_Model_3"."ScoreOrProba_0" + -1.1673213405522938)) THEN -(0.6206414655992062 * "Calibrated_Model_3"."ScoreOrProba_0" + -1.1673213405522938) ELSE -100.0 END <= 100.0) THEN CASE WHEN (-100.0 <= -(0.6206414655992062 * "Calibrated_Model_3"."ScoreOrProba_0" + -1.1673213405522938)) THEN -(0.6206414655992062 * "Calibrated_Model_3"."ScoreOrProba_0" + -1.1673213405522938) ELSE -100.0 END ELSE 100.0 END)) AS "Proba_0", 1.0 / (1.0 + exp(CASE WHEN (CASE WHEN (-100.0 <= -(-2.7761738984683926 * "Calibrated_Model_3"."ScoreOrProba_1" + -0.19966605688539338)) THEN -(-2.7761738984683926 * "Calibrated_Model_3"."ScoreOrProba_1" + -0.19966605688539338) ELSE -100.0 END <= 100.0) THEN CASE WHEN (-100.0 <= -(-2.7761738984683926 * "Calibrated_Model_3"."ScoreOrProba_1" + -0.19966605688539338)) THEN -(-2.7761738984683926 * "Calibrated_Model_3"."ScoreOrProba_1" + -0.19966605688539338) ELSE -100.0 END ELSE 100.0 END)) AS "Proba_1", 1.0 / (1.0 + exp(CASE WHEN (CASE WHEN (-100.0 <= -(-2.1447257820345906 * "Calibrated_Model_3"."ScoreOrProba_2" + -1.0509872207997617)) THEN -(-2.1447257820345906 * "Calibrated_Model_3"."ScoreOrProba_2" + -1.0509872207997617) ELSE -100.0 END <= 100.0) THEN CASE WHEN (-100.0 <= -(-2.1447257820345906 * "Calibrated_Model_3"."ScoreOrProba_2" + -1.0509872207997617)) THEN -(-2.1447257820345906 * "Calibrated_Model_3"."ScoreOrProba_2" + -1.0509872207997617) ELSE -100.0 END ELSE 100.0 END)) AS "Proba_2", 1.0 / (1.0 + exp(CASE WHEN (CASE WHEN (-100.0 <= -(1.0703910789584594 * "Calibrated_Model_3"."ScoreOrProba_3" + -1.2268123832374258)) THEN -(1.0703910789584594 * "Calibrated_Model_3"."ScoreOrProba_3" + -1.2268123832374258) ELSE -100.0 END <= 100.0) THEN CASE WHEN (-100.0 <= -(1.0703910789584594 * "Calibrated_Model_3"."ScoreOrProba_3" + -1.2268123832374258)) THEN -(1.0703910789584594 * "Calibrated_Model_3"."ScoreOrProba_3" + -1.2268123832374258) ELSE -100.0 END ELSE 100.0 END)) AS "Proba_3" 
...
-- Code For temporary table tmp_20180508181612_codegen_y4parg_calprob_union part 1. Create 


CREATE TEMPORARY TABLE tmp_20180508181612_codegen_y4parg_calprob_union (
	"KEY" BIGINT, 
	"Proba_0" DOUBLE, 
	"Proba_1" DOUBLE, 
	"Proba_2" DOUBLE, 
...
-- Code For temporary table tmp_20180508181612_codegen_y4parg_calprob_union part 2. Populate

INSERT INTO tmp_20180508181612_codegen_y4parg_calprob_union ("KEY", "Proba_0", "Proba_1", "Proba_2", "Proba_3") SELECT "U"."KEY", "U"."Proba_0", "U"."Proba_1", "U"."Proba_2", "U"."Proba_3" 
...
FROM tmp_20180508181612_codegen_pse3xp_calprob_b0 AS "CalProb_B0") AS "CalProb_EnsembleUnion") AS "CalProb_Union") AS "U"

-- Code For temporary table tmp_20180508181612_codegen_q8mpb2_calprob_avg part 1. Create 


CREATE TEMPORARY TABLE tmp_20180508181612_codegen_q8mpb2_calprob_avg (
	"KEY" BIGINT, 
	"Proba_0" DOUBLE, 
	"Proba_1" DOUBLE, 
	"Proba_2" DOUBLE, 
...
-- Code For temporary table tmp_20180508181612_codegen_q8mpb2_calprob_avg part 2. Populate

INSERT INTO tmp_20180508181612_codegen_q8mpb2_calprob_avg ("KEY", "Proba_0", "Proba_1", "Proba_2", "Proba_3") SELECT "U"."KEY", "U"."Proba_0", "U"."Proba_1", "U"."Proba_2", "U"."Proba_3" 
...
FROM tmp_20180508181612_codegen_y4parg_calprob_union AS "CalProb_Union" GROUP BY "CalProb_Union"."KEY") AS "T") AS "CalProb_avg") AS "U"
...
FROM tmp_20180508181612_codegen_q8mpb2_calprob_avg AS "CalProb_avg"), 
