...
-- Code For temporary table TMP_20180516_CODEGEN_SKCYFF_ADS part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180516_CODEGEN_SKCYFF_ADS" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20180516_CODEGEN_SKCYFF_ADS part 3. Create Index 

CREATE INDEX "ix_TMP_20180516_CODEGEN_5c0c" ON "TMP_20180516_CODEGEN_SKCYFF_ADS" ("KEY")

-- Code For temporary table TMP_20180516_CODEGEN_GBTA8X_ADS part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180516_CODEGEN_GBTA8X_ADS" (
	"KEY" BIGINT NOT NULL, 
...
FROM "TMP_20180516_CODEGEN_SKCYFF_ADS" AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT") AS "U"

-- Code For temporary table TMP_20180516_CODEGEN_GBTA8X_ADS part 3. Create Index 

CREATE INDEX "ix_TMP_20180516_CODEGEN_2dbd" ON "TMP_20180516_CODEGEN_GBTA8X_ADS" ("KEY")

-- Code For temporary table TMP_20180516_CODEGEN_4E4856_CAL part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180516_CODEGEN_4E4856_CAL" (
	"KEY" BIGINT, 
...
-- Code For temporary table TMP_20180516_CODEGEN_4E4856_CAL part 2. Populate

INSERT INTO "TMP_20180516_CODEGEN_4E4856_CAL" ("KEY", "Proba_0", "Proba_1", "Proba_2", "Proba_3") SELECT "U"."KEY", "U"."Proba_0", "U"."Proba_1", "U"."Proba_2", "U"."Proba_3" 
...
FROM "TMP_20180516_CODEGEN_GBTA8X_ADS" AS "ADS_sca_2_OUT"), 
"DT_node_data" AS 
...
-- Code For temporary table TMP_20180516_CODEGEN_UVNQJN_CAL part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180516_CODEGEN_UVNQJN_CAL" (
	"KEY" BIGINT NOT NULL, 
	"Proba_0" DOUBLE PRECISION, 
	"Proba_1" DOUBLE PRECISION, 
	"Proba_2" DOUBLE PRECISION, 
...
-- Code For temporary table TMP_20180516_CODEGEN_UVNQJN_CAL part 2. Populate

INSERT INTO "TMP_20180516_CODEGEN_UVNQJN_CAL" ("KEY", "Proba_0", "Proba_1", "Proba_2", "Proba_3") SELECT "U"."KEY", "U"."Proba_0", "U"."Proba_1", "U"."Proba_2", "U"."Proba_3" 
...
FROM "TMP_20180516_CODEGEN_4E4856_CAL" AS "CalProb_B0") AS "CalProb_EnsembleUnion")
...
-- Code For temporary table TMP_20180516_CODEGEN_UVNQJN_CAL part 3. Create Index 

CREATE INDEX "ix_TMP_20180516_CODEGEN_fa41" ON "TMP_20180516_CODEGEN_UVNQJN_CAL" ("KEY")
...
FROM "TMP_20180516_CODEGEN_UVNQJN_CAL" AS "CalProb_avg"), 
