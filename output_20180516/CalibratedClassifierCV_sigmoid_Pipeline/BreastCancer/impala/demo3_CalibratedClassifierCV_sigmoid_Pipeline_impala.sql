...
-- Code For temporary table tmp_20180602142324_idf_ads_imp_1_out part 1. Create 


CREATE TABLE tmp_20180602142324_idf_ads_imp_1_out (
	`KEY` BIGINT, 
	impter_2 DOUBLE, 
	impter_3 DOUBLE, 
	impter_4 DOUBLE, 
...
-- Code For temporary table tmp_20180602142324_qug_ads_sca_2_out part 1. Create 


CREATE TABLE tmp_20180602142324_qug_ads_sca_2_out (
	`KEY` BIGINT, 
	scaler_2 DOUBLE, 
	scaler_3 DOUBLE, 
	scaler_4 DOUBLE, 
...
FROM tmp_20180602142324_idf_ads_imp_1_out AS `ADS_imp_1_OUT`) AS `ADS_sca_2_OUT`

-- Code For temporary table tmp_20180602142324_15u_calprob_b0 part 1. Create 


CREATE TABLE tmp_20180602142324_15u_calprob_b0 (
	`KEY` BIGINT, 
	`Proba_1` DOUBLE, 
	`Proba_0` DOUBLE
)
...
-- Code For temporary table tmp_20180602142324_15u_calprob_b0 part 2. Populate
...
FROM tmp_20180602142324_qug_ads_sca_2_out AS `ADS_sca_2_OUT`), 
`DT_node_data` AS 
...
FROM sigmoid_calibration_3)
 INSERT INTO tmp_20180602142324_15u_calprob_b0 (`KEY`, `Proba_1`, `Proba_0`) SELECT `CalProb_B0`.`KEY`, `CalProb_B0`.`Proba_1`, `CalProb_B0`.`Proba_0` 
...
-- Code For temporary table tmp_20180602142324_sut_calprob_avg part 1. Create 


CREATE TABLE tmp_20180602142324_sut_calprob_avg (
	`KEY` BIGINT, 
	`Proba_1` DOUBLE, 
	`Proba_0` DOUBLE
)
...
-- Code For temporary table tmp_20180602142324_sut_calprob_avg part 2. Populate
...
FROM tmp_20180602142324_15u_calprob_b0 AS `CalProb_B0`) AS `CalProb_EnsembleUnion`)
 INSERT INTO tmp_20180602142324_sut_calprob_avg (`KEY`, `Proba_1`, `Proba_0`) SELECT `CalProb_avg`.`KEY`, `CalProb_avg`.`Proba_1`, `CalProb_avg`.`Proba_0` 
...
FROM tmp_20180602142324_sut_calprob_avg AS `CalProb_avg`), 
