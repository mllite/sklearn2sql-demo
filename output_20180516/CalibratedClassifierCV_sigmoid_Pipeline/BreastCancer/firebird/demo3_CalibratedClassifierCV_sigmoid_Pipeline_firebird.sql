...
-- Code For temporary table TMP_20180508180643_CODEGEN_DZ4W part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508180643_CODEGEN_DZ4W" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20180508180643_CODEGEN_DZ4W part 2. Populate

INSERT INTO "TMP_20180508180643_CODEGEN_DZ4W" ("KEY", impter_2, impter_3, impter_4, impter_5, impter_6, impter_7, impter_8, impter_9, impter_10, impter_11, impter_12, impter_13, impter_14, impter_15, impter_16, impter_17, impter_18, impter_19, impter_20, impter_21, impter_22, impter_23, impter_24, impter_25, impter_26, impter_27, impter_28, impter_29, impter_30, impter_31) SELECT "U"."KEY", "U".impter_2, "U".impter_3, "U".impter_4, "U".impter_5, "U".impter_6, "U".impter_7, "U".impter_8, "U".impter_9, "U".impter_10, "U".impter_11, "U".impter_12, "U".impter_13, "U".impter_14, "U".impter_15, "U".impter_16, "U".impter_17, "U".impter_18, "U".impter_19, "U".impter_20, "U".impter_21, "U".impter_22, "U".impter_23, "U".impter_24, "U".impter_25, "U".impter_26, "U".impter_27, "U".impter_28, "U".impter_29, "U".impter_30, "U".impter_31 
...
-- Code For temporary table TMP_20180508180643_CODEGEN_DZ4W part 3. Create Index 

CREATE INDEX "ix_TMP_20180508180643_C_e35d" ON "TMP_20180508180643_CODEGEN_DZ4W" ("KEY")

-- Code For temporary table TMP_20180508180643_CODEGEN_Z1ZZ part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508180643_CODEGEN_Z1ZZ" (
	"KEY" BIGINT NOT NULL, 
...
FROM "TMP_20180508180643_CODEGEN_DZ4W" AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT") AS "U"

-- Code For temporary table TMP_20180508180643_CODEGEN_Z1ZZ part 3. Create Index 

CREATE INDEX "ix_TMP_20180508180643_C_c7f9" ON "TMP_20180508180643_CODEGEN_Z1ZZ" ("KEY")

-- Code For temporary table TMP_20180508180643_CODEGEN_HFM8 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508180643_CODEGEN_HFM8" (
	"KEY" BIGINT, 
...
-- Code For temporary table TMP_20180508180643_CODEGEN_HFM8 part 2. Populate

INSERT INTO "TMP_20180508180643_CODEGEN_HFM8" ("KEY", "Proba_1", "Proba_0") SELECT "U"."KEY", "U"."Proba_1", "U"."Proba_0" 
...
FROM "TMP_20180508180643_CODEGEN_Z1ZZ" AS "ADS_sca_2_OUT"), 
"DT_node_data" AS 
...
(SELECT "Calibrated_Model_0"."KEY" AS "KEY", 1.0 / (1.0 + exp(CASE WHEN (minvalue(maxvalue(-100.0, -(5.756413424714996 * "Calibrated_Model_0"."ScoreOrProba_1" + -2.5569469411985817)), 100.0) >= -709.782712893384) THEN minvalue(maxvalue(-100.0, -(5.756413424714996 * "Calibrated_Model_0"."ScoreOrProba_1" + -2.5569469411985817)), 100.0) ELSE -709.782712893384 END)) AS "Proba_1", 1.0 - 1.0 / (1.0 + exp(CASE WHEN (minvalue(maxvalue(-100.0, -(5.756413424714996 * "Calibrated_Model_0"."ScoreOrProba_1" + -2.5569469411985817)), 100.0) >= -709.782712893384) THEN minvalue(maxvalue(-100.0, -(5.756413424714996 * "Calibrated_Model_0"."ScoreOrProba_1" + -2.5569469411985817)), 100.0) ELSE -709.782712893384 END)) AS "Proba_0" 
...
(SELECT "Calibrated_Model_1"."KEY" AS "KEY", 1.0 / (1.0 + exp(CASE WHEN (minvalue(maxvalue(-100.0, -(4.6995923736239025 * "Calibrated_Model_1"."ScoreOrProba_1" + -1.924211076199023)), 100.0) >= -709.782712893384) THEN minvalue(maxvalue(-100.0, -(4.6995923736239025 * "Calibrated_Model_1"."ScoreOrProba_1" + -1.924211076199023)), 100.0) ELSE -709.782712893384 END)) AS "Proba_1", 1.0 - 1.0 / (1.0 + exp(CASE WHEN (minvalue(maxvalue(-100.0, -(4.6995923736239025 * "Calibrated_Model_1"."ScoreOrProba_1" + -1.924211076199023)), 100.0) >= -709.782712893384) THEN minvalue(maxvalue(-100.0, -(4.6995923736239025 * "Calibrated_Model_1"."ScoreOrProba_1" + -1.924211076199023)), 100.0) ELSE -709.782712893384 END)) AS "Proba_0" 
...
(SELECT "Calibrated_Model_2"."KEY" AS "KEY", 1.0 / (1.0 + exp(CASE WHEN (minvalue(maxvalue(-100.0, -(5.460676238424658 * "Calibrated_Model_2"."ScoreOrProba_1" + -2.260905500780578)), 100.0) >= -709.782712893384) THEN minvalue(maxvalue(-100.0, -(5.460676238424658 * "Calibrated_Model_2"."ScoreOrProba_1" + -2.260905500780578)), 100.0) ELSE -709.782712893384 END)) AS "Proba_1", 1.0 - 1.0 / (1.0 + exp(CASE WHEN (minvalue(maxvalue(-100.0, -(5.460676238424658 * "Calibrated_Model_2"."ScoreOrProba_1" + -2.260905500780578)), 100.0) >= -709.782712893384) THEN minvalue(maxvalue(-100.0, -(5.460676238424658 * "Calibrated_Model_2"."ScoreOrProba_1" + -2.260905500780578)), 100.0) ELSE -709.782712893384 END)) AS "Proba_0" 
...
"DT_node_data_3" AS 
(SELECT "Values".nid AS nid, CAST("Values"."P_0" AS DOUBLE PRECISION) AS "P_0", CAST("Values"."P_1" AS DOUBLE PRECISION) AS "P_1", CAST("Values"."D" AS DOUBLE PRECISION) AS "D", CAST("Values"."DP" AS DOUBLE PRECISION) AS "DP" 
FROM (SELECT 4 AS nid, 1.0 AS "P_0", 0.0 AS "P_1", 0 AS "D", 1.0 AS "DP" FROM rdb$database UNION ALL SELECT 5 AS nid, 0.0 AS "P_0", 1.0 AS "P_1", 1 AS "D", 1.0 AS "DP" FROM rdb$database UNION ALL SELECT 7 AS nid, 0.0 AS "P_0", 1.0 AS "P_1", 1 AS "D", 1.0 AS "DP" FROM rdb$database UNION ALL SELECT 9 AS nid, 0.047619047619047616 AS "P_0", 0.9523809523809523 AS "P_1", 1 AS "D", 0.9523809523809523 AS "DP" FROM rdb$database UNION ALL SELECT 10 AS nid, 1.0 AS "P_0", 0.0 AS "P_1", 0 AS "D", 1.0 AS "DP" FROM rdb$database UNION ALL SELECT 11 AS nid, 1.0 AS "P_0", 0.0 AS "P_1", 0 AS "D", 1.0 AS "DP" FROM rdb$database UNION ALL SELECT 14 AS nid, 0.0 AS "P_0", 1.0 AS "P_1", 1 AS "D", 1.0 AS "DP" FROM rdb$database UNION ALL SELECT 15 AS nid, 1.0 AS "P_0", 0.0 AS "P_1", 0 AS "D", 1.0 AS "DP" FROM rdb$database UNION ALL SELECT 16 AS nid, 0.0 AS "P_0", 1.0 AS "P_1", 1 AS "D", 1.0 AS "DP" FROM rdb$database) AS "Values"), 
"DT_Output_3" AS 
...
(SELECT "Calibrated_Model_3"."KEY" AS "KEY", 1.0 / (1.0 + exp(CASE WHEN (minvalue(maxvalue(-100.0, -(4.949259195511301 * "Calibrated_Model_3"."ScoreOrProba_1" + -2.0321952231560854)), 100.0) >= -709.782712893384) THEN minvalue(maxvalue(-100.0, -(4.949259195511301 * "Calibrated_Model_3"."ScoreOrProba_1" + -2.0321952231560854)), 100.0) ELSE -709.782712893384 END)) AS "Proba_1", 1.0 - 1.0 / (1.0 + exp(CASE WHEN (minvalue(maxvalue(-100.0, -(4.949259195511301 * "Calibrated_Model_3"."ScoreOrProba_1" + -2.0321952231560854)), 100.0) >= -709.782712893384) THEN minvalue(maxvalue(-100.0, -(4.949259195511301 * "Calibrated_Model_3"."ScoreOrProba_1" + -2.0321952231560854)), 100.0) ELSE -709.782712893384 END)) AS "Proba_0" 
...
-- Code For temporary table TMP_20180508180643_CODEGEN_YQEK part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508180643_CODEGEN_YQEK" (
	"KEY" BIGINT, 
	"Proba_1" DOUBLE PRECISION, 
	"Proba_0" DOUBLE PRECISION
)
...
-- Code For temporary table TMP_20180508180643_CODEGEN_YQEK part 2. Populate

INSERT INTO "TMP_20180508180643_CODEGEN_YQEK" ("KEY", "Proba_1", "Proba_0") SELECT "U"."KEY", "U"."Proba_1", "U"."Proba_0" 
...
FROM "TMP_20180508180643_CODEGEN_HFM8" AS "CalProb_B0") AS "CalProb_EnsembleUnion") AS "CalProb_Union") AS "U"

-- Code For temporary table TMP_20180508180643_CODEGEN_CS1A part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508180643_CODEGEN_CS1A" (
	"KEY" BIGINT NOT NULL, 
	"Proba_1" DOUBLE PRECISION, 
	"Proba_0" DOUBLE PRECISION, 
	PRIMARY KEY ("KEY")
...
-- Code For temporary table TMP_20180508180643_CODEGEN_CS1A part 2. Populate

INSERT INTO "TMP_20180508180643_CODEGEN_CS1A" ("KEY", "Proba_1", "Proba_0") SELECT "U"."KEY", "U"."Proba_1", "U"."Proba_0" 
...
FROM "TMP_20180508180643_CODEGEN_YQEK" AS "CalProb_Union" GROUP BY "CalProb_Union"."KEY") AS "T") AS "CalProb_avg") AS "U"

-- Code For temporary table TMP_20180508180643_CODEGEN_CS1A part 3. Create Index 

CREATE INDEX "ix_TMP_20180508180643_C_ff4d" ON "TMP_20180508180643_CODEGEN_CS1A" ("KEY")
...
FROM "TMP_20180508180643_CODEGEN_CS1A" AS "CalProb_avg"), 
