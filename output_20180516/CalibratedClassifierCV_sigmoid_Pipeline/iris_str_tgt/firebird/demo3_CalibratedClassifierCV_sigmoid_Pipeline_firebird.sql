...
-- Code For temporary table TMP_20180508190438_CODEGEN_LT8Y part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508190438_CODEGEN_LT8Y" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20180508190438_CODEGEN_LT8Y part 2. Populate

INSERT INTO "TMP_20180508190438_CODEGEN_LT8Y" ("KEY", imputer_output_2, imputer_output_3, imputer_output_4, imputer_output_5) SELECT "U"."KEY", "U".imputer_output_2, "U".imputer_output_3, "U".imputer_output_4, "U".imputer_output_5 
...
-- Code For temporary table TMP_20180508190438_CODEGEN_LT8Y part 3. Create Index 

CREATE INDEX "ix_TMP_20180508190438_C_9618" ON "TMP_20180508190438_CODEGEN_LT8Y" ("KEY")

-- Code For temporary table TMP_20180508190438_CODEGEN_CFU7 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508190438_CODEGEN_CFU7" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20180508190438_CODEGEN_CFU7 part 2. Populate

INSERT INTO "TMP_20180508190438_CODEGEN_CFU7" ("KEY", scaler_output_2, scaler_output_3, scaler_output_4, scaler_output_5) SELECT "U"."KEY", "U".scaler_output_2, "U".scaler_output_3, "U".scaler_output_4, "U".scaler_output_5 
...
FROM "TMP_20180508190438_CODEGEN_LT8Y" AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT") AS "U"

-- Code For temporary table TMP_20180508190438_CODEGEN_CFU7 part 3. Create Index 

CREATE INDEX "ix_TMP_20180508190438_C_737b" ON "TMP_20180508190438_CODEGEN_CFU7" ("KEY")

-- Code For temporary table TMP_20180508190438_CODEGEN_V7OP part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508190438_CODEGEN_V7OP" (
	"KEY" BIGINT, 
...
-- Code For temporary table TMP_20180508190438_CODEGEN_V7OP part 2. Populate

INSERT INTO "TMP_20180508190438_CODEGEN_V7OP" ("KEY", "Proba_CLASS_0", "Proba_CLASS_1", "Proba_CLASS_2") SELECT "U"."KEY", "U"."Proba_CLASS_0", "U"."Proba_CLASS_1", "U"."Proba_CLASS_2" 
...
FROM "TMP_20180508190438_CODEGEN_CFU7" AS "ADS_sca_2_OUT"), 
"DT_node_data" AS 
...
-- Code For temporary table TMP_20180508190438_CODEGEN_LY1I part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508190438_CODEGEN_LY1I" (
	"KEY" BIGINT, 
	"Proba_CLASS_0" DOUBLE PRECISION, 
	"Proba_CLASS_1" DOUBLE PRECISION, 
	"Proba_CLASS_2" DOUBLE PRECISION
...
-- Code For temporary table TMP_20180508190438_CODEGEN_LY1I part 2. Populate

INSERT INTO "TMP_20180508190438_CODEGEN_LY1I" ("KEY", "Proba_CLASS_0", "Proba_CLASS_1", "Proba_CLASS_2") SELECT "U"."KEY", "U"."Proba_CLASS_0", "U"."Proba_CLASS_1", "U"."Proba_CLASS_2" 
...
FROM "TMP_20180508190438_CODEGEN_V7OP" AS "CalProb_B0") AS "CalProb_EnsembleUnion") AS "CalProb_Union") AS "U"

-- Code For temporary table TMP_20180508190438_CODEGEN_62V2 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508190438_CODEGEN_62V2" (
	"KEY" BIGINT NOT NULL, 
	"Proba_CLASS_0" DOUBLE PRECISION, 
	"Proba_CLASS_1" DOUBLE PRECISION, 
	"Proba_CLASS_2" DOUBLE PRECISION, 
...
-- Code For temporary table TMP_20180508190438_CODEGEN_62V2 part 2. Populate

INSERT INTO "TMP_20180508190438_CODEGEN_62V2" ("KEY", "Proba_CLASS_0", "Proba_CLASS_1", "Proba_CLASS_2") SELECT "U"."KEY", "U"."Proba_CLASS_0", "U"."Proba_CLASS_1", "U"."Proba_CLASS_2" 
...
FROM "TMP_20180508190438_CODEGEN_LY1I" AS "CalProb_Union" GROUP BY "CalProb_Union"."KEY") AS "T") AS "CalProb_avg") AS "U"

-- Code For temporary table TMP_20180508190438_CODEGEN_62V2 part 3. Create Index 

CREATE INDEX "ix_TMP_20180508190438_C_ea54" ON "TMP_20180508190438_CODEGEN_62V2" ("KEY")
...
FROM "TMP_20180508190438_CODEGEN_62V2" AS "CalProb_avg"), 
