...
-- Code For temporary table tmp_20180602160142_z0e_ads_imp_1_out part 1. Create 


CREATE TABLE tmp_20180602160142_z0e_ads_imp_1_out (
	`KEY` BIGINT, 
...
-- Code For temporary table tmp_20180602160142_z0e_ads_imp_1_out part 2. Populate

INSERT INTO tmp_20180602160142_z0e_ads_imp_1_out (`KEY`, imputer_output_2, imputer_output_3, imputer_output_4, imputer_output_5) SELECT `ADS_imp_1_OUT`.`KEY`, `ADS_imp_1_OUT`.imputer_output_2, `ADS_imp_1_OUT`.imputer_output_3, `ADS_imp_1_OUT`.imputer_output_4, `ADS_imp_1_OUT`.imputer_output_5 
...
-- Code For temporary table tmp_20180602160142_hzk_ads_sca_2_out part 1. Create 


CREATE TABLE tmp_20180602160142_hzk_ads_sca_2_out (
	`KEY` BIGINT, 
...
-- Code For temporary table tmp_20180602160142_hzk_ads_sca_2_out part 2. Populate

INSERT INTO tmp_20180602160142_hzk_ads_sca_2_out (`KEY`, scaler_output_2, scaler_output_3, scaler_output_4, scaler_output_5) SELECT `ADS_sca_2_OUT`.`KEY`, `ADS_sca_2_OUT`.scaler_output_2, `ADS_sca_2_OUT`.scaler_output_3, `ADS_sca_2_OUT`.scaler_output_4, `ADS_sca_2_OUT`.scaler_output_5 
...
FROM tmp_20180602160142_z0e_ads_imp_1_out AS `ADS_imp_1_OUT`) AS `ADS_sca_2_OUT`

-- Code For temporary table tmp_20180602160143_r0t_calprob_b0 part 1. Create 


CREATE TABLE tmp_20180602160143_r0t_calprob_b0 (
	`KEY` BIGINT, 
...
-- Code For temporary table tmp_20180602160143_r0t_calprob_b0 part 2. Populate
...
FROM tmp_20180602160142_hzk_ads_sca_2_out AS `ADS_sca_2_OUT`), 
`DT_node_data` AS 
...
FROM sigmoid_calibration_3)
 INSERT INTO tmp_20180602160143_r0t_calprob_b0 (`KEY`, `Proba_CLASS_0`, `Proba_CLASS_1`, `Proba_CLASS_2`) SELECT `CalProb_B0`.`KEY`, `CalProb_B0`.`Proba_CLASS_0`, `CalProb_B0`.`Proba_CLASS_1`, `CalProb_B0`.`Proba_CLASS_2` 
...
-- Code For temporary table tmp_20180602160143_hpq_calprob_avg part 1. Create 


CREATE TABLE tmp_20180602160143_hpq_calprob_avg (
	`KEY` BIGINT, 
	`Proba_CLASS_0` DOUBLE, 
	`Proba_CLASS_1` DOUBLE, 
	`Proba_CLASS_2` DOUBLE
...
-- Code For temporary table tmp_20180602160143_hpq_calprob_avg part 2. Populate
...
FROM tmp_20180602160143_r0t_calprob_b0 AS `CalProb_B0`) AS `CalProb_EnsembleUnion`)
 INSERT INTO tmp_20180602160143_hpq_calprob_avg (`KEY`, `Proba_CLASS_0`, `Proba_CLASS_1`, `Proba_CLASS_2`) SELECT `CalProb_avg`.`KEY`, `CalProb_avg`.`Proba_CLASS_0`, `CalProb_avg`.`Proba_CLASS_1`, `CalProb_avg`.`Proba_CLASS_2` 
...
FROM tmp_20180602160143_hpq_calprob_avg AS `CalProb_avg`), 
