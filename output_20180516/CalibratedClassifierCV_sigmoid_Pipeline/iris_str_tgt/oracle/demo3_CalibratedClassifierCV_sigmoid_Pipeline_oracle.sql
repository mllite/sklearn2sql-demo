...
-- Code For temporary table DEGEN_XYTI6O_ADS_IMP_1_OUT part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "DEGEN_XYTI6O_ADS_IMP_1_OUT" (
	"KEY" NUMBER(19), 
...
-- Code For temporary table DEGEN_XYTI6O_ADS_IMP_1_OUT part 2. Populate

INSERT INTO "DEGEN_XYTI6O_ADS_IMP_1_OUT" ("KEY", imputer_output_2, imputer_output_3, imputer_output_4, imputer_output_5) SELECT "U"."KEY", "U".imputer_output_2, "U".imputer_output_3, "U".imputer_output_4, "U".imputer_output_5 
...
-- Code For temporary table DEGEN_PO9UXH_ADS_SCA_2_OUT part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "DEGEN_PO9UXH_ADS_SCA_2_OUT" (
	"KEY" NUMBER(19), 
...
-- Code For temporary table DEGEN_PO9UXH_ADS_SCA_2_OUT part 2. Populate

INSERT INTO "DEGEN_PO9UXH_ADS_SCA_2_OUT" ("KEY", scaler_output_2, scaler_output_3, scaler_output_4, scaler_output_5) SELECT "U"."KEY", "U".scaler_output_2, "U".scaler_output_3, "U".scaler_output_4, "U".scaler_output_5 
...
FROM "DEGEN_XYTI6O_ADS_IMP_1_OUT" "ADS_imp_1_OUT") "ADS_sca_2_OUT") "U"

-- Code For temporary table _CODEGEN_91WB43_CALPROB_B0 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "_CODEGEN_91WB43_CALPROB_B0" (
	"KEY" NUMBER(19), 
...
-- Code For temporary table _CODEGEN_91WB43_CALPROB_B0 part 2. Populate

INSERT INTO "_CODEGEN_91WB43_CALPROB_B0" ("KEY", "Proba_CLASS_0", "Proba_CLASS_1", "Proba_CLASS_2") SELECT "U"."KEY", "U"."Proba_CLASS_0", "U"."Proba_CLASS_1", "U"."Proba_CLASS_2" 
...
FROM "DEGEN_PO9UXH_ADS_SCA_2_OUT" "ADS_sca_2_OUT"), 
"DT_node_data" AS 
...
FROM (SELECT 1 AS nid, 1.0 AS "P_CLASS_0", 0.0 AS "P_CLASS_1", 0.0 AS "P_CLASS_2", 'CLASS_0' AS "D", 1.0 AS "DP" FROM DUAL UNION ALL SELECT 3 AS nid, 0.0 AS "P_CLASS_0", 1.0 AS "P_CLASS_1", 0.0 AS "P_CLASS_2", 'CLASS_1' AS "D", 1.0 AS "DP" FROM DUAL UNION ALL SELECT 7 AS nid, 0.0 AS "P_CLASS_0", 0.6666666666666666 AS "P_CLASS_1", 0.3333333333333333 AS "P_CLASS_2", 'CLASS_1' AS "D", 0.6666666666666666 AS "DP" FROM DUAL UNION ALL SELECT 8 AS nid, 0.0 AS "P_CLASS_0", 0.0 AS "P_CLASS_1", 1.0 AS "P_CLASS_2", 'CLASS_2' AS "D", 1.0 AS "DP" FROM DUAL UNION ALL SELECT 9 AS nid, 0.0 AS "P_CLASS_0", 1.0 AS "P_CLASS_1", 0.0 AS "P_CLASS_2", 'CLASS_1' AS "D", 1.0 AS "DP" FROM DUAL UNION ALL SELECT 10 AS nid, 0.0 AS "P_CLASS_0", 0.0 AS "P_CLASS_1", 1.0 AS "P_CLASS_2", 'CLASS_2' AS "D", 1.0 AS "DP" FROM DUAL) "Values"), 
"DT_Output" AS 
...
(SELECT "DT_Output"."KEY" AS "KEY", CAST(NULL AS BINARY_DOUBLE) AS "Score_CLASS_0", CAST(NULL AS BINARY_DOUBLE) AS "Score_CLASS_1", CAST(NULL AS BINARY_DOUBLE) AS "Score_CLASS_2", "DT_Output"."P_CLASS_0" AS "Proba_CLASS_0", "DT_Output"."P_CLASS_1" AS "Proba_CLASS_1", "DT_Output"."P_CLASS_2" AS "Proba_CLASS_2", CASE WHEN ("DT_Output"."P_CLASS_0" IS NULL OR "DT_Output"."P_CLASS_0" > 0.0) THEN ln("DT_Output"."P_CLASS_0") ELSE -BINARY_DOUBLE_INFINITY END AS "LogProba_CLASS_0", CASE WHEN ("DT_Output"."P_CLASS_1" IS NULL OR "DT_Output"."P_CLASS_1" > 0.0) THEN ln("DT_Output"."P_CLASS_1") ELSE -BINARY_DOUBLE_INFINITY END AS "LogProba_CLASS_1", CASE WHEN ("DT_Output"."P_CLASS_2" IS NULL OR "DT_Output"."P_CLASS_2" > 0.0) THEN ln("DT_Output"."P_CLASS_2") ELSE -BINARY_DOUBLE_INFINITY END AS "LogProba_CLASS_2", CAST(NULL AS NUMBER(19)) AS "Decision", CAST(NULL AS BINARY_DOUBLE) AS "DecisionProba", coalesce(CAST(NULL AS BINARY_DOUBLE), "DT_Output"."P_CLASS_0") AS "ScoreOrProba_CLASS_0", coalesce(CAST(NULL AS BINARY_DOUBLE), "DT_Output"."P_CLASS_1") AS "ScoreOrProba_CLASS_1", coalesce(CAST(NULL AS BINARY_DOUBLE), "DT_Output"."P_CLASS_2") AS "ScoreOrProba_CLASS_2" 
FROM "DT_Output"), 
...
"DT_node_data_1" AS 
(SELECT "Values".nid AS nid, CAST("Values"."P_CLASS_0" AS BINARY_DOUBLE) AS "P_CLASS_0", CAST("Values"."P_CLASS_1" AS BINARY_DOUBLE) AS "P_CLASS_1", CAST("Values"."P_CLASS_2" AS BINARY_DOUBLE) AS "P_CLASS_2", CAST("Values"."D" AS BINARY_DOUBLE) AS "D", CAST("Values"."DP" AS BINARY_DOUBLE) AS "DP" 
FROM (SELECT 1 AS nid, 1.0 AS "P_CLASS_0", 0.0 AS "P_CLASS_1", 0.0 AS "P_CLASS_2", 'CLASS_0' AS "D", 1.0 AS "DP" FROM DUAL UNION ALL SELECT 4 AS nid, 0.0 AS "P_CLASS_0", 1.0 AS "P_CLASS_1", 0.0 AS "P_CLASS_2", 'CLASS_1' AS "D", 1.0 AS "DP" FROM DUAL UNION ALL SELECT 6 AS nid, 0.0 AS "P_CLASS_0", 0.0 AS "P_CLASS_1", 1.0 AS "P_CLASS_2", 'CLASS_2' AS "D", 1.0 AS "DP" FROM DUAL UNION ALL SELECT 7 AS nid, 0.0 AS "P_CLASS_0", 1.0 AS "P_CLASS_1", 0.0 AS "P_CLASS_2", 'CLASS_1' AS "D", 1.0 AS "DP" FROM DUAL UNION ALL SELECT 10 AS nid, 0.0 AS "P_CLASS_0", 0.0 AS "P_CLASS_1", 1.0 AS "P_CLASS_2", 'CLASS_2' AS "D", 1.0 AS "DP" FROM DUAL UNION ALL SELECT 11 AS nid, 0.0 AS "P_CLASS_0", 1.0 AS "P_CLASS_1", 0.0 AS "P_CLASS_2", 'CLASS_1' AS "D", 1.0 AS "DP" FROM DUAL UNION ALL SELECT 12 AS nid, 0.0 AS "P_CLASS_0", 0.0 AS "P_CLASS_1", 1.0 AS "P_CLASS_2", 'CLASS_2' AS "D", 1.0 AS "DP" FROM DUAL) "Values"), 
"DT_Output_1" AS 
...
(SELECT "DT_Output_1"."KEY" AS "KEY", CAST(NULL AS BINARY_DOUBLE) AS "Score_CLASS_0", CAST(NULL AS BINARY_DOUBLE) AS "Score_CLASS_1", CAST(NULL AS BINARY_DOUBLE) AS "Score_CLASS_2", "DT_Output_1"."P_CLASS_0" AS "Proba_CLASS_0", "DT_Output_1"."P_CLASS_1" AS "Proba_CLASS_1", "DT_Output_1"."P_CLASS_2" AS "Proba_CLASS_2", CASE WHEN ("DT_Output_1"."P_CLASS_0" IS NULL OR "DT_Output_1"."P_CLASS_0" > 0.0) THEN ln("DT_Output_1"."P_CLASS_0") ELSE -BINARY_DOUBLE_INFINITY END AS "LogProba_CLASS_0", CASE WHEN ("DT_Output_1"."P_CLASS_1" IS NULL OR "DT_Output_1"."P_CLASS_1" > 0.0) THEN ln("DT_Output_1"."P_CLASS_1") ELSE -BINARY_DOUBLE_INFINITY END AS "LogProba_CLASS_1", CASE WHEN ("DT_Output_1"."P_CLASS_2" IS NULL OR "DT_Output_1"."P_CLASS_2" > 0.0) THEN ln("DT_Output_1"."P_CLASS_2") ELSE -BINARY_DOUBLE_INFINITY END AS "LogProba_CLASS_2", CAST(NULL AS NUMBER(19)) AS "Decision", CAST(NULL AS BINARY_DOUBLE) AS "DecisionProba", coalesce(CAST(NULL AS BINARY_DOUBLE), "DT_Output_1"."P_CLASS_0") AS "ScoreOrProba_CLASS_0", coalesce(CAST(NULL AS BINARY_DOUBLE), "DT_Output_1"."P_CLASS_1") AS "ScoreOrProba_CLASS_1", coalesce(CAST(NULL AS BINARY_DOUBLE), "DT_Output_1"."P_CLASS_2") AS "ScoreOrProba_CLASS_2" 
FROM "DT_Output_1"), 
...
"DT_node_data_2" AS 
(SELECT "Values".nid AS nid, CAST("Values"."P_CLASS_0" AS BINARY_DOUBLE) AS "P_CLASS_0", CAST("Values"."P_CLASS_1" AS BINARY_DOUBLE) AS "P_CLASS_1", CAST("Values"."P_CLASS_2" AS BINARY_DOUBLE) AS "P_CLASS_2", CAST("Values"."D" AS BINARY_DOUBLE) AS "D", CAST("Values"."DP" AS BINARY_DOUBLE) AS "DP" 
FROM (SELECT 1 AS nid, 1.0 AS "P_CLASS_0", 0.0 AS "P_CLASS_1", 0.0 AS "P_CLASS_2", 'CLASS_0' AS "D", 1.0 AS "DP" FROM DUAL UNION ALL SELECT 5 AS nid, 0.0 AS "P_CLASS_0", 0.0 AS "P_CLASS_1", 1.0 AS "P_CLASS_2", 'CLASS_2' AS "D", 1.0 AS "DP" FROM DUAL UNION ALL SELECT 6 AS nid, 0.0 AS "P_CLASS_0", 1.0 AS "P_CLASS_1", 0.0 AS "P_CLASS_2", 'CLASS_1' AS "D", 1.0 AS "DP" FROM DUAL UNION ALL SELECT 8 AS nid, 0.0 AS "P_CLASS_0", 0.0 AS "P_CLASS_1", 1.0 AS "P_CLASS_2", 'CLASS_2' AS "D", 1.0 AS "DP" FROM DUAL UNION ALL SELECT 9 AS nid, 0.0 AS "P_CLASS_0", 1.0 AS "P_CLASS_1", 0.0 AS "P_CLASS_2", 'CLASS_1' AS "D", 1.0 AS "DP" FROM DUAL UNION ALL SELECT 10 AS nid, 0.0 AS "P_CLASS_0", 0.0 AS "P_CLASS_1", 1.0 AS "P_CLASS_2", 'CLASS_2' AS "D", 1.0 AS "DP" FROM DUAL) "Values"), 
"DT_Output_2" AS 
...
(SELECT "DT_Output_2"."KEY" AS "KEY", CAST(NULL AS BINARY_DOUBLE) AS "Score_CLASS_0", CAST(NULL AS BINARY_DOUBLE) AS "Score_CLASS_1", CAST(NULL AS BINARY_DOUBLE) AS "Score_CLASS_2", "DT_Output_2"."P_CLASS_0" AS "Proba_CLASS_0", "DT_Output_2"."P_CLASS_1" AS "Proba_CLASS_1", "DT_Output_2"."P_CLASS_2" AS "Proba_CLASS_2", CASE WHEN ("DT_Output_2"."P_CLASS_0" IS NULL OR "DT_Output_2"."P_CLASS_0" > 0.0) THEN ln("DT_Output_2"."P_CLASS_0") ELSE -BINARY_DOUBLE_INFINITY END AS "LogProba_CLASS_0", CASE WHEN ("DT_Output_2"."P_CLASS_1" IS NULL OR "DT_Output_2"."P_CLASS_1" > 0.0) THEN ln("DT_Output_2"."P_CLASS_1") ELSE -BINARY_DOUBLE_INFINITY END AS "LogProba_CLASS_1", CASE WHEN ("DT_Output_2"."P_CLASS_2" IS NULL OR "DT_Output_2"."P_CLASS_2" > 0.0) THEN ln("DT_Output_2"."P_CLASS_2") ELSE -BINARY_DOUBLE_INFINITY END AS "LogProba_CLASS_2", CAST(NULL AS NUMBER(19)) AS "Decision", CAST(NULL AS BINARY_DOUBLE) AS "DecisionProba", coalesce(CAST(NULL AS BINARY_DOUBLE), "DT_Output_2"."P_CLASS_0") AS "ScoreOrProba_CLASS_0", coalesce(CAST(NULL AS BINARY_DOUBLE), "DT_Output_2"."P_CLASS_1") AS "ScoreOrProba_CLASS_1", coalesce(CAST(NULL AS BINARY_DOUBLE), "DT_Output_2"."P_CLASS_2") AS "ScoreOrProba_CLASS_2" 
FROM "DT_Output_2"), 
...
"DT_node_data_3" AS 
(SELECT "Values".nid AS nid, CAST("Values"."P_CLASS_0" AS BINARY_DOUBLE) AS "P_CLASS_0", CAST("Values"."P_CLASS_1" AS BINARY_DOUBLE) AS "P_CLASS_1", CAST("Values"."P_CLASS_2" AS BINARY_DOUBLE) AS "P_CLASS_2", CAST("Values"."D" AS BINARY_DOUBLE) AS "D", CAST("Values"."DP" AS BINARY_DOUBLE) AS "DP" 
FROM (SELECT 1 AS nid, 1.0 AS "P_CLASS_0", 0.0 AS "P_CLASS_1", 0.0 AS "P_CLASS_2", 'CLASS_0' AS "D", 1.0 AS "DP" FROM DUAL UNION ALL SELECT 4 AS nid, 0.0 AS "P_CLASS_0", 1.0 AS "P_CLASS_1", 0.0 AS "P_CLASS_2", 'CLASS_1' AS "D", 1.0 AS "DP" FROM DUAL UNION ALL SELECT 6 AS nid, 0.0 AS "P_CLASS_0", 0.0 AS "P_CLASS_1", 1.0 AS "P_CLASS_2", 'CLASS_2' AS "D", 1.0 AS "DP" FROM DUAL UNION ALL SELECT 7 AS nid, 0.0 AS "P_CLASS_0", 1.0 AS "P_CLASS_1", 0.0 AS "P_CLASS_2", 'CLASS_1' AS "D", 1.0 AS "DP" FROM DUAL UNION ALL SELECT 10 AS nid, 0.0 AS "P_CLASS_0", 1.0 AS "P_CLASS_1", 0.0 AS "P_CLASS_2", 'CLASS_1' AS "D", 1.0 AS "DP" FROM DUAL UNION ALL SELECT 11 AS nid, 0.0 AS "P_CLASS_0", 0.0 AS "P_CLASS_1", 1.0 AS "P_CLASS_2", 'CLASS_2' AS "D", 1.0 AS "DP" FROM DUAL UNION ALL SELECT 12 AS nid, 0.0 AS "P_CLASS_0", 0.0 AS "P_CLASS_1", 1.0 AS "P_CLASS_2", 'CLASS_2' AS "D", 1.0 AS "DP" FROM DUAL) "Values"), 
"DT_Output_3" AS 
...
(SELECT "DT_Output_3"."KEY" AS "KEY", CAST(NULL AS BINARY_DOUBLE) AS "Score_CLASS_0", CAST(NULL AS BINARY_DOUBLE) AS "Score_CLASS_1", CAST(NULL AS BINARY_DOUBLE) AS "Score_CLASS_2", "DT_Output_3"."P_CLASS_0" AS "Proba_CLASS_0", "DT_Output_3"."P_CLASS_1" AS "Proba_CLASS_1", "DT_Output_3"."P_CLASS_2" AS "Proba_CLASS_2", CASE WHEN ("DT_Output_3"."P_CLASS_0" IS NULL OR "DT_Output_3"."P_CLASS_0" > 0.0) THEN ln("DT_Output_3"."P_CLASS_0") ELSE -BINARY_DOUBLE_INFINITY END AS "LogProba_CLASS_0", CASE WHEN ("DT_Output_3"."P_CLASS_1" IS NULL OR "DT_Output_3"."P_CLASS_1" > 0.0) THEN ln("DT_Output_3"."P_CLASS_1") ELSE -BINARY_DOUBLE_INFINITY END AS "LogProba_CLASS_1", CASE WHEN ("DT_Output_3"."P_CLASS_2" IS NULL OR "DT_Output_3"."P_CLASS_2" > 0.0) THEN ln("DT_Output_3"."P_CLASS_2") ELSE -BINARY_DOUBLE_INFINITY END AS "LogProba_CLASS_2", CAST(NULL AS NUMBER(19)) AS "Decision", CAST(NULL AS BINARY_DOUBLE) AS "DecisionProba", coalesce(CAST(NULL AS BINARY_DOUBLE), "DT_Output_3"."P_CLASS_0") AS "ScoreOrProba_CLASS_0", coalesce(CAST(NULL AS BINARY_DOUBLE), "DT_Output_3"."P_CLASS_1") AS "ScoreOrProba_CLASS_1", coalesce(CAST(NULL AS BINARY_DOUBLE), "DT_Output_3"."P_CLASS_2") AS "ScoreOrProba_CLASS_2" 
FROM "DT_Output_3"), 
...
-- Code For temporary table DEGEN_GB0O7H_CALPROB_UNION part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "DEGEN_GB0O7H_CALPROB_UNION" (
	"KEY" NUMBER(19), 
	"Proba_CLASS_0" BINARY_DOUBLE, 
	"Proba_CLASS_1" BINARY_DOUBLE, 
	"Proba_CLASS_2" BINARY_DOUBLE
...
-- Code For temporary table DEGEN_GB0O7H_CALPROB_UNION part 2. Populate

INSERT INTO "DEGEN_GB0O7H_CALPROB_UNION" ("KEY", "Proba_CLASS_0", "Proba_CLASS_1", "Proba_CLASS_2") SELECT "U"."KEY", "U"."Proba_CLASS_0", "U"."Proba_CLASS_1", "U"."Proba_CLASS_2" 
...
FROM "_CODEGEN_91WB43_CALPROB_B0" "CalProb_B0") "CalProb_EnsembleUnion") "CalProb_Union") "U"

-- Code For temporary table CODEGEN_G1SH6R_CALPROB_AVG part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "CODEGEN_G1SH6R_CALPROB_AVG" (
	"KEY" NUMBER(19), 
	"Proba_CLASS_0" BINARY_DOUBLE, 
	"Proba_CLASS_1" BINARY_DOUBLE, 
	"Proba_CLASS_2" BINARY_DOUBLE
...
-- Code For temporary table CODEGEN_G1SH6R_CALPROB_AVG part 2. Populate

INSERT INTO "CODEGEN_G1SH6R_CALPROB_AVG" ("KEY", "Proba_CLASS_0", "Proba_CLASS_1", "Proba_CLASS_2") SELECT "U"."KEY", "U"."Proba_CLASS_0", "U"."Proba_CLASS_1", "U"."Proba_CLASS_2" 
...
FROM "DEGEN_GB0O7H_CALPROB_UNION" "CalProb_Union" GROUP BY "CalProb_Union"."KEY") "T") "CalProb_avg") "U"
...
FROM "CODEGEN_G1SH6R_CALPROB_AVG" "CalProb_avg"), 
