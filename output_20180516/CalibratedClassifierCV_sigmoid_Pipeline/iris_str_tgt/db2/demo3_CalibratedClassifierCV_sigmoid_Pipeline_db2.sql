...
-- Code For temporary table tmp_20180602160146_k6p_ads_imp_1_out part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180602160146_k6p_ads_imp_1_out (
	"KEY" BIGINT, 
...
-- Code For temporary table tmp_20180602160146_k6p_ads_imp_1_out part 2. Populate

INSERT INTO tmp_20180602160146_k6p_ads_imp_1_out SELECT "ADS_imp_1_OUT"."KEY", "ADS_imp_1_OUT".imputer_output_2, "ADS_imp_1_OUT".imputer_output_3, "ADS_imp_1_OUT".imputer_output_4, "ADS_imp_1_OUT".imputer_output_5 
...
-- Code For temporary table tmp_20180602160146_v7s_ads_sca_2_out part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180602160146_v7s_ads_sca_2_out (
	"KEY" BIGINT, 
...
-- Code For temporary table tmp_20180602160146_v7s_ads_sca_2_out part 2. Populate

INSERT INTO tmp_20180602160146_v7s_ads_sca_2_out SELECT "ADS_sca_2_OUT"."KEY", "ADS_sca_2_OUT".scaler_output_2, "ADS_sca_2_OUT".scaler_output_3, "ADS_sca_2_OUT".scaler_output_4, "ADS_sca_2_OUT".scaler_output_5 
...
FROM tmp_20180602160146_k6p_ads_imp_1_out AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT"

-- Code For temporary table tmp_20180602160146_sny_calprob_b0 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180602160146_sny_calprob_b0 (
	"KEY" BIGINT, 
...
-- Code For temporary table tmp_20180602160146_sny_calprob_b0 part 2. Populate

INSERT INTO tmp_20180602160146_sny_calprob_b0 WITH "DT_node_lookup" AS 
...
FROM tmp_20180602160146_v7s_ads_sca_2_out AS "ADS_sca_2_OUT"), 
"DT_node_data" AS 
...
-- Code For temporary table tmp_20180602160146_1py_calprob_avg part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180602160146_1py_calprob_avg (
	"KEY" BIGINT, 
	"Proba_CLASS_0" DOUBLE, 
	"Proba_CLASS_1" DOUBLE, 
	"Proba_CLASS_2" DOUBLE
...
-- Code For temporary table tmp_20180602160146_1py_calprob_avg part 2. Populate

INSERT INTO tmp_20180602160146_1py_calprob_avg WITH "CalProb_Union" AS 
...
FROM tmp_20180602160146_sny_calprob_b0 AS "CalProb_B0") AS "CalProb_EnsembleUnion")
...
FROM tmp_20180602160146_1py_calprob_avg AS "CalProb_avg"), 
