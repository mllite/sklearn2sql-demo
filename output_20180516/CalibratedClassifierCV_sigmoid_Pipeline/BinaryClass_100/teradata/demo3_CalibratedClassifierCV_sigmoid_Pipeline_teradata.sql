...
-- Code For temporary table tmp_20180508180152_codegen_x7qxlo_ads_imp_1_out part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180508180152_codegen_x7qxlo_ads_imp_1_out  (
	"KEY" BIGINT, 
...
-- Code For temporary table tmp_20180508180152_codegen_zppgtj_ads_sca_2_out part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180508180152_codegen_zppgtj_ads_sca_2_out  (
	"KEY" BIGINT, 
...
FROM tmp_20180508180152_codegen_x7qxlo_ads_imp_1_out AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT") AS "U"

-- Code For temporary table tmp_20180508180153_codegen_z3ukb5_calprob_b0 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180508180153_codegen_z3ukb5_calprob_b0  (
	"KEY" BIGINT, 
...
-- Code For temporary table tmp_20180508180153_codegen_z3ukb5_calprob_b0 part 2. Populate

INSERT INTO tmp_20180508180153_codegen_z3ukb5_calprob_b0 ("KEY", "Proba_1", "Proba_0") SELECT "U"."KEY", "U"."Proba_1", "U"."Proba_0" 
FROM (WITH "DT_node_lookup" AS 
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", CASE WHEN ("ADS_sca_2_OUT".scaler_59 <= CAST(0.06653057038784 AS DOUBLE PRECISION)) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_20 <= CAST(-0.82361227273941 AS DOUBLE PRECISION)) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_79 <= CAST(0.75669264793396 AS DOUBLE PRECISION)) THEN 3 ELSE 4 END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_90 <= CAST(1.82358181476593 AS DOUBLE PRECISION)) THEN 6 ELSE 7 END END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_20 <= CAST(1.20068621635437 AS DOUBLE PRECISION)) THEN 9 ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_34 <= CAST(-0.013359494507313 AS DOUBLE PRECISION)) THEN 11 ELSE 12 END END END AS node_id_2 
FROM tmp_20180508180152_codegen_zppgtj_ads_sca_2_out AS "ADS_sca_2_OUT"), 
dummy_cte AS 
...
"DT_node_lookup_3" AS 
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", CASE WHEN ("ADS_sca_2_OUT".scaler_59 <= CAST(-0.120288252830505 AS DOUBLE PRECISION)) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_62 <= CAST(-0.568029999732971 AS DOUBLE PRECISION)) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_54 <= CAST(0.222714886069298 AS DOUBLE PRECISION)) THEN 3 ELSE 4 END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_50 <= CAST(-1.313613891601562 AS DOUBLE PRECISION)) THEN CASE WHEN ("ADS_sca_2_OUT".scaler_79 <= CAST(0.849839329719544 AS DOUBLE PRECISION)) THEN 7 ELSE 8 END ELSE 9 END END ELSE CASE WHEN ("ADS_sca_2_OUT".scaler_72 <= CAST(-1.824147701263428 AS DOUBLE PRECISION)) THEN 11 ELSE 12 END END AS node_id_2 
FROM tmp_20180508180152_codegen_zppgtj_ads_sca_2_out AS "ADS_sca_2_OUT"), 
dummy_cte_3 AS 
(SELECT CAST(0.0 AS DOUBLE PRECISION) AS "X"), 
"DT_node_data_3" AS 
...
-- Code For temporary table tmp_20180508180153_codegen_mn3qji_calprob_union part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180508180153_codegen_mn3qji_calprob_union  (
	"KEY" BIGINT, 
	"Proba_1" DOUBLE PRECISION, 
	"Proba_0" DOUBLE PRECISION
)
...
-- Code For temporary table tmp_20180508180153_codegen_mn3qji_calprob_union part 2. Populate

INSERT INTO tmp_20180508180153_codegen_mn3qji_calprob_union ("KEY", "Proba_1", "Proba_0") SELECT "U"."KEY", "U"."Proba_1", "U"."Proba_0" 
...
FROM tmp_20180508180153_codegen_z3ukb5_calprob_b0 AS "CalProb_B0") AS "CalProb_EnsembleUnion") AS "CalProb_Union") AS "U"

-- Code For temporary table tmp_20180508180153_codegen_h1h313_calprob_avg part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180508180153_codegen_h1h313_calprob_avg  (
	"KEY" BIGINT, 
	"Proba_1" DOUBLE PRECISION, 
	"Proba_0" DOUBLE PRECISION
)
...
-- Code For temporary table tmp_20180508180153_codegen_h1h313_calprob_avg part 2. Populate

INSERT INTO tmp_20180508180153_codegen_h1h313_calprob_avg ("KEY", "Proba_1", "Proba_0") SELECT "U"."KEY", "U"."Proba_1", "U"."Proba_0" 
...
FROM tmp_20180508180153_codegen_mn3qji_calprob_union AS "CalProb_Union" GROUP BY "CalProb_Union"."KEY") AS "T") AS "CalProb_avg") AS "U"
...
FROM tmp_20180508180153_codegen_h1h313_calprob_avg AS "CalProb_avg"), 
