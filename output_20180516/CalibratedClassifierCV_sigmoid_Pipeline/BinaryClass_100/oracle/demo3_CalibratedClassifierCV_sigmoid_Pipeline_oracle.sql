...
-- Code For temporary table DEGEN_3GWU9L_ADS_IMP_1_OUT part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "DEGEN_3GWU9L_ADS_IMP_1_OUT" (
	"KEY" NUMBER(19), 
...
-- Code For temporary table DEGEN_Z72084_ADS_SCA_2_OUT part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "DEGEN_Z72084_ADS_SCA_2_OUT" (
	"KEY" NUMBER(19), 
...
FROM "DEGEN_3GWU9L_ADS_IMP_1_OUT" "ADS_imp_1_OUT") "ADS_sca_2_OUT") "U"

-- Code For temporary table _CODEGEN_Y2A8TJ_CALPROB_B0 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "_CODEGEN_Y2A8TJ_CALPROB_B0" (
	"KEY" NUMBER(19), 
...
-- Code For temporary table _CODEGEN_Y2A8TJ_CALPROB_B0 part 2. Populate

INSERT INTO "_CODEGEN_Y2A8TJ_CALPROB_B0" ("KEY", "Proba_1", "Proba_0") SELECT "U"."KEY", "U"."Proba_1", "U"."Proba_0" 
...
FROM "DEGEN_Z72084_ADS_SCA_2_OUT" "ADS_sca_2_OUT"), 
"DT_node_data" AS 
...
-- Code For temporary table CODEGEN_QCK6JH_CALPROB_AVG part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "CODEGEN_QCK6JH_CALPROB_AVG" (
	"KEY" NUMBER(19), 
	"Proba_1" BINARY_DOUBLE, 
	"Proba_0" BINARY_DOUBLE
)
...
-- Code For temporary table CODEGEN_QCK6JH_CALPROB_AVG part 2. Populate

INSERT INTO "CODEGEN_QCK6JH_CALPROB_AVG" ("KEY", "Proba_1", "Proba_0") SELECT "U"."KEY", "U"."Proba_1", "U"."Proba_0" 
...
FROM "_CODEGEN_Y2A8TJ_CALPROB_B0" "CalProb_B0") "CalProb_EnsembleUnion")
...
FROM "CODEGEN_QCK6JH_CALPROB_AVG" "CalProb_avg"), 
