...
-- Code For temporary table TMP_20180508180153_CODEGEN_3SAL part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508180153_CODEGEN_3SAL" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20180508180153_CODEGEN_3SAL part 3. Create Index 

CREATE INDEX "ix_TMP_20180508180153_C_75ed" ON "TMP_20180508180153_CODEGEN_3SAL" ("KEY")

-- Code For temporary table TMP_20180508180153_CODEGEN_W42R part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508180153_CODEGEN_W42R" (
	"KEY" BIGINT NOT NULL, 
...
FROM "TMP_20180508180153_CODEGEN_3SAL" AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT") AS "U"

-- Code For temporary table TMP_20180508180153_CODEGEN_W42R part 3. Create Index 

CREATE INDEX "ix_TMP_20180508180153_C_38cd" ON "TMP_20180508180153_CODEGEN_W42R" ("KEY")

-- Code For temporary table TMP_20180508180153_CODEGEN_2OJ7 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508180153_CODEGEN_2OJ7" (
	"KEY" BIGINT, 
...
-- Code For temporary table TMP_20180508180153_CODEGEN_2OJ7 part 2. Populate

INSERT INTO "TMP_20180508180153_CODEGEN_2OJ7" ("KEY", "Proba_1", "Proba_0") SELECT "U"."KEY", "U"."Proba_1", "U"."Proba_0" 
...
FROM "TMP_20180508180153_CODEGEN_W42R" AS "ADS_sca_2_OUT"), 
"DT_node_data" AS 
...
-- Code For temporary table TMP_20180508180153_CODEGEN_W9W9 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508180153_CODEGEN_W9W9" (
	"KEY" BIGINT, 
	"Proba_1" DOUBLE PRECISION, 
	"Proba_0" DOUBLE PRECISION
)
...
-- Code For temporary table TMP_20180508180153_CODEGEN_W9W9 part 2. Populate

INSERT INTO "TMP_20180508180153_CODEGEN_W9W9" ("KEY", "Proba_1", "Proba_0") SELECT "U"."KEY", "U"."Proba_1", "U"."Proba_0" 
...
FROM "TMP_20180508180153_CODEGEN_2OJ7" AS "CalProb_B0") AS "CalProb_EnsembleUnion") AS "CalProb_Union") AS "U"

-- Code For temporary table TMP_20180508180153_CODEGEN_SZ0G part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508180153_CODEGEN_SZ0G" (
	"KEY" BIGINT NOT NULL, 
	"Proba_1" DOUBLE PRECISION, 
	"Proba_0" DOUBLE PRECISION, 
	PRIMARY KEY ("KEY")
...
-- Code For temporary table TMP_20180508180153_CODEGEN_SZ0G part 2. Populate

INSERT INTO "TMP_20180508180153_CODEGEN_SZ0G" ("KEY", "Proba_1", "Proba_0") SELECT "U"."KEY", "U"."Proba_1", "U"."Proba_0" 
...
FROM "TMP_20180508180153_CODEGEN_W9W9" AS "CalProb_Union" GROUP BY "CalProb_Union"."KEY") AS "T") AS "CalProb_avg") AS "U"

-- Code For temporary table TMP_20180508180153_CODEGEN_SZ0G part 3. Create Index 

CREATE INDEX "ix_TMP_20180508180153_C_2d91" ON "TMP_20180508180153_CODEGEN_SZ0G" ("KEY")
...
FROM "TMP_20180508180153_CODEGEN_SZ0G" AS "CalProb_avg"), 
