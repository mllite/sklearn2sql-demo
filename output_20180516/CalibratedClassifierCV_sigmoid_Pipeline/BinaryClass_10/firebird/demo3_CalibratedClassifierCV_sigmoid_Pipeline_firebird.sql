...
-- Code For temporary table TMP_20180508175712_CODEGEN_RX0Q part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508175712_CODEGEN_RX0Q" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20180508175712_CODEGEN_RX0Q part 2. Populate

INSERT INTO "TMP_20180508175712_CODEGEN_RX0Q" ("KEY", impter_2, impter_3, impter_4, impter_5, impter_6, impter_7, impter_8, impter_9, impter_10, impter_11) SELECT "U"."KEY", "U".impter_2, "U".impter_3, "U".impter_4, "U".impter_5, "U".impter_6, "U".impter_7, "U".impter_8, "U".impter_9, "U".impter_10, "U".impter_11 
...
-- Code For temporary table TMP_20180508175712_CODEGEN_RX0Q part 3. Create Index 

CREATE INDEX "ix_TMP_20180508175712_C_9ebb" ON "TMP_20180508175712_CODEGEN_RX0Q" ("KEY")

-- Code For temporary table TMP_20180508175712_CODEGEN_CNK6 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508175712_CODEGEN_CNK6" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20180508175712_CODEGEN_CNK6 part 2. Populate

INSERT INTO "TMP_20180508175712_CODEGEN_CNK6" ("KEY", scaler_2, scaler_3, scaler_4, scaler_5, scaler_6, scaler_7, scaler_8, scaler_9, scaler_10, scaler_11) SELECT "U"."KEY", "U".scaler_2, "U".scaler_3, "U".scaler_4, "U".scaler_5, "U".scaler_6, "U".scaler_7, "U".scaler_8, "U".scaler_9, "U".scaler_10, "U".scaler_11 
...
FROM "TMP_20180508175712_CODEGEN_RX0Q" AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT") AS "U"

-- Code For temporary table TMP_20180508175712_CODEGEN_CNK6 part 3. Create Index 

CREATE INDEX "ix_TMP_20180508175712_C_7fb1" ON "TMP_20180508175712_CODEGEN_CNK6" ("KEY")

-- Code For temporary table TMP_20180508175712_CODEGEN_F5VP part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508175712_CODEGEN_F5VP" (
	"KEY" BIGINT, 
...
-- Code For temporary table TMP_20180508175712_CODEGEN_F5VP part 2. Populate

INSERT INTO "TMP_20180508175712_CODEGEN_F5VP" ("KEY", "Proba_1", "Proba_0") SELECT "U"."KEY", "U"."Proba_1", "U"."Proba_0" 
...
FROM "TMP_20180508175712_CODEGEN_CNK6" AS "ADS_sca_2_OUT"), 
"DT_node_data" AS 
...
"DT_node_data_2" AS 
(SELECT "Values".nid AS nid, CAST("Values"."P_0" AS DOUBLE PRECISION) AS "P_0", CAST("Values"."P_1" AS DOUBLE PRECISION) AS "P_1", CAST("Values"."D" AS DOUBLE PRECISION) AS "D", CAST("Values"."DP" AS DOUBLE PRECISION) AS "DP" 
FROM (SELECT 5 AS nid, 1.0 AS "P_0", 0.0 AS "P_1", 0 AS "D", 1.0 AS "DP" FROM rdb$database UNION ALL SELECT 6 AS nid, 0.8 AS "P_0", 0.2 AS "P_1", 0 AS "D", 0.8 AS "DP" FROM rdb$database UNION ALL SELECT 7 AS nid, 0.0 AS "P_0", 1.0 AS "P_1", 1 AS "D", 1.0 AS "DP" FROM rdb$database UNION ALL SELECT 8 AS nid, 0.0 AS "P_0", 1.0 AS "P_1", 1 AS "D", 1.0 AS "DP" FROM rdb$database UNION ALL SELECT 9 AS nid, 0.0 AS "P_0", 1.0 AS "P_1", 1 AS "D", 1.0 AS "DP" FROM rdb$database UNION ALL SELECT 11 AS nid, 0.0 AS "P_0", 1.0 AS "P_1", 1 AS "D", 1.0 AS "DP" FROM rdb$database UNION ALL SELECT 12 AS nid, 1.0 AS "P_0", 0.0 AS "P_1", 0 AS "D", 1.0 AS "DP" FROM rdb$database) AS "Values"), 
"DT_Output_2" AS 
...
-- Code For temporary table TMP_20180508175712_CODEGEN_F0UX part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508175712_CODEGEN_F0UX" (
	"KEY" BIGINT, 
	"Proba_1" DOUBLE PRECISION, 
	"Proba_0" DOUBLE PRECISION
)
...
-- Code For temporary table TMP_20180508175712_CODEGEN_F0UX part 2. Populate

INSERT INTO "TMP_20180508175712_CODEGEN_F0UX" ("KEY", "Proba_1", "Proba_0") SELECT "U"."KEY", "U"."Proba_1", "U"."Proba_0" 
...
FROM "TMP_20180508175712_CODEGEN_F5VP" AS "CalProb_B0") AS "CalProb_EnsembleUnion") AS "CalProb_Union") AS "U"

-- Code For temporary table TMP_20180508175712_CODEGEN_JFCA part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508175712_CODEGEN_JFCA" (
	"KEY" BIGINT NOT NULL, 
	"Proba_1" DOUBLE PRECISION, 
	"Proba_0" DOUBLE PRECISION, 
	PRIMARY KEY ("KEY")
...
-- Code For temporary table TMP_20180508175712_CODEGEN_JFCA part 2. Populate

INSERT INTO "TMP_20180508175712_CODEGEN_JFCA" ("KEY", "Proba_1", "Proba_0") SELECT "U"."KEY", "U"."Proba_1", "U"."Proba_0" 
...
FROM "TMP_20180508175712_CODEGEN_F0UX" AS "CalProb_Union" GROUP BY "CalProb_Union"."KEY") AS "T") AS "CalProb_avg") AS "U"

-- Code For temporary table TMP_20180508175712_CODEGEN_JFCA part 3. Create Index 

CREATE INDEX "ix_TMP_20180508175712_C_c67b" ON "TMP_20180508175712_CODEGEN_JFCA" ("KEY")
...
FROM "TMP_20180508175712_CODEGEN_JFCA" AS "CalProb_avg"), 
