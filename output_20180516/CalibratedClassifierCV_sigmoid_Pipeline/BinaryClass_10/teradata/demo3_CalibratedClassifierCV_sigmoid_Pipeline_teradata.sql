...
-- Code For temporary table tmp_20180516110151_codegen_692fug_ads_imp_1_out part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180516110151_codegen_692fug_ads_imp_1_out  (
	"KEY" BIGINT, 
...
-- Code For temporary table tmp_20180516110151_codegen_692fug_ads_imp_1_out part 2. Populate

INSERT INTO tmp_20180516110151_codegen_692fug_ads_imp_1_out ("KEY", impter_2, impter_3, impter_4, impter_5, impter_6, impter_7, impter_8, impter_9, impter_10, impter_11) SELECT "U"."KEY", "U".impter_2, "U".impter_3, "U".impter_4, "U".impter_5, "U".impter_6, "U".impter_7, "U".impter_8, "U".impter_9, "U".impter_10, "U".impter_11 
...
-- Code For temporary table tmp_20180516110151_codegen_mersfd_ads_sca_2_out part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180516110151_codegen_mersfd_ads_sca_2_out  (
	"KEY" BIGINT, 
...
-- Code For temporary table tmp_20180516110151_codegen_mersfd_ads_sca_2_out part 2. Populate

INSERT INTO tmp_20180516110151_codegen_mersfd_ads_sca_2_out ("KEY", scaler_2, scaler_3, scaler_4, scaler_5, scaler_6, scaler_7, scaler_8, scaler_9, scaler_10, scaler_11) SELECT "U"."KEY", "U".scaler_2, "U".scaler_3, "U".scaler_4, "U".scaler_5, "U".scaler_6, "U".scaler_7, "U".scaler_8, "U".scaler_9, "U".scaler_10, "U".scaler_11 
...
FROM tmp_20180516110151_codegen_692fug_ads_imp_1_out AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT") AS "U"

-- Code For temporary table tmp_20180516110151_codegen_ls8hcn_calprob_b0 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180516110151_codegen_ls8hcn_calprob_b0  (
	"KEY" BIGINT, 
...
-- Code For temporary table tmp_20180516110151_codegen_ls8hcn_calprob_b0 part 2. Populate

INSERT INTO tmp_20180516110151_codegen_ls8hcn_calprob_b0 ("KEY", "Proba_1", "Proba_0") SELECT "U"."KEY", "U"."Proba_1", "U"."Proba_0" 
...
FROM tmp_20180516110151_codegen_mersfd_ads_sca_2_out AS "ADS_sca_2_OUT"), 
dummy_cte AS 
...
-- Code For temporary table tmp_20180516110151_codegen_0qdi4n_calprob_avg part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180516110151_codegen_0qdi4n_calprob_avg  (
	"KEY" BIGINT, 
	"Proba_1" DOUBLE PRECISION, 
	"Proba_0" DOUBLE PRECISION
)
...
-- Code For temporary table tmp_20180516110151_codegen_0qdi4n_calprob_avg part 2. Populate

INSERT INTO tmp_20180516110151_codegen_0qdi4n_calprob_avg ("KEY", "Proba_1", "Proba_0") SELECT "U"."KEY", "U"."Proba_1", "U"."Proba_0" 
...
FROM tmp_20180516110151_codegen_ls8hcn_calprob_b0 AS "CalProb_B0") AS "CalProb_EnsembleUnion")
...
FROM tmp_20180516110151_codegen_0qdi4n_calprob_avg AS "CalProb_avg"), 
