...
-- Code For temporary table tmp_20180516110150_codegen_1rbthc_ads_imp_1_out part 1. Create 


CREATE TABLE tmp_20180516110150_codegen_1rbthc_ads_imp_1_out (
	`KEY` BIGINT, 
	impter_2 DOUBLE, 
	impter_3 DOUBLE, 
	impter_4 DOUBLE, 
...
-- Code For temporary table tmp_20180516110150_codegen_bqgl6t_ads_sca_2_out part 1. Create 


CREATE TABLE tmp_20180516110150_codegen_bqgl6t_ads_sca_2_out (
	`KEY` BIGINT, 
	scaler_2 DOUBLE, 
	scaler_3 DOUBLE, 
	scaler_4 DOUBLE, 
...
-- Code For temporary table tmp_20180516110150_codegen_bqgl6t_ads_sca_2_out part 2. Populate

INSERT INTO tmp_20180516110150_codegen_bqgl6t_ads_sca_2_out (`KEY`, scaler_2, scaler_3, scaler_4, scaler_5, scaler_6, scaler_7, scaler_8, scaler_9, scaler_10, scaler_11) SELECT `ADS_sca_2_OUT`.`KEY`, `ADS_sca_2_OUT`.scaler_2, `ADS_sca_2_OUT`.scaler_3, `ADS_sca_2_OUT`.scaler_4, `ADS_sca_2_OUT`.scaler_5, `ADS_sca_2_OUT`.scaler_6, `ADS_sca_2_OUT`.scaler_7, `ADS_sca_2_OUT`.scaler_8, `ADS_sca_2_OUT`.scaler_9, `ADS_sca_2_OUT`.scaler_10, `ADS_sca_2_OUT`.scaler_11 
...
FROM tmp_20180516110150_codegen_1rbthc_ads_imp_1_out AS `ADS_imp_1_OUT`) AS `ADS_sca_2_OUT`

-- Code For temporary table tmp_20180516110151_codegen_ze7wr4_calprob_b0 part 1. Create 


CREATE TABLE tmp_20180516110151_codegen_ze7wr4_calprob_b0 (
	`KEY` BIGINT, 
	`Proba_1` DOUBLE, 
	`Proba_0` DOUBLE
)
...
-- Code For temporary table tmp_20180516110151_codegen_ze7wr4_calprob_b0 part 2. Populate
...
FROM tmp_20180516110150_codegen_bqgl6t_ads_sca_2_out AS `ADS_sca_2_OUT`), 
`DT_node_data` AS 
...
FROM sigmoid_calibration_3)
 INSERT INTO tmp_20180516110151_codegen_ze7wr4_calprob_b0 (`KEY`, `Proba_1`, `Proba_0`) SELECT `CalProb_B0`.`KEY`, `CalProb_B0`.`Proba_1`, `CalProb_B0`.`Proba_0` 
...
-- Code For temporary table tmp_20180516110151_codegen_zynaix_calprob_avg part 1. Create 


CREATE TABLE tmp_20180516110151_codegen_zynaix_calprob_avg (
	`KEY` BIGINT, 
	`Proba_1` DOUBLE, 
	`Proba_0` DOUBLE
)
...
-- Code For temporary table tmp_20180516110151_codegen_zynaix_calprob_avg part 2. Populate
...
FROM tmp_20180516110151_codegen_ze7wr4_calprob_b0 AS `CalProb_B0`) AS `CalProb_EnsembleUnion`)
 INSERT INTO tmp_20180516110151_codegen_zynaix_calprob_avg (`KEY`, `Proba_1`, `Proba_0`) SELECT `CalProb_avg`.`KEY`, `CalProb_avg`.`Proba_1`, `CalProb_avg`.`Proba_0` 
...
FROM tmp_20180516110151_codegen_zynaix_calprob_avg AS `CalProb_avg`), 
