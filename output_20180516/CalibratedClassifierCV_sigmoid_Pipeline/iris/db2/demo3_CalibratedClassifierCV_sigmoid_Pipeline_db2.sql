...
-- Code For temporary table tmp_20180516122249_codegen_6mjhuq_ads_imp_1_out part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180516122249_codegen_6mjhuq_ads_imp_1_out (
	"KEY" BIGINT, 
...
-- Code For temporary table tmp_20180516122249_codegen_6mjhuq_ads_imp_1_out part 2. Populate

INSERT INTO tmp_20180516122249_codegen_6mjhuq_ads_imp_1_out SELECT "ADS_imp_1_OUT"."KEY", "ADS_imp_1_OUT".imputer_output_2, "ADS_imp_1_OUT".imputer_output_3, "ADS_imp_1_OUT".imputer_output_4, "ADS_imp_1_OUT".imputer_output_5 
FROM (SELECT "ADS"."KEY" AS "KEY", CASE WHEN ("ADS"."Feature_0" IS NULL) THEN 5.8474999999999975 ELSE "ADS"."Feature_0" END AS imputer_output_2, CASE WHEN ("ADS"."Feature_1" IS NULL) THEN 3.0366666666666657 ELSE "ADS"."Feature_1" END AS imputer_output_3, CASE WHEN ("ADS"."Feature_2" IS NULL) THEN 3.8450000000000006 ELSE "ADS"."Feature_2" END AS imputer_output_4, CASE WHEN ("ADS"."Feature_3" IS NULL) THEN 1.245 ELSE "ADS"."Feature_3" END AS imputer_output_5 
FROM "IRIS" AS "ADS") AS "ADS_imp_1_OUT"

-- Code For temporary table tmp_20180516122249_codegen_t9h9hp_ads_sca_2_out part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180516122249_codegen_t9h9hp_ads_sca_2_out (
	"KEY" BIGINT, 
...
-- Code For temporary table tmp_20180516122249_codegen_t9h9hp_ads_sca_2_out part 2. Populate

INSERT INTO tmp_20180516122249_codegen_t9h9hp_ads_sca_2_out SELECT "ADS_sca_2_OUT"."KEY", "ADS_sca_2_OUT".scaler_output_2, "ADS_sca_2_OUT".scaler_output_3, "ADS_sca_2_OUT".scaler_output_4, "ADS_sca_2_OUT".scaler_output_5 
...
FROM tmp_20180516122249_codegen_6mjhuq_ads_imp_1_out AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT"

-- Code For temporary table tmp_20180516122249_codegen_6sfngt_calprob_b0 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180516122249_codegen_6sfngt_calprob_b0 (
	"KEY" BIGINT, 
	"Proba_0" DOUBLE, 
	"Proba_1" DOUBLE, 
	"Proba_2" DOUBLE
...
-- Code For temporary table tmp_20180516122249_codegen_6sfngt_calprob_b0 part 2. Populate

INSERT INTO tmp_20180516122249_codegen_6sfngt_calprob_b0 WITH "DT_node_lookup" AS 
...
FROM tmp_20180516122249_codegen_t9h9hp_ads_sca_2_out AS "ADS_sca_2_OUT"), 
"DT_node_data" AS 
...
-- Code For temporary table tmp_20180516122249_codegen_a0ps6h_calprob_avg part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180516122249_codegen_a0ps6h_calprob_avg (
	"KEY" BIGINT, 
	"Proba_0" DOUBLE, 
	"Proba_1" DOUBLE, 
	"Proba_2" DOUBLE
...
-- Code For temporary table tmp_20180516122249_codegen_a0ps6h_calprob_avg part 2. Populate

INSERT INTO tmp_20180516122249_codegen_a0ps6h_calprob_avg WITH "CalProb_Union" AS 
...
FROM tmp_20180516122249_codegen_6sfngt_calprob_b0 AS "CalProb_B0") AS "CalProb_EnsembleUnion")
...
FROM tmp_20180516122249_codegen_a0ps6h_calprob_avg AS "CalProb_avg"), 
