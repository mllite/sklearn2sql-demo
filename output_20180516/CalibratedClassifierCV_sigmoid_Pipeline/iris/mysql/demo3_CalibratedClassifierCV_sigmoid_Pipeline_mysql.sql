...
-- Code For temporary table TMP_20180602152627_I2P_ADS_imp_1_OUT part 1. Create 


CREATE TEMPORARY TABLE `TMP_20180602152627_I2P_ADS_imp_1_OUT` (
	`KEY` BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20180602152627_I2P_ADS_imp_1_OUT part 2. Populate

INSERT INTO `TMP_20180602152627_I2P_ADS_imp_1_OUT` (`KEY`, imputer_output_2, imputer_output_3, imputer_output_4, imputer_output_5) SELECT `U`.`KEY`, `U`.imputer_output_2, `U`.imputer_output_3, `U`.imputer_output_4, `U`.imputer_output_5 
...
-- Code For temporary table TMP_20180602152627_I2P_ADS_imp_1_OUT part 3. Create Index 

CREATE INDEX `ix_TMP_20180602152627_I2P_ADS_imp_1_OUT_KEY` ON `TMP_20180602152627_I2P_ADS_imp_1_OUT` (`KEY`)

-- Code For temporary table TMP_20180602152627_W19_ADS_sca_2_OUT part 1. Create 


CREATE TEMPORARY TABLE `TMP_20180602152627_W19_ADS_sca_2_OUT` (
	`KEY` BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20180602152627_W19_ADS_sca_2_OUT part 2. Populate

INSERT INTO `TMP_20180602152627_W19_ADS_sca_2_OUT` (`KEY`, scaler_output_2, scaler_output_3, scaler_output_4, scaler_output_5) SELECT `U`.`KEY`, `U`.scaler_output_2, `U`.scaler_output_3, `U`.scaler_output_4, `U`.scaler_output_5 
...
FROM `TMP_20180602152627_I2P_ADS_imp_1_OUT` AS `ADS_imp_1_OUT`) AS `ADS_sca_2_OUT`) AS `U`

-- Code For temporary table TMP_20180602152627_W19_ADS_sca_2_OUT part 3. Create Index 

CREATE INDEX `ix_TMP_20180602152627_W19_ADS_sca_2_OUT_KEY` ON `TMP_20180602152627_W19_ADS_sca_2_OUT` (`KEY`)

-- Code For temporary table TMP_20180602152627_L02_CalProb_B0 part 1. Create 


CREATE TEMPORARY TABLE `TMP_20180602152627_L02_CalProb_B0` (
	`KEY` BIGINT, 
	`Proba_0` DOUBLE, 
	`Proba_1` DOUBLE, 
	`Proba_2` DOUBLE
...
-- Code For temporary table TMP_20180602152627_L02_CalProb_B0 part 2. Populate

INSERT INTO `TMP_20180602152627_L02_CalProb_B0` (`KEY`, `Proba_0`, `Proba_1`, `Proba_2`) SELECT `U`.`KEY`, `U`.`Proba_0`, `U`.`Proba_1`, `U`.`Proba_2` 
...
FROM `TMP_20180602152627_W19_ADS_sca_2_OUT` AS `ADS_sca_2_OUT`), 
`DT_node_data` AS 
...
-- Code For temporary table TMP_20180602152627_42W_CalProb_avg part 1. Create 


CREATE TEMPORARY TABLE `TMP_20180602152627_42W_CalProb_avg` (
	`KEY` BIGINT NOT NULL, 
	`Proba_0` DOUBLE, 
	`Proba_1` DOUBLE, 
	`Proba_2` DOUBLE, 
...
-- Code For temporary table TMP_20180602152627_42W_CalProb_avg part 2. Populate

INSERT INTO `TMP_20180602152627_42W_CalProb_avg` (`KEY`, `Proba_0`, `Proba_1`, `Proba_2`) SELECT `U`.`KEY`, `U`.`Proba_0`, `U`.`Proba_1`, `U`.`Proba_2` 
...
FROM `TMP_20180602152627_L02_CalProb_B0` AS `CalProb_B0`) AS `CalProb_EnsembleUnion`)
...
-- Code For temporary table TMP_20180602152627_42W_CalProb_avg part 3. Create Index 

CREATE INDEX `ix_TMP_20180602152627_42W_CalProb_avg_KEY` ON `TMP_20180602152627_42W_CalProb_avg` (`KEY`)
...
FROM `TMP_20180602152627_42W_CalProb_avg` AS `CalProb_avg`), 
