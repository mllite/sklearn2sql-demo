...
-- Code For temporary table TMP_20180508185503_CODEGEN_YYDG part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508185503_CODEGEN_YYDG" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20180508185503_CODEGEN_YYDG part 2. Populate

INSERT INTO "TMP_20180508185503_CODEGEN_YYDG" ("KEY", imputer_output_2, imputer_output_3, imputer_output_4, imputer_output_5) SELECT "U"."KEY", "U".imputer_output_2, "U".imputer_output_3, "U".imputer_output_4, "U".imputer_output_5 
...
-- Code For temporary table TMP_20180508185503_CODEGEN_YYDG part 3. Create Index 

CREATE INDEX "ix_TMP_20180508185503_C_47ee" ON "TMP_20180508185503_CODEGEN_YYDG" ("KEY")

-- Code For temporary table TMP_20180508185503_CODEGEN_W3GX part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508185503_CODEGEN_W3GX" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20180508185503_CODEGEN_W3GX part 2. Populate

INSERT INTO "TMP_20180508185503_CODEGEN_W3GX" ("KEY", scaler_output_2, scaler_output_3, scaler_output_4, scaler_output_5) SELECT "U"."KEY", "U".scaler_output_2, "U".scaler_output_3, "U".scaler_output_4, "U".scaler_output_5 
...
FROM "TMP_20180508185503_CODEGEN_YYDG" AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT") AS "U"

-- Code For temporary table TMP_20180508185503_CODEGEN_W3GX part 3. Create Index 

CREATE INDEX "ix_TMP_20180508185503_C_cd38" ON "TMP_20180508185503_CODEGEN_W3GX" ("KEY")

-- Code For temporary table TMP_20180508185504_CODEGEN_A4UO part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508185504_CODEGEN_A4UO" (
	"KEY" BIGINT, 
...
-- Code For temporary table TMP_20180508185504_CODEGEN_A4UO part 2. Populate

INSERT INTO "TMP_20180508185504_CODEGEN_A4UO" ("KEY", "Proba_0", "Proba_1", "Proba_2") SELECT "U"."KEY", "U"."Proba_0", "U"."Proba_1", "U"."Proba_2" 
...
FROM "TMP_20180508185503_CODEGEN_W3GX" AS "ADS_sca_2_OUT"), 
"DT_node_data" AS 
...
-- Code For temporary table TMP_20180508185504_CODEGEN_0QWS part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508185504_CODEGEN_0QWS" (
	"KEY" BIGINT, 
	"Proba_0" DOUBLE PRECISION, 
	"Proba_1" DOUBLE PRECISION, 
	"Proba_2" DOUBLE PRECISION
...
-- Code For temporary table TMP_20180508185504_CODEGEN_0QWS part 2. Populate

INSERT INTO "TMP_20180508185504_CODEGEN_0QWS" ("KEY", "Proba_0", "Proba_1", "Proba_2") SELECT "U"."KEY", "U"."Proba_0", "U"."Proba_1", "U"."Proba_2" 
...
FROM "TMP_20180508185504_CODEGEN_A4UO" AS "CalProb_B0") AS "CalProb_EnsembleUnion") AS "CalProb_Union") AS "U"

-- Code For temporary table TMP_20180508185504_CODEGEN_F3EG part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508185504_CODEGEN_F3EG" (
	"KEY" BIGINT NOT NULL, 
	"Proba_0" DOUBLE PRECISION, 
	"Proba_1" DOUBLE PRECISION, 
	"Proba_2" DOUBLE PRECISION, 
...
-- Code For temporary table TMP_20180508185504_CODEGEN_F3EG part 2. Populate

INSERT INTO "TMP_20180508185504_CODEGEN_F3EG" ("KEY", "Proba_0", "Proba_1", "Proba_2") SELECT "U"."KEY", "U"."Proba_0", "U"."Proba_1", "U"."Proba_2" 
...
FROM "TMP_20180508185504_CODEGEN_0QWS" AS "CalProb_Union" GROUP BY "CalProb_Union"."KEY") AS "T") AS "CalProb_avg") AS "U"

-- Code For temporary table TMP_20180508185504_CODEGEN_F3EG part 3. Create Index 

CREATE INDEX "ix_TMP_20180508185504_C_fd41" ON "TMP_20180508185504_CODEGEN_F3EG" ("KEY")
...
FROM "TMP_20180508185504_CODEGEN_F3EG" AS "CalProb_avg"), 
