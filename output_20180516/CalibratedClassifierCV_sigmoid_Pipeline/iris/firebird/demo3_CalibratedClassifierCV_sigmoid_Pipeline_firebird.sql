...
-- Code For temporary table TMP_20180516_CODEGEN_B1A1P9_ADS part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180516_CODEGEN_B1A1P9_ADS" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20180516_CODEGEN_B1A1P9_ADS part 2. Populate

INSERT INTO "TMP_20180516_CODEGEN_B1A1P9_ADS" ("KEY", imputer_output_2, imputer_output_3, imputer_output_4, imputer_output_5) SELECT "U"."KEY", "U".imputer_output_2, "U".imputer_output_3, "U".imputer_output_4, "U".imputer_output_5 
...
-- Code For temporary table TMP_20180516_CODEGEN_B1A1P9_ADS part 3. Create Index 

CREATE INDEX "ix_TMP_20180516_CODEGEN_aa7d" ON "TMP_20180516_CODEGEN_B1A1P9_ADS" ("KEY")

-- Code For temporary table TMP_20180516_CODEGEN_JAZG31_ADS part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180516_CODEGEN_JAZG31_ADS" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20180516_CODEGEN_JAZG31_ADS part 2. Populate

INSERT INTO "TMP_20180516_CODEGEN_JAZG31_ADS" ("KEY", scaler_output_2, scaler_output_3, scaler_output_4, scaler_output_5) SELECT "U"."KEY", "U".scaler_output_2, "U".scaler_output_3, "U".scaler_output_4, "U".scaler_output_5 
...
FROM "TMP_20180516_CODEGEN_B1A1P9_ADS" AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT") AS "U"

-- Code For temporary table TMP_20180516_CODEGEN_JAZG31_ADS part 3. Create Index 

CREATE INDEX "ix_TMP_20180516_CODEGEN_96bb" ON "TMP_20180516_CODEGEN_JAZG31_ADS" ("KEY")

-- Code For temporary table TMP_20180516_CODEGEN_EFJQ8R_CAL part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180516_CODEGEN_EFJQ8R_CAL" (
	"KEY" BIGINT, 
...
-- Code For temporary table TMP_20180516_CODEGEN_EFJQ8R_CAL part 2. Populate

INSERT INTO "TMP_20180516_CODEGEN_EFJQ8R_CAL" ("KEY", "Proba_0", "Proba_1", "Proba_2") SELECT "U"."KEY", "U"."Proba_0", "U"."Proba_1", "U"."Proba_2" 
...
FROM "TMP_20180516_CODEGEN_JAZG31_ADS" AS "ADS_sca_2_OUT"), 
"DT_node_data" AS 
...
-- Code For temporary table TMP_20180516_CODEGEN_D1INYR_CAL part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180516_CODEGEN_D1INYR_CAL" (
	"KEY" BIGINT NOT NULL, 
	"Proba_0" DOUBLE PRECISION, 
	"Proba_1" DOUBLE PRECISION, 
	"Proba_2" DOUBLE PRECISION, 
...
-- Code For temporary table TMP_20180516_CODEGEN_D1INYR_CAL part 2. Populate

INSERT INTO "TMP_20180516_CODEGEN_D1INYR_CAL" ("KEY", "Proba_0", "Proba_1", "Proba_2") SELECT "U"."KEY", "U"."Proba_0", "U"."Proba_1", "U"."Proba_2" 
...
FROM "TMP_20180516_CODEGEN_EFJQ8R_CAL" AS "CalProb_B0") AS "CalProb_EnsembleUnion")
...
-- Code For temporary table TMP_20180516_CODEGEN_D1INYR_CAL part 3. Create Index 

CREATE INDEX "ix_TMP_20180516_CODEGEN_0b78" ON "TMP_20180516_CODEGEN_D1INYR_CAL" ("KEY")
...
FROM "TMP_20180516_CODEGEN_D1INYR_CAL" AS "CalProb_avg"), 
