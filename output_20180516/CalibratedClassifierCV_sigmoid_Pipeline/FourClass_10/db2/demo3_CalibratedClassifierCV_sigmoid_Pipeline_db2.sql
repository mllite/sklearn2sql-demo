...
-- Code For temporary table tmp_20180602142956_wn2_ads_imp_1_out part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180602142956_wn2_ads_imp_1_out (
	"KEY" BIGINT, 
	impter_2 DOUBLE, 
	impter_3 DOUBLE, 
	impter_4 DOUBLE, 
...
-- Code For temporary table tmp_20180602142956_wn2_ads_imp_1_out part 2. Populate

INSERT INTO tmp_20180602142956_wn2_ads_imp_1_out SELECT "ADS_imp_1_OUT"."KEY", "ADS_imp_1_OUT".impter_2, "ADS_imp_1_OUT".impter_3, "ADS_imp_1_OUT".impter_4, "ADS_imp_1_OUT".impter_5, "ADS_imp_1_OUT".impter_6, "ADS_imp_1_OUT".impter_7, "ADS_imp_1_OUT".impter_8, "ADS_imp_1_OUT".impter_9, "ADS_imp_1_OUT".impter_10, "ADS_imp_1_OUT".impter_11 
...
-- Code For temporary table tmp_20180602142956_cq0_ads_sca_2_out part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180602142956_cq0_ads_sca_2_out (
	"KEY" BIGINT, 
	scaler_2 DOUBLE, 
	scaler_3 DOUBLE, 
	scaler_4 DOUBLE, 
...
FROM tmp_20180602142956_wn2_ads_imp_1_out AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT"

-- Code For temporary table tmp_20180602142956_4uz_calprob_b0 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180602142956_4uz_calprob_b0 (
	"KEY" BIGINT, 
	"Proba_0" DOUBLE, 
	"Proba_1" DOUBLE, 
	"Proba_2" DOUBLE, 
...
-- Code For temporary table tmp_20180602142956_4uz_calprob_b0 part 2. Populate

INSERT INTO tmp_20180602142956_4uz_calprob_b0 WITH "DT_node_lookup" AS 
...
FROM tmp_20180602142956_cq0_ads_sca_2_out AS "ADS_sca_2_OUT"), 
"DT_node_data" AS 
...
-- Code For temporary table tmp_20180602142956_5jl_calprob_avg part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180602142956_5jl_calprob_avg (
	"KEY" BIGINT, 
	"Proba_0" DOUBLE, 
	"Proba_1" DOUBLE, 
	"Proba_2" DOUBLE, 
...
-- Code For temporary table tmp_20180602142956_5jl_calprob_avg part 2. Populate

INSERT INTO tmp_20180602142956_5jl_calprob_avg WITH "CalProb_Union" AS 
...
FROM tmp_20180602142956_4uz_calprob_b0 AS "CalProb_B0") AS "CalProb_EnsembleUnion")
...
FROM tmp_20180602142956_5jl_calprob_avg AS "CalProb_avg"), 
