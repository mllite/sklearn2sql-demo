...
-- Code For temporary table TMP_20180508181124_CODEGEN_Q4IQQV_ADS_imp_1_OUT part 1. Create 


CREATE TEMPORARY TABLE "TMP_20180508181124_CODEGEN_Q4IQQV_ADS_imp_1_OUT" (
	"KEY" BIGINT NOT NULL, 
	impter_2 FLOAT, 
	impter_3 FLOAT, 
	impter_4 FLOAT, 
...
-- Code For temporary table TMP_20180508181124_CODEGEN_Q4IQQV_ADS_imp_1_OUT part 2. Populate

INSERT INTO "TMP_20180508181124_CODEGEN_Q4IQQV_ADS_imp_1_OUT" ("KEY", impter_2, impter_3, impter_4, impter_5, impter_6, impter_7, impter_8, impter_9, impter_10, impter_11) SELECT "ADS_imp_1_OUT"."KEY", "ADS_imp_1_OUT".impter_2, "ADS_imp_1_OUT".impter_3, "ADS_imp_1_OUT".impter_4, "ADS_imp_1_OUT".impter_5, "ADS_imp_1_OUT".impter_6, "ADS_imp_1_OUT".impter_7, "ADS_imp_1_OUT".impter_8, "ADS_imp_1_OUT".impter_9, "ADS_imp_1_OUT".impter_10, "ADS_imp_1_OUT".impter_11 
...
-- Code For temporary table TMP_20180508181124_CODEGEN_Q4IQQV_ADS_imp_1_OUT part 3. Create Index 

CREATE INDEX "ix_TMP_20180508181124_CODEGEN_Q4IQQV_ADS_imp_1_OUT_KEY" ON "TMP_20180508181124_CODEGEN_Q4IQQV_ADS_imp_1_OUT" ("KEY")

-- Code For temporary table TMP_20180508181124_CODEGEN_97UVCC_ADS_sca_2_OUT part 1. Create 


CREATE TEMPORARY TABLE "TMP_20180508181124_CODEGEN_97UVCC_ADS_sca_2_OUT" (
	"KEY" BIGINT NOT NULL, 
	scaler_2 FLOAT, 
	scaler_3 FLOAT, 
	scaler_4 FLOAT, 
...
FROM "TMP_20180508181124_CODEGEN_Q4IQQV_ADS_imp_1_OUT" AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT"

-- Code For temporary table TMP_20180508181124_CODEGEN_97UVCC_ADS_sca_2_OUT part 3. Create Index 

CREATE INDEX "ix_TMP_20180508181124_CODEGEN_97UVCC_ADS_sca_2_OUT_KEY" ON "TMP_20180508181124_CODEGEN_97UVCC_ADS_sca_2_OUT" ("KEY")

-- Code For temporary table TMP_20180508181124_CODEGEN_I34586_CalProb_B0 part 1. Create 


CREATE TEMPORARY TABLE "TMP_20180508181124_CODEGEN_I34586_CalProb_B0" (
	"KEY" BIGINT, 
	"Proba_0" FLOAT, 
	"Proba_1" FLOAT, 
	"Proba_2" FLOAT, 
...
-- Code For temporary table TMP_20180508181124_CODEGEN_I34586_CalProb_B0 part 2. Populate
...
FROM "TMP_20180508181124_CODEGEN_97UVCC_ADS_sca_2_OUT" AS "ADS_sca_2_OUT"), 
"DT_node_data" AS 
...
(SELECT "Calibrated_Model_0"."KEY" AS "KEY", 1.0 / (1.0 + exp(min(max(-100.0, -(2.614782213667346 * "Calibrated_Model_0"."ScoreOrProba_0" + -1.8541774485001863)), 100.0))) AS "Proba_0", 1.0 / (1.0 + exp(min(max(-100.0, -(1.6744918254963246 * "Calibrated_Model_0"."ScoreOrProba_1" + -1.6402291617335063)), 100.0))) AS "Proba_1", 1.0 / (1.0 + exp(min(max(-100.0, -(1.612590274619459 * "Calibrated_Model_0"."ScoreOrProba_2" + -1.465775876667155)), 100.0))) AS "Proba_2", 1.0 / (1.0 + exp(min(max(-100.0, -(2.675768697999654 * "Calibrated_Model_0"."ScoreOrProba_3" + -2.1312246712336864)), 100.0))) AS "Proba_3" 
...
(SELECT "Calibrated_Model_1"."KEY" AS "KEY", 1.0 / (1.0 + exp(min(max(-100.0, -(2.9681424816383735 * "Calibrated_Model_1"."ScoreOrProba_0" + -2.1359182242144628)), 100.0))) AS "Proba_0", 1.0 / (1.0 + exp(min(max(-100.0, -(2.5189664651165287 * "Calibrated_Model_1"."ScoreOrProba_1" + -2.0741055120441403)), 100.0))) AS "Proba_1", 1.0 / (1.0 + exp(min(max(-100.0, -(2.140876412096892 * "Calibrated_Model_1"."ScoreOrProba_2" + -2.040476353698952)), 100.0))) AS "Proba_2", 1.0 / (1.0 + exp(min(max(-100.0, -(3.3646908708097913 * "Calibrated_Model_1"."ScoreOrProba_3" + -1.418780192015199)), 100.0))) AS "Proba_3" 
...
(SELECT "Calibrated_Model_2"."KEY" AS "KEY", 1.0 / (1.0 + exp(min(max(-100.0, -(1.689332668076091 * "Calibrated_Model_2"."ScoreOrProba_0" + -1.9406293857491108)), 100.0))) AS "Proba_0", 1.0 / (1.0 + exp(min(max(-100.0, -(1.405628394347645 * "Calibrated_Model_2"."ScoreOrProba_1" + -1.3489731040569997)), 100.0))) AS "Proba_1", 1.0 / (1.0 + exp(min(max(-100.0, -(0.22478479435704893 * "Calibrated_Model_2"."ScoreOrProba_2" + -1.0263746591668546)), 100.0))) AS "Proba_2", 1.0 / (1.0 + exp(min(max(-100.0, -(1.6386132666333737 * "Calibrated_Model_2"."ScoreOrProba_3" + -1.5671253094287134)), 100.0))) AS "Proba_3" 
...
(SELECT "Calibrated_Model_3"."KEY" AS "KEY", 1.0 / (1.0 + exp(min(max(-100.0, -(1.7911314395473739 * "Calibrated_Model_3"."ScoreOrProba_0" + -2.0076580723287925)), 100.0))) AS "Proba_0", 1.0 / (1.0 + exp(min(max(-100.0, -(1.3234114598263957 * "Calibrated_Model_3"."ScoreOrProba_1" + -1.484473012687775)), 100.0))) AS "Proba_1", 1.0 / (1.0 + exp(min(max(-100.0, -(1.6892598764470943 * "Calibrated_Model_3"."ScoreOrProba_2" + -1.315936557650469)), 100.0))) AS "Proba_2", 1.0 / (1.0 + exp(min(max(-100.0, -(2.253173046050721 * "Calibrated_Model_3"."ScoreOrProba_3" + -1.596635300071773)), 100.0))) AS "Proba_3" 
...
FROM sigmoid_calibration_3)
 INSERT INTO "TMP_20180508181124_CODEGEN_I34586_CalProb_B0" ("KEY", "Proba_0", "Proba_1", "Proba_2", "Proba_3") SELECT "CalProb_B0"."KEY", "CalProb_B0"."Proba_0", "CalProb_B0"."Proba_1", "CalProb_B0"."Proba_2", "CalProb_B0"."Proba_3" 
...
-- Code For temporary table TMP_20180508181124_CODEGEN_HSECJO_CalProb_Union part 1. Create 


CREATE TEMPORARY TABLE "TMP_20180508181124_CODEGEN_HSECJO_CalProb_Union" (
	"KEY" BIGINT, 
	"Proba_0" FLOAT, 
	"Proba_1" FLOAT, 
	"Proba_2" FLOAT, 
...
-- Code For temporary table TMP_20180508181124_CODEGEN_HSECJO_CalProb_Union part 2. Populate

INSERT INTO "TMP_20180508181124_CODEGEN_HSECJO_CalProb_Union" ("KEY", "Proba_0", "Proba_1", "Proba_2", "Proba_3") SELECT "CalProb_Union"."KEY", "CalProb_Union"."Proba_0", "CalProb_Union"."Proba_1", "CalProb_Union"."Proba_2", "CalProb_Union"."Proba_3" 
...
FROM "TMP_20180508181124_CODEGEN_I34586_CalProb_B0" AS "CalProb_B0") AS "CalProb_EnsembleUnion") AS "CalProb_Union"

-- Code For temporary table TMP_20180508181124_CODEGEN_09OVMZ_CalProb_avg part 1. Create 


CREATE TEMPORARY TABLE "TMP_20180508181124_CODEGEN_09OVMZ_CalProb_avg" (
	"KEY" BIGINT NOT NULL, 
	"Proba_0" FLOAT, 
	"Proba_1" FLOAT, 
	"Proba_2" FLOAT, 
...
-- Code For temporary table TMP_20180508181124_CODEGEN_09OVMZ_CalProb_avg part 2. Populate

INSERT INTO "TMP_20180508181124_CODEGEN_09OVMZ_CalProb_avg" ("KEY", "Proba_0", "Proba_1", "Proba_2", "Proba_3") SELECT "CalProb_avg"."KEY", "CalProb_avg"."Proba_0", "CalProb_avg"."Proba_1", "CalProb_avg"."Proba_2", "CalProb_avg"."Proba_3" 
...
FROM "TMP_20180508181124_CODEGEN_HSECJO_CalProb_Union" AS "CalProb_Union" GROUP BY "CalProb_Union"."KEY") AS "T") AS "CalProb_avg"

-- Code For temporary table TMP_20180508181124_CODEGEN_09OVMZ_CalProb_avg part 3. Create Index 

CREATE INDEX "ix_TMP_20180508181124_CODEGEN_09OVMZ_CalProb_avg_KEY" ON "TMP_20180508181124_CODEGEN_09OVMZ_CalProb_avg" ("KEY")
...
FROM "TMP_20180508181124_CODEGEN_09OVMZ_CalProb_avg" AS "CalProb_avg"), 
