...
-- Code For temporary table tmp_20180508181124_codegen_9lw0ji_ads_imp_1_out part 1. Create 


CREATE TEMPORARY TABLE tmp_20180508181124_codegen_9lw0ji_ads_imp_1_out (
	"KEY" BIGINT, 
	impter_2 DOUBLE, 
	impter_3 DOUBLE, 
	impter_4 DOUBLE, 
...
-- Code For temporary table tmp_20180508181124_codegen_9lw0ji_ads_imp_1_out part 2. Populate

INSERT INTO tmp_20180508181124_codegen_9lw0ji_ads_imp_1_out ("KEY", impter_2, impter_3, impter_4, impter_5, impter_6, impter_7, impter_8, impter_9, impter_10, impter_11) SELECT "U"."KEY", "U".impter_2, "U".impter_3, "U".impter_4, "U".impter_5, "U".impter_6, "U".impter_7, "U".impter_8, "U".impter_9, "U".impter_10, "U".impter_11 
...
-- Code For temporary table tmp_20180508181124_codegen_jz14bx_ads_sca_2_out part 1. Create 


CREATE TEMPORARY TABLE tmp_20180508181124_codegen_jz14bx_ads_sca_2_out (
	"KEY" BIGINT, 
	scaler_2 DOUBLE, 
	scaler_3 DOUBLE, 
	scaler_4 DOUBLE, 
...
-- Code For temporary table tmp_20180508181124_codegen_jz14bx_ads_sca_2_out part 2. Populate

INSERT INTO tmp_20180508181124_codegen_jz14bx_ads_sca_2_out ("KEY", scaler_2, scaler_3, scaler_4, scaler_5, scaler_6, scaler_7, scaler_8, scaler_9, scaler_10, scaler_11) SELECT "U"."KEY", "U".scaler_2, "U".scaler_3, "U".scaler_4, "U".scaler_5, "U".scaler_6, "U".scaler_7, "U".scaler_8, "U".scaler_9, "U".scaler_10, "U".scaler_11 
...
FROM tmp_20180508181124_codegen_9lw0ji_ads_imp_1_out AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT") AS "U"

-- Code For temporary table tmp_20180508181124_codegen_jjk8lw_calprob_b0 part 1. Create 


CREATE TEMPORARY TABLE tmp_20180508181124_codegen_jjk8lw_calprob_b0 (
	"KEY" BIGINT, 
	"Proba_0" DOUBLE, 
	"Proba_1" DOUBLE, 
	"Proba_2" DOUBLE, 
...
-- Code For temporary table tmp_20180508181124_codegen_jjk8lw_calprob_b0 part 2. Populate

INSERT INTO tmp_20180508181124_codegen_jjk8lw_calprob_b0 ("KEY", "Proba_0", "Proba_1", "Proba_2", "Proba_3") SELECT "U"."KEY", "U"."Proba_0", "U"."Proba_1", "U"."Proba_2", "U"."Proba_3" 
...
FROM tmp_20180508181124_codegen_jz14bx_ads_sca_2_out AS "ADS_sca_2_OUT"), 
"DT_node_data" AS 
...
(SELECT "DT_Output"."KEY" AS "KEY", CAST(NULL AS DOUBLE) AS "Score_0", CAST(NULL AS DOUBLE) AS "Score_1", CAST(NULL AS DOUBLE) AS "Score_2", CAST(NULL AS DOUBLE) AS "Score_3", "DT_Output"."P_0" AS "Proba_0", "DT_Output"."P_1" AS "Proba_1", "DT_Output"."P_2" AS "Proba_2", "DT_Output"."P_3" AS "Proba_3", log(CASE WHEN ("DT_Output"."P_0" IS NULL OR "DT_Output"."P_0" > 1e-100) THEN "DT_Output"."P_0" ELSE 1e-100 END) AS "LogProba_0", log(CASE WHEN ("DT_Output"."P_1" IS NULL OR "DT_Output"."P_1" > 1e-100) THEN "DT_Output"."P_1" ELSE 1e-100 END) AS "LogProba_1", log(CASE WHEN ("DT_Output"."P_2" IS NULL OR "DT_Output"."P_2" > 1e-100) THEN "DT_Output"."P_2" ELSE 1e-100 END) AS "LogProba_2", log(CASE WHEN ("DT_Output"."P_3" IS NULL OR "DT_Output"."P_3" > 1e-100) THEN "DT_Output"."P_3" ELSE 1e-100 END) AS "LogProba_3", CAST(NULL AS BIGINT) AS "Decision", CAST(NULL AS DOUBLE) AS "DecisionProba", coalesce(CAST(NULL AS DOUBLE), "DT_Output"."P_0") AS "ScoreOrProba_0", coalesce(CAST(NULL AS DOUBLE), "DT_Output"."P_1") AS "ScoreOrProba_1", coalesce(CAST(NULL AS DOUBLE), "DT_Output"."P_2") AS "ScoreOrProba_2", coalesce(CAST(NULL AS DOUBLE), "DT_Output"."P_3") AS "ScoreOrProba_3" 
FROM "DT_Output"), 
sigmoid_calibration_0 AS 
(SELECT "Calibrated_Model_0"."KEY" AS "KEY", 1.0 / (1.0 + exp(CASE WHEN (CASE WHEN (-100.0 <= -(2.614782213667346 * "Calibrated_Model_0"."ScoreOrProba_0" + -1.8541774485001863)) THEN -(2.614782213667346 * "Calibrated_Model_0"."ScoreOrProba_0" + -1.8541774485001863) ELSE -100.0 END <= 100.0) THEN CASE WHEN (-100.0 <= -(2.614782213667346 * "Calibrated_Model_0"."ScoreOrProba_0" + -1.8541774485001863)) THEN -(2.614782213667346 * "Calibrated_Model_0"."ScoreOrProba_0" + -1.8541774485001863) ELSE -100.0 END ELSE 100.0 END)) AS "Proba_0", 1.0 / (1.0 + exp(CASE WHEN (CASE WHEN (-100.0 <= -(1.6744918254963246 * "Calibrated_Model_0"."ScoreOrProba_1" + -1.6402291617335063)) THEN -(1.6744918254963246 * "Calibrated_Model_0"."ScoreOrProba_1" + -1.6402291617335063) ELSE -100.0 END <= 100.0) THEN CASE WHEN (-100.0 <= -(1.6744918254963246 * "Calibrated_Model_0"."ScoreOrProba_1" + -1.6402291617335063)) THEN -(1.6744918254963246 * "Calibrated_Model_0"."ScoreOrProba_1" + -1.6402291617335063) ELSE -100.0 END ELSE 100.0 END)) AS "Proba_1", 1.0 / (1.0 + exp(CASE WHEN (CASE WHEN (-100.0 <= -(1.612590274619459 * "Calibrated_Model_0"."ScoreOrProba_2" + -1.465775876667155)) THEN -(1.612590274619459 * "Calibrated_Model_0"."ScoreOrProba_2" + -1.465775876667155) ELSE -100.0 END <= 100.0) THEN CASE WHEN (-100.0 <= -(1.612590274619459 * "Calibrated_Model_0"."ScoreOrProba_2" + -1.465775876667155)) THEN -(1.612590274619459 * "Calibrated_Model_0"."ScoreOrProba_2" + -1.465775876667155) ELSE -100.0 END ELSE 100.0 END)) AS "Proba_2", 1.0 / (1.0 + exp(CASE WHEN (CASE WHEN (-100.0 <= -(2.675768697999654 * "Calibrated_Model_0"."ScoreOrProba_3" + -2.1312246712336864)) THEN -(2.675768697999654 * "Calibrated_Model_0"."ScoreOrProba_3" + -2.1312246712336864) ELSE -100.0 END <= 100.0) THEN CASE WHEN (-100.0 <= -(2.675768697999654 * "Calibrated_Model_0"."ScoreOrProba_3" + -2.1312246712336864)) THEN -(2.675768697999654 * "Calibrated_Model_0"."ScoreOrProba_3" + -2.1312246712336864) ELSE -100.0 END ELSE 100.0 END)) AS "Proba_3" 
...
(SELECT "DT_Output_1"."KEY" AS "KEY", CAST(NULL AS DOUBLE) AS "Score_0", CAST(NULL AS DOUBLE) AS "Score_1", CAST(NULL AS DOUBLE) AS "Score_2", CAST(NULL AS DOUBLE) AS "Score_3", "DT_Output_1"."P_0" AS "Proba_0", "DT_Output_1"."P_1" AS "Proba_1", "DT_Output_1"."P_2" AS "Proba_2", "DT_Output_1"."P_3" AS "Proba_3", log(CASE WHEN ("DT_Output_1"."P_0" IS NULL OR "DT_Output_1"."P_0" > 1e-100) THEN "DT_Output_1"."P_0" ELSE 1e-100 END) AS "LogProba_0", log(CASE WHEN ("DT_Output_1"."P_1" IS NULL OR "DT_Output_1"."P_1" > 1e-100) THEN "DT_Output_1"."P_1" ELSE 1e-100 END) AS "LogProba_1", log(CASE WHEN ("DT_Output_1"."P_2" IS NULL OR "DT_Output_1"."P_2" > 1e-100) THEN "DT_Output_1"."P_2" ELSE 1e-100 END) AS "LogProba_2", log(CASE WHEN ("DT_Output_1"."P_3" IS NULL OR "DT_Output_1"."P_3" > 1e-100) THEN "DT_Output_1"."P_3" ELSE 1e-100 END) AS "LogProba_3", CAST(NULL AS BIGINT) AS "Decision", CAST(NULL AS DOUBLE) AS "DecisionProba", coalesce(CAST(NULL AS DOUBLE), "DT_Output_1"."P_0") AS "ScoreOrProba_0", coalesce(CAST(NULL AS DOUBLE), "DT_Output_1"."P_1") AS "ScoreOrProba_1", coalesce(CAST(NULL AS DOUBLE), "DT_Output_1"."P_2") AS "ScoreOrProba_2", coalesce(CAST(NULL AS DOUBLE), "DT_Output_1"."P_3") AS "ScoreOrProba_3" 
FROM "DT_Output_1"), 
sigmoid_calibration_1 AS 
(SELECT "Calibrated_Model_1"."KEY" AS "KEY", 1.0 / (1.0 + exp(CASE WHEN (CASE WHEN (-100.0 <= -(2.9681424816383735 * "Calibrated_Model_1"."ScoreOrProba_0" + -2.1359182242144628)) THEN -(2.9681424816383735 * "Calibrated_Model_1"."ScoreOrProba_0" + -2.1359182242144628) ELSE -100.0 END <= 100.0) THEN CASE WHEN (-100.0 <= -(2.9681424816383735 * "Calibrated_Model_1"."ScoreOrProba_0" + -2.1359182242144628)) THEN -(2.9681424816383735 * "Calibrated_Model_1"."ScoreOrProba_0" + -2.1359182242144628) ELSE -100.0 END ELSE 100.0 END)) AS "Proba_0", 1.0 / (1.0 + exp(CASE WHEN (CASE WHEN (-100.0 <= -(2.5189664651165287 * "Calibrated_Model_1"."ScoreOrProba_1" + -2.0741055120441403)) THEN -(2.5189664651165287 * "Calibrated_Model_1"."ScoreOrProba_1" + -2.0741055120441403) ELSE -100.0 END <= 100.0) THEN CASE WHEN (-100.0 <= -(2.5189664651165287 * "Calibrated_Model_1"."ScoreOrProba_1" + -2.0741055120441403)) THEN -(2.5189664651165287 * "Calibrated_Model_1"."ScoreOrProba_1" + -2.0741055120441403) ELSE -100.0 END ELSE 100.0 END)) AS "Proba_1", 1.0 / (1.0 + exp(CASE WHEN (CASE WHEN (-100.0 <= -(2.140876412096892 * "Calibrated_Model_1"."ScoreOrProba_2" + -2.040476353698952)) THEN -(2.140876412096892 * "Calibrated_Model_1"."ScoreOrProba_2" + -2.040476353698952) ELSE -100.0 END <= 100.0) THEN CASE WHEN (-100.0 <= -(2.140876412096892 * "Calibrated_Model_1"."ScoreOrProba_2" + -2.040476353698952)) THEN -(2.140876412096892 * "Calibrated_Model_1"."ScoreOrProba_2" + -2.040476353698952) ELSE -100.0 END ELSE 100.0 END)) AS "Proba_2", 1.0 / (1.0 + exp(CASE WHEN (CASE WHEN (-100.0 <= -(3.3646908708097913 * "Calibrated_Model_1"."ScoreOrProba_3" + -1.418780192015199)) THEN -(3.3646908708097913 * "Calibrated_Model_1"."ScoreOrProba_3" + -1.418780192015199) ELSE -100.0 END <= 100.0) THEN CASE WHEN (-100.0 <= -(3.3646908708097913 * "Calibrated_Model_1"."ScoreOrProba_3" + -1.418780192015199)) THEN -(3.3646908708097913 * "Calibrated_Model_1"."ScoreOrProba_3" + -1.418780192015199) ELSE -100.0 END ELSE 100.0 END)) AS "Proba_3" 
...
(SELECT "DT_Output_2"."KEY" AS "KEY", CAST(NULL AS DOUBLE) AS "Score_0", CAST(NULL AS DOUBLE) AS "Score_1", CAST(NULL AS DOUBLE) AS "Score_2", CAST(NULL AS DOUBLE) AS "Score_3", "DT_Output_2"."P_0" AS "Proba_0", "DT_Output_2"."P_1" AS "Proba_1", "DT_Output_2"."P_2" AS "Proba_2", "DT_Output_2"."P_3" AS "Proba_3", log(CASE WHEN ("DT_Output_2"."P_0" IS NULL OR "DT_Output_2"."P_0" > 1e-100) THEN "DT_Output_2"."P_0" ELSE 1e-100 END) AS "LogProba_0", log(CASE WHEN ("DT_Output_2"."P_1" IS NULL OR "DT_Output_2"."P_1" > 1e-100) THEN "DT_Output_2"."P_1" ELSE 1e-100 END) AS "LogProba_1", log(CASE WHEN ("DT_Output_2"."P_2" IS NULL OR "DT_Output_2"."P_2" > 1e-100) THEN "DT_Output_2"."P_2" ELSE 1e-100 END) AS "LogProba_2", log(CASE WHEN ("DT_Output_2"."P_3" IS NULL OR "DT_Output_2"."P_3" > 1e-100) THEN "DT_Output_2"."P_3" ELSE 1e-100 END) AS "LogProba_3", CAST(NULL AS BIGINT) AS "Decision", CAST(NULL AS DOUBLE) AS "DecisionProba", coalesce(CAST(NULL AS DOUBLE), "DT_Output_2"."P_0") AS "ScoreOrProba_0", coalesce(CAST(NULL AS DOUBLE), "DT_Output_2"."P_1") AS "ScoreOrProba_1", coalesce(CAST(NULL AS DOUBLE), "DT_Output_2"."P_2") AS "ScoreOrProba_2", coalesce(CAST(NULL AS DOUBLE), "DT_Output_2"."P_3") AS "ScoreOrProba_3" 
FROM "DT_Output_2"), 
sigmoid_calibration_2 AS 
(SELECT "Calibrated_Model_2"."KEY" AS "KEY", 1.0 / (1.0 + exp(CASE WHEN (CASE WHEN (-100.0 <= -(1.689332668076091 * "Calibrated_Model_2"."ScoreOrProba_0" + -1.9406293857491108)) THEN -(1.689332668076091 * "Calibrated_Model_2"."ScoreOrProba_0" + -1.9406293857491108) ELSE -100.0 END <= 100.0) THEN CASE WHEN (-100.0 <= -(1.689332668076091 * "Calibrated_Model_2"."ScoreOrProba_0" + -1.9406293857491108)) THEN -(1.689332668076091 * "Calibrated_Model_2"."ScoreOrProba_0" + -1.9406293857491108) ELSE -100.0 END ELSE 100.0 END)) AS "Proba_0", 1.0 / (1.0 + exp(CASE WHEN (CASE WHEN (-100.0 <= -(1.405628394347645 * "Calibrated_Model_2"."ScoreOrProba_1" + -1.3489731040569997)) THEN -(1.405628394347645 * "Calibrated_Model_2"."ScoreOrProba_1" + -1.3489731040569997) ELSE -100.0 END <= 100.0) THEN CASE WHEN (-100.0 <= -(1.405628394347645 * "Calibrated_Model_2"."ScoreOrProba_1" + -1.3489731040569997)) THEN -(1.405628394347645 * "Calibrated_Model_2"."ScoreOrProba_1" + -1.3489731040569997) ELSE -100.0 END ELSE 100.0 END)) AS "Proba_1", 1.0 / (1.0 + exp(CASE WHEN (CASE WHEN (-100.0 <= -(0.22478479435704893 * "Calibrated_Model_2"."ScoreOrProba_2" + -1.0263746591668546)) THEN -(0.22478479435704893 * "Calibrated_Model_2"."ScoreOrProba_2" + -1.0263746591668546) ELSE -100.0 END <= 100.0) THEN CASE WHEN (-100.0 <= -(0.22478479435704893 * "Calibrated_Model_2"."ScoreOrProba_2" + -1.0263746591668546)) THEN -(0.22478479435704893 * "Calibrated_Model_2"."ScoreOrProba_2" + -1.0263746591668546) ELSE -100.0 END ELSE 100.0 END)) AS "Proba_2", 1.0 / (1.0 + exp(CASE WHEN (CASE WHEN (-100.0 <= -(1.6386132666333737 * "Calibrated_Model_2"."ScoreOrProba_3" + -1.5671253094287134)) THEN -(1.6386132666333737 * "Calibrated_Model_2"."ScoreOrProba_3" + -1.5671253094287134) ELSE -100.0 END <= 100.0) THEN CASE WHEN (-100.0 <= -(1.6386132666333737 * "Calibrated_Model_2"."ScoreOrProba_3" + -1.5671253094287134)) THEN -(1.6386132666333737 * "Calibrated_Model_2"."ScoreOrProba_3" + -1.5671253094287134) ELSE -100.0 END ELSE 100.0 END)) AS "Proba_3" 
...
(SELECT "DT_Output_3"."KEY" AS "KEY", CAST(NULL AS DOUBLE) AS "Score_0", CAST(NULL AS DOUBLE) AS "Score_1", CAST(NULL AS DOUBLE) AS "Score_2", CAST(NULL AS DOUBLE) AS "Score_3", "DT_Output_3"."P_0" AS "Proba_0", "DT_Output_3"."P_1" AS "Proba_1", "DT_Output_3"."P_2" AS "Proba_2", "DT_Output_3"."P_3" AS "Proba_3", log(CASE WHEN ("DT_Output_3"."P_0" IS NULL OR "DT_Output_3"."P_0" > 1e-100) THEN "DT_Output_3"."P_0" ELSE 1e-100 END) AS "LogProba_0", log(CASE WHEN ("DT_Output_3"."P_1" IS NULL OR "DT_Output_3"."P_1" > 1e-100) THEN "DT_Output_3"."P_1" ELSE 1e-100 END) AS "LogProba_1", log(CASE WHEN ("DT_Output_3"."P_2" IS NULL OR "DT_Output_3"."P_2" > 1e-100) THEN "DT_Output_3"."P_2" ELSE 1e-100 END) AS "LogProba_2", log(CASE WHEN ("DT_Output_3"."P_3" IS NULL OR "DT_Output_3"."P_3" > 1e-100) THEN "DT_Output_3"."P_3" ELSE 1e-100 END) AS "LogProba_3", CAST(NULL AS BIGINT) AS "Decision", CAST(NULL AS DOUBLE) AS "DecisionProba", coalesce(CAST(NULL AS DOUBLE), "DT_Output_3"."P_0") AS "ScoreOrProba_0", coalesce(CAST(NULL AS DOUBLE), "DT_Output_3"."P_1") AS "ScoreOrProba_1", coalesce(CAST(NULL AS DOUBLE), "DT_Output_3"."P_2") AS "ScoreOrProba_2", coalesce(CAST(NULL AS DOUBLE), "DT_Output_3"."P_3") AS "ScoreOrProba_3" 
FROM "DT_Output_3"), 
sigmoid_calibration_3 AS 
(SELECT "Calibrated_Model_3"."KEY" AS "KEY", 1.0 / (1.0 + exp(CASE WHEN (CASE WHEN (-100.0 <= -(1.7911314395473739 * "Calibrated_Model_3"."ScoreOrProba_0" + -2.0076580723287925)) THEN -(1.7911314395473739 * "Calibrated_Model_3"."ScoreOrProba_0" + -2.0076580723287925) ELSE -100.0 END <= 100.0) THEN CASE WHEN (-100.0 <= -(1.7911314395473739 * "Calibrated_Model_3"."ScoreOrProba_0" + -2.0076580723287925)) THEN -(1.7911314395473739 * "Calibrated_Model_3"."ScoreOrProba_0" + -2.0076580723287925) ELSE -100.0 END ELSE 100.0 END)) AS "Proba_0", 1.0 / (1.0 + exp(CASE WHEN (CASE WHEN (-100.0 <= -(1.3234114598263957 * "Calibrated_Model_3"."ScoreOrProba_1" + -1.484473012687775)) THEN -(1.3234114598263957 * "Calibrated_Model_3"."ScoreOrProba_1" + -1.484473012687775) ELSE -100.0 END <= 100.0) THEN CASE WHEN (-100.0 <= -(1.3234114598263957 * "Calibrated_Model_3"."ScoreOrProba_1" + -1.484473012687775)) THEN -(1.3234114598263957 * "Calibrated_Model_3"."ScoreOrProba_1" + -1.484473012687775) ELSE -100.0 END ELSE 100.0 END)) AS "Proba_1", 1.0 / (1.0 + exp(CASE WHEN (CASE WHEN (-100.0 <= -(1.6892598764470943 * "Calibrated_Model_3"."ScoreOrProba_2" + -1.315936557650469)) THEN -(1.6892598764470943 * "Calibrated_Model_3"."ScoreOrProba_2" + -1.315936557650469) ELSE -100.0 END <= 100.0) THEN CASE WHEN (-100.0 <= -(1.6892598764470943 * "Calibrated_Model_3"."ScoreOrProba_2" + -1.315936557650469)) THEN -(1.6892598764470943 * "Calibrated_Model_3"."ScoreOrProba_2" + -1.315936557650469) ELSE -100.0 END ELSE 100.0 END)) AS "Proba_2", 1.0 / (1.0 + exp(CASE WHEN (CASE WHEN (-100.0 <= -(2.253173046050721 * "Calibrated_Model_3"."ScoreOrProba_3" + -1.596635300071773)) THEN -(2.253173046050721 * "Calibrated_Model_3"."ScoreOrProba_3" + -1.596635300071773) ELSE -100.0 END <= 100.0) THEN CASE WHEN (-100.0 <= -(2.253173046050721 * "Calibrated_Model_3"."ScoreOrProba_3" + -1.596635300071773)) THEN -(2.253173046050721 * "Calibrated_Model_3"."ScoreOrProba_3" + -1.596635300071773) ELSE -100.0 END ELSE 100.0 END)) AS "Proba_3" 
...
-- Code For temporary table tmp_20180508181124_codegen_6bffhh_calprob_union part 1. Create 


CREATE TEMPORARY TABLE tmp_20180508181124_codegen_6bffhh_calprob_union (
	"KEY" BIGINT, 
	"Proba_0" DOUBLE, 
	"Proba_1" DOUBLE, 
	"Proba_2" DOUBLE, 
...
-- Code For temporary table tmp_20180508181124_codegen_6bffhh_calprob_union part 2. Populate

INSERT INTO tmp_20180508181124_codegen_6bffhh_calprob_union ("KEY", "Proba_0", "Proba_1", "Proba_2", "Proba_3") SELECT "U"."KEY", "U"."Proba_0", "U"."Proba_1", "U"."Proba_2", "U"."Proba_3" 
...
FROM tmp_20180508181124_codegen_jjk8lw_calprob_b0 AS "CalProb_B0") AS "CalProb_EnsembleUnion") AS "CalProb_Union") AS "U"

-- Code For temporary table tmp_20180508181124_codegen_edct81_calprob_avg part 1. Create 


CREATE TEMPORARY TABLE tmp_20180508181124_codegen_edct81_calprob_avg (
	"KEY" BIGINT, 
	"Proba_0" DOUBLE, 
	"Proba_1" DOUBLE, 
	"Proba_2" DOUBLE, 
...
-- Code For temporary table tmp_20180508181124_codegen_edct81_calprob_avg part 2. Populate

INSERT INTO tmp_20180508181124_codegen_edct81_calprob_avg ("KEY", "Proba_0", "Proba_1", "Proba_2", "Proba_3") SELECT "U"."KEY", "U"."Proba_0", "U"."Proba_1", "U"."Proba_2", "U"."Proba_3" 
...
FROM tmp_20180508181124_codegen_6bffhh_calprob_union AS "CalProb_Union" GROUP BY "CalProb_Union"."KEY") AS "T") AS "CalProb_avg") AS "U"
...
FROM tmp_20180508181124_codegen_edct81_calprob_avg AS "CalProb_avg"), 
