...
-- Code For temporary table 0_CODEGEN_2TFEIT_QUANTILES part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "0_CODEGEN_2TFEIT_QUANTILES" (
	"KEY" NUMBER(19), 
...
-- Code For temporary table 0_CODEGEN_2TFEIT_QUANTILES part 2. Populate

INSERT INTO "0_CODEGEN_2TFEIT_QUANTILES" ("KEY", "Quantile") SELECT "U"."KEY", "U"."Quantile" 
...
FROM "0_CODEGEN_2TFEIT_QUANTILES" "Quantiles"