...
-- Code For temporary table tmp_20180509004107_codegen_5l315x_quantiles part 1. Create 

CREATE TEMPORARY TABLE `tmp_20180509004107_codegen_5l315x_quantiles` STORED AS ORC AS WITH `DT_node_lookup` AS 
...
-- Code For temporary table tmp_20180509004107_codegen_5l315x_quantiles part 2. Populate

SELECT * FROM `tmp_20180509004107_codegen_5l315x_quantiles`

-- Model deployment code

SELECT `Quantiles`.`KEY` AS `KEY`, `Quantiles`.`Quantile` AS `Estimator` 
FROM `tmp_20180509004107_codegen_5l315x_quantiles` AS `Quantiles`