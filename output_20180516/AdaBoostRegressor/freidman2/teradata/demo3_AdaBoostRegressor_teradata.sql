...
-- Code For temporary table tmp_20180508184708_codegen_il5ckf_quantiles part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180508184708_codegen_il5ckf_quantiles  (
	"KEY" BIGINT, 
...
-- Code For temporary table tmp_20180508184708_codegen_il5ckf_quantiles part 2. Populate

INSERT INTO tmp_20180508184708_codegen_il5ckf_quantiles ("KEY", "Quantile") SELECT "U"."KEY", "U"."Quantile" 
...
FROM tmp_20180508184708_codegen_il5ckf_quantiles AS "Quantiles"