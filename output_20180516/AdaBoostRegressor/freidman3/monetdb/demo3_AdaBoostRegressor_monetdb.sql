...
-- Code For temporary table tmp_20180508185046_codegen_g0j2xs_quantiles part 1. Create 


CREATE TEMPORARY TABLE tmp_20180508185046_codegen_g0j2xs_quantiles (
	"KEY" BIGINT, 
	"Quantile" DOUBLE
)
...
-- Code For temporary table tmp_20180508185046_codegen_g0j2xs_quantiles part 2. Populate

INSERT INTO tmp_20180508185046_codegen_g0j2xs_quantiles ("KEY", "Quantile") SELECT "U"."KEY", "U"."Quantile" 
...
FROM tmp_20180508185046_codegen_g0j2xs_quantiles AS "Quantiles"