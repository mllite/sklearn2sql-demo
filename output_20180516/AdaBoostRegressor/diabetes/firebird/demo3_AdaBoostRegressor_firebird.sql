...
-- Code For temporary table TMP_20180508183242_CODEGEN_AC4H part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508183242_CODEGEN_AC4H" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20180508183242_CODEGEN_AC4H part 2. Populate

INSERT INTO "TMP_20180508183242_CODEGEN_AC4H" ("KEY", "Quantile") SELECT "U"."KEY", "U"."Quantile" 
...
-- Code For temporary table TMP_20180508183242_CODEGEN_AC4H part 3. Create Index 

CREATE INDEX "ix_TMP_20180508183242_C_1e11" ON "TMP_20180508183242_CODEGEN_AC4H" ("KEY")

-- Model deployment code

SELECT "Quantiles"."KEY" AS "KEY", "Quantiles"."Quantile" AS "Estimator" 
FROM "TMP_20180508183242_CODEGEN_AC4H" AS "Quantiles"