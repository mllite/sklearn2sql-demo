...
-- Code For temporary table ##TMP_20180516113512_CODEGEN_SEE0U6_Quantiles part 1. Create 


CREATE TABLE ##TMP_20180516113512_CODEGEN_SEE0U6_Quantiles (
	[KEY] BIGINT NULL, 
...
-- Code For temporary table ##TMP_20180516113512_CODEGEN_SEE0U6_Quantiles part 2. Populate
...
WHERE u1.[Estimator] >= u2.[Estimator] AND u1.[KEY] = u2.[KEY] GROUP BY u1.[KEY], u1.est_index, u1.[Estimator], u1.[Weight]) AS [CW])
 INSERT INTO ##TMP_20180516113512_CODEGEN_SEE0U6_Quantiles ([KEY], [Quantile]) SELECT [Quantiles].[KEY], [Quantiles].[Quantile] 
...
FROM ##TMP_20180516113512_CODEGEN_SEE0U6_Quantiles AS [Quantiles]