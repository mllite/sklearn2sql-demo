...
-- Code For temporary table TMP_20180516_CODEGEN_DNCRRN_QUA part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180516_CODEGEN_DNCRRN_QUA" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20180516_CODEGEN_DNCRRN_QUA part 2. Populate

INSERT INTO "TMP_20180516_CODEGEN_DNCRRN_QUA" ("KEY", "Quantile") SELECT "U"."KEY", "U"."Quantile" 
...
-- Code For temporary table TMP_20180516_CODEGEN_DNCRRN_QUA part 3. Create Index 

CREATE INDEX "ix_TMP_20180516_CODEGEN_59b7" ON "TMP_20180516_CODEGEN_DNCRRN_QUA" ("KEY")

-- Model deployment code

SELECT "Quantiles"."KEY" AS "KEY", "Quantiles"."Quantile" AS "Estimator" 
FROM "TMP_20180516_CODEGEN_DNCRRN_QUA" AS "Quantiles"