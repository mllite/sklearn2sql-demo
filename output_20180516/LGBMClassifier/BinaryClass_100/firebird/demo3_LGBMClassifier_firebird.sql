...
-- Code For temporary table TMP_20180602_WU3_LGBM_B0 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180602_WU3_LGBM_B0" (
	"KEY" BIGINT, 
...
-- Code For temporary table TMP_20180602_WU3_LGBM_B0 part 2. Populate

INSERT INTO "TMP_20180602_WU3_LGBM_B0" ("KEY", "Score_0") SELECT "U"."KEY", "U"."Score_0" 
...
FROM (SELECT 3 AS nid, 0.08181818181818183 AS "Score" FROM rdb$database UNION ALL SELECT 4 AS nid, -0.03043478260869564 AS "Score" FROM rdb$database UNION ALL SELECT 5 AS nid, -0.09999999999999999 AS "Score" FROM rdb$database) AS "Values"), 
"DT_Output" AS 
...
"DT_node_data_1" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE PRECISION) AS "Score" 
FROM (SELECT 3 AS nid, 0.07785970941192365 AS "Score" FROM rdb$database UNION ALL SELECT 4 AS nid, -0.028919854548823704 AS "Score" FROM rdb$database UNION ALL SELECT 5 AS nid, -0.09524187224606032 AS "Score" FROM rdb$database) AS "Values"), 
"DT_Output_1" AS 
...
"DT_node_data_2" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE PRECISION) AS "Score" 
FROM (SELECT 3 AS nid, 0.07432295598691702 AS "Score" FROM rdb$database UNION ALL SELECT 4 AS nid, -0.0274921214682807 AS "Score" FROM rdb$database UNION ALL SELECT 5 AS nid, -0.09113178077572359 AS "Score" FROM rdb$database) AS "Values"), 
"DT_Output_2" AS 
...
"DT_node_data_3" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE PRECISION) AS "Score" 
FROM (SELECT 3 AS nid, 0.07113620841455619 AS "Score" FROM rdb$database UNION ALL SELECT 4 AS nid, -0.02614440645343223 AS "Score" FROM rdb$database UNION ALL SELECT 5 AS nid, -0.08754910073915208 AS "Score" FROM rdb$database) AS "Values"), 
"DT_Output_3" AS 
...
"DT_node_data_4" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE PRECISION) AS "Score" 
FROM (SELECT 3 AS nid, 0.06459869004957046 AS "Score" FROM rdb$database UNION ALL SELECT 4 AS nid, -0.024763552746379 AS "Score" FROM rdb$database UNION ALL SELECT 5 AS nid, -0.08894052979112571 AS "Score" FROM rdb$database) AS "Values"), 
"DT_Output_4" AS 
...
-- Code For temporary table TMP_20180602_RN0_LGBM_B1 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180602_RN0_LGBM_B1" (
	"KEY" BIGINT, 
	"Score_0" DOUBLE PRECISION
)
...
-- Code For temporary table TMP_20180602_RN0_LGBM_B1 part 2. Populate

INSERT INTO "TMP_20180602_RN0_LGBM_B1" ("KEY", "Score_0") SELECT "U"."KEY", "U"."Score_0" 
...
"DT_node_data_5" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE PRECISION) AS "Score" 
FROM (SELECT 3 AS nid, 0.0657355331874627 AS "Score" FROM rdb$database UNION ALL SELECT 4 AS nid, -0.08699895614934877 AS "Score" FROM rdb$database UNION ALL SELECT 5 AS nid, -0.024924435827053032 AS "Score" FROM rdb$database) AS "Values"), 
"DT_Output_5" AS 
...
"DT_node_data_6" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE PRECISION) AS "Score" 
FROM (SELECT 3 AS nid, 0.0823479843071869 AS "Score" FROM rdb$database UNION ALL SELECT 4 AS nid, -0.011358622988871296 AS "Score" FROM rdb$database UNION ALL SELECT 5 AS nid, -0.08068312123593979 AS "Score" FROM rdb$database) AS "Values"), 
"DT_Output_6" AS 
...
"DT_node_data_7" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE PRECISION) AS "Score" 
FROM (SELECT 3 AS nid, 0.05794406614976366 AS "Score" FROM rdb$database UNION ALL SELECT 4 AS nid, -0.01910059898099636 AS "Score" FROM rdb$database UNION ALL SELECT 5 AS nid, -0.08243592993939444 AS "Score" FROM rdb$database) AS "Values"), 
"DT_Output_7" AS 
...
"DT_node_data_8" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE PRECISION) AS "Score" 
FROM (SELECT 3 AS nid, 0.07811377558076071 AS "Score" FROM rdb$database UNION ALL SELECT 4 AS nid, -0.07440223840763062 AS "Score" FROM rdb$database UNION ALL SELECT 5 AS nid, -0.006410822152913691 AS "Score" FROM rdb$database) AS "Values"), 
"DT_Output_8" AS 
...
"DT_node_data_9" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE PRECISION) AS "Score" 
FROM (SELECT 3 AS nid, 0.07600128757379401 AS "Score" FROM rdb$database UNION ALL SELECT 4 AS nid, -0.008448862260883665 AS "Score" FROM rdb$database UNION ALL SELECT 5 AS nid, -0.07587251310301008 AS "Score" FROM rdb$database) AS "Values"), 
"DT_Output_9" AS 
...
-- Code For temporary table TMP_20180602_5VV_LGBM_B2 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180602_5VV_LGBM_B2" (
	"KEY" BIGINT, 
	"Score_0" DOUBLE PRECISION
)
...
-- Code For temporary table TMP_20180602_5VV_LGBM_B2 part 2. Populate

INSERT INTO "TMP_20180602_5VV_LGBM_B2" ("KEY", "Score_0") SELECT "U"."KEY", "U"."Score_0" 
FROM (WITH "DT_node_lookup_10" AS 
(SELECT "ADS"."KEY" AS "KEY", CASE WHEN ("ADS"."Feature_57" <= -0.2067798577984605) THEN CASE WHEN ("ADS"."Feature_33" <= 0.20325693874805037) THEN 4 ELSE 5 END ELSE 3 END AS node_id_2 
FROM "BinaryClass_100" AS "ADS"), 
"DT_node_data_10" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE PRECISION) AS "Score" 
FROM (SELECT 3 AS nid, 0.053117278221128106 AS "Score" FROM rdb$database UNION ALL SELECT 4 AS nid, -0.014687938871197832 AS "Score" FROM rdb$database UNION ALL SELECT 5 AS nid, -0.07785403281397123 AS "Score" FROM rdb$database) AS "Values"), 
"DT_Output_10" AS 
...
"DT_node_data_11" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE PRECISION) AS "Score" 
FROM (SELECT 3 AS nid, 0.07285174128719608 AS "Score" FROM rdb$database UNION ALL SELECT 4 AS nid, -0.0703793816513677 AS "Score" FROM rdb$database UNION ALL SELECT 5 AS nid, -0.0030039051162096785 AS "Score" FROM rdb$database) AS "Values"), 
"DT_Output_11" AS 
...
"DT_node_data_12" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE PRECISION) AS "Score" 
FROM (SELECT 3 AS nid, 0.07124614965837597 AS "Score" FROM rdb$database UNION ALL SELECT 4 AS nid, -0.0059567913406479885 AS "Score" FROM rdb$database UNION ALL SELECT 5 AS nid, -0.07217794523350006 AS "Score" FROM rdb$database) AS "Values"), 
"DT_Output_12" AS 
...
"DT_node_data_13" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE PRECISION) AS "Score" 
FROM (SELECT 3 AS nid, 0.049136492733936415 AS "Score" FROM rdb$database UNION ALL SELECT 4 AS nid, -0.010819434344282008 AS "Score" FROM rdb$database UNION ALL SELECT 5 AS nid, -0.07430482101567583 AS "Score" FROM rdb$database) AS "Values"), 
"DT_Output_13" AS 
...
"DT_node_data_14" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE PRECISION) AS "Score" 
FROM (SELECT 3 AS nid, 0.06883643163561767 AS "Score" FROM rdb$database UNION ALL SELECT 4 AS nid, -0.06715003019821807 AS "Score" FROM rdb$database UNION ALL SELECT 5 AS nid, -2.985174807817525e-05 AS "Score" FROM rdb$database) AS "Values"), 
"DT_Output_14" AS 
...
-- Code For temporary table TMP_20180602_KX9_LGBM_B3 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180602_KX9_LGBM_B3" (
	"KEY" BIGINT, 
	"Score_0" DOUBLE PRECISION
)
...
-- Code For temporary table TMP_20180602_KX9_LGBM_B3 part 2. Populate

INSERT INTO "TMP_20180602_KX9_LGBM_B3" ("KEY", "Score_0") SELECT "U"."KEY", "U"."Score_0" 
...
"DT_node_data_15" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE PRECISION) AS "Score" 
FROM (SELECT 3 AS nid, 0.06758342181262621 AS "Score" FROM rdb$database UNION ALL SELECT 4 AS nid, 0.010001156735718013 AS "Score" FROM rdb$database UNION ALL SELECT 5 AS nid, -0.056401505595816886 AS "Score" FROM rdb$database) AS "Values"), 
"DT_Output_15" AS 
...
-- Code For temporary table TMP_20180602_WR7_LGBM_SUM part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180602_WR7_LGBM_SUM" (
	"KEY" BIGINT NOT NULL, 
	"Score_0" DOUBLE PRECISION, 
	PRIMARY KEY ("KEY")
)
...
-- Code For temporary table TMP_20180602_WR7_LGBM_SUM part 2. Populate

INSERT INTO "TMP_20180602_WR7_LGBM_SUM" ("KEY", "Score_0") SELECT "U"."KEY", "U"."Score_0" 
...
FROM "TMP_20180602_WU3_LGBM_B0" AS "LGBM_B0" UNION ALL SELECT "LGBM_B1"."KEY" AS "KEY", "LGBM_B1"."Score_0" AS "Score_0" 
FROM "TMP_20180602_RN0_LGBM_B1" AS "LGBM_B1" UNION ALL SELECT "LGBM_B2"."KEY" AS "KEY", "LGBM_B2"."Score_0" AS "Score_0" 
FROM "TMP_20180602_5VV_LGBM_B2" AS "LGBM_B2" UNION ALL SELECT "LGBM_B3"."KEY" AS "KEY", "LGBM_B3"."Score_0" AS "Score_0" 
FROM "TMP_20180602_KX9_LGBM_B3" AS "LGBM_B3") AS "LGBM_EnsembleUnion")
...
-- Code For temporary table TMP_20180602_WR7_LGBM_SUM part 3. Create Index 

CREATE INDEX "ix_TMP_20180602_WR7_LGB_2ef4" ON "TMP_20180602_WR7_LGBM_SUM" ("KEY")
...
FROM "TMP_20180602_WR7_LGBM_SUM" AS "LGBM_sum"), 
