...
-- Code For temporary table tmp_20180516111020_codegen_xg3r5a_lgbm_b0 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180516111020_codegen_xg3r5a_lgbm_b0  (
	"KEY" BIGINT, 
...
-- Code For temporary table tmp_20180516111020_codegen_xg3r5a_lgbm_b0 part 2. Populate

INSERT INTO tmp_20180516111020_codegen_xg3r5a_lgbm_b0 ("KEY", "Score_0") SELECT "U"."KEY", "U"."Score_0" 
...
-- Code For temporary table tmp_20180516111020_codegen_cc728t_lgbm_b1 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180516111020_codegen_cc728t_lgbm_b1  (
	"KEY" BIGINT, 
	"Score_0" DOUBLE PRECISION
)
...
-- Code For temporary table tmp_20180516111020_codegen_cc728t_lgbm_b1 part 2. Populate

INSERT INTO tmp_20180516111020_codegen_cc728t_lgbm_b1 ("KEY", "Score_0") SELECT "U"."KEY", "U"."Score_0" 
...
-- Code For temporary table tmp_20180516111021_codegen_ylt7nb_lgbm_sum part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180516111021_codegen_ylt7nb_lgbm_sum  (
	"KEY" BIGINT, 
	"Score_0" DOUBLE PRECISION
)
...
-- Code For temporary table tmp_20180516111021_codegen_ylt7nb_lgbm_sum part 2. Populate

INSERT INTO tmp_20180516111021_codegen_ylt7nb_lgbm_sum ("KEY", "Score_0") SELECT "U"."KEY", "U"."Score_0" 
...
FROM tmp_20180516111020_codegen_xg3r5a_lgbm_b0 AS "LGBM_B0" UNION ALL SELECT "LGBM_B1"."KEY" AS "KEY", "LGBM_B1"."Score_0" AS "Score_0" 
FROM tmp_20180516111020_codegen_cc728t_lgbm_b1 AS "LGBM_B1") AS "LGBM_EnsembleUnion")
...
FROM tmp_20180516111021_codegen_ylt7nb_lgbm_sum AS "LGBM_sum"), 
