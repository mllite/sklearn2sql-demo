...
-- Code For temporary table tmp_20180516111020_codegen_gyuy9j_lgbm_b0 part 1. Create 


CREATE TABLE tmp_20180516111020_codegen_gyuy9j_lgbm_b0 (
	`KEY` BIGINT, 
	`Score_0` DOUBLE
)
...
-- Code For temporary table tmp_20180516111020_codegen_gyuy9j_lgbm_b0 part 2. Populate
...
FROM `DT_Output_9`)
 INSERT INTO tmp_20180516111020_codegen_gyuy9j_lgbm_b0 (`KEY`, `Score_0`) SELECT `LGBM_B0`.`KEY`, `LGBM_B0`.`Score_0` 
...
-- Code For temporary table tmp_20180516111020_codegen_izika4_lgbm_b1 part 1. Create 


CREATE TABLE tmp_20180516111020_codegen_izika4_lgbm_b1 (
	`KEY` BIGINT, 
	`Score_0` DOUBLE
)
...
-- Code For temporary table tmp_20180516111020_codegen_izika4_lgbm_b1 part 2. Populate
...
FROM `DT_Output_15`)
 INSERT INTO tmp_20180516111020_codegen_izika4_lgbm_b1 (`KEY`, `Score_0`) SELECT `LGBM_B1`.`KEY`, `LGBM_B1`.`Score_0` 
...
-- Code For temporary table tmp_20180516111020_codegen_kgqw8l_lgbm_sum part 1. Create 


CREATE TABLE tmp_20180516111020_codegen_kgqw8l_lgbm_sum (
	`KEY` BIGINT, 
	`Score_0` DOUBLE
)
...
-- Code For temporary table tmp_20180516111020_codegen_kgqw8l_lgbm_sum part 2. Populate
...
FROM tmp_20180516111020_codegen_gyuy9j_lgbm_b0 AS `LGBM_B0` UNION ALL SELECT `LGBM_B1`.`KEY` AS `KEY`, `LGBM_B1`.`Score_0` AS `Score_0` 
FROM tmp_20180516111020_codegen_izika4_lgbm_b1 AS `LGBM_B1`) AS `LGBM_EnsembleUnion`)
 INSERT INTO tmp_20180516111020_codegen_kgqw8l_lgbm_sum (`KEY`, `Score_0`) SELECT `LGBM_sum`.`KEY`, `LGBM_sum`.`Score_0` 
...
FROM tmp_20180516111020_codegen_kgqw8l_lgbm_sum AS `LGBM_sum`), 
