...
-- Code For temporary table ##TMP_20180602141303_NEU_LGBM_B0 part 1. Create 


CREATE TABLE ##TMP_20180602141303_NEU_LGBM_B0 (
	[KEY] BIGINT NULL, 
...
-- Code For temporary table ##TMP_20180602141303_NEU_LGBM_B0 part 2. Populate
...
FROM [DT_Output_9])
 INSERT INTO ##TMP_20180602141303_NEU_LGBM_B0 ([KEY], [Score_0]) SELECT [LGBM_B0].[KEY], [LGBM_B0].[Score_0] 
...
-- Code For temporary table ##TMP_20180602141303_WQG_LGBM_B1 part 1. Create 


CREATE TABLE ##TMP_20180602141303_WQG_LGBM_B1 (
	[KEY] BIGINT NULL, 
	[Score_0] FLOAT(53) NULL
)
...
-- Code For temporary table ##TMP_20180602141303_WQG_LGBM_B1 part 2. Populate
...
FROM [DT_Output_15])
 INSERT INTO ##TMP_20180602141303_WQG_LGBM_B1 ([KEY], [Score_0]) SELECT [LGBM_B1].[KEY], [LGBM_B1].[Score_0] 
...
-- Code For temporary table ##TMP_20180602141303_FJG_LGBM_sum part 1. Create 


CREATE TABLE ##TMP_20180602141303_FJG_LGBM_sum (
	[KEY] BIGINT NULL, 
	[Score_0] FLOAT(53) NULL
)
...
-- Code For temporary table ##TMP_20180602141303_FJG_LGBM_sum part 2. Populate
...
FROM ##TMP_20180602141303_NEU_LGBM_B0 AS [LGBM_B0] UNION ALL SELECT [LGBM_B1].[KEY] AS [KEY], [LGBM_B1].[Score_0] AS [Score_0] 
FROM ##TMP_20180602141303_WQG_LGBM_B1 AS [LGBM_B1]) AS [LGBM_EnsembleUnion])
 INSERT INTO ##TMP_20180602141303_FJG_LGBM_sum ([KEY], [Score_0]) SELECT [LGBM_sum].[KEY], [LGBM_sum].[Score_0] 
...
FROM ##TMP_20180602141303_FJG_LGBM_sum AS [LGBM_sum]), 
