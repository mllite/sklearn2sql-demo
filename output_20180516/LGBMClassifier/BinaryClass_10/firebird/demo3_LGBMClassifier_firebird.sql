...
-- Code For temporary table TMP_20180508175843_CODEGEN_WUPN part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508175843_CODEGEN_WUPN" (
	"KEY" BIGINT, 
...
-- Code For temporary table TMP_20180508175843_CODEGEN_WUPN part 2. Populate

INSERT INTO "TMP_20180508175843_CODEGEN_WUPN" ("KEY", "Score_0") SELECT "U"."KEY", "U"."Score_0" 
...
-- Code For temporary table TMP_20180508175843_CODEGEN_WLMJ part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508175843_CODEGEN_WLMJ" (
	"KEY" BIGINT, 
	"Score_0" DOUBLE PRECISION
)
...
-- Code For temporary table TMP_20180508175843_CODEGEN_WLMJ part 2. Populate

INSERT INTO "TMP_20180508175843_CODEGEN_WLMJ" ("KEY", "Score_0") SELECT "U"."KEY", "U"."Score_0" 
...
-- Code For temporary table TMP_20180508175843_CODEGEN_FVTT part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508175843_CODEGEN_FVTT" (
	"KEY" BIGINT, 
	"Score_0" DOUBLE PRECISION
)
...
-- Code For temporary table TMP_20180508175843_CODEGEN_FVTT part 2. Populate

INSERT INTO "TMP_20180508175843_CODEGEN_FVTT" ("KEY", "Score_0") SELECT "U"."KEY", "U"."Score_0" 
...
FROM "TMP_20180508175843_CODEGEN_WUPN" AS "LGBM_B0" UNION ALL SELECT "LGBM_B1"."KEY" AS "KEY", "LGBM_B1"."Score_0" AS "Score_0" 
FROM "TMP_20180508175843_CODEGEN_WLMJ" AS "LGBM_B1") AS "LGBM_EnsembleUnion") AS "LGBM_Union") AS "U"

-- Code For temporary table TMP_20180508175843_CODEGEN_C834 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508175843_CODEGEN_C834" (
	"KEY" BIGINT NOT NULL, 
	"Score_0" DOUBLE PRECISION, 
	PRIMARY KEY ("KEY")
)
...
-- Code For temporary table TMP_20180508175843_CODEGEN_C834 part 2. Populate

INSERT INTO "TMP_20180508175843_CODEGEN_C834" ("KEY", "Score_0") SELECT "U"."KEY", "U"."Score_0" 
...
FROM "TMP_20180508175843_CODEGEN_FVTT" AS "LGBM_Union" GROUP BY "LGBM_Union"."KEY") AS "T") AS "LGBM_sum") AS "U"

-- Code For temporary table TMP_20180508175843_CODEGEN_C834 part 3. Create Index 

CREATE INDEX "ix_TMP_20180508175843_C_4a7a" ON "TMP_20180508175843_CODEGEN_C834" ("KEY")
...
FROM "TMP_20180508175843_CODEGEN_C834" AS "LGBM_sum"), 
