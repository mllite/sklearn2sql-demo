...
-- Code For temporary table TMP_20180516_CODEGEN_BNN3XZ_LGB part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180516_CODEGEN_BNN3XZ_LGB" (
	"KEY" BIGINT, 
...
-- Code For temporary table TMP_20180516_CODEGEN_BNN3XZ_LGB part 2. Populate

INSERT INTO "TMP_20180516_CODEGEN_BNN3XZ_LGB" ("KEY", "Score_0") SELECT "U"."KEY", "U"."Score_0" 
...
-- Code For temporary table TMP_20180516_CODEGEN_K0FLRA_LGB part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180516_CODEGEN_K0FLRA_LGB" (
	"KEY" BIGINT, 
	"Score_0" DOUBLE PRECISION
)
...
-- Code For temporary table TMP_20180516_CODEGEN_K0FLRA_LGB part 2. Populate

INSERT INTO "TMP_20180516_CODEGEN_K0FLRA_LGB" ("KEY", "Score_0") SELECT "U"."KEY", "U"."Score_0" 
...
-- Code For temporary table TMP_20180516_CODEGEN_Q2GCAD_LGB part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180516_CODEGEN_Q2GCAD_LGB" (
	"KEY" BIGINT NOT NULL, 
	"Score_0" DOUBLE PRECISION, 
	PRIMARY KEY ("KEY")
)
...
-- Code For temporary table TMP_20180516_CODEGEN_Q2GCAD_LGB part 2. Populate

INSERT INTO "TMP_20180516_CODEGEN_Q2GCAD_LGB" ("KEY", "Score_0") SELECT "U"."KEY", "U"."Score_0" 
...
FROM "TMP_20180516_CODEGEN_BNN3XZ_LGB" AS "LGBM_B0" UNION ALL SELECT "LGBM_B1"."KEY" AS "KEY", "LGBM_B1"."Score_0" AS "Score_0" 
FROM "TMP_20180516_CODEGEN_K0FLRA_LGB" AS "LGBM_B1") AS "LGBM_EnsembleUnion")
...
-- Code For temporary table TMP_20180516_CODEGEN_Q2GCAD_LGB part 3. Create Index 

CREATE INDEX "ix_TMP_20180516_CODEGEN_81d2" ON "TMP_20180516_CODEGEN_Q2GCAD_LGB" ("KEY")
...
FROM "TMP_20180516_CODEGEN_Q2GCAD_LGB" AS "LGBM_sum"), 
