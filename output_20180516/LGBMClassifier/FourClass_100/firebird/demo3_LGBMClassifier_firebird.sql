...
-- Code For temporary table TMP_20180602_3WY_LGBM_B0 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180602_3WY_LGBM_B0" (
	"KEY" BIGINT, 
...
-- Code For temporary table TMP_20180602_3WY_LGBM_B0 part 2. Populate

INSERT INTO "TMP_20180602_3WY_LGBM_B0" ("KEY", "Score_0", "Score_1", "Score_2", "Score_3") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1", "U"."Score_2", "U"."Score_3" 
...
"DT_node_data_1" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE PRECISION) AS "Score" 
FROM (SELECT 3 AS nid, 0.03650793650793651 AS "Score" FROM rdb$database UNION ALL SELECT 4 AS nid, -0.029629629629629624 AS "Score" FROM rdb$database UNION ALL SELECT 5 AS nid, 0.011111111111111112 AS "Score" FROM rdb$database) AS "Values"), 
"DT_Output_1" AS 
...
"DT_node_data_3" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE PRECISION) AS "Score" 
FROM (SELECT 3 AS nid, 0.029411764705882356 AS "Score" FROM rdb$database UNION ALL SELECT 5 AS nid, 0.011111111111111112 AS "Score" FROM rdb$database UNION ALL SELECT 8 AS nid, -0.03333333333333333 AS "Score" FROM rdb$database UNION ALL SELECT 9 AS nid, -0.026666666666666658 AS "Score" FROM rdb$database) AS "Values"), 
"DT_Output_3" AS 
...
"DT_node_data_4" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE PRECISION) AS "Score" 
FROM (SELECT 4 AS nid, -0.03313063553280779 AS "Score" FROM rdb$database UNION ALL SELECT 5 AS nid, -0.01946848263570873 AS "Score" FROM rdb$database UNION ALL SELECT 6 AS nid, 0.047804315466060794 AS "Score" FROM rdb$database UNION ALL SELECT 7 AS nid, -0.009420358924095377 AS "Score" FROM rdb$database) AS "Values"), 
"DT_Output_4" AS 
...
-- Code For temporary table TMP_20180602_ZYL_LGBM_B1 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180602_ZYL_LGBM_B1" (
	"KEY" BIGINT, 
	"Score_0" DOUBLE PRECISION, 
	"Score_1" DOUBLE PRECISION, 
	"Score_2" DOUBLE PRECISION, 
...
-- Code For temporary table TMP_20180602_ZYL_LGBM_B1 part 2. Populate

INSERT INTO "TMP_20180602_ZYL_LGBM_B1" ("KEY", "Score_0", "Score_1", "Score_2", "Score_3") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1", "U"."Score_2", "U"."Score_3" 
...
"DT_node_data_5" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE PRECISION) AS "Score" 
FROM (SELECT 2 AS nid, -0.022128639596904157 AS "Score" FROM rdb$database UNION ALL SELECT 6 AS nid, -0.015893056286332665 AS "Score" FROM rdb$database UNION ALL SELECT 7 AS nid, 0.0345887724914825 AS "Score" FROM rdb$database) AS "Values"), 
"DT_Output_5" AS 
...
"DT_node_data_6" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE PRECISION) AS "Score" 
FROM (SELECT 2 AS nid, 0.04636141762033609 AS "Score" FROM rdb$database UNION ALL SELECT 6 AS nid, 0.003476123535636002 AS "Score" FROM rdb$database UNION ALL SELECT 14 AS nid, -0.033194492304747726 AS "Score" FROM rdb$database UNION ALL SELECT 15 AS nid, -0.02637792754897038 AS "Score" FROM rdb$database) AS "Values"), 
"DT_Output_6" AS 
...
"DT_node_data_7" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE PRECISION) AS "Score" 
FROM (SELECT 3 AS nid, 0.028003031542196462 AS "Score" FROM rdb$database UNION ALL SELECT 5 AS nid, 0.01079504463896921 AS "Score" FROM rdb$database UNION ALL SELECT 8 AS nid, -0.033088509370357636 AS "Score" FROM rdb$database UNION ALL SELECT 9 AS nid, -0.026180098946625176 AS "Score" FROM rdb$database) AS "Values"), 
"DT_Output_7" AS 
...
"DT_node_data_8" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE PRECISION) AS "Score" 
FROM (SELECT 4 AS nid, -0.03287520880453387 AS "Score" FROM rdb$database UNION ALL SELECT 5 AS nid, -0.01906076855194895 AS "Score" FROM rdb$database UNION ALL SELECT 6 AS nid, 0.04545856342972875 AS "Score" FROM rdb$database UNION ALL SELECT 7 AS nid, -0.009273675005948893 AS "Score" FROM rdb$database) AS "Values"), 
"DT_Output_8" AS 
...
"DT_node_data_9" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE PRECISION) AS "Score" 
FROM (SELECT 2 AS nid, -0.02178747452531658 AS "Score" FROM rdb$database UNION ALL SELECT 6 AS nid, -0.015633550083858402 AS "Score" FROM rdb$database UNION ALL SELECT 7 AS nid, 0.033049943031577045 AS "Score" FROM rdb$database) AS "Values"), 
"DT_Output_9" AS 
...
-- Code For temporary table TMP_20180602_Z8H_LGBM_B2 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180602_Z8H_LGBM_B2" (
	"KEY" BIGINT, 
	"Score_0" DOUBLE PRECISION, 
	"Score_1" DOUBLE PRECISION, 
	"Score_2" DOUBLE PRECISION, 
...
-- Code For temporary table TMP_20180602_Z8H_LGBM_B2 part 2. Populate

INSERT INTO "TMP_20180602_Z8H_LGBM_B2" ("KEY", "Score_0", "Score_1", "Score_2", "Score_3") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1", "U"."Score_2", "U"."Score_3" 
...
"DT_node_data_10" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE PRECISION) AS "Score" 
FROM (SELECT 2 AS nid, 0.04360801790387012 AS "Score" FROM rdb$database UNION ALL SELECT 6 AS nid, 0.0035015579681582604 AS "Score" FROM rdb$database UNION ALL SELECT 14 AS nid, -0.03300552597103637 AS "Score" FROM rdb$database UNION ALL SELECT 15 AS nid, -0.025838525249519323 AS "Score" FROM rdb$database) AS "Values"), 
"DT_Output_10" AS 
...
"DT_node_data_11" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE PRECISION) AS "Score" 
FROM (SELECT 3 AS nid, 0.026913095344054363 AS "Score" FROM rdb$database UNION ALL SELECT 5 AS nid, 0.010570565651572383 AS "Score" FROM rdb$database UNION ALL SELECT 8 AS nid, -0.032849963703901496 AS "Score" FROM rdb$database UNION ALL SELECT 9 AS nid, -0.025852211069869586 AS "Score" FROM rdb$database) AS "Values"), 
"DT_Output_11" AS 
...
"DT_node_data_12" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE PRECISION) AS "Score" 
FROM (SELECT 4 AS nid, -0.032684808451172685 AS "Score" FROM rdb$database UNION ALL SELECT 5 AS nid, -0.018618045271835994 AS "Score" FROM rdb$database UNION ALL SELECT 6 AS nid, 0.05093382457055347 AS "Score" FROM rdb$database UNION ALL SELECT 7 AS nid, -0.001825864611335437 AS "Score" FROM rdb$database) AS "Values"), 
"DT_Output_12" AS 
...
"DT_node_data_13" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE PRECISION) AS "Score" 
FROM (SELECT 2 AS nid, -0.019739700134328863 AS "Score" FROM rdb$database UNION ALL SELECT 6 AS nid, -0.017278321105260622 AS "Score" FROM rdb$database UNION ALL SELECT 7 AS nid, 0.04203931593676188 AS "Score" FROM rdb$database) AS "Values"), 
"DT_Output_13" AS 
...
"DT_node_data_14" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE PRECISION) AS "Score" 
FROM (SELECT 4 AS nid, 0.06191570427359305 AS "Score" FROM rdb$database UNION ALL SELECT 5 AS nid, -0.009999292279124383 AS "Score" FROM rdb$database UNION ALL SELECT 6 AS nid, -0.03302648754228732 AS "Score" FROM rdb$database UNION ALL SELECT 7 AS nid, -0.019040024937333734 AS "Score" FROM rdb$database) AS "Values"), 
"DT_Output_14" AS 
...
-- Code For temporary table TMP_20180602_35E_LGBM_B3 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180602_35E_LGBM_B3" (
	"KEY" BIGINT, 
	"Score_0" DOUBLE PRECISION, 
	"Score_1" DOUBLE PRECISION, 
	"Score_2" DOUBLE PRECISION, 
...
-- Code For temporary table TMP_20180602_35E_LGBM_B3 part 2. Populate

INSERT INTO "TMP_20180602_35E_LGBM_B3" ("KEY", "Score_0", "Score_1", "Score_2", "Score_3") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1", "U"."Score_2", "U"."Score_3" 
...
"DT_node_data_15" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE PRECISION) AS "Score" 
FROM (SELECT 3 AS nid, 0.025816647222964468 AS "Score" FROM rdb$database UNION ALL SELECT 5 AS nid, 0.010300746326886004 AS "Score" FROM rdb$database UNION ALL SELECT 8 AS nid, -0.025475061036103065 AS "Score" FROM rdb$database UNION ALL SELECT 9 AS nid, -0.032620728414891755 AS "Score" FROM rdb$database) AS "Values"), 
"DT_Output_15" AS 
...
"DT_node_data_16" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE PRECISION) AS "Score" 
FROM (SELECT 4 AS nid, -0.032454311425163467 AS "Score" FROM rdb$database UNION ALL SELECT 5 AS nid, -0.018229419771509586 AS "Score" FROM rdb$database UNION ALL SELECT 6 AS nid, 0.042094042637813286 AS "Score" FROM rdb$database UNION ALL SELECT 7 AS nid, -0.009318732833803071 AS "Score" FROM rdb$database) AS "Values"), 
"DT_Output_16" AS 
...
"DT_node_data_17" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE PRECISION) AS "Score" 
FROM (SELECT 2 AS nid, -0.021439641313832667 AS "Score" FROM rdb$database UNION ALL SELECT 6 AS nid, -0.015132622012674813 AS "Score" FROM rdb$database UNION ALL SELECT 7 AS nid, 0.031131713533316355 AS "Score" FROM rdb$database) AS "Values"), 
"DT_Output_17" AS 
...
"DT_node_data_18" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE PRECISION) AS "Score" 
FROM (SELECT 4 AS nid, 0.05827580382821741 AS "Score" FROM rdb$database UNION ALL SELECT 5 AS nid, -0.009780366631463998 AS "Score" FROM rdb$database UNION ALL SELECT 6 AS nid, -0.03275225339711492 AS "Score" FROM rdb$database UNION ALL SELECT 7 AS nid, -0.01862315826988625 AS "Score" FROM rdb$database) AS "Values"), 
"DT_Output_18" AS 
...
"DT_node_data_19" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE PRECISION) AS "Score" 
FROM (SELECT 3 AS nid, 0.024639950969252696 AS "Score" FROM rdb$database UNION ALL SELECT 4 AS nid, -0.033050079810788155 AS "Score" FROM rdb$database UNION ALL SELECT 5 AS nid, 0.004645795769421992 AS "Score" FROM rdb$database) AS "Values"), 
"DT_Output_19" AS 
...
-- Code For temporary table TMP_20180602_MCQ_LGBM_B4 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180602_MCQ_LGBM_B4" (
	"KEY" BIGINT, 
	"Score_0" DOUBLE PRECISION, 
	"Score_1" DOUBLE PRECISION, 
	"Score_2" DOUBLE PRECISION, 
...
-- Code For temporary table TMP_20180602_MCQ_LGBM_B4 part 2. Populate

INSERT INTO "TMP_20180602_MCQ_LGBM_B4" ("KEY", "Score_0", "Score_1", "Score_2", "Score_3") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1", "U"."Score_2", "U"."Score_3" 
...
"DT_node_data_20" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE PRECISION) AS "Score" 
FROM (SELECT 4 AS nid, -0.03221493187703384 AS "Score" FROM rdb$database UNION ALL SELECT 5 AS nid, -0.017833970729870325 AS "Score" FROM rdb$database UNION ALL SELECT 6 AS nid, 0.046626139964803075 AS "Score" FROM rdb$database UNION ALL SELECT 7 AS nid, -0.0023916773247177805 AS "Score" FROM rdb$database) AS "Values"), 
"DT_Output_20" AS 
...
"DT_node_data_21" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE PRECISION) AS "Score" 
FROM (SELECT 2 AS nid, -0.019483975036855686 AS "Score" FROM rdb$database UNION ALL SELECT 6 AS nid, -0.016712457368410757 AS "Score" FROM rdb$database UNION ALL SELECT 7 AS nid, 0.039571142114960475 AS "Score" FROM rdb$database) AS "Values"), 
"DT_Output_21" AS 
...
"DT_node_data_22" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE PRECISION) AS "Score" 
FROM (SELECT 4 AS nid, 0.054919609031753996 AS "Score" FROM rdb$database UNION ALL SELECT 5 AS nid, -0.009537117515715366 AS "Score" FROM rdb$database UNION ALL SELECT 6 AS nid, -0.03251451021759937 AS "Score" FROM rdb$database UNION ALL SELECT 7 AS nid, -0.018188600220801203 AS "Score" FROM rdb$database) AS "Values"), 
"DT_Output_22" AS 
...
"DT_node_data_23" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE PRECISION) AS "Score" 
FROM (SELECT 3 AS nid, 0.02450432910475498 AS "Score" FROM rdb$database UNION ALL SELECT 5 AS nid, 0.00964162547669311 AS "Score" FROM rdb$database UNION ALL SELECT 8 AS nid, -0.032284694842014114 AS "Score" FROM rdb$database UNION ALL SELECT 9 AS nid, -0.024966600051597485 AS "Score" FROM rdb$database) AS "Values"), 
"DT_Output_23" AS 
...
"DT_node_data_24" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE PRECISION) AS "Score" 
FROM (SELECT 4 AS nid, -0.03202806863948834 AS "Score" FROM rdb$database UNION ALL SELECT 5 AS nid, -0.017403475194407575 AS "Score" FROM rdb$database UNION ALL SELECT 6 AS nid, 0.04549795287383693 AS "Score" FROM rdb$database UNION ALL SELECT 7 AS nid, -0.002418527389501781 AS "Score" FROM rdb$database) AS "Values"), 
"DT_Output_24" AS 
...
-- Code For temporary table TMP_20180602_B9H_LGBM_B5 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180602_B9H_LGBM_B5" (
	"KEY" BIGINT, 
	"Score_0" DOUBLE PRECISION, 
	"Score_1" DOUBLE PRECISION, 
	"Score_2" DOUBLE PRECISION, 
...
-- Code For temporary table TMP_20180602_B9H_LGBM_B5 part 2. Populate

INSERT INTO "TMP_20180602_B9H_LGBM_B5" ("KEY", "Score_0", "Score_1", "Score_2", "Score_3") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1", "U"."Score_2", "U"."Score_3" 
...
"DT_node_data_25" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE PRECISION) AS "Score" 
FROM (SELECT 2 AS nid, -0.02106707307433997 AS "Score" FROM rdb$database UNION ALL SELECT 6 AS nid, -0.009952380968756305 AS "Score" FROM rdb$database UNION ALL SELECT 7 AS nid, 0.03343269388429669 AS "Score" FROM rdb$database) AS "Values"), 
"DT_Output_25" AS 
...
"DT_node_data_26" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE PRECISION) AS "Score" 
FROM (SELECT 4 AS nid, 0.052049297103973484 AS "Score" FROM rdb$database UNION ALL SELECT 5 AS nid, -0.009289285381449438 AS "Score" FROM rdb$database UNION ALL SELECT 6 AS nid, -0.032283273512473974 AS "Score" FROM rdb$database UNION ALL SELECT 7 AS nid, -0.017801894864082766 AS "Score" FROM rdb$database) AS "Values"), 
"DT_Output_26" AS 
...
"DT_node_data_27" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE PRECISION) AS "Score" 
FROM (SELECT 3 AS nid, 0.023413302403993717 AS "Score" FROM rdb$database UNION ALL SELECT 4 AS nid, -0.03276393961108908 AS "Score" FROM rdb$database UNION ALL SELECT 5 AS nid, 0.00453305534977227 AS "Score" FROM rdb$database) AS "Values"), 
"DT_Output_27" AS 
...
"DT_node_data_28" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE PRECISION) AS "Score" 
FROM (SELECT 4 AS nid, -0.03181121954523248 AS "Score" FROM rdb$database UNION ALL SELECT 5 AS nid, -0.016980919100307 AS "Score" FROM rdb$database UNION ALL SELECT 6 AS nid, 0.037738102225264525 AS "Score" FROM rdb$database UNION ALL SELECT 7 AS nid, -0.009554268448184975 AS "Score" FROM rdb$database) AS "Values"), 
"DT_Output_28" AS 
...
"DT_node_data_29" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE PRECISION) AS "Score" 
FROM (SELECT 2 AS nid, -0.01910302277622988 AS "Score" FROM rdb$database UNION ALL SELECT 6 AS nid, -0.016466012794777243 AS "Score" FROM rdb$database UNION ALL SELECT 7 AS nid, 0.037609417765843145 AS "Score" FROM rdb$database) AS "Values"), 
"DT_Output_29" AS 
...
-- Code For temporary table TMP_20180602_6MP_LGBM_B6 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180602_6MP_LGBM_B6" (
	"KEY" BIGINT, 
	"Score_0" DOUBLE PRECISION, 
	"Score_1" DOUBLE PRECISION, 
	"Score_2" DOUBLE PRECISION, 
...
-- Code For temporary table TMP_20180602_6MP_LGBM_B6 part 2. Populate

INSERT INTO "TMP_20180602_6MP_LGBM_B6" ("KEY", "Score_0", "Score_1", "Score_2", "Score_3") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1", "U"."Score_2", "U"."Score_3" 
FROM (WITH "DT_node_lookup_30" AS 
(SELECT "ADS"."KEY" AS "KEY", CASE WHEN ("ADS"."Feature_56" <= 1.0000000180025095e-35) THEN CASE WHEN ("ADS"."Feature_54" <= 0.06279759359864408) THEN 4 ELSE 5 END ELSE CASE WHEN ("ADS"."Feature_31" <= 0.13931694912793788) THEN 6 ELSE 7 END END AS node_id_2 
FROM "FourClass_100" AS "ADS"), 
"DT_node_data_30" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE PRECISION) AS "Score" 
FROM (SELECT 4 AS nid, 0.04949398836810423 AS "Score" FROM rdb$database UNION ALL SELECT 5 AS nid, -0.009119718008998242 AS "Score" FROM rdb$database UNION ALL SELECT 6 AS nid, -0.032045899768456176 AS "Score" FROM rdb$database UNION ALL SELECT 7 AS nid, -0.01739712709303484 AS "Score" FROM rdb$database) AS "Values"), 
"DT_Output_30" AS 
...
"DT_node_data_31" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE PRECISION) AS "Score" 
FROM (SELECT 3 AS nid, 0.02322068934185108 AS "Score" FROM rdb$database UNION ALL SELECT 5 AS nid, 0.008983044952694008 AS "Score" FROM rdb$database UNION ALL SELECT 8 AS nid, -0.024485043709704547 AS "Score" FROM rdb$database UNION ALL SELECT 9 AS nid, -0.032180098460626104 AS "Score" FROM rdb$database) AS "Values"), 
"DT_Output_31" AS 
...
"DT_node_data_32" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE PRECISION) AS "Score" 
FROM (SELECT 4 AS nid, -0.03165306350454603 AS "Score" FROM rdb$database UNION ALL SELECT 5 AS nid, -0.016547956775647025 AS "Score" FROM rdb$database UNION ALL SELECT 6 AS nid, 0.04236424125283683 AS "Score" FROM rdb$database UNION ALL SELECT 7 AS nid, -0.003157749543253159 AS "Score" FROM rdb$database) AS "Values"), 
"DT_Output_32" AS 
...
"DT_node_data_33" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE PRECISION) AS "Score" 
FROM (SELECT 2 AS nid, -0.020713915285661487 AS "Score" FROM rdb$database UNION ALL SELECT 6 AS nid, -0.009585105918352885 AS "Score" FROM rdb$database UNION ALL SELECT 7 AS nid, 0.031581906969078685 AS "Score" FROM rdb$database) AS "Values"), 
"DT_Output_33" AS 
...
"DT_node_data_34" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE PRECISION) AS "Score" 
FROM (SELECT 2 AS nid, 0.03017514405834248 AS "Score" FROM rdb$database UNION ALL SELECT 6 AS nid, 0.006352547776770669 AS "Score" FROM rdb$database UNION ALL SELECT 14 AS nid, -0.0324511858268773 AS "Score" FROM rdb$database UNION ALL SELECT 15 AS nid, -0.02452530361619239 AS "Score" FROM rdb$database) AS "Values"), 
"DT_Output_34" AS 
...
-- Code For temporary table TMP_20180602_6DS_LGBM_B7 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180602_6DS_LGBM_B7" (
	"KEY" BIGINT, 
	"Score_0" DOUBLE PRECISION, 
	"Score_1" DOUBLE PRECISION, 
	"Score_2" DOUBLE PRECISION, 
...
-- Code For temporary table TMP_20180602_6DS_LGBM_B7 part 2. Populate

INSERT INTO "TMP_20180602_6DS_LGBM_B7" ("KEY", "Score_0", "Score_1", "Score_2", "Score_3") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1", "U"."Score_2", "U"."Score_3" 
...
"DT_node_data_35" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE PRECISION) AS "Score" 
FROM (SELECT 3 AS nid, 0.024166152588972728 AS "Score" FROM rdb$database UNION ALL SELECT 4 AS nid, -0.0326080426583267 AS "Score" FROM rdb$database UNION ALL SELECT 5 AS nid, 0.005762947554013325 AS "Score" FROM rdb$database) AS "Values"), 
"DT_Output_35" AS 
...
"DT_node_data_36" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE PRECISION) AS "Score" 
FROM (SELECT 4 AS nid, -0.03164999205960671 AS "Score" FROM rdb$database UNION ALL SELECT 5 AS nid, -0.016392063361358955 AS "Score" FROM rdb$database UNION ALL SELECT 6 AS nid, 0.04120937358074544 AS "Score" FROM rdb$database UNION ALL SELECT 7 AS nid, -0.0033596605580659016 AS "Score" FROM rdb$database) AS "Values"), 
"DT_Output_36" AS 
...
"DT_node_data_37" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE PRECISION) AS "Score" 
FROM (SELECT 2 AS nid, -0.01878183139443156 AS "Score" FROM rdb$database UNION ALL SELECT 6 AS nid, -0.016196255867969796 AS "Score" FROM rdb$database UNION ALL SELECT 7 AS nid, 0.03586818215214132 AS "Score" FROM rdb$database) AS "Values"), 
"DT_Output_37" AS 
...
"DT_node_data_38" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE PRECISION) AS "Score" 
FROM (SELECT 4 AS nid, 0.04627923093739975 AS "Score" FROM rdb$database UNION ALL SELECT 5 AS nid, -0.008709642902596513 AS "Score" FROM rdb$database UNION ALL SELECT 6 AS nid, -0.016897815597492767 AS "Score" FROM rdb$database UNION ALL SELECT 7 AS nid, -0.031788838443800864 AS "Score" FROM rdb$database) AS "Values"), 
"DT_Output_38" AS 
...
"DT_node_data_39" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE PRECISION) AS "Score" 
FROM (SELECT 4 AS nid, -0.015709967043262548 AS "Score" FROM rdb$database UNION ALL SELECT 5 AS nid, 0.0452239386252669 AS "Score" FROM rdb$database UNION ALL SELECT 6 AS nid, -0.033011237352626614 AS "Score" FROM rdb$database UNION ALL SELECT 7 AS nid, 0.0020836138648107918 AS "Score" FROM rdb$database) AS "Values"), 
"DT_Output_39" AS 
...
-- Code For temporary table TMP_20180602_FFO_LGBM_B8 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180602_FFO_LGBM_B8" (
	"KEY" BIGINT, 
	"Score_0" DOUBLE PRECISION, 
	"Score_1" DOUBLE PRECISION, 
	"Score_2" DOUBLE PRECISION, 
...
-- Code For temporary table TMP_20180602_FFO_LGBM_B8 part 2. Populate

INSERT INTO "TMP_20180602_FFO_LGBM_B8" ("KEY", "Score_0", "Score_1", "Score_2", "Score_3") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1", "U"."Score_2", "U"."Score_3" 
...
"DT_node_data_40" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE PRECISION) AS "Score" 
FROM (SELECT 4 AS nid, -0.03147096462543096 AS "Score" FROM rdb$database UNION ALL SELECT 5 AS nid, -0.015993678712197503 AS "Score" FROM rdb$database UNION ALL SELECT 6 AS nid, 0.040092705880045106 AS "Score" FROM rdb$database UNION ALL SELECT 7 AS nid, -0.003171039143636197 AS "Score" FROM rdb$database) AS "Values"), 
"DT_Output_40" AS 
...
"DT_node_data_41" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE PRECISION) AS "Score" 
FROM (SELECT 2 AS nid, -0.027064522737017527 AS "Score" FROM rdb$database UNION ALL SELECT 6 AS nid, -0.018253839394485372 AS "Score" FROM rdb$database UNION ALL SELECT 14 AS nid, 0.05731886506700709 AS "Score" FROM rdb$database UNION ALL SELECT 15 AS nid, -0.003891482566906324 AS "Score" FROM rdb$database) AS "Values"), 
"DT_Output_41" AS 
...
"DT_node_data_42" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE PRECISION) AS "Score" 
FROM (SELECT 4 AS nid, 0.044294881010899026 AS "Score" FROM rdb$database UNION ALL SELECT 5 AS nid, -0.008547712988689296 AS "Score" FROM rdb$database UNION ALL SELECT 6 AS nid, -0.03157628983612648 AS "Score" FROM rdb$database UNION ALL SELECT 7 AS nid, -0.0164619985924043 AS "Score" FROM rdb$database) AS "Values"), 
"DT_Output_42" AS 
...
"DT_node_data_43" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE PRECISION) AS "Score" 
FROM (SELECT 3 AS nid, 0.023054934767692613 AS "Score" FROM rdb$database UNION ALL SELECT 4 AS nid, -0.03257268736961252 AS "Score" FROM rdb$database UNION ALL SELECT 5 AS nid, 0.005531006469982258 AS "Score" FROM rdb$database) AS "Values"), 
"DT_Output_43" AS 
...
"DT_node_data_44" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE PRECISION) AS "Score" 
FROM (SELECT 4 AS nid, -0.03115008667894111 AS "Score" FROM rdb$database UNION ALL SELECT 5 AS nid, -0.015259237029207375 AS "Score" FROM rdb$database UNION ALL SELECT 6 AS nid, 0.038651455766307866 AS "Score" FROM rdb$database UNION ALL SELECT 7 AS nid, -0.003681803587735102 AS "Score" FROM rdb$database) AS "Values"), 
"DT_Output_44" AS 
...
-- Code For temporary table TMP_20180602_HHY_LGBM_B9 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180602_HHY_LGBM_B9" (
	"KEY" BIGINT, 
	"Score_0" DOUBLE PRECISION, 
	"Score_1" DOUBLE PRECISION, 
	"Score_2" DOUBLE PRECISION, 
...
-- Code For temporary table TMP_20180602_HHY_LGBM_B9 part 2. Populate

INSERT INTO "TMP_20180602_HHY_LGBM_B9" ("KEY", "Score_0", "Score_1", "Score_2", "Score_3") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1", "U"."Score_2", "U"."Score_3" 
...
"DT_node_data_45" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE PRECISION) AS "Score" 
FROM (SELECT 4 AS nid, 0.00028711338106361916 AS "Score" FROM rdb$database UNION ALL SELECT 5 AS nid, -0.032883857648840074 AS "Score" FROM rdb$database UNION ALL SELECT 6 AS nid, -0.013317225696533498 AS "Score" FROM rdb$database UNION ALL SELECT 7 AS nid, 0.030077361589194565 AS "Score" FROM rdb$database) AS "Values"), 
"DT_Output_45" AS 
...
"DT_node_data_46" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE PRECISION) AS "Score" 
FROM (SELECT 4 AS nid, 0.042452088090889566 AS "Score" FROM rdb$database UNION ALL SELECT 5 AS nid, -0.008315490911617558 AS "Score" FROM rdb$database UNION ALL SELECT 6 AS nid, -0.0314097908302536 AS "Score" FROM rdb$database UNION ALL SELECT 7 AS nid, -0.016081151403619518 AS "Score" FROM rdb$database) AS "Values"), 
"DT_Output_46" AS 
...
"DT_node_data_47" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE PRECISION) AS "Score" 
FROM (SELECT 3 AS nid, 0.021485838837834295 AS "Score" FROM rdb$database UNION ALL SELECT 4 AS nid, 0.007669882176625569 AS "Score" FROM rdb$database UNION ALL SELECT 5 AS nid, -0.028438227278971245 AS "Score" FROM rdb$database) AS "Values"), 
"DT_Output_47" AS 
...
"DT_node_data_48" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE PRECISION) AS "Score" 
FROM (SELECT 4 AS nid, -0.03096581233557897 AS "Score" FROM rdb$database UNION ALL SELECT 5 AS nid, -0.014913199936771624 AS "Score" FROM rdb$database UNION ALL SELECT 6 AS nid, 0.03769011341779827 AS "Score" FROM rdb$database UNION ALL SELECT 7 AS nid, -0.003986748168253898 AS "Score" FROM rdb$database) AS "Values"), 
"DT_Output_48" AS 
...
"DT_node_data_49" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE PRECISION) AS "Score" 
FROM (SELECT 2 AS nid, -0.02666351408876985 AS "Score" FROM rdb$database UNION ALL SELECT 6 AS nid, -0.01791896302520027 AS "Score" FROM rdb$database UNION ALL SELECT 14 AS nid, 0.05391967999653712 AS "Score" FROM rdb$database UNION ALL SELECT 15 AS nid, -0.0037269616365383862 AS "Score" FROM rdb$database) AS "Values"), 
"DT_Output_49" AS 
...
-- Code For temporary table TMP_20180602_AGG_LGBM_B10 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180602_AGG_LGBM_B10" (
	"KEY" BIGINT, 
	"Score_0" DOUBLE PRECISION, 
	"Score_1" DOUBLE PRECISION, 
	"Score_2" DOUBLE PRECISION, 
...
-- Code For temporary table TMP_20180602_AGG_LGBM_B10 part 2. Populate

INSERT INTO "TMP_20180602_AGG_LGBM_B10" ("KEY", "Score_0", "Score_1", "Score_2", "Score_3") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1", "U"."Score_2", "U"."Score_3" 
FROM (WITH "DT_node_lookup_50" AS 
(SELECT "ADS"."KEY" AS "KEY", CASE WHEN ("ADS"."Feature_56" <= 1.0000000180025095e-35) THEN CASE WHEN ("ADS"."Feature_54" <= 0.06279759359864408) THEN 4 ELSE 5 END ELSE CASE WHEN ("ADS"."Feature_95" <= 1.0000000180025095e-35) THEN 6 ELSE 7 END END AS node_id_2 
FROM "FourClass_100" AS "ADS"), 
"DT_node_data_50" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE PRECISION) AS "Score" 
FROM (SELECT 4 AS nid, 0.04082615911916668 AS "Score" FROM rdb$database UNION ALL SELECT 5 AS nid, -0.008164700830335773 AS "Score" FROM rdb$database UNION ALL SELECT 6 AS nid, -0.031209807537295783 AS "Score" FROM rdb$database UNION ALL SELECT 7 AS nid, -0.015777132862564016 AS "Score" FROM rdb$database) AS "Values"), 
"DT_Output_50" AS 
...
"DT_node_data_51" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE PRECISION) AS "Score" 
FROM (SELECT 4 AS nid, -0.01547809599581993 AS "Score" FROM rdb$database UNION ALL SELECT 5 AS nid, 0.0417110343214574 AS "Score" FROM rdb$database UNION ALL SELECT 6 AS nid, -0.032614617683428875 AS "Score" FROM rdb$database UNION ALL SELECT 7 AS nid, 0.0024211235355958514 AS "Score" FROM rdb$database) AS "Values"), 
"DT_Output_51" AS 
...
"DT_node_data_52" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE PRECISION) AS "Score" 
FROM (SELECT 4 AS nid, -0.031001791231726174 AS "Score" FROM rdb$database UNION ALL SELECT 5 AS nid, -0.014609160109801992 AS "Score" FROM rdb$database UNION ALL SELECT 6 AS nid, 0.038655269837439644 AS "Score" FROM rdb$database UNION ALL SELECT 7 AS nid, -0.0026621790034400874 AS "Score" FROM rdb$database) AS "Values"), 
"DT_Output_52" AS 
...
"DT_node_data_53" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE PRECISION) AS "Score" 
FROM (SELECT 2 AS nid, -0.02634224470316021 AS "Score" FROM rdb$database UNION ALL SELECT 6 AS nid, -0.01760692028303713 AS "Score" FROM rdb$database UNION ALL SELECT 14 AS nid, 0.05125224693900904 AS "Score" FROM rdb$database UNION ALL SELECT 15 AS nid, -0.003630507090393296 AS "Score" FROM rdb$database) AS "Values"), 
"DT_Output_53" AS 
...
"DT_node_data_54" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE PRECISION) AS "Score" 
FROM (SELECT 2 AS nid, 0.026645616660582346 AS "Score" FROM rdb$database UNION ALL SELECT 6 AS nid, 0.007263979734465707 AS "Score" FROM rdb$database UNION ALL SELECT 14 AS nid, -0.023587301127814084 AS "Score" FROM rdb$database UNION ALL SELECT 15 AS nid, -0.032532486849273935 AS "Score" FROM rdb$database) AS "Values"), 
"DT_Output_54" AS 
...
-- Code For temporary table TMP_20180602_JH1_LGBM_B11 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180602_JH1_LGBM_B11" (
	"KEY" BIGINT, 
	"Score_0" DOUBLE PRECISION, 
	"Score_1" DOUBLE PRECISION, 
	"Score_2" DOUBLE PRECISION, 
...
-- Code For temporary table TMP_20180602_JH1_LGBM_B11 part 2. Populate

INSERT INTO "TMP_20180602_JH1_LGBM_B11" ("KEY", "Score_0", "Score_1", "Score_2", "Score_3") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1", "U"."Score_2", "U"."Score_3" 
FROM (WITH "DT_node_lookup_55" AS 
(SELECT "ADS"."KEY" AS "KEY", CASE WHEN ("ADS"."Feature_29" <= 1.113050664616632) THEN CASE WHEN ("ADS"."Feature_67" <= 0.17024216436032105) THEN 4 ELSE 5 END ELSE 3 END AS node_id_2 
FROM "FourClass_100" AS "ADS"), 
"DT_node_data_55" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE PRECISION) AS "Score" 
FROM (SELECT 3 AS nid, 0.021712723775091754 AS "Score" FROM rdb$database UNION ALL SELECT 4 AS nid, -0.03219836534723082 AS "Score" FROM rdb$database UNION ALL SELECT 5 AS nid, 0.00517620951727828 AS "Score" FROM rdb$database) AS "Values"), 
"DT_Output_55" AS 
...
"DT_node_data_56" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE PRECISION) AS "Score" 
FROM (SELECT 4 AS nid, -0.015924392352000754 AS "Score" FROM rdb$database UNION ALL SELECT 5 AS nid, 0.035107118736792446 AS "Score" FROM rdb$database UNION ALL SELECT 6 AS nid, -0.03206437527500725 AS "Score" FROM rdb$database UNION ALL SELECT 7 AS nid, -0.0036986408236376125 AS "Score" FROM rdb$database) AS "Values"), 
"DT_Output_56" AS 
...
"DT_node_data_57" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE PRECISION) AS "Score" 
FROM (SELECT 2 AS nid, 0.024524413168279333 AS "Score" FROM rdb$database UNION ALL SELECT 7 AS nid, 0.01347308490703997 AS "Score" FROM rdb$database UNION ALL SELECT 12 AS nid, -0.03270992785852472 AS "Score" FROM rdb$database UNION ALL SELECT 13 AS nid, -0.005002800022170158 AS "Score" FROM rdb$database) AS "Values"), 
"DT_Output_57" AS 
...
"DT_node_data_58" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE PRECISION) AS "Score" 
FROM (SELECT 4 AS nid, 0.03864149231000985 AS "Score" FROM rdb$database UNION ALL SELECT 5 AS nid, -0.007719251083345181 AS "Score" FROM rdb$database UNION ALL SELECT 6 AS nid, -0.015219357006601536 AS "Score" FROM rdb$database UNION ALL SELECT 7 AS nid, -0.031029401688927233 AS "Score" FROM rdb$database) AS "Values"), 
"DT_Output_58" AS 
...
"DT_node_data_59" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE PRECISION) AS "Score" 
FROM (SELECT 3 AS nid, 0.02014978484742745 AS "Score" FROM rdb$database UNION ALL SELECT 4 AS nid, -0.03182398372091164 AS "Score" FROM rdb$database UNION ALL SELECT 5 AS nid, 0.0032512432848184137 AS "Score" FROM rdb$database) AS "Values"), 
"DT_Output_59" AS 
...
-- Code For temporary table TMP_20180602_NDD_LGBM_B12 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180602_NDD_LGBM_B12" (
	"KEY" BIGINT, 
	"Score_0" DOUBLE PRECISION, 
	"Score_1" DOUBLE PRECISION, 
	"Score_2" DOUBLE PRECISION, 
...
-- Code For temporary table TMP_20180602_NDD_LGBM_B12 part 2. Populate

INSERT INTO "TMP_20180602_NDD_LGBM_B12" ("KEY", "Score_0", "Score_1", "Score_2", "Score_3") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1", "U"."Score_2", "U"."Score_3" 
FROM (WITH "DT_node_lookup_60" AS 
(SELECT "ADS"."KEY" AS "KEY", CASE WHEN ("ADS"."Feature_78" <= -0.6945887143399035) THEN CASE WHEN ("ADS"."Feature_64" <= -0.0690557983856105) THEN 4 ELSE 5 END ELSE CASE WHEN ("ADS"."Feature_33" <= -0.20105028919503856) THEN 6 ELSE 7 END END AS node_id_2 
FROM "FourClass_100" AS "ADS"), 
"DT_node_data_60" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE PRECISION) AS "Score" 
FROM (SELECT 4 AS nid, -0.030738778266293867 AS "Score" FROM rdb$database UNION ALL SELECT 5 AS nid, -0.013870365876366276 AS "Score" FROM rdb$database UNION ALL SELECT 6 AS nid, 0.034836517528406045 AS "Score" FROM rdb$database UNION ALL SELECT 7 AS nid, -0.004342507924212075 AS "Score" FROM rdb$database) AS "Values"), 
"DT_Output_60" AS 
...
"DT_node_data_61" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE PRECISION) AS "Score" 
FROM (SELECT 2 AS nid, -0.019607042783816683 AS "Score" FROM rdb$database UNION ALL SELECT 6 AS nid, -0.014778929281387672 AS "Score" FROM rdb$database UNION ALL SELECT 7 AS nid, 0.025846603449826727 AS "Score" FROM rdb$database) AS "Values"), 
"DT_Output_61" AS 
...
"DT_node_data_62" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE PRECISION) AS "Score" 
FROM (SELECT 2 AS nid, -0.031748062077407484 AS "Score" FROM rdb$database UNION ALL SELECT 6 AS nid, -0.026057372564896777 AS "Score" FROM rdb$database UNION ALL SELECT 14 AS nid, 0.0007897005113826886 AS "Score" FROM rdb$database UNION ALL SELECT 15 AS nid, 0.0516238664210088 AS "Score" FROM rdb$database) AS "Values"), 
"DT_Output_62" AS 
...
"DT_node_data_63" AS 
(SELECT "Values".nid AS nid, CAST("Values"."Score" AS DOUBLE PRECISION) AS "Score" 
FROM (SELECT 4 AS nid, -0.014908285258812382 AS "Score" FROM rdb$database UNION ALL SELECT 5 AS nid, 0.03869811050918698 AS "Score" FROM rdb$database UNION ALL SELECT 6 AS nid, -0.03225446469059595 AS "Score" FROM rdb$database UNION ALL SELECT 7 AS nid, 0.002480184590942582 AS "Score" FROM rdb$database) AS "Values"), 
"DT_Output_63" AS 
...
-- Code For temporary table TMP_20180602_26Q_LGBM_SUM part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180602_26Q_LGBM_SUM" (
	"KEY" BIGINT NOT NULL, 
	"Score_0" DOUBLE PRECISION, 
	"Score_1" DOUBLE PRECISION, 
	"Score_2" DOUBLE PRECISION, 
...
-- Code For temporary table TMP_20180602_26Q_LGBM_SUM part 2. Populate

INSERT INTO "TMP_20180602_26Q_LGBM_SUM" ("KEY", "Score_0", "Score_1", "Score_2", "Score_3") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1", "U"."Score_2", "U"."Score_3" 
...
FROM "TMP_20180602_3WY_LGBM_B0" AS "LGBM_B0" UNION ALL SELECT "LGBM_B1"."KEY" AS "KEY", "LGBM_B1"."Score_0" AS "Score_0", "LGBM_B1"."Score_1" AS "Score_1", "LGBM_B1"."Score_2" AS "Score_2", "LGBM_B1"."Score_3" AS "Score_3" 
FROM "TMP_20180602_ZYL_LGBM_B1" AS "LGBM_B1" UNION ALL SELECT "LGBM_B2"."KEY" AS "KEY", "LGBM_B2"."Score_0" AS "Score_0", "LGBM_B2"."Score_1" AS "Score_1", "LGBM_B2"."Score_2" AS "Score_2", "LGBM_B2"."Score_3" AS "Score_3" 
FROM "TMP_20180602_Z8H_LGBM_B2" AS "LGBM_B2" UNION ALL SELECT "LGBM_B3"."KEY" AS "KEY", "LGBM_B3"."Score_0" AS "Score_0", "LGBM_B3"."Score_1" AS "Score_1", "LGBM_B3"."Score_2" AS "Score_2", "LGBM_B3"."Score_3" AS "Score_3" 
FROM "TMP_20180602_35E_LGBM_B3" AS "LGBM_B3" UNION ALL SELECT "LGBM_B4"."KEY" AS "KEY", "LGBM_B4"."Score_0" AS "Score_0", "LGBM_B4"."Score_1" AS "Score_1", "LGBM_B4"."Score_2" AS "Score_2", "LGBM_B4"."Score_3" AS "Score_3" 
FROM "TMP_20180602_MCQ_LGBM_B4" AS "LGBM_B4" UNION ALL SELECT "LGBM_B5"."KEY" AS "KEY", "LGBM_B5"."Score_0" AS "Score_0", "LGBM_B5"."Score_1" AS "Score_1", "LGBM_B5"."Score_2" AS "Score_2", "LGBM_B5"."Score_3" AS "Score_3" 
FROM "TMP_20180602_B9H_LGBM_B5" AS "LGBM_B5" UNION ALL SELECT "LGBM_B6"."KEY" AS "KEY", "LGBM_B6"."Score_0" AS "Score_0", "LGBM_B6"."Score_1" AS "Score_1", "LGBM_B6"."Score_2" AS "Score_2", "LGBM_B6"."Score_3" AS "Score_3" 
FROM "TMP_20180602_6MP_LGBM_B6" AS "LGBM_B6" UNION ALL SELECT "LGBM_B7"."KEY" AS "KEY", "LGBM_B7"."Score_0" AS "Score_0", "LGBM_B7"."Score_1" AS "Score_1", "LGBM_B7"."Score_2" AS "Score_2", "LGBM_B7"."Score_3" AS "Score_3" 
FROM "TMP_20180602_6DS_LGBM_B7" AS "LGBM_B7" UNION ALL SELECT "LGBM_B8"."KEY" AS "KEY", "LGBM_B8"."Score_0" AS "Score_0", "LGBM_B8"."Score_1" AS "Score_1", "LGBM_B8"."Score_2" AS "Score_2", "LGBM_B8"."Score_3" AS "Score_3" 
FROM "TMP_20180602_FFO_LGBM_B8" AS "LGBM_B8" UNION ALL SELECT "LGBM_B9"."KEY" AS "KEY", "LGBM_B9"."Score_0" AS "Score_0", "LGBM_B9"."Score_1" AS "Score_1", "LGBM_B9"."Score_2" AS "Score_2", "LGBM_B9"."Score_3" AS "Score_3" 
FROM "TMP_20180602_HHY_LGBM_B9" AS "LGBM_B9" UNION ALL SELECT "LGBM_B10"."KEY" AS "KEY", "LGBM_B10"."Score_0" AS "Score_0", "LGBM_B10"."Score_1" AS "Score_1", "LGBM_B10"."Score_2" AS "Score_2", "LGBM_B10"."Score_3" AS "Score_3" 
FROM "TMP_20180602_AGG_LGBM_B10" AS "LGBM_B10" UNION ALL SELECT "LGBM_B11"."KEY" AS "KEY", "LGBM_B11"."Score_0" AS "Score_0", "LGBM_B11"."Score_1" AS "Score_1", "LGBM_B11"."Score_2" AS "Score_2", "LGBM_B11"."Score_3" AS "Score_3" 
FROM "TMP_20180602_JH1_LGBM_B11" AS "LGBM_B11" UNION ALL SELECT "LGBM_B12"."KEY" AS "KEY", "LGBM_B12"."Score_0" AS "Score_0", "LGBM_B12"."Score_1" AS "Score_1", "LGBM_B12"."Score_2" AS "Score_2", "LGBM_B12"."Score_3" AS "Score_3" 
FROM "TMP_20180602_NDD_LGBM_B12" AS "LGBM_B12") AS "LGBM_EnsembleUnion")
...
-- Code For temporary table TMP_20180602_26Q_LGBM_SUM part 3. Create Index 

CREATE INDEX "ix_TMP_20180602_26Q_LGB_0bd8" ON "TMP_20180602_26Q_LGBM_SUM" ("KEY")
...
FROM "TMP_20180602_26Q_LGBM_SUM" AS "LGBM_sum"), 
