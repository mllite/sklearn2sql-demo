...
-- Code For temporary table ##TMP_20180602152828_5VC_LGBM_B0 part 1. Create 


CREATE TABLE ##TMP_20180602152828_5VC_LGBM_B0 (
	[KEY] BIGINT NULL, 
...
-- Code For temporary table ##TMP_20180602152828_5VC_LGBM_B0 part 2. Populate
...
FROM [DT_Output_9])
 INSERT INTO ##TMP_20180602152828_5VC_LGBM_B0 ([KEY], [Score_0], [Score_1], [Score_2]) SELECT [LGBM_B0].[KEY], [LGBM_B0].[Score_0], [LGBM_B0].[Score_1], [LGBM_B0].[Score_2] 
...
-- Code For temporary table ##TMP_20180602152828_D8E_LGBM_B1 part 1. Create 


CREATE TABLE ##TMP_20180602152828_D8E_LGBM_B1 (
	[KEY] BIGINT NULL, 
	[Score_0] FLOAT(53) NULL, 
	[Score_1] FLOAT(53) NULL, 
	[Score_2] FLOAT(53) NULL
...
-- Code For temporary table ##TMP_20180602152828_D8E_LGBM_B1 part 2. Populate
...
FROM [DT_Output_19])
 INSERT INTO ##TMP_20180602152828_D8E_LGBM_B1 ([KEY], [Score_0], [Score_1], [Score_2]) SELECT [LGBM_B1].[KEY], [LGBM_B1].[Score_0], [LGBM_B1].[Score_1], [LGBM_B1].[Score_2] 
...
-- Code For temporary table ##TMP_20180602152828_AAW_LGBM_B2 part 1. Create 


CREATE TABLE ##TMP_20180602152828_AAW_LGBM_B2 (
	[KEY] BIGINT NULL, 
	[Score_0] FLOAT(53) NULL, 
	[Score_1] FLOAT(53) NULL, 
	[Score_2] FLOAT(53) NULL
...
-- Code For temporary table ##TMP_20180602152828_AAW_LGBM_B2 part 2. Populate
...
FROM [DT_Output_29])
 INSERT INTO ##TMP_20180602152828_AAW_LGBM_B2 ([KEY], [Score_0], [Score_1], [Score_2]) SELECT [LGBM_B2].[KEY], [LGBM_B2].[Score_0], [LGBM_B2].[Score_1], [LGBM_B2].[Score_2] 
...
-- Code For temporary table ##TMP_20180602152828_TGO_LGBM_B3 part 1. Create 


CREATE TABLE ##TMP_20180602152828_TGO_LGBM_B3 (
	[KEY] BIGINT NULL, 
	[Score_0] FLOAT(53) NULL, 
	[Score_1] FLOAT(53) NULL, 
	[Score_2] FLOAT(53) NULL
...
-- Code For temporary table ##TMP_20180602152828_TGO_LGBM_B3 part 2. Populate
...
FROM [DT_Output_39])
 INSERT INTO ##TMP_20180602152828_TGO_LGBM_B3 ([KEY], [Score_0], [Score_1], [Score_2]) SELECT [LGBM_B3].[KEY], [LGBM_B3].[Score_0], [LGBM_B3].[Score_1], [LGBM_B3].[Score_2] 
...
-- Code For temporary table ##TMP_20180602152828_S8O_LGBM_B4 part 1. Create 


CREATE TABLE ##TMP_20180602152828_S8O_LGBM_B4 (
	[KEY] BIGINT NULL, 
	[Score_0] FLOAT(53) NULL, 
	[Score_1] FLOAT(53) NULL, 
	[Score_2] FLOAT(53) NULL
...
-- Code For temporary table ##TMP_20180602152828_S8O_LGBM_B4 part 2. Populate
...
FROM [DT_Output_47])
 INSERT INTO ##TMP_20180602152828_S8O_LGBM_B4 ([KEY], [Score_0], [Score_1], [Score_2]) SELECT [LGBM_B4].[KEY], [LGBM_B4].[Score_0], [LGBM_B4].[Score_1], [LGBM_B4].[Score_2] 
...
-- Code For temporary table ##TMP_20180602152828_KVP_LGBM_sum part 1. Create 


CREATE TABLE ##TMP_20180602152828_KVP_LGBM_sum (
	[KEY] BIGINT NULL, 
	[Score_0] FLOAT(53) NULL, 
	[Score_1] FLOAT(53) NULL, 
	[Score_2] FLOAT(53) NULL
...
-- Code For temporary table ##TMP_20180602152828_KVP_LGBM_sum part 2. Populate
...
FROM ##TMP_20180602152828_5VC_LGBM_B0 AS [LGBM_B0] UNION ALL SELECT [LGBM_B1].[KEY] AS [KEY], [LGBM_B1].[Score_0] AS [Score_0], [LGBM_B1].[Score_1] AS [Score_1], [LGBM_B1].[Score_2] AS [Score_2] 
FROM ##TMP_20180602152828_D8E_LGBM_B1 AS [LGBM_B1] UNION ALL SELECT [LGBM_B2].[KEY] AS [KEY], [LGBM_B2].[Score_0] AS [Score_0], [LGBM_B2].[Score_1] AS [Score_1], [LGBM_B2].[Score_2] AS [Score_2] 
FROM ##TMP_20180602152828_AAW_LGBM_B2 AS [LGBM_B2] UNION ALL SELECT [LGBM_B3].[KEY] AS [KEY], [LGBM_B3].[Score_0] AS [Score_0], [LGBM_B3].[Score_1] AS [Score_1], [LGBM_B3].[Score_2] AS [Score_2] 
FROM ##TMP_20180602152828_TGO_LGBM_B3 AS [LGBM_B3] UNION ALL SELECT [LGBM_B4].[KEY] AS [KEY], [LGBM_B4].[Score_0] AS [Score_0], [LGBM_B4].[Score_1] AS [Score_1], [LGBM_B4].[Score_2] AS [Score_2] 
FROM ##TMP_20180602152828_S8O_LGBM_B4 AS [LGBM_B4]) AS [LGBM_EnsembleUnion])
 INSERT INTO ##TMP_20180602152828_KVP_LGBM_sum ([KEY], [Score_0], [Score_1], [Score_2]) SELECT [LGBM_sum].[KEY], [LGBM_sum].[Score_0], [LGBM_sum].[Score_1], [LGBM_sum].[Score_2] 
...
FROM ##TMP_20180602152828_KVP_LGBM_sum AS [LGBM_sum]), 
