...
-- Code For temporary table TMP_20180508185635_CODEGEN_Y7GB part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508185635_CODEGEN_Y7GB" (
	"KEY" BIGINT, 
...
-- Code For temporary table TMP_20180508185635_CODEGEN_Y7GB part 2. Populate

INSERT INTO "TMP_20180508185635_CODEGEN_Y7GB" ("KEY", "Score_0", "Score_1", "Score_2") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1", "U"."Score_2" 
...
-- Code For temporary table TMP_20180508185635_CODEGEN_6VEZ part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508185635_CODEGEN_6VEZ" (
	"KEY" BIGINT, 
	"Score_0" DOUBLE PRECISION, 
	"Score_1" DOUBLE PRECISION, 
	"Score_2" DOUBLE PRECISION
...
-- Code For temporary table TMP_20180508185635_CODEGEN_6VEZ part 2. Populate

INSERT INTO "TMP_20180508185635_CODEGEN_6VEZ" ("KEY", "Score_0", "Score_1", "Score_2") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1", "U"."Score_2" 
...
-- Code For temporary table TMP_20180508185635_CODEGEN_4CDM part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508185635_CODEGEN_4CDM" (
	"KEY" BIGINT, 
	"Score_0" DOUBLE PRECISION, 
	"Score_1" DOUBLE PRECISION, 
	"Score_2" DOUBLE PRECISION
...
-- Code For temporary table TMP_20180508185635_CODEGEN_4CDM part 2. Populate

INSERT INTO "TMP_20180508185635_CODEGEN_4CDM" ("KEY", "Score_0", "Score_1", "Score_2") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1", "U"."Score_2" 
...
-- Code For temporary table TMP_20180508185635_CODEGEN_P9K5 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508185635_CODEGEN_P9K5" (
	"KEY" BIGINT, 
	"Score_0" DOUBLE PRECISION, 
	"Score_1" DOUBLE PRECISION, 
	"Score_2" DOUBLE PRECISION
...
-- Code For temporary table TMP_20180508185635_CODEGEN_P9K5 part 2. Populate

INSERT INTO "TMP_20180508185635_CODEGEN_P9K5" ("KEY", "Score_0", "Score_1", "Score_2") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1", "U"."Score_2" 
...
-- Code For temporary table TMP_20180508185635_CODEGEN_3HT4 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508185635_CODEGEN_3HT4" (
	"KEY" BIGINT, 
	"Score_0" DOUBLE PRECISION, 
	"Score_1" DOUBLE PRECISION, 
	"Score_2" DOUBLE PRECISION
...
-- Code For temporary table TMP_20180508185635_CODEGEN_3HT4 part 2. Populate

INSERT INTO "TMP_20180508185635_CODEGEN_3HT4" ("KEY", "Score_0", "Score_1", "Score_2") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1", "U"."Score_2" 
...
-- Code For temporary table TMP_20180508185635_CODEGEN_X437 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508185635_CODEGEN_X437" (
	"KEY" BIGINT, 
	"Score_0" DOUBLE PRECISION, 
	"Score_1" DOUBLE PRECISION, 
	"Score_2" DOUBLE PRECISION
...
-- Code For temporary table TMP_20180508185635_CODEGEN_X437 part 2. Populate

INSERT INTO "TMP_20180508185635_CODEGEN_X437" ("KEY", "Score_0", "Score_1", "Score_2") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1", "U"."Score_2" 
...
FROM "TMP_20180508185635_CODEGEN_Y7GB" AS "LGBM_B0" UNION ALL SELECT "LGBM_B1"."KEY" AS "KEY", "LGBM_B1"."Score_0" AS "Score_0", "LGBM_B1"."Score_1" AS "Score_1", "LGBM_B1"."Score_2" AS "Score_2" 
FROM "TMP_20180508185635_CODEGEN_6VEZ" AS "LGBM_B1" UNION ALL SELECT "LGBM_B2"."KEY" AS "KEY", "LGBM_B2"."Score_0" AS "Score_0", "LGBM_B2"."Score_1" AS "Score_1", "LGBM_B2"."Score_2" AS "Score_2" 
FROM "TMP_20180508185635_CODEGEN_4CDM" AS "LGBM_B2" UNION ALL SELECT "LGBM_B3"."KEY" AS "KEY", "LGBM_B3"."Score_0" AS "Score_0", "LGBM_B3"."Score_1" AS "Score_1", "LGBM_B3"."Score_2" AS "Score_2" 
FROM "TMP_20180508185635_CODEGEN_P9K5" AS "LGBM_B3" UNION ALL SELECT "LGBM_B4"."KEY" AS "KEY", "LGBM_B4"."Score_0" AS "Score_0", "LGBM_B4"."Score_1" AS "Score_1", "LGBM_B4"."Score_2" AS "Score_2" 
FROM "TMP_20180508185635_CODEGEN_3HT4" AS "LGBM_B4") AS "LGBM_EnsembleUnion") AS "LGBM_Union") AS "U"

-- Code For temporary table TMP_20180508185635_CODEGEN_Q93Q part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508185635_CODEGEN_Q93Q" (
	"KEY" BIGINT NOT NULL, 
	"Score_0" DOUBLE PRECISION, 
	"Score_1" DOUBLE PRECISION, 
	"Score_2" DOUBLE PRECISION, 
...
-- Code For temporary table TMP_20180508185635_CODEGEN_Q93Q part 2. Populate

INSERT INTO "TMP_20180508185635_CODEGEN_Q93Q" ("KEY", "Score_0", "Score_1", "Score_2") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1", "U"."Score_2" 
...
FROM "TMP_20180508185635_CODEGEN_X437" AS "LGBM_Union" GROUP BY "LGBM_Union"."KEY") AS "T") AS "LGBM_sum") AS "U"

-- Code For temporary table TMP_20180508185635_CODEGEN_Q93Q part 3. Create Index 

CREATE INDEX "ix_TMP_20180508185635_C_6fe0" ON "TMP_20180508185635_CODEGEN_Q93Q" ("KEY")
...
FROM "TMP_20180508185635_CODEGEN_Q93Q" AS "LGBM_sum"), 
