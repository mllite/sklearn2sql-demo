...
-- Code For temporary table tmp_20180602152832_85n_lgbm_b0 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180602152832_85n_lgbm_b0 (
	"KEY" BIGINT, 
	"Score_0" DOUBLE, 
	"Score_1" DOUBLE, 
	"Score_2" DOUBLE
...
-- Code For temporary table tmp_20180602152832_85n_lgbm_b0 part 2. Populate

INSERT INTO tmp_20180602152832_85n_lgbm_b0 WITH "DT_node_lookup" AS 
...
-- Code For temporary table tmp_20180602152832_ybh_lgbm_b1 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180602152832_ybh_lgbm_b1 (
	"KEY" BIGINT, 
	"Score_0" DOUBLE, 
	"Score_1" DOUBLE, 
	"Score_2" DOUBLE
...
-- Code For temporary table tmp_20180602152832_ybh_lgbm_b1 part 2. Populate

INSERT INTO tmp_20180602152832_ybh_lgbm_b1 WITH "DT_node_lookup_10" AS 
...
-- Code For temporary table tmp_20180602152832_2sz_lgbm_b2 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180602152832_2sz_lgbm_b2 (
	"KEY" BIGINT, 
	"Score_0" DOUBLE, 
	"Score_1" DOUBLE, 
	"Score_2" DOUBLE
...
-- Code For temporary table tmp_20180602152832_2sz_lgbm_b2 part 2. Populate

INSERT INTO tmp_20180602152832_2sz_lgbm_b2 WITH "DT_node_lookup_20" AS 
...
-- Code For temporary table tmp_20180602152832_j4t_lgbm_b3 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180602152832_j4t_lgbm_b3 (
	"KEY" BIGINT, 
	"Score_0" DOUBLE, 
	"Score_1" DOUBLE, 
	"Score_2" DOUBLE
...
-- Code For temporary table tmp_20180602152832_j4t_lgbm_b3 part 2. Populate

INSERT INTO tmp_20180602152832_j4t_lgbm_b3 WITH "DT_node_lookup_30" AS 
...
-- Code For temporary table tmp_20180602152832_u01_lgbm_b4 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180602152832_u01_lgbm_b4 (
	"KEY" BIGINT, 
	"Score_0" DOUBLE, 
	"Score_1" DOUBLE, 
	"Score_2" DOUBLE
...
-- Code For temporary table tmp_20180602152832_u01_lgbm_b4 part 2. Populate

INSERT INTO tmp_20180602152832_u01_lgbm_b4 WITH "DT_node_lookup_40" AS 
...
-- Code For temporary table tmp_20180602152832_x9q_lgbm_sum part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180602152832_x9q_lgbm_sum (
	"KEY" BIGINT, 
	"Score_0" DOUBLE, 
	"Score_1" DOUBLE, 
	"Score_2" DOUBLE
...
-- Code For temporary table tmp_20180602152832_x9q_lgbm_sum part 2. Populate

INSERT INTO tmp_20180602152832_x9q_lgbm_sum WITH "LGBM_Union" AS 
...
FROM tmp_20180602152832_85n_lgbm_b0 AS "LGBM_B0" UNION ALL SELECT "LGBM_B1"."KEY" AS "KEY", "LGBM_B1"."Score_0" AS "Score_0", "LGBM_B1"."Score_1" AS "Score_1", "LGBM_B1"."Score_2" AS "Score_2" 
FROM tmp_20180602152832_ybh_lgbm_b1 AS "LGBM_B1" UNION ALL SELECT "LGBM_B2"."KEY" AS "KEY", "LGBM_B2"."Score_0" AS "Score_0", "LGBM_B2"."Score_1" AS "Score_1", "LGBM_B2"."Score_2" AS "Score_2" 
FROM tmp_20180602152832_2sz_lgbm_b2 AS "LGBM_B2" UNION ALL SELECT "LGBM_B3"."KEY" AS "KEY", "LGBM_B3"."Score_0" AS "Score_0", "LGBM_B3"."Score_1" AS "Score_1", "LGBM_B3"."Score_2" AS "Score_2" 
FROM tmp_20180602152832_j4t_lgbm_b3 AS "LGBM_B3" UNION ALL SELECT "LGBM_B4"."KEY" AS "KEY", "LGBM_B4"."Score_0" AS "Score_0", "LGBM_B4"."Score_1" AS "Score_1", "LGBM_B4"."Score_2" AS "Score_2" 
FROM tmp_20180602152832_u01_lgbm_b4 AS "LGBM_B4") AS "LGBM_EnsembleUnion")
...
FROM tmp_20180602152832_x9q_lgbm_sum AS "LGBM_sum"), 
