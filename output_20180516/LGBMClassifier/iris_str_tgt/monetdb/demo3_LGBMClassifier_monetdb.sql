...
-- Code For temporary table tmp_20180516131213_codegen_60437a_lgbm_b0 part 1. Create 


CREATE TEMPORARY TABLE tmp_20180516131213_codegen_60437a_lgbm_b0 (
	"KEY" BIGINT, 
...
-- Code For temporary table tmp_20180516131213_codegen_60437a_lgbm_b0 part 2. Populate

INSERT INTO tmp_20180516131213_codegen_60437a_lgbm_b0 ("KEY", "Score_CLASS_0", "Score_CLASS_1", "Score_CLASS_2") SELECT "U"."KEY", "U"."Score_CLASS_0", "U"."Score_CLASS_1", "U"."Score_CLASS_2" 
...
-- Code For temporary table tmp_20180516131213_codegen_4g3jy2_lgbm_b1 part 1. Create 


CREATE TEMPORARY TABLE tmp_20180516131213_codegen_4g3jy2_lgbm_b1 (
	"KEY" BIGINT, 
	"Score_CLASS_0" DOUBLE, 
	"Score_CLASS_1" DOUBLE, 
	"Score_CLASS_2" DOUBLE
...
-- Code For temporary table tmp_20180516131213_codegen_4g3jy2_lgbm_b1 part 2. Populate

INSERT INTO tmp_20180516131213_codegen_4g3jy2_lgbm_b1 ("KEY", "Score_CLASS_0", "Score_CLASS_1", "Score_CLASS_2") SELECT "U"."KEY", "U"."Score_CLASS_0", "U"."Score_CLASS_1", "U"."Score_CLASS_2" 
...
-- Code For temporary table tmp_20180516131213_codegen_4ustpg_lgbm_b2 part 1. Create 


CREATE TEMPORARY TABLE tmp_20180516131213_codegen_4ustpg_lgbm_b2 (
	"KEY" BIGINT, 
	"Score_CLASS_0" DOUBLE, 
	"Score_CLASS_1" DOUBLE, 
	"Score_CLASS_2" DOUBLE
...
-- Code For temporary table tmp_20180516131213_codegen_4ustpg_lgbm_b2 part 2. Populate

INSERT INTO tmp_20180516131213_codegen_4ustpg_lgbm_b2 ("KEY", "Score_CLASS_0", "Score_CLASS_1", "Score_CLASS_2") SELECT "U"."KEY", "U"."Score_CLASS_0", "U"."Score_CLASS_1", "U"."Score_CLASS_2" 
...
-- Code For temporary table tmp_20180516131213_codegen_9y4uws_lgbm_b3 part 1. Create 


CREATE TEMPORARY TABLE tmp_20180516131213_codegen_9y4uws_lgbm_b3 (
	"KEY" BIGINT, 
	"Score_CLASS_0" DOUBLE, 
	"Score_CLASS_1" DOUBLE, 
	"Score_CLASS_2" DOUBLE
...
-- Code For temporary table tmp_20180516131213_codegen_9y4uws_lgbm_b3 part 2. Populate

INSERT INTO tmp_20180516131213_codegen_9y4uws_lgbm_b3 ("KEY", "Score_CLASS_0", "Score_CLASS_1", "Score_CLASS_2") SELECT "U"."KEY", "U"."Score_CLASS_0", "U"."Score_CLASS_1", "U"."Score_CLASS_2" 
...
-- Code For temporary table tmp_20180516131213_codegen_qjneej_lgbm_b4 part 1. Create 


CREATE TEMPORARY TABLE tmp_20180516131213_codegen_qjneej_lgbm_b4 (
	"KEY" BIGINT, 
	"Score_CLASS_0" DOUBLE, 
	"Score_CLASS_1" DOUBLE, 
	"Score_CLASS_2" DOUBLE
...
-- Code For temporary table tmp_20180516131213_codegen_qjneej_lgbm_b4 part 2. Populate

INSERT INTO tmp_20180516131213_codegen_qjneej_lgbm_b4 ("KEY", "Score_CLASS_0", "Score_CLASS_1", "Score_CLASS_2") SELECT "U"."KEY", "U"."Score_CLASS_0", "U"."Score_CLASS_1", "U"."Score_CLASS_2" 
...
-- Code For temporary table tmp_20180516131213_codegen_2wn8hr_lgbm_sum part 1. Create 


CREATE TEMPORARY TABLE tmp_20180516131213_codegen_2wn8hr_lgbm_sum (
	"KEY" BIGINT, 
	"Score_CLASS_0" DOUBLE, 
	"Score_CLASS_1" DOUBLE, 
	"Score_CLASS_2" DOUBLE
...
-- Code For temporary table tmp_20180516131213_codegen_2wn8hr_lgbm_sum part 2. Populate

INSERT INTO tmp_20180516131213_codegen_2wn8hr_lgbm_sum ("KEY", "Score_CLASS_0", "Score_CLASS_1", "Score_CLASS_2") SELECT "U"."KEY", "U"."Score_CLASS_0", "U"."Score_CLASS_1", "U"."Score_CLASS_2" 
...
FROM tmp_20180516131213_codegen_60437a_lgbm_b0 AS "LGBM_B0" UNION ALL SELECT "LGBM_B1"."KEY" AS "KEY", "LGBM_B1"."Score_CLASS_0" AS "Score_CLASS_0", "LGBM_B1"."Score_CLASS_1" AS "Score_CLASS_1", "LGBM_B1"."Score_CLASS_2" AS "Score_CLASS_2" 
FROM tmp_20180516131213_codegen_4g3jy2_lgbm_b1 AS "LGBM_B1" UNION ALL SELECT "LGBM_B2"."KEY" AS "KEY", "LGBM_B2"."Score_CLASS_0" AS "Score_CLASS_0", "LGBM_B2"."Score_CLASS_1" AS "Score_CLASS_1", "LGBM_B2"."Score_CLASS_2" AS "Score_CLASS_2" 
FROM tmp_20180516131213_codegen_4ustpg_lgbm_b2 AS "LGBM_B2" UNION ALL SELECT "LGBM_B3"."KEY" AS "KEY", "LGBM_B3"."Score_CLASS_0" AS "Score_CLASS_0", "LGBM_B3"."Score_CLASS_1" AS "Score_CLASS_1", "LGBM_B3"."Score_CLASS_2" AS "Score_CLASS_2" 
FROM tmp_20180516131213_codegen_9y4uws_lgbm_b3 AS "LGBM_B3" UNION ALL SELECT "LGBM_B4"."KEY" AS "KEY", "LGBM_B4"."Score_CLASS_0" AS "Score_CLASS_0", "LGBM_B4"."Score_CLASS_1" AS "Score_CLASS_1", "LGBM_B4"."Score_CLASS_2" AS "Score_CLASS_2" 
FROM tmp_20180516131213_codegen_qjneej_lgbm_b4 AS "LGBM_B4") AS "LGBM_EnsembleUnion")
...
FROM tmp_20180516131213_codegen_2wn8hr_lgbm_sum AS "LGBM_sum"), 
