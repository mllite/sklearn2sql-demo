...
-- Code For temporary table TMP_20180602160338_105_LGBM_B0 part 1. Create 


CREATE TEMPORARY TABLE "TMP_20180602160338_105_LGBM_B0" (
	"KEY" BIGINT, 
	"Score_CLASS_0" FLOAT, 
	"Score_CLASS_1" FLOAT, 
	"Score_CLASS_2" FLOAT
...
-- Code For temporary table TMP_20180602160338_105_LGBM_B0 part 2. Populate
...
FROM "DT_Output_9")
 INSERT INTO "TMP_20180602160338_105_LGBM_B0" ("KEY", "Score_CLASS_0", "Score_CLASS_1", "Score_CLASS_2") SELECT "LGBM_B0"."KEY", "LGBM_B0"."Score_CLASS_0", "LGBM_B0"."Score_CLASS_1", "LGBM_B0"."Score_CLASS_2" 
...
-- Code For temporary table TMP_20180602160338_1R6_LGBM_B1 part 1. Create 


CREATE TEMPORARY TABLE "TMP_20180602160338_1R6_LGBM_B1" (
	"KEY" BIGINT, 
	"Score_CLASS_0" FLOAT, 
	"Score_CLASS_1" FLOAT, 
	"Score_CLASS_2" FLOAT
...
-- Code For temporary table TMP_20180602160338_1R6_LGBM_B1 part 2. Populate
...
FROM "DT_Output_19")
 INSERT INTO "TMP_20180602160338_1R6_LGBM_B1" ("KEY", "Score_CLASS_0", "Score_CLASS_1", "Score_CLASS_2") SELECT "LGBM_B1"."KEY", "LGBM_B1"."Score_CLASS_0", "LGBM_B1"."Score_CLASS_1", "LGBM_B1"."Score_CLASS_2" 
...
-- Code For temporary table TMP_20180602160338_L80_LGBM_B2 part 1. Create 


CREATE TEMPORARY TABLE "TMP_20180602160338_L80_LGBM_B2" (
	"KEY" BIGINT, 
	"Score_CLASS_0" FLOAT, 
	"Score_CLASS_1" FLOAT, 
	"Score_CLASS_2" FLOAT
...
-- Code For temporary table TMP_20180602160338_L80_LGBM_B2 part 2. Populate
...
FROM "DT_Output_29")
 INSERT INTO "TMP_20180602160338_L80_LGBM_B2" ("KEY", "Score_CLASS_0", "Score_CLASS_1", "Score_CLASS_2") SELECT "LGBM_B2"."KEY", "LGBM_B2"."Score_CLASS_0", "LGBM_B2"."Score_CLASS_1", "LGBM_B2"."Score_CLASS_2" 
...
-- Code For temporary table TMP_20180602160338_2NF_LGBM_B3 part 1. Create 


CREATE TEMPORARY TABLE "TMP_20180602160338_2NF_LGBM_B3" (
	"KEY" BIGINT, 
	"Score_CLASS_0" FLOAT, 
	"Score_CLASS_1" FLOAT, 
	"Score_CLASS_2" FLOAT
...
-- Code For temporary table TMP_20180602160338_2NF_LGBM_B3 part 2. Populate
...
FROM "DT_Output_39")
 INSERT INTO "TMP_20180602160338_2NF_LGBM_B3" ("KEY", "Score_CLASS_0", "Score_CLASS_1", "Score_CLASS_2") SELECT "LGBM_B3"."KEY", "LGBM_B3"."Score_CLASS_0", "LGBM_B3"."Score_CLASS_1", "LGBM_B3"."Score_CLASS_2" 
...
-- Code For temporary table TMP_20180602160338_PBW_LGBM_B4 part 1. Create 


CREATE TEMPORARY TABLE "TMP_20180602160338_PBW_LGBM_B4" (
	"KEY" BIGINT, 
	"Score_CLASS_0" FLOAT, 
	"Score_CLASS_1" FLOAT, 
	"Score_CLASS_2" FLOAT
...
-- Code For temporary table TMP_20180602160338_PBW_LGBM_B4 part 2. Populate
...
FROM "DT_Output_47")
 INSERT INTO "TMP_20180602160338_PBW_LGBM_B4" ("KEY", "Score_CLASS_0", "Score_CLASS_1", "Score_CLASS_2") SELECT "LGBM_B4"."KEY", "LGBM_B4"."Score_CLASS_0", "LGBM_B4"."Score_CLASS_1", "LGBM_B4"."Score_CLASS_2" 
...
-- Code For temporary table TMP_20180602160338_KAH_LGBM_sum part 1. Create 


CREATE TEMPORARY TABLE "TMP_20180602160338_KAH_LGBM_sum" (
	"KEY" BIGINT NOT NULL, 
	"Score_CLASS_0" FLOAT, 
	"Score_CLASS_1" FLOAT, 
	"Score_CLASS_2" FLOAT, 
...
-- Code For temporary table TMP_20180602160338_KAH_LGBM_sum part 2. Populate
...
FROM "TMP_20180602160338_105_LGBM_B0" AS "LGBM_B0" UNION ALL SELECT "LGBM_B1"."KEY" AS "KEY", "LGBM_B1"."Score_CLASS_0" AS "Score_CLASS_0", "LGBM_B1"."Score_CLASS_1" AS "Score_CLASS_1", "LGBM_B1"."Score_CLASS_2" AS "Score_CLASS_2" 
FROM "TMP_20180602160338_1R6_LGBM_B1" AS "LGBM_B1" UNION ALL SELECT "LGBM_B2"."KEY" AS "KEY", "LGBM_B2"."Score_CLASS_0" AS "Score_CLASS_0", "LGBM_B2"."Score_CLASS_1" AS "Score_CLASS_1", "LGBM_B2"."Score_CLASS_2" AS "Score_CLASS_2" 
FROM "TMP_20180602160338_L80_LGBM_B2" AS "LGBM_B2" UNION ALL SELECT "LGBM_B3"."KEY" AS "KEY", "LGBM_B3"."Score_CLASS_0" AS "Score_CLASS_0", "LGBM_B3"."Score_CLASS_1" AS "Score_CLASS_1", "LGBM_B3"."Score_CLASS_2" AS "Score_CLASS_2" 
FROM "TMP_20180602160338_2NF_LGBM_B3" AS "LGBM_B3" UNION ALL SELECT "LGBM_B4"."KEY" AS "KEY", "LGBM_B4"."Score_CLASS_0" AS "Score_CLASS_0", "LGBM_B4"."Score_CLASS_1" AS "Score_CLASS_1", "LGBM_B4"."Score_CLASS_2" AS "Score_CLASS_2" 
FROM "TMP_20180602160338_PBW_LGBM_B4" AS "LGBM_B4") AS "LGBM_EnsembleUnion")
 INSERT INTO "TMP_20180602160338_KAH_LGBM_sum" ("KEY", "Score_CLASS_0", "Score_CLASS_1", "Score_CLASS_2") SELECT "LGBM_sum"."KEY", "LGBM_sum"."Score_CLASS_0", "LGBM_sum"."Score_CLASS_1", "LGBM_sum"."Score_CLASS_2" 
...
-- Code For temporary table TMP_20180602160338_KAH_LGBM_sum part 3. Create Index 

CREATE INDEX "ix_TMP_20180602160338_KAH_LGBM_sum_KEY" ON "TMP_20180602160338_KAH_LGBM_sum" ("KEY")
...
FROM "TMP_20180602160338_KAH_LGBM_sum" AS "LGBM_sum"), 
