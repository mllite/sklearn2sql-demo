...
-- Code For temporary table 611_CODEGEN_T7DTYP_LGBM_B0 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "611_CODEGEN_T7DTYP_LGBM_B0" (
	"KEY" NUMBER(19), 
...
-- Code For temporary table 611_CODEGEN_T7DTYP_LGBM_B0 part 2. Populate

INSERT INTO "611_CODEGEN_T7DTYP_LGBM_B0" ("KEY", "Score_CLASS_0", "Score_CLASS_1", "Score_CLASS_2") SELECT "U"."KEY", "U"."Score_CLASS_0", "U"."Score_CLASS_1", "U"."Score_CLASS_2" 
...
-- Code For temporary table 611_CODEGEN_1GIK7W_LGBM_B1 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "611_CODEGEN_1GIK7W_LGBM_B1" (
	"KEY" NUMBER(19), 
	"Score_CLASS_0" BINARY_DOUBLE, 
	"Score_CLASS_1" BINARY_DOUBLE, 
	"Score_CLASS_2" BINARY_DOUBLE
...
-- Code For temporary table 611_CODEGEN_1GIK7W_LGBM_B1 part 2. Populate

INSERT INTO "611_CODEGEN_1GIK7W_LGBM_B1" ("KEY", "Score_CLASS_0", "Score_CLASS_1", "Score_CLASS_2") SELECT "U"."KEY", "U"."Score_CLASS_0", "U"."Score_CLASS_1", "U"."Score_CLASS_2" 
...
-- Code For temporary table 611_CODEGEN_G4OPFN_LGBM_B2 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "611_CODEGEN_G4OPFN_LGBM_B2" (
	"KEY" NUMBER(19), 
	"Score_CLASS_0" BINARY_DOUBLE, 
	"Score_CLASS_1" BINARY_DOUBLE, 
	"Score_CLASS_2" BINARY_DOUBLE
...
-- Code For temporary table 611_CODEGEN_G4OPFN_LGBM_B2 part 2. Populate

INSERT INTO "611_CODEGEN_G4OPFN_LGBM_B2" ("KEY", "Score_CLASS_0", "Score_CLASS_1", "Score_CLASS_2") SELECT "U"."KEY", "U"."Score_CLASS_0", "U"."Score_CLASS_1", "U"."Score_CLASS_2" 
...
-- Code For temporary table 611_CODEGEN_FYMRPK_LGBM_B3 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "611_CODEGEN_FYMRPK_LGBM_B3" (
	"KEY" NUMBER(19), 
	"Score_CLASS_0" BINARY_DOUBLE, 
	"Score_CLASS_1" BINARY_DOUBLE, 
	"Score_CLASS_2" BINARY_DOUBLE
...
-- Code For temporary table 611_CODEGEN_FYMRPK_LGBM_B3 part 2. Populate

INSERT INTO "611_CODEGEN_FYMRPK_LGBM_B3" ("KEY", "Score_CLASS_0", "Score_CLASS_1", "Score_CLASS_2") SELECT "U"."KEY", "U"."Score_CLASS_0", "U"."Score_CLASS_1", "U"."Score_CLASS_2" 
...
-- Code For temporary table 611_CODEGEN_JZMWJY_LGBM_B4 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "611_CODEGEN_JZMWJY_LGBM_B4" (
	"KEY" NUMBER(19), 
	"Score_CLASS_0" BINARY_DOUBLE, 
	"Score_CLASS_1" BINARY_DOUBLE, 
	"Score_CLASS_2" BINARY_DOUBLE
...
-- Code For temporary table 611_CODEGEN_JZMWJY_LGBM_B4 part 2. Populate

INSERT INTO "611_CODEGEN_JZMWJY_LGBM_B4" ("KEY", "Score_CLASS_0", "Score_CLASS_1", "Score_CLASS_2") SELECT "U"."KEY", "U"."Score_CLASS_0", "U"."Score_CLASS_1", "U"."Score_CLASS_2" 
...
-- Code For temporary table _CODEGEN_NMYWK7_LGBM_UNION part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "_CODEGEN_NMYWK7_LGBM_UNION" (
	"KEY" NUMBER(19), 
	"Score_CLASS_0" BINARY_DOUBLE, 
	"Score_CLASS_1" BINARY_DOUBLE, 
	"Score_CLASS_2" BINARY_DOUBLE
...
-- Code For temporary table _CODEGEN_NMYWK7_LGBM_UNION part 2. Populate

INSERT INTO "_CODEGEN_NMYWK7_LGBM_UNION" ("KEY", "Score_CLASS_0", "Score_CLASS_1", "Score_CLASS_2") SELECT "U"."KEY", "U"."Score_CLASS_0", "U"."Score_CLASS_1", "U"."Score_CLASS_2" 
...
FROM "611_CODEGEN_T7DTYP_LGBM_B0" "LGBM_B0" UNION ALL SELECT "LGBM_B1"."KEY" AS "KEY", "LGBM_B1"."Score_CLASS_0" AS "Score_CLASS_0", "LGBM_B1"."Score_CLASS_1" AS "Score_CLASS_1", "LGBM_B1"."Score_CLASS_2" AS "Score_CLASS_2" 
FROM "611_CODEGEN_1GIK7W_LGBM_B1" "LGBM_B1" UNION ALL SELECT "LGBM_B2"."KEY" AS "KEY", "LGBM_B2"."Score_CLASS_0" AS "Score_CLASS_0", "LGBM_B2"."Score_CLASS_1" AS "Score_CLASS_1", "LGBM_B2"."Score_CLASS_2" AS "Score_CLASS_2" 
FROM "611_CODEGEN_G4OPFN_LGBM_B2" "LGBM_B2" UNION ALL SELECT "LGBM_B3"."KEY" AS "KEY", "LGBM_B3"."Score_CLASS_0" AS "Score_CLASS_0", "LGBM_B3"."Score_CLASS_1" AS "Score_CLASS_1", "LGBM_B3"."Score_CLASS_2" AS "Score_CLASS_2" 
FROM "611_CODEGEN_FYMRPK_LGBM_B3" "LGBM_B3" UNION ALL SELECT "LGBM_B4"."KEY" AS "KEY", "LGBM_B4"."Score_CLASS_0" AS "Score_CLASS_0", "LGBM_B4"."Score_CLASS_1" AS "Score_CLASS_1", "LGBM_B4"."Score_CLASS_2" AS "Score_CLASS_2" 
FROM "611_CODEGEN_JZMWJY_LGBM_B4" "LGBM_B4") "LGBM_EnsembleUnion") "LGBM_Union") "U"

-- Code For temporary table 11_CODEGEN_ZU82BJ_LGBM_SUM part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "11_CODEGEN_ZU82BJ_LGBM_SUM" (
	"KEY" NUMBER(19), 
	"Score_CLASS_0" BINARY_DOUBLE, 
	"Score_CLASS_1" BINARY_DOUBLE, 
	"Score_CLASS_2" BINARY_DOUBLE
...
-- Code For temporary table 11_CODEGEN_ZU82BJ_LGBM_SUM part 2. Populate

INSERT INTO "11_CODEGEN_ZU82BJ_LGBM_SUM" ("KEY", "Score_CLASS_0", "Score_CLASS_1", "Score_CLASS_2") SELECT "U"."KEY", "U"."Score_CLASS_0", "U"."Score_CLASS_1", "U"."Score_CLASS_2" 
...
FROM "_CODEGEN_NMYWK7_LGBM_UNION" "LGBM_Union" GROUP BY "LGBM_Union"."KEY") "T") "LGBM_sum") "U"
...
FROM "11_CODEGEN_ZU82BJ_LGBM_SUM" "LGBM_sum"), 
