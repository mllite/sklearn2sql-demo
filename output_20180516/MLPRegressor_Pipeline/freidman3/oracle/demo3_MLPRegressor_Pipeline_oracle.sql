...
-- Code For temporary table DEGEN_VGRY4Z_ADS_IMP_1_OUT part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "DEGEN_VGRY4Z_ADS_IMP_1_OUT" (
	"KEY" NUMBER(19), 
...
-- Code For temporary table DEGEN_VGRY4Z_ADS_IMP_1_OUT part 2. Populate

INSERT INTO "DEGEN_VGRY4Z_ADS_IMP_1_OUT" ("KEY", imputer_output_2, imputer_output_3, imputer_output_4, imputer_output_5) SELECT "U"."KEY", "U".imputer_output_2, "U".imputer_output_3, "U".imputer_output_4, "U".imputer_output_5 
...
-- Code For temporary table DEGEN_UWFI56_ADS_SCA_2_OUT part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "DEGEN_UWFI56_ADS_SCA_2_OUT" (
	"KEY" NUMBER(19), 
...
-- Code For temporary table DEGEN_UWFI56_ADS_SCA_2_OUT part 2. Populate

INSERT INTO "DEGEN_UWFI56_ADS_SCA_2_OUT" ("KEY", scaler_output_2, scaler_output_3, scaler_output_4, scaler_output_5) SELECT "U"."KEY", "U".scaler_output_2, "U".scaler_output_3, "U".scaler_output_4, "U".scaler_output_5 
...
FROM "DEGEN_VGRY4Z_ADS_IMP_1_OUT" "ADS_imp_1_OUT") "ADS_sca_2_OUT") "U"

-- Code For temporary table CODEGEN_7STHHR_HL_1_RELU_1 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "CODEGEN_7STHHR_HL_1_RELU_1" (
	"KEY" NUMBER(19), 
...
-- Code For temporary table CODEGEN_7STHHR_HL_1_RELU_1 part 2. Populate

INSERT INTO "CODEGEN_7STHHR_HL_1_RELU_1" ("KEY", "NEUR_1_1", "NEUR_1_2", "NEUR_1_3") SELECT "U"."KEY", "U"."NEUR_1_1", "U"."NEUR_1_2", "U"."NEUR_1_3" 
FROM (WITH "IL" AS 
...
FROM "DEGEN_UWFI56_ADS_SCA_2_OUT" "ADS_sca_2_OUT"), 
"HL_BA_1" AS 
...
-- Code For temporary table DEGEN_MLAP5N_OL_IDENTITY_1 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "DEGEN_MLAP5N_OL_IDENTITY_1" (
	"KEY" NUMBER(19), 
...
-- Code For temporary table DEGEN_MLAP5N_OL_IDENTITY_1 part 2. Populate

INSERT INTO "DEGEN_MLAP5N_OL_IDENTITY_1" ("KEY", "NEUR_3_1") SELECT "U"."KEY", "U"."NEUR_3_1" 
...
FROM "CODEGEN_7STHHR_HL_1_RELU_1" "HL_1_relu_1"), 
"HL_2_relu" AS 
...
FROM "DEGEN_MLAP5N_OL_IDENTITY_1" "OL_identity_1"