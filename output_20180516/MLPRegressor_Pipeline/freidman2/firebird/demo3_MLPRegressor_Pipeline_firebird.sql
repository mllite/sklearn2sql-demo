...
-- Code For temporary table TMP_20180516_CODEGEN_J9I31I_ADS part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180516_CODEGEN_J9I31I_ADS" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20180516_CODEGEN_J9I31I_ADS part 2. Populate

INSERT INTO "TMP_20180516_CODEGEN_J9I31I_ADS" ("KEY", imputer_output_2, imputer_output_3, imputer_output_4, imputer_output_5) SELECT "U"."KEY", "U".imputer_output_2, "U".imputer_output_3, "U".imputer_output_4, "U".imputer_output_5 
...
-- Code For temporary table TMP_20180516_CODEGEN_J9I31I_ADS part 3. Create Index 

CREATE INDEX "ix_TMP_20180516_CODEGEN_64e6" ON "TMP_20180516_CODEGEN_J9I31I_ADS" ("KEY")

-- Code For temporary table TMP_20180516_CODEGEN_P0TPW9_ADS part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180516_CODEGEN_P0TPW9_ADS" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20180516_CODEGEN_P0TPW9_ADS part 2. Populate

INSERT INTO "TMP_20180516_CODEGEN_P0TPW9_ADS" ("KEY", scaler_output_2, scaler_output_3, scaler_output_4, scaler_output_5) SELECT "U"."KEY", "U".scaler_output_2, "U".scaler_output_3, "U".scaler_output_4, "U".scaler_output_5 
...
FROM "TMP_20180516_CODEGEN_J9I31I_ADS" AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT") AS "U"

-- Code For temporary table TMP_20180516_CODEGEN_P0TPW9_ADS part 3. Create Index 

CREATE INDEX "ix_TMP_20180516_CODEGEN_1bbc" ON "TMP_20180516_CODEGEN_P0TPW9_ADS" ("KEY")

-- Code For temporary table TMP_20180516_CODEGEN_NMIN9X_HL_ part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180516_CODEGEN_NMIN9X_HL_" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20180516_CODEGEN_NMIN9X_HL_ part 2. Populate

INSERT INTO "TMP_20180516_CODEGEN_NMIN9X_HL_" ("KEY", "NEUR_1_1", "NEUR_1_2", "NEUR_1_3") SELECT "U"."KEY", "U"."NEUR_1_1", "U"."NEUR_1_2", "U"."NEUR_1_3" 
FROM (WITH "IL" AS 
...
FROM "TMP_20180516_CODEGEN_P0TPW9_ADS" AS "ADS_sca_2_OUT"), 
"HL_BA_1" AS 
...
-- Code For temporary table TMP_20180516_CODEGEN_NMIN9X_HL_ part 3. Create Index 

CREATE INDEX "ix_TMP_20180516_CODEGEN_f7da" ON "TMP_20180516_CODEGEN_NMIN9X_HL_" ("KEY")

-- Code For temporary table TMP_20180516_CODEGEN_B65UIW_OL_ part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180516_CODEGEN_B65UIW_OL_" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20180516_CODEGEN_B65UIW_OL_ part 2. Populate

INSERT INTO "TMP_20180516_CODEGEN_B65UIW_OL_" ("KEY", "NEUR_3_1") SELECT "U"."KEY", "U"."NEUR_3_1" 
...
FROM "TMP_20180516_CODEGEN_NMIN9X_HL_" AS "HL_1_relu_1"), 
"HL_2_relu" AS 
...
-- Code For temporary table TMP_20180516_CODEGEN_B65UIW_OL_ part 3. Create Index 

CREATE INDEX "ix_TMP_20180516_CODEGEN_29b6" ON "TMP_20180516_CODEGEN_B65UIW_OL_" ("KEY")

-- Model deployment code

SELECT "OL_identity_1"."KEY" AS "KEY", "OL_identity_1"."NEUR_3_1" AS "Estimator" 
FROM "TMP_20180516_CODEGEN_B65UIW_OL_" AS "OL_identity_1"