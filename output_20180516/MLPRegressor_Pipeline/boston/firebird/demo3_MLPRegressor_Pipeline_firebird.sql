...
-- Code For temporary table TMP_20180516_CODEGEN_90KHM1_ADS part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180516_CODEGEN_90KHM1_ADS" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20180516_CODEGEN_90KHM1_ADS part 3. Create Index 

CREATE INDEX "ix_TMP_20180516_CODEGEN_3802" ON "TMP_20180516_CODEGEN_90KHM1_ADS" ("KEY")

-- Code For temporary table TMP_20180516_CODEGEN_DLNQ9Q_ADS part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180516_CODEGEN_DLNQ9Q_ADS" (
	"KEY" BIGINT NOT NULL, 
...
FROM "TMP_20180516_CODEGEN_90KHM1_ADS" AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT") AS "U"

-- Code For temporary table TMP_20180516_CODEGEN_DLNQ9Q_ADS part 3. Create Index 

CREATE INDEX "ix_TMP_20180516_CODEGEN_fc91" ON "TMP_20180516_CODEGEN_DLNQ9Q_ADS" ("KEY")

-- Code For temporary table TMP_20180516_CODEGEN_Z4LG1R_HL_ part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180516_CODEGEN_Z4LG1R_HL_" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20180516_CODEGEN_Z4LG1R_HL_ part 2. Populate

INSERT INTO "TMP_20180516_CODEGEN_Z4LG1R_HL_" ("KEY", "NEUR_1_1", "NEUR_1_2", "NEUR_1_3") SELECT "U"."KEY", "U"."NEUR_1_1", "U"."NEUR_1_2", "U"."NEUR_1_3" 
FROM (WITH "IL" AS 
...
FROM "TMP_20180516_CODEGEN_DLNQ9Q_ADS" AS "ADS_sca_2_OUT"), 
"HL_BA_1" AS 
...
-- Code For temporary table TMP_20180516_CODEGEN_Z4LG1R_HL_ part 3. Create Index 

CREATE INDEX "ix_TMP_20180516_CODEGEN_f09d" ON "TMP_20180516_CODEGEN_Z4LG1R_HL_" ("KEY")

-- Code For temporary table TMP_20180516_CODEGEN_K0IZ0A_OL_ part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180516_CODEGEN_K0IZ0A_OL_" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20180516_CODEGEN_K0IZ0A_OL_ part 2. Populate

INSERT INTO "TMP_20180516_CODEGEN_K0IZ0A_OL_" ("KEY", "NEUR_3_1") SELECT "U"."KEY", "U"."NEUR_3_1" 
...
FROM "TMP_20180516_CODEGEN_Z4LG1R_HL_" AS "HL_1_relu_1"), 
"HL_2_relu" AS 
...
-- Code For temporary table TMP_20180516_CODEGEN_K0IZ0A_OL_ part 3. Create Index 

CREATE INDEX "ix_TMP_20180516_CODEGEN_1cbe" ON "TMP_20180516_CODEGEN_K0IZ0A_OL_" ("KEY")

-- Model deployment code

SELECT "OL_identity_1"."KEY" AS "KEY", "OL_identity_1"."NEUR_3_1" AS "Estimator" 
FROM "TMP_20180516_CODEGEN_K0IZ0A_OL_" AS "OL_identity_1"