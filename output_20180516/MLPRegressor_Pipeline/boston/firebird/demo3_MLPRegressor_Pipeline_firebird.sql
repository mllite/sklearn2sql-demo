...
-- Code For temporary table TMP_20180508183037_CODEGEN_CK6D part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508183037_CODEGEN_CK6D" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20180508183037_CODEGEN_CK6D part 2. Populate

INSERT INTO "TMP_20180508183037_CODEGEN_CK6D" ("KEY", impter_2, impter_3, impter_4, impter_5, impter_6, impter_7, impter_8, impter_9, impter_10, impter_11, impter_12, impter_13, impter_14) SELECT "U"."KEY", "U".impter_2, "U".impter_3, "U".impter_4, "U".impter_5, "U".impter_6, "U".impter_7, "U".impter_8, "U".impter_9, "U".impter_10, "U".impter_11, "U".impter_12, "U".impter_13, "U".impter_14 
...
-- Code For temporary table TMP_20180508183037_CODEGEN_CK6D part 3. Create Index 

CREATE INDEX "ix_TMP_20180508183037_C_cf88" ON "TMP_20180508183037_CODEGEN_CK6D" ("KEY")

-- Code For temporary table TMP_20180508183037_CODEGEN_TBWF part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508183037_CODEGEN_TBWF" (
	"KEY" BIGINT NOT NULL, 
...
FROM "TMP_20180508183037_CODEGEN_CK6D" AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT") AS "U"

-- Code For temporary table TMP_20180508183037_CODEGEN_TBWF part 3. Create Index 

CREATE INDEX "ix_TMP_20180508183037_C_f85e" ON "TMP_20180508183037_CODEGEN_TBWF" ("KEY")

-- Code For temporary table TMP_20180508183037_CODEGEN_RF6T part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508183037_CODEGEN_RF6T" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20180508183037_CODEGEN_RF6T part 2. Populate

INSERT INTO "TMP_20180508183037_CODEGEN_RF6T" ("KEY", "NEUR_1_1", "NEUR_1_2", "NEUR_1_3") SELECT "U"."KEY", "U"."NEUR_1_1", "U"."NEUR_1_2", "U"."NEUR_1_3" 
FROM (WITH "IL" AS 
...
FROM "TMP_20180508183037_CODEGEN_TBWF" AS "ADS_sca_2_OUT"), 
"HL_BA_1" AS 
...
-- Code For temporary table TMP_20180508183037_CODEGEN_RF6T part 3. Create Index 

CREATE INDEX "ix_TMP_20180508183037_C_a664" ON "TMP_20180508183037_CODEGEN_RF6T" ("KEY")

-- Code For temporary table TMP_20180508183037_CODEGEN_A5Z9 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508183037_CODEGEN_A5Z9" (
	"KEY" BIGINT NOT NULL, 
...
-- Code For temporary table TMP_20180508183037_CODEGEN_A5Z9 part 2. Populate

INSERT INTO "TMP_20180508183037_CODEGEN_A5Z9" ("KEY", "NEUR_3_1") SELECT "U"."KEY", "U"."NEUR_3_1" 
...
FROM "TMP_20180508183037_CODEGEN_RF6T" AS "HL_1_relu_1"), 
"HL_2_relu" AS 
...
-- Code For temporary table TMP_20180508183037_CODEGEN_A5Z9 part 3. Create Index 

CREATE INDEX "ix_TMP_20180508183037_C_ee0b" ON "TMP_20180508183037_CODEGEN_A5Z9" ("KEY")

-- Model deployment code

SELECT "OL_identity_1"."KEY" AS "KEY", "OL_identity_1"."NEUR_3_1" AS "Estimator" 
FROM "TMP_20180508183037_CODEGEN_A5Z9" AS "OL_identity_1"