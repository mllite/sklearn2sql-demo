...
-- Code For temporary table ##TMP_20180516120823_CODEGEN_ZBNVLS_ADS_imp_1_OUT part 1. Create 


CREATE TABLE ##TMP_20180516120823_CODEGEN_ZBNVLS_ADS_imp_1_OUT (
	[KEY] BIGINT NULL, 
...
-- Code For temporary table ##TMP_20180516120823_CODEGEN_ZBNVLS_ADS_imp_1_OUT part 2. Populate

INSERT INTO ##TMP_20180516120823_CODEGEN_ZBNVLS_ADS_imp_1_OUT ([KEY], impter_2, impter_3, impter_4, impter_5, impter_6, impter_7, impter_8, impter_9, impter_10, impter_11) SELECT [ADS_imp_1_OUT].[KEY], [ADS_imp_1_OUT].impter_2, [ADS_imp_1_OUT].impter_3, [ADS_imp_1_OUT].impter_4, [ADS_imp_1_OUT].impter_5, [ADS_imp_1_OUT].impter_6, [ADS_imp_1_OUT].impter_7, [ADS_imp_1_OUT].impter_8, [ADS_imp_1_OUT].impter_9, [ADS_imp_1_OUT].impter_10, [ADS_imp_1_OUT].impter_11 
...
-- Code For temporary table ##TMP_20180516120823_CODEGEN_D7WJ0F_ADS_sca_2_OUT part 1. Create 


CREATE TABLE ##TMP_20180516120823_CODEGEN_D7WJ0F_ADS_sca_2_OUT (
	[KEY] BIGINT NULL, 
	scaler_2 FLOAT NULL, 
	scaler_3 FLOAT NULL, 
	scaler_4 FLOAT NULL, 
...
FROM ##TMP_20180516120823_CODEGEN_ZBNVLS_ADS_imp_1_OUT AS [ADS_imp_1_OUT]) AS [ADS_sca_2_OUT]

-- Code For temporary table ##TMP_20180516120823_CODEGEN_QT5PUV_HL_1_relu_1 part 1. Create 


CREATE TABLE ##TMP_20180516120823_CODEGEN_QT5PUV_HL_1_relu_1 (
	[KEY] BIGINT NULL, 
	[NEUR_1_1] FLOAT NULL, 
	[NEUR_1_2] FLOAT NULL, 
	[NEUR_1_3] FLOAT NULL
...
-- Code For temporary table ##TMP_20180516120823_CODEGEN_QT5PUV_HL_1_relu_1 part 2. Populate
...
FROM ##TMP_20180516120823_CODEGEN_D7WJ0F_ADS_sca_2_OUT AS [ADS_sca_2_OUT]), 
[HL_BA_1] AS 
...
FROM [HL_BA_1])
 INSERT INTO ##TMP_20180516120823_CODEGEN_QT5PUV_HL_1_relu_1 ([KEY], [NEUR_1_1], [NEUR_1_2], [NEUR_1_3]) SELECT [HL_1_relu_1].[KEY], [HL_1_relu_1].[NEUR_1_1], [HL_1_relu_1].[NEUR_1_2], [HL_1_relu_1].[NEUR_1_3] 
FROM (SELECT [HL_1_relu].[KEY] AS [KEY], [HL_1_relu].[NEUR_1_1] AS [NEUR_1_1], [HL_1_relu].[NEUR_1_2] AS [NEUR_1_2], [HL_1_relu].[NEUR_1_3] AS [NEUR_1_3] 
FROM [HL_1_relu]) AS [HL_1_relu_1]

-- Code For temporary table ##TMP_20180516120823_CODEGEN_27BBP5_OL_identity_1 part 1. Create 


CREATE TABLE ##TMP_20180516120823_CODEGEN_27BBP5_OL_identity_1 (
	[KEY] BIGINT NULL, 
	[NEUR_3_1] FLOAT NULL
)
...
-- Code For temporary table ##TMP_20180516120823_CODEGEN_27BBP5_OL_identity_1 part 2. Populate
...
FROM ##TMP_20180516120823_CODEGEN_QT5PUV_HL_1_relu_1 AS [HL_1_relu_1]), 
[HL_2_relu] AS 
...
FROM [OL_BA])
 INSERT INTO ##TMP_20180516120823_CODEGEN_27BBP5_OL_identity_1 ([KEY], [NEUR_3_1]) SELECT [OL_identity_1].[KEY], [OL_identity_1].[NEUR_3_1] 
...
FROM ##TMP_20180516120823_CODEGEN_27BBP5_OL_identity_1 AS [OL_identity_1]