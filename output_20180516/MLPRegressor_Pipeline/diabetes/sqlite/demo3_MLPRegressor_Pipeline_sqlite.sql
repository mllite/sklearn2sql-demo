...
-- Code For temporary table TMP_20180516115356_CODEGEN_YQ066W_ADS_imp_1_OUT part 1. Create 


CREATE TEMPORARY TABLE "TMP_20180516115356_CODEGEN_YQ066W_ADS_imp_1_OUT" (
	"KEY" BIGINT NOT NULL, 
	impter_2 FLOAT, 
	impter_3 FLOAT, 
	impter_4 FLOAT, 
...
-- Code For temporary table TMP_20180516115356_CODEGEN_YQ066W_ADS_imp_1_OUT part 2. Populate

INSERT INTO "TMP_20180516115356_CODEGEN_YQ066W_ADS_imp_1_OUT" ("KEY", impter_2, impter_3, impter_4, impter_5, impter_6, impter_7, impter_8, impter_9, impter_10, impter_11) SELECT "ADS_imp_1_OUT"."KEY", "ADS_imp_1_OUT".impter_2, "ADS_imp_1_OUT".impter_3, "ADS_imp_1_OUT".impter_4, "ADS_imp_1_OUT".impter_5, "ADS_imp_1_OUT".impter_6, "ADS_imp_1_OUT".impter_7, "ADS_imp_1_OUT".impter_8, "ADS_imp_1_OUT".impter_9, "ADS_imp_1_OUT".impter_10, "ADS_imp_1_OUT".impter_11 
...
-- Code For temporary table TMP_20180516115356_CODEGEN_YQ066W_ADS_imp_1_OUT part 3. Create Index 

CREATE INDEX "ix_TMP_20180516115356_CODEGEN_YQ066W_ADS_imp_1_OUT_KEY" ON "TMP_20180516115356_CODEGEN_YQ066W_ADS_imp_1_OUT" ("KEY")

-- Code For temporary table TMP_20180516115356_CODEGEN_TZNDOW_ADS_sca_2_OUT part 1. Create 


CREATE TEMPORARY TABLE "TMP_20180516115356_CODEGEN_TZNDOW_ADS_sca_2_OUT" (
	"KEY" BIGINT NOT NULL, 
	scaler_2 FLOAT, 
	scaler_3 FLOAT, 
	scaler_4 FLOAT, 
...
-- Code For temporary table TMP_20180516115356_CODEGEN_TZNDOW_ADS_sca_2_OUT part 2. Populate

INSERT INTO "TMP_20180516115356_CODEGEN_TZNDOW_ADS_sca_2_OUT" ("KEY", scaler_2, scaler_3, scaler_4, scaler_5, scaler_6, scaler_7, scaler_8, scaler_9, scaler_10, scaler_11) SELECT "ADS_sca_2_OUT"."KEY", "ADS_sca_2_OUT".scaler_2, "ADS_sca_2_OUT".scaler_3, "ADS_sca_2_OUT".scaler_4, "ADS_sca_2_OUT".scaler_5, "ADS_sca_2_OUT".scaler_6, "ADS_sca_2_OUT".scaler_7, "ADS_sca_2_OUT".scaler_8, "ADS_sca_2_OUT".scaler_9, "ADS_sca_2_OUT".scaler_10, "ADS_sca_2_OUT".scaler_11 
...
FROM "TMP_20180516115356_CODEGEN_YQ066W_ADS_imp_1_OUT" AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT"

-- Code For temporary table TMP_20180516115356_CODEGEN_TZNDOW_ADS_sca_2_OUT part 3. Create Index 

CREATE INDEX "ix_TMP_20180516115356_CODEGEN_TZNDOW_ADS_sca_2_OUT_KEY" ON "TMP_20180516115356_CODEGEN_TZNDOW_ADS_sca_2_OUT" ("KEY")

-- Code For temporary table TMP_20180516115356_CODEGEN_AV0LRJ_HL_1_relu_1 part 1. Create 


CREATE TEMPORARY TABLE "TMP_20180516115356_CODEGEN_AV0LRJ_HL_1_relu_1" (
	"KEY" BIGINT NOT NULL, 
	"NEUR_1_1" FLOAT, 
	"NEUR_1_2" FLOAT, 
	"NEUR_1_3" FLOAT, 
...
-- Code For temporary table TMP_20180516115356_CODEGEN_AV0LRJ_HL_1_relu_1 part 2. Populate
...
FROM "TMP_20180516115356_CODEGEN_TZNDOW_ADS_sca_2_OUT" AS "ADS_sca_2_OUT"), 
"HL_BA_1" AS 
...
FROM "HL_BA_1")
 INSERT INTO "TMP_20180516115356_CODEGEN_AV0LRJ_HL_1_relu_1" ("KEY", "NEUR_1_1", "NEUR_1_2", "NEUR_1_3") SELECT "HL_1_relu_1"."KEY", "HL_1_relu_1"."NEUR_1_1", "HL_1_relu_1"."NEUR_1_2", "HL_1_relu_1"."NEUR_1_3" 
FROM (SELECT "HL_1_relu"."KEY" AS "KEY", "HL_1_relu"."NEUR_1_1" AS "NEUR_1_1", "HL_1_relu"."NEUR_1_2" AS "NEUR_1_2", "HL_1_relu"."NEUR_1_3" AS "NEUR_1_3" 
FROM "HL_1_relu") AS "HL_1_relu_1"

-- Code For temporary table TMP_20180516115356_CODEGEN_AV0LRJ_HL_1_relu_1 part 3. Create Index 

CREATE INDEX "ix_TMP_20180516115356_CODEGEN_AV0LRJ_HL_1_relu_1_KEY" ON "TMP_20180516115356_CODEGEN_AV0LRJ_HL_1_relu_1" ("KEY")

-- Code For temporary table TMP_20180516115356_CODEGEN_BE3BC0_OL_identity_1 part 1. Create 


CREATE TEMPORARY TABLE "TMP_20180516115356_CODEGEN_BE3BC0_OL_identity_1" (
	"KEY" BIGINT NOT NULL, 
	"NEUR_3_1" FLOAT, 
	PRIMARY KEY ("KEY")
)
...
-- Code For temporary table TMP_20180516115356_CODEGEN_BE3BC0_OL_identity_1 part 2. Populate
...
FROM "TMP_20180516115356_CODEGEN_AV0LRJ_HL_1_relu_1" AS "HL_1_relu_1"), 
"HL_2_relu" AS 
...
FROM "OL_BA")
 INSERT INTO "TMP_20180516115356_CODEGEN_BE3BC0_OL_identity_1" ("KEY", "NEUR_3_1") SELECT "OL_identity_1"."KEY", "OL_identity_1"."NEUR_3_1" 
FROM (SELECT "OL_identity"."KEY" AS "KEY", "OL_identity"."NEUR_3_1" AS "NEUR_3_1" 
FROM "OL_identity") AS "OL_identity_1"

-- Code For temporary table TMP_20180516115356_CODEGEN_BE3BC0_OL_identity_1 part 3. Create Index 

CREATE INDEX "ix_TMP_20180516115356_CODEGEN_BE3BC0_OL_identity_1_KEY" ON "TMP_20180516115356_CODEGEN_BE3BC0_OL_identity_1" ("KEY")

-- Model deployment code

SELECT "OL_identity_1"."KEY" AS "KEY", "OL_identity_1"."NEUR_3_1" AS "Estimator" 
FROM "TMP_20180516115356_CODEGEN_BE3BC0_OL_identity_1" AS "OL_identity_1"