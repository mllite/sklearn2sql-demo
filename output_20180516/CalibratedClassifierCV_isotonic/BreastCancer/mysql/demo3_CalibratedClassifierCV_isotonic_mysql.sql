...
-- Code For temporary table TMP_20180516111509_CODEGEN_4BAY3H_CalProb_B0 part 1. Create 


CREATE TEMPORARY TABLE `TMP_20180516111509_CODEGEN_4BAY3H_CalProb_B0` (
	`KEY` BIGINT, 
	`Proba_1` DOUBLE, 
	`Proba_0` DOUBLE
)
...
-- Code For temporary table TMP_20180516111509_CODEGEN_4BAY3H_CalProb_B0 part 2. Populate

INSERT INTO `TMP_20180516111509_CODEGEN_4BAY3H_CalProb_B0` (`KEY`, `Proba_1`, `Proba_0`) SELECT `U`.`KEY`, `U`.`Proba_1`, `U`.`Proba_0` 
...
-- Code For temporary table TMP_20180516111509_CODEGEN_JWXGAF_CalProb_avg part 1. Create 


CREATE TEMPORARY TABLE `TMP_20180516111509_CODEGEN_JWXGAF_CalProb_avg` (
	`KEY` BIGINT NOT NULL, 
	`Proba_1` DOUBLE, 
	`Proba_0` DOUBLE, 
	PRIMARY KEY (`KEY`)
...
-- Code For temporary table TMP_20180516111509_CODEGEN_JWXGAF_CalProb_avg part 2. Populate

INSERT INTO `TMP_20180516111509_CODEGEN_JWXGAF_CalProb_avg` (`KEY`, `Proba_1`, `Proba_0`) SELECT `U`.`KEY`, `U`.`Proba_1`, `U`.`Proba_0` 
...
FROM `TMP_20180516111509_CODEGEN_4BAY3H_CalProb_B0` AS `CalProb_B0`) AS `CalProb_EnsembleUnion`)
...
-- Code For temporary table TMP_20180516111509_CODEGEN_JWXGAF_CalProb_avg part 3. Create Index 

CREATE INDEX `ix_TMP_20180516111509_CODEGEN_JWXGAF_CalProb_avg_KEY` ON `TMP_20180516111509_CODEGEN_JWXGAF_CalProb_avg` (`KEY`)
...
FROM `TMP_20180516111509_CODEGEN_JWXGAF_CalProb_avg` AS `CalProb_avg`), 
