...
-- Code For temporary table tmp_20180516111510_codegen_mqyk1q_calprob_b0 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180516111510_codegen_mqyk1q_calprob_b0  (
	"KEY" BIGINT, 
...
-- Code For temporary table tmp_20180516111510_codegen_mqyk1q_calprob_b0 part 2. Populate

INSERT INTO tmp_20180516111510_codegen_mqyk1q_calprob_b0 ("KEY", "Proba_1", "Proba_0") SELECT "U"."KEY", "U"."Proba_1", "U"."Proba_0" 
...
-- Code For temporary table tmp_20180516111510_codegen_reyu6y_calprob_avg part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180516111510_codegen_reyu6y_calprob_avg  (
	"KEY" BIGINT, 
	"Proba_1" DOUBLE PRECISION, 
	"Proba_0" DOUBLE PRECISION
)
...
-- Code For temporary table tmp_20180516111510_codegen_reyu6y_calprob_avg part 2. Populate

INSERT INTO tmp_20180516111510_codegen_reyu6y_calprob_avg ("KEY", "Proba_1", "Proba_0") SELECT "U"."KEY", "U"."Proba_1", "U"."Proba_0" 
...
FROM tmp_20180516111510_codegen_mqyk1q_calprob_b0 AS "CalProb_B0") AS "CalProb_EnsembleUnion")
...
FROM tmp_20180516111510_codegen_reyu6y_calprob_avg AS "CalProb_avg"), 
