...
-- Code For temporary table _CODEGEN_SFPQF1_CALPROB_B0 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "_CODEGEN_SFPQF1_CALPROB_B0" (
	"KEY" NUMBER(19), 
...
-- Code For temporary table _CODEGEN_SFPQF1_CALPROB_B0 part 2. Populate

INSERT INTO "_CODEGEN_SFPQF1_CALPROB_B0" ("KEY", "Proba_1", "Proba_0") SELECT "U"."KEY", "U"."Proba_1", "U"."Proba_0" 
...
-- Code For temporary table CODEGEN_WOXDA9_CALPROB_AVG part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "CODEGEN_WOXDA9_CALPROB_AVG" (
	"KEY" NUMBER(19), 
	"Proba_1" BINARY_DOUBLE, 
	"Proba_0" BINARY_DOUBLE
)
...
-- Code For temporary table CODEGEN_WOXDA9_CALPROB_AVG part 2. Populate

INSERT INTO "CODEGEN_WOXDA9_CALPROB_AVG" ("KEY", "Proba_1", "Proba_0") SELECT "U"."KEY", "U"."Proba_1", "U"."Proba_0" 
...
FROM "_CODEGEN_SFPQF1_CALPROB_B0" "CalProb_B0") "CalProb_EnsembleUnion")
...
FROM "CODEGEN_WOXDA9_CALPROB_AVG" "CalProb_avg"), 
