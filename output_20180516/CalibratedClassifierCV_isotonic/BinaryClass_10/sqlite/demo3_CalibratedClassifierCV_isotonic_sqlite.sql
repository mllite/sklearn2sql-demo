...
-- Code For temporary table TMP_20180516110159_CODEGEN_77X83T_CalProb_B0 part 1. Create 


CREATE TEMPORARY TABLE "TMP_20180516110159_CODEGEN_77X83T_CalProb_B0" (
	"KEY" BIGINT, 
	"Proba_1" FLOAT, 
	"Proba_0" FLOAT
)
...
-- Code For temporary table TMP_20180516110159_CODEGEN_77X83T_CalProb_B0 part 2. Populate
...
FROM isotonic_cte_3)
 INSERT INTO "TMP_20180516110159_CODEGEN_77X83T_CalProb_B0" ("KEY", "Proba_1", "Proba_0") SELECT "CalProb_B0"."KEY", "CalProb_B0"."Proba_1", "CalProb_B0"."Proba_0" 
...
-- Code For temporary table TMP_20180516110159_CODEGEN_LIIEF7_CalProb_avg part 1. Create 


CREATE TEMPORARY TABLE "TMP_20180516110159_CODEGEN_LIIEF7_CalProb_avg" (
	"KEY" BIGINT NOT NULL, 
	"Proba_1" FLOAT, 
	"Proba_0" FLOAT, 
	PRIMARY KEY ("KEY")
...
-- Code For temporary table TMP_20180516110159_CODEGEN_LIIEF7_CalProb_avg part 2. Populate
...
FROM "TMP_20180516110159_CODEGEN_77X83T_CalProb_B0" AS "CalProb_B0") AS "CalProb_EnsembleUnion")
 INSERT INTO "TMP_20180516110159_CODEGEN_LIIEF7_CalProb_avg" ("KEY", "Proba_1", "Proba_0") SELECT "CalProb_avg"."KEY", "CalProb_avg"."Proba_1", "CalProb_avg"."Proba_0" 
...
-- Code For temporary table TMP_20180516110159_CODEGEN_LIIEF7_CalProb_avg part 3. Create Index 

CREATE INDEX "ix_TMP_20180516110159_CODEGEN_LIIEF7_CalProb_avg_KEY" ON "TMP_20180516110159_CODEGEN_LIIEF7_CalProb_avg" ("KEY")
...
FROM "TMP_20180516110159_CODEGEN_LIIEF7_CalProb_avg" AS "CalProb_avg"), 
