...
-- Code For temporary table tmp_20180508175719_codegen_no8qdd_calprob_b0 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180508175719_codegen_no8qdd_calprob_b0  (
	"KEY" BIGINT, 
...
-- Code For temporary table tmp_20180508175719_codegen_no8qdd_calprob_b0 part 2. Populate

INSERT INTO tmp_20180508175719_codegen_no8qdd_calprob_b0 ("KEY", "Proba_1", "Proba_0") SELECT "U"."KEY", "U"."Proba_1", "U"."Proba_0" 
FROM (WITH "DT_node_lookup" AS 
(SELECT "ADS"."KEY" AS "KEY", CASE WHEN ("ADS"."Feature_9" <= CAST(0.152860224246979 AS DOUBLE PRECISION)) THEN CASE WHEN ("ADS"."Feature_5" <= CAST(2.370686292648316 AS DOUBLE PRECISION)) THEN CASE WHEN ("ADS"."Feature_5" <= CAST(-1.473185777664184 AS DOUBLE PRECISION)) THEN CASE WHEN ("ADS"."Feature_3" <= CAST(0.849347174167633 AS DOUBLE PRECISION)) THEN 4 ELSE 5 END ELSE 6 END ELSE 7 END ELSE CASE WHEN ("ADS"."Feature_6" <= CAST(1.934103488922119 AS DOUBLE PRECISION)) THEN 9 ELSE 10 END END AS node_id_2 
...
FROM isotonic_cte_2), 
"DT_node_lookup_3" AS 
(SELECT "ADS"."KEY" AS "KEY", CASE WHEN ("ADS"."Feature_9" <= CAST(-0.272910356521606 AS DOUBLE PRECISION)) THEN CASE WHEN ("ADS"."Feature_6" <= CAST(1.62392270565033 AS DOUBLE PRECISION)) THEN CASE WHEN ("ADS"."Feature_5" <= CAST(2.391359567642212 AS DOUBLE PRECISION)) THEN CASE WHEN ("ADS"."Feature_5" <= CAST(-1.473185777664184 AS DOUBLE PRECISION)) THEN CASE WHEN ("ADS"."Feature_0" <= CAST(1.150492906570434 AS DOUBLE PRECISION)) THEN 5 ELSE 6 END ELSE 7 END ELSE 8 END ELSE 9 END ELSE CASE WHEN ("ADS"."Feature_6" <= CAST(1.934103488922119 AS DOUBLE PRECISION)) THEN CASE WHEN ("ADS"."Feature_9" <= CAST(-0.039503190666437 AS DOUBLE PRECISION)) THEN CASE WHEN ("ADS"."Feature_3" <= CAST(-0.098098665475845 AS DOUBLE PRECISION)) THEN 13 ELSE 14 END ELSE 15 END ELSE 16 END END AS node_id_2 
FROM "BinaryClass_10" AS "ADS"), 
dummy_cte_3 AS 
(SELECT CAST(0.0 AS DOUBLE PRECISION) AS "X"), 
"DT_node_data_3" AS 
...
-- Code For temporary table tmp_20180508175719_codegen_fgfkww_calprob_union part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180508175719_codegen_fgfkww_calprob_union  (
	"KEY" BIGINT, 
	"Proba_1" DOUBLE PRECISION, 
	"Proba_0" DOUBLE PRECISION
)
...
-- Code For temporary table tmp_20180508175719_codegen_fgfkww_calprob_union part 2. Populate

INSERT INTO tmp_20180508175719_codegen_fgfkww_calprob_union ("KEY", "Proba_1", "Proba_0") SELECT "U"."KEY", "U"."Proba_1", "U"."Proba_0" 
...
FROM tmp_20180508175719_codegen_no8qdd_calprob_b0 AS "CalProb_B0") AS "CalProb_EnsembleUnion") AS "CalProb_Union") AS "U"

-- Code For temporary table tmp_20180508175719_codegen_tr9y96_calprob_avg part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180508175719_codegen_tr9y96_calprob_avg  (
	"KEY" BIGINT, 
	"Proba_1" DOUBLE PRECISION, 
	"Proba_0" DOUBLE PRECISION
)
...
-- Code For temporary table tmp_20180508175719_codegen_tr9y96_calprob_avg part 2. Populate

INSERT INTO tmp_20180508175719_codegen_tr9y96_calprob_avg ("KEY", "Proba_1", "Proba_0") SELECT "U"."KEY", "U"."Proba_1", "U"."Proba_0" 
...
FROM tmp_20180508175719_codegen_fgfkww_calprob_union AS "CalProb_Union" GROUP BY "CalProb_Union"."KEY") AS "T") AS "CalProb_avg") AS "U"
...
FROM tmp_20180508175719_codegen_tr9y96_calprob_avg AS "CalProb_avg"), 
