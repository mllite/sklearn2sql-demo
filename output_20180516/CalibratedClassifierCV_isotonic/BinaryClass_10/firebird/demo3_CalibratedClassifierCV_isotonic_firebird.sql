...
-- Code For temporary table TMP_20180508175719_CODEGEN_PIA8 part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508175719_CODEGEN_PIA8" (
	"KEY" BIGINT, 
...
-- Code For temporary table TMP_20180508175719_CODEGEN_PIA8 part 2. Populate

INSERT INTO "TMP_20180508175719_CODEGEN_PIA8" ("KEY", "Proba_1", "Proba_0") SELECT "U"."KEY", "U"."Proba_1", "U"."Proba_0" 
...
-- Code For temporary table TMP_20180508175719_CODEGEN_C58V part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508175719_CODEGEN_C58V" (
	"KEY" BIGINT, 
	"Proba_1" DOUBLE PRECISION, 
	"Proba_0" DOUBLE PRECISION
)
...
-- Code For temporary table TMP_20180508175719_CODEGEN_C58V part 2. Populate

INSERT INTO "TMP_20180508175719_CODEGEN_C58V" ("KEY", "Proba_1", "Proba_0") SELECT "U"."KEY", "U"."Proba_1", "U"."Proba_0" 
...
FROM "TMP_20180508175719_CODEGEN_PIA8" AS "CalProb_B0") AS "CalProb_EnsembleUnion") AS "CalProb_Union") AS "U"

-- Code For temporary table TMP_20180508175719_CODEGEN_IMHJ part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "TMP_20180508175719_CODEGEN_IMHJ" (
	"KEY" BIGINT NOT NULL, 
	"Proba_1" DOUBLE PRECISION, 
	"Proba_0" DOUBLE PRECISION, 
	PRIMARY KEY ("KEY")
...
-- Code For temporary table TMP_20180508175719_CODEGEN_IMHJ part 2. Populate

INSERT INTO "TMP_20180508175719_CODEGEN_IMHJ" ("KEY", "Proba_1", "Proba_0") SELECT "U"."KEY", "U"."Proba_1", "U"."Proba_0" 
...
FROM "TMP_20180508175719_CODEGEN_C58V" AS "CalProb_Union" GROUP BY "CalProb_Union"."KEY") AS "T") AS "CalProb_avg") AS "U"

-- Code For temporary table TMP_20180508175719_CODEGEN_IMHJ part 3. Create Index 

CREATE INDEX "ix_TMP_20180508175719_C_08c0" ON "TMP_20180508175719_CODEGEN_IMHJ" ("KEY")
...
FROM "TMP_20180508175719_CODEGEN_IMHJ" AS "CalProb_avg"), 
