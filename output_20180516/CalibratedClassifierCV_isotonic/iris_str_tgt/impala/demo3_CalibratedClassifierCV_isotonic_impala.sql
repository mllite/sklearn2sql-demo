...
-- Code For temporary table tmp_20180516130434_codegen_lq71d1_calprob_b0 part 1. Create 


CREATE TABLE tmp_20180516130434_codegen_lq71d1_calprob_b0 (
	`KEY` BIGINT, 
...
-- Code For temporary table tmp_20180516130434_codegen_lq71d1_calprob_b0 part 2. Populate
...
FROM isotonic_cte_3)
 INSERT INTO tmp_20180516130434_codegen_lq71d1_calprob_b0 (`KEY`, `Proba_CLASS_0`, `Proba_CLASS_1`, `Proba_CLASS_2`) SELECT `CalProb_B0`.`KEY`, `CalProb_B0`.`Proba_CLASS_0`, `CalProb_B0`.`Proba_CLASS_1`, `CalProb_B0`.`Proba_CLASS_2` 
...
-- Code For temporary table tmp_20180516130434_codegen_iq9nyo_calprob_avg part 1. Create 


CREATE TABLE tmp_20180516130434_codegen_iq9nyo_calprob_avg (
	`KEY` BIGINT, 
	`Proba_CLASS_0` DOUBLE, 
	`Proba_CLASS_1` DOUBLE, 
	`Proba_CLASS_2` DOUBLE
...
-- Code For temporary table tmp_20180516130434_codegen_iq9nyo_calprob_avg part 2. Populate
...
FROM tmp_20180516130434_codegen_lq71d1_calprob_b0 AS `CalProb_B0`) AS `CalProb_EnsembleUnion`)
 INSERT INTO tmp_20180516130434_codegen_iq9nyo_calprob_avg (`KEY`, `Proba_CLASS_0`, `Proba_CLASS_1`, `Proba_CLASS_2`) SELECT `CalProb_avg`.`KEY`, `CalProb_avg`.`Proba_CLASS_0`, `CalProb_avg`.`Proba_CLASS_1`, `CalProb_avg`.`Proba_CLASS_2` 
...
FROM tmp_20180516130434_codegen_iq9nyo_calprob_avg AS `CalProb_avg`), 
