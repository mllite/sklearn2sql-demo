...
-- Code For temporary table ##TMP_20180602160150_29B_CalProb_B0 part 1. Create 


CREATE TABLE ##TMP_20180602160150_29B_CalProb_B0 (
	[KEY] BIGINT NULL, 
...
-- Code For temporary table ##TMP_20180602160150_29B_CalProb_B0 part 2. Populate
...
FROM isotonic_cte_3)
 INSERT INTO ##TMP_20180602160150_29B_CalProb_B0 ([KEY], [Proba_CLASS_0], [Proba_CLASS_1], [Proba_CLASS_2]) SELECT [CalProb_B0].[KEY], [CalProb_B0].[Proba_CLASS_0], [CalProb_B0].[Proba_CLASS_1], [CalProb_B0].[Proba_CLASS_2] 
...
-- Code For temporary table ##TMP_20180602160150_SEV_CalProb_avg part 1. Create 


CREATE TABLE ##TMP_20180602160150_SEV_CalProb_avg (
	[KEY] BIGINT NULL, 
...
-- Code For temporary table ##TMP_20180602160150_SEV_CalProb_avg part 2. Populate
...
FROM ##TMP_20180602160150_29B_CalProb_B0 AS [CalProb_B0]) AS [CalProb_EnsembleUnion])
 INSERT INTO ##TMP_20180602160150_SEV_CalProb_avg ([KEY], [Proba_CLASS_0], [Proba_CLASS_1], [Proba_CLASS_2]) SELECT [CalProb_avg].[KEY], [CalProb_avg].[Proba_CLASS_0], [CalProb_avg].[Proba_CLASS_1], [CalProb_avg].[Proba_CLASS_2] 
...
FROM ##TMP_20180602160150_SEV_CalProb_avg AS [CalProb_avg]), 
