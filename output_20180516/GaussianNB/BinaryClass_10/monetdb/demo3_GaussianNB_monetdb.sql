...
-- Code For temporary table tmp_20180516110314_codegen_dwky5y_naivebayes_scores part 1. Create 


CREATE TEMPORARY TABLE tmp_20180516110314_codegen_dwky5y_naivebayes_scores (
	"KEY" BIGINT, 
	"Score_0" DOUBLE, 
	"Score_1" DOUBLE
)
...
-- Code For temporary table tmp_20180516110314_codegen_dwky5y_naivebayes_scores part 2. Populate

INSERT INTO tmp_20180516110314_codegen_dwky5y_naivebayes_scores ("KEY", "Score_0", "Score_1") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1" 
...
FROM tmp_20180516110314_codegen_dwky5y_naivebayes_scores AS "NaiveBayes_Scores"), 
