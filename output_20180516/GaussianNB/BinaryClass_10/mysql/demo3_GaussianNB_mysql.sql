...
-- Code For temporary table TMP_20180602141229_OM9_NaiveBayes_Scores part 1. Create 


CREATE TEMPORARY TABLE `TMP_20180602141229_OM9_NaiveBayes_Scores` (
	`KEY` BIGINT NOT NULL, 
	`Score_0` DOUBLE, 
	`Score_1` DOUBLE, 
	PRIMARY KEY (`KEY`)
...
-- Code For temporary table TMP_20180602141229_OM9_NaiveBayes_Scores part 2. Populate

INSERT INTO `TMP_20180602141229_OM9_NaiveBayes_Scores` (`KEY`, `Score_0`, `Score_1`) SELECT `U`.`KEY`, `U`.`Score_0`, `U`.`Score_1` 
...
-- Code For temporary table TMP_20180602141229_OM9_NaiveBayes_Scores part 3. Create Index 

CREATE INDEX `ix_TMP_20180602141229_OM9_NaiveBayes_Scores_KEY` ON `TMP_20180602141229_OM9_NaiveBayes_Scores` (`KEY`)
...
FROM `TMP_20180602141229_OM9_NaiveBayes_Scores` AS `NaiveBayes_Scores`), 
