...
-- Code For temporary table tmp_20180602141230_qld_naivebayes_scores part 1. Create 


CREATE TABLE tmp_20180602141230_qld_naivebayes_scores (
	`KEY` BIGINT, 
	`Score_0` DOUBLE, 
	`Score_1` DOUBLE
)
...
-- Code For temporary table tmp_20180602141230_qld_naivebayes_scores part 2. Populate
...
FROM centered_data) AS `Values`)
 INSERT INTO tmp_20180602141230_qld_naivebayes_scores (`KEY`, `Score_0`, `Score_1`) SELECT `NaiveBayes_Scores`.`KEY`, `NaiveBayes_Scores`.`Score_0`, `NaiveBayes_Scores`.`Score_1` 
...
FROM tmp_20180602141230_qld_naivebayes_scores AS `NaiveBayes_Scores`), 
