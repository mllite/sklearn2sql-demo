...
-- Code For temporary table 0602_56Q_NAIVEBAYES_SCORES part 1. Create 


CREATE GLOBAL TEMPORARY TABLE "0602_56Q_NAIVEBAYES_SCORES" (
	"KEY" NUMBER(19), 
...
-- Code For temporary table 0602_56Q_NAIVEBAYES_SCORES part 2. Populate

INSERT INTO "0602_56Q_NAIVEBAYES_SCORES" ("KEY", "Score_CLASS_0", "Score_CLASS_1", "Score_CLASS_2") SELECT "U"."KEY", "U"."Score_CLASS_0", "U"."Score_CLASS_1", "U"."Score_CLASS_2" 
FROM (WITH centered_data AS 
(SELECT "ADS"."KEY" AS "KEY", CAST("ADS"."Feature_0" AS BINARY_DOUBLE) - 4.95945945945946 AS "Feature_0_CLASS_0", CAST("ADS"."Feature_1" AS BINARY_DOUBLE) - 3.4162162162162164 AS "Feature_1_CLASS_0", CAST("ADS"."Feature_2" AS BINARY_DOUBLE) - 1.4864864864864862 AS "Feature_2_CLASS_0", CAST("ADS"."Feature_3" AS BINARY_DOUBLE) - 0.2594594594594595 AS "Feature_3_CLASS_0", CAST("ADS"."Feature_0" AS BINARY_DOUBLE) - 5.914999999999999 AS "Feature_0_CLASS_1", CAST("ADS"."Feature_1" AS BINARY_DOUBLE) - 2.7600000000000007 AS "Feature_1_CLASS_1", CAST("ADS"."Feature_2" AS BINARY_DOUBLE) - 4.245 AS "Feature_2_CLASS_1", CAST("ADS"."Feature_3" AS BINARY_DOUBLE) - 1.325 AS "Feature_3_CLASS_1", CAST("ADS"."Feature_0" AS BINARY_DOUBLE) - 6.548837209302325 AS "Feature_0_CLASS_2", CAST("ADS"."Feature_1" AS BINARY_DOUBLE) - 2.9674418604651165 AS "Feature_1_CLASS_2", CAST("ADS"."Feature_2" AS BINARY_DOUBLE) - 5.502325581395348 AS "Feature_2_CLASS_2", CAST("ADS"."Feature_3" AS BINARY_DOUBLE) - 2.01860465116279 AS "Feature_3_CLASS_2" 
...
FROM "0602_56Q_NAIVEBAYES_SCORES" "NaiveBayes_Scores"), 
