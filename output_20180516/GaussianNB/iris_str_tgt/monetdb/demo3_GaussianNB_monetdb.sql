...
-- Code For temporary table tmp_20180602160300_3po_naivebayes_scores part 1. Create 


CREATE TEMPORARY TABLE tmp_20180602160300_3po_naivebayes_scores (
	"KEY" BIGINT, 
...
-- Code For temporary table tmp_20180602160300_3po_naivebayes_scores part 2. Populate

INSERT INTO tmp_20180602160300_3po_naivebayes_scores ("KEY", "Score_CLASS_0", "Score_CLASS_1", "Score_CLASS_2") SELECT "U"."KEY", "U"."Score_CLASS_0", "U"."Score_CLASS_1", "U"."Score_CLASS_2" 
...
FROM tmp_20180602160300_3po_naivebayes_scores AS "NaiveBayes_Scores"), 
