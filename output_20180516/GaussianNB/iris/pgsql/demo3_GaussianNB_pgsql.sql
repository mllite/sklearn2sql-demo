...
-- Code For temporary table TMP_20180516122412_CODEGEN_CBEEHE_NaiveBayes_Scores part 1. Create 


CREATE TEMPORARY TABLE "TMP_20180516122412_CODEGEN_CBEEHE_NaiveBayes_Scores" (
	"KEY" BIGINT NOT NULL, 
	"Score_0" FLOAT, 
	"Score_1" FLOAT, 
	"Score_2" FLOAT, 
...
-- Code For temporary table TMP_20180516122412_CODEGEN_CBEEHE_NaiveBayes_Scores part 2. Populate
...
FROM centered_data) AS "Values")
 INSERT INTO "TMP_20180516122412_CODEGEN_CBEEHE_NaiveBayes_Scores" ("KEY", "Score_0", "Score_1", "Score_2") SELECT "NaiveBayes_Scores"."KEY", "NaiveBayes_Scores"."Score_0", "NaiveBayes_Scores"."Score_1", "NaiveBayes_Scores"."Score_2" 
...
-- Code For temporary table TMP_20180516122412_CODEGEN_CBEEHE_NaiveBayes_Scores part 3. Create Index 

CREATE INDEX "ix_TMP_20180516122412_CODEGEN_CBEEHE_NaiveBayes_Scores_KEY" ON "TMP_20180516122412_CODEGEN_CBEEHE_NaiveBayes_Scores" ("KEY")
...
FROM "TMP_20180516122412_CODEGEN_CBEEHE_NaiveBayes_Scores" AS "NaiveBayes_Scores"), 
