...
-- Code For temporary table ##TMP_20180516122413_CODEGEN_HH8EDF_NaiveBayes_Scores part 1. Create 


CREATE TABLE ##TMP_20180516122413_CODEGEN_HH8EDF_NaiveBayes_Scores (
	[KEY] BIGINT NULL, 
	[Score_0] FLOAT NULL, 
	[Score_1] FLOAT NULL, 
	[Score_2] FLOAT NULL
...
-- Code For temporary table ##TMP_20180516122413_CODEGEN_HH8EDF_NaiveBayes_Scores part 2. Populate

WITH centered_data AS 
(SELECT [ADS].[KEY] AS [KEY], CAST([ADS].[Feature_0] AS FLOAT(53)) - 4.95945945945946 AS [Feature_0_0], CAST([ADS].[Feature_1] AS FLOAT(53)) - 3.4162162162162164 AS [Feature_1_0], CAST([ADS].[Feature_2] AS FLOAT(53)) - 1.4864864864864862 AS [Feature_2_0], CAST([ADS].[Feature_3] AS FLOAT(53)) - 0.2594594594594595 AS [Feature_3_0], CAST([ADS].[Feature_0] AS FLOAT(53)) - 5.914999999999999 AS [Feature_0_1], CAST([ADS].[Feature_1] AS FLOAT(53)) - 2.7600000000000007 AS [Feature_1_1], CAST([ADS].[Feature_2] AS FLOAT(53)) - 4.245 AS [Feature_2_1], CAST([ADS].[Feature_3] AS FLOAT(53)) - 1.325 AS [Feature_3_1], CAST([ADS].[Feature_0] AS FLOAT(53)) - 6.548837209302325 AS [Feature_0_2], CAST([ADS].[Feature_1] AS FLOAT(53)) - 2.9674418604651165 AS [Feature_1_2], CAST([ADS].[Feature_2] AS FLOAT(53)) - 5.502325581395348 AS [Feature_2_2], CAST([ADS].[Feature_3] AS FLOAT(53)) - 2.01860465116279 AS [Feature_3_2] 
FROM iris AS [ADS]), 
[NaiveBayes_data] AS 
...
FROM centered_data) AS [Values])
 INSERT INTO ##TMP_20180516122413_CODEGEN_HH8EDF_NaiveBayes_Scores ([KEY], [Score_0], [Score_1], [Score_2]) SELECT [NaiveBayes_Scores].[KEY], [NaiveBayes_Scores].[Score_0], [NaiveBayes_Scores].[Score_1], [NaiveBayes_Scores].[Score_2] 
...
FROM ##TMP_20180516122413_CODEGEN_HH8EDF_NaiveBayes_Scores AS [NaiveBayes_Scores]), 
