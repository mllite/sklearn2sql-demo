...
-- Code For temporary table ##TMP_20180602152749_88K_NaiveBayes_Scores part 1. Create 


CREATE TABLE ##TMP_20180602152749_88K_NaiveBayes_Scores (
	[KEY] BIGINT NULL, 
	[Score_0] FLOAT NULL, 
	[Score_1] FLOAT NULL, 
	[Score_2] FLOAT NULL
...
-- Code For temporary table ##TMP_20180602152749_88K_NaiveBayes_Scores part 2. Populate
...
FROM centered_data) AS [Values])
 INSERT INTO ##TMP_20180602152749_88K_NaiveBayes_Scores ([KEY], [Score_0], [Score_1], [Score_2]) SELECT [NaiveBayes_Scores].[KEY], [NaiveBayes_Scores].[Score_0], [NaiveBayes_Scores].[Score_1], [NaiveBayes_Scores].[Score_2] 
...
FROM ##TMP_20180602152749_88K_NaiveBayes_Scores AS [NaiveBayes_Scores]), 
