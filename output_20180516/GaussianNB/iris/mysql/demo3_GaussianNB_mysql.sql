...
(SELECT `ADS`.`KEY` AS `KEY`, `ADS`.`Feature_0` - 4.95945945945946 AS `Feature_0_0`, `ADS`.`Feature_1` - 3.4162162162162164 AS `Feature_1_0`, `ADS`.`Feature_2` - 1.4864864864864862 AS `Feature_2_0`, `ADS`.`Feature_3` - 0.2594594594594595 AS `Feature_3_0`, `ADS`.`Feature_0` - 5.914999999999999 AS `Feature_0_1`, `ADS`.`Feature_1` - 2.7600000000000007 AS `Feature_1_1`, `ADS`.`Feature_2` - 4.245 AS `Feature_2_1`, `ADS`.`Feature_3` - 1.325 AS `Feature_3_1`, `ADS`.`Feature_0` - 6.548837209302325 AS `Feature_0_2`, `ADS`.`Feature_1` - 2.9674418604651165 AS `Feature_1_2`, `ADS`.`Feature_2` - 5.502325581395348 AS `Feature_2_2`, `ADS`.`Feature_3` - 2.01860465116279 AS `Feature_3_2` 
FROM iris AS `ADS`), 
`NaiveBayes_data` AS 
