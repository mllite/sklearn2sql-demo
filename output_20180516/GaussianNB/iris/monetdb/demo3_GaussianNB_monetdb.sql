...
-- Code For temporary table tmp_20180602152748_2g1_naivebayes_scores part 1. Create 


CREATE TEMPORARY TABLE tmp_20180602152748_2g1_naivebayes_scores (
	"KEY" BIGINT, 
	"Score_0" DOUBLE, 
	"Score_1" DOUBLE, 
	"Score_2" DOUBLE
...
-- Code For temporary table tmp_20180602152748_2g1_naivebayes_scores part 2. Populate

INSERT INTO tmp_20180602152748_2g1_naivebayes_scores ("KEY", "Score_0", "Score_1", "Score_2") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1", "U"."Score_2" 
...
FROM tmp_20180602152748_2g1_naivebayes_scores AS "NaiveBayes_Scores"), 
