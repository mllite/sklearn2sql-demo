...
-- Code For temporary table tmp_20180602152749_4jx_naivebayes_scores part 1. Create 


CREATE GLOBAL TEMPORARY TABLE tmp_20180602152749_4jx_naivebayes_scores  (
	"KEY" BIGINT, 
...
-- Code For temporary table tmp_20180602152749_4jx_naivebayes_scores part 2. Populate

INSERT INTO tmp_20180602152749_4jx_naivebayes_scores ("KEY", "Score_0", "Score_1", "Score_2") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1", "U"."Score_2" 
...
FROM (SELECT centered_data."KEY" AS "KEY", 0 AS "Feature", CAST(-0.5 AS DOUBLE PRECISION) * CAST(-0.275833819302414 AS DOUBLE PRECISION) - (CAST(0.5 AS DOUBLE PRECISION) * centered_data."Feature_0_0" * centered_data."Feature_0_0") / CAST(0.120788899928588 AS DOUBLE PRECISION) AS log_proba_0, CAST(-0.5 AS DOUBLE PRECISION) * CAST(0.607816937322572 AS DOUBLE PRECISION) - (CAST(0.5 AS DOUBLE PRECISION) * centered_data."Feature_0_1" * centered_data."Feature_0_1") / CAST(0.292275002923475 AS DOUBLE PRECISION) AS log_proba_1, CAST(-0.5 AS DOUBLE PRECISION) * CAST(0.811527589265181 AS DOUBLE PRECISION) - (CAST(0.5 AS DOUBLE PRECISION) * centered_data."Feature_0_2" * centered_data."Feature_0_2") / CAST(0.358312604329641 AS DOUBLE PRECISION) AS log_proba_2 
...
FROM tmp_20180602152749_4jx_naivebayes_scores AS "NaiveBayes_Scores"), 
