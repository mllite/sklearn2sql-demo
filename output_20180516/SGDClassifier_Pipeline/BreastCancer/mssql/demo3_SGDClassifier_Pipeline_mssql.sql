...
-- Code For temporary table ##TMP_20180602142713_R6E_ADS_imp_1_OUT part 1. Create 


CREATE TABLE ##TMP_20180602142713_R6E_ADS_imp_1_OUT (
	[KEY] BIGINT NULL, 
...
-- Code For temporary table ##TMP_20180602142713_04V_ADS_sca_2_OUT part 1. Create 


CREATE TABLE ##TMP_20180602142713_04V_ADS_sca_2_OUT (
	[KEY] BIGINT NULL, 
	scaler_2 FLOAT NULL, 
	scaler_3 FLOAT NULL, 
	scaler_4 FLOAT NULL, 
...
FROM ##TMP_20180602142713_R6E_ADS_imp_1_OUT AS [ADS_imp_1_OUT]) AS [ADS_sca_2_OUT]
...
FROM ##TMP_20180602142713_04V_ADS_sca_2_OUT AS [ADS_sca_2_OUT]), 
linear_model_cte AS 
