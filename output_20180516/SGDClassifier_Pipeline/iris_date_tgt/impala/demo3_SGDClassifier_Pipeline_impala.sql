...
-- Code For temporary table tmp_20180516123908_codegen_jkhfuz_ads_imp_1_out part 1. Create 


CREATE TABLE tmp_20180516123908_codegen_jkhfuz_ads_imp_1_out (
	`KEY` BIGINT, 
...
-- Code For temporary table tmp_20180516123908_codegen_jkhfuz_ads_imp_1_out part 2. Populate

INSERT INTO tmp_20180516123908_codegen_jkhfuz_ads_imp_1_out (`KEY`, imputer_output_2, imputer_output_3, imputer_output_4, imputer_output_5) SELECT `ADS_imp_1_OUT`.`KEY`, `ADS_imp_1_OUT`.imputer_output_2, `ADS_imp_1_OUT`.imputer_output_3, `ADS_imp_1_OUT`.imputer_output_4, `ADS_imp_1_OUT`.imputer_output_5 
...
-- Code For temporary table tmp_20180516123908_codegen_0gnj69_ads_sca_2_out part 1. Create 


CREATE TABLE tmp_20180516123908_codegen_0gnj69_ads_sca_2_out (
	`KEY` BIGINT, 
...
-- Code For temporary table tmp_20180516123908_codegen_0gnj69_ads_sca_2_out part 2. Populate

INSERT INTO tmp_20180516123908_codegen_0gnj69_ads_sca_2_out (`KEY`, scaler_output_2, scaler_output_3, scaler_output_4, scaler_output_5) SELECT `ADS_sca_2_OUT`.`KEY`, `ADS_sca_2_OUT`.scaler_output_2, `ADS_sca_2_OUT`.scaler_output_3, `ADS_sca_2_OUT`.scaler_output_4, `ADS_sca_2_OUT`.scaler_output_5 
...
FROM tmp_20180516123908_codegen_jkhfuz_ads_imp_1_out AS `ADS_imp_1_OUT`) AS `ADS_sca_2_OUT`
...
FROM tmp_20180516123908_codegen_0gnj69_ads_sca_2_out AS `ADS_sca_2_OUT`), 
linear_model_cte AS 
