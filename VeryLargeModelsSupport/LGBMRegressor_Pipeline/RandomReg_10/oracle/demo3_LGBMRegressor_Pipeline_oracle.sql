...
-- Code For temporary table 31754_7LGMPM_ADS_IMP_1_OUT part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE "31754_7LGMPM_ADS_IMP_1_OUT" (
	"KEY" NUMBER(19), 
...
-- Code For temporary table 31754_7LGMPM_ADS_IMP_1_OUT part 2/2. Populate

INSERT INTO "31754_7LGMPM_ADS_IMP_1_OUT" ("KEY", impter_2, impter_3, impter_4, impter_5, impter_6, impter_7, impter_8, impter_9, impter_10, impter_11) SELECT "U"."KEY", "U".impter_2, "U".impter_3, "U".impter_4, "U".impter_5, "U".impter_6, "U".impter_7, "U".impter_8, "U".impter_9, "U".impter_10, "U".impter_11 
...
-- Code For temporary table 31754_MG99R1_ADS_SCA_2_OUT part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE "31754_MG99R1_ADS_SCA_2_OUT" (
	"KEY" NUMBER(19), 
 ...
 ON COMMIT PRESERVE ROWS
-- Code For temporary table 31754_MG99R1_ADS_SCA_2_OUT part 2/2. Populate

INSERT INTO "31754_MG99R1_ADS_SCA_2_OUT" ("KEY", scaler_2, scaler_3, scaler_4, scaler_5, scaler_6, scaler_7, scaler_8, scaler_9, scaler_10, scaler_11) SELECT "U"."KEY", "U".scaler_2, "U".scaler_3, "U".scaler_4, "U".scaler_5, "U".scaler_6, "U".scaler_7, "U".scaler_8, "U".scaler_9, "U".scaler_10, "U".scaler_11 
...
FROM "31754_7LGMPM_ADS_IMP_1_OUT" "ADS_imp_1_OUT") "ADS_sca_2_OUT") "U"
-- Code For temporary table 9231755_RF4KP0_LGBM_SUM_B0 part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE "9231755_RF4KP0_LGBM_SUM_B0" (
	"KEY" NUMBER(19), 
	"Estimator" BINARY_DOUBLE
)

 ON COMMIT PRESERVE ROWS
-- Code For temporary table 9231755_RF4KP0_LGBM_SUM_B0 part 2/2. Populate

INSERT INTO "9231755_RF4KP0_LGBM_SUM_B0" ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
FROM "31754_MG99R1_ADS_SCA_2_OUT" "ADS_sca_2_OUT"), 
"DT_node_data" AS 
...
-- Code For temporary table 9231755_575FR5_LGBM_SUM_B1 part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE "9231755_575FR5_LGBM_SUM_B1" (
	"KEY" NUMBER(19), 
	"Estimator" BINARY_DOUBLE
)

 ON COMMIT PRESERVE ROWS
-- Code For temporary table 9231755_575FR5_LGBM_SUM_B1 part 2/2. Populate

INSERT INTO "9231755_575FR5_LGBM_SUM_B1" ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
-- Code For temporary table 1755_Z1OCQM_LGBM_SUM_UNION part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE "1755_Z1OCQM_LGBM_SUM_UNION" (
	"KEY" NUMBER(19), 
	"Estimator" BINARY_DOUBLE
)

 ON COMMIT PRESERVE ROWS
-- Code For temporary table 1755_Z1OCQM_LGBM_SUM_UNION part 2/2. Populate

INSERT INTO "1755_Z1OCQM_LGBM_SUM_UNION" ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
FROM "9231755_RF4KP0_LGBM_SUM_B0" "LGBM_Sum_B0" UNION ALL SELECT "LGBM_Sum_B1"."KEY" AS "KEY", "LGBM_Sum_B1"."Estimator" AS "Estimator" 
FROM "9231755_575FR5_LGBM_SUM_B1" "LGBM_Sum_B1") "LGBM_Sum_EnsembleUnion") "LGBM_Sum_Union") "U"
...
FROM "1755_Z1OCQM_LGBM_SUM_UNION" "LGBM_Sum_Union" GROUP BY "LGBM_Sum_Union"."KEY") "T")
