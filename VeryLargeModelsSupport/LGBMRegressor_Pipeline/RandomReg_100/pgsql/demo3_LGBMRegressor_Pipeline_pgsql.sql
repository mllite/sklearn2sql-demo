...
-- Code For temporary table TMP_20180329231830_MULLCI_ADS_imp_1_OUT part 1/2. Create 


CREATE TEMPORARY TABLE "TMP_20180329231830_MULLCI_ADS_imp_1_OUT" (
	"KEY" BIGINT, 
	impter_2 FLOAT, 
	impter_3 FLOAT, 
	impter_4 FLOAT, 
...
-- Code For temporary table TMP_20180329231830_S0YQ3N_ADS_sca_2_OUT part 1/2. Create 


CREATE TEMPORARY TABLE "TMP_20180329231830_S0YQ3N_ADS_sca_2_OUT" (
	"KEY" BIGINT, 
	scaler_2 FLOAT, 
	scaler_3 FLOAT, 
	scaler_4 FLOAT, 
...
FROM "TMP_20180329231830_MULLCI_ADS_imp_1_OUT" AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT"
-- Code For temporary table TMP_20180329231830_V272VZ_LGBM_Sum_B0 part 1/2. Create 


CREATE TEMPORARY TABLE "TMP_20180329231830_V272VZ_LGBM_Sum_B0" (
	"KEY" BIGINT, 
	"Estimator" FLOAT
)

 ON COMMIT PRESERVE ROWS
-- Code For temporary table TMP_20180329231830_V272VZ_LGBM_Sum_B0 part 2/2. Populate
...
FROM "TMP_20180329231830_S0YQ3N_ADS_sca_2_OUT" AS "ADS_sca_2_OUT"), 
"DT_node_data" AS 
...
FROM "DT_Output_9")
 INSERT INTO "TMP_20180329231830_V272VZ_LGBM_Sum_B0" ("KEY", "Estimator") SELECT "LGBM_Sum_B0"."KEY", "LGBM_Sum_B0"."Estimator" 
...
-- Code For temporary table TMP_20180329231830_DD8VH5_LGBM_Sum_B1 part 1/2. Create 


CREATE TEMPORARY TABLE "TMP_20180329231830_DD8VH5_LGBM_Sum_B1" (
	"KEY" BIGINT, 
	"Estimator" FLOAT
)

 ON COMMIT PRESERVE ROWS
-- Code For temporary table TMP_20180329231830_DD8VH5_LGBM_Sum_B1 part 2/2. Populate
...
FROM "DT_Output_15")
 INSERT INTO "TMP_20180329231830_DD8VH5_LGBM_Sum_B1" ("KEY", "Estimator") SELECT "LGBM_Sum_B1"."KEY", "LGBM_Sum_B1"."Estimator" 
...
-- Code For temporary table TMP_20180329231830_ORJAP7_LGBM_Sum_Union part 1/2. Create 


CREATE TEMPORARY TABLE "TMP_20180329231830_ORJAP7_LGBM_Sum_Union" (
	"KEY" BIGINT, 
	"Estimator" FLOAT
)

 ON COMMIT PRESERVE ROWS
-- Code For temporary table TMP_20180329231830_ORJAP7_LGBM_Sum_Union part 2/2. Populate

INSERT INTO "TMP_20180329231830_ORJAP7_LGBM_Sum_Union" ("KEY", "Estimator") SELECT "LGBM_Sum_Union"."KEY", "LGBM_Sum_Union"."Estimator" 
...
FROM "TMP_20180329231830_V272VZ_LGBM_Sum_B0" AS "LGBM_Sum_B0" UNION ALL SELECT "LGBM_Sum_B1"."KEY" AS "KEY", "LGBM_Sum_B1"."Estimator" AS "Estimator" 
FROM "TMP_20180329231830_DD8VH5_LGBM_Sum_B1" AS "LGBM_Sum_B1") AS "LGBM_Sum_EnsembleUnion") AS "LGBM_Sum_Union"
...
FROM "TMP_20180329231830_ORJAP7_LGBM_Sum_Union" AS "LGBM_Sum_Union" GROUP BY "LGBM_Sum_Union"."KEY") AS "T")
