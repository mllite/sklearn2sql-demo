...
-- Code For temporary table 31830_ZG0L6D_ADS_IMP_1_OUT part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE "31830_ZG0L6D_ADS_IMP_1_OUT" (
	"KEY" NUMBER(19), 
...
-- Code For temporary table 31830_ZZO0ZT_ADS_SCA_2_OUT part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE "31830_ZZO0ZT_ADS_SCA_2_OUT" (
	"KEY" NUMBER(19), 
...
FROM "31830_ZG0L6D_ADS_IMP_1_OUT" "ADS_imp_1_OUT") "ADS_sca_2_OUT") "U"
-- Code For temporary table 9231831_TG7IA6_LGBM_SUM_B0 part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE "9231831_TG7IA6_LGBM_SUM_B0" (
	"KEY" NUMBER(19), 
	"Estimator" BINARY_DOUBLE
)

 ON COMMIT PRESERVE ROWS
-- Code For temporary table 9231831_TG7IA6_LGBM_SUM_B0 part 2/2. Populate

INSERT INTO "9231831_TG7IA6_LGBM_SUM_B0" ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
FROM "31830_ZZO0ZT_ADS_SCA_2_OUT" "ADS_sca_2_OUT"), 
"DT_node_data" AS 
...
-- Code For temporary table 9231831_AKNJ9X_LGBM_SUM_B1 part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE "9231831_AKNJ9X_LGBM_SUM_B1" (
	"KEY" NUMBER(19), 
	"Estimator" BINARY_DOUBLE
)

 ON COMMIT PRESERVE ROWS
-- Code For temporary table 9231831_AKNJ9X_LGBM_SUM_B1 part 2/2. Populate

INSERT INTO "9231831_AKNJ9X_LGBM_SUM_B1" ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
-- Code For temporary table 1831_JKFJIY_LGBM_SUM_UNION part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE "1831_JKFJIY_LGBM_SUM_UNION" (
	"KEY" NUMBER(19), 
	"Estimator" BINARY_DOUBLE
)

 ON COMMIT PRESERVE ROWS
-- Code For temporary table 1831_JKFJIY_LGBM_SUM_UNION part 2/2. Populate

INSERT INTO "1831_JKFJIY_LGBM_SUM_UNION" ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
FROM "9231831_TG7IA6_LGBM_SUM_B0" "LGBM_Sum_B0" UNION ALL SELECT "LGBM_Sum_B1"."KEY" AS "KEY", "LGBM_Sum_B1"."Estimator" AS "Estimator" 
FROM "9231831_AKNJ9X_LGBM_SUM_B1" "LGBM_Sum_B1") "LGBM_Sum_EnsembleUnion") "LGBM_Sum_Union") "U"
...
FROM "1831_JKFJIY_LGBM_SUM_UNION" "LGBM_Sum_Union" GROUP BY "LGBM_Sum_Union"."KEY") "T")
