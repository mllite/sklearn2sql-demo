...
-- Code For temporary table ##TMP_20180329232408_4CA8JY_ADS_imp_1_OUT part 1/2. Create 


CREATE TABLE ##TMP_20180329232408_4CA8JY_ADS_imp_1_OUT (
	[KEY] BIGINT NULL, 
...
-- Code For temporary table ##TMP_20180329232408_4CA8JY_ADS_imp_1_OUT part 2/2. Populate

INSERT INTO ##TMP_20180329232408_4CA8JY_ADS_imp_1_OUT ([KEY], imputer_output_2, imputer_output_3, imputer_output_4, imputer_output_5) SELECT [ADS_imp_1_OUT].[KEY], [ADS_imp_1_OUT].imputer_output_2, [ADS_imp_1_OUT].imputer_output_3, [ADS_imp_1_OUT].imputer_output_4, [ADS_imp_1_OUT].imputer_output_5 
...
-- Code For temporary table ##TMP_20180329232408_MAIJTG_ADS_sca_2_OUT part 1/2. Create 


CREATE TABLE ##TMP_20180329232408_MAIJTG_ADS_sca_2_OUT (
	[KEY] BIGINT NULL, 
...
-- Code For temporary table ##TMP_20180329232408_MAIJTG_ADS_sca_2_OUT part 2/2. Populate

INSERT INTO ##TMP_20180329232408_MAIJTG_ADS_sca_2_OUT ([KEY], scaler_output_2, scaler_output_3, scaler_output_4, scaler_output_5) SELECT [ADS_sca_2_OUT].[KEY], [ADS_sca_2_OUT].scaler_output_2, [ADS_sca_2_OUT].scaler_output_3, [ADS_sca_2_OUT].scaler_output_4, [ADS_sca_2_OUT].scaler_output_5 
...
FROM ##TMP_20180329232408_4CA8JY_ADS_imp_1_OUT AS [ADS_imp_1_OUT]) AS [ADS_sca_2_OUT]
-- Code For temporary table ##TMP_20180329232408_ENALFE_LGBM_Sum_B0 part 1/2. Create 


CREATE TABLE ##TMP_20180329232408_ENALFE_LGBM_Sum_B0 (
	[KEY] BIGINT NULL, 
	[Estimator] FLOAT(53) NULL
)


-- Code For temporary table ##TMP_20180329232408_ENALFE_LGBM_Sum_B0 part 2/2. Populate
...
FROM ##TMP_20180329232408_MAIJTG_ADS_sca_2_OUT AS [ADS_sca_2_OUT]), 
[DT_node_data] AS 
...
FROM [DT_Output_9])
 INSERT INTO ##TMP_20180329232408_ENALFE_LGBM_Sum_B0 ([KEY], [Estimator]) SELECT [LGBM_Sum_B0].[KEY], [LGBM_Sum_B0].[Estimator] 
...
-- Code For temporary table ##TMP_20180329232408_02U95H_LGBM_Sum_B1 part 1/2. Create 


CREATE TABLE ##TMP_20180329232408_02U95H_LGBM_Sum_B1 (
	[KEY] BIGINT NULL, 
	[Estimator] FLOAT(53) NULL
)


-- Code For temporary table ##TMP_20180329232408_02U95H_LGBM_Sum_B1 part 2/2. Populate
...
FROM [DT_Output_15])
 INSERT INTO ##TMP_20180329232408_02U95H_LGBM_Sum_B1 ([KEY], [Estimator]) SELECT [LGBM_Sum_B1].[KEY], [LGBM_Sum_B1].[Estimator] 
...
-- Code For temporary table ##TMP_20180329232408_8YWMGT_LGBM_Sum_Union part 1/2. Create 


CREATE TABLE ##TMP_20180329232408_8YWMGT_LGBM_Sum_Union (
	[KEY] BIGINT NULL, 
	[Estimator] FLOAT(53) NULL
)


-- Code For temporary table ##TMP_20180329232408_8YWMGT_LGBM_Sum_Union part 2/2. Populate

INSERT INTO ##TMP_20180329232408_8YWMGT_LGBM_Sum_Union ([KEY], [Estimator]) SELECT [LGBM_Sum_Union].[KEY], [LGBM_Sum_Union].[Estimator] 
...
FROM ##TMP_20180329232408_ENALFE_LGBM_Sum_B0 AS [LGBM_Sum_B0] UNION ALL SELECT [LGBM_Sum_B1].[KEY] AS [KEY], [LGBM_Sum_B1].[Estimator] AS [Estimator] 
FROM ##TMP_20180329232408_02U95H_LGBM_Sum_B1 AS [LGBM_Sum_B1]) AS [LGBM_Sum_EnsembleUnion]) AS [LGBM_Sum_Union]
...
FROM ##TMP_20180329232408_8YWMGT_LGBM_Sum_Union AS [LGBM_Sum_Union] GROUP BY [LGBM_Sum_Union].[KEY]) AS [T])
