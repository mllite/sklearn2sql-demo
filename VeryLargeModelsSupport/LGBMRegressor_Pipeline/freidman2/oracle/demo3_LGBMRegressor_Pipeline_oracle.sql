...
-- Code For temporary table 32321_VTL9FQ_ADS_IMP_1_OUT part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE "32321_VTL9FQ_ADS_IMP_1_OUT" (
	"KEY" NUMBER(19), 
...
-- Code For temporary table 32321_VTL9FQ_ADS_IMP_1_OUT part 2/2. Populate

INSERT INTO "32321_VTL9FQ_ADS_IMP_1_OUT" ("KEY", imputer_output_2, imputer_output_3, imputer_output_4, imputer_output_5) SELECT "U"."KEY", "U".imputer_output_2, "U".imputer_output_3, "U".imputer_output_4, "U".imputer_output_5 
...
-- Code For temporary table 32321_C2H0SR_ADS_SCA_2_OUT part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE "32321_C2H0SR_ADS_SCA_2_OUT" (
	"KEY" NUMBER(19), 
 ...
 ON COMMIT PRESERVE ROWS
-- Code For temporary table 32321_C2H0SR_ADS_SCA_2_OUT part 2/2. Populate

INSERT INTO "32321_C2H0SR_ADS_SCA_2_OUT" ("KEY", scaler_output_2, scaler_output_3, scaler_output_4, scaler_output_5) SELECT "U"."KEY", "U".scaler_output_2, "U".scaler_output_3, "U".scaler_output_4, "U".scaler_output_5 
...
FROM "32321_VTL9FQ_ADS_IMP_1_OUT" "ADS_imp_1_OUT") "ADS_sca_2_OUT") "U"
-- Code For temporary table 9232321_M5UJM0_LGBM_SUM_B0 part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE "9232321_M5UJM0_LGBM_SUM_B0" (
	"KEY" NUMBER(19), 
	"Estimator" BINARY_DOUBLE
)

 ON COMMIT PRESERVE ROWS
-- Code For temporary table 9232321_M5UJM0_LGBM_SUM_B0 part 2/2. Populate

INSERT INTO "9232321_M5UJM0_LGBM_SUM_B0" ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
FROM "32321_C2H0SR_ADS_SCA_2_OUT" "ADS_sca_2_OUT"), 
"DT_node_data" AS 
...
-- Code For temporary table 9232321_E87OVQ_LGBM_SUM_B1 part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE "9232321_E87OVQ_LGBM_SUM_B1" (
	"KEY" NUMBER(19), 
	"Estimator" BINARY_DOUBLE
)

 ON COMMIT PRESERVE ROWS
-- Code For temporary table 9232321_E87OVQ_LGBM_SUM_B1 part 2/2. Populate

INSERT INTO "9232321_E87OVQ_LGBM_SUM_B1" ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
-- Code For temporary table 2321_X9HESM_LGBM_SUM_UNION part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE "2321_X9HESM_LGBM_SUM_UNION" (
	"KEY" NUMBER(19), 
	"Estimator" BINARY_DOUBLE
)

 ON COMMIT PRESERVE ROWS
-- Code For temporary table 2321_X9HESM_LGBM_SUM_UNION part 2/2. Populate

INSERT INTO "2321_X9HESM_LGBM_SUM_UNION" ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
FROM "9232321_M5UJM0_LGBM_SUM_B0" "LGBM_Sum_B0" UNION ALL SELECT "LGBM_Sum_B1"."KEY" AS "KEY", "LGBM_Sum_B1"."Estimator" AS "Estimator" 
FROM "9232321_E87OVQ_LGBM_SUM_B1" "LGBM_Sum_B1") "LGBM_Sum_EnsembleUnion") "LGBM_Sum_Union") "U"
...
FROM "2321_X9HESM_LGBM_SUM_UNION" "LGBM_Sum_Union" GROUP BY "LGBM_Sum_Union"."KEY") "T")
