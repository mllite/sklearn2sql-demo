...
-- Code For temporary table TMP_20180329232447_JY3HVC_CalProb_AVG_B0 part 1/2. Create 


CREATE TEMPORARY TABLE "TMP_20180329232447_JY3HVC_CalProb_AVG_B0" (
	"KEY" BIGINT, 
	"Proba_1" FLOAT, 
	"Proba_0" FLOAT
)
...
-- Code For temporary table TMP_20180329232447_JY3HVC_CalProb_AVG_B0 part 2/2. Populate
...
FROM isotonic_cte_3)
 INSERT INTO "TMP_20180329232447_JY3HVC_CalProb_AVG_B0" ("KEY", "Proba_1", "Proba_0") SELECT "CalProb_AVG_B0"."KEY", "CalProb_AVG_B0"."Proba_1", "CalProb_AVG_B0"."Proba_0" 
...
-- Code For temporary table TMP_20180329232447_8YZSCT_CalProb_AVG_Union part 1/2. Create 


CREATE TEMPORARY TABLE "TMP_20180329232447_8YZSCT_CalProb_AVG_Union" (
	"KEY" BIGINT, 
	"Proba_1" FLOAT, 
	"Proba_0" FLOAT
)
 ...
 ON COMMIT PRESERVE ROWS
-- Code For temporary table TMP_20180329232447_8YZSCT_CalProb_AVG_Union part 2/2. Populate

INSERT INTO "TMP_20180329232447_8YZSCT_CalProb_AVG_Union" ("KEY", "Proba_1", "Proba_0") SELECT "CalProb_AVG_Union"."KEY", "CalProb_AVG_Union"."Proba_1", "CalProb_AVG_Union"."Proba_0" 
...
FROM "TMP_20180329232447_JY3HVC_CalProb_AVG_B0" AS "CalProb_AVG_B0") AS "CalProb_AVG_EnsembleUnion") AS "CalProb_AVG_Union"
...
FROM "TMP_20180329232447_8YZSCT_CalProb_AVG_Union" AS "CalProb_AVG_Union" GROUP BY "CalProb_AVG_Union"."KEY") AS "T"), 
orig_cte AS 
