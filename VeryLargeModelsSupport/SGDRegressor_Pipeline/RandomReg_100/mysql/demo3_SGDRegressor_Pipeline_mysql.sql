...
-- Code For temporary table TMP_20180329231842_CYA6WD_ADS_imp_1_OUT part 1/2. Create 


CREATE TEMPORARY TABLE `TMP_20180329231842_CYA6WD_ADS_imp_1_OUT` (
	`KEY` BIGINT, 
	impter_2 DOUBLE, 
	impter_3 DOUBLE, 
	impter_4 DOUBLE, 
...
-- Code For temporary table TMP_20180329231842_3FB5HT_ADS_sca_2_OUT part 1/2. Create 


CREATE TEMPORARY TABLE `TMP_20180329231842_3FB5HT_ADS_sca_2_OUT` (
	`KEY` BIGINT, 
	scaler_2 DOUBLE, 
	scaler_3 DOUBLE, 
	scaler_4 DOUBLE, 
...
FROM `TMP_20180329231842_CYA6WD_ADS_imp_1_OUT` AS `ADS_imp_1_OUT`) AS `ADS_sca_2_OUT`) AS `U`

-- Model deployment code

WITH linear_model_cte AS 
(SELECT `ADS_sca_2_OUT`.`KEY` AS `KEY`, -3.892208051852623 * `ADS_sca_2_OUT`.scaler_2 + -11.848313135503657 * `ADS_sca_2_OUT`.scaler_3 + -13.457635169218506 * `ADS_sca_2_OUT`.scaler_4 + 4.599424875668274 * `ADS_sca_2_OUT`.scaler_5 + 7.76248084723096 * `ADS_sca_2_OUT`.scaler_6 + 1.786983639870794 * `ADS_sca_2_OUT`.scaler_7 + -6.16696911298743 * `ADS_sca_2_OUT`.scaler_8 + -2.07522043069083 * `ADS_sca_2_OUT`.scaler_9 + 11.286727417270106 * `ADS_sca_2_OUT`.scaler_10 + 3.2365621120595938 * `ADS_sca_2_OUT`.scaler_11 + -8.507838866007688 * `ADS_sca_2_OUT`.scaler_12 + 9.518952142856344 * `ADS_sca_2_OUT`.scaler_13 + 8.499598620164361 * `ADS_sca_2_OUT`.scaler_14 + -1.3155938019858755 * `ADS_sca_2_OUT`.scaler_15 + -11.642646773616908 * `ADS_sca_2_OUT`.scaler_16 + 6.747015138920985 * `ADS_sca_2_OUT`.scaler_17 + 21.865788486539508 * `ADS_sca_2_OUT`.scaler_18 + 10.018782557526732 * `ADS_sca_2_OUT`.scaler_19 + 5.8627341778865265 * `ADS_sca_2_OUT`.scaler_20 + -13.378181328188369 * `ADS_sca_2_OUT`.scaler_21 + 9.08205947220331 * `ADS_sca_2_OUT`.scaler_22 + 2.2685587622967405 * `ADS_sca_2_OUT`.scaler_23 + -0.22457092018618763 * `ADS_sca_2_OUT`.scaler_24 + -6.3354879203330565 * `ADS_sca_2_OUT`.scaler_25 + 4.894085028202674 * `ADS_sca_2_OUT`.scaler_26 + 7.182706123836852 * `ADS_sca_2_OUT`.scaler_27 + 9.30223816916347 * `ADS_sca_2_OUT`.scaler_28 + 6.75623824828236 * `ADS_sca_2_OUT`.scaler_29 + 3.197047190078278 * `ADS_sca_2_OUT`.scaler_30 + 3.344455354283561 * `ADS_sca_2_OUT`.scaler_31 + -0.46688878729628225 * `ADS_sca_2_OUT`.scaler_32 + 2.4185905495653675 * `ADS_sca_2_OUT`.scaler_33 + 0.005224333748270358 * `ADS_sca_2_OUT`.scaler_34 + 12.881459740666012 * `ADS_sca_2_OUT`.scaler_35 + -12.576552097739931 * `ADS_sca_2_OUT`.scaler_36 + 3.248096933465154 * `ADS_sca_2_OUT`.scaler_37 + -13.569976529871898 * `ADS_sca_2_OUT`.scaler_38 + -11.892266498827654 * `ADS_sca_2_OUT`.scaler_39 + 10.69302154031217 * `ADS_sca_2_OUT`.scaler_40 + 34.421597488978875 * `ADS_sca_2_OUT`.scaler_41 + -7.4198775604652205 * `ADS_sca_2_OUT`.scaler_42 + 39.36048882741198 * `ADS_sca_2_OUT`.scaler_43 + -1.988499648082849 * `ADS_sca_2_OUT`.scaler_44 + 5.052941886223686 * `ADS_sca_2_OUT`.scaler_45 + 6.495924724518395 * `ADS_sca_2_OUT`.scaler_46 + -2.9023281366966085 * `ADS_sca_2_OUT`.scaler_47 + -4.329371243038219 * `ADS_sca_2_OUT`.scaler_48 + -0.6616356561761402 * `ADS_sca_2_OUT`.scaler_49 + 5.74987460645023 * `ADS_sca_2_OUT`.scaler_50 + 16.771044830202243 * `ADS_sca_2_OUT`.scaler_51 + -3.5354461366224372 * `ADS_sca_2_OUT`.scaler_52 + -4.309248354165154 * `ADS_sca_2_OUT`.scaler_53 + 1.1242051427527449 * `ADS_sca_2_OUT`.scaler_54 + -6.334547211738814 * `ADS_sca_2_OUT`.scaler_55 + 12.389798376668212 * `ADS_sca_2_OUT`.scaler_56 + -1.5311526355156102 * `ADS_sca_2_OUT`.scaler_57 + -11.016160320811704 * `ADS_sca_2_OUT`.scaler_58 + 9.071790303688793 * `ADS_sca_2_OUT`.scaler_59 + 10.583535323523266 * `ADS_sca_2_OUT`.scaler_60 + 2.0158016625665898 * `ADS_sca_2_OUT`.scaler_61 + 2.4549004642612493 * `ADS_sca_2_OUT`.scaler_62 + -8.907573986584561 * `ADS_sca_2_OUT`.scaler_63 + -11.95367665619825 * `ADS_sca_2_OUT`.scaler_64 + 40.19449353678731 * `ADS_sca_2_OUT`.scaler_65 + 6.309424954546972 * `ADS_sca_2_OUT`.scaler_66 + 4.704169228731129 * `ADS_sca_2_OUT`.scaler_67 + 0.35952569443771626 * `ADS_sca_2_OUT`.scaler_68 + -13.139523122050912 * `ADS_sca_2_OUT`.scaler_69 + 13.3101937765204 * `ADS_sca_2_OUT`.scaler_70 + -10.732683477919348 * `ADS_sca_2_OUT`.scaler_71 + -0.9108507556684591 * `ADS_sca_2_OUT`.scaler_72 + 10.854748469208642 * `ADS_sca_2_OUT`.scaler_73 + -1.9338165577885287 * `ADS_sca_2_OUT`.scaler_74 + -1.070501481873353 * `ADS_sca_2_OUT`.scaler_75 + 3.1092284689588006 * `ADS_sca_2_OUT`.scaler_76 + 5.088546833189747 * `ADS_sca_2_OUT`.scaler_77 + -0.4431713007138255 * `ADS_sca_2_OUT`.scaler_78 + -18.534054841929773 * `ADS_sca_2_OUT`.scaler_79 + 2.7435546910242348 * `ADS_sca_2_OUT`.scaler_80 + 14.41296897980937 * `ADS_sca_2_OUT`.scaler_81 + 58.2379539706645 * `ADS_sca_2_OUT`.scaler_82 + 10.332116522986373 * `ADS_sca_2_OUT`.scaler_83 + 2.1725379380665397 * `ADS_sca_2_OUT`.scaler_84 + -1.6351265891065223 * `ADS_sca_2_OUT`.scaler_85 + -4.7789943595176005 * `ADS_sca_2_OUT`.scaler_86 + 9.491934370953693 * `ADS_sca_2_OUT`.scaler_87 + -1.5320661438183112 * `ADS_sca_2_OUT`.scaler_88 + 10.086345620278204 * `ADS_sca_2_OUT`.scaler_89 + -2.3918020003219422 * `ADS_sca_2_OUT`.scaler_90 + 0.1964311908907408 * `ADS_sca_2_OUT`.scaler_91 + 3.0043997682270747 * `ADS_sca_2_OUT`.scaler_92 + 15.120761530169537 * `ADS_sca_2_OUT`.scaler_93 + 6.669072515571682 * `ADS_sca_2_OUT`.scaler_94 + -12.391901858872563 * `ADS_sca_2_OUT`.scaler_95 + -14.821645378419262 * `ADS_sca_2_OUT`.scaler_96 + 37.19255079985792 * `ADS_sca_2_OUT`.scaler_97 + -4.84971289841356 * `ADS_sca_2_OUT`.scaler_98 + 6.063494975602063 * `ADS_sca_2_OUT`.scaler_99 + -5.008955865407979 * `ADS_sca_2_OUT`.scaler_100 + -1.9223889312276206 * `ADS_sca_2_OUT`.scaler_101 + -7.524623969746814 AS `Estimator` 
FROM `TMP_20180329231842_3FB5HT_ADS_sca_2_OUT` AS `ADS_sca_2_OUT`)
