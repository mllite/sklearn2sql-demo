...
orig_cte AS 
(SELECT "GB_Sum_sum"."KEY" AS "KEY", -(-0.10008345855698253 + 0.1 * "GB_Sum_sum"."Score_1") AS "Score_0", -0.10008345855698253 + 0.1 * "GB_Sum_sum"."Score_1" AS "Score_1", 1.0 - 1.0 / (1.0 + exp(CASE WHEN (minvalue(maxvalue(-100.0, -(-0.10008345855698253 + 0.1 * "GB_Sum_sum"."Score_1")), 100.0) >= -709.782712893384) THEN minvalue(maxvalue(-100.0, -(-0.10008345855698253 + 0.1 * "GB_Sum_sum"."Score_1")), 100.0) ELSE -709.782712893384 END)) AS "Proba_0", 1.0 / (1.0 + exp(CASE WHEN (minvalue(maxvalue(-100.0, -(-0.10008345855698253 + 0.1 * "GB_Sum_sum"."Score_1")), 100.0) >= -709.782712893384) THEN minvalue(maxvalue(-100.0, -(-0.10008345855698253 + 0.1 * "GB_Sum_sum"."Score_1")), 100.0) ELSE -709.782712893384 END)) AS "Proba_1", CAST(NULL AS FLOAT) AS "LogProba_0", CAST(NULL AS FLOAT) AS "LogProba_1", CAST(NULL AS BIGINT) AS "Decision", CAST(NULL AS FLOAT) AS "DecisionProba" 
FROM "GB_Sum_sum"), 
