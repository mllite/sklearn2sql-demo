...
-- Code For temporary table TMP_20180329232552_PZSP7Y_GB_Sum_B0 part 1/2. Create 


CREATE TEMPORARY TABLE "TMP_20180329232552_PZSP7Y_GB_Sum_B0" (
	"KEY" BIGINT, 
	"Score_0" FLOAT, 
	"Score_1" FLOAT
)
...
-- Code For temporary table TMP_20180329232552_PZSP7Y_GB_Sum_B0 part 2/2. Populate
...
FROM "DT_Output_4")
 INSERT INTO "TMP_20180329232552_PZSP7Y_GB_Sum_B0" ("KEY", "Score_0", "Score_1") SELECT "GB_Sum_B0"."KEY", "GB_Sum_B0"."Score_0", "GB_Sum_B0"."Score_1" 
...
-- Code For temporary table TMP_20180329232552_60APFO_GB_Sum_B1 part 1/2. Create 


CREATE TEMPORARY TABLE "TMP_20180329232552_60APFO_GB_Sum_B1" (
	"KEY" BIGINT, 
	"Score_0" FLOAT, 
	"Score_1" FLOAT
)
...
-- Code For temporary table TMP_20180329232552_60APFO_GB_Sum_B1 part 2/2. Populate
...
FROM "DT_Output_9")
 INSERT INTO "TMP_20180329232552_60APFO_GB_Sum_B1" ("KEY", "Score_0", "Score_1") SELECT "GB_Sum_B1"."KEY", "GB_Sum_B1"."Score_0", "GB_Sum_B1"."Score_1" 
...
-- Code For temporary table TMP_20180329232552_GYGWWV_GB_Sum_B2 part 1/2. Create 


CREATE TEMPORARY TABLE "TMP_20180329232552_GYGWWV_GB_Sum_B2" (
	"KEY" BIGINT, 
	"Score_0" FLOAT, 
	"Score_1" FLOAT
)
...
-- Code For temporary table TMP_20180329232552_GYGWWV_GB_Sum_B2 part 2/2. Populate
...
FROM "DT_Output_14")
 INSERT INTO "TMP_20180329232552_GYGWWV_GB_Sum_B2" ("KEY", "Score_0", "Score_1") SELECT "GB_Sum_B2"."KEY", "GB_Sum_B2"."Score_0", "GB_Sum_B2"."Score_1" 
...
-- Code For temporary table TMP_20180329232552_EU1U6N_GB_Sum_B3 part 1/2. Create 


CREATE TEMPORARY TABLE "TMP_20180329232552_EU1U6N_GB_Sum_B3" (
	"KEY" BIGINT, 
	"Score_0" FLOAT, 
	"Score_1" FLOAT
)
...
-- Code For temporary table TMP_20180329232552_EU1U6N_GB_Sum_B3 part 2/2. Populate
...
FROM "DT_Output_15")
 INSERT INTO "TMP_20180329232552_EU1U6N_GB_Sum_B3" ("KEY", "Score_0", "Score_1") SELECT "GB_Sum_B3"."KEY", "GB_Sum_B3"."Score_0", "GB_Sum_B3"."Score_1" 
...
-- Code For temporary table TMP_20180329232552_8O5UFP_GB_Sum_Union part 1/2. Create 


CREATE TEMPORARY TABLE "TMP_20180329232552_8O5UFP_GB_Sum_Union" (
	"KEY" BIGINT, 
	"Score_0" FLOAT, 
	"Score_1" FLOAT
)
...
-- Code For temporary table TMP_20180329232552_8O5UFP_GB_Sum_Union part 2/2. Populate

INSERT INTO "TMP_20180329232552_8O5UFP_GB_Sum_Union" ("KEY", "Score_0", "Score_1") SELECT "GB_Sum_Union"."KEY", "GB_Sum_Union"."Score_0", "GB_Sum_Union"."Score_1" 
...
FROM "TMP_20180329232552_PZSP7Y_GB_Sum_B0" AS "GB_Sum_B0" UNION ALL SELECT "GB_Sum_B1"."KEY" AS "KEY", "GB_Sum_B1"."Score_0" AS "Score_0", "GB_Sum_B1"."Score_1" AS "Score_1" 
FROM "TMP_20180329232552_60APFO_GB_Sum_B1" AS "GB_Sum_B1" UNION ALL SELECT "GB_Sum_B2"."KEY" AS "KEY", "GB_Sum_B2"."Score_0" AS "Score_0", "GB_Sum_B2"."Score_1" AS "Score_1" 
FROM "TMP_20180329232552_GYGWWV_GB_Sum_B2" AS "GB_Sum_B2" UNION ALL SELECT "GB_Sum_B3"."KEY" AS "KEY", "GB_Sum_B3"."Score_0" AS "Score_0", "GB_Sum_B3"."Score_1" AS "Score_1" 
FROM "TMP_20180329232552_EU1U6N_GB_Sum_B3" AS "GB_Sum_B3") AS "GB_Sum_EnsembleUnion") AS "GB_Sum_Union"
...
FROM "TMP_20180329232552_8O5UFP_GB_Sum_Union" AS "GB_Sum_Union" GROUP BY "GB_Sum_Union"."KEY") AS "T"), 
orig_cte AS 
