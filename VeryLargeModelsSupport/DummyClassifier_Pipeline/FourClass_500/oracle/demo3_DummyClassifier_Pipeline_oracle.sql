...
-- Code For temporary table 33344_L8R65X_ADS_IMP_1_OUT part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE "33344_L8R65X_ADS_IMP_1_OUT" (
	"KEY" NUMBER(19), 
...
-- Code For temporary table 33344_SK7ZC5_ADS_SCA_2_OUT part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE "33344_SK7ZC5_ADS_SCA_2_OUT" (
	"KEY" NUMBER(19), 
...
FROM "33344_L8R65X_ADS_IMP_1_OUT" "ADS_imp_1_OUT") "ADS_sca_2_OUT") "U"

-- Model deployment code

WITH random_number_cte AS 
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", dbms_random.value AS uniform 
FROM "33344_SK7ZC5_ADS_SCA_2_OUT" "ADS_sca_2_OUT"), 
multinomial_cte AS 
...
(SELECT multinomial_cte."KEY" AS "KEY", 0.23875 AS "Proba_0", CASE WHEN (0.23875 IS NULL OR 0.23875 > 0.0) THEN ln(0.23875) ELSE -BINARY_DOUBLE_INFINITY END AS "LogProba_0", 0.25125 AS "Proba_1", CASE WHEN (0.25125 IS NULL OR 0.25125 > 0.0) THEN ln(0.25125) ELSE -BINARY_DOUBLE_INFINITY END AS "LogProba_1", 0.2525 AS "Proba_2", CASE WHEN (0.2525 IS NULL OR 0.2525 > 0.0) THEN ln(0.2525) ELSE -BINARY_DOUBLE_INFINITY END AS "LogProba_2", 0.2575 AS "Proba_3", CASE WHEN (0.2575 IS NULL OR 0.2575 > 0.0) THEN ln(0.2575) ELSE -BINARY_DOUBLE_INFINITY END AS "LogProba_3", multinomial_cte.multinomial_expr AS "Decision" 
