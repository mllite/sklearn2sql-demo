...
-- Code For temporary table ##TMP_20180329233344_H2XHQ9_ADS_imp_1_OUT part 1/2. Create 


CREATE TABLE ##TMP_20180329233344_H2XHQ9_ADS_imp_1_OUT (
	[KEY] BIGINT NULL, 
...
-- Code For temporary table ##TMP_20180329233344_9S6U8H_ADS_sca_2_OUT part 1/2. Create 


CREATE TABLE ##TMP_20180329233344_9S6U8H_ADS_sca_2_OUT (
	[KEY] BIGINT NULL, 
	scaler_2 FLOAT NULL, 
	scaler_3 FLOAT NULL, 
	scaler_4 FLOAT NULL, 
...
FROM ##TMP_20180329233344_H2XHQ9_ADS_imp_1_OUT AS [ADS_imp_1_OUT]) AS [ADS_sca_2_OUT]

-- Model deployment code

WITH random_number_cte AS 
(SELECT [ADS_sca_2_OUT].[KEY] AS [KEY], rand() AS uniform 
FROM ##TMP_20180329233344_9S6U8H_ADS_sca_2_OUT AS [ADS_sca_2_OUT]), 
multinomial_cte AS 
...
(SELECT multinomial_cte.[KEY] AS [KEY], 0.23875 AS [Proba_0], CASE WHEN (0.23875 IS NULL OR 0.23875 > 0.0) THEN log(0.23875) ELSE -1.79769313486231e+308 END AS [LogProba_0], 0.25125 AS [Proba_1], CASE WHEN (0.25125 IS NULL OR 0.25125 > 0.0) THEN log(0.25125) ELSE -1.79769313486231e+308 END AS [LogProba_1], 0.2525 AS [Proba_2], CASE WHEN (0.2525 IS NULL OR 0.2525 > 0.0) THEN log(0.2525) ELSE -1.79769313486231e+308 END AS [LogProba_2], 0.2575 AS [Proba_3], CASE WHEN (0.2575 IS NULL OR 0.2575 > 0.0) THEN log(0.2575) ELSE -1.79769313486231e+308 END AS [LogProba_3], multinomial_cte.multinomial_expr AS [Decision] 
