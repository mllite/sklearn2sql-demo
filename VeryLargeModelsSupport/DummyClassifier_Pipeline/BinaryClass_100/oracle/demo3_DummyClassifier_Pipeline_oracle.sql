...
-- Code For temporary table 32547_L9LXUV_ADS_IMP_1_OUT part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE "32547_L9LXUV_ADS_IMP_1_OUT" (
	"KEY" NUMBER(19), 
...
-- Code For temporary table 32547_NEJWS0_ADS_SCA_2_OUT part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE "32547_NEJWS0_ADS_SCA_2_OUT" (
	"KEY" NUMBER(19), 
...
FROM "32547_L9LXUV_ADS_IMP_1_OUT" "ADS_imp_1_OUT") "ADS_sca_2_OUT") "U"

-- Model deployment code

WITH random_number_cte AS 
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", dbms_random.value AS uniform 
FROM "32547_NEJWS0_ADS_SCA_2_OUT" "ADS_sca_2_OUT"), 
multinomial_cte AS 
...
(SELECT multinomial_cte."KEY" AS "KEY", 0.525 AS "Proba_0", CASE WHEN (0.525 IS NULL OR 0.525 > 0.0) THEN ln(0.525) ELSE -BINARY_DOUBLE_INFINITY END AS "LogProba_0", 0.475 AS "Proba_1", CASE WHEN (0.475 IS NULL OR 0.475 > 0.0) THEN ln(0.475) ELSE -BINARY_DOUBLE_INFINITY END AS "LogProba_1", multinomial_cte.multinomial_expr AS "Decision" 
