...
-- Code For temporary table 33821_GNE3YQ_ADS_IMP_1_OUT part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE "33821_GNE3YQ_ADS_IMP_1_OUT" (
	"KEY" NUMBER(19), 
...
-- Code For temporary table 33821_S55G2J_ADS_SCA_2_OUT part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE "33821_S55G2J_ADS_SCA_2_OUT" (
	"KEY" NUMBER(19), 
...
FROM "33821_GNE3YQ_ADS_IMP_1_OUT" "ADS_imp_1_OUT") "ADS_sca_2_OUT") "U"

-- Model deployment code

WITH random_number_cte AS 
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", dbms_random.value AS uniform 
FROM "33821_S55G2J_ADS_SCA_2_OUT" "ADS_sca_2_OUT"), 
multinomial_cte AS 
