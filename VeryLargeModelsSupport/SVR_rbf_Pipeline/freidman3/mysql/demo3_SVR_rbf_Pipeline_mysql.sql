...
-- Code For temporary table TMP_20180329232437_EJGIVN_ADS_imp_1_OUT part 1/2. Create 


CREATE TEMPORARY TABLE `TMP_20180329232437_EJGIVN_ADS_imp_1_OUT` (
	`KEY` BIGINT, 
 ...
 ENGINE=MEMORY
-- Code For temporary table TMP_20180329232437_EJGIVN_ADS_imp_1_OUT part 2/2. Populate

INSERT INTO `TMP_20180329232437_EJGIVN_ADS_imp_1_OUT` (`KEY`, imputer_output_2, imputer_output_3, imputer_output_4, imputer_output_5) SELECT `U`.`KEY`, `U`.imputer_output_2, `U`.imputer_output_3, `U`.imputer_output_4, `U`.imputer_output_5 
...
-- Code For temporary table TMP_20180329232437_L32O6O_ADS_sca_2_OUT part 1/2. Create 


CREATE TEMPORARY TABLE `TMP_20180329232437_L32O6O_ADS_sca_2_OUT` (
	`KEY` BIGINT, 
 ...
 ENGINE=MEMORY
-- Code For temporary table TMP_20180329232437_L32O6O_ADS_sca_2_OUT part 2/2. Populate

INSERT INTO `TMP_20180329232437_L32O6O_ADS_sca_2_OUT` (`KEY`, scaler_output_2, scaler_output_3, scaler_output_4, scaler_output_5) SELECT `U`.`KEY`, `U`.scaler_output_2, `U`.scaler_output_3, `U`.scaler_output_4, `U`.scaler_output_5 
...
FROM `TMP_20180329232437_EJGIVN_ADS_imp_1_OUT` AS `ADS_imp_1_OUT`) AS `ADS_sca_2_OUT`) AS `U`
...
FROM `TMP_20180329232437_L32O6O_ADS_sca_2_OUT` AS `ADS_sca_2_OUT`, `SV_data`) AS full_join_data_sv GROUP BY full_join_data_sv.`KEY`) AS t)
