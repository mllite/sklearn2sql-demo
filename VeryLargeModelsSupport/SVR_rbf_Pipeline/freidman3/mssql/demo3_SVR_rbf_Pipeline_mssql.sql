...
-- Code For temporary table ##TMP_20180329232438_44PC50_ADS_imp_1_OUT part 1/2. Create 


CREATE TABLE ##TMP_20180329232438_44PC50_ADS_imp_1_OUT (
	[KEY] BIGINT NULL, 
...
-- Code For temporary table ##TMP_20180329232438_44PC50_ADS_imp_1_OUT part 2/2. Populate

INSERT INTO ##TMP_20180329232438_44PC50_ADS_imp_1_OUT ([KEY], imputer_output_2, imputer_output_3, imputer_output_4, imputer_output_5) SELECT [ADS_imp_1_OUT].[KEY], [ADS_imp_1_OUT].imputer_output_2, [ADS_imp_1_OUT].imputer_output_3, [ADS_imp_1_OUT].imputer_output_4, [ADS_imp_1_OUT].imputer_output_5 
...
-- Code For temporary table ##TMP_20180329232438_1G77YC_ADS_sca_2_OUT part 1/2. Create 


CREATE TABLE ##TMP_20180329232438_1G77YC_ADS_sca_2_OUT (
	[KEY] BIGINT NULL, 
...
-- Code For temporary table ##TMP_20180329232438_1G77YC_ADS_sca_2_OUT part 2/2. Populate

INSERT INTO ##TMP_20180329232438_1G77YC_ADS_sca_2_OUT ([KEY], scaler_output_2, scaler_output_3, scaler_output_4, scaler_output_5) SELECT [ADS_sca_2_OUT].[KEY], [ADS_sca_2_OUT].scaler_output_2, [ADS_sca_2_OUT].scaler_output_3, [ADS_sca_2_OUT].scaler_output_4, [ADS_sca_2_OUT].scaler_output_5 
...
FROM ##TMP_20180329232438_44PC50_ADS_imp_1_OUT AS [ADS_imp_1_OUT]) AS [ADS_sca_2_OUT]
...
FROM (SELECT [ADS_sca_2_OUT].[KEY] AS [KEY], [SV_data].dual_coeff * exp(CASE WHEN (CASE WHEN (-100.0 <= -0.25 * (power([ADS_sca_2_OUT].scaler_output_2 - [SV_data].sv_0, 2) + power([ADS_sca_2_OUT].scaler_output_3 - [SV_data].sv_1, 2) + power([ADS_sca_2_OUT].scaler_output_4 - [SV_data].sv_2, 2) + power([ADS_sca_2_OUT].scaler_output_5 - [SV_data].sv_3, 2))) THEN -0.25 * (power([ADS_sca_2_OUT].scaler_output_2 - [SV_data].sv_0, 2) + power([ADS_sca_2_OUT].scaler_output_3 - [SV_data].sv_1, 2) + power([ADS_sca_2_OUT].scaler_output_4 - [SV_data].sv_2, 2) + power([ADS_sca_2_OUT].scaler_output_5 - [SV_data].sv_3, 2)) ELSE -100.0 END <= 100.0) THEN CASE WHEN (-100.0 <= -0.25 * (power([ADS_sca_2_OUT].scaler_output_2 - [SV_data].sv_0, 2) + power([ADS_sca_2_OUT].scaler_output_3 - [SV_data].sv_1, 2) + power([ADS_sca_2_OUT].scaler_output_4 - [SV_data].sv_2, 2) + power([ADS_sca_2_OUT].scaler_output_5 - [SV_data].sv_3, 2))) THEN -0.25 * (power([ADS_sca_2_OUT].scaler_output_2 - [SV_data].sv_0, 2) + power([ADS_sca_2_OUT].scaler_output_3 - [SV_data].sv_1, 2) + power([ADS_sca_2_OUT].scaler_output_4 - [SV_data].sv_2, 2) + power([ADS_sca_2_OUT].scaler_output_5 - [SV_data].sv_3, 2)) ELSE -100.0 END ELSE 100.0 END) AS dot_prod1 
FROM ##TMP_20180329232438_1G77YC_ADS_sca_2_OUT AS [ADS_sca_2_OUT], [SV_data]) AS full_join_data_sv GROUP BY full_join_data_sv.[KEY]) AS t)
