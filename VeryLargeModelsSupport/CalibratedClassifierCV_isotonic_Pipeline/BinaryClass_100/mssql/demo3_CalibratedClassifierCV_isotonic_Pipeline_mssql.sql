...
-- Code For temporary table ##TMP_20180329232542_3DNF84_ADS_imp_1_OUT part 1/2. Create 


CREATE TABLE ##TMP_20180329232542_3DNF84_ADS_imp_1_OUT (
	[KEY] BIGINT NULL, 
...
-- Code For temporary table ##TMP_20180329232542_M0QG4S_ADS_sca_2_OUT part 1/2. Create 


CREATE TABLE ##TMP_20180329232542_M0QG4S_ADS_sca_2_OUT (
	[KEY] BIGINT NULL, 
	scaler_2 FLOAT NULL, 
	scaler_3 FLOAT NULL, 
	scaler_4 FLOAT NULL, 
...
FROM ##TMP_20180329232542_3DNF84_ADS_imp_1_OUT AS [ADS_imp_1_OUT]) AS [ADS_sca_2_OUT]
-- Code For temporary table ##TMP_20180329232542_4ZXCO4_CalProb_AVG_B0 part 1/2. Create 


CREATE TABLE ##TMP_20180329232542_4ZXCO4_CalProb_AVG_B0 (
	[KEY] BIGINT NULL, 
	[Proba_1] FLOAT NULL, 
	[Proba_0] FLOAT NULL
)
...
-- Code For temporary table ##TMP_20180329232542_4ZXCO4_CalProb_AVG_B0 part 2/2. Populate
...
FROM ##TMP_20180329232542_M0QG4S_ADS_sca_2_OUT AS [ADS_sca_2_OUT]), 
[DT_node_data] AS 
...
FROM isotonic_cte_3)
 INSERT INTO ##TMP_20180329232542_4ZXCO4_CalProb_AVG_B0 ([KEY], [Proba_1], [Proba_0]) SELECT [CalProb_AVG_B0].[KEY], [CalProb_AVG_B0].[Proba_1], [CalProb_AVG_B0].[Proba_0] 
...
-- Code For temporary table ##TMP_20180329232542_1MJW1O_CalProb_AVG_Union part 1/2. Create 


CREATE TABLE ##TMP_20180329232542_1MJW1O_CalProb_AVG_Union (
	[KEY] BIGINT NULL, 
	[Proba_1] FLOAT NULL, 
	[Proba_0] FLOAT NULL
)
...
-- Code For temporary table ##TMP_20180329232542_1MJW1O_CalProb_AVG_Union part 2/2. Populate

INSERT INTO ##TMP_20180329232542_1MJW1O_CalProb_AVG_Union ([KEY], [Proba_1], [Proba_0]) SELECT [CalProb_AVG_Union].[KEY], [CalProb_AVG_Union].[Proba_1], [CalProb_AVG_Union].[Proba_0] 
...
FROM ##TMP_20180329232542_4ZXCO4_CalProb_AVG_B0 AS [CalProb_AVG_B0]) AS [CalProb_AVG_EnsembleUnion]) AS [CalProb_AVG_Union]
...
FROM ##TMP_20180329232542_1MJW1O_CalProb_AVG_Union AS [CalProb_AVG_Union] GROUP BY [CalProb_AVG_Union].[KEY]) AS [T]), 
orig_cte AS 
