...
-- Code For temporary table TMP_20180329231829_G8Q33A_GB_Sum_B0 part 1/2. Create 


CREATE TEMPORARY TABLE "TMP_20180329231829_G8Q33A_GB_Sum_B0" (
	"KEY" BIGINT, 
	"Estimator" FLOAT
)


-- Code For temporary table TMP_20180329231829_G8Q33A_GB_Sum_B0 part 2/2. Populate
...
FROM "DT_Output_9")
 INSERT INTO "TMP_20180329231829_G8Q33A_GB_Sum_B0" ("KEY", "Estimator") SELECT "GB_Sum_B0"."KEY", "GB_Sum_B0"."Estimator" 
...
-- Code For temporary table TMP_20180329231829_8TM20J_GB_Sum_B1 part 1/2. Create 


CREATE TEMPORARY TABLE "TMP_20180329231829_8TM20J_GB_Sum_B1" (
	"KEY" BIGINT, 
	"Estimator" FLOAT
)


-- Code For temporary table TMP_20180329231829_8TM20J_GB_Sum_B1 part 2/2. Populate
...
FROM "DT_Output_15")
 INSERT INTO "TMP_20180329231829_8TM20J_GB_Sum_B1" ("KEY", "Estimator") SELECT "GB_Sum_B1"."KEY", "GB_Sum_B1"."Estimator" 
...
-- Code For temporary table TMP_20180329231829_HXOHBJ_GB_Sum_Union part 1/2. Create 


CREATE TEMPORARY TABLE "TMP_20180329231829_HXOHBJ_GB_Sum_Union" (
	"KEY" BIGINT, 
	"Estimator" FLOAT
)


-- Code For temporary table TMP_20180329231829_HXOHBJ_GB_Sum_Union part 2/2. Populate

INSERT INTO "TMP_20180329231829_HXOHBJ_GB_Sum_Union" ("KEY", "Estimator") SELECT "GB_Sum_Union"."KEY", "GB_Sum_Union"."Estimator" 
...
FROM "TMP_20180329231829_G8Q33A_GB_Sum_B0" AS "GB_Sum_B0" UNION ALL SELECT "GB_Sum_B1"."KEY" AS "KEY", "GB_Sum_B1"."Estimator" AS "Estimator" 
FROM "TMP_20180329231829_8TM20J_GB_Sum_B1" AS "GB_Sum_B1") AS "GB_Sum_EnsembleUnion") AS "GB_Sum_Union"
...
FROM "TMP_20180329231829_HXOHBJ_GB_Sum_Union" AS "GB_Sum_Union" GROUP BY "GB_Sum_Union"."KEY") AS "T")
