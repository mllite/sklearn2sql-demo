...
-- Code For temporary table 329232321_SPFULZ_GB_SUM_B0 part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE "329232321_SPFULZ_GB_SUM_B0" (
	"KEY" NUMBER(19), 
	"Estimator" BINARY_DOUBLE
)

 ON COMMIT PRESERVE ROWS
-- Code For temporary table 329232321_SPFULZ_GB_SUM_B0 part 2/2. Populate

INSERT INTO "329232321_SPFULZ_GB_SUM_B0" ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
-- Code For temporary table 329232321_H2THX4_GB_SUM_B1 part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE "329232321_H2THX4_GB_SUM_B1" (
	"KEY" NUMBER(19), 
	"Estimator" BINARY_DOUBLE
)

 ON COMMIT PRESERVE ROWS
-- Code For temporary table 329232321_H2THX4_GB_SUM_B1 part 2/2. Populate

INSERT INTO "329232321_H2THX4_GB_SUM_B1" ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
-- Code For temporary table 232321_6AA4YJ_GB_SUM_UNION part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE "232321_6AA4YJ_GB_SUM_UNION" (
	"KEY" NUMBER(19), 
	"Estimator" BINARY_DOUBLE
)

 ON COMMIT PRESERVE ROWS
-- Code For temporary table 232321_6AA4YJ_GB_SUM_UNION part 2/2. Populate

INSERT INTO "232321_6AA4YJ_GB_SUM_UNION" ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
FROM "329232321_SPFULZ_GB_SUM_B0" "GB_Sum_B0" UNION ALL SELECT "GB_Sum_B1"."KEY" AS "KEY", "GB_Sum_B1"."Estimator" AS "Estimator" 
FROM "329232321_H2THX4_GB_SUM_B1" "GB_Sum_B1") "GB_Sum_EnsembleUnion") "GB_Sum_Union") "U"
...
FROM "232321_6AA4YJ_GB_SUM_UNION" "GB_Sum_Union" GROUP BY "GB_Sum_Union"."KEY") "T")
