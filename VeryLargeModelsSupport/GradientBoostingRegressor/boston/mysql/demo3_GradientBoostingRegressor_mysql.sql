...
-- Code For temporary table TMP_20180329232014_UUU6I3_GB_Sum_B0 part 1/2. Create 


CREATE TEMPORARY TABLE `TMP_20180329232014_UUU6I3_GB_Sum_B0` (
	`KEY` BIGINT, 
	`Estimator` DOUBLE
)

 ENGINE=MEMORY
-- Code For temporary table TMP_20180329232014_UUU6I3_GB_Sum_B0 part 2/2. Populate

INSERT INTO `TMP_20180329232014_UUU6I3_GB_Sum_B0` (`KEY`, `Estimator`) SELECT `U`.`KEY`, `U`.`Estimator` 
...
-- Code For temporary table TMP_20180329232015_HQ9JM9_GB_Sum_B1 part 1/2. Create 


CREATE TEMPORARY TABLE `TMP_20180329232015_HQ9JM9_GB_Sum_B1` (
	`KEY` BIGINT, 
	`Estimator` DOUBLE
)

 ENGINE=MEMORY
-- Code For temporary table TMP_20180329232015_HQ9JM9_GB_Sum_B1 part 2/2. Populate

INSERT INTO `TMP_20180329232015_HQ9JM9_GB_Sum_B1` (`KEY`, `Estimator`) SELECT `U`.`KEY`, `U`.`Estimator` 
...
-- Code For temporary table TMP_20180329232015_R93S3L_GB_Sum_Union part 1/2. Create 


CREATE TEMPORARY TABLE `TMP_20180329232015_R93S3L_GB_Sum_Union` (
	`KEY` BIGINT, 
	`Estimator` DOUBLE
)

 ENGINE=MEMORY
-- Code For temporary table TMP_20180329232015_R93S3L_GB_Sum_Union part 2/2. Populate

INSERT INTO `TMP_20180329232015_R93S3L_GB_Sum_Union` (`KEY`, `Estimator`) SELECT `U`.`KEY`, `U`.`Estimator` 
...
FROM `TMP_20180329232014_UUU6I3_GB_Sum_B0` AS `GB_Sum_B0` UNION ALL SELECT `GB_Sum_B1`.`KEY` AS `KEY`, `GB_Sum_B1`.`Estimator` AS `Estimator` 
FROM `TMP_20180329232015_HQ9JM9_GB_Sum_B1` AS `GB_Sum_B1`) AS `GB_Sum_EnsembleUnion`) AS `GB_Sum_Union`) AS `U`
...
FROM `TMP_20180329232015_R93S3L_GB_Sum_Union` AS `GB_Sum_Union` GROUP BY `GB_Sum_Union`.`KEY`) AS `T`)
