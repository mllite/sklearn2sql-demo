...
-- Code For temporary table TMP_20180329232503_VZV49I_ADS_imp_1_OUT part 1/2. Create 


CREATE TEMPORARY TABLE "TMP_20180329232503_VZV49I_ADS_imp_1_OUT" (
	"KEY" BIGINT, 
	impter_2 FLOAT, 
	impter_3 FLOAT, 
	impter_4 FLOAT, 
...
-- Code For temporary table TMP_20180329232503_VZV49I_ADS_imp_1_OUT part 2/2. Populate

INSERT INTO "TMP_20180329232503_VZV49I_ADS_imp_1_OUT" ("KEY", impter_2, impter_3, impter_4, impter_5, impter_6, impter_7, impter_8, impter_9, impter_10, impter_11) SELECT "ADS_imp_1_OUT"."KEY", "ADS_imp_1_OUT".impter_2, "ADS_imp_1_OUT".impter_3, "ADS_imp_1_OUT".impter_4, "ADS_imp_1_OUT".impter_5, "ADS_imp_1_OUT".impter_6, "ADS_imp_1_OUT".impter_7, "ADS_imp_1_OUT".impter_8, "ADS_imp_1_OUT".impter_9, "ADS_imp_1_OUT".impter_10, "ADS_imp_1_OUT".impter_11 
...
-- Code For temporary table TMP_20180329232503_W1ZXDW_ADS_sca_2_OUT part 1/2. Create 


CREATE TEMPORARY TABLE "TMP_20180329232503_W1ZXDW_ADS_sca_2_OUT" (
	"KEY" BIGINT, 
	scaler_2 FLOAT, 
	scaler_3 FLOAT, 
	scaler_4 FLOAT, 
...
-- Code For temporary table TMP_20180329232503_W1ZXDW_ADS_sca_2_OUT part 2/2. Populate

INSERT INTO "TMP_20180329232503_W1ZXDW_ADS_sca_2_OUT" ("KEY", scaler_2, scaler_3, scaler_4, scaler_5, scaler_6, scaler_7, scaler_8, scaler_9, scaler_10, scaler_11) SELECT "ADS_sca_2_OUT"."KEY", "ADS_sca_2_OUT".scaler_2, "ADS_sca_2_OUT".scaler_3, "ADS_sca_2_OUT".scaler_4, "ADS_sca_2_OUT".scaler_5, "ADS_sca_2_OUT".scaler_6, "ADS_sca_2_OUT".scaler_7, "ADS_sca_2_OUT".scaler_8, "ADS_sca_2_OUT".scaler_9, "ADS_sca_2_OUT".scaler_10, "ADS_sca_2_OUT".scaler_11 
...
FROM "TMP_20180329232503_VZV49I_ADS_imp_1_OUT" AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT"
-- Code For temporary table TMP_20180329232503_AMT7QT_LGBM_Sum_B0 part 1/2. Create 


CREATE TEMPORARY TABLE "TMP_20180329232503_AMT7QT_LGBM_Sum_B0" (
	"KEY" BIGINT, 
	"Score_0" FLOAT
)


-- Code For temporary table TMP_20180329232503_AMT7QT_LGBM_Sum_B0 part 2/2. Populate
...
FROM "TMP_20180329232503_W1ZXDW_ADS_sca_2_OUT" AS "ADS_sca_2_OUT"), 
"DT_node_data" AS 
...
FROM "DT_Output_9")
 INSERT INTO "TMP_20180329232503_AMT7QT_LGBM_Sum_B0" ("KEY", "Score_0") SELECT "LGBM_Sum_B0"."KEY", "LGBM_Sum_B0"."Score_0" 
...
-- Code For temporary table TMP_20180329232503_FMRCHS_LGBM_Sum_B1 part 1/2. Create 


CREATE TEMPORARY TABLE "TMP_20180329232503_FMRCHS_LGBM_Sum_B1" (
	"KEY" BIGINT, 
	"Score_0" FLOAT
)


-- Code For temporary table TMP_20180329232503_FMRCHS_LGBM_Sum_B1 part 2/2. Populate
...
FROM "DT_Output_15")
 INSERT INTO "TMP_20180329232503_FMRCHS_LGBM_Sum_B1" ("KEY", "Score_0") SELECT "LGBM_Sum_B1"."KEY", "LGBM_Sum_B1"."Score_0" 
...
-- Code For temporary table TMP_20180329232503_YTDQJ4_LGBM_Sum_Union part 1/2. Create 


CREATE TEMPORARY TABLE "TMP_20180329232503_YTDQJ4_LGBM_Sum_Union" (
	"KEY" BIGINT, 
	"Score_0" FLOAT
)


-- Code For temporary table TMP_20180329232503_YTDQJ4_LGBM_Sum_Union part 2/2. Populate

INSERT INTO "TMP_20180329232503_YTDQJ4_LGBM_Sum_Union" ("KEY", "Score_0") SELECT "LGBM_Sum_Union"."KEY", "LGBM_Sum_Union"."Score_0" 
...
FROM "TMP_20180329232503_AMT7QT_LGBM_Sum_B0" AS "LGBM_Sum_B0" UNION ALL SELECT "LGBM_Sum_B1"."KEY" AS "KEY", "LGBM_Sum_B1"."Score_0" AS "Score_0" 
FROM "TMP_20180329232503_FMRCHS_LGBM_Sum_B1" AS "LGBM_Sum_B1") AS "LGBM_Sum_EnsembleUnion") AS "LGBM_Sum_Union"
...
FROM "TMP_20180329232503_YTDQJ4_LGBM_Sum_Union" AS "LGBM_Sum_Union" GROUP BY "LGBM_Sum_Union"."KEY") AS "T"), 
orig_cte AS 
