...
-- Code For temporary table 2538_SRTTTG_CALPROB_AVG_B0 part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE "2538_SRTTTG_CALPROB_AVG_B0" (
	"KEY" NUMBER(19), 
...
-- Code For temporary table 2538_SRTTTG_CALPROB_AVG_B0 part 2/2. Populate

INSERT INTO "2538_SRTTTG_CALPROB_AVG_B0" ("KEY", "Proba_1", "Proba_0") SELECT "U"."KEY", "U"."Proba_1", "U"."Proba_0" 
...
-- Code For temporary table 8_0VTUWD_CALPROB_AVG_UNION part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE "8_0VTUWD_CALPROB_AVG_UNION" (
	"KEY" NUMBER(19), 
	"Proba_1" BINARY_DOUBLE, 
	"Proba_0" BINARY_DOUBLE
)
 ...
 ON COMMIT PRESERVE ROWS
-- Code For temporary table 8_0VTUWD_CALPROB_AVG_UNION part 2/2. Populate

INSERT INTO "8_0VTUWD_CALPROB_AVG_UNION" ("KEY", "Proba_1", "Proba_0") SELECT "U"."KEY", "U"."Proba_1", "U"."Proba_0" 
...
FROM "2538_SRTTTG_CALPROB_AVG_B0" "CalProb_AVG_B0") "CalProb_AVG_EnsembleUnion") "CalProb_AVG_Union") "U"
...
FROM "8_0VTUWD_CALPROB_AVG_UNION" "CalProb_AVG_Union" GROUP BY "CalProb_AVG_Union"."KEY") "T"), 
orig_cte AS 
