...
-- Code For temporary table TMP_20180329232537_IF7F0Q_CalProb_AVG_B0 part 1/2. Create 


CREATE TEMPORARY TABLE `TMP_20180329232537_IF7F0Q_CalProb_AVG_B0` (
	`KEY` BIGINT, 
	`Proba_1` DOUBLE, 
	`Proba_0` DOUBLE
)
 ...
 ENGINE=MEMORY
-- Code For temporary table TMP_20180329232537_IF7F0Q_CalProb_AVG_B0 part 2/2. Populate

INSERT INTO `TMP_20180329232537_IF7F0Q_CalProb_AVG_B0` (`KEY`, `Proba_1`, `Proba_0`) SELECT `U`.`KEY`, `U`.`Proba_1`, `U`.`Proba_0` 
...
-- Code For temporary table TMP_20180329232537_A2AM1N_CalProb_AVG_Union part 1/2. Create 


CREATE TEMPORARY TABLE `TMP_20180329232537_A2AM1N_CalProb_AVG_Union` (
	`KEY` BIGINT, 
	`Proba_1` DOUBLE, 
	`Proba_0` DOUBLE
)
 ...
 ENGINE=MEMORY
-- Code For temporary table TMP_20180329232537_A2AM1N_CalProb_AVG_Union part 2/2. Populate

INSERT INTO `TMP_20180329232537_A2AM1N_CalProb_AVG_Union` (`KEY`, `Proba_1`, `Proba_0`) SELECT `U`.`KEY`, `U`.`Proba_1`, `U`.`Proba_0` 
...
FROM `TMP_20180329232537_IF7F0Q_CalProb_AVG_B0` AS `CalProb_AVG_B0`) AS `CalProb_AVG_EnsembleUnion`) AS `CalProb_AVG_Union`) AS `U`
...
FROM `TMP_20180329232537_A2AM1N_CalProb_AVG_Union` AS `CalProb_AVG_Union` GROUP BY `CalProb_AVG_Union`.`KEY`) AS `T`), 
orig_cte AS 
