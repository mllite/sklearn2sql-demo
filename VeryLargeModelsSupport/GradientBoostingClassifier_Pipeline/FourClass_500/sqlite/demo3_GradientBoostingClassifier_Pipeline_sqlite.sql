...
-- Code For temporary table TMP_20180329233354_0TV3GQ_ADS_imp_1_OUT part 1/2. Create 


CREATE TEMPORARY TABLE "TMP_20180329233354_0TV3GQ_ADS_imp_1_OUT" (
	"KEY" BIGINT, 
	impter_2 FLOAT, 
	impter_3 FLOAT, 
	impter_4 FLOAT, 
...
-- Code For temporary table TMP_20180329233355_LTF8OY_ADS_sca_2_OUT part 1/2. Create 


CREATE TEMPORARY TABLE "TMP_20180329233355_LTF8OY_ADS_sca_2_OUT" (
	"KEY" BIGINT, 
	scaler_2 FLOAT, 
	scaler_3 FLOAT, 
	scaler_4 FLOAT, 
...
FROM "TMP_20180329233354_0TV3GQ_ADS_imp_1_OUT" AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT"
-- Code For temporary table TMP_20180329233356_A1D7ZI_GB_Sum_B0 part 1/2. Create 


CREATE TEMPORARY TABLE "TMP_20180329233356_A1D7ZI_GB_Sum_B0" (
	"KEY" BIGINT, 
	"Score_0" FLOAT, 
	"Score_1" FLOAT, 
	"Score_2" FLOAT, 
...
-- Code For temporary table TMP_20180329233356_A1D7ZI_GB_Sum_B0 part 2/2. Populate
...
FROM "TMP_20180329233355_LTF8OY_ADS_sca_2_OUT" AS "ADS_sca_2_OUT"), 
"DT_node_data" AS 
...
FROM "DT_Output_9")
 INSERT INTO "TMP_20180329233356_A1D7ZI_GB_Sum_B0" ("KEY", "Score_0", "Score_1", "Score_2", "Score_3") SELECT "GB_Sum_B0"."KEY", "GB_Sum_B0"."Score_0", "GB_Sum_B0"."Score_1", "GB_Sum_B0"."Score_2", "GB_Sum_B0"."Score_3" 
...
-- Code For temporary table TMP_20180329233356_XQWRIM_GB_Sum_B1 part 1/2. Create 


CREATE TEMPORARY TABLE "TMP_20180329233356_XQWRIM_GB_Sum_B1" (
	"KEY" BIGINT, 
	"Score_0" FLOAT, 
	"Score_1" FLOAT, 
	"Score_2" FLOAT, 
...
-- Code For temporary table TMP_20180329233356_XQWRIM_GB_Sum_B1 part 2/2. Populate
...
FROM "DT_Output_19")
 INSERT INTO "TMP_20180329233356_XQWRIM_GB_Sum_B1" ("KEY", "Score_0", "Score_1", "Score_2", "Score_3") SELECT "GB_Sum_B1"."KEY", "GB_Sum_B1"."Score_0", "GB_Sum_B1"."Score_1", "GB_Sum_B1"."Score_2", "GB_Sum_B1"."Score_3" 
...
-- Code For temporary table TMP_20180329233356_0KM951_GB_Sum_B2 part 1/2. Create 


CREATE TEMPORARY TABLE "TMP_20180329233356_0KM951_GB_Sum_B2" (
	"KEY" BIGINT, 
	"Score_0" FLOAT, 
	"Score_1" FLOAT, 
	"Score_2" FLOAT, 
...
-- Code For temporary table TMP_20180329233356_0KM951_GB_Sum_B2 part 2/2. Populate
...
FROM "DT_Output_29")
 INSERT INTO "TMP_20180329233356_0KM951_GB_Sum_B2" ("KEY", "Score_0", "Score_1", "Score_2", "Score_3") SELECT "GB_Sum_B2"."KEY", "GB_Sum_B2"."Score_0", "GB_Sum_B2"."Score_1", "GB_Sum_B2"."Score_2", "GB_Sum_B2"."Score_3" 
...
-- Code For temporary table TMP_20180329233356_3FP26B_GB_Sum_B3 part 1/2. Create 


CREATE TEMPORARY TABLE "TMP_20180329233356_3FP26B_GB_Sum_B3" (
	"KEY" BIGINT, 
	"Score_0" FLOAT, 
	"Score_1" FLOAT, 
	"Score_2" FLOAT, 
...
-- Code For temporary table TMP_20180329233356_3FP26B_GB_Sum_B3 part 2/2. Populate
...
FROM "DT_Output_39")
 INSERT INTO "TMP_20180329233356_3FP26B_GB_Sum_B3" ("KEY", "Score_0", "Score_1", "Score_2", "Score_3") SELECT "GB_Sum_B3"."KEY", "GB_Sum_B3"."Score_0", "GB_Sum_B3"."Score_1", "GB_Sum_B3"."Score_2", "GB_Sum_B3"."Score_3" 
...
-- Code For temporary table TMP_20180329233356_Q6BH7T_GB_Sum_B4 part 1/2. Create 


CREATE TEMPORARY TABLE "TMP_20180329233356_Q6BH7T_GB_Sum_B4" (
	"KEY" BIGINT, 
	"Score_0" FLOAT, 
	"Score_1" FLOAT, 
	"Score_2" FLOAT, 
...
-- Code For temporary table TMP_20180329233356_Q6BH7T_GB_Sum_B4 part 2/2. Populate
...
FROM "DT_Output_49")
 INSERT INTO "TMP_20180329233356_Q6BH7T_GB_Sum_B4" ("KEY", "Score_0", "Score_1", "Score_2", "Score_3") SELECT "GB_Sum_B4"."KEY", "GB_Sum_B4"."Score_0", "GB_Sum_B4"."Score_1", "GB_Sum_B4"."Score_2", "GB_Sum_B4"."Score_3" 
...
-- Code For temporary table TMP_20180329233356_F1CFG2_GB_Sum_B5 part 1/2. Create 


CREATE TEMPORARY TABLE "TMP_20180329233356_F1CFG2_GB_Sum_B5" (
	"KEY" BIGINT, 
	"Score_0" FLOAT, 
	"Score_1" FLOAT, 
	"Score_2" FLOAT, 
...
-- Code For temporary table TMP_20180329233356_F1CFG2_GB_Sum_B5 part 2/2. Populate
...
FROM "DT_Output_59")
 INSERT INTO "TMP_20180329233356_F1CFG2_GB_Sum_B5" ("KEY", "Score_0", "Score_1", "Score_2", "Score_3") SELECT "GB_Sum_B5"."KEY", "GB_Sum_B5"."Score_0", "GB_Sum_B5"."Score_1", "GB_Sum_B5"."Score_2", "GB_Sum_B5"."Score_3" 
...
-- Code For temporary table TMP_20180329233356_K12SUP_GB_Sum_B6 part 1/2. Create 


CREATE TEMPORARY TABLE "TMP_20180329233356_K12SUP_GB_Sum_B6" (
	"KEY" BIGINT, 
	"Score_0" FLOAT, 
	"Score_1" FLOAT, 
	"Score_2" FLOAT, 
...
-- Code For temporary table TMP_20180329233356_K12SUP_GB_Sum_B6 part 2/2. Populate
...
FROM "DT_Output_63")
 INSERT INTO "TMP_20180329233356_K12SUP_GB_Sum_B6" ("KEY", "Score_0", "Score_1", "Score_2", "Score_3") SELECT "GB_Sum_B6"."KEY", "GB_Sum_B6"."Score_0", "GB_Sum_B6"."Score_1", "GB_Sum_B6"."Score_2", "GB_Sum_B6"."Score_3" 
...
-- Code For temporary table TMP_20180329233356_ROLVXJ_GB_Sum_Union part 1/2. Create 


CREATE TEMPORARY TABLE "TMP_20180329233356_ROLVXJ_GB_Sum_Union" (
	"KEY" BIGINT, 
	"Score_0" FLOAT, 
	"Score_1" FLOAT, 
	"Score_2" FLOAT, 
...
-- Code For temporary table TMP_20180329233356_ROLVXJ_GB_Sum_Union part 2/2. Populate

INSERT INTO "TMP_20180329233356_ROLVXJ_GB_Sum_Union" ("KEY", "Score_0", "Score_1", "Score_2", "Score_3") SELECT "GB_Sum_Union"."KEY", "GB_Sum_Union"."Score_0", "GB_Sum_Union"."Score_1", "GB_Sum_Union"."Score_2", "GB_Sum_Union"."Score_3" 
...
FROM "TMP_20180329233356_A1D7ZI_GB_Sum_B0" AS "GB_Sum_B0" UNION ALL SELECT "GB_Sum_B1"."KEY" AS "KEY", "GB_Sum_B1"."Score_0" AS "Score_0", "GB_Sum_B1"."Score_1" AS "Score_1", "GB_Sum_B1"."Score_2" AS "Score_2", "GB_Sum_B1"."Score_3" AS "Score_3" 
FROM "TMP_20180329233356_XQWRIM_GB_Sum_B1" AS "GB_Sum_B1" UNION ALL SELECT "GB_Sum_B2"."KEY" AS "KEY", "GB_Sum_B2"."Score_0" AS "Score_0", "GB_Sum_B2"."Score_1" AS "Score_1", "GB_Sum_B2"."Score_2" AS "Score_2", "GB_Sum_B2"."Score_3" AS "Score_3" 
FROM "TMP_20180329233356_0KM951_GB_Sum_B2" AS "GB_Sum_B2" UNION ALL SELECT "GB_Sum_B3"."KEY" AS "KEY", "GB_Sum_B3"."Score_0" AS "Score_0", "GB_Sum_B3"."Score_1" AS "Score_1", "GB_Sum_B3"."Score_2" AS "Score_2", "GB_Sum_B3"."Score_3" AS "Score_3" 
FROM "TMP_20180329233356_3FP26B_GB_Sum_B3" AS "GB_Sum_B3" UNION ALL SELECT "GB_Sum_B4"."KEY" AS "KEY", "GB_Sum_B4"."Score_0" AS "Score_0", "GB_Sum_B4"."Score_1" AS "Score_1", "GB_Sum_B4"."Score_2" AS "Score_2", "GB_Sum_B4"."Score_3" AS "Score_3" 
FROM "TMP_20180329233356_Q6BH7T_GB_Sum_B4" AS "GB_Sum_B4" UNION ALL SELECT "GB_Sum_B5"."KEY" AS "KEY", "GB_Sum_B5"."Score_0" AS "Score_0", "GB_Sum_B5"."Score_1" AS "Score_1", "GB_Sum_B5"."Score_2" AS "Score_2", "GB_Sum_B5"."Score_3" AS "Score_3" 
FROM "TMP_20180329233356_F1CFG2_GB_Sum_B5" AS "GB_Sum_B5" UNION ALL SELECT "GB_Sum_B6"."KEY" AS "KEY", "GB_Sum_B6"."Score_0" AS "Score_0", "GB_Sum_B6"."Score_1" AS "Score_1", "GB_Sum_B6"."Score_2" AS "Score_2", "GB_Sum_B6"."Score_3" AS "Score_3" 
FROM "TMP_20180329233356_K12SUP_GB_Sum_B6" AS "GB_Sum_B6") AS "GB_Sum_EnsembleUnion") AS "GB_Sum_Union"

-- Model deployment code

WITH "GB_Sum_sum" AS 
(SELECT "T"."KEY" AS "KEY", "T"."Score_0" AS "Score_0", "T"."Score_1" AS "Score_1", "T"."Score_2" AS "Score_2", "T"."Score_3" AS "Score_3" 
FROM (SELECT "GB_Sum_Union"."KEY" AS "KEY", sum(CAST("GB_Sum_Union"."Score_0" AS FLOAT)) AS "Score_0", sum(CAST("GB_Sum_Union"."Score_1" AS FLOAT)) AS "Score_1", sum(CAST("GB_Sum_Union"."Score_2" AS FLOAT)) AS "Score_2", sum(CAST("GB_Sum_Union"."Score_3" AS FLOAT)) AS "Score_3" 
FROM "TMP_20180329233356_ROLVXJ_GB_Sum_Union" AS "GB_Sum_Union" GROUP BY "GB_Sum_Union"."KEY") AS "T"), 
orig_cte AS 
(SELECT "GB_Sum_sum"."KEY" AS "KEY", 0.23875 + 0.1 * "GB_Sum_sum"."Score_0" AS "Score_0", 0.25125 + 0.1 * "GB_Sum_sum"."Score_1" AS "Score_1", 0.2525 + 0.1 * "GB_Sum_sum"."Score_2" AS "Score_2", 0.2575 + 0.1 * "GB_Sum_sum"."Score_3" AS "Score_3", CAST(NULL AS FLOAT) AS "Proba_0", CAST(NULL AS FLOAT) AS "Proba_1", CAST(NULL AS FLOAT) AS "Proba_2", CAST(NULL AS FLOAT) AS "Proba_3", CAST(NULL AS FLOAT) AS "LogProba_0", CAST(NULL AS FLOAT) AS "LogProba_1", CAST(NULL AS FLOAT) AS "LogProba_2", CAST(NULL AS FLOAT) AS "LogProba_3", CAST(NULL AS BIGINT) AS "Decision", CAST(NULL AS FLOAT) AS "DecisionProba" 
FROM "GB_Sum_sum"), 
