...
-- Code For temporary table TMP_20180329233354_1EFAT1_ADS_imp_1_OUT part 1/2. Create 


CREATE TEMPORARY TABLE "TMP_20180329233354_1EFAT1_ADS_imp_1_OUT" (
	"KEY" BIGINT, 
	impter_2 FLOAT, 
	impter_3 FLOAT, 
	impter_4 FLOAT, 
...
-- Code For temporary table TMP_20180329233355_NWQADJ_ADS_sca_2_OUT part 1/2. Create 


CREATE TEMPORARY TABLE "TMP_20180329233355_NWQADJ_ADS_sca_2_OUT" (
	"KEY" BIGINT, 
	scaler_2 FLOAT, 
	scaler_3 FLOAT, 
	scaler_4 FLOAT, 
...
FROM "TMP_20180329233354_1EFAT1_ADS_imp_1_OUT" AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT"
-- Code For temporary table TMP_20180329233356_XPSE60_GB_Sum_B0 part 1/2. Create 


CREATE TEMPORARY TABLE "TMP_20180329233356_XPSE60_GB_Sum_B0" (
	"KEY" BIGINT, 
	"Score_0" FLOAT, 
	"Score_1" FLOAT, 
	"Score_2" FLOAT, 
...
-- Code For temporary table TMP_20180329233356_XPSE60_GB_Sum_B0 part 2/2. Populate
...
FROM "TMP_20180329233355_NWQADJ_ADS_sca_2_OUT" AS "ADS_sca_2_OUT"), 
"DT_node_data" AS 
...
FROM "DT_Output_9")
 INSERT INTO "TMP_20180329233356_XPSE60_GB_Sum_B0" ("KEY", "Score_0", "Score_1", "Score_2", "Score_3") SELECT "GB_Sum_B0"."KEY", "GB_Sum_B0"."Score_0", "GB_Sum_B0"."Score_1", "GB_Sum_B0"."Score_2", "GB_Sum_B0"."Score_3" 
...
-- Code For temporary table TMP_20180329233356_W295E0_GB_Sum_B1 part 1/2. Create 


CREATE TEMPORARY TABLE "TMP_20180329233356_W295E0_GB_Sum_B1" (
	"KEY" BIGINT, 
	"Score_0" FLOAT, 
	"Score_1" FLOAT, 
	"Score_2" FLOAT, 
...
-- Code For temporary table TMP_20180329233356_W295E0_GB_Sum_B1 part 2/2. Populate
...
FROM "DT_Output_19")
 INSERT INTO "TMP_20180329233356_W295E0_GB_Sum_B1" ("KEY", "Score_0", "Score_1", "Score_2", "Score_3") SELECT "GB_Sum_B1"."KEY", "GB_Sum_B1"."Score_0", "GB_Sum_B1"."Score_1", "GB_Sum_B1"."Score_2", "GB_Sum_B1"."Score_3" 
...
-- Code For temporary table TMP_20180329233356_OT7U2O_GB_Sum_B2 part 1/2. Create 


CREATE TEMPORARY TABLE "TMP_20180329233356_OT7U2O_GB_Sum_B2" (
	"KEY" BIGINT, 
	"Score_0" FLOAT, 
	"Score_1" FLOAT, 
	"Score_2" FLOAT, 
...
-- Code For temporary table TMP_20180329233356_OT7U2O_GB_Sum_B2 part 2/2. Populate
...
FROM "DT_Output_29")
 INSERT INTO "TMP_20180329233356_OT7U2O_GB_Sum_B2" ("KEY", "Score_0", "Score_1", "Score_2", "Score_3") SELECT "GB_Sum_B2"."KEY", "GB_Sum_B2"."Score_0", "GB_Sum_B2"."Score_1", "GB_Sum_B2"."Score_2", "GB_Sum_B2"."Score_3" 
...
-- Code For temporary table TMP_20180329233356_WJOLZM_GB_Sum_B3 part 1/2. Create 


CREATE TEMPORARY TABLE "TMP_20180329233356_WJOLZM_GB_Sum_B3" (
	"KEY" BIGINT, 
	"Score_0" FLOAT, 
	"Score_1" FLOAT, 
	"Score_2" FLOAT, 
...
-- Code For temporary table TMP_20180329233356_WJOLZM_GB_Sum_B3 part 2/2. Populate
...
FROM "DT_Output_39")
 INSERT INTO "TMP_20180329233356_WJOLZM_GB_Sum_B3" ("KEY", "Score_0", "Score_1", "Score_2", "Score_3") SELECT "GB_Sum_B3"."KEY", "GB_Sum_B3"."Score_0", "GB_Sum_B3"."Score_1", "GB_Sum_B3"."Score_2", "GB_Sum_B3"."Score_3" 
...
-- Code For temporary table TMP_20180329233356_CH4M0I_GB_Sum_B4 part 1/2. Create 


CREATE TEMPORARY TABLE "TMP_20180329233356_CH4M0I_GB_Sum_B4" (
	"KEY" BIGINT, 
	"Score_0" FLOAT, 
	"Score_1" FLOAT, 
	"Score_2" FLOAT, 
...
-- Code For temporary table TMP_20180329233356_CH4M0I_GB_Sum_B4 part 2/2. Populate
...
FROM "DT_Output_49")
 INSERT INTO "TMP_20180329233356_CH4M0I_GB_Sum_B4" ("KEY", "Score_0", "Score_1", "Score_2", "Score_3") SELECT "GB_Sum_B4"."KEY", "GB_Sum_B4"."Score_0", "GB_Sum_B4"."Score_1", "GB_Sum_B4"."Score_2", "GB_Sum_B4"."Score_3" 
...
-- Code For temporary table TMP_20180329233356_73365N_GB_Sum_B5 part 1/2. Create 


CREATE TEMPORARY TABLE "TMP_20180329233356_73365N_GB_Sum_B5" (
	"KEY" BIGINT, 
	"Score_0" FLOAT, 
	"Score_1" FLOAT, 
	"Score_2" FLOAT, 
...
-- Code For temporary table TMP_20180329233356_73365N_GB_Sum_B5 part 2/2. Populate
...
FROM "DT_Output_59")
 INSERT INTO "TMP_20180329233356_73365N_GB_Sum_B5" ("KEY", "Score_0", "Score_1", "Score_2", "Score_3") SELECT "GB_Sum_B5"."KEY", "GB_Sum_B5"."Score_0", "GB_Sum_B5"."Score_1", "GB_Sum_B5"."Score_2", "GB_Sum_B5"."Score_3" 
...
-- Code For temporary table TMP_20180329233356_RA2R1X_GB_Sum_B6 part 1/2. Create 


CREATE TEMPORARY TABLE "TMP_20180329233356_RA2R1X_GB_Sum_B6" (
	"KEY" BIGINT, 
	"Score_0" FLOAT, 
	"Score_1" FLOAT, 
	"Score_2" FLOAT, 
...
-- Code For temporary table TMP_20180329233356_RA2R1X_GB_Sum_B6 part 2/2. Populate
...
FROM "DT_Output_63")
 INSERT INTO "TMP_20180329233356_RA2R1X_GB_Sum_B6" ("KEY", "Score_0", "Score_1", "Score_2", "Score_3") SELECT "GB_Sum_B6"."KEY", "GB_Sum_B6"."Score_0", "GB_Sum_B6"."Score_1", "GB_Sum_B6"."Score_2", "GB_Sum_B6"."Score_3" 
...
-- Code For temporary table TMP_20180329233356_437A1W_GB_Sum_Union part 1/2. Create 


CREATE TEMPORARY TABLE "TMP_20180329233356_437A1W_GB_Sum_Union" (
	"KEY" BIGINT, 
	"Score_0" FLOAT, 
	"Score_1" FLOAT, 
	"Score_2" FLOAT, 
...
-- Code For temporary table TMP_20180329233356_437A1W_GB_Sum_Union part 2/2. Populate

INSERT INTO "TMP_20180329233356_437A1W_GB_Sum_Union" ("KEY", "Score_0", "Score_1", "Score_2", "Score_3") SELECT "GB_Sum_Union"."KEY", "GB_Sum_Union"."Score_0", "GB_Sum_Union"."Score_1", "GB_Sum_Union"."Score_2", "GB_Sum_Union"."Score_3" 
...
FROM "TMP_20180329233356_XPSE60_GB_Sum_B0" AS "GB_Sum_B0" UNION ALL SELECT "GB_Sum_B1"."KEY" AS "KEY", "GB_Sum_B1"."Score_0" AS "Score_0", "GB_Sum_B1"."Score_1" AS "Score_1", "GB_Sum_B1"."Score_2" AS "Score_2", "GB_Sum_B1"."Score_3" AS "Score_3" 
FROM "TMP_20180329233356_W295E0_GB_Sum_B1" AS "GB_Sum_B1" UNION ALL SELECT "GB_Sum_B2"."KEY" AS "KEY", "GB_Sum_B2"."Score_0" AS "Score_0", "GB_Sum_B2"."Score_1" AS "Score_1", "GB_Sum_B2"."Score_2" AS "Score_2", "GB_Sum_B2"."Score_3" AS "Score_3" 
FROM "TMP_20180329233356_OT7U2O_GB_Sum_B2" AS "GB_Sum_B2" UNION ALL SELECT "GB_Sum_B3"."KEY" AS "KEY", "GB_Sum_B3"."Score_0" AS "Score_0", "GB_Sum_B3"."Score_1" AS "Score_1", "GB_Sum_B3"."Score_2" AS "Score_2", "GB_Sum_B3"."Score_3" AS "Score_3" 
FROM "TMP_20180329233356_WJOLZM_GB_Sum_B3" AS "GB_Sum_B3" UNION ALL SELECT "GB_Sum_B4"."KEY" AS "KEY", "GB_Sum_B4"."Score_0" AS "Score_0", "GB_Sum_B4"."Score_1" AS "Score_1", "GB_Sum_B4"."Score_2" AS "Score_2", "GB_Sum_B4"."Score_3" AS "Score_3" 
FROM "TMP_20180329233356_CH4M0I_GB_Sum_B4" AS "GB_Sum_B4" UNION ALL SELECT "GB_Sum_B5"."KEY" AS "KEY", "GB_Sum_B5"."Score_0" AS "Score_0", "GB_Sum_B5"."Score_1" AS "Score_1", "GB_Sum_B5"."Score_2" AS "Score_2", "GB_Sum_B5"."Score_3" AS "Score_3" 
FROM "TMP_20180329233356_73365N_GB_Sum_B5" AS "GB_Sum_B5" UNION ALL SELECT "GB_Sum_B6"."KEY" AS "KEY", "GB_Sum_B6"."Score_0" AS "Score_0", "GB_Sum_B6"."Score_1" AS "Score_1", "GB_Sum_B6"."Score_2" AS "Score_2", "GB_Sum_B6"."Score_3" AS "Score_3" 
FROM "TMP_20180329233356_RA2R1X_GB_Sum_B6" AS "GB_Sum_B6") AS "GB_Sum_EnsembleUnion") AS "GB_Sum_Union"
...
FROM "TMP_20180329233356_437A1W_GB_Sum_Union" AS "GB_Sum_Union" GROUP BY "GB_Sum_Union"."KEY") AS "T"), 
orig_cte AS 
