...
-- Code For temporary table TMP_20180329232552_IA2PUO_ADS_imp_1_OUT part 1/2. Create 


CREATE TEMPORARY TABLE `TMP_20180329232552_IA2PUO_ADS_imp_1_OUT` (
	`KEY` BIGINT, 
	impter_2 DOUBLE, 
	impter_3 DOUBLE, 
	impter_4 DOUBLE, 
...
-- Code For temporary table TMP_20180329232552_9TTC4X_ADS_sca_2_OUT part 1/2. Create 


CREATE TEMPORARY TABLE `TMP_20180329232552_9TTC4X_ADS_sca_2_OUT` (
	`KEY` BIGINT, 
	scaler_2 DOUBLE, 
	scaler_3 DOUBLE, 
	scaler_4 DOUBLE, 
...
FROM `TMP_20180329232552_IA2PUO_ADS_imp_1_OUT` AS `ADS_imp_1_OUT`) AS `ADS_sca_2_OUT`) AS `U`
-- Code For temporary table TMP_20180329232554_BWB2SZ_GB_Sum_B0 part 1/2. Create 


CREATE TEMPORARY TABLE `TMP_20180329232554_BWB2SZ_GB_Sum_B0` (
	`KEY` BIGINT, 
	`Score_0` DOUBLE, 
	`Score_1` DOUBLE
)
 ...
 ENGINE=MEMORY
-- Code For temporary table TMP_20180329232554_BWB2SZ_GB_Sum_B0 part 2/2. Populate

INSERT INTO `TMP_20180329232554_BWB2SZ_GB_Sum_B0` (`KEY`, `Score_0`, `Score_1`) SELECT `U`.`KEY`, `U`.`Score_0`, `U`.`Score_1` 
...
FROM `TMP_20180329232552_9TTC4X_ADS_sca_2_OUT` AS `ADS_sca_2_OUT`), 
`DT_node_data` AS 
...
-- Code For temporary table TMP_20180329232554_ZR72NZ_GB_Sum_B1 part 1/2. Create 


CREATE TEMPORARY TABLE `TMP_20180329232554_ZR72NZ_GB_Sum_B1` (
	`KEY` BIGINT, 
	`Score_0` DOUBLE, 
	`Score_1` DOUBLE
)
 ...
 ENGINE=MEMORY
-- Code For temporary table TMP_20180329232554_ZR72NZ_GB_Sum_B1 part 2/2. Populate

INSERT INTO `TMP_20180329232554_ZR72NZ_GB_Sum_B1` (`KEY`, `Score_0`, `Score_1`) SELECT `U`.`KEY`, `U`.`Score_0`, `U`.`Score_1` 
...
-- Code For temporary table TMP_20180329232555_4CH3DY_GB_Sum_B2 part 1/2. Create 


CREATE TEMPORARY TABLE `TMP_20180329232555_4CH3DY_GB_Sum_B2` (
	`KEY` BIGINT, 
	`Score_0` DOUBLE, 
	`Score_1` DOUBLE
)
 ...
 ENGINE=MEMORY
-- Code For temporary table TMP_20180329232555_4CH3DY_GB_Sum_B2 part 2/2. Populate

INSERT INTO `TMP_20180329232555_4CH3DY_GB_Sum_B2` (`KEY`, `Score_0`, `Score_1`) SELECT `U`.`KEY`, `U`.`Score_0`, `U`.`Score_1` 
...
-- Code For temporary table TMP_20180329232555_4RHXUO_GB_Sum_B3 part 1/2. Create 


CREATE TEMPORARY TABLE `TMP_20180329232555_4RHXUO_GB_Sum_B3` (
	`KEY` BIGINT, 
	`Score_0` DOUBLE, 
	`Score_1` DOUBLE
)
 ...
 ENGINE=MEMORY
-- Code For temporary table TMP_20180329232555_4RHXUO_GB_Sum_B3 part 2/2. Populate

INSERT INTO `TMP_20180329232555_4RHXUO_GB_Sum_B3` (`KEY`, `Score_0`, `Score_1`) SELECT `U`.`KEY`, `U`.`Score_0`, `U`.`Score_1` 
...
-- Code For temporary table TMP_20180329232555_VNG8NI_GB_Sum_Union part 1/2. Create 


CREATE TEMPORARY TABLE `TMP_20180329232555_VNG8NI_GB_Sum_Union` (
	`KEY` BIGINT, 
	`Score_0` DOUBLE, 
	`Score_1` DOUBLE
)
 ...
 ENGINE=MEMORY
-- Code For temporary table TMP_20180329232555_VNG8NI_GB_Sum_Union part 2/2. Populate

INSERT INTO `TMP_20180329232555_VNG8NI_GB_Sum_Union` (`KEY`, `Score_0`, `Score_1`) SELECT `U`.`KEY`, `U`.`Score_0`, `U`.`Score_1` 
...
FROM `TMP_20180329232554_BWB2SZ_GB_Sum_B0` AS `GB_Sum_B0` UNION ALL SELECT `GB_Sum_B1`.`KEY` AS `KEY`, `GB_Sum_B1`.`Score_0` AS `Score_0`, `GB_Sum_B1`.`Score_1` AS `Score_1` 
FROM `TMP_20180329232554_ZR72NZ_GB_Sum_B1` AS `GB_Sum_B1` UNION ALL SELECT `GB_Sum_B2`.`KEY` AS `KEY`, `GB_Sum_B2`.`Score_0` AS `Score_0`, `GB_Sum_B2`.`Score_1` AS `Score_1` 
FROM `TMP_20180329232555_4CH3DY_GB_Sum_B2` AS `GB_Sum_B2` UNION ALL SELECT `GB_Sum_B3`.`KEY` AS `KEY`, `GB_Sum_B3`.`Score_0` AS `Score_0`, `GB_Sum_B3`.`Score_1` AS `Score_1` 
FROM `TMP_20180329232555_4RHXUO_GB_Sum_B3` AS `GB_Sum_B3`) AS `GB_Sum_EnsembleUnion`) AS `GB_Sum_Union`) AS `U`
...
FROM `TMP_20180329232555_VNG8NI_GB_Sum_Union` AS `GB_Sum_Union` GROUP BY `GB_Sum_Union`.`KEY`) AS `T`), 
orig_cte AS 
(SELECT `GB_Sum_sum`.`KEY` AS `KEY`, -(-0.10008345855698253 + 0.1 * `GB_Sum_sum`.`Score_1`) AS `Score_0`, -0.10008345855698253 + 0.1 * `GB_Sum_sum`.`Score_1` AS `Score_1`, 1.0 - 1.0 / (1.0 + exp(least(greatest(-100.0, -(-0.10008345855698253 + 0.1 * `GB_Sum_sum`.`Score_1`)), 100.0))) AS `Proba_0`, 1.0 / (1.0 + exp(least(greatest(-100.0, -(-0.10008345855698253 + 0.1 * `GB_Sum_sum`.`Score_1`)), 100.0))) AS `Proba_1`, NULL AS `LogProba_0`, NULL AS `LogProba_1`, CAST(NULL AS SIGNED INTEGER) AS `Decision`, NULL AS `DecisionProba` 
FROM `GB_Sum_sum`), 
