...
-- Code For temporary table ##TMP_20180329232554_W4OM9J_ADS_imp_1_OUT part 1/2. Create 


CREATE TABLE ##TMP_20180329232554_W4OM9J_ADS_imp_1_OUT (
	[KEY] BIGINT NULL, 
...
-- Code For temporary table ##TMP_20180329232555_8BBH74_ADS_sca_2_OUT part 1/2. Create 


CREATE TABLE ##TMP_20180329232555_8BBH74_ADS_sca_2_OUT (
	[KEY] BIGINT NULL, 
	scaler_2 FLOAT NULL, 
	scaler_3 FLOAT NULL, 
	scaler_4 FLOAT NULL, 
...
FROM ##TMP_20180329232554_W4OM9J_ADS_imp_1_OUT AS [ADS_imp_1_OUT]) AS [ADS_sca_2_OUT]
-- Code For temporary table ##TMP_20180329232556_8R6A8O_GB_Sum_B0 part 1/2. Create 


CREATE TABLE ##TMP_20180329232556_8R6A8O_GB_Sum_B0 (
	[KEY] BIGINT NULL, 
...
-- Code For temporary table ##TMP_20180329232556_8R6A8O_GB_Sum_B0 part 2/2. Populate
...
FROM ##TMP_20180329232555_8BBH74_ADS_sca_2_OUT AS [ADS_sca_2_OUT]), 
[DT_node_data] AS 
(SELECT [Values].node_id AS node_id, [Values].feature AS feature, [Values].threshold AS threshold, [Values].count AS count, [Values].depth AS depth, [Values].parent_id AS parent_id, [Values].[Estimator] AS [Estimator] 
FROM (SELECT 3 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 42 AS count, 3 AS depth, 2 AS parent_id, -1.6183315431435734 AS [Estimator] UNION ALL SELECT 4 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 2 AS count, 3 AS depth, 2 AS parent_id, 2.1052631578947363 AS [Estimator] UNION ALL SELECT 6 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS count, 3 AS depth, 5 AS parent_id, 2.1052631578947363 AS [Estimator] UNION ALL SELECT 7 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 1 AS count, 3 AS depth, 5 AS parent_id, -1.904761904761905 AS [Estimator] UNION ALL SELECT 10 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 1 AS count, 3 AS depth, 9 AS parent_id, -1.904761904761905 AS [Estimator] UNION ALL SELECT 11 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 30 AS count, 3 AS depth, 9 AS parent_id, 2.105263157894737 AS [Estimator] UNION ALL SELECT 12 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 1 AS count, 2 AS depth, 8 AS parent_id, -1.904761904761905 AS [Estimator]) AS [Values]), 
[DT_Output] AS 
...
[DT_node_data_1] AS 
(SELECT [Values].node_id AS node_id, [Values].feature AS feature, [Values].threshold AS threshold, [Values].count AS count, [Values].depth AS depth, [Values].parent_id AS parent_id, [Values].[Estimator] AS [Estimator] 
FROM (SELECT 3 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 2 AS count, 3 AS depth, 2 AS parent_id, 2.096008535366903 AS [Estimator] UNION ALL SELECT 4 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 44 AS count, 3 AS depth, 2 AS parent_id, -1.4234854473404777 AS [Estimator] UNION ALL SELECT 6 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 1 AS count, 3 AS depth, 5 AS parent_id, 1.895437496504261 AS [Estimator] UNION ALL SELECT 7 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 1 AS count, 3 AS depth, 5 AS parent_id, 2.2994181831603377 AS [Estimator] UNION ALL SELECT 10 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 30 AS count, 3 AS depth, 9 AS parent_id, 1.8954374965042624 AS [Estimator] UNION ALL SELECT 11 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 1 AS count, 3 AS depth, 9 AS parent_id, -1.7478449197552628 AS [Estimator] UNION ALL SELECT 12 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 1 AS count, 2 AS depth, 8 AS parent_id, -1.7478449197552628 AS [Estimator]) AS [Values]), 
[DT_Output_1] AS 
...
[DT_node_data_2] AS 
(SELECT [Values].node_id AS node_id, [Values].feature AS feature, [Values].threshold AS threshold, [Values].count AS count, [Values].depth AS depth, [Values].parent_id AS parent_id, [Values].[Estimator] AS [Estimator] 
FROM (SELECT 2 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 2 AS count, 2 AS depth, 1 AS parent_id, 2.0324558055611313 AS [Estimator] UNION ALL SELECT 4 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 44 AS count, 3 AS depth, 3 AS parent_id, -1.3276995551562458 AS [Estimator] UNION ALL SELECT 5 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 2 AS count, 3 AS depth, 3 AS parent_id, 2.0324201305914054 AS [Estimator] UNION ALL SELECT 7 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 1 AS count, 2 AS depth, 6 AS parent_id, -1.6279189753326482 AS [Estimator] UNION ALL SELECT 9 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 1 AS count, 3 AS depth, 8 AS parent_id, -1.6279189753326482 AS [Estimator] UNION ALL SELECT 10 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 30 AS count, 3 AS depth, 8 AS parent_id, 1.7408281426133267 AS [Estimator]) AS [Values]), 
[DT_Output_2] AS 
...
[DT_node_data_3] AS 
(SELECT [Values].node_id AS node_id, [Values].feature AS feature, [Values].threshold AS threshold, [Values].count AS count, [Values].depth AS depth, [Values].parent_id AS parent_id, [Values].[Estimator] AS [Estimator] 
FROM (SELECT 3 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 1 AS count, 3 AS depth, 2 AS parent_id, 2.2033215782363085 AS [Estimator] UNION ALL SELECT 4 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 1 AS count, 3 AS depth, 2 AS parent_id, 1.8292167028822635 AS [Estimator] UNION ALL SELECT 6 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 44 AS count, 3 AS depth, 5 AS parent_id, -1.2388948754014388 AS [Estimator] UNION ALL SELECT 7 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 2 AS count, 3 AS depth, 5 AS parent_id, 1.8443051333640834 AS [Estimator] UNION ALL SELECT 9 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 1 AS count, 2 AS depth, 8 AS parent_id, -1.5335854573777359 AS [Estimator] UNION ALL SELECT 11 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 30 AS count, 3 AS depth, 10 AS parent_id, 1.6224640389018972 AS [Estimator] UNION ALL SELECT 12 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 1 AS count, 3 AS depth, 10 AS parent_id, -1.5335854573777359 AS [Estimator]) AS [Values]), 
[DT_Output_3] AS 
...
[DT_node_data_4] AS 
(SELECT [Values].node_id AS node_id, [Values].feature AS feature, [Values].threshold AS threshold, [Values].count AS count, [Values].depth AS depth, [Values].parent_id AS parent_id, [Values].[Estimator] AS [Estimator] 
FROM (SELECT 3 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 36 AS count, 3 AS depth, 2 AS parent_id, -1.4201836338413583 AS [Estimator] UNION ALL SELECT 4 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS count, 3 AS depth, 2 AS parent_id, 0.8818891509469176 AS [Estimator] UNION ALL SELECT 6 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 4 AS count, 3 AS depth, 5 AS parent_id, 2.0543740519216325 AS [Estimator] UNION ALL SELECT 7 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS count, 3 AS depth, 5 AS parent_id, -1.5115435903792729 AS [Estimator] UNION ALL SELECT 10 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 1 AS count, 3 AS depth, 9 AS parent_id, -1.4577213966216014 AS [Estimator] UNION ALL SELECT 11 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 30 AS count, 3 AS depth, 9 AS parent_id, 1.5448043165070784 AS [Estimator] UNION ALL SELECT 13 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 2 AS count, 3 AS depth, 12 AS parent_id, -1.4876585385597692 AS [Estimator] UNION ALL SELECT 14 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 1 AS count, 3 AS depth, 12 AS parent_id, 1.529238644498216 AS [Estimator]) AS [Values]), 
[DT_Output_4] AS 
...
FROM [DT_Output_4])
 INSERT INTO ##TMP_20180329232556_8R6A8O_GB_Sum_B0 ([KEY], [Score_0], [Score_1]) SELECT [GB_Sum_B0].[KEY], [GB_Sum_B0].[Score_0], [GB_Sum_B0].[Score_1] 
...
-- Code For temporary table ##TMP_20180329232556_DX8Z0U_GB_Sum_B1 part 1/2. Create 


CREATE TABLE ##TMP_20180329232556_DX8Z0U_GB_Sum_B1 (
	[KEY] BIGINT NULL, 
	[Score_0] FLOAT(53) NULL, 
	[Score_1] FLOAT(53) NULL
)
...
-- Code For temporary table ##TMP_20180329232556_DX8Z0U_GB_Sum_B1 part 2/2. Populate
...
[DT_node_data_5] AS 
(SELECT [Values].node_id AS node_id, [Values].feature AS feature, [Values].threshold AS threshold, [Values].count AS count, [Values].depth AS depth, [Values].parent_id AS parent_id, [Values].[Estimator] AS [Estimator] 
FROM (SELECT 3 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 4 AS count, 3 AS depth, 2 AS parent_id, 1.958202526870995 AS [Estimator] UNION ALL SELECT 4 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS count, 3 AS depth, 2 AS parent_id, -1.448008549051362 AS [Estimator] UNION ALL SELECT 6 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 36 AS count, 3 AS depth, 5 AS parent_id, -1.3444944167722634 AS [Estimator] UNION ALL SELECT 7 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS count, 3 AS depth, 5 AS parent_id, 0.7265051857481474 AS [Estimator] UNION ALL SELECT 10 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 1 AS count, 3 AS depth, 9 AS parent_id, -1.395633609741032 AS [Estimator] UNION ALL SELECT 11 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 30 AS count, 3 AS depth, 9 AS parent_id, 1.4673881774513675 AS [Estimator] UNION ALL SELECT 13 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 1 AS count, 3 AS depth, 12 AS parent_id, 1.4541899894634762 AS [Estimator] UNION ALL SELECT 14 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 2 AS count, 3 AS depth, 12 AS parent_id, -1.4203469592033384 AS [Estimator]) AS [Values]), 
[DT_Output_5] AS 
...
[DT_node_data_6] AS 
(SELECT [Values].node_id AS node_id, [Values].feature AS feature, [Values].threshold AS threshold, [Values].count AS count, [Values].depth AS depth, [Values].parent_id AS parent_id, [Values].[Estimator] AS [Estimator] 
FROM (SELECT 3 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 32 AS count, 3 AS depth, 2 AS parent_id, -1.3946185074449031 AS [Estimator] UNION ALL SELECT 4 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS count, 3 AS depth, 2 AS parent_id, 0.525957561992705 AS [Estimator] UNION ALL SELECT 6 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 4 AS count, 3 AS depth, 5 AS parent_id, 1.937257098415046 AS [Estimator] UNION ALL SELECT 7 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 7 AS count, 3 AS depth, 5 AS parent_id, -0.8866233396726353 AS [Estimator] UNION ALL SELECT 10 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 1 AS count, 3 AS depth, 9 AS parent_id, -1.344097550451214 AS [Estimator] UNION ALL SELECT 11 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 30 AS count, 3 AS depth, 9 AS parent_id, 1.4040651025086777 AS [Estimator] UNION ALL SELECT 13 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 2 AS count, 3 AS depth, 12 AS parent_id, -1.3647650410708272 AS [Estimator] UNION ALL SELECT 14 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 1 AS count, 3 AS depth, 12 AS parent_id, 1.3927198824988734 AS [Estimator]) AS [Values]), 
[DT_Output_6] AS 
...
[DT_node_data_7] AS 
(SELECT [Values].node_id AS node_id, [Values].feature AS feature, [Values].threshold AS threshold, [Values].count AS count, [Values].depth AS depth, [Values].parent_id AS parent_id, [Values].[Estimator] AS [Estimator] 
FROM (SELECT 3 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS count, 3 AS depth, 2 AS parent_id, -1.337157307504241 AS [Estimator] UNION ALL SELECT 4 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 4 AS count, 3 AS depth, 2 AS parent_id, 1.720271726539447 AS [Estimator] UNION ALL SELECT 6 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 38 AS count, 3 AS depth, 5 AS parent_id, -1.170701604442776 AS [Estimator] UNION ALL SELECT 7 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 1 AS count, 3 AS depth, 5 AS parent_id, 1.8229070531835285 AS [Estimator] UNION ALL SELECT 10 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 1 AS count, 3 AS depth, 9 AS parent_id, -1.300821010694913 AS [Estimator] UNION ALL SELECT 11 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 30 AS count, 3 AS depth, 9 AS parent_id, 1.3515189609079086 AS [Estimator] UNION ALL SELECT 13 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 2 AS count, 3 AS depth, 12 AS parent_id, -1.3182902998610377 AS [Estimator] UNION ALL SELECT 14 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 1 AS count, 3 AS depth, 12 AS parent_id, 1.3416629081480635 AS [Estimator]) AS [Values]), 
[DT_Output_7] AS 
...
[DT_node_data_8] AS 
(SELECT [Values].node_id AS node_id, [Values].feature AS feature, [Values].threshold AS threshold, [Values].count AS count, [Values].depth AS depth, [Values].parent_id AS parent_id, [Values].[Estimator] AS [Estimator] 
FROM (SELECT 3 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 1 AS count, 3 AS depth, 2 AS parent_id, 1.6108718821416377 AS [Estimator] UNION ALL SELECT 4 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 1 AS count, 3 AS depth, 2 AS parent_id, 1.6688510571596784 AS [Estimator] UNION ALL SELECT 6 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 41 AS count, 3 AS depth, 5 AS parent_id, -1.068080084295244 AS [Estimator] UNION ALL SELECT 7 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS count, 3 AS depth, 5 AS parent_id, 0.9475315093373128 AS [Estimator] UNION ALL SELECT 10 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 30 AS count, 3 AS depth, 9 AS parent_id, 1.307398426483107 AS [Estimator] UNION ALL SELECT 11 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 1 AS count, 3 AS depth, 9 AS parent_id, -1.264127868945373 AS [Estimator] UNION ALL SELECT 13 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 1 AS count, 3 AS depth, 12 AS parent_id, 1.298765298853743 AS [Estimator] UNION ALL SELECT 14 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 2 AS count, 3 AS depth, 12 AS parent_id, -1.279025518068119 AS [Estimator]) AS [Values]), 
[DT_Output_8] AS 
...
[DT_node_data_9] AS 
(SELECT [Values].node_id AS node_id, [Values].feature AS feature, [Values].threshold AS threshold, [Values].count AS count, [Values].depth AS depth, [Values].parent_id AS parent_id, [Values].[Estimator] AS [Estimator] 
FROM (SELECT 3 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 2 AS count, 3 AS depth, 2 AS parent_id, 1.4900163352519837 AS [Estimator] UNION ALL SELECT 4 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 42 AS count, 3 AS depth, 2 AS parent_id, -0.9948753872812511 AS [Estimator] UNION ALL SELECT 6 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 1 AS count, 3 AS depth, 5 AS parent_id, 1.632261202074544 AS [Estimator] UNION ALL SELECT 7 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 1 AS count, 3 AS depth, 5 AS parent_id, 1.519985051185009 AS [Estimator] UNION ALL SELECT 10 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 1 AS count, 3 AS depth, 9 AS parent_id, -1.2327629493831462 AS [Estimator] UNION ALL SELECT 11 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 30 AS count, 3 AS depth, 9 AS parent_id, 1.2699877686233394 AS [Estimator] UNION ALL SELECT 13 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 2 AS count, 3 AS depth, 12 AS parent_id, -1.245562745293807 AS [Estimator] UNION ALL SELECT 14 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 1 AS count, 3 AS depth, 12 AS parent_id, 1.262376837539426 AS [Estimator]) AS [Values]), 
[DT_Output_9] AS 
...
FROM [DT_Output_9])
 INSERT INTO ##TMP_20180329232556_DX8Z0U_GB_Sum_B1 ([KEY], [Score_0], [Score_1]) SELECT [GB_Sum_B1].[KEY], [GB_Sum_B1].[Score_0], [GB_Sum_B1].[Score_1] 
...
-- Code For temporary table ##TMP_20180329232556_M1F448_GB_Sum_B2 part 1/2. Create 


CREATE TABLE ##TMP_20180329232556_M1F448_GB_Sum_B2 (
	[KEY] BIGINT NULL, 
	[Score_0] FLOAT(53) NULL, 
	[Score_1] FLOAT(53) NULL
)
...
-- Code For temporary table ##TMP_20180329232556_M1F448_GB_Sum_B2 part 2/2. Populate
...
[DT_node_data_10] AS 
(SELECT [Values].node_id AS node_id, [Values].feature AS feature, [Values].threshold AS threshold, [Values].count AS count, [Values].depth AS depth, [Values].parent_id AS parent_id, [Values].[Estimator] AS [Estimator] 
FROM (SELECT 3 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 1 AS count, 3 AS depth, 2 AS parent_id, 1.446661732834358 AS [Estimator] UNION ALL SELECT 4 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 33 AS count, 3 AS depth, 2 AS parent_id, -1.2499360133065067 AS [Estimator] UNION ALL SELECT 6 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 4 AS count, 3 AS depth, 5 AS parent_id, 1.6219351936501099 AS [Estimator] UNION ALL SELECT 7 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS count, 3 AS depth, 5 AS parent_id, -1.2895245850004842 AS [Estimator] UNION ALL SELECT 10 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 33 AS count, 3 AS depth, 9 AS parent_id, 1.1975528332766405 AS [Estimator] UNION ALL SELECT 11 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 4 AS count, 3 AS depth, 9 AS parent_id, -0.6151746918646214 AS [Estimator] UNION ALL SELECT 13 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 1 AS count, 3 AS depth, 12 AS parent_id, -1.317315323569 AS [Estimator] UNION ALL SELECT 14 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 1 AS count, 3 AS depth, 12 AS parent_id, -1.2057669579063237 AS [Estimator]) AS [Values]), 
[DT_Output_10] AS 
...
[DT_node_data_11] AS 
(SELECT [Values].node_id AS node_id, [Values].feature AS feature, [Values].threshold AS threshold, [Values].count AS count, [Values].depth AS depth, [Values].parent_id AS parent_id, [Values].[Estimator] AS [Estimator] 
FROM (SELECT 3 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 33 AS count, 3 AS depth, 2 AS parent_id, -1.220589039043774 AS [Estimator] UNION ALL SELECT 4 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 1 AS count, 3 AS depth, 2 AS parent_id, 1.3865013593274123 AS [Estimator] UNION ALL SELECT 6 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 4 AS count, 3 AS depth, 5 AS parent_id, 1.5327998769743132 AS [Estimator] UNION ALL SELECT 7 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS count, 3 AS depth, 5 AS parent_id, -1.2548231207419789 AS [Estimator] UNION ALL SELECT 10 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 1 AS count, 3 AS depth, 9 AS parent_id, -1.2256580639543597 AS [Estimator] UNION ALL SELECT 11 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 1 AS count, 3 AS depth, 9 AS parent_id, -1.2318331300228573 AS [Estimator] UNION ALL SELECT 13 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 29 AS count, 3 AS depth, 12 AS parent_id, 1.2459403972282284 AS [Estimator] UNION ALL SELECT 14 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 8 AS count, 3 AS depth, 12 AS parent_id, -0.05217530635323901 AS [Estimator]) AS [Values]), 
[DT_Output_11] AS 
...
[DT_node_data_12] AS 
(SELECT [Values].node_id AS node_id, [Values].feature AS feature, [Values].threshold AS threshold, [Values].count AS count, [Values].depth AS depth, [Values].parent_id AS parent_id, [Values].[Estimator] AS [Estimator] 
FROM (SELECT 3 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 1 AS count, 3 AS depth, 2 AS parent_id, 1.336462011301788 AS [Estimator] UNION ALL SELECT 4 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 33 AS count, 3 AS depth, 2 AS parent_id, -1.195258567601929 AS [Estimator] UNION ALL SELECT 6 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 4 AS count, 3 AS depth, 5 AS parent_id, 1.460157504031824 AS [Estimator] UNION ALL SELECT 7 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS count, 3 AS depth, 5 AS parent_id, -1.225033227714185 AS [Estimator] UNION ALL SELECT 10 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 33 AS count, 3 AS depth, 9 AS parent_id, 1.1286854488179339 AS [Estimator] UNION ALL SELECT 11 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 4 AS count, 3 AS depth, 9 AS parent_id, -0.5693352361704495 AS [Estimator] UNION ALL SELECT 13 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 1 AS count, 3 AS depth, 12 AS parent_id, -1.2767036085425458 AS [Estimator] UNION ALL SELECT 14 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 1 AS count, 3 AS depth, 12 AS parent_id, -1.1814445377175218 AS [Estimator]) AS [Values]), 
[DT_Output_12] AS 
...
[DT_node_data_13] AS 
(SELECT [Values].node_id AS node_id, [Values].feature AS feature, [Values].threshold AS threshold, [Values].count AS count, [Values].depth AS depth, [Values].parent_id AS parent_id, [Values].[Estimator] AS [Estimator] 
FROM (SELECT 3 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 39 AS count, 3 AS depth, 2 AS parent_id, -1.0027112222309909 AS [Estimator] UNION ALL SELECT 4 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 7 AS count, 3 AS depth, 2 AS parent_id, 0.5020490769066449 AS [Estimator] UNION ALL SELECT 6 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 1 AS count, 3 AS depth, 5 AS parent_id, 1.4820602336151274 AS [Estimator] UNION ALL SELECT 7 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 1 AS count, 3 AS depth, 5 AS parent_id, 1.289621326139366 AS [Estimator] UNION ALL SELECT 10 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 30 AS count, 3 AS depth, 9 AS parent_id, 1.1667450118563434 AS [Estimator] UNION ALL SELECT 11 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 1 AS count, 3 AS depth, 9 AS parent_id, -1.1612257530876875 AS [Estimator] UNION ALL SELECT 12 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 1 AS count, 2 AS depth, 8 AS parent_id, -1.1796530087132728 AS [Estimator]) AS [Values]), 
[DT_Output_13] AS 
...
[DT_node_data_14] AS 
(SELECT [Values].node_id AS node_id, [Values].feature AS feature, [Values].threshold AS threshold, [Values].count AS count, [Values].depth AS depth, [Values].parent_id AS parent_id, [Values].[Estimator] AS [Estimator] 
FROM (SELECT 3 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 1 AS count, 3 AS depth, 2 AS parent_id, 1.3748289048641364 AS [Estimator] UNION ALL SELECT 4 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 1 AS count, 3 AS depth, 2 AS parent_id, 1.3254178894915882 AS [Estimator] UNION ALL SELECT 6 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 1 AS count, 3 AS depth, 5 AS parent_id, 1.5416984936659368 AS [Estimator] UNION ALL SELECT 7 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 38 AS count, 3 AS depth, 5 AS parent_id, -0.9882844135467986 AS [Estimator] UNION ALL SELECT 10 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 2 AS count, 3 AS depth, 9 AS parent_id, -1.1728890055441057 AS [Estimator] UNION ALL SELECT 11 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 35 AS count, 3 AS depth, 9 AS parent_id, 1.017348509871444 AS [Estimator] UNION ALL SELECT 13 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 1 AS count, 3 AS depth, 12 AS parent_id, -1.1435499417251889 AS [Estimator] UNION ALL SELECT 14 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 1 AS count, 3 AS depth, 12 AS parent_id, -1.2203033466414503 AS [Estimator]) AS [Values]), 
[DT_Output_14] AS 
...
FROM [DT_Output_14])
 INSERT INTO ##TMP_20180329232556_M1F448_GB_Sum_B2 ([KEY], [Score_0], [Score_1]) SELECT [GB_Sum_B2].[KEY], [GB_Sum_B2].[Score_0], [GB_Sum_B2].[Score_1] 
...
-- Code For temporary table ##TMP_20180329232556_P5VEYJ_GB_Sum_B3 part 1/2. Create 


CREATE TABLE ##TMP_20180329232556_P5VEYJ_GB_Sum_B3 (
	[KEY] BIGINT NULL, 
	[Score_0] FLOAT(53) NULL, 
	[Score_1] FLOAT(53) NULL
)
...
-- Code For temporary table ##TMP_20180329232556_P5VEYJ_GB_Sum_B3 part 2/2. Populate
...
[DT_node_data_15] AS 
(SELECT [Values].node_id AS node_id, [Values].feature AS feature, [Values].threshold AS threshold, [Values].count AS count, [Values].depth AS depth, [Values].parent_id AS parent_id, [Values].[Estimator] AS [Estimator] 
FROM (SELECT 3 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 5 AS count, 3 AS depth, 2 AS parent_id, -1.1408123626661393 AS [Estimator] UNION ALL SELECT 4 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 1 AS count, 3 AS depth, 2 AS parent_id, -1.1949952326507387 AS [Estimator] UNION ALL SELECT 6 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 43 AS count, 3 AS depth, 5 AS parent_id, 0.8502158462658079 AS [Estimator] UNION ALL SELECT 7 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 7 AS count, 3 AS depth, 5 AS parent_id, -0.5955307623945251 AS [Estimator] UNION ALL SELECT 9 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 1 AS count, 2 AS depth, 8 AS parent_id, -1.2312159733472068 AS [Estimator] UNION ALL SELECT 11 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 2 AS count, 3 AS depth, 10 AS parent_id, -1.1721830246591496 AS [Estimator] UNION ALL SELECT 12 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 21 AS count, 3 AS depth, 10 AS parent_id, -1.1415942686578024 AS [Estimator]) AS [Values]), 
[DT_Output_15] AS 
...
FROM [DT_Output_15])
 INSERT INTO ##TMP_20180329232556_P5VEYJ_GB_Sum_B3 ([KEY], [Score_0], [Score_1]) SELECT [GB_Sum_B3].[KEY], [GB_Sum_B3].[Score_0], [GB_Sum_B3].[Score_1] 
...
-- Code For temporary table ##TMP_20180329232556_U5XZSA_GB_Sum_Union part 1/2. Create 


CREATE TABLE ##TMP_20180329232556_U5XZSA_GB_Sum_Union (
	[KEY] BIGINT NULL, 
	[Score_0] FLOAT(53) NULL, 
	[Score_1] FLOAT(53) NULL
)
...
-- Code For temporary table ##TMP_20180329232556_U5XZSA_GB_Sum_Union part 2/2. Populate

INSERT INTO ##TMP_20180329232556_U5XZSA_GB_Sum_Union ([KEY], [Score_0], [Score_1]) SELECT [GB_Sum_Union].[KEY], [GB_Sum_Union].[Score_0], [GB_Sum_Union].[Score_1] 
...
FROM ##TMP_20180329232556_8R6A8O_GB_Sum_B0 AS [GB_Sum_B0] UNION ALL SELECT [GB_Sum_B1].[KEY] AS [KEY], [GB_Sum_B1].[Score_0] AS [Score_0], [GB_Sum_B1].[Score_1] AS [Score_1] 
FROM ##TMP_20180329232556_DX8Z0U_GB_Sum_B1 AS [GB_Sum_B1] UNION ALL SELECT [GB_Sum_B2].[KEY] AS [KEY], [GB_Sum_B2].[Score_0] AS [Score_0], [GB_Sum_B2].[Score_1] AS [Score_1] 
FROM ##TMP_20180329232556_M1F448_GB_Sum_B2 AS [GB_Sum_B2] UNION ALL SELECT [GB_Sum_B3].[KEY] AS [KEY], [GB_Sum_B3].[Score_0] AS [Score_0], [GB_Sum_B3].[Score_1] AS [Score_1] 
FROM ##TMP_20180329232556_P5VEYJ_GB_Sum_B3 AS [GB_Sum_B3]) AS [GB_Sum_EnsembleUnion]) AS [GB_Sum_Union]
...
FROM ##TMP_20180329232556_U5XZSA_GB_Sum_Union AS [GB_Sum_Union] GROUP BY [GB_Sum_Union].[KEY]) AS [T]), 
orig_cte AS 
(SELECT [GB_Sum_sum].[KEY] AS [KEY], -(-0.10008345855698253 + 0.1 * [GB_Sum_sum].[Score_1]) AS [Score_0], -0.10008345855698253 + 0.1 * [GB_Sum_sum].[Score_1] AS [Score_1], 1.0 - 1.0 / (1.0 + exp(CASE WHEN (CASE WHEN (-100.0 <= -(-0.10008345855698253 + 0.1 * [GB_Sum_sum].[Score_1])) THEN -(-0.10008345855698253 + 0.1 * [GB_Sum_sum].[Score_1]) ELSE -100.0 END <= 100.0) THEN CASE WHEN (-100.0 <= -(-0.10008345855698253 + 0.1 * [GB_Sum_sum].[Score_1])) THEN -(-0.10008345855698253 + 0.1 * [GB_Sum_sum].[Score_1]) ELSE -100.0 END ELSE 100.0 END)) AS [Proba_0], 1.0 / (1.0 + exp(CASE WHEN (CASE WHEN (-100.0 <= -(-0.10008345855698253 + 0.1 * [GB_Sum_sum].[Score_1])) THEN -(-0.10008345855698253 + 0.1 * [GB_Sum_sum].[Score_1]) ELSE -100.0 END <= 100.0) THEN CASE WHEN (-100.0 <= -(-0.10008345855698253 + 0.1 * [GB_Sum_sum].[Score_1])) THEN -(-0.10008345855698253 + 0.1 * [GB_Sum_sum].[Score_1]) ELSE -100.0 END ELSE 100.0 END)) AS [Proba_1], CAST(NULL AS FLOAT(53)) AS [LogProba_0], CAST(NULL AS FLOAT(53)) AS [LogProba_1], CAST(NULL AS BIGINT) AS [Decision], CAST(NULL AS FLOAT(53)) AS [DecisionProba] 
FROM [GB_Sum_sum]), 
