...
-- Code For temporary table TMP_20180329232351_34MYZF_ADA_Median_B0 part 1/2. Create 


CREATE TEMPORARY TABLE "TMP_20180329232351_34MYZF_ADA_Median_B0" (
	"KEY" BIGINT, 
	"Estimator" FLOAT, 
	"Weight" FLOAT, 
	est_index BIGINT
...
-- Code For temporary table TMP_20180329232351_34MYZF_ADA_Median_B0 part 2/2. Populate
...
FROM "DT_Output_9")
 INSERT INTO "TMP_20180329232351_34MYZF_ADA_Median_B0" ("KEY", "Estimator", "Weight", est_index) SELECT "ADA_Median_B0"."KEY", "ADA_Median_B0"."Estimator", "ADA_Median_B0"."Weight", "ADA_Median_B0".est_index 
...
-- Code For temporary table TMP_20180329232351_43JNOV_ADA_Median_B1 part 1/2. Create 


CREATE TEMPORARY TABLE "TMP_20180329232351_43JNOV_ADA_Median_B1" (
	"KEY" BIGINT, 
	"Estimator" FLOAT, 
	"Weight" FLOAT, 
	est_index BIGINT
...
-- Code For temporary table TMP_20180329232351_43JNOV_ADA_Median_B1 part 2/2. Populate
...
FROM "DT_Output_15")
 INSERT INTO "TMP_20180329232351_43JNOV_ADA_Median_B1" ("KEY", "Estimator", "Weight", est_index) SELECT "ADA_Median_B1"."KEY", "ADA_Median_B1"."Estimator", "ADA_Median_B1"."Weight", "ADA_Median_B1".est_index 
...
-- Code For temporary table TMP_20180329232351_T84VOD_ADA_Median_Union part 1/2. Create 


CREATE TEMPORARY TABLE "TMP_20180329232351_T84VOD_ADA_Median_Union" (
	"KEY" BIGINT, 
	"Estimator" FLOAT, 
	"Weight" FLOAT, 
	est_index BIGINT
...
-- Code For temporary table TMP_20180329232351_T84VOD_ADA_Median_Union part 2/2. Populate

INSERT INTO "TMP_20180329232351_T84VOD_ADA_Median_Union" ("KEY", "Estimator", "Weight", est_index) SELECT "ADA_Median_Union"."KEY", "ADA_Median_Union"."Estimator", "ADA_Median_Union"."Weight", "ADA_Median_Union".est_index 
...
FROM "TMP_20180329232351_34MYZF_ADA_Median_B0" AS "ADA_Median_B0" UNION ALL SELECT "ADA_Median_B1"."KEY" AS "KEY", "ADA_Median_B1"."Estimator" AS "Estimator", "ADA_Median_B1"."Weight" AS "Weight", "ADA_Median_B1".est_index AS est_index 
FROM "TMP_20180329232351_43JNOV_ADA_Median_B1" AS "ADA_Median_B1") AS "ADA_Median_EnsembleUnion") AS "ADA_Median_Union"
