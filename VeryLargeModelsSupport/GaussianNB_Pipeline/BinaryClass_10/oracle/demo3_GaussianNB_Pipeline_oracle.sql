...
-- Code For temporary table 32458_D1L2P0_ADS_IMP_1_OUT part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE "32458_D1L2P0_ADS_IMP_1_OUT" (
	"KEY" NUMBER(19), 
...
-- Code For temporary table 32458_D1L2P0_ADS_IMP_1_OUT part 2/2. Populate

INSERT INTO "32458_D1L2P0_ADS_IMP_1_OUT" ("KEY", impter_2, impter_3, impter_4, impter_5, impter_6, impter_7, impter_8, impter_9, impter_10, impter_11) SELECT "U"."KEY", "U".impter_2, "U".impter_3, "U".impter_4, "U".impter_5, "U".impter_6, "U".impter_7, "U".impter_8, "U".impter_9, "U".impter_10, "U".impter_11 
...
-- Code For temporary table 32458_DLM6UQ_ADS_SCA_2_OUT part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE "32458_DLM6UQ_ADS_SCA_2_OUT" (
	"KEY" NUMBER(19), 
 ...
 ON COMMIT PRESERVE ROWS
-- Code For temporary table 32458_DLM6UQ_ADS_SCA_2_OUT part 2/2. Populate

INSERT INTO "32458_DLM6UQ_ADS_SCA_2_OUT" ("KEY", scaler_2, scaler_3, scaler_4, scaler_5, scaler_6, scaler_7, scaler_8, scaler_9, scaler_10, scaler_11) SELECT "U"."KEY", "U".scaler_2, "U".scaler_3, "U".scaler_4, "U".scaler_5, "U".scaler_6, "U".scaler_7, "U".scaler_8, "U".scaler_9, "U".scaler_10, "U".scaler_11 
...
FROM "32458_D1L2P0_ADS_IMP_1_OUT" "ADS_imp_1_OUT") "ADS_sca_2_OUT") "U"

-- Model deployment code

WITH "RawScores" AS 
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", CAST(NULL AS BINARY_DOUBLE) AS "LogProba_0", CAST(NULL AS BINARY_DOUBLE) AS "Proba_0", -0.6931471805599453 + (-0.5 * 0.7545429935238454 - (0.5 * (CAST("ADS_sca_2_OUT".scaler_2 AS BINARY_DOUBLE) - 0.6608885522985145) * (CAST("ADS_sca_2_OUT".scaler_2 AS BINARY_DOUBLE) - 0.6608885522985145)) / 0.33846517479399624) + (-0.5 * 1.755985503747587 - (0.5 * (CAST("ADS_sca_2_OUT".scaler_3 AS BINARY_DOUBLE) - 0.05011958986810387) * (CAST("ADS_sca_2_OUT".scaler_3 AS BINARY_DOUBLE) - 0.05011958986810387)) / 0.9213718643920022) + (-0.5 * 1.5895557833789096 - (0.5 * (CAST("ADS_sca_2_OUT".scaler_4 AS BINARY_DOUBLE) - 0.010237135493869304) * (CAST("ADS_sca_2_OUT".scaler_4 AS BINARY_DOUBLE) - 0.010237135493869304)) / 0.7801092671417778) + (-0.5 * 1.9720068756709808 - (0.5 * (CAST("ADS_sca_2_OUT".scaler_5 AS BINARY_DOUBLE) - -0.1134260581927905) * (CAST("ADS_sca_2_OUT".scaler_5 AS BINARY_DOUBLE) - -0.1134260581927905)) / 1.1435412522560795) + (-0.5 * 1.9028415823903153 - (0.5 * (CAST("ADS_sca_2_OUT".scaler_6 AS BINARY_DOUBLE) - 0.091931902073065) * (CAST("ADS_sca_2_OUT".scaler_6 AS BINARY_DOUBLE) - 0.091931902073065)) / 1.0671211579648936) + (-0.5 * 1.7474523867108946 - (0.5 * (CAST("ADS_sca_2_OUT".scaler_7 AS BINARY_DOUBLE) - 0.026957993139275754) * (CAST("ADS_sca_2_OUT".scaler_7 AS BINARY_DOUBLE) - 0.026957993139275754)) / 0.9135431396544423) + (-0.5 * 1.7568016284099544 - (0.5 * (CAST("ADS_sca_2_OUT".scaler_8 AS BINARY_DOUBLE) - 0.19931034565274267) * (CAST("ADS_sca_2_OUT".scaler_8 AS BINARY_DOUBLE) - 0.19931034565274267)) / 0.9221241256214605) + (-0.5 * 0.46653573969166034 - (0.5 * (CAST("ADS_sca_2_OUT".scaler_9 AS BINARY_DOUBLE) - 0.6831306672271085) * (CAST("ADS_sca_2_OUT".scaler_9 AS BINARY_DOUBLE) - 0.6831306672271085)) / 0.2537663475858361) + (-0.5 * 1.6698439164311882 - (0.5 * (CAST("ADS_sca_2_OUT".scaler_10 AS BINARY_DOUBLE) - -0.05290181072678812) * (CAST("ADS_sca_2_OUT".scaler_10 AS BINARY_DOUBLE) - -0.05290181072678812)) / 0.8453258116879874) + (-0.5 * 0.259643314471311 - (0.5 * (CAST("ADS_sca_2_OUT".scaler_11 AS BINARY_DOUBLE) - -0.6905707153132041) * (CAST("ADS_sca_2_OUT".scaler_11 AS BINARY_DOUBLE) - -0.6905707153132041)) / 0.20633922279541594) AS "Score_0", CAST(NULL AS BINARY_DOUBLE) AS "LogProba_1", CAST(NULL AS BINARY_DOUBLE) AS "Proba_1", -0.6931471805599453 + (-0.5 * 1.599603976254543 - (0.5 * (CAST("ADS_sca_2_OUT".scaler_2 AS BINARY_DOUBLE) - -0.6608885522985144) * (CAST("ADS_sca_2_OUT".scaler_2 AS BINARY_DOUBLE) - -0.6608885522985144)) / 0.7879874700875505) + (-0.5 * 1.9088984573543164 - (0.5 * (CAST("ADS_sca_2_OUT".scaler_3 AS BINARY_DOUBLE) - -0.05011958986810381) * (CAST("ADS_sca_2_OUT".scaler_3 AS BINARY_DOUBLE) - -0.05011958986810381)) / 1.0736041910309042) + (-0.5 * 2.0364665278554943 - (0.5 * (CAST("ADS_sca_2_OUT".scaler_4 AS BINARY_DOUBLE) - -0.010237135493869402) * (CAST("ADS_sca_2_OUT".scaler_4 AS BINARY_DOUBLE) - -0.010237135493869402)) / 1.2196811369719827) + (-0.5 * 1.6524239815631545 - (0.5 * (CAST("ADS_sca_2_OUT".scaler_5 AS BINARY_DOUBLE) - 0.11342605819279053) * (CAST("ADS_sca_2_OUT".scaler_5 AS BINARY_DOUBLE) - 0.11342605819279053)) / 0.8307278083896118) + (-0.5 * 1.7501118360318897 - (0.5 * (CAST("ADS_sca_2_OUT".scaler_6 AS BINARY_DOUBLE) - -0.09193190207306502) * (CAST("ADS_sca_2_OUT".scaler_6 AS BINARY_DOUBLE) - -0.09193190207306502)) / 0.9159758947975633) + (-0.5 * 1.9194601829428275 - (0.5 * (CAST("ADS_sca_2_OUT".scaler_7 AS BINARY_DOUBLE) - -0.02695799313927582) * (CAST("ADS_sca_2_OUT".scaler_7 AS BINARY_DOUBLE) - -0.02695799313927582)) / 1.0850033955573626) + (-0.5 * 1.8363024760023794 - (0.5 * (CAST("ADS_sca_2_OUT".scaler_8 AS BINARY_DOUBLE) - -0.19931034565274264) * (CAST("ADS_sca_2_OUT".scaler_8 AS BINARY_DOUBLE) - -0.19931034565274264)) / 0.9984266486101087) + (-0.5 * 1.6307282119596742 - (0.5 * (CAST("ADS_sca_2_OUT".scaler_9 AS BINARY_DOUBLE) - -0.6831306672271085) * (CAST("ADS_sca_2_OUT".scaler_9 AS BINARY_DOUBLE) - -0.6831306672271085)) / 0.8128986374018546) + (-0.5 * 1.9768360666480904 - (0.5 * (CAST("ADS_sca_2_OUT".scaler_10 AS BINARY_DOUBLE) - 0.05290181072678807) * (CAST("ADS_sca_2_OUT".scaler_10 AS BINARY_DOUBLE) - 0.05290181072678807)) / 1.149076987155667) + (-0.5 * 1.6633867097753936 - (0.5 * (CAST("ADS_sca_2_OUT".scaler_11 AS BINARY_DOUBLE) - 0.6905707153132041) * (CAST("ADS_sca_2_OUT".scaler_11 AS BINARY_DOUBLE) - 0.6905707153132041)) / 0.8398849535082032) AS "Score_1" 
FROM "32458_DLM6UQ_ADS_SCA_2_OUT" "ADS_sca_2_OUT"), 
orig_cte AS 
(SELECT "RawScores"."KEY" AS "KEY", "RawScores"."Score_0" AS "Score_0", "RawScores"."Score_1" AS "Score_1", "RawScores"."Proba_0" AS "Proba_0", "RawScores"."Proba_1" AS "Proba_1", "RawScores"."LogProba_0" AS "LogProba_0", "RawScores"."LogProba_1" AS "LogProba_1", CAST(NULL AS NUMBER(19)) AS "Decision", CAST(NULL AS BINARY_DOUBLE) AS "DecisionProba" 
FROM "RawScores"), 
