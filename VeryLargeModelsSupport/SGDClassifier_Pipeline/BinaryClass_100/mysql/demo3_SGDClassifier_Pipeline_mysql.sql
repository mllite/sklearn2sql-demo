...
-- Code For temporary table TMP_20180329232610_KVIYJ1_ADS_imp_1_OUT part 1/2. Create 


CREATE TEMPORARY TABLE `TMP_20180329232610_KVIYJ1_ADS_imp_1_OUT` (
	`KEY` BIGINT, 
	impter_2 DOUBLE, 
	impter_3 DOUBLE, 
	impter_4 DOUBLE, 
...
-- Code For temporary table TMP_20180329232610_G5WSAC_ADS_sca_2_OUT part 1/2. Create 


CREATE TEMPORARY TABLE `TMP_20180329232610_G5WSAC_ADS_sca_2_OUT` (
	`KEY` BIGINT, 
	scaler_2 DOUBLE, 
	scaler_3 DOUBLE, 
	scaler_4 DOUBLE, 
...
FROM `TMP_20180329232610_KVIYJ1_ADS_imp_1_OUT` AS `ADS_imp_1_OUT`) AS `ADS_sca_2_OUT`) AS `U`

-- Model deployment code

WITH linear_model_cte AS 
(SELECT `ADS_sca_2_OUT`.`KEY` AS `KEY`, 22.727201784740426 * `ADS_sca_2_OUT`.scaler_2 + 2.976265639655033 * `ADS_sca_2_OUT`.scaler_3 + -24.381371123796573 * `ADS_sca_2_OUT`.scaler_4 + 32.689503987413474 * `ADS_sca_2_OUT`.scaler_5 + -114.61157414064829 * `ADS_sca_2_OUT`.scaler_6 + 52.16164177799282 * `ADS_sca_2_OUT`.scaler_7 + -20.644425013463305 * `ADS_sca_2_OUT`.scaler_8 + 27.688697288763453 * `ADS_sca_2_OUT`.scaler_9 + -5.158852628090549 * `ADS_sca_2_OUT`.scaler_10 + 33.67149469389936 * `ADS_sca_2_OUT`.scaler_11 + -14.12826386146191 * `ADS_sca_2_OUT`.scaler_12 + 22.272471133826574 * `ADS_sca_2_OUT`.scaler_13 + 2.0150881987814495 * `ADS_sca_2_OUT`.scaler_14 + 1.7494382512627678 * `ADS_sca_2_OUT`.scaler_15 + -41.662934545114574 * `ADS_sca_2_OUT`.scaler_16 + -33.60576751772066 * `ADS_sca_2_OUT`.scaler_17 + 17.095603567433127 * `ADS_sca_2_OUT`.scaler_18 + 49.7701993889651 * `ADS_sca_2_OUT`.scaler_19 + -43.57984429090173 * `ADS_sca_2_OUT`.scaler_20 + -13.83821742635707 * `ADS_sca_2_OUT`.scaler_21 + 12.936839282081374 * `ADS_sca_2_OUT`.scaler_22 + -4.748725156650165 * `ADS_sca_2_OUT`.scaler_23 + -22.67011665271553 * `ADS_sca_2_OUT`.scaler_24 + 0.3034660166181855 * `ADS_sca_2_OUT`.scaler_25 + -41.66830526236125 * `ADS_sca_2_OUT`.scaler_26 + -37.68392388524636 * `ADS_sca_2_OUT`.scaler_27 + -25.25238265694478 * `ADS_sca_2_OUT`.scaler_28 + 24.73800830357099 * `ADS_sca_2_OUT`.scaler_29 + -22.748186192734995 * `ADS_sca_2_OUT`.scaler_30 + 34.31144892879837 * `ADS_sca_2_OUT`.scaler_31 + 0.5479485777583427 * `ADS_sca_2_OUT`.scaler_32 + -39.59935816732211 * `ADS_sca_2_OUT`.scaler_33 + 3.499077061635976 * `ADS_sca_2_OUT`.scaler_34 + -70.77088990992027 * `ADS_sca_2_OUT`.scaler_35 + -50.76304184904829 * `ADS_sca_2_OUT`.scaler_36 + -19.182190340470033 * `ADS_sca_2_OUT`.scaler_37 + 16.40944512481883 * `ADS_sca_2_OUT`.scaler_38 + 1.1740446369107933 * `ADS_sca_2_OUT`.scaler_39 + 3.6617728649018555 * `ADS_sca_2_OUT`.scaler_40 + -34.15446735092486 * `ADS_sca_2_OUT`.scaler_41 + 29.87965134635985 * `ADS_sca_2_OUT`.scaler_42 + -0.767455129113136 * `ADS_sca_2_OUT`.scaler_43 + -19.05218756480522 * `ADS_sca_2_OUT`.scaler_44 + -19.036078845172888 * `ADS_sca_2_OUT`.scaler_45 + -54.39560619627917 * `ADS_sca_2_OUT`.scaler_46 + -19.790403623114404 * `ADS_sca_2_OUT`.scaler_47 + 48.47289500009025 * `ADS_sca_2_OUT`.scaler_48 + -19.567618306415923 * `ADS_sca_2_OUT`.scaler_49 + -72.74534221115026 * `ADS_sca_2_OUT`.scaler_50 + -14.887952290715713 * `ADS_sca_2_OUT`.scaler_51 + -11.584862152113754 * `ADS_sca_2_OUT`.scaler_52 + 41.80337641718554 * `ADS_sca_2_OUT`.scaler_53 + -25.022757791039037 * `ADS_sca_2_OUT`.scaler_54 + 13.726335164053244 * `ADS_sca_2_OUT`.scaler_55 + 8.957476447475758 * `ADS_sca_2_OUT`.scaler_56 + -17.64450685709239 * `ADS_sca_2_OUT`.scaler_57 + 42.758805300140985 * `ADS_sca_2_OUT`.scaler_58 + 128.08023045937574 * `ADS_sca_2_OUT`.scaler_59 + 34.510272031866236 * `ADS_sca_2_OUT`.scaler_60 + 26.094595981635386 * `ADS_sca_2_OUT`.scaler_61 + -35.10711514305581 * `ADS_sca_2_OUT`.scaler_62 + -27.255480665263637 * `ADS_sca_2_OUT`.scaler_63 + 5.675310024414357 * `ADS_sca_2_OUT`.scaler_64 + 52.49562328737583 * `ADS_sca_2_OUT`.scaler_65 + 35.25177915204525 * `ADS_sca_2_OUT`.scaler_66 + 53.6625985857257 * `ADS_sca_2_OUT`.scaler_67 + -6.828528915404511 * `ADS_sca_2_OUT`.scaler_68 + 125.34907874878405 * `ADS_sca_2_OUT`.scaler_69 + -34.29905779782872 * `ADS_sca_2_OUT`.scaler_70 + 0.7923939632939515 * `ADS_sca_2_OUT`.scaler_71 + 28.41871530828211 * `ADS_sca_2_OUT`.scaler_72 + -36.850034927777536 * `ADS_sca_2_OUT`.scaler_73 + -15.437049475529486 * `ADS_sca_2_OUT`.scaler_74 + -68.19365796865488 * `ADS_sca_2_OUT`.scaler_75 + 1.7355944883946495 * `ADS_sca_2_OUT`.scaler_76 + 5.932061224021527 * `ADS_sca_2_OUT`.scaler_77 + -25.1615522107067 * `ADS_sca_2_OUT`.scaler_78 + -123.16556827997205 * `ADS_sca_2_OUT`.scaler_79 + 35.22396328014223 * `ADS_sca_2_OUT`.scaler_80 + -2.7092669976757002 * `ADS_sca_2_OUT`.scaler_81 + -12.192290511295644 * `ADS_sca_2_OUT`.scaler_82 + 16.461229761906782 * `ADS_sca_2_OUT`.scaler_83 + 18.216815210784777 * `ADS_sca_2_OUT`.scaler_84 + -4.041852606650706 * `ADS_sca_2_OUT`.scaler_85 + 12.50269307839754 * `ADS_sca_2_OUT`.scaler_86 + -33.25748642414413 * `ADS_sca_2_OUT`.scaler_87 + -15.238903102943686 * `ADS_sca_2_OUT`.scaler_88 + -0.8794825773261926 * `ADS_sca_2_OUT`.scaler_89 + 18.107604899314378 * `ADS_sca_2_OUT`.scaler_90 + -8.965382982009226 * `ADS_sca_2_OUT`.scaler_91 + -71.28250943489779 * `ADS_sca_2_OUT`.scaler_92 + -30.322220364858534 * `ADS_sca_2_OUT`.scaler_93 + 0.7763098864809954 * `ADS_sca_2_OUT`.scaler_94 + -18.106849548771507 * `ADS_sca_2_OUT`.scaler_95 + -30.615855713550637 * `ADS_sca_2_OUT`.scaler_96 + -72.21608877809781 * `ADS_sca_2_OUT`.scaler_97 + -23.102230123661244 * `ADS_sca_2_OUT`.scaler_98 + -0.03404283790824294 * `ADS_sca_2_OUT`.scaler_99 + -7.3736505306759215 * `ADS_sca_2_OUT`.scaler_100 + -38.499268647065634 * `ADS_sca_2_OUT`.scaler_101 + 9.41556817350413 AS lincomb 
FROM `TMP_20180329232610_G5WSAC_ADS_sca_2_OUT` AS `ADS_sca_2_OUT`)
