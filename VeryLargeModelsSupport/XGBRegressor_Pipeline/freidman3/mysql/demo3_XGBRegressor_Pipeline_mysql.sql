...
-- Code For temporary table TMP_20180329232439_8884GF_ADS_imp_1_OUT part 1/2. Create 


CREATE TEMPORARY TABLE `TMP_20180329232439_8884GF_ADS_imp_1_OUT` (
	`KEY` BIGINT, 
 ...
 ENGINE=MEMORY
-- Code For temporary table TMP_20180329232439_8884GF_ADS_imp_1_OUT part 2/2. Populate

INSERT INTO `TMP_20180329232439_8884GF_ADS_imp_1_OUT` (`KEY`, imputer_output_2, imputer_output_3, imputer_output_4, imputer_output_5) SELECT `U`.`KEY`, `U`.imputer_output_2, `U`.imputer_output_3, `U`.imputer_output_4, `U`.imputer_output_5 
...
-- Code For temporary table TMP_20180329232439_TOA9L9_ADS_sca_2_OUT part 1/2. Create 


CREATE TEMPORARY TABLE `TMP_20180329232439_TOA9L9_ADS_sca_2_OUT` (
	`KEY` BIGINT, 
 ...
 ENGINE=MEMORY
-- Code For temporary table TMP_20180329232439_TOA9L9_ADS_sca_2_OUT part 2/2. Populate

INSERT INTO `TMP_20180329232439_TOA9L9_ADS_sca_2_OUT` (`KEY`, scaler_output_2, scaler_output_3, scaler_output_4, scaler_output_5) SELECT `U`.`KEY`, `U`.scaler_output_2, `U`.scaler_output_3, `U`.scaler_output_4, `U`.scaler_output_5 
...
FROM `TMP_20180329232439_8884GF_ADS_imp_1_OUT` AS `ADS_imp_1_OUT`) AS `ADS_sca_2_OUT`) AS `U`
-- Code For temporary table TMP_20180329232439_M53YAX_XGB_Sum_B0 part 1/2. Create 


CREATE TEMPORARY TABLE `TMP_20180329232439_M53YAX_XGB_Sum_B0` (
	`KEY` BIGINT, 
	`Estimator` DOUBLE
)

 ENGINE=MEMORY
-- Code For temporary table TMP_20180329232439_M53YAX_XGB_Sum_B0 part 2/2. Populate

INSERT INTO `TMP_20180329232439_M53YAX_XGB_Sum_B0` (`KEY`, `Estimator`) SELECT `U`.`KEY`, `U`.`Estimator` 
...
FROM `TMP_20180329232439_TOA9L9_ADS_sca_2_OUT` AS `ADS_sca_2_OUT`), 
`DT_node_data` AS 
...
-- Code For temporary table TMP_20180329232439_18LBBM_XGB_Sum_B1 part 1/2. Create 


CREATE TEMPORARY TABLE `TMP_20180329232439_18LBBM_XGB_Sum_B1` (
	`KEY` BIGINT, 
	`Estimator` DOUBLE
)

 ENGINE=MEMORY
-- Code For temporary table TMP_20180329232439_18LBBM_XGB_Sum_B1 part 2/2. Populate

INSERT INTO `TMP_20180329232439_18LBBM_XGB_Sum_B1` (`KEY`, `Estimator`) SELECT `U`.`KEY`, `U`.`Estimator` 
...
-- Code For temporary table TMP_20180329232439_XGMRYH_XGB_Sum_Union part 1/2. Create 


CREATE TEMPORARY TABLE `TMP_20180329232439_XGMRYH_XGB_Sum_Union` (
	`KEY` BIGINT, 
	`Estimator` DOUBLE
)

 ENGINE=MEMORY
-- Code For temporary table TMP_20180329232439_XGMRYH_XGB_Sum_Union part 2/2. Populate

INSERT INTO `TMP_20180329232439_XGMRYH_XGB_Sum_Union` (`KEY`, `Estimator`) SELECT `U`.`KEY`, `U`.`Estimator` 
...
FROM `TMP_20180329232439_M53YAX_XGB_Sum_B0` AS `XGB_Sum_B0` UNION ALL SELECT `XGB_Sum_B1`.`KEY` AS `KEY`, `XGB_Sum_B1`.`Estimator` AS `Estimator` 
FROM `TMP_20180329232439_18LBBM_XGB_Sum_B1` AS `XGB_Sum_B1`) AS `XGB_Sum_EnsembleUnion`) AS `XGB_Sum_Union`) AS `U`
...
FROM `TMP_20180329232439_XGMRYH_XGB_Sum_Union` AS `XGB_Sum_Union` GROUP BY `XGB_Sum_Union`.`KEY`) AS `T`)
