...
-- Code For temporary table TMP_20180329232438_QNJUVW_ADS_imp_1_OUT part 1/2. Create 


CREATE TEMPORARY TABLE "TMP_20180329232438_QNJUVW_ADS_imp_1_OUT" (
	"KEY" BIGINT, 
...
-- Code For temporary table TMP_20180329232438_QNJUVW_ADS_imp_1_OUT part 2/2. Populate

INSERT INTO "TMP_20180329232438_QNJUVW_ADS_imp_1_OUT" ("KEY", imputer_output_2, imputer_output_3, imputer_output_4, imputer_output_5) SELECT "ADS_imp_1_OUT"."KEY", "ADS_imp_1_OUT".imputer_output_2, "ADS_imp_1_OUT".imputer_output_3, "ADS_imp_1_OUT".imputer_output_4, "ADS_imp_1_OUT".imputer_output_5 
...
-- Code For temporary table TMP_20180329232438_9P78EW_ADS_sca_2_OUT part 1/2. Create 


CREATE TEMPORARY TABLE "TMP_20180329232438_9P78EW_ADS_sca_2_OUT" (
	"KEY" BIGINT, 
...
-- Code For temporary table TMP_20180329232438_9P78EW_ADS_sca_2_OUT part 2/2. Populate

INSERT INTO "TMP_20180329232438_9P78EW_ADS_sca_2_OUT" ("KEY", scaler_output_2, scaler_output_3, scaler_output_4, scaler_output_5) SELECT "ADS_sca_2_OUT"."KEY", "ADS_sca_2_OUT".scaler_output_2, "ADS_sca_2_OUT".scaler_output_3, "ADS_sca_2_OUT".scaler_output_4, "ADS_sca_2_OUT".scaler_output_5 
...
FROM "TMP_20180329232438_QNJUVW_ADS_imp_1_OUT" AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT"
-- Code For temporary table TMP_20180329232438_BDCUDO_XGB_Sum_B0 part 1/2. Create 


CREATE TEMPORARY TABLE "TMP_20180329232438_BDCUDO_XGB_Sum_B0" (
	"KEY" BIGINT, 
	"Estimator" FLOAT
)


-- Code For temporary table TMP_20180329232438_BDCUDO_XGB_Sum_B0 part 2/2. Populate
...
FROM "TMP_20180329232438_9P78EW_ADS_sca_2_OUT" AS "ADS_sca_2_OUT"), 
"DT_node_data" AS 
...
FROM "DT_Output_9")
 INSERT INTO "TMP_20180329232438_BDCUDO_XGB_Sum_B0" ("KEY", "Estimator") SELECT "XGB_Sum_B0"."KEY", "XGB_Sum_B0"."Estimator" 
...
-- Code For temporary table TMP_20180329232438_7HCD4U_XGB_Sum_B1 part 1/2. Create 


CREATE TEMPORARY TABLE "TMP_20180329232438_7HCD4U_XGB_Sum_B1" (
	"KEY" BIGINT, 
	"Estimator" FLOAT
)


-- Code For temporary table TMP_20180329232438_7HCD4U_XGB_Sum_B1 part 2/2. Populate
...
FROM "DT_Output_15")
 INSERT INTO "TMP_20180329232438_7HCD4U_XGB_Sum_B1" ("KEY", "Estimator") SELECT "XGB_Sum_B1"."KEY", "XGB_Sum_B1"."Estimator" 
...
-- Code For temporary table TMP_20180329232438_DKBMZS_XGB_Sum_Union part 1/2. Create 


CREATE TEMPORARY TABLE "TMP_20180329232438_DKBMZS_XGB_Sum_Union" (
	"KEY" BIGINT, 
	"Estimator" FLOAT
)


-- Code For temporary table TMP_20180329232438_DKBMZS_XGB_Sum_Union part 2/2. Populate

INSERT INTO "TMP_20180329232438_DKBMZS_XGB_Sum_Union" ("KEY", "Estimator") SELECT "XGB_Sum_Union"."KEY", "XGB_Sum_Union"."Estimator" 
...
FROM "TMP_20180329232438_BDCUDO_XGB_Sum_B0" AS "XGB_Sum_B0" UNION ALL SELECT "XGB_Sum_B1"."KEY" AS "KEY", "XGB_Sum_B1"."Estimator" AS "Estimator" 
FROM "TMP_20180329232438_7HCD4U_XGB_Sum_B1" AS "XGB_Sum_B1") AS "XGB_Sum_EnsembleUnion") AS "XGB_Sum_Union"
...
FROM "TMP_20180329232438_DKBMZS_XGB_Sum_Union" AS "XGB_Sum_Union" GROUP BY "XGB_Sum_Union"."KEY") AS "T")
