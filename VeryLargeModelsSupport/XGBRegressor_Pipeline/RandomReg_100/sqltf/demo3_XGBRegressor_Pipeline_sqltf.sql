...
-- Code For temporary table TMP_20180329231858_PQLWN1_ADS_imp_1_OUT part 1/2. Create 


CREATE TEMPORARY TABLE "TMP_20180329231858_PQLWN1_ADS_imp_1_OUT" (
	"KEY" BIGINT, 
	impter_2 FLOAT, 
	impter_3 FLOAT, 
	impter_4 FLOAT, 
...
-- Code For temporary table TMP_20180329231859_U4VJ06_ADS_sca_2_OUT part 1/2. Create 


CREATE TEMPORARY TABLE "TMP_20180329231859_U4VJ06_ADS_sca_2_OUT" (
	"KEY" BIGINT, 
	scaler_2 FLOAT, 
	scaler_3 FLOAT, 
	scaler_4 FLOAT, 
...
FROM "TMP_20180329231858_PQLWN1_ADS_imp_1_OUT" AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT"
-- Code For temporary table TMP_20180329231859_CU5TJS_XGB_Sum_B0 part 1/2. Create 


CREATE TEMPORARY TABLE "TMP_20180329231859_CU5TJS_XGB_Sum_B0" (
	"KEY" BIGINT, 
	"Estimator" FLOAT
)


-- Code For temporary table TMP_20180329231859_CU5TJS_XGB_Sum_B0 part 2/2. Populate
...
FROM "TMP_20180329231859_U4VJ06_ADS_sca_2_OUT" AS "ADS_sca_2_OUT"), 
"DT_node_data" AS 
...
FROM "DT_Output_9")
 INSERT INTO "TMP_20180329231859_CU5TJS_XGB_Sum_B0" ("KEY", "Estimator") SELECT "XGB_Sum_B0"."KEY", "XGB_Sum_B0"."Estimator" 
...
-- Code For temporary table TMP_20180329231859_NUZJF2_XGB_Sum_B1 part 1/2. Create 


CREATE TEMPORARY TABLE "TMP_20180329231859_NUZJF2_XGB_Sum_B1" (
	"KEY" BIGINT, 
	"Estimator" FLOAT
)


-- Code For temporary table TMP_20180329231859_NUZJF2_XGB_Sum_B1 part 2/2. Populate
...
FROM "DT_Output_15")
 INSERT INTO "TMP_20180329231859_NUZJF2_XGB_Sum_B1" ("KEY", "Estimator") SELECT "XGB_Sum_B1"."KEY", "XGB_Sum_B1"."Estimator" 
...
-- Code For temporary table TMP_20180329231859_2OPUJ1_XGB_Sum_Union part 1/2. Create 


CREATE TEMPORARY TABLE "TMP_20180329231859_2OPUJ1_XGB_Sum_Union" (
	"KEY" BIGINT, 
	"Estimator" FLOAT
)


-- Code For temporary table TMP_20180329231859_2OPUJ1_XGB_Sum_Union part 2/2. Populate

INSERT INTO "TMP_20180329231859_2OPUJ1_XGB_Sum_Union" ("KEY", "Estimator") SELECT "XGB_Sum_Union"."KEY", "XGB_Sum_Union"."Estimator" 
...
FROM "TMP_20180329231859_CU5TJS_XGB_Sum_B0" AS "XGB_Sum_B0" UNION ALL SELECT "XGB_Sum_B1"."KEY" AS "KEY", "XGB_Sum_B1"."Estimator" AS "Estimator" 
FROM "TMP_20180329231859_NUZJF2_XGB_Sum_B1" AS "XGB_Sum_B1") AS "XGB_Sum_EnsembleUnion") AS "XGB_Sum_Union"
...
FROM "TMP_20180329231859_2OPUJ1_XGB_Sum_Union" AS "XGB_Sum_Union" GROUP BY "XGB_Sum_Union"."KEY") AS "T")
