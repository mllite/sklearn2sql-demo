...
-- Code For temporary table TMP_20180329233006_8KOEIW_ADS_imp_1_OUT part 1/2. Create 


CREATE TEMPORARY TABLE "TMP_20180329233006_8KOEIW_ADS_imp_1_OUT" (
	"KEY" BIGINT, 
	impter_2 FLOAT, 
	impter_3 FLOAT, 
	impter_4 FLOAT, 
...
-- Code For temporary table TMP_20180329233006_E7L70X_ADS_sca_2_OUT part 1/2. Create 


CREATE TEMPORARY TABLE "TMP_20180329233006_E7L70X_ADS_sca_2_OUT" (
	"KEY" BIGINT, 
	scaler_2 FLOAT, 
	scaler_3 FLOAT, 
	scaler_4 FLOAT, 
 ...
 ON COMMIT PRESERVE ROWS
-- Code For temporary table TMP_20180329233006_E7L70X_ADS_sca_2_OUT part 2/2. Populate

INSERT INTO "TMP_20180329233006_E7L70X_ADS_sca_2_OUT" ("KEY", scaler_2, scaler_3, scaler_4, scaler_5, scaler_6, scaler_7, scaler_8, scaler_9, scaler_10, scaler_11) SELECT "ADS_sca_2_OUT"."KEY", "ADS_sca_2_OUT".scaler_2, "ADS_sca_2_OUT".scaler_3, "ADS_sca_2_OUT".scaler_4, "ADS_sca_2_OUT".scaler_5, "ADS_sca_2_OUT".scaler_6, "ADS_sca_2_OUT".scaler_7, "ADS_sca_2_OUT".scaler_8, "ADS_sca_2_OUT".scaler_9, "ADS_sca_2_OUT".scaler_10, "ADS_sca_2_OUT".scaler_11 
...
FROM "TMP_20180329233006_8KOEIW_ADS_imp_1_OUT" AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT"
-- Code For temporary table TMP_20180329233006_Q2TXT2_HL_1_relu_1 part 1/2. Create 


CREATE TEMPORARY TABLE "TMP_20180329233006_Q2TXT2_HL_1_relu_1" (
	"KEY" BIGINT, 
	"NEUR_1_1" FLOAT, 
	"NEUR_1_2" FLOAT, 
	"NEUR_1_3" FLOAT
 ...
 ON COMMIT PRESERVE ROWS
-- Code For temporary table TMP_20180329233006_Q2TXT2_HL_1_relu_1 part 2/2. Populate
...
FROM "TMP_20180329233006_E7L70X_ADS_sca_2_OUT" AS "ADS_sca_2_OUT"), 
"HL_BA_1" AS 
...
FROM "HL_BA_1")
 INSERT INTO "TMP_20180329233006_Q2TXT2_HL_1_relu_1" ("KEY", "NEUR_1_1", "NEUR_1_2", "NEUR_1_3") SELECT "HL_1_relu_1"."KEY", "HL_1_relu_1"."NEUR_1_1", "HL_1_relu_1"."NEUR_1_2", "HL_1_relu_1"."NEUR_1_3" 
FROM (SELECT "HL_1_relu"."KEY" AS "KEY", "HL_1_relu"."NEUR_1_1" AS "NEUR_1_1", "HL_1_relu"."NEUR_1_2" AS "NEUR_1_2", "HL_1_relu"."NEUR_1_3" AS "NEUR_1_3" 
FROM "HL_1_relu") AS "HL_1_relu_1"
-- Code For temporary table TMP_20180329233006_IUQGL9_OL_softmax_1 part 1/2. Create 


CREATE TEMPORARY TABLE "TMP_20180329233006_IUQGL9_OL_softmax_1" (
	"KEY" BIGINT, 
	"NEUR_3_1" FLOAT, 
	"NEUR_3_2" FLOAT, 
	"NEUR_3_3" FLOAT, 
 ...
 ON COMMIT PRESERVE ROWS
-- Code For temporary table TMP_20180329233006_IUQGL9_OL_softmax_1 part 2/2. Populate
...
FROM "TMP_20180329233006_Q2TXT2_HL_1_relu_1" AS "HL_1_relu_1"), 
"HL_2_relu" AS 
...
FROM "OL_BA")
 INSERT INTO "TMP_20180329233006_IUQGL9_OL_softmax_1" ("KEY", "NEUR_3_1", "NEUR_3_2", "NEUR_3_3", "NEUR_3_4") SELECT "OL_softmax_1"."KEY", "OL_softmax_1"."NEUR_3_1", "OL_softmax_1"."NEUR_3_2", "OL_softmax_1"."NEUR_3_3", "OL_softmax_1"."NEUR_3_4" 
...
FROM "TMP_20180329233006_IUQGL9_OL_softmax_1" AS "OL_softmax_1"), 
