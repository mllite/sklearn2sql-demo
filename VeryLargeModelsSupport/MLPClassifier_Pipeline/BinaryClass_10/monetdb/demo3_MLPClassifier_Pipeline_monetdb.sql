...
FROM "HL_2_relu"), 
"OL_logistic" AS 
(SELECT "OL_BA"."KEY" AS "KEY", CAST(1.0 / (1.0 + exp(CASE WHEN (CASE WHEN (-100.0 <= -"OL_BA"."NEUR_3_1") THEN -"OL_BA"."NEUR_3_1" ELSE -100.0 END <= 100.0) THEN CASE WHEN (-100.0 <= -"OL_BA"."NEUR_3_1") THEN -"OL_BA"."NEUR_3_1" ELSE -100.0 END ELSE 100.0 END)) AS DOUBLE PRECISION) AS "NEUR_3_1" 
FROM "OL_BA"), 
"OL_logistic_1" AS 
