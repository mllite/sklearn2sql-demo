...
-- Code For temporary table TMP_20180329232413_32Q25D_HL_1_relu_1 part 1/2. Create 


CREATE TEMPORARY TABLE "TMP_20180329232413_32Q25D_HL_1_relu_1" (
	"KEY" BIGINT, 
	"NEUR_1_1" FLOAT, 
	"NEUR_1_2" FLOAT, 
	"NEUR_1_3" FLOAT
...
-- Code For temporary table TMP_20180329232413_32Q25D_HL_1_relu_1 part 2/2. Populate
...
FROM "HL_BA_1")
 INSERT INTO "TMP_20180329232413_32Q25D_HL_1_relu_1" ("KEY", "NEUR_1_1", "NEUR_1_2", "NEUR_1_3") SELECT "HL_1_relu_1"."KEY", "HL_1_relu_1"."NEUR_1_1", "HL_1_relu_1"."NEUR_1_2", "HL_1_relu_1"."NEUR_1_3" 
FROM (SELECT "HL_1_relu"."KEY" AS "KEY", "HL_1_relu"."NEUR_1_1" AS "NEUR_1_1", "HL_1_relu"."NEUR_1_2" AS "NEUR_1_2", "HL_1_relu"."NEUR_1_3" AS "NEUR_1_3" 
FROM "HL_1_relu") AS "HL_1_relu_1"
-- Code For temporary table TMP_20180329232413_9RSEZQ_OL_identity_1 part 1/2. Create 


CREATE TEMPORARY TABLE "TMP_20180329232413_9RSEZQ_OL_identity_1" (
	"KEY" BIGINT, 
	"NEUR_3_1" FLOAT
)


-- Code For temporary table TMP_20180329232413_9RSEZQ_OL_identity_1 part 2/2. Populate
...
FROM "TMP_20180329232413_32Q25D_HL_1_relu_1" AS "HL_1_relu_1"), 
"HL_2_relu" AS 
...
FROM "OL_BA")
 INSERT INTO "TMP_20180329232413_9RSEZQ_OL_identity_1" ("KEY", "NEUR_3_1") SELECT "OL_identity_1"."KEY", "OL_identity_1"."NEUR_3_1" 
...
FROM "TMP_20180329232413_9RSEZQ_OL_identity_1" AS "OL_identity_1"