...
-- Code For temporary table 9232413_SOKSGT_HL_1_RELU_1 part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE "9232413_SOKSGT_HL_1_RELU_1" (
	"KEY" NUMBER(19), 
...
-- Code For temporary table 9232413_SOKSGT_HL_1_RELU_1 part 2/2. Populate

INSERT INTO "9232413_SOKSGT_HL_1_RELU_1" ("KEY", "NEUR_1_1", "NEUR_1_2", "NEUR_1_3") SELECT "U"."KEY", "U"."NEUR_1_1", "U"."NEUR_1_2", "U"."NEUR_1_3" 
FROM (WITH "IL" AS 
...
-- Code For temporary table 32413_95736A_OL_IDENTITY_1 part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE "32413_95736A_OL_IDENTITY_1" (
	"KEY" NUMBER(19), 
	"NEUR_3_1" BINARY_DOUBLE
)

 ON COMMIT PRESERVE ROWS
-- Code For temporary table 32413_95736A_OL_IDENTITY_1 part 2/2. Populate

INSERT INTO "32413_95736A_OL_IDENTITY_1" ("KEY", "NEUR_3_1") SELECT "U"."KEY", "U"."NEUR_3_1" 
...
FROM "9232413_SOKSGT_HL_1_RELU_1" "HL_1_relu_1"), 
"HL_2_relu" AS 
...
FROM "32413_95736A_OL_IDENTITY_1" "OL_identity_1"