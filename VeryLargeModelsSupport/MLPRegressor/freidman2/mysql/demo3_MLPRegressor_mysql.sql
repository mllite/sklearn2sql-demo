...
-- Code For temporary table TMP_20180329232327_4857EW_HL_1_relu_1 part 1/2. Create 


CREATE TEMPORARY TABLE `TMP_20180329232327_4857EW_HL_1_relu_1` (
	`KEY` BIGINT, 
	`NEUR_1_1` DOUBLE, 
	`NEUR_1_2` DOUBLE, 
	`NEUR_1_3` DOUBLE
 ...
 ENGINE=MEMORY
-- Code For temporary table TMP_20180329232327_4857EW_HL_1_relu_1 part 2/2. Populate

INSERT INTO `TMP_20180329232327_4857EW_HL_1_relu_1` (`KEY`, `NEUR_1_1`, `NEUR_1_2`, `NEUR_1_3`) SELECT `U`.`KEY`, `U`.`NEUR_1_1`, `U`.`NEUR_1_2`, `U`.`NEUR_1_3` 
FROM (WITH `IL` AS 
...
-- Code For temporary table TMP_20180329232327_INYBUB_OL_identity_1 part 1/2. Create 


CREATE TEMPORARY TABLE `TMP_20180329232327_INYBUB_OL_identity_1` (
	`KEY` BIGINT, 
	`NEUR_3_1` DOUBLE
)

 ENGINE=MEMORY
-- Code For temporary table TMP_20180329232327_INYBUB_OL_identity_1 part 2/2. Populate

INSERT INTO `TMP_20180329232327_INYBUB_OL_identity_1` (`KEY`, `NEUR_3_1`) SELECT `U`.`KEY`, `U`.`NEUR_3_1` 
...
FROM `TMP_20180329232327_4857EW_HL_1_relu_1` AS `HL_1_relu_1`), 
`HL_2_relu` AS 
...
FROM `TMP_20180329232327_INYBUB_OL_identity_1` AS `OL_identity_1`