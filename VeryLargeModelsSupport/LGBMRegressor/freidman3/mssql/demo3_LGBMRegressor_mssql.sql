...
-- Code For temporary table ##TMP_20180329232408_MTS2RE_LGBM_Sum_B0 part 1/2. Create 


CREATE TABLE ##TMP_20180329232408_MTS2RE_LGBM_Sum_B0 (
	[KEY] BIGINT NULL, 
	[Estimator] FLOAT(53) NULL
)


-- Code For temporary table ##TMP_20180329232408_MTS2RE_LGBM_Sum_B0 part 2/2. Populate
...
FROM [DT_Output_9])
 INSERT INTO ##TMP_20180329232408_MTS2RE_LGBM_Sum_B0 ([KEY], [Estimator]) SELECT [LGBM_Sum_B0].[KEY], [LGBM_Sum_B0].[Estimator] 
...
-- Code For temporary table ##TMP_20180329232408_8HKEN5_LGBM_Sum_B1 part 1/2. Create 


CREATE TABLE ##TMP_20180329232408_8HKEN5_LGBM_Sum_B1 (
	[KEY] BIGINT NULL, 
	[Estimator] FLOAT(53) NULL
)


-- Code For temporary table ##TMP_20180329232408_8HKEN5_LGBM_Sum_B1 part 2/2. Populate
...
FROM [DT_Output_15])
 INSERT INTO ##TMP_20180329232408_8HKEN5_LGBM_Sum_B1 ([KEY], [Estimator]) SELECT [LGBM_Sum_B1].[KEY], [LGBM_Sum_B1].[Estimator] 
...
-- Code For temporary table ##TMP_20180329232408_VST0QP_LGBM_Sum_Union part 1/2. Create 


CREATE TABLE ##TMP_20180329232408_VST0QP_LGBM_Sum_Union (
	[KEY] BIGINT NULL, 
	[Estimator] FLOAT(53) NULL
)


-- Code For temporary table ##TMP_20180329232408_VST0QP_LGBM_Sum_Union part 2/2. Populate

INSERT INTO ##TMP_20180329232408_VST0QP_LGBM_Sum_Union ([KEY], [Estimator]) SELECT [LGBM_Sum_Union].[KEY], [LGBM_Sum_Union].[Estimator] 
...
FROM ##TMP_20180329232408_MTS2RE_LGBM_Sum_B0 AS [LGBM_Sum_B0] UNION ALL SELECT [LGBM_Sum_B1].[KEY] AS [KEY], [LGBM_Sum_B1].[Estimator] AS [Estimator] 
FROM ##TMP_20180329232408_8HKEN5_LGBM_Sum_B1 AS [LGBM_Sum_B1]) AS [LGBM_Sum_EnsembleUnion]) AS [LGBM_Sum_Union]
...
FROM ##TMP_20180329232408_VST0QP_LGBM_Sum_Union AS [LGBM_Sum_Union] GROUP BY [LGBM_Sum_Union].[KEY]) AS [T])
