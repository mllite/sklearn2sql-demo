...
-- Code For temporary table 9233006_WVHGTD_HL_1_RELU_1 part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE "9233006_WVHGTD_HL_1_RELU_1" (
	"KEY" NUMBER(19), 
...
-- Code For temporary table 9233006_WVHGTD_HL_1_RELU_1 part 2/2. Populate

INSERT INTO "9233006_WVHGTD_HL_1_RELU_1" ("KEY", "NEUR_1_1", "NEUR_1_2", "NEUR_1_3") SELECT "U"."KEY", "U"."NEUR_1_1", "U"."NEUR_1_2", "U"."NEUR_1_3" 
FROM (WITH "IL" AS 
...
-- Code For temporary table 233006_FNXMHL_OL_SOFTMAX_1 part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE "233006_FNXMHL_OL_SOFTMAX_1" (
	"KEY" NUMBER(19), 
 ...
 ON COMMIT PRESERVE ROWS
-- Code For temporary table 233006_FNXMHL_OL_SOFTMAX_1 part 2/2. Populate

INSERT INTO "233006_FNXMHL_OL_SOFTMAX_1" ("KEY", "NEUR_3_1", "NEUR_3_2", "NEUR_3_3", "NEUR_3_4") SELECT "U"."KEY", "U"."NEUR_3_1", "U"."NEUR_3_2", "U"."NEUR_3_3", "U"."NEUR_3_4" 
...
FROM "9233006_WVHGTD_HL_1_RELU_1" "HL_1_relu_1"), 
"HL_2_relu" AS 
...
FROM "233006_FNXMHL_OL_SOFTMAX_1" "OL_softmax_1"), 
