...
-- Code For temporary table 31828_NY1VA8_ADS_IMP_1_OUT part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE "31828_NY1VA8_ADS_IMP_1_OUT" (
	"KEY" NUMBER(19), 
...
-- Code For temporary table 31829_2SIFR4_ADS_SCA_2_OUT part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE "31829_2SIFR4_ADS_SCA_2_OUT" (
	"KEY" NUMBER(19), 
...
FROM "31828_NY1VA8_ADS_IMP_1_OUT" "ADS_imp_1_OUT") "ADS_sca_2_OUT") "U"
-- Code For temporary table 329231829_PTGGON_GB_SUM_B0 part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE "329231829_PTGGON_GB_SUM_B0" (
	"KEY" NUMBER(19), 
	"Estimator" BINARY_DOUBLE
)

 ON COMMIT PRESERVE ROWS
-- Code For temporary table 329231829_PTGGON_GB_SUM_B0 part 2/2. Populate

INSERT INTO "329231829_PTGGON_GB_SUM_B0" ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
FROM "31829_2SIFR4_ADS_SCA_2_OUT" "ADS_sca_2_OUT"), 
"DT_node_data" AS 
...
-- Code For temporary table 329231829_3JTXXN_GB_SUM_B1 part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE "329231829_3JTXXN_GB_SUM_B1" (
	"KEY" NUMBER(19), 
	"Estimator" BINARY_DOUBLE
)

 ON COMMIT PRESERVE ROWS
-- Code For temporary table 329231829_3JTXXN_GB_SUM_B1 part 2/2. Populate

INSERT INTO "329231829_3JTXXN_GB_SUM_B1" ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
-- Code For temporary table 231829_VCIOBW_GB_SUM_UNION part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE "231829_VCIOBW_GB_SUM_UNION" (
	"KEY" NUMBER(19), 
	"Estimator" BINARY_DOUBLE
)

 ON COMMIT PRESERVE ROWS
-- Code For temporary table 231829_VCIOBW_GB_SUM_UNION part 2/2. Populate

INSERT INTO "231829_VCIOBW_GB_SUM_UNION" ("KEY", "Estimator") SELECT "U"."KEY", "U"."Estimator" 
...
FROM "329231829_PTGGON_GB_SUM_B0" "GB_Sum_B0" UNION ALL SELECT "GB_Sum_B1"."KEY" AS "KEY", "GB_Sum_B1"."Estimator" AS "Estimator" 
FROM "329231829_3JTXXN_GB_SUM_B1" "GB_Sum_B1") "GB_Sum_EnsembleUnion") "GB_Sum_Union") "U"
...
FROM "231829_VCIOBW_GB_SUM_UNION" "GB_Sum_Union" GROUP BY "GB_Sum_Union"."KEY") "T")
