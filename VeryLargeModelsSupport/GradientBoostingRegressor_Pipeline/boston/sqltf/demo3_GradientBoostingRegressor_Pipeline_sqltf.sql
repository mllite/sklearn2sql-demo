...
-- Code For temporary table TMP_20180329232015_SXGKLM_ADS_imp_1_OUT part 1/2. Create 


CREATE TEMPORARY TABLE "TMP_20180329232015_SXGKLM_ADS_imp_1_OUT" (
	"KEY" BIGINT, 
	impter_2 FLOAT, 
	impter_3 FLOAT, 
	impter_4 FLOAT, 
...
-- Code For temporary table TMP_20180329232015_MPXZMA_ADS_sca_2_OUT part 1/2. Create 


CREATE TEMPORARY TABLE "TMP_20180329232015_MPXZMA_ADS_sca_2_OUT" (
	"KEY" BIGINT, 
	scaler_2 FLOAT, 
	scaler_3 FLOAT, 
	scaler_4 FLOAT, 
...
FROM "TMP_20180329232015_SXGKLM_ADS_imp_1_OUT" AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT"
-- Code For temporary table TMP_20180329232016_4WYC6L_GB_Sum_B0 part 1/2. Create 


CREATE TEMPORARY TABLE "TMP_20180329232016_4WYC6L_GB_Sum_B0" (
	"KEY" BIGINT, 
	"Estimator" FLOAT
)


-- Code For temporary table TMP_20180329232016_4WYC6L_GB_Sum_B0 part 2/2. Populate
...
FROM "TMP_20180329232015_MPXZMA_ADS_sca_2_OUT" AS "ADS_sca_2_OUT"), 
"DT_node_data" AS 
...
FROM "DT_Output_9")
 INSERT INTO "TMP_20180329232016_4WYC6L_GB_Sum_B0" ("KEY", "Estimator") SELECT "GB_Sum_B0"."KEY", "GB_Sum_B0"."Estimator" 
...
-- Code For temporary table TMP_20180329232016_B64PE4_GB_Sum_B1 part 1/2. Create 


CREATE TEMPORARY TABLE "TMP_20180329232016_B64PE4_GB_Sum_B1" (
	"KEY" BIGINT, 
	"Estimator" FLOAT
)


-- Code For temporary table TMP_20180329232016_B64PE4_GB_Sum_B1 part 2/2. Populate
...
FROM "DT_Output_15")
 INSERT INTO "TMP_20180329232016_B64PE4_GB_Sum_B1" ("KEY", "Estimator") SELECT "GB_Sum_B1"."KEY", "GB_Sum_B1"."Estimator" 
...
-- Code For temporary table TMP_20180329232016_4AUKQ4_GB_Sum_Union part 1/2. Create 


CREATE TEMPORARY TABLE "TMP_20180329232016_4AUKQ4_GB_Sum_Union" (
	"KEY" BIGINT, 
	"Estimator" FLOAT
)


-- Code For temporary table TMP_20180329232016_4AUKQ4_GB_Sum_Union part 2/2. Populate

INSERT INTO "TMP_20180329232016_4AUKQ4_GB_Sum_Union" ("KEY", "Estimator") SELECT "GB_Sum_Union"."KEY", "GB_Sum_Union"."Estimator" 
...
FROM "TMP_20180329232016_4WYC6L_GB_Sum_B0" AS "GB_Sum_B0" UNION ALL SELECT "GB_Sum_B1"."KEY" AS "KEY", "GB_Sum_B1"."Estimator" AS "Estimator" 
FROM "TMP_20180329232016_B64PE4_GB_Sum_B1" AS "GB_Sum_B1") AS "GB_Sum_EnsembleUnion") AS "GB_Sum_Union"
...
FROM "TMP_20180329232016_4AUKQ4_GB_Sum_Union" AS "GB_Sum_Union" GROUP BY "GB_Sum_Union"."KEY") AS "T")
