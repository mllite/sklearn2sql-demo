...
-- Code For temporary table 29232623_D9JP33_XGB_SUM_B0 part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE "29232623_D9JP33_XGB_SUM_B0" (
	"KEY" NUMBER(19), 
	"Score_0" BINARY_DOUBLE
)

 ON COMMIT PRESERVE ROWS
-- Code For temporary table 29232623_D9JP33_XGB_SUM_B0 part 2/2. Populate

INSERT INTO "29232623_D9JP33_XGB_SUM_B0" ("KEY", "Score_0") SELECT "U"."KEY", "U"."Score_0" 
...
-- Code For temporary table 29232623_05OTSQ_XGB_SUM_B1 part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE "29232623_05OTSQ_XGB_SUM_B1" (
	"KEY" NUMBER(19), 
	"Score_0" BINARY_DOUBLE
)

 ON COMMIT PRESERVE ROWS
-- Code For temporary table 29232623_05OTSQ_XGB_SUM_B1 part 2/2. Populate

INSERT INTO "29232623_05OTSQ_XGB_SUM_B1" ("KEY", "Score_0") SELECT "U"."KEY", "U"."Score_0" 
...
-- Code For temporary table 32623_R2C741_XGB_SUM_UNION part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE "32623_R2C741_XGB_SUM_UNION" (
	"KEY" NUMBER(19), 
	"Score_0" BINARY_DOUBLE
)

 ON COMMIT PRESERVE ROWS
-- Code For temporary table 32623_R2C741_XGB_SUM_UNION part 2/2. Populate

INSERT INTO "32623_R2C741_XGB_SUM_UNION" ("KEY", "Score_0") SELECT "U"."KEY", "U"."Score_0" 
...
FROM "29232623_D9JP33_XGB_SUM_B0" "XGB_Sum_B0" UNION ALL SELECT "XGB_Sum_B1"."KEY" AS "KEY", "XGB_Sum_B1"."Score_0" AS "Score_0" 
FROM "29232623_05OTSQ_XGB_SUM_B1" "XGB_Sum_B1") "XGB_Sum_EnsembleUnion") "XGB_Sum_Union") "U"
...
FROM "32623_R2C741_XGB_SUM_UNION" "XGB_Sum_Union" GROUP BY "XGB_Sum_Union"."KEY") "T"), 
orig_cte AS 
