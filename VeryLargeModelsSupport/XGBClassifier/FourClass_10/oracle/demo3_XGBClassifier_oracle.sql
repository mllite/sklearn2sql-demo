...
-- Code For temporary table 29233100_FYZKJP_XGB_SUM_B0 part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE "29233100_FYZKJP_XGB_SUM_B0" (
	"KEY" NUMBER(19), 
...
-- Code For temporary table 29233100_FYZKJP_XGB_SUM_B0 part 2/2. Populate

INSERT INTO "29233100_FYZKJP_XGB_SUM_B0" ("KEY", "Score_0", "Score_1", "Score_2", "Score_3") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1", "U"."Score_2", "U"."Score_3" 
...
-- Code For temporary table 29233100_R0AP8V_XGB_SUM_B1 part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE "29233100_R0AP8V_XGB_SUM_B1" (
	"KEY" NUMBER(19), 
	"Score_0" BINARY_DOUBLE, 
	"Score_1" BINARY_DOUBLE, 
	"Score_2" BINARY_DOUBLE, 
 ...
 ON COMMIT PRESERVE ROWS
-- Code For temporary table 29233100_R0AP8V_XGB_SUM_B1 part 2/2. Populate

INSERT INTO "29233100_R0AP8V_XGB_SUM_B1" ("KEY", "Score_0", "Score_1", "Score_2", "Score_3") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1", "U"."Score_2", "U"."Score_3" 
...
-- Code For temporary table 29233100_4SYFIB_XGB_SUM_B2 part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE "29233100_4SYFIB_XGB_SUM_B2" (
	"KEY" NUMBER(19), 
	"Score_0" BINARY_DOUBLE, 
	"Score_1" BINARY_DOUBLE, 
	"Score_2" BINARY_DOUBLE, 
 ...
 ON COMMIT PRESERVE ROWS
-- Code For temporary table 29233100_4SYFIB_XGB_SUM_B2 part 2/2. Populate

INSERT INTO "29233100_4SYFIB_XGB_SUM_B2" ("KEY", "Score_0", "Score_1", "Score_2", "Score_3") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1", "U"."Score_2", "U"."Score_3" 
...
-- Code For temporary table 29233100_I2K2J4_XGB_SUM_B3 part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE "29233100_I2K2J4_XGB_SUM_B3" (
	"KEY" NUMBER(19), 
	"Score_0" BINARY_DOUBLE, 
	"Score_1" BINARY_DOUBLE, 
	"Score_2" BINARY_DOUBLE, 
 ...
 ON COMMIT PRESERVE ROWS
-- Code For temporary table 29233100_I2K2J4_XGB_SUM_B3 part 2/2. Populate

INSERT INTO "29233100_I2K2J4_XGB_SUM_B3" ("KEY", "Score_0", "Score_1", "Score_2", "Score_3") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1", "U"."Score_2", "U"."Score_3" 
...
-- Code For temporary table 29233100_GBWY7X_XGB_SUM_B4 part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE "29233100_GBWY7X_XGB_SUM_B4" (
	"KEY" NUMBER(19), 
	"Score_0" BINARY_DOUBLE, 
	"Score_1" BINARY_DOUBLE, 
	"Score_2" BINARY_DOUBLE, 
 ...
 ON COMMIT PRESERVE ROWS
-- Code For temporary table 29233100_GBWY7X_XGB_SUM_B4 part 2/2. Populate

INSERT INTO "29233100_GBWY7X_XGB_SUM_B4" ("KEY", "Score_0", "Score_1", "Score_2", "Score_3") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1", "U"."Score_2", "U"."Score_3" 
...
-- Code For temporary table 29233100_2KLHUD_XGB_SUM_B5 part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE "29233100_2KLHUD_XGB_SUM_B5" (
	"KEY" NUMBER(19), 
	"Score_0" BINARY_DOUBLE, 
	"Score_1" BINARY_DOUBLE, 
	"Score_2" BINARY_DOUBLE, 
 ...
 ON COMMIT PRESERVE ROWS
-- Code For temporary table 29233100_2KLHUD_XGB_SUM_B5 part 2/2. Populate

INSERT INTO "29233100_2KLHUD_XGB_SUM_B5" ("KEY", "Score_0", "Score_1", "Score_2", "Score_3") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1", "U"."Score_2", "U"."Score_3" 
...
-- Code For temporary table 29233100_SLWLY5_XGB_SUM_B6 part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE "29233100_SLWLY5_XGB_SUM_B6" (
	"KEY" NUMBER(19), 
	"Score_0" BINARY_DOUBLE, 
	"Score_1" BINARY_DOUBLE, 
	"Score_2" BINARY_DOUBLE, 
 ...
 ON COMMIT PRESERVE ROWS
-- Code For temporary table 29233100_SLWLY5_XGB_SUM_B6 part 2/2. Populate

INSERT INTO "29233100_SLWLY5_XGB_SUM_B6" ("KEY", "Score_0", "Score_1", "Score_2", "Score_3") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1", "U"."Score_2", "U"."Score_3" 
...
-- Code For temporary table 33100_5NM7S1_XGB_SUM_UNION part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE "33100_5NM7S1_XGB_SUM_UNION" (
	"KEY" NUMBER(19), 
	"Score_0" BINARY_DOUBLE, 
	"Score_1" BINARY_DOUBLE, 
	"Score_2" BINARY_DOUBLE, 
 ...
 ON COMMIT PRESERVE ROWS
-- Code For temporary table 33100_5NM7S1_XGB_SUM_UNION part 2/2. Populate

INSERT INTO "33100_5NM7S1_XGB_SUM_UNION" ("KEY", "Score_0", "Score_1", "Score_2", "Score_3") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1", "U"."Score_2", "U"."Score_3" 
...
FROM "29233100_FYZKJP_XGB_SUM_B0" "XGB_Sum_B0" UNION ALL SELECT "XGB_Sum_B1"."KEY" AS "KEY", "XGB_Sum_B1"."Score_0" AS "Score_0", "XGB_Sum_B1"."Score_1" AS "Score_1", "XGB_Sum_B1"."Score_2" AS "Score_2", "XGB_Sum_B1"."Score_3" AS "Score_3" 
FROM "29233100_R0AP8V_XGB_SUM_B1" "XGB_Sum_B1" UNION ALL SELECT "XGB_Sum_B2"."KEY" AS "KEY", "XGB_Sum_B2"."Score_0" AS "Score_0", "XGB_Sum_B2"."Score_1" AS "Score_1", "XGB_Sum_B2"."Score_2" AS "Score_2", "XGB_Sum_B2"."Score_3" AS "Score_3" 
FROM "29233100_4SYFIB_XGB_SUM_B2" "XGB_Sum_B2" UNION ALL SELECT "XGB_Sum_B3"."KEY" AS "KEY", "XGB_Sum_B3"."Score_0" AS "Score_0", "XGB_Sum_B3"."Score_1" AS "Score_1", "XGB_Sum_B3"."Score_2" AS "Score_2", "XGB_Sum_B3"."Score_3" AS "Score_3" 
FROM "29233100_I2K2J4_XGB_SUM_B3" "XGB_Sum_B3" UNION ALL SELECT "XGB_Sum_B4"."KEY" AS "KEY", "XGB_Sum_B4"."Score_0" AS "Score_0", "XGB_Sum_B4"."Score_1" AS "Score_1", "XGB_Sum_B4"."Score_2" AS "Score_2", "XGB_Sum_B4"."Score_3" AS "Score_3" 
FROM "29233100_GBWY7X_XGB_SUM_B4" "XGB_Sum_B4" UNION ALL SELECT "XGB_Sum_B5"."KEY" AS "KEY", "XGB_Sum_B5"."Score_0" AS "Score_0", "XGB_Sum_B5"."Score_1" AS "Score_1", "XGB_Sum_B5"."Score_2" AS "Score_2", "XGB_Sum_B5"."Score_3" AS "Score_3" 
FROM "29233100_2KLHUD_XGB_SUM_B5" "XGB_Sum_B5" UNION ALL SELECT "XGB_Sum_B6"."KEY" AS "KEY", "XGB_Sum_B6"."Score_0" AS "Score_0", "XGB_Sum_B6"."Score_1" AS "Score_1", "XGB_Sum_B6"."Score_2" AS "Score_2", "XGB_Sum_B6"."Score_3" AS "Score_3" 
FROM "29233100_SLWLY5_XGB_SUM_B6" "XGB_Sum_B6") "XGB_Sum_EnsembleUnion") "XGB_Sum_Union") "U"
...
FROM "33100_5NM7S1_XGB_SUM_UNION" "XGB_Sum_Union" GROUP BY "XGB_Sum_Union"."KEY") "T"), 
orig_cte AS 
