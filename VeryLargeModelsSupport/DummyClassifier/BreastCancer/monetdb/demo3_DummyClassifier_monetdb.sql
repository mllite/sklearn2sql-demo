...
(SELECT multinomial_cte."KEY" AS "KEY", 0.3516483516483517 AS "Proba_0", CASE WHEN (0.3516483516483517 IS NULL OR 0.3516483516483517 > 0.0) THEN log(0.3516483516483517) ELSE -1e+125 END AS "LogProba_0", 0.6483516483516484 AS "Proba_1", CASE WHEN (0.6483516483516484 IS NULL OR 0.6483516483516484 > 0.0) THEN log(0.6483516483516484) ELSE -1e+125 END AS "LogProba_1", multinomial_cte.multinomial_expr AS "Decision" 
