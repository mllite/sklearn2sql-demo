...
(SELECT multinomial_cte."KEY" AS "KEY", 0.525 AS "Proba_0", CASE WHEN (0.525 IS NULL OR 0.525 > 0.0) THEN log(0.525) ELSE -1e+125 END AS "LogProba_0", 0.475 AS "Proba_1", CASE WHEN (0.475 IS NULL OR 0.475 > 0.0) THEN log(0.475) ELSE -1e+125 END AS "LogProba_1", multinomial_cte.multinomial_expr AS "Decision" 
