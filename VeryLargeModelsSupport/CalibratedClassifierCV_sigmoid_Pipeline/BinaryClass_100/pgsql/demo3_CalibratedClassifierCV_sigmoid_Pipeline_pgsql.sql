...
-- Code For temporary table TMP_20180329232539_9NDA92_ADS_imp_1_OUT part 1/2. Create 


CREATE TEMPORARY TABLE "TMP_20180329232539_9NDA92_ADS_imp_1_OUT" (
	"KEY" BIGINT, 
	impter_2 FLOAT, 
	impter_3 FLOAT, 
	impter_4 FLOAT, 
...
-- Code For temporary table TMP_20180329232539_9HLAIH_ADS_sca_2_OUT part 1/2. Create 


CREATE TEMPORARY TABLE "TMP_20180329232539_9HLAIH_ADS_sca_2_OUT" (
	"KEY" BIGINT, 
	scaler_2 FLOAT, 
	scaler_3 FLOAT, 
	scaler_4 FLOAT, 
...
FROM "TMP_20180329232539_9NDA92_ADS_imp_1_OUT" AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT"
-- Code For temporary table TMP_20180329232540_CY7VSA_CalProb_AVG_B0 part 1/2. Create 


CREATE TEMPORARY TABLE "TMP_20180329232540_CY7VSA_CalProb_AVG_B0" (
	"KEY" BIGINT, 
	"Proba_1" FLOAT, 
	"Proba_0" FLOAT
)
 ...
 ON COMMIT PRESERVE ROWS
-- Code For temporary table TMP_20180329232540_CY7VSA_CalProb_AVG_B0 part 2/2. Populate
...
FROM "TMP_20180329232539_9HLAIH_ADS_sca_2_OUT" AS "ADS_sca_2_OUT"), 
"DT_node_data" AS 
...
FROM sigmoid_calibration_3)
 INSERT INTO "TMP_20180329232540_CY7VSA_CalProb_AVG_B0" ("KEY", "Proba_1", "Proba_0") SELECT "CalProb_AVG_B0"."KEY", "CalProb_AVG_B0"."Proba_1", "CalProb_AVG_B0"."Proba_0" 
...
-- Code For temporary table TMP_20180329232540_UZ8LVQ_CalProb_AVG_Union part 1/2. Create 


CREATE TEMPORARY TABLE "TMP_20180329232540_UZ8LVQ_CalProb_AVG_Union" (
	"KEY" BIGINT, 
	"Proba_1" FLOAT, 
	"Proba_0" FLOAT
)
 ...
 ON COMMIT PRESERVE ROWS
-- Code For temporary table TMP_20180329232540_UZ8LVQ_CalProb_AVG_Union part 2/2. Populate

INSERT INTO "TMP_20180329232540_UZ8LVQ_CalProb_AVG_Union" ("KEY", "Proba_1", "Proba_0") SELECT "CalProb_AVG_Union"."KEY", "CalProb_AVG_Union"."Proba_1", "CalProb_AVG_Union"."Proba_0" 
...
FROM "TMP_20180329232540_CY7VSA_CalProb_AVG_B0" AS "CalProb_AVG_B0") AS "CalProb_AVG_EnsembleUnion") AS "CalProb_AVG_Union"
...
FROM "TMP_20180329232540_UZ8LVQ_CalProb_AVG_Union" AS "CalProb_AVG_Union" GROUP BY "CalProb_AVG_Union"."KEY") AS "T"), 
orig_cte AS 
