...
-- Code For temporary table TMP_20180329232539_SMHTCP_ADS_imp_1_OUT part 1/2. Create 


CREATE TEMPORARY TABLE `TMP_20180329232539_SMHTCP_ADS_imp_1_OUT` (
	`KEY` BIGINT, 
	impter_2 DOUBLE, 
	impter_3 DOUBLE, 
	impter_4 DOUBLE, 
...
-- Code For temporary table TMP_20180329232539_DUQ8HG_ADS_sca_2_OUT part 1/2. Create 


CREATE TEMPORARY TABLE `TMP_20180329232539_DUQ8HG_ADS_sca_2_OUT` (
	`KEY` BIGINT, 
	scaler_2 DOUBLE, 
	scaler_3 DOUBLE, 
	scaler_4 DOUBLE, 
...
FROM `TMP_20180329232539_SMHTCP_ADS_imp_1_OUT` AS `ADS_imp_1_OUT`) AS `ADS_sca_2_OUT`) AS `U`
-- Code For temporary table TMP_20180329232540_BERXC8_CalProb_AVG_B0 part 1/2. Create 


CREATE TEMPORARY TABLE `TMP_20180329232540_BERXC8_CalProb_AVG_B0` (
	`KEY` BIGINT, 
	`Proba_1` DOUBLE, 
	`Proba_0` DOUBLE
)
 ...
 ENGINE=MEMORY
-- Code For temporary table TMP_20180329232540_BERXC8_CalProb_AVG_B0 part 2/2. Populate

INSERT INTO `TMP_20180329232540_BERXC8_CalProb_AVG_B0` (`KEY`, `Proba_1`, `Proba_0`) SELECT `U`.`KEY`, `U`.`Proba_1`, `U`.`Proba_0` 
...
FROM `TMP_20180329232539_DUQ8HG_ADS_sca_2_OUT` AS `ADS_sca_2_OUT`), 
`DT_node_data` AS 
...
(SELECT calibration_base_estimator_0.`KEY` AS `KEY`, 1.0 / (1.0 + exp(least(greatest(-100.0, -(2.302343680054423 * calibration_base_estimator_0.`ScoreOrProba_1` + -1.2105553273631793)), 100.0))) AS `Proba_1`, 1.0 - 1.0 / (1.0 + exp(least(greatest(-100.0, -(2.302343680054423 * calibration_base_estimator_0.`ScoreOrProba_1` + -1.2105553273631793)), 100.0))) AS `Proba_0` 
...
(SELECT calibration_base_estimator_1.`KEY` AS `KEY`, 1.0 / (1.0 + exp(least(greatest(-100.0, -(3.314062182700888 * calibration_base_estimator_1.`ScoreOrProba_1` + -1.709231943724962)), 100.0))) AS `Proba_1`, 1.0 - 1.0 / (1.0 + exp(least(greatest(-100.0, -(3.314062182700888 * calibration_base_estimator_1.`ScoreOrProba_1` + -1.709231943724962)), 100.0))) AS `Proba_0` 
...
(SELECT calibration_base_estimator_2.`KEY` AS `KEY`, 1.0 / (1.0 + exp(least(greatest(-100.0, -(2.079068705462255 * calibration_base_estimator_2.`ScoreOrProba_1` + -1.106710373017934)), 100.0))) AS `Proba_1`, 1.0 - 1.0 / (1.0 + exp(least(greatest(-100.0, -(2.079068705462255 * calibration_base_estimator_2.`ScoreOrProba_1` + -1.106710373017934)), 100.0))) AS `Proba_0` 
...
(SELECT calibration_base_estimator_3.`KEY` AS `KEY`, 1.0 / (1.0 + exp(least(greatest(-100.0, -(2.244245371482823 * calibration_base_estimator_3.`ScoreOrProba_1` + -1.472565828440728)), 100.0))) AS `Proba_1`, 1.0 - 1.0 / (1.0 + exp(least(greatest(-100.0, -(2.244245371482823 * calibration_base_estimator_3.`ScoreOrProba_1` + -1.472565828440728)), 100.0))) AS `Proba_0` 
...
-- Code For temporary table TMP_20180329232540_NCDQ4L_CalProb_AVG_Union part 1/2. Create 


CREATE TEMPORARY TABLE `TMP_20180329232540_NCDQ4L_CalProb_AVG_Union` (
	`KEY` BIGINT, 
	`Proba_1` DOUBLE, 
	`Proba_0` DOUBLE
)
 ...
 ENGINE=MEMORY
-- Code For temporary table TMP_20180329232540_NCDQ4L_CalProb_AVG_Union part 2/2. Populate

INSERT INTO `TMP_20180329232540_NCDQ4L_CalProb_AVG_Union` (`KEY`, `Proba_1`, `Proba_0`) SELECT `U`.`KEY`, `U`.`Proba_1`, `U`.`Proba_0` 
...
FROM `TMP_20180329232540_BERXC8_CalProb_AVG_B0` AS `CalProb_AVG_B0`) AS `CalProb_AVG_EnsembleUnion`) AS `CalProb_AVG_Union`) AS `U`
...
FROM `TMP_20180329232540_NCDQ4L_CalProb_AVG_Union` AS `CalProb_AVG_Union` GROUP BY `CalProb_AVG_Union`.`KEY`) AS `T`), 
orig_cte AS 
