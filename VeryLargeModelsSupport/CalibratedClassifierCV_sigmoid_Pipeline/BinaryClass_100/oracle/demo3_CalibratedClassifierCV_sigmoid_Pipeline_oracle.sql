...
-- Code For temporary table 32539_6V2X7R_ADS_IMP_1_OUT part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE "32539_6V2X7R_ADS_IMP_1_OUT" (
	"KEY" NUMBER(19), 
...
-- Code For temporary table 32539_SR605U_ADS_SCA_2_OUT part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE "32539_SR605U_ADS_SCA_2_OUT" (
	"KEY" NUMBER(19), 
...
FROM "32539_6V2X7R_ADS_IMP_1_OUT" "ADS_imp_1_OUT") "ADS_sca_2_OUT") "U"
-- Code For temporary table 2539_G25GI4_CALPROB_AVG_B0 part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE "2539_G25GI4_CALPROB_AVG_B0" (
	"KEY" NUMBER(19), 
 ...
 ON COMMIT PRESERVE ROWS
-- Code For temporary table 2539_G25GI4_CALPROB_AVG_B0 part 2/2. Populate

INSERT INTO "2539_G25GI4_CALPROB_AVG_B0" ("KEY", "Proba_1", "Proba_0") SELECT "U"."KEY", "U"."Proba_1", "U"."Proba_0" 
...
FROM "32539_SR605U_ADS_SCA_2_OUT" "ADS_sca_2_OUT"), 
"DT_node_data" AS 
...
-- Code For temporary table 9_5B6JYJ_CALPROB_AVG_UNION part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE "9_5B6JYJ_CALPROB_AVG_UNION" (
	"KEY" NUMBER(19), 
	"Proba_1" BINARY_DOUBLE, 
	"Proba_0" BINARY_DOUBLE
)
 ...
 ON COMMIT PRESERVE ROWS
-- Code For temporary table 9_5B6JYJ_CALPROB_AVG_UNION part 2/2. Populate

INSERT INTO "9_5B6JYJ_CALPROB_AVG_UNION" ("KEY", "Proba_1", "Proba_0") SELECT "U"."KEY", "U"."Proba_1", "U"."Proba_0" 
...
FROM "2539_G25GI4_CALPROB_AVG_B0" "CalProb_AVG_B0") "CalProb_AVG_EnsembleUnion") "CalProb_AVG_Union") "U"
...
FROM "9_5B6JYJ_CALPROB_AVG_UNION" "CalProb_AVG_Union" GROUP BY "CalProb_AVG_Union"."KEY") "T"), 
orig_cte AS 
