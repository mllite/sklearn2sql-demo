...
-- Code For temporary table ##TMP_20180329232540_V1XNCA_ADS_imp_1_OUT part 1/2. Create 


CREATE TABLE ##TMP_20180329232540_V1XNCA_ADS_imp_1_OUT (
	[KEY] BIGINT NULL, 
...
-- Code For temporary table ##TMP_20180329232540_4HLRB5_ADS_sca_2_OUT part 1/2. Create 


CREATE TABLE ##TMP_20180329232540_4HLRB5_ADS_sca_2_OUT (
	[KEY] BIGINT NULL, 
	scaler_2 FLOAT NULL, 
	scaler_3 FLOAT NULL, 
	scaler_4 FLOAT NULL, 
...
FROM ##TMP_20180329232540_V1XNCA_ADS_imp_1_OUT AS [ADS_imp_1_OUT]) AS [ADS_sca_2_OUT]
-- Code For temporary table ##TMP_20180329232541_VUORYJ_CalProb_AVG_B0 part 1/2. Create 


CREATE TABLE ##TMP_20180329232541_VUORYJ_CalProb_AVG_B0 (
	[KEY] BIGINT NULL, 
	[Proba_1] FLOAT NULL, 
	[Proba_0] FLOAT NULL
)
...
-- Code For temporary table ##TMP_20180329232541_VUORYJ_CalProb_AVG_B0 part 2/2. Populate
...
FROM ##TMP_20180329232540_4HLRB5_ADS_sca_2_OUT AS [ADS_sca_2_OUT]), 
[DT_node_data] AS 
...
(SELECT calibration_base_estimator_0.[KEY] AS [KEY], 1.0 / (1.0 + exp(CASE WHEN (CASE WHEN (-100.0 <= -(2.302343680054423 * calibration_base_estimator_0.[ScoreOrProba_1] + -1.2105553273631793)) THEN -(2.302343680054423 * calibration_base_estimator_0.[ScoreOrProba_1] + -1.2105553273631793) ELSE -100.0 END <= 100.0) THEN CASE WHEN (-100.0 <= -(2.302343680054423 * calibration_base_estimator_0.[ScoreOrProba_1] + -1.2105553273631793)) THEN -(2.302343680054423 * calibration_base_estimator_0.[ScoreOrProba_1] + -1.2105553273631793) ELSE -100.0 END ELSE 100.0 END)) AS [Proba_1], 1.0 - 1.0 / (1.0 + exp(CASE WHEN (CASE WHEN (-100.0 <= -(2.302343680054423 * calibration_base_estimator_0.[ScoreOrProba_1] + -1.2105553273631793)) THEN -(2.302343680054423 * calibration_base_estimator_0.[ScoreOrProba_1] + -1.2105553273631793) ELSE -100.0 END <= 100.0) THEN CASE WHEN (-100.0 <= -(2.302343680054423 * calibration_base_estimator_0.[ScoreOrProba_1] + -1.2105553273631793)) THEN -(2.302343680054423 * calibration_base_estimator_0.[ScoreOrProba_1] + -1.2105553273631793) ELSE -100.0 END ELSE 100.0 END)) AS [Proba_0] 
...
(SELECT calibration_base_estimator_1.[KEY] AS [KEY], 1.0 / (1.0 + exp(CASE WHEN (CASE WHEN (-100.0 <= -(3.314062182700888 * calibration_base_estimator_1.[ScoreOrProba_1] + -1.709231943724962)) THEN -(3.314062182700888 * calibration_base_estimator_1.[ScoreOrProba_1] + -1.709231943724962) ELSE -100.0 END <= 100.0) THEN CASE WHEN (-100.0 <= -(3.314062182700888 * calibration_base_estimator_1.[ScoreOrProba_1] + -1.709231943724962)) THEN -(3.314062182700888 * calibration_base_estimator_1.[ScoreOrProba_1] + -1.709231943724962) ELSE -100.0 END ELSE 100.0 END)) AS [Proba_1], 1.0 - 1.0 / (1.0 + exp(CASE WHEN (CASE WHEN (-100.0 <= -(3.314062182700888 * calibration_base_estimator_1.[ScoreOrProba_1] + -1.709231943724962)) THEN -(3.314062182700888 * calibration_base_estimator_1.[ScoreOrProba_1] + -1.709231943724962) ELSE -100.0 END <= 100.0) THEN CASE WHEN (-100.0 <= -(3.314062182700888 * calibration_base_estimator_1.[ScoreOrProba_1] + -1.709231943724962)) THEN -(3.314062182700888 * calibration_base_estimator_1.[ScoreOrProba_1] + -1.709231943724962) ELSE -100.0 END ELSE 100.0 END)) AS [Proba_0] 
...
(SELECT calibration_base_estimator_2.[KEY] AS [KEY], 1.0 / (1.0 + exp(CASE WHEN (CASE WHEN (-100.0 <= -(2.079068705462255 * calibration_base_estimator_2.[ScoreOrProba_1] + -1.106710373017934)) THEN -(2.079068705462255 * calibration_base_estimator_2.[ScoreOrProba_1] + -1.106710373017934) ELSE -100.0 END <= 100.0) THEN CASE WHEN (-100.0 <= -(2.079068705462255 * calibration_base_estimator_2.[ScoreOrProba_1] + -1.106710373017934)) THEN -(2.079068705462255 * calibration_base_estimator_2.[ScoreOrProba_1] + -1.106710373017934) ELSE -100.0 END ELSE 100.0 END)) AS [Proba_1], 1.0 - 1.0 / (1.0 + exp(CASE WHEN (CASE WHEN (-100.0 <= -(2.079068705462255 * calibration_base_estimator_2.[ScoreOrProba_1] + -1.106710373017934)) THEN -(2.079068705462255 * calibration_base_estimator_2.[ScoreOrProba_1] + -1.106710373017934) ELSE -100.0 END <= 100.0) THEN CASE WHEN (-100.0 <= -(2.079068705462255 * calibration_base_estimator_2.[ScoreOrProba_1] + -1.106710373017934)) THEN -(2.079068705462255 * calibration_base_estimator_2.[ScoreOrProba_1] + -1.106710373017934) ELSE -100.0 END ELSE 100.0 END)) AS [Proba_0] 
...
(SELECT calibration_base_estimator_3.[KEY] AS [KEY], 1.0 / (1.0 + exp(CASE WHEN (CASE WHEN (-100.0 <= -(2.244245371482823 * calibration_base_estimator_3.[ScoreOrProba_1] + -1.472565828440728)) THEN -(2.244245371482823 * calibration_base_estimator_3.[ScoreOrProba_1] + -1.472565828440728) ELSE -100.0 END <= 100.0) THEN CASE WHEN (-100.0 <= -(2.244245371482823 * calibration_base_estimator_3.[ScoreOrProba_1] + -1.472565828440728)) THEN -(2.244245371482823 * calibration_base_estimator_3.[ScoreOrProba_1] + -1.472565828440728) ELSE -100.0 END ELSE 100.0 END)) AS [Proba_1], 1.0 - 1.0 / (1.0 + exp(CASE WHEN (CASE WHEN (-100.0 <= -(2.244245371482823 * calibration_base_estimator_3.[ScoreOrProba_1] + -1.472565828440728)) THEN -(2.244245371482823 * calibration_base_estimator_3.[ScoreOrProba_1] + -1.472565828440728) ELSE -100.0 END <= 100.0) THEN CASE WHEN (-100.0 <= -(2.244245371482823 * calibration_base_estimator_3.[ScoreOrProba_1] + -1.472565828440728)) THEN -(2.244245371482823 * calibration_base_estimator_3.[ScoreOrProba_1] + -1.472565828440728) ELSE -100.0 END ELSE 100.0 END)) AS [Proba_0] 
...
FROM sigmoid_calibration_3)
 INSERT INTO ##TMP_20180329232541_VUORYJ_CalProb_AVG_B0 ([KEY], [Proba_1], [Proba_0]) SELECT [CalProb_AVG_B0].[KEY], [CalProb_AVG_B0].[Proba_1], [CalProb_AVG_B0].[Proba_0] 
...
-- Code For temporary table ##TMP_20180329232541_A3E1QS_CalProb_AVG_Union part 1/2. Create 


CREATE TABLE ##TMP_20180329232541_A3E1QS_CalProb_AVG_Union (
	[KEY] BIGINT NULL, 
	[Proba_1] FLOAT NULL, 
	[Proba_0] FLOAT NULL
)
...
-- Code For temporary table ##TMP_20180329232541_A3E1QS_CalProb_AVG_Union part 2/2. Populate

INSERT INTO ##TMP_20180329232541_A3E1QS_CalProb_AVG_Union ([KEY], [Proba_1], [Proba_0]) SELECT [CalProb_AVG_Union].[KEY], [CalProb_AVG_Union].[Proba_1], [CalProb_AVG_Union].[Proba_0] 
...
FROM ##TMP_20180329232541_VUORYJ_CalProb_AVG_B0 AS [CalProb_AVG_B0]) AS [CalProb_AVG_EnsembleUnion]) AS [CalProb_AVG_Union]
...
FROM ##TMP_20180329232541_A3E1QS_CalProb_AVG_Union AS [CalProb_AVG_Union] GROUP BY [CalProb_AVG_Union].[KEY]) AS [T]), 
orig_cte AS 
