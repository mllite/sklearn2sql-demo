...
-- Code For temporary table 32128_VJC0PJ_ADS_IMP_1_OUT part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE "32128_VJC0PJ_ADS_IMP_1_OUT" (
	"KEY" NUMBER(19), 
...
-- Code For temporary table 32128_VJC0PJ_ADS_IMP_1_OUT part 2/2. Populate

INSERT INTO "32128_VJC0PJ_ADS_IMP_1_OUT" ("KEY", impter_2, impter_3, impter_4, impter_5, impter_6, impter_7, impter_8, impter_9, impter_10, impter_11) SELECT "U"."KEY", "U".impter_2, "U".impter_3, "U".impter_4, "U".impter_5, "U".impter_6, "U".impter_7, "U".impter_8, "U".impter_9, "U".impter_10, "U".impter_11 
...
-- Code For temporary table 32128_QIF663_ADS_SCA_2_OUT part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE "32128_QIF663_ADS_SCA_2_OUT" (
	"KEY" NUMBER(19), 
 ...
 ON COMMIT PRESERVE ROWS
-- Code For temporary table 32128_QIF663_ADS_SCA_2_OUT part 2/2. Populate

INSERT INTO "32128_QIF663_ADS_SCA_2_OUT" ("KEY", scaler_2, scaler_3, scaler_4, scaler_5, scaler_6, scaler_7, scaler_8, scaler_9, scaler_10, scaler_11) SELECT "U"."KEY", "U".scaler_2, "U".scaler_3, "U".scaler_4, "U".scaler_5, "U".scaler_6, "U".scaler_7, "U".scaler_8, "U".scaler_9, "U".scaler_10, "U".scaler_11 
...
FROM "32128_VJC0PJ_ADS_IMP_1_OUT" "ADS_imp_1_OUT") "ADS_sca_2_OUT") "U"
-- Code For temporary table 9232128_WMWX2K_HL_1_RELU_1 part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE "9232128_WMWX2K_HL_1_RELU_1" (
	"KEY" NUMBER(19), 
 ...
 ON COMMIT PRESERVE ROWS
-- Code For temporary table 9232128_WMWX2K_HL_1_RELU_1 part 2/2. Populate

INSERT INTO "9232128_WMWX2K_HL_1_RELU_1" ("KEY", "NEUR_1_1", "NEUR_1_2", "NEUR_1_3") SELECT "U"."KEY", "U"."NEUR_1_1", "U"."NEUR_1_2", "U"."NEUR_1_3" 
FROM (WITH "IL" AS 
...
FROM "32128_QIF663_ADS_SCA_2_OUT" "ADS_sca_2_OUT"), 
"HL_BA_1" AS 
...
-- Code For temporary table 32128_VU7VRI_OL_IDENTITY_1 part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE "32128_VU7VRI_OL_IDENTITY_1" (
	"KEY" NUMBER(19), 
	"NEUR_3_1" BINARY_DOUBLE
)

 ON COMMIT PRESERVE ROWS
-- Code For temporary table 32128_VU7VRI_OL_IDENTITY_1 part 2/2. Populate

INSERT INTO "32128_VU7VRI_OL_IDENTITY_1" ("KEY", "NEUR_3_1") SELECT "U"."KEY", "U"."NEUR_3_1" 
...
FROM "9232128_WMWX2K_HL_1_RELU_1" "HL_1_relu_1"), 
"HL_2_relu" AS 
...
FROM "32128_VU7VRI_OL_IDENTITY_1" "OL_identity_1"