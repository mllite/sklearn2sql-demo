...
-- Code For temporary table 33100_17XP4T_ADS_IMP_1_OUT part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE "33100_17XP4T_ADS_IMP_1_OUT" (
	"KEY" NUMBER(19), 
...
-- Code For temporary table 33100_17XP4T_ADS_IMP_1_OUT part 2/2. Populate

INSERT INTO "33100_17XP4T_ADS_IMP_1_OUT" ("KEY", impter_2, impter_3, impter_4, impter_5, impter_6, impter_7, impter_8, impter_9, impter_10, impter_11) SELECT "U"."KEY", "U".impter_2, "U".impter_3, "U".impter_4, "U".impter_5, "U".impter_6, "U".impter_7, "U".impter_8, "U".impter_9, "U".impter_10, "U".impter_11 
...
-- Code For temporary table 33100_LCJM8X_ADS_SCA_2_OUT part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE "33100_LCJM8X_ADS_SCA_2_OUT" (
	"KEY" NUMBER(19), 
 ...
 ON COMMIT PRESERVE ROWS
-- Code For temporary table 33100_LCJM8X_ADS_SCA_2_OUT part 2/2. Populate

INSERT INTO "33100_LCJM8X_ADS_SCA_2_OUT" ("KEY", scaler_2, scaler_3, scaler_4, scaler_5, scaler_6, scaler_7, scaler_8, scaler_9, scaler_10, scaler_11) SELECT "U"."KEY", "U".scaler_2, "U".scaler_3, "U".scaler_4, "U".scaler_5, "U".scaler_6, "U".scaler_7, "U".scaler_8, "U".scaler_9, "U".scaler_10, "U".scaler_11 
...
FROM "33100_17XP4T_ADS_IMP_1_OUT" "ADS_imp_1_OUT") "ADS_sca_2_OUT") "U"
-- Code For temporary table 29233100_MBE26I_XGB_SUM_B0 part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE "29233100_MBE26I_XGB_SUM_B0" (
	"KEY" NUMBER(19), 
 ...
 ON COMMIT PRESERVE ROWS
-- Code For temporary table 29233100_MBE26I_XGB_SUM_B0 part 2/2. Populate

INSERT INTO "29233100_MBE26I_XGB_SUM_B0" ("KEY", "Score_0", "Score_1", "Score_2", "Score_3") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1", "U"."Score_2", "U"."Score_3" 
...
FROM "33100_LCJM8X_ADS_SCA_2_OUT" "ADS_sca_2_OUT"), 
"DT_node_data" AS 
...
-- Code For temporary table 29233100_532EDN_XGB_SUM_B1 part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE "29233100_532EDN_XGB_SUM_B1" (
	"KEY" NUMBER(19), 
	"Score_0" BINARY_DOUBLE, 
	"Score_1" BINARY_DOUBLE, 
	"Score_2" BINARY_DOUBLE, 
 ...
 ON COMMIT PRESERVE ROWS
-- Code For temporary table 29233100_532EDN_XGB_SUM_B1 part 2/2. Populate

INSERT INTO "29233100_532EDN_XGB_SUM_B1" ("KEY", "Score_0", "Score_1", "Score_2", "Score_3") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1", "U"."Score_2", "U"."Score_3" 
...
-- Code For temporary table 29233100_M906M8_XGB_SUM_B2 part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE "29233100_M906M8_XGB_SUM_B2" (
	"KEY" NUMBER(19), 
	"Score_0" BINARY_DOUBLE, 
	"Score_1" BINARY_DOUBLE, 
	"Score_2" BINARY_DOUBLE, 
 ...
 ON COMMIT PRESERVE ROWS
-- Code For temporary table 29233100_M906M8_XGB_SUM_B2 part 2/2. Populate

INSERT INTO "29233100_M906M8_XGB_SUM_B2" ("KEY", "Score_0", "Score_1", "Score_2", "Score_3") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1", "U"."Score_2", "U"."Score_3" 
...
-- Code For temporary table 29233100_PLNC3T_XGB_SUM_B3 part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE "29233100_PLNC3T_XGB_SUM_B3" (
	"KEY" NUMBER(19), 
	"Score_0" BINARY_DOUBLE, 
	"Score_1" BINARY_DOUBLE, 
	"Score_2" BINARY_DOUBLE, 
 ...
 ON COMMIT PRESERVE ROWS
-- Code For temporary table 29233100_PLNC3T_XGB_SUM_B3 part 2/2. Populate

INSERT INTO "29233100_PLNC3T_XGB_SUM_B3" ("KEY", "Score_0", "Score_1", "Score_2", "Score_3") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1", "U"."Score_2", "U"."Score_3" 
...
-- Code For temporary table 29233100_XO7QYQ_XGB_SUM_B4 part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE "29233100_XO7QYQ_XGB_SUM_B4" (
	"KEY" NUMBER(19), 
	"Score_0" BINARY_DOUBLE, 
	"Score_1" BINARY_DOUBLE, 
	"Score_2" BINARY_DOUBLE, 
 ...
 ON COMMIT PRESERVE ROWS
-- Code For temporary table 29233100_XO7QYQ_XGB_SUM_B4 part 2/2. Populate

INSERT INTO "29233100_XO7QYQ_XGB_SUM_B4" ("KEY", "Score_0", "Score_1", "Score_2", "Score_3") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1", "U"."Score_2", "U"."Score_3" 
...
-- Code For temporary table 29233100_J1JGSD_XGB_SUM_B5 part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE "29233100_J1JGSD_XGB_SUM_B5" (
	"KEY" NUMBER(19), 
	"Score_0" BINARY_DOUBLE, 
	"Score_1" BINARY_DOUBLE, 
	"Score_2" BINARY_DOUBLE, 
 ...
 ON COMMIT PRESERVE ROWS
-- Code For temporary table 29233100_J1JGSD_XGB_SUM_B5 part 2/2. Populate

INSERT INTO "29233100_J1JGSD_XGB_SUM_B5" ("KEY", "Score_0", "Score_1", "Score_2", "Score_3") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1", "U"."Score_2", "U"."Score_3" 
...
-- Code For temporary table 29233100_6EA9HL_XGB_SUM_B6 part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE "29233100_6EA9HL_XGB_SUM_B6" (
	"KEY" NUMBER(19), 
	"Score_0" BINARY_DOUBLE, 
	"Score_1" BINARY_DOUBLE, 
	"Score_2" BINARY_DOUBLE, 
 ...
 ON COMMIT PRESERVE ROWS
-- Code For temporary table 29233100_6EA9HL_XGB_SUM_B6 part 2/2. Populate

INSERT INTO "29233100_6EA9HL_XGB_SUM_B6" ("KEY", "Score_0", "Score_1", "Score_2", "Score_3") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1", "U"."Score_2", "U"."Score_3" 
...
-- Code For temporary table 33100_490MOZ_XGB_SUM_UNION part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE "33100_490MOZ_XGB_SUM_UNION" (
	"KEY" NUMBER(19), 
	"Score_0" BINARY_DOUBLE, 
	"Score_1" BINARY_DOUBLE, 
	"Score_2" BINARY_DOUBLE, 
 ...
 ON COMMIT PRESERVE ROWS
-- Code For temporary table 33100_490MOZ_XGB_SUM_UNION part 2/2. Populate

INSERT INTO "33100_490MOZ_XGB_SUM_UNION" ("KEY", "Score_0", "Score_1", "Score_2", "Score_3") SELECT "U"."KEY", "U"."Score_0", "U"."Score_1", "U"."Score_2", "U"."Score_3" 
...
FROM "29233100_MBE26I_XGB_SUM_B0" "XGB_Sum_B0" UNION ALL SELECT "XGB_Sum_B1"."KEY" AS "KEY", "XGB_Sum_B1"."Score_0" AS "Score_0", "XGB_Sum_B1"."Score_1" AS "Score_1", "XGB_Sum_B1"."Score_2" AS "Score_2", "XGB_Sum_B1"."Score_3" AS "Score_3" 
FROM "29233100_532EDN_XGB_SUM_B1" "XGB_Sum_B1" UNION ALL SELECT "XGB_Sum_B2"."KEY" AS "KEY", "XGB_Sum_B2"."Score_0" AS "Score_0", "XGB_Sum_B2"."Score_1" AS "Score_1", "XGB_Sum_B2"."Score_2" AS "Score_2", "XGB_Sum_B2"."Score_3" AS "Score_3" 
FROM "29233100_M906M8_XGB_SUM_B2" "XGB_Sum_B2" UNION ALL SELECT "XGB_Sum_B3"."KEY" AS "KEY", "XGB_Sum_B3"."Score_0" AS "Score_0", "XGB_Sum_B3"."Score_1" AS "Score_1", "XGB_Sum_B3"."Score_2" AS "Score_2", "XGB_Sum_B3"."Score_3" AS "Score_3" 
FROM "29233100_PLNC3T_XGB_SUM_B3" "XGB_Sum_B3" UNION ALL SELECT "XGB_Sum_B4"."KEY" AS "KEY", "XGB_Sum_B4"."Score_0" AS "Score_0", "XGB_Sum_B4"."Score_1" AS "Score_1", "XGB_Sum_B4"."Score_2" AS "Score_2", "XGB_Sum_B4"."Score_3" AS "Score_3" 
FROM "29233100_XO7QYQ_XGB_SUM_B4" "XGB_Sum_B4" UNION ALL SELECT "XGB_Sum_B5"."KEY" AS "KEY", "XGB_Sum_B5"."Score_0" AS "Score_0", "XGB_Sum_B5"."Score_1" AS "Score_1", "XGB_Sum_B5"."Score_2" AS "Score_2", "XGB_Sum_B5"."Score_3" AS "Score_3" 
FROM "29233100_J1JGSD_XGB_SUM_B5" "XGB_Sum_B5" UNION ALL SELECT "XGB_Sum_B6"."KEY" AS "KEY", "XGB_Sum_B6"."Score_0" AS "Score_0", "XGB_Sum_B6"."Score_1" AS "Score_1", "XGB_Sum_B6"."Score_2" AS "Score_2", "XGB_Sum_B6"."Score_3" AS "Score_3" 
FROM "29233100_6EA9HL_XGB_SUM_B6" "XGB_Sum_B6") "XGB_Sum_EnsembleUnion") "XGB_Sum_Union") "U"
...
FROM "33100_490MOZ_XGB_SUM_UNION" "XGB_Sum_Union" GROUP BY "XGB_Sum_Union"."KEY") "T"), 
orig_cte AS 
