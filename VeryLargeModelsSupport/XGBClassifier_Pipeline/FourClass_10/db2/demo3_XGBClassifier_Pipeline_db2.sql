...
FROM "DT_Output_9"), 
"XGB_Sum_B0" AS 
(SELECT "XGB_Sum_esu_0"."KEY" AS "KEY", "XGB_Sum_esu_0"."Score_0" AS "Score_0", "XGB_Sum_esu_0"."Score_1" AS "Score_1", "XGB_Sum_esu_0"."Score_2" AS "Score_2", "XGB_Sum_esu_0"."Score_3" AS "Score_3" 
...
FROM "XGB_Tree_1_2") AS "XGB_Sum_esu_0"), 
...
FROM "DT_Output_19"), 
"XGB_Sum_B1" AS 
(SELECT "XGB_Sum_esu_1"."KEY" AS "KEY", "XGB_Sum_esu_1"."Score_0" AS "Score_0", "XGB_Sum_esu_1"."Score_1" AS "Score_1", "XGB_Sum_esu_1"."Score_2" AS "Score_2", "XGB_Sum_esu_1"."Score_3" AS "Score_3" 
...
FROM "XGB_Tree_3_4") AS "XGB_Sum_esu_1"), 
...
FROM "DT_Output_29"), 
"XGB_Sum_B2" AS 
(SELECT "XGB_Sum_esu_2"."KEY" AS "KEY", "XGB_Sum_esu_2"."Score_0" AS "Score_0", "XGB_Sum_esu_2"."Score_1" AS "Score_1", "XGB_Sum_esu_2"."Score_2" AS "Score_2", "XGB_Sum_esu_2"."Score_3" AS "Score_3" 
...
FROM "XGB_Tree_1_7") AS "XGB_Sum_esu_2"), 
...
FROM "DT_Output_39"), 
"XGB_Sum_B3" AS 
(SELECT "XGB_Sum_esu_3"."KEY" AS "KEY", "XGB_Sum_esu_3"."Score_0" AS "Score_0", "XGB_Sum_esu_3"."Score_1" AS "Score_1", "XGB_Sum_esu_3"."Score_2" AS "Score_2", "XGB_Sum_esu_3"."Score_3" AS "Score_3" 
...
FROM "XGB_Tree_3_9") AS "XGB_Sum_esu_3"), 
...
FROM "DT_Output_49"), 
"XGB_Sum_B4" AS 
(SELECT "XGB_Sum_esu_4"."KEY" AS "KEY", "XGB_Sum_esu_4"."Score_0" AS "Score_0", "XGB_Sum_esu_4"."Score_1" AS "Score_1", "XGB_Sum_esu_4"."Score_2" AS "Score_2", "XGB_Sum_esu_4"."Score_3" AS "Score_3" 
...
FROM "XGB_Tree_1_12") AS "XGB_Sum_esu_4"), 
...
FROM "DT_Output_59"), 
"XGB_Sum_B5" AS 
(SELECT "XGB_Sum_esu_5"."KEY" AS "KEY", "XGB_Sum_esu_5"."Score_0" AS "Score_0", "XGB_Sum_esu_5"."Score_1" AS "Score_1", "XGB_Sum_esu_5"."Score_2" AS "Score_2", "XGB_Sum_esu_5"."Score_3" AS "Score_3" 
...
FROM "XGB_Tree_3_14") AS "XGB_Sum_esu_5"), 
...
FROM "DT_Output_63"), 
"XGB_Sum_B6" AS 
(SELECT "XGB_Sum_esu_6"."KEY" AS "KEY", "XGB_Sum_esu_6"."Score_0" AS "Score_0", "XGB_Sum_esu_6"."Score_1" AS "Score_1", "XGB_Sum_esu_6"."Score_2" AS "Score_2", "XGB_Sum_esu_6"."Score_3" AS "Score_3" 
...
FROM "XGB_Tree_3_15") AS "XGB_Sum_esu_6"), 
"XGB_Sum_Union" AS 
(SELECT "XGB_Sum_EnsembleUnion"."KEY" AS "KEY", "XGB_Sum_EnsembleUnion"."Score_0" AS "Score_0", "XGB_Sum_EnsembleUnion"."Score_1" AS "Score_1", "XGB_Sum_EnsembleUnion"."Score_2" AS "Score_2", "XGB_Sum_EnsembleUnion"."Score_3" AS "Score_3" 
...
FROM "XGB_Sum_B0" UNION ALL SELECT "XGB_Sum_B1"."KEY" AS "KEY", "XGB_Sum_B1"."Score_0" AS "Score_0", "XGB_Sum_B1"."Score_1" AS "Score_1", "XGB_Sum_B1"."Score_2" AS "Score_2", "XGB_Sum_B1"."Score_3" AS "Score_3" 
FROM "XGB_Sum_B1" UNION ALL SELECT "XGB_Sum_B2"."KEY" AS "KEY", "XGB_Sum_B2"."Score_0" AS "Score_0", "XGB_Sum_B2"."Score_1" AS "Score_1", "XGB_Sum_B2"."Score_2" AS "Score_2", "XGB_Sum_B2"."Score_3" AS "Score_3" 
FROM "XGB_Sum_B2" UNION ALL SELECT "XGB_Sum_B3"."KEY" AS "KEY", "XGB_Sum_B3"."Score_0" AS "Score_0", "XGB_Sum_B3"."Score_1" AS "Score_1", "XGB_Sum_B3"."Score_2" AS "Score_2", "XGB_Sum_B3"."Score_3" AS "Score_3" 
FROM "XGB_Sum_B3" UNION ALL SELECT "XGB_Sum_B4"."KEY" AS "KEY", "XGB_Sum_B4"."Score_0" AS "Score_0", "XGB_Sum_B4"."Score_1" AS "Score_1", "XGB_Sum_B4"."Score_2" AS "Score_2", "XGB_Sum_B4"."Score_3" AS "Score_3" 
FROM "XGB_Sum_B4" UNION ALL SELECT "XGB_Sum_B5"."KEY" AS "KEY", "XGB_Sum_B5"."Score_0" AS "Score_0", "XGB_Sum_B5"."Score_1" AS "Score_1", "XGB_Sum_B5"."Score_2" AS "Score_2", "XGB_Sum_B5"."Score_3" AS "Score_3" 
FROM "XGB_Sum_B5" UNION ALL SELECT "XGB_Sum_B6"."KEY" AS "KEY", "XGB_Sum_B6"."Score_0" AS "Score_0", "XGB_Sum_B6"."Score_1" AS "Score_1", "XGB_Sum_B6"."Score_2" AS "Score_2", "XGB_Sum_B6"."Score_3" AS "Score_3" 
FROM "XGB_Sum_B6") AS "XGB_Sum_EnsembleUnion"), 
"XGB_Sum_sum" AS 
(SELECT "T"."KEY" AS "KEY", "T"."Score_0" AS "Score_0", "T"."Score_1" AS "Score_1", "T"."Score_2" AS "Score_2", "T"."Score_3" AS "Score_3" 
FROM (SELECT "XGB_Sum_Union"."KEY" AS "KEY", sum(CAST("XGB_Sum_Union"."Score_0" AS DOUBLE)) AS "Score_0", sum(CAST("XGB_Sum_Union"."Score_1" AS DOUBLE)) AS "Score_1", sum(CAST("XGB_Sum_Union"."Score_2" AS DOUBLE)) AS "Score_2", sum(CAST("XGB_Sum_Union"."Score_3" AS DOUBLE)) AS "Score_3" 
FROM "XGB_Sum_Union" GROUP BY "XGB_Sum_Union"."KEY") AS "T"), 
orig_cte AS 
(SELECT "XGB_Sum_sum"."KEY" AS "KEY", "XGB_Sum_sum"."Score_0" AS "Score_0", "XGB_Sum_sum"."Score_1" AS "Score_1", "XGB_Sum_sum"."Score_2" AS "Score_2", "XGB_Sum_sum"."Score_3" AS "Score_3", CAST(NULL AS DOUBLE) AS "Proba_0", CAST(NULL AS DOUBLE) AS "Proba_1", CAST(NULL AS DOUBLE) AS "Proba_2", CAST(NULL AS DOUBLE) AS "Proba_3", CAST(NULL AS DOUBLE) AS "LogProba_0", CAST(NULL AS DOUBLE) AS "LogProba_1", CAST(NULL AS DOUBLE) AS "LogProba_2", CAST(NULL AS DOUBLE) AS "LogProba_3", NULL AS "Decision", CAST(NULL AS DOUBLE) AS "DecisionProba" 
FROM "XGB_Sum_sum"), 
