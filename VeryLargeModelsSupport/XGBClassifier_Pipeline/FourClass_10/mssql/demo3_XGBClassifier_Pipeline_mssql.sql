...
-- Code For temporary table ##TMP_20180329233100_AUNXNX_ADS_imp_1_OUT part 1/2. Create 


CREATE TABLE ##TMP_20180329233100_AUNXNX_ADS_imp_1_OUT (
	[KEY] BIGINT NULL, 
...
-- Code For temporary table ##TMP_20180329233100_AUNXNX_ADS_imp_1_OUT part 2/2. Populate

INSERT INTO ##TMP_20180329233100_AUNXNX_ADS_imp_1_OUT ([KEY], impter_2, impter_3, impter_4, impter_5, impter_6, impter_7, impter_8, impter_9, impter_10, impter_11) SELECT [ADS_imp_1_OUT].[KEY], [ADS_imp_1_OUT].impter_2, [ADS_imp_1_OUT].impter_3, [ADS_imp_1_OUT].impter_4, [ADS_imp_1_OUT].impter_5, [ADS_imp_1_OUT].impter_6, [ADS_imp_1_OUT].impter_7, [ADS_imp_1_OUT].impter_8, [ADS_imp_1_OUT].impter_9, [ADS_imp_1_OUT].impter_10, [ADS_imp_1_OUT].impter_11 
...
-- Code For temporary table ##TMP_20180329233100_A5LHYH_ADS_sca_2_OUT part 1/2. Create 


CREATE TABLE ##TMP_20180329233100_A5LHYH_ADS_sca_2_OUT (
	[KEY] BIGINT NULL, 
	scaler_2 FLOAT NULL, 
	scaler_3 FLOAT NULL, 
	scaler_4 FLOAT NULL, 
...
FROM ##TMP_20180329233100_AUNXNX_ADS_imp_1_OUT AS [ADS_imp_1_OUT]) AS [ADS_sca_2_OUT]
-- Code For temporary table ##TMP_20180329233101_087E0Y_XGB_Sum_B0 part 1/2. Create 


CREATE TABLE ##TMP_20180329233101_087E0Y_XGB_Sum_B0 (
	[KEY] BIGINT NULL, 
...
-- Code For temporary table ##TMP_20180329233101_087E0Y_XGB_Sum_B0 part 2/2. Populate

WITH [DT_node_lookup] AS 
(SELECT [ADS_sca_2_OUT].[KEY] AS [KEY], CASE WHEN ([ADS_sca_2_OUT].scaler_6 < 0.055714450776576996) THEN 1 ELSE 2 END AS node_id_2 
FROM ##TMP_20180329233100_A5LHYH_ADS_sca_2_OUT AS [ADS_sca_2_OUT]), 
[DT_node_data] AS 
...
FROM (SELECT 1 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 1 AS depth, 0 AS parent_id, -0.05234899744391441 AS [Score] UNION ALL SELECT 2 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 1 AS depth, 0 AS parent_id, 0.0579439215362072 AS [Score]) AS [Values]), 
[DT_Output] AS 
...
[DT_node_data_1] AS 
(SELECT [Values].node_id AS node_id, [Values].feature AS feature, [Values].threshold AS threshold, [Values].depth AS depth, [Values].parent_id AS parent_id, [Values].[Score] AS [Score] 
FROM (SELECT 1 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 1 AS depth, 0 AS parent_id, -0.05734265595674515 AS [Score] UNION ALL SELECT 2 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 1 AS depth, 0 AS parent_id, 0.07256637513637543 AS [Score]) AS [Values]), 
[DT_Output_1] AS 
...
[DT_node_data_2] AS 
(SELECT [Values].node_id AS node_id, [Values].feature AS feature, [Values].threshold AS threshold, [Values].depth AS depth, [Values].parent_id AS parent_id, [Values].[Score] AS [Score] 
FROM (SELECT 1 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 1 AS depth, 0 AS parent_id, 0.04335664212703705 AS [Score] UNION ALL SELECT 2 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 1 AS depth, 0 AS parent_id, -0.05486725643277168 AS [Score]) AS [Values]), 
[DT_Output_2] AS 
...
[DT_node_data_3] AS 
(SELECT [Values].node_id AS node_id, [Values].feature AS feature, [Values].threshold AS threshold, [Values].depth AS depth, [Values].parent_id AS parent_id, [Values].[Score] AS [Score] 
FROM (SELECT 1 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 1 AS depth, 0 AS parent_id, 0.0625 AS [Score] UNION ALL SELECT 2 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 1 AS depth, 0 AS parent_id, -0.05000000074505806 AS [Score]) AS [Values]), 
[DT_Output_3] AS 
...
[DT_node_data_4] AS 
(SELECT [Values].node_id AS node_id, [Values].feature AS feature, [Values].threshold AS threshold, [Values].depth AS depth, [Values].parent_id AS parent_id, [Values].[Score] AS [Score] 
FROM (SELECT 1 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 1 AS depth, 0 AS parent_id, -0.050926752388477325 AS [Score] UNION ALL SELECT 2 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 1 AS depth, 0 AS parent_id, 0.053195446729660034 AS [Score]) AS [Values]), 
[DT_Output_4] AS 
...
[DT_node_data_5] AS 
(SELECT [Values].node_id AS node_id, [Values].feature AS feature, [Values].threshold AS threshold, [Values].depth AS depth, [Values].parent_id AS parent_id, [Values].[Score] AS [Score] 
FROM (SELECT 1 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 1 AS depth, 0 AS parent_id, -0.061356544494628906 AS [Score] UNION ALL SELECT 2 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 1 AS depth, 0 AS parent_id, 0.060008227825164795 AS [Score]) AS [Values]), 
[DT_Output_5] AS 
...
[DT_node_data_6] AS 
(SELECT [Values].node_id AS node_id, [Values].feature AS feature, [Values].threshold AS threshold, [Values].depth AS depth, [Values].parent_id AS parent_id, [Values].[Score] AS [Score] 
FROM (SELECT 1 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 1 AS depth, 0 AS parent_id, 0.03996139392256737 AS [Score] UNION ALL SELECT 2 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 1 AS depth, 0 AS parent_id, -0.05349121615290642 AS [Score]) AS [Values]), 
[DT_Output_6] AS 
...
[DT_node_data_7] AS 
(SELECT [Values].node_id AS node_id, [Values].feature AS feature, [Values].threshold AS threshold, [Values].depth AS depth, [Values].parent_id AS parent_id, [Values].[Score] AS [Score] 
FROM (SELECT 1 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 1 AS depth, 0 AS parent_id, 0.057209331542253494 AS [Score] UNION ALL SELECT 2 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 1 AS depth, 0 AS parent_id, -0.04868779703974724 AS [Score]) AS [Values]), 
[DT_Output_7] AS 
...
[DT_node_data_8] AS 
(SELECT [Values].node_id AS node_id, [Values].feature AS feature, [Values].threshold AS threshold, [Values].depth AS depth, [Values].parent_id AS parent_id, [Values].[Score] AS [Score] 
FROM (SELECT 1 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 1 AS depth, 0 AS parent_id, -0.049572717398405075 AS [Score] UNION ALL SELECT 2 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 1 AS depth, 0 AS parent_id, 0.04905882850289345 AS [Score]) AS [Values]), 
[DT_Output_8] AS 
...
[DT_node_data_9] AS 
(SELECT [Values].node_id AS node_id, [Values].feature AS feature, [Values].threshold AS threshold, [Values].depth AS depth, [Values].parent_id AS parent_id, [Values].[Score] AS [Score] 
FROM (SELECT 1 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 1 AS depth, 0 AS parent_id, -0.06014169380068779 AS [Score] UNION ALL SELECT 2 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 1 AS depth, 0 AS parent_id, 0.05473605915904045 AS [Score]) AS [Values]), 
[DT_Output_9] AS 
...
FROM [DT_Output_9])
 INSERT INTO ##TMP_20180329233101_087E0Y_XGB_Sum_B0 ([KEY], [Score_0], [Score_1], [Score_2], [Score_3]) SELECT [XGB_Sum_B0].[KEY], [XGB_Sum_B0].[Score_0], [XGB_Sum_B0].[Score_1], [XGB_Sum_B0].[Score_2], [XGB_Sum_B0].[Score_3] 
...
-- Code For temporary table ##TMP_20180329233101_2XV46L_XGB_Sum_B1 part 1/2. Create 


CREATE TABLE ##TMP_20180329233101_2XV46L_XGB_Sum_B1 (
	[KEY] BIGINT NULL, 
	[Score_0] FLOAT(53) NULL, 
	[Score_1] FLOAT(53) NULL, 
	[Score_2] FLOAT(53) NULL, 
...
-- Code For temporary table ##TMP_20180329233101_2XV46L_XGB_Sum_B1 part 2/2. Populate
...
[DT_node_data_10] AS 
(SELECT [Values].node_id AS node_id, [Values].feature AS feature, [Values].threshold AS threshold, [Values].depth AS depth, [Values].parent_id AS parent_id, [Values].[Score] AS [Score] 
FROM (SELECT 1 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 1 AS depth, 0 AS parent_id, -0.03426593914628029 AS [Score] UNION ALL SELECT 2 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 1 AS depth, 0 AS parent_id, 0.06422977894544601 AS [Score]) AS [Values]), 
[DT_Output_10] AS 
...
[DT_node_data_11] AS 
(SELECT [Values].node_id AS node_id, [Values].feature AS feature, [Values].threshold AS threshold, [Values].depth AS depth, [Values].parent_id AS parent_id, [Values].[Score] AS [Score] 
FROM (SELECT 1 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 1 AS depth, 0 AS parent_id, 0.052696116268634796 AS [Score] UNION ALL SELECT 2 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 1 AS depth, 0 AS parent_id, -0.047444455325603485 AS [Score]) AS [Values]), 
[DT_Output_11] AS 
...
[DT_node_data_12] AS 
(SELECT [Values].node_id AS node_id, [Values].feature AS feature, [Values].threshold AS threshold, [Values].depth AS depth, [Values].parent_id AS parent_id, [Values].[Score] AS [Score] 
FROM (SELECT 1 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 1 AS depth, 0 AS parent_id, -0.04834137111902237 AS [Score] UNION ALL SELECT 2 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 1 AS depth, 0 AS parent_id, 0.04559355229139328 AS [Score]) AS [Values]), 
[DT_Output_12] AS 
...
[DT_node_data_13] AS 
(SELECT [Values].node_id AS node_id, [Values].feature AS feature, [Values].threshold AS threshold, [Values].depth AS depth, [Values].parent_id AS parent_id, [Values].[Score] AS [Score] 
FROM (SELECT 1 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 1 AS depth, 0 AS parent_id, -0.05901144817471504 AS [Score] UNION ALL SELECT 2 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 1 AS depth, 0 AS parent_id, 0.04992173984646797 AS [Score]) AS [Values]), 
[DT_Output_13] AS 
...
[DT_node_data_14] AS 
(SELECT [Values].node_id AS node_id, [Values].feature AS feature, [Values].threshold AS threshold, [Values].depth AS depth, [Values].parent_id AS parent_id, [Values].[Score] AS [Score] 
FROM (SELECT 1 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 1 AS depth, 0 AS parent_id, 0.06350211799144745 AS [Score] UNION ALL SELECT 2 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 1 AS depth, 0 AS parent_id, -0.0336780808866024 AS [Score]) AS [Values]), 
[DT_Output_14] AS 
...
[DT_node_data_15] AS 
(SELECT [Values].node_id AS node_id, [Values].feature AS feature, [Values].threshold AS threshold, [Values].depth AS depth, [Values].parent_id AS parent_id, [Values].[Score] AS [Score] 
FROM (SELECT 1 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 1 AS depth, 0 AS parent_id, 0.04889610782265663 AS [Score] UNION ALL SELECT 2 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 1 AS depth, 0 AS parent_id, -0.04631924256682396 AS [Score]) AS [Values]), 
[DT_Output_15] AS 
...
[DT_node_data_16] AS 
(SELECT [Values].node_id AS node_id, [Values].feature AS feature, [Values].threshold AS threshold, [Values].depth AS depth, [Values].parent_id AS parent_id, [Values].[Score] AS [Score] 
FROM (SELECT 1 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 1 AS depth, 0 AS parent_id, 0.04237661510705948 AS [Score] UNION ALL SELECT 2 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 1 AS depth, 0 AS parent_id, -0.04944697022438049 AS [Score]) AS [Values]), 
[DT_Output_16] AS 
...
[DT_node_data_17] AS 
(SELECT [Values].node_id AS node_id, [Values].feature AS feature, [Values].threshold AS threshold, [Values].depth AS depth, [Values].parent_id AS parent_id, [Values].[Score] AS [Score] 
FROM (SELECT 1 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 1 AS depth, 0 AS parent_id, -0.052571412175893784 AS [Score] UNION ALL SELECT 2 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 1 AS depth, 0 AS parent_id, 0.05052562430500984 AS [Score]) AS [Values]), 
[DT_Output_17] AS 
...
[DT_node_data_18] AS 
(SELECT [Values].node_id AS node_id, [Values].feature AS feature, [Values].threshold AS threshold, [Values].depth AS depth, [Values].parent_id AS parent_id, [Values].[Score] AS [Score] 
FROM (SELECT 1 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 1 AS depth, 0 AS parent_id, 0.058749761432409286 AS [Score] UNION ALL SELECT 2 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 1 AS depth, 0 AS parent_id, -0.03251056745648384 AS [Score]) AS [Values]), 
[DT_Output_18] AS 
...
[DT_node_data_19] AS 
(SELECT [Values].node_id AS node_id, [Values].feature AS feature, [Values].threshold AS threshold, [Values].depth AS depth, [Values].parent_id AS parent_id, [Values].[Score] AS [Score] 
FROM (SELECT 1 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 1 AS depth, 0 AS parent_id, -0.05416066199541092 AS [Score] UNION ALL SELECT 2 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 1 AS depth, 0 AS parent_id, 0.04157326743006706 AS [Score]) AS [Values]), 
[DT_Output_19] AS 
...
FROM [DT_Output_19])
 INSERT INTO ##TMP_20180329233101_2XV46L_XGB_Sum_B1 ([KEY], [Score_0], [Score_1], [Score_2], [Score_3]) SELECT [XGB_Sum_B1].[KEY], [XGB_Sum_B1].[Score_0], [XGB_Sum_B1].[Score_1], [XGB_Sum_B1].[Score_2], [XGB_Sum_B1].[Score_3] 
...
-- Code For temporary table ##TMP_20180329233101_PE0X60_XGB_Sum_B2 part 1/2. Create 


CREATE TABLE ##TMP_20180329233101_PE0X60_XGB_Sum_B2 (
	[KEY] BIGINT NULL, 
	[Score_0] FLOAT(53) NULL, 
	[Score_1] FLOAT(53) NULL, 
	[Score_2] FLOAT(53) NULL, 
...
-- Code For temporary table ##TMP_20180329233101_PE0X60_XGB_Sum_B2 part 2/2. Populate
...
[DT_node_data_20] AS 
(SELECT [Values].node_id AS node_id, [Values].feature AS feature, [Values].threshold AS threshold, [Values].depth AS depth, [Values].parent_id AS parent_id, [Values].[Score] AS [Score] 
FROM (SELECT 1 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 1 AS depth, 0 AS parent_id, -0.046829257160425186 AS [Score] UNION ALL SELECT 2 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 1 AS depth, 0 AS parent_id, 0.042319949716329575 AS [Score]) AS [Values]), 
[DT_Output_20] AS 
...
[DT_node_data_21] AS 
(SELECT [Values].node_id AS node_id, [Values].feature AS feature, [Values].threshold AS threshold, [Values].depth AS depth, [Values].parent_id AS parent_id, [Values].[Score] AS [Score] 
FROM (SELECT 1 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 1 AS depth, 0 AS parent_id, -0.05705375596880913 AS [Score] UNION ALL SELECT 2 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 1 AS depth, 0 AS parent_id, 0.04210996255278587 AS [Score]) AS [Values]), 
[DT_Output_21] AS 
...
[DT_node_data_22] AS 
(SELECT [Values].node_id AS node_id, [Values].feature AS feature, [Values].threshold AS threshold, [Values].depth AS depth, [Values].parent_id AS parent_id, [Values].[Score] AS [Score] 
FROM (SELECT 1 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 1 AS depth, 0 AS parent_id, 0.05940497666597366 AS [Score] UNION ALL SELECT 2 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 1 AS depth, 0 AS parent_id, -0.032234277576208115 AS [Score]) AS [Values]), 
[DT_Output_22] AS 
...
[DT_node_data_23] AS 
(SELECT [Values].node_id AS node_id, [Values].feature AS feature, [Values].threshold AS threshold, [Values].depth AS depth, [Values].parent_id AS parent_id, [Values].[Score] AS [Score] 
FROM (SELECT 1 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 1 AS depth, 0 AS parent_id, 0.045328617095947266 AS [Score] UNION ALL SELECT 2 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 1 AS depth, 0 AS parent_id, -0.04538597911596298 AS [Score]) AS [Values]), 
[DT_Output_23] AS 
...
[DT_node_data_24] AS 
(SELECT [Values].node_id AS node_id, [Values].feature AS feature, [Values].threshold AS threshold, [Values].depth AS depth, [Values].parent_id AS parent_id, [Values].[Score] AS [Score] 
FROM (SELECT 1 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 1 AS depth, 0 AS parent_id, 0.039290837943553925 AS [Score] UNION ALL SELECT 2 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 1 AS depth, 0 AS parent_id, -0.04788238927721977 AS [Score]) AS [Values]), 
[DT_Output_24] AS 
...
[DT_node_data_25] AS 
(SELECT [Values].node_id AS node_id, [Values].feature AS feature, [Values].threshold AS threshold, [Values].depth AS depth, [Values].parent_id AS parent_id, [Values].[Score] AS [Score] 
FROM (SELECT 1 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 1 AS depth, 0 AS parent_id, -0.056167203933000565 AS [Score] UNION ALL SELECT 2 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 1 AS depth, 0 AS parent_id, 0.0387209914624691 AS [Score]) AS [Values]), 
[DT_Output_25] AS 
...
[DT_node_data_26] AS 
(SELECT [Values].node_id AS node_id, [Values].feature AS feature, [Values].threshold AS threshold, [Values].depth AS depth, [Values].parent_id AS parent_id, [Values].[Score] AS [Score] 
FROM (SELECT 1 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 1 AS depth, 0 AS parent_id, 0.05543717369437218 AS [Score] UNION ALL SELECT 2 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 1 AS depth, 0 AS parent_id, -0.031157618388533592 AS [Score]) AS [Values]), 
[DT_Output_26] AS 
...
[DT_node_data_27] AS 
(SELECT [Values].node_id AS node_id, [Values].feature AS feature, [Values].threshold AS threshold, [Values].depth AS depth, [Values].parent_id AS parent_id, [Values].[Score] AS [Score] 
FROM (SELECT 1 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 1 AS depth, 0 AS parent_id, -0.05286213383078575 AS [Score] UNION ALL SELECT 2 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 1 AS depth, 0 AS parent_id, 0.038254350423812866 AS [Score]) AS [Values]), 
[DT_Output_27] AS 
...
[DT_node_data_28] AS 
(SELECT [Values].node_id AS node_id, [Values].feature AS feature, [Values].threshold AS threshold, [Values].depth AS depth, [Values].parent_id AS parent_id, [Values].[Score] AS [Score] 
FROM (SELECT 1 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 1 AS depth, 0 AS parent_id, -0.045463137328624725 AS [Score] UNION ALL SELECT 2 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 1 AS depth, 0 AS parent_id, 0.039555009454488754 AS [Score]) AS [Values]), 
[DT_Output_28] AS 
...
[DT_node_data_29] AS 
(SELECT [Values].node_id AS node_id, [Values].feature AS feature, [Values].threshold AS threshold, [Values].depth AS depth, [Values].parent_id AS parent_id, [Values].[Score] AS [Score] 
FROM (SELECT 1 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 1 AS depth, 0 AS parent_id, -0.055302590131759644 AS [Score] UNION ALL SELECT 2 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 1 AS depth, 0 AS parent_id, 0.03555578365921974 AS [Score]) AS [Values]), 
[DT_Output_29] AS 
...
FROM [DT_Output_29])
 INSERT INTO ##TMP_20180329233101_PE0X60_XGB_Sum_B2 ([KEY], [Score_0], [Score_1], [Score_2], [Score_3]) SELECT [XGB_Sum_B2].[KEY], [XGB_Sum_B2].[Score_0], [XGB_Sum_B2].[Score_1], [XGB_Sum_B2].[Score_2], [XGB_Sum_B2].[Score_3] 
...
-- Code For temporary table ##TMP_20180329233101_LUMDDU_XGB_Sum_B3 part 1/2. Create 


CREATE TABLE ##TMP_20180329233101_LUMDDU_XGB_Sum_B3 (
	[KEY] BIGINT NULL, 
	[Score_0] FLOAT(53) NULL, 
	[Score_1] FLOAT(53) NULL, 
	[Score_2] FLOAT(53) NULL, 
...
-- Code For temporary table ##TMP_20180329233101_LUMDDU_XGB_Sum_B3 part 2/2. Populate
...
[DT_node_data_30] AS 
(SELECT [Values].node_id AS node_id, [Values].feature AS feature, [Values].threshold AS threshold, [Values].depth AS depth, [Values].parent_id AS parent_id, [Values].[Score] AS [Score] 
FROM (SELECT 1 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 1 AS depth, 0 AS parent_id, 0.05650178715586662 AS [Score] UNION ALL SELECT 2 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 1 AS depth, 0 AS parent_id, -0.0309823639690876 AS [Score]) AS [Values]), 
[DT_Output_30] AS 
...
[DT_node_data_31] AS 
(SELECT [Values].node_id AS node_id, [Values].feature AS feature, [Values].threshold AS threshold, [Values].depth AS depth, [Values].parent_id AS parent_id, [Values].[Score] AS [Score] 
FROM (SELECT 1 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 1 AS depth, 0 AS parent_id, 0.04246804490685463 AS [Score] UNION ALL SELECT 2 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 1 AS depth, 0 AS parent_id, -0.04452360048890114 AS [Score]) AS [Values]), 
[DT_Output_31] AS 
...
[DT_node_data_32] AS 
(SELECT [Values].node_id AS node_id, [Values].feature AS feature, [Values].threshold AS threshold, [Values].depth AS depth, [Values].parent_id AS parent_id, [Values].[Score] AS [Score] 
FROM (SELECT 1 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 1 AS depth, 0 AS parent_id, 0.036594901233911514 AS [Score] UNION ALL SELECT 2 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 1 AS depth, 0 AS parent_id, -0.04641127213835716 AS [Score]) AS [Values]), 
[DT_Output_32] AS 
...
[DT_node_data_33] AS 
(SELECT [Values].node_id AS node_id, [Values].feature AS feature, [Values].threshold AS threshold, [Values].depth AS depth, [Values].parent_id AS parent_id, [Values].[Score] AS [Score] 
FROM (SELECT 1 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 1 AS depth, 0 AS parent_id, -0.054527152329683304 AS [Score] UNION ALL SELECT 2 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 1 AS depth, 0 AS parent_id, 0.0328013151884079 AS [Score]) AS [Values]), 
[DT_Output_33] AS 
...
[DT_node_data_34] AS 
(SELECT [Values].node_id AS node_id, [Values].feature AS feature, [Values].threshold AS threshold, [Values].depth AS depth, [Values].parent_id AS parent_id, [Values].[Score] AS [Score] 
FROM (SELECT 1 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 1 AS depth, 0 AS parent_id, 0.0530412457883358 AS [Score] UNION ALL SELECT 2 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 1 AS depth, 0 AS parent_id, -0.029953250661492348 AS [Score]) AS [Values]), 
[DT_Output_34] AS 
...
[DT_node_data_35] AS 
(SELECT [Values].node_id AS node_id, [Values].feature AS feature, [Values].threshold AS threshold, [Values].depth AS depth, [Values].parent_id AS parent_id, [Values].[Score] AS [Score] 
FROM (SELECT 1 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 1 AS depth, 0 AS parent_id, -0.0515601821243763 AS [Score] UNION ALL SELECT 2 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 1 AS depth, 0 AS parent_id, 0.03540695831179619 AS [Score]) AS [Values]), 
[DT_Output_35] AS 
...
[DT_node_data_36] AS 
(SELECT [Values].node_id AS node_id, [Values].feature AS feature, [Values].threshold AS threshold, [Values].depth AS depth, [Values].parent_id AS parent_id, [Values].[Score] AS [Score] 
FROM (SELECT 1 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 1 AS depth, 0 AS parent_id, -0.04417154937982559 AS [Score] UNION ALL SELECT 2 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 1 AS depth, 0 AS parent_id, 0.03703683614730835 AS [Score]) AS [Values]), 
[DT_Output_36] AS 
...
[DT_node_data_37] AS 
(SELECT [Values].node_id AS node_id, [Values].feature AS feature, [Values].threshold AS threshold, [Values].depth AS depth, [Values].parent_id AS parent_id, [Values].[Score] AS [Score] 
FROM (SELECT 1 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 1 AS depth, 0 AS parent_id, -0.048233576118946075 AS [Score] UNION ALL SELECT 2 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 1 AS depth, 0 AS parent_id, 0.03405338525772095 AS [Score]) AS [Values]), 
[DT_Output_37] AS 
...
[DT_node_data_38] AS 
(SELECT [Values].node_id AS node_id, [Values].feature AS feature, [Values].threshold AS threshold, [Values].depth AS depth, [Values].parent_id AS parent_id, [Values].[Score] AS [Score] 
FROM (SELECT 1 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 1 AS depth, 0 AS parent_id, 0.04943091422319412 AS [Score] UNION ALL SELECT 2 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 1 AS depth, 0 AS parent_id, -0.028796164318919182 AS [Score]) AS [Values]), 
[DT_Output_38] AS 
...
[DT_node_data_39] AS 
(SELECT [Values].node_id AS node_id, [Values].feature AS feature, [Values].threshold AS threshold, [Values].depth AS depth, [Values].parent_id AS parent_id, [Values].[Score] AS [Score] 
FROM (SELECT 1 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 1 AS depth, 0 AS parent_id, 0.04011039063334465 AS [Score] UNION ALL SELECT 2 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 1 AS depth, 0 AS parent_id, -0.043712954968214035 AS [Score]) AS [Values]), 
[DT_Output_39] AS 
...
FROM [DT_Output_39])
 INSERT INTO ##TMP_20180329233101_LUMDDU_XGB_Sum_B3 ([KEY], [Score_0], [Score_1], [Score_2], [Score_3]) SELECT [XGB_Sum_B3].[KEY], [XGB_Sum_B3].[Score_0], [XGB_Sum_B3].[Score_1], [XGB_Sum_B3].[Score_2], [XGB_Sum_B3].[Score_3] 
...
-- Code For temporary table ##TMP_20180329233101_XQ5D39_XGB_Sum_B4 part 1/2. Create 


CREATE TABLE ##TMP_20180329233101_XQ5D39_XGB_Sum_B4 (
	[KEY] BIGINT NULL, 
	[Score_0] FLOAT(53) NULL, 
	[Score_1] FLOAT(53) NULL, 
	[Score_2] FLOAT(53) NULL, 
...
-- Code For temporary table ##TMP_20180329233101_XQ5D39_XGB_Sum_B4 part 2/2. Populate
...
[DT_node_data_40] AS 
(SELECT [Values].node_id AS node_id, [Values].feature AS feature, [Values].threshold AS threshold, [Values].depth AS depth, [Values].parent_id AS parent_id, [Values].[Score] AS [Score] 
FROM (SELECT 1 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 1 AS depth, 0 AS parent_id, 0.03435317054390907 AS [Score] UNION ALL SELECT 2 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 1 AS depth, 0 AS parent_id, -0.045086611062288284 AS [Score]) AS [Values]), 
[DT_Output_40] AS 
...
[DT_node_data_41] AS 
(SELECT [Values].node_id AS node_id, [Values].feature AS feature, [Values].threshold AS threshold, [Values].depth AS depth, [Values].parent_id AS parent_id, [Values].[Score] AS [Score] 
FROM (SELECT 1 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 1 AS depth, 0 AS parent_id, -0.04728106036782265 AS [Score] UNION ALL SELECT 2 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 1 AS depth, 0 AS parent_id, 0.031466033309698105 AS [Score]) AS [Values]), 
[DT_Output_41] AS 
...
[DT_node_data_42] AS 
(SELECT [Values].node_id AS node_id, [Values].feature AS feature, [Values].threshold AS threshold, [Values].depth AS depth, [Values].parent_id AS parent_id, [Values].[Score] AS [Score] 
FROM (SELECT 1 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 1 AS depth, 0 AS parent_id, 0.028842730447649956 AS [Score] UNION ALL SELECT 2 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 1 AS depth, 0 AS parent_id, -0.047328412532806396 AS [Score]) AS [Values]), 
[DT_Output_42] AS 
...
[DT_node_data_43] AS 
(SELECT [Values].node_id AS node_id, [Values].feature AS feature, [Values].threshold AS threshold, [Values].depth AS depth, [Values].parent_id AS parent_id, [Values].[Score] AS [Score] 
FROM (SELECT 1 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 1 AS depth, 0 AS parent_id, 0.037665992975234985 AS [Score] UNION ALL SELECT 2 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 1 AS depth, 0 AS parent_id, -0.04266652092337608 AS [Score]) AS [Values]), 
[DT_Output_43] AS 
...
[DT_node_data_44] AS 
(SELECT [Values].node_id AS node_id, [Values].feature AS feature, [Values].threshold AS threshold, [Values].depth AS depth, [Values].parent_id AS parent_id, [Values].[Score] AS [Score] 
FROM (SELECT 1 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 1 AS depth, 0 AS parent_id, -0.0428193062543869 AS [Score] UNION ALL SELECT 2 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 1 AS depth, 0 AS parent_id, 0.03453283756971359 AS [Score]) AS [Values]), 
[DT_Output_44] AS 
...
[DT_node_data_45] AS 
(SELECT [Values].node_id AS node_id, [Values].feature AS feature, [Values].threshold AS threshold, [Values].depth AS depth, [Values].parent_id AS parent_id, [Values].[Score] AS [Score] 
FROM (SELECT 1 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 1 AS depth, 0 AS parent_id, -0.0462663434445858 AS [Score] UNION ALL SELECT 2 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 1 AS depth, 0 AS parent_id, 0.028472160920500755 AS [Score]) AS [Values]), 
[DT_Output_45] AS 
...
[DT_node_data_46] AS 
(SELECT [Values].node_id AS node_id, [Values].feature AS feature, [Values].threshold AS threshold, [Values].depth AS depth, [Values].parent_id AS parent_id, [Values].[Score] AS [Score] 
FROM (SELECT 1 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 1 AS depth, 0 AS parent_id, 0.04639824852347374 AS [Score] UNION ALL SELECT 2 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 1 AS depth, 0 AS parent_id, -0.027551433071494102 AS [Score]) AS [Values]), 
[DT_Output_46] AS 
...
[DT_node_data_47] AS 
(SELECT [Values].node_id AS node_id, [Values].feature AS feature, [Values].threshold AS threshold, [Values].depth AS depth, [Values].parent_id AS parent_id, [Values].[Score] AS [Score] 
FROM (SELECT 1 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 1 AS depth, 0 AS parent_id, -0.050295837223529816 AS [Score] UNION ALL SELECT 2 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 1 AS depth, 0 AS parent_id, 0.032815709710121155 AS [Score]) AS [Values]), 
[DT_Output_47] AS 
...
[DT_node_data_48] AS 
(SELECT [Values].node_id AS node_id, [Values].feature AS feature, [Values].threshold AS threshold, [Values].depth AS depth, [Values].parent_id AS parent_id, [Values].[Score] AS [Score] 
FROM (SELECT 1 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 1 AS depth, 0 AS parent_id, 0.03235917538404465 AS [Score] UNION ALL SELECT 2 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 1 AS depth, 0 AS parent_id, -0.04387418180704117 AS [Score]) AS [Values]), 
[DT_Output_48] AS 
...
[DT_node_data_49] AS 
(SELECT [Values].node_id AS node_id, [Values].feature AS feature, [Values].threshold AS threshold, [Values].depth AS depth, [Values].parent_id AS parent_id, [Values].[Score] AS [Score] 
FROM (SELECT 1 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 1 AS depth, 0 AS parent_id, -0.045438311994075775 AS [Score] UNION ALL SELECT 2 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 1 AS depth, 0 AS parent_id, 0.027018070220947266 AS [Score]) AS [Values]), 
[DT_Output_49] AS 
...
FROM [DT_Output_49])
 INSERT INTO ##TMP_20180329233101_XQ5D39_XGB_Sum_B4 ([KEY], [Score_0], [Score_1], [Score_2], [Score_3]) SELECT [XGB_Sum_B4].[KEY], [XGB_Sum_B4].[Score_0], [XGB_Sum_B4].[Score_1], [XGB_Sum_B4].[Score_2], [XGB_Sum_B4].[Score_3] 
...
-- Code For temporary table ##TMP_20180329233101_MH9BLV_XGB_Sum_B5 part 1/2. Create 


CREATE TABLE ##TMP_20180329233101_MH9BLV_XGB_Sum_B5 (
	[KEY] BIGINT NULL, 
	[Score_0] FLOAT(53) NULL, 
	[Score_1] FLOAT(53) NULL, 
	[Score_2] FLOAT(53) NULL, 
...
-- Code For temporary table ##TMP_20180329233101_MH9BLV_XGB_Sum_B5 part 2/2. Populate
...
[DT_node_data_50] AS 
(SELECT [Values].node_id AS node_id, [Values].feature AS feature, [Values].threshold AS threshold, [Values].depth AS depth, [Values].parent_id AS parent_id, [Values].[Score] AS [Score] 
FROM (SELECT 1 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 1 AS depth, 0 AS parent_id, 0.04280025511980057 AS [Score] UNION ALL SELECT 2 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 1 AS depth, 0 AS parent_id, -0.026406705379486084 AS [Score]) AS [Values]), 
[DT_Output_50] AS 
...
[DT_node_data_51] AS 
(SELECT [Values].node_id AS node_id, [Values].feature AS feature, [Values].threshold AS threshold, [Values].depth AS depth, [Values].parent_id AS parent_id, [Values].[Score] AS [Score] 
FROM (SELECT 1 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 1 AS depth, 0 AS parent_id, 0.035598620772361755 AS [Score] UNION ALL SELECT 2 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 1 AS depth, 0 AS parent_id, -0.04177503660321236 AS [Score]) AS [Values]), 
[DT_Output_51] AS 
...
[DT_node_data_52] AS 
(SELECT [Values].node_id AS node_id, [Values].feature AS feature, [Values].threshold AS threshold, [Values].depth AS depth, [Values].parent_id AS parent_id, [Values].[Score] AS [Score] 
FROM (SELECT 1 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 1 AS depth, 0 AS parent_id, -0.04164227843284607 AS [Score] UNION ALL SELECT 2 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 1 AS depth, 0 AS parent_id, 0.032521262764930725 AS [Score]) AS [Values]), 
[DT_Output_52] AS 
...
[DT_node_data_53] AS 
(SELECT [Values].node_id AS node_id, [Values].feature AS feature, [Values].threshold AS threshold, [Values].depth AS depth, [Values].parent_id AS parent_id, [Values].[Score] AS [Score] 
FROM (SELECT 1 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 1 AS depth, 0 AS parent_id, -0.04450121521949768 AS [Score] UNION ALL SELECT 2 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 1 AS depth, 0 AS parent_id, 0.02436644397675991 AS [Score]) AS [Values]), 
[DT_Output_53] AS 
...
[DT_node_data_54] AS 
(SELECT [Values].node_id AS node_id, [Values].feature AS feature, [Values].threshold AS threshold, [Values].depth AS depth, [Values].parent_id AS parent_id, [Values].[Score] AS [Score] 
FROM (SELECT 1 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 1 AS depth, 0 AS parent_id, 0.04137987643480301 AS [Score] UNION ALL SELECT 2 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 1 AS depth, 0 AS parent_id, -0.025546375662088394 AS [Score]) AS [Values]), 
[DT_Output_54] AS 
...
[DT_node_data_55] AS 
(SELECT [Values].node_id AS node_id, [Values].feature AS feature, [Values].threshold AS threshold, [Values].depth AS depth, [Values].parent_id AS parent_id, [Values].[Score] AS [Score] 
FROM (SELECT 1 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 1 AS depth, 0 AS parent_id, -0.035051148384809494 AS [Score] UNION ALL SELECT 2 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 1 AS depth, 0 AS parent_id, 0.03875049576163292 AS [Score]) AS [Values]), 
[DT_Output_55] AS 
...
[DT_node_data_56] AS 
(SELECT [Values].node_id AS node_id, [Values].feature AS feature, [Values].threshold AS threshold, [Values].depth AS depth, [Values].parent_id AS parent_id, [Values].[Score] AS [Score] 
FROM (SELECT 1 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 1 AS depth, 0 AS parent_id, 0.03074887953698635 AS [Score] UNION ALL SELECT 2 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 1 AS depth, 0 AS parent_id, -0.04278656840324402 AS [Score]) AS [Values]), 
[DT_Output_56] AS 
...
[DT_node_data_57] AS 
(SELECT [Values].node_id AS node_id, [Values].feature AS feature, [Values].threshold AS threshold, [Values].depth AS depth, [Values].parent_id AS parent_id, [Values].[Score] AS [Score] 
FROM (SELECT 1 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 1 AS depth, 0 AS parent_id, -0.03527960926294327 AS [Score] UNION ALL SELECT 2 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 1 AS depth, 0 AS parent_id, 0.026150623336434364 AS [Score]) AS [Values]), 
[DT_Output_57] AS 
...
[DT_node_data_58] AS 
(SELECT [Values].node_id AS node_id, [Values].feature AS feature, [Values].threshold AS threshold, [Values].depth AS depth, [Values].parent_id AS parent_id, [Values].[Score] AS [Score] 
FROM (SELECT 1 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 1 AS depth, 0 AS parent_id, 0.03829155117273331 AS [Score] UNION ALL SELECT 2 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 1 AS depth, 0 AS parent_id, -0.02446977235376835 AS [Score]) AS [Values]), 
[DT_Output_58] AS 
...
[DT_node_data_59] AS 
(SELECT [Values].node_id AS node_id, [Values].feature AS feature, [Values].threshold AS threshold, [Values].depth AS depth, [Values].parent_id AS parent_id, [Values].[Score] AS [Score] 
FROM (SELECT 1 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 1 AS depth, 0 AS parent_id, 0.033693715929985046 AS [Score] UNION ALL SELECT 2 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 1 AS depth, 0 AS parent_id, -0.0408625602722168 AS [Score]) AS [Values]), 
[DT_Output_59] AS 
...
FROM [DT_Output_59])
 INSERT INTO ##TMP_20180329233101_MH9BLV_XGB_Sum_B5 ([KEY], [Score_0], [Score_1], [Score_2], [Score_3]) SELECT [XGB_Sum_B5].[KEY], [XGB_Sum_B5].[Score_0], [XGB_Sum_B5].[Score_1], [XGB_Sum_B5].[Score_2], [XGB_Sum_B5].[Score_3] 
...
-- Code For temporary table ##TMP_20180329233101_XCZUKA_XGB_Sum_B6 part 1/2. Create 


CREATE TABLE ##TMP_20180329233101_XCZUKA_XGB_Sum_B6 (
	[KEY] BIGINT NULL, 
	[Score_0] FLOAT(53) NULL, 
	[Score_1] FLOAT(53) NULL, 
	[Score_2] FLOAT(53) NULL, 
...
-- Code For temporary table ##TMP_20180329233101_XCZUKA_XGB_Sum_B6 part 2/2. Populate
...
[DT_node_data_60] AS 
(SELECT [Values].node_id AS node_id, [Values].feature AS feature, [Values].threshold AS threshold, [Values].depth AS depth, [Values].parent_id AS parent_id, [Values].[Score] AS [Score] 
FROM (SELECT 1 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 1 AS depth, 0 AS parent_id, -0.040506456047296524 AS [Score] UNION ALL SELECT 2 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 1 AS depth, 0 AS parent_id, 0.030637675896286964 AS [Score]) AS [Values]), 
[DT_Output_60] AS 
...
[DT_node_data_61] AS 
(SELECT [Values].node_id AS node_id, [Values].feature AS feature, [Values].threshold AS threshold, [Values].depth AS depth, [Values].parent_id AS parent_id, [Values].[Score] AS [Score] 
FROM (SELECT 1 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 1 AS depth, 0 AS parent_id, -0.03424902632832527 AS [Score] UNION ALL SELECT 2 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 1 AS depth, 0 AS parent_id, 0.02360677532851696 AS [Score]) AS [Values]), 
[DT_Output_61] AS 
...
[DT_node_data_62] AS 
(SELECT [Values].node_id AS node_id, [Values].feature AS feature, [Values].threshold AS threshold, [Values].depth AS depth, [Values].parent_id AS parent_id, [Values].[Score] AS [Score] 
FROM (SELECT 1 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 1 AS depth, 0 AS parent_id, -0.026660382747650146 AS [Score] UNION ALL SELECT 2 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 1 AS depth, 0 AS parent_id, 0.03497074544429779 AS [Score]) AS [Values]), 
[DT_Output_62] AS 
...
[DT_node_data_63] AS 
(SELECT [Values].node_id AS node_id, [Values].feature AS feature, [Values].threshold AS threshold, [Values].depth AS depth, [Values].parent_id AS parent_id, [Values].[Score] AS [Score] 
FROM (SELECT 1 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 1 AS depth, 0 AS parent_id, 0.03208934888243675 AS [Score] UNION ALL SELECT 2 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 1 AS depth, 0 AS parent_id, -0.039965447038412094 AS [Score]) AS [Values]), 
[DT_Output_63] AS 
...
FROM [DT_Output_63])
 INSERT INTO ##TMP_20180329233101_XCZUKA_XGB_Sum_B6 ([KEY], [Score_0], [Score_1], [Score_2], [Score_3]) SELECT [XGB_Sum_B6].[KEY], [XGB_Sum_B6].[Score_0], [XGB_Sum_B6].[Score_1], [XGB_Sum_B6].[Score_2], [XGB_Sum_B6].[Score_3] 
...
-- Code For temporary table ##TMP_20180329233101_Z794AN_XGB_Sum_Union part 1/2. Create 


CREATE TABLE ##TMP_20180329233101_Z794AN_XGB_Sum_Union (
	[KEY] BIGINT NULL, 
	[Score_0] FLOAT(53) NULL, 
	[Score_1] FLOAT(53) NULL, 
	[Score_2] FLOAT(53) NULL, 
...
-- Code For temporary table ##TMP_20180329233101_Z794AN_XGB_Sum_Union part 2/2. Populate

INSERT INTO ##TMP_20180329233101_Z794AN_XGB_Sum_Union ([KEY], [Score_0], [Score_1], [Score_2], [Score_3]) SELECT [XGB_Sum_Union].[KEY], [XGB_Sum_Union].[Score_0], [XGB_Sum_Union].[Score_1], [XGB_Sum_Union].[Score_2], [XGB_Sum_Union].[Score_3] 
...
FROM ##TMP_20180329233101_087E0Y_XGB_Sum_B0 AS [XGB_Sum_B0] UNION ALL SELECT [XGB_Sum_B1].[KEY] AS [KEY], [XGB_Sum_B1].[Score_0] AS [Score_0], [XGB_Sum_B1].[Score_1] AS [Score_1], [XGB_Sum_B1].[Score_2] AS [Score_2], [XGB_Sum_B1].[Score_3] AS [Score_3] 
FROM ##TMP_20180329233101_2XV46L_XGB_Sum_B1 AS [XGB_Sum_B1] UNION ALL SELECT [XGB_Sum_B2].[KEY] AS [KEY], [XGB_Sum_B2].[Score_0] AS [Score_0], [XGB_Sum_B2].[Score_1] AS [Score_1], [XGB_Sum_B2].[Score_2] AS [Score_2], [XGB_Sum_B2].[Score_3] AS [Score_3] 
FROM ##TMP_20180329233101_PE0X60_XGB_Sum_B2 AS [XGB_Sum_B2] UNION ALL SELECT [XGB_Sum_B3].[KEY] AS [KEY], [XGB_Sum_B3].[Score_0] AS [Score_0], [XGB_Sum_B3].[Score_1] AS [Score_1], [XGB_Sum_B3].[Score_2] AS [Score_2], [XGB_Sum_B3].[Score_3] AS [Score_3] 
FROM ##TMP_20180329233101_LUMDDU_XGB_Sum_B3 AS [XGB_Sum_B3] UNION ALL SELECT [XGB_Sum_B4].[KEY] AS [KEY], [XGB_Sum_B4].[Score_0] AS [Score_0], [XGB_Sum_B4].[Score_1] AS [Score_1], [XGB_Sum_B4].[Score_2] AS [Score_2], [XGB_Sum_B4].[Score_3] AS [Score_3] 
FROM ##TMP_20180329233101_XQ5D39_XGB_Sum_B4 AS [XGB_Sum_B4] UNION ALL SELECT [XGB_Sum_B5].[KEY] AS [KEY], [XGB_Sum_B5].[Score_0] AS [Score_0], [XGB_Sum_B5].[Score_1] AS [Score_1], [XGB_Sum_B5].[Score_2] AS [Score_2], [XGB_Sum_B5].[Score_3] AS [Score_3] 
FROM ##TMP_20180329233101_MH9BLV_XGB_Sum_B5 AS [XGB_Sum_B5] UNION ALL SELECT [XGB_Sum_B6].[KEY] AS [KEY], [XGB_Sum_B6].[Score_0] AS [Score_0], [XGB_Sum_B6].[Score_1] AS [Score_1], [XGB_Sum_B6].[Score_2] AS [Score_2], [XGB_Sum_B6].[Score_3] AS [Score_3] 
FROM ##TMP_20180329233101_XCZUKA_XGB_Sum_B6 AS [XGB_Sum_B6]) AS [XGB_Sum_EnsembleUnion]) AS [XGB_Sum_Union]
...
FROM ##TMP_20180329233101_Z794AN_XGB_Sum_Union AS [XGB_Sum_Union] GROUP BY [XGB_Sum_Union].[KEY]) AS [T]), 
orig_cte AS 
