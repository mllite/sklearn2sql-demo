...
-- Code For temporary table TMP_20180329233746_936R5U_ADS_imp_1_OUT part 1/2. Create 


CREATE TEMPORARY TABLE "TMP_20180329233746_936R5U_ADS_imp_1_OUT" (
	"KEY" BIGINT, 
	impter_2 FLOAT, 
	impter_3 FLOAT, 
	impter_4 FLOAT, 
...
-- Code For temporary table TMP_20180329233747_4H1AGJ_ADS_sca_2_OUT part 1/2. Create 


CREATE TEMPORARY TABLE "TMP_20180329233747_4H1AGJ_ADS_sca_2_OUT" (
	"KEY" BIGINT, 
	scaler_2 FLOAT, 
	scaler_3 FLOAT, 
	scaler_4 FLOAT, 
...
FROM "TMP_20180329233746_936R5U_ADS_imp_1_OUT" AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT"
-- Code For temporary table TMP_20180329233750_0LCE3N_XGB_Sum_B0 part 1/2. Create 


CREATE TEMPORARY TABLE "TMP_20180329233750_0LCE3N_XGB_Sum_B0" (
	"KEY" BIGINT, 
	"Score_0" FLOAT, 
	"Score_1" FLOAT, 
	"Score_2" FLOAT, 
...
-- Code For temporary table TMP_20180329233750_0LCE3N_XGB_Sum_B0 part 2/2. Populate
...
FROM "TMP_20180329233747_4H1AGJ_ADS_sca_2_OUT" AS "ADS_sca_2_OUT"), 
"DT_node_data" AS 
...
FROM "DT_Output_9")
 INSERT INTO "TMP_20180329233750_0LCE3N_XGB_Sum_B0" ("KEY", "Score_0", "Score_1", "Score_2", "Score_3") SELECT "XGB_Sum_B0"."KEY", "XGB_Sum_B0"."Score_0", "XGB_Sum_B0"."Score_1", "XGB_Sum_B0"."Score_2", "XGB_Sum_B0"."Score_3" 
...
-- Code For temporary table TMP_20180329233750_5KNDRH_XGB_Sum_B1 part 1/2. Create 


CREATE TEMPORARY TABLE "TMP_20180329233750_5KNDRH_XGB_Sum_B1" (
	"KEY" BIGINT, 
	"Score_0" FLOAT, 
	"Score_1" FLOAT, 
	"Score_2" FLOAT, 
...
-- Code For temporary table TMP_20180329233750_5KNDRH_XGB_Sum_B1 part 2/2. Populate
...
FROM "DT_Output_19")
 INSERT INTO "TMP_20180329233750_5KNDRH_XGB_Sum_B1" ("KEY", "Score_0", "Score_1", "Score_2", "Score_3") SELECT "XGB_Sum_B1"."KEY", "XGB_Sum_B1"."Score_0", "XGB_Sum_B1"."Score_1", "XGB_Sum_B1"."Score_2", "XGB_Sum_B1"."Score_3" 
...
-- Code For temporary table TMP_20180329233750_RK9CX8_XGB_Sum_B2 part 1/2. Create 


CREATE TEMPORARY TABLE "TMP_20180329233750_RK9CX8_XGB_Sum_B2" (
	"KEY" BIGINT, 
	"Score_0" FLOAT, 
	"Score_1" FLOAT, 
	"Score_2" FLOAT, 
...
-- Code For temporary table TMP_20180329233750_RK9CX8_XGB_Sum_B2 part 2/2. Populate
...
FROM "DT_Output_29")
 INSERT INTO "TMP_20180329233750_RK9CX8_XGB_Sum_B2" ("KEY", "Score_0", "Score_1", "Score_2", "Score_3") SELECT "XGB_Sum_B2"."KEY", "XGB_Sum_B2"."Score_0", "XGB_Sum_B2"."Score_1", "XGB_Sum_B2"."Score_2", "XGB_Sum_B2"."Score_3" 
...
-- Code For temporary table TMP_20180329233750_U00FFJ_XGB_Sum_B3 part 1/2. Create 


CREATE TEMPORARY TABLE "TMP_20180329233750_U00FFJ_XGB_Sum_B3" (
	"KEY" BIGINT, 
	"Score_0" FLOAT, 
	"Score_1" FLOAT, 
	"Score_2" FLOAT, 
...
-- Code For temporary table TMP_20180329233750_U00FFJ_XGB_Sum_B3 part 2/2. Populate
...
FROM "DT_Output_39")
 INSERT INTO "TMP_20180329233750_U00FFJ_XGB_Sum_B3" ("KEY", "Score_0", "Score_1", "Score_2", "Score_3") SELECT "XGB_Sum_B3"."KEY", "XGB_Sum_B3"."Score_0", "XGB_Sum_B3"."Score_1", "XGB_Sum_B3"."Score_2", "XGB_Sum_B3"."Score_3" 
...
-- Code For temporary table TMP_20180329233750_GDPEN8_XGB_Sum_B4 part 1/2. Create 


CREATE TEMPORARY TABLE "TMP_20180329233750_GDPEN8_XGB_Sum_B4" (
	"KEY" BIGINT, 
	"Score_0" FLOAT, 
	"Score_1" FLOAT, 
	"Score_2" FLOAT, 
...
-- Code For temporary table TMP_20180329233750_GDPEN8_XGB_Sum_B4 part 2/2. Populate
...
FROM "DT_Output_49")
 INSERT INTO "TMP_20180329233750_GDPEN8_XGB_Sum_B4" ("KEY", "Score_0", "Score_1", "Score_2", "Score_3") SELECT "XGB_Sum_B4"."KEY", "XGB_Sum_B4"."Score_0", "XGB_Sum_B4"."Score_1", "XGB_Sum_B4"."Score_2", "XGB_Sum_B4"."Score_3" 
...
-- Code For temporary table TMP_20180329233750_8V6GV8_XGB_Sum_B5 part 1/2. Create 


CREATE TEMPORARY TABLE "TMP_20180329233750_8V6GV8_XGB_Sum_B5" (
	"KEY" BIGINT, 
	"Score_0" FLOAT, 
	"Score_1" FLOAT, 
	"Score_2" FLOAT, 
...
-- Code For temporary table TMP_20180329233750_8V6GV8_XGB_Sum_B5 part 2/2. Populate
...
FROM "DT_Output_59")
 INSERT INTO "TMP_20180329233750_8V6GV8_XGB_Sum_B5" ("KEY", "Score_0", "Score_1", "Score_2", "Score_3") SELECT "XGB_Sum_B5"."KEY", "XGB_Sum_B5"."Score_0", "XGB_Sum_B5"."Score_1", "XGB_Sum_B5"."Score_2", "XGB_Sum_B5"."Score_3" 
...
-- Code For temporary table TMP_20180329233751_CQJK7J_XGB_Sum_B6 part 1/2. Create 


CREATE TEMPORARY TABLE "TMP_20180329233751_CQJK7J_XGB_Sum_B6" (
	"KEY" BIGINT, 
	"Score_0" FLOAT, 
	"Score_1" FLOAT, 
	"Score_2" FLOAT, 
...
-- Code For temporary table TMP_20180329233751_CQJK7J_XGB_Sum_B6 part 2/2. Populate
...
FROM "DT_Output_63")
 INSERT INTO "TMP_20180329233751_CQJK7J_XGB_Sum_B6" ("KEY", "Score_0", "Score_1", "Score_2", "Score_3") SELECT "XGB_Sum_B6"."KEY", "XGB_Sum_B6"."Score_0", "XGB_Sum_B6"."Score_1", "XGB_Sum_B6"."Score_2", "XGB_Sum_B6"."Score_3" 
...
-- Code For temporary table TMP_20180329233751_9FCUV6_XGB_Sum_Union part 1/2. Create 


CREATE TEMPORARY TABLE "TMP_20180329233751_9FCUV6_XGB_Sum_Union" (
	"KEY" BIGINT, 
	"Score_0" FLOAT, 
	"Score_1" FLOAT, 
	"Score_2" FLOAT, 
...
-- Code For temporary table TMP_20180329233751_9FCUV6_XGB_Sum_Union part 2/2. Populate

INSERT INTO "TMP_20180329233751_9FCUV6_XGB_Sum_Union" ("KEY", "Score_0", "Score_1", "Score_2", "Score_3") SELECT "XGB_Sum_Union"."KEY", "XGB_Sum_Union"."Score_0", "XGB_Sum_Union"."Score_1", "XGB_Sum_Union"."Score_2", "XGB_Sum_Union"."Score_3" 
...
FROM "TMP_20180329233750_0LCE3N_XGB_Sum_B0" AS "XGB_Sum_B0" UNION ALL SELECT "XGB_Sum_B1"."KEY" AS "KEY", "XGB_Sum_B1"."Score_0" AS "Score_0", "XGB_Sum_B1"."Score_1" AS "Score_1", "XGB_Sum_B1"."Score_2" AS "Score_2", "XGB_Sum_B1"."Score_3" AS "Score_3" 
FROM "TMP_20180329233750_5KNDRH_XGB_Sum_B1" AS "XGB_Sum_B1" UNION ALL SELECT "XGB_Sum_B2"."KEY" AS "KEY", "XGB_Sum_B2"."Score_0" AS "Score_0", "XGB_Sum_B2"."Score_1" AS "Score_1", "XGB_Sum_B2"."Score_2" AS "Score_2", "XGB_Sum_B2"."Score_3" AS "Score_3" 
FROM "TMP_20180329233750_RK9CX8_XGB_Sum_B2" AS "XGB_Sum_B2" UNION ALL SELECT "XGB_Sum_B3"."KEY" AS "KEY", "XGB_Sum_B3"."Score_0" AS "Score_0", "XGB_Sum_B3"."Score_1" AS "Score_1", "XGB_Sum_B3"."Score_2" AS "Score_2", "XGB_Sum_B3"."Score_3" AS "Score_3" 
FROM "TMP_20180329233750_U00FFJ_XGB_Sum_B3" AS "XGB_Sum_B3" UNION ALL SELECT "XGB_Sum_B4"."KEY" AS "KEY", "XGB_Sum_B4"."Score_0" AS "Score_0", "XGB_Sum_B4"."Score_1" AS "Score_1", "XGB_Sum_B4"."Score_2" AS "Score_2", "XGB_Sum_B4"."Score_3" AS "Score_3" 
FROM "TMP_20180329233750_GDPEN8_XGB_Sum_B4" AS "XGB_Sum_B4" UNION ALL SELECT "XGB_Sum_B5"."KEY" AS "KEY", "XGB_Sum_B5"."Score_0" AS "Score_0", "XGB_Sum_B5"."Score_1" AS "Score_1", "XGB_Sum_B5"."Score_2" AS "Score_2", "XGB_Sum_B5"."Score_3" AS "Score_3" 
FROM "TMP_20180329233750_8V6GV8_XGB_Sum_B5" AS "XGB_Sum_B5" UNION ALL SELECT "XGB_Sum_B6"."KEY" AS "KEY", "XGB_Sum_B6"."Score_0" AS "Score_0", "XGB_Sum_B6"."Score_1" AS "Score_1", "XGB_Sum_B6"."Score_2" AS "Score_2", "XGB_Sum_B6"."Score_3" AS "Score_3" 
FROM "TMP_20180329233751_CQJK7J_XGB_Sum_B6" AS "XGB_Sum_B6") AS "XGB_Sum_EnsembleUnion") AS "XGB_Sum_Union"
...
FROM "TMP_20180329233751_9FCUV6_XGB_Sum_Union" AS "XGB_Sum_Union" GROUP BY "XGB_Sum_Union"."KEY") AS "T"), 
orig_cte AS 
