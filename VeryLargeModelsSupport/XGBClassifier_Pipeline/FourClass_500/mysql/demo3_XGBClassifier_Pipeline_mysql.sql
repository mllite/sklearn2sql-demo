...
-- Code For temporary table TMP_20180329233747_01VSI2_ADS_imp_1_OUT part 1/2. Create 


CREATE TEMPORARY TABLE `TMP_20180329233747_01VSI2_ADS_imp_1_OUT` (
	`KEY` BIGINT, 
	impter_2 DOUBLE, 
	impter_3 DOUBLE, 
	impter_4 DOUBLE, 
...
-- Code For temporary table TMP_20180329233748_1E4RGU_ADS_sca_2_OUT part 1/2. Create 


CREATE TEMPORARY TABLE `TMP_20180329233748_1E4RGU_ADS_sca_2_OUT` (
	`KEY` BIGINT, 
	scaler_2 DOUBLE, 
	scaler_3 DOUBLE, 
	scaler_4 DOUBLE, 
...
FROM (SELECT `ADS_imp_1_OUT`.`KEY` AS `KEY`, (`ADS_imp_1_OUT`.impter_2 - 0.10810245375646362) / 0.9793817679782103 AS scaler_2, (`ADS_imp_1_OUT`.impter_3 - 0.040042372892287084) / 1.0023891813162529 AS scaler_3, (`ADS_imp_1_OUT`.impter_4 - -0.07667364732662786) / 0.9900776238894332 AS scaler_4, (`ADS_imp_1_OUT`.impter_5 - 0.17588592419877258) / 5.560255893599715 AS scaler_5, (`ADS_imp_1_OUT`.impter_6 - 0.02926169026463611) / 1.0394964701962466 AS scaler_6, (`ADS_imp_1_OUT`.impter_7 - -0.00904400654098767) / 0.9961880424548265 AS scaler_7, (`ADS_imp_1_OUT`.impter_8 - 0.02021641814123045) / 1.0128701222372198 AS scaler_8, (`ADS_imp_1_OUT`.impter_9 - -0.021740866363558604) / 0.9982204224505042 AS scaler_9, (`ADS_imp_1_OUT`.impter_10 - 0.12136863686872651) / 5.9946377958756045 AS scaler_10, (`ADS_imp_1_OUT`.impter_11 - -0.009621207715304118) / 1.0301565996554682 AS scaler_11, (`ADS_imp_1_OUT`.impter_12 - -0.0017282210866736356) / 0.981399050431275 AS scaler_12, (`ADS_imp_1_OUT`.impter_13 - -0.017782065935332218) / 1.0111944630304806 AS scaler_13, (`ADS_imp_1_OUT`.impter_14 - 0.03226275015550329) / 0.979628929805027 AS scaler_14, (`ADS_imp_1_OUT`.impter_15 - -0.0014825533746410664) / 0.9934430866044156 AS scaler_15, (`ADS_imp_1_OUT`.impter_16 - 0.06164712316198218) / 1.0212164409644986 AS scaler_16, (`ADS_imp_1_OUT`.impter_17 - 0.02754670267716649) / 1.0166324015399968 AS scaler_17, (`ADS_imp_1_OUT`.impter_18 - 0.08064319713194991) / 5.771736825789889 AS scaler_18, (`ADS_imp_1_OUT`.impter_19 - -0.011498650117894155) / 1.0134290863495095 AS scaler_19, (`ADS_imp_1_OUT`.impter_20 - 0.31890266993969374) / 5.708228988759961 AS scaler_20, (`ADS_imp_1_OUT`.impter_21 - -0.00022777424626326773) / 0.9933278547260863 AS scaler_21, (`ADS_imp_1_OUT`.impter_22 - 0.24588258651573852) / 6.039060090290538 AS scaler_22, (`ADS_imp_1_OUT`.impter_23 - -0.008717075180818528) / 0.9761125096364057 AS scaler_23, (`ADS_imp_1_OUT`.impter_24 - 0.0053072366770978985) / 0.9683216012472358 AS scaler_24, (`ADS_imp_1_OUT`.impter_25 - -0.014763237855175493) / 0.9851551177343002 AS scaler_25, (`ADS_imp_1_OUT`.impter_26 - -0.023154438774995047) / 1.0034590713202722 AS scaler_26, (`ADS_imp_1_OUT`.impter_27 - -0.12239207011675045) / 5.777017450648698 AS scaler_27, (`ADS_imp_1_OUT`.impter_28 - 0.020535611934405496) / 0.9878048079305166 AS scaler_28, (`ADS_imp_1_OUT`.impter_29 - 0.006055843023249926) / 0.9973455621257931 AS scaler_29, (`ADS_imp_1_OUT`.impter_30 - -0.02283750315483421) / 0.9862507261223278 AS scaler_30, (`ADS_imp_1_OUT`.impter_31 - 0.023985609638350506) / 0.9937627841184585 AS scaler_31, (`ADS_imp_1_OUT`.impter_32 - 0.008119293552803313) / 0.9954522177860405 AS scaler_32, (`ADS_imp_1_OUT`.impter_33 - 0.027089596569202946) / 1.0239371071038705 AS scaler_33, (`ADS_imp_1_OUT`.impter_34 - -0.06055225058050742) / 1.0104633173004076 AS scaler_34, (`ADS_imp_1_OUT`.impter_35 - -0.024424868791331697) / 0.9733566902991094 AS scaler_35, (`ADS_imp_1_OUT`.impter_36 - 0.012336464422653204) / 0.9893886329833442 AS scaler_36, (`ADS_imp_1_OUT`.impter_37 - -0.03733185453369615) / 0.9891003655260362 AS scaler_37, (`ADS_imp_1_OUT`.impter_38 - -0.01163301006213858) / 0.9677509701652444 AS scaler_38, (`ADS_imp_1_OUT`.impter_39 - -0.05102972508859019) / 1.0446002285287346 AS scaler_39, (`ADS_imp_1_OUT`.impter_40 - 0.0724619853931901) / 0.9433887406048981 AS scaler_40, (`ADS_imp_1_OUT`.impter_41 - 0.02873322955169374) / 0.9997034238642181 AS scaler_41, (`ADS_imp_1_OUT`.impter_42 - -0.0468030521847972) / 0.9799565417954935 AS scaler_42, (`ADS_imp_1_OUT`.impter_43 - 0.024222315050048744) / 0.977961503101405 AS scaler_43, (`ADS_imp_1_OUT`.impter_44 - 0.01149556673107005) / 5.54835190391683 AS scaler_44, (`ADS_imp_1_OUT`.impter_45 - -0.46581882386282575) / 5.894617213165279 AS scaler_45, (`ADS_imp_1_OUT`.impter_46 - -0.0013382860297555803) / 1.0219544648922987 AS scaler_46, (`ADS_imp_1_OUT`.impter_47 - -0.008602411981840778) / 0.931663415098126 AS scaler_47, (`ADS_imp_1_OUT`.impter_48 - -0.009965212302201201) / 1.0168312431071238 AS scaler_48, (`ADS_imp_1_OUT`.impter_49 - -0.03978485158208147) / 0.9423447496201277 AS scaler_49, (`ADS_imp_1_OUT`.impter_50 - 0.007027179196660041) / 1.0312559989326386 AS scaler_50, (`ADS_imp_1_OUT`.impter_51 - -0.01982980508470468) / 0.9800172715083906 AS scaler_51, (`ADS_imp_1_OUT`.impter_52 - -0.04505595017989205) / 1.006703914399541 AS scaler_52, (`ADS_imp_1_OUT`.impter_53 - -0.045447760217128444) / 1.0007330092630027 AS scaler_53, (`ADS_imp_1_OUT`.impter_54 - 0.037832771618739616) / 1.0202020707470842 AS scaler_54, (`ADS_imp_1_OUT`.impter_55 - -0.061624599074911364) / 0.9839597841021345 AS scaler_55, (`ADS_imp_1_OUT`.impter_56 - 0.07625111583055796) / 1.0202381673398924 AS scaler_56, (`ADS_imp_1_OUT`.impter_57 - -0.027271537635613834) / 0.9901971057770143 AS scaler_57, (`ADS_imp_1_OUT`.impter_58 - 0.08658875419996898) / 1.0341490471974248 AS scaler_58, (`ADS_imp_1_OUT`.impter_59 - 0.0999871472844467) / 1.0320762955753215 AS scaler_59, (`ADS_imp_1_OUT`.impter_60 - -0.007447998234187981) / 0.98028942569617 AS scaler_60, (`ADS_imp_1_OUT`.impter_61 - 0.0005691476004520007) / 0.962499434030872 AS scaler_61, (`ADS_imp_1_OUT`.impter_62 - 0.007052612183486737) / 0.9952316581074087 AS scaler_62, (`ADS_imp_1_OUT`.impter_63 - -0.07298857610906591) / 1.0117239365465656 AS scaler_63, (`ADS_imp_1_OUT`.impter_64 - 0.007257283737326912) / 0.9614049921549974 AS scaler_64, (`ADS_imp_1_OUT`.impter_65 - -0.01499281527733551) / 0.9856230299709878 AS scaler_65, (`ADS_imp_1_OUT`.impter_66 - 0.1504932184478646) / 6.139566226432819 AS scaler_66, (`ADS_imp_1_OUT`.impter_67 - -0.34139964395628075) / 5.589924447035164 AS scaler_67, (`ADS_imp_1_OUT`.impter_68 - 0.044769898693156215) / 0.9858338717221913 AS scaler_68, (`ADS_imp_1_OUT`.impter_69 - -0.06740805909718733) / 1.0160492930707818 AS scaler_69, (`ADS_imp_1_OUT`.impter_70 - 0.011827724290967036) / 0.9920309378976953 AS scaler_70, (`ADS_imp_1_OUT`.impter_71 - 0.04511965476174756) / 1.0134689242858836 AS scaler_71, (`ADS_imp_1_OUT`.impter_72 - -0.005725960546688403) / 0.9742042745897078 AS scaler_72, (`ADS_imp_1_OUT`.impter_73 - -0.45906874360950467) / 6.052269381209856 AS scaler_73, (`ADS_imp_1_OUT`.impter_74 - -0.4029233461203958) / 5.771992694521305 AS scaler_74, (`ADS_imp_1_OUT`.impter_75 - -0.01983348240532154) / 0.9849514335826905 AS scaler_75, (`ADS_imp_1_OUT`.impter_76 - -0.03762876790351029) / 0.9982596731767271 AS scaler_76, (`ADS_imp_1_OUT`.impter_77 - 0.0014482025177064296) / 0.9781075851188674 AS scaler_77, (`ADS_imp_1_OUT`.impter_78 - -0.009126373209438378) / 0.9875838602657921 AS scaler_78, (`ADS_imp_1_OUT`.impter_79 - -0.004847879746676399) / 1.0007261707872959 AS scaler_79, (`ADS_imp_1_OUT`.impter_80 - 0.0003242960082649739) / 1.0081288330481553 AS scaler_80, (`ADS_imp_1_OUT`.impter_81 - -0.030222670037465243) / 1.0126353893899334 AS scaler_81, (`ADS_imp_1_OUT`.impter_82 - 0.00597438906398475) / 0.997574121799789 AS scaler_82, (`ADS_imp_1_OUT`.impter_83 - 0.006442151047769896) / 0.9692977412695478 AS scaler_83, (`ADS_imp_1_OUT`.impter_84 - 0.06674583942705845) / 0.9650616611467926 AS scaler_84, (`ADS_imp_1_OUT`.impter_85 - 0.07788312942179253) / 1.0502476441331448 AS scaler_85, (`ADS_imp_1_OUT`.impter_86 - 0.04734384734963352) / 0.9922221019778982 AS scaler_86, (`ADS_imp_1_OUT`.impter_87 - -0.008706507745982245) / 1.0281463379538616 AS scaler_87, (`ADS_imp_1_OUT`.impter_88 - 0.048010462132819065) / 1.0219516364531134 AS scaler_88, (`ADS_imp_1_OUT`.impter_89 - -0.015721233574226466) / 0.986060770131844 AS scaler_89, (`ADS_imp_1_OUT`.impter_90 - 0.029859590983661574) / 0.9917320004086767 AS scaler_90, (`ADS_imp_1_OUT`.impter_91 - 0.05432072236762381) / 1.0137096750823185 AS scaler_91, (`ADS_imp_1_OUT`.impter_92 - -0.01029209788232909) / 1.000757192176457 AS scaler_92, (`ADS_imp_1_OUT`.impter_93 - -0.057667586642934685) / 5.94408516351358 AS scaler_93, (`ADS_imp_1_OUT`.impter_94 - 0.010705496096094396) / 1.0092360847471284 AS scaler_94, (`ADS_imp_1_OUT`.impter_95 - 0.07155562158168) / 0.983479044147119 AS scaler_95, (`ADS_imp_1_OUT`.impter_96 - 0.012567881232469623) / 1.0041791065815686 AS scaler_96, (`ADS_imp_1_OUT`.impter_97 - 0.013515801306018876) / 1.0171521249734952 AS scaler_97, (`ADS_imp_1_OUT`.impter_98 - -0.03144133874056725) / 0.9643293110743213 AS scaler_98, (`ADS_imp_1_OUT`.impter_99 - 0.04347042885615023) / 1.0350471688640486 AS scaler_99, (`ADS_imp_1_OUT`.impter_100 - 0.06271561958724896) / 0.9582071956389678 AS scaler_100, (`ADS_imp_1_OUT`.impter_101 - 0.05756441101485498) / 1.016873068211695 AS scaler_101, (`ADS_imp_1_OUT`.impter_102 - 0.08328088835981105) / 5.923497571865014 AS scaler_102, (`ADS_imp_1_OUT`.impter_103 - 0.027342821102590696) / 1.009759865874761 AS scaler_103, (`ADS_imp_1_OUT`.impter_104 - -0.45823161485829694) / 5.947446910796636 AS scaler_104, (`ADS_imp_1_OUT`.impter_105 - -0.0574871655764397) / 0.9558665112492322 AS scaler_105, (`ADS_imp_1_OUT`.impter_106 - -0.04439086595851878) / 1.0257189382967924 AS scaler_106, (`ADS_imp_1_OUT`.impter_107 - 0.02144592469206838) / 0.9895401881723541 AS scaler_107, (`ADS_imp_1_OUT`.impter_108 - 0.11209373860993643) / 5.749503930446186 AS scaler_108, (`ADS_imp_1_OUT`.impter_109 - 0.020021880427962078) / 1.003919278192992 AS scaler_109, (`ADS_imp_1_OUT`.impter_110 - -0.009743329217515511) / 0.9919583243676908 AS scaler_110, (`ADS_imp_1_OUT`.impter_111 - 0.4786622270719938) / 5.58775739405435 AS scaler_111, (`ADS_imp_1_OUT`.impter_112 - 0.02944493462807616) / 1.0248871232604297 AS scaler_112, (`ADS_imp_1_OUT`.impter_113 - -0.00310096676730144) / 1.0254001437004343 AS scaler_113, (`ADS_imp_1_OUT`.impter_114 - 0.0231371409575344) / 1.0664587771246052 AS scaler_114, (`ADS_imp_1_OUT`.impter_115 - -0.04815066967587055) / 1.018510444629956 AS scaler_115, (`ADS_imp_1_OUT`.impter_116 - 0.025111413866439537) / 1.0045413648024208 AS scaler_116, (`ADS_imp_1_OUT`.impter_117 - 0.0021133311116955213) / 0.9757575746423808 AS scaler_117, (`ADS_imp_1_OUT`.impter_118 - 0.034947174142157644) / 0.9975889189566856 AS scaler_118, (`ADS_imp_1_OUT`.impter_119 - -0.05606347652620213) / 0.9928987912016847 AS scaler_119, (`ADS_imp_1_OUT`.impter_120 - -0.023812528369921485) / 1.0013009070011438 AS scaler_120, (`ADS_imp_1_OUT`.impter_121 - -0.042073637845818246) / 0.9912144880843266 AS scaler_121, (`ADS_imp_1_OUT`.impter_122 - 0.007882510288965947) / 1.0172369989511076 AS scaler_122, (`ADS_imp_1_OUT`.impter_123 - -0.02733468989970973) / 1.01392267981462 AS scaler_123, (`ADS_imp_1_OUT`.impter_124 - -0.6701750904403835) / 6.145313938495119 AS scaler_124, (`ADS_imp_1_OUT`.impter_125 - -0.04044317104909807) / 0.9609996023909663 AS scaler_125, (`ADS_imp_1_OUT`.impter_126 - -0.00837516585592746) / 0.9754352444783934 AS scaler_126, (`ADS_imp_1_OUT`.impter_127 - -0.005344367193538407) / 1.0148601448564643 AS scaler_127, (`ADS_imp_1_OUT`.impter_128 - -0.009191225939401346) / 0.982128874729729 AS scaler_128, (`ADS_imp_1_OUT`.impter_129 - -0.004068573508204202) / 0.9971242820519521 AS scaler_129, (`ADS_imp_1_OUT`.impter_130 - -0.030267877751773992) / 0.96864155853453 AS scaler_130, (`ADS_imp_1_OUT`.impter_131 - 0.17410306271063888) / 5.789756786227785 AS scaler_131, (`ADS_imp_1_OUT`.impter_132 - -0.012642941998284607) / 0.9922148064395657 AS scaler_132, (`ADS_imp_1_OUT`.impter_133 - 0.01749739797543971) / 0.9787286398774294 AS scaler_133, (`ADS_imp_1_OUT`.impter_134 - 0.5426783595611434) / 5.907808207908198 AS scaler_134, (`ADS_imp_1_OUT`.impter_135 - -0.5946970819130108) / 6.0784028515757305 AS scaler_135, (`ADS_imp_1_OUT`.impter_136 - -0.02934504234656094) / 1.0091339941012132 AS scaler_136, (`ADS_imp_1_OUT`.impter_137 - 0.06552557763413538) / 6.095951331803264 AS scaler_137, (`ADS_imp_1_OUT`.impter_138 - -0.05569025110062092) / 0.9610638640494519 AS scaler_138, (`ADS_imp_1_OUT`.impter_139 - 0.023191171882599493) / 1.0128603239940146 AS scaler_139, (`ADS_imp_1_OUT`.impter_140 - -0.05295059390165566) / 0.9704481251340982 AS scaler_140, (`ADS_imp_1_OUT`.impter_141 - 0.033509246297397904) / 1.0152086117159598 AS scaler_141, (`ADS_imp_1_OUT`.impter_142 - -0.04155471151345872) / 1.0275865673837457 AS scaler_142, (`ADS_imp_1_OUT`.impter_143 - -0.6634336506604639) / 5.8591587401192315 AS scaler_143, (`ADS_imp_1_OUT`.impter_144 - -0.5573588681497673) / 5.822804930738725 AS scaler_144, (`ADS_imp_1_OUT`.impter_145 - 0.0441240830479543) / 0.9942937489948139 AS scaler_145, (`ADS_imp_1_OUT`.impter_146 - -0.0032026430582909036) / 1.0088252648820826 AS scaler_146, (`ADS_imp_1_OUT`.impter_147 - 0.0547961032530105) / 1.0250292567069976 AS scaler_147, (`ADS_imp_1_OUT`.impter_148 - -0.0570190089317311) / 1.0233221648265598 AS scaler_148, (`ADS_imp_1_OUT`.impter_149 - -0.05068123758307288) / 1.0059501057644102 AS scaler_149, (`ADS_imp_1_OUT`.impter_150 - 0.04963772213165472) / 5.707884171857318 AS scaler_150, (`ADS_imp_1_OUT`.impter_151 - -0.0053902063922270736) / 0.9733282006907008 AS scaler_151, (`ADS_imp_1_OUT`.impter_152 - -0.06888968948833549) / 1.0357034285112359 AS scaler_152, (`ADS_imp_1_OUT`.impter_153 - -0.016131263076271454) / 1.0352933940220925 AS scaler_153, (`ADS_imp_1_OUT`.impter_154 - -0.3673160108448531) / 5.831014219549596 AS scaler_154, (`ADS_imp_1_OUT`.impter_155 - 0.055182003778661885) / 5.684243359483168 AS scaler_155, (`ADS_imp_1_OUT`.impter_156 - 0.03906491494486876) / 0.9983722576273872 AS scaler_156, (`ADS_imp_1_OUT`.impter_157 - -0.018774913038090556) / 0.981565987462681 AS scaler_157, (`ADS_imp_1_OUT`.impter_158 - 0.04167563251378332) / 5.5897226143974885 AS scaler_158, (`ADS_imp_1_OUT`.impter_159 - -0.014464200228668327) / 1.0647700745180197 AS scaler_159, (`ADS_imp_1_OUT`.impter_160 - 0.001498972159727102) / 1.0346863623514742 AS scaler_160, (`ADS_imp_1_OUT`.impter_161 - -0.018229772297973595) / 1.0422072170743273 AS scaler_161, (`ADS_imp_1_OUT`.impter_162 - -0.044371023327894055) / 1.0176258203618869 AS scaler_162, (`ADS_imp_1_OUT`.impter_163 - 0.003260044680277718) / 1.0389488041486905 AS scaler_163, (`ADS_imp_1_OUT`.impter_164 - 0.04743398414161841) / 0.9782204833572162 AS scaler_164, (`ADS_imp_1_OUT`.impter_165 - 0.02952107505742563) / 1.0089690347262386 AS scaler_165, (`ADS_imp_1_OUT`.impter_166 - 0.039029822514854) / 1.0121176151207434 AS scaler_166, (`ADS_imp_1_OUT`.impter_167 - 0.33233879962749624) / 5.744346296798411 AS scaler_167, (`ADS_imp_1_OUT`.impter_168 - -0.030838711525630415) / 0.9705290180206547 AS scaler_168, (`ADS_imp_1_OUT`.impter_169 - 0.053457495179036106) / 1.0248755705105466 AS scaler_169, (`ADS_imp_1_OUT`.impter_170 - 0.06334783178164666) / 0.9775079956110175 AS scaler_170, (`ADS_imp_1_OUT`.impter_171 - -0.015185631962267647) / 0.9717858688863088 AS scaler_171, (`ADS_imp_1_OUT`.impter_172 - -0.0373186897788836) / 0.999257264463164 AS scaler_172, (`ADS_imp_1_OUT`.impter_173 - 0.058926161621590305) / 0.9602458384408017 AS scaler_173, (`ADS_imp_1_OUT`.impter_174 - 9.69895410212665e-05) / 1.0063812902851987 AS scaler_174, (`ADS_imp_1_OUT`.impter_175 - 0.023780298476686824) / 1.0186861099526499 AS scaler_175, (`ADS_imp_1_OUT`.impter_176 - 0.021640308005590803) / 0.967390860423614 AS scaler_176, (`ADS_imp_1_OUT`.impter_177 - 0.02609411025064558) / 1.019952052097139 AS scaler_177, (`ADS_imp_1_OUT`.impter_178 - 0.053659812775327234) / 1.0317585905842375 AS scaler_178, (`ADS_imp_1_OUT`.impter_179 - 0.02312075671447861) / 0.9624262389790543 AS scaler_179, (`ADS_imp_1_OUT`.impter_180 - 0.08189652549389312) / 1.008828045220763 AS scaler_180, (`ADS_imp_1_OUT`.impter_181 - -0.28662694866746835) / 6.172920864518475 AS scaler_181, (`ADS_imp_1_OUT`.impter_182 - -0.06816976745830143) / 1.006696859076202 AS scaler_182, (`ADS_imp_1_OUT`.impter_183 - -0.0288394136395886) / 1.0123612493717167 AS scaler_183, (`ADS_imp_1_OUT`.impter_184 - 0.030475929720363698) / 0.971249477659825 AS scaler_184, (`ADS_imp_1_OUT`.impter_185 - -0.9321092506061046) / 5.959856975617778 AS scaler_185, (`ADS_imp_1_OUT`.impter_186 - -0.005783297854668443) / 0.9729868220424777 AS scaler_186, (`ADS_imp_1_OUT`.impter_187 - -0.6842779545480162) / 5.6462061209635666 AS scaler_187, (`ADS_imp_1_OUT`.impter_188 - -0.035868681753580677) / 0.9515600028160798 AS scaler_188, (`ADS_imp_1_OUT`.impter_189 - 0.37446820466554537) / 6.045200162892497 AS scaler_189, (`ADS_imp_1_OUT`.impter_190 - 0.03710250301413846) / 1.0283479885398354 AS scaler_190, (`ADS_imp_1_OUT`.impter_191 - -0.1405646996029281) / 6.021540164862222 AS scaler_191, (`ADS_imp_1_OUT`.impter_192 - -0.008242263620478222) / 1.016675618095213 AS scaler_192, (`ADS_imp_1_OUT`.impter_193 - 0.23469193009627595) / 5.601102541825846 AS scaler_193, (`ADS_imp_1_OUT`.impter_194 - -0.04853360559010945) / 0.9850160080809853 AS scaler_194, (`ADS_imp_1_OUT`.impter_195 - -0.29107017412914993) / 5.586860950904685 AS scaler_195, (`ADS_imp_1_OUT`.impter_196 - 0.06554945522577102) / 0.9914300814275504 AS scaler_196, (`ADS_imp_1_OUT`.impter_197 - 0.03415746968907192) / 0.9939759564479547 AS scaler_197, (`ADS_imp_1_OUT`.impter_198 - -1.0112490880861227) / 5.782797574194705 AS scaler_198, (`ADS_imp_1_OUT`.impter_199 - 0.4496849630728245) / 5.837154258847168 AS scaler_199, (`ADS_imp_1_OUT`.impter_200 - 0.032026535978956015) / 0.9803145829814145 AS scaler_200, (`ADS_imp_1_OUT`.impter_201 - 0.000929134812353008) / 0.9966914430821684 AS scaler_201, (`ADS_imp_1_OUT`.impter_202 - 0.013717912018418882) / 1.0042933647333387 AS scaler_202, (`ADS_imp_1_OUT`.impter_203 - -0.025517677160104602) / 1.023007838139583 AS scaler_203, (`ADS_imp_1_OUT`.impter_204 - 0.008684033616587546) / 1.0055749498115065 AS scaler_204, (`ADS_imp_1_OUT`.impter_205 - 0.013537249806385316) / 0.9615196489451362 AS scaler_205, (`ADS_imp_1_OUT`.impter_206 - -0.0230268828473152) / 0.9775483835928382 AS scaler_206, (`ADS_imp_1_OUT`.impter_207 - 0.03589117923846176) / 0.9863064503789496 AS scaler_207, (`ADS_imp_1_OUT`.impter_208 - -0.011430934569701108) / 1.0568818033144645 AS scaler_208, (`ADS_imp_1_OUT`.impter_209 - -0.03231136300980085) / 1.0373910812235252 AS scaler_209, (`ADS_imp_1_OUT`.impter_210 - -0.03420275223278265) / 5.894903068982469 AS scaler_210, (`ADS_imp_1_OUT`.impter_211 - 0.23377425435020424) / 5.7466656009400365 AS scaler_211, (`ADS_imp_1_OUT`.impter_212 - 0.06340248702486702) / 5.640777044308502 AS scaler_212, (`ADS_imp_1_OUT`.impter_213 - -0.031763897397096605) / 1.0147599704147603 AS scaler_213, (`ADS_imp_1_OUT`.impter_214 - 0.004392749210234481) / 0.9750450927968857 AS scaler_214, (`ADS_imp_1_OUT`.impter_215 - -0.007220451377103457) / 0.998695256241697 AS scaler_215, (`ADS_imp_1_OUT`.impter_216 - 0.001039454428951527) / 0.9929801222993039 AS scaler_216, (`ADS_imp_1_OUT`.impter_217 - 0.255416687811933) / 5.606442450480165 AS scaler_217, (`ADS_imp_1_OUT`.impter_218 - -0.1279428512452052) / 6.183297227558894 AS scaler_218, (`ADS_imp_1_OUT`.impter_219 - 0.11623077388873257) / 5.860568084583105 AS scaler_219, (`ADS_imp_1_OUT`.impter_220 - 0.04461217703505275) / 5.83606925311369 AS scaler_220, (`ADS_imp_1_OUT`.impter_221 - -0.03146418763016053) / 1.009842922203672 AS scaler_221, (`ADS_imp_1_OUT`.impter_222 - 0.03437191123539599) / 0.9618546894792044 AS scaler_222, (`ADS_imp_1_OUT`.impter_223 - 0.02811765018111002) / 1.0234543094708461 AS scaler_223, (`ADS_imp_1_OUT`.impter_224 - -0.008115500982846469) / 0.9582255125846887 AS scaler_224, (`ADS_imp_1_OUT`.impter_225 - 0.0346610159959258) / 0.9382932228802465 AS scaler_225, (`ADS_imp_1_OUT`.impter_226 - 0.04873411944524845) / 0.9681071054529649 AS scaler_226, (`ADS_imp_1_OUT`.impter_227 - 4.894869923178419e-05) / 0.9711882273762723 AS scaler_227, (`ADS_imp_1_OUT`.impter_228 - 0.018209676154939517) / 0.9795446917047469 AS scaler_228, (`ADS_imp_1_OUT`.impter_229 - 0.026610576357411958) / 1.020416620612885 AS scaler_229, (`ADS_imp_1_OUT`.impter_230 - -0.18927414463099612) / 6.1290712879929945 AS scaler_230, (`ADS_imp_1_OUT`.impter_231 - 0.7485324016005227) / 5.734450284809372 AS scaler_231, (`ADS_imp_1_OUT`.impter_232 - 0.0487697431569858) / 1.0362121875167394 AS scaler_232, (`ADS_imp_1_OUT`.impter_233 - -0.05674203944761021) / 1.0094733416405102 AS scaler_233, (`ADS_imp_1_OUT`.impter_234 - -0.016772355037112788) / 0.9819007689885811 AS scaler_234, (`ADS_imp_1_OUT`.impter_235 - 0.021959192758732798) / 0.987918747045171 AS scaler_235, (`ADS_imp_1_OUT`.impter_236 - 0.009017510252386856) / 0.9874581776631882 AS scaler_236, (`ADS_imp_1_OUT`.impter_237 - 0.01719604397851632) / 0.992097179565061 AS scaler_237, (`ADS_imp_1_OUT`.impter_238 - 0.04752740880676183) / 0.9503833389031566 AS scaler_238, (`ADS_imp_1_OUT`.impter_239 - -0.6655794242164356) / 5.840051151687372 AS scaler_239, (`ADS_imp_1_OUT`.impter_240 - 0.040740002170661385) / 0.9668784340640053 AS scaler_240, (`ADS_imp_1_OUT`.impter_241 - -0.06790575667026853) / 0.9921903875597816 AS scaler_241, (`ADS_imp_1_OUT`.impter_242 - 0.00892920073818756) / 0.9953681335039088 AS scaler_242, (`ADS_imp_1_OUT`.impter_243 - -0.05642200650387437) / 1.080975513720933 AS scaler_243, (`ADS_imp_1_OUT`.impter_244 - 0.020080371219515784) / 1.0268320872033798 AS scaler_244, (`ADS_imp_1_OUT`.impter_245 - -0.08127236320512923) / 5.713688044684489 AS scaler_245, (`ADS_imp_1_OUT`.impter_246 - 0.013048668554363934) / 0.9840522233556672 AS scaler_246, (`ADS_imp_1_OUT`.impter_247 - 0.018841776335809746) / 0.9955454249138418 AS scaler_247, (`ADS_imp_1_OUT`.impter_248 - -0.005693217051300183) / 0.9944510267281536 AS scaler_248, (`ADS_imp_1_OUT`.impter_249 - -0.20394320931579465) / 5.772507892550791 AS scaler_249, (`ADS_imp_1_OUT`.impter_250 - -0.022446042990387664) / 1.0021361970741969 AS scaler_250, (`ADS_imp_1_OUT`.impter_251 - -4.076861252102798) / 34.2608991859537 AS scaler_251, (`ADS_imp_1_OUT`.impter_252 - -0.008817990550602733) / 1.0009581126868368 AS scaler_252, (`ADS_imp_1_OUT`.impter_253 - 0.07233780023230166) / 1.0333507786448697 AS scaler_253, (`ADS_imp_1_OUT`.impter_254 - 0.1138593990290942) / 5.886028350311137 AS scaler_254, (`ADS_imp_1_OUT`.impter_255 - -0.014123411384636636) / 0.9733196343517111 AS scaler_255, (`ADS_imp_1_OUT`.impter_256 - 0.014692128598930085) / 0.9620465679496903 AS scaler_256, (`ADS_imp_1_OUT`.impter_257 - 0.04595744723507997) / 0.9944842107666862 AS scaler_257, (`ADS_imp_1_OUT`.impter_258 - 0.015847884802623332) / 0.9910298990373428 AS scaler_258, (`ADS_imp_1_OUT`.impter_259 - 0.029322592909880204) / 1.0351113561261698 AS scaler_259, (`ADS_imp_1_OUT`.impter_260 - -0.03535258574843743) / 0.9316972257033983 AS scaler_260, (`ADS_imp_1_OUT`.impter_261 - -0.00650490190973122) / 0.9882615820765778 AS scaler_261, (`ADS_imp_1_OUT`.impter_262 - -0.03690470759934596) / 0.9949501210533109 AS scaler_262, (`ADS_imp_1_OUT`.impter_263 - -0.003181913166654664) / 0.9608914472397853 AS scaler_263, (`ADS_imp_1_OUT`.impter_264 - -0.0018035463835158838) / 0.9594115161166091 AS scaler_264, (`ADS_imp_1_OUT`.impter_265 - -0.004968061346310874) / 0.9841069876999591 AS scaler_265, (`ADS_imp_1_OUT`.impter_266 - -0.45419983150371857) / 5.83691454179742 AS scaler_266, (`ADS_imp_1_OUT`.impter_267 - 0.033791499419119894) / 0.9623098813915759 AS scaler_267, (`ADS_imp_1_OUT`.impter_268 - -0.40319293830766156) / 6.005116172706997 AS scaler_268, (`ADS_imp_1_OUT`.impter_269 - 0.6187460938207908) / 5.740858978880372 AS scaler_269, (`ADS_imp_1_OUT`.impter_270 - 0.622898951615882) / 5.837149612935237 AS scaler_270, (`ADS_imp_1_OUT`.impter_271 - -0.018232408103028765) / 1.0237582924270276 AS scaler_271, (`ADS_imp_1_OUT`.impter_272 - 0.01765800846800944) / 1.0369091422036907 AS scaler_272, (`ADS_imp_1_OUT`.impter_273 - -0.7754580279730494) / 5.650111104165515 AS scaler_273, (`ADS_imp_1_OUT`.impter_274 - -0.008494942988361138) / 0.9876490295553434 AS scaler_274, (`ADS_imp_1_OUT`.impter_275 - 0.06500802952263218) / 0.9938061896804096 AS scaler_275, (`ADS_imp_1_OUT`.impter_276 - 0.004846639297532018) / 0.9815019873684769 AS scaler_276, (`ADS_imp_1_OUT`.impter_277 - 0.31959901606775876) / 6.04265682063885 AS scaler_277, (`ADS_imp_1_OUT`.impter_278 - 0.06335285521269475) / 1.030255161135722 AS scaler_278, (`ADS_imp_1_OUT`.impter_279 - 0.05639859786390925) / 0.9704986281233102 AS scaler_279, (`ADS_imp_1_OUT`.impter_280 - -0.016826126115809636) / 0.9158313868217967 AS scaler_280, (`ADS_imp_1_OUT`.impter_281 - -0.035868631202668005) / 1.0109275682906786 AS scaler_281, (`ADS_imp_1_OUT`.impter_282 - 0.5939567726507027) / 6.134862342485855 AS scaler_282, (`ADS_imp_1_OUT`.impter_283 - -0.018499482983219337) / 0.9944840357762763 AS scaler_283, (`ADS_imp_1_OUT`.impter_284 - -0.002126060350638963) / 0.9778447419013441 AS scaler_284, (`ADS_imp_1_OUT`.impter_285 - 0.43749055924133856) / 5.851416241071843 AS scaler_285, (`ADS_imp_1_OUT`.impter_286 - -0.002792990485326514) / 1.0100816164740944 AS scaler_286, (`ADS_imp_1_OUT`.impter_287 - 0.05111067471537181) / 1.0268046765512155 AS scaler_287, (`ADS_imp_1_OUT`.impter_288 - 0.01652404135719371) / 1.0028252297771558 AS scaler_288, (`ADS_imp_1_OUT`.impter_289 - 0.046881980038056) / 0.9760255592175245 AS scaler_289, (`ADS_imp_1_OUT`.impter_290 - -0.21093566587728044) / 5.894017797300676 AS scaler_290, (`ADS_imp_1_OUT`.impter_291 - -0.38235732593808275) / 6.050957848475724 AS scaler_291, (`ADS_imp_1_OUT`.impter_292 - 0.07184577295054764) / 1.0317735699072899 AS scaler_292, (`ADS_imp_1_OUT`.impter_293 - 0.04617448263239929) / 1.008695230198085 AS scaler_293, (`ADS_imp_1_OUT`.impter_294 - -0.08558825454913567) / 0.9612556638919216 AS scaler_294, (`ADS_imp_1_OUT`.impter_295 - 0.03845417409897625) / 0.9634658509822347 AS scaler_295, (`ADS_imp_1_OUT`.impter_296 - 0.0010861389762425358) / 0.9878011845177224 AS scaler_296, (`ADS_imp_1_OUT`.impter_297 - 0.0013036543004699376) / 0.9802325604692824 AS scaler_297, (`ADS_imp_1_OUT`.impter_298 - -0.04572115009336087) / 0.9966809765564838 AS scaler_298, (`ADS_imp_1_OUT`.impter_299 - 0.109011335964655) / 5.862835709214262 AS scaler_299, (`ADS_imp_1_OUT`.impter_300 - 0.059388745922670474) / 1.0279151786530831 AS scaler_300, (`ADS_imp_1_OUT`.impter_301 - 0.02796049502507793) / 1.0196445533826572 AS scaler_301, (`ADS_imp_1_OUT`.impter_302 - 0.06765588611224771) / 0.996907552648703 AS scaler_302, (`ADS_imp_1_OUT`.impter_303 - 0.42516463145086364) / 6.021798926740255 AS scaler_303, (`ADS_imp_1_OUT`.impter_304 - -0.025755583751806005) / 0.9677777967417204 AS scaler_304, (`ADS_imp_1_OUT`.impter_305 - 0.05983631292026072) / 0.9714721805811518 AS scaler_305, (`ADS_imp_1_OUT`.impter_306 - -0.022966826151323574) / 0.9944894903866501 AS scaler_306, (`ADS_imp_1_OUT`.impter_307 - -0.025059373911550786) / 1.0097409585083836 AS scaler_307, (`ADS_imp_1_OUT`.impter_308 - -0.07477780703395227) / 1.0100566533671511 AS scaler_308, (`ADS_imp_1_OUT`.impter_309 - 0.005214344538572354) / 0.9837893167281717 AS scaler_309, (`ADS_imp_1_OUT`.impter_310 - 0.15069860934029664) / 5.735011156781238 AS scaler_310, (`ADS_imp_1_OUT`.impter_311 - 0.0920648545309688) / 1.0065402771379437 AS scaler_311, (`ADS_imp_1_OUT`.impter_312 - 0.02872039649838287) / 0.9784906033450759 AS scaler_312, (`ADS_imp_1_OUT`.impter_313 - 0.027206434346339497) / 0.9991615732109751 AS scaler_313, (`ADS_imp_1_OUT`.impter_314 - 0.006348743003703792) / 0.963185353898001 AS scaler_314, (`ADS_imp_1_OUT`.impter_315 - -0.05402460092901892) / 1.0519822785818902 AS scaler_315, (`ADS_imp_1_OUT`.impter_316 - 0.027029051133963092) / 0.9775996545554246 AS scaler_316, (`ADS_imp_1_OUT`.impter_317 - -0.0064650471205589975) / 1.0402075183971329 AS scaler_317, (`ADS_imp_1_OUT`.impter_318 - -0.043335487666484804) / 1.0011278238556536 AS scaler_318, (`ADS_imp_1_OUT`.impter_319 - 0.04481518768554344) / 0.9722446609062138 AS scaler_319, (`ADS_imp_1_OUT`.impter_320 - 0.004584500412058787) / 1.0262858605349432 AS scaler_320, (`ADS_imp_1_OUT`.impter_321 - -0.001027021710811342) / 0.9919602897367665 AS scaler_321, (`ADS_imp_1_OUT`.impter_322 - -0.03706762371695285) / 0.9474832242940362 AS scaler_322, (`ADS_imp_1_OUT`.impter_323 - -0.01578014654880059) / 0.9898649027094482 AS scaler_323, (`ADS_imp_1_OUT`.impter_324 - -0.06476010801389685) / 0.9782346350213528 AS scaler_324, (`ADS_imp_1_OUT`.impter_325 - 0.013158594346038825) / 1.0495582938116077 AS scaler_325, (`ADS_imp_1_OUT`.impter_326 - -0.6909561374047029) / 5.746508659742815 AS scaler_326, (`ADS_imp_1_OUT`.impter_327 - -0.032307395882269586) / 0.9535832586619137 AS scaler_327, (`ADS_imp_1_OUT`.impter_328 - 0.001871548534192734) / 0.9815964798775456 AS scaler_328, (`ADS_imp_1_OUT`.impter_329 - 0.009014081196377208) / 0.9660287896470228 AS scaler_329, (`ADS_imp_1_OUT`.impter_330 - 0.08432204289520576) / 1.0097164483499368 AS scaler_330, (`ADS_imp_1_OUT`.impter_331 - 0.03098818000424445) / 1.0130270342045389 AS scaler_331, (`ADS_imp_1_OUT`.impter_332 - 0.017842106547205465) / 0.993655606972685 AS scaler_332, (`ADS_imp_1_OUT`.impter_333 - 0.009830954519062886) / 5.92553450726784 AS scaler_333, (`ADS_imp_1_OUT`.impter_334 - 0.018857904928326345) / 0.9911886384867388 AS scaler_334, (`ADS_imp_1_OUT`.impter_335 - -0.09041919658309759) / 6.294466825822825 AS scaler_335, (`ADS_imp_1_OUT`.impter_336 - -0.0030938413689644926) / 0.9761716888106455 AS scaler_336, (`ADS_imp_1_OUT`.impter_337 - 0.06013463236860367) / 1.0011483068873699 AS scaler_337, (`ADS_imp_1_OUT`.impter_338 - -0.006783134159713595) / 0.9722970432848048 AS scaler_338, (`ADS_imp_1_OUT`.impter_339 - -0.022505432033342578) / 1.0089265011933541 AS scaler_339, (`ADS_imp_1_OUT`.impter_340 - 0.012902527459674764) / 5.731240866243183 AS scaler_340, (`ADS_imp_1_OUT`.impter_341 - -0.03249915020429405) / 1.044475101185332 AS scaler_341, (`ADS_imp_1_OUT`.impter_342 - -0.03379268322494926) / 0.9927711788351935 AS scaler_342, (`ADS_imp_1_OUT`.impter_343 - 0.006926122620280751) / 0.9801721512833292 AS scaler_343, (`ADS_imp_1_OUT`.impter_344 - -0.03319669654598365) / 1.0182345234275731 AS scaler_344, (`ADS_imp_1_OUT`.impter_345 - 2.7390190345202456) / 34.667875391393046 AS scaler_345, (`ADS_imp_1_OUT`.impter_346 - -0.0075319633963496155) / 0.9979191708443869 AS scaler_346, (`ADS_imp_1_OUT`.impter_347 - 0.022124363701982737) / 0.9808099368402478 AS scaler_347, (`ADS_imp_1_OUT`.impter_348 - -0.023653773851870237) / 1.0003846372052088 AS scaler_348, (`ADS_imp_1_OUT`.impter_349 - -0.01620635032677563) / 1.0105995254781748 AS scaler_349, (`ADS_imp_1_OUT`.impter_350 - -0.021142104441251273) / 1.0221080104646578 AS scaler_350, (`ADS_imp_1_OUT`.impter_351 - -0.06890676984297263) / 1.0082431727106027 AS scaler_351, (`ADS_imp_1_OUT`.impter_352 - 0.006174673936264955) / 1.014439751019311 AS scaler_352, (`ADS_imp_1_OUT`.impter_353 - -0.018480727521201546) / 0.9701951933455762 AS scaler_353, (`ADS_imp_1_OUT`.impter_354 - 0.01892387185297041) / 0.9808278094926718 AS scaler_354, (`ADS_imp_1_OUT`.impter_355 - 0.02727917887836492) / 1.026160540912389 AS scaler_355, (`ADS_imp_1_OUT`.impter_356 - -0.012823623960695998) / 0.9999639298811288 AS scaler_356, (`ADS_imp_1_OUT`.impter_357 - -0.013271487823414667) / 0.9888293309407856 AS scaler_357, (`ADS_imp_1_OUT`.impter_358 - -0.03395939012664646) / 0.9838454170841583 AS scaler_358, (`ADS_imp_1_OUT`.impter_359 - 0.03223004938335937) / 1.0311477237988198 AS scaler_359, (`ADS_imp_1_OUT`.impter_360 - -0.0016017230909337308) / 0.9977131054043721 AS scaler_360, (`ADS_imp_1_OUT`.impter_361 - -0.03321899170282454) / 0.9865478214908777 AS scaler_361, (`ADS_imp_1_OUT`.impter_362 - -0.0016618588765567152) / 0.9890613942697071 AS scaler_362, (`ADS_imp_1_OUT`.impter_363 - 0.04573989570209914) / 1.0180765967750773 AS scaler_363, (`ADS_imp_1_OUT`.impter_364 - -0.021293175937165) / 0.978862030082048 AS scaler_364, (`ADS_imp_1_OUT`.impter_365 - -0.011255144611449622) / 1.0085669156865533 AS scaler_365, (`ADS_imp_1_OUT`.impter_366 - -0.02563865782710232) / 1.0300081363336124 AS scaler_366, (`ADS_imp_1_OUT`.impter_367 - -0.015167083011311294) / 0.9899050483960369 AS scaler_367, (`ADS_imp_1_OUT`.impter_368 - 0.0010959755571049432) / 1.0362907152513867 AS scaler_368, (`ADS_imp_1_OUT`.impter_369 - 0.25830160330800345) / 5.815383768143437 AS scaler_369, (`ADS_imp_1_OUT`.impter_370 - -0.02512420755881165) / 1.0004687101039538 AS scaler_370, (`ADS_imp_1_OUT`.impter_371 - -0.5588992061400131) / 5.788250773541592 AS scaler_371, (`ADS_imp_1_OUT`.impter_372 - 0.04500746078257995) / 1.0086593860246837 AS scaler_372, (`ADS_imp_1_OUT`.impter_373 - -0.03582268471853405) / 1.0018148995353613 AS scaler_373, (`ADS_imp_1_OUT`.impter_374 - -0.0238194811504848) / 1.0251776661707117 AS scaler_374, (`ADS_imp_1_OUT`.impter_375 - 0.00870068158455398) / 1.0334836529068854 AS scaler_375, (`ADS_imp_1_OUT`.impter_376 - 0.41206876337723863) / 5.954218215874292 AS scaler_376, (`ADS_imp_1_OUT`.impter_377 - -0.00883623214870824) / 0.9659875346877604 AS scaler_377, (`ADS_imp_1_OUT`.impter_378 - -0.047673712853857325) / 0.9682385986144871 AS scaler_378, (`ADS_imp_1_OUT`.impter_379 - 0.39808785261614416) / 6.09008828409793 AS scaler_379, (`ADS_imp_1_OUT`.impter_380 - 0.014874268925561847) / 0.9655591180277953 AS scaler_380, (`ADS_imp_1_OUT`.impter_381 - -0.01355994466429737) / 1.0067469722911915 AS scaler_381, (`ADS_imp_1_OUT`.impter_382 - 0.06549584301442803) / 1.0522361938897125 AS scaler_382, (`ADS_imp_1_OUT`.impter_383 - -0.07523712848824068) / 1.0400455118176228 AS scaler_383, (`ADS_imp_1_OUT`.impter_384 - -0.020246425764404403) / 0.99550805592098 AS scaler_384, (`ADS_imp_1_OUT`.impter_385 - -0.06505456712739689) / 1.00815114883143 AS scaler_385, (`ADS_imp_1_OUT`.impter_386 - 0.040682923885247455) / 0.9675621093776584 AS scaler_386, (`ADS_imp_1_OUT`.impter_387 - 0.5036509170142887) / 6.055498495136896 AS scaler_387, (`ADS_imp_1_OUT`.impter_388 - -0.01984269915156025) / 0.9900740889033433 AS scaler_388, (`ADS_imp_1_OUT`.impter_389 - -0.029975294309893395) / 0.9997397749932063 AS scaler_389, (`ADS_imp_1_OUT`.impter_390 - -0.023935150902407186) / 1.00798921844037 AS scaler_390, (`ADS_imp_1_OUT`.impter_391 - 0.003487379328156493) / 1.0044645097371014 AS scaler_391, (`ADS_imp_1_OUT`.impter_392 - -0.006836589678473769) / 0.9763905812172375 AS scaler_392, (`ADS_imp_1_OUT`.impter_393 - -0.023001043810177268) / 0.9698402164080443 AS scaler_393, (`ADS_imp_1_OUT`.impter_394 - 0.026433076987905132) / 1.0299294878585217 AS scaler_394, (`ADS_imp_1_OUT`.impter_395 - 0.03869392603237684) / 1.0186157804435945 AS scaler_395, (`ADS_imp_1_OUT`.impter_396 - 0.007166160812626991) / 0.9843737579570186 AS scaler_396, (`ADS_imp_1_OUT`.impter_397 - -0.31652297140011876) / 6.070605480686376 AS scaler_397, (`ADS_imp_1_OUT`.impter_398 - 0.352192927636602) / 6.099135476868029 AS scaler_398, (`ADS_imp_1_OUT`.impter_399 - 0.2418343422011388) / 5.947824293275464 AS scaler_399, (`ADS_imp_1_OUT`.impter_400 - 0.23681058627355728) / 5.851504662987678 AS scaler_400, (`ADS_imp_1_OUT`.impter_401 - -0.011935061221661204) / 0.9960811072647195 AS scaler_401, (`ADS_imp_1_OUT`.impter_402 - -0.23225071389385885) / 5.877913338764821 AS scaler_402, (`ADS_imp_1_OUT`.impter_403 - 0.027478547688853303) / 0.9788713733340856 AS scaler_403, (`ADS_imp_1_OUT`.impter_404 - -0.2835956440898274) / 5.678310355351206 AS scaler_404, (`ADS_imp_1_OUT`.impter_405 - -0.026966778578135772) / 1.0011958124193499 AS scaler_405, (`ADS_imp_1_OUT`.impter_406 - -0.004329268838175945) / 5.946384673713921 AS scaler_406, (`ADS_imp_1_OUT`.impter_407 - 0.0774540554940731) / 0.9793348754271206 AS scaler_407, (`ADS_imp_1_OUT`.impter_408 - -0.6052203464446785) / 5.817154006812937 AS scaler_408, (`ADS_imp_1_OUT`.impter_409 - 0.0338701304693192) / 0.960463407901455 AS scaler_409, (`ADS_imp_1_OUT`.impter_410 - -0.05044305753803302) / 5.810222734574313 AS scaler_410, (`ADS_imp_1_OUT`.impter_411 - 0.008805453357057883) / 0.9798841614686381 AS scaler_411, (`ADS_imp_1_OUT`.impter_412 - -0.05374724915468808) / 0.9725143886399855 AS scaler_412, (`ADS_imp_1_OUT`.impter_413 - -0.004957359515296269) / 0.9748727609121598 AS scaler_413, (`ADS_imp_1_OUT`.impter_414 - 0.12039061456156476) / 5.880042099618977 AS scaler_414, (`ADS_imp_1_OUT`.impter_415 - -0.005732424778663252) / 1.0091331017994325 AS scaler_415, (`ADS_imp_1_OUT`.impter_416 - -0.4286478678045208) / 5.973293156925994 AS scaler_416, (`ADS_imp_1_OUT`.impter_417 - -0.028516293632594378) / 1.0152913842776887 AS scaler_417, (`ADS_imp_1_OUT`.impter_418 - 0.052380333284906204) / 1.01817218649359 AS scaler_418, (`ADS_imp_1_OUT`.impter_419 - -0.028497248319907256) / 5.847011203913571 AS scaler_419, (`ADS_imp_1_OUT`.impter_420 - -0.012190751471044496) / 1.0251203403698526 AS scaler_420, (`ADS_imp_1_OUT`.impter_421 - 0.014464401907681581) / 1.0492676826138123 AS scaler_421, (`ADS_imp_1_OUT`.impter_422 - -0.17428872440122373) / 5.904567530979285 AS scaler_422, (`ADS_imp_1_OUT`.impter_423 - -0.01773365620191358) / 1.0254922074959463 AS scaler_423, (`ADS_imp_1_OUT`.impter_424 - 0.40558807090091853) / 5.537078097301127 AS scaler_424, (`ADS_imp_1_OUT`.impter_425 - -0.0009022771635855167) / 0.9868008921623722 AS scaler_425, (`ADS_imp_1_OUT`.impter_426 - 0.05739992787057724) / 0.9696129618812115 AS scaler_426, (`ADS_imp_1_OUT`.impter_427 - 0.04850780446682892) / 0.9347455059647907 AS scaler_427, (`ADS_imp_1_OUT`.impter_428 - 0.04555082643401923) / 0.9795902806725212 AS scaler_428, (`ADS_imp_1_OUT`.impter_429 - -0.013088017894457874) / 5.853516696500564 AS scaler_429, (`ADS_imp_1_OUT`.impter_430 - 0.7622987596243614) / 5.976914501060202 AS scaler_430, (`ADS_imp_1_OUT`.impter_431 - 0.06277381315317203) / 1.0530187925965664 AS scaler_431, (`ADS_imp_1_OUT`.impter_432 - -0.00595076348043327) / 5.8761809381575265 AS scaler_432, (`ADS_imp_1_OUT`.impter_433 - -0.019782980673704004) / 1.016060957904549 AS scaler_433, (`ADS_imp_1_OUT`.impter_434 - 0.03813782436434927) / 0.9897709857222856 AS scaler_434, (`ADS_imp_1_OUT`.impter_435 - -0.03361997654906546) / 1.0108026015018525 AS scaler_435, (`ADS_imp_1_OUT`.impter_436 - -0.015449063685126078) / 0.9717326567278565 AS scaler_436, (`ADS_imp_1_OUT`.impter_437 - -0.05083199732740015) / 0.9791071943300053 AS scaler_437, (`ADS_imp_1_OUT`.impter_438 - 0.12294390238132996) / 5.80532595725793 AS scaler_438, (`ADS_imp_1_OUT`.impter_439 - 0.008273480374725027) / 1.0023549695531735 AS scaler_439, (`ADS_imp_1_OUT`.impter_440 - 0.04577021563207708) / 0.9948251301427953 AS scaler_440, (`ADS_imp_1_OUT`.impter_441 - -0.004739394213399075) / 0.9866453331207407 AS scaler_441, (`ADS_imp_1_OUT`.impter_442 - -0.025074465350024163) / 1.0215515668408335 AS scaler_442, (`ADS_imp_1_OUT`.impter_443 - 0.050774082486299194) / 0.9690110808898585 AS scaler_443, (`ADS_imp_1_OUT`.impter_444 - -0.0967069255496831) / 5.631254555346854 AS scaler_444, (`ADS_imp_1_OUT`.impter_445 - -0.007206652069868864) / 0.9728674931147712 AS scaler_445, (`ADS_imp_1_OUT`.impter_446 - 0.03506859491861105) / 1.0282750135426344 AS scaler_446, (`ADS_imp_1_OUT`.impter_447 - -0.00905435452775923) / 1.035287499798065 AS scaler_447, (`ADS_imp_1_OUT`.impter_448 - -0.012006634151227604) / 1.0200794266710214 AS scaler_448, (`ADS_imp_1_OUT`.impter_449 - 0.03145627491797305) / 0.9937879772736924 AS scaler_449, (`ADS_imp_1_OUT`.impter_450 - 0.02517699513431471) / 0.9684040296079491 AS scaler_450, (`ADS_imp_1_OUT`.impter_451 - 0.005640015529596338) / 1.015421580688403 AS scaler_451, (`ADS_imp_1_OUT`.impter_452 - -0.010608619203966895) / 1.0246613022268378 AS scaler_452, (`ADS_imp_1_OUT`.impter_453 - -0.062079998204146586) / 0.9869504608282007 AS scaler_453, (`ADS_imp_1_OUT`.impter_454 - -0.0876770647950911) / 1.0029750629720398 AS scaler_454, (`ADS_imp_1_OUT`.impter_455 - 0.012143657983602962) / 0.9744995952331035 AS scaler_455, (`ADS_imp_1_OUT`.impter_456 - 0.03448739220055286) / 1.0176699342790378 AS scaler_456, (`ADS_imp_1_OUT`.impter_457 - 0.006839876969520017) / 0.987127462042404 AS scaler_457, (`ADS_imp_1_OUT`.impter_458 - -0.1589087203718216) / 5.5807038713007335 AS scaler_458, (`ADS_imp_1_OUT`.impter_459 - 0.45343491151894105) / 5.6176560152403745 AS scaler_459, (`ADS_imp_1_OUT`.impter_460 - -0.007482014986002762) / 1.0334253515710414 AS scaler_460, (`ADS_imp_1_OUT`.impter_461 - -0.0538045349045037) / 0.9960348345876942 AS scaler_461, (`ADS_imp_1_OUT`.impter_462 - 0.006517329526108785) / 1.0021131774599925 AS scaler_462, (`ADS_imp_1_OUT`.impter_463 - -0.3201406707449883) / 5.716416507315997 AS scaler_463, (`ADS_imp_1_OUT`.impter_464 - 0.03164463472773337) / 0.9726515882520317 AS scaler_464, (`ADS_imp_1_OUT`.impter_465 - -0.031827670383012555) / 0.9812532959822754 AS scaler_465, (`ADS_imp_1_OUT`.impter_466 - -0.02220263625319023) / 1.0370390821341966 AS scaler_466, (`ADS_imp_1_OUT`.impter_467 - 0.04918588699743021) / 1.0206054749154756 AS scaler_467, (`ADS_imp_1_OUT`.impter_468 - 0.013873407999629129) / 0.987246490028904 AS scaler_468, (`ADS_imp_1_OUT`.impter_469 - -0.054844779309353775) / 0.9876262037314543 AS scaler_469, (`ADS_imp_1_OUT`.impter_470 - 0.05947169339023267) / 1.0092122222358388 AS scaler_470, (`ADS_imp_1_OUT`.impter_471 - -0.007061332655546885) / 1.0113339937552548 AS scaler_471, (`ADS_imp_1_OUT`.impter_472 - 0.0009227758698022626) / 1.020330749267979 AS scaler_472, (`ADS_imp_1_OUT`.impter_473 - -0.014955268248566689) / 1.0413119364682566 AS scaler_473, (`ADS_imp_1_OUT`.impter_474 - -0.00997364389328803) / 0.9793415870167274 AS scaler_474, (`ADS_imp_1_OUT`.impter_475 - 0.044011886118274696) / 1.0007453076824555 AS scaler_475, (`ADS_imp_1_OUT`.impter_476 - 0.03204255595840591) / 0.988499862882957 AS scaler_476, (`ADS_imp_1_OUT`.impter_477 - -0.028511291715894678) / 1.018673434822483 AS scaler_477, (`ADS_imp_1_OUT`.impter_478 - 0.05235198939025461) / 1.030225026137767 AS scaler_478, (`ADS_imp_1_OUT`.impter_479 - 0.4442463067830223) / 5.635010414681324 AS scaler_479, (`ADS_imp_1_OUT`.impter_480 - -0.0421220588184719) / 0.9772881180874626 AS scaler_480, (`ADS_imp_1_OUT`.impter_481 - -0.06375683381469409) / 0.9807772043168697 AS scaler_481, (`ADS_imp_1_OUT`.impter_482 - 0.09016412133268503) / 5.8772408365208255 AS scaler_482, (`ADS_imp_1_OUT`.impter_483 - -0.021181166332863134) / 1.050621089425892 AS scaler_483, (`ADS_imp_1_OUT`.impter_484 - 0.015134427562764584) / 1.0181907514344235 AS scaler_484, (`ADS_imp_1_OUT`.impter_485 - 0.1458909634165245) / 5.950692941207097 AS scaler_485, (`ADS_imp_1_OUT`.impter_486 - -0.0964936751824616) / 1.025397566101771 AS scaler_486, (`ADS_imp_1_OUT`.impter_487 - -0.0007661343328348244) / 1.0327977666221848 AS scaler_487, (`ADS_imp_1_OUT`.impter_488 - 0.007424472006137845) / 1.0131319009223352 AS scaler_488, (`ADS_imp_1_OUT`.impter_489 - 0.007776565305072426) / 0.9660414885523543 AS scaler_489, (`ADS_imp_1_OUT`.impter_490 - -0.02972669445658546) / 0.9816148436418729 AS scaler_490, (`ADS_imp_1_OUT`.impter_491 - -0.020022098906708034) / 1.0376883862584318 AS scaler_491, (`ADS_imp_1_OUT`.impter_492 - -0.03689120776576418) / 1.0350273972331128 AS scaler_492, (`ADS_imp_1_OUT`.impter_493 - 0.02342654499679442) / 0.9963841480580575 AS scaler_493, (`ADS_imp_1_OUT`.impter_494 - 0.06047072800386204) / 1.013712584435496 AS scaler_494, (`ADS_imp_1_OUT`.impter_495 - 0.02457996835763847) / 1.0206669115005262 AS scaler_495, (`ADS_imp_1_OUT`.impter_496 - -0.0053128065642532255) / 1.0066954008984852 AS scaler_496, (`ADS_imp_1_OUT`.impter_497 - -0.050025880514262516) / 5.692164744670064 AS scaler_497, (`ADS_imp_1_OUT`.impter_498 - -0.055008136401580685) / 0.9868440376092616 AS scaler_498, (`ADS_imp_1_OUT`.impter_499 - -0.46514935213874503) / 5.739355619460631 AS scaler_499, (`ADS_imp_1_OUT`.impter_500 - -0.037847190400891) / 0.9980592109563712 AS scaler_500, (`ADS_imp_1_OUT`.impter_501 - 0.028703608331041793) / 0.9938711909999083 AS scaler_501 
FROM `TMP_20180329233747_01VSI2_ADS_imp_1_OUT` AS `ADS_imp_1_OUT`) AS `ADS_sca_2_OUT`) AS `U`
-- Code For temporary table TMP_20180329233750_PY5NPQ_XGB_Sum_B0 part 1/2. Create 


CREATE TEMPORARY TABLE `TMP_20180329233750_PY5NPQ_XGB_Sum_B0` (
	`KEY` BIGINT, 
	`Score_0` DOUBLE, 
	`Score_1` DOUBLE, 
	`Score_2` DOUBLE, 
 ...
 ENGINE=MEMORY
-- Code For temporary table TMP_20180329233750_PY5NPQ_XGB_Sum_B0 part 2/2. Populate

INSERT INTO `TMP_20180329233750_PY5NPQ_XGB_Sum_B0` (`KEY`, `Score_0`, `Score_1`, `Score_2`, `Score_3`) SELECT `U`.`KEY`, `U`.`Score_0`, `U`.`Score_1`, `U`.`Score_2`, `U`.`Score_3` 
...
FROM `TMP_20180329233748_1E4RGU_ADS_sca_2_OUT` AS `ADS_sca_2_OUT`), 
`DT_node_data` AS 
...
FROM (SELECT 3 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 2 AS depth, 1 AS parent_id, 0.05920000001788139 AS `Score` UNION ALL SELECT 7 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 4 AS parent_id, -0.01216216292232275 AS `Score` UNION ALL SELECT 8 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 4 AS parent_id, -0.05462753772735596 AS `Score` UNION ALL SELECT 9 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 5 AS parent_id, 0.12546584010124207 AS `Score` UNION ALL SELECT 10 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 5 AS parent_id, 0.025242719799280167 AS `Score` UNION ALL SELECT 11 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 6 AS parent_id, 0.04210526496171951 AS `Score` UNION ALL SELECT 12 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 6 AS parent_id, -0.04216216132044792 AS `Score`) AS `Values`), 
`DT_Output` AS 
...
`DT_node_data_1` AS 
(SELECT `Values`.node_id AS node_id, `Values`.feature AS feature, `Values`.threshold AS threshold, `Values`.depth AS depth, `Values`.parent_id AS parent_id, `Values`.`Score` AS `Score` 
FROM (SELECT 5 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 2 AS depth, 2 AS parent_id, 0.06526315957307816 AS `Score` UNION ALL SELECT 7 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 3 AS parent_id, -0.011891892179846764 AS `Score` UNION ALL SELECT 8 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 3 AS parent_id, 0.0736842080950737 AS `Score` UNION ALL SELECT 9 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 4 AS parent_id, 0.03622047230601311 AS `Score` UNION ALL SELECT 10 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 4 AS parent_id, -0.03538767620921135 AS `Score` UNION ALL SELECT 11 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 6 AS parent_id, -0.04019138962030411 AS `Score` UNION ALL SELECT 12 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 6 AS parent_id, 0.02921348251402378 AS `Score`) AS `Values`), 
`DT_Output_1` AS 
...
`DT_node_data_2` AS 
(SELECT `Values`.node_id AS node_id, `Values`.feature AS feature, `Values`.threshold AS threshold, `Values`.depth AS depth, `Values`.parent_id AS parent_id, `Values`.`Score` AS `Score` 
FROM (SELECT 2 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 1 AS depth, 0 AS parent_id, 0.10112359374761581 AS `Score` UNION ALL SELECT 5 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 3 AS parent_id, 0.06077348068356514 AS `Score` UNION ALL SELECT 6 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 3 AS parent_id, -0.009798271581530571 AS `Score` UNION ALL SELECT 7 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 4 AS parent_id, -0.023613085970282555 AS `Score` UNION ALL SELECT 8 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 4 AS parent_id, 0.03050847351551056 AS `Score`) AS `Values`), 
`DT_Output_2` AS 
...
`DT_node_data_3` AS 
(SELECT `Values`.node_id AS node_id, `Values`.feature AS feature, `Values`.threshold AS threshold, `Values`.depth AS depth, `Values`.parent_id AS parent_id, `Values`.`Score` AS `Score` 
FROM (SELECT 4 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 2 AS depth, 1 AS parent_id, 0.09213483333587646 AS `Score` UNION ALL SELECT 7 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 3 AS parent_id, -0.028484387323260307 AS `Score` UNION ALL SELECT 8 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 3 AS parent_id, 0.021761657670140266 AS `Score` UNION ALL SELECT 9 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 5 AS parent_id, 0.0268041230738163 AS `Score` UNION ALL SELECT 10 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 5 AS parent_id, 0.12087912857532501 AS `Score` UNION ALL SELECT 11 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 6 AS parent_id, -0.03251231834292412 AS `Score` UNION ALL SELECT 12 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 6 AS parent_id, 0.056179773062467575 AS `Score`) AS `Values`), 
`DT_Output_3` AS 
...
`DT_node_data_4` AS 
(SELECT `Values`.node_id AS node_id, `Values`.feature AS feature, `Values`.threshold AS threshold, `Values`.depth AS depth, `Values`.parent_id AS parent_id, `Values`.`Score` AS `Score` 
FROM (SELECT 7 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 3 AS parent_id, 0.09607584029436111 AS `Score` UNION ALL SELECT 8 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 3 AS parent_id, -0.015485027804970741 AS `Score` UNION ALL SELECT 9 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 4 AS parent_id, 0.036579057574272156 AS `Score` UNION ALL SELECT 10 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 4 AS parent_id, -0.03371986374258995 AS `Score` UNION ALL SELECT 11 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 5 AS parent_id, -0.0028580992948263884 AS `Score` UNION ALL SELECT 12 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 5 AS parent_id, 0.09570012241601944 AS `Score` UNION ALL SELECT 13 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 6 AS parent_id, 0.026337960734963417 AS `Score` UNION ALL SELECT 14 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 6 AS parent_id, -0.055083002895116806 AS `Score`) AS `Values`), 
`DT_Output_4` AS 
...
`DT_node_data_5` AS 
(SELECT `Values`.node_id AS node_id, `Values`.feature AS feature, `Values`.threshold AS threshold, `Values`.depth AS depth, `Values`.parent_id AS parent_id, `Values`.`Score` AS `Score` 
FROM (SELECT 5 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 2 AS depth, 2 AS parent_id, 0.060418762266635895 AS `Score` UNION ALL SELECT 7 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 3 AS parent_id, -0.038837336003780365 AS `Score` UNION ALL SELECT 8 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 3 AS parent_id, 0.06123846396803856 AS `Score` UNION ALL SELECT 9 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 4 AS parent_id, 0.03360939025878906 AS `Score` UNION ALL SELECT 10 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 4 AS parent_id, -0.034248482435941696 AS `Score` UNION ALL SELECT 11 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 6 AS parent_id, -0.03893665969371796 AS `Score` UNION ALL SELECT 12 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 6 AS parent_id, 0.0278946366161108 AS `Score`) AS `Values`), 
`DT_Output_5` AS 
...
`DT_node_data_6` AS 
(SELECT `Values`.node_id AS node_id, `Values`.feature AS feature, `Values`.threshold AS threshold, `Values`.depth AS depth, `Values`.parent_id AS parent_id, `Values`.`Score` AS `Score` 
FROM (SELECT 2 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 1 AS depth, 0 AS parent_id, 0.09231676906347275 AS `Score` UNION ALL SELECT 5 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 3 AS parent_id, 0.05554412677884102 AS `Score` UNION ALL SELECT 6 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 3 AS parent_id, -0.009215951897203922 AS `Score` UNION ALL SELECT 7 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 4 AS parent_id, -0.022678403183817863 AS `Score` UNION ALL SELECT 8 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 4 AS parent_id, 0.02851615846157074 AS `Score`) AS `Values`), 
`DT_Output_6` AS 
...
`DT_node_data_7` AS 
(SELECT `Values`.node_id AS node_id, `Values`.feature AS feature, `Values`.threshold AS threshold, `Values`.depth AS depth, `Values`.parent_id AS parent_id, `Values`.`Score` AS `Score` 
FROM (SELECT 4 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 2 AS depth, 1 AS parent_id, 0.08377815783023834 AS `Score` UNION ALL SELECT 7 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 3 AS parent_id, -0.027406319975852966 AS `Score` UNION ALL SELECT 8 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 3 AS parent_id, 0.020225640386343002 AS `Score` UNION ALL SELECT 9 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 5 AS parent_id, -0.05653313547372818 AS `Score` UNION ALL SELECT 10 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 5 AS parent_id, 0.0402175672352314 AS `Score` UNION ALL SELECT 11 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 6 AS parent_id, 0.08774640411138535 AS `Score` UNION ALL SELECT 12 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 6 AS parent_id, -0.004126237705349922 AS `Score`) AS `Values`), 
`DT_Output_7` AS 
...
`DT_node_data_8` AS 
(SELECT `Values`.node_id AS node_id, `Values`.feature AS feature, `Values`.threshold AS threshold, `Values`.depth AS depth, `Values`.parent_id AS parent_id, `Values`.`Score` AS `Score` 
FROM (SELECT 7 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 3 AS parent_id, 0.08751743286848068 AS `Score` UNION ALL SELECT 8 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 3 AS parent_id, -0.014539751224219799 AS `Score` UNION ALL SELECT 9 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 4 AS parent_id, 0.03420233353972435 AS `Score` UNION ALL SELECT 10 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 4 AS parent_id, -0.033076170831918716 AS `Score` UNION ALL SELECT 11 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 5 AS parent_id, 0.1084410548210144 AS `Score` UNION ALL SELECT 12 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 5 AS parent_id, 0.025853008031845093 AS `Score` UNION ALL SELECT 13 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 6 AS parent_id, 0.04326630383729935 AS `Score` UNION ALL SELECT 14 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 6 AS parent_id, -0.03935687243938446 AS `Score`) AS `Values`), 
`DT_Output_8` AS 
...
`DT_node_data_9` AS 
(SELECT `Values`.node_id AS node_id, `Values`.feature AS feature, `Values`.threshold AS threshold, `Values`.depth AS depth, `Values`.parent_id AS parent_id, `Values`.`Score` AS `Score` 
FROM (SELECT 4 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 2 AS depth, 1 AS parent_id, 0.03496604785323143 AS `Score` UNION ALL SELECT 7 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 3 AS parent_id, -0.0029430079739540815 AS `Score` UNION ALL SELECT 8 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 3 AS parent_id, -0.04538097605109215 AS `Score` UNION ALL SELECT 9 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 5 AS parent_id, 0.0555804967880249 AS `Score` UNION ALL SELECT 10 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 5 AS parent_id, -0.0031077596358954906 AS `Score` UNION ALL SELECT 11 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 6 AS parent_id, 0.02065952867269516 AS `Score` UNION ALL SELECT 12 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 6 AS parent_id, -0.053802259266376495 AS `Score`) AS `Values`), 
`DT_Output_9` AS 
...
FROM `DT_Output_9`)
 SELECT `XGB_Sum_B0`.`KEY`, `XGB_Sum_B0`.`Score_0`, `XGB_Sum_B0`.`Score_1`, `XGB_Sum_B0`.`Score_2`, `XGB_Sum_B0`.`Score_3` 
...
FROM `XGB_Tree_1_2`) AS `XGB_Sum_esu_0`) AS `XGB_Sum_B0`) AS `U`
-- Code For temporary table TMP_20180329233751_Z07AWV_XGB_Sum_B1 part 1/2. Create 


CREATE TEMPORARY TABLE `TMP_20180329233751_Z07AWV_XGB_Sum_B1` (
	`KEY` BIGINT, 
	`Score_0` DOUBLE, 
	`Score_1` DOUBLE, 
	`Score_2` DOUBLE, 
 ...
 ENGINE=MEMORY
-- Code For temporary table TMP_20180329233751_Z07AWV_XGB_Sum_B1 part 2/2. Populate

INSERT INTO `TMP_20180329233751_Z07AWV_XGB_Sum_B1` (`KEY`, `Score_0`, `Score_1`, `Score_2`, `Score_3`) SELECT `U`.`KEY`, `U`.`Score_0`, `U`.`Score_1`, `U`.`Score_2`, `U`.`Score_3` 
...
`DT_node_data_10` AS 
(SELECT `Values`.node_id AS node_id, `Values`.feature AS feature, `Values`.threshold AS threshold, `Values`.depth AS depth, `Values`.parent_id AS parent_id, `Values`.`Score` AS `Score` 
FROM (SELECT 5 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 2 AS depth, 2 AS parent_id, -0.008790869265794754 AS `Score` UNION ALL SELECT 7 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 3 AS parent_id, 0.06957203149795532 AS `Score` UNION ALL SELECT 8 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 3 AS parent_id, -0.00328349438495934 AS `Score` UNION ALL SELECT 9 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 4 AS parent_id, -0.02921522594988346 AS `Score` UNION ALL SELECT 10 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 4 AS parent_id, 0.02526405267417431 AS `Score` UNION ALL SELECT 11 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 6 AS parent_id, 0.11763137578964233 AS `Score` UNION ALL SELECT 12 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 6 AS parent_id, 0.016481367871165276 AS `Score`) AS `Values`), 
`DT_Output_10` AS 
...
`DT_node_data_11` AS 
(SELECT `Values`.node_id AS node_id, `Values`.feature AS feature, `Values`.threshold AS threshold, `Values`.depth AS depth, `Values`.parent_id AS parent_id, `Values`.`Score` AS `Score` 
FROM (SELECT 4 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 2 AS depth, 1 AS parent_id, 0.07019458711147308 AS `Score` UNION ALL SELECT 7 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 3 AS parent_id, -0.032135557383298874 AS `Score` UNION ALL SELECT 8 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 3 AS parent_id, 0.02072135917842388 AS `Score` UNION ALL SELECT 9 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 5 AS parent_id, 0.022403763607144356 AS `Score` UNION ALL SELECT 10 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 5 AS parent_id, 0.10173390060663223 AS `Score` UNION ALL SELECT 11 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 6 AS parent_id, -0.03216777369379997 AS `Score` UNION ALL SELECT 12 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 6 AS parent_id, 0.05401819944381714 AS `Score`) AS `Values`), 
`DT_Output_11` AS 
...
`DT_node_data_12` AS 
(SELECT `Values`.node_id AS node_id, `Values`.feature AS feature, `Values`.threshold AS threshold, `Values`.depth AS depth, `Values`.parent_id AS parent_id, `Values`.`Score` AS `Score` 
FROM (SELECT 3 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 2 AS depth, 1 AS parent_id, 0.0539310947060585 AS `Score` UNION ALL SELECT 6 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 2 AS depth, 2 AS parent_id, -0.035748425871133804 AS `Score` UNION ALL SELECT 7 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 4 AS parent_id, -0.009767762385308743 AS `Score` UNION ALL SELECT 8 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 4 AS parent_id, -0.05237540602684021 AS `Score` UNION ALL SELECT 9 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 5 AS parent_id, 0.06403710693120956 AS `Score` UNION ALL SELECT 10 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 5 AS parent_id, -0.015579923056066036 AS `Score`) AS `Values`), 
`DT_Output_12` AS 
...
`DT_node_data_13` AS 
(SELECT `Values`.node_id AS node_id, `Values`.feature AS feature, `Values`.threshold AS threshold, `Values`.depth AS depth, `Values`.parent_id AS parent_id, `Values`.`Score` AS `Score` 
FROM (SELECT 7 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 3 AS parent_id, -0.006140175741165876 AS `Score` UNION ALL SELECT 8 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 3 AS parent_id, 0.08732748031616211 AS `Score` UNION ALL SELECT 9 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 4 AS parent_id, 0.024064267054200172 AS `Score` UNION ALL SELECT 10 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 4 AS parent_id, -0.03722305968403816 AS `Score` UNION ALL SELECT 11 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 5 AS parent_id, 0.1003611609339714 AS `Score` UNION ALL SELECT 12 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 5 AS parent_id, 0.018560035154223442 AS `Score` UNION ALL SELECT 13 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 6 AS parent_id, 0.003212355775758624 AS `Score` UNION ALL SELECT 14 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 6 AS parent_id, -0.06216219812631607 AS `Score`) AS `Values`), 
`DT_Output_13` AS 
...
`DT_node_data_14` AS 
(SELECT `Values`.node_id AS node_id, `Values`.feature AS feature, `Values`.threshold AS threshold, `Values`.depth AS depth, `Values`.parent_id AS parent_id, `Values`.`Score` AS `Score` 
FROM (SELECT 6 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 2 AS depth, 2 AS parent_id, 0.01994444988667965 AS `Score` UNION ALL SELECT 7 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 3 AS parent_id, -0.008840427733957767 AS `Score` UNION ALL SELECT 8 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 3 AS parent_id, 0.041015006601810455 AS `Score` UNION ALL SELECT 9 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 4 AS parent_id, -0.008826738223433495 AS `Score` UNION ALL SELECT 10 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 4 AS parent_id, 0.11533724516630173 AS `Score` UNION ALL SELECT 11 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 5 AS parent_id, 0.005022657569497824 AS `Score` UNION ALL SELECT 12 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 5 AS parent_id, -0.05824700742959976 AS `Score`) AS `Values`), 
`DT_Output_14` AS 
...
`DT_node_data_15` AS 
(SELECT `Values`.node_id AS node_id, `Values`.feature AS feature, `Values`.threshold AS threshold, `Values`.depth AS depth, `Values`.parent_id AS parent_id, `Values`.`Score` AS `Score` 
FROM (SELECT 7 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 3 AS parent_id, 0.08119431883096695 AS `Score` UNION ALL SELECT 8 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 3 AS parent_id, -0.016958048567175865 AS `Score` UNION ALL SELECT 9 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 4 AS parent_id, -0.04894222691655159 AS `Score` UNION ALL SELECT 10 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 4 AS parent_id, 0.020774265751242638 AS `Score` UNION ALL SELECT 11 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 5 AS parent_id, 0.05959690362215042 AS `Score` UNION ALL SELECT 12 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 5 AS parent_id, -0.015349075198173523 AS `Score` UNION ALL SELECT 13 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 6 AS parent_id, -0.028858020901679993 AS `Score` UNION ALL SELECT 14 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 6 AS parent_id, 0.05386820062994957 AS `Score`) AS `Values`), 
`DT_Output_15` AS 
...
`DT_node_data_16` AS 
(SELECT `Values`.node_id AS node_id, `Values`.feature AS feature, `Values`.threshold AS threshold, `Values`.depth AS depth, `Values`.parent_id AS parent_id, `Values`.`Score` AS `Score` 
FROM (SELECT 7 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 3 AS parent_id, 0.020459771156311035 AS `Score` UNION ALL SELECT 8 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 3 AS parent_id, -0.04557105898857117 AS `Score` UNION ALL SELECT 9 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 4 AS parent_id, 0.0067214989103376865 AS `Score` UNION ALL SELECT 10 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 4 AS parent_id, 0.07771588116884232 AS `Score` UNION ALL SELECT 11 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 5 AS parent_id, -0.04140172526240349 AS `Score` UNION ALL SELECT 12 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 5 AS parent_id, -0.06321712583303452 AS `Score` UNION ALL SELECT 13 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 6 AS parent_id, -0.02933119609951973 AS `Score` UNION ALL SELECT 14 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 6 AS parent_id, 0.014158675447106361 AS `Score`) AS `Values`), 
`DT_Output_16` AS 
...
`DT_node_data_17` AS 
(SELECT `Values`.node_id AS node_id, `Values`.feature AS feature, `Values`.threshold AS threshold, `Values`.depth AS depth, `Values`.parent_id AS parent_id, `Values`.`Score` AS `Score` 
FROM (SELECT 4 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 2 AS depth, 1 AS parent_id, 0.03261200338602066 AS `Score` UNION ALL SELECT 7 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 3 AS parent_id, 0.0077640279196202755 AS `Score` UNION ALL SELECT 8 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 3 AS parent_id, -0.03985454514622688 AS `Score` UNION ALL SELECT 9 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 5 AS parent_id, -0.02903418242931366 AS `Score` UNION ALL SELECT 10 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 5 AS parent_id, 0.02366705611348152 AS `Score` UNION ALL SELECT 11 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 6 AS parent_id, 0.07306354492902756 AS `Score` UNION ALL SELECT 12 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 6 AS parent_id, 0.006304766982793808 AS `Score`) AS `Values`), 
`DT_Output_17` AS 
...
`DT_node_data_18` AS 
(SELECT `Values`.node_id AS node_id, `Values`.feature AS feature, `Values`.threshold AS threshold, `Values`.depth AS depth, `Values`.parent_id AS parent_id, `Values`.`Score` AS `Score` 
FROM (SELECT 6 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 2 AS depth, 2 AS parent_id, 0.025553598999977112 AS `Score` UNION ALL SELECT 7 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 3 AS parent_id, 0.0065133883617818356 AS `Score` UNION ALL SELECT 8 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 3 AS parent_id, 0.06424790620803833 AS `Score` UNION ALL SELECT 9 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 4 AS parent_id, 0.041815135627985 AS `Score` UNION ALL SELECT 10 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 4 AS parent_id, -0.030325932428240776 AS `Score` UNION ALL SELECT 11 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 5 AS parent_id, -0.06116143614053726 AS `Score` UNION ALL SELECT 12 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 5 AS parent_id, -0.010125948116183281 AS `Score`) AS `Values`), 
`DT_Output_18` AS 
...
`DT_node_data_19` AS 
(SELECT `Values`.node_id AS node_id, `Values`.feature AS feature, `Values`.threshold AS threshold, `Values`.depth AS depth, `Values`.parent_id AS parent_id, `Values`.`Score` AS `Score` 
FROM (SELECT 3 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 2 AS depth, 1 AS parent_id, 0.04129407927393913 AS `Score` UNION ALL SELECT 7 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 4 AS parent_id, 0.02183225192129612 AS `Score` UNION ALL SELECT 8 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 4 AS parent_id, -0.042290374636650085 AS `Score` UNION ALL SELECT 9 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 5 AS parent_id, 0.05490966513752937 AS `Score` UNION ALL SELECT 10 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 5 AS parent_id, -0.01460323017090559 AS `Score` UNION ALL SELECT 11 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 6 AS parent_id, -0.027788743376731873 AS `Score` UNION ALL SELECT 12 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 6 AS parent_id, 0.049577005207538605 AS `Score`) AS `Values`), 
`DT_Output_19` AS 
...
FROM `DT_Output_19`)
 SELECT `XGB_Sum_B1`.`KEY`, `XGB_Sum_B1`.`Score_0`, `XGB_Sum_B1`.`Score_1`, `XGB_Sum_B1`.`Score_2`, `XGB_Sum_B1`.`Score_3` 
...
FROM `XGB_Tree_3_4`) AS `XGB_Sum_esu_1`) AS `XGB_Sum_B1`) AS `U`
-- Code For temporary table TMP_20180329233751_JQRNCM_XGB_Sum_B2 part 1/2. Create 


CREATE TEMPORARY TABLE `TMP_20180329233751_JQRNCM_XGB_Sum_B2` (
	`KEY` BIGINT, 
	`Score_0` DOUBLE, 
	`Score_1` DOUBLE, 
	`Score_2` DOUBLE, 
 ...
 ENGINE=MEMORY
-- Code For temporary table TMP_20180329233751_JQRNCM_XGB_Sum_B2 part 2/2. Populate

INSERT INTO `TMP_20180329233751_JQRNCM_XGB_Sum_B2` (`KEY`, `Score_0`, `Score_1`, `Score_2`, `Score_3`) SELECT `U`.`KEY`, `U`.`Score_0`, `U`.`Score_1`, `U`.`Score_2`, `U`.`Score_3` 
...
`DT_node_data_20` AS 
(SELECT `Values`.node_id AS node_id, `Values`.feature AS feature, `Values`.threshold AS threshold, `Values`.depth AS depth, `Values`.parent_id AS parent_id, `Values`.`Score` AS `Score` 
FROM (SELECT 7 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 3 AS parent_id, 0.005827127490192652 AS `Score` UNION ALL SELECT 8 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 3 AS parent_id, -0.04967145994305611 AS `Score` UNION ALL SELECT 9 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 4 AS parent_id, -0.014985725283622742 AS `Score` UNION ALL SELECT 10 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 4 AS parent_id, 0.04004320874810219 AS `Score` UNION ALL SELECT 11 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 5 AS parent_id, 0.06753060221672058 AS `Score` UNION ALL SELECT 12 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 5 AS parent_id, -0.020782005041837692 AS `Score` UNION ALL SELECT 13 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 6 AS parent_id, 0.03853040933609009 AS `Score` UNION ALL SELECT 14 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 6 AS parent_id, -0.03884701803326607 AS `Score`) AS `Values`), 
`DT_Output_20` AS 
...
`DT_node_data_21` AS 
(SELECT `Values`.node_id AS node_id, `Values`.feature AS feature, `Values`.threshold AS threshold, `Values`.depth AS depth, `Values`.parent_id AS parent_id, `Values`.`Score` AS `Score` 
FROM (SELECT 5 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 2 AS depth, 2 AS parent_id, 0.055492497980594635 AS `Score` UNION ALL SELECT 7 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 3 AS parent_id, -0.014772066846489906 AS `Score` UNION ALL SELECT 8 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 3 AS parent_id, 0.05612778291106224 AS `Score` UNION ALL SELECT 9 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 4 AS parent_id, 0.04864121600985527 AS `Score` UNION ALL SELECT 10 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 4 AS parent_id, -0.02466900274157524 AS `Score` UNION ALL SELECT 11 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 6 AS parent_id, 0.016786513850092888 AS `Score` UNION ALL SELECT 12 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 6 AS parent_id, -0.03829443082213402 AS `Score`) AS `Values`), 
`DT_Output_21` AS 
...
`DT_node_data_22` AS 
(SELECT `Values`.node_id AS node_id, `Values`.feature AS feature, `Values`.threshold AS threshold, `Values`.depth AS depth, `Values`.parent_id AS parent_id, `Values`.`Score` AS `Score` 
FROM (SELECT 7 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 3 AS parent_id, -0.03930896148085594 AS `Score` UNION ALL SELECT 8 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 3 AS parent_id, 0.0341477207839489 AS `Score` UNION ALL SELECT 9 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 4 AS parent_id, 0.08851488679647446 AS `Score` UNION ALL SELECT 10 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 4 AS parent_id, -0.02764022722840309 AS `Score` UNION ALL SELECT 11 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 5 AS parent_id, -0.02090100757777691 AS `Score` UNION ALL SELECT 12 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 5 AS parent_id, 0.02413676492869854 AS `Score` UNION ALL SELECT 13 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 6 AS parent_id, -0.03247928246855736 AS `Score` UNION ALL SELECT 14 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 6 AS parent_id, -0.06310635060071945 AS `Score`) AS `Values`), 
`DT_Output_22` AS 
...
`DT_node_data_23` AS 
(SELECT `Values`.node_id AS node_id, `Values`.feature AS feature, `Values`.threshold AS threshold, `Values`.depth AS depth, `Values`.parent_id AS parent_id, `Values`.`Score` AS `Score` 
FROM (SELECT 7 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 3 AS parent_id, 0.02124437503516674 AS `Score` UNION ALL SELECT 8 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 3 AS parent_id, -0.037389639765024185 AS `Score` UNION ALL SELECT 9 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 4 AS parent_id, 0.10131223499774933 AS `Score` UNION ALL SELECT 10 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 4 AS parent_id, 0.00032100858516059816 AS `Score` UNION ALL SELECT 11 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 5 AS parent_id, 0.018852492794394493 AS `Score` UNION ALL SELECT 12 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 5 AS parent_id, -0.055776603519916534 AS `Score` UNION ALL SELECT 13 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 6 AS parent_id, 0.01070458721369505 AS `Score` UNION ALL SELECT 14 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 6 AS parent_id, 0.07096356153488159 AS `Score`) AS `Values`), 
`DT_Output_23` AS 
...
`DT_node_data_24` AS 
(SELECT `Values`.node_id AS node_id, `Values`.feature AS feature, `Values`.threshold AS threshold, `Values`.depth AS depth, `Values`.parent_id AS parent_id, `Values`.`Score` AS `Score` 
FROM (SELECT 5 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 2 AS depth, 2 AS parent_id, -0.032145921140909195 AS `Score` UNION ALL SELECT 6 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 2 AS depth, 2 AS parent_id, -0.0624430850148201 AS `Score` UNION ALL SELECT 7 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 3 AS parent_id, 0.018838828429579735 AS `Score` UNION ALL SELECT 8 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 3 AS parent_id, -0.028550544753670692 AS `Score` UNION ALL SELECT 9 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 4 AS parent_id, 0.07398908585309982 AS `Score` UNION ALL SELECT 10 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 4 AS parent_id, 0.0016125008696690202 AS `Score`) AS `Values`), 
`DT_Output_24` AS 
...
`DT_node_data_25` AS 
(SELECT `Values`.node_id AS node_id, `Values`.feature AS feature, `Values`.threshold AS threshold, `Values`.depth AS depth, `Values`.parent_id AS parent_id, `Values`.`Score` AS `Score` 
FROM (SELECT 7 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 3 AS parent_id, -0.007662423886358738 AS `Score` UNION ALL SELECT 8 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 3 AS parent_id, 0.07232296466827393 AS `Score` UNION ALL SELECT 9 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 4 AS parent_id, 0.02757134847342968 AS `Score` UNION ALL SELECT 10 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 4 AS parent_id, -0.03524799272418022 AS `Score` UNION ALL SELECT 11 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 5 AS parent_id, 0.05534548684954643 AS `Score` UNION ALL SELECT 12 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 5 AS parent_id, -0.020572006702423096 AS `Score` UNION ALL SELECT 13 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 6 AS parent_id, 0.010050288401544094 AS `Score` UNION ALL SELECT 14 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 6 AS parent_id, -0.05646098405122757 AS `Score`) AS `Values`), 
`DT_Output_25` AS 
...
`DT_node_data_26` AS 
(SELECT `Values`.node_id AS node_id, `Values`.feature AS feature, `Values`.threshold AS threshold, `Values`.depth AS depth, `Values`.parent_id AS parent_id, `Values`.`Score` AS `Score` 
FROM (SELECT 6 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 2 AS depth, 2 AS parent_id, 0.018265990540385246 AS `Score` UNION ALL SELECT 7 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 3 AS parent_id, 0.031242886558175087 AS `Score` UNION ALL SELECT 8 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 3 AS parent_id, -0.022838179022073746 AS `Score` UNION ALL SELECT 9 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 4 AS parent_id, 0.05887241289019585 AS `Score` UNION ALL SELECT 10 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 4 AS parent_id, -0.004729592707008123 AS `Score` UNION ALL SELECT 11 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 5 AS parent_id, 0.001367178512737155 AS `Score` UNION ALL SELECT 12 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 5 AS parent_id, -0.055925171822309494 AS `Score`) AS `Values`), 
`DT_Output_26` AS 
...
`DT_node_data_27` AS 
(SELECT `Values`.node_id AS node_id, `Values`.feature AS feature, `Values`.threshold AS threshold, `Values`.depth AS depth, `Values`.parent_id AS parent_id, `Values`.`Score` AS `Score` 
FROM (SELECT 7 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 3 AS parent_id, -0.03846694156527519 AS `Score` UNION ALL SELECT 8 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 3 AS parent_id, 0.026645613834261894 AS `Score` UNION ALL SELECT 9 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 4 AS parent_id, -0.040703337639570236 AS `Score` UNION ALL SELECT 10 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 4 AS parent_id, 0.031859587877988815 AS `Score` UNION ALL SELECT 11 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 5 AS parent_id, -0.047432608902454376 AS `Score` UNION ALL SELECT 12 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 5 AS parent_id, 0.024984678253531456 AS `Score` UNION ALL SELECT 13 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 6 AS parent_id, 0.10632475465536118 AS `Score` UNION ALL SELECT 14 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 6 AS parent_id, 0.021915655583143234 AS `Score`) AS `Values`), 
`DT_Output_27` AS 
...
`DT_node_data_28` AS 
(SELECT `Values`.node_id AS node_id, `Values`.feature AS feature, `Values`.threshold AS threshold, `Values`.depth AS depth, `Values`.parent_id AS parent_id, `Values`.`Score` AS `Score` 
FROM (SELECT 5 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 2 AS depth, 2 AS parent_id, 0.05247628316283226 AS `Score` UNION ALL SELECT 7 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 3 AS parent_id, 0.01908094994723797 AS `Score` UNION ALL SELECT 8 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 3 AS parent_id, -0.04317503795027733 AS `Score` UNION ALL SELECT 9 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 4 AS parent_id, -0.03309667110443115 AS `Score` UNION ALL SELECT 10 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 4 AS parent_id, 0.0563591793179512 AS `Score` UNION ALL SELECT 11 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 6 AS parent_id, -0.026884019374847412 AS `Score` UNION ALL SELECT 12 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 6 AS parent_id, 0.05531301721930504 AS `Score`) AS `Values`), 
`DT_Output_28` AS 
...
`DT_node_data_29` AS 
(SELECT `Values`.node_id AS node_id, `Values`.feature AS feature, `Values`.threshold AS threshold, `Values`.depth AS depth, `Values`.parent_id AS parent_id, `Values`.`Score` AS `Score` 
FROM (SELECT 3 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 2 AS depth, 1 AS parent_id, 0.04639516770839691 AS `Score` UNION ALL SELECT 7 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 4 AS parent_id, 0.007881796918809414 AS `Score` UNION ALL SELECT 8 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 4 AS parent_id, -0.03795294463634491 AS `Score` UNION ALL SELECT 9 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 5 AS parent_id, 0.005231713410466909 AS `Score` UNION ALL SELECT 10 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 5 AS parent_id, 0.05576380714774132 AS `Score` UNION ALL SELECT 11 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 6 AS parent_id, 0.018933577463030815 AS `Score` UNION ALL SELECT 12 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 6 AS parent_id, -0.0517868809401989 AS `Score`) AS `Values`), 
`DT_Output_29` AS 
...
FROM `DT_Output_29`)
 SELECT `XGB_Sum_B2`.`KEY`, `XGB_Sum_B2`.`Score_0`, `XGB_Sum_B2`.`Score_1`, `XGB_Sum_B2`.`Score_2`, `XGB_Sum_B2`.`Score_3` 
...
FROM `XGB_Tree_1_7`) AS `XGB_Sum_esu_2`) AS `XGB_Sum_B2`) AS `U`
-- Code For temporary table TMP_20180329233751_78LP1X_XGB_Sum_B3 part 1/2. Create 


CREATE TEMPORARY TABLE `TMP_20180329233751_78LP1X_XGB_Sum_B3` (
	`KEY` BIGINT, 
	`Score_0` DOUBLE, 
	`Score_1` DOUBLE, 
	`Score_2` DOUBLE, 
 ...
 ENGINE=MEMORY
-- Code For temporary table TMP_20180329233751_78LP1X_XGB_Sum_B3 part 2/2. Populate

INSERT INTO `TMP_20180329233751_78LP1X_XGB_Sum_B3` (`KEY`, `Score_0`, `Score_1`, `Score_2`, `Score_3`) SELECT `U`.`KEY`, `U`.`Score_0`, `U`.`Score_1`, `U`.`Score_2`, `U`.`Score_3` 
...
`DT_node_data_30` AS 
(SELECT `Values`.node_id AS node_id, `Values`.feature AS feature, `Values`.threshold AS threshold, `Values`.depth AS depth, `Values`.parent_id AS parent_id, `Values`.`Score` AS `Score` 
FROM (SELECT 5 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 2 AS depth, 2 AS parent_id, 0.024335045367479324 AS `Score` UNION ALL SELECT 7 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 3 AS parent_id, 0.0031183697283267975 AS `Score` UNION ALL SELECT 8 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 3 AS parent_id, -0.0484158881008625 AS `Score` UNION ALL SELECT 9 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 4 AS parent_id, 0.04696567729115486 AS `Score` UNION ALL SELECT 10 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 4 AS parent_id, 0.0012184703955426812 AS `Score` UNION ALL SELECT 11 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 6 AS parent_id, -0.009236279875040054 AS `Score` UNION ALL SELECT 12 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 6 AS parent_id, -0.05990893766283989 AS `Score`) AS `Values`), 
`DT_Output_30` AS 
...
`DT_node_data_31` AS 
(SELECT `Values`.node_id AS node_id, `Values`.feature AS feature, `Values`.threshold AS threshold, `Values`.depth AS depth, `Values`.parent_id AS parent_id, `Values`.`Score` AS `Score` 
FROM (SELECT 4 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 2 AS depth, 1 AS parent_id, 0.07135328650474548 AS `Score` UNION ALL SELECT 7 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 3 AS parent_id, 0.008150999434292316 AS `Score` UNION ALL SELECT 8 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 3 AS parent_id, -0.030088474974036217 AS `Score` UNION ALL SELECT 9 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 5 AS parent_id, -0.05484221503138542 AS `Score` UNION ALL SELECT 10 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 5 AS parent_id, 0.030811358243227005 AS `Score` UNION ALL SELECT 11 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 6 AS parent_id, 0.06943303346633911 AS `Score` UNION ALL SELECT 12 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 6 AS parent_id, -0.005736625753343105 AS `Score`) AS `Values`), 
`DT_Output_31` AS 
...
`DT_node_data_32` AS 
(SELECT `Values`.node_id AS node_id, `Values`.feature AS feature, `Values`.threshold AS threshold, `Values`.depth AS depth, `Values`.parent_id AS parent_id, `Values`.`Score` AS `Score` 
FROM (SELECT 5 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 2 AS depth, 2 AS parent_id, -0.03152763471007347 AS `Score` UNION ALL SELECT 6 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 2 AS depth, 2 AS parent_id, -0.0612054280936718 AS `Score` UNION ALL SELECT 7 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 3 AS parent_id, 0.01775110885500908 AS `Score` UNION ALL SELECT 8 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 3 AS parent_id, -0.027158215641975403 AS `Score` UNION ALL SELECT 9 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 4 AS parent_id, 0.09504883736371994 AS `Score` UNION ALL SELECT 10 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 4 AS parent_id, 0.017177699133753777 AS `Score`) AS `Values`), 
`DT_Output_32` AS 
...
`DT_node_data_33` AS 
(SELECT `Values`.node_id AS node_id, `Values`.feature AS feature, `Values`.threshold AS threshold, `Values`.depth AS depth, `Values`.parent_id AS parent_id, `Values`.`Score` AS `Score` 
FROM (SELECT 3 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 2 AS depth, 1 AS parent_id, 0.07153145968914032 AS `Score` UNION ALL SELECT 7 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 4 AS parent_id, 0.0018362905830144882 AS `Score` UNION ALL SELECT 8 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 4 AS parent_id, -0.03750104829668999 AS `Score` UNION ALL SELECT 9 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 5 AS parent_id, -0.03271249681711197 AS `Score` UNION ALL SELECT 10 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 5 AS parent_id, 0.03141333535313606 AS `Score` UNION ALL SELECT 11 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 6 AS parent_id, 0.04453636333346367 AS `Score` UNION ALL SELECT 12 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 6 AS parent_id, 0.1268133670091629 AS `Score`) AS `Values`), 
`DT_Output_33` AS 
...
`DT_node_data_34` AS 
(SELECT `Values`.node_id AS node_id, `Values`.feature AS feature, `Values`.threshold AS threshold, `Values`.depth AS depth, `Values`.parent_id AS parent_id, `Values`.`Score` AS `Score` 
FROM (SELECT 6 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 2 AS depth, 2 AS parent_id, 0.029065271839499474 AS `Score` UNION ALL SELECT 7 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 3 AS parent_id, 0.028962543234229088 AS `Score` UNION ALL SELECT 8 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 3 AS parent_id, -0.021717583760619164 AS `Score` UNION ALL SELECT 9 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 4 AS parent_id, 0.0809566080570221 AS `Score` UNION ALL SELECT 10 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 4 AS parent_id, 0.011802677065134048 AS `Score` UNION ALL SELECT 11 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 5 AS parent_id, -0.00868432316929102 AS `Score` UNION ALL SELECT 12 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 5 AS parent_id, -0.057115424424409866 AS `Score`) AS `Values`), 
`DT_Output_34` AS 
...
`DT_node_data_35` AS 
(SELECT `Values`.node_id AS node_id, `Values`.feature AS feature, `Values`.threshold AS threshold, `Values`.depth AS depth, `Values`.parent_id AS parent_id, `Values`.`Score` AS `Score` 
FROM (SELECT 7 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 3 AS parent_id, -0.04038013517856598 AS `Score` UNION ALL SELECT 8 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 3 AS parent_id, 0.015114851295948029 AS `Score` UNION ALL SELECT 9 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 4 AS parent_id, -0.03607482835650444 AS `Score` UNION ALL SELECT 10 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 4 AS parent_id, 0.030008716508746147 AS `Score` UNION ALL SELECT 11 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 5 AS parent_id, 0.04301004484295845 AS `Score` UNION ALL SELECT 12 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 5 AS parent_id, -0.04086720943450928 AS `Score` UNION ALL SELECT 13 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 6 AS parent_id, 0.11025115102529526 AS `Score` UNION ALL SELECT 14 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 6 AS parent_id, 0.00865986105054617 AS `Score`) AS `Values`), 
`DT_Output_35` AS 
...
`DT_node_data_36` AS 
(SELECT `Values`.node_id AS node_id, `Values`.feature AS feature, `Values`.threshold AS threshold, `Values`.depth AS depth, `Values`.parent_id AS parent_id, `Values`.`Score` AS `Score` 
FROM (SELECT 5 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 2 AS depth, 2 AS parent_id, -0.060478728264570236 AS `Score` UNION ALL SELECT 6 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 2 AS depth, 2 AS parent_id, -0.03145900368690491 AS `Score` UNION ALL SELECT 7 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 3 AS parent_id, 0.016743337735533714 AS `Score` UNION ALL SELECT 8 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 3 AS parent_id, -0.02615290880203247 AS `Score` UNION ALL SELECT 9 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 4 AS parent_id, 0.06356044113636017 AS `Score` UNION ALL SELECT 10 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 4 AS parent_id, 0.00028482687775976956 AS `Score`) AS `Values`), 
`DT_Output_36` AS 
...
`DT_node_data_37` AS 
(SELECT `Values`.node_id AS node_id, `Values`.feature AS feature, `Values`.threshold AS threshold, `Values`.depth AS depth, `Values`.parent_id AS parent_id, `Values`.`Score` AS `Score` 
FROM (SELECT 7 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 3 AS parent_id, 0.04671819508075714 AS `Score` UNION ALL SELECT 8 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 3 AS parent_id, -0.045421965420246124 AS `Score` UNION ALL SELECT 9 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 4 AS parent_id, -0.04189855977892876 AS `Score` UNION ALL SELECT 10 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 4 AS parent_id, 0.030665302649140358 AS `Score` UNION ALL SELECT 11 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 5 AS parent_id, -4.055856607010355e-06 AS `Score` UNION ALL SELECT 12 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 5 AS parent_id, 0.0817563533782959 AS `Score` UNION ALL SELECT 13 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 6 AS parent_id, -0.036443132907152176 AS `Score` UNION ALL SELECT 14 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 6 AS parent_id, 0.03382762148976326 AS `Score`) AS `Values`), 
`DT_Output_37` AS 
...
`DT_node_data_38` AS 
(SELECT `Values`.node_id AS node_id, `Values`.feature AS feature, `Values`.threshold AS threshold, `Values`.depth AS depth, `Values`.parent_id AS parent_id, `Values`.`Score` AS `Score` 
FROM (SELECT 3 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 2 AS depth, 1 AS parent_id, 0.08996021002531052 AS `Score` UNION ALL SELECT 7 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 4 AS parent_id, -0.01649203710258007 AS `Score` UNION ALL SELECT 8 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 4 AS parent_id, 0.0748315304517746 AS `Score` UNION ALL SELECT 9 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 5 AS parent_id, -0.016731729730963707 AS `Score` UNION ALL SELECT 10 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 5 AS parent_id, 0.07087444514036179 AS `Score` UNION ALL SELECT 11 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 6 AS parent_id, -0.025820715352892876 AS `Score` UNION ALL SELECT 12 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 6 AS parent_id, 0.02309178002178669 AS `Score`) AS `Values`), 
`DT_Output_38` AS 
...
`DT_node_data_39` AS 
(SELECT `Values`.node_id AS node_id, `Values`.feature AS feature, `Values`.threshold AS threshold, `Values`.depth AS depth, `Values`.parent_id AS parent_id, `Values`.`Score` AS `Score` 
FROM (SELECT 3 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 2 AS depth, 1 AS parent_id, 0.039439357817173004 AS `Score` UNION ALL SELECT 6 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 2 AS depth, 2 AS parent_id, 0.0767761617898941 AS `Score` UNION ALL SELECT 7 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 4 AS parent_id, -0.04086436331272125 AS `Score` UNION ALL SELECT 8 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 4 AS parent_id, 0.024951597675681114 AS `Score` UNION ALL SELECT 9 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 5 AS parent_id, -0.04218345507979393 AS `Score` UNION ALL SELECT 10 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 5 AS parent_id, 0.01515407394617796 AS `Score`) AS `Values`), 
`DT_Output_39` AS 
...
FROM `DT_Output_39`)
 SELECT `XGB_Sum_B3`.`KEY`, `XGB_Sum_B3`.`Score_0`, `XGB_Sum_B3`.`Score_1`, `XGB_Sum_B3`.`Score_2`, `XGB_Sum_B3`.`Score_3` 
...
FROM `XGB_Tree_3_9`) AS `XGB_Sum_esu_3`) AS `XGB_Sum_B3`) AS `U`
-- Code For temporary table TMP_20180329233751_5TX2Y7_XGB_Sum_B4 part 1/2. Create 


CREATE TEMPORARY TABLE `TMP_20180329233751_5TX2Y7_XGB_Sum_B4` (
	`KEY` BIGINT, 
	`Score_0` DOUBLE, 
	`Score_1` DOUBLE, 
	`Score_2` DOUBLE, 
 ...
 ENGINE=MEMORY
-- Code For temporary table TMP_20180329233751_5TX2Y7_XGB_Sum_B4 part 2/2. Populate

INSERT INTO `TMP_20180329233751_5TX2Y7_XGB_Sum_B4` (`KEY`, `Score_0`, `Score_1`, `Score_2`, `Score_3`) SELECT `U`.`KEY`, `U`.`Score_0`, `U`.`Score_1`, `U`.`Score_2`, `U`.`Score_3` 
...
`DT_node_data_40` AS 
(SELECT `Values`.node_id AS node_id, `Values`.feature AS feature, `Values`.threshold AS threshold, `Values`.depth AS depth, `Values`.parent_id AS parent_id, `Values`.`Score` AS `Score` 
FROM (SELECT 7 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 3 AS parent_id, -0.03198102489113808 AS `Score` UNION ALL SELECT 8 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 3 AS parent_id, 0.05418172478675842 AS `Score` UNION ALL SELECT 9 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 4 AS parent_id, 0.036180853843688965 AS `Score` UNION ALL SELECT 10 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 4 AS parent_id, -0.028937626630067825 AS `Score` UNION ALL SELECT 11 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 5 AS parent_id, 0.07263517379760742 AS `Score` UNION ALL SELECT 12 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 5 AS parent_id, -0.016179367899894714 AS `Score` UNION ALL SELECT 13 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 6 AS parent_id, 0.02972520887851715 AS `Score` UNION ALL SELECT 14 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 6 AS parent_id, -0.04093458503484726 AS `Score`) AS `Values`), 
`DT_Output_40` AS 
...
`DT_node_data_41` AS 
(SELECT `Values`.node_id AS node_id, `Values`.feature AS feature, `Values`.threshold AS threshold, `Values`.depth AS depth, `Values`.parent_id AS parent_id, `Values`.`Score` AS `Score` 
FROM (SELECT 4 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 2 AS depth, 1 AS parent_id, 0.030849192291498184 AS `Score` UNION ALL SELECT 7 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 3 AS parent_id, 0.012673060409724712 AS `Score` UNION ALL SELECT 8 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 3 AS parent_id, -0.04551688954234123 AS `Score` UNION ALL SELECT 9 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 5 AS parent_id, 0.009846052154898643 AS `Score` UNION ALL SELECT 10 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 5 AS parent_id, 0.058444757014513016 AS `Score` UNION ALL SELECT 11 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 6 AS parent_id, 0.009322546422481537 AS `Score` UNION ALL SELECT 12 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 6 AS parent_id, -0.0493248850107193 AS `Score`) AS `Values`), 
`DT_Output_41` AS 
...
`DT_node_data_42` AS 
(SELECT `Values`.node_id AS node_id, `Values`.feature AS feature, `Values`.threshold AS threshold, `Values`.depth AS depth, `Values`.parent_id AS parent_id, `Values`.`Score` AS `Score` 
FROM (SELECT 5 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 2 AS depth, 2 AS parent_id, 0.023931538686156273 AS `Score` UNION ALL SELECT 7 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 3 AS parent_id, -0.00544687220826745 AS `Score` UNION ALL SELECT 8 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 3 AS parent_id, 0.046533457934856415 AS `Score` UNION ALL SELECT 9 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 4 AS parent_id, -0.02269798330962658 AS `Score` UNION ALL SELECT 10 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 4 AS parent_id, 0.06641175597906113 AS `Score` UNION ALL SELECT 11 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 6 AS parent_id, -0.009259425103664398 AS `Score` UNION ALL SELECT 12 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 6 AS parent_id, -0.058485448360443115 AS `Score`) AS `Values`), 
`DT_Output_42` AS 
...
`DT_node_data_43` AS 
(SELECT `Values`.node_id AS node_id, `Values`.feature AS feature, `Values`.threshold AS threshold, `Values`.depth AS depth, `Values`.parent_id AS parent_id, `Values`.`Score` AS `Score` 
FROM (SELECT 7 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 3 AS parent_id, -0.012849238701164722 AS `Score` UNION ALL SELECT 8 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 3 AS parent_id, 0.05471612140536308 AS `Score` UNION ALL SELECT 9 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 4 AS parent_id, -0.007312485482543707 AS `Score` UNION ALL SELECT 10 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 4 AS parent_id, -0.05218396708369255 AS `Score` UNION ALL SELECT 11 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 5 AS parent_id, -0.05339657887816429 AS `Score` UNION ALL SELECT 12 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 5 AS parent_id, 0.027653813362121582 AS `Score` UNION ALL SELECT 13 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 6 AS parent_id, 0.07000922411680222 AS `Score` UNION ALL SELECT 14 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 6 AS parent_id, 0.008446133695542812 AS `Score`) AS `Values`), 
`DT_Output_43` AS 
...
`DT_node_data_44` AS 
(SELECT `Values`.node_id AS node_id, `Values`.feature AS feature, `Values`.threshold AS threshold, `Values`.depth AS depth, `Values`.parent_id AS parent_id, `Values`.`Score` AS `Score` 
FROM (SELECT 7 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 3 AS parent_id, 0.04723435640335083 AS `Score` UNION ALL SELECT 8 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 3 AS parent_id, -0.04417108744382858 AS `Score` UNION ALL SELECT 9 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 4 AS parent_id, 0.0017780497437343001 AS `Score` UNION ALL SELECT 10 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 4 AS parent_id, -0.059220489114522934 AS `Score` UNION ALL SELECT 11 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 5 AS parent_id, -0.039489876478910446 AS `Score` UNION ALL SELECT 12 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 5 AS parent_id, -0.0607149563729763 AS `Score` UNION ALL SELECT 13 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 6 AS parent_id, -0.016589632257819176 AS `Score` UNION ALL SELECT 14 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 6 AS parent_id, 0.03514787554740906 AS `Score`) AS `Values`), 
`DT_Output_44` AS 
...
`DT_node_data_45` AS 
(SELECT `Values`.node_id AS node_id, `Values`.feature AS feature, `Values`.threshold AS threshold, `Values`.depth AS depth, `Values`.parent_id AS parent_id, `Values`.`Score` AS `Score` 
FROM (SELECT 7 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 3 AS parent_id, -0.03925728425383568 AS `Score` UNION ALL SELECT 8 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 3 AS parent_id, 0.044106967747211456 AS `Score` UNION ALL SELECT 9 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 4 AS parent_id, -0.04059438034892082 AS `Score` UNION ALL SELECT 10 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 4 AS parent_id, 0.02867412380874157 AS `Score` UNION ALL SELECT 11 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 5 AS parent_id, -0.015392429195344448 AS `Score` UNION ALL SELECT 12 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 5 AS parent_id, 0.06983601301908493 AS `Score` UNION ALL SELECT 13 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 6 AS parent_id, -0.035069357603788376 AS `Score` UNION ALL SELECT 14 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 6 AS parent_id, 0.030555495992302895 AS `Score`) AS `Values`), 
`DT_Output_45` AS 
...
`DT_node_data_46` AS 
(SELECT `Values`.node_id AS node_id, `Values`.feature AS feature, `Values`.threshold AS threshold, `Values`.depth AS depth, `Values`.parent_id AS parent_id, `Values`.`Score` AS `Score` 
FROM (SELECT 4 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 2 AS depth, 1 AS parent_id, 0.09063682705163956 AS `Score` UNION ALL SELECT 7 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 3 AS parent_id, 0.03708481416106224 AS `Score` UNION ALL SELECT 8 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 3 AS parent_id, -0.013739394955337048 AS `Score` UNION ALL SELECT 9 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 5 AS parent_id, -0.01025516539812088 AS `Score` UNION ALL SELECT 10 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 5 AS parent_id, 0.07824618369340897 AS `Score` UNION ALL SELECT 11 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 6 AS parent_id, 0.03067733906209469 AS `Score` UNION ALL SELECT 12 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 6 AS parent_id, -0.026095757260918617 AS `Score`) AS `Values`), 
`DT_Output_46` AS 
...
`DT_node_data_47` AS 
(SELECT `Values`.node_id AS node_id, `Values`.feature AS feature, `Values`.threshold AS threshold, `Values`.depth AS depth, `Values`.parent_id AS parent_id, `Values`.`Score` AS `Score` 
FROM (SELECT 6 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 2 AS depth, 2 AS parent_id, 0.03297403082251549 AS `Score` UNION ALL SELECT 7 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 3 AS parent_id, 0.04168371856212616 AS `Score` UNION ALL SELECT 8 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 3 AS parent_id, -0.029589567333459854 AS `Score` UNION ALL SELECT 9 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 4 AS parent_id, 0.00792620237916708 AS `Score` UNION ALL SELECT 10 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 4 AS parent_id, 0.0636928603053093 AS `Score` UNION ALL SELECT 11 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 5 AS parent_id, -0.036573510617017746 AS `Score` UNION ALL SELECT 12 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 5 AS parent_id, 0.027799397706985474 AS `Score`) AS `Values`), 
`DT_Output_47` AS 
...
`DT_node_data_48` AS 
(SELECT `Values`.node_id AS node_id, `Values`.feature AS feature, `Values`.threshold AS threshold, `Values`.depth AS depth, `Values`.parent_id AS parent_id, `Values`.`Score` AS `Score` 
FROM (SELECT 5 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 2 AS depth, 2 AS parent_id, -0.058993514627218246 AS `Score` UNION ALL SELECT 6 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 2 AS depth, 2 AS parent_id, -0.03041122853755951 AS `Score` UNION ALL SELECT 7 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 3 AS parent_id, 0.03186718374490738 AS `Score` UNION ALL SELECT 8 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 3 AS parent_id, -0.03109888732433319 AS `Score` UNION ALL SELECT 9 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 4 AS parent_id, -0.04466073587536812 AS `Score` UNION ALL SELECT 10 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 4 AS parent_id, 0.0016798910219222307 AS `Score`) AS `Values`), 
`DT_Output_48` AS 
...
`DT_node_data_49` AS 
(SELECT `Values`.node_id AS node_id, `Values`.feature AS feature, `Values`.threshold AS threshold, `Values`.depth AS depth, `Values`.parent_id AS parent_id, `Values`.`Score` AS `Score` 
FROM (SELECT 4 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 2 AS depth, 1 AS parent_id, -0.05784522369503975 AS `Score` UNION ALL SELECT 7 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 3 AS parent_id, 0.046256087720394135 AS `Score` UNION ALL SELECT 8 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 3 AS parent_id, -0.01758781261742115 AS `Score` UNION ALL SELECT 9 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 5 AS parent_id, 0.05251333862543106 AS `Score` UNION ALL SELECT 10 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 5 AS parent_id, -0.015795933082699776 AS `Score` UNION ALL SELECT 11 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 6 AS parent_id, 0.05491194128990173 AS `Score` UNION ALL SELECT 12 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 6 AS parent_id, -0.011253241449594498 AS `Score`) AS `Values`), 
`DT_Output_49` AS 
...
FROM `DT_Output_49`)
 SELECT `XGB_Sum_B4`.`KEY`, `XGB_Sum_B4`.`Score_0`, `XGB_Sum_B4`.`Score_1`, `XGB_Sum_B4`.`Score_2`, `XGB_Sum_B4`.`Score_3` 
...
FROM `XGB_Tree_1_12`) AS `XGB_Sum_esu_4`) AS `XGB_Sum_B4`) AS `U`
-- Code For temporary table TMP_20180329233752_MXGA6R_XGB_Sum_B5 part 1/2. Create 


CREATE TEMPORARY TABLE `TMP_20180329233752_MXGA6R_XGB_Sum_B5` (
	`KEY` BIGINT, 
	`Score_0` DOUBLE, 
	`Score_1` DOUBLE, 
	`Score_2` DOUBLE, 
 ...
 ENGINE=MEMORY
-- Code For temporary table TMP_20180329233752_MXGA6R_XGB_Sum_B5 part 2/2. Populate

INSERT INTO `TMP_20180329233752_MXGA6R_XGB_Sum_B5` (`KEY`, `Score_0`, `Score_1`, `Score_2`, `Score_3`) SELECT `U`.`KEY`, `U`.`Score_0`, `U`.`Score_1`, `U`.`Score_2`, `U`.`Score_3` 
...
`DT_node_data_50` AS 
(SELECT `Values`.node_id AS node_id, `Values`.feature AS feature, `Values`.threshold AS threshold, `Values`.depth AS depth, `Values`.parent_id AS parent_id, `Values`.`Score` AS `Score` 
FROM (SELECT 3 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 2 AS depth, 1 AS parent_id, 0.08113902807235718 AS `Score` UNION ALL SELECT 7 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 4 AS parent_id, -0.015393058769404888 AS `Score` UNION ALL SELECT 8 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 4 AS parent_id, 0.06897930800914764 AS `Score` UNION ALL SELECT 9 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 5 AS parent_id, 0.03675171360373497 AS `Score` UNION ALL SELECT 10 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 5 AS parent_id, -0.010842032730579376 AS `Score` UNION ALL SELECT 11 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 6 AS parent_id, -0.060816265642642975 AS `Score` UNION ALL SELECT 12 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 6 AS parent_id, -0.02239675633609295 AS `Score`) AS `Values`), 
`DT_Output_50` AS 
...
`DT_node_data_51` AS 
(SELECT `Values`.node_id AS node_id, `Values`.feature AS feature, `Values`.threshold AS threshold, `Values`.depth AS depth, `Values`.parent_id AS parent_id, `Values`.`Score` AS `Score` 
FROM (SELECT 7 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 3 AS parent_id, -0.03767390176653862 AS `Score` UNION ALL SELECT 8 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 3 AS parent_id, 0.01348965335637331 AS `Score` UNION ALL SELECT 9 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 4 AS parent_id, -0.038385480642318726 AS `Score` UNION ALL SELECT 10 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 4 AS parent_id, 0.027250802144408226 AS `Score` UNION ALL SELECT 11 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 5 AS parent_id, -0.045625049620866776 AS `Score` UNION ALL SELECT 12 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 5 AS parent_id, 0.023106446489691734 AS `Score` UNION ALL SELECT 13 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 6 AS parent_id, 0.0777437761425972 AS `Score` UNION ALL SELECT 14 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 6 AS parent_id, 0.0025067066308110952 AS `Score`) AS `Values`), 
`DT_Output_51` AS 
...
`DT_node_data_52` AS 
(SELECT `Values`.node_id AS node_id, `Values`.feature AS feature, `Values`.threshold AS threshold, `Values`.depth AS depth, `Values`.parent_id AS parent_id, `Values`.`Score` AS `Score` 
FROM (SELECT 3 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 2 AS depth, 1 AS parent_id, 0.04787541553378105 AS `Score` UNION ALL SELECT 5 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 2 AS depth, 2 AS parent_id, -0.04639987275004387 AS `Score` UNION ALL SELECT 7 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 4 AS parent_id, -0.007485274225473404 AS `Score` UNION ALL SELECT 8 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 4 AS parent_id, -0.05036280304193497 AS `Score` UNION ALL SELECT 9 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 6 AS parent_id, 0.04404906928539276 AS `Score` UNION ALL SELECT 10 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 6 AS parent_id, -0.024547625333070755 AS `Score`) AS `Values`), 
`DT_Output_52` AS 
...
`DT_node_data_53` AS 
(SELECT `Values`.node_id AS node_id, `Values`.feature AS feature, `Values`.threshold AS threshold, `Values`.depth AS depth, `Values`.parent_id AS parent_id, `Values`.`Score` AS `Score` 
FROM (SELECT 3 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 2 AS depth, 1 AS parent_id, 0.06186232715845108 AS `Score` UNION ALL SELECT 7 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 4 AS parent_id, 0.0015107045182958245 AS `Score` UNION ALL SELECT 8 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 4 AS parent_id, -0.03567669540643692 AS `Score` UNION ALL SELECT 9 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 5 AS parent_id, -0.031050730496644974 AS `Score` UNION ALL SELECT 10 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 5 AS parent_id, 0.02890966273844242 AS `Score` UNION ALL SELECT 11 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 6 AS parent_id, 0.038520652800798416 AS `Score` UNION ALL SELECT 12 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 6 AS parent_id, 0.11011015623807907 AS `Score`) AS `Values`), 
`DT_Output_53` AS 
...
`DT_node_data_54` AS 
(SELECT `Values`.node_id AS node_id, `Values`.feature AS feature, `Values`.threshold AS threshold, `Values`.depth AS depth, `Values`.parent_id AS parent_id, `Values`.`Score` AS `Score` 
FROM (SELECT 4 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 2 AS depth, 1 AS parent_id, 0.0621989481151104 AS `Score` UNION ALL SELECT 7 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 3 AS parent_id, -0.035851169377565384 AS `Score` UNION ALL SELECT 8 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 3 AS parent_id, 0.0016848951345309615 AS `Score` UNION ALL SELECT 9 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 5 AS parent_id, -0.06017543748021126 AS `Score` UNION ALL SELECT 10 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 5 AS parent_id, 0.014393058605492115 AS `Score` UNION ALL SELECT 11 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 6 AS parent_id, 0.07545775175094604 AS `Score` UNION ALL SELECT 12 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 6 AS parent_id, -0.014329669065773487 AS `Score`) AS `Values`), 
`DT_Output_54` AS 
...
`DT_node_data_55` AS 
(SELECT `Values`.node_id AS node_id, `Values`.feature AS feature, `Values`.threshold AS threshold, `Values`.depth AS depth, `Values`.parent_id AS parent_id, `Values`.`Score` AS `Score` 
FROM (SELECT 4 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 2 AS depth, 1 AS parent_id, 0.03991974517703056 AS `Score` UNION ALL SELECT 7 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 3 AS parent_id, 0.02743837796151638 AS `Score` UNION ALL SELECT 8 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 3 AS parent_id, -0.037529248744249344 AS `Score` UNION ALL SELECT 9 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 5 AS parent_id, 0.04469522461295128 AS `Score` UNION ALL SELECT 10 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 5 AS parent_id, -0.030154764652252197 AS `Score` UNION ALL SELECT 11 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 6 AS parent_id, 0.012652799487113953 AS `Score` UNION ALL SELECT 12 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 6 AS parent_id, 0.07079973071813583 AS `Score`) AS `Values`), 
`DT_Output_55` AS 
...
`DT_node_data_56` AS 
(SELECT `Values`.node_id AS node_id, `Values`.feature AS feature, `Values`.threshold AS threshold, `Values`.depth AS depth, `Values`.parent_id AS parent_id, `Values`.`Score` AS `Score` 
FROM (SELECT 6 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 2 AS depth, 2 AS parent_id, 0.05490348860621452 AS `Score` UNION ALL SELECT 7 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 3 AS parent_id, -0.05019739270210266 AS `Score` UNION ALL SELECT 8 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 3 AS parent_id, 0.02096550725400448 AS `Score` UNION ALL SELECT 9 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 4 AS parent_id, 0.11231861263513565 AS `Score` UNION ALL SELECT 10 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 4 AS parent_id, 0.027138788253068924 AS `Score` UNION ALL SELECT 11 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 5 AS parent_id, 0.02776581421494484 AS `Score` UNION ALL SELECT 12 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 5 AS parent_id, -0.023163659498095512 AS `Score`) AS `Values`), 
`DT_Output_56` AS 
...
`DT_node_data_57` AS 
(SELECT `Values`.node_id AS node_id, `Values`.feature AS feature, `Values`.threshold AS threshold, `Values`.depth AS depth, `Values`.parent_id AS parent_id, `Values`.`Score` AS `Score` 
FROM (SELECT 2 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 1 AS depth, 0 AS parent_id, 0.07204890251159668 AS `Score` UNION ALL SELECT 5 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 3 AS parent_id, -0.011807747185230255 AS `Score` UNION ALL SELECT 6 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 3 AS parent_id, 0.026426663622260094 AS `Score` UNION ALL SELECT 7 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 4 AS parent_id, 0.0004793795815203339 AS `Score` UNION ALL SELECT 8 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 4 AS parent_id, -0.054177261888980865 AS `Score`) AS `Values`), 
`DT_Output_57` AS 
...
`DT_node_data_58` AS 
(SELECT `Values`.node_id AS node_id, `Values`.feature AS feature, `Values`.threshold AS threshold, `Values`.depth AS depth, `Values`.parent_id AS parent_id, `Values`.`Score` AS `Score` 
FROM (SELECT 6 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 2 AS depth, 2 AS parent_id, 0.06407646834850311 AS `Score` UNION ALL SELECT 7 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 3 AS parent_id, 0.002627713605761528 AS `Score` UNION ALL SELECT 8 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 3 AS parent_id, 0.07727788388729095 AS `Score` UNION ALL SELECT 9 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 4 AS parent_id, 0.04721461236476898 AS `Score` UNION ALL SELECT 10 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 4 AS parent_id, -0.03674154728651047 AS `Score` UNION ALL SELECT 11 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 5 AS parent_id, -0.01735094003379345 AS `Score` UNION ALL SELECT 12 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 5 AS parent_id, 0.0557151734828949 AS `Score`) AS `Values`), 
`DT_Output_58` AS 
...
`DT_node_data_59` AS 
(SELECT `Values`.node_id AS node_id, `Values`.feature AS feature, `Values`.threshold AS threshold, `Values`.depth AS depth, `Values`.parent_id AS parent_id, `Values`.`Score` AS `Score` 
FROM (SELECT 3 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 2 AS depth, 1 AS parent_id, -0.000573145633097738 AS `Score` UNION ALL SELECT 4 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 2 AS depth, 1 AS parent_id, -0.058796633034944534 AS `Score` UNION ALL SELECT 7 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 5 AS parent_id, -0.01676192879676819 AS `Score` UNION ALL SELECT 8 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 5 AS parent_id, 0.028716787695884705 AS `Score` UNION ALL SELECT 9 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 6 AS parent_id, 0.024237455800175667 AS `Score` UNION ALL SELECT 10 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 6 AS parent_id, -0.03407886624336243 AS `Score`) AS `Values`), 
`DT_Output_59` AS 
...
FROM `DT_Output_59`)
 SELECT `XGB_Sum_B5`.`KEY`, `XGB_Sum_B5`.`Score_0`, `XGB_Sum_B5`.`Score_1`, `XGB_Sum_B5`.`Score_2`, `XGB_Sum_B5`.`Score_3` 
...
FROM `XGB_Tree_3_14`) AS `XGB_Sum_esu_5`) AS `XGB_Sum_B5`) AS `U`
-- Code For temporary table TMP_20180329233752_A1K94B_XGB_Sum_B6 part 1/2. Create 


CREATE TEMPORARY TABLE `TMP_20180329233752_A1K94B_XGB_Sum_B6` (
	`KEY` BIGINT, 
	`Score_0` DOUBLE, 
	`Score_1` DOUBLE, 
	`Score_2` DOUBLE, 
 ...
 ENGINE=MEMORY
-- Code For temporary table TMP_20180329233752_A1K94B_XGB_Sum_B6 part 2/2. Populate

INSERT INTO `TMP_20180329233752_A1K94B_XGB_Sum_B6` (`KEY`, `Score_0`, `Score_1`, `Score_2`, `Score_3`) SELECT `U`.`KEY`, `U`.`Score_0`, `U`.`Score_1`, `U`.`Score_2`, `U`.`Score_3` 
...
`DT_node_data_60` AS 
(SELECT `Values`.node_id AS node_id, `Values`.feature AS feature, `Values`.threshold AS threshold, `Values`.depth AS depth, `Values`.parent_id AS parent_id, `Values`.`Score` AS `Score` 
FROM (SELECT 5 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 2 AS depth, 2 AS parent_id, -0.029859209433197975 AS `Score` UNION ALL SELECT 6 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 2 AS depth, 2 AS parent_id, -0.05805216357111931 AS `Score` UNION ALL SELECT 7 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 3 AS parent_id, 0.015897035598754883 AS `Score` UNION ALL SELECT 8 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 3 AS parent_id, -0.024312617257237434 AS `Score` UNION ALL SELECT 9 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 4 AS parent_id, -0.011932064779102802 AS `Score` UNION ALL SELECT 10 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 4 AS parent_id, 0.047238875180482864 AS `Score`) AS `Values`), 
`DT_Output_60` AS 
...
`DT_node_data_61` AS 
(SELECT `Values`.node_id AS node_id, `Values`.feature AS feature, `Values`.threshold AS threshold, `Values`.depth AS depth, `Values`.parent_id AS parent_id, `Values`.`Score` AS `Score` 
FROM (SELECT 4 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 2 AS depth, 1 AS parent_id, 0.027227863669395447 AS `Score` UNION ALL SELECT 7 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 3 AS parent_id, 0.011816625483334064 AS `Score` UNION ALL SELECT 8 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 3 AS parent_id, -0.04362358897924423 AS `Score` UNION ALL SELECT 9 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 5 AS parent_id, -0.041690897196531296 AS `Score` UNION ALL SELECT 10 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 5 AS parent_id, 0.029101604595780373 AS `Score` UNION ALL SELECT 11 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 6 AS parent_id, 0.009007665328681469 AS `Score` UNION ALL SELECT 12 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 6 AS parent_id, -0.047675542533397675 AS `Score`) AS `Values`), 
`DT_Output_61` AS 
...
`DT_node_data_62` AS 
(SELECT `Values`.node_id AS node_id, `Values`.feature AS feature, `Values`.threshold AS threshold, `Values`.depth AS depth, `Values`.parent_id AS parent_id, `Values`.`Score` AS `Score` 
FROM (SELECT 3 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 2 AS depth, 1 AS parent_id, 0.04842666536569595 AS `Score` UNION ALL SELECT 5 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 2 AS depth, 2 AS parent_id, 0.09471293538808823 AS `Score` UNION ALL SELECT 7 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 4 AS parent_id, 0.016591977328062057 AS `Score` UNION ALL SELECT 8 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 4 AS parent_id, -0.021473579108715057 AS `Score` UNION ALL SELECT 9 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 6 AS parent_id, 0.048194851726293564 AS `Score` UNION ALL SELECT 10 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 6 AS parent_id, -0.016300618648529053 AS `Score`) AS `Values`), 
`DT_Output_62` AS 
...
`DT_node_data_63` AS 
(SELECT `Values`.node_id AS node_id, `Values`.feature AS feature, `Values`.threshold AS threshold, `Values`.depth AS depth, `Values`.parent_id AS parent_id, `Values`.`Score` AS `Score` 
FROM (SELECT 5 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 2 AS depth, 2 AS parent_id, 0.07901528477668762 AS `Score` UNION ALL SELECT 7 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 3 AS parent_id, -0.011822021566331387 AS `Score` UNION ALL SELECT 8 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 3 AS parent_id, 0.04737631604075432 AS `Score` UNION ALL SELECT 9 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 4 AS parent_id, -0.006803599186241627 AS `Score` UNION ALL SELECT 10 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 4 AS parent_id, -0.05067864805459976 AS `Score` UNION ALL SELECT 11 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 6 AS parent_id, 0.034979306161403656 AS `Score` UNION ALL SELECT 12 AS node_id, CAST(NULL AS CHAR(256)) AS feature, NULL AS threshold, 3 AS depth, 6 AS parent_id, -0.020377079024910927 AS `Score`) AS `Values`), 
`DT_Output_63` AS 
...
FROM `DT_Output_63`)
 SELECT `XGB_Sum_B6`.`KEY`, `XGB_Sum_B6`.`Score_0`, `XGB_Sum_B6`.`Score_1`, `XGB_Sum_B6`.`Score_2`, `XGB_Sum_B6`.`Score_3` 
...
FROM `XGB_Tree_3_15`) AS `XGB_Sum_esu_6`) AS `XGB_Sum_B6`) AS `U`
-- Code For temporary table TMP_20180329233752_M9R0DA_XGB_Sum_Union part 1/2. Create 


CREATE TEMPORARY TABLE `TMP_20180329233752_M9R0DA_XGB_Sum_Union` (
	`KEY` BIGINT, 
	`Score_0` DOUBLE, 
	`Score_1` DOUBLE, 
	`Score_2` DOUBLE, 
 ...
 ENGINE=MEMORY
-- Code For temporary table TMP_20180329233752_M9R0DA_XGB_Sum_Union part 2/2. Populate

INSERT INTO `TMP_20180329233752_M9R0DA_XGB_Sum_Union` (`KEY`, `Score_0`, `Score_1`, `Score_2`, `Score_3`) SELECT `U`.`KEY`, `U`.`Score_0`, `U`.`Score_1`, `U`.`Score_2`, `U`.`Score_3` 
FROM (SELECT `XGB_Sum_Union`.`KEY`, `XGB_Sum_Union`.`Score_0`, `XGB_Sum_Union`.`Score_1`, `XGB_Sum_Union`.`Score_2`, `XGB_Sum_Union`.`Score_3` 
...
FROM `TMP_20180329233750_PY5NPQ_XGB_Sum_B0` AS `XGB_Sum_B0` UNION ALL SELECT `XGB_Sum_B1`.`KEY` AS `KEY`, `XGB_Sum_B1`.`Score_0` AS `Score_0`, `XGB_Sum_B1`.`Score_1` AS `Score_1`, `XGB_Sum_B1`.`Score_2` AS `Score_2`, `XGB_Sum_B1`.`Score_3` AS `Score_3` 
FROM `TMP_20180329233751_Z07AWV_XGB_Sum_B1` AS `XGB_Sum_B1` UNION ALL SELECT `XGB_Sum_B2`.`KEY` AS `KEY`, `XGB_Sum_B2`.`Score_0` AS `Score_0`, `XGB_Sum_B2`.`Score_1` AS `Score_1`, `XGB_Sum_B2`.`Score_2` AS `Score_2`, `XGB_Sum_B2`.`Score_3` AS `Score_3` 
FROM `TMP_20180329233751_JQRNCM_XGB_Sum_B2` AS `XGB_Sum_B2` UNION ALL SELECT `XGB_Sum_B3`.`KEY` AS `KEY`, `XGB_Sum_B3`.`Score_0` AS `Score_0`, `XGB_Sum_B3`.`Score_1` AS `Score_1`, `XGB_Sum_B3`.`Score_2` AS `Score_2`, `XGB_Sum_B3`.`Score_3` AS `Score_3` 
FROM `TMP_20180329233751_78LP1X_XGB_Sum_B3` AS `XGB_Sum_B3` UNION ALL SELECT `XGB_Sum_B4`.`KEY` AS `KEY`, `XGB_Sum_B4`.`Score_0` AS `Score_0`, `XGB_Sum_B4`.`Score_1` AS `Score_1`, `XGB_Sum_B4`.`Score_2` AS `Score_2`, `XGB_Sum_B4`.`Score_3` AS `Score_3` 
FROM `TMP_20180329233751_5TX2Y7_XGB_Sum_B4` AS `XGB_Sum_B4` UNION ALL SELECT `XGB_Sum_B5`.`KEY` AS `KEY`, `XGB_Sum_B5`.`Score_0` AS `Score_0`, `XGB_Sum_B5`.`Score_1` AS `Score_1`, `XGB_Sum_B5`.`Score_2` AS `Score_2`, `XGB_Sum_B5`.`Score_3` AS `Score_3` 
FROM `TMP_20180329233752_MXGA6R_XGB_Sum_B5` AS `XGB_Sum_B5` UNION ALL SELECT `XGB_Sum_B6`.`KEY` AS `KEY`, `XGB_Sum_B6`.`Score_0` AS `Score_0`, `XGB_Sum_B6`.`Score_1` AS `Score_1`, `XGB_Sum_B6`.`Score_2` AS `Score_2`, `XGB_Sum_B6`.`Score_3` AS `Score_3` 
FROM `TMP_20180329233752_A1K94B_XGB_Sum_B6` AS `XGB_Sum_B6`) AS `XGB_Sum_EnsembleUnion`) AS `XGB_Sum_Union`) AS `U`

-- Model deployment code

WITH `XGB_Sum_sum` AS 
(SELECT `T`.`KEY` AS `KEY`, `T`.`Score_0` AS `Score_0`, `T`.`Score_1` AS `Score_1`, `T`.`Score_2` AS `Score_2`, `T`.`Score_3` AS `Score_3` 
FROM (SELECT `XGB_Sum_Union`.`KEY` AS `KEY`, sum(`XGB_Sum_Union`.`Score_0`) AS `Score_0`, sum(`XGB_Sum_Union`.`Score_1`) AS `Score_1`, sum(`XGB_Sum_Union`.`Score_2`) AS `Score_2`, sum(`XGB_Sum_Union`.`Score_3`) AS `Score_3` 
FROM `TMP_20180329233752_M9R0DA_XGB_Sum_Union` AS `XGB_Sum_Union` GROUP BY `XGB_Sum_Union`.`KEY`) AS `T`), 
orig_cte AS 
(SELECT `XGB_Sum_sum`.`KEY` AS `KEY`, `XGB_Sum_sum`.`Score_0` AS `Score_0`, `XGB_Sum_sum`.`Score_1` AS `Score_1`, `XGB_Sum_sum`.`Score_2` AS `Score_2`, `XGB_Sum_sum`.`Score_3` AS `Score_3`, NULL AS `Proba_0`, NULL AS `Proba_1`, NULL AS `Proba_2`, NULL AS `Proba_3`, NULL AS `LogProba_0`, NULL AS `LogProba_1`, NULL AS `LogProba_2`, NULL AS `LogProba_3`, CAST(NULL AS SIGNED INTEGER) AS `Decision`, NULL AS `DecisionProba` 
FROM `XGB_Sum_sum`), 
