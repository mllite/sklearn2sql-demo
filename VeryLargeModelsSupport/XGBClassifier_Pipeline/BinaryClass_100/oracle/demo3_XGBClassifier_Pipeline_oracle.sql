...
-- Code For temporary table 32624_2M62OY_ADS_IMP_1_OUT part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE "32624_2M62OY_ADS_IMP_1_OUT" (
	"KEY" NUMBER(19), 
...
-- Code For temporary table 32624_WV2JOM_ADS_SCA_2_OUT part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE "32624_WV2JOM_ADS_SCA_2_OUT" (
	"KEY" NUMBER(19), 
...
FROM "32624_2M62OY_ADS_IMP_1_OUT" "ADS_imp_1_OUT") "ADS_sca_2_OUT") "U"
-- Code For temporary table 29232625_1O9RC7_XGB_SUM_B0 part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE "29232625_1O9RC7_XGB_SUM_B0" (
	"KEY" NUMBER(19), 
	"Score_0" BINARY_DOUBLE
)

 ON COMMIT PRESERVE ROWS
-- Code For temporary table 29232625_1O9RC7_XGB_SUM_B0 part 2/2. Populate

INSERT INTO "29232625_1O9RC7_XGB_SUM_B0" ("KEY", "Score_0") SELECT "U"."KEY", "U"."Score_0" 
FROM (WITH "DT_node_lookup" AS 
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", CASE WHEN ("ADS_sca_2_OUT".scaler_59 < -0.1959642767906189) THEN 1 ELSE 2 END AS node_id_2 
FROM "32624_WV2JOM_ADS_SCA_2_OUT" "ADS_sca_2_OUT"), 
"DT_node_data" AS 
...
-- Code For temporary table 29232625_KXTFZQ_XGB_SUM_B1 part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE "29232625_KXTFZQ_XGB_SUM_B1" (
	"KEY" NUMBER(19), 
	"Score_0" BINARY_DOUBLE
)

 ON COMMIT PRESERVE ROWS
-- Code For temporary table 29232625_KXTFZQ_XGB_SUM_B1 part 2/2. Populate

INSERT INTO "29232625_KXTFZQ_XGB_SUM_B1" ("KEY", "Score_0") SELECT "U"."KEY", "U"."Score_0" 
...
-- Code For temporary table 32625_RE71W4_XGB_SUM_UNION part 1/2. Create 


CREATE GLOBAL TEMPORARY TABLE "32625_RE71W4_XGB_SUM_UNION" (
	"KEY" NUMBER(19), 
	"Score_0" BINARY_DOUBLE
)

 ON COMMIT PRESERVE ROWS
-- Code For temporary table 32625_RE71W4_XGB_SUM_UNION part 2/2. Populate

INSERT INTO "32625_RE71W4_XGB_SUM_UNION" ("KEY", "Score_0") SELECT "U"."KEY", "U"."Score_0" 
...
FROM "29232625_1O9RC7_XGB_SUM_B0" "XGB_Sum_B0" UNION ALL SELECT "XGB_Sum_B1"."KEY" AS "KEY", "XGB_Sum_B1"."Score_0" AS "Score_0" 
FROM "29232625_KXTFZQ_XGB_SUM_B1" "XGB_Sum_B1") "XGB_Sum_EnsembleUnion") "XGB_Sum_Union") "U"
...
FROM "32625_RE71W4_XGB_SUM_UNION" "XGB_Sum_Union" GROUP BY "XGB_Sum_Union"."KEY") "T"), 
orig_cte AS 
