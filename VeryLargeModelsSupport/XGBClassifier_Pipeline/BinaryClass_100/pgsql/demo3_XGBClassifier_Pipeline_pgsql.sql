...
-- Code For temporary table TMP_20180329232624_I0TN8R_ADS_imp_1_OUT part 1/2. Create 


CREATE TEMPORARY TABLE "TMP_20180329232624_I0TN8R_ADS_imp_1_OUT" (
	"KEY" BIGINT, 
	impter_2 FLOAT, 
	impter_3 FLOAT, 
	impter_4 FLOAT, 
...
-- Code For temporary table TMP_20180329232624_SOEGPK_ADS_sca_2_OUT part 1/2. Create 


CREATE TEMPORARY TABLE "TMP_20180329232624_SOEGPK_ADS_sca_2_OUT" (
	"KEY" BIGINT, 
	scaler_2 FLOAT, 
	scaler_3 FLOAT, 
	scaler_4 FLOAT, 
...
FROM "TMP_20180329232624_I0TN8R_ADS_imp_1_OUT" AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT"
-- Code For temporary table TMP_20180329232625_GHAR0N_XGB_Sum_B0 part 1/2. Create 


CREATE TEMPORARY TABLE "TMP_20180329232625_GHAR0N_XGB_Sum_B0" (
	"KEY" BIGINT, 
	"Score_0" FLOAT
)

 ON COMMIT PRESERVE ROWS
-- Code For temporary table TMP_20180329232625_GHAR0N_XGB_Sum_B0 part 2/2. Populate

WITH "DT_node_lookup" AS 
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", CASE WHEN ("ADS_sca_2_OUT".scaler_59 < -0.1959642767906189) THEN 1 ELSE 2 END AS node_id_2 
FROM "TMP_20180329232624_SOEGPK_ADS_sca_2_OUT" AS "ADS_sca_2_OUT"), 
"DT_node_data" AS 
...
FROM "DT_Output_9")
 INSERT INTO "TMP_20180329232625_GHAR0N_XGB_Sum_B0" ("KEY", "Score_0") SELECT "XGB_Sum_B0"."KEY", "XGB_Sum_B0"."Score_0" 
...
-- Code For temporary table TMP_20180329232625_OUNAUG_XGB_Sum_B1 part 1/2. Create 


CREATE TEMPORARY TABLE "TMP_20180329232625_OUNAUG_XGB_Sum_B1" (
	"KEY" BIGINT, 
	"Score_0" FLOAT
)

 ON COMMIT PRESERVE ROWS
-- Code For temporary table TMP_20180329232625_OUNAUG_XGB_Sum_B1 part 2/2. Populate
...
FROM "DT_Output_15")
 INSERT INTO "TMP_20180329232625_OUNAUG_XGB_Sum_B1" ("KEY", "Score_0") SELECT "XGB_Sum_B1"."KEY", "XGB_Sum_B1"."Score_0" 
...
-- Code For temporary table TMP_20180329232625_HEASKO_XGB_Sum_Union part 1/2. Create 


CREATE TEMPORARY TABLE "TMP_20180329232625_HEASKO_XGB_Sum_Union" (
	"KEY" BIGINT, 
	"Score_0" FLOAT
)

 ON COMMIT PRESERVE ROWS
-- Code For temporary table TMP_20180329232625_HEASKO_XGB_Sum_Union part 2/2. Populate

INSERT INTO "TMP_20180329232625_HEASKO_XGB_Sum_Union" ("KEY", "Score_0") SELECT "XGB_Sum_Union"."KEY", "XGB_Sum_Union"."Score_0" 
...
FROM "TMP_20180329232625_GHAR0N_XGB_Sum_B0" AS "XGB_Sum_B0" UNION ALL SELECT "XGB_Sum_B1"."KEY" AS "KEY", "XGB_Sum_B1"."Score_0" AS "Score_0" 
FROM "TMP_20180329232625_OUNAUG_XGB_Sum_B1" AS "XGB_Sum_B1") AS "XGB_Sum_EnsembleUnion") AS "XGB_Sum_Union"
...
FROM "TMP_20180329232625_HEASKO_XGB_Sum_Union" AS "XGB_Sum_Union" GROUP BY "XGB_Sum_Union"."KEY") AS "T"), 
orig_cte AS 
