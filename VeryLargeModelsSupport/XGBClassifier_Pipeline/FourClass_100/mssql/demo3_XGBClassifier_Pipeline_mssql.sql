...
-- Code For temporary table ##TMP_20180329233306_QNW2AN_ADS_imp_1_OUT part 1/2. Create 


CREATE TABLE ##TMP_20180329233306_QNW2AN_ADS_imp_1_OUT (
	[KEY] BIGINT NULL, 
...
-- Code For temporary table ##TMP_20180329233306_T5NGOV_ADS_sca_2_OUT part 1/2. Create 


CREATE TABLE ##TMP_20180329233306_T5NGOV_ADS_sca_2_OUT (
	[KEY] BIGINT NULL, 
	scaler_2 FLOAT NULL, 
	scaler_3 FLOAT NULL, 
	scaler_4 FLOAT NULL, 
...
FROM ##TMP_20180329233306_QNW2AN_ADS_imp_1_OUT AS [ADS_imp_1_OUT]) AS [ADS_sca_2_OUT]
-- Code For temporary table ##TMP_20180329233306_DUIJZJ_XGB_Sum_B0 part 1/2. Create 


CREATE TABLE ##TMP_20180329233306_DUIJZJ_XGB_Sum_B0 (
	[KEY] BIGINT NULL, 
...
-- Code For temporary table ##TMP_20180329233306_DUIJZJ_XGB_Sum_B0 part 2/2. Populate
...
FROM ##TMP_20180329233306_T5NGOV_ADS_sca_2_OUT AS [ADS_sca_2_OUT]), 
[DT_node_data] AS 
...
FROM (SELECT 7 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 3 AS parent_id, 0.02982107363641262 AS [Score] UNION ALL SELECT 8 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 3 AS parent_id, -0.048163264989852905 AS [Score] UNION ALL SELECT 9 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 4 AS parent_id, -0.0044052861630916595 AS [Score] UNION ALL SELECT 10 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 4 AS parent_id, -0.052241113036870956 AS [Score] UNION ALL SELECT 11 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 5 AS parent_id, 0.13502538204193115 AS [Score] UNION ALL SELECT 12 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 5 AS parent_id, 0.0261838436126709 AS [Score] UNION ALL SELECT 13 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 6 AS parent_id, -0.05177664756774902 AS [Score] UNION ALL SELECT 14 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 6 AS parent_id, 0.02921348251402378 AS [Score]) AS [Values]), 
[DT_Output] AS 
...
[DT_node_data_1] AS 
(SELECT [Values].node_id AS node_id, [Values].feature AS feature, [Values].threshold AS threshold, [Values].depth AS depth, [Values].parent_id AS parent_id, [Values].[Score] AS [Score] 
FROM (SELECT 7 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 3 AS parent_id, -0.003278688294813037 AS [Score] UNION ALL SELECT 8 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 3 AS parent_id, -0.056934308260679245 AS [Score] UNION ALL SELECT 9 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 4 AS parent_id, 0.026487523689866066 AS [Score] UNION ALL SELECT 10 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 4 AS parent_id, -0.035694051533937454 AS [Score] UNION ALL SELECT 11 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 5 AS parent_id, 0.0029850746504962444 AS [Score] UNION ALL SELECT 12 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 5 AS parent_id, 0.09965156763792038 AS [Score] UNION ALL SELECT 13 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 6 AS parent_id, 0.06315789371728897 AS [Score] UNION ALL SELECT 14 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 6 AS parent_id, -0.02593660168349743 AS [Score]) AS [Values]), 
[DT_Output_1] AS 
...
[DT_node_data_2] AS 
(SELECT [Values].node_id AS node_id, [Values].feature AS feature, [Values].threshold AS threshold, [Values].depth AS depth, [Values].parent_id AS parent_id, [Values].[Score] AS [Score] 
FROM (SELECT 7 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 3 AS parent_id, 0 AS [Score] UNION ALL SELECT 8 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 3 AS parent_id, -0.050349652767181396 AS [Score] UNION ALL SELECT 9 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 4 AS parent_id, 0.08905109763145447 AS [Score] UNION ALL SELECT 10 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 4 AS parent_id, -0.015189873054623604 AS [Score] UNION ALL SELECT 11 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 5 AS parent_id, 0.15102040767669678 AS [Score] UNION ALL SELECT 12 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 5 AS parent_id, 0.04477612301707268 AS [Score] UNION ALL SELECT 13 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 6 AS parent_id, -0.015625 AS [Score] UNION ALL SELECT 14 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 6 AS parent_id, 0.06276150792837143 AS [Score]) AS [Values]), 
[DT_Output_2] AS 
...
[DT_node_data_3] AS 
(SELECT [Values].node_id AS node_id, [Values].feature AS feature, [Values].threshold AS threshold, [Values].depth AS depth, [Values].parent_id AS parent_id, [Values].[Score] AS [Score] 
FROM (SELECT 5 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 2 AS depth, 2 AS parent_id, 0.0579439215362072 AS [Score] UNION ALL SELECT 7 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 3 AS parent_id, 0.1210300475358963 AS [Score] UNION ALL SELECT 8 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 3 AS parent_id, 0.02641509473323822 AS [Score] UNION ALL SELECT 9 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 4 AS parent_id, -0.031511254608631134 AS [Score] UNION ALL SELECT 10 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 4 AS parent_id, 0.041624363511800766 AS [Score] UNION ALL SELECT 11 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 6 AS parent_id, -0.0494915246963501 AS [Score] UNION ALL SELECT 12 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 6 AS parent_id, -0.008436724543571472 AS [Score]) AS [Values]), 
[DT_Output_3] AS 
...
[DT_node_data_4] AS 
(SELECT [Values].node_id AS node_id, [Values].feature AS feature, [Values].threshold AS threshold, [Values].depth AS depth, [Values].parent_id AS parent_id, [Values].[Score] AS [Score] 
FROM (SELECT 7 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 3 AS parent_id, 0.025498611852526665 AS [Score] UNION ALL SELECT 8 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 3 AS parent_id, -0.05176679417490959 AS [Score] UNION ALL SELECT 9 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 4 AS parent_id, -0.04878098517656326 AS [Score] UNION ALL SELECT 10 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 4 AS parent_id, 0.010918477550148964 AS [Score] UNION ALL SELECT 11 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 5 AS parent_id, 0.10659374296665192 AS [Score] UNION ALL SELECT 12 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 5 AS parent_id, 0.023271365091204643 AS [Score] UNION ALL SELECT 13 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 6 AS parent_id, 0.02157382294535637 AS [Score] UNION ALL SELECT 14 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 6 AS parent_id, -0.04819092899560928 AS [Score]) AS [Values]), 
[DT_Output_4] AS 
...
[DT_node_data_5] AS 
(SELECT [Values].node_id AS node_id, [Values].feature AS feature, [Values].threshold AS threshold, [Values].depth AS depth, [Values].parent_id AS parent_id, [Values].[Score] AS [Score] 
FROM (SELECT 7 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 3 AS parent_id, -0.05686519667506218 AS [Score] UNION ALL SELECT 8 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 3 AS parent_id, -0.007737312000244856 AS [Score] UNION ALL SELECT 9 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 4 AS parent_id, 0.024737540632486343 AS [Score] UNION ALL SELECT 10 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 4 AS parent_id, -0.03437568247318268 AS [Score] UNION ALL SELECT 11 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 5 AS parent_id, 0.003009149804711342 AS [Score] UNION ALL SELECT 12 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 5 AS parent_id, 0.08948536962270737 AS [Score] UNION ALL SELECT 13 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 6 AS parent_id, 0.057923801243305206 AS [Score] UNION ALL SELECT 14 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 6 AS parent_id, -0.024935407564044 AS [Score]) AS [Values]), 
[DT_Output_5] AS 
...
[DT_node_data_6] AS 
(SELECT [Values].node_id AS node_id, [Values].feature AS feature, [Values].threshold AS threshold, [Values].depth AS depth, [Values].parent_id AS parent_id, [Values].[Score] AS [Score] 
FROM (SELECT 7 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 3 AS parent_id, 0.12724867463111877 AS [Score] UNION ALL SELECT 8 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 3 AS parent_id, 0.029889622703194618 AS [Score] UNION ALL SELECT 9 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 4 AS parent_id, 0.007980834692716599 AS [Score] UNION ALL SELECT 10 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 4 AS parent_id, -0.05286563187837601 AS [Score] UNION ALL SELECT 11 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 5 AS parent_id, -0.04973331838846207 AS [Score] UNION ALL SELECT 12 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 5 AS parent_id, 0.006627052556723356 AS [Score] UNION ALL SELECT 13 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 6 AS parent_id, 0.07008529454469681 AS [Score] UNION ALL SELECT 14 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 6 AS parent_id, -0.018304329365491867 AS [Score]) AS [Values]), 
[DT_Output_6] AS 
...
[DT_node_data_7] AS 
(SELECT [Values].node_id AS node_id, [Values].feature AS feature, [Values].threshold AS threshold, [Values].depth AS depth, [Values].parent_id AS parent_id, [Values].[Score] AS [Score] 
FROM (SELECT 7 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 3 AS parent_id, 0.1155257374048233 AS [Score] UNION ALL SELECT 8 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 3 AS parent_id, 0.03019239939749241 AS [Score] UNION ALL SELECT 9 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 4 AS parent_id, -0.04226556047797203 AS [Score] UNION ALL SELECT 10 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 4 AS parent_id, 0.027537737041711807 AS [Score] UNION ALL SELECT 11 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 5 AS parent_id, -0.01156309898942709 AS [Score] UNION ALL SELECT 12 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 5 AS parent_id, -0.058785151690244675 AS [Score] UNION ALL SELECT 13 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 6 AS parent_id, 0.0817631259560585 AS [Score] UNION ALL SELECT 14 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 6 AS parent_id, -0.013365225866436958 AS [Score]) AS [Values]), 
[DT_Output_7] AS 
...
[DT_node_data_8] AS 
(SELECT [Values].node_id AS node_id, [Values].feature AS feature, [Values].threshold AS threshold, [Values].depth AS depth, [Values].parent_id AS parent_id, [Values].[Score] AS [Score] 
FROM (SELECT 7 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 3 AS parent_id, 0.05516712740063667 AS [Score] UNION ALL SELECT 8 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 3 AS parent_id, -0.02568330429494381 AS [Score] UNION ALL SELECT 9 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 4 AS parent_id, -0.007661888841539621 AS [Score] UNION ALL SELECT 10 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 4 AS parent_id, -0.054290879517793655 AS [Score] UNION ALL SELECT 11 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 5 AS parent_id, 0.08894934505224228 AS [Score] UNION ALL SELECT 12 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 5 AS parent_id, -0.0014713649870827794 AS [Score] UNION ALL SELECT 13 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 6 AS parent_id, 0.016941478475928307 AS [Score] UNION ALL SELECT 14 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 6 AS parent_id, -0.04010751470923424 AS [Score]) AS [Values]), 
[DT_Output_8] AS 
...
[DT_node_data_9] AS 
(SELECT [Values].node_id AS node_id, [Values].feature AS feature, [Values].threshold AS threshold, [Values].depth AS depth, [Values].parent_id AS parent_id, [Values].[Score] AS [Score] 
FROM (SELECT 7 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 3 AS parent_id, -0.001108604483306408 AS [Score] UNION ALL SELECT 8 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 3 AS parent_id, -0.054617155343294144 AS [Score] UNION ALL SELECT 9 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 4 AS parent_id, 0.023069441318511963 AS [Score] UNION ALL SELECT 10 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 4 AS parent_id, -0.0331183485686779 AS [Score] UNION ALL SELECT 11 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 5 AS parent_id, -0.029720613732933998 AS [Score] UNION ALL SELECT 12 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 5 AS parent_id, 0.04233134910464287 AS [Score] UNION ALL SELECT 13 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 6 AS parent_id, 0.023018721491098404 AS [Score] UNION ALL SELECT 14 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 6 AS parent_id, 0.095349982380867 AS [Score]) AS [Values]), 
[DT_Output_9] AS 
...
FROM [DT_Output_9])
 INSERT INTO ##TMP_20180329233306_DUIJZJ_XGB_Sum_B0 ([KEY], [Score_0], [Score_1], [Score_2], [Score_3]) SELECT [XGB_Sum_B0].[KEY], [XGB_Sum_B0].[Score_0], [XGB_Sum_B0].[Score_1], [XGB_Sum_B0].[Score_2], [XGB_Sum_B0].[Score_3] 
...
-- Code For temporary table ##TMP_20180329233306_2K0J8O_XGB_Sum_B1 part 1/2. Create 


CREATE TABLE ##TMP_20180329233306_2K0J8O_XGB_Sum_B1 (
	[KEY] BIGINT NULL, 
	[Score_0] FLOAT(53) NULL, 
	[Score_1] FLOAT(53) NULL, 
	[Score_2] FLOAT(53) NULL, 
...
-- Code For temporary table ##TMP_20180329233306_2K0J8O_XGB_Sum_B1 part 2/2. Populate
...
[DT_node_data_10] AS 
(SELECT [Values].node_id AS node_id, [Values].feature AS feature, [Values].threshold AS threshold, [Values].depth AS depth, [Values].parent_id AS parent_id, [Values].[Score] AS [Score] 
FROM (SELECT 5 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 2 AS depth, 2 AS parent_id, 0.10967139154672623 AS [Score] UNION ALL SELECT 7 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 3 AS parent_id, 0.0006981450715102255 AS [Score] UNION ALL SELECT 8 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 3 AS parent_id, -0.048348259180784225 AS [Score] UNION ALL SELECT 9 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 4 AS parent_id, 0.07572909444570541 AS [Score] UNION ALL SELECT 10 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 4 AS parent_id, -0.014470398426055908 AS [Score] UNION ALL SELECT 11 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 6 AS parent_id, -0.014250566251575947 AS [Score] UNION ALL SELECT 12 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 6 AS parent_id, 0.045102499425411224 AS [Score]) AS [Values]), 
[DT_Output_10] AS 
...
[DT_node_data_11] AS 
(SELECT [Values].node_id AS node_id, [Values].feature AS feature, [Values].threshold AS threshold, [Values].depth AS depth, [Values].parent_id AS parent_id, [Values].[Score] AS [Score] 
FROM (SELECT 7 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 3 AS parent_id, 0.12442632764577866 AS [Score] UNION ALL SELECT 8 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 3 AS parent_id, 0.043950628489255905 AS [Score] UNION ALL SELECT 9 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 4 AS parent_id, 0.060867439955472946 AS [Score] UNION ALL SELECT 10 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 4 AS parent_id, -0.027648985385894775 AS [Score] UNION ALL SELECT 11 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 5 AS parent_id, -0.032984111458063126 AS [Score] UNION ALL SELECT 12 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 5 AS parent_id, 0.03191494196653366 AS [Score] UNION ALL SELECT 13 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 6 AS parent_id, -0.04126276820898056 AS [Score] UNION ALL SELECT 14 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 6 AS parent_id, 0.029605058953166008 AS [Score]) AS [Values]), 
[DT_Output_11] AS 
...
[DT_node_data_12] AS 
(SELECT [Values].node_id AS node_id, [Values].feature AS feature, [Values].threshold AS threshold, [Values].depth AS depth, [Values].parent_id AS parent_id, [Values].[Score] AS [Score] 
FROM (SELECT 7 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 3 AS parent_id, -0.029904210940003395 AS [Score] UNION ALL SELECT 8 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 3 AS parent_id, 0.06685043126344681 AS [Score] UNION ALL SELECT 9 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 4 AS parent_id, -0.045662883669137955 AS [Score] UNION ALL SELECT 10 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 4 AS parent_id, -0.0024754067417234182 AS [Score] UNION ALL SELECT 11 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 5 AS parent_id, 0.011611285619437695 AS [Score] UNION ALL SELECT 12 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 5 AS parent_id, 0.09090034663677216 AS [Score] UNION ALL SELECT 13 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 6 AS parent_id, -0.04952401667833328 AS [Score] UNION ALL SELECT 14 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 6 AS parent_id, 0.028574800118803978 AS [Score]) AS [Values]), 
[DT_Output_12] AS 
...
[DT_node_data_13] AS 
(SELECT [Values].node_id AS node_id, [Values].feature AS feature, [Values].threshold AS threshold, [Values].depth AS depth, [Values].parent_id AS parent_id, [Values].[Score] AS [Score] 
FROM (SELECT 7 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 3 AS parent_id, -0.0012800133554264903 AS [Score] UNION ALL SELECT 8 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 3 AS parent_id, -0.053506266325712204 AS [Score] UNION ALL SELECT 9 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 4 AS parent_id, 0.043034303933382034 AS [Score] UNION ALL SELECT 10 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 4 AS parent_id, -0.015590890310704708 AS [Score] UNION ALL SELECT 11 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 5 AS parent_id, 0.10033302754163742 AS [Score] UNION ALL SELECT 12 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 5 AS parent_id, 0.027957722544670105 AS [Score] UNION ALL SELECT 13 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 6 AS parent_id, 0.05073144659399986 AS [Score] UNION ALL SELECT 14 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 6 AS parent_id, -0.024652263149619102 AS [Score]) AS [Values]), 
[DT_Output_13] AS 
...
[DT_node_data_14] AS 
(SELECT [Values].node_id AS node_id, [Values].feature AS feature, [Values].threshold AS threshold, [Values].depth AS depth, [Values].parent_id AS parent_id, [Values].[Score] AS [Score] 
FROM (SELECT 7 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 3 AS parent_id, -0.02777116559445858 AS [Score] UNION ALL SELECT 8 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 3 AS parent_id, 0.0516267791390419 AS [Score] UNION ALL SELECT 9 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 4 AS parent_id, -0.03446497768163681 AS [Score] UNION ALL SELECT 10 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 4 AS parent_id, 0.014176211319863796 AS [Score] UNION ALL SELECT 11 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 5 AS parent_id, -0.02818564884364605 AS [Score] UNION ALL SELECT 12 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 5 AS parent_id, 0.05528451129794121 AS [Score] UNION ALL SELECT 13 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 6 AS parent_id, 0.0027096678968518972 AS [Score] UNION ALL SELECT 14 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 6 AS parent_id, -0.05979834869503975 AS [Score]) AS [Values]), 
[DT_Output_14] AS 
...
[DT_node_data_15] AS 
(SELECT [Values].node_id AS node_id, [Values].feature AS feature, [Values].threshold AS threshold, [Values].depth AS depth, [Values].parent_id AS parent_id, [Values].[Score] AS [Score] 
FROM (SELECT 3 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 2 AS depth, 1 AS parent_id, 0.10651014000177383 AS [Score] UNION ALL SELECT 7 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 4 AS parent_id, 0.042609017342329025 AS [Score] UNION ALL SELECT 8 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 4 AS parent_id, -0.019566327333450317 AS [Score] UNION ALL SELECT 9 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 5 AS parent_id, -0.010257179848849773 AS [Score] UNION ALL SELECT 10 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 5 AS parent_id, -0.057035382837057114 AS [Score] UNION ALL SELECT 11 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 6 AS parent_id, 0.04231635481119156 AS [Score] UNION ALL SELECT 12 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 6 AS parent_id, -0.01981682889163494 AS [Score]) AS [Values]), 
[DT_Output_15] AS 
...
[DT_node_data_16] AS 
(SELECT [Values].node_id AS node_id, [Values].feature AS feature, [Values].threshold AS threshold, [Values].depth AS depth, [Values].parent_id AS parent_id, [Values].[Score] AS [Score] 
FROM (SELECT 7 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 3 AS parent_id, -0.04385801777243614 AS [Score] UNION ALL SELECT 8 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 3 AS parent_id, 0.04399209842085838 AS [Score] UNION ALL SELECT 9 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 4 AS parent_id, 0.10625304281711578 AS [Score] UNION ALL SELECT 10 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 4 AS parent_id, 0.007796549238264561 AS [Score] UNION ALL SELECT 11 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 5 AS parent_id, -0.012943456880748272 AS [Score] UNION ALL SELECT 12 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 5 AS parent_id, -0.05297156795859337 AS [Score] UNION ALL SELECT 13 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 6 AS parent_id, -0.027847403660416603 AS [Score] UNION ALL SELECT 14 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 6 AS parent_id, 0.06330638378858566 AS [Score]) AS [Values]), 
[DT_Output_16] AS 
...
[DT_node_data_17] AS 
(SELECT [Values].node_id AS node_id, [Values].feature AS feature, [Values].threshold AS threshold, [Values].depth AS depth, [Values].parent_id AS parent_id, [Values].[Score] AS [Score] 
FROM (SELECT 7 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 3 AS parent_id, -0.05378418043255806 AS [Score] UNION ALL SELECT 8 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 3 AS parent_id, -0.004072760231792927 AS [Score] UNION ALL SELECT 9 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 4 AS parent_id, 0.021538013592362404 AS [Score] UNION ALL SELECT 10 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 4 AS parent_id, -0.03184014558792114 AS [Score] UNION ALL SELECT 11 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 5 AS parent_id, -0.028020789846777916 AS [Score] UNION ALL SELECT 12 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 5 AS parent_id, 0.04416603222489357 AS [Score] UNION ALL SELECT 13 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 6 AS parent_id, 0.006774949375540018 AS [Score] UNION ALL SELECT 14 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 6 AS parent_id, 0.06902935355901718 AS [Score]) AS [Values]), 
[DT_Output_17] AS 
...
[DT_node_data_18] AS 
(SELECT [Values].node_id AS node_id, [Values].feature AS feature, [Values].threshold AS threshold, [Values].depth AS depth, [Values].parent_id AS parent_id, [Values].[Score] AS [Score] 
FROM (SELECT 7 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 3 AS parent_id, -0.0011311509879305959 AS [Score] UNION ALL SELECT 8 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 3 AS parent_id, -0.05170100927352905 AS [Score] UNION ALL SELECT 9 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 4 AS parent_id, -0.01547986175864935 AS [Score] UNION ALL SELECT 10 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 4 AS parent_id, 0.054527681320905685 AS [Score] UNION ALL SELECT 11 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 5 AS parent_id, 0.12224248796701431 AS [Score] UNION ALL SELECT 12 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 5 AS parent_id, 0.037100281566381454 AS [Score] UNION ALL SELECT 13 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 6 AS parent_id, -0.01568789966404438 AS [Score] UNION ALL SELECT 14 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 6 AS parent_id, 0.05215974524617195 AS [Score]) AS [Values]), 
[DT_Output_18] AS 
...
[DT_node_data_19] AS 
(SELECT [Values].node_id AS node_id, [Values].feature AS feature, [Values].threshold AS threshold, [Values].depth AS depth, [Values].parent_id AS parent_id, [Values].[Score] AS [Score] 
FROM (SELECT 3 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 2 AS depth, 1 AS parent_id, 0.03998119756579399 AS [Score] UNION ALL SELECT 7 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 4 AS parent_id, 0.03256377950310707 AS [Score] UNION ALL SELECT 8 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 4 AS parent_id, -0.04128411412239075 AS [Score] UNION ALL SELECT 9 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 5 AS parent_id, 0.11459574848413467 AS [Score] UNION ALL SELECT 10 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 5 AS parent_id, 0.02961430884897709 AS [Score] UNION ALL SELECT 11 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 6 AS parent_id, -0.028575077652931213 AS [Score] UNION ALL SELECT 12 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 6 AS parent_id, 0.02120259404182434 AS [Score]) AS [Values]), 
[DT_Output_19] AS 
...
FROM [DT_Output_19])
 INSERT INTO ##TMP_20180329233306_2K0J8O_XGB_Sum_B1 ([KEY], [Score_0], [Score_1], [Score_2], [Score_3]) SELECT [XGB_Sum_B1].[KEY], [XGB_Sum_B1].[Score_0], [XGB_Sum_B1].[Score_1], [XGB_Sum_B1].[Score_2], [XGB_Sum_B1].[Score_3] 
...
-- Code For temporary table ##TMP_20180329233306_5B3HSQ_XGB_Sum_B2 part 1/2. Create 


CREATE TABLE ##TMP_20180329233306_5B3HSQ_XGB_Sum_B2 (
	[KEY] BIGINT NULL, 
	[Score_0] FLOAT(53) NULL, 
	[Score_1] FLOAT(53) NULL, 
	[Score_2] FLOAT(53) NULL, 
...
-- Code For temporary table ##TMP_20180329233306_5B3HSQ_XGB_Sum_B2 part 2/2. Populate
...
[DT_node_data_20] AS 
(SELECT [Values].node_id AS node_id, [Values].feature AS feature, [Values].threshold AS threshold, [Values].depth AS depth, [Values].parent_id AS parent_id, [Values].[Score] AS [Score] 
FROM (SELECT 7 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 3 AS parent_id, 0.055468231439590454 AS [Score] UNION ALL SELECT 8 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 3 AS parent_id, -0.02480579912662506 AS [Score] UNION ALL SELECT 9 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 4 AS parent_id, -0.02433389239013195 AS [Score] UNION ALL SELECT 10 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 4 AS parent_id, -0.05841735750436783 AS [Score] UNION ALL SELECT 11 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 5 AS parent_id, 0.07362955808639526 AS [Score] UNION ALL SELECT 12 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 5 AS parent_id, -0.0022624977864325047 AS [Score] UNION ALL SELECT 13 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 6 AS parent_id, 0.015429462306201458 AS [Score] UNION ALL SELECT 14 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 6 AS parent_id, -0.03744170069694519 AS [Score]) AS [Values]), 
[DT_Output_20] AS 
...
[DT_node_data_21] AS 
(SELECT [Values].node_id AS node_id, [Values].feature AS feature, [Values].threshold AS threshold, [Values].depth AS depth, [Values].parent_id AS parent_id, [Values].[Score] AS [Score] 
FROM (SELECT 7 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 3 AS parent_id, -0.0060035912320017815 AS [Score] UNION ALL SELECT 8 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 3 AS parent_id, 0.06701063364744186 AS [Score] UNION ALL SELECT 9 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 4 AS parent_id, -0.044362135231494904 AS [Score] UNION ALL SELECT 10 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 4 AS parent_id, 0.011958517134189606 AS [Score] UNION ALL SELECT 11 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 5 AS parent_id, 0.06137970834970474 AS [Score] UNION ALL SELECT 12 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 5 AS parent_id, -0.027874445542693138 AS [Score] UNION ALL SELECT 13 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 6 AS parent_id, -0.05646149069070816 AS [Score] UNION ALL SELECT 14 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 6 AS parent_id, 0.006918293423950672 AS [Score]) AS [Values]), 
[DT_Output_21] AS 
...
[DT_node_data_22] AS 
(SELECT [Values].node_id AS node_id, [Values].feature AS feature, [Values].threshold AS threshold, [Values].depth AS depth, [Values].parent_id AS parent_id, [Values].[Score] AS [Score] 
FROM (SELECT 7 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 3 AS parent_id, 0.010038317181169987 AS [Score] UNION ALL SELECT 8 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 3 AS parent_id, 0.06581904739141464 AS [Score] UNION ALL SELECT 9 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 4 AS parent_id, -0.03301742300391197 AS [Score] UNION ALL SELECT 10 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 4 AS parent_id, 0.012963376939296722 AS [Score] UNION ALL SELECT 11 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 5 AS parent_id, -0.02734876051545143 AS [Score] UNION ALL SELECT 12 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 5 AS parent_id, 0.05313423275947571 AS [Score] UNION ALL SELECT 13 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 6 AS parent_id, 0.003317302791401744 AS [Score] UNION ALL SELECT 14 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 6 AS parent_id, -0.058521535247564316 AS [Score]) AS [Values]), 
[DT_Output_22] AS 
...
[DT_node_data_23] AS 
(SELECT [Values].node_id AS node_id, [Values].feature AS feature, [Values].threshold AS threshold, [Values].depth AS depth, [Values].parent_id AS parent_id, [Values].[Score] AS [Score] 
FROM (SELECT 5 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 2 AS depth, 2 AS parent_id, 0.05113719031214714 AS [Score] UNION ALL SELECT 7 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 3 AS parent_id, 0.07376319169998169 AS [Score] UNION ALL SELECT 8 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 3 AS parent_id, -0.009297083131968975 AS [Score] UNION ALL SELECT 9 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 4 AS parent_id, -0.029553154483437538 AS [Score] UNION ALL SELECT 10 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 4 AS parent_id, 0.035830043256282806 AS [Score] UNION ALL SELECT 11 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 6 AS parent_id, -0.04796059429645538 AS [Score] UNION ALL SELECT 12 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 6 AS parent_id, -0.007959111593663692 AS [Score]) AS [Values]), 
[DT_Output_23] AS 
...
[DT_node_data_24] AS 
(SELECT [Values].node_id AS node_id, [Values].feature AS feature, [Values].threshold AS threshold, [Values].depth AS depth, [Values].parent_id AS parent_id, [Values].[Score] AS [Score] 
FROM (SELECT 7 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 3 AS parent_id, 0.04272940382361412 AS [Score] UNION ALL SELECT 8 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 3 AS parent_id, -0.025317003950476646 AS [Score] UNION ALL SELECT 9 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 4 AS parent_id, -0.039187896996736526 AS [Score] UNION ALL SELECT 10 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 4 AS parent_id, -0.06160258129239082 AS [Score] UNION ALL SELECT 11 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 5 AS parent_id, 0.1095559224486351 AS [Score] UNION ALL SELECT 12 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 5 AS parent_id, 0.005851211957633495 AS [Score] UNION ALL SELECT 13 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 6 AS parent_id, -0.02739163115620613 AS [Score] UNION ALL SELECT 14 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 6 AS parent_id, 0.020885992795228958 AS [Score]) AS [Values]), 
[DT_Output_24] AS 
...
[DT_node_data_25] AS 
(SELECT [Values].node_id AS node_id, [Values].feature AS feature, [Values].threshold AS threshold, [Values].depth AS depth, [Values].parent_id AS parent_id, [Values].[Score] AS [Score] 
FROM (SELECT 7 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 3 AS parent_id, 0.046155136078596115 AS [Score] UNION ALL SELECT 8 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 3 AS parent_id, -0.021105259656906128 AS [Score] UNION ALL SELECT 9 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 4 AS parent_id, 0.0028807921335101128 AS [Score] UNION ALL SELECT 10 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 4 AS parent_id, 0.07023207098245621 AS [Score] UNION ALL SELECT 11 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 5 AS parent_id, -0.005796495359390974 AS [Score] UNION ALL SELECT 12 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 5 AS parent_id, -0.05261370539665222 AS [Score] UNION ALL SELECT 13 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 6 AS parent_id, 0.0334383063018322 AS [Score] UNION ALL SELECT 14 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 6 AS parent_id, -0.03471791371703148 AS [Score]) AS [Values]), 
[DT_Output_25] AS 
...
[DT_node_data_26] AS 
(SELECT [Values].node_id AS node_id, [Values].feature AS feature, [Values].threshold AS threshold, [Values].depth AS depth, [Values].parent_id AS parent_id, [Values].[Score] AS [Score] 
FROM (SELECT 7 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 3 AS parent_id, 0.0480872206389904 AS [Score] UNION ALL SELECT 8 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 3 AS parent_id, -0.02567831054329872 AS [Score] UNION ALL SELECT 9 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 4 AS parent_id, 0.055146217346191406 AS [Score] UNION ALL SELECT 10 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 4 AS parent_id, -0.043772440403699875 AS [Score] UNION ALL SELECT 11 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 5 AS parent_id, 0.03156007453799248 AS [Score] UNION ALL SELECT 12 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 5 AS parent_id, 0.1234440729022026 AS [Score] UNION ALL SELECT 13 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 6 AS parent_id, -0.03759337589144707 AS [Score] UNION ALL SELECT 14 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 6 AS parent_id, 0.046198826283216476 AS [Score]) AS [Values]), 
[DT_Output_26] AS 
...
[DT_node_data_27] AS 
(SELECT [Values].node_id AS node_id, [Values].feature AS feature, [Values].threshold AS threshold, [Values].depth AS depth, [Values].parent_id AS parent_id, [Values].[Score] AS [Score] 
FROM (SELECT 7 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 3 AS parent_id, 0.02995513193309307 AS [Score] UNION ALL SELECT 8 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 3 AS parent_id, -0.030499717220664024 AS [Score] UNION ALL SELECT 9 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 4 AS parent_id, -0.026748795062303543 AS [Score] UNION ALL SELECT 10 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 4 AS parent_id, -0.062266673892736435 AS [Score] UNION ALL SELECT 11 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 5 AS parent_id, 0.10039789974689484 AS [Score] UNION ALL SELECT 12 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 5 AS parent_id, 0.026707617565989494 AS [Score] UNION ALL SELECT 13 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 6 AS parent_id, 0.029458368197083473 AS [Score] UNION ALL SELECT 14 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 6 AS parent_id, -0.015608365647494793 AS [Score]) AS [Values]), 
[DT_Output_27] AS 
...
[DT_node_data_28] AS 
(SELECT [Values].node_id AS node_id, [Values].feature AS feature, [Values].threshold AS threshold, [Values].depth AS depth, [Values].parent_id AS parent_id, [Values].[Score] AS [Score] 
FROM (SELECT 7 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 3 AS parent_id, -0.05062326788902283 AS [Score] UNION ALL SELECT 8 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 3 AS parent_id, 0.02901136688888073 AS [Score] UNION ALL SELECT 9 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 4 AS parent_id, 0.023958656936883926 AS [Score] UNION ALL SELECT 10 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 4 AS parent_id, 0.08924262970685959 AS [Score] UNION ALL SELECT 11 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 5 AS parent_id, -0.012246732600033283 AS [Score] UNION ALL SELECT 12 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 5 AS parent_id, -0.05086950585246086 AS [Score] UNION ALL SELECT 13 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 6 AS parent_id, -0.02588464319705963 AS [Score] UNION ALL SELECT 14 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 6 AS parent_id, 0.05837602540850639 AS [Score]) AS [Values]), 
[DT_Output_28] AS 
...
[DT_node_data_29] AS 
(SELECT [Values].node_id AS node_id, [Values].feature AS feature, [Values].threshold AS threshold, [Values].depth AS depth, [Values].parent_id AS parent_id, [Values].[Score] AS [Score] 
FROM (SELECT 7 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 3 AS parent_id, 0.0009880325524136424 AS [Score] UNION ALL SELECT 8 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 3 AS parent_id, -0.05089639499783516 AS [Score] UNION ALL SELECT 9 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 4 AS parent_id, 0.01912977173924446 AS [Score] UNION ALL SELECT 10 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 4 AS parent_id, -0.029964029788970947 AS [Score] UNION ALL SELECT 11 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 5 AS parent_id, -0.02508319728076458 AS [Score] UNION ALL SELECT 12 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 5 AS parent_id, 0.038584038615226746 AS [Score] UNION ALL SELECT 13 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 6 AS parent_id, 0.02349322848021984 AS [Score] UNION ALL SELECT 14 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 6 AS parent_id, 0.08804778009653091 AS [Score]) AS [Values]), 
[DT_Output_29] AS 
...
FROM [DT_Output_29])
 INSERT INTO ##TMP_20180329233306_5B3HSQ_XGB_Sum_B2 ([KEY], [Score_0], [Score_1], [Score_2], [Score_3]) SELECT [XGB_Sum_B2].[KEY], [XGB_Sum_B2].[Score_0], [XGB_Sum_B2].[Score_1], [XGB_Sum_B2].[Score_2], [XGB_Sum_B2].[Score_3] 
...
-- Code For temporary table ##TMP_20180329233306_AA1JI1_XGB_Sum_B3 part 1/2. Create 


CREATE TABLE ##TMP_20180329233306_AA1JI1_XGB_Sum_B3 (
	[KEY] BIGINT NULL, 
	[Score_0] FLOAT(53) NULL, 
	[Score_1] FLOAT(53) NULL, 
	[Score_2] FLOAT(53) NULL, 
...
-- Code For temporary table ##TMP_20180329233306_AA1JI1_XGB_Sum_B3 part 2/2. Populate
...
[DT_node_data_30] AS 
(SELECT [Values].node_id AS node_id, [Values].feature AS feature, [Values].threshold AS threshold, [Values].depth AS depth, [Values].parent_id AS parent_id, [Values].[Score] AS [Score] 
FROM (SELECT 3 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 2 AS depth, 1 AS parent_id, -0.034783024340867996 AS [Score] UNION ALL SELECT 4 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 2 AS depth, 1 AS parent_id, 0.10543046146631241 AS [Score] UNION ALL SELECT 7 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 5 AS parent_id, 0.08061207830905914 AS [Score] UNION ALL SELECT 8 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 5 AS parent_id, -0.03037106990814209 AS [Score] UNION ALL SELECT 9 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 6 AS parent_id, -0.021619809791445732 AS [Score] UNION ALL SELECT 10 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 6 AS parent_id, 0.055830515921115875 AS [Score]) AS [Values]), 
[DT_Output_30] AS 
...
[DT_node_data_31] AS 
(SELECT [Values].node_id AS node_id, [Values].feature AS feature, [Values].threshold AS threshold, [Values].depth AS depth, [Values].parent_id AS parent_id, [Values].[Score] AS [Score] 
FROM (SELECT 4 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 2 AS depth, 1 AS parent_id, -0.04847417771816254 AS [Score] UNION ALL SELECT 7 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 3 AS parent_id, 0.0729953944683075 AS [Score] UNION ALL SELECT 8 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 3 AS parent_id, 0.013595908880233765 AS [Score] UNION ALL SELECT 9 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 5 AS parent_id, 0.032732512801885605 AS [Score] UNION ALL SELECT 10 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 5 AS parent_id, -0.024207843467593193 AS [Score] UNION ALL SELECT 11 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 6 AS parent_id, -0.03808260336518288 AS [Score] UNION ALL SELECT 12 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 6 AS parent_id, 0.02809174172580242 AS [Score]) AS [Values]), 
[DT_Output_31] AS 
...
[DT_node_data_32] AS 
(SELECT [Values].node_id AS node_id, [Values].feature AS feature, [Values].threshold AS threshold, [Values].depth AS depth, [Values].parent_id AS parent_id, [Values].[Score] AS [Score] 
FROM (SELECT 2 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 1 AS depth, 0 AS parent_id, 0.08278333395719528 AS [Score] UNION ALL SELECT 5 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 3 AS parent_id, -0.02895318903028965 AS [Score] UNION ALL SELECT 6 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 3 AS parent_id, 0.03702819347381592 AS [Score] UNION ALL SELECT 7 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 4 AS parent_id, -0.031459055840969086 AS [Score] UNION ALL SELECT 8 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 4 AS parent_id, 0.018474912270903587 AS [Score]) AS [Values]), 
[DT_Output_32] AS 
...
[DT_node_data_33] AS 
(SELECT [Values].node_id AS node_id, [Values].feature AS feature, [Values].threshold AS threshold, [Values].depth AS depth, [Values].parent_id AS parent_id, [Values].[Score] AS [Score] 
FROM (SELECT 7 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 3 AS parent_id, 0.015440719202160835 AS [Score] UNION ALL SELECT 8 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 3 AS parent_id, -0.05111033841967583 AS [Score] UNION ALL SELECT 9 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 4 AS parent_id, 0.008606505580246449 AS [Score] UNION ALL SELECT 10 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 4 AS parent_id, 0.06215933710336685 AS [Score] UNION ALL SELECT 11 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 5 AS parent_id, -0.01880643330514431 AS [Score] UNION ALL SELECT 12 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 5 AS parent_id, 0.058589089661836624 AS [Score] UNION ALL SELECT 13 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 6 AS parent_id, 0.002135075395926833 AS [Score] UNION ALL SELECT 14 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 6 AS parent_id, -0.04959695786237717 AS [Score]) AS [Values]), 
[DT_Output_33] AS 
...
[DT_node_data_34] AS 
(SELECT [Values].node_id AS node_id, [Values].feature AS feature, [Values].threshold AS threshold, [Values].depth AS depth, [Values].parent_id AS parent_id, [Values].[Score] AS [Score] 
FROM (SELECT 7 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 3 AS parent_id, -0.026487398892641068 AS [Score] UNION ALL SELECT 8 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 3 AS parent_id, 0.04266810417175293 AS [Score] UNION ALL SELECT 9 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 4 AS parent_id, -0.04589756950736046 AS [Score] UNION ALL SELECT 10 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 4 AS parent_id, 0.002722901990637183 AS [Score] UNION ALL SELECT 11 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 5 AS parent_id, -0.027439186349511147 AS [Score] UNION ALL SELECT 12 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 5 AS parent_id, 0.052225906401872635 AS [Score] UNION ALL SELECT 13 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 6 AS parent_id, 0.0032512873876839876 AS [Score] UNION ALL SELECT 14 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 6 AS parent_id, -0.05706444010138512 AS [Score]) AS [Values]), 
[DT_Output_34] AS 
...
[DT_node_data_35] AS 
(SELECT [Values].node_id AS node_id, [Values].feature AS feature, [Values].threshold AS threshold, [Values].depth AS depth, [Values].parent_id AS parent_id, [Values].[Score] AS [Score] 
FROM (SELECT 4 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 2 AS depth, 1 AS parent_id, -0.04925098270177841 AS [Score] UNION ALL SELECT 7 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 3 AS parent_id, 0.05965579301118851 AS [Score] UNION ALL SELECT 8 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 3 AS parent_id, 0.0047521828673779964 AS [Score] UNION ALL SELECT 9 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 5 AS parent_id, -0.005236402153968811 AS [Score] UNION ALL SELECT 10 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 5 AS parent_id, -0.05082934722304344 AS [Score] UNION ALL SELECT 11 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 6 AS parent_id, -0.017452681437134743 AS [Score] UNION ALL SELECT 12 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 6 AS parent_id, 0.0426335483789444 AS [Score]) AS [Values]), 
[DT_Output_35] AS 
...
[DT_node_data_36] AS 
(SELECT [Values].node_id AS node_id, [Values].feature AS feature, [Values].threshold AS threshold, [Values].depth AS depth, [Values].parent_id AS parent_id, [Values].[Score] AS [Score] 
FROM (SELECT 7 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 3 AS parent_id, 0.05180240422487259 AS [Score] UNION ALL SELECT 8 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 3 AS parent_id, -0.022498054429888725 AS [Score] UNION ALL SELECT 9 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 4 AS parent_id, -0.02637512981891632 AS [Score] UNION ALL SELECT 10 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 4 AS parent_id, -0.0599818229675293 AS [Score] UNION ALL SELECT 11 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 5 AS parent_id, -0.0050123585388064384 AS [Score] UNION ALL SELECT 12 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 5 AS parent_id, 0.04904205724596977 AS [Score] UNION ALL SELECT 13 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 6 AS parent_id, 0.01569882594048977 AS [Score] UNION ALL SELECT 14 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 6 AS parent_id, -0.05217389389872551 AS [Score]) AS [Values]), 
[DT_Output_36] AS 
...
[DT_node_data_37] AS 
(SELECT [Values].node_id AS node_id, [Values].feature AS feature, [Values].threshold AS threshold, [Values].depth AS depth, [Values].parent_id AS parent_id, [Values].[Score] AS [Score] 
FROM (SELECT 7 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 3 AS parent_id, 0.06927194446325302 AS [Score] UNION ALL SELECT 8 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 3 AS parent_id, -0.02023971639573574 AS [Score] UNION ALL SELECT 9 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 4 AS parent_id, -0.005124978255480528 AS [Score] UNION ALL SELECT 10 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 4 AS parent_id, 0.07468491047620773 AS [Score] UNION ALL SELECT 11 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 5 AS parent_id, -0.04250505566596985 AS [Score] UNION ALL SELECT 12 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 5 AS parent_id, 0.017809366807341576 AS [Score] UNION ALL SELECT 13 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 6 AS parent_id, -0.03642440214753151 AS [Score] UNION ALL SELECT 14 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 6 AS parent_id, 0.03550633415579796 AS [Score]) AS [Values]), 
[DT_Output_37] AS 
...
[DT_node_data_38] AS 
(SELECT [Values].node_id AS node_id, [Values].feature AS feature, [Values].threshold AS threshold, [Values].depth AS depth, [Values].parent_id AS parent_id, [Values].[Score] AS [Score] 
FROM (SELECT 7 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 3 AS parent_id, 0.008966959081590176 AS [Score] UNION ALL SELECT 8 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 3 AS parent_id, -0.0405251644551754 AS [Score] UNION ALL SELECT 9 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 4 AS parent_id, -0.0213593989610672 AS [Score] UNION ALL SELECT 10 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 4 AS parent_id, 0.0535426028072834 AS [Score] UNION ALL SELECT 11 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 5 AS parent_id, 0.010978109203279018 AS [Score] UNION ALL SELECT 12 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 5 AS parent_id, 0.09166537970304489 AS [Score] UNION ALL SELECT 13 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 6 AS parent_id, -0.03505472466349602 AS [Score] UNION ALL SELECT 14 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 6 AS parent_id, 0.014539849944412708 AS [Score]) AS [Values]), 
[DT_Output_38] AS 
...
[DT_node_data_39] AS 
(SELECT [Values].node_id AS node_id, [Values].feature AS feature, [Values].threshold AS threshold, [Values].depth AS depth, [Values].parent_id AS parent_id, [Values].[Score] AS [Score] 
FROM (SELECT 7 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 3 AS parent_id, -0.05254552513360977 AS [Score] UNION ALL SELECT 8 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 3 AS parent_id, 0.012479444034397602 AS [Score] UNION ALL SELECT 9 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 4 AS parent_id, -0.02490890398621559 AS [Score] UNION ALL SELECT 10 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 4 AS parent_id, -0.06077225133776665 AS [Score] UNION ALL SELECT 11 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 5 AS parent_id, 0.08631572127342224 AS [Score] UNION ALL SELECT 12 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 5 AS parent_id, 0.02223650924861431 AS [Score] UNION ALL SELECT 13 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 6 AS parent_id, -0.03108919970691204 AS [Score] UNION ALL SELECT 14 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 6 AS parent_id, 0.028538642451167107 AS [Score]) AS [Values]), 
[DT_Output_39] AS 
...
FROM [DT_Output_39])
 INSERT INTO ##TMP_20180329233306_AA1JI1_XGB_Sum_B3 ([KEY], [Score_0], [Score_1], [Score_2], [Score_3]) SELECT [XGB_Sum_B3].[KEY], [XGB_Sum_B3].[Score_0], [XGB_Sum_B3].[Score_1], [XGB_Sum_B3].[Score_2], [XGB_Sum_B3].[Score_3] 
...
-- Code For temporary table ##TMP_20180329233306_F5GVH9_XGB_Sum_B4 part 1/2. Create 


CREATE TABLE ##TMP_20180329233306_F5GVH9_XGB_Sum_B4 (
	[KEY] BIGINT NULL, 
	[Score_0] FLOAT(53) NULL, 
	[Score_1] FLOAT(53) NULL, 
	[Score_2] FLOAT(53) NULL, 
...
-- Code For temporary table ##TMP_20180329233306_F5GVH9_XGB_Sum_B4 part 2/2. Populate
...
[DT_node_data_40] AS 
(SELECT [Values].node_id AS node_id, [Values].feature AS feature, [Values].threshold AS threshold, [Values].depth AS depth, [Values].parent_id AS parent_id, [Values].[Score] AS [Score] 
FROM (SELECT 7 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 3 AS parent_id, -0.04876760393381119 AS [Score] UNION ALL SELECT 8 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 3 AS parent_id, 0.02582353912293911 AS [Score] UNION ALL SELECT 9 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 4 AS parent_id, 0.05697192624211311 AS [Score] UNION ALL SELECT 10 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 4 AS parent_id, -0.012934600003063679 AS [Score] UNION ALL SELECT 11 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 5 AS parent_id, -0.01117562223225832 AS [Score] UNION ALL SELECT 12 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 5 AS parent_id, -0.04942205920815468 AS [Score] UNION ALL SELECT 13 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 6 AS parent_id, -0.01866806671023369 AS [Score] UNION ALL SELECT 14 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 6 AS parent_id, 0.059236347675323486 AS [Score]) AS [Values]), 
[DT_Output_40] AS 
...
[DT_node_data_41] AS 
(SELECT [Values].node_id AS node_id, [Values].feature AS feature, [Values].threshold AS threshold, [Values].depth AS depth, [Values].parent_id AS parent_id, [Values].[Score] AS [Score] 
FROM (SELECT 7 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 3 AS parent_id, 0.0021971703972667456 AS [Score] UNION ALL SELECT 8 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 3 AS parent_id, -0.04941790923476219 AS [Score] UNION ALL SELECT 9 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 4 AS parent_id, 0.01099943183362484 AS [Score] UNION ALL SELECT 10 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 4 AS parent_id, -0.05028969794511795 AS [Score] UNION ALL SELECT 11 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 5 AS parent_id, 0.06234824284911156 AS [Score] UNION ALL SELECT 12 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 5 AS parent_id, 0.007999000139534473 AS [Score] UNION ALL SELECT 13 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 6 AS parent_id, 0.03704627975821495 AS [Score] UNION ALL SELECT 14 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 6 AS parent_id, -0.03503973409533501 AS [Score]) AS [Values]), 
[DT_Output_41] AS 
...
[DT_node_data_42] AS 
(SELECT [Values].node_id AS node_id, [Values].feature AS feature, [Values].threshold AS threshold, [Values].depth AS depth, [Values].parent_id AS parent_id, [Values].[Score] AS [Score] 
FROM (SELECT 4 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 2 AS depth, 1 AS parent_id, 0.0022090140264481306 AS [Score] UNION ALL SELECT 7 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 3 AS parent_id, -0.060344453901052475 AS [Score] UNION ALL SELECT 8 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 3 AS parent_id, -0.028459390625357628 AS [Score] UNION ALL SELECT 9 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 5 AS parent_id, 0.032061051577329636 AS [Score] UNION ALL SELECT 10 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 5 AS parent_id, -0.021398404613137245 AS [Score] UNION ALL SELECT 11 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 6 AS parent_id, 0.060808420181274414 AS [Score] UNION ALL SELECT 12 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 6 AS parent_id, -0.003979632165282965 AS [Score]) AS [Values]), 
[DT_Output_42] AS 
...
[DT_node_data_43] AS 
(SELECT [Values].node_id AS node_id, [Values].feature AS feature, [Values].threshold AS threshold, [Values].depth AS depth, [Values].parent_id AS parent_id, [Values].[Score] AS [Score] 
FROM (SELECT 7 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 3 AS parent_id, 0.06599914282560349 AS [Score] UNION ALL SELECT 8 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 3 AS parent_id, -0.014790437184274197 AS [Score] UNION ALL SELECT 9 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 4 AS parent_id, 0.04657822474837303 AS [Score] UNION ALL SELECT 10 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 4 AS parent_id, -0.026416141539812088 AS [Score] UNION ALL SELECT 11 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 5 AS parent_id, -0.029994403943419456 AS [Score] UNION ALL SELECT 12 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 5 AS parent_id, 0.026922086253762245 AS [Score] UNION ALL SELECT 13 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 6 AS parent_id, -0.03635767847299576 AS [Score] UNION ALL SELECT 14 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 6 AS parent_id, 0.027984855696558952 AS [Score]) AS [Values]), 
[DT_Output_43] AS 
...
[DT_node_data_44] AS 
(SELECT [Values].node_id AS node_id, [Values].feature AS feature, [Values].threshold AS threshold, [Values].depth AS depth, [Values].parent_id AS parent_id, [Values].[Score] AS [Score] 
FROM (SELECT 7 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 3 AS parent_id, 0.04094437137246132 AS [Score] UNION ALL SELECT 8 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 3 AS parent_id, -0.02240472286939621 AS [Score] UNION ALL SELECT 9 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 4 AS parent_id, -0.05945572257041931 AS [Score] UNION ALL SELECT 10 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 4 AS parent_id, -0.03866739571094513 AS [Score] UNION ALL SELECT 11 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 5 AS parent_id, 0.09261905401945114 AS [Score] UNION ALL SELECT 12 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 5 AS parent_id, 0.003314965171739459 AS [Score] UNION ALL SELECT 13 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 6 AS parent_id, -0.025624414905905724 AS [Score] UNION ALL SELECT 14 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 6 AS parent_id, 0.017992546781897545 AS [Score]) AS [Values]), 
[DT_Output_44] AS 
...
[DT_node_data_45] AS 
(SELECT [Values].node_id AS node_id, [Values].feature AS feature, [Values].threshold AS threshold, [Values].depth AS depth, [Values].parent_id AS parent_id, [Values].[Score] AS [Score] 
FROM (SELECT 7 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 3 AS parent_id, -0.038315266370773315 AS [Score] UNION ALL SELECT 8 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 3 AS parent_id, 0.0191685538738966 AS [Score] UNION ALL SELECT 9 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 4 AS parent_id, 0.00416363263502717 AS [Score] UNION ALL SELECT 10 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 4 AS parent_id, 0.05279272794723511 AS [Score] UNION ALL SELECT 11 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 5 AS parent_id, 0.03694342076778412 AS [Score] UNION ALL SELECT 12 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 5 AS parent_id, -0.031193271279335022 AS [Score] UNION ALL SELECT 13 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 6 AS parent_id, -0.058656882494688034 AS [Score] UNION ALL SELECT 14 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 6 AS parent_id, -0.01858246885240078 AS [Score]) AS [Values]), 
[DT_Output_45] AS 
...
[DT_node_data_46] AS 
(SELECT [Values].node_id AS node_id, [Values].feature AS feature, [Values].threshold AS threshold, [Values].depth AS depth, [Values].parent_id AS parent_id, [Values].[Score] AS [Score] 
FROM (SELECT 7 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 3 AS parent_id, 0.009624621830880642 AS [Score] UNION ALL SELECT 8 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 3 AS parent_id, 0.058065265417099 AS [Score] UNION ALL SELECT 9 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 4 AS parent_id, -0.032427649945020676 AS [Score] UNION ALL SELECT 10 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 4 AS parent_id, 0.01304126437753439 AS [Score] UNION ALL SELECT 11 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 5 AS parent_id, -0.02628222666680813 AS [Score] UNION ALL SELECT 12 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 5 AS parent_id, 0.0468265675008297 AS [Score] UNION ALL SELECT 13 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 6 AS parent_id, 0.0028799823485314846 AS [Score] UNION ALL SELECT 14 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 6 AS parent_id, -0.0556841678917408 AS [Score]) AS [Values]), 
[DT_Output_46] AS 
...
[DT_node_data_47] AS 
(SELECT [Values].node_id AS node_id, [Values].feature AS feature, [Values].threshold AS threshold, [Values].depth AS depth, [Values].parent_id AS parent_id, [Values].[Score] AS [Score] 
FROM (SELECT 3 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 2 AS depth, 1 AS parent_id, 0.036332808434963226 AS [Score] UNION ALL SELECT 7 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 4 AS parent_id, 0.030873596668243408 AS [Score] UNION ALL SELECT 8 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 4 AS parent_id, -0.03766203299164772 AS [Score] UNION ALL SELECT 9 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 5 AS parent_id, 0.05589587241411209 AS [Score] UNION ALL SELECT 10 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 5 AS parent_id, 0.005651197861880064 AS [Score] UNION ALL SELECT 11 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 6 AS parent_id, 0.03958473727107048 AS [Score] UNION ALL SELECT 12 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 6 AS parent_id, -0.024477314203977585 AS [Score]) AS [Values]), 
[DT_Output_47] AS 
...
[DT_node_data_48] AS 
(SELECT [Values].node_id AS node_id, [Values].feature AS feature, [Values].threshold AS threshold, [Values].depth AS depth, [Values].parent_id AS parent_id, [Values].[Score] AS [Score] 
FROM (SELECT 7 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 3 AS parent_id, 0.04825985059142113 AS [Score] UNION ALL SELECT 8 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 3 AS parent_id, -0.015195577405393124 AS [Score] UNION ALL SELECT 9 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 4 AS parent_id, 0.03359706327319145 AS [Score] UNION ALL SELECT 10 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 4 AS parent_id, 0.09745108336210251 AS [Score] UNION ALL SELECT 11 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 5 AS parent_id, -0.04821427911520004 AS [Score] UNION ALL SELECT 12 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 5 AS parent_id, -0.00728980777785182 AS [Score] UNION ALL SELECT 13 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 6 AS parent_id, -0.0300971120595932 AS [Score] UNION ALL SELECT 14 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 6 AS parent_id, 0.043091800063848495 AS [Score]) AS [Values]), 
[DT_Output_48] AS 
...
[DT_node_data_49] AS 
(SELECT [Values].node_id AS node_id, [Values].feature AS feature, [Values].threshold AS threshold, [Values].depth AS depth, [Values].parent_id AS parent_id, [Values].[Score] AS [Score] 
FROM (SELECT 7 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 3 AS parent_id, -0.00575980031862855 AS [Score] UNION ALL SELECT 8 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 3 AS parent_id, 0.05640079453587532 AS [Score] UNION ALL SELECT 9 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 4 AS parent_id, -0.040906116366386414 AS [Score] UNION ALL SELECT 10 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 4 AS parent_id, 0.012154919095337391 AS [Score] UNION ALL SELECT 11 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 5 AS parent_id, 0.04979899153113365 AS [Score] UNION ALL SELECT 12 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 5 AS parent_id, -0.027977382764220238 AS [Score] UNION ALL SELECT 13 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 6 AS parent_id, -0.05468582734465599 AS [Score] UNION ALL SELECT 14 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 6 AS parent_id, 0.006333962082862854 AS [Score]) AS [Values]), 
[DT_Output_49] AS 
...
FROM [DT_Output_49])
 INSERT INTO ##TMP_20180329233306_F5GVH9_XGB_Sum_B4 ([KEY], [Score_0], [Score_1], [Score_2], [Score_3]) SELECT [XGB_Sum_B4].[KEY], [XGB_Sum_B4].[Score_0], [XGB_Sum_B4].[Score_1], [XGB_Sum_B4].[Score_2], [XGB_Sum_B4].[Score_3] 
...
-- Code For temporary table ##TMP_20180329233306_XVSMCO_XGB_Sum_B5 part 1/2. Create 


CREATE TABLE ##TMP_20180329233306_XVSMCO_XGB_Sum_B5 (
	[KEY] BIGINT NULL, 
	[Score_0] FLOAT(53) NULL, 
	[Score_1] FLOAT(53) NULL, 
	[Score_2] FLOAT(53) NULL, 
...
-- Code For temporary table ##TMP_20180329233306_XVSMCO_XGB_Sum_B5 part 2/2. Populate
...
[DT_node_data_50] AS 
(SELECT [Values].node_id AS node_id, [Values].feature AS feature, [Values].threshold AS threshold, [Values].depth AS depth, [Values].parent_id AS parent_id, [Values].[Score] AS [Score] 
FROM (SELECT 3 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 2 AS depth, 1 AS parent_id, 0.033496156334877014 AS [Score] UNION ALL SELECT 4 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 2 AS depth, 1 AS parent_id, 0.08372087776660919 AS [Score] UNION ALL SELECT 7 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 5 AS parent_id, -0.05726892501115799 AS [Score] UNION ALL SELECT 8 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 5 AS parent_id, -0.023035062476992607 AS [Score] UNION ALL SELECT 9 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 6 AS parent_id, 0.04214300215244293 AS [Score] UNION ALL SELECT 10 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 6 AS parent_id, -0.006578226573765278 AS [Score]) AS [Values]), 
[DT_Output_50] AS 
...
[DT_node_data_51] AS 
(SELECT [Values].node_id AS node_id, [Values].feature AS feature, [Values].threshold AS threshold, [Values].depth AS depth, [Values].parent_id AS parent_id, [Values].[Score] AS [Score] 
FROM (SELECT 7 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 3 AS parent_id, 0.04488835856318474 AS [Score] UNION ALL SELECT 8 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 3 AS parent_id, -0.025708043947815895 AS [Score] UNION ALL SELECT 9 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 4 AS parent_id, 0.02214125357568264 AS [Score] UNION ALL SELECT 10 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 4 AS parent_id, -0.04747083783149719 AS [Score] UNION ALL SELECT 11 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 5 AS parent_id, 0.034832365810871124 AS [Score] UNION ALL SELECT 12 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 5 AS parent_id, -0.024368228390812874 AS [Score] UNION ALL SELECT 13 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 6 AS parent_id, 0.0026086438447237015 AS [Score] UNION ALL SELECT 14 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 6 AS parent_id, -0.0457550548017025 AS [Score]) AS [Values]), 
[DT_Output_51] AS 
...
[DT_node_data_52] AS 
(SELECT [Values].node_id AS node_id, [Values].feature AS feature, [Values].threshold AS threshold, [Values].depth AS depth, [Values].parent_id AS parent_id, [Values].[Score] AS [Score] 
FROM (SELECT 7 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 3 AS parent_id, -0.03012259304523468 AS [Score] UNION ALL SELECT 8 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 3 AS parent_id, 0.04278276860713959 AS [Score] UNION ALL SELECT 9 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 4 AS parent_id, 0.008319815620779991 AS [Score] UNION ALL SELECT 10 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 4 AS parent_id, 0.06911218166351318 AS [Score] UNION ALL SELECT 11 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 5 AS parent_id, 0.036526650190353394 AS [Score] UNION ALL SELECT 12 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 5 AS parent_id, -0.017992360517382622 AS [Score] UNION ALL SELECT 13 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 6 AS parent_id, -0.04643521085381508 AS [Score] UNION ALL SELECT 14 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 6 AS parent_id, 0.0009786552982404828 AS [Score]) AS [Values]), 
[DT_Output_52] AS 
...
[DT_node_data_53] AS 
(SELECT [Values].node_id AS node_id, [Values].feature AS feature, [Values].threshold AS threshold, [Values].depth AS depth, [Values].parent_id AS parent_id, [Values].[Score] AS [Score] 
FROM (SELECT 5 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 2 AS depth, 2 AS parent_id, 0.07197749614715576 AS [Score] UNION ALL SELECT 7 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 3 AS parent_id, -0.05760277435183525 AS [Score] UNION ALL SELECT 8 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 3 AS parent_id, -0.013729612343013287 AS [Score] UNION ALL SELECT 9 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 4 AS parent_id, 0.038679130375385284 AS [Score] UNION ALL SELECT 10 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 4 AS parent_id, -0.04456530883908272 AS [Score] UNION ALL SELECT 11 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 6 AS parent_id, 0.034001898020505905 AS [Score] UNION ALL SELECT 12 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 6 AS parent_id, -0.012919954024255276 AS [Score]) AS [Values]), 
[DT_Output_53] AS 
...
[DT_node_data_54] AS 
(SELECT [Values].node_id AS node_id, [Values].feature AS feature, [Values].threshold AS threshold, [Values].depth AS depth, [Values].parent_id AS parent_id, [Values].[Score] AS [Score] 
FROM (SELECT 7 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 3 AS parent_id, -0.028557583689689636 AS [Score] UNION ALL SELECT 8 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 3 AS parent_id, 0.014100681059062481 AS [Score] UNION ALL SELECT 9 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 4 AS parent_id, 0.06936196982860565 AS [Score] UNION ALL SELECT 10 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 4 AS parent_id, -0.00533871678635478 AS [Score] UNION ALL SELECT 11 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 5 AS parent_id, 0.039650317281484604 AS [Score] UNION ALL SELECT 12 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 5 AS parent_id, -0.030836766585707664 AS [Score] UNION ALL SELECT 13 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 6 AS parent_id, 0.09928488731384277 AS [Score] UNION ALL SELECT 14 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 6 AS parent_id, 0.02098323218524456 AS [Score]) AS [Values]), 
[DT_Output_54] AS 
...
[DT_node_data_55] AS 
(SELECT [Values].node_id AS node_id, [Values].feature AS feature, [Values].threshold AS threshold, [Values].depth AS depth, [Values].parent_id AS parent_id, [Values].[Score] AS [Score] 
FROM (SELECT 7 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 3 AS parent_id, -0.051072217524051666 AS [Score] UNION ALL SELECT 8 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 3 AS parent_id, 0.011868300847709179 AS [Score] UNION ALL SELECT 9 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 4 AS parent_id, -0.022490547969937325 AS [Score] UNION ALL SELECT 10 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 4 AS parent_id, -0.059083301573991776 AS [Score] UNION ALL SELECT 11 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 5 AS parent_id, 0.08488824963569641 AS [Score] UNION ALL SELECT 12 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 5 AS parent_id, 0.024159759283065796 AS [Score] UNION ALL SELECT 13 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 6 AS parent_id, -0.002633185824379325 AS [Score] UNION ALL SELECT 14 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 6 AS parent_id, 0.07649650424718857 AS [Score]) AS [Values]), 
[DT_Output_55] AS 
...
[DT_node_data_56] AS 
(SELECT [Values].node_id AS node_id, [Values].feature AS feature, [Values].threshold AS threshold, [Values].depth AS depth, [Values].parent_id AS parent_id, [Values].[Score] AS [Score] 
FROM (SELECT 7 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 3 AS parent_id, -0.03881421312689781 AS [Score] UNION ALL SELECT 8 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 3 AS parent_id, 0.017087822780013084 AS [Score] UNION ALL SELECT 9 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 4 AS parent_id, -0.05824935436248779 AS [Score] UNION ALL SELECT 10 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 4 AS parent_id, -0.03783629462122917 AS [Score] UNION ALL SELECT 11 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 5 AS parent_id, 0.07943808287382126 AS [Score] UNION ALL SELECT 12 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 5 AS parent_id, 0.010815889574587345 AS [Score] UNION ALL SELECT 13 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 6 AS parent_id, -0.0355265848338604 AS [Score] UNION ALL SELECT 14 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 6 AS parent_id, 0.00762586435303092 AS [Score]) AS [Values]), 
[DT_Output_56] AS 
...
[DT_node_data_57] AS 
(SELECT [Values].node_id AS node_id, [Values].feature AS feature, [Values].threshold AS threshold, [Values].depth AS depth, [Values].parent_id AS parent_id, [Values].[Score] AS [Score] 
FROM (SELECT 4 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 2 AS depth, 1 AS parent_id, -0.057538699358701706 AS [Score] UNION ALL SELECT 7 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 3 AS parent_id, 0.023567205294966698 AS [Score] UNION ALL SELECT 8 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 3 AS parent_id, -0.04060860350728035 AS [Score] UNION ALL SELECT 9 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 5 AS parent_id, 0.010231715627014637 AS [Score] UNION ALL SELECT 10 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 5 AS parent_id, 0.06956358999013901 AS [Score] UNION ALL SELECT 11 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 6 AS parent_id, 0.015529492869973183 AS [Score] UNION ALL SELECT 12 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 6 AS parent_id, -0.033209700137376785 AS [Score]) AS [Values]), 
[DT_Output_57] AS 
...
[DT_node_data_58] AS 
(SELECT [Values].node_id AS node_id, [Values].feature AS feature, [Values].threshold AS threshold, [Values].depth AS depth, [Values].parent_id AS parent_id, [Values].[Score] AS [Score] 
FROM (SELECT 7 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 3 AS parent_id, 0.03352846950292587 AS [Score] UNION ALL SELECT 8 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 3 AS parent_id, -0.03516964241862297 AS [Score] UNION ALL SELECT 9 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 4 AS parent_id, -0.030810890719294548 AS [Score] UNION ALL SELECT 10 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 4 AS parent_id, 0.011217988096177578 AS [Score] UNION ALL SELECT 11 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 5 AS parent_id, -0.04237969592213631 AS [Score] UNION ALL SELECT 12 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 5 AS parent_id, 0.01458519697189331 AS [Score] UNION ALL SELECT 13 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 6 AS parent_id, -0.03891104832291603 AS [Score] UNION ALL SELECT 14 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 6 AS parent_id, -0.059918709099292755 AS [Score]) AS [Values]), 
[DT_Output_58] AS 
...
[DT_node_data_59] AS 
(SELECT [Values].node_id AS node_id, [Values].feature AS feature, [Values].threshold AS threshold, [Values].depth AS depth, [Values].parent_id AS parent_id, [Values].[Score] AS [Score] 
FROM (SELECT 7 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 3 AS parent_id, -0.030201971530914307 AS [Score] UNION ALL SELECT 8 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 3 AS parent_id, 0.0357237346470356 AS [Score] UNION ALL SELECT 9 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 4 AS parent_id, -0.01894899271428585 AS [Score] UNION ALL SELECT 10 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 4 AS parent_id, 0.040240608155727386 AS [Score] UNION ALL SELECT 11 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 5 AS parent_id, 0.03809162601828575 AS [Score] UNION ALL SELECT 12 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 5 AS parent_id, -0.03198036551475525 AS [Score] UNION ALL SELECT 13 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 6 AS parent_id, -0.008656791411340237 AS [Score] UNION ALL SELECT 14 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 6 AS parent_id, -0.05523135885596275 AS [Score]) AS [Values]), 
[DT_Output_59] AS 
...
FROM [DT_Output_59])
 INSERT INTO ##TMP_20180329233306_XVSMCO_XGB_Sum_B5 ([KEY], [Score_0], [Score_1], [Score_2], [Score_3]) SELECT [XGB_Sum_B5].[KEY], [XGB_Sum_B5].[Score_0], [XGB_Sum_B5].[Score_1], [XGB_Sum_B5].[Score_2], [XGB_Sum_B5].[Score_3] 
...
-- Code For temporary table ##TMP_20180329233306_UMKY2O_XGB_Sum_B6 part 1/2. Create 


CREATE TABLE ##TMP_20180329233306_UMKY2O_XGB_Sum_B6 (
	[KEY] BIGINT NULL, 
	[Score_0] FLOAT(53) NULL, 
	[Score_1] FLOAT(53) NULL, 
	[Score_2] FLOAT(53) NULL, 
...
-- Code For temporary table ##TMP_20180329233306_UMKY2O_XGB_Sum_B6 part 2/2. Populate
...
[DT_node_data_60] AS 
(SELECT [Values].node_id AS node_id, [Values].feature AS feature, [Values].threshold AS threshold, [Values].depth AS depth, [Values].parent_id AS parent_id, [Values].[Score] AS [Score] 
FROM (SELECT 7 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 3 AS parent_id, 0.06879522651433945 AS [Score] UNION ALL SELECT 8 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 3 AS parent_id, 0.0024699706118553877 AS [Score] UNION ALL SELECT 9 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 4 AS parent_id, 0.031470734626054764 AS [Score] UNION ALL SELECT 10 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 4 AS parent_id, -0.024789946153759956 AS [Score] UNION ALL SELECT 11 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 5 AS parent_id, -0.05024401471018791 AS [Score] UNION ALL SELECT 12 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 5 AS parent_id, -0.008896782994270325 AS [Score] UNION ALL SELECT 13 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 6 AS parent_id, -0.03129715844988823 AS [Score] UNION ALL SELECT 14 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 6 AS parent_id, 0.055413492023944855 AS [Score]) AS [Values]), 
[DT_Output_60] AS 
...
[DT_node_data_61] AS 
(SELECT [Values].node_id AS node_id, [Values].feature AS feature, [Values].threshold AS threshold, [Values].depth AS depth, [Values].parent_id AS parent_id, [Values].[Score] AS [Score] 
FROM (SELECT 3 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 2 AS depth, 1 AS parent_id, -0.015538346953690052 AS [Score] UNION ALL SELECT 4 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 2 AS depth, 1 AS parent_id, -0.05628920719027519 AS [Score] UNION ALL SELECT 7 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 5 AS parent_id, 0.004397978074848652 AS [Score] UNION ALL SELECT 8 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 5 AS parent_id, -0.04288139566779137 AS [Score] UNION ALL SELECT 9 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 6 AS parent_id, 0.036460041999816895 AS [Score] UNION ALL SELECT 10 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 6 AS parent_id, -0.0022289908956736326 AS [Score]) AS [Values]), 
[DT_Output_61] AS 
...
[DT_node_data_62] AS 
(SELECT [Values].node_id AS node_id, [Values].feature AS feature, [Values].threshold AS threshold, [Values].depth AS depth, [Values].parent_id AS parent_id, [Values].[Score] AS [Score] 
FROM (SELECT 7 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 3 AS parent_id, -0.009700378403067589 AS [Score] UNION ALL SELECT 8 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 3 AS parent_id, -0.04937223345041275 AS [Score] UNION ALL SELECT 9 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 4 AS parent_id, -0.026166269555687904 AS [Score] UNION ALL SELECT 10 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 4 AS parent_id, 0.03651029244065285 AS [Score] UNION ALL SELECT 11 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 5 AS parent_id, 0.08718466758728027 AS [Score] UNION ALL SELECT 12 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 5 AS parent_id, -0.0020445287227630615 AS [Score] UNION ALL SELECT 13 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 6 AS parent_id, -0.03957219049334526 AS [Score] UNION ALL SELECT 14 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 6 AS parent_id, 0.00969963800162077 AS [Score]) AS [Values]), 
[DT_Output_62] AS 
...
[DT_node_data_63] AS 
(SELECT [Values].node_id AS node_id, [Values].feature AS feature, [Values].threshold AS threshold, [Values].depth AS depth, [Values].parent_id AS parent_id, [Values].[Score] AS [Score] 
FROM (SELECT 4 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 2 AS depth, 1 AS parent_id, -0.04640867933630943 AS [Score] UNION ALL SELECT 7 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 3 AS parent_id, 0.008396707475185394 AS [Score] UNION ALL SELECT 8 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 3 AS parent_id, 0.058647871017456055 AS [Score] UNION ALL SELECT 9 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 5 AS parent_id, 0.027225909754633904 AS [Score] UNION ALL SELECT 10 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 5 AS parent_id, -0.04279405251145363 AS [Score] UNION ALL SELECT 11 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 6 AS parent_id, 0.025560742244124413 AS [Score] UNION ALL SELECT 12 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT(53)) AS threshold, 3 AS depth, 6 AS parent_id, -0.023911846801638603 AS [Score]) AS [Values]), 
[DT_Output_63] AS 
...
FROM [DT_Output_63])
 INSERT INTO ##TMP_20180329233306_UMKY2O_XGB_Sum_B6 ([KEY], [Score_0], [Score_1], [Score_2], [Score_3]) SELECT [XGB_Sum_B6].[KEY], [XGB_Sum_B6].[Score_0], [XGB_Sum_B6].[Score_1], [XGB_Sum_B6].[Score_2], [XGB_Sum_B6].[Score_3] 
...
-- Code For temporary table ##TMP_20180329233306_CC141G_XGB_Sum_Union part 1/2. Create 


CREATE TABLE ##TMP_20180329233306_CC141G_XGB_Sum_Union (
	[KEY] BIGINT NULL, 
	[Score_0] FLOAT(53) NULL, 
	[Score_1] FLOAT(53) NULL, 
	[Score_2] FLOAT(53) NULL, 
...
-- Code For temporary table ##TMP_20180329233306_CC141G_XGB_Sum_Union part 2/2. Populate

INSERT INTO ##TMP_20180329233306_CC141G_XGB_Sum_Union ([KEY], [Score_0], [Score_1], [Score_2], [Score_3]) SELECT [XGB_Sum_Union].[KEY], [XGB_Sum_Union].[Score_0], [XGB_Sum_Union].[Score_1], [XGB_Sum_Union].[Score_2], [XGB_Sum_Union].[Score_3] 
...
FROM ##TMP_20180329233306_DUIJZJ_XGB_Sum_B0 AS [XGB_Sum_B0] UNION ALL SELECT [XGB_Sum_B1].[KEY] AS [KEY], [XGB_Sum_B1].[Score_0] AS [Score_0], [XGB_Sum_B1].[Score_1] AS [Score_1], [XGB_Sum_B1].[Score_2] AS [Score_2], [XGB_Sum_B1].[Score_3] AS [Score_3] 
FROM ##TMP_20180329233306_2K0J8O_XGB_Sum_B1 AS [XGB_Sum_B1] UNION ALL SELECT [XGB_Sum_B2].[KEY] AS [KEY], [XGB_Sum_B2].[Score_0] AS [Score_0], [XGB_Sum_B2].[Score_1] AS [Score_1], [XGB_Sum_B2].[Score_2] AS [Score_2], [XGB_Sum_B2].[Score_3] AS [Score_3] 
FROM ##TMP_20180329233306_5B3HSQ_XGB_Sum_B2 AS [XGB_Sum_B2] UNION ALL SELECT [XGB_Sum_B3].[KEY] AS [KEY], [XGB_Sum_B3].[Score_0] AS [Score_0], [XGB_Sum_B3].[Score_1] AS [Score_1], [XGB_Sum_B3].[Score_2] AS [Score_2], [XGB_Sum_B3].[Score_3] AS [Score_3] 
FROM ##TMP_20180329233306_AA1JI1_XGB_Sum_B3 AS [XGB_Sum_B3] UNION ALL SELECT [XGB_Sum_B4].[KEY] AS [KEY], [XGB_Sum_B4].[Score_0] AS [Score_0], [XGB_Sum_B4].[Score_1] AS [Score_1], [XGB_Sum_B4].[Score_2] AS [Score_2], [XGB_Sum_B4].[Score_3] AS [Score_3] 
FROM ##TMP_20180329233306_F5GVH9_XGB_Sum_B4 AS [XGB_Sum_B4] UNION ALL SELECT [XGB_Sum_B5].[KEY] AS [KEY], [XGB_Sum_B5].[Score_0] AS [Score_0], [XGB_Sum_B5].[Score_1] AS [Score_1], [XGB_Sum_B5].[Score_2] AS [Score_2], [XGB_Sum_B5].[Score_3] AS [Score_3] 
FROM ##TMP_20180329233306_XVSMCO_XGB_Sum_B5 AS [XGB_Sum_B5] UNION ALL SELECT [XGB_Sum_B6].[KEY] AS [KEY], [XGB_Sum_B6].[Score_0] AS [Score_0], [XGB_Sum_B6].[Score_1] AS [Score_1], [XGB_Sum_B6].[Score_2] AS [Score_2], [XGB_Sum_B6].[Score_3] AS [Score_3] 
FROM ##TMP_20180329233306_UMKY2O_XGB_Sum_B6 AS [XGB_Sum_B6]) AS [XGB_Sum_EnsembleUnion]) AS [XGB_Sum_Union]
...
FROM ##TMP_20180329233306_CC141G_XGB_Sum_Union AS [XGB_Sum_Union] GROUP BY [XGB_Sum_Union].[KEY]) AS [T]), 
orig_cte AS 
