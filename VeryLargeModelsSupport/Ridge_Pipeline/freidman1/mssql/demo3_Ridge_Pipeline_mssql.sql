...
-- Code For temporary table ##TMP_20180329232238_NN89VF_ADS_imp_1_OUT part 1/2. Create 


CREATE TABLE ##TMP_20180329232238_NN89VF_ADS_imp_1_OUT (
	[KEY] BIGINT NULL, 
...
-- Code For temporary table ##TMP_20180329232238_QVWOA4_ADS_sca_2_OUT part 1/2. Create 


CREATE TABLE ##TMP_20180329232238_QVWOA4_ADS_sca_2_OUT (
	[KEY] BIGINT NULL, 
	scaler_2 FLOAT NULL, 
	scaler_3 FLOAT NULL, 
	scaler_4 FLOAT NULL, 
...
-- Code For temporary table ##TMP_20180329232238_QVWOA4_ADS_sca_2_OUT part 2/2. Populate

INSERT INTO ##TMP_20180329232238_QVWOA4_ADS_sca_2_OUT ([KEY], scaler_2, scaler_3, scaler_4, scaler_5, scaler_6, scaler_7, scaler_8, scaler_9, scaler_10, scaler_11) SELECT [ADS_sca_2_OUT].[KEY], [ADS_sca_2_OUT].scaler_2, [ADS_sca_2_OUT].scaler_3, [ADS_sca_2_OUT].scaler_4, [ADS_sca_2_OUT].scaler_5, [ADS_sca_2_OUT].scaler_6, [ADS_sca_2_OUT].scaler_7, [ADS_sca_2_OUT].scaler_8, [ADS_sca_2_OUT].scaler_9, [ADS_sca_2_OUT].scaler_10, [ADS_sca_2_OUT].scaler_11 
...
FROM ##TMP_20180329232238_NN89VF_ADS_imp_1_OUT AS [ADS_imp_1_OUT]) AS [ADS_sca_2_OUT]
...
FROM ##TMP_20180329232238_QVWOA4_ADS_sca_2_OUT AS [ADS_sca_2_OUT])
