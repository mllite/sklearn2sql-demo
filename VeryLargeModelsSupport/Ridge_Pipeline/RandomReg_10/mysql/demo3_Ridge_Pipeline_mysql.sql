...
-- Code For temporary table TMP_20180329231756_NPY4GS_ADS_imp_1_OUT part 1/2. Create 


CREATE TEMPORARY TABLE `TMP_20180329231756_NPY4GS_ADS_imp_1_OUT` (
	`KEY` BIGINT, 
	impter_2 DOUBLE, 
	impter_3 DOUBLE, 
	impter_4 DOUBLE, 
 ...
 ENGINE=MEMORY
-- Code For temporary table TMP_20180329231756_NPY4GS_ADS_imp_1_OUT part 2/2. Populate

INSERT INTO `TMP_20180329231756_NPY4GS_ADS_imp_1_OUT` (`KEY`, impter_2, impter_3, impter_4, impter_5, impter_6, impter_7, impter_8, impter_9, impter_10, impter_11) SELECT `U`.`KEY`, `U`.impter_2, `U`.impter_3, `U`.impter_4, `U`.impter_5, `U`.impter_6, `U`.impter_7, `U`.impter_8, `U`.impter_9, `U`.impter_10, `U`.impter_11 
...
-- Code For temporary table TMP_20180329231756_5IS67B_ADS_sca_2_OUT part 1/2. Create 


CREATE TEMPORARY TABLE `TMP_20180329231756_5IS67B_ADS_sca_2_OUT` (
	`KEY` BIGINT, 
	scaler_2 DOUBLE, 
	scaler_3 DOUBLE, 
	scaler_4 DOUBLE, 
 ...
 ENGINE=MEMORY
-- Code For temporary table TMP_20180329231756_5IS67B_ADS_sca_2_OUT part 2/2. Populate

INSERT INTO `TMP_20180329231756_5IS67B_ADS_sca_2_OUT` (`KEY`, scaler_2, scaler_3, scaler_4, scaler_5, scaler_6, scaler_7, scaler_8, scaler_9, scaler_10, scaler_11) SELECT `U`.`KEY`, `U`.scaler_2, `U`.scaler_3, `U`.scaler_4, `U`.scaler_5, `U`.scaler_6, `U`.scaler_7, `U`.scaler_8, `U`.scaler_9, `U`.scaler_10, `U`.scaler_11 
...
FROM `TMP_20180329231756_NPY4GS_ADS_imp_1_OUT` AS `ADS_imp_1_OUT`) AS `ADS_sca_2_OUT`) AS `U`

-- Model deployment code

WITH linear_model_cte AS 
(SELECT `ADS_sca_2_OUT`.`KEY` AS `KEY`, 34.93629964239755 * `ADS_sca_2_OUT`.scaler_2 + 73.71003738769787 * `ADS_sca_2_OUT`.scaler_3 + 87.30118845385824 * `ADS_sca_2_OUT`.scaler_4 + 37.2003535662938 * `ADS_sca_2_OUT`.scaler_5 + 56.82441624467638 * `ADS_sca_2_OUT`.scaler_6 + 78.45109933480482 * `ADS_sca_2_OUT`.scaler_7 + 37.884334274023054 * `ADS_sca_2_OUT`.scaler_8 + 39.106491966994035 * `ADS_sca_2_OUT`.scaler_9 + 92.64892488769324 * `ADS_sca_2_OUT`.scaler_10 + 52.57456364033038 * `ADS_sca_2_OUT`.scaler_11 + 26.405852730652413 AS `Estimator` 
FROM `TMP_20180329231756_5IS67B_ADS_sca_2_OUT` AS `ADS_sca_2_OUT`)
