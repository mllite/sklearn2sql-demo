...
-- Code For temporary table TMP_20180329231842_FTJ9GZ_ADS_imp_1_OUT part 1/2. Create 


CREATE TEMPORARY TABLE `TMP_20180329231842_FTJ9GZ_ADS_imp_1_OUT` (
	`KEY` BIGINT, 
	impter_2 DOUBLE, 
	impter_3 DOUBLE, 
	impter_4 DOUBLE, 
...
-- Code For temporary table TMP_20180329231842_Y6Z2LI_ADS_sca_2_OUT part 1/2. Create 


CREATE TEMPORARY TABLE `TMP_20180329231842_Y6Z2LI_ADS_sca_2_OUT` (
	`KEY` BIGINT, 
	scaler_2 DOUBLE, 
	scaler_3 DOUBLE, 
	scaler_4 DOUBLE, 
...
FROM `TMP_20180329231842_FTJ9GZ_ADS_imp_1_OUT` AS `ADS_imp_1_OUT`) AS `ADS_sca_2_OUT`) AS `U`

-- Model deployment code

WITH linear_model_cte AS 
(SELECT `ADS_sca_2_OUT`.`KEY` AS `KEY`, 5.09599613704856 * `ADS_sca_2_OUT`.scaler_2 + -4.107273417096571 * `ADS_sca_2_OUT`.scaler_3 + -8.744027589886274 * `ADS_sca_2_OUT`.scaler_4 + 6.672610567506678 * `ADS_sca_2_OUT`.scaler_5 + 2.948321418041195 * `ADS_sca_2_OUT`.scaler_6 + -2.778593685434335 * `ADS_sca_2_OUT`.scaler_7 + 0.020322920117997967 * `ADS_sca_2_OUT`.scaler_8 + 1.752914144810204 * `ADS_sca_2_OUT`.scaler_9 + 10.279062856495884 * `ADS_sca_2_OUT`.scaler_10 + -0.33738496519227557 * `ADS_sca_2_OUT`.scaler_11 + -6.580497905717512 * `ADS_sca_2_OUT`.scaler_12 + 5.410219657962949 * `ADS_sca_2_OUT`.scaler_13 + 6.712821604660272 * `ADS_sca_2_OUT`.scaler_14 + -5.068126230868005 * `ADS_sca_2_OUT`.scaler_15 + -5.2838460486675 * `ADS_sca_2_OUT`.scaler_16 + -1.493246471531239 * `ADS_sca_2_OUT`.scaler_17 + 30.271643918117668 * `ADS_sca_2_OUT`.scaler_18 + 3.420933210115128 * `ADS_sca_2_OUT`.scaler_19 + 7.153906538763165 * `ADS_sca_2_OUT`.scaler_20 + -9.823933950367858 * `ADS_sca_2_OUT`.scaler_21 + 6.17529643100234 * `ADS_sca_2_OUT`.scaler_22 + 1.046705847773676 * `ADS_sca_2_OUT`.scaler_23 + 2.8474317436792105 * `ADS_sca_2_OUT`.scaler_24 + -9.625440535071023 * `ADS_sca_2_OUT`.scaler_25 + -2.351555368407495 * `ADS_sca_2_OUT`.scaler_26 + 7.290777200955382 * `ADS_sca_2_OUT`.scaler_27 + -2.3662295352376317 * `ADS_sca_2_OUT`.scaler_28 + 6.151240699675572 * `ADS_sca_2_OUT`.scaler_29 + 0.4187591706827418 * `ADS_sca_2_OUT`.scaler_30 + 11.16774155075781 * `ADS_sca_2_OUT`.scaler_31 + 0.8960993383270921 * `ADS_sca_2_OUT`.scaler_32 + -0.7756294151674874 * `ADS_sca_2_OUT`.scaler_33 + 0.47812306694092266 * `ADS_sca_2_OUT`.scaler_34 + -0.251527326308695 * `ADS_sca_2_OUT`.scaler_35 + -12.937313448340655 * `ADS_sca_2_OUT`.scaler_36 + 2.0700887548266023 * `ADS_sca_2_OUT`.scaler_37 + -6.872130539326328 * `ADS_sca_2_OUT`.scaler_38 + -12.273230250999987 * `ADS_sca_2_OUT`.scaler_39 + 7.0885986206692255 * `ADS_sca_2_OUT`.scaler_40 + 43.99857829658812 * `ADS_sca_2_OUT`.scaler_41 + -5.65691379045757 * `ADS_sca_2_OUT`.scaler_42 + 56.796497998081804 * `ADS_sca_2_OUT`.scaler_43 + -6.079265925216846 * `ADS_sca_2_OUT`.scaler_44 + -6.5116873304603455 * `ADS_sca_2_OUT`.scaler_45 + 7.38931582346718 * `ADS_sca_2_OUT`.scaler_46 + -5.8238271775871 * `ADS_sca_2_OUT`.scaler_47 + -4.819985406952863 * `ADS_sca_2_OUT`.scaler_48 + -6.663134411375009 * `ADS_sca_2_OUT`.scaler_49 + -2.0475778510148612 * `ADS_sca_2_OUT`.scaler_50 + 19.567130646589217 * `ADS_sca_2_OUT`.scaler_51 + 4.067029735445625 * `ADS_sca_2_OUT`.scaler_52 + -5.829697161503479 * `ADS_sca_2_OUT`.scaler_53 + 3.1291413776203942 * `ADS_sca_2_OUT`.scaler_54 + -0.4843073167415909 * `ADS_sca_2_OUT`.scaler_55 + 3.287469955148576 * `ADS_sca_2_OUT`.scaler_56 + -2.5263198974995063 * `ADS_sca_2_OUT`.scaler_57 + -10.797227830336695 * `ADS_sca_2_OUT`.scaler_58 + -7.9264785462633505 * `ADS_sca_2_OUT`.scaler_59 + 11.306732282759143 * `ADS_sca_2_OUT`.scaler_60 + -5.088545241814679 * `ADS_sca_2_OUT`.scaler_61 + 0.5064725543879296 * `ADS_sca_2_OUT`.scaler_62 + -10.639907419745688 * `ADS_sca_2_OUT`.scaler_63 + -14.569209121913536 * `ADS_sca_2_OUT`.scaler_64 + 59.77418973460151 * `ADS_sca_2_OUT`.scaler_65 + 14.852607049561737 * `ADS_sca_2_OUT`.scaler_66 + -3.3046680038070004 * `ADS_sca_2_OUT`.scaler_67 + -0.38823571696368386 * `ADS_sca_2_OUT`.scaler_68 + -14.434933388927696 * `ADS_sca_2_OUT`.scaler_69 + 24.123184908026555 * `ADS_sca_2_OUT`.scaler_70 + -6.426589457479596 * `ADS_sca_2_OUT`.scaler_71 + -9.653617627469755 * `ADS_sca_2_OUT`.scaler_72 + 4.0472576653750885 * `ADS_sca_2_OUT`.scaler_73 + -6.005570350870418 * `ADS_sca_2_OUT`.scaler_74 + -0.5416381213614276 * `ADS_sca_2_OUT`.scaler_75 + 11.947988424403336 * `ADS_sca_2_OUT`.scaler_76 + 2.608344017922993 * `ADS_sca_2_OUT`.scaler_77 + 2.1162508342608426 * `ADS_sca_2_OUT`.scaler_78 + -15.496524717607597 * `ADS_sca_2_OUT`.scaler_79 + -0.990500673791876 * `ADS_sca_2_OUT`.scaler_80 + 2.7869862260891747 * `ADS_sca_2_OUT`.scaler_81 + 85.19237676360382 * `ADS_sca_2_OUT`.scaler_82 + 0.7985756420814132 * `ADS_sca_2_OUT`.scaler_83 + 6.62865717262545 * `ADS_sca_2_OUT`.scaler_84 + -5.660347594200266 * `ADS_sca_2_OUT`.scaler_85 + -3.589822843093597 * `ADS_sca_2_OUT`.scaler_86 + 14.361770419539111 * `ADS_sca_2_OUT`.scaler_87 + 5.465034554273885 * `ADS_sca_2_OUT`.scaler_88 + 7.196965200692225 * `ADS_sca_2_OUT`.scaler_89 + 3.4556515313552514 * `ADS_sca_2_OUT`.scaler_90 + 1.8319715746979854 * `ADS_sca_2_OUT`.scaler_91 + 8.026533286334857 * `ADS_sca_2_OUT`.scaler_92 + 5.1994326457819 * `ADS_sca_2_OUT`.scaler_93 + 2.92756359570342 * `ADS_sca_2_OUT`.scaler_94 + -6.685072204956798 * `ADS_sca_2_OUT`.scaler_95 + -1.029173874298483 * `ADS_sca_2_OUT`.scaler_96 + 60.262539682191736 * `ADS_sca_2_OUT`.scaler_97 + -6.244601677182774 * `ADS_sca_2_OUT`.scaler_98 + 7.838837853932116 * `ADS_sca_2_OUT`.scaler_99 + -7.98272962152543 * `ADS_sca_2_OUT`.scaler_100 + -2.8217792988757293 * `ADS_sca_2_OUT`.scaler_101 + -11.471614782695328 AS `Estimator` 
FROM `TMP_20180329231842_Y6Z2LI_ADS_sca_2_OUT` AS `ADS_sca_2_OUT`)
