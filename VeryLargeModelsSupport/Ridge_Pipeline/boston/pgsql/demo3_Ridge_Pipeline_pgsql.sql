...
-- Code For temporary table TMP_20180329232032_MJG042_ADS_imp_1_OUT part 1/2. Create 


CREATE TEMPORARY TABLE "TMP_20180329232032_MJG042_ADS_imp_1_OUT" (
	"KEY" BIGINT, 
	impter_2 FLOAT, 
	impter_3 FLOAT, 
	impter_4 FLOAT, 
...
-- Code For temporary table TMP_20180329232032_MJG042_ADS_imp_1_OUT part 2/2. Populate

INSERT INTO "TMP_20180329232032_MJG042_ADS_imp_1_OUT" ("KEY", impter_2, impter_3, impter_4, impter_5, impter_6, impter_7, impter_8, impter_9, impter_10, impter_11, impter_12, impter_13, impter_14) SELECT "ADS_imp_1_OUT"."KEY", "ADS_imp_1_OUT".impter_2, "ADS_imp_1_OUT".impter_3, "ADS_imp_1_OUT".impter_4, "ADS_imp_1_OUT".impter_5, "ADS_imp_1_OUT".impter_6, "ADS_imp_1_OUT".impter_7, "ADS_imp_1_OUT".impter_8, "ADS_imp_1_OUT".impter_9, "ADS_imp_1_OUT".impter_10, "ADS_imp_1_OUT".impter_11, "ADS_imp_1_OUT".impter_12, "ADS_imp_1_OUT".impter_13, "ADS_imp_1_OUT".impter_14 
...
-- Code For temporary table TMP_20180329232032_V45Y5K_ADS_sca_2_OUT part 1/2. Create 


CREATE TEMPORARY TABLE "TMP_20180329232032_V45Y5K_ADS_sca_2_OUT" (
	"KEY" BIGINT, 
	scaler_2 FLOAT, 
	scaler_3 FLOAT, 
	scaler_4 FLOAT, 
...
FROM "TMP_20180329232032_MJG042_ADS_imp_1_OUT" AS "ADS_imp_1_OUT") AS "ADS_sca_2_OUT"

-- Model deployment code

WITH linear_model_cte AS 
(SELECT "ADS_sca_2_OUT"."KEY" AS "KEY", -0.7660419137923935 * "ADS_sca_2_OUT".scaler_2 + 0.8834647277561444 * "ADS_sca_2_OUT".scaler_3 + 0.13237599141058298 * "ADS_sca_2_OUT".scaler_4 + 0.628995263531277 * "ADS_sca_2_OUT".scaler_5 + -1.7185592740064695 * "ADS_sca_2_OUT".scaler_6 + 3.2598699806090257 * "ADS_sca_2_OUT".scaler_7 + -0.5617630967424377 * "ADS_sca_2_OUT".scaler_8 + -2.8588865115872126 * "ADS_sca_2_OUT".scaler_9 + 2.2686478628480815 * "ADS_sca_2_OUT".scaler_10 + -1.9670778375874505 * "ADS_sca_2_OUT".scaler_11 + -2.1543401538448443 * "ADS_sca_2_OUT".scaler_12 + 0.940261299902417 * "ADS_sca_2_OUT".scaler_13 + -2.8687510484355747 * "ADS_sca_2_OUT".scaler_14 + 22.578960396039605 AS "Estimator" 
FROM "TMP_20180329232032_V45Y5K_ADS_sca_2_OUT" AS "ADS_sca_2_OUT")
