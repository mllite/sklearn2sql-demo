...
-- Code For temporary table TMP_20180329232555_3M5DZG_LGBM_Sum_B0 part 1/2. Create 


CREATE TEMPORARY TABLE "TMP_20180329232555_3M5DZG_LGBM_Sum_B0" (
	"KEY" BIGINT, 
	"Score_0" FLOAT
)

 ON COMMIT PRESERVE ROWS
-- Code For temporary table TMP_20180329232555_3M5DZG_LGBM_Sum_B0 part 2/2. Populate
...
FROM "DT_Output_9")
 INSERT INTO "TMP_20180329232555_3M5DZG_LGBM_Sum_B0" ("KEY", "Score_0") SELECT "LGBM_Sum_B0"."KEY", "LGBM_Sum_B0"."Score_0" 
...
-- Code For temporary table TMP_20180329232555_5K72XB_LGBM_Sum_B1 part 1/2. Create 


CREATE TEMPORARY TABLE "TMP_20180329232555_5K72XB_LGBM_Sum_B1" (
	"KEY" BIGINT, 
	"Score_0" FLOAT
)

 ON COMMIT PRESERVE ROWS
-- Code For temporary table TMP_20180329232555_5K72XB_LGBM_Sum_B1 part 2/2. Populate
...
FROM "DT_Output_15")
 INSERT INTO "TMP_20180329232555_5K72XB_LGBM_Sum_B1" ("KEY", "Score_0") SELECT "LGBM_Sum_B1"."KEY", "LGBM_Sum_B1"."Score_0" 
...
-- Code For temporary table TMP_20180329232555_8SRT7P_LGBM_Sum_Union part 1/2. Create 


CREATE TEMPORARY TABLE "TMP_20180329232555_8SRT7P_LGBM_Sum_Union" (
	"KEY" BIGINT, 
	"Score_0" FLOAT
)

 ON COMMIT PRESERVE ROWS
-- Code For temporary table TMP_20180329232555_8SRT7P_LGBM_Sum_Union part 2/2. Populate

INSERT INTO "TMP_20180329232555_8SRT7P_LGBM_Sum_Union" ("KEY", "Score_0") SELECT "LGBM_Sum_Union"."KEY", "LGBM_Sum_Union"."Score_0" 
...
FROM "TMP_20180329232555_3M5DZG_LGBM_Sum_B0" AS "LGBM_Sum_B0" UNION ALL SELECT "LGBM_Sum_B1"."KEY" AS "KEY", "LGBM_Sum_B1"."Score_0" AS "Score_0" 
FROM "TMP_20180329232555_5K72XB_LGBM_Sum_B1" AS "LGBM_Sum_B1") AS "LGBM_Sum_EnsembleUnion") AS "LGBM_Sum_Union"
...
FROM "TMP_20180329232555_8SRT7P_LGBM_Sum_Union" AS "LGBM_Sum_Union" GROUP BY "LGBM_Sum_Union"."KEY") AS "T"), 
orig_cte AS 
