...
-- Code For temporary table TMP_20180329232954_PIP82N_LGBM_Sum_B0 part 1/2. Create 


CREATE TEMPORARY TABLE "TMP_20180329232954_PIP82N_LGBM_Sum_B0" (
	"KEY" BIGINT, 
	"Score_0" FLOAT, 
	"Score_1" FLOAT, 
	"Score_2" FLOAT, 
...
-- Code For temporary table TMP_20180329232954_PIP82N_LGBM_Sum_B0 part 2/2. Populate
...
FROM "DT_Output_9")
 INSERT INTO "TMP_20180329232954_PIP82N_LGBM_Sum_B0" ("KEY", "Score_0", "Score_1", "Score_2", "Score_3") SELECT "LGBM_Sum_B0"."KEY", "LGBM_Sum_B0"."Score_0", "LGBM_Sum_B0"."Score_1", "LGBM_Sum_B0"."Score_2", "LGBM_Sum_B0"."Score_3" 
...
-- Code For temporary table TMP_20180329232954_3YBUFS_LGBM_Sum_B1 part 1/2. Create 


CREATE TEMPORARY TABLE "TMP_20180329232954_3YBUFS_LGBM_Sum_B1" (
	"KEY" BIGINT, 
	"Score_0" FLOAT, 
	"Score_1" FLOAT, 
	"Score_2" FLOAT, 
...
-- Code For temporary table TMP_20180329232954_3YBUFS_LGBM_Sum_B1 part 2/2. Populate
...
FROM "DT_Output_19")
 INSERT INTO "TMP_20180329232954_3YBUFS_LGBM_Sum_B1" ("KEY", "Score_0", "Score_1", "Score_2", "Score_3") SELECT "LGBM_Sum_B1"."KEY", "LGBM_Sum_B1"."Score_0", "LGBM_Sum_B1"."Score_1", "LGBM_Sum_B1"."Score_2", "LGBM_Sum_B1"."Score_3" 
...
-- Code For temporary table TMP_20180329232954_14FQQX_LGBM_Sum_B2 part 1/2. Create 


CREATE TEMPORARY TABLE "TMP_20180329232954_14FQQX_LGBM_Sum_B2" (
	"KEY" BIGINT, 
	"Score_0" FLOAT, 
	"Score_1" FLOAT, 
	"Score_2" FLOAT, 
...
-- Code For temporary table TMP_20180329232954_14FQQX_LGBM_Sum_B2 part 2/2. Populate
...
FROM "DT_Output_29")
 INSERT INTO "TMP_20180329232954_14FQQX_LGBM_Sum_B2" ("KEY", "Score_0", "Score_1", "Score_2", "Score_3") SELECT "LGBM_Sum_B2"."KEY", "LGBM_Sum_B2"."Score_0", "LGBM_Sum_B2"."Score_1", "LGBM_Sum_B2"."Score_2", "LGBM_Sum_B2"."Score_3" 
...
-- Code For temporary table TMP_20180329232954_30L2IK_LGBM_Sum_B3 part 1/2. Create 


CREATE TEMPORARY TABLE "TMP_20180329232954_30L2IK_LGBM_Sum_B3" (
	"KEY" BIGINT, 
	"Score_0" FLOAT, 
	"Score_1" FLOAT, 
	"Score_2" FLOAT, 
...
-- Code For temporary table TMP_20180329232954_30L2IK_LGBM_Sum_B3 part 2/2. Populate
...
FROM "DT_Output_39")
 INSERT INTO "TMP_20180329232954_30L2IK_LGBM_Sum_B3" ("KEY", "Score_0", "Score_1", "Score_2", "Score_3") SELECT "LGBM_Sum_B3"."KEY", "LGBM_Sum_B3"."Score_0", "LGBM_Sum_B3"."Score_1", "LGBM_Sum_B3"."Score_2", "LGBM_Sum_B3"."Score_3" 
...
-- Code For temporary table TMP_20180329232954_N93RJD_LGBM_Sum_B4 part 1/2. Create 


CREATE TEMPORARY TABLE "TMP_20180329232954_N93RJD_LGBM_Sum_B4" (
	"KEY" BIGINT, 
	"Score_0" FLOAT, 
	"Score_1" FLOAT, 
	"Score_2" FLOAT, 
...
-- Code For temporary table TMP_20180329232954_N93RJD_LGBM_Sum_B4 part 2/2. Populate
...
FROM "DT_Output_49")
 INSERT INTO "TMP_20180329232954_N93RJD_LGBM_Sum_B4" ("KEY", "Score_0", "Score_1", "Score_2", "Score_3") SELECT "LGBM_Sum_B4"."KEY", "LGBM_Sum_B4"."Score_0", "LGBM_Sum_B4"."Score_1", "LGBM_Sum_B4"."Score_2", "LGBM_Sum_B4"."Score_3" 
...
-- Code For temporary table TMP_20180329232954_OQP992_LGBM_Sum_B5 part 1/2. Create 


CREATE TEMPORARY TABLE "TMP_20180329232954_OQP992_LGBM_Sum_B5" (
	"KEY" BIGINT, 
	"Score_0" FLOAT, 
	"Score_1" FLOAT, 
	"Score_2" FLOAT, 
...
-- Code For temporary table TMP_20180329232954_OQP992_LGBM_Sum_B5 part 2/2. Populate
...
FROM "DT_Output_59")
 INSERT INTO "TMP_20180329232954_OQP992_LGBM_Sum_B5" ("KEY", "Score_0", "Score_1", "Score_2", "Score_3") SELECT "LGBM_Sum_B5"."KEY", "LGBM_Sum_B5"."Score_0", "LGBM_Sum_B5"."Score_1", "LGBM_Sum_B5"."Score_2", "LGBM_Sum_B5"."Score_3" 
...
-- Code For temporary table TMP_20180329232954_6D5JJQ_LGBM_Sum_B6 part 1/2. Create 


CREATE TEMPORARY TABLE "TMP_20180329232954_6D5JJQ_LGBM_Sum_B6" (
	"KEY" BIGINT, 
	"Score_0" FLOAT, 
	"Score_1" FLOAT, 
	"Score_2" FLOAT, 
...
-- Code For temporary table TMP_20180329232954_6D5JJQ_LGBM_Sum_B6 part 2/2. Populate
...
FROM "DT_Output_63")
 INSERT INTO "TMP_20180329232954_6D5JJQ_LGBM_Sum_B6" ("KEY", "Score_0", "Score_1", "Score_2", "Score_3") SELECT "LGBM_Sum_B6"."KEY", "LGBM_Sum_B6"."Score_0", "LGBM_Sum_B6"."Score_1", "LGBM_Sum_B6"."Score_2", "LGBM_Sum_B6"."Score_3" 
...
-- Code For temporary table TMP_20180329232954_DJAYNP_LGBM_Sum_Union part 1/2. Create 


CREATE TEMPORARY TABLE "TMP_20180329232954_DJAYNP_LGBM_Sum_Union" (
	"KEY" BIGINT, 
	"Score_0" FLOAT, 
	"Score_1" FLOAT, 
	"Score_2" FLOAT, 
...
-- Code For temporary table TMP_20180329232954_DJAYNP_LGBM_Sum_Union part 2/2. Populate

INSERT INTO "TMP_20180329232954_DJAYNP_LGBM_Sum_Union" ("KEY", "Score_0", "Score_1", "Score_2", "Score_3") SELECT "LGBM_Sum_Union"."KEY", "LGBM_Sum_Union"."Score_0", "LGBM_Sum_Union"."Score_1", "LGBM_Sum_Union"."Score_2", "LGBM_Sum_Union"."Score_3" 
...
FROM "TMP_20180329232954_PIP82N_LGBM_Sum_B0" AS "LGBM_Sum_B0" UNION ALL SELECT "LGBM_Sum_B1"."KEY" AS "KEY", "LGBM_Sum_B1"."Score_0" AS "Score_0", "LGBM_Sum_B1"."Score_1" AS "Score_1", "LGBM_Sum_B1"."Score_2" AS "Score_2", "LGBM_Sum_B1"."Score_3" AS "Score_3" 
FROM "TMP_20180329232954_3YBUFS_LGBM_Sum_B1" AS "LGBM_Sum_B1" UNION ALL SELECT "LGBM_Sum_B2"."KEY" AS "KEY", "LGBM_Sum_B2"."Score_0" AS "Score_0", "LGBM_Sum_B2"."Score_1" AS "Score_1", "LGBM_Sum_B2"."Score_2" AS "Score_2", "LGBM_Sum_B2"."Score_3" AS "Score_3" 
FROM "TMP_20180329232954_14FQQX_LGBM_Sum_B2" AS "LGBM_Sum_B2" UNION ALL SELECT "LGBM_Sum_B3"."KEY" AS "KEY", "LGBM_Sum_B3"."Score_0" AS "Score_0", "LGBM_Sum_B3"."Score_1" AS "Score_1", "LGBM_Sum_B3"."Score_2" AS "Score_2", "LGBM_Sum_B3"."Score_3" AS "Score_3" 
FROM "TMP_20180329232954_30L2IK_LGBM_Sum_B3" AS "LGBM_Sum_B3" UNION ALL SELECT "LGBM_Sum_B4"."KEY" AS "KEY", "LGBM_Sum_B4"."Score_0" AS "Score_0", "LGBM_Sum_B4"."Score_1" AS "Score_1", "LGBM_Sum_B4"."Score_2" AS "Score_2", "LGBM_Sum_B4"."Score_3" AS "Score_3" 
FROM "TMP_20180329232954_N93RJD_LGBM_Sum_B4" AS "LGBM_Sum_B4" UNION ALL SELECT "LGBM_Sum_B5"."KEY" AS "KEY", "LGBM_Sum_B5"."Score_0" AS "Score_0", "LGBM_Sum_B5"."Score_1" AS "Score_1", "LGBM_Sum_B5"."Score_2" AS "Score_2", "LGBM_Sum_B5"."Score_3" AS "Score_3" 
FROM "TMP_20180329232954_OQP992_LGBM_Sum_B5" AS "LGBM_Sum_B5" UNION ALL SELECT "LGBM_Sum_B6"."KEY" AS "KEY", "LGBM_Sum_B6"."Score_0" AS "Score_0", "LGBM_Sum_B6"."Score_1" AS "Score_1", "LGBM_Sum_B6"."Score_2" AS "Score_2", "LGBM_Sum_B6"."Score_3" AS "Score_3" 
FROM "TMP_20180329232954_6D5JJQ_LGBM_Sum_B6" AS "LGBM_Sum_B6") AS "LGBM_Sum_EnsembleUnion") AS "LGBM_Sum_Union"
...
FROM "TMP_20180329232954_DJAYNP_LGBM_Sum_Union" AS "LGBM_Sum_Union" GROUP BY "LGBM_Sum_Union"."KEY") AS "T"), 
orig_cte AS 
