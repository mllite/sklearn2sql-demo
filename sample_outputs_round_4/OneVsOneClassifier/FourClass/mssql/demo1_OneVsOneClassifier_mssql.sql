...
[DT_node_data_3] AS 
(SELECT [Values].node_id AS node_id, [Values].feature AS feature, [Values].threshold AS threshold, [Values].count AS count, [Values].depth AS depth, [Values].parent_id AS parent_id, [Values].[Proba_0] AS [Proba_0], [Values].[LogProba_0] AS [LogProba_0], [Values].[Proba_1] AS [Proba_1], [Values].[LogProba_1] AS [LogProba_1], [Values].[Decision] AS [Decision] 
FROM (SELECT 0 AS node_id, 'Feature_7' AS feature, 0.20230038464069366 AS threshold, 50 AS count, 0 AS depth, CAST(NULL AS INTEGER) AS parent_id, 0.5 AS [Proba_0], -0.69314718056 AS [LogProba_0], 0.5 AS [Proba_1], -0.69314718056 AS [LogProba_1], 0 AS [Decision] UNION ALL SELECT 1 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT) AS threshold, 29 AS count, 1 AS depth, CAST(NULL AS INTEGER) AS parent_id, 0.13793103448275862 AS [Proba_0], -1.98100146887 AS [LogProba_0], 0.8620689655172413 AS [Proba_1], -0.148420005118 AS [LogProba_1], 1 AS [Decision] UNION ALL SELECT 2 AS node_id, CAST(NULL AS VARCHAR(256)) AS feature, CAST(NULL AS FLOAT) AS threshold, 21 AS count, 1 AS depth, CAST(NULL AS INTEGER) AS parent_id, 1.0 AS [Proba_0], 0.0 AS [LogProba_0], 0.0 AS [Proba_1], -1.79769313486231e+308 AS [LogProba_1], 0 AS [Decision]) AS [Values]), 
[DT_Output_3] AS 
