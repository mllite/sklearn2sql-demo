...
linear_model_cte AS 
(SELECT [ADS_ano_2_OUT].[KEY] AS [KEY], -1.1381192558814768 * [ADS_ano_2_OUT].anova_output_2 + 0.2124463291293219 * [ADS_ano_2_OUT].anova_output_3 + 0.023100368963337628 * [ADS_ano_2_OUT].anova_output_4 + -0.0009694736943393199 * [ADS_ano_2_OUT].anova_output_5 + -1.36757224777 AS [Score_0], 0.2796225536964365 * [ADS_ano_2_OUT].anova_output_2 + -2.2147992413489472 * [ADS_ano_2_OUT].anova_output_3 + -2.8883102012537956 * [ADS_ano_2_OUT].anova_output_4 + -1.81100966602359 * [ADS_ano_2_OUT].anova_output_5 + -0.998472881931 AS [Score_1], 7.216213800895781 * [ADS_ano_2_OUT].anova_output_2 + -4.601900993662282 * [ADS_ano_2_OUT].anova_output_3 + 4.096389405971153 * [ADS_ano_2_OUT].anova_output_4 + 2.8724524406093312 * [ADS_ano_2_OUT].anova_output_5 + -9.95637210222 AS [Score_2] 
FROM [ADS_ano_2_OUT]), 
orig_cte AS 
