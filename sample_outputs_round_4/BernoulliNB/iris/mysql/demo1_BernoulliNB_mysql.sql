...
WITH `RawScores` AS 
(SELECT `ADS`.`KEY` AS `KEY`, NULL AS `LogProba_0`, NULL AS `Proba_0`, -1.09861228867 + `ADS`.`Feature_0` * -0.0194180858571 + (1 - `ADS`.`Feature_0`) * -3.95124371858 + `ADS`.`Feature_1` * -0.0194180858571 + (1 - `ADS`.`Feature_1`) * -3.95124371858 + `ADS`.`Feature_2` * -0.0194180858571 + (1 - `ADS`.`Feature_2`) * -3.95124371858 + `ADS`.`Feature_3` * -0.0194180858571 + (1 - `ADS`.`Feature_3`) * -3.95124371858 AS `Score_0`, NULL AS `LogProba_1`, NULL AS `Proba_1`, -1.09861228867 + `ADS`.`Feature_0` * -0.0194180858571 + (1 - `ADS`.`Feature_0`) * -3.95124371858 + `ADS`.`Feature_1` * -0.0194180858571 + (1 - `ADS`.`Feature_1`) * -3.95124371858 + `ADS`.`Feature_2` * -0.0194180858571 + (1 - `ADS`.`Feature_2`) * -3.95124371858 + `ADS`.`Feature_3` * -0.0194180858571 + (1 - `ADS`.`Feature_3`) * -3.95124371858 AS `Score_1`, NULL AS `LogProba_2`, NULL AS `Proba_2`, -1.09861228867 + `ADS`.`Feature_0` * -0.0194180858571 + (1 - `ADS`.`Feature_0`) * -3.95124371858 + `ADS`.`Feature_1` * -0.0194180858571 + (1 - `ADS`.`Feature_1`) * -3.95124371858 + `ADS`.`Feature_2` * -0.0194180858571 + (1 - `ADS`.`Feature_2`) * -3.95124371858 + `ADS`.`Feature_3` * -0.0194180858571 + (1 - `ADS`.`Feature_3`) * -3.95124371858 AS `Score_2` 
